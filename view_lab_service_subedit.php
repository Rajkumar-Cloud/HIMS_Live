...
var fview_lab_service_subedit = currentForm = new ew.Form("fview_lab_service_subedit", "edit");
...
fview_lab_service_subedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_lab_service_sub_edit->Modified->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_lab_service_sub->Modified->caption(), $view_lab_service_sub->Modified->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($view_lab_service_sub_edit->ModifiedDateTime->Required) { ?>
			elm = this.getElements("x" + infix + "_ModifiedDateTime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_lab_service_sub->ModifiedDateTime->caption(), $view_lab_service_sub->ModifiedDateTime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fview_lab_service_subedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_lab_service_subedit.lists["x_UNITS"] = <?php echo $view_lab_service_sub_edit->UNITS->Lookup->toClientList() ?>;
fview_lab_service_subedit.lists["x_UNITS"].options = <?php echo JsonEncode($view_lab_service_sub_edit->UNITS->lookupOptions()) ?>;
fview_lab_service_subedit.lists["x_SERVICE_TYPE"] = <?php echo $view_lab_service_sub_edit->SERVICE_TYPE->Lookup->toClientList() ?>;
...
fview_lab_service_subedit.lists["x_DEPARTMENT"] = <?php echo $view_lab_service_sub_edit->DEPARTMENT->Lookup->toClientList() ?>;
...
fview_lab_service_subedit.lists["x_Inactive[]"] = <?php echo $view_lab_service_sub_edit->Inactive->Lookup->toClientList() ?>;
...
fview_lab_service_subedit.lists["x_TestType"] = <?php echo $view_lab_service_sub_edit->TestType->Lookup->toClientList() ?>;
...
<?php if ($view_lab_service_sub_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_lab_service_sub_edit->Token ?>">
<?php } ?>
...
<?php if ($view_lab_service_sub->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group row">
		<label id="elh_view_lab_service_sub_Id" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Id->caption() ?><?php echo ($view_lab_service_sub->Id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Id->cellAttributes() ?>>
...
<input type="hidden" data-table="view_lab_service_sub" data-field="x_Id" name="x_Id" id="x_Id" value="<?php echo HtmlEncode($view_lab_service_sub->Id->CurrentValue) ?>">
<?php echo $view_lab_service_sub->Id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_lab_service_sub->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_view_lab_service_sub_CODE" for="x_CODE" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->CODE->caption() ?><?php echo ($view_lab_service_sub->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->CODE->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->SERVICE->Visible) { // SERVICE ?>
	<div id="r_SERVICE" class="form-group row">
		<label id="elh_view_lab_service_sub_SERVICE" for="x_SERVICE" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->SERVICE->caption() ?><?php echo ($view_lab_service_sub->SERVICE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->SERVICE->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->UNITS->Visible) { // UNITS ?>
	<div id="r_UNITS" class="form-group row">
		<label id="elh_view_lab_service_sub_UNITS" for="x_UNITS" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->UNITS->caption() ?><?php echo ($view_lab_service_sub->UNITS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->UNITS->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->AMOUNT->Visible) { // AMOUNT ?>
	<div id="r_AMOUNT" class="form-group row">
		<label id="elh_view_lab_service_sub_AMOUNT" for="x_AMOUNT" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->AMOUNT->caption() ?><?php echo ($view_lab_service_sub->AMOUNT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->AMOUNT->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
	<div id="r_SERVICE_TYPE" class="form-group row">
		<label id="elh_view_lab_service_sub_SERVICE_TYPE" for="x_SERVICE_TYPE" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->SERVICE_TYPE->caption() ?><?php echo ($view_lab_service_sub->SERVICE_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->SERVICE_TYPE->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->DEPARTMENT->Visible) { // DEPARTMENT ?>
	<div id="r_DEPARTMENT" class="form-group row">
		<label id="elh_view_lab_service_sub_DEPARTMENT" for="x_DEPARTMENT" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->DEPARTMENT->caption() ?><?php echo ($view_lab_service_sub->DEPARTMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->DEPARTMENT->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
	<div id="r_mas_services_billingcol" class="form-group row">
		<label id="elh_view_lab_service_sub_mas_services_billingcol" for="x_mas_services_billingcol" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->mas_services_billingcol->caption() ?><?php echo ($view_lab_service_sub->mas_services_billingcol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->mas_services_billingcol->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->DrShareAmount->Visible) { // DrShareAmount ?>
	<div id="r_DrShareAmount" class="form-group row">
		<label id="elh_view_lab_service_sub_DrShareAmount" for="x_DrShareAmount" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->DrShareAmount->caption() ?><?php echo ($view_lab_service_sub->DrShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->DrShareAmount->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->HospShareAmount->Visible) { // HospShareAmount ?>
	<div id="r_HospShareAmount" class="form-group row">
		<label id="elh_view_lab_service_sub_HospShareAmount" for="x_HospShareAmount" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->HospShareAmount->caption() ?><?php echo ($view_lab_service_sub->HospShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->HospShareAmount->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->DrSharePer->Visible) { // DrSharePer ?>
	<div id="r_DrSharePer" class="form-group row">
		<label id="elh_view_lab_service_sub_DrSharePer" for="x_DrSharePer" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->DrSharePer->caption() ?><?php echo ($view_lab_service_sub->DrSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->DrSharePer->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->HospSharePer->Visible) { // HospSharePer ?>
	<div id="r_HospSharePer" class="form-group row">
		<label id="elh_view_lab_service_sub_HospSharePer" for="x_HospSharePer" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->HospSharePer->caption() ?><?php echo ($view_lab_service_sub->HospSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->HospSharePer->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_view_lab_service_sub_TestSubCd" for="x_TestSubCd" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->TestSubCd->caption() ?><?php echo ($view_lab_service_sub->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->TestSubCd->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_view_lab_service_sub_Method" for="x_Method" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Method->caption() ?><?php echo ($view_lab_service_sub->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Method->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_view_lab_service_sub_Order" for="x_Order" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Order->caption() ?><?php echo ($view_lab_service_sub->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Order->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_view_lab_service_sub_Form" for="x_Form" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Form->caption() ?><?php echo ($view_lab_service_sub->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Form->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_view_lab_service_sub_ResType" for="x_ResType" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->ResType->caption() ?><?php echo ($view_lab_service_sub->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->ResType->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->UnitCD->Visible) { // UnitCD ?>
	<div id="r_UnitCD" class="form-group row">
		<label id="elh_view_lab_service_sub_UnitCD" for="x_UnitCD" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->UnitCD->caption() ?><?php echo ($view_lab_service_sub->UnitCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->UnitCD->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_view_lab_service_sub_RefValue" for="x_RefValue" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->RefValue->caption() ?><?php echo ($view_lab_service_sub->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->RefValue->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_view_lab_service_sub_Sample" for="x_Sample" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Sample->caption() ?><?php echo ($view_lab_service_sub->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Sample->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_view_lab_service_sub_NoD" for="x_NoD" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->NoD->caption() ?><?php echo ($view_lab_service_sub->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->NoD->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_view_lab_service_sub_BillOrder" for="x_BillOrder" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->BillOrder->caption() ?><?php echo ($view_lab_service_sub->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->BillOrder->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_view_lab_service_sub_Formula" for="x_Formula" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Formula->caption() ?><?php echo ($view_lab_service_sub->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Formula->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_view_lab_service_sub_Inactive" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Inactive->caption() ?><?php echo ($view_lab_service_sub->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Inactive->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Outsource->Visible) { // Outsource ?>
	<div id="r_Outsource" class="form-group row">
		<label id="elh_view_lab_service_sub_Outsource" for="x_Outsource" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Outsource->caption() ?><?php echo ($view_lab_service_sub->Outsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Outsource->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_view_lab_service_sub_CollSample" for="x_CollSample" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->CollSample->caption() ?><?php echo ($view_lab_service_sub->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->CollSample->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->TestType->Visible) { // TestType ?>
	<div id="r_TestType" class="form-group row">
		<label id="elh_view_lab_service_sub_TestType" for="x_TestType" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->TestType->caption() ?><?php echo ($view_lab_service_sub->TestType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->TestType->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->NoHeading->Visible) { // NoHeading ?>
	<div id="r_NoHeading" class="form-group row">
		<label id="elh_view_lab_service_sub_NoHeading" for="x_NoHeading" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->NoHeading->caption() ?><?php echo ($view_lab_service_sub->NoHeading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->NoHeading->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->ChemicalCode->Visible) { // ChemicalCode ?>
	<div id="r_ChemicalCode" class="form-group row">
		<label id="elh_view_lab_service_sub_ChemicalCode" for="x_ChemicalCode" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->ChemicalCode->caption() ?><?php echo ($view_lab_service_sub->ChemicalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->ChemicalCode->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->ChemicalName->Visible) { // ChemicalName ?>
	<div id="r_ChemicalName" class="form-group row">
		<label id="elh_view_lab_service_sub_ChemicalName" for="x_ChemicalName" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->ChemicalName->caption() ?><?php echo ($view_lab_service_sub->ChemicalName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->ChemicalName->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Utilaization->Visible) { // Utilaization ?>
	<div id="r_Utilaization" class="form-group row">
		<label id="elh_view_lab_service_sub_Utilaization" for="x_Utilaization" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Utilaization->caption() ?><?php echo ($view_lab_service_sub->Utilaization->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Utilaization->cellAttributes() ?>>
...
<?php if ($view_lab_service_sub->Interpretation->Visible) { // Interpretation ?>
	<div id="r_Interpretation" class="form-group row">
		<label id="elh_view_lab_service_sub_Interpretation" class="<?php echo $view_lab_service_sub_edit->LeftColumnClass ?>"><?php echo $view_lab_service_sub->Interpretation->caption() ?><?php echo ($view_lab_service_sub->Interpretation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_lab_service_sub_edit->RightColumnClass ?>"><div<?php echo $view_lab_service_sub->Interpretation->cellAttributes() ?>>
...
<script>
ew.createEditor("fview_lab_service_subedit", "x_Interpretation", 35, 4, <?php echo ($view_lab_service_sub->Interpretation->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
