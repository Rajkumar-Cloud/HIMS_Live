...
class view_opd_follow_up extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Reception
		$this->Reception = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 200, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Reception->Sortable = TRUE; // Allow sort
		$this->fields['Reception'] = &$this->Reception;

		// PatientId
		$this->PatientId = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 3, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mrnno
		$this->mrnno = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// PatientName
		$this->PatientName = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Telephone
		$this->Telephone = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_Telephone', 'Telephone', '`Telephone`', '`Telephone`', 200, -1, FALSE, '`Telephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Telephone->Sortable = TRUE; // Allow sort
		$this->fields['Telephone'] = &$this->Telephone;

		// Age
		$this->Age = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// profilePic
		$this->profilePic = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// procedurenotes
		$this->procedurenotes = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_procedurenotes', 'procedurenotes', '`procedurenotes`', '`procedurenotes`', 201, -1, FALSE, '`procedurenotes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->procedurenotes->Sortable = TRUE; // Allow sort
		$this->fields['procedurenotes'] = &$this->procedurenotes;

		// NextReviewDate
		$this->NextReviewDate = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_NextReviewDate', 'NextReviewDate', '`NextReviewDate`', CastDateFieldForLike('`NextReviewDate`', 0, "DB"), 135, 0, FALSE, '`NextReviewDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ICSIAdvised
		$this->ICSIAdvised = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_ICSIAdvised', 'ICSIAdvised', '`ICSIAdvised`', '`ICSIAdvised`', 200, -1, FALSE, '`ICSIAdvised`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// DeliveryRegistered
		$this->DeliveryRegistered = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_DeliveryRegistered', 'DeliveryRegistered', '`DeliveryRegistered`', '`DeliveryRegistered`', 200, -1, FALSE, '`DeliveryRegistered`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// EDD
		$this->EDD = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_EDD', 'EDD', '`EDD`', CastDateFieldForLike('`EDD`', 0, "DB"), 135, 0, FALSE, '`EDD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SerologyPositive
		$this->SerologyPositive = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_SerologyPositive', 'SerologyPositive', '`SerologyPositive`', '`SerologyPositive`', 200, -1, FALSE, '`SerologyPositive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Allergy
		$this->Allergy = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_Allergy', 'Allergy', '`Allergy`', '`Allergy`', 200, -1, FALSE, '`Allergy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status
		$this->status = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdby
		$this->createdby = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// LMP
		$this->LMP = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_LMP', 'LMP', '`LMP`', CastDateFieldForLike('`LMP`', 0, "DB"), 135, 0, FALSE, '`LMP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Procedure
		$this->Procedure = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_Procedure', 'Procedure', '`Procedure`', '`Procedure`', 201, -1, FALSE, '`Procedure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Procedure->Sortable = TRUE; // Allow sort
		$this->fields['Procedure'] = &$this->Procedure;

		// ProcedureDateTime
		$this->ProcedureDateTime = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_ProcedureDateTime', 'ProcedureDateTime', '`ProcedureDateTime`', CastDateFieldForLike('`ProcedureDateTime`', 0, "DB"), 135, 0, FALSE, '`ProcedureDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ICSIDate
		$this->ICSIDate = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_ICSIDate', 'ICSIDate', '`ICSIDate`', CastDateFieldForLike('`ICSIDate`', 0, "DB"), 135, 0, FALSE, '`ICSIDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RIDNo
		$this->RIDNo = new DbField('view_opd_follow_up', 'view_opd_follow_up', 'x_RIDNo', 'RIDNo', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_opd_follow_upview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
