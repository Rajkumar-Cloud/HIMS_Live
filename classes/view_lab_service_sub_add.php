 ...
 * Page class
 */
class view_lab_service_sub_add extends view_lab_service_sub
{
	...
	// Page object name
	public $PageObjName = "view_lab_service_sub_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "view_lab_service_subview.php")
