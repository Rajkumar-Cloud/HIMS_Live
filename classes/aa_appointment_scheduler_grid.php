 ...
 * Page class
 */
class aa_appointment_scheduler_grid extends aa_appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "aa_appointment_scheduler_grid";

	// Grid form hidden field names
	public $FormName = "faa_appointment_schedulergrid";
