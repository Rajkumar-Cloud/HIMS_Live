 ...
 * Page class
 */
class patient_investigations_delete extends patient_investigations
{
	...
	// Page object name
	public $PageObjName = "patient_investigations_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_investigationslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_investigationslist.php"); // Return to list
			}
		}
	}
