 ...
 * Page class
 */
class store_billing_transfer_edit extends store_billing_transfer
{
	...
	// Page object name
	public $PageObjName = "store_billing_transfer_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("view_store_transfer", $detailTblVar) && $GLOBALS["view_store_transfer"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("view_store_transfer", $detailTblVar) && $GLOBALS["view_store_transfer"]->DetailEdit) {
						...
						$editRow = $GLOBALS["view_store_transfer_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("view_store_transfer", $detailTblVar)) {
				...
				if ($GLOBALS["view_store_transfer_grid"]->DetailEdit) {
					$GLOBALS["view_store_transfer_grid"]->CurrentMode = "edit";
					$GLOBALS["view_store_transfer_grid"]->CurrentAction = "gridedit";
