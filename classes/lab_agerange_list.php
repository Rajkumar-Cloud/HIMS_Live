 ...
 * Page class
 */
class lab_agerange_list extends lab_agerange
{
	...
	// Page object name
	public $PageObjName = "lab_agerange_list";

	// Grid form hidden field names
	public $FormName = "flab_agerangelist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "lab_agerangedelete.php";
		$this->MultiUpdateUrl = "lab_agerangeupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option flab_agerangelistsrch";
	...
	public function getFilterList()
	{
		...
		if (SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "flab_agerangelistsrch");
		...
		$filterList = Concat($filterList, $this->MinAge->AdvancedSearch->toJson(), ","); // Field MinAge
		$filterList = Concat($filterList, $this->MinAgeType->AdvancedSearch->toJson(), ","); // Field MinAgeType
		$filterList = Concat($filterList, $this->MaxAge->AdvancedSearch->toJson(), ","); // Field MaxAge
		$filterList = Concat($filterList, $this->MaxAgeType->AdvancedSearch->toJson(), ","); // Field MaxAgeType
		...
		$filterList = Concat($filterList, $this->Modied->AdvancedSearch->toJson(), ","); // Field Modied
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "flab_agerangelistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field MinAge
		$this->MinAge->AdvancedSearch->SearchValue = @$filter["x_MinAge"];
		$this->MinAge->AdvancedSearch->SearchOperator = @$filter["z_MinAge"];
		$this->MinAge->AdvancedSearch->SearchCondition = @$filter["v_MinAge"];
		$this->MinAge->AdvancedSearch->SearchValue2 = @$filter["y_MinAge"];
		$this->MinAge->AdvancedSearch->SearchOperator2 = @$filter["w_MinAge"];
		$this->MinAge->AdvancedSearch->save();

		// Field MinAgeType
		$this->MinAgeType->AdvancedSearch->SearchValue = @$filter["x_MinAgeType"];
		$this->MinAgeType->AdvancedSearch->SearchOperator = @$filter["z_MinAgeType"];
		$this->MinAgeType->AdvancedSearch->SearchCondition = @$filter["v_MinAgeType"];
		$this->MinAgeType->AdvancedSearch->SearchValue2 = @$filter["y_MinAgeType"];
		$this->MinAgeType->AdvancedSearch->SearchOperator2 = @$filter["w_MinAgeType"];
		$this->MinAgeType->AdvancedSearch->save();

		// Field MaxAge
		$this->MaxAge->AdvancedSearch->SearchValue = @$filter["x_MaxAge"];
		$this->MaxAge->AdvancedSearch->SearchOperator = @$filter["z_MaxAge"];
		$this->MaxAge->AdvancedSearch->SearchCondition = @$filter["v_MaxAge"];
		$this->MaxAge->AdvancedSearch->SearchValue2 = @$filter["y_MaxAge"];
		$this->MaxAge->AdvancedSearch->SearchOperator2 = @$filter["w_MaxAge"];
		$this->MaxAge->AdvancedSearch->save();

		// Field MaxAgeType
		$this->MaxAgeType->AdvancedSearch->SearchValue = @$filter["x_MaxAgeType"];
		$this->MaxAgeType->AdvancedSearch->SearchOperator = @$filter["z_MaxAgeType"];
		$this->MaxAgeType->AdvancedSearch->SearchCondition = @$filter["v_MaxAgeType"];
		$this->MaxAgeType->AdvancedSearch->SearchValue2 = @$filter["y_MaxAgeType"];
		$this->MaxAgeType->AdvancedSearch->SearchOperator2 = @$filter["w_MaxAgeType"];
		$this->MaxAgeType->AdvancedSearch->save();
		...
		// Field Modied
		$this->Modied->AdvancedSearch->SearchValue = @$filter["x_Modied"];
		$this->Modied->AdvancedSearch->SearchOperator = @$filter["z_Modied"];
		$this->Modied->AdvancedSearch->SearchCondition = @$filter["v_Modied"];
		$this->Modied->AdvancedSearch->SearchValue2 = @$filter["y_Modied"];
		$this->Modied->AdvancedSearch->SearchOperator2 = @$filter["w_Modied"];
		$this->Modied->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->MinAgeType, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->MaxAgeType, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->MinAge); // MinAge
			$this->updateSort($this->MinAgeType); // MinAgeType
			$this->updateSort($this->MaxAge); // MaxAge
			$this->updateSort($this->MaxAgeType); // MaxAgeType
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->Gender->setSort("");
				$this->MinAge->setSort("");
				$this->MinAgeType->setSort("");
				$this->MaxAge->setSort("");
				$this->MaxAgeType->setSort("");
				$this->Value->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"flab_agerangelistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"flab_agerangelistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.flab_agerangelist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"flab_agerangelistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('MinAge')); // MinAge
		$hash .= GetFieldHash($rs->fields('MinAgeType')); // MinAgeType
		$hash .= GetFieldHash($rs->fields('MaxAge')); // MaxAge
		$hash .= GetFieldHash($rs->fields('MaxAgeType')); // MaxAgeType
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.flab_agerangelist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.flab_agerangelist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.flab_agerangelist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	public function exportData($return = FALSE)
	{
		...
		if (EXPORT_MASTER_RECORD && $this->getMasterFilter() <> "" && $this->getCurrentMasterTable() == "lab_testname") {
			global $lab_testname;
			if (!isset($lab_testname))
				$lab_testname = new lab_testname();
			$rsmaster = $lab_testname->loadRs($this->DbMasterFilter); // Load master record
			if ($rsmaster && !$rsmaster->EOF) {
				$exportStyle = $doc->Style;
				$doc->setStyle("v"); // Change to vertical
				if (!$this->isExport("csv") || EXPORT_MASTER_RECORD_FOR_CSV) {
					$doc->Table = &$lab_testname;
					$lab_testname->exportDocument($doc, $rsmaster);
					$doc->exportEmptyRow();
					$doc->Table = &$this;
				}
