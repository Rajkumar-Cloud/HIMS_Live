 ...
 * Page class
 */
class ivf_ovum_pick_up_chart_preview extends ivf_ovum_pick_up_chart
{
	...
	// Page object name
	public $PageObjName = "ivf_ovum_pick_up_chart_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'ivf_ovum_pick_up_chart');
			if ($Security->isLoggedIn())
