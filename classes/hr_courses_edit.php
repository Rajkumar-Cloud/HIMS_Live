 ...
 * Page class
 */
class hr_courses_edit extends hr_courses
{
	...
	// Page object name
	public $PageObjName = "hr_courses_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// coordinator
			$this->coordinator->setDbValueDef($rsnew, $this->coordinator->CurrentValue, NULL, $this->coordinator->ReadOnly);

			// trainer
			$this->trainer->setDbValueDef($rsnew, $this->trainer->CurrentValue, NULL, $this->trainer->ReadOnly);

			// trainer_info
			$this->trainer_info->setDbValueDef($rsnew, $this->trainer_info->CurrentValue, NULL, $this->trainer_info->ReadOnly);
