...
class ivf_semenanalysisreport extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNo
		$this->RIDNo = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientName
		$this->PatientName = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->IsForeignKey = TRUE; // Foreign key field
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// HusbandName
		$this->HusbandName = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_HusbandName', 'HusbandName', '`HusbandName`', '`HusbandName`', 200, -1, FALSE, '`HusbandName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HusbandName->Sortable = TRUE; // Allow sort
		$this->fields['HusbandName'] = &$this->HusbandName;

		// RequestDr
		$this->RequestDr = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_RequestDr', 'RequestDr', '`RequestDr`', '`RequestDr`', 200, -1, FALSE, '`RequestDr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RequestDr->Sortable = TRUE; // Allow sort
		$this->fields['RequestDr'] = &$this->RequestDr;

		// CollectionDate
		$this->CollectionDate = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CollectionDate', 'CollectionDate', '`CollectionDate`', CastDateFieldForLike('`CollectionDate`', 0, "DB"), 135, 0, FALSE, '`CollectionDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResultDate
		$this->ResultDate = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike('`ResultDate`', 0, "DB"), 135, 0, FALSE, '`ResultDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RequestSample
		$this->RequestSample = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_RequestSample', 'RequestSample', '`RequestSample`', '`RequestSample`', 200, -1, FALSE, '`RequestSample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CollectionType
		$this->CollectionType = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CollectionType', 'CollectionType', '`CollectionType`', '`CollectionType`', 200, -1, FALSE, '`CollectionType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CollectionMethod
		$this->CollectionMethod = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CollectionMethod', 'CollectionMethod', '`CollectionMethod`', '`CollectionMethod`', 200, -1, FALSE, '`CollectionMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Medicationused
		$this->Medicationused = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Medicationused', 'Medicationused', '`Medicationused`', '`Medicationused`', 200, -1, FALSE, '`Medicationused`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->DifficultiesinCollection = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_DifficultiesinCollection', 'DifficultiesinCollection', '`DifficultiesinCollection`', '`DifficultiesinCollection`', 200, -1, FALSE, '`DifficultiesinCollection`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// pH
		$this->pH = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_pH', 'pH', '`pH`', '`pH`', 200, -1, FALSE, '`pH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pH->Sortable = TRUE; // Allow sort
		$this->fields['pH'] = &$this->pH;

		// Timeofcollection
		$this->Timeofcollection = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Timeofcollection', 'Timeofcollection', '`Timeofcollection`', '`Timeofcollection`', 200, 3, FALSE, '`Timeofcollection`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Timeofcollection->Sortable = TRUE; // Allow sort
		$this->fields['Timeofcollection'] = &$this->Timeofcollection;

		// Timeofexamination
		$this->Timeofexamination = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Timeofexamination', 'Timeofexamination', '`Timeofexamination`', '`Timeofexamination`', 200, 3, FALSE, '`Timeofexamination`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Timeofexamination->Sortable = TRUE; // Allow sort
		$this->fields['Timeofexamination'] = &$this->Timeofexamination;

		// Volume
		$this->Volume = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Volume', 'Volume', '`Volume`', '`Volume`', 200, -1, FALSE, '`Volume`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Volume->Sortable = TRUE; // Allow sort
		$this->fields['Volume'] = &$this->Volume;

		// Concentration
		$this->Concentration = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Concentration', 'Concentration', '`Concentration`', '`Concentration`', 200, -1, FALSE, '`Concentration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Concentration->Sortable = TRUE; // Allow sort
		$this->fields['Concentration'] = &$this->Concentration;

		// Total
		$this->Total = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Total', 'Total', '`Total`', '`Total`', 200, -1, FALSE, '`Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total->Sortable = TRUE; // Allow sort
		$this->fields['Total'] = &$this->Total;

		// ProgressiveMotility
		$this->ProgressiveMotility = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_ProgressiveMotility', 'ProgressiveMotility', '`ProgressiveMotility`', '`ProgressiveMotility`', 200, -1, FALSE, '`ProgressiveMotility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProgressiveMotility->Sortable = TRUE; // Allow sort
		$this->fields['ProgressiveMotility'] = &$this->ProgressiveMotility;

		// NonProgrssiveMotile
		$this->NonProgrssiveMotile = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_NonProgrssiveMotile', 'NonProgrssiveMotile', '`NonProgrssiveMotile`', '`NonProgrssiveMotile`', 200, -1, FALSE, '`NonProgrssiveMotile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NonProgrssiveMotile->Sortable = TRUE; // Allow sort
		$this->fields['NonProgrssiveMotile'] = &$this->NonProgrssiveMotile;

		// Immotile
		$this->Immotile = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Immotile', 'Immotile', '`Immotile`', '`Immotile`', 200, -1, FALSE, '`Immotile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Immotile->Sortable = TRUE; // Allow sort
		$this->fields['Immotile'] = &$this->Immotile;

		// TotalProgrssiveMotile
		$this->TotalProgrssiveMotile = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TotalProgrssiveMotile', 'TotalProgrssiveMotile', '`TotalProgrssiveMotile`', '`TotalProgrssiveMotile`', 200, -1, FALSE, '`TotalProgrssiveMotile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TotalProgrssiveMotile->Sortable = TRUE; // Allow sort
		$this->fields['TotalProgrssiveMotile'] = &$this->TotalProgrssiveMotile;

		// Appearance
		$this->Appearance = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Appearance', 'Appearance', '`Appearance`', '`Appearance`', 200, -1, FALSE, '`Appearance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Appearance->Sortable = TRUE; // Allow sort
		$this->fields['Appearance'] = &$this->Appearance;

		// Homogenosity
		$this->Homogenosity = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Homogenosity', 'Homogenosity', '`Homogenosity`', '`Homogenosity`', 200, -1, FALSE, '`Homogenosity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CompleteSample
		$this->CompleteSample = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CompleteSample', 'CompleteSample', '`CompleteSample`', '`CompleteSample`', 200, -1, FALSE, '`CompleteSample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Liquefactiontime
		$this->Liquefactiontime = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Liquefactiontime', 'Liquefactiontime', '`Liquefactiontime`', '`Liquefactiontime`', 200, -1, FALSE, '`Liquefactiontime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Liquefactiontime->Sortable = TRUE; // Allow sort
		$this->fields['Liquefactiontime'] = &$this->Liquefactiontime;

		// Normal
		$this->Normal = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Normal', 'Normal', '`Normal`', '`Normal`', 200, -1, FALSE, '`Normal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Normal->Sortable = TRUE; // Allow sort
		$this->fields['Normal'] = &$this->Normal;

		// Abnormal
		$this->Abnormal = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Abnormal', 'Abnormal', '`Abnormal`', '`Abnormal`', 200, -1, FALSE, '`Abnormal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Abnormal->Sortable = TRUE; // Allow sort
		$this->fields['Abnormal'] = &$this->Abnormal;

		// Headdefects
		$this->Headdefects = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Headdefects', 'Headdefects', '`Headdefects`', '`Headdefects`', 200, -1, FALSE, '`Headdefects`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Headdefects->Sortable = TRUE; // Allow sort
		$this->fields['Headdefects'] = &$this->Headdefects;

		// MidpieceDefects
		$this->MidpieceDefects = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_MidpieceDefects', 'MidpieceDefects', '`MidpieceDefects`', '`MidpieceDefects`', 200, -1, FALSE, '`MidpieceDefects`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MidpieceDefects->Sortable = TRUE; // Allow sort
		$this->fields['MidpieceDefects'] = &$this->MidpieceDefects;

		// TailDefects
		$this->TailDefects = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TailDefects', 'TailDefects', '`TailDefects`', '`TailDefects`', 200, -1, FALSE, '`TailDefects`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TailDefects->Sortable = TRUE; // Allow sort
		$this->fields['TailDefects'] = &$this->TailDefects;

		// NormalProgMotile
		$this->NormalProgMotile = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_NormalProgMotile', 'NormalProgMotile', '`NormalProgMotile`', '`NormalProgMotile`', 200, -1, FALSE, '`NormalProgMotile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NormalProgMotile->Sortable = TRUE; // Allow sort
		$this->fields['NormalProgMotile'] = &$this->NormalProgMotile;

		// ImmatureForms
		$this->ImmatureForms = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_ImmatureForms', 'ImmatureForms', '`ImmatureForms`', '`ImmatureForms`', 200, -1, FALSE, '`ImmatureForms`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ImmatureForms->Sortable = TRUE; // Allow sort
		$this->fields['ImmatureForms'] = &$this->ImmatureForms;

		// Leucocytes
		$this->Leucocytes = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Leucocytes', 'Leucocytes', '`Leucocytes`', '`Leucocytes`', 200, -1, FALSE, '`Leucocytes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Leucocytes->Sortable = TRUE; // Allow sort
		$this->fields['Leucocytes'] = &$this->Leucocytes;

		// Agglutination
		$this->Agglutination = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Agglutination', 'Agglutination', '`Agglutination`', '`Agglutination`', 200, -1, FALSE, '`Agglutination`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Agglutination->Sortable = TRUE; // Allow sort
		$this->fields['Agglutination'] = &$this->Agglutination;

		// Debris
		$this->Debris = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Debris', 'Debris', '`Debris`', '`Debris`', 200, -1, FALSE, '`Debris`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Debris->Sortable = TRUE; // Allow sort
		$this->fields['Debris'] = &$this->Debris;

		// Diagnosis
		$this->Diagnosis = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Diagnosis', 'Diagnosis', '`Diagnosis`', '`Diagnosis`', 201, -1, FALSE, '`Diagnosis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Diagnosis->Sortable = TRUE; // Allow sort
		$this->fields['Diagnosis'] = &$this->Diagnosis;

		// Observations
		$this->Observations = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Observations', 'Observations', '`Observations`', '`Observations`', 201, -1, FALSE, '`Observations`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Observations->Sortable = TRUE; // Allow sort
		$this->fields['Observations'] = &$this->Observations;

		// Signature
		$this->Signature = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Signature', 'Signature', '`Signature`', '`Signature`', 200, -1, FALSE, '`Signature`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Signature->Sortable = TRUE; // Allow sort
		$this->fields['Signature'] = &$this->Signature;

		// SemenOrgin
		$this->SemenOrgin = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_SemenOrgin', 'SemenOrgin', '`SemenOrgin`', '`SemenOrgin`', 200, -1, FALSE, '`SemenOrgin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Donor
		$this->Donor = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Donor', 'Donor', '`Donor`', '`Donor`', 3, -1, FALSE, '`Donor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DonorBloodgroup
		$this->DonorBloodgroup = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_DonorBloodgroup', 'DonorBloodgroup', '`DonorBloodgroup`', '`DonorBloodgroup`', 200, -1, FALSE, '`DonorBloodgroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DonorBloodgroup->Sortable = TRUE; // Allow sort
		$this->fields['DonorBloodgroup'] = &$this->DonorBloodgroup;

		// Tank
		$this->Tank = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Tank', 'Tank', '`Tank`', '`Tank`', 200, -1, FALSE, '`Tank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tank->Sortable = TRUE; // Allow sort
		$this->fields['Tank'] = &$this->Tank;

		// Location
		$this->Location = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Location', 'Location', '`Location`', '`Location`', 200, -1, FALSE, '`Location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Location->Sortable = TRUE; // Allow sort
		$this->fields['Location'] = &$this->Location;

		// Volume1
		$this->Volume1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Volume1', 'Volume1', '`Volume1`', '`Volume1`', 200, -1, FALSE, '`Volume1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Volume1->Sortable = TRUE; // Allow sort
		$this->fields['Volume1'] = &$this->Volume1;

		// Concentration1
		$this->Concentration1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Concentration1', 'Concentration1', '`Concentration1`', '`Concentration1`', 200, -1, FALSE, '`Concentration1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Concentration1->Sortable = TRUE; // Allow sort
		$this->fields['Concentration1'] = &$this->Concentration1;

		// Total1
		$this->Total1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Total1', 'Total1', '`Total1`', '`Total1`', 200, -1, FALSE, '`Total1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total1->Sortable = TRUE; // Allow sort
		$this->fields['Total1'] = &$this->Total1;

		// ProgressiveMotility1
		$this->ProgressiveMotility1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_ProgressiveMotility1', 'ProgressiveMotility1', '`ProgressiveMotility1`', '`ProgressiveMotility1`', 200, -1, FALSE, '`ProgressiveMotility1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->NonProgrssiveMotile1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_NonProgrssiveMotile1', 'NonProgrssiveMotile1', '`NonProgrssiveMotile1`', '`NonProgrssiveMotile1`', 200, -1, FALSE, '`NonProgrssiveMotile1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NonProgrssiveMotile1->Sortable = TRUE; // Allow sort
		$this->fields['NonProgrssiveMotile1'] = &$this->NonProgrssiveMotile1;

		// Immotile1
		$this->Immotile1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Immotile1', 'Immotile1', '`Immotile1`', '`Immotile1`', 200, -1, FALSE, '`Immotile1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Immotile1->Sortable = TRUE; // Allow sort
		$this->fields['Immotile1'] = &$this->Immotile1;

		// TotalProgrssiveMotile1
		$this->TotalProgrssiveMotile1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TotalProgrssiveMotile1', 'TotalProgrssiveMotile1', '`TotalProgrssiveMotile1`', '`TotalProgrssiveMotile1`', 200, -1, FALSE, '`TotalProgrssiveMotile1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TotalProgrssiveMotile1->Sortable = TRUE; // Allow sort
		$this->fields['TotalProgrssiveMotile1'] = &$this->TotalProgrssiveMotile1;

		// TidNo
		$this->TidNo = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Color
		$this->Color = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Color', 'Color', '`Color`', '`Color`', 200, -1, FALSE, '`Color`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Color->Sortable = TRUE; // Allow sort
		$this->fields['Color'] = &$this->Color;

		// DoneBy
		$this->DoneBy = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_DoneBy', 'DoneBy', '`DoneBy`', '`DoneBy`', 200, -1, FALSE, '`DoneBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DoneBy->Sortable = TRUE; // Allow sort
		$this->fields['DoneBy'] = &$this->DoneBy;

		// Method
		$this->Method = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Method', 'Method', '`Method`', '`Method`', 200, -1, FALSE, '`Method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Method->Sortable = TRUE; // Allow sort
		$this->fields['Method'] = &$this->Method;

		// Abstinence
		$this->Abstinence = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Abstinence', 'Abstinence', '`Abstinence`', '`Abstinence`', 200, -1, FALSE, '`Abstinence`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Abstinence->Sortable = TRUE; // Allow sort
		$this->fields['Abstinence'] = &$this->Abstinence;

		// ProcessedBy
		$this->ProcessedBy = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_ProcessedBy', 'ProcessedBy', '`ProcessedBy`', '`ProcessedBy`', 200, -1, FALSE, '`ProcessedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProcessedBy->Sortable = TRUE; // Allow sort
		$this->fields['ProcessedBy'] = &$this->ProcessedBy;

		// InseminationTime
		$this->InseminationTime = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_InseminationTime', 'InseminationTime', '`InseminationTime`', '`InseminationTime`', 200, -1, FALSE, '`InseminationTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->InseminationTime->Sortable = TRUE; // Allow sort
		$this->fields['InseminationTime'] = &$this->InseminationTime;

		// InseminationBy
		$this->InseminationBy = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_InseminationBy', 'InseminationBy', '`InseminationBy`', '`InseminationBy`', 200, -1, FALSE, '`InseminationBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->InseminationBy->Sortable = TRUE; // Allow sort
		$this->fields['InseminationBy'] = &$this->InseminationBy;

		// Big
		$this->Big = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Big', 'Big', '`Big`', '`Big`', 200, -1, FALSE, '`Big`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Big->Sortable = TRUE; // Allow sort
		$this->fields['Big'] = &$this->Big;

		// Medium
		$this->Medium = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Medium', 'Medium', '`Medium`', '`Medium`', 200, -1, FALSE, '`Medium`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Medium->Sortable = TRUE; // Allow sort
		$this->fields['Medium'] = &$this->Medium;

		// Small
		$this->Small = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Small', 'Small', '`Small`', '`Small`', 200, -1, FALSE, '`Small`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Small->Sortable = TRUE; // Allow sort
		$this->fields['Small'] = &$this->Small;

		// NoHalo
		$this->NoHalo = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_NoHalo', 'NoHalo', '`NoHalo`', '`NoHalo`', 200, -1, FALSE, '`NoHalo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoHalo->Sortable = TRUE; // Allow sort
		$this->fields['NoHalo'] = &$this->NoHalo;

		// Fragmented
		$this->Fragmented = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Fragmented', 'Fragmented', '`Fragmented`', '`Fragmented`', 200, -1, FALSE, '`Fragmented`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fragmented->Sortable = TRUE; // Allow sort
		$this->fields['Fragmented'] = &$this->Fragmented;

		// NonFragmented
		$this->NonFragmented = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_NonFragmented', 'NonFragmented', '`NonFragmented`', '`NonFragmented`', 200, -1, FALSE, '`NonFragmented`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NonFragmented->Sortable = TRUE; // Allow sort
		$this->fields['NonFragmented'] = &$this->NonFragmented;

		// DFI
		$this->DFI = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_DFI', 'DFI', '`DFI`', '`DFI`', 200, -1, FALSE, '`DFI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DFI->Sortable = TRUE; // Allow sort
		$this->fields['DFI'] = &$this->DFI;

		// IsueBy
		$this->IsueBy = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IsueBy', 'IsueBy', '`IsueBy`', '`IsueBy`', 200, -1, FALSE, '`IsueBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IsueBy->Sortable = TRUE; // Allow sort
		$this->fields['IsueBy'] = &$this->IsueBy;

		// Volume2
		$this->Volume2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Volume2', 'Volume2', '`Volume2`', '`Volume2`', 200, -1, FALSE, '`Volume2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Volume2->Sortable = TRUE; // Allow sort
		$this->fields['Volume2'] = &$this->Volume2;

		// Concentration2
		$this->Concentration2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Concentration2', 'Concentration2', '`Concentration2`', '`Concentration2`', 200, -1, FALSE, '`Concentration2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Concentration2->Sortable = TRUE; // Allow sort
		$this->fields['Concentration2'] = &$this->Concentration2;

		// Total2
		$this->Total2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Total2', 'Total2', '`Total2`', '`Total2`', 200, -1, FALSE, '`Total2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total2->Sortable = TRUE; // Allow sort
		$this->fields['Total2'] = &$this->Total2;

		// ProgressiveMotility2
		$this->ProgressiveMotility2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_ProgressiveMotility2', 'ProgressiveMotility2', '`ProgressiveMotility2`', '`ProgressiveMotility2`', 200, -1, FALSE, '`ProgressiveMotility2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->NonProgrssiveMotile2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_NonProgrssiveMotile2', 'NonProgrssiveMotile2', '`NonProgrssiveMotile2`', '`NonProgrssiveMotile2`', 200, -1, FALSE, '`NonProgrssiveMotile2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NonProgrssiveMotile2->Sortable = TRUE; // Allow sort
		$this->fields['NonProgrssiveMotile2'] = &$this->NonProgrssiveMotile2;

		// Immotile2
		$this->Immotile2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Immotile2', 'Immotile2', '`Immotile2`', '`Immotile2`', 200, -1, FALSE, '`Immotile2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Immotile2->Sortable = TRUE; // Allow sort
		$this->fields['Immotile2'] = &$this->Immotile2;

		// TotalProgrssiveMotile2
		$this->TotalProgrssiveMotile2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TotalProgrssiveMotile2', 'TotalProgrssiveMotile2', '`TotalProgrssiveMotile2`', '`TotalProgrssiveMotile2`', 200, -1, FALSE, '`TotalProgrssiveMotile2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TotalProgrssiveMotile2->Sortable = TRUE; // Allow sort
		$this->fields['TotalProgrssiveMotile2'] = &$this->TotalProgrssiveMotile2;

		// MACS
		$this->MACS = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, -1, FALSE, '`MACS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// IssuedBy
		$this->IssuedBy = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IssuedBy', 'IssuedBy', '`IssuedBy`', '`IssuedBy`', 200, -1, FALSE, '`IssuedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IssuedBy->Sortable = TRUE; // Allow sort
		$this->fields['IssuedBy'] = &$this->IssuedBy;

		// IssuedTo
		$this->IssuedTo = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IssuedTo', 'IssuedTo', '`IssuedTo`', '`IssuedTo`', 200, -1, FALSE, '`IssuedTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IssuedTo->Sortable = TRUE; // Allow sort
		$this->fields['IssuedTo'] = &$this->IssuedTo;

		// PaID
		$this->PaID = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PaID', 'PaID', '`PaID`', '`PaID`', 200, -1, FALSE, '`PaID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaID->Sortable = TRUE; // Allow sort
		$this->fields['PaID'] = &$this->PaID;

		// PaName
		$this->PaName = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PaName', 'PaName', '`PaName`', '`PaName`', 200, -1, FALSE, '`PaName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaName->Sortable = TRUE; // Allow sort
		$this->fields['PaName'] = &$this->PaName;

		// PaMobile
		$this->PaMobile = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PaMobile', 'PaMobile', '`PaMobile`', '`PaMobile`', 200, -1, FALSE, '`PaMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaMobile->Sortable = TRUE; // Allow sort
		$this->fields['PaMobile'] = &$this->PaMobile;

		// PartnerID
		$this->PartnerID = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PartnerID', 'PartnerID', '`PartnerID`', '`PartnerID`', 200, -1, FALSE, '`PartnerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerID->Sortable = TRUE; // Allow sort
		$this->fields['PartnerID'] = &$this->PartnerID;

		// PartnerName
		$this->PartnerName = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, -1, FALSE, '`PartnerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerName->Sortable = TRUE; // Allow sort
		$this->fields['PartnerName'] = &$this->PartnerName;

		// PartnerMobile
		$this->PartnerMobile = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PartnerMobile', 'PartnerMobile', '`PartnerMobile`', '`PartnerMobile`', 200, -1, FALSE, '`PartnerMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerMobile->Sortable = TRUE; // Allow sort
		$this->fields['PartnerMobile'] = &$this->PartnerMobile;

		// PREG_TEST_DATE
		$this->PREG_TEST_DATE = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_PREG_TEST_DATE', 'PREG_TEST_DATE', '`PREG_TEST_DATE`', CastDateFieldForLike('`PREG_TEST_DATE`', 0, "DB"), 135, 0, FALSE, '`PREG_TEST_DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SPECIFIC_PROBLEMS
		$this->SPECIFIC_PROBLEMS = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_SPECIFIC_PROBLEMS', 'SPECIFIC_PROBLEMS', '`SPECIFIC_PROBLEMS`', '`SPECIFIC_PROBLEMS`', 200, -1, FALSE, '`SPECIFIC_PROBLEMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IMSC_1
		$this->IMSC_1 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IMSC_1', 'IMSC_1', '`IMSC_1`', '`IMSC_1`', 200, -1, FALSE, '`IMSC_1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMSC_1->Sortable = TRUE; // Allow sort
		$this->fields['IMSC_1'] = &$this->IMSC_1;

		// IMSC_2
		$this->IMSC_2 = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IMSC_2', 'IMSC_2', '`IMSC_2`', '`IMSC_2`', 200, -1, FALSE, '`IMSC_2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMSC_2->Sortable = TRUE; // Allow sort
		$this->fields['IMSC_2'] = &$this->IMSC_2;

		// LIQUIFACTION_STORAGE
		$this->LIQUIFACTION_STORAGE = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_LIQUIFACTION_STORAGE', 'LIQUIFACTION_STORAGE', '`LIQUIFACTION_STORAGE`', '`LIQUIFACTION_STORAGE`', 200, -1, FALSE, '`LIQUIFACTION_STORAGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IUI_PREP_METHOD
		$this->IUI_PREP_METHOD = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IUI_PREP_METHOD', 'IUI_PREP_METHOD', '`IUI_PREP_METHOD`', '`IUI_PREP_METHOD`', 200, -1, FALSE, '`IUI_PREP_METHOD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TIME_FROM_TRIGGER
		$this->TIME_FROM_TRIGGER = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TIME_FROM_TRIGGER', 'TIME_FROM_TRIGGER', '`TIME_FROM_TRIGGER`', '`TIME_FROM_TRIGGER`', 200, -1, FALSE, '`TIME_FROM_TRIGGER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->COLLECTION_TO_PREPARATION = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_COLLECTION_TO_PREPARATION', 'COLLECTION_TO_PREPARATION', '`COLLECTION_TO_PREPARATION`', '`COLLECTION_TO_PREPARATION`', 200, -1, FALSE, '`COLLECTION_TO_PREPARATION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TIME_FROM_PREP_TO_INSEM = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TIME_FROM_PREP_TO_INSEM', 'TIME_FROM_PREP_TO_INSEM', '`TIME_FROM_PREP_TO_INSEM`', '`TIME_FROM_PREP_TO_INSEM`', 200, -1, FALSE, '`TIME_FROM_PREP_TO_INSEM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_semenanalysisreportview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
