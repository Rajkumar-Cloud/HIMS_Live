 ...
 * Page class
 */
class view_template_for_et_list extends view_template_for_et
{
	...
	// Table name
	public $TableName = 'view_template_for_et';

	// Page object name
	public $PageObjName = "view_template_for_et_list";

	// Grid form hidden field names
	public $FormName = "fview_template_for_etlist";
	...
	public function __construct()
	{
		...
		// Table object (view_template_for_et)
		if (!isset($GLOBALS["view_template_for_et"]) || get_class($GLOBALS["view_template_for_et"]) == PROJECT_NAMESPACE . "view_template_for_et") {
			$GLOBALS["view_template_for_et"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["view_template_for_et"];
		}
		...
		$this->AddUrl = "view_template_for_etadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "view_template_for_etdelete.php";
		$this->MultiUpdateUrl = "view_template_for_etupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_template_for_et');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fview_template_for_etlistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $view_template_for_et;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($view_template_for_et);
				$doc->Text = @$content;
	...
	public function run()
	{
		...
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->Visible = FALSE;
		...
		$this->MISCARRIAGE_EARLY_2F_LATE->Visible = FALSE;
		$this->ANC->Visible = FALSE;
		$this->NICU_ADMISSION->Visible = FALSE;
		...
		$this->DELIVERED_HOSPITAL->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		if (SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fview_template_for_etlistsrch");
		...
		$filterList = Concat($filterList, $this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->toJson(), ","); // Field FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
		...
		$filterList = Concat($filterList, $this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->toJson(), ","); // Field MISCARRIAGE EARLY / LATE
		$filterList = Concat($filterList, $this->ANC->AdvancedSearch->toJson(), ","); // Field ANC
		$filterList = Concat($filterList, $this->NICU_ADMISSION->AdvancedSearch->toJson(), ","); // Field NICU ADMISSION
		...
		$filterList = Concat($filterList, $this->DELIVERED_HOSPITAL->AdvancedSearch->toJson(), ","); // Field DELIVERED HOSPITAL
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fview_template_for_etlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->SearchValue = @$filter["x_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET"];
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->SearchOperator = @$filter["z_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET"];
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->SearchCondition = @$filter["v_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET"];
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->SearchValue2 = @$filter["y_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET"];
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->SearchOperator2 = @$filter["w_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET"];
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->save();
		...
		// Field MISCARRIAGE EARLY / LATE
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->SearchValue = @$filter["x_MISCARRIAGE_EARLY_2F_LATE"];
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->SearchOperator = @$filter["z_MISCARRIAGE_EARLY_2F_LATE"];
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->SearchCondition = @$filter["v_MISCARRIAGE_EARLY_2F_LATE"];
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->SearchValue2 = @$filter["y_MISCARRIAGE_EARLY_2F_LATE"];
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->SearchOperator2 = @$filter["w_MISCARRIAGE_EARLY_2F_LATE"];
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->save();
		...
		// Field NICU ADMISSION
		$this->NICU_ADMISSION->AdvancedSearch->SearchValue = @$filter["x_NICU_ADMISSION"];
		$this->NICU_ADMISSION->AdvancedSearch->SearchOperator = @$filter["z_NICU_ADMISSION"];
		$this->NICU_ADMISSION->AdvancedSearch->SearchCondition = @$filter["v_NICU_ADMISSION"];
		$this->NICU_ADMISSION->AdvancedSearch->SearchValue2 = @$filter["y_NICU_ADMISSION"];
		$this->NICU_ADMISSION->AdvancedSearch->SearchOperator2 = @$filter["w_NICU_ADMISSION"];
		$this->NICU_ADMISSION->AdvancedSearch->save();
		...
		// Field DELIVERED HOSPITAL
		$this->DELIVERED_HOSPITAL->AdvancedSearch->SearchValue = @$filter["x_DELIVERED_HOSPITAL"];
		$this->DELIVERED_HOSPITAL->AdvancedSearch->SearchOperator = @$filter["z_DELIVERED_HOSPITAL"];
		$this->DELIVERED_HOSPITAL->AdvancedSearch->SearchCondition = @$filter["v_DELIVERED_HOSPITAL"];
		$this->DELIVERED_HOSPITAL->AdvancedSearch->SearchValue2 = @$filter["y_DELIVERED_HOSPITAL"];
		$this->DELIVERED_HOSPITAL->AdvancedSearch->SearchOperator2 = @$filter["w_DELIVERED_HOSPITAL"];
		$this->DELIVERED_HOSPITAL->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET, $default, FALSE); // FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
		...
		$this->buildSearchSql($where, $this->MISCARRIAGE_EARLY_2F_LATE, $default, FALSE); // MISCARRIAGE EARLY / LATE
		$this->buildSearchSql($where, $this->ANC, $default, FALSE); // ANC
		$this->buildSearchSql($where, $this->NICU_ADMISSION, $default, FALSE); // NICU ADMISSION
		...
		$this->buildSearchSql($where, $this->DELIVERED_HOSPITAL, $default, FALSE); // DELIVERED HOSPITAL
		...
		if (!$default && $this->Command == "search") {
			...
			$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->save(); // FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
			...
			$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->save(); // MISCARRIAGE EARLY / LATE
			$this->ANC->AdvancedSearch->save(); // ANC
			$this->NICU_ADMISSION->AdvancedSearch->save(); // NICU ADMISSION
			...
			$this->DELIVERED_HOSPITAL->AdvancedSearch->save(); // DELIVERED HOSPITAL
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->MISCARRIAGE_EARLY_2F_LATE, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ANC, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->NICU_ADMISSION, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->DELIVERED_HOSPITAL, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->PartnerAge->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->Type_of_preg->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ANC->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->NICU_ADMISSION->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->Pregnancy_outcome->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->DELIVERED_HOSPITAL->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->unsetSession();
		...
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->unsetSession();
		$this->ANC->AdvancedSearch->unsetSession();
		$this->NICU_ADMISSION->AdvancedSearch->unsetSession();
		...
		$this->DELIVERED_HOSPITAL->AdvancedSearch->unsetSession();
	...
	protected function restoreSearchParms()
	{
		...
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->load();
		...
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->load();
		$this->ANC->AdvancedSearch->load();
		$this->NICU_ADMISSION->AdvancedSearch->load();
		...
		$this->DELIVERED_HOSPITAL->AdvancedSearch->load();
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_template_for_etlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_template_for_etlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fview_template_for_etlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_template_for_etlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function loadSearchValues()
	{
		...
		if (!$this->isAddOrEdit())
			$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->setSearchValue(Get("x_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET", Get("FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET", "")));
		if ($this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->AdvancedSearch->setSearchOperator(Get("z_FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET", ""));
		...
		if (!$this->isAddOrEdit())
			$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->setSearchValue(Get("x_MISCARRIAGE_EARLY_2F_LATE", Get("MISCARRIAGE_EARLY_2F_LATE", "")));
		if ($this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->MISCARRIAGE_EARLY_2F_LATE->AdvancedSearch->setSearchOperator(Get("z_MISCARRIAGE_EARLY_2F_LATE", ""));
		...
		// NICU ADMISSION
		if (!$this->isAddOrEdit())
			$this->NICU_ADMISSION->AdvancedSearch->setSearchValue(Get("x_NICU_ADMISSION", Get("NICU_ADMISSION", "")));
		if ($this->NICU_ADMISSION->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->NICU_ADMISSION->AdvancedSearch->setSearchOperator(Get("z_NICU_ADMISSION", ""));
		...
		// DELIVERED HOSPITAL
		if (!$this->isAddOrEdit())
			$this->DELIVERED_HOSPITAL->AdvancedSearch->setSearchValue(Get("x_DELIVERED_HOSPITAL", Get("DELIVERED_HOSPITAL", "")));
		if ($this->DELIVERED_HOSPITAL->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DELIVERED_HOSPITAL->AdvancedSearch->setSearchOperator(Get("z_DELIVERED_HOSPITAL", ""));
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->FRESH_ET2F_FET2F_FRESH_OD_ET2F_OD_FET_2F_FRESH_DET2F_FROZEN_DET->setDbValue($row['FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET']);
		...
		$this->MISCARRIAGE_EARLY_2F_LATE->setDbValue($row['MISCARRIAGE EARLY / LATE']);
		$this->ANC->setDbValue($row['ANC']);
		$this->NICU_ADMISSION->setDbValue($row['NICU ADMISSION']);
		...
		$this->DELIVERED_HOSPITAL->setDbValue($row['DELIVERED HOSPITAL']);
	...
	protected function newRow()
	{
		...
		$row['PatientAge'] = NULL;
		$row['PartnerAge'] = NULL;
		$row['FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET'] = NULL;
		...
		$row['MISCARRIAGE EARLY / LATE'] = NULL;
		$row['ANC'] = NULL;
		$row['NICU ADMISSION'] = NULL;
		$row['anomalies'] = NULL;
		$row['baby wt'] = NULL;
		$row['GA at delivery'] = NULL;
		$row['Pregnancy outcome'] = NULL;
		$row['DELIVERED HOSPITAL'] = NULL;
		$row['DOCTOR'] = NULL;
		return $row;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (REMOVE_XSS)
				$this->Ectopic->AdvancedSearch->SearchValue = HtmlDecode($this->Ectopic->AdvancedSearch->SearchValue);
			$this->Ectopic->EditValue = HtmlEncode($this->Ectopic->AdvancedSearch->SearchValue);
			...
			if (REMOVE_XSS)
				$this->ERA->AdvancedSearch->SearchValue = HtmlDecode($this->ERA->AdvancedSearch->SearchValue);
			$this->ERA->EditValue = HtmlEncode($this->ERA->AdvancedSearch->SearchValue);
	...
	protected function validateSearch()
	{
		...
		if (!CheckDate($this->OPUDATE->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->OPUDATE->errorMessage());
		}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_template_for_etlist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_template_for_etlist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_template_for_etlist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_view_template_for_et\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_view_template_for_et',hdr:ew.language.phrase('ExportToEmailText'),f:document.fview_template_for_etlist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
