 ...
 * Page class
 */
class employee_attendance_edit extends employee_attendance
{
	...
	// Page object name
	public $PageObjName = "employee_attendance_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// in_time
			$this->in_time->setDbValueDef($rsnew, UnFormatDateTime($this->in_time->CurrentValue, 0), NULL, $this->in_time->ReadOnly);

			// out_time
			$this->out_time->setDbValueDef($rsnew, UnFormatDateTime($this->out_time->CurrentValue, 0), NULL, $this->out_time->ReadOnly);
