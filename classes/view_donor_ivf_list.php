 ...
 * Page class
 */
class view_donor_ivf_list extends view_donor_ivf
{
	...
	// Page object name
	public $PageObjName = "view_donor_ivf_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "view_donor_ivfadd.php?" . TABLE_SHOW_DETAIL . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "view_donor_ivfdelete.php";
		$this->MultiUpdateUrl = "view_donor_ivfupdate.php";
	...
	public function renderListOptions()
	{
		...
		// "detail_ivf_treatment_plan"
		$opt = &$this->ListOptions->Items["detail_ivf_treatment_plan"];
		if ($Security->allowList(CurrentProjectID() . 'ivf_treatment_plan')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ivf_treatment_planlist.php?" . TABLE_SHOW_MASTER . "=view_donor_ivf&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_Female=" . urlencode(strval($this->Female->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["ivf_treatment_plan_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'ivf_treatment_plan')) {
				$caption = $Language->phrase("MasterDetailViewLink");
				$url = $this->getViewUrl(TABLE_SHOW_DETAIL . "=ivf_treatment_plan");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailViewTblVar <> "")
					$detailViewTblVar .= ",";
				$detailViewTblVar .= "ivf_treatment_plan";
			}
			if ($GLOBALS["ivf_treatment_plan_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'ivf_treatment_plan')) {
				$caption = $Language->phrase("MasterDetailEditLink");
				$url = $this->getEditUrl(TABLE_SHOW_DETAIL . "=ivf_treatment_plan");
	...
	protected function setupOtherOptions()
	{
		...
		$url = $this->getAddUrl(TABLE_SHOW_DETAIL . "=ivf_treatment_plan");
		...
		$item->Visible = ($GLOBALS["ivf_treatment_plan"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ivf_treatment_plan') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink <> "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_donor_ivflistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_donor_ivflistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fview_donor_ivflist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_donor_ivflistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"view_donor_ivfsrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<button type=\"button\" class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_donor_ivf\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" onclick=\"ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'view_donor_ivfsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</button>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-highlight active\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fview_donor_ivflistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</button>";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages->Items["ivf_treatment_plan"]->Visible) {
			$link = "";
			$option = &$this->ListOptions->Items["detail_ivf_treatment_plan"];
			$url = "ivf_treatment_planpreview.php?t=view_donor_ivf&f=" . Encrypt($sqlwrk);
			...
			if ($Security->allowList(CurrentProjectID() . 'ivf_treatment_plan')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("ivf_treatment_planlist.php?" . TABLE_SHOW_MASTER . "=view_donor_ivf&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_Female=" . urlencode(strval($this->Female->CurrentValue)) . "");
				$btngrp .= "<button type=\"button\" class=\"btn btn-default\" title=\"" . $Language->TablePhrase("ivf_treatment_plan", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "'\">" . $Language->Phrase("MasterDetailListLink") . "</button>";
			}
			if (!isset($GLOBALS["ivf_treatment_plan_grid"]))
				$GLOBALS["ivf_treatment_plan_grid"] = new ivf_treatment_plan_grid();
			if ($GLOBALS["ivf_treatment_plan_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'ivf_treatment_plan')) {
	...
	protected function loadSearchValues()
	{
		...
		// WifeCell
		if (!$this->isAddOrEdit())
			$this->WifeCell->AdvancedSearch->setSearchValue(Get("x_WifeCell", Get("WifeCell", "")));
		if ($this->WifeCell->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->WifeCell->AdvancedSearch->setSearchOperator(Get("z_WifeCell", ""));

		// HusbandCell
		if (!$this->isAddOrEdit())
			$this->HusbandCell->AdvancedSearch->setSearchValue(Get("x_HusbandCell", Get("HusbandCell", "")));
		if ($this->HusbandCell->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->HusbandCell->AdvancedSearch->setSearchOperator(Get("z_HusbandCell", ""));

		// WifeEmail
		if (!$this->isAddOrEdit())
			$this->WifeEmail->AdvancedSearch->setSearchValue(Get("x_WifeEmail", Get("WifeEmail", "")));
		if ($this->WifeEmail->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->WifeEmail->AdvancedSearch->setSearchOperator(Get("z_WifeEmail", ""));

		// HusbandEmail
		if (!$this->isAddOrEdit())
			$this->HusbandEmail->AdvancedSearch->setSearchValue(Get("x_HusbandEmail", Get("HusbandEmail", "")));
		if ($this->HusbandEmail->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->HusbandEmail->AdvancedSearch->setSearchOperator(Get("z_HusbandEmail", ""));
		...
		// femalepic
		if (!$this->isAddOrEdit())
			$this->femalepic->AdvancedSearch->setSearchValue(Get("x_femalepic", Get("femalepic", "")));
		if ($this->femalepic->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->femalepic->AdvancedSearch->setSearchOperator(Get("z_femalepic", ""));

		// Fgender
		if (!$this->isAddOrEdit())
			$this->Fgender->AdvancedSearch->setSearchValue(Get("x_Fgender", Get("Fgender", "")));
		if ($this->Fgender->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Fgender->AdvancedSearch->setSearchOperator(Get("z_Fgender", ""));
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if ($this->malepropic->UseColorbox) {
				...
				$this->malepropic->LinkAttrs["data-rel"] = "view_donor_ivf_x" . $this->RowCnt . "_malepropic";
			...
			if ($this->femalepropic->UseColorbox) {
				...
				$this->femalepropic->LinkAttrs["data-rel"] = "view_donor_ivf_x" . $this->RowCnt . "_femalepropic";
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_donor_ivflist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_donor_ivflist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_donor_ivflist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
