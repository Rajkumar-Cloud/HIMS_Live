 ...
 * Page class
 */
class hr_courses_delete extends hr_courses
{
	...
	// Page object name
	public $PageObjName = "hr_courses_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("hr_courseslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hr_courseslist.php"); // Return to list
			}
		}
	}
