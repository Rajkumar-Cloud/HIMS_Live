 ...
 * Page class
 */
class view_pharmacy_gst_report_list extends view_pharmacy_gst_report
{
	...
	// Table name
	public $TableName = 'view_pharmacy_gst_report';

	// Page object name
	public $PageObjName = "view_pharmacy_gst_report_list";

	// Grid form hidden field names
	public $FormName = "fview_pharmacy_gst_reportlist";
	...
	public function __construct()
	{
		...
		// Table object (view_pharmacy_gst_report)
		if (!isset($GLOBALS["view_pharmacy_gst_report"]) || get_class($GLOBALS["view_pharmacy_gst_report"]) == PROJECT_NAMESPACE . "view_pharmacy_gst_report") {
			$GLOBALS["view_pharmacy_gst_report"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["view_pharmacy_gst_report"];
		}
		...
		$this->AddUrl = "view_pharmacy_gst_reportadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "view_pharmacy_gst_reportdelete.php";
		$this->MultiUpdateUrl = "view_pharmacy_gst_reportupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'view_pharmacy_gst_report');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fview_pharmacy_gst_reportlistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $view_pharmacy_gst_report;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($view_pharmacy_gst_report);
				$doc->Text = @$content;
	...
	public function run()
	{
		...
		$this->TaxableAmount->setVisibility();
		$this->SGST->setVisibility();
		$this->CGST->setVisibility();
		$this->RateOfTax->setVisibility();
	...
	public function getFilterList()
	{
		...
		if (SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fview_pharmacy_gst_reportlistsrch");
		...
		$filterList = Concat($filterList, $this->TaxableAmount->AdvancedSearch->toJson(), ","); // Field TaxableAmount
		$filterList = Concat($filterList, $this->SGST->AdvancedSearch->toJson(), ","); // Field SGST
		$filterList = Concat($filterList, $this->CGST->AdvancedSearch->toJson(), ","); // Field CGST
		$filterList = Concat($filterList, $this->RateOfTax->AdvancedSearch->toJson(), ","); // Field RateOfTax
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fview_pharmacy_gst_reportlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field TaxableAmount
		$this->TaxableAmount->AdvancedSearch->SearchValue = @$filter["x_TaxableAmount"];
		$this->TaxableAmount->AdvancedSearch->SearchOperator = @$filter["z_TaxableAmount"];
		$this->TaxableAmount->AdvancedSearch->SearchCondition = @$filter["v_TaxableAmount"];
		$this->TaxableAmount->AdvancedSearch->SearchValue2 = @$filter["y_TaxableAmount"];
		$this->TaxableAmount->AdvancedSearch->SearchOperator2 = @$filter["w_TaxableAmount"];
		$this->TaxableAmount->AdvancedSearch->save();

		// Field SGST
		$this->SGST->AdvancedSearch->SearchValue = @$filter["x_SGST"];
		$this->SGST->AdvancedSearch->SearchOperator = @$filter["z_SGST"];
		$this->SGST->AdvancedSearch->SearchCondition = @$filter["v_SGST"];
		$this->SGST->AdvancedSearch->SearchValue2 = @$filter["y_SGST"];
		$this->SGST->AdvancedSearch->SearchOperator2 = @$filter["w_SGST"];
		$this->SGST->AdvancedSearch->save();

		// Field CGST
		$this->CGST->AdvancedSearch->SearchValue = @$filter["x_CGST"];
		$this->CGST->AdvancedSearch->SearchOperator = @$filter["z_CGST"];
		$this->CGST->AdvancedSearch->SearchCondition = @$filter["v_CGST"];
		$this->CGST->AdvancedSearch->SearchValue2 = @$filter["y_CGST"];
		$this->CGST->AdvancedSearch->SearchOperator2 = @$filter["w_CGST"];
		$this->CGST->AdvancedSearch->save();

		// Field RateOfTax
		$this->RateOfTax->AdvancedSearch->SearchValue = @$filter["x_RateOfTax"];
		$this->RateOfTax->AdvancedSearch->SearchOperator = @$filter["z_RateOfTax"];
		$this->RateOfTax->AdvancedSearch->SearchCondition = @$filter["v_RateOfTax"];
		$this->RateOfTax->AdvancedSearch->SearchValue2 = @$filter["y_RateOfTax"];
		$this->RateOfTax->AdvancedSearch->SearchOperator2 = @$filter["w_RateOfTax"];
		$this->RateOfTax->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->TaxableAmount, $default, FALSE); // TaxableAmount
		$this->buildSearchSql($where, $this->SGST, $default, FALSE); // SGST
		$this->buildSearchSql($where, $this->CGST, $default, FALSE); // CGST
		$this->buildSearchSql($where, $this->RateOfTax, $default, FALSE); // RateOfTax
		...
		if (!$default && $this->Command == "search") {
			...
			$this->TaxableAmount->AdvancedSearch->save(); // TaxableAmount
			$this->SGST->AdvancedSearch->save(); // SGST
			$this->CGST->AdvancedSearch->save(); // CGST
			$this->RateOfTax->AdvancedSearch->save(); // RateOfTax
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->TaxableAmount, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->SGST, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->CGST, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->RateOfTax, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->Amount->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->TaxableAmount->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->SGST->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->CGST->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->RateOfTax->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->TaxableAmount->AdvancedSearch->unsetSession();
		$this->SGST->AdvancedSearch->unsetSession();
		$this->CGST->AdvancedSearch->unsetSession();
		$this->RateOfTax->AdvancedSearch->unsetSession();
	...
	protected function restoreSearchParms()
	{
		...
		$this->TaxableAmount->AdvancedSearch->load();
		$this->SGST->AdvancedSearch->load();
		$this->CGST->AdvancedSearch->load();
		$this->RateOfTax->AdvancedSearch->load();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->TaxableAmount); // TaxableAmount
			$this->updateSort($this->SGST); // SGST
			$this->updateSort($this->CGST); // CGST
			$this->updateSort($this->RateOfTax); // RateOfTax
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->QTY->setSort("");
				$this->Amount->setSort("");
				$this->TaxableAmount->setSort("");
				$this->SGST->setSort("");
				$this->CGST->setSort("");
				$this->RateOfTax->setSort("");
				$this->Total->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_pharmacy_gst_reportlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_pharmacy_gst_reportlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fview_pharmacy_gst_reportlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_pharmacy_gst_reportlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function loadSearchValues()
	{
		...
		// TaxableAmount
		if (!$this->isAddOrEdit())
			$this->TaxableAmount->AdvancedSearch->setSearchValue(Get("x_TaxableAmount", Get("TaxableAmount", "")));
		if ($this->TaxableAmount->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TaxableAmount->AdvancedSearch->setSearchOperator(Get("z_TaxableAmount", ""));

		// SGST
		if (!$this->isAddOrEdit())
			$this->SGST->AdvancedSearch->setSearchValue(Get("x_SGST", Get("SGST", "")));
		if ($this->SGST->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->SGST->AdvancedSearch->setSearchOperator(Get("z_SGST", ""));

		// CGST
		if (!$this->isAddOrEdit())
			$this->CGST->AdvancedSearch->setSearchValue(Get("x_CGST", Get("CGST", "")));
		if ($this->CGST->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->CGST->AdvancedSearch->setSearchOperator(Get("z_CGST", ""));

		// RateOfTax
		if (!$this->isAddOrEdit())
			$this->RateOfTax->AdvancedSearch->setSearchValue(Get("x_RateOfTax", Get("RateOfTax", "")));
		if ($this->RateOfTax->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->RateOfTax->AdvancedSearch->setSearchOperator(Get("z_RateOfTax", ""));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (REMOVE_XSS)
				$this->TaxableAmount->AdvancedSearch->SearchValue = HtmlDecode($this->TaxableAmount->AdvancedSearch->SearchValue);
			$this->TaxableAmount->EditValue = HtmlEncode($this->TaxableAmount->AdvancedSearch->SearchValue);
			...
			if (REMOVE_XSS)
				$this->SGST->AdvancedSearch->SearchValue = HtmlDecode($this->SGST->AdvancedSearch->SearchValue);
			$this->SGST->EditValue = HtmlEncode($this->SGST->AdvancedSearch->SearchValue);
			...
			if (REMOVE_XSS)
				$this->CGST->AdvancedSearch->SearchValue = HtmlDecode($this->CGST->AdvancedSearch->SearchValue);
			$this->CGST->EditValue = HtmlEncode($this->CGST->AdvancedSearch->SearchValue);
			...
			if (REMOVE_XSS)
				$this->RateOfTax->AdvancedSearch->SearchValue = HtmlDecode($this->RateOfTax->AdvancedSearch->SearchValue);
			$this->RateOfTax->EditValue = HtmlEncode($this->RateOfTax->AdvancedSearch->SearchValue);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_pharmacy_gst_reportlist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_pharmacy_gst_reportlist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_pharmacy_gst_reportlist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_view_pharmacy_gst_report\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_view_pharmacy_gst_report',hdr:ew.language.phrase('ExportToEmailText'),f:document.fview_pharmacy_gst_reportlist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
