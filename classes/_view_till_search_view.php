...
class _view_till_search_view extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('_view_till_search_view', 'view_till_search_view', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DepositDate
		$this->DepositDate = new DbField('_view_till_search_view', 'view_till_search_view', 'x_DepositDate', 'DepositDate', '`DepositDate`', CastDateFieldForLike('`DepositDate`', 7, "DB"), 135, 7, FALSE, '`DepositDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepositToBankSelect
		$this->DepositToBankSelect = new DbField('_view_till_search_view', 'view_till_search_view', 'x_DepositToBankSelect', 'DepositToBankSelect', '`DepositToBankSelect`', '`DepositToBankSelect`', 200, -1, FALSE, '`DepositToBankSelect`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DepositToBankSelect->Sortable = TRUE; // Allow sort
		$this->fields['DepositToBankSelect'] = &$this->DepositToBankSelect;

		// DepositToBank
		$this->DepositToBank = new DbField('_view_till_search_view', 'view_till_search_view', 'x_DepositToBank', 'DepositToBank', '`DepositToBank`', '`DepositToBank`', 200, -1, FALSE, '`DepositToBank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DepositToBank->Sortable = TRUE; // Allow sort
		$this->fields['DepositToBank'] = &$this->DepositToBank;

		// CreatedUserName
		$this->CreatedUserName = new DbField('_view_till_search_view', 'view_till_search_view', 'x_CreatedUserName', 'CreatedUserName', '`CreatedUserName`', '`CreatedUserName`', 200, -1, FALSE, '`CreatedUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedUserName->Sortable = TRUE; // Allow sort
		$this->fields['CreatedUserName'] = &$this->CreatedUserName;

		// TransferToSelect
		$this->TransferToSelect = new DbField('_view_till_search_view', 'view_till_search_view', 'x_TransferToSelect', 'TransferToSelect', '`TransferToSelect`', '`TransferToSelect`', 200, -1, FALSE, '`TransferToSelect`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TransferToSelect->Sortable = TRUE; // Allow sort
		$this->fields['TransferToSelect'] = &$this->TransferToSelect;

		// TransferTo
		$this->TransferTo = new DbField('_view_till_search_view', 'view_till_search_view', 'x_TransferTo', 'TransferTo', '`TransferTo`', '`TransferTo`', 200, -1, FALSE, '`TransferTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TransferTo->Sortable = TRUE; // Allow sort
		$this->fields['TransferTo'] = &$this->TransferTo;

		// OpeningBalance
		$this->OpeningBalance = new DbField('_view_till_search_view', 'view_till_search_view', 'x_OpeningBalance', 'OpeningBalance', '`OpeningBalance`', '`OpeningBalance`', 131, -1, FALSE, '`OpeningBalance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CashCollected
		$this->CashCollected = new DbField('_view_till_search_view', 'view_till_search_view', 'x_CashCollected', 'CashCollected', '`CashCollected`', '`CashCollected`', 131, -1, FALSE, '`CashCollected`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A2000Count
		$this->A2000Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A2000Count', 'A2000Count', '`A2000Count`', '`A2000Count`', 3, -1, FALSE, '`A2000Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A2000Amount
		$this->A2000Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A2000Amount', 'A2000Amount', '`A2000Amount`', '`A2000Amount`', 131, -1, FALSE, '`A2000Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A1000Count
		$this->A1000Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A1000Count', 'A1000Count', '`A1000Count`', '`A1000Count`', 3, -1, FALSE, '`A1000Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A1000Amount
		$this->A1000Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A1000Amount', 'A1000Amount', '`A1000Amount`', '`A1000Amount`', 131, -1, FALSE, '`A1000Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A500Count
		$this->A500Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A500Count', 'A500Count', '`A500Count`', '`A500Count`', 3, -1, FALSE, '`A500Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A500Amount
		$this->A500Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A500Amount', 'A500Amount', '`A500Amount`', '`A500Amount`', 131, -1, FALSE, '`A500Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A200Count
		$this->A200Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A200Count', 'A200Count', '`A200Count`', '`A200Count`', 3, -1, FALSE, '`A200Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A200Amount
		$this->A200Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A200Amount', 'A200Amount', '`A200Amount`', '`A200Amount`', 131, -1, FALSE, '`A200Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A100Count
		$this->A100Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A100Count', 'A100Count', '`A100Count`', '`A100Count`', 3, -1, FALSE, '`A100Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A100Amount
		$this->A100Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A100Amount', 'A100Amount', '`A100Amount`', '`A100Amount`', 131, -1, FALSE, '`A100Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A50Count
		$this->A50Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A50Count', 'A50Count', '`A50Count`', '`A50Count`', 3, -1, FALSE, '`A50Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A50Amount
		$this->A50Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A50Amount', 'A50Amount', '`A50Amount`', '`A50Amount`', 131, -1, FALSE, '`A50Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A20Count
		$this->A20Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A20Count', 'A20Count', '`A20Count`', '`A20Count`', 3, -1, FALSE, '`A20Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A20Amount
		$this->A20Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A20Amount', 'A20Amount', '`A20Amount`', '`A20Amount`', 131, -1, FALSE, '`A20Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A10Count
		$this->A10Count = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A10Count', 'A10Count', '`A10Count`', '`A10Count`', 3, -1, FALSE, '`A10Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A10Amount
		$this->A10Amount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_A10Amount', 'A10Amount', '`A10Amount`', '`A10Amount`', 131, -1, FALSE, '`A10Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TotalCash
		$this->TotalCash = new DbField('_view_till_search_view', 'view_till_search_view', 'x_TotalCash', 'TotalCash', '`TotalCash`', '`TotalCash`', 131, -1, FALSE, '`TotalCash`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Cheque
		$this->Cheque = new DbField('_view_till_search_view', 'view_till_search_view', 'x_Cheque', 'Cheque', '`Cheque`', '`Cheque`', 131, -1, FALSE, '`Cheque`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Card
		$this->Card = new DbField('_view_till_search_view', 'view_till_search_view', 'x_Card', 'Card', '`Card`', '`Card`', 131, -1, FALSE, '`Card`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Card->Sortable = TRUE; // Allow sort
		$this->Card->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Card'] = &$this->Card;

		// RTGS
		$this->RTGS = new DbField('_view_till_search_view', 'view_till_search_view', 'x_RTGS', 'RTGS', '`RTGS`', '`RTGS`', 131, -1, FALSE, '`RTGS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RTGS->Sortable = TRUE; // Allow sort
		$this->RTGS->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RTGS'] = &$this->RTGS;

		// NEFTRTGS
		$this->NEFTRTGS = new DbField('_view_till_search_view', 'view_till_search_view', 'x_NEFTRTGS', 'NEFTRTGS', '`NEFTRTGS`', '`NEFTRTGS`', 131, -1, FALSE, '`NEFTRTGS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PAYTM
		$this->PAYTM = new DbField('_view_till_search_view', 'view_till_search_view', 'x_PAYTM', 'PAYTM', '`PAYTM`', '`PAYTM`', 131, -1, FALSE, '`PAYTM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Other
		$this->Other = new DbField('_view_till_search_view', 'view_till_search_view', 'x_Other', 'Other', '`Other`', '`Other`', 131, -1, FALSE, '`Other`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->TotalTransferDepositAmount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_TotalTransferDepositAmount', 'TotalTransferDepositAmount', '`TotalTransferDepositAmount`', '`TotalTransferDepositAmount`', 131, -1, FALSE, '`TotalTransferDepositAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new DbField('_view_till_search_view', 'view_till_search_view', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->CreatedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('_view_till_search_view', 'view_till_search_view', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 7, "DB"), 135, 7, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ModifiedBy
		$this->ModifiedBy = new DbField('_view_till_search_view', 'view_till_search_view', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->ModifiedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('_view_till_search_view', 'view_till_search_view', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike('`ModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedDateTime->Sortable = TRUE; // Allow sort
		$this->ModifiedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['ModifiedDateTime'] = &$this->ModifiedDateTime;

		// ModifiedUserName
		$this->ModifiedUserName = new DbField('_view_till_search_view', 'view_till_search_view', 'x_ModifiedUserName', 'ModifiedUserName', '`ModifiedUserName`', '`ModifiedUserName`', 200, -1, FALSE, '`ModifiedUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedUserName->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedUserName'] = &$this->ModifiedUserName;

		// BalanceAmount
		$this->BalanceAmount = new DbField('_view_till_search_view', 'view_till_search_view', 'x_BalanceAmount', 'BalanceAmount', '`BalanceAmount`', '`BalanceAmount`', 131, -1, FALSE, '`BalanceAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('_view_till_search_view', 'view_till_search_view', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("_view_till_search_viewview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
