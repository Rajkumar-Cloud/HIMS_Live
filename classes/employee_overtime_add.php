 ...
 * Page class
 */
class employee_overtime_add extends employee_overtime
{
	...
	// Page object name
	public $PageObjName = "employee_overtime_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "employee_overtimeview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// start_time
		$this->start_time->setDbValueDef($rsnew, UnFormatDateTime($this->start_time->CurrentValue, 0), NULL, FALSE);

		// end_time
		$this->end_time->setDbValueDef($rsnew, UnFormatDateTime($this->end_time->CurrentValue, 0), NULL, FALSE);
