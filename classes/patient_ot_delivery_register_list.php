 ...
 * Page class
 */
class patient_ot_delivery_register_list extends patient_ot_delivery_register
{
	...
	// Page object name
	public $PageObjName = "patient_ot_delivery_register_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_ot_delivery_registeradd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "patient_ot_delivery_registerdelete.php";
		$this->MultiUpdateUrl = "patient_ot_delivery_registerupdate.php";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_ot_delivery_registerlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_ot_delivery_registerlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fpatient_ot_delivery_registerlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_ot_delivery_registerlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function loadSearchValues()
	{
		...
		if (!$this->isAddOrEdit())
			$this->ObstetricsHistryMale->AdvancedSearch->setSearchValue(Get("x_ObstetricsHistryMale", Get("ObstetricsHistryMale", "")));
		if ($this->ObstetricsHistryMale->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ObstetricsHistryMale->AdvancedSearch->setSearchOperator(Get("z_ObstetricsHistryMale", ""));

		// ObstetricsHistryFeMale
		if (!$this->isAddOrEdit())
			$this->ObstetricsHistryFeMale->AdvancedSearch->setSearchValue(Get("x_ObstetricsHistryFeMale", Get("ObstetricsHistryFeMale", "")));
		if ($this->ObstetricsHistryFeMale->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ObstetricsHistryFeMale->AdvancedSearch->setSearchOperator(Get("z_ObstetricsHistryFeMale", ""));

		// Abortion
		if (!$this->isAddOrEdit())
			$this->Abortion->AdvancedSearch->setSearchValue(Get("x_Abortion", Get("Abortion", "")));
		if ($this->Abortion->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Abortion->AdvancedSearch->setSearchOperator(Get("z_Abortion", ""));

		// ChildBirthDate
		if (!$this->isAddOrEdit())
			$this->ChildBirthDate->AdvancedSearch->setSearchValue(Get("x_ChildBirthDate", Get("ChildBirthDate", "")));
		if ($this->ChildBirthDate->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildBirthDate->AdvancedSearch->setSearchOperator(Get("z_ChildBirthDate", ""));

		// ChildBirthTime
		if (!$this->isAddOrEdit())
			$this->ChildBirthTime->AdvancedSearch->setSearchValue(Get("x_ChildBirthTime", Get("ChildBirthTime", "")));
		if ($this->ChildBirthTime->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildBirthTime->AdvancedSearch->setSearchOperator(Get("z_ChildBirthTime", ""));

		// ChildSex
		if (!$this->isAddOrEdit())
			$this->ChildSex->AdvancedSearch->setSearchValue(Get("x_ChildSex", Get("ChildSex", "")));
		if ($this->ChildSex->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildSex->AdvancedSearch->setSearchOperator(Get("z_ChildSex", ""));

		// ChildWt
		if (!$this->isAddOrEdit())
			$this->ChildWt->AdvancedSearch->setSearchValue(Get("x_ChildWt", Get("ChildWt", "")));
		if ($this->ChildWt->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildWt->AdvancedSearch->setSearchOperator(Get("z_ChildWt", ""));

		// ChildDay
		if (!$this->isAddOrEdit())
			$this->ChildDay->AdvancedSearch->setSearchValue(Get("x_ChildDay", Get("ChildDay", "")));
		if ($this->ChildDay->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildDay->AdvancedSearch->setSearchOperator(Get("z_ChildDay", ""));

		// ChildOE
		if (!$this->isAddOrEdit())
			$this->ChildOE->AdvancedSearch->setSearchValue(Get("x_ChildOE", Get("ChildOE", "")));
		if ($this->ChildOE->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildOE->AdvancedSearch->setSearchOperator(Get("z_ChildOE", ""));

		// TypeofDelivery
		if (!$this->isAddOrEdit())
			$this->TypeofDelivery->AdvancedSearch->setSearchValue(Get("x_TypeofDelivery", Get("TypeofDelivery", "")));
		if ($this->TypeofDelivery->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TypeofDelivery->AdvancedSearch->setSearchOperator(Get("z_TypeofDelivery", ""));

		// ChildBlGrp
		if (!$this->isAddOrEdit())
			$this->ChildBlGrp->AdvancedSearch->setSearchValue(Get("x_ChildBlGrp", Get("ChildBlGrp", "")));
		if ($this->ChildBlGrp->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildBlGrp->AdvancedSearch->setSearchOperator(Get("z_ChildBlGrp", ""));

		// ApgarScore
		if (!$this->isAddOrEdit())
			$this->ApgarScore->AdvancedSearch->setSearchValue(Get("x_ApgarScore", Get("ApgarScore", "")));
		if ($this->ApgarScore->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ApgarScore->AdvancedSearch->setSearchOperator(Get("z_ApgarScore", ""));

		// birthnotification
		if (!$this->isAddOrEdit())
			$this->birthnotification->AdvancedSearch->setSearchValue(Get("x_birthnotification", Get("birthnotification", "")));
		if ($this->birthnotification->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->birthnotification->AdvancedSearch->setSearchOperator(Get("z_birthnotification", ""));

		// formno
		if (!$this->isAddOrEdit())
			$this->formno->AdvancedSearch->setSearchValue(Get("x_formno", Get("formno", "")));
		if ($this->formno->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->formno->AdvancedSearch->setSearchOperator(Get("z_formno", ""));

		// dte
		if (!$this->isAddOrEdit())
			$this->dte->AdvancedSearch->setSearchValue(Get("x_dte", Get("dte", "")));
		if ($this->dte->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->dte->AdvancedSearch->setSearchOperator(Get("z_dte", ""));
		$this->dte->AdvancedSearch->setSearchCondition(Get("v_dte", ""));
		$this->dte->AdvancedSearch->setSearchValue2(Get("y_dte", ""));
		if ($this->dte->AdvancedSearch->SearchValue2 <> "" && $this->Command == "")
			$this->Command = "search";
		$this->dte->AdvancedSearch->setSearchOperator2(Get("w_dte", ""));

		// motherReligion
		if (!$this->isAddOrEdit())
			$this->motherReligion->AdvancedSearch->setSearchValue(Get("x_motherReligion", Get("motherReligion", "")));
		if ($this->motherReligion->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->motherReligion->AdvancedSearch->setSearchOperator(Get("z_motherReligion", ""));

		// bloodgroup
		if (!$this->isAddOrEdit())
			$this->bloodgroup->AdvancedSearch->setSearchValue(Get("x_bloodgroup", Get("bloodgroup", "")));
		if ($this->bloodgroup->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->bloodgroup->AdvancedSearch->setSearchOperator(Get("z_bloodgroup", ""));
		...
		// ChildBirthDate1
		if (!$this->isAddOrEdit())
			$this->ChildBirthDate1->AdvancedSearch->setSearchValue(Get("x_ChildBirthDate1", Get("ChildBirthDate1", "")));
		if ($this->ChildBirthDate1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildBirthDate1->AdvancedSearch->setSearchOperator(Get("z_ChildBirthDate1", ""));

		// ChildBirthTime1
		if (!$this->isAddOrEdit())
			$this->ChildBirthTime1->AdvancedSearch->setSearchValue(Get("x_ChildBirthTime1", Get("ChildBirthTime1", "")));
		if ($this->ChildBirthTime1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildBirthTime1->AdvancedSearch->setSearchOperator(Get("z_ChildBirthTime1", ""));

		// ChildSex1
		if (!$this->isAddOrEdit())
			$this->ChildSex1->AdvancedSearch->setSearchValue(Get("x_ChildSex1", Get("ChildSex1", "")));
		if ($this->ChildSex1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildSex1->AdvancedSearch->setSearchOperator(Get("z_ChildSex1", ""));

		// ChildWt1
		if (!$this->isAddOrEdit())
			$this->ChildWt1->AdvancedSearch->setSearchValue(Get("x_ChildWt1", Get("ChildWt1", "")));
		if ($this->ChildWt1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildWt1->AdvancedSearch->setSearchOperator(Get("z_ChildWt1", ""));

		// ChildDay1
		if (!$this->isAddOrEdit())
			$this->ChildDay1->AdvancedSearch->setSearchValue(Get("x_ChildDay1", Get("ChildDay1", "")));
		if ($this->ChildDay1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildDay1->AdvancedSearch->setSearchOperator(Get("z_ChildDay1", ""));

		// ChildOE1
		if (!$this->isAddOrEdit())
			$this->ChildOE1->AdvancedSearch->setSearchValue(Get("x_ChildOE1", Get("ChildOE1", "")));
		if ($this->ChildOE1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildOE1->AdvancedSearch->setSearchOperator(Get("z_ChildOE1", ""));

		// TypeofDelivery1
		if (!$this->isAddOrEdit())
			$this->TypeofDelivery1->AdvancedSearch->setSearchValue(Get("x_TypeofDelivery1", Get("TypeofDelivery1", "")));
		if ($this->TypeofDelivery1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TypeofDelivery1->AdvancedSearch->setSearchOperator(Get("z_TypeofDelivery1", ""));

		// ChildBlGrp1
		if (!$this->isAddOrEdit())
			$this->ChildBlGrp1->AdvancedSearch->setSearchValue(Get("x_ChildBlGrp1", Get("ChildBlGrp1", "")));
		if ($this->ChildBlGrp1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ChildBlGrp1->AdvancedSearch->setSearchOperator(Get("z_ChildBlGrp1", ""));

		// ApgarScore1
		if (!$this->isAddOrEdit())
			$this->ApgarScore1->AdvancedSearch->setSearchValue(Get("x_ApgarScore1", Get("ApgarScore1", "")));
		if ($this->ApgarScore1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ApgarScore1->AdvancedSearch->setSearchOperator(Get("z_ApgarScore1", ""));

		// birthnotification1
		if (!$this->isAddOrEdit())
			$this->birthnotification1->AdvancedSearch->setSearchValue(Get("x_birthnotification1", Get("birthnotification1", "")));
		if ($this->birthnotification1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->birthnotification1->AdvancedSearch->setSearchOperator(Get("z_birthnotification1", ""));

		// formno1
		if (!$this->isAddOrEdit())
			$this->formno1->AdvancedSearch->setSearchValue(Get("x_formno1", Get("formno1", "")));
		if ($this->formno1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->formno1->AdvancedSearch->setSearchOperator(Get("z_formno1", ""));
		...
		// DrVisit1
		if (!$this->isAddOrEdit())
			$this->DrVisit1->AdvancedSearch->setSearchValue(Get("x_DrVisit1", Get("DrVisit1", "")));
		if ($this->DrVisit1->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DrVisit1->AdvancedSearch->setSearchOperator(Get("z_DrVisit1", ""));

		// DrVisit2
		if (!$this->isAddOrEdit())
			$this->DrVisit2->AdvancedSearch->setSearchValue(Get("x_DrVisit2", Get("DrVisit2", "")));
		if ($this->DrVisit2->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DrVisit2->AdvancedSearch->setSearchOperator(Get("z_DrVisit2", ""));

		// DrVisit3
		if (!$this->isAddOrEdit())
			$this->DrVisit3->AdvancedSearch->setSearchValue(Get("x_DrVisit3", Get("DrVisit3", "")));
		if ($this->DrVisit3->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DrVisit3->AdvancedSearch->setSearchOperator(Get("z_DrVisit3", ""));

		// DrVisit4
		if (!$this->isAddOrEdit())
			$this->DrVisit4->AdvancedSearch->setSearchValue(Get("x_DrVisit4", Get("DrVisit4", "")));
		if ($this->DrVisit4->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DrVisit4->AdvancedSearch->setSearchOperator(Get("z_DrVisit4", ""));
	...
	protected function validateSearch()
	{
		...
		if (!CheckDate($this->dte->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->dte->errorMessage());
		}
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fpatient_ot_delivery_registerlist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fpatient_ot_delivery_registerlist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fpatient_ot_delivery_registerlist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
