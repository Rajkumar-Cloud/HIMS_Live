 ...
 * Page class
 */
class view_vitals_history_add extends view_vitals_history
{
	...
	// Page object name
	public $PageObjName = "view_vitals_history_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "view_vitals_historyview.php")
