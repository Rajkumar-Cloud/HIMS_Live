 ...
 * Page class
 */
class recruitment_interviews_edit extends recruitment_interviews
{
	...
	// Page object name
	public $PageObjName = "recruitment_interviews_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("recruitment_interviewslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "recruitment_interviewslist.php")
	...
	protected function validateForm()
	{
		...
		if ($this->mapId->Required) {
			if (!$this->mapId->IsDetailKey && $this->mapId->FormValue != NULL && $this->mapId->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->mapId->caption(), $this->mapId->RequiredErrorMessage));
			}
		}
		if (!CheckInteger($this->mapId->FormValue)) {
			AddMessage($FormError, $this->mapId->errorMessage());
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// mapId
			$this->mapId->setDbValueDef($rsnew, $this->mapId->CurrentValue, NULL, $this->mapId->ReadOnly);
