...
class hospital extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('hospital', 'hospital', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// logo
		$this->logo = new DbField('hospital', 'hospital', 'x_logo', 'logo', '`logo`', '`logo`', 201, -1, TRUE, '`logo`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->logo->Sortable = TRUE; // Allow sort
		$this->fields['logo'] = &$this->logo;

		// hospital
		$this->hospital = new DbField('hospital', 'hospital', 'x_hospital', 'hospital', '`hospital`', '`hospital`', 200, -1, FALSE, '`hospital`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// street
		$this->street = new DbField('hospital', 'hospital', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// area
		$this->area = new DbField('hospital', 'hospital', 'x_area', 'area', '`area`', '`area`', 200, -1, FALSE, '`area`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->area->Sortable = TRUE; // Allow sort
		$this->fields['area'] = &$this->area;

		// town
		$this->town = new DbField('hospital', 'hospital', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// province
		$this->province = new DbField('hospital', 'hospital', 'x_province', 'province', '`province`', '`province`', 200, -1, FALSE, '`province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->province->Sortable = TRUE; // Allow sort
		$this->fields['province'] = &$this->province;

		// postal_code
		$this->postal_code = new DbField('hospital', 'hospital', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, -1, FALSE, '`postal_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->postal_code->Sortable = TRUE; // Allow sort
		$this->fields['postal_code'] = &$this->postal_code;

		// phone_no
		$this->phone_no = new DbField('hospital', 'hospital', 'x_phone_no', 'phone_no', '`phone_no`', '`phone_no`', 200, -1, FALSE, '`phone_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone_no->Sortable = TRUE; // Allow sort
		$this->fields['phone_no'] = &$this->phone_no;

		// status
		$this->status = new DbField('hospital', 'hospital', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('hospital', 'hospital', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = FALSE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('hospital', 'hospital', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = FALSE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('hospital', 'hospital', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = FALSE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('hospital', 'hospital', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = FALSE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// PreFixCode
		$this->PreFixCode = new DbField('hospital', 'hospital', 'x_PreFixCode', 'PreFixCode', '`PreFixCode`', '`PreFixCode`', 200, -1, FALSE, '`PreFixCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PreFixCode->Sortable = TRUE; // Allow sort
		$this->fields['PreFixCode'] = &$this->PreFixCode;

		// BillingGST
		$this->BillingGST = new DbField('hospital', 'hospital', 'x_BillingGST', 'BillingGST', '`BillingGST`', '`BillingGST`', 200, -1, FALSE, '`BillingGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillingGST->Sortable = TRUE; // Allow sort
		$this->fields['BillingGST'] = &$this->BillingGST;

		// pharmacyGST
		$this->pharmacyGST = new DbField('hospital', 'hospital', 'x_pharmacyGST', 'pharmacyGST', '`pharmacyGST`', '`pharmacyGST`', 200, -1, FALSE, '`pharmacyGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pharmacyGST->Sortable = TRUE; // Allow sort
		$this->fields['pharmacyGST'] = &$this->pharmacyGST;

		// Country
		$this->Country = new DbField('hospital', 'hospital', 'x_Country', 'Country', '`Country`', '`Country`', 200, -1, FALSE, '`Country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("hospitalview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
