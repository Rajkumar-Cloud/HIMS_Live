 ...
 * Page class
 */
class ivf_agency_add extends ivf_agency
{
	...
	// Page object name
	public $PageObjName = "ivf_agency_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ivf_agencylist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "ivf_agencylist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "ivf_agencyview.php")
	...
	protected function validateForm()
	{
		...
		if ($this->Pin->Required) {
			if (!$this->Pin->IsDetailKey && $this->Pin->FormValue != NULL && $this->Pin->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->Pin->caption(), $this->Pin->RequiredErrorMessage));
			}
		}
