 ...
 * Page class
 */
class hr_expensespaymentmethods_add extends hr_expensespaymentmethods
{
	...
	// Page object name
	public $PageObjName = "hr_expensespaymentmethods_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("hr_expensespaymentmethodslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "hr_expensespaymentmethodslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "hr_expensespaymentmethodsview.php")
