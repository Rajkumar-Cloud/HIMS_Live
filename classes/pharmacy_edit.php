 ...
 * Page class
 */
class pharmacy_edit extends pharmacy
{
	...
	// Page object name
	public $PageObjName = "pharmacy_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("pharmacy_services", $detailTblVar) && $GLOBALS["pharmacy_services"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("pharmacy_services", $detailTblVar) && $GLOBALS["pharmacy_services"]->DetailEdit) {
						...
						$editRow = $GLOBALS["pharmacy_services_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("pharmacy_services", $detailTblVar)) {
				...
				if ($GLOBALS["pharmacy_services_grid"]->DetailEdit) {
					$GLOBALS["pharmacy_services_grid"]->CurrentMode = "edit";
					$GLOBALS["pharmacy_services_grid"]->CurrentAction = "gridedit";
