...
class pres_tradenames extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('pres_tradenames', 'pres_tradenames', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// GENERIC_NAMES
		$this->GENERIC_NAMES = new DbField('pres_tradenames', 'pres_tradenames', 'x_GENERIC_NAMES', 'GENERIC_NAMES', '`GENERIC_NAMES`', '`GENERIC_NAMES`', 201, -1, FALSE, '`GENERIC_NAMES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->GENERIC_NAMES->Sortable = TRUE; // Allow sort
		$this->fields['GENERIC_NAMES'] = &$this->GENERIC_NAMES;

		// TRADE_NAME
		$this->TRADE_NAME = new DbField('pres_tradenames', 'pres_tradenames', 'x_TRADE_NAME', 'TRADE_NAME', '`TRADE_NAME`', '`TRADE_NAME`', 201, -1, FALSE, '`TRADE_NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->TRADE_NAME->Sortable = TRUE; // Allow sort
		$this->fields['TRADE_NAME'] = &$this->TRADE_NAME;

		// Drug_Name
		$this->Drug_Name = new DbField('pres_tradenames', 'pres_tradenames', 'x_Drug_Name', 'Drug_Name', '`Drug_Name`', '`Drug_Name`', 201, -1, FALSE, '`Drug_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Drug_Name->Sortable = TRUE; // Allow sort
		$this->fields['Drug_Name'] = &$this->Drug_Name;

		// PR_CODE
		$this->PR_CODE = new DbField('pres_tradenames', 'pres_tradenames', 'x_PR_CODE', 'PR_CODE', '`PR_CODE`', '`PR_CODE`', 200, -1, FALSE, '`PR_CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PR_CODE->Sortable = TRUE; // Allow sort
		$this->fields['PR_CODE'] = &$this->PR_CODE;

		// GenericNames_symbols
		$this->GenericNames_symbols = new DbField('pres_tradenames', 'pres_tradenames', 'x_GenericNames_symbols', 'GenericNames_symbols', '`GenericNames_symbols`', '`GenericNames_symbols`', 201, -1, FALSE, '`GenericNames_symbols`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->GenericNames_symbols->Sortable = TRUE; // Allow sort
		$this->fields['GenericNames_symbols'] = &$this->GenericNames_symbols;

		// CONTAINER_TYPE
		$this->CONTAINER_TYPE = new DbField('pres_tradenames', 'pres_tradenames', 'x_CONTAINER_TYPE', 'CONTAINER_TYPE', '`CONTAINER_TYPE`', '`CONTAINER_TYPE`', 200, -1, FALSE, '`CONTAINER_TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CONTAINER_TYPE->Sortable = TRUE; // Allow sort
		$this->fields['CONTAINER_TYPE'] = &$this->CONTAINER_TYPE;

		// STRENGTH
		$this->STRENGTH = new DbField('pres_tradenames', 'pres_tradenames', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 200, -1, FALSE, '`STRENGTH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pres_tradenamesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
