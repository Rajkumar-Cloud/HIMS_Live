 ...
 * Page class
 */
class recruitment_applications_edit extends recruitment_applications
{
	...
	// Page object name
	public $PageObjName = "recruitment_applications_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// job
			$this->job->setDbValueDef($rsnew, $this->job->CurrentValue, 0, $this->job->ReadOnly);

			// candidate
			$this->candidate->setDbValueDef($rsnew, $this->candidate->CurrentValue, NULL, $this->candidate->ReadOnly);

			// created
			$this->created->setDbValueDef($rsnew, UnFormatDateTime($this->created->CurrentValue, 0), NULL, $this->created->ReadOnly);

			// referredByEmail
			$this->referredByEmail->setDbValueDef($rsnew, $this->referredByEmail->CurrentValue, NULL, $this->referredByEmail->ReadOnly);
