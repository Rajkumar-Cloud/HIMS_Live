 ...
 * Page class
 */
class appointment_scheduler_view extends appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "appointment_scheduler_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "appointment_schedulerlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "appointment_schedulerlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "appointment_schedulerlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
