...
class patient_document extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient_document', 'patient_document', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// patient_id
		$this->patient_id = new DbField('patient_document', 'patient_document', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, -1, FALSE, '`patient_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DocumentName
		$this->DocumentName = new DbField('patient_document', 'patient_document', 'x_DocumentName', 'DocumentName', '`DocumentName`', '`DocumentName`', 3, -1, FALSE, '`DocumentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DocumentUpload
		$this->DocumentUpload = new DbField('patient_document', 'patient_document', 'x_DocumentUpload', 'DocumentUpload', '`DocumentUpload`', '`DocumentUpload`', 201, -1, TRUE, '`DocumentUpload`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// status
		$this->status = new DbField('patient_document', 'patient_document', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('patient_document', 'patient_document', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('patient_document', 'patient_document', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('patient_document', 'patient_document', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('patient_document', 'patient_document', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// DocumentNumber
		$this->DocumentNumber = new DbField('patient_document', 'patient_document', 'x_DocumentNumber', 'DocumentNumber', '`DocumentNumber`', '`DocumentNumber`', 200, -1, FALSE, '`DocumentNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patient_documentview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
