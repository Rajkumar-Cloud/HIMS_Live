 ...
 */
class store_billing_transfer extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// transfer
		$this->transfer = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_transfer', 'transfer', '`transfer`', '`transfer`', 3, -1, FALSE, '`transfer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// pharmacy
		$this->pharmacy = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_pharmacy', 'pharmacy', '`pharmacy`', '`pharmacy`', 200, -1, FALSE, '`pharmacy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pharmacy->Required = TRUE; // Required field
		$this->pharmacy->Sortable = TRUE; // Allow sort
		$this->fields['pharmacy'] = &$this->pharmacy;

		// street
		$this->street = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_street', 'street', '`street`', '`street`', 201, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->street->Sortable = TRUE; // Allow sort
		$this->fields['street'] = &$this->street;

		// area
		$this->area = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_area', 'area', '`area`', '`area`', 201, -1, FALSE, '`area`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->area->Sortable = TRUE; // Allow sort
		$this->fields['area'] = &$this->area;

		// town
		$this->town = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_town', 'town', '`town`', '`town`', 201, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// province
		$this->province = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_province', 'province', '`province`', '`province`', 200, -1, FALSE, '`province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->province->Sortable = TRUE; // Allow sort
		$this->fields['province'] = &$this->province;

		// postal_code
		$this->postal_code = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, -1, FALSE, '`postal_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->postal_code->Sortable = TRUE; // Allow sort
		$this->fields['postal_code'] = &$this->postal_code;

		// phone_no
		$this->phone_no = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_phone_no', 'phone_no', '`phone_no`', '`phone_no`', 200, -1, FALSE, '`phone_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone_no->Sortable = TRUE; // Allow sort
		$this->fields['phone_no'] = &$this->phone_no;

		// Details
		$this->Details = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_Details', 'Details', '`Details`', '`Details`', 200, -1, FALSE, '`Details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Details->Sortable = TRUE; // Allow sort
		$this->fields['Details'] = &$this->Details;

		// createdby
		$this->createdby = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// HospID
		$this->HospID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// RIDNO
		$this->RIDNO = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNO->Sortable = TRUE; // Allow sort
		$this->RIDNO->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNO'] = &$this->RIDNO;

		// TidNo
		$this->TidNo = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CId
		$this->CId = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_CId', 'CId', '`CId`', '`CId`', 3, -1, FALSE, '`CId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CId->Sortable = TRUE; // Allow sort
		$this->CId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['CId'] = &$this->CId;

		// PatId
		$this->PatId = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, -1, FALSE, '`PatId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrID
		$this->DrID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, -1, FALSE, '`DrID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillStatus
		$this->BillStatus = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, -1, FALSE, '`BillStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StoreID
		$this->StoreID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, -1, FALSE, '`StoreID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BranchID
		$this->BranchID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_BranchID', 'BranchID', '`BranchID`', '`BranchID`', 3, -1, FALSE, '`BranchID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_store_transfer") {
			$detailUrl = $GLOBALS["view_store_transfer"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "store_billing_transferlist.php";
		return $detailUrl;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "store_billing_transferlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "store_billing_transferview.php")
			return $Language->phrase("View");
		elseif ($pageName == "store_billing_transferedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "store_billing_transferadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("store_billing_transferview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("store_billing_transferview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "store_billing_transferadd.php?" . $this->getUrlParm($parm);
		else
			$url = "store_billing_transferadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("store_billing_transferedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("store_billing_transferedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("store_billing_transferadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("store_billing_transferadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("store_billing_transferdelete.php", $this->getUrlParm());
	}
