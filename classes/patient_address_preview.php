 ...
 * Page class
 */
class patient_address_preview extends patient_address
{
	...
	// Page object name
	public $PageObjName = "patient_address_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_address');
			if ($Security->isLoggedIn())
