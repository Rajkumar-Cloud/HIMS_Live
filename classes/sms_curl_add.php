 ...
 * Page class
 */
class sms_curl_add extends sms_curl
{
	...
	// Page object name
	public $PageObjName = "sms_curl_add";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("sms_curllist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("sms_curllist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "sms_curllist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "sms_curlview.php")
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->SMSType->EditValue = HtmlEncode($this->SMSType->CurrentValue);
	...
	protected function addRow($rsold = NULL)
	{
		...
		// SMSType
		$this->SMSType->setDbValueDef($rsnew, $this->SMSType->CurrentValue, NULL, FALSE);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("sms_curllist.php"), "", $this->TableVar, TRUE);
