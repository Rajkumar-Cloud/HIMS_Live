 ...
 * Page class
 */
class ivf_et_chart_edit extends ivf_et_chart
{
	...
	// Page object name
	public $PageObjName = "ivf_et_chart_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// TemplateProcedureRecord
			$this->TemplateProcedureRecord->setDbValueDef($rsnew, $this->TemplateProcedureRecord->CurrentValue, "", $this->TemplateProcedureRecord->ReadOnly);

			// TemplateMedicationsadvised
			$this->TemplateMedicationsadvised->setDbValueDef($rsnew, $this->TemplateMedicationsadvised->CurrentValue, "", $this->TemplateMedicationsadvised->ReadOnly);

			// TemplatePostProcedureInstructions
			$this->TemplatePostProcedureInstructions->setDbValueDef($rsnew, $this->TemplatePostProcedureInstructions->CurrentValue, "", $this->TemplatePostProcedureInstructions->ReadOnly);
