...
class lab_dept_mast extends DbTable
{
	...
	public function __construct()
	{
		...
		// MainCD
		$this->MainCD = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_MainCD', 'MainCD', '`MainCD`', '`MainCD`', 200, -1, FALSE, '`MainCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Code
		$this->Code = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_Code', 'Code', '`Code`', '`Code`', 200, -1, FALSE, '`Code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Order
		$this->Order = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_Order', 'Order', '`Order`', '`Order`', 131, -1, FALSE, '`Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SignCD
		$this->SignCD = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_SignCD', 'SignCD', '`SignCD`', '`SignCD`', 200, -1, FALSE, '`SignCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Collection
		$this->Collection = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_Collection', 'Collection', '`Collection`', '`Collection`', 200, -1, FALSE, '`Collection`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EditDate
		$this->EditDate = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_EditDate', 'EditDate', '`EditDate`', CastDateFieldForLike('`EditDate`', 0, "DB"), 135, 0, FALSE, '`EditDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SMS
		$this->SMS = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_SMS', 'SMS', '`SMS`', '`SMS`', 200, -1, FALSE, '`SMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Note
		$this->Note = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_Note', 'Note', '`Note`', '`Note`', 201, -1, FALSE, '`Note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// WorkList
		$this->WorkList = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_WorkList', 'WorkList', '`WorkList`', '`WorkList`', 200, -1, FALSE, '`WorkList`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Page
		$this->_Page = new DbField('lab_dept_mast', 'lab_dept_mast', 'x__Page', 'Page', '`Page`', '`Page`', 131, -1, FALSE, '`Page`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Incharge
		$this->Incharge = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_Incharge', 'Incharge', '`Incharge`', '`Incharge`', 200, -1, FALSE, '`Incharge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AutoNum
		$this->AutoNum = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_AutoNum', 'AutoNum', '`AutoNum`', '`AutoNum`', 200, -1, FALSE, '`AutoNum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id
		$this->id = new DbField('lab_dept_mast', 'lab_dept_mast', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("lab_dept_mastview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
