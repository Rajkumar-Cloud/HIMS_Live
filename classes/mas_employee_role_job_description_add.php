 ...
 * Page class
 */
class mas_employee_role_job_description_add extends mas_employee_role_job_description
{
	...
	// Page object name
	public $PageObjName = "mas_employee_role_job_description_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("mas_employee_role_job_descriptionlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "mas_employee_role_job_descriptionlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "mas_employee_role_job_descriptionview.php")
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'job_description' first before field var 'x_job_description'
		$val = $CurrentForm->hasValue("job_description") ? $CurrentForm->getValue("job_description") : $CurrentForm->getValue("x_job_description");
	...
	protected function newRow()
	{
		...
		$row['job_description'] = $this->job_description->CurrentValue;
