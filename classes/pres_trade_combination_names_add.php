 ...
 * Page class
 */
class pres_trade_combination_names_add extends pres_trade_combination_names
{
	...
	// Page object name
	public $PageObjName = "pres_trade_combination_names_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "pres_trade_combination_namesview.php")
