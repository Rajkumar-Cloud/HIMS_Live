 ...
 */
class hr_trainingsessions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// name
		$this->name = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_name', 'name', '`name`', '`name`', 201, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// course
		$this->course = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_course', 'course', '`course`', '`course`', 20, -1, FALSE, '`course`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// description
		$this->description = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// scheduled
		$this->scheduled = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_scheduled', 'scheduled', '`scheduled`', CastDateFieldForLike('`scheduled`', 0, "DB"), 135, 0, FALSE, '`scheduled`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// dueDate
		$this->dueDate = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_dueDate', 'dueDate', '`dueDate`', CastDateFieldForLike('`dueDate`', 0, "DB"), 135, 0, FALSE, '`dueDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// deliveryMethod
		$this->deliveryMethod = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_deliveryMethod', 'deliveryMethod', '`deliveryMethod`', '`deliveryMethod`', 202, -1, FALSE, '`deliveryMethod`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// deliveryLocation
		$this->deliveryLocation = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_deliveryLocation', 'deliveryLocation', '`deliveryLocation`', '`deliveryLocation`', 201, -1, FALSE, '`deliveryLocation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->deliveryLocation->Sortable = TRUE; // Allow sort
		$this->fields['deliveryLocation'] = &$this->deliveryLocation;

		// status
		$this->status = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// attendanceType
		$this->attendanceType = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_attendanceType', 'attendanceType', '`attendanceType`', '`attendanceType`', 202, -1, FALSE, '`attendanceType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// attachment
		$this->attachment = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_attachment', 'attachment', '`attachment`', '`attachment`', 201, -1, FALSE, '`attachment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->attachment->Sortable = TRUE; // Allow sort
		$this->fields['attachment'] = &$this->attachment;

		// created
		$this->created = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_created', 'created', '`created`', CastDateFieldForLike('`created`', 0, "DB"), 135, 0, FALSE, '`created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated
		$this->updated = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_updated', 'updated', '`updated`', CastDateFieldForLike('`updated`', 0, "DB"), 135, 0, FALSE, '`updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// requireProof
		$this->requireProof = new DbField('hr_trainingsessions', 'hr_trainingsessions', 'x_requireProof', 'requireProof', '`requireProof`', '`requireProof`', 202, -1, FALSE, '`requireProof`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "hr_trainingsessionslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "hr_trainingsessionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "hr_trainingsessionsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("hr_trainingsessionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("hr_trainingsessionsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "hr_trainingsessionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "hr_trainingsessionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("hr_trainingsessionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("hr_trainingsessionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("hr_trainingsessionsdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->dueDate->setDbValue($rs->fields('dueDate'));
		$this->deliveryMethod->setDbValue($rs->fields('deliveryMethod'));
		$this->deliveryLocation->setDbValue($rs->fields('deliveryLocation'));
		$this->status->setDbValue($rs->fields('status'));
		$this->attendanceType->setDbValue($rs->fields('attendanceType'));
		$this->attachment->setDbValue($rs->fields('attachment'));
		$this->created->setDbValue($rs->fields('created'));
		$this->updated->setDbValue($rs->fields('updated'));
		$this->requireProof->setDbValue($rs->fields('requireProof'));
	}
