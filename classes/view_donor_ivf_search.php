 ...
 * Page class
 */
class view_donor_ivf_search extends view_donor_ivf
{
	...
	// Page object name
	public $PageObjName = "view_donor_ivf_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr <> "") {
					...
					$srchStr = "view_donor_ivflist.php" . "?" . $srchStr;
	...
	protected function loadSearchValues()
	{
		...
		// Fgender
		if (!$this->isAddOrEdit())
			$this->Fgender->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Fgender"));
		$this->Fgender->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Fgender"));
	}
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->Male->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->Male->errorMessage());
		}
