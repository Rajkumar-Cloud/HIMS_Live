 ...
 * Page class
 */
class patient_provisional_diagnosis_preview extends patient_provisional_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_provisional_diagnosis_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_provisional_diagnosis');
			if ($Security->isLoggedIn())
