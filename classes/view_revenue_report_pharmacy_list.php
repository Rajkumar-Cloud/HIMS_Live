 ...
 * Page class
 */
class view_revenue_report_pharmacy_list extends view_revenue_report_pharmacy
{
	...
	// Page object name
	public $PageObjName = "view_revenue_report_pharmacy_list";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["view_revenue_report_pharmacy"]) || get_class($GLOBALS["view_revenue_report_pharmacy"]) == PROJECT_NAMESPACE . "view_revenue_report_pharmacy") {
			...
			$GLOBALS["Table"] = &$GLOBALS["view_revenue_report_pharmacy"];
		}
		...
		$this->AddUrl = "view_revenue_report_pharmacyadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "view_revenue_report_pharmacydelete.php";
		$this->MultiUpdateUrl = "view_revenue_report_pharmacyupdate.php";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $view_revenue_report_pharmacy;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($view_revenue_report_pharmacy);
				$doc->Text = @$content;
	...
	public function run()
	{
		...
		$this->_525Tax->Visible = FALSE;
		$this->TAXABLE_525->setVisibility();
		$this->_1225Tax->Visible = FALSE;
		$this->TAXABLE_1225->setVisibility();
		$this->_1825Tax->Visible = FALSE;
		$this->TAXABLE_1825->setVisibility();
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->_525Tax->AdvancedSearch->toJson(), ","); // Field 5%Tax
		$filterList = Concat($filterList, $this->TAXABLE_525->AdvancedSearch->toJson(), ","); // Field TAXABLE 5%
		$filterList = Concat($filterList, $this->_1225Tax->AdvancedSearch->toJson(), ","); // Field 12%Tax
		$filterList = Concat($filterList, $this->TAXABLE_1225->AdvancedSearch->toJson(), ","); // Field TAXABLE 12%
		$filterList = Concat($filterList, $this->_1825Tax->AdvancedSearch->toJson(), ","); // Field 18%Tax
		$filterList = Concat($filterList, $this->TAXABLE_1825->AdvancedSearch->toJson(), ","); // Field TAXABLE 18%
	...
	protected function restoreFilterList()
	{
		...
		// Field 5%Tax
		$this->_525Tax->AdvancedSearch->SearchValue = @$filter["x__525Tax"];
		$this->_525Tax->AdvancedSearch->SearchOperator = @$filter["z__525Tax"];
		$this->_525Tax->AdvancedSearch->SearchCondition = @$filter["v__525Tax"];
		$this->_525Tax->AdvancedSearch->SearchValue2 = @$filter["y__525Tax"];
		$this->_525Tax->AdvancedSearch->SearchOperator2 = @$filter["w__525Tax"];
		$this->_525Tax->AdvancedSearch->save();

		// Field TAXABLE 5%
		$this->TAXABLE_525->AdvancedSearch->SearchValue = @$filter["x_TAXABLE_525"];
		$this->TAXABLE_525->AdvancedSearch->SearchOperator = @$filter["z_TAXABLE_525"];
		$this->TAXABLE_525->AdvancedSearch->SearchCondition = @$filter["v_TAXABLE_525"];
		$this->TAXABLE_525->AdvancedSearch->SearchValue2 = @$filter["y_TAXABLE_525"];
		$this->TAXABLE_525->AdvancedSearch->SearchOperator2 = @$filter["w_TAXABLE_525"];
		$this->TAXABLE_525->AdvancedSearch->save();

		// Field 12%Tax
		$this->_1225Tax->AdvancedSearch->SearchValue = @$filter["x__1225Tax"];
		$this->_1225Tax->AdvancedSearch->SearchOperator = @$filter["z__1225Tax"];
		$this->_1225Tax->AdvancedSearch->SearchCondition = @$filter["v__1225Tax"];
		$this->_1225Tax->AdvancedSearch->SearchValue2 = @$filter["y__1225Tax"];
		$this->_1225Tax->AdvancedSearch->SearchOperator2 = @$filter["w__1225Tax"];
		$this->_1225Tax->AdvancedSearch->save();

		// Field TAXABLE 12%
		$this->TAXABLE_1225->AdvancedSearch->SearchValue = @$filter["x_TAXABLE_1225"];
		$this->TAXABLE_1225->AdvancedSearch->SearchOperator = @$filter["z_TAXABLE_1225"];
		$this->TAXABLE_1225->AdvancedSearch->SearchCondition = @$filter["v_TAXABLE_1225"];
		$this->TAXABLE_1225->AdvancedSearch->SearchValue2 = @$filter["y_TAXABLE_1225"];
		$this->TAXABLE_1225->AdvancedSearch->SearchOperator2 = @$filter["w_TAXABLE_1225"];
		$this->TAXABLE_1225->AdvancedSearch->save();

		// Field 18%Tax
		$this->_1825Tax->AdvancedSearch->SearchValue = @$filter["x__1825Tax"];
		$this->_1825Tax->AdvancedSearch->SearchOperator = @$filter["z__1825Tax"];
		$this->_1825Tax->AdvancedSearch->SearchCondition = @$filter["v__1825Tax"];
		$this->_1825Tax->AdvancedSearch->SearchValue2 = @$filter["y__1825Tax"];
		$this->_1825Tax->AdvancedSearch->SearchOperator2 = @$filter["w__1825Tax"];
		$this->_1825Tax->AdvancedSearch->save();

		// Field TAXABLE 18%
		$this->TAXABLE_1825->AdvancedSearch->SearchValue = @$filter["x_TAXABLE_1825"];
		$this->TAXABLE_1825->AdvancedSearch->SearchOperator = @$filter["z_TAXABLE_1825"];
		$this->TAXABLE_1825->AdvancedSearch->SearchCondition = @$filter["v_TAXABLE_1825"];
		$this->TAXABLE_1825->AdvancedSearch->SearchValue2 = @$filter["y_TAXABLE_1825"];
		$this->TAXABLE_1825->AdvancedSearch->SearchOperator2 = @$filter["w_TAXABLE_1825"];
		$this->TAXABLE_1825->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->_525Tax, $default, FALSE); // 5%Tax
		$this->buildSearchSql($where, $this->TAXABLE_525, $default, FALSE); // TAXABLE 5%
		$this->buildSearchSql($where, $this->_1225Tax, $default, FALSE); // 12%Tax
		$this->buildSearchSql($where, $this->TAXABLE_1225, $default, FALSE); // TAXABLE 12%
		$this->buildSearchSql($where, $this->_1825Tax, $default, FALSE); // 18%Tax
		$this->buildSearchSql($where, $this->TAXABLE_1825, $default, FALSE); // TAXABLE 18%
		...
		if (!$default && $this->Command == "search") {
			...
			$this->_525Tax->AdvancedSearch->save(); // 5%Tax
			$this->TAXABLE_525->AdvancedSearch->save(); // TAXABLE 5%
			$this->_1225Tax->AdvancedSearch->save(); // 12%Tax
			$this->TAXABLE_1225->AdvancedSearch->save(); // TAXABLE 12%
			$this->_1825Tax->AdvancedSearch->save(); // 18%Tax
			$this->TAXABLE_1825->AdvancedSearch->save(); // TAXABLE 18%
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->_525Tax, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->TAXABLE_525, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->_1225Tax, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->TAXABLE_1225, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->_1825Tax, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->TAXABLE_1825, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->PatientId->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->_525Tax->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->TAXABLE_525->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->_1225Tax->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->TAXABLE_1225->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->_1825Tax->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->TAXABLE_1825->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->_525Tax->AdvancedSearch->unsetSession();
		$this->TAXABLE_525->AdvancedSearch->unsetSession();
		$this->_1225Tax->AdvancedSearch->unsetSession();
		$this->TAXABLE_1225->AdvancedSearch->unsetSession();
		$this->_1825Tax->AdvancedSearch->unsetSession();
		$this->TAXABLE_1825->AdvancedSearch->unsetSession();
	...
	protected function restoreSearchParms()
	{
		...
		$this->_525Tax->AdvancedSearch->load();
		$this->TAXABLE_525->AdvancedSearch->load();
		$this->_1225Tax->AdvancedSearch->load();
		$this->TAXABLE_1225->AdvancedSearch->load();
		$this->_1825Tax->AdvancedSearch->load();
		$this->TAXABLE_1825->AdvancedSearch->load();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->TAXABLE_525); // TAXABLE 5%
			$this->updateSort($this->TAXABLE_1225); // TAXABLE 12%
			$this->updateSort($this->TAXABLE_1825); // TAXABLE 18%
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->TAXABLE_525->setSort("");
				$this->TAXABLE_1225->setSort("");
				$this->TAXABLE_1825->setSort("");
				$this->Amount->setSort("");
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_revenue_report_pharmacylistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_revenue_report_pharmacylistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fview_revenue_report_pharmacylist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_revenue_report_pharmacylistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function loadSearchValues()
	{
		...
		// 5%Tax
		if (!$this->isAddOrEdit())
			$this->_525Tax->AdvancedSearch->setSearchValue(Get("x__525Tax", Get("_525Tax", "")));
		if ($this->_525Tax->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->_525Tax->AdvancedSearch->setSearchOperator(Get("z__525Tax", ""));

		// TAXABLE 5%
		if (!$this->isAddOrEdit())
			$this->TAXABLE_525->AdvancedSearch->setSearchValue(Get("x_TAXABLE_525", Get("TAXABLE_525", "")));
		if ($this->TAXABLE_525->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TAXABLE_525->AdvancedSearch->setSearchOperator(Get("z_TAXABLE_525", ""));

		// 12%Tax
		if (!$this->isAddOrEdit())
			$this->_1225Tax->AdvancedSearch->setSearchValue(Get("x__1225Tax", Get("_1225Tax", "")));
		if ($this->_1225Tax->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->_1225Tax->AdvancedSearch->setSearchOperator(Get("z__1225Tax", ""));

		// TAXABLE 12%
		if (!$this->isAddOrEdit())
			$this->TAXABLE_1225->AdvancedSearch->setSearchValue(Get("x_TAXABLE_1225", Get("TAXABLE_1225", "")));
		if ($this->TAXABLE_1225->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TAXABLE_1225->AdvancedSearch->setSearchOperator(Get("z_TAXABLE_1225", ""));

		// 18%Tax
		if (!$this->isAddOrEdit())
			$this->_1825Tax->AdvancedSearch->setSearchValue(Get("x__1825Tax", Get("_1825Tax", "")));
		if ($this->_1825Tax->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->_1825Tax->AdvancedSearch->setSearchOperator(Get("z__1825Tax", ""));

		// TAXABLE 18%
		if (!$this->isAddOrEdit())
			$this->TAXABLE_1825->AdvancedSearch->setSearchValue(Get("x_TAXABLE_1825", Get("TAXABLE_1825", "")));
		if ($this->TAXABLE_1825->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TAXABLE_1825->AdvancedSearch->setSearchOperator(Get("z_TAXABLE_1825", ""));
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->_525Tax->setDbValue($row['5%Tax']);
		$this->TAXABLE_525->setDbValue($row['TAXABLE 5%']);
		$this->_1225Tax->setDbValue($row['12%Tax']);
		$this->TAXABLE_1225->setDbValue($row['TAXABLE 12%']);
		$this->_1825Tax->setDbValue($row['18%Tax']);
		$this->TAXABLE_1825->setDbValue($row['TAXABLE 18%']);
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (REMOVE_XSS)
				$this->TAXABLE_525->AdvancedSearch->SearchValue = HtmlDecode($this->TAXABLE_525->AdvancedSearch->SearchValue);
			$this->TAXABLE_525->EditValue = HtmlEncode($this->TAXABLE_525->AdvancedSearch->SearchValue);
			...
			if (REMOVE_XSS)
				$this->TAXABLE_1225->AdvancedSearch->SearchValue = HtmlDecode($this->TAXABLE_1225->AdvancedSearch->SearchValue);
			$this->TAXABLE_1225->EditValue = HtmlEncode($this->TAXABLE_1225->AdvancedSearch->SearchValue);
			...
			if (REMOVE_XSS)
				$this->TAXABLE_1825->AdvancedSearch->SearchValue = HtmlDecode($this->TAXABLE_1825->AdvancedSearch->SearchValue);
			$this->TAXABLE_1825->EditValue = HtmlEncode($this->TAXABLE_1825->AdvancedSearch->SearchValue);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_revenue_report_pharmacylist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_revenue_report_pharmacylist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_revenue_report_pharmacylist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
