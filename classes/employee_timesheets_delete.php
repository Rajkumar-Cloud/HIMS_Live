 ...
 * Page class
 */
class employee_timesheets_delete extends employee_timesheets
{
	...
	// Page object name
	public $PageObjName = "employee_timesheets_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_timesheetslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_timesheetslist.php"); // Return to list
			}
		}
	}
