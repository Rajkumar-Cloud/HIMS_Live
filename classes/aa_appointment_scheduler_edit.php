 ...
 * Page class
 */
class aa_appointment_scheduler_edit extends aa_appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "aa_appointment_scheduler_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("aa_appointment_schedulerlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "aa_appointment_schedulerlist.php")
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// gendar
			$this->gendar->setDbValueDef($rsnew, $this->gendar->CurrentValue, "", $this->gendar->ReadOnly);
