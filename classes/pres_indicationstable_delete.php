 ...
 * Page class
 */
class pres_indicationstable_delete extends pres_indicationstable
{
	...
	// Page object name
	public $PageObjName = "pres_indicationstable_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pres_indicationstablelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pres_indicationstablelist.php"); // Return to list
			}
		}
	}
