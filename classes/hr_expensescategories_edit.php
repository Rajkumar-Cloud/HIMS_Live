 ...
 * Page class
 */
class hr_expensescategories_edit extends hr_expensescategories
{
	...
	// Page object name
	public $PageObjName = "hr_expensescategories_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// pre_approve
			$this->pre_approve->setDbValueDef($rsnew, $this->pre_approve->CurrentValue, NULL, $this->pre_approve->ReadOnly);
