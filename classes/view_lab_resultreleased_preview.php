...
class view_lab_resultreleased_preview extends view_lab_resultreleased
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_lab_services") {
			$url = "" . TABLE_SHOW_MASTER . "=view_lab_services&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		if ($masterTblVar == "view_labreport_print") {
			$url = "" . TABLE_SHOW_MASTER . "=view_labreport_print&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		return $url;
	}
