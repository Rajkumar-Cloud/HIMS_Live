...
class view_dashboard_summary_payment_mode extends DbTable
{
	...
	public function __construct()
	{
		...
		// createddate
		$this->createddate = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_createddate', 'createddate', '`createddate`', CastDateFieldForLike('`createddate`', 7, "DB"), 133, 7, FALSE, '`createddate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UserName
		$this->UserName = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UserName->IsForeignKey = TRUE; // Foreign key field
		$this->UserName->Sortable = TRUE; // Allow sort
		$this->fields['UserName'] = &$this->UserName;

		// CARD
		$this->CARD = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_CARD', 'CARD', '`CARD`', '`CARD`', 131, -1, FALSE, '`CARD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CARD->Sortable = TRUE; // Allow sort
		$this->CARD->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['CARD'] = &$this->CARD;

		// CASH
		$this->CASH = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_CASH', 'CASH', '`CASH`', '`CASH`', 131, -1, FALSE, '`CASH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASH->Sortable = TRUE; // Allow sort
		$this->CASH->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['CASH'] = &$this->CASH;

		// NEFT
		$this->NEFT = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_NEFT', 'NEFT', '`NEFT`', '`NEFT`', 131, -1, FALSE, '`NEFT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NEFT->Sortable = TRUE; // Allow sort
		$this->NEFT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['NEFT'] = &$this->NEFT;

		// PAYTM
		$this->PAYTM = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_PAYTM', 'PAYTM', '`PAYTM`', '`PAYTM`', 131, -1, FALSE, '`PAYTM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CHEQUE
		$this->CHEQUE = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_CHEQUE', 'CHEQUE', '`CHEQUE`', '`CHEQUE`', 131, -1, FALSE, '`CHEQUE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RTGS
		$this->RTGS = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_RTGS', 'RTGS', '`RTGS`', '`RTGS`', 131, -1, FALSE, '`RTGS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RTGS->Sortable = TRUE; // Allow sort
		$this->RTGS->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RTGS'] = &$this->RTGS;

		// NotSelected
		$this->NotSelected = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_NotSelected', 'NotSelected', '`NotSelected`', '`NotSelected`', 131, -1, FALSE, '`NotSelected`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Total
		$this->Total = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_Total', 'Total', '`Total`', '`Total`', 131, -1, FALSE, '`Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total->Sortable = TRUE; // Allow sort
		$this->Total->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Total'] = &$this->Total;

		// REFUND
		$this->REFUND = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_REFUND', 'REFUND', '`REFUND`', '`REFUND`', 131, -1, FALSE, '`REFUND`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CANCEL
		$this->CANCEL = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_CANCEL', 'CANCEL', '`CANCEL`', '`CANCEL`', 131, -1, FALSE, '`CANCEL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillType
		$this->BillType = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, -1, FALSE, '`BillType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AdjAdvance
		$this->AdjAdvance = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_AdjAdvance', 'AdjAdvance', '`AdjAdvance`', '`AdjAdvance`', 131, -1, FALSE, '`AdjAdvance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_dashboard_summary_payment_modeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
