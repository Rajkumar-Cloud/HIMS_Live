 ...
 */
class view_pharmacygrn extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// ORDNO
		$this->ORDNO = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, -1, FALSE, '`ORDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ORDNO->Sortable = TRUE; // Allow sort
		$this->fields['ORDNO'] = &$this->ORDNO;

		// PRC
		$this->PRC = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Required = TRUE; // Required field
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// QTY
		$this->QTY = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 3, -1, FALSE, '`QTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QTY->Sortable = TRUE; // Allow sort
		$this->QTY->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['QTY'] = &$this->QTY;

		// DT
		$this->DT = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 0, "DB"), 135, 0, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PC
		$this->PC = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PC->Sortable = TRUE; // Allow sort
		$this->fields['PC'] = &$this->PC;

		// YM
		$this->YM = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_YM', 'YM', '`YM`', '`YM`', 200, -1, FALSE, '`YM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->YM->Sortable = TRUE; // Allow sort
		$this->fields['YM'] = &$this->YM;

		// Stock
		$this->Stock = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 3, -1, FALSE, '`Stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastMonthSale
		$this->LastMonthSale = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_LastMonthSale', 'LastMonthSale', '`LastMonthSale`', '`LastMonthSale`', 3, -1, FALSE, '`LastMonthSale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Printcheck
		$this->Printcheck = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Printcheck', 'Printcheck', '`Printcheck`', '`Printcheck`', 200, -1, FALSE, '`Printcheck`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Printcheck->Sortable = TRUE; // Allow sort
		$this->fields['Printcheck'] = &$this->Printcheck;

		// id
		$this->id = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// poid
		$this->poid = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_poid', 'poid', '`poid`', '`poid`', 3, -1, FALSE, '`poid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrName
		$this->PrName = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, -1, FALSE, '`EV__PrName`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		$this->PrName->Required = TRUE; // Required field
		$this->PrName->Sortable = TRUE; // Allow sort
		$this->PrName->Lookup = new Lookup('PrName', 'pharmacy_storemast', FALSE, 'DES', ["DES","","",""], [], [], [], [], ["PRC","BATCHNO","EXPDT","HSNCODE","MFRCODE","MRP","PurValue","PSGST","PCGST","RT","SaleRate","SSGST","SCGST"], ["x_PRC","x_BatchNo","x_ExpDate","x_HSN","x_MFRCODE","x_MRP","x_PurValue","x_PSGST","x_PCGST","x_ItemValue","x_SalRate","x_SSGST","x_SCGST"], '', '');
		$this->fields['PrName'] = &$this->PrName;

		// grnid
		$this->grnid = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grnid', 'grnid', '`grnid`', '`grnid`', 3, -1, FALSE, '`grnid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GrnQuantity
		$this->GrnQuantity = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 3, -1, FALSE, '`GrnQuantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FreeQty
		$this->FreeQty = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 3, -1, FALSE, '`FreeQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FreeQtyyy
		$this->FreeQtyyy = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_FreeQtyyy', 'FreeQtyyy', '`FreeQtyyy`', '`FreeQtyyy`', 3, -1, FALSE, '`FreeQtyyy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BatchNo
		$this->BatchNo = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, -1, FALSE, '`BatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchNo->Sortable = TRUE; // Allow sort
		$this->fields['BatchNo'] = &$this->BatchNo;

		// ExpDate
		$this->ExpDate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike('`ExpDate`', 7, "DB"), 135, 7, FALSE, '`ExpDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HSN
		$this->HSN = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, -1, FALSE, '`HSN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HSN->Sortable = TRUE; // Allow sort
		$this->fields['HSN'] = &$this->HSN;

		// MFRCODE
		$this->MFRCODE = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// PUnit
		$this->PUnit = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, -1, FALSE, '`PUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SUnit
		$this->SUnit = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, -1, FALSE, '`SUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pack
		$this->Pack = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Pack', 'Pack', '`Pack`', '`Pack`', 200, -1, FALSE, '`Pack`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pack->Sortable = TRUE; // Allow sort
		$this->fields['Pack'] = &$this->Pack;

		// GrnMRP
		$this->GrnMRP = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_GrnMRP', 'GrnMRP', '`GrnMRP`', '`GrnMRP`', 131, -1, FALSE, '`GrnMRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MRP
		$this->MRP = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurValue
		$this->PurValue = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GRNPer
		$this->GRNPer = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_GRNPer', 'GRNPer', '`GRNPer`', '`GRNPer`', 131, -1, FALSE, '`GRNPer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Disc
		$this->Disc = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, -1, FALSE, '`Disc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Disc->Required = TRUE; // Required field
		$this->Disc->Sortable = TRUE; // Allow sort
		$this->fields['Disc'] = &$this->Disc;

		// PSGST
		$this->PSGST = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PSGST->Required = TRUE; // Required field
		$this->PSGST->Sortable = TRUE; // Allow sort
		$this->fields['PSGST'] = &$this->PSGST;

		// PCGST
		$this->PCGST = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCGST->Required = TRUE; // Required field
		$this->PCGST->Sortable = TRUE; // Allow sort
		$this->fields['PCGST'] = &$this->PCGST;

		// PTax
		$this->PTax = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PTax', 'PTax', '`PTax`', '`PTax`', 131, -1, FALSE, '`PTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ItemValue
		$this->ItemValue = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_ItemValue', 'ItemValue', '`ItemValue`', '`ItemValue`', 131, -1, FALSE, '`ItemValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalTax
		$this->SalTax = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_SalTax', 'SalTax', '`SalTax`', '`SalTax`', 131, -1, FALSE, '`SalTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurRate
		$this->PurRate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, -1, FALSE, '`PurRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalRate
		$this->SalRate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, -1, FALSE, '`SalRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Discount
		$this->Discount = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SSGST
		$this->SSGST = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SSGST->Required = TRUE; // Required field
		$this->SSGST->Sortable = TRUE; // Allow sort
		$this->fields['SSGST'] = &$this->SSGST;

		// SCGST
		$this->SCGST = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SCGST->Required = TRUE; // Required field
		$this->SCGST->Sortable = TRUE; // Allow sort
		$this->fields['SCGST'] = &$this->SCGST;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// trid
		$this->trid = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_trid', 'trid', '`trid`', '`trid`', 3, -1, FALSE, '`trid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// CreatedBy
		$this->CreatedBy = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->CreatedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedDateTime->Sortable = TRUE; // Allow sort
		$this->CreatedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['CreatedDateTime'] = &$this->CreatedDateTime;

		// ModifiedBy
		$this->ModifiedBy = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->ModifiedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike('`ModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedDateTime->Sortable = TRUE; // Allow sort
		$this->ModifiedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['ModifiedDateTime'] = &$this->ModifiedDateTime;

		// grncreatedby
		$this->grncreatedby = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grncreatedby', 'grncreatedby', '`grncreatedby`', '`grncreatedby`', 3, -1, FALSE, '`grncreatedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grncreatedDateTime
		$this->grncreatedDateTime = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grncreatedDateTime', 'grncreatedDateTime', '`grncreatedDateTime`', CastDateFieldForLike('`grncreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`grncreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grnModifiedby
		$this->grnModifiedby = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grnModifiedby', 'grnModifiedby', '`grnModifiedby`', '`grnModifiedby`', 3, -1, FALSE, '`grnModifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grnModifiedDateTime
		$this->grnModifiedDateTime = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grnModifiedDateTime', 'grnModifiedDateTime', '`grnModifiedDateTime`', CastDateFieldForLike('`grnModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`grnModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Received
		$this->Received = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Received', 'Received', '`Received`', '`Received`', 200, -1, FALSE, '`Received`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Received->Sortable = TRUE; // Allow sort
		$this->fields['Received'] = &$this->Received;

		// BillDate
		$this->BillDate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike('`BillDate`', 0, "DB"), 135, 0, FALSE, '`BillDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grndate
		$this->grndate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grndate', 'grndate', '`grndate`', CastDateFieldForLike('`grndate`', 0, "DB"), 133, 0, FALSE, '`grndate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grndatetime
		$this->grndatetime = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grndatetime', 'grndatetime', '`grndatetime`', CastDateFieldForLike('`grndatetime`', 0, "DB"), 135, 0, FALSE, '`grndatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	// Master filter
	public function sqlMasterFilter_pharmacy_grn()
	{
		return "`id`=@id@";
	}

	// Detail filter
	public function sqlDetailFilter_pharmacy_grn()
	{
		return "`grnid`=@grnid@";
	}
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `DES` FROM `pharmacy_storemast` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`DES` = `view_pharmacygrn`.`PrName` LIMIT 1) AS `EV__PrName` FROM `view_pharmacygrn`" .
			") `TMP_TABLE`";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacygrnlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "view_pharmacygrnedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacygrnadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacygrnview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacygrnview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacygrnadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacygrnadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacygrnedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacygrnadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacygrndelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "pharmacy_grn" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$pprrName = $rsnew["PrName"];
		$NNamee = str_replace("'"," ",$pprrName);
		$rsnew["PrName"] = $NNamee;
				...
				$cid = $_GET["fk_id"] ;
						...
						$sql = "SELECT * FROM ganeshkumar_bjhims.pharmacy_batchmas where PRC='".$rsnew["PRC"]."' and BATCHNO='".$rsnew["BatchNo"]."' and `BRCODE`='".$rsnew["BRCODE"]."' and  `HospID`='".HospitalID()."'; ";
								...
								if($batchmasCount > 0)
								{
									...
									{
										$sqlA = " UPDATE `ganeshkumar_bjhims`.`pharmacy_batchmas` SET `RQ`=  `RQ` + '".$rsnew["Quantity"]."', `MRP`='".$rsnew["MRP"]."', `FRQ`=  `FRQ` + '".$FreeQty."', 
	`PurValue`='".$rsnew["PurValue"]."',  `PurRate` = '". $rsnew["PurRate"]."',	`PUnit`='".$rsnew["PUnit"]."',  `SUnit` = '". $rsnew["SUnit"]."',
	...
	`PurValue`='".$rsnew["PurValue"]."',  `PurRate` = '". $rsnew["PurRate"]."',	`PUnit`='".$rsnew["PUnit"]."',  `SUnit` = '". $rsnew["SUnit"]."',
								...
								if($rsnew["ExpDate"] == null)
								{
								$sqlC = "UPDATE `ganeshkumar_bjhims`.`pharmacy_storemast` SET `BRCODE`='".$rsnew["BRCODE"]."', `RT`='".$rsnew["SalRate"]."', `HSN`='".$rsnew["HSNCODE"]."',
