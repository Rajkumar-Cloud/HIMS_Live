...
class banktransferto extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('banktransferto', 'banktransferto', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Name
		$this->Name = new DbField('banktransferto', 'banktransferto', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Street_Address
		$this->Street_Address = new DbField('banktransferto', 'banktransferto', 'x_Street_Address', 'Street_Address', '`Street_Address`', '`Street_Address`', 200, -1, FALSE, '`Street_Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// City
		$this->City = new DbField('banktransferto', 'banktransferto', 'x_City', 'City', '`City`', '`City`', 200, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// State
		$this->State = new DbField('banktransferto', 'banktransferto', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Zipcode
		$this->Zipcode = new DbField('banktransferto', 'banktransferto', 'x_Zipcode', 'Zipcode', '`Zipcode`', '`Zipcode`', 200, -1, FALSE, '`Zipcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Mobile_Number
		$this->Mobile_Number = new DbField('banktransferto', 'banktransferto', 'x_Mobile_Number', 'Mobile_Number', '`Mobile_Number`', '`Mobile_Number`', 200, -1, FALSE, '`Mobile_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccountNo
		$this->AccountNo = new DbField('banktransferto', 'banktransferto', 'x_AccountNo', 'AccountNo', '`AccountNo`', '`AccountNo`', 200, -1, FALSE, '`AccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "banktransfertoview.php")
			return $Language->phrase("View");
		elseif ($pageName == "banktransfertoedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "banktransfertoadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("banktransfertoview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("banktransfertoview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "banktransfertoadd.php?" . $this->getUrlParm($parm);
		else
			$url = "banktransfertoadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("banktransfertoedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("banktransfertoadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("banktransfertodelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Street_Address->setDbValue($rs->fields('Street_Address'));
