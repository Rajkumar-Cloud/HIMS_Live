...
class user_login extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('user_login', 'user_login', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// User_Name
		$this->User_Name = new DbField('user_login', 'user_login', 'x_User_Name', 'User_Name', '`User_Name`', '`User_Name`', 200, -1, FALSE, '`User_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mail_id
		$this->mail_id = new DbField('user_login', 'user_login', 'x_mail_id', 'mail_id', '`mail_id`', '`mail_id`', 200, -1, FALSE, '`mail_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mobile_no
		$this->mobile_no = new DbField('user_login', 'user_login', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// password
		$this->password = new DbField('user_login', 'user_login', 'x_password', 'password', '`password`', '`password`', 200, -1, FALSE, '`password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		...
		// email_verified
		$this->email_verified = new DbField('user_login', 'user_login', 'x_email_verified', 'email_verified', '`email_verified`', '`email_verified`', 200, -1, FALSE, '`email_verified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ReportTo
		$this->ReportTo = new DbField('user_login', 'user_login', 'x_ReportTo', 'ReportTo', '`ReportTo`', '`ReportTo`', 3, -1, FALSE, '`ReportTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UserLevel
		$this->UserLevel = new DbField('user_login', 'user_login', 'x_UserLevel', 'UserLevel', '`UserLevel`', '`UserLevel`', 3, -1, FALSE, '`UserLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->UserLevel->Lookup = new Lookup('UserLevel', 'userlevels', FALSE, 'id', ["UserLevelsName","","",""], [], [], [], [], [], [], '', '');
		$this->UserLevel->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['UserLevel'] = &$this->UserLevel;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('user_login', 'user_login', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedDateTime->Sortable = TRUE; // Allow sort
		$this->CreatedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['CreatedDateTime'] = &$this->CreatedDateTime;

		// profilefield
		$this->profilefield = new DbField('user_login', 'user_login', 'x_profilefield', 'profilefield', '`profilefield`', '`profilefield`', 200, -1, FALSE, '`profilefield`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->profilefield->Sortable = TRUE; // Allow sort
		$this->fields['profilefield'] = &$this->profilefield;

		// UserID
		$this->_UserID = new DbField('user_login', 'user_login', 'x__UserID', 'UserID', '`UserID`', '`UserID`', 3, -1, FALSE, '`UserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_UserID->Sortable = TRUE; // Allow sort
		$this->_UserID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['UserID'] = &$this->_UserID;

		// GroupID
		$this->GroupID = new DbField('user_login', 'user_login', 'x_GroupID', 'GroupID', '`GroupID`', '`GroupID`', 3, -1, FALSE, '`GroupID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('user_login', 'user_login', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PharID
		$this->PharID = new DbField('user_login', 'user_login', 'x_PharID', 'PharID', '`PharID`', '`PharID`', 3, -1, FALSE, '`PharID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// StoreID
		$this->StoreID = new DbField('user_login', 'user_login', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, -1, FALSE, '`StoreID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// OTP
		$this->OTP = new DbField('user_login', 'user_login', 'x_OTP', 'OTP', '`OTP`', '`OTP`', 200, -1, FALSE, '`OTP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OTP->Sortable = TRUE; // Allow sort
		$this->fields['OTP'] = &$this->OTP;

		// LoginType
		$this->LoginType = new DbField('user_login', 'user_login', 'x_LoginType', 'LoginType', '`LoginType`', '`LoginType`', 3, -1, FALSE, '`LoginType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LoginType->Sortable = TRUE; // Allow sort
		$this->LoginType->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['LoginType'] = &$this->LoginType;

		// BranchId
		$this->BranchId = new DbField('user_login', 'user_login', 'x_BranchId', 'BranchId', '`BranchId`', '`BranchId`', 3, -1, FALSE, '`BranchId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->LoginType->DbValue = $row['LoginType'];
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("user_loginview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->LoginType->setDbValue($rs->fields('LoginType'));
	...
	public function renderEditRow()
	{
		...
		$this->LoginType->EditValue = $this->LoginType->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->LoginType);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->LoginType);
