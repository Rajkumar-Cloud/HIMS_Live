 ...
 */
class view_pharmacy_non_movement extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// prc
		$this->prc = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_prc', 'prc', '`prc`', '`prc`', 200, -1, FALSE, '`prc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->prc->Sortable = TRUE; // Allow sort
		$this->fields['prc'] = &$this->prc;

		// prname
		$this->prname = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_prname', 'prname', '`prname`', '`prname`', 200, -1, FALSE, '`prname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->prname->Sortable = TRUE; // Allow sort
		$this->fields['prname'] = &$this->prname;

		// BATCHNO
		$this->BATCHNO = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// EXPDT
		$this->EXPDT = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MFRCODE
		$this->MFRCODE = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// PurDate
		$this->PurDate = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_PurDate', 'PurDate', '`PurDate`', CastDateFieldForLike('`PurDate`', 0, "DB"), 135, 0, FALSE, '`PurDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastSaleDate
		$this->LastSaleDate = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_LastSaleDate', 'LastSaleDate', '`LastSaleDate`', CastDateFieldForLike('`LastSaleDate`', 0, "DB"), 135, 0, FALSE, '`LastSaleDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_non_movement', 'view_pharmacy_non_movement', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_non_movementlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_non_movementview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_non_movementedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_non_movementadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_non_movementview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_non_movementview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_non_movementadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_non_movementadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_non_movementedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_non_movementadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_non_movementdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->PurDate->setDbValue($rs->fields('PurDate'));
		$this->LastSaleDate->setDbValue($rs->fields('LastSaleDate'));
