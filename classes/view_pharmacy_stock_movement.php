 ...
 */
class view_pharmacy_stock_movement extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PRC
		$this->PRC = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// PrName
		$this->PrName = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, -1, FALSE, '`PrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PrName->Sortable = TRUE; // Allow sort
		$this->fields['PrName'] = &$this->PrName;

		// OpeningStk
		$this->OpeningStk = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_OpeningStk', 'OpeningStk', '`OpeningStk`', '`OpeningStk`', 131, -1, FALSE, '`OpeningStk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurchaseQty
		$this->PurchaseQty = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_PurchaseQty', 'PurchaseQty', '`PurchaseQty`', '`PurchaseQty`', 131, -1, FALSE, '`PurchaseQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalesQty
		$this->SalesQty = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_SalesQty', 'SalesQty', '`SalesQty`', '`SalesQty`', 131, -1, FALSE, '`SalesQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ClosingStk
		$this->ClosingStk = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_ClosingStk', 'ClosingStk', '`ClosingStk`', '`ClosingStk`', 131, -1, FALSE, '`ClosingStk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurchasefreeQty
		$this->PurchasefreeQty = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_PurchasefreeQty', 'PurchasefreeQty', '`PurchasefreeQty`', '`PurchasefreeQty`', 131, -1, FALSE, '`PurchasefreeQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TransferingQty
		$this->TransferingQty = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_TransferingQty', 'TransferingQty', '`TransferingQty`', '`TransferingQty`', 131, -1, FALSE, '`TransferingQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitPurchaseRate
		$this->UnitPurchaseRate = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_UnitPurchaseRate', 'UnitPurchaseRate', '`UnitPurchaseRate`', '`UnitPurchaseRate`', 131, -1, FALSE, '`UnitPurchaseRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitSaleRate
		$this->UnitSaleRate = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_UnitSaleRate', 'UnitSaleRate', '`UnitSaleRate`', '`UnitSaleRate`', 131, -1, FALSE, '`UnitSaleRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedDate
		$this->CreatedDate = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_CreatedDate', 'CreatedDate', '`CreatedDate`', CastDateFieldForLike('`CreatedDate`', 0, "DB"), 133, 0, FALSE, '`CreatedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_stock_movement', 'view_pharmacy_stock_movement', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_stock_movementlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_stock_movementview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_stock_movementedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_stock_movementadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_stock_movementview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_stock_movementview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_stock_movementadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_stock_movementadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_stock_movementedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_stock_movementadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_stock_movementdelete.php", $this->getUrlParm());
	}
