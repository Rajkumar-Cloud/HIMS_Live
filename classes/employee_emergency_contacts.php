 ...
 */
class employee_emergency_contacts extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee
		$this->employee = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_employee', 'employee', '`employee`', '`employee`', 3, -1, FALSE, '`employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// name
		$this->name = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// relationship
		$this->relationship = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_relationship', 'relationship', '`relationship`', '`relationship`', 200, -1, FALSE, '`relationship`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->relationship->Sortable = TRUE; // Allow sort
		$this->fields['relationship'] = &$this->relationship;

		// home_phone
		$this->home_phone = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_home_phone', 'home_phone', '`home_phone`', '`home_phone`', 200, -1, FALSE, '`home_phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->home_phone->Sortable = TRUE; // Allow sort
		$this->fields['home_phone'] = &$this->home_phone;

		// work_phone
		$this->work_phone = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_work_phone', 'work_phone', '`work_phone`', '`work_phone`', 200, -1, FALSE, '`work_phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->work_phone->Sortable = TRUE; // Allow sort
		$this->fields['work_phone'] = &$this->work_phone;

		// mobile_phone
		$this->mobile_phone = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_mobile_phone', 'mobile_phone', '`mobile_phone`', '`mobile_phone`', 200, -1, FALSE, '`mobile_phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_emergency_contactslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "employee_emergency_contactsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "employee_emergency_contactsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_emergency_contactsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_emergency_contactsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_emergency_contactsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_emergency_contactsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_emergency_contactsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_emergency_contactsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_emergency_contactsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_emergency_contactsdelete.php", $this->getUrlParm());
	}
