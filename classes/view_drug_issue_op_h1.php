 ...
 */
class view_drug_issue_op_h1 extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// voucher_type
		$this->voucher_type = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, -1, FALSE, '`voucher_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->voucher_type->Sortable = TRUE; // Allow sort
		$this->fields['voucher_type'] = &$this->voucher_type;

		// Doctor
		$this->Doctor = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, -1, FALSE, '`Doctor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Doctor->Sortable = TRUE; // Allow sort
		$this->fields['Doctor'] = &$this->Doctor;

		// PatientName
		$this->PatientName = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// PatientId
		$this->PatientId = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = FALSE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// Product
		$this->Product = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_Product', 'Product', '`Product`', '`Product`', 200, -1, FALSE, '`Product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product->Sortable = TRUE; // Allow sort
		$this->fields['Product'] = &$this->Product;

		// IQ
		$this->IQ = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = TRUE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// Mfg
		$this->Mfg = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, -1, FALSE, '`Mfg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mfg->Sortable = FALSE; // Allow sort
		$this->fields['Mfg'] = &$this->Mfg;

		// BATCHNO
		$this->BATCHNO = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// EXPDT
		$this->EXPDT = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_EXPDT', 'EXPDT', '`EXPDT`', '`EXPDT`', 200, -1, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EXPDT->Sortable = TRUE; // Allow sort
		$this->fields['EXPDT'] = &$this->EXPDT;

		// createddatetime
		$this->createddatetime = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 7, "DB"), 135, 7, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_drug_issue_op_h1list.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_drug_issue_op_h1view.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_drug_issue_op_h1edit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_drug_issue_op_h1add.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_drug_issue_op_h1view.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_drug_issue_op_h1view.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_drug_issue_op_h1add.php?" . $this->getUrlParm($parm);
		else
			$url = "view_drug_issue_op_h1add.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_drug_issue_op_h1edit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_drug_issue_op_h1add.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_drug_issue_op_h1delete.php", $this->getUrlParm());
	}
