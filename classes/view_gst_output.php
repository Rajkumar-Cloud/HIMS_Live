...
class view_gst_output extends DbTable
{
	...
	public function __construct()
	{
		...
		// BillDate
		$this->BillDate = new DbField('view_gst_output', 'view_gst_output', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike('`BillDate`', 7, "DB"), 133, 7, FALSE, '`BillDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 2.5% SGST
		$this->IP_2_525_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_2_525_SGST', 'IP 2.5% SGST', '`IP 2.5% SGST`', '`IP 2.5% SGST`', 131, -1, FALSE, '`IP 2.5% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 2.5% CGST
		$this->IP_2_525_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_2_525_CGST', 'IP 2.5% CGST', '`IP 2.5% CGST`', '`IP 2.5% CGST`', 131, -1, FALSE, '`IP 2.5% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 6.0% SGST
		$this->IP_6_025_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_6_025_SGST', 'IP 6.0% SGST', '`IP 6.0% SGST`', '`IP 6.0% SGST`', 131, -1, FALSE, '`IP 6.0% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 6.0% CGST
		$this->IP_6_025_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_6_025_CGST', 'IP 6.0% CGST', '`IP 6.0% CGST`', '`IP 6.0% CGST`', 131, -1, FALSE, '`IP 6.0% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 9.0% SGST
		$this->IP_9_025_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_9_025_SGST', 'IP 9.0% SGST', '`IP 9.0% SGST`', '`IP 9.0% SGST`', 131, -1, FALSE, '`IP 9.0% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 9.0% CGST
		$this->IP_9_025_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_9_025_CGST', 'IP 9.0% CGST', '`IP 9.0% CGST`', '`IP 9.0% CGST`', 131, -1, FALSE, '`IP 9.0% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 14.0% SGST
		$this->IP_14_025_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_14_025_SGST', 'IP 14.0% SGST', '`IP 14.0% SGST`', '`IP 14.0% SGST`', 131, -1, FALSE, '`IP 14.0% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IP 14.0% CGST
		$this->IP_14_025_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_IP_14_025_CGST', 'IP 14.0% CGST', '`IP 14.0% CGST`', '`IP 14.0% CGST`', 131, -1, FALSE, '`IP 14.0% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 2.5% SGST
		$this->OP_2_525_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_2_525_SGST', 'OP 2.5% SGST', '`OP 2.5% SGST`', '`OP 2.5% SGST`', 131, -1, FALSE, '`OP 2.5% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 2.5% CGST
		$this->OP_2_525_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_2_525_CGST', 'OP 2.5% CGST', '`OP 2.5% CGST`', '`OP 2.5% CGST`', 131, -1, FALSE, '`OP 2.5% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 6.0% SGST
		$this->OP_6_025_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_6_025_SGST', 'OP 6.0% SGST', '`OP 6.0% SGST`', '`OP 6.0% SGST`', 131, -1, FALSE, '`OP 6.0% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 6.0% CGST
		$this->OP_6_025_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_6_025_CGST', 'OP 6.0% CGST', '`OP 6.0% CGST`', '`OP 6.0% CGST`', 131, -1, FALSE, '`OP 6.0% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 9.0% SGST
		$this->OP_9_025_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_9_025_SGST', 'OP 9.0% SGST', '`OP 9.0% SGST`', '`OP 9.0% SGST`', 131, -1, FALSE, '`OP 9.0% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 9.0% CGST
		$this->OP_9_025_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_9_025_CGST', 'OP 9.0% CGST', '`OP 9.0% CGST`', '`OP 9.0% CGST`', 131, -1, FALSE, '`OP 9.0% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 14.0% SGST
		$this->OP_14_025_SGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_14_025_SGST', 'OP 14.0% SGST', '`OP 14.0% SGST`', '`OP 14.0% SGST`', 131, -1, FALSE, '`OP 14.0% SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OP 14.0% CGST
		$this->OP_14_025_CGST = new DbField('view_gst_output', 'view_gst_output', 'x_OP_14_025_CGST', 'OP 14.0% CGST', '`OP 14.0% CGST`', '`OP 14.0% CGST`', 131, -1, FALSE, '`OP 14.0% CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HosoID
		$this->HosoID = new DbField('view_gst_output', 'view_gst_output', 'x_HosoID', 'HosoID', '`HosoID`', '`HosoID`', 3, -1, FALSE, '`HosoID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_gst_outputview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
