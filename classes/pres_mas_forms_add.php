 ...
 * Page class
 */
class pres_mas_forms_add extends pres_mas_forms
{
	...
	// Page object name
	public $PageObjName = "pres_mas_forms_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("pres_mas_formslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "pres_mas_formslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "pres_mas_formsview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Forms
		$this->Forms->setDbValueDef($rsnew, $this->Forms->CurrentValue, "", FALSE);
