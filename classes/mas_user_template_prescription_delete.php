 ...
 * Page class
 */
class mas_user_template_prescription_delete extends mas_user_template_prescription
{
	...
	// Page object name
	public $PageObjName = "mas_user_template_prescription_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("mas_user_template_prescriptionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("mas_user_template_prescriptionlist.php"); // Return to list
			}
		}
	}
