 ...
 * Page class
 */
class pres_mas_unit_edit extends pres_mas_unit
{
	...
	// Page object name
	public $PageObjName = "pres_mas_unit_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Units
			$this->Units->setDbValueDef($rsnew, $this->Units->CurrentValue, "", $this->Units->ReadOnly);
