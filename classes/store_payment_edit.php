 ...
 * Page class
 */
class store_payment_edit extends store_payment
{
	...
	// Page object name
	public $PageObjName = "store_payment_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("store_grn", $detailTblVar) && $GLOBALS["store_grn"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("store_grn", $detailTblVar) && $GLOBALS["store_grn"]->DetailEdit) {
						...
						$editRow = $GLOBALS["store_grn_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("store_grn", $detailTblVar)) {
				...
				if ($GLOBALS["store_grn_grid"]->DetailEdit) {
					$GLOBALS["store_grn_grid"]->CurrentMode = "edit";
					$GLOBALS["store_grn_grid"]->CurrentAction = "gridedit";
