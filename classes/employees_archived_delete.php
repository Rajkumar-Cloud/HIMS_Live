 ...
 * Page class
 */
class employees_archived_delete extends employees_archived
{
	...
	// Page object name
	public $PageObjName = "employees_archived_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employees_archivedlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employees_archivedlist.php"); // Return to list
			}
		}
	}
