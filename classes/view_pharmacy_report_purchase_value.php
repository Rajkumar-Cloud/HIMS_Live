 ...
 */
class view_pharmacy_report_purchase_value extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// PRC
		$this->PRC = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// BatchNo
		$this->BatchNo = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, -1, FALSE, '`BatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchNo->Sortable = TRUE; // Allow sort
		$this->fields['BatchNo'] = &$this->BatchNo;

		// MRP
		$this->MRP = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// PurValue
		$this->PurValue = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// PUnit
		$this->PUnit = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, -1, FALSE, '`PUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_report_purchase_value', 'view_pharmacy_report_purchase_value', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_report_purchase_valuelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_report_purchase_valueview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_report_purchase_valueedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_report_purchase_valueadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_report_purchase_valueview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_report_purchase_valueview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_report_purchase_valueadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_report_purchase_valueadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_report_purchase_valueedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_report_purchase_valueadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_report_purchase_valuedelete.php", $this->getUrlParm());
	}
