 ...
 * Page class
 */
class view_semenanalysis_edit extends view_semenanalysis
{
	...
	// Page object name
	public $PageObjName = "view_semenanalysis_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// CollectionDate
			$this->CollectionDate->setDbValueDef($rsnew, UnFormatDateTime($this->CollectionDate->CurrentValue, 7), NULL, $this->CollectionDate->ReadOnly);

			// ResultDate
			$this->ResultDate->setDbValueDef($rsnew, UnFormatDateTime($this->ResultDate->CurrentValue, 7), NULL, $this->ResultDate->ReadOnly);
			...
			// PREG_TEST_DATE
			$this->PREG_TEST_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->PREG_TEST_DATE->CurrentValue, 7), NULL, $this->PREG_TEST_DATE->ReadOnly);
