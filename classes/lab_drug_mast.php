...
class lab_drug_mast extends DbTable
{
	...
	public function __construct()
	{
		...
		// DrugName
		$this->DrugName = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_DrugName', 'DrugName', '`DrugName`', '`DrugName`', 200, -1, FALSE, '`DrugName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Positive
		$this->Positive = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_Positive', 'Positive', '`Positive`', '`Positive`', 200, -1, FALSE, '`Positive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Negative
		$this->Negative = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_Negative', 'Negative', '`Negative`', '`Negative`', 200, -1, FALSE, '`Negative`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ShortName
		$this->ShortName = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_ShortName', 'ShortName', '`ShortName`', '`ShortName`', 200, -1, FALSE, '`ShortName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GroupCD
		$this->GroupCD = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_GroupCD', 'GroupCD', '`GroupCD`', '`GroupCD`', 200, -1, FALSE, '`GroupCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Content
		$this->Content = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_Content', 'Content', '`Content`', '`Content`', 200, -1, FALSE, '`Content`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Order
		$this->Order = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_Order', 'Order', '`Order`', '`Order`', 131, -1, FALSE, '`Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrugCD
		$this->DrugCD = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_DrugCD', 'DrugCD', '`DrugCD`', '`DrugCD`', 200, -1, FALSE, '`DrugCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id
		$this->id = new DbField('lab_drug_mast', 'lab_drug_mast', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("lab_drug_mastview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
