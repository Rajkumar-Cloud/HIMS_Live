 ...
 */
class ivf_embryology_chart extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNo
		$this->RIDNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->IsForeignKey = TRUE; // Foreign key field
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// ARTCycle
		$this->ARTCycle = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ARTCycle', 'ARTCycle', '`ARTCycle`', '`ARTCycle`', 200, -1, FALSE, '`ARTCycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ARTCycle->Sortable = TRUE; // Allow sort
		$this->fields['ARTCycle'] = &$this->ARTCycle;

		// SpermOrigin
		$this->SpermOrigin = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_SpermOrigin', 'SpermOrigin', '`SpermOrigin`', '`SpermOrigin`', 200, -1, FALSE, '`SpermOrigin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SpermOrigin->Sortable = TRUE; // Allow sort
		$this->fields['SpermOrigin'] = &$this->SpermOrigin;

		// InseminatinTechnique
		$this->InseminatinTechnique = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_InseminatinTechnique', 'InseminatinTechnique', '`InseminatinTechnique`', '`InseminatinTechnique`', 200, -1, FALSE, '`InseminatinTechnique`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->InseminatinTechnique->Sortable = TRUE; // Allow sort
		$this->fields['InseminatinTechnique'] = &$this->InseminatinTechnique;

		// IndicationForART
		$this->IndicationForART = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_IndicationForART', 'IndicationForART', '`IndicationForART`', '`IndicationForART`', 200, -1, FALSE, '`IndicationForART`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IndicationForART->Sortable = TRUE; // Allow sort
		$this->fields['IndicationForART'] = &$this->IndicationForART;

		// Day0sino
		$this->Day0sino = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0sino', 'Day0sino', '`Day0sino`', '`Day0sino`', 200, -1, FALSE, '`Day0sino`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day0sino->Sortable = TRUE; // Allow sort
		$this->fields['Day0sino'] = &$this->Day0sino;

		// Day0OocyteStage
		$this->Day0OocyteStage = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0OocyteStage', 'Day0OocyteStage', '`Day0OocyteStage`', '`Day0OocyteStage`', 200, -1, FALSE, '`Day0OocyteStage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day0OocyteStage->Sortable = TRUE; // Allow sort
		$this->fields['Day0OocyteStage'] = &$this->Day0OocyteStage;

		// Day0PolarBodyPosition
		$this->Day0PolarBodyPosition = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0PolarBodyPosition', 'Day0PolarBodyPosition', '`Day0PolarBodyPosition`', '`Day0PolarBodyPosition`', 200, -1, FALSE, '`Day0PolarBodyPosition`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day0Breakage
		$this->Day0Breakage = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0Breakage', 'Day0Breakage', '`Day0Breakage`', '`Day0Breakage`', 200, -1, FALSE, '`Day0Breakage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day0Attempts
		$this->Day0Attempts = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0Attempts', 'Day0Attempts', '`Day0Attempts`', '`Day0Attempts`', 200, -1, FALSE, '`Day0Attempts`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day0SPZMorpho
		$this->Day0SPZMorpho = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0SPZMorpho', 'Day0SPZMorpho', '`Day0SPZMorpho`', '`Day0SPZMorpho`', 200, -1, FALSE, '`Day0SPZMorpho`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day0SPZLocation
		$this->Day0SPZLocation = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0SPZLocation', 'Day0SPZLocation', '`Day0SPZLocation`', '`Day0SPZLocation`', 200, -1, FALSE, '`Day0SPZLocation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day0SpOrgin
		$this->Day0SpOrgin = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day0SpOrgin', 'Day0SpOrgin', '`Day0SpOrgin`', '`Day0SpOrgin`', 200, -1, FALSE, '`Day0SpOrgin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5Cryoptop
		$this->Day5Cryoptop = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5Cryoptop', 'Day5Cryoptop', '`Day5Cryoptop`', '`Day5Cryoptop`', 200, -1, FALSE, '`Day5Cryoptop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day1Sperm
		$this->Day1Sperm = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1Sperm', 'Day1Sperm', '`Day1Sperm`', '`Day1Sperm`', 200, -1, FALSE, '`Day1Sperm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day1Sperm->Sortable = TRUE; // Allow sort
		$this->fields['Day1Sperm'] = &$this->Day1Sperm;

		// Day1PN
		$this->Day1PN = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1PN', 'Day1PN', '`Day1PN`', '`Day1PN`', 200, -1, FALSE, '`Day1PN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day1PB
		$this->Day1PB = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1PB', 'Day1PB', '`Day1PB`', '`Day1PB`', 200, -1, FALSE, '`Day1PB`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day1Pronucleus
		$this->Day1Pronucleus = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1Pronucleus', 'Day1Pronucleus', '`Day1Pronucleus`', '`Day1Pronucleus`', 200, -1, FALSE, '`Day1Pronucleus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day1Nucleolus
		$this->Day1Nucleolus = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1Nucleolus', 'Day1Nucleolus', '`Day1Nucleolus`', '`Day1Nucleolus`', 200, -1, FALSE, '`Day1Nucleolus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day1Halo
		$this->Day1Halo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1Halo', 'Day1Halo', '`Day1Halo`', '`Day1Halo`', 200, -1, FALSE, '`Day1Halo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day2SiNo
		$this->Day2SiNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2SiNo', 'Day2SiNo', '`Day2SiNo`', '`Day2SiNo`', 200, -1, FALSE, '`Day2SiNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day2SiNo->Sortable = TRUE; // Allow sort
		$this->fields['Day2SiNo'] = &$this->Day2SiNo;

		// Day2CellNo
		$this->Day2CellNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2CellNo', 'Day2CellNo', '`Day2CellNo`', '`Day2CellNo`', 200, -1, FALSE, '`Day2CellNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day2CellNo->Sortable = TRUE; // Allow sort
		$this->fields['Day2CellNo'] = &$this->Day2CellNo;

		// Day2Frag
		$this->Day2Frag = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2Frag', 'Day2Frag', '`Day2Frag`', '`Day2Frag`', 200, -1, FALSE, '`Day2Frag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day2Frag->Sortable = TRUE; // Allow sort
		$this->fields['Day2Frag'] = &$this->Day2Frag;

		// Day2Symmetry
		$this->Day2Symmetry = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2Symmetry', 'Day2Symmetry', '`Day2Symmetry`', '`Day2Symmetry`', 200, -1, FALSE, '`Day2Symmetry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day2Symmetry->Sortable = TRUE; // Allow sort
		$this->fields['Day2Symmetry'] = &$this->Day2Symmetry;

		// Day2Cryoptop
		$this->Day2Cryoptop = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2Cryoptop', 'Day2Cryoptop', '`Day2Cryoptop`', '`Day2Cryoptop`', 200, -1, FALSE, '`Day2Cryoptop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day2Cryoptop->Sortable = TRUE; // Allow sort
		$this->fields['Day2Cryoptop'] = &$this->Day2Cryoptop;

		// Day2Grade
		$this->Day2Grade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2Grade', 'Day2Grade', '`Day2Grade`', '`Day2Grade`', 200, -1, FALSE, '`Day2Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day2Grade->Sortable = TRUE; // Allow sort
		$this->fields['Day2Grade'] = &$this->Day2Grade;

		// Day2End
		$this->Day2End = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day2End', 'Day2End', '`Day2End`', '`Day2End`', 200, -1, FALSE, '`Day2End`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3Sino
		$this->Day3Sino = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3Sino', 'Day3Sino', '`Day3Sino`', '`Day3Sino`', 200, -1, FALSE, '`Day3Sino`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day3Sino->Sortable = TRUE; // Allow sort
		$this->fields['Day3Sino'] = &$this->Day3Sino;

		// Day3CellNo
		$this->Day3CellNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3CellNo', 'Day3CellNo', '`Day3CellNo`', '`Day3CellNo`', 200, -1, FALSE, '`Day3CellNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day3CellNo->Sortable = TRUE; // Allow sort
		$this->fields['Day3CellNo'] = &$this->Day3CellNo;

		// Day3Frag
		$this->Day3Frag = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3Frag', 'Day3Frag', '`Day3Frag`', '`Day3Frag`', 200, -1, FALSE, '`Day3Frag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3Symmetry
		$this->Day3Symmetry = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3Symmetry', 'Day3Symmetry', '`Day3Symmetry`', '`Day3Symmetry`', 200, -1, FALSE, '`Day3Symmetry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3ZP
		$this->Day3ZP = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3ZP', 'Day3ZP', '`Day3ZP`', '`Day3ZP`', 200, -1, FALSE, '`Day3ZP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3Vacoules
		$this->Day3Vacoules = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3Vacoules', 'Day3Vacoules', '`Day3Vacoules`', '`Day3Vacoules`', 200, -1, FALSE, '`Day3Vacoules`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3Grade
		$this->Day3Grade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3Grade', 'Day3Grade', '`Day3Grade`', '`Day3Grade`', 200, -1, FALSE, '`Day3Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3Cryoptop
		$this->Day3Cryoptop = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3Cryoptop', 'Day3Cryoptop', '`Day3Cryoptop`', '`Day3Cryoptop`', 200, -1, FALSE, '`Day3Cryoptop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day3End
		$this->Day3End = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day3End', 'Day3End', '`Day3End`', '`Day3End`', 200, -1, FALSE, '`Day3End`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day4SiNo
		$this->Day4SiNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4SiNo', 'Day4SiNo', '`Day4SiNo`', '`Day4SiNo`', 200, -1, FALSE, '`Day4SiNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day4SiNo->Sortable = TRUE; // Allow sort
		$this->fields['Day4SiNo'] = &$this->Day4SiNo;

		// Day4CellNo
		$this->Day4CellNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4CellNo', 'Day4CellNo', '`Day4CellNo`', '`Day4CellNo`', 200, -1, FALSE, '`Day4CellNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day4CellNo->Sortable = TRUE; // Allow sort
		$this->fields['Day4CellNo'] = &$this->Day4CellNo;

		// Day4Frag
		$this->Day4Frag = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4Frag', 'Day4Frag', '`Day4Frag`', '`Day4Frag`', 200, -1, FALSE, '`Day4Frag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day4Frag->Sortable = TRUE; // Allow sort
		$this->fields['Day4Frag'] = &$this->Day4Frag;

		// Day4Symmetry
		$this->Day4Symmetry = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4Symmetry', 'Day4Symmetry', '`Day4Symmetry`', '`Day4Symmetry`', 200, -1, FALSE, '`Day4Symmetry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day4Symmetry->Sortable = TRUE; // Allow sort
		$this->fields['Day4Symmetry'] = &$this->Day4Symmetry;

		// Day4Grade
		$this->Day4Grade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4Grade', 'Day4Grade', '`Day4Grade`', '`Day4Grade`', 200, -1, FALSE, '`Day4Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day4Grade->Sortable = TRUE; // Allow sort
		$this->fields['Day4Grade'] = &$this->Day4Grade;

		// Day4Cryoptop
		$this->Day4Cryoptop = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4Cryoptop', 'Day4Cryoptop', '`Day4Cryoptop`', '`Day4Cryoptop`', 200, -1, FALSE, '`Day4Cryoptop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day4End
		$this->Day4End = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day4End', 'Day4End', '`Day4End`', '`Day4End`', 200, -1, FALSE, '`Day4End`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5CellNo
		$this->Day5CellNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5CellNo', 'Day5CellNo', '`Day5CellNo`', '`Day5CellNo`', 200, -1, FALSE, '`Day5CellNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day5CellNo->Sortable = TRUE; // Allow sort
		$this->fields['Day5CellNo'] = &$this->Day5CellNo;

		// Day5ICM
		$this->Day5ICM = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5ICM', 'Day5ICM', '`Day5ICM`', '`Day5ICM`', 200, -1, FALSE, '`Day5ICM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5TE
		$this->Day5TE = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5TE', 'Day5TE', '`Day5TE`', '`Day5TE`', 200, -1, FALSE, '`Day5TE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5Observation
		$this->Day5Observation = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5Observation', 'Day5Observation', '`Day5Observation`', '`Day5Observation`', 200, -1, FALSE, '`Day5Observation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5Collapsed
		$this->Day5Collapsed = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5Collapsed', 'Day5Collapsed', '`Day5Collapsed`', '`Day5Collapsed`', 200, -1, FALSE, '`Day5Collapsed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5Vacoulles
		$this->Day5Vacoulles = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5Vacoulles', 'Day5Vacoulles', '`Day5Vacoulles`', '`Day5Vacoulles`', 200, -1, FALSE, '`Day5Vacoulles`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day5Grade
		$this->Day5Grade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day5Grade', 'Day5Grade', '`Day5Grade`', '`Day5Grade`', 200, -1, FALSE, '`Day5Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6CellNo
		$this->Day6CellNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6CellNo', 'Day6CellNo', '`Day6CellNo`', '`Day6CellNo`', 200, -1, FALSE, '`Day6CellNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day6CellNo->Sortable = TRUE; // Allow sort
		$this->fields['Day6CellNo'] = &$this->Day6CellNo;

		// Day6ICM
		$this->Day6ICM = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6ICM', 'Day6ICM', '`Day6ICM`', '`Day6ICM`', 200, -1, FALSE, '`Day6ICM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6TE
		$this->Day6TE = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6TE', 'Day6TE', '`Day6TE`', '`Day6TE`', 200, -1, FALSE, '`Day6TE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6Observation
		$this->Day6Observation = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6Observation', 'Day6Observation', '`Day6Observation`', '`Day6Observation`', 200, -1, FALSE, '`Day6Observation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6Collapsed
		$this->Day6Collapsed = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6Collapsed', 'Day6Collapsed', '`Day6Collapsed`', '`Day6Collapsed`', 200, -1, FALSE, '`Day6Collapsed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6Vacoulles
		$this->Day6Vacoulles = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6Vacoulles', 'Day6Vacoulles', '`Day6Vacoulles`', '`Day6Vacoulles`', 200, -1, FALSE, '`Day6Vacoulles`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6Grade
		$this->Day6Grade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6Grade', 'Day6Grade', '`Day6Grade`', '`Day6Grade`', 200, -1, FALSE, '`Day6Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Day6Cryoptop
		$this->Day6Cryoptop = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day6Cryoptop', 'Day6Cryoptop', '`Day6Cryoptop`', '`Day6Cryoptop`', 200, -1, FALSE, '`Day6Cryoptop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Day6Cryoptop->Sortable = TRUE; // Allow sort
		$this->fields['Day6Cryoptop'] = &$this->Day6Cryoptop;

		// EndSiNo
		$this->EndSiNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_EndSiNo', 'EndSiNo', '`EndSiNo`', '`EndSiNo`', 200, -1, FALSE, '`EndSiNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EndSiNo->Sortable = TRUE; // Allow sort
		$this->fields['EndSiNo'] = &$this->EndSiNo;

		// EndingDay
		$this->EndingDay = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_EndingDay', 'EndingDay', '`EndingDay`', '`EndingDay`', 200, -1, FALSE, '`EndingDay`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// EndingCellStage
		$this->EndingCellStage = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_EndingCellStage', 'EndingCellStage', '`EndingCellStage`', '`EndingCellStage`', 200, -1, FALSE, '`EndingCellStage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EndingCellStage->Sortable = TRUE; // Allow sort
		$this->fields['EndingCellStage'] = &$this->EndingCellStage;

		// EndingGrade
		$this->EndingGrade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_EndingGrade', 'EndingGrade', '`EndingGrade`', '`EndingGrade`', 200, -1, FALSE, '`EndingGrade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// EndingState
		$this->EndingState = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_EndingState', 'EndingState', '`EndingState`', '`EndingState`', 200, -1, FALSE, '`EndingState`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TidNo
		$this->TidNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DidNO
		$this->DidNO = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_DidNO', 'DidNO', '`DidNO`', '`DidNO`', 200, -1, FALSE, '`DidNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DidNO->IsForeignKey = TRUE; // Foreign key field
		$this->DidNO->Sortable = TRUE; // Allow sort
		$this->fields['DidNO'] = &$this->DidNO;

		// ICSiIVFDateTime
		$this->ICSiIVFDateTime = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ICSiIVFDateTime', 'ICSiIVFDateTime', '`ICSiIVFDateTime`', CastDateFieldForLike('`ICSiIVFDateTime`', 0, "DB"), 135, 0, FALSE, '`ICSiIVFDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrimaryEmbrologist
		$this->PrimaryEmbrologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_PrimaryEmbrologist', 'PrimaryEmbrologist', '`PrimaryEmbrologist`', '`PrimaryEmbrologist`', 200, -1, FALSE, '`PrimaryEmbrologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SecondaryEmbrologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_SecondaryEmbrologist', 'SecondaryEmbrologist', '`SecondaryEmbrologist`', '`SecondaryEmbrologist`', 200, -1, FALSE, '`SecondaryEmbrologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SecondaryEmbrologist->Sortable = TRUE; // Allow sort
		$this->fields['SecondaryEmbrologist'] = &$this->SecondaryEmbrologist;

		// Incubator
		$this->Incubator = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Incubator', 'Incubator', '`Incubator`', '`Incubator`', 200, -1, FALSE, '`Incubator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Incubator->Sortable = TRUE; // Allow sort
		$this->fields['Incubator'] = &$this->Incubator;

		// location
		$this->location = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_location', 'location', '`location`', '`location`', 200, -1, FALSE, '`location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->location->Sortable = TRUE; // Allow sort
		$this->fields['location'] = &$this->location;

		// OocyteNo
		$this->OocyteNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_OocyteNo', 'OocyteNo', '`OocyteNo`', '`OocyteNo`', 200, -1, FALSE, '`OocyteNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OocyteNo->Sortable = TRUE; // Allow sort
		$this->fields['OocyteNo'] = &$this->OocyteNo;

		// Stage
		$this->Stage = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Stage', 'Stage', '`Stage`', '`Stage`', 200, -1, FALSE, '`Stage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Remarks
		$this->Remarks = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// vitrificationDate
		$this->vitrificationDate = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitrificationDate', 'vitrificationDate', '`vitrificationDate`', CastDateFieldForLike('`vitrificationDate`', 0, "DB"), 135, 0, FALSE, '`vitrificationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->vitriPrimaryEmbryologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriPrimaryEmbryologist', 'vitriPrimaryEmbryologist', '`vitriPrimaryEmbryologist`', '`vitriPrimaryEmbryologist`', 200, -1, FALSE, '`vitriPrimaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->vitriSecondaryEmbryologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriSecondaryEmbryologist', 'vitriSecondaryEmbryologist', '`vitriSecondaryEmbryologist`', '`vitriSecondaryEmbryologist`', 200, -1, FALSE, '`vitriSecondaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// vitriEmbryoNo
		$this->vitriEmbryoNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriEmbryoNo', 'vitriEmbryoNo', '`vitriEmbryoNo`', '`vitriEmbryoNo`', 200, -1, FALSE, '`vitriEmbryoNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriEmbryoNo->Sortable = TRUE; // Allow sort
		$this->fields['vitriEmbryoNo'] = &$this->vitriEmbryoNo;

		// thawReFrozen
		$this->thawReFrozen = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawReFrozen', 'thawReFrozen', '`thawReFrozen`', '`thawReFrozen`', 200, -1, FALSE, '`thawReFrozen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		$this->vitriFertilisationDate = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriFertilisationDate', 'vitriFertilisationDate', '`vitriFertilisationDate`', CastDateFieldForLike('`vitriFertilisationDate`', 0, "DB"), 135, 0, FALSE, '`vitriFertilisationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// vitriDay
		$this->vitriDay = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriDay', 'vitriDay', '`vitriDay`', '`vitriDay`', 200, -1, FALSE, '`vitriDay`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// vitriStage
		$this->vitriStage = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriStage', 'vitriStage', '`vitriStage`', '`vitriStage`', 200, -1, FALSE, '`vitriStage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriStage->Sortable = TRUE; // Allow sort
		$this->fields['vitriStage'] = &$this->vitriStage;

		// vitriGrade
		$this->vitriGrade = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriGrade', 'vitriGrade', '`vitriGrade`', '`vitriGrade`', 200, -1, FALSE, '`vitriGrade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// vitriIncubator
		$this->vitriIncubator = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriIncubator', 'vitriIncubator', '`vitriIncubator`', '`vitriIncubator`', 200, -1, FALSE, '`vitriIncubator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriIncubator->Sortable = TRUE; // Allow sort
		$this->fields['vitriIncubator'] = &$this->vitriIncubator;

		// vitriTank
		$this->vitriTank = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriTank', 'vitriTank', '`vitriTank`', '`vitriTank`', 200, -1, FALSE, '`vitriTank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriTank->Sortable = TRUE; // Allow sort
		$this->fields['vitriTank'] = &$this->vitriTank;

		// vitriCanister
		$this->vitriCanister = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriCanister', 'vitriCanister', '`vitriCanister`', '`vitriCanister`', 200, -1, FALSE, '`vitriCanister`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriCanister->Sortable = TRUE; // Allow sort
		$this->fields['vitriCanister'] = &$this->vitriCanister;

		// vitriGobiet
		$this->vitriGobiet = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriGobiet', 'vitriGobiet', '`vitriGobiet`', '`vitriGobiet`', 200, -1, FALSE, '`vitriGobiet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriGobiet->Sortable = TRUE; // Allow sort
		$this->fields['vitriGobiet'] = &$this->vitriGobiet;

		// vitriViscotube
		$this->vitriViscotube = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriViscotube', 'vitriViscotube', '`vitriViscotube`', '`vitriViscotube`', 200, -1, FALSE, '`vitriViscotube`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriViscotube->Sortable = TRUE; // Allow sort
		$this->fields['vitriViscotube'] = &$this->vitriViscotube;

		// vitriCryolockNo
		$this->vitriCryolockNo = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriCryolockNo', 'vitriCryolockNo', '`vitriCryolockNo`', '`vitriCryolockNo`', 200, -1, FALSE, '`vitriCryolockNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriCryolockNo->Sortable = TRUE; // Allow sort
		$this->fields['vitriCryolockNo'] = &$this->vitriCryolockNo;

		// vitriCryolockColour
		$this->vitriCryolockColour = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_vitriCryolockColour', 'vitriCryolockColour', '`vitriCryolockColour`', '`vitriCryolockColour`', 200, -1, FALSE, '`vitriCryolockColour`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vitriCryolockColour->Sortable = TRUE; // Allow sort
		$this->fields['vitriCryolockColour'] = &$this->vitriCryolockColour;

		// thawDate
		$this->thawDate = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawDate', 'thawDate', '`thawDate`', CastDateFieldForLike('`thawDate`', 0, "DB"), 135, 0, FALSE, '`thawDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->thawPrimaryEmbryologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawPrimaryEmbryologist', 'thawPrimaryEmbryologist', '`thawPrimaryEmbryologist`', '`thawPrimaryEmbryologist`', 200, -1, FALSE, '`thawPrimaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->thawSecondaryEmbryologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawSecondaryEmbryologist', 'thawSecondaryEmbryologist', '`thawSecondaryEmbryologist`', '`thawSecondaryEmbryologist`', 200, -1, FALSE, '`thawSecondaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// thawET
		$this->thawET = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawET', 'thawET', '`thawET`', '`thawET`', 200, -1, FALSE, '`thawET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// thawAbserve
		$this->thawAbserve = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawAbserve', 'thawAbserve', '`thawAbserve`', '`thawAbserve`', 200, -1, FALSE, '`thawAbserve`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->thawAbserve->Sortable = TRUE; // Allow sort
		$this->fields['thawAbserve'] = &$this->thawAbserve;

		// thawDiscard
		$this->thawDiscard = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_thawDiscard', 'thawDiscard', '`thawDiscard`', '`thawDiscard`', 200, -1, FALSE, '`thawDiscard`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->thawDiscard->Sortable = TRUE; // Allow sort
		$this->fields['thawDiscard'] = &$this->thawDiscard;

		// ETCatheter
		$this->ETCatheter = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETCatheter', 'ETCatheter', '`ETCatheter`', '`ETCatheter`', 200, -1, FALSE, '`ETCatheter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ETCatheter->Sortable = TRUE; // Allow sort
		$this->fields['ETCatheter'] = &$this->ETCatheter;

		// ETDifficulty
		$this->ETDifficulty = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETDifficulty', 'ETDifficulty', '`ETDifficulty`', '`ETDifficulty`', 200, -1, FALSE, '`ETDifficulty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ETEasy
		$this->ETEasy = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETEasy', 'ETEasy', '`ETEasy`', '`ETEasy`', 200, -1, FALSE, '`ETEasy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// ETComments
		$this->ETComments = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETComments', 'ETComments', '`ETComments`', '`ETComments`', 200, -1, FALSE, '`ETComments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ETComments->Sortable = TRUE; // Allow sort
		$this->fields['ETComments'] = &$this->ETComments;

		// ETDoctor
		$this->ETDoctor = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETDoctor', 'ETDoctor', '`ETDoctor`', '`ETDoctor`', 200, -1, FALSE, '`ETDoctor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ETDoctor->Sortable = TRUE; // Allow sort
		$this->fields['ETDoctor'] = &$this->ETDoctor;

		// ETEmbryologist
		$this->ETEmbryologist = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETEmbryologist', 'ETEmbryologist', '`ETEmbryologist`', '`ETEmbryologist`', 200, -1, FALSE, '`ETEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ETEmbryologist->Sortable = TRUE; // Allow sort
		$this->fields['ETEmbryologist'] = &$this->ETEmbryologist;

		// ETDate
		$this->ETDate = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_ETDate', 'ETDate', '`ETDate`', CastDateFieldForLike('`ETDate`', 0, "DB"), 135, 0, FALSE, '`ETDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day1End
		$this->Day1End = new DbField('ivf_embryology_chart', 'ivf_embryology_chart', 'x_Day1End', 'Day1End', '`Day1End`', '`Day1End`', 200, -1, FALSE, '`Day1End`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getMasterFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "ivf_oocytedenudation") {
			if ($this->DidNO->getSessionValue() <> "")
				$masterFilter .= "`id`=" . QuotedValue($this->DidNO->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "ivf_oocytedenudation") {
			if ($this->DidNO->getSessionValue() <> "")
				$detailFilter .= "`DidNO`=" . QuotedValue($this->DidNO->getSessionValue(), DATATYPE_STRING, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ivf_embryology_chartlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "ivf_embryology_chartedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ivf_embryology_chartadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("ivf_embryology_chartview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ivf_embryology_chartview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "ivf_embryology_chartadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ivf_embryology_chartadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ivf_embryology_chartedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ivf_embryology_chartadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ivf_embryology_chartdelete.php", $this->getUrlParm());
	}
	...
	public function addMasterUrl($url)
	{
		...
		if ($this->getCurrentMasterTable() == "ivf_oocytedenudation" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->DidNO->CurrentValue);
		}
		return $url;
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Day0PolarBodyPosition->setDbValue($rs->fields('Day0PolarBodyPosition'));
		$this->Day0Breakage->setDbValue($rs->fields('Day0Breakage'));
		$this->Day0Attempts->setDbValue($rs->fields('Day0Attempts'));
		$this->Day0SPZMorpho->setDbValue($rs->fields('Day0SPZMorpho'));
		$this->Day0SPZLocation->setDbValue($rs->fields('Day0SPZLocation'));
		$this->Day0SpOrgin->setDbValue($rs->fields('Day0SpOrgin'));
		$this->Day5Cryoptop->setDbValue($rs->fields('Day5Cryoptop'));
		$this->Day1Sperm->setDbValue($rs->fields('Day1Sperm'));
		$this->Day1PN->setDbValue($rs->fields('Day1PN'));
		$this->Day1PB->setDbValue($rs->fields('Day1PB'));
		$this->Day1Pronucleus->setDbValue($rs->fields('Day1Pronucleus'));
		$this->Day1Nucleolus->setDbValue($rs->fields('Day1Nucleolus'));
		$this->Day1Halo->setDbValue($rs->fields('Day1Halo'));
		$this->Day2SiNo->setDbValue($rs->fields('Day2SiNo'));
		$this->Day2CellNo->setDbValue($rs->fields('Day2CellNo'));
		$this->Day2Frag->setDbValue($rs->fields('Day2Frag'));
		$this->Day2Symmetry->setDbValue($rs->fields('Day2Symmetry'));
		$this->Day2Cryoptop->setDbValue($rs->fields('Day2Cryoptop'));
		$this->Day2Grade->setDbValue($rs->fields('Day2Grade'));
		$this->Day2End->setDbValue($rs->fields('Day2End'));
		$this->Day3Sino->setDbValue($rs->fields('Day3Sino'));
		$this->Day3CellNo->setDbValue($rs->fields('Day3CellNo'));
		$this->Day3Frag->setDbValue($rs->fields('Day3Frag'));
		$this->Day3Symmetry->setDbValue($rs->fields('Day3Symmetry'));
		$this->Day3ZP->setDbValue($rs->fields('Day3ZP'));
		$this->Day3Vacoules->setDbValue($rs->fields('Day3Vacoules'));
		$this->Day3Grade->setDbValue($rs->fields('Day3Grade'));
		$this->Day3Cryoptop->setDbValue($rs->fields('Day3Cryoptop'));
		$this->Day3End->setDbValue($rs->fields('Day3End'));
		$this->Day4SiNo->setDbValue($rs->fields('Day4SiNo'));
		$this->Day4CellNo->setDbValue($rs->fields('Day4CellNo'));
		$this->Day4Frag->setDbValue($rs->fields('Day4Frag'));
		$this->Day4Symmetry->setDbValue($rs->fields('Day4Symmetry'));
		$this->Day4Grade->setDbValue($rs->fields('Day4Grade'));
		$this->Day4Cryoptop->setDbValue($rs->fields('Day4Cryoptop'));
		$this->Day4End->setDbValue($rs->fields('Day4End'));
		$this->Day5CellNo->setDbValue($rs->fields('Day5CellNo'));
		$this->Day5ICM->setDbValue($rs->fields('Day5ICM'));
		$this->Day5TE->setDbValue($rs->fields('Day5TE'));
		$this->Day5Observation->setDbValue($rs->fields('Day5Observation'));
		$this->Day5Collapsed->setDbValue($rs->fields('Day5Collapsed'));
		$this->Day5Vacoulles->setDbValue($rs->fields('Day5Vacoulles'));
		$this->Day5Grade->setDbValue($rs->fields('Day5Grade'));
		$this->Day6CellNo->setDbValue($rs->fields('Day6CellNo'));
		$this->Day6ICM->setDbValue($rs->fields('Day6ICM'));
		$this->Day6TE->setDbValue($rs->fields('Day6TE'));
		$this->Day6Observation->setDbValue($rs->fields('Day6Observation'));
		$this->Day6Collapsed->setDbValue($rs->fields('Day6Collapsed'));
		$this->Day6Vacoulles->setDbValue($rs->fields('Day6Vacoulles'));
		$this->Day6Grade->setDbValue($rs->fields('Day6Grade'));
		$this->Day6Cryoptop->setDbValue($rs->fields('Day6Cryoptop'));
		$this->EndSiNo->setDbValue($rs->fields('EndSiNo'));
		$this->EndingDay->setDbValue($rs->fields('EndingDay'));
		$this->EndingCellStage->setDbValue($rs->fields('EndingCellStage'));
		$this->EndingGrade->setDbValue($rs->fields('EndingGrade'));
		$this->EndingState->setDbValue($rs->fields('EndingState'));
		$this->TidNo->setDbValue($rs->fields('TidNo'));
		$this->DidNO->setDbValue($rs->fields('DidNO'));
		$this->ICSiIVFDateTime->setDbValue($rs->fields('ICSiIVFDateTime'));
		$this->PrimaryEmbrologist->setDbValue($rs->fields('PrimaryEmbrologist'));
		$this->SecondaryEmbrologist->setDbValue($rs->fields('SecondaryEmbrologist'));
		...
		$this->vitriPrimaryEmbryologist->setDbValue($rs->fields('vitriPrimaryEmbryologist'));
		$this->vitriSecondaryEmbryologist->setDbValue($rs->fields('vitriSecondaryEmbryologist'));
		$this->vitriEmbryoNo->setDbValue($rs->fields('vitriEmbryoNo'));
		$this->thawReFrozen->setDbValue($rs->fields('thawReFrozen'));
		$this->vitriFertilisationDate->setDbValue($rs->fields('vitriFertilisationDate'));
		$this->vitriDay->setDbValue($rs->fields('vitriDay'));
		$this->vitriStage->setDbValue($rs->fields('vitriStage'));
		$this->vitriGrade->setDbValue($rs->fields('vitriGrade'));
		$this->vitriIncubator->setDbValue($rs->fields('vitriIncubator'));
		$this->vitriTank->setDbValue($rs->fields('vitriTank'));
		$this->vitriCanister->setDbValue($rs->fields('vitriCanister'));
		$this->vitriGobiet->setDbValue($rs->fields('vitriGobiet'));
		$this->vitriViscotube->setDbValue($rs->fields('vitriViscotube'));
		$this->vitriCryolockNo->setDbValue($rs->fields('vitriCryolockNo'));
		$this->vitriCryolockColour->setDbValue($rs->fields('vitriCryolockColour'));
		...
		$this->ETCatheter->setDbValue($rs->fields('ETCatheter'));
		$this->ETDifficulty->setDbValue($rs->fields('ETDifficulty'));
		$this->ETEasy->setDbValue($rs->fields('ETEasy'));
		$this->ETComments->setDbValue($rs->fields('ETComments'));
		$this->ETDoctor->setDbValue($rs->fields('ETDoctor'));
		$this->ETEmbryologist->setDbValue($rs->fields('ETEmbryologist'));
		$this->ETDate->setDbValue($rs->fields('ETDate'));
		$this->Day1End->setDbValue($rs->fields('Day1End'));
	}
