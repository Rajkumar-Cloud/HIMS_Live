 ...
 * Page class
 */
class view_pharmacytransfer_search extends view_pharmacytransfer
{
	...
	// Page object name
	public $PageObjName = "view_pharmacytransfer_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr <> "") {
					...
					$srchStr = "view_pharmacytransferlist.php" . "?" . $srchStr;
	...
	protected function loadSearchValues()
	{
		...
		// trid
		if (!$this->isAddOrEdit())
			$this->trid->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_trid"));
		$this->trid->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_trid"));
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->trid->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->trid->errorMessage());
		}
