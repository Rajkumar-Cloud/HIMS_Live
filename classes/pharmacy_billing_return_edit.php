 ...
 * Page class
 */
class pharmacy_billing_return_edit extends pharmacy_billing_return
{
	...
	// Page object name
	public $PageObjName = "pharmacy_billing_return_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("view_pharmacy_pharled_return", $detailTblVar) && $GLOBALS["view_pharmacy_pharled_return"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("view_pharmacy_pharled_return", $detailTblVar) && $GLOBALS["view_pharmacy_pharled_return"]->DetailEdit) {
						...
						$editRow = $GLOBALS["view_pharmacy_pharled_return_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("view_pharmacy_pharled_return", $detailTblVar)) {
				...
				if ($GLOBALS["view_pharmacy_pharled_return_grid"]->DetailEdit) {
					$GLOBALS["view_pharmacy_pharled_return_grid"]->CurrentMode = "edit";
					$GLOBALS["view_pharmacy_pharled_return_grid"]->CurrentAction = "gridedit";
