 ...
 * Page class
 */
class employee_emergency_contacts_delete extends employee_emergency_contacts
{
	...
	// Page object name
	public $PageObjName = "employee_emergency_contacts_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_emergency_contactslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_emergency_contactslist.php"); // Return to list
			}
		}
	}
