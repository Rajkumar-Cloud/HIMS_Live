...
class bankbranches extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('bankbranches', 'bankbranches', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Branch_Name
		$this->Branch_Name = new DbField('bankbranches', 'bankbranches', 'x_Branch_Name', 'Branch_Name', '`Branch_Name`', '`Branch_Name`', 200, -1, FALSE, '`Branch_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Street_Address
		$this->Street_Address = new DbField('bankbranches', 'bankbranches', 'x_Street_Address', 'Street_Address', '`Street_Address`', '`Street_Address`', 200, -1, FALSE, '`Street_Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// City
		$this->City = new DbField('bankbranches', 'bankbranches', 'x_City', 'City', '`City`', '`City`', 200, -1, FALSE, '`City`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// State
		$this->State = new DbField('bankbranches', 'bankbranches', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Zipcode
		$this->Zipcode = new DbField('bankbranches', 'bankbranches', 'x_Zipcode', 'Zipcode', '`Zipcode`', '`Zipcode`', 200, -1, FALSE, '`Zipcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Phone_Number
		$this->Phone_Number = new DbField('bankbranches', 'bankbranches', 'x_Phone_Number', 'Phone_Number', '`Phone_Number`', '`Phone_Number`', 200, -1, FALSE, '`Phone_Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccountNo
		$this->AccountNo = new DbField('bankbranches', 'bankbranches', 'x_AccountNo', 'AccountNo', '`AccountNo`', '`AccountNo`', 200, -1, FALSE, '`AccountNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("bankbranchesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
