 ...
 * Page class
 */
class pharmacy_billing_voucher_delete extends pharmacy_billing_voucher
{
	...
	// Page object name
	public $PageObjName = "pharmacy_billing_voucher_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_billing_voucherlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_billing_voucherlist.php"); // Return to list
			}
		}
	}
