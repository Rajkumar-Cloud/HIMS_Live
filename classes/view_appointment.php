...
class view_appointment extends DbTable
{
	...
	public function __construct()
	{
		...
		// PId
		$this->PId = new DbField('view_appointment', 'view_appointment', 'x_PId', 'PId', '`PId`', '`PId`', 3, -1, FALSE, '`PId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PId->Sortable = TRUE; // Allow sort
		$this->PId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PId'] = &$this->PId;

		// patientID
		$this->patientID = new DbField('view_appointment', 'view_appointment', 'x_patientID', 'patientID', '`patientID`', '`patientID`', 200, -1, FALSE, '`patientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->patientID->Sortable = TRUE; // Allow sort
		$this->fields['patientID'] = &$this->patientID;

		// patientName
		$this->patientName = new DbField('view_appointment', 'view_appointment', 'x_patientName', 'patientName', '`patientName`', '`patientName`', 200, -1, FALSE, '`patientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->patientName->Sortable = TRUE; // Allow sort
		$this->fields['patientName'] = &$this->patientName;

		// MobileNumber
		$this->MobileNumber = new DbField('view_appointment', 'view_appointment', 'x_MobileNumber', 'MobileNumber', '`MobileNumber`', '`MobileNumber`', 200, -1, FALSE, '`MobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['MobileNumber'] = &$this->MobileNumber;

		// Referal
		$this->Referal = new DbField('view_appointment', 'view_appointment', 'x_Referal', 'Referal', '`Referal`', '`Referal`', 200, -1, FALSE, '`Referal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Referal->Sortable = TRUE; // Allow sort
		$this->fields['Referal'] = &$this->Referal;

		// createdDateTime
		$this->createdDateTime = new DbField('view_appointment', 'view_appointment', 'x_createdDateTime', 'createdDateTime', '`createdDateTime`', CastDateFieldForLike('`createdDateTime`', 0, "DB"), 135, 0, FALSE, '`createdDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdDateTime->Sortable = TRUE; // Allow sort
		$this->createdDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createdDateTime'] = &$this->createdDateTime;

		// App
		$this->App = new DbField('view_appointment', 'view_appointment', 'x_App', 'App', '`App`', '`App`', 200, -1, FALSE, '`App`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_appointment', 'view_appointment', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_appointmentview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
