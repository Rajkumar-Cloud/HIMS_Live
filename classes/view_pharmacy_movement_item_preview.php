...
class view_pharmacy_movement_item_preview extends view_pharmacy_movement_item
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_pharmacy_movement") {
			$url = "" . TABLE_SHOW_MASTER . "=view_pharmacy_movement&fk_prc=" . urlencode(strval($this->prc->QueryStringValue)) . "&fk_BatchNo=" . urlencode(strval($this->BatchNo->QueryStringValue)) . "";
		}
		return $url;
	}
