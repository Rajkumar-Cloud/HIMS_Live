 ...
 * Page class
 */
class sms_curl_edit extends sms_curl
{
	...
	// Page object name
	public $PageObjName = "sms_curl_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// SMSType
			$this->SMSType->setDbValueDef($rsnew, $this->SMSType->CurrentValue, NULL, $this->SMSType->ReadOnly);
