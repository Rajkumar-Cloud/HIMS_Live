 ...
 * Page class
 */
class patient_vitals_delete extends patient_vitals
{
	...
	// Page object name
	public $PageObjName = "patient_vitals_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_vitalslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_vitalslist.php"); // Return to list
			}
		}
	}
