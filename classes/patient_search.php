...
class patient_search extends patient
{
	...
	protected function loadSearchValues()
	{
		...
		// title
		if (!$this->isAddOrEdit())
			$this->title->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_title"));
		$this->title->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_title"));

		// first_name
		if (!$this->isAddOrEdit())
			$this->first_name->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_first_name"));
		$this->first_name->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_first_name"));

		// middle_name
		if (!$this->isAddOrEdit())
			$this->middle_name->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_middle_name"));
		$this->middle_name->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_middle_name"));

		// last_name
		if (!$this->isAddOrEdit())
			$this->last_name->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_last_name"));
		$this->last_name->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_last_name"));
		...
		// blood_group
		if (!$this->isAddOrEdit())
			$this->blood_group->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_blood_group"));
		$this->blood_group->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_blood_group"));

		// mobile_no
		if (!$this->isAddOrEdit())
			$this->mobile_no->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_mobile_no"));
		$this->mobile_no->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_mobile_no"));
		...
		// IdentificationMark
		if (!$this->isAddOrEdit())
			$this->IdentificationMark->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IdentificationMark"));
		$this->IdentificationMark->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IdentificationMark"));

		// Religion
		if (!$this->isAddOrEdit())
			$this->Religion->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Religion"));
		$this->Religion->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Religion"));

		// Nationality
		if (!$this->isAddOrEdit())
			$this->Nationality->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Nationality"));
		$this->Nationality->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Nationality"));
		...
		// spouse_title
		if (!$this->isAddOrEdit())
			$this->spouse_title->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_title"));
		$this->spouse_title->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_title"));

		// spouse_first_name
		if (!$this->isAddOrEdit())
			$this->spouse_first_name->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_first_name"));
		$this->spouse_first_name->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_first_name"));

		// spouse_middle_name
		if (!$this->isAddOrEdit())
			$this->spouse_middle_name->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_middle_name"));
		$this->spouse_middle_name->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_middle_name"));

		// spouse_last_name
		if (!$this->isAddOrEdit())
			$this->spouse_last_name->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_last_name"));
		$this->spouse_last_name->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_last_name"));

		// spouse_gender
		if (!$this->isAddOrEdit())
			$this->spouse_gender->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_gender"));
		$this->spouse_gender->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_gender"));

		// spouse_dob
		if (!$this->isAddOrEdit())
			$this->spouse_dob->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_dob"));
		$this->spouse_dob->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_dob"));

		// spouse_Age
		if (!$this->isAddOrEdit())
			$this->spouse_Age->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_Age"));
		$this->spouse_Age->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_Age"));

		// spouse_blood_group
		if (!$this->isAddOrEdit())
			$this->spouse_blood_group->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_blood_group"));
		$this->spouse_blood_group->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_blood_group"));

		// spouse_mobile_no
		if (!$this->isAddOrEdit())
			$this->spouse_mobile_no->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_mobile_no"));
		$this->spouse_mobile_no->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_mobile_no"));

		// Maritalstatus
		if (!$this->isAddOrEdit())
			$this->Maritalstatus->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Maritalstatus"));
		$this->Maritalstatus->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Maritalstatus"));

		// Business
		if (!$this->isAddOrEdit())
			$this->Business->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Business"));
		$this->Business->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Business"));

		// Patient_Language
		if (!$this->isAddOrEdit())
			$this->Patient_Language->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Patient_Language"));
		$this->Patient_Language->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Patient_Language"));

		// Passport
		if (!$this->isAddOrEdit())
			$this->Passport->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Passport"));
		$this->Passport->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Passport"));

		// VisaNo
		if (!$this->isAddOrEdit())
			$this->VisaNo->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_VisaNo"));
		$this->VisaNo->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_VisaNo"));

		// ValidityOfVisa
		if (!$this->isAddOrEdit())
			$this->ValidityOfVisa->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ValidityOfVisa"));
		$this->ValidityOfVisa->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ValidityOfVisa"));

		// WhereDidYouHear
		if (!$this->isAddOrEdit())
			$this->WhereDidYouHear->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_WhereDidYouHear"));
		$this->WhereDidYouHear->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_WhereDidYouHear"));
		...
		// street
		if (!$this->isAddOrEdit())
			$this->street->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_street"));
		$this->street->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_street"));

		// town
		if (!$this->isAddOrEdit())
			$this->town->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_town"));
		$this->town->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_town"));

		// province
		if (!$this->isAddOrEdit())
			$this->province->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_province"));
		$this->province->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_province"));
		...
		// postal_code
		if (!$this->isAddOrEdit())
			$this->postal_code->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_postal_code"));
		$this->postal_code->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_postal_code"));

		// PEmail
		if (!$this->isAddOrEdit())
			$this->PEmail->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PEmail"));
		$this->PEmail->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PEmail"));

		// PEmergencyContact
		if (!$this->isAddOrEdit())
			$this->PEmergencyContact->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PEmergencyContact"));
		$this->PEmergencyContact->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PEmergencyContact"));

		// occupation
		if (!$this->isAddOrEdit())
			$this->occupation->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_occupation"));
		$this->occupation->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_occupation"));

		// spouse_occupation
		if (!$this->isAddOrEdit())
			$this->spouse_occupation->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_spouse_occupation"));
		$this->spouse_occupation->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_spouse_occupation"));

		// WhatsApp
		if (!$this->isAddOrEdit())
			$this->WhatsApp->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_WhatsApp"));
		$this->WhatsApp->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_WhatsApp"));

		// CouppleID
		if (!$this->isAddOrEdit())
			$this->CouppleID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_CouppleID"));
		$this->CouppleID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_CouppleID"));

		// MaleID
		if (!$this->isAddOrEdit())
			$this->MaleID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_MaleID"));
		$this->MaleID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_MaleID"));

		// FemaleID
		if (!$this->isAddOrEdit())
			$this->FemaleID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_FemaleID"));
		$this->FemaleID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_FemaleID"));

		// GroupID
		if (!$this->isAddOrEdit())
			$this->GroupID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_GroupID"));
		$this->GroupID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_GroupID"));

		// Relationship
		if (!$this->isAddOrEdit())
			$this->Relationship->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Relationship"));
		$this->Relationship->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Relationship"));

		// AppointmentSearch
		if (!$this->isAddOrEdit())
			$this->AppointmentSearch->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_AppointmentSearch"));
		$this->AppointmentSearch->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_AppointmentSearch"));

		// FacebookID
		if (!$this->isAddOrEdit())
			$this->FacebookID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_FacebookID"));
		$this->FacebookID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_FacebookID"));

		// Clients
		if (!$this->isAddOrEdit())
			$this->Clients->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Clients"));
		$this->Clients->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Clients"));
	}
