 ...
 * Page class
 */
class crm_crmentity_add extends crm_crmentity
{
	...
	// Page object name
	public $PageObjName = "crm_crmentity_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("crmid") !== NULL) {
				...
				$this->setKey("crmid", $this->crmid->CurrentValue); // Set up key
			} else {
				$this->setKey("crmid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "crm_crmentityview.php")
