 ...
 */
class pharmacy_batchmas extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// PRC
		$this->PRC = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// PrName
		$this->PrName = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, -1, FALSE, '`PrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BATCHNO
		$this->BATCHNO = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// BATCH
		$this->BATCH = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, -1, FALSE, '`BATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCH->Sortable = TRUE; // Allow sort
		$this->fields['BATCH'] = &$this->BATCH;

		// MFRCODE
		$this->MFRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// EXPDT
		$this->EXPDT = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PRCODE
		$this->PRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PRCODE', 'PRCODE', '`PRCODE`', '`PRCODE`', 200, -1, FALSE, '`PRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRCODE->Sortable = TRUE; // Allow sort
		$this->fields['PRCODE'] = &$this->PRCODE;

		// OQ
		$this->OQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, -1, FALSE, '`OQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RQ
		$this->RQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, -1, FALSE, '`RQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RQ->Sortable = TRUE; // Allow sort
		$this->RQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RQ'] = &$this->RQ;

		// FRQ
		$this->FRQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_FRQ', 'FRQ', '`FRQ`', '`FRQ`', 131, -1, FALSE, '`FRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FRQ->Sortable = TRUE; // Allow sort
		$this->FRQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['FRQ'] = &$this->FRQ;

		// IQ
		$this->IQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = TRUE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// MRQ
		$this->MRQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, -1, FALSE, '`MRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRQ->Sortable = TRUE; // Allow sort
		$this->MRQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRQ'] = &$this->MRQ;

		// MRP
		$this->MRP = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// UR
		$this->UR = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_UR', 'UR', '`UR`', '`UR`', 131, -1, FALSE, '`UR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UR->Sortable = TRUE; // Allow sort
		$this->UR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['UR'] = &$this->UR;

		// PC
		$this->PC = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PC->Sortable = TRUE; // Allow sort
		$this->fields['PC'] = &$this->PC;

		// OLDRT
		$this->OLDRT = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OLDRT', 'OLDRT', '`OLDRT`', '`OLDRT`', 131, -1, FALSE, '`OLDRT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TEMPMRQ
		$this->TEMPMRQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_TEMPMRQ', 'TEMPMRQ', '`TEMPMRQ`', '`TEMPMRQ`', 131, -1, FALSE, '`TEMPMRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAXP
		$this->TAXP = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, -1, FALSE, '`TAXP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXP->Sortable = TRUE; // Allow sort
		$this->TAXP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAXP'] = &$this->TAXP;

		// OLDRATE
		$this->OLDRATE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OLDRATE', 'OLDRATE', '`OLDRATE`', '`OLDRATE`', 131, -1, FALSE, '`OLDRATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NEWRATE
		$this->NEWRATE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_NEWRATE', 'NEWRATE', '`NEWRATE`', '`NEWRATE`', 131, -1, FALSE, '`NEWRATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OTEMPMRA
		$this->OTEMPMRA = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OTEMPMRA', 'OTEMPMRA', '`OTEMPMRA`', '`OTEMPMRA`', 131, -1, FALSE, '`OTEMPMRA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ACTIVESTATUS
		$this->ACTIVESTATUS = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_ACTIVESTATUS', 'ACTIVESTATUS', '`ACTIVESTATUS`', '`ACTIVESTATUS`', 200, -1, FALSE, '`ACTIVESTATUS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ACTIVESTATUS->Sortable = TRUE; // Allow sort
		$this->fields['ACTIVESTATUS'] = &$this->ACTIVESTATUS;

		// id
		$this->id = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PSGST
		$this->PSGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PSGST->Sortable = TRUE; // Allow sort
		$this->fields['PSGST'] = &$this->PSGST;

		// PCGST
		$this->PCGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCGST->Sortable = TRUE; // Allow sort
		$this->fields['PCGST'] = &$this->PCGST;

		// SSGST
		$this->SSGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SSGST->Sortable = TRUE; // Allow sort
		$this->fields['SSGST'] = &$this->SSGST;

		// SCGST
		$this->SCGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SCGST->Sortable = TRUE; // Allow sort
		$this->fields['SCGST'] = &$this->SCGST;

		// RT
		$this->RT = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_RT', 'RT', '`RT`', '`RT`', 131, -1, FALSE, '`RT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RT->Sortable = TRUE; // Allow sort
		$this->RT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RT'] = &$this->RT;

		// BRCODE
		$this->BRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HospID
		$this->HospID = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// UM
		$this->UM = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_UM', 'UM', '`UM`', '`UM`', 200, -1, FALSE, '`UM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UM->Sortable = TRUE; // Allow sort
		$this->fields['UM'] = &$this->UM;

		// GENNAME
		$this->GENNAME = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, -1, FALSE, '`GENNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GENNAME->Sortable = TRUE; // Allow sort
		$this->fields['GENNAME'] = &$this->GENNAME;

		// BILLDATE
		$this->BILLDATE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike('`BILLDATE`', 0, "DB"), 135, 0, FALSE, '`BILLDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PUnit
		$this->PUnit = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, -1, FALSE, '`PUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SUnit
		$this->SUnit = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, -1, FALSE, '`SUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurValue
		$this->PurValue = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurRate
		$this->PurRate = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, -1, FALSE, '`PurRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "pharmacy_batchmaslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "pharmacy_batchmasedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "pharmacy_batchmasadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("pharmacy_batchmasview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("pharmacy_batchmasview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "pharmacy_batchmasadd.php?" . $this->getUrlParm($parm);
		else
			$url = "pharmacy_batchmasadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pharmacy_batchmasedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pharmacy_batchmasadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("pharmacy_batchmasdelete.php", $this->getUrlParm());
	}
