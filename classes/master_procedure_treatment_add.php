 ...
 * Page class
 */
class master_procedure_treatment_add extends master_procedure_treatment
{
	...
	// Page object name
	public $PageObjName = "master_procedure_treatment_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("master_procedure_treatmentlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "master_procedure_treatmentlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "master_procedure_treatmentview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Treatment
		$this->Treatment->setDbValueDef($rsnew, $this->Treatment->CurrentValue, "", FALSE);

		// Procedure
		$this->Procedure->setDbValueDef($rsnew, $this->Procedure->CurrentValue, "", FALSE);
