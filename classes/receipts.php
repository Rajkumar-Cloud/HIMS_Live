...
class receipts extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('receipts', 'receipts', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Reception
		$this->Reception = new DbField('receipts', 'receipts', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Aid
		$this->Aid = new DbField('receipts', 'receipts', 'x_Aid', 'Aid', '`Aid`', '`Aid`', 3, -1, FALSE, '`Aid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Aid->Sortable = TRUE; // Allow sort
		$this->Aid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Aid'] = &$this->Aid;

		// Vid
		$this->Vid = new DbField('receipts', 'receipts', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, -1, FALSE, '`Vid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Vid->Sortable = TRUE; // Allow sort
		$this->Vid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Vid'] = &$this->Vid;

		// patient_id
		$this->patient_id = new DbField('receipts', 'receipts', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, -1, FALSE, '`patient_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mrnno
		$this->mrnno = new DbField('receipts', 'receipts', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// PatientName
		$this->PatientName = new DbField('receipts', 'receipts', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// amount
		$this->amount = new DbField('receipts', 'receipts', 'x_amount', 'amount', '`amount`', '`amount`', 5, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Discount
		$this->Discount = new DbField('receipts', 'receipts', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 5, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubTotal
		$this->SubTotal = new DbField('receipts', 'receipts', 'x_SubTotal', 'SubTotal', '`SubTotal`', '`SubTotal`', 5, -1, FALSE, '`SubTotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// patient_type
		$this->patient_type = new DbField('receipts', 'receipts', 'x_patient_type', 'patient_type', '`patient_type`', '`patient_type`', 3, -1, FALSE, '`patient_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceId
		$this->invoiceId = new DbField('receipts', 'receipts', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, -1, FALSE, '`invoiceId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceAmount
		$this->invoiceAmount = new DbField('receipts', 'receipts', 'x_invoiceAmount', 'invoiceAmount', '`invoiceAmount`', '`invoiceAmount`', 5, -1, FALSE, '`invoiceAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceStatus
		$this->invoiceStatus = new DbField('receipts', 'receipts', 'x_invoiceStatus', 'invoiceStatus', '`invoiceStatus`', '`invoiceStatus`', 200, -1, FALSE, '`invoiceStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoiceStatus->Sortable = TRUE; // Allow sort
		$this->fields['invoiceStatus'] = &$this->invoiceStatus;

		// modeOfPayment
		$this->modeOfPayment = new DbField('receipts', 'receipts', 'x_modeOfPayment', 'modeOfPayment', '`modeOfPayment`', '`modeOfPayment`', 200, -1, FALSE, '`modeOfPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modeOfPayment->Sortable = TRUE; // Allow sort
		$this->fields['modeOfPayment'] = &$this->modeOfPayment;

		// charged_date
		$this->charged_date = new DbField('receipts', 'receipts', 'x_charged_date', 'charged_date', '`charged_date`', CastDateFieldForLike('`charged_date`', 0, "DB"), 135, 0, FALSE, '`charged_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('receipts', 'receipts', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdby
		$this->createdby = new DbField('receipts', 'receipts', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('receipts', 'receipts', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('receipts', 'receipts', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('receipts', 'receipts', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// ChequeCardNo
		$this->ChequeCardNo = new DbField('receipts', 'receipts', 'x_ChequeCardNo', 'ChequeCardNo', '`ChequeCardNo`', '`ChequeCardNo`', 200, -1, FALSE, '`ChequeCardNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ChequeCardNo->Sortable = TRUE; // Allow sort
		$this->fields['ChequeCardNo'] = &$this->ChequeCardNo;

		// CreditBankName
		$this->CreditBankName = new DbField('receipts', 'receipts', 'x_CreditBankName', 'CreditBankName', '`CreditBankName`', '`CreditBankName`', 200, -1, FALSE, '`CreditBankName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditBankName->Sortable = TRUE; // Allow sort
		$this->fields['CreditBankName'] = &$this->CreditBankName;

		// CreditCardHolder
		$this->CreditCardHolder = new DbField('receipts', 'receipts', 'x_CreditCardHolder', 'CreditCardHolder', '`CreditCardHolder`', '`CreditCardHolder`', 200, -1, FALSE, '`CreditCardHolder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditCardHolder->Sortable = TRUE; // Allow sort
		$this->fields['CreditCardHolder'] = &$this->CreditCardHolder;

		// CreditCardType
		$this->CreditCardType = new DbField('receipts', 'receipts', 'x_CreditCardType', 'CreditCardType', '`CreditCardType`', '`CreditCardType`', 200, -1, FALSE, '`CreditCardType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditCardType->Sortable = TRUE; // Allow sort
		$this->fields['CreditCardType'] = &$this->CreditCardType;

		// CreditCardMachine
		$this->CreditCardMachine = new DbField('receipts', 'receipts', 'x_CreditCardMachine', 'CreditCardMachine', '`CreditCardMachine`', '`CreditCardMachine`', 200, -1, FALSE, '`CreditCardMachine`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditCardMachine->Sortable = TRUE; // Allow sort
		$this->fields['CreditCardMachine'] = &$this->CreditCardMachine;

		// CreditCardBatchNo
		$this->CreditCardBatchNo = new DbField('receipts', 'receipts', 'x_CreditCardBatchNo', 'CreditCardBatchNo', '`CreditCardBatchNo`', '`CreditCardBatchNo`', 200, -1, FALSE, '`CreditCardBatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditCardBatchNo->Sortable = TRUE; // Allow sort
		$this->fields['CreditCardBatchNo'] = &$this->CreditCardBatchNo;

		// CreditCardTax
		$this->CreditCardTax = new DbField('receipts', 'receipts', 'x_CreditCardTax', 'CreditCardTax', '`CreditCardTax`', '`CreditCardTax`', 200, -1, FALSE, '`CreditCardTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditCardTax->Sortable = TRUE; // Allow sort
		$this->fields['CreditCardTax'] = &$this->CreditCardTax;

		// CreditDeductionAmount
		$this->CreditDeductionAmount = new DbField('receipts', 'receipts', 'x_CreditDeductionAmount', 'CreditDeductionAmount', '`CreditDeductionAmount`', '`CreditDeductionAmount`', 200, -1, FALSE, '`CreditDeductionAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreditDeductionAmount->Sortable = TRUE; // Allow sort
		$this->fields['CreditDeductionAmount'] = &$this->CreditDeductionAmount;

		// RealizationAmount
		$this->RealizationAmount = new DbField('receipts', 'receipts', 'x_RealizationAmount', 'RealizationAmount', '`RealizationAmount`', '`RealizationAmount`', 200, -1, FALSE, '`RealizationAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationAmount->Sortable = TRUE; // Allow sort
		$this->fields['RealizationAmount'] = &$this->RealizationAmount;

		// RealizationStatus
		$this->RealizationStatus = new DbField('receipts', 'receipts', 'x_RealizationStatus', 'RealizationStatus', '`RealizationStatus`', '`RealizationStatus`', 200, -1, FALSE, '`RealizationStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationStatus->Sortable = TRUE; // Allow sort
		$this->fields['RealizationStatus'] = &$this->RealizationStatus;

		// RealizationRemarks
		$this->RealizationRemarks = new DbField('receipts', 'receipts', 'x_RealizationRemarks', 'RealizationRemarks', '`RealizationRemarks`', '`RealizationRemarks`', 200, -1, FALSE, '`RealizationRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationRemarks->Sortable = TRUE; // Allow sort
		$this->fields['RealizationRemarks'] = &$this->RealizationRemarks;

		// RealizationBatchNo
		$this->RealizationBatchNo = new DbField('receipts', 'receipts', 'x_RealizationBatchNo', 'RealizationBatchNo', '`RealizationBatchNo`', '`RealizationBatchNo`', 200, -1, FALSE, '`RealizationBatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationBatchNo->Sortable = TRUE; // Allow sort
		$this->fields['RealizationBatchNo'] = &$this->RealizationBatchNo;

		// RealizationDate
		$this->RealizationDate = new DbField('receipts', 'receipts', 'x_RealizationDate', 'RealizationDate', '`RealizationDate`', '`RealizationDate`', 200, -1, FALSE, '`RealizationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationDate->Sortable = TRUE; // Allow sort
		$this->fields['RealizationDate'] = &$this->RealizationDate;

		// BankAccHolderMobileNumber
		$this->BankAccHolderMobileNumber = new DbField('receipts', 'receipts', 'x_BankAccHolderMobileNumber', 'BankAccHolderMobileNumber', '`BankAccHolderMobileNumber`', '`BankAccHolderMobileNumber`', 200, -1, FALSE, '`BankAccHolderMobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("receiptsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
