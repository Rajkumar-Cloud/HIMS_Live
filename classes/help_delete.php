 ...
 * Page class
 */
class help_delete extends help
{
	...
	// Page object name
	public $PageObjName = "help_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("helplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("helplist.php"); // Return to list
			}
		}
	}
