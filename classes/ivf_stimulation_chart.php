...
class ivf_stimulation_chart extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNo
		$this->RIDNo = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->IsForeignKey = TRUE; // Foreign key field
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// ARTCycle
		$this->ARTCycle = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ARTCycle', 'ARTCycle', '`ARTCycle`', '`ARTCycle`', 200, -1, FALSE, '`ARTCycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// FemaleFactor
		$this->FemaleFactor = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_FemaleFactor', 'FemaleFactor', '`FemaleFactor`', '`FemaleFactor`', 200, -1, FALSE, '`FemaleFactor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// MaleFactor
		$this->MaleFactor = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_MaleFactor', 'MaleFactor', '`MaleFactor`', '`MaleFactor`', 200, -1, FALSE, '`MaleFactor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Protocol
		$this->Protocol = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Protocol', 'Protocol', '`Protocol`', '`Protocol`', 200, -1, FALSE, '`Protocol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SemenFrozen
		$this->SemenFrozen = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_SemenFrozen', 'SemenFrozen', '`SemenFrozen`', '`SemenFrozen`', 200, -1, FALSE, '`SemenFrozen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// A4ICSICycle
		$this->A4ICSICycle = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_A4ICSICycle', 'A4ICSICycle', '`A4ICSICycle`', '`A4ICSICycle`', 200, -1, FALSE, '`A4ICSICycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TotalICSICycle
		$this->TotalICSICycle = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TotalICSICycle', 'TotalICSICycle', '`TotalICSICycle`', '`TotalICSICycle`', 200, -1, FALSE, '`TotalICSICycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TypeOfInfertility
		$this->TypeOfInfertility = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TypeOfInfertility', 'TypeOfInfertility', '`TypeOfInfertility`', '`TypeOfInfertility`', 200, -1, FALSE, '`TypeOfInfertility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Duration
		$this->Duration = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Duration', 'Duration', '`Duration`', '`Duration`', 200, -1, FALSE, '`Duration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Duration->Sortable = TRUE; // Allow sort
		$this->fields['Duration'] = &$this->Duration;

		// LMP
		$this->LMP = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_LMP', 'LMP', '`LMP`', CastDateFieldForLike('`LMP`', 7, "DB"), 135, 7, FALSE, '`LMP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LMP->Sortable = TRUE; // Allow sort
		$this->fields['LMP'] = &$this->LMP;

		// RelevantHistory
		$this->RelevantHistory = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RelevantHistory', 'RelevantHistory', '`RelevantHistory`', '`RelevantHistory`', 200, -1, FALSE, '`RelevantHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RelevantHistory->Sortable = TRUE; // Allow sort
		$this->fields['RelevantHistory'] = &$this->RelevantHistory;

		// IUICycles
		$this->IUICycles = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_IUICycles', 'IUICycles', '`IUICycles`', '`IUICycles`', 200, -1, FALSE, '`IUICycles`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IUICycles->Sortable = TRUE; // Allow sort
		$this->fields['IUICycles'] = &$this->IUICycles;

		// AFC
		$this->AFC = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_AFC', 'AFC', '`AFC`', '`AFC`', 200, -1, FALSE, '`AFC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AFC->Sortable = TRUE; // Allow sort
		$this->fields['AFC'] = &$this->AFC;

		// AMH
		$this->AMH = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_AMH', 'AMH', '`AMH`', '`AMH`', 200, -1, FALSE, '`AMH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AMH->Sortable = TRUE; // Allow sort
		$this->fields['AMH'] = &$this->AMH;

		// FBMI
		$this->FBMI = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_FBMI', 'FBMI', '`FBMI`', '`FBMI`', 200, -1, FALSE, '`FBMI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FBMI->Sortable = TRUE; // Allow sort
		$this->fields['FBMI'] = &$this->FBMI;

		// MBMI
		$this->MBMI = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_MBMI', 'MBMI', '`MBMI`', '`MBMI`', 200, -1, FALSE, '`MBMI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MBMI->Sortable = TRUE; // Allow sort
		$this->fields['MBMI'] = &$this->MBMI;

		// OvarianVolumeRT
		$this->OvarianVolumeRT = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_OvarianVolumeRT', 'OvarianVolumeRT', '`OvarianVolumeRT`', '`OvarianVolumeRT`', 200, -1, FALSE, '`OvarianVolumeRT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OvarianVolumeRT->Sortable = TRUE; // Allow sort
		$this->fields['OvarianVolumeRT'] = &$this->OvarianVolumeRT;

		// OvarianVolumeLT
		$this->OvarianVolumeLT = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_OvarianVolumeLT', 'OvarianVolumeLT', '`OvarianVolumeLT`', '`OvarianVolumeLT`', 200, -1, FALSE, '`OvarianVolumeLT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OvarianVolumeLT->Sortable = TRUE; // Allow sort
		$this->fields['OvarianVolumeLT'] = &$this->OvarianVolumeLT;

		// DAYSOFSTIMULATION
		$this->DAYSOFSTIMULATION = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DAYSOFSTIMULATION', 'DAYSOFSTIMULATION', '`DAYSOFSTIMULATION`', '`DAYSOFSTIMULATION`', 200, -1, FALSE, '`DAYSOFSTIMULATION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAYSOFSTIMULATION->Sortable = TRUE; // Allow sort
		$this->fields['DAYSOFSTIMULATION'] = &$this->DAYSOFSTIMULATION;

		// DOSEOFGONADOTROPINS
		$this->DOSEOFGONADOTROPINS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DOSEOFGONADOTROPINS', 'DOSEOFGONADOTROPINS', '`DOSEOFGONADOTROPINS`', '`DOSEOFGONADOTROPINS`', 200, -1, FALSE, '`DOSEOFGONADOTROPINS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DOSEOFGONADOTROPINS->Sortable = TRUE; // Allow sort
		$this->fields['DOSEOFGONADOTROPINS'] = &$this->DOSEOFGONADOTROPINS;

		// INJTYPE
		$this->INJTYPE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_INJTYPE', 'INJTYPE', '`INJTYPE`', '`INJTYPE`', 200, -1, FALSE, '`INJTYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ANTAGONISTDAYS
		$this->ANTAGONISTDAYS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ANTAGONISTDAYS', 'ANTAGONISTDAYS', '`ANTAGONISTDAYS`', '`ANTAGONISTDAYS`', 200, -1, FALSE, '`ANTAGONISTDAYS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANTAGONISTDAYS->Sortable = TRUE; // Allow sort
		$this->fields['ANTAGONISTDAYS'] = &$this->ANTAGONISTDAYS;

		// ANTAGONISTSTARTDAY
		$this->ANTAGONISTSTARTDAY = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ANTAGONISTSTARTDAY', 'ANTAGONISTSTARTDAY', '`ANTAGONISTSTARTDAY`', '`ANTAGONISTSTARTDAY`', 200, -1, FALSE, '`ANTAGONISTSTARTDAY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GROWTHHORMONE
		$this->GROWTHHORMONE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GROWTHHORMONE', 'GROWTHHORMONE', '`GROWTHHORMONE`', '`GROWTHHORMONE`', 200, -1, FALSE, '`GROWTHHORMONE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GROWTHHORMONE->Sortable = TRUE; // Allow sort
		$this->fields['GROWTHHORMONE'] = &$this->GROWTHHORMONE;

		// PRETREATMENT
		$this->PRETREATMENT = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_PRETREATMENT', 'PRETREATMENT', '`PRETREATMENT`', '`PRETREATMENT`', 200, -1, FALSE, '`PRETREATMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SerumP4
		$this->SerumP4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_SerumP4', 'SerumP4', '`SerumP4`', '`SerumP4`', 200, -1, FALSE, '`SerumP4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SerumP4->Sortable = TRUE; // Allow sort
		$this->fields['SerumP4'] = &$this->SerumP4;

		// FORT
		$this->FORT = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_FORT', 'FORT', '`FORT`', '`FORT`', 200, -1, FALSE, '`FORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FORT->Sortable = TRUE; // Allow sort
		$this->fields['FORT'] = &$this->FORT;

		// MedicalFactors
		$this->MedicalFactors = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_MedicalFactors', 'MedicalFactors', '`MedicalFactors`', '`MedicalFactors`', 200, -1, FALSE, '`MedicalFactors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SCDate
		$this->SCDate = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_SCDate', 'SCDate', '`SCDate`', CastDateFieldForLike('`SCDate`', 7, "DB"), 135, 7, FALSE, '`SCDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SCDate->Sortable = TRUE; // Allow sort
		$this->fields['SCDate'] = &$this->SCDate;

		// OvarianSurgery
		$this->OvarianSurgery = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_OvarianSurgery', 'OvarianSurgery', '`OvarianSurgery`', '`OvarianSurgery`', 200, -1, FALSE, '`OvarianSurgery`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OvarianSurgery->Sortable = TRUE; // Allow sort
		$this->fields['OvarianSurgery'] = &$this->OvarianSurgery;

		// PreProcedureOrder
		$this->PreProcedureOrder = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_PreProcedureOrder', 'PreProcedureOrder', '`PreProcedureOrder`', '`PreProcedureOrder`', 200, -1, FALSE, '`PreProcedureOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PreProcedureOrder->Sortable = TRUE; // Allow sort
		$this->fields['PreProcedureOrder'] = &$this->PreProcedureOrder;

		// TRIGGERR
		$this->TRIGGERR = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TRIGGERR', 'TRIGGERR', '`TRIGGERR`', '`TRIGGERR`', 200, -1, FALSE, '`TRIGGERR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TRIGGERDATE
		$this->TRIGGERDATE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TRIGGERDATE', 'TRIGGERDATE', '`TRIGGERDATE`', CastDateFieldForLike('`TRIGGERDATE`', 11, "DB"), 135, 11, FALSE, '`TRIGGERDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TRIGGERDATE->Sortable = TRUE; // Allow sort
		$this->fields['TRIGGERDATE'] = &$this->TRIGGERDATE;

		// ATHOMEorCLINIC
		$this->ATHOMEorCLINIC = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ATHOMEorCLINIC', 'ATHOMEorCLINIC', '`ATHOMEorCLINIC`', '`ATHOMEorCLINIC`', 200, -1, FALSE, '`ATHOMEorCLINIC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// OPUDATE
		$this->OPUDATE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_OPUDATE', 'OPUDATE', '`OPUDATE`', CastDateFieldForLike('`OPUDATE`', 11, "DB"), 135, 11, FALSE, '`OPUDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OPUDATE->Sortable = TRUE; // Allow sort
		$this->fields['OPUDATE'] = &$this->OPUDATE;

		// ALLFREEZEINDICATION
		$this->ALLFREEZEINDICATION = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ALLFREEZEINDICATION', 'ALLFREEZEINDICATION', '`ALLFREEZEINDICATION`', '`ALLFREEZEINDICATION`', 200, -1, FALSE, '`ALLFREEZEINDICATION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ERA
		$this->ERA = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ERA', 'ERA', '`ERA`', '`ERA`', 200, -1, FALSE, '`ERA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PGTA
		$this->PGTA = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_PGTA', 'PGTA', '`PGTA`', '`PGTA`', 200, -1, FALSE, '`PGTA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PGTA->Sortable = TRUE; // Allow sort
		$this->fields['PGTA'] = &$this->PGTA;

		// PGD
		$this->PGD = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_PGD', 'PGD', '`PGD`', '`PGD`', 200, -1, FALSE, '`PGD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PGD->Sortable = TRUE; // Allow sort
		$this->fields['PGD'] = &$this->PGD;

		// DATEOFET
		$this->DATEOFET = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DATEOFET', 'DATEOFET', '`DATEOFET`', CastDateFieldForLike('`DATEOFET`', 11, "DB"), 135, 11, FALSE, '`DATEOFET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DATEOFET->Sortable = TRUE; // Allow sort
		$this->fields['DATEOFET'] = &$this->DATEOFET;

		// ET
		$this->ET = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ET', 'ET', '`ET`', '`ET`', 200, -1, FALSE, '`ET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ESET
		$this->ESET = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ESET', 'ESET', '`ESET`', '`ESET`', 200, -1, FALSE, '`ESET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ESET->Sortable = TRUE; // Allow sort
		$this->fields['ESET'] = &$this->ESET;

		// DOET
		$this->DOET = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DOET', 'DOET', '`DOET`', '`DOET`', 200, -1, FALSE, '`DOET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DOET->Sortable = TRUE; // Allow sort
		$this->fields['DOET'] = &$this->DOET;

		// SEMENPREPARATION
		$this->SEMENPREPARATION = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_SEMENPREPARATION', 'SEMENPREPARATION', '`SEMENPREPARATION`', '`SEMENPREPARATION`', 200, -1, FALSE, '`SEMENPREPARATION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// REASONFORESET
		$this->REASONFORESET = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_REASONFORESET', 'REASONFORESET', '`REASONFORESET`', '`REASONFORESET`', 200, -1, FALSE, '`REASONFORESET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Expectedoocytes
		$this->Expectedoocytes = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Expectedoocytes', 'Expectedoocytes', '`Expectedoocytes`', '`Expectedoocytes`', 200, -1, FALSE, '`Expectedoocytes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Expectedoocytes->Sortable = TRUE; // Allow sort
		$this->fields['Expectedoocytes'] = &$this->Expectedoocytes;

		// StChDate1
		$this->StChDate1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate1', 'StChDate1', '`StChDate1`', CastDateFieldForLike('`StChDate1`', 7, "DB"), 135, 7, FALSE, '`StChDate1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate1->Sortable = TRUE; // Allow sort
		$this->fields['StChDate1'] = &$this->StChDate1;

		// StChDate2
		$this->StChDate2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate2', 'StChDate2', '`StChDate2`', CastDateFieldForLike('`StChDate2`', 7, "DB"), 135, 7, FALSE, '`StChDate2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate2->Sortable = TRUE; // Allow sort
		$this->fields['StChDate2'] = &$this->StChDate2;

		// StChDate3
		$this->StChDate3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate3', 'StChDate3', '`StChDate3`', CastDateFieldForLike('`StChDate3`', 7, "DB"), 135, 7, FALSE, '`StChDate3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate3->Sortable = TRUE; // Allow sort
		$this->fields['StChDate3'] = &$this->StChDate3;

		// StChDate4
		$this->StChDate4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate4', 'StChDate4', '`StChDate4`', CastDateFieldForLike('`StChDate4`', 7, "DB"), 135, 7, FALSE, '`StChDate4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate4->Sortable = TRUE; // Allow sort
		$this->fields['StChDate4'] = &$this->StChDate4;

		// StChDate5
		$this->StChDate5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate5', 'StChDate5', '`StChDate5`', CastDateFieldForLike('`StChDate5`', 7, "DB"), 135, 7, FALSE, '`StChDate5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate5->Sortable = TRUE; // Allow sort
		$this->fields['StChDate5'] = &$this->StChDate5;

		// StChDate6
		$this->StChDate6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate6', 'StChDate6', '`StChDate6`', CastDateFieldForLike('`StChDate6`', 7, "DB"), 135, 7, FALSE, '`StChDate6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate6->Sortable = TRUE; // Allow sort
		$this->fields['StChDate6'] = &$this->StChDate6;

		// StChDate7
		$this->StChDate7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate7', 'StChDate7', '`StChDate7`', CastDateFieldForLike('`StChDate7`', 7, "DB"), 135, 7, FALSE, '`StChDate7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate7->Sortable = TRUE; // Allow sort
		$this->fields['StChDate7'] = &$this->StChDate7;

		// StChDate8
		$this->StChDate8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate8', 'StChDate8', '`StChDate8`', CastDateFieldForLike('`StChDate8`', 7, "DB"), 135, 7, FALSE, '`StChDate8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate8->Sortable = TRUE; // Allow sort
		$this->fields['StChDate8'] = &$this->StChDate8;

		// StChDate9
		$this->StChDate9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate9', 'StChDate9', '`StChDate9`', CastDateFieldForLike('`StChDate9`', 7, "DB"), 135, 7, FALSE, '`StChDate9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate9->Sortable = TRUE; // Allow sort
		$this->fields['StChDate9'] = &$this->StChDate9;

		// StChDate10
		$this->StChDate10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate10', 'StChDate10', '`StChDate10`', CastDateFieldForLike('`StChDate10`', 7, "DB"), 135, 7, FALSE, '`StChDate10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate10->Sortable = TRUE; // Allow sort
		$this->fields['StChDate10'] = &$this->StChDate10;

		// StChDate11
		$this->StChDate11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate11', 'StChDate11', '`StChDate11`', CastDateFieldForLike('`StChDate11`', 7, "DB"), 135, 7, FALSE, '`StChDate11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate11->Sortable = TRUE; // Allow sort
		$this->fields['StChDate11'] = &$this->StChDate11;

		// StChDate12
		$this->StChDate12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate12', 'StChDate12', '`StChDate12`', CastDateFieldForLike('`StChDate12`', 7, "DB"), 135, 7, FALSE, '`StChDate12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate12->Sortable = TRUE; // Allow sort
		$this->fields['StChDate12'] = &$this->StChDate12;

		// StChDate13
		$this->StChDate13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate13', 'StChDate13', '`StChDate13`', CastDateFieldForLike('`StChDate13`', 7, "DB"), 135, 7, FALSE, '`StChDate13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StChDate13->Sortable = TRUE; // Allow sort
		$this->fields['StChDate13'] = &$this->StChDate13;

		// CycleDay1
		$this->CycleDay1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay1', 'CycleDay1', '`CycleDay1`', '`CycleDay1`', 200, -1, FALSE, '`CycleDay1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay1->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay1'] = &$this->CycleDay1;

		// CycleDay2
		$this->CycleDay2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay2', 'CycleDay2', '`CycleDay2`', '`CycleDay2`', 200, -1, FALSE, '`CycleDay2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay2->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay2'] = &$this->CycleDay2;

		// CycleDay3
		$this->CycleDay3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay3', 'CycleDay3', '`CycleDay3`', '`CycleDay3`', 200, -1, FALSE, '`CycleDay3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay3->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay3'] = &$this->CycleDay3;

		// CycleDay4
		$this->CycleDay4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay4', 'CycleDay4', '`CycleDay4`', '`CycleDay4`', 200, -1, FALSE, '`CycleDay4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay4->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay4'] = &$this->CycleDay4;

		// CycleDay5
		$this->CycleDay5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay5', 'CycleDay5', '`CycleDay5`', '`CycleDay5`', 200, -1, FALSE, '`CycleDay5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay5->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay5'] = &$this->CycleDay5;

		// CycleDay6
		$this->CycleDay6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay6', 'CycleDay6', '`CycleDay6`', '`CycleDay6`', 200, -1, FALSE, '`CycleDay6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay6->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay6'] = &$this->CycleDay6;

		// CycleDay7
		$this->CycleDay7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay7', 'CycleDay7', '`CycleDay7`', '`CycleDay7`', 200, -1, FALSE, '`CycleDay7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay7->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay7'] = &$this->CycleDay7;

		// CycleDay8
		$this->CycleDay8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay8', 'CycleDay8', '`CycleDay8`', '`CycleDay8`', 200, -1, FALSE, '`CycleDay8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay8->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay8'] = &$this->CycleDay8;

		// CycleDay9
		$this->CycleDay9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay9', 'CycleDay9', '`CycleDay9`', '`CycleDay9`', 200, -1, FALSE, '`CycleDay9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay9->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay9'] = &$this->CycleDay9;

		// CycleDay10
		$this->CycleDay10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay10', 'CycleDay10', '`CycleDay10`', '`CycleDay10`', 200, -1, FALSE, '`CycleDay10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay10->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay10'] = &$this->CycleDay10;

		// CycleDay11
		$this->CycleDay11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay11', 'CycleDay11', '`CycleDay11`', '`CycleDay11`', 200, -1, FALSE, '`CycleDay11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay11->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay11'] = &$this->CycleDay11;

		// CycleDay12
		$this->CycleDay12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay12', 'CycleDay12', '`CycleDay12`', '`CycleDay12`', 200, -1, FALSE, '`CycleDay12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay12->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay12'] = &$this->CycleDay12;

		// CycleDay13
		$this->CycleDay13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay13', 'CycleDay13', '`CycleDay13`', '`CycleDay13`', 200, -1, FALSE, '`CycleDay13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay13->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay13'] = &$this->CycleDay13;

		// StimulationDay1
		$this->StimulationDay1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay1', 'StimulationDay1', '`StimulationDay1`', '`StimulationDay1`', 200, -1, FALSE, '`StimulationDay1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay1->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay1'] = &$this->StimulationDay1;

		// StimulationDay2
		$this->StimulationDay2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay2', 'StimulationDay2', '`StimulationDay2`', '`StimulationDay2`', 200, -1, FALSE, '`StimulationDay2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay2->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay2'] = &$this->StimulationDay2;

		// StimulationDay3
		$this->StimulationDay3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay3', 'StimulationDay3', '`StimulationDay3`', '`StimulationDay3`', 200, -1, FALSE, '`StimulationDay3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay3->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay3'] = &$this->StimulationDay3;

		// StimulationDay4
		$this->StimulationDay4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay4', 'StimulationDay4', '`StimulationDay4`', '`StimulationDay4`', 200, -1, FALSE, '`StimulationDay4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay4->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay4'] = &$this->StimulationDay4;

		// StimulationDay5
		$this->StimulationDay5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay5', 'StimulationDay5', '`StimulationDay5`', '`StimulationDay5`', 200, -1, FALSE, '`StimulationDay5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay5->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay5'] = &$this->StimulationDay5;

		// StimulationDay6
		$this->StimulationDay6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay6', 'StimulationDay6', '`StimulationDay6`', '`StimulationDay6`', 200, -1, FALSE, '`StimulationDay6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay6->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay6'] = &$this->StimulationDay6;

		// StimulationDay7
		$this->StimulationDay7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay7', 'StimulationDay7', '`StimulationDay7`', '`StimulationDay7`', 200, -1, FALSE, '`StimulationDay7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay7->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay7'] = &$this->StimulationDay7;

		// StimulationDay8
		$this->StimulationDay8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay8', 'StimulationDay8', '`StimulationDay8`', '`StimulationDay8`', 200, -1, FALSE, '`StimulationDay8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay8->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay8'] = &$this->StimulationDay8;

		// StimulationDay9
		$this->StimulationDay9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay9', 'StimulationDay9', '`StimulationDay9`', '`StimulationDay9`', 200, -1, FALSE, '`StimulationDay9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay9->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay9'] = &$this->StimulationDay9;

		// StimulationDay10
		$this->StimulationDay10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay10', 'StimulationDay10', '`StimulationDay10`', '`StimulationDay10`', 200, -1, FALSE, '`StimulationDay10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay10->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay10'] = &$this->StimulationDay10;

		// StimulationDay11
		$this->StimulationDay11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay11', 'StimulationDay11', '`StimulationDay11`', '`StimulationDay11`', 200, -1, FALSE, '`StimulationDay11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay11->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay11'] = &$this->StimulationDay11;

		// StimulationDay12
		$this->StimulationDay12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay12', 'StimulationDay12', '`StimulationDay12`', '`StimulationDay12`', 200, -1, FALSE, '`StimulationDay12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay12->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay12'] = &$this->StimulationDay12;

		// StimulationDay13
		$this->StimulationDay13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay13', 'StimulationDay13', '`StimulationDay13`', '`StimulationDay13`', 200, -1, FALSE, '`StimulationDay13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay13->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay13'] = &$this->StimulationDay13;

		// Tablet1
		$this->Tablet1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet1', 'Tablet1', '`Tablet1`', '`Tablet1`', 200, -1, FALSE, '`Tablet1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet2
		$this->Tablet2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet2', 'Tablet2', '`Tablet2`', '`Tablet2`', 200, -1, FALSE, '`Tablet2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet3
		$this->Tablet3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet3', 'Tablet3', '`Tablet3`', '`Tablet3`', 200, -1, FALSE, '`Tablet3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet4
		$this->Tablet4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet4', 'Tablet4', '`Tablet4`', '`Tablet4`', 200, -1, FALSE, '`Tablet4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet5
		$this->Tablet5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet5', 'Tablet5', '`Tablet5`', '`Tablet5`', 200, -1, FALSE, '`Tablet5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet6
		$this->Tablet6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet6', 'Tablet6', '`Tablet6`', '`Tablet6`', 200, -1, FALSE, '`Tablet6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet7
		$this->Tablet7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet7', 'Tablet7', '`Tablet7`', '`Tablet7`', 200, -1, FALSE, '`Tablet7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet8
		$this->Tablet8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet8', 'Tablet8', '`Tablet8`', '`Tablet8`', 200, -1, FALSE, '`Tablet8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet9
		$this->Tablet9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet9', 'Tablet9', '`Tablet9`', '`Tablet9`', 200, -1, FALSE, '`Tablet9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet10
		$this->Tablet10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet10', 'Tablet10', '`Tablet10`', '`Tablet10`', 200, -1, FALSE, '`Tablet10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet11
		$this->Tablet11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet11', 'Tablet11', '`Tablet11`', '`Tablet11`', 200, -1, FALSE, '`Tablet11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet12
		$this->Tablet12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet12', 'Tablet12', '`Tablet12`', '`Tablet12`', 200, -1, FALSE, '`Tablet12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet13
		$this->Tablet13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet13', 'Tablet13', '`Tablet13`', '`Tablet13`', 200, -1, FALSE, '`Tablet13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH1
		$this->RFSH1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH1', 'RFSH1', '`RFSH1`', '`RFSH1`', 200, -1, FALSE, '`RFSH1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH2
		$this->RFSH2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH2', 'RFSH2', '`RFSH2`', '`RFSH2`', 200, -1, FALSE, '`RFSH2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH3
		$this->RFSH3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH3', 'RFSH3', '`RFSH3`', '`RFSH3`', 200, -1, FALSE, '`RFSH3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH4
		$this->RFSH4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH4', 'RFSH4', '`RFSH4`', '`RFSH4`', 200, -1, FALSE, '`RFSH4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH5
		$this->RFSH5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH5', 'RFSH5', '`RFSH5`', '`RFSH5`', 200, -1, FALSE, '`RFSH5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH6
		$this->RFSH6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH6', 'RFSH6', '`RFSH6`', '`RFSH6`', 200, -1, FALSE, '`RFSH6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH7
		$this->RFSH7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH7', 'RFSH7', '`RFSH7`', '`RFSH7`', 200, -1, FALSE, '`RFSH7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH8
		$this->RFSH8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH8', 'RFSH8', '`RFSH8`', '`RFSH8`', 200, -1, FALSE, '`RFSH8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH9
		$this->RFSH9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH9', 'RFSH9', '`RFSH9`', '`RFSH9`', 200, -1, FALSE, '`RFSH9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH10
		$this->RFSH10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH10', 'RFSH10', '`RFSH10`', '`RFSH10`', 200, -1, FALSE, '`RFSH10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH11
		$this->RFSH11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH11', 'RFSH11', '`RFSH11`', '`RFSH11`', 200, -1, FALSE, '`RFSH11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH12
		$this->RFSH12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH12', 'RFSH12', '`RFSH12`', '`RFSH12`', 200, -1, FALSE, '`RFSH12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH13
		$this->RFSH13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH13', 'RFSH13', '`RFSH13`', '`RFSH13`', 200, -1, FALSE, '`RFSH13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG1
		$this->HMG1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG1', 'HMG1', '`HMG1`', '`HMG1`', 200, -1, FALSE, '`HMG1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG2
		$this->HMG2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG2', 'HMG2', '`HMG2`', '`HMG2`', 200, -1, FALSE, '`HMG2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG3
		$this->HMG3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG3', 'HMG3', '`HMG3`', '`HMG3`', 200, -1, FALSE, '`HMG3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG4
		$this->HMG4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG4', 'HMG4', '`HMG4`', '`HMG4`', 200, -1, FALSE, '`HMG4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG5
		$this->HMG5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG5', 'HMG5', '`HMG5`', '`HMG5`', 200, -1, FALSE, '`HMG5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG6
		$this->HMG6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG6', 'HMG6', '`HMG6`', '`HMG6`', 200, -1, FALSE, '`HMG6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG7
		$this->HMG7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG7', 'HMG7', '`HMG7`', '`HMG7`', 200, -1, FALSE, '`HMG7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG8
		$this->HMG8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG8', 'HMG8', '`HMG8`', '`HMG8`', 200, -1, FALSE, '`HMG8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG9
		$this->HMG9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG9', 'HMG9', '`HMG9`', '`HMG9`', 200, -1, FALSE, '`HMG9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG10
		$this->HMG10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG10', 'HMG10', '`HMG10`', '`HMG10`', 200, -1, FALSE, '`HMG10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG11
		$this->HMG11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG11', 'HMG11', '`HMG11`', '`HMG11`', 200, -1, FALSE, '`HMG11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG12
		$this->HMG12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG12', 'HMG12', '`HMG12`', '`HMG12`', 200, -1, FALSE, '`HMG12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG13
		$this->HMG13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG13', 'HMG13', '`HMG13`', '`HMG13`', 200, -1, FALSE, '`HMG13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH1
		$this->GnRH1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH1', 'GnRH1', '`GnRH1`', '`GnRH1`', 200, -1, FALSE, '`GnRH1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH2
		$this->GnRH2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH2', 'GnRH2', '`GnRH2`', '`GnRH2`', 200, -1, FALSE, '`GnRH2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH3
		$this->GnRH3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH3', 'GnRH3', '`GnRH3`', '`GnRH3`', 200, -1, FALSE, '`GnRH3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH4
		$this->GnRH4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH4', 'GnRH4', '`GnRH4`', '`GnRH4`', 200, -1, FALSE, '`GnRH4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH5
		$this->GnRH5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH5', 'GnRH5', '`GnRH5`', '`GnRH5`', 200, -1, FALSE, '`GnRH5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH6
		$this->GnRH6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH6', 'GnRH6', '`GnRH6`', '`GnRH6`', 200, -1, FALSE, '`GnRH6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH7
		$this->GnRH7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH7', 'GnRH7', '`GnRH7`', '`GnRH7`', 200, -1, FALSE, '`GnRH7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH8
		$this->GnRH8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH8', 'GnRH8', '`GnRH8`', '`GnRH8`', 200, -1, FALSE, '`GnRH8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH9
		$this->GnRH9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH9', 'GnRH9', '`GnRH9`', '`GnRH9`', 200, -1, FALSE, '`GnRH9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH10
		$this->GnRH10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH10', 'GnRH10', '`GnRH10`', '`GnRH10`', 200, -1, FALSE, '`GnRH10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH11
		$this->GnRH11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH11', 'GnRH11', '`GnRH11`', '`GnRH11`', 200, -1, FALSE, '`GnRH11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH12
		$this->GnRH12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH12', 'GnRH12', '`GnRH12`', '`GnRH12`', 200, -1, FALSE, '`GnRH12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH13
		$this->GnRH13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH13', 'GnRH13', '`GnRH13`', '`GnRH13`', 200, -1, FALSE, '`GnRH13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// E21
		$this->E21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E21', 'E21', '`E21`', '`E21`', 200, -1, FALSE, '`E21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E21->Sortable = TRUE; // Allow sort
		$this->fields['E21'] = &$this->E21;

		// E22
		$this->E22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E22', 'E22', '`E22`', '`E22`', 200, -1, FALSE, '`E22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E22->Sortable = TRUE; // Allow sort
		$this->fields['E22'] = &$this->E22;

		// E23
		$this->E23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E23', 'E23', '`E23`', '`E23`', 200, -1, FALSE, '`E23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E23->Sortable = TRUE; // Allow sort
		$this->fields['E23'] = &$this->E23;

		// E24
		$this->E24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E24', 'E24', '`E24`', '`E24`', 200, -1, FALSE, '`E24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E24->Sortable = TRUE; // Allow sort
		$this->fields['E24'] = &$this->E24;

		// E25
		$this->E25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E25', 'E25', '`E25`', '`E25`', 200, -1, FALSE, '`E25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E25->Sortable = TRUE; // Allow sort
		$this->fields['E25'] = &$this->E25;

		// E26
		$this->E26 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E26', 'E26', '`E26`', '`E26`', 200, -1, FALSE, '`E26`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E26->Sortable = TRUE; // Allow sort
		$this->fields['E26'] = &$this->E26;

		// E27
		$this->E27 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E27', 'E27', '`E27`', '`E27`', 200, -1, FALSE, '`E27`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E27->Sortable = TRUE; // Allow sort
		$this->fields['E27'] = &$this->E27;

		// E28
		$this->E28 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E28', 'E28', '`E28`', '`E28`', 200, -1, FALSE, '`E28`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E28->Sortable = TRUE; // Allow sort
		$this->fields['E28'] = &$this->E28;

		// E29
		$this->E29 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E29', 'E29', '`E29`', '`E29`', 200, -1, FALSE, '`E29`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E29->Sortable = TRUE; // Allow sort
		$this->fields['E29'] = &$this->E29;

		// E210
		$this->E210 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E210', 'E210', '`E210`', '`E210`', 200, -1, FALSE, '`E210`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E210->Sortable = TRUE; // Allow sort
		$this->fields['E210'] = &$this->E210;

		// E211
		$this->E211 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E211', 'E211', '`E211`', '`E211`', 200, -1, FALSE, '`E211`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E211->Sortable = TRUE; // Allow sort
		$this->fields['E211'] = &$this->E211;

		// E212
		$this->E212 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E212', 'E212', '`E212`', '`E212`', 200, -1, FALSE, '`E212`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E212->Sortable = TRUE; // Allow sort
		$this->fields['E212'] = &$this->E212;

		// E213
		$this->E213 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E213', 'E213', '`E213`', '`E213`', 200, -1, FALSE, '`E213`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E213->Sortable = TRUE; // Allow sort
		$this->fields['E213'] = &$this->E213;

		// P41
		$this->P41 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P41', 'P41', '`P41`', '`P41`', 200, -1, FALSE, '`P41`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P41->Sortable = TRUE; // Allow sort
		$this->fields['P41'] = &$this->P41;

		// P42
		$this->P42 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P42', 'P42', '`P42`', '`P42`', 200, -1, FALSE, '`P42`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P42->Sortable = TRUE; // Allow sort
		$this->fields['P42'] = &$this->P42;

		// P43
		$this->P43 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P43', 'P43', '`P43`', '`P43`', 200, -1, FALSE, '`P43`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P43->Sortable = TRUE; // Allow sort
		$this->fields['P43'] = &$this->P43;

		// P44
		$this->P44 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P44', 'P44', '`P44`', '`P44`', 200, -1, FALSE, '`P44`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P44->Sortable = TRUE; // Allow sort
		$this->fields['P44'] = &$this->P44;

		// P45
		$this->P45 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P45', 'P45', '`P45`', '`P45`', 200, -1, FALSE, '`P45`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P45->Sortable = TRUE; // Allow sort
		$this->fields['P45'] = &$this->P45;

		// P46
		$this->P46 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P46', 'P46', '`P46`', '`P46`', 200, -1, FALSE, '`P46`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P46->Sortable = TRUE; // Allow sort
		$this->fields['P46'] = &$this->P46;

		// P47
		$this->P47 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P47', 'P47', '`P47`', '`P47`', 200, -1, FALSE, '`P47`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P47->Sortable = TRUE; // Allow sort
		$this->fields['P47'] = &$this->P47;

		// P48
		$this->P48 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P48', 'P48', '`P48`', '`P48`', 200, -1, FALSE, '`P48`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P48->Sortable = TRUE; // Allow sort
		$this->fields['P48'] = &$this->P48;

		// P49
		$this->P49 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P49', 'P49', '`P49`', '`P49`', 200, -1, FALSE, '`P49`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P49->Sortable = TRUE; // Allow sort
		$this->fields['P49'] = &$this->P49;

		// P410
		$this->P410 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P410', 'P410', '`P410`', '`P410`', 200, -1, FALSE, '`P410`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P410->Sortable = TRUE; // Allow sort
		$this->fields['P410'] = &$this->P410;

		// P411
		$this->P411 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P411', 'P411', '`P411`', '`P411`', 200, -1, FALSE, '`P411`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P411->Sortable = TRUE; // Allow sort
		$this->fields['P411'] = &$this->P411;

		// P412
		$this->P412 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P412', 'P412', '`P412`', '`P412`', 200, -1, FALSE, '`P412`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P412->Sortable = TRUE; // Allow sort
		$this->fields['P412'] = &$this->P412;

		// P413
		$this->P413 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P413', 'P413', '`P413`', '`P413`', 200, -1, FALSE, '`P413`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P413->Sortable = TRUE; // Allow sort
		$this->fields['P413'] = &$this->P413;

		// USGRt1
		$this->USGRt1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt1', 'USGRt1', '`USGRt1`', '`USGRt1`', 200, -1, FALSE, '`USGRt1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt1->Sortable = TRUE; // Allow sort
		$this->fields['USGRt1'] = &$this->USGRt1;

		// USGRt2
		$this->USGRt2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt2', 'USGRt2', '`USGRt2`', '`USGRt2`', 200, -1, FALSE, '`USGRt2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt2->Sortable = TRUE; // Allow sort
		$this->fields['USGRt2'] = &$this->USGRt2;

		// USGRt3
		$this->USGRt3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt3', 'USGRt3', '`USGRt3`', '`USGRt3`', 200, -1, FALSE, '`USGRt3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt3->Sortable = TRUE; // Allow sort
		$this->fields['USGRt3'] = &$this->USGRt3;

		// USGRt4
		$this->USGRt4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt4', 'USGRt4', '`USGRt4`', '`USGRt4`', 200, -1, FALSE, '`USGRt4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt4->Sortable = TRUE; // Allow sort
		$this->fields['USGRt4'] = &$this->USGRt4;

		// USGRt5
		$this->USGRt5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt5', 'USGRt5', '`USGRt5`', '`USGRt5`', 200, -1, FALSE, '`USGRt5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt5->Sortable = TRUE; // Allow sort
		$this->fields['USGRt5'] = &$this->USGRt5;

		// USGRt6
		$this->USGRt6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt6', 'USGRt6', '`USGRt6`', '`USGRt6`', 200, -1, FALSE, '`USGRt6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt6->Sortable = TRUE; // Allow sort
		$this->fields['USGRt6'] = &$this->USGRt6;

		// USGRt7
		$this->USGRt7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt7', 'USGRt7', '`USGRt7`', '`USGRt7`', 200, -1, FALSE, '`USGRt7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt7->Sortable = TRUE; // Allow sort
		$this->fields['USGRt7'] = &$this->USGRt7;

		// USGRt8
		$this->USGRt8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt8', 'USGRt8', '`USGRt8`', '`USGRt8`', 200, -1, FALSE, '`USGRt8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt8->Sortable = TRUE; // Allow sort
		$this->fields['USGRt8'] = &$this->USGRt8;

		// USGRt9
		$this->USGRt9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt9', 'USGRt9', '`USGRt9`', '`USGRt9`', 200, -1, FALSE, '`USGRt9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt9->Sortable = TRUE; // Allow sort
		$this->fields['USGRt9'] = &$this->USGRt9;

		// USGRt10
		$this->USGRt10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt10', 'USGRt10', '`USGRt10`', '`USGRt10`', 200, -1, FALSE, '`USGRt10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt10->Sortable = TRUE; // Allow sort
		$this->fields['USGRt10'] = &$this->USGRt10;

		// USGRt11
		$this->USGRt11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt11', 'USGRt11', '`USGRt11`', '`USGRt11`', 200, -1, FALSE, '`USGRt11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt11->Sortable = TRUE; // Allow sort
		$this->fields['USGRt11'] = &$this->USGRt11;

		// USGRt12
		$this->USGRt12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt12', 'USGRt12', '`USGRt12`', '`USGRt12`', 200, -1, FALSE, '`USGRt12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt12->Sortable = TRUE; // Allow sort
		$this->fields['USGRt12'] = &$this->USGRt12;

		// USGRt13
		$this->USGRt13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt13', 'USGRt13', '`USGRt13`', '`USGRt13`', 200, -1, FALSE, '`USGRt13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt13->Sortable = TRUE; // Allow sort
		$this->fields['USGRt13'] = &$this->USGRt13;

		// USGLt1
		$this->USGLt1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt1', 'USGLt1', '`USGLt1`', '`USGLt1`', 200, -1, FALSE, '`USGLt1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt1->Sortable = TRUE; // Allow sort
		$this->fields['USGLt1'] = &$this->USGLt1;

		// USGLt2
		$this->USGLt2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt2', 'USGLt2', '`USGLt2`', '`USGLt2`', 200, -1, FALSE, '`USGLt2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt2->Sortable = TRUE; // Allow sort
		$this->fields['USGLt2'] = &$this->USGLt2;

		// USGLt3
		$this->USGLt3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt3', 'USGLt3', '`USGLt3`', '`USGLt3`', 200, -1, FALSE, '`USGLt3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt3->Sortable = TRUE; // Allow sort
		$this->fields['USGLt3'] = &$this->USGLt3;

		// USGLt4
		$this->USGLt4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt4', 'USGLt4', '`USGLt4`', '`USGLt4`', 200, -1, FALSE, '`USGLt4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt4->Sortable = TRUE; // Allow sort
		$this->fields['USGLt4'] = &$this->USGLt4;

		// USGLt5
		$this->USGLt5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt5', 'USGLt5', '`USGLt5`', '`USGLt5`', 200, -1, FALSE, '`USGLt5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt5->Sortable = TRUE; // Allow sort
		$this->fields['USGLt5'] = &$this->USGLt5;

		// USGLt6
		$this->USGLt6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt6', 'USGLt6', '`USGLt6`', '`USGLt6`', 200, -1, FALSE, '`USGLt6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt6->Sortable = TRUE; // Allow sort
		$this->fields['USGLt6'] = &$this->USGLt6;

		// USGLt7
		$this->USGLt7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt7', 'USGLt7', '`USGLt7`', '`USGLt7`', 200, -1, FALSE, '`USGLt7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt7->Sortable = TRUE; // Allow sort
		$this->fields['USGLt7'] = &$this->USGLt7;

		// USGLt8
		$this->USGLt8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt8', 'USGLt8', '`USGLt8`', '`USGLt8`', 200, -1, FALSE, '`USGLt8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt8->Sortable = TRUE; // Allow sort
		$this->fields['USGLt8'] = &$this->USGLt8;

		// USGLt9
		$this->USGLt9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt9', 'USGLt9', '`USGLt9`', '`USGLt9`', 200, -1, FALSE, '`USGLt9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt9->Sortable = TRUE; // Allow sort
		$this->fields['USGLt9'] = &$this->USGLt9;

		// USGLt10
		$this->USGLt10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt10', 'USGLt10', '`USGLt10`', '`USGLt10`', 200, -1, FALSE, '`USGLt10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt10->Sortable = TRUE; // Allow sort
		$this->fields['USGLt10'] = &$this->USGLt10;

		// USGLt11
		$this->USGLt11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt11', 'USGLt11', '`USGLt11`', '`USGLt11`', 200, -1, FALSE, '`USGLt11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt11->Sortable = TRUE; // Allow sort
		$this->fields['USGLt11'] = &$this->USGLt11;

		// USGLt12
		$this->USGLt12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt12', 'USGLt12', '`USGLt12`', '`USGLt12`', 200, -1, FALSE, '`USGLt12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt12->Sortable = TRUE; // Allow sort
		$this->fields['USGLt12'] = &$this->USGLt12;

		// USGLt13
		$this->USGLt13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt13', 'USGLt13', '`USGLt13`', '`USGLt13`', 200, -1, FALSE, '`USGLt13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt13->Sortable = TRUE; // Allow sort
		$this->fields['USGLt13'] = &$this->USGLt13;

		// EM1
		$this->EM1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM1', 'EM1', '`EM1`', '`EM1`', 200, -1, FALSE, '`EM1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM1->Sortable = TRUE; // Allow sort
		$this->fields['EM1'] = &$this->EM1;

		// EM2
		$this->EM2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM2', 'EM2', '`EM2`', '`EM2`', 200, -1, FALSE, '`EM2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM2->Sortable = TRUE; // Allow sort
		$this->fields['EM2'] = &$this->EM2;

		// EM3
		$this->EM3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM3', 'EM3', '`EM3`', '`EM3`', 200, -1, FALSE, '`EM3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM3->Sortable = TRUE; // Allow sort
		$this->fields['EM3'] = &$this->EM3;

		// EM4
		$this->EM4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM4', 'EM4', '`EM4`', '`EM4`', 200, -1, FALSE, '`EM4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM4->Sortable = TRUE; // Allow sort
		$this->fields['EM4'] = &$this->EM4;

		// EM5
		$this->EM5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM5', 'EM5', '`EM5`', '`EM5`', 200, -1, FALSE, '`EM5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM5->Sortable = TRUE; // Allow sort
		$this->fields['EM5'] = &$this->EM5;

		// EM6
		$this->EM6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM6', 'EM6', '`EM6`', '`EM6`', 200, -1, FALSE, '`EM6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM6->Sortable = TRUE; // Allow sort
		$this->fields['EM6'] = &$this->EM6;

		// EM7
		$this->EM7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM7', 'EM7', '`EM7`', '`EM7`', 200, -1, FALSE, '`EM7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM7->Sortable = TRUE; // Allow sort
		$this->fields['EM7'] = &$this->EM7;

		// EM8
		$this->EM8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM8', 'EM8', '`EM8`', '`EM8`', 200, -1, FALSE, '`EM8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM8->Sortable = TRUE; // Allow sort
		$this->fields['EM8'] = &$this->EM8;

		// EM9
		$this->EM9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM9', 'EM9', '`EM9`', '`EM9`', 200, -1, FALSE, '`EM9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM9->Sortable = TRUE; // Allow sort
		$this->fields['EM9'] = &$this->EM9;

		// EM10
		$this->EM10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM10', 'EM10', '`EM10`', '`EM10`', 200, -1, FALSE, '`EM10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM10->Sortable = TRUE; // Allow sort
		$this->fields['EM10'] = &$this->EM10;

		// EM11
		$this->EM11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM11', 'EM11', '`EM11`', '`EM11`', 200, -1, FALSE, '`EM11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM11->Sortable = TRUE; // Allow sort
		$this->fields['EM11'] = &$this->EM11;

		// EM12
		$this->EM12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM12', 'EM12', '`EM12`', '`EM12`', 200, -1, FALSE, '`EM12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM12->Sortable = TRUE; // Allow sort
		$this->fields['EM12'] = &$this->EM12;

		// EM13
		$this->EM13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM13', 'EM13', '`EM13`', '`EM13`', 200, -1, FALSE, '`EM13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM13->Sortable = TRUE; // Allow sort
		$this->fields['EM13'] = &$this->EM13;

		// Others1
		$this->Others1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others1', 'Others1', '`Others1`', '`Others1`', 200, -1, FALSE, '`Others1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others1->Sortable = TRUE; // Allow sort
		$this->fields['Others1'] = &$this->Others1;

		// Others2
		$this->Others2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others2', 'Others2', '`Others2`', '`Others2`', 200, -1, FALSE, '`Others2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others2->Sortable = TRUE; // Allow sort
		$this->fields['Others2'] = &$this->Others2;

		// Others3
		$this->Others3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others3', 'Others3', '`Others3`', '`Others3`', 200, -1, FALSE, '`Others3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others3->Sortable = TRUE; // Allow sort
		$this->fields['Others3'] = &$this->Others3;

		// Others4
		$this->Others4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others4', 'Others4', '`Others4`', '`Others4`', 200, -1, FALSE, '`Others4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others4->Sortable = TRUE; // Allow sort
		$this->fields['Others4'] = &$this->Others4;

		// Others5
		$this->Others5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others5', 'Others5', '`Others5`', '`Others5`', 200, -1, FALSE, '`Others5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others5->Sortable = TRUE; // Allow sort
		$this->fields['Others5'] = &$this->Others5;

		// Others6
		$this->Others6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others6', 'Others6', '`Others6`', '`Others6`', 200, -1, FALSE, '`Others6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others6->Sortable = TRUE; // Allow sort
		$this->fields['Others6'] = &$this->Others6;

		// Others7
		$this->Others7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others7', 'Others7', '`Others7`', '`Others7`', 200, -1, FALSE, '`Others7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others7->Sortable = TRUE; // Allow sort
		$this->fields['Others7'] = &$this->Others7;

		// Others8
		$this->Others8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others8', 'Others8', '`Others8`', '`Others8`', 200, -1, FALSE, '`Others8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others8->Sortable = TRUE; // Allow sort
		$this->fields['Others8'] = &$this->Others8;

		// Others9
		$this->Others9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others9', 'Others9', '`Others9`', '`Others9`', 200, -1, FALSE, '`Others9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others9->Sortable = TRUE; // Allow sort
		$this->fields['Others9'] = &$this->Others9;

		// Others10
		$this->Others10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others10', 'Others10', '`Others10`', '`Others10`', 200, -1, FALSE, '`Others10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others10->Sortable = TRUE; // Allow sort
		$this->fields['Others10'] = &$this->Others10;

		// Others11
		$this->Others11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others11', 'Others11', '`Others11`', '`Others11`', 200, -1, FALSE, '`Others11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others11->Sortable = TRUE; // Allow sort
		$this->fields['Others11'] = &$this->Others11;

		// Others12
		$this->Others12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others12', 'Others12', '`Others12`', '`Others12`', 200, -1, FALSE, '`Others12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others12->Sortable = TRUE; // Allow sort
		$this->fields['Others12'] = &$this->Others12;

		// Others13
		$this->Others13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others13', 'Others13', '`Others13`', '`Others13`', 200, -1, FALSE, '`Others13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others13->Sortable = TRUE; // Allow sort
		$this->fields['Others13'] = &$this->Others13;

		// DR1
		$this->DR1 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR1', 'DR1', '`DR1`', '`DR1`', 200, -1, FALSE, '`DR1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR1->Sortable = TRUE; // Allow sort
		$this->fields['DR1'] = &$this->DR1;

		// DR2
		$this->DR2 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR2', 'DR2', '`DR2`', '`DR2`', 200, -1, FALSE, '`DR2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR2->Sortable = TRUE; // Allow sort
		$this->fields['DR2'] = &$this->DR2;

		// DR3
		$this->DR3 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR3', 'DR3', '`DR3`', '`DR3`', 200, -1, FALSE, '`DR3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR3->Sortable = TRUE; // Allow sort
		$this->fields['DR3'] = &$this->DR3;

		// DR4
		$this->DR4 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR4', 'DR4', '`DR4`', '`DR4`', 200, -1, FALSE, '`DR4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR4->Sortable = TRUE; // Allow sort
		$this->fields['DR4'] = &$this->DR4;

		// DR5
		$this->DR5 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR5', 'DR5', '`DR5`', '`DR5`', 200, -1, FALSE, '`DR5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR5->Sortable = TRUE; // Allow sort
		$this->fields['DR5'] = &$this->DR5;

		// DR6
		$this->DR6 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR6', 'DR6', '`DR6`', '`DR6`', 200, -1, FALSE, '`DR6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR6->Sortable = TRUE; // Allow sort
		$this->fields['DR6'] = &$this->DR6;

		// DR7
		$this->DR7 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR7', 'DR7', '`DR7`', '`DR7`', 200, -1, FALSE, '`DR7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR7->Sortable = TRUE; // Allow sort
		$this->fields['DR7'] = &$this->DR7;

		// DR8
		$this->DR8 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR8', 'DR8', '`DR8`', '`DR8`', 200, -1, FALSE, '`DR8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR8->Sortable = TRUE; // Allow sort
		$this->fields['DR8'] = &$this->DR8;

		// DR9
		$this->DR9 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR9', 'DR9', '`DR9`', '`DR9`', 200, -1, FALSE, '`DR9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR9->Sortable = TRUE; // Allow sort
		$this->fields['DR9'] = &$this->DR9;

		// DR10
		$this->DR10 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR10', 'DR10', '`DR10`', '`DR10`', 200, -1, FALSE, '`DR10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR10->Sortable = TRUE; // Allow sort
		$this->fields['DR10'] = &$this->DR10;

		// DR11
		$this->DR11 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR11', 'DR11', '`DR11`', '`DR11`', 200, -1, FALSE, '`DR11`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR11->Sortable = TRUE; // Allow sort
		$this->fields['DR11'] = &$this->DR11;

		// DR12
		$this->DR12 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR12', 'DR12', '`DR12`', '`DR12`', 200, -1, FALSE, '`DR12`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR12->Sortable = TRUE; // Allow sort
		$this->fields['DR12'] = &$this->DR12;

		// DR13
		$this->DR13 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR13', 'DR13', '`DR13`', '`DR13`', 200, -1, FALSE, '`DR13`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR13->Sortable = TRUE; // Allow sort
		$this->fields['DR13'] = &$this->DR13;

		// DOCTORRESPONSIBLE
		$this->DOCTORRESPONSIBLE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DOCTORRESPONSIBLE', 'DOCTORRESPONSIBLE', '`DOCTORRESPONSIBLE`', '`DOCTORRESPONSIBLE`', 201, -1, FALSE, '`DOCTORRESPONSIBLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DOCTORRESPONSIBLE->Sortable = TRUE; // Allow sort
		$this->fields['DOCTORRESPONSIBLE'] = &$this->DOCTORRESPONSIBLE;

		// TidNo
		$this->TidNo = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Convert
		$this->Convert = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Convert', 'Convert', '`Convert`', '`Convert`', 200, -1, FALSE, '`Convert`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Consultant
		$this->Consultant = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, -1, FALSE, '`Consultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Consultant->Sortable = TRUE; // Allow sort
		$this->fields['Consultant'] = &$this->Consultant;

		// InseminatinTechnique
		$this->InseminatinTechnique = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_InseminatinTechnique', 'InseminatinTechnique', '`InseminatinTechnique`', '`InseminatinTechnique`', 200, -1, FALSE, '`InseminatinTechnique`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IndicationForART
		$this->IndicationForART = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_IndicationForART', 'IndicationForART', '`IndicationForART`', '`IndicationForART`', 200, -1, FALSE, '`IndicationForART`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Hysteroscopy
		$this->Hysteroscopy = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Hysteroscopy', 'Hysteroscopy', '`Hysteroscopy`', '`Hysteroscopy`', 200, -1, FALSE, '`Hysteroscopy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->EndometrialScratching = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EndometrialScratching', 'EndometrialScratching', '`EndometrialScratching`', '`EndometrialScratching`', 200, -1, FALSE, '`EndometrialScratching`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TrialCannulation
		$this->TrialCannulation = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TrialCannulation', 'TrialCannulation', '`TrialCannulation`', '`TrialCannulation`', 200, -1, FALSE, '`TrialCannulation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CYCLETYPE
		$this->CYCLETYPE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CYCLETYPE', 'CYCLETYPE', '`CYCLETYPE`', '`CYCLETYPE`', 200, -1, FALSE, '`CYCLETYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HRTCYCLE
		$this->HRTCYCLE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HRTCYCLE', 'HRTCYCLE', '`HRTCYCLE`', '`HRTCYCLE`', 200, -1, FALSE, '`HRTCYCLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HRTCYCLE->Sortable = TRUE; // Allow sort
		$this->fields['HRTCYCLE'] = &$this->HRTCYCLE;

		// OralEstrogenDosage
		$this->OralEstrogenDosage = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_OralEstrogenDosage', 'OralEstrogenDosage', '`OralEstrogenDosage`', '`OralEstrogenDosage`', 200, -1, FALSE, '`OralEstrogenDosage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// VaginalEstrogen
		$this->VaginalEstrogen = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_VaginalEstrogen', 'VaginalEstrogen', '`VaginalEstrogen`', '`VaginalEstrogen`', 200, -1, FALSE, '`VaginalEstrogen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VaginalEstrogen->Sortable = TRUE; // Allow sort
		$this->fields['VaginalEstrogen'] = &$this->VaginalEstrogen;

		// GCSF
		$this->GCSF = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GCSF', 'GCSF', '`GCSF`', '`GCSF`', 200, -1, FALSE, '`GCSF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ActivatedPRP
		$this->ActivatedPRP = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ActivatedPRP', 'ActivatedPRP', '`ActivatedPRP`', '`ActivatedPRP`', 200, -1, FALSE, '`ActivatedPRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// UCLcm
		$this->UCLcm = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_UCLcm', 'UCLcm', '`UCLcm`', '`UCLcm`', 200, -1, FALSE, '`UCLcm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UCLcm->Sortable = TRUE; // Allow sort
		$this->fields['UCLcm'] = &$this->UCLcm;

		// DATOFEMBRYOTRANSFER
		$this->DATOFEMBRYOTRANSFER = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DATOFEMBRYOTRANSFER', 'DATOFEMBRYOTRANSFER', '`DATOFEMBRYOTRANSFER`', CastDateFieldForLike('`DATOFEMBRYOTRANSFER`', 0, "DB"), 135, -1, FALSE, '`DATOFEMBRYOTRANSFER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DATOFEMBRYOTRANSFER->Sortable = TRUE; // Allow sort
		$this->fields['DATOFEMBRYOTRANSFER'] = &$this->DATOFEMBRYOTRANSFER;

		// DAYOFEMBRYOTRANSFER
		$this->DAYOFEMBRYOTRANSFER = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DAYOFEMBRYOTRANSFER', 'DAYOFEMBRYOTRANSFER', '`DAYOFEMBRYOTRANSFER`', '`DAYOFEMBRYOTRANSFER`', 200, -1, FALSE, '`DAYOFEMBRYOTRANSFER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAYOFEMBRYOTRANSFER->Sortable = TRUE; // Allow sort
		$this->fields['DAYOFEMBRYOTRANSFER'] = &$this->DAYOFEMBRYOTRANSFER;

		// NOOFEMBRYOSTHAWED
		$this->NOOFEMBRYOSTHAWED = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_NOOFEMBRYOSTHAWED', 'NOOFEMBRYOSTHAWED', '`NOOFEMBRYOSTHAWED`', '`NOOFEMBRYOSTHAWED`', 200, -1, FALSE, '`NOOFEMBRYOSTHAWED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->NOOFEMBRYOSTRANSFERRED = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_NOOFEMBRYOSTRANSFERRED', 'NOOFEMBRYOSTRANSFERRED', '`NOOFEMBRYOSTRANSFERRED`', '`NOOFEMBRYOSTRANSFERRED`', 200, -1, FALSE, '`NOOFEMBRYOSTRANSFERRED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOOFEMBRYOSTRANSFERRED->Sortable = TRUE; // Allow sort
		$this->fields['NOOFEMBRYOSTRANSFERRED'] = &$this->NOOFEMBRYOSTRANSFERRED;

		// DAYOFEMBRYOS
		$this->DAYOFEMBRYOS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DAYOFEMBRYOS', 'DAYOFEMBRYOS', '`DAYOFEMBRYOS`', '`DAYOFEMBRYOS`', 200, -1, FALSE, '`DAYOFEMBRYOS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAYOFEMBRYOS->Sortable = TRUE; // Allow sort
		$this->fields['DAYOFEMBRYOS'] = &$this->DAYOFEMBRYOS;

		// CRYOPRESERVEDEMBRYOS
		$this->CRYOPRESERVEDEMBRYOS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CRYOPRESERVEDEMBRYOS', 'CRYOPRESERVEDEMBRYOS', '`CRYOPRESERVEDEMBRYOS`', '`CRYOPRESERVEDEMBRYOS`', 200, -1, FALSE, '`CRYOPRESERVEDEMBRYOS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CRYOPRESERVEDEMBRYOS->Sortable = TRUE; // Allow sort
		$this->fields['CRYOPRESERVEDEMBRYOS'] = &$this->CRYOPRESERVEDEMBRYOS;

		// ViaAdmin
		$this->ViaAdmin = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ViaAdmin', 'ViaAdmin', '`ViaAdmin`', '`ViaAdmin`', 200, -1, FALSE, '`ViaAdmin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ViaAdmin->Sortable = TRUE; // Allow sort
		$this->fields['ViaAdmin'] = &$this->ViaAdmin;

		// ViaStartDateTime
		$this->ViaStartDateTime = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ViaStartDateTime', 'ViaStartDateTime', '`ViaStartDateTime`', CastDateFieldForLike('`ViaStartDateTime`', 0, "DB"), 135, 0, FALSE, '`ViaStartDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ViaDose
		$this->ViaDose = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ViaDose', 'ViaDose', '`ViaDose`', '`ViaDose`', 200, -1, FALSE, '`ViaDose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ViaDose->Sortable = TRUE; // Allow sort
		$this->fields['ViaDose'] = &$this->ViaDose;

		// AllFreeze
		$this->AllFreeze = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_AllFreeze', 'AllFreeze', '`AllFreeze`', '`AllFreeze`', 200, -1, FALSE, '`AllFreeze`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// TreatmentCancel
		$this->TreatmentCancel = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TreatmentCancel', 'TreatmentCancel', '`TreatmentCancel`', '`TreatmentCancel`', 200, -1, FALSE, '`TreatmentCancel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// Reason
		$this->Reason = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Reason', 'Reason', '`Reason`', '`Reason`', 201, -1, FALSE, '`Reason`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Reason->Sortable = TRUE; // Allow sort
		$this->fields['Reason'] = &$this->Reason;

		// ProgesteroneAdmin
		$this->ProgesteroneAdmin = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ProgesteroneAdmin', 'ProgesteroneAdmin', '`ProgesteroneAdmin`', '`ProgesteroneAdmin`', 200, -1, FALSE, '`ProgesteroneAdmin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProgesteroneAdmin->Sortable = TRUE; // Allow sort
		$this->fields['ProgesteroneAdmin'] = &$this->ProgesteroneAdmin;

		// ProgesteroneStart
		$this->ProgesteroneStart = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ProgesteroneStart', 'ProgesteroneStart', '`ProgesteroneStart`', '`ProgesteroneStart`', 200, 11, FALSE, '`ProgesteroneStart`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProgesteroneStart->Sortable = TRUE; // Allow sort
		$this->fields['ProgesteroneStart'] = &$this->ProgesteroneStart;

		// ProgesteroneDose
		$this->ProgesteroneDose = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ProgesteroneDose', 'ProgesteroneDose', '`ProgesteroneDose`', '`ProgesteroneDose`', 200, -1, FALSE, '`ProgesteroneDose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProgesteroneDose->Sortable = TRUE; // Allow sort
		$this->fields['ProgesteroneDose'] = &$this->ProgesteroneDose;

		// Projectron
		$this->Projectron = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Projectron', 'Projectron', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// StChDate14
		$this->StChDate14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate14', 'StChDate14', '`StChDate14`', CastDateFieldForLike('`StChDate14`', 7, "DB"), 135, 7, FALSE, '`StChDate14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate15
		$this->StChDate15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate15', 'StChDate15', '`StChDate15`', CastDateFieldForLike('`StChDate15`', 7, "DB"), 135, 7, FALSE, '`StChDate15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate16
		$this->StChDate16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate16', 'StChDate16', '`StChDate16`', CastDateFieldForLike('`StChDate16`', 7, "DB"), 135, 7, FALSE, '`StChDate16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate17
		$this->StChDate17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate17', 'StChDate17', '`StChDate17`', CastDateFieldForLike('`StChDate17`', 7, "DB"), 135, 7, FALSE, '`StChDate17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate18
		$this->StChDate18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate18', 'StChDate18', '`StChDate18`', CastDateFieldForLike('`StChDate18`', 7, "DB"), 135, 7, FALSE, '`StChDate18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate19
		$this->StChDate19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate19', 'StChDate19', '`StChDate19`', CastDateFieldForLike('`StChDate19`', 7, "DB"), 135, 7, FALSE, '`StChDate19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate20
		$this->StChDate20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate20', 'StChDate20', '`StChDate20`', CastDateFieldForLike('`StChDate20`', 7, "DB"), 135, 7, FALSE, '`StChDate20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate21
		$this->StChDate21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate21', 'StChDate21', '`StChDate21`', CastDateFieldForLike('`StChDate21`', 7, "DB"), 135, 7, FALSE, '`StChDate21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate22
		$this->StChDate22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate22', 'StChDate22', '`StChDate22`', CastDateFieldForLike('`StChDate22`', 7, "DB"), 135, 7, FALSE, '`StChDate22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate23
		$this->StChDate23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate23', 'StChDate23', '`StChDate23`', CastDateFieldForLike('`StChDate23`', 7, "DB"), 135, 7, FALSE, '`StChDate23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate24
		$this->StChDate24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate24', 'StChDate24', '`StChDate24`', CastDateFieldForLike('`StChDate24`', 7, "DB"), 135, 7, FALSE, '`StChDate24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StChDate25
		$this->StChDate25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StChDate25', 'StChDate25', '`StChDate25`', CastDateFieldForLike('`StChDate25`', 7, "DB"), 135, 7, FALSE, '`StChDate25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CycleDay14
		$this->CycleDay14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay14', 'CycleDay14', '`CycleDay14`', '`CycleDay14`', 200, -1, FALSE, '`CycleDay14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay14->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay14'] = &$this->CycleDay14;

		// CycleDay15
		$this->CycleDay15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay15', 'CycleDay15', '`CycleDay15`', '`CycleDay15`', 200, -1, FALSE, '`CycleDay15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay15->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay15'] = &$this->CycleDay15;

		// CycleDay16
		$this->CycleDay16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay16', 'CycleDay16', '`CycleDay16`', '`CycleDay16`', 200, -1, FALSE, '`CycleDay16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay16->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay16'] = &$this->CycleDay16;

		// CycleDay17
		$this->CycleDay17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay17', 'CycleDay17', '`CycleDay17`', '`CycleDay17`', 200, -1, FALSE, '`CycleDay17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay17->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay17'] = &$this->CycleDay17;

		// CycleDay18
		$this->CycleDay18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay18', 'CycleDay18', '`CycleDay18`', '`CycleDay18`', 200, -1, FALSE, '`CycleDay18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay18->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay18'] = &$this->CycleDay18;

		// CycleDay19
		$this->CycleDay19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay19', 'CycleDay19', '`CycleDay19`', '`CycleDay19`', 200, -1, FALSE, '`CycleDay19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay19->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay19'] = &$this->CycleDay19;

		// CycleDay20
		$this->CycleDay20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay20', 'CycleDay20', '`CycleDay20`', '`CycleDay20`', 200, -1, FALSE, '`CycleDay20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay20->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay20'] = &$this->CycleDay20;

		// CycleDay21
		$this->CycleDay21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay21', 'CycleDay21', '`CycleDay21`', '`CycleDay21`', 200, -1, FALSE, '`CycleDay21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay21->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay21'] = &$this->CycleDay21;

		// CycleDay22
		$this->CycleDay22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay22', 'CycleDay22', '`CycleDay22`', '`CycleDay22`', 200, -1, FALSE, '`CycleDay22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay22->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay22'] = &$this->CycleDay22;

		// CycleDay23
		$this->CycleDay23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay23', 'CycleDay23', '`CycleDay23`', '`CycleDay23`', 200, -1, FALSE, '`CycleDay23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay23->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay23'] = &$this->CycleDay23;

		// CycleDay24
		$this->CycleDay24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay24', 'CycleDay24', '`CycleDay24`', '`CycleDay24`', 200, -1, FALSE, '`CycleDay24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay24->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay24'] = &$this->CycleDay24;

		// CycleDay25
		$this->CycleDay25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_CycleDay25', 'CycleDay25', '`CycleDay25`', '`CycleDay25`', 200, -1, FALSE, '`CycleDay25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CycleDay25->Sortable = TRUE; // Allow sort
		$this->fields['CycleDay25'] = &$this->CycleDay25;

		// StimulationDay14
		$this->StimulationDay14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay14', 'StimulationDay14', '`StimulationDay14`', '`StimulationDay14`', 200, -1, FALSE, '`StimulationDay14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay14->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay14'] = &$this->StimulationDay14;

		// StimulationDay15
		$this->StimulationDay15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay15', 'StimulationDay15', '`StimulationDay15`', '`StimulationDay15`', 200, -1, FALSE, '`StimulationDay15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay15->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay15'] = &$this->StimulationDay15;

		// StimulationDay16
		$this->StimulationDay16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay16', 'StimulationDay16', '`StimulationDay16`', '`StimulationDay16`', 200, -1, FALSE, '`StimulationDay16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay16->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay16'] = &$this->StimulationDay16;

		// StimulationDay17
		$this->StimulationDay17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay17', 'StimulationDay17', '`StimulationDay17`', '`StimulationDay17`', 200, -1, FALSE, '`StimulationDay17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay17->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay17'] = &$this->StimulationDay17;

		// StimulationDay18
		$this->StimulationDay18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay18', 'StimulationDay18', '`StimulationDay18`', '`StimulationDay18`', 200, -1, FALSE, '`StimulationDay18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay18->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay18'] = &$this->StimulationDay18;

		// StimulationDay19
		$this->StimulationDay19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay19', 'StimulationDay19', '`StimulationDay19`', '`StimulationDay19`', 200, -1, FALSE, '`StimulationDay19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay19->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay19'] = &$this->StimulationDay19;

		// StimulationDay20
		$this->StimulationDay20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay20', 'StimulationDay20', '`StimulationDay20`', '`StimulationDay20`', 200, -1, FALSE, '`StimulationDay20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay20->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay20'] = &$this->StimulationDay20;

		// StimulationDay21
		$this->StimulationDay21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay21', 'StimulationDay21', '`StimulationDay21`', '`StimulationDay21`', 200, -1, FALSE, '`StimulationDay21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay21->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay21'] = &$this->StimulationDay21;

		// StimulationDay22
		$this->StimulationDay22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay22', 'StimulationDay22', '`StimulationDay22`', '`StimulationDay22`', 200, -1, FALSE, '`StimulationDay22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay22->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay22'] = &$this->StimulationDay22;

		// StimulationDay23
		$this->StimulationDay23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay23', 'StimulationDay23', '`StimulationDay23`', '`StimulationDay23`', 200, -1, FALSE, '`StimulationDay23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay23->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay23'] = &$this->StimulationDay23;

		// StimulationDay24
		$this->StimulationDay24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay24', 'StimulationDay24', '`StimulationDay24`', '`StimulationDay24`', 200, -1, FALSE, '`StimulationDay24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay24->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay24'] = &$this->StimulationDay24;

		// StimulationDay25
		$this->StimulationDay25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_StimulationDay25', 'StimulationDay25', '`StimulationDay25`', '`StimulationDay25`', 200, -1, FALSE, '`StimulationDay25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StimulationDay25->Sortable = TRUE; // Allow sort
		$this->fields['StimulationDay25'] = &$this->StimulationDay25;

		// Tablet14
		$this->Tablet14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet14', 'Tablet14', '`Tablet14`', '`Tablet14`', 200, -1, FALSE, '`Tablet14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet15
		$this->Tablet15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet15', 'Tablet15', '`Tablet15`', '`Tablet15`', 200, -1, FALSE, '`Tablet15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet16
		$this->Tablet16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet16', 'Tablet16', '`Tablet16`', '`Tablet16`', 200, -1, FALSE, '`Tablet16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet17
		$this->Tablet17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet17', 'Tablet17', '`Tablet17`', '`Tablet17`', 200, -1, FALSE, '`Tablet17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet18
		$this->Tablet18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet18', 'Tablet18', '`Tablet18`', '`Tablet18`', 200, -1, FALSE, '`Tablet18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet19
		$this->Tablet19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet19', 'Tablet19', '`Tablet19`', '`Tablet19`', 200, -1, FALSE, '`Tablet19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet20
		$this->Tablet20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet20', 'Tablet20', '`Tablet20`', '`Tablet20`', 200, -1, FALSE, '`Tablet20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet21
		$this->Tablet21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet21', 'Tablet21', '`Tablet21`', '`Tablet21`', 200, -1, FALSE, '`Tablet21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet22
		$this->Tablet22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet22', 'Tablet22', '`Tablet22`', '`Tablet22`', 200, -1, FALSE, '`Tablet22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet23
		$this->Tablet23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet23', 'Tablet23', '`Tablet23`', '`Tablet23`', 200, -1, FALSE, '`Tablet23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet24
		$this->Tablet24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet24', 'Tablet24', '`Tablet24`', '`Tablet24`', 200, -1, FALSE, '`Tablet24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Tablet25
		$this->Tablet25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Tablet25', 'Tablet25', '`Tablet25`', '`Tablet25`', 200, -1, FALSE, '`Tablet25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH14
		$this->RFSH14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH14', 'RFSH14', '`RFSH14`', '`RFSH14`', 200, -1, FALSE, '`RFSH14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH15
		$this->RFSH15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH15', 'RFSH15', '`RFSH15`', '`RFSH15`', 200, -1, FALSE, '`RFSH15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH16
		$this->RFSH16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH16', 'RFSH16', '`RFSH16`', '`RFSH16`', 200, -1, FALSE, '`RFSH16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH17
		$this->RFSH17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH17', 'RFSH17', '`RFSH17`', '`RFSH17`', 200, -1, FALSE, '`RFSH17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH18
		$this->RFSH18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH18', 'RFSH18', '`RFSH18`', '`RFSH18`', 200, -1, FALSE, '`RFSH18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH19
		$this->RFSH19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH19', 'RFSH19', '`RFSH19`', '`RFSH19`', 200, -1, FALSE, '`RFSH19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH20
		$this->RFSH20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH20', 'RFSH20', '`RFSH20`', '`RFSH20`', 200, -1, FALSE, '`RFSH20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH21
		$this->RFSH21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH21', 'RFSH21', '`RFSH21`', '`RFSH21`', 200, -1, FALSE, '`RFSH21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH22
		$this->RFSH22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH22', 'RFSH22', '`RFSH22`', '`RFSH22`', 200, -1, FALSE, '`RFSH22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH23
		$this->RFSH23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH23', 'RFSH23', '`RFSH23`', '`RFSH23`', 200, -1, FALSE, '`RFSH23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH24
		$this->RFSH24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH24', 'RFSH24', '`RFSH24`', '`RFSH24`', 200, -1, FALSE, '`RFSH24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RFSH25
		$this->RFSH25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_RFSH25', 'RFSH25', '`RFSH25`', '`RFSH25`', 200, -1, FALSE, '`RFSH25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG14
		$this->HMG14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG14', 'HMG14', '`HMG14`', '`HMG14`', 200, -1, FALSE, '`HMG14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG15
		$this->HMG15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG15', 'HMG15', '`HMG15`', '`HMG15`', 200, -1, FALSE, '`HMG15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG16
		$this->HMG16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG16', 'HMG16', '`HMG16`', '`HMG16`', 200, -1, FALSE, '`HMG16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG17
		$this->HMG17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG17', 'HMG17', '`HMG17`', '`HMG17`', 200, -1, FALSE, '`HMG17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG18
		$this->HMG18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG18', 'HMG18', '`HMG18`', '`HMG18`', 200, -1, FALSE, '`HMG18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG19
		$this->HMG19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG19', 'HMG19', '`HMG19`', '`HMG19`', 200, -1, FALSE, '`HMG19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG20
		$this->HMG20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG20', 'HMG20', '`HMG20`', '`HMG20`', 200, -1, FALSE, '`HMG20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG21
		$this->HMG21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG21', 'HMG21', '`HMG21`', '`HMG21`', 200, -1, FALSE, '`HMG21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG22
		$this->HMG22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG22', 'HMG22', '`HMG22`', '`HMG22`', 200, -1, FALSE, '`HMG22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG23
		$this->HMG23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG23', 'HMG23', '`HMG23`', '`HMG23`', 200, -1, FALSE, '`HMG23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG24
		$this->HMG24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG24', 'HMG24', '`HMG24`', '`HMG24`', 200, -1, FALSE, '`HMG24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HMG25
		$this->HMG25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HMG25', 'HMG25', '`HMG25`', '`HMG25`', 200, -1, FALSE, '`HMG25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH14
		$this->GnRH14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH14', 'GnRH14', '`GnRH14`', '`GnRH14`', 200, -1, FALSE, '`GnRH14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH15
		$this->GnRH15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH15', 'GnRH15', '`GnRH15`', '`GnRH15`', 200, -1, FALSE, '`GnRH15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH16
		$this->GnRH16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH16', 'GnRH16', '`GnRH16`', '`GnRH16`', 200, -1, FALSE, '`GnRH16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH17
		$this->GnRH17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH17', 'GnRH17', '`GnRH17`', '`GnRH17`', 200, -1, FALSE, '`GnRH17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH18
		$this->GnRH18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH18', 'GnRH18', '`GnRH18`', '`GnRH18`', 200, -1, FALSE, '`GnRH18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH19
		$this->GnRH19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH19', 'GnRH19', '`GnRH19`', '`GnRH19`', 200, -1, FALSE, '`GnRH19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH20
		$this->GnRH20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH20', 'GnRH20', '`GnRH20`', '`GnRH20`', 200, -1, FALSE, '`GnRH20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH21
		$this->GnRH21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH21', 'GnRH21', '`GnRH21`', '`GnRH21`', 200, -1, FALSE, '`GnRH21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH22
		$this->GnRH22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH22', 'GnRH22', '`GnRH22`', '`GnRH22`', 200, -1, FALSE, '`GnRH22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH23
		$this->GnRH23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH23', 'GnRH23', '`GnRH23`', '`GnRH23`', 200, -1, FALSE, '`GnRH23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH24
		$this->GnRH24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH24', 'GnRH24', '`GnRH24`', '`GnRH24`', 200, -1, FALSE, '`GnRH24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GnRH25
		$this->GnRH25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_GnRH25', 'GnRH25', '`GnRH25`', '`GnRH25`', 200, -1, FALSE, '`GnRH25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// P414
		$this->P414 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P414', 'P414', '`P414`', '`P414`', 200, -1, FALSE, '`P414`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P414->Sortable = TRUE; // Allow sort
		$this->fields['P414'] = &$this->P414;

		// P415
		$this->P415 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P415', 'P415', '`P415`', '`P415`', 200, -1, FALSE, '`P415`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P415->Sortable = TRUE; // Allow sort
		$this->fields['P415'] = &$this->P415;

		// P416
		$this->P416 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P416', 'P416', '`P416`', '`P416`', 200, -1, FALSE, '`P416`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P416->Sortable = TRUE; // Allow sort
		$this->fields['P416'] = &$this->P416;

		// P417
		$this->P417 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P417', 'P417', '`P417`', '`P417`', 200, -1, FALSE, '`P417`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P417->Sortable = TRUE; // Allow sort
		$this->fields['P417'] = &$this->P417;

		// P418
		$this->P418 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P418', 'P418', '`P418`', '`P418`', 200, -1, FALSE, '`P418`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P418->Sortable = TRUE; // Allow sort
		$this->fields['P418'] = &$this->P418;

		// P419
		$this->P419 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P419', 'P419', '`P419`', '`P419`', 200, -1, FALSE, '`P419`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P419->Sortable = TRUE; // Allow sort
		$this->fields['P419'] = &$this->P419;

		// P420
		$this->P420 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P420', 'P420', '`P420`', '`P420`', 200, -1, FALSE, '`P420`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P420->Sortable = TRUE; // Allow sort
		$this->fields['P420'] = &$this->P420;

		// P421
		$this->P421 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P421', 'P421', '`P421`', '`P421`', 200, -1, FALSE, '`P421`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P421->Sortable = TRUE; // Allow sort
		$this->fields['P421'] = &$this->P421;

		// P422
		$this->P422 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P422', 'P422', '`P422`', '`P422`', 200, -1, FALSE, '`P422`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P422->Sortable = TRUE; // Allow sort
		$this->fields['P422'] = &$this->P422;

		// P423
		$this->P423 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P423', 'P423', '`P423`', '`P423`', 200, -1, FALSE, '`P423`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P423->Sortable = TRUE; // Allow sort
		$this->fields['P423'] = &$this->P423;

		// P424
		$this->P424 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P424', 'P424', '`P424`', '`P424`', 200, -1, FALSE, '`P424`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P424->Sortable = TRUE; // Allow sort
		$this->fields['P424'] = &$this->P424;

		// P425
		$this->P425 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_P425', 'P425', '`P425`', '`P425`', 200, -1, FALSE, '`P425`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P425->Sortable = TRUE; // Allow sort
		$this->fields['P425'] = &$this->P425;

		// USGRt14
		$this->USGRt14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt14', 'USGRt14', '`USGRt14`', '`USGRt14`', 200, -1, FALSE, '`USGRt14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt14->Sortable = TRUE; // Allow sort
		$this->fields['USGRt14'] = &$this->USGRt14;

		// USGRt15
		$this->USGRt15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt15', 'USGRt15', '`USGRt15`', '`USGRt15`', 200, -1, FALSE, '`USGRt15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt15->Sortable = TRUE; // Allow sort
		$this->fields['USGRt15'] = &$this->USGRt15;

		// USGRt16
		$this->USGRt16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt16', 'USGRt16', '`USGRt16`', '`USGRt16`', 200, -1, FALSE, '`USGRt16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt16->Sortable = TRUE; // Allow sort
		$this->fields['USGRt16'] = &$this->USGRt16;

		// USGRt17
		$this->USGRt17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt17', 'USGRt17', '`USGRt17`', '`USGRt17`', 200, -1, FALSE, '`USGRt17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt17->Sortable = TRUE; // Allow sort
		$this->fields['USGRt17'] = &$this->USGRt17;

		// USGRt18
		$this->USGRt18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt18', 'USGRt18', '`USGRt18`', '`USGRt18`', 200, -1, FALSE, '`USGRt18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt18->Sortable = TRUE; // Allow sort
		$this->fields['USGRt18'] = &$this->USGRt18;

		// USGRt19
		$this->USGRt19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt19', 'USGRt19', '`USGRt19`', '`USGRt19`', 200, -1, FALSE, '`USGRt19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt19->Sortable = TRUE; // Allow sort
		$this->fields['USGRt19'] = &$this->USGRt19;

		// USGRt20
		$this->USGRt20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt20', 'USGRt20', '`USGRt20`', '`USGRt20`', 200, -1, FALSE, '`USGRt20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt20->Sortable = TRUE; // Allow sort
		$this->fields['USGRt20'] = &$this->USGRt20;

		// USGRt21
		$this->USGRt21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt21', 'USGRt21', '`USGRt21`', '`USGRt21`', 200, -1, FALSE, '`USGRt21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt21->Sortable = TRUE; // Allow sort
		$this->fields['USGRt21'] = &$this->USGRt21;

		// USGRt22
		$this->USGRt22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt22', 'USGRt22', '`USGRt22`', '`USGRt22`', 200, -1, FALSE, '`USGRt22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt22->Sortable = TRUE; // Allow sort
		$this->fields['USGRt22'] = &$this->USGRt22;

		// USGRt23
		$this->USGRt23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt23', 'USGRt23', '`USGRt23`', '`USGRt23`', 200, -1, FALSE, '`USGRt23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt23->Sortable = TRUE; // Allow sort
		$this->fields['USGRt23'] = &$this->USGRt23;

		// USGRt24
		$this->USGRt24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt24', 'USGRt24', '`USGRt24`', '`USGRt24`', 200, -1, FALSE, '`USGRt24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt24->Sortable = TRUE; // Allow sort
		$this->fields['USGRt24'] = &$this->USGRt24;

		// USGRt25
		$this->USGRt25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGRt25', 'USGRt25', '`USGRt25`', '`USGRt25`', 200, -1, FALSE, '`USGRt25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGRt25->Sortable = TRUE; // Allow sort
		$this->fields['USGRt25'] = &$this->USGRt25;

		// USGLt14
		$this->USGLt14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt14', 'USGLt14', '`USGLt14`', '`USGLt14`', 200, -1, FALSE, '`USGLt14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt14->Sortable = TRUE; // Allow sort
		$this->fields['USGLt14'] = &$this->USGLt14;

		// USGLt15
		$this->USGLt15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt15', 'USGLt15', '`USGLt15`', '`USGLt15`', 200, -1, FALSE, '`USGLt15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt15->Sortable = TRUE; // Allow sort
		$this->fields['USGLt15'] = &$this->USGLt15;

		// USGLt16
		$this->USGLt16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt16', 'USGLt16', '`USGLt16`', '`USGLt16`', 200, -1, FALSE, '`USGLt16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt16->Sortable = TRUE; // Allow sort
		$this->fields['USGLt16'] = &$this->USGLt16;

		// USGLt17
		$this->USGLt17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt17', 'USGLt17', '`USGLt17`', '`USGLt17`', 200, -1, FALSE, '`USGLt17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt17->Sortable = TRUE; // Allow sort
		$this->fields['USGLt17'] = &$this->USGLt17;

		// USGLt18
		$this->USGLt18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt18', 'USGLt18', '`USGLt18`', '`USGLt18`', 200, -1, FALSE, '`USGLt18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt18->Sortable = TRUE; // Allow sort
		$this->fields['USGLt18'] = &$this->USGLt18;

		// USGLt19
		$this->USGLt19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt19', 'USGLt19', '`USGLt19`', '`USGLt19`', 200, -1, FALSE, '`USGLt19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt19->Sortable = TRUE; // Allow sort
		$this->fields['USGLt19'] = &$this->USGLt19;

		// USGLt20
		$this->USGLt20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt20', 'USGLt20', '`USGLt20`', '`USGLt20`', 200, -1, FALSE, '`USGLt20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt20->Sortable = TRUE; // Allow sort
		$this->fields['USGLt20'] = &$this->USGLt20;

		// USGLt21
		$this->USGLt21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt21', 'USGLt21', '`USGLt21`', '`USGLt21`', 200, -1, FALSE, '`USGLt21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt21->Sortable = TRUE; // Allow sort
		$this->fields['USGLt21'] = &$this->USGLt21;

		// USGLt22
		$this->USGLt22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt22', 'USGLt22', '`USGLt22`', '`USGLt22`', 200, -1, FALSE, '`USGLt22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt22->Sortable = TRUE; // Allow sort
		$this->fields['USGLt22'] = &$this->USGLt22;

		// USGLt23
		$this->USGLt23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt23', 'USGLt23', '`USGLt23`', '`USGLt23`', 200, -1, FALSE, '`USGLt23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt23->Sortable = TRUE; // Allow sort
		$this->fields['USGLt23'] = &$this->USGLt23;

		// USGLt24
		$this->USGLt24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt24', 'USGLt24', '`USGLt24`', '`USGLt24`', 200, -1, FALSE, '`USGLt24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt24->Sortable = TRUE; // Allow sort
		$this->fields['USGLt24'] = &$this->USGLt24;

		// USGLt25
		$this->USGLt25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_USGLt25', 'USGLt25', '`USGLt25`', '`USGLt25`', 200, -1, FALSE, '`USGLt25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USGLt25->Sortable = TRUE; // Allow sort
		$this->fields['USGLt25'] = &$this->USGLt25;

		// EM14
		$this->EM14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM14', 'EM14', '`EM14`', '`EM14`', 200, -1, FALSE, '`EM14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM14->Sortable = TRUE; // Allow sort
		$this->fields['EM14'] = &$this->EM14;

		// EM15
		$this->EM15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM15', 'EM15', '`EM15`', '`EM15`', 200, -1, FALSE, '`EM15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM15->Sortable = TRUE; // Allow sort
		$this->fields['EM15'] = &$this->EM15;

		// EM16
		$this->EM16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM16', 'EM16', '`EM16`', '`EM16`', 200, -1, FALSE, '`EM16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM16->Sortable = TRUE; // Allow sort
		$this->fields['EM16'] = &$this->EM16;

		// EM17
		$this->EM17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM17', 'EM17', '`EM17`', '`EM17`', 200, -1, FALSE, '`EM17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM17->Sortable = TRUE; // Allow sort
		$this->fields['EM17'] = &$this->EM17;

		// EM18
		$this->EM18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM18', 'EM18', '`EM18`', '`EM18`', 200, -1, FALSE, '`EM18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM18->Sortable = TRUE; // Allow sort
		$this->fields['EM18'] = &$this->EM18;

		// EM19
		$this->EM19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM19', 'EM19', '`EM19`', '`EM19`', 200, -1, FALSE, '`EM19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM19->Sortable = TRUE; // Allow sort
		$this->fields['EM19'] = &$this->EM19;

		// EM20
		$this->EM20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM20', 'EM20', '`EM20`', '`EM20`', 200, -1, FALSE, '`EM20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM20->Sortable = TRUE; // Allow sort
		$this->fields['EM20'] = &$this->EM20;

		// EM21
		$this->EM21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM21', 'EM21', '`EM21`', '`EM21`', 200, -1, FALSE, '`EM21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM21->Sortable = TRUE; // Allow sort
		$this->fields['EM21'] = &$this->EM21;

		// EM22
		$this->EM22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM22', 'EM22', '`EM22`', '`EM22`', 200, -1, FALSE, '`EM22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM22->Sortable = TRUE; // Allow sort
		$this->fields['EM22'] = &$this->EM22;

		// EM23
		$this->EM23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM23', 'EM23', '`EM23`', '`EM23`', 200, -1, FALSE, '`EM23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM23->Sortable = TRUE; // Allow sort
		$this->fields['EM23'] = &$this->EM23;

		// EM24
		$this->EM24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM24', 'EM24', '`EM24`', '`EM24`', 200, -1, FALSE, '`EM24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM24->Sortable = TRUE; // Allow sort
		$this->fields['EM24'] = &$this->EM24;

		// EM25
		$this->EM25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EM25', 'EM25', '`EM25`', '`EM25`', 200, -1, FALSE, '`EM25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EM25->Sortable = TRUE; // Allow sort
		$this->fields['EM25'] = &$this->EM25;

		// Others14
		$this->Others14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others14', 'Others14', '`Others14`', '`Others14`', 200, -1, FALSE, '`Others14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others14->Sortable = TRUE; // Allow sort
		$this->fields['Others14'] = &$this->Others14;

		// Others15
		$this->Others15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others15', 'Others15', '`Others15`', '`Others15`', 200, -1, FALSE, '`Others15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others15->Sortable = TRUE; // Allow sort
		$this->fields['Others15'] = &$this->Others15;

		// Others16
		$this->Others16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others16', 'Others16', '`Others16`', '`Others16`', 200, -1, FALSE, '`Others16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others16->Sortable = TRUE; // Allow sort
		$this->fields['Others16'] = &$this->Others16;

		// Others17
		$this->Others17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others17', 'Others17', '`Others17`', '`Others17`', 200, -1, FALSE, '`Others17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others17->Sortable = TRUE; // Allow sort
		$this->fields['Others17'] = &$this->Others17;

		// Others18
		$this->Others18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others18', 'Others18', '`Others18`', '`Others18`', 200, -1, FALSE, '`Others18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others18->Sortable = TRUE; // Allow sort
		$this->fields['Others18'] = &$this->Others18;

		// Others19
		$this->Others19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others19', 'Others19', '`Others19`', '`Others19`', 200, -1, FALSE, '`Others19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others19->Sortable = TRUE; // Allow sort
		$this->fields['Others19'] = &$this->Others19;

		// Others20
		$this->Others20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others20', 'Others20', '`Others20`', '`Others20`', 200, -1, FALSE, '`Others20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others20->Sortable = TRUE; // Allow sort
		$this->fields['Others20'] = &$this->Others20;

		// Others21
		$this->Others21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others21', 'Others21', '`Others21`', '`Others21`', 200, -1, FALSE, '`Others21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others21->Sortable = TRUE; // Allow sort
		$this->fields['Others21'] = &$this->Others21;

		// Others22
		$this->Others22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others22', 'Others22', '`Others22`', '`Others22`', 200, -1, FALSE, '`Others22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others22->Sortable = TRUE; // Allow sort
		$this->fields['Others22'] = &$this->Others22;

		// Others23
		$this->Others23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others23', 'Others23', '`Others23`', '`Others23`', 200, -1, FALSE, '`Others23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others23->Sortable = TRUE; // Allow sort
		$this->fields['Others23'] = &$this->Others23;

		// Others24
		$this->Others24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others24', 'Others24', '`Others24`', '`Others24`', 200, -1, FALSE, '`Others24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others24->Sortable = TRUE; // Allow sort
		$this->fields['Others24'] = &$this->Others24;

		// Others25
		$this->Others25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_Others25', 'Others25', '`Others25`', '`Others25`', 200, -1, FALSE, '`Others25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others25->Sortable = TRUE; // Allow sort
		$this->fields['Others25'] = &$this->Others25;

		// DR14
		$this->DR14 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR14', 'DR14', '`DR14`', '`DR14`', 200, -1, FALSE, '`DR14`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR14->Sortable = TRUE; // Allow sort
		$this->fields['DR14'] = &$this->DR14;

		// DR15
		$this->DR15 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR15', 'DR15', '`DR15`', '`DR15`', 200, -1, FALSE, '`DR15`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR15->Sortable = TRUE; // Allow sort
		$this->fields['DR15'] = &$this->DR15;

		// DR16
		$this->DR16 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR16', 'DR16', '`DR16`', '`DR16`', 200, -1, FALSE, '`DR16`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR16->Sortable = TRUE; // Allow sort
		$this->fields['DR16'] = &$this->DR16;

		// DR17
		$this->DR17 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR17', 'DR17', '`DR17`', '`DR17`', 200, -1, FALSE, '`DR17`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR17->Sortable = TRUE; // Allow sort
		$this->fields['DR17'] = &$this->DR17;

		// DR18
		$this->DR18 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR18', 'DR18', '`DR18`', '`DR18`', 200, -1, FALSE, '`DR18`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR18->Sortable = TRUE; // Allow sort
		$this->fields['DR18'] = &$this->DR18;

		// DR19
		$this->DR19 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR19', 'DR19', '`DR19`', '`DR19`', 200, -1, FALSE, '`DR19`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR19->Sortable = TRUE; // Allow sort
		$this->fields['DR19'] = &$this->DR19;

		// DR20
		$this->DR20 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR20', 'DR20', '`DR20`', '`DR20`', 200, -1, FALSE, '`DR20`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR20->Sortable = TRUE; // Allow sort
		$this->fields['DR20'] = &$this->DR20;

		// DR21
		$this->DR21 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR21', 'DR21', '`DR21`', '`DR21`', 200, -1, FALSE, '`DR21`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR21->Sortable = TRUE; // Allow sort
		$this->fields['DR21'] = &$this->DR21;

		// DR22
		$this->DR22 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR22', 'DR22', '`DR22`', '`DR22`', 200, -1, FALSE, '`DR22`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR22->Sortable = TRUE; // Allow sort
		$this->fields['DR22'] = &$this->DR22;

		// DR23
		$this->DR23 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR23', 'DR23', '`DR23`', '`DR23`', 200, -1, FALSE, '`DR23`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR23->Sortable = TRUE; // Allow sort
		$this->fields['DR23'] = &$this->DR23;

		// DR24
		$this->DR24 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR24', 'DR24', '`DR24`', '`DR24`', 200, -1, FALSE, '`DR24`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR24->Sortable = TRUE; // Allow sort
		$this->fields['DR24'] = &$this->DR24;

		// DR25
		$this->DR25 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DR25', 'DR25', '`DR25`', '`DR25`', 200, -1, FALSE, '`DR25`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DR25->Sortable = TRUE; // Allow sort
		$this->fields['DR25'] = &$this->DR25;

		// E214
		$this->E214 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E214', 'E214', '`E214`', '`E214`', 200, -1, FALSE, '`E214`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E214->Sortable = TRUE; // Allow sort
		$this->fields['E214'] = &$this->E214;

		// E215
		$this->E215 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E215', 'E215', '`E215`', '`E215`', 200, -1, FALSE, '`E215`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E215->Sortable = TRUE; // Allow sort
		$this->fields['E215'] = &$this->E215;

		// E216
		$this->E216 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E216', 'E216', '`E216`', '`E216`', 200, -1, FALSE, '`E216`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E216->Sortable = TRUE; // Allow sort
		$this->fields['E216'] = &$this->E216;

		// E217
		$this->E217 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E217', 'E217', '`E217`', '`E217`', 200, -1, FALSE, '`E217`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E217->Sortable = TRUE; // Allow sort
		$this->fields['E217'] = &$this->E217;

		// E218
		$this->E218 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E218', 'E218', '`E218`', '`E218`', 200, -1, FALSE, '`E218`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E218->Sortable = TRUE; // Allow sort
		$this->fields['E218'] = &$this->E218;

		// E219
		$this->E219 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E219', 'E219', '`E219`', '`E219`', 200, -1, FALSE, '`E219`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E219->Sortable = TRUE; // Allow sort
		$this->fields['E219'] = &$this->E219;

		// E220
		$this->E220 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E220', 'E220', '`E220`', '`E220`', 200, -1, FALSE, '`E220`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E220->Sortable = TRUE; // Allow sort
		$this->fields['E220'] = &$this->E220;

		// E221
		$this->E221 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E221', 'E221', '`E221`', '`E221`', 200, -1, FALSE, '`E221`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E221->Sortable = TRUE; // Allow sort
		$this->fields['E221'] = &$this->E221;

		// E222
		$this->E222 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E222', 'E222', '`E222`', '`E222`', 200, -1, FALSE, '`E222`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E222->Sortable = TRUE; // Allow sort
		$this->fields['E222'] = &$this->E222;

		// E223
		$this->E223 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E223', 'E223', '`E223`', '`E223`', 200, -1, FALSE, '`E223`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E223->Sortable = TRUE; // Allow sort
		$this->fields['E223'] = &$this->E223;

		// E224
		$this->E224 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E224', 'E224', '`E224`', '`E224`', 200, -1, FALSE, '`E224`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E224->Sortable = TRUE; // Allow sort
		$this->fields['E224'] = &$this->E224;

		// E225
		$this->E225 = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_E225', 'E225', '`E225`', '`E225`', 200, -1, FALSE, '`E225`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E225->Sortable = TRUE; // Allow sort
		$this->fields['E225'] = &$this->E225;

		// EEETTTDTE
		$this->EEETTTDTE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EEETTTDTE', 'EEETTTDTE', '`EEETTTDTE`', CastDateFieldForLike('`EEETTTDTE`', 7, "DB"), 135, 7, FALSE, '`EEETTTDTE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bhcgdate
		$this->bhcgdate = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_bhcgdate', 'bhcgdate', '`bhcgdate`', CastDateFieldForLike('`bhcgdate`', 7, "DB"), 135, 7, FALSE, '`bhcgdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TUBAL_PATENCY
		$this->TUBAL_PATENCY = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TUBAL_PATENCY', 'TUBAL_PATENCY', '`TUBAL_PATENCY`', '`TUBAL_PATENCY`', 200, -1, FALSE, '`TUBAL_PATENCY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HSG
		$this->HSG = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_HSG', 'HSG', '`HSG`', '`HSG`', 200, -1, FALSE, '`HSG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DHL
		$this->DHL = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_DHL', 'DHL', '`DHL`', '`DHL`', 200, -1, FALSE, '`DHL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// UTERINE_PROBLEMS
		$this->UTERINE_PROBLEMS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_UTERINE_PROBLEMS', 'UTERINE_PROBLEMS', '`UTERINE_PROBLEMS`', '`UTERINE_PROBLEMS`', 200, -1, FALSE, '`UTERINE_PROBLEMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// W_COMORBIDS
		$this->W_COMORBIDS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_W_COMORBIDS', 'W_COMORBIDS', '`W_COMORBIDS`', '`W_COMORBIDS`', 200, -1, FALSE, '`W_COMORBIDS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// H_COMORBIDS
		$this->H_COMORBIDS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_H_COMORBIDS', 'H_COMORBIDS', '`H_COMORBIDS`', '`H_COMORBIDS`', 200, -1, FALSE, '`H_COMORBIDS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// SEXUAL_DYSFUNCTION
		$this->SEXUAL_DYSFUNCTION = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_SEXUAL_DYSFUNCTION', 'SEXUAL_DYSFUNCTION', '`SEXUAL_DYSFUNCTION`', '`SEXUAL_DYSFUNCTION`', 200, -1, FALSE, '`SEXUAL_DYSFUNCTION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TABLETS
		$this->TABLETS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_TABLETS', 'TABLETS', '`TABLETS`', '`TABLETS`', 200, -1, FALSE, '`TABLETS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TABLETS->Sortable = TRUE; // Allow sort
		$this->fields['TABLETS'] = &$this->TABLETS;

		// FOLLICLE_STATUS
		$this->FOLLICLE_STATUS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_FOLLICLE_STATUS', 'FOLLICLE_STATUS', '`FOLLICLE_STATUS`', '`FOLLICLE_STATUS`', 200, -1, FALSE, '`FOLLICLE_STATUS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NUMBER_OF_IUI
		$this->NUMBER_OF_IUI = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_NUMBER_OF_IUI', 'NUMBER_OF_IUI', '`NUMBER_OF_IUI`', '`NUMBER_OF_IUI`', 200, -1, FALSE, '`NUMBER_OF_IUI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PROCEDURE
		$this->PROCEDURE = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_PROCEDURE', 'PROCEDURE', '`PROCEDURE`', '`PROCEDURE`', 200, -1, FALSE, '`PROCEDURE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// LUTEAL_SUPPORT
		$this->LUTEAL_SUPPORT = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_LUTEAL_SUPPORT', 'LUTEAL_SUPPORT', '`LUTEAL_SUPPORT`', '`LUTEAL_SUPPORT`', 200, -1, FALSE, '`LUTEAL_SUPPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->SPECIFIC_MATERNAL_PROBLEMS = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_SPECIFIC_MATERNAL_PROBLEMS', 'SPECIFIC_MATERNAL_PROBLEMS', '`SPECIFIC_MATERNAL_PROBLEMS`', '`SPECIFIC_MATERNAL_PROBLEMS`', 200, -1, FALSE, '`SPECIFIC_MATERNAL_PROBLEMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ONGOING_PREG
		$this->ONGOING_PREG = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_ONGOING_PREG', 'ONGOING_PREG', '`ONGOING_PREG`', '`ONGOING_PREG`', 200, -1, FALSE, '`ONGOING_PREG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ONGOING_PREG->Sortable = TRUE; // Allow sort
		$this->fields['ONGOING_PREG'] = &$this->ONGOING_PREG;

		// EDD_Date
		$this->EDD_Date = new DbField('ivf_stimulation_chart', 'ivf_stimulation_chart', 'x_EDD_Date', 'EDD_Date', '`EDD_Date`', CastDateFieldForLike('`EDD_Date`', 0, "DB"), 135, 0, FALSE, '`EDD_Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_stimulation_chartview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
