...
class store_storeled extends DbTable
{
	...
	public function __construct()
	{
		...
		// BRCODE
		$this->BRCODE = new DbField('store_storeled', 'store_storeled', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TYPE
		$this->TYPE = new DbField('store_storeled', 'store_storeled', 'x_TYPE', 'TYPE', '`TYPE`', '`TYPE`', 200, -1, FALSE, '`TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TYPE->Sortable = TRUE; // Allow sort
		$this->fields['TYPE'] = &$this->TYPE;

		// DN
		$this->DN = new DbField('store_storeled', 'store_storeled', 'x_DN', 'DN', '`DN`', '`DN`', 200, -1, FALSE, '`DN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DN->Sortable = TRUE; // Allow sort
		$this->fields['DN'] = &$this->DN;

		// RDN
		$this->RDN = new DbField('store_storeled', 'store_storeled', 'x_RDN', 'RDN', '`RDN`', '`RDN`', 200, -1, FALSE, '`RDN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RDN->Sortable = TRUE; // Allow sort
		$this->fields['RDN'] = &$this->RDN;

		// DT
		$this->DT = new DbField('store_storeled', 'store_storeled', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 0, "DB"), 135, 0, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PRC
		$this->PRC = new DbField('store_storeled', 'store_storeled', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// OQ
		$this->OQ = new DbField('store_storeled', 'store_storeled', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, -1, FALSE, '`OQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OQ->Sortable = TRUE; // Allow sort
		$this->OQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['OQ'] = &$this->OQ;

		// RQ
		$this->RQ = new DbField('store_storeled', 'store_storeled', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, -1, FALSE, '`RQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RQ->Sortable = TRUE; // Allow sort
		$this->RQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RQ'] = &$this->RQ;

		// MRQ
		$this->MRQ = new DbField('store_storeled', 'store_storeled', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, -1, FALSE, '`MRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRQ->Sortable = TRUE; // Allow sort
		$this->MRQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRQ'] = &$this->MRQ;

		// IQ
		$this->IQ = new DbField('store_storeled', 'store_storeled', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = TRUE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// BATCHNO
		$this->BATCHNO = new DbField('store_storeled', 'store_storeled', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// EXPDT
		$this->EXPDT = new DbField('store_storeled', 'store_storeled', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BILLNO
		$this->BILLNO = new DbField('store_storeled', 'store_storeled', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, -1, FALSE, '`BILLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLNO->Sortable = TRUE; // Allow sort
		$this->fields['BILLNO'] = &$this->BILLNO;

		// BILLDT
		$this->BILLDT = new DbField('store_storeled', 'store_storeled', 'x_BILLDT', 'BILLDT', '`BILLDT`', CastDateFieldForLike('`BILLDT`', 0, "DB"), 135, 0, FALSE, '`BILLDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RT
		$this->RT = new DbField('store_storeled', 'store_storeled', 'x_RT', 'RT', '`RT`', '`RT`', 131, -1, FALSE, '`RT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RT->Sortable = TRUE; // Allow sort
		$this->RT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RT'] = &$this->RT;

		// VALUE
		$this->VALUE = new DbField('store_storeled', 'store_storeled', 'x_VALUE', 'VALUE', '`VALUE`', '`VALUE`', 131, -1, FALSE, '`VALUE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DISC
		$this->DISC = new DbField('store_storeled', 'store_storeled', 'x_DISC', 'DISC', '`DISC`', '`DISC`', 131, -1, FALSE, '`DISC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DISC->Sortable = TRUE; // Allow sort
		$this->DISC->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['DISC'] = &$this->DISC;

		// TAXP
		$this->TAXP = new DbField('store_storeled', 'store_storeled', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, -1, FALSE, '`TAXP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXP->Sortable = TRUE; // Allow sort
		$this->TAXP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAXP'] = &$this->TAXP;

		// TAX
		$this->TAX = new DbField('store_storeled', 'store_storeled', 'x_TAX', 'TAX', '`TAX`', '`TAX`', 131, -1, FALSE, '`TAX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAX->Sortable = TRUE; // Allow sort
		$this->TAX->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAX'] = &$this->TAX;

		// TAXR
		$this->TAXR = new DbField('store_storeled', 'store_storeled', 'x_TAXR', 'TAXR', '`TAXR`', '`TAXR`', 131, -1, FALSE, '`TAXR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXR->Sortable = TRUE; // Allow sort
		$this->TAXR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAXR'] = &$this->TAXR;

		// DAMT
		$this->DAMT = new DbField('store_storeled', 'store_storeled', 'x_DAMT', 'DAMT', '`DAMT`', '`DAMT`', 131, -1, FALSE, '`DAMT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAMT->Sortable = TRUE; // Allow sort
		$this->DAMT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['DAMT'] = &$this->DAMT;

		// EMPNO
		$this->EMPNO = new DbField('store_storeled', 'store_storeled', 'x_EMPNO', 'EMPNO', '`EMPNO`', '`EMPNO`', 200, -1, FALSE, '`EMPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EMPNO->Sortable = TRUE; // Allow sort
		$this->fields['EMPNO'] = &$this->EMPNO;

		// PC
		$this->PC = new DbField('store_storeled', 'store_storeled', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PC->Sortable = TRUE; // Allow sort
		$this->fields['PC'] = &$this->PC;

		// DRNAME
		$this->DRNAME = new DbField('store_storeled', 'store_storeled', 'x_DRNAME', 'DRNAME', '`DRNAME`', '`DRNAME`', 200, -1, FALSE, '`DRNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DRNAME->Sortable = TRUE; // Allow sort
		$this->fields['DRNAME'] = &$this->DRNAME;

		// BTIME
		$this->BTIME = new DbField('store_storeled', 'store_storeled', 'x_BTIME', 'BTIME', '`BTIME`', '`BTIME`', 200, -1, FALSE, '`BTIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BTIME->Sortable = TRUE; // Allow sort
		$this->fields['BTIME'] = &$this->BTIME;

		// ONO
		$this->ONO = new DbField('store_storeled', 'store_storeled', 'x_ONO', 'ONO', '`ONO`', '`ONO`', 200, -1, FALSE, '`ONO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ONO->Sortable = TRUE; // Allow sort
		$this->fields['ONO'] = &$this->ONO;

		// ODT
		$this->ODT = new DbField('store_storeled', 'store_storeled', 'x_ODT', 'ODT', '`ODT`', CastDateFieldForLike('`ODT`', 0, "DB"), 135, 0, FALSE, '`ODT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PURRT
		$this->PURRT = new DbField('store_storeled', 'store_storeled', 'x_PURRT', 'PURRT', '`PURRT`', '`PURRT`', 131, -1, FALSE, '`PURRT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GRP
		$this->GRP = new DbField('store_storeled', 'store_storeled', 'x_GRP', 'GRP', '`GRP`', '`GRP`', 200, -1, FALSE, '`GRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GRP->Sortable = TRUE; // Allow sort
		$this->fields['GRP'] = &$this->GRP;

		// IBATCH
		$this->IBATCH = new DbField('store_storeled', 'store_storeled', 'x_IBATCH', 'IBATCH', '`IBATCH`', '`IBATCH`', 200, -1, FALSE, '`IBATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IBATCH->Sortable = TRUE; // Allow sort
		$this->fields['IBATCH'] = &$this->IBATCH;

		// IPNO
		$this->IPNO = new DbField('store_storeled', 'store_storeled', 'x_IPNO', 'IPNO', '`IPNO`', '`IPNO`', 200, -1, FALSE, '`IPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IPNO->Sortable = TRUE; // Allow sort
		$this->fields['IPNO'] = &$this->IPNO;

		// OPNO
		$this->OPNO = new DbField('store_storeled', 'store_storeled', 'x_OPNO', 'OPNO', '`OPNO`', '`OPNO`', 200, -1, FALSE, '`OPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OPNO->Sortable = TRUE; // Allow sort
		$this->fields['OPNO'] = &$this->OPNO;

		// RECID
		$this->RECID = new DbField('store_storeled', 'store_storeled', 'x_RECID', 'RECID', '`RECID`', '`RECID`', 200, -1, FALSE, '`RECID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RECID->Sortable = TRUE; // Allow sort
		$this->fields['RECID'] = &$this->RECID;

		// FQTY
		$this->FQTY = new DbField('store_storeled', 'store_storeled', 'x_FQTY', 'FQTY', '`FQTY`', '`FQTY`', 131, -1, FALSE, '`FQTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FQTY->Sortable = TRUE; // Allow sort
		$this->FQTY->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['FQTY'] = &$this->FQTY;

		// UR
		$this->UR = new DbField('store_storeled', 'store_storeled', 'x_UR', 'UR', '`UR`', '`UR`', 131, -1, FALSE, '`UR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UR->Sortable = TRUE; // Allow sort
		$this->UR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['UR'] = &$this->UR;

		// DCID
		$this->DCID = new DbField('store_storeled', 'store_storeled', 'x_DCID', 'DCID', '`DCID`', '`DCID`', 200, -1, FALSE, '`DCID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DCID->Sortable = TRUE; // Allow sort
		$this->fields['DCID'] = &$this->DCID;

		// USERID
		$this->_USERID = new DbField('store_storeled', 'store_storeled', 'x__USERID', 'USERID', '`USERID`', '`USERID`', 200, -1, FALSE, '`USERID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_USERID->Sortable = TRUE; // Allow sort
		$this->fields['USERID'] = &$this->_USERID;

		// MODDT
		$this->MODDT = new DbField('store_storeled', 'store_storeled', 'x_MODDT', 'MODDT', '`MODDT`', CastDateFieldForLike('`MODDT`', 0, "DB"), 135, 0, FALSE, '`MODDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FYM
		$this->FYM = new DbField('store_storeled', 'store_storeled', 'x_FYM', 'FYM', '`FYM`', '`FYM`', 200, -1, FALSE, '`FYM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FYM->Sortable = TRUE; // Allow sort
		$this->fields['FYM'] = &$this->FYM;

		// PRCBATCH
		$this->PRCBATCH = new DbField('store_storeled', 'store_storeled', 'x_PRCBATCH', 'PRCBATCH', '`PRCBATCH`', '`PRCBATCH`', 200, -1, FALSE, '`PRCBATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRCBATCH->Sortable = TRUE; // Allow sort
		$this->fields['PRCBATCH'] = &$this->PRCBATCH;

		// SLNO
		$this->SLNO = new DbField('store_storeled', 'store_storeled', 'x_SLNO', 'SLNO', '`SLNO`', '`SLNO`', 3, -1, FALSE, '`SLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MRP
		$this->MRP = new DbField('store_storeled', 'store_storeled', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// BILLYM
		$this->BILLYM = new DbField('store_storeled', 'store_storeled', 'x_BILLYM', 'BILLYM', '`BILLYM`', '`BILLYM`', 200, -1, FALSE, '`BILLYM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLYM->Sortable = TRUE; // Allow sort
		$this->fields['BILLYM'] = &$this->BILLYM;

		// BILLGRP
		$this->BILLGRP = new DbField('store_storeled', 'store_storeled', 'x_BILLGRP', 'BILLGRP', '`BILLGRP`', '`BILLGRP`', 200, -1, FALSE, '`BILLGRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLGRP->Sortable = TRUE; // Allow sort
		$this->fields['BILLGRP'] = &$this->BILLGRP;

		// STAFF
		$this->STAFF = new DbField('store_storeled', 'store_storeled', 'x_STAFF', 'STAFF', '`STAFF`', '`STAFF`', 200, -1, FALSE, '`STAFF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->STAFF->Sortable = TRUE; // Allow sort
		$this->fields['STAFF'] = &$this->STAFF;

		// TEMPIPNO
		$this->TEMPIPNO = new DbField('store_storeled', 'store_storeled', 'x_TEMPIPNO', 'TEMPIPNO', '`TEMPIPNO`', '`TEMPIPNO`', 200, -1, FALSE, '`TEMPIPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TEMPIPNO->Sortable = TRUE; // Allow sort
		$this->fields['TEMPIPNO'] = &$this->TEMPIPNO;

		// PRNTED
		$this->PRNTED = new DbField('store_storeled', 'store_storeled', 'x_PRNTED', 'PRNTED', '`PRNTED`', '`PRNTED`', 200, -1, FALSE, '`PRNTED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRNTED->Sortable = TRUE; // Allow sort
		$this->fields['PRNTED'] = &$this->PRNTED;

		// PATNAME
		$this->PATNAME = new DbField('store_storeled', 'store_storeled', 'x_PATNAME', 'PATNAME', '`PATNAME`', '`PATNAME`', 200, -1, FALSE, '`PATNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PATNAME->Sortable = TRUE; // Allow sort
		$this->fields['PATNAME'] = &$this->PATNAME;

		// PJVNO
		$this->PJVNO = new DbField('store_storeled', 'store_storeled', 'x_PJVNO', 'PJVNO', '`PJVNO`', '`PJVNO`', 200, -1, FALSE, '`PJVNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PJVNO->Sortable = TRUE; // Allow sort
		$this->fields['PJVNO'] = &$this->PJVNO;

		// PJVSLNO
		$this->PJVSLNO = new DbField('store_storeled', 'store_storeled', 'x_PJVSLNO', 'PJVSLNO', '`PJVSLNO`', '`PJVSLNO`', 200, -1, FALSE, '`PJVSLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PJVSLNO->Sortable = TRUE; // Allow sort
		$this->fields['PJVSLNO'] = &$this->PJVSLNO;

		// OTHDISC
		$this->OTHDISC = new DbField('store_storeled', 'store_storeled', 'x_OTHDISC', 'OTHDISC', '`OTHDISC`', '`OTHDISC`', 131, -1, FALSE, '`OTHDISC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PJVYM
		$this->PJVYM = new DbField('store_storeled', 'store_storeled', 'x_PJVYM', 'PJVYM', '`PJVYM`', '`PJVYM`', 200, -1, FALSE, '`PJVYM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PJVYM->Sortable = TRUE; // Allow sort
		$this->fields['PJVYM'] = &$this->PJVYM;

		// PURDISCPER
		$this->PURDISCPER = new DbField('store_storeled', 'store_storeled', 'x_PURDISCPER', 'PURDISCPER', '`PURDISCPER`', '`PURDISCPER`', 131, -1, FALSE, '`PURDISCPER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CASHIER
		$this->CASHIER = new DbField('store_storeled', 'store_storeled', 'x_CASHIER', 'CASHIER', '`CASHIER`', '`CASHIER`', 200, -1, FALSE, '`CASHIER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHIER->Sortable = TRUE; // Allow sort
		$this->fields['CASHIER'] = &$this->CASHIER;

		// CASHTIME
		$this->CASHTIME = new DbField('store_storeled', 'store_storeled', 'x_CASHTIME', 'CASHTIME', '`CASHTIME`', '`CASHTIME`', 200, -1, FALSE, '`CASHTIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHTIME->Sortable = TRUE; // Allow sort
		$this->fields['CASHTIME'] = &$this->CASHTIME;

		// CASHRECD
		$this->CASHRECD = new DbField('store_storeled', 'store_storeled', 'x_CASHRECD', 'CASHRECD', '`CASHRECD`', '`CASHRECD`', 131, -1, FALSE, '`CASHRECD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CASHREFNO
		$this->CASHREFNO = new DbField('store_storeled', 'store_storeled', 'x_CASHREFNO', 'CASHREFNO', '`CASHREFNO`', '`CASHREFNO`', 200, -1, FALSE, '`CASHREFNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHREFNO->Sortable = TRUE; // Allow sort
		$this->fields['CASHREFNO'] = &$this->CASHREFNO;

		// CASHIERSHIFT
		$this->CASHIERSHIFT = new DbField('store_storeled', 'store_storeled', 'x_CASHIERSHIFT', 'CASHIERSHIFT', '`CASHIERSHIFT`', '`CASHIERSHIFT`', 200, -1, FALSE, '`CASHIERSHIFT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHIERSHIFT->Sortable = TRUE; // Allow sort
		$this->fields['CASHIERSHIFT'] = &$this->CASHIERSHIFT;

		// PRCODE
		$this->PRCODE = new DbField('store_storeled', 'store_storeled', 'x_PRCODE', 'PRCODE', '`PRCODE`', '`PRCODE`', 200, -1, FALSE, '`PRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRCODE->Sortable = TRUE; // Allow sort
		$this->fields['PRCODE'] = &$this->PRCODE;

		// RELEASEBY
		$this->RELEASEBY = new DbField('store_storeled', 'store_storeled', 'x_RELEASEBY', 'RELEASEBY', '`RELEASEBY`', '`RELEASEBY`', 200, -1, FALSE, '`RELEASEBY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RELEASEBY->Sortable = TRUE; // Allow sort
		$this->fields['RELEASEBY'] = &$this->RELEASEBY;

		// CRAUTHOR
		$this->CRAUTHOR = new DbField('store_storeled', 'store_storeled', 'x_CRAUTHOR', 'CRAUTHOR', '`CRAUTHOR`', '`CRAUTHOR`', 200, -1, FALSE, '`CRAUTHOR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CRAUTHOR->Sortable = TRUE; // Allow sort
		$this->fields['CRAUTHOR'] = &$this->CRAUTHOR;

		// PAYMENT
		$this->PAYMENT = new DbField('store_storeled', 'store_storeled', 'x_PAYMENT', 'PAYMENT', '`PAYMENT`', '`PAYMENT`', 200, -1, FALSE, '`PAYMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PAYMENT->Sortable = TRUE; // Allow sort
		$this->fields['PAYMENT'] = &$this->PAYMENT;

		// DRID
		$this->DRID = new DbField('store_storeled', 'store_storeled', 'x_DRID', 'DRID', '`DRID`', '`DRID`', 200, -1, FALSE, '`DRID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DRID->Sortable = TRUE; // Allow sort
		$this->fields['DRID'] = &$this->DRID;

		// WARD
		$this->WARD = new DbField('store_storeled', 'store_storeled', 'x_WARD', 'WARD', '`WARD`', '`WARD`', 200, -1, FALSE, '`WARD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WARD->Sortable = TRUE; // Allow sort
		$this->fields['WARD'] = &$this->WARD;

		// STAXTYPE
		$this->STAXTYPE = new DbField('store_storeled', 'store_storeled', 'x_STAXTYPE', 'STAXTYPE', '`STAXTYPE`', '`STAXTYPE`', 200, -1, FALSE, '`STAXTYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->STAXTYPE->Sortable = TRUE; // Allow sort
		$this->fields['STAXTYPE'] = &$this->STAXTYPE;

		// PURDISCVAL
		$this->PURDISCVAL = new DbField('store_storeled', 'store_storeled', 'x_PURDISCVAL', 'PURDISCVAL', '`PURDISCVAL`', '`PURDISCVAL`', 131, -1, FALSE, '`PURDISCVAL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RNDOFF
		$this->RNDOFF = new DbField('store_storeled', 'store_storeled', 'x_RNDOFF', 'RNDOFF', '`RNDOFF`', '`RNDOFF`', 131, -1, FALSE, '`RNDOFF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DISCONMRP
		$this->DISCONMRP = new DbField('store_storeled', 'store_storeled', 'x_DISCONMRP', 'DISCONMRP', '`DISCONMRP`', '`DISCONMRP`', 131, -1, FALSE, '`DISCONMRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DELVDT
		$this->DELVDT = new DbField('store_storeled', 'store_storeled', 'x_DELVDT', 'DELVDT', '`DELVDT`', CastDateFieldForLike('`DELVDT`', 0, "DB"), 135, 0, FALSE, '`DELVDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DELVTIME
		$this->DELVTIME = new DbField('store_storeled', 'store_storeled', 'x_DELVTIME', 'DELVTIME', '`DELVTIME`', '`DELVTIME`', 200, -1, FALSE, '`DELVTIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DELVTIME->Sortable = TRUE; // Allow sort
		$this->fields['DELVTIME'] = &$this->DELVTIME;

		// DELVBY
		$this->DELVBY = new DbField('store_storeled', 'store_storeled', 'x_DELVBY', 'DELVBY', '`DELVBY`', '`DELVBY`', 200, -1, FALSE, '`DELVBY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DELVBY->Sortable = TRUE; // Allow sort
		$this->fields['DELVBY'] = &$this->DELVBY;

		// HOSPNO
		$this->HOSPNO = new DbField('store_storeled', 'store_storeled', 'x_HOSPNO', 'HOSPNO', '`HOSPNO`', '`HOSPNO`', 200, -1, FALSE, '`HOSPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HOSPNO->Sortable = TRUE; // Allow sort
		$this->fields['HOSPNO'] = &$this->HOSPNO;

		// id
		$this->id = new DbField('store_storeled', 'store_storeled', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pbv
		$this->pbv = new DbField('store_storeled', 'store_storeled', 'x_pbv', 'pbv', '`pbv`', '`pbv`', 3, -1, FALSE, '`pbv`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pbv->Sortable = TRUE; // Allow sort
		$this->pbv->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pbv'] = &$this->pbv;

		// pbt
		$this->pbt = new DbField('store_storeled', 'store_storeled', 'x_pbt', 'pbt', '`pbt`', '`pbt`', 3, -1, FALSE, '`pbt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pbt->Sortable = TRUE; // Allow sort
		$this->pbt->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pbt'] = &$this->pbt;

		// SiNo
		$this->SiNo = new DbField('store_storeled', 'store_storeled', 'x_SiNo', 'SiNo', '`SiNo`', '`SiNo`', 3, -1, FALSE, '`SiNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Product
		$this->Product = new DbField('store_storeled', 'store_storeled', 'x_Product', 'Product', '`Product`', '`Product`', 200, -1, FALSE, '`Product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product->Sortable = TRUE; // Allow sort
		$this->fields['Product'] = &$this->Product;

		// Mfg
		$this->Mfg = new DbField('store_storeled', 'store_storeled', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, -1, FALSE, '`Mfg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mfg->Sortable = TRUE; // Allow sort
		$this->fields['Mfg'] = &$this->Mfg;

		// HosoID
		$this->HosoID = new DbField('store_storeled', 'store_storeled', 'x_HosoID', 'HosoID', '`HosoID`', '`HosoID`', 3, -1, FALSE, '`HosoID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdby
		$this->createdby = new DbField('store_storeled', 'store_storeled', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('store_storeled', 'store_storeled', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('store_storeled', 'store_storeled', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('store_storeled', 'store_storeled', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// MFRCODE
		$this->MFRCODE = new DbField('store_storeled', 'store_storeled', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// Reception
		$this->Reception = new DbField('store_storeled', 'store_storeled', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatID
		$this->PatID = new DbField('store_storeled', 'store_storeled', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mrnno
		$this->mrnno = new DbField('store_storeled', 'store_storeled', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// BRNAME
		$this->BRNAME = new DbField('store_storeled', 'store_storeled', 'x_BRNAME', 'BRNAME', '`BRNAME`', '`BRNAME`', 200, -1, FALSE, '`BRNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BRNAME->Sortable = TRUE; // Allow sort
		$this->fields['BRNAME'] = &$this->BRNAME;

		// StoreID
		$this->StoreID = new DbField('store_storeled', 'store_storeled', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, -1, FALSE, '`StoreID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("store_storeledview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
