 ...
 * Page class
 */
class view_lab_services_auth_search extends view_lab_services_auth
{
	...
	// Page object name
	public $PageObjName = "view_lab_services_auth_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr <> "") {
					...
					$srchStr = "view_lab_services_authlist.php" . "?" . $srchStr;
