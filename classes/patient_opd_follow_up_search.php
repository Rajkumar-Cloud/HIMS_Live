...
class patient_opd_follow_up_search extends patient_opd_follow_up
{
	...
	protected function loadSearchValues()
	{
		...
		// Telephone
		if (!$this->isAddOrEdit())
			$this->Telephone->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Telephone"));
		$this->Telephone->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Telephone"));
		...
		// procedurenotes
		if (!$this->isAddOrEdit())
			$this->procedurenotes->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_procedurenotes"));
		$this->procedurenotes->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_procedurenotes"));

		// NextReviewDate
		if (!$this->isAddOrEdit())
			$this->NextReviewDate->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NextReviewDate"));
		$this->NextReviewDate->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NextReviewDate"));

		// ICSIAdvised
		if (!$this->isAddOrEdit())
			$this->ICSIAdvised->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ICSIAdvised"));
		$this->ICSIAdvised->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ICSIAdvised"));
		...
		// DeliveryRegistered
		if (!$this->isAddOrEdit())
			$this->DeliveryRegistered->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DeliveryRegistered"));
		$this->DeliveryRegistered->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DeliveryRegistered"));
		...
		// EDD
		if (!$this->isAddOrEdit())
			$this->EDD->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_EDD"));
		$this->EDD->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_EDD"));

		// SerologyPositive
		if (!$this->isAddOrEdit())
			$this->SerologyPositive->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SerologyPositive"));
		$this->SerologyPositive->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SerologyPositive"));
		...
		// Allergy
		if (!$this->isAddOrEdit())
			$this->Allergy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Allergy"));
		$this->Allergy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Allergy"));
		...
		// ProcedureDateTime
		if (!$this->isAddOrEdit())
			$this->ProcedureDateTime->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ProcedureDateTime"));
		$this->ProcedureDateTime->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ProcedureDateTime"));

		// ICSIDate
		if (!$this->isAddOrEdit())
			$this->ICSIDate->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ICSIDate"));
		$this->ICSIDate->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ICSIDate"));
		...
		// createdUserName
		if (!$this->isAddOrEdit())
			$this->createdUserName->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_createdUserName"));
		$this->createdUserName->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_createdUserName"));

		// TemplateDrNotes
		if (!$this->isAddOrEdit())
			$this->TemplateDrNotes->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TemplateDrNotes"));
		$this->TemplateDrNotes->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TemplateDrNotes"));
