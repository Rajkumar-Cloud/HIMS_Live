...
class view_et extends DbTable
{
	...
	public function __construct()
	{
		...
		// RIDNo
		$this->RIDNo = new DbField('view_et', 'view_et', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientName
		$this->PatientName = new DbField('view_et', 'view_et', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = FALSE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// TiDNo
		$this->TiDNo = new DbField('view_et', 'view_et', 'x_TiDNo', 'TiDNo', '`TiDNo`', '`TiDNo`', 3, -1, FALSE, '`TiDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id
		$this->id = new DbField('view_et', 'view_et', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// EmbryoNo
		$this->EmbryoNo = new DbField('view_et', 'view_et', 'x_EmbryoNo', 'EmbryoNo', '`EmbryoNo`', '`EmbryoNo`', 200, -1, FALSE, '`EmbryoNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmbryoNo->Sortable = TRUE; // Allow sort
		$this->fields['EmbryoNo'] = &$this->EmbryoNo;

		// Stage
		$this->Stage = new DbField('view_et', 'view_et', 'x_Stage', 'Stage', '`Stage`', '`Stage`', 200, -1, FALSE, '`Stage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Stage->Sortable = TRUE; // Allow sort
		$this->fields['Stage'] = &$this->Stage;

		// FertilisationDate
		$this->FertilisationDate = new DbField('view_et', 'view_et', 'x_FertilisationDate', 'FertilisationDate', '`FertilisationDate`', CastDateFieldForLike('`FertilisationDate`', 0, "DB"), 135, 0, FALSE, '`FertilisationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day
		$this->Day = new DbField('view_et', 'view_et', 'x_Day', 'Day', '`Day`', '`Day`', 200, -1, FALSE, '`Day`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade
		$this->Grade = new DbField('view_et', 'view_et', 'x_Grade', 'Grade', '`Grade`', '`Grade`', 200, -1, FALSE, '`Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Incubator
		$this->Incubator = new DbField('view_et', 'view_et', 'x_Incubator', 'Incubator', '`Incubator`', '`Incubator`', 200, -1, FALSE, '`Incubator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Incubator->Sortable = TRUE; // Allow sort
		$this->fields['Incubator'] = &$this->Incubator;

		// Catheter
		$this->Catheter = new DbField('view_et', 'view_et', 'x_Catheter', 'Catheter', '`Catheter`', '`Catheter`', 200, -1, FALSE, '`Catheter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Catheter->Sortable = TRUE; // Allow sort
		$this->fields['Catheter'] = &$this->Catheter;

		// Difficulty
		$this->Difficulty = new DbField('view_et', 'view_et', 'x_Difficulty', 'Difficulty', '`Difficulty`', '`Difficulty`', 200, -1, FALSE, '`Difficulty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Easy
		$this->Easy = new DbField('view_et', 'view_et', 'x_Easy', 'Easy', '`Easy`', '`Easy`', 200, -1, FALSE, '`Easy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Comments
		$this->Comments = new DbField('view_et', 'view_et', 'x_Comments', 'Comments', '`Comments`', '`Comments`', 200, -1, FALSE, '`Comments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Comments->Sortable = TRUE; // Allow sort
		$this->fields['Comments'] = &$this->Comments;

		// Doctor
		$this->Doctor = new DbField('view_et', 'view_et', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, -1, FALSE, '`Doctor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Doctor->Sortable = TRUE; // Allow sort
		$this->fields['Doctor'] = &$this->Doctor;

		// Embryologist
		$this->Embryologist = new DbField('view_et', 'view_et', 'x_Embryologist', 'Embryologist', '`Embryologist`', '`Embryologist`', 200, -1, FALSE, '`Embryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_etview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
