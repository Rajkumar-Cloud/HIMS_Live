 ...
 */
class view_revenue_report_opd extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// DATE
		$this->DATE = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_DATE', 'DATE', '`DATE`', CastDateFieldForLike('`DATE`', 0, "DB"), 133, 0, FALSE, '`DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillNumber
		$this->BillNumber = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, -1, FALSE, '`BillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillNumber->Sortable = TRUE; // Allow sort
		$this->fields['BillNumber'] = &$this->BillNumber;

		// PatientId
		$this->PatientId = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// Op consultations
		$this->Op_consultations = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Op_consultations', 'Op consultations', '`Op consultations`', '`Op consultations`', 131, -1, FALSE, '`Op consultations`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Op_consultations->Sortable = TRUE; // Allow sort
		$this->Op_consultations->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Op consultations'] = &$this->Op_consultations;

		// Scan
		$this->Scan = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Scan', 'Scan', '`Scan`', '`Scan`', 131, -1, FALSE, '`Scan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Scan->Sortable = TRUE; // Allow sort
		$this->Scan->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Scan'] = &$this->Scan;

		// PROCEDURES
		$this->PROCEDURES = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_PROCEDURES', 'PROCEDURES', '`PROCEDURES`', '`PROCEDURES`', 131, -1, FALSE, '`PROCEDURES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LAB
		$this->LAB = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_LAB', 'LAB', '`LAB`', '`LAB`', 131, -1, FALSE, '`LAB`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LAB->Sortable = TRUE; // Allow sort
		$this->LAB->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['LAB'] = &$this->LAB;

		// Others
		$this->Others = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Others', 'Others', '`Others`', '`Others`', 131, -1, FALSE, '`Others`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Other Services
		$this->Other_Services = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Other_Services', 'Other Services', '`Other Services`', '`Other Services`', 201, -1, FALSE, '`Other Services`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Other_Services->Sortable = TRUE; // Allow sort
		$this->fields['Other Services'] = &$this->Other_Services;

		// Amount
		$this->Amount = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->Amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Amount'] = &$this->Amount;

		// ModeofPayment
		$this->ModeofPayment = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, -1, FALSE, '`ModeofPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModeofPayment->Sortable = TRUE; // Allow sort
		$this->fields['ModeofPayment'] = &$this->ModeofPayment;

		// Cash
		$this->Cash = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Cash', 'Cash', '`Cash`', '`Cash`', 131, -1, FALSE, '`Cash`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cash->Sortable = TRUE; // Allow sort
		$this->Cash->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Cash'] = &$this->Cash;

		// Card
		$this->Card = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Card', 'Card', '`Card`', '`Card`', 131, -1, FALSE, '`Card`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Card->Sortable = TRUE; // Allow sort
		$this->Card->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Card'] = &$this->Card;

		// Remarks
		$this->Remarks = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// DiscountRemarks
		$this->DiscountRemarks = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 201, -1, FALSE, '`DiscountRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->DiscountRemarks->Sortable = TRUE; // Allow sort
		$this->fields['DiscountRemarks'] = &$this->DiscountRemarks;

		// HospID
		$this->HospID = new DbField('view_revenue_report_opd', 'view_revenue_report_opd', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->Op_consultations->DbValue = $row['Op consultations'];
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_revenue_report_opdlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_revenue_report_opdview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_revenue_report_opdedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_revenue_report_opdadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_revenue_report_opdview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_revenue_report_opdview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_revenue_report_opdadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_revenue_report_opdadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_revenue_report_opdedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_revenue_report_opdadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_revenue_report_opddelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Op_consultations->setDbValue($rs->fields('Op consultations'));
		$this->Scan->setDbValue($rs->fields('Scan'));
		$this->PROCEDURES->setDbValue($rs->fields('PROCEDURES'));
	...
	public function renderEditRow()
	{
		...
		$this->Op_consultations->EditValue = $this->Op_consultations->CurrentValue;
		$this->Op_consultations->PlaceHolder = RemoveHtml($this->Op_consultations->caption());
		if (strval($this->Op_consultations->EditValue) <> "" && is_numeric($this->Op_consultations->EditValue))
			$this->Op_consultations->EditValue = FormatNumber($this->Op_consultations->EditValue, -2, -2, -2, -2);
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->Op_consultations);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->Op_consultations);
