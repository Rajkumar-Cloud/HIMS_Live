 ...
 * Page class
 */
class ivf_mas_template_type_add extends ivf_mas_template_type
{
	...
	// Page object name
	public $PageObjName = "ivf_mas_template_type_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("ivf_mas_template_typelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "ivf_mas_template_typelist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "ivf_mas_template_typeview.php")
