 ...
 * Page class
 */
class patient_history_list extends patient_history
{
	...
	// Page object name
	public $PageObjName = "patient_history_list";

	// Grid form hidden field names
	public $FormName = "fpatient_historylist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_historyadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "patient_historydelete.php";
		$this->MultiUpdateUrl = "patient_historyupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fpatient_historylistsrch";
	...
	public function run()
	{
		...
		$this->SurgicalHistory->Visible = FALSE;
		$this->PastHistory->Visible = FALSE;
		$this->TreatmentHistory->Visible = FALSE;
		$this->FamilyHistory->Visible = FALSE;
		$this->Age->setVisibility();
		$this->Gender->setVisibility();
		$this->profilePic->Visible = FALSE;
		$this->Complaints->Visible = FALSE;
		$this->illness->Visible = FALSE;
		$this->PersonalHistory->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		if (SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpatient_historylistsrch");
		...
		$filterList = Concat($filterList, $this->TreatmentHistory->AdvancedSearch->toJson(), ","); // Field TreatmentHistory
		...
		$filterList = Concat($filterList, $this->Complaints->AdvancedSearch->toJson(), ","); // Field Complaints
		$filterList = Concat($filterList, $this->illness->AdvancedSearch->toJson(), ","); // Field illness
		$filterList = Concat($filterList, $this->PersonalHistory->AdvancedSearch->toJson(), ","); // Field PersonalHistory
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fpatient_historylistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		$this->TreatmentHistory->AdvancedSearch->SearchValue = @$filter["x_TreatmentHistory"];
		$this->TreatmentHistory->AdvancedSearch->SearchOperator = @$filter["z_TreatmentHistory"];
		$this->TreatmentHistory->AdvancedSearch->SearchCondition = @$filter["v_TreatmentHistory"];
		$this->TreatmentHistory->AdvancedSearch->SearchValue2 = @$filter["y_TreatmentHistory"];
		$this->TreatmentHistory->AdvancedSearch->SearchOperator2 = @$filter["w_TreatmentHistory"];
		$this->TreatmentHistory->AdvancedSearch->save();
		...
		// Field Complaints
		$this->Complaints->AdvancedSearch->SearchValue = @$filter["x_Complaints"];
		$this->Complaints->AdvancedSearch->SearchOperator = @$filter["z_Complaints"];
		$this->Complaints->AdvancedSearch->SearchCondition = @$filter["v_Complaints"];
		$this->Complaints->AdvancedSearch->SearchValue2 = @$filter["y_Complaints"];
		$this->Complaints->AdvancedSearch->SearchOperator2 = @$filter["w_Complaints"];
		$this->Complaints->AdvancedSearch->save();

		// Field illness
		$this->illness->AdvancedSearch->SearchValue = @$filter["x_illness"];
		$this->illness->AdvancedSearch->SearchOperator = @$filter["z_illness"];
		$this->illness->AdvancedSearch->SearchCondition = @$filter["v_illness"];
		$this->illness->AdvancedSearch->SearchValue2 = @$filter["y_illness"];
		$this->illness->AdvancedSearch->SearchOperator2 = @$filter["w_illness"];
		$this->illness->AdvancedSearch->save();

		// Field PersonalHistory
		$this->PersonalHistory->AdvancedSearch->SearchValue = @$filter["x_PersonalHistory"];
		$this->PersonalHistory->AdvancedSearch->SearchOperator = @$filter["z_PersonalHistory"];
		$this->PersonalHistory->AdvancedSearch->SearchCondition = @$filter["v_PersonalHistory"];
		$this->PersonalHistory->AdvancedSearch->SearchValue2 = @$filter["y_PersonalHistory"];
		$this->PersonalHistory->AdvancedSearch->SearchOperator2 = @$filter["w_PersonalHistory"];
		$this->PersonalHistory->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->MaritalHistory, $default, FALSE); // MaritalHistory
		$this->buildSearchSql($where, $this->MenstrualHistory, $default, FALSE); // MenstrualHistory
		$this->buildSearchSql($where, $this->ObstetricHistory, $default, FALSE); // ObstetricHistory
		$this->buildSearchSql($where, $this->MedicalHistory, $default, FALSE); // MedicalHistory
		$this->buildSearchSql($where, $this->SurgicalHistory, $default, FALSE); // SurgicalHistory
		$this->buildSearchSql($where, $this->PastHistory, $default, FALSE); // PastHistory
		$this->buildSearchSql($where, $this->TreatmentHistory, $default, FALSE); // TreatmentHistory
		$this->buildSearchSql($where, $this->FamilyHistory, $default, FALSE); // FamilyHistory
		...
		$this->buildSearchSql($where, $this->Complaints, $default, FALSE); // Complaints
		$this->buildSearchSql($where, $this->illness, $default, FALSE); // illness
		$this->buildSearchSql($where, $this->PersonalHistory, $default, FALSE); // PersonalHistory
		...
		if (!$default && $this->Command == "search") {
			...
			$this->MaritalHistory->AdvancedSearch->save(); // MaritalHistory
			$this->MenstrualHistory->AdvancedSearch->save(); // MenstrualHistory
			$this->ObstetricHistory->AdvancedSearch->save(); // ObstetricHistory
			$this->MedicalHistory->AdvancedSearch->save(); // MedicalHistory
			$this->SurgicalHistory->AdvancedSearch->save(); // SurgicalHistory
			$this->PastHistory->AdvancedSearch->save(); // PastHistory
			$this->TreatmentHistory->AdvancedSearch->save(); // TreatmentHistory
			$this->FamilyHistory->AdvancedSearch->save(); // FamilyHistory
			$this->Age->AdvancedSearch->save(); // Age
			$this->Gender->AdvancedSearch->save(); // Gender
			$this->profilePic->AdvancedSearch->save(); // profilePic
			$this->Complaints->AdvancedSearch->save(); // Complaints
			$this->illness->AdvancedSearch->save(); // illness
			$this->PersonalHistory->AdvancedSearch->save(); // PersonalHistory
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->TreatmentHistory, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->Complaints, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->illness, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->PersonalHistory, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->MobileNumber->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->MaritalHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->MenstrualHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->ObstetricHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->MedicalHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->SurgicalHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->PastHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->TreatmentHistory->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->FamilyHistory->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->profilePic->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->Complaints->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->illness->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->PersonalHistory->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->MaritalHistory->AdvancedSearch->unsetSession();
		$this->MenstrualHistory->AdvancedSearch->unsetSession();
		$this->ObstetricHistory->AdvancedSearch->unsetSession();
		$this->MedicalHistory->AdvancedSearch->unsetSession();
		$this->SurgicalHistory->AdvancedSearch->unsetSession();
		$this->PastHistory->AdvancedSearch->unsetSession();
		$this->TreatmentHistory->AdvancedSearch->unsetSession();
		$this->FamilyHistory->AdvancedSearch->unsetSession();
		$this->Age->AdvancedSearch->unsetSession();
		$this->Gender->AdvancedSearch->unsetSession();
		$this->profilePic->AdvancedSearch->unsetSession();
		$this->Complaints->AdvancedSearch->unsetSession();
		$this->illness->AdvancedSearch->unsetSession();
		$this->PersonalHistory->AdvancedSearch->unsetSession();
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_historylistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_historylistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fpatient_historylist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_historylistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"btn btn-default ew-advanced-aearch\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"patient_historysrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-highlight active\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fpatient_historylistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</button>";
	...
	protected function loadSearchValues()
	{
		...
		// MaritalHistory
		if (!$this->isAddOrEdit())
			$this->MaritalHistory->AdvancedSearch->setSearchValue(Get("x_MaritalHistory", Get("MaritalHistory", "")));
		if ($this->MaritalHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->MaritalHistory->AdvancedSearch->setSearchOperator(Get("z_MaritalHistory", ""));

		// MenstrualHistory
		if (!$this->isAddOrEdit())
			$this->MenstrualHistory->AdvancedSearch->setSearchValue(Get("x_MenstrualHistory", Get("MenstrualHistory", "")));
		if ($this->MenstrualHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->MenstrualHistory->AdvancedSearch->setSearchOperator(Get("z_MenstrualHistory", ""));

		// ObstetricHistory
		if (!$this->isAddOrEdit())
			$this->ObstetricHistory->AdvancedSearch->setSearchValue(Get("x_ObstetricHistory", Get("ObstetricHistory", "")));
		if ($this->ObstetricHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ObstetricHistory->AdvancedSearch->setSearchOperator(Get("z_ObstetricHistory", ""));

		// MedicalHistory
		if (!$this->isAddOrEdit())
			$this->MedicalHistory->AdvancedSearch->setSearchValue(Get("x_MedicalHistory", Get("MedicalHistory", "")));
		if ($this->MedicalHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->MedicalHistory->AdvancedSearch->setSearchOperator(Get("z_MedicalHistory", ""));

		// SurgicalHistory
		if (!$this->isAddOrEdit())
			$this->SurgicalHistory->AdvancedSearch->setSearchValue(Get("x_SurgicalHistory", Get("SurgicalHistory", "")));
		if ($this->SurgicalHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->SurgicalHistory->AdvancedSearch->setSearchOperator(Get("z_SurgicalHistory", ""));

		// PastHistory
		if (!$this->isAddOrEdit())
			$this->PastHistory->AdvancedSearch->setSearchValue(Get("x_PastHistory", Get("PastHistory", "")));
		if ($this->PastHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PastHistory->AdvancedSearch->setSearchOperator(Get("z_PastHistory", ""));

		// TreatmentHistory
		if (!$this->isAddOrEdit())
			$this->TreatmentHistory->AdvancedSearch->setSearchValue(Get("x_TreatmentHistory", Get("TreatmentHistory", "")));
		if ($this->TreatmentHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TreatmentHistory->AdvancedSearch->setSearchOperator(Get("z_TreatmentHistory", ""));

		// FamilyHistory
		if (!$this->isAddOrEdit())
			$this->FamilyHistory->AdvancedSearch->setSearchValue(Get("x_FamilyHistory", Get("FamilyHistory", "")));
		if ($this->FamilyHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->FamilyHistory->AdvancedSearch->setSearchOperator(Get("z_FamilyHistory", ""));
		...
		// Complaints
		if (!$this->isAddOrEdit())
			$this->Complaints->AdvancedSearch->setSearchValue(Get("x_Complaints", Get("Complaints", "")));
		if ($this->Complaints->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Complaints->AdvancedSearch->setSearchOperator(Get("z_Complaints", ""));

		// illness
		if (!$this->isAddOrEdit())
			$this->illness->AdvancedSearch->setSearchValue(Get("x_illness", Get("illness", "")));
		if ($this->illness->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->illness->AdvancedSearch->setSearchOperator(Get("z_illness", ""));

		// PersonalHistory
		if (!$this->isAddOrEdit())
			$this->PersonalHistory->AdvancedSearch->setSearchValue(Get("x_PersonalHistory", Get("PersonalHistory", "")));
		if ($this->PersonalHistory->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PersonalHistory->AdvancedSearch->setSearchOperator(Get("z_PersonalHistory", ""));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->isExport())
				$this->MaritalHistory->ViewValue = $this->highlightValue($this->MaritalHistory);
			...
			if (!$this->isExport())
				$this->MenstrualHistory->ViewValue = $this->highlightValue($this->MenstrualHistory);
			...
			if (!$this->isExport())
				$this->ObstetricHistory->ViewValue = $this->highlightValue($this->ObstetricHistory);
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fpatient_historylist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fpatient_historylist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fpatient_historylist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_patient_history\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_patient_history',hdr:ew.language.phrase('ExportToEmailText'),f:document.fpatient_historylist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
