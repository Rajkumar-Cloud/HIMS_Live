 ...
 * Page class
 */
class patient_provisional_diagnosis_list extends patient_provisional_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_provisional_diagnosis_list";

	// Grid form hidden field names
	public $FormName = "fpatient_provisional_diagnosislist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_provisional_diagnosisadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "patient_provisional_diagnosisdelete.php";
		$this->MultiUpdateUrl = "patient_provisional_diagnosisupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fpatient_provisional_diagnosislistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $patient_provisional_diagnosis;
	...
	public function run()
	{
		...
		$this->provisionaldiagnosisTemplate->Visible = FALSE;
	...
	public function getFilterList()
	{
		...
		if (SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpatient_provisional_diagnosislistsrch");
		...
		$filterList = Concat($filterList, $this->provisionaldiagnosisTemplate->AdvancedSearch->toJson(), ","); // Field provisionaldiagnosisTemplate
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fpatient_provisional_diagnosislistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field provisionaldiagnosisTemplate
		$this->provisionaldiagnosisTemplate->AdvancedSearch->SearchValue = @$filter["x_provisionaldiagnosisTemplate"];
		$this->provisionaldiagnosisTemplate->AdvancedSearch->SearchOperator = @$filter["z_provisionaldiagnosisTemplate"];
		$this->provisionaldiagnosisTemplate->AdvancedSearch->SearchCondition = @$filter["v_provisionaldiagnosisTemplate"];
		$this->provisionaldiagnosisTemplate->AdvancedSearch->SearchValue2 = @$filter["y_provisionaldiagnosisTemplate"];
		$this->provisionaldiagnosisTemplate->AdvancedSearch->SearchOperator2 = @$filter["w_provisionaldiagnosisTemplate"];
		$this->provisionaldiagnosisTemplate->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->provisionaldiagnosisTemplate, $arKeywords, $type);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_provisional_diagnosislistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_provisional_diagnosislistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fpatient_provisional_diagnosislist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_provisional_diagnosislistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function newRow()
	{
		...
		$row['Gender'] = NULL;
		$row['profilePic'] = NULL;
		$row['provisionaldiagnosisTemplate'] = NULL;
		$row['HospID'] = NULL;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fpatient_provisional_diagnosislist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fpatient_provisional_diagnosislist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fpatient_provisional_diagnosislist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_patient_provisional_diagnosis\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_patient_provisional_diagnosis',hdr:ew.language.phrase('ExportToEmailText'),f:document.fpatient_provisional_diagnosislist,sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
