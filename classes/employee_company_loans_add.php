 ...
 * Page class
 */
class employee_company_loans_add extends employee_company_loans
{
	...
	// Page object name
	public $PageObjName = "employee_company_loans_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "employee_company_loansview.php")
