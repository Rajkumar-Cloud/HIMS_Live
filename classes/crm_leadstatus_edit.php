 ...
 * Page class
 */
class crm_leadstatus_edit extends crm_leadstatus
{
	...
	// Page object name
	public $PageObjName = "crm_leadstatus_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_leadstatusid")) {
				$this->leadstatusid->setFormValue($CurrentForm->getValue("x_leadstatusid"));
			}
		} else {
