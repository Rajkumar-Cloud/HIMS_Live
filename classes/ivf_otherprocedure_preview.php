 ...
 * Page class
 */
class ivf_otherprocedure_preview extends ivf_otherprocedure
{
	...
	// Page object name
	public $PageObjName = "ivf_otherprocedure_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'ivf_otherprocedure');
			if ($Security->isLoggedIn())
