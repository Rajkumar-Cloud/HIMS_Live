 ...
 * Page class
 */
class pres_fluidformulation_delete extends pres_fluidformulation
{
	...
	// Page object name
	public $PageObjName = "pres_fluidformulation_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pres_fluidformulationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pres_fluidformulationlist.php"); // Return to list
			}
		}
	}
