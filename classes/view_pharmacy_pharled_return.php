 ...
 */
class view_pharmacy_pharled_return extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BRCODE->Sortable = TRUE; // Allow sort
		$this->fields['BRCODE'] = &$this->BRCODE;

		// TYPE
		$this->TYPE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TYPE', 'TYPE', '`TYPE`', '`TYPE`', 200, -1, FALSE, '`TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TYPE->Sortable = TRUE; // Allow sort
		$this->fields['TYPE'] = &$this->TYPE;

		// DN
		$this->DN = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DN', 'DN', '`DN`', '`DN`', 200, -1, FALSE, '`DN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DN->Sortable = TRUE; // Allow sort
		$this->fields['DN'] = &$this->DN;

		// RDN
		$this->RDN = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RDN', 'RDN', '`RDN`', '`RDN`', 200, -1, FALSE, '`RDN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RDN->Sortable = TRUE; // Allow sort
		$this->fields['RDN'] = &$this->RDN;

		// DT
		$this->DT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 0, "DB"), 135, 0, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PRC
		$this->PRC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// OQ
		$this->OQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, -1, FALSE, '`OQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OQ->Sortable = TRUE; // Allow sort
		$this->OQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['OQ'] = &$this->OQ;

		// SiNo
		$this->SiNo = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_SiNo', 'SiNo', '`SiNo`', '`SiNo`', 3, -1, FALSE, '`SiNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RQ
		$this->RQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, -1, FALSE, '`RQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RQ->Sortable = TRUE; // Allow sort
		$this->RQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RQ'] = &$this->RQ;

		// Product
		$this->Product = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_Product', 'Product', '`Product`', '`Product`', 200, -1, FALSE, '`Product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product->Sortable = TRUE; // Allow sort
		$this->fields['Product'] = &$this->Product;

		// SLNO
		$this->SLNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_SLNO', 'SLNO', '`SLNO`', '`SLNO`', 3, -1, FALSE, '`SLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RT
		$this->RT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RT', 'RT', '`RT`', '`RT`', 131, -1, FALSE, '`RT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RT->Sortable = TRUE; // Allow sort
		$this->RT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RT'] = &$this->RT;

		// MRQ
		$this->MRQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, -1, FALSE, '`MRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRQ->Sortable = TRUE; // Allow sort
		$this->MRQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRQ'] = &$this->MRQ;

		// IQ
		$this->IQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = TRUE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// DAMT
		$this->DAMT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DAMT', 'DAMT', '`DAMT`', '`DAMT`', 131, -1, FALSE, '`DAMT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAMT->Sortable = TRUE; // Allow sort
		$this->DAMT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['DAMT'] = &$this->DAMT;

		// BATCHNO
		$this->BATCHNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// EXPDT
		$this->EXPDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Mfg
		$this->Mfg = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, -1, FALSE, '`Mfg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mfg->Sortable = TRUE; // Allow sort
		$this->fields['Mfg'] = &$this->Mfg;

		// BILLNO
		$this->BILLNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, -1, FALSE, '`BILLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLNO->Sortable = TRUE; // Allow sort
		$this->fields['BILLNO'] = &$this->BILLNO;

		// BILLDT
		$this->BILLDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLDT', 'BILLDT', '`BILLDT`', CastDateFieldForLike('`BILLDT`', 0, "DB"), 135, 0, FALSE, '`BILLDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// VALUE
		$this->VALUE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_VALUE', 'VALUE', '`VALUE`', '`VALUE`', 131, -1, FALSE, '`VALUE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DISC
		$this->DISC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DISC', 'DISC', '`DISC`', '`DISC`', 131, -1, FALSE, '`DISC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DISC->Sortable = TRUE; // Allow sort
		$this->DISC->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['DISC'] = &$this->DISC;

		// TAXP
		$this->TAXP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, -1, FALSE, '`TAXP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXP->Sortable = TRUE; // Allow sort
		$this->TAXP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAXP'] = &$this->TAXP;

		// TAX
		$this->TAX = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TAX', 'TAX', '`TAX`', '`TAX`', 131, -1, FALSE, '`TAX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAX->Sortable = TRUE; // Allow sort
		$this->TAX->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAX'] = &$this->TAX;

		// TAXR
		$this->TAXR = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TAXR', 'TAXR', '`TAXR`', '`TAXR`', 131, -1, FALSE, '`TAXR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXR->Sortable = TRUE; // Allow sort
		$this->TAXR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['TAXR'] = &$this->TAXR;

		// EMPNO
		$this->EMPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_EMPNO', 'EMPNO', '`EMPNO`', '`EMPNO`', 200, -1, FALSE, '`EMPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EMPNO->Sortable = TRUE; // Allow sort
		$this->fields['EMPNO'] = &$this->EMPNO;

		// PC
		$this->PC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PC->Sortable = TRUE; // Allow sort
		$this->fields['PC'] = &$this->PC;

		// DRNAME
		$this->DRNAME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DRNAME', 'DRNAME', '`DRNAME`', '`DRNAME`', 200, -1, FALSE, '`DRNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DRNAME->Sortable = TRUE; // Allow sort
		$this->fields['DRNAME'] = &$this->DRNAME;

		// BTIME
		$this->BTIME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BTIME', 'BTIME', '`BTIME`', '`BTIME`', 200, -1, FALSE, '`BTIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BTIME->Sortable = TRUE; // Allow sort
		$this->fields['BTIME'] = &$this->BTIME;

		// ONO
		$this->ONO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_ONO', 'ONO', '`ONO`', '`ONO`', 200, -1, FALSE, '`ONO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ONO->Sortable = TRUE; // Allow sort
		$this->fields['ONO'] = &$this->ONO;

		// ODT
		$this->ODT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_ODT', 'ODT', '`ODT`', CastDateFieldForLike('`ODT`', 0, "DB"), 135, 0, FALSE, '`ODT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PURRT
		$this->PURRT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PURRT', 'PURRT', '`PURRT`', '`PURRT`', 131, -1, FALSE, '`PURRT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GRP
		$this->GRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_GRP', 'GRP', '`GRP`', '`GRP`', 200, -1, FALSE, '`GRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GRP->Sortable = TRUE; // Allow sort
		$this->fields['GRP'] = &$this->GRP;

		// IBATCH
		$this->IBATCH = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_IBATCH', 'IBATCH', '`IBATCH`', '`IBATCH`', 200, -1, FALSE, '`IBATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IBATCH->Sortable = TRUE; // Allow sort
		$this->fields['IBATCH'] = &$this->IBATCH;

		// IPNO
		$this->IPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_IPNO', 'IPNO', '`IPNO`', '`IPNO`', 200, -1, FALSE, '`IPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IPNO->Sortable = TRUE; // Allow sort
		$this->fields['IPNO'] = &$this->IPNO;

		// OPNO
		$this->OPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_OPNO', 'OPNO', '`OPNO`', '`OPNO`', 200, -1, FALSE, '`OPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OPNO->Sortable = TRUE; // Allow sort
		$this->fields['OPNO'] = &$this->OPNO;

		// RECID
		$this->RECID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RECID', 'RECID', '`RECID`', '`RECID`', 200, -1, FALSE, '`RECID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RECID->Sortable = TRUE; // Allow sort
		$this->fields['RECID'] = &$this->RECID;

		// FQTY
		$this->FQTY = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_FQTY', 'FQTY', '`FQTY`', '`FQTY`', 131, -1, FALSE, '`FQTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FQTY->Sortable = TRUE; // Allow sort
		$this->FQTY->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['FQTY'] = &$this->FQTY;

		// UR
		$this->UR = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_UR', 'UR', '`UR`', '`UR`', 131, -1, FALSE, '`UR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UR->Sortable = TRUE; // Allow sort
		$this->UR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['UR'] = &$this->UR;

		// DCID
		$this->DCID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DCID', 'DCID', '`DCID`', '`DCID`', 200, -1, FALSE, '`DCID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DCID->Sortable = TRUE; // Allow sort
		$this->fields['DCID'] = &$this->DCID;

		// USERID
		$this->_USERID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x__USERID', 'USERID', '`USERID`', '`USERID`', 200, -1, FALSE, '`USERID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_USERID->Sortable = TRUE; // Allow sort
		$this->fields['USERID'] = &$this->_USERID;

		// MODDT
		$this->MODDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MODDT', 'MODDT', '`MODDT`', CastDateFieldForLike('`MODDT`', 0, "DB"), 135, 0, FALSE, '`MODDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FYM
		$this->FYM = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_FYM', 'FYM', '`FYM`', '`FYM`', 200, -1, FALSE, '`FYM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FYM->Sortable = TRUE; // Allow sort
		$this->fields['FYM'] = &$this->FYM;

		// PRCBATCH
		$this->PRCBATCH = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRCBATCH', 'PRCBATCH', '`PRCBATCH`', '`PRCBATCH`', 200, -1, FALSE, '`PRCBATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRCBATCH->Sortable = TRUE; // Allow sort
		$this->fields['PRCBATCH'] = &$this->PRCBATCH;

		// MRP
		$this->MRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// BILLYM
		$this->BILLYM = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLYM', 'BILLYM', '`BILLYM`', '`BILLYM`', 200, -1, FALSE, '`BILLYM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLYM->Sortable = TRUE; // Allow sort
		$this->fields['BILLYM'] = &$this->BILLYM;

		// BILLGRP
		$this->BILLGRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLGRP', 'BILLGRP', '`BILLGRP`', '`BILLGRP`', 200, -1, FALSE, '`BILLGRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLGRP->Sortable = TRUE; // Allow sort
		$this->fields['BILLGRP'] = &$this->BILLGRP;

		// STAFF
		$this->STAFF = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_STAFF', 'STAFF', '`STAFF`', '`STAFF`', 200, -1, FALSE, '`STAFF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->STAFF->Sortable = TRUE; // Allow sort
		$this->fields['STAFF'] = &$this->STAFF;

		// TEMPIPNO
		$this->TEMPIPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TEMPIPNO', 'TEMPIPNO', '`TEMPIPNO`', '`TEMPIPNO`', 200, -1, FALSE, '`TEMPIPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TEMPIPNO->Sortable = TRUE; // Allow sort
		$this->fields['TEMPIPNO'] = &$this->TEMPIPNO;

		// PRNTED
		$this->PRNTED = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRNTED', 'PRNTED', '`PRNTED`', '`PRNTED`', 200, -1, FALSE, '`PRNTED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRNTED->Sortable = TRUE; // Allow sort
		$this->fields['PRNTED'] = &$this->PRNTED;

		// PATNAME
		$this->PATNAME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PATNAME', 'PATNAME', '`PATNAME`', '`PATNAME`', 200, -1, FALSE, '`PATNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PATNAME->Sortable = TRUE; // Allow sort
		$this->fields['PATNAME'] = &$this->PATNAME;

		// PJVNO
		$this->PJVNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PJVNO', 'PJVNO', '`PJVNO`', '`PJVNO`', 200, -1, FALSE, '`PJVNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PJVNO->Sortable = TRUE; // Allow sort
		$this->fields['PJVNO'] = &$this->PJVNO;

		// PJVSLNO
		$this->PJVSLNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PJVSLNO', 'PJVSLNO', '`PJVSLNO`', '`PJVSLNO`', 200, -1, FALSE, '`PJVSLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PJVSLNO->Sortable = TRUE; // Allow sort
		$this->fields['PJVSLNO'] = &$this->PJVSLNO;

		// OTHDISC
		$this->OTHDISC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_OTHDISC', 'OTHDISC', '`OTHDISC`', '`OTHDISC`', 131, -1, FALSE, '`OTHDISC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PJVYM
		$this->PJVYM = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PJVYM', 'PJVYM', '`PJVYM`', '`PJVYM`', 200, -1, FALSE, '`PJVYM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PJVYM->Sortable = TRUE; // Allow sort
		$this->fields['PJVYM'] = &$this->PJVYM;

		// PURDISCPER
		$this->PURDISCPER = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PURDISCPER', 'PURDISCPER', '`PURDISCPER`', '`PURDISCPER`', 131, -1, FALSE, '`PURDISCPER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CASHIER
		$this->CASHIER = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHIER', 'CASHIER', '`CASHIER`', '`CASHIER`', 200, -1, FALSE, '`CASHIER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHIER->Sortable = TRUE; // Allow sort
		$this->fields['CASHIER'] = &$this->CASHIER;

		// CASHTIME
		$this->CASHTIME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHTIME', 'CASHTIME', '`CASHTIME`', '`CASHTIME`', 200, -1, FALSE, '`CASHTIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHTIME->Sortable = TRUE; // Allow sort
		$this->fields['CASHTIME'] = &$this->CASHTIME;

		// CASHRECD
		$this->CASHRECD = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHRECD', 'CASHRECD', '`CASHRECD`', '`CASHRECD`', 131, -1, FALSE, '`CASHRECD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CASHREFNO
		$this->CASHREFNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHREFNO', 'CASHREFNO', '`CASHREFNO`', '`CASHREFNO`', 200, -1, FALSE, '`CASHREFNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHREFNO->Sortable = TRUE; // Allow sort
		$this->fields['CASHREFNO'] = &$this->CASHREFNO;

		// CASHIERSHIFT
		$this->CASHIERSHIFT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHIERSHIFT', 'CASHIERSHIFT', '`CASHIERSHIFT`', '`CASHIERSHIFT`', 200, -1, FALSE, '`CASHIERSHIFT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CASHIERSHIFT->Sortable = TRUE; // Allow sort
		$this->fields['CASHIERSHIFT'] = &$this->CASHIERSHIFT;

		// PRCODE
		$this->PRCODE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRCODE', 'PRCODE', '`PRCODE`', '`PRCODE`', 200, -1, FALSE, '`PRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRCODE->Sortable = TRUE; // Allow sort
		$this->fields['PRCODE'] = &$this->PRCODE;

		// RELEASEBY
		$this->RELEASEBY = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RELEASEBY', 'RELEASEBY', '`RELEASEBY`', '`RELEASEBY`', 200, -1, FALSE, '`RELEASEBY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RELEASEBY->Sortable = TRUE; // Allow sort
		$this->fields['RELEASEBY'] = &$this->RELEASEBY;

		// CRAUTHOR
		$this->CRAUTHOR = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CRAUTHOR', 'CRAUTHOR', '`CRAUTHOR`', '`CRAUTHOR`', 200, -1, FALSE, '`CRAUTHOR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CRAUTHOR->Sortable = TRUE; // Allow sort
		$this->fields['CRAUTHOR'] = &$this->CRAUTHOR;

		// PAYMENT
		$this->PAYMENT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PAYMENT', 'PAYMENT', '`PAYMENT`', '`PAYMENT`', 200, -1, FALSE, '`PAYMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PAYMENT->Sortable = TRUE; // Allow sort
		$this->fields['PAYMENT'] = &$this->PAYMENT;

		// DRID
		$this->DRID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DRID', 'DRID', '`DRID`', '`DRID`', 200, -1, FALSE, '`DRID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DRID->Sortable = TRUE; // Allow sort
		$this->fields['DRID'] = &$this->DRID;

		// WARD
		$this->WARD = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_WARD', 'WARD', '`WARD`', '`WARD`', 200, -1, FALSE, '`WARD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WARD->Sortable = TRUE; // Allow sort
		$this->fields['WARD'] = &$this->WARD;

		// STAXTYPE
		$this->STAXTYPE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_STAXTYPE', 'STAXTYPE', '`STAXTYPE`', '`STAXTYPE`', 200, -1, FALSE, '`STAXTYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->STAXTYPE->Sortable = TRUE; // Allow sort
		$this->fields['STAXTYPE'] = &$this->STAXTYPE;

		// PURDISCVAL
		$this->PURDISCVAL = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PURDISCVAL', 'PURDISCVAL', '`PURDISCVAL`', '`PURDISCVAL`', 131, -1, FALSE, '`PURDISCVAL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RNDOFF
		$this->RNDOFF = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RNDOFF', 'RNDOFF', '`RNDOFF`', '`RNDOFF`', 131, -1, FALSE, '`RNDOFF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DISCONMRP
		$this->DISCONMRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DISCONMRP', 'DISCONMRP', '`DISCONMRP`', '`DISCONMRP`', 131, -1, FALSE, '`DISCONMRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DELVDT
		$this->DELVDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DELVDT', 'DELVDT', '`DELVDT`', CastDateFieldForLike('`DELVDT`', 0, "DB"), 135, 0, FALSE, '`DELVDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DELVTIME
		$this->DELVTIME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DELVTIME', 'DELVTIME', '`DELVTIME`', '`DELVTIME`', 200, -1, FALSE, '`DELVTIME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DELVTIME->Sortable = TRUE; // Allow sort
		$this->fields['DELVTIME'] = &$this->DELVTIME;

		// DELVBY
		$this->DELVBY = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DELVBY', 'DELVBY', '`DELVBY`', '`DELVBY`', 200, -1, FALSE, '`DELVBY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DELVBY->Sortable = TRUE; // Allow sort
		$this->fields['DELVBY'] = &$this->DELVBY;

		// HOSPNO
		$this->HOSPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_HOSPNO', 'HOSPNO', '`HOSPNO`', '`HOSPNO`', 200, -1, FALSE, '`HOSPNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HOSPNO->Sortable = TRUE; // Allow sort
		$this->fields['HOSPNO'] = &$this->HOSPNO;

		// id
		$this->id = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pbv
		$this->pbv = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_pbv', 'pbv', '`pbv`', '`pbv`', 3, -1, FALSE, '`pbv`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pbv->Sortable = TRUE; // Allow sort
		$this->pbv->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pbv'] = &$this->pbv;

		// pbt
		$this->pbt = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_pbt', 'pbt', '`pbt`', '`pbt`', 3, -1, FALSE, '`pbt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pbt->Sortable = TRUE; // Allow sort
		$this->pbt->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['pbt'] = &$this->pbt;

		// HosoID
		$this->HosoID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_HosoID', 'HosoID', '`HosoID`', '`HosoID`', 3, -1, FALSE, '`HosoID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdby
		$this->createdby = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// MFRCODE
		$this->MFRCODE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// Reception
		$this->Reception = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatID
		$this->PatID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mrnno
		$this->mrnno = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// BRNAME
		$this->BRNAME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BRNAME', 'BRNAME', '`BRNAME`', '`BRNAME`', 200, -1, FALSE, '`BRNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BRNAME->Sortable = TRUE; // Allow sort
		$this->fields['BRNAME'] = &$this->BRNAME;

		// sretid
		$this->sretid = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_sretid', 'sretid', '`sretid`', '`sretid`', 3, -1, FALSE, '`sretid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sprid
		$this->sprid = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_sprid', 'sprid', '`sprid`', '`sprid`', 3, -1, FALSE, '`sprid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "pharmacy_billing_return") {
			if ($this->sretid->getSessionValue() <> "")
				$masterFilter .= "`id`=" . QuotedValue($this->sretid->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "pharmacy_billing_return") {
			if ($this->sretid->getSessionValue() <> "")
				$detailFilter .= "`sretid`=" . QuotedValue($this->sretid->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`HosoID`='".HospitalID()."'  and `pbt` is not null";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_pharled_returnlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_pharled_returnview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_pharled_returnedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_pharled_returnadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_pharled_returnview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_pharled_returnview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_pharled_returnadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_pharled_returnadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_pharled_returnedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_pharled_returnadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_pharled_returndelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "pharmacy_billing_return" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->sretid->CurrentValue);
		}
		return $url;
	}
