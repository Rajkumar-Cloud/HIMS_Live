 ...
 */
class view_ip_admission extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_ip_admission', 'view_ip_admission', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// mrnNo
		$this->mrnNo = new DbField('view_ip_admission', 'view_ip_admission', 'x_mrnNo', 'mrnNo', '`mrnNo`', '`mrnNo`', 200, -1, FALSE, '`mrnNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// patient_id
		$this->patient_id = new DbField('view_ip_admission', 'view_ip_admission', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, -1, FALSE, '`patient_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// patient_name
		$this->patient_name = new DbField('view_ip_admission', 'view_ip_admission', 'x_patient_name', 'patient_name', '`patient_name`', '`patient_name`', 200, -1, FALSE, '`patient_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->patient_name->Sortable = TRUE; // Allow sort
		$this->fields['patient_name'] = &$this->patient_name;

		// profilePic
		$this->profilePic = new DbField('view_ip_admission', 'view_ip_admission', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// gender
		$this->gender = new DbField('view_ip_admission', 'view_ip_admission', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gender->Sortable = TRUE; // Allow sort
		$this->fields['gender'] = &$this->gender;

		// age
		$this->age = new DbField('view_ip_admission', 'view_ip_admission', 'x_age', 'age', '`age`', '`age`', 200, -1, FALSE, '`age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->age->Sortable = TRUE; // Allow sort
		$this->fields['age'] = &$this->age;

		// physician_id
		$this->physician_id = new DbField('view_ip_admission', 'view_ip_admission', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, -1, FALSE, '`physician_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// typeRegsisteration
		$this->typeRegsisteration = new DbField('view_ip_admission', 'view_ip_admission', 'x_typeRegsisteration', 'typeRegsisteration', '`typeRegsisteration`', '`typeRegsisteration`', 200, -1, FALSE, '`typeRegsisteration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->typeRegsisteration->Sortable = TRUE; // Allow sort
		$this->fields['typeRegsisteration'] = &$this->typeRegsisteration;

		// PaymentCategory
		$this->PaymentCategory = new DbField('view_ip_admission', 'view_ip_admission', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, -1, FALSE, '`PaymentCategory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentCategory->Sortable = TRUE; // Allow sort
		$this->fields['PaymentCategory'] = &$this->PaymentCategory;

		// admission_consultant_id
		$this->admission_consultant_id = new DbField('view_ip_admission', 'view_ip_admission', 'x_admission_consultant_id', 'admission_consultant_id', '`admission_consultant_id`', '`admission_consultant_id`', 3, -1, FALSE, '`admission_consultant_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->leading_consultant_id = new DbField('view_ip_admission', 'view_ip_admission', 'x_leading_consultant_id', 'leading_consultant_id', '`leading_consultant_id`', '`leading_consultant_id`', 3, -1, FALSE, '`leading_consultant_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// cause
		$this->cause = new DbField('view_ip_admission', 'view_ip_admission', 'x_cause', 'cause', '`cause`', '`cause`', 201, -1, FALSE, '`cause`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->cause->Sortable = TRUE; // Allow sort
		$this->fields['cause'] = &$this->cause;

		// admission_date
		$this->admission_date = new DbField('view_ip_admission', 'view_ip_admission', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike('`admission_date`', 0, "DB"), 135, 0, FALSE, '`admission_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// release_date
		$this->release_date = new DbField('view_ip_admission', 'view_ip_admission', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike('`release_date`', 0, "DB"), 135, 0, FALSE, '`release_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentStatus
		$this->PaymentStatus = new DbField('view_ip_admission', 'view_ip_admission', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, -1, FALSE, '`PaymentStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('view_ip_admission', 'view_ip_admission', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// createdby
		$this->createdby = new DbField('view_ip_admission', 'view_ip_admission', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_ip_admission', 'view_ip_admission', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_ip_admission', 'view_ip_admission', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_ip_admission', 'view_ip_admission', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// PatientID
		$this->PatientID = new DbField('view_ip_admission', 'view_ip_admission', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// HospID
		$this->HospID = new DbField('view_ip_admission', 'view_ip_admission', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->fields['HospID'] = &$this->HospID;

		// ReferedByDr
		$this->ReferedByDr = new DbField('view_ip_admission', 'view_ip_admission', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, -1, FALSE, '`ReferedByDr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferedByDr->Sortable = TRUE; // Allow sort
		$this->fields['ReferedByDr'] = &$this->ReferedByDr;

		// ReferClinicname
		$this->ReferClinicname = new DbField('view_ip_admission', 'view_ip_admission', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, -1, FALSE, '`ReferClinicname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferClinicname->Sortable = TRUE; // Allow sort
		$this->fields['ReferClinicname'] = &$this->ReferClinicname;

		// ReferCity
		$this->ReferCity = new DbField('view_ip_admission', 'view_ip_admission', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, -1, FALSE, '`ReferCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferCity->Sortable = TRUE; // Allow sort
		$this->fields['ReferCity'] = &$this->ReferCity;

		// ReferMobileNo
		$this->ReferMobileNo = new DbField('view_ip_admission', 'view_ip_admission', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, -1, FALSE, '`ReferMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['ReferMobileNo'] = &$this->ReferMobileNo;

		// ReferA4TreatingConsultant
		$this->ReferA4TreatingConsultant = new DbField('view_ip_admission', 'view_ip_admission', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, -1, FALSE, '`ReferA4TreatingConsultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurposreReferredfor
		$this->PurposreReferredfor = new DbField('view_ip_admission', 'view_ip_admission', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, -1, FALSE, '`PurposreReferredfor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PurposreReferredfor->Sortable = TRUE; // Allow sort
		$this->fields['PurposreReferredfor'] = &$this->PurposreReferredfor;

		// mobileno
		$this->mobileno = new DbField('view_ip_admission', 'view_ip_admission', 'x_mobileno', 'mobileno', '`mobileno`', '`mobileno`', 200, -1, FALSE, '`mobileno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobileno->Sortable = TRUE; // Allow sort
		$this->fields['mobileno'] = &$this->mobileno;

		// BillClosing
		$this->BillClosing = new DbField('view_ip_admission', 'view_ip_admission', 'x_BillClosing', 'BillClosing', '`BillClosing`', '`BillClosing`', 200, -1, FALSE, '`BillClosing`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillClosing->Sortable = TRUE; // Allow sort
		$this->fields['BillClosing'] = &$this->BillClosing;

		// BillClosingDate
		$this->BillClosingDate = new DbField('view_ip_admission', 'view_ip_admission', 'x_BillClosingDate', 'BillClosingDate', '`BillClosingDate`', CastDateFieldForLike('`BillClosingDate`', 0, "DB"), 135, 0, FALSE, '`BillClosingDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillNumber
		$this->BillNumber = new DbField('view_ip_admission', 'view_ip_admission', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, -1, FALSE, '`BillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillNumber->Sortable = TRUE; // Allow sort
		$this->fields['BillNumber'] = &$this->BillNumber;

		// ClosingAmount
		$this->ClosingAmount = new DbField('view_ip_admission', 'view_ip_admission', 'x_ClosingAmount', 'ClosingAmount', '`ClosingAmount`', '`ClosingAmount`', 200, -1, FALSE, '`ClosingAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ClosingAmount->Sortable = TRUE; // Allow sort
		$this->fields['ClosingAmount'] = &$this->ClosingAmount;

		// ClosingType
		$this->ClosingType = new DbField('view_ip_admission', 'view_ip_admission', 'x_ClosingType', 'ClosingType', '`ClosingType`', '`ClosingType`', 200, -1, FALSE, '`ClosingType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ClosingType->Sortable = TRUE; // Allow sort
		$this->fields['ClosingType'] = &$this->ClosingType;

		// BillAmount
		$this->BillAmount = new DbField('view_ip_admission', 'view_ip_admission', 'x_BillAmount', 'BillAmount', '`BillAmount`', '`BillAmount`', 200, -1, FALSE, '`BillAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillAmount->Sortable = TRUE; // Allow sort
		$this->fields['BillAmount'] = &$this->BillAmount;

		// billclosedBy
		$this->billclosedBy = new DbField('view_ip_admission', 'view_ip_admission', 'x_billclosedBy', 'billclosedBy', '`billclosedBy`', '`billclosedBy`', 200, -1, FALSE, '`billclosedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->billclosedBy->Sortable = TRUE; // Allow sort
		$this->fields['billclosedBy'] = &$this->billclosedBy;

		// bllcloseByDate
		$this->bllcloseByDate = new DbField('view_ip_admission', 'view_ip_admission', 'x_bllcloseByDate', 'bllcloseByDate', '`bllcloseByDate`', CastDateFieldForLike('`bllcloseByDate`', 0, "DB"), 135, 0, FALSE, '`bllcloseByDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReportHeader
		$this->ReportHeader = new DbField('view_ip_admission', 'view_ip_admission', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, -1, FALSE, '`ReportHeader`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReportHeader->Sortable = TRUE; // Allow sort
		$this->fields['ReportHeader'] = &$this->ReportHeader;

		// Procedure
		$this->Procedure = new DbField('view_ip_admission', 'view_ip_admission', 'x_Procedure', 'Procedure', '`Procedure`', '`Procedure`', 200, -1, FALSE, '`Procedure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Procedure->Sortable = TRUE; // Allow sort
		$this->fields['Procedure'] = &$this->Procedure;

		// Consultant
		$this->Consultant = new DbField('view_ip_admission', 'view_ip_admission', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, -1, FALSE, '`Consultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Consultant->Sortable = TRUE; // Allow sort
		$this->fields['Consultant'] = &$this->Consultant;

		// Anesthetist
		$this->Anesthetist = new DbField('view_ip_admission', 'view_ip_admission', 'x_Anesthetist', 'Anesthetist', '`Anesthetist`', '`Anesthetist`', 200, -1, FALSE, '`Anesthetist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Anesthetist->Sortable = TRUE; // Allow sort
		$this->fields['Anesthetist'] = &$this->Anesthetist;

		// Amound
		$this->Amound = new DbField('view_ip_admission', 'view_ip_admission', 'x_Amound', 'Amound', '`Amound`', '`Amound`', 131, -1, FALSE, '`Amound`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Package
		$this->Package = new DbField('view_ip_admission', 'view_ip_admission', 'x_Package', 'Package', '`Package`', '`Package`', 200, -1, FALSE, '`Package`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Package->Sortable = TRUE; // Allow sort
		$this->fields['Package'] = &$this->Package;

		// PartnerID
		$this->PartnerID = new DbField('view_ip_admission', 'view_ip_admission', 'x_PartnerID', 'PartnerID', '`PartnerID`', '`PartnerID`', 200, -1, FALSE, '`PartnerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerID->Sortable = TRUE; // Allow sort
		$this->fields['PartnerID'] = &$this->PartnerID;

		// PartnerName
		$this->PartnerName = new DbField('view_ip_admission', 'view_ip_admission', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, -1, FALSE, '`PartnerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerName->Sortable = TRUE; // Allow sort
		$this->fields['PartnerName'] = &$this->PartnerName;

		// PartnerMobile
		$this->PartnerMobile = new DbField('view_ip_admission', 'view_ip_admission', 'x_PartnerMobile', 'PartnerMobile', '`PartnerMobile`', '`PartnerMobile`', 200, -1, FALSE, '`PartnerMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerMobile->Sortable = TRUE; // Allow sort
		$this->fields['PartnerMobile'] = &$this->PartnerMobile;

		// Cid
		$this->Cid = new DbField('view_ip_admission', 'view_ip_admission', 'x_Cid', 'Cid', '`Cid`', '`Cid`', 3, -1, FALSE, '`Cid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cid->Sortable = TRUE; // Allow sort
		$this->Cid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Cid'] = &$this->Cid;

		// PartId
		$this->PartId = new DbField('view_ip_admission', 'view_ip_admission', 'x_PartId', 'PartId', '`PartId`', '`PartId`', 3, -1, FALSE, '`PartId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IDProof
		$this->IDProof = new DbField('view_ip_admission', 'view_ip_admission', 'x_IDProof', 'IDProof', '`IDProof`', '`IDProof`', 200, -1, FALSE, '`IDProof`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_ip_admissionlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_ip_admissionview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_ip_admissionedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_ip_admissionadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_ip_admissionview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_ip_admissionview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_ip_admissionadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_ip_admissionadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admissionedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admissionadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_ip_admissiondelete.php", $this->getUrlParm());
	}
