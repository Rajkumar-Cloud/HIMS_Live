 ...
 * Page class
 */
class reception_delete extends reception
{
	...
	// Page object name
	public $PageObjName = "reception_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("receptionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("receptionlist.php"); // Return to list
			}
		}
	}
