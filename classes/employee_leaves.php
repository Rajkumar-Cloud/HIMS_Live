 ...
 */
class employee_leaves extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_leaves', 'employee_leaves', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee
		$this->employee = new DbField('employee_leaves', 'employee_leaves', 'x_employee', 'employee', '`employee`', '`employee`', 3, -1, FALSE, '`employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// leave_type
		$this->leave_type = new DbField('employee_leaves', 'employee_leaves', 'x_leave_type', 'leave_type', '`leave_type`', '`leave_type`', 20, -1, FALSE, '`leave_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// leave_period
		$this->leave_period = new DbField('employee_leaves', 'employee_leaves', 'x_leave_period', 'leave_period', '`leave_period`', '`leave_period`', 20, -1, FALSE, '`leave_period`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date_start
		$this->date_start = new DbField('employee_leaves', 'employee_leaves', 'x_date_start', 'date_start', '`date_start`', CastDateFieldForLike('`date_start`', 0, "DB"), 133, 0, FALSE, '`date_start`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date_end
		$this->date_end = new DbField('employee_leaves', 'employee_leaves', 'x_date_end', 'date_end', '`date_end`', CastDateFieldForLike('`date_end`', 0, "DB"), 133, 0, FALSE, '`date_end`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// details
		$this->details = new DbField('employee_leaves', 'employee_leaves', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->details->Sortable = TRUE; // Allow sort
		$this->fields['details'] = &$this->details;

		// status
		$this->status = new DbField('employee_leaves', 'employee_leaves', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// attachment
		$this->attachment = new DbField('employee_leaves', 'employee_leaves', 'x_attachment', 'attachment', '`attachment`', '`attachment`', 200, -1, FALSE, '`attachment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_leaveslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_leavesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_leavesadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_leavesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_leavesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_leavesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_leavesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_leavesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_leavesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_leavesdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->leave_period->setDbValue($rs->fields('leave_period'));
