 ...
 * Page class
 */
class patient_provisional_diagnosis_grid extends patient_provisional_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_provisional_diagnosis_grid";

	// Grid form hidden field names
	public $FormName = "fpatient_provisional_diagnosisgrid";
