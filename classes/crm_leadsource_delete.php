 ...
 * Page class
 */
class crm_leadsource_delete extends crm_leadsource
{
	...
	// Page object name
	public $PageObjName = "crm_leadsource_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("crm_leadsourcelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("crm_leadsourcelist.php"); // Return to list
			}
		}
	}
