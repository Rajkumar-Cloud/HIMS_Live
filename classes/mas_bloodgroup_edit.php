 ...
 * Page class
 */
class mas_bloodgroup_edit extends mas_bloodgroup
{
	...
	// Page object name
	public $PageObjName = "mas_bloodgroup_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// BloodGroup
			$this->BloodGroup->setDbValueDef($rsnew, $this->BloodGroup->CurrentValue, "", $this->BloodGroup->ReadOnly);
