 ...
 * Page class
 */
class pharmacy_master_genericgrp_add extends pharmacy_master_genericgrp
{
	...
	// Page object name
	public $PageObjName = "pharmacy_master_genericgrp_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("pharmacy_master_genericgrplist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "pharmacy_master_genericgrplist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "pharmacy_master_genericgrpview.php")
