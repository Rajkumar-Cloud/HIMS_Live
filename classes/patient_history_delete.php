 ...
 * Page class
 */
class patient_history_delete extends patient_history
{
	...
	// Page object name
	public $PageObjName = "patient_history_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_historylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_historylist.php"); // Return to list
			}
		}
	}
