 ...
 * Page class
 */
class view_ivf_oocytedenudation_embryology_chart_list extends view_ivf_oocytedenudation_embryology_chart
{
	...
	// Page object name
	public $PageObjName = "view_ivf_oocytedenudation_embryology_chart_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "view_ivf_oocytedenudation_embryology_chartadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "view_ivf_oocytedenudation_embryology_chartdelete.php";
		$this->MultiUpdateUrl = "view_ivf_oocytedenudation_embryology_chartupdate.php";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-action ew-multi-update\" title=\"" . HtmlTitle($Language->phrase("UpdateSelectedLink")) . "\" data-table=\"view_ivf_oocytedenudation_embryology_chart\" data-caption=\"" . HtmlTitle($Language->phrase("UpdateSelectedLink")) . "\" href=\"\" onclick=\"ew.submitAction(event,{f:document.fview_ivf_oocytedenudation_embryology_chartlist,url:'" . $this->MultiUpdateUrl . "'});return false;\">" . $Language->phrase("UpdateSelectedLink") . "</a>";
		$item->Visible = ($Security->canEdit());
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_ivf_oocytedenudation_embryology_chartlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_ivf_oocytedenudation_embryology_chartlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fview_ivf_oocytedenudation_embryology_chartlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_ivf_oocytedenudation_embryology_chartlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function loadSearchValues()
	{
		...
		// OocyteNo
		if (!$this->isAddOrEdit())
			$this->OocyteNo->AdvancedSearch->setSearchValue(Get("x_OocyteNo", Get("OocyteNo", "")));
		if ($this->OocyteNo->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->OocyteNo->AdvancedSearch->setSearchOperator(Get("z_OocyteNo", ""));

		// Stage
		if (!$this->isAddOrEdit())
			$this->Stage->AdvancedSearch->setSearchValue(Get("x_Stage", Get("Stage", "")));
		if ($this->Stage->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Stage->AdvancedSearch->setSearchOperator(Get("z_Stage", ""));
		...
		// Day0OocyteStage
		if (!$this->isAddOrEdit())
			$this->Day0OocyteStage->AdvancedSearch->setSearchValue(Get("x_Day0OocyteStage", Get("Day0OocyteStage", "")));
		if ($this->Day0OocyteStage->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Day0OocyteStage->AdvancedSearch->setSearchOperator(Get("z_Day0OocyteStage", ""));

		// Day0sino
		if (!$this->isAddOrEdit())
			$this->Day0sino->AdvancedSearch->setSearchValue(Get("x_Day0sino", Get("Day0sino", "")));
		if ($this->Day0sino->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Day0sino->AdvancedSearch->setSearchOperator(Get("z_Day0sino", ""));
		...
		// DidNO
		if (!$this->isAddOrEdit())
			$this->DidNO->AdvancedSearch->setSearchValue(Get("x_DidNO", Get("DidNO", "")));
		if ($this->DidNO->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DidNO->AdvancedSearch->setSearchOperator(Get("z_DidNO", ""));
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('DidNO')); // DidNO
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_ivf_oocytedenudation_embryology_chartlist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_ivf_oocytedenudation_embryology_chartlist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_ivf_oocytedenudation_embryology_chartlist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
