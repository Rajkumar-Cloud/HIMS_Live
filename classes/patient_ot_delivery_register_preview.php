...
class patient_ot_delivery_register_preview extends patient_ot_delivery_register
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "ip_admission") {
			$url = "" . TABLE_SHOW_MASTER . "=ip_admission&fk_id=" . urlencode(strval($this->Reception->QueryStringValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnno->QueryStringValue)) . "&fk_patient_id=" . urlencode(strval($this->PId->QueryStringValue)) . "";
		}
		return $url;
	}
