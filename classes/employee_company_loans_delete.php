 ...
 * Page class
 */
class employee_company_loans_delete extends employee_company_loans
{
	...
	// Page object name
	public $PageObjName = "employee_company_loans_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_company_loanslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_company_loanslist.php"); // Return to list
			}
		}
	}
