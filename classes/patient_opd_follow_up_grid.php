 ...
 * Page class
 */
class patient_opd_follow_up_grid extends patient_opd_follow_up
{
	...
	// Page object name
	public $PageObjName = "patient_opd_follow_up_grid";

	// Grid form hidden field names
	public $FormName = "fpatient_opd_follow_upgrid";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_opd_follow_upadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->ProcedureDateTime->EditValue = HtmlEncode($this->ProcedureDateTime->CurrentValue);
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ProcedureDateTime
			$this->ProcedureDateTime->setDbValueDef($rsnew, $this->ProcedureDateTime->CurrentValue, NULL, $this->ProcedureDateTime->ReadOnly);
	...
	protected function addRow($rsold = NULL)
	{
		...
		// ProcedureDateTime
		$this->ProcedureDateTime->setDbValueDef($rsnew, $this->ProcedureDateTime->CurrentValue, NULL, FALSE);
