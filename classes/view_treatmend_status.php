 ...
 */
class view_treatmend_status extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// TreatmentStartDate
		$this->TreatmentStartDate = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_TreatmentStartDate', 'TreatmentStartDate', '`TreatmentStartDate`', CastDateFieldForLike('`TreatmentStartDate`', 14, "DB"), 135, 14, FALSE, '`TreatmentStartDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientID
		$this->PatientID = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->IsPrimaryKey = TRUE; // Primary key field
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// first_name
		$this->first_name = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// mobile_no
		$this->mobile_no = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_no->Sortable = FALSE; // Allow sort
		$this->fields['mobile_no'] = &$this->mobile_no;

		// Treatment
		$this->Treatment = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 200, -1, FALSE, '`Treatment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// OPUDATE
		$this->OPUDATE = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_OPUDATE', 'OPUDATE', '`OPUDATE`', CastDateFieldForLike('`OPUDATE`', 7, "DB"), 135, 7, FALSE, '`OPUDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Treatment1
		$this->Treatment1 = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_Treatment1', 'Treatment1', '`Treatment1`', '`Treatment1`', 200, -1, FALSE, '`Treatment1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Status
		$this->Status = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_Status', 'Status', '`Status`', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_treatmend_statuslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_treatmend_statusview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_treatmend_statusedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_treatmend_statusadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_treatmend_statusview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_treatmend_statusview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_treatmend_statusadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_treatmend_statusadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_treatmend_statusedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_treatmend_statusadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_treatmend_statusdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Treatment1->setDbValue($rs->fields('Treatment1'));
