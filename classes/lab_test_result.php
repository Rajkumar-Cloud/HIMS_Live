...
class lab_test_result extends DbTable
{
	...
	public function __construct()
	{
		...
		// Branch
		$this->Branch = new DbField('lab_test_result', 'lab_test_result', 'x_Branch', 'Branch', '`Branch`', '`Branch`', 200, -1, FALSE, '`Branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SidNo
		$this->SidNo = new DbField('lab_test_result', 'lab_test_result', 'x_SidNo', 'SidNo', '`SidNo`', '`SidNo`', 200, -1, FALSE, '`SidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SidDate
		$this->SidDate = new DbField('lab_test_result', 'lab_test_result', 'x_SidDate', 'SidDate', '`SidDate`', CastDateFieldForLike('`SidDate`', 0, "DB"), 135, 0, FALSE, '`SidDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TestCd
		$this->TestCd = new DbField('lab_test_result', 'lab_test_result', 'x_TestCd', 'TestCd', '`TestCd`', '`TestCd`', 200, -1, FALSE, '`TestCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TestSubCd
		$this->TestSubCd = new DbField('lab_test_result', 'lab_test_result', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, -1, FALSE, '`TestSubCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DEptCd
		$this->DEptCd = new DbField('lab_test_result', 'lab_test_result', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, -1, FALSE, '`DEptCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProfCd
		$this->ProfCd = new DbField('lab_test_result', 'lab_test_result', 'x_ProfCd', 'ProfCd', '`ProfCd`', '`ProfCd`', 200, -1, FALSE, '`ProfCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LabReport
		$this->LabReport = new DbField('lab_test_result', 'lab_test_result', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, -1, FALSE, '`LabReport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// ResultDate
		$this->ResultDate = new DbField('lab_test_result', 'lab_test_result', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike('`ResultDate`', 0, "DB"), 135, 0, FALSE, '`ResultDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Comments
		$this->Comments = new DbField('lab_test_result', 'lab_test_result', 'x_Comments', 'Comments', '`Comments`', '`Comments`', 201, -1, FALSE, '`Comments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// Method
		$this->Method = new DbField('lab_test_result', 'lab_test_result', 'x_Method', 'Method', '`Method`', '`Method`', 200, -1, FALSE, '`Method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Specimen
		$this->Specimen = new DbField('lab_test_result', 'lab_test_result', 'x_Specimen', 'Specimen', '`Specimen`', '`Specimen`', 200, -1, FALSE, '`Specimen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Amount
		$this->Amount = new DbField('lab_test_result', 'lab_test_result', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResultBy
		$this->ResultBy = new DbField('lab_test_result', 'lab_test_result', 'x_ResultBy', 'ResultBy', '`ResultBy`', '`ResultBy`', 200, -1, FALSE, '`ResultBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AuthBy
		$this->AuthBy = new DbField('lab_test_result', 'lab_test_result', 'x_AuthBy', 'AuthBy', '`AuthBy`', '`AuthBy`', 200, -1, FALSE, '`AuthBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AuthDate
		$this->AuthDate = new DbField('lab_test_result', 'lab_test_result', 'x_AuthDate', 'AuthDate', '`AuthDate`', CastDateFieldForLike('`AuthDate`', 0, "DB"), 135, 0, FALSE, '`AuthDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Abnormal
		$this->Abnormal = new DbField('lab_test_result', 'lab_test_result', 'x_Abnormal', 'Abnormal', '`Abnormal`', '`Abnormal`', 200, -1, FALSE, '`Abnormal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Printed
		$this->Printed = new DbField('lab_test_result', 'lab_test_result', 'x_Printed', 'Printed', '`Printed`', '`Printed`', 200, -1, FALSE, '`Printed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Dispatch
		$this->Dispatch = new DbField('lab_test_result', 'lab_test_result', 'x_Dispatch', 'Dispatch', '`Dispatch`', '`Dispatch`', 200, -1, FALSE, '`Dispatch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LOWHIGH
		$this->LOWHIGH = new DbField('lab_test_result', 'lab_test_result', 'x_LOWHIGH', 'LOWHIGH', '`LOWHIGH`', '`LOWHIGH`', 200, -1, FALSE, '`LOWHIGH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RefValue
		$this->RefValue = new DbField('lab_test_result', 'lab_test_result', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, -1, FALSE, '`RefValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// Unit
		$this->Unit = new DbField('lab_test_result', 'lab_test_result', 'x_Unit', 'Unit', '`Unit`', '`Unit`', 200, -1, FALSE, '`Unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResDate
		$this->ResDate = new DbField('lab_test_result', 'lab_test_result', 'x_ResDate', 'ResDate', '`ResDate`', CastDateFieldForLike('`ResDate`', 0, "DB"), 135, 0, FALSE, '`ResDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pic1
		$this->Pic1 = new DbField('lab_test_result', 'lab_test_result', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, -1, FALSE, '`Pic1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pic2
		$this->Pic2 = new DbField('lab_test_result', 'lab_test_result', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, -1, FALSE, '`Pic2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GraphPath
		$this->GraphPath = new DbField('lab_test_result', 'lab_test_result', 'x_GraphPath', 'GraphPath', '`GraphPath`', '`GraphPath`', 200, -1, FALSE, '`GraphPath`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SampleDate
		$this->SampleDate = new DbField('lab_test_result', 'lab_test_result', 'x_SampleDate', 'SampleDate', '`SampleDate`', CastDateFieldForLike('`SampleDate`', 0, "DB"), 135, 0, FALSE, '`SampleDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SampleUser
		$this->SampleUser = new DbField('lab_test_result', 'lab_test_result', 'x_SampleUser', 'SampleUser', '`SampleUser`', '`SampleUser`', 200, -1, FALSE, '`SampleUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceivedDate
		$this->ReceivedDate = new DbField('lab_test_result', 'lab_test_result', 'x_ReceivedDate', 'ReceivedDate', '`ReceivedDate`', CastDateFieldForLike('`ReceivedDate`', 0, "DB"), 135, 0, FALSE, '`ReceivedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceivedUser
		$this->ReceivedUser = new DbField('lab_test_result', 'lab_test_result', 'x_ReceivedUser', 'ReceivedUser', '`ReceivedUser`', '`ReceivedUser`', 200, -1, FALSE, '`ReceivedUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeptRecvDate
		$this->DeptRecvDate = new DbField('lab_test_result', 'lab_test_result', 'x_DeptRecvDate', 'DeptRecvDate', '`DeptRecvDate`', CastDateFieldForLike('`DeptRecvDate`', 0, "DB"), 135, 0, FALSE, '`DeptRecvDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeptRecvUser
		$this->DeptRecvUser = new DbField('lab_test_result', 'lab_test_result', 'x_DeptRecvUser', 'DeptRecvUser', '`DeptRecvUser`', '`DeptRecvUser`', 200, -1, FALSE, '`DeptRecvUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrintBy
		$this->PrintBy = new DbField('lab_test_result', 'lab_test_result', 'x_PrintBy', 'PrintBy', '`PrintBy`', '`PrintBy`', 200, -1, FALSE, '`PrintBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrintDate
		$this->PrintDate = new DbField('lab_test_result', 'lab_test_result', 'x_PrintDate', 'PrintDate', '`PrintDate`', CastDateFieldForLike('`PrintDate`', 0, "DB"), 135, 0, FALSE, '`PrintDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MachineCD
		$this->MachineCD = new DbField('lab_test_result', 'lab_test_result', 'x_MachineCD', 'MachineCD', '`MachineCD`', '`MachineCD`', 200, -1, FALSE, '`MachineCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TestCancel
		$this->TestCancel = new DbField('lab_test_result', 'lab_test_result', 'x_TestCancel', 'TestCancel', '`TestCancel`', '`TestCancel`', 200, -1, FALSE, '`TestCancel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OutSource
		$this->OutSource = new DbField('lab_test_result', 'lab_test_result', 'x_OutSource', 'OutSource', '`OutSource`', '`OutSource`', 200, -1, FALSE, '`OutSource`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tariff
		$this->Tariff = new DbField('lab_test_result', 'lab_test_result', 'x_Tariff', 'Tariff', '`Tariff`', '`Tariff`', 131, -1, FALSE, '`Tariff`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EDITDATE
		$this->EDITDATE = new DbField('lab_test_result', 'lab_test_result', 'x_EDITDATE', 'EDITDATE', '`EDITDATE`', CastDateFieldForLike('`EDITDATE`', 0, "DB"), 135, 0, FALSE, '`EDITDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UPLOAD
		$this->UPLOAD = new DbField('lab_test_result', 'lab_test_result', 'x_UPLOAD', 'UPLOAD', '`UPLOAD`', '`UPLOAD`', 200, -1, FALSE, '`UPLOAD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SAuthDate
		$this->SAuthDate = new DbField('lab_test_result', 'lab_test_result', 'x_SAuthDate', 'SAuthDate', '`SAuthDate`', CastDateFieldForLike('`SAuthDate`', 0, "DB"), 135, 0, FALSE, '`SAuthDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SAuthBy
		$this->SAuthBy = new DbField('lab_test_result', 'lab_test_result', 'x_SAuthBy', 'SAuthBy', '`SAuthBy`', '`SAuthBy`', 200, -1, FALSE, '`SAuthBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NoRC
		$this->NoRC = new DbField('lab_test_result', 'lab_test_result', 'x_NoRC', 'NoRC', '`NoRC`', '`NoRC`', 200, -1, FALSE, '`NoRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DispDt
		$this->DispDt = new DbField('lab_test_result', 'lab_test_result', 'x_DispDt', 'DispDt', '`DispDt`', CastDateFieldForLike('`DispDt`', 0, "DB"), 135, 0, FALSE, '`DispDt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DispUser
		$this->DispUser = new DbField('lab_test_result', 'lab_test_result', 'x_DispUser', 'DispUser', '`DispUser`', '`DispUser`', 200, -1, FALSE, '`DispUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DispRemarks
		$this->DispRemarks = new DbField('lab_test_result', 'lab_test_result', 'x_DispRemarks', 'DispRemarks', '`DispRemarks`', '`DispRemarks`', 200, -1, FALSE, '`DispRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DispMode
		$this->DispMode = new DbField('lab_test_result', 'lab_test_result', 'x_DispMode', 'DispMode', '`DispMode`', '`DispMode`', 200, -1, FALSE, '`DispMode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductCD
		$this->ProductCD = new DbField('lab_test_result', 'lab_test_result', 'x_ProductCD', 'ProductCD', '`ProductCD`', '`ProductCD`', 200, -1, FALSE, '`ProductCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nos
		$this->Nos = new DbField('lab_test_result', 'lab_test_result', 'x_Nos', 'Nos', '`Nos`', '`Nos`', 131, -1, FALSE, '`Nos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nos->Sortable = TRUE; // Allow sort
		$this->Nos->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Nos'] = &$this->Nos;

		// WBCPath
		$this->WBCPath = new DbField('lab_test_result', 'lab_test_result', 'x_WBCPath', 'WBCPath', '`WBCPath`', '`WBCPath`', 200, -1, FALSE, '`WBCPath`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RBCPath
		$this->RBCPath = new DbField('lab_test_result', 'lab_test_result', 'x_RBCPath', 'RBCPath', '`RBCPath`', '`RBCPath`', 200, -1, FALSE, '`RBCPath`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PTPath
		$this->PTPath = new DbField('lab_test_result', 'lab_test_result', 'x_PTPath', 'PTPath', '`PTPath`', '`PTPath`', 200, -1, FALSE, '`PTPath`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ActualAmt
		$this->ActualAmt = new DbField('lab_test_result', 'lab_test_result', 'x_ActualAmt', 'ActualAmt', '`ActualAmt`', '`ActualAmt`', 131, -1, FALSE, '`ActualAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NoSign
		$this->NoSign = new DbField('lab_test_result', 'lab_test_result', 'x_NoSign', 'NoSign', '`NoSign`', '`NoSign`', 200, -1, FALSE, '`NoSign`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Barcode
		$this->_Barcode = new DbField('lab_test_result', 'lab_test_result', 'x__Barcode', 'Barcode', '`Barcode`', '`Barcode`', 200, -1, FALSE, '`Barcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReadTime
		$this->ReadTime = new DbField('lab_test_result', 'lab_test_result', 'x_ReadTime', 'ReadTime', '`ReadTime`', CastDateFieldForLike('`ReadTime`', 0, "DB"), 135, 0, FALSE, '`ReadTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Result
		$this->Result = new DbField('lab_test_result', 'lab_test_result', 'x_Result', 'Result', '`Result`', '`Result`', 201, -1, FALSE, '`Result`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// VailID
		$this->VailID = new DbField('lab_test_result', 'lab_test_result', 'x_VailID', 'VailID', '`VailID`', '`VailID`', 200, -1, FALSE, '`VailID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReadMachine
		$this->ReadMachine = new DbField('lab_test_result', 'lab_test_result', 'x_ReadMachine', 'ReadMachine', '`ReadMachine`', '`ReadMachine`', 200, -1, FALSE, '`ReadMachine`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LabCD
		$this->LabCD = new DbField('lab_test_result', 'lab_test_result', 'x_LabCD', 'LabCD', '`LabCD`', '`LabCD`', 200, -1, FALSE, '`LabCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OutLabAmt
		$this->OutLabAmt = new DbField('lab_test_result', 'lab_test_result', 'x_OutLabAmt', 'OutLabAmt', '`OutLabAmt`', '`OutLabAmt`', 131, -1, FALSE, '`OutLabAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductQty
		$this->ProductQty = new DbField('lab_test_result', 'lab_test_result', 'x_ProductQty', 'ProductQty', '`ProductQty`', '`ProductQty`', 131, -1, FALSE, '`ProductQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Repeat
		$this->Repeat = new DbField('lab_test_result', 'lab_test_result', 'x_Repeat', 'Repeat', '`Repeat`', '`Repeat`', 200, -1, FALSE, '`Repeat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeptNo
		$this->DeptNo = new DbField('lab_test_result', 'lab_test_result', 'x_DeptNo', 'DeptNo', '`DeptNo`', '`DeptNo`', 200, -1, FALSE, '`DeptNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Desc1
		$this->Desc1 = new DbField('lab_test_result', 'lab_test_result', 'x_Desc1', 'Desc1', '`Desc1`', '`Desc1`', 200, -1, FALSE, '`Desc1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Desc2
		$this->Desc2 = new DbField('lab_test_result', 'lab_test_result', 'x_Desc2', 'Desc2', '`Desc2`', '`Desc2`', 200, -1, FALSE, '`Desc2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RptResult
		$this->RptResult = new DbField('lab_test_result', 'lab_test_result', 'x_RptResult', 'RptResult', '`RptResult`', '`RptResult`', 200, -1, FALSE, '`RptResult`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("lab_test_resultview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
