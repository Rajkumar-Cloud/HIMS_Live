 ...
 * Page class
 */
class view_lab_resultreleased_grid extends view_lab_resultreleased
{
	...
	// Page object name
	public $PageObjName = "view_lab_resultreleased_grid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "view_lab_services") {
			...
			if ($GLOBALS["view_lab_services"]->EventCancelled)
				$this->EventCancelled = TRUE;
		}
		if ($masterTblVar == "view_labreport_print") {
			$this->Vid->Visible = FALSE;
			if ($GLOBALS["view_labreport_print"]->EventCancelled)
				$this->EventCancelled = TRUE;
		}
