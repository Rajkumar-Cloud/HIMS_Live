 ...
 * Page class
 */
class lab_sub_test_master_delete extends lab_sub_test_master
{
	...
	// Page object name
	public $PageObjName = "lab_sub_test_master_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lab_sub_test_masterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("lab_sub_test_masterlist.php"); // Return to list
			}
		}
	}
