 ...
 */
class view_next_review_date extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// first_name
		$this->first_name = new DbField('view_next_review_date', 'view_next_review_date', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// PatientID
		$this->PatientID = new DbField('view_next_review_date', 'view_next_review_date', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mobile_no
		$this->mobile_no = new DbField('view_next_review_date', 'view_next_review_date', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['mobile_no'] = &$this->mobile_no;

		// street
		$this->street = new DbField('view_next_review_date', 'view_next_review_date', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->street->Sortable = TRUE; // Allow sort
		$this->fields['street'] = &$this->street;

		// town
		$this->town = new DbField('view_next_review_date', 'view_next_review_date', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// NextReviewDate
		$this->NextReviewDate = new DbField('view_next_review_date', 'view_next_review_date', 'x_NextReviewDate', 'NextReviewDate', '`NextReviewDate`', CastDateFieldForLike('`NextReviewDate`', 0, "DB"), 135, 0, FALSE, '`NextReviewDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserName
		$this->createdUserName = new DbField('view_next_review_date', 'view_next_review_date', 'x_createdUserName', 'createdUserName', '`createdUserName`', '`createdUserName`', 200, -1, FALSE, '`createdUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdUserName->Sortable = TRUE; // Allow sort
		$this->fields['createdUserName'] = &$this->createdUserName;

		// HospID
		$this->HospID = new DbField('view_next_review_date', 'view_next_review_date', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Purpose
		$this->Purpose = new DbField('view_next_review_date', 'view_next_review_date', 'x_Purpose', 'Purpose', '`Purpose`', '`Purpose`', 201, -1, FALSE, '`Purpose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Purpose->Sortable = TRUE; // Allow sort
		$this->fields['Purpose'] = &$this->Purpose;

		// DrName
		$this->DrName = new DbField('view_next_review_date', 'view_next_review_date', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, -1, FALSE, '`DrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`HospID`='".HospitalID()."' and `NextReviewDate` is not null";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_next_review_datelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_next_review_dateview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_next_review_dateedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_next_review_dateadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_next_review_dateview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_next_review_dateview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_next_review_dateadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_next_review_dateadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_next_review_dateedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_next_review_dateadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_next_review_datedelete.php", $this->getUrlParm());
	}
