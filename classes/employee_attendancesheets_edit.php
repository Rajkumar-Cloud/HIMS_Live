 ...
 * Page class
 */
class employee_attendancesheets_edit extends employee_attendancesheets
{
	...
	// Page object name
	public $PageObjName = "employee_attendancesheets_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// date_start
			$this->date_start->setDbValueDef($rsnew, UnFormatDateTime($this->date_start->CurrentValue, 0), CurrentDate(), $this->date_start->ReadOnly);

			// date_end
			$this->date_end->setDbValueDef($rsnew, UnFormatDateTime($this->date_end->CurrentValue, 0), CurrentDate(), $this->date_end->ReadOnly);
