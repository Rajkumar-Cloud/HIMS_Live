 ...
 * Page class
 */
class view_labreport_print_preview extends view_labreport_print
{
	...
	// Page object name
	public $PageObjName = "view_labreport_print_preview";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS['view_lab_print']))
			$GLOBALS['view_lab_print'] = new view_lab_print();
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'view_labreport_print');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_lab_print") {
			$url = "" . TABLE_SHOW_MASTER . "=view_lab_print&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("view_labreport_printlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
