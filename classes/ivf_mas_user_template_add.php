 ...
 * Page class
 */
class ivf_mas_user_template_add extends ivf_mas_user_template
{
	...
	// Page object name
	public $PageObjName = "ivf_mas_user_template_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_mas_user_templateview.php")
