...
class view_dashboard_service_drwise_summary extends DbTable
{
	...
	public function __construct()
	{
		...
		// DrName
		$this->DrName = new DbField('view_dashboard_service_drwise_summary', 'view_dashboard_service_drwise_summary', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, -1, FALSE, '`DrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DrName->Sortable = TRUE; // Allow sort
		$this->fields['DrName'] = &$this->DrName;

		// sum(SubTotal)
		$this->sum28SubTotal29 = new DbField('view_dashboard_service_drwise_summary', 'view_dashboard_service_drwise_summary', 'x_sum28SubTotal29', 'sum(SubTotal)', '`sum(SubTotal)`', '`sum(SubTotal)`', 131, -1, FALSE, '`sum(SubTotal)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdDate
		$this->createdDate = new DbField('view_dashboard_service_drwise_summary', 'view_dashboard_service_drwise_summary', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike('`createdDate`', 0, "DB"), 133, 0, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_dashboard_service_drwise_summary', 'view_dashboard_service_drwise_summary', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_dashboard_service_drwise_summaryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
