...
class view_iui_excel extends DbTable
{
	...
	public function __construct()
	{
		...
		// NAME
		$this->NAME = new DbField('view_iui_excel', 'view_iui_excel', 'x_NAME', 'NAME', '`NAME`', '`NAME`', 200, -1, FALSE, '`NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NAME->Sortable = TRUE; // Allow sort
		$this->fields['NAME'] = &$this->NAME;

		// HUSBAND NAME
		$this->HUSBAND_NAME = new DbField('view_iui_excel', 'view_iui_excel', 'x_HUSBAND_NAME', 'HUSBAND NAME', '`HUSBAND NAME`', '`HUSBAND NAME`', 200, -1, FALSE, '`HUSBAND NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HUSBAND_NAME->Sortable = TRUE; // Allow sort
		$this->fields['HUSBAND NAME'] = &$this->HUSBAND_NAME;

		// CoupleID
		$this->CoupleID = new DbField('view_iui_excel', 'view_iui_excel', 'x_CoupleID', 'CoupleID', '`CoupleID`', '`CoupleID`', 200, -1, FALSE, '`CoupleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AGE  - WIFE
		$this->AGE____WIFE = new DbField('view_iui_excel', 'view_iui_excel', 'x_AGE____WIFE', 'AGE  - WIFE', '`AGE  - WIFE`', '`AGE  - WIFE`', 200, -1, FALSE, '`AGE  - WIFE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AGE____WIFE->Sortable = TRUE; // Allow sort
		$this->fields['AGE  - WIFE'] = &$this->AGE____WIFE;

		// AGE- HUSBAND
		$this->AGE__HUSBAND = new DbField('view_iui_excel', 'view_iui_excel', 'x_AGE__HUSBAND', 'AGE- HUSBAND', '`AGE- HUSBAND`', '`AGE- HUSBAND`', 200, -1, FALSE, '`AGE- HUSBAND`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AGE__HUSBAND->Sortable = TRUE; // Allow sort
		$this->fields['AGE- HUSBAND'] = &$this->AGE__HUSBAND;

		// ANXIOUS TO CONCEIVE FOR
		$this->ANXIOUS_TO_CONCEIVE_FOR = new DbField('view_iui_excel', 'view_iui_excel', 'x_ANXIOUS_TO_CONCEIVE_FOR', 'ANXIOUS TO CONCEIVE FOR', '`ANXIOUS TO CONCEIVE FOR`', '`ANXIOUS TO CONCEIVE FOR`', 200, -1, FALSE, '`ANXIOUS TO CONCEIVE FOR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANXIOUS_TO_CONCEIVE_FOR->Sortable = TRUE; // Allow sort
		$this->fields['ANXIOUS TO CONCEIVE FOR'] = &$this->ANXIOUS_TO_CONCEIVE_FOR;

		// AMH ( NG/ML)
		$this->AMH_28_NG2FML29 = new DbField('view_iui_excel', 'view_iui_excel', 'x_AMH_28_NG2FML29', 'AMH ( NG/ML)', '`AMH ( NG/ML)`', '`AMH ( NG/ML)`', 200, -1, FALSE, '`AMH ( NG/ML)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AMH_28_NG2FML29->Sortable = TRUE; // Allow sort
		$this->fields['AMH ( NG/ML)'] = &$this->AMH_28_NG2FML29;

		// TUBAL_PATENCY
		$this->TUBAL_PATENCY = new DbField('view_iui_excel', 'view_iui_excel', 'x_TUBAL_PATENCY', 'TUBAL_PATENCY', '`TUBAL_PATENCY`', '`TUBAL_PATENCY`', 200, -1, FALSE, '`TUBAL_PATENCY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TUBAL_PATENCY->Sortable = TRUE; // Allow sort
		$this->fields['TUBAL_PATENCY'] = &$this->TUBAL_PATENCY;

		// HSG
		$this->HSG = new DbField('view_iui_excel', 'view_iui_excel', 'x_HSG', 'HSG', '`HSG`', '`HSG`', 200, -1, FALSE, '`HSG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HSG->Sortable = TRUE; // Allow sort
		$this->fields['HSG'] = &$this->HSG;

		// DHL
		$this->DHL = new DbField('view_iui_excel', 'view_iui_excel', 'x_DHL', 'DHL', '`DHL`', '`DHL`', 200, -1, FALSE, '`DHL`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DHL->Sortable = TRUE; // Allow sort
		$this->fields['DHL'] = &$this->DHL;

		// UTERINE_PROBLEMS
		$this->UTERINE_PROBLEMS = new DbField('view_iui_excel', 'view_iui_excel', 'x_UTERINE_PROBLEMS', 'UTERINE_PROBLEMS', '`UTERINE_PROBLEMS`', '`UTERINE_PROBLEMS`', 200, -1, FALSE, '`UTERINE_PROBLEMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UTERINE_PROBLEMS->Sortable = TRUE; // Allow sort
		$this->fields['UTERINE_PROBLEMS'] = &$this->UTERINE_PROBLEMS;

		// W_COMORBIDS
		$this->W_COMORBIDS = new DbField('view_iui_excel', 'view_iui_excel', 'x_W_COMORBIDS', 'W_COMORBIDS', '`W_COMORBIDS`', '`W_COMORBIDS`', 200, -1, FALSE, '`W_COMORBIDS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->W_COMORBIDS->Sortable = TRUE; // Allow sort
		$this->fields['W_COMORBIDS'] = &$this->W_COMORBIDS;

		// H_COMORBIDS
		$this->H_COMORBIDS = new DbField('view_iui_excel', 'view_iui_excel', 'x_H_COMORBIDS', 'H_COMORBIDS', '`H_COMORBIDS`', '`H_COMORBIDS`', 200, -1, FALSE, '`H_COMORBIDS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->H_COMORBIDS->Sortable = TRUE; // Allow sort
		$this->fields['H_COMORBIDS'] = &$this->H_COMORBIDS;

		// SEXUAL_DYSFUNCTION
		$this->SEXUAL_DYSFUNCTION = new DbField('view_iui_excel', 'view_iui_excel', 'x_SEXUAL_DYSFUNCTION', 'SEXUAL_DYSFUNCTION', '`SEXUAL_DYSFUNCTION`', '`SEXUAL_DYSFUNCTION`', 200, -1, FALSE, '`SEXUAL_DYSFUNCTION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SEXUAL_DYSFUNCTION->Sortable = TRUE; // Allow sort
		$this->fields['SEXUAL_DYSFUNCTION'] = &$this->SEXUAL_DYSFUNCTION;

		// PREV IUI
		$this->PREV_IUI = new DbField('view_iui_excel', 'view_iui_excel', 'x_PREV_IUI', 'PREV IUI', '`PREV IUI`', '`PREV IUI`', 200, -1, FALSE, '`PREV IUI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PREV_IUI->Sortable = TRUE; // Allow sort
		$this->fields['PREV IUI'] = &$this->PREV_IUI;

		// PREV_IVF
		$this->PREV_IVF = new DbField('view_iui_excel', 'view_iui_excel', 'x_PREV_IVF', 'PREV_IVF', '`PREV_IVF`', '`PREV_IVF`', 201, -1, FALSE, '`PREV_IVF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// TABLETS
		$this->TABLETS = new DbField('view_iui_excel', 'view_iui_excel', 'x_TABLETS', 'TABLETS', '`TABLETS`', '`TABLETS`', 200, -1, FALSE, '`TABLETS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TABLETS->Sortable = TRUE; // Allow sort
		$this->fields['TABLETS'] = &$this->TABLETS;

		// INJTYPE
		$this->INJTYPE = new DbField('view_iui_excel', 'view_iui_excel', 'x_INJTYPE', 'INJTYPE', '`INJTYPE`', '`INJTYPE`', 200, -1, FALSE, '`INJTYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->INJTYPE->Sortable = TRUE; // Allow sort
		$this->fields['INJTYPE'] = &$this->INJTYPE;

		// LMP
		$this->LMP = new DbField('view_iui_excel', 'view_iui_excel', 'x_LMP', 'LMP', '`LMP`', CastDateFieldForLike('`LMP`', 0, "DB"), 135, 0, FALSE, '`LMP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TRIGGERR
		$this->TRIGGERR = new DbField('view_iui_excel', 'view_iui_excel', 'x_TRIGGERR', 'TRIGGERR', '`TRIGGERR`', '`TRIGGERR`', 200, -1, FALSE, '`TRIGGERR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TRIGGERR->Sortable = TRUE; // Allow sort
		$this->fields['TRIGGERR'] = &$this->TRIGGERR;

		// TRIGGERDATE
		$this->TRIGGERDATE = new DbField('view_iui_excel', 'view_iui_excel', 'x_TRIGGERDATE', 'TRIGGERDATE', '`TRIGGERDATE`', CastDateFieldForLike('`TRIGGERDATE`', 0, "DB"), 135, 0, FALSE, '`TRIGGERDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FOLLICLE_STATUS
		$this->FOLLICLE_STATUS = new DbField('view_iui_excel', 'view_iui_excel', 'x_FOLLICLE_STATUS', 'FOLLICLE_STATUS', '`FOLLICLE_STATUS`', '`FOLLICLE_STATUS`', 200, -1, FALSE, '`FOLLICLE_STATUS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FOLLICLE_STATUS->Sortable = TRUE; // Allow sort
		$this->fields['FOLLICLE_STATUS'] = &$this->FOLLICLE_STATUS;

		// NUMBER_OF_IUI
		$this->NUMBER_OF_IUI = new DbField('view_iui_excel', 'view_iui_excel', 'x_NUMBER_OF_IUI', 'NUMBER_OF_IUI', '`NUMBER_OF_IUI`', '`NUMBER_OF_IUI`', 200, -1, FALSE, '`NUMBER_OF_IUI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NUMBER_OF_IUI->Sortable = TRUE; // Allow sort
		$this->fields['NUMBER_OF_IUI'] = &$this->NUMBER_OF_IUI;

		// PROCEDURE
		$this->PROCEDURE = new DbField('view_iui_excel', 'view_iui_excel', 'x_PROCEDURE', 'PROCEDURE', '`PROCEDURE`', '`PROCEDURE`', 200, -1, FALSE, '`PROCEDURE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PROCEDURE->Sortable = TRUE; // Allow sort
		$this->fields['PROCEDURE'] = &$this->PROCEDURE;

		// LUTEAL_SUPPORT
		$this->LUTEAL_SUPPORT = new DbField('view_iui_excel', 'view_iui_excel', 'x_LUTEAL_SUPPORT', 'LUTEAL_SUPPORT', '`LUTEAL_SUPPORT`', '`LUTEAL_SUPPORT`', 200, -1, FALSE, '`LUTEAL_SUPPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LUTEAL_SUPPORT->Sortable = TRUE; // Allow sort
		$this->fields['LUTEAL_SUPPORT'] = &$this->LUTEAL_SUPPORT;

		// H/D SAMPLE
		$this->H2FD_SAMPLE = new DbField('view_iui_excel', 'view_iui_excel', 'x_H2FD_SAMPLE', 'H/D SAMPLE', '`H/D SAMPLE`', '`H/D SAMPLE`', 200, -1, FALSE, '`H/D SAMPLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->H2FD_SAMPLE->Sortable = TRUE; // Allow sort
		$this->fields['H/D SAMPLE'] = &$this->H2FD_SAMPLE;

		// DONOR - I.D
		$this->DONOR___I_D = new DbField('view_iui_excel', 'view_iui_excel', 'x_DONOR___I_D', 'DONOR - I.D', '`DONOR - I.D`', '`DONOR - I.D`', 3, -1, FALSE, '`DONOR - I.D`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PREG_TEST_DATE
		$this->PREG_TEST_DATE = new DbField('view_iui_excel', 'view_iui_excel', 'x_PREG_TEST_DATE', 'PREG_TEST_DATE', '`PREG_TEST_DATE`', CastDateFieldForLike('`PREG_TEST_DATE`', 7, "DB"), 135, 7, FALSE, '`PREG_TEST_DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// COLLECTION  METHOD
		$this->COLLECTION__METHOD = new DbField('view_iui_excel', 'view_iui_excel', 'x_COLLECTION__METHOD', 'COLLECTION  METHOD', '`COLLECTION  METHOD`', '`COLLECTION  METHOD`', 200, -1, FALSE, '`COLLECTION  METHOD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->COLLECTION__METHOD->Sortable = TRUE; // Allow sort
		$this->fields['COLLECTION  METHOD'] = &$this->COLLECTION__METHOD;

		// SAMPLE SOURCE
		$this->SAMPLE_SOURCE = new DbField('view_iui_excel', 'view_iui_excel', 'x_SAMPLE_SOURCE', 'SAMPLE SOURCE', '`SAMPLE SOURCE`', '`SAMPLE SOURCE`', 200, -1, FALSE, '`SAMPLE SOURCE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SAMPLE_SOURCE->Sortable = TRUE; // Allow sort
		$this->fields['SAMPLE SOURCE'] = &$this->SAMPLE_SOURCE;

		// SPECIFIC_PROBLEMS
		$this->SPECIFIC_PROBLEMS = new DbField('view_iui_excel', 'view_iui_excel', 'x_SPECIFIC_PROBLEMS', 'SPECIFIC_PROBLEMS', '`SPECIFIC_PROBLEMS`', '`SPECIFIC_PROBLEMS`', 200, -1, FALSE, '`SPECIFIC_PROBLEMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SPECIFIC_PROBLEMS->Sortable = TRUE; // Allow sort
		$this->fields['SPECIFIC_PROBLEMS'] = &$this->SPECIFIC_PROBLEMS;

		// IMSC_1
		$this->IMSC_1 = new DbField('view_iui_excel', 'view_iui_excel', 'x_IMSC_1', 'IMSC_1', '`IMSC_1`', '`IMSC_1`', 200, -1, FALSE, '`IMSC_1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMSC_1->Sortable = TRUE; // Allow sort
		$this->fields['IMSC_1'] = &$this->IMSC_1;

		// IMSC_2
		$this->IMSC_2 = new DbField('view_iui_excel', 'view_iui_excel', 'x_IMSC_2', 'IMSC_2', '`IMSC_2`', '`IMSC_2`', 200, -1, FALSE, '`IMSC_2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMSC_2->Sortable = TRUE; // Allow sort
		$this->fields['IMSC_2'] = &$this->IMSC_2;

		// LIQUIFACTION_STORAGE
		$this->LIQUIFACTION_STORAGE = new DbField('view_iui_excel', 'view_iui_excel', 'x_LIQUIFACTION_STORAGE', 'LIQUIFACTION_STORAGE', '`LIQUIFACTION_STORAGE`', '`LIQUIFACTION_STORAGE`', 200, -1, FALSE, '`LIQUIFACTION_STORAGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LIQUIFACTION_STORAGE->Sortable = TRUE; // Allow sort
		$this->fields['LIQUIFACTION_STORAGE'] = &$this->LIQUIFACTION_STORAGE;

		// IUI_PREP_METHOD
		$this->IUI_PREP_METHOD = new DbField('view_iui_excel', 'view_iui_excel', 'x_IUI_PREP_METHOD', 'IUI_PREP_METHOD', '`IUI_PREP_METHOD`', '`IUI_PREP_METHOD`', 200, -1, FALSE, '`IUI_PREP_METHOD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IUI_PREP_METHOD->Sortable = TRUE; // Allow sort
		$this->fields['IUI_PREP_METHOD'] = &$this->IUI_PREP_METHOD;

		// TIME_FROM_TRIGGER
		$this->TIME_FROM_TRIGGER = new DbField('view_iui_excel', 'view_iui_excel', 'x_TIME_FROM_TRIGGER', 'TIME_FROM_TRIGGER', '`TIME_FROM_TRIGGER`', '`TIME_FROM_TRIGGER`', 200, -1, FALSE, '`TIME_FROM_TRIGGER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->COLLECTION_TO_PREPARATION = new DbField('view_iui_excel', 'view_iui_excel', 'x_COLLECTION_TO_PREPARATION', 'COLLECTION_TO_PREPARATION', '`COLLECTION_TO_PREPARATION`', '`COLLECTION_TO_PREPARATION`', 200, -1, FALSE, '`COLLECTION_TO_PREPARATION`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->TIME_FROM_PREP_TO_INSEM = new DbField('view_iui_excel', 'view_iui_excel', 'x_TIME_FROM_PREP_TO_INSEM', 'TIME_FROM_PREP_TO_INSEM', '`TIME_FROM_PREP_TO_INSEM`', '`TIME_FROM_PREP_TO_INSEM`', 200, -1, FALSE, '`TIME_FROM_PREP_TO_INSEM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SPECIFIC_MATERNAL_PROBLEMS = new DbField('view_iui_excel', 'view_iui_excel', 'x_SPECIFIC_MATERNAL_PROBLEMS', 'SPECIFIC_MATERNAL_PROBLEMS', '`SPECIFIC_MATERNAL_PROBLEMS`', '`SPECIFIC_MATERNAL_PROBLEMS`', 200, -1, FALSE, '`SPECIFIC_MATERNAL_PROBLEMS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RESULTS
		$this->RESULTS = new DbField('view_iui_excel', 'view_iui_excel', 'x_RESULTS', 'RESULTS', '`RESULTS`', '`RESULTS`', 201, -1, FALSE, '`RESULTS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// ONGOING_PREG
		$this->ONGOING_PREG = new DbField('view_iui_excel', 'view_iui_excel', 'x_ONGOING_PREG', 'ONGOING_PREG', '`ONGOING_PREG`', '`ONGOING_PREG`', 200, -1, FALSE, '`ONGOING_PREG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ONGOING_PREG->Sortable = TRUE; // Allow sort
		$this->fields['ONGOING_PREG'] = &$this->ONGOING_PREG;

		// EDD_Date
		$this->EDD_Date = new DbField('view_iui_excel', 'view_iui_excel', 'x_EDD_Date', 'EDD_Date', '`EDD_Date`', CastDateFieldForLike('`EDD_Date`', 0, "DB"), 135, 0, FALSE, '`EDD_Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getRecordFilter($row = NULL)
	{
		...
		$val = is_array($row) ? (array_key_exists('CoupleID', $row) ? $row['CoupleID'] : NULL) : $this->CoupleID->CurrentValue;
		if ($val == NULL)
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_iui_excelview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
