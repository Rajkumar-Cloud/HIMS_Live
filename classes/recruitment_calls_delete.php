 ...
 * Page class
 */
class recruitment_calls_delete extends recruitment_calls
{
	...
	// Page object name
	public $PageObjName = "recruitment_calls_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("recruitment_callslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("recruitment_callslist.php"); // Return to list
			}
		}
	}
