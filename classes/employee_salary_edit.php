 ...
 * Page class
 */
class employee_salary_edit extends employee_salary
{
	...
	// Page object name
	public $PageObjName = "employee_salary_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// component
			$this->component->setDbValueDef($rsnew, $this->component->CurrentValue, 0, $this->component->ReadOnly);
