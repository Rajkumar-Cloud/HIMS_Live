 ...
 * Page class
 */
class hr_companystructures_delete extends hr_companystructures
{
	...
	// Page object name
	public $PageObjName = "hr_companystructures_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("hr_companystructureslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hr_companystructureslist.php"); // Return to list
			}
		}
	}
