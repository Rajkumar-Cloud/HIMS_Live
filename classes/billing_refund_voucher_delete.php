 ...
 * Page class
 */
class billing_refund_voucher_delete extends billing_refund_voucher
{
	...
	// Page object name
	public $PageObjName = "billing_refund_voucher_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("billing_refund_voucherlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("billing_refund_voucherlist.php"); // Return to list
			}
		}
	}
