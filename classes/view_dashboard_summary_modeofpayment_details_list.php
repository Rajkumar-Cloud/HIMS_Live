...
class view_dashboard_summary_modeofpayment_details_list extends view_dashboard_summary_modeofpayment_details
{
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $view_dashboard_summary_modeofpayment_details;
	...
	public function renderListOptions()
	{
		...
		// "detail_view_dashboard_collection_details"
		$opt = &$this->ListOptions->Items["detail_view_dashboard_collection_details"];
		if ($Security->allowList(CurrentProjectID() . 'view_dashboard_collection_details')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("view_dashboard_collection_detailslist.php?" . TABLE_SHOW_MASTER . "=view_dashboard_summary_modeofpayment_details&fk_UserName=" . urlencode(strval($this->UserName->CurrentValue)) . "&fk_createddate=" . urlencode(UnFormatDateTime($this->createddate->CurrentValue, 0)) . "&fk_ModeofPayment=" . urlencode(strval($this->ModeofPayment->CurrentValue)) . "&fk_HospID=" . urlencode(strval($this->HospID->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($links <> "") {
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_dashboard_summary_modeofpayment_detailslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_dashboard_summary_modeofpayment_detailslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fview_dashboard_summary_modeofpayment_detailslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_dashboard_summary_modeofpayment_detailslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages->Items["view_dashboard_collection_details"]->Visible) {
			$link = "";
			$option = &$this->ListOptions->Items["detail_view_dashboard_collection_details"];
			...
			if ($Security->allowList(CurrentProjectID() . 'view_dashboard_collection_details')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("view_dashboard_collection_detailslist.php?" . TABLE_SHOW_MASTER . "=view_dashboard_summary_modeofpayment_details&fk_UserName=" . urlencode(strval($this->UserName->CurrentValue)) . "&fk_createddate=" . urlencode(UnFormatDateTime(UnFormatDateTime($this->createddate->CurrentValue, 0), 0)) . "&fk_ModeofPayment=" . urlencode(strval($this->ModeofPayment->CurrentValue)) . "&fk_HospID=" . urlencode(strval($this->HospID->CurrentValue)) . "");
				$btngrp .= "<button type=\"button\" class=\"btn btn-default\" title=\"" . $Language->TablePhrase("view_dashboard_collection_details", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "'\">" . $Language->Phrase("MasterDetailListLink") . "</button>";
			}
			if (!isset($GLOBALS["view_dashboard_collection_details_grid"]))
				$GLOBALS["view_dashboard_collection_details_grid"] = new view_dashboard_collection_details_grid();
			if ($GLOBALS["view_dashboard_collection_details_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_dashboard_collection_details')) {
				$caption = $Language->Phrase("MasterDetailViewLink");
				$url = $this->getViewUrl(TABLE_SHOW_DETAIL . "=view_dashboard_collection_details");
	...
	protected function loadSearchValues()
	{
		...
		// sum(Amount)
		if (!$this->isAddOrEdit())
			$this->sum28Amount29->AdvancedSearch->setSearchValue(Get("x_sum28Amount29", Get("sum28Amount29", "")));
		if ($this->sum28Amount29->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->sum28Amount29->AdvancedSearch->setSearchOperator(Get("z_sum28Amount29", ""));
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_dashboard_summary_modeofpayment_detailslist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_dashboard_summary_modeofpayment_detailslist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_dashboard_summary_modeofpayment_detailslist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	public function exportData($return = FALSE)
	{
		...
		if (EXPORT_MASTER_RECORD && $this->getMasterFilter() <> "" && $this->getCurrentMasterTable() == "view_dashboard_summary_details") {
			global $view_dashboard_summary_details;
	...
	protected function setupMasterParms()
	{
		...
		if (Get(TABLE_SHOW_MASTER) !== NULL) {
			...
			if ($masterTblVar == "view_dashboard_summary_details") {
				$validMaster = TRUE;
				if (Get("fk_UserName") !== NULL) {
					$this->UserName->setQueryStringValue(Get("fk_UserName"));
					$this->UserName->setSessionValue($this->UserName->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
				if (Get("fk_createddate") !== NULL) {
					$this->createddate->setQueryStringValue(Get("fk_createddate"));
					$this->createddate->setSessionValue($this->createddate->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
				if (Get("fk_HospID") !== NULL) {
					$this->HospID->setQueryStringValue(Get("fk_HospID"));
					$this->HospID->setSessionValue($this->HospID->QueryStringValue);
					if (!is_numeric($this->HospID->QueryStringValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
			...
			if ($masterTblVar == "view_dashboard_summary_details") {
				$validMaster = TRUE;
				if (Post("fk_UserName") !== NULL) {
					$this->UserName->setFormValue(Post("fk_UserName"));
					$this->UserName->setSessionValue($this->UserName->FormValue);
				} else {
					$validMaster = FALSE;
				}
				if (Post("fk_createddate") !== NULL) {
					$this->createddate->setFormValue(Post("fk_createddate"));
					$this->createddate->setSessionValue($this->createddate->FormValue);
				} else {
					$validMaster = FALSE;
				}
				if (Post("fk_HospID") !== NULL) {
					$this->HospID->setFormValue(Post("fk_HospID"));
					$this->HospID->setSessionValue($this->HospID->FormValue);
					if (!is_numeric($this->HospID->FormValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
