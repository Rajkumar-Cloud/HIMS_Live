 ...
 * Page class
 */
class patient_prescription_delete extends patient_prescription
{
	...
	// Page object name
	public $PageObjName = "patient_prescription_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_prescriptionlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_prescriptionlist.php"); // Return to list
			}
		}
	}
