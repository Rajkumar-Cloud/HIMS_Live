 ...
 */
class qaqcrecord_endrology extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Date
		$this->Date = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_Date', 'Date', '`Date`', CastDateFieldForLike('`Date`', 0, "DB"), 133, 0, FALSE, '`Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LN2_Level
		$this->LN2_Level = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_LN2_Level', 'LN2_Level', '`LN2_Level`', '`LN2_Level`', 131, -1, FALSE, '`LN2_Level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LN2_Checked
		$this->LN2_Checked = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_LN2_Checked', 'LN2_Checked', '`LN2_Checked`', '`LN2_Checked`', 200, -1, FALSE, '`LN2_Checked`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Incubator_Temp
		$this->Incubator_Temp = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_Incubator_Temp', 'Incubator_Temp', '`Incubator_Temp`', '`Incubator_Temp`', 131, -1, FALSE, '`Incubator_Temp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Incubator_Cleaned
		$this->Incubator_Cleaned = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_Incubator_Cleaned', 'Incubator_Cleaned', '`Incubator_Cleaned`', '`Incubator_Cleaned`', 200, -1, FALSE, '`Incubator_Cleaned`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// LAF_MG
		$this->LAF_MG = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_LAF_MG', 'LAF_MG', '`LAF_MG`', '`LAF_MG`', 131, -1, FALSE, '`LAF_MG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LAF_Cleaned
		$this->LAF_Cleaned = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_LAF_Cleaned', 'LAF_Cleaned', '`LAF_Cleaned`', '`LAF_Cleaned`', 200, -1, FALSE, '`LAF_Cleaned`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// REF_Temp
		$this->REF_Temp = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_REF_Temp', 'REF_Temp', '`REF_Temp`', '`REF_Temp`', 131, -1, FALSE, '`REF_Temp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// REF_Cleaned
		$this->REF_Cleaned = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_REF_Cleaned', 'REF_Cleaned', '`REF_Cleaned`', '`REF_Cleaned`', 200, -1, FALSE, '`REF_Cleaned`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Heating_Temp
		$this->Heating_Temp = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_Heating_Temp', 'Heating_Temp', '`Heating_Temp`', '`Heating_Temp`', 131, -1, FALSE, '`Heating_Temp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Heating_Cleaned
		$this->Heating_Cleaned = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_Heating_Cleaned', 'Heating_Cleaned', '`Heating_Cleaned`', '`Heating_Cleaned`', 200, -1, FALSE, '`Heating_Cleaned`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Createdby
		$this->Createdby = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_Createdby', 'Createdby', '`Createdby`', '`Createdby`', 200, -1, FALSE, '`Createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Createdby->Sortable = TRUE; // Allow sort
		$this->fields['Createdby'] = &$this->Createdby;

		// CreatedDate
		$this->CreatedDate = new DbField('qaqcrecord_endrology', 'qaqcrecord_endrology', 'x_CreatedDate', 'CreatedDate', '`CreatedDate`', CastDateFieldForLike('`CreatedDate`', 0, "DB"), 135, 0, FALSE, '`CreatedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "qaqcrecord_endrologylist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "qaqcrecord_endrologyedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "qaqcrecord_endrologyadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("qaqcrecord_endrologyview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("qaqcrecord_endrologyview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "qaqcrecord_endrologyadd.php?" . $this->getUrlParm($parm);
		else
			$url = "qaqcrecord_endrologyadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("qaqcrecord_endrologyedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("qaqcrecord_endrologyadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("qaqcrecord_endrologydelete.php", $this->getUrlParm());
	}
