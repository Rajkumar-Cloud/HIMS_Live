 ...
 * Page class
 */
class view_ivf_oocytedenudation_embryology_chart_delete extends view_ivf_oocytedenudation_embryology_chart
{
	...
	// Page object name
	public $PageObjName = "view_ivf_oocytedenudation_embryology_chart_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_ivf_oocytedenudation_embryology_chartlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("view_ivf_oocytedenudation_embryology_chartlist.php"); // Return to list
			}
		}
	}
