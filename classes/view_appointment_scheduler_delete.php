 ...
 * Page class
 */
class view_appointment_scheduler_delete extends view_appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "view_appointment_scheduler_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_appointment_schedulerlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("view_appointment_schedulerlist.php"); // Return to list
			}
		}
	}
