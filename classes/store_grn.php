 ...
 */
class store_grn extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('store_grn', 'store_grn', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// GRNNO
		$this->GRNNO = new DbField('store_grn', 'store_grn', 'x_GRNNO', 'GRNNO', '`GRNNO`', '`GRNNO`', 200, -1, FALSE, '`GRNNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GRNNO->Sortable = TRUE; // Allow sort
		$this->fields['GRNNO'] = &$this->GRNNO;

		// DT
		$this->DT = new DbField('store_grn', 'store_grn', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 0, "DB"), 135, 0, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// YM
		$this->YM = new DbField('store_grn', 'store_grn', 'x_YM', 'YM', '`YM`', '`YM`', 200, -1, FALSE, '`YM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->YM->Required = TRUE; // Required field
		$this->YM->Sortable = TRUE; // Allow sort
		$this->fields['YM'] = &$this->YM;

		// PC
		$this->PC = new DbField('store_grn', 'store_grn', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Customercode
		$this->Customercode = new DbField('store_grn', 'store_grn', 'x_Customercode', 'Customercode', '`Customercode`', '`Customercode`', 200, -1, FALSE, '`Customercode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Customercode->Sortable = TRUE; // Allow sort
		$this->fields['Customercode'] = &$this->Customercode;

		// Customername
		$this->Customername = new DbField('store_grn', 'store_grn', 'x_Customername', 'Customername', '`Customername`', '`Customername`', 200, -1, FALSE, '`Customername`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Customername->Sortable = TRUE; // Allow sort
		$this->fields['Customername'] = &$this->Customername;

		// pharmacy_pocol
		$this->pharmacy_pocol = new DbField('store_grn', 'store_grn', 'x_pharmacy_pocol', 'pharmacy_pocol', '`pharmacy_pocol`', '`pharmacy_pocol`', 200, -1, FALSE, '`pharmacy_pocol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pharmacy_pocol->Sortable = TRUE; // Allow sort
		$this->fields['pharmacy_pocol'] = &$this->pharmacy_pocol;

		// Address1
		$this->Address1 = new DbField('store_grn', 'store_grn', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 201, -1, FALSE, '`Address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address1->Sortable = TRUE; // Allow sort
		$this->fields['Address1'] = &$this->Address1;

		// Address2
		$this->Address2 = new DbField('store_grn', 'store_grn', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 201, -1, FALSE, '`Address2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address2->Sortable = TRUE; // Allow sort
		$this->fields['Address2'] = &$this->Address2;

		// Address3
		$this->Address3 = new DbField('store_grn', 'store_grn', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 201, -1, FALSE, '`Address3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address3->Sortable = TRUE; // Allow sort
		$this->fields['Address3'] = &$this->Address3;

		// State
		$this->State = new DbField('store_grn', 'store_grn', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->State->Sortable = TRUE; // Allow sort
		$this->fields['State'] = &$this->State;

		// Pincode
		$this->Pincode = new DbField('store_grn', 'store_grn', 'x_Pincode', 'Pincode', '`Pincode`', '`Pincode`', 200, -1, FALSE, '`Pincode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pincode->Sortable = TRUE; // Allow sort
		$this->fields['Pincode'] = &$this->Pincode;

		// Phone
		$this->Phone = new DbField('store_grn', 'store_grn', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Phone->Sortable = TRUE; // Allow sort
		$this->fields['Phone'] = &$this->Phone;

		// Fax
		$this->Fax = new DbField('store_grn', 'store_grn', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, -1, FALSE, '`Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fax->Sortable = TRUE; // Allow sort
		$this->fields['Fax'] = &$this->Fax;

		// EEmail
		$this->EEmail = new DbField('store_grn', 'store_grn', 'x_EEmail', 'EEmail', '`EEmail`', '`EEmail`', 200, -1, FALSE, '`EEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EEmail->Sortable = TRUE; // Allow sort
		$this->fields['EEmail'] = &$this->EEmail;

		// HospID
		$this->HospID = new DbField('store_grn', 'store_grn', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// createdby
		$this->createdby = new DbField('store_grn', 'store_grn', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('store_grn', 'store_grn', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('store_grn', 'store_grn', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('store_grn', 'store_grn', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// BILLNO
		$this->BILLNO = new DbField('store_grn', 'store_grn', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, -1, FALSE, '`BILLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLNO->Required = TRUE; // Required field
		$this->BILLNO->Sortable = TRUE; // Allow sort
		$this->fields['BILLNO'] = &$this->BILLNO;

		// BILLDT
		$this->BILLDT = new DbField('store_grn', 'store_grn', 'x_BILLDT', 'BILLDT', '`BILLDT`', CastDateFieldForLike('`BILLDT`', 0, "DB"), 135, 0, FALSE, '`BILLDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BRCODE
		$this->BRCODE = new DbField('store_grn', 'store_grn', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PharmacyID
		$this->PharmacyID = new DbField('store_grn', 'store_grn', 'x_PharmacyID', 'PharmacyID', '`PharmacyID`', '`PharmacyID`', 3, -1, FALSE, '`PharmacyID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillTotalValue
		$this->BillTotalValue = new DbField('store_grn', 'store_grn', 'x_BillTotalValue', 'BillTotalValue', '`BillTotalValue`', '`BillTotalValue`', 131, -1, FALSE, '`BillTotalValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GRNTotalValue
		$this->GRNTotalValue = new DbField('store_grn', 'store_grn', 'x_GRNTotalValue', 'GRNTotalValue', '`GRNTotalValue`', '`GRNTotalValue`', 131, -1, FALSE, '`GRNTotalValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillDiscount
		$this->BillDiscount = new DbField('store_grn', 'store_grn', 'x_BillDiscount', 'BillDiscount', '`BillDiscount`', '`BillDiscount`', 131, -1, FALSE, '`BillDiscount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillUpload
		$this->BillUpload = new DbField('store_grn', 'store_grn', 'x_BillUpload', 'BillUpload', '`BillUpload`', '`BillUpload`', 201, -1, TRUE, '`BillUpload`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->BillUpload->Sortable = TRUE; // Allow sort
		$this->fields['BillUpload'] = &$this->BillUpload;

		// TransPort
		$this->TransPort = new DbField('store_grn', 'store_grn', 'x_TransPort', 'TransPort', '`TransPort`', '`TransPort`', 131, -1, FALSE, '`TransPort`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AnyOther
		$this->AnyOther = new DbField('store_grn', 'store_grn', 'x_AnyOther', 'AnyOther', '`AnyOther`', '`AnyOther`', 131, -1, FALSE, '`AnyOther`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Remarks
		$this->Remarks = new DbField('store_grn', 'store_grn', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// GrnValue
		$this->GrnValue = new DbField('store_grn', 'store_grn', 'x_GrnValue', 'GrnValue', '`GrnValue`', '`GrnValue`', 131, -1, FALSE, '`GrnValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pid
		$this->Pid = new DbField('store_grn', 'store_grn', 'x_Pid', 'Pid', '`Pid`', '`Pid`', 3, -1, FALSE, '`Pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentNo
		$this->PaymentNo = new DbField('store_grn', 'store_grn', 'x_PaymentNo', 'PaymentNo', '`PaymentNo`', '`PaymentNo`', 200, -1, FALSE, '`PaymentNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentNo->Sortable = TRUE; // Allow sort
		$this->fields['PaymentNo'] = &$this->PaymentNo;

		// PaymentStatus
		$this->PaymentStatus = new DbField('store_grn', 'store_grn', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 200, -1, FALSE, '`PaymentStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentStatus->Sortable = TRUE; // Allow sort
		$this->fields['PaymentStatus'] = &$this->PaymentStatus;

		// PaidAmount
		$this->PaidAmount = new DbField('store_grn', 'store_grn', 'x_PaidAmount', 'PaidAmount', '`PaidAmount`', '`PaidAmount`', 131, -1, FALSE, '`PaidAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StoreID
		$this->StoreID = new DbField('store_grn', 'store_grn', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, -1, FALSE, '`StoreID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_store_grn") {
			$detailUrl = $GLOBALS["view_store_grn"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "store_grnlist.php";
		return $detailUrl;
	}
	...
	{
		global $Language;
		if ($pageName == "store_grnview.php")
			return $Language->phrase("View");
		elseif ($pageName == "store_grnedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "store_grnadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("store_grnview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("store_grnview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "store_grnadd.php?" . $this->getUrlParm($parm);
		else
			$url = "store_grnadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("store_grnedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("store_grnedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("store_grnadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("store_grnadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("store_grndelete.php", $this->getUrlParm());
	}

	// Add master url
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "store_payment" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
