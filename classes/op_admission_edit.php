 ...
 * Page class
 */
class op_admission_edit extends op_admission
{
	...
	// Page object name
	public $PageObjName = "op_admission_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// physician_id
			$this->physician_id->setDbValueDef($rsnew, $this->physician_id->CurrentValue, 0, $this->physician_id->ReadOnly);
