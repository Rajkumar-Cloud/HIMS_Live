 ...
 * Page class
 */
class mas_user_template_prescription_add extends mas_user_template_prescription
{
	...
	// Page object name
	public $PageObjName = "mas_user_template_prescription_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "mas_user_template_prescriptionview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// CreateDateTime
		$this->CreateDateTime->setDbValueDef($rsnew, CurrentDateTime(), NULL);
		$rsnew['CreateDateTime'] = &$this->CreateDateTime->DbValue;
