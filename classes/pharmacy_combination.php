...
class pharmacy_combination extends DbTable
{
	...
	public function __construct()
	{
		...
		// GENCODE
		$this->GENCODE = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_GENCODE', 'GENCODE', '`GENCODE`', '`GENCODE`', 200, -1, FALSE, '`GENCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// COMBCODE
		$this->COMBCODE = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_COMBCODE', 'COMBCODE', '`COMBCODE`', '`COMBCODE`', 200, -1, FALSE, '`COMBCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// STRENGTH
		$this->STRENGTH = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 131, -1, FALSE, '`STRENGTH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SLNO
		$this->SLNO = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_SLNO', 'SLNO', '`SLNO`', '`SLNO`', 200, -1, FALSE, '`SLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SLNO->Sortable = TRUE; // Allow sort
		$this->fields['SLNO'] = &$this->SLNO;

		// id
		$this->id = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_combinationview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
