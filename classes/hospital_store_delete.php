 ...
 * Page class
 */
class hospital_store_delete extends hospital_store
{
	...
	// Page object name
	public $PageObjName = "hospital_store_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("hospital_storelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hospital_storelist.php"); // Return to list
			}
		}
	}
