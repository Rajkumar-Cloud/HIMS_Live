 ...
 * Page class
 */
class ivf_ovumpickupchartt_preview extends ivf_ovumpickupchartt
{
	...
	// Page object name
	public $PageObjName = "ivf_ovumpickupchartt_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'ivf_ovumpickupchartt');
			if ($Security->isLoggedIn())
