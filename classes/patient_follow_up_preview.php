 ...
 * Page class
 */
class patient_follow_up_preview extends patient_follow_up
{
	...
	// Page object name
	public $PageObjName = "patient_follow_up_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_follow_up');
			if ($Security->isLoggedIn())
