...
class view_dashboard_summary_details extends DbTable
{
	...
	public function __construct()
	{
		...
		// UserName
		$this->UserName = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UserName->IsForeignKey = TRUE; // Foreign key field
		$this->UserName->Sortable = TRUE; // Allow sort
		$this->fields['UserName'] = &$this->UserName;

		// sum(Amount)
		$this->sum28Amount29 = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_sum28Amount29', 'sum(Amount)', '`sum(Amount)`', '`sum(Amount)`', 131, -1, FALSE, '`sum(Amount)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createddate
		$this->createddate = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_createddate', 'createddate', '`createddate`', CastDateFieldForLike('`createddate`', 7, "DB"), 133, 7, FALSE, '`createddate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_dashboard_summary_modeofpayment_details") {
			$detailUrl = $GLOBALS["view_dashboard_summary_modeofpayment_details"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_dashboard_summary_detailsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
