 ...
 * Page class
 */
class patient_insurance_preview extends patient_insurance
{
	...
	// Page object name
	public $PageObjName = "patient_insurance_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_insurance');
			if ($Security->isLoggedIn())
