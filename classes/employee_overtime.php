 ...
 */
class employee_overtime extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_overtime', 'employee_overtime', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee
		$this->employee = new DbField('employee_overtime', 'employee_overtime', 'x_employee', 'employee', '`employee`', '`employee`', 3, -1, FALSE, '`employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// start_time
		$this->start_time = new DbField('employee_overtime', 'employee_overtime', 'x_start_time', 'start_time', '`start_time`', CastDateFieldForLike('`start_time`', 0, "DB"), 135, 0, FALSE, '`start_time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end_time
		$this->end_time = new DbField('employee_overtime', 'employee_overtime', 'x_end_time', 'end_time', '`end_time`', CastDateFieldForLike('`end_time`', 0, "DB"), 135, 0, FALSE, '`end_time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// category
		$this->category = new DbField('employee_overtime', 'employee_overtime', 'x_category', 'category', '`category`', '`category`', 20, -1, FALSE, '`category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// project
		$this->project = new DbField('employee_overtime', 'employee_overtime', 'x_project', 'project', '`project`', '`project`', 20, -1, FALSE, '`project`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// notes
		$this->notes = new DbField('employee_overtime', 'employee_overtime', 'x_notes', 'notes', '`notes`', '`notes`', 201, -1, FALSE, '`notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->notes->Sortable = TRUE; // Allow sort
		$this->fields['notes'] = &$this->notes;

		// created
		$this->created = new DbField('employee_overtime', 'employee_overtime', 'x_created', 'created', '`created`', CastDateFieldForLike('`created`', 0, "DB"), 135, 0, FALSE, '`created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated
		$this->updated = new DbField('employee_overtime', 'employee_overtime', 'x_updated', 'updated', '`updated`', CastDateFieldForLike('`updated`', 0, "DB"), 135, 0, FALSE, '`updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('employee_overtime', 'employee_overtime', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_overtimelist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_overtimeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_overtimeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_overtimeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_overtimeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_overtimeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_overtimeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_overtimeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_overtimeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_overtimedelete.php", $this->getUrlParm());
	}
