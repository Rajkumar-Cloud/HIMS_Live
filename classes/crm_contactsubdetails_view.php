 ...
 * Page class
 */
class crm_contactsubdetails_view extends crm_contactsubdetails
{
	...
	// Page object name
	public $PageObjName = "crm_contactsubdetails_view";
	...
	public function __construct()
	{
		...
		if (Get("contactsubscriptionid") !== NULL) {
			$this->RecKey["contactsubscriptionid"] = Get("contactsubscriptionid");
			$keyUrl .= "&amp;contactsubscriptionid=" . urlencode($this->RecKey["contactsubscriptionid"]);
		}
	...
	public function run()
	{
		...
		if (Get("contactsubscriptionid") !== NULL) {
			if ($ExportFileName <> "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("contactsubscriptionid");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("contactsubscriptionid") !== NULL) {
				...
				$this->RecKey["contactsubscriptionid"] = $this->contactsubscriptionid->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->contactsubscriptionid->setQueryStringValue(Key(0));
				$this->RecKey["contactsubscriptionid"] = $this->contactsubscriptionid->QueryStringValue;
			} elseif (Post("contactsubscriptionid") !== NULL) {
				$this->contactsubscriptionid->setFormValue(Post("contactsubscriptionid"));
				$this->RecKey["contactsubscriptionid"] = $this->contactsubscriptionid->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->contactsubscriptionid->setFormValue(Route(2));
				$this->RecKey["contactsubscriptionid"] = $this->contactsubscriptionid->FormValue;
			} else {
				$returnUrl = "crm_contactsubdetailslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "crm_contactsubdetailslist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "crm_contactsubdetailslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fcrm_contactsubdetailsview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fcrm_contactsubdetailsview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fcrm_contactsubdetailsview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
