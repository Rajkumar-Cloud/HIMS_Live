 ...
 * Page class
 */
class pharmacy_billing_issue_delete extends pharmacy_billing_issue
{
	...
	// Page object name
	public $PageObjName = "pharmacy_billing_issue_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_billing_issuelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_billing_issuelist.php"); // Return to list
			}
		}
	}
