 ...
 * Page class
 */
class employee_email_preview extends employee_email
{
	...
	// Page object name
	public $PageObjName = "employee_email_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'employee_email');
			if ($Security->isLoggedIn())
