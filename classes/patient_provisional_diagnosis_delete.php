 ...
 * Page class
 */
class patient_provisional_diagnosis_delete extends patient_provisional_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_provisional_diagnosis_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_provisional_diagnosislist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_provisional_diagnosislist.php"); // Return to list
			}
		}
	}
