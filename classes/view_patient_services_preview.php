...
class view_patient_services_preview extends view_patient_services
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_billing_voucher") {
			$url = "" . TABLE_SHOW_MASTER . "=view_billing_voucher&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		if ($masterTblVar == "view_billing_voucher_print") {
			$url = "" . TABLE_SHOW_MASTER . "=view_billing_voucher_print&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		return $url;
	}
