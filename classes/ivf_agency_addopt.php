 ...
 * Page class
 */
class ivf_agency_addopt extends ivf_agency
{
	...
	// Page object name
	public $PageObjName = "ivf_agency_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->Pin->IsDetailKey) {
			$this->Pin->setFormValue(ConvertFromUtf8($val));
		}
	...
	public function restoreFormValues()
	{
		...
		$this->Pin->CurrentValue = ConvertToUtf8($this->Pin->FormValue);
	}
