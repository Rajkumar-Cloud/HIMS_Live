 ...
 * Page class
 */
class employee_projects_edit extends employee_projects
{
	...
	// Page object name
	public $PageObjName = "employee_projects_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("employee_projectslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "employee_projectslist.php")
