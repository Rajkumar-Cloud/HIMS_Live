 ...
 * Page class
 */
class pres_trade_combination_names_delete extends pres_trade_combination_names
{
	...
	// Page object name
	public $PageObjName = "pres_trade_combination_names_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pres_trade_combination_nameslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pres_trade_combination_nameslist.php"); // Return to list
			}
		}
	}
