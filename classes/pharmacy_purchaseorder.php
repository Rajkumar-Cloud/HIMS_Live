...
class pharmacy_purchaseorder extends DbTable
{
	...
	public function __construct()
	{
		...
		// ORDNO
		$this->ORDNO = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, -1, FALSE, '`ORDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ORDNO->Sortable = TRUE; // Allow sort
		$this->fields['ORDNO'] = &$this->ORDNO;

		// PRC
		$this->PRC = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`EV__PRC`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// QTY
		$this->QTY = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 3, -1, FALSE, '`QTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QTY->Sortable = TRUE; // Allow sort
		$this->QTY->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['QTY'] = &$this->QTY;

		// DT
		$this->DT = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 0, "DB"), 135, 0, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PC
		$this->PC = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// YM
		$this->YM = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_YM', 'YM', '`YM`', '`YM`', 200, -1, FALSE, '`YM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->YM->Sortable = TRUE; // Allow sort
		$this->fields['YM'] = &$this->YM;

		// MFRCODE
		$this->MFRCODE = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// Stock
		$this->Stock = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 3, -1, FALSE, '`Stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastMonthSale
		$this->LastMonthSale = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_LastMonthSale', 'LastMonthSale', '`LastMonthSale`', '`LastMonthSale`', 3, -1, FALSE, '`LastMonthSale`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Printcheck
		$this->Printcheck = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Printcheck', 'Printcheck', '`Printcheck`', '`Printcheck`', 200, -1, FALSE, '`Printcheck`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Printcheck->Sortable = TRUE; // Allow sort
		$this->fields['Printcheck'] = &$this->Printcheck;

		// id
		$this->id = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// poid
		$this->poid = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_poid', 'poid', '`poid`', '`poid`', 3, -1, FALSE, '`poid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grnid
		$this->grnid = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grnid', 'grnid', '`grnid`', '`grnid`', 3, -1, FALSE, '`grnid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BatchNo
		$this->BatchNo = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, -1, FALSE, '`BatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchNo->Sortable = TRUE; // Allow sort
		$this->fields['BatchNo'] = &$this->BatchNo;

		// ExpDate
		$this->ExpDate = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike('`ExpDate`', 0, "DB"), 135, 0, FALSE, '`ExpDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrName
		$this->PrName = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, -1, FALSE, '`PrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PrName->Sortable = TRUE; // Allow sort
		$this->fields['PrName'] = &$this->PrName;

		// Quantity
		$this->Quantity = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Quantity'] = &$this->Quantity;

		// FreeQty
		$this->FreeQty = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 3, -1, FALSE, '`FreeQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ItemValue
		$this->ItemValue = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_ItemValue', 'ItemValue', '`ItemValue`', '`ItemValue`', 131, -1, FALSE, '`ItemValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Disc
		$this->Disc = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, -1, FALSE, '`Disc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Disc->Sortable = TRUE; // Allow sort
		$this->Disc->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Disc'] = &$this->Disc;

		// PTax
		$this->PTax = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PTax', 'PTax', '`PTax`', '`PTax`', 131, -1, FALSE, '`PTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PTax->Sortable = TRUE; // Allow sort
		$this->PTax->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['PTax'] = &$this->PTax;

		// MRP
		$this->MRP = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// SalTax
		$this->SalTax = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_SalTax', 'SalTax', '`SalTax`', '`SalTax`', 131, -1, FALSE, '`SalTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurValue
		$this->PurValue = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurRate
		$this->PurRate = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, -1, FALSE, '`PurRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalRate
		$this->SalRate = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, -1, FALSE, '`SalRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Discount
		$this->Discount = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PSGST
		$this->PSGST = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PSGST->Sortable = TRUE; // Allow sort
		$this->fields['PSGST'] = &$this->PSGST;

		// PCGST
		$this->PCGST = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PCGST->Sortable = TRUE; // Allow sort
		$this->fields['PCGST'] = &$this->PCGST;

		// SSGST
		$this->SSGST = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SSGST->Sortable = TRUE; // Allow sort
		$this->fields['SSGST'] = &$this->SSGST;

		// SCGST
		$this->SCGST = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SCGST->Sortable = TRUE; // Allow sort
		$this->fields['SCGST'] = &$this->SCGST;

		// BRCODE
		$this->BRCODE = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HSN
		$this->HSN = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, -1, FALSE, '`HSN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HSN->Sortable = TRUE; // Allow sort
		$this->fields['HSN'] = &$this->HSN;

		// Pack
		$this->Pack = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Pack', 'Pack', '`Pack`', '`Pack`', 200, -1, FALSE, '`Pack`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pack->Sortable = TRUE; // Allow sort
		$this->fields['Pack'] = &$this->Pack;

		// PUnit
		$this->PUnit = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, -1, FALSE, '`PUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SUnit
		$this->SUnit = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, -1, FALSE, '`SUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GrnQuantity
		$this->GrnQuantity = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 3, -1, FALSE, '`GrnQuantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GrnMRP
		$this->GrnMRP = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_GrnMRP', 'GrnMRP', '`GrnMRP`', '`GrnMRP`', 131, -1, FALSE, '`GrnMRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// trid
		$this->trid = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_trid', 'trid', '`trid`', '`trid`', 3, -1, FALSE, '`trid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// CreatedBy
		$this->CreatedBy = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->CreatedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedDateTime->Sortable = TRUE; // Allow sort
		$this->CreatedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['CreatedDateTime'] = &$this->CreatedDateTime;

		// ModifiedBy
		$this->ModifiedBy = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->ModifiedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike('`ModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedDateTime->Sortable = TRUE; // Allow sort
		$this->ModifiedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['ModifiedDateTime'] = &$this->ModifiedDateTime;

		// grncreatedby
		$this->grncreatedby = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grncreatedby', 'grncreatedby', '`grncreatedby`', '`grncreatedby`', 3, -1, FALSE, '`grncreatedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grncreatedDateTime
		$this->grncreatedDateTime = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grncreatedDateTime', 'grncreatedDateTime', '`grncreatedDateTime`', CastDateFieldForLike('`grncreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`grncreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grnModifiedby
		$this->grnModifiedby = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grnModifiedby', 'grnModifiedby', '`grnModifiedby`', '`grnModifiedby`', 3, -1, FALSE, '`grnModifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grnModifiedDateTime
		$this->grnModifiedDateTime = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grnModifiedDateTime', 'grnModifiedDateTime', '`grnModifiedDateTime`', CastDateFieldForLike('`grnModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`grnModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Received
		$this->Received = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Received', 'Received', '`Received`', '`Received`', 200, -1, FALSE, '`Received`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// BillDate
		$this->BillDate = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike('`BillDate`', 0, "DB"), 135, 0, FALSE, '`BillDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CurStock
		$this->CurStock = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_CurStock', 'CurStock', '`CurStock`', '`CurStock`', 3, -1, FALSE, '`CurStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grndate
		$this->grndate = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grndate', 'grndate', '`grndate`', CastDateFieldForLike('`grndate`', 0, "DB"), 133, 0, FALSE, '`grndate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// grndatetime
		$this->grndatetime = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grndatetime', 'grndatetime', '`grndatetime`', CastDateFieldForLike('`grndatetime`', 0, "DB"), 135, 0, FALSE, '`grndatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// strid
		$this->strid = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_strid', 'strid', '`strid`', '`strid`', 3, -1, FALSE, '`strid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GRNPer
		$this->GRNPer = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_GRNPer', 'GRNPer', '`GRNPer`', '`GRNPer`', 131, -1, FALSE, '`GRNPer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FreeQtyyy
		$this->FreeQtyyy = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_FreeQtyyy', 'FreeQtyyy', '`FreeQtyyy`', '`FreeQtyyy`', 3, -1, FALSE, '`FreeQtyyy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_purchaseorderview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($this->getCurrentMasterTable() == "pharmacy_po" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
