...
class view_billing_voucher extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// createddatetime
		$this->createddatetime = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 7, "DB"), 135, 7, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillNumber
		$this->BillNumber = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, -1, FALSE, '`BillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillNumber->Sortable = TRUE; // Allow sort
		$this->fields['BillNumber'] = &$this->BillNumber;

		// Reception
		$this->Reception = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientId
		$this->PatientId = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// mrnno
		$this->mrnno = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// PatientName
		$this->PatientName = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Required = TRUE; // Required field
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Age
		$this->Age = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// profilePic
		$this->profilePic = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// Mobile
		$this->Mobile = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, -1, FALSE, '`Mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mobile->Sortable = TRUE; // Allow sort
		$this->fields['Mobile'] = &$this->Mobile;

		// IP_OP
		$this->IP_OP = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_IP_OP', 'IP_OP', '`IP_OP`', '`IP_OP`', 200, -1, FALSE, '`IP_OP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IP_OP->Sortable = TRUE; // Allow sort
		$this->fields['IP_OP'] = &$this->IP_OP;

		// Doctor
		$this->Doctor = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, -1, FALSE, '`Doctor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Doctor->Sortable = TRUE; // Allow sort
		$this->fields['Doctor'] = &$this->Doctor;

		// voucher_type
		$this->voucher_type = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, -1, FALSE, '`voucher_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->voucher_type->Sortable = TRUE; // Allow sort
		$this->fields['voucher_type'] = &$this->voucher_type;

		// Details
		$this->Details = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Details', 'Details', '`Details`', '`Details`', 200, -1, FALSE, '`Details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Details->Sortable = TRUE; // Allow sort
		$this->fields['Details'] = &$this->Details;

		// ModeofPayment
		$this->ModeofPayment = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, -1, FALSE, '`ModeofPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Amount
		$this->Amount = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AnyDues
		$this->AnyDues = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_AnyDues', 'AnyDues', '`AnyDues`', '`AnyDues`', 200, -1, FALSE, '`AnyDues`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AnyDues->Sortable = TRUE; // Allow sort
		$this->fields['AnyDues'] = &$this->AnyDues;

		// DiscountAmount
		$this->DiscountAmount = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_DiscountAmount', 'DiscountAmount', '`DiscountAmount`', '`DiscountAmount`', 131, -1, FALSE, '`DiscountAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdby
		$this->createdby = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// modifiedby
		$this->modifiedby = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// RealizationAmount
		$this->RealizationAmount = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RealizationAmount', 'RealizationAmount', '`RealizationAmount`', '`RealizationAmount`', 131, -1, FALSE, '`RealizationAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RealizationStatus
		$this->RealizationStatus = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RealizationStatus', 'RealizationStatus', '`RealizationStatus`', '`RealizationStatus`', 200, -1, FALSE, '`RealizationStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationStatus->Sortable = TRUE; // Allow sort
		$this->fields['RealizationStatus'] = &$this->RealizationStatus;

		// RealizationRemarks
		$this->RealizationRemarks = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RealizationRemarks', 'RealizationRemarks', '`RealizationRemarks`', '`RealizationRemarks`', 200, -1, FALSE, '`RealizationRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationRemarks->Sortable = TRUE; // Allow sort
		$this->fields['RealizationRemarks'] = &$this->RealizationRemarks;

		// RealizationBatchNo
		$this->RealizationBatchNo = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RealizationBatchNo', 'RealizationBatchNo', '`RealizationBatchNo`', '`RealizationBatchNo`', 200, -1, FALSE, '`RealizationBatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationBatchNo->Sortable = TRUE; // Allow sort
		$this->fields['RealizationBatchNo'] = &$this->RealizationBatchNo;

		// RealizationDate
		$this->RealizationDate = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RealizationDate', 'RealizationDate', '`RealizationDate`', '`RealizationDate`', 200, -1, FALSE, '`RealizationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RealizationDate->Sortable = TRUE; // Allow sort
		$this->fields['RealizationDate'] = &$this->RealizationDate;

		// HospID
		$this->HospID = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// RIDNO
		$this->RIDNO = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNO->Sortable = TRUE; // Allow sort
		$this->RIDNO->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNO'] = &$this->RIDNO;

		// TidNo
		$this->TidNo = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CId
		$this->CId = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CId', 'CId', '`CId`', '`CId`', 3, -1, FALSE, '`CId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PartnerName
		$this->PartnerName = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, -1, FALSE, '`PartnerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerName->Sortable = TRUE; // Allow sort
		$this->fields['PartnerName'] = &$this->PartnerName;

		// PayerType
		$this->PayerType = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PayerType', 'PayerType', '`PayerType`', '`PayerType`', 200, -1, FALSE, '`PayerType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PayerType->Sortable = TRUE; // Allow sort
		$this->fields['PayerType'] = &$this->PayerType;

		// Dob
		$this->Dob = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Dob', 'Dob', '`Dob`', '`Dob`', 200, -1, FALSE, '`Dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dob->Sortable = TRUE; // Allow sort
		$this->fields['Dob'] = &$this->Dob;

		// Currency
		$this->Currency = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, -1, FALSE, '`Currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Currency->Sortable = TRUE; // Allow sort
		$this->fields['Currency'] = &$this->Currency;

		// DiscountRemarks
		$this->DiscountRemarks = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 201, -1, FALSE, '`DiscountRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DiscountRemarks->Sortable = TRUE; // Allow sort
		$this->fields['DiscountRemarks'] = &$this->DiscountRemarks;

		// Remarks
		$this->Remarks = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// PatId
		$this->PatId = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, -1, FALSE, '`PatId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DrDepartment
		$this->DrDepartment = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_DrDepartment', 'DrDepartment', '`DrDepartment`', '`DrDepartment`', 200, -1, FALSE, '`DrDepartment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DrDepartment->Sortable = TRUE; // Allow sort
		$this->fields['DrDepartment'] = &$this->DrDepartment;

		// RefferedBy
		$this->RefferedBy = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, -1, FALSE, '`RefferedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CardNumber
		$this->CardNumber = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, -1, FALSE, '`CardNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CardNumber->Sortable = TRUE; // Allow sort
		$this->fields['CardNumber'] = &$this->CardNumber;

		// BankName
		$this->BankName = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, -1, FALSE, '`BankName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankName->Sortable = TRUE; // Allow sort
		$this->fields['BankName'] = &$this->BankName;

		// DrID
		$this->DrID = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, -1, FALSE, '`DrID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// BillStatus
		$this->BillStatus = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, -1, FALSE, '`BillStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReportHeader
		$this->ReportHeader = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, -1, FALSE, '`ReportHeader`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// UserName
		$this->UserName = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UserName->Sortable = TRUE; // Allow sort
		$this->fields['UserName'] = &$this->UserName;

		// AdjustmentAdvance
		$this->AdjustmentAdvance = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_AdjustmentAdvance', 'AdjustmentAdvance', '`AdjustmentAdvance`', '`AdjustmentAdvance`', 200, -1, FALSE, '`AdjustmentAdvance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// billing_vouchercol
		$this->billing_vouchercol = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_billing_vouchercol', 'billing_vouchercol', '`billing_vouchercol`', '`billing_vouchercol`', 200, -1, FALSE, '`billing_vouchercol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->billing_vouchercol->Sortable = TRUE; // Allow sort
		$this->fields['billing_vouchercol'] = &$this->billing_vouchercol;

		// BillType
		$this->BillType = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, -1, FALSE, '`BillType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// ProcedureName
		$this->ProcedureName = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_ProcedureName', 'ProcedureName', '`ProcedureName`', '`ProcedureName`', 200, -1, FALSE, '`ProcedureName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProcedureName->Sortable = TRUE; // Allow sort
		$this->fields['ProcedureName'] = &$this->ProcedureName;

		// ProcedureAmount
		$this->ProcedureAmount = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_ProcedureAmount', 'ProcedureAmount', '`ProcedureAmount`', '`ProcedureAmount`', 131, -1, FALSE, '`ProcedureAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IncludePackage
		$this->IncludePackage = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_IncludePackage', 'IncludePackage', '`IncludePackage`', '`IncludePackage`', 200, -1, FALSE, '`IncludePackage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// CancelBill
		$this->CancelBill = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelBill', 'CancelBill', '`CancelBill`', '`CancelBill`', 200, -1, FALSE, '`CancelBill`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CancelReason
		$this->CancelReason = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelReason', 'CancelReason', '`CancelReason`', '`CancelReason`', 201, -1, FALSE, '`CancelReason`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->CancelReason->Sortable = TRUE; // Allow sort
		$this->fields['CancelReason'] = &$this->CancelReason;

		// CancelModeOfPayment
		$this->CancelModeOfPayment = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelModeOfPayment', 'CancelModeOfPayment', '`CancelModeOfPayment`', '`CancelModeOfPayment`', 200, -1, FALSE, '`CancelModeOfPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CancelModeOfPayment->Sortable = TRUE; // Allow sort
		$this->fields['CancelModeOfPayment'] = &$this->CancelModeOfPayment;

		// CancelAmount
		$this->CancelAmount = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelAmount', 'CancelAmount', '`CancelAmount`', '`CancelAmount`', 200, -1, FALSE, '`CancelAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CancelAmount->Sortable = TRUE; // Allow sort
		$this->fields['CancelAmount'] = &$this->CancelAmount;

		// CancelBankName
		$this->CancelBankName = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelBankName', 'CancelBankName', '`CancelBankName`', '`CancelBankName`', 200, -1, FALSE, '`CancelBankName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CancelBankName->Sortable = TRUE; // Allow sort
		$this->fields['CancelBankName'] = &$this->CancelBankName;

		// CancelTransactionNumber
		$this->CancelTransactionNumber = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelTransactionNumber', 'CancelTransactionNumber', '`CancelTransactionNumber`', '`CancelTransactionNumber`', 200, -1, FALSE, '`CancelTransactionNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CancelTransactionNumber->Sortable = TRUE; // Allow sort
		$this->fields['CancelTransactionNumber'] = &$this->CancelTransactionNumber;

		// LabTest
		$this->LabTest = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_LabTest', 'LabTest', '`LabTest`', '`LabTest`', 200, -1, FALSE, '`LabTest`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LabTest->Sortable = TRUE; // Allow sort
		$this->fields['LabTest'] = &$this->LabTest;

		// sid
		$this->sid = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_sid', 'sid', '`sid`', '`sid`', 3, -1, FALSE, '`sid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sid->Sortable = TRUE; // Allow sort
		$this->sid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['sid'] = &$this->sid;

		// SidNo
		$this->SidNo = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_SidNo', 'SidNo', '`SidNo`', '`SidNo`', 200, -1, FALSE, '`SidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SidNo->Sortable = TRUE; // Allow sort
		$this->fields['SidNo'] = &$this->SidNo;

		// createdDatettime
		$this->createdDatettime = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_createdDatettime', 'createdDatettime', '`createdDatettime`', CastDateFieldForLike('`createdDatettime`', 0, "DB"), 135, 0, FALSE, '`createdDatettime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillClosing
		$this->BillClosing = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_BillClosing', 'BillClosing', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// GoogleReviewID
		$this->GoogleReviewID = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_GoogleReviewID', 'GoogleReviewID', '`GoogleReviewID`', '`GoogleReviewID`', 200, -1, FALSE, '`GoogleReviewID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// CardType
		$this->CardType = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CardType', 'CardType', '`CardType`', '`CardType`', 200, -1, FALSE, '`CardType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// PharmacyBill
		$this->PharmacyBill = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PharmacyBill', 'PharmacyBill', '`PharmacyBill`', '`PharmacyBill`', 200, -1, FALSE, '`PharmacyBill`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// cash
		$this->cash = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_cash', 'cash', '`cash`', '`cash`', 131, -1, FALSE, '`cash`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cash->Sortable = TRUE; // Allow sort
		$this->cash->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['cash'] = &$this->cash;

		// Card
		$this->Card = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Card', 'Card', '`Card`', '`Card`', 131, -1, FALSE, '`Card`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_patient_services") {
			$detailUrl = $GLOBALS["view_patient_services"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_billing_voucherview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_billing_voucheredit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_billing_voucheradd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
