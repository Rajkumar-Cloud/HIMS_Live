 ...
 * Page class
 */
class depositdetails_edit extends depositdetails
{
	...
	// Page object name
	public $PageObjName = "depositdetails_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// DepositDate
			$this->DepositDate->setDbValueDef($rsnew, UnFormatDateTime($this->DepositDate->CurrentValue, 7), NULL, $this->DepositDate->ReadOnly);
			...
			// ManualCash
			$this->ManualCash->setDbValueDef($rsnew, $this->ManualCash->CurrentValue, NULL, $this->ManualCash->ReadOnly);

			// ManualCard
			$this->ManualCard->setDbValueDef($rsnew, $this->ManualCard->CurrentValue, NULL, $this->ManualCard->ReadOnly);
