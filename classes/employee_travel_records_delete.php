 ...
 * Page class
 */
class employee_travel_records_delete extends employee_travel_records
{
	...
	// Page object name
	public $PageObjName = "employee_travel_records_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_travel_recordslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_travel_recordslist.php"); // Return to list
			}
		}
	}
