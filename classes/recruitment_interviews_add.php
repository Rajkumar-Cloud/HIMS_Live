 ...
 * Page class
 */
class recruitment_interviews_add extends recruitment_interviews
{
	...
	// Page object name
	public $PageObjName = "recruitment_interviews_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "recruitment_interviewsview.php")
