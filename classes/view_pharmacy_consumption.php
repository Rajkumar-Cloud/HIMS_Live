...
class view_pharmacy_consumption extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PRC
		$this->PRC = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// DES
		$this->DES = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_DES', 'DES', '`DES`', '`DES`', 200, -1, FALSE, '`DES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DES->Sortable = TRUE; // Allow sort
		$this->fields['DES'] = &$this->DES;

		// BATCH
		$this->BATCH = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, -1, FALSE, '`BATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCH->Sortable = TRUE; // Allow sort
		$this->fields['BATCH'] = &$this->BATCH;

		// OQ
		$this->OQ = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, -1, FALSE, '`OQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OQ->Sortable = FALSE; // Allow sort
		$this->OQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['OQ'] = &$this->OQ;

		// Stock
		$this->Stock = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, -1, FALSE, '`Stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EXPDT
		$this->EXPDT = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BILLDATE
		$this->BILLDATE = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike('`BILLDATE`', 0, "DB"), 135, 0, FALSE, '`BILLDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GENNAME
		$this->GENNAME = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, -1, FALSE, '`GENNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GENNAME->Sortable = FALSE; // Allow sort
		$this->fields['GENNAME'] = &$this->GENNAME;

		// UNIT
		$this->UNIT = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, -1, FALSE, '`UNIT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UNIT->Sortable = FALSE; // Allow sort
		$this->fields['UNIT'] = &$this->UNIT;

		// RT
		$this->RT = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_RT', 'RT', '`RT`', '`RT`', 131, -1, FALSE, '`RT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RT->Sortable = FALSE; // Allow sort
		$this->RT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RT'] = &$this->RT;

		// SSGST
		$this->SSGST = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SCGST
		$this->SCGST = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MFRCODE
		$this->MFRCODE = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = FALSE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// Select
		$this->Select = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_Select', 'Select', '`Select`', '`Select`', 200, -1, FALSE, '`Select`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// ConsQTY
		$this->ConsQTY = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_ConsQTY', 'ConsQTY', '`ConsQTY`', '`ConsQTY`', 200, -1, FALSE, '`ConsQTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_pharmacy_consumptionview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
