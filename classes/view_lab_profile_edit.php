 ...
 * Page class
 */
class view_lab_profile_edit extends view_lab_profile
{
	...
	// Page object name
	public $PageObjName = "view_lab_profile_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("lab_profile_details", $detailTblVar) && $GLOBALS["lab_profile_details"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("lab_profile_details", $detailTblVar) && $GLOBALS["lab_profile_details"]->DetailEdit) {
						...
						$editRow = $GLOBALS["lab_profile_details_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("lab_profile_details", $detailTblVar)) {
				...
				if ($GLOBALS["lab_profile_details_grid"]->DetailEdit) {
					$GLOBALS["lab_profile_details_grid"]->CurrentMode = "edit";
					$GLOBALS["lab_profile_details_grid"]->CurrentAction = "gridedit";
