 ...
 * Page class
 */
class mas_reference_type_delete extends mas_reference_type
{
	...
	// Page object name
	public $PageObjName = "mas_reference_type_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("mas_reference_typelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("mas_reference_typelist.php"); // Return to list
			}
		}
	}
