 ...
 * Page class
 */
class hr_leaveperiods_add extends hr_leaveperiods
{
	...
	// Page object name
	public $PageObjName = "hr_leaveperiods_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "hr_leaveperiodsview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->status->CurrentValue = "Inactive";
