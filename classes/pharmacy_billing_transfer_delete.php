 ...
 * Page class
 */
class pharmacy_billing_transfer_delete extends pharmacy_billing_transfer
{
	...
	// Page object name
	public $PageObjName = "pharmacy_billing_transfer_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_billing_transferlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_billing_transferlist.php"); // Return to list
			}
		}
	}
