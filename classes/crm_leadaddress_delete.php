 ...
 * Page class
 */
class crm_leadaddress_delete extends crm_leadaddress
{
	...
	// Page object name
	public $PageObjName = "crm_leadaddress_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("crm_leadaddresslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("crm_leadaddresslist.php"); // Return to list
			}
		}
	}
