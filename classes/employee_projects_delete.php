 ...
 * Page class
 */
class employee_projects_delete extends employee_projects
{
	...
	// Page object name
	public $PageObjName = "employee_projects_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_projectslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_projectslist.php"); // Return to list
			}
		}
	}
