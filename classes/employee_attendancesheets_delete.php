 ...
 * Page class
 */
class employee_attendancesheets_delete extends employee_attendancesheets
{
	...
	// Page object name
	public $PageObjName = "employee_attendancesheets_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_attendancesheetslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_attendancesheetslist.php"); // Return to list
			}
		}
	}
