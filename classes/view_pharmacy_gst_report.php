 ...
 */
class view_pharmacy_gst_report extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// DATE
		$this->DATE = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_DATE', 'DATE', '`DATE`', CastDateFieldForLike('`DATE`', 0, "DB"), 133, 0, FALSE, '`DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillNumber
		$this->BillNumber = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, -1, FALSE, '`BillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillNumber->Sortable = TRUE; // Allow sort
		$this->fields['BillNumber'] = &$this->BillNumber;

		// PatientId
		$this->PatientId = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// PatientName
		$this->PatientName = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Product
		$this->Product = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_Product', 'Product', '`Product`', '`Product`', 200, -1, FALSE, '`Product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product->Sortable = TRUE; // Allow sort
		$this->fields['Product'] = &$this->Product;

		// HSN
		$this->HSN = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, -1, FALSE, '`HSN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HSN->Sortable = TRUE; // Allow sort
		$this->fields['HSN'] = &$this->HSN;

		// QTY
		$this->QTY = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 200, -1, FALSE, '`QTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QTY->Sortable = TRUE; // Allow sort
		$this->fields['QTY'] = &$this->QTY;

		// Amount
		$this->Amount = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 200, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->fields['Amount'] = &$this->Amount;

		// TaxableAmount
		$this->TaxableAmount = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_TaxableAmount', 'TaxableAmount', '`TaxableAmount`', '`TaxableAmount`', 200, -1, FALSE, '`TaxableAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TaxableAmount->Sortable = TRUE; // Allow sort
		$this->fields['TaxableAmount'] = &$this->TaxableAmount;

		// SGST
		$this->SGST = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_SGST', 'SGST', '`SGST`', '`SGST`', 200, -1, FALSE, '`SGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SGST->Sortable = TRUE; // Allow sort
		$this->fields['SGST'] = &$this->SGST;

		// CGST
		$this->CGST = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_CGST', 'CGST', '`CGST`', '`CGST`', 200, -1, FALSE, '`CGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CGST->Sortable = TRUE; // Allow sort
		$this->fields['CGST'] = &$this->CGST;

		// RateOfTax
		$this->RateOfTax = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_RateOfTax', 'RateOfTax', '`RateOfTax`', '`RateOfTax`', 200, -1, FALSE, '`RateOfTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RateOfTax->Sortable = TRUE; // Allow sort
		$this->fields['RateOfTax'] = &$this->RateOfTax;

		// Total
		$this->Total = new DbField('view_pharmacy_gst_report', 'view_pharmacy_gst_report', 'x_Total', 'Total', '`Total`', '`Total`', 200, -1, FALSE, '`Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_gst_reportlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_gst_reportview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_gst_reportedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_gst_reportadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_gst_reportview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_gst_reportview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_gst_reportadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_gst_reportadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_gst_reportedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_gst_reportadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_gst_reportdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->TaxableAmount->setDbValue($rs->fields('TaxableAmount'));
		$this->SGST->setDbValue($rs->fields('SGST'));
		$this->CGST->setDbValue($rs->fields('CGST'));
		$this->RateOfTax->setDbValue($rs->fields('RateOfTax'));
