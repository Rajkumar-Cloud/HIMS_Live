 ...
 * Page class
 */
class crm_contactsubdetails_delete extends crm_contactsubdetails
{
	...
	// Page object name
	public $PageObjName = "crm_contactsubdetails_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("crm_contactsubdetailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("crm_contactsubdetailslist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['contactsubscriptionid'];
