 ...
 */
class ivf_treatment_plan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNO
		$this->RIDNO = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->IsForeignKey = TRUE; // Foreign key field
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// TreatmentStartDate
		$this->TreatmentStartDate = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TreatmentStartDate', 'TreatmentStartDate', '`TreatmentStartDate`', CastDateFieldForLike('`TreatmentStartDate`', 7, "DB"), 135, 7, FALSE, '`TreatmentStartDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Age
		$this->Age = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// treatment_status
		$this->treatment_status = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_treatment_status', 'treatment_status', '`treatment_status`', '`treatment_status`', 200, -1, FALSE, '`treatment_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ARTCYCLE
		$this->ARTCYCLE = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_ARTCYCLE', 'ARTCYCLE', '`ARTCYCLE`', '`ARTCYCLE`', 200, -1, FALSE, '`ARTCYCLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// IVFCycleNO
		$this->IVFCycleNO = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_IVFCycleNO', 'IVFCycleNO', '`IVFCycleNO`', '`IVFCycleNO`', 200, -1, FALSE, '`IVFCycleNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IVFCycleNO->Sortable = TRUE; // Allow sort
		$this->fields['IVFCycleNO'] = &$this->IVFCycleNO;

		// RESULT
		$this->RESULT = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_RESULT', 'RESULT', '`RESULT`', '`RESULT`', 200, -1, FALSE, '`RESULT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status
		$this->status = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// TreatementStopDate
		$this->TreatementStopDate = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TreatementStopDate', 'TreatementStopDate', '`TreatementStopDate`', CastDateFieldForLike('`TreatementStopDate`', 7, "DB"), 135, 7, FALSE, '`TreatementStopDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TypePatient
		$this->TypePatient = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TypePatient', 'TypePatient', '`TypePatient`', '`TypePatient`', 200, -1, FALSE, '`TypePatient`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TypePatient->Sortable = TRUE; // Allow sort
		$this->fields['TypePatient'] = &$this->TypePatient;

		// Treatment
		$this->Treatment = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 200, -1, FALSE, '`Treatment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TreatmentTec
		$this->TreatmentTec = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TreatmentTec', 'TreatmentTec', '`TreatmentTec`', '`TreatmentTec`', 200, -1, FALSE, '`TreatmentTec`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TreatmentTec->Sortable = TRUE; // Allow sort
		$this->fields['TreatmentTec'] = &$this->TreatmentTec;

		// TypeOfCycle
		$this->TypeOfCycle = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TypeOfCycle', 'TypeOfCycle', '`TypeOfCycle`', '`TypeOfCycle`', 200, -1, FALSE, '`TypeOfCycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// SpermOrgin
		$this->SpermOrgin = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_SpermOrgin', 'SpermOrgin', '`SpermOrgin`', '`SpermOrgin`', 200, -1, FALSE, '`SpermOrgin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// State
		$this->State = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Origin
		$this->Origin = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Origin', 'Origin', '`Origin`', '`Origin`', 200, -1, FALSE, '`Origin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// MACS
		$this->MACS = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, -1, FALSE, '`MACS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// Technique
		$this->Technique = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Technique', 'Technique', '`Technique`', '`Technique`', 200, -1, FALSE, '`Technique`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Technique->Sortable = TRUE; // Allow sort
		$this->fields['Technique'] = &$this->Technique;

		// PgdPlanning
		$this->PgdPlanning = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_PgdPlanning', 'PgdPlanning', '`PgdPlanning`', '`PgdPlanning`', 200, -1, FALSE, '`PgdPlanning`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// IMSI
		$this->IMSI = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_IMSI', 'IMSI', '`IMSI`', '`IMSI`', 200, -1, FALSE, '`IMSI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMSI->Sortable = TRUE; // Allow sort
		$this->fields['IMSI'] = &$this->IMSI;

		// SequentialCulture
		$this->SequentialCulture = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_SequentialCulture', 'SequentialCulture', '`SequentialCulture`', '`SequentialCulture`', 200, -1, FALSE, '`SequentialCulture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SequentialCulture->Sortable = TRUE; // Allow sort
		$this->fields['SequentialCulture'] = &$this->SequentialCulture;

		// TimeLapse
		$this->TimeLapse = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TimeLapse', 'TimeLapse', '`TimeLapse`', '`TimeLapse`', 200, -1, FALSE, '`TimeLapse`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TimeLapse->Sortable = TRUE; // Allow sort
		$this->fields['TimeLapse'] = &$this->TimeLapse;

		// AH
		$this->AH = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_AH', 'AH', '`AH`', '`AH`', 200, -1, FALSE, '`AH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AH->Sortable = TRUE; // Allow sort
		$this->fields['AH'] = &$this->AH;

		// Weight
		$this->Weight = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Weight', 'Weight', '`Weight`', '`Weight`', 200, -1, FALSE, '`Weight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Weight->Sortable = TRUE; // Allow sort
		$this->fields['Weight'] = &$this->Weight;

		// BMI
		$this->BMI = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_BMI', 'BMI', '`BMI`', '`BMI`', 200, -1, FALSE, '`BMI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BMI->Sortable = TRUE; // Allow sort
		$this->fields['BMI'] = &$this->BMI;

		// MaleIndications
		$this->MaleIndications = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_MaleIndications', 'MaleIndications', '`MaleIndications`', '`MaleIndications`', 200, -1, FALSE, '`MaleIndications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// FemaleIndications
		$this->FemaleIndications = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_FemaleIndications', 'FemaleIndications', '`FemaleIndications`', '`FemaleIndications`', 200, -1, FALSE, '`FemaleIndications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// UseOfThe
		$this->UseOfThe = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_UseOfThe', 'UseOfThe', '`UseOfThe`', '`UseOfThe`', 200, -1, FALSE, '`UseOfThe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UseOfThe->Sortable = TRUE; // Allow sort
		$this->fields['UseOfThe'] = &$this->UseOfThe;

		// Ectopic
		$this->Ectopic = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Ectopic', 'Ectopic', '`Ectopic`', '`Ectopic`', 200, -1, FALSE, '`Ectopic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Ectopic->Sortable = TRUE; // Allow sort
		$this->fields['Ectopic'] = &$this->Ectopic;

		// Heterotopic
		$this->Heterotopic = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Heterotopic', 'Heterotopic', '`Heterotopic`', '`Heterotopic`', 200, -1, FALSE, '`Heterotopic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TransferDFE
		$this->TransferDFE = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TransferDFE', 'TransferDFE', '`TransferDFE`', '`TransferDFE`', 200, -1, FALSE, '`TransferDFE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Evolutive
		$this->Evolutive = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Evolutive', 'Evolutive', '`Evolutive`', '`Evolutive`', 200, -1, FALSE, '`Evolutive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Evolutive->Sortable = TRUE; // Allow sort
		$this->fields['Evolutive'] = &$this->Evolutive;

		// Number
		$this->Number = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_Number', 'Number', '`Number`', '`Number`', 200, -1, FALSE, '`Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Number->Sortable = TRUE; // Allow sort
		$this->fields['Number'] = &$this->Number;

		// SequentialCult
		$this->SequentialCult = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_SequentialCult', 'SequentialCult', '`SequentialCult`', '`SequentialCult`', 200, -1, FALSE, '`SequentialCult`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SequentialCult->Sortable = TRUE; // Allow sort
		$this->fields['SequentialCult'] = &$this->SequentialCult;

		// TineLapse
		$this->TineLapse = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_TineLapse', 'TineLapse', '`TineLapse`', '`TineLapse`', 200, -1, FALSE, '`TineLapse`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientName
		$this->PatientName = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// PatientID
		$this->PatientID = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// PartnerName
		$this->PartnerName = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, -1, FALSE, '`PartnerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerName->Sortable = TRUE; // Allow sort
		$this->fields['PartnerName'] = &$this->PartnerName;

		// PartnerID
		$this->PartnerID = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_PartnerID', 'PartnerID', '`PartnerID`', '`PartnerID`', 200, -1, FALSE, '`PartnerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerID->Sortable = TRUE; // Allow sort
		$this->fields['PartnerID'] = &$this->PartnerID;

		// WifeCell
		$this->WifeCell = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_WifeCell', 'WifeCell', '`WifeCell`', '`WifeCell`', 200, -1, FALSE, '`WifeCell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WifeCell->Sortable = TRUE; // Allow sort
		$this->fields['WifeCell'] = &$this->WifeCell;

		// HusbandCell
		$this->HusbandCell = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_HusbandCell', 'HusbandCell', '`HusbandCell`', '`HusbandCell`', 200, -1, FALSE, '`HusbandCell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HusbandCell->Sortable = TRUE; // Allow sort
		$this->fields['HusbandCell'] = &$this->HusbandCell;

		// CoupleID
		$this->CoupleID = new DbField('ivf_treatment_plan', 'ivf_treatment_plan', 'x_CoupleID', 'CoupleID', '`CoupleID`', '`CoupleID`', 200, -1, FALSE, '`CoupleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "ivf_outcome") {
			$detailUrl = $GLOBALS["ivf_outcome"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
		...
		if ($this->getCurrentDetailTable() == "ivf_stimulation_chart") {
			$detailUrl = $GLOBALS["ivf_stimulation_chart"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_RIDNO=" . urlencode($this->RIDNO->CurrentValue);
			$detailUrl .= "&fk_Name=" . urlencode($this->Name->CurrentValue);
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		...
		if ($detailUrl == "")
			$detailUrl = "ivf_treatment_planlist.php";
		return $detailUrl;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "ivf_treatment_planlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "ivf_treatment_planedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ivf_treatment_planadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("ivf_treatment_planview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ivf_treatment_planview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "ivf_treatment_planadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ivf_treatment_planadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("ivf_treatment_planedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ivf_treatment_planedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("ivf_treatment_planadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ivf_treatment_planadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ivf_treatment_plandelete.php", $this->getUrlParm());
	}
	...
	public function addMasterUrl($url)
	{
		...
		if ($this->getCurrentMasterTable() == "view_donor_ivf" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->RIDNO->CurrentValue);
			$url .= "&fk_Female=" . urlencode($this->Name->CurrentValue);
		}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->IVFCycleNO->setDbValue($rs->fields('IVFCycleNO'));
