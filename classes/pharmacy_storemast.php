...
class pharmacy_storemast extends DbTable
{
	...
	public function __construct()
	{
		...
		// BRCODE
		$this->BRCODE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BRCODE->Sortable = TRUE; // Allow sort
		$this->fields['BRCODE'] = &$this->BRCODE;

		// PRC
		$this->PRC = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Required = TRUE; // Required field
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// TYPE
		$this->TYPE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_TYPE', 'TYPE', '`TYPE`', '`TYPE`', 200, -1, FALSE, '`TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DES
		$this->DES = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_DES', 'DES', '`DES`', '`DES`', 200, -1, FALSE, '`DES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DES->Sortable = TRUE; // Allow sort
		$this->fields['DES'] = &$this->DES;

		// UM
		$this->UM = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_UM', 'UM', '`UM`', '`UM`', 200, -1, FALSE, '`UM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UM->Sortable = TRUE; // Allow sort
		$this->fields['UM'] = &$this->UM;

		// RT
		$this->RT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_RT', 'RT', '`RT`', '`RT`', 131, -1, FALSE, '`RT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RT->Sortable = TRUE; // Allow sort
		$this->RT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RT'] = &$this->RT;

		// UR
		$this->UR = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_UR', 'UR', '`UR`', '`UR`', 131, -1, FALSE, '`UR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UR->Sortable = FALSE; // Allow sort
		$this->UR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['UR'] = &$this->UR;

		// TAXP
		$this->TAXP = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, -1, FALSE, '`TAXP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BATCHNO
		$this->BATCHNO = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// OQ
		$this->OQ = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, -1, FALSE, '`OQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OQ->Sortable = FALSE; // Allow sort
		$this->OQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['OQ'] = &$this->OQ;

		// RQ
		$this->RQ = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, -1, FALSE, '`RQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RQ->Sortable = FALSE; // Allow sort
		$this->RQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RQ'] = &$this->RQ;

		// MRQ
		$this->MRQ = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, -1, FALSE, '`MRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRQ->Sortable = FALSE; // Allow sort
		$this->MRQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRQ'] = &$this->MRQ;

		// IQ
		$this->IQ = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = FALSE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// MRP
		$this->MRP = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// EXPDT
		$this->EXPDT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SALQTY
		$this->SALQTY = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_SALQTY', 'SALQTY', '`SALQTY`', '`SALQTY`', 131, -1, FALSE, '`SALQTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LASTPURDT
		$this->LASTPURDT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_LASTPURDT', 'LASTPURDT', '`LASTPURDT`', CastDateFieldForLike('`LASTPURDT`', 0, "DB"), 135, 0, FALSE, '`LASTPURDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LASTSUPP
		$this->LASTSUPP = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_LASTSUPP', 'LASTSUPP', '`LASTSUPP`', '`LASTSUPP`', 200, -1, FALSE, '`LASTSUPP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GENNAME
		$this->GENNAME = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, -1, FALSE, '`GENNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LASTISSDT
		$this->LASTISSDT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_LASTISSDT', 'LASTISSDT', '`LASTISSDT`', CastDateFieldForLike('`LASTISSDT`', 0, "DB"), 135, 0, FALSE, '`LASTISSDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CREATEDDT
		$this->CREATEDDT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_CREATEDDT', 'CREATEDDT', '`CREATEDDT`', CastDateFieldForLike('`CREATEDDT`', 0, "DB"), 135, 0, FALSE, '`CREATEDDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OPPRC
		$this->OPPRC = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_OPPRC', 'OPPRC', '`OPPRC`', '`OPPRC`', 200, -1, FALSE, '`OPPRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OPPRC->Sortable = FALSE; // Allow sort
		$this->fields['OPPRC'] = &$this->OPPRC;

		// RESTRICT
		$this->RESTRICT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_RESTRICT', 'RESTRICT', '`RESTRICT`', '`RESTRICT`', 200, -1, FALSE, '`RESTRICT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RESTRICT->Sortable = FALSE; // Allow sort
		$this->fields['RESTRICT'] = &$this->RESTRICT;

		// BAWAPRC
		$this->BAWAPRC = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_BAWAPRC', 'BAWAPRC', '`BAWAPRC`', '`BAWAPRC`', 200, -1, FALSE, '`BAWAPRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BAWAPRC->Sortable = FALSE; // Allow sort
		$this->fields['BAWAPRC'] = &$this->BAWAPRC;

		// STAXPER
		$this->STAXPER = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_STAXPER', 'STAXPER', '`STAXPER`', '`STAXPER`', 131, -1, FALSE, '`STAXPER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAXTYPE
		$this->TAXTYPE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_TAXTYPE', 'TAXTYPE', '`TAXTYPE`', '`TAXTYPE`', 200, -1, FALSE, '`TAXTYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXTYPE->Sortable = FALSE; // Allow sort
		$this->fields['TAXTYPE'] = &$this->TAXTYPE;

		// OLDTAXP
		$this->OLDTAXP = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_OLDTAXP', 'OLDTAXP', '`OLDTAXP`', '`OLDTAXP`', 131, -1, FALSE, '`OLDTAXP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TAXUPD
		$this->TAXUPD = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_TAXUPD', 'TAXUPD', '`TAXUPD`', '`TAXUPD`', 200, -1, FALSE, '`TAXUPD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TAXUPD->Sortable = FALSE; // Allow sort
		$this->fields['TAXUPD'] = &$this->TAXUPD;

		// PACKAGE
		$this->PACKAGE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PACKAGE', 'PACKAGE', '`PACKAGE`', '`PACKAGE`', 200, -1, FALSE, '`PACKAGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PACKAGE->Sortable = FALSE; // Allow sort
		$this->fields['PACKAGE'] = &$this->PACKAGE;

		// NEWRT
		$this->NEWRT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_NEWRT', 'NEWRT', '`NEWRT`', '`NEWRT`', 131, -1, FALSE, '`NEWRT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NEWMRP
		$this->NEWMRP = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_NEWMRP', 'NEWMRP', '`NEWMRP`', '`NEWMRP`', 131, -1, FALSE, '`NEWMRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NEWUR
		$this->NEWUR = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_NEWUR', 'NEWUR', '`NEWUR`', '`NEWUR`', 131, -1, FALSE, '`NEWUR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// STATUS
		$this->STATUS = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_STATUS', 'STATUS', '`STATUS`', '`STATUS`', 200, -1, FALSE, '`STATUS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->STATUS->Sortable = FALSE; // Allow sort
		$this->fields['STATUS'] = &$this->STATUS;

		// RETNQTY
		$this->RETNQTY = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_RETNQTY', 'RETNQTY', '`RETNQTY`', '`RETNQTY`', 131, -1, FALSE, '`RETNQTY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// KEMODISC
		$this->KEMODISC = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_KEMODISC', 'KEMODISC', '`KEMODISC`', '`KEMODISC`', 200, -1, FALSE, '`KEMODISC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KEMODISC->Sortable = FALSE; // Allow sort
		$this->fields['KEMODISC'] = &$this->KEMODISC;

		// PATSALE
		$this->PATSALE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PATSALE', 'PATSALE', '`PATSALE`', '`PATSALE`', 131, -1, FALSE, '`PATSALE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ORGAN
		$this->ORGAN = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_ORGAN', 'ORGAN', '`ORGAN`', '`ORGAN`', 200, -1, FALSE, '`ORGAN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ORGAN->Sortable = FALSE; // Allow sort
		$this->fields['ORGAN'] = &$this->ORGAN;

		// OLDRQ
		$this->OLDRQ = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_OLDRQ', 'OLDRQ', '`OLDRQ`', '`OLDRQ`', 131, -1, FALSE, '`OLDRQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DRID
		$this->DRID = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_DRID', 'DRID', '`DRID`', '`DRID`', 200, -1, FALSE, '`DRID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// MFRCODE
		$this->MFRCODE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// COMBCODE
		$this->COMBCODE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_COMBCODE', 'COMBCODE', '`COMBCODE`', '`COMBCODE`', 200, -1, FALSE, '`COMBCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GENCODE
		$this->GENCODE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_GENCODE', 'GENCODE', '`GENCODE`', '`GENCODE`', 200, -1, FALSE, '`GENCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// STRENGTH
		$this->STRENGTH = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 131, -1, FALSE, '`STRENGTH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UNIT
		$this->UNIT = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, -1, FALSE, '`UNIT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// FORMULARY
		$this->FORMULARY = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_FORMULARY', 'FORMULARY', '`FORMULARY`', '`FORMULARY`', 200, -1, FALSE, '`FORMULARY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// STOCK
		$this->STOCK = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_STOCK', 'STOCK', '`STOCK`', '`STOCK`', 131, -1, FALSE, '`STOCK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RACKNO
		$this->RACKNO = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_RACKNO', 'RACKNO', '`RACKNO`', '`RACKNO`', 200, -1, FALSE, '`RACKNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RACKNO->Sortable = TRUE; // Allow sort
		$this->fields['RACKNO'] = &$this->RACKNO;

		// SUPPNAME
		$this->SUPPNAME = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_SUPPNAME', 'SUPPNAME', '`SUPPNAME`', '`SUPPNAME`', 200, -1, FALSE, '`SUPPNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// COMBNAME
		$this->COMBNAME = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_COMBNAME', 'COMBNAME', '`COMBNAME`', '`COMBNAME`', 200, -1, FALSE, '`COMBNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// GENERICNAME
		$this->GENERICNAME = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_GENERICNAME', 'GENERICNAME', '`GENERICNAME`', '`GENERICNAME`', 200, -1, FALSE, '`GENERICNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// REMARK
		$this->REMARK = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_REMARK', 'REMARK', '`REMARK`', '`REMARK`', 200, -1, FALSE, '`REMARK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->REMARK->Sortable = TRUE; // Allow sort
		$this->fields['REMARK'] = &$this->REMARK;

		// TEMP
		$this->TEMP = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_TEMP', 'TEMP', '`TEMP`', '`TEMP`', 200, -1, FALSE, '`TEMP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TEMP->Sortable = TRUE; // Allow sort
		$this->fields['TEMP'] = &$this->TEMP;

		// PACKING
		$this->PACKING = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PACKING', 'PACKING', '`PACKING`', '`PACKING`', 131, -1, FALSE, '`PACKING`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PhysQty
		$this->PhysQty = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PhysQty', 'PhysQty', '`PhysQty`', '`PhysQty`', 131, -1, FALSE, '`PhysQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LedQty
		$this->LedQty = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_LedQty', 'LedQty', '`LedQty`', '`LedQty`', 131, -1, FALSE, '`LedQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id
		$this->id = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PurValue
		$this->PurValue = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PSGST
		$this->PSGST = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCGST
		$this->PCGST = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SaleValue
		$this->SaleValue = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_SaleValue', 'SaleValue', '`SaleValue`', '`SaleValue`', 131, -1, FALSE, '`SaleValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SSGST
		$this->SSGST = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SCGST
		$this->SCGST = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SaleRate
		$this->SaleRate = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_SaleRate', 'SaleRate', '`SaleRate`', '`SaleRate`', 131, -1, FALSE, '`SaleRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// BRNAME
		$this->BRNAME = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_BRNAME', 'BRNAME', '`BRNAME`', '`BRNAME`', 200, -1, FALSE, '`BRNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BRNAME->Sortable = TRUE; // Allow sort
		$this->fields['BRNAME'] = &$this->BRNAME;

		// OV
		$this->OV = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_OV', 'OV', '`OV`', '`OV`', 131, -1, FALSE, '`OV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OV->Sortable = FALSE; // Allow sort
		$this->OV->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['OV'] = &$this->OV;

		// LATESTOV
		$this->LATESTOV = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_LATESTOV', 'LATESTOV', '`LATESTOV`', '`LATESTOV`', 131, -1, FALSE, '`LATESTOV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ITEMTYPE
		$this->ITEMTYPE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_ITEMTYPE', 'ITEMTYPE', '`ITEMTYPE`', '`ITEMTYPE`', 200, -1, FALSE, '`ITEMTYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ITEMTYPE->Sortable = FALSE; // Allow sort
		$this->fields['ITEMTYPE'] = &$this->ITEMTYPE;

		// ROWID
		$this->ROWID = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_ROWID', 'ROWID', '`ROWID`', '`ROWID`', 200, -1, FALSE, '`ROWID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ROWID->Sortable = FALSE; // Allow sort
		$this->fields['ROWID'] = &$this->ROWID;

		// MOVED
		$this->MOVED = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_MOVED', 'MOVED', '`MOVED`', '`MOVED`', 3, -1, FALSE, '`MOVED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NEWTAX
		$this->NEWTAX = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_NEWTAX', 'NEWTAX', '`NEWTAX`', '`NEWTAX`', 131, -1, FALSE, '`NEWTAX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HSNCODE
		$this->HSNCODE = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_HSNCODE', 'HSNCODE', '`HSNCODE`', '`HSNCODE`', 200, -1, FALSE, '`HSNCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HSNCODE->Sortable = FALSE; // Allow sort
		$this->fields['HSNCODE'] = &$this->HSNCODE;

		// OLDTAX
		$this->OLDTAX = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_OLDTAX', 'OLDTAX', '`OLDTAX`', '`OLDTAX`', 131, -1, FALSE, '`OLDTAX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Scheduling
		$this->Scheduling = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_Scheduling', 'Scheduling', '`Scheduling`', '`Scheduling`', 200, -1, FALSE, '`Scheduling`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->Scheduling->Sortable = TRUE; // Allow sort
		$this->Scheduling->Lookup = new Lookup('Scheduling', 'pharmacy_storemast', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->Scheduling->OptionCount = 2;
		$this->fields['Scheduling'] = &$this->Scheduling;

		// Schedulingh1
		$this->Schedulingh1 = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_Schedulingh1', 'Schedulingh1', '`Schedulingh1`', '`Schedulingh1`', 200, -1, FALSE, '`Schedulingh1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->Schedulingh1->Sortable = TRUE; // Allow sort
		$this->Schedulingh1->Lookup = new Lookup('Schedulingh1', 'pharmacy_storemast', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->Schedulingh1->OptionCount = 2;
		$this->fields['Schedulingh1'] = &$this->Schedulingh1;
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->Scheduling->DbValue = $row['Scheduling'];
		$this->Schedulingh1->DbValue = $row['Schedulingh1'];
	}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_storemastview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Scheduling->setDbValue($rs->fields('Scheduling'));
		$this->Schedulingh1->setDbValue($rs->fields('Schedulingh1'));
	}
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->Scheduling);
					$doc->exportCaption($this->Schedulingh1);
				} else {
					$doc->exportCaption($this->BRCODE);
					$doc->exportCaption($this->PRC);
					$doc->exportCaption($this->TYPE);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->Scheduling);
						$doc->exportField($this->Schedulingh1);
					} else {
						$doc->exportField($this->BRCODE);
						$doc->exportField($this->PRC);
						$doc->exportField($this->TYPE);
