 ...
 * Page class
 */
class ivf_mas_art_cycle_addopt extends ivf_mas_art_cycle
{
	...
	// Page object name
	public $PageObjName = "ivf_mas_art_cycle_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->ARTCYCLE->IsDetailKey) {
			$this->ARTCYCLE->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->ARTCYCLE->CurrentValue = ConvertToUtf8($this->ARTCYCLE->FormValue);
	}
