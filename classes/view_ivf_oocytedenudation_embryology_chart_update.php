 ...
 * Page class
 */
class view_ivf_oocytedenudation_embryology_chart_update extends view_ivf_oocytedenudation_embryology_chart
{
	...
	// Page object name
	public $PageObjName = "view_ivf_oocytedenudation_embryology_chart_update";
	...
	public function run()
	{
		...
		if (count($this->RecKeys) <= 0)
			$this->terminate("view_ivf_oocytedenudation_embryology_chartlist.php"); // No records selected, return to list
		if ($this->isUpdate()) {
