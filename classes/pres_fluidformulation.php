...
class pres_fluidformulation extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Tradename
		$this->Tradename = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_Tradename', 'Tradename', '`Tradename`', '`Tradename`', 201, -1, FALSE, '`Tradename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tradename->Sortable = TRUE; // Allow sort
		$this->fields['Tradename'] = &$this->Tradename;

		// Itemcode
		$this->Itemcode = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_Itemcode', 'Itemcode', '`Itemcode`', '`Itemcode`', 200, -1, FALSE, '`Itemcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Itemcode->Sortable = TRUE; // Allow sort
		$this->fields['Itemcode'] = &$this->Itemcode;

		// Genericname
		$this->Genericname = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_Genericname', 'Genericname', '`Genericname`', '`Genericname`', 200, -1, FALSE, '`Genericname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Genericname->Sortable = TRUE; // Allow sort
		$this->fields['Genericname'] = &$this->Genericname;

		// Volume
		$this->Volume = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_Volume', 'Volume', '`Volume`', '`Volume`', 5, -1, FALSE, '`Volume`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// VolumeUnit
		$this->VolumeUnit = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_VolumeUnit', 'VolumeUnit', '`VolumeUnit`', '`VolumeUnit`', 200, -1, FALSE, '`VolumeUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VolumeUnit->Sortable = TRUE; // Allow sort
		$this->fields['VolumeUnit'] = &$this->VolumeUnit;

		// Strength
		$this->Strength = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_Strength', 'Strength', '`Strength`', '`Strength`', 5, -1, FALSE, '`Strength`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StrengthUnit
		$this->StrengthUnit = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_StrengthUnit', 'StrengthUnit', '`StrengthUnit`', '`StrengthUnit`', 200, -1, FALSE, '`StrengthUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StrengthUnit->Sortable = TRUE; // Allow sort
		$this->fields['StrengthUnit'] = &$this->StrengthUnit;

		// Route
		$this->_Route = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x__Route', 'Route', '`Route`', '`Route`', 200, -1, FALSE, '`Route`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Route->Sortable = TRUE; // Allow sort
		$this->fields['Route'] = &$this->_Route;

		// Forms
		$this->Forms = new DbField('pres_fluidformulation', 'pres_fluidformulation', 'x_Forms', 'Forms', '`Forms`', '`Forms`', 200, -1, FALSE, '`Forms`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pres_fluidformulationview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
