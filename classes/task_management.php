 ...
 */
class task_management extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('task_management', 'task_management', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// TaskName
		$this->TaskName = new DbField('task_management', 'task_management', 'x_TaskName', 'TaskName', '`TaskName`', '`TaskName`', 200, -1, FALSE, '`TaskName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TaskName->Sortable = TRUE; // Allow sort
		$this->fields['TaskName'] = &$this->TaskName;

		// AssignTo
		$this->AssignTo = new DbField('task_management', 'task_management', 'x_AssignTo', 'AssignTo', '`AssignTo`', '`AssignTo`', 200, -1, FALSE, '`AssignTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Description
		$this->Description = new DbField('task_management', 'task_management', 'x_Description', 'Description', '`Description`', '`Description`', 201, -1, FALSE, '`Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Description->Sortable = TRUE; // Allow sort
		$this->fields['Description'] = &$this->Description;

		// StartDate
		$this->StartDate = new DbField('task_management', 'task_management', 'x_StartDate', 'StartDate', '`StartDate`', CastDateFieldForLike('`StartDate`', 7, "DB"), 135, 7, FALSE, '`StartDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EndDate
		$this->EndDate = new DbField('task_management', 'task_management', 'x_EndDate', 'EndDate', '`EndDate`', CastDateFieldForLike('`EndDate`', 7, "DB"), 135, 7, FALSE, '`EndDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StatusOfTask
		$this->StatusOfTask = new DbField('task_management', 'task_management', 'x_StatusOfTask', 'StatusOfTask', '`StatusOfTask`', '`StatusOfTask`', 200, -1, FALSE, '`StatusOfTask`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ForwardTo
		$this->ForwardTo = new DbField('task_management', 'task_management', 'x_ForwardTo', 'ForwardTo', '`ForwardTo`', '`ForwardTo`', 200, -1, FALSE, '`ForwardTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('task_management', 'task_management', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('task_management', 'task_management', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('task_management', 'task_management', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('task_management', 'task_management', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// GetUserName
		$this->GetUserName = new DbField('task_management', 'task_management', 'x_GetUserName', 'GetUserName', '`GetUserName`', '`GetUserName`', 200, -1, FALSE, '`GetUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GetUserName->Sortable = TRUE; // Allow sort
		$this->fields['GetUserName'] = &$this->GetUserName;

		// GetModifiedName
		$this->GetModifiedName = new DbField('task_management', 'task_management', 'x_GetModifiedName', 'GetModifiedName', '`GetModifiedName`', '`GetModifiedName`', 200, -1, FALSE, '`GetModifiedName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GetModifiedName->Sortable = TRUE; // Allow sort
		$this->fields['GetModifiedName'] = &$this->GetModifiedName;

		// HospID
		$this->HospID = new DbField('task_management', 'task_management', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "task_managementlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "task_managementedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "task_managementadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("task_managementview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("task_managementview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "task_managementadd.php?" . $this->getUrlParm($parm);
		else
			$url = "task_managementadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("task_managementedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("task_managementadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("task_managementdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->AssignTo->setDbValue($rs->fields('AssignTo'));
		$this->Description->setDbValue($rs->fields('Description'));
		$this->StartDate->setDbValue($rs->fields('StartDate'));
		$this->EndDate->setDbValue($rs->fields('EndDate'));
		$this->StatusOfTask->setDbValue($rs->fields('StatusOfTask'));
		$this->ForwardTo->setDbValue($rs->fields('ForwardTo'));
		$this->createdby->setDbValue($rs->fields('createdby'));
		$this->createddatetime->setDbValue($rs->fields('createddatetime'));
		$this->modifiedby->setDbValue($rs->fields('modifiedby'));
		$this->modifieddatetime->setDbValue($rs->fields('modifieddatetime'));
		$this->GetUserName->setDbValue($rs->fields('GetUserName'));
		$this->GetModifiedName->setDbValue($rs->fields('GetModifiedName'));
