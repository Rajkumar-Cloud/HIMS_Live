...
class patient_investigations extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient_investigations', 'patient_investigations', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Reception
		$this->Reception = new DbField('patient_investigations', 'patient_investigations', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 200, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientId
		$this->PatientId = new DbField('patient_investigations', 'patient_investigations', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->IsForeignKey = TRUE; // Foreign key field
		$this->PatientId->Sortable = FALSE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// PatientName
		$this->PatientName = new DbField('patient_investigations', 'patient_investigations', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = FALSE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Investigation
		$this->Investigation = new DbField('patient_investigations', 'patient_investigations', 'x_Investigation', 'Investigation', '`Investigation`', '`Investigation`', 200, -1, FALSE, '`Investigation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Investigation->Sortable = TRUE; // Allow sort
		$this->fields['Investigation'] = &$this->Investigation;

		// Value
		$this->Value = new DbField('patient_investigations', 'patient_investigations', 'x_Value', 'Value', '`Value`', '`Value`', 200, -1, FALSE, '`Value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Value->Sortable = TRUE; // Allow sort
		$this->fields['Value'] = &$this->Value;

		// NormalRange
		$this->NormalRange = new DbField('patient_investigations', 'patient_investigations', 'x_NormalRange', 'NormalRange', '`NormalRange`', '`NormalRange`', 200, -1, FALSE, '`NormalRange`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NormalRange->Sortable = TRUE; // Allow sort
		$this->fields['NormalRange'] = &$this->NormalRange;

		// mrnno
		$this->mrnno = new DbField('patient_investigations', 'patient_investigations', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->IsForeignKey = TRUE; // Foreign key field
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// Age
		$this->Age = new DbField('patient_investigations', 'patient_investigations', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('patient_investigations', 'patient_investigations', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// profilePic
		$this->profilePic = new DbField('patient_investigations', 'patient_investigations', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// SampleCollected
		$this->SampleCollected = new DbField('patient_investigations', 'patient_investigations', 'x_SampleCollected', 'SampleCollected', '`SampleCollected`', CastDateFieldForLike('`SampleCollected`', 0, "DB"), 135, 0, FALSE, '`SampleCollected`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SampleCollectedBy
		$this->SampleCollectedBy = new DbField('patient_investigations', 'patient_investigations', 'x_SampleCollectedBy', 'SampleCollectedBy', '`SampleCollectedBy`', '`SampleCollectedBy`', 200, -1, FALSE, '`SampleCollectedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SampleCollectedBy->Sortable = TRUE; // Allow sort
		$this->fields['SampleCollectedBy'] = &$this->SampleCollectedBy;

		// ResultedDate
		$this->ResultedDate = new DbField('patient_investigations', 'patient_investigations', 'x_ResultedDate', 'ResultedDate', '`ResultedDate`', CastDateFieldForLike('`ResultedDate`', 0, "DB"), 135, 0, FALSE, '`ResultedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResultedBy
		$this->ResultedBy = new DbField('patient_investigations', 'patient_investigations', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, -1, FALSE, '`ResultedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ResultedBy->Sortable = TRUE; // Allow sort
		$this->fields['ResultedBy'] = &$this->ResultedBy;

		// Modified
		$this->Modified = new DbField('patient_investigations', 'patient_investigations', 'x_Modified', 'Modified', '`Modified`', CastDateFieldForLike('`Modified`', 0, "DB"), 135, 0, FALSE, '`Modified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ModifiedBy
		$this->ModifiedBy = new DbField('patient_investigations', 'patient_investigations', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// Created
		$this->Created = new DbField('patient_investigations', 'patient_investigations', 'x_Created', 'Created', '`Created`', CastDateFieldForLike('`Created`', 0, "DB"), 135, 0, FALSE, '`Created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new DbField('patient_investigations', 'patient_investigations', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// GroupHead
		$this->GroupHead = new DbField('patient_investigations', 'patient_investigations', 'x_GroupHead', 'GroupHead', '`GroupHead`', '`GroupHead`', 200, -1, FALSE, '`GroupHead`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GroupHead->Sortable = TRUE; // Allow sort
		$this->fields['GroupHead'] = &$this->GroupHead;

		// Cost
		$this->Cost = new DbField('patient_investigations', 'patient_investigations', 'x_Cost', 'Cost', '`Cost`', '`Cost`', 131, -1, FALSE, '`Cost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cost->Sortable = TRUE; // Allow sort
		$this->Cost->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Cost'] = &$this->Cost;

		// PaymentStatus
		$this->PaymentStatus = new DbField('patient_investigations', 'patient_investigations', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 200, -1, FALSE, '`PaymentStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaymentStatus->Sortable = TRUE; // Allow sort
		$this->fields['PaymentStatus'] = &$this->PaymentStatus;

		// PayMode
		$this->PayMode = new DbField('patient_investigations', 'patient_investigations', 'x_PayMode', 'PayMode', '`PayMode`', '`PayMode`', 200, -1, FALSE, '`PayMode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PayMode->Sortable = TRUE; // Allow sort
		$this->fields['PayMode'] = &$this->PayMode;

		// VoucherNo
		$this->VoucherNo = new DbField('patient_investigations', 'patient_investigations', 'x_VoucherNo', 'VoucherNo', '`VoucherNo`', '`VoucherNo`', 200, -1, FALSE, '`VoucherNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VoucherNo->Sortable = TRUE; // Allow sort
		$this->fields['VoucherNo'] = &$this->VoucherNo;

		// InvestigationMultiselect
		$this->InvestigationMultiselect = new DbField('patient_investigations', 'patient_investigations', 'x_InvestigationMultiselect', 'InvestigationMultiselect', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patient_investigationsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
