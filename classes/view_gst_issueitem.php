 ...
 */
class view_gst_issueitem extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// createddatetime
		$this->createddatetime = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// voucher_type
		$this->voucher_type = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, -1, FALSE, '`voucher_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->voucher_type->Sortable = TRUE; // Allow sort
		$this->fields['voucher_type'] = &$this->voucher_type;

		// product
		$this->product = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_product', 'product', '`product`', '`product`', 200, -1, FALSE, '`product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->product->Sortable = TRUE; // Allow sort
		$this->fields['product'] = &$this->product;

		// Damt
		$this->Damt = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_Damt', 'Damt', '`Damt`', '`Damt`', 131, -1, FALSE, '`Damt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Damt->Sortable = TRUE; // Allow sort
		$this->Damt->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Damt'] = &$this->Damt;

		// IQ
		$this->IQ = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = TRUE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// amount
		$this->amount = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_amount', 'amount', '`amount`', '`amount`', 131, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_gst_issueitemlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_gst_issueitemview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_gst_issueitemedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_gst_issueitemadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_gst_issueitemview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_gst_issueitemview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_gst_issueitemadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_gst_issueitemadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_gst_issueitemedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_gst_issueitemadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_gst_issueitemdelete.php", $this->getUrlParm());
	}
