...
class view_pharmacy_purchase_request_approved extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DT
		$this->DT = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 0, "DB"), 135, 0, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmployeeName
		$this->EmployeeName = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_EmployeeName', 'EmployeeName', '`EmployeeName`', '`EmployeeName`', 200, -1, FALSE, '`EmployeeName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmployeeName->Sortable = TRUE; // Allow sort
		$this->fields['EmployeeName'] = &$this->EmployeeName;

		// Department
		$this->Department = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_Department', 'Department', '`Department`', '`Department`', 200, -1, FALSE, '`Department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Department->Sortable = TRUE; // Allow sort
		$this->fields['Department'] = &$this->Department;

		// ApprovedStatus
		$this->ApprovedStatus = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_ApprovedStatus', 'ApprovedStatus', '`ApprovedStatus`', '`ApprovedStatus`', 200, -1, FALSE, '`ApprovedStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PurchaseStatus
		$this->PurchaseStatus = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_PurchaseStatus', 'PurchaseStatus', '`PurchaseStatus`', '`PurchaseStatus`', 200, -1, FALSE, '`PurchaseStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PurchaseStatus->Sortable = TRUE; // Allow sort
		$this->fields['PurchaseStatus'] = &$this->PurchaseStatus;

		// HospID
		$this->HospID = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// createdby
		$this->createdby = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_pharmacy_purchase_request_items_approved") {
			$detailUrl = $GLOBALS["view_pharmacy_purchase_request_items_approved"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_pharmacy_purchase_request_approvedview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_pharmacy_purchase_request_approvededit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_pharmacy_purchase_request_approvedadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
