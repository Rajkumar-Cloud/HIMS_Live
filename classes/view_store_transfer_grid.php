 ...
 * Page class
 */
class view_store_transfer_grid extends view_store_transfer
{
	...
	// Page object name
	public $PageObjName = "view_store_transfer_grid";

	// Grid form hidden field names
	public $FormName = "fview_store_transfergrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "store_billing_transfer") {
			$this->strid->Visible = FALSE;
			if ($GLOBALS["store_billing_transfer"]->EventCancelled)
