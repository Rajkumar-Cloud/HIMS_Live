 ...
 */
class view_pharmacy_pharled extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PSGST
		$this->PSGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCGST
		$this->PCGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SSGST
		$this->SSGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SCGST
		$this->SCGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalRate
		$this->SalRate = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, -1, FALSE, '`SalRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurValue
		$this->PurValue = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PUnit
		$this->PUnit = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, -1, FALSE, '`PUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_pharledlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_pharledview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_pharlededit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_pharledadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_pharledview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_pharledview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_pharledadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_pharledadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_pharlededit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_pharledadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_pharleddelete.php", $this->getUrlParm());
	}
