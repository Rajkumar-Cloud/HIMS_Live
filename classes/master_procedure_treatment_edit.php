 ...
 * Page class
 */
class master_procedure_treatment_edit extends master_procedure_treatment
{
	...
	// Page object name
	public $PageObjName = "master_procedure_treatment_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Treatment
			$this->Treatment->setDbValueDef($rsnew, $this->Treatment->CurrentValue, "", $this->Treatment->ReadOnly);

			// Procedure
			$this->Procedure->setDbValueDef($rsnew, $this->Procedure->CurrentValue, "", $this->Procedure->ReadOnly);
