 ...
 * Page class
 */
class mas_reference_type_edit extends mas_reference_type
{
	...
	// Page object name
	public $PageObjName = "mas_reference_type_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// whatapp
			$this->whatapp->setDbValueDef($rsnew, $this->whatapp->CurrentValue, NULL, $this->whatapp->ReadOnly);
