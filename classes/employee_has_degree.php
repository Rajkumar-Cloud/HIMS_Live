 ...
 */
class employee_has_degree extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_has_degree', 'employee_has_degree', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee_id
		$this->employee_id = new DbField('employee_has_degree', 'employee_has_degree', 'x_employee_id', 'employee_id', '`employee_id`', '`employee_id`', 3, -1, FALSE, '`employee_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// degree_id
		$this->degree_id = new DbField('employee_has_degree', 'employee_has_degree', 'x_degree_id', 'degree_id', '`degree_id`', '`degree_id`', 3, -1, FALSE, '`degree_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// college_or_school
		$this->college_or_school = new DbField('employee_has_degree', 'employee_has_degree', 'x_college_or_school', 'college_or_school', '`college_or_school`', '`college_or_school`', 200, -1, FALSE, '`college_or_school`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// university_or_board
		$this->university_or_board = new DbField('employee_has_degree', 'employee_has_degree', 'x_university_or_board', 'university_or_board', '`university_or_board`', '`university_or_board`', 200, -1, FALSE, '`university_or_board`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// year_of_passing
		$this->year_of_passing = new DbField('employee_has_degree', 'employee_has_degree', 'x_year_of_passing', 'year_of_passing', '`year_of_passing`', '`year_of_passing`', 200, -1, FALSE, '`year_of_passing`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// scoring_marks
		$this->scoring_marks = new DbField('employee_has_degree', 'employee_has_degree', 'x_scoring_marks', 'scoring_marks', '`scoring_marks`', '`scoring_marks`', 200, -1, FALSE, '`scoring_marks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// certificates
		$this->certificates = new DbField('employee_has_degree', 'employee_has_degree', 'x_certificates', 'certificates', '`certificates`', '`certificates`', 200, -1, TRUE, '`certificates`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// others
		$this->others = new DbField('employee_has_degree', 'employee_has_degree', 'x_others', 'others', '`others`', '`others`', 200, -1, TRUE, '`others`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// status
		$this->status = new DbField('employee_has_degree', 'employee_has_degree', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('employee_has_degree', 'employee_has_degree', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = FALSE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('employee_has_degree', 'employee_has_degree', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = FALSE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('employee_has_degree', 'employee_has_degree', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = FALSE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('employee_has_degree', 'employee_has_degree', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = FALSE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// HospID
		$this->HospID = new DbField('employee_has_degree', 'employee_has_degree', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_has_degreelist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_has_degreeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_has_degreeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_has_degreeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_has_degreeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_has_degreeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_has_degreeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_has_degreeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_has_degreeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_has_degreedelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->degree_id->setDbValue($rs->fields('degree_id'));
		$this->college_or_school->setDbValue($rs->fields('college_or_school'));
		$this->university_or_board->setDbValue($rs->fields('university_or_board'));
		$this->year_of_passing->setDbValue($rs->fields('year_of_passing'));
		$this->scoring_marks->setDbValue($rs->fields('scoring_marks'));
