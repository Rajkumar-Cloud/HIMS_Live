 ...
 * Page class
 */
class view_billing_voucher_print_add extends view_billing_voucher_print
{
	...
	// Page object name
	public $PageObjName = "view_billing_voucher_print_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "view_billing_voucher_printview.php")
