 ...
 * Page class
 */
class banktransferto_addopt extends banktransferto
{
	...
	// Page object name
	public $PageObjName = "banktransferto_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->Mobile_Number->IsDetailKey) {
			$this->Mobile_Number->setFormValue(ConvertFromUtf8($val));
		}
	...
	public function restoreFormValues()
	{
		...
		$this->Mobile_Number->CurrentValue = ConvertToUtf8($this->Mobile_Number->FormValue);
