 ...
 * Page class
 */
class pharmacy_billing_return_delete extends pharmacy_billing_return
{
	...
	// Page object name
	public $PageObjName = "pharmacy_billing_return_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_billing_returnlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_billing_returnlist.php"); // Return to list
			}
		}
	}
