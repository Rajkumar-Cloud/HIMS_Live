 ...
 * Page class
 */
class patient_opd_follow_up_list extends patient_opd_follow_up
{
	...
	// Page object name
	public $PageObjName = "patient_opd_follow_up_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_opd_follow_upadd.php?" . TABLE_SHOW_DETAIL . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "patient_opd_follow_updelete.php";
		$this->MultiUpdateUrl = "patient_opd_follow_upupdate.php";
	...
	public function renderListOptions()
	{
		...
		// "detail_patient_an_registration"
		$opt = &$this->ListOptions->Items["detail_patient_an_registration"];
		if ($Security->allowList(CurrentProjectID() . 'patient_an_registration')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("patient_an_registrationlist.php?" . TABLE_SHOW_MASTER . "=patient_opd_follow_up&fk_PatientId=" . urlencode(strval($this->PatientId->CurrentValue)) . "&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["patient_an_registration_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'patient_an_registration')) {
				$caption = $Language->phrase("MasterDetailViewLink");
				$url = $this->getViewUrl(TABLE_SHOW_DETAIL . "=patient_an_registration");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailViewTblVar <> "")
					$detailViewTblVar .= ",";
				$detailViewTblVar .= "patient_an_registration";
			}
			if ($GLOBALS["patient_an_registration_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'patient_an_registration')) {
				$caption = $Language->phrase("MasterDetailEditLink");
				$url = $this->getEditUrl(TABLE_SHOW_DETAIL . "=patient_an_registration");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar <> "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "patient_an_registration";
			}
			if ($GLOBALS["patient_an_registration_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'patient_an_registration')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(TABLE_SHOW_DETAIL . "=patient_an_registration");
	...
	protected function setupOtherOptions()
	{
		...
		$url = $this->getAddUrl(TABLE_SHOW_DETAIL . "=patient_an_registration");
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_an_registration"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["patient_an_registration"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'patient_an_registration') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink <> "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_opd_follow_uplistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_opd_follow_uplistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fpatient_opd_follow_uplist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_opd_follow_uplistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"patient_opd_follow_upsrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<button type=\"button\" class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"patient_opd_follow_up\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" onclick=\"ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'patient_opd_follow_upsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</button>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-highlight active\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fpatient_opd_follow_uplistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</button>";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages->Items["patient_an_registration"]->Visible) {
			$link = "";
			$option = &$this->ListOptions->Items["detail_patient_an_registration"];
			$url = "patient_an_registrationpreview.php?t=patient_opd_follow_up&f=" . Encrypt($sqlwrk);
			...
			if ($Security->allowList(CurrentProjectID() . 'patient_an_registration')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_an_registrationlist.php?" . TABLE_SHOW_MASTER . "=patient_opd_follow_up&fk_PatientId=" . urlencode(strval($this->PatientId->CurrentValue)) . "&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
				$btngrp .= "<button type=\"button\" class=\"btn btn-default\" title=\"" . $Language->TablePhrase("patient_an_registration", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "'\">" . $Language->Phrase("MasterDetailListLink") . "</button>";
			}
			if (!isset($GLOBALS["patient_an_registration_grid"]))
				$GLOBALS["patient_an_registration_grid"] = new patient_an_registration_grid();
			if ($GLOBALS["patient_an_registration_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'patient_an_registration')) {
	...
	protected function loadSearchValues()
	{
		...
		// Telephone
		if (!$this->isAddOrEdit())
			$this->Telephone->AdvancedSearch->setSearchValue(Get("x_Telephone", Get("Telephone", "")));
		if ($this->Telephone->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Telephone->AdvancedSearch->setSearchOperator(Get("z_Telephone", ""));
		...
		// ICSIAdvised
		if (!$this->isAddOrEdit())
			$this->ICSIAdvised->AdvancedSearch->setSearchValue(Get("x_ICSIAdvised", Get("ICSIAdvised", "")));
		if ($this->ICSIAdvised->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ICSIAdvised->AdvancedSearch->setSearchOperator(Get("z_ICSIAdvised", ""));
		if (is_array($this->ICSIAdvised->AdvancedSearch->SearchValue))
			$this->ICSIAdvised->AdvancedSearch->SearchValue = implode(",", $this->ICSIAdvised->AdvancedSearch->SearchValue);
		if (is_array($this->ICSIAdvised->AdvancedSearch->SearchValue2))
			$this->ICSIAdvised->AdvancedSearch->SearchValue2 = implode(",", $this->ICSIAdvised->AdvancedSearch->SearchValue2);

		// DeliveryRegistered
		if (!$this->isAddOrEdit())
			$this->DeliveryRegistered->AdvancedSearch->setSearchValue(Get("x_DeliveryRegistered", Get("DeliveryRegistered", "")));
		if ($this->DeliveryRegistered->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->DeliveryRegistered->AdvancedSearch->setSearchOperator(Get("z_DeliveryRegistered", ""));
		if (is_array($this->DeliveryRegistered->AdvancedSearch->SearchValue))
			$this->DeliveryRegistered->AdvancedSearch->SearchValue = implode(",", $this->DeliveryRegistered->AdvancedSearch->SearchValue);
		if (is_array($this->DeliveryRegistered->AdvancedSearch->SearchValue2))
			$this->DeliveryRegistered->AdvancedSearch->SearchValue2 = implode(",", $this->DeliveryRegistered->AdvancedSearch->SearchValue2);

		// EDD
		if (!$this->isAddOrEdit())
			$this->EDD->AdvancedSearch->setSearchValue(Get("x_EDD", Get("EDD", "")));
		if ($this->EDD->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->EDD->AdvancedSearch->setSearchOperator(Get("z_EDD", ""));

		// SerologyPositive
		if (!$this->isAddOrEdit())
			$this->SerologyPositive->AdvancedSearch->setSearchValue(Get("x_SerologyPositive", Get("SerologyPositive", "")));
		if ($this->SerologyPositive->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->SerologyPositive->AdvancedSearch->setSearchOperator(Get("z_SerologyPositive", ""));
		if (is_array($this->SerologyPositive->AdvancedSearch->SearchValue))
			$this->SerologyPositive->AdvancedSearch->SearchValue = implode(",", $this->SerologyPositive->AdvancedSearch->SearchValue);
		if (is_array($this->SerologyPositive->AdvancedSearch->SearchValue2))
			$this->SerologyPositive->AdvancedSearch->SearchValue2 = implode(",", $this->SerologyPositive->AdvancedSearch->SearchValue2);

		// Allergy
		if (!$this->isAddOrEdit())
			$this->Allergy->AdvancedSearch->setSearchValue(Get("x_Allergy", Get("Allergy", "")));
		if ($this->Allergy->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->Allergy->AdvancedSearch->setSearchOperator(Get("z_Allergy", ""));
		...
		// ProcedureDateTime
		if (!$this->isAddOrEdit())
			$this->ProcedureDateTime->AdvancedSearch->setSearchValue(Get("x_ProcedureDateTime", Get("ProcedureDateTime", "")));
		if ($this->ProcedureDateTime->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ProcedureDateTime->AdvancedSearch->setSearchOperator(Get("z_ProcedureDateTime", ""));

		// ICSIDate
		if (!$this->isAddOrEdit())
			$this->ICSIDate->AdvancedSearch->setSearchValue(Get("x_ICSIDate", Get("ICSIDate", "")));
		if ($this->ICSIDate->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ICSIDate->AdvancedSearch->setSearchOperator(Get("z_ICSIDate", ""));
		...
		// TemplateDrNotes
		if (!$this->isAddOrEdit())
			$this->TemplateDrNotes->AdvancedSearch->setSearchValue(Get("x_TemplateDrNotes", Get("TemplateDrNotes", "")));
		if ($this->TemplateDrNotes->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->TemplateDrNotes->AdvancedSearch->setSearchOperator(Get("z_TemplateDrNotes", ""));
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fpatient_opd_follow_uplist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fpatient_opd_follow_uplist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fpatient_opd_follow_uplist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
