...
class view_iui_excel_search extends view_iui_excel
{
	...
	protected function loadSearchValues()
	{
		...
		// HUSBAND NAME
		if (!$this->isAddOrEdit())
			$this->HUSBAND_NAME->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HUSBAND_NAME"));
		$this->HUSBAND_NAME->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HUSBAND_NAME"));

		// CoupleID
		if (!$this->isAddOrEdit())
			$this->CoupleID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_CoupleID"));
		$this->CoupleID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_CoupleID"));

		// AGE  - WIFE
		if (!$this->isAddOrEdit())
			$this->AGE____WIFE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_AGE____WIFE"));
		$this->AGE____WIFE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_AGE____WIFE"));

		// AGE- HUSBAND
		if (!$this->isAddOrEdit())
			$this->AGE__HUSBAND->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_AGE__HUSBAND"));
		$this->AGE__HUSBAND->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_AGE__HUSBAND"));

		// ANXIOUS TO CONCEIVE FOR
		if (!$this->isAddOrEdit())
			$this->ANXIOUS_TO_CONCEIVE_FOR->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ANXIOUS_TO_CONCEIVE_FOR"));
		$this->ANXIOUS_TO_CONCEIVE_FOR->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ANXIOUS_TO_CONCEIVE_FOR"));

		// AMH ( NG/ML)
		if (!$this->isAddOrEdit())
			$this->AMH_28_NG2FML29->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_AMH_28_NG2FML29"));
		$this->AMH_28_NG2FML29->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_AMH_28_NG2FML29"));

		// TUBAL_PATENCY
		if (!$this->isAddOrEdit())
			$this->TUBAL_PATENCY->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TUBAL_PATENCY"));
		$this->TUBAL_PATENCY->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TUBAL_PATENCY"));

		// HSG
		if (!$this->isAddOrEdit())
			$this->HSG->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HSG"));
		$this->HSG->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HSG"));

		// DHL
		if (!$this->isAddOrEdit())
			$this->DHL->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DHL"));
		$this->DHL->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DHL"));

		// UTERINE_PROBLEMS
		if (!$this->isAddOrEdit())
			$this->UTERINE_PROBLEMS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_UTERINE_PROBLEMS"));
		$this->UTERINE_PROBLEMS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_UTERINE_PROBLEMS"));

		// W_COMORBIDS
		if (!$this->isAddOrEdit())
			$this->W_COMORBIDS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_W_COMORBIDS"));
		$this->W_COMORBIDS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_W_COMORBIDS"));

		// H_COMORBIDS
		if (!$this->isAddOrEdit())
			$this->H_COMORBIDS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_H_COMORBIDS"));
		$this->H_COMORBIDS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_H_COMORBIDS"));

		// SEXUAL_DYSFUNCTION
		if (!$this->isAddOrEdit())
			$this->SEXUAL_DYSFUNCTION->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SEXUAL_DYSFUNCTION"));
		$this->SEXUAL_DYSFUNCTION->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SEXUAL_DYSFUNCTION"));

		// PREV IUI
		if (!$this->isAddOrEdit())
			$this->PREV_IUI->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PREV_IUI"));
		$this->PREV_IUI->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PREV_IUI"));

		// PREV_IVF
		if (!$this->isAddOrEdit())
			$this->PREV_IVF->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PREV_IVF"));
		$this->PREV_IVF->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PREV_IVF"));

		// TABLETS
		if (!$this->isAddOrEdit())
			$this->TABLETS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TABLETS"));
		$this->TABLETS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TABLETS"));

		// INJTYPE
		if (!$this->isAddOrEdit())
			$this->INJTYPE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_INJTYPE"));
		$this->INJTYPE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_INJTYPE"));

		// LMP
		if (!$this->isAddOrEdit())
			$this->LMP->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_LMP"));
		$this->LMP->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_LMP"));

		// TRIGGERR
		if (!$this->isAddOrEdit())
			$this->TRIGGERR->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TRIGGERR"));
		$this->TRIGGERR->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TRIGGERR"));

		// TRIGGERDATE
		if (!$this->isAddOrEdit())
			$this->TRIGGERDATE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TRIGGERDATE"));
		$this->TRIGGERDATE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TRIGGERDATE"));

		// FOLLICLE_STATUS
		if (!$this->isAddOrEdit())
			$this->FOLLICLE_STATUS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_FOLLICLE_STATUS"));
		$this->FOLLICLE_STATUS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_FOLLICLE_STATUS"));

		// NUMBER_OF_IUI
		if (!$this->isAddOrEdit())
			$this->NUMBER_OF_IUI->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NUMBER_OF_IUI"));
		$this->NUMBER_OF_IUI->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NUMBER_OF_IUI"));
		...
		// LUTEAL_SUPPORT
		if (!$this->isAddOrEdit())
			$this->LUTEAL_SUPPORT->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_LUTEAL_SUPPORT"));
		$this->LUTEAL_SUPPORT->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_LUTEAL_SUPPORT"));

		// H/D SAMPLE
		if (!$this->isAddOrEdit())
			$this->H2FD_SAMPLE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_H2FD_SAMPLE"));
		$this->H2FD_SAMPLE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_H2FD_SAMPLE"));

		// DONOR - I.D
		if (!$this->isAddOrEdit())
			$this->DONOR___I_D->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DONOR___I_D"));
		$this->DONOR___I_D->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DONOR___I_D"));
		...
		// COLLECTION  METHOD
		if (!$this->isAddOrEdit())
			$this->COLLECTION__METHOD->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_COLLECTION__METHOD"));
		$this->COLLECTION__METHOD->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_COLLECTION__METHOD"));

		// SAMPLE SOURCE
		if (!$this->isAddOrEdit())
			$this->SAMPLE_SOURCE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SAMPLE_SOURCE"));
		$this->SAMPLE_SOURCE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SAMPLE_SOURCE"));
		...
		if (!$this->isAddOrEdit())
			$this->SPECIFIC_MATERNAL_PROBLEMS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SPECIFIC_MATERNAL_PROBLEMS"));
		$this->SPECIFIC_MATERNAL_PROBLEMS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SPECIFIC_MATERNAL_PROBLEMS"));

		// RESULTS
		if (!$this->isAddOrEdit())
			$this->RESULTS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_RESULTS"));
		$this->RESULTS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_RESULTS"));

		// ONGOING_PREG
		if (!$this->isAddOrEdit())
			$this->ONGOING_PREG->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ONGOING_PREG"));
		$this->ONGOING_PREG->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ONGOING_PREG"));

		// EDD_Date
		if (!$this->isAddOrEdit())
			$this->EDD_Date->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_EDD_Date"));
		$this->EDD_Date->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_EDD_Date"));
		$this->EDD_Date->AdvancedSearch->setSearchCondition($CurrentForm->getValue("v_EDD_Date"));
		$this->EDD_Date->AdvancedSearch->setSearchValue2($CurrentForm->getValue("y_EDD_Date"));
		$this->EDD_Date->AdvancedSearch->setSearchOperator2($CurrentForm->getValue("w_EDD_Date"));
	}
