 ...
 * Page class
 */
class employee_immigrations_delete extends employee_immigrations
{
	...
	// Page object name
	public $PageObjName = "employee_immigrations_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_immigrationslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_immigrationslist.php"); // Return to list
			}
		}
	}
