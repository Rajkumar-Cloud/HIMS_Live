 ...
 * Page class
 */
class employee_leaves_edit extends employee_leaves
{
	...
	// Page object name
	public $PageObjName = "employee_leaves_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// leave_period
			$this->leave_period->setDbValueDef($rsnew, $this->leave_period->CurrentValue, 0, $this->leave_period->ReadOnly);
