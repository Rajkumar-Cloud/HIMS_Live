 ...
 * Page class
 */
class billing_other_voucher_delete extends billing_other_voucher
{
	...
	// Page object name
	public $PageObjName = "billing_other_voucher_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("billing_other_voucherlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("billing_other_voucherlist.php"); // Return to list
			}
		}
	}
