 ...
 * Page class
 */
class ivf_donorsemendetails_delete extends ivf_donorsemendetails
{
	...
	// Page object name
	public $PageObjName = "ivf_donorsemendetails_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_donorsemendetailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("ivf_donorsemendetailslist.php"); // Return to list
			}
		}
	}
