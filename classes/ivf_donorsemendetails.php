...
class ivf_donorsemendetails extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNo
		$this->RIDNo = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNo->Sortable = FALSE; // Allow sort
		$this->RIDNo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNo'] = &$this->RIDNo;

		// TidNo
		$this->TidNo = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Agency
		$this->Agency = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Agency', 'Agency', '`Agency`', '`Agency`', 200, -1, FALSE, '`Agency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Agency->Sortable = FALSE; // Allow sort
		$this->fields['Agency'] = &$this->Agency;

		// ReceivedOn
		$this->ReceivedOn = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_ReceivedOn', 'ReceivedOn', '`ReceivedOn`', CastDateFieldForLike('`ReceivedOn`', 0, "DB"), 135, 0, FALSE, '`ReceivedOn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceivedBy
		$this->ReceivedBy = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_ReceivedBy', 'ReceivedBy', '`ReceivedBy`', '`ReceivedBy`', 200, -1, FALSE, '`ReceivedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReceivedBy->Sortable = FALSE; // Allow sort
		$this->fields['ReceivedBy'] = &$this->ReceivedBy;

		// DonorNo
		$this->DonorNo = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_DonorNo', 'DonorNo', '`DonorNo`', '`DonorNo`', 200, -1, FALSE, '`DonorNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DonorNo->Sortable = TRUE; // Allow sort
		$this->fields['DonorNo'] = &$this->DonorNo;

		// BatchNo
		$this->BatchNo = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, -1, FALSE, '`BatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchNo->Sortable = TRUE; // Allow sort
		$this->fields['BatchNo'] = &$this->BatchNo;

		// BloodGroup
		$this->BloodGroup = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_BloodGroup', 'BloodGroup', '`BloodGroup`', '`BloodGroup`', 200, -1, FALSE, '`BloodGroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Height
		$this->Height = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Height', 'Height', '`Height`', '`Height`', 200, -1, FALSE, '`Height`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Height->Sortable = TRUE; // Allow sort
		$this->fields['Height'] = &$this->Height;

		// SkinColor
		$this->SkinColor = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_SkinColor', 'SkinColor', '`SkinColor`', '`SkinColor`', 200, -1, FALSE, '`SkinColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// EyeColor
		$this->EyeColor = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_EyeColor', 'EyeColor', '`EyeColor`', '`EyeColor`', 200, -1, FALSE, '`EyeColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HairColor
		$this->HairColor = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_HairColor', 'HairColor', '`HairColor`', '`HairColor`', 200, -1, FALSE, '`HairColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NoOfVials
		$this->NoOfVials = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_NoOfVials', 'NoOfVials', '`NoOfVials`', '`NoOfVials`', 200, -1, FALSE, '`NoOfVials`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoOfVials->Sortable = TRUE; // Allow sort
		$this->fields['NoOfVials'] = &$this->NoOfVials;

		// Tank
		$this->Tank = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Tank', 'Tank', '`Tank`', '`Tank`', 200, -1, FALSE, '`Tank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tank->Sortable = TRUE; // Allow sort
		$this->fields['Tank'] = &$this->Tank;

		// Canister
		$this->Canister = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Canister', 'Canister', '`Canister`', '`Canister`', 200, -1, FALSE, '`Canister`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Canister->Sortable = TRUE; // Allow sort
		$this->fields['Canister'] = &$this->Canister;

		// Remarks
		$this->Remarks = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// patientid
		$this->patientid = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_patientid', 'patientid', '`patientid`', '`patientid`', 3, -1, FALSE, '`patientid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->patientid->Sortable = FALSE; // Allow sort
		$this->patientid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['patientid'] = &$this->patientid;

		// coupleid
		$this->coupleid = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_coupleid', 'coupleid', '`coupleid`', '`coupleid`', 3, -1, FALSE, '`coupleid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Usedstatus
		$this->Usedstatus = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Usedstatus', 'Usedstatus', '`Usedstatus`', '`Usedstatus`', 3, -1, FALSE, '`Usedstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = FALSE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// createdby
		$this->createdby = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = FALSE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = FALSE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = FALSE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = FALSE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// Lagency
		$this->Lagency = new DbField('ivf_donorsemendetails', 'ivf_donorsemendetails', 'x_Lagency', 'Lagency', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_donorsemendetailsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
