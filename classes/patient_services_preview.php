...
class patient_services_preview extends patient_services
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "billing_voucher") {
			$url = "" . TABLE_SHOW_MASTER . "=billing_voucher&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		if ($masterTblVar == "ip_admission") {
			$url = "" . TABLE_SHOW_MASTER . "=ip_admission&fk_id=" . urlencode(strval($this->Reception->QueryStringValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnno->QueryStringValue)) . "&fk_patient_id=" . urlencode(strval($this->PatID->QueryStringValue)) . "";
		}
		return $url;
	}
