 ...
 * Page class
 */
class crm_leads_relation_add extends crm_leads_relation
{
	...
	// Page object name
	public $PageObjName = "crm_leads_relation_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("leads_relationid") !== NULL) {
				...
				$this->setKey("leads_relationid", $this->leads_relationid->CurrentValue); // Set up key
			} else {
				$this->setKey("leads_relationid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "crm_leads_relationview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->leads_relationid->OldValue = $this->leads_relationid->CurrentValue;
		$this->leads_relation->CurrentValue = NULL;
		$this->leads_relation->OldValue = $this->leads_relation->CurrentValue;
		$this->sortorderid->CurrentValue = NULL;
		$this->sortorderid->OldValue = $this->sortorderid->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['leads_relationid'] = $this->leads_relationid->CurrentValue;
		$row['leads_relation'] = $this->leads_relation->CurrentValue;
		$row['sortorderid'] = $this->sortorderid->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// leads_relation
		$this->leads_relation->setDbValueDef($rsnew, $this->leads_relation->CurrentValue, "", FALSE);

		// sortorderid
		$this->sortorderid->setDbValueDef($rsnew, $this->sortorderid->CurrentValue, NULL, FALSE);
