 ...
 */
class view_pharmacy_purchaseorder_new extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// PrName
		$this->PrName = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, -1, FALSE, '`PrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PrName->Sortable = TRUE; // Allow sort
		$this->fields['PrName'] = &$this->PrName;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PSGST
		$this->PSGST = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCGST
		$this->PCGST = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SSGST
		$this->SSGST = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SCGST
		$this->SCGST = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalRate
		$this->SalRate = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, -1, FALSE, '`SalRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurValue
		$this->PurValue = new DbField('view_pharmacy_purchaseorder_new', 'view_pharmacy_purchaseorder_new', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_purchaseorder_newlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_purchaseorder_newview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_purchaseorder_newedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_purchaseorder_newadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_purchaseorder_newview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_purchaseorder_newview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_purchaseorder_newadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_purchaseorder_newadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_purchaseorder_newedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_purchaseorder_newadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_purchaseorder_newdelete.php", $this->getUrlParm());
	}
