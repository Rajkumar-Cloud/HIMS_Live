 ...
 * Page class
 */
class employee_permissions_edit extends employee_permissions
{
	...
	// Page object name
	public $PageObjName = "employee_permissions_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// module_id
			$this->module_id->setDbValueDef($rsnew, $this->module_id->CurrentValue, 0, $this->module_id->ReadOnly);

			// permission
			$this->permission->setDbValueDef($rsnew, $this->permission->CurrentValue, NULL, $this->permission->ReadOnly);
