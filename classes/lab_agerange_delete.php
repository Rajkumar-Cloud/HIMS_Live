 ...
 * Page class
 */
class lab_agerange_delete extends lab_agerange
{
	...
	// Page object name
	public $PageObjName = "lab_agerange_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lab_agerangelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("lab_agerangelist.php"); // Return to list
			}
		}
	}
