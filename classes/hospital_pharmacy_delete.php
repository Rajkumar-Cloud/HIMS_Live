 ...
 * Page class
 */
class hospital_pharmacy_delete extends hospital_pharmacy
{
	...
	// Page object name
	public $PageObjName = "hospital_pharmacy_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("hospital_pharmacylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hospital_pharmacylist.php"); // Return to list
			}
		}
	}
