 ...
 * Page class
 */
class view_billing_voucher_delete extends view_billing_voucher
{
	...
	// Page object name
	public $PageObjName = "view_billing_voucher_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_billing_voucherlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("view_billing_voucherlist.php"); // Return to list
			}
		}
	}
