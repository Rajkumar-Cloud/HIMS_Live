 ...
 * Page class
 */
class employee_has_degree_delete extends employee_has_degree
{
	...
	// Page object name
	public $PageObjName = "employee_has_degree_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_has_degreelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_has_degreelist.php"); // Return to list
			}
		}
	}
