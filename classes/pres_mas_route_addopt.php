 ...
 * Page class
 */
class pres_mas_route_addopt extends pres_mas_route
{
	...
	// Page object name
	public $PageObjName = "pres_mas_route_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->_Route->IsDetailKey) {
			$this->_Route->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->_Route->CurrentValue = ConvertToUtf8($this->_Route->FormValue);
	}
