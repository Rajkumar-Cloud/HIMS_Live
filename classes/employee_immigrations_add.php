 ...
 * Page class
 */
class employee_immigrations_add extends employee_immigrations
{
	...
	// Page object name
	public $PageObjName = "employee_immigrations_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "employee_immigrationsview.php")
