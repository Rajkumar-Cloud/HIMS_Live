...
class services extends DbTable
{
	...
	public function __construct()
	{
		...
		// Id
		$this->Id = new DbField('services', 'services', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DEPARTMENT
		$this->DEPARTMENT = new DbField('services', 'services', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, -1, FALSE, '`DEPARTMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEPARTMENT->Sortable = TRUE; // Allow sort
		$this->fields['DEPARTMENT'] = &$this->DEPARTMENT;

		// SERVICE_TYPE
		$this->SERVICE_TYPE = new DbField('services', 'services', 'x_SERVICE_TYPE', 'SERVICE_TYPE', '`SERVICE_TYPE`', '`SERVICE_TYPE`', 200, -1, FALSE, '`SERVICE_TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SERVICE_TYPE->Sortable = TRUE; // Allow sort
		$this->fields['SERVICE_TYPE'] = &$this->SERVICE_TYPE;

		// SERVICE
		$this->SERVICE = new DbField('services', 'services', 'x_SERVICE', 'SERVICE', '`SERVICE`', '`SERVICE`', 200, -1, FALSE, '`SERVICE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SERVICE->Sortable = TRUE; // Allow sort
		$this->fields['SERVICE'] = &$this->SERVICE;

		// CODE
		$this->CODE = new DbField('services', 'services', 'x_CODE', 'CODE', '`CODE`', '`CODE`', 200, -1, FALSE, '`CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CODE->Sortable = TRUE; // Allow sort
		$this->fields['CODE'] = &$this->CODE;

		// AMOUNT
		$this->AMOUNT = new DbField('services', 'services', 'x_AMOUNT', 'AMOUNT', '`AMOUNT`', '`AMOUNT`', 200, -1, FALSE, '`AMOUNT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("servicesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
