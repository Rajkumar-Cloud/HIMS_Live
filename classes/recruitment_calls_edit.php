 ...
 * Page class
 */
class recruitment_calls_edit extends recruitment_calls
{
	...
	// Page object name
	public $PageObjName = "recruitment_calls_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("recruitment_callslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "recruitment_callslist.php")
