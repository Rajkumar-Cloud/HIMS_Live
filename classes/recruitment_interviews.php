 ...
 */
class recruitment_interviews extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// job
		$this->job = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_job', 'job', '`job`', '`job`', 20, -1, FALSE, '`job`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// candidate
		$this->candidate = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_candidate', 'candidate', '`candidate`', '`candidate`', 20, -1, FALSE, '`candidate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// level
		$this->level = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_level', 'level', '`level`', '`level`', 200, -1, FALSE, '`level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->level->Sortable = TRUE; // Allow sort
		$this->fields['level'] = &$this->level;

		// created
		$this->created = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_created', 'created', '`created`', CastDateFieldForLike('`created`', 0, "DB"), 135, 0, FALSE, '`created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated
		$this->updated = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_updated', 'updated', '`updated`', CastDateFieldForLike('`updated`', 0, "DB"), 135, 0, FALSE, '`updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// scheduled
		$this->scheduled = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_scheduled', 'scheduled', '`scheduled`', CastDateFieldForLike('`scheduled`', 0, "DB"), 135, 0, FALSE, '`scheduled`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// location
		$this->location = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_location', 'location', '`location`', '`location`', 201, -1, FALSE, '`location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->location->Sortable = TRUE; // Allow sort
		$this->fields['location'] = &$this->location;

		// mapId
		$this->mapId = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_mapId', 'mapId', '`mapId`', '`mapId`', 20, -1, FALSE, '`mapId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->fields['status'] = &$this->status;

		// notes
		$this->notes = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_notes', 'notes', '`notes`', '`notes`', 201, -1, FALSE, '`notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "recruitment_interviewslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "recruitment_interviewsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "recruitment_interviewsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "recruitment_interviewsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("recruitment_interviewsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("recruitment_interviewsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "recruitment_interviewsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "recruitment_interviewsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("recruitment_interviewsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("recruitment_interviewsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("recruitment_interviewsdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->candidate->setDbValue($rs->fields('candidate'));
		$this->level->setDbValue($rs->fields('level'));
		$this->created->setDbValue($rs->fields('created'));
		$this->updated->setDbValue($rs->fields('updated'));
		$this->scheduled->setDbValue($rs->fields('scheduled'));
		$this->location->setDbValue($rs->fields('location'));
		$this->mapId->setDbValue($rs->fields('mapId'));
