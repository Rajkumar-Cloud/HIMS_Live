 ...
 */
class view_pharmacy_report_stock_value_max extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// prc
		$this->prc = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_prc', 'prc', '`prc`', '`prc`', 200, -1, FALSE, '`prc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->prc->Sortable = TRUE; // Allow sort
		$this->fields['prc'] = &$this->prc;

		// batchno
		$this->batchno = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_batchno', 'batchno', '`batchno`', '`batchno`', 200, -1, FALSE, '`batchno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->batchno->Sortable = TRUE; // Allow sort
		$this->fields['batchno'] = &$this->batchno;

		// mrp
		$this->mrp = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_mrp', 'mrp', '`mrp`', '`mrp`', 131, -1, FALSE, '`mrp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrp->Sortable = TRUE; // Allow sort
		$this->mrp->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['mrp'] = &$this->mrp;

		// purvalue
		$this->purvalue = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_purvalue', 'purvalue', '`purvalue`', '`purvalue`', 131, -1, FALSE, '`purvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// hospid
		$this->hospid = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_hospid', 'hospid', '`hospid`', '`hospid`', 3, -1, FALSE, '`hospid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hospid->Sortable = TRUE; // Allow sort
		$this->hospid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['hospid'] = &$this->hospid;

		// punit
		$this->punit = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_punit', 'punit', '`punit`', '`punit`', 3, -1, FALSE, '`punit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// brcode
		$this->brcode = new DbField('view_pharmacy_report_stock_value_max', 'view_pharmacy_report_stock_value_max', 'x_brcode', 'brcode', '`brcode`', '`brcode`', 3, -1, FALSE, '`brcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_report_stock_value_maxlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_report_stock_value_maxview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_report_stock_value_maxedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_report_stock_value_maxadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_report_stock_value_maxview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_report_stock_value_maxview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_report_stock_value_maxadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_report_stock_value_maxadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_report_stock_value_maxedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_report_stock_value_maxadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_report_stock_value_maxdelete.php", $this->getUrlParm());
	}
