 ...
 * Page class
 */
class ivf_vitals_history_preview extends ivf_vitals_history
{
	...
	// Page object name
	public $PageObjName = "ivf_vitals_history_preview";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'ivf_vitals_history');
			if ($Security->isLoggedIn())
