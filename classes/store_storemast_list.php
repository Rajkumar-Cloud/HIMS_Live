 ...
 * Page class
 */
class store_storemast_list extends store_storemast
{
	...
	// Page object name
	public $PageObjName = "store_storemast_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "store_storemastadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "store_storemastdelete.php";
		$this->MultiUpdateUrl = "store_storemastupdate.php";
	...
	public function getFilterList()
	{
		...
		if (SEARCH_FILTER_OPTION == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fstore_storemastlistsrch");
		...
		$filterList = Concat($filterList, $this->OV->AdvancedSearch->toJson(), ","); // Field OV
		$filterList = Concat($filterList, $this->LATESTOV->AdvancedSearch->toJson(), ","); // Field LATESTOV
		$filterList = Concat($filterList, $this->ITEMTYPE->AdvancedSearch->toJson(), ","); // Field ITEMTYPE
		$filterList = Concat($filterList, $this->ROWID->AdvancedSearch->toJson(), ","); // Field ROWID
		$filterList = Concat($filterList, $this->MOVED->AdvancedSearch->toJson(), ","); // Field MOVED
		$filterList = Concat($filterList, $this->NEWTAX->AdvancedSearch->toJson(), ","); // Field NEWTAX
		$filterList = Concat($filterList, $this->HSNCODE->AdvancedSearch->toJson(), ","); // Field HSNCODE
		$filterList = Concat($filterList, $this->OLDTAX->AdvancedSearch->toJson(), ","); // Field OLDTAX
	...
	protected function restoreFilterList()
	{
		...
		// Field OV
		$this->OV->AdvancedSearch->SearchValue = @$filter["x_OV"];
		$this->OV->AdvancedSearch->SearchOperator = @$filter["z_OV"];
		$this->OV->AdvancedSearch->SearchCondition = @$filter["v_OV"];
		$this->OV->AdvancedSearch->SearchValue2 = @$filter["y_OV"];
		$this->OV->AdvancedSearch->SearchOperator2 = @$filter["w_OV"];
		$this->OV->AdvancedSearch->save();

		// Field LATESTOV
		$this->LATESTOV->AdvancedSearch->SearchValue = @$filter["x_LATESTOV"];
		$this->LATESTOV->AdvancedSearch->SearchOperator = @$filter["z_LATESTOV"];
		$this->LATESTOV->AdvancedSearch->SearchCondition = @$filter["v_LATESTOV"];
		$this->LATESTOV->AdvancedSearch->SearchValue2 = @$filter["y_LATESTOV"];
		$this->LATESTOV->AdvancedSearch->SearchOperator2 = @$filter["w_LATESTOV"];
		$this->LATESTOV->AdvancedSearch->save();

		// Field ITEMTYPE
		$this->ITEMTYPE->AdvancedSearch->SearchValue = @$filter["x_ITEMTYPE"];
		$this->ITEMTYPE->AdvancedSearch->SearchOperator = @$filter["z_ITEMTYPE"];
		$this->ITEMTYPE->AdvancedSearch->SearchCondition = @$filter["v_ITEMTYPE"];
		$this->ITEMTYPE->AdvancedSearch->SearchValue2 = @$filter["y_ITEMTYPE"];
		$this->ITEMTYPE->AdvancedSearch->SearchOperator2 = @$filter["w_ITEMTYPE"];
		$this->ITEMTYPE->AdvancedSearch->save();
		...
		// Field MOVED
		$this->MOVED->AdvancedSearch->SearchValue = @$filter["x_MOVED"];
		$this->MOVED->AdvancedSearch->SearchOperator = @$filter["z_MOVED"];
		$this->MOVED->AdvancedSearch->SearchCondition = @$filter["v_MOVED"];
		$this->MOVED->AdvancedSearch->SearchValue2 = @$filter["y_MOVED"];
		$this->MOVED->AdvancedSearch->SearchOperator2 = @$filter["w_MOVED"];
		$this->MOVED->AdvancedSearch->save();

		// Field NEWTAX
		$this->NEWTAX->AdvancedSearch->SearchValue = @$filter["x_NEWTAX"];
		$this->NEWTAX->AdvancedSearch->SearchOperator = @$filter["z_NEWTAX"];
		$this->NEWTAX->AdvancedSearch->SearchCondition = @$filter["v_NEWTAX"];
		$this->NEWTAX->AdvancedSearch->SearchValue2 = @$filter["y_NEWTAX"];
		$this->NEWTAX->AdvancedSearch->SearchOperator2 = @$filter["w_NEWTAX"];
		$this->NEWTAX->AdvancedSearch->save();

		// Field HSNCODE
		$this->HSNCODE->AdvancedSearch->SearchValue = @$filter["x_HSNCODE"];
		$this->HSNCODE->AdvancedSearch->SearchOperator = @$filter["z_HSNCODE"];
		$this->HSNCODE->AdvancedSearch->SearchCondition = @$filter["v_HSNCODE"];
		$this->HSNCODE->AdvancedSearch->SearchValue2 = @$filter["y_HSNCODE"];
		$this->HSNCODE->AdvancedSearch->SearchOperator2 = @$filter["w_HSNCODE"];
		$this->HSNCODE->AdvancedSearch->save();

		// Field OLDTAX
		$this->OLDTAX->AdvancedSearch->SearchValue = @$filter["x_OLDTAX"];
		$this->OLDTAX->AdvancedSearch->SearchOperator = @$filter["z_OLDTAX"];
		$this->OLDTAX->AdvancedSearch->SearchCondition = @$filter["v_OLDTAX"];
		$this->OLDTAX->AdvancedSearch->SearchValue2 = @$filter["y_OLDTAX"];
		$this->OLDTAX->AdvancedSearch->SearchOperator2 = @$filter["w_OLDTAX"];
		$this->OLDTAX->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->ITEMTYPE, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ROWID, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->HSNCODE, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->OV); // OV
			$this->updateSort($this->LATESTOV); // LATESTOV
			$this->updateSort($this->ITEMTYPE); // ITEMTYPE
			$this->updateSort($this->ROWID); // ROWID
			$this->updateSort($this->MOVED); // MOVED
			$this->updateSort($this->NEWTAX); // NEWTAX
			$this->updateSort($this->HSNCODE); // HSNCODE
			$this->updateSort($this->OLDTAX); // OLDTAX
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fstore_storemastlistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fstore_storemastlistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fstore_storemastlist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fstore_storemastlistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fstore_storemastlist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fstore_storemastlist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fstore_storemastlist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
