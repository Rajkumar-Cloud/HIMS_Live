...
class mas_reference_type extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('mas_reference_type', 'mas_reference_type', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// reference
		$this->reference = new DbField('mas_reference_type', 'mas_reference_type', 'x_reference', 'reference', '`reference`', '`reference`', 200, -1, FALSE, '`reference`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReferMobileNo
		$this->ReferMobileNo = new DbField('mas_reference_type', 'mas_reference_type', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, -1, FALSE, '`ReferMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['ReferMobileNo'] = &$this->ReferMobileNo;

		// ReferClinicname
		$this->ReferClinicname = new DbField('mas_reference_type', 'mas_reference_type', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, -1, FALSE, '`ReferClinicname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferClinicname->Sortable = TRUE; // Allow sort
		$this->fields['ReferClinicname'] = &$this->ReferClinicname;

		// ReferCity
		$this->ReferCity = new DbField('mas_reference_type', 'mas_reference_type', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, -1, FALSE, '`ReferCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferCity->Sortable = TRUE; // Allow sort
		$this->fields['ReferCity'] = &$this->ReferCity;

		// HospID
		$this->HospID = new DbField('mas_reference_type', 'mas_reference_type', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// email
		$this->_email = new DbField('mas_reference_type', 'mas_reference_type', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->fields['email'] = &$this->_email;

		// whatapp
		$this->whatapp = new DbField('mas_reference_type', 'mas_reference_type', 'x_whatapp', 'whatapp', '`whatapp`', '`whatapp`', 200, -1, FALSE, '`whatapp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("mas_reference_typeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->whatapp->setDbValue($rs->fields('whatapp'));
	}
