 ...
 * Page class
 */
class qaqcrecord_andrology_delete extends qaqcrecord_andrology
{
	...
	// Page object name
	public $PageObjName = "qaqcrecord_andrology_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("qaqcrecord_andrologylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("qaqcrecord_andrologylist.php"); // Return to list
			}
		}
	}
