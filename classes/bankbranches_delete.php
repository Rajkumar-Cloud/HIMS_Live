 ...
 * Page class
 */
class bankbranches_delete extends bankbranches
{
	...
	// Page object name
	public $PageObjName = "bankbranches_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bankbrancheslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("bankbrancheslist.php"); // Return to list
			}
		}
	}
