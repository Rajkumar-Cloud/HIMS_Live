...
class patient extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient', 'patient', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PatientID
		$this->PatientID = new DbField('patient', 'patient', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// title
		$this->title = new DbField('patient', 'patient', 'x_title', 'title', '`title`', '`title`', 3, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// first_name
		$this->first_name = new DbField('patient', 'patient', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Required = TRUE; // Required field
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// middle_name
		$this->middle_name = new DbField('patient', 'patient', 'x_middle_name', 'middle_name', '`middle_name`', '`middle_name`', 200, -1, FALSE, '`middle_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->middle_name->Sortable = FALSE; // Allow sort
		$this->fields['middle_name'] = &$this->middle_name;

		// last_name
		$this->last_name = new DbField('patient', 'patient', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, -1, FALSE, '`last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->last_name->Sortable = FALSE; // Allow sort
		$this->fields['last_name'] = &$this->last_name;

		// gender
		$this->gender = new DbField('patient', 'patient', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// dob
		$this->dob = new DbField('patient', 'patient', 'x_dob', 'dob', '`dob`', CastDateFieldForLike('`dob`', 7, "DB"), 133, 7, FALSE, '`dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Age
		$this->Age = new DbField('patient', 'patient', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = FALSE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// blood_group
		$this->blood_group = new DbField('patient', 'patient', 'x_blood_group', 'blood_group', '`blood_group`', '`blood_group`', 200, -1, FALSE, '`blood_group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mobile_no
		$this->mobile_no = new DbField('patient', 'patient', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_no->Required = TRUE; // Required field
		$this->mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['mobile_no'] = &$this->mobile_no;

		// description
		$this->description = new DbField('patient', 'patient', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->description->Sortable = FALSE; // Allow sort
		$this->fields['description'] = &$this->description;

		// status
		$this->status = new DbField('patient', 'patient', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('patient', 'patient', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = FALSE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('patient', 'patient', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('patient', 'patient', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = FALSE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('patient', 'patient', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = FALSE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// profilePic
		$this->profilePic = new DbField('patient', 'patient', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 200, -1, TRUE, '`profilePic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->profilePic->ImageResize = TRUE;
		$this->fields['profilePic'] = &$this->profilePic;

		// IdentificationMark
		$this->IdentificationMark = new DbField('patient', 'patient', 'x_IdentificationMark', 'IdentificationMark', '`IdentificationMark`', '`IdentificationMark`', 200, -1, FALSE, '`IdentificationMark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Religion
		$this->Religion = new DbField('patient', 'patient', 'x_Religion', 'Religion', '`Religion`', '`Religion`', 200, -1, FALSE, '`Religion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Religion->Sortable = TRUE; // Allow sort
		$this->fields['Religion'] = &$this->Religion;

		// Nationality
		$this->Nationality = new DbField('patient', 'patient', 'x_Nationality', 'Nationality', '`Nationality`', '`Nationality`', 200, -1, FALSE, '`Nationality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReferedByDr
		$this->ReferedByDr = new DbField('patient', 'patient', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, -1, FALSE, '`EV__ReferedByDr`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// ReferClinicname
		$this->ReferClinicname = new DbField('patient', 'patient', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, -1, FALSE, '`ReferClinicname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferClinicname->Sortable = FALSE; // Allow sort
		$this->fields['ReferClinicname'] = &$this->ReferClinicname;

		// ReferCity
		$this->ReferCity = new DbField('patient', 'patient', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, -1, FALSE, '`ReferCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferCity->Sortable = FALSE; // Allow sort
		$this->fields['ReferCity'] = &$this->ReferCity;

		// ReferMobileNo
		$this->ReferMobileNo = new DbField('patient', 'patient', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, -1, FALSE, '`ReferMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['ReferMobileNo'] = &$this->ReferMobileNo;

		// ReferA4TreatingConsultant
		$this->ReferA4TreatingConsultant = new DbField('patient', 'patient', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, -1, FALSE, '`EV__ReferA4TreatingConsultant`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// PurposreReferredfor
		$this->PurposreReferredfor = new DbField('patient', 'patient', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, -1, FALSE, '`PurposreReferredfor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spouse_title
		$this->spouse_title = new DbField('patient', 'patient', 'x_spouse_title', 'spouse_title', '`spouse_title`', '`spouse_title`', 200, -1, FALSE, '`spouse_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// spouse_first_name
		$this->spouse_first_name = new DbField('patient', 'patient', 'x_spouse_first_name', 'spouse_first_name', '`spouse_first_name`', '`spouse_first_name`', 200, -1, FALSE, '`spouse_first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spouse_middle_name
		$this->spouse_middle_name = new DbField('patient', 'patient', 'x_spouse_middle_name', 'spouse_middle_name', '`spouse_middle_name`', '`spouse_middle_name`', 200, -1, FALSE, '`spouse_middle_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_middle_name->Sortable = FALSE; // Allow sort
		$this->fields['spouse_middle_name'] = &$this->spouse_middle_name;

		// spouse_last_name
		$this->spouse_last_name = new DbField('patient', 'patient', 'x_spouse_last_name', 'spouse_last_name', '`spouse_last_name`', '`spouse_last_name`', 200, -1, FALSE, '`spouse_last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_last_name->Sortable = FALSE; // Allow sort
		$this->fields['spouse_last_name'] = &$this->spouse_last_name;

		// spouse_gender
		$this->spouse_gender = new DbField('patient', 'patient', 'x_spouse_gender', 'spouse_gender', '`spouse_gender`', '`spouse_gender`', 200, -1, FALSE, '`spouse_gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// spouse_dob
		$this->spouse_dob = new DbField('patient', 'patient', 'x_spouse_dob', 'spouse_dob', '`spouse_dob`', CastDateFieldForLike('`spouse_dob`', 7, "DB"), 133, 7, FALSE, '`spouse_dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_dob->Sortable = FALSE; // Allow sort
		$this->fields['spouse_dob'] = &$this->spouse_dob;

		// spouse_Age
		$this->spouse_Age = new DbField('patient', 'patient', 'x_spouse_Age', 'spouse_Age', '`spouse_Age`', '`spouse_Age`', 200, -1, FALSE, '`spouse_Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spouse_blood_group
		$this->spouse_blood_group = new DbField('patient', 'patient', 'x_spouse_blood_group', 'spouse_blood_group', '`spouse_blood_group`', '`spouse_blood_group`', 200, -1, FALSE, '`spouse_blood_group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// spouse_mobile_no
		$this->spouse_mobile_no = new DbField('patient', 'patient', 'x_spouse_mobile_no', 'spouse_mobile_no', '`spouse_mobile_no`', '`spouse_mobile_no`', 200, -1, FALSE, '`spouse_mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Maritalstatus
		$this->Maritalstatus = new DbField('patient', 'patient', 'x_Maritalstatus', 'Maritalstatus', '`Maritalstatus`', '`Maritalstatus`', 200, -1, FALSE, '`Maritalstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Business
		$this->Business = new DbField('patient', 'patient', 'x_Business', 'Business', '`Business`', '`Business`', 200, -1, FALSE, '`Business`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Patient_Language
		$this->Patient_Language = new DbField('patient', 'patient', 'x_Patient_Language', 'Patient_Language', '`Patient_Language`', '`Patient_Language`', 200, -1, FALSE, '`Patient_Language`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Passport
		$this->Passport = new DbField('patient', 'patient', 'x_Passport', 'Passport', '`Passport`', '`Passport`', 200, -1, FALSE, '`Passport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Passport->Sortable = TRUE; // Allow sort
		$this->fields['Passport'] = &$this->Passport;

		// VisaNo
		$this->VisaNo = new DbField('patient', 'patient', 'x_VisaNo', 'VisaNo', '`VisaNo`', '`VisaNo`', 200, -1, FALSE, '`VisaNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VisaNo->Sortable = TRUE; // Allow sort
		$this->fields['VisaNo'] = &$this->VisaNo;

		// ValidityOfVisa
		$this->ValidityOfVisa = new DbField('patient', 'patient', 'x_ValidityOfVisa', 'ValidityOfVisa', '`ValidityOfVisa`', '`ValidityOfVisa`', 200, -1, FALSE, '`ValidityOfVisa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ValidityOfVisa->Sortable = FALSE; // Allow sort
		$this->fields['ValidityOfVisa'] = &$this->ValidityOfVisa;

		// WhereDidYouHear
		$this->WhereDidYouHear = new DbField('patient', 'patient', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, -1, FALSE, '`WhereDidYouHear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// HospID
		$this->HospID = new DbField('patient', 'patient', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// street
		$this->street = new DbField('patient', 'patient', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->street->Sortable = FALSE; // Allow sort
		$this->fields['street'] = &$this->street;

		// town
		$this->town = new DbField('patient', 'patient', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Required = TRUE; // Required field
		$this->town->Sortable = FALSE; // Allow sort
		$this->fields['town'] = &$this->town;

		// province
		$this->province = new DbField('patient', 'patient', 'x_province', 'province', '`province`', '`province`', 200, -1, FALSE, '`province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->province->Required = TRUE; // Required field
		$this->province->Sortable = TRUE; // Allow sort
		$this->fields['province'] = &$this->province;

		// country
		$this->country = new DbField('patient', 'patient', 'x_country', 'country', '`country`', '`country`', 200, -1, FALSE, '`country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->country->Required = TRUE; // Required field
		$this->country->Sortable = TRUE; // Allow sort
		$this->fields['country'] = &$this->country;

		// postal_code
		$this->postal_code = new DbField('patient', 'patient', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, -1, FALSE, '`postal_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PEmail
		$this->PEmail = new DbField('patient', 'patient', 'x_PEmail', 'PEmail', '`PEmail`', '`PEmail`', 200, -1, FALSE, '`PEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PEmail->Sortable = TRUE; // Allow sort
		$this->fields['PEmail'] = &$this->PEmail;

		// PEmergencyContact
		$this->PEmergencyContact = new DbField('patient', 'patient', 'x_PEmergencyContact', 'PEmergencyContact', '`PEmergencyContact`', '`PEmergencyContact`', 200, -1, FALSE, '`PEmergencyContact`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// occupation
		$this->occupation = new DbField('patient', 'patient', 'x_occupation', 'occupation', '`occupation`', '`occupation`', 200, -1, FALSE, '`occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->occupation->Sortable = FALSE; // Allow sort
		$this->fields['occupation'] = &$this->occupation;

		// spouse_occupation
		$this->spouse_occupation = new DbField('patient', 'patient', 'x_spouse_occupation', 'spouse_occupation', '`spouse_occupation`', '`spouse_occupation`', 200, -1, FALSE, '`spouse_occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_occupation->Sortable = FALSE; // Allow sort
		$this->fields['spouse_occupation'] = &$this->spouse_occupation;

		// WhatsApp
		$this->WhatsApp = new DbField('patient', 'patient', 'x_WhatsApp', 'WhatsApp', '`WhatsApp`', '`WhatsApp`', 200, -1, FALSE, '`WhatsApp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WhatsApp->Sortable = FALSE; // Allow sort
		$this->fields['WhatsApp'] = &$this->WhatsApp;

		// CouppleID
		$this->CouppleID = new DbField('patient', 'patient', 'x_CouppleID', 'CouppleID', '`CouppleID`', '`CouppleID`', 3, -1, FALSE, '`CouppleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MaleID
		$this->MaleID = new DbField('patient', 'patient', 'x_MaleID', 'MaleID', '`MaleID`', '`MaleID`', 3, -1, FALSE, '`MaleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FemaleID
		$this->FemaleID = new DbField('patient', 'patient', 'x_FemaleID', 'FemaleID', '`FemaleID`', '`FemaleID`', 3, -1, FALSE, '`FemaleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GroupID
		$this->GroupID = new DbField('patient', 'patient', 'x_GroupID', 'GroupID', '`GroupID`', '`GroupID`', 3, -1, FALSE, '`GroupID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Relationship
		$this->Relationship = new DbField('patient', 'patient', 'x_Relationship', 'Relationship', '`Relationship`', '`Relationship`', 200, -1, FALSE, '`Relationship`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Relationship->Sortable = FALSE; // Allow sort
		$this->fields['Relationship'] = &$this->Relationship;

		// AppointmentSearch
		$this->AppointmentSearch = new DbField('patient', 'patient', 'x_AppointmentSearch', 'AppointmentSearch', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// FacebookID
		$this->FacebookID = new DbField('patient', 'patient', 'x_FacebookID', 'FacebookID', '`FacebookID`', '`FacebookID`', 200, -1, FALSE, '`FacebookID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FacebookID->Sortable = FALSE; // Allow sort
		$this->fields['FacebookID'] = &$this->FacebookID;

		// profilePicImage
		$this->profilePicImage = new DbField('patient', 'patient', 'x_profilePicImage', 'profilePicImage', '`profilePicImage`', '`profilePicImage`', 205, -1, TRUE, '`profilePicImage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->profilePicImage->Sortable = FALSE; // Allow sort
		$this->fields['profilePicImage'] = &$this->profilePicImage;

		// Clients
		$this->Clients = new DbField('patient', 'patient', 'x_Clients', 'Clients', '`Clients`', '`Clients`', 200, -1, FALSE, '`Clients`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "patient_address") {
			$detailUrl = $GLOBALS["patient_address"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_email") {
			$detailUrl = $GLOBALS["patient_email"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_telephone") {
			$detailUrl = $GLOBALS["patient_telephone"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_emergency_contact") {
			$detailUrl = $GLOBALS["patient_emergency_contact"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_document") {
			$detailUrl = $GLOBALS["patient_document"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patientview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patientedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patientadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->profilePicImage->Upload->DbValue = $rs->fields('profilePicImage');
