 ...
 * Page class
 */
class view_ivf_oocytedenudation_embryology_chart_view extends view_ivf_oocytedenudation_embryology_chart
{
	...
	// Page object name
	public $PageObjName = "view_ivf_oocytedenudation_embryology_chart_view";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["view_ivf_oocytedenudation_embryology_chart"]) || get_class($GLOBALS["view_ivf_oocytedenudation_embryology_chart"]) == PROJECT_NAMESPACE . "view_ivf_oocytedenudation_embryology_chart") {
			...
			$GLOBALS["Table"] = &$GLOBALS["view_ivf_oocytedenudation_embryology_chart"];
		}
		$keyUrl = "";
		if (Get("id") !== NULL) {
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $view_ivf_oocytedenudation_embryology_chart;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($view_ivf_oocytedenudation_embryology_chart);
				$doc->Text = @$content;
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("view_ivf_oocytedenudation_embryology_chartlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "view_ivf_oocytedenudation_embryology_chartlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "view_ivf_oocytedenudation_embryology_chartlist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "view_ivf_oocytedenudation_embryology_chartlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fview_ivf_oocytedenudation_embryology_chartview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fview_ivf_oocytedenudation_embryology_chartview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fview_ivf_oocytedenudation_embryology_chartview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_view_ivf_oocytedenudation_embryology_chart\" class=\"ew-export-link ew-email\" title=\"" . $Language->phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_view_ivf_oocytedenudation_embryology_chart',hdr:ew.language.phrase('ExportToEmailText'),f:document.fview_ivf_oocytedenudation_embryology_chartview,key:" . ArrayToJsonAttribute($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("view_ivf_oocytedenudation_embryology_chartlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
