...
class doctors extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('doctors', 'doctors', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// CODE
		$this->CODE = new DbField('doctors', 'doctors', 'x_CODE', 'CODE', '`CODE`', '`CODE`', 200, -1, FALSE, '`CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CODE->Required = TRUE; // Required field
		$this->CODE->Sortable = TRUE; // Allow sort
		$this->fields['CODE'] = &$this->CODE;

		// NAME
		$this->NAME = new DbField('doctors', 'doctors', 'x_NAME', 'NAME', '`NAME`', '`NAME`', 200, -1, FALSE, '`NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NAME->Required = TRUE; // Required field
		$this->NAME->Sortable = TRUE; // Allow sort
		$this->fields['NAME'] = &$this->NAME;

		// DEPARTMENT
		$this->DEPARTMENT = new DbField('doctors', 'doctors', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, -1, FALSE, '`DEPARTMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEPARTMENT->Required = TRUE; // Required field
		$this->DEPARTMENT->Sortable = TRUE; // Allow sort
		$this->fields['DEPARTMENT'] = &$this->DEPARTMENT;

		// start_time
		$this->start_time = new DbField('doctors', 'doctors', 'x_start_time', 'start_time', '`start_time`', '`start_time`', 200, 4, FALSE, '`start_time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->start_time->Sortable = TRUE; // Allow sort
		$this->fields['start_time'] = &$this->start_time;

		// end_time
		$this->end_time = new DbField('doctors', 'doctors', 'x_end_time', 'end_time', '`end_time`', '`end_time`', 200, 4, FALSE, '`end_time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->end_time->Sortable = TRUE; // Allow sort
		$this->fields['end_time'] = &$this->end_time;

		// start_time1
		$this->start_time1 = new DbField('doctors', 'doctors', 'x_start_time1', 'start_time1', '`start_time1`', '`start_time1`', 200, 4, FALSE, '`start_time1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->start_time1->Sortable = TRUE; // Allow sort
		$this->fields['start_time1'] = &$this->start_time1;

		// end_time1
		$this->end_time1 = new DbField('doctors', 'doctors', 'x_end_time1', 'end_time1', '`end_time1`', '`end_time1`', 200, 4, FALSE, '`end_time1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->end_time1->Sortable = TRUE; // Allow sort
		$this->fields['end_time1'] = &$this->end_time1;

		// start_time2
		$this->start_time2 = new DbField('doctors', 'doctors', 'x_start_time2', 'start_time2', '`start_time2`', '`start_time2`', 200, 4, FALSE, '`start_time2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->start_time2->Sortable = TRUE; // Allow sort
		$this->fields['start_time2'] = &$this->start_time2;

		// end_time2
		$this->end_time2 = new DbField('doctors', 'doctors', 'x_end_time2', 'end_time2', '`end_time2`', '`end_time2`', 200, 4, FALSE, '`end_time2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->end_time2->Sortable = TRUE; // Allow sort
		$this->fields['end_time2'] = &$this->end_time2;

		// slot_time
		$this->slot_time = new DbField('doctors', 'doctors', 'x_slot_time', 'slot_time', '`slot_time`', '`slot_time`', 200, -1, FALSE, '`slot_time`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fees
		$this->Fees = new DbField('doctors', 'doctors', 'x_Fees', 'Fees', '`Fees`', '`Fees`', 5, -1, FALSE, '`Fees`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fees->Sortable = TRUE; // Allow sort
		$this->Fees->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Fees'] = &$this->Fees;

		// ProfilePic
		$this->ProfilePic = new DbField('doctors', 'doctors', 'x_ProfilePic', 'ProfilePic', '`ProfilePic`', '`ProfilePic`', 201, -1, TRUE, '`ProfilePic`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->ProfilePic->Sortable = TRUE; // Allow sort
		$this->fields['ProfilePic'] = &$this->ProfilePic;

		// slot_days
		$this->slot_days = new DbField('doctors', 'doctors', 'x_slot_days', 'slot_days', '`slot_days`', '`slot_days`', 200, -1, FALSE, '`slot_days`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Status
		$this->Status = new DbField('doctors', 'doctors', 'x_Status', 'Status', '`Status`', '`Status`', 3, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// scheduler_id
		$this->scheduler_id = new DbField('doctors', 'doctors', 'x_scheduler_id', 'scheduler_id', '`scheduler_id`', '`scheduler_id`', 200, -1, FALSE, '`scheduler_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->scheduler_id->Sortable = TRUE; // Allow sort
		$this->fields['scheduler_id'] = &$this->scheduler_id;

		// HospID
		$this->HospID = new DbField('doctors', 'doctors', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// Designation
		$this->Designation = new DbField('doctors', 'doctors', 'x_Designation', 'Designation', '`Designation`', '`Designation`', 200, -1, FALSE, '`Designation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("doctorsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("doctorsedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("doctorsadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
