...
class pharmacy_services_preview extends pharmacy_services
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "pharmacy") {
			$url = "" . TABLE_SHOW_MASTER . "=pharmacy&fk_id=" . urlencode(strval($this->pharmacy_id->QueryStringValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->QueryStringValue)) . "";
		}
		if ($masterTblVar == "mas_pharmacy") {
			$url = "" . TABLE_SHOW_MASTER . "=mas_pharmacy&fk_name=" . urlencode(strval($this->name->QueryStringValue)) . "&fk_amount=" . urlencode(strval($this->amount->QueryStringValue)) . "&fk_description=" . urlencode(strval($this->description->QueryStringValue)) . "";
		}
		return $url;
	}
