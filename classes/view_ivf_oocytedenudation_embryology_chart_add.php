 ...
 * Page class
 */
class view_ivf_oocytedenudation_embryology_chart_add extends view_ivf_oocytedenudation_embryology_chart
{
	...
	// Page object name
	public $PageObjName = "view_ivf_oocytedenudation_embryology_chart_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("view_ivf_oocytedenudation_embryology_chartlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "view_ivf_oocytedenudation_embryology_chartlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "view_ivf_oocytedenudation_embryology_chartview.php")
