 ...
 * Page class
 */
class aa_appointment_scheduler_add extends aa_appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "aa_appointment_scheduler_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "aa_appointment_schedulerview.php")
