 ...
 */
class pres_genericinteractions extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Genericname
		$this->Genericname = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Genericname', 'Genericname', '`Genericname`', '`Genericname`', 200, -1, FALSE, '`Genericname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Genericname->Sortable = TRUE; // Allow sort
		$this->fields['Genericname'] = &$this->Genericname;

		// Catid
		$this->Catid = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Catid', 'Catid', '`Catid`', '`Catid`', 3, -1, FALSE, '`Catid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Catid->Sortable = FALSE; // Allow sort
		$this->Catid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Catid'] = &$this->Catid;

		// Interactions
		$this->Interactions = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Interactions', 'Interactions', '`Interactions`', '`Interactions`', 200, -1, FALSE, '`Interactions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Interactions->Sortable = TRUE; // Allow sort
		$this->fields['Interactions'] = &$this->Interactions;

		// Intid
		$this->Intid = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Intid', 'Intid', '`Intid`', '`Intid`', 3, -1, FALSE, '`Intid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Intid->Sortable = FALSE; // Allow sort
		$this->Intid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Intid'] = &$this->Intid;

		// Createddt
		$this->Createddt = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Createddt', 'Createddt', '`Createddt`', CastDateFieldForLike('`Createddt`', 0, "DB"), 133, 0, FALSE, '`Createddt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Createddt->Sortable = FALSE; // Allow sort
		...
		// Createdtm
		$this->Createdtm = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Createdtm', 'Createdtm', '`Createdtm`', CastDateFieldForLike('`Createdtm`', 4, "DB"), 134, 4, FALSE, '`Createdtm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Createdtm->Sortable = FALSE; // Allow sort
		...
		// Statusbit
		$this->Statusbit = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Statusbit', 'Statusbit', '`Statusbit`', '`Statusbit`', 3, -1, FALSE, '`Statusbit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Statusbit->Sortable = FALSE; // Allow sort
		$this->Statusbit->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Statusbit'] = &$this->Statusbit;

		// Remarks
		$this->Remarks = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// Username
		$this->Username = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Username', 'Username', '`Username`', '`Username`', 200, -1, FALSE, '`Username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "pres_genericinteractionslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "pres_genericinteractionsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "pres_genericinteractionsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("pres_genericinteractionsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("pres_genericinteractionsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "pres_genericinteractionsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "pres_genericinteractionsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pres_genericinteractionsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pres_genericinteractionsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("pres_genericinteractionsdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->Intid->setDbValue($rs->fields('Intid'));
		$this->Createddt->setDbValue($rs->fields('Createddt'));
		$this->Createdtm->setDbValue($rs->fields('Createdtm'));
		$this->Statusbit->setDbValue($rs->fields('Statusbit'));
