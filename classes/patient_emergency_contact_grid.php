 ...
 * Page class
 */
class patient_emergency_contact_grid extends patient_emergency_contact
{
	...
	// Page object name
	public $PageObjName = "patient_emergency_contact_grid";

	// Grid form hidden field names
	public $FormName = "fpatient_emergency_contactgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_name") && $CurrentForm->hasValue("o_name") && $this->name->CurrentValue <> $this->name->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_relationship") && $CurrentForm->hasValue("o_relationship") && $this->relationship->CurrentValue <> $this->relationship->OldValue)
			return FALSE;
