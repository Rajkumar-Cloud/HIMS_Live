 ...
 * Page class
 */
class pres_mas_forms_edit extends pres_mas_forms
{
	...
	// Page object name
	public $PageObjName = "pres_mas_forms_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Forms
			$this->Forms->setDbValueDef($rsnew, $this->Forms->CurrentValue, "", $this->Forms->ReadOnly);
