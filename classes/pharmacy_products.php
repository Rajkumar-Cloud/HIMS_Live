...
class pharmacy_products extends DbTable
{
	...
	public function __construct()
	{
		...
		// ProductCode
		$this->ProductCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductCode', 'ProductCode', '`ProductCode`', '`ProductCode`', 3, -1, FALSE, '`ProductCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ProductName
		$this->ProductName = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductName', 'ProductName', '`ProductName`', '`ProductName`', 200, -1, FALSE, '`ProductName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductName->Sortable = TRUE; // Allow sort
		$this->fields['ProductName'] = &$this->ProductName;

		// DivisionCode
		$this->DivisionCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_DivisionCode', 'DivisionCode', '`DivisionCode`', '`DivisionCode`', 200, -1, FALSE, '`DivisionCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DivisionCode->Sortable = TRUE; // Allow sort
		$this->fields['DivisionCode'] = &$this->DivisionCode;

		// ManufacturerCode
		$this->ManufacturerCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ManufacturerCode', 'ManufacturerCode', '`ManufacturerCode`', '`ManufacturerCode`', 200, -1, FALSE, '`ManufacturerCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ManufacturerCode->Sortable = TRUE; // Allow sort
		$this->fields['ManufacturerCode'] = &$this->ManufacturerCode;

		// SupplierCode
		$this->SupplierCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_SupplierCode', 'SupplierCode', '`SupplierCode`', '`SupplierCode`', 200, -1, FALSE, '`SupplierCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SupplierCode->Sortable = TRUE; // Allow sort
		$this->fields['SupplierCode'] = &$this->SupplierCode;

		// AlternateSupplierCodes
		$this->AlternateSupplierCodes = new DbField('pharmacy_products', 'pharmacy_products', 'x_AlternateSupplierCodes', 'AlternateSupplierCodes', '`AlternateSupplierCodes`', '`AlternateSupplierCodes`', 200, -1, FALSE, '`AlternateSupplierCodes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AlternateProductCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_AlternateProductCode', 'AlternateProductCode', '`AlternateProductCode`', '`AlternateProductCode`', 200, -1, FALSE, '`AlternateProductCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AlternateProductCode->Sortable = TRUE; // Allow sort
		$this->fields['AlternateProductCode'] = &$this->AlternateProductCode;

		// UniversalProductCode
		$this->UniversalProductCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_UniversalProductCode', 'UniversalProductCode', '`UniversalProductCode`', '`UniversalProductCode`', 3, -1, FALSE, '`UniversalProductCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BookProductCode
		$this->BookProductCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_BookProductCode', 'BookProductCode', '`BookProductCode`', '`BookProductCode`', 3, -1, FALSE, '`BookProductCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OldCode
		$this->OldCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_OldCode', 'OldCode', '`OldCode`', '`OldCode`', 200, -1, FALSE, '`OldCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OldCode->Sortable = TRUE; // Allow sort
		$this->fields['OldCode'] = &$this->OldCode;

		// ProtectedProducts
		$this->ProtectedProducts = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProtectedProducts', 'ProtectedProducts', '`ProtectedProducts`', '`ProtectedProducts`', 16, -1, FALSE, '`ProtectedProducts`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductFullName
		$this->ProductFullName = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductFullName', 'ProductFullName', '`ProductFullName`', '`ProductFullName`', 200, -1, FALSE, '`ProductFullName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductFullName->Sortable = TRUE; // Allow sort
		$this->fields['ProductFullName'] = &$this->ProductFullName;

		// UnitOfMeasure
		$this->UnitOfMeasure = new DbField('pharmacy_products', 'pharmacy_products', 'x_UnitOfMeasure', 'UnitOfMeasure', '`UnitOfMeasure`', '`UnitOfMeasure`', 3, -1, FALSE, '`UnitOfMeasure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitDescription
		$this->UnitDescription = new DbField('pharmacy_products', 'pharmacy_products', 'x_UnitDescription', 'UnitDescription', '`UnitDescription`', '`UnitDescription`', 200, -1, FALSE, '`UnitDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UnitDescription->Sortable = TRUE; // Allow sort
		$this->fields['UnitDescription'] = &$this->UnitDescription;

		// BulkDescription
		$this->BulkDescription = new DbField('pharmacy_products', 'pharmacy_products', 'x_BulkDescription', 'BulkDescription', '`BulkDescription`', '`BulkDescription`', 200, -1, FALSE, '`BulkDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BulkDescription->Sortable = TRUE; // Allow sort
		$this->fields['BulkDescription'] = &$this->BulkDescription;

		// BarCodeDescription
		$this->BarCodeDescription = new DbField('pharmacy_products', 'pharmacy_products', 'x_BarCodeDescription', 'BarCodeDescription', '`BarCodeDescription`', '`BarCodeDescription`', 200, -1, FALSE, '`BarCodeDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BarCodeDescription->Sortable = TRUE; // Allow sort
		$this->fields['BarCodeDescription'] = &$this->BarCodeDescription;

		// PackageInformation
		$this->PackageInformation = new DbField('pharmacy_products', 'pharmacy_products', 'x_PackageInformation', 'PackageInformation', '`PackageInformation`', '`PackageInformation`', 200, -1, FALSE, '`PackageInformation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PackageInformation->Sortable = TRUE; // Allow sort
		$this->fields['PackageInformation'] = &$this->PackageInformation;

		// PackageId
		$this->PackageId = new DbField('pharmacy_products', 'pharmacy_products', 'x_PackageId', 'PackageId', '`PackageId`', '`PackageId`', 3, -1, FALSE, '`PackageId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Weight
		$this->Weight = new DbField('pharmacy_products', 'pharmacy_products', 'x_Weight', 'Weight', '`Weight`', '`Weight`', 5, -1, FALSE, '`Weight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AllowFractions
		$this->AllowFractions = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllowFractions', 'AllowFractions', '`AllowFractions`', '`AllowFractions`', 16, -1, FALSE, '`AllowFractions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MinimumStockLevel
		$this->MinimumStockLevel = new DbField('pharmacy_products', 'pharmacy_products', 'x_MinimumStockLevel', 'MinimumStockLevel', '`MinimumStockLevel`', '`MinimumStockLevel`', 5, -1, FALSE, '`MinimumStockLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MaximumStockLevel
		$this->MaximumStockLevel = new DbField('pharmacy_products', 'pharmacy_products', 'x_MaximumStockLevel', 'MaximumStockLevel', '`MaximumStockLevel`', '`MaximumStockLevel`', 5, -1, FALSE, '`MaximumStockLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReorderLevel
		$this->ReorderLevel = new DbField('pharmacy_products', 'pharmacy_products', 'x_ReorderLevel', 'ReorderLevel', '`ReorderLevel`', '`ReorderLevel`', 5, -1, FALSE, '`ReorderLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MinMaxRatio
		$this->MinMaxRatio = new DbField('pharmacy_products', 'pharmacy_products', 'x_MinMaxRatio', 'MinMaxRatio', '`MinMaxRatio`', '`MinMaxRatio`', 5, -1, FALSE, '`MinMaxRatio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AutoMinMaxRatio
		$this->AutoMinMaxRatio = new DbField('pharmacy_products', 'pharmacy_products', 'x_AutoMinMaxRatio', 'AutoMinMaxRatio', '`AutoMinMaxRatio`', '`AutoMinMaxRatio`', 5, -1, FALSE, '`AutoMinMaxRatio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ScheduleCode
		$this->ScheduleCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ScheduleCode', 'ScheduleCode', '`ScheduleCode`', '`ScheduleCode`', 3, -1, FALSE, '`ScheduleCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RopRatio
		$this->RopRatio = new DbField('pharmacy_products', 'pharmacy_products', 'x_RopRatio', 'RopRatio', '`RopRatio`', '`RopRatio`', 5, -1, FALSE, '`RopRatio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MRP
		$this->MRP = new DbField('pharmacy_products', 'pharmacy_products', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 5, -1, FALSE, '`MRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MRP->Sortable = TRUE; // Allow sort
		$this->MRP->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['MRP'] = &$this->MRP;

		// PurchasePrice
		$this->PurchasePrice = new DbField('pharmacy_products', 'pharmacy_products', 'x_PurchasePrice', 'PurchasePrice', '`PurchasePrice`', '`PurchasePrice`', 5, -1, FALSE, '`PurchasePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurchaseUnit
		$this->PurchaseUnit = new DbField('pharmacy_products', 'pharmacy_products', 'x_PurchaseUnit', 'PurchaseUnit', '`PurchaseUnit`', '`PurchaseUnit`', 5, -1, FALSE, '`PurchaseUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurchaseTaxCode
		$this->PurchaseTaxCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_PurchaseTaxCode', 'PurchaseTaxCode', '`PurchaseTaxCode`', '`PurchaseTaxCode`', 3, -1, FALSE, '`PurchaseTaxCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AllowDirectInward
		$this->AllowDirectInward = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllowDirectInward', 'AllowDirectInward', '`AllowDirectInward`', '`AllowDirectInward`', 16, -1, FALSE, '`AllowDirectInward`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalePrice
		$this->SalePrice = new DbField('pharmacy_products', 'pharmacy_products', 'x_SalePrice', 'SalePrice', '`SalePrice`', '`SalePrice`', 5, -1, FALSE, '`SalePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SaleUnit
		$this->SaleUnit = new DbField('pharmacy_products', 'pharmacy_products', 'x_SaleUnit', 'SaleUnit', '`SaleUnit`', '`SaleUnit`', 5, -1, FALSE, '`SaleUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalesTaxCode
		$this->SalesTaxCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_SalesTaxCode', 'SalesTaxCode', '`SalesTaxCode`', '`SalesTaxCode`', 3, -1, FALSE, '`SalesTaxCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StockReceived
		$this->StockReceived = new DbField('pharmacy_products', 'pharmacy_products', 'x_StockReceived', 'StockReceived', '`StockReceived`', '`StockReceived`', 5, -1, FALSE, '`StockReceived`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TotalStock
		$this->TotalStock = new DbField('pharmacy_products', 'pharmacy_products', 'x_TotalStock', 'TotalStock', '`TotalStock`', '`TotalStock`', 5, -1, FALSE, '`TotalStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StockType
		$this->StockType = new DbField('pharmacy_products', 'pharmacy_products', 'x_StockType', 'StockType', '`StockType`', '`StockType`', 2, -1, FALSE, '`StockType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StockCheckDate
		$this->StockCheckDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_StockCheckDate', 'StockCheckDate', '`StockCheckDate`', CastDateFieldForLike('`StockCheckDate`', 0, "DB"), 135, 0, FALSE, '`StockCheckDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StockAdjustmentDate
		$this->StockAdjustmentDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_StockAdjustmentDate', 'StockAdjustmentDate', '`StockAdjustmentDate`', CastDateFieldForLike('`StockAdjustmentDate`', 0, "DB"), 135, 0, FALSE, '`StockAdjustmentDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Remarks
		$this->Remarks = new DbField('pharmacy_products', 'pharmacy_products', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// CostCentre
		$this->CostCentre = new DbField('pharmacy_products', 'pharmacy_products', 'x_CostCentre', 'CostCentre', '`CostCentre`', '`CostCentre`', 3, -1, FALSE, '`CostCentre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductType
		$this->ProductType = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductType', 'ProductType', '`ProductType`', '`ProductType`', 3, -1, FALSE, '`ProductType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TaxAmount
		$this->TaxAmount = new DbField('pharmacy_products', 'pharmacy_products', 'x_TaxAmount', 'TaxAmount', '`TaxAmount`', '`TaxAmount`', 5, -1, FALSE, '`TaxAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TaxId
		$this->TaxId = new DbField('pharmacy_products', 'pharmacy_products', 'x_TaxId', 'TaxId', '`TaxId`', '`TaxId`', 3, -1, FALSE, '`TaxId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResaleTaxApplicable
		$this->ResaleTaxApplicable = new DbField('pharmacy_products', 'pharmacy_products', 'x_ResaleTaxApplicable', 'ResaleTaxApplicable', '`ResaleTaxApplicable`', '`ResaleTaxApplicable`', 16, -1, FALSE, '`ResaleTaxApplicable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CstOtherTax
		$this->CstOtherTax = new DbField('pharmacy_products', 'pharmacy_products', 'x_CstOtherTax', 'CstOtherTax', '`CstOtherTax`', '`CstOtherTax`', 200, -1, FALSE, '`CstOtherTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CstOtherTax->Sortable = TRUE; // Allow sort
		$this->fields['CstOtherTax'] = &$this->CstOtherTax;

		// TotalTax
		$this->TotalTax = new DbField('pharmacy_products', 'pharmacy_products', 'x_TotalTax', 'TotalTax', '`TotalTax`', '`TotalTax`', 5, -1, FALSE, '`TotalTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ItemCost
		$this->ItemCost = new DbField('pharmacy_products', 'pharmacy_products', 'x_ItemCost', 'ItemCost', '`ItemCost`', '`ItemCost`', 5, -1, FALSE, '`ItemCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ExpiryDate
		$this->ExpiryDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_ExpiryDate', 'ExpiryDate', '`ExpiryDate`', CastDateFieldForLike('`ExpiryDate`', 0, "DB"), 135, 0, FALSE, '`ExpiryDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BatchDescription
		$this->BatchDescription = new DbField('pharmacy_products', 'pharmacy_products', 'x_BatchDescription', 'BatchDescription', '`BatchDescription`', '`BatchDescription`', 200, -1, FALSE, '`BatchDescription`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchDescription->Sortable = TRUE; // Allow sort
		$this->fields['BatchDescription'] = &$this->BatchDescription;

		// FreeScheme
		$this->FreeScheme = new DbField('pharmacy_products', 'pharmacy_products', 'x_FreeScheme', 'FreeScheme', '`FreeScheme`', '`FreeScheme`', 16, -1, FALSE, '`FreeScheme`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->CashDiscountEligibility = new DbField('pharmacy_products', 'pharmacy_products', 'x_CashDiscountEligibility', 'CashDiscountEligibility', '`CashDiscountEligibility`', '`CashDiscountEligibility`', 16, -1, FALSE, '`CashDiscountEligibility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DiscountPerAllowInBill = new DbField('pharmacy_products', 'pharmacy_products', 'x_DiscountPerAllowInBill', 'DiscountPerAllowInBill', '`DiscountPerAllowInBill`', '`DiscountPerAllowInBill`', 5, -1, FALSE, '`DiscountPerAllowInBill`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Discount
		$this->Discount = new DbField('pharmacy_products', 'pharmacy_products', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 5, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TotalAmount
		$this->TotalAmount = new DbField('pharmacy_products', 'pharmacy_products', 'x_TotalAmount', 'TotalAmount', '`TotalAmount`', '`TotalAmount`', 5, -1, FALSE, '`TotalAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StandardMargin
		$this->StandardMargin = new DbField('pharmacy_products', 'pharmacy_products', 'x_StandardMargin', 'StandardMargin', '`StandardMargin`', '`StandardMargin`', 5, -1, FALSE, '`StandardMargin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Margin
		$this->Margin = new DbField('pharmacy_products', 'pharmacy_products', 'x_Margin', 'Margin', '`Margin`', '`Margin`', 5, -1, FALSE, '`Margin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarginId
		$this->MarginId = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarginId', 'MarginId', '`MarginId`', '`MarginId`', 3, -1, FALSE, '`MarginId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ExpectedMargin
		$this->ExpectedMargin = new DbField('pharmacy_products', 'pharmacy_products', 'x_ExpectedMargin', 'ExpectedMargin', '`ExpectedMargin`', '`ExpectedMargin`', 5, -1, FALSE, '`ExpectedMargin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SurchargeBeforeTax
		$this->SurchargeBeforeTax = new DbField('pharmacy_products', 'pharmacy_products', 'x_SurchargeBeforeTax', 'SurchargeBeforeTax', '`SurchargeBeforeTax`', '`SurchargeBeforeTax`', 5, -1, FALSE, '`SurchargeBeforeTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SurchargeAfterTax
		$this->SurchargeAfterTax = new DbField('pharmacy_products', 'pharmacy_products', 'x_SurchargeAfterTax', 'SurchargeAfterTax', '`SurchargeAfterTax`', '`SurchargeAfterTax`', 5, -1, FALSE, '`SurchargeAfterTax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TempOrderNo
		$this->TempOrderNo = new DbField('pharmacy_products', 'pharmacy_products', 'x_TempOrderNo', 'TempOrderNo', '`TempOrderNo`', '`TempOrderNo`', 3, -1, FALSE, '`TempOrderNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TempOrderDate
		$this->TempOrderDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_TempOrderDate', 'TempOrderDate', '`TempOrderDate`', CastDateFieldForLike('`TempOrderDate`', 0, "DB"), 135, 0, FALSE, '`TempOrderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderUnit
		$this->OrderUnit = new DbField('pharmacy_products', 'pharmacy_products', 'x_OrderUnit', 'OrderUnit', '`OrderUnit`', '`OrderUnit`', 5, -1, FALSE, '`OrderUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderQuantity
		$this->OrderQuantity = new DbField('pharmacy_products', 'pharmacy_products', 'x_OrderQuantity', 'OrderQuantity', '`OrderQuantity`', '`OrderQuantity`', 5, -1, FALSE, '`OrderQuantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarkForOrder
		$this->MarkForOrder = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarkForOrder', 'MarkForOrder', '`MarkForOrder`', '`MarkForOrder`', 16, -1, FALSE, '`MarkForOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderAllId
		$this->OrderAllId = new DbField('pharmacy_products', 'pharmacy_products', 'x_OrderAllId', 'OrderAllId', '`OrderAllId`', '`OrderAllId`', 3, -1, FALSE, '`OrderAllId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CalculateOrderQty
		$this->CalculateOrderQty = new DbField('pharmacy_products', 'pharmacy_products', 'x_CalculateOrderQty', 'CalculateOrderQty', '`CalculateOrderQty`', '`CalculateOrderQty`', 5, -1, FALSE, '`CalculateOrderQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubLocation
		$this->SubLocation = new DbField('pharmacy_products', 'pharmacy_products', 'x_SubLocation', 'SubLocation', '`SubLocation`', '`SubLocation`', 200, -1, FALSE, '`SubLocation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SubLocation->Sortable = TRUE; // Allow sort
		$this->fields['SubLocation'] = &$this->SubLocation;

		// CategoryCode
		$this->CategoryCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_CategoryCode', 'CategoryCode', '`CategoryCode`', '`CategoryCode`', 200, -1, FALSE, '`CategoryCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CategoryCode->Sortable = TRUE; // Allow sort
		$this->fields['CategoryCode'] = &$this->CategoryCode;

		// SubCategory
		$this->SubCategory = new DbField('pharmacy_products', 'pharmacy_products', 'x_SubCategory', 'SubCategory', '`SubCategory`', '`SubCategory`', 200, -1, FALSE, '`SubCategory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SubCategory->Sortable = TRUE; // Allow sort
		$this->fields['SubCategory'] = &$this->SubCategory;

		// FlexCategoryCode
		$this->FlexCategoryCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_FlexCategoryCode', 'FlexCategoryCode', '`FlexCategoryCode`', '`FlexCategoryCode`', 3, -1, FALSE, '`FlexCategoryCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ABCSaleQty
		$this->ABCSaleQty = new DbField('pharmacy_products', 'pharmacy_products', 'x_ABCSaleQty', 'ABCSaleQty', '`ABCSaleQty`', '`ABCSaleQty`', 5, -1, FALSE, '`ABCSaleQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ABCSaleValue
		$this->ABCSaleValue = new DbField('pharmacy_products', 'pharmacy_products', 'x_ABCSaleValue', 'ABCSaleValue', '`ABCSaleValue`', '`ABCSaleValue`', 5, -1, FALSE, '`ABCSaleValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ConvertionFactor
		$this->ConvertionFactor = new DbField('pharmacy_products', 'pharmacy_products', 'x_ConvertionFactor', 'ConvertionFactor', '`ConvertionFactor`', '`ConvertionFactor`', 3, -1, FALSE, '`ConvertionFactor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ConvertionUnitDesc
		$this->ConvertionUnitDesc = new DbField('pharmacy_products', 'pharmacy_products', 'x_ConvertionUnitDesc', 'ConvertionUnitDesc', '`ConvertionUnitDesc`', '`ConvertionUnitDesc`', 200, -1, FALSE, '`ConvertionUnitDesc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ConvertionUnitDesc->Sortable = TRUE; // Allow sort
		$this->fields['ConvertionUnitDesc'] = &$this->ConvertionUnitDesc;

		// TransactionId
		$this->TransactionId = new DbField('pharmacy_products', 'pharmacy_products', 'x_TransactionId', 'TransactionId', '`TransactionId`', '`TransactionId`', 3, -1, FALSE, '`TransactionId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SoldProductId
		$this->SoldProductId = new DbField('pharmacy_products', 'pharmacy_products', 'x_SoldProductId', 'SoldProductId', '`SoldProductId`', '`SoldProductId`', 3, -1, FALSE, '`SoldProductId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// WantedBookId
		$this->WantedBookId = new DbField('pharmacy_products', 'pharmacy_products', 'x_WantedBookId', 'WantedBookId', '`WantedBookId`', '`WantedBookId`', 3, -1, FALSE, '`WantedBookId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AllId
		$this->AllId = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllId', 'AllId', '`AllId`', '`AllId`', 3, -1, FALSE, '`AllId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->BatchAndExpiryCompulsory = new DbField('pharmacy_products', 'pharmacy_products', 'x_BatchAndExpiryCompulsory', 'BatchAndExpiryCompulsory', '`BatchAndExpiryCompulsory`', '`BatchAndExpiryCompulsory`', 16, -1, FALSE, '`BatchAndExpiryCompulsory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->BatchStockForWantedBook = new DbField('pharmacy_products', 'pharmacy_products', 'x_BatchStockForWantedBook', 'BatchStockForWantedBook', '`BatchStockForWantedBook`', '`BatchStockForWantedBook`', 16, -1, FALSE, '`BatchStockForWantedBook`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UnitBasedBilling
		$this->UnitBasedBilling = new DbField('pharmacy_products', 'pharmacy_products', 'x_UnitBasedBilling', 'UnitBasedBilling', '`UnitBasedBilling`', '`UnitBasedBilling`', 16, -1, FALSE, '`UnitBasedBilling`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DoNotCheckStock
		$this->DoNotCheckStock = new DbField('pharmacy_products', 'pharmacy_products', 'x_DoNotCheckStock', 'DoNotCheckStock', '`DoNotCheckStock`', '`DoNotCheckStock`', 16, -1, FALSE, '`DoNotCheckStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AcceptRate
		$this->AcceptRate = new DbField('pharmacy_products', 'pharmacy_products', 'x_AcceptRate', 'AcceptRate', '`AcceptRate`', '`AcceptRate`', 16, -1, FALSE, '`AcceptRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PriceLevel
		$this->PriceLevel = new DbField('pharmacy_products', 'pharmacy_products', 'x_PriceLevel', 'PriceLevel', '`PriceLevel`', '`PriceLevel`', 16, -1, FALSE, '`PriceLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastQuotePrice
		$this->LastQuotePrice = new DbField('pharmacy_products', 'pharmacy_products', 'x_LastQuotePrice', 'LastQuotePrice', '`LastQuotePrice`', '`LastQuotePrice`', 5, -1, FALSE, '`LastQuotePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PriceChange
		$this->PriceChange = new DbField('pharmacy_products', 'pharmacy_products', 'x_PriceChange', 'PriceChange', '`PriceChange`', '`PriceChange`', 5, -1, FALSE, '`PriceChange`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CommodityCode
		$this->CommodityCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_CommodityCode', 'CommodityCode', '`CommodityCode`', '`CommodityCode`', 200, -1, FALSE, '`CommodityCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CommodityCode->Sortable = TRUE; // Allow sort
		$this->fields['CommodityCode'] = &$this->CommodityCode;

		// InstitutePrice
		$this->InstitutePrice = new DbField('pharmacy_products', 'pharmacy_products', 'x_InstitutePrice', 'InstitutePrice', '`InstitutePrice`', '`InstitutePrice`', 5, -1, FALSE, '`InstitutePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CtrlOrDCtrlProduct
		$this->CtrlOrDCtrlProduct = new DbField('pharmacy_products', 'pharmacy_products', 'x_CtrlOrDCtrlProduct', 'CtrlOrDCtrlProduct', '`CtrlOrDCtrlProduct`', '`CtrlOrDCtrlProduct`', 16, -1, FALSE, '`CtrlOrDCtrlProduct`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ImportedDate
		$this->ImportedDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_ImportedDate', 'ImportedDate', '`ImportedDate`', CastDateFieldForLike('`ImportedDate`', 0, "DB"), 135, 0, FALSE, '`ImportedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsImported
		$this->IsImported = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsImported', 'IsImported', '`IsImported`', '`IsImported`', 16, -1, FALSE, '`IsImported`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FileName
		$this->FileName = new DbField('pharmacy_products', 'pharmacy_products', 'x_FileName', 'FileName', '`FileName`', '`FileName`', 200, -1, FALSE, '`FileName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FileName->Sortable = TRUE; // Allow sort
		$this->fields['FileName'] = &$this->FileName;

		// LPName
		$this->LPName = new DbField('pharmacy_products', 'pharmacy_products', 'x_LPName', 'LPName', '`LPName`', '`LPName`', 201, -1, FALSE, '`LPName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LPName->Sortable = TRUE; // Allow sort
		$this->fields['LPName'] = &$this->LPName;

		// GodownNumber
		$this->GodownNumber = new DbField('pharmacy_products', 'pharmacy_products', 'x_GodownNumber', 'GodownNumber', '`GodownNumber`', '`GodownNumber`', 3, -1, FALSE, '`GodownNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreationDate
		$this->CreationDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_CreationDate', 'CreationDate', '`CreationDate`', CastDateFieldForLike('`CreationDate`', 0, "DB"), 135, 0, FALSE, '`CreationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedbyUser
		$this->CreatedbyUser = new DbField('pharmacy_products', 'pharmacy_products', 'x_CreatedbyUser', 'CreatedbyUser', '`CreatedbyUser`', '`CreatedbyUser`', 200, -1, FALSE, '`CreatedbyUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedbyUser->Sortable = TRUE; // Allow sort
		$this->fields['CreatedbyUser'] = &$this->CreatedbyUser;

		// ModifiedDate
		$this->ModifiedDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_ModifiedDate', 'ModifiedDate', '`ModifiedDate`', CastDateFieldForLike('`ModifiedDate`', 0, "DB"), 135, 0, FALSE, '`ModifiedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ModifiedbyUser
		$this->ModifiedbyUser = new DbField('pharmacy_products', 'pharmacy_products', 'x_ModifiedbyUser', 'ModifiedbyUser', '`ModifiedbyUser`', '`ModifiedbyUser`', 200, -1, FALSE, '`ModifiedbyUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedbyUser->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedbyUser'] = &$this->ModifiedbyUser;

		// isActive
		$this->isActive = new DbField('pharmacy_products', 'pharmacy_products', 'x_isActive', 'isActive', '`isActive`', '`isActive`', 17, -1, FALSE, '`isActive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AllowExpiryClaim
		$this->AllowExpiryClaim = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllowExpiryClaim', 'AllowExpiryClaim', '`AllowExpiryClaim`', '`AllowExpiryClaim`', 16, -1, FALSE, '`AllowExpiryClaim`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BrandCode
		$this->BrandCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_BrandCode', 'BrandCode', '`BrandCode`', '`BrandCode`', 3, -1, FALSE, '`BrandCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FreeSchemeBasedon
		$this->FreeSchemeBasedon = new DbField('pharmacy_products', 'pharmacy_products', 'x_FreeSchemeBasedon', 'FreeSchemeBasedon', '`FreeSchemeBasedon`', '`FreeSchemeBasedon`', 17, -1, FALSE, '`FreeSchemeBasedon`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DoNotCheckCostInBill = new DbField('pharmacy_products', 'pharmacy_products', 'x_DoNotCheckCostInBill', 'DoNotCheckCostInBill', '`DoNotCheckCostInBill`', '`DoNotCheckCostInBill`', 16, -1, FALSE, '`DoNotCheckCostInBill`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductGroupCode
		$this->ProductGroupCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductGroupCode', 'ProductGroupCode', '`ProductGroupCode`', '`ProductGroupCode`', 3, -1, FALSE, '`ProductGroupCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductStrengthCode
		$this->ProductStrengthCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductStrengthCode', 'ProductStrengthCode', '`ProductStrengthCode`', '`ProductStrengthCode`', 3, -1, FALSE, '`ProductStrengthCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PackingCode
		$this->PackingCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_PackingCode', 'PackingCode', '`PackingCode`', '`PackingCode`', 3, -1, FALSE, '`PackingCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ComputedMinStock
		$this->ComputedMinStock = new DbField('pharmacy_products', 'pharmacy_products', 'x_ComputedMinStock', 'ComputedMinStock', '`ComputedMinStock`', '`ComputedMinStock`', 5, -1, FALSE, '`ComputedMinStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ComputedMaxStock
		$this->ComputedMaxStock = new DbField('pharmacy_products', 'pharmacy_products', 'x_ComputedMaxStock', 'ComputedMaxStock', '`ComputedMaxStock`', '`ComputedMaxStock`', 5, -1, FALSE, '`ComputedMaxStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductRemark
		$this->ProductRemark = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductRemark', 'ProductRemark', '`ProductRemark`', '`ProductRemark`', 3, -1, FALSE, '`ProductRemark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductDrugCode
		$this->ProductDrugCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductDrugCode', 'ProductDrugCode', '`ProductDrugCode`', '`ProductDrugCode`', 3, -1, FALSE, '`ProductDrugCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsMatrixProduct
		$this->IsMatrixProduct = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsMatrixProduct', 'IsMatrixProduct', '`IsMatrixProduct`', '`IsMatrixProduct`', 3, -1, FALSE, '`IsMatrixProduct`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount1
		$this->AttributeCount1 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount1', 'AttributeCount1', '`AttributeCount1`', '`AttributeCount1`', 3, -1, FALSE, '`AttributeCount1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount2
		$this->AttributeCount2 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount2', 'AttributeCount2', '`AttributeCount2`', '`AttributeCount2`', 3, -1, FALSE, '`AttributeCount2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount3
		$this->AttributeCount3 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount3', 'AttributeCount3', '`AttributeCount3`', '`AttributeCount3`', 3, -1, FALSE, '`AttributeCount3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount4
		$this->AttributeCount4 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount4', 'AttributeCount4', '`AttributeCount4`', '`AttributeCount4`', 3, -1, FALSE, '`AttributeCount4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount5
		$this->AttributeCount5 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount5', 'AttributeCount5', '`AttributeCount5`', '`AttributeCount5`', 3, -1, FALSE, '`AttributeCount5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DefaultDiscountPercentage = new DbField('pharmacy_products', 'pharmacy_products', 'x_DefaultDiscountPercentage', 'DefaultDiscountPercentage', '`DefaultDiscountPercentage`', '`DefaultDiscountPercentage`', 5, -1, FALSE, '`DefaultDiscountPercentage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DonotPrintBarcode
		$this->DonotPrintBarcode = new DbField('pharmacy_products', 'pharmacy_products', 'x_DonotPrintBarcode', 'DonotPrintBarcode', '`DonotPrintBarcode`', '`DonotPrintBarcode`', 16, -1, FALSE, '`DonotPrintBarcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->ProductLevelDiscount = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductLevelDiscount', 'ProductLevelDiscount', '`ProductLevelDiscount`', '`ProductLevelDiscount`', 16, -1, FALSE, '`ProductLevelDiscount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Markup
		$this->Markup = new DbField('pharmacy_products', 'pharmacy_products', 'x_Markup', 'Markup', '`Markup`', '`Markup`', 5, -1, FALSE, '`Markup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarkDown
		$this->MarkDown = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarkDown', 'MarkDown', '`MarkDown`', '`MarkDown`', 5, -1, FALSE, '`MarkDown`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReworkSalePrice
		$this->ReworkSalePrice = new DbField('pharmacy_products', 'pharmacy_products', 'x_ReworkSalePrice', 'ReworkSalePrice', '`ReworkSalePrice`', '`ReworkSalePrice`', 16, -1, FALSE, '`ReworkSalePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MultipleInput
		$this->MultipleInput = new DbField('pharmacy_products', 'pharmacy_products', 'x_MultipleInput', 'MultipleInput', '`MultipleInput`', '`MultipleInput`', 3, -1, FALSE, '`MultipleInput`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->LpPackageInformation = new DbField('pharmacy_products', 'pharmacy_products', 'x_LpPackageInformation', 'LpPackageInformation', '`LpPackageInformation`', '`LpPackageInformation`', 200, -1, FALSE, '`LpPackageInformation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LpPackageInformation->Sortable = TRUE; // Allow sort
		$this->fields['LpPackageInformation'] = &$this->LpPackageInformation;

		// AllowNegativeStock
		$this->AllowNegativeStock = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllowNegativeStock', 'AllowNegativeStock', '`AllowNegativeStock`', '`AllowNegativeStock`', 16, -1, FALSE, '`AllowNegativeStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderDate
		$this->OrderDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_OrderDate', 'OrderDate', '`OrderDate`', CastDateFieldForLike('`OrderDate`', 0, "DB"), 135, 0, FALSE, '`OrderDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderTime
		$this->OrderTime = new DbField('pharmacy_products', 'pharmacy_products', 'x_OrderTime', 'OrderTime', '`OrderTime`', CastDateFieldForLike('`OrderTime`', 0, "DB"), 135, 0, FALSE, '`OrderTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RateGroupCode
		$this->RateGroupCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_RateGroupCode', 'RateGroupCode', '`RateGroupCode`', '`RateGroupCode`', 3, -1, FALSE, '`RateGroupCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ConversionCaseLot
		$this->ConversionCaseLot = new DbField('pharmacy_products', 'pharmacy_products', 'x_ConversionCaseLot', 'ConversionCaseLot', '`ConversionCaseLot`', '`ConversionCaseLot`', 3, -1, FALSE, '`ConversionCaseLot`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ShippingLot
		$this->ShippingLot = new DbField('pharmacy_products', 'pharmacy_products', 'x_ShippingLot', 'ShippingLot', '`ShippingLot`', '`ShippingLot`', 200, -1, FALSE, '`ShippingLot`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShippingLot->Sortable = TRUE; // Allow sort
		$this->fields['ShippingLot'] = &$this->ShippingLot;

		// AllowExpiryReplacement
		$this->AllowExpiryReplacement = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllowExpiryReplacement', 'AllowExpiryReplacement', '`AllowExpiryReplacement`', '`AllowExpiryReplacement`', 16, -1, FALSE, '`AllowExpiryReplacement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->NoOfMonthExpiryAllowed = new DbField('pharmacy_products', 'pharmacy_products', 'x_NoOfMonthExpiryAllowed', 'NoOfMonthExpiryAllowed', '`NoOfMonthExpiryAllowed`', '`NoOfMonthExpiryAllowed`', 3, -1, FALSE, '`NoOfMonthExpiryAllowed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->ProductDiscountEligibility = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductDiscountEligibility', 'ProductDiscountEligibility', '`ProductDiscountEligibility`', '`ProductDiscountEligibility`', 16, -1, FALSE, '`ProductDiscountEligibility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ScheduleTypeCode
		$this->ScheduleTypeCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ScheduleTypeCode', 'ScheduleTypeCode', '`ScheduleTypeCode`', '`ScheduleTypeCode`', 3, -1, FALSE, '`ScheduleTypeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AIOCDProductCode
		$this->AIOCDProductCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_AIOCDProductCode', 'AIOCDProductCode', '`AIOCDProductCode`', '`AIOCDProductCode`', 200, -1, FALSE, '`AIOCDProductCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AIOCDProductCode->Sortable = TRUE; // Allow sort
		$this->fields['AIOCDProductCode'] = &$this->AIOCDProductCode;

		// FreeQuantity
		$this->FreeQuantity = new DbField('pharmacy_products', 'pharmacy_products', 'x_FreeQuantity', 'FreeQuantity', '`FreeQuantity`', '`FreeQuantity`', 5, -1, FALSE, '`FreeQuantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DiscountType
		$this->DiscountType = new DbField('pharmacy_products', 'pharmacy_products', 'x_DiscountType', 'DiscountType', '`DiscountType`', '`DiscountType`', 3, -1, FALSE, '`DiscountType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DiscountValue
		$this->DiscountValue = new DbField('pharmacy_products', 'pharmacy_products', 'x_DiscountValue', 'DiscountValue', '`DiscountValue`', '`DiscountValue`', 5, -1, FALSE, '`DiscountValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->HasProductOrderAttribute = new DbField('pharmacy_products', 'pharmacy_products', 'x_HasProductOrderAttribute', 'HasProductOrderAttribute', '`HasProductOrderAttribute`', '`HasProductOrderAttribute`', 16, -1, FALSE, '`HasProductOrderAttribute`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FirstPODate
		$this->FirstPODate = new DbField('pharmacy_products', 'pharmacy_products', 'x_FirstPODate', 'FirstPODate', '`FirstPODate`', CastDateFieldForLike('`FirstPODate`', 0, "DB"), 135, 0, FALSE, '`FirstPODate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SaleprcieAndMrpCalcPercent = new DbField('pharmacy_products', 'pharmacy_products', 'x_SaleprcieAndMrpCalcPercent', 'SaleprcieAndMrpCalcPercent', '`SaleprcieAndMrpCalcPercent`', '`SaleprcieAndMrpCalcPercent`', 5, -1, FALSE, '`SaleprcieAndMrpCalcPercent`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->IsGiftVoucherProducts = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsGiftVoucherProducts', 'IsGiftVoucherProducts', '`IsGiftVoucherProducts`', '`IsGiftVoucherProducts`', 17, -1, FALSE, '`IsGiftVoucherProducts`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AcceptRange4SerialNumber = new DbField('pharmacy_products', 'pharmacy_products', 'x_AcceptRange4SerialNumber', 'AcceptRange4SerialNumber', '`AcceptRange4SerialNumber`', '`AcceptRange4SerialNumber`', 16, -1, FALSE, '`AcceptRange4SerialNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->GiftVoucherDenomination = new DbField('pharmacy_products', 'pharmacy_products', 'x_GiftVoucherDenomination', 'GiftVoucherDenomination', '`GiftVoucherDenomination`', '`GiftVoucherDenomination`', 3, -1, FALSE, '`GiftVoucherDenomination`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Subclasscode
		$this->Subclasscode = new DbField('pharmacy_products', 'pharmacy_products', 'x_Subclasscode', 'Subclasscode', '`Subclasscode`', '`Subclasscode`', 200, -1, FALSE, '`Subclasscode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Subclasscode->Sortable = TRUE; // Allow sort
		$this->fields['Subclasscode'] = &$this->Subclasscode;

		// BarCodeFromWeighingMachine
		$this->BarCodeFromWeighingMachine = new DbField('pharmacy_products', 'pharmacy_products', 'x_BarCodeFromWeighingMachine', 'BarCodeFromWeighingMachine', '`BarCodeFromWeighingMachine`', '`BarCodeFromWeighingMachine`', 3, -1, FALSE, '`BarCodeFromWeighingMachine`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CheckCostInReturn
		$this->CheckCostInReturn = new DbField('pharmacy_products', 'pharmacy_products', 'x_CheckCostInReturn', 'CheckCostInReturn', '`CheckCostInReturn`', '`CheckCostInReturn`', 3, -1, FALSE, '`CheckCostInReturn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FrequentSaleProduct
		$this->FrequentSaleProduct = new DbField('pharmacy_products', 'pharmacy_products', 'x_FrequentSaleProduct', 'FrequentSaleProduct', '`FrequentSaleProduct`', '`FrequentSaleProduct`', 16, -1, FALSE, '`FrequentSaleProduct`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RateType
		$this->RateType = new DbField('pharmacy_products', 'pharmacy_products', 'x_RateType', 'RateType', '`RateType`', '`RateType`', 3, -1, FALSE, '`RateType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TouchscreenName
		$this->TouchscreenName = new DbField('pharmacy_products', 'pharmacy_products', 'x_TouchscreenName', 'TouchscreenName', '`TouchscreenName`', '`TouchscreenName`', 200, -1, FALSE, '`TouchscreenName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TouchscreenName->Sortable = TRUE; // Allow sort
		$this->fields['TouchscreenName'] = &$this->TouchscreenName;

		// FreeType
		$this->FreeType = new DbField('pharmacy_products', 'pharmacy_products', 'x_FreeType', 'FreeType', '`FreeType`', '`FreeType`', 3, -1, FALSE, '`FreeType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LooseQtyasNewBatch
		$this->LooseQtyasNewBatch = new DbField('pharmacy_products', 'pharmacy_products', 'x_LooseQtyasNewBatch', 'LooseQtyasNewBatch', '`LooseQtyasNewBatch`', '`LooseQtyasNewBatch`', 16, -1, FALSE, '`LooseQtyasNewBatch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AllowSlabBilling
		$this->AllowSlabBilling = new DbField('pharmacy_products', 'pharmacy_products', 'x_AllowSlabBilling', 'AllowSlabBilling', '`AllowSlabBilling`', '`AllowSlabBilling`', 16, -1, FALSE, '`AllowSlabBilling`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->ProductTypeForProduction = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductTypeForProduction', 'ProductTypeForProduction', '`ProductTypeForProduction`', '`ProductTypeForProduction`', 3, -1, FALSE, '`ProductTypeForProduction`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RecipeCode
		$this->RecipeCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_RecipeCode', 'RecipeCode', '`RecipeCode`', '`RecipeCode`', 3, -1, FALSE, '`RecipeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DefaultUnitType
		$this->DefaultUnitType = new DbField('pharmacy_products', 'pharmacy_products', 'x_DefaultUnitType', 'DefaultUnitType', '`DefaultUnitType`', '`DefaultUnitType`', 3, -1, FALSE, '`DefaultUnitType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PIstatus
		$this->PIstatus = new DbField('pharmacy_products', 'pharmacy_products', 'x_PIstatus', 'PIstatus', '`PIstatus`', '`PIstatus`', 3, -1, FALSE, '`PIstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastPiConfirmedDate
		$this->LastPiConfirmedDate = new DbField('pharmacy_products', 'pharmacy_products', 'x_LastPiConfirmedDate', 'LastPiConfirmedDate', '`LastPiConfirmedDate`', CastDateFieldForLike('`LastPiConfirmedDate`', 0, "DB"), 135, 0, FALSE, '`LastPiConfirmedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BarCodeDesign
		$this->BarCodeDesign = new DbField('pharmacy_products', 'pharmacy_products', 'x_BarCodeDesign', 'BarCodeDesign', '`BarCodeDesign`', '`BarCodeDesign`', 200, -1, FALSE, '`BarCodeDesign`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BarCodeDesign->Sortable = TRUE; // Allow sort
		$this->fields['BarCodeDesign'] = &$this->BarCodeDesign;

		// AcceptRemarksInBill
		$this->AcceptRemarksInBill = new DbField('pharmacy_products', 'pharmacy_products', 'x_AcceptRemarksInBill', 'AcceptRemarksInBill', '`AcceptRemarksInBill`', '`AcceptRemarksInBill`', 16, -1, FALSE, '`AcceptRemarksInBill`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Classification
		$this->Classification = new DbField('pharmacy_products', 'pharmacy_products', 'x_Classification', 'Classification', '`Classification`', '`Classification`', 3, -1, FALSE, '`Classification`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TimeSlot
		$this->TimeSlot = new DbField('pharmacy_products', 'pharmacy_products', 'x_TimeSlot', 'TimeSlot', '`TimeSlot`', '`TimeSlot`', 3, -1, FALSE, '`TimeSlot`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsBundle
		$this->IsBundle = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsBundle', 'IsBundle', '`IsBundle`', '`IsBundle`', 16, -1, FALSE, '`IsBundle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ColorCode
		$this->ColorCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ColorCode', 'ColorCode', '`ColorCode`', '`ColorCode`', 3, -1, FALSE, '`ColorCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GenderCode
		$this->GenderCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_GenderCode', 'GenderCode', '`GenderCode`', '`GenderCode`', 3, -1, FALSE, '`GenderCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SizeCode
		$this->SizeCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_SizeCode', 'SizeCode', '`SizeCode`', '`SizeCode`', 3, -1, FALSE, '`SizeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GiftCard
		$this->GiftCard = new DbField('pharmacy_products', 'pharmacy_products', 'x_GiftCard', 'GiftCard', '`GiftCard`', '`GiftCard`', 3, -1, FALSE, '`GiftCard`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ToonLabel
		$this->ToonLabel = new DbField('pharmacy_products', 'pharmacy_products', 'x_ToonLabel', 'ToonLabel', '`ToonLabel`', '`ToonLabel`', 3, -1, FALSE, '`ToonLabel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GarmentType
		$this->GarmentType = new DbField('pharmacy_products', 'pharmacy_products', 'x_GarmentType', 'GarmentType', '`GarmentType`', '`GarmentType`', 3, -1, FALSE, '`GarmentType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AgeGroup
		$this->AgeGroup = new DbField('pharmacy_products', 'pharmacy_products', 'x_AgeGroup', 'AgeGroup', '`AgeGroup`', '`AgeGroup`', 3, -1, FALSE, '`AgeGroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Season
		$this->Season = new DbField('pharmacy_products', 'pharmacy_products', 'x_Season', 'Season', '`Season`', '`Season`', 3, -1, FALSE, '`Season`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DailyStockEntry
		$this->DailyStockEntry = new DbField('pharmacy_products', 'pharmacy_products', 'x_DailyStockEntry', 'DailyStockEntry', '`DailyStockEntry`', '`DailyStockEntry`', 16, -1, FALSE, '`DailyStockEntry`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ModifierApplicable
		$this->ModifierApplicable = new DbField('pharmacy_products', 'pharmacy_products', 'x_ModifierApplicable', 'ModifierApplicable', '`ModifierApplicable`', '`ModifierApplicable`', 16, -1, FALSE, '`ModifierApplicable`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ModifierType
		$this->ModifierType = new DbField('pharmacy_products', 'pharmacy_products', 'x_ModifierType', 'ModifierType', '`ModifierType`', '`ModifierType`', 3, -1, FALSE, '`ModifierType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AcceptZeroRate
		$this->AcceptZeroRate = new DbField('pharmacy_products', 'pharmacy_products', 'x_AcceptZeroRate', 'AcceptZeroRate', '`AcceptZeroRate`', '`AcceptZeroRate`', 3, -1, FALSE, '`AcceptZeroRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ExciseDutyCode
		$this->ExciseDutyCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ExciseDutyCode', 'ExciseDutyCode', '`ExciseDutyCode`', '`ExciseDutyCode`', 3, -1, FALSE, '`ExciseDutyCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->IndentProductGroupCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_IndentProductGroupCode', 'IndentProductGroupCode', '`IndentProductGroupCode`', '`IndentProductGroupCode`', 3, -1, FALSE, '`IndentProductGroupCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsMultiBatch
		$this->IsMultiBatch = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsMultiBatch', 'IsMultiBatch', '`IsMultiBatch`', '`IsMultiBatch`', 16, -1, FALSE, '`IsMultiBatch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsSingleBatch
		$this->IsSingleBatch = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsSingleBatch', 'IsSingleBatch', '`IsSingleBatch`', '`IsSingleBatch`', 16, -1, FALSE, '`IsSingleBatch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarkUpRate1
		$this->MarkUpRate1 = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarkUpRate1', 'MarkUpRate1', '`MarkUpRate1`', '`MarkUpRate1`', 5, -1, FALSE, '`MarkUpRate1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarkDownRate1
		$this->MarkDownRate1 = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarkDownRate1', 'MarkDownRate1', '`MarkDownRate1`', '`MarkDownRate1`', 5, -1, FALSE, '`MarkDownRate1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarkUpRate2
		$this->MarkUpRate2 = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarkUpRate2', 'MarkUpRate2', '`MarkUpRate2`', '`MarkUpRate2`', 5, -1, FALSE, '`MarkUpRate2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarkDownRate2
		$this->MarkDownRate2 = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarkDownRate2', 'MarkDownRate2', '`MarkDownRate2`', '`MarkDownRate2`', 5, -1, FALSE, '`MarkDownRate2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Yield
		$this->_Yield = new DbField('pharmacy_products', 'pharmacy_products', 'x__Yield', 'Yield', '`Yield`', '`Yield`', 5, -1, FALSE, '`Yield`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RefProductCode
		$this->RefProductCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_RefProductCode', 'RefProductCode', '`RefProductCode`', '`RefProductCode`', 3, -1, FALSE, '`RefProductCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Volume
		$this->Volume = new DbField('pharmacy_products', 'pharmacy_products', 'x_Volume', 'Volume', '`Volume`', '`Volume`', 5, -1, FALSE, '`Volume`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MeasurementID
		$this->MeasurementID = new DbField('pharmacy_products', 'pharmacy_products', 'x_MeasurementID', 'MeasurementID', '`MeasurementID`', '`MeasurementID`', 3, -1, FALSE, '`MeasurementID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CountryCode
		$this->CountryCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_CountryCode', 'CountryCode', '`CountryCode`', '`CountryCode`', 3, -1, FALSE, '`CountryCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AcceptWMQty
		$this->AcceptWMQty = new DbField('pharmacy_products', 'pharmacy_products', 'x_AcceptWMQty', 'AcceptWMQty', '`AcceptWMQty`', '`AcceptWMQty`', 3, -1, FALSE, '`AcceptWMQty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SingleBatchBasedOnRate = new DbField('pharmacy_products', 'pharmacy_products', 'x_SingleBatchBasedOnRate', 'SingleBatchBasedOnRate', '`SingleBatchBasedOnRate`', '`SingleBatchBasedOnRate`', 3, -1, FALSE, '`SingleBatchBasedOnRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TenderNo
		$this->TenderNo = new DbField('pharmacy_products', 'pharmacy_products', 'x_TenderNo', 'TenderNo', '`TenderNo`', '`TenderNo`', 200, -1, FALSE, '`TenderNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TenderNo->Sortable = TRUE; // Allow sort
		$this->fields['TenderNo'] = &$this->TenderNo;

		// SingleBillMaximumSoldQtyFiled
		$this->SingleBillMaximumSoldQtyFiled = new DbField('pharmacy_products', 'pharmacy_products', 'x_SingleBillMaximumSoldQtyFiled', 'SingleBillMaximumSoldQtyFiled', '`SingleBillMaximumSoldQtyFiled`', '`SingleBillMaximumSoldQtyFiled`', 5, -1, FALSE, '`SingleBillMaximumSoldQtyFiled`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Strength1
		$this->Strength1 = new DbField('pharmacy_products', 'pharmacy_products', 'x_Strength1', 'Strength1', '`Strength1`', '`Strength1`', 200, -1, FALSE, '`Strength1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Strength1->Sortable = TRUE; // Allow sort
		$this->fields['Strength1'] = &$this->Strength1;

		// Strength2
		$this->Strength2 = new DbField('pharmacy_products', 'pharmacy_products', 'x_Strength2', 'Strength2', '`Strength2`', '`Strength2`', 200, -1, FALSE, '`Strength2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Strength2->Sortable = TRUE; // Allow sort
		$this->fields['Strength2'] = &$this->Strength2;

		// Strength3
		$this->Strength3 = new DbField('pharmacy_products', 'pharmacy_products', 'x_Strength3', 'Strength3', '`Strength3`', '`Strength3`', 200, -1, FALSE, '`Strength3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Strength3->Sortable = TRUE; // Allow sort
		$this->fields['Strength3'] = &$this->Strength3;

		// Strength4
		$this->Strength4 = new DbField('pharmacy_products', 'pharmacy_products', 'x_Strength4', 'Strength4', '`Strength4`', '`Strength4`', 200, -1, FALSE, '`Strength4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Strength4->Sortable = TRUE; // Allow sort
		$this->fields['Strength4'] = &$this->Strength4;

		// Strength5
		$this->Strength5 = new DbField('pharmacy_products', 'pharmacy_products', 'x_Strength5', 'Strength5', '`Strength5`', '`Strength5`', 200, -1, FALSE, '`Strength5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Strength5->Sortable = TRUE; // Allow sort
		$this->fields['Strength5'] = &$this->Strength5;

		// IngredientCode1
		$this->IngredientCode1 = new DbField('pharmacy_products', 'pharmacy_products', 'x_IngredientCode1', 'IngredientCode1', '`IngredientCode1`', '`IngredientCode1`', 3, -1, FALSE, '`IngredientCode1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IngredientCode2
		$this->IngredientCode2 = new DbField('pharmacy_products', 'pharmacy_products', 'x_IngredientCode2', 'IngredientCode2', '`IngredientCode2`', '`IngredientCode2`', 3, -1, FALSE, '`IngredientCode2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IngredientCode3
		$this->IngredientCode3 = new DbField('pharmacy_products', 'pharmacy_products', 'x_IngredientCode3', 'IngredientCode3', '`IngredientCode3`', '`IngredientCode3`', 3, -1, FALSE, '`IngredientCode3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IngredientCode4
		$this->IngredientCode4 = new DbField('pharmacy_products', 'pharmacy_products', 'x_IngredientCode4', 'IngredientCode4', '`IngredientCode4`', '`IngredientCode4`', 3, -1, FALSE, '`IngredientCode4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IngredientCode5
		$this->IngredientCode5 = new DbField('pharmacy_products', 'pharmacy_products', 'x_IngredientCode5', 'IngredientCode5', '`IngredientCode5`', '`IngredientCode5`', 3, -1, FALSE, '`IngredientCode5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// OrderType
		$this->OrderType = new DbField('pharmacy_products', 'pharmacy_products', 'x_OrderType', 'OrderType', '`OrderType`', '`OrderType`', 3, -1, FALSE, '`OrderType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StockUOM
		$this->StockUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_StockUOM', 'StockUOM', '`StockUOM`', '`StockUOM`', 3, -1, FALSE, '`StockUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PriceUOM
		$this->PriceUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_PriceUOM', 'PriceUOM', '`PriceUOM`', '`PriceUOM`', 3, -1, FALSE, '`PriceUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DefaultSaleUOM
		$this->DefaultSaleUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_DefaultSaleUOM', 'DefaultSaleUOM', '`DefaultSaleUOM`', '`DefaultSaleUOM`', 3, -1, FALSE, '`DefaultSaleUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DefaultPurchaseUOM
		$this->DefaultPurchaseUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_DefaultPurchaseUOM', 'DefaultPurchaseUOM', '`DefaultPurchaseUOM`', '`DefaultPurchaseUOM`', 3, -1, FALSE, '`DefaultPurchaseUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReportingUOM
		$this->ReportingUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_ReportingUOM', 'ReportingUOM', '`ReportingUOM`', '`ReportingUOM`', 3, -1, FALSE, '`ReportingUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LastPurchasedUOM
		$this->LastPurchasedUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_LastPurchasedUOM', 'LastPurchasedUOM', '`LastPurchasedUOM`', '`LastPurchasedUOM`', 3, -1, FALSE, '`LastPurchasedUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TreatmentCodes
		$this->TreatmentCodes = new DbField('pharmacy_products', 'pharmacy_products', 'x_TreatmentCodes', 'TreatmentCodes', '`TreatmentCodes`', '`TreatmentCodes`', 200, -1, FALSE, '`TreatmentCodes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TreatmentCodes->Sortable = TRUE; // Allow sort
		$this->fields['TreatmentCodes'] = &$this->TreatmentCodes;

		// InsuranceType
		$this->InsuranceType = new DbField('pharmacy_products', 'pharmacy_products', 'x_InsuranceType', 'InsuranceType', '`InsuranceType`', '`InsuranceType`', 3, -1, FALSE, '`InsuranceType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CoverageGroupCodes
		$this->CoverageGroupCodes = new DbField('pharmacy_products', 'pharmacy_products', 'x_CoverageGroupCodes', 'CoverageGroupCodes', '`CoverageGroupCodes`', '`CoverageGroupCodes`', 200, -1, FALSE, '`CoverageGroupCodes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CoverageGroupCodes->Sortable = TRUE; // Allow sort
		$this->fields['CoverageGroupCodes'] = &$this->CoverageGroupCodes;

		// MultipleUOM
		$this->MultipleUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_MultipleUOM', 'MultipleUOM', '`MultipleUOM`', '`MultipleUOM`', 17, -1, FALSE, '`MultipleUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SalePriceComputation = new DbField('pharmacy_products', 'pharmacy_products', 'x_SalePriceComputation', 'SalePriceComputation', '`SalePriceComputation`', '`SalePriceComputation`', 3, -1, FALSE, '`SalePriceComputation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// StockCorrection
		$this->StockCorrection = new DbField('pharmacy_products', 'pharmacy_products', 'x_StockCorrection', 'StockCorrection', '`StockCorrection`', '`StockCorrection`', 17, -1, FALSE, '`StockCorrection`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LBTPercentage
		$this->LBTPercentage = new DbField('pharmacy_products', 'pharmacy_products', 'x_LBTPercentage', 'LBTPercentage', '`LBTPercentage`', '`LBTPercentage`', 5, -1, FALSE, '`LBTPercentage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SalesCommission
		$this->SalesCommission = new DbField('pharmacy_products', 'pharmacy_products', 'x_SalesCommission', 'SalesCommission', '`SalesCommission`', '`SalesCommission`', 5, -1, FALSE, '`SalesCommission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LockedStock
		$this->LockedStock = new DbField('pharmacy_products', 'pharmacy_products', 'x_LockedStock', 'LockedStock', '`LockedStock`', '`LockedStock`', 5, -1, FALSE, '`LockedStock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MinMaxUOM
		$this->MinMaxUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_MinMaxUOM', 'MinMaxUOM', '`MinMaxUOM`', '`MinMaxUOM`', 3, -1, FALSE, '`MinMaxUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ExpiryMfrDateFormat
		$this->ExpiryMfrDateFormat = new DbField('pharmacy_products', 'pharmacy_products', 'x_ExpiryMfrDateFormat', 'ExpiryMfrDateFormat', '`ExpiryMfrDateFormat`', '`ExpiryMfrDateFormat`', 3, -1, FALSE, '`ExpiryMfrDateFormat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ProductLifeTime
		$this->ProductLifeTime = new DbField('pharmacy_products', 'pharmacy_products', 'x_ProductLifeTime', 'ProductLifeTime', '`ProductLifeTime`', '`ProductLifeTime`', 3, -1, FALSE, '`ProductLifeTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsCombo
		$this->IsCombo = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsCombo', 'IsCombo', '`IsCombo`', '`IsCombo`', 17, -1, FALSE, '`IsCombo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ComboTypeCode
		$this->ComboTypeCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_ComboTypeCode', 'ComboTypeCode', '`ComboTypeCode`', '`ComboTypeCode`', 3, -1, FALSE, '`ComboTypeCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount6
		$this->AttributeCount6 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount6', 'AttributeCount6', '`AttributeCount6`', '`AttributeCount6`', 3, -1, FALSE, '`AttributeCount6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount7
		$this->AttributeCount7 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount7', 'AttributeCount7', '`AttributeCount7`', '`AttributeCount7`', 3, -1, FALSE, '`AttributeCount7`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount8
		$this->AttributeCount8 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount8', 'AttributeCount8', '`AttributeCount8`', '`AttributeCount8`', 3, -1, FALSE, '`AttributeCount8`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount9
		$this->AttributeCount9 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount9', 'AttributeCount9', '`AttributeCount9`', '`AttributeCount9`', 3, -1, FALSE, '`AttributeCount9`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AttributeCount10
		$this->AttributeCount10 = new DbField('pharmacy_products', 'pharmacy_products', 'x_AttributeCount10', 'AttributeCount10', '`AttributeCount10`', '`AttributeCount10`', 3, -1, FALSE, '`AttributeCount10`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LabourCharge
		$this->LabourCharge = new DbField('pharmacy_products', 'pharmacy_products', 'x_LabourCharge', 'LabourCharge', '`LabourCharge`', '`LabourCharge`', 5, -1, FALSE, '`LabourCharge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AffectOtherCharge
		$this->AffectOtherCharge = new DbField('pharmacy_products', 'pharmacy_products', 'x_AffectOtherCharge', 'AffectOtherCharge', '`AffectOtherCharge`', '`AffectOtherCharge`', 17, -1, FALSE, '`AffectOtherCharge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DosageInfo
		$this->DosageInfo = new DbField('pharmacy_products', 'pharmacy_products', 'x_DosageInfo', 'DosageInfo', '`DosageInfo`', '`DosageInfo`', 200, -1, FALSE, '`DosageInfo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DosageInfo->Sortable = TRUE; // Allow sort
		$this->fields['DosageInfo'] = &$this->DosageInfo;

		// DosageType
		$this->DosageType = new DbField('pharmacy_products', 'pharmacy_products', 'x_DosageType', 'DosageType', '`DosageType`', '`DosageType`', 3, -1, FALSE, '`DosageType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DefaultIndentUOM
		$this->DefaultIndentUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_DefaultIndentUOM', 'DefaultIndentUOM', '`DefaultIndentUOM`', '`DefaultIndentUOM`', 3, -1, FALSE, '`DefaultIndentUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PromoTag
		$this->PromoTag = new DbField('pharmacy_products', 'pharmacy_products', 'x_PromoTag', 'PromoTag', '`PromoTag`', '`PromoTag`', 17, -1, FALSE, '`PromoTag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillLevelPromoTag
		$this->BillLevelPromoTag = new DbField('pharmacy_products', 'pharmacy_products', 'x_BillLevelPromoTag', 'BillLevelPromoTag', '`BillLevelPromoTag`', '`BillLevelPromoTag`', 17, -1, FALSE, '`BillLevelPromoTag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IsMRPProduct
		$this->IsMRPProduct = new DbField('pharmacy_products', 'pharmacy_products', 'x_IsMRPProduct', 'IsMRPProduct', '`IsMRPProduct`', '`IsMRPProduct`', 17, -1, FALSE, '`IsMRPProduct`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MrpList
		$this->MrpList = new DbField('pharmacy_products', 'pharmacy_products', 'x_MrpList', 'MrpList', '`MrpList`', '`MrpList`', 201, -1, FALSE, '`MrpList`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MrpList->Sortable = TRUE; // Allow sort
		$this->fields['MrpList'] = &$this->MrpList;

		// AlternateSaleUOM
		$this->AlternateSaleUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_AlternateSaleUOM', 'AlternateSaleUOM', '`AlternateSaleUOM`', '`AlternateSaleUOM`', 3, -1, FALSE, '`AlternateSaleUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FreeUOM
		$this->FreeUOM = new DbField('pharmacy_products', 'pharmacy_products', 'x_FreeUOM', 'FreeUOM', '`FreeUOM`', '`FreeUOM`', 3, -1, FALSE, '`FreeUOM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MarketedCode
		$this->MarketedCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_MarketedCode', 'MarketedCode', '`MarketedCode`', '`MarketedCode`', 200, -1, FALSE, '`MarketedCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MarketedCode->Sortable = TRUE; // Allow sort
		$this->fields['MarketedCode'] = &$this->MarketedCode;

		// MinimumSalePrice
		$this->MinimumSalePrice = new DbField('pharmacy_products', 'pharmacy_products', 'x_MinimumSalePrice', 'MinimumSalePrice', '`MinimumSalePrice`', '`MinimumSalePrice`', 5, -1, FALSE, '`MinimumSalePrice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PRate1
		$this->PRate1 = new DbField('pharmacy_products', 'pharmacy_products', 'x_PRate1', 'PRate1', '`PRate1`', '`PRate1`', 5, -1, FALSE, '`PRate1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PRate2
		$this->PRate2 = new DbField('pharmacy_products', 'pharmacy_products', 'x_PRate2', 'PRate2', '`PRate2`', '`PRate2`', 5, -1, FALSE, '`PRate2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LPItemCost
		$this->LPItemCost = new DbField('pharmacy_products', 'pharmacy_products', 'x_LPItemCost', 'LPItemCost', '`LPItemCost`', '`LPItemCost`', 5, -1, FALSE, '`LPItemCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FixedItemCost
		$this->FixedItemCost = new DbField('pharmacy_products', 'pharmacy_products', 'x_FixedItemCost', 'FixedItemCost', '`FixedItemCost`', '`FixedItemCost`', 5, -1, FALSE, '`FixedItemCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HSNId
		$this->HSNId = new DbField('pharmacy_products', 'pharmacy_products', 'x_HSNId', 'HSNId', '`HSNId`', '`HSNId`', 3, -1, FALSE, '`HSNId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TaxInclusive
		$this->TaxInclusive = new DbField('pharmacy_products', 'pharmacy_products', 'x_TaxInclusive', 'TaxInclusive', '`TaxInclusive`', '`TaxInclusive`', 17, -1, FALSE, '`TaxInclusive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EligibleforWarranty
		$this->EligibleforWarranty = new DbField('pharmacy_products', 'pharmacy_products', 'x_EligibleforWarranty', 'EligibleforWarranty', '`EligibleforWarranty`', '`EligibleforWarranty`', 17, -1, FALSE, '`EligibleforWarranty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NoofMonthsWarranty
		$this->NoofMonthsWarranty = new DbField('pharmacy_products', 'pharmacy_products', 'x_NoofMonthsWarranty', 'NoofMonthsWarranty', '`NoofMonthsWarranty`', '`NoofMonthsWarranty`', 3, -1, FALSE, '`NoofMonthsWarranty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ComputeTaxonCost
		$this->ComputeTaxonCost = new DbField('pharmacy_products', 'pharmacy_products', 'x_ComputeTaxonCost', 'ComputeTaxonCost', '`ComputeTaxonCost`', '`ComputeTaxonCost`', 17, -1, FALSE, '`ComputeTaxonCost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HasEmptyBottleTrack
		$this->HasEmptyBottleTrack = new DbField('pharmacy_products', 'pharmacy_products', 'x_HasEmptyBottleTrack', 'HasEmptyBottleTrack', '`HasEmptyBottleTrack`', '`HasEmptyBottleTrack`', 17, -1, FALSE, '`HasEmptyBottleTrack`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->EmptyBottleReferenceCode = new DbField('pharmacy_products', 'pharmacy_products', 'x_EmptyBottleReferenceCode', 'EmptyBottleReferenceCode', '`EmptyBottleReferenceCode`', '`EmptyBottleReferenceCode`', 3, -1, FALSE, '`EmptyBottleReferenceCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AdditionalCESSAmount = new DbField('pharmacy_products', 'pharmacy_products', 'x_AdditionalCESSAmount', 'AdditionalCESSAmount', '`AdditionalCESSAmount`', '`AdditionalCESSAmount`', 5, -1, FALSE, '`AdditionalCESSAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EmptyBottleRate
		$this->EmptyBottleRate = new DbField('pharmacy_products', 'pharmacy_products', 'x_EmptyBottleRate', 'EmptyBottleRate', '`EmptyBottleRate`', '`EmptyBottleRate`', 5, -1, FALSE, '`EmptyBottleRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getRecordFilter($row = NULL)
	{
		...
		$val = is_array($row) ? (array_key_exists('ProductCode', $row) ? $row['ProductCode'] : NULL) : $this->ProductCode->CurrentValue;
		if (!is_numeric($val))
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_productsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
