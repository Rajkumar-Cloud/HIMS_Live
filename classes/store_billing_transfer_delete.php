 ...
 * Page class
 */
class store_billing_transfer_delete extends store_billing_transfer
{
	...
	// Page object name
	public $PageObjName = "store_billing_transfer_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("store_billing_transferlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("store_billing_transferlist.php"); // Return to list
			}
		}
	}
