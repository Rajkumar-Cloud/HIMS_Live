 ...
 */
class hospital_store extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('hospital_store', 'hospital_store', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// logo
		$this->logo = new DbField('hospital_store', 'hospital_store', 'x_logo', 'logo', '`logo`', '`logo`', 201, -1, TRUE, '`logo`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->logo->Sortable = TRUE; // Allow sort
		$this->fields['logo'] = &$this->logo;

		// pharmacy
		$this->pharmacy = new DbField('hospital_store', 'hospital_store', 'x_pharmacy', 'pharmacy', '`pharmacy`', '`pharmacy`', 200, -1, FALSE, '`pharmacy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// street
		$this->street = new DbField('hospital_store', 'hospital_store', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// area
		$this->area = new DbField('hospital_store', 'hospital_store', 'x_area', 'area', '`area`', '`area`', 200, -1, FALSE, '`area`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->area->Sortable = TRUE; // Allow sort
		$this->fields['area'] = &$this->area;

		// town
		$this->town = new DbField('hospital_store', 'hospital_store', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// province
		$this->province = new DbField('hospital_store', 'hospital_store', 'x_province', 'province', '`province`', '`province`', 200, -1, FALSE, '`province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->province->Sortable = TRUE; // Allow sort
		$this->fields['province'] = &$this->province;

		// postal_code
		$this->postal_code = new DbField('hospital_store', 'hospital_store', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, -1, FALSE, '`postal_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->postal_code->Sortable = TRUE; // Allow sort
		$this->fields['postal_code'] = &$this->postal_code;

		// phone_no
		$this->phone_no = new DbField('hospital_store', 'hospital_store', 'x_phone_no', 'phone_no', '`phone_no`', '`phone_no`', 200, -1, FALSE, '`phone_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->phone_no->Sortable = TRUE; // Allow sort
		$this->fields['phone_no'] = &$this->phone_no;

		// PreFixCode
		$this->PreFixCode = new DbField('hospital_store', 'hospital_store', 'x_PreFixCode', 'PreFixCode', '`PreFixCode`', '`PreFixCode`', 200, -1, FALSE, '`PreFixCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PreFixCode->Sortable = TRUE; // Allow sort
		$this->fields['PreFixCode'] = &$this->PreFixCode;

		// status
		$this->status = new DbField('hospital_store', 'hospital_store', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('hospital_store', 'hospital_store', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('hospital_store', 'hospital_store', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('hospital_store', 'hospital_store', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('hospital_store', 'hospital_store', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// pharmacyGST
		$this->pharmacyGST = new DbField('hospital_store', 'hospital_store', 'x_pharmacyGST', 'pharmacyGST', '`pharmacyGST`', '`pharmacyGST`', 200, -1, FALSE, '`pharmacyGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pharmacyGST->Sortable = TRUE; // Allow sort
		$this->fields['pharmacyGST'] = &$this->pharmacyGST;

		// HospId
		$this->HospId = new DbField('hospital_store', 'hospital_store', 'x_HospId', 'HospId', '`HospId`', '`HospId`', 3, -1, FALSE, '`HospId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// BranchID
		$this->BranchID = new DbField('hospital_store', 'hospital_store', 'x_BranchID', 'BranchID', '`BranchID`', '`BranchID`', 3, -1, FALSE, '`BranchID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "hospital_storeview.php")
			return $Language->phrase("View");
		elseif ($pageName == "hospital_storeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "hospital_storeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("hospital_storeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("hospital_storeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "hospital_storeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "hospital_storeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("hospital_storeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("hospital_storeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("hospital_storedelete.php", $this->getUrlParm());
	}
