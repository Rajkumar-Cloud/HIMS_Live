 ...
 * Page class
 */
class store_grn_delete extends store_grn
{
	...
	// Page object name
	public $PageObjName = "store_grn_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("store_grnlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("store_grnlist.php"); // Return to list
			}
		}
	}
