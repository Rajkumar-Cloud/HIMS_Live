 ...
 * Page class
 */
class crm_contactsubdetails_edit extends crm_contactsubdetails
{
	...
	// Page object name
	public $PageObjName = "crm_contactsubdetails_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_contactsubscriptionid")) {
				$this->contactsubscriptionid->setFormValue($CurrentForm->getValue("x_contactsubscriptionid"));
			}
		} else {
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->contactsubscriptionid->EditValue = FormatNumber($this->contactsubscriptionid->EditValue, 0, -2, -2, -2);
			$this->contactsubscriptionid->ViewCustomAttributes = "";
