...
class view_treatment_culture extends DbTable
{
	...
	public function __construct()
	{
		...
		// TidNo
		$this->TidNo = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day0OocyteStage
		$this->Day0OocyteStage = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day0OocyteStage', 'Day0OocyteStage', '`Day0OocyteStage`', '`Day0OocyteStage`', 20, -1, FALSE, '`Day0OocyteStage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day1
		$this->Day1 = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day1', 'Day1', '`Day1`', '`Day1`', 20, -1, FALSE, '`Day1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day2
		$this->Day2 = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day2', 'Day2', '`Day2`', '`Day2`', 20, -1, FALSE, '`Day2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day3
		$this->Day3 = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day3', 'Day3', '`Day3`', '`Day3`', 20, -1, FALSE, '`Day3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day4
		$this->Day4 = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day4', 'Day4', '`Day4`', '`Day4`', 20, -1, FALSE, '`Day4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day5
		$this->Day5 = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day5', 'Day5', '`Day5`', '`Day5`', 20, -1, FALSE, '`Day5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day6
		$this->Day6 = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_Day6', 'Day6', '`Day6`', '`Day6`', 20, -1, FALSE, '`Day6`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ET
		$this->ET = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_ET', 'ET', '`ET`', '`ET`', 20, -1, FALSE, '`ET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ETDate
		$this->ETDate = new DbField('view_treatment_culture', 'view_treatment_culture', 'x_ETDate', 'ETDate', '`ETDate`', '`ETDate`', 20, -1, FALSE, '`ETDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_treatment_cultureview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
