...
class view_partner_semenstock extends DbTable
{
	...
	public function __construct()
	{
		...
		// RIDNo
		$this->RIDNo = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientName
		$this->PatientName = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// HusbandName
		$this->HusbandName = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_HusbandName', 'HusbandName', '`HusbandName`', '`HusbandName`', 200, -1, FALSE, '`HusbandName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HusbandName->Sortable = TRUE; // Allow sort
		$this->fields['HusbandName'] = &$this->HusbandName;

		// RequestDr
		$this->RequestDr = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_RequestDr', 'RequestDr', '`RequestDr`', '`RequestDr`', 200, -1, FALSE, '`RequestDr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RequestDr->Sortable = TRUE; // Allow sort
		$this->fields['RequestDr'] = &$this->RequestDr;

		// stock
		$this->stock = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_stock', 'stock', '`stock`', '`stock`', 20, -1, FALSE, '`stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_partner_semenstockview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
