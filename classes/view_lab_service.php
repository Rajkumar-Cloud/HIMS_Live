...
class view_lab_service extends DbTable
{
	...
	public function __construct()
	{
		...
		// Id
		$this->Id = new DbField('view_lab_service', 'view_lab_service', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// CODE
		$this->CODE = new DbField('view_lab_service', 'view_lab_service', 'x_CODE', 'CODE', '`CODE`', '`CODE`', 200, -1, FALSE, '`CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SERVICE
		$this->SERVICE = new DbField('view_lab_service', 'view_lab_service', 'x_SERVICE', 'SERVICE', '`SERVICE`', '`SERVICE`', 200, -1, FALSE, '`SERVICE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SERVICE->Required = TRUE; // Required field
		$this->SERVICE->Sortable = TRUE; // Allow sort
		$this->fields['SERVICE'] = &$this->SERVICE;

		// UNITS
		$this->UNITS = new DbField('view_lab_service', 'view_lab_service', 'x_UNITS', 'UNITS', '`UNITS`', '`UNITS`', 3, -1, FALSE, '`UNITS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// AMOUNT
		$this->AMOUNT = new DbField('view_lab_service', 'view_lab_service', 'x_AMOUNT', 'AMOUNT', '`AMOUNT`', '`AMOUNT`', 5, -1, FALSE, '`AMOUNT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AMOUNT->Required = TRUE; // Required field
		$this->AMOUNT->Sortable = TRUE; // Allow sort
		$this->fields['AMOUNT'] = &$this->AMOUNT;

		// SERVICE_TYPE
		$this->SERVICE_TYPE = new DbField('view_lab_service', 'view_lab_service', 'x_SERVICE_TYPE', 'SERVICE_TYPE', '`SERVICE_TYPE`', '`SERVICE_TYPE`', 200, -1, FALSE, '`SERVICE_TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DEPARTMENT
		$this->DEPARTMENT = new DbField('view_lab_service', 'view_lab_service', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, -1, FALSE, '`DEPARTMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Created
		$this->Created = new DbField('view_lab_service', 'view_lab_service', 'x_Created', 'Created', '`Created`', '`Created`', 200, -1, FALSE, '`Created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Created->Sortable = FALSE; // Allow sort
		$this->fields['Created'] = &$this->Created;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('view_lab_service', 'view_lab_service', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedDateTime->Sortable = FALSE; // Allow sort
		$this->CreatedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['CreatedDateTime'] = &$this->CreatedDateTime;

		// Modified
		$this->Modified = new DbField('view_lab_service', 'view_lab_service', 'x_Modified', 'Modified', '`Modified`', '`Modified`', 200, -1, FALSE, '`Modified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Modified->Sortable = FALSE; // Allow sort
		$this->fields['Modified'] = &$this->Modified;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('view_lab_service', 'view_lab_service', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike('`ModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedDateTime->Sortable = FALSE; // Allow sort
		$this->ModifiedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['ModifiedDateTime'] = &$this->ModifiedDateTime;

		// mas_services_billingcol
		$this->mas_services_billingcol = new DbField('view_lab_service', 'view_lab_service', 'x_mas_services_billingcol', 'mas_services_billingcol', '`mas_services_billingcol`', '`mas_services_billingcol`', 200, -1, FALSE, '`mas_services_billingcol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mas_services_billingcol->Sortable = TRUE; // Allow sort
		$this->fields['mas_services_billingcol'] = &$this->mas_services_billingcol;

		// DrShareAmount
		$this->DrShareAmount = new DbField('view_lab_service', 'view_lab_service', 'x_DrShareAmount', 'DrShareAmount', '`DrShareAmount`', '`DrShareAmount`', 5, -1, FALSE, '`DrShareAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospShareAmount
		$this->HospShareAmount = new DbField('view_lab_service', 'view_lab_service', 'x_HospShareAmount', 'HospShareAmount', '`HospShareAmount`', '`HospShareAmount`', 5, -1, FALSE, '`HospShareAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrSharePer
		$this->DrSharePer = new DbField('view_lab_service', 'view_lab_service', 'x_DrSharePer', 'DrSharePer', '`DrSharePer`', '`DrSharePer`', 3, -1, FALSE, '`DrSharePer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospSharePer
		$this->HospSharePer = new DbField('view_lab_service', 'view_lab_service', 'x_HospSharePer', 'HospSharePer', '`HospSharePer`', '`HospSharePer`', 3, -1, FALSE, '`HospSharePer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_lab_service', 'view_lab_service', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// TestSubCd
		$this->TestSubCd = new DbField('view_lab_service', 'view_lab_service', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, -1, FALSE, '`TestSubCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestSubCd->Sortable = TRUE; // Allow sort
		$this->fields['TestSubCd'] = &$this->TestSubCd;

		// Method
		$this->Method = new DbField('view_lab_service', 'view_lab_service', 'x_Method', 'Method', '`Method`', '`Method`', 200, -1, FALSE, '`Method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Method->Sortable = TRUE; // Allow sort
		$this->fields['Method'] = &$this->Method;

		// Order
		$this->Order = new DbField('view_lab_service', 'view_lab_service', 'x_Order', 'Order', '`Order`', '`Order`', 131, -1, FALSE, '`Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Form
		$this->Form = new DbField('view_lab_service', 'view_lab_service', 'x_Form', 'Form', '`Form`', '`Form`', 201, -1, FALSE, '`Form`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Form->Sortable = TRUE; // Allow sort
		$this->fields['Form'] = &$this->Form;

		// ResType
		$this->ResType = new DbField('view_lab_service', 'view_lab_service', 'x_ResType', 'ResType', '`ResType`', '`ResType`', 200, -1, FALSE, '`ResType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ResType->Sortable = TRUE; // Allow sort
		$this->fields['ResType'] = &$this->ResType;

		// UnitCD
		$this->UnitCD = new DbField('view_lab_service', 'view_lab_service', 'x_UnitCD', 'UnitCD', '`UnitCD`', '`UnitCD`', 200, -1, FALSE, '`UnitCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UnitCD->Sortable = TRUE; // Allow sort
		$this->fields['UnitCD'] = &$this->UnitCD;

		// RefValue
		$this->RefValue = new DbField('view_lab_service', 'view_lab_service', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, -1, FALSE, '`RefValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->RefValue->Sortable = TRUE; // Allow sort
		$this->fields['RefValue'] = &$this->RefValue;

		// Sample
		$this->Sample = new DbField('view_lab_service', 'view_lab_service', 'x_Sample', 'Sample', '`Sample`', '`Sample`', 200, -1, FALSE, '`Sample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sample->Sortable = TRUE; // Allow sort
		$this->fields['Sample'] = &$this->Sample;

		// NoD
		$this->NoD = new DbField('view_lab_service', 'view_lab_service', 'x_NoD', 'NoD', '`NoD`', '`NoD`', 131, -1, FALSE, '`NoD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoD->Sortable = TRUE; // Allow sort
		$this->NoD->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['NoD'] = &$this->NoD;

		// BillOrder
		$this->BillOrder = new DbField('view_lab_service', 'view_lab_service', 'x_BillOrder', 'BillOrder', '`BillOrder`', '`BillOrder`', 131, -1, FALSE, '`BillOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Formula
		$this->Formula = new DbField('view_lab_service', 'view_lab_service', 'x_Formula', 'Formula', '`Formula`', '`Formula`', 201, -1, FALSE, '`Formula`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Formula->Sortable = TRUE; // Allow sort
		$this->fields['Formula'] = &$this->Formula;

		// Inactive
		$this->Inactive = new DbField('view_lab_service', 'view_lab_service', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, -1, FALSE, '`Inactive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Outsource
		$this->Outsource = new DbField('view_lab_service', 'view_lab_service', 'x_Outsource', 'Outsource', '`Outsource`', '`Outsource`', 200, -1, FALSE, '`Outsource`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Outsource->Sortable = TRUE; // Allow sort
		$this->fields['Outsource'] = &$this->Outsource;

		// CollSample
		$this->CollSample = new DbField('view_lab_service', 'view_lab_service', 'x_CollSample', 'CollSample', '`CollSample`', '`CollSample`', 200, -1, FALSE, '`CollSample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CollSample->Sortable = TRUE; // Allow sort
		$this->fields['CollSample'] = &$this->CollSample;

		// TestType
		$this->TestType = new DbField('view_lab_service', 'view_lab_service', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, -1, FALSE, '`TestType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NoHeading
		$this->NoHeading = new DbField('view_lab_service', 'view_lab_service', 'x_NoHeading', 'NoHeading', '`NoHeading`', '`NoHeading`', 200, -1, FALSE, '`NoHeading`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoHeading->Sortable = TRUE; // Allow sort
		$this->fields['NoHeading'] = &$this->NoHeading;

		// ChemicalCode
		$this->ChemicalCode = new DbField('view_lab_service', 'view_lab_service', 'x_ChemicalCode', 'ChemicalCode', '`ChemicalCode`', '`ChemicalCode`', 200, -1, FALSE, '`ChemicalCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ChemicalCode->Sortable = TRUE; // Allow sort
		$this->fields['ChemicalCode'] = &$this->ChemicalCode;

		// ChemicalName
		$this->ChemicalName = new DbField('view_lab_service', 'view_lab_service', 'x_ChemicalName', 'ChemicalName', '`ChemicalName`', '`ChemicalName`', 200, -1, FALSE, '`ChemicalName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ChemicalName->Sortable = TRUE; // Allow sort
		$this->fields['ChemicalName'] = &$this->ChemicalName;

		// Utilaization
		$this->Utilaization = new DbField('view_lab_service', 'view_lab_service', 'x_Utilaization', 'Utilaization', '`Utilaization`', '`Utilaization`', 200, -1, FALSE, '`Utilaization`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Utilaization->Sortable = TRUE; // Allow sort
		$this->fields['Utilaization'] = &$this->Utilaization;

		// Interpretation
		$this->Interpretation = new DbField('view_lab_service', 'view_lab_service', 'x_Interpretation', 'Interpretation', '`Interpretation`', '`Interpretation`', 201, -1, FALSE, '`Interpretation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_lab_service_sub") {
			$detailUrl = $GLOBALS["view_lab_service_sub"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_lab_serviceview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_lab_serviceedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_lab_serviceadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
