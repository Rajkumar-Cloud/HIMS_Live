...
class pharmacy_batchmas_search extends pharmacy_batchmas
{
	...
	protected function loadSearchValues()
	{
		...
		// PRCODE
		if (!$this->isAddOrEdit())
			$this->PRCODE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PRCODE"));
		$this->PRCODE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PRCODE"));
		...
		// FRQ
		if (!$this->isAddOrEdit())
			$this->FRQ->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_FRQ"));
		$this->FRQ->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_FRQ"));
		...
		// OLDRT
		if (!$this->isAddOrEdit())
			$this->OLDRT->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_OLDRT"));
		$this->OLDRT->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_OLDRT"));

		// TEMPMRQ
		if (!$this->isAddOrEdit())
			$this->TEMPMRQ->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TEMPMRQ"));
		$this->TEMPMRQ->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TEMPMRQ"));
		...
		// OLDRATE
		if (!$this->isAddOrEdit())
			$this->OLDRATE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_OLDRATE"));
		$this->OLDRATE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_OLDRATE"));

		// NEWRATE
		if (!$this->isAddOrEdit())
			$this->NEWRATE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NEWRATE"));
		$this->NEWRATE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NEWRATE"));

		// OTEMPMRA
		if (!$this->isAddOrEdit())
			$this->OTEMPMRA->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_OTEMPMRA"));
		$this->OTEMPMRA->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_OTEMPMRA"));

		// ACTIVESTATUS
		if (!$this->isAddOrEdit())
			$this->ACTIVESTATUS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ACTIVESTATUS"));
		$this->ACTIVESTATUS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ACTIVESTATUS"));
