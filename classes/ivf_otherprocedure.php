...
class ivf_otherprocedure extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNO
		$this->RIDNO = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNO->Sortable = TRUE; // Allow sort
		$this->RIDNO->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNO'] = &$this->RIDNO;

		// Name
		$this->Name = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->Name->Lookup = new Lookup('Name', 'patient', FALSE, 'id', ["first_name","","",""], [], [], [], [], [], [], '', '');
		$this->fields['Name'] = &$this->Name;

		// Age
		$this->Age = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = FALSE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// SEX
		$this->SEX = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_SEX', 'SEX', '`SEX`', '`SEX`', 200, -1, FALSE, '`SEX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SEX->Sortable = FALSE; // Allow sort
		$this->fields['SEX'] = &$this->SEX;

		// Address
		$this->Address = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Address', 'Address', '`Address`', '`Address`', 200, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address->Sortable = FALSE; // Allow sort
		$this->fields['Address'] = &$this->Address;

		// DateofAdmission
		$this->DateofAdmission = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_DateofAdmission', 'DateofAdmission', '`DateofAdmission`', CastDateFieldForLike('`DateofAdmission`', 11, "DB"), 135, 11, FALSE, '`DateofAdmission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateofProcedure
		$this->DateofProcedure = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_DateofProcedure', 'DateofProcedure', '`DateofProcedure`', CastDateFieldForLike('`DateofProcedure`', 11, "DB"), 135, 11, FALSE, '`DateofProcedure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DateofProcedure->Sortable = TRUE; // Allow sort
		$this->fields['DateofProcedure'] = &$this->DateofProcedure;

		// DateofDischarge
		$this->DateofDischarge = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_DateofDischarge', 'DateofDischarge', '`DateofDischarge`', CastDateFieldForLike('`DateofDischarge`', 11, "DB"), 135, 11, FALSE, '`DateofDischarge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DateofDischarge->Sortable = TRUE; // Allow sort
		$this->fields['DateofDischarge'] = &$this->DateofDischarge;

		// Consultant
		$this->Consultant = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, -1, FALSE, '`Consultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Surgeon
		$this->Surgeon = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Surgeon', 'Surgeon', '`Surgeon`', '`Surgeon`', 200, -1, FALSE, '`Surgeon`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Anesthetist
		$this->Anesthetist = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Anesthetist', 'Anesthetist', '`Anesthetist`', '`Anesthetist`', 200, -1, FALSE, '`Anesthetist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IdentificationMark
		$this->IdentificationMark = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_IdentificationMark', 'IdentificationMark', '`IdentificationMark`', '`IdentificationMark`', 200, -1, FALSE, '`IdentificationMark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IdentificationMark->Sortable = TRUE; // Allow sort
		$this->fields['IdentificationMark'] = &$this->IdentificationMark;

		// ProcedureDone
		$this->ProcedureDone = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_ProcedureDone', 'ProcedureDone', '`ProcedureDone`', '`ProcedureDone`', 200, -1, FALSE, '`ProcedureDone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProcedureDone->Sortable = TRUE; // Allow sort
		$this->fields['ProcedureDone'] = &$this->ProcedureDone;

		// PROVISIONALDIAGNOSIS
		$this->PROVISIONALDIAGNOSIS = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_PROVISIONALDIAGNOSIS', 'PROVISIONALDIAGNOSIS', '`PROVISIONALDIAGNOSIS`', '`PROVISIONALDIAGNOSIS`', 200, -1, FALSE, '`PROVISIONALDIAGNOSIS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PROVISIONALDIAGNOSIS->Sortable = TRUE; // Allow sort
		$this->fields['PROVISIONALDIAGNOSIS'] = &$this->PROVISIONALDIAGNOSIS;

		// Chiefcomplaints
		$this->Chiefcomplaints = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Chiefcomplaints', 'Chiefcomplaints', '`Chiefcomplaints`', '`Chiefcomplaints`', 200, -1, FALSE, '`Chiefcomplaints`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Chiefcomplaints->Sortable = TRUE; // Allow sort
		$this->fields['Chiefcomplaints'] = &$this->Chiefcomplaints;

		// MaritallHistory
		$this->MaritallHistory = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_MaritallHistory', 'MaritallHistory', '`MaritallHistory`', '`MaritallHistory`', 200, -1, FALSE, '`MaritallHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MaritallHistory->Sortable = TRUE; // Allow sort
		$this->fields['MaritallHistory'] = &$this->MaritallHistory;

		// MenstrualHistory
		$this->MenstrualHistory = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_MenstrualHistory', 'MenstrualHistory', '`MenstrualHistory`', '`MenstrualHistory`', 200, -1, FALSE, '`MenstrualHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MenstrualHistory->Sortable = TRUE; // Allow sort
		$this->fields['MenstrualHistory'] = &$this->MenstrualHistory;

		// SurgicalHistory
		$this->SurgicalHistory = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_SurgicalHistory', 'SurgicalHistory', '`SurgicalHistory`', '`SurgicalHistory`', 200, -1, FALSE, '`SurgicalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SurgicalHistory->Sortable = TRUE; // Allow sort
		$this->fields['SurgicalHistory'] = &$this->SurgicalHistory;

		// PastHistory
		$this->PastHistory = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_PastHistory', 'PastHistory', '`PastHistory`', '`PastHistory`', 200, -1, FALSE, '`PastHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PastHistory->Sortable = TRUE; // Allow sort
		$this->fields['PastHistory'] = &$this->PastHistory;

		// FamilyHistory
		$this->FamilyHistory = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_FamilyHistory', 'FamilyHistory', '`FamilyHistory`', '`FamilyHistory`', 200, -1, FALSE, '`FamilyHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FamilyHistory->Sortable = TRUE; // Allow sort
		$this->fields['FamilyHistory'] = &$this->FamilyHistory;

		// Temp
		$this->Temp = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Temp', 'Temp', '`Temp`', '`Temp`', 200, -1, FALSE, '`Temp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Temp->Sortable = TRUE; // Allow sort
		$this->fields['Temp'] = &$this->Temp;

		// Pulse
		$this->Pulse = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Pulse', 'Pulse', '`Pulse`', '`Pulse`', 200, -1, FALSE, '`Pulse`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pulse->Sortable = TRUE; // Allow sort
		$this->fields['Pulse'] = &$this->Pulse;

		// BP
		$this->BP = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_BP', 'BP', '`BP`', '`BP`', 200, -1, FALSE, '`BP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BP->Sortable = TRUE; // Allow sort
		$this->fields['BP'] = &$this->BP;

		// CNS
		$this->CNS = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_CNS', 'CNS', '`CNS`', '`CNS`', 200, -1, FALSE, '`CNS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CNS->Sortable = TRUE; // Allow sort
		$this->fields['CNS'] = &$this->CNS;

		// RS
		$this->_RS = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x__RS', 'RS', '`RS`', '`RS`', 200, -1, FALSE, '`RS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_RS->Sortable = TRUE; // Allow sort
		$this->fields['RS'] = &$this->_RS;

		// CVS
		$this->CVS = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_CVS', 'CVS', '`CVS`', '`CVS`', 200, -1, FALSE, '`CVS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CVS->Sortable = TRUE; // Allow sort
		$this->fields['CVS'] = &$this->CVS;

		// PA
		$this->PA = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_PA', 'PA', '`PA`', '`PA`', 200, -1, FALSE, '`PA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PA->Sortable = TRUE; // Allow sort
		$this->fields['PA'] = &$this->PA;

		// InvestigationReport
		$this->InvestigationReport = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_InvestigationReport', 'InvestigationReport', '`InvestigationReport`', '`InvestigationReport`', 201, -1, FALSE, '`InvestigationReport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->InvestigationReport->Sortable = TRUE; // Allow sort
		$this->fields['InvestigationReport'] = &$this->InvestigationReport;

		// FinalDiagnosis
		$this->FinalDiagnosis = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_FinalDiagnosis', 'FinalDiagnosis', '`FinalDiagnosis`', '`FinalDiagnosis`', 201, -1, FALSE, '`FinalDiagnosis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->FinalDiagnosis->Sortable = TRUE; // Allow sort
		$this->fields['FinalDiagnosis'] = &$this->FinalDiagnosis;

		// Treatment
		$this->Treatment = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 201, -1, FALSE, '`Treatment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Treatment->Sortable = TRUE; // Allow sort
		$this->fields['Treatment'] = &$this->Treatment;

		// DetailOfOperation
		$this->DetailOfOperation = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_DetailOfOperation', 'DetailOfOperation', '`DetailOfOperation`', '`DetailOfOperation`', 201, -1, FALSE, '`DetailOfOperation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->DetailOfOperation->Sortable = TRUE; // Allow sort
		$this->fields['DetailOfOperation'] = &$this->DetailOfOperation;

		// FollowUpAdvice
		$this->FollowUpAdvice = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_FollowUpAdvice', 'FollowUpAdvice', '`FollowUpAdvice`', '`FollowUpAdvice`', 201, -1, FALSE, '`FollowUpAdvice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->FollowUpAdvice->Sortable = TRUE; // Allow sort
		$this->fields['FollowUpAdvice'] = &$this->FollowUpAdvice;

		// FollowUpMedication
		$this->FollowUpMedication = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_FollowUpMedication', 'FollowUpMedication', '`FollowUpMedication`', '`FollowUpMedication`', 201, -1, FALSE, '`FollowUpMedication`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->FollowUpMedication->Sortable = TRUE; // Allow sort
		$this->fields['FollowUpMedication'] = &$this->FollowUpMedication;

		// Plan
		$this->Plan = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_Plan', 'Plan', '`Plan`', '`Plan`', 201, -1, FALSE, '`Plan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Plan->Sortable = TRUE; // Allow sort
		$this->fields['Plan'] = &$this->Plan;

		// TempleteFinalDiagnosis
		$this->TempleteFinalDiagnosis = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TempleteFinalDiagnosis', 'TempleteFinalDiagnosis', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TemplateTreatment
		$this->TemplateTreatment = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TemplateTreatment', 'TemplateTreatment', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TemplateOperation
		$this->TemplateOperation = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TemplateOperation', 'TemplateOperation', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateFollowUpAdvice = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TemplateFollowUpAdvice', 'TemplateFollowUpAdvice', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateFollowUpMedication = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TemplateFollowUpMedication', 'TemplateFollowUpMedication', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TemplatePlan
		$this->TemplatePlan = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TemplatePlan', 'TemplatePlan', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// QRCode
		$this->QRCode = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_QRCode', 'QRCode', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->QRCode->IsCustom = TRUE; // Custom field
		$this->QRCode->Sortable = TRUE; // Allow sort
		$this->fields['QRCode'] = &$this->QRCode;

		// TidNo
		$this->TidNo = new DbField('ivf_otherprocedure', 'ivf_otherprocedure', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_otherprocedureview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
