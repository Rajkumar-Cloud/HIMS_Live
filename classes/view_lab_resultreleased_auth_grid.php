 ...
 * Page class
 */
class view_lab_resultreleased_auth_grid extends view_lab_resultreleased_auth
{
	...
	// Page object name
	public $PageObjName = "view_lab_resultreleased_auth_grid";

	// Grid form hidden field names
	public $FormName = "fview_lab_resultreleased_authgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "view_lab_services_auth") {
			...
			if ($GLOBALS["view_lab_services_auth"]->EventCancelled)
