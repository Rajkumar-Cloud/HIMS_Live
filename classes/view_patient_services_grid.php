 ...
 * Page class
 */
class view_patient_services_grid extends view_patient_services
{
	...
	// Page object name
	public $PageObjName = "view_patient_services_grid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "view_billing_voucher") {
			...
			if ($GLOBALS["view_billing_voucher"]->EventCancelled)
				$this->EventCancelled = TRUE;
		}
		if ($masterTblVar == "view_billing_voucher_print") {
			$this->Vid->Visible = FALSE;
			if ($GLOBALS["view_billing_voucher_print"]->EventCancelled)
				$this->EventCancelled = TRUE;
		}
