 ...
 * Page class
 */
class qaqcrecord_endrology_delete extends qaqcrecord_endrology
{
	...
	// Page object name
	public $PageObjName = "qaqcrecord_endrology_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("qaqcrecord_endrologylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("qaqcrecord_endrologylist.php"); // Return to list
			}
		}
	}
