 ...
 * Page class
 */
class room_master_delete extends room_master
{
	...
	// Page object name
	public $PageObjName = "room_master_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("room_masterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("room_masterlist.php"); // Return to list
			}
		}
	}
