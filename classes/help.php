...
class help extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('help', 'help', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Tittle
		$this->Tittle = new DbField('help', 'help', 'x_Tittle', 'Tittle', '`Tittle`', '`Tittle`', 200, -1, FALSE, '`Tittle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Description
		$this->Description = new DbField('help', 'help', 'x_Description', 'Description', '`Description`', '`Description`', 201, -1, FALSE, '`Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// orderid
		$this->orderid = new DbField('help', 'help', 'x_orderid', 'orderid', '`orderid`', '`orderid`', 3, -1, FALSE, '`orderid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("helpview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
