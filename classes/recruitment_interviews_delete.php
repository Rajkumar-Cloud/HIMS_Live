 ...
 * Page class
 */
class recruitment_interviews_delete extends recruitment_interviews
{
	...
	// Page object name
	public $PageObjName = "recruitment_interviews_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("recruitment_interviewslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("recruitment_interviewslist.php"); // Return to list
			}
		}
	}
