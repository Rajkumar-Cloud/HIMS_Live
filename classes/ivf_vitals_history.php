...
class ivf_vitals_history extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNO
		$this->RIDNO = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNO->Sortable = TRUE; // Allow sort
		$this->RIDNO->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNO'] = &$this->RIDNO;

		// Name
		$this->Name = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// Age
		$this->Age = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// SEX
		$this->SEX = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_SEX', 'SEX', '`SEX`', '`SEX`', 200, -1, FALSE, '`SEX`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SEX->Sortable = TRUE; // Allow sort
		$this->fields['SEX'] = &$this->SEX;

		// Religion
		$this->Religion = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Religion', 'Religion', '`Religion`', '`Religion`', 200, -1, FALSE, '`Religion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Religion->Sortable = TRUE; // Allow sort
		$this->fields['Religion'] = &$this->Religion;

		// Address
		$this->Address = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Address', 'Address', '`Address`', '`Address`', 200, -1, FALSE, '`Address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address->Sortable = TRUE; // Allow sort
		$this->fields['Address'] = &$this->Address;

		// IdentificationMark
		$this->IdentificationMark = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_IdentificationMark', 'IdentificationMark', '`IdentificationMark`', '`IdentificationMark`', 200, -1, FALSE, '`IdentificationMark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IdentificationMark->Sortable = TRUE; // Allow sort
		$this->fields['IdentificationMark'] = &$this->IdentificationMark;

		// DoublewitnessName1
		$this->DoublewitnessName1 = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_DoublewitnessName1', 'DoublewitnessName1', '`DoublewitnessName1`', '`DoublewitnessName1`', 201, -1, FALSE, '`DoublewitnessName1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->DoublewitnessName1->Sortable = TRUE; // Allow sort
		$this->fields['DoublewitnessName1'] = &$this->DoublewitnessName1;

		// DoublewitnessName2
		$this->DoublewitnessName2 = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_DoublewitnessName2', 'DoublewitnessName2', '`DoublewitnessName2`', '`DoublewitnessName2`', 201, -1, FALSE, '`DoublewitnessName2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->DoublewitnessName2->Sortable = TRUE; // Allow sort
		$this->fields['DoublewitnessName2'] = &$this->DoublewitnessName2;

		// Chiefcomplaints
		$this->Chiefcomplaints = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Chiefcomplaints', 'Chiefcomplaints', '`Chiefcomplaints`', '`Chiefcomplaints`', 201, -1, FALSE, '`Chiefcomplaints`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Chiefcomplaints->Sortable = TRUE; // Allow sort
		$this->fields['Chiefcomplaints'] = &$this->Chiefcomplaints;

		// MenstrualHistory
		$this->MenstrualHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MenstrualHistory', 'MenstrualHistory', '`MenstrualHistory`', '`MenstrualHistory`', 201, -1, FALSE, '`MenstrualHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MenstrualHistory->Sortable = TRUE; // Allow sort
		$this->fields['MenstrualHistory'] = &$this->MenstrualHistory;

		// ObstetricHistory
		$this->ObstetricHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_ObstetricHistory', 'ObstetricHistory', '`ObstetricHistory`', '`ObstetricHistory`', 201, -1, FALSE, '`ObstetricHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ObstetricHistory->Sortable = TRUE; // Allow sort
		$this->fields['ObstetricHistory'] = &$this->ObstetricHistory;

		// MedicalHistory
		$this->MedicalHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MedicalHistory', 'MedicalHistory', '`MedicalHistory`', '`MedicalHistory`', 200, -1, FALSE, '`MedicalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// SurgicalHistory
		$this->SurgicalHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_SurgicalHistory', 'SurgicalHistory', '`SurgicalHistory`', '`SurgicalHistory`', 200, -1, FALSE, '`SurgicalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SurgicalHistory->Sortable = TRUE; // Allow sort
		$this->fields['SurgicalHistory'] = &$this->SurgicalHistory;

		// Generalexaminationpallor
		$this->Generalexaminationpallor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Generalexaminationpallor', 'Generalexaminationpallor', '`Generalexaminationpallor`', '`Generalexaminationpallor`', 200, -1, FALSE, '`Generalexaminationpallor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Generalexaminationpallor->Sortable = TRUE; // Allow sort
		$this->fields['Generalexaminationpallor'] = &$this->Generalexaminationpallor;

		// PR
		$this->PR = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PR', 'PR', '`PR`', '`PR`', 200, -1, FALSE, '`PR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PR->Sortable = TRUE; // Allow sort
		$this->fields['PR'] = &$this->PR;

		// CVS
		$this->CVS = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_CVS', 'CVS', '`CVS`', '`CVS`', 200, -1, FALSE, '`CVS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CVS->Sortable = TRUE; // Allow sort
		$this->fields['CVS'] = &$this->CVS;

		// PA
		$this->PA = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PA', 'PA', '`PA`', '`PA`', 200, -1, FALSE, '`PA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PA->Sortable = TRUE; // Allow sort
		$this->fields['PA'] = &$this->PA;

		// PROVISIONALDIAGNOSIS
		$this->PROVISIONALDIAGNOSIS = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PROVISIONALDIAGNOSIS', 'PROVISIONALDIAGNOSIS', '`PROVISIONALDIAGNOSIS`', '`PROVISIONALDIAGNOSIS`', 200, -1, FALSE, '`PROVISIONALDIAGNOSIS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PROVISIONALDIAGNOSIS->Sortable = TRUE; // Allow sort
		$this->fields['PROVISIONALDIAGNOSIS'] = &$this->PROVISIONALDIAGNOSIS;

		// Investigations
		$this->Investigations = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Investigations', 'Investigations', '`Investigations`', '`Investigations`', 200, -1, FALSE, '`Investigations`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Investigations->Sortable = TRUE; // Allow sort
		$this->fields['Investigations'] = &$this->Investigations;

		// Fheight
		$this->Fheight = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Fheight', 'Fheight', '`Fheight`', '`Fheight`', 200, -1, FALSE, '`Fheight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fheight->Sortable = TRUE; // Allow sort
		$this->fields['Fheight'] = &$this->Fheight;

		// Fweight
		$this->Fweight = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Fweight', 'Fweight', '`Fweight`', '`Fweight`', 200, -1, FALSE, '`Fweight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fweight->Sortable = TRUE; // Allow sort
		$this->fields['Fweight'] = &$this->Fweight;

		// FBMI
		$this->FBMI = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FBMI', 'FBMI', '`FBMI`', '`FBMI`', 200, -1, FALSE, '`FBMI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FBMI->Sortable = TRUE; // Allow sort
		$this->fields['FBMI'] = &$this->FBMI;

		// FBloodgroup
		$this->FBloodgroup = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FBloodgroup', 'FBloodgroup', '`FBloodgroup`', '`FBloodgroup`', 200, -1, FALSE, '`FBloodgroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Mheight
		$this->Mheight = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Mheight', 'Mheight', '`Mheight`', '`Mheight`', 200, -1, FALSE, '`Mheight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mheight->Sortable = TRUE; // Allow sort
		$this->fields['Mheight'] = &$this->Mheight;

		// Mweight
		$this->Mweight = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Mweight', 'Mweight', '`Mweight`', '`Mweight`', 200, -1, FALSE, '`Mweight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mweight->Sortable = TRUE; // Allow sort
		$this->fields['Mweight'] = &$this->Mweight;

		// MBMI
		$this->MBMI = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MBMI', 'MBMI', '`MBMI`', '`MBMI`', 200, -1, FALSE, '`MBMI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MBMI->Sortable = TRUE; // Allow sort
		$this->fields['MBMI'] = &$this->MBMI;

		// MBloodgroup
		$this->MBloodgroup = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MBloodgroup', 'MBloodgroup', '`MBloodgroup`', '`MBloodgroup`', 200, -1, FALSE, '`MBloodgroup`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// FBuild
		$this->FBuild = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FBuild', 'FBuild', '`FBuild`', '`FBuild`', 200, -1, FALSE, '`FBuild`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// MBuild
		$this->MBuild = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MBuild', 'MBuild', '`MBuild`', '`MBuild`', 200, -1, FALSE, '`MBuild`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// FSkinColor
		$this->FSkinColor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FSkinColor', 'FSkinColor', '`FSkinColor`', '`FSkinColor`', 200, -1, FALSE, '`FSkinColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// MSkinColor
		$this->MSkinColor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MSkinColor', 'MSkinColor', '`MSkinColor`', '`MSkinColor`', 200, -1, FALSE, '`MSkinColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// FEyesColor
		$this->FEyesColor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FEyesColor', 'FEyesColor', '`FEyesColor`', '`FEyesColor`', 200, -1, FALSE, '`FEyesColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// MEyesColor
		$this->MEyesColor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MEyesColor', 'MEyesColor', '`MEyesColor`', '`MEyesColor`', 200, -1, FALSE, '`MEyesColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// FHairColor
		$this->FHairColor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FHairColor', 'FHairColor', '`FHairColor`', '`FHairColor`', 200, -1, FALSE, '`FHairColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// MhairColor
		$this->MhairColor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MhairColor', 'MhairColor', '`MhairColor`', '`MhairColor`', 200, -1, FALSE, '`MhairColor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// FhairTexture
		$this->FhairTexture = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FhairTexture', 'FhairTexture', '`FhairTexture`', '`FhairTexture`', 200, -1, FALSE, '`FhairTexture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// MHairTexture
		$this->MHairTexture = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MHairTexture', 'MHairTexture', '`MHairTexture`', '`MHairTexture`', 200, -1, FALSE, '`MHairTexture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// Fothers
		$this->Fothers = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Fothers', 'Fothers', '`Fothers`', '`Fothers`', 200, -1, FALSE, '`Fothers`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fothers->Sortable = TRUE; // Allow sort
		$this->fields['Fothers'] = &$this->Fothers;

		// Mothers
		$this->Mothers = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Mothers', 'Mothers', '`Mothers`', '`Mothers`', 200, -1, FALSE, '`Mothers`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mothers->Sortable = TRUE; // Allow sort
		$this->fields['Mothers'] = &$this->Mothers;

		// PGE
		$this->PGE = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PGE', 'PGE', '`PGE`', '`PGE`', 200, -1, FALSE, '`PGE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PGE->Sortable = TRUE; // Allow sort
		$this->fields['PGE'] = &$this->PGE;

		// PPR
		$this->PPR = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PPR', 'PPR', '`PPR`', '`PPR`', 200, -1, FALSE, '`PPR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PPR->Sortable = TRUE; // Allow sort
		$this->fields['PPR'] = &$this->PPR;

		// PBP
		$this->PBP = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PBP', 'PBP', '`PBP`', '`PBP`', 200, -1, FALSE, '`PBP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PBP->Sortable = TRUE; // Allow sort
		$this->fields['PBP'] = &$this->PBP;

		// Breast
		$this->Breast = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Breast', 'Breast', '`Breast`', '`Breast`', 200, -1, FALSE, '`Breast`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Breast->Sortable = TRUE; // Allow sort
		$this->fields['Breast'] = &$this->Breast;

		// PPA
		$this->PPA = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PPA', 'PPA', '`PPA`', '`PPA`', 200, -1, FALSE, '`PPA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PPA->Sortable = TRUE; // Allow sort
		$this->fields['PPA'] = &$this->PPA;

		// PPSV
		$this->PPSV = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PPSV', 'PPSV', '`PPSV`', '`PPSV`', 200, -1, FALSE, '`PPSV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PPSV->Sortable = TRUE; // Allow sort
		$this->fields['PPSV'] = &$this->PPSV;

		// PPAPSMEAR
		$this->PPAPSMEAR = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PPAPSMEAR', 'PPAPSMEAR', '`PPAPSMEAR`', '`PPAPSMEAR`', 200, -1, FALSE, '`PPAPSMEAR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PPAPSMEAR->Sortable = TRUE; // Allow sort
		$this->fields['PPAPSMEAR'] = &$this->PPAPSMEAR;

		// PTHYROID
		$this->PTHYROID = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PTHYROID', 'PTHYROID', '`PTHYROID`', '`PTHYROID`', 200, -1, FALSE, '`PTHYROID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PTHYROID->Sortable = TRUE; // Allow sort
		$this->fields['PTHYROID'] = &$this->PTHYROID;

		// MTHYROID
		$this->MTHYROID = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MTHYROID', 'MTHYROID', '`MTHYROID`', '`MTHYROID`', 200, -1, FALSE, '`MTHYROID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MTHYROID->Sortable = TRUE; // Allow sort
		$this->fields['MTHYROID'] = &$this->MTHYROID;

		// SecSexCharacters
		$this->SecSexCharacters = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_SecSexCharacters', 'SecSexCharacters', '`SecSexCharacters`', '`SecSexCharacters`', 200, -1, FALSE, '`SecSexCharacters`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SecSexCharacters->Sortable = TRUE; // Allow sort
		$this->fields['SecSexCharacters'] = &$this->SecSexCharacters;

		// PenisUM
		$this->PenisUM = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PenisUM', 'PenisUM', '`PenisUM`', '`PenisUM`', 200, -1, FALSE, '`PenisUM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PenisUM->Sortable = TRUE; // Allow sort
		$this->fields['PenisUM'] = &$this->PenisUM;

		// VAS
		$this->VAS = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_VAS', 'VAS', '`VAS`', '`VAS`', 200, -1, FALSE, '`VAS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VAS->Sortable = TRUE; // Allow sort
		$this->fields['VAS'] = &$this->VAS;

		// EPIDIDYMIS
		$this->EPIDIDYMIS = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_EPIDIDYMIS', 'EPIDIDYMIS', '`EPIDIDYMIS`', '`EPIDIDYMIS`', 200, -1, FALSE, '`EPIDIDYMIS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EPIDIDYMIS->Sortable = TRUE; // Allow sort
		$this->fields['EPIDIDYMIS'] = &$this->EPIDIDYMIS;

		// Varicocele
		$this->Varicocele = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Varicocele', 'Varicocele', '`Varicocele`', '`Varicocele`', 200, -1, FALSE, '`Varicocele`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Varicocele->Sortable = TRUE; // Allow sort
		$this->fields['Varicocele'] = &$this->Varicocele;

		// FertilityTreatmentHistory
		$this->FertilityTreatmentHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FertilityTreatmentHistory', 'FertilityTreatmentHistory', '`FertilityTreatmentHistory`', '`FertilityTreatmentHistory`', 201, -1, FALSE, '`FertilityTreatmentHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// SurgeryHistory
		$this->SurgeryHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_SurgeryHistory', 'SurgeryHistory', '`SurgeryHistory`', '`SurgeryHistory`', 201, -1, FALSE, '`SurgeryHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->SurgeryHistory->Sortable = TRUE; // Allow sort
		$this->fields['SurgeryHistory'] = &$this->SurgeryHistory;

		// FamilyHistory
		$this->FamilyHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_FamilyHistory', 'FamilyHistory', '`FamilyHistory`', '`FamilyHistory`', 200, -1, FALSE, '`FamilyHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PInvestigations
		$this->PInvestigations = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PInvestigations', 'PInvestigations', '`PInvestigations`', '`PInvestigations`', 201, -1, FALSE, '`PInvestigations`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PInvestigations->Sortable = TRUE; // Allow sort
		$this->fields['PInvestigations'] = &$this->PInvestigations;

		// Addictions
		$this->Addictions = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Addictions', 'Addictions', '`Addictions`', '`Addictions`', 200, -1, FALSE, '`Addictions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Medications
		$this->Medications = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Medications', 'Medications', '`Medications`', '`Medications`', 201, -1, FALSE, '`Medications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Medications->Sortable = TRUE; // Allow sort
		$this->fields['Medications'] = &$this->Medications;

		// Medical
		$this->Medical = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Medical', 'Medical', '`Medical`', '`Medical`', 200, -1, FALSE, '`Medical`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Surgical
		$this->Surgical = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_Surgical', 'Surgical', '`Surgical`', '`Surgical`', 200, -1, FALSE, '`EV__Surgical`', TRUE, FALSE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// CoitalHistory
		$this->CoitalHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_CoitalHistory', 'CoitalHistory', '`CoitalHistory`', '`CoitalHistory`', 200, -1, FALSE, '`CoitalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SemenAnalysis
		$this->SemenAnalysis = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_SemenAnalysis', 'SemenAnalysis', '`SemenAnalysis`', '`SemenAnalysis`', 201, -1, FALSE, '`SemenAnalysis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->SemenAnalysis->Sortable = TRUE; // Allow sort
		$this->fields['SemenAnalysis'] = &$this->SemenAnalysis;

		// MInsvestications
		$this->MInsvestications = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MInsvestications', 'MInsvestications', '`MInsvestications`', '`MInsvestications`', 201, -1, FALSE, '`MInsvestications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MInsvestications->Sortable = TRUE; // Allow sort
		$this->fields['MInsvestications'] = &$this->MInsvestications;

		// PImpression
		$this->PImpression = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PImpression', 'PImpression', '`PImpression`', '`PImpression`', 201, -1, FALSE, '`PImpression`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PImpression->Sortable = TRUE; // Allow sort
		$this->fields['PImpression'] = &$this->PImpression;

		// MIMpression
		$this->MIMpression = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MIMpression', 'MIMpression', '`MIMpression`', '`MIMpression`', 201, -1, FALSE, '`MIMpression`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MIMpression->Sortable = TRUE; // Allow sort
		$this->fields['MIMpression'] = &$this->MIMpression;

		// PPlanOfManagement
		$this->PPlanOfManagement = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PPlanOfManagement', 'PPlanOfManagement', '`PPlanOfManagement`', '`PPlanOfManagement`', 201, -1, FALSE, '`PPlanOfManagement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PPlanOfManagement->Sortable = TRUE; // Allow sort
		$this->fields['PPlanOfManagement'] = &$this->PPlanOfManagement;

		// MPlanOfManagement
		$this->MPlanOfManagement = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MPlanOfManagement', 'MPlanOfManagement', '`MPlanOfManagement`', '`MPlanOfManagement`', 201, -1, FALSE, '`MPlanOfManagement`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MPlanOfManagement->Sortable = TRUE; // Allow sort
		$this->fields['MPlanOfManagement'] = &$this->MPlanOfManagement;

		// PReadMore
		$this->PReadMore = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_PReadMore', 'PReadMore', '`PReadMore`', '`PReadMore`', 201, -1, FALSE, '`PReadMore`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->PReadMore->Sortable = TRUE; // Allow sort
		$this->fields['PReadMore'] = &$this->PReadMore;

		// MReadMore
		$this->MReadMore = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MReadMore', 'MReadMore', '`MReadMore`', '`MReadMore`', 201, -1, FALSE, '`MReadMore`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->MReadMore->Sortable = TRUE; // Allow sort
		$this->fields['MReadMore'] = &$this->MReadMore;

		// MariedFor
		$this->MariedFor = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MariedFor', 'MariedFor', '`MariedFor`', '`MariedFor`', 200, -1, FALSE, '`MariedFor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MariedFor->Sortable = TRUE; // Allow sort
		$this->fields['MariedFor'] = &$this->MariedFor;

		// CMNCM
		$this->CMNCM = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_CMNCM', 'CMNCM', '`CMNCM`', '`CMNCM`', 200, -1, FALSE, '`CMNCM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CMNCM->Sortable = TRUE; // Allow sort
		$this->fields['CMNCM'] = &$this->CMNCM;

		// TemplateMenstrualHistory
		$this->TemplateMenstrualHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateMenstrualHistory', 'TemplateMenstrualHistory', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateObstetricHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateObstetricHistory', 'TemplateObstetricHistory', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateFertilityTreatmentHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateFertilityTreatmentHistory', 'TemplateFertilityTreatmentHistory', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateSurgeryHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateSurgeryHistory', 'TemplateSurgeryHistory', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateFInvestigations = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateFInvestigations', 'TemplateFInvestigations', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplatePlanOfManagement = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplatePlanOfManagement', 'TemplatePlanOfManagement', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TemplatePImpression
		$this->TemplatePImpression = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplatePImpression', 'TemplatePImpression', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TemplateMedications
		$this->TemplateMedications = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateMedications', 'TemplateMedications', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateSemenAnalysis = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateSemenAnalysis', 'TemplateSemenAnalysis', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// MaleInsvestications
		$this->MaleInsvestications = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_MaleInsvestications', 'MaleInsvestications', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TemplateMIMpression
		$this->TemplateMIMpression = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateMIMpression', 'TemplateMIMpression', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateMalePlanOfManagement = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TemplateMalePlanOfManagement', 'TemplateMalePlanOfManagement', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TidNo
		$this->TidNo = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pFamilyHistory
		$this->pFamilyHistory = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_pFamilyHistory', 'pFamilyHistory', '`pFamilyHistory`', '`pFamilyHistory`', 200, -1, FALSE, '`pFamilyHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->pTemplateMedications = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_pTemplateMedications', 'pTemplateMedications', '`pTemplateMedications`', '`pTemplateMedications`', 201, -1, FALSE, '`pTemplateMedications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->pTemplateMedications->Sortable = TRUE; // Allow sort
		$this->fields['pTemplateMedications'] = &$this->pTemplateMedications;

		// AntiTPO
		$this->AntiTPO = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_AntiTPO', 'AntiTPO', '`AntiTPO`', '`AntiTPO`', 200, -1, FALSE, '`AntiTPO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AntiTPO->Sortable = TRUE; // Allow sort
		$this->fields['AntiTPO'] = &$this->AntiTPO;

		// AntiTG
		$this->AntiTG = new DbField('ivf_vitals_history', 'ivf_vitals_history', 'x_AntiTG', 'AntiTG', '`AntiTG`', '`AntiTG`', 200, -1, FALSE, '`AntiTG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_vitals_historyview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
