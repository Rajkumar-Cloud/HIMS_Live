...
class reception extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('reception', 'reception', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PatientID
		$this->PatientID = new DbField('reception', 'reception', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// PatientName
		$this->PatientName = new DbField('reception', 'reception', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// OorN
		$this->OorN = new DbField('reception', 'reception', 'x_OorN', 'OorN', '`OorN`', '`OorN`', 200, -1, FALSE, '`OorN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OorN->Sortable = TRUE; // Allow sort
		$this->fields['OorN'] = &$this->OorN;

		// PRIMARY_CONSULTANT
		$this->PRIMARY_CONSULTANT = new DbField('reception', 'reception', 'x_PRIMARY_CONSULTANT', 'PRIMARY_CONSULTANT', '`PRIMARY_CONSULTANT`', '`PRIMARY_CONSULTANT`', 200, -1, FALSE, '`PRIMARY_CONSULTANT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRIMARY_CONSULTANT->Sortable = TRUE; // Allow sort
		$this->fields['PRIMARY_CONSULTANT'] = &$this->PRIMARY_CONSULTANT;

		// CATEGORY
		$this->CATEGORY = new DbField('reception', 'reception', 'x_CATEGORY', 'CATEGORY', '`CATEGORY`', '`CATEGORY`', 200, -1, FALSE, '`CATEGORY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PROCEDURE
		$this->PROCEDURE = new DbField('reception', 'reception', 'x_PROCEDURE', 'PROCEDURE', '`PROCEDURE`', '`PROCEDURE`', 200, -1, FALSE, '`PROCEDURE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Amount
		$this->Amount = new DbField('reception', 'reception', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 200, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->fields['Amount'] = &$this->Amount;

		// MODE OF PAYMENT
		$this->MODE_OF_PAYMENT = new DbField('reception', 'reception', 'x_MODE_OF_PAYMENT', 'MODE OF PAYMENT', '`MODE OF PAYMENT`', '`MODE OF PAYMENT`', 200, -1, FALSE, '`MODE OF PAYMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NEXT REVIEW DATE
		$this->NEXT_REVIEW_DATE = new DbField('reception', 'reception', 'x_NEXT_REVIEW_DATE', 'NEXT REVIEW DATE', '`NEXT REVIEW DATE`', CastDateFieldForLike('`NEXT REVIEW DATE`', 0, "DB"), 133, 0, FALSE, '`NEXT REVIEW DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// REMARKS
		$this->REMARKS = new DbField('reception', 'reception', 'x_REMARKS', 'REMARKS', '`REMARKS`', '`REMARKS`', 200, -1, FALSE, '`REMARKS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("receptionview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
