 ...
 * Page class
 */
class recruitment_candidates_edit extends recruitment_candidates
{
	...
	// Page object name
	public $PageObjName = "recruitment_candidates_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// cv_title
			$this->cv_title->setDbValueDef($rsnew, $this->cv_title->CurrentValue, "", $this->cv_title->ReadOnly);

			// cv
			$this->cv->setDbValueDef($rsnew, $this->cv->CurrentValue, NULL, $this->cv->ReadOnly);

			// cvtext
			$this->cvtext->setDbValueDef($rsnew, $this->cvtext->CurrentValue, NULL, $this->cvtext->ReadOnly);

			// industry
			$this->industry->setDbValueDef($rsnew, $this->industry->CurrentValue, NULL, $this->industry->ReadOnly);

			// profileImage
			$this->profileImage->setDbValueDef($rsnew, $this->profileImage->CurrentValue, NULL, $this->profileImage->ReadOnly);

			// head_line
			$this->head_line->setDbValueDef($rsnew, $this->head_line->CurrentValue, NULL, $this->head_line->ReadOnly);

			// objective
			$this->objective->setDbValueDef($rsnew, $this->objective->CurrentValue, NULL, $this->objective->ReadOnly);

			// work_history
			$this->work_history->setDbValueDef($rsnew, $this->work_history->CurrentValue, NULL, $this->work_history->ReadOnly);

			// education
			$this->education->setDbValueDef($rsnew, $this->education->CurrentValue, NULL, $this->education->ReadOnly);

			// skills
			$this->skills->setDbValueDef($rsnew, $this->skills->CurrentValue, NULL, $this->skills->ReadOnly);

			// referees
			$this->referees->setDbValueDef($rsnew, $this->referees->CurrentValue, NULL, $this->referees->ReadOnly);

			// linkedInUrl
			$this->linkedInUrl->setDbValueDef($rsnew, $this->linkedInUrl->CurrentValue, NULL, $this->linkedInUrl->ReadOnly);

			// linkedInData
			$this->linkedInData->setDbValueDef($rsnew, $this->linkedInData->CurrentValue, NULL, $this->linkedInData->ReadOnly);

			// totalYearsOfExperience
			$this->totalYearsOfExperience->setDbValueDef($rsnew, $this->totalYearsOfExperience->CurrentValue, NULL, $this->totalYearsOfExperience->ReadOnly);

			// totalMonthsOfExperience
			$this->totalMonthsOfExperience->setDbValueDef($rsnew, $this->totalMonthsOfExperience->CurrentValue, NULL, $this->totalMonthsOfExperience->ReadOnly);

			// htmlCVData
			$this->htmlCVData->setDbValueDef($rsnew, $this->htmlCVData->CurrentValue, NULL, $this->htmlCVData->ReadOnly);

			// generatedCVFile
			$this->generatedCVFile->setDbValueDef($rsnew, $this->generatedCVFile->CurrentValue, NULL, $this->generatedCVFile->ReadOnly);
			...
			// expectedSalary
			$this->expectedSalary->setDbValueDef($rsnew, $this->expectedSalary->CurrentValue, NULL, $this->expectedSalary->ReadOnly);

			// preferedPositions
			$this->preferedPositions->setDbValueDef($rsnew, $this->preferedPositions->CurrentValue, NULL, $this->preferedPositions->ReadOnly);

			// preferedJobtype
			$this->preferedJobtype->setDbValueDef($rsnew, $this->preferedJobtype->CurrentValue, NULL, $this->preferedJobtype->ReadOnly);

			// preferedCountries
			$this->preferedCountries->setDbValueDef($rsnew, $this->preferedCountries->CurrentValue, NULL, $this->preferedCountries->ReadOnly);
			...
			// calls
			$this->calls->setDbValueDef($rsnew, $this->calls->CurrentValue, NULL, $this->calls->ReadOnly);
			...
			// linkedInProfileLink
			$this->linkedInProfileLink->setDbValueDef($rsnew, $this->linkedInProfileLink->CurrentValue, NULL, $this->linkedInProfileLink->ReadOnly);

			// linkedInProfileId
			$this->linkedInProfileId->setDbValueDef($rsnew, $this->linkedInProfileId->CurrentValue, NULL, $this->linkedInProfileId->ReadOnly);

			// facebookProfileLink
			$this->facebookProfileLink->setDbValueDef($rsnew, $this->facebookProfileLink->CurrentValue, NULL, $this->facebookProfileLink->ReadOnly);

			// facebookProfileId
			$this->facebookProfileId->setDbValueDef($rsnew, $this->facebookProfileId->CurrentValue, NULL, $this->facebookProfileId->ReadOnly);

			// twitterProfileLink
			$this->twitterProfileLink->setDbValueDef($rsnew, $this->twitterProfileLink->CurrentValue, NULL, $this->twitterProfileLink->ReadOnly);

			// twitterProfileId
			$this->twitterProfileId->setDbValueDef($rsnew, $this->twitterProfileId->CurrentValue, NULL, $this->twitterProfileId->ReadOnly);

			// googleProfileLink
			$this->googleProfileLink->setDbValueDef($rsnew, $this->googleProfileLink->CurrentValue, NULL, $this->googleProfileLink->ReadOnly);

			// googleProfileId
			$this->googleProfileId->setDbValueDef($rsnew, $this->googleProfileId->CurrentValue, NULL, $this->googleProfileId->ReadOnly);
