 ...
 * Page class
 */
class mas_user_template_edit extends mas_user_template
{
	...
	// Page object name
	public $PageObjName = "mas_user_template_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("mas_user_templatelist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "mas_user_templatelist.php")
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Template
			$this->Template->setDbValueDef($rsnew, $this->Template->CurrentValue, NULL, $this->Template->ReadOnly);
