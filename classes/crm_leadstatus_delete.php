 ...
 * Page class
 */
class crm_leadstatus_delete extends crm_leadstatus
{
	...
	// Page object name
	public $PageObjName = "crm_leadstatus_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("crm_leadstatuslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("crm_leadstatuslist.php"); // Return to list
			}
		}
	}
