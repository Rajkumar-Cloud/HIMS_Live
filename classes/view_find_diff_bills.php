...
class view_find_diff_bills extends DbTable
{
	...
	public function __construct()
	{
		...
		// PatientId
		$this->PatientId = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// PatientName
		$this->PatientName = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// BillNumber
		$this->BillNumber = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, -1, FALSE, '`BillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillNumber->Sortable = TRUE; // Allow sort
		$this->fields['BillNumber'] = &$this->BillNumber;

		// Amount
		$this->Amount = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->Amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Amount'] = &$this->Amount;

		// sum(b.amount)
		$this->sum28b_amount29 = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_sum28b_amount29', 'sum(b.amount)', '`sum(b.amount)`', '`sum(b.amount)`', 131, -1, FALSE, '`sum(b.amount)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// diff
		$this->diff = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_diff', 'diff', '`diff`', '`diff`', 131, -1, FALSE, '`diff`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->diff->Sortable = TRUE; // Allow sort
		$this->diff->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['diff'] = &$this->diff;

		// HospID
		$this->HospID = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// createddatetime
		$this->createddatetime = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// createdby
		$this->createdby = new DbField('view_find_diff_bills', 'view_find_diff_bills', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_find_diff_billsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
