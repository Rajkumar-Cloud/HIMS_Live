 ...
 * Page class
 */
class patient_room_delete extends patient_room
{
	...
	// Page object name
	public $PageObjName = "patient_room_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_roomlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_roomlist.php"); // Return to list
			}
		}
	}
