 ...
 * Page class
 */
class lab_sub_test_master_grid extends lab_sub_test_master
{
	...
	// Page object name
	public $PageObjName = "lab_sub_test_master_grid";

	// Grid form hidden field names
	public $FormName = "flab_sub_test_mastergrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "lab_test_master") {
			$this->TestMasterID->Visible = FALSE;
			if ($GLOBALS["lab_test_master"]->EventCancelled)
