 ...
 * Page class
 */
class banktransferto_edit extends banktransferto
{
	...
	// Page object name
	public $PageObjName = "banktransferto_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("banktransfertolist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "banktransfertolist.php")
	...
	protected function loadFormValues()
	{
		...
		if (!$this->Street_Address->IsDetailKey) {
			if (IsApi() && $val == NULL)
				$this->Street_Address->Visible = FALSE; // Disable update for API request
			else
				$this->Street_Address->setFormValue($val);
		}
	...
	public function restoreFormValues()
	{
		...
		$this->Street_Address->CurrentValue = $this->Street_Address->FormValue;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Street_Address
			$this->Street_Address->setDbValueDef($rsnew, $this->Street_Address->CurrentValue, "", $this->Street_Address->ReadOnly);
			...
			// AccountNo
			$this->AccountNo->setDbValueDef($rsnew, $this->AccountNo->CurrentValue, "", $this->AccountNo->ReadOnly);
