...
class patient_follow_up_edit extends patient_follow_up
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// DischargeAdviceMedicine
			$this->DischargeAdviceMedicine->setDbValueDef($rsnew, $this->DischargeAdviceMedicine->CurrentValue, NULL, $this->DischargeAdviceMedicine->ReadOnly);

			// DischargeAdviceMedicineTemplate
			$this->DischargeAdviceMedicineTemplate->setDbValueDef($rsnew, $this->DischargeAdviceMedicineTemplate->CurrentValue, "", $this->DischargeAdviceMedicineTemplate->ReadOnly);
