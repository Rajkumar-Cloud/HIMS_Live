 ...
 */
class employee_projects extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_projects', 'employee_projects', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee
		$this->employee = new DbField('employee_projects', 'employee_projects', 'x_employee', 'employee', '`employee`', '`employee`', 3, -1, FALSE, '`employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// project
		$this->project = new DbField('employee_projects', 'employee_projects', 'x_project', 'project', '`project`', '`project`', 20, -1, FALSE, '`project`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date_start
		$this->date_start = new DbField('employee_projects', 'employee_projects', 'x_date_start', 'date_start', '`date_start`', CastDateFieldForLike('`date_start`', 0, "DB"), 133, 0, FALSE, '`date_start`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date_end
		$this->date_end = new DbField('employee_projects', 'employee_projects', 'x_date_end', 'date_end', '`date_end`', CastDateFieldForLike('`date_end`', 0, "DB"), 133, 0, FALSE, '`date_end`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('employee_projects', 'employee_projects', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// details
		$this->details = new DbField('employee_projects', 'employee_projects', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_projectslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "employee_projectsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "employee_projectsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_projectsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_projectsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_projectsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_projectsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_projectsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_projectsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_projectsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_projectsdelete.php", $this->getUrlParm());
	}
