 ...
 * Page class
 */
class lab_testname_delete extends lab_testname
{
	...
	// Page object name
	public $PageObjName = "lab_testname_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lab_testnamelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("lab_testnamelist.php"); // Return to list
			}
		}
	}
