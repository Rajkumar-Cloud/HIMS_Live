...
class patient_prescription extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient_prescription', 'patient_prescription', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Reception
		$this->Reception = new DbField('patient_prescription', 'patient_prescription', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientId
		$this->PatientId = new DbField('patient_prescription', 'patient_prescription', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 3, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientName
		$this->PatientName = new DbField('patient_prescription', 'patient_prescription', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Medicine
		$this->Medicine = new DbField('patient_prescription', 'patient_prescription', 'x_Medicine', 'Medicine', '`Medicine`', '`Medicine`', 200, -1, FALSE, '`Medicine`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// M
		$this->M = new DbField('patient_prescription', 'patient_prescription', 'x_M', 'M', '`M`', '`M`', 200, -1, FALSE, '`M`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->M->Sortable = TRUE; // Allow sort
		$this->fields['M'] = &$this->M;

		// A
		$this->A = new DbField('patient_prescription', 'patient_prescription', 'x_A', 'A', '`A`', '`A`', 200, -1, FALSE, '`A`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A->Sortable = TRUE; // Allow sort
		$this->fields['A'] = &$this->A;

		// N
		$this->N = new DbField('patient_prescription', 'patient_prescription', 'x_N', 'N', '`N`', '`N`', 200, -1, FALSE, '`N`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->N->Sortable = TRUE; // Allow sort
		$this->fields['N'] = &$this->N;

		// NoOfDays
		$this->NoOfDays = new DbField('patient_prescription', 'patient_prescription', 'x_NoOfDays', 'NoOfDays', '`NoOfDays`', '`NoOfDays`', 200, -1, FALSE, '`NoOfDays`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoOfDays->Sortable = TRUE; // Allow sort
		$this->fields['NoOfDays'] = &$this->NoOfDays;

		// PreRoute
		$this->PreRoute = new DbField('patient_prescription', 'patient_prescription', 'x_PreRoute', 'PreRoute', '`PreRoute`', '`PreRoute`', 200, -1, FALSE, '`EV__PreRoute`', TRUE, FALSE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// TimeOfTaking
		$this->TimeOfTaking = new DbField('patient_prescription', 'patient_prescription', 'x_TimeOfTaking', 'TimeOfTaking', '`TimeOfTaking`', '`TimeOfTaking`', 200, -1, FALSE, '`EV__TimeOfTaking`', TRUE, FALSE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// Type
		$this->Type = new DbField('patient_prescription', 'patient_prescription', 'x_Type', 'Type', '`Type`', '`Type`', 200, -1, FALSE, '`Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// mrnno
		$this->mrnno = new DbField('patient_prescription', 'patient_prescription', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->IsForeignKey = TRUE; // Foreign key field
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// Age
		$this->Age = new DbField('patient_prescription', 'patient_prescription', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('patient_prescription', 'patient_prescription', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// profilePic
		$this->profilePic = new DbField('patient_prescription', 'patient_prescription', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// Status
		$this->Status = new DbField('patient_prescription', 'patient_prescription', 'x_Status', 'Status', '`Status`', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CreatedBy
		$this->CreatedBy = new DbField('patient_prescription', 'patient_prescription', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// CreateDateTime
		$this->CreateDateTime = new DbField('patient_prescription', 'patient_prescription', 'x_CreateDateTime', 'CreateDateTime', '`CreateDateTime`', '`CreateDateTime`', 200, -1, FALSE, '`CreateDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreateDateTime->Sortable = TRUE; // Allow sort
		$this->fields['CreateDateTime'] = &$this->CreateDateTime;

		// ModifiedBy
		$this->ModifiedBy = new DbField('patient_prescription', 'patient_prescription', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('patient_prescription', 'patient_prescription', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', '`ModifiedDateTime`', 200, -1, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patient_prescriptionview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
