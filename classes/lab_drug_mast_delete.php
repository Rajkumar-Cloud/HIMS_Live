 ...
 * Page class
 */
class lab_drug_mast_delete extends lab_drug_mast
{
	...
	// Page object name
	public $PageObjName = "lab_drug_mast_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lab_drug_mastlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("lab_drug_mastlist.php"); // Return to list
			}
		}
	}
