 ...
 * Page class
 */
class pres_trade_combination_names_new_add extends pres_trade_combination_names_new
{
	...
	// Page object name
	public $PageObjName = "pres_trade_combination_names_new_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "pres_trade_combination_names_newview.php")
