 ...
 * Page class
 */
class pres_indicationstable_edit extends pres_indicationstable
{
	...
	// Page object name
	public $PageObjName = "pres_indicationstable_edit";
	...
	protected function validateForm()
	{
		...
		if ($this->Sno->Required) {
			if (!$this->Sno->IsDetailKey && $this->Sno->FormValue != NULL && $this->Sno->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->Sno->caption(), $this->Sno->RequiredErrorMessage));
			}
		}
