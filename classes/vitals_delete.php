 ...
 * Page class
 */
class vitals_delete extends vitals
{
	...
	// Page object name
	public $PageObjName = "vitals_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("vitalslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("vitalslist.php"); // Return to list
			}
		}
	}
