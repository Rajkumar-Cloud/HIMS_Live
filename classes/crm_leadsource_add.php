 ...
 * Page class
 */
class crm_leadsource_add extends crm_leadsource
{
	...
	// Page object name
	public $PageObjName = "crm_leadsource_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("leadsourceid") !== NULL) {
				...
				$this->setKey("leadsourceid", $this->leadsourceid->CurrentValue); // Set up key
			} else {
				$this->setKey("leadsourceid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "crm_leadsourceview.php")
