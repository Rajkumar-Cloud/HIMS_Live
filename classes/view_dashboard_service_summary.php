 ...
 */
class view_dashboard_service_summary extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// DEPARTMENT
		$this->DEPARTMENT = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, -1, FALSE, '`DEPARTMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEPARTMENT->IsForeignKey = TRUE; // Foreign key field
		$this->DEPARTMENT->Sortable = TRUE; // Allow sort
		$this->fields['DEPARTMENT'] = &$this->DEPARTMENT;

		// SubTotal
		$this->SubTotal = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_SubTotal', 'SubTotal', '`SubTotal`', '`SubTotal`', 131, -1, FALSE, '`SubTotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdDate
		$this->createdDate = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike('`createdDate`', 7, "DB"), 133, 7, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// vid
		$this->vid = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_vid', 'vid', '`vid`', '`vid`', 3, -1, FALSE, '`vid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vid->Sortable = TRUE; // Allow sort
		$this->vid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['vid'] = &$this->vid;

		// ItemCode
		$this->ItemCode = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, -1, FALSE, '`ItemCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ItemCode->Sortable = TRUE; // Allow sort
		$this->fields['ItemCode'] = &$this->ItemCode;

		// PatientId
		$this->PatientId = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_dashboard_service_servicetype") {
			$detailUrl = $GLOBALS["view_dashboard_service_servicetype"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
		...
		if ($detailUrl == "")
			$detailUrl = "view_dashboard_service_summarylist.php";
		return $detailUrl;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_dashboard_service_summarylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_dashboard_service_summaryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_dashboard_service_summaryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_dashboard_service_summaryadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_dashboard_service_summaryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_dashboard_service_summaryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_dashboard_service_summaryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_dashboard_service_summaryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_dashboard_service_summaryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_dashboard_service_summaryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_dashboard_service_summarydelete.php", $this->getUrlParm());
	}
