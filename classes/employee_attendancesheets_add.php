 ...
 * Page class
 */
class employee_attendancesheets_add extends employee_attendancesheets
{
	...
	// Page object name
	public $PageObjName = "employee_attendancesheets_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("employee_attendancesheetslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "employee_attendancesheetslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "employee_attendancesheetsview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// date_start
		$this->date_start->setDbValueDef($rsnew, UnFormatDateTime($this->date_start->CurrentValue, 0), CurrentDate(), FALSE);

		// date_end
		$this->date_end->setDbValueDef($rsnew, UnFormatDateTime($this->date_end->CurrentValue, 0), CurrentDate(), FALSE);
