 ...
 * Page class
 */
class store_grn_edit extends store_grn
{
	...
	// Page object name
	public $PageObjName = "store_grn_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("view_store_grn", $detailTblVar) && $GLOBALS["view_store_grn"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("view_store_grn", $detailTblVar) && $GLOBALS["view_store_grn"]->DetailEdit) {
						...
						$editRow = $GLOBALS["view_store_grn_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar <> "") {
			...
			if (in_array("view_store_grn", $detailTblVar)) {
				...
				if ($GLOBALS["view_store_grn_grid"]->DetailEdit) {
					$GLOBALS["view_store_grn_grid"]->CurrentMode = "edit";
					$GLOBALS["view_store_grn_grid"]->CurrentAction = "gridedit";
