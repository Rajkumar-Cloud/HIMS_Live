 ...
 * Page class
 */
class employee_permissions_delete extends employee_permissions
{
	...
	// Page object name
	public $PageObjName = "employee_permissions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_permissionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_permissionslist.php"); // Return to list
			}
		}
	}
