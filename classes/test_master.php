...
/**
 * Table class for test_master
 */
class test_master extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'test_master';
		$this->TableName = 'test_master';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`test_master`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('test_master', 'test_master', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// MainDeptCd
		$this->MainDeptCd = new DbField('test_master', 'test_master', 'x_MainDeptCd', 'MainDeptCd', '`MainDeptCd`', '`MainDeptCd`', 200, -1, FALSE, '`MainDeptCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MainDeptCd->Sortable = TRUE; // Allow sort
		$this->fields['MainDeptCd'] = &$this->MainDeptCd;

		// DeptCd
		$this->DeptCd = new DbField('test_master', 'test_master', 'x_DeptCd', 'DeptCd', '`DeptCd`', '`DeptCd`', 200, -1, FALSE, '`DeptCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeptCd->Sortable = TRUE; // Allow sort
		$this->fields['DeptCd'] = &$this->DeptCd;

		// TestCd
		$this->TestCd = new DbField('test_master', 'test_master', 'x_TestCd', 'TestCd', '`TestCd`', '`TestCd`', 200, -1, FALSE, '`TestCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestCd->Sortable = TRUE; // Allow sort
		$this->fields['TestCd'] = &$this->TestCd;

		// TestSubCd
		$this->TestSubCd = new DbField('test_master', 'test_master', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, -1, FALSE, '`TestSubCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestSubCd->Sortable = TRUE; // Allow sort
		$this->fields['TestSubCd'] = &$this->TestSubCd;

		// TestName
		$this->TestName = new DbField('test_master', 'test_master', 'x_TestName', 'TestName', '`TestName`', '`TestName`', 200, -1, FALSE, '`TestName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestName->Sortable = TRUE; // Allow sort
		$this->fields['TestName'] = &$this->TestName;

		// XrayPart
		$this->XrayPart = new DbField('test_master', 'test_master', 'x_XrayPart', 'XrayPart', '`XrayPart`', '`XrayPart`', 200, -1, FALSE, '`XrayPart`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->XrayPart->Sortable = TRUE; // Allow sort
		$this->fields['XrayPart'] = &$this->XrayPart;

		// Method
		$this->Method = new DbField('test_master', 'test_master', 'x_Method', 'Method', '`Method`', '`Method`', 200, -1, FALSE, '`Method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Method->Sortable = TRUE; // Allow sort
		$this->fields['Method'] = &$this->Method;

		// Order
		$this->Order = new DbField('test_master', 'test_master', 'x_Order', 'Order', '`Order`', '`Order`', 131, -1, FALSE, '`Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Form
		$this->Form = new DbField('test_master', 'test_master', 'x_Form', 'Form', '`Form`', '`Form`', 200, -1, FALSE, '`Form`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Form->Sortable = TRUE; // Allow sort
		$this->fields['Form'] = &$this->Form;

		// Amt
		$this->Amt = new DbField('test_master', 'test_master', 'x_Amt', 'Amt', '`Amt`', '`Amt`', 131, -1, FALSE, '`Amt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amt->Sortable = TRUE; // Allow sort
		$this->Amt->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Amt'] = &$this->Amt;

		// SplAmt
		$this->SplAmt = new DbField('test_master', 'test_master', 'x_SplAmt', 'SplAmt', '`SplAmt`', '`SplAmt`', 131, -1, FALSE, '`SplAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResType
		$this->ResType = new DbField('test_master', 'test_master', 'x_ResType', 'ResType', '`ResType`', '`ResType`', 200, -1, FALSE, '`ResType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ResType->Sortable = TRUE; // Allow sort
		$this->fields['ResType'] = &$this->ResType;

		// UnitCD
		$this->UnitCD = new DbField('test_master', 'test_master', 'x_UnitCD', 'UnitCD', '`UnitCD`', '`UnitCD`', 200, -1, FALSE, '`UnitCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UnitCD->Sortable = TRUE; // Allow sort
		$this->fields['UnitCD'] = &$this->UnitCD;

		// RefValue
		$this->RefValue = new DbField('test_master', 'test_master', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, -1, FALSE, '`RefValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->RefValue->Sortable = TRUE; // Allow sort
		$this->fields['RefValue'] = &$this->RefValue;

		// Sample
		$this->Sample = new DbField('test_master', 'test_master', 'x_Sample', 'Sample', '`Sample`', '`Sample`', 200, -1, FALSE, '`Sample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sample->Sortable = TRUE; // Allow sort
		$this->fields['Sample'] = &$this->Sample;

		// NoD
		$this->NoD = new DbField('test_master', 'test_master', 'x_NoD', 'NoD', '`NoD`', '`NoD`', 131, -1, FALSE, '`NoD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoD->Sortable = TRUE; // Allow sort
		$this->NoD->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['NoD'] = &$this->NoD;

		// BillOrder
		$this->BillOrder = new DbField('test_master', 'test_master', 'x_BillOrder', 'BillOrder', '`BillOrder`', '`BillOrder`', 131, -1, FALSE, '`BillOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Formula
		$this->Formula = new DbField('test_master', 'test_master', 'x_Formula', 'Formula', '`Formula`', '`Formula`', 201, -1, FALSE, '`Formula`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Formula->Sortable = TRUE; // Allow sort
		$this->fields['Formula'] = &$this->Formula;

		// Inactive
		$this->Inactive = new DbField('test_master', 'test_master', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, -1, FALSE, '`Inactive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Inactive->Sortable = TRUE; // Allow sort
		$this->fields['Inactive'] = &$this->Inactive;

		// ReagentAmt
		$this->ReagentAmt = new DbField('test_master', 'test_master', 'x_ReagentAmt', 'ReagentAmt', '`ReagentAmt`', '`ReagentAmt`', 131, -1, FALSE, '`ReagentAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LabAmt
		$this->LabAmt = new DbField('test_master', 'test_master', 'x_LabAmt', 'LabAmt', '`LabAmt`', '`LabAmt`', 131, -1, FALSE, '`LabAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RefAmt
		$this->RefAmt = new DbField('test_master', 'test_master', 'x_RefAmt', 'RefAmt', '`RefAmt`', '`RefAmt`', 131, -1, FALSE, '`RefAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreFrom
		$this->CreFrom = new DbField('test_master', 'test_master', 'x_CreFrom', 'CreFrom', '`CreFrom`', '`CreFrom`', 131, -1, FALSE, '`CreFrom`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreTo
		$this->CreTo = new DbField('test_master', 'test_master', 'x_CreTo', 'CreTo', '`CreTo`', '`CreTo`', 131, -1, FALSE, '`CreTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Note
		$this->Note = new DbField('test_master', 'test_master', 'x_Note', 'Note', '`Note`', '`Note`', 201, -1, FALSE, '`Note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Note->Sortable = TRUE; // Allow sort
		$this->fields['Note'] = &$this->Note;

		// Sun
		$this->Sun = new DbField('test_master', 'test_master', 'x_Sun', 'Sun', '`Sun`', '`Sun`', 200, -1, FALSE, '`Sun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sun->Sortable = TRUE; // Allow sort
		$this->fields['Sun'] = &$this->Sun;

		// Mon
		$this->Mon = new DbField('test_master', 'test_master', 'x_Mon', 'Mon', '`Mon`', '`Mon`', 200, -1, FALSE, '`Mon`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mon->Sortable = TRUE; // Allow sort
		$this->fields['Mon'] = &$this->Mon;

		// Tue
		$this->Tue = new DbField('test_master', 'test_master', 'x_Tue', 'Tue', '`Tue`', '`Tue`', 200, -1, FALSE, '`Tue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tue->Sortable = TRUE; // Allow sort
		$this->fields['Tue'] = &$this->Tue;

		// Wed
		$this->Wed = new DbField('test_master', 'test_master', 'x_Wed', 'Wed', '`Wed`', '`Wed`', 200, -1, FALSE, '`Wed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Wed->Sortable = TRUE; // Allow sort
		$this->fields['Wed'] = &$this->Wed;

		// Thi
		$this->Thi = new DbField('test_master', 'test_master', 'x_Thi', 'Thi', '`Thi`', '`Thi`', 200, -1, FALSE, '`Thi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Thi->Sortable = TRUE; // Allow sort
		$this->fields['Thi'] = &$this->Thi;

		// Fri
		$this->Fri = new DbField('test_master', 'test_master', 'x_Fri', 'Fri', '`Fri`', '`Fri`', 200, -1, FALSE, '`Fri`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fri->Sortable = TRUE; // Allow sort
		$this->fields['Fri'] = &$this->Fri;

		// Sat
		$this->Sat = new DbField('test_master', 'test_master', 'x_Sat', 'Sat', '`Sat`', '`Sat`', 200, -1, FALSE, '`Sat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sat->Sortable = TRUE; // Allow sort
		$this->fields['Sat'] = &$this->Sat;

		// Days
		$this->Days = new DbField('test_master', 'test_master', 'x_Days', 'Days', '`Days`', '`Days`', 131, -1, FALSE, '`Days`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Days->Sortable = TRUE; // Allow sort
		$this->Days->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Days'] = &$this->Days;

		// Cutoff
		$this->Cutoff = new DbField('test_master', 'test_master', 'x_Cutoff', 'Cutoff', '`Cutoff`', '`Cutoff`', 200, -1, FALSE, '`Cutoff`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cutoff->Sortable = TRUE; // Allow sort
		$this->fields['Cutoff'] = &$this->Cutoff;

		// FontBold
		$this->FontBold = new DbField('test_master', 'test_master', 'x_FontBold', 'FontBold', '`FontBold`', '`FontBold`', 200, -1, FALSE, '`FontBold`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FontBold->Sortable = TRUE; // Allow sort
		$this->fields['FontBold'] = &$this->FontBold;

		// TestHeading
		$this->TestHeading = new DbField('test_master', 'test_master', 'x_TestHeading', 'TestHeading', '`TestHeading`', '`TestHeading`', 200, -1, FALSE, '`TestHeading`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestHeading->Sortable = TRUE; // Allow sort
		$this->fields['TestHeading'] = &$this->TestHeading;

		// Outsource
		$this->Outsource = new DbField('test_master', 'test_master', 'x_Outsource', 'Outsource', '`Outsource`', '`Outsource`', 200, -1, FALSE, '`Outsource`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Outsource->Sortable = TRUE; // Allow sort
		$this->fields['Outsource'] = &$this->Outsource;

		// NoResult
		$this->NoResult = new DbField('test_master', 'test_master', 'x_NoResult', 'NoResult', '`NoResult`', '`NoResult`', 200, -1, FALSE, '`NoResult`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoResult->Sortable = TRUE; // Allow sort
		$this->fields['NoResult'] = &$this->NoResult;

		// GraphLow
		$this->GraphLow = new DbField('test_master', 'test_master', 'x_GraphLow', 'GraphLow', '`GraphLow`', '`GraphLow`', 131, -1, FALSE, '`GraphLow`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GraphHigh
		$this->GraphHigh = new DbField('test_master', 'test_master', 'x_GraphHigh', 'GraphHigh', '`GraphHigh`', '`GraphHigh`', 131, -1, FALSE, '`GraphHigh`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CollSample
		$this->CollSample = new DbField('test_master', 'test_master', 'x_CollSample', 'CollSample', '`CollSample`', '`CollSample`', 200, -1, FALSE, '`CollSample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CollSample->Sortable = TRUE; // Allow sort
		$this->fields['CollSample'] = &$this->CollSample;

		// ProcessTime
		$this->ProcessTime = new DbField('test_master', 'test_master', 'x_ProcessTime', 'ProcessTime', '`ProcessTime`', '`ProcessTime`', 200, -1, FALSE, '`ProcessTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProcessTime->Sortable = TRUE; // Allow sort
		$this->fields['ProcessTime'] = &$this->ProcessTime;

		// TamilName
		$this->TamilName = new DbField('test_master', 'test_master', 'x_TamilName', 'TamilName', '`TamilName`', '`TamilName`', 200, -1, FALSE, '`TamilName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TamilName->Sortable = TRUE; // Allow sort
		$this->fields['TamilName'] = &$this->TamilName;

		// ShortName
		$this->ShortName = new DbField('test_master', 'test_master', 'x_ShortName', 'ShortName', '`ShortName`', '`ShortName`', 200, -1, FALSE, '`ShortName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShortName->Sortable = TRUE; // Allow sort
		$this->fields['ShortName'] = &$this->ShortName;

		// Individual
		$this->Individual = new DbField('test_master', 'test_master', 'x_Individual', 'Individual', '`Individual`', '`Individual`', 200, -1, FALSE, '`Individual`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Individual->Sortable = TRUE; // Allow sort
		$this->fields['Individual'] = &$this->Individual;

		// PrevAmt
		$this->PrevAmt = new DbField('test_master', 'test_master', 'x_PrevAmt', 'PrevAmt', '`PrevAmt`', '`PrevAmt`', 131, -1, FALSE, '`PrevAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrevSplAmt
		$this->PrevSplAmt = new DbField('test_master', 'test_master', 'x_PrevSplAmt', 'PrevSplAmt', '`PrevSplAmt`', '`PrevSplAmt`', 131, -1, FALSE, '`PrevSplAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Remarks
		$this->Remarks = new DbField('test_master', 'test_master', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// EditDate
		$this->EditDate = new DbField('test_master', 'test_master', 'x_EditDate', 'EditDate', '`EditDate`', CastDateFieldForLike('`EditDate`', 0, "DB"), 135, 0, FALSE, '`EditDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillName
		$this->BillName = new DbField('test_master', 'test_master', 'x_BillName', 'BillName', '`BillName`', '`BillName`', 200, -1, FALSE, '`BillName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillName->Sortable = TRUE; // Allow sort
		$this->fields['BillName'] = &$this->BillName;

		// ActualAmt
		$this->ActualAmt = new DbField('test_master', 'test_master', 'x_ActualAmt', 'ActualAmt', '`ActualAmt`', '`ActualAmt`', 131, -1, FALSE, '`ActualAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HISCD
		$this->HISCD = new DbField('test_master', 'test_master', 'x_HISCD', 'HISCD', '`HISCD`', '`HISCD`', 200, -1, FALSE, '`HISCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HISCD->Sortable = TRUE; // Allow sort
		$this->fields['HISCD'] = &$this->HISCD;

		// PriceList
		$this->PriceList = new DbField('test_master', 'test_master', 'x_PriceList', 'PriceList', '`PriceList`', '`PriceList`', 200, -1, FALSE, '`PriceList`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PriceList->Sortable = TRUE; // Allow sort
		$this->fields['PriceList'] = &$this->PriceList;

		// IPAmt
		$this->IPAmt = new DbField('test_master', 'test_master', 'x_IPAmt', 'IPAmt', '`IPAmt`', '`IPAmt`', 131, -1, FALSE, '`IPAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// InsAmt
		$this->InsAmt = new DbField('test_master', 'test_master', 'x_InsAmt', 'InsAmt', '`InsAmt`', '`InsAmt`', 131, -1, FALSE, '`InsAmt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ManualCD
		$this->ManualCD = new DbField('test_master', 'test_master', 'x_ManualCD', 'ManualCD', '`ManualCD`', '`ManualCD`', 200, -1, FALSE, '`ManualCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ManualCD->Sortable = TRUE; // Allow sort
		$this->fields['ManualCD'] = &$this->ManualCD;

		// Free
		$this->Free = new DbField('test_master', 'test_master', 'x_Free', 'Free', '`Free`', '`Free`', 200, -1, FALSE, '`Free`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Free->Sortable = TRUE; // Allow sort
		$this->fields['Free'] = &$this->Free;

		// AutoAuth
		$this->AutoAuth = new DbField('test_master', 'test_master', 'x_AutoAuth', 'AutoAuth', '`AutoAuth`', '`AutoAuth`', 200, -1, FALSE, '`AutoAuth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AutoAuth->Sortable = TRUE; // Allow sort
		$this->fields['AutoAuth'] = &$this->AutoAuth;

		// ProductCD
		$this->ProductCD = new DbField('test_master', 'test_master', 'x_ProductCD', 'ProductCD', '`ProductCD`', '`ProductCD`', 200, -1, FALSE, '`ProductCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProductCD->Sortable = TRUE; // Allow sort
		$this->fields['ProductCD'] = &$this->ProductCD;

		// Inventory
		$this->Inventory = new DbField('test_master', 'test_master', 'x_Inventory', 'Inventory', '`Inventory`', '`Inventory`', 200, -1, FALSE, '`Inventory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Inventory->Sortable = TRUE; // Allow sort
		$this->fields['Inventory'] = &$this->Inventory;

		// IntimateTest
		$this->IntimateTest = new DbField('test_master', 'test_master', 'x_IntimateTest', 'IntimateTest', '`IntimateTest`', '`IntimateTest`', 200, -1, FALSE, '`IntimateTest`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IntimateTest->Sortable = TRUE; // Allow sort
		$this->fields['IntimateTest'] = &$this->IntimateTest;

		// Manual
		$this->Manual = new DbField('test_master', 'test_master', 'x_Manual', 'Manual', '`Manual`', '`Manual`', 200, -1, FALSE, '`Manual`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`test_master`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "test_masteredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "test_masteradd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("test_masterview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("test_masterview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "test_masteradd.php?" . $this->getUrlParm($parm);
		else
			$url = "test_masteradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("test_masteredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("test_masteradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("test_masterdelete.php", $this->getUrlParm());
	}
