 ...
 * Page class
 */
class hospital_delete extends hospital
{
	...
	// Page object name
	public $PageObjName = "hospital_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("hospitallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hospitallist.php"); // Return to list
			}
		}
	}
