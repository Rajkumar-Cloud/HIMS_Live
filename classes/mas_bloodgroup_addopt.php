 ...
 * Page class
 */
class mas_bloodgroup_addopt extends mas_bloodgroup
{
	...
	// Page object name
	public $PageObjName = "mas_bloodgroup_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->BloodGroup->IsDetailKey) {
			$this->BloodGroup->setFormValue(ConvertFromUtf8($val));
		}
	...
	{
		global $CurrentForm;
		$this->BloodGroup->CurrentValue = ConvertToUtf8($this->BloodGroup->FormValue);
	}
