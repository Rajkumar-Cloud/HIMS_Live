...
class view_lab_resultreleased_auth extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PatID
		$this->PatID = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientName
		$this->PatientName = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Age
		$this->Age = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// sid
		$this->sid = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_sid', 'sid', '`sid`', '`sid`', 3, -1, FALSE, '`sid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sid->Sortable = TRUE; // Allow sort
		$this->sid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['sid'] = &$this->sid;

		// ItemCode
		$this->ItemCode = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, -1, FALSE, '`ItemCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ItemCode->Sortable = TRUE; // Allow sort
		$this->fields['ItemCode'] = &$this->ItemCode;

		// DEptCd
		$this->DEptCd = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, -1, FALSE, '`DEptCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEptCd->Sortable = TRUE; // Allow sort
		$this->fields['DEptCd'] = &$this->DEptCd;

		// Resulted
		$this->Resulted = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, -1, FALSE, '`Resulted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Services
		$this->Services = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Services', 'Services', '`Services`', '`Services`', 200, -1, FALSE, '`Services`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// LabReport
		$this->LabReport = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, -1, FALSE, '`LabReport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LabReport->Sortable = TRUE; // Allow sort
		$this->fields['LabReport'] = &$this->LabReport;

		// Pic1
		$this->Pic1 = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, -1, TRUE, '`Pic1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->Pic1->Sortable = TRUE; // Allow sort
		$this->fields['Pic1'] = &$this->Pic1;

		// Pic2
		$this->Pic2 = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, -1, TRUE, '`Pic2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->Pic2->Sortable = TRUE; // Allow sort
		$this->fields['Pic2'] = &$this->Pic2;

		// TestUnit
		$this->TestUnit = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_TestUnit', 'TestUnit', '`TestUnit`', '`TestUnit`', 200, -1, FALSE, '`TestUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RefValue
		$this->RefValue = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, -1, FALSE, '`RefValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->RefValue->Sortable = TRUE; // Allow sort
		$this->fields['RefValue'] = &$this->RefValue;

		// Order
		$this->Order = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Order', 'Order', '`Order`', '`Order`', 131, -1, FALSE, '`Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Repeated
		$this->Repeated = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, -1, FALSE, '`Repeated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Vid
		$this->Vid = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, -1, FALSE, '`Vid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceId
		$this->invoiceId = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, -1, FALSE, '`invoiceId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrID
		$this->DrID = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, -1, FALSE, '`DrID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrCODE
		$this->DrCODE = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_DrCODE', 'DrCODE', '`DrCODE`', '`DrCODE`', 200, -1, FALSE, '`DrCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DrCODE->Sortable = TRUE; // Allow sort
		$this->fields['DrCODE'] = &$this->DrCODE;

		// DrName
		$this->DrName = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, -1, FALSE, '`DrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DrName->Sortable = TRUE; // Allow sort
		$this->fields['DrName'] = &$this->DrName;

		// Department
		$this->Department = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Department', 'Department', '`Department`', '`Department`', 200, -1, FALSE, '`Department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Department->Sortable = TRUE; // Allow sort
		$this->fields['Department'] = &$this->Department;

		// createddatetime
		$this->createddatetime = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// status
		$this->status = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// TestType
		$this->TestType = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, -1, FALSE, '`TestType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestType->Sortable = TRUE; // Allow sort
		$this->fields['TestType'] = &$this->TestType;

		// ResultDate
		$this->ResultDate = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike('`ResultDate`', 0, "DB"), 135, 0, FALSE, '`ResultDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResultedBy
		$this->ResultedBy = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, -1, FALSE, '`ResultedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ResultedBy->Sortable = TRUE; // Allow sort
		$this->fields['ResultedBy'] = &$this->ResultedBy;

		// HospID
		$this->HospID = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_lab_resultreleased_authview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($this->getCurrentMasterTable() == "view_lab_services_auth" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
