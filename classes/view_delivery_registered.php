 ...
 */
class view_delivery_registered extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// first_name
		$this->first_name = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// PatientID
		$this->PatientID = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mobile_no
		$this->mobile_no = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['mobile_no'] = &$this->mobile_no;

		// street
		$this->street = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->street->Sortable = TRUE; // Allow sort
		$this->fields['street'] = &$this->street;

		// town
		$this->town = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// DeliveryRegistered
		$this->DeliveryRegistered = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_DeliveryRegistered', 'DeliveryRegistered', '`DeliveryRegistered`', '`DeliveryRegistered`', 200, -1, FALSE, '`DeliveryRegistered`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// LMP
		$this->LMP = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_LMP', 'LMP', '`LMP`', CastDateFieldForLike('`LMP`', 7, "DB"), 135, 7, FALSE, '`LMP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EDD
		$this->EDD = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_EDD', 'EDD', '`EDD`', CastDateFieldForLike('`EDD`', 7, "DB"), 135, 7, FALSE, '`EDD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdUserName
		$this->createdUserName = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_createdUserName', 'createdUserName', '`createdUserName`', '`createdUserName`', 200, -1, FALSE, '`createdUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdUserName->Sortable = TRUE; // Allow sort
		$this->fields['createdUserName'] = &$this->createdUserName;

		// HospID
		$this->HospID = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`HospID`='".HospitalID()."' and `DeliveryRegistered` = '1'";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_delivery_registeredlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_delivery_registeredview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_delivery_registerededit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_delivery_registeredadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_delivery_registeredview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_delivery_registeredview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_delivery_registeredadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_delivery_registeredadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_delivery_registerededit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_delivery_registeredadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_delivery_registereddelete.php", $this->getUrlParm());
	}
