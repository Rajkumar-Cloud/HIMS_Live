 ...
 * Page class
 */
class sys_days_edit extends sys_days
{
	...
	// Page object name
	public $PageObjName = "sys_days_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("sys_dayslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "sys_dayslist.php")
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Days
			$this->Days->setDbValueDef($rsnew, $this->Days->CurrentValue, "", $this->Days->ReadOnly);
