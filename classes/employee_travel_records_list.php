 ...
 * Page class
 */
class employee_travel_records_list extends employee_travel_records
{
	...
	// Page object name
	public $PageObjName = "employee_travel_records_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "employee_travel_recordsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "employee_travel_recordsdelete.php";
		$this->MultiUpdateUrl = "employee_travel_recordsupdate.php";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"femployee_travel_recordslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"femployee_travel_recordslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.femployee_travel_recordslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"femployee_travel_recordslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function loadSearchValues()
	{
		...
		// travel_from
		if (!$this->isAddOrEdit())
			$this->travel_from->AdvancedSearch->setSearchValue(Get("x_travel_from", Get("travel_from", "")));
		if ($this->travel_from->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->travel_from->AdvancedSearch->setSearchOperator(Get("z_travel_from", ""));

		// travel_to
		if (!$this->isAddOrEdit())
			$this->travel_to->AdvancedSearch->setSearchValue(Get("x_travel_to", Get("travel_to", "")));
		if ($this->travel_to->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->travel_to->AdvancedSearch->setSearchOperator(Get("z_travel_to", ""));

		// travel_date
		if (!$this->isAddOrEdit())
			$this->travel_date->AdvancedSearch->setSearchValue(Get("x_travel_date", Get("travel_date", "")));
		if ($this->travel_date->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->travel_date->AdvancedSearch->setSearchOperator(Get("z_travel_date", ""));

		// return_date
		if (!$this->isAddOrEdit())
			$this->return_date->AdvancedSearch->setSearchValue(Get("x_return_date", Get("return_date", "")));
		if ($this->return_date->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->return_date->AdvancedSearch->setSearchOperator(Get("z_return_date", ""));
		...
		// funding
		if (!$this->isAddOrEdit())
			$this->funding->AdvancedSearch->setSearchValue(Get("x_funding", Get("funding", "")));
		if ($this->funding->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->funding->AdvancedSearch->setSearchOperator(Get("z_funding", ""));
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.femployee_travel_recordslist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.femployee_travel_recordslist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.femployee_travel_recordslist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
