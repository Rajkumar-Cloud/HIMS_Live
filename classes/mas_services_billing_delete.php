 ...
 * Page class
 */
class mas_services_billing_delete extends mas_services_billing
{
	...
	// Page object name
	public $PageObjName = "mas_services_billing_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("mas_services_billinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("mas_services_billinglist.php"); // Return to list
			}
		}
	}
