 ...
 */
class view_followups extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_followups', 'view_followups', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PatientID
		$this->PatientID = new DbField('view_followups', 'view_followups', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// title
		$this->title = new DbField('view_followups', 'view_followups', 'x_title', 'title', '`title`', '`title`', 3, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->title->Sortable = TRUE; // Allow sort
		$this->title->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['title'] = &$this->title;

		// first_name
		$this->first_name = new DbField('view_followups', 'view_followups', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// middle_name
		$this->middle_name = new DbField('view_followups', 'view_followups', 'x_middle_name', 'middle_name', '`middle_name`', '`middle_name`', 200, -1, FALSE, '`middle_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->middle_name->Sortable = TRUE; // Allow sort
		$this->fields['middle_name'] = &$this->middle_name;

		// last_name
		$this->last_name = new DbField('view_followups', 'view_followups', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, -1, FALSE, '`last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->last_name->Sortable = TRUE; // Allow sort
		$this->fields['last_name'] = &$this->last_name;

		// gender
		$this->gender = new DbField('view_followups', 'view_followups', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gender->Sortable = TRUE; // Allow sort
		$this->fields['gender'] = &$this->gender;

		// dob
		$this->dob = new DbField('view_followups', 'view_followups', 'x_dob', 'dob', '`dob`', CastDateFieldForLike('`dob`', 0, "DB"), 133, 0, FALSE, '`dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Age
		$this->Age = new DbField('view_followups', 'view_followups', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// blood_group
		$this->blood_group = new DbField('view_followups', 'view_followups', 'x_blood_group', 'blood_group', '`blood_group`', '`blood_group`', 200, -1, FALSE, '`blood_group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->blood_group->Sortable = TRUE; // Allow sort
		$this->fields['blood_group'] = &$this->blood_group;

		// mobile_no
		$this->mobile_no = new DbField('view_followups', 'view_followups', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['mobile_no'] = &$this->mobile_no;

		// description
		$this->description = new DbField('view_followups', 'view_followups', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// IdentificationMark
		$this->IdentificationMark = new DbField('view_followups', 'view_followups', 'x_IdentificationMark', 'IdentificationMark', '`IdentificationMark`', '`IdentificationMark`', 200, -1, FALSE, '`IdentificationMark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IdentificationMark->Sortable = TRUE; // Allow sort
		$this->fields['IdentificationMark'] = &$this->IdentificationMark;

		// Religion
		$this->Religion = new DbField('view_followups', 'view_followups', 'x_Religion', 'Religion', '`Religion`', '`Religion`', 200, -1, FALSE, '`Religion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Religion->Sortable = TRUE; // Allow sort
		$this->fields['Religion'] = &$this->Religion;

		// Nationality
		$this->Nationality = new DbField('view_followups', 'view_followups', 'x_Nationality', 'Nationality', '`Nationality`', '`Nationality`', 200, -1, FALSE, '`Nationality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nationality->Sortable = TRUE; // Allow sort
		$this->fields['Nationality'] = &$this->Nationality;

		// profilePic
		$this->profilePic = new DbField('view_followups', 'view_followups', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 200, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// status
		$this->status = new DbField('view_followups', 'view_followups', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// createdby
		$this->createdby = new DbField('view_followups', 'view_followups', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_followups', 'view_followups', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_followups', 'view_followups', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_followups', 'view_followups', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// ReferedByDr
		$this->ReferedByDr = new DbField('view_followups', 'view_followups', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, -1, FALSE, '`ReferedByDr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferedByDr->Sortable = TRUE; // Allow sort
		$this->fields['ReferedByDr'] = &$this->ReferedByDr;

		// ReferClinicname
		$this->ReferClinicname = new DbField('view_followups', 'view_followups', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, -1, FALSE, '`ReferClinicname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferClinicname->Sortable = TRUE; // Allow sort
		$this->fields['ReferClinicname'] = &$this->ReferClinicname;

		// ReferCity
		$this->ReferCity = new DbField('view_followups', 'view_followups', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, -1, FALSE, '`ReferCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferCity->Sortable = TRUE; // Allow sort
		$this->fields['ReferCity'] = &$this->ReferCity;

		// ReferMobileNo
		$this->ReferMobileNo = new DbField('view_followups', 'view_followups', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, -1, FALSE, '`ReferMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['ReferMobileNo'] = &$this->ReferMobileNo;

		// ReferA4TreatingConsultant
		$this->ReferA4TreatingConsultant = new DbField('view_followups', 'view_followups', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, -1, FALSE, '`ReferA4TreatingConsultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurposreReferredfor
		$this->PurposreReferredfor = new DbField('view_followups', 'view_followups', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, -1, FALSE, '`PurposreReferredfor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PurposreReferredfor->Sortable = TRUE; // Allow sort
		$this->fields['PurposreReferredfor'] = &$this->PurposreReferredfor;

		// spouse_title
		$this->spouse_title = new DbField('view_followups', 'view_followups', 'x_spouse_title', 'spouse_title', '`spouse_title`', '`spouse_title`', 200, -1, FALSE, '`spouse_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_title->Sortable = TRUE; // Allow sort
		$this->fields['spouse_title'] = &$this->spouse_title;

		// spouse_first_name
		$this->spouse_first_name = new DbField('view_followups', 'view_followups', 'x_spouse_first_name', 'spouse_first_name', '`spouse_first_name`', '`spouse_first_name`', 200, -1, FALSE, '`spouse_first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_first_name->Sortable = TRUE; // Allow sort
		$this->fields['spouse_first_name'] = &$this->spouse_first_name;

		// spouse_middle_name
		$this->spouse_middle_name = new DbField('view_followups', 'view_followups', 'x_spouse_middle_name', 'spouse_middle_name', '`spouse_middle_name`', '`spouse_middle_name`', 200, -1, FALSE, '`spouse_middle_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_middle_name->Sortable = TRUE; // Allow sort
		$this->fields['spouse_middle_name'] = &$this->spouse_middle_name;

		// spouse_last_name
		$this->spouse_last_name = new DbField('view_followups', 'view_followups', 'x_spouse_last_name', 'spouse_last_name', '`spouse_last_name`', '`spouse_last_name`', 200, -1, FALSE, '`spouse_last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_last_name->Sortable = TRUE; // Allow sort
		$this->fields['spouse_last_name'] = &$this->spouse_last_name;

		// spouse_gender
		$this->spouse_gender = new DbField('view_followups', 'view_followups', 'x_spouse_gender', 'spouse_gender', '`spouse_gender`', '`spouse_gender`', 200, -1, FALSE, '`spouse_gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_gender->Sortable = TRUE; // Allow sort
		$this->fields['spouse_gender'] = &$this->spouse_gender;

		// spouse_dob
		$this->spouse_dob = new DbField('view_followups', 'view_followups', 'x_spouse_dob', 'spouse_dob', '`spouse_dob`', CastDateFieldForLike('`spouse_dob`', 0, "DB"), 133, 0, FALSE, '`spouse_dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spouse_Age
		$this->spouse_Age = new DbField('view_followups', 'view_followups', 'x_spouse_Age', 'spouse_Age', '`spouse_Age`', '`spouse_Age`', 200, -1, FALSE, '`spouse_Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_Age->Sortable = TRUE; // Allow sort
		$this->fields['spouse_Age'] = &$this->spouse_Age;

		// spouse_blood_group
		$this->spouse_blood_group = new DbField('view_followups', 'view_followups', 'x_spouse_blood_group', 'spouse_blood_group', '`spouse_blood_group`', '`spouse_blood_group`', 200, -1, FALSE, '`spouse_blood_group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_blood_group->Sortable = TRUE; // Allow sort
		$this->fields['spouse_blood_group'] = &$this->spouse_blood_group;

		// spouse_mobile_no
		$this->spouse_mobile_no = new DbField('view_followups', 'view_followups', 'x_spouse_mobile_no', 'spouse_mobile_no', '`spouse_mobile_no`', '`spouse_mobile_no`', 200, -1, FALSE, '`spouse_mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['spouse_mobile_no'] = &$this->spouse_mobile_no;

		// Maritalstatus
		$this->Maritalstatus = new DbField('view_followups', 'view_followups', 'x_Maritalstatus', 'Maritalstatus', '`Maritalstatus`', '`Maritalstatus`', 200, -1, FALSE, '`Maritalstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Maritalstatus->Sortable = TRUE; // Allow sort
		$this->fields['Maritalstatus'] = &$this->Maritalstatus;

		// Business
		$this->Business = new DbField('view_followups', 'view_followups', 'x_Business', 'Business', '`Business`', '`Business`', 200, -1, FALSE, '`Business`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Business->Sortable = TRUE; // Allow sort
		$this->fields['Business'] = &$this->Business;

		// Patient_Language
		$this->Patient_Language = new DbField('view_followups', 'view_followups', 'x_Patient_Language', 'Patient_Language', '`Patient_Language`', '`Patient_Language`', 200, -1, FALSE, '`Patient_Language`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Patient_Language->Sortable = TRUE; // Allow sort
		$this->fields['Patient_Language'] = &$this->Patient_Language;

		// Passport
		$this->Passport = new DbField('view_followups', 'view_followups', 'x_Passport', 'Passport', '`Passport`', '`Passport`', 200, -1, FALSE, '`Passport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Passport->Sortable = TRUE; // Allow sort
		$this->fields['Passport'] = &$this->Passport;

		// VisaNo
		$this->VisaNo = new DbField('view_followups', 'view_followups', 'x_VisaNo', 'VisaNo', '`VisaNo`', '`VisaNo`', 200, -1, FALSE, '`VisaNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VisaNo->Sortable = TRUE; // Allow sort
		$this->fields['VisaNo'] = &$this->VisaNo;

		// ValidityOfVisa
		$this->ValidityOfVisa = new DbField('view_followups', 'view_followups', 'x_ValidityOfVisa', 'ValidityOfVisa', '`ValidityOfVisa`', '`ValidityOfVisa`', 200, -1, FALSE, '`ValidityOfVisa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ValidityOfVisa->Sortable = TRUE; // Allow sort
		$this->fields['ValidityOfVisa'] = &$this->ValidityOfVisa;

		// WhereDidYouHear
		$this->WhereDidYouHear = new DbField('view_followups', 'view_followups', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, -1, FALSE, '`WhereDidYouHear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WhereDidYouHear->Sortable = TRUE; // Allow sort
		$this->fields['WhereDidYouHear'] = &$this->WhereDidYouHear;

		// HospID
		$this->HospID = new DbField('view_followups', 'view_followups', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->fields['HospID'] = &$this->HospID;

		// street
		$this->street = new DbField('view_followups', 'view_followups', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->street->Sortable = TRUE; // Allow sort
		$this->fields['street'] = &$this->street;

		// town
		$this->town = new DbField('view_followups', 'view_followups', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// province
		$this->province = new DbField('view_followups', 'view_followups', 'x_province', 'province', '`province`', '`province`', 200, -1, FALSE, '`province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->province->Sortable = TRUE; // Allow sort
		$this->fields['province'] = &$this->province;

		// country
		$this->country = new DbField('view_followups', 'view_followups', 'x_country', 'country', '`country`', '`country`', 200, -1, FALSE, '`country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->country->Sortable = TRUE; // Allow sort
		$this->fields['country'] = &$this->country;

		// postal_code
		$this->postal_code = new DbField('view_followups', 'view_followups', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, -1, FALSE, '`postal_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->postal_code->Sortable = TRUE; // Allow sort
		$this->fields['postal_code'] = &$this->postal_code;

		// PEmail
		$this->PEmail = new DbField('view_followups', 'view_followups', 'x_PEmail', 'PEmail', '`PEmail`', '`PEmail`', 200, -1, FALSE, '`PEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PEmail->Sortable = TRUE; // Allow sort
		$this->fields['PEmail'] = &$this->PEmail;

		// PEmergencyContact
		$this->PEmergencyContact = new DbField('view_followups', 'view_followups', 'x_PEmergencyContact', 'PEmergencyContact', '`PEmergencyContact`', '`PEmergencyContact`', 200, -1, FALSE, '`PEmergencyContact`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PEmergencyContact->Sortable = TRUE; // Allow sort
		$this->fields['PEmergencyContact'] = &$this->PEmergencyContact;

		// occupation
		$this->occupation = new DbField('view_followups', 'view_followups', 'x_occupation', 'occupation', '`occupation`', '`occupation`', 200, -1, FALSE, '`occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->occupation->Sortable = TRUE; // Allow sort
		$this->fields['occupation'] = &$this->occupation;

		// spouse_occupation
		$this->spouse_occupation = new DbField('view_followups', 'view_followups', 'x_spouse_occupation', 'spouse_occupation', '`spouse_occupation`', '`spouse_occupation`', 200, -1, FALSE, '`spouse_occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_occupation->Sortable = TRUE; // Allow sort
		$this->fields['spouse_occupation'] = &$this->spouse_occupation;

		// WhatsApp
		$this->WhatsApp = new DbField('view_followups', 'view_followups', 'x_WhatsApp', 'WhatsApp', '`WhatsApp`', '`WhatsApp`', 200, -1, FALSE, '`WhatsApp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WhatsApp->Sortable = TRUE; // Allow sort
		$this->fields['WhatsApp'] = &$this->WhatsApp;

		// CouppleID
		$this->CouppleID = new DbField('view_followups', 'view_followups', 'x_CouppleID', 'CouppleID', '`CouppleID`', '`CouppleID`', 3, -1, FALSE, '`CouppleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MaleID
		$this->MaleID = new DbField('view_followups', 'view_followups', 'x_MaleID', 'MaleID', '`MaleID`', '`MaleID`', 3, -1, FALSE, '`MaleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FemaleID
		$this->FemaleID = new DbField('view_followups', 'view_followups', 'x_FemaleID', 'FemaleID', '`FemaleID`', '`FemaleID`', 3, -1, FALSE, '`FemaleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GroupID
		$this->GroupID = new DbField('view_followups', 'view_followups', 'x_GroupID', 'GroupID', '`GroupID`', '`GroupID`', 3, -1, FALSE, '`GroupID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Relationship
		$this->Relationship = new DbField('view_followups', 'view_followups', 'x_Relationship', 'Relationship', '`Relationship`', '`Relationship`', 200, -1, FALSE, '`Relationship`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "view_followupsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_followupsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_followupsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_followupsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_followupsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_followupsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_followupsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_followupsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_followupsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_followupsdelete.php", $this->getUrlParm());
	}
