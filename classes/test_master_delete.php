 ...
 * Page class
 */
class test_master_delete extends test_master
{
	...
	// Page object name
	public $PageObjName = "test_master_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("test_masterlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("test_masterlist.php"); // Return to list
			}
		}
	}
