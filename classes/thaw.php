...
class thaw extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('thaw', 'thaw', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNo
		$this->RIDNo = new DbField('thaw', 'thaw', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientName
		$this->PatientName = new DbField('thaw', 'thaw', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = FALSE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// TiDNo
		$this->TiDNo = new DbField('thaw', 'thaw', 'x_TiDNo', 'TiDNo', '`TiDNo`', '`TiDNo`', 3, -1, FALSE, '`TiDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// thawDate
		$this->thawDate = new DbField('thaw', 'thaw', 'x_thawDate', 'thawDate', '`thawDate`', CastDateFieldForLike('`thawDate`', 0, "DB"), 135, 0, FALSE, '`thawDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->thawPrimaryEmbryologist = new DbField('thaw', 'thaw', 'x_thawPrimaryEmbryologist', 'thawPrimaryEmbryologist', '`thawPrimaryEmbryologist`', '`thawPrimaryEmbryologist`', 200, -1, FALSE, '`thawPrimaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->thawSecondaryEmbryologist = new DbField('thaw', 'thaw', 'x_thawSecondaryEmbryologist', 'thawSecondaryEmbryologist', '`thawSecondaryEmbryologist`', '`thawSecondaryEmbryologist`', 200, -1, FALSE, '`thawSecondaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// thawET
		$this->thawET = new DbField('thaw', 'thaw', 'x_thawET', 'thawET', '`thawET`', '`thawET`', 200, -1, FALSE, '`thawET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->thawET->Sortable = FALSE; // Allow sort
		$this->fields['thawET'] = &$this->thawET;

		// thawReFrozen
		$this->thawReFrozen = new DbField('thaw', 'thaw', 'x_thawReFrozen', 'thawReFrozen', '`thawReFrozen`', '`thawReFrozen`', 200, -1, FALSE, '`thawReFrozen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// thawAbserve
		$this->thawAbserve = new DbField('thaw', 'thaw', 'x_thawAbserve', 'thawAbserve', '`thawAbserve`', '`thawAbserve`', 200, -1, FALSE, '`thawAbserve`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->thawAbserve->Sortable = FALSE; // Allow sort
		$this->fields['thawAbserve'] = &$this->thawAbserve;

		// thawDiscard
		$this->thawDiscard = new DbField('thaw', 'thaw', 'x_thawDiscard', 'thawDiscard', '`thawDiscard`', '`thawDiscard`', 200, -1, FALSE, '`thawDiscard`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->thawDiscard->Sortable = FALSE; // Allow sort
		$this->fields['thawDiscard'] = &$this->thawDiscard;

		// vitrificationDate
		$this->vitrificationDate = new DbField('thaw', 'thaw', 'x_vitrificationDate', 'vitrificationDate', '`vitrificationDate`', CastDateFieldForLike('`vitrificationDate`', 0, "DB"), 135, 0, FALSE, '`vitrificationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PrimaryEmbryologist
		$this->PrimaryEmbryologist = new DbField('thaw', 'thaw', 'x_PrimaryEmbryologist', 'PrimaryEmbryologist', '`PrimaryEmbryologist`', '`PrimaryEmbryologist`', 200, -1, FALSE, '`PrimaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->SecondaryEmbryologist = new DbField('thaw', 'thaw', 'x_SecondaryEmbryologist', 'SecondaryEmbryologist', '`SecondaryEmbryologist`', '`SecondaryEmbryologist`', 200, -1, FALSE, '`SecondaryEmbryologist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SecondaryEmbryologist->Sortable = TRUE; // Allow sort
		$this->fields['SecondaryEmbryologist'] = &$this->SecondaryEmbryologist;

		// EmbryoNo
		$this->EmbryoNo = new DbField('thaw', 'thaw', 'x_EmbryoNo', 'EmbryoNo', '`EmbryoNo`', '`EmbryoNo`', 200, -1, FALSE, '`EmbryoNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmbryoNo->Sortable = FALSE; // Allow sort
		$this->fields['EmbryoNo'] = &$this->EmbryoNo;

		// FertilisationDate
		$this->FertilisationDate = new DbField('thaw', 'thaw', 'x_FertilisationDate', 'FertilisationDate', '`FertilisationDate`', CastDateFieldForLike('`FertilisationDate`', 0, "DB"), 135, 0, FALSE, '`FertilisationDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Day
		$this->Day = new DbField('thaw', 'thaw', 'x_Day', 'Day', '`Day`', '`Day`', 200, -1, FALSE, '`Day`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade
		$this->Grade = new DbField('thaw', 'thaw', 'x_Grade', 'Grade', '`Grade`', '`Grade`', 200, -1, FALSE, '`Grade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Incubator
		$this->Incubator = new DbField('thaw', 'thaw', 'x_Incubator', 'Incubator', '`Incubator`', '`Incubator`', 200, -1, FALSE, '`Incubator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Incubator->Sortable = FALSE; // Allow sort
		$this->fields['Incubator'] = &$this->Incubator;

		// Tank
		$this->Tank = new DbField('thaw', 'thaw', 'x_Tank', 'Tank', '`Tank`', '`Tank`', 200, -1, FALSE, '`Tank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tank->Sortable = TRUE; // Allow sort
		$this->fields['Tank'] = &$this->Tank;

		// Canister
		$this->Canister = new DbField('thaw', 'thaw', 'x_Canister', 'Canister', '`Canister`', '`Canister`', 200, -1, FALSE, '`Canister`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Canister->Sortable = TRUE; // Allow sort
		$this->fields['Canister'] = &$this->Canister;

		// Gobiet
		$this->Gobiet = new DbField('thaw', 'thaw', 'x_Gobiet', 'Gobiet', '`Gobiet`', '`Gobiet`', 200, -1, FALSE, '`Gobiet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gobiet->Sortable = TRUE; // Allow sort
		$this->fields['Gobiet'] = &$this->Gobiet;

		// CryolockNo
		$this->CryolockNo = new DbField('thaw', 'thaw', 'x_CryolockNo', 'CryolockNo', '`CryolockNo`', '`CryolockNo`', 200, -1, FALSE, '`CryolockNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CryolockNo->Sortable = TRUE; // Allow sort
		$this->fields['CryolockNo'] = &$this->CryolockNo;

		// CryolockColour
		$this->CryolockColour = new DbField('thaw', 'thaw', 'x_CryolockColour', 'CryolockColour', '`CryolockColour`', '`CryolockColour`', 200, -1, FALSE, '`CryolockColour`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CryolockColour->Sortable = TRUE; // Allow sort
		$this->fields['CryolockColour'] = &$this->CryolockColour;

		// Stage
		$this->Stage = new DbField('thaw', 'thaw', 'x_Stage', 'Stage', '`Stage`', '`Stage`', 200, -1, FALSE, '`Stage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("thawview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
