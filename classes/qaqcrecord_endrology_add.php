 ...
 * Page class
 */
class qaqcrecord_endrology_add extends qaqcrecord_endrology
{
	...
	// Page object name
	public $PageObjName = "qaqcrecord_endrology_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "qaqcrecord_endrologyview.php")
