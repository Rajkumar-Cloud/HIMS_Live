 ...
 * Page class
 */
class ivf_mas_user_template_edit extends ivf_mas_user_template
{
	...
	// Page object name
	public $PageObjName = "ivf_mas_user_template_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("ivf_mas_user_templatelist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "ivf_mas_user_templatelist.php")
