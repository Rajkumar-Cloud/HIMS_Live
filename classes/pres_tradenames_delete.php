 ...
 * Page class
 */
class pres_tradenames_delete extends pres_tradenames
{
	...
	// Page object name
	public $PageObjName = "pres_tradenames_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pres_tradenameslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pres_tradenameslist.php"); // Return to list
			}
		}
	}
