...
class patient_an_registration extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient_an_registration', 'patient_an_registration', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pid
		$this->pid = new DbField('patient_an_registration', 'patient_an_registration', 'x_pid', 'pid', '`pid`', '`pid`', 3, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// fid
		$this->fid = new DbField('patient_an_registration', 'patient_an_registration', 'x_fid', 'fid', '`fid`', '`fid`', 3, -1, FALSE, '`fid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// G
		$this->G = new DbField('patient_an_registration', 'patient_an_registration', 'x_G', 'G', '`G`', '`G`', 200, -1, FALSE, '`G`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->G->Sortable = TRUE; // Allow sort
		$this->fields['G'] = &$this->G;

		// P
		$this->P = new DbField('patient_an_registration', 'patient_an_registration', 'x_P', 'P', '`P`', '`P`', 200, -1, FALSE, '`P`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->P->Sortable = TRUE; // Allow sort
		$this->fields['P'] = &$this->P;

		// L
		$this->L = new DbField('patient_an_registration', 'patient_an_registration', 'x_L', 'L', '`L`', '`L`', 200, -1, FALSE, '`L`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->L->Sortable = TRUE; // Allow sort
		$this->fields['L'] = &$this->L;

		// A
		$this->A = new DbField('patient_an_registration', 'patient_an_registration', 'x_A', 'A', '`A`', '`A`', 200, -1, FALSE, '`A`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A->Sortable = TRUE; // Allow sort
		$this->fields['A'] = &$this->A;

		// E
		$this->E = new DbField('patient_an_registration', 'patient_an_registration', 'x_E', 'E', '`E`', '`E`', 200, -1, FALSE, '`E`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->E->Sortable = TRUE; // Allow sort
		$this->fields['E'] = &$this->E;

		// M
		$this->M = new DbField('patient_an_registration', 'patient_an_registration', 'x_M', 'M', '`M`', '`M`', 200, -1, FALSE, '`M`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->M->Sortable = TRUE; // Allow sort
		$this->fields['M'] = &$this->M;

		// LMP
		$this->LMP = new DbField('patient_an_registration', 'patient_an_registration', 'x_LMP', 'LMP', '`LMP`', '`LMP`', 200, 7, FALSE, '`LMP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LMP->Sortable = TRUE; // Allow sort
		$this->fields['LMP'] = &$this->LMP;

		// EDO
		$this->EDO = new DbField('patient_an_registration', 'patient_an_registration', 'x_EDO', 'EDO', '`EDO`', '`EDO`', 200, 7, FALSE, '`EDO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EDO->Sortable = TRUE; // Allow sort
		$this->fields['EDO'] = &$this->EDO;

		// MenstrualHistory
		$this->MenstrualHistory = new DbField('patient_an_registration', 'patient_an_registration', 'x_MenstrualHistory', 'MenstrualHistory', '`MenstrualHistory`', '`MenstrualHistory`', 200, -1, FALSE, '`MenstrualHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// MaritalHistory
		$this->MaritalHistory = new DbField('patient_an_registration', 'patient_an_registration', 'x_MaritalHistory', 'MaritalHistory', '`MaritalHistory`', '`MaritalHistory`', 200, -1, FALSE, '`MaritalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MaritalHistory->Sortable = TRUE; // Allow sort
		$this->fields['MaritalHistory'] = &$this->MaritalHistory;

		// ObstetricHistory
		$this->ObstetricHistory = new DbField('patient_an_registration', 'patient_an_registration', 'x_ObstetricHistory', 'ObstetricHistory', '`ObstetricHistory`', '`ObstetricHistory`', 200, -1, FALSE, '`ObstetricHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ObstetricHistory->Sortable = TRUE; // Allow sort
		$this->fields['ObstetricHistory'] = &$this->ObstetricHistory;

		// PreviousHistoryofGDM
		$this->PreviousHistoryofGDM = new DbField('patient_an_registration', 'patient_an_registration', 'x_PreviousHistoryofGDM', 'PreviousHistoryofGDM', '`PreviousHistoryofGDM`', '`PreviousHistoryofGDM`', 200, -1, FALSE, '`PreviousHistoryofGDM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PreviousHistorofPIH
		$this->PreviousHistorofPIH = new DbField('patient_an_registration', 'patient_an_registration', 'x_PreviousHistorofPIH', 'PreviousHistorofPIH', '`PreviousHistorofPIH`', '`PreviousHistorofPIH`', 200, -1, FALSE, '`PreviousHistorofPIH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->PreviousHistoryofIUGR = new DbField('patient_an_registration', 'patient_an_registration', 'x_PreviousHistoryofIUGR', 'PreviousHistoryofIUGR', '`PreviousHistoryofIUGR`', '`PreviousHistoryofIUGR`', 200, -1, FALSE, '`PreviousHistoryofIUGR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->PreviousHistoryofOligohydramnios = new DbField('patient_an_registration', 'patient_an_registration', 'x_PreviousHistoryofOligohydramnios', 'PreviousHistoryofOligohydramnios', '`PreviousHistoryofOligohydramnios`', '`PreviousHistoryofOligohydramnios`', 200, -1, FALSE, '`PreviousHistoryofOligohydramnios`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->PreviousHistoryofPreterm = new DbField('patient_an_registration', 'patient_an_registration', 'x_PreviousHistoryofPreterm', 'PreviousHistoryofPreterm', '`PreviousHistoryofPreterm`', '`PreviousHistoryofPreterm`', 200, -1, FALSE, '`PreviousHistoryofPreterm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// G1
		$this->G1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_G1', 'G1', '`G1`', '`G1`', 200, -1, FALSE, '`G1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->G1->Sortable = TRUE; // Allow sort
		$this->fields['G1'] = &$this->G1;

		// G2
		$this->G2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_G2', 'G2', '`G2`', '`G2`', 200, -1, FALSE, '`G2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->G2->Sortable = TRUE; // Allow sort
		$this->fields['G2'] = &$this->G2;

		// G3
		$this->G3 = new DbField('patient_an_registration', 'patient_an_registration', 'x_G3', 'G3', '`G3`', '`G3`', 200, -1, FALSE, '`G3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->G3->Sortable = TRUE; // Allow sort
		$this->fields['G3'] = &$this->G3;

		// DeliveryNDLSCS1
		$this->DeliveryNDLSCS1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_DeliveryNDLSCS1', 'DeliveryNDLSCS1', '`DeliveryNDLSCS1`', '`DeliveryNDLSCS1`', 200, -1, FALSE, '`DeliveryNDLSCS1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeliveryNDLSCS1->Sortable = TRUE; // Allow sort
		$this->fields['DeliveryNDLSCS1'] = &$this->DeliveryNDLSCS1;

		// DeliveryNDLSCS2
		$this->DeliveryNDLSCS2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_DeliveryNDLSCS2', 'DeliveryNDLSCS2', '`DeliveryNDLSCS2`', '`DeliveryNDLSCS2`', 200, -1, FALSE, '`DeliveryNDLSCS2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeliveryNDLSCS2->Sortable = TRUE; // Allow sort
		$this->fields['DeliveryNDLSCS2'] = &$this->DeliveryNDLSCS2;

		// DeliveryNDLSCS3
		$this->DeliveryNDLSCS3 = new DbField('patient_an_registration', 'patient_an_registration', 'x_DeliveryNDLSCS3', 'DeliveryNDLSCS3', '`DeliveryNDLSCS3`', '`DeliveryNDLSCS3`', 200, -1, FALSE, '`DeliveryNDLSCS3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeliveryNDLSCS3->Sortable = TRUE; // Allow sort
		$this->fields['DeliveryNDLSCS3'] = &$this->DeliveryNDLSCS3;

		// BabySexweight1
		$this->BabySexweight1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_BabySexweight1', 'BabySexweight1', '`BabySexweight1`', '`BabySexweight1`', 200, -1, FALSE, '`BabySexweight1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BabySexweight1->Sortable = TRUE; // Allow sort
		$this->fields['BabySexweight1'] = &$this->BabySexweight1;

		// BabySexweight2
		$this->BabySexweight2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_BabySexweight2', 'BabySexweight2', '`BabySexweight2`', '`BabySexweight2`', 200, -1, FALSE, '`BabySexweight2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BabySexweight2->Sortable = TRUE; // Allow sort
		$this->fields['BabySexweight2'] = &$this->BabySexweight2;

		// BabySexweight3
		$this->BabySexweight3 = new DbField('patient_an_registration', 'patient_an_registration', 'x_BabySexweight3', 'BabySexweight3', '`BabySexweight3`', '`BabySexweight3`', 200, -1, FALSE, '`BabySexweight3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BabySexweight3->Sortable = TRUE; // Allow sort
		$this->fields['BabySexweight3'] = &$this->BabySexweight3;

		// PastMedicalHistory
		$this->PastMedicalHistory = new DbField('patient_an_registration', 'patient_an_registration', 'x_PastMedicalHistory', 'PastMedicalHistory', '`PastMedicalHistory`', '`PastMedicalHistory`', 200, -1, FALSE, '`PastMedicalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// PastSurgicalHistory
		$this->PastSurgicalHistory = new DbField('patient_an_registration', 'patient_an_registration', 'x_PastSurgicalHistory', 'PastSurgicalHistory', '`PastSurgicalHistory`', '`PastSurgicalHistory`', 200, -1, FALSE, '`PastSurgicalHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// FamilyHistory
		$this->FamilyHistory = new DbField('patient_an_registration', 'patient_an_registration', 'x_FamilyHistory', 'FamilyHistory', '`FamilyHistory`', '`FamilyHistory`', 200, -1, FALSE, '`FamilyHistory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Viability
		$this->Viability = new DbField('patient_an_registration', 'patient_an_registration', 'x_Viability', 'Viability', '`Viability`', '`Viability`', 200, -1, FALSE, '`Viability`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Viability->Sortable = TRUE; // Allow sort
		$this->fields['Viability'] = &$this->Viability;

		// ViabilityDATE
		$this->ViabilityDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_ViabilityDATE', 'ViabilityDATE', '`ViabilityDATE`', '`ViabilityDATE`', 200, 7, FALSE, '`ViabilityDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ViabilityDATE->Sortable = TRUE; // Allow sort
		$this->fields['ViabilityDATE'] = &$this->ViabilityDATE;

		// ViabilityREPORT
		$this->ViabilityREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_ViabilityREPORT', 'ViabilityREPORT', '`ViabilityREPORT`', '`ViabilityREPORT`', 201, -1, FALSE, '`ViabilityREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ViabilityREPORT->Sortable = TRUE; // Allow sort
		$this->fields['ViabilityREPORT'] = &$this->ViabilityREPORT;

		// Viability2
		$this->Viability2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Viability2', 'Viability2', '`Viability2`', '`Viability2`', 200, -1, FALSE, '`Viability2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Viability2->Sortable = TRUE; // Allow sort
		$this->fields['Viability2'] = &$this->Viability2;

		// Viability2DATE
		$this->Viability2DATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_Viability2DATE', 'Viability2DATE', '`Viability2DATE`', '`Viability2DATE`', 200, 7, FALSE, '`Viability2DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Viability2DATE->Sortable = TRUE; // Allow sort
		$this->fields['Viability2DATE'] = &$this->Viability2DATE;

		// Viability2REPORT
		$this->Viability2REPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_Viability2REPORT', 'Viability2REPORT', '`Viability2REPORT`', '`Viability2REPORT`', 201, -1, FALSE, '`Viability2REPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Viability2REPORT->Sortable = TRUE; // Allow sort
		$this->fields['Viability2REPORT'] = &$this->Viability2REPORT;

		// NTscan
		$this->NTscan = new DbField('patient_an_registration', 'patient_an_registration', 'x_NTscan', 'NTscan', '`NTscan`', '`NTscan`', 200, -1, FALSE, '`NTscan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NTscan->Sortable = TRUE; // Allow sort
		$this->fields['NTscan'] = &$this->NTscan;

		// NTscanDATE
		$this->NTscanDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_NTscanDATE', 'NTscanDATE', '`NTscanDATE`', '`NTscanDATE`', 200, 7, FALSE, '`NTscanDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NTscanDATE->Sortable = TRUE; // Allow sort
		$this->fields['NTscanDATE'] = &$this->NTscanDATE;

		// NTscanREPORT
		$this->NTscanREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_NTscanREPORT', 'NTscanREPORT', '`NTscanREPORT`', '`NTscanREPORT`', 201, -1, FALSE, '`NTscanREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NTscanREPORT->Sortable = TRUE; // Allow sort
		$this->fields['NTscanREPORT'] = &$this->NTscanREPORT;

		// EarlyTarget
		$this->EarlyTarget = new DbField('patient_an_registration', 'patient_an_registration', 'x_EarlyTarget', 'EarlyTarget', '`EarlyTarget`', '`EarlyTarget`', 200, -1, FALSE, '`EarlyTarget`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EarlyTarget->Sortable = TRUE; // Allow sort
		$this->fields['EarlyTarget'] = &$this->EarlyTarget;

		// EarlyTargetDATE
		$this->EarlyTargetDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_EarlyTargetDATE', 'EarlyTargetDATE', '`EarlyTargetDATE`', '`EarlyTargetDATE`', 200, 7, FALSE, '`EarlyTargetDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EarlyTargetDATE->Sortable = TRUE; // Allow sort
		$this->fields['EarlyTargetDATE'] = &$this->EarlyTargetDATE;

		// EarlyTargetREPORT
		$this->EarlyTargetREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_EarlyTargetREPORT', 'EarlyTargetREPORT', '`EarlyTargetREPORT`', '`EarlyTargetREPORT`', 201, -1, FALSE, '`EarlyTargetREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EarlyTargetREPORT->Sortable = TRUE; // Allow sort
		$this->fields['EarlyTargetREPORT'] = &$this->EarlyTargetREPORT;

		// Anomaly
		$this->Anomaly = new DbField('patient_an_registration', 'patient_an_registration', 'x_Anomaly', 'Anomaly', '`Anomaly`', '`Anomaly`', 200, -1, FALSE, '`Anomaly`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Anomaly->Sortable = TRUE; // Allow sort
		$this->fields['Anomaly'] = &$this->Anomaly;

		// AnomalyDATE
		$this->AnomalyDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_AnomalyDATE', 'AnomalyDATE', '`AnomalyDATE`', '`AnomalyDATE`', 200, 7, FALSE, '`AnomalyDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AnomalyDATE->Sortable = TRUE; // Allow sort
		$this->fields['AnomalyDATE'] = &$this->AnomalyDATE;

		// AnomalyREPORT
		$this->AnomalyREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_AnomalyREPORT', 'AnomalyREPORT', '`AnomalyREPORT`', '`AnomalyREPORT`', 201, -1, FALSE, '`AnomalyREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AnomalyREPORT->Sortable = TRUE; // Allow sort
		$this->fields['AnomalyREPORT'] = &$this->AnomalyREPORT;

		// Growth
		$this->Growth = new DbField('patient_an_registration', 'patient_an_registration', 'x_Growth', 'Growth', '`Growth`', '`Growth`', 200, -1, FALSE, '`Growth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Growth->Sortable = TRUE; // Allow sort
		$this->fields['Growth'] = &$this->Growth;

		// GrowthDATE
		$this->GrowthDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_GrowthDATE', 'GrowthDATE', '`GrowthDATE`', '`GrowthDATE`', 200, 7, FALSE, '`GrowthDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GrowthDATE->Sortable = TRUE; // Allow sort
		$this->fields['GrowthDATE'] = &$this->GrowthDATE;

		// GrowthREPORT
		$this->GrowthREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_GrowthREPORT', 'GrowthREPORT', '`GrowthREPORT`', '`GrowthREPORT`', 201, -1, FALSE, '`GrowthREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GrowthREPORT->Sortable = TRUE; // Allow sort
		$this->fields['GrowthREPORT'] = &$this->GrowthREPORT;

		// Growth1
		$this->Growth1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Growth1', 'Growth1', '`Growth1`', '`Growth1`', 200, -1, FALSE, '`Growth1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Growth1->Sortable = TRUE; // Allow sort
		$this->fields['Growth1'] = &$this->Growth1;

		// Growth1DATE
		$this->Growth1DATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_Growth1DATE', 'Growth1DATE', '`Growth1DATE`', '`Growth1DATE`', 200, 7, FALSE, '`Growth1DATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Growth1DATE->Sortable = TRUE; // Allow sort
		$this->fields['Growth1DATE'] = &$this->Growth1DATE;

		// Growth1REPORT
		$this->Growth1REPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_Growth1REPORT', 'Growth1REPORT', '`Growth1REPORT`', '`Growth1REPORT`', 201, -1, FALSE, '`Growth1REPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Growth1REPORT->Sortable = TRUE; // Allow sort
		$this->fields['Growth1REPORT'] = &$this->Growth1REPORT;

		// ANProfile
		$this->ANProfile = new DbField('patient_an_registration', 'patient_an_registration', 'x_ANProfile', 'ANProfile', '`ANProfile`', '`ANProfile`', 200, -1, FALSE, '`ANProfile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANProfile->Sortable = TRUE; // Allow sort
		$this->fields['ANProfile'] = &$this->ANProfile;

		// ANProfileDATE
		$this->ANProfileDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_ANProfileDATE', 'ANProfileDATE', '`ANProfileDATE`', '`ANProfileDATE`', 200, 7, FALSE, '`ANProfileDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANProfileDATE->Sortable = TRUE; // Allow sort
		$this->fields['ANProfileDATE'] = &$this->ANProfileDATE;

		// ANProfileINHOUSE
		$this->ANProfileINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_ANProfileINHOUSE', 'ANProfileINHOUSE', '`ANProfileINHOUSE`', '`ANProfileINHOUSE`', 200, -1, FALSE, '`ANProfileINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANProfileINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['ANProfileINHOUSE'] = &$this->ANProfileINHOUSE;

		// ANProfileREPORT
		$this->ANProfileREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_ANProfileREPORT', 'ANProfileREPORT', '`ANProfileREPORT`', '`ANProfileREPORT`', 201, -1, FALSE, '`ANProfileREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANProfileREPORT->Sortable = TRUE; // Allow sort
		$this->fields['ANProfileREPORT'] = &$this->ANProfileREPORT;

		// DualMarker
		$this->DualMarker = new DbField('patient_an_registration', 'patient_an_registration', 'x_DualMarker', 'DualMarker', '`DualMarker`', '`DualMarker`', 200, -1, FALSE, '`DualMarker`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DualMarker->Sortable = TRUE; // Allow sort
		$this->fields['DualMarker'] = &$this->DualMarker;

		// DualMarkerDATE
		$this->DualMarkerDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_DualMarkerDATE', 'DualMarkerDATE', '`DualMarkerDATE`', '`DualMarkerDATE`', 200, 7, FALSE, '`DualMarkerDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DualMarkerDATE->Sortable = TRUE; // Allow sort
		$this->fields['DualMarkerDATE'] = &$this->DualMarkerDATE;

		// DualMarkerINHOUSE
		$this->DualMarkerINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_DualMarkerINHOUSE', 'DualMarkerINHOUSE', '`DualMarkerINHOUSE`', '`DualMarkerINHOUSE`', 200, -1, FALSE, '`DualMarkerINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DualMarkerINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['DualMarkerINHOUSE'] = &$this->DualMarkerINHOUSE;

		// DualMarkerREPORT
		$this->DualMarkerREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_DualMarkerREPORT', 'DualMarkerREPORT', '`DualMarkerREPORT`', '`DualMarkerREPORT`', 201, -1, FALSE, '`DualMarkerREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DualMarkerREPORT->Sortable = TRUE; // Allow sort
		$this->fields['DualMarkerREPORT'] = &$this->DualMarkerREPORT;

		// Quadruple
		$this->Quadruple = new DbField('patient_an_registration', 'patient_an_registration', 'x_Quadruple', 'Quadruple', '`Quadruple`', '`Quadruple`', 200, -1, FALSE, '`Quadruple`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quadruple->Sortable = TRUE; // Allow sort
		$this->fields['Quadruple'] = &$this->Quadruple;

		// QuadrupleDATE
		$this->QuadrupleDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_QuadrupleDATE', 'QuadrupleDATE', '`QuadrupleDATE`', '`QuadrupleDATE`', 200, 7, FALSE, '`QuadrupleDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QuadrupleDATE->Sortable = TRUE; // Allow sort
		$this->fields['QuadrupleDATE'] = &$this->QuadrupleDATE;

		// QuadrupleINHOUSE
		$this->QuadrupleINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_QuadrupleINHOUSE', 'QuadrupleINHOUSE', '`QuadrupleINHOUSE`', '`QuadrupleINHOUSE`', 200, -1, FALSE, '`QuadrupleINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QuadrupleINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['QuadrupleINHOUSE'] = &$this->QuadrupleINHOUSE;

		// QuadrupleREPORT
		$this->QuadrupleREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_QuadrupleREPORT', 'QuadrupleREPORT', '`QuadrupleREPORT`', '`QuadrupleREPORT`', 201, -1, FALSE, '`QuadrupleREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->QuadrupleREPORT->Sortable = TRUE; // Allow sort
		$this->fields['QuadrupleREPORT'] = &$this->QuadrupleREPORT;

		// A5month
		$this->A5month = new DbField('patient_an_registration', 'patient_an_registration', 'x_A5month', 'A5month', '`A5month`', '`A5month`', 200, -1, FALSE, '`A5month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A5month->Sortable = TRUE; // Allow sort
		$this->fields['A5month'] = &$this->A5month;

		// A5monthDATE
		$this->A5monthDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_A5monthDATE', 'A5monthDATE', '`A5monthDATE`', '`A5monthDATE`', 200, 7, FALSE, '`A5monthDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A5monthDATE->Sortable = TRUE; // Allow sort
		$this->fields['A5monthDATE'] = &$this->A5monthDATE;

		// A5monthINHOUSE
		$this->A5monthINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_A5monthINHOUSE', 'A5monthINHOUSE', '`A5monthINHOUSE`', '`A5monthINHOUSE`', 200, -1, FALSE, '`A5monthINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A5monthINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['A5monthINHOUSE'] = &$this->A5monthINHOUSE;

		// A5monthREPORT
		$this->A5monthREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_A5monthREPORT', 'A5monthREPORT', '`A5monthREPORT`', '`A5monthREPORT`', 201, -1, FALSE, '`A5monthREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A5monthREPORT->Sortable = TRUE; // Allow sort
		$this->fields['A5monthREPORT'] = &$this->A5monthREPORT;

		// A7month
		$this->A7month = new DbField('patient_an_registration', 'patient_an_registration', 'x_A7month', 'A7month', '`A7month`', '`A7month`', 200, -1, FALSE, '`A7month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A7month->Sortable = TRUE; // Allow sort
		$this->fields['A7month'] = &$this->A7month;

		// A7monthDATE
		$this->A7monthDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_A7monthDATE', 'A7monthDATE', '`A7monthDATE`', '`A7monthDATE`', 200, 7, FALSE, '`A7monthDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A7monthDATE->Sortable = TRUE; // Allow sort
		$this->fields['A7monthDATE'] = &$this->A7monthDATE;

		// A7monthINHOUSE
		$this->A7monthINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_A7monthINHOUSE', 'A7monthINHOUSE', '`A7monthINHOUSE`', '`A7monthINHOUSE`', 200, -1, FALSE, '`A7monthINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A7monthINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['A7monthINHOUSE'] = &$this->A7monthINHOUSE;

		// A7monthREPORT
		$this->A7monthREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_A7monthREPORT', 'A7monthREPORT', '`A7monthREPORT`', '`A7monthREPORT`', 201, -1, FALSE, '`A7monthREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A7monthREPORT->Sortable = TRUE; // Allow sort
		$this->fields['A7monthREPORT'] = &$this->A7monthREPORT;

		// A9month
		$this->A9month = new DbField('patient_an_registration', 'patient_an_registration', 'x_A9month', 'A9month', '`A9month`', '`A9month`', 200, -1, FALSE, '`A9month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A9month->Sortable = TRUE; // Allow sort
		$this->fields['A9month'] = &$this->A9month;

		// A9monthDATE
		$this->A9monthDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_A9monthDATE', 'A9monthDATE', '`A9monthDATE`', '`A9monthDATE`', 200, 7, FALSE, '`A9monthDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A9monthDATE->Sortable = TRUE; // Allow sort
		$this->fields['A9monthDATE'] = &$this->A9monthDATE;

		// A9monthINHOUSE
		$this->A9monthINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_A9monthINHOUSE', 'A9monthINHOUSE', '`A9monthINHOUSE`', '`A9monthINHOUSE`', 200, -1, FALSE, '`A9monthINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A9monthINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['A9monthINHOUSE'] = &$this->A9monthINHOUSE;

		// A9monthREPORT
		$this->A9monthREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_A9monthREPORT', 'A9monthREPORT', '`A9monthREPORT`', '`A9monthREPORT`', 201, -1, FALSE, '`A9monthREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->A9monthREPORT->Sortable = TRUE; // Allow sort
		$this->fields['A9monthREPORT'] = &$this->A9monthREPORT;

		// INJ
		$this->INJ = new DbField('patient_an_registration', 'patient_an_registration', 'x_INJ', 'INJ', '`INJ`', '`INJ`', 200, -1, FALSE, '`INJ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->INJ->Sortable = TRUE; // Allow sort
		$this->fields['INJ'] = &$this->INJ;

		// INJDATE
		$this->INJDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_INJDATE', 'INJDATE', '`INJDATE`', '`INJDATE`', 200, 7, FALSE, '`INJDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->INJDATE->Sortable = TRUE; // Allow sort
		$this->fields['INJDATE'] = &$this->INJDATE;

		// INJINHOUSE
		$this->INJINHOUSE = new DbField('patient_an_registration', 'patient_an_registration', 'x_INJINHOUSE', 'INJINHOUSE', '`INJINHOUSE`', '`INJINHOUSE`', 200, -1, FALSE, '`INJINHOUSE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->INJINHOUSE->Sortable = TRUE; // Allow sort
		$this->fields['INJINHOUSE'] = &$this->INJINHOUSE;

		// INJREPORT
		$this->INJREPORT = new DbField('patient_an_registration', 'patient_an_registration', 'x_INJREPORT', 'INJREPORT', '`INJREPORT`', '`INJREPORT`', 201, -1, FALSE, '`INJREPORT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->INJREPORT->Sortable = TRUE; // Allow sort
		$this->fields['INJREPORT'] = &$this->INJREPORT;

		// Bleeding
		$this->Bleeding = new DbField('patient_an_registration', 'patient_an_registration', 'x_Bleeding', 'Bleeding', '`Bleeding`', '`Bleeding`', 200, -1, FALSE, '`Bleeding`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Hypothyroidism
		$this->Hypothyroidism = new DbField('patient_an_registration', 'patient_an_registration', 'x_Hypothyroidism', 'Hypothyroidism', '`Hypothyroidism`', '`Hypothyroidism`', 200, -1, FALSE, '`Hypothyroidism`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Hypothyroidism->Sortable = TRUE; // Allow sort
		$this->fields['Hypothyroidism'] = &$this->Hypothyroidism;

		// PICMENumber
		$this->PICMENumber = new DbField('patient_an_registration', 'patient_an_registration', 'x_PICMENumber', 'PICMENumber', '`PICMENumber`', '`PICMENumber`', 200, -1, FALSE, '`PICMENumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PICMENumber->Sortable = TRUE; // Allow sort
		$this->fields['PICMENumber'] = &$this->PICMENumber;

		// Outcome
		$this->Outcome = new DbField('patient_an_registration', 'patient_an_registration', 'x_Outcome', 'Outcome', '`Outcome`', '`Outcome`', 200, -1, FALSE, '`Outcome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Outcome->Sortable = TRUE; // Allow sort
		$this->fields['Outcome'] = &$this->Outcome;

		// DateofAdmission
		$this->DateofAdmission = new DbField('patient_an_registration', 'patient_an_registration', 'x_DateofAdmission', 'DateofAdmission', '`DateofAdmission`', '`DateofAdmission`', 200, 7, FALSE, '`DateofAdmission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DateofAdmission->Sortable = TRUE; // Allow sort
		$this->fields['DateofAdmission'] = &$this->DateofAdmission;

		// DateodProcedure
		$this->DateodProcedure = new DbField('patient_an_registration', 'patient_an_registration', 'x_DateodProcedure', 'DateodProcedure', '`DateodProcedure`', '`DateodProcedure`', 200, 7, FALSE, '`DateodProcedure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DateodProcedure->Sortable = TRUE; // Allow sort
		$this->fields['DateodProcedure'] = &$this->DateodProcedure;

		// Miscarriage
		$this->Miscarriage = new DbField('patient_an_registration', 'patient_an_registration', 'x_Miscarriage', 'Miscarriage', '`Miscarriage`', '`Miscarriage`', 200, -1, FALSE, '`Miscarriage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ModeOfDelivery
		$this->ModeOfDelivery = new DbField('patient_an_registration', 'patient_an_registration', 'x_ModeOfDelivery', 'ModeOfDelivery', '`ModeOfDelivery`', '`ModeOfDelivery`', 200, -1, FALSE, '`ModeOfDelivery`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ND
		$this->ND = new DbField('patient_an_registration', 'patient_an_registration', 'x_ND', 'ND', '`ND`', '`ND`', 200, -1, FALSE, '`ND`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ND->Sortable = TRUE; // Allow sort
		$this->fields['ND'] = &$this->ND;

		// NDS
		$this->NDS = new DbField('patient_an_registration', 'patient_an_registration', 'x_NDS', 'NDS', '`NDS`', '`NDS`', 200, -1, FALSE, '`NDS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NDP
		$this->NDP = new DbField('patient_an_registration', 'patient_an_registration', 'x_NDP', 'NDP', '`NDP`', '`NDP`', 200, -1, FALSE, '`NDP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Vaccum
		$this->Vaccum = new DbField('patient_an_registration', 'patient_an_registration', 'x_Vaccum', 'Vaccum', '`Vaccum`', '`Vaccum`', 200, -1, FALSE, '`Vaccum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Vaccum->Sortable = TRUE; // Allow sort
		$this->fields['Vaccum'] = &$this->Vaccum;

		// VaccumS
		$this->VaccumS = new DbField('patient_an_registration', 'patient_an_registration', 'x_VaccumS', 'VaccumS', '`VaccumS`', '`VaccumS`', 200, -1, FALSE, '`VaccumS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// VaccumP
		$this->VaccumP = new DbField('patient_an_registration', 'patient_an_registration', 'x_VaccumP', 'VaccumP', '`VaccumP`', '`VaccumP`', 200, -1, FALSE, '`VaccumP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Forceps
		$this->Forceps = new DbField('patient_an_registration', 'patient_an_registration', 'x_Forceps', 'Forceps', '`Forceps`', '`Forceps`', 200, -1, FALSE, '`Forceps`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Forceps->Sortable = TRUE; // Allow sort
		$this->fields['Forceps'] = &$this->Forceps;

		// ForcepsS
		$this->ForcepsS = new DbField('patient_an_registration', 'patient_an_registration', 'x_ForcepsS', 'ForcepsS', '`ForcepsS`', '`ForcepsS`', 200, -1, FALSE, '`ForcepsS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ForcepsP
		$this->ForcepsP = new DbField('patient_an_registration', 'patient_an_registration', 'x_ForcepsP', 'ForcepsP', '`ForcepsP`', '`ForcepsP`', 200, -1, FALSE, '`ForcepsP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Elective
		$this->Elective = new DbField('patient_an_registration', 'patient_an_registration', 'x_Elective', 'Elective', '`Elective`', '`Elective`', 200, -1, FALSE, '`Elective`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Elective->Sortable = TRUE; // Allow sort
		$this->fields['Elective'] = &$this->Elective;

		// ElectiveS
		$this->ElectiveS = new DbField('patient_an_registration', 'patient_an_registration', 'x_ElectiveS', 'ElectiveS', '`ElectiveS`', '`ElectiveS`', 200, -1, FALSE, '`ElectiveS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ElectiveP
		$this->ElectiveP = new DbField('patient_an_registration', 'patient_an_registration', 'x_ElectiveP', 'ElectiveP', '`ElectiveP`', '`ElectiveP`', 200, -1, FALSE, '`ElectiveP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Emergency
		$this->Emergency = new DbField('patient_an_registration', 'patient_an_registration', 'x_Emergency', 'Emergency', '`Emergency`', '`Emergency`', 200, -1, FALSE, '`Emergency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Emergency->Sortable = TRUE; // Allow sort
		$this->fields['Emergency'] = &$this->Emergency;

		// EmergencyS
		$this->EmergencyS = new DbField('patient_an_registration', 'patient_an_registration', 'x_EmergencyS', 'EmergencyS', '`EmergencyS`', '`EmergencyS`', 200, -1, FALSE, '`EmergencyS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// EmergencyP
		$this->EmergencyP = new DbField('patient_an_registration', 'patient_an_registration', 'x_EmergencyP', 'EmergencyP', '`EmergencyP`', '`EmergencyP`', 200, -1, FALSE, '`EmergencyP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Maturity
		$this->Maturity = new DbField('patient_an_registration', 'patient_an_registration', 'x_Maturity', 'Maturity', '`Maturity`', '`Maturity`', 200, -1, FALSE, '`Maturity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Baby1
		$this->Baby1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Baby1', 'Baby1', '`Baby1`', '`Baby1`', 200, -1, FALSE, '`Baby1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Baby1->Sortable = TRUE; // Allow sort
		$this->fields['Baby1'] = &$this->Baby1;

		// Baby2
		$this->Baby2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Baby2', 'Baby2', '`Baby2`', '`Baby2`', 200, -1, FALSE, '`Baby2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Baby2->Sortable = TRUE; // Allow sort
		$this->fields['Baby2'] = &$this->Baby2;

		// sex1
		$this->sex1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_sex1', 'sex1', '`sex1`', '`sex1`', 200, -1, FALSE, '`sex1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sex1->Sortable = TRUE; // Allow sort
		$this->fields['sex1'] = &$this->sex1;

		// sex2
		$this->sex2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_sex2', 'sex2', '`sex2`', '`sex2`', 200, -1, FALSE, '`sex2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sex2->Sortable = TRUE; // Allow sort
		$this->fields['sex2'] = &$this->sex2;

		// weight1
		$this->weight1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_weight1', 'weight1', '`weight1`', '`weight1`', 200, -1, FALSE, '`weight1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->weight1->Sortable = TRUE; // Allow sort
		$this->fields['weight1'] = &$this->weight1;

		// weight2
		$this->weight2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_weight2', 'weight2', '`weight2`', '`weight2`', 200, -1, FALSE, '`weight2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->weight2->Sortable = TRUE; // Allow sort
		$this->fields['weight2'] = &$this->weight2;

		// NICU1
		$this->NICU1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_NICU1', 'NICU1', '`NICU1`', '`NICU1`', 200, -1, FALSE, '`NICU1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NICU1->Sortable = TRUE; // Allow sort
		$this->fields['NICU1'] = &$this->NICU1;

		// NICU2
		$this->NICU2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_NICU2', 'NICU2', '`NICU2`', '`NICU2`', 200, -1, FALSE, '`NICU2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NICU2->Sortable = TRUE; // Allow sort
		$this->fields['NICU2'] = &$this->NICU2;

		// Jaundice1
		$this->Jaundice1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Jaundice1', 'Jaundice1', '`Jaundice1`', '`Jaundice1`', 200, -1, FALSE, '`Jaundice1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Jaundice1->Sortable = TRUE; // Allow sort
		$this->fields['Jaundice1'] = &$this->Jaundice1;

		// Jaundice2
		$this->Jaundice2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Jaundice2', 'Jaundice2', '`Jaundice2`', '`Jaundice2`', 200, -1, FALSE, '`Jaundice2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Jaundice2->Sortable = TRUE; // Allow sort
		$this->fields['Jaundice2'] = &$this->Jaundice2;

		// Others1
		$this->Others1 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Others1', 'Others1', '`Others1`', '`Others1`', 200, -1, FALSE, '`Others1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others1->Sortable = TRUE; // Allow sort
		$this->fields['Others1'] = &$this->Others1;

		// Others2
		$this->Others2 = new DbField('patient_an_registration', 'patient_an_registration', 'x_Others2', 'Others2', '`Others2`', '`Others2`', 200, -1, FALSE, '`Others2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others2->Sortable = TRUE; // Allow sort
		$this->fields['Others2'] = &$this->Others2;

		// SpillOverReasons
		$this->SpillOverReasons = new DbField('patient_an_registration', 'patient_an_registration', 'x_SpillOverReasons', 'SpillOverReasons', '`SpillOverReasons`', '`SpillOverReasons`', 200, -1, FALSE, '`SpillOverReasons`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ANClosed
		$this->ANClosed = new DbField('patient_an_registration', 'patient_an_registration', 'x_ANClosed', 'ANClosed', '`ANClosed`', '`ANClosed`', 200, -1, FALSE, '`ANClosed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// ANClosedDATE
		$this->ANClosedDATE = new DbField('patient_an_registration', 'patient_an_registration', 'x_ANClosedDATE', 'ANClosedDATE', '`ANClosedDATE`', '`ANClosedDATE`', 200, 7, FALSE, '`ANClosedDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ANClosedDATE->Sortable = TRUE; // Allow sort
		$this->fields['ANClosedDATE'] = &$this->ANClosedDATE;

		// PastMedicalHistoryOthers
		$this->PastMedicalHistoryOthers = new DbField('patient_an_registration', 'patient_an_registration', 'x_PastMedicalHistoryOthers', 'PastMedicalHistoryOthers', '`PastMedicalHistoryOthers`', '`PastMedicalHistoryOthers`', 200, -1, FALSE, '`PastMedicalHistoryOthers`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->PastSurgicalHistoryOthers = new DbField('patient_an_registration', 'patient_an_registration', 'x_PastSurgicalHistoryOthers', 'PastSurgicalHistoryOthers', '`PastSurgicalHistoryOthers`', '`PastSurgicalHistoryOthers`', 200, -1, FALSE, '`PastSurgicalHistoryOthers`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FamilyHistoryOthers
		$this->FamilyHistoryOthers = new DbField('patient_an_registration', 'patient_an_registration', 'x_FamilyHistoryOthers', 'FamilyHistoryOthers', '`FamilyHistoryOthers`', '`FamilyHistoryOthers`', 200, -1, FALSE, '`FamilyHistoryOthers`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ETdate
		$this->ETdate = new DbField('patient_an_registration', 'patient_an_registration', 'x_ETdate', 'ETdate', '`ETdate`', '`ETdate`', 200, 0, FALSE, '`ETdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "patient_opd_follow_up") {
			if ($this->pid->getSessionValue() <> "")
				$masterFilter .= "`PatientId`=" . QuotedValue($this->pid->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->fid->getSessionValue() <> "")
				$masterFilter .= " AND `id`=" . QuotedValue($this->fid->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "patient_opd_follow_up") {
			if ($this->pid->getSessionValue() <> "")
				...
				return "";
			if ($this->fid->getSessionValue() <> "")
				$detailFilter .= " AND `fid`=" . QuotedValue($this->fid->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patient_an_registrationview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($this->getCurrentMasterTable() == "patient_opd_follow_up" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
