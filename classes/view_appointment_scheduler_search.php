...
class view_appointment_scheduler_search extends view_appointment_scheduler
{
	...
	protected function loadSearchValues()
	{
		...
		// PatientType
		if (!$this->isAddOrEdit())
			$this->PatientType->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PatientType"));
		$this->PatientType->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PatientType"));

		// Referal
		if (!$this->isAddOrEdit())
			$this->Referal->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Referal"));
		$this->Referal->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Referal"));

		// start_date
		if (!$this->isAddOrEdit())
			$this->start_date->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_start_date"));
		$this->start_date->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_start_date"));

		// DoctorName
		if (!$this->isAddOrEdit())
			$this->DoctorName->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DoctorName"));
		$this->DoctorName->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DoctorName"));
		...
		// DoctorID
		if (!$this->isAddOrEdit())
			$this->DoctorID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DoctorID"));
		$this->DoctorID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DoctorID"));

		// DoctorCode
		if (!$this->isAddOrEdit())
			$this->DoctorCode->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DoctorCode"));
		$this->DoctorCode->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DoctorCode"));
		...
		// AppointmentStatus
		if (!$this->isAddOrEdit())
			$this->AppointmentStatus->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_AppointmentStatus"));
		$this->AppointmentStatus->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_AppointmentStatus"));
		...
		// scheduler_id
		if (!$this->isAddOrEdit())
			$this->scheduler_id->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_scheduler_id"));
		$this->scheduler_id->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_scheduler_id"));

		// text
		if (!$this->isAddOrEdit())
			$this->text->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_text"));
		$this->text->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_text"));

		// appointment_status
		if (!$this->isAddOrEdit())
			$this->appointment_status->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_appointment_status"));
		$this->appointment_status->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_appointment_status"));
		...
		// SchEmail
		if (!$this->isAddOrEdit())
			$this->SchEmail->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SchEmail"));
		$this->SchEmail->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SchEmail"));

		// appointment_type
		if (!$this->isAddOrEdit())
			$this->appointment_type->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_appointment_type"));
		$this->appointment_type->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_appointment_type"));

		// Notified
		if (!$this->isAddOrEdit())
			$this->Notified->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Notified"));
		$this->Notified->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Notified"));
		...
		// paymentType
		if (!$this->isAddOrEdit())
			$this->paymentType->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_paymentType"));
		$this->paymentType->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_paymentType"));
		...
		// PatientTypee
		if (!$this->isAddOrEdit())
			$this->PatientTypee->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PatientTypee"));
		$this->PatientTypee->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PatientTypee"));
	}
