 ...
 */
class hr_courses extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('hr_courses', 'hr_courses', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// code
		$this->code = new DbField('hr_courses', 'hr_courses', 'x_code', 'code', '`code`', '`code`', 201, -1, FALSE, '`code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// name
		$this->name = new DbField('hr_courses', 'hr_courses', 'x_name', 'name', '`name`', '`name`', 201, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// description
		$this->description = new DbField('hr_courses', 'hr_courses', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// coordinator
		$this->coordinator = new DbField('hr_courses', 'hr_courses', 'x_coordinator', 'coordinator', '`coordinator`', '`coordinator`', 3, -1, FALSE, '`coordinator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// trainer
		$this->trainer = new DbField('hr_courses', 'hr_courses', 'x_trainer', 'trainer', '`trainer`', '`trainer`', 201, -1, FALSE, '`trainer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->trainer->Sortable = TRUE; // Allow sort
		$this->fields['trainer'] = &$this->trainer;

		// trainer_info
		$this->trainer_info = new DbField('hr_courses', 'hr_courses', 'x_trainer_info', 'trainer_info', '`trainer_info`', '`trainer_info`', 201, -1, FALSE, '`trainer_info`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->trainer_info->Sortable = TRUE; // Allow sort
		$this->fields['trainer_info'] = &$this->trainer_info;

		// paymentType
		$this->paymentType = new DbField('hr_courses', 'hr_courses', 'x_paymentType', 'paymentType', '`paymentType`', '`paymentType`', 202, -1, FALSE, '`paymentType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// currency
		$this->currency = new DbField('hr_courses', 'hr_courses', 'x_currency', 'currency', '`currency`', '`currency`', 200, -1, FALSE, '`currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->currency->Sortable = TRUE; // Allow sort
		$this->fields['currency'] = &$this->currency;

		// cost
		$this->cost = new DbField('hr_courses', 'hr_courses', 'x_cost', 'cost', '`cost`', '`cost`', 131, -1, FALSE, '`cost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cost->Sortable = TRUE; // Allow sort
		$this->cost->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['cost'] = &$this->cost;

		// status
		$this->status = new DbField('hr_courses', 'hr_courses', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// created
		$this->created = new DbField('hr_courses', 'hr_courses', 'x_created', 'created', '`created`', CastDateFieldForLike('`created`', 0, "DB"), 135, 0, FALSE, '`created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated
		$this->updated = new DbField('hr_courses', 'hr_courses', 'x_updated', 'updated', '`updated`', CastDateFieldForLike('`updated`', 0, "DB"), 135, 0, FALSE, '`updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "hr_coursesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "hr_coursesadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("hr_coursesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("hr_coursesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "hr_coursesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "hr_coursesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("hr_coursesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("hr_coursesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("hr_coursesdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->coordinator->setDbValue($rs->fields('coordinator'));
		$this->trainer->setDbValue($rs->fields('trainer'));
		$this->trainer_info->setDbValue($rs->fields('trainer_info'));
