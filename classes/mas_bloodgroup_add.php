 ...
 * Page class
 */
class mas_bloodgroup_add extends mas_bloodgroup
{
	...
	// Page object name
	public $PageObjName = "mas_bloodgroup_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("mas_bloodgrouplist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "mas_bloodgrouplist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "mas_bloodgroupview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// BloodGroup
		$this->BloodGroup->setDbValueDef($rsnew, $this->BloodGroup->CurrentValue, "", FALSE);
