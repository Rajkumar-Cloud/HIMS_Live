 ...
 * Page class
 */
class hr_trainingsessions_delete extends hr_trainingsessions
{
	...
	// Page object name
	public $PageObjName = "hr_trainingsessions_delete";
	...
	public function run()
	{
		...
		$this->deliveryLocation->Visible = FALSE;
		...
		if ($filter == "") {
			$this->terminate("hr_trainingsessionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hr_trainingsessionslist.php"); // Return to list
			}
		}
	}
