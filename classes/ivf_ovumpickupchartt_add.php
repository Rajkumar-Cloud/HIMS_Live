 ...
 * Page class
 */
class ivf_ovumpickupchartt_add extends ivf_ovumpickupchartt
{
	...
	// Page object name
	public $PageObjName = "ivf_ovumpickupchartt_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_ovumpickupcharttview.php")
