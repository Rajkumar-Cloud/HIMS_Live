...
class ivf_art_summary extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ARTCycle
		$this->ARTCycle = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_ARTCycle', 'ARTCycle', '`ARTCycle`', '`ARTCycle`', 200, -1, FALSE, '`ARTCycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Spermorigin
		$this->Spermorigin = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Spermorigin', 'Spermorigin', '`Spermorigin`', '`Spermorigin`', 200, -1, FALSE, '`Spermorigin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IndicationforART
		$this->IndicationforART = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_IndicationforART', 'IndicationforART', '`IndicationforART`', '`IndicationforART`', 200, -1, FALSE, '`IndicationforART`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IndicationforART->Sortable = TRUE; // Allow sort
		$this->fields['IndicationforART'] = &$this->IndicationforART;

		// DateofICSI
		$this->DateofICSI = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_DateofICSI', 'DateofICSI', '`DateofICSI`', CastDateFieldForLike('`DateofICSI`', 7, "DB"), 135, 7, FALSE, '`DateofICSI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Origin
		$this->Origin = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Origin', 'Origin', '`Origin`', '`Origin`', 200, -1, FALSE, '`Origin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Status
		$this->Status = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Status', 'Status', '`Status`', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Method
		$this->Method = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Method', 'Method', '`Method`', '`Method`', 200, -1, FALSE, '`Method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// pre_Concentration
		$this->pre_Concentration = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_pre_Concentration', 'pre_Concentration', '`pre_Concentration`', '`pre_Concentration`', 200, -1, FALSE, '`pre_Concentration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pre_Concentration->Sortable = TRUE; // Allow sort
		$this->fields['pre_Concentration'] = &$this->pre_Concentration;

		// pre_Motility
		$this->pre_Motility = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_pre_Motility', 'pre_Motility', '`pre_Motility`', '`pre_Motility`', 200, -1, FALSE, '`pre_Motility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pre_Motility->Sortable = TRUE; // Allow sort
		$this->fields['pre_Motility'] = &$this->pre_Motility;

		// pre_Morphology
		$this->pre_Morphology = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_pre_Morphology', 'pre_Morphology', '`pre_Morphology`', '`pre_Morphology`', 200, -1, FALSE, '`pre_Morphology`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pre_Morphology->Sortable = TRUE; // Allow sort
		$this->fields['pre_Morphology'] = &$this->pre_Morphology;

		// post_Concentration
		$this->post_Concentration = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_post_Concentration', 'post_Concentration', '`post_Concentration`', '`post_Concentration`', 200, -1, FALSE, '`post_Concentration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->post_Concentration->Sortable = TRUE; // Allow sort
		$this->fields['post_Concentration'] = &$this->post_Concentration;

		// post_Motility
		$this->post_Motility = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_post_Motility', 'post_Motility', '`post_Motility`', '`post_Motility`', 200, -1, FALSE, '`post_Motility`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->post_Motility->Sortable = TRUE; // Allow sort
		$this->fields['post_Motility'] = &$this->post_Motility;

		// post_Morphology
		$this->post_Morphology = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_post_Morphology', 'post_Morphology', '`post_Morphology`', '`post_Morphology`', 200, -1, FALSE, '`post_Morphology`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->post_Morphology->Sortable = TRUE; // Allow sort
		$this->fields['post_Morphology'] = &$this->post_Morphology;

		// NumberofEmbryostransferred
		$this->NumberofEmbryostransferred = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_NumberofEmbryostransferred', 'NumberofEmbryostransferred', '`NumberofEmbryostransferred`', '`NumberofEmbryostransferred`', 200, -1, FALSE, '`NumberofEmbryostransferred`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Embryosunderobservation = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Embryosunderobservation', 'Embryosunderobservation', '`Embryosunderobservation`', '`Embryosunderobservation`', 200, -1, FALSE, '`Embryosunderobservation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->EmbryoDevelopmentSummary = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_EmbryoDevelopmentSummary', 'EmbryoDevelopmentSummary', '`EmbryoDevelopmentSummary`', '`EmbryoDevelopmentSummary`', 200, -1, FALSE, '`EmbryoDevelopmentSummary`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->EmbryologistSignature = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_EmbryologistSignature', 'EmbryologistSignature', '`EmbryologistSignature`', '`EmbryologistSignature`', 200, -1, FALSE, '`EmbryologistSignature`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmbryologistSignature->Sortable = TRUE; // Allow sort
		$this->fields['EmbryologistSignature'] = &$this->EmbryologistSignature;

		// IVFRegistrationID
		$this->IVFRegistrationID = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_IVFRegistrationID', 'IVFRegistrationID', '`IVFRegistrationID`', '`IVFRegistrationID`', 3, -1, FALSE, '`IVFRegistrationID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->InseminatinTechnique = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_InseminatinTechnique', 'InseminatinTechnique', '`InseminatinTechnique`', '`InseminatinTechnique`', 200, -1, FALSE, '`InseminatinTechnique`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ICSIDetails
		$this->ICSIDetails = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_ICSIDetails', 'ICSIDetails', '`ICSIDetails`', '`ICSIDetails`', 200, -1, FALSE, '`ICSIDetails`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ICSIDetails->Sortable = TRUE; // Allow sort
		$this->fields['ICSIDetails'] = &$this->ICSIDetails;

		// DateofET
		$this->DateofET = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_DateofET', 'DateofET', '`DateofET`', '`DateofET`', 200, -1, FALSE, '`DateofET`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Reasonfornotranfer
		$this->Reasonfornotranfer = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Reasonfornotranfer', 'Reasonfornotranfer', '`Reasonfornotranfer`', '`Reasonfornotranfer`', 200, -1, FALSE, '`Reasonfornotranfer`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->EmbryosCryopreserved = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_EmbryosCryopreserved', 'EmbryosCryopreserved', '`EmbryosCryopreserved`', '`EmbryosCryopreserved`', 200, -1, FALSE, '`EmbryosCryopreserved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EmbryosCryopreserved->Sortable = TRUE; // Allow sort
		$this->fields['EmbryosCryopreserved'] = &$this->EmbryosCryopreserved;

		// LegendCellStage
		$this->LegendCellStage = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_LegendCellStage', 'LegendCellStage', '`LegendCellStage`', '`LegendCellStage`', 200, -1, FALSE, '`LegendCellStage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LegendCellStage->Sortable = TRUE; // Allow sort
		$this->fields['LegendCellStage'] = &$this->LegendCellStage;

		// ConsultantsSignature
		$this->ConsultantsSignature = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_ConsultantsSignature', 'ConsultantsSignature', '`ConsultantsSignature`', '`ConsultantsSignature`', 200, -1, FALSE, '`ConsultantsSignature`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Name
		$this->Name = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// M2
		$this->M2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_M2', 'M2', '`M2`', '`M2`', 200, -1, FALSE, '`M2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->M2->Sortable = TRUE; // Allow sort
		$this->fields['M2'] = &$this->M2;

		// Mi2
		$this->Mi2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Mi2', 'Mi2', '`Mi2`', '`Mi2`', 200, -1, FALSE, '`Mi2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mi2->Sortable = TRUE; // Allow sort
		$this->fields['Mi2'] = &$this->Mi2;

		// ICSI
		$this->ICSI = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_ICSI', 'ICSI', '`ICSI`', '`ICSI`', 200, -1, FALSE, '`ICSI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ICSI->Sortable = TRUE; // Allow sort
		$this->fields['ICSI'] = &$this->ICSI;

		// IVF
		$this->IVF = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_IVF', 'IVF', '`IVF`', '`IVF`', 200, -1, FALSE, '`IVF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IVF->Sortable = TRUE; // Allow sort
		$this->fields['IVF'] = &$this->IVF;

		// M1
		$this->M1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_M1', 'M1', '`M1`', '`M1`', 200, -1, FALSE, '`M1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->M1->Sortable = TRUE; // Allow sort
		$this->fields['M1'] = &$this->M1;

		// GV
		$this->GV = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_GV', 'GV', '`GV`', '`GV`', 200, -1, FALSE, '`GV`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GV->Sortable = TRUE; // Allow sort
		$this->fields['GV'] = &$this->GV;

		// Others
		$this->Others = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Others', 'Others', '`Others`', '`Others`', 200, -1, FALSE, '`Others`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Others->Sortable = TRUE; // Allow sort
		$this->fields['Others'] = &$this->Others;

		// Normal2PN
		$this->Normal2PN = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Normal2PN', 'Normal2PN', '`Normal2PN`', '`Normal2PN`', 200, -1, FALSE, '`Normal2PN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Normal2PN->Sortable = TRUE; // Allow sort
		$this->fields['Normal2PN'] = &$this->Normal2PN;

		// Abnormalfertilisation1N
		$this->Abnormalfertilisation1N = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Abnormalfertilisation1N', 'Abnormalfertilisation1N', '`Abnormalfertilisation1N`', '`Abnormalfertilisation1N`', 200, -1, FALSE, '`Abnormalfertilisation1N`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Abnormalfertilisation3N = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Abnormalfertilisation3N', 'Abnormalfertilisation3N', '`Abnormalfertilisation3N`', '`Abnormalfertilisation3N`', 200, -1, FALSE, '`Abnormalfertilisation3N`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Abnormalfertilisation3N->Sortable = TRUE; // Allow sort
		$this->fields['Abnormalfertilisation3N'] = &$this->Abnormalfertilisation3N;

		// NotFertilized
		$this->NotFertilized = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_NotFertilized', 'NotFertilized', '`NotFertilized`', '`NotFertilized`', 200, -1, FALSE, '`NotFertilized`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NotFertilized->Sortable = TRUE; // Allow sort
		$this->fields['NotFertilized'] = &$this->NotFertilized;

		// Degenerated
		$this->Degenerated = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Degenerated', 'Degenerated', '`Degenerated`', '`Degenerated`', 200, -1, FALSE, '`Degenerated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Degenerated->Sortable = TRUE; // Allow sort
		$this->fields['Degenerated'] = &$this->Degenerated;

		// SpermDate
		$this->SpermDate = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_SpermDate', 'SpermDate', '`SpermDate`', CastDateFieldForLike('`SpermDate`', 0, "DB"), 135, 0, FALSE, '`SpermDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Code1
		$this->Code1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Code1', 'Code1', '`Code1`', '`Code1`', 200, -1, FALSE, '`Code1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code1->Sortable = TRUE; // Allow sort
		$this->fields['Code1'] = &$this->Code1;

		// Day1
		$this->Day1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Day1', 'Day1', '`Day1`', '`Day1`', 200, -1, FALSE, '`Day1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CellStage1
		$this->CellStage1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_CellStage1', 'CellStage1', '`CellStage1`', '`CellStage1`', 200, -1, FALSE, '`CellStage1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade1
		$this->Grade1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Grade1', 'Grade1', '`Grade1`', '`Grade1`', 200, -1, FALSE, '`Grade1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// State1
		$this->State1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_State1', 'State1', '`State1`', '`State1`', 200, -1, FALSE, '`State1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Code2
		$this->Code2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Code2', 'Code2', '`Code2`', '`Code2`', 200, -1, FALSE, '`Code2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code2->Sortable = TRUE; // Allow sort
		$this->fields['Code2'] = &$this->Code2;

		// Day2
		$this->Day2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Day2', 'Day2', '`Day2`', '`Day2`', 200, -1, FALSE, '`Day2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CellStage2
		$this->CellStage2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_CellStage2', 'CellStage2', '`CellStage2`', '`CellStage2`', 200, -1, FALSE, '`CellStage2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade2
		$this->Grade2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Grade2', 'Grade2', '`Grade2`', '`Grade2`', 200, -1, FALSE, '`Grade2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// State2
		$this->State2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_State2', 'State2', '`State2`', '`State2`', 200, -1, FALSE, '`State2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Code3
		$this->Code3 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Code3', 'Code3', '`Code3`', '`Code3`', 200, -1, FALSE, '`Code3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code3->Sortable = TRUE; // Allow sort
		$this->fields['Code3'] = &$this->Code3;

		// Day3
		$this->Day3 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Day3', 'Day3', '`Day3`', '`Day3`', 200, -1, FALSE, '`Day3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CellStage3
		$this->CellStage3 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_CellStage3', 'CellStage3', '`CellStage3`', '`CellStage3`', 200, -1, FALSE, '`CellStage3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade3
		$this->Grade3 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Grade3', 'Grade3', '`Grade3`', '`Grade3`', 200, -1, FALSE, '`Grade3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// State3
		$this->State3 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_State3', 'State3', '`State3`', '`State3`', 200, -1, FALSE, '`State3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Code4
		$this->Code4 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Code4', 'Code4', '`Code4`', '`Code4`', 200, -1, FALSE, '`Code4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code4->Sortable = TRUE; // Allow sort
		$this->fields['Code4'] = &$this->Code4;

		// Day4
		$this->Day4 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Day4', 'Day4', '`Day4`', '`Day4`', 200, -1, FALSE, '`Day4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CellStage4
		$this->CellStage4 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_CellStage4', 'CellStage4', '`CellStage4`', '`CellStage4`', 200, -1, FALSE, '`CellStage4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade4
		$this->Grade4 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Grade4', 'Grade4', '`Grade4`', '`Grade4`', 200, -1, FALSE, '`Grade4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// State4
		$this->State4 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_State4', 'State4', '`State4`', '`State4`', 200, -1, FALSE, '`State4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Code5
		$this->Code5 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Code5', 'Code5', '`Code5`', '`Code5`', 200, -1, FALSE, '`Code5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code5->Sortable = TRUE; // Allow sort
		$this->fields['Code5'] = &$this->Code5;

		// Day5
		$this->Day5 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Day5', 'Day5', '`Day5`', '`Day5`', 200, -1, FALSE, '`Day5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CellStage5
		$this->CellStage5 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_CellStage5', 'CellStage5', '`CellStage5`', '`CellStage5`', 200, -1, FALSE, '`CellStage5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Grade5
		$this->Grade5 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Grade5', 'Grade5', '`Grade5`', '`Grade5`', 200, -1, FALSE, '`Grade5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// State5
		$this->State5 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_State5', 'State5', '`State5`', '`State5`', 200, -1, FALSE, '`State5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TidNo
		$this->TidNo = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RIDNo
		$this->RIDNo = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNo->Sortable = TRUE; // Allow sort
		$this->RIDNo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNo'] = &$this->RIDNo;

		// Volume
		$this->Volume = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Volume', 'Volume', '`Volume`', '`Volume`', 200, -1, FALSE, '`Volume`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Volume->Sortable = TRUE; // Allow sort
		$this->fields['Volume'] = &$this->Volume;

		// Volume1
		$this->Volume1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Volume1', 'Volume1', '`Volume1`', '`Volume1`', 200, -1, FALSE, '`Volume1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Volume1->Sortable = TRUE; // Allow sort
		$this->fields['Volume1'] = &$this->Volume1;

		// Volume2
		$this->Volume2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Volume2', 'Volume2', '`Volume2`', '`Volume2`', 200, -1, FALSE, '`Volume2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Volume2->Sortable = TRUE; // Allow sort
		$this->fields['Volume2'] = &$this->Volume2;

		// Concentration2
		$this->Concentration2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Concentration2', 'Concentration2', '`Concentration2`', '`Concentration2`', 200, -1, FALSE, '`Concentration2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Concentration2->Sortable = TRUE; // Allow sort
		$this->fields['Concentration2'] = &$this->Concentration2;

		// Total
		$this->Total = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Total', 'Total', '`Total`', '`Total`', 200, -1, FALSE, '`Total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total->Sortable = TRUE; // Allow sort
		$this->fields['Total'] = &$this->Total;

		// Total1
		$this->Total1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Total1', 'Total1', '`Total1`', '`Total1`', 200, -1, FALSE, '`Total1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total1->Sortable = TRUE; // Allow sort
		$this->fields['Total1'] = &$this->Total1;

		// Total2
		$this->Total2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Total2', 'Total2', '`Total2`', '`Total2`', 200, -1, FALSE, '`Total2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Total2->Sortable = TRUE; // Allow sort
		$this->fields['Total2'] = &$this->Total2;

		// Progressive
		$this->Progressive = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Progressive', 'Progressive', '`Progressive`', '`Progressive`', 200, -1, FALSE, '`Progressive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Progressive->Sortable = TRUE; // Allow sort
		$this->fields['Progressive'] = &$this->Progressive;

		// Progressive1
		$this->Progressive1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Progressive1', 'Progressive1', '`Progressive1`', '`Progressive1`', 200, -1, FALSE, '`Progressive1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Progressive1->Sortable = TRUE; // Allow sort
		$this->fields['Progressive1'] = &$this->Progressive1;

		// Progressive2
		$this->Progressive2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Progressive2', 'Progressive2', '`Progressive2`', '`Progressive2`', 200, -1, FALSE, '`Progressive2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Progressive2->Sortable = TRUE; // Allow sort
		$this->fields['Progressive2'] = &$this->Progressive2;

		// NotProgressive
		$this->NotProgressive = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_NotProgressive', 'NotProgressive', '`NotProgressive`', '`NotProgressive`', 200, -1, FALSE, '`NotProgressive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NotProgressive->Sortable = TRUE; // Allow sort
		$this->fields['NotProgressive'] = &$this->NotProgressive;

		// NotProgressive1
		$this->NotProgressive1 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_NotProgressive1', 'NotProgressive1', '`NotProgressive1`', '`NotProgressive1`', 200, -1, FALSE, '`NotProgressive1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NotProgressive1->Sortable = TRUE; // Allow sort
		$this->fields['NotProgressive1'] = &$this->NotProgressive1;

		// NotProgressive2
		$this->NotProgressive2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_NotProgressive2', 'NotProgressive2', '`NotProgressive2`', '`NotProgressive2`', 200, -1, FALSE, '`NotProgressive2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NotProgressive2->Sortable = TRUE; // Allow sort
		$this->fields['NotProgressive2'] = &$this->NotProgressive2;

		// Motility2
		$this->Motility2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Motility2', 'Motility2', '`Motility2`', '`Motility2`', 200, -1, FALSE, '`Motility2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Motility2->Sortable = TRUE; // Allow sort
		$this->fields['Motility2'] = &$this->Motility2;

		// Morphology2
		$this->Morphology2 = new DbField('ivf_art_summary', 'ivf_art_summary', 'x_Morphology2', 'Morphology2', '`Morphology2`', '`Morphology2`', 200, -1, FALSE, '`Morphology2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_art_summaryview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
