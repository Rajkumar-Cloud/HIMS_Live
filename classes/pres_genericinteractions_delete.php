 ...
 * Page class
 */
class pres_genericinteractions_delete extends pres_genericinteractions
{
	...
	// Page object name
	public $PageObjName = "pres_genericinteractions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pres_genericinteractionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pres_genericinteractionslist.php"); // Return to list
			}
		}
	}
