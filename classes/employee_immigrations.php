 ...
 */
class employee_immigrations extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_immigrations', 'employee_immigrations', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee
		$this->employee = new DbField('employee_immigrations', 'employee_immigrations', 'x_employee', 'employee', '`employee`', '`employee`', 3, -1, FALSE, '`employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// document
		$this->document = new DbField('employee_immigrations', 'employee_immigrations', 'x_document', 'document', '`document`', '`document`', 20, -1, FALSE, '`document`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// documentname
		$this->documentname = new DbField('employee_immigrations', 'employee_immigrations', 'x_documentname', 'documentname', '`documentname`', '`documentname`', 200, -1, FALSE, '`documentname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// valid_until
		$this->valid_until = new DbField('employee_immigrations', 'employee_immigrations', 'x_valid_until', 'valid_until', '`valid_until`', CastDateFieldForLike('`valid_until`', 0, "DB"), 133, 0, FALSE, '`valid_until`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('employee_immigrations', 'employee_immigrations', 'x_status', 'status', '`status`', '`status`', 202, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// details
		$this->details = new DbField('employee_immigrations', 'employee_immigrations', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->details->Sortable = TRUE; // Allow sort
		$this->fields['details'] = &$this->details;

		// attachment1
		$this->attachment1 = new DbField('employee_immigrations', 'employee_immigrations', 'x_attachment1', 'attachment1', '`attachment1`', '`attachment1`', 200, -1, FALSE, '`attachment1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->attachment1->Sortable = TRUE; // Allow sort
		$this->fields['attachment1'] = &$this->attachment1;

		// attachment2
		$this->attachment2 = new DbField('employee_immigrations', 'employee_immigrations', 'x_attachment2', 'attachment2', '`attachment2`', '`attachment2`', 200, -1, FALSE, '`attachment2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->attachment2->Sortable = TRUE; // Allow sort
		$this->fields['attachment2'] = &$this->attachment2;

		// attachment3
		$this->attachment3 = new DbField('employee_immigrations', 'employee_immigrations', 'x_attachment3', 'attachment3', '`attachment3`', '`attachment3`', 200, -1, FALSE, '`attachment3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->attachment3->Sortable = TRUE; // Allow sort
		$this->fields['attachment3'] = &$this->attachment3;

		// created
		$this->created = new DbField('employee_immigrations', 'employee_immigrations', 'x_created', 'created', '`created`', CastDateFieldForLike('`created`', 0, "DB"), 135, 0, FALSE, '`created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated
		$this->updated = new DbField('employee_immigrations', 'employee_immigrations', 'x_updated', 'updated', '`updated`', CastDateFieldForLike('`updated`', 0, "DB"), 135, 0, FALSE, '`updated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_immigrationslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_immigrationsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_immigrationsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_immigrationsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_immigrationsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_immigrationsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_immigrationsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_immigrationsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_immigrationsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_immigrationsdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->document->setDbValue($rs->fields('document'));
		$this->documentname->setDbValue($rs->fields('documentname'));
		$this->valid_until->setDbValue($rs->fields('valid_until'));
