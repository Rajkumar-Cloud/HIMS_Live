 ...
 * Page class
 */
class pharmacy_services_grid extends pharmacy_services
{
	...
	// Page object name
	public $PageObjName = "pharmacy_services_grid";

	// Grid form hidden field names
	public $FormName = "fpharmacy_servicesgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_pharmacy_id") && $CurrentForm->hasValue("o_pharmacy_id") && $this->pharmacy_id->CurrentValue <> $this->pharmacy_id->OldValue)
			return FALSE;
	...
	protected function loadFormValues()
	{
		...
		$this->pharmacy_id->setOldValue($CurrentForm->getValue("o_pharmacy_id"));
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// charged_date
			$this->charged_date->setDbValueDef($rsnew, CurrentDate(), CurrentDate());
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->description->getSessionValue() <> "") {
			$rsnew['description'] = $this->description->getSessionValue();
		}
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "pharmacy") {
			$this->pharmacy_id->Visible = FALSE;
			if ($GLOBALS["pharmacy"]->EventCancelled)
		...
		if ($masterTblVar == "mas_pharmacy") {
			...
			if ($GLOBALS["mas_pharmacy"]->EventCancelled)
				$this->EventCancelled = TRUE;
