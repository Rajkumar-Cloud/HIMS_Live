 ...
 * Page class
 */
class view_lab_profile_delete extends view_lab_profile
{
	...
	// Page object name
	public $PageObjName = "view_lab_profile_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_lab_profilelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("view_lab_profilelist.php"); // Return to list
			}
		}
	}
