 ...
 * Page class
 */
class recruitment_job_delete extends recruitment_job
{
	...
	// Page object name
	public $PageObjName = "recruitment_job_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("recruitment_joblist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("recruitment_joblist.php"); // Return to list
			}
		}
	}
