...
class ivf_treatment_plan_preview extends ivf_treatment_plan
{
	...
	protected function masterKeyUrl()
	{
		...
		$url = "";
		if ($masterTblVar == "ivf") {
			$url = "" . TABLE_SHOW_MASTER . "=ivf&fk_id=" . urlencode(strval($this->RIDNO->QueryStringValue)) . "&fk_Female=" . urlencode(strval($this->Name->QueryStringValue)) . "";
		}
		if ($masterTblVar == "view_donor_ivf") {
			$url = "" . TABLE_SHOW_MASTER . "=view_donor_ivf&fk_id=" . urlencode(strval($this->RIDNO->QueryStringValue)) . "&fk_Female=" . urlencode(strval($this->Name->QueryStringValue)) . "";
		}
		return $url;
	}
