 ...
 * Page class
 */
class ivf_mas_user_template_delete extends ivf_mas_user_template
{
	...
	// Page object name
	public $PageObjName = "ivf_mas_user_template_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_mas_user_templatelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("ivf_mas_user_templatelist.php"); // Return to list
			}
		}
	}
