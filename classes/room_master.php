...
/**
 * Table class for room_master
 */
class room_master extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'room_master';
		$this->TableName = 'room_master';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`room_master`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('room_master', 'room_master', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RoomNo
		$this->RoomNo = new DbField('room_master', 'room_master', 'x_RoomNo', 'RoomNo', '`RoomNo`', '`RoomNo`', 200, -1, FALSE, '`RoomNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RoomNo->Sortable = TRUE; // Allow sort
		$this->fields['RoomNo'] = &$this->RoomNo;

		// RoomType
		$this->RoomType = new DbField('room_master', 'room_master', 'x_RoomType', 'RoomType', '`RoomType`', '`RoomType`', 200, -1, FALSE, '`RoomType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->RoomType->Sortable = TRUE; // Allow sort
		$this->RoomType->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->RoomType->PleaseSelectText = $Language->phrase("PleaseSelect"); // PleaseSelect text
		$this->RoomType->Lookup = new Lookup('RoomType', 'room_types', FALSE, 'Types', ["Types","","",""], [], [], [], [], [], [], '', '');
		$this->fields['RoomType'] = &$this->RoomType;

		// SharingRoom
		$this->SharingRoom = new DbField('room_master', 'room_master', 'x_SharingRoom', 'SharingRoom', '`SharingRoom`', '`SharingRoom`', 200, -1, FALSE, '`SharingRoom`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->SharingRoom->Sortable = TRUE; // Allow sort
		$this->SharingRoom->Lookup = new Lookup('SharingRoom', 'room_master', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->SharingRoom->OptionCount = 2;
		$this->fields['SharingRoom'] = &$this->SharingRoom;

		// Amount
		$this->Amount = new DbField('room_master', 'room_master', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->Amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Amount'] = &$this->Amount;

		// Status
		$this->Status = new DbField('room_master', 'room_master', 'x_Status', 'Status', '`Status`', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->Status->Sortable = TRUE; // Allow sort
		$this->Status->Lookup = new Lookup('Status', 'room_master', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->Status->OptionCount = 5;
		$this->fields['Status'] = &$this->Status;

		// PatientID
		$this->PatientID = new DbField('room_master', 'room_master', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Sortable = FALSE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// PatientName
		$this->PatientName = new DbField('room_master', 'room_master', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = FALSE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// MobileNo
		$this->MobileNo = new DbField('room_master', 'room_master', 'x_MobileNo', 'MobileNo', '`MobileNo`', '`MobileNo`', 200, -1, FALSE, '`MobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNo->Sortable = FALSE; // Allow sort
		$this->fields['MobileNo'] = &$this->MobileNo;

		// PatID
		$this->PatID = new DbField('room_master', 'room_master', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`room_master`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "room_masteredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "room_masteradd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("room_masterview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("room_masterview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "room_masteradd.php?" . $this->getUrlParm($parm);
		else
			$url = "room_masteradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("room_masteredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("room_masteradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("room_masterdelete.php", $this->getUrlParm());
	}
