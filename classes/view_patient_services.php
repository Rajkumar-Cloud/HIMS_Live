...
class view_patient_services extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_patient_services', 'view_patient_services', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Reception
		$this->Reception = new DbField('view_patient_services', 'view_patient_services', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mrnno
		$this->mrnno = new DbField('view_patient_services', 'view_patient_services', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// PatientName
		$this->PatientName = new DbField('view_patient_services', 'view_patient_services', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Age
		$this->Age = new DbField('view_patient_services', 'view_patient_services', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('view_patient_services', 'view_patient_services', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// profilePic
		$this->profilePic = new DbField('view_patient_services', 'view_patient_services', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// Services
		$this->Services = new DbField('view_patient_services', 'view_patient_services', 'x_Services', 'Services', '`Services`', '`Services`', 200, -1, FALSE, '`EV__Services`', TRUE, FALSE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// Unit
		$this->Unit = new DbField('view_patient_services', 'view_patient_services', 'x_Unit', 'Unit', '`Unit`', '`Unit`', 3, -1, FALSE, '`Unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// amount
		$this->amount = new DbField('view_patient_services', 'view_patient_services', 'x_amount', 'amount', '`amount`', '`amount`', 131, -1, FALSE, '`amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Quantity
		$this->Quantity = new DbField('view_patient_services', 'view_patient_services', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, -1, FALSE, '`Quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Quantity->Sortable = TRUE; // Allow sort
		$this->Quantity->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Quantity'] = &$this->Quantity;

		// DiscountCategory
		$this->DiscountCategory = new DbField('view_patient_services', 'view_patient_services', 'x_DiscountCategory', 'DiscountCategory', '`DiscountCategory`', '`DiscountCategory`', 200, -1, FALSE, '`DiscountCategory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Discount
		$this->Discount = new DbField('view_patient_services', 'view_patient_services', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, -1, FALSE, '`Discount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SubTotal
		$this->SubTotal = new DbField('view_patient_services', 'view_patient_services', 'x_SubTotal', 'SubTotal', '`SubTotal`', '`SubTotal`', 131, -1, FALSE, '`SubTotal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// description
		$this->description = new DbField('view_patient_services', 'view_patient_services', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// patient_type
		$this->patient_type = new DbField('view_patient_services', 'view_patient_services', 'x_patient_type', 'patient_type', '`patient_type`', '`patient_type`', 3, -1, FALSE, '`patient_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// charged_date
		$this->charged_date = new DbField('view_patient_services', 'view_patient_services', 'x_charged_date', 'charged_date', '`charged_date`', CastDateFieldForLike('`charged_date`', 0, "DB"), 135, 0, FALSE, '`charged_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status
		$this->status = new DbField('view_patient_services', 'view_patient_services', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// createdby
		$this->createdby = new DbField('view_patient_services', 'view_patient_services', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_patient_services', 'view_patient_services', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_patient_services', 'view_patient_services', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_patient_services', 'view_patient_services', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// Aid
		$this->Aid = new DbField('view_patient_services', 'view_patient_services', 'x_Aid', 'Aid', '`Aid`', '`Aid`', 3, -1, FALSE, '`Aid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Aid->Sortable = TRUE; // Allow sort
		$this->Aid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Aid'] = &$this->Aid;

		// Vid
		$this->Vid = new DbField('view_patient_services', 'view_patient_services', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, -1, FALSE, '`Vid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrID
		$this->DrID = new DbField('view_patient_services', 'view_patient_services', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, -1, FALSE, '`DrID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrCODE
		$this->DrCODE = new DbField('view_patient_services', 'view_patient_services', 'x_DrCODE', 'DrCODE', '`DrCODE`', '`DrCODE`', 200, -1, FALSE, '`DrCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DrCODE->Sortable = TRUE; // Allow sort
		$this->fields['DrCODE'] = &$this->DrCODE;

		// DrName
		$this->DrName = new DbField('view_patient_services', 'view_patient_services', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, -1, FALSE, '`DrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DrName->Sortable = TRUE; // Allow sort
		$this->fields['DrName'] = &$this->DrName;

		// Department
		$this->Department = new DbField('view_patient_services', 'view_patient_services', 'x_Department', 'Department', '`Department`', '`Department`', 200, -1, FALSE, '`Department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Department->Sortable = TRUE; // Allow sort
		$this->fields['Department'] = &$this->Department;

		// DrSharePres
		$this->DrSharePres = new DbField('view_patient_services', 'view_patient_services', 'x_DrSharePres', 'DrSharePres', '`DrSharePres`', '`DrSharePres`', 131, -1, FALSE, '`DrSharePres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospSharePres
		$this->HospSharePres = new DbField('view_patient_services', 'view_patient_services', 'x_HospSharePres', 'HospSharePres', '`HospSharePres`', '`HospSharePres`', 131, -1, FALSE, '`HospSharePres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrShareAmount
		$this->DrShareAmount = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareAmount', 'DrShareAmount', '`DrShareAmount`', '`DrShareAmount`', 131, -1, FALSE, '`DrShareAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospShareAmount
		$this->HospShareAmount = new DbField('view_patient_services', 'view_patient_services', 'x_HospShareAmount', 'HospShareAmount', '`HospShareAmount`', '`HospShareAmount`', 131, -1, FALSE, '`HospShareAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DrShareSettiledAmount = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareSettiledAmount', 'DrShareSettiledAmount', '`DrShareSettiledAmount`', '`DrShareSettiledAmount`', 131, -1, FALSE, '`DrShareSettiledAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DrShareSettledId
		$this->DrShareSettledId = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareSettledId', 'DrShareSettledId', '`DrShareSettledId`', '`DrShareSettledId`', 3, -1, FALSE, '`DrShareSettledId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DrShareSettiledStatus = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareSettiledStatus', 'DrShareSettiledStatus', '`DrShareSettiledStatus`', '`DrShareSettiledStatus`', 3, -1, FALSE, '`DrShareSettiledStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceId
		$this->invoiceId = new DbField('view_patient_services', 'view_patient_services', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, -1, FALSE, '`invoiceId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceAmount
		$this->invoiceAmount = new DbField('view_patient_services', 'view_patient_services', 'x_invoiceAmount', 'invoiceAmount', '`invoiceAmount`', '`invoiceAmount`', 131, -1, FALSE, '`invoiceAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// invoiceStatus
		$this->invoiceStatus = new DbField('view_patient_services', 'view_patient_services', 'x_invoiceStatus', 'invoiceStatus', '`invoiceStatus`', '`invoiceStatus`', 200, -1, FALSE, '`invoiceStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->invoiceStatus->Sortable = TRUE; // Allow sort
		$this->fields['invoiceStatus'] = &$this->invoiceStatus;

		// modeOfPayment
		$this->modeOfPayment = new DbField('view_patient_services', 'view_patient_services', 'x_modeOfPayment', 'modeOfPayment', '`modeOfPayment`', '`modeOfPayment`', 200, -1, FALSE, '`modeOfPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modeOfPayment->Sortable = TRUE; // Allow sort
		$this->fields['modeOfPayment'] = &$this->modeOfPayment;

		// HospID
		$this->HospID = new DbField('view_patient_services', 'view_patient_services', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// RIDNO
		$this->RIDNO = new DbField('view_patient_services', 'view_patient_services', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNO->Sortable = TRUE; // Allow sort
		$this->RIDNO->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNO'] = &$this->RIDNO;

		// ItemCode
		$this->ItemCode = new DbField('view_patient_services', 'view_patient_services', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, -1, FALSE, '`ItemCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ItemCode->Sortable = TRUE; // Allow sort
		$this->fields['ItemCode'] = &$this->ItemCode;

		// TidNo
		$this->TidNo = new DbField('view_patient_services', 'view_patient_services', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sid
		$this->sid = new DbField('view_patient_services', 'view_patient_services', 'x_sid', 'sid', '`sid`', '`sid`', 3, -1, FALSE, '`sid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sid->Sortable = TRUE; // Allow sort
		$this->sid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['sid'] = &$this->sid;

		// TestSubCd
		$this->TestSubCd = new DbField('view_patient_services', 'view_patient_services', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, -1, FALSE, '`TestSubCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestSubCd->Sortable = TRUE; // Allow sort
		$this->fields['TestSubCd'] = &$this->TestSubCd;

		// DEptCd
		$this->DEptCd = new DbField('view_patient_services', 'view_patient_services', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, -1, FALSE, '`DEptCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEptCd->Sortable = TRUE; // Allow sort
		$this->fields['DEptCd'] = &$this->DEptCd;

		// ProfCd
		$this->ProfCd = new DbField('view_patient_services', 'view_patient_services', 'x_ProfCd', 'ProfCd', '`ProfCd`', '`ProfCd`', 200, -1, FALSE, '`ProfCd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProfCd->Sortable = TRUE; // Allow sort
		$this->fields['ProfCd'] = &$this->ProfCd;

		// LabReport
		$this->LabReport = new DbField('view_patient_services', 'view_patient_services', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, -1, FALSE, '`LabReport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->LabReport->Sortable = TRUE; // Allow sort
		$this->fields['LabReport'] = &$this->LabReport;

		// Comments
		$this->Comments = new DbField('view_patient_services', 'view_patient_services', 'x_Comments', 'Comments', '`Comments`', '`Comments`', 200, -1, FALSE, '`Comments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Comments->Sortable = TRUE; // Allow sort
		$this->fields['Comments'] = &$this->Comments;

		// Method
		$this->Method = new DbField('view_patient_services', 'view_patient_services', 'x_Method', 'Method', '`Method`', '`Method`', 200, -1, FALSE, '`Method`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Method->Sortable = TRUE; // Allow sort
		$this->fields['Method'] = &$this->Method;

		// Specimen
		$this->Specimen = new DbField('view_patient_services', 'view_patient_services', 'x_Specimen', 'Specimen', '`Specimen`', '`Specimen`', 200, -1, FALSE, '`Specimen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Specimen->Sortable = TRUE; // Allow sort
		$this->fields['Specimen'] = &$this->Specimen;

		// Abnormal
		$this->Abnormal = new DbField('view_patient_services', 'view_patient_services', 'x_Abnormal', 'Abnormal', '`Abnormal`', '`Abnormal`', 200, -1, FALSE, '`Abnormal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Abnormal->Sortable = TRUE; // Allow sort
		$this->fields['Abnormal'] = &$this->Abnormal;

		// RefValue
		$this->RefValue = new DbField('view_patient_services', 'view_patient_services', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, -1, FALSE, '`RefValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->RefValue->Sortable = TRUE; // Allow sort
		$this->fields['RefValue'] = &$this->RefValue;

		// TestUnit
		$this->TestUnit = new DbField('view_patient_services', 'view_patient_services', 'x_TestUnit', 'TestUnit', '`TestUnit`', '`TestUnit`', 200, -1, FALSE, '`TestUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestUnit->Sortable = TRUE; // Allow sort
		$this->fields['TestUnit'] = &$this->TestUnit;

		// LOWHIGH
		$this->LOWHIGH = new DbField('view_patient_services', 'view_patient_services', 'x_LOWHIGH', 'LOWHIGH', '`LOWHIGH`', '`LOWHIGH`', 200, -1, FALSE, '`LOWHIGH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LOWHIGH->Sortable = TRUE; // Allow sort
		$this->fields['LOWHIGH'] = &$this->LOWHIGH;

		// Branch
		$this->Branch = new DbField('view_patient_services', 'view_patient_services', 'x_Branch', 'Branch', '`Branch`', '`Branch`', 200, -1, FALSE, '`Branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Branch->Sortable = TRUE; // Allow sort
		$this->fields['Branch'] = &$this->Branch;

		// Dispatch
		$this->Dispatch = new DbField('view_patient_services', 'view_patient_services', 'x_Dispatch', 'Dispatch', '`Dispatch`', '`Dispatch`', 200, -1, FALSE, '`Dispatch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dispatch->Sortable = TRUE; // Allow sort
		$this->fields['Dispatch'] = &$this->Dispatch;

		// Pic1
		$this->Pic1 = new DbField('view_patient_services', 'view_patient_services', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, -1, FALSE, '`Pic1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pic1->Sortable = TRUE; // Allow sort
		$this->fields['Pic1'] = &$this->Pic1;

		// Pic2
		$this->Pic2 = new DbField('view_patient_services', 'view_patient_services', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, -1, FALSE, '`Pic2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pic2->Sortable = TRUE; // Allow sort
		$this->fields['Pic2'] = &$this->Pic2;

		// GraphPath
		$this->GraphPath = new DbField('view_patient_services', 'view_patient_services', 'x_GraphPath', 'GraphPath', '`GraphPath`', '`GraphPath`', 200, -1, FALSE, '`GraphPath`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GraphPath->Sortable = TRUE; // Allow sort
		$this->fields['GraphPath'] = &$this->GraphPath;

		// MachineCD
		$this->MachineCD = new DbField('view_patient_services', 'view_patient_services', 'x_MachineCD', 'MachineCD', '`MachineCD`', '`MachineCD`', 200, -1, FALSE, '`MachineCD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MachineCD->Sortable = TRUE; // Allow sort
		$this->fields['MachineCD'] = &$this->MachineCD;

		// TestCancel
		$this->TestCancel = new DbField('view_patient_services', 'view_patient_services', 'x_TestCancel', 'TestCancel', '`TestCancel`', '`TestCancel`', 200, -1, FALSE, '`TestCancel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestCancel->Sortable = TRUE; // Allow sort
		$this->fields['TestCancel'] = &$this->TestCancel;

		// OutSource
		$this->OutSource = new DbField('view_patient_services', 'view_patient_services', 'x_OutSource', 'OutSource', '`OutSource`', '`OutSource`', 200, -1, FALSE, '`OutSource`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OutSource->Sortable = TRUE; // Allow sort
		$this->fields['OutSource'] = &$this->OutSource;

		// Printed
		$this->Printed = new DbField('view_patient_services', 'view_patient_services', 'x_Printed', 'Printed', '`Printed`', '`Printed`', 200, -1, FALSE, '`Printed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Printed->Sortable = TRUE; // Allow sort
		$this->fields['Printed'] = &$this->Printed;

		// PrintBy
		$this->PrintBy = new DbField('view_patient_services', 'view_patient_services', 'x_PrintBy', 'PrintBy', '`PrintBy`', '`PrintBy`', 200, -1, FALSE, '`PrintBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PrintBy->Sortable = TRUE; // Allow sort
		$this->fields['PrintBy'] = &$this->PrintBy;

		// PrintDate
		$this->PrintDate = new DbField('view_patient_services', 'view_patient_services', 'x_PrintDate', 'PrintDate', '`PrintDate`', CastDateFieldForLike('`PrintDate`', 0, "DB"), 135, 0, FALSE, '`PrintDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillingDate
		$this->BillingDate = new DbField('view_patient_services', 'view_patient_services', 'x_BillingDate', 'BillingDate', '`BillingDate`', CastDateFieldForLike('`BillingDate`', 0, "DB"), 135, 0, FALSE, '`BillingDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BilledBy
		$this->BilledBy = new DbField('view_patient_services', 'view_patient_services', 'x_BilledBy', 'BilledBy', '`BilledBy`', '`BilledBy`', 200, -1, FALSE, '`BilledBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BilledBy->Sortable = TRUE; // Allow sort
		$this->fields['BilledBy'] = &$this->BilledBy;

		// Resulted
		$this->Resulted = new DbField('view_patient_services', 'view_patient_services', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, -1, FALSE, '`Resulted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Resulted->Sortable = TRUE; // Allow sort
		$this->fields['Resulted'] = &$this->Resulted;

		// ResultDate
		$this->ResultDate = new DbField('view_patient_services', 'view_patient_services', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike('`ResultDate`', 0, "DB"), 135, 0, FALSE, '`ResultDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ResultedBy
		$this->ResultedBy = new DbField('view_patient_services', 'view_patient_services', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, -1, FALSE, '`ResultedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ResultedBy->Sortable = TRUE; // Allow sort
		$this->fields['ResultedBy'] = &$this->ResultedBy;

		// SampleDate
		$this->SampleDate = new DbField('view_patient_services', 'view_patient_services', 'x_SampleDate', 'SampleDate', '`SampleDate`', CastDateFieldForLike('`SampleDate`', 0, "DB"), 135, 0, FALSE, '`SampleDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SampleUser
		$this->SampleUser = new DbField('view_patient_services', 'view_patient_services', 'x_SampleUser', 'SampleUser', '`SampleUser`', '`SampleUser`', 200, -1, FALSE, '`SampleUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SampleUser->Sortable = TRUE; // Allow sort
		$this->fields['SampleUser'] = &$this->SampleUser;

		// Sampled
		$this->Sampled = new DbField('view_patient_services', 'view_patient_services', 'x_Sampled', 'Sampled', '`Sampled`', '`Sampled`', 200, -1, FALSE, '`Sampled`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sampled->Sortable = TRUE; // Allow sort
		$this->fields['Sampled'] = &$this->Sampled;

		// ReceivedDate
		$this->ReceivedDate = new DbField('view_patient_services', 'view_patient_services', 'x_ReceivedDate', 'ReceivedDate', '`ReceivedDate`', CastDateFieldForLike('`ReceivedDate`', 0, "DB"), 135, 0, FALSE, '`ReceivedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReceivedUser
		$this->ReceivedUser = new DbField('view_patient_services', 'view_patient_services', 'x_ReceivedUser', 'ReceivedUser', '`ReceivedUser`', '`ReceivedUser`', 200, -1, FALSE, '`ReceivedUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReceivedUser->Sortable = TRUE; // Allow sort
		$this->fields['ReceivedUser'] = &$this->ReceivedUser;

		// Recevied
		$this->Recevied = new DbField('view_patient_services', 'view_patient_services', 'x_Recevied', 'Recevied', '`Recevied`', '`Recevied`', 200, -1, FALSE, '`Recevied`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Recevied->Sortable = TRUE; // Allow sort
		$this->fields['Recevied'] = &$this->Recevied;

		// DeptRecvDate
		$this->DeptRecvDate = new DbField('view_patient_services', 'view_patient_services', 'x_DeptRecvDate', 'DeptRecvDate', '`DeptRecvDate`', CastDateFieldForLike('`DeptRecvDate`', 0, "DB"), 135, 0, FALSE, '`DeptRecvDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DeptRecvUser
		$this->DeptRecvUser = new DbField('view_patient_services', 'view_patient_services', 'x_DeptRecvUser', 'DeptRecvUser', '`DeptRecvUser`', '`DeptRecvUser`', 200, -1, FALSE, '`DeptRecvUser`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeptRecvUser->Sortable = TRUE; // Allow sort
		$this->fields['DeptRecvUser'] = &$this->DeptRecvUser;

		// DeptRecived
		$this->DeptRecived = new DbField('view_patient_services', 'view_patient_services', 'x_DeptRecived', 'DeptRecived', '`DeptRecived`', '`DeptRecived`', 200, -1, FALSE, '`DeptRecived`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DeptRecived->Sortable = TRUE; // Allow sort
		$this->fields['DeptRecived'] = &$this->DeptRecived;

		// SAuthDate
		$this->SAuthDate = new DbField('view_patient_services', 'view_patient_services', 'x_SAuthDate', 'SAuthDate', '`SAuthDate`', CastDateFieldForLike('`SAuthDate`', 0, "DB"), 135, 0, FALSE, '`SAuthDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SAuthBy
		$this->SAuthBy = new DbField('view_patient_services', 'view_patient_services', 'x_SAuthBy', 'SAuthBy', '`SAuthBy`', '`SAuthBy`', 200, -1, FALSE, '`SAuthBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SAuthBy->Sortable = TRUE; // Allow sort
		$this->fields['SAuthBy'] = &$this->SAuthBy;

		// SAuthendicate
		$this->SAuthendicate = new DbField('view_patient_services', 'view_patient_services', 'x_SAuthendicate', 'SAuthendicate', '`SAuthendicate`', '`SAuthendicate`', 200, -1, FALSE, '`SAuthendicate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SAuthendicate->Sortable = TRUE; // Allow sort
		$this->fields['SAuthendicate'] = &$this->SAuthendicate;

		// AuthDate
		$this->AuthDate = new DbField('view_patient_services', 'view_patient_services', 'x_AuthDate', 'AuthDate', '`AuthDate`', CastDateFieldForLike('`AuthDate`', 0, "DB"), 135, 0, FALSE, '`AuthDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AuthBy
		$this->AuthBy = new DbField('view_patient_services', 'view_patient_services', 'x_AuthBy', 'AuthBy', '`AuthBy`', '`AuthBy`', 200, -1, FALSE, '`AuthBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AuthBy->Sortable = TRUE; // Allow sort
		$this->fields['AuthBy'] = &$this->AuthBy;

		// Authencate
		$this->Authencate = new DbField('view_patient_services', 'view_patient_services', 'x_Authencate', 'Authencate', '`Authencate`', '`Authencate`', 200, -1, FALSE, '`Authencate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Authencate->Sortable = TRUE; // Allow sort
		$this->fields['Authencate'] = &$this->Authencate;

		// EditDate
		$this->EditDate = new DbField('view_patient_services', 'view_patient_services', 'x_EditDate', 'EditDate', '`EditDate`', CastDateFieldForLike('`EditDate`', 0, "DB"), 135, 0, FALSE, '`EditDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EditBy
		$this->EditBy = new DbField('view_patient_services', 'view_patient_services', 'x_EditBy', 'EditBy', '`EditBy`', '`EditBy`', 200, -1, FALSE, '`EditBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EditBy->Sortable = TRUE; // Allow sort
		$this->fields['EditBy'] = &$this->EditBy;

		// Editted
		$this->Editted = new DbField('view_patient_services', 'view_patient_services', 'x_Editted', 'Editted', '`Editted`', '`Editted`', 200, -1, FALSE, '`Editted`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Editted->Sortable = TRUE; // Allow sort
		$this->fields['Editted'] = &$this->Editted;

		// PatID
		$this->PatID = new DbField('view_patient_services', 'view_patient_services', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientId
		$this->PatientId = new DbField('view_patient_services', 'view_patient_services', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// Mobile
		$this->Mobile = new DbField('view_patient_services', 'view_patient_services', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, -1, FALSE, '`Mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mobile->Sortable = TRUE; // Allow sort
		$this->fields['Mobile'] = &$this->Mobile;

		// CId
		$this->CId = new DbField('view_patient_services', 'view_patient_services', 'x_CId', 'CId', '`CId`', '`CId`', 3, -1, FALSE, '`CId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CId->Sortable = TRUE; // Allow sort
		$this->CId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['CId'] = &$this->CId;

		// Order
		$this->Order = new DbField('view_patient_services', 'view_patient_services', 'x_Order', 'Order', '`Order`', '`Order`', 131, -1, FALSE, '`Order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Form
		$this->Form = new DbField('view_patient_services', 'view_patient_services', 'x_Form', 'Form', '`Form`', '`Form`', 201, -1, FALSE, '`Form`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Form->Sortable = TRUE; // Allow sort
		$this->fields['Form'] = &$this->Form;

		// ResType
		$this->ResType = new DbField('view_patient_services', 'view_patient_services', 'x_ResType', 'ResType', '`ResType`', '`ResType`', 200, -1, FALSE, '`ResType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ResType->Sortable = TRUE; // Allow sort
		$this->fields['ResType'] = &$this->ResType;

		// Sample
		$this->Sample = new DbField('view_patient_services', 'view_patient_services', 'x_Sample', 'Sample', '`Sample`', '`Sample`', 200, -1, FALSE, '`Sample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sample->Sortable = TRUE; // Allow sort
		$this->fields['Sample'] = &$this->Sample;

		// NoD
		$this->NoD = new DbField('view_patient_services', 'view_patient_services', 'x_NoD', 'NoD', '`NoD`', '`NoD`', 131, -1, FALSE, '`NoD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoD->Sortable = TRUE; // Allow sort
		$this->NoD->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['NoD'] = &$this->NoD;

		// BillOrder
		$this->BillOrder = new DbField('view_patient_services', 'view_patient_services', 'x_BillOrder', 'BillOrder', '`BillOrder`', '`BillOrder`', 131, -1, FALSE, '`BillOrder`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Formula
		$this->Formula = new DbField('view_patient_services', 'view_patient_services', 'x_Formula', 'Formula', '`Formula`', '`Formula`', 201, -1, FALSE, '`Formula`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Formula->Sortable = TRUE; // Allow sort
		$this->fields['Formula'] = &$this->Formula;

		// Inactive
		$this->Inactive = new DbField('view_patient_services', 'view_patient_services', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, -1, FALSE, '`Inactive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Inactive->Sortable = TRUE; // Allow sort
		$this->fields['Inactive'] = &$this->Inactive;

		// CollSample
		$this->CollSample = new DbField('view_patient_services', 'view_patient_services', 'x_CollSample', 'CollSample', '`CollSample`', '`CollSample`', 200, -1, FALSE, '`CollSample`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CollSample->Sortable = TRUE; // Allow sort
		$this->fields['CollSample'] = &$this->CollSample;

		// TestType
		$this->TestType = new DbField('view_patient_services', 'view_patient_services', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, -1, FALSE, '`TestType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TestType->Sortable = TRUE; // Allow sort
		$this->fields['TestType'] = &$this->TestType;

		// Repeated
		$this->Repeated = new DbField('view_patient_services', 'view_patient_services', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, -1, FALSE, '`Repeated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Repeated->Sortable = TRUE; // Allow sort
		$this->fields['Repeated'] = &$this->Repeated;

		// RepeatedBy
		$this->RepeatedBy = new DbField('view_patient_services', 'view_patient_services', 'x_RepeatedBy', 'RepeatedBy', '`RepeatedBy`', '`RepeatedBy`', 200, -1, FALSE, '`RepeatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RepeatedBy->Sortable = TRUE; // Allow sort
		$this->fields['RepeatedBy'] = &$this->RepeatedBy;

		// RepeatedDate
		$this->RepeatedDate = new DbField('view_patient_services', 'view_patient_services', 'x_RepeatedDate', 'RepeatedDate', '`RepeatedDate`', CastDateFieldForLike('`RepeatedDate`', 0, "DB"), 135, 0, FALSE, '`RepeatedDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// serviceID
		$this->serviceID = new DbField('view_patient_services', 'view_patient_services', 'x_serviceID', 'serviceID', '`serviceID`', '`serviceID`', 3, -1, FALSE, '`serviceID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Service_Type
		$this->Service_Type = new DbField('view_patient_services', 'view_patient_services', 'x_Service_Type', 'Service_Type', '`Service_Type`', '`Service_Type`', 200, -1, FALSE, '`Service_Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Service_Type->Sortable = TRUE; // Allow sort
		$this->fields['Service_Type'] = &$this->Service_Type;

		// Service_Department
		$this->Service_Department = new DbField('view_patient_services', 'view_patient_services', 'x_Service_Department', 'Service_Department', '`Service_Department`', '`Service_Department`', 200, -1, FALSE, '`Service_Department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Service_Department->Sortable = TRUE; // Allow sort
		$this->fields['Service_Department'] = &$this->Service_Department;

		// RequestNo
		$this->RequestNo = new DbField('view_patient_services', 'view_patient_services', 'x_RequestNo', 'RequestNo', '`RequestNo`', '`RequestNo`', 3, -1, FALSE, '`RequestNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_patient_servicesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($this->getCurrentMasterTable() == "view_billing_voucher" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->Vid->CurrentValue);
		}
		if ($this->getCurrentMasterTable() == "view_billing_voucher_print" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
			$url .= (ContainsString($url, "?") ? "&" : "?") . TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->Vid->CurrentValue);
		}
		return $url;
