 ...
 */
class view_pharmacy_report_search_product extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DES
		$this->DES = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_DES', 'DES', '`DES`', '`DES`', 200, -1, FALSE, '`DES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DES->Sortable = TRUE; // Allow sort
		$this->fields['DES'] = &$this->DES;

		// BATCH
		$this->BATCH = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, -1, FALSE, '`BATCH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCH->Sortable = TRUE; // Allow sort
		$this->fields['BATCH'] = &$this->BATCH;

		// PRC
		$this->PRC = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// OQ
		$this->OQ = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, -1, FALSE, '`OQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OQ->Sortable = TRUE; // Allow sort
		$this->OQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['OQ'] = &$this->OQ;

		// Stock
		$this->Stock = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, -1, FALSE, '`Stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EXPDT
		$this->EXPDT = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike('`EXPDT`', 0, "DB"), 135, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GENNAME
		$this->GENNAME = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, -1, FALSE, '`GENNAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GENNAME->Sortable = TRUE; // Allow sort
		$this->fields['GENNAME'] = &$this->GENNAME;

		// UNIT
		$this->UNIT = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, -1, FALSE, '`UNIT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UNIT->Sortable = TRUE; // Allow sort
		$this->fields['UNIT'] = &$this->UNIT;

		// RT
		$this->RT = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_RT', 'RT', '`RT`', '`RT`', 131, -1, FALSE, '`RT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RT->Sortable = TRUE; // Allow sort
		$this->RT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RT'] = &$this->RT;

		// SSGST
		$this->SSGST = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SCGST
		$this->SCGST = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MFRCODE
		$this->MFRCODE = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = FALSE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// BILLDATE
		$this->BILLDATE = new DbField('view_pharmacy_report_search_product', 'view_pharmacy_report_search_product', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike('`BILLDATE`', 0, "DB"), 135, 0, FALSE, '`BILLDATE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_report_search_productlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_report_search_productview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_report_search_productedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_report_search_productadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_report_search_productview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_report_search_productview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_report_search_productadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_report_search_productadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_report_search_productedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_report_search_productadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_report_search_productdelete.php", $this->getUrlParm());
	}
