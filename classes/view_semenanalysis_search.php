...
class view_semenanalysis_search extends view_semenanalysis
{
	...
	protected function loadSearchValues()
	{
		...
		// PaID
		if (!$this->isAddOrEdit())
			$this->PaID->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PaID"));
		$this->PaID->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PaID"));

		// PaName
		if (!$this->isAddOrEdit())
			$this->PaName->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PaName"));
		$this->PaName->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PaName"));

		// PaMobile
		if (!$this->isAddOrEdit())
			$this->PaMobile->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PaMobile"));
		$this->PaMobile->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PaMobile"));
		...
		// HusbandName
		if (!$this->isAddOrEdit())
			$this->HusbandName->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HusbandName"));
		$this->HusbandName->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HusbandName"));

		// RequestDr
		if (!$this->isAddOrEdit())
			$this->RequestDr->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_RequestDr"));
		$this->RequestDr->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_RequestDr"));

		// CollectionDate
		if (!$this->isAddOrEdit())
			$this->CollectionDate->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_CollectionDate"));
		$this->CollectionDate->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_CollectionDate"));
		...
		// RequestSample
		if (!$this->isAddOrEdit())
			$this->RequestSample->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_RequestSample"));
		$this->RequestSample->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_RequestSample"));

		// CollectionType
		if (!$this->isAddOrEdit())
			$this->CollectionType->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_CollectionType"));
		$this->CollectionType->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_CollectionType"));

		// CollectionMethod
		if (!$this->isAddOrEdit())
			$this->CollectionMethod->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_CollectionMethod"));
		$this->CollectionMethod->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_CollectionMethod"));

		// Medicationused
		if (!$this->isAddOrEdit())
			$this->Medicationused->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Medicationused"));
		$this->Medicationused->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Medicationused"));

		// DifficultiesinCollection
		if (!$this->isAddOrEdit())
			$this->DifficultiesinCollection->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DifficultiesinCollection"));
		$this->DifficultiesinCollection->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DifficultiesinCollection"));

		// Volume
		if (!$this->isAddOrEdit())
			$this->Volume->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Volume"));
		$this->Volume->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Volume"));

		// pH
		if (!$this->isAddOrEdit())
			$this->pH->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_pH"));
		$this->pH->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_pH"));

		// Timeofcollection
		if (!$this->isAddOrEdit())
			$this->Timeofcollection->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Timeofcollection"));
		$this->Timeofcollection->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Timeofcollection"));

		// Timeofexamination
		if (!$this->isAddOrEdit())
			$this->Timeofexamination->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Timeofexamination"));
		$this->Timeofexamination->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Timeofexamination"));

		// Concentration
		if (!$this->isAddOrEdit())
			$this->Concentration->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Concentration"));
		$this->Concentration->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Concentration"));
		...
		// ProgressiveMotility
		if (!$this->isAddOrEdit())
			$this->ProgressiveMotility->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ProgressiveMotility"));
		$this->ProgressiveMotility->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ProgressiveMotility"));

		// NonProgrssiveMotile
		if (!$this->isAddOrEdit())
			$this->NonProgrssiveMotile->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NonProgrssiveMotile"));
		$this->NonProgrssiveMotile->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NonProgrssiveMotile"));

		// Immotile
		if (!$this->isAddOrEdit())
			$this->Immotile->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Immotile"));
		$this->Immotile->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Immotile"));

		// TotalProgrssiveMotile
		if (!$this->isAddOrEdit())
			$this->TotalProgrssiveMotile->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TotalProgrssiveMotile"));
		$this->TotalProgrssiveMotile->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TotalProgrssiveMotile"));

		// Appearance
		if (!$this->isAddOrEdit())
			$this->Appearance->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Appearance"));
		$this->Appearance->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Appearance"));

		// Homogenosity
		if (!$this->isAddOrEdit())
			$this->Homogenosity->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Homogenosity"));
		$this->Homogenosity->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Homogenosity"));

		// CompleteSample
		if (!$this->isAddOrEdit())
			$this->CompleteSample->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_CompleteSample"));
		$this->CompleteSample->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_CompleteSample"));

		// Liquefactiontime
		if (!$this->isAddOrEdit())
			$this->Liquefactiontime->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Liquefactiontime"));
		$this->Liquefactiontime->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Liquefactiontime"));

		// Normal
		if (!$this->isAddOrEdit())
			$this->Normal->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Normal"));
		$this->Normal->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Normal"));
		...
		// Headdefects
		if (!$this->isAddOrEdit())
			$this->Headdefects->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Headdefects"));
		$this->Headdefects->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Headdefects"));

		// MidpieceDefects
		if (!$this->isAddOrEdit())
			$this->MidpieceDefects->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_MidpieceDefects"));
		$this->MidpieceDefects->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_MidpieceDefects"));

		// TailDefects
		if (!$this->isAddOrEdit())
			$this->TailDefects->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TailDefects"));
		$this->TailDefects->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TailDefects"));

		// NormalProgMotile
		if (!$this->isAddOrEdit())
			$this->NormalProgMotile->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NormalProgMotile"));
		$this->NormalProgMotile->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NormalProgMotile"));

		// ImmatureForms
		if (!$this->isAddOrEdit())
			$this->ImmatureForms->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ImmatureForms"));
		$this->ImmatureForms->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ImmatureForms"));

		// Leucocytes
		if (!$this->isAddOrEdit())
			$this->Leucocytes->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Leucocytes"));
		$this->Leucocytes->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Leucocytes"));

		// Agglutination
		if (!$this->isAddOrEdit())
			$this->Agglutination->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Agglutination"));
		$this->Agglutination->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Agglutination"));

		// Debris
		if (!$this->isAddOrEdit())
			$this->Debris->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Debris"));
		$this->Debris->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Debris"));

		// Diagnosis
		if (!$this->isAddOrEdit())
			$this->Diagnosis->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Diagnosis"));
		$this->Diagnosis->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Diagnosis"));

		// Observations
		if (!$this->isAddOrEdit())
			$this->Observations->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Observations"));
		$this->Observations->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Observations"));

		// Signature
		if (!$this->isAddOrEdit())
			$this->Signature->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Signature"));
		$this->Signature->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Signature"));

		// SemenOrgin
		if (!$this->isAddOrEdit())
			$this->SemenOrgin->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SemenOrgin"));
		$this->SemenOrgin->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SemenOrgin"));

		// Donor
		if (!$this->isAddOrEdit())
			$this->Donor->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Donor"));
		$this->Donor->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Donor"));

		// DonorBloodgroup
		if (!$this->isAddOrEdit())
			$this->DonorBloodgroup->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DonorBloodgroup"));
		$this->DonorBloodgroup->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DonorBloodgroup"));

		// Tank
		if (!$this->isAddOrEdit())
			$this->Tank->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Tank"));
		$this->Tank->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Tank"));
		...
		// Volume1
		if (!$this->isAddOrEdit())
			$this->Volume1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Volume1"));
		$this->Volume1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Volume1"));

		// Concentration1
		if (!$this->isAddOrEdit())
			$this->Concentration1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Concentration1"));
		$this->Concentration1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Concentration1"));

		// Total1
		if (!$this->isAddOrEdit())
			$this->Total1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Total1"));
		$this->Total1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Total1"));

		// ProgressiveMotility1
		if (!$this->isAddOrEdit())
			$this->ProgressiveMotility1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ProgressiveMotility1"));
		$this->ProgressiveMotility1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ProgressiveMotility1"));

		// NonProgrssiveMotile1
		if (!$this->isAddOrEdit())
			$this->NonProgrssiveMotile1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NonProgrssiveMotile1"));
		$this->NonProgrssiveMotile1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NonProgrssiveMotile1"));

		// Immotile1
		if (!$this->isAddOrEdit())
			$this->Immotile1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Immotile1"));
		$this->Immotile1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Immotile1"));

		// TotalProgrssiveMotile1
		if (!$this->isAddOrEdit())
			$this->TotalProgrssiveMotile1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TotalProgrssiveMotile1"));
		$this->TotalProgrssiveMotile1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TotalProgrssiveMotile1"));
		...
		// DoneBy
		if (!$this->isAddOrEdit())
			$this->DoneBy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DoneBy"));
		$this->DoneBy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DoneBy"));
		...
		// Abstinence
		if (!$this->isAddOrEdit())
			$this->Abstinence->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Abstinence"));
		$this->Abstinence->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Abstinence"));

		// ProcessedBy
		if (!$this->isAddOrEdit())
			$this->ProcessedBy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ProcessedBy"));
		$this->ProcessedBy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ProcessedBy"));

		// InseminationTime
		if (!$this->isAddOrEdit())
			$this->InseminationTime->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_InseminationTime"));
		$this->InseminationTime->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_InseminationTime"));

		// InseminationBy
		if (!$this->isAddOrEdit())
			$this->InseminationBy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_InseminationBy"));
		$this->InseminationBy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_InseminationBy"));

		// Big
		if (!$this->isAddOrEdit())
			$this->Big->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Big"));
		$this->Big->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Big"));

		// Medium
		if (!$this->isAddOrEdit())
			$this->Medium->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Medium"));
		$this->Medium->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Medium"));

		// Small
		if (!$this->isAddOrEdit())
			$this->Small->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Small"));
		$this->Small->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Small"));

		// NoHalo
		if (!$this->isAddOrEdit())
			$this->NoHalo->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NoHalo"));
		$this->NoHalo->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NoHalo"));

		// Fragmented
		if (!$this->isAddOrEdit())
			$this->Fragmented->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Fragmented"));
		$this->Fragmented->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Fragmented"));

		// NonFragmented
		if (!$this->isAddOrEdit())
			$this->NonFragmented->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NonFragmented"));
		$this->NonFragmented->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NonFragmented"));

		// DFI
		if (!$this->isAddOrEdit())
			$this->DFI->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_DFI"));
		$this->DFI->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_DFI"));

		// IsueBy
		if (!$this->isAddOrEdit())
			$this->IsueBy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IsueBy"));
		$this->IsueBy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IsueBy"));

		// Volume2
		if (!$this->isAddOrEdit())
			$this->Volume2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Volume2"));
		$this->Volume2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Volume2"));

		// Concentration2
		if (!$this->isAddOrEdit())
			$this->Concentration2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Concentration2"));
		$this->Concentration2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Concentration2"));

		// Total2
		if (!$this->isAddOrEdit())
			$this->Total2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Total2"));
		$this->Total2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Total2"));

		// ProgressiveMotility2
		if (!$this->isAddOrEdit())
			$this->ProgressiveMotility2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ProgressiveMotility2"));
		$this->ProgressiveMotility2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ProgressiveMotility2"));

		// NonProgrssiveMotile2
		if (!$this->isAddOrEdit())
			$this->NonProgrssiveMotile2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_NonProgrssiveMotile2"));
		$this->NonProgrssiveMotile2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_NonProgrssiveMotile2"));

		// Immotile2
		if (!$this->isAddOrEdit())
			$this->Immotile2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Immotile2"));
		$this->Immotile2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Immotile2"));

		// TotalProgrssiveMotile2
		if (!$this->isAddOrEdit())
			$this->TotalProgrssiveMotile2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TotalProgrssiveMotile2"));
		$this->TotalProgrssiveMotile2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TotalProgrssiveMotile2"));

		// IssuedBy
		if (!$this->isAddOrEdit())
			$this->IssuedBy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IssuedBy"));
		$this->IssuedBy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IssuedBy"));

		// IssuedTo
		if (!$this->isAddOrEdit())
			$this->IssuedTo->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IssuedTo"));
		$this->IssuedTo->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IssuedTo"));

		// MACS
		if (!$this->isAddOrEdit())
			$this->MACS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_MACS"));
		$this->MACS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_MACS"));
		...
		// PREG_TEST_DATE
		if (!$this->isAddOrEdit())
			$this->PREG_TEST_DATE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PREG_TEST_DATE"));
		$this->PREG_TEST_DATE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PREG_TEST_DATE"));
		$this->PREG_TEST_DATE->AdvancedSearch->setSearchCondition($CurrentForm->getValue("v_PREG_TEST_DATE"));
		$this->PREG_TEST_DATE->AdvancedSearch->setSearchValue2($CurrentForm->getValue("y_PREG_TEST_DATE"));
		$this->PREG_TEST_DATE->AdvancedSearch->setSearchOperator2($CurrentForm->getValue("w_PREG_TEST_DATE"));

		// SPECIFIC_PROBLEMS
		if (!$this->isAddOrEdit())
			$this->SPECIFIC_PROBLEMS->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_SPECIFIC_PROBLEMS"));
		$this->SPECIFIC_PROBLEMS->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_SPECIFIC_PROBLEMS"));

		// IMSC_1
		if (!$this->isAddOrEdit())
			$this->IMSC_1->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IMSC_1"));
		$this->IMSC_1->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IMSC_1"));

		// IMSC_2
		if (!$this->isAddOrEdit())
			$this->IMSC_2->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IMSC_2"));
		$this->IMSC_2->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IMSC_2"));

		// LIQUIFACTION_STORAGE
		if (!$this->isAddOrEdit())
			$this->LIQUIFACTION_STORAGE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_LIQUIFACTION_STORAGE"));
		$this->LIQUIFACTION_STORAGE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_LIQUIFACTION_STORAGE"));

		// IUI_PREP_METHOD
		if (!$this->isAddOrEdit())
			$this->IUI_PREP_METHOD->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_IUI_PREP_METHOD"));
		$this->IUI_PREP_METHOD->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_IUI_PREP_METHOD"));

		// TIME_FROM_TRIGGER
		if (!$this->isAddOrEdit())
			$this->TIME_FROM_TRIGGER->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TIME_FROM_TRIGGER"));
		$this->TIME_FROM_TRIGGER->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TIME_FROM_TRIGGER"));

		// COLLECTION_TO_PREPARATION
		if (!$this->isAddOrEdit())
			$this->COLLECTION_TO_PREPARATION->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_COLLECTION_TO_PREPARATION"));
		$this->COLLECTION_TO_PREPARATION->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_COLLECTION_TO_PREPARATION"));

		// TIME_FROM_PREP_TO_INSEM
		if (!$this->isAddOrEdit())
			$this->TIME_FROM_PREP_TO_INSEM->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_TIME_FROM_PREP_TO_INSEM"));
		$this->TIME_FROM_PREP_TO_INSEM->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_TIME_FROM_PREP_TO_INSEM"));
	}
