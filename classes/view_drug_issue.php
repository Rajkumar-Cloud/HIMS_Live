 ...
 */
class view_drug_issue extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// BILLNO
		$this->BILLNO = new DbField('view_drug_issue', 'view_drug_issue', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, -1, FALSE, '`BILLNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BILLNO->Sortable = TRUE; // Allow sort
		$this->fields['BILLNO'] = &$this->BILLNO;

		// Doctor
		$this->Doctor = new DbField('view_drug_issue', 'view_drug_issue', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, -1, FALSE, '`Doctor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Doctor->Sortable = TRUE; // Allow sort
		$this->fields['Doctor'] = &$this->Doctor;

		// PatientId
		$this->PatientId = new DbField('view_drug_issue', 'view_drug_issue', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->fields['PatientId'] = &$this->PatientId;

		// PatientName
		$this->PatientName = new DbField('view_drug_issue', 'view_drug_issue', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Product
		$this->Product = new DbField('view_drug_issue', 'view_drug_issue', 'x_Product', 'Product', '`Product`', '`Product`', 200, -1, FALSE, '`Product`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Product->Sortable = TRUE; // Allow sort
		$this->fields['Product'] = &$this->Product;

		// IQ
		$this->IQ = new DbField('view_drug_issue', 'view_drug_issue', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, -1, FALSE, '`IQ`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IQ->Sortable = TRUE; // Allow sort
		$this->IQ->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['IQ'] = &$this->IQ;

		// Mfg
		$this->Mfg = new DbField('view_drug_issue', 'view_drug_issue', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, -1, FALSE, '`Mfg`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mfg->Sortable = TRUE; // Allow sort
		$this->fields['Mfg'] = &$this->Mfg;

		// BATCHNO
		$this->BATCHNO = new DbField('view_drug_issue', 'view_drug_issue', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, -1, FALSE, '`BATCHNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BATCHNO->Sortable = TRUE; // Allow sort
		$this->fields['BATCHNO'] = &$this->BATCHNO;

		// EXPDT
		$this->EXPDT = new DbField('view_drug_issue', 'view_drug_issue', 'x_EXPDT', 'EXPDT', '`EXPDT`', '`EXPDT`', 200, 0, FALSE, '`EXPDT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createddatetime
		$this->createddatetime = new DbField('view_drug_issue', 'view_drug_issue', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// HospID
		$this->HospID = new DbField('view_drug_issue', 'view_drug_issue', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_drug_issuelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_drug_issueview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_drug_issueedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_drug_issueadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_drug_issueview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_drug_issueview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_drug_issueadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_drug_issueadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_drug_issueedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_drug_issueadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_drug_issuedelete.php", $this->getUrlParm());
	}
