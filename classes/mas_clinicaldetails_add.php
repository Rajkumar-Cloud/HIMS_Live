 ...
 * Page class
 */
class mas_clinicaldetails_add extends mas_clinicaldetails
{
	...
	// Page object name
	public $PageObjName = "mas_clinicaldetails_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("mas_clinicaldetailslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "mas_clinicaldetailslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "mas_clinicaldetailsview.php")
	...
	protected function validateForm()
	{
		...
		if ($this->ClinicalDetails->Required) {
			if (!$this->ClinicalDetails->IsDetailKey && $this->ClinicalDetails->FormValue != NULL && $this->ClinicalDetails->FormValue == "") {
