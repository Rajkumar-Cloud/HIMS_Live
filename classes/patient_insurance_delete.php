 ...
 * Page class
 */
class patient_insurance_delete extends patient_insurance
{
	...
	// Page object name
	public $PageObjName = "patient_insurance_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_insurancelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_insurancelist.php"); // Return to list
			}
		}
	}
