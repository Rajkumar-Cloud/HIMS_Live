...
class ivf_search extends ivf
{
	...
	protected function loadSearchValues()
	{
		...
		// Male
		if (!$this->isAddOrEdit())
			$this->Male->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Male"));
		$this->Male->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Male"));

		// Female
		if (!$this->isAddOrEdit())
			$this->Female->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Female"));
		$this->Female->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Female"));
		...
		// malepropic
		if (!$this->isAddOrEdit())
			$this->malepropic->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_malepropic"));
		$this->malepropic->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_malepropic"));

		// femalepropic
		if (!$this->isAddOrEdit())
			$this->femalepropic->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_femalepropic"));
		$this->femalepropic->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_femalepropic"));

		// HusbandEducation
		if (!$this->isAddOrEdit())
			$this->HusbandEducation->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HusbandEducation"));
		$this->HusbandEducation->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HusbandEducation"));

		// WifeEducation
		if (!$this->isAddOrEdit())
			$this->WifeEducation->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_WifeEducation"));
		$this->WifeEducation->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_WifeEducation"));

		// HusbandWorkHours
		if (!$this->isAddOrEdit())
			$this->HusbandWorkHours->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HusbandWorkHours"));
		$this->HusbandWorkHours->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HusbandWorkHours"));

		// WifeWorkHours
		if (!$this->isAddOrEdit())
			$this->WifeWorkHours->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_WifeWorkHours"));
		$this->WifeWorkHours->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_WifeWorkHours"));

		// PatientLanguage
		if (!$this->isAddOrEdit())
			$this->PatientLanguage->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_PatientLanguage"));
		$this->PatientLanguage->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_PatientLanguage"));

		// ReferedBy
		if (!$this->isAddOrEdit())
			$this->ReferedBy->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ReferedBy"));
		$this->ReferedBy->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ReferedBy"));

		// ReferPhNo
		if (!$this->isAddOrEdit())
			$this->ReferPhNo->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ReferPhNo"));
		$this->ReferPhNo->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ReferPhNo"));

		// WifeCell
		if (!$this->isAddOrEdit())
			$this->WifeCell->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_WifeCell"));
		$this->WifeCell->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_WifeCell"));

		// HusbandCell
		if (!$this->isAddOrEdit())
			$this->HusbandCell->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HusbandCell"));
		$this->HusbandCell->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HusbandCell"));

		// WifeEmail
		if (!$this->isAddOrEdit())
			$this->WifeEmail->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_WifeEmail"));
		$this->WifeEmail->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_WifeEmail"));

		// HusbandEmail
		if (!$this->isAddOrEdit())
			$this->HusbandEmail->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_HusbandEmail"));
		$this->HusbandEmail->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_HusbandEmail"));

		// ARTCYCLE
		if (!$this->isAddOrEdit())
			$this->ARTCYCLE->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_ARTCYCLE"));
		$this->ARTCYCLE->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_ARTCYCLE"));
		...
		// malepic
		if (!$this->isAddOrEdit())
			$this->malepic->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_malepic"));
		$this->malepic->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_malepic"));

		// femalepic
		if (!$this->isAddOrEdit())
			$this->femalepic->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_femalepic"));
		$this->femalepic->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_femalepic"));

		// Mgendar
		if (!$this->isAddOrEdit())
			$this->Mgendar->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Mgendar"));
		$this->Mgendar->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Mgendar"));

		// Fgendar
		if (!$this->isAddOrEdit())
			$this->Fgendar->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_Fgendar"));
		$this->Fgendar->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_Fgendar"));
