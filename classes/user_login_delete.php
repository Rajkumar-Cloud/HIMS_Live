 ...
 * Page class
 */
class user_login_delete extends user_login
{
	...
	// Page object name
	public $PageObjName = "user_login_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("user_loginlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("user_loginlist.php"); // Return to list
			}
		}
	}
