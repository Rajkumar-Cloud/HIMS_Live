 ...
 * Page class
 */
class pres_mas_unit_add extends pres_mas_unit
{
	...
	// Page object name
	public $PageObjName = "pres_mas_unit_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("pres_mas_unitlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "pres_mas_unitlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "pres_mas_unitview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Units
		$this->Units->setDbValueDef($rsnew, $this->Units->CurrentValue, "", FALSE);
