 ...
 */
class employee_skills extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_skills', 'employee_skills', 'x_id', 'id', '`id`', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// skill_id
		$this->skill_id = new DbField('employee_skills', 'employee_skills', 'x_skill_id', 'skill_id', '`skill_id`', '`skill_id`', 20, -1, FALSE, '`skill_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// employee
		$this->employee = new DbField('employee_skills', 'employee_skills', 'x_employee', 'employee', '`employee`', '`employee`', 3, -1, FALSE, '`employee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// details
		$this->details = new DbField('employee_skills', 'employee_skills', 'x_details', 'details', '`details`', '`details`', 201, -1, FALSE, '`details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_skillslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_skillsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_skillsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_skillsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_skillsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_skillsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_skillsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_skillsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_skillsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_skillsdelete.php", $this->getUrlParm());
	}
