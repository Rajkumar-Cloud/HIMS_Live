 ...
 * Page class
 */
class patient_vitals_list extends patient_vitals
{
	...
	// Page object name
	public $PageObjName = "patient_vitals_list";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "patient_vitalsdelete.php";
		$this->MultiUpdateUrl = "patient_vitalsupdate.php";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_vitalslistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_vitalslistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fpatient_vitalslist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_vitalslistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"btn btn-default ew-advanced-aearch\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"patient_vitalssrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-highlight active\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fpatient_vitalslistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</button>";
	...
	protected function loadSearchValues()
	{
		...
		// HT
		if (!$this->isAddOrEdit())
			$this->HT->AdvancedSearch->setSearchValue(Get("x_HT", Get("HT", "")));
		if ($this->HT->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->HT->AdvancedSearch->setSearchOperator(Get("z_HT", ""));

		// WT
		if (!$this->isAddOrEdit())
			$this->WT->AdvancedSearch->setSearchValue(Get("x_WT", Get("WT", "")));
		if ($this->WT->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->WT->AdvancedSearch->setSearchOperator(Get("z_WT", ""));

		// SurfaceArea
		if (!$this->isAddOrEdit())
			$this->SurfaceArea->AdvancedSearch->setSearchValue(Get("x_SurfaceArea", Get("SurfaceArea", "")));
		if ($this->SurfaceArea->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->SurfaceArea->AdvancedSearch->setSearchOperator(Get("z_SurfaceArea", ""));

		// BodyMassIndex
		if (!$this->isAddOrEdit())
			$this->BodyMassIndex->AdvancedSearch->setSearchValue(Get("x_BodyMassIndex", Get("BodyMassIndex", "")));
		if ($this->BodyMassIndex->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->BodyMassIndex->AdvancedSearch->setSearchOperator(Get("z_BodyMassIndex", ""));

		// ClinicalFindings
		if (!$this->isAddOrEdit())
			$this->ClinicalFindings->AdvancedSearch->setSearchValue(Get("x_ClinicalFindings", Get("ClinicalFindings", "")));
		if ($this->ClinicalFindings->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ClinicalFindings->AdvancedSearch->setSearchOperator(Get("z_ClinicalFindings", ""));

		// ClinicalDiagnosis
		if (!$this->isAddOrEdit())
			$this->ClinicalDiagnosis->AdvancedSearch->setSearchValue(Get("x_ClinicalDiagnosis", Get("ClinicalDiagnosis", "")));
		if ($this->ClinicalDiagnosis->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->ClinicalDiagnosis->AdvancedSearch->setSearchOperator(Get("z_ClinicalDiagnosis", ""));

		// AnticoagulantifAny
		if (!$this->isAddOrEdit())
			$this->AnticoagulantifAny->AdvancedSearch->setSearchValue(Get("x_AnticoagulantifAny", Get("AnticoagulantifAny", "")));
		if ($this->AnticoagulantifAny->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->AnticoagulantifAny->AdvancedSearch->setSearchOperator(Get("z_AnticoagulantifAny", ""));

		// FoodAllergies
		if (!$this->isAddOrEdit())
			$this->FoodAllergies->AdvancedSearch->setSearchValue(Get("x_FoodAllergies", Get("FoodAllergies", "")));
		if ($this->FoodAllergies->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->FoodAllergies->AdvancedSearch->setSearchOperator(Get("z_FoodAllergies", ""));

		// GenericAllergies
		if (!$this->isAddOrEdit())
			$this->GenericAllergies->AdvancedSearch->setSearchValue(Get("x_GenericAllergies", Get("GenericAllergies", "")));
		if ($this->GenericAllergies->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->GenericAllergies->AdvancedSearch->setSearchOperator(Get("z_GenericAllergies", ""));
		...
		// GroupAllergies
		if (!$this->isAddOrEdit())
			$this->GroupAllergies->AdvancedSearch->setSearchValue(Get("x_GroupAllergies", Get("GroupAllergies", "")));
		if ($this->GroupAllergies->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->GroupAllergies->AdvancedSearch->setSearchOperator(Get("z_GroupAllergies", ""));
		...
		// PR
		if (!$this->isAddOrEdit())
			$this->PR->AdvancedSearch->setSearchValue(Get("x_PR", Get("PR", "")));
		if ($this->PR->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PR->AdvancedSearch->setSearchOperator(Get("z_PR", ""));

		// CNS
		if (!$this->isAddOrEdit())
			$this->CNS->AdvancedSearch->setSearchValue(Get("x_CNS", Get("CNS", "")));
		if ($this->CNS->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->CNS->AdvancedSearch->setSearchOperator(Get("z_CNS", ""));

		// RSA
		if (!$this->isAddOrEdit())
			$this->RSA->AdvancedSearch->setSearchValue(Get("x_RSA", Get("RSA", "")));
		if ($this->RSA->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->RSA->AdvancedSearch->setSearchOperator(Get("z_RSA", ""));

		// CVS
		if (!$this->isAddOrEdit())
			$this->CVS->AdvancedSearch->setSearchValue(Get("x_CVS", Get("CVS", "")));
		if ($this->CVS->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->CVS->AdvancedSearch->setSearchOperator(Get("z_CVS", ""));

		// PA
		if (!$this->isAddOrEdit())
			$this->PA->AdvancedSearch->setSearchValue(Get("x_PA", Get("PA", "")));
		if ($this->PA->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PA->AdvancedSearch->setSearchOperator(Get("z_PA", ""));

		// PS
		if (!$this->isAddOrEdit())
			$this->PS->AdvancedSearch->setSearchValue(Get("x_PS", Get("PS", "")));
		if ($this->PS->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PS->AdvancedSearch->setSearchOperator(Get("z_PS", ""));

		// PV
		if (!$this->isAddOrEdit())
			$this->PV->AdvancedSearch->setSearchValue(Get("x_PV", Get("PV", "")));
		if ($this->PV->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->PV->AdvancedSearch->setSearchOperator(Get("z_PV", ""));

		// clinicaldetails
		if (!$this->isAddOrEdit())
			$this->clinicaldetails->AdvancedSearch->setSearchValue(Get("x_clinicaldetails", Get("clinicaldetails", "")));
		if ($this->clinicaldetails->AdvancedSearch->SearchValue <> "" && $this->Command == "")
			$this->Command = "search";
		$this->clinicaldetails->AdvancedSearch->setSearchOperator(Get("z_clinicaldetails", ""));
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.fpatient_vitalslist,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.fpatient_vitalslist,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.fpatient_vitalslist,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
