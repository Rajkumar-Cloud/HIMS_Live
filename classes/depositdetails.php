...
class depositdetails extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('depositdetails', 'depositdetails', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DepositDate
		$this->DepositDate = new DbField('depositdetails', 'depositdetails', 'x_DepositDate', 'DepositDate', '`DepositDate`', CastDateFieldForLike('`DepositDate`', 7, "DB"), 135, 7, FALSE, '`DepositDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DepositToBankSelect
		$this->DepositToBankSelect = new DbField('depositdetails', 'depositdetails', 'x_DepositToBankSelect', 'DepositToBankSelect', '`DepositToBankSelect`', '`DepositToBankSelect`', 200, -1, FALSE, '`DepositToBankSelect`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// DepositToBank
		$this->DepositToBank = new DbField('depositdetails', 'depositdetails', 'x_DepositToBank', 'DepositToBank', '`DepositToBank`', '`DepositToBank`', 200, -1, FALSE, '`DepositToBank`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TransferToSelect
		$this->TransferToSelect = new DbField('depositdetails', 'depositdetails', 'x_TransferToSelect', 'TransferToSelect', '`TransferToSelect`', '`TransferToSelect`', 200, -1, FALSE, '`TransferToSelect`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TransferToSelect->Sortable = TRUE; // Allow sort
		$this->fields['TransferToSelect'] = &$this->TransferToSelect;

		// TransferTo
		$this->TransferTo = new DbField('depositdetails', 'depositdetails', 'x_TransferTo', 'TransferTo', '`TransferTo`', '`TransferTo`', 200, -1, FALSE, '`TransferTo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// OpeningBalance
		$this->OpeningBalance = new DbField('depositdetails', 'depositdetails', 'x_OpeningBalance', 'OpeningBalance', '`OpeningBalance`', '`OpeningBalance`', 131, -1, FALSE, '`OpeningBalance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->OpeningBalance->Sortable = TRUE; // Allow sort
		$this->fields['OpeningBalance'] = &$this->OpeningBalance;

		// Other
		$this->Other = new DbField('depositdetails', 'depositdetails', 'x_Other', 'Other', '`Other`', '`Other`', 131, -1, FALSE, '`Other`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Other->Sortable = TRUE; // Allow sort
		$this->fields['Other'] = &$this->Other;

		// TotalCash
		$this->TotalCash = new DbField('depositdetails', 'depositdetails', 'x_TotalCash', 'TotalCash', '`TotalCash`', '`TotalCash`', 131, -1, FALSE, '`TotalCash`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TotalCash->Sortable = TRUE; // Allow sort
		$this->fields['TotalCash'] = &$this->TotalCash;

		// Cheque
		$this->Cheque = new DbField('depositdetails', 'depositdetails', 'x_Cheque', 'Cheque', '`Cheque`', '`Cheque`', 131, -1, FALSE, '`Cheque`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cheque->Sortable = TRUE; // Allow sort
		$this->fields['Cheque'] = &$this->Cheque;

		// Card
		$this->Card = new DbField('depositdetails', 'depositdetails', 'x_Card', 'Card', '`Card`', '`Card`', 131, -1, FALSE, '`Card`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Card->Sortable = TRUE; // Allow sort
		$this->fields['Card'] = &$this->Card;

		// NEFTRTGS
		$this->NEFTRTGS = new DbField('depositdetails', 'depositdetails', 'x_NEFTRTGS', 'NEFTRTGS', '`NEFTRTGS`', '`NEFTRTGS`', 131, -1, FALSE, '`NEFTRTGS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NEFTRTGS->Sortable = TRUE; // Allow sort
		$this->fields['NEFTRTGS'] = &$this->NEFTRTGS;

		// TotalTransferDepositAmount
		$this->TotalTransferDepositAmount = new DbField('depositdetails', 'depositdetails', 'x_TotalTransferDepositAmount', 'TotalTransferDepositAmount', '`TotalTransferDepositAmount`', '`TotalTransferDepositAmount`', 131, -1, FALSE, '`TotalTransferDepositAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CreatedBy
		$this->CreatedBy = new DbField('depositdetails', 'depositdetails', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('depositdetails', 'depositdetails', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedDateTime->Sortable = TRUE; // Allow sort
		$this->CreatedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['CreatedDateTime'] = &$this->CreatedDateTime;

		// ModifiedBy
		$this->ModifiedBy = new DbField('depositdetails', 'depositdetails', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('depositdetails', 'depositdetails', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike('`ModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedDateTime->Sortable = TRUE; // Allow sort
		$this->ModifiedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['ModifiedDateTime'] = &$this->ModifiedDateTime;

		// CreatedUserName
		$this->CreatedUserName = new DbField('depositdetails', 'depositdetails', 'x_CreatedUserName', 'CreatedUserName', '`CreatedUserName`', '`CreatedUserName`', 200, -1, FALSE, '`CreatedUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedUserName->Sortable = TRUE; // Allow sort
		$this->fields['CreatedUserName'] = &$this->CreatedUserName;

		// ModifiedUserName
		$this->ModifiedUserName = new DbField('depositdetails', 'depositdetails', 'x_ModifiedUserName', 'ModifiedUserName', '`ModifiedUserName`', '`ModifiedUserName`', 200, -1, FALSE, '`ModifiedUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedUserName->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedUserName'] = &$this->ModifiedUserName;

		// A2000Count
		$this->A2000Count = new DbField('depositdetails', 'depositdetails', 'x_A2000Count', 'A2000Count', '`A2000Count`', '`A2000Count`', 3, -1, FALSE, '`A2000Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A2000Amount
		$this->A2000Amount = new DbField('depositdetails', 'depositdetails', 'x_A2000Amount', 'A2000Amount', '`A2000Amount`', '`A2000Amount`', 131, -1, FALSE, '`A2000Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A1000Count
		$this->A1000Count = new DbField('depositdetails', 'depositdetails', 'x_A1000Count', 'A1000Count', '`A1000Count`', '`A1000Count`', 3, -1, FALSE, '`A1000Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A1000Amount
		$this->A1000Amount = new DbField('depositdetails', 'depositdetails', 'x_A1000Amount', 'A1000Amount', '`A1000Amount`', '`A1000Amount`', 131, -1, FALSE, '`A1000Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A500Count
		$this->A500Count = new DbField('depositdetails', 'depositdetails', 'x_A500Count', 'A500Count', '`A500Count`', '`A500Count`', 3, -1, FALSE, '`A500Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A500Amount
		$this->A500Amount = new DbField('depositdetails', 'depositdetails', 'x_A500Amount', 'A500Amount', '`A500Amount`', '`A500Amount`', 131, -1, FALSE, '`A500Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A200Count
		$this->A200Count = new DbField('depositdetails', 'depositdetails', 'x_A200Count', 'A200Count', '`A200Count`', '`A200Count`', 3, -1, FALSE, '`A200Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A200Amount
		$this->A200Amount = new DbField('depositdetails', 'depositdetails', 'x_A200Amount', 'A200Amount', '`A200Amount`', '`A200Amount`', 131, -1, FALSE, '`A200Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A100Count
		$this->A100Count = new DbField('depositdetails', 'depositdetails', 'x_A100Count', 'A100Count', '`A100Count`', '`A100Count`', 3, -1, FALSE, '`A100Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A100Amount
		$this->A100Amount = new DbField('depositdetails', 'depositdetails', 'x_A100Amount', 'A100Amount', '`A100Amount`', '`A100Amount`', 131, -1, FALSE, '`A100Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A50Count
		$this->A50Count = new DbField('depositdetails', 'depositdetails', 'x_A50Count', 'A50Count', '`A50Count`', '`A50Count`', 3, -1, FALSE, '`A50Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A50Amount
		$this->A50Amount = new DbField('depositdetails', 'depositdetails', 'x_A50Amount', 'A50Amount', '`A50Amount`', '`A50Amount`', 131, -1, FALSE, '`A50Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A20Count
		$this->A20Count = new DbField('depositdetails', 'depositdetails', 'x_A20Count', 'A20Count', '`A20Count`', '`A20Count`', 3, -1, FALSE, '`A20Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A20Amount
		$this->A20Amount = new DbField('depositdetails', 'depositdetails', 'x_A20Amount', 'A20Amount', '`A20Amount`', '`A20Amount`', 131, -1, FALSE, '`A20Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A10Count
		$this->A10Count = new DbField('depositdetails', 'depositdetails', 'x_A10Count', 'A10Count', '`A10Count`', '`A10Count`', 3, -1, FALSE, '`A10Count`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// A10Amount
		$this->A10Amount = new DbField('depositdetails', 'depositdetails', 'x_A10Amount', 'A10Amount', '`A10Amount`', '`A10Amount`', 131, -1, FALSE, '`A10Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BalanceAmount
		$this->BalanceAmount = new DbField('depositdetails', 'depositdetails', 'x_BalanceAmount', 'BalanceAmount', '`BalanceAmount`', '`BalanceAmount`', 131, -1, FALSE, '`BalanceAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CashCollected
		$this->CashCollected = new DbField('depositdetails', 'depositdetails', 'x_CashCollected', 'CashCollected', '`CashCollected`', '`CashCollected`', 131, -1, FALSE, '`CashCollected`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// RTGS
		$this->RTGS = new DbField('depositdetails', 'depositdetails', 'x_RTGS', 'RTGS', '`RTGS`', '`RTGS`', 131, -1, FALSE, '`RTGS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RTGS->Sortable = TRUE; // Allow sort
		$this->RTGS->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['RTGS'] = &$this->RTGS;

		// PAYTM
		$this->PAYTM = new DbField('depositdetails', 'depositdetails', 'x_PAYTM', 'PAYTM', '`PAYTM`', '`PAYTM`', 131, -1, FALSE, '`PAYTM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('depositdetails', 'depositdetails', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// ManualCash
		$this->ManualCash = new DbField('depositdetails', 'depositdetails', 'x_ManualCash', 'ManualCash', '`ManualCash`', '`ManualCash`', 131, -1, FALSE, '`ManualCash`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ManualCard
		$this->ManualCard = new DbField('depositdetails', 'depositdetails', 'x_ManualCard', 'ManualCard', '`ManualCard`', '`ManualCard`', 131, -1, FALSE, '`ManualCard`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("depositdetailsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
