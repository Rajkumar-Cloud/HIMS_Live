 ...
 * Page class
 */
class employee_dependents_add extends employee_dependents
{
	...
	// Page object name
	public $PageObjName = "employee_dependents_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "employee_dependentsview.php")
