...
class billing_other_voucher extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// freezed
		$this->freezed = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_freezed', 'freezed', '`freezed`', '`freezed`', 200, -1, FALSE, '`freezed`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->freezed->Sortable = FALSE; // Allow sort
		$this->fields['freezed'] = &$this->freezed;

		// AdvanceNo
		$this->AdvanceNo = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_AdvanceNo', 'AdvanceNo', '`AdvanceNo`', '`AdvanceNo`', 200, -1, FALSE, '`AdvanceNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AdvanceNo->Sortable = TRUE; // Allow sort
		$this->fields['AdvanceNo'] = &$this->AdvanceNo;

		// PatientID
		$this->PatientID = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Required = TRUE; // Required field
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// PatientName
		$this->PatientName = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Required = TRUE; // Required field
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Mobile
		$this->Mobile = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, -1, FALSE, '`Mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mobile->Sortable = TRUE; // Allow sort
		$this->fields['Mobile'] = &$this->Mobile;

		// ModeofPayment
		$this->ModeofPayment = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, -1, FALSE, '`ModeofPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Amount
		$this->Amount = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CardNumber
		$this->CardNumber = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, -1, FALSE, '`CardNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CardNumber->Sortable = TRUE; // Allow sort
		$this->fields['CardNumber'] = &$this->CardNumber;

		// BankName
		$this->BankName = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, -1, FALSE, '`BankName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankName->Sortable = TRUE; // Allow sort
		$this->fields['BankName'] = &$this->BankName;

		// Name
		$this->Name = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// voucher_type
		$this->voucher_type = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, -1, FALSE, '`voucher_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->voucher_type->Sortable = TRUE; // Allow sort
		$this->fields['voucher_type'] = &$this->voucher_type;

		// Details
		$this->Details = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Details', 'Details', '`Details`', '`Details`', 200, -1, FALSE, '`Details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Details->Sortable = TRUE; // Allow sort
		$this->fields['Details'] = &$this->Details;

		// Date
		$this->Date = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Date', 'Date', '`Date`', CastDateFieldForLike('`Date`', 7, "DB"), 135, 7, FALSE, '`Date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AnyDues
		$this->AnyDues = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_AnyDues', 'AnyDues', '`AnyDues`', '`AnyDues`', 200, -1, FALSE, '`AnyDues`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AnyDues->Sortable = TRUE; // Allow sort
		$this->fields['AnyDues'] = &$this->AnyDues;

		// createdby
		$this->createdby = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 7, "DB"), 135, 7, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// modifiedby
		$this->modifiedby = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// PatID
		$this->PatID = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// VisiteType
		$this->VisiteType = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_VisiteType', 'VisiteType', '`VisiteType`', '`VisiteType`', 200, -1, FALSE, '`VisiteType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VisiteType->Sortable = TRUE; // Allow sort
		$this->fields['VisiteType'] = &$this->VisiteType;

		// VisitDate
		$this->VisitDate = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_VisitDate', 'VisitDate', '`VisitDate`', CastDateFieldForLike('`VisitDate`', 0, "DB"), 135, -1, FALSE, '`VisitDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VisitDate->Sortable = TRUE; // Allow sort
		$this->fields['VisitDate'] = &$this->VisitDate;

		// Status
		$this->Status = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Status', 'Status', '`Status`', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Status->Sortable = TRUE; // Allow sort
		$this->fields['Status'] = &$this->Status;

		// AdvanceValidityDate
		$this->AdvanceValidityDate = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_AdvanceValidityDate', 'AdvanceValidityDate', '`AdvanceValidityDate`', CastDateFieldForLike('`AdvanceValidityDate`', 0, "DB"), 135, 0, FALSE, '`AdvanceValidityDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->TotalRemainingAdvance = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_TotalRemainingAdvance', 'TotalRemainingAdvance', '`TotalRemainingAdvance`', '`TotalRemainingAdvance`', 200, -1, FALSE, '`TotalRemainingAdvance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TotalRemainingAdvance->Sortable = TRUE; // Allow sort
		$this->fields['TotalRemainingAdvance'] = &$this->TotalRemainingAdvance;

		// Remarks
		$this->Remarks = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// SeectPaymentMode
		$this->SeectPaymentMode = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_SeectPaymentMode', 'SeectPaymentMode', '`SeectPaymentMode`', '`SeectPaymentMode`', 200, -1, FALSE, '`SeectPaymentMode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SeectPaymentMode->Sortable = TRUE; // Allow sort
		$this->fields['SeectPaymentMode'] = &$this->SeectPaymentMode;

		// PaidAmount
		$this->PaidAmount = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_PaidAmount', 'PaidAmount', '`PaidAmount`', '`PaidAmount`', 200, -1, FALSE, '`PaidAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaidAmount->Sortable = TRUE; // Allow sort
		$this->fields['PaidAmount'] = &$this->PaidAmount;

		// Currency
		$this->Currency = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, -1, FALSE, '`Currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Currency->Sortable = TRUE; // Allow sort
		$this->fields['Currency'] = &$this->Currency;

		// HospID
		$this->HospID = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// Reception
		$this->Reception = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// mrnno
		$this->mrnno = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// GetUserName
		$this->GetUserName = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_GetUserName', 'GetUserName', '`GetUserName`', '`GetUserName`', 200, -1, FALSE, '`GetUserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GetUserName->Sortable = TRUE; // Allow sort
		$this->fields['GetUserName'] = &$this->GetUserName;

		// AdjustmentwithAdvance
		$this->AdjustmentwithAdvance = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_AdjustmentwithAdvance', 'AdjustmentwithAdvance', '`AdjustmentwithAdvance`', '`AdjustmentwithAdvance`', 200, -1, FALSE, '`AdjustmentwithAdvance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->AdjustmentBillNumber = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_AdjustmentBillNumber', 'AdjustmentBillNumber', '`AdjustmentBillNumber`', '`AdjustmentBillNumber`', 200, -1, FALSE, '`AdjustmentBillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AdjustmentBillNumber->Sortable = TRUE; // Allow sort
		$this->fields['AdjustmentBillNumber'] = &$this->AdjustmentBillNumber;

		// CancelAdvance
		$this->CancelAdvance = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelAdvance', 'CancelAdvance', '`CancelAdvance`', '`CancelAdvance`', 200, -1, FALSE, '`CancelAdvance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// CancelReasan
		$this->CancelReasan = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelReasan', 'CancelReasan', '`CancelReasan`', '`CancelReasan`', 201, -1, FALSE, '`CancelReasan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->CancelReasan->Sortable = TRUE; // Allow sort
		$this->fields['CancelReasan'] = &$this->CancelReasan;

		// CancelBy
		$this->CancelBy = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelBy', 'CancelBy', '`CancelBy`', '`CancelBy`', 200, -1, FALSE, '`CancelBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CancelBy->Sortable = TRUE; // Allow sort
		$this->fields['CancelBy'] = &$this->CancelBy;

		// CancelDate
		$this->CancelDate = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelDate', 'CancelDate', '`CancelDate`', CastDateFieldForLike('`CancelDate`', 7, "DB"), 135, 7, FALSE, '`CancelDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CancelDateTime
		$this->CancelDateTime = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelDateTime', 'CancelDateTime', '`CancelDateTime`', CastDateFieldForLike('`CancelDateTime`', 0, "DB"), 135, 0, FALSE, '`CancelDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CanceledBy
		$this->CanceledBy = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CanceledBy', 'CanceledBy', '`CanceledBy`', '`CanceledBy`', 200, -1, FALSE, '`CanceledBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CanceledBy->Sortable = TRUE; // Allow sort
		$this->fields['CanceledBy'] = &$this->CanceledBy;

		// CancelStatus
		$this->CancelStatus = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelStatus', 'CancelStatus', '`CancelStatus`', '`CancelStatus`', 200, -1, FALSE, '`CancelStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Cash
		$this->Cash = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Cash', 'Cash', '`Cash`', '`Cash`', 131, -1, FALSE, '`Cash`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cash->Sortable = TRUE; // Allow sort
		$this->Cash->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Cash'] = &$this->Cash;

		// Card
		$this->Card = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Card', 'Card', '`Card`', '`Card`', 131, -1, FALSE, '`Card`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`HospID`='".HospitalID()."'  and  (freezed != 'Yes' or   freezed is null )  ";
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("billing_other_voucherview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
