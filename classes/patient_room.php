...
class patient_room extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient_room', 'patient_room', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Reception
		$this->Reception = new DbField('patient_room', 'patient_room', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientId
		$this->PatientId = new DbField('patient_room', 'patient_room', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 3, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientId->Sortable = TRUE; // Allow sort
		$this->PatientId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PatientId'] = &$this->PatientId;

		// mrnno
		$this->mrnno = new DbField('patient_room', 'patient_room', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->IsForeignKey = TRUE; // Foreign key field
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// PatientName
		$this->PatientName = new DbField('patient_room', 'patient_room', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// Gender
		$this->Gender = new DbField('patient_room', 'patient_room', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// RoomID
		$this->RoomID = new DbField('patient_room', 'patient_room', 'x_RoomID', 'RoomID', '`RoomID`', '`RoomID`', 3, -1, FALSE, '`RoomID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// RoomNo
		$this->RoomNo = new DbField('patient_room', 'patient_room', 'x_RoomNo', 'RoomNo', '`RoomNo`', '`RoomNo`', 200, -1, FALSE, '`RoomNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RoomNo->Sortable = TRUE; // Allow sort
		$this->fields['RoomNo'] = &$this->RoomNo;

		// RoomType
		$this->RoomType = new DbField('patient_room', 'patient_room', 'x_RoomType', 'RoomType', '`RoomType`', '`RoomType`', 200, -1, FALSE, '`RoomType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RoomType->Sortable = TRUE; // Allow sort
		$this->fields['RoomType'] = &$this->RoomType;

		// SharingRoom
		$this->SharingRoom = new DbField('patient_room', 'patient_room', 'x_SharingRoom', 'SharingRoom', '`SharingRoom`', '`SharingRoom`', 200, -1, FALSE, '`SharingRoom`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SharingRoom->Sortable = TRUE; // Allow sort
		$this->fields['SharingRoom'] = &$this->SharingRoom;

		// Amount
		$this->Amount = new DbField('patient_room', 'patient_room', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->Amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Amount'] = &$this->Amount;

		// Startdatetime
		$this->Startdatetime = new DbField('patient_room', 'patient_room', 'x_Startdatetime', 'Startdatetime', '`Startdatetime`', CastDateFieldForLike('`Startdatetime`', 0, "DB"), 135, 0, FALSE, '`Startdatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Enddatetime
		$this->Enddatetime = new DbField('patient_room', 'patient_room', 'x_Enddatetime', 'Enddatetime', '`Enddatetime`', CastDateFieldForLike('`Enddatetime`', 0, "DB"), 135, 0, FALSE, '`Enddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DaysHours
		$this->DaysHours = new DbField('patient_room', 'patient_room', 'x_DaysHours', 'DaysHours', '`DaysHours`', '`DaysHours`', 200, -1, FALSE, '`DaysHours`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DaysHours->Sortable = TRUE; // Allow sort
		$this->fields['DaysHours'] = &$this->DaysHours;

		// Days
		$this->Days = new DbField('patient_room', 'patient_room', 'x_Days', 'Days', '`Days`', '`Days`', 3, -1, FALSE, '`Days`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Hours
		$this->Hours = new DbField('patient_room', 'patient_room', 'x_Hours', 'Hours', '`Hours`', '`Hours`', 3, -1, FALSE, '`Hours`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TotalAmount
		$this->TotalAmount = new DbField('patient_room', 'patient_room', 'x_TotalAmount', 'TotalAmount', '`TotalAmount`', '`TotalAmount`', 131, -1, FALSE, '`TotalAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatID
		$this->PatID = new DbField('patient_room', 'patient_room', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 200, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatID->IsForeignKey = TRUE; // Foreign key field
		$this->PatID->Sortable = TRUE; // Allow sort
		$this->fields['PatID'] = &$this->PatID;

		// MobileNumber
		$this->MobileNumber = new DbField('patient_room', 'patient_room', 'x_MobileNumber', 'MobileNumber', '`MobileNumber`', '`MobileNumber`', 200, -1, FALSE, '`MobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['MobileNumber'] = &$this->MobileNumber;

		// HospID
		$this->HospID = new DbField('patient_room', 'patient_room', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// status
		$this->status = new DbField('patient_room', 'patient_room', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// createdby
		$this->createdby = new DbField('patient_room', 'patient_room', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('patient_room', 'patient_room', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('patient_room', 'patient_room', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('patient_room', 'patient_room', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patient_roomview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
