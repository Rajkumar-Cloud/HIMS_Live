...
class _appointment_scheduler extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// start_date
		$this->start_date = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_start_date', 'start_date', '`start_date`', CastDateFieldForLike('`start_date`', 11, "DB"), 135, 11, FALSE, '`start_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end_date
		$this->end_date = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_end_date', 'end_date', '`end_date`', CastDateFieldForLike('`end_date`', 11, "DB"), 135, 11, FALSE, '`end_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// patientID
		$this->patientID = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_patientID', 'patientID', '`patientID`', '`patientID`', 200, -1, FALSE, '`EV__patientID`', TRUE, TRUE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// patientName
		$this->patientName = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_patientName', 'patientName', '`patientName`', '`patientName`', 200, -1, FALSE, '`patientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->patientName->Sortable = TRUE; // Allow sort
		$this->fields['patientName'] = &$this->patientName;

		// DoctorID
		$this->DoctorID = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_DoctorID', 'DoctorID', '`DoctorID`', '`DoctorID`', 3, -1, FALSE, '`DoctorID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DoctorName
		$this->DoctorName = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_DoctorName', 'DoctorName', '`DoctorName`', '`DoctorName`', 200, -1, FALSE, '`DoctorName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// AppointmentStatus
		$this->AppointmentStatus = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_AppointmentStatus', 'AppointmentStatus', '`AppointmentStatus`', '`AppointmentStatus`', 200, -1, FALSE, '`AppointmentStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AppointmentStatus->Sortable = TRUE; // Allow sort
		$this->fields['AppointmentStatus'] = &$this->AppointmentStatus;

		// status
		$this->status = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// DoctorCode
		$this->DoctorCode = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_DoctorCode', 'DoctorCode', '`DoctorCode`', '`DoctorCode`', 200, -1, FALSE, '`DoctorCode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DoctorCode->Sortable = TRUE; // Allow sort
		$this->fields['DoctorCode'] = &$this->DoctorCode;

		// Department
		$this->Department = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Department', 'Department', '`Department`', '`Department`', 200, -1, FALSE, '`Department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Department->Sortable = TRUE; // Allow sort
		$this->fields['Department'] = &$this->Department;

		// scheduler_id
		$this->scheduler_id = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_scheduler_id', 'scheduler_id', '`scheduler_id`', '`scheduler_id`', 200, -1, FALSE, '`scheduler_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->scheduler_id->Sortable = TRUE; // Allow sort
		$this->fields['scheduler_id'] = &$this->scheduler_id;

		// text
		$this->text = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_text', 'text', '`text`', '`text`', 200, -1, FALSE, '`text`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->text->Sortable = TRUE; // Allow sort
		$this->fields['text'] = &$this->text;

		// appointment_status
		$this->appointment_status = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_appointment_status', 'appointment_status', '`appointment_status`', '`appointment_status`', 200, -1, FALSE, '`appointment_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->appointment_status->Sortable = TRUE; // Allow sort
		$this->fields['appointment_status'] = &$this->appointment_status;

		// PId
		$this->PId = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_PId', 'PId', '`PId`', '`PId`', 3, -1, FALSE, '`PId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PId->Sortable = TRUE; // Allow sort
		$this->PId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['PId'] = &$this->PId;

		// MobileNumber
		$this->MobileNumber = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_MobileNumber', 'MobileNumber', '`MobileNumber`', '`MobileNumber`', 200, -1, FALSE, '`MobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['MobileNumber'] = &$this->MobileNumber;

		// SchEmail
		$this->SchEmail = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_SchEmail', 'SchEmail', '`SchEmail`', '`SchEmail`', 200, -1, FALSE, '`SchEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SchEmail->Sortable = TRUE; // Allow sort
		$this->fields['SchEmail'] = &$this->SchEmail;

		// appointment_type
		$this->appointment_type = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_appointment_type', 'appointment_type', '`appointment_type`', '`appointment_type`', 200, -1, FALSE, '`appointment_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// Notified
		$this->Notified = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Notified', 'Notified', '`Notified`', '`Notified`', 200, -1, FALSE, '`Notified`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// Purpose
		$this->Purpose = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Purpose', 'Purpose', '`Purpose`', '`Purpose`', 200, -1, FALSE, '`Purpose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Purpose->Sortable = TRUE; // Allow sort
		$this->fields['Purpose'] = &$this->Purpose;

		// Notes
		$this->Notes = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Notes', 'Notes', '`Notes`', '`Notes`', 200, -1, FALSE, '`Notes`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Notes->Sortable = TRUE; // Allow sort
		$this->fields['Notes'] = &$this->Notes;

		// PatientType
		$this->PatientType = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_PatientType', 'PatientType', '`PatientType`', '`PatientType`', 200, -1, FALSE, '`PatientType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// Referal
		$this->Referal = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Referal', 'Referal', '`Referal`', '`Referal`', 200, -1, FALSE, '`EV__Referal`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// paymentType
		$this->paymentType = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_paymentType', 'paymentType', '`paymentType`', '`paymentType`', 200, -1, FALSE, '`paymentType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->paymentType->Sortable = TRUE; // Allow sort
		$this->fields['paymentType'] = &$this->paymentType;

		// tittle
		$this->tittle = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_tittle', 'tittle', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// gendar
		$this->gendar = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_gendar', 'gendar', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Dob
		$this->Dob = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Dob', 'Dob', '\'\'', '\'\'', 201, 7, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Dob->IsCustom = TRUE; // Custom field
		$this->Dob->Sortable = TRUE; // Allow sort
		$this->fields['Dob'] = &$this->Dob;

		// Age
		$this->Age = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_Age', 'Age', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->IsCustom = TRUE; // Custom field
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// WhereDidYouHear
		$this->WhereDidYouHear = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, -1, FALSE, '`WhereDidYouHear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// HospID
		$this->HospID = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// createdBy
		$this->createdBy = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_createdBy', 'createdBy', '`createdBy`', '`createdBy`', 200, -1, FALSE, '`createdBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdBy->Sortable = TRUE; // Allow sort
		$this->fields['createdBy'] = &$this->createdBy;

		// createdDateTime
		$this->createdDateTime = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_createdDateTime', 'createdDateTime', '`createdDateTime`', CastDateFieldForLike('`createdDateTime`', 0, "DB"), 135, 0, FALSE, '`createdDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdDateTime->Sortable = TRUE; // Allow sort
		$this->createdDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createdDateTime'] = &$this->createdDateTime;

		// PatientTypee
		$this->PatientTypee = new DbField('_appointment_scheduler', 'appointment_scheduler', 'x_PatientTypee', 'PatientTypee', '`PatientTypee`', '`PatientTypee`', 200, -1, FALSE, '`PatientTypee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("_appointment_schedulerview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($this->getCurrentMasterTable() == "doctors" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
