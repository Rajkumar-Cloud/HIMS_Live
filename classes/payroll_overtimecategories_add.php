 ...
 * Page class
 */
class payroll_overtimecategories_add extends payroll_overtimecategories
{
	...
	// Page object name
	public $PageObjName = "payroll_overtimecategories_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("payroll_overtimecategorieslist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "payroll_overtimecategorieslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "payroll_overtimecategoriesview.php")
