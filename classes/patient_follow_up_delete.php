 ...
 * Page class
 */
class patient_follow_up_delete extends patient_follow_up
{
	...
	// Page object name
	public $PageObjName = "patient_follow_up_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_follow_uplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_follow_uplist.php"); // Return to list
			}
		}
	}
