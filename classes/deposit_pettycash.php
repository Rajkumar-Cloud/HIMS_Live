...
class deposit_pettycash extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// TransType
		$this->TransType = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_TransType', 'TransType', '`TransType`', '`TransType`', 200, -1, FALSE, '`TransType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ShiftNumber
		$this->ShiftNumber = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_ShiftNumber', 'ShiftNumber', '`ShiftNumber`', '`ShiftNumber`', 200, -1, FALSE, '`ShiftNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ShiftNumber->Sortable = TRUE; // Allow sort
		$this->fields['ShiftNumber'] = &$this->ShiftNumber;

		// TerminalNumber
		$this->TerminalNumber = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_TerminalNumber', 'TerminalNumber', '`TerminalNumber`', '`TerminalNumber`', 200, -1, FALSE, '`TerminalNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// User
		$this->User = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_User', 'User', '`User`', '`User`', 200, -1, FALSE, '`User`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->User->Sortable = TRUE; // Allow sort
		$this->fields['User'] = &$this->User;

		// OpenedDateTime
		$this->OpenedDateTime = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_OpenedDateTime', 'OpenedDateTime', '`OpenedDateTime`', CastDateFieldForLike('`OpenedDateTime`', 7, "DB"), 135, 7, FALSE, '`OpenedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AccoundHead
		$this->AccoundHead = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_AccoundHead', 'AccoundHead', '`AccoundHead`', '`AccoundHead`', 200, -1, FALSE, '`AccoundHead`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Amount
		$this->Amount = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Amount->Sortable = TRUE; // Allow sort
		$this->Amount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
		$this->fields['Amount'] = &$this->Amount;

		// Narration
		$this->Narration = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_Narration', 'Narration', '`Narration`', '`Narration`', 201, -1, FALSE, '`Narration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Narration->Sortable = TRUE; // Allow sort
		$this->fields['Narration'] = &$this->Narration;

		// CreatedBy
		$this->CreatedBy = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 200, -1, FALSE, '`CreatedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedBy->Sortable = TRUE; // Allow sort
		$this->fields['CreatedBy'] = &$this->CreatedBy;

		// CreatedDateTime
		$this->CreatedDateTime = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike('`CreatedDateTime`', 0, "DB"), 135, 0, FALSE, '`CreatedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CreatedDateTime->Sortable = TRUE; // Allow sort
		$this->CreatedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['CreatedDateTime'] = &$this->CreatedDateTime;

		// ModifiedBy
		$this->ModifiedBy = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 200, -1, FALSE, '`ModifiedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedBy->Sortable = TRUE; // Allow sort
		$this->fields['ModifiedBy'] = &$this->ModifiedBy;

		// ModifiedDateTime
		$this->ModifiedDateTime = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike('`ModifiedDateTime`', 0, "DB"), 135, 0, FALSE, '`ModifiedDateTime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ModifiedDateTime->Sortable = TRUE; // Allow sort
		$this->ModifiedDateTime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['ModifiedDateTime'] = &$this->ModifiedDateTime;

		// HospID
		$this->HospID = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("deposit_pettycashview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
