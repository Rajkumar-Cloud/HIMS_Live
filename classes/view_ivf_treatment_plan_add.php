 ...
 * Page class
 */
class view_ivf_treatment_plan_add extends view_ivf_treatment_plan
{
	...
	// Page object name
	public $PageObjName = "view_ivf_treatment_plan_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "view_ivf_treatment_planview.php")
