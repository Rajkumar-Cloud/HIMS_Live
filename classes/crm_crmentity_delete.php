 ...
 * Page class
 */
class crm_crmentity_delete extends crm_crmentity
{
	...
	// Page object name
	public $PageObjName = "crm_crmentity_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("crm_crmentitylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("crm_crmentitylist.php"); // Return to list
			}
		}
	}
