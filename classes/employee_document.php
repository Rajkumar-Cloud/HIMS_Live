 ...
 */
class employee_document extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('employee_document', 'employee_document', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// employee_id
		$this->employee_id = new DbField('employee_document', 'employee_document', 'x_employee_id', 'employee_id', '`employee_id`', '`employee_id`', 3, -1, FALSE, '`employee_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DocumentName
		$this->DocumentName = new DbField('employee_document', 'employee_document', 'x_DocumentName', 'DocumentName', '`DocumentName`', '`DocumentName`', 3, -1, FALSE, '`DocumentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DocumentNumber
		$this->DocumentNumber = new DbField('employee_document', 'employee_document', 'x_DocumentNumber', 'DocumentNumber', '`DocumentNumber`', '`DocumentNumber`', 200, -1, FALSE, '`DocumentNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DocumentNumber->Sortable = TRUE; // Allow sort
		$this->fields['DocumentNumber'] = &$this->DocumentNumber;

		// DocumentUpload
		$this->DocumentUpload = new DbField('employee_document', 'employee_document', 'x_DocumentUpload', 'DocumentUpload', '`DocumentUpload`', '`DocumentUpload`', 201, -1, TRUE, '`DocumentUpload`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// status
		$this->status = new DbField('employee_document', 'employee_document', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('employee_document', 'employee_document', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('employee_document', 'employee_document', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('employee_document', 'employee_document', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('employee_document', 'employee_document', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// HospID
		$this->HospID = new DbField('employee_document', 'employee_document', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "employee_documentlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_documentedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_documentadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("employee_documentview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_documentview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "employee_documentadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_documentadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_documentedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_documentadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_documentdelete.php", $this->getUrlParm());
	}
