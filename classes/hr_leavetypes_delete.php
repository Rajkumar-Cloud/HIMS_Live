 ...
 * Page class
 */
class hr_leavetypes_delete extends hr_leavetypes
{
	...
	// Page object name
	public $PageObjName = "hr_leavetypes_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("hr_leavetypeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("hr_leavetypeslist.php"); // Return to list
			}
		}
	}
