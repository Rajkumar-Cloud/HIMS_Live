 ...
 * Page class
 */
class employee_timeentry_delete extends employee_timeentry
{
	...
	// Page object name
	public $PageObjName = "employee_timeentry_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_timeentrylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_timeentrylist.php"); // Return to list
			}
		}
	}
