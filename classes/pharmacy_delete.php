 ...
 * Page class
 */
class pharmacy_delete extends pharmacy
{
	...
	// Page object name
	public $PageObjName = "pharmacy_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pharmacylist.php"); // Return to list
			}
		}
	}
