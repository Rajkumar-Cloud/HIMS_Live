 ...
 */
class view_pharmacy_purchaseorder extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// HospID
		$this->HospID = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// PRC
		$this->PRC = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, -1, FALSE, '`PRC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PRC->Sortable = TRUE; // Allow sort
		$this->fields['PRC'] = &$this->PRC;

		// BRCODE
		$this->BRCODE = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, -1, FALSE, '`BRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PSGST
		$this->PSGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, -1, FALSE, '`PSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PCGST
		$this->PCGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, -1, FALSE, '`PCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SSGST
		$this->SSGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, -1, FALSE, '`SSGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// SCGST
		$this->SCGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, -1, FALSE, '`SCGST`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HSN
		$this->HSN = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, -1, FALSE, '`HSN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HSN->Sortable = TRUE; // Allow sort
		$this->fields['HSN'] = &$this->HSN;

		// BatchNo
		$this->BatchNo = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, -1, FALSE, '`BatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchNo->Sortable = TRUE; // Allow sort
		$this->fields['BatchNo'] = &$this->BatchNo;

		// SalRate
		$this->SalRate = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, -1, FALSE, '`SalRate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurValue
		$this->PurValue = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, -1, FALSE, '`PurValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PUnit
		$this->PUnit = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, -1, FALSE, '`PUnit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_purchaseorderlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_purchaseorderview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_purchaseorderedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_purchaseorderadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_purchaseorderview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_purchaseorderview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_purchaseorderadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_purchaseorderadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_purchaseorderedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_purchaseorderadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_purchaseorderdelete.php", $this->getUrlParm());
	}
