 ...
 * Page class
 */
class hr_leaveperiods_edit extends hr_leaveperiods
{
	...
	// Page object name
	public $PageObjName = "hr_leaveperiods_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("hr_leaveperiodslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "hr_leaveperiodslist.php")
