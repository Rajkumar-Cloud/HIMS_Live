...
class ivf_agency extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_agency', 'ivf_agency', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Name
		$this->Name = new DbField('ivf_agency', 'ivf_agency', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Street
		$this->Street = new DbField('ivf_agency', 'ivf_agency', 'x_Street', 'Street', '`Street`', '`Street`', 200, -1, FALSE, '`Street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Street->Sortable = TRUE; // Allow sort
		$this->fields['Street'] = &$this->Street;

		// Town
		$this->Town = new DbField('ivf_agency', 'ivf_agency', 'x_Town', 'Town', '`Town`', '`Town`', 200, -1, FALSE, '`Town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Town->Sortable = TRUE; // Allow sort
		$this->fields['Town'] = &$this->Town;

		// State
		$this->State = new DbField('ivf_agency', 'ivf_agency', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->State->Sortable = TRUE; // Allow sort
		$this->fields['State'] = &$this->State;

		// Pin
		$this->Pin = new DbField('ivf_agency', 'ivf_agency', 'x_Pin', 'Pin', '`Pin`', '`Pin`', 200, -1, FALSE, '`Pin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_agencyview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
