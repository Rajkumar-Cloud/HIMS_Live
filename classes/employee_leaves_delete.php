 ...
 * Page class
 */
class employee_leaves_delete extends employee_leaves
{
	...
	// Page object name
	public $PageObjName = "employee_leaves_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_leaveslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_leaveslist.php"); // Return to list
			}
		}
	}
