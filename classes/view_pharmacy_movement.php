 ...
 */
class view_pharmacy_movement extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// prc
		$this->prc = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_prc', 'prc', '`prc`', '`prc`', 200, -1, FALSE, '`prc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->prc->IsForeignKey = TRUE; // Foreign key field
		$this->prc->Sortable = TRUE; // Allow sort
		$this->fields['prc'] = &$this->prc;

		// PrName
		$this->PrName = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, -1, FALSE, '`PrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PrName->Sortable = TRUE; // Allow sort
		$this->fields['PrName'] = &$this->PrName;

		// BatchNo
		$this->BatchNo = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, -1, FALSE, '`BatchNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BatchNo->IsForeignKey = TRUE; // Foreign key field
		$this->BatchNo->Sortable = TRUE; // Allow sort
		$this->fields['BatchNo'] = &$this->BatchNo;

		// ExpDate
		$this->ExpDate = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike('`ExpDate`', 7, "DB"), 135, 7, FALSE, '`ExpDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MFRCODE
		$this->MFRCODE = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, -1, FALSE, '`MFRCODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MFRCODE->Sortable = TRUE; // Allow sort
		$this->fields['MFRCODE'] = &$this->MFRCODE;

		// hsn
		$this->hsn = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_hsn', 'hsn', '`hsn`', '`hsn`', 200, -1, FALSE, '`hsn`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->hsn->Sortable = TRUE; // Allow sort
		$this->fields['hsn'] = &$this->hsn;

		// HospID
		$this->HospID = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_pharmacy_movement_item") {
			$detailUrl = $GLOBALS["view_pharmacy_movement_item"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_prc=" . urlencode($this->prc->CurrentValue);
			$detailUrl .= "&fk_BatchNo=" . urlencode($this->BatchNo->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "view_pharmacy_movementlist.php";
		return $detailUrl;
	}
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`PrName` ASC";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_pharmacy_movementlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_pharmacy_movementview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_pharmacy_movementedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_pharmacy_movementadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("view_pharmacy_movementview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_pharmacy_movementview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "view_pharmacy_movementadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_pharmacy_movementadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_movementedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_pharmacy_movementadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_pharmacy_movementdelete.php", $this->getUrlParm());
	}
