...
class view_ongoing_treatment extends DbTable
{
	...
	public function __construct()
	{
		...
		// bid
		$this->bid = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_bid', 'bid', '`bid`', '`bid`', 3, -1, FALSE, '`bid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// bPatientID
		$this->bPatientID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_bPatientID', 'bPatientID', '`bPatientID`', '`bPatientID`', 200, -1, FALSE, '`bPatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// title
		$this->title = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_title', 'title', '`title`', '`title`', 3, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->title->Sortable = TRUE; // Allow sort
		$this->title->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['title'] = &$this->title;

		// first_name
		$this->first_name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, -1, FALSE, '`first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->first_name->Sortable = TRUE; // Allow sort
		$this->fields['first_name'] = &$this->first_name;

		// middle_name
		$this->middle_name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_middle_name', 'middle_name', '`middle_name`', '`middle_name`', 200, -1, FALSE, '`middle_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->middle_name->Sortable = TRUE; // Allow sort
		$this->fields['middle_name'] = &$this->middle_name;

		// last_name
		$this->last_name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, -1, FALSE, '`last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->last_name->Sortable = TRUE; // Allow sort
		$this->fields['last_name'] = &$this->last_name;

		// gender
		$this->gender = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gender->Sortable = TRUE; // Allow sort
		$this->fields['gender'] = &$this->gender;

		// dob
		$this->dob = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_dob', 'dob', '`dob`', CastDateFieldForLike('`dob`', 0, "DB"), 133, 0, FALSE, '`dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bAge
		$this->bAge = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_bAge', 'bAge', '`bAge`', '`bAge`', 200, -1, FALSE, '`bAge`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bAge->Sortable = TRUE; // Allow sort
		$this->fields['bAge'] = &$this->bAge;

		// blood_group
		$this->blood_group = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_blood_group', 'blood_group', '`blood_group`', '`blood_group`', 200, -1, FALSE, '`blood_group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->blood_group->Sortable = TRUE; // Allow sort
		$this->fields['blood_group'] = &$this->blood_group;

		// mobile_no
		$this->mobile_no = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, -1, FALSE, '`mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['mobile_no'] = &$this->mobile_no;

		// description
		$this->description = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// IdentificationMark
		$this->IdentificationMark = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_IdentificationMark', 'IdentificationMark', '`IdentificationMark`', '`IdentificationMark`', 200, -1, FALSE, '`IdentificationMark`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IdentificationMark->Sortable = TRUE; // Allow sort
		$this->fields['IdentificationMark'] = &$this->IdentificationMark;

		// Religion
		$this->Religion = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Religion', 'Religion', '`Religion`', '`Religion`', 200, -1, FALSE, '`Religion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Religion->Sortable = TRUE; // Allow sort
		$this->fields['Religion'] = &$this->Religion;

		// Nationality
		$this->Nationality = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Nationality', 'Nationality', '`Nationality`', '`Nationality`', 200, -1, FALSE, '`Nationality`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nationality->Sortable = TRUE; // Allow sort
		$this->fields['Nationality'] = &$this->Nationality;

		// profilePic
		$this->profilePic = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 200, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// ReferedByDr
		$this->ReferedByDr = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, -1, FALSE, '`ReferedByDr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferedByDr->Sortable = TRUE; // Allow sort
		$this->fields['ReferedByDr'] = &$this->ReferedByDr;

		// ReferClinicname
		$this->ReferClinicname = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, -1, FALSE, '`ReferClinicname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferClinicname->Sortable = TRUE; // Allow sort
		$this->fields['ReferClinicname'] = &$this->ReferClinicname;

		// ReferCity
		$this->ReferCity = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, -1, FALSE, '`ReferCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferCity->Sortable = TRUE; // Allow sort
		$this->fields['ReferCity'] = &$this->ReferCity;

		// ReferMobileNo
		$this->ReferMobileNo = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, -1, FALSE, '`ReferMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['ReferMobileNo'] = &$this->ReferMobileNo;

		// ReferA4TreatingConsultant
		$this->ReferA4TreatingConsultant = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, -1, FALSE, '`ReferA4TreatingConsultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PurposreReferredfor
		$this->PurposreReferredfor = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, -1, FALSE, '`PurposreReferredfor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PurposreReferredfor->Sortable = TRUE; // Allow sort
		$this->fields['PurposreReferredfor'] = &$this->PurposreReferredfor;

		// spouse_title
		$this->spouse_title = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_title', 'spouse_title', '`spouse_title`', '`spouse_title`', 200, -1, FALSE, '`spouse_title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_title->Sortable = TRUE; // Allow sort
		$this->fields['spouse_title'] = &$this->spouse_title;

		// spouse_first_name
		$this->spouse_first_name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_first_name', 'spouse_first_name', '`spouse_first_name`', '`spouse_first_name`', 200, -1, FALSE, '`spouse_first_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_first_name->Sortable = TRUE; // Allow sort
		$this->fields['spouse_first_name'] = &$this->spouse_first_name;

		// spouse_middle_name
		$this->spouse_middle_name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_middle_name', 'spouse_middle_name', '`spouse_middle_name`', '`spouse_middle_name`', 200, -1, FALSE, '`spouse_middle_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_middle_name->Sortable = TRUE; // Allow sort
		$this->fields['spouse_middle_name'] = &$this->spouse_middle_name;

		// spouse_last_name
		$this->spouse_last_name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_last_name', 'spouse_last_name', '`spouse_last_name`', '`spouse_last_name`', 200, -1, FALSE, '`spouse_last_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_last_name->Sortable = TRUE; // Allow sort
		$this->fields['spouse_last_name'] = &$this->spouse_last_name;

		// spouse_gender
		$this->spouse_gender = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_gender', 'spouse_gender', '`spouse_gender`', '`spouse_gender`', 200, -1, FALSE, '`spouse_gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_gender->Sortable = TRUE; // Allow sort
		$this->fields['spouse_gender'] = &$this->spouse_gender;

		// spouse_dob
		$this->spouse_dob = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_dob', 'spouse_dob', '`spouse_dob`', CastDateFieldForLike('`spouse_dob`', 0, "DB"), 133, 0, FALSE, '`spouse_dob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spouse_Age
		$this->spouse_Age = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_Age', 'spouse_Age', '`spouse_Age`', '`spouse_Age`', 200, -1, FALSE, '`spouse_Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_Age->Sortable = TRUE; // Allow sort
		$this->fields['spouse_Age'] = &$this->spouse_Age;

		// spouse_blood_group
		$this->spouse_blood_group = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_blood_group', 'spouse_blood_group', '`spouse_blood_group`', '`spouse_blood_group`', 200, -1, FALSE, '`spouse_blood_group`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_blood_group->Sortable = TRUE; // Allow sort
		$this->fields['spouse_blood_group'] = &$this->spouse_blood_group;

		// spouse_mobile_no
		$this->spouse_mobile_no = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_mobile_no', 'spouse_mobile_no', '`spouse_mobile_no`', '`spouse_mobile_no`', 200, -1, FALSE, '`spouse_mobile_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_mobile_no->Sortable = TRUE; // Allow sort
		$this->fields['spouse_mobile_no'] = &$this->spouse_mobile_no;

		// Maritalstatus
		$this->Maritalstatus = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Maritalstatus', 'Maritalstatus', '`Maritalstatus`', '`Maritalstatus`', 200, -1, FALSE, '`Maritalstatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Maritalstatus->Sortable = TRUE; // Allow sort
		$this->fields['Maritalstatus'] = &$this->Maritalstatus;

		// Business
		$this->Business = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Business', 'Business', '`Business`', '`Business`', 200, -1, FALSE, '`Business`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Business->Sortable = TRUE; // Allow sort
		$this->fields['Business'] = &$this->Business;

		// Patient_Language
		$this->Patient_Language = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Patient_Language', 'Patient_Language', '`Patient_Language`', '`Patient_Language`', 200, -1, FALSE, '`Patient_Language`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Patient_Language->Sortable = TRUE; // Allow sort
		$this->fields['Patient_Language'] = &$this->Patient_Language;

		// Passport
		$this->Passport = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Passport', 'Passport', '`Passport`', '`Passport`', 200, -1, FALSE, '`Passport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Passport->Sortable = TRUE; // Allow sort
		$this->fields['Passport'] = &$this->Passport;

		// VisaNo
		$this->VisaNo = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_VisaNo', 'VisaNo', '`VisaNo`', '`VisaNo`', 200, -1, FALSE, '`VisaNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VisaNo->Sortable = TRUE; // Allow sort
		$this->fields['VisaNo'] = &$this->VisaNo;

		// ValidityOfVisa
		$this->ValidityOfVisa = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ValidityOfVisa', 'ValidityOfVisa', '`ValidityOfVisa`', '`ValidityOfVisa`', 200, -1, FALSE, '`ValidityOfVisa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ValidityOfVisa->Sortable = TRUE; // Allow sort
		$this->fields['ValidityOfVisa'] = &$this->ValidityOfVisa;

		// WhereDidYouHear
		$this->WhereDidYouHear = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, -1, FALSE, '`WhereDidYouHear`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WhereDidYouHear->Sortable = TRUE; // Allow sort
		$this->fields['WhereDidYouHear'] = &$this->WhereDidYouHear;

		// HospID
		$this->HospID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->fields['HospID'] = &$this->HospID;

		// street
		$this->street = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_street', 'street', '`street`', '`street`', 200, -1, FALSE, '`street`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->street->Sortable = TRUE; // Allow sort
		$this->fields['street'] = &$this->street;

		// town
		$this->town = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_town', 'town', '`town`', '`town`', 200, -1, FALSE, '`town`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->town->Sortable = TRUE; // Allow sort
		$this->fields['town'] = &$this->town;

		// province
		$this->province = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_province', 'province', '`province`', '`province`', 200, -1, FALSE, '`province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->province->Sortable = TRUE; // Allow sort
		$this->fields['province'] = &$this->province;

		// country
		$this->country = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_country', 'country', '`country`', '`country`', 200, -1, FALSE, '`country`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->country->Sortable = TRUE; // Allow sort
		$this->fields['country'] = &$this->country;

		// postal_code
		$this->postal_code = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, -1, FALSE, '`postal_code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->postal_code->Sortable = TRUE; // Allow sort
		$this->fields['postal_code'] = &$this->postal_code;

		// PEmail
		$this->PEmail = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PEmail', 'PEmail', '`PEmail`', '`PEmail`', 200, -1, FALSE, '`PEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PEmail->Sortable = TRUE; // Allow sort
		$this->fields['PEmail'] = &$this->PEmail;

		// PEmergencyContact
		$this->PEmergencyContact = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PEmergencyContact', 'PEmergencyContact', '`PEmergencyContact`', '`PEmergencyContact`', 200, -1, FALSE, '`PEmergencyContact`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PEmergencyContact->Sortable = TRUE; // Allow sort
		$this->fields['PEmergencyContact'] = &$this->PEmergencyContact;

		// occupation
		$this->occupation = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_occupation', 'occupation', '`occupation`', '`occupation`', 200, -1, FALSE, '`occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->occupation->Sortable = TRUE; // Allow sort
		$this->fields['occupation'] = &$this->occupation;

		// spouse_occupation
		$this->spouse_occupation = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_spouse_occupation', 'spouse_occupation', '`spouse_occupation`', '`spouse_occupation`', 200, -1, FALSE, '`spouse_occupation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->spouse_occupation->Sortable = TRUE; // Allow sort
		$this->fields['spouse_occupation'] = &$this->spouse_occupation;

		// WhatsApp
		$this->WhatsApp = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_WhatsApp', 'WhatsApp', '`WhatsApp`', '`WhatsApp`', 200, -1, FALSE, '`WhatsApp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WhatsApp->Sortable = TRUE; // Allow sort
		$this->fields['WhatsApp'] = &$this->WhatsApp;

		// CouppleID
		$this->CouppleID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_CouppleID', 'CouppleID', '`CouppleID`', '`CouppleID`', 3, -1, FALSE, '`CouppleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MaleID
		$this->MaleID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_MaleID', 'MaleID', '`MaleID`', '`MaleID`', 3, -1, FALSE, '`MaleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FemaleID
		$this->FemaleID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_FemaleID', 'FemaleID', '`FemaleID`', '`FemaleID`', 3, -1, FALSE, '`FemaleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GroupID
		$this->GroupID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_GroupID', 'GroupID', '`GroupID`', '`GroupID`', 3, -1, FALSE, '`GroupID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Relationship
		$this->Relationship = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Relationship', 'Relationship', '`Relationship`', '`Relationship`', 200, -1, FALSE, '`Relationship`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Relationship->Sortable = TRUE; // Allow sort
		$this->fields['Relationship'] = &$this->Relationship;

		// FacebookID
		$this->FacebookID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_FacebookID', 'FacebookID', '`FacebookID`', '`FacebookID`', 200, -1, FALSE, '`FacebookID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FacebookID->Sortable = TRUE; // Allow sort
		$this->fields['FacebookID'] = &$this->FacebookID;

		// id
		$this->id = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNO
		$this->RIDNO = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, -1, FALSE, '`RIDNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RIDNO->Sortable = TRUE; // Allow sort
		$this->RIDNO->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['RIDNO'] = &$this->RIDNO;

		// Name
		$this->Name = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// treatment_status
		$this->treatment_status = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_treatment_status', 'treatment_status', '`treatment_status`', '`treatment_status`', 200, -1, FALSE, '`treatment_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->treatment_status->Sortable = TRUE; // Allow sort
		$this->fields['treatment_status'] = &$this->treatment_status;

		// ARTCYCLE
		$this->ARTCYCLE = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_ARTCYCLE', 'ARTCYCLE', '`ARTCYCLE`', '`ARTCYCLE`', 200, -1, FALSE, '`ARTCYCLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ARTCYCLE->Sortable = TRUE; // Allow sort
		$this->fields['ARTCYCLE'] = &$this->ARTCYCLE;

		// RESULT
		$this->RESULT = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_RESULT', 'RESULT', '`RESULT`', '`RESULT`', 200, -1, FALSE, '`RESULT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RESULT->Sortable = TRUE; // Allow sort
		$this->fields['RESULT'] = &$this->RESULT;

		// status
		$this->status = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// createdby
		$this->createdby = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// TreatmentStartDate
		$this->TreatmentStartDate = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TreatmentStartDate', 'TreatmentStartDate', '`TreatmentStartDate`', CastDateFieldForLike('`TreatmentStartDate`', 0, "DB"), 135, 0, FALSE, '`TreatmentStartDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TreatementStopDate
		$this->TreatementStopDate = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TreatementStopDate', 'TreatementStopDate', '`TreatementStopDate`', CastDateFieldForLike('`TreatementStopDate`', 0, "DB"), 135, 0, FALSE, '`TreatementStopDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TypePatient
		$this->TypePatient = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TypePatient', 'TypePatient', '`TypePatient`', '`TypePatient`', 200, -1, FALSE, '`TypePatient`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TypePatient->Sortable = TRUE; // Allow sort
		$this->fields['TypePatient'] = &$this->TypePatient;

		// Treatment
		$this->Treatment = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 200, -1, FALSE, '`Treatment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Treatment->Sortable = TRUE; // Allow sort
		$this->fields['Treatment'] = &$this->Treatment;

		// TreatmentTec
		$this->TreatmentTec = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TreatmentTec', 'TreatmentTec', '`TreatmentTec`', '`TreatmentTec`', 200, -1, FALSE, '`TreatmentTec`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TreatmentTec->Sortable = TRUE; // Allow sort
		$this->fields['TreatmentTec'] = &$this->TreatmentTec;

		// TypeOfCycle
		$this->TypeOfCycle = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TypeOfCycle', 'TypeOfCycle', '`TypeOfCycle`', '`TypeOfCycle`', 200, -1, FALSE, '`TypeOfCycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TypeOfCycle->Sortable = TRUE; // Allow sort
		$this->fields['TypeOfCycle'] = &$this->TypeOfCycle;

		// SpermOrgin
		$this->SpermOrgin = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_SpermOrgin', 'SpermOrgin', '`SpermOrgin`', '`SpermOrgin`', 200, -1, FALSE, '`SpermOrgin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SpermOrgin->Sortable = TRUE; // Allow sort
		$this->fields['SpermOrgin'] = &$this->SpermOrgin;

		// State
		$this->State = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->State->Sortable = TRUE; // Allow sort
		$this->fields['State'] = &$this->State;

		// Origin
		$this->Origin = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Origin', 'Origin', '`Origin`', '`Origin`', 200, -1, FALSE, '`Origin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Origin->Sortable = TRUE; // Allow sort
		$this->fields['Origin'] = &$this->Origin;

		// MACS
		$this->MACS = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, -1, FALSE, '`MACS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MACS->Sortable = TRUE; // Allow sort
		$this->fields['MACS'] = &$this->MACS;

		// Technique
		$this->Technique = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Technique', 'Technique', '`Technique`', '`Technique`', 200, -1, FALSE, '`Technique`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Technique->Sortable = TRUE; // Allow sort
		$this->fields['Technique'] = &$this->Technique;

		// PgdPlanning
		$this->PgdPlanning = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PgdPlanning', 'PgdPlanning', '`PgdPlanning`', '`PgdPlanning`', 200, -1, FALSE, '`PgdPlanning`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PgdPlanning->Sortable = TRUE; // Allow sort
		$this->fields['PgdPlanning'] = &$this->PgdPlanning;

		// IMSI
		$this->IMSI = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_IMSI', 'IMSI', '`IMSI`', '`IMSI`', 200, -1, FALSE, '`IMSI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IMSI->Sortable = TRUE; // Allow sort
		$this->fields['IMSI'] = &$this->IMSI;

		// SequentialCulture
		$this->SequentialCulture = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_SequentialCulture', 'SequentialCulture', '`SequentialCulture`', '`SequentialCulture`', 200, -1, FALSE, '`SequentialCulture`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SequentialCulture->Sortable = TRUE; // Allow sort
		$this->fields['SequentialCulture'] = &$this->SequentialCulture;

		// TimeLapse
		$this->TimeLapse = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TimeLapse', 'TimeLapse', '`TimeLapse`', '`TimeLapse`', 200, -1, FALSE, '`TimeLapse`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TimeLapse->Sortable = TRUE; // Allow sort
		$this->fields['TimeLapse'] = &$this->TimeLapse;

		// AH
		$this->AH = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_AH', 'AH', '`AH`', '`AH`', 200, -1, FALSE, '`AH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AH->Sortable = TRUE; // Allow sort
		$this->fields['AH'] = &$this->AH;

		// Weight
		$this->Weight = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Weight', 'Weight', '`Weight`', '`Weight`', 200, -1, FALSE, '`Weight`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Weight->Sortable = TRUE; // Allow sort
		$this->fields['Weight'] = &$this->Weight;

		// BMI
		$this->BMI = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_BMI', 'BMI', '`BMI`', '`BMI`', 200, -1, FALSE, '`BMI`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BMI->Sortable = TRUE; // Allow sort
		$this->fields['BMI'] = &$this->BMI;

		// MaleIndications
		$this->MaleIndications = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_MaleIndications', 'MaleIndications', '`MaleIndications`', '`MaleIndications`', 200, -1, FALSE, '`MaleIndications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MaleIndications->Sortable = TRUE; // Allow sort
		$this->fields['MaleIndications'] = &$this->MaleIndications;

		// FemaleIndications
		$this->FemaleIndications = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_FemaleIndications', 'FemaleIndications', '`FemaleIndications`', '`FemaleIndications`', 200, -1, FALSE, '`FemaleIndications`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FemaleIndications->Sortable = TRUE; // Allow sort
		$this->fields['FemaleIndications'] = &$this->FemaleIndications;

		// UseOfThe
		$this->UseOfThe = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_UseOfThe', 'UseOfThe', '`UseOfThe`', '`UseOfThe`', 200, -1, FALSE, '`UseOfThe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UseOfThe->Sortable = TRUE; // Allow sort
		$this->fields['UseOfThe'] = &$this->UseOfThe;

		// Ectopic
		$this->Ectopic = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Ectopic', 'Ectopic', '`Ectopic`', '`Ectopic`', 200, -1, FALSE, '`Ectopic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Ectopic->Sortable = TRUE; // Allow sort
		$this->fields['Ectopic'] = &$this->Ectopic;

		// Heterotopic
		$this->Heterotopic = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Heterotopic', 'Heterotopic', '`Heterotopic`', '`Heterotopic`', 200, -1, FALSE, '`Heterotopic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Heterotopic->Sortable = TRUE; // Allow sort
		$this->fields['Heterotopic'] = &$this->Heterotopic;

		// TransferDFE
		$this->TransferDFE = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TransferDFE', 'TransferDFE', '`TransferDFE`', '`TransferDFE`', 200, -1, FALSE, '`TransferDFE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TransferDFE->Sortable = TRUE; // Allow sort
		$this->fields['TransferDFE'] = &$this->TransferDFE;

		// Evolutive
		$this->Evolutive = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Evolutive', 'Evolutive', '`Evolutive`', '`Evolutive`', 200, -1, FALSE, '`Evolutive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Evolutive->Sortable = TRUE; // Allow sort
		$this->fields['Evolutive'] = &$this->Evolutive;

		// Number
		$this->Number = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_Number', 'Number', '`Number`', '`Number`', 200, -1, FALSE, '`Number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Number->Sortable = TRUE; // Allow sort
		$this->fields['Number'] = &$this->Number;

		// SequentialCult
		$this->SequentialCult = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_SequentialCult', 'SequentialCult', '`SequentialCult`', '`SequentialCult`', 200, -1, FALSE, '`SequentialCult`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SequentialCult->Sortable = TRUE; // Allow sort
		$this->fields['SequentialCult'] = &$this->SequentialCult;

		// TineLapse
		$this->TineLapse = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_TineLapse', 'TineLapse', '`TineLapse`', '`TineLapse`', 200, -1, FALSE, '`TineLapse`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TineLapse->Sortable = TRUE; // Allow sort
		$this->fields['TineLapse'] = &$this->TineLapse;

		// PatientName
		$this->PatientName = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// PatientID
		$this->PatientID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// PartnerName
		$this->PartnerName = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, -1, FALSE, '`PartnerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerName->Sortable = TRUE; // Allow sort
		$this->fields['PartnerName'] = &$this->PartnerName;

		// PartnerID
		$this->PartnerID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_PartnerID', 'PartnerID', '`PartnerID`', '`PartnerID`', 200, -1, FALSE, '`PartnerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerID->Sortable = TRUE; // Allow sort
		$this->fields['PartnerID'] = &$this->PartnerID;

		// WifeCell
		$this->WifeCell = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_WifeCell', 'WifeCell', '`WifeCell`', '`WifeCell`', 200, -1, FALSE, '`WifeCell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->WifeCell->Sortable = TRUE; // Allow sort
		$this->fields['WifeCell'] = &$this->WifeCell;

		// HusbandCell
		$this->HusbandCell = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_HusbandCell', 'HusbandCell', '`HusbandCell`', '`HusbandCell`', 200, -1, FALSE, '`HusbandCell`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HusbandCell->Sortable = TRUE; // Allow sort
		$this->fields['HusbandCell'] = &$this->HusbandCell;

		// CoupleID
		$this->CoupleID = new DbField('view_ongoing_treatment', 'view_ongoing_treatment', 'x_CoupleID', 'CoupleID', '`CoupleID`', '`CoupleID`', 200, -1, FALSE, '`CoupleID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getRecordFilter($row = NULL)
	{
		...
		$val = is_array($row) ? (array_key_exists('bid', $row) ? $row['bid'] : NULL) : $this->bid->CurrentValue;
		if (!is_numeric($val))
		...
		$val = is_array($row) ? (array_key_exists('bPatientID', $row) ? $row['bPatientID'] : NULL) : $this->bPatientID->CurrentValue;
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_ongoing_treatmentview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
