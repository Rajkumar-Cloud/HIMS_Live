 ...
 * Page class
 */
class ivf_outcome_add extends ivf_outcome
{
	...
	// Page object name
	public $PageObjName = "ivf_outcome_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_outcomeview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// BabyDetails
		$this->BabyDetails->setDbValueDef($rsnew, $this->BabyDetails->CurrentValue, NULL, FALSE);

		// LSCSNormal
		$this->LSCSNormal->setDbValueDef($rsnew, $this->LSCSNormal->CurrentValue, NULL, FALSE);
