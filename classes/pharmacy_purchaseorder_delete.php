 ...
 * Page class
 */
class pharmacy_purchaseorder_delete extends pharmacy_purchaseorder
{
	...
	// Page object name
	public $PageObjName = "pharmacy_purchaseorder_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_purchaseorderlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_purchaseorderlist.php"); // Return to list
			}
		}
	}
