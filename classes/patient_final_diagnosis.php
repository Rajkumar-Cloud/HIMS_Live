...
class patient_final_diagnosis extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PatID
		$this->PatID = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 200, -1, FALSE, '`PatID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatID->Sortable = TRUE; // Allow sort
		$this->fields['PatID'] = &$this->PatID;

		// PatientName
		$this->PatientName = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// mrnno
		$this->mrnno = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, -1, FALSE, '`mrnno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mrnno->IsForeignKey = TRUE; // Foreign key field
		$this->mrnno->Sortable = TRUE; // Allow sort
		$this->fields['mrnno'] = &$this->mrnno;

		// MobileNumber
		$this->MobileNumber = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_MobileNumber', 'MobileNumber', '`MobileNumber`', '`MobileNumber`', 200, -1, FALSE, '`MobileNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MobileNumber->Sortable = TRUE; // Allow sort
		$this->fields['MobileNumber'] = &$this->MobileNumber;

		// FinalDiagnosis
		$this->FinalDiagnosis = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_FinalDiagnosis', 'FinalDiagnosis', '`FinalDiagnosis`', '`FinalDiagnosis`', 201, -1, FALSE, '`FinalDiagnosis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->FinalDiagnosis->Sortable = TRUE; // Allow sort
		$this->fields['FinalDiagnosis'] = &$this->FinalDiagnosis;

		// Treatments
		$this->Treatments = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_Treatments', 'Treatments', '`Treatments`', '`Treatments`', 201, -1, FALSE, '`Treatments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Treatments->Sortable = TRUE; // Allow sort
		$this->fields['Treatments'] = &$this->Treatments;

		// Age
		$this->Age = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_Age', 'Age', '`Age`', '`Age`', 200, -1, FALSE, '`Age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Age->Sortable = TRUE; // Allow sort
		$this->fields['Age'] = &$this->Age;

		// Gender
		$this->Gender = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, -1, FALSE, '`Gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gender->Sortable = TRUE; // Allow sort
		$this->fields['Gender'] = &$this->Gender;

		// profilePic
		$this->profilePic = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// FinalDiagnosisTemplate
		$this->FinalDiagnosisTemplate = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_FinalDiagnosisTemplate', 'FinalDiagnosisTemplate', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TreatmentsTemplate
		$this->TreatmentsTemplate = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_TreatmentsTemplate', 'TreatmentsTemplate', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientId
		$this->PatientId = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 3, -1, FALSE, '`PatientId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Reception
		$this->Reception = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, -1, FALSE, '`Reception`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// PatientSearch
		$this->PatientSearch = new DbField('patient_final_diagnosis', 'patient_final_diagnosis', 'x_PatientSearch', 'PatientSearch', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("patient_final_diagnosisview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
