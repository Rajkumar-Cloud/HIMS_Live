 ...
 * Page class
 */
class ivf_vitals_history_delete extends ivf_vitals_history
{
	...
	// Page object name
	public $PageObjName = "ivf_vitals_history_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_vitals_historylist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("ivf_vitals_historylist.php"); // Return to list
			}
		}
	}
