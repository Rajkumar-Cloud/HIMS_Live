 ...
 * Page class
 */
class patient_address_delete extends patient_address
{
	...
	// Page object name
	public $PageObjName = "patient_address_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_addresslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("patient_addresslist.php"); // Return to list
			}
		}
	}
