 ...
 * Page class
 */
class employee_overtime_delete extends employee_overtime
{
	...
	// Page object name
	public $PageObjName = "employee_overtime_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_overtimelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("employee_overtimelist.php"); // Return to list
			}
		}
	}
