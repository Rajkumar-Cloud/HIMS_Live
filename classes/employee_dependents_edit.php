 ...
 * Page class
 */
class employee_dependents_edit extends employee_dependents
{
	...
	// Page object name
	public $PageObjName = "employee_dependents_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("employee_dependentslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "employee_dependentslist.php")
	...
	protected function validateForm()
	{
		...
		if ($this->id_number->Required) {
			if (!$this->id_number->IsDetailKey && $this->id_number->FormValue != NULL && $this->id_number->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->id_number->caption(), $this->id_number->RequiredErrorMessage));
			}
		}
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// id_number
			$this->id_number->setDbValueDef($rsnew, $this->id_number->CurrentValue, NULL, $this->id_number->ReadOnly);
