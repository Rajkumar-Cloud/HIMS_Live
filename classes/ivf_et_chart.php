...
class ivf_et_chart extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// RIDNo
		$this->RIDNo = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Name
		$this->Name = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Name', 'Name', '`Name`', '`Name`', 200, -1, FALSE, '`Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name->Sortable = TRUE; // Allow sort
		$this->fields['Name'] = &$this->Name;

		// ARTCycle
		$this->ARTCycle = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_ARTCycle', 'ARTCycle', '`ARTCycle`', '`ARTCycle`', 200, -1, FALSE, '`ARTCycle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Consultant
		$this->Consultant = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, -1, FALSE, '`Consultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Consultant->Sortable = TRUE; // Allow sort
		$this->fields['Consultant'] = &$this->Consultant;

		// InseminatinTechnique
		$this->InseminatinTechnique = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_InseminatinTechnique', 'InseminatinTechnique', '`InseminatinTechnique`', '`InseminatinTechnique`', 200, -1, FALSE, '`InseminatinTechnique`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IndicationForART
		$this->IndicationForART = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_IndicationForART', 'IndicationForART', '`IndicationForART`', '`IndicationForART`', 200, -1, FALSE, '`IndicationForART`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IndicationForART->Sortable = TRUE; // Allow sort
		$this->fields['IndicationForART'] = &$this->IndicationForART;

		// PreTreatment
		$this->PreTreatment = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_PreTreatment', 'PreTreatment', '`PreTreatment`', '`PreTreatment`', 200, -1, FALSE, '`PreTreatment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Hysteroscopy
		$this->Hysteroscopy = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Hysteroscopy', 'Hysteroscopy', '`Hysteroscopy`', '`Hysteroscopy`', 200, -1, FALSE, '`Hysteroscopy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->EndometrialScratching = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_EndometrialScratching', 'EndometrialScratching', '`EndometrialScratching`', '`EndometrialScratching`', 200, -1, FALSE, '`EndometrialScratching`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TrialCannulation
		$this->TrialCannulation = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_TrialCannulation', 'TrialCannulation', '`TrialCannulation`', '`TrialCannulation`', 200, -1, FALSE, '`TrialCannulation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// CYCLETYPE
		$this->CYCLETYPE = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_CYCLETYPE', 'CYCLETYPE', '`CYCLETYPE`', '`CYCLETYPE`', 200, -1, FALSE, '`CYCLETYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// HRTCYCLE
		$this->HRTCYCLE = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_HRTCYCLE', 'HRTCYCLE', '`HRTCYCLE`', '`HRTCYCLE`', 200, -1, FALSE, '`HRTCYCLE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HRTCYCLE->Sortable = TRUE; // Allow sort
		$this->fields['HRTCYCLE'] = &$this->HRTCYCLE;

		// OralEstrogenDosage
		$this->OralEstrogenDosage = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_OralEstrogenDosage', 'OralEstrogenDosage', '`OralEstrogenDosage`', '`OralEstrogenDosage`', 200, -1, FALSE, '`OralEstrogenDosage`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// VaginalEstrogen
		$this->VaginalEstrogen = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_VaginalEstrogen', 'VaginalEstrogen', '`VaginalEstrogen`', '`VaginalEstrogen`', 200, -1, FALSE, '`VaginalEstrogen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->VaginalEstrogen->Sortable = TRUE; // Allow sort
		$this->fields['VaginalEstrogen'] = &$this->VaginalEstrogen;

		// GCSF
		$this->GCSF = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_GCSF', 'GCSF', '`GCSF`', '`GCSF`', 200, -1, FALSE, '`GCSF`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ActivatedPRP
		$this->ActivatedPRP = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_ActivatedPRP', 'ActivatedPRP', '`ActivatedPRP`', '`ActivatedPRP`', 200, -1, FALSE, '`ActivatedPRP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ERA
		$this->ERA = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_ERA', 'ERA', '`ERA`', '`ERA`', 200, -1, FALSE, '`ERA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// UCLcm
		$this->UCLcm = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_UCLcm', 'UCLcm', '`UCLcm`', '`UCLcm`', 200, -1, FALSE, '`UCLcm`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->UCLcm->Sortable = TRUE; // Allow sort
		$this->fields['UCLcm'] = &$this->UCLcm;

		// DATEOFSTART
		$this->DATEOFSTART = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_DATEOFSTART', 'DATEOFSTART', '`DATEOFSTART`', CastDateFieldForLike('`DATEOFSTART`', 11, "DB"), 135, 11, FALSE, '`DATEOFSTART`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATEOFEMBRYOTRANSFER = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_DATEOFEMBRYOTRANSFER', 'DATEOFEMBRYOTRANSFER', '`DATEOFEMBRYOTRANSFER`', CastDateFieldForLike('`DATEOFEMBRYOTRANSFER`', 11, "DB"), 135, 11, FALSE, '`DATEOFEMBRYOTRANSFER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DAYOFEMBRYOTRANSFER
		$this->DAYOFEMBRYOTRANSFER = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_DAYOFEMBRYOTRANSFER', 'DAYOFEMBRYOTRANSFER', '`DAYOFEMBRYOTRANSFER`', '`DAYOFEMBRYOTRANSFER`', 200, -1, FALSE, '`DAYOFEMBRYOTRANSFER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAYOFEMBRYOTRANSFER->Sortable = TRUE; // Allow sort
		$this->fields['DAYOFEMBRYOTRANSFER'] = &$this->DAYOFEMBRYOTRANSFER;

		// NOOFEMBRYOSTHAWED
		$this->NOOFEMBRYOSTHAWED = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_NOOFEMBRYOSTHAWED', 'NOOFEMBRYOSTHAWED', '`NOOFEMBRYOSTHAWED`', '`NOOFEMBRYOSTHAWED`', 200, -1, FALSE, '`NOOFEMBRYOSTHAWED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->NOOFEMBRYOSTRANSFERRED = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_NOOFEMBRYOSTRANSFERRED', 'NOOFEMBRYOSTRANSFERRED', '`NOOFEMBRYOSTRANSFERRED`', '`NOOFEMBRYOSTRANSFERRED`', 200, -1, FALSE, '`NOOFEMBRYOSTRANSFERRED`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOOFEMBRYOSTRANSFERRED->Sortable = TRUE; // Allow sort
		$this->fields['NOOFEMBRYOSTRANSFERRED'] = &$this->NOOFEMBRYOSTRANSFERRED;

		// DAYOFEMBRYOS
		$this->DAYOFEMBRYOS = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_DAYOFEMBRYOS', 'DAYOFEMBRYOS', '`DAYOFEMBRYOS`', '`DAYOFEMBRYOS`', 200, -1, FALSE, '`DAYOFEMBRYOS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DAYOFEMBRYOS->Sortable = TRUE; // Allow sort
		$this->fields['DAYOFEMBRYOS'] = &$this->DAYOFEMBRYOS;

		// CRYOPRESERVEDEMBRYOS
		$this->CRYOPRESERVEDEMBRYOS = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_CRYOPRESERVEDEMBRYOS', 'CRYOPRESERVEDEMBRYOS', '`CRYOPRESERVEDEMBRYOS`', '`CRYOPRESERVEDEMBRYOS`', 200, -1, FALSE, '`CRYOPRESERVEDEMBRYOS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CRYOPRESERVEDEMBRYOS->Sortable = TRUE; // Allow sort
		$this->fields['CRYOPRESERVEDEMBRYOS'] = &$this->CRYOPRESERVEDEMBRYOS;

		// Code1
		$this->Code1 = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Code1', 'Code1', '`Code1`', '`Code1`', 200, -1, FALSE, '`Code1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code1->Sortable = TRUE; // Allow sort
		$this->fields['Code1'] = &$this->Code1;

		// Code2
		$this->Code2 = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Code2', 'Code2', '`Code2`', '`Code2`', 200, -1, FALSE, '`Code2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Code2->Sortable = TRUE; // Allow sort
		$this->fields['Code2'] = &$this->Code2;

		// CellStage1
		$this->CellStage1 = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_CellStage1', 'CellStage1', '`CellStage1`', '`CellStage1`', 200, -1, FALSE, '`CellStage1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CellStage1->Sortable = TRUE; // Allow sort
		$this->fields['CellStage1'] = &$this->CellStage1;

		// CellStage2
		$this->CellStage2 = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_CellStage2', 'CellStage2', '`CellStage2`', '`CellStage2`', 200, -1, FALSE, '`CellStage2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CellStage2->Sortable = TRUE; // Allow sort
		$this->fields['CellStage2'] = &$this->CellStage2;

		// Grade1
		$this->Grade1 = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Grade1', 'Grade1', '`Grade1`', '`Grade1`', 200, -1, FALSE, '`Grade1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Grade1->Sortable = TRUE; // Allow sort
		$this->fields['Grade1'] = &$this->Grade1;

		// Grade2
		$this->Grade2 = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Grade2', 'Grade2', '`Grade2`', '`Grade2`', 200, -1, FALSE, '`Grade2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Grade2->Sortable = TRUE; // Allow sort
		$this->fields['Grade2'] = &$this->Grade2;

		// ProcedureRecord
		$this->ProcedureRecord = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_ProcedureRecord', 'ProcedureRecord', '`ProcedureRecord`', '`ProcedureRecord`', 201, -1, FALSE, '`ProcedureRecord`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->ProcedureRecord->Sortable = TRUE; // Allow sort
		$this->fields['ProcedureRecord'] = &$this->ProcedureRecord;

		// Medicationsadvised
		$this->Medicationsadvised = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_Medicationsadvised', 'Medicationsadvised', '`Medicationsadvised`', '`Medicationsadvised`', 201, -1, FALSE, '`Medicationsadvised`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		$this->PostProcedureInstructions = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_PostProcedureInstructions', 'PostProcedureInstructions', '`PostProcedureInstructions`', '`PostProcedureInstructions`', 201, -1, FALSE, '`PostProcedureInstructions`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		$this->PregnancyTestingWithSerumBetaHcG = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_PregnancyTestingWithSerumBetaHcG', 'PregnancyTestingWithSerumBetaHcG', '`PregnancyTestingWithSerumBetaHcG`', '`PregnancyTestingWithSerumBetaHcG`', 200, -1, FALSE, '`PregnancyTestingWithSerumBetaHcG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReviewDate
		$this->ReviewDate = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_ReviewDate', 'ReviewDate', '`ReviewDate`', CastDateFieldForLike('`ReviewDate`', 0, "DB"), 135, 0, FALSE, '`ReviewDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReviewDoctor
		$this->ReviewDoctor = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_ReviewDoctor', 'ReviewDoctor', '`ReviewDoctor`', '`ReviewDoctor`', 200, -1, FALSE, '`ReviewDoctor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReviewDoctor->Sortable = TRUE; // Allow sort
		$this->fields['ReviewDoctor'] = &$this->ReviewDoctor;

		// TemplateProcedureRecord
		$this->TemplateProcedureRecord = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_TemplateProcedureRecord', 'TemplateProcedureRecord', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplateMedicationsadvised = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_TemplateMedicationsadvised', 'TemplateMedicationsadvised', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->TemplatePostProcedureInstructions = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_TemplatePostProcedureInstructions', 'TemplatePostProcedureInstructions', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TidNo
		$this->TidNo = new DbField('ivf_et_chart', 'ivf_et_chart', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, -1, FALSE, '`TidNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ivf_et_chartview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
