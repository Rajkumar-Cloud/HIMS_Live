 ...
 * Page class
 */
class banktransferto_delete extends banktransferto
{
	...
	// Page object name
	public $PageObjName = "banktransferto_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("banktransfertolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("banktransfertolist.php"); // Return to list
			}
		}
	}
