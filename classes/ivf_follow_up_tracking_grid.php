 ...
 * Page class
 */
class ivf_follow_up_tracking_grid extends ivf_follow_up_tracking
{
	...
	// Page object name
	public $PageObjName = "ivf_follow_up_tracking_grid";

	// Grid form hidden field names
	public $FormName = "fivf_follow_up_trackinggrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_Age") && $CurrentForm->hasValue("o_Age") && $this->Age->CurrentValue <> $this->Age->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_MReadMore") && $CurrentForm->hasValue("o_MReadMore") && $this->MReadMore->CurrentValue <> $this->MReadMore->OldValue)
			return FALSE;
	...
	protected function loadFormValues()
	{
		...
		$this->MReadMore->setOldValue($CurrentForm->getValue("o_MReadMore"));
