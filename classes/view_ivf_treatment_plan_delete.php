 ...
 * Page class
 */
class view_ivf_treatment_plan_delete extends view_ivf_treatment_plan
{
	...
	// Page object name
	public $PageObjName = "view_ivf_treatment_plan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_ivf_treatment_planlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("view_ivf_treatment_planlist.php"); // Return to list
			}
		}
	}
