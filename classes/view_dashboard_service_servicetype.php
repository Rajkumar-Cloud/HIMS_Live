...
class view_dashboard_service_servicetype extends DbTable
{
	...
	public function __construct()
	{
		...
		// DEPARTMENT
		$this->DEPARTMENT = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, -1, FALSE, '`DEPARTMENT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DEPARTMENT->IsForeignKey = TRUE; // Foreign key field
		$this->DEPARTMENT->Sortable = TRUE; // Allow sort
		$this->fields['DEPARTMENT'] = &$this->DEPARTMENT;

		// SERVICE_TYPE
		$this->SERVICE_TYPE = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_SERVICE_TYPE', 'SERVICE_TYPE', '`SERVICE_TYPE`', '`SERVICE_TYPE`', 200, -1, FALSE, '`SERVICE_TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sum(SubTotal)
		$this->sum28SubTotal29 = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_sum28SubTotal29', 'sum(SubTotal)', '`sum(SubTotal)`', '`sum(SubTotal)`', 131, -1, FALSE, '`sum(SubTotal)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// createdDate
		$this->createdDate = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike('`createdDate`', 7, "DB"), 133, 7, FALSE, '`createdDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// HospID
		$this->HospID = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_dashboard_service_details") {
			$detailUrl = $GLOBALS["view_dashboard_service_details"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("view_dashboard_service_servicetypeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($this->getCurrentMasterTable() == "view_dashboard_service_summary" && !ContainsString($url, TABLE_SHOW_MASTER . "=")) {
