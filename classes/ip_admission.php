...
class ip_admission extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ip_admission', 'ip_admission', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// mrnNo
		$this->mrnNo = new DbField('ip_admission', 'ip_admission', 'x_mrnNo', 'mrnNo', '`mrnNo`', '`mrnNo`', 200, -1, FALSE, '`mrnNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PatientID
		$this->PatientID = new DbField('ip_admission', 'ip_admission', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, -1, FALSE, '`PatientID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientID->Sortable = TRUE; // Allow sort
		$this->fields['PatientID'] = &$this->PatientID;

		// patient_name
		$this->patient_name = new DbField('ip_admission', 'ip_admission', 'x_patient_name', 'patient_name', '`patient_name`', '`patient_name`', 200, -1, FALSE, '`patient_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->patient_name->Sortable = TRUE; // Allow sort
		$this->fields['patient_name'] = &$this->patient_name;

		// mobileno
		$this->mobileno = new DbField('ip_admission', 'ip_admission', 'x_mobileno', 'mobileno', '`mobileno`', '`mobileno`', 200, -1, FALSE, '`mobileno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobileno->Sortable = TRUE; // Allow sort
		$this->fields['mobileno'] = &$this->mobileno;

		// gender
		$this->gender = new DbField('ip_admission', 'ip_admission', 'x_gender', 'gender', '`gender`', '`gender`', 200, -1, FALSE, '`gender`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->gender->Sortable = TRUE; // Allow sort
		$this->gender->Lookup = new Lookup('gender', 'sys_gender', FALSE, 'Name', ["Name","","",""], [], [], [], [], [], [], '', '');
		$this->fields['gender'] = &$this->gender;

		// age
		$this->age = new DbField('ip_admission', 'ip_admission', 'x_age', 'age', '`age`', '`age`', 200, -1, FALSE, '`age`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->age->Sortable = TRUE; // Allow sort
		$this->fields['age'] = &$this->age;

		// typeRegsisteration
		$this->typeRegsisteration = new DbField('ip_admission', 'ip_admission', 'x_typeRegsisteration', 'typeRegsisteration', '`typeRegsisteration`', '`typeRegsisteration`', 200, -1, FALSE, '`typeRegsisteration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PaymentCategory
		$this->PaymentCategory = new DbField('ip_admission', 'ip_admission', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, -1, FALSE, '`PaymentCategory`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// physician_id
		$this->physician_id = new DbField('ip_admission', 'ip_admission', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, -1, FALSE, '`physician_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->admission_consultant_id = new DbField('ip_admission', 'ip_admission', 'x_admission_consultant_id', 'admission_consultant_id', '`admission_consultant_id`', '`admission_consultant_id`', 3, -1, FALSE, '`admission_consultant_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->leading_consultant_id = new DbField('ip_admission', 'ip_admission', 'x_leading_consultant_id', 'leading_consultant_id', '`leading_consultant_id`', '`leading_consultant_id`', 3, -1, FALSE, '`leading_consultant_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// cause
		$this->cause = new DbField('ip_admission', 'ip_admission', 'x_cause', 'cause', '`cause`', '`cause`', 201, -1, FALSE, '`cause`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->cause->Sortable = TRUE; // Allow sort
		$this->fields['cause'] = &$this->cause;

		// admission_date
		$this->admission_date = new DbField('ip_admission', 'ip_admission', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike('`admission_date`', 11, "DB"), 135, 11, FALSE, '`admission_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// release_date
		$this->release_date = new DbField('ip_admission', 'ip_admission', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike('`release_date`', 17, "DB"), 135, 17, FALSE, '`release_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PaymentStatus
		$this->PaymentStatus = new DbField('ip_admission', 'ip_admission', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, -1, FALSE, '`PaymentStatus`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status
		$this->status = new DbField('ip_admission', 'ip_admission', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('ip_admission', 'ip_admission', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = FALSE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('ip_admission', 'ip_admission', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('ip_admission', 'ip_admission', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = FALSE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('ip_admission', 'ip_admission', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = FALSE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// profilePic
		$this->profilePic = new DbField('ip_admission', 'ip_admission', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, -1, FALSE, '`profilePic`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->profilePic->Sortable = TRUE; // Allow sort
		$this->fields['profilePic'] = &$this->profilePic;

		// HospID
		$this->HospID = new DbField('ip_admission', 'ip_admission', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DOB
		$this->DOB = new DbField('ip_admission', 'ip_admission', 'x_DOB', 'DOB', '\'\'', '\'\'', 201, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DOB->IsCustom = TRUE; // Custom field
		$this->DOB->Sortable = TRUE; // Allow sort
		$this->fields['DOB'] = &$this->DOB;

		// ReferedByDr
		$this->ReferedByDr = new DbField('ip_admission', 'ip_admission', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, -1, FALSE, '`EV__ReferedByDr`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// ReferClinicname
		$this->ReferClinicname = new DbField('ip_admission', 'ip_admission', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, -1, FALSE, '`ReferClinicname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferClinicname->Sortable = TRUE; // Allow sort
		$this->fields['ReferClinicname'] = &$this->ReferClinicname;

		// ReferCity
		$this->ReferCity = new DbField('ip_admission', 'ip_admission', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, -1, FALSE, '`ReferCity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferCity->Sortable = TRUE; // Allow sort
		$this->fields['ReferCity'] = &$this->ReferCity;

		// ReferMobileNo
		$this->ReferMobileNo = new DbField('ip_admission', 'ip_admission', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, -1, FALSE, '`ReferMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReferMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['ReferMobileNo'] = &$this->ReferMobileNo;

		// ReferA4TreatingConsultant
		$this->ReferA4TreatingConsultant = new DbField('ip_admission', 'ip_admission', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, -1, FALSE, '`EV__ReferA4TreatingConsultant`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// PurposreReferredfor
		$this->PurposreReferredfor = new DbField('ip_admission', 'ip_admission', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, -1, FALSE, '`PurposreReferredfor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PurposreReferredfor->Sortable = TRUE; // Allow sort
		$this->fields['PurposreReferredfor'] = &$this->PurposreReferredfor;

		// BillClosing
		$this->BillClosing = new DbField('ip_admission', 'ip_admission', 'x_BillClosing', 'BillClosing', '`BillClosing`', '`BillClosing`', 200, -1, FALSE, '`BillClosing`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillClosing->Sortable = TRUE; // Allow sort
		$this->fields['BillClosing'] = &$this->BillClosing;

		// BillClosingDate
		$this->BillClosingDate = new DbField('ip_admission', 'ip_admission', 'x_BillClosingDate', 'BillClosingDate', '`BillClosingDate`', CastDateFieldForLike('`BillClosingDate`', 0, "DB"), 135, 0, FALSE, '`BillClosingDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillNumber
		$this->BillNumber = new DbField('ip_admission', 'ip_admission', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, -1, FALSE, '`BillNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillNumber->Sortable = TRUE; // Allow sort
		$this->fields['BillNumber'] = &$this->BillNumber;

		// ClosingAmount
		$this->ClosingAmount = new DbField('ip_admission', 'ip_admission', 'x_ClosingAmount', 'ClosingAmount', '`ClosingAmount`', '`ClosingAmount`', 200, -1, FALSE, '`ClosingAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ClosingAmount->Sortable = TRUE; // Allow sort
		$this->fields['ClosingAmount'] = &$this->ClosingAmount;

		// ClosingType
		$this->ClosingType = new DbField('ip_admission', 'ip_admission', 'x_ClosingType', 'ClosingType', '`ClosingType`', '`ClosingType`', 200, -1, FALSE, '`ClosingType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ClosingType->Sortable = TRUE; // Allow sort
		$this->fields['ClosingType'] = &$this->ClosingType;

		// BillAmount
		$this->BillAmount = new DbField('ip_admission', 'ip_admission', 'x_BillAmount', 'BillAmount', '`BillAmount`', '`BillAmount`', 200, -1, FALSE, '`BillAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BillAmount->Sortable = TRUE; // Allow sort
		$this->fields['BillAmount'] = &$this->BillAmount;

		// billclosedBy
		$this->billclosedBy = new DbField('ip_admission', 'ip_admission', 'x_billclosedBy', 'billclosedBy', '`billclosedBy`', '`billclosedBy`', 200, -1, FALSE, '`billclosedBy`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->billclosedBy->Sortable = TRUE; // Allow sort
		$this->fields['billclosedBy'] = &$this->billclosedBy;

		// bllcloseByDate
		$this->bllcloseByDate = new DbField('ip_admission', 'ip_admission', 'x_bllcloseByDate', 'bllcloseByDate', '`bllcloseByDate`', CastDateFieldForLike('`bllcloseByDate`', 0, "DB"), 135, 0, FALSE, '`bllcloseByDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ReportHeader
		$this->ReportHeader = new DbField('ip_admission', 'ip_admission', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, -1, FALSE, '`ReportHeader`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ReportHeader->Sortable = TRUE; // Allow sort
		$this->fields['ReportHeader'] = &$this->ReportHeader;

		// Procedure
		$this->Procedure = new DbField('ip_admission', 'ip_admission', 'x_Procedure', 'Procedure', '`Procedure`', '`Procedure`', 200, -1, FALSE, '`Procedure`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Procedure->Sortable = TRUE; // Allow sort
		$this->fields['Procedure'] = &$this->Procedure;

		// Consultant
		$this->Consultant = new DbField('ip_admission', 'ip_admission', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, -1, FALSE, '`Consultant`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Consultant->Sortable = TRUE; // Allow sort
		$this->fields['Consultant'] = &$this->Consultant;

		// Anesthetist
		$this->Anesthetist = new DbField('ip_admission', 'ip_admission', 'x_Anesthetist', 'Anesthetist', '`Anesthetist`', '`Anesthetist`', 200, -1, FALSE, '`Anesthetist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Anesthetist->Sortable = TRUE; // Allow sort
		$this->fields['Anesthetist'] = &$this->Anesthetist;

		// Amound
		$this->Amound = new DbField('ip_admission', 'ip_admission', 'x_Amound', 'Amound', '`Amound`', '`Amound`', 131, -1, FALSE, '`Amound`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Package
		$this->Package = new DbField('ip_admission', 'ip_admission', 'x_Package', 'Package', '`Package`', '`Package`', 200, -1, FALSE, '`Package`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Package->Sortable = TRUE; // Allow sort
		$this->fields['Package'] = &$this->Package;

		// patient_id
		$this->patient_id = new DbField('ip_admission', 'ip_admission', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, -1, FALSE, '`EV__patient_id`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// PartnerID
		$this->PartnerID = new DbField('ip_admission', 'ip_admission', 'x_PartnerID', 'PartnerID', '`PartnerID`', '`PartnerID`', 200, -1, FALSE, '`PartnerID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerID->Sortable = TRUE; // Allow sort
		$this->fields['PartnerID'] = &$this->PartnerID;

		// PartnerName
		$this->PartnerName = new DbField('ip_admission', 'ip_admission', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, -1, FALSE, '`PartnerName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerName->Sortable = TRUE; // Allow sort
		$this->fields['PartnerName'] = &$this->PartnerName;

		// PartnerMobile
		$this->PartnerMobile = new DbField('ip_admission', 'ip_admission', 'x_PartnerMobile', 'PartnerMobile', '`PartnerMobile`', '`PartnerMobile`', 200, -1, FALSE, '`PartnerMobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PartnerMobile->Sortable = TRUE; // Allow sort
		$this->fields['PartnerMobile'] = &$this->PartnerMobile;

		// Cid
		$this->Cid = new DbField('ip_admission', 'ip_admission', 'x_Cid', 'Cid', '`Cid`', '`Cid`', 3, -1, FALSE, '`Cid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cid->Sortable = TRUE; // Allow sort
		$this->Cid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['Cid'] = &$this->Cid;

		// PartId
		$this->PartId = new DbField('ip_admission', 'ip_admission', 'x_PartId', 'PartId', '`PartId`', '`PartId`', 3, -1, FALSE, '`PartId`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// IDProof
		$this->IDProof = new DbField('ip_admission', 'ip_admission', 'x_IDProof', 'IDProof', '`IDProof`', '`IDProof`', 200, -1, FALSE, '`IDProof`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->IDProof->Sortable = TRUE; // Allow sort
		$this->fields['IDProof'] = &$this->IDProof;

		// AdviceToOtherHospital
		$this->AdviceToOtherHospital = new DbField('ip_admission', 'ip_admission', 'x_AdviceToOtherHospital', 'AdviceToOtherHospital', '`AdviceToOtherHospital`', '`AdviceToOtherHospital`', 200, -1, FALSE, '`AdviceToOtherHospital`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AdviceToOtherHospital->Sortable = TRUE; // Allow sort
		$this->fields['AdviceToOtherHospital'] = &$this->AdviceToOtherHospital;

		// Reason
		$this->Reason = new DbField('ip_admission', 'ip_admission', 'x_Reason', 'Reason', '`Reason`', '`Reason`', 201, -1, FALSE, '`Reason`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "patient_vitals") {
			$detailUrl = $GLOBALS["patient_vitals"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
		...
		if ($this->getCurrentDetailTable() == "patient_history") {
			$detailUrl = $GLOBALS["patient_history"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_provisional_diagnosis") {
			$detailUrl = $GLOBALS["patient_provisional_diagnosis"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_prescription") {
			$detailUrl = $GLOBALS["patient_prescription"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_final_diagnosis") {
			$detailUrl = $GLOBALS["patient_final_diagnosis"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_follow_up") {
			$detailUrl = $GLOBALS["patient_follow_up"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_ot_delivery_register") {
			$detailUrl = $GLOBALS["patient_ot_delivery_register"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_ot_surgery_register") {
			$detailUrl = $GLOBALS["patient_ot_surgery_register"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
		}
		...
		if ($this->getCurrentDetailTable() == "patient_investigations") {
			$detailUrl = $GLOBALS["patient_investigations"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_insurance") {
			$detailUrl = $GLOBALS["patient_insurance"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
		}
		...
		if ($this->getCurrentDetailTable() == "view_ip_advance") {
			$detailUrl = $GLOBALS["view_ip_advance"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "patient_room") {
			$detailUrl = $GLOBALS["patient_room"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_mrnNo=" . urlencode($this->mrnNo->CurrentValue);
			$detailUrl .= "&fk_patient_id=" . urlencode($this->patient_id->CurrentValue);
		}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ip_admissionview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ip_admissionedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("ip_admissionadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
