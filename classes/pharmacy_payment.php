...
class pharmacy_payment extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// PAYNO
		$this->PAYNO = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_PAYNO', 'PAYNO', '`PAYNO`', '`PAYNO`', 200, -1, FALSE, '`PAYNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PAYNO->Sortable = TRUE; // Allow sort
		$this->fields['PAYNO'] = &$this->PAYNO;

		// DT
		$this->DT = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_DT', 'DT', '`DT`', CastDateFieldForLike('`DT`', 7, "DB"), 135, 7, FALSE, '`DT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// YM
		$this->YM = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_YM', 'YM', '`YM`', '`YM`', 200, -1, FALSE, '`YM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->YM->Sortable = TRUE; // Allow sort
		$this->fields['YM'] = &$this->YM;

		// PC
		$this->PC = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_PC', 'PC', '`PC`', '`PC`', 200, -1, FALSE, '`PC`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PC->Sortable = TRUE; // Allow sort
		$this->fields['PC'] = &$this->PC;

		// Customercode
		$this->Customercode = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Customercode', 'Customercode', '`Customercode`', '`Customercode`', 200, -1, FALSE, '`Customercode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Customercode->Sortable = TRUE; // Allow sort
		$this->fields['Customercode'] = &$this->Customercode;

		// Customername
		$this->Customername = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Customername', 'Customername', '`Customername`', '`Customername`', 200, -1, FALSE, '`Customername`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// pharmacy_pocol
		$this->pharmacy_pocol = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_pharmacy_pocol', 'pharmacy_pocol', '`pharmacy_pocol`', '`pharmacy_pocol`', 200, -1, FALSE, '`pharmacy_pocol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Address1
		$this->Address1 = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 201, -1, FALSE, '`Address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address1->Sortable = TRUE; // Allow sort
		$this->fields['Address1'] = &$this->Address1;

		// Address2
		$this->Address2 = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 201, -1, FALSE, '`Address2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address2->Sortable = TRUE; // Allow sort
		$this->fields['Address2'] = &$this->Address2;

		// Address3
		$this->Address3 = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 201, -1, FALSE, '`Address3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address3->Sortable = TRUE; // Allow sort
		$this->fields['Address3'] = &$this->Address3;

		// State
		$this->State = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->State->Sortable = TRUE; // Allow sort
		$this->fields['State'] = &$this->State;

		// Pincode
		$this->Pincode = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Pincode', 'Pincode', '`Pincode`', '`Pincode`', 200, -1, FALSE, '`Pincode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pincode->Sortable = TRUE; // Allow sort
		$this->fields['Pincode'] = &$this->Pincode;

		// Phone
		$this->Phone = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Phone->Sortable = TRUE; // Allow sort
		$this->fields['Phone'] = &$this->Phone;

		// Fax
		$this->Fax = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, -1, FALSE, '`Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fax->Sortable = TRUE; // Allow sort
		$this->fields['Fax'] = &$this->Fax;

		// EEmail
		$this->EEmail = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_EEmail', 'EEmail', '`EEmail`', '`EEmail`', 200, -1, FALSE, '`EEmail`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EEmail->Sortable = TRUE; // Allow sort
		$this->fields['EEmail'] = &$this->EEmail;

		// HospID
		$this->HospID = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, -1, FALSE, '`HospID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HospID->Sortable = TRUE; // Allow sort
		$this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['HospID'] = &$this->HospID;

		// createdby
		$this->createdby = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike('`createddatetime`', 0, "DB"), 135, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike('`modifieddatetime`', 0, "DB"), 135, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// PharmacyID
		$this->PharmacyID = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_PharmacyID', 'PharmacyID', '`PharmacyID`', '`PharmacyID`', 3, -1, FALSE, '`PharmacyID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillTotalValue
		$this->BillTotalValue = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_BillTotalValue', 'BillTotalValue', '`BillTotalValue`', '`BillTotalValue`', 131, -1, FALSE, '`BillTotalValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// GRNTotalValue
		$this->GRNTotalValue = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_GRNTotalValue', 'GRNTotalValue', '`GRNTotalValue`', '`GRNTotalValue`', 131, -1, FALSE, '`GRNTotalValue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillDiscount
		$this->BillDiscount = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_BillDiscount', 'BillDiscount', '`BillDiscount`', '`BillDiscount`', 131, -1, FALSE, '`BillDiscount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BillUpload
		$this->BillUpload = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_BillUpload', 'BillUpload', '`BillUpload`', '`BillUpload`', 201, -1, FALSE, '`BillUpload`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->BillUpload->Sortable = TRUE; // Allow sort
		$this->fields['BillUpload'] = &$this->BillUpload;

		// TransPort
		$this->TransPort = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_TransPort', 'TransPort', '`TransPort`', '`TransPort`', 131, -1, FALSE, '`TransPort`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// AnyOther
		$this->AnyOther = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_AnyOther', 'AnyOther', '`AnyOther`', '`AnyOther`', 131, -1, FALSE, '`AnyOther`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// voucher_type
		$this->voucher_type = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, -1, FALSE, '`voucher_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->voucher_type->Sortable = TRUE; // Allow sort
		$this->fields['voucher_type'] = &$this->voucher_type;

		// Details
		$this->Details = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Details', 'Details', '`Details`', '`Details`', 200, -1, FALSE, '`Details`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Details->Sortable = TRUE; // Allow sort
		$this->fields['Details'] = &$this->Details;

		// ModeofPayment
		$this->ModeofPayment = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, -1, FALSE, '`ModeofPayment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Amount
		$this->Amount = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, -1, FALSE, '`Amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// BankName
		$this->BankName = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, -1, FALSE, '`BankName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->BankName->Sortable = TRUE; // Allow sort
		$this->fields['BankName'] = &$this->BankName;

		// AccountNumber
		$this->AccountNumber = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_AccountNumber', 'AccountNumber', '`AccountNumber`', '`AccountNumber`', 200, -1, FALSE, '`AccountNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->AccountNumber->Sortable = TRUE; // Allow sort
		$this->fields['AccountNumber'] = &$this->AccountNumber;

		// chequeNumber
		$this->chequeNumber = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_chequeNumber', 'chequeNumber', '`chequeNumber`', '`chequeNumber`', 200, -1, FALSE, '`chequeNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->chequeNumber->Sortable = TRUE; // Allow sort
		$this->fields['chequeNumber'] = &$this->chequeNumber;

		// Remarks
		$this->Remarks = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// SeectPaymentMode
		$this->SeectPaymentMode = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_SeectPaymentMode', 'SeectPaymentMode', '`SeectPaymentMode`', '`SeectPaymentMode`', 200, -1, FALSE, '`SeectPaymentMode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SeectPaymentMode->Sortable = TRUE; // Allow sort
		$this->fields['SeectPaymentMode'] = &$this->SeectPaymentMode;

		// PaidAmount
		$this->PaidAmount = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_PaidAmount', 'PaidAmount', '`PaidAmount`', '`PaidAmount`', 200, -1, FALSE, '`PaidAmount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PaidAmount->Sortable = TRUE; // Allow sort
		$this->fields['PaidAmount'] = &$this->PaidAmount;

		// Currency
		$this->Currency = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, -1, FALSE, '`Currency`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Currency->Sortable = TRUE; // Allow sort
		$this->fields['Currency'] = &$this->Currency;

		// CardNumber
		$this->CardNumber = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, -1, FALSE, '`CardNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "pharmacy_grn") {
			$detailUrl = $GLOBALS["pharmacy_grn"]->getListUrl() . "?" . TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_paymentview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_paymentedit.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm <> "")
			...
			$url = $this->keyUrl("pharmacy_paymentadd.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
		return $this->addMasterUrl($url);
	}
