 ...
 * Page class
 */
class ivf_ovumpickupchartt_delete extends ivf_ovumpickupchartt
{
	...
	// Page object name
	public $PageObjName = "ivf_ovumpickupchartt_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_ovumpickupcharttlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("ivf_ovumpickupcharttlist.php"); // Return to list
			}
		}
	}
