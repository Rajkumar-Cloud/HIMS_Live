...
var fivf_agencyadd = currentForm = new ew.Form("fivf_agencyadd", "add");
...
fivf_agencyadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($ivf_agency_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_agency_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_agency->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_agency_Name" for="x_Name" class="<?php echo $ivf_agency_add->LeftColumnClass ?>"><?php echo $ivf_agency->Name->caption() ?><?php echo ($ivf_agency->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_agency_add->RightColumnClass ?>"><div<?php echo $ivf_agency->Name->cellAttributes() ?>>
...
<?php if ($ivf_agency->Street->Visible) { // Street ?>
	<div id="r_Street" class="form-group row">
		<label id="elh_ivf_agency_Street" for="x_Street" class="<?php echo $ivf_agency_add->LeftColumnClass ?>"><?php echo $ivf_agency->Street->caption() ?><?php echo ($ivf_agency->Street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_agency_add->RightColumnClass ?>"><div<?php echo $ivf_agency->Street->cellAttributes() ?>>
...
<?php if ($ivf_agency->Town->Visible) { // Town ?>
	<div id="r_Town" class="form-group row">
		<label id="elh_ivf_agency_Town" for="x_Town" class="<?php echo $ivf_agency_add->LeftColumnClass ?>"><?php echo $ivf_agency->Town->caption() ?><?php echo ($ivf_agency->Town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_agency_add->RightColumnClass ?>"><div<?php echo $ivf_agency->Town->cellAttributes() ?>>
...
<?php if ($ivf_agency->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_ivf_agency_State" for="x_State" class="<?php echo $ivf_agency_add->LeftColumnClass ?>"><?php echo $ivf_agency->State->caption() ?><?php echo ($ivf_agency->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_agency_add->RightColumnClass ?>"><div<?php echo $ivf_agency->State->cellAttributes() ?>>
...
<?php if ($ivf_agency->Pin->Visible) { // Pin ?>
	<div id="r_Pin" class="form-group row">
		<label id="elh_ivf_agency_Pin" for="x_Pin" class="<?php echo $ivf_agency_add->LeftColumnClass ?>"><?php echo $ivf_agency->Pin->caption() ?><?php echo ($ivf_agency->Pin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_agency_add->RightColumnClass ?>"><div<?php echo $ivf_agency->Pin->cellAttributes() ?>>
