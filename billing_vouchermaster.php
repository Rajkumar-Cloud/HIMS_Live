...
<?php if ($billing_voucher->CardType->Visible) { // CardType ?>
		<tr id="r_CardType">
			<td class="<?php echo $billing_voucher->TableLeftColumnClass ?>"><?php echo $billing_voucher->CardType->caption() ?></td>
...
<?php if ($billing_voucher->PharmacyBill->Visible) { // PharmacyBill ?>
		<tr id="r_PharmacyBill">
			<td class="<?php echo $billing_voucher->TableLeftColumnClass ?>"><?php echo $billing_voucher->PharmacyBill->caption() ?></td>
...
<?php if ($billing_voucher->DiscountAmount->Visible) { // DiscountAmount ?>
		<tr id="r_DiscountAmount">
			<td class="<?php echo $billing_voucher->TableLeftColumnClass ?>"><?php echo $billing_voucher->DiscountAmount->caption() ?></td>
...
<?php if ($billing_voucher->Cash->Visible) { // Cash ?>
		<tr id="r_Cash">
			<td class="<?php echo $billing_voucher->TableLeftColumnClass ?>"><?php echo $billing_voucher->Cash->caption() ?></td>
...
<?php if ($billing_voucher->Card->Visible) { // Card ?>
		<tr id="r_Card">
			<td class="<?php echo $billing_voucher->TableLeftColumnClass ?>"><?php echo $billing_voucher->Card->caption() ?></td>
