...
var fpharmacy_poadd = currentForm = new ew.Form("fpharmacy_poadd", "add");
...
fpharmacy_poadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_po_add->createdby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $pharmacy_po->createdby->caption(), $pharmacy_po->createdby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($pharmacy_po_add->createddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_createddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $pharmacy_po->createddatetime->caption(), $pharmacy_po->createddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fpharmacy_poadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_poadd.lists["x_PC"] = <?php echo $pharmacy_po_add->PC->Lookup->toClientList() ?>;
fpharmacy_poadd.lists["x_PC"].options = <?php echo JsonEncode($pharmacy_po_add->PC->lookupOptions()) ?>;
fpharmacy_poadd.lists["x_BRCODE"] = <?php echo $pharmacy_po_add->BRCODE->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_po_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_po_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_po->ORDNO->Visible) { // ORDNO ?>
	<div id="r_ORDNO" class="form-group row">
		<label id="elh_pharmacy_po_ORDNO" for="x_ORDNO" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_ORDNO" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->ORDNO->caption() ?><?php echo ($pharmacy_po->ORDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->ORDNO->cellAttributes() ?>>
<script id="tpx_pharmacy_po_ORDNO" class="pharmacy_poadd" type="text/html">
<span id="el_pharmacy_po_ORDNO">
<input type="text" data-table="pharmacy_po" data-field="x_ORDNO" name="x_ORDNO" id="x_ORDNO" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($pharmacy_po->ORDNO->getPlaceHolder()) ?>" value="<?php echo $pharmacy_po->ORDNO->EditValue ?>"<?php echo $pharmacy_po->ORDNO->editAttributes() ?>>
</span>
</script>
...
<?php if ($pharmacy_po->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_pharmacy_po_DT" for="x_DT" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_DT" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->DT->caption() ?><?php echo ($pharmacy_po->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->DT->cellAttributes() ?>>
<script id="tpx_pharmacy_po_DT" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_pharmacy_po_YM" for="x_YM" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_YM" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->YM->caption() ?><?php echo ($pharmacy_po->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->YM->cellAttributes() ?>>
<script id="tpx_pharmacy_po_YM" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_pharmacy_po_PC" for="x_PC" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_PC" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->PC->caption() ?><?php echo ($pharmacy_po->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->PC->cellAttributes() ?>>
<script id="tpx_pharmacy_po_PC" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Customercode->Visible) { // Customercode ?>
	<div id="r_Customercode" class="form-group row">
		<label id="elh_pharmacy_po_Customercode" for="x_Customercode" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Customercode" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Customercode->caption() ?><?php echo ($pharmacy_po->Customercode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Customercode->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Customercode" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Customername->Visible) { // Customername ?>
	<div id="r_Customername" class="form-group row">
		<label id="elh_pharmacy_po_Customername" for="x_Customername" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Customername" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Customername->caption() ?><?php echo ($pharmacy_po->Customername->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Customername->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Customername" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->pharmacy_pocol->Visible) { // pharmacy_pocol ?>
	<div id="r_pharmacy_pocol" class="form-group row">
		<label id="elh_pharmacy_po_pharmacy_pocol" for="x_pharmacy_pocol" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_pharmacy_pocol" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->pharmacy_pocol->caption() ?><?php echo ($pharmacy_po->pharmacy_pocol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->pharmacy_pocol->cellAttributes() ?>>
<script id="tpx_pharmacy_po_pharmacy_pocol" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Address1->Visible) { // Address1 ?>
	<div id="r_Address1" class="form-group row">
		<label id="elh_pharmacy_po_Address1" for="x_Address1" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Address1" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Address1->caption() ?><?php echo ($pharmacy_po->Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Address1->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Address1" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Address2->Visible) { // Address2 ?>
	<div id="r_Address2" class="form-group row">
		<label id="elh_pharmacy_po_Address2" for="x_Address2" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Address2" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Address2->caption() ?><?php echo ($pharmacy_po->Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Address2->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Address2" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Address3->Visible) { // Address3 ?>
	<div id="r_Address3" class="form-group row">
		<label id="elh_pharmacy_po_Address3" for="x_Address3" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Address3" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Address3->caption() ?><?php echo ($pharmacy_po->Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Address3->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Address3" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_pharmacy_po_State" for="x_State" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_State" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->State->caption() ?><?php echo ($pharmacy_po->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->State->cellAttributes() ?>>
<script id="tpx_pharmacy_po_State" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Pincode->Visible) { // Pincode ?>
	<div id="r_Pincode" class="form-group row">
		<label id="elh_pharmacy_po_Pincode" for="x_Pincode" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Pincode" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Pincode->caption() ?><?php echo ($pharmacy_po->Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Pincode->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Pincode" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Phone->Visible) { // Phone ?>
	<div id="r_Phone" class="form-group row">
		<label id="elh_pharmacy_po_Phone" for="x_Phone" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Phone" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Phone->caption() ?><?php echo ($pharmacy_po->Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Phone->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Phone" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->Fax->Visible) { // Fax ?>
	<div id="r_Fax" class="form-group row">
		<label id="elh_pharmacy_po_Fax" for="x_Fax" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_Fax" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->Fax->caption() ?><?php echo ($pharmacy_po->Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->Fax->cellAttributes() ?>>
<script id="tpx_pharmacy_po_Fax" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->EEmail->Visible) { // EEmail ?>
	<div id="r_EEmail" class="form-group row">
		<label id="elh_pharmacy_po_EEmail" for="x_EEmail" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_EEmail" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->EEmail->caption() ?><?php echo ($pharmacy_po->EEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->EEmail->cellAttributes() ?>>
<script id="tpx_pharmacy_po_EEmail" class="pharmacy_poadd" type="text/html">
...
<?php if ($pharmacy_po->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_pharmacy_po_BRCODE" for="x_BRCODE" class="<?php echo $pharmacy_po_add->LeftColumnClass ?>"><script id="tpc_pharmacy_po_BRCODE" class="pharmacy_poadd" type="text/html"><span><?php echo $pharmacy_po->BRCODE->caption() ?><?php echo ($pharmacy_po->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_po_add->RightColumnClass ?>"><div<?php echo $pharmacy_po->BRCODE->cellAttributes() ?>>
<script id="tpx_pharmacy_po_BRCODE" class="pharmacy_poadd" type="text/html">
...
ew.applyTemplate("tpd_pharmacy_poadd", "tpm_pharmacy_poadd", "pharmacy_poadd", "<?php echo $pharmacy_po->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.pharmacy_poadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
