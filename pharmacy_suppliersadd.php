...
var fpharmacy_suppliersadd = currentForm = new ew.Form("fpharmacy_suppliersadd", "add");
...
fpharmacy_suppliersadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pharmacy_suppliers_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_suppliers_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_suppliers->Suppliercode->Visible) { // Suppliercode ?>
	<div id="r_Suppliercode" class="form-group row">
		<label id="elh_pharmacy_suppliers_Suppliercode" for="x_Suppliercode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Suppliercode->caption() ?><?php echo ($pharmacy_suppliers->Suppliercode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Suppliercode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Suppliername->Visible) { // Suppliername ?>
	<div id="r_Suppliername" class="form-group row">
		<label id="elh_pharmacy_suppliers_Suppliername" for="x_Suppliername" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Suppliername->caption() ?><?php echo ($pharmacy_suppliers->Suppliername->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Suppliername->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Abbreviation->Visible) { // Abbreviation ?>
	<div id="r_Abbreviation" class="form-group row">
		<label id="elh_pharmacy_suppliers_Abbreviation" for="x_Abbreviation" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Abbreviation->caption() ?><?php echo ($pharmacy_suppliers->Abbreviation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Abbreviation->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Creationdate->Visible) { // Creationdate ?>
	<div id="r_Creationdate" class="form-group row">
		<label id="elh_pharmacy_suppliers_Creationdate" for="x_Creationdate" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Creationdate->caption() ?><?php echo ($pharmacy_suppliers->Creationdate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Creationdate->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Address1->Visible) { // Address1 ?>
	<div id="r_Address1" class="form-group row">
		<label id="elh_pharmacy_suppliers_Address1" for="x_Address1" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Address1->caption() ?><?php echo ($pharmacy_suppliers->Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Address1->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Address2->Visible) { // Address2 ?>
	<div id="r_Address2" class="form-group row">
		<label id="elh_pharmacy_suppliers_Address2" for="x_Address2" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Address2->caption() ?><?php echo ($pharmacy_suppliers->Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Address2->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Address3->Visible) { // Address3 ?>
	<div id="r_Address3" class="form-group row">
		<label id="elh_pharmacy_suppliers_Address3" for="x_Address3" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Address3->caption() ?><?php echo ($pharmacy_suppliers->Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Address3->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Citycode->Visible) { // Citycode ?>
	<div id="r_Citycode" class="form-group row">
		<label id="elh_pharmacy_suppliers_Citycode" for="x_Citycode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Citycode->caption() ?><?php echo ($pharmacy_suppliers->Citycode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Citycode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_pharmacy_suppliers_State" for="x_State" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->State->caption() ?><?php echo ($pharmacy_suppliers->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->State->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Pincode->Visible) { // Pincode ?>
	<div id="r_Pincode" class="form-group row">
		<label id="elh_pharmacy_suppliers_Pincode" for="x_Pincode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Pincode->caption() ?><?php echo ($pharmacy_suppliers->Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Pincode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Tngstnumber->Visible) { // Tngstnumber ?>
	<div id="r_Tngstnumber" class="form-group row">
		<label id="elh_pharmacy_suppliers_Tngstnumber" for="x_Tngstnumber" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Tngstnumber->caption() ?><?php echo ($pharmacy_suppliers->Tngstnumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Tngstnumber->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Phone->Visible) { // Phone ?>
	<div id="r_Phone" class="form-group row">
		<label id="elh_pharmacy_suppliers_Phone" for="x_Phone" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Phone->caption() ?><?php echo ($pharmacy_suppliers->Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Phone->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Fax->Visible) { // Fax ?>
	<div id="r_Fax" class="form-group row">
		<label id="elh_pharmacy_suppliers_Fax" for="x_Fax" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Fax->caption() ?><?php echo ($pharmacy_suppliers->Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Fax->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group row">
		<label id="elh_pharmacy_suppliers__Email" for="x__Email" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->_Email->caption() ?><?php echo ($pharmacy_suppliers->_Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->_Email->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Paymentmode->Visible) { // Paymentmode ?>
	<div id="r_Paymentmode" class="form-group row">
		<label id="elh_pharmacy_suppliers_Paymentmode" for="x_Paymentmode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Paymentmode->caption() ?><?php echo ($pharmacy_suppliers->Paymentmode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Paymentmode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Contactperson1->Visible) { // Contactperson1 ?>
	<div id="r_Contactperson1" class="form-group row">
		<label id="elh_pharmacy_suppliers_Contactperson1" for="x_Contactperson1" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Contactperson1->caption() ?><?php echo ($pharmacy_suppliers->Contactperson1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Contactperson1->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Address1->Visible) { // CP1Address1 ?>
	<div id="r_CP1Address1" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Address1" for="x_CP1Address1" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Address1->caption() ?><?php echo ($pharmacy_suppliers->CP1Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Address1->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Address2->Visible) { // CP1Address2 ?>
	<div id="r_CP1Address2" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Address2" for="x_CP1Address2" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Address2->caption() ?><?php echo ($pharmacy_suppliers->CP1Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Address2->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Address3->Visible) { // CP1Address3 ?>
	<div id="r_CP1Address3" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Address3" for="x_CP1Address3" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Address3->caption() ?><?php echo ($pharmacy_suppliers->CP1Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Address3->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Citycode->Visible) { // CP1Citycode ?>
	<div id="r_CP1Citycode" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Citycode" for="x_CP1Citycode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Citycode->caption() ?><?php echo ($pharmacy_suppliers->CP1Citycode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Citycode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1State->Visible) { // CP1State ?>
	<div id="r_CP1State" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1State" for="x_CP1State" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1State->caption() ?><?php echo ($pharmacy_suppliers->CP1State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1State->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Pincode->Visible) { // CP1Pincode ?>
	<div id="r_CP1Pincode" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Pincode" for="x_CP1Pincode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Pincode->caption() ?><?php echo ($pharmacy_suppliers->CP1Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Pincode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Designation->Visible) { // CP1Designation ?>
	<div id="r_CP1Designation" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Designation" for="x_CP1Designation" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Designation->caption() ?><?php echo ($pharmacy_suppliers->CP1Designation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Designation->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Phone->Visible) { // CP1Phone ?>
	<div id="r_CP1Phone" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Phone" for="x_CP1Phone" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Phone->caption() ?><?php echo ($pharmacy_suppliers->CP1Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Phone->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1MobileNo->Visible) { // CP1MobileNo ?>
	<div id="r_CP1MobileNo" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1MobileNo" for="x_CP1MobileNo" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1MobileNo->caption() ?><?php echo ($pharmacy_suppliers->CP1MobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1MobileNo->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Fax->Visible) { // CP1Fax ?>
	<div id="r_CP1Fax" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Fax" for="x_CP1Fax" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Fax->caption() ?><?php echo ($pharmacy_suppliers->CP1Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Fax->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP1Email->Visible) { // CP1Email ?>
	<div id="r_CP1Email" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP1Email" for="x_CP1Email" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP1Email->caption() ?><?php echo ($pharmacy_suppliers->CP1Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP1Email->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Contactperson2->Visible) { // Contactperson2 ?>
	<div id="r_Contactperson2" class="form-group row">
		<label id="elh_pharmacy_suppliers_Contactperson2" for="x_Contactperson2" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Contactperson2->caption() ?><?php echo ($pharmacy_suppliers->Contactperson2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Contactperson2->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Address1->Visible) { // CP2Address1 ?>
	<div id="r_CP2Address1" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Address1" for="x_CP2Address1" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Address1->caption() ?><?php echo ($pharmacy_suppliers->CP2Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Address1->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Address2->Visible) { // CP2Address2 ?>
	<div id="r_CP2Address2" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Address2" for="x_CP2Address2" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Address2->caption() ?><?php echo ($pharmacy_suppliers->CP2Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Address2->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Address3->Visible) { // CP2Address3 ?>
	<div id="r_CP2Address3" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Address3" for="x_CP2Address3" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Address3->caption() ?><?php echo ($pharmacy_suppliers->CP2Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Address3->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Citycode->Visible) { // CP2Citycode ?>
	<div id="r_CP2Citycode" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Citycode" for="x_CP2Citycode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Citycode->caption() ?><?php echo ($pharmacy_suppliers->CP2Citycode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Citycode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2State->Visible) { // CP2State ?>
	<div id="r_CP2State" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2State" for="x_CP2State" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2State->caption() ?><?php echo ($pharmacy_suppliers->CP2State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2State->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Pincode->Visible) { // CP2Pincode ?>
	<div id="r_CP2Pincode" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Pincode" for="x_CP2Pincode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Pincode->caption() ?><?php echo ($pharmacy_suppliers->CP2Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Pincode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Designation->Visible) { // CP2Designation ?>
	<div id="r_CP2Designation" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Designation" for="x_CP2Designation" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Designation->caption() ?><?php echo ($pharmacy_suppliers->CP2Designation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Designation->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Phone->Visible) { // CP2Phone ?>
	<div id="r_CP2Phone" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Phone" for="x_CP2Phone" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Phone->caption() ?><?php echo ($pharmacy_suppliers->CP2Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Phone->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2MobileNo->Visible) { // CP2MobileNo ?>
	<div id="r_CP2MobileNo" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2MobileNo" for="x_CP2MobileNo" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2MobileNo->caption() ?><?php echo ($pharmacy_suppliers->CP2MobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2MobileNo->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Fax->Visible) { // CP2Fax ?>
	<div id="r_CP2Fax" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Fax" for="x_CP2Fax" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Fax->caption() ?><?php echo ($pharmacy_suppliers->CP2Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Fax->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->CP2Email->Visible) { // CP2Email ?>
	<div id="r_CP2Email" class="form-group row">
		<label id="elh_pharmacy_suppliers_CP2Email" for="x_CP2Email" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->CP2Email->caption() ?><?php echo ($pharmacy_suppliers->CP2Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->CP2Email->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group row">
		<label id="elh_pharmacy_suppliers_Type" for="x_Type" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Type->caption() ?><?php echo ($pharmacy_suppliers->Type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Type->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Creditterms->Visible) { // Creditterms ?>
	<div id="r_Creditterms" class="form-group row">
		<label id="elh_pharmacy_suppliers_Creditterms" for="x_Creditterms" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Creditterms->caption() ?><?php echo ($pharmacy_suppliers->Creditterms->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Creditterms->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_pharmacy_suppliers_Remarks" for="x_Remarks" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Remarks->caption() ?><?php echo ($pharmacy_suppliers->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Remarks->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Tinnumber->Visible) { // Tinnumber ?>
	<div id="r_Tinnumber" class="form-group row">
		<label id="elh_pharmacy_suppliers_Tinnumber" for="x_Tinnumber" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Tinnumber->caption() ?><?php echo ($pharmacy_suppliers->Tinnumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Tinnumber->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Universalsuppliercode->Visible) { // Universalsuppliercode ?>
	<div id="r_Universalsuppliercode" class="form-group row">
		<label id="elh_pharmacy_suppliers_Universalsuppliercode" for="x_Universalsuppliercode" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Universalsuppliercode->caption() ?><?php echo ($pharmacy_suppliers->Universalsuppliercode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Universalsuppliercode->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->Mobilenumber->Visible) { // Mobilenumber ?>
	<div id="r_Mobilenumber" class="form-group row">
		<label id="elh_pharmacy_suppliers_Mobilenumber" for="x_Mobilenumber" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->Mobilenumber->caption() ?><?php echo ($pharmacy_suppliers->Mobilenumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->Mobilenumber->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->PANNumber->Visible) { // PANNumber ?>
	<div id="r_PANNumber" class="form-group row">
		<label id="elh_pharmacy_suppliers_PANNumber" for="x_PANNumber" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->PANNumber->caption() ?><?php echo ($pharmacy_suppliers->PANNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->PANNumber->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->SalesRepMobileNo->Visible) { // SalesRepMobileNo ?>
	<div id="r_SalesRepMobileNo" class="form-group row">
		<label id="elh_pharmacy_suppliers_SalesRepMobileNo" for="x_SalesRepMobileNo" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->SalesRepMobileNo->caption() ?><?php echo ($pharmacy_suppliers->SalesRepMobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->SalesRepMobileNo->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->GSTNumber->Visible) { // GSTNumber ?>
	<div id="r_GSTNumber" class="form-group row">
		<label id="elh_pharmacy_suppliers_GSTNumber" for="x_GSTNumber" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->GSTNumber->caption() ?><?php echo ($pharmacy_suppliers->GSTNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->GSTNumber->cellAttributes() ?>>
...
<?php if ($pharmacy_suppliers->TANNumber->Visible) { // TANNumber ?>
	<div id="r_TANNumber" class="form-group row">
		<label id="elh_pharmacy_suppliers_TANNumber" for="x_TANNumber" class="<?php echo $pharmacy_suppliers_add->LeftColumnClass ?>"><?php echo $pharmacy_suppliers->TANNumber->caption() ?><?php echo ($pharmacy_suppliers->TANNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_suppliers_add->RightColumnClass ?>"><div<?php echo $pharmacy_suppliers->TANNumber->cellAttributes() ?>>
