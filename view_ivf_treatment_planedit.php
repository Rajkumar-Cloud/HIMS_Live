...
var fview_ivf_treatment_planedit = currentForm = new ew.Form("fview_ivf_treatment_planedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_ivf_treatment_plan_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_ivf_treatment_plan->id->caption(), $view_ivf_treatment_plan->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php if ($view_ivf_treatment_plan_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_ivf_treatment_plan->modifiedby->caption(), $view_ivf_treatment_plan->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($view_ivf_treatment_plan_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_ivf_treatment_plan->modifieddatetime->caption(), $view_ivf_treatment_plan->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fview_ivf_treatment_planedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_ivf_treatment_planedit.lists["x_RIDNO"] = <?php echo $view_ivf_treatment_plan_edit->RIDNO->Lookup->toClientList() ?>;
fview_ivf_treatment_planedit.lists["x_RIDNO"].options = <?php echo JsonEncode($view_ivf_treatment_plan_edit->RIDNO->lookupOptions()) ?>;
fview_ivf_treatment_planedit.lists["x_treatment_status"] = <?php echo $view_ivf_treatment_plan_edit->treatment_status->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_ARTCYCLE"] = <?php echo $view_ivf_treatment_plan_edit->ARTCYCLE->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_RESULT"] = <?php echo $view_ivf_treatment_plan_edit->RESULT->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_status"] = <?php echo $view_ivf_treatment_plan_edit->status->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_Treatment"] = <?php echo $view_ivf_treatment_plan_edit->Treatment->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_TypeOfCycle"] = <?php echo $view_ivf_treatment_plan_edit->TypeOfCycle->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_SpermOrgin"] = <?php echo $view_ivf_treatment_plan_edit->SpermOrgin->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_State"] = <?php echo $view_ivf_treatment_plan_edit->State->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_MACS"] = <?php echo $view_ivf_treatment_plan_edit->MACS->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_PgdPlanning"] = <?php echo $view_ivf_treatment_plan_edit->PgdPlanning->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_MaleIndications"] = <?php echo $view_ivf_treatment_plan_edit->MaleIndications->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_FemaleIndications"] = <?php echo $view_ivf_treatment_plan_edit->FemaleIndications->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_Heterotopic"] = <?php echo $view_ivf_treatment_plan_edit->Heterotopic->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_TransferDFE[]"] = <?php echo $view_ivf_treatment_plan_edit->TransferDFE->Lookup->toClientList() ?>;
...
fview_ivf_treatment_planedit.lists["x_TineLapse"] = <?php echo $view_ivf_treatment_plan_edit->TineLapse->Lookup->toClientList() ?>;
...
<?php if ($view_ivf_treatment_plan_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_ivf_treatment_plan_edit->Token ?>">
<?php } ?>
...
<?php if ($view_ivf_treatment_plan->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_id" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_id" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->id->caption() ?><?php echo ($view_ivf_treatment_plan->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->id->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_id" class="view_ivf_treatment_planedit" type="text/html">
<span id="el_view_ivf_treatment_plan_id">
<span<?php echo $view_ivf_treatment_plan->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($view_ivf_treatment_plan->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="view_ivf_treatment_plan" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($view_ivf_treatment_plan->id->CurrentValue) ?>">
<?php echo $view_ivf_treatment_plan->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_ivf_treatment_plan->CoupleID->Visible) { // CoupleID ?>
	<div id="r_CoupleID" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_CoupleID" for="x_CoupleID" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_CoupleID" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->CoupleID->caption() ?><?php echo ($view_ivf_treatment_plan->CoupleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->CoupleID->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_CoupleID" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_PatientID" for="x_PatientID" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_PatientID" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->PatientID->caption() ?><?php echo ($view_ivf_treatment_plan->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->PatientID->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_PatientID" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_PatientName" for="x_PatientName" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_PatientName" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->PatientName->caption() ?><?php echo ($view_ivf_treatment_plan->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->PatientName->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_PatientName" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->WifeCell->Visible) { // WifeCell ?>
	<div id="r_WifeCell" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_WifeCell" for="x_WifeCell" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_WifeCell" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->WifeCell->caption() ?><?php echo ($view_ivf_treatment_plan->WifeCell->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->WifeCell->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_WifeCell" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_PartnerID" for="x_PartnerID" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_PartnerID" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->PartnerID->caption() ?><?php echo ($view_ivf_treatment_plan->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->PartnerID->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_PartnerID" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_PartnerName" for="x_PartnerName" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_PartnerName" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->PartnerName->caption() ?><?php echo ($view_ivf_treatment_plan->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->PartnerName->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_PartnerName" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->HusbandCell->Visible) { // HusbandCell ?>
	<div id="r_HusbandCell" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_HusbandCell" for="x_HusbandCell" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_HusbandCell" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->HusbandCell->caption() ?><?php echo ($view_ivf_treatment_plan->HusbandCell->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->HusbandCell->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_HusbandCell" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_RIDNO" for="x_RIDNO" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_RIDNO" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->RIDNO->caption() ?><?php echo ($view_ivf_treatment_plan->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->RIDNO->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_RIDNO" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Name" for="x_Name" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Name" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Name->caption() ?><?php echo ($view_ivf_treatment_plan->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Name->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Name" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Age" for="x_Age" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Age" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Age->caption() ?><?php echo ($view_ivf_treatment_plan->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Age->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Age" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TreatmentStartDate->Visible) { // TreatmentStartDate ?>
	<div id="r_TreatmentStartDate" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TreatmentStartDate" for="x_TreatmentStartDate" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TreatmentStartDate" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TreatmentStartDate->caption() ?><?php echo ($view_ivf_treatment_plan->TreatmentStartDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TreatmentStartDate->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TreatmentStartDate" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->treatment_status->Visible) { // treatment_status ?>
	<div id="r_treatment_status" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_treatment_status" for="x_treatment_status" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_treatment_status" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->treatment_status->caption() ?><?php echo ($view_ivf_treatment_plan->treatment_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->treatment_status->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_treatment_status" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->ARTCYCLE->Visible) { // ARTCYCLE ?>
	<div id="r_ARTCYCLE" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_ARTCYCLE" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_ARTCYCLE" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->ARTCYCLE->caption() ?><?php echo ($view_ivf_treatment_plan->ARTCYCLE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->ARTCYCLE->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_ARTCYCLE" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->RESULT->Visible) { // RESULT ?>
	<div id="r_RESULT" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_RESULT" for="x_RESULT" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_RESULT" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->RESULT->caption() ?><?php echo ($view_ivf_treatment_plan->RESULT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->RESULT->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_RESULT" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_status" for="x_status" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_status" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->status->caption() ?><?php echo ($view_ivf_treatment_plan->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->status->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_status" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TreatementStopDate->Visible) { // TreatementStopDate ?>
	<div id="r_TreatementStopDate" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TreatementStopDate" for="x_TreatementStopDate" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TreatementStopDate" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TreatementStopDate->caption() ?><?php echo ($view_ivf_treatment_plan->TreatementStopDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TreatementStopDate->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TreatementStopDate" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TypePatient->Visible) { // TypePatient ?>
	<div id="r_TypePatient" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TypePatient" for="x_TypePatient" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TypePatient" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TypePatient->caption() ?><?php echo ($view_ivf_treatment_plan->TypePatient->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TypePatient->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TypePatient" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Treatment->Visible) { // Treatment ?>
	<div id="r_Treatment" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Treatment" for="x_Treatment" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Treatment" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Treatment->caption() ?><?php echo ($view_ivf_treatment_plan->Treatment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Treatment->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Treatment" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TreatmentTec->Visible) { // TreatmentTec ?>
	<div id="r_TreatmentTec" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TreatmentTec" for="x_TreatmentTec" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TreatmentTec" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TreatmentTec->caption() ?><?php echo ($view_ivf_treatment_plan->TreatmentTec->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TreatmentTec->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TreatmentTec" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TypeOfCycle->Visible) { // TypeOfCycle ?>
	<div id="r_TypeOfCycle" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TypeOfCycle" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TypeOfCycle" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TypeOfCycle->caption() ?><?php echo ($view_ivf_treatment_plan->TypeOfCycle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TypeOfCycle->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TypeOfCycle" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->SpermOrgin->Visible) { // SpermOrgin ?>
	<div id="r_SpermOrgin" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_SpermOrgin" for="x_SpermOrgin" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_SpermOrgin" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->SpermOrgin->caption() ?><?php echo ($view_ivf_treatment_plan->SpermOrgin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->SpermOrgin->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_SpermOrgin" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_State" for="x_State" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_State" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->State->caption() ?><?php echo ($view_ivf_treatment_plan->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->State->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_State" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Origin->Visible) { // Origin ?>
	<div id="r_Origin" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Origin" for="x_Origin" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Origin" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Origin->caption() ?><?php echo ($view_ivf_treatment_plan->Origin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Origin->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Origin" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->MACS->Visible) { // MACS ?>
	<div id="r_MACS" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_MACS" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_MACS" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->MACS->caption() ?><?php echo ($view_ivf_treatment_plan->MACS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->MACS->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_MACS" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Technique->Visible) { // Technique ?>
	<div id="r_Technique" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Technique" for="x_Technique" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Technique" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Technique->caption() ?><?php echo ($view_ivf_treatment_plan->Technique->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Technique->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Technique" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->PgdPlanning->Visible) { // PgdPlanning ?>
	<div id="r_PgdPlanning" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_PgdPlanning" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_PgdPlanning" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->PgdPlanning->caption() ?><?php echo ($view_ivf_treatment_plan->PgdPlanning->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->PgdPlanning->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_PgdPlanning" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->IMSI->Visible) { // IMSI ?>
	<div id="r_IMSI" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_IMSI" for="x_IMSI" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_IMSI" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->IMSI->caption() ?><?php echo ($view_ivf_treatment_plan->IMSI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->IMSI->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_IMSI" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->SequentialCulture->Visible) { // SequentialCulture ?>
	<div id="r_SequentialCulture" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_SequentialCulture" for="x_SequentialCulture" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_SequentialCulture" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->SequentialCulture->caption() ?><?php echo ($view_ivf_treatment_plan->SequentialCulture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->SequentialCulture->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_SequentialCulture" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TimeLapse->Visible) { // TimeLapse ?>
	<div id="r_TimeLapse" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TimeLapse" for="x_TimeLapse" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TimeLapse" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TimeLapse->caption() ?><?php echo ($view_ivf_treatment_plan->TimeLapse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TimeLapse->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TimeLapse" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->AH->Visible) { // AH ?>
	<div id="r_AH" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_AH" for="x_AH" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_AH" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->AH->caption() ?><?php echo ($view_ivf_treatment_plan->AH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->AH->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_AH" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Weight->Visible) { // Weight ?>
	<div id="r_Weight" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Weight" for="x_Weight" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Weight" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Weight->caption() ?><?php echo ($view_ivf_treatment_plan->Weight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Weight->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Weight" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->BMI->Visible) { // BMI ?>
	<div id="r_BMI" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_BMI" for="x_BMI" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_BMI" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->BMI->caption() ?><?php echo ($view_ivf_treatment_plan->BMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->BMI->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_BMI" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->MaleIndications->Visible) { // MaleIndications ?>
	<div id="r_MaleIndications" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_MaleIndications" for="x_MaleIndications" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_MaleIndications" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->MaleIndications->caption() ?><?php echo ($view_ivf_treatment_plan->MaleIndications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->MaleIndications->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_MaleIndications" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->FemaleIndications->Visible) { // FemaleIndications ?>
	<div id="r_FemaleIndications" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_FemaleIndications" for="x_FemaleIndications" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_FemaleIndications" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->FemaleIndications->caption() ?><?php echo ($view_ivf_treatment_plan->FemaleIndications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->FemaleIndications->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_FemaleIndications" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->UseOfThe->Visible) { // UseOfThe ?>
	<div id="r_UseOfThe" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_UseOfThe" for="x_UseOfThe" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_UseOfThe" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->UseOfThe->caption() ?><?php echo ($view_ivf_treatment_plan->UseOfThe->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->UseOfThe->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_UseOfThe" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Ectopic->Visible) { // Ectopic ?>
	<div id="r_Ectopic" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Ectopic" for="x_Ectopic" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Ectopic" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Ectopic->caption() ?><?php echo ($view_ivf_treatment_plan->Ectopic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Ectopic->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Ectopic" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Heterotopic->Visible) { // Heterotopic ?>
	<div id="r_Heterotopic" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Heterotopic" for="x_Heterotopic" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Heterotopic" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Heterotopic->caption() ?><?php echo ($view_ivf_treatment_plan->Heterotopic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Heterotopic->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Heterotopic" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TransferDFE->Visible) { // TransferDFE ?>
	<div id="r_TransferDFE" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TransferDFE" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TransferDFE" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TransferDFE->caption() ?><?php echo ($view_ivf_treatment_plan->TransferDFE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TransferDFE->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TransferDFE" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Evolutive->Visible) { // Evolutive ?>
	<div id="r_Evolutive" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Evolutive" for="x_Evolutive" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Evolutive" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Evolutive->caption() ?><?php echo ($view_ivf_treatment_plan->Evolutive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Evolutive->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Evolutive" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->Number->Visible) { // Number ?>
	<div id="r_Number" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_Number" for="x_Number" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_Number" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->Number->caption() ?><?php echo ($view_ivf_treatment_plan->Number->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->Number->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_Number" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->SequentialCult->Visible) { // SequentialCult ?>
	<div id="r_SequentialCult" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_SequentialCult" for="x_SequentialCult" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_SequentialCult" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->SequentialCult->caption() ?><?php echo ($view_ivf_treatment_plan->SequentialCult->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->SequentialCult->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_SequentialCult" class="view_ivf_treatment_planedit" type="text/html">
...
<?php if ($view_ivf_treatment_plan->TineLapse->Visible) { // TineLapse ?>
	<div id="r_TineLapse" class="form-group row">
		<label id="elh_view_ivf_treatment_plan_TineLapse" for="x_TineLapse" class="<?php echo $view_ivf_treatment_plan_edit->LeftColumnClass ?>"><script id="tpc_view_ivf_treatment_plan_TineLapse" class="view_ivf_treatment_planedit" type="text/html"><span><?php echo $view_ivf_treatment_plan->TineLapse->caption() ?><?php echo ($view_ivf_treatment_plan->TineLapse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ivf_treatment_plan_edit->RightColumnClass ?>"><div<?php echo $view_ivf_treatment_plan->TineLapse->cellAttributes() ?>>
<script id="tpx_view_ivf_treatment_plan_TineLapse" class="view_ivf_treatment_planedit" type="text/html">
...
ew.applyTemplate("tpd_view_ivf_treatment_planedit", "tpm_view_ivf_treatment_planedit", "view_ivf_treatment_planedit", "<?php echo $view_ivf_treatment_plan->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_ivf_treatment_planedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
