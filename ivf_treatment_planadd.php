...
var fivf_treatment_planadd = currentForm = new ew.Form("fivf_treatment_planadd", "add");
...
fivf_treatment_planadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($ivf_treatment_plan_add->createdby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_treatment_plan->createdby->caption(), $ivf_treatment_plan->createdby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($ivf_treatment_plan_add->createddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_createddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_treatment_plan->createddatetime->caption(), $ivf_treatment_plan->createddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fivf_treatment_planadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_treatment_planadd.lists["x_treatment_status"] = <?php echo $ivf_treatment_plan_add->treatment_status->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_ARTCYCLE"] = <?php echo $ivf_treatment_plan_add->ARTCYCLE->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_ARTCYCLE"].options = <?php echo JsonEncode($ivf_treatment_plan_add->ARTCYCLE->options(FALSE, TRUE)) ?>;
fivf_treatment_planadd.lists["x_RESULT"] = <?php echo $ivf_treatment_plan_add->RESULT->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_RESULT"].options = <?php echo JsonEncode($ivf_treatment_plan_add->RESULT->options(FALSE, TRUE)) ?>;
fivf_treatment_planadd.lists["x_status"] = <?php echo $ivf_treatment_plan_add->status->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_status"].options = <?php echo JsonEncode($ivf_treatment_plan_add->status->lookupOptions()) ?>;
fivf_treatment_planadd.lists["x_Treatment"] = <?php echo $ivf_treatment_plan_add->Treatment->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_Treatment"].options = <?php echo JsonEncode($ivf_treatment_plan_add->Treatment->options(FALSE, TRUE)) ?>;
fivf_treatment_planadd.lists["x_TypeOfCycle"] = <?php echo $ivf_treatment_plan_add->TypeOfCycle->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_SpermOrgin"] = <?php echo $ivf_treatment_plan_add->SpermOrgin->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_State"] = <?php echo $ivf_treatment_plan_add->State->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_State"].options = <?php echo JsonEncode($ivf_treatment_plan_add->State->options(FALSE, TRUE)) ?>;
fivf_treatment_planadd.lists["x_Origin"] = <?php echo $ivf_treatment_plan_add->Origin->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_Origin"].options = <?php echo JsonEncode($ivf_treatment_plan_add->Origin->options(FALSE, TRUE)) ?>;
fivf_treatment_planadd.lists["x_MACS"] = <?php echo $ivf_treatment_plan_add->MACS->Lookup->toClientList() ?>;
fivf_treatment_planadd.lists["x_MACS"].options = <?php echo JsonEncode($ivf_treatment_plan_add->MACS->options(FALSE, TRUE)) ?>;
fivf_treatment_planadd.lists["x_PgdPlanning"] = <?php echo $ivf_treatment_plan_add->PgdPlanning->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_MaleIndications"] = <?php echo $ivf_treatment_plan_add->MaleIndications->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_FemaleIndications"] = <?php echo $ivf_treatment_plan_add->FemaleIndications->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_Heterotopic"] = <?php echo $ivf_treatment_plan_add->Heterotopic->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_TransferDFE[]"] = <?php echo $ivf_treatment_plan_add->TransferDFE->Lookup->toClientList() ?>;
...
fivf_treatment_planadd.lists["x_TineLapse"] = <?php echo $ivf_treatment_plan_add->TineLapse->Lookup->toClientList() ?>;
...
<?php if ($ivf_treatment_plan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_treatment_plan_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_treatment_plan->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_ivf_treatment_plan_RIDNO" for="x_RIDNO" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_RIDNO" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->RIDNO->caption() ?><?php echo ($ivf_treatment_plan->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->RIDNO->cellAttributes() ?>>
<?php if ($ivf_treatment_plan->RIDNO->getSessionValue() <> "") { ?>
<script id="tpx_ivf_treatment_plan_RIDNO" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_treatment_plan_Name" for="x_Name" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Name" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Name->caption() ?><?php echo ($ivf_treatment_plan->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Name->cellAttributes() ?>>
<?php if ($ivf_treatment_plan->Name->getSessionValue() <> "") { ?>
<script id="tpx_ivf_treatment_plan_Name" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TreatmentStartDate->Visible) { // TreatmentStartDate ?>
	<div id="r_TreatmentStartDate" class="form-group row">
		<label id="elh_ivf_treatment_plan_TreatmentStartDate" for="x_TreatmentStartDate" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TreatmentStartDate" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TreatmentStartDate->caption() ?><?php echo ($ivf_treatment_plan->TreatmentStartDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TreatmentStartDate->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TreatmentStartDate" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_ivf_treatment_plan_Age" for="x_Age" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Age" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Age->caption() ?><?php echo ($ivf_treatment_plan->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Age->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Age" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->treatment_status->Visible) { // treatment_status ?>
	<div id="r_treatment_status" class="form-group row">
		<label id="elh_ivf_treatment_plan_treatment_status" for="x_treatment_status" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_treatment_status" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->treatment_status->caption() ?><?php echo ($ivf_treatment_plan->treatment_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->treatment_status->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_treatment_status" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->ARTCYCLE->Visible) { // ARTCYCLE ?>
	<div id="r_ARTCYCLE" class="form-group row">
		<label id="elh_ivf_treatment_plan_ARTCYCLE" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_ARTCYCLE" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->ARTCYCLE->caption() ?><?php echo ($ivf_treatment_plan->ARTCYCLE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->ARTCYCLE->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_ARTCYCLE" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->IVFCycleNO->Visible) { // IVFCycleNO ?>
	<div id="r_IVFCycleNO" class="form-group row">
		<label id="elh_ivf_treatment_plan_IVFCycleNO" for="x_IVFCycleNO" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_IVFCycleNO" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->IVFCycleNO->caption() ?><?php echo ($ivf_treatment_plan->IVFCycleNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->IVFCycleNO->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_IVFCycleNO" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->RESULT->Visible) { // RESULT ?>
	<div id="r_RESULT" class="form-group row">
		<label id="elh_ivf_treatment_plan_RESULT" for="x_RESULT" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_RESULT" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->RESULT->caption() ?><?php echo ($ivf_treatment_plan->RESULT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->RESULT->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_RESULT" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_ivf_treatment_plan_status" for="x_status" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_status" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->status->caption() ?><?php echo ($ivf_treatment_plan->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->status->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_status" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TreatementStopDate->Visible) { // TreatementStopDate ?>
	<div id="r_TreatementStopDate" class="form-group row">
		<label id="elh_ivf_treatment_plan_TreatementStopDate" for="x_TreatementStopDate" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TreatementStopDate" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TreatementStopDate->caption() ?><?php echo ($ivf_treatment_plan->TreatementStopDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TreatementStopDate->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TreatementStopDate" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TypePatient->Visible) { // TypePatient ?>
	<div id="r_TypePatient" class="form-group row">
		<label id="elh_ivf_treatment_plan_TypePatient" for="x_TypePatient" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TypePatient" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TypePatient->caption() ?><?php echo ($ivf_treatment_plan->TypePatient->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TypePatient->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TypePatient" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Treatment->Visible) { // Treatment ?>
	<div id="r_Treatment" class="form-group row">
		<label id="elh_ivf_treatment_plan_Treatment" for="x_Treatment" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Treatment" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Treatment->caption() ?><?php echo ($ivf_treatment_plan->Treatment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Treatment->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Treatment" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TreatmentTec->Visible) { // TreatmentTec ?>
	<div id="r_TreatmentTec" class="form-group row">
		<label id="elh_ivf_treatment_plan_TreatmentTec" for="x_TreatmentTec" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TreatmentTec" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TreatmentTec->caption() ?><?php echo ($ivf_treatment_plan->TreatmentTec->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TreatmentTec->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TreatmentTec" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TypeOfCycle->Visible) { // TypeOfCycle ?>
	<div id="r_TypeOfCycle" class="form-group row">
		<label id="elh_ivf_treatment_plan_TypeOfCycle" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TypeOfCycle" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TypeOfCycle->caption() ?><?php echo ($ivf_treatment_plan->TypeOfCycle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TypeOfCycle->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TypeOfCycle" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->SpermOrgin->Visible) { // SpermOrgin ?>
	<div id="r_SpermOrgin" class="form-group row">
		<label id="elh_ivf_treatment_plan_SpermOrgin" for="x_SpermOrgin" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_SpermOrgin" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->SpermOrgin->caption() ?><?php echo ($ivf_treatment_plan->SpermOrgin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->SpermOrgin->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_SpermOrgin" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_ivf_treatment_plan_State" for="x_State" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_State" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->State->caption() ?><?php echo ($ivf_treatment_plan->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->State->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_State" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Origin->Visible) { // Origin ?>
	<div id="r_Origin" class="form-group row">
		<label id="elh_ivf_treatment_plan_Origin" for="x_Origin" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Origin" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Origin->caption() ?><?php echo ($ivf_treatment_plan->Origin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Origin->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Origin" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->MACS->Visible) { // MACS ?>
	<div id="r_MACS" class="form-group row">
		<label id="elh_ivf_treatment_plan_MACS" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_MACS" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->MACS->caption() ?><?php echo ($ivf_treatment_plan->MACS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->MACS->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_MACS" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Technique->Visible) { // Technique ?>
	<div id="r_Technique" class="form-group row">
		<label id="elh_ivf_treatment_plan_Technique" for="x_Technique" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Technique" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Technique->caption() ?><?php echo ($ivf_treatment_plan->Technique->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Technique->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Technique" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->PgdPlanning->Visible) { // PgdPlanning ?>
	<div id="r_PgdPlanning" class="form-group row">
		<label id="elh_ivf_treatment_plan_PgdPlanning" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_PgdPlanning" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->PgdPlanning->caption() ?><?php echo ($ivf_treatment_plan->PgdPlanning->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->PgdPlanning->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_PgdPlanning" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->IMSI->Visible) { // IMSI ?>
	<div id="r_IMSI" class="form-group row">
		<label id="elh_ivf_treatment_plan_IMSI" for="x_IMSI" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_IMSI" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->IMSI->caption() ?><?php echo ($ivf_treatment_plan->IMSI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->IMSI->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_IMSI" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->SequentialCulture->Visible) { // SequentialCulture ?>
	<div id="r_SequentialCulture" class="form-group row">
		<label id="elh_ivf_treatment_plan_SequentialCulture" for="x_SequentialCulture" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_SequentialCulture" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->SequentialCulture->caption() ?><?php echo ($ivf_treatment_plan->SequentialCulture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->SequentialCulture->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_SequentialCulture" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TimeLapse->Visible) { // TimeLapse ?>
	<div id="r_TimeLapse" class="form-group row">
		<label id="elh_ivf_treatment_plan_TimeLapse" for="x_TimeLapse" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TimeLapse" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TimeLapse->caption() ?><?php echo ($ivf_treatment_plan->TimeLapse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TimeLapse->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TimeLapse" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->AH->Visible) { // AH ?>
	<div id="r_AH" class="form-group row">
		<label id="elh_ivf_treatment_plan_AH" for="x_AH" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_AH" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->AH->caption() ?><?php echo ($ivf_treatment_plan->AH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->AH->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_AH" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Weight->Visible) { // Weight ?>
	<div id="r_Weight" class="form-group row">
		<label id="elh_ivf_treatment_plan_Weight" for="x_Weight" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Weight" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Weight->caption() ?><?php echo ($ivf_treatment_plan->Weight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Weight->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Weight" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->BMI->Visible) { // BMI ?>
	<div id="r_BMI" class="form-group row">
		<label id="elh_ivf_treatment_plan_BMI" for="x_BMI" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_BMI" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->BMI->caption() ?><?php echo ($ivf_treatment_plan->BMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->BMI->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_BMI" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->MaleIndications->Visible) { // MaleIndications ?>
	<div id="r_MaleIndications" class="form-group row">
		<label id="elh_ivf_treatment_plan_MaleIndications" for="x_MaleIndications" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_MaleIndications" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->MaleIndications->caption() ?><?php echo ($ivf_treatment_plan->MaleIndications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->MaleIndications->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_MaleIndications" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->FemaleIndications->Visible) { // FemaleIndications ?>
	<div id="r_FemaleIndications" class="form-group row">
		<label id="elh_ivf_treatment_plan_FemaleIndications" for="x_FemaleIndications" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_FemaleIndications" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->FemaleIndications->caption() ?><?php echo ($ivf_treatment_plan->FemaleIndications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->FemaleIndications->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_FemaleIndications" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->UseOfThe->Visible) { // UseOfThe ?>
	<div id="r_UseOfThe" class="form-group row">
		<label id="elh_ivf_treatment_plan_UseOfThe" for="x_UseOfThe" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_UseOfThe" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->UseOfThe->caption() ?><?php echo ($ivf_treatment_plan->UseOfThe->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->UseOfThe->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_UseOfThe" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Ectopic->Visible) { // Ectopic ?>
	<div id="r_Ectopic" class="form-group row">
		<label id="elh_ivf_treatment_plan_Ectopic" for="x_Ectopic" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Ectopic" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Ectopic->caption() ?><?php echo ($ivf_treatment_plan->Ectopic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Ectopic->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Ectopic" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Heterotopic->Visible) { // Heterotopic ?>
	<div id="r_Heterotopic" class="form-group row">
		<label id="elh_ivf_treatment_plan_Heterotopic" for="x_Heterotopic" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Heterotopic" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Heterotopic->caption() ?><?php echo ($ivf_treatment_plan->Heterotopic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Heterotopic->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Heterotopic" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TransferDFE->Visible) { // TransferDFE ?>
	<div id="r_TransferDFE" class="form-group row">
		<label id="elh_ivf_treatment_plan_TransferDFE" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TransferDFE" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TransferDFE->caption() ?><?php echo ($ivf_treatment_plan->TransferDFE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TransferDFE->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TransferDFE" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Evolutive->Visible) { // Evolutive ?>
	<div id="r_Evolutive" class="form-group row">
		<label id="elh_ivf_treatment_plan_Evolutive" for="x_Evolutive" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Evolutive" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Evolutive->caption() ?><?php echo ($ivf_treatment_plan->Evolutive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Evolutive->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Evolutive" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->Number->Visible) { // Number ?>
	<div id="r_Number" class="form-group row">
		<label id="elh_ivf_treatment_plan_Number" for="x_Number" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_Number" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->Number->caption() ?><?php echo ($ivf_treatment_plan->Number->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->Number->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_Number" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->SequentialCult->Visible) { // SequentialCult ?>
	<div id="r_SequentialCult" class="form-group row">
		<label id="elh_ivf_treatment_plan_SequentialCult" for="x_SequentialCult" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_SequentialCult" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->SequentialCult->caption() ?><?php echo ($ivf_treatment_plan->SequentialCult->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->SequentialCult->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_SequentialCult" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->TineLapse->Visible) { // TineLapse ?>
	<div id="r_TineLapse" class="form-group row">
		<label id="elh_ivf_treatment_plan_TineLapse" for="x_TineLapse" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_TineLapse" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->TineLapse->caption() ?><?php echo ($ivf_treatment_plan->TineLapse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->TineLapse->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_TineLapse" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_ivf_treatment_plan_PatientName" for="x_PatientName" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_PatientName" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->PatientName->caption() ?><?php echo ($ivf_treatment_plan->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->PatientName->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_PatientName" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_ivf_treatment_plan_PatientID" for="x_PatientID" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_PatientID" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->PatientID->caption() ?><?php echo ($ivf_treatment_plan->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->PatientID->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_PatientID" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_ivf_treatment_plan_PartnerName" for="x_PartnerName" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_PartnerName" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->PartnerName->caption() ?><?php echo ($ivf_treatment_plan->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->PartnerName->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_PartnerName" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_ivf_treatment_plan_PartnerID" for="x_PartnerID" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_PartnerID" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->PartnerID->caption() ?><?php echo ($ivf_treatment_plan->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->PartnerID->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_PartnerID" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->WifeCell->Visible) { // WifeCell ?>
	<div id="r_WifeCell" class="form-group row">
		<label id="elh_ivf_treatment_plan_WifeCell" for="x_WifeCell" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_WifeCell" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->WifeCell->caption() ?><?php echo ($ivf_treatment_plan->WifeCell->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->WifeCell->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_WifeCell" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->HusbandCell->Visible) { // HusbandCell ?>
	<div id="r_HusbandCell" class="form-group row">
		<label id="elh_ivf_treatment_plan_HusbandCell" for="x_HusbandCell" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_HusbandCell" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->HusbandCell->caption() ?><?php echo ($ivf_treatment_plan->HusbandCell->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->HusbandCell->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_HusbandCell" class="ivf_treatment_planadd" type="text/html">
...
<?php if ($ivf_treatment_plan->CoupleID->Visible) { // CoupleID ?>
	<div id="r_CoupleID" class="form-group row">
		<label id="elh_ivf_treatment_plan_CoupleID" for="x_CoupleID" class="<?php echo $ivf_treatment_plan_add->LeftColumnClass ?>"><script id="tpc_ivf_treatment_plan_CoupleID" class="ivf_treatment_planadd" type="text/html"><span><?php echo $ivf_treatment_plan->CoupleID->caption() ?><?php echo ($ivf_treatment_plan->CoupleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_treatment_plan_add->RightColumnClass ?>"><div<?php echo $ivf_treatment_plan->CoupleID->cellAttributes() ?>>
<script id="tpx_ivf_treatment_plan_CoupleID" class="ivf_treatment_planadd" type="text/html">
...
ew.applyTemplate("tpd_ivf_treatment_planadd", "tpm_ivf_treatment_planadd", "ivf_treatment_planadd", "<?php echo $ivf_treatment_plan->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_treatment_planadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
