...
// Create page object
$crm_leaddetails_add = new crm_leaddetails_add();

// Run the page
$crm_leaddetails_add->run();
...
$crm_leaddetails_add->Page_Render();
?>
...
var fcrm_leaddetailsadd = currentForm = new ew.Form("fcrm_leaddetailsadd", "add");

// Validate form
fcrm_leaddetailsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($crm_leaddetails_add->leadid->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->lead_no->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->interest->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->firstname->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->salutation->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->lastname->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->company->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->annualrevenue->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->industry->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->campaign->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->leadstatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->leadsource->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->converted->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->licencekeystatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->space->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->comments->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->priority->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->demorequest->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->partnercontact->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->productversion->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->product->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->maildate->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->nextstepdate->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->fundingsituation->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->purpose->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->evaluationstatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->transferdate->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->revenuetype->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->noofemployees->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->secondaryemail->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->noapprovalcalls->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->noapprovalemails->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->vat_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->registration_number_1->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->registration_number_2->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->verification->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->subindustry->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->atenttion->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->leads_relation->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->legal_form->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leaddetails_add->sum_time->Required) { ?>
		...
		<?php if ($crm_leaddetails_add->active->Required) { ?>
...
fcrm_leaddetailsadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcrm_leaddetailsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $crm_leaddetails_add->showPageHeader(); ?>
<?php
$crm_leaddetails_add->showMessage();
?>
<form name="fcrm_leaddetailsadd" id="fcrm_leaddetailsadd" class="<?php echo $crm_leaddetails_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($crm_leaddetails_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $crm_leaddetails_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="crm_leaddetails">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$crm_leaddetails_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($crm_leaddetails->leadid->Visible) { // leadid ?>
	<div id="r_leadid" class="form-group row">
		<label id="elh_crm_leaddetails_leadid" for="x_leadid" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->leadid->caption() ?><?php echo ($crm_leaddetails->leadid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->leadid->cellAttributes() ?>>
<span id="el_crm_leaddetails_leadid">
<input type="text" data-table="crm_leaddetails" data-field="x_leadid" name="x_leadid" id="x_leadid" size="30" placeholder="<?php echo HtmlEncode($crm_leaddetails->leadid->getPlaceHolder()) ?>" value="<?php echo $crm_leaddetails->leadid->EditValue ?>"<?php echo $crm_leaddetails->leadid->editAttributes() ?>>
</span>
...
<?php if ($crm_leaddetails->lead_no->Visible) { // lead_no ?>
	<div id="r_lead_no" class="form-group row">
		<label id="elh_crm_leaddetails_lead_no" for="x_lead_no" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->lead_no->caption() ?><?php echo ($crm_leaddetails->lead_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->lead_no->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->_email->Visible) { // email ?>
	<div id="r__email" class="form-group row">
		<label id="elh_crm_leaddetails__email" for="x__email" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->_email->caption() ?><?php echo ($crm_leaddetails->_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->_email->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->interest->Visible) { // interest ?>
	<div id="r_interest" class="form-group row">
		<label id="elh_crm_leaddetails_interest" for="x_interest" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->interest->caption() ?><?php echo ($crm_leaddetails->interest->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->interest->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->firstname->Visible) { // firstname ?>
	<div id="r_firstname" class="form-group row">
		<label id="elh_crm_leaddetails_firstname" for="x_firstname" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->firstname->caption() ?><?php echo ($crm_leaddetails->firstname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->firstname->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->salutation->Visible) { // salutation ?>
	<div id="r_salutation" class="form-group row">
		<label id="elh_crm_leaddetails_salutation" for="x_salutation" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->salutation->caption() ?><?php echo ($crm_leaddetails->salutation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->salutation->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->lastname->Visible) { // lastname ?>
	<div id="r_lastname" class="form-group row">
		<label id="elh_crm_leaddetails_lastname" for="x_lastname" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->lastname->caption() ?><?php echo ($crm_leaddetails->lastname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->lastname->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->company->Visible) { // company ?>
	<div id="r_company" class="form-group row">
		<label id="elh_crm_leaddetails_company" for="x_company" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->company->caption() ?><?php echo ($crm_leaddetails->company->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->company->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->annualrevenue->Visible) { // annualrevenue ?>
	<div id="r_annualrevenue" class="form-group row">
		<label id="elh_crm_leaddetails_annualrevenue" for="x_annualrevenue" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->annualrevenue->caption() ?><?php echo ($crm_leaddetails->annualrevenue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->annualrevenue->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->industry->Visible) { // industry ?>
	<div id="r_industry" class="form-group row">
		<label id="elh_crm_leaddetails_industry" for="x_industry" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->industry->caption() ?><?php echo ($crm_leaddetails->industry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->industry->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->campaign->Visible) { // campaign ?>
	<div id="r_campaign" class="form-group row">
		<label id="elh_crm_leaddetails_campaign" for="x_campaign" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->campaign->caption() ?><?php echo ($crm_leaddetails->campaign->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->campaign->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->leadstatus->Visible) { // leadstatus ?>
	<div id="r_leadstatus" class="form-group row">
		<label id="elh_crm_leaddetails_leadstatus" for="x_leadstatus" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->leadstatus->caption() ?><?php echo ($crm_leaddetails->leadstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->leadstatus->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->leadsource->Visible) { // leadsource ?>
	<div id="r_leadsource" class="form-group row">
		<label id="elh_crm_leaddetails_leadsource" for="x_leadsource" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->leadsource->caption() ?><?php echo ($crm_leaddetails->leadsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->leadsource->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->converted->Visible) { // converted ?>
	<div id="r_converted" class="form-group row">
		<label id="elh_crm_leaddetails_converted" for="x_converted" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->converted->caption() ?><?php echo ($crm_leaddetails->converted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->converted->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->licencekeystatus->Visible) { // licencekeystatus ?>
	<div id="r_licencekeystatus" class="form-group row">
		<label id="elh_crm_leaddetails_licencekeystatus" for="x_licencekeystatus" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->licencekeystatus->caption() ?><?php echo ($crm_leaddetails->licencekeystatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->licencekeystatus->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->space->Visible) { // space ?>
	<div id="r_space" class="form-group row">
		<label id="elh_crm_leaddetails_space" for="x_space" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->space->caption() ?><?php echo ($crm_leaddetails->space->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->space->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->comments->Visible) { // comments ?>
	<div id="r_comments" class="form-group row">
		<label id="elh_crm_leaddetails_comments" for="x_comments" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->comments->caption() ?><?php echo ($crm_leaddetails->comments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->comments->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->priority->Visible) { // priority ?>
	<div id="r_priority" class="form-group row">
		<label id="elh_crm_leaddetails_priority" for="x_priority" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->priority->caption() ?><?php echo ($crm_leaddetails->priority->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->priority->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->demorequest->Visible) { // demorequest ?>
	<div id="r_demorequest" class="form-group row">
		<label id="elh_crm_leaddetails_demorequest" for="x_demorequest" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->demorequest->caption() ?><?php echo ($crm_leaddetails->demorequest->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->demorequest->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->partnercontact->Visible) { // partnercontact ?>
	<div id="r_partnercontact" class="form-group row">
		<label id="elh_crm_leaddetails_partnercontact" for="x_partnercontact" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->partnercontact->caption() ?><?php echo ($crm_leaddetails->partnercontact->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->partnercontact->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->productversion->Visible) { // productversion ?>
	<div id="r_productversion" class="form-group row">
		<label id="elh_crm_leaddetails_productversion" for="x_productversion" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->productversion->caption() ?><?php echo ($crm_leaddetails->productversion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->productversion->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->product->Visible) { // product ?>
	<div id="r_product" class="form-group row">
		<label id="elh_crm_leaddetails_product" for="x_product" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->product->caption() ?><?php echo ($crm_leaddetails->product->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->product->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->maildate->Visible) { // maildate ?>
	<div id="r_maildate" class="form-group row">
		<label id="elh_crm_leaddetails_maildate" for="x_maildate" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->maildate->caption() ?><?php echo ($crm_leaddetails->maildate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->maildate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fcrm_leaddetailsadd", "x_maildate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($crm_leaddetails->nextstepdate->Visible) { // nextstepdate ?>
	<div id="r_nextstepdate" class="form-group row">
		<label id="elh_crm_leaddetails_nextstepdate" for="x_nextstepdate" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->nextstepdate->caption() ?><?php echo ($crm_leaddetails->nextstepdate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->nextstepdate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fcrm_leaddetailsadd", "x_nextstepdate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($crm_leaddetails->fundingsituation->Visible) { // fundingsituation ?>
	<div id="r_fundingsituation" class="form-group row">
		<label id="elh_crm_leaddetails_fundingsituation" for="x_fundingsituation" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->fundingsituation->caption() ?><?php echo ($crm_leaddetails->fundingsituation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->fundingsituation->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->purpose->Visible) { // purpose ?>
	<div id="r_purpose" class="form-group row">
		<label id="elh_crm_leaddetails_purpose" for="x_purpose" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->purpose->caption() ?><?php echo ($crm_leaddetails->purpose->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->purpose->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->evaluationstatus->Visible) { // evaluationstatus ?>
	<div id="r_evaluationstatus" class="form-group row">
		<label id="elh_crm_leaddetails_evaluationstatus" for="x_evaluationstatus" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->evaluationstatus->caption() ?><?php echo ($crm_leaddetails->evaluationstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->evaluationstatus->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->transferdate->Visible) { // transferdate ?>
	<div id="r_transferdate" class="form-group row">
		<label id="elh_crm_leaddetails_transferdate" for="x_transferdate" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->transferdate->caption() ?><?php echo ($crm_leaddetails->transferdate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->transferdate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fcrm_leaddetailsadd", "x_transferdate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($crm_leaddetails->revenuetype->Visible) { // revenuetype ?>
	<div id="r_revenuetype" class="form-group row">
		<label id="elh_crm_leaddetails_revenuetype" for="x_revenuetype" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->revenuetype->caption() ?><?php echo ($crm_leaddetails->revenuetype->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->revenuetype->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->noofemployees->Visible) { // noofemployees ?>
	<div id="r_noofemployees" class="form-group row">
		<label id="elh_crm_leaddetails_noofemployees" for="x_noofemployees" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->noofemployees->caption() ?><?php echo ($crm_leaddetails->noofemployees->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->noofemployees->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->secondaryemail->Visible) { // secondaryemail ?>
	<div id="r_secondaryemail" class="form-group row">
		<label id="elh_crm_leaddetails_secondaryemail" for="x_secondaryemail" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->secondaryemail->caption() ?><?php echo ($crm_leaddetails->secondaryemail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->secondaryemail->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->noapprovalcalls->Visible) { // noapprovalcalls ?>
	<div id="r_noapprovalcalls" class="form-group row">
		<label id="elh_crm_leaddetails_noapprovalcalls" for="x_noapprovalcalls" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->noapprovalcalls->caption() ?><?php echo ($crm_leaddetails->noapprovalcalls->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->noapprovalcalls->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->noapprovalemails->Visible) { // noapprovalemails ?>
	<div id="r_noapprovalemails" class="form-group row">
		<label id="elh_crm_leaddetails_noapprovalemails" for="x_noapprovalemails" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->noapprovalemails->caption() ?><?php echo ($crm_leaddetails->noapprovalemails->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->noapprovalemails->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->vat_id->Visible) { // vat_id ?>
	<div id="r_vat_id" class="form-group row">
		<label id="elh_crm_leaddetails_vat_id" for="x_vat_id" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->vat_id->caption() ?><?php echo ($crm_leaddetails->vat_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->vat_id->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->registration_number_1->Visible) { // registration_number_1 ?>
	<div id="r_registration_number_1" class="form-group row">
		<label id="elh_crm_leaddetails_registration_number_1" for="x_registration_number_1" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->registration_number_1->caption() ?><?php echo ($crm_leaddetails->registration_number_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->registration_number_1->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->registration_number_2->Visible) { // registration_number_2 ?>
	<div id="r_registration_number_2" class="form-group row">
		<label id="elh_crm_leaddetails_registration_number_2" for="x_registration_number_2" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->registration_number_2->caption() ?><?php echo ($crm_leaddetails->registration_number_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->registration_number_2->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->verification->Visible) { // verification ?>
	<div id="r_verification" class="form-group row">
		<label id="elh_crm_leaddetails_verification" for="x_verification" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->verification->caption() ?><?php echo ($crm_leaddetails->verification->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->verification->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->subindustry->Visible) { // subindustry ?>
	<div id="r_subindustry" class="form-group row">
		<label id="elh_crm_leaddetails_subindustry" for="x_subindustry" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->subindustry->caption() ?><?php echo ($crm_leaddetails->subindustry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->subindustry->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->atenttion->Visible) { // atenttion ?>
	<div id="r_atenttion" class="form-group row">
		<label id="elh_crm_leaddetails_atenttion" for="x_atenttion" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->atenttion->caption() ?><?php echo ($crm_leaddetails->atenttion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->atenttion->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->leads_relation->Visible) { // leads_relation ?>
	<div id="r_leads_relation" class="form-group row">
		<label id="elh_crm_leaddetails_leads_relation" for="x_leads_relation" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->leads_relation->caption() ?><?php echo ($crm_leaddetails->leads_relation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->leads_relation->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->legal_form->Visible) { // legal_form ?>
	<div id="r_legal_form" class="form-group row">
		<label id="elh_crm_leaddetails_legal_form" for="x_legal_form" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->legal_form->caption() ?><?php echo ($crm_leaddetails->legal_form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->legal_form->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->sum_time->Visible) { // sum_time ?>
	<div id="r_sum_time" class="form-group row">
		<label id="elh_crm_leaddetails_sum_time" for="x_sum_time" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->sum_time->caption() ?><?php echo ($crm_leaddetails->sum_time->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->sum_time->cellAttributes() ?>>
...
<?php if ($crm_leaddetails->active->Visible) { // active ?>
	<div id="r_active" class="form-group row">
		<label id="elh_crm_leaddetails_active" for="x_active" class="<?php echo $crm_leaddetails_add->LeftColumnClass ?>"><?php echo $crm_leaddetails->active->caption() ?><?php echo ($crm_leaddetails->active->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leaddetails_add->RightColumnClass ?>"><div<?php echo $crm_leaddetails->active->cellAttributes() ?>>
...
<?php if (!$crm_leaddetails_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $crm_leaddetails_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $crm_leaddetails_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$crm_leaddetails_add->showPageFooter();
if (DEBUG_ENABLED)
