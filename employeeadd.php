...
var femployeeadd = currentForm = new ew.Form("femployeeadd", "add");
...
femployeeadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_add->employee_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->nationality->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->birthday->Required) { ?>
		...
		<?php if ($employee_add->marital_status->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->ssn_num->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->nic_num->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->other_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->driving_license->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->driving_license_exp_date->Required) { ?>
		...
		<?php if ($employee_add->employment_status->Required) { ?>
		...
		<?php if ($employee_add->job_title->Required) { ?>
		...
		<?php if ($employee_add->pay_grade->Required) { ?>
		...
		<?php if ($employee_add->work_station_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->address1->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->address2->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->province->Required) { ?>
		...
		<?php if ($employee_add->postal_code->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->home_phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->mobile_phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->work_phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->work_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->private_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->joined_date->Required) { ?>
		...
		<?php if ($employee_add->confirmation_date->Required) { ?>
		...
		<?php if ($employee_add->supervisor->Required) { ?>
		...
		<?php if ($employee_add->indirect_supervisors->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->department->Required) { ?>
		...
		<?php if ($employee_add->custom1->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom2->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom3->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom4->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom5->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom6->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom7->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom8->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom9->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->custom10->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->termination_date->Required) { ?>
		...
		<?php if ($employee_add->notes->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->ethnicity->Required) { ?>
		...
		<?php if ($employee_add->immigration_status->Required) { ?>
		...
		<?php if ($employee_add->approver1->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->approver2->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_add->approver3->Required) { ?>
...
femployeeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Multi-Page
femployeeadd.multiPage = new ew.MultiPage("femployeeadd");

// Dynamic selection lists
femployeeadd.lists["x_gender"] = <?php echo $employee_add->gender->Lookup->toClientList() ?>;
femployeeadd.lists["x_gender"].options = <?php echo JsonEncode($employee_add->gender->lookupOptions()) ?>;
femployeeadd.lists["x_nationality"] = <?php echo $employee_add->nationality->Lookup->toClientList() ?>;
femployeeadd.lists["x_nationality"].options = <?php echo JsonEncode($employee_add->nationality->lookupOptions()) ?>;
femployeeadd.lists["x_marital_status"] = <?php echo $employee_add->marital_status->Lookup->toClientList() ?>;
femployeeadd.lists["x_marital_status"].options = <?php echo JsonEncode($employee_add->marital_status->options(FALSE, TRUE)) ?>;
femployeeadd.lists["x_approver1"] = <?php echo $employee_add->approver1->Lookup->toClientList() ?>;
femployeeadd.lists["x_approver1"].options = <?php echo JsonEncode($employee_add->approver1->lookupOptions()) ?>;
femployeeadd.lists["x_approver2"] = <?php echo $employee_add->approver2->Lookup->toClientList() ?>;
femployeeadd.lists["x_approver2"].options = <?php echo JsonEncode($employee_add->approver2->lookupOptions()) ?>;
femployeeadd.lists["x_approver3"] = <?php echo $employee_add->approver3->Lookup->toClientList() ?>;
femployeeadd.lists["x_approver3"].options = <?php echo JsonEncode($employee_add->approver3->lookupOptions()) ?>;
femployeeadd.lists["x_status"] = <?php echo $employee_add->status->Lookup->toClientList() ?>;
...
<?php if ($employee_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$employee_add->IsModal ?>">
<?php if ($employee_add->MultiPages->Items[0]->Visible) { ?>
<div class="ew-add-div"><!-- page0 -->
<?php if ($employee->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group row">
		<label id="elh_employee_employee_id" for="x_employee_id" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->employee_id->caption() ?><?php echo ($employee->employee_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->employee_id->cellAttributes() ?>>
...
<?php if ($employee->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group row">
		<label id="elh_employee_first_name" for="x_first_name" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->first_name->caption() ?><?php echo ($employee->first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->first_name->cellAttributes() ?>>
...
<?php if ($employee->middle_name->Visible) { // middle_name ?>
	<div id="r_middle_name" class="form-group row">
		<label id="elh_employee_middle_name" for="x_middle_name" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->middle_name->caption() ?><?php echo ($employee->middle_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->middle_name->cellAttributes() ?>>
...
<?php if ($employee->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group row">
		<label id="elh_employee_last_name" for="x_last_name" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->last_name->caption() ?><?php echo ($employee->last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->last_name->cellAttributes() ?>>
...
<?php if ($employee->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_employee_gender" for="x_gender" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->gender->caption() ?><?php echo ($employee->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->gender->cellAttributes() ?>>
...
<?php if ($employee->nationality->Visible) { // nationality ?>
	<div id="r_nationality" class="form-group row">
		<label id="elh_employee_nationality" for="x_nationality" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->nationality->caption() ?><?php echo ($employee->nationality->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->nationality->cellAttributes() ?>>
...
<?php if ($employee->birthday->Visible) { // birthday ?>
	<div id="r_birthday" class="form-group row">
		<label id="elh_employee_birthday" for="x_birthday" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->birthday->caption() ?><?php echo ($employee->birthday->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->birthday->cellAttributes() ?>>
...
<?php if ($employee->marital_status->Visible) { // marital_status ?>
	<div id="r_marital_status" class="form-group row">
		<label id="elh_employee_marital_status" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->marital_status->caption() ?><?php echo ($employee->marital_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->marital_status->cellAttributes() ?>>
...
<div class="ew-nav-tabs" id="employee_add"><!-- multi-page tabs -->
	<ul class="<?php echo $employee_add->MultiPages->navStyle() ?>">
		...
		<li class="nav-item"><a class="nav-link<?php echo $employee_add->MultiPages->pageStyle("4") ?>" href="#tab_employee4" data-toggle="tab"><?php echo $employee->pageCaption(4) ?></a></li>
		<li class="nav-item"><a class="nav-link<?php echo $employee_add->MultiPages->pageStyle("5") ?>" href="#tab_employee5" data-toggle="tab"><?php echo $employee->pageCaption(5) ?></a></li>
		<li class="nav-item"><a class="nav-link<?php echo $employee_add->MultiPages->pageStyle("6") ?>" href="#tab_employee6" data-toggle="tab"><?php echo $employee->pageCaption(6) ?></a></li>
	</ul>
...
<?php if ($employee->employment_status->Visible) { // employment_status ?>
	<div id="r_employment_status" class="form-group row">
		<label id="elh_employee_employment_status" for="x_employment_status" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->employment_status->caption() ?><?php echo ($employee->employment_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->employment_status->cellAttributes() ?>>
...
<?php if ($employee->job_title->Visible) { // job_title ?>
	<div id="r_job_title" class="form-group row">
		<label id="elh_employee_job_title" for="x_job_title" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->job_title->caption() ?><?php echo ($employee->job_title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->job_title->cellAttributes() ?>>
...
<?php if ($employee->pay_grade->Visible) { // pay_grade ?>
	<div id="r_pay_grade" class="form-group row">
		<label id="elh_employee_pay_grade" for="x_pay_grade" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->pay_grade->caption() ?><?php echo ($employee->pay_grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->pay_grade->cellAttributes() ?>>
...
<?php if ($employee->work_station_id->Visible) { // work_station_id ?>
	<div id="r_work_station_id" class="form-group row">
		<label id="elh_employee_work_station_id" for="x_work_station_id" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->work_station_id->caption() ?><?php echo ($employee->work_station_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->work_station_id->cellAttributes() ?>>
...
<?php if ($employee->joined_date->Visible) { // joined_date ?>
	<div id="r_joined_date" class="form-group row">
		<label id="elh_employee_joined_date" for="x_joined_date" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->joined_date->caption() ?><?php echo ($employee->joined_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->joined_date->cellAttributes() ?>>
...
<?php if ($employee->confirmation_date->Visible) { // confirmation_date ?>
	<div id="r_confirmation_date" class="form-group row">
		<label id="elh_employee_confirmation_date" for="x_confirmation_date" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->confirmation_date->caption() ?><?php echo ($employee->confirmation_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->confirmation_date->cellAttributes() ?>>
...
<?php if ($employee->supervisor->Visible) { // supervisor ?>
	<div id="r_supervisor" class="form-group row">
		<label id="elh_employee_supervisor" for="x_supervisor" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->supervisor->caption() ?><?php echo ($employee->supervisor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->supervisor->cellAttributes() ?>>
...
<?php if ($employee->indirect_supervisors->Visible) { // indirect_supervisors ?>
	<div id="r_indirect_supervisors" class="form-group row">
		<label id="elh_employee_indirect_supervisors" for="x_indirect_supervisors" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->indirect_supervisors->caption() ?><?php echo ($employee->indirect_supervisors->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->indirect_supervisors->cellAttributes() ?>>
...
<?php if ($employee->department->Visible) { // department ?>
	<div id="r_department" class="form-group row">
		<label id="elh_employee_department" for="x_department" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->department->caption() ?><?php echo ($employee->department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->department->cellAttributes() ?>>
...
<?php if ($employee->termination_date->Visible) { // termination_date ?>
	<div id="r_termination_date" class="form-group row">
		<label id="elh_employee_termination_date" for="x_termination_date" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->termination_date->caption() ?><?php echo ($employee->termination_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->termination_date->cellAttributes() ?>>
...
<?php if ($employee->ethnicity->Visible) { // ethnicity ?>
	<div id="r_ethnicity" class="form-group row">
		<label id="elh_employee_ethnicity" for="x_ethnicity" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->ethnicity->caption() ?><?php echo ($employee->ethnicity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->ethnicity->cellAttributes() ?>>
...
<?php if ($employee->immigration_status->Visible) { // immigration_status ?>
	<div id="r_immigration_status" class="form-group row">
		<label id="elh_employee_immigration_status" for="x_immigration_status" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->immigration_status->caption() ?><?php echo ($employee->immigration_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->immigration_status->cellAttributes() ?>>
...
<?php if ($employee->ssn_num->Visible) { // ssn_num ?>
	<div id="r_ssn_num" class="form-group row">
		<label id="elh_employee_ssn_num" for="x_ssn_num" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->ssn_num->caption() ?><?php echo ($employee->ssn_num->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->ssn_num->cellAttributes() ?>>
...
<?php if ($employee->nic_num->Visible) { // nic_num ?>
	<div id="r_nic_num" class="form-group row">
		<label id="elh_employee_nic_num" for="x_nic_num" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->nic_num->caption() ?><?php echo ($employee->nic_num->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->nic_num->cellAttributes() ?>>
...
<?php if ($employee->other_id->Visible) { // other_id ?>
	<div id="r_other_id" class="form-group row">
		<label id="elh_employee_other_id" for="x_other_id" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->other_id->caption() ?><?php echo ($employee->other_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->other_id->cellAttributes() ?>>
...
<?php if ($employee->driving_license->Visible) { // driving_license ?>
	<div id="r_driving_license" class="form-group row">
		<label id="elh_employee_driving_license" for="x_driving_license" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->driving_license->caption() ?><?php echo ($employee->driving_license->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->driving_license->cellAttributes() ?>>
...
<?php if ($employee->driving_license_exp_date->Visible) { // driving_license_exp_date ?>
	<div id="r_driving_license_exp_date" class="form-group row">
		<label id="elh_employee_driving_license_exp_date" for="x_driving_license_exp_date" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->driving_license_exp_date->caption() ?><?php echo ($employee->driving_license_exp_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->driving_license_exp_date->cellAttributes() ?>>
...
<?php if ($employee->address1->Visible) { // address1 ?>
	<div id="r_address1" class="form-group row">
		<label id="elh_employee_address1" for="x_address1" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->address1->caption() ?><?php echo ($employee->address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->address1->cellAttributes() ?>>
...
<?php if ($employee->address2->Visible) { // address2 ?>
	<div id="r_address2" class="form-group row">
		<label id="elh_employee_address2" for="x_address2" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->address2->caption() ?><?php echo ($employee->address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->address2->cellAttributes() ?>>
...
<?php if ($employee->city->Visible) { // city ?>
	<div id="r_city" class="form-group row">
		<label id="elh_employee_city" for="x_city" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->city->caption() ?><?php echo ($employee->city->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->city->cellAttributes() ?>>
...
<?php if ($employee->country->Visible) { // country ?>
	<div id="r_country" class="form-group row">
		<label id="elh_employee_country" for="x_country" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->country->caption() ?><?php echo ($employee->country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->country->cellAttributes() ?>>
...
<?php if ($employee->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_employee_province" for="x_province" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->province->caption() ?><?php echo ($employee->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->province->cellAttributes() ?>>
...
<?php if ($employee->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_employee_postal_code" for="x_postal_code" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->postal_code->caption() ?><?php echo ($employee->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->postal_code->cellAttributes() ?>>
...
<?php if ($employee->home_phone->Visible) { // home_phone ?>
	<div id="r_home_phone" class="form-group row">
		<label id="elh_employee_home_phone" for="x_home_phone" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->home_phone->caption() ?><?php echo ($employee->home_phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->home_phone->cellAttributes() ?>>
...
<?php if ($employee->mobile_phone->Visible) { // mobile_phone ?>
	<div id="r_mobile_phone" class="form-group row">
		<label id="elh_employee_mobile_phone" for="x_mobile_phone" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->mobile_phone->caption() ?><?php echo ($employee->mobile_phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->mobile_phone->cellAttributes() ?>>
...
<?php if ($employee->work_phone->Visible) { // work_phone ?>
	<div id="r_work_phone" class="form-group row">
		<label id="elh_employee_work_phone" for="x_work_phone" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->work_phone->caption() ?><?php echo ($employee->work_phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->work_phone->cellAttributes() ?>>
...
<?php if ($employee->work_email->Visible) { // work_email ?>
	<div id="r_work_email" class="form-group row">
		<label id="elh_employee_work_email" for="x_work_email" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->work_email->caption() ?><?php echo ($employee->work_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->work_email->cellAttributes() ?>>
...
<?php if ($employee->private_email->Visible) { // private_email ?>
	<div id="r_private_email" class="form-group row">
		<label id="elh_employee_private_email" for="x_private_email" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->private_email->caption() ?><?php echo ($employee->private_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->private_email->cellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $employee_add->MultiPages->pageStyle("4") ?>" id="tab_employee4"><!-- multi-page .tab-pane -->
<div class="ew-add-div"><!-- page* -->
<?php if ($employee->custom1->Visible) { // custom1 ?>
	<div id="r_custom1" class="form-group row">
		<label id="elh_employee_custom1" for="x_custom1" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom1->caption() ?><?php echo ($employee->custom1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom1->cellAttributes() ?>>
...
<?php if ($employee->custom2->Visible) { // custom2 ?>
	<div id="r_custom2" class="form-group row">
		<label id="elh_employee_custom2" for="x_custom2" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom2->caption() ?><?php echo ($employee->custom2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom2->cellAttributes() ?>>
...
<?php if ($employee->custom3->Visible) { // custom3 ?>
	<div id="r_custom3" class="form-group row">
		<label id="elh_employee_custom3" for="x_custom3" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom3->caption() ?><?php echo ($employee->custom3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom3->cellAttributes() ?>>
...
<?php if ($employee->custom4->Visible) { // custom4 ?>
	<div id="r_custom4" class="form-group row">
		<label id="elh_employee_custom4" for="x_custom4" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom4->caption() ?><?php echo ($employee->custom4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom4->cellAttributes() ?>>
...
<?php if ($employee->custom5->Visible) { // custom5 ?>
	<div id="r_custom5" class="form-group row">
		<label id="elh_employee_custom5" for="x_custom5" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom5->caption() ?><?php echo ($employee->custom5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom5->cellAttributes() ?>>
...
<?php if ($employee->custom6->Visible) { // custom6 ?>
	<div id="r_custom6" class="form-group row">
		<label id="elh_employee_custom6" for="x_custom6" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom6->caption() ?><?php echo ($employee->custom6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom6->cellAttributes() ?>>
...
<?php if ($employee->custom7->Visible) { // custom7 ?>
	<div id="r_custom7" class="form-group row">
		<label id="elh_employee_custom7" for="x_custom7" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom7->caption() ?><?php echo ($employee->custom7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom7->cellAttributes() ?>>
...
<?php if ($employee->custom8->Visible) { // custom8 ?>
	<div id="r_custom8" class="form-group row">
		<label id="elh_employee_custom8" for="x_custom8" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom8->caption() ?><?php echo ($employee->custom8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom8->cellAttributes() ?>>
...
<?php if ($employee->custom9->Visible) { // custom9 ?>
	<div id="r_custom9" class="form-group row">
		<label id="elh_employee_custom9" for="x_custom9" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom9->caption() ?><?php echo ($employee->custom9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom9->cellAttributes() ?>>
...
<?php if ($employee->custom10->Visible) { // custom10 ?>
	<div id="r_custom10" class="form-group row">
		<label id="elh_employee_custom10" for="x_custom10" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->custom10->caption() ?><?php echo ($employee->custom10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->custom10->cellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $employee_add->MultiPages->pageStyle("5") ?>" id="tab_employee5"><!-- multi-page .tab-pane -->
<div class="ew-add-div"><!-- page* -->
<?php if ($employee->notes->Visible) { // notes ?>
	<div id="r_notes" class="form-group row">
		<label id="elh_employee_notes" for="x_notes" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->notes->caption() ?><?php echo ($employee->notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->notes->cellAttributes() ?>>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $employee_add->MultiPages->pageStyle("6") ?>" id="tab_employee6"><!-- multi-page .tab-pane -->
<div class="ew-add-div"><!-- page* -->
<?php if ($employee->approver1->Visible) { // approver1 ?>
	<div id="r_approver1" class="form-group row">
		<label id="elh_employee_approver1" for="x_approver1" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->approver1->caption() ?><?php echo ($employee->approver1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->approver1->cellAttributes() ?>>
...
<?php if ($employee->approver2->Visible) { // approver2 ?>
	<div id="r_approver2" class="form-group row">
		<label id="elh_employee_approver2" for="x_approver2" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->approver2->caption() ?><?php echo ($employee->approver2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->approver2->cellAttributes() ?>>
...
<?php if ($employee->approver3->Visible) { // approver3 ?>
	<div id="r_approver3" class="form-group row">
		<label id="elh_employee_approver3" for="x_approver3" class="<?php echo $employee_add->LeftColumnClass ?>"><?php echo $employee->approver3->caption() ?><?php echo ($employee->approver3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_add->RightColumnClass ?>"><div<?php echo $employee->approver3->cellAttributes() ?>>
