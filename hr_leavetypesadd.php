...
// Create page object
$hr_leavetypes_add = new hr_leavetypes_add();

// Run the page
$hr_leavetypes_add->run();
...
var fhr_leavetypesadd = currentForm = new ew.Form("fhr_leavetypesadd", "add");
...
fhr_leavetypesadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($hr_leavetypes_add->name->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->supervisor_leave_assign->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->employee_can_apply->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->apply_beyond_current->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->leave_accrue->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->carried_forward->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->default_per_year->Required) { ?>
		...
		<?php if ($hr_leavetypes_add->carried_forward_percentage->Required) { ?>
		...
		<?php if ($hr_leavetypes_add->carried_forward_leave_availability->Required) { ?>
		...
		<?php if ($hr_leavetypes_add->propotionate_on_joined_date->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->send_notification_emails->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->leave_group->Required) { ?>
		...
		<?php if ($hr_leavetypes_add->leave_color->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_leavetypes_add->max_carried_forward_amount->Required) { ?>
		...
		<?php if ($hr_leavetypes_add->HospID->Required) { ?>
...
fhr_leavetypesadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fhr_leavetypesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhr_leavetypesadd.lists["x_supervisor_leave_assign"] = <?php echo $hr_leavetypes_add->supervisor_leave_assign->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_supervisor_leave_assign"].options = <?php echo JsonEncode($hr_leavetypes_add->supervisor_leave_assign->options(FALSE, TRUE)) ?>;
fhr_leavetypesadd.lists["x_employee_can_apply"] = <?php echo $hr_leavetypes_add->employee_can_apply->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_employee_can_apply"].options = <?php echo JsonEncode($hr_leavetypes_add->employee_can_apply->options(FALSE, TRUE)) ?>;
fhr_leavetypesadd.lists["x_apply_beyond_current"] = <?php echo $hr_leavetypes_add->apply_beyond_current->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_apply_beyond_current"].options = <?php echo JsonEncode($hr_leavetypes_add->apply_beyond_current->options(FALSE, TRUE)) ?>;
fhr_leavetypesadd.lists["x_leave_accrue"] = <?php echo $hr_leavetypes_add->leave_accrue->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_leave_accrue"].options = <?php echo JsonEncode($hr_leavetypes_add->leave_accrue->options(FALSE, TRUE)) ?>;
fhr_leavetypesadd.lists["x_carried_forward"] = <?php echo $hr_leavetypes_add->carried_forward->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_carried_forward"].options = <?php echo JsonEncode($hr_leavetypes_add->carried_forward->options(FALSE, TRUE)) ?>;
fhr_leavetypesadd.lists["x_propotionate_on_joined_date"] = <?php echo $hr_leavetypes_add->propotionate_on_joined_date->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_propotionate_on_joined_date"].options = <?php echo JsonEncode($hr_leavetypes_add->propotionate_on_joined_date->options(FALSE, TRUE)) ?>;
fhr_leavetypesadd.lists["x_send_notification_emails"] = <?php echo $hr_leavetypes_add->send_notification_emails->Lookup->toClientList() ?>;
fhr_leavetypesadd.lists["x_send_notification_emails"].options = <?php echo JsonEncode($hr_leavetypes_add->send_notification_emails->options(FALSE, TRUE)) ?>;
...
<?php $hr_leavetypes_add->showPageHeader(); ?>
<?php
$hr_leavetypes_add->showMessage();
?>
<form name="fhr_leavetypesadd" id="fhr_leavetypesadd" class="<?php echo $hr_leavetypes_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($hr_leavetypes_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $hr_leavetypes_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="hr_leavetypes">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$hr_leavetypes_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($hr_leavetypes->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_hr_leavetypes_name" for="x_name" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->name->caption() ?><?php echo ($hr_leavetypes->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->name->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->supervisor_leave_assign->Visible) { // supervisor_leave_assign ?>
	<div id="r_supervisor_leave_assign" class="form-group row">
		<label id="elh_hr_leavetypes_supervisor_leave_assign" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->supervisor_leave_assign->caption() ?><?php echo ($hr_leavetypes->supervisor_leave_assign->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->supervisor_leave_assign->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->employee_can_apply->Visible) { // employee_can_apply ?>
	<div id="r_employee_can_apply" class="form-group row">
		<label id="elh_hr_leavetypes_employee_can_apply" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->employee_can_apply->caption() ?><?php echo ($hr_leavetypes->employee_can_apply->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->employee_can_apply->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->apply_beyond_current->Visible) { // apply_beyond_current ?>
	<div id="r_apply_beyond_current" class="form-group row">
		<label id="elh_hr_leavetypes_apply_beyond_current" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->apply_beyond_current->caption() ?><?php echo ($hr_leavetypes->apply_beyond_current->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->apply_beyond_current->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->leave_accrue->Visible) { // leave_accrue ?>
	<div id="r_leave_accrue" class="form-group row">
		<label id="elh_hr_leavetypes_leave_accrue" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->leave_accrue->caption() ?><?php echo ($hr_leavetypes->leave_accrue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->leave_accrue->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->carried_forward->Visible) { // carried_forward ?>
	<div id="r_carried_forward" class="form-group row">
		<label id="elh_hr_leavetypes_carried_forward" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->carried_forward->caption() ?><?php echo ($hr_leavetypes->carried_forward->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->carried_forward->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->default_per_year->Visible) { // default_per_year ?>
	<div id="r_default_per_year" class="form-group row">
		<label id="elh_hr_leavetypes_default_per_year" for="x_default_per_year" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->default_per_year->caption() ?><?php echo ($hr_leavetypes->default_per_year->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->default_per_year->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->carried_forward_percentage->Visible) { // carried_forward_percentage ?>
	<div id="r_carried_forward_percentage" class="form-group row">
		<label id="elh_hr_leavetypes_carried_forward_percentage" for="x_carried_forward_percentage" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->carried_forward_percentage->caption() ?><?php echo ($hr_leavetypes->carried_forward_percentage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->carried_forward_percentage->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->carried_forward_leave_availability->Visible) { // carried_forward_leave_availability ?>
	<div id="r_carried_forward_leave_availability" class="form-group row">
		<label id="elh_hr_leavetypes_carried_forward_leave_availability" for="x_carried_forward_leave_availability" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->carried_forward_leave_availability->caption() ?><?php echo ($hr_leavetypes->carried_forward_leave_availability->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->carried_forward_leave_availability->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->propotionate_on_joined_date->Visible) { // propotionate_on_joined_date ?>
	<div id="r_propotionate_on_joined_date" class="form-group row">
		<label id="elh_hr_leavetypes_propotionate_on_joined_date" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->propotionate_on_joined_date->caption() ?><?php echo ($hr_leavetypes->propotionate_on_joined_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->propotionate_on_joined_date->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->send_notification_emails->Visible) { // send_notification_emails ?>
	<div id="r_send_notification_emails" class="form-group row">
		<label id="elh_hr_leavetypes_send_notification_emails" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->send_notification_emails->caption() ?><?php echo ($hr_leavetypes->send_notification_emails->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->send_notification_emails->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->leave_group->Visible) { // leave_group ?>
	<div id="r_leave_group" class="form-group row">
		<label id="elh_hr_leavetypes_leave_group" for="x_leave_group" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->leave_group->caption() ?><?php echo ($hr_leavetypes->leave_group->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->leave_group->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->leave_color->Visible) { // leave_color ?>
	<div id="r_leave_color" class="form-group row">
		<label id="elh_hr_leavetypes_leave_color" for="x_leave_color" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->leave_color->caption() ?><?php echo ($hr_leavetypes->leave_color->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->leave_color->cellAttributes() ?>>
...
<?php if ($hr_leavetypes->max_carried_forward_amount->Visible) { // max_carried_forward_amount ?>
	<div id="r_max_carried_forward_amount" class="form-group row">
		<label id="elh_hr_leavetypes_max_carried_forward_amount" for="x_max_carried_forward_amount" class="<?php echo $hr_leavetypes_add->LeftColumnClass ?>"><?php echo $hr_leavetypes->max_carried_forward_amount->caption() ?><?php echo ($hr_leavetypes->max_carried_forward_amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_leavetypes_add->RightColumnClass ?>"><div<?php echo $hr_leavetypes->max_carried_forward_amount->cellAttributes() ?>>
...
<?php if (!$hr_leavetypes_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $hr_leavetypes_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $hr_leavetypes_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$hr_leavetypes_add->showPageFooter();
if (DEBUG_ENABLED)
