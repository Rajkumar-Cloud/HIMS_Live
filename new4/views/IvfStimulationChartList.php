...
<form name="fivf_stimulation_chartlistsrch" id="fivf_stimulation_chartlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fivf_stimulation_chartlist" id="fivf_stimulation_chartlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
