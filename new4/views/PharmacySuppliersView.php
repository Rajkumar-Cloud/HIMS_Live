...
// Page object
$PharmacySuppliersView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fpharmacy_suppliersview;
...
$Page->showMessage();
?>
<form name="fpharmacy_suppliersview" id="fpharmacy_suppliersview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Suppliercode->Visible) { // Suppliercode ?>
    <tr id="r_Suppliercode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Suppliercode"><?= $Page->Suppliercode->caption() ?></span></td>
...
<?php if ($Page->Suppliername->Visible) { // Suppliername ?>
    <tr id="r_Suppliername">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Suppliername"><?= $Page->Suppliername->caption() ?></span></td>
...
<?php if ($Page->Abbreviation->Visible) { // Abbreviation ?>
    <tr id="r_Abbreviation">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Abbreviation"><?= $Page->Abbreviation->caption() ?></span></td>
...
<?php if ($Page->Creationdate->Visible) { // Creationdate ?>
    <tr id="r_Creationdate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Creationdate"><?= $Page->Creationdate->caption() ?></span></td>
...
<?php if ($Page->Address1->Visible) { // Address1 ?>
    <tr id="r_Address1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Address1"><?= $Page->Address1->caption() ?></span></td>
...
<?php if ($Page->Address2->Visible) { // Address2 ?>
    <tr id="r_Address2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Address2"><?= $Page->Address2->caption() ?></span></td>
...
<?php if ($Page->Address3->Visible) { // Address3 ?>
    <tr id="r_Address3">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Address3"><?= $Page->Address3->caption() ?></span></td>
...
<?php if ($Page->Citycode->Visible) { // Citycode ?>
    <tr id="r_Citycode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Citycode"><?= $Page->Citycode->caption() ?></span></td>
...
<?php if ($Page->State->Visible) { // State ?>
    <tr id="r_State">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_State"><?= $Page->State->caption() ?></span></td>
...
<?php if ($Page->Pincode->Visible) { // Pincode ?>
    <tr id="r_Pincode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Pincode"><?= $Page->Pincode->caption() ?></span></td>
...
<?php if ($Page->Tngstnumber->Visible) { // Tngstnumber ?>
    <tr id="r_Tngstnumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Tngstnumber"><?= $Page->Tngstnumber->caption() ?></span></td>
...
<?php if ($Page->Phone->Visible) { // Phone ?>
    <tr id="r_Phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Phone"><?= $Page->Phone->caption() ?></span></td>
...
<?php if ($Page->Fax->Visible) { // Fax ?>
    <tr id="r_Fax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Fax"><?= $Page->Fax->caption() ?></span></td>
...
<?php if ($Page->_Email->Visible) { // Email ?>
    <tr id="r__Email">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers__Email"><?= $Page->_Email->caption() ?></span></td>
...
<?php if ($Page->Paymentmode->Visible) { // Paymentmode ?>
    <tr id="r_Paymentmode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Paymentmode"><?= $Page->Paymentmode->caption() ?></span></td>
...
<?php if ($Page->Contactperson1->Visible) { // Contactperson1 ?>
    <tr id="r_Contactperson1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Contactperson1"><?= $Page->Contactperson1->caption() ?></span></td>
...
<?php if ($Page->CP1Address1->Visible) { // CP1Address1 ?>
    <tr id="r_CP1Address1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Address1"><?= $Page->CP1Address1->caption() ?></span></td>
...
<?php if ($Page->CP1Address2->Visible) { // CP1Address2 ?>
    <tr id="r_CP1Address2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Address2"><?= $Page->CP1Address2->caption() ?></span></td>
...
<?php if ($Page->CP1Address3->Visible) { // CP1Address3 ?>
    <tr id="r_CP1Address3">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Address3"><?= $Page->CP1Address3->caption() ?></span></td>
...
<?php if ($Page->CP1Citycode->Visible) { // CP1Citycode ?>
    <tr id="r_CP1Citycode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Citycode"><?= $Page->CP1Citycode->caption() ?></span></td>
...
<?php if ($Page->CP1State->Visible) { // CP1State ?>
    <tr id="r_CP1State">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1State"><?= $Page->CP1State->caption() ?></span></td>
...
<?php if ($Page->CP1Pincode->Visible) { // CP1Pincode ?>
    <tr id="r_CP1Pincode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Pincode"><?= $Page->CP1Pincode->caption() ?></span></td>
...
<?php if ($Page->CP1Designation->Visible) { // CP1Designation ?>
    <tr id="r_CP1Designation">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Designation"><?= $Page->CP1Designation->caption() ?></span></td>
...
<?php if ($Page->CP1Phone->Visible) { // CP1Phone ?>
    <tr id="r_CP1Phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Phone"><?= $Page->CP1Phone->caption() ?></span></td>
...
<?php if ($Page->CP1MobileNo->Visible) { // CP1MobileNo ?>
    <tr id="r_CP1MobileNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1MobileNo"><?= $Page->CP1MobileNo->caption() ?></span></td>
...
<?php if ($Page->CP1Fax->Visible) { // CP1Fax ?>
    <tr id="r_CP1Fax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Fax"><?= $Page->CP1Fax->caption() ?></span></td>
...
<?php if ($Page->CP1Email->Visible) { // CP1Email ?>
    <tr id="r_CP1Email">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP1Email"><?= $Page->CP1Email->caption() ?></span></td>
...
<?php if ($Page->Contactperson2->Visible) { // Contactperson2 ?>
    <tr id="r_Contactperson2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Contactperson2"><?= $Page->Contactperson2->caption() ?></span></td>
...
<?php if ($Page->CP2Address1->Visible) { // CP2Address1 ?>
    <tr id="r_CP2Address1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Address1"><?= $Page->CP2Address1->caption() ?></span></td>
...
<?php if ($Page->CP2Address2->Visible) { // CP2Address2 ?>
    <tr id="r_CP2Address2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Address2"><?= $Page->CP2Address2->caption() ?></span></td>
...
<?php if ($Page->CP2Address3->Visible) { // CP2Address3 ?>
    <tr id="r_CP2Address3">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Address3"><?= $Page->CP2Address3->caption() ?></span></td>
...
<?php if ($Page->CP2Citycode->Visible) { // CP2Citycode ?>
    <tr id="r_CP2Citycode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Citycode"><?= $Page->CP2Citycode->caption() ?></span></td>
...
<?php if ($Page->CP2State->Visible) { // CP2State ?>
    <tr id="r_CP2State">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2State"><?= $Page->CP2State->caption() ?></span></td>
...
<?php if ($Page->CP2Pincode->Visible) { // CP2Pincode ?>
    <tr id="r_CP2Pincode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Pincode"><?= $Page->CP2Pincode->caption() ?></span></td>
...
<?php if ($Page->CP2Designation->Visible) { // CP2Designation ?>
    <tr id="r_CP2Designation">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Designation"><?= $Page->CP2Designation->caption() ?></span></td>
...
<?php if ($Page->CP2Phone->Visible) { // CP2Phone ?>
    <tr id="r_CP2Phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Phone"><?= $Page->CP2Phone->caption() ?></span></td>
...
<?php if ($Page->CP2MobileNo->Visible) { // CP2MobileNo ?>
    <tr id="r_CP2MobileNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2MobileNo"><?= $Page->CP2MobileNo->caption() ?></span></td>
...
<?php if ($Page->CP2Fax->Visible) { // CP2Fax ?>
    <tr id="r_CP2Fax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Fax"><?= $Page->CP2Fax->caption() ?></span></td>
...
<?php if ($Page->CP2Email->Visible) { // CP2Email ?>
    <tr id="r_CP2Email">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_CP2Email"><?= $Page->CP2Email->caption() ?></span></td>
...
<?php if ($Page->Type->Visible) { // Type ?>
    <tr id="r_Type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Type"><?= $Page->Type->caption() ?></span></td>
...
<?php if ($Page->Creditterms->Visible) { // Creditterms ?>
    <tr id="r_Creditterms">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Creditterms"><?= $Page->Creditterms->caption() ?></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Remarks"><?= $Page->Remarks->caption() ?></span></td>
...
<?php if ($Page->Tinnumber->Visible) { // Tinnumber ?>
    <tr id="r_Tinnumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Tinnumber"><?= $Page->Tinnumber->caption() ?></span></td>
...
<?php if ($Page->Universalsuppliercode->Visible) { // Universalsuppliercode ?>
    <tr id="r_Universalsuppliercode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Universalsuppliercode"><?= $Page->Universalsuppliercode->caption() ?></span></td>
...
<?php if ($Page->Mobilenumber->Visible) { // Mobilenumber ?>
    <tr id="r_Mobilenumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_Mobilenumber"><?= $Page->Mobilenumber->caption() ?></span></td>
...
<?php if ($Page->PANNumber->Visible) { // PANNumber ?>
    <tr id="r_PANNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_PANNumber"><?= $Page->PANNumber->caption() ?></span></td>
...
<?php if ($Page->SalesRepMobileNo->Visible) { // SalesRepMobileNo ?>
    <tr id="r_SalesRepMobileNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_SalesRepMobileNo"><?= $Page->SalesRepMobileNo->caption() ?></span></td>
...
<?php if ($Page->GSTNumber->Visible) { // GSTNumber ?>
    <tr id="r_GSTNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_GSTNumber"><?= $Page->GSTNumber->caption() ?></span></td>
...
<?php if ($Page->TANNumber->Visible) { // TANNumber ?>
    <tr id="r_TANNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_TANNumber"><?= $Page->TANNumber->caption() ?></span></td>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_suppliers_id"><?= $Page->id->caption() ?></span></td>
