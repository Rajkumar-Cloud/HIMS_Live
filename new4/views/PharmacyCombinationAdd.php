...
// Page object
$PharmacyCombinationAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_combinationadd;
loadjs.ready("head", function () {
    ...
    fpharmacy_combinationadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpharmacy_combinationadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpharmacy_combinationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_combinationadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpharmacy_combinationadd.lists.GENCODE = <?= $Page->GENCODE->toClientList($Page) ?>;
    fpharmacy_combinationadd.lists.COMBCODE = <?= $Page->COMBCODE->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_combinationadd" id="fpharmacy_combinationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
