...
// Page object
$ViewPharmacyPurchaseRequestItemsApprovedView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_pharmacy_purchase_request_items_approvedview;
...
$Page->showMessage();
?>
<form name="fview_pharmacy_purchase_request_items_approvedview" id="fview_pharmacy_purchase_request_items_approvedview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->PRC->Visible) { // PRC ?>
    <tr id="r_PRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_PRC"><?= $Page->PRC->caption() ?></span></td>
...
<?php if ($Page->PrName->Visible) { // PrName ?>
    <tr id="r_PrName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_PrName"><?= $Page->PrName->caption() ?></span></td>
...
<?php if ($Page->Quantity->Visible) { // Quantity ?>
    <tr id="r_Quantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_Quantity"><?= $Page->Quantity->caption() ?></span></td>
...
<?php if ($Page->ApprovedStatus->Visible) { // ApprovedStatus ?>
    <tr id="r_ApprovedStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_ApprovedStatus"><?= $Page->ApprovedStatus->caption() ?></span></td>
...
<?php if ($Page->PurchaseStatus->Visible) { // PurchaseStatus ?>
    <tr id="r_PurchaseStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_PurchaseStatus"><?= $Page->PurchaseStatus->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_BRCODE"><?= $Page->BRCODE->caption() ?></span></td>
...
<?php if ($Page->prid->Visible) { // prid ?>
    <tr id="r_prid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_items_approved_prid"><?= $Page->prid->caption() ?></span></td>
