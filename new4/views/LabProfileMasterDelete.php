...
<script>
if (!ew.vars.tables.lab_profile_master) ew.vars.tables.lab_profile_master = <?= JsonEncode(GetClientVar("tables", "lab_profile_master")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="flab_profile_masterdelete" id="flab_profile_masterdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
