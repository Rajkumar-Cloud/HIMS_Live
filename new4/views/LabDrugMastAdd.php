...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "lab_drug_mast")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.lab_drug_mast)
        ew.vars.tables.lab_drug_mast = currentTable;
    flab_drug_mastadd.addFields([
        ["DrugName", [fields.DrugName.visible && fields.DrugName.required ? ew.Validators.required(fields.DrugName.caption) : null], fields.DrugName.isInvalid],
        ["Positive", [fields.Positive.visible && fields.Positive.required ? ew.Validators.required(fields.Positive.caption) : null], fields.Positive.isInvalid],
        ["Negative", [fields.Negative.visible && fields.Negative.required ? ew.Validators.required(fields.Negative.caption) : null], fields.Negative.isInvalid],
        ...
        ["GroupCD", [fields.GroupCD.visible && fields.GroupCD.required ? ew.Validators.required(fields.GroupCD.caption) : null], fields.GroupCD.isInvalid],
        ...
        ["DrugCD", [fields.DrugCD.visible && fields.DrugCD.required ? ew.Validators.required(fields.DrugCD.caption) : null], fields.DrugCD.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = flab_drug_mastadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    flab_drug_mastadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flab_drug_mastadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="flab_drug_mastadd" id="flab_drug_mastadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
