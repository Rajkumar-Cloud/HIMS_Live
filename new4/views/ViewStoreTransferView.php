...
// Page object
$ViewStoreTransferView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_store_transferview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fview_store_transferview = currentForm = new ew.Form("fview_store_transferview", "view");
    loadjs.done("fview_store_transferview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<script>
if (!ew.vars.tables.view_store_transfer) ew.vars.tables.view_store_transfer = <?= JsonEncode(GetClientVar("tables", "view_store_transfer")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fview_store_transferview" id="fview_store_transferview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ORDNO->Visible) { // ORDNO ?>
    <tr id="r_ORDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_ORDNO"><?= $Page->ORDNO->caption() ?></span></td>
...
<?php if ($Page->PRC->Visible) { // PRC ?>
    <tr id="r_PRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PRC"><?= $Page->PRC->caption() ?></span></td>
...
<?php if ($Page->QTY->Visible) { // QTY ?>
    <tr id="r_QTY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_QTY"><?= $Page->QTY->caption() ?></span></td>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <tr id="r_DT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_DT"><?= $Page->DT->caption() ?></span></td>
...
<?php if ($Page->PC->Visible) { // PC ?>
    <tr id="r_PC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PC"><?= $Page->PC->caption() ?></span></td>
...
<?php if ($Page->YM->Visible) { // YM ?>
    <tr id="r_YM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_YM"><?= $Page->YM->caption() ?></span></td>
...
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
    <tr id="r_MFRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_MFRCODE"><?= $Page->MFRCODE->caption() ?></span></td>
...
<?php if ($Page->Stock->Visible) { // Stock ?>
    <tr id="r_Stock">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Stock"><?= $Page->Stock->caption() ?></span></td>
...
<?php if ($Page->LastMonthSale->Visible) { // LastMonthSale ?>
    <tr id="r_LastMonthSale">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_LastMonthSale"><?= $Page->LastMonthSale->caption() ?></span></td>
...
<?php if ($Page->Printcheck->Visible) { // Printcheck ?>
    <tr id="r_Printcheck">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Printcheck"><?= $Page->Printcheck->caption() ?></span></td>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->poid->Visible) { // poid ?>
    <tr id="r_poid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_poid"><?= $Page->poid->caption() ?></span></td>
...
<?php if ($Page->grnid->Visible) { // grnid ?>
    <tr id="r_grnid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_grnid"><?= $Page->grnid->caption() ?></span></td>
...
<?php if ($Page->BatchNo->Visible) { // BatchNo ?>
    <tr id="r_BatchNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_BatchNo"><?= $Page->BatchNo->caption() ?></span></td>
...
<?php if ($Page->ExpDate->Visible) { // ExpDate ?>
    <tr id="r_ExpDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_ExpDate"><?= $Page->ExpDate->caption() ?></span></td>
...
<?php if ($Page->PrName->Visible) { // PrName ?>
    <tr id="r_PrName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PrName"><?= $Page->PrName->caption() ?></span></td>
...
<?php if ($Page->Quantity->Visible) { // Quantity ?>
    <tr id="r_Quantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Quantity"><?= $Page->Quantity->caption() ?></span></td>
...
<?php if ($Page->FreeQty->Visible) { // FreeQty ?>
    <tr id="r_FreeQty">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_FreeQty"><?= $Page->FreeQty->caption() ?></span></td>
...
<?php if ($Page->ItemValue->Visible) { // ItemValue ?>
    <tr id="r_ItemValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_ItemValue"><?= $Page->ItemValue->caption() ?></span></td>
...
<?php if ($Page->Disc->Visible) { // Disc ?>
    <tr id="r_Disc">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Disc"><?= $Page->Disc->caption() ?></span></td>
...
<?php if ($Page->PTax->Visible) { // PTax ?>
    <tr id="r_PTax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PTax"><?= $Page->PTax->caption() ?></span></td>
...
<?php if ($Page->MRP->Visible) { // MRP ?>
    <tr id="r_MRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_MRP"><?= $Page->MRP->caption() ?></span></td>
...
<?php if ($Page->SalTax->Visible) { // SalTax ?>
    <tr id="r_SalTax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_SalTax"><?= $Page->SalTax->caption() ?></span></td>
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <tr id="r_PurValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PurValue"><?= $Page->PurValue->caption() ?></span></td>
...
<?php if ($Page->PurRate->Visible) { // PurRate ?>
    <tr id="r_PurRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PurRate"><?= $Page->PurRate->caption() ?></span></td>
...
<?php if ($Page->SalRate->Visible) { // SalRate ?>
    <tr id="r_SalRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_SalRate"><?= $Page->SalRate->caption() ?></span></td>
...
<?php if ($Page->Discount->Visible) { // Discount ?>
    <tr id="r_Discount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Discount"><?= $Page->Discount->caption() ?></span></td>
...
<?php if ($Page->PSGST->Visible) { // PSGST ?>
    <tr id="r_PSGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PSGST"><?= $Page->PSGST->caption() ?></span></td>
...
<?php if ($Page->PCGST->Visible) { // PCGST ?>
    <tr id="r_PCGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PCGST"><?= $Page->PCGST->caption() ?></span></td>
...
<?php if ($Page->SSGST->Visible) { // SSGST ?>
    <tr id="r_SSGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_SSGST"><?= $Page->SSGST->caption() ?></span></td>
...
<?php if ($Page->SCGST->Visible) { // SCGST ?>
    <tr id="r_SCGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_SCGST"><?= $Page->SCGST->caption() ?></span></td>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_BRCODE"><?= $Page->BRCODE->caption() ?></span></td>
...
<?php if ($Page->HSN->Visible) { // HSN ?>
    <tr id="r_HSN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_HSN"><?= $Page->HSN->caption() ?></span></td>
...
<?php if ($Page->Pack->Visible) { // Pack ?>
    <tr id="r_Pack">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Pack"><?= $Page->Pack->caption() ?></span></td>
...
<?php if ($Page->PUnit->Visible) { // PUnit ?>
    <tr id="r_PUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_PUnit"><?= $Page->PUnit->caption() ?></span></td>
...
<?php if ($Page->SUnit->Visible) { // SUnit ?>
    <tr id="r_SUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_SUnit"><?= $Page->SUnit->caption() ?></span></td>
...
<?php if ($Page->GrnQuantity->Visible) { // GrnQuantity ?>
    <tr id="r_GrnQuantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_GrnQuantity"><?= $Page->GrnQuantity->caption() ?></span></td>
...
<?php if ($Page->GrnMRP->Visible) { // GrnMRP ?>
    <tr id="r_GrnMRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_GrnMRP"><?= $Page->GrnMRP->caption() ?></span></td>
...
<?php if ($Page->strid->Visible) { // strid ?>
    <tr id="r_strid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_strid"><?= $Page->strid->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
    <tr id="r_CreatedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_CreatedBy"><?= $Page->CreatedBy->caption() ?></span></td>
...
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
    <tr id="r_CreatedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_CreatedDateTime"><?= $Page->CreatedDateTime->caption() ?></span></td>
...
<?php if ($Page->ModifiedBy->Visible) { // ModifiedBy ?>
    <tr id="r_ModifiedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_ModifiedBy"><?= $Page->ModifiedBy->caption() ?></span></td>
...
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
    <tr id="r_ModifiedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_ModifiedDateTime"><?= $Page->ModifiedDateTime->caption() ?></span></td>
...
<?php if ($Page->grncreatedby->Visible) { // grncreatedby ?>
    <tr id="r_grncreatedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_grncreatedby"><?= $Page->grncreatedby->caption() ?></span></td>
...
<?php if ($Page->grncreatedDateTime->Visible) { // grncreatedDateTime ?>
    <tr id="r_grncreatedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_grncreatedDateTime"><?= $Page->grncreatedDateTime->caption() ?></span></td>
...
<?php if ($Page->grnModifiedby->Visible) { // grnModifiedby ?>
    <tr id="r_grnModifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_grnModifiedby"><?= $Page->grnModifiedby->caption() ?></span></td>
...
<?php if ($Page->grnModifiedDateTime->Visible) { // grnModifiedDateTime ?>
    <tr id="r_grnModifiedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_grnModifiedDateTime"><?= $Page->grnModifiedDateTime->caption() ?></span></td>
...
<?php if ($Page->Received->Visible) { // Received ?>
    <tr id="r_Received">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_Received"><?= $Page->Received->caption() ?></span></td>
...
<?php if ($Page->BillDate->Visible) { // BillDate ?>
    <tr id="r_BillDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_BillDate"><?= $Page->BillDate->caption() ?></span></td>
...
<?php if ($Page->CurStock->Visible) { // CurStock ?>
    <tr id="r_CurStock">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_store_transfer_CurStock"><?= $Page->CurStock->caption() ?></span></td>
