...
<script>
if (!ew.vars.tables.monitor_treatment_plan) ew.vars.tables.monitor_treatment_plan = <?= JsonEncode(GetClientVar("tables", "monitor_treatment_plan")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fmonitor_treatment_plandelete" id="fmonitor_treatment_plandelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
