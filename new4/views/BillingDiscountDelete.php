...
<script>
if (!ew.vars.tables.billing_discount) ew.vars.tables.billing_discount = <?= JsonEncode(GetClientVar("tables", "billing_discount")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fbilling_discountdelete" id="fbilling_discountdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
