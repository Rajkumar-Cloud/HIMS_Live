...
// Page object
$ViewDonorIvfAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_donor_ivfadd;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fview_donor_ivfadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_donor_ivfadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_donor_ivfadd.lists.Female = <?= $Page->Female->toClientList($Page) ?>;
    fview_donor_ivfadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fview_donor_ivfadd.lists.ReferedBy = <?= $Page->ReferedBy->toClientList($Page) ?>;
    fview_donor_ivfadd.lists.DrID = <?= $Page->DrID->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_donor_ivfadd" id="fview_donor_ivfadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_view_donor_ivfadd">
<div id="ct_ViewDonorIvfAdd"><style>
...
.ew-row .ew-cell {
	margin-right: unset;
				   ...
				   <slot class="ew-slot" name="tpc_view_donor_ivf_Fgender"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_Fgender"></slot>
...
<?php
    if (in_array("ivf_treatment_plan", explode(",", $Page->getCurrentDetailTable())) && $ivf_treatment_plan->DetailAdd) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_donor_ivfadd", "tpm_view_donor_ivfadd", "view_donor_ivfadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
