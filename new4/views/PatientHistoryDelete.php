...
$Page->showMessage();
?>
<form name="fpatient_historydelete" id="fpatient_historydelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->MaritalHistory->Visible) { // MaritalHistory ?>
        <th class="<?= $Page->MaritalHistory->headerCellClass() ?>"><span id="elh_patient_history_MaritalHistory" class="patient_history_MaritalHistory"><?= $Page->MaritalHistory->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MenstrualHistory->Visible) { // MenstrualHistory ?>
        <th class="<?= $Page->MenstrualHistory->headerCellClass() ?>"><span id="elh_patient_history_MenstrualHistory" class="patient_history_MenstrualHistory"><?= $Page->MenstrualHistory->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ObstetricHistory->Visible) { // ObstetricHistory ?>
        <th class="<?= $Page->ObstetricHistory->headerCellClass() ?>"><span id="elh_patient_history_ObstetricHistory" class="patient_history_ObstetricHistory"><?= $Page->ObstetricHistory->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_patient_history_MaritalHistory" class="patient_history_MaritalHistory">
...
<span id="el<?= $Page->RowCount ?>_patient_history_MenstrualHistory" class="patient_history_MenstrualHistory">
...
<span id="el<?= $Page->RowCount ?>_patient_history_ObstetricHistory" class="patient_history_ObstetricHistory">
