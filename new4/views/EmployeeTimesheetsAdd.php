...
// Page object
$EmployeeTimesheetsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_timesheetsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_timesheetsadd = currentForm = new ew.Form("femployee_timesheetsadd", "add");
    ...
    femployee_timesheetsadd.addFields([
    ...
    // Form_CustomValidate
    femployee_timesheetsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_timesheetsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_timesheetsadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_timesheetsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_timesheetsadd" id="femployee_timesheetsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_timesheetsadd", "datetimepicker"], function() {
