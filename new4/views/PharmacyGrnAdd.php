...
loadjs.ready("head", function () {
    ...
    fpharmacy_grnadd.lists.PC = <?= $Page->PC->toClientList($Page) ?>;
    fpharmacy_grnadd.lists.BRCODE = <?= $Page->BRCODE->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_grnadd" id="fpharmacy_grnadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_pharmacy_grnadd">
<div id="ct_PharmacyGrnAdd"><style>
...
<?php
    if (in_array("view_pharmacygrn", explode(",", $Page->getCurrentDetailTable())) && $view_pharmacygrn->DetailAdd) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_grnadd", "tpm_pharmacy_grnadd", "pharmacy_grnadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
