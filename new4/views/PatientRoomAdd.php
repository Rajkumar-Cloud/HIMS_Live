...
loadjs.ready("head", function () {
    ...
    fpatient_roomadd.lists.Reception = <?= $Page->Reception->toClientList($Page) ?>;
    fpatient_roomadd.lists.RoomID = <?= $Page->RoomID->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_roomadd" id="fpatient_roomadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" is="selection-list" data-table="patient_room" data-field="x_Reception" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->Reception->displayValueSeparatorAttribute() ?>" name="x_Reception" id="x_Reception" value="<?= $Page->Reception->CurrentValue ?>"<?= $Page->Reception->editAttributes() ?>>
</span></template>
<?php } ?>
</div></div>
    </div>
...
<template id="tpm_patient_roomadd">
<div id="ct_PatientRoomAdd"><style>
...
.widget-user .widget-user-header {
	...
	?>
<slot class="ew-slot" name="tpc_patient_room_Reception"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_Reception"></slot>	
			...
			<div class="card bg-info" style="color:#ac3973;">             
			  <div class="card-body">
			  	<table  style="width: 100%;"  class="ew-table">
			  			<tbody>
			  				<tr>
			  					<td><slot class="ew-slot" name="tpc_patient_room_RoomID"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_RoomID"></slot></td>
			  					<td><slot class="ew-slot" name="tpc_patient_room_RoomNo"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_RoomNo"></slot></td>
			  				</tr>
			  				<tr>
			  					<td><slot class="ew-slot" name="tpc_patient_room_RoomType"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_RoomType"></slot></td>
			  					<td><slot class="ew-slot" name="tpc_patient_room_SharingRoom"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_SharingRoom"></slot></td>
			  				</tr>
			  				<tr>
			  					<td></td>
			  					<td>&#x20B9; <slot class="ew-slot" name="tpc_patient_room_Amount"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_Amount"></slot></td>
			  				</tr>
			  			</tbody>
			  		</table>
			  </div>
			...
			<div class="card bg-info" style="color:#8a8a5c;">             
			  <div class="card-body">
			 	<table  style="width: 100%;"  class="ew-table">
			  			<tbody>
			  				<tr>
			  					<td><slot class="ew-slot" name="tpc_patient_room_Startdatetime"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_Startdatetime"></slot></td>
			  					<td><slot class="ew-slot" name="tpc_patient_room_Enddatetime"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_Enddatetime"></slot></td>
			  				</tr>
			  				<tr>
			  					<td><slot class="ew-slot" name="tpc_patient_room_Days"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_Days"></slot></td>
			  					<td><slot class="ew-slot" name="tpc_patient_room_Hours"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_Hours"></slot></td>
			  				</tr>
			  				<tr>
			  					<td><slot class="ew-slot" name="tpc_patient_room_DaysHours"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_DaysHours"></slot></td>
			  					<td>&#x20B9; <slot class="ew-slot" name="tpc_patient_room_TotalAmount"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_room_TotalAmount"></slot></td>
			  				</tr>
			  			</tbody>
			  		</table>
			  </div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_roomadd", "tpm_patient_roomadd", "patient_roomadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
