...
// Page object
$ViewIvfTreatmentPlanView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_ivf_treatment_planview;
...
$Page->showMessage();
?>
<form name="fview_ivf_treatment_planview" id="fview_ivf_treatment_planview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_id"><template id="tpc_view_ivf_treatment_plan_id"><?= $Page->id->caption() ?></template></span></td>
        <td data-name="id" <?= $Page->id->cellAttributes() ?>>
<template id="tpx_view_ivf_treatment_plan_id"><span id="el_view_ivf_treatment_plan_id">
...
<?php if ($Page->CoupleID->Visible) { // CoupleID ?>
    <tr id="r_CoupleID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_CoupleID"><template id="tpc_view_ivf_treatment_plan_CoupleID"><?= $Page->CoupleID->caption() ?></template></span></td>
...
<?php if ($Page->PatientID->Visible) { // PatientID ?>
    <tr id="r_PatientID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_PatientID"><template id="tpc_view_ivf_treatment_plan_PatientID"><?= $Page->PatientID->caption() ?></template></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_PatientName"><template id="tpc_view_ivf_treatment_plan_PatientName"><?= $Page->PatientName->caption() ?></template></span></td>
...
<?php if ($Page->WifeCell->Visible) { // WifeCell ?>
    <tr id="r_WifeCell">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_WifeCell"><template id="tpc_view_ivf_treatment_plan_WifeCell"><?= $Page->WifeCell->caption() ?></template></span></td>
...
<?php if ($Page->PartnerID->Visible) { // PartnerID ?>
    <tr id="r_PartnerID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_PartnerID"><template id="tpc_view_ivf_treatment_plan_PartnerID"><?= $Page->PartnerID->caption() ?></template></span></td>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <tr id="r_PartnerName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_PartnerName"><template id="tpc_view_ivf_treatment_plan_PartnerName"><?= $Page->PartnerName->caption() ?></template></span></td>
...
<?php if ($Page->HusbandCell->Visible) { // HusbandCell ?>
    <tr id="r_HusbandCell">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_HusbandCell"><template id="tpc_view_ivf_treatment_plan_HusbandCell"><?= $Page->HusbandCell->caption() ?></template></span></td>
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <tr id="r_RIDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_RIDNO"><template id="tpc_view_ivf_treatment_plan_RIDNO"><?= $Page->RIDNO->caption() ?></template></span></td>
...
<?php if ($Page->Name->Visible) { // Name ?>
    <tr id="r_Name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Name"><template id="tpc_view_ivf_treatment_plan_Name"><?= $Page->Name->caption() ?></template></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Age"><template id="tpc_view_ivf_treatment_plan_Age"><?= $Page->Age->caption() ?></template></span></td>
...
<?php if ($Page->TreatmentStartDate->Visible) { // TreatmentStartDate ?>
    <tr id="r_TreatmentStartDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TreatmentStartDate"><template id="tpc_view_ivf_treatment_plan_TreatmentStartDate"><?= $Page->TreatmentStartDate->caption() ?></template></span></td>
...
<?php if ($Page->treatment_status->Visible) { // treatment_status ?>
    <tr id="r_treatment_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_treatment_status"><template id="tpc_view_ivf_treatment_plan_treatment_status"><?= $Page->treatment_status->caption() ?></template></span></td>
...
<?php if ($Page->ARTCYCLE->Visible) { // ARTCYCLE ?>
    <tr id="r_ARTCYCLE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_ARTCYCLE"><template id="tpc_view_ivf_treatment_plan_ARTCYCLE"><?= $Page->ARTCYCLE->caption() ?></template></span></td>
...
<?php if ($Page->RESULT->Visible) { // RESULT ?>
    <tr id="r_RESULT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_RESULT"><template id="tpc_view_ivf_treatment_plan_RESULT"><?= $Page->RESULT->caption() ?></template></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_status"><template id="tpc_view_ivf_treatment_plan_status"><?= $Page->status->caption() ?></template></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_createdby"><template id="tpc_view_ivf_treatment_plan_createdby"><?= $Page->createdby->caption() ?></template></span></td>
        <td data-name="createdby" <?= $Page->createdby->cellAttributes() ?>>
<template id="tpx_view_ivf_treatment_plan_createdby"><span id="el_view_ivf_treatment_plan_createdby">
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_createddatetime"><template id="tpc_view_ivf_treatment_plan_createddatetime"><?= $Page->createddatetime->caption() ?></template></span></td>
        <td data-name="createddatetime" <?= $Page->createddatetime->cellAttributes() ?>>
<template id="tpx_view_ivf_treatment_plan_createddatetime"><span id="el_view_ivf_treatment_plan_createddatetime">
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_modifiedby"><template id="tpc_view_ivf_treatment_plan_modifiedby"><?= $Page->modifiedby->caption() ?></template></span></td>
        <td data-name="modifiedby" <?= $Page->modifiedby->cellAttributes() ?>>
<template id="tpx_view_ivf_treatment_plan_modifiedby"><span id="el_view_ivf_treatment_plan_modifiedby">
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_modifieddatetime"><template id="tpc_view_ivf_treatment_plan_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></template></span></td>
        <td data-name="modifieddatetime" <?= $Page->modifieddatetime->cellAttributes() ?>>
<template id="tpx_view_ivf_treatment_plan_modifieddatetime"><span id="el_view_ivf_treatment_plan_modifieddatetime">
...
<?php if ($Page->TreatementStopDate->Visible) { // TreatementStopDate ?>
    <tr id="r_TreatementStopDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TreatementStopDate"><template id="tpc_view_ivf_treatment_plan_TreatementStopDate"><?= $Page->TreatementStopDate->caption() ?></template></span></td>
...
<?php if ($Page->TypePatient->Visible) { // TypePatient ?>
    <tr id="r_TypePatient">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TypePatient"><template id="tpc_view_ivf_treatment_plan_TypePatient"><?= $Page->TypePatient->caption() ?></template></span></td>
...
<?php if ($Page->Treatment->Visible) { // Treatment ?>
    <tr id="r_Treatment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Treatment"><template id="tpc_view_ivf_treatment_plan_Treatment"><?= $Page->Treatment->caption() ?></template></span></td>
...
<?php if ($Page->TreatmentTec->Visible) { // TreatmentTec ?>
    <tr id="r_TreatmentTec">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TreatmentTec"><template id="tpc_view_ivf_treatment_plan_TreatmentTec"><?= $Page->TreatmentTec->caption() ?></template></span></td>
...
<?php if ($Page->TypeOfCycle->Visible) { // TypeOfCycle ?>
    <tr id="r_TypeOfCycle">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TypeOfCycle"><template id="tpc_view_ivf_treatment_plan_TypeOfCycle"><?= $Page->TypeOfCycle->caption() ?></template></span></td>
...
<?php if ($Page->SpermOrgin->Visible) { // SpermOrgin ?>
    <tr id="r_SpermOrgin">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_SpermOrgin"><template id="tpc_view_ivf_treatment_plan_SpermOrgin"><?= $Page->SpermOrgin->caption() ?></template></span></td>
...
<?php if ($Page->State->Visible) { // State ?>
    <tr id="r_State">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_State"><template id="tpc_view_ivf_treatment_plan_State"><?= $Page->State->caption() ?></template></span></td>
...
<?php if ($Page->Origin->Visible) { // Origin ?>
    <tr id="r_Origin">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Origin"><template id="tpc_view_ivf_treatment_plan_Origin"><?= $Page->Origin->caption() ?></template></span></td>
...
<?php if ($Page->MACS->Visible) { // MACS ?>
    <tr id="r_MACS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_MACS"><template id="tpc_view_ivf_treatment_plan_MACS"><?= $Page->MACS->caption() ?></template></span></td>
...
<?php if ($Page->Technique->Visible) { // Technique ?>
    <tr id="r_Technique">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Technique"><template id="tpc_view_ivf_treatment_plan_Technique"><?= $Page->Technique->caption() ?></template></span></td>
...
<?php if ($Page->PgdPlanning->Visible) { // PgdPlanning ?>
    <tr id="r_PgdPlanning">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_PgdPlanning"><template id="tpc_view_ivf_treatment_plan_PgdPlanning"><?= $Page->PgdPlanning->caption() ?></template></span></td>
...
<?php if ($Page->IMSI->Visible) { // IMSI ?>
    <tr id="r_IMSI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_IMSI"><template id="tpc_view_ivf_treatment_plan_IMSI"><?= $Page->IMSI->caption() ?></template></span></td>
...
<?php if ($Page->SequentialCulture->Visible) { // SequentialCulture ?>
    <tr id="r_SequentialCulture">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_SequentialCulture"><template id="tpc_view_ivf_treatment_plan_SequentialCulture"><?= $Page->SequentialCulture->caption() ?></template></span></td>
...
<?php if ($Page->TimeLapse->Visible) { // TimeLapse ?>
    <tr id="r_TimeLapse">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TimeLapse"><template id="tpc_view_ivf_treatment_plan_TimeLapse"><?= $Page->TimeLapse->caption() ?></template></span></td>
...
<?php if ($Page->AH->Visible) { // AH ?>
    <tr id="r_AH">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_AH"><template id="tpc_view_ivf_treatment_plan_AH"><?= $Page->AH->caption() ?></template></span></td>
...
<?php if ($Page->Weight->Visible) { // Weight ?>
    <tr id="r_Weight">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Weight"><template id="tpc_view_ivf_treatment_plan_Weight"><?= $Page->Weight->caption() ?></template></span></td>
...
<?php if ($Page->BMI->Visible) { // BMI ?>
    <tr id="r_BMI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_BMI"><template id="tpc_view_ivf_treatment_plan_BMI"><?= $Page->BMI->caption() ?></template></span></td>
...
<?php if ($Page->MaleIndications->Visible) { // MaleIndications ?>
    <tr id="r_MaleIndications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_MaleIndications"><template id="tpc_view_ivf_treatment_plan_MaleIndications"><?= $Page->MaleIndications->caption() ?></template></span></td>
...
<?php if ($Page->FemaleIndications->Visible) { // FemaleIndications ?>
    <tr id="r_FemaleIndications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_FemaleIndications"><template id="tpc_view_ivf_treatment_plan_FemaleIndications"><?= $Page->FemaleIndications->caption() ?></template></span></td>
...
<?php if ($Page->UseOfThe->Visible) { // UseOfThe ?>
    <tr id="r_UseOfThe">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_UseOfThe"><template id="tpc_view_ivf_treatment_plan_UseOfThe"><?= $Page->UseOfThe->caption() ?></template></span></td>
...
<?php if ($Page->Ectopic->Visible) { // Ectopic ?>
    <tr id="r_Ectopic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Ectopic"><template id="tpc_view_ivf_treatment_plan_Ectopic"><?= $Page->Ectopic->caption() ?></template></span></td>
...
<?php if ($Page->Heterotopic->Visible) { // Heterotopic ?>
    <tr id="r_Heterotopic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Heterotopic"><template id="tpc_view_ivf_treatment_plan_Heterotopic"><?= $Page->Heterotopic->caption() ?></template></span></td>
...
<?php if ($Page->TransferDFE->Visible) { // TransferDFE ?>
    <tr id="r_TransferDFE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TransferDFE"><template id="tpc_view_ivf_treatment_plan_TransferDFE"><?= $Page->TransferDFE->caption() ?></template></span></td>
...
<?php if ($Page->Evolutive->Visible) { // Evolutive ?>
    <tr id="r_Evolutive">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Evolutive"><template id="tpc_view_ivf_treatment_plan_Evolutive"><?= $Page->Evolutive->caption() ?></template></span></td>
...
<?php if ($Page->Number->Visible) { // Number ?>
    <tr id="r_Number">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_Number"><template id="tpc_view_ivf_treatment_plan_Number"><?= $Page->Number->caption() ?></template></span></td>
...
<?php if ($Page->SequentialCult->Visible) { // SequentialCult ?>
    <tr id="r_SequentialCult">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_SequentialCult"><template id="tpc_view_ivf_treatment_plan_SequentialCult"><?= $Page->SequentialCult->caption() ?></template></span></td>
...
<?php if ($Page->TineLapse->Visible) { // TineLapse ?>
    <tr id="r_TineLapse">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_ivf_treatment_plan_TineLapse"><template id="tpc_view_ivf_treatment_plan_TineLapse"><?= $Page->TineLapse->caption() ?></template></span></td>
...
<template id="tpm_view_ivf_treatment_planview">
<div id="ct_ViewIvfTreatmentPlanView"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_ivf_treatment_planview", "tpm_view_ivf_treatment_planview", "view_ivf_treatment_planview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
