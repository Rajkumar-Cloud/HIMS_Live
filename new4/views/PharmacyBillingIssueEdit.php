...
// Page object
$PharmacyBillingIssueEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_billing_issueedit;
loadjs.ready("head", function () {
    ...
    fpharmacy_billing_issueedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpharmacy_billing_issueedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpharmacy_billing_issueedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_billing_issueedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpharmacy_billing_issueedit.lists.Reception = <?= $Page->Reception->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.ModeofPayment = <?= $Page->ModeofPayment->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.RIDNO = <?= $Page->RIDNO->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.CId = <?= $Page->CId->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.PatId = <?= $Page->PatId->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.RefferedBy = <?= $Page->RefferedBy->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.DrID = <?= $Page->DrID->toClientList($Page) ?>;
    fpharmacy_billing_issueedit.lists.ReportHeader = <?= $Page->ReportHeader->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_billing_issueedit" id="fpharmacy_billing_issueedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_pharmacy_billing_issue_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_issue_id"><span id="el_pharmacy_billing_issue_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span></template>
<input type="hidden" data-table="pharmacy_billing_issue" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->Reception->Visible) { // Reception ?>
    <div id="r_Reception" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Reception" for="x_Reception" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Reception"><?= $Page->Reception->caption() ?><?= $Page->Reception->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="pharmacy_billing_issue" data-field="x_Reception" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->Reception->displayValueSeparatorAttribute() ?>" name="x_Reception" id="x_Reception" value="<?= $Page->Reception->CurrentValue ?>"<?= $Page->Reception->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <div id="r_PatientId" class="form-group row">
        <label id="elh_pharmacy_billing_issue_PatientId" for="x_PatientId" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_PatientId"><?= $Page->PatientId->caption() ?><?= $Page->PatientId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientId->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_issue_PatientId"><span id="el_pharmacy_billing_issue_PatientId">
<input type="<?= $Page->PatientId->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PatientId->getPlaceHolder()) ?>" value="<?= $Page->PatientId->EditValue ?>"<?= $Page->PatientId->editAttributes() ?> aria-describedby="x_PatientId_help">
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <div id="r_mrnno" class="form-group row">
        <label id="elh_pharmacy_billing_issue_mrnno" for="x_mrnno" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_mrnno"><?= $Page->mrnno->caption() ?><?= $Page->mrnno->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->mrnno->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->mrnno->getPlaceHolder()) ?>" value="<?= $Page->mrnno->EditValue ?>"<?= $Page->mrnno->editAttributes() ?> aria-describedby="x_mrnno_help">
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <div id="r_PatientName" class="form-group row">
        <label id="elh_pharmacy_billing_issue_PatientName" for="x_PatientName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_PatientName"><?= $Page->PatientName->caption() ?><?= $Page->PatientName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <div id="r_Age" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Age" for="x_Age" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Age"><?= $Page->Age->caption() ?><?= $Page->Age->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Age->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_issue_Age"><span id="el_pharmacy_billing_issue_Age">
<input type="<?= $Page->Age->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Age" name="x_Age" id="x_Age" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Age->getPlaceHolder()) ?>" value="<?= $Page->Age->EditValue ?>"<?= $Page->Age->editAttributes() ?> aria-describedby="x_Age_help">
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <div id="r_Gender" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Gender" for="x_Gender" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Gender"><?= $Page->Gender->caption() ?><?= $Page->Gender->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Gender->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_issue_Gender"><span id="el_pharmacy_billing_issue_Gender">
<input type="<?= $Page->Gender->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Gender" name="x_Gender" id="x_Gender" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Gender->getPlaceHolder()) ?>" value="<?= $Page->Gender->EditValue ?>"<?= $Page->Gender->editAttributes() ?> aria-describedby="x_Gender_help">
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <div id="r_profilePic" class="form-group row">
        <label id="elh_pharmacy_billing_issue_profilePic" for="x_profilePic" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_profilePic"><?= $Page->profilePic->caption() ?><?= $Page->profilePic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="pharmacy_billing_issue" data-field="x_profilePic" name="x_profilePic" id="x_profilePic" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->profilePic->getPlaceHolder()) ?>"<?= $Page->profilePic->editAttributes() ?> aria-describedby="x_profilePic_help"><?= $Page->profilePic->EditValue ?></textarea>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <div id="r_Mobile" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Mobile" for="x_Mobile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Mobile"><?= $Page->Mobile->caption() ?><?= $Page->Mobile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Mobile->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Mobile" name="x_Mobile" id="x_Mobile" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Mobile->getPlaceHolder()) ?>" value="<?= $Page->Mobile->EditValue ?>"<?= $Page->Mobile->editAttributes() ?> aria-describedby="x_Mobile_help">
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
    <div id="r_IP_OP" class="form-group row">
        <label id="elh_pharmacy_billing_issue_IP_OP" for="x_IP_OP" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_IP_OP"><?= $Page->IP_OP->caption() ?><?= $Page->IP_OP->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->IP_OP->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_IP_OP" name="x_IP_OP" id="x_IP_OP" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->IP_OP->getPlaceHolder()) ?>" value="<?= $Page->IP_OP->EditValue ?>"<?= $Page->IP_OP->editAttributes() ?> aria-describedby="x_IP_OP_help">
...
<?php if ($Page->Doctor->Visible) { // Doctor ?>
    <div id="r_Doctor" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Doctor" for="x_Doctor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Doctor"><?= $Page->Doctor->caption() ?><?= $Page->Doctor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Doctor->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Doctor" name="x_Doctor" id="x_Doctor" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Doctor->getPlaceHolder()) ?>" value="<?= $Page->Doctor->EditValue ?>"<?= $Page->Doctor->editAttributes() ?> aria-describedby="x_Doctor_help">
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
    <div id="r_voucher_type" class="form-group row">
        <label id="elh_pharmacy_billing_issue_voucher_type" for="x_voucher_type" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_voucher_type"><?= $Page->voucher_type->caption() ?><?= $Page->voucher_type->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Details->Visible) { // Details ?>
    <div id="r_Details" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Details" for="x_Details" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Details"><?= $Page->Details->caption() ?><?= $Page->Details->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Details->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Details" name="x_Details" id="x_Details" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Details->getPlaceHolder()) ?>" value="<?= $Page->Details->EditValue ?>"<?= $Page->Details->editAttributes() ?> aria-describedby="x_Details_help">
...
<?php if ($Page->ModeofPayment->Visible) { // ModeofPayment ?>
    <div id="r_ModeofPayment" class="form-group row">
        <label id="elh_pharmacy_billing_issue_ModeofPayment" for="x_ModeofPayment" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_ModeofPayment"><?= $Page->ModeofPayment->caption() ?><?= $Page->ModeofPayment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <div id="r_Amount" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Amount" for="x_Amount" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Amount"><?= $Page->Amount->caption() ?><?= $Page->Amount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Amount->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_issue_Amount"><span id="el_pharmacy_billing_issue_Amount">
<input type="<?= $Page->Amount->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Amount" name="x_Amount" id="x_Amount" size="30" placeholder="<?= HtmlEncode($Page->Amount->getPlaceHolder()) ?>" value="<?= $Page->Amount->EditValue ?>"<?= $Page->Amount->editAttributes() ?> aria-describedby="x_Amount_help">
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
    <div id="r_AnyDues" class="form-group row">
        <label id="elh_pharmacy_billing_issue_AnyDues" for="x_AnyDues" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_AnyDues"><?= $Page->AnyDues->caption() ?><?= $Page->AnyDues->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->AnyDues->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_AnyDues" name="x_AnyDues" id="x_AnyDues" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->AnyDues->getPlaceHolder()) ?>" value="<?= $Page->AnyDues->EditValue ?>"<?= $Page->AnyDues->editAttributes() ?> aria-describedby="x_AnyDues_help">
...
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
    <div id="r_RealizationAmount" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RealizationAmount" for="x_RealizationAmount" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RealizationAmount"><?= $Page->RealizationAmount->caption() ?><?= $Page->RealizationAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
    <div id="r_RealizationStatus" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RealizationStatus" for="x_RealizationStatus" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RealizationStatus"><?= $Page->RealizationStatus->caption() ?><?= $Page->RealizationStatus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
    <div id="r_RealizationRemarks" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RealizationRemarks" for="x_RealizationRemarks" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RealizationRemarks"><?= $Page->RealizationRemarks->caption() ?><?= $Page->RealizationRemarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
    <div id="r_RealizationBatchNo" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RealizationBatchNo" for="x_RealizationBatchNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RealizationBatchNo"><?= $Page->RealizationBatchNo->caption() ?><?= $Page->RealizationBatchNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
    <div id="r_RealizationDate" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RealizationDate" for="x_RealizationDate" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RealizationDate"><?= $Page->RealizationDate->caption() ?><?= $Page->RealizationDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <div id="r_RIDNO" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RIDNO" for="x_RIDNO" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RIDNO"><?= $Page->RIDNO->caption() ?><?= $Page->RIDNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="pharmacy_billing_issue" data-field="x_RIDNO" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->RIDNO->displayValueSeparatorAttribute() ?>" name="x_RIDNO" id="x_RIDNO" value="<?= $Page->RIDNO->CurrentValue ?>"<?= $Page->RIDNO->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <div id="r_TidNo" class="form-group row">
        <label id="elh_pharmacy_billing_issue_TidNo" for="x_TidNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_TidNo"><?= $Page->TidNo->caption() ?><?= $Page->TidNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->TidNo->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_TidNo" name="x_TidNo" id="x_TidNo" size="30" placeholder="<?= HtmlEncode($Page->TidNo->getPlaceHolder()) ?>" value="<?= $Page->TidNo->EditValue ?>"<?= $Page->TidNo->editAttributes() ?> aria-describedby="x_TidNo_help">
...
<?php if ($Page->CId->Visible) { // CId ?>
    <div id="r_CId" class="form-group row">
        <label id="elh_pharmacy_billing_issue_CId" for="x_CId" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_CId"><?= $Page->CId->caption() ?><?= $Page->CId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="pharmacy_billing_issue" data-field="x_CId" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->CId->displayValueSeparatorAttribute() ?>" name="x_CId" id="x_CId" value="<?= $Page->CId->CurrentValue ?>"<?= $Page->CId->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <div id="r_PartnerName" class="form-group row">
        <label id="elh_pharmacy_billing_issue_PartnerName" for="x_PartnerName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_PartnerName"><?= $Page->PartnerName->caption() ?><?= $Page->PartnerName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
    <div id="r_PayerType" class="form-group row">
        <label id="elh_pharmacy_billing_issue_PayerType" for="x_PayerType" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_PayerType"><?= $Page->PayerType->caption() ?><?= $Page->PayerType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PayerType->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_PayerType" name="x_PayerType" id="x_PayerType" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PayerType->getPlaceHolder()) ?>" value="<?= $Page->PayerType->EditValue ?>"<?= $Page->PayerType->editAttributes() ?> aria-describedby="x_PayerType_help">
...
<?php if ($Page->Dob->Visible) { // Dob ?>
    <div id="r_Dob" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Dob" for="x_Dob" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Dob"><?= $Page->Dob->caption() ?><?= $Page->Dob->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Dob->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Dob" name="x_Dob" id="x_Dob" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Dob->getPlaceHolder()) ?>" value="<?= $Page->Dob->EditValue ?>"<?= $Page->Dob->editAttributes() ?> aria-describedby="x_Dob_help">
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <div id="r_Currency" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Currency" for="x_Currency" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Currency"><?= $Page->Currency->caption() ?><?= $Page->Currency->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Currency->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Currency" name="x_Currency" id="x_Currency" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Currency->getPlaceHolder()) ?>" value="<?= $Page->Currency->EditValue ?>"<?= $Page->Currency->editAttributes() ?> aria-describedby="x_Currency_help">
...
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
    <div id="r_DiscountRemarks" class="form-group row">
        <label id="elh_pharmacy_billing_issue_DiscountRemarks" for="x_DiscountRemarks" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_DiscountRemarks"><?= $Page->DiscountRemarks->caption() ?><?= $Page->DiscountRemarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <div id="r_Remarks" class="form-group row">
        <label id="elh_pharmacy_billing_issue_Remarks" for="x_Remarks" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_Remarks"><?= $Page->Remarks->caption() ?><?= $Page->Remarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Remarks->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_issue_Remarks"><span id="el_pharmacy_billing_issue_Remarks">
<input type="<?= $Page->Remarks->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_Remarks" name="x_Remarks" id="x_Remarks" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Remarks->getPlaceHolder()) ?>" value="<?= $Page->Remarks->EditValue ?>"<?= $Page->Remarks->editAttributes() ?> aria-describedby="x_Remarks_help">
...
<?php if ($Page->PatId->Visible) { // PatId ?>
    <div id="r_PatId" class="form-group row">
        <label id="elh_pharmacy_billing_issue_PatId" for="x_PatId" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_PatId"><?= $Page->PatId->caption() ?><?= $Page->PatId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="pharmacy_billing_issue" data-field="x_PatId" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->PatId->displayValueSeparatorAttribute() ?>" name="x_PatId" id="x_PatId" value="<?= $Page->PatId->CurrentValue ?>"<?= $Page->PatId->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
    <div id="r_DrDepartment" class="form-group row">
        <label id="elh_pharmacy_billing_issue_DrDepartment" for="x_DrDepartment" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_DrDepartment"><?= $Page->DrDepartment->caption() ?><?= $Page->DrDepartment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
    <div id="r_RefferedBy" class="form-group row">
        <label id="elh_pharmacy_billing_issue_RefferedBy" for="x_RefferedBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_RefferedBy"><?= $Page->RefferedBy->caption() ?><?= $Page->RefferedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BillNumber->Visible) { // BillNumber ?>
    <div id="r_BillNumber" class="form-group row">
        <label id="elh_pharmacy_billing_issue_BillNumber" for="x_BillNumber" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_BillNumber"><?= $Page->BillNumber->caption() ?><?= $Page->BillNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <div id="r_CardNumber" class="form-group row">
        <label id="elh_pharmacy_billing_issue_CardNumber" for="x_CardNumber" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_CardNumber"><?= $Page->CardNumber->caption() ?><?= $Page->CardNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <div id="r_BankName" class="form-group row">
        <label id="elh_pharmacy_billing_issue_BankName" for="x_BankName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_BankName"><?= $Page->BankName->caption() ?><?= $Page->BankName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->BankName->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_BankName" name="x_BankName" id="x_BankName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->BankName->getPlaceHolder()) ?>" value="<?= $Page->BankName->EditValue ?>"<?= $Page->BankName->editAttributes() ?> aria-describedby="x_BankName_help">
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <div id="r_DrID" class="form-group row">
        <label id="elh_pharmacy_billing_issue_DrID" for="x_DrID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_DrID"><?= $Page->DrID->caption() ?><?= $Page->DrID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="pharmacy_billing_issue" data-field="x_DrID" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->DrID->displayValueSeparatorAttribute() ?>" name="x_DrID" id="x_DrID" value="<?= $Page->DrID->CurrentValue ?>"<?= $Page->DrID->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
    <div id="r_BillStatus" class="form-group row">
        <label id="elh_pharmacy_billing_issue_BillStatus" for="x_BillStatus" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_BillStatus"><?= $Page->BillStatus->caption() ?><?= $Page->BillStatus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->BillStatus->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_BillStatus" name="x_BillStatus" id="x_BillStatus" size="30" placeholder="<?= HtmlEncode($Page->BillStatus->getPlaceHolder()) ?>" value="<?= $Page->BillStatus->EditValue ?>"<?= $Page->BillStatus->editAttributes() ?> aria-describedby="x_BillStatus_help">
...
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
    <div id="r_ReportHeader" class="form-group row">
        <label id="elh_pharmacy_billing_issue_ReportHeader" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_ReportHeader"><?= $Page->ReportHeader->caption() ?><?= $Page->ReportHeader->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_ReportHeader">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="pharmacy_billing_issue" data-field="x_ReportHeader" name="x_ReportHeader" id="x_ReportHeader"<?= $Page->ReportHeader->editAttributes() ?>>
...
<?php if ($Page->PharID->Visible) { // PharID ?>
    <div id="r_PharID" class="form-group row">
        <label id="elh_pharmacy_billing_issue_PharID" for="x_PharID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_billing_issue_PharID"><?= $Page->PharID->caption() ?><?= $Page->PharID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PharID->getInputTextType() ?>" data-table="pharmacy_billing_issue" data-field="x_PharID" name="x_PharID" id="x_PharID" size="30" placeholder="<?= HtmlEncode($Page->PharID->getPlaceHolder()) ?>" value="<?= $Page->PharID->EditValue ?>"<?= $Page->PharID->editAttributes() ?> aria-describedby="x_PharID_help">
...
<template id="tpm_pharmacy_billing_issueedit">
<div id="ct_PharmacyBillingIssueEdit"><style>
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_pharmacy_billing_issue_PatId"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_PatId"></slot></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_pharmacy_billing_issue_RIDNO"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_RIDNO"></slot></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_pharmacy_billing_issue_CId"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_CId"></slot></h3>
	</div>
</div>
<div class="row">
	<div class="col-12">
...
<table class="ew-table">
	 <tbody>
		<tr>
		<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_PatientId"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_PatientId"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_PatientName"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_PatientName"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Mobile"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Mobile"></slot></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Dob"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Dob"></slot></td>
		<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Age"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Age"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Gender"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Gender"></slot></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_PartnerName"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_PartnerName"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_PayerType"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_PayerType"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_RefferedBy"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_RefferedBy"></slot></td>
			<td></td>
		</tr>
		 <tr>
		 	<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_DrID"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_DrID"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Doctor"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Doctor"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_DrDepartment"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_DrDepartment"></slot></td>
		</tr>
	</tbody>
</table>
			  <!-- /.card-body -->
...
<slot class="ew-slot" name="tpc_pharmacy_billing_issue_ReportHeader"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_ReportHeader"></slot>
<div class="row">
	<div class="col-12">
		<div class="card card-danger">
...
<table class="ew-table">
	 <tbody>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_ModeofPayment"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_ModeofPayment"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Amount"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Amount"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_AnyDues"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_AnyDues"></slot></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_DiscountRemarks"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_DiscountRemarks"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_Remarks"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_Remarks"></slot></td>
			<td></td>
		</tr>
	</tbody>
</table>
...
<table class="ew-table">
	 <tbody>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_CardNumber"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_CardNumber"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_issue_BankName"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_issue_BankName"></slot></td>
		</tr>
	</tbody>
</table>
			</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_billing_issueedit", "tpm_pharmacy_billing_issueedit", "pharmacy_billing_issueedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
...
loadjs.ready("load", function () {
    // Startup script
    function addtotalSum(){for(var e=0,a=1;a<40;a++)try{var t=document.getElementById("x"+a+"_SubTotal");""!=t.value&&(e=parseInt(e)+parseInt(t.value))}catch(e){}document.getElementById("x_Amount").value=e}document.getElementById("viewBankName").style.display="none",$("[data-name='PRC']").hide(),$("[data-name='UR']").hide(),$("[data-name='Product']").hide(),$("[data-name='baid']").hide(),$("[data-name='isdate']").hide(),$("[data-name='PCGST']").hide(),$("[data-name='PSGST']").hide(),$("[data-name='PUnit']").hide(),$("[data-name='PurRate']").hide(),$("[data-name='PurValue']").hide(),$("[data-name='SCGST']").hide(),$("[data-name='SSGST']").hide(),$("[data-name='SUnit']").hide();var HospitalIDDD="<?php echo HospitalID(); ?>",grpButton='<input type="hidden" id="HospitalIDDD" name="HospitalIDDD" value="'+HospitalIDDD+'">',searchfrm=document.getElementById("tbl_view_patient_servicesgrid"),node=document.createElement("div");node.innerHTML=grpButton,searchfrm.appendChild(node);
});
</script>
