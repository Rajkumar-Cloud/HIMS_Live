...
$Page->showMessage();
?>
<form name="fstore_storemastdelete" id="fstore_storemastdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->OV->Visible) { // OV ?>
        <th class="<?= $Page->OV->headerCellClass() ?>"><span id="elh_store_storemast_OV" class="store_storemast_OV"><?= $Page->OV->caption() ?></span></th>
<?php } ?>
<?php if ($Page->LATESTOV->Visible) { // LATESTOV ?>
        <th class="<?= $Page->LATESTOV->headerCellClass() ?>"><span id="elh_store_storemast_LATESTOV" class="store_storemast_LATESTOV"><?= $Page->LATESTOV->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ITEMTYPE->Visible) { // ITEMTYPE ?>
        <th class="<?= $Page->ITEMTYPE->headerCellClass() ?>"><span id="elh_store_storemast_ITEMTYPE" class="store_storemast_ITEMTYPE"><?= $Page->ITEMTYPE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ROWID->Visible) { // ROWID ?>
        <th class="<?= $Page->ROWID->headerCellClass() ?>"><span id="elh_store_storemast_ROWID" class="store_storemast_ROWID"><?= $Page->ROWID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MOVED->Visible) { // MOVED ?>
        <th class="<?= $Page->MOVED->headerCellClass() ?>"><span id="elh_store_storemast_MOVED" class="store_storemast_MOVED"><?= $Page->MOVED->caption() ?></span></th>
<?php } ?>
<?php if ($Page->NEWTAX->Visible) { // NEWTAX ?>
        <th class="<?= $Page->NEWTAX->headerCellClass() ?>"><span id="elh_store_storemast_NEWTAX" class="store_storemast_NEWTAX"><?= $Page->NEWTAX->caption() ?></span></th>
<?php } ?>
<?php if ($Page->HSNCODE->Visible) { // HSNCODE ?>
        <th class="<?= $Page->HSNCODE->headerCellClass() ?>"><span id="elh_store_storemast_HSNCODE" class="store_storemast_HSNCODE"><?= $Page->HSNCODE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->OLDTAX->Visible) { // OLDTAX ?>
        <th class="<?= $Page->OLDTAX->headerCellClass() ?>"><span id="elh_store_storemast_OLDTAX" class="store_storemast_OLDTAX"><?= $Page->OLDTAX->caption() ?></span></th>
<?php } ?>
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <th class="<?= $Page->StoreID->headerCellClass() ?>"><span id="elh_store_storemast_StoreID" class="store_storemast_StoreID"><?= $Page->StoreID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_store_storemast_OV" class="store_storemast_OV">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_LATESTOV" class="store_storemast_LATESTOV">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_ITEMTYPE" class="store_storemast_ITEMTYPE">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_ROWID" class="store_storemast_ROWID">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_MOVED" class="store_storemast_MOVED">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_NEWTAX" class="store_storemast_NEWTAX">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_HSNCODE" class="store_storemast_HSNCODE">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_OLDTAX" class="store_storemast_OLDTAX">
...
<span id="el<?= $Page->RowCount ?>_store_storemast_StoreID" class="store_storemast_StoreID">
