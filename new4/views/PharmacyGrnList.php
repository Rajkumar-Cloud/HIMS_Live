...
loadjs.ready("head", function () {
    ...
    fpharmacy_grnlistsrch.addFields([
        ["id", [], fields.id.isInvalid],
        ["GRNNO", [], fields.GRNNO.isInvalid],
        ["DT", [ew.Validators.datetime(7)], fields.DT.isInvalid],
        ["y_DT", [ew.Validators.between], false],
        ...
        ["BILLDT", [ew.Validators.datetime(0)], fields.BILLDT.isInvalid],
        ["y_BILLDT", [ew.Validators.between], false],
        ["BillTotalValue", [], fields.BillTotalValue.isInvalid],
        ["GRNTotalValue", [], fields.GRNTotalValue.isInvalid],
        ["BillDiscount", [], fields.BillDiscount.isInvalid],
        ["GrnValue", [], fields.GrnValue.isInvalid],
    ...
    // Set invalid fields
    $(function() {
        fpharmacy_grnlistsrch.setInvalid();
    });

    // Validate form
    fpharmacy_grnlistsrch.validate = function () {
    ...
    // Form_CustomValidate
    fpharmacy_grnlistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_grnlistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "pharmacy_payment") {
    if ($Page->MasterRecordExists) {
        include_once "views/PharmacyPaymentMaster.php";
    }
}
?>
<?php } ?>
...
<form name="fpharmacy_grnlistsrch" id="fpharmacy_grnlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<div id="xsr_<?= $Page->SearchRowCount ?>" class="ew-row d-sm-flex">
    ...
    <div id="xsc_DT" class="ew-cell form-group">
        <label for="x_DT" class="ew-search-caption ew-label"><?= $Page->DT->caption() ?></label>
        <span class="ew-search-operator">
<select name="z_DT" id="z_DT" class="custom-select" onchange="ew.searchOperatorChanged(this);">
<option value="="<?= $Page->DT->AdvancedSearch->SearchOperator == "=" ? " selected" : "" ?>><?= $Language->phrase("EQUAL") ?></option>
<option value="&lt;&gt;"<?= $Page->DT->AdvancedSearch->SearchOperator == "<>" ? " selected" : "" ?>><?= $Language->phrase("<>") ?></option>
<option value="&lt;"<?= $Page->DT->AdvancedSearch->SearchOperator == "<" ? " selected" : "" ?>><?= $Language->phrase("<") ?></option>
<option value="&lt;="<?= $Page->DT->AdvancedSearch->SearchOperator == "<=" ? " selected" : "" ?>><?= $Language->phrase("<=") ?></option>
<option value="&gt;"<?= $Page->DT->AdvancedSearch->SearchOperator == ">" ? " selected" : "" ?>><?= $Language->phrase(">") ?></option>
<option value="&gt;="<?= $Page->DT->AdvancedSearch->SearchOperator == ">=" ? " selected" : "" ?>><?= $Language->phrase(">=") ?></option>
<option value="IS NULL"<?= $Page->DT->AdvancedSearch->SearchOperator == "IS NULL" ? " selected" : "" ?>><?= $Language->phrase("IS NULL") ?></option>
<option value="IS NOT NULL"<?= $Page->DT->AdvancedSearch->SearchOperator == "IS NOT NULL" ? " selected" : "" ?>><?= $Language->phrase("IS NOT NULL") ?></option>
<option value="BETWEEN"<?= $Page->DT->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
</select>
</span>
        <span id="el_pharmacy_grn_DT" class="ew-search-field">
<input type="<?= $Page->DT->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_DT" data-format="7" name="x_DT" id="x_DT" placeholder="<?= HtmlEncode($Page->DT->getPlaceHolder()) ?>" value="<?= $Page->DT->EditValue ?>"<?= $Page->DT->editAttributes() ?>>
...
<script>
loadjs.ready(["fpharmacy_grnlistsrch", "datetimepicker"], function() {
...
<?php } ?>
        ...
        <span id="el2_pharmacy_grn_DT" class="ew-search-field2 d-none">
<input type="<?= $Page->DT->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_DT" data-format="7" name="y_DT" id="y_DT" placeholder="<?= HtmlEncode($Page->DT->getPlaceHolder()) ?>" value="<?= $Page->DT->EditValue2 ?>"<?= $Page->DT->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DT->getErrorMessage(false) ?></div>
<?php if (!$Page->DT->ReadOnly && !$Page->DT->Disabled && !isset($Page->DT->EditAttrs["readonly"]) && !isset($Page->DT->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fpharmacy_grnlistsrch", "datetimepicker"], function() {
...
<input type="hidden" name="z_Customername" id="z_Customername" value="LIKE">
        ...
        <span id="el_pharmacy_grn_Customername" class="ew-search-field">
<input type="<?= $Page->Customername->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_Customername" name="x_Customername" id="x_Customername" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Customername->getPlaceHolder()) ?>" value="<?= $Page->Customername->EditValue ?>"<?= $Page->Customername->editAttributes() ?>>
...
<div id="xsr_<?= $Page->SearchRowCount ?>" class="ew-row d-sm-flex">
    ...
    <div id="xsc_BILLNO" class="ew-cell form-group">
        <label for="x_BILLNO" class="ew-search-caption ew-label"><?= $Page->BILLNO->caption() ?></label>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_BILLNO" id="z_BILLNO" value="LIKE">
</span>
        <span id="el_pharmacy_grn_BILLNO" class="ew-search-field">
<input type="<?= $Page->BILLNO->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_BILLNO" name="x_BILLNO" id="x_BILLNO" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->BILLNO->getPlaceHolder()) ?>" value="<?= $Page->BILLNO->EditValue ?>"<?= $Page->BILLNO->editAttributes() ?>>
...
<div id="xsr_<?= $Page->SearchRowCount ?>" class="ew-row d-sm-flex">
    ...
    <div id="xsc_BILLDT" class="ew-cell form-group">
        <label for="x_BILLDT" class="ew-search-caption ew-label"><?= $Page->BILLDT->caption() ?></label>
        <span class="ew-search-operator">
<select name="z_BILLDT" id="z_BILLDT" class="custom-select" onchange="ew.searchOperatorChanged(this);">
<option value="="<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "=" ? " selected" : "" ?>><?= $Language->phrase("EQUAL") ?></option>
<option value="&lt;&gt;"<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "<>" ? " selected" : "" ?>><?= $Language->phrase("<>") ?></option>
<option value="&lt;"<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "<" ? " selected" : "" ?>><?= $Language->phrase("<") ?></option>
<option value="&lt;="<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "<=" ? " selected" : "" ?>><?= $Language->phrase("<=") ?></option>
<option value="&gt;"<?= $Page->BILLDT->AdvancedSearch->SearchOperator == ">" ? " selected" : "" ?>><?= $Language->phrase(">") ?></option>
<option value="&gt;="<?= $Page->BILLDT->AdvancedSearch->SearchOperator == ">=" ? " selected" : "" ?>><?= $Language->phrase(">=") ?></option>
<option value="IS NULL"<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "IS NULL" ? " selected" : "" ?>><?= $Language->phrase("IS NULL") ?></option>
<option value="IS NOT NULL"<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "IS NOT NULL" ? " selected" : "" ?>><?= $Language->phrase("IS NOT NULL") ?></option>
<option value="BETWEEN"<?= $Page->BILLDT->AdvancedSearch->SearchOperator == "BETWEEN" ? " selected" : "" ?>><?= $Language->phrase("BETWEEN") ?></option>
</select>
</span>
        <span id="el_pharmacy_grn_BILLDT" class="ew-search-field">
<input type="<?= $Page->BILLDT->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_BILLDT" name="x_BILLDT" id="x_BILLDT" placeholder="<?= HtmlEncode($Page->BILLDT->getPlaceHolder()) ?>" value="<?= $Page->BILLDT->EditValue ?>"<?= $Page->BILLDT->editAttributes() ?>>
...
<?php } ?>
        ...
        <span class="ew-search-and d-none"><label><?= $Language->phrase("AND") ?></label></span>
        <span id="el2_pharmacy_grn_BILLDT" class="ew-search-field2 d-none">
<input type="<?= $Page->BILLDT->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_BILLDT" name="y_BILLDT" id="y_BILLDT" placeholder="<?= HtmlEncode($Page->BILLDT->getPlaceHolder()) ?>" value="<?= $Page->BILLDT->EditValue2 ?>"<?= $Page->BILLDT->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->BILLDT->getErrorMessage(false) ?></div>
<?php if (!$Page->BILLDT->ReadOnly && !$Page->BILLDT->Disabled && !isset($Page->BILLDT->EditAttrs["readonly"]) && !isset($Page->BILLDT->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fpharmacy_grnlistsrch", "datetimepicker"], function() {
...
<?php } ?>
<form name="fpharmacy_grnlist" id="fpharmacy_grnlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="pharmacy_grn">
<?php if ($Page->getCurrentMasterTable() == "pharmacy_payment" && $Page->CurrentAction) { ?>
...
?>
    <?php if ($Page->id->Visible) { // id ?>
        <td data-name="id" class="<?= $Page->id->footerCellClass() ?>"><span id="elf_pharmacy_grn_id" class="pharmacy_grn_id">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->GRNNO->Visible) { // GRNNO ?>
        <td data-name="GRNNO" class="<?= $Page->GRNNO->footerCellClass() ?>"><span id="elf_pharmacy_grn_GRNNO" class="pharmacy_grn_GRNNO">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->DT->Visible) { // DT ?>
        <td data-name="DT" class="<?= $Page->DT->footerCellClass() ?>"><span id="elf_pharmacy_grn_DT" class="pharmacy_grn_DT">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->Customername->Visible) { // Customername ?>
        <td data-name="Customername" class="<?= $Page->Customername->footerCellClass() ?>"><span id="elf_pharmacy_grn_Customername" class="pharmacy_grn_Customername">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->State->Visible) { // State ?>
        <td data-name="State" class="<?= $Page->State->footerCellClass() ?>"><span id="elf_pharmacy_grn_State" class="pharmacy_grn_State">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->Pincode->Visible) { // Pincode ?>
        <td data-name="Pincode" class="<?= $Page->Pincode->footerCellClass() ?>"><span id="elf_pharmacy_grn_Pincode" class="pharmacy_grn_Pincode">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->Phone->Visible) { // Phone ?>
        <td data-name="Phone" class="<?= $Page->Phone->footerCellClass() ?>"><span id="elf_pharmacy_grn_Phone" class="pharmacy_grn_Phone">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->BILLNO->Visible) { // BILLNO ?>
        <td data-name="BILLNO" class="<?= $Page->BILLNO->footerCellClass() ?>"><span id="elf_pharmacy_grn_BILLNO" class="pharmacy_grn_BILLNO">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->BILLDT->Visible) { // BILLDT ?>
        <td data-name="BILLDT" class="<?= $Page->BILLDT->footerCellClass() ?>"><span id="elf_pharmacy_grn_BILLDT" class="pharmacy_grn_BILLDT">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->BillTotalValue->Visible) { // BillTotalValue ?>
        <td data-name="BillTotalValue" class="<?= $Page->BillTotalValue->footerCellClass() ?>"><span id="elf_pharmacy_grn_BillTotalValue" class="pharmacy_grn_BillTotalValue">
        <span class="ew-aggregate"><?= $Language->phrase("TOTAL") ?></span><span class="ew-aggregate-value">
        <?= $Page->BillTotalValue->ViewValue ?></span>
        </span></td>
    <?php } ?>
    <?php if ($Page->GRNTotalValue->Visible) { // GRNTotalValue ?>
        <td data-name="GRNTotalValue" class="<?= $Page->GRNTotalValue->footerCellClass() ?>"><span id="elf_pharmacy_grn_GRNTotalValue" class="pharmacy_grn_GRNTotalValue">
        <span class="ew-aggregate"><?= $Language->phrase("TOTAL") ?></span><span class="ew-aggregate-value">
        <?= $Page->GRNTotalValue->ViewValue ?></span>
        </span></td>
    <?php } ?>
    <?php if ($Page->BillDiscount->Visible) { // BillDiscount ?>
        <td data-name="BillDiscount" class="<?= $Page->BillDiscount->footerCellClass() ?>"><span id="elf_pharmacy_grn_BillDiscount" class="pharmacy_grn_BillDiscount">
        <span class="ew-aggregate"><?= $Language->phrase("TOTAL") ?></span><span class="ew-aggregate-value">
        <?= $Page->BillDiscount->ViewValue ?></span>
        </span></td>
    <?php } ?>
    <?php if ($Page->GrnValue->Visible) { // GrnValue ?>
        <td data-name="GrnValue" class="<?= $Page->GrnValue->footerCellClass() ?>"><span id="elf_pharmacy_grn_GrnValue" class="pharmacy_grn_GrnValue">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->Pid->Visible) { // Pid ?>
        <td data-name="Pid" class="<?= $Page->Pid->footerCellClass() ?>"><span id="elf_pharmacy_grn_Pid" class="pharmacy_grn_Pid">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->PaymentNo->Visible) { // PaymentNo ?>
        <td data-name="PaymentNo" class="<?= $Page->PaymentNo->footerCellClass() ?>"><span id="elf_pharmacy_grn_PaymentNo" class="pharmacy_grn_PaymentNo">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->PaymentStatus->Visible) { // PaymentStatus ?>
        <td data-name="PaymentStatus" class="<?= $Page->PaymentStatus->footerCellClass() ?>"><span id="elf_pharmacy_grn_PaymentStatus" class="pharmacy_grn_PaymentStatus">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->PaidAmount->Visible) { // PaidAmount ?>
        <td data-name="PaidAmount" class="<?= $Page->PaidAmount->footerCellClass() ?>"><span id="elf_pharmacy_grn_PaidAmount" class="pharmacy_grn_PaidAmount">
        &nbsp;
        </span></td>
    <?php } ?>
<?php
