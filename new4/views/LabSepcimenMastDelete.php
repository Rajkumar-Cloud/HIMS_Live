...
<script>
if (!ew.vars.tables.lab_sepcimen_mast) ew.vars.tables.lab_sepcimen_mast = <?= JsonEncode(GetClientVar("tables", "lab_sepcimen_mast")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="flab_sepcimen_mastdelete" id="flab_sepcimen_mastdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
