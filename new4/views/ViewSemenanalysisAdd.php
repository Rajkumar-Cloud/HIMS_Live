...
// Page object
$ViewSemenanalysisAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_semenanalysisadd;
loadjs.ready("head", function () {
    ...
    fview_semenanalysisadd.addFields([
    ...
    // Form_CustomValidate
    fview_semenanalysisadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_semenanalysisadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_semenanalysisadd.lists.RIDNo = <?= $Page->RIDNo->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.PatientName = <?= $Page->PatientName->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.HusbandName = <?= $Page->HusbandName->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.RequestSample = <?= $Page->RequestSample->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.CollectionType = <?= $Page->CollectionType->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.CollectionMethod = <?= $Page->CollectionMethod->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.Medicationused = <?= $Page->Medicationused->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.DifficultiesinCollection = <?= $Page->DifficultiesinCollection->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.Homogenosity = <?= $Page->Homogenosity->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.CompleteSample = <?= $Page->CompleteSample->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.SemenOrgin = <?= $Page->SemenOrgin->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.Donor = <?= $Page->Donor->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.MACS = <?= $Page->MACS->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.SPECIFIC_PROBLEMS = <?= $Page->SPECIFIC_PROBLEMS->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.LIQUIFACTION_STORAGE = <?= $Page->LIQUIFACTION_STORAGE->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.IUI_PREP_METHOD = <?= $Page->IUI_PREP_METHOD->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.TIME_FROM_TRIGGER = <?= $Page->TIME_FROM_TRIGGER->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.COLLECTION_TO_PREPARATION = <?= $Page->COLLECTION_TO_PREPARATION->toClientList($Page) ?>;
    fview_semenanalysisadd.lists.TIME_FROM_PREP_TO_INSEM = <?= $Page->TIME_FROM_PREP_TO_INSEM->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_semenanalysisadd" id="fview_semenanalysisadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="<?= $Page->PaID->getInputTextType() ?>" data-table="view_semenanalysis" data-field="x_PaID" name="x_PaID" id="x_PaID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PaID->getPlaceHolder()) ?>" value="<?= $Page->PaID->EditValue ?>"<?= $Page->PaID->editAttributes() ?> aria-describedby="x_PaID_help">
...
<input type="<?= $Page->PaName->getInputTextType() ?>" data-table="view_semenanalysis" data-field="x_PaName" name="x_PaName" id="x_PaName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PaName->getPlaceHolder()) ?>" value="<?= $Page->PaName->EditValue ?>"<?= $Page->PaName->editAttributes() ?> aria-describedby="x_PaName_help">
...
<input type="<?= $Page->PaMobile->getInputTextType() ?>" data-table="view_semenanalysis" data-field="x_PaMobile" name="x_PaMobile" id="x_PaMobile" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PaMobile->getPlaceHolder()) ?>" value="<?= $Page->PaMobile->EditValue ?>"<?= $Page->PaMobile->editAttributes() ?> aria-describedby="x_PaMobile_help">
...
<input type="<?= $Page->PartnerID->getInputTextType() ?>" data-table="view_semenanalysis" data-field="x_PartnerID" name="x_PartnerID" id="x_PartnerID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PartnerID->getPlaceHolder()) ?>" value="<?= $Page->PartnerID->EditValue ?>"<?= $Page->PartnerID->editAttributes() ?> aria-describedby="x_PartnerID_help">
...
<input type="hidden" is="selection-list" data-table="view_semenanalysis" data-field="x_RIDNo" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->RIDNo->displayValueSeparatorAttribute() ?>" name="x_RIDNo" id="x_RIDNo" value="<?= $Page->RIDNo->CurrentValue ?>"<?= $Page->RIDNo->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fview_semenanalysisadd"], function() {
    fview_semenanalysisadd.createAutoSuggest(Object.assign({"id":"x_PatientName","forceSelect":false}, ew.vars.tables.view_semenanalysis.fields.PatientName.autoSuggestOptions));
});
</script>
...
<?php $Page->HusbandName->EditAttrs->prepend("onchange", "ew.autoFill(this);"); ?>
<div class="input-group ew-lookup-list" aria-describedby="x_HusbandName_help">
    <div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_HusbandName"><?= EmptyValue(strval($Page->HusbandName->ViewValue)) ? $Language->phrase("PleaseSelect") : $Page->HusbandName->ViewValue ?></div>
    <div class="input-group-append">
...
<input type="<?= $Page->TidNo->getInputTextType() ?>" data-table="view_semenanalysis" data-field="x_TidNo" name="x_TidNo" id="x_TidNo" size="30" placeholder="<?= HtmlEncode($Page->TidNo->getPlaceHolder()) ?>" value="<?= $Page->TidNo->EditValue ?>"<?= $Page->TidNo->editAttributes() ?> aria-describedby="x_TidNo_help">
...
<template id="tpm_view_semenanalysisadd">
<div id="ct_ViewSemenanalysisAdd"><style>
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_view_semenanalysis_HusbandName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_HusbandName"></slot></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_view_semenanalysis_RIDNo"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_RIDNo"></slot></h3>
	</div>
</div>
<div id="divCheckbox" style="display: none;">
<slot class="ew-slot" name="tpc_view_semenanalysis_PaID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PaID"></slot>
<slot class="ew-slot" name="tpc_view_semenanalysis_PaName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PaName"></slot>
<slot class="ew-slot" name="tpc_view_semenanalysis_PatientName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PatientName"></slot>
<slot class="ew-slot" name="tpc_view_semenanalysis_PaMobile"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PaMobile"></slot>
<slot class="ew-slot" name="tpc_view_semenanalysis_PartnerID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PartnerID"></slot>
<slot class="ew-slot" name="tpc_view_semenanalysis_PartnerName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PartnerName"></slot>
<slot class="ew-slot" name="tpc_view_semenanalysis_PartnerMobile"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_PartnerMobile"></slot>
</div>
<div class="row">
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_semenanalysisadd", "tpm_view_semenanalysisadd", "view_semenanalysisadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
