...
// Page object
$IvfDonorsemendetailsEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_donorsemendetailsedit;
loadjs.ready("head", function () {
    ...
    fivf_donorsemendetailsedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_donorsemendetailsedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_donorsemendetailsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_donorsemendetailsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_donorsemendetailsedit.lists.BloodGroup = <?= $Page->BloodGroup->toClientList($Page) ?>;
    fivf_donorsemendetailsedit.lists.SkinColor = <?= $Page->SkinColor->toClientList($Page) ?>;
    fivf_donorsemendetailsedit.lists.EyeColor = <?= $Page->EyeColor->toClientList($Page) ?>;
    fivf_donorsemendetailsedit.lists.HairColor = <?= $Page->HairColor->toClientList($Page) ?>;
    fivf_donorsemendetailsedit.lists.Lagency = <?= $Page->Lagency->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_donorsemendetailsedit" id="fivf_donorsemendetailsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_donorsemendetails_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_ivf_donorsemendetails_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="ivf_donorsemendetails" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
