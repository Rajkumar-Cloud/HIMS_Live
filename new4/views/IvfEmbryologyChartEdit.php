...
loadjs.ready("head", function () {
    ...
    fivf_embryology_chartedit.lists.Day0PolarBodyPosition = <?= $Page->Day0PolarBodyPosition->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day0Breakage = <?= $Page->Day0Breakage->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day0Attempts = <?= $Page->Day0Attempts->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day0SPZMorpho = <?= $Page->Day0SPZMorpho->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day0SPZLocation = <?= $Page->Day0SPZLocation->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day0SpOrgin = <?= $Page->Day0SpOrgin->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5Cryoptop = <?= $Page->Day5Cryoptop->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day1PN = <?= $Page->Day1PN->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day1PB = <?= $Page->Day1PB->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day1Pronucleus = <?= $Page->Day1Pronucleus->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day1Nucleolus = <?= $Page->Day1Nucleolus->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day1Halo = <?= $Page->Day1Halo->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day2End = <?= $Page->Day2End->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3Frag = <?= $Page->Day3Frag->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3Symmetry = <?= $Page->Day3Symmetry->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3ZP = <?= $Page->Day3ZP->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3Vacoules = <?= $Page->Day3Vacoules->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3Grade = <?= $Page->Day3Grade->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3Cryoptop = <?= $Page->Day3Cryoptop->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day3End = <?= $Page->Day3End->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day4Cryoptop = <?= $Page->Day4Cryoptop->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day4End = <?= $Page->Day4End->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5ICM = <?= $Page->Day5ICM->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5TE = <?= $Page->Day5TE->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5Observation = <?= $Page->Day5Observation->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5Collapsed = <?= $Page->Day5Collapsed->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5Vacoulles = <?= $Page->Day5Vacoulles->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day5Grade = <?= $Page->Day5Grade->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day6ICM = <?= $Page->Day6ICM->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day6TE = <?= $Page->Day6TE->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day6Observation = <?= $Page->Day6Observation->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day6Collapsed = <?= $Page->Day6Collapsed->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day6Vacoulles = <?= $Page->Day6Vacoulles->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day6Grade = <?= $Page->Day6Grade->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.EndingDay = <?= $Page->EndingDay->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.EndingGrade = <?= $Page->EndingGrade->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.EndingState = <?= $Page->EndingState->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Stage = <?= $Page->Stage->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.thawReFrozen = <?= $Page->thawReFrozen->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.vitriDay = <?= $Page->vitriDay->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.vitriGrade = <?= $Page->vitriGrade->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.thawET = <?= $Page->thawET->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.ETDifficulty = <?= $Page->ETDifficulty->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.ETEasy = <?= $Page->ETEasy->toClientList($Page) ?>;
    fivf_embryology_chartedit.lists.Day1End = <?= $Page->Day1End->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_embryology_chartedit" id="fivf_embryology_chartedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_RIDNo" data-hidden="1" name="x_RIDNo" id="x_RIDNo" value="<?= HtmlEncode($Page->RIDNo->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_Name" data-hidden="1" name="x_Name" id="x_Name" value="<?= HtmlEncode($Page->Name->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_ARTCycle" data-hidden="1" name="x_ARTCycle" id="x_ARTCycle" value="<?= HtmlEncode($Page->ARTCycle->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_TidNo" data-hidden="1" name="x_TidNo" id="x_TidNo" value="<?= HtmlEncode($Page->TidNo->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_DidNO" data-hidden="1" name="x_DidNO" id="x_DidNO" value="<?= HtmlEncode($Page->DidNO->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
