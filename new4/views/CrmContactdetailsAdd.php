...
// Page object
$CrmContactdetailsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_contactdetailsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcrm_contactdetailsadd = currentForm = new ew.Form("fcrm_contactdetailsadd", "add");
    ...
    fcrm_contactdetailsadd.addFields([
    ...
    // Form_CustomValidate
    fcrm_contactdetailsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_contactdetailsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_contactdetailsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_contactdetailsadd" id="fcrm_contactdetailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
