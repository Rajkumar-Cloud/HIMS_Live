...
// Page object
$QaqcrecordEndrologyAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fqaqcrecord_endrologyadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fqaqcrecord_endrologyadd = currentForm = new ew.Form("fqaqcrecord_endrologyadd", "add");
    ...
    fqaqcrecord_endrologyadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fqaqcrecord_endrologyadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fqaqcrecord_endrologyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fqaqcrecord_endrologyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fqaqcrecord_endrologyadd.lists.LN2_Checked = <?= $Page->LN2_Checked->toClientList($Page) ?>;
    fqaqcrecord_endrologyadd.lists.Incubator_Cleaned = <?= $Page->Incubator_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_endrologyadd.lists.LAF_Cleaned = <?= $Page->LAF_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_endrologyadd.lists.REF_Cleaned = <?= $Page->REF_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_endrologyadd.lists.Heating_Cleaned = <?= $Page->Heating_Cleaned->toClientList($Page) ?>;
    loadjs.done("fqaqcrecord_endrologyadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fqaqcrecord_endrologyadd" id="fqaqcrecord_endrologyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fqaqcrecord_endrologyadd", "datetimepicker"], function() {
