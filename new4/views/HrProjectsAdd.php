...
loadjs.ready("head", function () {
    ...
    fhr_projectsadd = currentForm = new ew.Form("fhr_projectsadd", "add");
    ...
    // Form_CustomValidate
    fhr_projectsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_projectsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhr_projectsadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("fhr_projectsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_projectsadd" id="fhr_projectsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fhr_projectsadd", "datetimepicker"], function() {
