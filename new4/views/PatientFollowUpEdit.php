...
loadjs.ready("head", function () {
    ...
    fpatient_follow_upedit.lists._Template = <?= $Page->_Template->toClientList($Page) ?>;
    fpatient_follow_upedit.lists.Template1 = <?= $Page->Template1->toClientList($Page) ?>;
    fpatient_follow_upedit.lists.Template2 = <?= $Page->Template2->toClientList($Page) ?>;
    fpatient_follow_upedit.lists.Template3 = <?= $Page->Template3->toClientList($Page) ?>;
    fpatient_follow_upedit.lists.PatientSearch = <?= $Page->PatientSearch->toClientList($Page) ?>;
    fpatient_follow_upedit.lists.DischargeAdviceMedicineTemplate = <?= $Page->DischargeAdviceMedicineTemplate->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_follow_upedit" id="fpatient_follow_upedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_patient_follow_up_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_patient_follow_up_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" data-table="patient_follow_up" data-field="x_mrnno" data-hidden="1" name="x_mrnno" id="x_mrnno" value="<?= HtmlEncode($Page->mrnno->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fpatient_follow_upedit", "editor"], function() {
	ew.createEditor("fpatient_follow_upedit", "x_FollowupAdvice", 35, 25, <?= $Page->FollowupAdvice->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fpatient_follow_upedit", "editor"], function() {
	ew.createEditor("fpatient_follow_upedit", "x_courseinhospital", 35, 4, <?= $Page->courseinhospital->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fpatient_follow_upedit", "editor"], function() {
	ew.createEditor("fpatient_follow_upedit", "x_procedurenotes", 35, 4, <?= $Page->procedurenotes->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fpatient_follow_upedit", "editor"], function() {
	ew.createEditor("fpatient_follow_upedit", "x_conditionatdischarge", 35, 4, <?= $Page->conditionatdischarge->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<input type="hidden" data-table="patient_follow_up" data-field="x_Reception" data-hidden="1" name="x_Reception" id="x_Reception" value="<?= HtmlEncode($Page->Reception->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_follow_up" data-field="x_PatientId" data-hidden="1" name="x_PatientId" id="x_PatientId" value="<?= HtmlEncode($Page->PatientId->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fpatient_follow_upedit", "editor"], function() {
	ew.createEditor("fpatient_follow_upedit", "x_DischargeAdviceMedicine", 35, 10, <?= $Page->DischargeAdviceMedicine->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_patient_follow_upedit">
<div id="ct_PatientFollowUpEdit"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_follow_upedit", "tpm_patient_follow_upedit", "patient_follow_upedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
