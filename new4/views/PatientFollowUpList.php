...
<form name="fpatient_follow_uplistsrch" id="fpatient_follow_uplistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpatient_follow_uplist" id="fpatient_follow_uplist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
