...
loadjs.ready("head", function () {
    ...
    fappointment_patienttypeeadd.lists.Type = <?= $Page->Type->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fappointment_patienttypeeadd" id="fappointment_patienttypeeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
