...
<script>
if (!ew.vars.tables.employee_address) ew.vars.tables.employee_address = <?= JsonEncode(GetClientVar("tables", "employee_address")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="femployee_addressdelete" id="femployee_addressdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th class="<?= $Page->HospID->headerCellClass() ?>"><span id="elh_employee_address_HospID" class="employee_address_HospID"><?= $Page->HospID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_employee_address_HospID" class="employee_address_HospID">
