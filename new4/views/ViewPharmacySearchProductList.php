...
// Page object
$ViewPharmacySearchProductList = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_pharmacy_search_productlist;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "list";
    fview_pharmacy_search_productlist = currentForm = new ew.Form("fview_pharmacy_search_productlist", "list");
    fview_pharmacy_search_productlist.formKeyCountName = '<?= $Page->FormKeyCountName ?>';
    loadjs.done("fview_pharmacy_search_productlist");
});
var fview_pharmacy_search_productlistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    ...
    fview_pharmacy_search_productlistsrch.addFields([
    ...
    // Set invalid fields
    $(function() {
        fview_pharmacy_search_productlistsrch.setInvalid();
    });

    // Validate form
    fview_pharmacy_search_productlistsrch.validate = function () {
    ...
    // Form_CustomValidate
    fview_pharmacy_search_productlistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_pharmacy_search_productlistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists

    // Filters
    fview_pharmacy_search_productlistsrch.filterList = <?= $Page->getFilterList() ?>;
...
<form name="fview_pharmacy_search_productlistsrch" id="fview_pharmacy_search_productlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
<div id="fview_pharmacy_search_productlistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> view_pharmacy_search_product">
<?php if (!$Page->isExport()) { ?>
...
<?php } ?>
<form name="fview_pharmacy_search_productlist" id="fview_pharmacy_search_productlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="view_pharmacy_search_product">
<div id="gmp_view_pharmacy_search_product" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
...
<?php if ($Page->PRC->Visible) { // PRC ?>
        <th data-name="PRC" class="<?= $Page->PRC->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_PRC" class="view_pharmacy_search_product_PRC"><?= $Page->renderSort($Page->PRC) ?></div></th>
<?php } ?>
<?php if ($Page->DES->Visible) { // DES ?>
        <th data-name="DES" class="<?= $Page->DES->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_DES" class="view_pharmacy_search_product_DES"><?= $Page->renderSort($Page->DES) ?></div></th>
<?php } ?>
<?php if ($Page->BATCH->Visible) { // BATCH ?>
        <th data-name="BATCH" class="<?= $Page->BATCH->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_BATCH" class="view_pharmacy_search_product_BATCH"><?= $Page->renderSort($Page->BATCH) ?></div></th>
<?php } ?>
<?php if ($Page->Stock->Visible) { // Stock ?>
        <th data-name="Stock" class="<?= $Page->Stock->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_Stock" class="view_pharmacy_search_product_Stock"><?= $Page->renderSort($Page->Stock) ?></div></th>
<?php } ?>
<?php if ($Page->EXPDT->Visible) { // EXPDT ?>
        <th data-name="EXPDT" class="<?= $Page->EXPDT->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_EXPDT" class="view_pharmacy_search_product_EXPDT"><?= $Page->renderSort($Page->EXPDT) ?></div></th>
<?php } ?>
<?php if ($Page->UNIT->Visible) { // UNIT ?>
        <th data-name="UNIT" class="<?= $Page->UNIT->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_UNIT" class="view_pharmacy_search_product_UNIT"><?= $Page->renderSort($Page->UNIT) ?></div></th>
<?php } ?>
<?php if ($Page->RT->Visible) { // RT ?>
        <th data-name="RT" class="<?= $Page->RT->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_RT" class="view_pharmacy_search_product_RT"><?= $Page->renderSort($Page->RT) ?></div></th>
<?php } ?>
<?php if ($Page->OQ->Visible) { // OQ ?>
        <th data-name="OQ" class="<?= $Page->OQ->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_OQ" class="view_pharmacy_search_product_OQ"><?= $Page->renderSort($Page->OQ) ?></div></th>
<?php } ?>
<?php if ($Page->GENNAME->Visible) { // GENNAME ?>
        <th data-name="GENNAME" class="<?= $Page->GENNAME->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_GENNAME" class="view_pharmacy_search_product_GENNAME"><?= $Page->renderSort($Page->GENNAME) ?></div></th>
<?php } ?>
<?php if ($Page->SSGST->Visible) { // SSGST ?>
        <th data-name="SSGST" class="<?= $Page->SSGST->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_SSGST" class="view_pharmacy_search_product_SSGST"><?= $Page->renderSort($Page->SSGST) ?></div></th>
<?php } ?>
<?php if ($Page->SCGST->Visible) { // SCGST ?>
        <th data-name="SCGST" class="<?= $Page->SCGST->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_SCGST" class="view_pharmacy_search_product_SCGST"><?= $Page->renderSort($Page->SCGST) ?></div></th>
<?php } ?>
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
        <th data-name="MFRCODE" class="<?= $Page->MFRCODE->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_MFRCODE" class="view_pharmacy_search_product_MFRCODE"><?= $Page->renderSort($Page->MFRCODE) ?></div></th>
<?php } ?>
<?php if ($Page->BILLDATE->Visible) { // BILLDATE ?>
        <th data-name="BILLDATE" class="<?= $Page->BILLDATE->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_BILLDATE" class="view_pharmacy_search_product_BILLDATE"><?= $Page->renderSort($Page->BILLDATE) ?></div></th>
<?php } ?>
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_id" class="view_pharmacy_search_product_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->PUnit->Visible) { // PUnit ?>
        <th data-name="PUnit" class="<?= $Page->PUnit->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_PUnit" class="view_pharmacy_search_product_PUnit"><?= $Page->renderSort($Page->PUnit) ?></div></th>
<?php } ?>
<?php if ($Page->PurRate->Visible) { // PurRate ?>
        <th data-name="PurRate" class="<?= $Page->PurRate->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_PurRate" class="view_pharmacy_search_product_PurRate"><?= $Page->renderSort($Page->PurRate) ?></div></th>
<?php } ?>
<?php if ($Page->PurValue->Visible) { // PurValue ?>
        <th data-name="PurValue" class="<?= $Page->PurValue->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_PurValue" class="view_pharmacy_search_product_PurValue"><?= $Page->renderSort($Page->PurValue) ?></div></th>
<?php } ?>
<?php if ($Page->SUnit->Visible) { // SUnit ?>
        <th data-name="SUnit" class="<?= $Page->SUnit->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_SUnit" class="view_pharmacy_search_product_SUnit"><?= $Page->renderSort($Page->SUnit) ?></div></th>
<?php } ?>
<?php if ($Page->PSGST->Visible) { // PSGST ?>
        <th data-name="PSGST" class="<?= $Page->PSGST->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_PSGST" class="view_pharmacy_search_product_PSGST"><?= $Page->renderSort($Page->PSGST) ?></div></th>
<?php } ?>
<?php if ($Page->PCGST->Visible) { // PCGST ?>
        <th data-name="PCGST" class="<?= $Page->PCGST->headerCellClass() ?>"><div id="elh_view_pharmacy_search_product_PCGST" class="view_pharmacy_search_product_PCGST"><?= $Page->renderSort($Page->PCGST) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowCount, "id" => "r" . $Page->RowCount . "_view_pharmacy_search_product", "data-rowtype" => $Page->RowType]);
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_PRC">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_DES">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_BATCH">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_Stock">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_EXPDT">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_UNIT">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_RT">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_OQ">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_GENNAME">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_SSGST">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_SCGST">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_MFRCODE">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_BILLDATE">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_id">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_PUnit">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_PurRate">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_PurValue">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_SUnit">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_PSGST">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_search_product_PCGST">
