...
$Page->showMessage();
?>
<form name="fpharmacy_purchase_requestedit" id="fpharmacy_purchase_requestedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if (in_array("pharmacy_purchase_request_items", explode(",", $Page->getCurrentDetailTable())) && $pharmacy_purchase_request_items->DetailEdit) {
?>
