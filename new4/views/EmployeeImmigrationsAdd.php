...
// Page object
$EmployeeImmigrationsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_immigrationsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_immigrationsadd = currentForm = new ew.Form("femployee_immigrationsadd", "add");
    ...
    femployee_immigrationsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_immigrationsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_immigrationsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_immigrationsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_immigrationsadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_immigrationsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_immigrationsadd" id="femployee_immigrationsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_immigrationsadd", "datetimepicker"], function() {
