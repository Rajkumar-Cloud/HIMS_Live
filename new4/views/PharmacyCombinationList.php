...
<form name="fpharmacy_combinationlistsrch" id="fpharmacy_combinationlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpharmacy_combinationlist" id="fpharmacy_combinationlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
