...
// Page object
$EmployeeOvertimeAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_overtimeadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_overtimeadd = currentForm = new ew.Form("femployee_overtimeadd", "add");
    ...
    femployee_overtimeadd.addFields([
    ...
    // Form_CustomValidate
    femployee_overtimeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_overtimeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_overtimeadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_overtimeadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_overtimeadd" id="femployee_overtimeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_overtimeadd", "datetimepicker"], function() {
