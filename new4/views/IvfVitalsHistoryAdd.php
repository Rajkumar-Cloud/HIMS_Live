...
// Page object
$IvfVitalsHistoryAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_vitals_historyadd;
loadjs.ready("head", function () {
    ...
    fivf_vitals_historyadd.addFields([
    ...
    // Form_CustomValidate
    fivf_vitals_historyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_vitals_historyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_vitals_historyadd.lists.MedicalHistory = <?= $Page->MedicalHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FBloodgroup = <?= $Page->FBloodgroup->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MBloodgroup = <?= $Page->MBloodgroup->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FBuild = <?= $Page->FBuild->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MBuild = <?= $Page->MBuild->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FSkinColor = <?= $Page->FSkinColor->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MSkinColor = <?= $Page->MSkinColor->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FEyesColor = <?= $Page->FEyesColor->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MEyesColor = <?= $Page->MEyesColor->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FHairColor = <?= $Page->FHairColor->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MhairColor = <?= $Page->MhairColor->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FhairTexture = <?= $Page->FhairTexture->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MHairTexture = <?= $Page->MHairTexture->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.FamilyHistory = <?= $Page->FamilyHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.Addictions = <?= $Page->Addictions->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.Medical = <?= $Page->Medical->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.Surgical = <?= $Page->Surgical->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.CoitalHistory = <?= $Page->CoitalHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateMenstrualHistory = <?= $Page->TemplateMenstrualHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateObstetricHistory = <?= $Page->TemplateObstetricHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateFertilityTreatmentHistory = <?= $Page->TemplateFertilityTreatmentHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateSurgeryHistory = <?= $Page->TemplateSurgeryHistory->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateFInvestigations = <?= $Page->TemplateFInvestigations->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplatePlanOfManagement = <?= $Page->TemplatePlanOfManagement->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplatePImpression = <?= $Page->TemplatePImpression->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateMedications = <?= $Page->TemplateMedications->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateSemenAnalysis = <?= $Page->TemplateSemenAnalysis->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.MaleInsvestications = <?= $Page->MaleInsvestications->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateMIMpression = <?= $Page->TemplateMIMpression->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.TemplateMalePlanOfManagement = <?= $Page->TemplateMalePlanOfManagement->toClientList($Page) ?>;
    fivf_vitals_historyadd.lists.pFamilyHistory = <?= $Page->pFamilyHistory->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_vitals_historyadd" id="fivf_vitals_historyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_MenstrualHistory", 0, 0, <?= $Page->MenstrualHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_ObstetricHistory", 0, 0, <?= $Page->ObstetricHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_FertilityTreatmentHistory", 35, 4, <?= $Page->FertilityTreatmentHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_SurgeryHistory", 35, 4, <?= $Page->SurgeryHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
loadjs.ready(["fivf_vitals_historyadd"], function() {
    fivf_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_FamilyHistory","forceSelect":false}, ew.vars.tables.ivf_vitals_history.fields.FamilyHistory.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_PInvestigations", 35, 4, <?= $Page->PInvestigations->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_Medications", 35, 4, <?= $Page->Medications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd"], function() {
    fivf_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_Surgical","forceSelect":false}, ew.vars.tables.ivf_vitals_history.fields.Surgical.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fivf_vitals_historyadd"], function() {
    fivf_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_CoitalHistory","forceSelect":false}, ew.vars.tables.ivf_vitals_history.fields.CoitalHistory.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_SemenAnalysis", 35, 4, <?= $Page->SemenAnalysis->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_MInsvestications", 35, 4, <?= $Page->MInsvestications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_PImpression", 35, 4, <?= $Page->PImpression->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_MIMpression", 35, 4, <?= $Page->MIMpression->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_PPlanOfManagement", 35, 4, <?= $Page->PPlanOfManagement->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_MPlanOfManagement", 35, 4, <?= $Page->MPlanOfManagement->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_PReadMore", 35, 4, <?= $Page->PReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_MReadMore", 35, 4, <?= $Page->MReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_vitals_historyadd"], function() {
    fivf_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_pFamilyHistory","forceSelect":false}, ew.vars.tables.ivf_vitals_history.fields.pFamilyHistory.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fivf_vitals_historyadd", "editor"], function() {
	ew.createEditor("fivf_vitals_historyadd", "x_pTemplateMedications", 35, 4, <?= $Page->pTemplateMedications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_ivf_vitals_historyadd">
<div id="ct_IvfVitalsHistoryAdd"><style>
...
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				 <div class="ew-row">
				 	<span class="ew-cellA col-6"><slot class="ew-slot" name="tpc_ivf_vitals_history_PGE"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_PGE"></slot></span>
					<span class="ew-cellA col-6"><slot class="ew-slot" name="tpc_ivf_vitals_history_PPR"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_PPR"></slot></span>
				 	<div class="row">
				 		<span class="ew-cellA col-6"><slot class="ew-slot" name="tpc_ivf_vitals_history_PBP"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_PBP"></slot></span>
				  ...
				  <div class="ew-row">
				   ...
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_vitals_history_PTHYROID"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_PTHYROID"></slot></span>
				  	...
				  	<div class="row">
				 		<span class="ew-cellA col-9"><slot class="ew-slot" name="tpc_ivf_vitals_history_AntiTPO"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_AntiTPO"></slot></span>
				 		<span class="ew-cellA col-3">IU/mL</span>
				 	</div>
				 	<div class="row">
				 		<span class="ew-cellA col-9"><slot class="ew-slot" name="tpc_ivf_vitals_history_AntiTG"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_AntiTG"></slot></span>
				 		<span class="ew-cellA col-3">IU/mL</span>
				 	</div>
			  <!-- /.card-body -->
			</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_vitals_historyadd", "tpm_ivf_vitals_historyadd", "ivf_vitals_historyadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
