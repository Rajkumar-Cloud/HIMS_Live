...
$Page->showMessage();
?>
<form name="fpatient_ot_surgery_registerdelete" id="fpatient_ot_surgery_registerdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
