...
loadjs.ready("head", function () {
    ...
    fpatient_vitalslistsrch.addFields([
    ...
    // Set invalid fields
    $(function() {
        fpatient_vitalslistsrch.setInvalid();
    });

    // Validate form
    fpatient_vitalslistsrch.validate = function () {
    ...
    // Form_CustomValidate
    fpatient_vitalslistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpatient_vitalslistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
<form name="fpatient_vitalslistsrch" id="fpatient_vitalslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpatient_vitalslist" id="fpatient_vitalslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
