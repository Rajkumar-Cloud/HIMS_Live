...
loadjs.ready("head", function () {
    ...
    fivf_art_summaryadd.lists.ARTCycle = <?= $Page->ARTCycle->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Spermorigin = <?= $Page->Spermorigin->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Origin = <?= $Page->Origin->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Status = <?= $Page->Status->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Method = <?= $Page->Method->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.InseminatinTechnique = <?= $Page->InseminatinTechnique->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.DateofET = <?= $Page->DateofET->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Reasonfornotranfer = <?= $Page->Reasonfornotranfer->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.ConsultantsSignature = <?= $Page->ConsultantsSignature->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Day1 = <?= $Page->Day1->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.CellStage1 = <?= $Page->CellStage1->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Grade1 = <?= $Page->Grade1->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.State1 = <?= $Page->State1->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Day2 = <?= $Page->Day2->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.CellStage2 = <?= $Page->CellStage2->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Grade2 = <?= $Page->Grade2->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.State2 = <?= $Page->State2->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Day3 = <?= $Page->Day3->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.CellStage3 = <?= $Page->CellStage3->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Grade3 = <?= $Page->Grade3->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.State3 = <?= $Page->State3->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Day4 = <?= $Page->Day4->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.CellStage4 = <?= $Page->CellStage4->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Grade4 = <?= $Page->Grade4->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.State4 = <?= $Page->State4->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Day5 = <?= $Page->Day5->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.CellStage5 = <?= $Page->CellStage5->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.Grade5 = <?= $Page->Grade5->toClientList($Page) ?>;
    fivf_art_summaryadd.lists.State5 = <?= $Page->State5->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_art_summaryadd" id="fivf_art_summaryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_ivf_art_summaryadd">
<div id="ct_IvfArtSummaryAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_art_summaryadd", "tpm_ivf_art_summaryadd", "ivf_art_summaryadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
