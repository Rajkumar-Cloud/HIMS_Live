...
loadjs.ready("head", function () {
    ...
    fpatient_ot_surgery_registeradd.lists.Surgeon = <?= $Page->Surgeon->toClientList($Page) ?>;
    fpatient_ot_surgery_registeradd.lists.Anaesthetist = <?= $Page->Anaesthetist->toClientList($Page) ?>;
    fpatient_ot_surgery_registeradd.lists.AsstSurgeon1 = <?= $Page->AsstSurgeon1->toClientList($Page) ?>;
    fpatient_ot_surgery_registeradd.lists.AsstSurgeon2 = <?= $Page->AsstSurgeon2->toClientList($Page) ?>;
    fpatient_ot_surgery_registeradd.lists.paediatric = <?= $Page->paediatric->toClientList($Page) ?>;
    fpatient_ot_surgery_registeradd.lists.PatientSearch = <?= $Page->PatientSearch->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_ot_surgery_registeradd" id="fpatient_ot_surgery_registeradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_patient_ot_surgery_registeradd">
<div id="ct_PatientOtSurgeryRegisterAdd"><style>
...
<slot class="ew-slot" name="tpc_patient_ot_surgery_register_PatientSearch"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_ot_surgery_register_PatientSearch"></slot>	
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_ot_surgery_registeradd", "tpm_patient_ot_surgery_registeradd", "patient_ot_surgery_registeradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
