...
loadjs.ready("head", function () {
    ...
    fbilling_voucheradd.lists.Reception = <?= $Page->Reception->toClientList($Page) ?>;
    fbilling_voucheradd.lists.Doctor = <?= $Page->Doctor->toClientList($Page) ?>;
    fbilling_voucheradd.lists.voucher_type = <?= $Page->voucher_type->toClientList($Page) ?>;
    fbilling_voucheradd.lists.ModeofPayment = <?= $Page->ModeofPayment->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fbilling_voucheradd" id="fbilling_voucheradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fbilling_voucheradd"], function() {
    fbilling_voucheradd.createAutoSuggest(Object.assign({"id":"x_Doctor","forceSelect":false}, ew.vars.tables.billing_voucher.fields.Doctor.autoSuggestOptions));
});
</script>
...
<?php } ?>
    ...
    <input type="hidden" data-table="billing_voucher" data-field="x_createdby" data-hidden="1" name="x_createdby" id="x_createdby" value="<?= HtmlEncode($Page->createdby->FormValue) ?>">
    <?php } ?>
    <?php if (!$Page->isConfirm()) { ?>
    <?php } else { ?>
    ...
    <input type="hidden" data-table="billing_voucher" data-field="x_createddatetime" data-hidden="1" name="x_createddatetime" id="x_createddatetime" value="<?= HtmlEncode($Page->createddatetime->FormValue) ?>">
    <?php } ?>
...
<?php } ?>
    ...
    <input type="hidden" data-table="billing_voucher" data-field="x_HospID" data-hidden="1" name="x_HospID" id="x_HospID" value="<?= HtmlEncode($Page->HospID->FormValue) ?>">
    <?php } ?>
...
<?php } ?>
    ...
    <input type="hidden" data-table="billing_voucher" data-field="x__UserName" data-hidden="1" name="x__UserName" id="x__UserName" value="<?= HtmlEncode($Page->_UserName->FormValue) ?>">
    <?php } ?>
...
<?php } ?>
    ...
    <input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->createdDatettime->getDisplayValue($Page->createdDatettime->ViewValue))) ?>"></span>
    </span></template>
    <input type="hidden" data-table="billing_voucher" data-field="x_createdDatettime" data-hidden="1" name="x_createdDatettime" id="x_createdDatettime" value="<?= HtmlEncode($Page->createdDatettime->FormValue) ?>">
    <?php } ?>
...
<template id="tpm_billing_voucheradd">
<div id="ct_BillingVoucherAdd"><style>
...
<table class="ew-table">
	 <tbody>
		...
		<tr>
		 ...
		 <tr>
		 	<td><slot class="ew-slot" name="tpc_billing_voucher_DrID"></slot>&nbsp;<slot class="ew-slot" name="tpx_billing_voucher_DrID"></slot></td>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_billing_voucheradd", "tpm_billing_voucheradd", "billing_voucheradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
