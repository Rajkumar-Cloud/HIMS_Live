...
$Page->showMessage();
?>
<form name="fpatient_servicesview" id="fpatient_servicesview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ServiceSelect->Visible) { // ServiceSelect ?>
    <tr id="r_ServiceSelect">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_services_ServiceSelect"><?= $Page->ServiceSelect->caption() ?></span></td>
