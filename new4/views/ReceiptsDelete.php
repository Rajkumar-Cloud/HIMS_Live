...
<script>
if (!ew.vars.tables.receipts) ew.vars.tables.receipts = <?= JsonEncode(GetClientVar("tables", "receipts")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="freceiptsdelete" id="freceiptsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
