...
// Page object
$StorePurchaseorderView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fstore_purchaseorderview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fstore_purchaseorderview = currentForm = new ew.Form("fstore_purchaseorderview", "view");
    loadjs.done("fstore_purchaseorderview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fstore_purchaseorderview" id="fstore_purchaseorderview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ORDNO->Visible) { // ORDNO ?>
    <tr id="r_ORDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_ORDNO"><?= $Page->ORDNO->caption() ?></span></td>
...
<?php if ($Page->PRC->Visible) { // PRC ?>
    <tr id="r_PRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PRC"><?= $Page->PRC->caption() ?></span></td>
...
<?php if ($Page->QTY->Visible) { // QTY ?>
    <tr id="r_QTY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_QTY"><?= $Page->QTY->caption() ?></span></td>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <tr id="r_DT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_DT"><?= $Page->DT->caption() ?></span></td>
...
<?php if ($Page->PC->Visible) { // PC ?>
    <tr id="r_PC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PC"><?= $Page->PC->caption() ?></span></td>
...
<?php if ($Page->YM->Visible) { // YM ?>
    <tr id="r_YM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_YM"><?= $Page->YM->caption() ?></span></td>
...
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
    <tr id="r_MFRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_MFRCODE"><?= $Page->MFRCODE->caption() ?></span></td>
...
<?php if ($Page->Stock->Visible) { // Stock ?>
    <tr id="r_Stock">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Stock"><?= $Page->Stock->caption() ?></span></td>
...
<?php if ($Page->LastMonthSale->Visible) { // LastMonthSale ?>
    <tr id="r_LastMonthSale">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_LastMonthSale"><?= $Page->LastMonthSale->caption() ?></span></td>
...
<?php if ($Page->Printcheck->Visible) { // Printcheck ?>
    <tr id="r_Printcheck">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Printcheck"><?= $Page->Printcheck->caption() ?></span></td>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->poid->Visible) { // poid ?>
    <tr id="r_poid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_poid"><?= $Page->poid->caption() ?></span></td>
...
<?php if ($Page->grnid->Visible) { // grnid ?>
    <tr id="r_grnid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grnid"><?= $Page->grnid->caption() ?></span></td>
...
<?php if ($Page->BatchNo->Visible) { // BatchNo ?>
    <tr id="r_BatchNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_BatchNo"><?= $Page->BatchNo->caption() ?></span></td>
...
<?php if ($Page->ExpDate->Visible) { // ExpDate ?>
    <tr id="r_ExpDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_ExpDate"><?= $Page->ExpDate->caption() ?></span></td>
...
<?php if ($Page->PrName->Visible) { // PrName ?>
    <tr id="r_PrName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PrName"><?= $Page->PrName->caption() ?></span></td>
...
<?php if ($Page->Quantity->Visible) { // Quantity ?>
    <tr id="r_Quantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Quantity"><?= $Page->Quantity->caption() ?></span></td>
...
<?php if ($Page->FreeQty->Visible) { // FreeQty ?>
    <tr id="r_FreeQty">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_FreeQty"><?= $Page->FreeQty->caption() ?></span></td>
...
<?php if ($Page->ItemValue->Visible) { // ItemValue ?>
    <tr id="r_ItemValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_ItemValue"><?= $Page->ItemValue->caption() ?></span></td>
...
<?php if ($Page->Disc->Visible) { // Disc ?>
    <tr id="r_Disc">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Disc"><?= $Page->Disc->caption() ?></span></td>
...
<?php if ($Page->PTax->Visible) { // PTax ?>
    <tr id="r_PTax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PTax"><?= $Page->PTax->caption() ?></span></td>
...
<?php if ($Page->MRP->Visible) { // MRP ?>
    <tr id="r_MRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_MRP"><?= $Page->MRP->caption() ?></span></td>
...
<?php if ($Page->SalTax->Visible) { // SalTax ?>
    <tr id="r_SalTax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_SalTax"><?= $Page->SalTax->caption() ?></span></td>
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <tr id="r_PurValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PurValue"><?= $Page->PurValue->caption() ?></span></td>
...
<?php if ($Page->PurRate->Visible) { // PurRate ?>
    <tr id="r_PurRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PurRate"><?= $Page->PurRate->caption() ?></span></td>
...
<?php if ($Page->SalRate->Visible) { // SalRate ?>
    <tr id="r_SalRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_SalRate"><?= $Page->SalRate->caption() ?></span></td>
...
<?php if ($Page->Discount->Visible) { // Discount ?>
    <tr id="r_Discount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Discount"><?= $Page->Discount->caption() ?></span></td>
...
<?php if ($Page->PSGST->Visible) { // PSGST ?>
    <tr id="r_PSGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PSGST"><?= $Page->PSGST->caption() ?></span></td>
...
<?php if ($Page->PCGST->Visible) { // PCGST ?>
    <tr id="r_PCGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PCGST"><?= $Page->PCGST->caption() ?></span></td>
...
<?php if ($Page->SSGST->Visible) { // SSGST ?>
    <tr id="r_SSGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_SSGST"><?= $Page->SSGST->caption() ?></span></td>
...
<?php if ($Page->SCGST->Visible) { // SCGST ?>
    <tr id="r_SCGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_SCGST"><?= $Page->SCGST->caption() ?></span></td>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_BRCODE"><?= $Page->BRCODE->caption() ?></span></td>
...
<?php if ($Page->HSN->Visible) { // HSN ?>
    <tr id="r_HSN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_HSN"><?= $Page->HSN->caption() ?></span></td>
...
<?php if ($Page->Pack->Visible) { // Pack ?>
    <tr id="r_Pack">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Pack"><?= $Page->Pack->caption() ?></span></td>
...
<?php if ($Page->PUnit->Visible) { // PUnit ?>
    <tr id="r_PUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_PUnit"><?= $Page->PUnit->caption() ?></span></td>
...
<?php if ($Page->SUnit->Visible) { // SUnit ?>
    <tr id="r_SUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_SUnit"><?= $Page->SUnit->caption() ?></span></td>
...
<?php if ($Page->GrnQuantity->Visible) { // GrnQuantity ?>
    <tr id="r_GrnQuantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_GrnQuantity"><?= $Page->GrnQuantity->caption() ?></span></td>
...
<?php if ($Page->GrnMRP->Visible) { // GrnMRP ?>
    <tr id="r_GrnMRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_GrnMRP"><?= $Page->GrnMRP->caption() ?></span></td>
...
<?php if ($Page->trid->Visible) { // trid ?>
    <tr id="r_trid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_trid"><?= $Page->trid->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
    <tr id="r_CreatedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_CreatedBy"><?= $Page->CreatedBy->caption() ?></span></td>
...
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
    <tr id="r_CreatedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_CreatedDateTime"><?= $Page->CreatedDateTime->caption() ?></span></td>
...
<?php if ($Page->ModifiedBy->Visible) { // ModifiedBy ?>
    <tr id="r_ModifiedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_ModifiedBy"><?= $Page->ModifiedBy->caption() ?></span></td>
...
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
    <tr id="r_ModifiedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_ModifiedDateTime"><?= $Page->ModifiedDateTime->caption() ?></span></td>
...
<?php if ($Page->grncreatedby->Visible) { // grncreatedby ?>
    <tr id="r_grncreatedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grncreatedby"><?= $Page->grncreatedby->caption() ?></span></td>
...
<?php if ($Page->grncreatedDateTime->Visible) { // grncreatedDateTime ?>
    <tr id="r_grncreatedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grncreatedDateTime"><?= $Page->grncreatedDateTime->caption() ?></span></td>
...
<?php if ($Page->grnModifiedby->Visible) { // grnModifiedby ?>
    <tr id="r_grnModifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grnModifiedby"><?= $Page->grnModifiedby->caption() ?></span></td>
...
<?php if ($Page->grnModifiedDateTime->Visible) { // grnModifiedDateTime ?>
    <tr id="r_grnModifiedDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grnModifiedDateTime"><?= $Page->grnModifiedDateTime->caption() ?></span></td>
...
<?php if ($Page->Received->Visible) { // Received ?>
    <tr id="r_Received">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_Received"><?= $Page->Received->caption() ?></span></td>
...
<?php if ($Page->BillDate->Visible) { // BillDate ?>
    <tr id="r_BillDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_BillDate"><?= $Page->BillDate->caption() ?></span></td>
...
<?php if ($Page->CurStock->Visible) { // CurStock ?>
    <tr id="r_CurStock">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_CurStock"><?= $Page->CurStock->caption() ?></span></td>
...
<?php if ($Page->FreeQtyyy->Visible) { // FreeQtyyy ?>
    <tr id="r_FreeQtyyy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_FreeQtyyy"><?= $Page->FreeQtyyy->caption() ?></span></td>
...
<?php if ($Page->grndate->Visible) { // grndate ?>
    <tr id="r_grndate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grndate"><?= $Page->grndate->caption() ?></span></td>
...
<?php if ($Page->grndatetime->Visible) { // grndatetime ?>
    <tr id="r_grndatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_grndatetime"><?= $Page->grndatetime->caption() ?></span></td>
...
<?php if ($Page->strid->Visible) { // strid ?>
    <tr id="r_strid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_strid"><?= $Page->strid->caption() ?></span></td>
...
<?php if ($Page->GRNPer->Visible) { // GRNPer ?>
    <tr id="r_GRNPer">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_GRNPer"><?= $Page->GRNPer->caption() ?></span></td>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_purchaseorder_StoreID"><?= $Page->StoreID->caption() ?></span></td>
