...
loadjs.ready("head", function () {
    ...
    fbilling_other_voucheradd.lists.ModeofPayment = <?= $Page->ModeofPayment->toClientList($Page) ?>;
    fbilling_other_voucheradd.lists.PatID = <?= $Page->PatID->toClientList($Page) ?>;
    fbilling_other_voucheradd.lists.CancelAdvance = <?= $Page->CancelAdvance->toClientList($Page) ?>;
    fbilling_other_voucheradd.lists.CancelStatus = <?= $Page->CancelStatus->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fbilling_other_voucheradd" id="fbilling_other_voucheradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="billing_other_voucher" data-field="x_createdby" data-hidden="1" name="x_createdby" id="x_createdby" value="<?= HtmlEncode($Page->createdby->FormValue) ?>">
    <?php } ?>
    <?php if (!$Page->isConfirm()) { ?>
    <?php } else { ?>
    ...
    <input type="hidden" data-table="billing_other_voucher" data-field="x_createddatetime" data-hidden="1" name="x_createddatetime" id="x_createddatetime" value="<?= HtmlEncode($Page->createddatetime->FormValue) ?>">
    <?php } ?>
...
<?php } ?>
    ...
    <input type="hidden" data-table="billing_other_voucher" data-field="x_HospID" data-hidden="1" name="x_HospID" id="x_HospID" value="<?= HtmlEncode($Page->HospID->FormValue) ?>">
    <?php } ?>
...
<?php } ?>
    ...
    <input type="hidden" data-table="billing_other_voucher" data-field="x_GetUserName" data-hidden="1" name="x_GetUserName" id="x_GetUserName" value="<?= HtmlEncode($Page->GetUserName->FormValue) ?>">
    <?php } ?>
...
<template id="tpm_billing_other_voucheradd">
<div id="ct_BillingOtherVoucherAdd"><style>
...
<table class="ew-table">
	 <tbody>
		<tr>
			...
			<td><slot class="ew-slot" name="tpc_billing_other_voucher_SeectPaymentMode"></slot>&nbsp;<slot class="ew-slot" name="tpx_billing_other_voucher_SeectPaymentMode"></slot></td>
		</tr>
	</tbody>
</table>
			</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_billing_other_voucheradd", "tpm_billing_other_voucheradd", "billing_other_voucheradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
