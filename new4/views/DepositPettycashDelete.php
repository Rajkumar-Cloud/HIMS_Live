...
<script>
if (!ew.vars.tables.deposit_pettycash) ew.vars.tables.deposit_pettycash = <?= JsonEncode(GetClientVar("tables", "deposit_pettycash")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fdeposit_pettycashdelete" id="fdeposit_pettycashdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th class="<?= $Page->HospID->headerCellClass() ?>"><span id="elh_deposit_pettycash_HospID" class="deposit_pettycash_HospID"><?= $Page->HospID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_deposit_pettycash_HospID" class="deposit_pettycash_HospID">
