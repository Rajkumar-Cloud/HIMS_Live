...
// Page object
$EmployeeCompanyLoansAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_company_loansadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_company_loansadd = currentForm = new ew.Form("femployee_company_loansadd", "add");
    ...
    femployee_company_loansadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_company_loansadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_company_loansadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_company_loansadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_company_loansadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_company_loansadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_company_loansadd" id="femployee_company_loansadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_company_loansadd", "datetimepicker"], function() {
