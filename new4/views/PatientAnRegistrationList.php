...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "patient_opd_follow_up") {
    if ($Page->MasterRecordExists) {
        include_once "views/PatientOpdFollowUpMaster.php";
    }
}
?>
<?php } ?>
...
<form name="fpatient_an_registrationlistsrch" id="fpatient_an_registrationlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpatient_an_registrationlist" id="fpatient_an_registrationlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="patient_an_registration">
<?php if ($Page->getCurrentMasterTable() == "patient_opd_follow_up" && $Page->CurrentAction) { ?>
...
<?php if ($Page->ViabilityREPORT->Visible) { // ViabilityREPORT ?>
        <th data-name="ViabilityREPORT" class="<?= $Page->ViabilityREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_ViabilityREPORT" class="patient_an_registration_ViabilityREPORT"><?= $Page->renderSort($Page->ViabilityREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->Viability2REPORT->Visible) { // Viability2REPORT ?>
        <th data-name="Viability2REPORT" class="<?= $Page->Viability2REPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_Viability2REPORT" class="patient_an_registration_Viability2REPORT"><?= $Page->renderSort($Page->Viability2REPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->NTscanREPORT->Visible) { // NTscanREPORT ?>
        <th data-name="NTscanREPORT" class="<?= $Page->NTscanREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_NTscanREPORT" class="patient_an_registration_NTscanREPORT"><?= $Page->renderSort($Page->NTscanREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->EarlyTargetREPORT->Visible) { // EarlyTargetREPORT ?>
        <th data-name="EarlyTargetREPORT" class="<?= $Page->EarlyTargetREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_EarlyTargetREPORT" class="patient_an_registration_EarlyTargetREPORT"><?= $Page->renderSort($Page->EarlyTargetREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->AnomalyREPORT->Visible) { // AnomalyREPORT ?>
        <th data-name="AnomalyREPORT" class="<?= $Page->AnomalyREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_AnomalyREPORT" class="patient_an_registration_AnomalyREPORT"><?= $Page->renderSort($Page->AnomalyREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->GrowthREPORT->Visible) { // GrowthREPORT ?>
        <th data-name="GrowthREPORT" class="<?= $Page->GrowthREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_GrowthREPORT" class="patient_an_registration_GrowthREPORT"><?= $Page->renderSort($Page->GrowthREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->Growth1REPORT->Visible) { // Growth1REPORT ?>
        <th data-name="Growth1REPORT" class="<?= $Page->Growth1REPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_Growth1REPORT" class="patient_an_registration_Growth1REPORT"><?= $Page->renderSort($Page->Growth1REPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->ANProfileREPORT->Visible) { // ANProfileREPORT ?>
        <th data-name="ANProfileREPORT" class="<?= $Page->ANProfileREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_ANProfileREPORT" class="patient_an_registration_ANProfileREPORT"><?= $Page->renderSort($Page->ANProfileREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->DualMarkerREPORT->Visible) { // DualMarkerREPORT ?>
        <th data-name="DualMarkerREPORT" class="<?= $Page->DualMarkerREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_DualMarkerREPORT" class="patient_an_registration_DualMarkerREPORT"><?= $Page->renderSort($Page->DualMarkerREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->QuadrupleREPORT->Visible) { // QuadrupleREPORT ?>
        <th data-name="QuadrupleREPORT" class="<?= $Page->QuadrupleREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_QuadrupleREPORT" class="patient_an_registration_QuadrupleREPORT"><?= $Page->renderSort($Page->QuadrupleREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->A5monthREPORT->Visible) { // A5monthREPORT ?>
        <th data-name="A5monthREPORT" class="<?= $Page->A5monthREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_A5monthREPORT" class="patient_an_registration_A5monthREPORT"><?= $Page->renderSort($Page->A5monthREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->A7monthREPORT->Visible) { // A7monthREPORT ?>
        <th data-name="A7monthREPORT" class="<?= $Page->A7monthREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_A7monthREPORT" class="patient_an_registration_A7monthREPORT"><?= $Page->renderSort($Page->A7monthREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->A9monthREPORT->Visible) { // A9monthREPORT ?>
        <th data-name="A9monthREPORT" class="<?= $Page->A9monthREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_A9monthREPORT" class="patient_an_registration_A9monthREPORT"><?= $Page->renderSort($Page->A9monthREPORT) ?></div></th>
<?php } ?>
...
<?php if ($Page->INJREPORT->Visible) { // INJREPORT ?>
        <th data-name="INJREPORT" class="<?= $Page->INJREPORT->headerCellClass() ?>"><div id="elh_patient_an_registration_INJREPORT" class="patient_an_registration_INJREPORT"><?= $Page->renderSort($Page->INJREPORT) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_ViabilityREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_Viability2REPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_NTscanREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_EarlyTargetREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_AnomalyREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_GrowthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_Growth1REPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_ANProfileREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_DualMarkerREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_QuadrupleREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_A5monthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_A7monthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_A9monthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_INJREPORT">
