...
loadjs.ready("head", function () {
    ...
    fpharmacy_master_genericedit.lists.GRPCODE = <?= $Page->GRPCODE->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_master_genericedit" id="fpharmacy_master_genericedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
