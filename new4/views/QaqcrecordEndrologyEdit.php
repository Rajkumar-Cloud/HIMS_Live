...
// Page object
$QaqcrecordEndrologyEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fqaqcrecord_endrologyedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fqaqcrecord_endrologyedit = currentForm = new ew.Form("fqaqcrecord_endrologyedit", "edit");
    ...
    fqaqcrecord_endrologyedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fqaqcrecord_endrologyedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fqaqcrecord_endrologyedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fqaqcrecord_endrologyedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fqaqcrecord_endrologyedit.lists.LN2_Checked = <?= $Page->LN2_Checked->toClientList($Page) ?>;
    fqaqcrecord_endrologyedit.lists.Incubator_Cleaned = <?= $Page->Incubator_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_endrologyedit.lists.LAF_Cleaned = <?= $Page->LAF_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_endrologyedit.lists.REF_Cleaned = <?= $Page->REF_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_endrologyedit.lists.Heating_Cleaned = <?= $Page->Heating_Cleaned->toClientList($Page) ?>;
    loadjs.done("fqaqcrecord_endrologyedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fqaqcrecord_endrologyedit" id="fqaqcrecord_endrologyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_qaqcrecord_endrology_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_qaqcrecord_endrology_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="qaqcrecord_endrology" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->Date->Visible) { // Date ?>
    <div id="r_Date" class="form-group row">
        <label id="elh_qaqcrecord_endrology_Date" for="x_Date" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Date->caption() ?><?= $Page->Date->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Date->cellAttributes() ?>>
<span id="el_qaqcrecord_endrology_Date">
<input type="<?= $Page->Date->getInputTextType() ?>" data-table="qaqcrecord_endrology" data-field="x_Date" name="x_Date" id="x_Date" placeholder="<?= HtmlEncode($Page->Date->getPlaceHolder()) ?>" value="<?= $Page->Date->EditValue ?>"<?= $Page->Date->editAttributes() ?> aria-describedby="x_Date_help">
...
<script>
loadjs.ready(["fqaqcrecord_endrologyedit", "datetimepicker"], function() {
...
<?php if ($Page->LN2_Level->Visible) { // LN2_Level ?>
    <div id="r_LN2_Level" class="form-group row">
        <label id="elh_qaqcrecord_endrology_LN2_Level" for="x_LN2_Level" class="<?= $Page->LeftColumnClass ?>"><?= $Page->LN2_Level->caption() ?><?= $Page->LN2_Level->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LN2_Level->cellAttributes() ?>>
<span id="el_qaqcrecord_endrology_LN2_Level">
<input type="<?= $Page->LN2_Level->getInputTextType() ?>" data-table="qaqcrecord_endrology" data-field="x_LN2_Level" name="x_LN2_Level" id="x_LN2_Level" size="30" placeholder="<?= HtmlEncode($Page->LN2_Level->getPlaceHolder()) ?>" value="<?= $Page->LN2_Level->EditValue ?>"<?= $Page->LN2_Level->editAttributes() ?> aria-describedby="x_LN2_Level_help">
...
<?php if ($Page->LN2_Checked->Visible) { // LN2_Checked ?>
    <div id="r_LN2_Checked" class="form-group row">
        <label id="elh_qaqcrecord_endrology_LN2_Checked" class="<?= $Page->LeftColumnClass ?>"><?= $Page->LN2_Checked->caption() ?><?= $Page->LN2_Checked->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_LN2_Checked">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="qaqcrecord_endrology" data-field="x_LN2_Checked" name="x_LN2_Checked" id="x_LN2_Checked"<?= $Page->LN2_Checked->editAttributes() ?>>
...
<?php if ($Page->Incubator_Temp->Visible) { // Incubator_Temp ?>
    <div id="r_Incubator_Temp" class="form-group row">
        <label id="elh_qaqcrecord_endrology_Incubator_Temp" for="x_Incubator_Temp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Incubator_Temp->caption() ?><?= $Page->Incubator_Temp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Incubator_Cleaned->Visible) { // Incubator_Cleaned ?>
    <div id="r_Incubator_Cleaned" class="form-group row">
        <label id="elh_qaqcrecord_endrology_Incubator_Cleaned" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Incubator_Cleaned->caption() ?><?= $Page->Incubator_Cleaned->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_Incubator_Cleaned">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="qaqcrecord_endrology" data-field="x_Incubator_Cleaned" name="x_Incubator_Cleaned" id="x_Incubator_Cleaned"<?= $Page->Incubator_Cleaned->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->LAF_MG->Visible) { // LAF_MG ?>
    <div id="r_LAF_MG" class="form-group row">
        <label id="elh_qaqcrecord_endrology_LAF_MG" for="x_LAF_MG" class="<?= $Page->LeftColumnClass ?>"><?= $Page->LAF_MG->caption() ?><?= $Page->LAF_MG->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LAF_MG->cellAttributes() ?>>
<span id="el_qaqcrecord_endrology_LAF_MG">
<input type="<?= $Page->LAF_MG->getInputTextType() ?>" data-table="qaqcrecord_endrology" data-field="x_LAF_MG" name="x_LAF_MG" id="x_LAF_MG" size="30" placeholder="<?= HtmlEncode($Page->LAF_MG->getPlaceHolder()) ?>" value="<?= $Page->LAF_MG->EditValue ?>"<?= $Page->LAF_MG->editAttributes() ?> aria-describedby="x_LAF_MG_help">
...
<?php if ($Page->LAF_Cleaned->Visible) { // LAF_Cleaned ?>
    <div id="r_LAF_Cleaned" class="form-group row">
        <label id="elh_qaqcrecord_endrology_LAF_Cleaned" class="<?= $Page->LeftColumnClass ?>"><?= $Page->LAF_Cleaned->caption() ?><?= $Page->LAF_Cleaned->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_LAF_Cleaned">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="qaqcrecord_endrology" data-field="x_LAF_Cleaned" name="x_LAF_Cleaned" id="x_LAF_Cleaned"<?= $Page->LAF_Cleaned->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->REF_Temp->Visible) { // REF_Temp ?>
    <div id="r_REF_Temp" class="form-group row">
        <label id="elh_qaqcrecord_endrology_REF_Temp" for="x_REF_Temp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->REF_Temp->caption() ?><?= $Page->REF_Temp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->REF_Temp->cellAttributes() ?>>
<span id="el_qaqcrecord_endrology_REF_Temp">
<input type="<?= $Page->REF_Temp->getInputTextType() ?>" data-table="qaqcrecord_endrology" data-field="x_REF_Temp" name="x_REF_Temp" id="x_REF_Temp" size="30" placeholder="<?= HtmlEncode($Page->REF_Temp->getPlaceHolder()) ?>" value="<?= $Page->REF_Temp->EditValue ?>"<?= $Page->REF_Temp->editAttributes() ?> aria-describedby="x_REF_Temp_help">
...
<?php if ($Page->REF_Cleaned->Visible) { // REF_Cleaned ?>
    <div id="r_REF_Cleaned" class="form-group row">
        <label id="elh_qaqcrecord_endrology_REF_Cleaned" class="<?= $Page->LeftColumnClass ?>"><?= $Page->REF_Cleaned->caption() ?><?= $Page->REF_Cleaned->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_REF_Cleaned">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="qaqcrecord_endrology" data-field="x_REF_Cleaned" name="x_REF_Cleaned" id="x_REF_Cleaned"<?= $Page->REF_Cleaned->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->Heating_Temp->Visible) { // Heating_Temp ?>
    <div id="r_Heating_Temp" class="form-group row">
        <label id="elh_qaqcrecord_endrology_Heating_Temp" for="x_Heating_Temp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Heating_Temp->caption() ?><?= $Page->Heating_Temp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Heating_Cleaned->Visible) { // Heating_Cleaned ?>
    <div id="r_Heating_Cleaned" class="form-group row">
        <label id="elh_qaqcrecord_endrology_Heating_Cleaned" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Heating_Cleaned->caption() ?><?= $Page->Heating_Cleaned->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_Heating_Cleaned">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="qaqcrecord_endrology" data-field="x_Heating_Cleaned" name="x_Heating_Cleaned" id="x_Heating_Cleaned"<?= $Page->Heating_Cleaned->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
