...
loadjs.ready("head", function () {
    ...
    fivf_oocytedenudation_stageedit.lists.Stage = <?= $Page->Stage->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_oocytedenudation_stageedit" id="fivf_oocytedenudation_stageedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
