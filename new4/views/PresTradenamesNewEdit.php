...
loadjs.ready("head", function () {
    ...
    fpres_tradenames_newedit.lists.Generic_Name = <?= $Page->Generic_Name->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Form = <?= $Page->Form->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Unit = <?= $Page->Unit->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.TypeOfDrug = <?= $Page->TypeOfDrug->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.ProductType = <?= $Page->ProductType->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Generic_Name1 = <?= $Page->Generic_Name1->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Unit1 = <?= $Page->Unit1->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Generic_Name2 = <?= $Page->Generic_Name2->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Unit2 = <?= $Page->Unit2->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Generic_Name3 = <?= $Page->Generic_Name3->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Unit3 = <?= $Page->Unit3->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Generic_Name4 = <?= $Page->Generic_Name4->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Generic_Name5 = <?= $Page->Generic_Name5->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Unit4 = <?= $Page->Unit4->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.Unit5 = <?= $Page->Unit5->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.AlterNative1 = <?= $Page->AlterNative1->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.AlterNative2 = <?= $Page->AlterNative2->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.AlterNative3 = <?= $Page->AlterNative3->toClientList($Page) ?>;
    fpres_tradenames_newedit.lists.AlterNative4 = <?= $Page->AlterNative4->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpres_tradenames_newedit" id="fpres_tradenames_newedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if (in_array("pres_trade_combination_names_new", explode(",", $Page->getCurrentDetailTable())) && $pres_trade_combination_names_new->DetailEdit) {
?>
