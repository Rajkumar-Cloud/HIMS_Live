...
$Page->showMessage();
?>
<form name="fbilling_voucherview" id="fbilling_voucherview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_id"><template id="tpc_billing_voucher_id"><?= $Page->id->caption() ?></template></span></td>
...
<?php if ($Page->PatId->Visible) { // PatId ?>
    <tr id="r_PatId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_PatId"><template id="tpc_billing_voucher_PatId"><?= $Page->PatId->caption() ?></template></span></td>
        <td data-name="PatId" <?= $Page->PatId->cellAttributes() ?>>
<template id="tpx_billing_voucher_PatId" class="billing_voucherview">
<?= Barcode()->show($Page->PatId->CurrentValue, 'QRCODE', 60) ?>
</template>
<template id="tpx_billing_voucher_PatId"><span id="el_billing_voucher_PatId">
<span<?= $Page->PatId->viewAttributes() ?>><slot name="tpx_billing_voucher_PatId"></slot></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Reception"><template id="tpc_billing_voucher_Reception"><?= $Page->Reception->caption() ?></template></span></td>
        <td data-name="Reception" <?= $Page->Reception->cellAttributes() ?>>
<template id="tpx_billing_voucher_Reception" class="billing_voucherview">
<?= Barcode()->show($Page->Reception->CurrentValue, 'QRCODE', 60) ?>
</template>
<template id="tpx_billing_voucher_Reception"><span id="el_billing_voucher_Reception">
<span><slot name="tpx_billing_voucher_Reception"></slot></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->BillNumber->Visible) { // BillNumber ?>
    <tr id="r_BillNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_BillNumber"><template id="tpc_billing_voucher_BillNumber"><?= $Page->BillNumber->caption() ?></template></span></td>
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <tr id="r_PatientId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_PatientId"><template id="tpc_billing_voucher_PatientId"><?= $Page->PatientId->caption() ?></template></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_mrnno"><template id="tpc_billing_voucher_mrnno"><?= $Page->mrnno->caption() ?></template></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_PatientName"><template id="tpc_billing_voucher_PatientName"><?= $Page->PatientName->caption() ?></template></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Age"><template id="tpc_billing_voucher_Age"><?= $Page->Age->caption() ?></template></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Gender"><template id="tpc_billing_voucher_Gender"><?= $Page->Gender->caption() ?></template></span></td>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <tr id="r_profilePic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_profilePic"><template id="tpc_billing_voucher_profilePic"><?= $Page->profilePic->caption() ?></template></span></td>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <tr id="r_Mobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Mobile"><template id="tpc_billing_voucher_Mobile"><?= $Page->Mobile->caption() ?></template></span></td>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
    <tr id="r_IP_OP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_IP_OP"><template id="tpc_billing_voucher_IP_OP"><?= $Page->IP_OP->caption() ?></template></span></td>
...
<?php if ($Page->Doctor->Visible) { // Doctor ?>
    <tr id="r_Doctor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Doctor"><template id="tpc_billing_voucher_Doctor"><?= $Page->Doctor->caption() ?></template></span></td>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
    <tr id="r_voucher_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_voucher_type"><template id="tpc_billing_voucher_voucher_type"><?= $Page->voucher_type->caption() ?></template></span></td>
...
<?php if ($Page->Details->Visible) { // Details ?>
    <tr id="r_Details">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Details"><template id="tpc_billing_voucher_Details"><?= $Page->Details->caption() ?></template></span></td>
...
<?php if ($Page->ModeofPayment->Visible) { // ModeofPayment ?>
    <tr id="r_ModeofPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_ModeofPayment"><template id="tpc_billing_voucher_ModeofPayment"><?= $Page->ModeofPayment->caption() ?></template></span></td>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <tr id="r_Amount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Amount"><template id="tpc_billing_voucher_Amount"><?= $Page->Amount->caption() ?></template></span></td>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
    <tr id="r_AnyDues">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_AnyDues"><template id="tpc_billing_voucher_AnyDues"><?= $Page->AnyDues->caption() ?></template></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_createdby"><template id="tpc_billing_voucher_createdby"><?= $Page->createdby->caption() ?></template></span></td>
        <td data-name="createdby" <?= $Page->createdby->cellAttributes() ?>>
<template id="tpx_billing_voucher_createdby"><span id="el_billing_voucher_createdby">
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_createddatetime"><template id="tpc_billing_voucher_createddatetime"><?= $Page->createddatetime->caption() ?></template></span></td>
        <td data-name="createddatetime" <?= $Page->createddatetime->cellAttributes() ?>>
<template id="tpx_billing_voucher_createddatetime"><span id="el_billing_voucher_createddatetime">
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_modifiedby"><template id="tpc_billing_voucher_modifiedby"><?= $Page->modifiedby->caption() ?></template></span></td>
        <td data-name="modifiedby" <?= $Page->modifiedby->cellAttributes() ?>>
<template id="tpx_billing_voucher_modifiedby"><span id="el_billing_voucher_modifiedby">
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_modifieddatetime"><template id="tpc_billing_voucher_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></template></span></td>
        <td data-name="modifieddatetime" <?= $Page->modifieddatetime->cellAttributes() ?>>
<template id="tpx_billing_voucher_modifieddatetime"><span id="el_billing_voucher_modifieddatetime">
...
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
    <tr id="r_RealizationAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RealizationAmount"><template id="tpc_billing_voucher_RealizationAmount"><?= $Page->RealizationAmount->caption() ?></template></span></td>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
    <tr id="r_RealizationStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RealizationStatus"><template id="tpc_billing_voucher_RealizationStatus"><?= $Page->RealizationStatus->caption() ?></template></span></td>
...
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
    <tr id="r_RealizationRemarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RealizationRemarks"><template id="tpc_billing_voucher_RealizationRemarks"><?= $Page->RealizationRemarks->caption() ?></template></span></td>
...
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
    <tr id="r_RealizationBatchNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RealizationBatchNo"><template id="tpc_billing_voucher_RealizationBatchNo"><?= $Page->RealizationBatchNo->caption() ?></template></span></td>
...
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
    <tr id="r_RealizationDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RealizationDate"><template id="tpc_billing_voucher_RealizationDate"><?= $Page->RealizationDate->caption() ?></template></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_HospID"><template id="tpc_billing_voucher_HospID"><?= $Page->HospID->caption() ?></template></span></td>
        <td data-name="HospID" <?= $Page->HospID->cellAttributes() ?>>
<template id="tpx_billing_voucher_HospID"><span id="el_billing_voucher_HospID">
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <tr id="r_RIDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RIDNO"><template id="tpc_billing_voucher_RIDNO"><?= $Page->RIDNO->caption() ?></template></span></td>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <tr id="r_TidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_TidNo"><template id="tpc_billing_voucher_TidNo"><?= $Page->TidNo->caption() ?></template></span></td>
...
<?php if ($Page->CId->Visible) { // CId ?>
    <tr id="r_CId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CId"><template id="tpc_billing_voucher_CId"><?= $Page->CId->caption() ?></template></span></td>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <tr id="r_PartnerName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_PartnerName"><template id="tpc_billing_voucher_PartnerName"><?= $Page->PartnerName->caption() ?></template></span></td>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
    <tr id="r_PayerType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_PayerType"><template id="tpc_billing_voucher_PayerType"><?= $Page->PayerType->caption() ?></template></span></td>
...
<?php if ($Page->Dob->Visible) { // Dob ?>
    <tr id="r_Dob">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Dob"><template id="tpc_billing_voucher_Dob"><?= $Page->Dob->caption() ?></template></span></td>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <tr id="r_Currency">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Currency"><template id="tpc_billing_voucher_Currency"><?= $Page->Currency->caption() ?></template></span></td>
...
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
    <tr id="r_DiscountRemarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_DiscountRemarks"><template id="tpc_billing_voucher_DiscountRemarks"><?= $Page->DiscountRemarks->caption() ?></template></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Remarks"><template id="tpc_billing_voucher_Remarks"><?= $Page->Remarks->caption() ?></template></span></td>
...
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
    <tr id="r_DrDepartment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_DrDepartment"><template id="tpc_billing_voucher_DrDepartment"><?= $Page->DrDepartment->caption() ?></template></span></td>
...
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
    <tr id="r_RefferedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_RefferedBy"><template id="tpc_billing_voucher_RefferedBy"><?= $Page->RefferedBy->caption() ?></template></span></td>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <tr id="r_CardNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CardNumber"><template id="tpc_billing_voucher_CardNumber"><?= $Page->CardNumber->caption() ?></template></span></td>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <tr id="r_BankName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_BankName"><template id="tpc_billing_voucher_BankName"><?= $Page->BankName->caption() ?></template></span></td>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <tr id="r_DrID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_DrID"><template id="tpc_billing_voucher_DrID"><?= $Page->DrID->caption() ?></template></span></td>
...
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
    <tr id="r_BillStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_BillStatus"><template id="tpc_billing_voucher_BillStatus"><?= $Page->BillStatus->caption() ?></template></span></td>
...
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
    <tr id="r_ReportHeader">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_ReportHeader"><template id="tpc_billing_voucher_ReportHeader"><?= $Page->ReportHeader->caption() ?></template></span></td>
...
<?php if ($Page->_UserName->Visible) { // UserName ?>
    <tr id="r__UserName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher__UserName"><template id="tpc_billing_voucher__UserName"><?= $Page->_UserName->caption() ?></template></span></td>
        <td data-name="_UserName" <?= $Page->_UserName->cellAttributes() ?>>
<template id="tpx_billing_voucher__UserName"><span id="el_billing_voucher__UserName">
...
<?php if ($Page->AdjustmentAdvance->Visible) { // AdjustmentAdvance ?>
    <tr id="r_AdjustmentAdvance">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_AdjustmentAdvance"><template id="tpc_billing_voucher_AdjustmentAdvance"><?= $Page->AdjustmentAdvance->caption() ?></template></span></td>
...
<?php if ($Page->billing_vouchercol->Visible) { // billing_vouchercol ?>
    <tr id="r_billing_vouchercol">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_billing_vouchercol"><template id="tpc_billing_voucher_billing_vouchercol"><?= $Page->billing_vouchercol->caption() ?></template></span></td>
...
<?php if ($Page->BillType->Visible) { // BillType ?>
    <tr id="r_BillType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_BillType"><template id="tpc_billing_voucher_BillType"><?= $Page->BillType->caption() ?></template></span></td>
...
<?php if ($Page->ProcedureName->Visible) { // ProcedureName ?>
    <tr id="r_ProcedureName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_ProcedureName"><template id="tpc_billing_voucher_ProcedureName"><?= $Page->ProcedureName->caption() ?></template></span></td>
...
<?php if ($Page->ProcedureAmount->Visible) { // ProcedureAmount ?>
    <tr id="r_ProcedureAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_ProcedureAmount"><template id="tpc_billing_voucher_ProcedureAmount"><?= $Page->ProcedureAmount->caption() ?></template></span></td>
...
<?php if ($Page->IncludePackage->Visible) { // IncludePackage ?>
    <tr id="r_IncludePackage">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_IncludePackage"><template id="tpc_billing_voucher_IncludePackage"><?= $Page->IncludePackage->caption() ?></template></span></td>
...
<?php if ($Page->CancelBill->Visible) { // CancelBill ?>
    <tr id="r_CancelBill">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CancelBill"><template id="tpc_billing_voucher_CancelBill"><?= $Page->CancelBill->caption() ?></template></span></td>
...
<?php if ($Page->CancelReason->Visible) { // CancelReason ?>
    <tr id="r_CancelReason">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CancelReason"><template id="tpc_billing_voucher_CancelReason"><?= $Page->CancelReason->caption() ?></template></span></td>
...
<?php if ($Page->CancelModeOfPayment->Visible) { // CancelModeOfPayment ?>
    <tr id="r_CancelModeOfPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CancelModeOfPayment"><template id="tpc_billing_voucher_CancelModeOfPayment"><?= $Page->CancelModeOfPayment->caption() ?></template></span></td>
...
<?php if ($Page->CancelAmount->Visible) { // CancelAmount ?>
    <tr id="r_CancelAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CancelAmount"><template id="tpc_billing_voucher_CancelAmount"><?= $Page->CancelAmount->caption() ?></template></span></td>
...
<?php if ($Page->CancelBankName->Visible) { // CancelBankName ?>
    <tr id="r_CancelBankName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CancelBankName"><template id="tpc_billing_voucher_CancelBankName"><?= $Page->CancelBankName->caption() ?></template></span></td>
...
<?php if ($Page->CancelTransactionNumber->Visible) { // CancelTransactionNumber ?>
    <tr id="r_CancelTransactionNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CancelTransactionNumber"><template id="tpc_billing_voucher_CancelTransactionNumber"><?= $Page->CancelTransactionNumber->caption() ?></template></span></td>
...
<?php if ($Page->LabTest->Visible) { // LabTest ?>
    <tr id="r_LabTest">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_LabTest"><template id="tpc_billing_voucher_LabTest"><?= $Page->LabTest->caption() ?></template></span></td>
...
<?php if ($Page->sid->Visible) { // sid ?>
    <tr id="r_sid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_sid"><template id="tpc_billing_voucher_sid"><?= $Page->sid->caption() ?></template></span></td>
...
<?php if ($Page->SidNo->Visible) { // SidNo ?>
    <tr id="r_SidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_SidNo"><template id="tpc_billing_voucher_SidNo"><?= $Page->SidNo->caption() ?></template></span></td>
...
<?php if ($Page->createdDatettime->Visible) { // createdDatettime ?>
    <tr id="r_createdDatettime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_createdDatettime"><template id="tpc_billing_voucher_createdDatettime"><?= $Page->createdDatettime->caption() ?></template></span></td>
        <td data-name="createdDatettime" <?= $Page->createdDatettime->cellAttributes() ?>>
<template id="tpx_billing_voucher_createdDatettime"><span id="el_billing_voucher_createdDatettime">
...
<?php if ($Page->LabTestReleased->Visible) { // LabTestReleased ?>
    <tr id="r_LabTestReleased">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_LabTestReleased"><template id="tpc_billing_voucher_LabTestReleased"><?= $Page->LabTestReleased->caption() ?></template></span></td>
...
<?php if ($Page->GoogleReviewID->Visible) { // GoogleReviewID ?>
    <tr id="r_GoogleReviewID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_GoogleReviewID"><template id="tpc_billing_voucher_GoogleReviewID"><?= $Page->GoogleReviewID->caption() ?></template></span></td>
...
<?php if ($Page->CardType->Visible) { // CardType ?>
    <tr id="r_CardType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_CardType"><template id="tpc_billing_voucher_CardType"><?= $Page->CardType->caption() ?></template></span></td>
...
<?php if ($Page->PharmacyBill->Visible) { // PharmacyBill ?>
    <tr id="r_PharmacyBill">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_PharmacyBill"><template id="tpc_billing_voucher_PharmacyBill"><?= $Page->PharmacyBill->caption() ?></template></span></td>
...
<?php if ($Page->DiscountAmount->Visible) { // DiscountAmount ?>
    <tr id="r_DiscountAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_DiscountAmount"><template id="tpc_billing_voucher_DiscountAmount"><?= $Page->DiscountAmount->caption() ?></template></span></td>
...
<?php if ($Page->Cash->Visible) { // Cash ?>
    <tr id="r_Cash">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Cash"><template id="tpc_billing_voucher_Cash"><?= $Page->Cash->caption() ?></template></span></td>
...
<?php if ($Page->Card->Visible) { // Card ?>
    <tr id="r_Card">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_voucher_Card"><template id="tpc_billing_voucher_Card"><?= $Page->Card->caption() ?></template></span></td>
...
<template id="tpm_billing_voucherview">
<div id="ct_BillingVoucherView"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_billing_voucherview", "tpm_billing_voucherview", "billing_voucherview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
