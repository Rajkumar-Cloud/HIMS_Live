...
loadjs.ready("head", function () {
    ...
    fivf_vitrificationedit.lists.Day = <?= $Page->Day->toClientList($Page) ?>;
    fivf_vitrificationedit.lists.Grade = <?= $Page->Grade->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_vitrificationedit" id="fivf_vitrificationedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
