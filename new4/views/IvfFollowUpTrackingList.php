...
<form name="fivf_follow_up_trackinglistsrch" id="fivf_follow_up_trackinglistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fivf_follow_up_trackinglist" id="fivf_follow_up_trackinglist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->MReadMore->Visible) { // MReadMore ?>
        <th data-name="MReadMore" class="<?= $Page->MReadMore->headerCellClass() ?>"><div id="elh_ivf_follow_up_tracking_MReadMore" class="ivf_follow_up_tracking_MReadMore"><?= $Page->renderSort($Page->MReadMore) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ivf_follow_up_tracking_MReadMore">
