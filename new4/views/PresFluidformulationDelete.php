...
$Page->showMessage();
?>
<form name="fpres_fluidformulationdelete" id="fpres_fluidformulationdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Tradename->Visible) { // Tradename ?>
        <th class="<?= $Page->Tradename->headerCellClass() ?>"><span id="elh_pres_fluidformulation_Tradename" class="pres_fluidformulation_Tradename"><?= $Page->Tradename->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->Tradename->Visible) { // Tradename ?>
        <td <?= $Page->Tradename->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pres_fluidformulation_Tradename" class="pres_fluidformulation_Tradename">
