...
// Page object
$EmployeePermissionsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_permissionsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_permissionsadd = currentForm = new ew.Form("femployee_permissionsadd", "add");
    ...
    femployee_permissionsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_permissionsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_permissionsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_permissionsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_permissionsadd.lists.user_level = <?= $Page->user_level->toClientList($Page) ?>;
    loadjs.done("femployee_permissionsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_permissionsadd" id="femployee_permissionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
