...
<?php if ($Page->contact_persion->Visible) { // contact_persion ?>
    <?php if ($Page->SortUrl($Page->contact_persion) == "") { ?>
        <th class="<?= $Page->contact_persion->headerCellClass() ?>"><?= $Page->contact_persion->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->contact_persion->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->contact_persion->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->contact_persion->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->contact_persion->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->contact_persion->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
