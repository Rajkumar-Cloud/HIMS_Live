...
// Page object
$LabProfileMasterEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var flab_profile_masteredit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "lab_profile_master")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.lab_profile_master)
        ew.vars.tables.lab_profile_master = currentTable;
    flab_profile_masteredit.addFields([
        ...
        ["ProfileName", [fields.ProfileName.visible && fields.ProfileName.required ? ew.Validators.required(fields.ProfileName.caption) : null], fields.ProfileName.isInvalid],
        ["ProfileAmount", [fields.ProfileAmount.visible && fields.ProfileAmount.required ? ew.Validators.required(fields.ProfileAmount.caption) : null, ew.Validators.float], fields.ProfileAmount.isInvalid],
        ["ProfileSpecialAmount", [fields.ProfileSpecialAmount.visible && fields.ProfileSpecialAmount.required ? ew.Validators.required(fields.ProfileSpecialAmount.caption) : null, ew.Validators.float], fields.ProfileSpecialAmount.isInvalid],
        ["ProfileMasterInactive", [fields.ProfileMasterInactive.visible && fields.ProfileMasterInactive.required ? ew.Validators.required(fields.ProfileMasterInactive.caption) : null], fields.ProfileMasterInactive.isInvalid],
        ...
        ["EditUser", [fields.EditUser.visible && fields.EditUser.required ? ew.Validators.required(fields.EditUser.caption) : null], fields.EditUser.isInvalid],
        ...
        ["IInsAmt", [fields.IInsAmt.visible && fields.IInsAmt.required ? ew.Validators.required(fields.IInsAmt.caption) : null, ew.Validators.float], fields.IInsAmt.isInvalid],
        ...
        ["IIpAmt", [fields.IIpAmt.visible && fields.IIpAmt.required ? ew.Validators.required(fields.IIpAmt.caption) : null, ew.Validators.float], fields.IIpAmt.isInvalid],
    ...
    // Form_CustomValidate
    flab_profile_masteredit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flab_profile_masteredit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="flab_profile_masteredit" id="flab_profile_masteredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_lab_profile_master_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_lab_profile_master_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="lab_profile_master" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
