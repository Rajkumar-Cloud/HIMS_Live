...
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fsms_cintentadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsms_cintentadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fsms_cintentadd.lists.SMSType = <?= $Page->SMSType->toClientList($Page) ?>;
    fsms_cintentadd.lists.Enabled = <?= $Page->Enabled->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fsms_cintentadd" id="fsms_cintentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
