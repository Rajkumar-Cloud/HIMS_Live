...
loadjs.ready("head", function () {
    ...
    fpatientedit.lists.title = <?= $Page->title->toClientList($Page) ?>;
    fpatientedit.lists.gender = <?= $Page->gender->toClientList($Page) ?>;
    fpatientedit.lists.blood_group = <?= $Page->blood_group->toClientList($Page) ?>;
    fpatientedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fpatientedit.lists.ReferedByDr = <?= $Page->ReferedByDr->toClientList($Page) ?>;
    fpatientedit.lists.ReferA4TreatingConsultant = <?= $Page->ReferA4TreatingConsultant->toClientList($Page) ?>;
    fpatientedit.lists.spouse_title = <?= $Page->spouse_title->toClientList($Page) ?>;
    fpatientedit.lists.spouse_gender = <?= $Page->spouse_gender->toClientList($Page) ?>;
    fpatientedit.lists.spouse_blood_group = <?= $Page->spouse_blood_group->toClientList($Page) ?>;
    fpatientedit.lists.Maritalstatus = <?= $Page->Maritalstatus->toClientList($Page) ?>;
    fpatientedit.lists.Business = <?= $Page->Business->toClientList($Page) ?>;
    fpatientedit.lists.Patient_Language = <?= $Page->Patient_Language->toClientList($Page) ?>;
    fpatientedit.lists.WhereDidYouHear = <?= $Page->WhereDidYouHear->toClientList($Page) ?>;
    fpatientedit.lists.AppointmentSearch = <?= $Page->AppointmentSearch->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatientedit" id="fpatientedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_patient_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_patient_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" data-table="patient" data-field="x_PatientID" data-hidden="1" name="x_PatientID" id="x_PatientID" value="<?= HtmlEncode($Page->PatientID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fpatientedit"], function() {
    fpatientedit.createAutoSuggest(Object.assign({"id":"x_Business","forceSelect":false}, ew.vars.tables.patient.fields.Business.autoSuggestOptions));
});
</script>
...
<input type="hidden" name="fa_x_profilePicImage" id= "fa_x_profilePicImage" value="<?= (Post("fa_x_profilePicImage") == "0") ? "0" : "1" ?>">
...
<template id="tpm_patientedit">
<div id="ct_PatientEdit"><style>
...
<?php
    if (in_array("patient_address", explode(",", $Page->getCurrentDetailTable())) && $patient_address->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("patient_email", explode(",", $Page->getCurrentDetailTable())) && $patient_email->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_telephone", explode(",", $Page->getCurrentDetailTable())) && $patient_telephone->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_emergency_contact", explode(",", $Page->getCurrentDetailTable())) && $patient_emergency_contact->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_document", explode(",", $Page->getCurrentDetailTable())) && $patient_document->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patientedit", "tpm_patientedit", "patientedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
