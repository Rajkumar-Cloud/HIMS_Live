...
// Page object
$ViewStoreGrnEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_store_grnedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fview_store_grnedit = currentForm = new ew.Form("fview_store_grnedit", "edit");
    ...
    // Form_CustomValidate
    fview_store_grnedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_store_grnedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_store_grnedit.lists.PrName = <?= $Page->PrName->toClientList($Page) ?>;
    loadjs.done("fview_store_grnedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fview_store_grnedit" id="fview_store_grnedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fview_store_grnedit"], function() {
    fview_store_grnedit.createAutoSuggest(Object.assign({"id":"x_PrName","forceSelect":true}, ew.vars.tables.view_store_grn.fields.PrName.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_store_grnedit", "datetimepicker"], function() {
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_view_store_grn_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_view_store_grn_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="view_store_grn" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
