...
// Page object
$StoreStoremastView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fstore_storemastview;
...
<?php } ?>
<script>
if (!ew.vars.tables.store_storemast) ew.vars.tables.store_storemast = <?= JsonEncode(GetClientVar("tables", "store_storemast")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fstore_storemastview" id="fstore_storemastview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_BRCODE"><?= $Page->BRCODE->caption() ?></span></td>
...
<?php if ($Page->PRC->Visible) { // PRC ?>
    <tr id="r_PRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PRC"><?= $Page->PRC->caption() ?></span></td>
...
<?php if ($Page->TYPE->Visible) { // TYPE ?>
    <tr id="r_TYPE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_TYPE"><?= $Page->TYPE->caption() ?></span></td>
...
<?php if ($Page->DES->Visible) { // DES ?>
    <tr id="r_DES">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_DES"><?= $Page->DES->caption() ?></span></td>
...
<?php if ($Page->UM->Visible) { // UM ?>
    <tr id="r_UM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_UM"><?= $Page->UM->caption() ?></span></td>
...
<?php if ($Page->RT->Visible) { // RT ?>
    <tr id="r_RT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_RT"><?= $Page->RT->caption() ?></span></td>
...
<?php if ($Page->UR->Visible) { // UR ?>
    <tr id="r_UR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_UR"><?= $Page->UR->caption() ?></span></td>
...
<?php if ($Page->TAXP->Visible) { // TAXP ?>
    <tr id="r_TAXP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_TAXP"><?= $Page->TAXP->caption() ?></span></td>
...
<?php if ($Page->BATCHNO->Visible) { // BATCHNO ?>
    <tr id="r_BATCHNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_BATCHNO"><?= $Page->BATCHNO->caption() ?></span></td>
...
<?php if ($Page->OQ->Visible) { // OQ ?>
    <tr id="r_OQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_OQ"><?= $Page->OQ->caption() ?></span></td>
...
<?php if ($Page->RQ->Visible) { // RQ ?>
    <tr id="r_RQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_RQ"><?= $Page->RQ->caption() ?></span></td>
...
<?php if ($Page->MRQ->Visible) { // MRQ ?>
    <tr id="r_MRQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_MRQ"><?= $Page->MRQ->caption() ?></span></td>
...
<?php if ($Page->IQ->Visible) { // IQ ?>
    <tr id="r_IQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_IQ"><?= $Page->IQ->caption() ?></span></td>
...
<?php if ($Page->MRP->Visible) { // MRP ?>
    <tr id="r_MRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_MRP"><?= $Page->MRP->caption() ?></span></td>
...
<?php if ($Page->EXPDT->Visible) { // EXPDT ?>
    <tr id="r_EXPDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_EXPDT"><?= $Page->EXPDT->caption() ?></span></td>
...
<?php if ($Page->SALQTY->Visible) { // SALQTY ?>
    <tr id="r_SALQTY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_SALQTY"><?= $Page->SALQTY->caption() ?></span></td>
...
<?php if ($Page->LASTPURDT->Visible) { // LASTPURDT ?>
    <tr id="r_LASTPURDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_LASTPURDT"><?= $Page->LASTPURDT->caption() ?></span></td>
...
<?php if ($Page->LASTSUPP->Visible) { // LASTSUPP ?>
    <tr id="r_LASTSUPP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_LASTSUPP"><?= $Page->LASTSUPP->caption() ?></span></td>
...
<?php if ($Page->GENNAME->Visible) { // GENNAME ?>
    <tr id="r_GENNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_GENNAME"><?= $Page->GENNAME->caption() ?></span></td>
...
<?php if ($Page->LASTISSDT->Visible) { // LASTISSDT ?>
    <tr id="r_LASTISSDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_LASTISSDT"><?= $Page->LASTISSDT->caption() ?></span></td>
...
<?php if ($Page->CREATEDDT->Visible) { // CREATEDDT ?>
    <tr id="r_CREATEDDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_CREATEDDT"><?= $Page->CREATEDDT->caption() ?></span></td>
...
<?php if ($Page->OPPRC->Visible) { // OPPRC ?>
    <tr id="r_OPPRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_OPPRC"><?= $Page->OPPRC->caption() ?></span></td>
...
<?php if ($Page->RESTRICT->Visible) { // RESTRICT ?>
    <tr id="r_RESTRICT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_RESTRICT"><?= $Page->RESTRICT->caption() ?></span></td>
...
<?php if ($Page->BAWAPRC->Visible) { // BAWAPRC ?>
    <tr id="r_BAWAPRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_BAWAPRC"><?= $Page->BAWAPRC->caption() ?></span></td>
...
<?php if ($Page->STAXPER->Visible) { // STAXPER ?>
    <tr id="r_STAXPER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_STAXPER"><?= $Page->STAXPER->caption() ?></span></td>
...
<?php if ($Page->TAXTYPE->Visible) { // TAXTYPE ?>
    <tr id="r_TAXTYPE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_TAXTYPE"><?= $Page->TAXTYPE->caption() ?></span></td>
...
<?php if ($Page->OLDTAXP->Visible) { // OLDTAXP ?>
    <tr id="r_OLDTAXP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_OLDTAXP"><?= $Page->OLDTAXP->caption() ?></span></td>
...
<?php if ($Page->TAXUPD->Visible) { // TAXUPD ?>
    <tr id="r_TAXUPD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_TAXUPD"><?= $Page->TAXUPD->caption() ?></span></td>
...
<?php if ($Page->PACKAGE->Visible) { // PACKAGE ?>
    <tr id="r_PACKAGE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PACKAGE"><?= $Page->PACKAGE->caption() ?></span></td>
...
<?php if ($Page->NEWRT->Visible) { // NEWRT ?>
    <tr id="r_NEWRT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_NEWRT"><?= $Page->NEWRT->caption() ?></span></td>
...
<?php if ($Page->NEWMRP->Visible) { // NEWMRP ?>
    <tr id="r_NEWMRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_NEWMRP"><?= $Page->NEWMRP->caption() ?></span></td>
...
<?php if ($Page->NEWUR->Visible) { // NEWUR ?>
    <tr id="r_NEWUR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_NEWUR"><?= $Page->NEWUR->caption() ?></span></td>
...
<?php if ($Page->STATUS->Visible) { // STATUS ?>
    <tr id="r_STATUS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_STATUS"><?= $Page->STATUS->caption() ?></span></td>
...
<?php if ($Page->RETNQTY->Visible) { // RETNQTY ?>
    <tr id="r_RETNQTY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_RETNQTY"><?= $Page->RETNQTY->caption() ?></span></td>
...
<?php if ($Page->KEMODISC->Visible) { // KEMODISC ?>
    <tr id="r_KEMODISC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_KEMODISC"><?= $Page->KEMODISC->caption() ?></span></td>
...
<?php if ($Page->PATSALE->Visible) { // PATSALE ?>
    <tr id="r_PATSALE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PATSALE"><?= $Page->PATSALE->caption() ?></span></td>
...
<?php if ($Page->ORGAN->Visible) { // ORGAN ?>
    <tr id="r_ORGAN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_ORGAN"><?= $Page->ORGAN->caption() ?></span></td>
...
<?php if ($Page->OLDRQ->Visible) { // OLDRQ ?>
    <tr id="r_OLDRQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_OLDRQ"><?= $Page->OLDRQ->caption() ?></span></td>
...
<?php if ($Page->DRID->Visible) { // DRID ?>
    <tr id="r_DRID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_DRID"><?= $Page->DRID->caption() ?></span></td>
...
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
    <tr id="r_MFRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_MFRCODE"><?= $Page->MFRCODE->caption() ?></span></td>
...
<?php if ($Page->COMBCODE->Visible) { // COMBCODE ?>
    <tr id="r_COMBCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_COMBCODE"><?= $Page->COMBCODE->caption() ?></span></td>
...
<?php if ($Page->GENCODE->Visible) { // GENCODE ?>
    <tr id="r_GENCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_GENCODE"><?= $Page->GENCODE->caption() ?></span></td>
...
<?php if ($Page->STRENGTH->Visible) { // STRENGTH ?>
    <tr id="r_STRENGTH">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_STRENGTH"><?= $Page->STRENGTH->caption() ?></span></td>
...
<?php if ($Page->UNIT->Visible) { // UNIT ?>
    <tr id="r_UNIT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_UNIT"><?= $Page->UNIT->caption() ?></span></td>
...
<?php if ($Page->FORMULARY->Visible) { // FORMULARY ?>
    <tr id="r_FORMULARY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_FORMULARY"><?= $Page->FORMULARY->caption() ?></span></td>
...
<?php if ($Page->STOCK->Visible) { // STOCK ?>
    <tr id="r_STOCK">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_STOCK"><?= $Page->STOCK->caption() ?></span></td>
...
<?php if ($Page->RACKNO->Visible) { // RACKNO ?>
    <tr id="r_RACKNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_RACKNO"><?= $Page->RACKNO->caption() ?></span></td>
...
<?php if ($Page->SUPPNAME->Visible) { // SUPPNAME ?>
    <tr id="r_SUPPNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_SUPPNAME"><?= $Page->SUPPNAME->caption() ?></span></td>
...
<?php if ($Page->COMBNAME->Visible) { // COMBNAME ?>
    <tr id="r_COMBNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_COMBNAME"><?= $Page->COMBNAME->caption() ?></span></td>
...
<?php if ($Page->GENERICNAME->Visible) { // GENERICNAME ?>
    <tr id="r_GENERICNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_GENERICNAME"><?= $Page->GENERICNAME->caption() ?></span></td>
...
<?php if ($Page->REMARK->Visible) { // REMARK ?>
    <tr id="r_REMARK">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_REMARK"><?= $Page->REMARK->caption() ?></span></td>
...
<?php if ($Page->TEMP->Visible) { // TEMP ?>
    <tr id="r_TEMP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_TEMP"><?= $Page->TEMP->caption() ?></span></td>
...
<?php if ($Page->PACKING->Visible) { // PACKING ?>
    <tr id="r_PACKING">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PACKING"><?= $Page->PACKING->caption() ?></span></td>
...
<?php if ($Page->PhysQty->Visible) { // PhysQty ?>
    <tr id="r_PhysQty">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PhysQty"><?= $Page->PhysQty->caption() ?></span></td>
...
<?php if ($Page->LedQty->Visible) { // LedQty ?>
    <tr id="r_LedQty">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_LedQty"><?= $Page->LedQty->caption() ?></span></td>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <tr id="r_PurValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PurValue"><?= $Page->PurValue->caption() ?></span></td>
...
<?php if ($Page->PSGST->Visible) { // PSGST ?>
    <tr id="r_PSGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PSGST"><?= $Page->PSGST->caption() ?></span></td>
...
<?php if ($Page->PCGST->Visible) { // PCGST ?>
    <tr id="r_PCGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_PCGST"><?= $Page->PCGST->caption() ?></span></td>
...
<?php if ($Page->SaleValue->Visible) { // SaleValue ?>
    <tr id="r_SaleValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_SaleValue"><?= $Page->SaleValue->caption() ?></span></td>
...
<?php if ($Page->SSGST->Visible) { // SSGST ?>
    <tr id="r_SSGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_SSGST"><?= $Page->SSGST->caption() ?></span></td>
...
<?php if ($Page->SCGST->Visible) { // SCGST ?>
    <tr id="r_SCGST">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_SCGST"><?= $Page->SCGST->caption() ?></span></td>
...
<?php if ($Page->SaleRate->Visible) { // SaleRate ?>
    <tr id="r_SaleRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_SaleRate"><?= $Page->SaleRate->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->BRNAME->Visible) { // BRNAME ?>
    <tr id="r_BRNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_BRNAME"><?= $Page->BRNAME->caption() ?></span></td>
...
<?php if ($Page->OV->Visible) { // OV ?>
    <tr id="r_OV">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_OV"><?= $Page->OV->caption() ?></span></td>
...
<?php if ($Page->LATESTOV->Visible) { // LATESTOV ?>
    <tr id="r_LATESTOV">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_LATESTOV"><?= $Page->LATESTOV->caption() ?></span></td>
...
<?php if ($Page->ITEMTYPE->Visible) { // ITEMTYPE ?>
    <tr id="r_ITEMTYPE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_ITEMTYPE"><?= $Page->ITEMTYPE->caption() ?></span></td>
...
<?php if ($Page->ROWID->Visible) { // ROWID ?>
    <tr id="r_ROWID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_ROWID"><?= $Page->ROWID->caption() ?></span></td>
...
<?php if ($Page->MOVED->Visible) { // MOVED ?>
    <tr id="r_MOVED">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_MOVED"><?= $Page->MOVED->caption() ?></span></td>
...
<?php if ($Page->NEWTAX->Visible) { // NEWTAX ?>
    <tr id="r_NEWTAX">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_NEWTAX"><?= $Page->NEWTAX->caption() ?></span></td>
...
<?php if ($Page->HSNCODE->Visible) { // HSNCODE ?>
    <tr id="r_HSNCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_HSNCODE"><?= $Page->HSNCODE->caption() ?></span></td>
...
<?php if ($Page->OLDTAX->Visible) { // OLDTAX ?>
    <tr id="r_OLDTAX">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_OLDTAX"><?= $Page->OLDTAX->caption() ?></span></td>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storemast_StoreID"><?= $Page->StoreID->caption() ?></span></td>
