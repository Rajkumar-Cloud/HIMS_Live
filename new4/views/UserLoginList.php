...
<?php if ($Page->OTP->Visible) { // OTP ?>
        <th data-name="OTP" class="<?= $Page->OTP->headerCellClass() ?>"><div id="elh_user_login_OTP" class="user_login_OTP"><?= $Page->renderSort($Page->OTP) ?></div></th>
<?php } ?>
<?php if ($Page->_LoginType->Visible) { // LoginType ?>
        <th data-name="_LoginType" class="<?= $Page->_LoginType->headerCellClass() ?>"><div id="elh_user_login__LoginType" class="user_login__LoginType"><?= $Page->renderSort($Page->_LoginType) ?></div></th>
<?php } ?>
<?php if ($Page->BranchId->Visible) { // BranchId ?>
        <th data-name="BranchId" class="<?= $Page->BranchId->headerCellClass() ?>"><div id="elh_user_login_BranchId" class="user_login_BranchId"><?= $Page->renderSort($Page->BranchId) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_user_login_OTP">
...
<span id="el<?= $Page->RowCount ?>_user_login__LoginType">
...
<span id="el<?= $Page->RowCount ?>_user_login_BranchId">
