...
<script>
if (!ew.vars.tables.appointment_block_slot) ew.vars.tables.appointment_block_slot = <?= JsonEncode(GetClientVar("tables", "appointment_block_slot")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fappointment_block_slotdelete" id="fappointment_block_slotdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
