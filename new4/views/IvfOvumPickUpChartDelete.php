...
$Page->showMessage();
?>
<form name="fivf_ovum_pick_up_chartdelete" id="fivf_ovum_pick_up_chartdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
