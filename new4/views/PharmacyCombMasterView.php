...
<?php } ?>
<script>
if (!ew.vars.tables.pharmacy_comb_master) ew.vars.tables.pharmacy_comb_master = <?= JsonEncode(GetClientVar("tables", "pharmacy_comb_master")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fpharmacy_comb_masterview" id="fpharmacy_comb_masterview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
