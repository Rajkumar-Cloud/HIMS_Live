...
loadjs.ready("head", function () {
    ...
    femployee_has_degreeedit.lists.degree_id = <?= $Page->degree_id->toClientList($Page) ?>;
    femployee_has_degreeedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="femployee_has_degreeedit" id="femployee_has_degreeedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
