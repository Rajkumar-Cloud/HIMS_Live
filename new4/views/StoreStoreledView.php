...
// Page object
$StoreStoreledView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fstore_storeledview;
...
<?php } ?>
<script>
if (!ew.vars.tables.store_storeled) ew.vars.tables.store_storeled = <?= JsonEncode(GetClientVar("tables", "store_storeled")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fstore_storeledview" id="fstore_storeledview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BRCODE"><?= $Page->BRCODE->caption() ?></span></td>
...
<?php if ($Page->TYPE->Visible) { // TYPE ?>
    <tr id="r_TYPE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_TYPE"><?= $Page->TYPE->caption() ?></span></td>
...
<?php if ($Page->DN->Visible) { // DN ?>
    <tr id="r_DN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DN"><?= $Page->DN->caption() ?></span></td>
...
<?php if ($Page->RDN->Visible) { // RDN ?>
    <tr id="r_RDN">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_RDN"><?= $Page->RDN->caption() ?></span></td>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <tr id="r_DT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DT"><?= $Page->DT->caption() ?></span></td>
...
<?php if ($Page->PRC->Visible) { // PRC ?>
    <tr id="r_PRC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PRC"><?= $Page->PRC->caption() ?></span></td>
...
<?php if ($Page->OQ->Visible) { // OQ ?>
    <tr id="r_OQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_OQ"><?= $Page->OQ->caption() ?></span></td>
...
<?php if ($Page->RQ->Visible) { // RQ ?>
    <tr id="r_RQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_RQ"><?= $Page->RQ->caption() ?></span></td>
...
<?php if ($Page->MRQ->Visible) { // MRQ ?>
    <tr id="r_MRQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_MRQ"><?= $Page->MRQ->caption() ?></span></td>
...
<?php if ($Page->IQ->Visible) { // IQ ?>
    <tr id="r_IQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_IQ"><?= $Page->IQ->caption() ?></span></td>
...
<?php if ($Page->BATCHNO->Visible) { // BATCHNO ?>
    <tr id="r_BATCHNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BATCHNO"><?= $Page->BATCHNO->caption() ?></span></td>
...
<?php if ($Page->EXPDT->Visible) { // EXPDT ?>
    <tr id="r_EXPDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_EXPDT"><?= $Page->EXPDT->caption() ?></span></td>
...
<?php if ($Page->BILLNO->Visible) { // BILLNO ?>
    <tr id="r_BILLNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BILLNO"><?= $Page->BILLNO->caption() ?></span></td>
...
<?php if ($Page->BILLDT->Visible) { // BILLDT ?>
    <tr id="r_BILLDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BILLDT"><?= $Page->BILLDT->caption() ?></span></td>
...
<?php if ($Page->RT->Visible) { // RT ?>
    <tr id="r_RT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_RT"><?= $Page->RT->caption() ?></span></td>
...
<?php if ($Page->VALUE->Visible) { // VALUE ?>
    <tr id="r_VALUE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_VALUE"><?= $Page->VALUE->caption() ?></span></td>
...
<?php if ($Page->DISC->Visible) { // DISC ?>
    <tr id="r_DISC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DISC"><?= $Page->DISC->caption() ?></span></td>
...
<?php if ($Page->TAXP->Visible) { // TAXP ?>
    <tr id="r_TAXP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_TAXP"><?= $Page->TAXP->caption() ?></span></td>
...
<?php if ($Page->TAX->Visible) { // TAX ?>
    <tr id="r_TAX">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_TAX"><?= $Page->TAX->caption() ?></span></td>
...
<?php if ($Page->TAXR->Visible) { // TAXR ?>
    <tr id="r_TAXR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_TAXR"><?= $Page->TAXR->caption() ?></span></td>
...
<?php if ($Page->DAMT->Visible) { // DAMT ?>
    <tr id="r_DAMT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DAMT"><?= $Page->DAMT->caption() ?></span></td>
...
<?php if ($Page->EMPNO->Visible) { // EMPNO ?>
    <tr id="r_EMPNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_EMPNO"><?= $Page->EMPNO->caption() ?></span></td>
...
<?php if ($Page->PC->Visible) { // PC ?>
    <tr id="r_PC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PC"><?= $Page->PC->caption() ?></span></td>
...
<?php if ($Page->DRNAME->Visible) { // DRNAME ?>
    <tr id="r_DRNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DRNAME"><?= $Page->DRNAME->caption() ?></span></td>
...
<?php if ($Page->BTIME->Visible) { // BTIME ?>
    <tr id="r_BTIME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BTIME"><?= $Page->BTIME->caption() ?></span></td>
...
<?php if ($Page->ONO->Visible) { // ONO ?>
    <tr id="r_ONO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_ONO"><?= $Page->ONO->caption() ?></span></td>
...
<?php if ($Page->ODT->Visible) { // ODT ?>
    <tr id="r_ODT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_ODT"><?= $Page->ODT->caption() ?></span></td>
...
<?php if ($Page->PURRT->Visible) { // PURRT ?>
    <tr id="r_PURRT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PURRT"><?= $Page->PURRT->caption() ?></span></td>
...
<?php if ($Page->GRP->Visible) { // GRP ?>
    <tr id="r_GRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_GRP"><?= $Page->GRP->caption() ?></span></td>
...
<?php if ($Page->IBATCH->Visible) { // IBATCH ?>
    <tr id="r_IBATCH">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_IBATCH"><?= $Page->IBATCH->caption() ?></span></td>
...
<?php if ($Page->IPNO->Visible) { // IPNO ?>
    <tr id="r_IPNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_IPNO"><?= $Page->IPNO->caption() ?></span></td>
...
<?php if ($Page->OPNO->Visible) { // OPNO ?>
    <tr id="r_OPNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_OPNO"><?= $Page->OPNO->caption() ?></span></td>
...
<?php if ($Page->RECID->Visible) { // RECID ?>
    <tr id="r_RECID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_RECID"><?= $Page->RECID->caption() ?></span></td>
...
<?php if ($Page->FQTY->Visible) { // FQTY ?>
    <tr id="r_FQTY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_FQTY"><?= $Page->FQTY->caption() ?></span></td>
...
<?php if ($Page->UR->Visible) { // UR ?>
    <tr id="r_UR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_UR"><?= $Page->UR->caption() ?></span></td>
...
<?php if ($Page->DCID->Visible) { // DCID ?>
    <tr id="r_DCID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DCID"><?= $Page->DCID->caption() ?></span></td>
...
<?php if ($Page->_USERID->Visible) { // USERID ?>
    <tr id="r__USERID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled__USERID"><?= $Page->_USERID->caption() ?></span></td>
...
<?php if ($Page->MODDT->Visible) { // MODDT ?>
    <tr id="r_MODDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_MODDT"><?= $Page->MODDT->caption() ?></span></td>
...
<?php if ($Page->FYM->Visible) { // FYM ?>
    <tr id="r_FYM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_FYM"><?= $Page->FYM->caption() ?></span></td>
...
<?php if ($Page->PRCBATCH->Visible) { // PRCBATCH ?>
    <tr id="r_PRCBATCH">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PRCBATCH"><?= $Page->PRCBATCH->caption() ?></span></td>
...
<?php if ($Page->SLNO->Visible) { // SLNO ?>
    <tr id="r_SLNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_SLNO"><?= $Page->SLNO->caption() ?></span></td>
...
<?php if ($Page->MRP->Visible) { // MRP ?>
    <tr id="r_MRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_MRP"><?= $Page->MRP->caption() ?></span></td>
...
<?php if ($Page->BILLYM->Visible) { // BILLYM ?>
    <tr id="r_BILLYM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BILLYM"><?= $Page->BILLYM->caption() ?></span></td>
...
<?php if ($Page->BILLGRP->Visible) { // BILLGRP ?>
    <tr id="r_BILLGRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BILLGRP"><?= $Page->BILLGRP->caption() ?></span></td>
...
<?php if ($Page->STAFF->Visible) { // STAFF ?>
    <tr id="r_STAFF">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_STAFF"><?= $Page->STAFF->caption() ?></span></td>
...
<?php if ($Page->TEMPIPNO->Visible) { // TEMPIPNO ?>
    <tr id="r_TEMPIPNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_TEMPIPNO"><?= $Page->TEMPIPNO->caption() ?></span></td>
...
<?php if ($Page->PRNTED->Visible) { // PRNTED ?>
    <tr id="r_PRNTED">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PRNTED"><?= $Page->PRNTED->caption() ?></span></td>
...
<?php if ($Page->PATNAME->Visible) { // PATNAME ?>
    <tr id="r_PATNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PATNAME"><?= $Page->PATNAME->caption() ?></span></td>
...
<?php if ($Page->PJVNO->Visible) { // PJVNO ?>
    <tr id="r_PJVNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PJVNO"><?= $Page->PJVNO->caption() ?></span></td>
...
<?php if ($Page->PJVSLNO->Visible) { // PJVSLNO ?>
    <tr id="r_PJVSLNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PJVSLNO"><?= $Page->PJVSLNO->caption() ?></span></td>
...
<?php if ($Page->OTHDISC->Visible) { // OTHDISC ?>
    <tr id="r_OTHDISC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_OTHDISC"><?= $Page->OTHDISC->caption() ?></span></td>
...
<?php if ($Page->PJVYM->Visible) { // PJVYM ?>
    <tr id="r_PJVYM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PJVYM"><?= $Page->PJVYM->caption() ?></span></td>
...
<?php if ($Page->PURDISCPER->Visible) { // PURDISCPER ?>
    <tr id="r_PURDISCPER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PURDISCPER"><?= $Page->PURDISCPER->caption() ?></span></td>
...
<?php if ($Page->CASHIER->Visible) { // CASHIER ?>
    <tr id="r_CASHIER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_CASHIER"><?= $Page->CASHIER->caption() ?></span></td>
...
<?php if ($Page->CASHTIME->Visible) { // CASHTIME ?>
    <tr id="r_CASHTIME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_CASHTIME"><?= $Page->CASHTIME->caption() ?></span></td>
...
<?php if ($Page->CASHRECD->Visible) { // CASHRECD ?>
    <tr id="r_CASHRECD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_CASHRECD"><?= $Page->CASHRECD->caption() ?></span></td>
...
<?php if ($Page->CASHREFNO->Visible) { // CASHREFNO ?>
    <tr id="r_CASHREFNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_CASHREFNO"><?= $Page->CASHREFNO->caption() ?></span></td>
...
<?php if ($Page->CASHIERSHIFT->Visible) { // CASHIERSHIFT ?>
    <tr id="r_CASHIERSHIFT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_CASHIERSHIFT"><?= $Page->CASHIERSHIFT->caption() ?></span></td>
...
<?php if ($Page->PRCODE->Visible) { // PRCODE ?>
    <tr id="r_PRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PRCODE"><?= $Page->PRCODE->caption() ?></span></td>
...
<?php if ($Page->RELEASEBY->Visible) { // RELEASEBY ?>
    <tr id="r_RELEASEBY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_RELEASEBY"><?= $Page->RELEASEBY->caption() ?></span></td>
...
<?php if ($Page->CRAUTHOR->Visible) { // CRAUTHOR ?>
    <tr id="r_CRAUTHOR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_CRAUTHOR"><?= $Page->CRAUTHOR->caption() ?></span></td>
...
<?php if ($Page->PAYMENT->Visible) { // PAYMENT ?>
    <tr id="r_PAYMENT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PAYMENT"><?= $Page->PAYMENT->caption() ?></span></td>
...
<?php if ($Page->DRID->Visible) { // DRID ?>
    <tr id="r_DRID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DRID"><?= $Page->DRID->caption() ?></span></td>
...
<?php if ($Page->WARD->Visible) { // WARD ?>
    <tr id="r_WARD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_WARD"><?= $Page->WARD->caption() ?></span></td>
...
<?php if ($Page->STAXTYPE->Visible) { // STAXTYPE ?>
    <tr id="r_STAXTYPE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_STAXTYPE"><?= $Page->STAXTYPE->caption() ?></span></td>
...
<?php if ($Page->PURDISCVAL->Visible) { // PURDISCVAL ?>
    <tr id="r_PURDISCVAL">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PURDISCVAL"><?= $Page->PURDISCVAL->caption() ?></span></td>
...
<?php if ($Page->RNDOFF->Visible) { // RNDOFF ?>
    <tr id="r_RNDOFF">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_RNDOFF"><?= $Page->RNDOFF->caption() ?></span></td>
...
<?php if ($Page->DISCONMRP->Visible) { // DISCONMRP ?>
    <tr id="r_DISCONMRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DISCONMRP"><?= $Page->DISCONMRP->caption() ?></span></td>
...
<?php if ($Page->DELVDT->Visible) { // DELVDT ?>
    <tr id="r_DELVDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DELVDT"><?= $Page->DELVDT->caption() ?></span></td>
...
<?php if ($Page->DELVTIME->Visible) { // DELVTIME ?>
    <tr id="r_DELVTIME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DELVTIME"><?= $Page->DELVTIME->caption() ?></span></td>
...
<?php if ($Page->DELVBY->Visible) { // DELVBY ?>
    <tr id="r_DELVBY">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_DELVBY"><?= $Page->DELVBY->caption() ?></span></td>
...
<?php if ($Page->HOSPNO->Visible) { // HOSPNO ?>
    <tr id="r_HOSPNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_HOSPNO"><?= $Page->HOSPNO->caption() ?></span></td>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->pbv->Visible) { // pbv ?>
    <tr id="r_pbv">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_pbv"><?= $Page->pbv->caption() ?></span></td>
...
<?php if ($Page->pbt->Visible) { // pbt ?>
    <tr id="r_pbt">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_pbt"><?= $Page->pbt->caption() ?></span></td>
...
<?php if ($Page->SiNo->Visible) { // SiNo ?>
    <tr id="r_SiNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_SiNo"><?= $Page->SiNo->caption() ?></span></td>
...
<?php if ($Page->Product->Visible) { // Product ?>
    <tr id="r_Product">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_Product"><?= $Page->Product->caption() ?></span></td>
...
<?php if ($Page->Mfg->Visible) { // Mfg ?>
    <tr id="r_Mfg">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_Mfg"><?= $Page->Mfg->caption() ?></span></td>
...
<?php if ($Page->HosoID->Visible) { // HosoID ?>
    <tr id="r_HosoID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_HosoID"><?= $Page->HosoID->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
    <tr id="r_MFRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_MFRCODE"><?= $Page->MFRCODE->caption() ?></span></td>
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_Reception"><?= $Page->Reception->caption() ?></span></td>
...
<?php if ($Page->PatID->Visible) { // PatID ?>
    <tr id="r_PatID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_PatID"><?= $Page->PatID->caption() ?></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_mrnno"><?= $Page->mrnno->caption() ?></span></td>
...
<?php if ($Page->BRNAME->Visible) { // BRNAME ?>
    <tr id="r_BRNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_BRNAME"><?= $Page->BRNAME->caption() ?></span></td>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_storeled_StoreID"><?= $Page->StoreID->caption() ?></span></td>
