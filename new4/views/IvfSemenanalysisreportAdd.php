...
loadjs.ready("head", function () {
    ...
    fivf_semenanalysisreportadd.lists.RequestSample = <?= $Page->RequestSample->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.CollectionType = <?= $Page->CollectionType->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.CollectionMethod = <?= $Page->CollectionMethod->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.Medicationused = <?= $Page->Medicationused->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.DifficultiesinCollection = <?= $Page->DifficultiesinCollection->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.Homogenosity = <?= $Page->Homogenosity->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.CompleteSample = <?= $Page->CompleteSample->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.SemenOrgin = <?= $Page->SemenOrgin->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.Donor = <?= $Page->Donor->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.MACS = <?= $Page->MACS->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.SPECIFIC_PROBLEMS = <?= $Page->SPECIFIC_PROBLEMS->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.LIQUIFACTION_STORAGE = <?= $Page->LIQUIFACTION_STORAGE->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.IUI_PREP_METHOD = <?= $Page->IUI_PREP_METHOD->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.TIME_FROM_TRIGGER = <?= $Page->TIME_FROM_TRIGGER->toClientList($Page) ?>;
    fivf_semenanalysisreportadd.lists.COLLECTION_TO_PREPARATION = <?= $Page->COLLECTION_TO_PREPARATION->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_semenanalysisreportadd" id="fivf_semenanalysisreportadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fk_Name" value="<?= HtmlEncode($Page->PatientName->getSessionValue()) ?>">
<?php } ?>
...
<?php if ($Page->RIDNo->Visible) { // RIDNo ?>
    <div id="r_RIDNo" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_RIDNo" for="x_RIDNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_RIDNo"><?= $Page->RIDNo->caption() ?><?= $Page->RIDNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <div id="r_PatientName" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PatientName" for="x_PatientName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PatientName"><?= $Page->PatientName->caption() ?><?= $Page->PatientName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientName->cellAttributes() ?>>
<?php if ($Page->PatientName->getSessionValue() != "") { ?>
...
<input type="hidden" id="x_PatientName" name="x_PatientName" value="<?= HtmlEncode($Page->PatientName->CurrentValue) ?>" data-hidden="1">
<?php } else { ?>
<template id="tpx_ivf_semenanalysisreport_PatientName"><span id="el_ivf_semenanalysisreport_PatientName">
...
<?php if ($Page->HusbandName->Visible) { // HusbandName ?>
    <div id="r_HusbandName" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_HusbandName" for="x_HusbandName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_HusbandName"><?= $Page->HusbandName->caption() ?><?= $Page->HusbandName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RequestDr->Visible) { // RequestDr ?>
    <div id="r_RequestDr" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_RequestDr" for="x_RequestDr" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_RequestDr"><?= $Page->RequestDr->caption() ?><?= $Page->RequestDr->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->CollectionDate->Visible) { // CollectionDate ?>
    <div id="r_CollectionDate" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_CollectionDate" for="x_CollectionDate" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_CollectionDate"><?= $Page->CollectionDate->caption() ?><?= $Page->CollectionDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->ResultDate->Visible) { // ResultDate ?>
    <div id="r_ResultDate" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_ResultDate" for="x_ResultDate" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_ResultDate"><?= $Page->ResultDate->caption() ?><?= $Page->ResultDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RequestSample->Visible) { // RequestSample ?>
    <div id="r_RequestSample" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_RequestSample" for="x_RequestSample" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_RequestSample"><?= $Page->RequestSample->caption() ?><?= $Page->RequestSample->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_RequestSample"><span id="el_ivf_semenanalysisreport_RequestSample">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_RequestSample"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_RequestSample']"),
        options = { name: "x_RequestSample", selectId: "ivf_semenanalysisreport_x_RequestSample", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->CollectionType->Visible) { // CollectionType ?>
    <div id="r_CollectionType" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_CollectionType" for="x_CollectionType" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_CollectionType"><?= $Page->CollectionType->caption() ?><?= $Page->CollectionType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_CollectionType"><span id="el_ivf_semenanalysisreport_CollectionType">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_CollectionType"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_CollectionType']"),
        options = { name: "x_CollectionType", selectId: "ivf_semenanalysisreport_x_CollectionType", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->CollectionMethod->Visible) { // CollectionMethod ?>
    <div id="r_CollectionMethod" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_CollectionMethod" for="x_CollectionMethod" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_CollectionMethod"><?= $Page->CollectionMethod->caption() ?><?= $Page->CollectionMethod->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_CollectionMethod"><span id="el_ivf_semenanalysisreport_CollectionMethod">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_CollectionMethod"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_CollectionMethod']"),
        options = { name: "x_CollectionMethod", selectId: "ivf_semenanalysisreport_x_CollectionMethod", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->Medicationused->Visible) { // Medicationused ?>
    <div id="r_Medicationused" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Medicationused" for="x_Medicationused" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Medicationused"><?= $Page->Medicationused->caption() ?><?= $Page->Medicationused->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_Medicationused"><span id="el_ivf_semenanalysisreport_Medicationused">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_Medicationused"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_Medicationused']"),
        options = { name: "x_Medicationused", selectId: "ivf_semenanalysisreport_x_Medicationused", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->DifficultiesinCollection->Visible) { // DifficultiesinCollection ?>
    <div id="r_DifficultiesinCollection" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_DifficultiesinCollection" for="x_DifficultiesinCollection" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_DifficultiesinCollection"><?= $Page->DifficultiesinCollection->caption() ?><?= $Page->DifficultiesinCollection->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_DifficultiesinCollection"><span id="el_ivf_semenanalysisreport_DifficultiesinCollection">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_DifficultiesinCollection"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_DifficultiesinCollection']"),
        options = { name: "x_DifficultiesinCollection", selectId: "ivf_semenanalysisreport_x_DifficultiesinCollection", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->pH->Visible) { // pH ?>
    <div id="r_pH" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_pH" for="x_pH" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_pH"><?= $Page->pH->caption() ?><?= $Page->pH->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->pH->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_pH" name="x_pH" id="x_pH" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->pH->getPlaceHolder()) ?>" value="<?= $Page->pH->EditValue ?>"<?= $Page->pH->editAttributes() ?> aria-describedby="x_pH_help">
...
<?php if ($Page->Timeofcollection->Visible) { // Timeofcollection ?>
    <div id="r_Timeofcollection" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Timeofcollection" for="x_Timeofcollection" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Timeofcollection"><?= $Page->Timeofcollection->caption() ?><?= $Page->Timeofcollection->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if (!$Page->Timeofcollection->ReadOnly && !$Page->Timeofcollection->Disabled && !isset($Page->Timeofcollection->EditAttrs["readonly"]) && !isset($Page->Timeofcollection->EditAttrs["disabled"])) { ?>
<script>
...
<?php if ($Page->Timeofexamination->Visible) { // Timeofexamination ?>
    <div id="r_Timeofexamination" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Timeofexamination" for="x_Timeofexamination" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Timeofexamination"><?= $Page->Timeofexamination->caption() ?><?= $Page->Timeofexamination->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if (!$Page->Timeofexamination->ReadOnly && !$Page->Timeofexamination->Disabled && !isset($Page->Timeofexamination->EditAttrs["readonly"]) && !isset($Page->Timeofexamination->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fivf_semenanalysisreportadd", "timepicker"], function() {
...
<?php if ($Page->Volume->Visible) { // Volume ?>
    <div id="r_Volume" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Volume" for="x_Volume" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Volume"><?= $Page->Volume->caption() ?><?= $Page->Volume->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Volume->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Volume" name="x_Volume" id="x_Volume" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Volume->getPlaceHolder()) ?>" value="<?= $Page->Volume->EditValue ?>"<?= $Page->Volume->editAttributes() ?> aria-describedby="x_Volume_help">
...
<?php if ($Page->Concentration->Visible) { // Concentration ?>
    <div id="r_Concentration" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Concentration" for="x_Concentration" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Concentration"><?= $Page->Concentration->caption() ?><?= $Page->Concentration->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Concentration->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Concentration" name="x_Concentration" id="x_Concentration" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Concentration->getPlaceHolder()) ?>" value="<?= $Page->Concentration->EditValue ?>"<?= $Page->Concentration->editAttributes() ?> aria-describedby="x_Concentration_help">
...
<?php if ($Page->Total->Visible) { // Total ?>
    <div id="r_Total" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Total" for="x_Total" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Total"><?= $Page->Total->caption() ?><?= $Page->Total->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Total->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Total" name="x_Total" id="x_Total" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Total->getPlaceHolder()) ?>" value="<?= $Page->Total->EditValue ?>"<?= $Page->Total->editAttributes() ?> aria-describedby="x_Total_help">
...
<?php if ($Page->ProgressiveMotility->Visible) { // ProgressiveMotility ?>
    <div id="r_ProgressiveMotility" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_ProgressiveMotility" for="x_ProgressiveMotility" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_ProgressiveMotility"><?= $Page->ProgressiveMotility->caption() ?><?= $Page->ProgressiveMotility->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->ProgressiveMotility->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_ProgressiveMotility" name="x_ProgressiveMotility" id="x_ProgressiveMotility" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->ProgressiveMotility->getPlaceHolder()) ?>" value="<?= $Page->ProgressiveMotility->EditValue ?>"<?= $Page->ProgressiveMotility->editAttributes() ?> aria-describedby="x_ProgressiveMotility_help">
...
<?php if ($Page->NonProgrssiveMotile->Visible) { // NonProgrssiveMotile ?>
    <div id="r_NonProgrssiveMotile" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_NonProgrssiveMotile" for="x_NonProgrssiveMotile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_NonProgrssiveMotile"><?= $Page->NonProgrssiveMotile->caption() ?><?= $Page->NonProgrssiveMotile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->NonProgrssiveMotile->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_NonProgrssiveMotile" name="x_NonProgrssiveMotile" id="x_NonProgrssiveMotile" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->NonProgrssiveMotile->getPlaceHolder()) ?>" value="<?= $Page->NonProgrssiveMotile->EditValue ?>"<?= $Page->NonProgrssiveMotile->editAttributes() ?> aria-describedby="x_NonProgrssiveMotile_help">
...
<?php if ($Page->Immotile->Visible) { // Immotile ?>
    <div id="r_Immotile" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Immotile" for="x_Immotile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Immotile"><?= $Page->Immotile->caption() ?><?= $Page->Immotile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Immotile->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Immotile" name="x_Immotile" id="x_Immotile" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Immotile->getPlaceHolder()) ?>" value="<?= $Page->Immotile->EditValue ?>"<?= $Page->Immotile->editAttributes() ?> aria-describedby="x_Immotile_help">
...
<?php if ($Page->TotalProgrssiveMotile->Visible) { // TotalProgrssiveMotile ?>
    <div id="r_TotalProgrssiveMotile" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TotalProgrssiveMotile" for="x_TotalProgrssiveMotile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TotalProgrssiveMotile"><?= $Page->TotalProgrssiveMotile->caption() ?><?= $Page->TotalProgrssiveMotile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->TotalProgrssiveMotile->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_TotalProgrssiveMotile" name="x_TotalProgrssiveMotile" id="x_TotalProgrssiveMotile" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->TotalProgrssiveMotile->getPlaceHolder()) ?>" value="<?= $Page->TotalProgrssiveMotile->EditValue ?>"<?= $Page->TotalProgrssiveMotile->editAttributes() ?> aria-describedby="x_TotalProgrssiveMotile_help">
...
<?php if ($Page->Appearance->Visible) { // Appearance ?>
    <div id="r_Appearance" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Appearance" for="x_Appearance" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Appearance"><?= $Page->Appearance->caption() ?><?= $Page->Appearance->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Homogenosity->Visible) { // Homogenosity ?>
    <div id="r_Homogenosity" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Homogenosity" for="x_Homogenosity" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Homogenosity"><?= $Page->Homogenosity->caption() ?><?= $Page->Homogenosity->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_Homogenosity"><span id="el_ivf_semenanalysisreport_Homogenosity">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_Homogenosity"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_Homogenosity']"),
        options = { name: "x_Homogenosity", selectId: "ivf_semenanalysisreport_x_Homogenosity", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->CompleteSample->Visible) { // CompleteSample ?>
    <div id="r_CompleteSample" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_CompleteSample" for="x_CompleteSample" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_CompleteSample"><?= $Page->CompleteSample->caption() ?><?= $Page->CompleteSample->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_CompleteSample"><span id="el_ivf_semenanalysisreport_CompleteSample">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_CompleteSample"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_CompleteSample']"),
        options = { name: "x_CompleteSample", selectId: "ivf_semenanalysisreport_x_CompleteSample", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->Liquefactiontime->Visible) { // Liquefactiontime ?>
    <div id="r_Liquefactiontime" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Liquefactiontime" for="x_Liquefactiontime" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Liquefactiontime"><?= $Page->Liquefactiontime->caption() ?><?= $Page->Liquefactiontime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Normal->Visible) { // Normal ?>
    <div id="r_Normal" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Normal" for="x_Normal" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Normal"><?= $Page->Normal->caption() ?><?= $Page->Normal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Abnormal->Visible) { // Abnormal ?>
    <div id="r_Abnormal" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Abnormal" for="x_Abnormal" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Abnormal"><?= $Page->Abnormal->caption() ?><?= $Page->Abnormal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Headdefects->Visible) { // Headdefects ?>
    <div id="r_Headdefects" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Headdefects" for="x_Headdefects" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Headdefects"><?= $Page->Headdefects->caption() ?><?= $Page->Headdefects->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->MidpieceDefects->Visible) { // MidpieceDefects ?>
    <div id="r_MidpieceDefects" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_MidpieceDefects" for="x_MidpieceDefects" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_MidpieceDefects"><?= $Page->MidpieceDefects->caption() ?><?= $Page->MidpieceDefects->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->TailDefects->Visible) { // TailDefects ?>
    <div id="r_TailDefects" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TailDefects" for="x_TailDefects" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TailDefects"><?= $Page->TailDefects->caption() ?><?= $Page->TailDefects->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->NormalProgMotile->Visible) { // NormalProgMotile ?>
    <div id="r_NormalProgMotile" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_NormalProgMotile" for="x_NormalProgMotile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_NormalProgMotile"><?= $Page->NormalProgMotile->caption() ?><?= $Page->NormalProgMotile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->ImmatureForms->Visible) { // ImmatureForms ?>
    <div id="r_ImmatureForms" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_ImmatureForms" for="x_ImmatureForms" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_ImmatureForms"><?= $Page->ImmatureForms->caption() ?><?= $Page->ImmatureForms->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Leucocytes->Visible) { // Leucocytes ?>
    <div id="r_Leucocytes" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Leucocytes" for="x_Leucocytes" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Leucocytes"><?= $Page->Leucocytes->caption() ?><?= $Page->Leucocytes->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Agglutination->Visible) { // Agglutination ?>
    <div id="r_Agglutination" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Agglutination" for="x_Agglutination" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Agglutination"><?= $Page->Agglutination->caption() ?><?= $Page->Agglutination->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Debris->Visible) { // Debris ?>
    <div id="r_Debris" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Debris" for="x_Debris" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Debris"><?= $Page->Debris->caption() ?><?= $Page->Debris->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Diagnosis->Visible) { // Diagnosis ?>
    <div id="r_Diagnosis" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Diagnosis" for="x_Diagnosis" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Diagnosis"><?= $Page->Diagnosis->caption() ?><?= $Page->Diagnosis->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Observations->Visible) { // Observations ?>
    <div id="r_Observations" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Observations" for="x_Observations" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Observations"><?= $Page->Observations->caption() ?><?= $Page->Observations->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Signature->Visible) { // Signature ?>
    <div id="r_Signature" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Signature" for="x_Signature" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Signature"><?= $Page->Signature->caption() ?><?= $Page->Signature->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->SemenOrgin->Visible) { // SemenOrgin ?>
    <div id="r_SemenOrgin" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_SemenOrgin" for="x_SemenOrgin" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_SemenOrgin"><?= $Page->SemenOrgin->caption() ?><?= $Page->SemenOrgin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_SemenOrgin"><span id="el_ivf_semenanalysisreport_SemenOrgin">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_SemenOrgin"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_SemenOrgin']"),
        options = { name: "x_SemenOrgin", selectId: "ivf_semenanalysisreport_x_SemenOrgin", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->Donor->Visible) { // Donor ?>
    <div id="r_Donor" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Donor" for="x_Donor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Donor"><?= $Page->Donor->caption() ?><?= $Page->Donor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="ivf_semenanalysisreport" data-field="x_Donor" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->Donor->displayValueSeparatorAttribute() ?>" name="x_Donor" id="x_Donor" value="<?= $Page->Donor->CurrentValue ?>"<?= $Page->Donor->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->DonorBloodgroup->Visible) { // DonorBloodgroup ?>
    <div id="r_DonorBloodgroup" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_DonorBloodgroup" for="x_DonorBloodgroup" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_DonorBloodgroup"><?= $Page->DonorBloodgroup->caption() ?><?= $Page->DonorBloodgroup->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Tank->Visible) { // Tank ?>
    <div id="r_Tank" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Tank" for="x_Tank" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Tank"><?= $Page->Tank->caption() ?><?= $Page->Tank->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Location->Visible) { // Location ?>
    <div id="r_Location" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Location" for="x_Location" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Location"><?= $Page->Location->caption() ?><?= $Page->Location->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Volume1->Visible) { // Volume1 ?>
    <div id="r_Volume1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Volume1" for="x_Volume1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Volume1"><?= $Page->Volume1->caption() ?><?= $Page->Volume1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Volume1->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Volume1" name="x_Volume1" id="x_Volume1" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Volume1->getPlaceHolder()) ?>" value="<?= $Page->Volume1->EditValue ?>"<?= $Page->Volume1->editAttributes() ?> aria-describedby="x_Volume1_help">
...
<?php if ($Page->Concentration1->Visible) { // Concentration1 ?>
    <div id="r_Concentration1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Concentration1" for="x_Concentration1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Concentration1"><?= $Page->Concentration1->caption() ?><?= $Page->Concentration1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Concentration1->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Concentration1" name="x_Concentration1" id="x_Concentration1" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Concentration1->getPlaceHolder()) ?>" value="<?= $Page->Concentration1->EditValue ?>"<?= $Page->Concentration1->editAttributes() ?> aria-describedby="x_Concentration1_help">
...
<?php if ($Page->Total1->Visible) { // Total1 ?>
    <div id="r_Total1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Total1" for="x_Total1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Total1"><?= $Page->Total1->caption() ?><?= $Page->Total1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Total1->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Total1" name="x_Total1" id="x_Total1" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Total1->getPlaceHolder()) ?>" value="<?= $Page->Total1->EditValue ?>"<?= $Page->Total1->editAttributes() ?> aria-describedby="x_Total1_help">
...
<?php if ($Page->ProgressiveMotility1->Visible) { // ProgressiveMotility1 ?>
    <div id="r_ProgressiveMotility1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_ProgressiveMotility1" for="x_ProgressiveMotility1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_ProgressiveMotility1"><?= $Page->ProgressiveMotility1->caption() ?><?= $Page->ProgressiveMotility1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->NonProgrssiveMotile1->Visible) { // NonProgrssiveMotile1 ?>
    <div id="r_NonProgrssiveMotile1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_NonProgrssiveMotile1" for="x_NonProgrssiveMotile1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_NonProgrssiveMotile1"><?= $Page->NonProgrssiveMotile1->caption() ?><?= $Page->NonProgrssiveMotile1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Immotile1->Visible) { // Immotile1 ?>
    <div id="r_Immotile1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Immotile1" for="x_Immotile1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Immotile1"><?= $Page->Immotile1->caption() ?><?= $Page->Immotile1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Immotile1->getInputTextType() ?>" data-table="ivf_semenanalysisreport" data-field="x_Immotile1" name="x_Immotile1" id="x_Immotile1" size="5" maxlength="45" placeholder="<?= HtmlEncode($Page->Immotile1->getPlaceHolder()) ?>" value="<?= $Page->Immotile1->EditValue ?>"<?= $Page->Immotile1->editAttributes() ?> aria-describedby="x_Immotile1_help">
...
<?php if ($Page->TotalProgrssiveMotile1->Visible) { // TotalProgrssiveMotile1 ?>
    <div id="r_TotalProgrssiveMotile1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TotalProgrssiveMotile1" for="x_TotalProgrssiveMotile1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TotalProgrssiveMotile1"><?= $Page->TotalProgrssiveMotile1->caption() ?><?= $Page->TotalProgrssiveMotile1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <div id="r_TidNo" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TidNo" for="x_TidNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TidNo"><?= $Page->TidNo->caption() ?><?= $Page->TidNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Color->Visible) { // Color ?>
    <div id="r_Color" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Color" for="x_Color" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Color"><?= $Page->Color->caption() ?><?= $Page->Color->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->DoneBy->Visible) { // DoneBy ?>
    <div id="r_DoneBy" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_DoneBy" for="x_DoneBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_DoneBy"><?= $Page->DoneBy->caption() ?><?= $Page->DoneBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Method->Visible) { // Method ?>
    <div id="r_Method" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Method" for="x_Method" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Method"><?= $Page->Method->caption() ?><?= $Page->Method->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Abstinence->Visible) { // Abstinence ?>
    <div id="r_Abstinence" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Abstinence" for="x_Abstinence" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Abstinence"><?= $Page->Abstinence->caption() ?><?= $Page->Abstinence->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->ProcessedBy->Visible) { // ProcessedBy ?>
    <div id="r_ProcessedBy" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_ProcessedBy" for="x_ProcessedBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_ProcessedBy"><?= $Page->ProcessedBy->caption() ?><?= $Page->ProcessedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->InseminationTime->Visible) { // InseminationTime ?>
    <div id="r_InseminationTime" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_InseminationTime" for="x_InseminationTime" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_InseminationTime"><?= $Page->InseminationTime->caption() ?><?= $Page->InseminationTime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->InseminationBy->Visible) { // InseminationBy ?>
    <div id="r_InseminationBy" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_InseminationBy" for="x_InseminationBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_InseminationBy"><?= $Page->InseminationBy->caption() ?><?= $Page->InseminationBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Big->Visible) { // Big ?>
    <div id="r_Big" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Big" for="x_Big" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Big"><?= $Page->Big->caption() ?><?= $Page->Big->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Medium->Visible) { // Medium ?>
    <div id="r_Medium" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Medium" for="x_Medium" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Medium"><?= $Page->Medium->caption() ?><?= $Page->Medium->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Small->Visible) { // Small ?>
    <div id="r_Small" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Small" for="x_Small" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Small"><?= $Page->Small->caption() ?><?= $Page->Small->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->NoHalo->Visible) { // NoHalo ?>
    <div id="r_NoHalo" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_NoHalo" for="x_NoHalo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_NoHalo"><?= $Page->NoHalo->caption() ?><?= $Page->NoHalo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Fragmented->Visible) { // Fragmented ?>
    <div id="r_Fragmented" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Fragmented" for="x_Fragmented" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Fragmented"><?= $Page->Fragmented->caption() ?><?= $Page->Fragmented->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->NonFragmented->Visible) { // NonFragmented ?>
    <div id="r_NonFragmented" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_NonFragmented" for="x_NonFragmented" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_NonFragmented"><?= $Page->NonFragmented->caption() ?><?= $Page->NonFragmented->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->DFI->Visible) { // DFI ?>
    <div id="r_DFI" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_DFI" for="x_DFI" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_DFI"><?= $Page->DFI->caption() ?><?= $Page->DFI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->IsueBy->Visible) { // IsueBy ?>
    <div id="r_IsueBy" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_IsueBy" for="x_IsueBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_IsueBy"><?= $Page->IsueBy->caption() ?><?= $Page->IsueBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Volume2->Visible) { // Volume2 ?>
    <div id="r_Volume2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Volume2" for="x_Volume2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Volume2"><?= $Page->Volume2->caption() ?><?= $Page->Volume2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Concentration2->Visible) { // Concentration2 ?>
    <div id="r_Concentration2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Concentration2" for="x_Concentration2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Concentration2"><?= $Page->Concentration2->caption() ?><?= $Page->Concentration2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Total2->Visible) { // Total2 ?>
    <div id="r_Total2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Total2" for="x_Total2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Total2"><?= $Page->Total2->caption() ?><?= $Page->Total2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->ProgressiveMotility2->Visible) { // ProgressiveMotility2 ?>
    <div id="r_ProgressiveMotility2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_ProgressiveMotility2" for="x_ProgressiveMotility2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_ProgressiveMotility2"><?= $Page->ProgressiveMotility2->caption() ?><?= $Page->ProgressiveMotility2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->NonProgrssiveMotile2->Visible) { // NonProgrssiveMotile2 ?>
    <div id="r_NonProgrssiveMotile2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_NonProgrssiveMotile2" for="x_NonProgrssiveMotile2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_NonProgrssiveMotile2"><?= $Page->NonProgrssiveMotile2->caption() ?><?= $Page->NonProgrssiveMotile2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Immotile2->Visible) { // Immotile2 ?>
    <div id="r_Immotile2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_Immotile2" for="x_Immotile2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_Immotile2"><?= $Page->Immotile2->caption() ?><?= $Page->Immotile2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->TotalProgrssiveMotile2->Visible) { // TotalProgrssiveMotile2 ?>
    <div id="r_TotalProgrssiveMotile2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TotalProgrssiveMotile2" for="x_TotalProgrssiveMotile2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TotalProgrssiveMotile2"><?= $Page->TotalProgrssiveMotile2->caption() ?><?= $Page->TotalProgrssiveMotile2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->MACS->Visible) { // MACS ?>
    <div id="r_MACS" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_MACS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_MACS"><?= $Page->MACS->caption() ?><?= $Page->MACS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MACS">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="ivf_semenanalysisreport" data-field="x_MACS" name="x_MACS" id="x_MACS"<?= $Page->MACS->editAttributes() ?>>
...
<?php if ($Page->IssuedBy->Visible) { // IssuedBy ?>
    <div id="r_IssuedBy" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_IssuedBy" for="x_IssuedBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_IssuedBy"><?= $Page->IssuedBy->caption() ?><?= $Page->IssuedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->IssuedTo->Visible) { // IssuedTo ?>
    <div id="r_IssuedTo" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_IssuedTo" for="x_IssuedTo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_IssuedTo"><?= $Page->IssuedTo->caption() ?><?= $Page->IssuedTo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PaID->Visible) { // PaID ?>
    <div id="r_PaID" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PaID" for="x_PaID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PaID"><?= $Page->PaID->caption() ?><?= $Page->PaID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PaName->Visible) { // PaName ?>
    <div id="r_PaName" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PaName" for="x_PaName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PaName"><?= $Page->PaName->caption() ?><?= $Page->PaName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PaMobile->Visible) { // PaMobile ?>
    <div id="r_PaMobile" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PaMobile" for="x_PaMobile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PaMobile"><?= $Page->PaMobile->caption() ?><?= $Page->PaMobile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PartnerID->Visible) { // PartnerID ?>
    <div id="r_PartnerID" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PartnerID" for="x_PartnerID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PartnerID"><?= $Page->PartnerID->caption() ?><?= $Page->PartnerID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <div id="r_PartnerName" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PartnerName" for="x_PartnerName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PartnerName"><?= $Page->PartnerName->caption() ?><?= $Page->PartnerName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PartnerMobile->Visible) { // PartnerMobile ?>
    <div id="r_PartnerMobile" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PartnerMobile" for="x_PartnerMobile" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PartnerMobile"><?= $Page->PartnerMobile->caption() ?><?= $Page->PartnerMobile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PREG_TEST_DATE->Visible) { // PREG_TEST_DATE ?>
    <div id="r_PREG_TEST_DATE" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_PREG_TEST_DATE" for="x_PREG_TEST_DATE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_PREG_TEST_DATE"><?= $Page->PREG_TEST_DATE->caption() ?><?= $Page->PREG_TEST_DATE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->SPECIFIC_PROBLEMS->Visible) { // SPECIFIC_PROBLEMS ?>
    <div id="r_SPECIFIC_PROBLEMS" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_SPECIFIC_PROBLEMS" for="x_SPECIFIC_PROBLEMS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_SPECIFIC_PROBLEMS"><?= $Page->SPECIFIC_PROBLEMS->caption() ?><?= $Page->SPECIFIC_PROBLEMS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_SPECIFIC_PROBLEMS"><span id="el_ivf_semenanalysisreport_SPECIFIC_PROBLEMS">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_SPECIFIC_PROBLEMS"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_SPECIFIC_PROBLEMS']"),
        options = { name: "x_SPECIFIC_PROBLEMS", selectId: "ivf_semenanalysisreport_x_SPECIFIC_PROBLEMS", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->IMSC_1->Visible) { // IMSC_1 ?>
    <div id="r_IMSC_1" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_IMSC_1" for="x_IMSC_1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_IMSC_1"><?= $Page->IMSC_1->caption() ?><?= $Page->IMSC_1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->IMSC_2->Visible) { // IMSC_2 ?>
    <div id="r_IMSC_2" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_IMSC_2" for="x_IMSC_2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_IMSC_2"><?= $Page->IMSC_2->caption() ?><?= $Page->IMSC_2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->LIQUIFACTION_STORAGE->Visible) { // LIQUIFACTION_STORAGE ?>
    <div id="r_LIQUIFACTION_STORAGE" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_LIQUIFACTION_STORAGE" for="x_LIQUIFACTION_STORAGE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_LIQUIFACTION_STORAGE"><?= $Page->LIQUIFACTION_STORAGE->caption() ?><?= $Page->LIQUIFACTION_STORAGE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_LIQUIFACTION_STORAGE"><span id="el_ivf_semenanalysisreport_LIQUIFACTION_STORAGE">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_LIQUIFACTION_STORAGE"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_LIQUIFACTION_STORAGE']"),
        options = { name: "x_LIQUIFACTION_STORAGE", selectId: "ivf_semenanalysisreport_x_LIQUIFACTION_STORAGE", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->IUI_PREP_METHOD->Visible) { // IUI_PREP_METHOD ?>
    <div id="r_IUI_PREP_METHOD" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_IUI_PREP_METHOD" for="x_IUI_PREP_METHOD" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_IUI_PREP_METHOD"><?= $Page->IUI_PREP_METHOD->caption() ?><?= $Page->IUI_PREP_METHOD->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_IUI_PREP_METHOD"><span id="el_ivf_semenanalysisreport_IUI_PREP_METHOD">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_IUI_PREP_METHOD"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_IUI_PREP_METHOD']"),
        options = { name: "x_IUI_PREP_METHOD", selectId: "ivf_semenanalysisreport_x_IUI_PREP_METHOD", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->TIME_FROM_TRIGGER->Visible) { // TIME_FROM_TRIGGER ?>
    <div id="r_TIME_FROM_TRIGGER" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TIME_FROM_TRIGGER" for="x_TIME_FROM_TRIGGER" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TIME_FROM_TRIGGER"><?= $Page->TIME_FROM_TRIGGER->caption() ?><?= $Page->TIME_FROM_TRIGGER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_TIME_FROM_TRIGGER"><span id="el_ivf_semenanalysisreport_TIME_FROM_TRIGGER">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_TIME_FROM_TRIGGER"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_TIME_FROM_TRIGGER']"),
        options = { name: "x_TIME_FROM_TRIGGER", selectId: "ivf_semenanalysisreport_x_TIME_FROM_TRIGGER", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->COLLECTION_TO_PREPARATION->Visible) { // COLLECTION_TO_PREPARATION ?>
    <div id="r_COLLECTION_TO_PREPARATION" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION" for="x_COLLECTION_TO_PREPARATION" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION"><?= $Page->COLLECTION_TO_PREPARATION->caption() ?><?= $Page->COLLECTION_TO_PREPARATION->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION"><span id="el_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION">
    <select
        ...
        data-select2-id="ivf_semenanalysisreport_x_COLLECTION_TO_PREPARATION"
        data-table="ivf_semenanalysisreport"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_semenanalysisreport_x_COLLECTION_TO_PREPARATION']"),
        options = { name: "x_COLLECTION_TO_PREPARATION", selectId: "ivf_semenanalysisreport_x_COLLECTION_TO_PREPARATION", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->TIME_FROM_PREP_TO_INSEM->Visible) { // TIME_FROM_PREP_TO_INSEM ?>
    <div id="r_TIME_FROM_PREP_TO_INSEM" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_TIME_FROM_PREP_TO_INSEM" for="x_TIME_FROM_PREP_TO_INSEM" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_TIME_FROM_PREP_TO_INSEM"><?= $Page->TIME_FROM_PREP_TO_INSEM->caption() ?><?= $Page->TIME_FROM_PREP_TO_INSEM->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpm_ivf_semenanalysisreportadd">
<div id="ct_IvfSemenanalysisreportAdd"><style>
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_HusbandName"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_HusbandName"></slot></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_RIDNo"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_RIDNo"></slot></h3>
	</div>
</div>
<div id="divCheckbox" style="display: none;">
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PaID"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PaID"></slot>
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PaName"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PaName"></slot>
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PatientName"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PatientName"></slot>
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PaMobile"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PaMobile"></slot>
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PartnerID"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PartnerID"></slot>
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PartnerName"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PartnerName"></slot>
<slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PartnerMobile"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PartnerMobile"></slot>
</div>
<div class="row">
...
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:100%">
	<tbody>
		<tr>
			<td>Request Dr</td>
			<td><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_RequestDr"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_RequestDr"></slot></td>
		</tr>
	<tr>
...
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				 <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_RequestSample"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_RequestSample"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_CollectionType"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_CollectionType"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_CollectionMethod"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_CollectionMethod"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>
	...
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				<div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Abstinence"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Abstinence"></slot></span>
				  </div>
				<div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Medicationused"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Medicationused"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_DifficultiesinCollection"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_DifficultiesinCollection"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>				
...
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:50%">
	<tbody>
		<tr>
			<td><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_pH"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_pH"></slot>>=7.2</td>
			<td></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Timeofcollection"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Timeofcollection"></slot></td>
			<td></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Timeofexamination"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Timeofexamination"></slot></td>
			<td></td>
		</tr>
	</tbody>
</table>
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:50%">
	<tbody>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Appearance"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Appearance"></slot></td>
			<td ></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Color"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Color"></slot></td>
			<td ></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Homogenosity"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Homogenosity"></slot></td>
			<td ></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_CompleteSample"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_CompleteSample"></slot></td>
			<td ></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Liquefactiontime"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Liquefactiontime"></slot></td>
			<td></td>
		</tr>
	</tbody>
</table>
...
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:100%">
	<tbody>
	<tr>
			<td id="Method"><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Method"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Method"></slot></td>
			<td ></td>
			<td ></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Agglutination"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Agglutination"></slot></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_ImmatureForms"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_ImmatureForms"></slot></td>
			<td ></td>
			<td ></td>
			<td ></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Leucocytes"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Leucocytes"></slot></td>
			<td >%   <1 mill/ml or 20/field </td>
				<td ></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_Debris"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_Debris"></slot></td>
		</tr>
	</tbody>
</table>
</div>
...
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:100%">
	<tbody>
		...
		<tr>		
		<tr>
			<td id='InseminationTime'><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_InseminationTime"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_InseminationTime"></slot></td>
			<td ></td>
			<td ></td>
			<td id='InseminationBy'><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_InseminationBy"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_InseminationBy"></slot></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_ProcessedBy"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_ProcessedBy"></slot></td>
			...
			<td ></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_DoneBy"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_DoneBy"></slot></td>
		</tr>	
	</tbody>
</table>
</div>
...
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:100%">
	<tbody>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION"></slot></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_IMSC_1"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_IMSC_1"></slot></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_IMSC_2"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_IMSC_2"></slot></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_IUI_PREP_METHOD"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_IUI_PREP_METHOD"></slot></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_LIQUIFACTION_STORAGE"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_LIQUIFACTION_STORAGE"></slot></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_PREG_TEST_DATE"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_PREG_TEST_DATE"></slot></td>
		</tr>
		<tr>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_SPECIFIC_PROBLEMS"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_SPECIFIC_PROBLEMS"></slot></td>
			<td ><slot class="ew-slot" name="tpc_ivf_semenanalysisreport_TIME_FROM_TRIGGER"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_semenanalysisreport_TIME_FROM_TRIGGER"></slot></td>
			<td ></td>
		</tr>
	</tbody>
</table>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_semenanalysisreportadd", "tpm_ivf_semenanalysisreportadd", "ivf_semenanalysisreportadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
