...
<script>
if (!ew.vars.tables.pres_mas_route) ew.vars.tables.pres_mas_route = <?= JsonEncode(GetClientVar("tables", "pres_mas_route")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fpres_mas_routedelete" id="fpres_mas_routedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
