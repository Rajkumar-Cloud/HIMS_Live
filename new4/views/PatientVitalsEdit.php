...
loadjs.ready("head", function () {
    ...
    fpatient_vitalsedit.lists.AnticoagulantifAny = <?= $Page->AnticoagulantifAny->toClientList($Page) ?>;
    fpatient_vitalsedit.lists.GenericAllergies = <?= $Page->GenericAllergies->toClientList($Page) ?>;
    fpatient_vitalsedit.lists.GroupAllergies = <?= $Page->GroupAllergies->toClientList($Page) ?>;
    fpatient_vitalsedit.lists.clinicaldetails = <?= $Page->clinicaldetails->toClientList($Page) ?>;
    fpatient_vitalsedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fpatient_vitalsedit.lists.PatientSearch = <?= $Page->PatientSearch->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_vitalsedit" id="fpatient_vitalsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_patient_vitals_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_patient_vitals_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" data-table="patient_vitals" data-field="x_mrnno" data-hidden="1" name="x_mrnno" id="x_mrnno" value="<?= HtmlEncode($Page->mrnno->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_vitals" data-field="x_PatientName" data-hidden="1" name="x_PatientName" id="x_PatientName" value="<?= HtmlEncode($Page->PatientName->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_vitals" data-field="x_PatID" data-hidden="1" name="x_PatID" id="x_PatID" value="<?= HtmlEncode($Page->PatID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fpatient_vitalsedit"], function() {
    fpatient_vitalsedit.createAutoSuggest(Object.assign({"id":"x_AnticoagulantifAny","forceSelect":true}, ew.vars.tables.patient_vitals.fields.AnticoagulantifAny.autoSuggestOptions));
});
</script>
...
<input type="hidden" data-table="patient_vitals" data-field="x_PatientId" data-hidden="1" name="x_PatientId" id="x_PatientId" value="<?= HtmlEncode($Page->PatientId->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_vitals" data-field="x_Reception" data-hidden="1" name="x_Reception" id="x_Reception" value="<?= HtmlEncode($Page->Reception->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
</div><!-- /page* -->
<div id="tpd_patient_vitalsedit" class="ew-custom-template"></div>
<template id="tpm_patient_vitalsedit">
<div id="ct_PatientVitalsEdit"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_vitalsedit", "tpm_patient_vitalsedit", "patient_vitalsedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
