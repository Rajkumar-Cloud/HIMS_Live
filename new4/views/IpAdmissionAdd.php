...
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fip_admissionadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fip_admissionadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fip_admissionadd.lists.gender = <?= $Page->gender->toClientList($Page) ?>;
    fip_admissionadd.lists.typeRegsisteration = <?= $Page->typeRegsisteration->toClientList($Page) ?>;
    fip_admissionadd.lists.PaymentCategory = <?= $Page->PaymentCategory->toClientList($Page) ?>;
    fip_admissionadd.lists.physician_id = <?= $Page->physician_id->toClientList($Page) ?>;
    fip_admissionadd.lists.admission_consultant_id = <?= $Page->admission_consultant_id->toClientList($Page) ?>;
    fip_admissionadd.lists.leading_consultant_id = <?= $Page->leading_consultant_id->toClientList($Page) ?>;
    fip_admissionadd.lists.PaymentStatus = <?= $Page->PaymentStatus->toClientList($Page) ?>;
    fip_admissionadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fip_admissionadd.lists.HospID = <?= $Page->HospID->toClientList($Page) ?>;
    fip_admissionadd.lists.ReferedByDr = <?= $Page->ReferedByDr->toClientList($Page) ?>;
    fip_admissionadd.lists.ReferA4TreatingConsultant = <?= $Page->ReferA4TreatingConsultant->toClientList($Page) ?>;
    fip_admissionadd.lists.patient_id = <?= $Page->patient_id->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fip_admissionadd" id="fip_admissionadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fip_admissionadd"], function() {
    fip_admissionadd.createAutoSuggest(Object.assign({"id":"x_gender","forceSelect":false}, ew.vars.tables.ip_admission.fields.gender.autoSuggestOptions));
});
</script>
...
<template id="tpm_ip_admissionadd">
<div id="ct_IpAdmissionAdd"><style>
...
<?php } ?>
<?php
    if (in_array("patient_history", explode(",", $Page->getCurrentDetailTable())) && $patient_history->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_provisional_diagnosis", explode(",", $Page->getCurrentDetailTable())) && $patient_provisional_diagnosis->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_prescription", explode(",", $Page->getCurrentDetailTable())) && $patient_prescription->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_final_diagnosis", explode(",", $Page->getCurrentDetailTable())) && $patient_final_diagnosis->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_follow_up", explode(",", $Page->getCurrentDetailTable())) && $patient_follow_up->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_ot_delivery_register", explode(",", $Page->getCurrentDetailTable())) && $patient_ot_delivery_register->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_ot_surgery_register", explode(",", $Page->getCurrentDetailTable())) && $patient_ot_surgery_register->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_services", explode(",", $Page->getCurrentDetailTable())) && $patient_services->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_investigations", explode(",", $Page->getCurrentDetailTable())) && $patient_investigations->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_insurance", explode(",", $Page->getCurrentDetailTable())) && $patient_insurance->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("view_ip_advance", explode(",", $Page->getCurrentDetailTable())) && $view_ip_advance->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("patient_room", explode(",", $Page->getCurrentDetailTable())) && $patient_room->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ip_admissionadd", "tpm_ip_admissionadd", "ip_admissionadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
