...
// Page object
$EmployeesPayrollAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployees_payrolladd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployees_payrolladd = currentForm = new ew.Form("femployees_payrolladd", "add");
    ...
    femployees_payrolladd.addFields([
    ...
    // Form_CustomValidate
    femployees_payrolladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployees_payrolladd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("femployees_payrolladd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployees_payrolladd" id="femployees_payrolladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
