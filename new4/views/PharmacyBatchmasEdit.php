...
loadjs.ready("head", function () {
    ...
    fpharmacy_batchmasedit.lists.PrName = <?= $Page->PrName->toClientList($Page) ?>;
    fpharmacy_batchmasedit.lists.BRCODE = <?= $Page->BRCODE->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_batchmasedit" id="fpharmacy_batchmasedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpharmacy_batchmasedit"], function() {
    fpharmacy_batchmasedit.createAutoSuggest(Object.assign({"id":"x_PrName","forceSelect":true}, ew.vars.tables.pharmacy_batchmas.fields.PrName.autoSuggestOptions));
});
</script>
