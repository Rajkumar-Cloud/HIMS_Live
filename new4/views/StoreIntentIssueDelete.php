...
<script>
if (!ew.vars.tables.store_intent_issue) ew.vars.tables.store_intent_issue = <?= JsonEncode(GetClientVar("tables", "store_intent_issue")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fstore_intent_issuedelete" id="fstore_intent_issuedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <th class="<?= $Page->StoreID->headerCellClass() ?>"><span id="elh_store_intent_issue_StoreID" class="store_intent_issue_StoreID"><?= $Page->StoreID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->BranchID->Visible) { // BranchID ?>
        <th class="<?= $Page->BranchID->headerCellClass() ?>"><span id="elh_store_intent_issue_BranchID" class="store_intent_issue_BranchID"><?= $Page->BranchID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_store_intent_issue_StoreID" class="store_intent_issue_StoreID">
...
<span id="el<?= $Page->RowCount ?>_store_intent_issue_BranchID" class="store_intent_issue_BranchID">
