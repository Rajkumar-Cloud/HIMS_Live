...
// Page object
$StoreIntentIssueEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fstore_intent_issueedit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "store_intent_issue")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.store_intent_issue)
        ew.vars.tables.store_intent_issue = currentTable;
    fstore_intent_issueedit.addFields([
    ...
    // Form_CustomValidate
    fstore_intent_issueedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fstore_intent_issueedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fstore_intent_issueedit" id="fstore_intent_issueedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_store_intent_issue_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_store_intent_issue_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="store_intent_issue" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <div id="r_StoreID" class="form-group row">
        <label id="elh_store_intent_issue_StoreID" for="x_StoreID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->StoreID->caption() ?><?= $Page->StoreID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->StoreID->cellAttributes() ?>>
<span id="el_store_intent_issue_StoreID">
<input type="<?= $Page->StoreID->getInputTextType() ?>" data-table="store_intent_issue" data-field="x_StoreID" name="x_StoreID" id="x_StoreID" size="30" placeholder="<?= HtmlEncode($Page->StoreID->getPlaceHolder()) ?>" value="<?= $Page->StoreID->EditValue ?>"<?= $Page->StoreID->editAttributes() ?> aria-describedby="x_StoreID_help">
...
<?php if ($Page->BranchID->Visible) { // BranchID ?>
    <div id="r_BranchID" class="form-group row">
        <label id="elh_store_intent_issue_BranchID" for="x_BranchID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BranchID->caption() ?><?= $Page->BranchID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BranchID->cellAttributes() ?>>
<span id="el_store_intent_issue_BranchID">
<input type="<?= $Page->BranchID->getInputTextType() ?>" data-table="store_intent_issue" data-field="x_BranchID" name="x_BranchID" id="x_BranchID" size="30" placeholder="<?= HtmlEncode($Page->BranchID->getPlaceHolder()) ?>" value="<?= $Page->BranchID->EditValue ?>"<?= $Page->BranchID->editAttributes() ?> aria-describedby="x_BranchID_help">
