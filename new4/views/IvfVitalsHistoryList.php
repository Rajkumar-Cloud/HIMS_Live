...
<form name="fivf_vitals_historylistsrch" id="fivf_vitals_historylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fivf_vitals_historylist" id="fivf_vitals_historylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->DoublewitnessName1->Visible) { // DoublewitnessName1 ?>
        <th data-name="DoublewitnessName1" class="<?= $Page->DoublewitnessName1->headerCellClass() ?>"><div id="elh_ivf_vitals_history_DoublewitnessName1" class="ivf_vitals_history_DoublewitnessName1"><?= $Page->renderSort($Page->DoublewitnessName1) ?></div></th>
<?php } ?>
<?php if ($Page->DoublewitnessName2->Visible) { // DoublewitnessName2 ?>
        <th data-name="DoublewitnessName2" class="<?= $Page->DoublewitnessName2->headerCellClass() ?>"><div id="elh_ivf_vitals_history_DoublewitnessName2" class="ivf_vitals_history_DoublewitnessName2"><?= $Page->renderSort($Page->DoublewitnessName2) ?></div></th>
<?php } ?>
<?php if ($Page->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
        <th data-name="Chiefcomplaints" class="<?= $Page->Chiefcomplaints->headerCellClass() ?>"><div id="elh_ivf_vitals_history_Chiefcomplaints" class="ivf_vitals_history_Chiefcomplaints"><?= $Page->renderSort($Page->Chiefcomplaints) ?></div></th>
<?php } ?>
<?php if ($Page->MenstrualHistory->Visible) { // MenstrualHistory ?>
        <th data-name="MenstrualHistory" class="<?= $Page->MenstrualHistory->headerCellClass() ?>"><div id="elh_ivf_vitals_history_MenstrualHistory" class="ivf_vitals_history_MenstrualHistory"><?= $Page->renderSort($Page->MenstrualHistory) ?></div></th>
<?php } ?>
<?php if ($Page->ObstetricHistory->Visible) { // ObstetricHistory ?>
        <th data-name="ObstetricHistory" class="<?= $Page->ObstetricHistory->headerCellClass() ?>"><div id="elh_ivf_vitals_history_ObstetricHistory" class="ivf_vitals_history_ObstetricHistory"><?= $Page->renderSort($Page->ObstetricHistory) ?></div></th>
<?php } ?>
...
<?php if ($Page->AntiTPO->Visible) { // AntiTPO ?>
        <th data-name="AntiTPO" class="<?= $Page->AntiTPO->headerCellClass() ?>"><div id="elh_ivf_vitals_history_AntiTPO" class="ivf_vitals_history_AntiTPO"><?= $Page->renderSort($Page->AntiTPO) ?></div></th>
<?php } ?>
<?php if ($Page->AntiTG->Visible) { // AntiTG ?>
        <th data-name="AntiTG" class="<?= $Page->AntiTG->headerCellClass() ?>"><div id="elh_ivf_vitals_history_AntiTG" class="ivf_vitals_history_AntiTG"><?= $Page->renderSort($Page->AntiTG) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_DoublewitnessName1">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_DoublewitnessName2">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_Chiefcomplaints">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_MenstrualHistory">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_ObstetricHistory">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_AntiTPO">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_AntiTG">
