...
<form name="freceptionlistsrch" id="freceptionlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="freceptionlist" id="freceptionlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->MODEOFPAYMENT->Visible) { // MODE OF PAYMENT ?>
        <th data-name="MODEOFPAYMENT" class="<?= $Page->MODEOFPAYMENT->headerCellClass() ?>"><div id="elh_reception_MODEOFPAYMENT" class="reception_MODEOFPAYMENT"><?= $Page->renderSort($Page->MODEOFPAYMENT) ?></div></th>
<?php } ?>
<?php if ($Page->NEXTREVIEWDATE->Visible) { // NEXT REVIEW DATE ?>
        <th data-name="NEXTREVIEWDATE" class="<?= $Page->NEXTREVIEWDATE->headerCellClass() ?>"><div id="elh_reception_NEXTREVIEWDATE" class="reception_NEXTREVIEWDATE"><?= $Page->renderSort($Page->NEXTREVIEWDATE) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_reception_MODEOFPAYMENT">
...
<span id="el<?= $Page->RowCount ?>_reception_NEXTREVIEWDATE">
