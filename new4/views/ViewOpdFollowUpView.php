...
// Page object
$ViewOpdFollowUpView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_opd_follow_upview;
...
$Page->showMessage();
?>
<form name="fview_opd_follow_upview" id="fview_opd_follow_upview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_Reception"><?= $Page->Reception->caption() ?></span></td>
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <tr id="r_PatientId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_PatientId"><?= $Page->PatientId->caption() ?></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_mrnno"><?= $Page->mrnno->caption() ?></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_PatientName"><?= $Page->PatientName->caption() ?></span></td>
...
<?php if ($Page->Telephone->Visible) { // Telephone ?>
    <tr id="r_Telephone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_Telephone"><?= $Page->Telephone->caption() ?></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_Age"><?= $Page->Age->caption() ?></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_Gender"><?= $Page->Gender->caption() ?></span></td>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <tr id="r_profilePic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_profilePic"><?= $Page->profilePic->caption() ?></span></td>
...
<?php if ($Page->procedurenotes->Visible) { // procedurenotes ?>
    <tr id="r_procedurenotes">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_procedurenotes"><?= $Page->procedurenotes->caption() ?></span></td>
...
<?php if ($Page->NextReviewDate->Visible) { // NextReviewDate ?>
    <tr id="r_NextReviewDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_NextReviewDate"><?= $Page->NextReviewDate->caption() ?></span></td>
...
<?php if ($Page->ICSIAdvised->Visible) { // ICSIAdvised ?>
    <tr id="r_ICSIAdvised">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_ICSIAdvised"><?= $Page->ICSIAdvised->caption() ?></span></td>
...
<?php if ($Page->DeliveryRegistered->Visible) { // DeliveryRegistered ?>
    <tr id="r_DeliveryRegistered">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_DeliveryRegistered"><?= $Page->DeliveryRegistered->caption() ?></span></td>
...
<?php if ($Page->EDD->Visible) { // EDD ?>
    <tr id="r_EDD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_EDD"><?= $Page->EDD->caption() ?></span></td>
...
<?php if ($Page->SerologyPositive->Visible) { // SerologyPositive ?>
    <tr id="r_SerologyPositive">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_SerologyPositive"><?= $Page->SerologyPositive->caption() ?></span></td>
...
<?php if ($Page->Allergy->Visible) { // Allergy ?>
    <tr id="r_Allergy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_Allergy"><?= $Page->Allergy->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->LMP->Visible) { // LMP ?>
    <tr id="r_LMP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_LMP"><?= $Page->LMP->caption() ?></span></td>
...
<?php if ($Page->Procedure->Visible) { // Procedure ?>
    <tr id="r_Procedure">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_Procedure"><?= $Page->Procedure->caption() ?></span></td>
...
<?php if ($Page->ProcedureDateTime->Visible) { // ProcedureDateTime ?>
    <tr id="r_ProcedureDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_ProcedureDateTime"><?= $Page->ProcedureDateTime->caption() ?></span></td>
...
<?php if ($Page->ICSIDate->Visible) { // ICSIDate ?>
    <tr id="r_ICSIDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_ICSIDate"><?= $Page->ICSIDate->caption() ?></span></td>
...
<?php if ($Page->RIDNo->Visible) { // RIDNo ?>
    <tr id="r_RIDNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_opd_follow_up_RIDNo"><?= $Page->RIDNo->caption() ?></span></td>
