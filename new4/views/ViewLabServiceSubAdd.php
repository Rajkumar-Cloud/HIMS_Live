...
// Page object
$ViewLabServiceSubAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_lab_service_subadd;
loadjs.ready("head", function () {
    ...
    fview_lab_service_subadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_lab_service_subadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_lab_service_subadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_lab_service_subadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_lab_service_subadd.lists.UNITS = <?= $Page->UNITS->toClientList($Page) ?>;
    fview_lab_service_subadd.lists.SERVICE_TYPE = <?= $Page->SERVICE_TYPE->toClientList($Page) ?>;
    fview_lab_service_subadd.lists.DEPARTMENT = <?= $Page->DEPARTMENT->toClientList($Page) ?>;
    fview_lab_service_subadd.lists.Inactive = <?= $Page->Inactive->toClientList($Page) ?>;
    fview_lab_service_subadd.lists.TestType = <?= $Page->TestType->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_lab_service_subadd" id="fview_lab_service_subadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fview_lab_service_subadd", "editor"], function() {
	ew.createEditor("fview_lab_service_subadd", "x_Interpretation", 35, 4, <?= $Page->Interpretation->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
