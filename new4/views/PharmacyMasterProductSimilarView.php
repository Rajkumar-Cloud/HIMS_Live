...
<?php } ?>
<script>
if (!ew.vars.tables.pharmacy_master_product_similar) ew.vars.tables.pharmacy_master_product_similar = <?= JsonEncode(GetClientVar("tables", "pharmacy_master_product_similar")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fpharmacy_master_product_similarview" id="fpharmacy_master_product_similarview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
