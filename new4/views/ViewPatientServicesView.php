...
// Page object
$ViewPatientServicesView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_patient_servicesview;
...
$Page->showMessage();
?>
<form name="fview_patient_servicesview" id="fview_patient_servicesview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Reception"><?= $Page->Reception->caption() ?></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_mrnno"><?= $Page->mrnno->caption() ?></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PatientName"><?= $Page->PatientName->caption() ?></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Age"><?= $Page->Age->caption() ?></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Gender"><?= $Page->Gender->caption() ?></span></td>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <tr id="r_profilePic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_profilePic"><?= $Page->profilePic->caption() ?></span></td>
...
<?php if ($Page->Services->Visible) { // Services ?>
    <tr id="r_Services">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Services"><?= $Page->Services->caption() ?></span></td>
...
<?php if ($Page->Unit->Visible) { // Unit ?>
    <tr id="r_Unit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Unit"><?= $Page->Unit->caption() ?></span></td>
...
<?php if ($Page->amount->Visible) { // amount ?>
    <tr id="r_amount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_amount"><?= $Page->amount->caption() ?></span></td>
...
<?php if ($Page->Quantity->Visible) { // Quantity ?>
    <tr id="r_Quantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Quantity"><?= $Page->Quantity->caption() ?></span></td>
...
<?php if ($Page->DiscountCategory->Visible) { // DiscountCategory ?>
    <tr id="r_DiscountCategory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DiscountCategory"><?= $Page->DiscountCategory->caption() ?></span></td>
...
<?php if ($Page->Discount->Visible) { // Discount ?>
    <tr id="r_Discount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Discount"><?= $Page->Discount->caption() ?></span></td>
...
<?php if ($Page->SubTotal->Visible) { // SubTotal ?>
    <tr id="r_SubTotal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SubTotal"><?= $Page->SubTotal->caption() ?></span></td>
...
<?php if ($Page->description->Visible) { // description ?>
    <tr id="r_description">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_description"><?= $Page->description->caption() ?></span></td>
...
<?php if ($Page->patient_type->Visible) { // patient_type ?>
    <tr id="r_patient_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_patient_type"><?= $Page->patient_type->caption() ?></span></td>
...
<?php if ($Page->charged_date->Visible) { // charged_date ?>
    <tr id="r_charged_date">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_charged_date"><?= $Page->charged_date->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->Aid->Visible) { // Aid ?>
    <tr id="r_Aid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Aid"><?= $Page->Aid->caption() ?></span></td>
...
<?php if ($Page->Vid->Visible) { // Vid ?>
    <tr id="r_Vid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Vid"><?= $Page->Vid->caption() ?></span></td>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <tr id="r_DrID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrID"><?= $Page->DrID->caption() ?></span></td>
...
<?php if ($Page->DrCODE->Visible) { // DrCODE ?>
    <tr id="r_DrCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrCODE"><?= $Page->DrCODE->caption() ?></span></td>
...
<?php if ($Page->DrName->Visible) { // DrName ?>
    <tr id="r_DrName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrName"><?= $Page->DrName->caption() ?></span></td>
...
<?php if ($Page->Department->Visible) { // Department ?>
    <tr id="r_Department">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Department"><?= $Page->Department->caption() ?></span></td>
...
<?php if ($Page->DrSharePres->Visible) { // DrSharePres ?>
    <tr id="r_DrSharePres">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrSharePres"><?= $Page->DrSharePres->caption() ?></span></td>
...
<?php if ($Page->HospSharePres->Visible) { // HospSharePres ?>
    <tr id="r_HospSharePres">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_HospSharePres"><?= $Page->HospSharePres->caption() ?></span></td>
...
<?php if ($Page->DrShareAmount->Visible) { // DrShareAmount ?>
    <tr id="r_DrShareAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareAmount"><?= $Page->DrShareAmount->caption() ?></span></td>
...
<?php if ($Page->HospShareAmount->Visible) { // HospShareAmount ?>
    <tr id="r_HospShareAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_HospShareAmount"><?= $Page->HospShareAmount->caption() ?></span></td>
...
<?php if ($Page->DrShareSettiledAmount->Visible) { // DrShareSettiledAmount ?>
    <tr id="r_DrShareSettiledAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareSettiledAmount"><?= $Page->DrShareSettiledAmount->caption() ?></span></td>
...
<?php if ($Page->DrShareSettledId->Visible) { // DrShareSettledId ?>
    <tr id="r_DrShareSettledId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareSettledId"><?= $Page->DrShareSettledId->caption() ?></span></td>
...
<?php if ($Page->DrShareSettiledStatus->Visible) { // DrShareSettiledStatus ?>
    <tr id="r_DrShareSettiledStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareSettiledStatus"><?= $Page->DrShareSettiledStatus->caption() ?></span></td>
...
<?php if ($Page->invoiceId->Visible) { // invoiceId ?>
    <tr id="r_invoiceId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_invoiceId"><?= $Page->invoiceId->caption() ?></span></td>
...
<?php if ($Page->invoiceAmount->Visible) { // invoiceAmount ?>
    <tr id="r_invoiceAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_invoiceAmount"><?= $Page->invoiceAmount->caption() ?></span></td>
...
<?php if ($Page->invoiceStatus->Visible) { // invoiceStatus ?>
    <tr id="r_invoiceStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_invoiceStatus"><?= $Page->invoiceStatus->caption() ?></span></td>
...
<?php if ($Page->modeOfPayment->Visible) { // modeOfPayment ?>
    <tr id="r_modeOfPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_modeOfPayment"><?= $Page->modeOfPayment->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <tr id="r_RIDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RIDNO"><?= $Page->RIDNO->caption() ?></span></td>
...
<?php if ($Page->ItemCode->Visible) { // ItemCode ?>
    <tr id="r_ItemCode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ItemCode"><?= $Page->ItemCode->caption() ?></span></td>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <tr id="r_TidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TidNo"><?= $Page->TidNo->caption() ?></span></td>
...
<?php if ($Page->sid->Visible) { // sid ?>
    <tr id="r_sid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_sid"><?= $Page->sid->caption() ?></span></td>
...
<?php if ($Page->TestSubCd->Visible) { // TestSubCd ?>
    <tr id="r_TestSubCd">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestSubCd"><?= $Page->TestSubCd->caption() ?></span></td>
...
<?php if ($Page->DEptCd->Visible) { // DEptCd ?>
    <tr id="r_DEptCd">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DEptCd"><?= $Page->DEptCd->caption() ?></span></td>
...
<?php if ($Page->ProfCd->Visible) { // ProfCd ?>
    <tr id="r_ProfCd">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ProfCd"><?= $Page->ProfCd->caption() ?></span></td>
...
<?php if ($Page->LabReport->Visible) { // LabReport ?>
    <tr id="r_LabReport">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_LabReport"><?= $Page->LabReport->caption() ?></span></td>
...
<?php if ($Page->Comments->Visible) { // Comments ?>
    <tr id="r_Comments">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Comments"><?= $Page->Comments->caption() ?></span></td>
...
<?php if ($Page->Method->Visible) { // Method ?>
    <tr id="r_Method">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Method"><?= $Page->Method->caption() ?></span></td>
...
<?php if ($Page->Specimen->Visible) { // Specimen ?>
    <tr id="r_Specimen">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Specimen"><?= $Page->Specimen->caption() ?></span></td>
...
<?php if ($Page->Abnormal->Visible) { // Abnormal ?>
    <tr id="r_Abnormal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Abnormal"><?= $Page->Abnormal->caption() ?></span></td>
...
<?php if ($Page->RefValue->Visible) { // RefValue ?>
    <tr id="r_RefValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RefValue"><?= $Page->RefValue->caption() ?></span></td>
...
<?php if ($Page->TestUnit->Visible) { // TestUnit ?>
    <tr id="r_TestUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestUnit"><?= $Page->TestUnit->caption() ?></span></td>
...
<?php if ($Page->LOWHIGH->Visible) { // LOWHIGH ?>
    <tr id="r_LOWHIGH">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_LOWHIGH"><?= $Page->LOWHIGH->caption() ?></span></td>
...
<?php if ($Page->Branch->Visible) { // Branch ?>
    <tr id="r_Branch">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Branch"><?= $Page->Branch->caption() ?></span></td>
...
<?php if ($Page->Dispatch->Visible) { // Dispatch ?>
    <tr id="r_Dispatch">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Dispatch"><?= $Page->Dispatch->caption() ?></span></td>
...
<?php if ($Page->Pic1->Visible) { // Pic1 ?>
    <tr id="r_Pic1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Pic1"><?= $Page->Pic1->caption() ?></span></td>
...
<?php if ($Page->Pic2->Visible) { // Pic2 ?>
    <tr id="r_Pic2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Pic2"><?= $Page->Pic2->caption() ?></span></td>
...
<?php if ($Page->GraphPath->Visible) { // GraphPath ?>
    <tr id="r_GraphPath">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_GraphPath"><?= $Page->GraphPath->caption() ?></span></td>
...
<?php if ($Page->MachineCD->Visible) { // MachineCD ?>
    <tr id="r_MachineCD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_MachineCD"><?= $Page->MachineCD->caption() ?></span></td>
...
<?php if ($Page->TestCancel->Visible) { // TestCancel ?>
    <tr id="r_TestCancel">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestCancel"><?= $Page->TestCancel->caption() ?></span></td>
...
<?php if ($Page->OutSource->Visible) { // OutSource ?>
    <tr id="r_OutSource">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_OutSource"><?= $Page->OutSource->caption() ?></span></td>
...
<?php if ($Page->Printed->Visible) { // Printed ?>
    <tr id="r_Printed">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Printed"><?= $Page->Printed->caption() ?></span></td>
...
<?php if ($Page->PrintBy->Visible) { // PrintBy ?>
    <tr id="r_PrintBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PrintBy"><?= $Page->PrintBy->caption() ?></span></td>
...
<?php if ($Page->PrintDate->Visible) { // PrintDate ?>
    <tr id="r_PrintDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PrintDate"><?= $Page->PrintDate->caption() ?></span></td>
...
<?php if ($Page->BillingDate->Visible) { // BillingDate ?>
    <tr id="r_BillingDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_BillingDate"><?= $Page->BillingDate->caption() ?></span></td>
...
<?php if ($Page->BilledBy->Visible) { // BilledBy ?>
    <tr id="r_BilledBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_BilledBy"><?= $Page->BilledBy->caption() ?></span></td>
...
<?php if ($Page->Resulted->Visible) { // Resulted ?>
    <tr id="r_Resulted">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Resulted"><?= $Page->Resulted->caption() ?></span></td>
...
<?php if ($Page->ResultDate->Visible) { // ResultDate ?>
    <tr id="r_ResultDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ResultDate"><?= $Page->ResultDate->caption() ?></span></td>
...
<?php if ($Page->ResultedBy->Visible) { // ResultedBy ?>
    <tr id="r_ResultedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ResultedBy"><?= $Page->ResultedBy->caption() ?></span></td>
...
<?php if ($Page->SampleDate->Visible) { // SampleDate ?>
    <tr id="r_SampleDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SampleDate"><?= $Page->SampleDate->caption() ?></span></td>
...
<?php if ($Page->SampleUser->Visible) { // SampleUser ?>
    <tr id="r_SampleUser">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SampleUser"><?= $Page->SampleUser->caption() ?></span></td>
...
<?php if ($Page->Sampled->Visible) { // Sampled ?>
    <tr id="r_Sampled">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Sampled"><?= $Page->Sampled->caption() ?></span></td>
...
<?php if ($Page->ReceivedDate->Visible) { // ReceivedDate ?>
    <tr id="r_ReceivedDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ReceivedDate"><?= $Page->ReceivedDate->caption() ?></span></td>
...
<?php if ($Page->ReceivedUser->Visible) { // ReceivedUser ?>
    <tr id="r_ReceivedUser">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ReceivedUser"><?= $Page->ReceivedUser->caption() ?></span></td>
...
<?php if ($Page->Recevied->Visible) { // Recevied ?>
    <tr id="r_Recevied">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Recevied"><?= $Page->Recevied->caption() ?></span></td>
...
<?php if ($Page->DeptRecvDate->Visible) { // DeptRecvDate ?>
    <tr id="r_DeptRecvDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DeptRecvDate"><?= $Page->DeptRecvDate->caption() ?></span></td>
...
<?php if ($Page->DeptRecvUser->Visible) { // DeptRecvUser ?>
    <tr id="r_DeptRecvUser">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DeptRecvUser"><?= $Page->DeptRecvUser->caption() ?></span></td>
...
<?php if ($Page->DeptRecived->Visible) { // DeptRecived ?>
    <tr id="r_DeptRecived">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DeptRecived"><?= $Page->DeptRecived->caption() ?></span></td>
...
<?php if ($Page->SAuthDate->Visible) { // SAuthDate ?>
    <tr id="r_SAuthDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SAuthDate"><?= $Page->SAuthDate->caption() ?></span></td>
...
<?php if ($Page->SAuthBy->Visible) { // SAuthBy ?>
    <tr id="r_SAuthBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SAuthBy"><?= $Page->SAuthBy->caption() ?></span></td>
...
<?php if ($Page->SAuthendicate->Visible) { // SAuthendicate ?>
    <tr id="r_SAuthendicate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SAuthendicate"><?= $Page->SAuthendicate->caption() ?></span></td>
...
<?php if ($Page->AuthDate->Visible) { // AuthDate ?>
    <tr id="r_AuthDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_AuthDate"><?= $Page->AuthDate->caption() ?></span></td>
...
<?php if ($Page->AuthBy->Visible) { // AuthBy ?>
    <tr id="r_AuthBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_AuthBy"><?= $Page->AuthBy->caption() ?></span></td>
...
<?php if ($Page->Authencate->Visible) { // Authencate ?>
    <tr id="r_Authencate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Authencate"><?= $Page->Authencate->caption() ?></span></td>
...
<?php if ($Page->EditDate->Visible) { // EditDate ?>
    <tr id="r_EditDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_EditDate"><?= $Page->EditDate->caption() ?></span></td>
...
<?php if ($Page->EditBy->Visible) { // EditBy ?>
    <tr id="r_EditBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_EditBy"><?= $Page->EditBy->caption() ?></span></td>
...
<?php if ($Page->Editted->Visible) { // Editted ?>
    <tr id="r_Editted">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Editted"><?= $Page->Editted->caption() ?></span></td>
...
<?php if ($Page->PatID->Visible) { // PatID ?>
    <tr id="r_PatID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PatID"><?= $Page->PatID->caption() ?></span></td>
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <tr id="r_PatientId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PatientId"><?= $Page->PatientId->caption() ?></span></td>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <tr id="r_Mobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Mobile"><?= $Page->Mobile->caption() ?></span></td>
...
<?php if ($Page->CId->Visible) { // CId ?>
    <tr id="r_CId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_CId"><?= $Page->CId->caption() ?></span></td>
...
<?php if ($Page->Order->Visible) { // Order ?>
    <tr id="r_Order">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Order"><?= $Page->Order->caption() ?></span></td>
...
<?php if ($Page->Form->Visible) { // Form ?>
    <tr id="r_Form">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Form"><?= $Page->Form->caption() ?></span></td>
...
<?php if ($Page->ResType->Visible) { // ResType ?>
    <tr id="r_ResType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ResType"><?= $Page->ResType->caption() ?></span></td>
...
<?php if ($Page->Sample->Visible) { // Sample ?>
    <tr id="r_Sample">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Sample"><?= $Page->Sample->caption() ?></span></td>
...
<?php if ($Page->NoD->Visible) { // NoD ?>
    <tr id="r_NoD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_NoD"><?= $Page->NoD->caption() ?></span></td>
...
<?php if ($Page->BillOrder->Visible) { // BillOrder ?>
    <tr id="r_BillOrder">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_BillOrder"><?= $Page->BillOrder->caption() ?></span></td>
...
<?php if ($Page->Formula->Visible) { // Formula ?>
    <tr id="r_Formula">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Formula"><?= $Page->Formula->caption() ?></span></td>
...
<?php if ($Page->Inactive->Visible) { // Inactive ?>
    <tr id="r_Inactive">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Inactive"><?= $Page->Inactive->caption() ?></span></td>
...
<?php if ($Page->CollSample->Visible) { // CollSample ?>
    <tr id="r_CollSample">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_CollSample"><?= $Page->CollSample->caption() ?></span></td>
...
<?php if ($Page->TestType->Visible) { // TestType ?>
    <tr id="r_TestType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestType"><?= $Page->TestType->caption() ?></span></td>
...
<?php if ($Page->Repeated->Visible) { // Repeated ?>
    <tr id="r_Repeated">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Repeated"><?= $Page->Repeated->caption() ?></span></td>
...
<?php if ($Page->RepeatedBy->Visible) { // RepeatedBy ?>
    <tr id="r_RepeatedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RepeatedBy"><?= $Page->RepeatedBy->caption() ?></span></td>
...
<?php if ($Page->RepeatedDate->Visible) { // RepeatedDate ?>
    <tr id="r_RepeatedDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RepeatedDate"><?= $Page->RepeatedDate->caption() ?></span></td>
...
<?php if ($Page->serviceID->Visible) { // serviceID ?>
    <tr id="r_serviceID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_serviceID"><?= $Page->serviceID->caption() ?></span></td>
...
<?php if ($Page->Service_Type->Visible) { // Service_Type ?>
    <tr id="r_Service_Type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Service_Type"><?= $Page->Service_Type->caption() ?></span></td>
...
<?php if ($Page->Service_Department->Visible) { // Service_Department ?>
    <tr id="r_Service_Department">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Service_Department"><?= $Page->Service_Department->caption() ?></span></td>
...
<?php if ($Page->RequestNo->Visible) { // RequestNo ?>
    <tr id="r_RequestNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RequestNo"><?= $Page->RequestNo->caption() ?></span></td>
