...
// Page object
$EmployeeRoleJobDescriptionAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_role_job_descriptionadd;
loadjs.ready("head", function () {
    ...
    femployee_role_job_descriptionadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_role_job_descriptionadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_role_job_descriptionadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_role_job_descriptionadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="femployee_role_job_descriptionadd" id="femployee_role_job_descriptionadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
