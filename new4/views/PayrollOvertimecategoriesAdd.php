...
// Page object
$PayrollOvertimecategoriesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpayroll_overtimecategoriesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpayroll_overtimecategoriesadd = currentForm = new ew.Form("fpayroll_overtimecategoriesadd", "add");
    ...
    fpayroll_overtimecategoriesadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpayroll_overtimecategoriesadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpayroll_overtimecategoriesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpayroll_overtimecategoriesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpayroll_overtimecategoriesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpayroll_overtimecategoriesadd" id="fpayroll_overtimecategoriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpayroll_overtimecategoriesadd", "datetimepicker"], function() {
