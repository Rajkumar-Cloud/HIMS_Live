...
loadjs.ready("head", function () {
    ...
    fpatient_telephoneedit.lists.tele_type = <?= $Page->tele_type->toClientList($Page) ?>;
    fpatient_telephoneedit.lists.telephone_type = <?= $Page->telephone_type->toClientList($Page) ?>;
    fpatient_telephoneedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_telephoneedit" id="fpatient_telephoneedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="patient_telephone" data-field="x_patient_id" data-hidden="1" name="x_patient_id" id="x_patient_id" value="<?= HtmlEncode($Page->patient_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
