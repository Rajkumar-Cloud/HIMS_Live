...
// Page object
$StoreSuppliersEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fstore_suppliersedit;
loadjs.ready("head", function () {
    ...
    fstore_suppliersedit.addFields([
    ...
    // Form_CustomValidate
    fstore_suppliersedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fstore_suppliersedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fstore_suppliersedit" id="fstore_suppliersedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Creationdate->Visible) { // Creationdate ?>
    <div id="r_Creationdate" class="form-group row">
        <label id="elh_store_suppliers_Creationdate" for="x_Creationdate" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Creationdate->caption() ?><?= $Page->Creationdate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Creationdate->cellAttributes() ?>>
<span id="el_store_suppliers_Creationdate">
<input type="<?= $Page->Creationdate->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Creationdate" name="x_Creationdate" id="x_Creationdate" placeholder="<?= HtmlEncode($Page->Creationdate->getPlaceHolder()) ?>" value="<?= $Page->Creationdate->EditValue ?>"<?= $Page->Creationdate->editAttributes() ?> aria-describedby="x_Creationdate_help">
...
<?php if ($Page->Address1->Visible) { // Address1 ?>
    <div id="r_Address1" class="form-group row">
        <label id="elh_store_suppliers_Address1" for="x_Address1" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Address1->caption() ?><?= $Page->Address1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address1->cellAttributes() ?>>
<span id="el_store_suppliers_Address1">
<input type="<?= $Page->Address1->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Address1" name="x_Address1" id="x_Address1" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->Address1->getPlaceHolder()) ?>" value="<?= $Page->Address1->EditValue ?>"<?= $Page->Address1->editAttributes() ?> aria-describedby="x_Address1_help">
...
<?php if ($Page->Address2->Visible) { // Address2 ?>
    <div id="r_Address2" class="form-group row">
        <label id="elh_store_suppliers_Address2" for="x_Address2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Address2->caption() ?><?= $Page->Address2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address2->cellAttributes() ?>>
<span id="el_store_suppliers_Address2">
<input type="<?= $Page->Address2->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Address2" name="x_Address2" id="x_Address2" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->Address2->getPlaceHolder()) ?>" value="<?= $Page->Address2->EditValue ?>"<?= $Page->Address2->editAttributes() ?> aria-describedby="x_Address2_help">
...
<?php if ($Page->Address3->Visible) { // Address3 ?>
    <div id="r_Address3" class="form-group row">
        <label id="elh_store_suppliers_Address3" for="x_Address3" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Address3->caption() ?><?= $Page->Address3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address3->cellAttributes() ?>>
<span id="el_store_suppliers_Address3">
<input type="<?= $Page->Address3->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Address3" name="x_Address3" id="x_Address3" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->Address3->getPlaceHolder()) ?>" value="<?= $Page->Address3->EditValue ?>"<?= $Page->Address3->editAttributes() ?> aria-describedby="x_Address3_help">
...
<?php if ($Page->Citycode->Visible) { // Citycode ?>
    <div id="r_Citycode" class="form-group row">
        <label id="elh_store_suppliers_Citycode" for="x_Citycode" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Citycode->caption() ?><?= $Page->Citycode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Citycode->cellAttributes() ?>>
<span id="el_store_suppliers_Citycode">
<input type="<?= $Page->Citycode->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Citycode" name="x_Citycode" id="x_Citycode" size="30" placeholder="<?= HtmlEncode($Page->Citycode->getPlaceHolder()) ?>" value="<?= $Page->Citycode->EditValue ?>"<?= $Page->Citycode->editAttributes() ?> aria-describedby="x_Citycode_help">
...
<?php if ($Page->State->Visible) { // State ?>
    <div id="r_State" class="form-group row">
        <label id="elh_store_suppliers_State" for="x_State" class="<?= $Page->LeftColumnClass ?>"><?= $Page->State->caption() ?><?= $Page->State->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->State->cellAttributes() ?>>
<span id="el_store_suppliers_State">
<input type="<?= $Page->State->getInputTextType() ?>" data-table="store_suppliers" data-field="x_State" name="x_State" id="x_State" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->State->getPlaceHolder()) ?>" value="<?= $Page->State->EditValue ?>"<?= $Page->State->editAttributes() ?> aria-describedby="x_State_help">
...
<?php if ($Page->Pincode->Visible) { // Pincode ?>
    <div id="r_Pincode" class="form-group row">
        <label id="elh_store_suppliers_Pincode" for="x_Pincode" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Pincode->caption() ?><?= $Page->Pincode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Pincode->cellAttributes() ?>>
<span id="el_store_suppliers_Pincode">
<input type="<?= $Page->Pincode->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Pincode" name="x_Pincode" id="x_Pincode" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->Pincode->getPlaceHolder()) ?>" value="<?= $Page->Pincode->EditValue ?>"<?= $Page->Pincode->editAttributes() ?> aria-describedby="x_Pincode_help">
...
<?php if ($Page->Phone->Visible) { // Phone ?>
    <div id="r_Phone" class="form-group row">
        <label id="elh_store_suppliers_Phone" for="x_Phone" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Phone->caption() ?><?= $Page->Phone->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Phone->cellAttributes() ?>>
<span id="el_store_suppliers_Phone">
<input type="<?= $Page->Phone->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Phone" name="x_Phone" id="x_Phone" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->Phone->getPlaceHolder()) ?>" value="<?= $Page->Phone->EditValue ?>"<?= $Page->Phone->editAttributes() ?> aria-describedby="x_Phone_help">
...
<?php if ($Page->Fax->Visible) { // Fax ?>
    <div id="r_Fax" class="form-group row">
        <label id="elh_store_suppliers_Fax" for="x_Fax" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Fax->caption() ?><?= $Page->Fax->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Fax->cellAttributes() ?>>
<span id="el_store_suppliers_Fax">
<input type="<?= $Page->Fax->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Fax" name="x_Fax" id="x_Fax" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->Fax->getPlaceHolder()) ?>" value="<?= $Page->Fax->EditValue ?>"<?= $Page->Fax->editAttributes() ?> aria-describedby="x_Fax_help">
...
<?php if ($Page->_Email->Visible) { // Email ?>
    <div id="r__Email" class="form-group row">
        <label id="elh_store_suppliers__Email" for="x__Email" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_Email->caption() ?><?= $Page->_Email->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->_Email->cellAttributes() ?>>
<span id="el_store_suppliers__Email">
<input type="<?= $Page->_Email->getInputTextType() ?>" data-table="store_suppliers" data-field="x__Email" name="x__Email" id="x__Email" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->_Email->getPlaceHolder()) ?>" value="<?= $Page->_Email->EditValue ?>"<?= $Page->_Email->editAttributes() ?> aria-describedby="x__Email_help">
...
<?php if ($Page->CP1Citycode->Visible) { // CP1Citycode ?>
    <div id="r_CP1Citycode" class="form-group row">
        <label id="elh_store_suppliers_CP1Citycode" for="x_CP1Citycode" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP1Citycode->caption() ?><?= $Page->CP1Citycode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP1Citycode->cellAttributes() ?>>
<span id="el_store_suppliers_CP1Citycode">
<input type="<?= $Page->CP1Citycode->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP1Citycode" name="x_CP1Citycode" id="x_CP1Citycode" size="30" placeholder="<?= HtmlEncode($Page->CP1Citycode->getPlaceHolder()) ?>" value="<?= $Page->CP1Citycode->EditValue ?>"<?= $Page->CP1Citycode->editAttributes() ?> aria-describedby="x_CP1Citycode_help">
...
<?php if ($Page->CP1State->Visible) { // CP1State ?>
    <div id="r_CP1State" class="form-group row">
        <label id="elh_store_suppliers_CP1State" for="x_CP1State" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP1State->caption() ?><?= $Page->CP1State->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP1State->cellAttributes() ?>>
<span id="el_store_suppliers_CP1State">
<input type="<?= $Page->CP1State->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP1State" name="x_CP1State" id="x_CP1State" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP1State->getPlaceHolder()) ?>" value="<?= $Page->CP1State->EditValue ?>"<?= $Page->CP1State->editAttributes() ?> aria-describedby="x_CP1State_help">
...
<?php if ($Page->CP1Phone->Visible) { // CP1Phone ?>
    <div id="r_CP1Phone" class="form-group row">
        <label id="elh_store_suppliers_CP1Phone" for="x_CP1Phone" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP1Phone->caption() ?><?= $Page->CP1Phone->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP1Phone->cellAttributes() ?>>
<span id="el_store_suppliers_CP1Phone">
<input type="<?= $Page->CP1Phone->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP1Phone" name="x_CP1Phone" id="x_CP1Phone" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP1Phone->getPlaceHolder()) ?>" value="<?= $Page->CP1Phone->EditValue ?>"<?= $Page->CP1Phone->editAttributes() ?> aria-describedby="x_CP1Phone_help">
...
<?php if ($Page->CP1Fax->Visible) { // CP1Fax ?>
    <div id="r_CP1Fax" class="form-group row">
        <label id="elh_store_suppliers_CP1Fax" for="x_CP1Fax" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP1Fax->caption() ?><?= $Page->CP1Fax->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP1Fax->cellAttributes() ?>>
<span id="el_store_suppliers_CP1Fax">
<input type="<?= $Page->CP1Fax->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP1Fax" name="x_CP1Fax" id="x_CP1Fax" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP1Fax->getPlaceHolder()) ?>" value="<?= $Page->CP1Fax->EditValue ?>"<?= $Page->CP1Fax->editAttributes() ?> aria-describedby="x_CP1Fax_help">
...
<?php if ($Page->CP1Email->Visible) { // CP1Email ?>
    <div id="r_CP1Email" class="form-group row">
        <label id="elh_store_suppliers_CP1Email" for="x_CP1Email" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP1Email->caption() ?><?= $Page->CP1Email->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP1Email->cellAttributes() ?>>
<span id="el_store_suppliers_CP1Email">
<input type="<?= $Page->CP1Email->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP1Email" name="x_CP1Email" id="x_CP1Email" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP1Email->getPlaceHolder()) ?>" value="<?= $Page->CP1Email->EditValue ?>"<?= $Page->CP1Email->editAttributes() ?> aria-describedby="x_CP1Email_help">
...
<?php if ($Page->CP2Address2->Visible) { // CP2Address2 ?>
    <div id="r_CP2Address2" class="form-group row">
        <label id="elh_store_suppliers_CP2Address2" for="x_CP2Address2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP2Address2->caption() ?><?= $Page->CP2Address2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CP2Citycode->Visible) { // CP2Citycode ?>
    <div id="r_CP2Citycode" class="form-group row">
        <label id="elh_store_suppliers_CP2Citycode" for="x_CP2Citycode" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP2Citycode->caption() ?><?= $Page->CP2Citycode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP2Citycode->cellAttributes() ?>>
<span id="el_store_suppliers_CP2Citycode">
<input type="<?= $Page->CP2Citycode->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP2Citycode" name="x_CP2Citycode" id="x_CP2Citycode" size="30" placeholder="<?= HtmlEncode($Page->CP2Citycode->getPlaceHolder()) ?>" value="<?= $Page->CP2Citycode->EditValue ?>"<?= $Page->CP2Citycode->editAttributes() ?> aria-describedby="x_CP2Citycode_help">
...
<?php if ($Page->CP2State->Visible) { // CP2State ?>
    <div id="r_CP2State" class="form-group row">
        <label id="elh_store_suppliers_CP2State" for="x_CP2State" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP2State->caption() ?><?= $Page->CP2State->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP2State->cellAttributes() ?>>
<span id="el_store_suppliers_CP2State">
<input type="<?= $Page->CP2State->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP2State" name="x_CP2State" id="x_CP2State" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP2State->getPlaceHolder()) ?>" value="<?= $Page->CP2State->EditValue ?>"<?= $Page->CP2State->editAttributes() ?> aria-describedby="x_CP2State_help">
...
<?php if ($Page->CP2Phone->Visible) { // CP2Phone ?>
    <div id="r_CP2Phone" class="form-group row">
        <label id="elh_store_suppliers_CP2Phone" for="x_CP2Phone" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP2Phone->caption() ?><?= $Page->CP2Phone->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP2Phone->cellAttributes() ?>>
<span id="el_store_suppliers_CP2Phone">
<input type="<?= $Page->CP2Phone->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP2Phone" name="x_CP2Phone" id="x_CP2Phone" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP2Phone->getPlaceHolder()) ?>" value="<?= $Page->CP2Phone->EditValue ?>"<?= $Page->CP2Phone->editAttributes() ?> aria-describedby="x_CP2Phone_help">
...
<?php if ($Page->CP2Fax->Visible) { // CP2Fax ?>
    <div id="r_CP2Fax" class="form-group row">
        <label id="elh_store_suppliers_CP2Fax" for="x_CP2Fax" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP2Fax->caption() ?><?= $Page->CP2Fax->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP2Fax->cellAttributes() ?>>
<span id="el_store_suppliers_CP2Fax">
<input type="<?= $Page->CP2Fax->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP2Fax" name="x_CP2Fax" id="x_CP2Fax" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP2Fax->getPlaceHolder()) ?>" value="<?= $Page->CP2Fax->EditValue ?>"<?= $Page->CP2Fax->editAttributes() ?> aria-describedby="x_CP2Fax_help">
...
<?php if ($Page->CP2Email->Visible) { // CP2Email ?>
    <div id="r_CP2Email" class="form-group row">
        <label id="elh_store_suppliers_CP2Email" for="x_CP2Email" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CP2Email->caption() ?><?= $Page->CP2Email->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CP2Email->cellAttributes() ?>>
<span id="el_store_suppliers_CP2Email">
<input type="<?= $Page->CP2Email->getInputTextType() ?>" data-table="store_suppliers" data-field="x_CP2Email" name="x_CP2Email" id="x_CP2Email" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CP2Email->getPlaceHolder()) ?>" value="<?= $Page->CP2Email->EditValue ?>"<?= $Page->CP2Email->editAttributes() ?> aria-describedby="x_CP2Email_help">
...
<?php if ($Page->Type->Visible) { // Type ?>
    <div id="r_Type" class="form-group row">
        <label id="elh_store_suppliers_Type" for="x_Type" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Type->caption() ?><?= $Page->Type->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Type->cellAttributes() ?>>
<span id="el_store_suppliers_Type">
<input type="<?= $Page->Type->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Type" name="x_Type" id="x_Type" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Type->getPlaceHolder()) ?>" value="<?= $Page->Type->EditValue ?>"<?= $Page->Type->editAttributes() ?> aria-describedby="x_Type_help">
...
<?php if ($Page->Creditterms->Visible) { // Creditterms ?>
    <div id="r_Creditterms" class="form-group row">
        <label id="elh_store_suppliers_Creditterms" for="x_Creditterms" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Creditterms->caption() ?><?= $Page->Creditterms->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <div id="r_Remarks" class="form-group row">
        <label id="elh_store_suppliers_Remarks" for="x_Remarks" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Remarks->caption() ?><?= $Page->Remarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Remarks->cellAttributes() ?>>
<span id="el_store_suppliers_Remarks">
<input type="<?= $Page->Remarks->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Remarks" name="x_Remarks" id="x_Remarks" size="30" maxlength="120" placeholder="<?= HtmlEncode($Page->Remarks->getPlaceHolder()) ?>" value="<?= $Page->Remarks->EditValue ?>"<?= $Page->Remarks->editAttributes() ?> aria-describedby="x_Remarks_help">
...
<?php if ($Page->Tinnumber->Visible) { // Tinnumber ?>
    <div id="r_Tinnumber" class="form-group row">
        <label id="elh_store_suppliers_Tinnumber" for="x_Tinnumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Tinnumber->caption() ?><?= $Page->Tinnumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Tinnumber->cellAttributes() ?>>
<span id="el_store_suppliers_Tinnumber">
<input type="<?= $Page->Tinnumber->getInputTextType() ?>" data-table="store_suppliers" data-field="x_Tinnumber" name="x_Tinnumber" id="x_Tinnumber" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Tinnumber->getPlaceHolder()) ?>" value="<?= $Page->Tinnumber->EditValue ?>"<?= $Page->Tinnumber->editAttributes() ?> aria-describedby="x_Tinnumber_help">
...
<?php if ($Page->Universalsuppliercode->Visible) { // Universalsuppliercode ?>
    <div id="r_Universalsuppliercode" class="form-group row">
        <label id="elh_store_suppliers_Universalsuppliercode" for="x_Universalsuppliercode" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Universalsuppliercode->caption() ?><?= $Page->Universalsuppliercode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->PANNumber->Visible) { // PANNumber ?>
    <div id="r_PANNumber" class="form-group row">
        <label id="elh_store_suppliers_PANNumber" for="x_PANNumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PANNumber->caption() ?><?= $Page->PANNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PANNumber->cellAttributes() ?>>
<span id="el_store_suppliers_PANNumber">
<input type="<?= $Page->PANNumber->getInputTextType() ?>" data-table="store_suppliers" data-field="x_PANNumber" name="x_PANNumber" id="x_PANNumber" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->PANNumber->getPlaceHolder()) ?>" value="<?= $Page->PANNumber->EditValue ?>"<?= $Page->PANNumber->editAttributes() ?> aria-describedby="x_PANNumber_help">
...
<?php if ($Page->SalesRepMobileNo->Visible) { // SalesRepMobileNo ?>
    <div id="r_SalesRepMobileNo" class="form-group row">
        <label id="elh_store_suppliers_SalesRepMobileNo" for="x_SalesRepMobileNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SalesRepMobileNo->caption() ?><?= $Page->SalesRepMobileNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->GSTNumber->Visible) { // GSTNumber ?>
    <div id="r_GSTNumber" class="form-group row">
        <label id="elh_store_suppliers_GSTNumber" for="x_GSTNumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->GSTNumber->caption() ?><?= $Page->GSTNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->GSTNumber->cellAttributes() ?>>
<span id="el_store_suppliers_GSTNumber">
<input type="<?= $Page->GSTNumber->getInputTextType() ?>" data-table="store_suppliers" data-field="x_GSTNumber" name="x_GSTNumber" id="x_GSTNumber" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->GSTNumber->getPlaceHolder()) ?>" value="<?= $Page->GSTNumber->EditValue ?>"<?= $Page->GSTNumber->editAttributes() ?> aria-describedby="x_GSTNumber_help">
...
<?php if ($Page->TANNumber->Visible) { // TANNumber ?>
    <div id="r_TANNumber" class="form-group row">
        <label id="elh_store_suppliers_TANNumber" for="x_TANNumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TANNumber->caption() ?><?= $Page->TANNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TANNumber->cellAttributes() ?>>
<span id="el_store_suppliers_TANNumber">
<input type="<?= $Page->TANNumber->getInputTextType() ?>" data-table="store_suppliers" data-field="x_TANNumber" name="x_TANNumber" id="x_TANNumber" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->TANNumber->getPlaceHolder()) ?>" value="<?= $Page->TANNumber->EditValue ?>"<?= $Page->TANNumber->editAttributes() ?> aria-describedby="x_TANNumber_help">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_store_suppliers_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_store_suppliers_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="store_suppliers" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
    <div id="r_HospID" class="form-group row">
        <label id="elh_store_suppliers_HospID" for="x_HospID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->HospID->caption() ?><?= $Page->HospID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->HospID->cellAttributes() ?>>
<span id="el_store_suppliers_HospID">
<input type="<?= $Page->HospID->getInputTextType() ?>" data-table="store_suppliers" data-field="x_HospID" name="x_HospID" id="x_HospID" size="30" placeholder="<?= HtmlEncode($Page->HospID->getPlaceHolder()) ?>" value="<?= $Page->HospID->EditValue ?>"<?= $Page->HospID->editAttributes() ?> aria-describedby="x_HospID_help">
...
<?php if ($Page->BranchID->Visible) { // BranchID ?>
    <div id="r_BranchID" class="form-group row">
        <label id="elh_store_suppliers_BranchID" for="x_BranchID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BranchID->caption() ?><?= $Page->BranchID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BranchID->cellAttributes() ?>>
<span id="el_store_suppliers_BranchID">
<input type="<?= $Page->BranchID->getInputTextType() ?>" data-table="store_suppliers" data-field="x_BranchID" name="x_BranchID" id="x_BranchID" size="30" placeholder="<?= HtmlEncode($Page->BranchID->getPlaceHolder()) ?>" value="<?= $Page->BranchID->EditValue ?>"<?= $Page->BranchID->editAttributes() ?> aria-describedby="x_BranchID_help">
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <div id="r_StoreID" class="form-group row">
        <label id="elh_store_suppliers_StoreID" for="x_StoreID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->StoreID->caption() ?><?= $Page->StoreID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->StoreID->cellAttributes() ?>>
<span id="el_store_suppliers_StoreID">
<input type="<?= $Page->StoreID->getInputTextType() ?>" data-table="store_suppliers" data-field="x_StoreID" name="x_StoreID" id="x_StoreID" size="30" placeholder="<?= HtmlEncode($Page->StoreID->getPlaceHolder()) ?>" value="<?= $Page->StoreID->EditValue ?>"<?= $Page->StoreID->editAttributes() ?> aria-describedby="x_StoreID_help">
