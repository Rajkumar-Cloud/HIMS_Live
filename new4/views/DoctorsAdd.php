...
loadjs.ready("head", function () {
    ...
    fdoctorsadd.lists.slot_days = <?= $Page->slot_days->toClientList($Page) ?>;
    fdoctorsadd.lists.Status = <?= $Page->Status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fdoctorsadd" id="fdoctorsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if (in_array("appointment_scheduler", explode(",", $Page->getCurrentDetailTable())) && $appointment_scheduler->DetailAdd) {
?>
