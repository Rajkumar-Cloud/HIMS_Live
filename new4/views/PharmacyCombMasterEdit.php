...
loadjs.ready("head", function () {
    ...
    fpharmacy_comb_masteredit.lists.GRPCODE = <?= $Page->GRPCODE->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_comb_masteredit" id="fpharmacy_comb_masteredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
