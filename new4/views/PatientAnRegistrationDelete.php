...
$Page->showMessage();
?>
<form name="fpatient_an_registrationdelete" id="fpatient_an_registrationdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ViabilityREPORT->Visible) { // ViabilityREPORT ?>
        <th class="<?= $Page->ViabilityREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_ViabilityREPORT" class="patient_an_registration_ViabilityREPORT"><?= $Page->ViabilityREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->Viability2REPORT->Visible) { // Viability2REPORT ?>
        <th class="<?= $Page->Viability2REPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_Viability2REPORT" class="patient_an_registration_Viability2REPORT"><?= $Page->Viability2REPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->NTscanREPORT->Visible) { // NTscanREPORT ?>
        <th class="<?= $Page->NTscanREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_NTscanREPORT" class="patient_an_registration_NTscanREPORT"><?= $Page->NTscanREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->EarlyTargetREPORT->Visible) { // EarlyTargetREPORT ?>
        <th class="<?= $Page->EarlyTargetREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_EarlyTargetREPORT" class="patient_an_registration_EarlyTargetREPORT"><?= $Page->EarlyTargetREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->AnomalyREPORT->Visible) { // AnomalyREPORT ?>
        <th class="<?= $Page->AnomalyREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_AnomalyREPORT" class="patient_an_registration_AnomalyREPORT"><?= $Page->AnomalyREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->GrowthREPORT->Visible) { // GrowthREPORT ?>
        <th class="<?= $Page->GrowthREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_GrowthREPORT" class="patient_an_registration_GrowthREPORT"><?= $Page->GrowthREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->Growth1REPORT->Visible) { // Growth1REPORT ?>
        <th class="<?= $Page->Growth1REPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_Growth1REPORT" class="patient_an_registration_Growth1REPORT"><?= $Page->Growth1REPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->ANProfileREPORT->Visible) { // ANProfileREPORT ?>
        <th class="<?= $Page->ANProfileREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_ANProfileREPORT" class="patient_an_registration_ANProfileREPORT"><?= $Page->ANProfileREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->DualMarkerREPORT->Visible) { // DualMarkerREPORT ?>
        <th class="<?= $Page->DualMarkerREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_DualMarkerREPORT" class="patient_an_registration_DualMarkerREPORT"><?= $Page->DualMarkerREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->QuadrupleREPORT->Visible) { // QuadrupleREPORT ?>
        <th class="<?= $Page->QuadrupleREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_QuadrupleREPORT" class="patient_an_registration_QuadrupleREPORT"><?= $Page->QuadrupleREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->A5monthREPORT->Visible) { // A5monthREPORT ?>
        <th class="<?= $Page->A5monthREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_A5monthREPORT" class="patient_an_registration_A5monthREPORT"><?= $Page->A5monthREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->A7monthREPORT->Visible) { // A7monthREPORT ?>
        <th class="<?= $Page->A7monthREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_A7monthREPORT" class="patient_an_registration_A7monthREPORT"><?= $Page->A7monthREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->A9monthREPORT->Visible) { // A9monthREPORT ?>
        <th class="<?= $Page->A9monthREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_A9monthREPORT" class="patient_an_registration_A9monthREPORT"><?= $Page->A9monthREPORT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->INJREPORT->Visible) { // INJREPORT ?>
        <th class="<?= $Page->INJREPORT->headerCellClass() ?>"><span id="elh_patient_an_registration_INJREPORT" class="patient_an_registration_INJREPORT"><?= $Page->INJREPORT->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_ViabilityREPORT" class="patient_an_registration_ViabilityREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_Viability2REPORT" class="patient_an_registration_Viability2REPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_NTscanREPORT" class="patient_an_registration_NTscanREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_EarlyTargetREPORT" class="patient_an_registration_EarlyTargetREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_AnomalyREPORT" class="patient_an_registration_AnomalyREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_GrowthREPORT" class="patient_an_registration_GrowthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_Growth1REPORT" class="patient_an_registration_Growth1REPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_ANProfileREPORT" class="patient_an_registration_ANProfileREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_DualMarkerREPORT" class="patient_an_registration_DualMarkerREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_QuadrupleREPORT" class="patient_an_registration_QuadrupleREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_A5monthREPORT" class="patient_an_registration_A5monthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_A7monthREPORT" class="patient_an_registration_A7monthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_A9monthREPORT" class="patient_an_registration_A9monthREPORT">
...
<span id="el<?= $Page->RowCount ?>_patient_an_registration_INJREPORT" class="patient_an_registration_INJREPORT">
