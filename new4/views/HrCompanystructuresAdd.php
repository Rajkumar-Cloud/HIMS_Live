...
// Page object
$HrCompanystructuresAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fhr_companystructuresadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fhr_companystructuresadd = currentForm = new ew.Form("fhr_companystructuresadd", "add");
    ...
    fhr_companystructuresadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fhr_companystructuresadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fhr_companystructuresadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_companystructuresadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhr_companystructuresadd.lists.type = <?= $Page->type->toClientList($Page) ?>;
    loadjs.done("fhr_companystructuresadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_companystructuresadd" id="fhr_companystructuresadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
