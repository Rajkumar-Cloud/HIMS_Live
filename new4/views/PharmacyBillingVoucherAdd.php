...
loadjs.ready("head", function () {
    ...
    fpharmacy_billing_voucheradd.lists.Reception = <?= $Page->Reception->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.ModeofPayment = <?= $Page->ModeofPayment->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.RIDNO = <?= $Page->RIDNO->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.CId = <?= $Page->CId->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.PatId = <?= $Page->PatId->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.RefferedBy = <?= $Page->RefferedBy->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.DrID = <?= $Page->DrID->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.ReportHeader = <?= $Page->ReportHeader->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.CardType = <?= $Page->CardType->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.BillType = <?= $Page->BillType->toClientList($Page) ?>;
    fpharmacy_billing_voucheradd.lists.PartialSave = <?= $Page->PartialSave->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_billing_voucheradd" id="fpharmacy_billing_voucheradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_pharmacy_billing_voucheradd">
<div id="ct_PharmacyBillingVoucherAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_billing_voucheradd", "tpm_pharmacy_billing_voucheradd", "pharmacy_billing_voucheradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
