...
// Page object
$EmployeeProjectsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_projectsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_projectsadd = currentForm = new ew.Form("femployee_projectsadd", "add");
    ...
    femployee_projectsadd.addFields([
    ...
    // Form_CustomValidate
    femployee_projectsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_projectsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_projectsadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_projectsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_projectsadd" id="femployee_projectsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_projectsadd", "datetimepicker"], function() {
