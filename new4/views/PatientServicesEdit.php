...
loadjs.ready("head", function () {
    ...
    fpatient_servicesedit.lists.Services = <?= $Page->Services->toClientList($Page) ?>;
    fpatient_servicesedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fpatient_servicesedit.lists.ServiceSelect = <?= $Page->ServiceSelect->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_servicesedit" id="fpatient_servicesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->getCurrentMasterTable() == "billing_voucher") { ?>
...
<input type="hidden" data-table="patient_services" data-field="x_Reception" data-hidden="1" name="x_Reception" id="x_Reception" value="<?= HtmlEncode($Page->Reception->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->Services->Visible) { // Services ?>
    <div id="r_Services" class="form-group row">
        <label id="elh_patient_services_Services" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Services->caption() ?><?= $Page->Services->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" is="selection-list" class="form-control" data-table="patient_services" data-field="x_Services" data-input="sv_x_Services" data-value-separator="<?= $Page->Services->displayValueSeparatorAttribute() ?>" name="x_Services" id="x_Services" value="<?= HtmlEncode($Page->Services->CurrentValue) ?>"<?= $onchange ?>>
...
loadjs.ready(["fpatient_servicesedit"], function() {
    fpatient_servicesedit.createAutoSuggest(Object.assign({"id":"x_Services","forceSelect":true}, ew.vars.tables.patient_services.fields.Services.autoSuggestOptions));
});
</script>
...
<input type="<?= $Page->amount->getInputTextType() ?>" data-table="patient_services" data-field="x_amount" name="x_amount" id="x_amount" size="8" maxlength="13" placeholder="<?= HtmlEncode($Page->amount->getPlaceHolder()) ?>" value="<?= $Page->amount->EditValue ?>"<?= $Page->amount->editAttributes() ?> aria-describedby="x_amount_help">
...
<input type="<?= $Page->description->getInputTextType() ?>" data-table="patient_services" data-field="x_description" name="x_description" id="x_description" placeholder="<?= HtmlEncode($Page->description->getPlaceHolder()) ?>" value="<?= $Page->description->EditValue ?>"<?= $Page->description->editAttributes() ?> aria-describedby="x_description_help">
...
<input type="hidden" data-table="patient_services" data-field="x_mrnno" data-hidden="1" name="x_mrnno" id="x_mrnno" value="<?= HtmlEncode($Page->mrnno->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="<?= $Page->Quantity->getInputTextType() ?>" data-table="patient_services" data-field="x_Quantity" name="x_Quantity" id="x_Quantity" size="2" maxlength="4" placeholder="<?= HtmlEncode($Page->Quantity->getPlaceHolder()) ?>" value="<?= $Page->Quantity->EditValue ?>"<?= $Page->Quantity->editAttributes() ?> aria-describedby="x_Quantity_help">
...
<input type="<?= $Page->Discount->getInputTextType() ?>" data-table="patient_services" data-field="x_Discount" name="x_Discount" id="x_Discount" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->Discount->getPlaceHolder()) ?>" value="<?= $Page->Discount->EditValue ?>"<?= $Page->Discount->editAttributes() ?> aria-describedby="x_Discount_help">
...
<input type="<?= $Page->SubTotal->getInputTextType() ?>" data-table="patient_services" data-field="x_SubTotal" name="x_SubTotal" id="x_SubTotal" size="8" maxlength="13" placeholder="<?= HtmlEncode($Page->SubTotal->getPlaceHolder()) ?>" value="<?= $Page->SubTotal->EditValue ?>"<?= $Page->SubTotal->editAttributes() ?> aria-describedby="x_SubTotal_help">
...
<?php if ($Page->ServiceSelect->Visible) { // ServiceSelect ?>
    <div id="r_ServiceSelect" class="form-group row">
        <label id="elh_patient_services_ServiceSelect" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ServiceSelect->caption() ?><?= $Page->ServiceSelect->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?= $Page->ServiceSelect->getCustomMessage() ?>
...
<input type="hidden" id="x_Vid" name="x_Vid" value="<?= HtmlEncode($Page->Vid->CurrentValue) ?>" data-hidden="1">
<?php } else { ?>
<span id="el_patient_services_Vid">
...
<input type="hidden" data-table="patient_services" data-field="x_RIDNO" data-hidden="1" name="x_RIDNO" id="x_RIDNO" value="<?= HtmlEncode($Page->RIDNO->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_services" data-field="x_TidNo" data-hidden="1" name="x_TidNo" id="x_TidNo" value="<?= HtmlEncode($Page->TidNo->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="<?= $Page->sid->getInputTextType() ?>" data-table="patient_services" data-field="x_sid" name="x_sid" id="x_sid" size="8" maxlength="8" placeholder="<?= HtmlEncode($Page->sid->getPlaceHolder()) ?>" value="<?= $Page->sid->EditValue ?>"<?= $Page->sid->editAttributes() ?> aria-describedby="x_sid_help">
...
<input type="<?= $Page->ItemCode->getInputTextType() ?>" data-table="patient_services" data-field="x_ItemCode" name="x_ItemCode" id="x_ItemCode" size="8" maxlength="8" placeholder="<?= HtmlEncode($Page->ItemCode->getPlaceHolder()) ?>" value="<?= $Page->ItemCode->EditValue ?>"<?= $Page->ItemCode->editAttributes() ?> aria-describedby="x_ItemCode_help">
