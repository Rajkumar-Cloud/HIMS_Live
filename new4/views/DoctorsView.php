...
$Page->showMessage();
?>
<form name="fdoctorsview" id="fdoctorsview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if (in_array("appointment_scheduler", explode(",", $Page->getCurrentDetailTable())) && $appointment_scheduler->DetailView) {
?>
