...
$Page->showMessage();
?>
<form name="fpharmacy_purchase_requestdelete" id="fpharmacy_purchase_requestdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
