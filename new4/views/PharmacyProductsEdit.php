...
// Page object
$PharmacyProductsEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_productsedit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "pharmacy_products")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.pharmacy_products)
        ew.vars.tables.pharmacy_products = currentTable;
    fpharmacy_productsedit.addFields([
        ...
        ["DivisionCode", [fields.DivisionCode.visible && fields.DivisionCode.required ? ew.Validators.required(fields.DivisionCode.caption) : null], fields.DivisionCode.isInvalid],
        ["ManufacturerCode", [fields.ManufacturerCode.visible && fields.ManufacturerCode.required ? ew.Validators.required(fields.ManufacturerCode.caption) : null], fields.ManufacturerCode.isInvalid],
        ...
        ["AlternateSupplierCodes", [fields.AlternateSupplierCodes.visible && fields.AlternateSupplierCodes.required ? ew.Validators.required(fields.AlternateSupplierCodes.caption) : null], fields.AlternateSupplierCodes.isInvalid],
        ["AlternateProductCode", [fields.AlternateProductCode.visible && fields.AlternateProductCode.required ? ew.Validators.required(fields.AlternateProductCode.caption) : null], fields.AlternateProductCode.isInvalid],
        ["UniversalProductCode", [fields.UniversalProductCode.visible && fields.UniversalProductCode.required ? ew.Validators.required(fields.UniversalProductCode.caption) : null, ew.Validators.integer], fields.UniversalProductCode.isInvalid],
        ["BookProductCode", [fields.BookProductCode.visible && fields.BookProductCode.required ? ew.Validators.required(fields.BookProductCode.caption) : null, ew.Validators.integer], fields.BookProductCode.isInvalid],
        ["OldCode", [fields.OldCode.visible && fields.OldCode.required ? ew.Validators.required(fields.OldCode.caption) : null], fields.OldCode.isInvalid],
        ["ProtectedProducts", [fields.ProtectedProducts.visible && fields.ProtectedProducts.required ? ew.Validators.required(fields.ProtectedProducts.caption) : null, ew.Validators.integer], fields.ProtectedProducts.isInvalid],
        ["ProductFullName", [fields.ProductFullName.visible && fields.ProductFullName.required ? ew.Validators.required(fields.ProductFullName.caption) : null], fields.ProductFullName.isInvalid],
        ["UnitOfMeasure", [fields.UnitOfMeasure.visible && fields.UnitOfMeasure.required ? ew.Validators.required(fields.UnitOfMeasure.caption) : null, ew.Validators.integer], fields.UnitOfMeasure.isInvalid],
        ["UnitDescription", [fields.UnitDescription.visible && fields.UnitDescription.required ? ew.Validators.required(fields.UnitDescription.caption) : null], fields.UnitDescription.isInvalid],
        ["BulkDescription", [fields.BulkDescription.visible && fields.BulkDescription.required ? ew.Validators.required(fields.BulkDescription.caption) : null], fields.BulkDescription.isInvalid],
        ["BarCodeDescription", [fields.BarCodeDescription.visible && fields.BarCodeDescription.required ? ew.Validators.required(fields.BarCodeDescription.caption) : null], fields.BarCodeDescription.isInvalid],
        ["PackageInformation", [fields.PackageInformation.visible && fields.PackageInformation.required ? ew.Validators.required(fields.PackageInformation.caption) : null], fields.PackageInformation.isInvalid],
        ["PackageId", [fields.PackageId.visible && fields.PackageId.required ? ew.Validators.required(fields.PackageId.caption) : null, ew.Validators.integer], fields.PackageId.isInvalid],
        ...
        ["AllowFractions", [fields.AllowFractions.visible && fields.AllowFractions.required ? ew.Validators.required(fields.AllowFractions.caption) : null, ew.Validators.integer], fields.AllowFractions.isInvalid],
        ["MinimumStockLevel", [fields.MinimumStockLevel.visible && fields.MinimumStockLevel.required ? ew.Validators.required(fields.MinimumStockLevel.caption) : null, ew.Validators.float], fields.MinimumStockLevel.isInvalid],
        ["MaximumStockLevel", [fields.MaximumStockLevel.visible && fields.MaximumStockLevel.required ? ew.Validators.required(fields.MaximumStockLevel.caption) : null, ew.Validators.float], fields.MaximumStockLevel.isInvalid],
        ["ReorderLevel", [fields.ReorderLevel.visible && fields.ReorderLevel.required ? ew.Validators.required(fields.ReorderLevel.caption) : null, ew.Validators.float], fields.ReorderLevel.isInvalid],
        ["MinMaxRatio", [fields.MinMaxRatio.visible && fields.MinMaxRatio.required ? ew.Validators.required(fields.MinMaxRatio.caption) : null, ew.Validators.float], fields.MinMaxRatio.isInvalid],
        ["AutoMinMaxRatio", [fields.AutoMinMaxRatio.visible && fields.AutoMinMaxRatio.required ? ew.Validators.required(fields.AutoMinMaxRatio.caption) : null, ew.Validators.float], fields.AutoMinMaxRatio.isInvalid],
        ["ScheduleCode", [fields.ScheduleCode.visible && fields.ScheduleCode.required ? ew.Validators.required(fields.ScheduleCode.caption) : null, ew.Validators.integer], fields.ScheduleCode.isInvalid],
        ["RopRatio", [fields.RopRatio.visible && fields.RopRatio.required ? ew.Validators.required(fields.RopRatio.caption) : null, ew.Validators.float], fields.RopRatio.isInvalid],
        ...
        ["PurchasePrice", [fields.PurchasePrice.visible && fields.PurchasePrice.required ? ew.Validators.required(fields.PurchasePrice.caption) : null, ew.Validators.float], fields.PurchasePrice.isInvalid],
        ["PurchaseUnit", [fields.PurchaseUnit.visible && fields.PurchaseUnit.required ? ew.Validators.required(fields.PurchaseUnit.caption) : null, ew.Validators.float], fields.PurchaseUnit.isInvalid],
        ["PurchaseTaxCode", [fields.PurchaseTaxCode.visible && fields.PurchaseTaxCode.required ? ew.Validators.required(fields.PurchaseTaxCode.caption) : null, ew.Validators.integer], fields.PurchaseTaxCode.isInvalid],
        ["AllowDirectInward", [fields.AllowDirectInward.visible && fields.AllowDirectInward.required ? ew.Validators.required(fields.AllowDirectInward.caption) : null, ew.Validators.integer], fields.AllowDirectInward.isInvalid],
        ["SalePrice", [fields.SalePrice.visible && fields.SalePrice.required ? ew.Validators.required(fields.SalePrice.caption) : null, ew.Validators.float], fields.SalePrice.isInvalid],
        ["SaleUnit", [fields.SaleUnit.visible && fields.SaleUnit.required ? ew.Validators.required(fields.SaleUnit.caption) : null, ew.Validators.float], fields.SaleUnit.isInvalid],
        ["SalesTaxCode", [fields.SalesTaxCode.visible && fields.SalesTaxCode.required ? ew.Validators.required(fields.SalesTaxCode.caption) : null, ew.Validators.integer], fields.SalesTaxCode.isInvalid],
        ["StockReceived", [fields.StockReceived.visible && fields.StockReceived.required ? ew.Validators.required(fields.StockReceived.caption) : null, ew.Validators.float], fields.StockReceived.isInvalid],
        ["TotalStock", [fields.TotalStock.visible && fields.TotalStock.required ? ew.Validators.required(fields.TotalStock.caption) : null, ew.Validators.float], fields.TotalStock.isInvalid],
        ["StockType", [fields.StockType.visible && fields.StockType.required ? ew.Validators.required(fields.StockType.caption) : null, ew.Validators.integer], fields.StockType.isInvalid],
        ["StockCheckDate", [fields.StockCheckDate.visible && fields.StockCheckDate.required ? ew.Validators.required(fields.StockCheckDate.caption) : null, ew.Validators.datetime(0)], fields.StockCheckDate.isInvalid],
        ["StockAdjustmentDate", [fields.StockAdjustmentDate.visible && fields.StockAdjustmentDate.required ? ew.Validators.required(fields.StockAdjustmentDate.caption) : null, ew.Validators.datetime(0)], fields.StockAdjustmentDate.isInvalid],
        ["Remarks", [fields.Remarks.visible && fields.Remarks.required ? ew.Validators.required(fields.Remarks.caption) : null], fields.Remarks.isInvalid],
        ["CostCentre", [fields.CostCentre.visible && fields.CostCentre.required ? ew.Validators.required(fields.CostCentre.caption) : null, ew.Validators.integer], fields.CostCentre.isInvalid],
        ["ProductType", [fields.ProductType.visible && fields.ProductType.required ? ew.Validators.required(fields.ProductType.caption) : null, ew.Validators.integer], fields.ProductType.isInvalid],
        ["TaxAmount", [fields.TaxAmount.visible && fields.TaxAmount.required ? ew.Validators.required(fields.TaxAmount.caption) : null, ew.Validators.float], fields.TaxAmount.isInvalid],
        ["TaxId", [fields.TaxId.visible && fields.TaxId.required ? ew.Validators.required(fields.TaxId.caption) : null, ew.Validators.integer], fields.TaxId.isInvalid],
        ["ResaleTaxApplicable", [fields.ResaleTaxApplicable.visible && fields.ResaleTaxApplicable.required ? ew.Validators.required(fields.ResaleTaxApplicable.caption) : null, ew.Validators.integer], fields.ResaleTaxApplicable.isInvalid],
        ["CstOtherTax", [fields.CstOtherTax.visible && fields.CstOtherTax.required ? ew.Validators.required(fields.CstOtherTax.caption) : null], fields.CstOtherTax.isInvalid],
        ["TotalTax", [fields.TotalTax.visible && fields.TotalTax.required ? ew.Validators.required(fields.TotalTax.caption) : null, ew.Validators.float], fields.TotalTax.isInvalid],
        ["ItemCost", [fields.ItemCost.visible && fields.ItemCost.required ? ew.Validators.required(fields.ItemCost.caption) : null, ew.Validators.float], fields.ItemCost.isInvalid],
        ["ExpiryDate", [fields.ExpiryDate.visible && fields.ExpiryDate.required ? ew.Validators.required(fields.ExpiryDate.caption) : null, ew.Validators.datetime(0)], fields.ExpiryDate.isInvalid],
        ["BatchDescription", [fields.BatchDescription.visible && fields.BatchDescription.required ? ew.Validators.required(fields.BatchDescription.caption) : null], fields.BatchDescription.isInvalid],
        ["FreeScheme", [fields.FreeScheme.visible && fields.FreeScheme.required ? ew.Validators.required(fields.FreeScheme.caption) : null, ew.Validators.integer], fields.FreeScheme.isInvalid],
        ["CashDiscountEligibility", [fields.CashDiscountEligibility.visible && fields.CashDiscountEligibility.required ? ew.Validators.required(fields.CashDiscountEligibility.caption) : null, ew.Validators.integer], fields.CashDiscountEligibility.isInvalid],
        ["DiscountPerAllowInBill", [fields.DiscountPerAllowInBill.visible && fields.DiscountPerAllowInBill.required ? ew.Validators.required(fields.DiscountPerAllowInBill.caption) : null, ew.Validators.float], fields.DiscountPerAllowInBill.isInvalid],
        ...
        ["StandardMargin", [fields.StandardMargin.visible && fields.StandardMargin.required ? ew.Validators.required(fields.StandardMargin.caption) : null, ew.Validators.float], fields.StandardMargin.isInvalid],
        ...
        ["MarginId", [fields.MarginId.visible && fields.MarginId.required ? ew.Validators.required(fields.MarginId.caption) : null, ew.Validators.integer], fields.MarginId.isInvalid],
        ["ExpectedMargin", [fields.ExpectedMargin.visible && fields.ExpectedMargin.required ? ew.Validators.required(fields.ExpectedMargin.caption) : null, ew.Validators.float], fields.ExpectedMargin.isInvalid],
        ["SurchargeBeforeTax", [fields.SurchargeBeforeTax.visible && fields.SurchargeBeforeTax.required ? ew.Validators.required(fields.SurchargeBeforeTax.caption) : null, ew.Validators.float], fields.SurchargeBeforeTax.isInvalid],
        ["SurchargeAfterTax", [fields.SurchargeAfterTax.visible && fields.SurchargeAfterTax.required ? ew.Validators.required(fields.SurchargeAfterTax.caption) : null, ew.Validators.float], fields.SurchargeAfterTax.isInvalid],
        ["TempOrderNo", [fields.TempOrderNo.visible && fields.TempOrderNo.required ? ew.Validators.required(fields.TempOrderNo.caption) : null, ew.Validators.integer], fields.TempOrderNo.isInvalid],
        ["TempOrderDate", [fields.TempOrderDate.visible && fields.TempOrderDate.required ? ew.Validators.required(fields.TempOrderDate.caption) : null, ew.Validators.datetime(0)], fields.TempOrderDate.isInvalid],
        ["OrderUnit", [fields.OrderUnit.visible && fields.OrderUnit.required ? ew.Validators.required(fields.OrderUnit.caption) : null, ew.Validators.float], fields.OrderUnit.isInvalid],
        ["OrderQuantity", [fields.OrderQuantity.visible && fields.OrderQuantity.required ? ew.Validators.required(fields.OrderQuantity.caption) : null, ew.Validators.float], fields.OrderQuantity.isInvalid],
        ["MarkForOrder", [fields.MarkForOrder.visible && fields.MarkForOrder.required ? ew.Validators.required(fields.MarkForOrder.caption) : null, ew.Validators.integer], fields.MarkForOrder.isInvalid],
        ["OrderAllId", [fields.OrderAllId.visible && fields.OrderAllId.required ? ew.Validators.required(fields.OrderAllId.caption) : null, ew.Validators.integer], fields.OrderAllId.isInvalid],
        ["CalculateOrderQty", [fields.CalculateOrderQty.visible && fields.CalculateOrderQty.required ? ew.Validators.required(fields.CalculateOrderQty.caption) : null, ew.Validators.float], fields.CalculateOrderQty.isInvalid],
        ["SubLocation", [fields.SubLocation.visible && fields.SubLocation.required ? ew.Validators.required(fields.SubLocation.caption) : null], fields.SubLocation.isInvalid],
        ["CategoryCode", [fields.CategoryCode.visible && fields.CategoryCode.required ? ew.Validators.required(fields.CategoryCode.caption) : null], fields.CategoryCode.isInvalid],
        ...
        ["FlexCategoryCode", [fields.FlexCategoryCode.visible && fields.FlexCategoryCode.required ? ew.Validators.required(fields.FlexCategoryCode.caption) : null, ew.Validators.integer], fields.FlexCategoryCode.isInvalid],
        ["ABCSaleQty", [fields.ABCSaleQty.visible && fields.ABCSaleQty.required ? ew.Validators.required(fields.ABCSaleQty.caption) : null, ew.Validators.float], fields.ABCSaleQty.isInvalid],
        ["ABCSaleValue", [fields.ABCSaleValue.visible && fields.ABCSaleValue.required ? ew.Validators.required(fields.ABCSaleValue.caption) : null, ew.Validators.float], fields.ABCSaleValue.isInvalid],
        ["ConvertionFactor", [fields.ConvertionFactor.visible && fields.ConvertionFactor.required ? ew.Validators.required(fields.ConvertionFactor.caption) : null, ew.Validators.integer], fields.ConvertionFactor.isInvalid],
        ["ConvertionUnitDesc", [fields.ConvertionUnitDesc.visible && fields.ConvertionUnitDesc.required ? ew.Validators.required(fields.ConvertionUnitDesc.caption) : null], fields.ConvertionUnitDesc.isInvalid],
        ["TransactionId", [fields.TransactionId.visible && fields.TransactionId.required ? ew.Validators.required(fields.TransactionId.caption) : null, ew.Validators.integer], fields.TransactionId.isInvalid],
        ["SoldProductId", [fields.SoldProductId.visible && fields.SoldProductId.required ? ew.Validators.required(fields.SoldProductId.caption) : null, ew.Validators.integer], fields.SoldProductId.isInvalid],
        ["WantedBookId", [fields.WantedBookId.visible && fields.WantedBookId.required ? ew.Validators.required(fields.WantedBookId.caption) : null, ew.Validators.integer], fields.WantedBookId.isInvalid],
        ["AllId", [fields.AllId.visible && fields.AllId.required ? ew.Validators.required(fields.AllId.caption) : null, ew.Validators.integer], fields.AllId.isInvalid],
        ["BatchAndExpiryCompulsory", [fields.BatchAndExpiryCompulsory.visible && fields.BatchAndExpiryCompulsory.required ? ew.Validators.required(fields.BatchAndExpiryCompulsory.caption) : null, ew.Validators.integer], fields.BatchAndExpiryCompulsory.isInvalid],
        ["BatchStockForWantedBook", [fields.BatchStockForWantedBook.visible && fields.BatchStockForWantedBook.required ? ew.Validators.required(fields.BatchStockForWantedBook.caption) : null, ew.Validators.integer], fields.BatchStockForWantedBook.isInvalid],
        ["UnitBasedBilling", [fields.UnitBasedBilling.visible && fields.UnitBasedBilling.required ? ew.Validators.required(fields.UnitBasedBilling.caption) : null, ew.Validators.integer], fields.UnitBasedBilling.isInvalid],
        ["DoNotCheckStock", [fields.DoNotCheckStock.visible && fields.DoNotCheckStock.required ? ew.Validators.required(fields.DoNotCheckStock.caption) : null, ew.Validators.integer], fields.DoNotCheckStock.isInvalid],
        ["AcceptRate", [fields.AcceptRate.visible && fields.AcceptRate.required ? ew.Validators.required(fields.AcceptRate.caption) : null, ew.Validators.integer], fields.AcceptRate.isInvalid],
        ["PriceLevel", [fields.PriceLevel.visible && fields.PriceLevel.required ? ew.Validators.required(fields.PriceLevel.caption) : null, ew.Validators.integer], fields.PriceLevel.isInvalid],
        ["LastQuotePrice", [fields.LastQuotePrice.visible && fields.LastQuotePrice.required ? ew.Validators.required(fields.LastQuotePrice.caption) : null, ew.Validators.float], fields.LastQuotePrice.isInvalid],
        ["PriceChange", [fields.PriceChange.visible && fields.PriceChange.required ? ew.Validators.required(fields.PriceChange.caption) : null, ew.Validators.float], fields.PriceChange.isInvalid],
        ["CommodityCode", [fields.CommodityCode.visible && fields.CommodityCode.required ? ew.Validators.required(fields.CommodityCode.caption) : null], fields.CommodityCode.isInvalid],
        ["InstitutePrice", [fields.InstitutePrice.visible && fields.InstitutePrice.required ? ew.Validators.required(fields.InstitutePrice.caption) : null, ew.Validators.float], fields.InstitutePrice.isInvalid],
        ["CtrlOrDCtrlProduct", [fields.CtrlOrDCtrlProduct.visible && fields.CtrlOrDCtrlProduct.required ? ew.Validators.required(fields.CtrlOrDCtrlProduct.caption) : null, ew.Validators.integer], fields.CtrlOrDCtrlProduct.isInvalid],
        ["ImportedDate", [fields.ImportedDate.visible && fields.ImportedDate.required ? ew.Validators.required(fields.ImportedDate.caption) : null, ew.Validators.datetime(0)], fields.ImportedDate.isInvalid],
        ["IsImported", [fields.IsImported.visible && fields.IsImported.required ? ew.Validators.required(fields.IsImported.caption) : null, ew.Validators.integer], fields.IsImported.isInvalid],
        ...
        ["LPName", [fields.LPName.visible && fields.LPName.required ? ew.Validators.required(fields.LPName.caption) : null], fields.LPName.isInvalid],
        ["GodownNumber", [fields.GodownNumber.visible && fields.GodownNumber.required ? ew.Validators.required(fields.GodownNumber.caption) : null, ew.Validators.integer], fields.GodownNumber.isInvalid],
        ...
        ["CreatedbyUser", [fields.CreatedbyUser.visible && fields.CreatedbyUser.required ? ew.Validators.required(fields.CreatedbyUser.caption) : null], fields.CreatedbyUser.isInvalid],
        ["ModifiedDate", [fields.ModifiedDate.visible && fields.ModifiedDate.required ? ew.Validators.required(fields.ModifiedDate.caption) : null, ew.Validators.datetime(0)], fields.ModifiedDate.isInvalid],
        ["ModifiedbyUser", [fields.ModifiedbyUser.visible && fields.ModifiedbyUser.required ? ew.Validators.required(fields.ModifiedbyUser.caption) : null], fields.ModifiedbyUser.isInvalid],
        ...
        ["AllowExpiryClaim", [fields.AllowExpiryClaim.visible && fields.AllowExpiryClaim.required ? ew.Validators.required(fields.AllowExpiryClaim.caption) : null, ew.Validators.integer], fields.AllowExpiryClaim.isInvalid],
        ["BrandCode", [fields.BrandCode.visible && fields.BrandCode.required ? ew.Validators.required(fields.BrandCode.caption) : null, ew.Validators.integer], fields.BrandCode.isInvalid],
        ["FreeSchemeBasedon", [fields.FreeSchemeBasedon.visible && fields.FreeSchemeBasedon.required ? ew.Validators.required(fields.FreeSchemeBasedon.caption) : null, ew.Validators.integer], fields.FreeSchemeBasedon.isInvalid],
        ["DoNotCheckCostInBill", [fields.DoNotCheckCostInBill.visible && fields.DoNotCheckCostInBill.required ? ew.Validators.required(fields.DoNotCheckCostInBill.caption) : null, ew.Validators.integer], fields.DoNotCheckCostInBill.isInvalid],
        ["ProductGroupCode", [fields.ProductGroupCode.visible && fields.ProductGroupCode.required ? ew.Validators.required(fields.ProductGroupCode.caption) : null, ew.Validators.integer], fields.ProductGroupCode.isInvalid],
        ["ProductStrengthCode", [fields.ProductStrengthCode.visible && fields.ProductStrengthCode.required ? ew.Validators.required(fields.ProductStrengthCode.caption) : null, ew.Validators.integer], fields.ProductStrengthCode.isInvalid],
        ["PackingCode", [fields.PackingCode.visible && fields.PackingCode.required ? ew.Validators.required(fields.PackingCode.caption) : null, ew.Validators.integer], fields.PackingCode.isInvalid],
        ["ComputedMinStock", [fields.ComputedMinStock.visible && fields.ComputedMinStock.required ? ew.Validators.required(fields.ComputedMinStock.caption) : null, ew.Validators.float], fields.ComputedMinStock.isInvalid],
        ["ComputedMaxStock", [fields.ComputedMaxStock.visible && fields.ComputedMaxStock.required ? ew.Validators.required(fields.ComputedMaxStock.caption) : null, ew.Validators.float], fields.ComputedMaxStock.isInvalid],
        ["ProductRemark", [fields.ProductRemark.visible && fields.ProductRemark.required ? ew.Validators.required(fields.ProductRemark.caption) : null, ew.Validators.integer], fields.ProductRemark.isInvalid],
        ["ProductDrugCode", [fields.ProductDrugCode.visible && fields.ProductDrugCode.required ? ew.Validators.required(fields.ProductDrugCode.caption) : null, ew.Validators.integer], fields.ProductDrugCode.isInvalid],
        ["IsMatrixProduct", [fields.IsMatrixProduct.visible && fields.IsMatrixProduct.required ? ew.Validators.required(fields.IsMatrixProduct.caption) : null, ew.Validators.integer], fields.IsMatrixProduct.isInvalid],
        ["AttributeCount1", [fields.AttributeCount1.visible && fields.AttributeCount1.required ? ew.Validators.required(fields.AttributeCount1.caption) : null, ew.Validators.integer], fields.AttributeCount1.isInvalid],
        ["AttributeCount2", [fields.AttributeCount2.visible && fields.AttributeCount2.required ? ew.Validators.required(fields.AttributeCount2.caption) : null, ew.Validators.integer], fields.AttributeCount2.isInvalid],
        ["AttributeCount3", [fields.AttributeCount3.visible && fields.AttributeCount3.required ? ew.Validators.required(fields.AttributeCount3.caption) : null, ew.Validators.integer], fields.AttributeCount3.isInvalid],
        ["AttributeCount4", [fields.AttributeCount4.visible && fields.AttributeCount4.required ? ew.Validators.required(fields.AttributeCount4.caption) : null, ew.Validators.integer], fields.AttributeCount4.isInvalid],
        ["AttributeCount5", [fields.AttributeCount5.visible && fields.AttributeCount5.required ? ew.Validators.required(fields.AttributeCount5.caption) : null, ew.Validators.integer], fields.AttributeCount5.isInvalid],
        ["DefaultDiscountPercentage", [fields.DefaultDiscountPercentage.visible && fields.DefaultDiscountPercentage.required ? ew.Validators.required(fields.DefaultDiscountPercentage.caption) : null, ew.Validators.float], fields.DefaultDiscountPercentage.isInvalid],
        ["DonotPrintBarcode", [fields.DonotPrintBarcode.visible && fields.DonotPrintBarcode.required ? ew.Validators.required(fields.DonotPrintBarcode.caption) : null, ew.Validators.integer], fields.DonotPrintBarcode.isInvalid],
        ["ProductLevelDiscount", [fields.ProductLevelDiscount.visible && fields.ProductLevelDiscount.required ? ew.Validators.required(fields.ProductLevelDiscount.caption) : null, ew.Validators.integer], fields.ProductLevelDiscount.isInvalid],
        ["Markup", [fields.Markup.visible && fields.Markup.required ? ew.Validators.required(fields.Markup.caption) : null, ew.Validators.float], fields.Markup.isInvalid],
        ["MarkDown", [fields.MarkDown.visible && fields.MarkDown.required ? ew.Validators.required(fields.MarkDown.caption) : null, ew.Validators.float], fields.MarkDown.isInvalid],
        ["ReworkSalePrice", [fields.ReworkSalePrice.visible && fields.ReworkSalePrice.required ? ew.Validators.required(fields.ReworkSalePrice.caption) : null, ew.Validators.integer], fields.ReworkSalePrice.isInvalid],
        ["MultipleInput", [fields.MultipleInput.visible && fields.MultipleInput.required ? ew.Validators.required(fields.MultipleInput.caption) : null, ew.Validators.integer], fields.MultipleInput.isInvalid],
        ["LpPackageInformation", [fields.LpPackageInformation.visible && fields.LpPackageInformation.required ? ew.Validators.required(fields.LpPackageInformation.caption) : null], fields.LpPackageInformation.isInvalid],
        ["AllowNegativeStock", [fields.AllowNegativeStock.visible && fields.AllowNegativeStock.required ? ew.Validators.required(fields.AllowNegativeStock.caption) : null, ew.Validators.integer], fields.AllowNegativeStock.isInvalid],
        ...
        ["OrderTime", [fields.OrderTime.visible && fields.OrderTime.required ? ew.Validators.required(fields.OrderTime.caption) : null, ew.Validators.datetime(0)], fields.OrderTime.isInvalid],
        ["RateGroupCode", [fields.RateGroupCode.visible && fields.RateGroupCode.required ? ew.Validators.required(fields.RateGroupCode.caption) : null, ew.Validators.integer], fields.RateGroupCode.isInvalid],
        ["ConversionCaseLot", [fields.ConversionCaseLot.visible && fields.ConversionCaseLot.required ? ew.Validators.required(fields.ConversionCaseLot.caption) : null, ew.Validators.integer], fields.ConversionCaseLot.isInvalid],
        ["ShippingLot", [fields.ShippingLot.visible && fields.ShippingLot.required ? ew.Validators.required(fields.ShippingLot.caption) : null], fields.ShippingLot.isInvalid],
        ["AllowExpiryReplacement", [fields.AllowExpiryReplacement.visible && fields.AllowExpiryReplacement.required ? ew.Validators.required(fields.AllowExpiryReplacement.caption) : null, ew.Validators.integer], fields.AllowExpiryReplacement.isInvalid],
        ["NoOfMonthExpiryAllowed", [fields.NoOfMonthExpiryAllowed.visible && fields.NoOfMonthExpiryAllowed.required ? ew.Validators.required(fields.NoOfMonthExpiryAllowed.caption) : null, ew.Validators.integer], fields.NoOfMonthExpiryAllowed.isInvalid],
        ["ProductDiscountEligibility", [fields.ProductDiscountEligibility.visible && fields.ProductDiscountEligibility.required ? ew.Validators.required(fields.ProductDiscountEligibility.caption) : null, ew.Validators.integer], fields.ProductDiscountEligibility.isInvalid],
        ["ScheduleTypeCode", [fields.ScheduleTypeCode.visible && fields.ScheduleTypeCode.required ? ew.Validators.required(fields.ScheduleTypeCode.caption) : null, ew.Validators.integer], fields.ScheduleTypeCode.isInvalid],
        ["AIOCDProductCode", [fields.AIOCDProductCode.visible && fields.AIOCDProductCode.required ? ew.Validators.required(fields.AIOCDProductCode.caption) : null], fields.AIOCDProductCode.isInvalid],
        ["FreeQuantity", [fields.FreeQuantity.visible && fields.FreeQuantity.required ? ew.Validators.required(fields.FreeQuantity.caption) : null, ew.Validators.float], fields.FreeQuantity.isInvalid],
        ["DiscountType", [fields.DiscountType.visible && fields.DiscountType.required ? ew.Validators.required(fields.DiscountType.caption) : null, ew.Validators.integer], fields.DiscountType.isInvalid],
        ["DiscountValue", [fields.DiscountValue.visible && fields.DiscountValue.required ? ew.Validators.required(fields.DiscountValue.caption) : null, ew.Validators.float], fields.DiscountValue.isInvalid],
        ["HasProductOrderAttribute", [fields.HasProductOrderAttribute.visible && fields.HasProductOrderAttribute.required ? ew.Validators.required(fields.HasProductOrderAttribute.caption) : null, ew.Validators.integer], fields.HasProductOrderAttribute.isInvalid],
        ["FirstPODate", [fields.FirstPODate.visible && fields.FirstPODate.required ? ew.Validators.required(fields.FirstPODate.caption) : null, ew.Validators.datetime(0)], fields.FirstPODate.isInvalid],
        ["SaleprcieAndMrpCalcPercent", [fields.SaleprcieAndMrpCalcPercent.visible && fields.SaleprcieAndMrpCalcPercent.required ? ew.Validators.required(fields.SaleprcieAndMrpCalcPercent.caption) : null, ew.Validators.float], fields.SaleprcieAndMrpCalcPercent.isInvalid],
        ["IsGiftVoucherProducts", [fields.IsGiftVoucherProducts.visible && fields.IsGiftVoucherProducts.required ? ew.Validators.required(fields.IsGiftVoucherProducts.caption) : null, ew.Validators.integer], fields.IsGiftVoucherProducts.isInvalid],
        ["AcceptRange4SerialNumber", [fields.AcceptRange4SerialNumber.visible && fields.AcceptRange4SerialNumber.required ? ew.Validators.required(fields.AcceptRange4SerialNumber.caption) : null, ew.Validators.integer], fields.AcceptRange4SerialNumber.isInvalid],
        ["GiftVoucherDenomination", [fields.GiftVoucherDenomination.visible && fields.GiftVoucherDenomination.required ? ew.Validators.required(fields.GiftVoucherDenomination.caption) : null, ew.Validators.integer], fields.GiftVoucherDenomination.isInvalid],
        ["Subclasscode", [fields.Subclasscode.visible && fields.Subclasscode.required ? ew.Validators.required(fields.Subclasscode.caption) : null], fields.Subclasscode.isInvalid],
        ["BarCodeFromWeighingMachine", [fields.BarCodeFromWeighingMachine.visible && fields.BarCodeFromWeighingMachine.required ? ew.Validators.required(fields.BarCodeFromWeighingMachine.caption) : null, ew.Validators.integer], fields.BarCodeFromWeighingMachine.isInvalid],
        ["CheckCostInReturn", [fields.CheckCostInReturn.visible && fields.CheckCostInReturn.required ? ew.Validators.required(fields.CheckCostInReturn.caption) : null, ew.Validators.integer], fields.CheckCostInReturn.isInvalid],
        ["FrequentSaleProduct", [fields.FrequentSaleProduct.visible && fields.FrequentSaleProduct.required ? ew.Validators.required(fields.FrequentSaleProduct.caption) : null, ew.Validators.integer], fields.FrequentSaleProduct.isInvalid],
        ["RateType", [fields.RateType.visible && fields.RateType.required ? ew.Validators.required(fields.RateType.caption) : null, ew.Validators.integer], fields.RateType.isInvalid],
        ["TouchscreenName", [fields.TouchscreenName.visible && fields.TouchscreenName.required ? ew.Validators.required(fields.TouchscreenName.caption) : null], fields.TouchscreenName.isInvalid],
        ["FreeType", [fields.FreeType.visible && fields.FreeType.required ? ew.Validators.required(fields.FreeType.caption) : null, ew.Validators.integer], fields.FreeType.isInvalid],
        ["LooseQtyasNewBatch", [fields.LooseQtyasNewBatch.visible && fields.LooseQtyasNewBatch.required ? ew.Validators.required(fields.LooseQtyasNewBatch.caption) : null, ew.Validators.integer], fields.LooseQtyasNewBatch.isInvalid],
        ["AllowSlabBilling", [fields.AllowSlabBilling.visible && fields.AllowSlabBilling.required ? ew.Validators.required(fields.AllowSlabBilling.caption) : null, ew.Validators.integer], fields.AllowSlabBilling.isInvalid],
        ["ProductTypeForProduction", [fields.ProductTypeForProduction.visible && fields.ProductTypeForProduction.required ? ew.Validators.required(fields.ProductTypeForProduction.caption) : null, ew.Validators.integer], fields.ProductTypeForProduction.isInvalid],
        ["RecipeCode", [fields.RecipeCode.visible && fields.RecipeCode.required ? ew.Validators.required(fields.RecipeCode.caption) : null, ew.Validators.integer], fields.RecipeCode.isInvalid],
        ["DefaultUnitType", [fields.DefaultUnitType.visible && fields.DefaultUnitType.required ? ew.Validators.required(fields.DefaultUnitType.caption) : null, ew.Validators.integer], fields.DefaultUnitType.isInvalid],
        ["PIstatus", [fields.PIstatus.visible && fields.PIstatus.required ? ew.Validators.required(fields.PIstatus.caption) : null, ew.Validators.integer], fields.PIstatus.isInvalid],
        ["LastPiConfirmedDate", [fields.LastPiConfirmedDate.visible && fields.LastPiConfirmedDate.required ? ew.Validators.required(fields.LastPiConfirmedDate.caption) : null, ew.Validators.datetime(0)], fields.LastPiConfirmedDate.isInvalid],
        ["BarCodeDesign", [fields.BarCodeDesign.visible && fields.BarCodeDesign.required ? ew.Validators.required(fields.BarCodeDesign.caption) : null], fields.BarCodeDesign.isInvalid],
        ["AcceptRemarksInBill", [fields.AcceptRemarksInBill.visible && fields.AcceptRemarksInBill.required ? ew.Validators.required(fields.AcceptRemarksInBill.caption) : null, ew.Validators.integer], fields.AcceptRemarksInBill.isInvalid],
        ["Classification", [fields.Classification.visible && fields.Classification.required ? ew.Validators.required(fields.Classification.caption) : null, ew.Validators.integer], fields.Classification.isInvalid],
        ["TimeSlot", [fields.TimeSlot.visible && fields.TimeSlot.required ? ew.Validators.required(fields.TimeSlot.caption) : null, ew.Validators.integer], fields.TimeSlot.isInvalid],
        ["IsBundle", [fields.IsBundle.visible && fields.IsBundle.required ? ew.Validators.required(fields.IsBundle.caption) : null, ew.Validators.integer], fields.IsBundle.isInvalid],
        ["ColorCode", [fields.ColorCode.visible && fields.ColorCode.required ? ew.Validators.required(fields.ColorCode.caption) : null, ew.Validators.integer], fields.ColorCode.isInvalid],
        ["GenderCode", [fields.GenderCode.visible && fields.GenderCode.required ? ew.Validators.required(fields.GenderCode.caption) : null, ew.Validators.integer], fields.GenderCode.isInvalid],
        ["SizeCode", [fields.SizeCode.visible && fields.SizeCode.required ? ew.Validators.required(fields.SizeCode.caption) : null, ew.Validators.integer], fields.SizeCode.isInvalid],
        ["GiftCard", [fields.GiftCard.visible && fields.GiftCard.required ? ew.Validators.required(fields.GiftCard.caption) : null, ew.Validators.integer], fields.GiftCard.isInvalid],
        ["ToonLabel", [fields.ToonLabel.visible && fields.ToonLabel.required ? ew.Validators.required(fields.ToonLabel.caption) : null, ew.Validators.integer], fields.ToonLabel.isInvalid],
        ["GarmentType", [fields.GarmentType.visible && fields.GarmentType.required ? ew.Validators.required(fields.GarmentType.caption) : null, ew.Validators.integer], fields.GarmentType.isInvalid],
        ["AgeGroup", [fields.AgeGroup.visible && fields.AgeGroup.required ? ew.Validators.required(fields.AgeGroup.caption) : null, ew.Validators.integer], fields.AgeGroup.isInvalid],
        ["Season", [fields.Season.visible && fields.Season.required ? ew.Validators.required(fields.Season.caption) : null, ew.Validators.integer], fields.Season.isInvalid],
        ["DailyStockEntry", [fields.DailyStockEntry.visible && fields.DailyStockEntry.required ? ew.Validators.required(fields.DailyStockEntry.caption) : null, ew.Validators.integer], fields.DailyStockEntry.isInvalid],
        ["ModifierApplicable", [fields.ModifierApplicable.visible && fields.ModifierApplicable.required ? ew.Validators.required(fields.ModifierApplicable.caption) : null, ew.Validators.integer], fields.ModifierApplicable.isInvalid],
        ["ModifierType", [fields.ModifierType.visible && fields.ModifierType.required ? ew.Validators.required(fields.ModifierType.caption) : null, ew.Validators.integer], fields.ModifierType.isInvalid],
        ["AcceptZeroRate", [fields.AcceptZeroRate.visible && fields.AcceptZeroRate.required ? ew.Validators.required(fields.AcceptZeroRate.caption) : null, ew.Validators.integer], fields.AcceptZeroRate.isInvalid],
        ["ExciseDutyCode", [fields.ExciseDutyCode.visible && fields.ExciseDutyCode.required ? ew.Validators.required(fields.ExciseDutyCode.caption) : null, ew.Validators.integer], fields.ExciseDutyCode.isInvalid],
        ["IndentProductGroupCode", [fields.IndentProductGroupCode.visible && fields.IndentProductGroupCode.required ? ew.Validators.required(fields.IndentProductGroupCode.caption) : null, ew.Validators.integer], fields.IndentProductGroupCode.isInvalid],
        ["IsMultiBatch", [fields.IsMultiBatch.visible && fields.IsMultiBatch.required ? ew.Validators.required(fields.IsMultiBatch.caption) : null, ew.Validators.integer], fields.IsMultiBatch.isInvalid],
        ["IsSingleBatch", [fields.IsSingleBatch.visible && fields.IsSingleBatch.required ? ew.Validators.required(fields.IsSingleBatch.caption) : null, ew.Validators.integer], fields.IsSingleBatch.isInvalid],
        ["MarkUpRate1", [fields.MarkUpRate1.visible && fields.MarkUpRate1.required ? ew.Validators.required(fields.MarkUpRate1.caption) : null, ew.Validators.float], fields.MarkUpRate1.isInvalid],
        ["MarkDownRate1", [fields.MarkDownRate1.visible && fields.MarkDownRate1.required ? ew.Validators.required(fields.MarkDownRate1.caption) : null, ew.Validators.float], fields.MarkDownRate1.isInvalid],
        ["MarkUpRate2", [fields.MarkUpRate2.visible && fields.MarkUpRate2.required ? ew.Validators.required(fields.MarkUpRate2.caption) : null, ew.Validators.float], fields.MarkUpRate2.isInvalid],
        ["MarkDownRate2", [fields.MarkDownRate2.visible && fields.MarkDownRate2.required ? ew.Validators.required(fields.MarkDownRate2.caption) : null, ew.Validators.float], fields.MarkDownRate2.isInvalid],
        ["_Yield", [fields._Yield.visible && fields._Yield.required ? ew.Validators.required(fields._Yield.caption) : null, ew.Validators.float], fields._Yield.isInvalid],
        ["RefProductCode", [fields.RefProductCode.visible && fields.RefProductCode.required ? ew.Validators.required(fields.RefProductCode.caption) : null, ew.Validators.integer], fields.RefProductCode.isInvalid],
        ...
        ["MeasurementID", [fields.MeasurementID.visible && fields.MeasurementID.required ? ew.Validators.required(fields.MeasurementID.caption) : null, ew.Validators.integer], fields.MeasurementID.isInvalid],
        ["CountryCode", [fields.CountryCode.visible && fields.CountryCode.required ? ew.Validators.required(fields.CountryCode.caption) : null, ew.Validators.integer], fields.CountryCode.isInvalid],
        ["AcceptWMQty", [fields.AcceptWMQty.visible && fields.AcceptWMQty.required ? ew.Validators.required(fields.AcceptWMQty.caption) : null, ew.Validators.integer], fields.AcceptWMQty.isInvalid],
        ["SingleBatchBasedOnRate", [fields.SingleBatchBasedOnRate.visible && fields.SingleBatchBasedOnRate.required ? ew.Validators.required(fields.SingleBatchBasedOnRate.caption) : null, ew.Validators.integer], fields.SingleBatchBasedOnRate.isInvalid],
        ["TenderNo", [fields.TenderNo.visible && fields.TenderNo.required ? ew.Validators.required(fields.TenderNo.caption) : null], fields.TenderNo.isInvalid],
        ["SingleBillMaximumSoldQtyFiled", [fields.SingleBillMaximumSoldQtyFiled.visible && fields.SingleBillMaximumSoldQtyFiled.required ? ew.Validators.required(fields.SingleBillMaximumSoldQtyFiled.caption) : null, ew.Validators.float], fields.SingleBillMaximumSoldQtyFiled.isInvalid],
        ...
        ["IngredientCode1", [fields.IngredientCode1.visible && fields.IngredientCode1.required ? ew.Validators.required(fields.IngredientCode1.caption) : null, ew.Validators.integer], fields.IngredientCode1.isInvalid],
        ["IngredientCode2", [fields.IngredientCode2.visible && fields.IngredientCode2.required ? ew.Validators.required(fields.IngredientCode2.caption) : null, ew.Validators.integer], fields.IngredientCode2.isInvalid],
        ["IngredientCode3", [fields.IngredientCode3.visible && fields.IngredientCode3.required ? ew.Validators.required(fields.IngredientCode3.caption) : null, ew.Validators.integer], fields.IngredientCode3.isInvalid],
        ["IngredientCode4", [fields.IngredientCode4.visible && fields.IngredientCode4.required ? ew.Validators.required(fields.IngredientCode4.caption) : null, ew.Validators.integer], fields.IngredientCode4.isInvalid],
        ["IngredientCode5", [fields.IngredientCode5.visible && fields.IngredientCode5.required ? ew.Validators.required(fields.IngredientCode5.caption) : null, ew.Validators.integer], fields.IngredientCode5.isInvalid],
        ["OrderType", [fields.OrderType.visible && fields.OrderType.required ? ew.Validators.required(fields.OrderType.caption) : null, ew.Validators.integer], fields.OrderType.isInvalid],
        ["StockUOM", [fields.StockUOM.visible && fields.StockUOM.required ? ew.Validators.required(fields.StockUOM.caption) : null, ew.Validators.integer], fields.StockUOM.isInvalid],
        ["PriceUOM", [fields.PriceUOM.visible && fields.PriceUOM.required ? ew.Validators.required(fields.PriceUOM.caption) : null, ew.Validators.integer], fields.PriceUOM.isInvalid],
        ["DefaultSaleUOM", [fields.DefaultSaleUOM.visible && fields.DefaultSaleUOM.required ? ew.Validators.required(fields.DefaultSaleUOM.caption) : null, ew.Validators.integer], fields.DefaultSaleUOM.isInvalid],
        ["DefaultPurchaseUOM", [fields.DefaultPurchaseUOM.visible && fields.DefaultPurchaseUOM.required ? ew.Validators.required(fields.DefaultPurchaseUOM.caption) : null, ew.Validators.integer], fields.DefaultPurchaseUOM.isInvalid],
        ["ReportingUOM", [fields.ReportingUOM.visible && fields.ReportingUOM.required ? ew.Validators.required(fields.ReportingUOM.caption) : null, ew.Validators.integer], fields.ReportingUOM.isInvalid],
        ["LastPurchasedUOM", [fields.LastPurchasedUOM.visible && fields.LastPurchasedUOM.required ? ew.Validators.required(fields.LastPurchasedUOM.caption) : null, ew.Validators.integer], fields.LastPurchasedUOM.isInvalid],
        ["TreatmentCodes", [fields.TreatmentCodes.visible && fields.TreatmentCodes.required ? ew.Validators.required(fields.TreatmentCodes.caption) : null], fields.TreatmentCodes.isInvalid],
        ["InsuranceType", [fields.InsuranceType.visible && fields.InsuranceType.required ? ew.Validators.required(fields.InsuranceType.caption) : null, ew.Validators.integer], fields.InsuranceType.isInvalid],
        ["CoverageGroupCodes", [fields.CoverageGroupCodes.visible && fields.CoverageGroupCodes.required ? ew.Validators.required(fields.CoverageGroupCodes.caption) : null], fields.CoverageGroupCodes.isInvalid],
        ["MultipleUOM", [fields.MultipleUOM.visible && fields.MultipleUOM.required ? ew.Validators.required(fields.MultipleUOM.caption) : null, ew.Validators.integer], fields.MultipleUOM.isInvalid],
        ["SalePriceComputation", [fields.SalePriceComputation.visible && fields.SalePriceComputation.required ? ew.Validators.required(fields.SalePriceComputation.caption) : null, ew.Validators.integer], fields.SalePriceComputation.isInvalid],
        ["StockCorrection", [fields.StockCorrection.visible && fields.StockCorrection.required ? ew.Validators.required(fields.StockCorrection.caption) : null, ew.Validators.integer], fields.StockCorrection.isInvalid],
        ["LBTPercentage", [fields.LBTPercentage.visible && fields.LBTPercentage.required ? ew.Validators.required(fields.LBTPercentage.caption) : null, ew.Validators.float], fields.LBTPercentage.isInvalid],
        ["SalesCommission", [fields.SalesCommission.visible && fields.SalesCommission.required ? ew.Validators.required(fields.SalesCommission.caption) : null, ew.Validators.float], fields.SalesCommission.isInvalid],
        ["LockedStock", [fields.LockedStock.visible && fields.LockedStock.required ? ew.Validators.required(fields.LockedStock.caption) : null, ew.Validators.float], fields.LockedStock.isInvalid],
        ["MinMaxUOM", [fields.MinMaxUOM.visible && fields.MinMaxUOM.required ? ew.Validators.required(fields.MinMaxUOM.caption) : null, ew.Validators.integer], fields.MinMaxUOM.isInvalid],
        ["ExpiryMfrDateFormat", [fields.ExpiryMfrDateFormat.visible && fields.ExpiryMfrDateFormat.required ? ew.Validators.required(fields.ExpiryMfrDateFormat.caption) : null, ew.Validators.integer], fields.ExpiryMfrDateFormat.isInvalid],
        ["ProductLifeTime", [fields.ProductLifeTime.visible && fields.ProductLifeTime.required ? ew.Validators.required(fields.ProductLifeTime.caption) : null, ew.Validators.integer], fields.ProductLifeTime.isInvalid],
        ["IsCombo", [fields.IsCombo.visible && fields.IsCombo.required ? ew.Validators.required(fields.IsCombo.caption) : null, ew.Validators.integer], fields.IsCombo.isInvalid],
        ["ComboTypeCode", [fields.ComboTypeCode.visible && fields.ComboTypeCode.required ? ew.Validators.required(fields.ComboTypeCode.caption) : null, ew.Validators.integer], fields.ComboTypeCode.isInvalid],
        ["AttributeCount6", [fields.AttributeCount6.visible && fields.AttributeCount6.required ? ew.Validators.required(fields.AttributeCount6.caption) : null, ew.Validators.integer], fields.AttributeCount6.isInvalid],
        ["AttributeCount7", [fields.AttributeCount7.visible && fields.AttributeCount7.required ? ew.Validators.required(fields.AttributeCount7.caption) : null, ew.Validators.integer], fields.AttributeCount7.isInvalid],
        ["AttributeCount8", [fields.AttributeCount8.visible && fields.AttributeCount8.required ? ew.Validators.required(fields.AttributeCount8.caption) : null, ew.Validators.integer], fields.AttributeCount8.isInvalid],
        ["AttributeCount9", [fields.AttributeCount9.visible && fields.AttributeCount9.required ? ew.Validators.required(fields.AttributeCount9.caption) : null, ew.Validators.integer], fields.AttributeCount9.isInvalid],
        ["AttributeCount10", [fields.AttributeCount10.visible && fields.AttributeCount10.required ? ew.Validators.required(fields.AttributeCount10.caption) : null, ew.Validators.integer], fields.AttributeCount10.isInvalid],
        ["LabourCharge", [fields.LabourCharge.visible && fields.LabourCharge.required ? ew.Validators.required(fields.LabourCharge.caption) : null, ew.Validators.float], fields.LabourCharge.isInvalid],
        ["AffectOtherCharge", [fields.AffectOtherCharge.visible && fields.AffectOtherCharge.required ? ew.Validators.required(fields.AffectOtherCharge.caption) : null, ew.Validators.integer], fields.AffectOtherCharge.isInvalid],
        ["DosageInfo", [fields.DosageInfo.visible && fields.DosageInfo.required ? ew.Validators.required(fields.DosageInfo.caption) : null], fields.DosageInfo.isInvalid],
        ["DosageType", [fields.DosageType.visible && fields.DosageType.required ? ew.Validators.required(fields.DosageType.caption) : null, ew.Validators.integer], fields.DosageType.isInvalid],
        ["DefaultIndentUOM", [fields.DefaultIndentUOM.visible && fields.DefaultIndentUOM.required ? ew.Validators.required(fields.DefaultIndentUOM.caption) : null, ew.Validators.integer], fields.DefaultIndentUOM.isInvalid],
        ["PromoTag", [fields.PromoTag.visible && fields.PromoTag.required ? ew.Validators.required(fields.PromoTag.caption) : null, ew.Validators.integer], fields.PromoTag.isInvalid],
        ["BillLevelPromoTag", [fields.BillLevelPromoTag.visible && fields.BillLevelPromoTag.required ? ew.Validators.required(fields.BillLevelPromoTag.caption) : null, ew.Validators.integer], fields.BillLevelPromoTag.isInvalid],
        ["IsMRPProduct", [fields.IsMRPProduct.visible && fields.IsMRPProduct.required ? ew.Validators.required(fields.IsMRPProduct.caption) : null, ew.Validators.integer], fields.IsMRPProduct.isInvalid],
        ["MrpList", [fields.MrpList.visible && fields.MrpList.required ? ew.Validators.required(fields.MrpList.caption) : null], fields.MrpList.isInvalid],
        ["AlternateSaleUOM", [fields.AlternateSaleUOM.visible && fields.AlternateSaleUOM.required ? ew.Validators.required(fields.AlternateSaleUOM.caption) : null, ew.Validators.integer], fields.AlternateSaleUOM.isInvalid],
        ["FreeUOM", [fields.FreeUOM.visible && fields.FreeUOM.required ? ew.Validators.required(fields.FreeUOM.caption) : null, ew.Validators.integer], fields.FreeUOM.isInvalid],
        ["MarketedCode", [fields.MarketedCode.visible && fields.MarketedCode.required ? ew.Validators.required(fields.MarketedCode.caption) : null], fields.MarketedCode.isInvalid],
        ["MinimumSalePrice", [fields.MinimumSalePrice.visible && fields.MinimumSalePrice.required ? ew.Validators.required(fields.MinimumSalePrice.caption) : null, ew.Validators.float], fields.MinimumSalePrice.isInvalid],
        ["PRate1", [fields.PRate1.visible && fields.PRate1.required ? ew.Validators.required(fields.PRate1.caption) : null, ew.Validators.float], fields.PRate1.isInvalid],
        ["PRate2", [fields.PRate2.visible && fields.PRate2.required ? ew.Validators.required(fields.PRate2.caption) : null, ew.Validators.float], fields.PRate2.isInvalid],
        ["LPItemCost", [fields.LPItemCost.visible && fields.LPItemCost.required ? ew.Validators.required(fields.LPItemCost.caption) : null, ew.Validators.float], fields.LPItemCost.isInvalid],
        ["FixedItemCost", [fields.FixedItemCost.visible && fields.FixedItemCost.required ? ew.Validators.required(fields.FixedItemCost.caption) : null, ew.Validators.float], fields.FixedItemCost.isInvalid],
        ["HSNId", [fields.HSNId.visible && fields.HSNId.required ? ew.Validators.required(fields.HSNId.caption) : null, ew.Validators.integer], fields.HSNId.isInvalid],
        ["TaxInclusive", [fields.TaxInclusive.visible && fields.TaxInclusive.required ? ew.Validators.required(fields.TaxInclusive.caption) : null, ew.Validators.integer], fields.TaxInclusive.isInvalid],
        ["EligibleforWarranty", [fields.EligibleforWarranty.visible && fields.EligibleforWarranty.required ? ew.Validators.required(fields.EligibleforWarranty.caption) : null, ew.Validators.integer], fields.EligibleforWarranty.isInvalid],
        ["NoofMonthsWarranty", [fields.NoofMonthsWarranty.visible && fields.NoofMonthsWarranty.required ? ew.Validators.required(fields.NoofMonthsWarranty.caption) : null, ew.Validators.integer], fields.NoofMonthsWarranty.isInvalid],
        ["ComputeTaxonCost", [fields.ComputeTaxonCost.visible && fields.ComputeTaxonCost.required ? ew.Validators.required(fields.ComputeTaxonCost.caption) : null, ew.Validators.integer], fields.ComputeTaxonCost.isInvalid],
        ["HasEmptyBottleTrack", [fields.HasEmptyBottleTrack.visible && fields.HasEmptyBottleTrack.required ? ew.Validators.required(fields.HasEmptyBottleTrack.caption) : null, ew.Validators.integer], fields.HasEmptyBottleTrack.isInvalid],
        ["EmptyBottleReferenceCode", [fields.EmptyBottleReferenceCode.visible && fields.EmptyBottleReferenceCode.required ? ew.Validators.required(fields.EmptyBottleReferenceCode.caption) : null, ew.Validators.integer], fields.EmptyBottleReferenceCode.isInvalid],
        ["AdditionalCESSAmount", [fields.AdditionalCESSAmount.visible && fields.AdditionalCESSAmount.required ? ew.Validators.required(fields.AdditionalCESSAmount.caption) : null, ew.Validators.float], fields.AdditionalCESSAmount.isInvalid],
        ["EmptyBottleRate", [fields.EmptyBottleRate.visible && fields.EmptyBottleRate.required ? ew.Validators.required(fields.EmptyBottleRate.caption) : null, ew.Validators.float], fields.EmptyBottleRate.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fpharmacy_productsedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpharmacy_productsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_productsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_productsedit" id="fpharmacy_productsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ProductCode->Visible) { // ProductCode ?>
    <div id="r_ProductCode" class="form-group row">
        <label id="elh_pharmacy_products_ProductCode" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ProductCode->caption() ?><?= $Page->ProductCode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->ProductCode->getDisplayValue($Page->ProductCode->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="pharmacy_products" data-field="x_ProductCode" data-hidden="1" name="x_ProductCode" id="x_ProductCode" value="<?= HtmlEncode($Page->ProductCode->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
