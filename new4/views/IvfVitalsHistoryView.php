...
<?php } ?>
<script>
if (!ew.vars.tables.ivf_vitals_history) ew.vars.tables.ivf_vitals_history = <?= JsonEncode(GetClientVar("tables", "ivf_vitals_history")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fivf_vitals_historyview" id="fivf_vitals_historyview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_id"><template id="tpc_ivf_vitals_history_id"><?= $Page->id->caption() ?></template></span></td>
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <tr id="r_RIDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_RIDNO"><template id="tpc_ivf_vitals_history_RIDNO"><?= $Page->RIDNO->caption() ?></template></span></td>
...
<?php if ($Page->Name->Visible) { // Name ?>
    <tr id="r_Name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Name"><template id="tpc_ivf_vitals_history_Name"><?= $Page->Name->caption() ?></template></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Age"><template id="tpc_ivf_vitals_history_Age"><?= $Page->Age->caption() ?></template></span></td>
...
<?php if ($Page->SEX->Visible) { // SEX ?>
    <tr id="r_SEX">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_SEX"><template id="tpc_ivf_vitals_history_SEX"><?= $Page->SEX->caption() ?></template></span></td>
...
<?php if ($Page->Religion->Visible) { // Religion ?>
    <tr id="r_Religion">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Religion"><template id="tpc_ivf_vitals_history_Religion"><?= $Page->Religion->caption() ?></template></span></td>
...
<?php if ($Page->Address->Visible) { // Address ?>
    <tr id="r_Address">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Address"><template id="tpc_ivf_vitals_history_Address"><?= $Page->Address->caption() ?></template></span></td>
...
<?php if ($Page->IdentificationMark->Visible) { // IdentificationMark ?>
    <tr id="r_IdentificationMark">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_IdentificationMark"><template id="tpc_ivf_vitals_history_IdentificationMark"><?= $Page->IdentificationMark->caption() ?></template></span></td>
...
<?php if ($Page->DoublewitnessName1->Visible) { // DoublewitnessName1 ?>
    <tr id="r_DoublewitnessName1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_DoublewitnessName1"><template id="tpc_ivf_vitals_history_DoublewitnessName1"><?= $Page->DoublewitnessName1->caption() ?></template></span></td>
...
<?php if ($Page->DoublewitnessName2->Visible) { // DoublewitnessName2 ?>
    <tr id="r_DoublewitnessName2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_DoublewitnessName2"><template id="tpc_ivf_vitals_history_DoublewitnessName2"><?= $Page->DoublewitnessName2->caption() ?></template></span></td>
...
<?php if ($Page->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
    <tr id="r_Chiefcomplaints">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Chiefcomplaints"><template id="tpc_ivf_vitals_history_Chiefcomplaints"><?= $Page->Chiefcomplaints->caption() ?></template></span></td>
...
<?php if ($Page->MenstrualHistory->Visible) { // MenstrualHistory ?>
    <tr id="r_MenstrualHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MenstrualHistory"><template id="tpc_ivf_vitals_history_MenstrualHistory"><?= $Page->MenstrualHistory->caption() ?></template></span></td>
...
<?php if ($Page->ObstetricHistory->Visible) { // ObstetricHistory ?>
    <tr id="r_ObstetricHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_ObstetricHistory"><template id="tpc_ivf_vitals_history_ObstetricHistory"><?= $Page->ObstetricHistory->caption() ?></template></span></td>
...
<?php if ($Page->MedicalHistory->Visible) { // MedicalHistory ?>
    <tr id="r_MedicalHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MedicalHistory"><template id="tpc_ivf_vitals_history_MedicalHistory"><?= $Page->MedicalHistory->caption() ?></template></span></td>
...
<?php if ($Page->SurgicalHistory->Visible) { // SurgicalHistory ?>
    <tr id="r_SurgicalHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_SurgicalHistory"><template id="tpc_ivf_vitals_history_SurgicalHistory"><?= $Page->SurgicalHistory->caption() ?></template></span></td>
...
<?php if ($Page->Generalexaminationpallor->Visible) { // Generalexaminationpallor ?>
    <tr id="r_Generalexaminationpallor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Generalexaminationpallor"><template id="tpc_ivf_vitals_history_Generalexaminationpallor"><?= $Page->Generalexaminationpallor->caption() ?></template></span></td>
...
<?php if ($Page->PR->Visible) { // PR ?>
    <tr id="r_PR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PR"><template id="tpc_ivf_vitals_history_PR"><?= $Page->PR->caption() ?></template></span></td>
...
<?php if ($Page->CVS->Visible) { // CVS ?>
    <tr id="r_CVS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_CVS"><template id="tpc_ivf_vitals_history_CVS"><?= $Page->CVS->caption() ?></template></span></td>
...
<?php if ($Page->PA->Visible) { // PA ?>
    <tr id="r_PA">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PA"><template id="tpc_ivf_vitals_history_PA"><?= $Page->PA->caption() ?></template></span></td>
...
<?php if ($Page->PROVISIONALDIAGNOSIS->Visible) { // PROVISIONALDIAGNOSIS ?>
    <tr id="r_PROVISIONALDIAGNOSIS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PROVISIONALDIAGNOSIS"><template id="tpc_ivf_vitals_history_PROVISIONALDIAGNOSIS"><?= $Page->PROVISIONALDIAGNOSIS->caption() ?></template></span></td>
...
<?php if ($Page->Investigations->Visible) { // Investigations ?>
    <tr id="r_Investigations">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Investigations"><template id="tpc_ivf_vitals_history_Investigations"><?= $Page->Investigations->caption() ?></template></span></td>
...
<?php if ($Page->Fheight->Visible) { // Fheight ?>
    <tr id="r_Fheight">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Fheight"><template id="tpc_ivf_vitals_history_Fheight"><?= $Page->Fheight->caption() ?></template></span></td>
...
<?php if ($Page->Fweight->Visible) { // Fweight ?>
    <tr id="r_Fweight">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Fweight"><template id="tpc_ivf_vitals_history_Fweight"><?= $Page->Fweight->caption() ?></template></span></td>
...
<?php if ($Page->FBMI->Visible) { // FBMI ?>
    <tr id="r_FBMI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FBMI"><template id="tpc_ivf_vitals_history_FBMI"><?= $Page->FBMI->caption() ?></template></span></td>
...
<?php if ($Page->FBloodgroup->Visible) { // FBloodgroup ?>
    <tr id="r_FBloodgroup">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FBloodgroup"><template id="tpc_ivf_vitals_history_FBloodgroup"><?= $Page->FBloodgroup->caption() ?></template></span></td>
...
<?php if ($Page->Mheight->Visible) { // Mheight ?>
    <tr id="r_Mheight">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Mheight"><template id="tpc_ivf_vitals_history_Mheight"><?= $Page->Mheight->caption() ?></template></span></td>
...
<?php if ($Page->Mweight->Visible) { // Mweight ?>
    <tr id="r_Mweight">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Mweight"><template id="tpc_ivf_vitals_history_Mweight"><?= $Page->Mweight->caption() ?></template></span></td>
...
<?php if ($Page->MBMI->Visible) { // MBMI ?>
    <tr id="r_MBMI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MBMI"><template id="tpc_ivf_vitals_history_MBMI"><?= $Page->MBMI->caption() ?></template></span></td>
...
<?php if ($Page->MBloodgroup->Visible) { // MBloodgroup ?>
    <tr id="r_MBloodgroup">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MBloodgroup"><template id="tpc_ivf_vitals_history_MBloodgroup"><?= $Page->MBloodgroup->caption() ?></template></span></td>
...
<?php if ($Page->FBuild->Visible) { // FBuild ?>
    <tr id="r_FBuild">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FBuild"><template id="tpc_ivf_vitals_history_FBuild"><?= $Page->FBuild->caption() ?></template></span></td>
...
<?php if ($Page->MBuild->Visible) { // MBuild ?>
    <tr id="r_MBuild">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MBuild"><template id="tpc_ivf_vitals_history_MBuild"><?= $Page->MBuild->caption() ?></template></span></td>
...
<?php if ($Page->FSkinColor->Visible) { // FSkinColor ?>
    <tr id="r_FSkinColor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FSkinColor"><template id="tpc_ivf_vitals_history_FSkinColor"><?= $Page->FSkinColor->caption() ?></template></span></td>
...
<?php if ($Page->MSkinColor->Visible) { // MSkinColor ?>
    <tr id="r_MSkinColor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MSkinColor"><template id="tpc_ivf_vitals_history_MSkinColor"><?= $Page->MSkinColor->caption() ?></template></span></td>
...
<?php if ($Page->FEyesColor->Visible) { // FEyesColor ?>
    <tr id="r_FEyesColor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FEyesColor"><template id="tpc_ivf_vitals_history_FEyesColor"><?= $Page->FEyesColor->caption() ?></template></span></td>
...
<?php if ($Page->MEyesColor->Visible) { // MEyesColor ?>
    <tr id="r_MEyesColor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MEyesColor"><template id="tpc_ivf_vitals_history_MEyesColor"><?= $Page->MEyesColor->caption() ?></template></span></td>
...
<?php if ($Page->FHairColor->Visible) { // FHairColor ?>
    <tr id="r_FHairColor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FHairColor"><template id="tpc_ivf_vitals_history_FHairColor"><?= $Page->FHairColor->caption() ?></template></span></td>
...
<?php if ($Page->MhairColor->Visible) { // MhairColor ?>
    <tr id="r_MhairColor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MhairColor"><template id="tpc_ivf_vitals_history_MhairColor"><?= $Page->MhairColor->caption() ?></template></span></td>
...
<?php if ($Page->FhairTexture->Visible) { // FhairTexture ?>
    <tr id="r_FhairTexture">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FhairTexture"><template id="tpc_ivf_vitals_history_FhairTexture"><?= $Page->FhairTexture->caption() ?></template></span></td>
...
<?php if ($Page->MHairTexture->Visible) { // MHairTexture ?>
    <tr id="r_MHairTexture">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MHairTexture"><template id="tpc_ivf_vitals_history_MHairTexture"><?= $Page->MHairTexture->caption() ?></template></span></td>
...
<?php if ($Page->Fothers->Visible) { // Fothers ?>
    <tr id="r_Fothers">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Fothers"><template id="tpc_ivf_vitals_history_Fothers"><?= $Page->Fothers->caption() ?></template></span></td>
...
<?php if ($Page->Mothers->Visible) { // Mothers ?>
    <tr id="r_Mothers">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Mothers"><template id="tpc_ivf_vitals_history_Mothers"><?= $Page->Mothers->caption() ?></template></span></td>
...
<?php if ($Page->PGE->Visible) { // PGE ?>
    <tr id="r_PGE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PGE"><template id="tpc_ivf_vitals_history_PGE"><?= $Page->PGE->caption() ?></template></span></td>
...
<?php if ($Page->PPR->Visible) { // PPR ?>
    <tr id="r_PPR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PPR"><template id="tpc_ivf_vitals_history_PPR"><?= $Page->PPR->caption() ?></template></span></td>
...
<?php if ($Page->PBP->Visible) { // PBP ?>
    <tr id="r_PBP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PBP"><template id="tpc_ivf_vitals_history_PBP"><?= $Page->PBP->caption() ?></template></span></td>
...
<?php if ($Page->Breast->Visible) { // Breast ?>
    <tr id="r_Breast">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Breast"><template id="tpc_ivf_vitals_history_Breast"><?= $Page->Breast->caption() ?></template></span></td>
...
<?php if ($Page->PPA->Visible) { // PPA ?>
    <tr id="r_PPA">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PPA"><template id="tpc_ivf_vitals_history_PPA"><?= $Page->PPA->caption() ?></template></span></td>
...
<?php if ($Page->PPSV->Visible) { // PPSV ?>
    <tr id="r_PPSV">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PPSV"><template id="tpc_ivf_vitals_history_PPSV"><?= $Page->PPSV->caption() ?></template></span></td>
...
<?php if ($Page->PPAPSMEAR->Visible) { // PPAPSMEAR ?>
    <tr id="r_PPAPSMEAR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PPAPSMEAR"><template id="tpc_ivf_vitals_history_PPAPSMEAR"><?= $Page->PPAPSMEAR->caption() ?></template></span></td>
...
<?php if ($Page->PTHYROID->Visible) { // PTHYROID ?>
    <tr id="r_PTHYROID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PTHYROID"><template id="tpc_ivf_vitals_history_PTHYROID"><?= $Page->PTHYROID->caption() ?></template></span></td>
...
<?php if ($Page->MTHYROID->Visible) { // MTHYROID ?>
    <tr id="r_MTHYROID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MTHYROID"><template id="tpc_ivf_vitals_history_MTHYROID"><?= $Page->MTHYROID->caption() ?></template></span></td>
...
<?php if ($Page->SecSexCharacters->Visible) { // SecSexCharacters ?>
    <tr id="r_SecSexCharacters">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_SecSexCharacters"><template id="tpc_ivf_vitals_history_SecSexCharacters"><?= $Page->SecSexCharacters->caption() ?></template></span></td>
...
<?php if ($Page->PenisUM->Visible) { // PenisUM ?>
    <tr id="r_PenisUM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PenisUM"><template id="tpc_ivf_vitals_history_PenisUM"><?= $Page->PenisUM->caption() ?></template></span></td>
...
<?php if ($Page->VAS->Visible) { // VAS ?>
    <tr id="r_VAS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_VAS"><template id="tpc_ivf_vitals_history_VAS"><?= $Page->VAS->caption() ?></template></span></td>
...
<?php if ($Page->EPIDIDYMIS->Visible) { // EPIDIDYMIS ?>
    <tr id="r_EPIDIDYMIS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_EPIDIDYMIS"><template id="tpc_ivf_vitals_history_EPIDIDYMIS"><?= $Page->EPIDIDYMIS->caption() ?></template></span></td>
...
<?php if ($Page->Varicocele->Visible) { // Varicocele ?>
    <tr id="r_Varicocele">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Varicocele"><template id="tpc_ivf_vitals_history_Varicocele"><?= $Page->Varicocele->caption() ?></template></span></td>
...
<?php if ($Page->FertilityTreatmentHistory->Visible) { // FertilityTreatmentHistory ?>
    <tr id="r_FertilityTreatmentHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FertilityTreatmentHistory"><template id="tpc_ivf_vitals_history_FertilityTreatmentHistory"><?= $Page->FertilityTreatmentHistory->caption() ?></template></span></td>
...
<?php if ($Page->SurgeryHistory->Visible) { // SurgeryHistory ?>
    <tr id="r_SurgeryHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_SurgeryHistory"><template id="tpc_ivf_vitals_history_SurgeryHistory"><?= $Page->SurgeryHistory->caption() ?></template></span></td>
...
<?php if ($Page->FamilyHistory->Visible) { // FamilyHistory ?>
    <tr id="r_FamilyHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_FamilyHistory"><template id="tpc_ivf_vitals_history_FamilyHistory"><?= $Page->FamilyHistory->caption() ?></template></span></td>
...
<?php if ($Page->PInvestigations->Visible) { // PInvestigations ?>
    <tr id="r_PInvestigations">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PInvestigations"><template id="tpc_ivf_vitals_history_PInvestigations"><?= $Page->PInvestigations->caption() ?></template></span></td>
...
<?php if ($Page->Addictions->Visible) { // Addictions ?>
    <tr id="r_Addictions">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Addictions"><template id="tpc_ivf_vitals_history_Addictions"><?= $Page->Addictions->caption() ?></template></span></td>
...
<?php if ($Page->Medications->Visible) { // Medications ?>
    <tr id="r_Medications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Medications"><template id="tpc_ivf_vitals_history_Medications"><?= $Page->Medications->caption() ?></template></span></td>
...
<?php if ($Page->Medical->Visible) { // Medical ?>
    <tr id="r_Medical">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Medical"><template id="tpc_ivf_vitals_history_Medical"><?= $Page->Medical->caption() ?></template></span></td>
...
<?php if ($Page->Surgical->Visible) { // Surgical ?>
    <tr id="r_Surgical">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_Surgical"><template id="tpc_ivf_vitals_history_Surgical"><?= $Page->Surgical->caption() ?></template></span></td>
...
<?php if ($Page->CoitalHistory->Visible) { // CoitalHistory ?>
    <tr id="r_CoitalHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_CoitalHistory"><template id="tpc_ivf_vitals_history_CoitalHistory"><?= $Page->CoitalHistory->caption() ?></template></span></td>
...
<?php if ($Page->SemenAnalysis->Visible) { // SemenAnalysis ?>
    <tr id="r_SemenAnalysis">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_SemenAnalysis"><template id="tpc_ivf_vitals_history_SemenAnalysis"><?= $Page->SemenAnalysis->caption() ?></template></span></td>
...
<?php if ($Page->MInsvestications->Visible) { // MInsvestications ?>
    <tr id="r_MInsvestications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MInsvestications"><template id="tpc_ivf_vitals_history_MInsvestications"><?= $Page->MInsvestications->caption() ?></template></span></td>
...
<?php if ($Page->PImpression->Visible) { // PImpression ?>
    <tr id="r_PImpression">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PImpression"><template id="tpc_ivf_vitals_history_PImpression"><?= $Page->PImpression->caption() ?></template></span></td>
...
<?php if ($Page->MIMpression->Visible) { // MIMpression ?>
    <tr id="r_MIMpression">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MIMpression"><template id="tpc_ivf_vitals_history_MIMpression"><?= $Page->MIMpression->caption() ?></template></span></td>
...
<?php if ($Page->PPlanOfManagement->Visible) { // PPlanOfManagement ?>
    <tr id="r_PPlanOfManagement">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PPlanOfManagement"><template id="tpc_ivf_vitals_history_PPlanOfManagement"><?= $Page->PPlanOfManagement->caption() ?></template></span></td>
...
<?php if ($Page->MPlanOfManagement->Visible) { // MPlanOfManagement ?>
    <tr id="r_MPlanOfManagement">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MPlanOfManagement"><template id="tpc_ivf_vitals_history_MPlanOfManagement"><?= $Page->MPlanOfManagement->caption() ?></template></span></td>
...
<?php if ($Page->PReadMore->Visible) { // PReadMore ?>
    <tr id="r_PReadMore">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_PReadMore"><template id="tpc_ivf_vitals_history_PReadMore"><?= $Page->PReadMore->caption() ?></template></span></td>
...
<?php if ($Page->MReadMore->Visible) { // MReadMore ?>
    <tr id="r_MReadMore">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MReadMore"><template id="tpc_ivf_vitals_history_MReadMore"><?= $Page->MReadMore->caption() ?></template></span></td>
...
<?php if ($Page->MariedFor->Visible) { // MariedFor ?>
    <tr id="r_MariedFor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MariedFor"><template id="tpc_ivf_vitals_history_MariedFor"><?= $Page->MariedFor->caption() ?></template></span></td>
...
<?php if ($Page->CMNCM->Visible) { // CMNCM ?>
    <tr id="r_CMNCM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_CMNCM"><template id="tpc_ivf_vitals_history_CMNCM"><?= $Page->CMNCM->caption() ?></template></span></td>
...
<?php if ($Page->TemplateMenstrualHistory->Visible) { // TemplateMenstrualHistory ?>
    <tr id="r_TemplateMenstrualHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateMenstrualHistory"><template id="tpc_ivf_vitals_history_TemplateMenstrualHistory"><?= $Page->TemplateMenstrualHistory->caption() ?></template></span></td>
        <td data-name="TemplateMenstrualHistory" <?= $Page->TemplateMenstrualHistory->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateMenstrualHistory"><span id="el_ivf_vitals_history_TemplateMenstrualHistory">
<span<?= $Page->TemplateMenstrualHistory->viewAttributes() ?>>
<?= $Page->TemplateMenstrualHistory->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateObstetricHistory->Visible) { // TemplateObstetricHistory ?>
    <tr id="r_TemplateObstetricHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateObstetricHistory"><template id="tpc_ivf_vitals_history_TemplateObstetricHistory"><?= $Page->TemplateObstetricHistory->caption() ?></template></span></td>
        <td data-name="TemplateObstetricHistory" <?= $Page->TemplateObstetricHistory->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateObstetricHistory"><span id="el_ivf_vitals_history_TemplateObstetricHistory">
<span<?= $Page->TemplateObstetricHistory->viewAttributes() ?>>
<?= $Page->TemplateObstetricHistory->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateFertilityTreatmentHistory->Visible) { // TemplateFertilityTreatmentHistory ?>
    <tr id="r_TemplateFertilityTreatmentHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateFertilityTreatmentHistory"><template id="tpc_ivf_vitals_history_TemplateFertilityTreatmentHistory"><?= $Page->TemplateFertilityTreatmentHistory->caption() ?></template></span></td>
        <td data-name="TemplateFertilityTreatmentHistory" <?= $Page->TemplateFertilityTreatmentHistory->cellAttributes() ?>>
...
<span<?= $Page->TemplateFertilityTreatmentHistory->viewAttributes() ?>>
<?= $Page->TemplateFertilityTreatmentHistory->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateSurgeryHistory->Visible) { // TemplateSurgeryHistory ?>
    <tr id="r_TemplateSurgeryHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateSurgeryHistory"><template id="tpc_ivf_vitals_history_TemplateSurgeryHistory"><?= $Page->TemplateSurgeryHistory->caption() ?></template></span></td>
        <td data-name="TemplateSurgeryHistory" <?= $Page->TemplateSurgeryHistory->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateSurgeryHistory"><span id="el_ivf_vitals_history_TemplateSurgeryHistory">
<span<?= $Page->TemplateSurgeryHistory->viewAttributes() ?>>
<?= $Page->TemplateSurgeryHistory->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateFInvestigations->Visible) { // TemplateFInvestigations ?>
    <tr id="r_TemplateFInvestigations">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateFInvestigations"><template id="tpc_ivf_vitals_history_TemplateFInvestigations"><?= $Page->TemplateFInvestigations->caption() ?></template></span></td>
        <td data-name="TemplateFInvestigations" <?= $Page->TemplateFInvestigations->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateFInvestigations"><span id="el_ivf_vitals_history_TemplateFInvestigations">
<span<?= $Page->TemplateFInvestigations->viewAttributes() ?>>
<?= $Page->TemplateFInvestigations->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplatePlanOfManagement->Visible) { // TemplatePlanOfManagement ?>
    <tr id="r_TemplatePlanOfManagement">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplatePlanOfManagement"><template id="tpc_ivf_vitals_history_TemplatePlanOfManagement"><?= $Page->TemplatePlanOfManagement->caption() ?></template></span></td>
        <td data-name="TemplatePlanOfManagement" <?= $Page->TemplatePlanOfManagement->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplatePlanOfManagement"><span id="el_ivf_vitals_history_TemplatePlanOfManagement">
<span<?= $Page->TemplatePlanOfManagement->viewAttributes() ?>>
<?= $Page->TemplatePlanOfManagement->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplatePImpression->Visible) { // TemplatePImpression ?>
    <tr id="r_TemplatePImpression">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplatePImpression"><template id="tpc_ivf_vitals_history_TemplatePImpression"><?= $Page->TemplatePImpression->caption() ?></template></span></td>
        <td data-name="TemplatePImpression" <?= $Page->TemplatePImpression->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplatePImpression"><span id="el_ivf_vitals_history_TemplatePImpression">
<span<?= $Page->TemplatePImpression->viewAttributes() ?>>
<?= $Page->TemplatePImpression->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateMedications->Visible) { // TemplateMedications ?>
    <tr id="r_TemplateMedications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateMedications"><template id="tpc_ivf_vitals_history_TemplateMedications"><?= $Page->TemplateMedications->caption() ?></template></span></td>
        <td data-name="TemplateMedications" <?= $Page->TemplateMedications->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateMedications"><span id="el_ivf_vitals_history_TemplateMedications">
<span<?= $Page->TemplateMedications->viewAttributes() ?>>
<?= $Page->TemplateMedications->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateSemenAnalysis->Visible) { // TemplateSemenAnalysis ?>
    <tr id="r_TemplateSemenAnalysis">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateSemenAnalysis"><template id="tpc_ivf_vitals_history_TemplateSemenAnalysis"><?= $Page->TemplateSemenAnalysis->caption() ?></template></span></td>
        <td data-name="TemplateSemenAnalysis" <?= $Page->TemplateSemenAnalysis->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateSemenAnalysis"><span id="el_ivf_vitals_history_TemplateSemenAnalysis">
<span<?= $Page->TemplateSemenAnalysis->viewAttributes() ?>>
<?= $Page->TemplateSemenAnalysis->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->MaleInsvestications->Visible) { // MaleInsvestications ?>
    <tr id="r_MaleInsvestications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_MaleInsvestications"><template id="tpc_ivf_vitals_history_MaleInsvestications"><?= $Page->MaleInsvestications->caption() ?></template></span></td>
        <td data-name="MaleInsvestications" <?= $Page->MaleInsvestications->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_MaleInsvestications"><span id="el_ivf_vitals_history_MaleInsvestications">
<span<?= $Page->MaleInsvestications->viewAttributes() ?>>
<?= $Page->MaleInsvestications->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateMIMpression->Visible) { // TemplateMIMpression ?>
    <tr id="r_TemplateMIMpression">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateMIMpression"><template id="tpc_ivf_vitals_history_TemplateMIMpression"><?= $Page->TemplateMIMpression->caption() ?></template></span></td>
        <td data-name="TemplateMIMpression" <?= $Page->TemplateMIMpression->cellAttributes() ?>>
<template id="tpx_ivf_vitals_history_TemplateMIMpression"><span id="el_ivf_vitals_history_TemplateMIMpression">
<span<?= $Page->TemplateMIMpression->viewAttributes() ?>>
<?= $Page->TemplateMIMpression->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TemplateMalePlanOfManagement->Visible) { // TemplateMalePlanOfManagement ?>
    <tr id="r_TemplateMalePlanOfManagement">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TemplateMalePlanOfManagement"><template id="tpc_ivf_vitals_history_TemplateMalePlanOfManagement"><?= $Page->TemplateMalePlanOfManagement->caption() ?></template></span></td>
        <td data-name="TemplateMalePlanOfManagement" <?= $Page->TemplateMalePlanOfManagement->cellAttributes() ?>>
...
<span<?= $Page->TemplateMalePlanOfManagement->viewAttributes() ?>>
<?= $Page->TemplateMalePlanOfManagement->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <tr id="r_TidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_TidNo"><template id="tpc_ivf_vitals_history_TidNo"><?= $Page->TidNo->caption() ?></template></span></td>
...
<?php if ($Page->pFamilyHistory->Visible) { // pFamilyHistory ?>
    <tr id="r_pFamilyHistory">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_pFamilyHistory"><template id="tpc_ivf_vitals_history_pFamilyHistory"><?= $Page->pFamilyHistory->caption() ?></template></span></td>
...
<?php if ($Page->pTemplateMedications->Visible) { // pTemplateMedications ?>
    <tr id="r_pTemplateMedications">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_pTemplateMedications"><template id="tpc_ivf_vitals_history_pTemplateMedications"><?= $Page->pTemplateMedications->caption() ?></template></span></td>
...
<?php if ($Page->AntiTPO->Visible) { // AntiTPO ?>
    <tr id="r_AntiTPO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_AntiTPO"><template id="tpc_ivf_vitals_history_AntiTPO"><?= $Page->AntiTPO->caption() ?></template></span></td>
...
<?php if ($Page->AntiTG->Visible) { // AntiTG ?>
    <tr id="r_AntiTG">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ivf_vitals_history_AntiTG"><template id="tpc_ivf_vitals_history_AntiTG"><?= $Page->AntiTG->caption() ?></template></span></td>
...
<template id="tpm_ivf_vitals_historyview">
<div id="ct_IvfVitalsHistoryView"><style>
...
<slot class="ew-slot" name="tpc_ivf_vitals_history_Chiefcomplaints"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_Chiefcomplaints"></slot>
  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_vitals_history_CoitalHistory"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_CoitalHistory"></slot></span>
				  				 ...
				  				 <div class="ew-row">
				 <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateFertilityTreatmentHistory"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateFertilityTreatmentHistory"></slot>
...
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
			 		<div class="ew-row">
			 		<slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateMenstrualHistory"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateMenstrualHistory"></slot>
				   ...
				   <div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateObstetricHistory"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateObstetricHistory"></slot>
				   ...
				   <div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateSurgeryHistory"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateSurgeryHistory"></slot>
				  ...
				  <div class="ew-row">
				   ...
				   <div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateFInvestigations"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateFInvestigations"></slot>
					...
					<div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateMedications"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateMedications"></slot>
		...
		<div class="card card-danger">
			...
			<div class="card-body">
				...
				<div class="ew-row">
				   ...
				   <div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateSemenAnalysis"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateSemenAnalysis"></slot>
				    ...
				    <div class="ew-row">
				    <slot class="ew-slot" name="tpc_ivf_vitals_history_MaleInsvestications"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_MaleInsvestications"></slot>
...
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
			 		<div class="ew-row">
			 		<slot class="ew-slot" name="tpc_ivf_vitals_history_TemplatePImpression"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplatePImpression"></slot>
				   ...
				   <div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplatePlanOfManagement"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplatePlanOfManagement"></slot>
	...
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				<div class="ew-row">
				<slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateMIMpression"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateMIMpression"></slot>
				   ...
				   <div class="ew-row">
				   <slot class="ew-slot" name="tpc_ivf_vitals_history_TemplateMalePlanOfManagement"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_vitals_history_TemplateMalePlanOfManagement"></slot>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_vitals_historyview", "tpm_ivf_vitals_historyview", "ivf_vitals_historyview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
