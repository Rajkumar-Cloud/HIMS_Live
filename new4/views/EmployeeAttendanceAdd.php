...
// Page object
$EmployeeAttendanceAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_attendanceadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_attendanceadd = currentForm = new ew.Form("femployee_attendanceadd", "add");
    ...
    femployee_attendanceadd.addFields([
    ...
    // Form_CustomValidate
    femployee_attendanceadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_attendanceadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("femployee_attendanceadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_attendanceadd" id="femployee_attendanceadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_attendanceadd", "datetimepicker"], function() {
