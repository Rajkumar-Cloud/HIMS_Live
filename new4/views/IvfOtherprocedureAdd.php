...
loadjs.ready("head", function () {
    ...
    fivf_otherprocedureadd.lists.Name = <?= $Page->Name->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.Consultant = <?= $Page->Consultant->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.Surgeon = <?= $Page->Surgeon->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.Anesthetist = <?= $Page->Anesthetist->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.TempleteFinalDiagnosis = <?= $Page->TempleteFinalDiagnosis->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.TemplateTreatment = <?= $Page->TemplateTreatment->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.TemplateOperation = <?= $Page->TemplateOperation->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.TemplateFollowUpAdvice = <?= $Page->TemplateFollowUpAdvice->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.TemplateFollowUpMedication = <?= $Page->TemplateFollowUpMedication->toClientList($Page) ?>;
    fivf_otherprocedureadd.lists.TemplatePlan = <?= $Page->TemplatePlan->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_otherprocedureadd" id="fivf_otherprocedureadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fivf_otherprocedureadd"], function() {
    fivf_otherprocedureadd.createAutoSuggest(Object.assign({"id":"x_Name","forceSelect":false}, ew.vars.tables.ivf_otherprocedure.fields.Name.autoSuggestOptions));
});
</script>
...
loadjs.ready(["fivf_otherprocedureadd", "editor"], function() {
	ew.createEditor("fivf_otherprocedureadd", "x_FinalDiagnosis", 0, 0, <?= $Page->FinalDiagnosis->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_otherprocedureadd", "editor"], function() {
	ew.createEditor("fivf_otherprocedureadd", "x_Treatment", 35, 4, <?= $Page->Treatment->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_otherprocedureadd", "editor"], function() {
	ew.createEditor("fivf_otherprocedureadd", "x_DetailOfOperation", 35, 4, <?= $Page->DetailOfOperation->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_otherprocedureadd", "editor"], function() {
	ew.createEditor("fivf_otherprocedureadd", "x_FollowUpAdvice", 35, 4, <?= $Page->FollowUpAdvice->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_otherprocedureadd", "editor"], function() {
	ew.createEditor("fivf_otherprocedureadd", "x_FollowUpMedication", 35, 4, <?= $Page->FollowUpMedication->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_otherprocedureadd", "editor"], function() {
	ew.createEditor("fivf_otherprocedureadd", "x_Plan", 35, 4, <?= $Page->Plan->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_ivf_otherprocedureadd">
<div id="ct_IvfOtherprocedureAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_otherprocedureadd", "tpm_ivf_otherprocedureadd", "ivf_otherprocedureadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
