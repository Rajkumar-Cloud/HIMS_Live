...
// Page object
$IvfFollowUpTrackingEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_follow_up_trackingedit;
loadjs.ready("head", function () {
    ...
    fivf_follow_up_trackingedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_follow_up_trackingedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_follow_up_trackingedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_follow_up_trackingedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fivf_follow_up_trackingedit" id="fivf_follow_up_trackingedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_follow_up_tracking_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_follow_up_tracking_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<template id="tpx_ivf_follow_up_tracking_id"><span id="el_ivf_follow_up_tracking_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span></template>
<input type="hidden" data-table="ivf_follow_up_tracking" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fivf_follow_up_trackingedit", "editor"], function() {
	ew.createEditor("fivf_follow_up_trackingedit", "x_MReadMore", 100, 4, <?= $Page->MReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_ivf_follow_up_trackingedit">
<div id="ct_IvfFollowUpTrackingEdit"><style>
...
?>	
<slot class="ew-slot" name="tpc_ivf_follow_up_tracking_RIDNO"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_follow_up_tracking_RIDNO"></slot>
<div class="row">
<div class="col-md-6">
...
<div class="row">
	<div class="col-12">
		<div class="card card-danger">
			...
			<div class="card-body">
			<slot class="ew-slot" name="tpc_ivf_follow_up_tracking_FollowUpDate"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_follow_up_tracking_FollowUpDate"></slot>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_follow_up_tracking_MReadMore"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_follow_up_tracking_MReadMore"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_follow_up_trackingedit", "tpm_ivf_follow_up_trackingedit", "ivf_follow_up_trackingedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
