...
// Page object
$ViewVitalsHistoryAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_vitals_historyadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fview_vitals_historyadd = currentForm = new ew.Form("fview_vitals_historyadd", "add");
    ...
    fview_vitals_historyadd.addFields([
    ...
    // Form_CustomValidate
    fview_vitals_historyadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_vitals_historyadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_vitals_historyadd.lists.MedicalHistory = <?= $Page->MedicalHistory->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FBloodgroup = <?= $Page->FBloodgroup->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.MBloodgroup = <?= $Page->MBloodgroup->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FBuild = <?= $Page->FBuild->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.MBuild = <?= $Page->MBuild->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FSkinColor = <?= $Page->FSkinColor->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.MSkinColor = <?= $Page->MSkinColor->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FEyesColor = <?= $Page->FEyesColor->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.MEyesColor = <?= $Page->MEyesColor->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FHairColor = <?= $Page->FHairColor->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.MhairColor = <?= $Page->MhairColor->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FhairTexture = <?= $Page->FhairTexture->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.MHairTexture = <?= $Page->MHairTexture->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.FamilyHistory = <?= $Page->FamilyHistory->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.Addictions = <?= $Page->Addictions->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.Medical = <?= $Page->Medical->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.Surgical = <?= $Page->Surgical->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.CoitalHistory = <?= $Page->CoitalHistory->toClientList($Page) ?>;
    fview_vitals_historyadd.lists.pFamilyHistory = <?= $Page->pFamilyHistory->toClientList($Page) ?>;
    loadjs.done("fview_vitals_historyadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fview_vitals_historyadd" id="fview_vitals_historyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_MenstrualHistory", 0, 0, <?= $Page->MenstrualHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_ObstetricHistory", 0, 0, <?= $Page->ObstetricHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_FertilityTreatmentHistory", 35, 4, <?= $Page->FertilityTreatmentHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_SurgeryHistory", 35, 4, <?= $Page->SurgeryHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd"], function() {
    fview_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_FamilyHistory","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.FamilyHistory.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_PInvestigations", 35, 4, <?= $Page->PInvestigations->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_Medications", 35, 4, <?= $Page->Medications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd"], function() {
    fview_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_Surgical","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.Surgical.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_vitals_historyadd"], function() {
    fview_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_CoitalHistory","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.CoitalHistory.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_SemenAnalysis", 35, 4, <?= $Page->SemenAnalysis->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_MInsvestications", 35, 4, <?= $Page->MInsvestications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_PImpression", 35, 4, <?= $Page->PImpression->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_MIMpression", 35, 4, <?= $Page->MIMpression->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_PPlanOfManagement", 35, 4, <?= $Page->PPlanOfManagement->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_MPlanOfManagement", 35, 4, <?= $Page->MPlanOfManagement->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_PReadMore", 35, 4, <?= $Page->PReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_MReadMore", 35, 4, <?= $Page->MReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fview_vitals_historyadd"], function() {
    fview_vitals_historyadd.createAutoSuggest(Object.assign({"id":"x_pFamilyHistory","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.pFamilyHistory.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_vitals_historyadd", "editor"], function() {
	ew.createEditor("fview_vitals_historyadd", "x_pTemplateMedications", 35, 4, <?= $Page->pTemplateMedications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_view_vitals_historyadd">
<div id="ct_ViewVitalsHistoryAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_vitals_historyadd", "tpm_view_vitals_historyadd", "view_vitals_historyadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
