...
// Page object
$LabProfileDetailsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var flab_profile_detailsadd;
loadjs.ready("head", function () {
    ...
    flab_profile_detailsadd.addFields([
    ...
    // Form_CustomValidate
    flab_profile_detailsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flab_profile_detailsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    flab_profile_detailsadd.lists.SubProfileCode = <?= $Page->SubProfileCode->toClientList($Page) ?>;
    flab_profile_detailsadd.lists.ProfileTestCode = <?= $Page->ProfileTestCode->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="flab_profile_detailsadd" id="flab_profile_detailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
