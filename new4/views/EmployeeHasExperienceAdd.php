...
loadjs.ready("head", function () {
    ...
    femployee_has_experienceadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="femployee_has_experienceadd" id="femployee_has_experienceadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
