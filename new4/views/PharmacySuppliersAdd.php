...
// Page object
$PharmacySuppliersAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_suppliersadd;
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "pharmacy_suppliers")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.pharmacy_suppliers)
        ew.vars.tables.pharmacy_suppliers = currentTable;
    fpharmacy_suppliersadd.addFields([
    ...
    // Form_CustomValidate
    fpharmacy_suppliersadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_suppliersadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_suppliersadd" id="fpharmacy_suppliersadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
