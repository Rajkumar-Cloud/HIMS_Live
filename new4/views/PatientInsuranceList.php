...
<form name="fpatient_insurancelistsrch" id="fpatient_insurancelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpatient_insurancelist" id="fpatient_insurancelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
