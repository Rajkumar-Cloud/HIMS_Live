...
<form name="fpharmacy_polistsrch" id="fpharmacy_polistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpharmacy_polist" id="fpharmacy_polist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Address1->Visible) { // Address1 ?>
        <th data-name="Address1" class="<?= $Page->Address1->headerCellClass() ?>"><div id="elh_pharmacy_po_Address1" class="pharmacy_po_Address1"><?= $Page->renderSort($Page->Address1) ?></div></th>
<?php } ?>
<?php if ($Page->Address2->Visible) { // Address2 ?>
        <th data-name="Address2" class="<?= $Page->Address2->headerCellClass() ?>"><div id="elh_pharmacy_po_Address2" class="pharmacy_po_Address2"><?= $Page->renderSort($Page->Address2) ?></div></th>
<?php } ?>
<?php if ($Page->Address3->Visible) { // Address3 ?>
        <th data-name="Address3" class="<?= $Page->Address3->headerCellClass() ?>"><div id="elh_pharmacy_po_Address3" class="pharmacy_po_Address3"><?= $Page->renderSort($Page->Address3) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_pharmacy_po_Address1">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_po_Address2">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_po_Address3">
