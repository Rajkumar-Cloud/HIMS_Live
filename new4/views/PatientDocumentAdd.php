...
loadjs.ready("head", function () {
    ...
    fpatient_documentadd.lists.DocumentName = <?= $Page->DocumentName->toClientList($Page) ?>;
    fpatient_documentadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_documentadd" id="fpatient_documentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
