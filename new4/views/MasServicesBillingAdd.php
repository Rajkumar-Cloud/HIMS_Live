...
loadjs.ready("head", function () {
    ...
    fmas_services_billingadd.lists.SERVICE_TYPE = <?= $Page->SERVICE_TYPE->toClientList($Page) ?>;
    fmas_services_billingadd.lists.DEPARTMENT = <?= $Page->DEPARTMENT->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmas_services_billingadd" id="fmas_services_billingadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fmas_services_billingadd", "editor"], function() {
	ew.createEditor("fmas_services_billingadd", "x_Interpretation", 35, 4, <?= $Page->Interpretation->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_mas_services_billingadd">
<div id="ct_MasServicesBillingAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_mas_services_billingadd", "tpm_mas_services_billingadd", "mas_services_billingadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
