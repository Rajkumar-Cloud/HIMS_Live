...
// Page object
$PresIndicationstableAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpres_indicationstableadd;
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "pres_indicationstable")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.pres_indicationstable)
        ew.vars.tables.pres_indicationstable = currentTable;
    fpres_indicationstableadd.addFields([
        ...
        ["Indications", [fields.Indications.visible && fields.Indications.required ? ew.Validators.required(fields.Indications.caption) : null], fields.Indications.isInvalid],
        ...
        ["Min_Age", [fields.Min_Age.visible && fields.Min_Age.required ? ew.Validators.required(fields.Min_Age.caption) : null, ew.Validators.integer], fields.Min_Age.isInvalid],
        ["Min_Days", [fields.Min_Days.visible && fields.Min_Days.required ? ew.Validators.required(fields.Min_Days.caption) : null], fields.Min_Days.isInvalid],
        ["Max_Age", [fields.Max_Age.visible && fields.Max_Age.required ? ew.Validators.required(fields.Max_Age.caption) : null, ew.Validators.integer], fields.Max_Age.isInvalid],
        ["Max_Days", [fields.Max_Days.visible && fields.Max_Days.required ? ew.Validators.required(fields.Max_Days.caption) : null], fields.Max_Days.isInvalid],
        ...
        ["Min_Dose_Val", [fields.Min_Dose_Val.visible && fields.Min_Dose_Val.required ? ew.Validators.required(fields.Min_Dose_Val.caption) : null, ew.Validators.float], fields.Min_Dose_Val.isInvalid],
        ["Min_Dose_Unit", [fields.Min_Dose_Unit.visible && fields.Min_Dose_Unit.required ? ew.Validators.required(fields.Min_Dose_Unit.caption) : null], fields.Min_Dose_Unit.isInvalid],
        ["Max_Dose_Val", [fields.Max_Dose_Val.visible && fields.Max_Dose_Val.required ? ew.Validators.required(fields.Max_Dose_Val.caption) : null, ew.Validators.float], fields.Max_Dose_Val.isInvalid],
        ["Max_Dose_Unit", [fields.Max_Dose_Unit.visible && fields.Max_Dose_Unit.required ? ew.Validators.required(fields.Max_Dose_Unit.caption) : null], fields.Max_Dose_Unit.isInvalid],
        ...
        ["DWMY", [fields.DWMY.visible && fields.DWMY.required ? ew.Validators.required(fields.DWMY.caption) : null], fields.DWMY.isInvalid],
        ...
        ["RecStatus", [fields.RecStatus.visible && fields.RecStatus.required ? ew.Validators.required(fields.RecStatus.caption) : null], fields.RecStatus.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fpres_indicationstableadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpres_indicationstableadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpres_indicationstableadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpres_indicationstableadd" id="fpres_indicationstableadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="<?= $Page->Indications->getInputTextType() ?>" data-table="pres_indicationstable" data-field="x_Indications" name="x_Indications" id="x_Indications" placeholder="<?= HtmlEncode($Page->Indications->getPlaceHolder()) ?>" value="<?= $Page->Indications->EditValue ?>"<?= $Page->Indications->editAttributes() ?> aria-describedby="x_Indications_help">
