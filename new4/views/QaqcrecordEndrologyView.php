...
// Page object
$QaqcrecordEndrologyView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fqaqcrecord_endrologyview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fqaqcrecord_endrologyview = currentForm = new ew.Form("fqaqcrecord_endrologyview", "view");
    loadjs.done("fqaqcrecord_endrologyview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fqaqcrecord_endrologyview" id="fqaqcrecord_endrologyview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->Date->Visible) { // Date ?>
    <tr id="r_Date">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_Date"><?= $Page->Date->caption() ?></span></td>
...
<?php if ($Page->LN2_Level->Visible) { // LN2_Level ?>
    <tr id="r_LN2_Level">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_LN2_Level"><?= $Page->LN2_Level->caption() ?></span></td>
...
<?php if ($Page->LN2_Checked->Visible) { // LN2_Checked ?>
    <tr id="r_LN2_Checked">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_LN2_Checked"><?= $Page->LN2_Checked->caption() ?></span></td>
...
<?php if ($Page->Incubator_Temp->Visible) { // Incubator_Temp ?>
    <tr id="r_Incubator_Temp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_Incubator_Temp"><?= $Page->Incubator_Temp->caption() ?></span></td>
...
<?php if ($Page->Incubator_Cleaned->Visible) { // Incubator_Cleaned ?>
    <tr id="r_Incubator_Cleaned">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_Incubator_Cleaned"><?= $Page->Incubator_Cleaned->caption() ?></span></td>
...
<?php if ($Page->LAF_MG->Visible) { // LAF_MG ?>
    <tr id="r_LAF_MG">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_LAF_MG"><?= $Page->LAF_MG->caption() ?></span></td>
...
<?php if ($Page->LAF_Cleaned->Visible) { // LAF_Cleaned ?>
    <tr id="r_LAF_Cleaned">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_LAF_Cleaned"><?= $Page->LAF_Cleaned->caption() ?></span></td>
...
<?php if ($Page->REF_Temp->Visible) { // REF_Temp ?>
    <tr id="r_REF_Temp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_REF_Temp"><?= $Page->REF_Temp->caption() ?></span></td>
...
<?php if ($Page->REF_Cleaned->Visible) { // REF_Cleaned ?>
    <tr id="r_REF_Cleaned">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_REF_Cleaned"><?= $Page->REF_Cleaned->caption() ?></span></td>
...
<?php if ($Page->Heating_Temp->Visible) { // Heating_Temp ?>
    <tr id="r_Heating_Temp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_Heating_Temp"><?= $Page->Heating_Temp->caption() ?></span></td>
...
<?php if ($Page->Heating_Cleaned->Visible) { // Heating_Cleaned ?>
    <tr id="r_Heating_Cleaned">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_Heating_Cleaned"><?= $Page->Heating_Cleaned->caption() ?></span></td>
...
<?php if ($Page->Createdby->Visible) { // Createdby ?>
    <tr id="r_Createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_Createdby"><?= $Page->Createdby->caption() ?></span></td>
...
<?php if ($Page->CreatedDate->Visible) { // CreatedDate ?>
    <tr id="r_CreatedDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_qaqcrecord_endrology_CreatedDate"><?= $Page->CreatedDate->caption() ?></span></td>
