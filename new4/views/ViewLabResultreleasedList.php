...
loadjs.ready("head", function () {
    ...
    fview_lab_resultreleasedlist.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_lab_resultreleasedlist,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_lab_resultreleasedlist.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_lab_resultreleasedlist.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_lab_resultreleasedlist.lists.Resulted = <?= $Page->Resulted->toClientList($Page) ?>;
    fview_lab_resultreleasedlist.lists.TestUnit = <?= $Page->TestUnit->toClientList($Page) ?>;
    fview_lab_resultreleasedlist.lists.Repeated = <?= $Page->Repeated->toClientList($Page) ?>;
...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "view_lab_services") {
    if ($Page->MasterRecordExists) {
        include_once "views/ViewLabServicesMaster.php";
    }
}
?>
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "view_labreport_print") {
    if ($Page->MasterRecordExists) {
        include_once "views/ViewLabreportPrintMaster.php";
    }
}
?>
<?php } ?>
...
<?php } ?>
<form name="fview_lab_resultreleasedlist" id="fview_lab_resultreleasedlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="view_lab_resultreleased">
<?php if ($Page->getCurrentMasterTable() == "view_lab_services" && $Page->CurrentAction) { ?>
<input type="hidden" name="<?= Config("TABLE_SHOW_MASTER") ?>" value="view_lab_services">
<input type="hidden" name="fk_id" value="<?= HtmlEncode($Page->Vid->getSessionValue()) ?>">
<?php } ?>
<?php if ($Page->getCurrentMasterTable() == "view_labreport_print" && $Page->CurrentAction) { ?>
<input type="hidden" name="<?= Config("TABLE_SHOW_MASTER") ?>" value="view_labreport_print">
<input type="hidden" name="fk_id" value="<?= HtmlEncode($Page->Vid->getSessionValue()) ?>">
<?php } ?>
...
<?php if ($Page->LabReport->Visible) { // LabReport ?>
        <th data-name="LabReport" class="<?= $Page->LabReport->headerCellClass() ?>"><div id="elh_view_lab_resultreleased_LabReport" class="view_lab_resultreleased_LabReport"><?= $Page->renderSort($Page->LabReport) ?></div></th>
<?php } ?>
...
<?php if ($Page->RefValue->Visible) { // RefValue ?>
        <th data-name="RefValue" class="<?= $Page->RefValue->headerCellClass() ?>"><div id="elh_view_lab_resultreleased_RefValue" class="view_lab_resultreleased_RefValue"><?= $Page->renderSort($Page->RefValue) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_id" class="form-group"></span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_id" data-hidden="1" name="o<?= $Page->RowIndex ?>_id" id="o<?= $Page->RowIndex ?>_id" value="<?= HtmlEncode($Page->id->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_id" class="form-group">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_id" data-hidden="1" name="x<?= $Page->RowIndex ?>_id" id="x<?= $Page->RowIndex ?>_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php } ?>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_PatID" class="form-group">
<input type="<?= $Page->PatID->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_PatID" name="x<?= $Page->RowIndex ?>_PatID" id="x<?= $Page->RowIndex ?>_PatID" size="30" placeholder="<?= HtmlEncode($Page->PatID->getPlaceHolder()) ?>" value="<?= $Page->PatID->EditValue ?>"<?= $Page->PatID->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->PatID->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_PatID" data-hidden="1" name="o<?= $Page->RowIndex ?>_PatID" id="o<?= $Page->RowIndex ?>_PatID" value="<?= HtmlEncode($Page->PatID->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_PatID" class="form-group">
<input type="<?= $Page->PatID->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_PatID" name="x<?= $Page->RowIndex ?>_PatID" id="x<?= $Page->RowIndex ?>_PatID" size="30" placeholder="<?= HtmlEncode($Page->PatID->getPlaceHolder()) ?>" value="<?= $Page->PatID->EditValue ?>"<?= $Page->PatID->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_PatientName" class="form-group">
<input type="<?= $Page->PatientName->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_PatientName" name="x<?= $Page->RowIndex ?>_PatientName" id="x<?= $Page->RowIndex ?>_PatientName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PatientName->getPlaceHolder()) ?>" value="<?= $Page->PatientName->EditValue ?>"<?= $Page->PatientName->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->PatientName->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_PatientName" data-hidden="1" name="o<?= $Page->RowIndex ?>_PatientName" id="o<?= $Page->RowIndex ?>_PatientName" value="<?= HtmlEncode($Page->PatientName->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_PatientName" class="form-group">
<input type="<?= $Page->PatientName->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_PatientName" name="x<?= $Page->RowIndex ?>_PatientName" id="x<?= $Page->RowIndex ?>_PatientName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PatientName->getPlaceHolder()) ?>" value="<?= $Page->PatientName->EditValue ?>"<?= $Page->PatientName->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Age" class="form-group">
<input type="<?= $Page->Age->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Age" name="x<?= $Page->RowIndex ?>_Age" id="x<?= $Page->RowIndex ?>_Age" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Age->getPlaceHolder()) ?>" value="<?= $Page->Age->EditValue ?>"<?= $Page->Age->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Age->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Age" data-hidden="1" name="o<?= $Page->RowIndex ?>_Age" id="o<?= $Page->RowIndex ?>_Age" value="<?= HtmlEncode($Page->Age->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Age" class="form-group">
<input type="<?= $Page->Age->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Age" name="x<?= $Page->RowIndex ?>_Age" id="x<?= $Page->RowIndex ?>_Age" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Age->getPlaceHolder()) ?>" value="<?= $Page->Age->EditValue ?>"<?= $Page->Age->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Gender" class="form-group">
<input type="<?= $Page->Gender->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Gender" name="x<?= $Page->RowIndex ?>_Gender" id="x<?= $Page->RowIndex ?>_Gender" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Gender->getPlaceHolder()) ?>" value="<?= $Page->Gender->EditValue ?>"<?= $Page->Gender->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Gender->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Gender" data-hidden="1" name="o<?= $Page->RowIndex ?>_Gender" id="o<?= $Page->RowIndex ?>_Gender" value="<?= HtmlEncode($Page->Gender->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Gender" class="form-group">
<input type="<?= $Page->Gender->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Gender" name="x<?= $Page->RowIndex ?>_Gender" id="x<?= $Page->RowIndex ?>_Gender" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Gender->getPlaceHolder()) ?>" value="<?= $Page->Gender->EditValue ?>"<?= $Page->Gender->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_sid" class="form-group">
<input type="<?= $Page->sid->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_sid" name="x<?= $Page->RowIndex ?>_sid" id="x<?= $Page->RowIndex ?>_sid" size="30" placeholder="<?= HtmlEncode($Page->sid->getPlaceHolder()) ?>" value="<?= $Page->sid->EditValue ?>"<?= $Page->sid->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->sid->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_sid" data-hidden="1" name="o<?= $Page->RowIndex ?>_sid" id="o<?= $Page->RowIndex ?>_sid" value="<?= HtmlEncode($Page->sid->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_sid" class="form-group">
<input type="<?= $Page->sid->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_sid" name="x<?= $Page->RowIndex ?>_sid" id="x<?= $Page->RowIndex ?>_sid" size="30" placeholder="<?= HtmlEncode($Page->sid->getPlaceHolder()) ?>" value="<?= $Page->sid->EditValue ?>"<?= $Page->sid->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_ItemCode" class="form-group">
<input type="<?= $Page->ItemCode->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_ItemCode" name="x<?= $Page->RowIndex ?>_ItemCode" id="x<?= $Page->RowIndex ?>_ItemCode" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ItemCode->getPlaceHolder()) ?>" value="<?= $Page->ItemCode->EditValue ?>"<?= $Page->ItemCode->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->ItemCode->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_ItemCode" data-hidden="1" name="o<?= $Page->RowIndex ?>_ItemCode" id="o<?= $Page->RowIndex ?>_ItemCode" value="<?= HtmlEncode($Page->ItemCode->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_ItemCode" class="form-group">
<input type="<?= $Page->ItemCode->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_ItemCode" name="x<?= $Page->RowIndex ?>_ItemCode" id="x<?= $Page->RowIndex ?>_ItemCode" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ItemCode->getPlaceHolder()) ?>" value="<?= $Page->ItemCode->EditValue ?>"<?= $Page->ItemCode->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DEptCd" class="form-group">
<input type="<?= $Page->DEptCd->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DEptCd" name="x<?= $Page->RowIndex ?>_DEptCd" id="x<?= $Page->RowIndex ?>_DEptCd" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DEptCd->getPlaceHolder()) ?>" value="<?= $Page->DEptCd->EditValue ?>"<?= $Page->DEptCd->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DEptCd->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_DEptCd" data-hidden="1" name="o<?= $Page->RowIndex ?>_DEptCd" id="o<?= $Page->RowIndex ?>_DEptCd" value="<?= HtmlEncode($Page->DEptCd->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DEptCd" class="form-group">
<input type="<?= $Page->DEptCd->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DEptCd" name="x<?= $Page->RowIndex ?>_DEptCd" id="x<?= $Page->RowIndex ?>_DEptCd" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DEptCd->getPlaceHolder()) ?>" value="<?= $Page->DEptCd->EditValue ?>"<?= $Page->DEptCd->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Resulted" class="form-group">
<template id="tp_x<?= $Page->RowIndex ?>_Resulted">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="view_lab_resultreleased" data-field="x_Resulted" name="x<?= $Page->RowIndex ?>_Resulted" id="x<?= $Page->RowIndex ?>_Resulted"<?= $Page->Resulted->editAttributes() ?>>
...
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Resulted" data-hidden="1" name="o<?= $Page->RowIndex ?>_Resulted[]" id="o<?= $Page->RowIndex ?>_Resulted[]" value="<?= HtmlEncode($Page->Resulted->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Resulted" class="form-group">
<template id="tp_x<?= $Page->RowIndex ?>_Resulted">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Services" class="form-group">
<input type="<?= $Page->Services->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Services" name="x<?= $Page->RowIndex ?>_Services" id="x<?= $Page->RowIndex ?>_Services" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Services->getPlaceHolder()) ?>" value="<?= $Page->Services->EditValue ?>"<?= $Page->Services->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Services->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Services" data-hidden="1" name="o<?= $Page->RowIndex ?>_Services" id="o<?= $Page->RowIndex ?>_Services" value="<?= HtmlEncode($Page->Services->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Services" class="form-group">
<input type="<?= $Page->Services->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Services" name="x<?= $Page->RowIndex ?>_Services" id="x<?= $Page->RowIndex ?>_Services" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Services->getPlaceHolder()) ?>" value="<?= $Page->Services->EditValue ?>"<?= $Page->Services->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_LabReport" class="form-group">
<textarea data-table="view_lab_resultreleased" data-field="x_LabReport" name="x<?= $Page->RowIndex ?>_LabReport" id="x<?= $Page->RowIndex ?>_LabReport" cols="20" rows="2" placeholder="<?= HtmlEncode($Page->LabReport->getPlaceHolder()) ?>"<?= $Page->LabReport->editAttributes() ?>><?= $Page->LabReport->EditValue ?></textarea>
<div class="invalid-feedback"><?= $Page->LabReport->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_LabReport" data-hidden="1" name="o<?= $Page->RowIndex ?>_LabReport" id="o<?= $Page->RowIndex ?>_LabReport" value="<?= HtmlEncode($Page->LabReport->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_LabReport" class="form-group">
<textarea data-table="view_lab_resultreleased" data-field="x_LabReport" name="x<?= $Page->RowIndex ?>_LabReport" id="x<?= $Page->RowIndex ?>_LabReport" cols="20" rows="2" placeholder="<?= HtmlEncode($Page->LabReport->getPlaceHolder()) ?>"<?= $Page->LabReport->editAttributes() ?>><?= $Page->LabReport->EditValue ?></textarea>
...
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_LabReport">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Pic1" class="form-group">
<div id="fd_x<?= $Page->RowIndex ?>_Pic1">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->Pic1->title() ?>" data-table="view_lab_resultreleased" data-field="x_Pic1" name="x<?= $Page->RowIndex ?>_Pic1" id="x<?= $Page->RowIndex ?>_Pic1" lang="<?= CurrentLanguageID() ?>"<?= $Page->Pic1->editAttributes() ?><?= ($Page->Pic1->ReadOnly || $Page->Pic1->Disabled) ? " disabled" : "" ?>>
...
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Pic1" data-hidden="1" name="o<?= $Page->RowIndex ?>_Pic1" id="o<?= $Page->RowIndex ?>_Pic1" value="<?= HtmlEncode($Page->Pic1->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Pic1" class="form-group">
<div id="fd_x<?= $Page->RowIndex ?>_Pic1">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Pic2" class="form-group">
<div id="fd_x<?= $Page->RowIndex ?>_Pic2">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->Pic2->title() ?>" data-table="view_lab_resultreleased" data-field="x_Pic2" name="x<?= $Page->RowIndex ?>_Pic2" id="x<?= $Page->RowIndex ?>_Pic2" lang="<?= CurrentLanguageID() ?>"<?= $Page->Pic2->editAttributes() ?><?= ($Page->Pic2->ReadOnly || $Page->Pic2->Disabled) ? " disabled" : "" ?>>
...
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Pic2" data-hidden="1" name="o<?= $Page->RowIndex ?>_Pic2" id="o<?= $Page->RowIndex ?>_Pic2" value="<?= HtmlEncode($Page->Pic2->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Pic2" class="form-group">
<div id="fd_x<?= $Page->RowIndex ?>_Pic2">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_TestUnit" class="form-group">
<?php
...
loadjs.ready(["fview_lab_resultreleasedlist"], function() {
    fview_lab_resultreleasedlist.createAutoSuggest(Object.assign({"id":"x<?= $Page->RowIndex ?>_TestUnit","forceSelect":false}, ew.vars.tables.view_lab_resultreleased.fields.TestUnit.autoSuggestOptions));
});
</script>
<?= $Page->TestUnit->Lookup->getParamTag($Page, "p_x" . $Page->RowIndex . "_TestUnit") ?>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_TestUnit" data-hidden="1" name="o<?= $Page->RowIndex ?>_TestUnit" id="o<?= $Page->RowIndex ?>_TestUnit" value="<?= HtmlEncode($Page->TestUnit->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_TestUnit" class="form-group">
<?php
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_RefValue" class="form-group">
<textarea data-table="view_lab_resultreleased" data-field="x_RefValue" name="x<?= $Page->RowIndex ?>_RefValue" id="x<?= $Page->RowIndex ?>_RefValue" cols="20" rows="2" placeholder="<?= HtmlEncode($Page->RefValue->getPlaceHolder()) ?>"<?= $Page->RefValue->editAttributes() ?>><?= $Page->RefValue->EditValue ?></textarea>
<div class="invalid-feedback"><?= $Page->RefValue->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_RefValue" data-hidden="1" name="o<?= $Page->RowIndex ?>_RefValue" id="o<?= $Page->RowIndex ?>_RefValue" value="<?= HtmlEncode($Page->RefValue->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_RefValue" class="form-group">
<textarea data-table="view_lab_resultreleased" data-field="x_RefValue" name="x<?= $Page->RowIndex ?>_RefValue" id="x<?= $Page->RowIndex ?>_RefValue" cols="20" rows="2" placeholder="<?= HtmlEncode($Page->RefValue->getPlaceHolder()) ?>"<?= $Page->RefValue->editAttributes() ?>><?= $Page->RefValue->EditValue ?></textarea>
...
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_RefValue">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Order" class="form-group">
<input type="<?= $Page->Order->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Order" name="x<?= $Page->RowIndex ?>_Order" id="x<?= $Page->RowIndex ?>_Order" size="30" placeholder="<?= HtmlEncode($Page->Order->getPlaceHolder()) ?>" value="<?= $Page->Order->EditValue ?>"<?= $Page->Order->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Order->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Order" data-hidden="1" name="o<?= $Page->RowIndex ?>_Order" id="o<?= $Page->RowIndex ?>_Order" value="<?= HtmlEncode($Page->Order->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Order" class="form-group">
<input type="<?= $Page->Order->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Order" name="x<?= $Page->RowIndex ?>_Order" id="x<?= $Page->RowIndex ?>_Order" size="30" placeholder="<?= HtmlEncode($Page->Order->getPlaceHolder()) ?>" value="<?= $Page->Order->EditValue ?>"<?= $Page->Order->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Repeated" class="form-group">
<template id="tp_x<?= $Page->RowIndex ?>_Repeated">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="view_lab_resultreleased" data-field="x_Repeated" name="x<?= $Page->RowIndex ?>_Repeated" id="x<?= $Page->RowIndex ?>_Repeated"<?= $Page->Repeated->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Repeated" data-hidden="1" name="o<?= $Page->RowIndex ?>_Repeated[]" id="o<?= $Page->RowIndex ?>_Repeated[]" value="<?= HtmlEncode($Page->Repeated->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Repeated" class="form-group">
<template id="tp_x<?= $Page->RowIndex ?>_Repeated">
...
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Vid" class="form-group">
...
<?php } else { ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Vid" class="form-group">
<input type="<?= $Page->Vid->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Vid" name="x<?= $Page->RowIndex ?>_Vid" id="x<?= $Page->RowIndex ?>_Vid" size="30" placeholder="<?= HtmlEncode($Page->Vid->getPlaceHolder()) ?>" value="<?= $Page->Vid->EditValue ?>"<?= $Page->Vid->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Vid->getErrorMessage() ?></div>
</span>
<?php } ?>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Vid" data-hidden="1" name="o<?= $Page->RowIndex ?>_Vid" id="o<?= $Page->RowIndex ?>_Vid" value="<?= HtmlEncode($Page->Vid->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<?php if ($Page->Vid->getSessionValue() != "") { ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Vid" class="form-group">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_invoiceId" class="form-group">
<input type="<?= $Page->invoiceId->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_invoiceId" name="x<?= $Page->RowIndex ?>_invoiceId" id="x<?= $Page->RowIndex ?>_invoiceId" size="30" placeholder="<?= HtmlEncode($Page->invoiceId->getPlaceHolder()) ?>" value="<?= $Page->invoiceId->EditValue ?>"<?= $Page->invoiceId->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->invoiceId->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_invoiceId" data-hidden="1" name="o<?= $Page->RowIndex ?>_invoiceId" id="o<?= $Page->RowIndex ?>_invoiceId" value="<?= HtmlEncode($Page->invoiceId->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_invoiceId" class="form-group">
<input type="<?= $Page->invoiceId->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_invoiceId" name="x<?= $Page->RowIndex ?>_invoiceId" id="x<?= $Page->RowIndex ?>_invoiceId" size="30" placeholder="<?= HtmlEncode($Page->invoiceId->getPlaceHolder()) ?>" value="<?= $Page->invoiceId->EditValue ?>"<?= $Page->invoiceId->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DrID" class="form-group">
<input type="<?= $Page->DrID->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DrID" name="x<?= $Page->RowIndex ?>_DrID" id="x<?= $Page->RowIndex ?>_DrID" size="30" placeholder="<?= HtmlEncode($Page->DrID->getPlaceHolder()) ?>" value="<?= $Page->DrID->EditValue ?>"<?= $Page->DrID->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DrID->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_DrID" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrID" id="o<?= $Page->RowIndex ?>_DrID" value="<?= HtmlEncode($Page->DrID->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DrID" class="form-group">
<input type="<?= $Page->DrID->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DrID" name="x<?= $Page->RowIndex ?>_DrID" id="x<?= $Page->RowIndex ?>_DrID" size="30" placeholder="<?= HtmlEncode($Page->DrID->getPlaceHolder()) ?>" value="<?= $Page->DrID->EditValue ?>"<?= $Page->DrID->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DrCODE" class="form-group">
<input type="<?= $Page->DrCODE->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DrCODE" name="x<?= $Page->RowIndex ?>_DrCODE" id="x<?= $Page->RowIndex ?>_DrCODE" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DrCODE->getPlaceHolder()) ?>" value="<?= $Page->DrCODE->EditValue ?>"<?= $Page->DrCODE->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DrCODE->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_DrCODE" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrCODE" id="o<?= $Page->RowIndex ?>_DrCODE" value="<?= HtmlEncode($Page->DrCODE->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DrCODE" class="form-group">
<input type="<?= $Page->DrCODE->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DrCODE" name="x<?= $Page->RowIndex ?>_DrCODE" id="x<?= $Page->RowIndex ?>_DrCODE" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DrCODE->getPlaceHolder()) ?>" value="<?= $Page->DrCODE->EditValue ?>"<?= $Page->DrCODE->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DrName" class="form-group">
<input type="<?= $Page->DrName->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DrName" name="x<?= $Page->RowIndex ?>_DrName" id="x<?= $Page->RowIndex ?>_DrName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DrName->getPlaceHolder()) ?>" value="<?= $Page->DrName->EditValue ?>"<?= $Page->DrName->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DrName->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_DrName" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrName" id="o<?= $Page->RowIndex ?>_DrName" value="<?= HtmlEncode($Page->DrName->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_DrName" class="form-group">
<input type="<?= $Page->DrName->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_DrName" name="x<?= $Page->RowIndex ?>_DrName" id="x<?= $Page->RowIndex ?>_DrName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DrName->getPlaceHolder()) ?>" value="<?= $Page->DrName->EditValue ?>"<?= $Page->DrName->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Department" class="form-group">
...
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_Department" data-hidden="1" name="o<?= $Page->RowIndex ?>_Department" id="o<?= $Page->RowIndex ?>_Department" value="<?= HtmlEncode($Page->Department->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_Department" class="form-group">
<input type="<?= $Page->Department->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_Department" name="x<?= $Page->RowIndex ?>_Department" id="x<?= $Page->RowIndex ?>_Department" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Department->getPlaceHolder()) ?>" value="<?= $Page->Department->EditValue ?>"<?= $Page->Department->editAttributes() ?>>
...
loadjs.ready(["fview_lab_resultreleasedlist", "datetimepicker"], function() {
    ew.createDateTimePicker("fview_lab_resultreleasedlist", "x<?= $Page->RowIndex ?>_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_createddatetime" data-hidden="1" name="o<?= $Page->RowIndex ?>_createddatetime" id="o<?= $Page->RowIndex ?>_createddatetime" value="<?= HtmlEncode($Page->createddatetime->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_createddatetime" class="form-group">
<input type="<?= $Page->createddatetime->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_createddatetime" name="x<?= $Page->RowIndex ?>_createddatetime" id="x<?= $Page->RowIndex ?>_createddatetime" placeholder="<?= HtmlEncode($Page->createddatetime->getPlaceHolder()) ?>" value="<?= $Page->createddatetime->EditValue ?>"<?= $Page->createddatetime->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_status" class="form-group">
<input type="<?= $Page->status->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_status" name="x<?= $Page->RowIndex ?>_status" id="x<?= $Page->RowIndex ?>_status" size="30" placeholder="<?= HtmlEncode($Page->status->getPlaceHolder()) ?>" value="<?= $Page->status->EditValue ?>"<?= $Page->status->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->status->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_status" data-hidden="1" name="o<?= $Page->RowIndex ?>_status" id="o<?= $Page->RowIndex ?>_status" value="<?= HtmlEncode($Page->status->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_status" class="form-group">
<input type="<?= $Page->status->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_status" name="x<?= $Page->RowIndex ?>_status" id="x<?= $Page->RowIndex ?>_status" size="30" placeholder="<?= HtmlEncode($Page->status->getPlaceHolder()) ?>" value="<?= $Page->status->EditValue ?>"<?= $Page->status->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_TestType" class="form-group">
<input type="<?= $Page->TestType->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_TestType" name="x<?= $Page->RowIndex ?>_TestType" id="x<?= $Page->RowIndex ?>_TestType" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->TestType->getPlaceHolder()) ?>" value="<?= $Page->TestType->EditValue ?>"<?= $Page->TestType->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->TestType->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_TestType" data-hidden="1" name="o<?= $Page->RowIndex ?>_TestType" id="o<?= $Page->RowIndex ?>_TestType" value="<?= HtmlEncode($Page->TestType->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_TestType" class="form-group">
<input type="<?= $Page->TestType->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_TestType" name="x<?= $Page->RowIndex ?>_TestType" id="x<?= $Page->RowIndex ?>_TestType" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->TestType->getPlaceHolder()) ?>" value="<?= $Page->TestType->EditValue ?>"<?= $Page->TestType->editAttributes() ?>>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_ResultDate" data-hidden="1" name="o<?= $Page->RowIndex ?>_ResultDate" id="o<?= $Page->RowIndex ?>_ResultDate" value="<?= HtmlEncode($Page->ResultDate->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_ResultedBy" data-hidden="1" name="o<?= $Page->RowIndex ?>_ResultedBy" id="o<?= $Page->RowIndex ?>_ResultedBy" value="<?= HtmlEncode($Page->ResultedBy->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_HospID" class="form-group">
<input type="<?= $Page->HospID->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_HospID" name="x<?= $Page->RowIndex ?>_HospID" id="x<?= $Page->RowIndex ?>_HospID" size="30" placeholder="<?= HtmlEncode($Page->HospID->getPlaceHolder()) ?>" value="<?= $Page->HospID->EditValue ?>"<?= $Page->HospID->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->HospID->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_resultreleased" data-field="x_HospID" data-hidden="1" name="o<?= $Page->RowIndex ?>_HospID" id="o<?= $Page->RowIndex ?>_HospID" value="<?= HtmlEncode($Page->HospID->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_resultreleased_HospID" class="form-group">
<input type="<?= $Page->HospID->getInputTextType() ?>" data-table="view_lab_resultreleased" data-field="x_HospID" name="x<?= $Page->RowIndex ?>_HospID" id="x<?= $Page->RowIndex ?>_HospID" size="30" placeholder="<?= HtmlEncode($Page->HospID->getPlaceHolder()) ?>" value="<?= $Page->HospID->EditValue ?>"<?= $Page->HospID->editAttributes() ?>>
...
loadjs.ready(["fview_lab_resultreleasedlist","load"], function () {
    fview_lab_resultreleasedlist.updateLists(<?= $Page->RowIndex ?>);
});
</script>
<?php } ?>
<?php
...
<?php
    if ($Page->isGridAdd() || $Page->isGridEdit()) {
        ...
        // Set row properties
        $Page->resetAttributes();
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowIndex, "id" => "r0_view_lab_resultreleased", "data-rowtype" => ROWTYPE_ADD]);
