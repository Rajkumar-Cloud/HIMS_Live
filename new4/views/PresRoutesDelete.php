...
<script>
if (!ew.vars.tables.pres_routes) ew.vars.tables.pres_routes = <?= JsonEncode(GetClientVar("tables", "pres_routes")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fpres_routesdelete" id="fpres_routesdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
