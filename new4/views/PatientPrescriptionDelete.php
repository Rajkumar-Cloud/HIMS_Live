...
<script>
if (!ew.vars.tables.patient_prescription) ew.vars.tables.patient_prescription = <?= JsonEncode(GetClientVar("tables", "patient_prescription")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fpatient_prescriptiondelete" id="fpatient_prescriptiondelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
        <th class="<?= $Page->profilePic->headerCellClass() ?>"><span id="elh_patient_prescription_profilePic" class="patient_prescription_profilePic"><?= $Page->profilePic->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_patient_prescription_profilePic" class="patient_prescription_profilePic">
