...
// Page object
$PharmacyBillingReturnView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fpharmacy_billing_returnview;
...
$Page->showMessage();
?>
<form name="fpharmacy_billing_returnview" id="fpharmacy_billing_returnview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_id"><template id="tpc_pharmacy_billing_return_id"><?= $Page->id->caption() ?></template></span></td>
        <td data-name="id" <?= $Page->id->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_id"><span id="el_pharmacy_billing_return_id">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Reception"><template id="tpc_pharmacy_billing_return_Reception"><?= $Page->Reception->caption() ?></template></span></td>
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <tr id="r_PatientId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PatientId"><template id="tpc_pharmacy_billing_return_PatientId"><?= $Page->PatientId->caption() ?></template></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_mrnno"><template id="tpc_pharmacy_billing_return_mrnno"><?= $Page->mrnno->caption() ?></template></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PatientName"><template id="tpc_pharmacy_billing_return_PatientName"><?= $Page->PatientName->caption() ?></template></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Age"><template id="tpc_pharmacy_billing_return_Age"><?= $Page->Age->caption() ?></template></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Gender"><template id="tpc_pharmacy_billing_return_Gender"><?= $Page->Gender->caption() ?></template></span></td>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <tr id="r_profilePic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_profilePic"><template id="tpc_pharmacy_billing_return_profilePic"><?= $Page->profilePic->caption() ?></template></span></td>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <tr id="r_Mobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Mobile"><template id="tpc_pharmacy_billing_return_Mobile"><?= $Page->Mobile->caption() ?></template></span></td>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
    <tr id="r_IP_OP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_IP_OP"><template id="tpc_pharmacy_billing_return_IP_OP"><?= $Page->IP_OP->caption() ?></template></span></td>
...
<?php if ($Page->Doctor->Visible) { // Doctor ?>
    <tr id="r_Doctor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Doctor"><template id="tpc_pharmacy_billing_return_Doctor"><?= $Page->Doctor->caption() ?></template></span></td>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
    <tr id="r_voucher_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_voucher_type"><template id="tpc_pharmacy_billing_return_voucher_type"><?= $Page->voucher_type->caption() ?></template></span></td>
...
<?php if ($Page->Details->Visible) { // Details ?>
    <tr id="r_Details">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Details"><template id="tpc_pharmacy_billing_return_Details"><?= $Page->Details->caption() ?></template></span></td>
...
<?php if ($Page->ModeofPayment->Visible) { // ModeofPayment ?>
    <tr id="r_ModeofPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_ModeofPayment"><template id="tpc_pharmacy_billing_return_ModeofPayment"><?= $Page->ModeofPayment->caption() ?></template></span></td>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <tr id="r_Amount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Amount"><template id="tpc_pharmacy_billing_return_Amount"><?= $Page->Amount->caption() ?></template></span></td>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
    <tr id="r_AnyDues">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_AnyDues"><template id="tpc_pharmacy_billing_return_AnyDues"><?= $Page->AnyDues->caption() ?></template></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_createdby"><template id="tpc_pharmacy_billing_return_createdby"><?= $Page->createdby->caption() ?></template></span></td>
        <td data-name="createdby" <?= $Page->createdby->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_createdby"><span id="el_pharmacy_billing_return_createdby">
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_createddatetime"><template id="tpc_pharmacy_billing_return_createddatetime"><?= $Page->createddatetime->caption() ?></template></span></td>
        <td data-name="createddatetime" <?= $Page->createddatetime->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_createddatetime"><span id="el_pharmacy_billing_return_createddatetime">
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_modifiedby"><template id="tpc_pharmacy_billing_return_modifiedby"><?= $Page->modifiedby->caption() ?></template></span></td>
        <td data-name="modifiedby" <?= $Page->modifiedby->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_modifiedby"><span id="el_pharmacy_billing_return_modifiedby">
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_modifieddatetime"><template id="tpc_pharmacy_billing_return_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></template></span></td>
        <td data-name="modifieddatetime" <?= $Page->modifieddatetime->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_modifieddatetime"><span id="el_pharmacy_billing_return_modifieddatetime">
...
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
    <tr id="r_RealizationAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationAmount"><template id="tpc_pharmacy_billing_return_RealizationAmount"><?= $Page->RealizationAmount->caption() ?></template></span></td>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
    <tr id="r_RealizationStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationStatus"><template id="tpc_pharmacy_billing_return_RealizationStatus"><?= $Page->RealizationStatus->caption() ?></template></span></td>
...
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
    <tr id="r_RealizationRemarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationRemarks"><template id="tpc_pharmacy_billing_return_RealizationRemarks"><?= $Page->RealizationRemarks->caption() ?></template></span></td>
...
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
    <tr id="r_RealizationBatchNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationBatchNo"><template id="tpc_pharmacy_billing_return_RealizationBatchNo"><?= $Page->RealizationBatchNo->caption() ?></template></span></td>
...
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
    <tr id="r_RealizationDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationDate"><template id="tpc_pharmacy_billing_return_RealizationDate"><?= $Page->RealizationDate->caption() ?></template></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_HospID"><template id="tpc_pharmacy_billing_return_HospID"><?= $Page->HospID->caption() ?></template></span></td>
        <td data-name="HospID" <?= $Page->HospID->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_HospID"><span id="el_pharmacy_billing_return_HospID">
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <tr id="r_RIDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RIDNO"><template id="tpc_pharmacy_billing_return_RIDNO"><?= $Page->RIDNO->caption() ?></template></span></td>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <tr id="r_TidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_TidNo"><template id="tpc_pharmacy_billing_return_TidNo"><?= $Page->TidNo->caption() ?></template></span></td>
...
<?php if ($Page->CId->Visible) { // CId ?>
    <tr id="r_CId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_CId"><template id="tpc_pharmacy_billing_return_CId"><?= $Page->CId->caption() ?></template></span></td>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <tr id="r_PartnerName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PartnerName"><template id="tpc_pharmacy_billing_return_PartnerName"><?= $Page->PartnerName->caption() ?></template></span></td>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
    <tr id="r_PayerType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PayerType"><template id="tpc_pharmacy_billing_return_PayerType"><?= $Page->PayerType->caption() ?></template></span></td>
...
<?php if ($Page->Dob->Visible) { // Dob ?>
    <tr id="r_Dob">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Dob"><template id="tpc_pharmacy_billing_return_Dob"><?= $Page->Dob->caption() ?></template></span></td>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <tr id="r_Currency">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Currency"><template id="tpc_pharmacy_billing_return_Currency"><?= $Page->Currency->caption() ?></template></span></td>
...
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
    <tr id="r_DiscountRemarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_DiscountRemarks"><template id="tpc_pharmacy_billing_return_DiscountRemarks"><?= $Page->DiscountRemarks->caption() ?></template></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Remarks"><template id="tpc_pharmacy_billing_return_Remarks"><?= $Page->Remarks->caption() ?></template></span></td>
...
<?php if ($Page->PatId->Visible) { // PatId ?>
    <tr id="r_PatId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PatId"><template id="tpc_pharmacy_billing_return_PatId"><?= $Page->PatId->caption() ?></template></span></td>
...
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
    <tr id="r_DrDepartment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_DrDepartment"><template id="tpc_pharmacy_billing_return_DrDepartment"><?= $Page->DrDepartment->caption() ?></template></span></td>
...
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
    <tr id="r_RefferedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RefferedBy"><template id="tpc_pharmacy_billing_return_RefferedBy"><?= $Page->RefferedBy->caption() ?></template></span></td>
...
<?php if ($Page->BillNumber->Visible) { // BillNumber ?>
    <tr id="r_BillNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_BillNumber"><template id="tpc_pharmacy_billing_return_BillNumber"><?= $Page->BillNumber->caption() ?></template></span></td>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <tr id="r_CardNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_CardNumber"><template id="tpc_pharmacy_billing_return_CardNumber"><?= $Page->CardNumber->caption() ?></template></span></td>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <tr id="r_BankName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_BankName"><template id="tpc_pharmacy_billing_return_BankName"><?= $Page->BankName->caption() ?></template></span></td>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <tr id="r_DrID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_DrID"><template id="tpc_pharmacy_billing_return_DrID"><?= $Page->DrID->caption() ?></template></span></td>
...
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
    <tr id="r_BillStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_BillStatus"><template id="tpc_pharmacy_billing_return_BillStatus"><?= $Page->BillStatus->caption() ?></template></span></td>
...
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
    <tr id="r_ReportHeader">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_ReportHeader"><template id="tpc_pharmacy_billing_return_ReportHeader"><?= $Page->ReportHeader->caption() ?></template></span></td>
...
<?php if ($Page->PharID->Visible) { // PharID ?>
    <tr id="r_PharID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PharID"><template id="tpc_pharmacy_billing_return_PharID"><?= $Page->PharID->caption() ?></template></span></td>
        <td data-name="PharID" <?= $Page->PharID->cellAttributes() ?>>
<template id="tpx_pharmacy_billing_return_PharID"><span id="el_pharmacy_billing_return_PharID">
...
<template id="tpm_pharmacy_billing_returnview">
<div id="ct_PharmacyBillingReturnView"><style>
...
<?php
    if (in_array("view_pharmacy_pharled_return", explode(",", $Page->getCurrentDetailTable())) && $view_pharmacy_pharled_return->DetailView) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_billing_returnview", "tpm_pharmacy_billing_returnview", "pharmacy_billing_returnview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
