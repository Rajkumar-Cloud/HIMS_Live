...
loadjs.ready("head", function () {
    ...
    fhospital_pharmacyadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fhospital_pharmacyadd.lists.HospId = <?= $Page->HospId->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fhospital_pharmacyadd" id="fhospital_pharmacyadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
