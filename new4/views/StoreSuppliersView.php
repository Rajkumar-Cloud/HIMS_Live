...
$Page->showMessage();
?>
<form name="fstore_suppliersview" id="fstore_suppliersview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_suppliers_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->BranchID->Visible) { // BranchID ?>
    <tr id="r_BranchID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_suppliers_BranchID"><?= $Page->BranchID->caption() ?></span></td>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_suppliers_StoreID"><?= $Page->StoreID->caption() ?></span></td>
