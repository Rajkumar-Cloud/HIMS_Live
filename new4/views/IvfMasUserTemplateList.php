...
<form name="fivf_mas_user_templatelistsrch" id="fivf_mas_user_templatelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fivf_mas_user_templatelist" id="fivf_mas_user_templatelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
