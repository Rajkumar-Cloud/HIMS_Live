...
// Page object
$ViewPharmacytransferAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_pharmacytransferadd;
loadjs.ready("head", function () {
    ...
    fview_pharmacytransferadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_pharmacytransferadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_pharmacytransferadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_pharmacytransferadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_pharmacytransferadd.lists.ORDNO = <?= $Page->ORDNO->toClientList($Page) ?>;
    fview_pharmacytransferadd.lists.BRCODE = <?= $Page->BRCODE->toClientList($Page) ?>;
    fview_pharmacytransferadd.lists.LastMonthSale = <?= $Page->LastMonthSale->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_pharmacytransferadd" id="fview_pharmacytransferadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fview_pharmacytransferadd"], function() {
    fview_pharmacytransferadd.createAutoSuggest(Object.assign({"id":"x_BRCODE","forceSelect":false}, ew.vars.tables.view_pharmacytransfer.fields.BRCODE.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_pharmacytransferadd"], function() {
    fview_pharmacytransferadd.createAutoSuggest(Object.assign({"id":"x_LastMonthSale","forceSelect":true}, ew.vars.tables.view_pharmacytransfer.fields.LastMonthSale.autoSuggestOptions));
});
</script>
