...
loadjs.ready("head", function () {
    ...
    femployeeedit.lists.gender = <?= $Page->gender->toClientList($Page) ?>;
    femployeeedit.lists.nationality = <?= $Page->nationality->toClientList($Page) ?>;
    femployeeedit.lists.marital_status = <?= $Page->marital_status->toClientList($Page) ?>;
    femployeeedit.lists.approver1 = <?= $Page->approver1->toClientList($Page) ?>;
    femployeeedit.lists.approver2 = <?= $Page->approver2->toClientList($Page) ?>;
    femployeeedit.lists.approver3 = <?= $Page->approver3->toClientList($Page) ?>;
    femployeeedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
<input type="hidden" data-table="employee" data-field="x_id" data-hidden="1" data-page="0" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php
    if (in_array("employee_address", explode(",", $Page->getCurrentDetailTable())) && $employee_address->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("employee_telephone", explode(",", $Page->getCurrentDetailTable())) && $employee_telephone->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("employee_email", explode(",", $Page->getCurrentDetailTable())) && $employee_email->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("employee_has_degree", explode(",", $Page->getCurrentDetailTable())) && $employee_has_degree->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("employee_has_experience", explode(",", $Page->getCurrentDetailTable())) && $employee_has_experience->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("employee_document", explode(",", $Page->getCurrentDetailTable())) && $employee_document->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
