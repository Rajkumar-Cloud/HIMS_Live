...
// Page object
$ViewPharmacygrnEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_pharmacygrnedit;
loadjs.ready("head", function () {
    ...
    fview_pharmacygrnedit.addFields([
    ...
    // Form_CustomValidate
    fview_pharmacygrnedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_pharmacygrnedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_pharmacygrnedit.lists.PrName = <?= $Page->PrName->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_pharmacygrnedit" id="fview_pharmacygrnedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->getCurrentMasterTable() == "pharmacy_grn") { ?>
...
<?php if ($Page->ORDNO->Visible) { // ORDNO ?>
    <div id="r_ORDNO" class="form-group row">
        <label id="elh_view_pharmacygrn_ORDNO" for="x_ORDNO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORDNO->caption() ?><?= $Page->ORDNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORDNO->cellAttributes() ?>>
<span id="el_view_pharmacygrn_ORDNO">
<input type="<?= $Page->ORDNO->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_ORDNO" name="x_ORDNO" id="x_ORDNO" size="30" maxlength="5" placeholder="<?= HtmlEncode($Page->ORDNO->getPlaceHolder()) ?>" value="<?= $Page->ORDNO->EditValue ?>"<?= $Page->ORDNO->editAttributes() ?> aria-describedby="x_ORDNO_help">
...
<?php if ($Page->PRC->Visible) { // PRC ?>
    <div id="r_PRC" class="form-group row">
        <label id="elh_view_pharmacygrn_PRC" for="x_PRC" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PRC->caption() ?><?= $Page->PRC->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PRC->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PRC">
<input type="<?= $Page->PRC->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PRC" name="x_PRC" id="x_PRC" size="4" maxlength="9" placeholder="<?= HtmlEncode($Page->PRC->getPlaceHolder()) ?>" value="<?= $Page->PRC->EditValue ?>"<?= $Page->PRC->editAttributes() ?> aria-describedby="x_PRC_help">
...
<?php if ($Page->QTY->Visible) { // QTY ?>
    <div id="r_QTY" class="form-group row">
        <label id="elh_view_pharmacygrn_QTY" for="x_QTY" class="<?= $Page->LeftColumnClass ?>"><?= $Page->QTY->caption() ?><?= $Page->QTY->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->QTY->cellAttributes() ?>>
<span id="el_view_pharmacygrn_QTY">
<input type="<?= $Page->QTY->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_QTY" name="x_QTY" id="x_QTY" size="30" placeholder="<?= HtmlEncode($Page->QTY->getPlaceHolder()) ?>" value="<?= $Page->QTY->EditValue ?>"<?= $Page->QTY->editAttributes() ?> aria-describedby="x_QTY_help">
...
<?php if ($Page->DT->Visible) { // DT ?>
    <div id="r_DT" class="form-group row">
        <label id="elh_view_pharmacygrn_DT" for="x_DT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DT->caption() ?><?= $Page->DT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DT->cellAttributes() ?>>
<span id="el_view_pharmacygrn_DT">
<input type="<?= $Page->DT->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_DT" name="x_DT" id="x_DT" placeholder="<?= HtmlEncode($Page->DT->getPlaceHolder()) ?>" value="<?= $Page->DT->EditValue ?>"<?= $Page->DT->editAttributes() ?> aria-describedby="x_DT_help">
...
<?php if ($Page->PC->Visible) { // PC ?>
    <div id="r_PC" class="form-group row">
        <label id="elh_view_pharmacygrn_PC" for="x_PC" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PC->caption() ?><?= $Page->PC->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PC->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PC">
<input type="<?= $Page->PC->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PC" name="x_PC" id="x_PC" size="30" maxlength="5" placeholder="<?= HtmlEncode($Page->PC->getPlaceHolder()) ?>" value="<?= $Page->PC->EditValue ?>"<?= $Page->PC->editAttributes() ?> aria-describedby="x_PC_help">
...
<?php if ($Page->YM->Visible) { // YM ?>
    <div id="r_YM" class="form-group row">
        <label id="elh_view_pharmacygrn_YM" for="x_YM" class="<?= $Page->LeftColumnClass ?>"><?= $Page->YM->caption() ?><?= $Page->YM->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->YM->cellAttributes() ?>>
<span id="el_view_pharmacygrn_YM">
<input type="<?= $Page->YM->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_YM" name="x_YM" id="x_YM" size="30" maxlength="6" placeholder="<?= HtmlEncode($Page->YM->getPlaceHolder()) ?>" value="<?= $Page->YM->EditValue ?>"<?= $Page->YM->editAttributes() ?> aria-describedby="x_YM_help">
...
<?php if ($Page->Stock->Visible) { // Stock ?>
    <div id="r_Stock" class="form-group row">
        <label id="elh_view_pharmacygrn_Stock" for="x_Stock" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Stock->caption() ?><?= $Page->Stock->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Stock->cellAttributes() ?>>
<span id="el_view_pharmacygrn_Stock">
<input type="<?= $Page->Stock->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_Stock" name="x_Stock" id="x_Stock" size="30" placeholder="<?= HtmlEncode($Page->Stock->getPlaceHolder()) ?>" value="<?= $Page->Stock->EditValue ?>"<?= $Page->Stock->editAttributes() ?> aria-describedby="x_Stock_help">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_view_pharmacygrn_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_view_pharmacygrn_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="view_pharmacygrn" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->poid->Visible) { // poid ?>
    <div id="r_poid" class="form-group row">
        <label id="elh_view_pharmacygrn_poid" for="x_poid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->poid->caption() ?><?= $Page->poid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->poid->cellAttributes() ?>>
<span id="el_view_pharmacygrn_poid">
<input type="<?= $Page->poid->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_poid" name="x_poid" id="x_poid" size="30" placeholder="<?= HtmlEncode($Page->poid->getPlaceHolder()) ?>" value="<?= $Page->poid->EditValue ?>"<?= $Page->poid->editAttributes() ?> aria-describedby="x_poid_help">
...
<?php if ($Page->PrName->Visible) { // PrName ?>
    <div id="r_PrName" class="form-group row">
        <label id="elh_view_pharmacygrn_PrName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PrName->caption() ?><?= $Page->PrName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="as_x_PrName" class="ew-auto-suggest">
    <div class="input-group">
        ...
        <?php if (AllowAdd(CurrentProjectID() . "pharmacy_storemast") && !$Page->PrName->ReadOnly) { ?>
        <div class="input-group-append"><button type="button" class="btn btn-default ew-add-opt-btn" id="aol_x_PrName" title="<?= HtmlTitle($Language->phrase("AddLink")) . "&nbsp;" . $Page->PrName->caption() ?>" data-title="<?= $Page->PrName->caption() ?>" onclick="ew.addOptionDialogShow({lnk:this,el:'x_PrName',url:'<?= GetUrl("PharmacyStoremastAddopt") ?>'});"><i class="fas fa-plus ew-icon"></i></button></div>
        <?php } ?>
    </div>
</span>
<input type="hidden" is="selection-list" class="form-control" data-table="view_pharmacygrn" data-field="x_PrName" data-input="sv_x_PrName" data-value-separator="<?= $Page->PrName->displayValueSeparatorAttribute() ?>" name="x_PrName" id="x_PrName" value="<?= HtmlEncode($Page->PrName->CurrentValue) ?>"<?= $onchange ?>>
...
loadjs.ready(["fview_pharmacygrnedit"], function() {
    fview_pharmacygrnedit.createAutoSuggest(Object.assign({"id":"x_PrName","forceSelect":true}, ew.vars.tables.view_pharmacygrn.fields.PrName.autoSuggestOptions));
});
</script>
...
<?php if ($Page->grnid->Visible) { // grnid ?>
    <div id="r_grnid" class="form-group row">
        <label id="elh_view_pharmacygrn_grnid" for="x_grnid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->grnid->caption() ?><?= $Page->grnid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php } else { ?>
<span id="el_view_pharmacygrn_grnid">
<input type="<?= $Page->grnid->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_grnid" name="x_grnid" id="x_grnid" size="30" placeholder="<?= HtmlEncode($Page->grnid->getPlaceHolder()) ?>" value="<?= $Page->grnid->EditValue ?>"<?= $Page->grnid->editAttributes() ?> aria-describedby="x_grnid_help">
...
<?php if ($Page->Quantity->Visible) { // Quantity ?>
    <div id="r_Quantity" class="form-group row">
        <label id="elh_view_pharmacygrn_Quantity" for="x_Quantity" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Quantity->caption() ?><?= $Page->Quantity->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Quantity->cellAttributes() ?>>
<span id="el_view_pharmacygrn_Quantity">
<input type="<?= $Page->Quantity->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_Quantity" name="x_Quantity" id="x_Quantity" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->Quantity->getPlaceHolder()) ?>" value="<?= $Page->Quantity->EditValue ?>"<?= $Page->Quantity->editAttributes() ?> aria-describedby="x_Quantity_help">
...
<?php if ($Page->FreeQty->Visible) { // FreeQty ?>
    <div id="r_FreeQty" class="form-group row">
        <label id="elh_view_pharmacygrn_FreeQty" for="x_FreeQty" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FreeQty->caption() ?><?= $Page->FreeQty->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FreeQty->cellAttributes() ?>>
<span id="el_view_pharmacygrn_FreeQty">
<input type="<?= $Page->FreeQty->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_FreeQty" name="x_FreeQty" id="x_FreeQty" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->FreeQty->getPlaceHolder()) ?>" value="<?= $Page->FreeQty->EditValue ?>"<?= $Page->FreeQty->editAttributes() ?> aria-describedby="x_FreeQty_help">
...
<?php if ($Page->FreeQtyyy->Visible) { // FreeQtyyy ?>
    <div id="r_FreeQtyyy" class="form-group row">
        <label id="elh_view_pharmacygrn_FreeQtyyy" for="x_FreeQtyyy" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FreeQtyyy->caption() ?><?= $Page->FreeQtyyy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FreeQtyyy->cellAttributes() ?>>
<span id="el_view_pharmacygrn_FreeQtyyy">
<input type="<?= $Page->FreeQtyyy->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_FreeQtyyy" name="x_FreeQtyyy" id="x_FreeQtyyy" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->FreeQtyyy->getPlaceHolder()) ?>" value="<?= $Page->FreeQtyyy->EditValue ?>"<?= $Page->FreeQtyyy->editAttributes() ?> aria-describedby="x_FreeQtyyy_help">
...
<?php if ($Page->BatchNo->Visible) { // BatchNo ?>
    <div id="r_BatchNo" class="form-group row">
        <label id="elh_view_pharmacygrn_BatchNo" for="x_BatchNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BatchNo->caption() ?><?= $Page->BatchNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BatchNo->cellAttributes() ?>>
<span id="el_view_pharmacygrn_BatchNo">
<input type="<?= $Page->BatchNo->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_BatchNo" name="x_BatchNo" id="x_BatchNo" size="8" maxlength="8" placeholder="<?= HtmlEncode($Page->BatchNo->getPlaceHolder()) ?>" value="<?= $Page->BatchNo->EditValue ?>"<?= $Page->BatchNo->editAttributes() ?> aria-describedby="x_BatchNo_help">
...
<?php if ($Page->ExpDate->Visible) { // ExpDate ?>
    <div id="r_ExpDate" class="form-group row">
        <label id="elh_view_pharmacygrn_ExpDate" for="x_ExpDate" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ExpDate->caption() ?><?= $Page->ExpDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ExpDate->cellAttributes() ?>>
<span id="el_view_pharmacygrn_ExpDate">
<input type="<?= $Page->ExpDate->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_ExpDate" data-format="7" name="x_ExpDate" id="x_ExpDate" size="8" maxlength="10" placeholder="<?= HtmlEncode($Page->ExpDate->getPlaceHolder()) ?>" value="<?= $Page->ExpDate->EditValue ?>"<?= $Page->ExpDate->editAttributes() ?> aria-describedby="x_ExpDate_help">
...
<?php if ($Page->HSN->Visible) { // HSN ?>
    <div id="r_HSN" class="form-group row">
        <label id="elh_view_pharmacygrn_HSN" for="x_HSN" class="<?= $Page->LeftColumnClass ?>"><?= $Page->HSN->caption() ?><?= $Page->HSN->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->HSN->cellAttributes() ?>>
<span id="el_view_pharmacygrn_HSN">
<input type="<?= $Page->HSN->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_HSN" name="x_HSN" id="x_HSN" size="10" maxlength="10" placeholder="<?= HtmlEncode($Page->HSN->getPlaceHolder()) ?>" value="<?= $Page->HSN->EditValue ?>"<?= $Page->HSN->editAttributes() ?> aria-describedby="x_HSN_help">
...
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
    <div id="r_MFRCODE" class="form-group row">
        <label id="elh_view_pharmacygrn_MFRCODE" for="x_MFRCODE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MFRCODE->caption() ?><?= $Page->MFRCODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MFRCODE->cellAttributes() ?>>
<span id="el_view_pharmacygrn_MFRCODE">
<input type="<?= $Page->MFRCODE->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_MFRCODE" name="x_MFRCODE" id="x_MFRCODE" size="6" maxlength="6" placeholder="<?= HtmlEncode($Page->MFRCODE->getPlaceHolder()) ?>" value="<?= $Page->MFRCODE->EditValue ?>"<?= $Page->MFRCODE->editAttributes() ?> aria-describedby="x_MFRCODE_help">
...
<?php if ($Page->PUnit->Visible) { // PUnit ?>
    <div id="r_PUnit" class="form-group row">
        <label id="elh_view_pharmacygrn_PUnit" for="x_PUnit" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PUnit->caption() ?><?= $Page->PUnit->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PUnit->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PUnit">
<input type="<?= $Page->PUnit->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PUnit" name="x_PUnit" id="x_PUnit" size="8" maxlength="8" placeholder="<?= HtmlEncode($Page->PUnit->getPlaceHolder()) ?>" value="<?= $Page->PUnit->EditValue ?>"<?= $Page->PUnit->editAttributes() ?> aria-describedby="x_PUnit_help">
...
<?php if ($Page->SUnit->Visible) { // SUnit ?>
    <div id="r_SUnit" class="form-group row">
        <label id="elh_view_pharmacygrn_SUnit" for="x_SUnit" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SUnit->caption() ?><?= $Page->SUnit->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SUnit->cellAttributes() ?>>
<span id="el_view_pharmacygrn_SUnit">
<input type="<?= $Page->SUnit->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_SUnit" name="x_SUnit" id="x_SUnit" size="8" maxlength="8" placeholder="<?= HtmlEncode($Page->SUnit->getPlaceHolder()) ?>" value="<?= $Page->SUnit->EditValue ?>"<?= $Page->SUnit->editAttributes() ?> aria-describedby="x_SUnit_help">
...
<?php if ($Page->Pack->Visible) { // Pack ?>
    <div id="r_Pack" class="form-group row">
        <label id="elh_view_pharmacygrn_Pack" for="x_Pack" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Pack->caption() ?><?= $Page->Pack->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Pack->cellAttributes() ?>>
<span id="el_view_pharmacygrn_Pack">
<input type="<?= $Page->Pack->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_Pack" name="x_Pack" id="x_Pack" size="8" maxlength="8" placeholder="<?= HtmlEncode($Page->Pack->getPlaceHolder()) ?>" value="<?= $Page->Pack->EditValue ?>"<?= $Page->Pack->editAttributes() ?> aria-describedby="x_Pack_help">
...
<?php if ($Page->GrnMRP->Visible) { // GrnMRP ?>
    <div id="r_GrnMRP" class="form-group row">
        <label id="elh_view_pharmacygrn_GrnMRP" for="x_GrnMRP" class="<?= $Page->LeftColumnClass ?>"><?= $Page->GrnMRP->caption() ?><?= $Page->GrnMRP->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->GrnMRP->cellAttributes() ?>>
<span id="el_view_pharmacygrn_GrnMRP">
<input type="<?= $Page->GrnMRP->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_GrnMRP" name="x_GrnMRP" id="x_GrnMRP" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->GrnMRP->getPlaceHolder()) ?>" value="<?= $Page->GrnMRP->EditValue ?>"<?= $Page->GrnMRP->editAttributes() ?> aria-describedby="x_GrnMRP_help">
...
<?php if ($Page->MRP->Visible) { // MRP ?>
    <div id="r_MRP" class="form-group row">
        <label id="elh_view_pharmacygrn_MRP" for="x_MRP" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MRP->caption() ?><?= $Page->MRP->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MRP->cellAttributes() ?>>
<span id="el_view_pharmacygrn_MRP">
<input type="<?= $Page->MRP->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_MRP" name="x_MRP" id="x_MRP" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->MRP->getPlaceHolder()) ?>" value="<?= $Page->MRP->EditValue ?>"<?= $Page->MRP->editAttributes() ?> aria-describedby="x_MRP_help">
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <div id="r_PurValue" class="form-group row">
        <label id="elh_view_pharmacygrn_PurValue" for="x_PurValue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PurValue->caption() ?><?= $Page->PurValue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PurValue->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PurValue">
<input type="<?= $Page->PurValue->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PurValue" name="x_PurValue" id="x_PurValue" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->PurValue->getPlaceHolder()) ?>" value="<?= $Page->PurValue->EditValue ?>"<?= $Page->PurValue->editAttributes() ?> aria-describedby="x_PurValue_help">
...
<?php if ($Page->GRNPer->Visible) { // GRNPer ?>
    <div id="r_GRNPer" class="form-group row">
        <label id="elh_view_pharmacygrn_GRNPer" for="x_GRNPer" class="<?= $Page->LeftColumnClass ?>"><?= $Page->GRNPer->caption() ?><?= $Page->GRNPer->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->GRNPer->cellAttributes() ?>>
<span id="el_view_pharmacygrn_GRNPer">
<input type="<?= $Page->GRNPer->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_GRNPer" name="x_GRNPer" id="x_GRNPer" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->GRNPer->getPlaceHolder()) ?>" value="<?= $Page->GRNPer->EditValue ?>"<?= $Page->GRNPer->editAttributes() ?> aria-describedby="x_GRNPer_help">
...
<?php if ($Page->Disc->Visible) { // Disc ?>
    <div id="r_Disc" class="form-group row">
        <label id="elh_view_pharmacygrn_Disc" for="x_Disc" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Disc->caption() ?><?= $Page->Disc->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Disc->cellAttributes() ?>>
<span id="el_view_pharmacygrn_Disc">
<input type="<?= $Page->Disc->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_Disc" name="x_Disc" id="x_Disc" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->Disc->getPlaceHolder()) ?>" value="<?= $Page->Disc->EditValue ?>"<?= $Page->Disc->editAttributes() ?> aria-describedby="x_Disc_help">
...
<?php if ($Page->PSGST->Visible) { // PSGST ?>
    <div id="r_PSGST" class="form-group row">
        <label id="elh_view_pharmacygrn_PSGST" for="x_PSGST" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PSGST->caption() ?><?= $Page->PSGST->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PSGST->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PSGST">
<input type="<?= $Page->PSGST->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PSGST" name="x_PSGST" id="x_PSGST" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->PSGST->getPlaceHolder()) ?>" value="<?= $Page->PSGST->EditValue ?>"<?= $Page->PSGST->editAttributes() ?> aria-describedby="x_PSGST_help">
...
<?php if ($Page->PCGST->Visible) { // PCGST ?>
    <div id="r_PCGST" class="form-group row">
        <label id="elh_view_pharmacygrn_PCGST" for="x_PCGST" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PCGST->caption() ?><?= $Page->PCGST->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PCGST->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PCGST">
<input type="<?= $Page->PCGST->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PCGST" name="x_PCGST" id="x_PCGST" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->PCGST->getPlaceHolder()) ?>" value="<?= $Page->PCGST->EditValue ?>"<?= $Page->PCGST->editAttributes() ?> aria-describedby="x_PCGST_help">
...
<?php if ($Page->PTax->Visible) { // PTax ?>
    <div id="r_PTax" class="form-group row">
        <label id="elh_view_pharmacygrn_PTax" for="x_PTax" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PTax->caption() ?><?= $Page->PTax->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PTax->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PTax">
<input type="<?= $Page->PTax->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PTax" name="x_PTax" id="x_PTax" size="6" maxlength="10" placeholder="<?= HtmlEncode($Page->PTax->getPlaceHolder()) ?>" value="<?= $Page->PTax->EditValue ?>"<?= $Page->PTax->editAttributes() ?> aria-describedby="x_PTax_help">
...
<?php if ($Page->ItemValue->Visible) { // ItemValue ?>
    <div id="r_ItemValue" class="form-group row">
        <label id="elh_view_pharmacygrn_ItemValue" for="x_ItemValue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ItemValue->caption() ?><?= $Page->ItemValue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ItemValue->cellAttributes() ?>>
<span id="el_view_pharmacygrn_ItemValue">
<input type="<?= $Page->ItemValue->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_ItemValue" name="x_ItemValue" id="x_ItemValue" size="8" maxlength="12" placeholder="<?= HtmlEncode($Page->ItemValue->getPlaceHolder()) ?>" value="<?= $Page->ItemValue->EditValue ?>"<?= $Page->ItemValue->editAttributes() ?> aria-describedby="x_ItemValue_help">
...
<?php if ($Page->SalTax->Visible) { // SalTax ?>
    <div id="r_SalTax" class="form-group row">
        <label id="elh_view_pharmacygrn_SalTax" for="x_SalTax" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SalTax->caption() ?><?= $Page->SalTax->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SalTax->cellAttributes() ?>>
<span id="el_view_pharmacygrn_SalTax">
<input type="<?= $Page->SalTax->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_SalTax" name="x_SalTax" id="x_SalTax" size="8" maxlength="12" placeholder="<?= HtmlEncode($Page->SalTax->getPlaceHolder()) ?>" value="<?= $Page->SalTax->EditValue ?>"<?= $Page->SalTax->editAttributes() ?> aria-describedby="x_SalTax_help">
...
<?php if ($Page->PurRate->Visible) { // PurRate ?>
    <div id="r_PurRate" class="form-group row">
        <label id="elh_view_pharmacygrn_PurRate" for="x_PurRate" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PurRate->caption() ?><?= $Page->PurRate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PurRate->cellAttributes() ?>>
<span id="el_view_pharmacygrn_PurRate">
<input type="<?= $Page->PurRate->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_PurRate" name="x_PurRate" id="x_PurRate" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->PurRate->getPlaceHolder()) ?>" value="<?= $Page->PurRate->EditValue ?>"<?= $Page->PurRate->editAttributes() ?> aria-describedby="x_PurRate_help">
...
<?php if ($Page->SalRate->Visible) { // SalRate ?>
    <div id="r_SalRate" class="form-group row">
        <label id="elh_view_pharmacygrn_SalRate" for="x_SalRate" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SalRate->caption() ?><?= $Page->SalRate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SalRate->cellAttributes() ?>>
<span id="el_view_pharmacygrn_SalRate">
<input type="<?= $Page->SalRate->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_SalRate" name="x_SalRate" id="x_SalRate" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->SalRate->getPlaceHolder()) ?>" value="<?= $Page->SalRate->EditValue ?>"<?= $Page->SalRate->editAttributes() ?> aria-describedby="x_SalRate_help">
...
<?php if ($Page->Discount->Visible) { // Discount ?>
    <div id="r_Discount" class="form-group row">
        <label id="elh_view_pharmacygrn_Discount" for="x_Discount" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Discount->caption() ?><?= $Page->Discount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Discount->cellAttributes() ?>>
<span id="el_view_pharmacygrn_Discount">
<input type="<?= $Page->Discount->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_Discount" name="x_Discount" id="x_Discount" size="4" maxlength="8" placeholder="<?= HtmlEncode($Page->Discount->getPlaceHolder()) ?>" value="<?= $Page->Discount->EditValue ?>"<?= $Page->Discount->editAttributes() ?> aria-describedby="x_Discount_help">
...
<?php if ($Page->SSGST->Visible) { // SSGST ?>
    <div id="r_SSGST" class="form-group row">
        <label id="elh_view_pharmacygrn_SSGST" for="x_SSGST" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SSGST->caption() ?><?= $Page->SSGST->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SSGST->cellAttributes() ?>>
<span id="el_view_pharmacygrn_SSGST">
<input type="<?= $Page->SSGST->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_SSGST" name="x_SSGST" id="x_SSGST" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->SSGST->getPlaceHolder()) ?>" value="<?= $Page->SSGST->EditValue ?>"<?= $Page->SSGST->editAttributes() ?> aria-describedby="x_SSGST_help">
...
<?php if ($Page->SCGST->Visible) { // SCGST ?>
    <div id="r_SCGST" class="form-group row">
        <label id="elh_view_pharmacygrn_SCGST" for="x_SCGST" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SCGST->caption() ?><?= $Page->SCGST->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SCGST->cellAttributes() ?>>
<span id="el_view_pharmacygrn_SCGST">
<input type="<?= $Page->SCGST->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_SCGST" name="x_SCGST" id="x_SCGST" size="4" maxlength="4" placeholder="<?= HtmlEncode($Page->SCGST->getPlaceHolder()) ?>" value="<?= $Page->SCGST->EditValue ?>"<?= $Page->SCGST->editAttributes() ?> aria-describedby="x_SCGST_help">
...
<?php if ($Page->trid->Visible) { // trid ?>
    <div id="r_trid" class="form-group row">
        <label id="elh_view_pharmacygrn_trid" for="x_trid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->trid->caption() ?><?= $Page->trid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->trid->cellAttributes() ?>>
<span id="el_view_pharmacygrn_trid">
<input type="<?= $Page->trid->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_trid" name="x_trid" id="x_trid" size="30" placeholder="<?= HtmlEncode($Page->trid->getPlaceHolder()) ?>" value="<?= $Page->trid->EditValue ?>"<?= $Page->trid->editAttributes() ?> aria-describedby="x_trid_help">
...
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
    <div id="r_CreatedBy" class="form-group row">
        <label id="elh_view_pharmacygrn_CreatedBy" for="x_CreatedBy" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CreatedBy->caption() ?><?= $Page->CreatedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CreatedBy->cellAttributes() ?>>
<span id="el_view_pharmacygrn_CreatedBy">
<input type="<?= $Page->CreatedBy->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_CreatedBy" name="x_CreatedBy" id="x_CreatedBy" size="30" placeholder="<?= HtmlEncode($Page->CreatedBy->getPlaceHolder()) ?>" value="<?= $Page->CreatedBy->EditValue ?>"<?= $Page->CreatedBy->editAttributes() ?> aria-describedby="x_CreatedBy_help">
...
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
    <div id="r_CreatedDateTime" class="form-group row">
        <label id="elh_view_pharmacygrn_CreatedDateTime" for="x_CreatedDateTime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CreatedDateTime->caption() ?><?= $Page->CreatedDateTime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CreatedDateTime->cellAttributes() ?>>
<span id="el_view_pharmacygrn_CreatedDateTime">
<input type="<?= $Page->CreatedDateTime->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_CreatedDateTime" name="x_CreatedDateTime" id="x_CreatedDateTime" placeholder="<?= HtmlEncode($Page->CreatedDateTime->getPlaceHolder()) ?>" value="<?= $Page->CreatedDateTime->EditValue ?>"<?= $Page->CreatedDateTime->editAttributes() ?> aria-describedby="x_CreatedDateTime_help">
...
<?php if ($Page->ModifiedBy->Visible) { // ModifiedBy ?>
    <div id="r_ModifiedBy" class="form-group row">
        <label id="elh_view_pharmacygrn_ModifiedBy" for="x_ModifiedBy" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ModifiedBy->caption() ?><?= $Page->ModifiedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ModifiedBy->cellAttributes() ?>>
<span id="el_view_pharmacygrn_ModifiedBy">
<input type="<?= $Page->ModifiedBy->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_ModifiedBy" name="x_ModifiedBy" id="x_ModifiedBy" size="30" placeholder="<?= HtmlEncode($Page->ModifiedBy->getPlaceHolder()) ?>" value="<?= $Page->ModifiedBy->EditValue ?>"<?= $Page->ModifiedBy->editAttributes() ?> aria-describedby="x_ModifiedBy_help">
...
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
    <div id="r_ModifiedDateTime" class="form-group row">
        <label id="elh_view_pharmacygrn_ModifiedDateTime" for="x_ModifiedDateTime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ModifiedDateTime->caption() ?><?= $Page->ModifiedDateTime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ModifiedDateTime->cellAttributes() ?>>
<span id="el_view_pharmacygrn_ModifiedDateTime">
<input type="<?= $Page->ModifiedDateTime->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_ModifiedDateTime" name="x_ModifiedDateTime" id="x_ModifiedDateTime" placeholder="<?= HtmlEncode($Page->ModifiedDateTime->getPlaceHolder()) ?>" value="<?= $Page->ModifiedDateTime->EditValue ?>"<?= $Page->ModifiedDateTime->editAttributes() ?> aria-describedby="x_ModifiedDateTime_help">
...
<?php if ($Page->Received->Visible) { // Received ?>
    <div id="r_Received" class="form-group row">
        <label id="elh_view_pharmacygrn_Received" for="x_Received" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Received->caption() ?><?= $Page->Received->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Received->cellAttributes() ?>>
<span id="el_view_pharmacygrn_Received">
<input type="<?= $Page->Received->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_Received" name="x_Received" id="x_Received" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Received->getPlaceHolder()) ?>" value="<?= $Page->Received->EditValue ?>"<?= $Page->Received->editAttributes() ?> aria-describedby="x_Received_help">
...
<?php if ($Page->BillDate->Visible) { // BillDate ?>
    <div id="r_BillDate" class="form-group row">
        <label id="elh_view_pharmacygrn_BillDate" for="x_BillDate" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BillDate->caption() ?><?= $Page->BillDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BillDate->cellAttributes() ?>>
<span id="el_view_pharmacygrn_BillDate">
<input type="<?= $Page->BillDate->getInputTextType() ?>" data-table="view_pharmacygrn" data-field="x_BillDate" name="x_BillDate" id="x_BillDate" placeholder="<?= HtmlEncode($Page->BillDate->getPlaceHolder()) ?>" value="<?= $Page->BillDate->EditValue ?>"<?= $Page->BillDate->editAttributes() ?> aria-describedby="x_BillDate_help">
