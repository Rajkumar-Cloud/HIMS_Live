...
// Page object
$PatientInvestigationsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpatient_investigationsadd;
loadjs.ready("head", function () {
    ...
    fpatient_investigationsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpatient_investigationsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpatient_investigationsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpatient_investigationsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpatient_investigationsadd" id="fpatient_investigationsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
