...
<form name="fstore_storeledlistsrch" id="fstore_storeledlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fstore_storeledlist" id="fstore_storeledlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <th data-name="StoreID" class="<?= $Page->StoreID->headerCellClass() ?>"><div id="elh_store_storeled_StoreID" class="store_storeled_StoreID"><?= $Page->renderSort($Page->StoreID) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_store_storeled_StoreID">
