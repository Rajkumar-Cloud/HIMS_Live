...
// Page object
$IvfOvumPickUpChartAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_ovum_pick_up_chartadd;
loadjs.ready("head", function () {
    ...
    fivf_ovum_pick_up_chartadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_ovum_pick_up_chartadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_ovum_pick_up_chartadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_ovum_pick_up_chartadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_ovum_pick_up_chartadd.lists.Protocol = <?= $Page->Protocol->toClientList($Page) ?>;
    fivf_ovum_pick_up_chartadd.lists.Cannulation = <?= $Page->Cannulation->toClientList($Page) ?>;
    fivf_ovum_pick_up_chartadd.lists.PlanT = <?= $Page->PlanT->toClientList($Page) ?>;
    fivf_ovum_pick_up_chartadd.lists.TemplateProcedure = <?= $Page->TemplateProcedure->toClientList($Page) ?>;
    fivf_ovum_pick_up_chartadd.lists.TemplateCourseInHospital = <?= $Page->TemplateCourseInHospital->toClientList($Page) ?>;
    fivf_ovum_pick_up_chartadd.lists.TemplateDischargeAdvise = <?= $Page->TemplateDischargeAdvise->toClientList($Page) ?>;
    fivf_ovum_pick_up_chartadd.lists.TemplateFollowUpAdvise = <?= $Page->TemplateFollowUpAdvise->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_ovum_pick_up_chartadd" id="fivf_ovum_pick_up_chartadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fivf_ovum_pick_up_chartadd", "editor"], function() {
	ew.createEditor("fivf_ovum_pick_up_chartadd", "x_ProcedureT", 35, 4, <?= $Page->ProcedureT->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_ovum_pick_up_chartadd", "editor"], function() {
	ew.createEditor("fivf_ovum_pick_up_chartadd", "x_CourseInHospital", 35, 4, <?= $Page->CourseInHospital->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_ovum_pick_up_chartadd", "editor"], function() {
	ew.createEditor("fivf_ovum_pick_up_chartadd", "x_DischargeAdvise", 35, 4, <?= $Page->DischargeAdvise->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<script>
loadjs.ready(["fivf_ovum_pick_up_chartadd", "editor"], function() {
	ew.createEditor("fivf_ovum_pick_up_chartadd", "x_FollowUpAdvise", 35, 4, <?= $Page->FollowUpAdvise->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_ivf_ovum_pick_up_chartadd">
<div id="ct_IvfOvumPickUpChartAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_ovum_pick_up_chartadd", "tpm_ivf_ovum_pick_up_chartadd", "ivf_ovum_pick_up_chartadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
