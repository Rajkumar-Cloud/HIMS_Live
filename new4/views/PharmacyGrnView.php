...
$Page->showMessage();
?>
<form name="fpharmacy_grnview" id="fpharmacy_grnview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_id"><template id="tpc_pharmacy_grn_id"><?= $Page->id->caption() ?></template></span></td>
...
<?php if ($Page->GRNNO->Visible) { // GRNNO ?>
    <tr id="r_GRNNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_GRNNO"><template id="tpc_pharmacy_grn_GRNNO"><?= $Page->GRNNO->caption() ?></template></span></td>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <tr id="r_DT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_DT"><template id="tpc_pharmacy_grn_DT"><?= $Page->DT->caption() ?></template></span></td>
...
<?php if ($Page->YM->Visible) { // YM ?>
    <tr id="r_YM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_YM"><template id="tpc_pharmacy_grn_YM"><?= $Page->YM->caption() ?></template></span></td>
...
<?php if ($Page->PC->Visible) { // PC ?>
    <tr id="r_PC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_PC"><template id="tpc_pharmacy_grn_PC"><?= $Page->PC->caption() ?></template></span></td>
...
<?php if ($Page->Customercode->Visible) { // Customercode ?>
    <tr id="r_Customercode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Customercode"><template id="tpc_pharmacy_grn_Customercode"><?= $Page->Customercode->caption() ?></template></span></td>
...
<?php if ($Page->Customername->Visible) { // Customername ?>
    <tr id="r_Customername">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Customername"><template id="tpc_pharmacy_grn_Customername"><?= $Page->Customername->caption() ?></template></span></td>
...
<?php if ($Page->pharmacy_pocol->Visible) { // pharmacy_pocol ?>
    <tr id="r_pharmacy_pocol">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_pharmacy_pocol"><template id="tpc_pharmacy_grn_pharmacy_pocol"><?= $Page->pharmacy_pocol->caption() ?></template></span></td>
...
<?php if ($Page->Address1->Visible) { // Address1 ?>
    <tr id="r_Address1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Address1"><template id="tpc_pharmacy_grn_Address1"><?= $Page->Address1->caption() ?></template></span></td>
...
<?php if ($Page->Address2->Visible) { // Address2 ?>
    <tr id="r_Address2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Address2"><template id="tpc_pharmacy_grn_Address2"><?= $Page->Address2->caption() ?></template></span></td>
...
<?php if ($Page->Address3->Visible) { // Address3 ?>
    <tr id="r_Address3">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Address3"><template id="tpc_pharmacy_grn_Address3"><?= $Page->Address3->caption() ?></template></span></td>
...
<?php if ($Page->State->Visible) { // State ?>
    <tr id="r_State">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_State"><template id="tpc_pharmacy_grn_State"><?= $Page->State->caption() ?></template></span></td>
...
<?php if ($Page->Pincode->Visible) { // Pincode ?>
    <tr id="r_Pincode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Pincode"><template id="tpc_pharmacy_grn_Pincode"><?= $Page->Pincode->caption() ?></template></span></td>
...
<?php if ($Page->Phone->Visible) { // Phone ?>
    <tr id="r_Phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Phone"><template id="tpc_pharmacy_grn_Phone"><?= $Page->Phone->caption() ?></template></span></td>
...
<?php if ($Page->Fax->Visible) { // Fax ?>
    <tr id="r_Fax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Fax"><template id="tpc_pharmacy_grn_Fax"><?= $Page->Fax->caption() ?></template></span></td>
...
<?php if ($Page->EEmail->Visible) { // EEmail ?>
    <tr id="r_EEmail">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_EEmail"><template id="tpc_pharmacy_grn_EEmail"><?= $Page->EEmail->caption() ?></template></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_HospID"><template id="tpc_pharmacy_grn_HospID"><?= $Page->HospID->caption() ?></template></span></td>
        <td data-name="HospID" <?= $Page->HospID->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_HospID"><span id="el_pharmacy_grn_HospID">
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_createdby"><template id="tpc_pharmacy_grn_createdby"><?= $Page->createdby->caption() ?></template></span></td>
        <td data-name="createdby" <?= $Page->createdby->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_createdby"><span id="el_pharmacy_grn_createdby">
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_createddatetime"><template id="tpc_pharmacy_grn_createddatetime"><?= $Page->createddatetime->caption() ?></template></span></td>
        <td data-name="createddatetime" <?= $Page->createddatetime->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_createddatetime"><span id="el_pharmacy_grn_createddatetime">
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_modifiedby"><template id="tpc_pharmacy_grn_modifiedby"><?= $Page->modifiedby->caption() ?></template></span></td>
        <td data-name="modifiedby" <?= $Page->modifiedby->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_modifiedby"><span id="el_pharmacy_grn_modifiedby">
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_modifieddatetime"><template id="tpc_pharmacy_grn_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></template></span></td>
        <td data-name="modifieddatetime" <?= $Page->modifieddatetime->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_modifieddatetime"><span id="el_pharmacy_grn_modifieddatetime">
...
<?php if ($Page->BILLNO->Visible) { // BILLNO ?>
    <tr id="r_BILLNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_BILLNO"><template id="tpc_pharmacy_grn_BILLNO"><?= $Page->BILLNO->caption() ?></template></span></td>
...
<?php if ($Page->BILLDT->Visible) { // BILLDT ?>
    <tr id="r_BILLDT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_BILLDT"><template id="tpc_pharmacy_grn_BILLDT"><?= $Page->BILLDT->caption() ?></template></span></td>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_BRCODE"><template id="tpc_pharmacy_grn_BRCODE"><?= $Page->BRCODE->caption() ?></template></span></td>
...
<?php if ($Page->PharmacyID->Visible) { // PharmacyID ?>
    <tr id="r_PharmacyID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_PharmacyID"><template id="tpc_pharmacy_grn_PharmacyID"><?= $Page->PharmacyID->caption() ?></template></span></td>
        <td data-name="PharmacyID" <?= $Page->PharmacyID->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_PharmacyID"><span id="el_pharmacy_grn_PharmacyID">
...
<?php if ($Page->BillTotalValue->Visible) { // BillTotalValue ?>
    <tr id="r_BillTotalValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_BillTotalValue"><template id="tpc_pharmacy_grn_BillTotalValue"><?= $Page->BillTotalValue->caption() ?></template></span></td>
...
<?php if ($Page->GRNTotalValue->Visible) { // GRNTotalValue ?>
    <tr id="r_GRNTotalValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_GRNTotalValue"><template id="tpc_pharmacy_grn_GRNTotalValue"><?= $Page->GRNTotalValue->caption() ?></template></span></td>
...
<?php if ($Page->BillDiscount->Visible) { // BillDiscount ?>
    <tr id="r_BillDiscount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_BillDiscount"><template id="tpc_pharmacy_grn_BillDiscount"><?= $Page->BillDiscount->caption() ?></template></span></td>
...
<?php if ($Page->BillUpload->Visible) { // BillUpload ?>
    <tr id="r_BillUpload">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_BillUpload"><template id="tpc_pharmacy_grn_BillUpload"><?= $Page->BillUpload->caption() ?></template></span></td>
...
<?php if ($Page->TransPort->Visible) { // TransPort ?>
    <tr id="r_TransPort">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_TransPort"><template id="tpc_pharmacy_grn_TransPort"><?= $Page->TransPort->caption() ?></template></span></td>
...
<?php if ($Page->AnyOther->Visible) { // AnyOther ?>
    <tr id="r_AnyOther">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_AnyOther"><template id="tpc_pharmacy_grn_AnyOther"><?= $Page->AnyOther->caption() ?></template></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Remarks"><template id="tpc_pharmacy_grn_Remarks"><?= $Page->Remarks->caption() ?></template></span></td>
...
<?php if ($Page->GrnValue->Visible) { // GrnValue ?>
    <tr id="r_GrnValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_GrnValue"><template id="tpc_pharmacy_grn_GrnValue"><?= $Page->GrnValue->caption() ?></template></span></td>
...
<?php if ($Page->Pid->Visible) { // Pid ?>
    <tr id="r_Pid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_Pid"><template id="tpc_pharmacy_grn_Pid"><?= $Page->Pid->caption() ?></template></span></td>
...
<?php if ($Page->PaymentNo->Visible) { // PaymentNo ?>
    <tr id="r_PaymentNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_PaymentNo"><template id="tpc_pharmacy_grn_PaymentNo"><?= $Page->PaymentNo->caption() ?></template></span></td>
...
<?php if ($Page->PaymentStatus->Visible) { // PaymentStatus ?>
    <tr id="r_PaymentStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_PaymentStatus"><template id="tpc_pharmacy_grn_PaymentStatus"><?= $Page->PaymentStatus->caption() ?></template></span></td>
...
<?php if ($Page->PaidAmount->Visible) { // PaidAmount ?>
    <tr id="r_PaidAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_grn_PaidAmount"><template id="tpc_pharmacy_grn_PaidAmount"><?= $Page->PaidAmount->caption() ?></template></span></td>
...
<template id="tpm_pharmacy_grnview">
<div id="ct_PharmacyGrnView"><style>
...
<?php
    if (in_array("view_pharmacygrn", explode(",", $Page->getCurrentDetailTable())) && $view_pharmacygrn->DetailView) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_grnview", "tpm_pharmacy_grnview", "pharmacy_grnview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
