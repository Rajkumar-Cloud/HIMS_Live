...
// Page object
$EmployeeDependentsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_dependentsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_dependentsadd = currentForm = new ew.Form("femployee_dependentsadd", "add");
    ...
    femployee_dependentsadd.addFields([
    ...
    // Form_CustomValidate
    femployee_dependentsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_dependentsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_dependentsadd.lists.relationship = <?= $Page->relationship->toClientList($Page) ?>;
    loadjs.done("femployee_dependentsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_dependentsadd" id="femployee_dependentsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_dependentsadd", "datetimepicker"], function() {
