...
// Page object
$StoreSuppliersAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fstore_suppliersadd;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fstore_suppliersadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fstore_suppliersadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fstore_suppliersadd" id="fstore_suppliersadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
