...
<script>
if (!ew.vars.tables.mas_where_didyou_hear) ew.vars.tables.mas_where_didyou_hear = <?= JsonEncode(GetClientVar("tables", "mas_where_didyou_hear")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fmas_where_didyou_heardelete" id="fmas_where_didyou_heardelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
