...
// Page object
$CrmLeadsubdetailsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_leadsubdetailsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcrm_leadsubdetailsadd = currentForm = new ew.Form("fcrm_leadsubdetailsadd", "add");
    ...
    fcrm_leadsubdetailsadd.addFields([
    ...
    // Form_CustomValidate
    fcrm_leadsubdetailsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_leadsubdetailsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_leadsubdetailsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_leadsubdetailsadd" id="fcrm_leadsubdetailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
