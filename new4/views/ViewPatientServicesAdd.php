...
// Page object
$ViewPatientServicesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_patient_servicesadd;
loadjs.ready("head", function () {
    ...
    fview_patient_servicesadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_patient_servicesadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_patient_servicesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_patient_servicesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_patient_servicesadd.lists.Services = <?= $Page->Services->toClientList($Page) ?>;
    fview_patient_servicesadd.lists.DiscountCategory = <?= $Page->DiscountCategory->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_patient_servicesadd" id="fview_patient_servicesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="<?= $Page->Reception->getInputTextType() ?>" data-table="view_patient_services" data-field="x_Reception" name="x_Reception" id="x_Reception" size="30" placeholder="<?= HtmlEncode($Page->Reception->getPlaceHolder()) ?>" value="<?= $Page->Reception->EditValue ?>"<?= $Page->Reception->editAttributes() ?> aria-describedby="x_Reception_help">
...
<input type="<?= $Page->mrnno->getInputTextType() ?>" data-table="view_patient_services" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->mrnno->getPlaceHolder()) ?>" value="<?= $Page->mrnno->EditValue ?>"<?= $Page->mrnno->editAttributes() ?> aria-describedby="x_mrnno_help">
...
<input type="<?= $Page->Age->getInputTextType() ?>" data-table="view_patient_services" data-field="x_Age" name="x_Age" id="x_Age" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Age->getPlaceHolder()) ?>" value="<?= $Page->Age->EditValue ?>"<?= $Page->Age->editAttributes() ?> aria-describedby="x_Age_help">
...
<input type="<?= $Page->Gender->getInputTextType() ?>" data-table="view_patient_services" data-field="x_Gender" name="x_Gender" id="x_Gender" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Gender->getPlaceHolder()) ?>" value="<?= $Page->Gender->EditValue ?>"<?= $Page->Gender->editAttributes() ?> aria-describedby="x_Gender_help">
...
<textarea data-table="view_patient_services" data-field="x_profilePic" name="x_profilePic" id="x_profilePic" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->profilePic->getPlaceHolder()) ?>"<?= $Page->profilePic->editAttributes() ?> aria-describedby="x_profilePic_help"><?= $Page->profilePic->EditValue ?></textarea>
...
loadjs.ready(["fview_patient_servicesadd"], function() {
    fview_patient_servicesadd.createAutoSuggest(Object.assign({"id":"x_Services","forceSelect":false}, ew.vars.tables.view_patient_services.fields.Services.autoSuggestOptions));
});
</script>
...
<textarea data-table="view_patient_services" data-field="x_description" name="x_description" id="x_description" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->description->getPlaceHolder()) ?>"<?= $Page->description->editAttributes() ?> aria-describedby="x_description_help"><?= $Page->description->EditValue ?></textarea>
...
<input type="<?= $Page->charged_date->getInputTextType() ?>" data-table="view_patient_services" data-field="x_charged_date" name="x_charged_date" id="x_charged_date" placeholder="<?= HtmlEncode($Page->charged_date->getPlaceHolder()) ?>" value="<?= $Page->charged_date->EditValue ?>"<?= $Page->charged_date->editAttributes() ?> aria-describedby="x_charged_date_help">
...
<input type="<?= $Page->status->getInputTextType() ?>" data-table="view_patient_services" data-field="x_status" name="x_status" id="x_status" size="30" placeholder="<?= HtmlEncode($Page->status->getPlaceHolder()) ?>" value="<?= $Page->status->EditValue ?>"<?= $Page->status->editAttributes() ?> aria-describedby="x_status_help">
...
<input type="<?= $Page->Aid->getInputTextType() ?>" data-table="view_patient_services" data-field="x_Aid" name="x_Aid" id="x_Aid" size="30" placeholder="<?= HtmlEncode($Page->Aid->getPlaceHolder()) ?>" value="<?= $Page->Aid->EditValue ?>"<?= $Page->Aid->editAttributes() ?> aria-describedby="x_Aid_help">
...
<?php } else { ?>
<span id="el_view_patient_services_Vid">
<input type="<?= $Page->Vid->getInputTextType() ?>" data-table="view_patient_services" data-field="x_Vid" name="x_Vid" id="x_Vid" size="30" placeholder="<?= HtmlEncode($Page->Vid->getPlaceHolder()) ?>" value="<?= $Page->Vid->EditValue ?>"<?= $Page->Vid->editAttributes() ?> aria-describedby="x_Vid_help">
...
<input type="<?= $Page->DrID->getInputTextType() ?>" data-table="view_patient_services" data-field="x_DrID" name="x_DrID" id="x_DrID" size="30" placeholder="<?= HtmlEncode($Page->DrID->getPlaceHolder()) ?>" value="<?= $Page->DrID->EditValue ?>"<?= $Page->DrID->editAttributes() ?> aria-describedby="x_DrID_help">
...
<input type="<?= $Page->DrCODE->getInputTextType() ?>" data-table="view_patient_services" data-field="x_DrCODE" name="x_DrCODE" id="x_DrCODE" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DrCODE->getPlaceHolder()) ?>" value="<?= $Page->DrCODE->EditValue ?>"<?= $Page->DrCODE->editAttributes() ?> aria-describedby="x_DrCODE_help">
...
<input type="<?= $Page->DrName->getInputTextType() ?>" data-table="view_patient_services" data-field="x_DrName" name="x_DrName" id="x_DrName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->DrName->getPlaceHolder()) ?>" value="<?= $Page->DrName->EditValue ?>"<?= $Page->DrName->editAttributes() ?> aria-describedby="x_DrName_help">
...
<input type="<?= $Page->TestType->getInputTextType() ?>" data-table="view_patient_services" data-field="x_TestType" name="x_TestType" id="x_TestType" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->TestType->getPlaceHolder()) ?>" value="<?= $Page->TestType->EditValue ?>"<?= $Page->TestType->editAttributes() ?> aria-describedby="x_TestType_help">
