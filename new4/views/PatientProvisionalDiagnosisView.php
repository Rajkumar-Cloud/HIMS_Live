...
<?php } ?>
<script>
if (!ew.vars.tables.patient_provisional_diagnosis) ew.vars.tables.patient_provisional_diagnosis = <?= JsonEncode(GetClientVar("tables", "patient_provisional_diagnosis")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fpatient_provisional_diagnosisview" id="fpatient_provisional_diagnosisview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_id"><template id="tpc_patient_provisional_diagnosis_id"><?= $Page->id->caption() ?></template></span></td>
        <td data-name="id" <?= $Page->id->cellAttributes() ?>>
<template id="tpx_patient_provisional_diagnosis_id"><span id="el_patient_provisional_diagnosis_id">
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_mrnno"><template id="tpc_patient_provisional_diagnosis_mrnno"><?= $Page->mrnno->caption() ?></template></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_PatientName"><template id="tpc_patient_provisional_diagnosis_PatientName"><?= $Page->PatientName->caption() ?></template></span></td>
...
<?php if ($Page->PatID->Visible) { // PatID ?>
    <tr id="r_PatID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_PatID"><template id="tpc_patient_provisional_diagnosis_PatID"><?= $Page->PatID->caption() ?></template></span></td>
...
<?php if ($Page->MobileNumber->Visible) { // MobileNumber ?>
    <tr id="r_MobileNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_MobileNumber"><template id="tpc_patient_provisional_diagnosis_MobileNumber"><?= $Page->MobileNumber->caption() ?></template></span></td>
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_Reception"><template id="tpc_patient_provisional_diagnosis_Reception"><?= $Page->Reception->caption() ?></template></span></td>
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <tr id="r_PatientId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_PatientId"><template id="tpc_patient_provisional_diagnosis_PatientId"><?= $Page->PatientId->caption() ?></template></span></td>
...
<?php if ($Page->provisional_diagnosis->Visible) { // provisional_diagnosis ?>
    <tr id="r_provisional_diagnosis">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_provisional_diagnosis"><template id="tpc_patient_provisional_diagnosis_provisional_diagnosis"><?= $Page->provisional_diagnosis->caption() ?></template></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_Age"><template id="tpc_patient_provisional_diagnosis_Age"><?= $Page->Age->caption() ?></template></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_Gender"><template id="tpc_patient_provisional_diagnosis_Gender"><?= $Page->Gender->caption() ?></template></span></td>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <tr id="r_profilePic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_profilePic"><template id="tpc_patient_provisional_diagnosis_profilePic"><?= $Page->profilePic->caption() ?></template></span></td>
...
<?php if ($Page->provisionaldiagnosisTemplate->Visible) { // provisionaldiagnosisTemplate ?>
    <tr id="r_provisionaldiagnosisTemplate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_provisionaldiagnosisTemplate"><template id="tpc_patient_provisional_diagnosis_provisionaldiagnosisTemplate"><?= $Page->provisionaldiagnosisTemplate->caption() ?></template></span></td>
        <td data-name="provisionaldiagnosisTemplate" <?= $Page->provisionaldiagnosisTemplate->cellAttributes() ?>>
...
<span<?= $Page->provisionaldiagnosisTemplate->viewAttributes() ?>>
<?= $Page->provisionaldiagnosisTemplate->getViewValue() ?></span>
</span></template>
</td>
    </tr>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_HospID"><template id="tpc_patient_provisional_diagnosis_HospID"><?= $Page->HospID->caption() ?></template></span></td>
        <td data-name="HospID" <?= $Page->HospID->cellAttributes() ?>>
<template id="tpx_patient_provisional_diagnosis_HospID"><span id="el_patient_provisional_diagnosis_HospID">
...
<?php if ($Page->PatientSearch->Visible) { // PatientSearch ?>
    <tr id="r_PatientSearch">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_provisional_diagnosis_PatientSearch"><template id="tpc_patient_provisional_diagnosis_PatientSearch"><?= $Page->PatientSearch->caption() ?></template></span></td>
...
<template id="tpm_patient_provisional_diagnosisview">
<div id="ct_PatientProvisionalDiagnosisView"><style>
...
.widget-user .widget-user-header {
	...
	?>
<div hidden>
<p id="PPatientSearch" hidden><slot class="ew-slot" name="tpc_patient_provisional_diagnosis_PatientSearch"></slot>&nbsp;<slot class="ew-slot" name="tpx_patient_provisional_diagnosis_PatientSearch"></slot></p>
</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_provisional_diagnosisview", "tpm_patient_provisional_diagnosisview", "patient_provisional_diagnosisview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
