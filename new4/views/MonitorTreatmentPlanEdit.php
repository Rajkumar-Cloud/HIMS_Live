...
// Page object
$MonitorTreatmentPlanEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fmonitor_treatment_planedit;
loadjs.ready("head", function () {
    ...
    fmonitor_treatment_planedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fmonitor_treatment_planedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fmonitor_treatment_planedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmonitor_treatment_planedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fmonitor_treatment_planedit.lists.PatId = <?= $Page->PatId->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.NewVisitYesNo = <?= $Page->NewVisitYesNo->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.Treatment = <?= $Page->Treatment->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.IUIDoneYesNo1 = <?= $Page->IUIDoneYesNo1->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.UPTTestYesNo1 = <?= $Page->UPTTestYesNo1->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.IUIDoneYesNo2 = <?= $Page->IUIDoneYesNo2->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.UPTTestYesNo2 = <?= $Page->UPTTestYesNo2->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.IUIDoneYesNo3 = <?= $Page->IUIDoneYesNo3->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.UPTTestYesNo3 = <?= $Page->UPTTestYesNo3->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.IUIDoneYesNo4 = <?= $Page->IUIDoneYesNo4->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.UPTTestYesNo4 = <?= $Page->UPTTestYesNo4->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.IVFStimulationYesNo = <?= $Page->IVFStimulationYesNo->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.OPUYesNo = <?= $Page->OPUYesNo->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.ETYesNo = <?= $Page->ETYesNo->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.BetaHCGYesNo = <?= $Page->BetaHCGYesNo->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.FETYesNo = <?= $Page->FETYesNo->toClientList($Page) ?>;
    fmonitor_treatment_planedit.lists.FBetaHCGYesNo = <?= $Page->FBetaHCGYesNo->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmonitor_treatment_planedit" id="fmonitor_treatment_planedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_monitor_treatment_plan_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_monitor_treatment_plan_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="monitor_treatment_plan" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php if ($Page->NewVisitYesNo->Visible) { // NewVisitYesNo ?>
    <div id="r_NewVisitYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_NewVisitYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->NewVisitYesNo->caption() ?><?= $Page->NewVisitYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IUIDoneYesNo1->Visible) { // IUIDoneYesNo1 ?>
    <div id="r_IUIDoneYesNo1" class="form-group row">
        <label id="elh_monitor_treatment_plan_IUIDoneYesNo1" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IUIDoneYesNo1->caption() ?><?= $Page->IUIDoneYesNo1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->UPTTestYesNo1->Visible) { // UPTTestYesNo1 ?>
    <div id="r_UPTTestYesNo1" class="form-group row">
        <label id="elh_monitor_treatment_plan_UPTTestYesNo1" class="<?= $Page->LeftColumnClass ?>"><?= $Page->UPTTestYesNo1->caption() ?><?= $Page->UPTTestYesNo1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IUIDoneYesNo2->Visible) { // IUIDoneYesNo2 ?>
    <div id="r_IUIDoneYesNo2" class="form-group row">
        <label id="elh_monitor_treatment_plan_IUIDoneYesNo2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IUIDoneYesNo2->caption() ?><?= $Page->IUIDoneYesNo2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->UPTTestYesNo2->Visible) { // UPTTestYesNo2 ?>
    <div id="r_UPTTestYesNo2" class="form-group row">
        <label id="elh_monitor_treatment_plan_UPTTestYesNo2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->UPTTestYesNo2->caption() ?><?= $Page->UPTTestYesNo2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IUIDoneYesNo3->Visible) { // IUIDoneYesNo3 ?>
    <div id="r_IUIDoneYesNo3" class="form-group row">
        <label id="elh_monitor_treatment_plan_IUIDoneYesNo3" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IUIDoneYesNo3->caption() ?><?= $Page->IUIDoneYesNo3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->UPTTestYesNo3->Visible) { // UPTTestYesNo3 ?>
    <div id="r_UPTTestYesNo3" class="form-group row">
        <label id="elh_monitor_treatment_plan_UPTTestYesNo3" class="<?= $Page->LeftColumnClass ?>"><?= $Page->UPTTestYesNo3->caption() ?><?= $Page->UPTTestYesNo3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IUIDoneYesNo4->Visible) { // IUIDoneYesNo4 ?>
    <div id="r_IUIDoneYesNo4" class="form-group row">
        <label id="elh_monitor_treatment_plan_IUIDoneYesNo4" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IUIDoneYesNo4->caption() ?><?= $Page->IUIDoneYesNo4->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->UPTTestYesNo4->Visible) { // UPTTestYesNo4 ?>
    <div id="r_UPTTestYesNo4" class="form-group row">
        <label id="elh_monitor_treatment_plan_UPTTestYesNo4" class="<?= $Page->LeftColumnClass ?>"><?= $Page->UPTTestYesNo4->caption() ?><?= $Page->UPTTestYesNo4->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IVFStimulationYesNo->Visible) { // IVFStimulationYesNo ?>
    <div id="r_IVFStimulationYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_IVFStimulationYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IVFStimulationYesNo->caption() ?><?= $Page->IVFStimulationYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->OPUYesNo->Visible) { // OPUYesNo ?>
    <div id="r_OPUYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_OPUYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->OPUYesNo->caption() ?><?= $Page->OPUYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->ETYesNo->Visible) { // ETYesNo ?>
    <div id="r_ETYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_ETYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ETYesNo->caption() ?><?= $Page->ETYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->BetaHCGYesNo->Visible) { // BetaHCGYesNo ?>
    <div id="r_BetaHCGYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_BetaHCGYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BetaHCGYesNo->caption() ?><?= $Page->BetaHCGYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->FETYesNo->Visible) { // FETYesNo ?>
    <div id="r_FETYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_FETYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FETYesNo->caption() ?><?= $Page->FETYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->FBetaHCGYesNo->Visible) { // FBetaHCGYesNo ?>
    <div id="r_FBetaHCGYesNo" class="form-group row">
        <label id="elh_monitor_treatment_plan_FBetaHCGYesNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FBetaHCGYesNo->caption() ?><?= $Page->FBetaHCGYesNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
