...
// Page object
$CrmLeadsourceAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_leadsourceadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcrm_leadsourceadd = currentForm = new ew.Form("fcrm_leadsourceadd", "add");
    ...
    // Form_CustomValidate
    fcrm_leadsourceadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_leadsourceadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_leadsourceadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_leadsourceadd" id="fcrm_leadsourceadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
