...
$Page->showMessage();
?>
<form name="fivf_vitals_historydelete" id="fivf_vitals_historydelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->DoublewitnessName1->Visible) { // DoublewitnessName1 ?>
        <th class="<?= $Page->DoublewitnessName1->headerCellClass() ?>"><span id="elh_ivf_vitals_history_DoublewitnessName1" class="ivf_vitals_history_DoublewitnessName1"><?= $Page->DoublewitnessName1->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DoublewitnessName2->Visible) { // DoublewitnessName2 ?>
        <th class="<?= $Page->DoublewitnessName2->headerCellClass() ?>"><span id="elh_ivf_vitals_history_DoublewitnessName2" class="ivf_vitals_history_DoublewitnessName2"><?= $Page->DoublewitnessName2->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
        <th class="<?= $Page->Chiefcomplaints->headerCellClass() ?>"><span id="elh_ivf_vitals_history_Chiefcomplaints" class="ivf_vitals_history_Chiefcomplaints"><?= $Page->Chiefcomplaints->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MenstrualHistory->Visible) { // MenstrualHistory ?>
        <th class="<?= $Page->MenstrualHistory->headerCellClass() ?>"><span id="elh_ivf_vitals_history_MenstrualHistory" class="ivf_vitals_history_MenstrualHistory"><?= $Page->MenstrualHistory->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ObstetricHistory->Visible) { // ObstetricHistory ?>
        <th class="<?= $Page->ObstetricHistory->headerCellClass() ?>"><span id="elh_ivf_vitals_history_ObstetricHistory" class="ivf_vitals_history_ObstetricHistory"><?= $Page->ObstetricHistory->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->AntiTPO->Visible) { // AntiTPO ?>
        <th class="<?= $Page->AntiTPO->headerCellClass() ?>"><span id="elh_ivf_vitals_history_AntiTPO" class="ivf_vitals_history_AntiTPO"><?= $Page->AntiTPO->caption() ?></span></th>
<?php } ?>
<?php if ($Page->AntiTG->Visible) { // AntiTG ?>
        <th class="<?= $Page->AntiTG->headerCellClass() ?>"><span id="elh_ivf_vitals_history_AntiTG" class="ivf_vitals_history_AntiTG"><?= $Page->AntiTG->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_DoublewitnessName1" class="ivf_vitals_history_DoublewitnessName1">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_DoublewitnessName2" class="ivf_vitals_history_DoublewitnessName2">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_Chiefcomplaints" class="ivf_vitals_history_Chiefcomplaints">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_MenstrualHistory" class="ivf_vitals_history_MenstrualHistory">
...
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_ObstetricHistory" class="ivf_vitals_history_ObstetricHistory">
...
<?php } ?>
<?php if ($Page->AntiTPO->Visible) { // AntiTPO ?>
        <td <?= $Page->AntiTPO->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_AntiTPO" class="ivf_vitals_history_AntiTPO">
...
<?php } ?>
<?php if ($Page->AntiTG->Visible) { // AntiTG ?>
        <td <?= $Page->AntiTG->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_vitals_history_AntiTG" class="ivf_vitals_history_AntiTG">
