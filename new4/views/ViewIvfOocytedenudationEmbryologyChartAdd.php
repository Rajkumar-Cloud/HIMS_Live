...
// Page object
$ViewIvfOocytedenudationEmbryologyChartAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_ivf_oocytedenudation_embryology_chartadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fview_ivf_oocytedenudation_embryology_chartadd = currentForm = new ew.Form("fview_ivf_oocytedenudation_embryology_chartadd", "add");
    ...
    fview_ivf_oocytedenudation_embryology_chartadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_ivf_oocytedenudation_embryology_chartadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_ivf_oocytedenudation_embryology_chartadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_ivf_oocytedenudation_embryology_chartadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fview_ivf_oocytedenudation_embryology_chartadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fview_ivf_oocytedenudation_embryology_chartadd" id="fview_ivf_oocytedenudation_embryology_chartadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
