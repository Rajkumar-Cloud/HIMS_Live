...
// Page object
$ViewAppointmentSchedulerNewAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_appointment_scheduler_newadd;
loadjs.ready("head", function () {
    ...
    fview_appointment_scheduler_newadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_appointment_scheduler_newadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_appointment_scheduler_newadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_appointment_scheduler_newadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_appointment_scheduler_newadd.lists.Referal = <?= $Page->Referal->toClientList($Page) ?>;
    fview_appointment_scheduler_newadd.lists.DoctorName = <?= $Page->DoctorName->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_appointment_scheduler_newadd" id="fview_appointment_scheduler_newadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fview_appointment_scheduler_newadd"], function() {
    fview_appointment_scheduler_newadd.createAutoSuggest(Object.assign({"id":"x_Referal","forceSelect":false}, ew.vars.tables.view_appointment_scheduler_new.fields.Referal.autoSuggestOptions));
});
</script>
