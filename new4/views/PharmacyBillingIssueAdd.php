...
// Page object
$PharmacyBillingIssueAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_billing_issueadd;
loadjs.ready("head", function () {
    ...
    fpharmacy_billing_issueadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpharmacy_billing_issueadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpharmacy_billing_issueadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_billing_issueadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpharmacy_billing_issueadd.lists.Reception = <?= $Page->Reception->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.ModeofPayment = <?= $Page->ModeofPayment->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.RIDNO = <?= $Page->RIDNO->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.CId = <?= $Page->CId->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.PatId = <?= $Page->PatId->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.RefferedBy = <?= $Page->RefferedBy->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.DrID = <?= $Page->DrID->toClientList($Page) ?>;
    fpharmacy_billing_issueadd.lists.ReportHeader = <?= $Page->ReportHeader->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_billing_issueadd" id="fpharmacy_billing_issueadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_pharmacy_billing_issueadd">
<div id="ct_PharmacyBillingIssueAdd"><style>
...
<?php
    if (in_array("pharmacy_pharled", explode(",", $Page->getCurrentDetailTable())) && $pharmacy_pharled->DetailAdd) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_billing_issueadd", "tpm_pharmacy_billing_issueadd", "pharmacy_billing_issueadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
