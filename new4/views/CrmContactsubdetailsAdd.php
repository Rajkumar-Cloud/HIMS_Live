...
// Page object
$CrmContactsubdetailsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_contactsubdetailsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcrm_contactsubdetailsadd = currentForm = new ew.Form("fcrm_contactsubdetailsadd", "add");
    ...
    fcrm_contactsubdetailsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fcrm_contactsubdetailsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fcrm_contactsubdetailsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_contactsubdetailsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_contactsubdetailsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_contactsubdetailsadd" id="fcrm_contactsubdetailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fcrm_contactsubdetailsadd", "datetimepicker"], function() {
