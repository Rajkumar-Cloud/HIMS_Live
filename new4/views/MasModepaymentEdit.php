...
loadjs.ready("head", function () {
    ...
    fmas_modepaymentedit.lists.BankingDatails = <?= $Page->BankingDatails->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmas_modepaymentedit" id="fmas_modepaymentedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
