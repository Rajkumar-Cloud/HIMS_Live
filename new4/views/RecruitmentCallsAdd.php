...
// Page object
$RecruitmentCallsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var frecruitment_callsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    frecruitment_callsadd = currentForm = new ew.Form("frecruitment_callsadd", "add");
    ...
    frecruitment_callsadd.addFields([
    ...
    // Form_CustomValidate
    frecruitment_callsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frecruitment_callsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("frecruitment_callsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frecruitment_callsadd" id="frecruitment_callsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["frecruitment_callsadd", "datetimepicker"], function() {
