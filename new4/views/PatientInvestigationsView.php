...
$Page->showMessage();
?>
<form name="fpatient_investigationsview" id="fpatient_investigationsview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->InvestigationMultiselect->Visible) { // InvestigationMultiselect ?>
    <tr id="r_InvestigationMultiselect">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_patient_investigations_InvestigationMultiselect"><?= $Page->InvestigationMultiselect->caption() ?></span></td>
        <td data-name="InvestigationMultiselect" <?= $Page->InvestigationMultiselect->cellAttributes() ?>>
<span id="el_patient_investigations_InvestigationMultiselect">
<span<?= $Page->InvestigationMultiselect->viewAttributes() ?>>
<?= $Page->InvestigationMultiselect->getViewValue() ?></span>
</span>
</td>
    </tr>
<?php } ?>
