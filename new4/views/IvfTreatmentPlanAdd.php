...
// Page object
$IvfTreatmentPlanAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_treatment_planadd;
loadjs.ready("head", function () {
    ...
    fivf_treatment_planadd.addFields([
    ...
    // Form_CustomValidate
    fivf_treatment_planadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_treatment_planadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_treatment_planadd.lists.treatment_status = <?= $Page->treatment_status->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.ARTCYCLE = <?= $Page->ARTCYCLE->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.RESULT = <?= $Page->RESULT->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.Treatment = <?= $Page->Treatment->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.TypeOfCycle = <?= $Page->TypeOfCycle->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.SpermOrgin = <?= $Page->SpermOrgin->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.State = <?= $Page->State->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.Origin = <?= $Page->Origin->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.MACS = <?= $Page->MACS->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.PgdPlanning = <?= $Page->PgdPlanning->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.MaleIndications = <?= $Page->MaleIndications->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.FemaleIndications = <?= $Page->FemaleIndications->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.Heterotopic = <?= $Page->Heterotopic->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.TransferDFE = <?= $Page->TransferDFE->toClientList($Page) ?>;
    fivf_treatment_planadd.lists.TineLapse = <?= $Page->TineLapse->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_treatment_planadd" id="fivf_treatment_planadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_ivf_treatment_planadd">
<div id="ct_IvfTreatmentPlanAdd"><style>
...
<?php
    if (in_array("ivf_outcome", explode(",", $Page->getCurrentDetailTable())) && $ivf_outcome->DetailAdd) {
?>
...
<?php } ?>
<?php
    if (in_array("ivf_stimulation_chart", explode(",", $Page->getCurrentDetailTable())) && $ivf_stimulation_chart->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("ivf_semenanalysisreport", explode(",", $Page->getCurrentDetailTable())) && $ivf_semenanalysisreport->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("ivf_embryology_chart", explode(",", $Page->getCurrentDetailTable())) && $ivf_embryology_chart->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_treatment_planadd", "tpm_ivf_treatment_planadd", "ivf_treatment_planadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
