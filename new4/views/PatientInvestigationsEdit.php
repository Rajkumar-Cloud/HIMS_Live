...
loadjs.ready("head", function () {
    ...
    fpatient_investigationsedit.addFields([
        ...
        ["InvestigationMultiselect", [fields.InvestigationMultiselect.visible && fields.InvestigationMultiselect.required ? ew.Validators.required(fields.InvestigationMultiselect.caption) : null], fields.InvestigationMultiselect.isInvalid]
    ]);
...
$Page->showMessage();
?>
<form name="fpatient_investigationsedit" id="fpatient_investigationsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="patient_investigations" data-field="x_Reception" data-hidden="1" name="x_Reception" id="x_Reception" value="<?= HtmlEncode($Page->Reception->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_investigations" data-field="x_PatientId" data-hidden="1" name="x_PatientId" id="x_PatientId" value="<?= HtmlEncode($Page->PatientId->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="patient_investigations" data-field="x_mrnno" data-hidden="1" name="x_mrnno" id="x_mrnno" value="<?= HtmlEncode($Page->mrnno->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<?php } ?>
<?php if ($Page->InvestigationMultiselect->Visible) { // InvestigationMultiselect ?>
    <div id="r_InvestigationMultiselect" class="form-group row">
        <label id="elh_patient_investigations_InvestigationMultiselect" for="x_InvestigationMultiselect" class="<?= $Page->LeftColumnClass ?>"><?= $Page->InvestigationMultiselect->caption() ?><?= $Page->InvestigationMultiselect->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->InvestigationMultiselect->cellAttributes() ?>>
<span id="el_patient_investigations_InvestigationMultiselect">
<input type="<?= $Page->InvestigationMultiselect->getInputTextType() ?>" data-table="patient_investigations" data-field="x_InvestigationMultiselect" name="x_InvestigationMultiselect" id="x_InvestigationMultiselect" placeholder="<?= HtmlEncode($Page->InvestigationMultiselect->getPlaceHolder()) ?>" value="<?= $Page->InvestigationMultiselect->EditValue ?>"<?= $Page->InvestigationMultiselect->editAttributes() ?> aria-describedby="x_InvestigationMultiselect_help">
<?= $Page->InvestigationMultiselect->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->InvestigationMultiselect->getErrorMessage() ?></div>
</span>
</div></div>
    </div>
<?php } ?>
