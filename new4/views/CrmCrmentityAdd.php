...
// Page object
$CrmCrmentityAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_crmentityadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcrm_crmentityadd = currentForm = new ew.Form("fcrm_crmentityadd", "add");
    ...
    // Form_CustomValidate
    fcrm_crmentityadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_crmentityadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_crmentityadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_crmentityadd" id="fcrm_crmentityadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fcrm_crmentityadd", "datetimepicker"], function() {
