...
loadjs.ready("head", function () {
    ...
    fmas_user_templateedit.lists.TemplateType = <?= $Page->TemplateType->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmas_user_templateedit" id="fmas_user_templateedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fmas_user_templateedit", "editor"], function() {
	ew.createEditor("fmas_user_templateedit", "x__Template", 35, 25, <?= $Page->_Template->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
