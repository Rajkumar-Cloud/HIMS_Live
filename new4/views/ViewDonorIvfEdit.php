...
// Page object
$ViewDonorIvfEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_donor_ivfedit;
loadjs.ready("head", function () {
    ...
    if (!ew.vars.tables.view_donor_ivf)
        ew.vars.tables.view_donor_ivf = currentTable;
    fview_donor_ivfedit.addFields([
        ...
        ["Fgender", [fields.Fgender.visible && fields.Fgender.required ? ew.Validators.required(fields.Fgender.caption) : null], fields.Fgender.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fview_donor_ivfedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_donor_ivfedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_donor_ivfedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_donor_ivfedit.lists.Female = <?= $Page->Female->toClientList($Page) ?>;
    fview_donor_ivfedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fview_donor_ivfedit.lists.ReferedBy = <?= $Page->ReferedBy->toClientList($Page) ?>;
    fview_donor_ivfedit.lists.DrID = <?= $Page->DrID->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_donor_ivfedit" id="fview_donor_ivfedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_view_donor_ivf_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<template id="tpx_view_donor_ivf_id"><span id="el_view_donor_ivf_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span></template>
<input type="hidden" data-table="view_donor_ivf" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->Female->Visible) { // Female ?>
    <div id="r_Female" class="form-group row">
        <label id="elh_view_donor_ivf_Female" for="x_Female" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_Female"><?= $Page->Female->caption() ?><?= $Page->Female->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="view_donor_ivf" data-field="x_Female" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->Female->displayValueSeparatorAttribute() ?>" name="x_Female" id="x_Female" value="<?= $Page->Female->CurrentValue ?>"<?= $Page->Female->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->status->Visible) { // status ?>
    <div id="r_status" class="form-group row">
        <label id="elh_view_donor_ivf_status" for="x_status" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_status"><?= $Page->status->caption() ?><?= $Page->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->malepropic->Visible) { // malepropic ?>
    <div id="r_malepropic" class="form-group row">
        <label id="elh_view_donor_ivf_malepropic" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_malepropic"><?= $Page->malepropic->caption() ?><?= $Page->malepropic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->malepropic->title() ?>" data-table="view_donor_ivf" data-field="x_malepropic" name="x_malepropic" id="x_malepropic" lang="<?= CurrentLanguageID() ?>"<?= $Page->malepropic->editAttributes() ?><?= ($Page->malepropic->ReadOnly || $Page->malepropic->Disabled) ? " disabled" : "" ?> aria-describedby="x_malepropic_help">
...
<?php if ($Page->femalepropic->Visible) { // femalepropic ?>
    <div id="r_femalepropic" class="form-group row">
        <label id="elh_view_donor_ivf_femalepropic" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_femalepropic"><?= $Page->femalepropic->caption() ?><?= $Page->femalepropic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->HusbandEducation->Visible) { // HusbandEducation ?>
    <div id="r_HusbandEducation" class="form-group row">
        <label id="elh_view_donor_ivf_HusbandEducation" for="x_HusbandEducation" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_HusbandEducation"><?= $Page->HusbandEducation->caption() ?><?= $Page->HusbandEducation->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->WifeEducation->Visible) { // WifeEducation ?>
    <div id="r_WifeEducation" class="form-group row">
        <label id="elh_view_donor_ivf_WifeEducation" for="x_WifeEducation" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_WifeEducation"><?= $Page->WifeEducation->caption() ?><?= $Page->WifeEducation->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->HusbandWorkHours->Visible) { // HusbandWorkHours ?>
    <div id="r_HusbandWorkHours" class="form-group row">
        <label id="elh_view_donor_ivf_HusbandWorkHours" for="x_HusbandWorkHours" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_HusbandWorkHours"><?= $Page->HusbandWorkHours->caption() ?><?= $Page->HusbandWorkHours->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->WifeWorkHours->Visible) { // WifeWorkHours ?>
    <div id="r_WifeWorkHours" class="form-group row">
        <label id="elh_view_donor_ivf_WifeWorkHours" for="x_WifeWorkHours" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_WifeWorkHours"><?= $Page->WifeWorkHours->caption() ?><?= $Page->WifeWorkHours->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PatientLanguage->Visible) { // PatientLanguage ?>
    <div id="r_PatientLanguage" class="form-group row">
        <label id="elh_view_donor_ivf_PatientLanguage" for="x_PatientLanguage" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_PatientLanguage"><?= $Page->PatientLanguage->caption() ?><?= $Page->PatientLanguage->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->ReferedBy->Visible) { // ReferedBy ?>
    <div id="r_ReferedBy" class="form-group row">
        <label id="elh_view_donor_ivf_ReferedBy" for="x_ReferedBy" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_ReferedBy"><?= $Page->ReferedBy->caption() ?><?= $Page->ReferedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="view_donor_ivf" data-field="x_ReferedBy" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->ReferedBy->displayValueSeparatorAttribute() ?>" name="x_ReferedBy" id="x_ReferedBy" value="<?= $Page->ReferedBy->CurrentValue ?>"<?= $Page->ReferedBy->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->ReferPhNo->Visible) { // ReferPhNo ?>
    <div id="r_ReferPhNo" class="form-group row">
        <label id="elh_view_donor_ivf_ReferPhNo" for="x_ReferPhNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_ReferPhNo"><?= $Page->ReferPhNo->caption() ?><?= $Page->ReferPhNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->ReferPhNo->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_ReferPhNo" name="x_ReferPhNo" id="x_ReferPhNo" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ReferPhNo->getPlaceHolder()) ?>" value="<?= $Page->ReferPhNo->EditValue ?>"<?= $Page->ReferPhNo->editAttributes() ?> aria-describedby="x_ReferPhNo_help">
...
<?php if ($Page->WifeCell->Visible) { // WifeCell ?>
    <div id="r_WifeCell" class="form-group row">
        <label id="elh_view_donor_ivf_WifeCell" for="x_WifeCell" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_WifeCell"><?= $Page->WifeCell->caption() ?><?= $Page->WifeCell->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->WifeCell->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_WifeCell" name="x_WifeCell" id="x_WifeCell" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->WifeCell->getPlaceHolder()) ?>" value="<?= $Page->WifeCell->EditValue ?>"<?= $Page->WifeCell->editAttributes() ?> aria-describedby="x_WifeCell_help">
...
<?php if ($Page->HusbandCell->Visible) { // HusbandCell ?>
    <div id="r_HusbandCell" class="form-group row">
        <label id="elh_view_donor_ivf_HusbandCell" for="x_HusbandCell" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_HusbandCell"><?= $Page->HusbandCell->caption() ?><?= $Page->HusbandCell->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->WifeEmail->Visible) { // WifeEmail ?>
    <div id="r_WifeEmail" class="form-group row">
        <label id="elh_view_donor_ivf_WifeEmail" for="x_WifeEmail" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_WifeEmail"><?= $Page->WifeEmail->caption() ?><?= $Page->WifeEmail->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->WifeEmail->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_WifeEmail" name="x_WifeEmail" id="x_WifeEmail" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->WifeEmail->getPlaceHolder()) ?>" value="<?= $Page->WifeEmail->EditValue ?>"<?= $Page->WifeEmail->editAttributes() ?> aria-describedby="x_WifeEmail_help">
...
<?php if ($Page->HusbandEmail->Visible) { // HusbandEmail ?>
    <div id="r_HusbandEmail" class="form-group row">
        <label id="elh_view_donor_ivf_HusbandEmail" for="x_HusbandEmail" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_HusbandEmail"><?= $Page->HusbandEmail->caption() ?><?= $Page->HusbandEmail->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->ARTCYCLE->Visible) { // ARTCYCLE ?>
    <div id="r_ARTCYCLE" class="form-group row">
        <label id="elh_view_donor_ivf_ARTCYCLE" for="x_ARTCYCLE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_ARTCYCLE"><?= $Page->ARTCYCLE->caption() ?><?= $Page->ARTCYCLE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->ARTCYCLE->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_ARTCYCLE" name="x_ARTCYCLE" id="x_ARTCYCLE" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ARTCYCLE->getPlaceHolder()) ?>" value="<?= $Page->ARTCYCLE->EditValue ?>"<?= $Page->ARTCYCLE->editAttributes() ?> aria-describedby="x_ARTCYCLE_help">
...
<?php if ($Page->RESULT->Visible) { // RESULT ?>
    <div id="r_RESULT" class="form-group row">
        <label id="elh_view_donor_ivf_RESULT" for="x_RESULT" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_RESULT"><?= $Page->RESULT->caption() ?><?= $Page->RESULT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->RESULT->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_RESULT" name="x_RESULT" id="x_RESULT" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->RESULT->getPlaceHolder()) ?>" value="<?= $Page->RESULT->EditValue ?>"<?= $Page->RESULT->editAttributes() ?> aria-describedby="x_RESULT_help">
...
<?php if ($Page->CoupleID->Visible) { // CoupleID ?>
    <div id="r_CoupleID" class="form-group row">
        <label id="elh_view_donor_ivf_CoupleID" for="x_CoupleID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_CoupleID"><?= $Page->CoupleID->caption() ?><?= $Page->CoupleID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->CoupleID->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_CoupleID" name="x_CoupleID" id="x_CoupleID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->CoupleID->getPlaceHolder()) ?>" value="<?= $Page->CoupleID->EditValue ?>"<?= $Page->CoupleID->editAttributes() ?> aria-describedby="x_CoupleID_help">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <div id="r_HospID" class="form-group row">
        <label id="elh_view_donor_ivf_HospID" for="x_HospID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_HospID"><?= $Page->HospID->caption() ?><?= $Page->HospID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->HospID->cellAttributes() ?>>
<template id="tpx_view_donor_ivf_HospID"><span id="el_view_donor_ivf_HospID">
<input type="<?= $Page->HospID->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_HospID" name="x_HospID" id="x_HospID" size="30" placeholder="<?= HtmlEncode($Page->HospID->getPlaceHolder()) ?>" value="<?= $Page->HospID->EditValue ?>"<?= $Page->HospID->editAttributes() ?> aria-describedby="x_HospID_help">
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <div id="r_PatientName" class="form-group row">
        <label id="elh_view_donor_ivf_PatientName" for="x_PatientName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_PatientName"><?= $Page->PatientName->caption() ?><?= $Page->PatientName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientName->cellAttributes() ?>>
<template id="tpx_view_donor_ivf_PatientName"><span id="el_view_donor_ivf_PatientName">
<input type="<?= $Page->PatientName->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_PatientName" name="x_PatientName" id="x_PatientName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PatientName->getPlaceHolder()) ?>" value="<?= $Page->PatientName->EditValue ?>"<?= $Page->PatientName->editAttributes() ?> aria-describedby="x_PatientName_help">
...
<?php if ($Page->PatientID->Visible) { // PatientID ?>
    <div id="r_PatientID" class="form-group row">
        <label id="elh_view_donor_ivf_PatientID" for="x_PatientID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_PatientID"><?= $Page->PatientID->caption() ?><?= $Page->PatientID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientID->cellAttributes() ?>>
<template id="tpx_view_donor_ivf_PatientID"><span id="el_view_donor_ivf_PatientID">
<input type="<?= $Page->PatientID->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_PatientID" name="x_PatientID" id="x_PatientID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PatientID->getPlaceHolder()) ?>" value="<?= $Page->PatientID->EditValue ?>"<?= $Page->PatientID->editAttributes() ?> aria-describedby="x_PatientID_help">
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <div id="r_PartnerName" class="form-group row">
        <label id="elh_view_donor_ivf_PartnerName" for="x_PartnerName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_PartnerName"><?= $Page->PartnerName->caption() ?><?= $Page->PartnerName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PartnerID->Visible) { // PartnerID ?>
    <div id="r_PartnerID" class="form-group row">
        <label id="elh_view_donor_ivf_PartnerID" for="x_PartnerID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_PartnerID"><?= $Page->PartnerID->caption() ?><?= $Page->PartnerID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PartnerID->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_PartnerID" name="x_PartnerID" id="x_PartnerID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PartnerID->getPlaceHolder()) ?>" value="<?= $Page->PartnerID->EditValue ?>"<?= $Page->PartnerID->editAttributes() ?> aria-describedby="x_PartnerID_help">
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <div id="r_DrID" class="form-group row">
        <label id="elh_view_donor_ivf_DrID" for="x_DrID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_DrID"><?= $Page->DrID->caption() ?><?= $Page->DrID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" data-table="view_donor_ivf" data-field="x_DrID" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->DrID->displayValueSeparatorAttribute() ?>" name="x_DrID" id="x_DrID" value="<?= $Page->DrID->CurrentValue ?>"<?= $Page->DrID->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
    <div id="r_DrDepartment" class="form-group row">
        <label id="elh_view_donor_ivf_DrDepartment" for="x_DrDepartment" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_DrDepartment"><?= $Page->DrDepartment->caption() ?><?= $Page->DrDepartment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Doctor->Visible) { // Doctor ?>
    <div id="r_Doctor" class="form-group row">
        <label id="elh_view_donor_ivf_Doctor" for="x_Doctor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_Doctor"><?= $Page->Doctor->caption() ?><?= $Page->Doctor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Doctor->getInputTextType() ?>" data-table="view_donor_ivf" data-field="x_Doctor" name="x_Doctor" id="x_Doctor" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Doctor->getPlaceHolder()) ?>" value="<?= $Page->Doctor->EditValue ?>"<?= $Page->Doctor->editAttributes() ?> aria-describedby="x_Doctor_help">
...
<?php if ($Page->femalepic->Visible) { // femalepic ?>
    <div id="r_femalepic" class="form-group row">
        <label id="elh_view_donor_ivf_femalepic" for="x_femalepic" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_femalepic"><?= $Page->femalepic->caption() ?><?= $Page->femalepic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->femalepic->cellAttributes() ?>>
<template id="tpx_view_donor_ivf_femalepic"><span id="el_view_donor_ivf_femalepic">
<textarea data-table="view_donor_ivf" data-field="x_femalepic" name="x_femalepic" id="x_femalepic" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->femalepic->getPlaceHolder()) ?>"<?= $Page->femalepic->editAttributes() ?> aria-describedby="x_femalepic_help"><?= $Page->femalepic->EditValue ?></textarea>
...
<?php if ($Page->Fgender->Visible) { // Fgender ?>
    <div id="r_Fgender" class="form-group row">
        <label id="elh_view_donor_ivf_Fgender" for="x_Fgender" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_donor_ivf_Fgender"><?= $Page->Fgender->caption() ?><?= $Page->Fgender->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Fgender->cellAttributes() ?>>
<template id="tpx_view_donor_ivf_Fgender"><span id="el_view_donor_ivf_Fgender">
<textarea data-table="view_donor_ivf" data-field="x_Fgender" name="x_Fgender" id="x_Fgender" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Fgender->getPlaceHolder()) ?>"<?= $Page->Fgender->editAttributes() ?> aria-describedby="x_Fgender_help"><?= $Page->Fgender->EditValue ?></textarea>
<?= $Page->Fgender->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->Fgender->getErrorMessage() ?></div>
</span></template>
</div></div>
    </div>
<?php } ?>
...
<template id="tpm_view_donor_ivfedit">
<div id="ct_ViewDonorIvfEdit"><style>
...
?>	
				   ...
				   <slot class="ew-slot" name="tpx_malepic"></slot>
				   <slot class="ew-slot" name="tpx_Mgendar"></slot>
				   <slot class="ew-slot" name="tpc_view_donor_ivf_PartnerName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_PartnerName"></slot>
				   <slot class="ew-slot" name="tpc_view_donor_ivf_PartnerID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_PartnerID"></slot>
				   <slot class="ew-slot" name="tpc_view_donor_ivf_WifeCell"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_WifeCell"></slot>
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_malepropic"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_malepropic"></slot></span>
				  </div>
				   <div class="ew-row" style="display: none;">
				   <slot class="ew-slot" name="tpc_view_donor_ivf_femalepic"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_femalepic"></slot>
				   <slot class="ew-slot" name="tpx_Fgendar"></slot>
				   <slot class="ew-slot" name="tpc_view_donor_ivf_PatientName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_PatientName"></slot>
				   <slot class="ew-slot" name="tpc_view_donor_ivf_PatientID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_PatientID"></slot>
				   <slot class="ew-slot" name="tpc_view_donor_ivf_HusbandCell"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_HusbandCell"></slot>
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_femalepropic"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_femalepropic"></slot></span>
				  </div>
<script>
...
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body card-widget widget-user">
				 <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_Female"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_Female"></slot></span>
				  </div>
			<div class="widget-user-image">
				  ...
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_WifeEducation"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_WifeEducation"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_WifeWorkHours"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_WifeWorkHours"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_WifeCell"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_WifeCell"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_WifeEmail"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_WifeEmail"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>
	...
	<div style="visibility: hidden" class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body card-widget widget-user">
				<div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_Male"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_Male"></slot></span>
				  </div>
			<div class="widget-user-image">
			   		<img id="maleprofilePicturePatient" class="img-circle elevation-2" src='<?php echo "uploads/".$results1[0]["profilePic"]; ?>' alt="User Avatar"> 
			  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_HusbandEducation"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_HusbandEducation"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_HusbandWorkHours"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_HusbandWorkHours"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_HusbandCell"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_HusbandCell"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_HusbandEmail"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_HusbandEmail"></slot></span>
				  </div>
				  			  <!-- /.card-body -->
			</div>
		</div>				
...
<table class="ew-table">
	 <tbody>
		 <tr>
		 	<td><slot class="ew-slot" name="tpc_view_donor_ivf_DrID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_DrID"></slot></td>
			<td><slot class="ew-slot" name="tpc_view_donor_ivf_Doctor"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_Doctor"></slot></td>
			<td><slot class="ew-slot" name="tpc_view_donor_ivf_DrDepartment"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_DrDepartment"></slot></td>
		</tr>
	  </tbody>
</table>
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
 <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_PatientLanguage"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_PatientLanguage"></slot></span>
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_ReferedBy"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_ReferedBy"></slot></span>
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_ReferPhNo"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_ReferPhNo"></slot></span>
</div>
	</div>
		</div>
	</div>
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_view_donor_ivf_status"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_donor_ivf_status"></slot></span>
				  </div>
	</div>
		</div>				
	</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_donor_ivfedit", "tpm_view_donor_ivfedit", "view_donor_ivfedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
