...
loadjs.ready("head", function () {
    ...
    fpres_indicationstableedit.addFields([
        ["Sno", [fields.Sno.visible && fields.Sno.required ? ew.Validators.required(fields.Sno.caption) : null], fields.Sno.isInvalid],
...
$Page->showMessage();
?>
<form name="fpres_indicationstableedit" id="fpres_indicationstableedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
