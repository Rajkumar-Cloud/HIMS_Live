...
<script>
if (!ew.vars.tables.pres_indicationstable) ew.vars.tables.pres_indicationstable = <?= JsonEncode(GetClientVar("tables", "pres_indicationstable")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fpres_indicationstabledelete" id="fpres_indicationstabledelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Indications->Visible) { // Indications ?>
        <th class="<?= $Page->Indications->headerCellClass() ?>"><span id="elh_pres_indicationstable_Indications" class="pres_indicationstable_Indications"><?= $Page->Indications->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->Contraindications->Visible) { // Contraindications ?>
        <th class="<?= $Page->Contraindications->headerCellClass() ?>"><span id="elh_pres_indicationstable_Contraindications" class="pres_indicationstable_Contraindications"><?= $Page->Contraindications->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->Indications->Visible) { // Indications ?>
        <td <?= $Page->Indications->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pres_indicationstable_Indications" class="pres_indicationstable_Indications">
...
<span id="el<?= $Page->RowCount ?>_pres_indicationstable_Contraindications" class="pres_indicationstable_Contraindications">
