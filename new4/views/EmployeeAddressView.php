...
$Page->showMessage();
?>
<form name="femployee_addressview" id="femployee_addressview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_address_HospID"><?= $Page->HospID->caption() ?></span></td>
