...
$Page->showMessage();
?>
<form name="fpharmacy_purchase_request_itemsdelete" id="fpharmacy_purchase_request_itemsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
