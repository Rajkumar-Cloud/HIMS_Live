...
loadjs.ready("head", function () {
    ...
    femployee_addressedit.lists.address_type = <?= $Page->address_type->toClientList($Page) ?>;
    femployee_addressedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="femployee_addressedit" id="femployee_addressedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
