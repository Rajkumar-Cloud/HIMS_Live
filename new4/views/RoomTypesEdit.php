...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "room_types")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.room_types)
        ew.vars.tables.room_types = currentTable;
    froom_typesedit.addFields([
        ["Id", [fields.Id.visible && fields.Id.required ? ew.Validators.required(fields.Id.caption) : null], fields.Id.isInvalid],
        ["Types", [fields.Types.visible && fields.Types.required ? ew.Validators.required(fields.Types.caption) : null], fields.Types.isInvalid]
    ]);
...
$Page->showMessage();
?>
<form name="froom_typesedit" id="froom_typesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
