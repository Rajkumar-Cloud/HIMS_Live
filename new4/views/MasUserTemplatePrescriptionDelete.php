...
<script>
if (!ew.vars.tables.mas_user_template_prescription) ew.vars.tables.mas_user_template_prescription = <?= JsonEncode(GetClientVar("tables", "mas_user_template_prescription")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fmas_user_template_prescriptiondelete" id="fmas_user_template_prescriptiondelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
