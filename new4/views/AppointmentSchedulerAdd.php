...
loadjs.ready("head", function () {
    ...
    fappointment_scheduleradd.lists.patientID = <?= $Page->patientID->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.DoctorName = <?= $Page->DoctorName->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.appointment_type = <?= $Page->appointment_type->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.Notified = <?= $Page->Notified->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.PatientType = <?= $Page->PatientType->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.Referal = <?= $Page->Referal->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.tittle = <?= $Page->tittle->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.gendar = <?= $Page->gendar->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.WhereDidYouHear = <?= $Page->WhereDidYouHear->toClientList($Page) ?>;
    fappointment_scheduleradd.lists.PatientTypee = <?= $Page->PatientTypee->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fappointment_scheduleradd" id="fappointment_scheduleradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_appointment_scheduleradd">
<div id="ct_AppointmentSchedulerAdd"><style type="text/css" >
.form-control {
	display: table;
	max-width: none;
}
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_appointment_scheduleradd", "tpm_appointment_scheduleradd", "appointment_scheduleradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
