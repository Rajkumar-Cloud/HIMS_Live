...
loadjs.ready("head", function () {
    ...
    fmas_activity_cardedit.lists.Selected = <?= $Page->Selected->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmas_activity_cardedit" id="fmas_activity_cardedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
