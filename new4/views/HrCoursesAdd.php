...
loadjs.ready("head", function () {
    ...
    fhr_coursesadd = currentForm = new ew.Form("fhr_coursesadd", "add");
    ...
    // Form_CustomValidate
    fhr_coursesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_coursesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhr_coursesadd.lists.paymentType = <?= $Page->paymentType->toClientList($Page) ?>;
    fhr_coursesadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("fhr_coursesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_coursesadd" id="fhr_coursesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fhr_coursesadd", "datetimepicker"], function() {
