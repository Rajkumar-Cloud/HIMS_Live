...
<form name="fpres_fluidformulationlistsrch" id="fpres_fluidformulationlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpres_fluidformulationlist" id="fpres_fluidformulationlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Tradename->Visible) { // Tradename ?>
        <th data-name="Tradename" class="<?= $Page->Tradename->headerCellClass() ?>"><div id="elh_pres_fluidformulation_Tradename" class="pres_fluidformulation_Tradename"><?= $Page->renderSort($Page->Tradename) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_pres_fluidformulation_Tradename">
