...
loadjs.ready("head", function () {
    ...
    femployee_documentadd.lists.DocumentName = <?= $Page->DocumentName->toClientList($Page) ?>;
    femployee_documentadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="femployee_documentadd" id="femployee_documentadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
