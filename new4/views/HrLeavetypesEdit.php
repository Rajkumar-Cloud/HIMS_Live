...
// Page object
$HrLeavetypesEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fhr_leavetypesedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fhr_leavetypesedit = currentForm = new ew.Form("fhr_leavetypesedit", "edit");
    ...
    // Form_CustomValidate
    fhr_leavetypesedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_leavetypesedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhr_leavetypesedit.lists.supervisor_leave_assign = <?= $Page->supervisor_leave_assign->toClientList($Page) ?>;
    fhr_leavetypesedit.lists.employee_can_apply = <?= $Page->employee_can_apply->toClientList($Page) ?>;
    fhr_leavetypesedit.lists.apply_beyond_current = <?= $Page->apply_beyond_current->toClientList($Page) ?>;
    fhr_leavetypesedit.lists.leave_accrue = <?= $Page->leave_accrue->toClientList($Page) ?>;
    fhr_leavetypesedit.lists.carried_forward = <?= $Page->carried_forward->toClientList($Page) ?>;
    fhr_leavetypesedit.lists.propotionate_on_joined_date = <?= $Page->propotionate_on_joined_date->toClientList($Page) ?>;
    fhr_leavetypesedit.lists.send_notification_emails = <?= $Page->send_notification_emails->toClientList($Page) ?>;
    loadjs.done("fhr_leavetypesedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_leavetypesedit" id="fhr_leavetypesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_hr_leavetypes_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_hr_leavetypes_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="hr_leavetypes" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
