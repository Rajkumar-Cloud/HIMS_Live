...
// Page object
$ViewVitalsHistoryEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_vitals_historyedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fview_vitals_historyedit = currentForm = new ew.Form("fview_vitals_historyedit", "edit");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "view_vitals_history")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.view_vitals_history)
        ew.vars.tables.view_vitals_history = currentTable;
    fview_vitals_historyedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_vitals_historyedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_vitals_historyedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_vitals_historyedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_vitals_historyedit.lists.MedicalHistory = <?= $Page->MedicalHistory->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FBloodgroup = <?= $Page->FBloodgroup->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.MBloodgroup = <?= $Page->MBloodgroup->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FBuild = <?= $Page->FBuild->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.MBuild = <?= $Page->MBuild->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FSkinColor = <?= $Page->FSkinColor->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.MSkinColor = <?= $Page->MSkinColor->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FEyesColor = <?= $Page->FEyesColor->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.MEyesColor = <?= $Page->MEyesColor->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FHairColor = <?= $Page->FHairColor->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.MhairColor = <?= $Page->MhairColor->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FhairTexture = <?= $Page->FhairTexture->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.MHairTexture = <?= $Page->MHairTexture->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.FamilyHistory = <?= $Page->FamilyHistory->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.Addictions = <?= $Page->Addictions->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.Medical = <?= $Page->Medical->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.Surgical = <?= $Page->Surgical->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.CoitalHistory = <?= $Page->CoitalHistory->toClientList($Page) ?>;
    fview_vitals_historyedit.lists.pFamilyHistory = <?= $Page->pFamilyHistory->toClientList($Page) ?>;
    loadjs.done("fview_vitals_historyedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fview_vitals_historyedit" id="fview_vitals_historyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_view_vitals_history_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<template id="tpx_view_vitals_history_id"><span id="el_view_vitals_history_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span></template>
<input type="hidden" data-table="view_vitals_history" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <div id="r_RIDNO" class="form-group row">
        <label id="elh_view_vitals_history_RIDNO" for="x_RIDNO" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_RIDNO"><?= $Page->RIDNO->caption() ?><?= $Page->RIDNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->RIDNO->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_RIDNO" name="x_RIDNO" id="x_RIDNO" size="30" placeholder="<?= HtmlEncode($Page->RIDNO->getPlaceHolder()) ?>" value="<?= $Page->RIDNO->EditValue ?>"<?= $Page->RIDNO->editAttributes() ?> aria-describedby="x_RIDNO_help">
...
<?php if ($Page->Name->Visible) { // Name ?>
    <div id="r_Name" class="form-group row">
        <label id="elh_view_vitals_history_Name" for="x_Name" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Name"><?= $Page->Name->caption() ?><?= $Page->Name->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Name->cellAttributes() ?>>
<template id="tpx_view_vitals_history_Name"><span id="el_view_vitals_history_Name">
<input type="<?= $Page->Name->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Name" name="x_Name" id="x_Name" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Name->getPlaceHolder()) ?>" value="<?= $Page->Name->EditValue ?>"<?= $Page->Name->editAttributes() ?> aria-describedby="x_Name_help">
...
<?php if ($Page->Age->Visible) { // Age ?>
    <div id="r_Age" class="form-group row">
        <label id="elh_view_vitals_history_Age" for="x_Age" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Age"><?= $Page->Age->caption() ?><?= $Page->Age->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Age->cellAttributes() ?>>
<template id="tpx_view_vitals_history_Age"><span id="el_view_vitals_history_Age">
<input type="<?= $Page->Age->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Age" name="x_Age" id="x_Age" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Age->getPlaceHolder()) ?>" value="<?= $Page->Age->EditValue ?>"<?= $Page->Age->editAttributes() ?> aria-describedby="x_Age_help">
...
<?php if ($Page->SEX->Visible) { // SEX ?>
    <div id="r_SEX" class="form-group row">
        <label id="elh_view_vitals_history_SEX" for="x_SEX" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_SEX"><?= $Page->SEX->caption() ?><?= $Page->SEX->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->SEX->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_SEX" name="x_SEX" id="x_SEX" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->SEX->getPlaceHolder()) ?>" value="<?= $Page->SEX->EditValue ?>"<?= $Page->SEX->editAttributes() ?> aria-describedby="x_SEX_help">
...
<?php if ($Page->Religion->Visible) { // Religion ?>
    <div id="r_Religion" class="form-group row">
        <label id="elh_view_vitals_history_Religion" for="x_Religion" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Religion"><?= $Page->Religion->caption() ?><?= $Page->Religion->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Religion->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Religion" name="x_Religion" id="x_Religion" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Religion->getPlaceHolder()) ?>" value="<?= $Page->Religion->EditValue ?>"<?= $Page->Religion->editAttributes() ?> aria-describedby="x_Religion_help">
...
<?php if ($Page->Address->Visible) { // Address ?>
    <div id="r_Address" class="form-group row">
        <label id="elh_view_vitals_history_Address" for="x_Address" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Address"><?= $Page->Address->caption() ?><?= $Page->Address->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address->cellAttributes() ?>>
<template id="tpx_view_vitals_history_Address"><span id="el_view_vitals_history_Address">
<input type="<?= $Page->Address->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Address" name="x_Address" id="x_Address" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Address->getPlaceHolder()) ?>" value="<?= $Page->Address->EditValue ?>"<?= $Page->Address->editAttributes() ?> aria-describedby="x_Address_help">
...
<?php if ($Page->IdentificationMark->Visible) { // IdentificationMark ?>
    <div id="r_IdentificationMark" class="form-group row">
        <label id="elh_view_vitals_history_IdentificationMark" for="x_IdentificationMark" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_IdentificationMark"><?= $Page->IdentificationMark->caption() ?><?= $Page->IdentificationMark->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->DoublewitnessName1->Visible) { // DoublewitnessName1 ?>
    <div id="r_DoublewitnessName1" class="form-group row">
        <label id="elh_view_vitals_history_DoublewitnessName1" for="x_DoublewitnessName1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_DoublewitnessName1"><?= $Page->DoublewitnessName1->caption() ?><?= $Page->DoublewitnessName1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->DoublewitnessName2->Visible) { // DoublewitnessName2 ?>
    <div id="r_DoublewitnessName2" class="form-group row">
        <label id="elh_view_vitals_history_DoublewitnessName2" for="x_DoublewitnessName2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_DoublewitnessName2"><?= $Page->DoublewitnessName2->caption() ?><?= $Page->DoublewitnessName2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
    <div id="r_Chiefcomplaints" class="form-group row">
        <label id="elh_view_vitals_history_Chiefcomplaints" for="x_Chiefcomplaints" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Chiefcomplaints"><?= $Page->Chiefcomplaints->caption() ?><?= $Page->Chiefcomplaints->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->MenstrualHistory->Visible) { // MenstrualHistory ?>
    <div id="r_MenstrualHistory" class="form-group row">
        <label id="elh_view_vitals_history_MenstrualHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MenstrualHistory"><?= $Page->MenstrualHistory->caption() ?><?= $Page->MenstrualHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_MenstrualHistory", 0, 0, <?= $Page->MenstrualHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->ObstetricHistory->Visible) { // ObstetricHistory ?>
    <div id="r_ObstetricHistory" class="form-group row">
        <label id="elh_view_vitals_history_ObstetricHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_ObstetricHistory"><?= $Page->ObstetricHistory->caption() ?><?= $Page->ObstetricHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_ObstetricHistory", 0, 0, <?= $Page->ObstetricHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->MedicalHistory->Visible) { // MedicalHistory ?>
    <div id="r_MedicalHistory" class="form-group row">
        <label id="elh_view_vitals_history_MedicalHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MedicalHistory"><?= $Page->MedicalHistory->caption() ?><?= $Page->MedicalHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_view_vitals_history_MedicalHistory"><span id="el_view_vitals_history_MedicalHistory">
    <select
        ...
        data-select2-id="view_vitals_history_x_MedicalHistory[]"
        data-table="view_vitals_history"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_vitals_history_x_MedicalHistory[]']"),
        options = { name: "x_MedicalHistory[]", selectId: "view_vitals_history_x_MedicalHistory[]", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.multiple = true;
    options.closeOnSelect = false;
    options.data = ew.vars.tables.view_vitals_history.fields.MedicalHistory.lookupOptions;
    ...
    Object.assign(options, ew.vars.tables.view_vitals_history.fields.MedicalHistory.selectOptions);
...
<?php if ($Page->SurgicalHistory->Visible) { // SurgicalHistory ?>
    <div id="r_SurgicalHistory" class="form-group row">
        <label id="elh_view_vitals_history_SurgicalHistory" for="x_SurgicalHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_SurgicalHistory"><?= $Page->SurgicalHistory->caption() ?><?= $Page->SurgicalHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Generalexaminationpallor->Visible) { // Generalexaminationpallor ?>
    <div id="r_Generalexaminationpallor" class="form-group row">
        <label id="elh_view_vitals_history_Generalexaminationpallor" for="x_Generalexaminationpallor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Generalexaminationpallor"><?= $Page->Generalexaminationpallor->caption() ?><?= $Page->Generalexaminationpallor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PR->Visible) { // PR ?>
    <div id="r_PR" class="form-group row">
        <label id="elh_view_vitals_history_PR" for="x_PR" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PR"><?= $Page->PR->caption() ?><?= $Page->PR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PR->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PR" name="x_PR" id="x_PR" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PR->getPlaceHolder()) ?>" value="<?= $Page->PR->EditValue ?>"<?= $Page->PR->editAttributes() ?> aria-describedby="x_PR_help">
...
<?php if ($Page->CVS->Visible) { // CVS ?>
    <div id="r_CVS" class="form-group row">
        <label id="elh_view_vitals_history_CVS" for="x_CVS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_CVS"><?= $Page->CVS->caption() ?><?= $Page->CVS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->CVS->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_CVS" name="x_CVS" id="x_CVS" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->CVS->getPlaceHolder()) ?>" value="<?= $Page->CVS->EditValue ?>"<?= $Page->CVS->editAttributes() ?> aria-describedby="x_CVS_help">
...
<?php if ($Page->PA->Visible) { // PA ?>
    <div id="r_PA" class="form-group row">
        <label id="elh_view_vitals_history_PA" for="x_PA" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PA"><?= $Page->PA->caption() ?><?= $Page->PA->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PA->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PA" name="x_PA" id="x_PA" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PA->getPlaceHolder()) ?>" value="<?= $Page->PA->EditValue ?>"<?= $Page->PA->editAttributes() ?> aria-describedby="x_PA_help">
...
<?php if ($Page->PROVISIONALDIAGNOSIS->Visible) { // PROVISIONALDIAGNOSIS ?>
    <div id="r_PROVISIONALDIAGNOSIS" class="form-group row">
        <label id="elh_view_vitals_history_PROVISIONALDIAGNOSIS" for="x_PROVISIONALDIAGNOSIS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PROVISIONALDIAGNOSIS"><?= $Page->PROVISIONALDIAGNOSIS->caption() ?><?= $Page->PROVISIONALDIAGNOSIS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Investigations->Visible) { // Investigations ?>
    <div id="r_Investigations" class="form-group row">
        <label id="elh_view_vitals_history_Investigations" for="x_Investigations" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Investigations"><?= $Page->Investigations->caption() ?><?= $Page->Investigations->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Fheight->Visible) { // Fheight ?>
    <div id="r_Fheight" class="form-group row">
        <label id="elh_view_vitals_history_Fheight" for="x_Fheight" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Fheight"><?= $Page->Fheight->caption() ?><?= $Page->Fheight->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Fheight->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Fheight" name="x_Fheight" id="x_Fheight" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Fheight->getPlaceHolder()) ?>" value="<?= $Page->Fheight->EditValue ?>"<?= $Page->Fheight->editAttributes() ?> aria-describedby="x_Fheight_help">
...
<?php if ($Page->Fweight->Visible) { // Fweight ?>
    <div id="r_Fweight" class="form-group row">
        <label id="elh_view_vitals_history_Fweight" for="x_Fweight" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Fweight"><?= $Page->Fweight->caption() ?><?= $Page->Fweight->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Fweight->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Fweight" name="x_Fweight" id="x_Fweight" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Fweight->getPlaceHolder()) ?>" value="<?= $Page->Fweight->EditValue ?>"<?= $Page->Fweight->editAttributes() ?> aria-describedby="x_Fweight_help">
...
<?php if ($Page->FBMI->Visible) { // FBMI ?>
    <div id="r_FBMI" class="form-group row">
        <label id="elh_view_vitals_history_FBMI" for="x_FBMI" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FBMI"><?= $Page->FBMI->caption() ?><?= $Page->FBMI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->FBMI->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_FBMI" name="x_FBMI" id="x_FBMI" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->FBMI->getPlaceHolder()) ?>" value="<?= $Page->FBMI->EditValue ?>"<?= $Page->FBMI->editAttributes() ?> aria-describedby="x_FBMI_help">
...
<?php if ($Page->FBloodgroup->Visible) { // FBloodgroup ?>
    <div id="r_FBloodgroup" class="form-group row">
        <label id="elh_view_vitals_history_FBloodgroup" for="x_FBloodgroup" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FBloodgroup"><?= $Page->FBloodgroup->caption() ?><?= $Page->FBloodgroup->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="view_vitals_history_x_FBloodgroup"
        data-table="view_vitals_history"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_vitals_history_x_FBloodgroup']"),
        options = { name: "x_FBloodgroup", selectId: "view_vitals_history_x_FBloodgroup", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.view_vitals_history.fields.FBloodgroup.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->Mheight->Visible) { // Mheight ?>
    <div id="r_Mheight" class="form-group row">
        <label id="elh_view_vitals_history_Mheight" for="x_Mheight" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Mheight"><?= $Page->Mheight->caption() ?><?= $Page->Mheight->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Mheight->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Mheight" name="x_Mheight" id="x_Mheight" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Mheight->getPlaceHolder()) ?>" value="<?= $Page->Mheight->EditValue ?>"<?= $Page->Mheight->editAttributes() ?> aria-describedby="x_Mheight_help">
...
<?php if ($Page->Mweight->Visible) { // Mweight ?>
    <div id="r_Mweight" class="form-group row">
        <label id="elh_view_vitals_history_Mweight" for="x_Mweight" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Mweight"><?= $Page->Mweight->caption() ?><?= $Page->Mweight->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Mweight->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Mweight" name="x_Mweight" id="x_Mweight" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Mweight->getPlaceHolder()) ?>" value="<?= $Page->Mweight->EditValue ?>"<?= $Page->Mweight->editAttributes() ?> aria-describedby="x_Mweight_help">
...
<?php if ($Page->MBMI->Visible) { // MBMI ?>
    <div id="r_MBMI" class="form-group row">
        <label id="elh_view_vitals_history_MBMI" for="x_MBMI" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MBMI"><?= $Page->MBMI->caption() ?><?= $Page->MBMI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->MBMI->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_MBMI" name="x_MBMI" id="x_MBMI" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->MBMI->getPlaceHolder()) ?>" value="<?= $Page->MBMI->EditValue ?>"<?= $Page->MBMI->editAttributes() ?> aria-describedby="x_MBMI_help">
...
<?php if ($Page->MBloodgroup->Visible) { // MBloodgroup ?>
    <div id="r_MBloodgroup" class="form-group row">
        <label id="elh_view_vitals_history_MBloodgroup" for="x_MBloodgroup" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MBloodgroup"><?= $Page->MBloodgroup->caption() ?><?= $Page->MBloodgroup->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<div class="input-group flex-nowrap">
    <select
        ...
        data-select2-id="view_vitals_history_x_MBloodgroup"
        data-table="view_vitals_history"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_vitals_history_x_MBloodgroup']"),
        options = { name: "x_MBloodgroup", selectId: "view_vitals_history_x_MBloodgroup", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.view_vitals_history.fields.MBloodgroup.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->FBuild->Visible) { // FBuild ?>
    <div id="r_FBuild" class="form-group row">
        <label id="elh_view_vitals_history_FBuild" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FBuild"><?= $Page->FBuild->caption() ?><?= $Page->FBuild->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_FBuild">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_FBuild" name="x_FBuild" id="x_FBuild"<?= $Page->FBuild->editAttributes() ?>>
...
<?php if ($Page->MBuild->Visible) { // MBuild ?>
    <div id="r_MBuild" class="form-group row">
        <label id="elh_view_vitals_history_MBuild" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MBuild"><?= $Page->MBuild->caption() ?><?= $Page->MBuild->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MBuild">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_MBuild" name="x_MBuild" id="x_MBuild"<?= $Page->MBuild->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->FSkinColor->Visible) { // FSkinColor ?>
    <div id="r_FSkinColor" class="form-group row">
        <label id="elh_view_vitals_history_FSkinColor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FSkinColor"><?= $Page->FSkinColor->caption() ?><?= $Page->FSkinColor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_FSkinColor">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_FSkinColor" name="x_FSkinColor" id="x_FSkinColor"<?= $Page->FSkinColor->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->MSkinColor->Visible) { // MSkinColor ?>
    <div id="r_MSkinColor" class="form-group row">
        <label id="elh_view_vitals_history_MSkinColor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MSkinColor"><?= $Page->MSkinColor->caption() ?><?= $Page->MSkinColor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MSkinColor">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_MSkinColor" name="x_MSkinColor" id="x_MSkinColor"<?= $Page->MSkinColor->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->FEyesColor->Visible) { // FEyesColor ?>
    <div id="r_FEyesColor" class="form-group row">
        <label id="elh_view_vitals_history_FEyesColor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FEyesColor"><?= $Page->FEyesColor->caption() ?><?= $Page->FEyesColor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_FEyesColor">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_FEyesColor" name="x_FEyesColor" id="x_FEyesColor"<?= $Page->FEyesColor->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->MEyesColor->Visible) { // MEyesColor ?>
    <div id="r_MEyesColor" class="form-group row">
        <label id="elh_view_vitals_history_MEyesColor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MEyesColor"><?= $Page->MEyesColor->caption() ?><?= $Page->MEyesColor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MEyesColor">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_MEyesColor" name="x_MEyesColor" id="x_MEyesColor"<?= $Page->MEyesColor->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->FHairColor->Visible) { // FHairColor ?>
    <div id="r_FHairColor" class="form-group row">
        <label id="elh_view_vitals_history_FHairColor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FHairColor"><?= $Page->FHairColor->caption() ?><?= $Page->FHairColor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_FHairColor">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_FHairColor" name="x_FHairColor" id="x_FHairColor"<?= $Page->FHairColor->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->MhairColor->Visible) { // MhairColor ?>
    <div id="r_MhairColor" class="form-group row">
        <label id="elh_view_vitals_history_MhairColor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MhairColor"><?= $Page->MhairColor->caption() ?><?= $Page->MhairColor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MhairColor">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_MhairColor" name="x_MhairColor" id="x_MhairColor"<?= $Page->MhairColor->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->FhairTexture->Visible) { // FhairTexture ?>
    <div id="r_FhairTexture" class="form-group row">
        <label id="elh_view_vitals_history_FhairTexture" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FhairTexture"><?= $Page->FhairTexture->caption() ?><?= $Page->FhairTexture->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_FhairTexture">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_FhairTexture" name="x_FhairTexture" id="x_FhairTexture"<?= $Page->FhairTexture->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->MHairTexture->Visible) { // MHairTexture ?>
    <div id="r_MHairTexture" class="form-group row">
        <label id="elh_view_vitals_history_MHairTexture" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MHairTexture"><?= $Page->MHairTexture->caption() ?><?= $Page->MHairTexture->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MHairTexture">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="view_vitals_history" data-field="x_MHairTexture" name="x_MHairTexture" id="x_MHairTexture"<?= $Page->MHairTexture->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->Fothers->Visible) { // Fothers ?>
    <div id="r_Fothers" class="form-group row">
        <label id="elh_view_vitals_history_Fothers" for="x_Fothers" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Fothers"><?= $Page->Fothers->caption() ?><?= $Page->Fothers->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Fothers->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Fothers" name="x_Fothers" id="x_Fothers" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Fothers->getPlaceHolder()) ?>" value="<?= $Page->Fothers->EditValue ?>"<?= $Page->Fothers->editAttributes() ?> aria-describedby="x_Fothers_help">
...
<?php if ($Page->Mothers->Visible) { // Mothers ?>
    <div id="r_Mothers" class="form-group row">
        <label id="elh_view_vitals_history_Mothers" for="x_Mothers" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Mothers"><?= $Page->Mothers->caption() ?><?= $Page->Mothers->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Mothers->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Mothers" name="x_Mothers" id="x_Mothers" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Mothers->getPlaceHolder()) ?>" value="<?= $Page->Mothers->EditValue ?>"<?= $Page->Mothers->editAttributes() ?> aria-describedby="x_Mothers_help">
...
<?php if ($Page->PGE->Visible) { // PGE ?>
    <div id="r_PGE" class="form-group row">
        <label id="elh_view_vitals_history_PGE" for="x_PGE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PGE"><?= $Page->PGE->caption() ?><?= $Page->PGE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PGE->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PGE" name="x_PGE" id="x_PGE" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PGE->getPlaceHolder()) ?>" value="<?= $Page->PGE->EditValue ?>"<?= $Page->PGE->editAttributes() ?> aria-describedby="x_PGE_help">
...
<?php if ($Page->PPR->Visible) { // PPR ?>
    <div id="r_PPR" class="form-group row">
        <label id="elh_view_vitals_history_PPR" for="x_PPR" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PPR"><?= $Page->PPR->caption() ?><?= $Page->PPR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PPR->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PPR" name="x_PPR" id="x_PPR" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PPR->getPlaceHolder()) ?>" value="<?= $Page->PPR->EditValue ?>"<?= $Page->PPR->editAttributes() ?> aria-describedby="x_PPR_help">
...
<?php if ($Page->PBP->Visible) { // PBP ?>
    <div id="r_PBP" class="form-group row">
        <label id="elh_view_vitals_history_PBP" for="x_PBP" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PBP"><?= $Page->PBP->caption() ?><?= $Page->PBP->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PBP->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PBP" name="x_PBP" id="x_PBP" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PBP->getPlaceHolder()) ?>" value="<?= $Page->PBP->EditValue ?>"<?= $Page->PBP->editAttributes() ?> aria-describedby="x_PBP_help">
...
<?php if ($Page->Breast->Visible) { // Breast ?>
    <div id="r_Breast" class="form-group row">
        <label id="elh_view_vitals_history_Breast" for="x_Breast" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Breast"><?= $Page->Breast->caption() ?><?= $Page->Breast->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Breast->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_Breast" name="x_Breast" id="x_Breast" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Breast->getPlaceHolder()) ?>" value="<?= $Page->Breast->EditValue ?>"<?= $Page->Breast->editAttributes() ?> aria-describedby="x_Breast_help">
...
<?php if ($Page->PPA->Visible) { // PPA ?>
    <div id="r_PPA" class="form-group row">
        <label id="elh_view_vitals_history_PPA" for="x_PPA" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PPA"><?= $Page->PPA->caption() ?><?= $Page->PPA->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PPA->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PPA" name="x_PPA" id="x_PPA" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PPA->getPlaceHolder()) ?>" value="<?= $Page->PPA->EditValue ?>"<?= $Page->PPA->editAttributes() ?> aria-describedby="x_PPA_help">
...
<?php if ($Page->PPSV->Visible) { // PPSV ?>
    <div id="r_PPSV" class="form-group row">
        <label id="elh_view_vitals_history_PPSV" for="x_PPSV" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PPSV"><?= $Page->PPSV->caption() ?><?= $Page->PPSV->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PPSV->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PPSV" name="x_PPSV" id="x_PPSV" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PPSV->getPlaceHolder()) ?>" value="<?= $Page->PPSV->EditValue ?>"<?= $Page->PPSV->editAttributes() ?> aria-describedby="x_PPSV_help">
...
<?php if ($Page->PPAPSMEAR->Visible) { // PPAPSMEAR ?>
    <div id="r_PPAPSMEAR" class="form-group row">
        <label id="elh_view_vitals_history_PPAPSMEAR" for="x_PPAPSMEAR" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PPAPSMEAR"><?= $Page->PPAPSMEAR->caption() ?><?= $Page->PPAPSMEAR->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PPAPSMEAR->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PPAPSMEAR" name="x_PPAPSMEAR" id="x_PPAPSMEAR" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PPAPSMEAR->getPlaceHolder()) ?>" value="<?= $Page->PPAPSMEAR->EditValue ?>"<?= $Page->PPAPSMEAR->editAttributes() ?> aria-describedby="x_PPAPSMEAR_help">
...
<?php if ($Page->PTHYROID->Visible) { // PTHYROID ?>
    <div id="r_PTHYROID" class="form-group row">
        <label id="elh_view_vitals_history_PTHYROID" for="x_PTHYROID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PTHYROID"><?= $Page->PTHYROID->caption() ?><?= $Page->PTHYROID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PTHYROID->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PTHYROID" name="x_PTHYROID" id="x_PTHYROID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PTHYROID->getPlaceHolder()) ?>" value="<?= $Page->PTHYROID->EditValue ?>"<?= $Page->PTHYROID->editAttributes() ?> aria-describedby="x_PTHYROID_help">
...
<?php if ($Page->MTHYROID->Visible) { // MTHYROID ?>
    <div id="r_MTHYROID" class="form-group row">
        <label id="elh_view_vitals_history_MTHYROID" for="x_MTHYROID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MTHYROID"><?= $Page->MTHYROID->caption() ?><?= $Page->MTHYROID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->MTHYROID->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_MTHYROID" name="x_MTHYROID" id="x_MTHYROID" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->MTHYROID->getPlaceHolder()) ?>" value="<?= $Page->MTHYROID->EditValue ?>"<?= $Page->MTHYROID->editAttributes() ?> aria-describedby="x_MTHYROID_help">
...
<?php if ($Page->SecSexCharacters->Visible) { // SecSexCharacters ?>
    <div id="r_SecSexCharacters" class="form-group row">
        <label id="elh_view_vitals_history_SecSexCharacters" for="x_SecSexCharacters" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_SecSexCharacters"><?= $Page->SecSexCharacters->caption() ?><?= $Page->SecSexCharacters->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PenisUM->Visible) { // PenisUM ?>
    <div id="r_PenisUM" class="form-group row">
        <label id="elh_view_vitals_history_PenisUM" for="x_PenisUM" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PenisUM"><?= $Page->PenisUM->caption() ?><?= $Page->PenisUM->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->PenisUM->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_PenisUM" name="x_PenisUM" id="x_PenisUM" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PenisUM->getPlaceHolder()) ?>" value="<?= $Page->PenisUM->EditValue ?>"<?= $Page->PenisUM->editAttributes() ?> aria-describedby="x_PenisUM_help">
...
<?php if ($Page->VAS->Visible) { // VAS ?>
    <div id="r_VAS" class="form-group row">
        <label id="elh_view_vitals_history_VAS" for="x_VAS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_VAS"><?= $Page->VAS->caption() ?><?= $Page->VAS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->VAS->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_VAS" name="x_VAS" id="x_VAS" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->VAS->getPlaceHolder()) ?>" value="<?= $Page->VAS->EditValue ?>"<?= $Page->VAS->editAttributes() ?> aria-describedby="x_VAS_help">
...
<?php if ($Page->EPIDIDYMIS->Visible) { // EPIDIDYMIS ?>
    <div id="r_EPIDIDYMIS" class="form-group row">
        <label id="elh_view_vitals_history_EPIDIDYMIS" for="x_EPIDIDYMIS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_EPIDIDYMIS"><?= $Page->EPIDIDYMIS->caption() ?><?= $Page->EPIDIDYMIS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Varicocele->Visible) { // Varicocele ?>
    <div id="r_Varicocele" class="form-group row">
        <label id="elh_view_vitals_history_Varicocele" for="x_Varicocele" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Varicocele"><?= $Page->Varicocele->caption() ?><?= $Page->Varicocele->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->FertilityTreatmentHistory->Visible) { // FertilityTreatmentHistory ?>
    <div id="r_FertilityTreatmentHistory" class="form-group row">
        <label id="elh_view_vitals_history_FertilityTreatmentHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FertilityTreatmentHistory"><?= $Page->FertilityTreatmentHistory->caption() ?><?= $Page->FertilityTreatmentHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_FertilityTreatmentHistory", 35, 4, <?= $Page->FertilityTreatmentHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->SurgeryHistory->Visible) { // SurgeryHistory ?>
    <div id="r_SurgeryHistory" class="form-group row">
        <label id="elh_view_vitals_history_SurgeryHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_SurgeryHistory"><?= $Page->SurgeryHistory->caption() ?><?= $Page->SurgeryHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_SurgeryHistory" name="x_SurgeryHistory" id="x_SurgeryHistory" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->SurgeryHistory->getPlaceHolder()) ?>"<?= $Page->SurgeryHistory->editAttributes() ?> aria-describedby="x_SurgeryHistory_help"><?= $Page->SurgeryHistory->EditValue ?></textarea>
<?= $Page->SurgeryHistory->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->SurgeryHistory->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_SurgeryHistory", 35, 4, <?= $Page->SurgeryHistory->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->FamilyHistory->Visible) { // FamilyHistory ?>
    <div id="r_FamilyHistory" class="form-group row">
        <label id="elh_view_vitals_history_FamilyHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_FamilyHistory"><?= $Page->FamilyHistory->caption() ?><?= $Page->FamilyHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PInvestigations->Visible) { // PInvestigations ?>
    <div id="r_PInvestigations" class="form-group row">
        <label id="elh_view_vitals_history_PInvestigations" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PInvestigations"><?= $Page->PInvestigations->caption() ?><?= $Page->PInvestigations->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_PInvestigations", 35, 4, <?= $Page->PInvestigations->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->Addictions->Visible) { // Addictions ?>
    <div id="r_Addictions" class="form-group row">
        <label id="elh_view_vitals_history_Addictions" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Addictions"><?= $Page->Addictions->caption() ?><?= $Page->Addictions->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_Addictions">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="view_vitals_history" data-field="x_Addictions" name="x_Addictions" id="x_Addictions"<?= $Page->Addictions->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->Medications->Visible) { // Medications ?>
    <div id="r_Medications" class="form-group row">
        <label id="elh_view_vitals_history_Medications" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Medications"><?= $Page->Medications->caption() ?><?= $Page->Medications->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_Medications" name="x_Medications" id="x_Medications" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Medications->getPlaceHolder()) ?>"<?= $Page->Medications->editAttributes() ?> aria-describedby="x_Medications_help"><?= $Page->Medications->EditValue ?></textarea>
<?= $Page->Medications->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->Medications->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_Medications", 35, 4, <?= $Page->Medications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->Medical->Visible) { // Medical ?>
    <div id="r_Medical" class="form-group row">
        <label id="elh_view_vitals_history_Medical" for="x_Medical" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Medical"><?= $Page->Medical->caption() ?><?= $Page->Medical->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_view_vitals_history_Medical"><span id="el_view_vitals_history_Medical">
    <select
        ...
        data-select2-id="view_vitals_history_x_Medical"
        data-table="view_vitals_history"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_vitals_history_x_Medical']"),
        options = { name: "x_Medical", selectId: "view_vitals_history_x_Medical", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.view_vitals_history.fields.Medical.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.view_vitals_history.fields.Medical.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->Surgical->Visible) { // Surgical ?>
    <div id="r_Surgical" class="form-group row">
        <label id="elh_view_vitals_history_Surgical" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_Surgical"><?= $Page->Surgical->caption() ?><?= $Page->Surgical->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" is="selection-list" class="form-control" data-table="view_vitals_history" data-field="x_Surgical" data-input="sv_x_Surgical" data-value-separator="<?= $Page->Surgical->displayValueSeparatorAttribute() ?>" name="x_Surgical" id="x_Surgical" value="<?= HtmlEncode($Page->Surgical->CurrentValue) ?>"<?= $onchange ?>>
<?= $Page->Surgical->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->Surgical->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit"], function() {
    fview_vitals_historyedit.createAutoSuggest(Object.assign({"id":"x_Surgical","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.Surgical.autoSuggestOptions));
});
</script>
...
<?php if ($Page->CoitalHistory->Visible) { // CoitalHistory ?>
    <div id="r_CoitalHistory" class="form-group row">
        <label id="elh_view_vitals_history_CoitalHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_CoitalHistory"><?= $Page->CoitalHistory->caption() ?><?= $Page->CoitalHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit"], function() {
    fview_vitals_historyedit.createAutoSuggest(Object.assign({"id":"x_CoitalHistory","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.CoitalHistory.autoSuggestOptions));
});
</script>
...
<?php if ($Page->SemenAnalysis->Visible) { // SemenAnalysis ?>
    <div id="r_SemenAnalysis" class="form-group row">
        <label id="elh_view_vitals_history_SemenAnalysis" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_SemenAnalysis"><?= $Page->SemenAnalysis->caption() ?><?= $Page->SemenAnalysis->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_SemenAnalysis" name="x_SemenAnalysis" id="x_SemenAnalysis" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->SemenAnalysis->getPlaceHolder()) ?>"<?= $Page->SemenAnalysis->editAttributes() ?> aria-describedby="x_SemenAnalysis_help"><?= $Page->SemenAnalysis->EditValue ?></textarea>
<?= $Page->SemenAnalysis->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->SemenAnalysis->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_SemenAnalysis", 35, 4, <?= $Page->SemenAnalysis->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->MInsvestications->Visible) { // MInsvestications ?>
    <div id="r_MInsvestications" class="form-group row">
        <label id="elh_view_vitals_history_MInsvestications" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MInsvestications"><?= $Page->MInsvestications->caption() ?><?= $Page->MInsvestications->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_MInsvestications", 35, 4, <?= $Page->MInsvestications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->PImpression->Visible) { // PImpression ?>
    <div id="r_PImpression" class="form-group row">
        <label id="elh_view_vitals_history_PImpression" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PImpression"><?= $Page->PImpression->caption() ?><?= $Page->PImpression->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_PImpression" name="x_PImpression" id="x_PImpression" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->PImpression->getPlaceHolder()) ?>"<?= $Page->PImpression->editAttributes() ?> aria-describedby="x_PImpression_help"><?= $Page->PImpression->EditValue ?></textarea>
<?= $Page->PImpression->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->PImpression->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_PImpression", 35, 4, <?= $Page->PImpression->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->MIMpression->Visible) { // MIMpression ?>
    <div id="r_MIMpression" class="form-group row">
        <label id="elh_view_vitals_history_MIMpression" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MIMpression"><?= $Page->MIMpression->caption() ?><?= $Page->MIMpression->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_MIMpression" name="x_MIMpression" id="x_MIMpression" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->MIMpression->getPlaceHolder()) ?>"<?= $Page->MIMpression->editAttributes() ?> aria-describedby="x_MIMpression_help"><?= $Page->MIMpression->EditValue ?></textarea>
<?= $Page->MIMpression->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->MIMpression->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_MIMpression", 35, 4, <?= $Page->MIMpression->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->PPlanOfManagement->Visible) { // PPlanOfManagement ?>
    <div id="r_PPlanOfManagement" class="form-group row">
        <label id="elh_view_vitals_history_PPlanOfManagement" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PPlanOfManagement"><?= $Page->PPlanOfManagement->caption() ?><?= $Page->PPlanOfManagement->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_PPlanOfManagement", 35, 4, <?= $Page->PPlanOfManagement->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->MPlanOfManagement->Visible) { // MPlanOfManagement ?>
    <div id="r_MPlanOfManagement" class="form-group row">
        <label id="elh_view_vitals_history_MPlanOfManagement" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MPlanOfManagement"><?= $Page->MPlanOfManagement->caption() ?><?= $Page->MPlanOfManagement->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_MPlanOfManagement", 35, 4, <?= $Page->MPlanOfManagement->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->PReadMore->Visible) { // PReadMore ?>
    <div id="r_PReadMore" class="form-group row">
        <label id="elh_view_vitals_history_PReadMore" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_PReadMore"><?= $Page->PReadMore->caption() ?><?= $Page->PReadMore->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_PReadMore" name="x_PReadMore" id="x_PReadMore" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->PReadMore->getPlaceHolder()) ?>"<?= $Page->PReadMore->editAttributes() ?> aria-describedby="x_PReadMore_help"><?= $Page->PReadMore->EditValue ?></textarea>
<?= $Page->PReadMore->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->PReadMore->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_PReadMore", 35, 4, <?= $Page->PReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->MReadMore->Visible) { // MReadMore ?>
    <div id="r_MReadMore" class="form-group row">
        <label id="elh_view_vitals_history_MReadMore" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MReadMore"><?= $Page->MReadMore->caption() ?><?= $Page->MReadMore->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<textarea data-table="view_vitals_history" data-field="x_MReadMore" name="x_MReadMore" id="x_MReadMore" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->MReadMore->getPlaceHolder()) ?>"<?= $Page->MReadMore->editAttributes() ?> aria-describedby="x_MReadMore_help"><?= $Page->MReadMore->EditValue ?></textarea>
<?= $Page->MReadMore->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->MReadMore->getErrorMessage() ?></div>
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_MReadMore", 35, 4, <?= $Page->MReadMore->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<?php if ($Page->MariedFor->Visible) { // MariedFor ?>
    <div id="r_MariedFor" class="form-group row">
        <label id="elh_view_vitals_history_MariedFor" for="x_MariedFor" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_MariedFor"><?= $Page->MariedFor->caption() ?><?= $Page->MariedFor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->MariedFor->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_MariedFor" name="x_MariedFor" id="x_MariedFor" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->MariedFor->getPlaceHolder()) ?>" value="<?= $Page->MariedFor->EditValue ?>"<?= $Page->MariedFor->editAttributes() ?> aria-describedby="x_MariedFor_help">
...
<?php if ($Page->CMNCM->Visible) { // CMNCM ?>
    <div id="r_CMNCM" class="form-group row">
        <label id="elh_view_vitals_history_CMNCM" for="x_CMNCM" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_CMNCM"><?= $Page->CMNCM->caption() ?><?= $Page->CMNCM->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->CMNCM->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_CMNCM" name="x_CMNCM" id="x_CMNCM" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->CMNCM->getPlaceHolder()) ?>" value="<?= $Page->CMNCM->EditValue ?>"<?= $Page->CMNCM->editAttributes() ?> aria-describedby="x_CMNCM_help">
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <div id="r_TidNo" class="form-group row">
        <label id="elh_view_vitals_history_TidNo" for="x_TidNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_TidNo"><?= $Page->TidNo->caption() ?><?= $Page->TidNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->TidNo->getInputTextType() ?>" data-table="view_vitals_history" data-field="x_TidNo" name="x_TidNo" id="x_TidNo" size="30" placeholder="<?= HtmlEncode($Page->TidNo->getPlaceHolder()) ?>" value="<?= $Page->TidNo->EditValue ?>"<?= $Page->TidNo->editAttributes() ?> aria-describedby="x_TidNo_help">
...
<?php if ($Page->pFamilyHistory->Visible) { // pFamilyHistory ?>
    <div id="r_pFamilyHistory" class="form-group row">
        <label id="elh_view_vitals_history_pFamilyHistory" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_pFamilyHistory"><?= $Page->pFamilyHistory->caption() ?><?= $Page->pFamilyHistory->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit"], function() {
    fview_vitals_historyedit.createAutoSuggest(Object.assign({"id":"x_pFamilyHistory","forceSelect":false}, ew.vars.tables.view_vitals_history.fields.pFamilyHistory.autoSuggestOptions));
});
</script>
...
<?php if ($Page->pTemplateMedications->Visible) { // pTemplateMedications ?>
    <div id="r_pTemplateMedications" class="form-group row">
        <label id="elh_view_vitals_history_pTemplateMedications" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_vitals_history_pTemplateMedications"><?= $Page->pTemplateMedications->caption() ?><?= $Page->pTemplateMedications->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<script>
loadjs.ready(["fview_vitals_historyedit", "editor"], function() {
	ew.createEditor("fview_vitals_historyedit", "x_pTemplateMedications", 35, 4, <?= $Page->pTemplateMedications->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_view_vitals_historyedit">
<div id="ct_ViewVitalsHistoryEdit"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_vitals_historyedit", "tpm_view_vitals_historyedit", "view_vitals_historyedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
...
loadjs.ready("head", function() {
    ew.addEventHandlers("view_vitals_history");
});
</script>
<script>
