...
<form name="fpres_trade_combination_nameslistsrch" id="fpres_trade_combination_nameslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpres_trade_combination_nameslist" id="fpres_trade_combination_nameslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
