...
$Page->showMessage();
?>
<form name="fstore_batchmasview" id="fstore_batchmasview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->FRQ->Visible) { // FRQ ?>
    <tr id="r_FRQ">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_FRQ"><?= $Page->FRQ->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->UM->Visible) { // UM ?>
    <tr id="r_UM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_UM"><?= $Page->UM->caption() ?></span></td>
...
<?php if ($Page->GENNAME->Visible) { // GENNAME ?>
    <tr id="r_GENNAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_GENNAME"><?= $Page->GENNAME->caption() ?></span></td>
...
<?php if ($Page->BILLDATE->Visible) { // BILLDATE ?>
    <tr id="r_BILLDATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_BILLDATE"><?= $Page->BILLDATE->caption() ?></span></td>
...
<?php if ($Page->PUnit->Visible) { // PUnit ?>
    <tr id="r_PUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_PUnit"><?= $Page->PUnit->caption() ?></span></td>
...
<?php if ($Page->SUnit->Visible) { // SUnit ?>
    <tr id="r_SUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_SUnit"><?= $Page->SUnit->caption() ?></span></td>
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <tr id="r_PurValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_PurValue"><?= $Page->PurValue->caption() ?></span></td>
...
<?php if ($Page->PurRate->Visible) { // PurRate ?>
    <tr id="r_PurRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_PurRate"><?= $Page->PurRate->caption() ?></span></td>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_batchmas_StoreID"><?= $Page->StoreID->caption() ?></span></td>
