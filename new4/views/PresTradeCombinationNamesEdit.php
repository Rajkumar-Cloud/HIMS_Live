...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "pres_trade_combination_names")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.pres_trade_combination_names)
        ew.vars.tables.pres_trade_combination_names = currentTable;
...
$Page->showMessage();
?>
<form name="fpres_trade_combination_namesedit" id="fpres_trade_combination_namesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
