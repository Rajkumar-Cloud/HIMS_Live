...
$Page->showMessage();
?>
<form name="fpres_trade_combination_namesdelete" id="fpres_trade_combination_namesdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
