...
$Page->showMessage();
?>
<form name="fdeposit_pettycashview" id="fdeposit_pettycashview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_deposit_pettycash_HospID"><?= $Page->HospID->caption() ?></span></td>
