...
$Page->showMessage();
?>
<form name="femployee_role_job_descriptionview" id="femployee_role_job_descriptionview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
