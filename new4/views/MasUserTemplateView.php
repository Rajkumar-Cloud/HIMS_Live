...
// Page object
$MasUserTemplateView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fmas_user_templateview;
...
$Page->showMessage();
?>
<form name="fmas_user_templateview" id="fmas_user_templateview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->TemplateName->Visible) { // TemplateName ?>
    <tr id="r_TemplateName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_TemplateName"><?= $Page->TemplateName->caption() ?></span></td>
...
<?php if ($Page->TemplateType->Visible) { // TemplateType ?>
    <tr id="r_TemplateType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_TemplateType"><?= $Page->TemplateType->caption() ?></span></td>
...
<?php if ($Page->_Template->Visible) { // Template ?>
    <tr id="r__Template">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template__Template"><?= $Page->_Template->caption() ?></span></td>
...
<?php if ($Page->created->Visible) { // created ?>
    <tr id="r_created">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_created"><?= $Page->created->caption() ?></span></td>
...
<?php if ($Page->createdDatetime->Visible) { // createdDatetime ?>
    <tr id="r_createdDatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_createdDatetime"><?= $Page->createdDatetime->caption() ?></span></td>
...
<?php if ($Page->modified->Visible) { // modified ?>
    <tr id="r_modified">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_modified"><?= $Page->modified->caption() ?></span></td>
...
<?php if ($Page->modifiedDatetime->Visible) { // modifiedDatetime ?>
    <tr id="r_modifiedDatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_mas_user_template_modifiedDatetime"><?= $Page->modifiedDatetime->caption() ?></span></td>
