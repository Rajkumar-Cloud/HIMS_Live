...
// Page object
$ViewPharmacygrnAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_pharmacygrnadd;
loadjs.ready("head", function () {
    ...
    fview_pharmacygrnadd.addFields([
    ...
    // Form_CustomValidate
    fview_pharmacygrnadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_pharmacygrnadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_pharmacygrnadd.lists.PrName = <?= $Page->PrName->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_pharmacygrnadd" id="fview_pharmacygrnadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fview_pharmacygrnadd"], function() {
    fview_pharmacygrnadd.createAutoSuggest(Object.assign({"id":"x_PrName","forceSelect":true}, ew.vars.tables.view_pharmacygrn.fields.PrName.autoSuggestOptions));
});
</script>
