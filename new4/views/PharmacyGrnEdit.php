...
// Page object
$PharmacyGrnEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_grnedit;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fpharmacy_grnedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_grnedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpharmacy_grnedit.lists.PC = <?= $Page->PC->toClientList($Page) ?>;
    fpharmacy_grnedit.lists.BRCODE = <?= $Page->BRCODE->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_grnedit" id="fpharmacy_grnedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->getCurrentMasterTable() == "pharmacy_payment") { ?>
<input type="hidden" name="<?= Config("TABLE_SHOW_MASTER") ?>" value="pharmacy_payment">
<input type="hidden" name="fk_id" value="<?= HtmlEncode($Page->Pid->getSessionValue()) ?>">
<?php } ?>
<div class="ew-edit-div d-none"><!-- page* -->
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_pharmacy_grn_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_id"><span id="el_pharmacy_grn_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span></template>
<input type="hidden" data-table="pharmacy_grn" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->GRNNO->Visible) { // GRNNO ?>
    <div id="r_GRNNO" class="form-group row">
        <label id="elh_pharmacy_grn_GRNNO" for="x_GRNNO" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_GRNNO"><?= $Page->GRNNO->caption() ?><?= $Page->GRNNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <div id="r_DT" class="form-group row">
        <label id="elh_pharmacy_grn_DT" for="x_DT" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_DT"><?= $Page->DT->caption() ?><?= $Page->DT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DT->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_DT"><span id="el_pharmacy_grn_DT">
<input type="<?= $Page->DT->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_DT" data-format="7" name="x_DT" id="x_DT" placeholder="<?= HtmlEncode($Page->DT->getPlaceHolder()) ?>" value="<?= $Page->DT->EditValue ?>"<?= $Page->DT->editAttributes() ?> aria-describedby="x_DT_help">
...
<?php if ($Page->YM->Visible) { // YM ?>
    <div id="r_YM" class="form-group row">
        <label id="elh_pharmacy_grn_YM" for="x_YM" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_YM"><?= $Page->YM->caption() ?><?= $Page->YM->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->YM->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_YM"><span id="el_pharmacy_grn_YM">
...
<?php if ($Page->PC->Visible) { // PC ?>
    <div id="r_PC" class="form-group row">
        <label id="elh_pharmacy_grn_PC" for="x_PC" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_PC"><?= $Page->PC->caption() ?><?= $Page->PC->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PC->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_PC"><span id="el_pharmacy_grn_PC">
...
<input type="hidden" is="selection-list" data-table="pharmacy_grn" data-field="x_PC" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->PC->displayValueSeparatorAttribute() ?>" name="x_PC" id="x_PC" value="<?= $Page->PC->CurrentValue ?>"<?= $Page->PC->editAttributes() ?>>
</span></template>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->Customercode->Visible) { // Customercode ?>
    <div id="r_Customercode" class="form-group row">
        <label id="elh_pharmacy_grn_Customercode" for="x_Customercode" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Customercode"><?= $Page->Customercode->caption() ?><?= $Page->Customercode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Customercode->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_Customercode"><span id="el_pharmacy_grn_Customercode">
...
<?php if ($Page->Customername->Visible) { // Customername ?>
    <div id="r_Customername" class="form-group row">
        <label id="elh_pharmacy_grn_Customername" for="x_Customername" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Customername"><?= $Page->Customername->caption() ?><?= $Page->Customername->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->pharmacy_pocol->Visible) { // pharmacy_pocol ?>
    <div id="r_pharmacy_pocol" class="form-group row">
        <label id="elh_pharmacy_grn_pharmacy_pocol" for="x_pharmacy_pocol" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_pharmacy_pocol"><?= $Page->pharmacy_pocol->caption() ?><?= $Page->pharmacy_pocol->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pharmacy_pocol->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_pharmacy_pocol"><span id="el_pharmacy_grn_pharmacy_pocol">
...
<?php if ($Page->Address1->Visible) { // Address1 ?>
    <div id="r_Address1" class="form-group row">
        <label id="elh_pharmacy_grn_Address1" for="x_Address1" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Address1"><?= $Page->Address1->caption() ?><?= $Page->Address1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address1->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_Address1"><span id="el_pharmacy_grn_Address1">
<input type="<?= $Page->Address1->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_Address1" name="x_Address1" id="x_Address1" placeholder="<?= HtmlEncode($Page->Address1->getPlaceHolder()) ?>" value="<?= $Page->Address1->EditValue ?>"<?= $Page->Address1->editAttributes() ?> aria-describedby="x_Address1_help">
...
<?php if ($Page->Address2->Visible) { // Address2 ?>
    <div id="r_Address2" class="form-group row">
        <label id="elh_pharmacy_grn_Address2" for="x_Address2" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Address2"><?= $Page->Address2->caption() ?><?= $Page->Address2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address2->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_Address2"><span id="el_pharmacy_grn_Address2">
<input type="<?= $Page->Address2->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_Address2" name="x_Address2" id="x_Address2" placeholder="<?= HtmlEncode($Page->Address2->getPlaceHolder()) ?>" value="<?= $Page->Address2->EditValue ?>"<?= $Page->Address2->editAttributes() ?> aria-describedby="x_Address2_help">
...
<?php if ($Page->Address3->Visible) { // Address3 ?>
    <div id="r_Address3" class="form-group row">
        <label id="elh_pharmacy_grn_Address3" for="x_Address3" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Address3"><?= $Page->Address3->caption() ?><?= $Page->Address3->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Address3->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_Address3"><span id="el_pharmacy_grn_Address3">
<input type="<?= $Page->Address3->getInputTextType() ?>" data-table="pharmacy_grn" data-field="x_Address3" name="x_Address3" id="x_Address3" placeholder="<?= HtmlEncode($Page->Address3->getPlaceHolder()) ?>" value="<?= $Page->Address3->EditValue ?>"<?= $Page->Address3->editAttributes() ?> aria-describedby="x_Address3_help">
...
<?php if ($Page->State->Visible) { // State ?>
    <div id="r_State" class="form-group row">
        <label id="elh_pharmacy_grn_State" for="x_State" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_State"><?= $Page->State->caption() ?><?= $Page->State->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Pincode->Visible) { // Pincode ?>
    <div id="r_Pincode" class="form-group row">
        <label id="elh_pharmacy_grn_Pincode" for="x_Pincode" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Pincode"><?= $Page->Pincode->caption() ?><?= $Page->Pincode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Phone->Visible) { // Phone ?>
    <div id="r_Phone" class="form-group row">
        <label id="elh_pharmacy_grn_Phone" for="x_Phone" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Phone"><?= $Page->Phone->caption() ?><?= $Page->Phone->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Fax->Visible) { // Fax ?>
    <div id="r_Fax" class="form-group row">
        <label id="elh_pharmacy_grn_Fax" for="x_Fax" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Fax"><?= $Page->Fax->caption() ?><?= $Page->Fax->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Fax->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_Fax"><span id="el_pharmacy_grn_Fax">
...
<?php if ($Page->EEmail->Visible) { // EEmail ?>
    <div id="r_EEmail" class="form-group row">
        <label id="elh_pharmacy_grn_EEmail" for="x_EEmail" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_EEmail"><?= $Page->EEmail->caption() ?><?= $Page->EEmail->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EEmail->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_EEmail"><span id="el_pharmacy_grn_EEmail">
...
<?php if ($Page->BILLNO->Visible) { // BILLNO ?>
    <div id="r_BILLNO" class="form-group row">
        <label id="elh_pharmacy_grn_BILLNO" for="x_BILLNO" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_BILLNO"><?= $Page->BILLNO->caption() ?><?= $Page->BILLNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BILLDT->Visible) { // BILLDT ?>
    <div id="r_BILLDT" class="form-group row">
        <label id="elh_pharmacy_grn_BILLDT" for="x_BILLDT" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_BILLDT"><?= $Page->BILLDT->caption() ?><?= $Page->BILLDT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <div id="r_BRCODE" class="form-group row">
        <label id="elh_pharmacy_grn_BRCODE" for="x_BRCODE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_BRCODE"><?= $Page->BRCODE->caption() ?><?= $Page->BRCODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BRCODE->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_BRCODE"><span id="el_pharmacy_grn_BRCODE">
    <select
        id="x_BRCODE"
        name="x_BRCODE"
        class="form-control ew-select<?= $Page->BRCODE->isInvalidClass() ?>"
        data-select2-id="pharmacy_grn_x_BRCODE"
        data-table="pharmacy_grn"
        data-field="x_BRCODE"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='pharmacy_grn_x_BRCODE']"),
        options = { name: "x_BRCODE", selectId: "pharmacy_grn_x_BRCODE", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.pharmacy_grn.fields.BRCODE.selectOptions);
...
<?php if ($Page->BillTotalValue->Visible) { // BillTotalValue ?>
    <div id="r_BillTotalValue" class="form-group row">
        <label id="elh_pharmacy_grn_BillTotalValue" for="x_BillTotalValue" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_BillTotalValue"><?= $Page->BillTotalValue->caption() ?><?= $Page->BillTotalValue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->GRNTotalValue->Visible) { // GRNTotalValue ?>
    <div id="r_GRNTotalValue" class="form-group row">
        <label id="elh_pharmacy_grn_GRNTotalValue" for="x_GRNTotalValue" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_GRNTotalValue"><?= $Page->GRNTotalValue->caption() ?><?= $Page->GRNTotalValue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BillDiscount->Visible) { // BillDiscount ?>
    <div id="r_BillDiscount" class="form-group row">
        <label id="elh_pharmacy_grn_BillDiscount" for="x_BillDiscount" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_BillDiscount"><?= $Page->BillDiscount->caption() ?><?= $Page->BillDiscount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BillUpload->Visible) { // BillUpload ?>
    <div id="r_BillUpload" class="form-group row">
        <label id="elh_pharmacy_grn_BillUpload" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_BillUpload"><?= $Page->BillUpload->caption() ?><?= $Page->BillUpload->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BillUpload->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_BillUpload"><span id="el_pharmacy_grn_BillUpload">
<div id="fd_x_BillUpload">
<div class="input-group">
    <div class="custom-file">
        <input type="file" class="custom-file-input" title="<?= $Page->BillUpload->title() ?>" data-table="pharmacy_grn" data-field="x_BillUpload" name="x_BillUpload" id="x_BillUpload" lang="<?= CurrentLanguageID() ?>"<?= $Page->BillUpload->editAttributes() ?><?= ($Page->BillUpload->ReadOnly || $Page->BillUpload->Disabled) ? " disabled" : "" ?> aria-describedby="x_BillUpload_help">
...
<input type="hidden" name="fa_x_BillUpload" id= "fa_x_BillUpload" value="<?= (Post("fa_x_BillUpload") == "0") ? "0" : "1" ?>">
...
<?php if ($Page->TransPort->Visible) { // TransPort ?>
    <div id="r_TransPort" class="form-group row">
        <label id="elh_pharmacy_grn_TransPort" for="x_TransPort" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_TransPort"><?= $Page->TransPort->caption() ?><?= $Page->TransPort->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TransPort->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_TransPort"><span id="el_pharmacy_grn_TransPort">
...
<?php if ($Page->AnyOther->Visible) { // AnyOther ?>
    <div id="r_AnyOther" class="form-group row">
        <label id="elh_pharmacy_grn_AnyOther" for="x_AnyOther" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_AnyOther"><?= $Page->AnyOther->caption() ?><?= $Page->AnyOther->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AnyOther->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_AnyOther"><span id="el_pharmacy_grn_AnyOther">
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <div id="r_Remarks" class="form-group row">
        <label id="elh_pharmacy_grn_Remarks" for="x_Remarks" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Remarks"><?= $Page->Remarks->caption() ?><?= $Page->Remarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Remarks->cellAttributes() ?>>
<template id="tpx_pharmacy_grn_Remarks"><span id="el_pharmacy_grn_Remarks">
...
<?php if ($Page->GrnValue->Visible) { // GrnValue ?>
    <div id="r_GrnValue" class="form-group row">
        <label id="elh_pharmacy_grn_GrnValue" for="x_GrnValue" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_GrnValue"><?= $Page->GrnValue->caption() ?><?= $Page->GrnValue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Pid->Visible) { // Pid ?>
    <div id="r_Pid" class="form-group row">
        <label id="elh_pharmacy_grn_Pid" for="x_Pid" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_Pid"><?= $Page->Pid->caption() ?><?= $Page->Pid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PaymentNo->Visible) { // PaymentNo ?>
    <div id="r_PaymentNo" class="form-group row">
        <label id="elh_pharmacy_grn_PaymentNo" for="x_PaymentNo" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_PaymentNo"><?= $Page->PaymentNo->caption() ?><?= $Page->PaymentNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PaymentStatus->Visible) { // PaymentStatus ?>
    <div id="r_PaymentStatus" class="form-group row">
        <label id="elh_pharmacy_grn_PaymentStatus" for="x_PaymentStatus" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_PaymentStatus"><?= $Page->PaymentStatus->caption() ?><?= $Page->PaymentStatus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PaidAmount->Visible) { // PaidAmount ?>
    <div id="r_PaidAmount" class="form-group row">
        <label id="elh_pharmacy_grn_PaidAmount" for="x_PaidAmount" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_pharmacy_grn_PaidAmount"><?= $Page->PaidAmount->caption() ?><?= $Page->PaidAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpm_pharmacy_grnedit">
<div id="ct_PharmacyGrnEdit"><style>
...
<?php
    if (in_array("view_pharmacygrn", explode(",", $Page->getCurrentDetailTable())) && $view_pharmacygrn->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
<h4 class="ew-detail-caption"><?= $Language->tablePhrase("view_pharmacygrn", "TblCaption") ?></h4>
<?php } ?>
<?php include_once "ViewPharmacygrnGrid.php" ?>
<?php } ?>
<?php if (!$Page->IsModal) { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_grnedit", "tpm_pharmacy_grnedit", "pharmacy_grnedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
