...
loadjs.ready("head", function () {
    ...
    femployee_telephoneadd.lists.tele_type = <?= $Page->tele_type->toClientList($Page) ?>;
    femployee_telephoneadd.lists.telephone_type = <?= $Page->telephone_type->toClientList($Page) ?>;
    femployee_telephoneadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="femployee_telephoneadd" id="femployee_telephoneadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
