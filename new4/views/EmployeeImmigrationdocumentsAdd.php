...
// Page object
$EmployeeImmigrationdocumentsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_immigrationdocumentsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_immigrationdocumentsadd = currentForm = new ew.Form("femployee_immigrationdocumentsadd", "add");
    ...
    femployee_immigrationdocumentsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_immigrationdocumentsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_immigrationdocumentsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_immigrationdocumentsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_immigrationdocumentsadd.lists.required = <?= $Page->required->toClientList($Page) ?>;
    femployee_immigrationdocumentsadd.lists.alert_on_missing = <?= $Page->alert_on_missing->toClientList($Page) ?>;
    femployee_immigrationdocumentsadd.lists.alert_before_expiry = <?= $Page->alert_before_expiry->toClientList($Page) ?>;
    loadjs.done("femployee_immigrationdocumentsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_immigrationdocumentsadd" id="femployee_immigrationdocumentsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_immigrationdocumentsadd", "datetimepicker"], function() {
