...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <?php if ($Page->SortUrl($Page->StoreID) == "") { ?>
        <th class="<?= $Page->StoreID->headerCellClass() ?>"><?= $Page->StoreID->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->StoreID->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->StoreID->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->StoreID->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->StoreID->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->StoreID->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
<?php
...
<?php if ($Page->CurStock->Visible) { // CurStock ?>
        <!-- CurStock -->
        <td class="<?= $Page->CurStock->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php if ($Page->FreeQtyyy->Visible) { // FreeQtyyy ?>
...
<?php if ($Page->strid->Visible) { // strid ?>
        <!-- strid -->
        <td class="<?= $Page->strid->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php if ($Page->GRNPer->Visible) { // GRNPer ?>
        <!-- GRNPer -->
        <td class="<?= $Page->GRNPer->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <!-- StoreID -->
        <td class="<?= $Page->StoreID->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php
