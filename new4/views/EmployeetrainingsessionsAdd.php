...
// Page object
$EmployeetrainingsessionsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployeetrainingsessionsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployeetrainingsessionsadd = currentForm = new ew.Form("femployeetrainingsessionsadd", "add");
    ...
    femployeetrainingsessionsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployeetrainingsessionsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployeetrainingsessionsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployeetrainingsessionsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployeetrainingsessionsadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployeetrainingsessionsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployeetrainingsessionsadd" id="femployeetrainingsessionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
