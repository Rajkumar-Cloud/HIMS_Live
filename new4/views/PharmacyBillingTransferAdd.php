...
// Page object
$PharmacyBillingTransferAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpharmacy_billing_transferadd;
loadjs.ready("head", function () {
    ...
    fpharmacy_billing_transferadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpharmacy_billing_transferadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpharmacy_billing_transferadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpharmacy_billing_transferadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpharmacy_billing_transferadd.lists.PharID = <?= $Page->PharID->toClientList($Page) ?>;
    fpharmacy_billing_transferadd.lists.transfer = <?= $Page->transfer->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_billing_transferadd" id="fpharmacy_billing_transferadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_pharmacy_billing_transferadd">
<div id="ct_PharmacyBillingTransferAdd"><style>
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title"><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_transfer"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_transfer"></slot></h3>
	</div>
		<div class="col-4">
...
<table class="ew-table">
	 <tbody>
		<tr>
		<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_pharmacy"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_pharmacy"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_street"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_street"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_area"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_area"></slot></td>		
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_town"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_town"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_province"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_province"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_postal_code"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_postal_code"></slot></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_phone_no"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_phone_no"></slot></td>
			<td><slot class="ew-slot" name="tpc_pharmacy_billing_transfer_Details"></slot>&nbsp;<slot class="ew-slot" name="tpx_pharmacy_billing_transfer_Details"></slot></td>
			<td></td>
			<td></td>
		</tr>
	</tbody>
...
<?php
    if (in_array("view_pharmacytransfer", explode(",", $Page->getCurrentDetailTable())) && $view_pharmacytransfer->DetailAdd) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_pharmacy_billing_transferadd", "tpm_pharmacy_billing_transferadd", "pharmacy_billing_transferadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
