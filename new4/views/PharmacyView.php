...
$Page->showMessage();
?>
<form name="fpharmacyview" id="fpharmacyview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if (in_array("pharmacy_services", explode(",", $Page->getCurrentDetailTable())) && $pharmacy_services->DetailView) {
?>
