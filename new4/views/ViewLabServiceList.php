...
loadjs.ready("head", function () {
    ...
    fview_lab_servicelist.addFields([
    ...
    // Check empty row
    fview_lab_servicelist.emptyRow = function (rowIndex) {
        var fobj = this.getForm();
    ...
    // Form_CustomValidate
    fview_lab_servicelist.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_lab_servicelist.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_lab_servicelist.lists.UNITS = <?= $Page->UNITS->toClientList($Page) ?>;
    fview_lab_servicelist.lists.SERVICE_TYPE = <?= $Page->SERVICE_TYPE->toClientList($Page) ?>;
    fview_lab_servicelist.lists.DEPARTMENT = <?= $Page->DEPARTMENT->toClientList($Page) ?>;
    fview_lab_servicelist.lists.Inactive = <?= $Page->Inactive->toClientList($Page) ?>;
    fview_lab_servicelist.lists.TestType = <?= $Page->TestType->toClientList($Page) ?>;
...
loadjs.ready("head", function () {
    ...
    var currentTable = <?= JsonEncode(GetClientVar("tables", "view_lab_service")) ?>,
        fields = currentTable.fields;
    fview_lab_servicelistsrch.addFields([
    ...
    // Set invalid fields
    $(function() {
        fview_lab_servicelistsrch.setInvalid();
    });

    // Validate form
    fview_lab_servicelistsrch.validate = function () {
        if (!this.validateRequired)
            return true; // Ignore validation
        var fobj = this.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_lab_servicelistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_lab_servicelistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_lab_servicelistsrch.lists.SERVICE_TYPE = <?= $Page->SERVICE_TYPE->toClientList($Page) ?>;
    fview_lab_servicelistsrch.lists.DEPARTMENT = <?= $Page->DEPARTMENT->toClientList($Page) ?>;
    fview_lab_servicelistsrch.lists.TestType = <?= $Page->TestType->toClientList($Page) ?>;
...
<form name="fview_lab_servicelistsrch" id="fview_lab_servicelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<input type="<?= $Page->SERVICE->getInputTextType() ?>" data-table="view_lab_service" data-field="x_SERVICE" name="x_SERVICE" id="x_SERVICE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->SERVICE->getPlaceHolder()) ?>" value="<?= $Page->SERVICE->EditValue ?>"<?= $Page->SERVICE->editAttributes() ?>>
...
<?php } ?>
<form name="fview_lab_servicelist" id="fview_lab_servicelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if ($Page->isAdd() || $Page->isCopy()) {
        ...
        // Set row properties
        $Page->resetAttributes();
        $Page->RowAttrs->merge(["data-rowindex" => 0, "id" => "r0_view_lab_service", "data-rowtype" => ROWTYPE_ADD]);
...
?>
    <?php if ($Page->Id->Visible) { // Id ?>
        <td data-name="Id">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Id" class="form-group view_lab_service_Id"></span>
<input type="hidden" data-table="view_lab_service" data-field="x_Id" data-hidden="1" name="o<?= $Page->RowIndex ?>_Id" id="o<?= $Page->RowIndex ?>_Id" value="<?= HtmlEncode($Page->Id->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->CODE->Visible) { // CODE ?>
        <td data-name="CODE">
<span id="el<?= $Page->RowCount ?>_view_lab_service_CODE" class="form-group view_lab_service_CODE">
<input type="<?= $Page->CODE->getInputTextType() ?>" data-table="view_lab_service" data-field="x_CODE" name="x<?= $Page->RowIndex ?>_CODE" id="x<?= $Page->RowIndex ?>_CODE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CODE->getPlaceHolder()) ?>" value="<?= $Page->CODE->EditValue ?>"<?= $Page->CODE->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->CODE->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_CODE" data-hidden="1" name="o<?= $Page->RowIndex ?>_CODE" id="o<?= $Page->RowIndex ?>_CODE" value="<?= HtmlEncode($Page->CODE->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->SERVICE->Visible) { // SERVICE ?>
        <td data-name="SERVICE">
<span id="el<?= $Page->RowCount ?>_view_lab_service_SERVICE" class="form-group view_lab_service_SERVICE">
<input type="<?= $Page->SERVICE->getInputTextType() ?>" data-table="view_lab_service" data-field="x_SERVICE" name="x<?= $Page->RowIndex ?>_SERVICE" id="x<?= $Page->RowIndex ?>_SERVICE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->SERVICE->getPlaceHolder()) ?>" value="<?= $Page->SERVICE->EditValue ?>"<?= $Page->SERVICE->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->SERVICE->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_SERVICE" data-hidden="1" name="o<?= $Page->RowIndex ?>_SERVICE" id="o<?= $Page->RowIndex ?>_SERVICE" value="<?= HtmlEncode($Page->SERVICE->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->UNITS->Visible) { // UNITS ?>
        <td data-name="UNITS">
<span id="el<?= $Page->RowCount ?>_view_lab_service_UNITS" class="form-group view_lab_service_UNITS">
<div class="input-group ew-lookup-list">
    <div class="form-control ew-lookup-text" tabindex="-1" id="lu_x<?= $Page->RowIndex ?>_UNITS"><?= EmptyValue(strval($Page->UNITS->ViewValue)) ? $Language->phrase("PleaseSelect") : $Page->UNITS->ViewValue ?></div>
    <div class="input-group-append">
        <button type="button" title="<?= HtmlEncode(str_replace("%s", RemoveHtml($Page->UNITS->caption()), $Language->phrase("LookupLink", true))) ?>" class="ew-lookup-btn btn btn-default"<?= ($Page->UNITS->ReadOnly || $Page->UNITS->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x<?= $Page->RowIndex ?>_UNITS',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
        <?php if (AllowAdd(CurrentProjectID() . "lab_unit_mast") && !$Page->UNITS->ReadOnly) { ?>
        <button type="button" class="btn btn-default ew-add-opt-btn" id="aol_x<?= $Page->RowIndex ?>_UNITS" title="<?= HtmlTitle($Language->phrase("AddLink")) . "&nbsp;" . $Page->UNITS->caption() ?>" data-title="<?= $Page->UNITS->caption() ?>" onclick="ew.addOptionDialogShow({lnk:this,el:'x<?= $Page->RowIndex ?>_UNITS',url:'<?= GetUrl("LabUnitMastAddopt") ?>'});"><i class="fas fa-plus ew-icon"></i></button>
        <?php } ?>
    </div>
</div>
<div class="invalid-feedback"><?= $Page->UNITS->getErrorMessage() ?></div>
<?= $Page->UNITS->Lookup->getParamTag($Page, "p_x" . $Page->RowIndex . "_UNITS") ?>
<input type="hidden" is="selection-list" data-table="view_lab_service" data-field="x_UNITS" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->UNITS->displayValueSeparatorAttribute() ?>" name="x<?= $Page->RowIndex ?>_UNITS" id="x<?= $Page->RowIndex ?>_UNITS" value="<?= $Page->UNITS->CurrentValue ?>"<?= $Page->UNITS->editAttributes() ?>>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_UNITS" data-hidden="1" name="o<?= $Page->RowIndex ?>_UNITS" id="o<?= $Page->RowIndex ?>_UNITS" value="<?= HtmlEncode($Page->UNITS->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->AMOUNT->Visible) { // AMOUNT ?>
        <td data-name="AMOUNT">
<span id="el<?= $Page->RowCount ?>_view_lab_service_AMOUNT" class="form-group view_lab_service_AMOUNT">
<input type="<?= $Page->AMOUNT->getInputTextType() ?>" data-table="view_lab_service" data-field="x_AMOUNT" name="x<?= $Page->RowIndex ?>_AMOUNT" id="x<?= $Page->RowIndex ?>_AMOUNT" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->AMOUNT->getPlaceHolder()) ?>" value="<?= $Page->AMOUNT->EditValue ?>"<?= $Page->AMOUNT->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->AMOUNT->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_AMOUNT" data-hidden="1" name="o<?= $Page->RowIndex ?>_AMOUNT" id="o<?= $Page->RowIndex ?>_AMOUNT" value="<?= HtmlEncode($Page->AMOUNT->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
        <td data-name="SERVICE_TYPE">
<span id="el<?= $Page->RowCount ?>_view_lab_service_SERVICE_TYPE" class="form-group view_lab_service_SERVICE_TYPE">
<div class="input-group flex-nowrap">
    <select
        id="x<?= $Page->RowIndex ?>_SERVICE_TYPE"
        name="x<?= $Page->RowIndex ?>_SERVICE_TYPE"
        class="form-control ew-select<?= $Page->SERVICE_TYPE->isInvalidClass() ?>"
        data-select2-id="view_lab_service_x<?= $Page->RowIndex ?>_SERVICE_TYPE"
        data-table="view_lab_service"
        data-field="x_SERVICE_TYPE"
        data-value-separator="<?= $Page->SERVICE_TYPE->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Page->SERVICE_TYPE->getPlaceHolder()) ?>"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_lab_service_x<?= $Page->RowIndex ?>_SERVICE_TYPE']"),
        options = { name: "x<?= $Page->RowIndex ?>_SERVICE_TYPE", selectId: "view_lab_service_x<?= $Page->RowIndex ?>_SERVICE_TYPE", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.view_lab_service.fields.SERVICE_TYPE.selectOptions);
    ew.createSelect(options);
});
...
<input type="hidden" data-table="view_lab_service" data-field="x_SERVICE_TYPE" data-hidden="1" name="o<?= $Page->RowIndex ?>_SERVICE_TYPE" id="o<?= $Page->RowIndex ?>_SERVICE_TYPE" value="<?= HtmlEncode($Page->SERVICE_TYPE->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->DEPARTMENT->Visible) { // DEPARTMENT ?>
        <td data-name="DEPARTMENT">
<span id="el<?= $Page->RowCount ?>_view_lab_service_DEPARTMENT" class="form-group view_lab_service_DEPARTMENT">
    <select
        id="x<?= $Page->RowIndex ?>_DEPARTMENT"
        name="x<?= $Page->RowIndex ?>_DEPARTMENT"
        class="form-control ew-select<?= $Page->DEPARTMENT->isInvalidClass() ?>"
        data-select2-id="view_lab_service_x<?= $Page->RowIndex ?>_DEPARTMENT"
        data-table="view_lab_service"
        data-field="x_DEPARTMENT"
        data-value-separator="<?= $Page->DEPARTMENT->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Page->DEPARTMENT->getPlaceHolder()) ?>"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_lab_service_x<?= $Page->RowIndex ?>_DEPARTMENT']"),
        options = { name: "x<?= $Page->RowIndex ?>_DEPARTMENT", selectId: "view_lab_service_x<?= $Page->RowIndex ?>_DEPARTMENT", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.view_lab_service.fields.DEPARTMENT.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.view_lab_service.fields.DEPARTMENT.selectOptions);
    ew.createSelect(options);
...
<input type="hidden" data-table="view_lab_service" data-field="x_DEPARTMENT" data-hidden="1" name="o<?= $Page->RowIndex ?>_DEPARTMENT" id="o<?= $Page->RowIndex ?>_DEPARTMENT" value="<?= HtmlEncode($Page->DEPARTMENT->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
        <td data-name="mas_services_billingcol">
<span id="el<?= $Page->RowCount ?>_view_lab_service_mas_services_billingcol" class="form-group view_lab_service_mas_services_billingcol">
...
<input type="hidden" data-table="view_lab_service" data-field="x_mas_services_billingcol" data-hidden="1" name="o<?= $Page->RowIndex ?>_mas_services_billingcol" id="o<?= $Page->RowIndex ?>_mas_services_billingcol" value="<?= HtmlEncode($Page->mas_services_billingcol->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->DrShareAmount->Visible) { // DrShareAmount ?>
        <td data-name="DrShareAmount">
<span id="el<?= $Page->RowCount ?>_view_lab_service_DrShareAmount" class="form-group view_lab_service_DrShareAmount">
...
<input type="hidden" data-table="view_lab_service" data-field="x_DrShareAmount" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrShareAmount" id="o<?= $Page->RowIndex ?>_DrShareAmount" value="<?= HtmlEncode($Page->DrShareAmount->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->HospShareAmount->Visible) { // HospShareAmount ?>
        <td data-name="HospShareAmount">
<span id="el<?= $Page->RowCount ?>_view_lab_service_HospShareAmount" class="form-group view_lab_service_HospShareAmount">
...
<input type="hidden" data-table="view_lab_service" data-field="x_HospShareAmount" data-hidden="1" name="o<?= $Page->RowIndex ?>_HospShareAmount" id="o<?= $Page->RowIndex ?>_HospShareAmount" value="<?= HtmlEncode($Page->HospShareAmount->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->DrSharePer->Visible) { // DrSharePer ?>
        <td data-name="DrSharePer">
<span id="el<?= $Page->RowCount ?>_view_lab_service_DrSharePer" class="form-group view_lab_service_DrSharePer">
<input type="<?= $Page->DrSharePer->getInputTextType() ?>" data-table="view_lab_service" data-field="x_DrSharePer" name="x<?= $Page->RowIndex ?>_DrSharePer" id="x<?= $Page->RowIndex ?>_DrSharePer" size="30" placeholder="<?= HtmlEncode($Page->DrSharePer->getPlaceHolder()) ?>" value="<?= $Page->DrSharePer->EditValue ?>"<?= $Page->DrSharePer->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DrSharePer->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_DrSharePer" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrSharePer" id="o<?= $Page->RowIndex ?>_DrSharePer" value="<?= HtmlEncode($Page->DrSharePer->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->HospSharePer->Visible) { // HospSharePer ?>
        <td data-name="HospSharePer">
<span id="el<?= $Page->RowCount ?>_view_lab_service_HospSharePer" class="form-group view_lab_service_HospSharePer">
<input type="<?= $Page->HospSharePer->getInputTextType() ?>" data-table="view_lab_service" data-field="x_HospSharePer" name="x<?= $Page->RowIndex ?>_HospSharePer" id="x<?= $Page->RowIndex ?>_HospSharePer" size="30" placeholder="<?= HtmlEncode($Page->HospSharePer->getPlaceHolder()) ?>" value="<?= $Page->HospSharePer->EditValue ?>"<?= $Page->HospSharePer->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->HospSharePer->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_HospSharePer" data-hidden="1" name="o<?= $Page->RowIndex ?>_HospSharePer" id="o<?= $Page->RowIndex ?>_HospSharePer" value="<?= HtmlEncode($Page->HospSharePer->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->HospID->Visible) { // HospID ?>
        <td data-name="HospID">
<input type="hidden" data-table="view_lab_service" data-field="x_HospID" data-hidden="1" name="o<?= $Page->RowIndex ?>_HospID" id="o<?= $Page->RowIndex ?>_HospID" value="<?= HtmlEncode($Page->HospID->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->TestSubCd->Visible) { // TestSubCd ?>
        <td data-name="TestSubCd">
<span id="el<?= $Page->RowCount ?>_view_lab_service_TestSubCd" class="form-group view_lab_service_TestSubCd">
<input type="<?= $Page->TestSubCd->getInputTextType() ?>" data-table="view_lab_service" data-field="x_TestSubCd" name="x<?= $Page->RowIndex ?>_TestSubCd" id="x<?= $Page->RowIndex ?>_TestSubCd" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->TestSubCd->getPlaceHolder()) ?>" value="<?= $Page->TestSubCd->EditValue ?>"<?= $Page->TestSubCd->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->TestSubCd->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_TestSubCd" data-hidden="1" name="o<?= $Page->RowIndex ?>_TestSubCd" id="o<?= $Page->RowIndex ?>_TestSubCd" value="<?= HtmlEncode($Page->TestSubCd->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->Method->Visible) { // Method ?>
        <td data-name="Method">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Method" class="form-group view_lab_service_Method">
<input type="<?= $Page->Method->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Method" name="x<?= $Page->RowIndex ?>_Method" id="x<?= $Page->RowIndex ?>_Method" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Method->getPlaceHolder()) ?>" value="<?= $Page->Method->EditValue ?>"<?= $Page->Method->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Method->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Method" data-hidden="1" name="o<?= $Page->RowIndex ?>_Method" id="o<?= $Page->RowIndex ?>_Method" value="<?= HtmlEncode($Page->Method->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->Order->Visible) { // Order ?>
        <td data-name="Order">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Order" class="form-group view_lab_service_Order">
<input type="<?= $Page->Order->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Order" name="x<?= $Page->RowIndex ?>_Order" id="x<?= $Page->RowIndex ?>_Order" size="30" placeholder="<?= HtmlEncode($Page->Order->getPlaceHolder()) ?>" value="<?= $Page->Order->EditValue ?>"<?= $Page->Order->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Order->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Order" data-hidden="1" name="o<?= $Page->RowIndex ?>_Order" id="o<?= $Page->RowIndex ?>_Order" value="<?= HtmlEncode($Page->Order->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->ResType->Visible) { // ResType ?>
        <td data-name="ResType">
<span id="el<?= $Page->RowCount ?>_view_lab_service_ResType" class="form-group view_lab_service_ResType">
<input type="<?= $Page->ResType->getInputTextType() ?>" data-table="view_lab_service" data-field="x_ResType" name="x<?= $Page->RowIndex ?>_ResType" id="x<?= $Page->RowIndex ?>_ResType" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ResType->getPlaceHolder()) ?>" value="<?= $Page->ResType->EditValue ?>"<?= $Page->ResType->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->ResType->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_ResType" data-hidden="1" name="o<?= $Page->RowIndex ?>_ResType" id="o<?= $Page->RowIndex ?>_ResType" value="<?= HtmlEncode($Page->ResType->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->UnitCD->Visible) { // UnitCD ?>
        <td data-name="UnitCD">
<span id="el<?= $Page->RowCount ?>_view_lab_service_UnitCD" class="form-group view_lab_service_UnitCD">
<input type="<?= $Page->UnitCD->getInputTextType() ?>" data-table="view_lab_service" data-field="x_UnitCD" name="x<?= $Page->RowIndex ?>_UnitCD" id="x<?= $Page->RowIndex ?>_UnitCD" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->UnitCD->getPlaceHolder()) ?>" value="<?= $Page->UnitCD->EditValue ?>"<?= $Page->UnitCD->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->UnitCD->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_UnitCD" data-hidden="1" name="o<?= $Page->RowIndex ?>_UnitCD" id="o<?= $Page->RowIndex ?>_UnitCD" value="<?= HtmlEncode($Page->UnitCD->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->Sample->Visible) { // Sample ?>
        <td data-name="Sample">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Sample" class="form-group view_lab_service_Sample">
<input type="<?= $Page->Sample->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Sample" name="x<?= $Page->RowIndex ?>_Sample" id="x<?= $Page->RowIndex ?>_Sample" size="30" maxlength="105" placeholder="<?= HtmlEncode($Page->Sample->getPlaceHolder()) ?>" value="<?= $Page->Sample->EditValue ?>"<?= $Page->Sample->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Sample->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Sample" data-hidden="1" name="o<?= $Page->RowIndex ?>_Sample" id="o<?= $Page->RowIndex ?>_Sample" value="<?= HtmlEncode($Page->Sample->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->NoD->Visible) { // NoD ?>
        <td data-name="NoD">
<span id="el<?= $Page->RowCount ?>_view_lab_service_NoD" class="form-group view_lab_service_NoD">
<input type="<?= $Page->NoD->getInputTextType() ?>" data-table="view_lab_service" data-field="x_NoD" name="x<?= $Page->RowIndex ?>_NoD" id="x<?= $Page->RowIndex ?>_NoD" size="30" placeholder="<?= HtmlEncode($Page->NoD->getPlaceHolder()) ?>" value="<?= $Page->NoD->EditValue ?>"<?= $Page->NoD->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->NoD->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_NoD" data-hidden="1" name="o<?= $Page->RowIndex ?>_NoD" id="o<?= $Page->RowIndex ?>_NoD" value="<?= HtmlEncode($Page->NoD->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->BillOrder->Visible) { // BillOrder ?>
        <td data-name="BillOrder">
<span id="el<?= $Page->RowCount ?>_view_lab_service_BillOrder" class="form-group view_lab_service_BillOrder">
<input type="<?= $Page->BillOrder->getInputTextType() ?>" data-table="view_lab_service" data-field="x_BillOrder" name="x<?= $Page->RowIndex ?>_BillOrder" id="x<?= $Page->RowIndex ?>_BillOrder" size="30" placeholder="<?= HtmlEncode($Page->BillOrder->getPlaceHolder()) ?>" value="<?= $Page->BillOrder->EditValue ?>"<?= $Page->BillOrder->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->BillOrder->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_BillOrder" data-hidden="1" name="o<?= $Page->RowIndex ?>_BillOrder" id="o<?= $Page->RowIndex ?>_BillOrder" value="<?= HtmlEncode($Page->BillOrder->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->Inactive->Visible) { // Inactive ?>
        <td data-name="Inactive">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Inactive" class="form-group view_lab_service_Inactive">
<template id="tp_x<?= $Page->RowIndex ?>_Inactive">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="view_lab_service" data-field="x_Inactive" name="x<?= $Page->RowIndex ?>_Inactive" id="x<?= $Page->RowIndex ?>_Inactive"<?= $Page->Inactive->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
<div id="dsl_x<?= $Page->RowIndex ?>_Inactive" class="ew-item-list"></div>
<input type="hidden"
    is="selection-list"
    id="x<?= $Page->RowIndex ?>_Inactive[]"
    name="x<?= $Page->RowIndex ?>_Inactive[]"
    value="<?= HtmlEncode($Page->Inactive->CurrentValue) ?>"
    data-type="select-multiple"
    data-template="tp_x<?= $Page->RowIndex ?>_Inactive"
    data-target="dsl_x<?= $Page->RowIndex ?>_Inactive"
    data-repeatcolumn="5"
...
<input type="hidden" data-table="view_lab_service" data-field="x_Inactive" data-hidden="1" name="o<?= $Page->RowIndex ?>_Inactive[]" id="o<?= $Page->RowIndex ?>_Inactive[]" value="<?= HtmlEncode($Page->Inactive->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->Outsource->Visible) { // Outsource ?>
        <td data-name="Outsource">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Outsource" class="form-group view_lab_service_Outsource">
<input type="<?= $Page->Outsource->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Outsource" name="x<?= $Page->RowIndex ?>_Outsource" id="x<?= $Page->RowIndex ?>_Outsource" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Outsource->getPlaceHolder()) ?>" value="<?= $Page->Outsource->EditValue ?>"<?= $Page->Outsource->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Outsource->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Outsource" data-hidden="1" name="o<?= $Page->RowIndex ?>_Outsource" id="o<?= $Page->RowIndex ?>_Outsource" value="<?= HtmlEncode($Page->Outsource->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->CollSample->Visible) { // CollSample ?>
        <td data-name="CollSample">
<span id="el<?= $Page->RowCount ?>_view_lab_service_CollSample" class="form-group view_lab_service_CollSample">
<input type="<?= $Page->CollSample->getInputTextType() ?>" data-table="view_lab_service" data-field="x_CollSample" name="x<?= $Page->RowIndex ?>_CollSample" id="x<?= $Page->RowIndex ?>_CollSample" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->CollSample->getPlaceHolder()) ?>" value="<?= $Page->CollSample->EditValue ?>"<?= $Page->CollSample->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->CollSample->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_CollSample" data-hidden="1" name="o<?= $Page->RowIndex ?>_CollSample" id="o<?= $Page->RowIndex ?>_CollSample" value="<?= HtmlEncode($Page->CollSample->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->TestType->Visible) { // TestType ?>
        <td data-name="TestType">
<span id="el<?= $Page->RowCount ?>_view_lab_service_TestType" class="form-group view_lab_service_TestType">
    <select
        id="x<?= $Page->RowIndex ?>_TestType"
        name="x<?= $Page->RowIndex ?>_TestType"
        class="form-control ew-select<?= $Page->TestType->isInvalidClass() ?>"
        data-select2-id="view_lab_service_x<?= $Page->RowIndex ?>_TestType"
        data-table="view_lab_service"
        data-field="x_TestType"
        data-value-separator="<?= $Page->TestType->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Page->TestType->getPlaceHolder()) ?>"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='view_lab_service_x<?= $Page->RowIndex ?>_TestType']"),
        options = { name: "x<?= $Page->RowIndex ?>_TestType", selectId: "view_lab_service_x<?= $Page->RowIndex ?>_TestType", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.view_lab_service.fields.TestType.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.view_lab_service.fields.TestType.selectOptions);
    ew.createSelect(options);
...
<input type="hidden" data-table="view_lab_service" data-field="x_TestType" data-hidden="1" name="o<?= $Page->RowIndex ?>_TestType" id="o<?= $Page->RowIndex ?>_TestType" value="<?= HtmlEncode($Page->TestType->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->NoHeading->Visible) { // NoHeading ?>
        <td data-name="NoHeading">
<span id="el<?= $Page->RowCount ?>_view_lab_service_NoHeading" class="form-group view_lab_service_NoHeading">
<input type="<?= $Page->NoHeading->getInputTextType() ?>" data-table="view_lab_service" data-field="x_NoHeading" name="x<?= $Page->RowIndex ?>_NoHeading" id="x<?= $Page->RowIndex ?>_NoHeading" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->NoHeading->getPlaceHolder()) ?>" value="<?= $Page->NoHeading->EditValue ?>"<?= $Page->NoHeading->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->NoHeading->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_NoHeading" data-hidden="1" name="o<?= $Page->RowIndex ?>_NoHeading" id="o<?= $Page->RowIndex ?>_NoHeading" value="<?= HtmlEncode($Page->NoHeading->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->ChemicalCode->Visible) { // ChemicalCode ?>
        <td data-name="ChemicalCode">
<span id="el<?= $Page->RowCount ?>_view_lab_service_ChemicalCode" class="form-group view_lab_service_ChemicalCode">
...
<input type="hidden" data-table="view_lab_service" data-field="x_ChemicalCode" data-hidden="1" name="o<?= $Page->RowIndex ?>_ChemicalCode" id="o<?= $Page->RowIndex ?>_ChemicalCode" value="<?= HtmlEncode($Page->ChemicalCode->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->ChemicalName->Visible) { // ChemicalName ?>
        <td data-name="ChemicalName">
<span id="el<?= $Page->RowCount ?>_view_lab_service_ChemicalName" class="form-group view_lab_service_ChemicalName">
...
<input type="hidden" data-table="view_lab_service" data-field="x_ChemicalName" data-hidden="1" name="o<?= $Page->RowIndex ?>_ChemicalName" id="o<?= $Page->RowIndex ?>_ChemicalName" value="<?= HtmlEncode($Page->ChemicalName->OldValue) ?>">
</td>
    <?php } ?>
    <?php if ($Page->Utilaization->Visible) { // Utilaization ?>
        <td data-name="Utilaization">
<span id="el<?= $Page->RowCount ?>_view_lab_service_Utilaization" class="form-group view_lab_service_Utilaization">
...
<input type="hidden" data-table="view_lab_service" data-field="x_Utilaization" data-hidden="1" name="o<?= $Page->RowIndex ?>_Utilaization" id="o<?= $Page->RowIndex ?>_Utilaization" value="<?= HtmlEncode($Page->Utilaization->OldValue) ?>">
</td>
    <?php } ?>
<?php
...
loadjs.ready(["fview_lab_servicelist","load"], function() {
    fview_lab_servicelist.updateLists(<?= $Page->RowIndex ?>);
});
</script>
    </tr>
<?php
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_Id" class="form-group"></span>
<input type="hidden" data-table="view_lab_service" data-field="x_Id" data-hidden="1" name="o<?= $Page->RowIndex ?>_Id" id="o<?= $Page->RowIndex ?>_Id" value="<?= HtmlEncode($Page->Id->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Id" class="form-group">
<span<?= $Page->Id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->Id->getDisplayValue($Page->Id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Id" data-hidden="1" name="x<?= $Page->RowIndex ?>_Id" id="x<?= $Page->RowIndex ?>_Id" value="<?= HtmlEncode($Page->Id->CurrentValue) ?>">
<?php } ?>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_CODE" class="form-group">
<input type="<?= $Page->CODE->getInputTextType() ?>" data-table="view_lab_service" data-field="x_CODE" name="x<?= $Page->RowIndex ?>_CODE" id="x<?= $Page->RowIndex ?>_CODE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->CODE->getPlaceHolder()) ?>" value="<?= $Page->CODE->EditValue ?>"<?= $Page->CODE->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->CODE->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_CODE" data-hidden="1" name="o<?= $Page->RowIndex ?>_CODE" id="o<?= $Page->RowIndex ?>_CODE" value="<?= HtmlEncode($Page->CODE->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_SERVICE" class="form-group">
<input type="<?= $Page->SERVICE->getInputTextType() ?>" data-table="view_lab_service" data-field="x_SERVICE" name="x<?= $Page->RowIndex ?>_SERVICE" id="x<?= $Page->RowIndex ?>_SERVICE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->SERVICE->getPlaceHolder()) ?>" value="<?= $Page->SERVICE->EditValue ?>"<?= $Page->SERVICE->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->SERVICE->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_SERVICE" data-hidden="1" name="o<?= $Page->RowIndex ?>_SERVICE" id="o<?= $Page->RowIndex ?>_SERVICE" value="<?= HtmlEncode($Page->SERVICE->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_UNITS" class="form-group">
<div class="input-group ew-lookup-list">
    <div class="form-control ew-lookup-text" tabindex="-1" id="lu_x<?= $Page->RowIndex ?>_UNITS"><?= EmptyValue(strval($Page->UNITS->ViewValue)) ? $Language->phrase("PleaseSelect") : $Page->UNITS->ViewValue ?></div>
    <div class="input-group-append">
        <button type="button" title="<?= HtmlEncode(str_replace("%s", RemoveHtml($Page->UNITS->caption()), $Language->phrase("LookupLink", true))) ?>" class="ew-lookup-btn btn btn-default"<?= ($Page->UNITS->ReadOnly || $Page->UNITS->Disabled) ? " disabled" : "" ?> onclick="ew.modalLookupShow({lnk:this,el:'x<?= $Page->RowIndex ?>_UNITS',m:0,n:10});"><i class="fas fa-search ew-icon"></i></button>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_AMOUNT" class="form-group">
<input type="<?= $Page->AMOUNT->getInputTextType() ?>" data-table="view_lab_service" data-field="x_AMOUNT" name="x<?= $Page->RowIndex ?>_AMOUNT" id="x<?= $Page->RowIndex ?>_AMOUNT" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->AMOUNT->getPlaceHolder()) ?>" value="<?= $Page->AMOUNT->EditValue ?>"<?= $Page->AMOUNT->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->AMOUNT->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_AMOUNT" data-hidden="1" name="o<?= $Page->RowIndex ?>_AMOUNT" id="o<?= $Page->RowIndex ?>_AMOUNT" value="<?= HtmlEncode($Page->AMOUNT->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_SERVICE_TYPE" class="form-group">
<div class="input-group flex-nowrap">
    <select
        id="x<?= $Page->RowIndex ?>_SERVICE_TYPE"
        name="x<?= $Page->RowIndex ?>_SERVICE_TYPE"
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_DEPARTMENT" class="form-group">
    <select
        id="x<?= $Page->RowIndex ?>_DEPARTMENT"
        name="x<?= $Page->RowIndex ?>_DEPARTMENT"
        class="form-control ew-select<?= $Page->DEPARTMENT->isInvalidClass() ?>"
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_mas_services_billingcol" class="form-group">
<input type="<?= $Page->mas_services_billingcol->getInputTextType() ?>" data-table="view_lab_service" data-field="x_mas_services_billingcol" name="x<?= $Page->RowIndex ?>_mas_services_billingcol" id="x<?= $Page->RowIndex ?>_mas_services_billingcol" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->mas_services_billingcol->getPlaceHolder()) ?>" value="<?= $Page->mas_services_billingcol->EditValue ?>"<?= $Page->mas_services_billingcol->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->mas_services_billingcol->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_mas_services_billingcol" data-hidden="1" name="o<?= $Page->RowIndex ?>_mas_services_billingcol" id="o<?= $Page->RowIndex ?>_mas_services_billingcol" value="<?= HtmlEncode($Page->mas_services_billingcol->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_DrShareAmount" class="form-group">
<input type="<?= $Page->DrShareAmount->getInputTextType() ?>" data-table="view_lab_service" data-field="x_DrShareAmount" name="x<?= $Page->RowIndex ?>_DrShareAmount" id="x<?= $Page->RowIndex ?>_DrShareAmount" size="30" placeholder="<?= HtmlEncode($Page->DrShareAmount->getPlaceHolder()) ?>" value="<?= $Page->DrShareAmount->EditValue ?>"<?= $Page->DrShareAmount->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DrShareAmount->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_DrShareAmount" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrShareAmount" id="o<?= $Page->RowIndex ?>_DrShareAmount" value="<?= HtmlEncode($Page->DrShareAmount->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_HospShareAmount" class="form-group">
<input type="<?= $Page->HospShareAmount->getInputTextType() ?>" data-table="view_lab_service" data-field="x_HospShareAmount" name="x<?= $Page->RowIndex ?>_HospShareAmount" id="x<?= $Page->RowIndex ?>_HospShareAmount" size="30" placeholder="<?= HtmlEncode($Page->HospShareAmount->getPlaceHolder()) ?>" value="<?= $Page->HospShareAmount->EditValue ?>"<?= $Page->HospShareAmount->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->HospShareAmount->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_HospShareAmount" data-hidden="1" name="o<?= $Page->RowIndex ?>_HospShareAmount" id="o<?= $Page->RowIndex ?>_HospShareAmount" value="<?= HtmlEncode($Page->HospShareAmount->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_DrSharePer" class="form-group">
<input type="<?= $Page->DrSharePer->getInputTextType() ?>" data-table="view_lab_service" data-field="x_DrSharePer" name="x<?= $Page->RowIndex ?>_DrSharePer" id="x<?= $Page->RowIndex ?>_DrSharePer" size="30" placeholder="<?= HtmlEncode($Page->DrSharePer->getPlaceHolder()) ?>" value="<?= $Page->DrSharePer->EditValue ?>"<?= $Page->DrSharePer->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->DrSharePer->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_DrSharePer" data-hidden="1" name="o<?= $Page->RowIndex ?>_DrSharePer" id="o<?= $Page->RowIndex ?>_DrSharePer" value="<?= HtmlEncode($Page->DrSharePer->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_HospSharePer" class="form-group">
<input type="<?= $Page->HospSharePer->getInputTextType() ?>" data-table="view_lab_service" data-field="x_HospSharePer" name="x<?= $Page->RowIndex ?>_HospSharePer" id="x<?= $Page->RowIndex ?>_HospSharePer" size="30" placeholder="<?= HtmlEncode($Page->HospSharePer->getPlaceHolder()) ?>" value="<?= $Page->HospSharePer->EditValue ?>"<?= $Page->HospSharePer->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->HospSharePer->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_HospSharePer" data-hidden="1" name="o<?= $Page->RowIndex ?>_HospSharePer" id="o<?= $Page->RowIndex ?>_HospSharePer" value="<?= HtmlEncode($Page->HospSharePer->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_TestSubCd" class="form-group">
<input type="<?= $Page->TestSubCd->getInputTextType() ?>" data-table="view_lab_service" data-field="x_TestSubCd" name="x<?= $Page->RowIndex ?>_TestSubCd" id="x<?= $Page->RowIndex ?>_TestSubCd" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->TestSubCd->getPlaceHolder()) ?>" value="<?= $Page->TestSubCd->EditValue ?>"<?= $Page->TestSubCd->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->TestSubCd->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_TestSubCd" data-hidden="1" name="o<?= $Page->RowIndex ?>_TestSubCd" id="o<?= $Page->RowIndex ?>_TestSubCd" value="<?= HtmlEncode($Page->TestSubCd->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Method" class="form-group">
<input type="<?= $Page->Method->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Method" name="x<?= $Page->RowIndex ?>_Method" id="x<?= $Page->RowIndex ?>_Method" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Method->getPlaceHolder()) ?>" value="<?= $Page->Method->EditValue ?>"<?= $Page->Method->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Method->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Method" data-hidden="1" name="o<?= $Page->RowIndex ?>_Method" id="o<?= $Page->RowIndex ?>_Method" value="<?= HtmlEncode($Page->Method->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Order" class="form-group">
<input type="<?= $Page->Order->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Order" name="x<?= $Page->RowIndex ?>_Order" id="x<?= $Page->RowIndex ?>_Order" size="30" placeholder="<?= HtmlEncode($Page->Order->getPlaceHolder()) ?>" value="<?= $Page->Order->EditValue ?>"<?= $Page->Order->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Order->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Order" data-hidden="1" name="o<?= $Page->RowIndex ?>_Order" id="o<?= $Page->RowIndex ?>_Order" value="<?= HtmlEncode($Page->Order->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_ResType" class="form-group">
<input type="<?= $Page->ResType->getInputTextType() ?>" data-table="view_lab_service" data-field="x_ResType" name="x<?= $Page->RowIndex ?>_ResType" id="x<?= $Page->RowIndex ?>_ResType" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ResType->getPlaceHolder()) ?>" value="<?= $Page->ResType->EditValue ?>"<?= $Page->ResType->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->ResType->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_ResType" data-hidden="1" name="o<?= $Page->RowIndex ?>_ResType" id="o<?= $Page->RowIndex ?>_ResType" value="<?= HtmlEncode($Page->ResType->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_UnitCD" class="form-group">
<input type="<?= $Page->UnitCD->getInputTextType() ?>" data-table="view_lab_service" data-field="x_UnitCD" name="x<?= $Page->RowIndex ?>_UnitCD" id="x<?= $Page->RowIndex ?>_UnitCD" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->UnitCD->getPlaceHolder()) ?>" value="<?= $Page->UnitCD->EditValue ?>"<?= $Page->UnitCD->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->UnitCD->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_UnitCD" data-hidden="1" name="o<?= $Page->RowIndex ?>_UnitCD" id="o<?= $Page->RowIndex ?>_UnitCD" value="<?= HtmlEncode($Page->UnitCD->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Sample" class="form-group">
<input type="<?= $Page->Sample->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Sample" name="x<?= $Page->RowIndex ?>_Sample" id="x<?= $Page->RowIndex ?>_Sample" size="30" maxlength="105" placeholder="<?= HtmlEncode($Page->Sample->getPlaceHolder()) ?>" value="<?= $Page->Sample->EditValue ?>"<?= $Page->Sample->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Sample->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Sample" data-hidden="1" name="o<?= $Page->RowIndex ?>_Sample" id="o<?= $Page->RowIndex ?>_Sample" value="<?= HtmlEncode($Page->Sample->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_NoD" class="form-group">
<input type="<?= $Page->NoD->getInputTextType() ?>" data-table="view_lab_service" data-field="x_NoD" name="x<?= $Page->RowIndex ?>_NoD" id="x<?= $Page->RowIndex ?>_NoD" size="30" placeholder="<?= HtmlEncode($Page->NoD->getPlaceHolder()) ?>" value="<?= $Page->NoD->EditValue ?>"<?= $Page->NoD->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->NoD->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_NoD" data-hidden="1" name="o<?= $Page->RowIndex ?>_NoD" id="o<?= $Page->RowIndex ?>_NoD" value="<?= HtmlEncode($Page->NoD->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_BillOrder" class="form-group">
<input type="<?= $Page->BillOrder->getInputTextType() ?>" data-table="view_lab_service" data-field="x_BillOrder" name="x<?= $Page->RowIndex ?>_BillOrder" id="x<?= $Page->RowIndex ?>_BillOrder" size="30" placeholder="<?= HtmlEncode($Page->BillOrder->getPlaceHolder()) ?>" value="<?= $Page->BillOrder->EditValue ?>"<?= $Page->BillOrder->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->BillOrder->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_BillOrder" data-hidden="1" name="o<?= $Page->RowIndex ?>_BillOrder" id="o<?= $Page->RowIndex ?>_BillOrder" value="<?= HtmlEncode($Page->BillOrder->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Inactive" class="form-group">
<template id="tp_x<?= $Page->RowIndex ?>_Inactive">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="view_lab_service" data-field="x_Inactive" name="x<?= $Page->RowIndex ?>_Inactive" id="x<?= $Page->RowIndex ?>_Inactive"<?= $Page->Inactive->editAttributes() ?>>
        <label class="custom-control-label"></label>
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Outsource" class="form-group">
<input type="<?= $Page->Outsource->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Outsource" name="x<?= $Page->RowIndex ?>_Outsource" id="x<?= $Page->RowIndex ?>_Outsource" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Outsource->getPlaceHolder()) ?>" value="<?= $Page->Outsource->EditValue ?>"<?= $Page->Outsource->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Outsource->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Outsource" data-hidden="1" name="o<?= $Page->RowIndex ?>_Outsource" id="o<?= $Page->RowIndex ?>_Outsource" value="<?= HtmlEncode($Page->Outsource->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_CollSample" class="form-group">
<input type="<?= $Page->CollSample->getInputTextType() ?>" data-table="view_lab_service" data-field="x_CollSample" name="x<?= $Page->RowIndex ?>_CollSample" id="x<?= $Page->RowIndex ?>_CollSample" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->CollSample->getPlaceHolder()) ?>" value="<?= $Page->CollSample->EditValue ?>"<?= $Page->CollSample->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->CollSample->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_CollSample" data-hidden="1" name="o<?= $Page->RowIndex ?>_CollSample" id="o<?= $Page->RowIndex ?>_CollSample" value="<?= HtmlEncode($Page->CollSample->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_TestType" class="form-group">
    <select
        id="x<?= $Page->RowIndex ?>_TestType"
        name="x<?= $Page->RowIndex ?>_TestType"
        class="form-control ew-select<?= $Page->TestType->isInvalidClass() ?>"
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_NoHeading" class="form-group">
<input type="<?= $Page->NoHeading->getInputTextType() ?>" data-table="view_lab_service" data-field="x_NoHeading" name="x<?= $Page->RowIndex ?>_NoHeading" id="x<?= $Page->RowIndex ?>_NoHeading" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->NoHeading->getPlaceHolder()) ?>" value="<?= $Page->NoHeading->EditValue ?>"<?= $Page->NoHeading->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->NoHeading->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_NoHeading" data-hidden="1" name="o<?= $Page->RowIndex ?>_NoHeading" id="o<?= $Page->RowIndex ?>_NoHeading" value="<?= HtmlEncode($Page->NoHeading->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_ChemicalCode" class="form-group">
<input type="<?= $Page->ChemicalCode->getInputTextType() ?>" data-table="view_lab_service" data-field="x_ChemicalCode" name="x<?= $Page->RowIndex ?>_ChemicalCode" id="x<?= $Page->RowIndex ?>_ChemicalCode" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ChemicalCode->getPlaceHolder()) ?>" value="<?= $Page->ChemicalCode->EditValue ?>"<?= $Page->ChemicalCode->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->ChemicalCode->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_ChemicalCode" data-hidden="1" name="o<?= $Page->RowIndex ?>_ChemicalCode" id="o<?= $Page->RowIndex ?>_ChemicalCode" value="<?= HtmlEncode($Page->ChemicalCode->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_ChemicalName" class="form-group">
<input type="<?= $Page->ChemicalName->getInputTextType() ?>" data-table="view_lab_service" data-field="x_ChemicalName" name="x<?= $Page->RowIndex ?>_ChemicalName" id="x<?= $Page->RowIndex ?>_ChemicalName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->ChemicalName->getPlaceHolder()) ?>" value="<?= $Page->ChemicalName->EditValue ?>"<?= $Page->ChemicalName->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->ChemicalName->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_ChemicalName" data-hidden="1" name="o<?= $Page->RowIndex ?>_ChemicalName" id="o<?= $Page->RowIndex ?>_ChemicalName" value="<?= HtmlEncode($Page->ChemicalName->OldValue) ?>">
...
<?php if ($Page->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?= $Page->RowCount ?>_view_lab_service_Utilaization" class="form-group">
<input type="<?= $Page->Utilaization->getInputTextType() ?>" data-table="view_lab_service" data-field="x_Utilaization" name="x<?= $Page->RowIndex ?>_Utilaization" id="x<?= $Page->RowIndex ?>_Utilaization" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Utilaization->getPlaceHolder()) ?>" value="<?= $Page->Utilaization->EditValue ?>"<?= $Page->Utilaization->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->Utilaization->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="view_lab_service" data-field="x_Utilaization" data-hidden="1" name="o<?= $Page->RowIndex ?>_Utilaization" id="o<?= $Page->RowIndex ?>_Utilaization" value="<?= HtmlEncode($Page->Utilaization->OldValue) ?>">
...
<?php
    if ($Page->isGridAdd() || $Page->isGridEdit()) {
        ...
        // Set row properties
        $Page->resetAttributes();
        $Page->RowAttrs->merge(["data-rowindex" => $Page->RowIndex, "id" => "r0_view_lab_service", "data-rowtype" => ROWTYPE_ADD]);
