...
<?php if ($Page->UserLevelsName->Visible) { // UserLevelsName ?>
        <th class="<?= $Page->UserLevelsName->headerCellClass() ?>"><span id="elh_userlevels_UserLevelsName" class="userlevels_UserLevelsName"><?= $Page->UserLevelsName->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_userlevels_id" class="userlevels_id">
...
<?php } ?>
<?php if ($Page->UserLevelsName->Visible) { // UserLevelsName ?>
        <td <?= $Page->UserLevelsName->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_userlevels_UserLevelsName" class="userlevels_UserLevelsName">
