...
$Page->showMessage();
?>
<form name="fivf_otherproceduredelete" id="fivf_otherproceduredelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->InvestigationReport->Visible) { // InvestigationReport ?>
        <th class="<?= $Page->InvestigationReport->headerCellClass() ?>"><span id="elh_ivf_otherprocedure_InvestigationReport" class="ivf_otherprocedure_InvestigationReport"><?= $Page->InvestigationReport->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->InvestigationReport->Visible) { // InvestigationReport ?>
        <td <?= $Page->InvestigationReport->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_otherprocedure_InvestigationReport" class="ivf_otherprocedure_InvestigationReport">
