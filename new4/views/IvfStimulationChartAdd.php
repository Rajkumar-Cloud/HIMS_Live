...
// Page object
$IvfStimulationChartAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_stimulation_chartadd;
loadjs.ready("head", function () {
    ...
    fivf_stimulation_chartadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_stimulation_chartadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_stimulation_chartadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_stimulation_chartadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_stimulation_chartadd.lists.ARTCycle = <?= $Page->ARTCycle->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.FemaleFactor = <?= $Page->FemaleFactor->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.MaleFactor = <?= $Page->MaleFactor->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Protocol = <?= $Page->Protocol->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.SemenFrozen = <?= $Page->SemenFrozen->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.A4ICSICycle = <?= $Page->A4ICSICycle->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.TotalICSICycle = <?= $Page->TotalICSICycle->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.TypeOfInfertility = <?= $Page->TypeOfInfertility->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.INJTYPE = <?= $Page->INJTYPE->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.ANTAGONISTSTARTDAY = <?= $Page->ANTAGONISTSTARTDAY->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.PRETREATMENT = <?= $Page->PRETREATMENT->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.MedicalFactors = <?= $Page->MedicalFactors->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.TRIGGERR = <?= $Page->TRIGGERR->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.ATHOMEorCLINIC = <?= $Page->ATHOMEorCLINIC->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.ALLFREEZEINDICATION = <?= $Page->ALLFREEZEINDICATION->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.ERA = <?= $Page->ERA->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.ET = <?= $Page->ET->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.SEMENPREPARATION = <?= $Page->SEMENPREPARATION->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.REASONFORESET = <?= $Page->REASONFORESET->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet1 = <?= $Page->Tablet1->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet2 = <?= $Page->Tablet2->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet3 = <?= $Page->Tablet3->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet4 = <?= $Page->Tablet4->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet5 = <?= $Page->Tablet5->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet6 = <?= $Page->Tablet6->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet7 = <?= $Page->Tablet7->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet8 = <?= $Page->Tablet8->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet9 = <?= $Page->Tablet9->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet10 = <?= $Page->Tablet10->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet11 = <?= $Page->Tablet11->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet12 = <?= $Page->Tablet12->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet13 = <?= $Page->Tablet13->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH1 = <?= $Page->RFSH1->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH2 = <?= $Page->RFSH2->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH3 = <?= $Page->RFSH3->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH4 = <?= $Page->RFSH4->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH5 = <?= $Page->RFSH5->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH6 = <?= $Page->RFSH6->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH7 = <?= $Page->RFSH7->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH8 = <?= $Page->RFSH8->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH9 = <?= $Page->RFSH9->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH10 = <?= $Page->RFSH10->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH11 = <?= $Page->RFSH11->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH12 = <?= $Page->RFSH12->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH13 = <?= $Page->RFSH13->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG1 = <?= $Page->HMG1->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG2 = <?= $Page->HMG2->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG3 = <?= $Page->HMG3->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG4 = <?= $Page->HMG4->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG5 = <?= $Page->HMG5->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG6 = <?= $Page->HMG6->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG7 = <?= $Page->HMG7->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG8 = <?= $Page->HMG8->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG9 = <?= $Page->HMG9->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG10 = <?= $Page->HMG10->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG11 = <?= $Page->HMG11->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG12 = <?= $Page->HMG12->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG13 = <?= $Page->HMG13->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH1 = <?= $Page->GnRH1->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH2 = <?= $Page->GnRH2->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH3 = <?= $Page->GnRH3->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH4 = <?= $Page->GnRH4->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH5 = <?= $Page->GnRH5->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH6 = <?= $Page->GnRH6->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH7 = <?= $Page->GnRH7->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH8 = <?= $Page->GnRH8->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH9 = <?= $Page->GnRH9->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH10 = <?= $Page->GnRH10->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH11 = <?= $Page->GnRH11->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH12 = <?= $Page->GnRH12->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH13 = <?= $Page->GnRH13->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Convert = <?= $Page->Convert->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.InseminatinTechnique = <?= $Page->InseminatinTechnique->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.IndicationForART = <?= $Page->IndicationForART->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Hysteroscopy = <?= $Page->Hysteroscopy->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.EndometrialScratching = <?= $Page->EndometrialScratching->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.TrialCannulation = <?= $Page->TrialCannulation->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.CYCLETYPE = <?= $Page->CYCLETYPE->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.OralEstrogenDosage = <?= $Page->OralEstrogenDosage->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GCSF = <?= $Page->GCSF->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.ActivatedPRP = <?= $Page->ActivatedPRP->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.AllFreeze = <?= $Page->AllFreeze->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.TreatmentCancel = <?= $Page->TreatmentCancel->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Projectron = <?= $Page->Projectron->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet14 = <?= $Page->Tablet14->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet15 = <?= $Page->Tablet15->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet16 = <?= $Page->Tablet16->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet17 = <?= $Page->Tablet17->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet18 = <?= $Page->Tablet18->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet19 = <?= $Page->Tablet19->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet20 = <?= $Page->Tablet20->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet21 = <?= $Page->Tablet21->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet22 = <?= $Page->Tablet22->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet23 = <?= $Page->Tablet23->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet24 = <?= $Page->Tablet24->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.Tablet25 = <?= $Page->Tablet25->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH14 = <?= $Page->RFSH14->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH15 = <?= $Page->RFSH15->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH16 = <?= $Page->RFSH16->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH17 = <?= $Page->RFSH17->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH18 = <?= $Page->RFSH18->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH19 = <?= $Page->RFSH19->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH20 = <?= $Page->RFSH20->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH21 = <?= $Page->RFSH21->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH22 = <?= $Page->RFSH22->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH23 = <?= $Page->RFSH23->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH24 = <?= $Page->RFSH24->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.RFSH25 = <?= $Page->RFSH25->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG14 = <?= $Page->HMG14->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG15 = <?= $Page->HMG15->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG16 = <?= $Page->HMG16->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG17 = <?= $Page->HMG17->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG18 = <?= $Page->HMG18->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG19 = <?= $Page->HMG19->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG20 = <?= $Page->HMG20->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG21 = <?= $Page->HMG21->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG22 = <?= $Page->HMG22->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG23 = <?= $Page->HMG23->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG24 = <?= $Page->HMG24->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HMG25 = <?= $Page->HMG25->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH14 = <?= $Page->GnRH14->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH15 = <?= $Page->GnRH15->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH16 = <?= $Page->GnRH16->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH17 = <?= $Page->GnRH17->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH18 = <?= $Page->GnRH18->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH19 = <?= $Page->GnRH19->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH20 = <?= $Page->GnRH20->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH21 = <?= $Page->GnRH21->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH22 = <?= $Page->GnRH22->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH23 = <?= $Page->GnRH23->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH24 = <?= $Page->GnRH24->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.GnRH25 = <?= $Page->GnRH25->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.TUBAL_PATENCY = <?= $Page->TUBAL_PATENCY->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.HSG = <?= $Page->HSG->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.DHL = <?= $Page->DHL->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.UTERINE_PROBLEMS = <?= $Page->UTERINE_PROBLEMS->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.W_COMORBIDS = <?= $Page->W_COMORBIDS->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.H_COMORBIDS = <?= $Page->H_COMORBIDS->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.SEXUAL_DYSFUNCTION = <?= $Page->SEXUAL_DYSFUNCTION->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.FOLLICLE_STATUS = <?= $Page->FOLLICLE_STATUS->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.NUMBER_OF_IUI = <?= $Page->NUMBER_OF_IUI->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.PROCEDURE = <?= $Page->PROCEDURE->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.LUTEAL_SUPPORT = <?= $Page->LUTEAL_SUPPORT->toClientList($Page) ?>;
    fivf_stimulation_chartadd.lists.SPECIFIC_MATERNAL_PROBLEMS = <?= $Page->SPECIFIC_MATERNAL_PROBLEMS->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_stimulation_chartadd" id="fivf_stimulation_chartadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_ivf_stimulation_chartadd">
<div id="ct_IvfStimulationChartAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_stimulation_chartadd", "tpm_ivf_stimulation_chartadd", "ivf_stimulation_chartadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
