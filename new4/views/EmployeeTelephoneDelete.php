...
$Page->showMessage();
?>
<form name="femployee_telephonedelete" id="femployee_telephonedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th class="<?= $Page->HospID->headerCellClass() ?>"><span id="elh_employee_telephone_HospID" class="employee_telephone_HospID"><?= $Page->HospID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_employee_telephone_HospID" class="employee_telephone_HospID">
