...
// Page object
$HrTrainingsessionsEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fhr_trainingsessionsedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fhr_trainingsessionsedit = currentForm = new ew.Form("fhr_trainingsessionsedit", "edit");
    ...
    fhr_trainingsessionsedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fhr_trainingsessionsedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fhr_trainingsessionsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_trainingsessionsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhr_trainingsessionsedit.lists.deliveryMethod = <?= $Page->deliveryMethod->toClientList($Page) ?>;
    fhr_trainingsessionsedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fhr_trainingsessionsedit.lists.attendanceType = <?= $Page->attendanceType->toClientList($Page) ?>;
    fhr_trainingsessionsedit.lists.requireProof = <?= $Page->requireProof->toClientList($Page) ?>;
    loadjs.done("fhr_trainingsessionsedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_trainingsessionsedit" id="fhr_trainingsessionsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_hr_trainingsessions_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_hr_trainingsessions_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="hr_trainingsessions" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fhr_trainingsessionsedit", "datetimepicker"], function() {
