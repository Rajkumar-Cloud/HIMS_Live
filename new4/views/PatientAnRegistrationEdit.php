...
loadjs.ready("head", function () {
    ...
    fpatient_an_registrationedit.lists.MenstrualHistory = <?= $Page->MenstrualHistory->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PreviousHistoryofGDM = <?= $Page->PreviousHistoryofGDM->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PreviousHistorofPIH = <?= $Page->PreviousHistorofPIH->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PreviousHistoryofIUGR = <?= $Page->PreviousHistoryofIUGR->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PreviousHistoryofOligohydramnios = <?= $Page->PreviousHistoryofOligohydramnios->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PreviousHistoryofPreterm = <?= $Page->PreviousHistoryofPreterm->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PastMedicalHistory = <?= $Page->PastMedicalHistory->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.PastSurgicalHistory = <?= $Page->PastSurgicalHistory->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.FamilyHistory = <?= $Page->FamilyHistory->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.Bleeding = <?= $Page->Bleeding->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.Miscarriage = <?= $Page->Miscarriage->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.ModeOfDelivery = <?= $Page->ModeOfDelivery->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.NDS = <?= $Page->NDS->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.NDP = <?= $Page->NDP->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.VaccumS = <?= $Page->VaccumS->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.VaccumP = <?= $Page->VaccumP->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.ForcepsS = <?= $Page->ForcepsS->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.ForcepsP = <?= $Page->ForcepsP->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.ElectiveS = <?= $Page->ElectiveS->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.ElectiveP = <?= $Page->ElectiveP->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.EmergencyS = <?= $Page->EmergencyS->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.EmergencyP = <?= $Page->EmergencyP->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.Maturity = <?= $Page->Maturity->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.SpillOverReasons = <?= $Page->SpillOverReasons->toClientList($Page) ?>;
    fpatient_an_registrationedit.lists.ANClosed = <?= $Page->ANClosed->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_an_registrationedit" id="fpatient_an_registrationedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_patient_an_registration_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_patient_an_registration_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpm_patient_an_registrationedit">
<div id="ct_PatientAnRegistrationEdit"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_an_registrationedit", "tpm_patient_an_registrationedit", "patient_an_registrationedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
