...
<script>
if (!ew.vars.tables.ivf_follow_up_tracking) ew.vars.tables.ivf_follow_up_tracking = <?= JsonEncode(GetClientVar("tables", "ivf_follow_up_tracking")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fivf_follow_up_trackingdelete" id="fivf_follow_up_trackingdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->MReadMore->Visible) { // MReadMore ?>
        <th class="<?= $Page->MReadMore->headerCellClass() ?>"><span id="elh_ivf_follow_up_tracking_MReadMore" class="ivf_follow_up_tracking_MReadMore"><?= $Page->MReadMore->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->MReadMore->Visible) { // MReadMore ?>
        <td <?= $Page->MReadMore->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_follow_up_tracking_MReadMore" class="ivf_follow_up_tracking_MReadMore">
