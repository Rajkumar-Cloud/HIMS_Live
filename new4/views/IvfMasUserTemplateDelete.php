...
$Page->showMessage();
?>
<form name="fivf_mas_user_templatedelete" id="fivf_mas_user_templatedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
