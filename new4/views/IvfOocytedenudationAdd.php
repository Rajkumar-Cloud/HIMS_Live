...
// Page object
$IvfOocytedenudationAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_oocytedenudationadd;
loadjs.ready("head", function () {
    ...
    fivf_oocytedenudationadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_oocytedenudationadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_oocytedenudationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_oocytedenudationadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_oocytedenudationadd.lists.patient2 = <?= $Page->patient2->toClientList($Page) ?>;
    fivf_oocytedenudationadd.lists.OocyteOrgin = <?= $Page->OocyteOrgin->toClientList($Page) ?>;
    fivf_oocytedenudationadd.lists.patient1 = <?= $Page->patient1->toClientList($Page) ?>;
    fivf_oocytedenudationadd.lists.OocyteType = <?= $Page->OocyteType->toClientList($Page) ?>;
    fivf_oocytedenudationadd.lists.patient3 = <?= $Page->patient3->toClientList($Page) ?>;
    fivf_oocytedenudationadd.lists.patient4 = <?= $Page->patient4->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_oocytedenudationadd" id="fivf_oocytedenudationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<template id="tpm_ivf_oocytedenudationadd">
<div id="ct_IvfOocytedenudationAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_oocytedenudationadd", "tpm_ivf_oocytedenudationadd", "ivf_oocytedenudationadd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
