...
<script>
if (!ew.vars.tables.store_suppliers) ew.vars.tables.store_suppliers = <?= JsonEncode(GetClientVar("tables", "store_suppliers")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fstore_suppliersdelete" id="fstore_suppliersdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th class="<?= $Page->HospID->headerCellClass() ?>"><span id="elh_store_suppliers_HospID" class="store_suppliers_HospID"><?= $Page->HospID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->BranchID->Visible) { // BranchID ?>
        <th class="<?= $Page->BranchID->headerCellClass() ?>"><span id="elh_store_suppliers_BranchID" class="store_suppliers_BranchID"><?= $Page->BranchID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <th class="<?= $Page->StoreID->headerCellClass() ?>"><span id="elh_store_suppliers_StoreID" class="store_suppliers_StoreID"><?= $Page->StoreID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_store_suppliers_HospID" class="store_suppliers_HospID">
...
<span id="el<?= $Page->RowCount ?>_store_suppliers_BranchID" class="store_suppliers_BranchID">
...
<span id="el<?= $Page->RowCount ?>_store_suppliers_StoreID" class="store_suppliers_StoreID">
