...
$Page->showMessage();
?>
<form name="fpharmacy_batchmasview" id="fpharmacy_batchmasview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->PUnit->Visible) { // PUnit ?>
    <tr id="r_PUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_batchmas_PUnit"><?= $Page->PUnit->caption() ?></span></td>
...
<?php if ($Page->SUnit->Visible) { // SUnit ?>
    <tr id="r_SUnit">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_batchmas_SUnit"><?= $Page->SUnit->caption() ?></span></td>
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <tr id="r_PurValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_batchmas_PurValue"><?= $Page->PurValue->caption() ?></span></td>
...
<?php if ($Page->PurRate->Visible) { // PurRate ?>
    <tr id="r_PurRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_batchmas_PurRate"><?= $Page->PurRate->caption() ?></span></td>
