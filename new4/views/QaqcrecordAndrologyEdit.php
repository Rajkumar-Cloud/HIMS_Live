...
// Page object
$QaqcrecordAndrologyEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fqaqcrecord_andrologyedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fqaqcrecord_andrologyedit = currentForm = new ew.Form("fqaqcrecord_andrologyedit", "edit");
    ...
    fqaqcrecord_andrologyedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fqaqcrecord_andrologyedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fqaqcrecord_andrologyedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fqaqcrecord_andrologyedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fqaqcrecord_andrologyedit.lists.LN2_Checked = <?= $Page->LN2_Checked->toClientList($Page) ?>;
    fqaqcrecord_andrologyedit.lists.Incubator_Cleaned = <?= $Page->Incubator_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_andrologyedit.lists.LAF_Cleaned = <?= $Page->LAF_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_andrologyedit.lists.REF_Cleaned = <?= $Page->REF_Cleaned->toClientList($Page) ?>;
    fqaqcrecord_andrologyedit.lists.Heating_Cleaned = <?= $Page->Heating_Cleaned->toClientList($Page) ?>;
    loadjs.done("fqaqcrecord_andrologyedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fqaqcrecord_andrologyedit" id="fqaqcrecord_andrologyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_qaqcrecord_andrology_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_qaqcrecord_andrology_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="qaqcrecord_andrology" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fqaqcrecord_andrologyedit", "datetimepicker"], function() {
