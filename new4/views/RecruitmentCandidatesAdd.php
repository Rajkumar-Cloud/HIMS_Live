...
// Page object
$RecruitmentCandidatesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var frecruitment_candidatesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    frecruitment_candidatesadd = currentForm = new ew.Form("frecruitment_candidatesadd", "add");
    ...
    frecruitment_candidatesadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = frecruitment_candidatesadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    frecruitment_candidatesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    frecruitment_candidatesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    frecruitment_candidatesadd.lists.gender = <?= $Page->gender->toClientList($Page) ?>;
    frecruitment_candidatesadd.lists.marital_status = <?= $Page->marital_status->toClientList($Page) ?>;
    loadjs.done("frecruitment_candidatesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="frecruitment_candidatesadd" id="frecruitment_candidatesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["frecruitment_candidatesadd", "datetimepicker"], function() {
