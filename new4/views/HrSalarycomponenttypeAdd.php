...
// Page object
$HrSalarycomponenttypeAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fhr_salarycomponenttypeadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fhr_salarycomponenttypeadd = currentForm = new ew.Form("fhr_salarycomponenttypeadd", "add");
    ...
    fhr_salarycomponenttypeadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fhr_salarycomponenttypeadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fhr_salarycomponenttypeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_salarycomponenttypeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fhr_salarycomponenttypeadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_salarycomponenttypeadd" id="fhr_salarycomponenttypeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
