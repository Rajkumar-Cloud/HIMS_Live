...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "view_dashboard_service_summary")) ?>,
        fields = currentTable.fields;
    fview_dashboard_service_summarylistsrch.addFields([
    ...
    // Set invalid fields
    $(function() {
        fview_dashboard_service_summarylistsrch.setInvalid();
    });

    // Validate form
    fview_dashboard_service_summarylistsrch.validate = function () {
    ...
    // Form_CustomValidate
    fview_dashboard_service_summarylistsrch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_dashboard_service_summarylistsrch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
<form name="fview_dashboard_service_summarylistsrch" id="fview_dashboard_service_summarylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<input type="<?= $Page->createdDate->getInputTextType() ?>" data-table="view_dashboard_service_summary" data-field="x_createdDate" data-format="7" name="x_createdDate" id="x_createdDate" placeholder="<?= HtmlEncode($Page->createdDate->getPlaceHolder()) ?>" value="<?= $Page->createdDate->EditValue ?>"<?= $Page->createdDate->editAttributes() ?>>
...
<input type="<?= $Page->createdDate->getInputTextType() ?>" data-table="view_dashboard_service_summary" data-field="x_createdDate" data-format="7" name="y_createdDate" id="y_createdDate" placeholder="<?= HtmlEncode($Page->createdDate->getPlaceHolder()) ?>" value="<?= $Page->createdDate->EditValue2 ?>"<?= $Page->createdDate->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->createdDate->getErrorMessage(false) ?></div>
<?php if (!$Page->createdDate->ReadOnly && !$Page->createdDate->Disabled && !isset($Page->createdDate->EditAttrs["readonly"]) && !isset($Page->createdDate->EditAttrs["disabled"])) { ?>
<script>
loadjs.ready(["fview_dashboard_service_summarylistsrch", "datetimepicker"], function() {
...
<?php } ?>
<form name="fview_dashboard_service_summarylist" id="fview_dashboard_service_summarylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->SubTotal->Visible) { // SubTotal ?>
        <th data-name="SubTotal" class="<?= $Page->SubTotal->headerCellClass() ?>"><div id="elh_view_dashboard_service_summary_SubTotal" class="view_dashboard_service_summary_SubTotal"><?= $Page->renderSort($Page->SubTotal) ?></div></th>
<?php } ?>
<?php if ($Page->createdDate->Visible) { // createdDate ?>
...
<?php if ($Page->ItemCode->Visible) { // ItemCode ?>
        <th data-name="ItemCode" class="<?= $Page->ItemCode->headerCellClass() ?>"><div id="elh_view_dashboard_service_summary_ItemCode" class="view_dashboard_service_summary_ItemCode"><?= $Page->renderSort($Page->ItemCode) ?></div></th>
<?php } ?>
<?php if ($Page->PatientId->Visible) { // PatientId ?>
        <th data-name="PatientId" class="<?= $Page->PatientId->headerCellClass() ?>"><div id="elh_view_dashboard_service_summary_PatientId" class="view_dashboard_service_summary_PatientId"><?= $Page->renderSort($Page->PatientId) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_view_dashboard_service_summary_SubTotal">
...
<span id="el<?= $Page->RowCount ?>_view_dashboard_service_summary_ItemCode">
...
<span id="el<?= $Page->RowCount ?>_view_dashboard_service_summary_PatientId">
...
?>
    <?php if ($Page->DEPARTMENT->Visible) { // DEPARTMENT ?>
        <td data-name="DEPARTMENT" class="<?= $Page->DEPARTMENT->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_DEPARTMENT" class="view_dashboard_service_summary_DEPARTMENT">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->SubTotal->Visible) { // SubTotal ?>
        <td data-name="SubTotal" class="<?= $Page->SubTotal->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_SubTotal" class="view_dashboard_service_summary_SubTotal">
        <span class="ew-aggregate"><?= $Language->phrase("TOTAL") ?></span><span class="ew-aggregate-value">
        <?= $Page->SubTotal->ViewValue ?></span>
        </span></td>
    <?php } ?>
    <?php if ($Page->createdDate->Visible) { // createdDate ?>
        <td data-name="createdDate" class="<?= $Page->createdDate->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_createdDate" class="view_dashboard_service_summary_createdDate">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->HospID->Visible) { // HospID ?>
        <td data-name="HospID" class="<?= $Page->HospID->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_HospID" class="view_dashboard_service_summary_HospID">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->vid->Visible) { // vid ?>
        <td data-name="vid" class="<?= $Page->vid->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_vid" class="view_dashboard_service_summary_vid">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->ItemCode->Visible) { // ItemCode ?>
        <td data-name="ItemCode" class="<?= $Page->ItemCode->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_ItemCode" class="view_dashboard_service_summary_ItemCode">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->PatientId->Visible) { // PatientId ?>
        <td data-name="PatientId" class="<?= $Page->PatientId->footerCellClass() ?>"><span id="elf_view_dashboard_service_summary_PatientId" class="view_dashboard_service_summary_PatientId">
        &nbsp;
        </span></td>
    <?php } ?>
<?php
