...
<form name="fview_labreport_printlistsrch" id="fview_labreport_printlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fview_labreport_printlist" id="fview_labreport_printlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
