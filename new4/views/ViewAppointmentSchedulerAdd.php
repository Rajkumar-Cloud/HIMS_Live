...
// Page object
$ViewAppointmentSchedulerAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_appointment_scheduleradd;
loadjs.ready("head", function () {
    ...
    fview_appointment_scheduleradd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_appointment_scheduleradd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_appointment_scheduleradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_appointment_scheduleradd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_appointment_scheduleradd.lists.patientID = <?= $Page->patientID->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.PatientType = <?= $Page->PatientType->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.Referal = <?= $Page->Referal->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.DoctorName = <?= $Page->DoctorName->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.appointment_type = <?= $Page->appointment_type->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.Notified = <?= $Page->Notified->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.WhereDidYouHear = <?= $Page->WhereDidYouHear->toClientList($Page) ?>;
    fview_appointment_scheduleradd.lists.PatientTypee = <?= $Page->PatientTypee->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fview_appointment_scheduleradd" id="fview_appointment_scheduleradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->patientID->Visible) { // patientID ?>
    <div id="r_patientID" class="form-group row">
        <label id="elh_view_appointment_scheduler_patientID" for="x_patientID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_patientID"><?= $Page->patientID->caption() ?><?= $Page->patientID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->patientID->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_patientID"><span id="el_view_appointment_scheduler_patientID">
...
<?php if ($Page->patientName->Visible) { // patientName ?>
    <div id="r_patientName" class="form-group row">
        <label id="elh_view_appointment_scheduler_patientName" for="x_patientName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_patientName"><?= $Page->patientName->caption() ?><?= $Page->patientName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->patientName->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_patientName"><span id="el_view_appointment_scheduler_patientName">
...
<?php if ($Page->MobileNumber->Visible) { // MobileNumber ?>
    <div id="r_MobileNumber" class="form-group row">
        <label id="elh_view_appointment_scheduler_MobileNumber" for="x_MobileNumber" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_MobileNumber"><?= $Page->MobileNumber->caption() ?><?= $Page->MobileNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MobileNumber->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_MobileNumber"><span id="el_view_appointment_scheduler_MobileNumber">
...
<?php if ($Page->Purpose->Visible) { // Purpose ?>
    <div id="r_Purpose" class="form-group row">
        <label id="elh_view_appointment_scheduler_Purpose" for="x_Purpose" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_Purpose"><?= $Page->Purpose->caption() ?><?= $Page->Purpose->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Purpose->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_Purpose"><span id="el_view_appointment_scheduler_Purpose">
...
<?php if ($Page->PatientType->Visible) { // PatientType ?>
    <div id="r_PatientType" class="form-group row">
        <label id="elh_view_appointment_scheduler_PatientType" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_PatientType"><?= $Page->PatientType->caption() ?><?= $Page->PatientType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientType->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_PatientType"><span id="el_view_appointment_scheduler_PatientType">
...
<?php if ($Page->Referal->Visible) { // Referal ?>
    <div id="r_Referal" class="form-group row">
        <label id="elh_view_appointment_scheduler_Referal" for="x_Referal" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_Referal"><?= $Page->Referal->caption() ?><?= $Page->Referal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Referal->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_Referal"><span id="el_view_appointment_scheduler_Referal">
...
<?php if ($Page->start_date->Visible) { // start_date ?>
    <div id="r_start_date" class="form-group row">
        <label id="elh_view_appointment_scheduler_start_date" for="x_start_date" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_start_date"><?= $Page->start_date->caption() ?><?= $Page->start_date->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->start_date->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_start_date"><span id="el_view_appointment_scheduler_start_date">
...
<?php if ($Page->DoctorName->Visible) { // DoctorName ?>
    <div id="r_DoctorName" class="form-group row">
        <label id="elh_view_appointment_scheduler_DoctorName" for="x_DoctorName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_DoctorName"><?= $Page->DoctorName->caption() ?><?= $Page->DoctorName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DoctorName->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_DoctorName"><span id="el_view_appointment_scheduler_DoctorName">
...
<?php if ($Page->end_date->Visible) { // end_date ?>
    <div id="r_end_date" class="form-group row">
        <label id="elh_view_appointment_scheduler_end_date" for="x_end_date" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_end_date"><?= $Page->end_date->caption() ?><?= $Page->end_date->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->end_date->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_end_date"><span id="el_view_appointment_scheduler_end_date">
...
<?php if ($Page->DoctorID->Visible) { // DoctorID ?>
    <div id="r_DoctorID" class="form-group row">
        <label id="elh_view_appointment_scheduler_DoctorID" for="x_DoctorID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_DoctorID"><?= $Page->DoctorID->caption() ?><?= $Page->DoctorID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DoctorID->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_DoctorID"><span id="el_view_appointment_scheduler_DoctorID">
...
<?php if ($Page->DoctorCode->Visible) { // DoctorCode ?>
    <div id="r_DoctorCode" class="form-group row">
        <label id="elh_view_appointment_scheduler_DoctorCode" for="x_DoctorCode" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_DoctorCode"><?= $Page->DoctorCode->caption() ?><?= $Page->DoctorCode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DoctorCode->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_DoctorCode"><span id="el_view_appointment_scheduler_DoctorCode">
...
<?php if ($Page->Department->Visible) { // Department ?>
    <div id="r_Department" class="form-group row">
        <label id="elh_view_appointment_scheduler_Department" for="x_Department" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_Department"><?= $Page->Department->caption() ?><?= $Page->Department->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Department->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_Department"><span id="el_view_appointment_scheduler_Department">
...
<?php if ($Page->AppointmentStatus->Visible) { // AppointmentStatus ?>
    <div id="r_AppointmentStatus" class="form-group row">
        <label id="elh_view_appointment_scheduler_AppointmentStatus" for="x_AppointmentStatus" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_AppointmentStatus"><?= $Page->AppointmentStatus->caption() ?><?= $Page->AppointmentStatus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AppointmentStatus->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_AppointmentStatus"><span id="el_view_appointment_scheduler_AppointmentStatus">
...
<?php if ($Page->status->Visible) { // status ?>
    <div id="r_status" class="form-group row">
        <label id="elh_view_appointment_scheduler_status" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_status"><?= $Page->status->caption() ?><?= $Page->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->status->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_status"><span id="el_view_appointment_scheduler_status">
...
<?php if ($Page->scheduler_id->Visible) { // scheduler_id ?>
    <div id="r_scheduler_id" class="form-group row">
        <label id="elh_view_appointment_scheduler_scheduler_id" for="x_scheduler_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_scheduler_id"><?= $Page->scheduler_id->caption() ?><?= $Page->scheduler_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->scheduler_id->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_scheduler_id"><span id="el_view_appointment_scheduler_scheduler_id">
...
<?php if ($Page->text->Visible) { // text ?>
    <div id="r_text" class="form-group row">
        <label id="elh_view_appointment_scheduler_text" for="x_text" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_text"><?= $Page->text->caption() ?><?= $Page->text->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->text->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_text"><span id="el_view_appointment_scheduler_text">
...
<?php if ($Page->appointment_status->Visible) { // appointment_status ?>
    <div id="r_appointment_status" class="form-group row">
        <label id="elh_view_appointment_scheduler_appointment_status" for="x_appointment_status" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_appointment_status"><?= $Page->appointment_status->caption() ?><?= $Page->appointment_status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->appointment_status->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_appointment_status"><span id="el_view_appointment_scheduler_appointment_status">
...
<?php if ($Page->PId->Visible) { // PId ?>
    <div id="r_PId" class="form-group row">
        <label id="elh_view_appointment_scheduler_PId" for="x_PId" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_PId"><?= $Page->PId->caption() ?><?= $Page->PId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PId->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_PId"><span id="el_view_appointment_scheduler_PId">
...
<?php if ($Page->SchEmail->Visible) { // SchEmail ?>
    <div id="r_SchEmail" class="form-group row">
        <label id="elh_view_appointment_scheduler_SchEmail" for="x_SchEmail" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_SchEmail"><?= $Page->SchEmail->caption() ?><?= $Page->SchEmail->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SchEmail->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_SchEmail"><span id="el_view_appointment_scheduler_SchEmail">
...
<?php if ($Page->appointment_type->Visible) { // appointment_type ?>
    <div id="r_appointment_type" class="form-group row">
        <label id="elh_view_appointment_scheduler_appointment_type" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_appointment_type"><?= $Page->appointment_type->caption() ?><?= $Page->appointment_type->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->appointment_type->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_appointment_type"><span id="el_view_appointment_scheduler_appointment_type">
...
<?php if ($Page->Notified->Visible) { // Notified ?>
    <div id="r_Notified" class="form-group row">
        <label id="elh_view_appointment_scheduler_Notified" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_Notified"><?= $Page->Notified->caption() ?><?= $Page->Notified->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Notified->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_Notified"><span id="el_view_appointment_scheduler_Notified">
...
<?php if ($Page->Notes->Visible) { // Notes ?>
    <div id="r_Notes" class="form-group row">
        <label id="elh_view_appointment_scheduler_Notes" for="x_Notes" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_Notes"><?= $Page->Notes->caption() ?><?= $Page->Notes->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Notes->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_Notes"><span id="el_view_appointment_scheduler_Notes">
...
<?php if ($Page->paymentType->Visible) { // paymentType ?>
    <div id="r_paymentType" class="form-group row">
        <label id="elh_view_appointment_scheduler_paymentType" for="x_paymentType" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_paymentType"><?= $Page->paymentType->caption() ?><?= $Page->paymentType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->paymentType->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_paymentType"><span id="el_view_appointment_scheduler_paymentType">
...
<?php if ($Page->WhereDidYouHear->Visible) { // WhereDidYouHear ?>
    <div id="r_WhereDidYouHear" class="form-group row">
        <label id="elh_view_appointment_scheduler_WhereDidYouHear" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_WhereDidYouHear"><?= $Page->WhereDidYouHear->caption() ?><?= $Page->WhereDidYouHear->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->WhereDidYouHear->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_WhereDidYouHear"><span id="el_view_appointment_scheduler_WhereDidYouHear">
...
<?php if ($Page->PatientTypee->Visible) { // PatientTypee ?>
    <div id="r_PatientTypee" class="form-group row">
        <label id="elh_view_appointment_scheduler_PatientTypee" for="x_PatientTypee" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_view_appointment_scheduler_PatientTypee"><?= $Page->PatientTypee->caption() ?><?= $Page->PatientTypee->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientTypee->cellAttributes() ?>>
<template id="tpx_view_appointment_scheduler_PatientTypee"><span id="el_view_appointment_scheduler_PatientTypee">
    <select
        id="x_PatientTypee"
        name="x_PatientTypee"
...
<template id="tpm_view_appointment_scheduleradd">
<div id="ct_ViewAppointmentSchedulerAdd"><style type="text/css" >
.form-control {
	display: table;
	max-width: none;
}
...
<table class="ew-table" style="width:100%;">
	 <tbody>
		<tr><td class="bg-warning text-warning"><slot class="ew-slot" name="tpc_view_appointment_scheduler_start_date"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_start_date"></slot></td><td class="bg-warning text-warning"><slot class="ew-slot" name="tpc_view_appointment_scheduler_end_date"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_end_date"></slot></td><td><slot class="ew-slot" name="tpc_view_appointment_scheduler_PatientType"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_PatientType"></slot></td></tr>
	</tbody>
</table>
<table class="ew-table"  style="width:100%;">
	 <tbody>
	 	<tr>
		<td><slot class="ew-slot" name="tpc_view_appointment_scheduler_patientID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_patientID"></slot></td><td><slot class="ew-slot" name="tpc_view_appointment_scheduler_patientName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_patientName"></slot></td>
		<td><slot class="ew-slot" name="tpc_view_appointment_scheduler_PatientTypee"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_PatientTypee"></slot></td>
	</tr>
	</tbody>
</table>
<table id="addNewPatient" class="ew-table"  style="width:100%;background-color:#FF33A8;">
	 <tbody>	
		<tr>
			<td  name="addNewPatient"><slot class="ew-slot" name="tpx_tittle"></slot></td>
			<td>
			<slot class="ew-slot" name="tpx_gendar"></slot>
</td>
			<td>
			<slot class="ew-slot" name="tpx_Dob"></slot>
			</td>
			<td>
			<slot class="ew-slot" name="tpx_Age"></slot>
			</td>
			<td>
...
<table class="ew-table"  style="width:100%;">
	 <tbody>
		<tr><td><slot class="ew-slot" name="tpc_view_appointment_scheduler_PId"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_PId"></slot></td><td><slot class="ew-slot" name="tpc_view_appointment_scheduler_MobileNumber"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_MobileNumber"></slot></td></tr>
		<tr><td><slot class="ew-slot" name="tpc_view_appointment_scheduler_SchEmail"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_SchEmail"></slot></td><td><slot class="ew-slot" name="tpc_view_appointment_scheduler_Notes"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_Notes"></slot></td></tr>
	</tbody>
</table>
<table class="ew-table"  style="width:100%;">
	 <tbody>
		<tr><td class="bg-success text-success"><slot class="ew-slot" name="tpc_view_appointment_scheduler_DoctorID"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_DoctorID"></slot></td><td class="bg-success text-success"><slot class="ew-slot" name="tpc_view_appointment_scheduler_DoctorName"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_DoctorName"></slot></td>
		<td class="bg-success text-success"><slot class="ew-slot" name="tpc_view_appointment_scheduler_DoctorCode"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_DoctorCode"></slot></td><td class="bg-success text-success"><slot class="ew-slot" name="tpc_view_appointment_scheduler_Department"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_Department"></slot></td></tr>
	</tbody>
</table>
<table class="ew-table"  style="width:100%;">
	 <tbody>
		<tr><td class="bg-danger text-danger"><slot class="ew-slot" name="tpc_view_appointment_scheduler_Referal"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_Referal"></slot></td><td class="bg-danger text-danger"><slot class="ew-slot" name="tpc_view_appointment_scheduler_Purpose"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_Purpose"></slot></td></tr>
	</tbody>
</table>
<table class="ew-table"  style="width:100%;">
	 <tbody>	
		<tr>
			<td><slot class="ew-slot" name="tpc_view_appointment_scheduler_WhereDidYouHear"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_WhereDidYouHear"></slot></td>
		</tr>
		<tr>
			<td><slot class="ew-slot" name="tpc_view_appointment_scheduler_status"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_appointment_scheduler_status"></slot></td>
		</tr>
	</tbody>
</table>
</div>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_appointment_scheduleradd", "tpm_view_appointment_scheduleradd", "view_appointment_scheduleradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
