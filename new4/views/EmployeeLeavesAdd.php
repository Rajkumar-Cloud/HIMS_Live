...
// Page object
$EmployeeLeavesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_leavesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_leavesadd = currentForm = new ew.Form("femployee_leavesadd", "add");
    ...
    // Form_CustomValidate
    femployee_leavesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_leavesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_leavesadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_leavesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_leavesadd" id="femployee_leavesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_leavesadd", "datetimepicker"], function() {
