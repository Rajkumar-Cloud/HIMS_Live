...
<form name="fpres_genericinteractionslistsrch" id="fpres_genericinteractionslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpres_genericinteractionslist" id="fpres_genericinteractionslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
        <th data-name="Remarks" class="<?= $Page->Remarks->headerCellClass() ?>"><div id="elh_pres_genericinteractions_Remarks" class="pres_genericinteractions_Remarks"><?= $Page->renderSort($Page->Remarks) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_pres_genericinteractions_Remarks">
