...
loadjs.ready("head", function () {
    ...
    fpharmacy_purchaseorderedit.lists.PRC = <?= $Page->PRC->toClientList($Page) ?>;
    fpharmacy_purchaseorderedit.lists.PC = <?= $Page->PC->toClientList($Page) ?>;
    fpharmacy_purchaseorderedit.lists.Received = <?= $Page->Received->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_purchaseorderedit" id="fpharmacy_purchaseorderedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpharmacy_purchaseorderedit"], function() {
    fpharmacy_purchaseorderedit.createAutoSuggest(Object.assign({"id":"x_PRC","forceSelect":true}, ew.vars.tables.pharmacy_purchaseorder.fields.PRC.autoSuggestOptions));
});
</script>
