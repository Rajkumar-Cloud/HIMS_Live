...
// Page object
$StorePaymentView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fstore_paymentview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fstore_paymentview = currentForm = new ew.Form("fstore_paymentview", "view");
    loadjs.done("fstore_paymentview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fstore_paymentview" id="fstore_paymentview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->PAYNO->Visible) { // PAYNO ?>
    <tr id="r_PAYNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_PAYNO"><?= $Page->PAYNO->caption() ?></span></td>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <tr id="r_DT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_DT"><?= $Page->DT->caption() ?></span></td>
...
<?php if ($Page->YM->Visible) { // YM ?>
    <tr id="r_YM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_YM"><?= $Page->YM->caption() ?></span></td>
...
<?php if ($Page->PC->Visible) { // PC ?>
    <tr id="r_PC">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_PC"><?= $Page->PC->caption() ?></span></td>
...
<?php if ($Page->Customercode->Visible) { // Customercode ?>
    <tr id="r_Customercode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Customercode"><?= $Page->Customercode->caption() ?></span></td>
...
<?php if ($Page->Customername->Visible) { // Customername ?>
    <tr id="r_Customername">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Customername"><?= $Page->Customername->caption() ?></span></td>
...
<?php if ($Page->pharmacy_pocol->Visible) { // pharmacy_pocol ?>
    <tr id="r_pharmacy_pocol">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_pharmacy_pocol"><?= $Page->pharmacy_pocol->caption() ?></span></td>
...
<?php if ($Page->Address1->Visible) { // Address1 ?>
    <tr id="r_Address1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Address1"><?= $Page->Address1->caption() ?></span></td>
...
<?php if ($Page->Address2->Visible) { // Address2 ?>
    <tr id="r_Address2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Address2"><?= $Page->Address2->caption() ?></span></td>
...
<?php if ($Page->Address3->Visible) { // Address3 ?>
    <tr id="r_Address3">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Address3"><?= $Page->Address3->caption() ?></span></td>
...
<?php if ($Page->State->Visible) { // State ?>
    <tr id="r_State">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_State"><?= $Page->State->caption() ?></span></td>
...
<?php if ($Page->Pincode->Visible) { // Pincode ?>
    <tr id="r_Pincode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Pincode"><?= $Page->Pincode->caption() ?></span></td>
...
<?php if ($Page->Phone->Visible) { // Phone ?>
    <tr id="r_Phone">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Phone"><?= $Page->Phone->caption() ?></span></td>
...
<?php if ($Page->Fax->Visible) { // Fax ?>
    <tr id="r_Fax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Fax"><?= $Page->Fax->caption() ?></span></td>
...
<?php if ($Page->EEmail->Visible) { // EEmail ?>
    <tr id="r_EEmail">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_EEmail"><?= $Page->EEmail->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->PharmacyID->Visible) { // PharmacyID ?>
    <tr id="r_PharmacyID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_PharmacyID"><?= $Page->PharmacyID->caption() ?></span></td>
...
<?php if ($Page->BillTotalValue->Visible) { // BillTotalValue ?>
    <tr id="r_BillTotalValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_BillTotalValue"><?= $Page->BillTotalValue->caption() ?></span></td>
...
<?php if ($Page->GRNTotalValue->Visible) { // GRNTotalValue ?>
    <tr id="r_GRNTotalValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_GRNTotalValue"><?= $Page->GRNTotalValue->caption() ?></span></td>
...
<?php if ($Page->BillDiscount->Visible) { // BillDiscount ?>
    <tr id="r_BillDiscount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_BillDiscount"><?= $Page->BillDiscount->caption() ?></span></td>
...
<?php if ($Page->BillUpload->Visible) { // BillUpload ?>
    <tr id="r_BillUpload">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_BillUpload"><?= $Page->BillUpload->caption() ?></span></td>
...
<?php if ($Page->TransPort->Visible) { // TransPort ?>
    <tr id="r_TransPort">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_TransPort"><?= $Page->TransPort->caption() ?></span></td>
...
<?php if ($Page->AnyOther->Visible) { // AnyOther ?>
    <tr id="r_AnyOther">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_AnyOther"><?= $Page->AnyOther->caption() ?></span></td>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
    <tr id="r_voucher_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_voucher_type"><?= $Page->voucher_type->caption() ?></span></td>
...
<?php if ($Page->Details->Visible) { // Details ?>
    <tr id="r_Details">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Details"><?= $Page->Details->caption() ?></span></td>
...
<?php if ($Page->ModeofPayment->Visible) { // ModeofPayment ?>
    <tr id="r_ModeofPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_ModeofPayment"><?= $Page->ModeofPayment->caption() ?></span></td>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <tr id="r_Amount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Amount"><?= $Page->Amount->caption() ?></span></td>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <tr id="r_BankName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_BankName"><?= $Page->BankName->caption() ?></span></td>
...
<?php if ($Page->AccountNumber->Visible) { // AccountNumber ?>
    <tr id="r_AccountNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_AccountNumber"><?= $Page->AccountNumber->caption() ?></span></td>
...
<?php if ($Page->chequeNumber->Visible) { // chequeNumber ?>
    <tr id="r_chequeNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_chequeNumber"><?= $Page->chequeNumber->caption() ?></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Remarks"><?= $Page->Remarks->caption() ?></span></td>
...
<?php if ($Page->SeectPaymentMode->Visible) { // SeectPaymentMode ?>
    <tr id="r_SeectPaymentMode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_SeectPaymentMode"><?= $Page->SeectPaymentMode->caption() ?></span></td>
...
<?php if ($Page->PaidAmount->Visible) { // PaidAmount ?>
    <tr id="r_PaidAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_PaidAmount"><?= $Page->PaidAmount->caption() ?></span></td>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <tr id="r_Currency">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_Currency"><?= $Page->Currency->caption() ?></span></td>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <tr id="r_CardNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_CardNumber"><?= $Page->CardNumber->caption() ?></span></td>
...
<?php if ($Page->BranchID->Visible) { // BranchID ?>
    <tr id="r_BranchID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_BranchID"><?= $Page->BranchID->caption() ?></span></td>
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_payment_StoreID"><?= $Page->StoreID->caption() ?></span></td>
...
<?php
    if (in_array("store_grn", explode(",", $Page->getCurrentDetailTable())) && $store_grn->DetailView) {
?>
