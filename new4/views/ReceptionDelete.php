...
$Page->showMessage();
?>
<form name="freceptiondelete" id="freceptiondelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->MODEOFPAYMENT->Visible) { // MODE OF PAYMENT ?>
        <th class="<?= $Page->MODEOFPAYMENT->headerCellClass() ?>"><span id="elh_reception_MODEOFPAYMENT" class="reception_MODEOFPAYMENT"><?= $Page->MODEOFPAYMENT->caption() ?></span></th>
<?php } ?>
<?php if ($Page->NEXTREVIEWDATE->Visible) { // NEXT REVIEW DATE ?>
        <th class="<?= $Page->NEXTREVIEWDATE->headerCellClass() ?>"><span id="elh_reception_NEXTREVIEWDATE" class="reception_NEXTREVIEWDATE"><?= $Page->NEXTREVIEWDATE->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_reception_MODEOFPAYMENT" class="reception_MODEOFPAYMENT">
...
<span id="el<?= $Page->RowCount ?>_reception_NEXTREVIEWDATE" class="reception_NEXTREVIEWDATE">
