...
loadjs.ready("head", function () {
    ...
    fhospital_storeedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fhospital_storeedit.lists.HospId = <?= $Page->HospId->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fhospital_storeedit" id="fhospital_storeedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
