...
<form name="fstore_batchmaslistsrch" id="fstore_batchmaslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fstore_batchmaslist" id="fstore_batchmaslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->FRQ->Visible) { // FRQ ?>
        <th data-name="FRQ" class="<?= $Page->FRQ->headerCellClass() ?>"><div id="elh_store_batchmas_FRQ" class="store_batchmas_FRQ"><?= $Page->renderSort($Page->FRQ) ?></div></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_store_batchmas_HospID" class="store_batchmas_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php if ($Page->UM->Visible) { // UM ?>
        <th data-name="UM" class="<?= $Page->UM->headerCellClass() ?>"><div id="elh_store_batchmas_UM" class="store_batchmas_UM"><?= $Page->renderSort($Page->UM) ?></div></th>
<?php } ?>
<?php if ($Page->GENNAME->Visible) { // GENNAME ?>
        <th data-name="GENNAME" class="<?= $Page->GENNAME->headerCellClass() ?>"><div id="elh_store_batchmas_GENNAME" class="store_batchmas_GENNAME"><?= $Page->renderSort($Page->GENNAME) ?></div></th>
<?php } ?>
<?php if ($Page->BILLDATE->Visible) { // BILLDATE ?>
        <th data-name="BILLDATE" class="<?= $Page->BILLDATE->headerCellClass() ?>"><div id="elh_store_batchmas_BILLDATE" class="store_batchmas_BILLDATE"><?= $Page->renderSort($Page->BILLDATE) ?></div></th>
<?php } ?>
<?php if ($Page->PUnit->Visible) { // PUnit ?>
        <th data-name="PUnit" class="<?= $Page->PUnit->headerCellClass() ?>"><div id="elh_store_batchmas_PUnit" class="store_batchmas_PUnit"><?= $Page->renderSort($Page->PUnit) ?></div></th>
<?php } ?>
<?php if ($Page->SUnit->Visible) { // SUnit ?>
        <th data-name="SUnit" class="<?= $Page->SUnit->headerCellClass() ?>"><div id="elh_store_batchmas_SUnit" class="store_batchmas_SUnit"><?= $Page->renderSort($Page->SUnit) ?></div></th>
<?php } ?>
<?php if ($Page->PurValue->Visible) { // PurValue ?>
        <th data-name="PurValue" class="<?= $Page->PurValue->headerCellClass() ?>"><div id="elh_store_batchmas_PurValue" class="store_batchmas_PurValue"><?= $Page->renderSort($Page->PurValue) ?></div></th>
<?php } ?>
<?php if ($Page->PurRate->Visible) { // PurRate ?>
        <th data-name="PurRate" class="<?= $Page->PurRate->headerCellClass() ?>"><div id="elh_store_batchmas_PurRate" class="store_batchmas_PurRate"><?= $Page->renderSort($Page->PurRate) ?></div></th>
<?php } ?>
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <th data-name="StoreID" class="<?= $Page->StoreID->headerCellClass() ?>"><div id="elh_store_batchmas_StoreID" class="store_batchmas_StoreID"><?= $Page->renderSort($Page->StoreID) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_FRQ">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_HospID">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_UM">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_GENNAME">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_BILLDATE">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_PUnit">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_SUnit">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_PurValue">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_PurRate">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_StoreID">
