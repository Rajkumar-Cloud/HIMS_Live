...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "billing_type")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.billing_type)
        ew.vars.tables.billing_type = currentTable;
...
$Page->showMessage();
?>
<form name="fbilling_typeedit" id="fbilling_typeedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
