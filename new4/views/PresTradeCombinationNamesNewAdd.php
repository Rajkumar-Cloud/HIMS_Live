...
loadjs.ready("head", function () {
    ...
    fpres_trade_combination_names_newadd.lists.Generic_Name = <?= $Page->Generic_Name->toClientList($Page) ?>;
    fpres_trade_combination_names_newadd.lists.Form = <?= $Page->Form->toClientList($Page) ?>;
    fpres_trade_combination_names_newadd.lists.Unit = <?= $Page->Unit->toClientList($Page) ?>;
    fpres_trade_combination_names_newadd.lists.TypeOfDrug = <?= $Page->TypeOfDrug->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpres_trade_combination_names_newadd" id="fpres_trade_combination_names_newadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
