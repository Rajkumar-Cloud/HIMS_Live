...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "pres_routes")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.pres_routes)
        ew.vars.tables.pres_routes = currentTable;
    fpres_routesadd.addFields([
    ...
    // Form_CustomValidate
    fpres_routesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpres_routesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpres_routesadd" id="fpres_routesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
