...
// Page object
$BankbranchesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fbankbranchesadd;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fbankbranchesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbankbranchesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fbankbranchesadd" id="fbankbranchesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
