...
<form name="fpharmacy_supplierslistsrch" id="fpharmacy_supplierslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fpharmacy_supplierslist" id="fpharmacy_supplierslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
