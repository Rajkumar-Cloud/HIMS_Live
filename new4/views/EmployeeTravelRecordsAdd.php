...
// Page object
$EmployeeTravelRecordsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_travel_recordsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    femployee_travel_recordsadd = currentForm = new ew.Form("femployee_travel_recordsadd", "add");
    ...
    femployee_travel_recordsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_travel_recordsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_travel_recordsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_travel_recordsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    femployee_travel_recordsadd.lists.type = <?= $Page->type->toClientList($Page) ?>;
    femployee_travel_recordsadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    loadjs.done("femployee_travel_recordsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="femployee_travel_recordsadd" id="femployee_travel_recordsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["femployee_travel_recordsadd", "datetimepicker"], function() {
