...
// Page object
$CrmLeaddetailsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_leaddetailsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcrm_leaddetailsadd = currentForm = new ew.Form("fcrm_leaddetailsadd", "add");
    ...
    // Form_CustomValidate
    fcrm_leaddetailsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_leaddetailsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_leaddetailsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_leaddetailsadd" id="fcrm_leaddetailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fcrm_leaddetailsadd", "datetimepicker"], function() {
