...
<?php if ($Page->baid->Visible) { // baid ?>
    <?php if ($Page->SortUrl($Page->baid) == "") { ?>
        <th class="<?= $Page->baid->headerCellClass() ?>"><?= $Page->baid->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->baid->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->baid->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->baid->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->baid->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->baid->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
<?php if ($Page->isdate->Visible) { // isdate ?>
    <?php if ($Page->SortUrl($Page->isdate) == "") { ?>
        <th class="<?= $Page->isdate->headerCellClass() ?>"><?= $Page->isdate->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->isdate->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->isdate->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->isdate->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->isdate->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->isdate->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->HSNCODE->Visible) { // HSNCODE ?>
    <?php if ($Page->SortUrl($Page->HSNCODE) == "") { ?>
        <th class="<?= $Page->HSNCODE->headerCellClass() ?>"><?= $Page->HSNCODE->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->HSNCODE->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->HSNCODE->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->HSNCODE->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->HSNCODE->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->HSNCODE->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
<?php
