...
// Page object
$ViewSemenanalysisView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_semenanalysisview;
...
$Page->showMessage();
?>
<form name="fview_semenanalysisview" id="fview_semenanalysisview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_id"><template id="tpc_view_semenanalysis_id"><?= $Page->id->caption() ?></template></span></td>
...
<?php if ($Page->PaID->Visible) { // PaID ?>
    <tr id="r_PaID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PaID"><template id="tpc_view_semenanalysis_PaID"><?= $Page->PaID->caption() ?></template></span></td>
...
<?php if ($Page->PaName->Visible) { // PaName ?>
    <tr id="r_PaName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PaName"><template id="tpc_view_semenanalysis_PaName"><?= $Page->PaName->caption() ?></template></span></td>
...
<?php if ($Page->PaMobile->Visible) { // PaMobile ?>
    <tr id="r_PaMobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PaMobile"><template id="tpc_view_semenanalysis_PaMobile"><?= $Page->PaMobile->caption() ?></template></span></td>
...
<?php if ($Page->PartnerID->Visible) { // PartnerID ?>
    <tr id="r_PartnerID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PartnerID"><template id="tpc_view_semenanalysis_PartnerID"><?= $Page->PartnerID->caption() ?></template></span></td>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <tr id="r_PartnerName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PartnerName"><template id="tpc_view_semenanalysis_PartnerName"><?= $Page->PartnerName->caption() ?></template></span></td>
...
<?php if ($Page->PartnerMobile->Visible) { // PartnerMobile ?>
    <tr id="r_PartnerMobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PartnerMobile"><template id="tpc_view_semenanalysis_PartnerMobile"><?= $Page->PartnerMobile->caption() ?></template></span></td>
...
<?php if ($Page->RIDNo->Visible) { // RIDNo ?>
    <tr id="r_RIDNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_RIDNo"><template id="tpc_view_semenanalysis_RIDNo"><?= $Page->RIDNo->caption() ?></template></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PatientName"><template id="tpc_view_semenanalysis_PatientName"><?= $Page->PatientName->caption() ?></template></span></td>
...
<?php if ($Page->HusbandName->Visible) { // HusbandName ?>
    <tr id="r_HusbandName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_HusbandName"><template id="tpc_view_semenanalysis_HusbandName"><?= $Page->HusbandName->caption() ?></template></span></td>
...
<?php if ($Page->RequestDr->Visible) { // RequestDr ?>
    <tr id="r_RequestDr">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_RequestDr"><template id="tpc_view_semenanalysis_RequestDr"><?= $Page->RequestDr->caption() ?></template></span></td>
...
<?php if ($Page->CollectionDate->Visible) { // CollectionDate ?>
    <tr id="r_CollectionDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_CollectionDate"><template id="tpc_view_semenanalysis_CollectionDate"><?= $Page->CollectionDate->caption() ?></template></span></td>
...
<?php if ($Page->ResultDate->Visible) { // ResultDate ?>
    <tr id="r_ResultDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_ResultDate"><template id="tpc_view_semenanalysis_ResultDate"><?= $Page->ResultDate->caption() ?></template></span></td>
...
<?php if ($Page->RequestSample->Visible) { // RequestSample ?>
    <tr id="r_RequestSample">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_RequestSample"><template id="tpc_view_semenanalysis_RequestSample"><?= $Page->RequestSample->caption() ?></template></span></td>
...
<?php if ($Page->CollectionType->Visible) { // CollectionType ?>
    <tr id="r_CollectionType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_CollectionType"><template id="tpc_view_semenanalysis_CollectionType"><?= $Page->CollectionType->caption() ?></template></span></td>
...
<?php if ($Page->CollectionMethod->Visible) { // CollectionMethod ?>
    <tr id="r_CollectionMethod">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_CollectionMethod"><template id="tpc_view_semenanalysis_CollectionMethod"><?= $Page->CollectionMethod->caption() ?></template></span></td>
...
<?php if ($Page->Medicationused->Visible) { // Medicationused ?>
    <tr id="r_Medicationused">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Medicationused"><template id="tpc_view_semenanalysis_Medicationused"><?= $Page->Medicationused->caption() ?></template></span></td>
...
<?php if ($Page->DifficultiesinCollection->Visible) { // DifficultiesinCollection ?>
    <tr id="r_DifficultiesinCollection">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_DifficultiesinCollection"><template id="tpc_view_semenanalysis_DifficultiesinCollection"><?= $Page->DifficultiesinCollection->caption() ?></template></span></td>
...
<?php if ($Page->Volume->Visible) { // Volume ?>
    <tr id="r_Volume">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Volume"><template id="tpc_view_semenanalysis_Volume"><?= $Page->Volume->caption() ?></template></span></td>
...
<?php if ($Page->pH->Visible) { // pH ?>
    <tr id="r_pH">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_pH"><template id="tpc_view_semenanalysis_pH"><?= $Page->pH->caption() ?></template></span></td>
...
<?php if ($Page->Timeofcollection->Visible) { // Timeofcollection ?>
    <tr id="r_Timeofcollection">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Timeofcollection"><template id="tpc_view_semenanalysis_Timeofcollection"><?= $Page->Timeofcollection->caption() ?></template></span></td>
...
<?php if ($Page->Timeofexamination->Visible) { // Timeofexamination ?>
    <tr id="r_Timeofexamination">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Timeofexamination"><template id="tpc_view_semenanalysis_Timeofexamination"><?= $Page->Timeofexamination->caption() ?></template></span></td>
...
<?php if ($Page->Concentration->Visible) { // Concentration ?>
    <tr id="r_Concentration">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Concentration"><template id="tpc_view_semenanalysis_Concentration"><?= $Page->Concentration->caption() ?></template></span></td>
...
<?php if ($Page->Total->Visible) { // Total ?>
    <tr id="r_Total">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Total"><template id="tpc_view_semenanalysis_Total"><?= $Page->Total->caption() ?></template></span></td>
...
<?php if ($Page->ProgressiveMotility->Visible) { // ProgressiveMotility ?>
    <tr id="r_ProgressiveMotility">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_ProgressiveMotility"><template id="tpc_view_semenanalysis_ProgressiveMotility"><?= $Page->ProgressiveMotility->caption() ?></template></span></td>
...
<?php if ($Page->NonProgrssiveMotile->Visible) { // NonProgrssiveMotile ?>
    <tr id="r_NonProgrssiveMotile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_NonProgrssiveMotile"><template id="tpc_view_semenanalysis_NonProgrssiveMotile"><?= $Page->NonProgrssiveMotile->caption() ?></template></span></td>
...
<?php if ($Page->Immotile->Visible) { // Immotile ?>
    <tr id="r_Immotile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Immotile"><template id="tpc_view_semenanalysis_Immotile"><?= $Page->Immotile->caption() ?></template></span></td>
...
<?php if ($Page->TotalProgrssiveMotile->Visible) { // TotalProgrssiveMotile ?>
    <tr id="r_TotalProgrssiveMotile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TotalProgrssiveMotile"><template id="tpc_view_semenanalysis_TotalProgrssiveMotile"><?= $Page->TotalProgrssiveMotile->caption() ?></template></span></td>
...
<?php if ($Page->Appearance->Visible) { // Appearance ?>
    <tr id="r_Appearance">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Appearance"><template id="tpc_view_semenanalysis_Appearance"><?= $Page->Appearance->caption() ?></template></span></td>
...
<?php if ($Page->Homogenosity->Visible) { // Homogenosity ?>
    <tr id="r_Homogenosity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Homogenosity"><template id="tpc_view_semenanalysis_Homogenosity"><?= $Page->Homogenosity->caption() ?></template></span></td>
...
<?php if ($Page->CompleteSample->Visible) { // CompleteSample ?>
    <tr id="r_CompleteSample">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_CompleteSample"><template id="tpc_view_semenanalysis_CompleteSample"><?= $Page->CompleteSample->caption() ?></template></span></td>
...
<?php if ($Page->Liquefactiontime->Visible) { // Liquefactiontime ?>
    <tr id="r_Liquefactiontime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Liquefactiontime"><template id="tpc_view_semenanalysis_Liquefactiontime"><?= $Page->Liquefactiontime->caption() ?></template></span></td>
...
<?php if ($Page->Normal->Visible) { // Normal ?>
    <tr id="r_Normal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Normal"><template id="tpc_view_semenanalysis_Normal"><?= $Page->Normal->caption() ?></template></span></td>
...
<?php if ($Page->Abnormal->Visible) { // Abnormal ?>
    <tr id="r_Abnormal">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Abnormal"><template id="tpc_view_semenanalysis_Abnormal"><?= $Page->Abnormal->caption() ?></template></span></td>
...
<?php if ($Page->Headdefects->Visible) { // Headdefects ?>
    <tr id="r_Headdefects">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Headdefects"><template id="tpc_view_semenanalysis_Headdefects"><?= $Page->Headdefects->caption() ?></template></span></td>
...
<?php if ($Page->MidpieceDefects->Visible) { // MidpieceDefects ?>
    <tr id="r_MidpieceDefects">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_MidpieceDefects"><template id="tpc_view_semenanalysis_MidpieceDefects"><?= $Page->MidpieceDefects->caption() ?></template></span></td>
...
<?php if ($Page->TailDefects->Visible) { // TailDefects ?>
    <tr id="r_TailDefects">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TailDefects"><template id="tpc_view_semenanalysis_TailDefects"><?= $Page->TailDefects->caption() ?></template></span></td>
...
<?php if ($Page->NormalProgMotile->Visible) { // NormalProgMotile ?>
    <tr id="r_NormalProgMotile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_NormalProgMotile"><template id="tpc_view_semenanalysis_NormalProgMotile"><?= $Page->NormalProgMotile->caption() ?></template></span></td>
...
<?php if ($Page->ImmatureForms->Visible) { // ImmatureForms ?>
    <tr id="r_ImmatureForms">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_ImmatureForms"><template id="tpc_view_semenanalysis_ImmatureForms"><?= $Page->ImmatureForms->caption() ?></template></span></td>
...
<?php if ($Page->Leucocytes->Visible) { // Leucocytes ?>
    <tr id="r_Leucocytes">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Leucocytes"><template id="tpc_view_semenanalysis_Leucocytes"><?= $Page->Leucocytes->caption() ?></template></span></td>
...
<?php if ($Page->Agglutination->Visible) { // Agglutination ?>
    <tr id="r_Agglutination">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Agglutination"><template id="tpc_view_semenanalysis_Agglutination"><?= $Page->Agglutination->caption() ?></template></span></td>
...
<?php if ($Page->Debris->Visible) { // Debris ?>
    <tr id="r_Debris">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Debris"><template id="tpc_view_semenanalysis_Debris"><?= $Page->Debris->caption() ?></template></span></td>
...
<?php if ($Page->Diagnosis->Visible) { // Diagnosis ?>
    <tr id="r_Diagnosis">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Diagnosis"><template id="tpc_view_semenanalysis_Diagnosis"><?= $Page->Diagnosis->caption() ?></template></span></td>
...
<?php if ($Page->Observations->Visible) { // Observations ?>
    <tr id="r_Observations">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Observations"><template id="tpc_view_semenanalysis_Observations"><?= $Page->Observations->caption() ?></template></span></td>
...
<?php if ($Page->Signature->Visible) { // Signature ?>
    <tr id="r_Signature">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Signature"><template id="tpc_view_semenanalysis_Signature"><?= $Page->Signature->caption() ?></template></span></td>
...
<?php if ($Page->SemenOrgin->Visible) { // SemenOrgin ?>
    <tr id="r_SemenOrgin">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_SemenOrgin"><template id="tpc_view_semenanalysis_SemenOrgin"><?= $Page->SemenOrgin->caption() ?></template></span></td>
...
<?php if ($Page->Donor->Visible) { // Donor ?>
    <tr id="r_Donor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Donor"><template id="tpc_view_semenanalysis_Donor"><?= $Page->Donor->caption() ?></template></span></td>
...
<?php if ($Page->DonorBloodgroup->Visible) { // DonorBloodgroup ?>
    <tr id="r_DonorBloodgroup">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_DonorBloodgroup"><template id="tpc_view_semenanalysis_DonorBloodgroup"><?= $Page->DonorBloodgroup->caption() ?></template></span></td>
...
<?php if ($Page->Tank->Visible) { // Tank ?>
    <tr id="r_Tank">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Tank"><template id="tpc_view_semenanalysis_Tank"><?= $Page->Tank->caption() ?></template></span></td>
...
<?php if ($Page->Location->Visible) { // Location ?>
    <tr id="r_Location">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Location"><template id="tpc_view_semenanalysis_Location"><?= $Page->Location->caption() ?></template></span></td>
...
<?php if ($Page->Volume1->Visible) { // Volume1 ?>
    <tr id="r_Volume1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Volume1"><template id="tpc_view_semenanalysis_Volume1"><?= $Page->Volume1->caption() ?></template></span></td>
...
<?php if ($Page->Concentration1->Visible) { // Concentration1 ?>
    <tr id="r_Concentration1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Concentration1"><template id="tpc_view_semenanalysis_Concentration1"><?= $Page->Concentration1->caption() ?></template></span></td>
...
<?php if ($Page->Total1->Visible) { // Total1 ?>
    <tr id="r_Total1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Total1"><template id="tpc_view_semenanalysis_Total1"><?= $Page->Total1->caption() ?></template></span></td>
...
<?php if ($Page->ProgressiveMotility1->Visible) { // ProgressiveMotility1 ?>
    <tr id="r_ProgressiveMotility1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_ProgressiveMotility1"><template id="tpc_view_semenanalysis_ProgressiveMotility1"><?= $Page->ProgressiveMotility1->caption() ?></template></span></td>
...
<?php if ($Page->NonProgrssiveMotile1->Visible) { // NonProgrssiveMotile1 ?>
    <tr id="r_NonProgrssiveMotile1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_NonProgrssiveMotile1"><template id="tpc_view_semenanalysis_NonProgrssiveMotile1"><?= $Page->NonProgrssiveMotile1->caption() ?></template></span></td>
...
<?php if ($Page->Immotile1->Visible) { // Immotile1 ?>
    <tr id="r_Immotile1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Immotile1"><template id="tpc_view_semenanalysis_Immotile1"><?= $Page->Immotile1->caption() ?></template></span></td>
...
<?php if ($Page->TotalProgrssiveMotile1->Visible) { // TotalProgrssiveMotile1 ?>
    <tr id="r_TotalProgrssiveMotile1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TotalProgrssiveMotile1"><template id="tpc_view_semenanalysis_TotalProgrssiveMotile1"><?= $Page->TotalProgrssiveMotile1->caption() ?></template></span></td>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <tr id="r_TidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TidNo"><template id="tpc_view_semenanalysis_TidNo"><?= $Page->TidNo->caption() ?></template></span></td>
...
<?php if ($Page->Color->Visible) { // Color ?>
    <tr id="r_Color">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Color"><template id="tpc_view_semenanalysis_Color"><?= $Page->Color->caption() ?></template></span></td>
...
<?php if ($Page->DoneBy->Visible) { // DoneBy ?>
    <tr id="r_DoneBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_DoneBy"><template id="tpc_view_semenanalysis_DoneBy"><?= $Page->DoneBy->caption() ?></template></span></td>
...
<?php if ($Page->Method->Visible) { // Method ?>
    <tr id="r_Method">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Method"><template id="tpc_view_semenanalysis_Method"><?= $Page->Method->caption() ?></template></span></td>
...
<?php if ($Page->Abstinence->Visible) { // Abstinence ?>
    <tr id="r_Abstinence">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Abstinence"><template id="tpc_view_semenanalysis_Abstinence"><?= $Page->Abstinence->caption() ?></template></span></td>
...
<?php if ($Page->ProcessedBy->Visible) { // ProcessedBy ?>
    <tr id="r_ProcessedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_ProcessedBy"><template id="tpc_view_semenanalysis_ProcessedBy"><?= $Page->ProcessedBy->caption() ?></template></span></td>
...
<?php if ($Page->InseminationTime->Visible) { // InseminationTime ?>
    <tr id="r_InseminationTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_InseminationTime"><template id="tpc_view_semenanalysis_InseminationTime"><?= $Page->InseminationTime->caption() ?></template></span></td>
...
<?php if ($Page->InseminationBy->Visible) { // InseminationBy ?>
    <tr id="r_InseminationBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_InseminationBy"><template id="tpc_view_semenanalysis_InseminationBy"><?= $Page->InseminationBy->caption() ?></template></span></td>
...
<?php if ($Page->Big->Visible) { // Big ?>
    <tr id="r_Big">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Big"><template id="tpc_view_semenanalysis_Big"><?= $Page->Big->caption() ?></template></span></td>
...
<?php if ($Page->Medium->Visible) { // Medium ?>
    <tr id="r_Medium">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Medium"><template id="tpc_view_semenanalysis_Medium"><?= $Page->Medium->caption() ?></template></span></td>
...
<?php if ($Page->Small->Visible) { // Small ?>
    <tr id="r_Small">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Small"><template id="tpc_view_semenanalysis_Small"><?= $Page->Small->caption() ?></template></span></td>
...
<?php if ($Page->NoHalo->Visible) { // NoHalo ?>
    <tr id="r_NoHalo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_NoHalo"><template id="tpc_view_semenanalysis_NoHalo"><?= $Page->NoHalo->caption() ?></template></span></td>
...
<?php if ($Page->Fragmented->Visible) { // Fragmented ?>
    <tr id="r_Fragmented">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Fragmented"><template id="tpc_view_semenanalysis_Fragmented"><?= $Page->Fragmented->caption() ?></template></span></td>
...
<?php if ($Page->NonFragmented->Visible) { // NonFragmented ?>
    <tr id="r_NonFragmented">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_NonFragmented"><template id="tpc_view_semenanalysis_NonFragmented"><?= $Page->NonFragmented->caption() ?></template></span></td>
...
<?php if ($Page->DFI->Visible) { // DFI ?>
    <tr id="r_DFI">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_DFI"><template id="tpc_view_semenanalysis_DFI"><?= $Page->DFI->caption() ?></template></span></td>
...
<?php if ($Page->IsueBy->Visible) { // IsueBy ?>
    <tr id="r_IsueBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_IsueBy"><template id="tpc_view_semenanalysis_IsueBy"><?= $Page->IsueBy->caption() ?></template></span></td>
...
<?php if ($Page->Volume2->Visible) { // Volume2 ?>
    <tr id="r_Volume2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Volume2"><template id="tpc_view_semenanalysis_Volume2"><?= $Page->Volume2->caption() ?></template></span></td>
...
<?php if ($Page->Concentration2->Visible) { // Concentration2 ?>
    <tr id="r_Concentration2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Concentration2"><template id="tpc_view_semenanalysis_Concentration2"><?= $Page->Concentration2->caption() ?></template></span></td>
...
<?php if ($Page->Total2->Visible) { // Total2 ?>
    <tr id="r_Total2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Total2"><template id="tpc_view_semenanalysis_Total2"><?= $Page->Total2->caption() ?></template></span></td>
...
<?php if ($Page->ProgressiveMotility2->Visible) { // ProgressiveMotility2 ?>
    <tr id="r_ProgressiveMotility2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_ProgressiveMotility2"><template id="tpc_view_semenanalysis_ProgressiveMotility2"><?= $Page->ProgressiveMotility2->caption() ?></template></span></td>
...
<?php if ($Page->NonProgrssiveMotile2->Visible) { // NonProgrssiveMotile2 ?>
    <tr id="r_NonProgrssiveMotile2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_NonProgrssiveMotile2"><template id="tpc_view_semenanalysis_NonProgrssiveMotile2"><?= $Page->NonProgrssiveMotile2->caption() ?></template></span></td>
...
<?php if ($Page->Immotile2->Visible) { // Immotile2 ?>
    <tr id="r_Immotile2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_Immotile2"><template id="tpc_view_semenanalysis_Immotile2"><?= $Page->Immotile2->caption() ?></template></span></td>
...
<?php if ($Page->TotalProgrssiveMotile2->Visible) { // TotalProgrssiveMotile2 ?>
    <tr id="r_TotalProgrssiveMotile2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TotalProgrssiveMotile2"><template id="tpc_view_semenanalysis_TotalProgrssiveMotile2"><?= $Page->TotalProgrssiveMotile2->caption() ?></template></span></td>
...
<?php if ($Page->IssuedBy->Visible) { // IssuedBy ?>
    <tr id="r_IssuedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_IssuedBy"><template id="tpc_view_semenanalysis_IssuedBy"><?= $Page->IssuedBy->caption() ?></template></span></td>
...
<?php if ($Page->IssuedTo->Visible) { // IssuedTo ?>
    <tr id="r_IssuedTo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_IssuedTo"><template id="tpc_view_semenanalysis_IssuedTo"><?= $Page->IssuedTo->caption() ?></template></span></td>
...
<?php if ($Page->MACS->Visible) { // MACS ?>
    <tr id="r_MACS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_MACS"><template id="tpc_view_semenanalysis_MACS"><?= $Page->MACS->caption() ?></template></span></td>
...
<?php if ($Page->PREG_TEST_DATE->Visible) { // PREG_TEST_DATE ?>
    <tr id="r_PREG_TEST_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_PREG_TEST_DATE"><template id="tpc_view_semenanalysis_PREG_TEST_DATE"><?= $Page->PREG_TEST_DATE->caption() ?></template></span></td>
...
<?php if ($Page->SPECIFIC_PROBLEMS->Visible) { // SPECIFIC_PROBLEMS ?>
    <tr id="r_SPECIFIC_PROBLEMS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_SPECIFIC_PROBLEMS"><template id="tpc_view_semenanalysis_SPECIFIC_PROBLEMS"><?= $Page->SPECIFIC_PROBLEMS->caption() ?></template></span></td>
...
<?php if ($Page->IMSC_1->Visible) { // IMSC_1 ?>
    <tr id="r_IMSC_1">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_IMSC_1"><template id="tpc_view_semenanalysis_IMSC_1"><?= $Page->IMSC_1->caption() ?></template></span></td>
...
<?php if ($Page->IMSC_2->Visible) { // IMSC_2 ?>
    <tr id="r_IMSC_2">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_IMSC_2"><template id="tpc_view_semenanalysis_IMSC_2"><?= $Page->IMSC_2->caption() ?></template></span></td>
...
<?php if ($Page->LIQUIFACTION_STORAGE->Visible) { // LIQUIFACTION_STORAGE ?>
    <tr id="r_LIQUIFACTION_STORAGE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_LIQUIFACTION_STORAGE"><template id="tpc_view_semenanalysis_LIQUIFACTION_STORAGE"><?= $Page->LIQUIFACTION_STORAGE->caption() ?></template></span></td>
...
<?php if ($Page->IUI_PREP_METHOD->Visible) { // IUI_PREP_METHOD ?>
    <tr id="r_IUI_PREP_METHOD">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_IUI_PREP_METHOD"><template id="tpc_view_semenanalysis_IUI_PREP_METHOD"><?= $Page->IUI_PREP_METHOD->caption() ?></template></span></td>
...
<?php if ($Page->TIME_FROM_TRIGGER->Visible) { // TIME_FROM_TRIGGER ?>
    <tr id="r_TIME_FROM_TRIGGER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TIME_FROM_TRIGGER"><template id="tpc_view_semenanalysis_TIME_FROM_TRIGGER"><?= $Page->TIME_FROM_TRIGGER->caption() ?></template></span></td>
...
<?php if ($Page->COLLECTION_TO_PREPARATION->Visible) { // COLLECTION_TO_PREPARATION ?>
    <tr id="r_COLLECTION_TO_PREPARATION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_COLLECTION_TO_PREPARATION"><template id="tpc_view_semenanalysis_COLLECTION_TO_PREPARATION"><?= $Page->COLLECTION_TO_PREPARATION->caption() ?></template></span></td>
...
<?php if ($Page->TIME_FROM_PREP_TO_INSEM->Visible) { // TIME_FROM_PREP_TO_INSEM ?>
    <tr id="r_TIME_FROM_PREP_TO_INSEM">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_semenanalysis_TIME_FROM_PREP_TO_INSEM"><template id="tpc_view_semenanalysis_TIME_FROM_PREP_TO_INSEM"><?= $Page->TIME_FROM_PREP_TO_INSEM->caption() ?></template></span></td>
...
<template id="tpm_view_semenanalysisview">
<div id="ct_ViewSemenanalysisView"><style>
...
<table align="left" border="0" cellpadding="1" cellspacing="1" style="width:100%">
	<tbody>
	<tr>
			<td id="Method" style="font-size:120%;width:25%" ><slot class="ew-slot" name="tpc_view_semenanalysis_Method"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_Method"></slot></td>
			<td ></td>
			<td ></td>
		...
		<tr>
			<td style="width:25%"><slot class="ew-slot" name="tpc_view_semenanalysis_ImmatureForms"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_ImmatureForms"></slot></td>
			<td ></td>
			<td ></td>
			<td ></td>
			<td ></td>
		...
		<tr>
			<td style="width:25%"><slot class="ew-slot" name="tpc_view_semenanalysis_Leucocytes"></slot>&nbsp;<slot class="ew-slot" name="tpx_view_semenanalysis_Leucocytes"></slot></td>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_semenanalysisview", "tpm_view_semenanalysisview", "view_semenanalysisview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
