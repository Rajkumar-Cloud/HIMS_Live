...
loadjs.ready("head", function () {
    ...
    fivf_treatment_planedit.addFields([
        ...
        ["TreatementStopDate", [fields.TreatementStopDate.visible && fields.TreatementStopDate.required ? ew.Validators.required(fields.TreatementStopDate.caption) : null, ew.Validators.datetime(7)], fields.TreatementStopDate.isInvalid],
    ...
    fivf_treatment_planedit.lists.treatment_status = <?= $Page->treatment_status->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.ARTCYCLE = <?= $Page->ARTCYCLE->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.RESULT = <?= $Page->RESULT->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.Treatment = <?= $Page->Treatment->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.TypeOfCycle = <?= $Page->TypeOfCycle->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.SpermOrgin = <?= $Page->SpermOrgin->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.State = <?= $Page->State->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.Origin = <?= $Page->Origin->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.MACS = <?= $Page->MACS->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.PgdPlanning = <?= $Page->PgdPlanning->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.MaleIndications = <?= $Page->MaleIndications->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.FemaleIndications = <?= $Page->FemaleIndications->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.Heterotopic = <?= $Page->Heterotopic->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.TransferDFE = <?= $Page->TransferDFE->toClientList($Page) ?>;
    fivf_treatment_planedit.lists.TineLapse = <?= $Page->TineLapse->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_treatment_planedit" id="fivf_treatment_planedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->getCurrentMasterTable() == "ivf") { ?>
...
<?php } ?>
<?php if ($Page->getCurrentMasterTable() == "view_donor_ivf") { ?>
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_treatment_plan_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <div id="r_RIDNO" class="form-group row">
        <label id="elh_ivf_treatment_plan_RIDNO" for="x_RIDNO" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_RIDNO"><?= $Page->RIDNO->caption() ?><?= $Page->RIDNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Name->Visible) { // Name ?>
    <div id="r_Name" class="form-group row">
        <label id="elh_ivf_treatment_plan_Name" for="x_Name" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Name"><?= $Page->Name->caption() ?><?= $Page->Name->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->TreatmentStartDate->Visible) { // TreatmentStartDate ?>
    <div id="r_TreatmentStartDate" class="form-group row">
        <label id="elh_ivf_treatment_plan_TreatmentStartDate" for="x_TreatmentStartDate" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TreatmentStartDate"><?= $Page->TreatmentStartDate->caption() ?><?= $Page->TreatmentStartDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <div id="r_Age" class="form-group row">
        <label id="elh_ivf_treatment_plan_Age" for="x_Age" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Age"><?= $Page->Age->caption() ?><?= $Page->Age->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->treatment_status->Visible) { // treatment_status ?>
    <div id="r_treatment_status" class="form-group row">
        <label id="elh_ivf_treatment_plan_treatment_status" for="x_treatment_status" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_treatment_status"><?= $Page->treatment_status->caption() ?><?= $Page->treatment_status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_treatment_status"><span id="el_ivf_treatment_plan_treatment_status">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_treatment_status"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_treatment_status']"),
        options = { name: "x_treatment_status", selectId: "ivf_treatment_plan_x_treatment_status", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->ARTCYCLE->Visible) { // ARTCYCLE ?>
    <div id="r_ARTCYCLE" class="form-group row">
        <label id="elh_ivf_treatment_plan_ARTCYCLE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_ARTCYCLE"><?= $Page->ARTCYCLE->caption() ?><?= $Page->ARTCYCLE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_ARTCYCLE">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="ivf_treatment_plan" data-field="x_ARTCYCLE" name="x_ARTCYCLE" id="x_ARTCYCLE"<?= $Page->ARTCYCLE->editAttributes() ?>>
...
<?php if ($Page->IVFCycleNO->Visible) { // IVFCycleNO ?>
    <div id="r_IVFCycleNO" class="form-group row">
        <label id="elh_ivf_treatment_plan_IVFCycleNO" for="x_IVFCycleNO" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_IVFCycleNO"><?= $Page->IVFCycleNO->caption() ?><?= $Page->IVFCycleNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->RESULT->Visible) { // RESULT ?>
    <div id="r_RESULT" class="form-group row">
        <label id="elh_ivf_treatment_plan_RESULT" for="x_RESULT" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_RESULT"><?= $Page->RESULT->caption() ?><?= $Page->RESULT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_RESULT"><span id="el_ivf_treatment_plan_RESULT">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_RESULT"
        data-table="ivf_treatment_plan"
        data-field="x_RESULT"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_RESULT']"),
        options = { name: "x_RESULT", selectId: "ivf_treatment_plan_x_RESULT", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.ivf_treatment_plan.fields.RESULT.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.ivf_treatment_plan.fields.RESULT.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->status->Visible) { // status ?>
    <div id="r_status" class="form-group row">
        <label id="elh_ivf_treatment_plan_status" for="x_status" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_status"><?= $Page->status->caption() ?><?= $Page->status->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_status"><span id="el_ivf_treatment_plan_status">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_status"
        data-table="ivf_treatment_plan"
        data-field="x_status"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_status']"),
        options = { name: "x_status", selectId: "ivf_treatment_plan_x_status", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.ivf_treatment_plan.fields.status.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->TreatementStopDate->Visible) { // TreatementStopDate ?>
    <div id="r_TreatementStopDate" class="form-group row">
        <label id="elh_ivf_treatment_plan_TreatementStopDate" for="x_TreatementStopDate" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TreatementStopDate"><?= $Page->TreatementStopDate->caption() ?><?= $Page->TreatementStopDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->TreatementStopDate->getInputTextType() ?>" data-table="ivf_treatment_plan" data-field="x_TreatementStopDate" data-format="7" name="x_TreatementStopDate" id="x_TreatementStopDate" placeholder="<?= HtmlEncode($Page->TreatementStopDate->getPlaceHolder()) ?>" value="<?= $Page->TreatementStopDate->EditValue ?>"<?= $Page->TreatementStopDate->editAttributes() ?> aria-describedby="x_TreatementStopDate_help">
...
<?php if ($Page->TypePatient->Visible) { // TypePatient ?>
    <div id="r_TypePatient" class="form-group row">
        <label id="elh_ivf_treatment_plan_TypePatient" for="x_TypePatient" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TypePatient"><?= $Page->TypePatient->caption() ?><?= $Page->TypePatient->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Treatment->Visible) { // Treatment ?>
    <div id="r_Treatment" class="form-group row">
        <label id="elh_ivf_treatment_plan_Treatment" for="x_Treatment" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Treatment"><?= $Page->Treatment->caption() ?><?= $Page->Treatment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_Treatment"><span id="el_ivf_treatment_plan_Treatment">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_Treatment"
        data-table="ivf_treatment_plan"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_Treatment']"),
        options = { name: "x_Treatment", selectId: "ivf_treatment_plan_x_Treatment", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->TreatmentTec->Visible) { // TreatmentTec ?>
    <div id="r_TreatmentTec" class="form-group row">
        <label id="elh_ivf_treatment_plan_TreatmentTec" for="x_TreatmentTec" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TreatmentTec"><?= $Page->TreatmentTec->caption() ?><?= $Page->TreatmentTec->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->TypeOfCycle->Visible) { // TypeOfCycle ?>
    <div id="r_TypeOfCycle" class="form-group row">
        <label id="elh_ivf_treatment_plan_TypeOfCycle" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TypeOfCycle"><?= $Page->TypeOfCycle->caption() ?><?= $Page->TypeOfCycle->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_TypeOfCycle">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="ivf_treatment_plan" data-field="x_TypeOfCycle" name="x_TypeOfCycle" id="x_TypeOfCycle"<?= $Page->TypeOfCycle->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->SpermOrgin->Visible) { // SpermOrgin ?>
    <div id="r_SpermOrgin" class="form-group row">
        <label id="elh_ivf_treatment_plan_SpermOrgin" for="x_SpermOrgin" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_SpermOrgin"><?= $Page->SpermOrgin->caption() ?><?= $Page->SpermOrgin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_SpermOrgin"><span id="el_ivf_treatment_plan_SpermOrgin">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_SpermOrgin"
        data-table="ivf_treatment_plan"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_SpermOrgin']"),
        options = { name: "x_SpermOrgin", selectId: "ivf_treatment_plan_x_SpermOrgin", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->State->Visible) { // State ?>
    <div id="r_State" class="form-group row">
        <label id="elh_ivf_treatment_plan_State" for="x_State" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_State"><?= $Page->State->caption() ?><?= $Page->State->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_State"><span id="el_ivf_treatment_plan_State">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_State"
        data-table="ivf_treatment_plan"
        data-field="x_State"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_State']"),
        options = { name: "x_State", selectId: "ivf_treatment_plan_x_State", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->Origin->Visible) { // Origin ?>
    <div id="r_Origin" class="form-group row">
        <label id="elh_ivf_treatment_plan_Origin" for="x_Origin" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Origin"><?= $Page->Origin->caption() ?><?= $Page->Origin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_Origin"><span id="el_ivf_treatment_plan_Origin">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_Origin"
        data-table="ivf_treatment_plan"
        data-field="x_Origin"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_Origin']"),
        options = { name: "x_Origin", selectId: "ivf_treatment_plan_x_Origin", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->MACS->Visible) { // MACS ?>
    <div id="r_MACS" class="form-group row">
        <label id="elh_ivf_treatment_plan_MACS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_MACS"><?= $Page->MACS->caption() ?><?= $Page->MACS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_MACS">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="ivf_treatment_plan" data-field="x_MACS" name="x_MACS" id="x_MACS"<?= $Page->MACS->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->Technique->Visible) { // Technique ?>
    <div id="r_Technique" class="form-group row">
        <label id="elh_ivf_treatment_plan_Technique" for="x_Technique" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Technique"><?= $Page->Technique->caption() ?><?= $Page->Technique->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PgdPlanning->Visible) { // PgdPlanning ?>
    <div id="r_PgdPlanning" class="form-group row">
        <label id="elh_ivf_treatment_plan_PgdPlanning" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_PgdPlanning"><?= $Page->PgdPlanning->caption() ?><?= $Page->PgdPlanning->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_PgdPlanning">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="ivf_treatment_plan" data-field="x_PgdPlanning" name="x_PgdPlanning" id="x_PgdPlanning"<?= $Page->PgdPlanning->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->IMSI->Visible) { // IMSI ?>
    <div id="r_IMSI" class="form-group row">
        <label id="elh_ivf_treatment_plan_IMSI" for="x_IMSI" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_IMSI"><?= $Page->IMSI->caption() ?><?= $Page->IMSI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->SequentialCulture->Visible) { // SequentialCulture ?>
    <div id="r_SequentialCulture" class="form-group row">
        <label id="elh_ivf_treatment_plan_SequentialCulture" for="x_SequentialCulture" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_SequentialCulture"><?= $Page->SequentialCulture->caption() ?><?= $Page->SequentialCulture->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->TimeLapse->Visible) { // TimeLapse ?>
    <div id="r_TimeLapse" class="form-group row">
        <label id="elh_ivf_treatment_plan_TimeLapse" for="x_TimeLapse" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TimeLapse"><?= $Page->TimeLapse->caption() ?><?= $Page->TimeLapse->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->AH->Visible) { // AH ?>
    <div id="r_AH" class="form-group row">
        <label id="elh_ivf_treatment_plan_AH" for="x_AH" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_AH"><?= $Page->AH->caption() ?><?= $Page->AH->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Weight->Visible) { // Weight ?>
    <div id="r_Weight" class="form-group row">
        <label id="elh_ivf_treatment_plan_Weight" for="x_Weight" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Weight"><?= $Page->Weight->caption() ?><?= $Page->Weight->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->BMI->Visible) { // BMI ?>
    <div id="r_BMI" class="form-group row">
        <label id="elh_ivf_treatment_plan_BMI" for="x_BMI" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_BMI"><?= $Page->BMI->caption() ?><?= $Page->BMI->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->MaleIndications->Visible) { // MaleIndications ?>
    <div id="r_MaleIndications" class="form-group row">
        <label id="elh_ivf_treatment_plan_MaleIndications" for="x_MaleIndications" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_MaleIndications"><?= $Page->MaleIndications->caption() ?><?= $Page->MaleIndications->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_MaleIndications"><span id="el_ivf_treatment_plan_MaleIndications">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_MaleIndications"
        data-table="ivf_treatment_plan"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_MaleIndications']"),
        options = { name: "x_MaleIndications", selectId: "ivf_treatment_plan_x_MaleIndications", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->FemaleIndications->Visible) { // FemaleIndications ?>
    <div id="r_FemaleIndications" class="form-group row">
        <label id="elh_ivf_treatment_plan_FemaleIndications" for="x_FemaleIndications" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_FemaleIndications"><?= $Page->FemaleIndications->caption() ?><?= $Page->FemaleIndications->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_FemaleIndications"><span id="el_ivf_treatment_plan_FemaleIndications">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_FemaleIndications"
        data-table="ivf_treatment_plan"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_FemaleIndications']"),
        options = { name: "x_FemaleIndications", selectId: "ivf_treatment_plan_x_FemaleIndications", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
...
<?php if ($Page->UseOfThe->Visible) { // UseOfThe ?>
    <div id="r_UseOfThe" class="form-group row">
        <label id="elh_ivf_treatment_plan_UseOfThe" for="x_UseOfThe" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_UseOfThe"><?= $Page->UseOfThe->caption() ?><?= $Page->UseOfThe->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Ectopic->Visible) { // Ectopic ?>
    <div id="r_Ectopic" class="form-group row">
        <label id="elh_ivf_treatment_plan_Ectopic" for="x_Ectopic" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Ectopic"><?= $Page->Ectopic->caption() ?><?= $Page->Ectopic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->Heterotopic->Visible) { // Heterotopic ?>
    <div id="r_Heterotopic" class="form-group row">
        <label id="elh_ivf_treatment_plan_Heterotopic" for="x_Heterotopic" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Heterotopic"><?= $Page->Heterotopic->caption() ?><?= $Page->Heterotopic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_Heterotopic"><span id="el_ivf_treatment_plan_Heterotopic">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_Heterotopic"
        data-table="ivf_treatment_plan"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_Heterotopic']"),
        options = { name: "x_Heterotopic", selectId: "ivf_treatment_plan_x_Heterotopic", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.ivf_treatment_plan.fields.Heterotopic.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.ivf_treatment_plan.fields.Heterotopic.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->TransferDFE->Visible) { // TransferDFE ?>
    <div id="r_TransferDFE" class="form-group row">
        <label id="elh_ivf_treatment_plan_TransferDFE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TransferDFE"><?= $Page->TransferDFE->caption() ?><?= $Page->TransferDFE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tp_x_TransferDFE">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="ivf_treatment_plan" data-field="x_TransferDFE" name="x_TransferDFE" id="x_TransferDFE"<?= $Page->TransferDFE->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->Evolutive->Visible) { // Evolutive ?>
    <div id="r_Evolutive" class="form-group row">
        <label id="elh_ivf_treatment_plan_Evolutive" for="x_Evolutive" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Evolutive"><?= $Page->Evolutive->caption() ?><?= $Page->Evolutive->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Evolutive->getInputTextType() ?>" data-table="ivf_treatment_plan" data-field="x_Evolutive" name="x_Evolutive" id="x_Evolutive" size="10" maxlength="45" placeholder="<?= HtmlEncode($Page->Evolutive->getPlaceHolder()) ?>" value="<?= $Page->Evolutive->EditValue ?>"<?= $Page->Evolutive->editAttributes() ?> aria-describedby="x_Evolutive_help">
...
<?php if ($Page->Number->Visible) { // Number ?>
    <div id="r_Number" class="form-group row">
        <label id="elh_ivf_treatment_plan_Number" for="x_Number" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_Number"><?= $Page->Number->caption() ?><?= $Page->Number->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->Number->getInputTextType() ?>" data-table="ivf_treatment_plan" data-field="x_Number" name="x_Number" id="x_Number" size="10" maxlength="45" placeholder="<?= HtmlEncode($Page->Number->getPlaceHolder()) ?>" value="<?= $Page->Number->EditValue ?>"<?= $Page->Number->editAttributes() ?> aria-describedby="x_Number_help">
...
<?php if ($Page->SequentialCult->Visible) { // SequentialCult ?>
    <div id="r_SequentialCult" class="form-group row">
        <label id="elh_ivf_treatment_plan_SequentialCult" for="x_SequentialCult" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_SequentialCult"><?= $Page->SequentialCult->caption() ?><?= $Page->SequentialCult->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="<?= $Page->SequentialCult->getInputTextType() ?>" data-table="ivf_treatment_plan" data-field="x_SequentialCult" name="x_SequentialCult" id="x_SequentialCult" size="10" maxlength="45" placeholder="<?= HtmlEncode($Page->SequentialCult->getPlaceHolder()) ?>" value="<?= $Page->SequentialCult->EditValue ?>"<?= $Page->SequentialCult->editAttributes() ?> aria-describedby="x_SequentialCult_help">
...
<?php if ($Page->TineLapse->Visible) { // TineLapse ?>
    <div id="r_TineLapse" class="form-group row">
        <label id="elh_ivf_treatment_plan_TineLapse" for="x_TineLapse" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_TineLapse"><?= $Page->TineLapse->caption() ?><?= $Page->TineLapse->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpx_ivf_treatment_plan_TineLapse"><span id="el_ivf_treatment_plan_TineLapse">
    <select
        ...
        data-select2-id="ivf_treatment_plan_x_TineLapse"
        data-table="ivf_treatment_plan"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='ivf_treatment_plan_x_TineLapse']"),
        options = { name: "x_TineLapse", selectId: "ivf_treatment_plan_x_TineLapse", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.ivf_treatment_plan.fields.TineLapse.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.ivf_treatment_plan.fields.TineLapse.selectOptions);
    ew.createSelect(options);
});
</script>
</span></template>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <div id="r_PatientName" class="form-group row">
        <label id="elh_ivf_treatment_plan_PatientName" for="x_PatientName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_PatientName"><?= $Page->PatientName->caption() ?><?= $Page->PatientName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PatientID->Visible) { // PatientID ?>
    <div id="r_PatientID" class="form-group row">
        <label id="elh_ivf_treatment_plan_PatientID" for="x_PatientID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_PatientID"><?= $Page->PatientID->caption() ?><?= $Page->PatientID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <div id="r_PartnerName" class="form-group row">
        <label id="elh_ivf_treatment_plan_PartnerName" for="x_PartnerName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_PartnerName"><?= $Page->PartnerName->caption() ?><?= $Page->PartnerName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->PartnerID->Visible) { // PartnerID ?>
    <div id="r_PartnerID" class="form-group row">
        <label id="elh_ivf_treatment_plan_PartnerID" for="x_PartnerID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_PartnerID"><?= $Page->PartnerID->caption() ?><?= $Page->PartnerID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->WifeCell->Visible) { // WifeCell ?>
    <div id="r_WifeCell" class="form-group row">
        <label id="elh_ivf_treatment_plan_WifeCell" for="x_WifeCell" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_WifeCell"><?= $Page->WifeCell->caption() ?><?= $Page->WifeCell->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->HusbandCell->Visible) { // HusbandCell ?>
    <div id="r_HusbandCell" class="form-group row">
        <label id="elh_ivf_treatment_plan_HusbandCell" for="x_HusbandCell" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_HusbandCell"><?= $Page->HusbandCell->caption() ?><?= $Page->HusbandCell->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<?php if ($Page->CoupleID->Visible) { // CoupleID ?>
    <div id="r_CoupleID" class="form-group row">
        <label id="elh_ivf_treatment_plan_CoupleID" for="x_CoupleID" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_treatment_plan_CoupleID"><?= $Page->CoupleID->caption() ?><?= $Page->CoupleID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<template id="tpm_ivf_treatment_planedit">
<div id="ct_IvfTreatmentPlanEdit"><style>
...
<table class="ew-table">
	 <tbody>
		<tr>
			<td>
			<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_treatment_plan_treatment_status"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_treatment_plan_treatment_status"></slot></span>
			</td>
			<td>
			<span class="ew-cell"><slot class="ew-slot" name="tpc_ivf_treatment_plan_TreatmentStartDate"></slot>&nbsp;<slot class="ew-slot" name="tpx_ivf_treatment_plan_TreatmentStartDate"></slot></span>
			</td>
		</tr>
	</tbody>
</table>
...
<?php
    if (in_array("ivf_outcome", explode(",", $Page->getCurrentDetailTable())) && $ivf_outcome->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("ivf_stimulation_chart", explode(",", $Page->getCurrentDetailTable())) && $ivf_stimulation_chart->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("ivf_semenanalysisreport", explode(",", $Page->getCurrentDetailTable())) && $ivf_semenanalysisreport->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_treatment_planedit", "tpm_ivf_treatment_planedit", "ivf_treatment_planedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
