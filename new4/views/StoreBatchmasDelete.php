...
<script>
if (!ew.vars.tables.store_batchmas) ew.vars.tables.store_batchmas = <?= JsonEncode(GetClientVar("tables", "store_batchmas")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fstore_batchmasdelete" id="fstore_batchmasdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->FRQ->Visible) { // FRQ ?>
        <th class="<?= $Page->FRQ->headerCellClass() ?>"><span id="elh_store_batchmas_FRQ" class="store_batchmas_FRQ"><?= $Page->FRQ->caption() ?></span></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th class="<?= $Page->HospID->headerCellClass() ?>"><span id="elh_store_batchmas_HospID" class="store_batchmas_HospID"><?= $Page->HospID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->UM->Visible) { // UM ?>
        <th class="<?= $Page->UM->headerCellClass() ?>"><span id="elh_store_batchmas_UM" class="store_batchmas_UM"><?= $Page->UM->caption() ?></span></th>
<?php } ?>
<?php if ($Page->GENNAME->Visible) { // GENNAME ?>
        <th class="<?= $Page->GENNAME->headerCellClass() ?>"><span id="elh_store_batchmas_GENNAME" class="store_batchmas_GENNAME"><?= $Page->GENNAME->caption() ?></span></th>
<?php } ?>
<?php if ($Page->BILLDATE->Visible) { // BILLDATE ?>
        <th class="<?= $Page->BILLDATE->headerCellClass() ?>"><span id="elh_store_batchmas_BILLDATE" class="store_batchmas_BILLDATE"><?= $Page->BILLDATE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PUnit->Visible) { // PUnit ?>
        <th class="<?= $Page->PUnit->headerCellClass() ?>"><span id="elh_store_batchmas_PUnit" class="store_batchmas_PUnit"><?= $Page->PUnit->caption() ?></span></th>
<?php } ?>
<?php if ($Page->SUnit->Visible) { // SUnit ?>
        <th class="<?= $Page->SUnit->headerCellClass() ?>"><span id="elh_store_batchmas_SUnit" class="store_batchmas_SUnit"><?= $Page->SUnit->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PurValue->Visible) { // PurValue ?>
        <th class="<?= $Page->PurValue->headerCellClass() ?>"><span id="elh_store_batchmas_PurValue" class="store_batchmas_PurValue"><?= $Page->PurValue->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PurRate->Visible) { // PurRate ?>
        <th class="<?= $Page->PurRate->headerCellClass() ?>"><span id="elh_store_batchmas_PurRate" class="store_batchmas_PurRate"><?= $Page->PurRate->caption() ?></span></th>
<?php } ?>
<?php if ($Page->StoreID->Visible) { // StoreID ?>
        <th class="<?= $Page->StoreID->headerCellClass() ?>"><span id="elh_store_batchmas_StoreID" class="store_batchmas_StoreID"><?= $Page->StoreID->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_FRQ" class="store_batchmas_FRQ">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_HospID" class="store_batchmas_HospID">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_UM" class="store_batchmas_UM">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_GENNAME" class="store_batchmas_GENNAME">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_BILLDATE" class="store_batchmas_BILLDATE">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_PUnit" class="store_batchmas_PUnit">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_SUnit" class="store_batchmas_SUnit">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_PurValue" class="store_batchmas_PurValue">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_PurRate" class="store_batchmas_PurRate">
...
<span id="el<?= $Page->RowCount ?>_store_batchmas_StoreID" class="store_batchmas_StoreID">
