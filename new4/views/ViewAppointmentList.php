...
<form name="fview_appointmentlistsrch" id="fview_appointmentlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fview_appointmentlist" id="fview_appointmentlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
