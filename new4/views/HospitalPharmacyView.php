...
$Page->showMessage();
?>
<form name="fhospital_pharmacyview" id="fhospital_pharmacyview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->BranchID->Visible) { // BranchID ?>
    <tr id="r_BranchID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_hospital_pharmacy_BranchID"><?= $Page->BranchID->caption() ?></span></td>
