...
$Page->showMessage();
?>
<form name="fmas_user_template_prescriptionview" id="fmas_user_template_prescriptionview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
