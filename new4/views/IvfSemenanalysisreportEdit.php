...
// Page object
$IvfSemenanalysisreportEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_semenanalysisreportedit;
loadjs.ready("head", function () {
    ...
    fivf_semenanalysisreportedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_semenanalysisreportedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_semenanalysisreportedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_semenanalysisreportedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fivf_semenanalysisreportedit.lists.RequestSample = <?= $Page->RequestSample->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.CollectionType = <?= $Page->CollectionType->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.CollectionMethod = <?= $Page->CollectionMethod->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.Medicationused = <?= $Page->Medicationused->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.DifficultiesinCollection = <?= $Page->DifficultiesinCollection->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.Homogenosity = <?= $Page->Homogenosity->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.CompleteSample = <?= $Page->CompleteSample->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.SemenOrgin = <?= $Page->SemenOrgin->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.Donor = <?= $Page->Donor->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.MACS = <?= $Page->MACS->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.SPECIFIC_PROBLEMS = <?= $Page->SPECIFIC_PROBLEMS->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.LIQUIFACTION_STORAGE = <?= $Page->LIQUIFACTION_STORAGE->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.IUI_PREP_METHOD = <?= $Page->IUI_PREP_METHOD->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.TIME_FROM_TRIGGER = <?= $Page->TIME_FROM_TRIGGER->toClientList($Page) ?>;
    fivf_semenanalysisreportedit.lists.COLLECTION_TO_PREPARATION = <?= $Page->COLLECTION_TO_PREPARATION->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_semenanalysisreportedit" id="fivf_semenanalysisreportedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_semenanalysisreport_id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_ivf_semenanalysisreport_id"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
...
<input type="hidden" data-table="ivf_semenanalysisreport" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<template id="tpm_ivf_semenanalysisreportedit">
<div id="ct_IvfSemenanalysisreportEdit"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_ivf_semenanalysisreportedit", "tpm_ivf_semenanalysisreportedit", "ivf_semenanalysisreportedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
