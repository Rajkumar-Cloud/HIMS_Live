...
// Page object
$ViewStoreTransferAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_store_transferadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fview_store_transferadd = currentForm = new ew.Form("fview_store_transferadd", "add");
    ...
    fview_store_transferadd.addFields([
    ...
    // Form_CustomValidate
    fview_store_transferadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_store_transferadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fview_store_transferadd.lists.ORDNO = <?= $Page->ORDNO->toClientList($Page) ?>;
    fview_store_transferadd.lists.LastMonthSale = <?= $Page->LastMonthSale->toClientList($Page) ?>;
    fview_store_transferadd.lists.BRCODE = <?= $Page->BRCODE->toClientList($Page) ?>;
    loadjs.done("fview_store_transferadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fview_store_transferadd" id="fview_store_transferadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fview_store_transferadd", "datetimepicker"], function() {
...
<script>
loadjs.ready(["fview_store_transferadd"], function() {
    fview_store_transferadd.createAutoSuggest(Object.assign({"id":"x_LastMonthSale","forceSelect":true}, ew.vars.tables.view_store_transfer.fields.LastMonthSale.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fview_store_transferadd"], function() {
    fview_store_transferadd.createAutoSuggest(Object.assign({"id":"x_BRCODE","forceSelect":false}, ew.vars.tables.view_store_transfer.fields.BRCODE.autoSuggestOptions));
});
</script>
