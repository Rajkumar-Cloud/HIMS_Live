...
loadjs.ready("head", function () {
    ...
    fpatient_ot_delivery_registeradd.lists.DrVisit1 = <?= $Page->DrVisit1->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.DrVisit2 = <?= $Page->DrVisit2->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.DrVisit3 = <?= $Page->DrVisit3->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.DrVisit4 = <?= $Page->DrVisit4->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.Surgeon = <?= $Page->Surgeon->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.Anaesthetist = <?= $Page->Anaesthetist->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.AsstSurgeon1 = <?= $Page->AsstSurgeon1->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.AsstSurgeon2 = <?= $Page->AsstSurgeon2->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.paediatric = <?= $Page->paediatric->toClientList($Page) ?>;
    fpatient_ot_delivery_registeradd.lists.PatientSearch = <?= $Page->PatientSearch->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_ot_delivery_registeradd" id="fpatient_ot_delivery_registeradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpatient_ot_delivery_registeradd"], function() {
    fpatient_ot_delivery_registeradd.createAutoSuggest(Object.assign({"id":"x_Surgeon","forceSelect":false}, ew.vars.tables.patient_ot_delivery_register.fields.Surgeon.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fpatient_ot_delivery_registeradd"], function() {
    fpatient_ot_delivery_registeradd.createAutoSuggest(Object.assign({"id":"x_Anaesthetist","forceSelect":false}, ew.vars.tables.patient_ot_delivery_register.fields.Anaesthetist.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fpatient_ot_delivery_registeradd"], function() {
    fpatient_ot_delivery_registeradd.createAutoSuggest(Object.assign({"id":"x_AsstSurgeon1","forceSelect":false}, ew.vars.tables.patient_ot_delivery_register.fields.AsstSurgeon1.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fpatient_ot_delivery_registeradd"], function() {
    fpatient_ot_delivery_registeradd.createAutoSuggest(Object.assign({"id":"x_AsstSurgeon2","forceSelect":false}, ew.vars.tables.patient_ot_delivery_register.fields.AsstSurgeon2.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready(["fpatient_ot_delivery_registeradd"], function() {
    fpatient_ot_delivery_registeradd.createAutoSuggest(Object.assign({"id":"x_paediatric","forceSelect":false}, ew.vars.tables.patient_ot_delivery_register.fields.paediatric.autoSuggestOptions));
});
</script>
...
<template id="tpm_patient_ot_delivery_registeradd">
<div id="ct_PatientOtDeliveryRegisterAdd"><style>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_patient_ot_delivery_registeradd", "tpm_patient_ot_delivery_registeradd", "patient_ot_delivery_registeradd", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
