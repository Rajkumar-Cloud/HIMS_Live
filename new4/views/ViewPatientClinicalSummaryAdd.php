...
// Page object
$ViewPatientClinicalSummaryAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fview_patient_clinical_summaryadd;
loadjs.ready("head", function () {
    ...
    fview_patient_clinical_summaryadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fview_patient_clinical_summaryadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fview_patient_clinical_summaryadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fview_patient_clinical_summaryadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fview_patient_clinical_summaryadd" id="fview_patient_clinical_summaryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
