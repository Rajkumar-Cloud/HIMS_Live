...
$Page->showMessage();
?>
<form name="fpatient_ot_delivery_registerdelete" id="fpatient_ot_delivery_registerdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
