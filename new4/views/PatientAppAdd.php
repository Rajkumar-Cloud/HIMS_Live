...
loadjs.ready("head", function () {
    ...
    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "patient_app")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.patient_app)
        ew.vars.tables.patient_app = currentTable;
    fpatient_appadd.addFields([
        ...
        ["title", [fields.title.visible && fields.title.required ? ew.Validators.required(fields.title.caption) : null, ew.Validators.integer], fields.title.isInvalid],
        ...
        ["spouse_dob", [fields.spouse_dob.visible && fields.spouse_dob.required ? ew.Validators.required(fields.spouse_dob.caption) : null, ew.Validators.datetime(0)], fields.spouse_dob.isInvalid],
    ...
    // Form_CustomValidate
    fpatient_appadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpatient_appadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpatient_appadd" id="fpatient_appadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
