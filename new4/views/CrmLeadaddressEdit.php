...
// Page object
$CrmLeadaddressEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcrm_leadaddressedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fcrm_leadaddressedit = currentForm = new ew.Form("fcrm_leadaddressedit", "edit");
    ...
    fcrm_leadaddressedit.addFields([
    ...
    // Form_CustomValidate
    fcrm_leadaddressedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcrm_leadaddressedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcrm_leadaddressedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcrm_leadaddressedit" id="fcrm_leadaddressedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="crm_leadaddress" data-field="x_leadaddressid" data-hidden="1" name="o_leadaddressid" id="o_leadaddressid" value="<?= HtmlEncode($Page->leadaddressid->OldValue ?? $Page->leadaddressid->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
