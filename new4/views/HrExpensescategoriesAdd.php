...
// Page object
$HrExpensescategoriesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fhr_expensescategoriesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fhr_expensescategoriesadd = currentForm = new ew.Form("fhr_expensescategoriesadd", "add");
    ...
    fhr_expensescategoriesadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fhr_expensescategoriesadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fhr_expensescategoriesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fhr_expensescategoriesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fhr_expensescategoriesadd.lists.pre_approve = <?= $Page->pre_approve->toClientList($Page) ?>;
    loadjs.done("fhr_expensescategoriesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fhr_expensescategoriesadd" id="fhr_expensescategoriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fhr_expensescategoriesadd", "datetimepicker"], function() {
