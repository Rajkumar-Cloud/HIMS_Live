...
loadjs.ready("head", function () {
    ...
    fpatient_emergency_contactadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpatient_emergency_contactadd" id="fpatient_emergency_contactadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
