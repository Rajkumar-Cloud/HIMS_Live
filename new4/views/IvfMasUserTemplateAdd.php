...
loadjs.ready("head", function () {
    ...
    fivf_mas_user_templateadd.lists.TemplateType = <?= $Page->TemplateType->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fivf_mas_user_templateadd" id="fivf_mas_user_templateadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
