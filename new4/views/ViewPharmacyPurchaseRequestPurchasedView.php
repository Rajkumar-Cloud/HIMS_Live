...
// Page object
$ViewPharmacyPurchaseRequestPurchasedView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fview_pharmacy_purchase_request_purchasedview;
...
$Page->showMessage();
?>
<form name="fview_pharmacy_purchase_request_purchasedview" id="fview_pharmacy_purchase_request_purchasedview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_id"><template id="tpc_view_pharmacy_purchase_request_purchased_id"><?= $Page->id->caption() ?></template></span></td>
...
<?php if ($Page->DT->Visible) { // DT ?>
    <tr id="r_DT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_DT"><template id="tpc_view_pharmacy_purchase_request_purchased_DT"><?= $Page->DT->caption() ?></template></span></td>
...
<?php if ($Page->EmployeeName->Visible) { // EmployeeName ?>
    <tr id="r_EmployeeName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_EmployeeName"><template id="tpc_view_pharmacy_purchase_request_purchased_EmployeeName"><?= $Page->EmployeeName->caption() ?></template></span></td>
...
<?php if ($Page->Department->Visible) { // Department ?>
    <tr id="r_Department">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_Department"><template id="tpc_view_pharmacy_purchase_request_purchased_Department"><?= $Page->Department->caption() ?></template></span></td>
...
<?php if ($Page->ApprovedStatus->Visible) { // ApprovedStatus ?>
    <tr id="r_ApprovedStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_ApprovedStatus"><template id="tpc_view_pharmacy_purchase_request_purchased_ApprovedStatus"><?= $Page->ApprovedStatus->caption() ?></template></span></td>
...
<?php if ($Page->PurchaseStatus->Visible) { // PurchaseStatus ?>
    <tr id="r_PurchaseStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_PurchaseStatus"><template id="tpc_view_pharmacy_purchase_request_purchased_PurchaseStatus"><?= $Page->PurchaseStatus->caption() ?></template></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_HospID"><template id="tpc_view_pharmacy_purchase_request_purchased_HospID"><?= $Page->HospID->caption() ?></template></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_createdby"><template id="tpc_view_pharmacy_purchase_request_purchased_createdby"><?= $Page->createdby->caption() ?></template></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_createddatetime"><template id="tpc_view_pharmacy_purchase_request_purchased_createddatetime"><?= $Page->createddatetime->caption() ?></template></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_modifiedby"><template id="tpc_view_pharmacy_purchase_request_purchased_modifiedby"><?= $Page->modifiedby->caption() ?></template></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_modifieddatetime"><template id="tpc_view_pharmacy_purchase_request_purchased_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></template></span></td>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
    <tr id="r_BRCODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_pharmacy_purchase_request_purchased_BRCODE"><template id="tpc_view_pharmacy_purchase_request_purchased_BRCODE"><?= $Page->BRCODE->caption() ?></template></span></td>
...
<template id="tpm_view_pharmacy_purchase_request_purchasedview">
<div id="ct_ViewPharmacyPurchaseRequestPurchasedView"><style>
...
<?php
    if (in_array("view_pharmacy_purchase_request_items_purchased", explode(",", $Page->getCurrentDetailTable())) && $view_pharmacy_purchase_request_items_purchased->DetailView) {
?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_view_pharmacy_purchase_request_purchasedview", "tpm_view_pharmacy_purchase_request_purchasedview", "view_pharmacy_purchase_request_purchasedview", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
