...
<?php if ($Page->DocumentName->Visible) { // DocumentName ?>
    <?php if ($Page->SortUrl($Page->DocumentName) == "") { ?>
        <th class="<?= $Page->DocumentName->headerCellClass() ?>"><?= $Page->DocumentName->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->DocumentName->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->DocumentName->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->DocumentName->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->DocumentName->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->DocumentName->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
<?php if ($Page->DocumentNumber->Visible) { // DocumentNumber ?>
    <?php if ($Page->SortUrl($Page->DocumentNumber) == "") { ?>
        <th class="<?= $Page->DocumentNumber->headerCellClass() ?>"><?= $Page->DocumentNumber->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->DocumentNumber->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->DocumentNumber->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->DocumentNumber->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->DocumentNumber->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->DocumentNumber->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
