...
loadjs.ready("head", function () {
    ...
    fpharmacy_purchase_request_itemsedit.lists.PrName = <?= $Page->PrName->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpharmacy_purchase_request_itemsedit" id="fpharmacy_purchase_request_itemsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpharmacy_purchase_request_itemsedit"], function() {
    fpharmacy_purchase_request_itemsedit.createAutoSuggest(Object.assign({"id":"x_PrName","forceSelect":true}, ew.vars.tables.pharmacy_purchase_request_items.fields.PrName.autoSuggestOptions));
});
</script>
