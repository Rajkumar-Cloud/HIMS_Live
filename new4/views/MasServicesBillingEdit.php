...
// Page object
$MasServicesBillingEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fmas_services_billingedit;
loadjs.ready("head", function () {
    ...
    fmas_services_billingedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fmas_services_billingedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fmas_services_billingedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmas_services_billingedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fmas_services_billingedit.lists.SERVICE_TYPE = <?= $Page->SERVICE_TYPE->toClientList($Page) ?>;
    fmas_services_billingedit.lists.DEPARTMENT = <?= $Page->DEPARTMENT->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fmas_services_billingedit" id="fmas_services_billingedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Id->Visible) { // Id ?>
    <div id="r_Id" class="form-group row">
        <label id="elh_mas_services_billing_Id" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Id"><?= $Page->Id->caption() ?><?= $Page->Id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Id->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Id"><span id="el_mas_services_billing_Id">
<span<?= $Page->Id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->Id->getDisplayValue($Page->Id->EditValue))) ?>"></span>
</span></template>
<input type="hidden" data-table="mas_services_billing" data-field="x_Id" data-hidden="1" name="x_Id" id="x_Id" value="<?= HtmlEncode($Page->Id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->CODE->Visible) { // CODE ?>
    <div id="r_CODE" class="form-group row">
        <label id="elh_mas_services_billing_CODE" for="x_CODE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_CODE"><?= $Page->CODE->caption() ?><?= $Page->CODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CODE->cellAttributes() ?>>
<template id="tpx_mas_services_billing_CODE"><span id="el_mas_services_billing_CODE">
...
<?php if ($Page->SERVICE->Visible) { // SERVICE ?>
    <div id="r_SERVICE" class="form-group row">
        <label id="elh_mas_services_billing_SERVICE" for="x_SERVICE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_SERVICE"><?= $Page->SERVICE->caption() ?><?= $Page->SERVICE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SERVICE->cellAttributes() ?>>
<template id="tpx_mas_services_billing_SERVICE"><span id="el_mas_services_billing_SERVICE">
...
<?php if ($Page->UNITS->Visible) { // UNITS ?>
    <div id="r_UNITS" class="form-group row">
        <label id="elh_mas_services_billing_UNITS" for="x_UNITS" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_UNITS"><?= $Page->UNITS->caption() ?><?= $Page->UNITS->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->UNITS->cellAttributes() ?>>
<template id="tpx_mas_services_billing_UNITS"><span id="el_mas_services_billing_UNITS">
...
<?php if ($Page->AMOUNT->Visible) { // AMOUNT ?>
    <div id="r_AMOUNT" class="form-group row">
        <label id="elh_mas_services_billing_AMOUNT" for="x_AMOUNT" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_AMOUNT"><?= $Page->AMOUNT->caption() ?><?= $Page->AMOUNT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AMOUNT->cellAttributes() ?>>
<template id="tpx_mas_services_billing_AMOUNT"><span id="el_mas_services_billing_AMOUNT">
<input type="<?= $Page->AMOUNT->getInputTextType() ?>" data-table="mas_services_billing" data-field="x_AMOUNT" name="x_AMOUNT" id="x_AMOUNT" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->AMOUNT->getPlaceHolder()) ?>" value="<?= $Page->AMOUNT->EditValue ?>"<?= $Page->AMOUNT->editAttributes() ?> aria-describedby="x_AMOUNT_help">
...
<?php if ($Page->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
    <div id="r_SERVICE_TYPE" class="form-group row">
        <label id="elh_mas_services_billing_SERVICE_TYPE" for="x_SERVICE_TYPE" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_SERVICE_TYPE"><?= $Page->SERVICE_TYPE->caption() ?><?= $Page->SERVICE_TYPE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SERVICE_TYPE->cellAttributes() ?>>
<template id="tpx_mas_services_billing_SERVICE_TYPE"><span id="el_mas_services_billing_SERVICE_TYPE">
...
<?php if ($Page->DEPARTMENT->Visible) { // DEPARTMENT ?>
    <div id="r_DEPARTMENT" class="form-group row">
        <label id="elh_mas_services_billing_DEPARTMENT" for="x_DEPARTMENT" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_DEPARTMENT"><?= $Page->DEPARTMENT->caption() ?><?= $Page->DEPARTMENT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DEPARTMENT->cellAttributes() ?>>
<template id="tpx_mas_services_billing_DEPARTMENT"><span id="el_mas_services_billing_DEPARTMENT">
<div class="input-group flex-nowrap">
    <select
        id="x_DEPARTMENT"
        name="x_DEPARTMENT"
...
<?php if ($Page->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
    <div id="r_mas_services_billingcol" class="form-group row">
        <label id="elh_mas_services_billing_mas_services_billingcol" for="x_mas_services_billingcol" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_mas_services_billingcol"><?= $Page->mas_services_billingcol->caption() ?><?= $Page->mas_services_billingcol->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->mas_services_billingcol->cellAttributes() ?>>
<template id="tpx_mas_services_billing_mas_services_billingcol"><span id="el_mas_services_billing_mas_services_billingcol">
...
<?php if ($Page->DrShareAmount->Visible) { // DrShareAmount ?>
    <div id="r_DrShareAmount" class="form-group row">
        <label id="elh_mas_services_billing_DrShareAmount" for="x_DrShareAmount" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_DrShareAmount"><?= $Page->DrShareAmount->caption() ?><?= $Page->DrShareAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DrShareAmount->cellAttributes() ?>>
<template id="tpx_mas_services_billing_DrShareAmount"><span id="el_mas_services_billing_DrShareAmount">
...
<?php if ($Page->HospShareAmount->Visible) { // HospShareAmount ?>
    <div id="r_HospShareAmount" class="form-group row">
        <label id="elh_mas_services_billing_HospShareAmount" for="x_HospShareAmount" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_HospShareAmount"><?= $Page->HospShareAmount->caption() ?><?= $Page->HospShareAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->HospShareAmount->cellAttributes() ?>>
<template id="tpx_mas_services_billing_HospShareAmount"><span id="el_mas_services_billing_HospShareAmount">
...
<?php if ($Page->DrSharePer->Visible) { // DrSharePer ?>
    <div id="r_DrSharePer" class="form-group row">
        <label id="elh_mas_services_billing_DrSharePer" for="x_DrSharePer" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_DrSharePer"><?= $Page->DrSharePer->caption() ?><?= $Page->DrSharePer->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DrSharePer->cellAttributes() ?>>
<template id="tpx_mas_services_billing_DrSharePer"><span id="el_mas_services_billing_DrSharePer">
...
<?php if ($Page->HospSharePer->Visible) { // HospSharePer ?>
    <div id="r_HospSharePer" class="form-group row">
        <label id="elh_mas_services_billing_HospSharePer" for="x_HospSharePer" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_HospSharePer"><?= $Page->HospSharePer->caption() ?><?= $Page->HospSharePer->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->HospSharePer->cellAttributes() ?>>
<template id="tpx_mas_services_billing_HospSharePer"><span id="el_mas_services_billing_HospSharePer">
...
<?php if ($Page->TestSubCd->Visible) { // TestSubCd ?>
    <div id="r_TestSubCd" class="form-group row">
        <label id="elh_mas_services_billing_TestSubCd" for="x_TestSubCd" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_TestSubCd"><?= $Page->TestSubCd->caption() ?><?= $Page->TestSubCd->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TestSubCd->cellAttributes() ?>>
<template id="tpx_mas_services_billing_TestSubCd"><span id="el_mas_services_billing_TestSubCd">
...
<?php if ($Page->Method->Visible) { // Method ?>
    <div id="r_Method" class="form-group row">
        <label id="elh_mas_services_billing_Method" for="x_Method" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Method"><?= $Page->Method->caption() ?><?= $Page->Method->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Method->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Method"><span id="el_mas_services_billing_Method">
...
<?php if ($Page->Order->Visible) { // Order ?>
    <div id="r_Order" class="form-group row">
        <label id="elh_mas_services_billing_Order" for="x_Order" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Order"><?= $Page->Order->caption() ?><?= $Page->Order->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Order->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Order"><span id="el_mas_services_billing_Order">
...
<?php if ($Page->Form->Visible) { // Form ?>
    <div id="r_Form" class="form-group row">
        <label id="elh_mas_services_billing_Form" for="x_Form" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Form"><?= $Page->Form->caption() ?><?= $Page->Form->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Form->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Form"><span id="el_mas_services_billing_Form">
...
<?php if ($Page->ResType->Visible) { // ResType ?>
    <div id="r_ResType" class="form-group row">
        <label id="elh_mas_services_billing_ResType" for="x_ResType" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_ResType"><?= $Page->ResType->caption() ?><?= $Page->ResType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ResType->cellAttributes() ?>>
<template id="tpx_mas_services_billing_ResType"><span id="el_mas_services_billing_ResType">
...
<?php if ($Page->UnitCD->Visible) { // UnitCD ?>
    <div id="r_UnitCD" class="form-group row">
        <label id="elh_mas_services_billing_UnitCD" for="x_UnitCD" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_UnitCD"><?= $Page->UnitCD->caption() ?><?= $Page->UnitCD->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->UnitCD->cellAttributes() ?>>
<template id="tpx_mas_services_billing_UnitCD"><span id="el_mas_services_billing_UnitCD">
...
<?php if ($Page->RefValue->Visible) { // RefValue ?>
    <div id="r_RefValue" class="form-group row">
        <label id="elh_mas_services_billing_RefValue" for="x_RefValue" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_RefValue"><?= $Page->RefValue->caption() ?><?= $Page->RefValue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RefValue->cellAttributes() ?>>
<template id="tpx_mas_services_billing_RefValue"><span id="el_mas_services_billing_RefValue">
...
<?php if ($Page->Sample->Visible) { // Sample ?>
    <div id="r_Sample" class="form-group row">
        <label id="elh_mas_services_billing_Sample" for="x_Sample" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Sample"><?= $Page->Sample->caption() ?><?= $Page->Sample->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Sample->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Sample"><span id="el_mas_services_billing_Sample">
...
<?php if ($Page->NoD->Visible) { // NoD ?>
    <div id="r_NoD" class="form-group row">
        <label id="elh_mas_services_billing_NoD" for="x_NoD" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_NoD"><?= $Page->NoD->caption() ?><?= $Page->NoD->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NoD->cellAttributes() ?>>
<template id="tpx_mas_services_billing_NoD"><span id="el_mas_services_billing_NoD">
...
<?php if ($Page->BillOrder->Visible) { // BillOrder ?>
    <div id="r_BillOrder" class="form-group row">
        <label id="elh_mas_services_billing_BillOrder" for="x_BillOrder" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_BillOrder"><?= $Page->BillOrder->caption() ?><?= $Page->BillOrder->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BillOrder->cellAttributes() ?>>
<template id="tpx_mas_services_billing_BillOrder"><span id="el_mas_services_billing_BillOrder">
...
<?php if ($Page->Formula->Visible) { // Formula ?>
    <div id="r_Formula" class="form-group row">
        <label id="elh_mas_services_billing_Formula" for="x_Formula" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Formula"><?= $Page->Formula->caption() ?><?= $Page->Formula->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Formula->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Formula"><span id="el_mas_services_billing_Formula">
...
<?php if ($Page->Inactive->Visible) { // Inactive ?>
    <div id="r_Inactive" class="form-group row">
        <label id="elh_mas_services_billing_Inactive" for="x_Inactive" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Inactive"><?= $Page->Inactive->caption() ?><?= $Page->Inactive->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Inactive->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Inactive"><span id="el_mas_services_billing_Inactive">
...
<?php if ($Page->Outsource->Visible) { // Outsource ?>
    <div id="r_Outsource" class="form-group row">
        <label id="elh_mas_services_billing_Outsource" for="x_Outsource" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Outsource"><?= $Page->Outsource->caption() ?><?= $Page->Outsource->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Outsource->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Outsource"><span id="el_mas_services_billing_Outsource">
...
<?php if ($Page->CollSample->Visible) { // CollSample ?>
    <div id="r_CollSample" class="form-group row">
        <label id="elh_mas_services_billing_CollSample" for="x_CollSample" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_CollSample"><?= $Page->CollSample->caption() ?><?= $Page->CollSample->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CollSample->cellAttributes() ?>>
<template id="tpx_mas_services_billing_CollSample"><span id="el_mas_services_billing_CollSample">
...
<?php if ($Page->TestType->Visible) { // TestType ?>
    <div id="r_TestType" class="form-group row">
        <label id="elh_mas_services_billing_TestType" for="x_TestType" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_TestType"><?= $Page->TestType->caption() ?><?= $Page->TestType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TestType->cellAttributes() ?>>
<template id="tpx_mas_services_billing_TestType"><span id="el_mas_services_billing_TestType">
...
<?php if ($Page->NoHeading->Visible) { // NoHeading ?>
    <div id="r_NoHeading" class="form-group row">
        <label id="elh_mas_services_billing_NoHeading" for="x_NoHeading" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_NoHeading"><?= $Page->NoHeading->caption() ?><?= $Page->NoHeading->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NoHeading->cellAttributes() ?>>
<template id="tpx_mas_services_billing_NoHeading"><span id="el_mas_services_billing_NoHeading">
...
<?php if ($Page->ChemicalCode->Visible) { // ChemicalCode ?>
    <div id="r_ChemicalCode" class="form-group row">
        <label id="elh_mas_services_billing_ChemicalCode" for="x_ChemicalCode" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_ChemicalCode"><?= $Page->ChemicalCode->caption() ?><?= $Page->ChemicalCode->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ChemicalCode->cellAttributes() ?>>
<template id="tpx_mas_services_billing_ChemicalCode"><span id="el_mas_services_billing_ChemicalCode">
...
<?php if ($Page->ChemicalName->Visible) { // ChemicalName ?>
    <div id="r_ChemicalName" class="form-group row">
        <label id="elh_mas_services_billing_ChemicalName" for="x_ChemicalName" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_ChemicalName"><?= $Page->ChemicalName->caption() ?><?= $Page->ChemicalName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ChemicalName->cellAttributes() ?>>
<template id="tpx_mas_services_billing_ChemicalName"><span id="el_mas_services_billing_ChemicalName">
...
<?php if ($Page->Utilaization->Visible) { // Utilaization ?>
    <div id="r_Utilaization" class="form-group row">
        <label id="elh_mas_services_billing_Utilaization" for="x_Utilaization" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Utilaization"><?= $Page->Utilaization->caption() ?><?= $Page->Utilaization->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Utilaization->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Utilaization"><span id="el_mas_services_billing_Utilaization">
...
<?php if ($Page->Interpretation->Visible) { // Interpretation ?>
    <div id="r_Interpretation" class="form-group row">
        <label id="elh_mas_services_billing_Interpretation" class="<?= $Page->LeftColumnClass ?>"><template id="tpc_mas_services_billing_Interpretation"><?= $Page->Interpretation->caption() ?><?= $Page->Interpretation->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></template></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Interpretation->cellAttributes() ?>>
<template id="tpx_mas_services_billing_Interpretation"><span id="el_mas_services_billing_Interpretation">
...
loadjs.ready(["fmas_services_billingedit", "editor"], function() {
	ew.createEditor("fmas_services_billingedit", "x_Interpretation", 35, 4, <?= $Page->Interpretation->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span></template>
</div></div>
...
<template id="tpm_mas_services_billingedit">
<div id="ct_MasServicesBillingEdit"><style>
...
<div class="row">
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">			
				 <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_CODE"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_CODE"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_SERVICE"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_SERVICE"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_UNITS"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_UNITS"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_AMOUNT"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_AMOUNT"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_SERVICE_TYPE"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_SERVICE_TYPE"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_DEPARTMENT"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_DEPARTMENT"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>
	...
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				<div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_mas_services_billingcol"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_mas_services_billingcol"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_DrShareAmount"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_DrShareAmount"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_HospShareAmount"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_HospShareAmount"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_DrSharePer"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_DrSharePer"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_HospSharePer"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_HospSharePer"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>				
...
<div class="row">
	...
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">			
				 <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_TestSubCd"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_TestSubCd"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Method"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Method"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Order"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Order"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Form"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Form"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_ResType"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_ResType"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_UnitCD"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_UnitCD"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Inactive"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Inactive"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Outsource"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Outsource"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_CollSample"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_CollSample"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>
	...
	<div class="col-6">
		<div class="card card-danger">
			...
			<div class="card-body">
				<div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_RefValue"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_RefValue"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Sample"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Sample"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_NoD"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_NoD"></slot></span>
				  </div>
				   <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_BillOrder"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_BillOrder"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Formula"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Formula"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_TestType"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_TestType"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_NoHeading"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_NoHeading"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_ChemicalCode"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_ChemicalCode"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_ChemicalName"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_ChemicalName"></slot></span>
				  </div>
				  <div class="ew-row">
					<span class="ew-cell"><slot class="ew-slot" name="tpc_mas_services_billing_Utilaization"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Utilaization"></slot></span>
				  </div>
			  <!-- /.card-body -->
			</div>
		</div>				
...
<div class="row">
<slot class="ew-slot" name="tpc_mas_services_billing_Interpretation"></slot>&nbsp;<slot class="ew-slot" name="tpx_mas_services_billing_Interpretation"></slot>
</div>
</div>
</template>
<?php if (!$Page->IsModal) { ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
    ...
    ew.applyTemplate("tpd_mas_services_billingedit", "tpm_mas_services_billingedit", "mas_services_billingedit", "<?= $Page->CustomExport ?>", ew.templateData.rows[0]);
