...
$Page->showMessage();
?>
<form name="fivf_outcomedelete" id="fivf_outcomedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Implantation->Visible) { // Implantation ?>
        <th class="<?= $Page->Implantation->headerCellClass() ?>"><span id="elh_ivf_outcome_Implantation" class="ivf_outcome_Implantation"><?= $Page->Implantation->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DeliveryDate->Visible) { // DeliveryDate ?>
        <th class="<?= $Page->DeliveryDate->headerCellClass() ?>"><span id="elh_ivf_outcome_DeliveryDate" class="ivf_outcome_DeliveryDate"><?= $Page->DeliveryDate->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_ivf_outcome_Implantation" class="ivf_outcome_Implantation">
...
<span id="el<?= $Page->RowCount ?>_ivf_outcome_DeliveryDate" class="ivf_outcome_DeliveryDate">
