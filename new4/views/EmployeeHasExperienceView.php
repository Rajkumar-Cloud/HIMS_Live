...
$Page->showMessage();
?>
<form name="femployee_has_experienceview" id="femployee_has_experienceview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->jobdescription->Visible) { // job description ?>
    <tr id="r_jobdescription">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_has_experience_jobdescription"><?= $Page->jobdescription->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_employee_has_experience_HospID"><?= $Page->HospID->caption() ?></span></td>
