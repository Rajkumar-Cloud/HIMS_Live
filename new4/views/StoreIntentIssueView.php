...
$Page->showMessage();
?>
<form name="fstore_intent_issueview" id="fstore_intent_issueview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->StoreID->Visible) { // StoreID ?>
    <tr id="r_StoreID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_intent_issue_StoreID"><?= $Page->StoreID->caption() ?></span></td>
...
<?php if ($Page->BranchID->Visible) { // BranchID ?>
    <tr id="r_BranchID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_store_intent_issue_BranchID"><?= $Page->BranchID->caption() ?></span></td>
