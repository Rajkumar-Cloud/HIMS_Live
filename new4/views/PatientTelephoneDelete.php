...
<script>
if (!ew.vars.tables.patient_telephone) ew.vars.tables.patient_telephone = <?= JsonEncode(GetClientVar("tables", "patient_telephone")) ?>;
</script>
<?php $Page->showPageHeader(); ?>
<?php
$Page->showMessage();
?>
<form name="fpatient_telephonedelete" id="fpatient_telephonedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
