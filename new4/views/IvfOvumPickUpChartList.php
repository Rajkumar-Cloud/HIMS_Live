...
<form name="fivf_ovum_pick_up_chartlistsrch" id="fivf_ovum_pick_up_chartlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="fivf_ovum_pick_up_chartlist" id="fivf_ovum_pick_up_chartlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
