...
<form name="flab_dept_mastlistsrch" id="flab_dept_mastlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>">
...
<?php } ?>
<form name="flab_dept_mastlist" id="flab_dept_mastlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
