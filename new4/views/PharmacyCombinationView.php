...
<?php } ?>
<script>
if (!ew.vars.tables.pharmacy_combination) ew.vars.tables.pharmacy_combination = <?= JsonEncode(GetClientVar("tables", "pharmacy_combination")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fpharmacy_combinationview" id="fpharmacy_combinationview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
