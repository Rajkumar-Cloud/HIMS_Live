...
<?php if ($Page->ServiceSelect->Visible) { // ServiceSelect ?>
    <?php if ($Page->SortUrl($Page->ServiceSelect) == "") { ?>
        <th class="<?= $Page->ServiceSelect->headerCellClass() ?>"><?= $Page->ServiceSelect->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->ServiceSelect->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?= HtmlEncode($Page->ServiceSelect->Name) ?>" data-sort-order="<?= $Page->SortField == $Page->ServiceSelect->Name && $Page->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
            <div class="ew-table-header-btn"><span class="ew-table-header-caption"><?= $Page->ServiceSelect->caption() ?></span><span class="ew-table-header-sort"><?php if ($Page->SortField == $Page->ServiceSelect->Name) { ?><?php if ($Page->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($Page->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
        </div></div></th>
    <?php } ?>
<?php } ?>
...
<?php if ($Page->ServiceSelect->Visible) { // ServiceSelect ?>
        <!-- ServiceSelect -->
        <td class="<?= $Page->ServiceSelect->footerCellClass() ?>">
        &nbsp;
        </td>
<?php } ?>
<?php if ($Page->Aid->Visible) { // Aid ?>
