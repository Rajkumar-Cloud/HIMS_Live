...
$CONFIG = [
    ...
    "RANDOM_KEY" => '6jEJOLr50tNQkpEb', // Random key for encryption
    ...
    "SESSION_TIMEOUT" => 600, // Session timeout time (minutes)

    // Session keep alive interval
    "SESSION_KEEP_ALIVE_INTERVAL" => 0, // Session keep alive interval (seconds)
    "SESSION_TIMEOUT_COUNTDOWN" => 600, // Session timeout count down interval (seconds)
