 ...
 * Page class
 */
class ViewIpAdmissionBillSummaryList extends ViewIpAdmissionBillSummary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpAdmissionBillSummaryList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewIpAdmissionBillSummaryAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewIpAdmissionBillSummaryDelete";
        $this->MultiUpdateUrl = "ViewIpAdmissionBillSummaryUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_ip_admission_bill_summary"));
                $doc->Text = @$content;
