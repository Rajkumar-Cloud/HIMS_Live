 ...
 * Page class
 */
class EmployeeDocumentList extends EmployeeDocument
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeDocumentList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "EmployeeDocumentAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "EmployeeDocumentDelete";
        $this->MultiUpdateUrl = "EmployeeDocumentUpdate";
    ...
    public function resetFormError()
    {
        ...
        $this->DocumentName->clearErrorMessage();
        $this->DocumentNumber->clearErrorMessage();
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash .= GetFieldHash($row['DocumentName']); // DocumentName
        $hash .= GetFieldHash($row['DocumentNumber']); // DocumentNumber
