 ...
 * Page class
 */
class ViewTreatmentCultureList extends ViewTreatmentCulture
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewTreatmentCultureList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewTreatmentCultureAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewTreatmentCultureDelete";
        $this->MultiUpdateUrl = "ViewTreatmentCultureUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_treatment_culture"));
                $doc->Text = @$content;
