 ...
 * Page class
 */
class StoreIntentIssueList extends StoreIntentIssue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreIntentIssueList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "StoreIntentIssueAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "StoreIntentIssueDelete";
        $this->MultiUpdateUrl = "StoreIntentIssueUpdate";
