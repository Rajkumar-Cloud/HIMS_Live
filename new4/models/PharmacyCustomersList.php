 ...
 * Page class
 */
class PharmacyCustomersList extends PharmacyCustomers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyCustomersList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PharmacyCustomersAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PharmacyCustomersDelete";
        $this->MultiUpdateUrl = "PharmacyCustomersUpdate";
