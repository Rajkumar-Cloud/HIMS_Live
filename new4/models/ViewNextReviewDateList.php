 ...
 * Page class
 */
class ViewNextReviewDateList extends ViewNextReviewDate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewNextReviewDateList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewNextReviewDateAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewNextReviewDateDelete";
        $this->MultiUpdateUrl = "ViewNextReviewDateUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_next_review_date"));
                $doc->Text = @$content;
