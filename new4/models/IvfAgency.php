...
/**
 * Table class for ivf_agency
 */
class IvfAgency extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ivf_agency';
        $this->TableName = 'ivf_agency';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`ivf_agency`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('ivf_agency', 'ivf_agency', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Name
        $this->Name = new DbField('ivf_agency', 'ivf_agency', 'x_Name', 'Name', '`Name`', '`Name`', 200, 45, -1, false, '`Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Street
        $this->Street = new DbField('ivf_agency', 'ivf_agency', 'x_Street', 'Street', '`Street`', '`Street`', 200, 45, -1, false, '`Street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Town
        $this->Town = new DbField('ivf_agency', 'ivf_agency', 'x_Town', 'Town', '`Town`', '`Town`', 200, 45, -1, false, '`Town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // State
        $this->State = new DbField('ivf_agency', 'ivf_agency', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pin
        $this->Pin = new DbField('ivf_agency', 'ivf_agency', 'x_Pin', 'Pin', '`Pin`', '`Pin`', 200, 45, -1, false, '`Pin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`ivf_agency`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IvfAgencyList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "IvfAgencyEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "IvfAgencyAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IvfAgencyView";
            case Config("API_ADD_ACTION"):
                return "IvfAgencyAdd";
            case Config("API_EDIT_ACTION"):
                return "IvfAgencyEdit";
            case Config("API_DELETE_ACTION"):
                return "IvfAgencyDelete";
            case Config("API_LIST_ACTION"):
                return "IvfAgencyList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("IvfAgencyView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("IvfAgencyView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "IvfAgencyAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "IvfAgencyAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("IvfAgencyEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("IvfAgencyAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("IvfAgencyDelete", $this->getUrlParm());
    }
