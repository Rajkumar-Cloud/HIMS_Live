 ...
 * Page class
 */
class ViewPatientClinicalSummaryView extends ViewPatientClinicalSummary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPatientClinicalSummaryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewPatientClinicalSummaryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewPatientClinicalSummaryList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewPatientClinicalSummaryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
