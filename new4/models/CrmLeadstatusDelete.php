 ...
 * Page class
 */
class CrmLeadstatusDelete extends CrmLeadstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CrmLeadstatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CrmLeadstatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CrmLeadstatusList"); // Return to list
                return;
            }
        }
