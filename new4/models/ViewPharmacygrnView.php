 ...
 * Page class
 */
class ViewPharmacygrnView extends ViewPharmacygrn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacygrnView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewPharmacygrnList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewPharmacygrnList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewPharmacygrnList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
