 ...
 * Page class
 */
class PharmacyCustomersDelete extends PharmacyCustomers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyCustomersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyCustomersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyCustomersList"); // Return to list
                return;
            }
        }
