 ...
 * Page class
 */
class StoreIntentIssueDelete extends StoreIntentIssue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreIntentIssueDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StoreIntentIssueList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StoreIntentIssueList"); // Return to list
                return;
            }
        }
