 ...
 * Page class
 */
class PresGenericinteractionsDelete extends PresGenericinteractions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresGenericinteractionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PresGenericinteractionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PresGenericinteractionsList"); // Return to list
                return;
            }
        }
