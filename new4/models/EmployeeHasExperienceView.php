 ...
 * Page class
 */
class EmployeeHasExperienceView extends EmployeeHasExperience
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeHasExperienceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmployeeHasExperienceList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EmployeeHasExperienceList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "EmployeeHasExperienceList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
