 ...
 * Page class
 */
class PharmacyBillingTransferAdd extends PharmacyBillingTransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingTransferAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    $returnUrl = "PharmacyBillingTransferList";
                    if (GetPageName($returnUrl) == "PharmacyBillingTransferList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PharmacyBillingTransferView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_pharmacytransfer", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("ViewPharmacytransferGrid");
            if (in_array("view_pharmacytransfer", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->trid->setSessionValue($this->id->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->trid->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
