 ...
 * Page class
 */
class ViewDashboardCollectionDetailsPreview extends ViewDashboardCollectionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardCollectionDetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_dashboard_summary_modeofpayment_details") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_summary_modeofpayment_details&" . GetForeignKeyUrl("fk__UserName", $this->_UserName->QueryStringValue) . "&" . GetForeignKeyUrl("fk_createddate", $this->createddate->QueryStringValue, 0) . "&" . GetForeignKeyUrl("fk_ModeofPayment", $this->ModeofPayment->QueryStringValue) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->QueryStringValue) . "";
        }
        if ($masterTblVar == "view_dashboard_summary_payment_mode") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_summary_payment_mode&" . GetForeignKeyUrl("fk_createddate", $this->createddate->QueryStringValue, 0) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->QueryStringValue) . "&" . GetForeignKeyUrl("fk__UserName", $this->_UserName->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "view_dashboard_summary_modeofpayment_details") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->_UserName->setQueryStringValue($val);
            }
            $find = "`createddate`=";
            $x = strpos($f, $find);
            if ($x !== false) {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewDashboardCollectionDetailsList"), "", $this->TableVar, true);
        $pageId = "preview";
