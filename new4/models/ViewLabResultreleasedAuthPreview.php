 ...
 * Page class
 */
class ViewLabResultreleasedAuthPreview extends ViewLabResultreleasedAuth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabResultreleasedAuthPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_lab_services_auth") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_services_auth&" . GetForeignKeyUrl("fk_id", $this->Vid->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewLabResultreleasedAuthList"), "", $this->TableVar, true);
        $pageId = "preview";
