 ...
 * Page class
 */
class StoreBillingTransferDelete extends StoreBillingTransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreBillingTransferDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StoreBillingTransferList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StoreBillingTransferList"); // Return to list
                return;
            }
        }
