...
/**
 * Table class for view_ip_admission_issue
 */
class ViewIpAdmissionIssue extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_ip_admission_issue';
        $this->TableName = 'view_ip_admission_issue';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_ip_admission_issue`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // mrnNo
        $this->mrnNo = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_mrnNo', 'mrnNo', '`mrnNo`', '`mrnNo`', 200, 45, -1, false, '`mrnNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // patient_id
        $this->patient_id = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, 11, -1, false, '`patient_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // patient_name
        $this->patient_name = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_patient_name', 'patient_name', '`patient_name`', '`patient_name`', 200, 45, -1, false, '`patient_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profilePic
        $this->profilePic = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // gender
        $this->gender = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_gender', 'gender', '`gender`', '`gender`', 200, 45, -1, false, '`gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->gender->Sortable = true; // Allow sort
        $this->gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->gender->Param, "CustomMsg");
        $this->Fields['gender'] = &$this->gender;

        // age
        $this->age = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_age', 'age', '`age`', '`age`', 200, 45, -1, false, '`age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->age->Sortable = true; // Allow sort
        $this->age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->age->Param, "CustomMsg");
        $this->Fields['age'] = &$this->age;

        // physician_id
        $this->physician_id = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, 11, -1, false, '`physician_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // typeRegsisteration
        $this->typeRegsisteration = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_typeRegsisteration', 'typeRegsisteration', '`typeRegsisteration`', '`typeRegsisteration`', 200, 45, -1, false, '`typeRegsisteration`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentCategory
        $this->PaymentCategory = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, 45, -1, false, '`PaymentCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->admission_consultant_id = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_admission_consultant_id', 'admission_consultant_id', '`admission_consultant_id`', '`admission_consultant_id`', 3, 11, -1, false, '`admission_consultant_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->leading_consultant_id = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_leading_consultant_id', 'leading_consultant_id', '`leading_consultant_id`', '`leading_consultant_id`', 3, 11, -1, false, '`leading_consultant_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cause
        $this->cause = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_cause', 'cause', '`cause`', '`cause`', 201, 65535, -1, false, '`cause`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // admission_date
        $this->admission_date = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike("`admission_date`", 0, "DB"), 135, 19, 0, false, '`admission_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // release_date
        $this->release_date = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike("`release_date`", 0, "DB"), 135, 19, 0, false, '`release_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentStatus
        $this->PaymentStatus = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, 11, -1, false, '`PaymentStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientID
        $this->PatientID = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientID->Sortable = true; // Allow sort
        $this->PatientID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientID->Param, "CustomMsg");
        $this->Fields['PatientID'] = &$this->PatientID;

        // HospID
        $this->HospID = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->HospID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HospID->Param, "CustomMsg");
        $this->Fields['HospID'] = &$this->HospID;

        // ReferedByDr
        $this->ReferedByDr = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, 45, -1, false, '`ReferedByDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferClinicname
        $this->ReferClinicname = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, 45, -1, false, '`ReferClinicname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferCity
        $this->ReferCity = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, 45, -1, false, '`ReferCity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferMobileNo
        $this->ReferMobileNo = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, 45, -1, false, '`ReferMobileNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->ReferA4TreatingConsultant = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, 45, -1, false, '`ReferA4TreatingConsultant`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurposreReferredfor
        $this->PurposreReferredfor = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, 45, -1, false, '`PurposreReferredfor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mobileno
        $this->mobileno = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_mobileno', 'mobileno', '`mobileno`', '`mobileno`', 200, 45, -1, false, '`mobileno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillClosing
        $this->BillClosing = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_BillClosing', 'BillClosing', '`BillClosing`', '`BillClosing`', 200, 45, -1, false, '`BillClosing`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillClosingDate
        $this->BillClosingDate = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_BillClosingDate', 'BillClosingDate', '`BillClosingDate`', CastDateFieldForLike("`BillClosingDate`", 0, "DB"), 135, 19, 0, false, '`BillClosingDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillNumber
        $this->BillNumber = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, 45, -1, false, '`BillNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ClosingAmount
        $this->ClosingAmount = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ClosingAmount', 'ClosingAmount', '`ClosingAmount`', '`ClosingAmount`', 200, 45, -1, false, '`ClosingAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ClosingType
        $this->ClosingType = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ClosingType', 'ClosingType', '`ClosingType`', '`ClosingType`', 200, 45, -1, false, '`ClosingType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillAmount
        $this->BillAmount = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_BillAmount', 'BillAmount', '`BillAmount`', '`BillAmount`', 200, 45, -1, false, '`BillAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // billclosedBy
        $this->billclosedBy = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_billclosedBy', 'billclosedBy', '`billclosedBy`', '`billclosedBy`', 200, 45, -1, false, '`billclosedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bllcloseByDate
        $this->bllcloseByDate = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_bllcloseByDate', 'bllcloseByDate', '`bllcloseByDate`', CastDateFieldForLike("`bllcloseByDate`", 0, "DB"), 135, 19, 0, false, '`bllcloseByDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Procedure
        $this->Procedure = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_Procedure', 'Procedure', '`Procedure`', '`Procedure`', 200, 45, -1, false, '`Procedure`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Consultant
        $this->Consultant = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, 45, -1, false, '`Consultant`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Anesthetist
        $this->Anesthetist = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_Anesthetist', 'Anesthetist', '`Anesthetist`', '`Anesthetist`', 200, 45, -1, false, '`Anesthetist`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Amound
        $this->Amound = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_Amound', 'Amound', '`Amound`', '`Amound`', 131, 10, -1, false, '`Amound`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Package
        $this->Package = new DbField('view_ip_admission_issue', 'view_ip_admission_issue', 'x_Package', 'Package', '`Package`', '`Package`', 200, 45, -1, false, '`Package`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_ip_admission_issue`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewIpAdmissionIssueList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewIpAdmissionIssueView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewIpAdmissionIssueEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewIpAdmissionIssueAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewIpAdmissionIssueView";
            case Config("API_ADD_ACTION"):
                return "ViewIpAdmissionIssueAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewIpAdmissionIssueEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewIpAdmissionIssueDelete";
            case Config("API_LIST_ACTION"):
                return "ViewIpAdmissionIssueList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewIpAdmissionIssueView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewIpAdmissionIssueView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewIpAdmissionIssueAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewIpAdmissionIssueAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIpAdmissionIssueEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIpAdmissionIssueAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewIpAdmissionIssueDelete", $this->getUrlParm());
    }
