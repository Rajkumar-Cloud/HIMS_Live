...
/**
 * Table class for view_patient_services
 */
class ViewPatientServices extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_patient_services';
        $this->TableName = 'view_patient_services';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_patient_services`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_patient_services', 'view_patient_services', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Reception
        $this->Reception = new DbField('view_patient_services', 'view_patient_services', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mrnno
        $this->mrnno = new DbField('view_patient_services', 'view_patient_services', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // PatientName
        $this->PatientName = new DbField('view_patient_services', 'view_patient_services', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('view_patient_services', 'view_patient_services', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('view_patient_services', 'view_patient_services', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // profilePic
        $this->profilePic = new DbField('view_patient_services', 'view_patient_services', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // Services
        $this->Services = new DbField('view_patient_services', 'view_patient_services', 'x_Services', 'Services', '`Services`', '`Services`', 200, 50, -1, false, '`Services`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Services->Lookup = new Lookup('Services', 'mas_services_billing', false, 'SERVICE', ["SERVICE","","",""], [], [], [], [], ["UNITS","AMOUNT","Id"], ["x_Unit","x_amount","x_sid"], '', '');
        ...
        // Unit
        $this->Unit = new DbField('view_patient_services', 'view_patient_services', 'x_Unit', 'Unit', '`Unit`', '`Unit`', 3, 11, -1, false, '`Unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // amount
        $this->amount = new DbField('view_patient_services', 'view_patient_services', 'x_amount', 'amount', '`amount`', '`amount`', 131, 12, -1, false, '`amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Quantity
        $this->Quantity = new DbField('view_patient_services', 'view_patient_services', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, 11, -1, false, '`Quantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountCategory
        $this->DiscountCategory = new DbField('view_patient_services', 'view_patient_services', 'x_DiscountCategory', 'DiscountCategory', '`DiscountCategory`', '`DiscountCategory`', 200, 45, -1, false, '`DiscountCategory`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DiscountCategory->Sortable = true; // Allow sort
        $this->DiscountCategory->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->DiscountCategory->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->DiscountCategory->Lookup = new Lookup('DiscountCategory', 'billing_discount', false, 'Particulars', ["Particulars","","",""], [], [], [], [], [], [], '', '');
        ...
        // Discount
        $this->Discount = new DbField('view_patient_services', 'view_patient_services', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, 12, -1, false, '`Discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SubTotal
        $this->SubTotal = new DbField('view_patient_services', 'view_patient_services', 'x_SubTotal', 'SubTotal', '`SubTotal`', '`SubTotal`', 131, 12, -1, false, '`SubTotal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // description
        $this->description = new DbField('view_patient_services', 'view_patient_services', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->description->Sortable = true; // Allow sort
        $this->description->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->description->Param, "CustomMsg");
        $this->Fields['description'] = &$this->description;

        // patient_type
        $this->patient_type = new DbField('view_patient_services', 'view_patient_services', 'x_patient_type', 'patient_type', '`patient_type`', '`patient_type`', 3, 11, -1, false, '`patient_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // charged_date
        $this->charged_date = new DbField('view_patient_services', 'view_patient_services', 'x_charged_date', 'charged_date', '`charged_date`', CastDateFieldForLike("`charged_date`", 0, "DB"), 135, 19, 0, false, '`charged_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('view_patient_services', 'view_patient_services', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_patient_services', 'view_patient_services', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_patient_services', 'view_patient_services', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_patient_services', 'view_patient_services', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('view_patient_services', 'view_patient_services', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aid
        $this->Aid = new DbField('view_patient_services', 'view_patient_services', 'x_Aid', 'Aid', '`Aid`', '`Aid`', 3, 11, -1, false, '`Aid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Vid
        $this->Vid = new DbField('view_patient_services', 'view_patient_services', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, 11, -1, false, '`Vid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_patient_services', 'view_patient_services', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrCODE
        $this->DrCODE = new DbField('view_patient_services', 'view_patient_services', 'x_DrCODE', 'DrCODE', '`DrCODE`', '`DrCODE`', 200, 45, -1, false, '`DrCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrName
        $this->DrName = new DbField('view_patient_services', 'view_patient_services', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, 45, -1, false, '`DrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Department
        $this->Department = new DbField('view_patient_services', 'view_patient_services', 'x_Department', 'Department', '`Department`', '`Department`', 200, 45, -1, false, '`Department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrSharePres
        $this->DrSharePres = new DbField('view_patient_services', 'view_patient_services', 'x_DrSharePres', 'DrSharePres', '`DrSharePres`', '`DrSharePres`', 131, 12, -1, false, '`DrSharePres`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospSharePres
        $this->HospSharePres = new DbField('view_patient_services', 'view_patient_services', 'x_HospSharePres', 'HospSharePres', '`HospSharePres`', '`HospSharePres`', 131, 12, -1, false, '`HospSharePres`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrShareAmount
        $this->DrShareAmount = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareAmount', 'DrShareAmount', '`DrShareAmount`', '`DrShareAmount`', 131, 12, -1, false, '`DrShareAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospShareAmount
        $this->HospShareAmount = new DbField('view_patient_services', 'view_patient_services', 'x_HospShareAmount', 'HospShareAmount', '`HospShareAmount`', '`HospShareAmount`', 131, 12, -1, false, '`HospShareAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DrShareSettiledAmount = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareSettiledAmount', 'DrShareSettiledAmount', '`DrShareSettiledAmount`', '`DrShareSettiledAmount`', 131, 12, -1, false, '`DrShareSettiledAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrShareSettledId
        $this->DrShareSettledId = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareSettledId', 'DrShareSettledId', '`DrShareSettledId`', '`DrShareSettledId`', 3, 11, -1, false, '`DrShareSettledId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DrShareSettiledStatus = new DbField('view_patient_services', 'view_patient_services', 'x_DrShareSettiledStatus', 'DrShareSettiledStatus', '`DrShareSettiledStatus`', '`DrShareSettiledStatus`', 3, 11, -1, false, '`DrShareSettiledStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // invoiceId
        $this->invoiceId = new DbField('view_patient_services', 'view_patient_services', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, 11, -1, false, '`invoiceId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // invoiceAmount
        $this->invoiceAmount = new DbField('view_patient_services', 'view_patient_services', 'x_invoiceAmount', 'invoiceAmount', '`invoiceAmount`', '`invoiceAmount`', 131, 12, -1, false, '`invoiceAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // invoiceStatus
        $this->invoiceStatus = new DbField('view_patient_services', 'view_patient_services', 'x_invoiceStatus', 'invoiceStatus', '`invoiceStatus`', '`invoiceStatus`', 200, 45, -1, false, '`invoiceStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modeOfPayment
        $this->modeOfPayment = new DbField('view_patient_services', 'view_patient_services', 'x_modeOfPayment', 'modeOfPayment', '`modeOfPayment`', '`modeOfPayment`', 200, 45, -1, false, '`modeOfPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_patient_services', 'view_patient_services', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_patient_services', 'view_patient_services', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemCode
        $this->ItemCode = new DbField('view_patient_services', 'view_patient_services', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, 45, -1, false, '`ItemCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TidNo
        $this->TidNo = new DbField('view_patient_services', 'view_patient_services', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sid
        $this->sid = new DbField('view_patient_services', 'view_patient_services', 'x_sid', 'sid', '`sid`', '`sid`', 3, 11, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestSubCd
        $this->TestSubCd = new DbField('view_patient_services', 'view_patient_services', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, 45, -1, false, '`TestSubCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DEptCd
        $this->DEptCd = new DbField('view_patient_services', 'view_patient_services', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, 45, -1, false, '`DEptCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ProfCd
        $this->ProfCd = new DbField('view_patient_services', 'view_patient_services', 'x_ProfCd', 'ProfCd', '`ProfCd`', '`ProfCd`', 200, 45, -1, false, '`ProfCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LabReport
        $this->LabReport = new DbField('view_patient_services', 'view_patient_services', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, 65535, -1, false, '`LabReport`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Comments
        $this->Comments = new DbField('view_patient_services', 'view_patient_services', 'x_Comments', 'Comments', '`Comments`', '`Comments`', 200, 45, -1, false, '`Comments`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Method
        $this->Method = new DbField('view_patient_services', 'view_patient_services', 'x_Method', 'Method', '`Method`', '`Method`', 200, 45, -1, false, '`Method`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Specimen
        $this->Specimen = new DbField('view_patient_services', 'view_patient_services', 'x_Specimen', 'Specimen', '`Specimen`', '`Specimen`', 200, 45, -1, false, '`Specimen`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Abnormal
        $this->Abnormal = new DbField('view_patient_services', 'view_patient_services', 'x_Abnormal', 'Abnormal', '`Abnormal`', '`Abnormal`', 200, 45, -1, false, '`Abnormal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefValue
        $this->RefValue = new DbField('view_patient_services', 'view_patient_services', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, 65535, -1, false, '`RefValue`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // TestUnit
        $this->TestUnit = new DbField('view_patient_services', 'view_patient_services', 'x_TestUnit', 'TestUnit', '`TestUnit`', '`TestUnit`', 200, 45, -1, false, '`TestUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOWHIGH
        $this->LOWHIGH = new DbField('view_patient_services', 'view_patient_services', 'x_LOWHIGH', 'LOWHIGH', '`LOWHIGH`', '`LOWHIGH`', 200, 45, -1, false, '`LOWHIGH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Branch
        $this->Branch = new DbField('view_patient_services', 'view_patient_services', 'x_Branch', 'Branch', '`Branch`', '`Branch`', 200, 45, -1, false, '`Branch`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Dispatch
        $this->Dispatch = new DbField('view_patient_services', 'view_patient_services', 'x_Dispatch', 'Dispatch', '`Dispatch`', '`Dispatch`', 200, 45, -1, false, '`Dispatch`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic1
        $this->Pic1 = new DbField('view_patient_services', 'view_patient_services', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, 45, -1, false, '`Pic1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic2
        $this->Pic2 = new DbField('view_patient_services', 'view_patient_services', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, 45, -1, false, '`Pic2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GraphPath
        $this->GraphPath = new DbField('view_patient_services', 'view_patient_services', 'x_GraphPath', 'GraphPath', '`GraphPath`', '`GraphPath`', 200, 45, -1, false, '`GraphPath`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MachineCD
        $this->MachineCD = new DbField('view_patient_services', 'view_patient_services', 'x_MachineCD', 'MachineCD', '`MachineCD`', '`MachineCD`', 200, 45, -1, false, '`MachineCD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestCancel
        $this->TestCancel = new DbField('view_patient_services', 'view_patient_services', 'x_TestCancel', 'TestCancel', '`TestCancel`', '`TestCancel`', 200, 45, -1, false, '`TestCancel`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OutSource
        $this->OutSource = new DbField('view_patient_services', 'view_patient_services', 'x_OutSource', 'OutSource', '`OutSource`', '`OutSource`', 200, 45, -1, false, '`OutSource`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Printed
        $this->Printed = new DbField('view_patient_services', 'view_patient_services', 'x_Printed', 'Printed', '`Printed`', '`Printed`', 200, 45, -1, false, '`Printed`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrintBy
        $this->PrintBy = new DbField('view_patient_services', 'view_patient_services', 'x_PrintBy', 'PrintBy', '`PrintBy`', '`PrintBy`', 200, 45, -1, false, '`PrintBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrintDate
        $this->PrintDate = new DbField('view_patient_services', 'view_patient_services', 'x_PrintDate', 'PrintDate', '`PrintDate`', CastDateFieldForLike("`PrintDate`", 0, "DB"), 135, 19, 0, false, '`PrintDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillingDate
        $this->BillingDate = new DbField('view_patient_services', 'view_patient_services', 'x_BillingDate', 'BillingDate', '`BillingDate`', CastDateFieldForLike("`BillingDate`", 0, "DB"), 135, 19, 0, false, '`BillingDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BilledBy
        $this->BilledBy = new DbField('view_patient_services', 'view_patient_services', 'x_BilledBy', 'BilledBy', '`BilledBy`', '`BilledBy`', 200, 45, -1, false, '`BilledBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Resulted
        $this->Resulted = new DbField('view_patient_services', 'view_patient_services', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, 45, -1, false, '`Resulted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultDate
        $this->ResultDate = new DbField('view_patient_services', 'view_patient_services', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike("`ResultDate`", 0, "DB"), 135, 19, 0, false, '`ResultDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultedBy
        $this->ResultedBy = new DbField('view_patient_services', 'view_patient_services', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, 45, -1, false, '`ResultedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SampleDate
        $this->SampleDate = new DbField('view_patient_services', 'view_patient_services', 'x_SampleDate', 'SampleDate', '`SampleDate`', CastDateFieldForLike("`SampleDate`", 0, "DB"), 135, 19, 0, false, '`SampleDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SampleUser
        $this->SampleUser = new DbField('view_patient_services', 'view_patient_services', 'x_SampleUser', 'SampleUser', '`SampleUser`', '`SampleUser`', 200, 45, -1, false, '`SampleUser`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Sampled
        $this->Sampled = new DbField('view_patient_services', 'view_patient_services', 'x_Sampled', 'Sampled', '`Sampled`', '`Sampled`', 200, 45, -1, false, '`Sampled`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReceivedDate
        $this->ReceivedDate = new DbField('view_patient_services', 'view_patient_services', 'x_ReceivedDate', 'ReceivedDate', '`ReceivedDate`', CastDateFieldForLike("`ReceivedDate`", 0, "DB"), 135, 19, 0, false, '`ReceivedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReceivedUser
        $this->ReceivedUser = new DbField('view_patient_services', 'view_patient_services', 'x_ReceivedUser', 'ReceivedUser', '`ReceivedUser`', '`ReceivedUser`', 200, 45, -1, false, '`ReceivedUser`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Recevied
        $this->Recevied = new DbField('view_patient_services', 'view_patient_services', 'x_Recevied', 'Recevied', '`Recevied`', '`Recevied`', 200, 45, -1, false, '`Recevied`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DeptRecvDate
        $this->DeptRecvDate = new DbField('view_patient_services', 'view_patient_services', 'x_DeptRecvDate', 'DeptRecvDate', '`DeptRecvDate`', CastDateFieldForLike("`DeptRecvDate`", 0, "DB"), 135, 19, 0, false, '`DeptRecvDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DeptRecvUser
        $this->DeptRecvUser = new DbField('view_patient_services', 'view_patient_services', 'x_DeptRecvUser', 'DeptRecvUser', '`DeptRecvUser`', '`DeptRecvUser`', 200, 45, -1, false, '`DeptRecvUser`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DeptRecived
        $this->DeptRecived = new DbField('view_patient_services', 'view_patient_services', 'x_DeptRecived', 'DeptRecived', '`DeptRecived`', '`DeptRecived`', 200, 45, -1, false, '`DeptRecived`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SAuthDate
        $this->SAuthDate = new DbField('view_patient_services', 'view_patient_services', 'x_SAuthDate', 'SAuthDate', '`SAuthDate`', CastDateFieldForLike("`SAuthDate`", 0, "DB"), 135, 19, 0, false, '`SAuthDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SAuthBy
        $this->SAuthBy = new DbField('view_patient_services', 'view_patient_services', 'x_SAuthBy', 'SAuthBy', '`SAuthBy`', '`SAuthBy`', 200, 45, -1, false, '`SAuthBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SAuthendicate
        $this->SAuthendicate = new DbField('view_patient_services', 'view_patient_services', 'x_SAuthendicate', 'SAuthendicate', '`SAuthendicate`', '`SAuthendicate`', 200, 45, -1, false, '`SAuthendicate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AuthDate
        $this->AuthDate = new DbField('view_patient_services', 'view_patient_services', 'x_AuthDate', 'AuthDate', '`AuthDate`', CastDateFieldForLike("`AuthDate`", 0, "DB"), 135, 19, 0, false, '`AuthDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AuthBy
        $this->AuthBy = new DbField('view_patient_services', 'view_patient_services', 'x_AuthBy', 'AuthBy', '`AuthBy`', '`AuthBy`', 200, 45, -1, false, '`AuthBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Authencate
        $this->Authencate = new DbField('view_patient_services', 'view_patient_services', 'x_Authencate', 'Authencate', '`Authencate`', '`Authencate`', 200, 45, -1, false, '`Authencate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EditDate
        $this->EditDate = new DbField('view_patient_services', 'view_patient_services', 'x_EditDate', 'EditDate', '`EditDate`', CastDateFieldForLike("`EditDate`", 0, "DB"), 135, 19, 0, false, '`EditDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EditBy
        $this->EditBy = new DbField('view_patient_services', 'view_patient_services', 'x_EditBy', 'EditBy', '`EditBy`', '`EditBy`', 200, 45, -1, false, '`EditBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Editted
        $this->Editted = new DbField('view_patient_services', 'view_patient_services', 'x_Editted', 'Editted', '`Editted`', '`Editted`', 200, 45, -1, false, '`Editted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatID
        $this->PatID = new DbField('view_patient_services', 'view_patient_services', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientId
        $this->PatientId = new DbField('view_patient_services', 'view_patient_services', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientId->Sortable = true; // Allow sort
        $this->PatientId->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientId->Param, "CustomMsg");
        $this->Fields['PatientId'] = &$this->PatientId;

        // Mobile
        $this->Mobile = new DbField('view_patient_services', 'view_patient_services', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 45, -1, false, '`Mobile`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile->Sortable = true; // Allow sort
        $this->Mobile->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile->Param, "CustomMsg");
        $this->Fields['Mobile'] = &$this->Mobile;

        // CId
        $this->CId = new DbField('view_patient_services', 'view_patient_services', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Order
        $this->Order = new DbField('view_patient_services', 'view_patient_services', 'x_Order', 'Order', '`Order`', '`Order`', 131, 10, -1, false, '`Order`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Form
        $this->Form = new DbField('view_patient_services', 'view_patient_services', 'x_Form', 'Form', '`Form`', '`Form`', 201, 500, -1, false, '`Form`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ResType
        $this->ResType = new DbField('view_patient_services', 'view_patient_services', 'x_ResType', 'ResType', '`ResType`', '`ResType`', 200, 45, -1, false, '`ResType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Sample
        $this->Sample = new DbField('view_patient_services', 'view_patient_services', 'x_Sample', 'Sample', '`Sample`', '`Sample`', 200, 150, -1, false, '`Sample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NoD
        $this->NoD = new DbField('view_patient_services', 'view_patient_services', 'x_NoD', 'NoD', '`NoD`', '`NoD`', 131, 10, -1, false, '`NoD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillOrder
        $this->BillOrder = new DbField('view_patient_services', 'view_patient_services', 'x_BillOrder', 'BillOrder', '`BillOrder`', '`BillOrder`', 131, 10, -1, false, '`BillOrder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Formula
        $this->Formula = new DbField('view_patient_services', 'view_patient_services', 'x_Formula', 'Formula', '`Formula`', '`Formula`', 201, 1500, -1, false, '`Formula`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Inactive
        $this->Inactive = new DbField('view_patient_services', 'view_patient_services', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, 45, -1, false, '`Inactive`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CollSample
        $this->CollSample = new DbField('view_patient_services', 'view_patient_services', 'x_CollSample', 'CollSample', '`CollSample`', '`CollSample`', 200, 45, -1, false, '`CollSample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestType
        $this->TestType = new DbField('view_patient_services', 'view_patient_services', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, 45, -1, false, '`TestType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Repeated
        $this->Repeated = new DbField('view_patient_services', 'view_patient_services', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, 45, -1, false, '`Repeated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RepeatedBy
        $this->RepeatedBy = new DbField('view_patient_services', 'view_patient_services', 'x_RepeatedBy', 'RepeatedBy', '`RepeatedBy`', '`RepeatedBy`', 200, 45, -1, false, '`RepeatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RepeatedDate
        $this->RepeatedDate = new DbField('view_patient_services', 'view_patient_services', 'x_RepeatedDate', 'RepeatedDate', '`RepeatedDate`', CastDateFieldForLike("`RepeatedDate`", 0, "DB"), 135, 19, 0, false, '`RepeatedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // serviceID
        $this->serviceID = new DbField('view_patient_services', 'view_patient_services', 'x_serviceID', 'serviceID', '`serviceID`', '`serviceID`', 3, 11, -1, false, '`serviceID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Service_Type
        $this->Service_Type = new DbField('view_patient_services', 'view_patient_services', 'x_Service_Type', 'Service_Type', '`Service_Type`', '`Service_Type`', 200, 45, -1, false, '`Service_Type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Service_Department
        $this->Service_Department = new DbField('view_patient_services', 'view_patient_services', 'x_Service_Department', 'Service_Department', '`Service_Department`', '`Service_Department`', 200, 45, -1, false, '`Service_Department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RequestNo
        $this->RequestNo = new DbField('view_patient_services', 'view_patient_services', 'x_RequestNo', 'RequestNo', '`RequestNo`', '`RequestNo`', 3, 11, -1, false, '`RequestNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    // Master filter
    public function sqlMasterFilter_view_billing_voucher()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_billing_voucher()
    {
        return "`Vid`=@Vid@";
    }

    // Master filter
    public function sqlMasterFilter_view_billing_voucher_print()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_billing_voucher_print()
    {
        return "`Vid`=@Vid@";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_patient_services`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPatientServicesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewPatientServicesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPatientServicesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPatientServicesView";
            case Config("API_ADD_ACTION"):
                return "ViewPatientServicesAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPatientServicesEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPatientServicesDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPatientServicesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPatientServicesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPatientServicesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPatientServicesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPatientServicesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientServicesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientServicesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPatientServicesDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "view_billing_voucher" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->Vid->CurrentValue ?? $this->Vid->getSessionValue());
        }
        if ($this->getCurrentMasterTable() == "view_billing_voucher_print" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->Vid->CurrentValue ?? $this->Vid->getSessionValue());
        }
        return $url;
    ...
    public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->profilePic, '');
