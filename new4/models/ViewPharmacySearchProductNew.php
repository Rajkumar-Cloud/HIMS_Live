 ...
 */
class ViewPharmacySearchProductNew extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DES
        $this->DES = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_DES', 'DES', '`DES`', '`DES`', 200, 100, -1, false, '`DES`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH
        $this->BATCH = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, 10, -1, false, '`BATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 16, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENNAME
        $this->GENNAME = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, 150, -1, false, '`GENNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNIT
        $this->UNIT = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, 45, -1, false, '`UNIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDATE
        $this->BILLDATE = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike("`BILLDATE`", 0, "DB"), 135, 19, 0, false, '`BILLDATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 113, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacySearchProductNewList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacySearchProductNewView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacySearchProductNewEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacySearchProductNewAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacySearchProductNewView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacySearchProductNewAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacySearchProductNewEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacySearchProductNewDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacySearchProductNewList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacySearchProductNewView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacySearchProductNewView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacySearchProductNewAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacySearchProductNewAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacySearchProductNewEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacySearchProductNewAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacySearchProductNewDelete", $this->getUrlParm());
    }
