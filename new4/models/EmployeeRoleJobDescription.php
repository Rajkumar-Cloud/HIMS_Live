 ...
 */
class EmployeeRoleJobDescription extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeRoleJobDescriptionList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "EmployeeRoleJobDescriptionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeRoleJobDescriptionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeRoleJobDescriptionView";
            case Config("API_ADD_ACTION"):
                return "EmployeeRoleJobDescriptionAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeRoleJobDescriptionEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeRoleJobDescriptionDelete";
            case Config("API_LIST_ACTION"):
                return "EmployeeRoleJobDescriptionList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeRoleJobDescriptionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeRoleJobDescriptionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeRoleJobDescriptionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeRoleJobDescriptionAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeRoleJobDescriptionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeRoleJobDescriptionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeRoleJobDescriptionDelete", $this->getUrlParm());
    }
