...
/**
 * Table class for view_next_review_date
 */
class ViewNextReviewDate extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_next_review_date';
        $this->TableName = 'view_next_review_date';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_next_review_date`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // first_name
        $this->first_name = new DbField('view_next_review_date', 'view_next_review_date', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, 50, -1, false, '`first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientID
        $this->PatientID = new DbField('view_next_review_date', 'view_next_review_date', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mobile_no
        $this->mobile_no = new DbField('view_next_review_date', 'view_next_review_date', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, 45, -1, false, '`mobile_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // street
        $this->street = new DbField('view_next_review_date', 'view_next_review_date', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('view_next_review_date', 'view_next_review_date', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NextReviewDate
        $this->NextReviewDate = new DbField('view_next_review_date', 'view_next_review_date', 'x_NextReviewDate', 'NextReviewDate', '`NextReviewDate`', CastDateFieldForLike("`NextReviewDate`", 0, "DB"), 135, 19, 0, false, '`NextReviewDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdUserName
        $this->createdUserName = new DbField('view_next_review_date', 'view_next_review_date', 'x_createdUserName', 'createdUserName', '`createdUserName`', '`createdUserName`', 200, 45, -1, false, '`createdUserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_next_review_date', 'view_next_review_date', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Purpose
        $this->Purpose = new DbField('view_next_review_date', 'view_next_review_date', 'x_Purpose', 'Purpose', '`Purpose`', '`Purpose`', 201, 16777215, -1, false, '`Purpose`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // DrName
        $this->DrName = new DbField('view_next_review_date', 'view_next_review_date', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, 45, -1, false, '`DrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_next_review_date`";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HospID`='".HospitalID()."' and `NextReviewDate` is not null";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewNextReviewDateList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewNextReviewDateView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewNextReviewDateEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewNextReviewDateAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewNextReviewDateView";
            case Config("API_ADD_ACTION"):
                return "ViewNextReviewDateAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewNextReviewDateEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewNextReviewDateDelete";
            case Config("API_LIST_ACTION"):
                return "ViewNextReviewDateList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewNextReviewDateView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewNextReviewDateView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewNextReviewDateAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewNextReviewDateAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewNextReviewDateEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewNextReviewDateAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewNextReviewDateDelete", $this->getUrlParm());
    }
