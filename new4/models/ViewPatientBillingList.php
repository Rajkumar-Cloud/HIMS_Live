 ...
 * Page class
 */
class ViewPatientBillingList extends ViewPatientBilling
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPatientBillingList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPatientBillingAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPatientBillingDelete";
        $this->MultiUpdateUrl = "ViewPatientBillingUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_patient_billing"));
                $doc->Text = @$content;
