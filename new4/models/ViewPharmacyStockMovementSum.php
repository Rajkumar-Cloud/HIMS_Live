 ...
 */
class ViewPharmacyStockMovementSum extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // PRC
        $this->PRC = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OpeningStk
        $this->OpeningStk = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_OpeningStk', 'OpeningStk', '`OpeningStk`', '`OpeningStk`', 131, 34, -1, false, '`OpeningStk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UnitPurchaseRate
        $this->UnitPurchaseRate = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_UnitPurchaseRate', 'UnitPurchaseRate', '`UnitPurchaseRate`', '`UnitPurchaseRate`', 131, 12, -1, false, '`UnitPurchaseRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UnitSaleRate
        $this->UnitSaleRate = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_UnitSaleRate', 'UnitSaleRate', '`UnitSaleRate`', '`UnitSaleRate`', 131, 12, -1, false, '`UnitSaleRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDate
        $this->CreatedDate = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_CreatedDate', 'CreatedDate', '`CreatedDate`', CastDateFieldForLike("`CreatedDate`", 0, "DB"), 133, 10, 0, false, '`CreatedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurchaseQty
        $this->PurchaseQty = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_PurchaseQty', 'PurchaseQty', '`PurchaseQty`', '`PurchaseQty`', 131, 34, -1, false, '`PurchaseQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalesQty
        $this->SalesQty = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_SalesQty', 'SalesQty', '`SalesQty`', '`SalesQty`', 131, 34, -1, false, '`SalesQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ClosingStk
        $this->ClosingStk = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_ClosingStk', 'ClosingStk', '`ClosingStk`', '`ClosingStk`', 131, 34, -1, false, '`ClosingStk`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurchasefreeQty
        $this->PurchasefreeQty = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_PurchasefreeQty', 'PurchasefreeQty', '`PurchasefreeQty`', '`PurchasefreeQty`', 131, 34, -1, false, '`PurchasefreeQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TransferingQty
        $this->TransferingQty = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_TransferingQty', 'TransferingQty', '`TransferingQty`', '`TransferingQty`', 131, 34, -1, false, '`TransferingQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_stock_movement_sum', 'view_pharmacy_stock_movement_sum', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyStockMovementSumList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyStockMovementSumView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyStockMovementSumEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyStockMovementSumAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyStockMovementSumView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyStockMovementSumAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyStockMovementSumEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyStockMovementSumDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyStockMovementSumList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyStockMovementSumView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyStockMovementSumView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyStockMovementSumAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyStockMovementSumAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyStockMovementSumEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyStockMovementSumAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyStockMovementSumDelete", $this->getUrlParm());
    }
