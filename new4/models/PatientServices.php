...
class PatientServices extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ServiceSelect->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ServiceSelect->Param, "CustomMsg");
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `ServiceSelect`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PatientServicesList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PatientServicesView";
            case Config("API_ADD_ACTION"):
                return "PatientServicesAdd";
            case Config("API_EDIT_ACTION"):
                return "PatientServicesEdit";
            case Config("API_DELETE_ACTION"):
                return "PatientServicesDelete";
