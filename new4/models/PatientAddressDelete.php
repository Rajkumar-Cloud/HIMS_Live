 ...
 * Page class
 */
class PatientAddressDelete extends PatientAddress
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAddressDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientAddressList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientAddressList"); // Return to list
                return;
            }
        }
