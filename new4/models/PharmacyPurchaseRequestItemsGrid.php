 ...
 * Page class
 */
class PharmacyPurchaseRequestItemsGrid extends PharmacyPurchaseRequestItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPurchaseRequestItemsGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpharmacy_purchase_request_itemsgrid";
