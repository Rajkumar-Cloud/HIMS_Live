 ...
 * Page class
 */
class ViewLabProfileList extends ViewLabProfile
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabProfileList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewLabProfileAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewLabProfileDelete";
        $this->MultiUpdateUrl = "ViewLabProfileUpdate";
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'lab_profile_details')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("LabProfileDetailsList?" . Config("TABLE_SHOW_MASTER") . "=view_lab_profile&" . GetForeignKeyUrl("fk_CODE", $this->CODE->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("LabProfileDetailsGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_lab_profile')) {
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'view_lab_profile')) {
            ...
            if ($detailPage->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'view_lab_profile')) {
    ...
    protected function setupOtherOptions()
    {
        ...
        $detailTableLink = "";
                ...
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'view_lab_profile') && $Security->canAdd());
                if ($item->Visible) {
                    if ($detailTableLink != "") {
                        $detailTableLink .= ",";
                    }
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["lab_profile_details"] && $this->DetailPages["lab_profile_details"]->Visible) {
            ...
            $url = "LabProfileDetailsPreview?t=view_lab_profile&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_lab_profile')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("LabProfileDetailsList?" . Config("TABLE_SHOW_MASTER") . "=view_lab_profile&" . GetForeignKeyUrl("fk_CODE", $this->CODE->CurrentValue) . "");
