...
class ViewPatientVitals extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPatientVitalsList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPatientVitalsView";
            case Config("API_ADD_ACTION"):
                return "ViewPatientVitalsAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPatientVitalsEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPatientVitalsDelete";
