...
class ViewPharmacyMovementItem extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ProductFrom->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ProductFrom->Param, "CustomMsg");
        ...
        $this->PatientBILLNO->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientBILLNO->Param, "CustomMsg");
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_pharmacy_movement_item', 'view_pharmacy_movement_item', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 11, "DB"), 135, 19, 11, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('view_pharmacy_movement_item', 'view_pharmacy_movement_item', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 11, "DB"), 135, 19, 11, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_pharmacy_movement_item', 'view_pharmacy_movement_item', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 7, "DB"), 135, 19, 7, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_pharmacy_movement") {
            if ($this->prc->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`prc`", $this->prc->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->BatchNo->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("`BatchNo`", $this->BatchNo->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_pharmacy_movement") {
            if ($this->prc->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`prc`", $this->prc->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->BatchNo->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("`BatchNo`", $this->BatchNo->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyMovementItemList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyMovementItemView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyMovementItemAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyMovementItemEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyMovementItemDelete";
    ...
    {
        if ($this->getCurrentMasterTable() == "view_pharmacy_movement" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_prc", $this->prc->CurrentValue ?? $this->prc->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_BatchNo", $this->BatchNo->CurrentValue ?? $this->BatchNo->getSessionValue());
        }
        return $url;
    }
