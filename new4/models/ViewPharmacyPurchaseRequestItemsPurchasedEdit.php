 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestItemsPurchasedEdit extends ViewPharmacyPurchaseRequestItemsPurchased
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestItemsPurchasedEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ViewPharmacyPurchaseRequestItemsPurchasedList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ViewPharmacyPurchaseRequestItemsPurchasedList") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewPharmacyPurchaseRequestItemsPurchasedList"), "", $this->TableVar, true);
        $pageId = "edit";
