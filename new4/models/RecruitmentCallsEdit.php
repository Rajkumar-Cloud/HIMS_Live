 ...
 * Page class
 */
class RecruitmentCallsEdit extends RecruitmentCalls
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecruitmentCallsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("RecruitmentCallsList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "RecruitmentCallsList") {
