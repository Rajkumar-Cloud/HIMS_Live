 ...
 */
class StoreSuppliers extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // HospID
        $this->HospID = new DbField('store_suppliers', 'store_suppliers', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BranchID
        $this->BranchID = new DbField('store_suppliers', 'store_suppliers', 'x_BranchID', 'BranchID', '`BranchID`', '`BranchID`', 3, 11, -1, false, '`BranchID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StoreID
        $this->StoreID = new DbField('store_suppliers', 'store_suppliers', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, 11, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StoreSuppliersList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "StoreSuppliersEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "StoreSuppliersAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StoreSuppliersView";
            case Config("API_ADD_ACTION"):
                return "StoreSuppliersAdd";
            case Config("API_EDIT_ACTION"):
                return "StoreSuppliersEdit";
            case Config("API_DELETE_ACTION"):
                return "StoreSuppliersDelete";
            case Config("API_LIST_ACTION"):
                return "StoreSuppliersList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StoreSuppliersView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StoreSuppliersView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "StoreSuppliersAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "StoreSuppliersAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StoreSuppliersEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StoreSuppliersAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("StoreSuppliersDelete", $this->getUrlParm());
    }
