 ...
 * Page class
 */
class PharmacyPurchaseRequestItemsDelete extends PharmacyPurchaseRequestItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPurchaseRequestItemsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyPurchaseRequestItemsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyPurchaseRequestItemsList"); // Return to list
                return;
            }
        }
