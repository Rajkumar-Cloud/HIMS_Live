 ...
 * Page class
 */
class MasUserTemplateAddopt extends MasUserTemplate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasUserTemplateAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->_Template->IsDetailKey) {
            $this->_Template->setFormValue(ConvertFromUtf8($val));
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->_Template->CurrentValue = ConvertToUtf8($this->_Template->FormValue);
