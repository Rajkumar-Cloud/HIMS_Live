 ...
 * Page class
 */
class HospitalPharmacyList extends HospitalPharmacy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HospitalPharmacyList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "HospitalPharmacyAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "HospitalPharmacyDelete";
        $this->MultiUpdateUrl = "HospitalPharmacyUpdate";
