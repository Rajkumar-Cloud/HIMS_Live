 ...
 * Page class
 */
class PresIndicationstableView extends PresIndicationstable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresIndicationstableView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Sno") ?? Route("Sno")) !== null) {
                ...
                $returnUrl = "PresIndicationstableList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PresIndicationstableList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PresIndicationstableList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
