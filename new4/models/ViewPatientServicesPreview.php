 ...
 * Page class
 */
class ViewPatientServicesPreview extends ViewPatientServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPatientServicesPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_billing_voucher") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_billing_voucher&" . GetForeignKeyUrl("fk_id", $this->Vid->QueryStringValue) . "";
        }
        if ($masterTblVar == "view_billing_voucher_print") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_billing_voucher_print&" . GetForeignKeyUrl("fk_id", $this->Vid->QueryStringValue) . "";
        }
        return $url;
    }
