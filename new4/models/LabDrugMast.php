...
class LabDrugMast extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->DrugName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DrugName->Param, "CustomMsg");
        ...
        $this->Positive->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Positive->Param, "CustomMsg");
        ...
        $this->Negative->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Negative->Param, "CustomMsg");
        ...
        $this->GroupCD->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GroupCD->Param, "CustomMsg");
        ...
        $this->DrugCD->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DrugCD->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LabDrugMastList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LabDrugMastView";
            case Config("API_ADD_ACTION"):
                return "LabDrugMastAdd";
            case Config("API_EDIT_ACTION"):
                return "LabDrugMastEdit";
            case Config("API_DELETE_ACTION"):
                return "LabDrugMastDelete";
