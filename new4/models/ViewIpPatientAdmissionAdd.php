 ...
 * Page class
 */
class ViewIpPatientAdmissionAdd extends ViewIpPatientAdmission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpPatientAdmissionAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ViewIpPatientAdmissionView") {
