...
class Thaw extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ThawList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ThawEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ThawAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ThawView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ThawView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ThawAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ThawAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ThawEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ThawAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ThawDelete", $this->getUrlParm());
    }
