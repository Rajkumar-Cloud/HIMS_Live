 ...
 * Page class
 */
class BillingOtherVoucherView extends BillingOtherVoucher
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BillingOtherVoucherView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BillingOtherVoucherList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BillingOtherVoucherList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "BillingOtherVoucherList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
