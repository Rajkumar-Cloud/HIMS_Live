 ...
 * Page class
 */
class PresFluidformulationView extends PresFluidformulation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresFluidformulationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PresFluidformulationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PresFluidformulationList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PresFluidformulationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
