 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestItemsApprovedGrid extends ViewPharmacyPurchaseRequestItemsApproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestItemsApprovedGrid";
