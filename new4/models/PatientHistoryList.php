 ...
 * Page class
 */
class PatientHistoryList extends PatientHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientHistoryList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PatientHistoryAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PatientHistoryDelete";
        $this->MultiUpdateUrl = "PatientHistoryUpdate";
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->TreatmentHistory->setSort("");
                $this->FamilyHistory->setSort("");
                $this->Age->setSort("");
                $this->Gender->setSort("");
                $this->profilePic->setSort("");
                $this->Complaints->setSort("");
                $this->illness->setSort("");
                $this->PersonalHistory->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_historylistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_historylistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpatient_historylist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadSearchValues()
    {
        ...
        // MaritalHistory
        if (!$this->isAddOrEdit() && $this->MaritalHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->MaritalHistory->AdvancedSearch->SearchValue != "" || $this->MaritalHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // MenstrualHistory
        if (!$this->isAddOrEdit() && $this->MenstrualHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->MenstrualHistory->AdvancedSearch->SearchValue != "" || $this->MenstrualHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // ObstetricHistory
        if (!$this->isAddOrEdit() && $this->ObstetricHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->ObstetricHistory->AdvancedSearch->SearchValue != "" || $this->ObstetricHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // MedicalHistory
        if (!$this->isAddOrEdit() && $this->MedicalHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->MedicalHistory->AdvancedSearch->SearchValue != "" || $this->MedicalHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // SurgicalHistory
        if (!$this->isAddOrEdit() && $this->SurgicalHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->SurgicalHistory->AdvancedSearch->SearchValue != "" || $this->SurgicalHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // PastHistory
        if (!$this->isAddOrEdit() && $this->PastHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->PastHistory->AdvancedSearch->SearchValue != "" || $this->PastHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // TreatmentHistory
        if (!$this->isAddOrEdit() && $this->TreatmentHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->TreatmentHistory->AdvancedSearch->SearchValue != "" || $this->TreatmentHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // FamilyHistory
        if (!$this->isAddOrEdit() && $this->FamilyHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->FamilyHistory->AdvancedSearch->SearchValue != "" || $this->FamilyHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // Complaints
        if (!$this->isAddOrEdit() && $this->Complaints->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Complaints->AdvancedSearch->SearchValue != "" || $this->Complaints->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // illness
        if (!$this->isAddOrEdit() && $this->illness->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->illness->AdvancedSearch->SearchValue != "" || $this->illness->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // PersonalHistory
        if (!$this->isAddOrEdit() && $this->PersonalHistory->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->PersonalHistory->AdvancedSearch->SearchValue != "" || $this->PersonalHistory->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpatient_historylist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpatient_historylist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpatient_historylist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_historylistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"PatientHistorySearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        $item->Visible = true;

        // Search highlight button
        $item = &$this->SearchOptions->add("searchhighlight");
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fpatient_historylistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
