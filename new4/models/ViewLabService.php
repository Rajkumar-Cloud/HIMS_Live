...
/**
 * Table class for view_lab_service
 */
class ViewLabService extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_lab_service';
        $this->TableName = 'view_lab_service';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_lab_service`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Id
        $this->Id = new DbField('view_lab_service', 'view_lab_service', 'x_Id', 'Id', '`Id`', '`Id`', 3, 11, -1, false, '`Id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // CODE
        $this->CODE = new DbField('view_lab_service', 'view_lab_service', 'x_CODE', 'CODE', '`CODE`', '`CODE`', 200, 50, -1, false, '`CODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVICE
        $this->SERVICE = new DbField('view_lab_service', 'view_lab_service', 'x_SERVICE', 'SERVICE', '`SERVICE`', '`SERVICE`', 200, 50, -1, false, '`SERVICE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNITS
        $this->UNITS = new DbField('view_lab_service', 'view_lab_service', 'x_UNITS', 'UNITS', '`UNITS`', '`UNITS`', 3, 11, -1, false, '`UNITS`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->UNITS->Sortable = true; // Allow sort
        $this->UNITS->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->UNITS->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->UNITS->Lookup = new Lookup('UNITS', 'lab_unit_mast', true, 'id', ["Name","","",""], [], [], [], [], [], [], '`Name` ASC', '');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('view_lab_service', 'view_lab_service', 'x_AMOUNT', 'AMOUNT', '`AMOUNT`', '`AMOUNT`', 5, 22, -1, false, '`AMOUNT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVICE_TYPE
        $this->SERVICE_TYPE = new DbField('view_lab_service', 'view_lab_service', 'x_SERVICE_TYPE', 'SERVICE_TYPE', '`SERVICE_TYPE`', '`SERVICE_TYPE`', 200, 50, -1, false, '`SERVICE_TYPE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->SERVICE_TYPE->Lookup = new Lookup('SERVICE_TYPE', 'mas_lab_services_type', true, 'name', ["name","","",""], [], [], [], [], [], [], '', '');
        ...
        // DEPARTMENT
        $this->DEPARTMENT = new DbField('view_lab_service', 'view_lab_service', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, 50, -1, false, '`DEPARTMENT`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->DEPARTMENT->OptionCount = 2;
        $this->DEPARTMENT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DEPARTMENT->Param, "CustomMsg");
        $this->Fields['DEPARTMENT'] = &$this->DEPARTMENT;

        // Created
        $this->Created = new DbField('view_lab_service', 'view_lab_service', 'x_Created', 'Created', '`Created`', '`Created`', 200, 45, -1, false, '`Created`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_lab_service', 'view_lab_service', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Modified
        $this->Modified = new DbField('view_lab_service', 'view_lab_service', 'x_Modified', 'Modified', '`Modified`', '`Modified`', 200, 45, -1, false, '`Modified`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('view_lab_service', 'view_lab_service', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->mas_services_billingcol = new DbField('view_lab_service', 'view_lab_service', 'x_mas_services_billingcol', 'mas_services_billingcol', '`mas_services_billingcol`', '`mas_services_billingcol`', 200, 45, -1, false, '`mas_services_billingcol`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrShareAmount
        $this->DrShareAmount = new DbField('view_lab_service', 'view_lab_service', 'x_DrShareAmount', 'DrShareAmount', '`DrShareAmount`', '`DrShareAmount`', 5, 22, -1, false, '`DrShareAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospShareAmount
        $this->HospShareAmount = new DbField('view_lab_service', 'view_lab_service', 'x_HospShareAmount', 'HospShareAmount', '`HospShareAmount`', '`HospShareAmount`', 5, 22, -1, false, '`HospShareAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrSharePer
        $this->DrSharePer = new DbField('view_lab_service', 'view_lab_service', 'x_DrSharePer', 'DrSharePer', '`DrSharePer`', '`DrSharePer`', 3, 11, -1, false, '`DrSharePer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospSharePer
        $this->HospSharePer = new DbField('view_lab_service', 'view_lab_service', 'x_HospSharePer', 'HospSharePer', '`HospSharePer`', '`HospSharePer`', 3, 11, -1, false, '`HospSharePer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_lab_service', 'view_lab_service', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestSubCd
        $this->TestSubCd = new DbField('view_lab_service', 'view_lab_service', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, 45, -1, false, '`TestSubCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Method
        $this->Method = new DbField('view_lab_service', 'view_lab_service', 'x_Method', 'Method', '`Method`', '`Method`', 200, 45, -1, false, '`Method`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Order
        $this->Order = new DbField('view_lab_service', 'view_lab_service', 'x_Order', 'Order', '`Order`', '`Order`', 131, 10, -1, false, '`Order`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Form
        $this->Form = new DbField('view_lab_service', 'view_lab_service', 'x_Form', 'Form', '`Form`', '`Form`', 201, 405, -1, false, '`Form`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ResType
        $this->ResType = new DbField('view_lab_service', 'view_lab_service', 'x_ResType', 'ResType', '`ResType`', '`ResType`', 200, 45, -1, false, '`ResType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UnitCD
        $this->UnitCD = new DbField('view_lab_service', 'view_lab_service', 'x_UnitCD', 'UnitCD', '`UnitCD`', '`UnitCD`', 200, 45, -1, false, '`UnitCD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefValue
        $this->RefValue = new DbField('view_lab_service', 'view_lab_service', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, 65535, -1, false, '`RefValue`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Sample
        $this->Sample = new DbField('view_lab_service', 'view_lab_service', 'x_Sample', 'Sample', '`Sample`', '`Sample`', 200, 105, -1, false, '`Sample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NoD
        $this->NoD = new DbField('view_lab_service', 'view_lab_service', 'x_NoD', 'NoD', '`NoD`', '`NoD`', 131, 10, -1, false, '`NoD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillOrder
        $this->BillOrder = new DbField('view_lab_service', 'view_lab_service', 'x_BillOrder', 'BillOrder', '`BillOrder`', '`BillOrder`', 131, 10, -1, false, '`BillOrder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Formula
        $this->Formula = new DbField('view_lab_service', 'view_lab_service', 'x_Formula', 'Formula', '`Formula`', '`Formula`', 201, 1000, -1, false, '`Formula`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Inactive
        $this->Inactive = new DbField('view_lab_service', 'view_lab_service', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, 45, -1, false, '`Inactive`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->Inactive->Sortable = true; // Allow sort
        $this->Inactive->Lookup = new Lookup('Inactive', 'view_lab_service', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->Inactive->OptionCount = 1;
        ...
        // Outsource
        $this->Outsource = new DbField('view_lab_service', 'view_lab_service', 'x_Outsource', 'Outsource', '`Outsource`', '`Outsource`', 200, 45, -1, false, '`Outsource`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CollSample
        $this->CollSample = new DbField('view_lab_service', 'view_lab_service', 'x_CollSample', 'CollSample', '`CollSample`', '`CollSample`', 200, 45, -1, false, '`CollSample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestType
        $this->TestType = new DbField('view_lab_service', 'view_lab_service', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, 45, -1, false, '`TestType`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->TestType->Lookup = new Lookup('TestType', 'view_lab_service', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // NoHeading
        $this->NoHeading = new DbField('view_lab_service', 'view_lab_service', 'x_NoHeading', 'NoHeading', '`NoHeading`', '`NoHeading`', 200, 45, -1, false, '`NoHeading`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ChemicalCode
        $this->ChemicalCode = new DbField('view_lab_service', 'view_lab_service', 'x_ChemicalCode', 'ChemicalCode', '`ChemicalCode`', '`ChemicalCode`', 200, 45, -1, false, '`ChemicalCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ChemicalName
        $this->ChemicalName = new DbField('view_lab_service', 'view_lab_service', 'x_ChemicalName', 'ChemicalName', '`ChemicalName`', '`ChemicalName`', 200, 45, -1, false, '`ChemicalName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Utilaization
        $this->Utilaization = new DbField('view_lab_service', 'view_lab_service', 'x_Utilaization', 'Utilaization', '`Utilaization`', '`Utilaization`', 200, 45, -1, false, '`Utilaization`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Interpretation
        $this->Interpretation = new DbField('view_lab_service', 'view_lab_service', 'x_Interpretation', 'Interpretation', '`Interpretation`', '`Interpretation`', 201, 65535, -1, false, '`Interpretation`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_lab_service_sub") {
            $detailUrl = Container("view_lab_service_sub")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_CODE", $this->CODE->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewLabServiceList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_lab_service`";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`DEPARTMENT` IN ('LAB','OTR')";
    ...
    {
        // Cascade Update detail table 'view_lab_service_sub'
        $cascadeUpdate = false;
        $rscascade = [];
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("view_lab_service_sub")->loadRs("`CODE` = " . QuotedValue($rsold['CODE'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                ...
                $success = Container("view_lab_service_sub")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("view_lab_service_sub")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("view_lab_service_sub")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        // Cascade delete detail table 'view_lab_service_sub'
        $dtlrows = Container("view_lab_service_sub")->loadRs("`CODE` = " . QuotedValue($rs['CODE'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("view_lab_service_sub")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("view_lab_service_sub")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("view_lab_service_sub")->rowDeleted($dtlrow);
            }
        }
        if ($success) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewLabServiceList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewLabServiceView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewLabServiceEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewLabServiceAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewLabServiceView";
            case Config("API_ADD_ACTION"):
                return "ViewLabServiceAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewLabServiceEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewLabServiceDelete";
            case Config("API_LIST_ACTION"):
                return "ViewLabServiceList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabServiceView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabServiceView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewLabServiceAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewLabServiceAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabServiceEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabServiceEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabServiceAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabServiceAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewLabServiceDelete", $this->getUrlParm());
    }
