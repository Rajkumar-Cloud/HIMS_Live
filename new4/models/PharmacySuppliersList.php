 ...
 * Page class
 */
class PharmacySuppliersList extends PharmacySuppliers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacySuppliersList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PharmacySuppliersAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PharmacySuppliersDelete";
        $this->MultiUpdateUrl = "PharmacySuppliersUpdate";
