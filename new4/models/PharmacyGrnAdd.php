 ...
 * Page class
 */
class PharmacyGrnAdd extends PharmacyGrn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyGrnAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PharmacyGrnView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_pharmacygrn", $detailTblVar) && $detailPage->DetailAdd) {
