 ...
 * Page class
 */
class EmployeeProjectsDelete extends EmployeeProjects
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeProjectsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeProjectsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeProjectsList"); // Return to list
                return;
            }
        }
