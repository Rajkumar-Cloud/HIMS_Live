...
/**
 * Table class for view_pharmacy_billing_voucher
 */
class ViewPharmacyBillingVoucher extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_billing_voucher';
        $this->TableName = 'view_pharmacy_billing_voucher';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_pharmacy_billing_voucher`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Reception
        $this->Reception = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientId
        $this->PatientId = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientId->Sortable = true; // Allow sort
        $this->PatientId->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientId->Param, "CustomMsg");
        $this->Fields['PatientId'] = &$this->PatientId;

        // mrnno
        $this->mrnno = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // PatientName
        $this->PatientName = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // profilePic
        $this->profilePic = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // Mobile
        $this->Mobile = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 45, -1, false, '`Mobile`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile->Sortable = true; // Allow sort
        $this->Mobile->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile->Param, "CustomMsg");
        $this->Fields['Mobile'] = &$this->Mobile;

        // IP_OP
        $this->IP_OP = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_IP_OP', 'IP_OP', '`IP_OP`', '`IP_OP`', 200, 45, -1, false, '`IP_OP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Doctor
        $this->Doctor = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, 45, -1, false, '`Doctor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // voucher_type
        $this->voucher_type = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Details
        $this->Details = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Details', 'Details', '`Details`', '`Details`', 200, 45, -1, false, '`Details`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Amount
        $this->Amount = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, 10, -1, false, '`Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnyDues
        $this->AnyDues = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_AnyDues', 'AnyDues', '`AnyDues`', '`AnyDues`', 200, 45, -1, false, '`AnyDues`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationAmount
        $this->RealizationAmount = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RealizationAmount', 'RealizationAmount', '`RealizationAmount`', '`RealizationAmount`', 131, 10, -1, false, '`RealizationAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationStatus
        $this->RealizationStatus = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RealizationStatus', 'RealizationStatus', '`RealizationStatus`', '`RealizationStatus`', 200, 45, -1, false, '`RealizationStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationRemarks
        $this->RealizationRemarks = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RealizationRemarks', 'RealizationRemarks', '`RealizationRemarks`', '`RealizationRemarks`', 200, 45, -1, false, '`RealizationRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationBatchNo
        $this->RealizationBatchNo = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RealizationBatchNo', 'RealizationBatchNo', '`RealizationBatchNo`', '`RealizationBatchNo`', 200, 45, -1, false, '`RealizationBatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationDate
        $this->RealizationDate = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RealizationDate', 'RealizationDate', '`RealizationDate`', '`RealizationDate`', 200, 45, -1, false, '`RealizationDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TidNo
        $this->TidNo = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PartnerName
        $this->PartnerName = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, 45, -1, false, '`PartnerName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PayerType
        $this->PayerType = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_PayerType', 'PayerType', '`PayerType`', '`PayerType`', 200, 45, -1, false, '`PayerType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Dob
        $this->Dob = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Dob', 'Dob', '`Dob`', '`Dob`', 200, 45, -1, false, '`Dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Currency
        $this->Currency = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, 45, -1, false, '`Currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 200, 45, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, 45, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Remarks->Sortable = true; // Allow sort
        $this->Remarks->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Remarks->Param, "CustomMsg");
        $this->Fields['Remarks'] = &$this->Remarks;

        // PatId
        $this->PatId = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrDepartment
        $this->DrDepartment = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_DrDepartment', 'DrDepartment', '`DrDepartment`', '`DrDepartment`', 200, 45, -1, false, '`DrDepartment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefferedBy
        $this->RefferedBy = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, 45, -1, false, '`RefferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillNumber
        $this->BillNumber = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, 45, -1, false, '`BillNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardNumber
        $this->CardNumber = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, 45, -1, false, '`CardNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BankName
        $this->BankName = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, 45, -1, false, '`BankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillStatus
        $this->BillStatus = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, 11, -1, false, '`BillStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PharID
        $this->PharID = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_PharID', 'PharID', '`PharID`', '`PharID`', 3, 11, -1, false, '`PharID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserName
        $this->_UserName = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardType
        $this->CardType = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_CardType', 'CardType', '`CardType`', '`CardType`', 200, 45, -1, false, '`CardType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountAmount
        $this->DiscountAmount = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_DiscountAmount', 'DiscountAmount', '`DiscountAmount`', '`DiscountAmount`', 131, 10, -1, false, '`DiscountAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ApprovalNumber
        $this->ApprovalNumber = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_ApprovalNumber', 'ApprovalNumber', '`ApprovalNumber`', '`ApprovalNumber`', 200, 45, -1, false, '`ApprovalNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cash
        $this->Cash = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Cash', 'Cash', '`Cash`', '`Cash`', 131, 10, -1, false, '`Cash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Card
        $this->Card = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_Card', 'Card', '`Card`', '`Card`', 131, 10, -1, false, '`Card`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddate
        $this->createddate = new DbField('view_pharmacy_billing_voucher', 'view_pharmacy_billing_voucher', 'x_createddate', 'createddate', '`createddate`', CastDateFieldForLike("`createddate`", 0, "DB"), 133, 10, 0, false, '`createddate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_pharmacy_billing_voucher`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyBillingVoucherList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyBillingVoucherView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyBillingVoucherEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyBillingVoucherAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyBillingVoucherView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyBillingVoucherAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyBillingVoucherEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyBillingVoucherDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyBillingVoucherList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyBillingVoucherView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyBillingVoucherView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyBillingVoucherAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyBillingVoucherAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyBillingVoucherEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyBillingVoucherAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyBillingVoucherDelete", $this->getUrlParm());
    }
