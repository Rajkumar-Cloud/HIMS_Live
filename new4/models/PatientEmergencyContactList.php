 ...
 * Page class
 */
class PatientEmergencyContactList extends PatientEmergencyContact
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientEmergencyContactList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PatientEmergencyContactAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PatientEmergencyContactDelete";
        $this->MultiUpdateUrl = "PatientEmergencyContactUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("patient_emergency_contact"));
                $doc->Text = @$content;
