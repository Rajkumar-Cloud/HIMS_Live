 ...
 * Page class
 */
class ViewDashboardServiceServicetypePreview extends ViewDashboardServiceServicetype
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardServiceServicetypePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_dashboard_service_summary") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_service_summary&" . GetForeignKeyUrl("fk_DEPARTMENT", $this->DEPARTMENT->QueryStringValue) . "&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->QueryStringValue, 7) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewDashboardServiceServicetypeList"), "", $this->TableVar, true);
        $pageId = "preview";
