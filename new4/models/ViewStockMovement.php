 ...
 */
class ViewStockMovement extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // prc
        $this->prc = new DbField('view_stock_movement', 'view_stock_movement', 'x_prc', 'prc', '`prc`', '`prc`', 200, 9, -1, false, '`prc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Product
        $this->Product = new DbField('view_stock_movement', 'view_stock_movement', 'x_Product', 'Product', '`Product`', '`Product`', 200, 100, -1, false, '`Product`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCHNO
        $this->BATCHNO = new DbField('view_stock_movement', 'view_stock_movement', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, 45, -1, false, '`BATCHNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('view_stock_movement', 'view_stock_movement', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 34, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnQuantity
        $this->GrnQuantity = new DbField('view_stock_movement', 'view_stock_movement', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 131, 32, -1, false, '`GrnQuantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GrnQuantity->Sortable = true; // Allow sort
        $this->GrnQuantity->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // FreeQty
        $this->FreeQty = new DbField('view_stock_movement', 'view_stock_movement', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 131, 32, -1, false, '`FreeQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->FreeQty->Sortable = true; // Allow sort
        $this->FreeQty->DefaultDecimalPrecision = 2; // Default decimal precision
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_stock_movement', 'view_stock_movement', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_stock_movement', 'view_stock_movement', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_stock_movement', 'view_stock_movement', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDate
        $this->CreatedDate = new DbField('view_stock_movement', 'view_stock_movement', 'x_CreatedDate', 'CreatedDate', '`CreatedDate`', CastDateFieldForLike("`CreatedDate`", 7, "DB"), 133, 10, 7, false, '`CreatedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewStockMovementList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewStockMovementView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewStockMovementEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewStockMovementAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewStockMovementView";
            case Config("API_ADD_ACTION"):
                return "ViewStockMovementAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewStockMovementEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewStockMovementDelete";
            case Config("API_LIST_ACTION"):
                return "ViewStockMovementList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewStockMovementView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewStockMovementView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewStockMovementAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewStockMovementAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewStockMovementEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewStockMovementAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewStockMovementDelete", $this->getUrlParm());
    }
