 ...
 * Page class
 */
class ViewBillingVoucherVoucherView extends ViewBillingVoucherVoucher
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBillingVoucherVoucherView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewBillingVoucherVoucherList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewBillingVoucherVoucherList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewBillingVoucherVoucherList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewBillingVoucherVoucherList"), "", $this->TableVar, true);
        $pageId = "view";
