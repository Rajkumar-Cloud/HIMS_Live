 ...
 * Page class
 */
class ViewBillingVoucherPrintAdd extends ViewBillingVoucherPrint
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBillingVoucherPrintAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ViewBillingVoucherPrintView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->RIDNO->ViewValue !== null) { // Load from cache
                ...
                $arwrk = $rswrk;
                foreach ($arwrk as &$row)
                    $row = $this->RIDNO->Lookup->renderViewRow($row);
