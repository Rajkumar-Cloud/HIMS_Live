 ...
 * Page class
 */
class DepositPettycashView extends DepositPettycash
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DepositPettycashView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DepositPettycashList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DepositPettycashList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "DepositPettycashList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
