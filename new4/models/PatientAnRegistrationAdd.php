 ...
 * Page class
 */
class PatientAnRegistrationAdd extends PatientAnRegistration
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAnRegistrationAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PatientAnRegistrationView") {
