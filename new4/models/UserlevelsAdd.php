...
class UserlevelsAdd extends Userlevels
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->UserLevelsName->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->UserLevelsName->Visible = false; // Disable update for API request
            } else {
                $this->UserLevelsName->setFormValue($val);
            }
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        $this->UserLevelsName->CurrentValue = $this->UserLevelsName->FormValue;
    }
    ...
    protected function validateForm()
    {
        ...
        if ($this->UserLevelsName->Required) {
            if (!$this->UserLevelsName->IsDetailKey && EmptyValue($this->UserLevelsName->FormValue)) {
                $this->UserLevelsName->addErrorMessage(str_replace("%s", $this->UserLevelsName->caption(), $this->UserLevelsName->RequiredErrorMessage));
            }
        }
