 ...
 * Page class
 */
class EmployeeAddressDelete extends EmployeeAddress
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeAddressDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeAddressList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeAddressList"); // Return to list
                return;
            }
        }
