 ...
 * Page class
 */
class ViewStoreGrnPreview extends ViewStoreGrn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewStoreGrnPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "store_grn") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=store_grn&" . GetForeignKeyUrl("fk_id", $this->grnid->QueryStringValue) . "";
        }
        return $url;
    }
