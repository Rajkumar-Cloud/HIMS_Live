 ...
 */
class ViewIssuingSemen extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // RIDNo
        $this->RIDNo = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, 11, -1, false, '`RIDNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientName
        $this->PatientName = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // HusbandName
        $this->HusbandName = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_HusbandName', 'HusbandName', '`HusbandName`', '`HusbandName`', 200, 45, -1, false, '`HusbandName`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // RequestDr
        $this->RequestDr = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_RequestDr', 'RequestDr', '`RequestDr`', '`RequestDr`', 200, 45, -1, false, '`RequestDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CollectionDate
        $this->CollectionDate = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_CollectionDate', 'CollectionDate', '`CollectionDate`', CastDateFieldForLike("`CollectionDate`", 0, "DB"), 135, 19, 0, false, '`CollectionDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Tank
        $this->Tank = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_Tank', 'Tank', '`Tank`', '`Tank`', 200, 45, -1, false, '`Tank`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Location
        $this->Location = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_Location', 'Location', '`Location`', '`Location`', 200, 45, -1, false, '`Location`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IssuedBy
        $this->IssuedBy = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_IssuedBy', 'IssuedBy', '`IssuedBy`', '`IssuedBy`', 200, 45, -1, false, '`IssuedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IssuedTo
        $this->IssuedTo = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_IssuedTo', 'IssuedTo', '`IssuedTo`', '`IssuedTo`', 200, 45, -1, false, '`IssuedTo`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // RequestSample
        $this->RequestSample = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_RequestSample', 'RequestSample', '`RequestSample`', '`RequestSample`', 200, 45, -1, false, '`RequestSample`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`RequestSample`='Freezing'";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewIssuingSemenList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewIssuingSemenView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewIssuingSemenEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewIssuingSemenAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewIssuingSemenView";
            case Config("API_ADD_ACTION"):
                return "ViewIssuingSemenAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewIssuingSemenEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewIssuingSemenDelete";
            case Config("API_LIST_ACTION"):
                return "ViewIssuingSemenList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewIssuingSemenView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewIssuingSemenView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewIssuingSemenAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewIssuingSemenAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIssuingSemenEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIssuingSemenAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewIssuingSemenDelete", $this->getUrlParm());
    }
