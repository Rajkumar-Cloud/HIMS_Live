...
class StoreStoreled extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // StoreID
        $this->StoreID = new DbField('store_storeled', 'store_storeled', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, 11, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StoreStoreledList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StoreStoreledView";
            case Config("API_ADD_ACTION"):
                return "StoreStoreledAdd";
            case Config("API_EDIT_ACTION"):
                return "StoreStoreledEdit";
            case Config("API_DELETE_ACTION"):
                return "StoreStoreledDelete";
