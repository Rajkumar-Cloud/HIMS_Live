 ...
 * Page class
 */
class HrTrainingsessionsDelete extends HrTrainingsessions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrTrainingsessionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HrTrainingsessionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HrTrainingsessionsList"); // Return to list
                return;
            }
        }
