...
class PresGenericinteractions extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Catid->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Catid->Param, "CustomMsg");
        ...
        $this->Interactions->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Interactions->Param, "CustomMsg");
        ...
        $this->Intid->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Intid->Param, "CustomMsg");
        ...
        $this->Createdtm->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Createdtm->Param, "CustomMsg");
        ...
        $this->Statusbit->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Statusbit->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PresGenericinteractionsList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PresGenericinteractionsView";
            case Config("API_ADD_ACTION"):
                return "PresGenericinteractionsAdd";
            case Config("API_EDIT_ACTION"):
                return "PresGenericinteractionsEdit";
            case Config("API_DELETE_ACTION"):
                return "PresGenericinteractionsDelete";
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->Createdtm->EditValue = FormatDateTime($this->Createdtm->CurrentValue, 4);
