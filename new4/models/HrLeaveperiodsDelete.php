 ...
 * Page class
 */
class HrLeaveperiodsDelete extends HrLeaveperiods
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrLeaveperiodsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HrLeaveperiodsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HrLeaveperiodsList"); // Return to list
                return;
            }
        }
