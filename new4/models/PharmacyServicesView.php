 ...
 * Page class
 */
class PharmacyServicesView extends PharmacyServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyServicesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PharmacyServicesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PharmacyServicesList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PharmacyServicesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
