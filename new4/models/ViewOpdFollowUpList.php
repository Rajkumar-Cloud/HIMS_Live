 ...
 * Page class
 */
class ViewOpdFollowUpList extends ViewOpdFollowUp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOpdFollowUpList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewOpdFollowUpAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewOpdFollowUpDelete";
        $this->MultiUpdateUrl = "ViewOpdFollowUpUpdate";
