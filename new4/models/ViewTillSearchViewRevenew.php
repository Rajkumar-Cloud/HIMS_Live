 ...
 */
class ViewTillSearchViewRevenew extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DepositDate
        $this->DepositDate = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_DepositDate', 'DepositDate', '`DepositDate`', CastDateFieldForLike("`DepositDate`", 7, "DB"), 135, 19, 7, false, '`DepositDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DepositDate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DepositDate->Param, "CustomMsg");
        $this->Fields['DepositDate'] = &$this->DepositDate;

        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 11, "DB"), 135, 19, 11, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedUserName
        $this->CreatedUserName = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_CreatedUserName', 'CreatedUserName', '`CreatedUserName`', '`CreatedUserName`', 200, 45, -1, false, '`CreatedUserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DepositToBankSelect
        $this->DepositToBankSelect = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_DepositToBankSelect', 'DepositToBankSelect', '`DepositToBankSelect`', '`DepositToBankSelect`', 200, 45, -1, false, '`DepositToBankSelect`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DepositToBankSelect->Sortable = true; // Allow sort
        $this->DepositToBankSelect->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DepositToBankSelect->Param, "CustomMsg");
        $this->Fields['DepositToBankSelect'] = &$this->DepositToBankSelect;

        // DepositToBank
        $this->DepositToBank = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_DepositToBank', 'DepositToBank', '`DepositToBank`', '`DepositToBank`', 200, 45, -1, false, '`DepositToBank`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DepositToBank->Sortable = true; // Allow sort
        $this->DepositToBank->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DepositToBank->Param, "CustomMsg");
        $this->Fields['DepositToBank'] = &$this->DepositToBank;

        // TransferToSelect
        $this->TransferToSelect = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_TransferToSelect', 'TransferToSelect', '`TransferToSelect`', '`TransferToSelect`', 200, 45, -1, false, '`TransferToSelect`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TransferToSelect->Sortable = true; // Allow sort
        $this->TransferToSelect->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TransferToSelect->Param, "CustomMsg");
        $this->Fields['TransferToSelect'] = &$this->TransferToSelect;

        // TransferTo
        $this->TransferTo = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_TransferTo', 'TransferTo', '`TransferTo`', '`TransferTo`', 200, 45, -1, false, '`TransferTo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TransferTo->Sortable = true; // Allow sort
        $this->TransferTo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TransferTo->Param, "CustomMsg");
        $this->Fields['TransferTo'] = &$this->TransferTo;

        // OpeningBalance
        $this->OpeningBalance = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_OpeningBalance', 'OpeningBalance', '`OpeningBalance`', '`OpeningBalance`', 131, 10, -1, false, '`OpeningBalance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OpeningBalance->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OpeningBalance->Param, "CustomMsg");
        $this->Fields['OpeningBalance'] = &$this->OpeningBalance;

        // A2000Count
        $this->A2000Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A2000Count', 'A2000Count', '`A2000Count`', '`A2000Count`', 3, 11, -1, false, '`A2000Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A2000Count->Sortable = true; // Allow sort
        $this->A2000Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A2000Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A2000Count->Param, "CustomMsg");
        $this->Fields['A2000Count'] = &$this->A2000Count;

        // A2000Amount
        $this->A2000Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A2000Amount', 'A2000Amount', '`A2000Amount`', '`A2000Amount`', 131, 10, -1, false, '`A2000Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A2000Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A2000Amount->Param, "CustomMsg");
        $this->Fields['A2000Amount'] = &$this->A2000Amount;

        // A1000Count
        $this->A1000Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A1000Count', 'A1000Count', '`A1000Count`', '`A1000Count`', 3, 11, -1, false, '`A1000Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A1000Count->Sortable = true; // Allow sort
        $this->A1000Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A1000Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A1000Count->Param, "CustomMsg");
        $this->Fields['A1000Count'] = &$this->A1000Count;

        // A1000Amount
        $this->A1000Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A1000Amount', 'A1000Amount', '`A1000Amount`', '`A1000Amount`', 131, 10, -1, false, '`A1000Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A1000Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A1000Amount->Param, "CustomMsg");
        $this->Fields['A1000Amount'] = &$this->A1000Amount;

        // A500Count
        $this->A500Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A500Count', 'A500Count', '`A500Count`', '`A500Count`', 3, 11, -1, false, '`A500Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A500Count->Sortable = true; // Allow sort
        $this->A500Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A500Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A500Count->Param, "CustomMsg");
        $this->Fields['A500Count'] = &$this->A500Count;

        // A500Amount
        $this->A500Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A500Amount', 'A500Amount', '`A500Amount`', '`A500Amount`', 131, 10, -1, false, '`A500Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A500Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A500Amount->Param, "CustomMsg");
        $this->Fields['A500Amount'] = &$this->A500Amount;

        // A200Count
        $this->A200Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A200Count', 'A200Count', '`A200Count`', '`A200Count`', 3, 11, -1, false, '`A200Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A200Count->Sortable = true; // Allow sort
        $this->A200Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A200Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A200Count->Param, "CustomMsg");
        $this->Fields['A200Count'] = &$this->A200Count;

        // A200Amount
        $this->A200Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A200Amount', 'A200Amount', '`A200Amount`', '`A200Amount`', 131, 10, -1, false, '`A200Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A200Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A200Amount->Param, "CustomMsg");
        $this->Fields['A200Amount'] = &$this->A200Amount;

        // A100Count
        $this->A100Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A100Count', 'A100Count', '`A100Count`', '`A100Count`', 3, 11, -1, false, '`A100Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A100Count->Sortable = true; // Allow sort
        $this->A100Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A100Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A100Count->Param, "CustomMsg");
        $this->Fields['A100Count'] = &$this->A100Count;

        // A100Amount
        $this->A100Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A100Amount', 'A100Amount', '`A100Amount`', '`A100Amount`', 131, 10, -1, false, '`A100Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A100Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A100Amount->Param, "CustomMsg");
        $this->Fields['A100Amount'] = &$this->A100Amount;

        // A50Count
        $this->A50Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A50Count', 'A50Count', '`A50Count`', '`A50Count`', 3, 11, -1, false, '`A50Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A50Count->Sortable = true; // Allow sort
        $this->A50Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A50Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A50Count->Param, "CustomMsg");
        $this->Fields['A50Count'] = &$this->A50Count;

        // A50Amount
        $this->A50Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A50Amount', 'A50Amount', '`A50Amount`', '`A50Amount`', 131, 10, -1, false, '`A50Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A50Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A50Amount->Param, "CustomMsg");
        $this->Fields['A50Amount'] = &$this->A50Amount;

        // A20Count
        $this->A20Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A20Count', 'A20Count', '`A20Count`', '`A20Count`', 3, 11, -1, false, '`A20Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A20Count->Sortable = true; // Allow sort
        $this->A20Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A20Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A20Count->Param, "CustomMsg");
        $this->Fields['A20Count'] = &$this->A20Count;

        // A20Amount
        $this->A20Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A20Amount', 'A20Amount', '`A20Amount`', '`A20Amount`', 131, 10, -1, false, '`A20Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A20Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A20Amount->Param, "CustomMsg");
        $this->Fields['A20Amount'] = &$this->A20Amount;

        // A10Count
        $this->A10Count = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A10Count', 'A10Count', '`A10Count`', '`A10Count`', 3, 11, -1, false, '`A10Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->A10Count->Sortable = true; // Allow sort
        $this->A10Count->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->A10Count->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A10Count->Param, "CustomMsg");
        $this->Fields['A10Count'] = &$this->A10Count;

        // A10Amount
        $this->A10Amount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_A10Amount', 'A10Amount', '`A10Amount`', '`A10Amount`', 131, 10, -1, false, '`A10Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->A10Amount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->A10Amount->Param, "CustomMsg");
        $this->Fields['A10Amount'] = &$this->A10Amount;

        // Other
        $this->Other = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_Other', 'Other', '`Other`', '`Other`', 131, 10, -1, false, '`Other`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TotalCash
        $this->TotalCash = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_TotalCash', 'TotalCash', '`TotalCash`', '`TotalCash`', 131, 10, -1, false, '`TotalCash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TotalCash->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TotalCash->Param, "CustomMsg");
        $this->Fields['TotalCash'] = &$this->TotalCash;

        // Cheque
        $this->Cheque = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_Cheque', 'Cheque', '`Cheque`', '`Cheque`', 131, 10, -1, false, '`Cheque`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Cheque->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Cheque->Param, "CustomMsg");
        $this->Fields['Cheque'] = &$this->Cheque;

        // Card
        $this->Card = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_Card', 'Card', '`Card`', '`Card`', 131, 10, -1, false, '`Card`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NEFTRTGS
        $this->NEFTRTGS = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_NEFTRTGS', 'NEFTRTGS', '`NEFTRTGS`', '`NEFTRTGS`', 131, 10, -1, false, '`NEFTRTGS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NEFTRTGS->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NEFTRTGS->Param, "CustomMsg");
        $this->Fields['NEFTRTGS'] = &$this->NEFTRTGS;

        // TotalTransferDepositAmount
        $this->TotalTransferDepositAmount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_TotalTransferDepositAmount', 'TotalTransferDepositAmount', '`TotalTransferDepositAmount`', '`TotalTransferDepositAmount`', 131, 10, -1, false, '`TotalTransferDepositAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TotalTransferDepositAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TotalTransferDepositAmount->Param, "CustomMsg");
        $this->Fields['TotalTransferDepositAmount'] = &$this->TotalTransferDepositAmount;

        // CreatedBy
        $this->CreatedBy = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, 11, -1, false, '`CreatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedBy
        $this->ModifiedBy = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, 11, -1, false, '`ModifiedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedUserName
        $this->ModifiedUserName = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_ModifiedUserName', 'ModifiedUserName', '`ModifiedUserName`', '`ModifiedUserName`', 200, 45, -1, false, '`ModifiedUserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ModifiedUserName->Sortable = true; // Allow sort
        $this->ModifiedUserName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ModifiedUserName->Param, "CustomMsg");
        $this->Fields['ModifiedUserName'] = &$this->ModifiedUserName;

        // BalanceAmount
        $this->BalanceAmount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_BalanceAmount', 'BalanceAmount', '`BalanceAmount`', '`BalanceAmount`', 131, 10, -1, false, '`BalanceAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->BalanceAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BalanceAmount->Param, "CustomMsg");
        $this->Fields['BalanceAmount'] = &$this->BalanceAmount;

        // CashCollected
        $this->CashCollected = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_CashCollected', 'CashCollected', '`CashCollected`', '`CashCollected`', 131, 10, -1, false, '`CashCollected`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->CashCollected->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CashCollected->Param, "CustomMsg");
        $this->Fields['CashCollected'] = &$this->CashCollected;

        // RTGS
        $this->RTGS = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_RTGS', 'RTGS', '`RTGS`', '`RTGS`', 131, 10, -1, false, '`RTGS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->RTGS->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RTGS->Param, "CustomMsg");
        $this->Fields['RTGS'] = &$this->RTGS;

        // PAYTM
        $this->PAYTM = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_PAYTM', 'PAYTM', '`PAYTM`', '`PAYTM`', 131, 10, -1, false, '`PAYTM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PAYTM->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PAYTM->Param, "CustomMsg");
        $this->Fields['PAYTM'] = &$this->PAYTM;

        // HospID
        $this->HospID = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ManualCash
        $this->ManualCash = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_ManualCash', 'ManualCash', '`ManualCash`', '`ManualCash`', 131, 10, -1, false, '`ManualCash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ManualCash->Sortable = true; // Allow sort
        $this->ManualCash->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->ManualCash->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->ManualCash->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ManualCash->Param, "CustomMsg");
        $this->Fields['ManualCash'] = &$this->ManualCash;

        // ManualCard
        $this->ManualCard = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_ManualCard', 'ManualCard', '`ManualCard`', '`ManualCard`', 131, 10, -1, false, '`ManualCard`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ManualCard->Sortable = true; // Allow sort
        $this->ManualCard->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->ManualCard->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->ManualCard->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ManualCard->Param, "CustomMsg");
        $this->Fields['ManualCard'] = &$this->ManualCard;

        // TotalCashAmount
        $this->TotalCashAmount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_TotalCashAmount', 'TotalCashAmount', '`TotalCashAmount`', '`TotalCashAmount`', 131, 12, -1, false, '`TotalCashAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TotalCashAmount->Sortable = true; // Allow sort
        $this->TotalCashAmount->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->TotalCashAmount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->TotalCashAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TotalCashAmount->Param, "CustomMsg");
        $this->Fields['TotalCashAmount'] = &$this->TotalCashAmount;

        // TotalCardAmount
        $this->TotalCardAmount = new DbField('view_till_search_view_revenew', 'view_till_search_view_revenew', 'x_TotalCardAmount', 'TotalCardAmount', '`TotalCardAmount`', '`TotalCardAmount`', 131, 11, -1, false, '`TotalCardAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TotalCardAmount->Sortable = true; // Allow sort
        $this->TotalCardAmount->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->TotalCardAmount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->TotalCardAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TotalCardAmount->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewTillSearchViewRevenewList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewTillSearchViewRevenewView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewTillSearchViewRevenewEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewTillSearchViewRevenewAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewTillSearchViewRevenewView";
            case Config("API_ADD_ACTION"):
                return "ViewTillSearchViewRevenewAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewTillSearchViewRevenewEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewTillSearchViewRevenewDelete";
            case Config("API_LIST_ACTION"):
                return "ViewTillSearchViewRevenewList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewTillSearchViewRevenewView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewTillSearchViewRevenewView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewTillSearchViewRevenewAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewTillSearchViewRevenewAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTillSearchViewRevenewEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTillSearchViewRevenewAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewTillSearchViewRevenewDelete", $this->getUrlParm());
    }
