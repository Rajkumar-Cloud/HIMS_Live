 ...
 * Page class
 */
class ViewDashboardPatientDetailsPreview extends ViewDashboardPatientDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardPatientDetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_dashboard_patient_summary") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_patient_summary&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->QueryStringValue, 7) . "&" . GetForeignKeyUrl("fk_WhereDidYouHear", $this->WhereDidYouHear->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewDashboardPatientDetailsList"), "", $this->TableVar, true);
        $pageId = "preview";
