 ...
 * Page class
 */
class RoomMasterView extends RoomMaster
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RoomMasterView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "RoomMasterList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RoomMasterList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "RoomMasterList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
