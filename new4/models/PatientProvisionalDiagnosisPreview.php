 ...
 * Page class
 */
class PatientProvisionalDiagnosisPreview extends PatientProvisionalDiagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientProvisionalDiagnosisPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "ip_admission") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ip_admission&" . GetForeignKeyUrl("fk_id", $this->Reception->QueryStringValue) . "&" . GetForeignKeyUrl("fk_patient_id", $this->PatientId->QueryStringValue) . "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnno->QueryStringValue) . "";
        }
        return $url;
    }
