 ...
 * Page class
 */
class ViewLabServiceAdd extends ViewLabService
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabServiceAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("ViewLabServiceList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ViewLabServiceList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ViewLabServiceView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_lab_service_sub", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("ViewLabServiceSubGrid");
            if (in_array("view_lab_service_sub", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->CODE->setSessionValue($this->CODE->CurrentValue); // Set master key
