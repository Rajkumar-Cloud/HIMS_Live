 ...
 * Page class
 */
class MasUserTemplateAdd extends MasUserTemplate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasUserTemplateAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MasUserTemplateView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Template
        $this->_Template->setDbValueDef($rsnew, $this->_Template->CurrentValue, null, false);
