...
/**
 * Table class for view_patient_services_dashboard
 */
class ViewPatientServicesDashboard2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_patient_services_dashboard2';
        $this->TableName = 'view_patient_services_dashboard';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_patient_services_dashboard`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Reception
        $this->Reception = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatID
        $this->PatID = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mrnno
        $this->mrnno = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // PatientName
        $this->PatientName = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // profilePic
        $this->profilePic = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // Services
        $this->Services = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Services', 'Services', '`Services`', '`Services`', 200, 50, -1, false, '`Services`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Unit
        $this->Unit = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Unit', 'Unit', '`Unit`', '`Unit`', 3, 11, -1, false, '`Unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // amount
        $this->amount = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_amount', 'amount', '`amount`', '`amount`', 131, 12, -1, false, '`amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Quantity
        $this->Quantity = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, 11, -1, false, '`Quantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Discount
        $this->Discount = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, 12, -1, false, '`Discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SubTotal
        $this->SubTotal = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_SubTotal', 'SubTotal', '`SubTotal`', '`SubTotal`', 131, 12, -1, false, '`SubTotal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // description
        $this->description = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->description->Sortable = true; // Allow sort
        $this->description->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->description->Param, "CustomMsg");
        $this->Fields['description'] = &$this->description;

        // patient_type
        $this->patient_type = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_patient_type', 'patient_type', '`patient_type`', '`patient_type`', 3, 11, -1, false, '`patient_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->patient_type->Sortable = true; // Allow sort
        $this->patient_type->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->patient_type->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->patient_type->Param, "CustomMsg");
        $this->Fields['patient_type'] = &$this->patient_type;

        // charged_date
        $this->charged_date = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_charged_date', 'charged_date', '`charged_date`', CastDateFieldForLike("`charged_date`", 0, "DB"), 135, 19, 0, false, '`charged_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->charged_date->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->charged_date->Param, "CustomMsg");
        $this->Fields['charged_date'] = &$this->charged_date;

        // status
        $this->status = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Aid
        $this->Aid = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Aid', 'Aid', '`Aid`', '`Aid`', 3, 11, -1, false, '`Aid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Aid->Sortable = true; // Allow sort
        $this->Aid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Aid->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Aid->Param, "CustomMsg");
        $this->Fields['Aid'] = &$this->Aid;

        // Vid
        $this->Vid = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, 11, -1, false, '`Vid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrCODE
        $this->DrCODE = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrCODE', 'DrCODE', '`DrCODE`', '`DrCODE`', 200, 45, -1, false, '`DrCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrName
        $this->DrName = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, 45, -1, false, '`DrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Department
        $this->Department = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Department', 'Department', '`Department`', '`Department`', 200, 45, -1, false, '`Department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrSharePres
        $this->DrSharePres = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrSharePres', 'DrSharePres', '`DrSharePres`', '`DrSharePres`', 131, 12, -1, false, '`DrSharePres`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DrSharePres->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DrSharePres->Param, "CustomMsg");
        $this->Fields['DrSharePres'] = &$this->DrSharePres;

        // HospSharePres
        $this->HospSharePres = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_HospSharePres', 'HospSharePres', '`HospSharePres`', '`HospSharePres`', 131, 12, -1, false, '`HospSharePres`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->HospSharePres->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HospSharePres->Param, "CustomMsg");
        $this->Fields['HospSharePres'] = &$this->HospSharePres;

        // DrShareAmount
        $this->DrShareAmount = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrShareAmount', 'DrShareAmount', '`DrShareAmount`', '`DrShareAmount`', 131, 12, -1, false, '`DrShareAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospShareAmount
        $this->HospShareAmount = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_HospShareAmount', 'HospShareAmount', '`HospShareAmount`', '`HospShareAmount`', 131, 12, -1, false, '`HospShareAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DrShareSettiledAmount = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrShareSettiledAmount', 'DrShareSettiledAmount', '`DrShareSettiledAmount`', '`DrShareSettiledAmount`', 131, 12, -1, false, '`DrShareSettiledAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DrShareSettiledAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DrShareSettiledAmount->Param, "CustomMsg");
        $this->Fields['DrShareSettiledAmount'] = &$this->DrShareSettiledAmount;

        // DrShareSettledId
        $this->DrShareSettledId = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrShareSettledId', 'DrShareSettledId', '`DrShareSettledId`', '`DrShareSettledId`', 3, 11, -1, false, '`DrShareSettledId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DrShareSettledId->Sortable = true; // Allow sort
        $this->DrShareSettledId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->DrShareSettledId->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DrShareSettledId->Param, "CustomMsg");
        $this->Fields['DrShareSettledId'] = &$this->DrShareSettledId;

        // DrShareSettiledStatus
        $this->DrShareSettiledStatus = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DrShareSettiledStatus', 'DrShareSettiledStatus', '`DrShareSettiledStatus`', '`DrShareSettiledStatus`', 3, 11, -1, false, '`DrShareSettiledStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DrShareSettiledStatus->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DrShareSettiledStatus->Param, "CustomMsg");
        $this->Fields['DrShareSettiledStatus'] = &$this->DrShareSettiledStatus;

        // invoiceId
        $this->invoiceId = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, 11, -1, false, '`invoiceId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // invoiceAmount
        $this->invoiceAmount = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_invoiceAmount', 'invoiceAmount', '`invoiceAmount`', '`invoiceAmount`', 131, 12, -1, false, '`invoiceAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->invoiceAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->invoiceAmount->Param, "CustomMsg");
        $this->Fields['invoiceAmount'] = &$this->invoiceAmount;

        // invoiceStatus
        $this->invoiceStatus = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_invoiceStatus', 'invoiceStatus', '`invoiceStatus`', '`invoiceStatus`', 200, 45, -1, false, '`invoiceStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->invoiceStatus->Sortable = true; // Allow sort
        $this->invoiceStatus->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->invoiceStatus->Param, "CustomMsg");
        $this->Fields['invoiceStatus'] = &$this->invoiceStatus;

        // modeOfPayment
        $this->modeOfPayment = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_modeOfPayment', 'modeOfPayment', '`modeOfPayment`', '`modeOfPayment`', 200, 45, -1, false, '`modeOfPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TidNo
        $this->TidNo = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountCategory
        $this->DiscountCategory = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DiscountCategory', 'DiscountCategory', '`DiscountCategory`', '`DiscountCategory`', 200, 45, -1, false, '`DiscountCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DiscountCategory->Sortable = true; // Allow sort
        $this->DiscountCategory->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DiscountCategory->Param, "CustomMsg");
        $this->Fields['DiscountCategory'] = &$this->DiscountCategory;

        // sid
        $this->sid = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_sid', 'sid', '`sid`', '`sid`', 3, 11, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemCode
        $this->ItemCode = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, 45, -1, false, '`ItemCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestSubCd
        $this->TestSubCd = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_TestSubCd', 'TestSubCd', '`TestSubCd`', '`TestSubCd`', 200, 45, -1, false, '`TestSubCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DEptCd
        $this->DEptCd = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, 45, -1, false, '`DEptCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ProfCd
        $this->ProfCd = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ProfCd', 'ProfCd', '`ProfCd`', '`ProfCd`', 200, 45, -1, false, '`ProfCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LabReport
        $this->LabReport = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, 65535, -1, false, '`LabReport`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Comments
        $this->Comments = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Comments', 'Comments', '`Comments`', '`Comments`', 200, 45, -1, false, '`Comments`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Method
        $this->Method = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Method', 'Method', '`Method`', '`Method`', 200, 45, -1, false, '`Method`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Specimen
        $this->Specimen = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Specimen', 'Specimen', '`Specimen`', '`Specimen`', 200, 45, -1, false, '`Specimen`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Abnormal
        $this->Abnormal = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Abnormal', 'Abnormal', '`Abnormal`', '`Abnormal`', 200, 45, -1, false, '`Abnormal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefValue
        $this->RefValue = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, 65535, -1, false, '`RefValue`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // TestUnit
        $this->TestUnit = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_TestUnit', 'TestUnit', '`TestUnit`', '`TestUnit`', 200, 45, -1, false, '`TestUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOWHIGH
        $this->LOWHIGH = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_LOWHIGH', 'LOWHIGH', '`LOWHIGH`', '`LOWHIGH`', 200, 45, -1, false, '`LOWHIGH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Branch
        $this->Branch = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Branch', 'Branch', '`Branch`', '`Branch`', 200, 45, -1, false, '`Branch`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Dispatch
        $this->Dispatch = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Dispatch', 'Dispatch', '`Dispatch`', '`Dispatch`', 200, 45, -1, false, '`Dispatch`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic1
        $this->Pic1 = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, 45, -1, false, '`Pic1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic2
        $this->Pic2 = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, 45, -1, false, '`Pic2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GraphPath
        $this->GraphPath = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_GraphPath', 'GraphPath', '`GraphPath`', '`GraphPath`', 200, 45, -1, false, '`GraphPath`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MachineCD
        $this->MachineCD = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_MachineCD', 'MachineCD', '`MachineCD`', '`MachineCD`', 200, 45, -1, false, '`MachineCD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestCancel
        $this->TestCancel = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_TestCancel', 'TestCancel', '`TestCancel`', '`TestCancel`', 200, 45, -1, false, '`TestCancel`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OutSource
        $this->OutSource = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_OutSource', 'OutSource', '`OutSource`', '`OutSource`', 200, 45, -1, false, '`OutSource`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Printed
        $this->Printed = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Printed', 'Printed', '`Printed`', '`Printed`', 200, 45, -1, false, '`Printed`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrintBy
        $this->PrintBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_PrintBy', 'PrintBy', '`PrintBy`', '`PrintBy`', 200, 45, -1, false, '`PrintBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrintDate
        $this->PrintDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_PrintDate', 'PrintDate', '`PrintDate`', CastDateFieldForLike("`PrintDate`", 0, "DB"), 135, 19, 0, false, '`PrintDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillingDate
        $this->BillingDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_BillingDate', 'BillingDate', '`BillingDate`', CastDateFieldForLike("`BillingDate`", 0, "DB"), 135, 19, 0, false, '`BillingDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->BillingDate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BillingDate->Param, "CustomMsg");
        $this->Fields['BillingDate'] = &$this->BillingDate;

        // BilledBy
        $this->BilledBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_BilledBy', 'BilledBy', '`BilledBy`', '`BilledBy`', 200, 45, -1, false, '`BilledBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BilledBy->Sortable = true; // Allow sort
        $this->BilledBy->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BilledBy->Param, "CustomMsg");
        $this->Fields['BilledBy'] = &$this->BilledBy;

        // Resulted
        $this->Resulted = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, 45, -1, false, '`Resulted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultDate
        $this->ResultDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike("`ResultDate`", 0, "DB"), 135, 19, 0, false, '`ResultDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultedBy
        $this->ResultedBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, 45, -1, false, '`ResultedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SampleDate
        $this->SampleDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_SampleDate', 'SampleDate', '`SampleDate`', CastDateFieldForLike("`SampleDate`", 0, "DB"), 135, 19, 0, false, '`SampleDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SampleUser
        $this->SampleUser = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_SampleUser', 'SampleUser', '`SampleUser`', '`SampleUser`', 200, 45, -1, false, '`SampleUser`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Sampled
        $this->Sampled = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Sampled', 'Sampled', '`Sampled`', '`Sampled`', 200, 45, -1, false, '`Sampled`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Sampled->Sortable = true; // Allow sort
        $this->Sampled->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Sampled->Param, "CustomMsg");
        $this->Fields['Sampled'] = &$this->Sampled;

        // ReceivedDate
        $this->ReceivedDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ReceivedDate', 'ReceivedDate', '`ReceivedDate`', CastDateFieldForLike("`ReceivedDate`", 0, "DB"), 135, 19, 0, false, '`ReceivedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReceivedUser
        $this->ReceivedUser = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ReceivedUser', 'ReceivedUser', '`ReceivedUser`', '`ReceivedUser`', 200, 45, -1, false, '`ReceivedUser`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Recevied
        $this->Recevied = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Recevied', 'Recevied', '`Recevied`', '`Recevied`', 200, 45, -1, false, '`Recevied`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Recevied->Sortable = true; // Allow sort
        $this->Recevied->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Recevied->Param, "CustomMsg");
        $this->Fields['Recevied'] = &$this->Recevied;

        // DeptRecvDate
        $this->DeptRecvDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DeptRecvDate', 'DeptRecvDate', '`DeptRecvDate`', CastDateFieldForLike("`DeptRecvDate`", 0, "DB"), 135, 19, 0, false, '`DeptRecvDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DeptRecvUser
        $this->DeptRecvUser = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DeptRecvUser', 'DeptRecvUser', '`DeptRecvUser`', '`DeptRecvUser`', 200, 45, -1, false, '`DeptRecvUser`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DeptRecived
        $this->DeptRecived = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_DeptRecived', 'DeptRecived', '`DeptRecived`', '`DeptRecived`', 200, 45, -1, false, '`DeptRecived`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DeptRecived->Sortable = true; // Allow sort
        $this->DeptRecived->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DeptRecived->Param, "CustomMsg");
        $this->Fields['DeptRecived'] = &$this->DeptRecived;

        // SAuthDate
        $this->SAuthDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_SAuthDate', 'SAuthDate', '`SAuthDate`', CastDateFieldForLike("`SAuthDate`", 0, "DB"), 135, 19, 0, false, '`SAuthDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SAuthBy
        $this->SAuthBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_SAuthBy', 'SAuthBy', '`SAuthBy`', '`SAuthBy`', 200, 45, -1, false, '`SAuthBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SAuthendicate
        $this->SAuthendicate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_SAuthendicate', 'SAuthendicate', '`SAuthendicate`', '`SAuthendicate`', 200, 45, -1, false, '`SAuthendicate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SAuthendicate->Sortable = true; // Allow sort
        $this->SAuthendicate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SAuthendicate->Param, "CustomMsg");
        $this->Fields['SAuthendicate'] = &$this->SAuthendicate;

        // AuthDate
        $this->AuthDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_AuthDate', 'AuthDate', '`AuthDate`', CastDateFieldForLike("`AuthDate`", 0, "DB"), 135, 19, 0, false, '`AuthDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AuthBy
        $this->AuthBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_AuthBy', 'AuthBy', '`AuthBy`', '`AuthBy`', 200, 45, -1, false, '`AuthBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Authencate
        $this->Authencate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Authencate', 'Authencate', '`Authencate`', '`Authencate`', 200, 45, -1, false, '`Authencate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Authencate->Sortable = true; // Allow sort
        $this->Authencate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Authencate->Param, "CustomMsg");
        $this->Fields['Authencate'] = &$this->Authencate;

        // EditDate
        $this->EditDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_EditDate', 'EditDate', '`EditDate`', CastDateFieldForLike("`EditDate`", 0, "DB"), 135, 19, 0, false, '`EditDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EditBy
        $this->EditBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_EditBy', 'EditBy', '`EditBy`', '`EditBy`', 200, 45, -1, false, '`EditBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->EditBy->Sortable = true; // Allow sort
        $this->EditBy->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->EditBy->Param, "CustomMsg");
        $this->Fields['EditBy'] = &$this->EditBy;

        // Editted
        $this->Editted = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Editted', 'Editted', '`Editted`', '`Editted`', 200, 45, -1, false, '`Editted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Editted->Sortable = true; // Allow sort
        $this->Editted->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Editted->Param, "CustomMsg");
        $this->Fields['Editted'] = &$this->Editted;

        // PatientId
        $this->PatientId = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientId->Sortable = true; // Allow sort
        $this->PatientId->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientId->Param, "CustomMsg");
        $this->Fields['PatientId'] = &$this->PatientId;

        // Mobile
        $this->Mobile = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 45, -1, false, '`Mobile`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile->Sortable = true; // Allow sort
        $this->Mobile->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile->Param, "CustomMsg");
        $this->Fields['Mobile'] = &$this->Mobile;

        // CId
        $this->CId = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Order
        $this->Order = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Order', 'Order', '`Order`', '`Order`', 131, 10, -1, false, '`Order`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Form
        $this->Form = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Form', 'Form', '`Form`', '`Form`', 201, 500, -1, false, '`Form`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ResType
        $this->ResType = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_ResType', 'ResType', '`ResType`', '`ResType`', 200, 45, -1, false, '`ResType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Sample
        $this->Sample = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Sample', 'Sample', '`Sample`', '`Sample`', 200, 150, -1, false, '`Sample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NoD
        $this->NoD = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_NoD', 'NoD', '`NoD`', '`NoD`', 131, 10, -1, false, '`NoD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillOrder
        $this->BillOrder = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_BillOrder', 'BillOrder', '`BillOrder`', '`BillOrder`', 131, 10, -1, false, '`BillOrder`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Formula
        $this->Formula = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Formula', 'Formula', '`Formula`', '`Formula`', 201, 1500, -1, false, '`Formula`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Inactive
        $this->Inactive = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, 45, -1, false, '`Inactive`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CollSample
        $this->CollSample = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_CollSample', 'CollSample', '`CollSample`', '`CollSample`', 200, 45, -1, false, '`CollSample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestType
        $this->TestType = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, 45, -1, false, '`TestType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Repeated
        $this->Repeated = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, 45, -1, false, '`Repeated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RepeatedBy
        $this->RepeatedBy = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_RepeatedBy', 'RepeatedBy', '`RepeatedBy`', '`RepeatedBy`', 200, 45, -1, false, '`RepeatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RepeatedBy->Sortable = true; // Allow sort
        $this->RepeatedBy->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RepeatedBy->Param, "CustomMsg");
        $this->Fields['RepeatedBy'] = &$this->RepeatedBy;

        // RepeatedDate
        $this->RepeatedDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_RepeatedDate', 'RepeatedDate', '`RepeatedDate`', CastDateFieldForLike("`RepeatedDate`", 0, "DB"), 135, 19, 0, false, '`RepeatedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->RepeatedDate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RepeatedDate->Param, "CustomMsg");
        $this->Fields['RepeatedDate'] = &$this->RepeatedDate;

        // serviceID
        $this->serviceID = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_serviceID', 'serviceID', '`serviceID`', '`serviceID`', 3, 11, -1, false, '`serviceID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->serviceID->Sortable = true; // Allow sort
        $this->serviceID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->serviceID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->serviceID->Param, "CustomMsg");
        $this->Fields['serviceID'] = &$this->serviceID;

        // Service_Type
        $this->Service_Type = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Service_Type', 'Service_Type', '`Service_Type`', '`Service_Type`', 200, 45, -1, false, '`Service_Type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Service_Department
        $this->Service_Department = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_Service_Department', 'Service_Department', '`Service_Department`', '`Service_Department`', 200, 45, -1, false, '`Service_Department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Service_Department->Sortable = true; // Allow sort
        $this->Service_Department->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Service_Department->Param, "CustomMsg");
        $this->Fields['Service_Department'] = &$this->Service_Department;

        // createdDate
        $this->createdDate = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike("`createdDate`", 0, "DB"), 133, 10, 0, false, '`createdDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RequestNo
        $this->RequestNo = new DbField('view_patient_services_dashboard2', 'view_patient_services_dashboard', 'x_RequestNo', 'RequestNo', '`RequestNo`', '`RequestNo`', 3, 11, -1, false, '`RequestNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RequestNo->Sortable = true; // Allow sort
        $this->RequestNo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->RequestNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RequestNo->Param, "CustomMsg");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_patient_services_dashboard`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPatientServicesDashboard2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPatientServicesDashboard2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPatientServicesDashboard2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPatientServicesDashboard2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPatientServicesDashboard2View";
            case Config("API_ADD_ACTION"):
                return "ViewPatientServicesDashboard2Add";
            case Config("API_EDIT_ACTION"):
                return "ViewPatientServicesDashboard2Edit";
            case Config("API_DELETE_ACTION"):
                return "ViewPatientServicesDashboard2Delete";
            case Config("API_LIST_ACTION"):
                return "ViewPatientServicesDashboard2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPatientServicesDashboard2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPatientServicesDashboard2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPatientServicesDashboard2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPatientServicesDashboard2Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientServicesDashboard2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientServicesDashboard2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPatientServicesDashboard2Delete", $this->getUrlParm());
    }
