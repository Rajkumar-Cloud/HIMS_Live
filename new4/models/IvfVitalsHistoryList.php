 ...
 * Page class
 */
class IvfVitalsHistoryList extends IvfVitalsHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfVitalsHistoryList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "IvfVitalsHistoryAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "IvfVitalsHistoryDelete";
        $this->MultiUpdateUrl = "IvfVitalsHistoryUpdate";
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->CMNCM->setSort("");
                $this->TemplateMenstrualHistory->setSort("");
                $this->TemplateObstetricHistory->setSort("");
                $this->TemplateFertilityTreatmentHistory->setSort("");
                $this->TemplateSurgeryHistory->setSort("");
                $this->TemplateFInvestigations->setSort("");
                $this->TemplatePlanOfManagement->setSort("");
                $this->TemplatePImpression->setSort("");
                $this->TemplateMedications->setSort("");
                $this->TemplateSemenAnalysis->setSort("");
                $this->MaleInsvestications->setSort("");
                $this->TemplateMIMpression->setSort("");
                $this->TemplateMalePlanOfManagement->setSort("");
                $this->TidNo->setSort("");
