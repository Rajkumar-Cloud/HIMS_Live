 ...
 * Page class
 */
class PharmacyPaymentAdd extends PharmacyPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPaymentAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PharmacyPaymentView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("pharmacy_grn", $detailTblVar) && $detailPage->DetailAdd) {
