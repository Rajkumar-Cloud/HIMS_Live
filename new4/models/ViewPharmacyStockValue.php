...
/**
 * Table class for view_pharmacy_stock_value
 */
class ViewPharmacyStockValue extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_stock_value';
        $this->TableName = 'view_pharmacy_stock_value';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_pharmacy_stock_value`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DES
        $this->DES = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_DES', 'DES', '`DES`', '`DES`', 200, 100, -1, false, '`DES`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH
        $this->BATCH = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, 10, -1, false, '`BATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 16, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StockValue
        $this->StockValue = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_StockValue', 'StockValue', '`StockValue`', '`StockValue`', 131, 27, -1, false, '`StockValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->StockValue->Sortable = true; // Allow sort
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENNAME
        $this->GENNAME = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, 150, -1, false, '`GENNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNIT
        $this->UNIT = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, 45, -1, false, '`UNIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDATE
        $this->BILLDATE = new DbField('view_pharmacy_stock_value', 'view_pharmacy_stock_value', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike("`BILLDATE`", 0, "DB"), 135, 19, 0, false, '`BILLDATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_pharmacy_stock_value`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyStockValueList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyStockValueView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyStockValueEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyStockValueAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyStockValueView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyStockValueAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyStockValueEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyStockValueDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyStockValueList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyStockValueView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyStockValueView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyStockValueAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyStockValueAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyStockValueEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyStockValueAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyStockValueDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    {
            if (is_numeric($this->RT->CurrentValue)) {
                $this->RT->Total += $this->RT->CurrentValue; // Accumulate total
            }
    ...
    {
            $this->RT->CurrentValue = $this->RT->Total;
            $this->RT->ViewValue = $this->RT->CurrentValue;
            $this->RT->ViewValue = FormatNumber($this->RT->ViewValue, 2, -2, -2, -2);
            $this->RT->ViewCustomAttributes = "";
            $this->RT->HrefValue = ""; // Clear href value
    ...
    public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->OQ, '');
                $doc->exportAggregate($this->Stock, '');
                $doc->exportAggregate($this->RT, 'TOTAL');
                $doc->exportAggregate($this->StockValue, 'TOTAL');
                $doc->exportAggregate($this->EXPDT, '');
                $doc->exportAggregate($this->GENNAME, '');
