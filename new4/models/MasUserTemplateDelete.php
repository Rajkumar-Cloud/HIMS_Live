 ...
 * Page class
 */
class MasUserTemplateDelete extends MasUserTemplate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasUserTemplateDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MasUserTemplateList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MasUserTemplateList"); // Return to list
                return;
            }
        }
