 ...
 * Page class
 */
class MasServicesBillingList extends MasServicesBilling
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasServicesBillingList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "MasServicesBillingAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MasServicesBillingDelete";
        $this->MultiUpdateUrl = "MasServicesBillingUpdate";
