 ...
 * Page class
 */
class ViewDonorIvfDelete extends ViewDonorIvf
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDonorIvfDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewDonorIvfList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewDonorIvfList"); // Return to list
                return;
            }
        }
