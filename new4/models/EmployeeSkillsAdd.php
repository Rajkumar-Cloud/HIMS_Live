 ...
 * Page class
 */
class EmployeeSkillsAdd extends EmployeeSkills
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeSkillsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmployeeSkillsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmployeeSkillsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmployeeSkillsView") {
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->skill_id->FormValue)) {
            $this->skill_id->addErrorMessage($this->skill_id->getErrorMessage(false));
        }
