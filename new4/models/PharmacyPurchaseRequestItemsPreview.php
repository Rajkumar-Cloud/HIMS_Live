 ...
 * Page class
 */
class PharmacyPurchaseRequestItemsPreview extends PharmacyPurchaseRequestItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPurchaseRequestItemsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_purchase_request") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_purchase_request&" . GetForeignKeyUrl("fk_id", $this->prid->QueryStringValue) . "";
        }
        return $url;
    }
