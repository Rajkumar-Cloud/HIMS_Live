 ...
 * Page class
 */
class PatientFollowUpDelete extends PatientFollowUp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientFollowUpDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientFollowUpList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientFollowUpList"); // Return to list
                return;
            }
        }
