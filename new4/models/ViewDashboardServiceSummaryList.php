 ...
 * Page class
 */
class ViewDashboardServiceSummaryList extends ViewDashboardServiceSummary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardServiceSummaryList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewDashboardServiceSummaryAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewDashboardServiceSummaryDelete";
        $this->MultiUpdateUrl = "ViewDashboardServiceSummaryUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_dashboard_service_summary"));
                $doc->Text = @$content;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_dashboard_service_servicetype')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewDashboardServiceServicetypeList?" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_service_summary&" . GetForeignKeyUrl("fk_DEPARTMENT", $this->DEPARTMENT->CurrentValue) . "&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->CurrentValue, 7) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ViewDashboardServiceServicetypeGrid");
            if ($links != "") {
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["view_dashboard_service_servicetype"] && $this->DetailPages["view_dashboard_service_servicetype"]->Visible) {
            ...
            $url = "ViewDashboardServiceServicetypePreview?t=view_dashboard_service_summary&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_dashboard_service_summary')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewDashboardServiceServicetypeList?" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_service_summary&" . GetForeignKeyUrl("fk_DEPARTMENT", $this->DEPARTMENT->CurrentValue) . "&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->CurrentValue, 7) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->CurrentValue) . "");
            ...
            $detailPageObj = Container("ViewDashboardServiceServicetypeGrid");
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_dashboard_service_summary')) {
