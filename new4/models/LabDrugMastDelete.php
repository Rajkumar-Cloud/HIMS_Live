 ...
 * Page class
 */
class LabDrugMastDelete extends LabDrugMast
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabDrugMastDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LabDrugMastList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LabDrugMastList"); // Return to list
                return;
            }
        }
