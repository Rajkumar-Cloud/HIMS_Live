 ...
 * Page class
 */
class IvfSemenanalysisreportPreview extends IvfSemenanalysisreport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfSemenanalysisreportPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_ivf_treatment") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_ivf_treatment&" . GetForeignKeyUrl("fk_id", $this->TidNo->QueryStringValue) . "&" . GetForeignKeyUrl("fk_RIDNO", $this->RIDNo->QueryStringValue) . "&" . GetForeignKeyUrl("fk_Name", $this->PatientName->QueryStringValue) . "";
        }
        if ($masterTblVar == "ivf_treatment_plan") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ivf_treatment_plan&" . GetForeignKeyUrl("fk_RIDNO", $this->RIDNo->QueryStringValue) . "&" . GetForeignKeyUrl("fk_Name", $this->PatientName->QueryStringValue) . "&" . GetForeignKeyUrl("fk_id", $this->TidNo->QueryStringValue) . "";
        }
        return $url;
    }
