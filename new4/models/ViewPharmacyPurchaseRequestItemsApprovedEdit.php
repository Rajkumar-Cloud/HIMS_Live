 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestItemsApprovedEdit extends ViewPharmacyPurchaseRequestItemsApproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestItemsApprovedEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ViewPharmacyPurchaseRequestItemsApprovedList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ViewPharmacyPurchaseRequestItemsApprovedList") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewPharmacyPurchaseRequestItemsApprovedList"), "", $this->TableVar, true);
        $pageId = "edit";
