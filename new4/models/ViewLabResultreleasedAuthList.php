 ...
 * Page class
 */
class ViewLabResultreleasedAuthList extends ViewLabResultreleasedAuth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabResultreleasedAuthList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewLabResultreleasedAuthAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewLabResultreleasedAuthDelete";
        $this->MultiUpdateUrl = "ViewLabResultreleasedAuthUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_lab_resultreleased_auth"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_lab_services_auth") {
            $masterTbl = Container("view_lab_services_auth");
            $rsmaster = $masterTbl->loadRs($this->DbMasterFilter)->fetch(\PDO::FETCH_ASSOC);
            $this->MasterRecordExists = $rsmaster !== false;
            if (!$this->MasterRecordExists) {
                $this->setFailureMessage($Language->phrase("NoRecord")); // Set no record found
                $this->terminate("ViewLabServicesAuthList"); // Return to master page
                return;
            } else {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_lab_services_auth") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    ...
                    $view_lab_services_auth->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
