 ...
 * Page class
 */
class SysDaysEdit extends SysDays
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SysDaysEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("SysDaysList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "SysDaysList") {
