 ...
 * Page class
 */
class ViewBarcodeIvfView extends ViewBarcodeIvf
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBarcodeIvfView";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_barcode_ivf"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewBarcodeIvfList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewBarcodeIvfList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewBarcodeIvfList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewBarcodeIvfList"), "", $this->TableVar, true);
        $pageId = "view";
