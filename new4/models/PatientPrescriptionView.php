 ...
 * Page class
 */
class PatientPrescriptionView extends PatientPrescription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientPrescriptionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientPrescriptionList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientPrescriptionList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientPrescriptionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
