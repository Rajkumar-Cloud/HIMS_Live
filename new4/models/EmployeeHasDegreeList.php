 ...
 * Page class
 */
class EmployeeHasDegreeList extends EmployeeHasDegree
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeHasDegreeList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "femployee_has_degreelist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "EmployeeHasDegreeAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "EmployeeHasDegreeDelete";
        $this->MultiUpdateUrl = "EmployeeHasDegreeUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option femployee_has_degreelistsrch";
    ...
    public function resetFormError()
    {
        ...
        $this->degree_id->clearErrorMessage();
        $this->college_or_school->clearErrorMessage();
        $this->university_or_board->clearErrorMessage();
        $this->year_of_passing->clearErrorMessage();
        $this->scoring_marks->clearErrorMessage();
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "femployee_has_degreelistsrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->employee_id->AdvancedSearch->toJson(), ","); // Field employee_id
        $filterList = Concat($filterList, $this->degree_id->AdvancedSearch->toJson(), ","); // Field degree_id
        $filterList = Concat($filterList, $this->college_or_school->AdvancedSearch->toJson(), ","); // Field college_or_school
        $filterList = Concat($filterList, $this->university_or_board->AdvancedSearch->toJson(), ","); // Field university_or_board
        $filterList = Concat($filterList, $this->year_of_passing->AdvancedSearch->toJson(), ","); // Field year_of_passing
        $filterList = Concat($filterList, $this->scoring_marks->AdvancedSearch->toJson(), ","); // Field scoring_marks
        $filterList = Concat($filterList, $this->certificates->AdvancedSearch->toJson(), ","); // Field certificates
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "femployee_has_degreelistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field degree_id
        $this->degree_id->AdvancedSearch->SearchValue = @$filter["x_degree_id"];
        $this->degree_id->AdvancedSearch->SearchOperator = @$filter["z_degree_id"];
        $this->degree_id->AdvancedSearch->SearchCondition = @$filter["v_degree_id"];
        $this->degree_id->AdvancedSearch->SearchValue2 = @$filter["y_degree_id"];
        $this->degree_id->AdvancedSearch->SearchOperator2 = @$filter["w_degree_id"];
        $this->degree_id->AdvancedSearch->save();

        // Field college_or_school
        $this->college_or_school->AdvancedSearch->SearchValue = @$filter["x_college_or_school"];
        $this->college_or_school->AdvancedSearch->SearchOperator = @$filter["z_college_or_school"];
        $this->college_or_school->AdvancedSearch->SearchCondition = @$filter["v_college_or_school"];
        $this->college_or_school->AdvancedSearch->SearchValue2 = @$filter["y_college_or_school"];
        $this->college_or_school->AdvancedSearch->SearchOperator2 = @$filter["w_college_or_school"];
        $this->college_or_school->AdvancedSearch->save();

        // Field university_or_board
        $this->university_or_board->AdvancedSearch->SearchValue = @$filter["x_university_or_board"];
        $this->university_or_board->AdvancedSearch->SearchOperator = @$filter["z_university_or_board"];
        $this->university_or_board->AdvancedSearch->SearchCondition = @$filter["v_university_or_board"];
        $this->university_or_board->AdvancedSearch->SearchValue2 = @$filter["y_university_or_board"];
        $this->university_or_board->AdvancedSearch->SearchOperator2 = @$filter["w_university_or_board"];
        $this->university_or_board->AdvancedSearch->save();

        // Field year_of_passing
        $this->year_of_passing->AdvancedSearch->SearchValue = @$filter["x_year_of_passing"];
        $this->year_of_passing->AdvancedSearch->SearchOperator = @$filter["z_year_of_passing"];
        $this->year_of_passing->AdvancedSearch->SearchCondition = @$filter["v_year_of_passing"];
        $this->year_of_passing->AdvancedSearch->SearchValue2 = @$filter["y_year_of_passing"];
        $this->year_of_passing->AdvancedSearch->SearchOperator2 = @$filter["w_year_of_passing"];
        $this->year_of_passing->AdvancedSearch->save();

        // Field scoring_marks
        $this->scoring_marks->AdvancedSearch->SearchValue = @$filter["x_scoring_marks"];
        $this->scoring_marks->AdvancedSearch->SearchOperator = @$filter["z_scoring_marks"];
        $this->scoring_marks->AdvancedSearch->SearchCondition = @$filter["v_scoring_marks"];
        $this->scoring_marks->AdvancedSearch->SearchValue2 = @$filter["y_scoring_marks"];
        $this->scoring_marks->AdvancedSearch->SearchOperator2 = @$filter["w_scoring_marks"];
        $this->scoring_marks->AdvancedSearch->save();

        // Field certificates
        $this->certificates->AdvancedSearch->SearchValue = @$filter["x_certificates"];
        $this->certificates->AdvancedSearch->SearchOperator = @$filter["z_certificates"];
        $this->certificates->AdvancedSearch->SearchCondition = @$filter["v_certificates"];
        $this->certificates->AdvancedSearch->SearchValue2 = @$filter["y_certificates"];
        $this->certificates->AdvancedSearch->SearchOperator2 = @$filter["w_certificates"];
        $this->certificates->AdvancedSearch->save();
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->college_or_school, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->university_or_board, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->year_of_passing, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->scoring_marks, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->certificates, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->degree_id); // degree_id
            $this->updateSort($this->college_or_school); // college_or_school
            $this->updateSort($this->university_or_board); // university_or_board
            $this->updateSort($this->year_of_passing); // year_of_passing
            $this->updateSort($this->scoring_marks); // scoring_marks
            $this->updateSort($this->certificates); // certificates
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->degree_id->setSort("");
                $this->college_or_school->setSort("");
                $this->university_or_board->setSort("");
                $this->year_of_passing->setSort("");
                $this->scoring_marks->setSort("");
                $this->certificates->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"femployee_has_degreelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"femployee_has_degreelistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
        ...
        if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
            ...
            foreach ($this->ListActions->Items as $listaction) {
                if ($listaction->Select == ACTION_MULTIPLE) {
                    ...
                    $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.femployee_has_degreelist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_degree_id")) {
        ...
        if ($CurrentForm->hasValue("o_college_or_school")) {
        ...
        if ($CurrentForm->hasValue("o_university_or_board")) {
        ...
        if ($CurrentForm->hasValue("o_year_of_passing")) {
        ...
        if ($CurrentForm->hasValue("o_scoring_marks")) {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->certificates->UseColorbox) {
                ...
                $this->certificates->LinkAttrs["data-rel"] = "employee_has_degree_x" . $this->RowCount . "_certificates";
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash .= GetFieldHash($row['degree_id']); // degree_id
        $hash .= GetFieldHash($row['college_or_school']); // college_or_school
        $hash .= GetFieldHash($row['university_or_board']); // university_or_board
        $hash .= GetFieldHash($row['year_of_passing']); // year_of_passing
        $hash .= GetFieldHash($row['scoring_marks']); // scoring_marks
        $hash .= GetFieldHash($row['certificates']); // certificates
        $hash .= GetFieldHash($row['others']); // others
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.femployee_has_degreelist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.femployee_has_degreelist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.femployee_has_degreelist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_employee_has_degree" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_employee_has_degree\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.femployee_has_degreelist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"femployee_has_degreelistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
