...
class IvfVitrification extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Day
        $this->Day = new DbField('ivf_vitrification', 'ivf_vitrification', 'x_Day', 'Day', '`Day`', '`Day`', 200, 45, -1, false, '`Day`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Grade
        $this->Grade = new DbField('ivf_vitrification', 'ivf_vitrification', 'x_Grade', 'Grade', '`Grade`', '`Grade`', 200, 45, -1, false, '`Grade`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->Gobiet->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gobiet->Param, "CustomMsg");
        ...
        $this->CryolockNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CryolockNo->Param, "CustomMsg");
        ...
        $this->CryolockColour->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CryolockColour->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IvfVitrificationList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IvfVitrificationView";
            case Config("API_ADD_ACTION"):
                return "IvfVitrificationAdd";
            case Config("API_EDIT_ACTION"):
                return "IvfVitrificationEdit";
            case Config("API_DELETE_ACTION"):
                return "IvfVitrificationDelete";
