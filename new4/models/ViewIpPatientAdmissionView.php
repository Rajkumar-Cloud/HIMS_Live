 ...
 * Page class
 */
class ViewIpPatientAdmissionView extends ViewIpPatientAdmission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpPatientAdmissionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewIpPatientAdmissionList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewIpPatientAdmissionList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewIpPatientAdmissionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
