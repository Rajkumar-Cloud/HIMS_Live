...
/**
 * Table class for view_drug_issue_op_h1
 */
class ViewDrugIssueOpH1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_drug_issue_op_h1';
        $this->TableName = 'view_drug_issue_op_h1';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_drug_issue_op_h1`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // voucher_type
        $this->voucher_type = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Doctor
        $this->Doctor = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, 45, -1, false, '`Doctor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientName
        $this->PatientName = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // PatientId
        $this->PatientId = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Product
        $this->Product = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_Product', 'Product', '`Product`', '`Product`', 200, 100, -1, false, '`Product`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 12, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Mfg
        $this->Mfg = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, 45, -1, false, '`Mfg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCHNO
        $this->BATCHNO = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, 10, -1, false, '`BATCHNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_EXPDT', 'EXPDT', '`EXPDT`', '`EXPDT`', 200, 7, -1, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 7, "DB"), 135, 19, 7, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_drug_issue_op_h1', 'view_drug_issue_op_h1', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_drug_issue_op_h1`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDrugIssueOpH1List");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDrugIssueOpH1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDrugIssueOpH1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDrugIssueOpH1Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDrugIssueOpH1View";
            case Config("API_ADD_ACTION"):
                return "ViewDrugIssueOpH1Add";
            case Config("API_EDIT_ACTION"):
                return "ViewDrugIssueOpH1Edit";
            case Config("API_DELETE_ACTION"):
                return "ViewDrugIssueOpH1Delete";
            case Config("API_LIST_ACTION"):
                return "ViewDrugIssueOpH1List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDrugIssueOpH1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDrugIssueOpH1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDrugIssueOpH1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDrugIssueOpH1Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDrugIssueOpH1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDrugIssueOpH1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDrugIssueOpH1Delete", $this->getUrlParm());
    }
