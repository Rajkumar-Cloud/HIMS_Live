 ...
 * Page class
 */
class HrLeaveperiodsEdit extends HrLeaveperiods
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrLeaveperiodsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("HrLeaveperiodsList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "HrLeaveperiodsList") {
