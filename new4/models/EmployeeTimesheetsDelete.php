 ...
 * Page class
 */
class EmployeeTimesheetsDelete extends EmployeeTimesheets
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTimesheetsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeTimesheetsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeTimesheetsList"); // Return to list
                return;
            }
        }
