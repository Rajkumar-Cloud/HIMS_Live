 ...
 * Page class
 */
class EmployeeEmergencyContactsDelete extends EmployeeEmergencyContacts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeEmergencyContactsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeEmergencyContactsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeEmergencyContactsList"); // Return to list
                return;
            }
        }
