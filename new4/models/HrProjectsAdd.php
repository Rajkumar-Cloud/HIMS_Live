 ...
 * Page class
 */
class HrProjectsAdd extends HrProjects
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrProjectsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("HrProjectsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "HrProjectsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "HrProjectsView") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->client->Required) {
            if (!$this->client->IsDetailKey && EmptyValue($this->client->FormValue)) {
                $this->client->addErrorMessage(str_replace("%s", $this->client->caption(), $this->client->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->client->FormValue)) {
            $this->client->addErrorMessage($this->client->getErrorMessage(false));
        }
