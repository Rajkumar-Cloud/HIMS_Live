...
class ViewProcedureRegistered extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ProcedureDateTime
        $this->ProcedureDateTime = new DbField('view_procedure_registered', 'view_procedure_registered', 'x_ProcedureDateTime', 'ProcedureDateTime', '`ProcedureDateTime`', CastDateFieldForLike("`ProcedureDateTime`", 7, "DB"), 135, 19, 7, false, '`ProcedureDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_procedure_registered', 'view_procedure_registered', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HospID`='".HospitalID()."'   and `ProcedureDateTime` is not null";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewProcedureRegisteredList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewProcedureRegisteredView";
            case Config("API_ADD_ACTION"):
                return "ViewProcedureRegisteredAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewProcedureRegisteredEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewProcedureRegisteredDelete";
