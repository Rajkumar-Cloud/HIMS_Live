 ...
 * Page class
 */
class PatientRoomView extends PatientRoom
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientRoomView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientRoomList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientRoomList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientRoomList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
