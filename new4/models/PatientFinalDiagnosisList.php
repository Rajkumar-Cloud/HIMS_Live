 ...
 * Page class
 */
class PatientFinalDiagnosisList extends PatientFinalDiagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientFinalDiagnosisList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpatient_final_diagnosislist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PatientFinalDiagnosisAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PatientFinalDiagnosisDelete";
        $this->MultiUpdateUrl = "PatientFinalDiagnosisUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpatient_final_diagnosislistsrch";
    ...
    public function run()
    {
        ...
        $this->FinalDiagnosisTemplate->Visible = false;
        $this->TreatmentsTemplate->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpatient_final_diagnosislistsrch");
        }
        ...
        $filterList = Concat($filterList, $this->FinalDiagnosisTemplate->AdvancedSearch->toJson(), ","); // Field FinalDiagnosisTemplate
        $filterList = Concat($filterList, $this->TreatmentsTemplate->AdvancedSearch->toJson(), ","); // Field TreatmentsTemplate
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpatient_final_diagnosislistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field FinalDiagnosisTemplate
        $this->FinalDiagnosisTemplate->AdvancedSearch->SearchValue = @$filter["x_FinalDiagnosisTemplate"];
        $this->FinalDiagnosisTemplate->AdvancedSearch->SearchOperator = @$filter["z_FinalDiagnosisTemplate"];
        $this->FinalDiagnosisTemplate->AdvancedSearch->SearchCondition = @$filter["v_FinalDiagnosisTemplate"];
        $this->FinalDiagnosisTemplate->AdvancedSearch->SearchValue2 = @$filter["y_FinalDiagnosisTemplate"];
        $this->FinalDiagnosisTemplate->AdvancedSearch->SearchOperator2 = @$filter["w_FinalDiagnosisTemplate"];
        $this->FinalDiagnosisTemplate->AdvancedSearch->save();

        // Field TreatmentsTemplate
        $this->TreatmentsTemplate->AdvancedSearch->SearchValue = @$filter["x_TreatmentsTemplate"];
        $this->TreatmentsTemplate->AdvancedSearch->SearchOperator = @$filter["z_TreatmentsTemplate"];
        $this->TreatmentsTemplate->AdvancedSearch->SearchCondition = @$filter["v_TreatmentsTemplate"];
        $this->TreatmentsTemplate->AdvancedSearch->SearchValue2 = @$filter["y_TreatmentsTemplate"];
        $this->TreatmentsTemplate->AdvancedSearch->SearchOperator2 = @$filter["w_TreatmentsTemplate"];
        $this->TreatmentsTemplate->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->FinalDiagnosisTemplate, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->TreatmentsTemplate, $arKeywords, $type);
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->FinalDiagnosisTemplate->setSort("");
                $this->TreatmentsTemplate->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_final_diagnosislistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_final_diagnosislistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpatient_final_diagnosislist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpatient_final_diagnosislist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpatient_final_diagnosislist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpatient_final_diagnosislist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_patient_final_diagnosis" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_patient_final_diagnosis\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpatient_final_diagnosislist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_final_diagnosislistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
