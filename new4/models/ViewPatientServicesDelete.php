 ...
 * Page class
 */
class ViewPatientServicesDelete extends ViewPatientServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPatientServicesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewPatientServicesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewPatientServicesList"); // Return to list
                return;
            }
        }
