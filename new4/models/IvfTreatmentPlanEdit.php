...
class IvfTreatmentPlanEdit extends IvfTreatmentPlan
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("ivf_outcome", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
        $detailPage = Container("IvfStimulationChartGrid");
        if (in_array("ivf_stimulation_chart", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
        $detailPage = Container("IvfSemenanalysisreportGrid");
        if (in_array("ivf_semenanalysisreport", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
