...
class UserLoginList extends UserLogin
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->_LoginType->AdvancedSearch->toJson(), ","); // Field LoginType
    ...
    protected function restoreFilterList()
    {
        ...
        // Field LoginType
        $this->_LoginType->AdvancedSearch->SearchValue = @$filter["x__LoginType"];
        $this->_LoginType->AdvancedSearch->SearchOperator = @$filter["z__LoginType"];
        $this->_LoginType->AdvancedSearch->SearchCondition = @$filter["v__LoginType"];
        $this->_LoginType->AdvancedSearch->SearchValue2 = @$filter["y__LoginType"];
        $this->_LoginType->AdvancedSearch->SearchOperator2 = @$filter["w__LoginType"];
        $this->_LoginType->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->_LoginType); // LoginType
