...
/**
 * Table class for pharmacy_batchmas
 */
class PharmacyBatchmas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pharmacy_batchmas';
        $this->TableName = 'pharmacy_batchmas';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pharmacy_batchmas`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // PRC
        $this->PRC = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PrName->Required = true; // Required field
        $this->PrName->Sortable = true; // Allow sort
        $this->PrName->Lookup = new Lookup('PrName', 'pharmacy_storemast', false, 'DES', ["DES","","",""], [], [], [], [], ["PRC","BATCHNO","BATCHNO","MFRCODE","MRP","UR","SSGST","SCGST","RT","BRCODE"], ["x_PRC","x_BATCHNO","x_BATCH","x_MFRCODE","x_MRP","x_UR","x_SSGST","x_SCGST","x_RT","x_BRCODE"], '', '');
        $this->PrName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PrName->Param, "CustomMsg");
        $this->Fields['PrName'] = &$this->PrName;

        // BATCHNO
        $this->BATCHNO = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, 10, -1, false, '`BATCHNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH
        $this->BATCH = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, 10, -1, false, '`BATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRCODE
        $this->PRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PRCODE', 'PRCODE', '`PRCODE`', '`PRCODE`', 200, 9, -1, false, '`PRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->OQ->Required = true; // Required field
        ...
        // RQ
        $this->RQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, 12, -1, false, '`RQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FRQ
        $this->FRQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_FRQ', 'FRQ', '`FRQ`', '`FRQ`', 131, 12, -1, false, '`FRQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 12, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRQ
        $this->MRQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, 12, -1, false, '`MRQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRP
        $this->MRP = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UR
        $this->UR = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_UR', 'UR', '`UR`', '`UR`', 131, 12, -1, false, '`UR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OLDRT
        $this->OLDRT = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OLDRT', 'OLDRT', '`OLDRT`', '`OLDRT`', 131, 12, -1, false, '`OLDRT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TEMPMRQ
        $this->TEMPMRQ = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_TEMPMRQ', 'TEMPMRQ', '`TEMPMRQ`', '`TEMPMRQ`', 131, 12, -1, false, '`TEMPMRQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAXP
        $this->TAXP = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, 12, -1, false, '`TAXP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OLDRATE
        $this->OLDRATE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OLDRATE', 'OLDRATE', '`OLDRATE`', '`OLDRATE`', 131, 12, -1, false, '`OLDRATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NEWRATE
        $this->NEWRATE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_NEWRATE', 'NEWRATE', '`NEWRATE`', '`NEWRATE`', 131, 12, -1, false, '`NEWRATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OTEMPMRA
        $this->OTEMPMRA = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_OTEMPMRA', 'OTEMPMRA', '`OTEMPMRA`', '`OTEMPMRA`', 131, 12, -1, false, '`OTEMPMRA`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACTIVESTATUS
        $this->ACTIVESTATUS = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_ACTIVESTATUS', 'ACTIVESTATUS', '`ACTIVESTATUS`', '`ACTIVESTATUS`', 200, 99, -1, false, '`ACTIVESTATUS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PSGST
        $this->PSGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // HospID
        $this->HospID = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UM
        $this->UM = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_UM', 'UM', '`UM`', '`UM`', 200, 45, -1, false, '`UM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENNAME
        $this->GENNAME = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, 150, -1, false, '`GENNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDATE
        $this->BILLDATE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike("`BILLDATE`", 0, "DB"), 135, 19, 0, false, '`BILLDATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pharmacy_batchmas`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyBatchmasList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PharmacyBatchmasEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PharmacyBatchmasAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyBatchmasView";
            case Config("API_ADD_ACTION"):
                return "PharmacyBatchmasAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyBatchmasEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyBatchmasDelete";
            case Config("API_LIST_ACTION"):
                return "PharmacyBatchmasList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyBatchmasView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyBatchmasView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PharmacyBatchmasAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PharmacyBatchmasAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PharmacyBatchmasEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PharmacyBatchmasAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PharmacyBatchmasDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function rowRendered() {
    	...
    	$this->UR->CellAttrs["style"] = "text-align: right;";
    	$this->RT->CellAttrs["style"] = "text-align: right;";
    	$this->SSGST->CellAttrs["style"] = "text-align: right;";
    	$this->SCGST->CellAttrs["style"] = "text-align: right;";
    		$this->UR->ViewAttrs["style"] = "text-align: right;";
    	$this->RT->ViewAttrs["style"] = "text-align: right;";
    	$this->SSGST->ViewAttrs["style"] = "text-align: right;";
    	$this->SCGST->ViewAttrs["style"] = "text-align: right;";
    }
