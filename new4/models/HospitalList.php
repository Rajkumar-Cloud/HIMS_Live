 ...
 * Page class
 */
class HospitalList extends Hospital
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HospitalList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fhospitallist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "HospitalAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "HospitalDelete";
        $this->MultiUpdateUrl = "HospitalUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fhospitallistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("hospital"));
                $doc->Text = @$content;
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fhospitallistsrch");
        }
        ...
        $filterList = Concat($filterList, $this->PreFixCode->AdvancedSearch->toJson(), ","); // Field PreFixCode
        $filterList = Concat($filterList, $this->BillingGST->AdvancedSearch->toJson(), ","); // Field BillingGST
        $filterList = Concat($filterList, $this->pharmacyGST->AdvancedSearch->toJson(), ","); // Field pharmacyGST
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fhospitallistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field PreFixCode
        $this->PreFixCode->AdvancedSearch->SearchValue = @$filter["x_PreFixCode"];
        $this->PreFixCode->AdvancedSearch->SearchOperator = @$filter["z_PreFixCode"];
        $this->PreFixCode->AdvancedSearch->SearchCondition = @$filter["v_PreFixCode"];
        $this->PreFixCode->AdvancedSearch->SearchValue2 = @$filter["y_PreFixCode"];
        $this->PreFixCode->AdvancedSearch->SearchOperator2 = @$filter["w_PreFixCode"];
        $this->PreFixCode->AdvancedSearch->save();

        // Field BillingGST
        $this->BillingGST->AdvancedSearch->SearchValue = @$filter["x_BillingGST"];
        $this->BillingGST->AdvancedSearch->SearchOperator = @$filter["z_BillingGST"];
        $this->BillingGST->AdvancedSearch->SearchCondition = @$filter["v_BillingGST"];
        $this->BillingGST->AdvancedSearch->SearchValue2 = @$filter["y_BillingGST"];
        $this->BillingGST->AdvancedSearch->SearchOperator2 = @$filter["w_BillingGST"];
        $this->BillingGST->AdvancedSearch->save();

        // Field pharmacyGST
        $this->pharmacyGST->AdvancedSearch->SearchValue = @$filter["x_pharmacyGST"];
        $this->pharmacyGST->AdvancedSearch->SearchOperator = @$filter["z_pharmacyGST"];
        $this->pharmacyGST->AdvancedSearch->SearchCondition = @$filter["v_pharmacyGST"];
        $this->pharmacyGST->AdvancedSearch->SearchValue2 = @$filter["y_pharmacyGST"];
        $this->pharmacyGST->AdvancedSearch->SearchOperator2 = @$filter["w_pharmacyGST"];
        $this->pharmacyGST->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->PreFixCode, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->BillingGST, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->pharmacyGST, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->PreFixCode); // PreFixCode
            $this->updateSort($this->BillingGST); // BillingGST
            $this->updateSort($this->pharmacyGST); // pharmacyGST
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->PreFixCode->setSort("");
                $this->BillingGST->setSort("");
                $this->pharmacyGST->setSort("");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fhospitallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fhospitallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fhospitallist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fhospitallist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fhospitallist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fhospitallist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_hospital" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_hospital\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fhospitallist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fhospitallistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
