 ...
 * Page class
 */
class PresTradeCombinationNamesNewPreview extends PresTradeCombinationNamesNew
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresTradeCombinationNamesNewPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pres_tradenames_new") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pres_tradenames_new&" . GetForeignKeyUrl("fk_ID", $this->tradenames_id->QueryStringValue) . "";
        }
        return $url;
    }
