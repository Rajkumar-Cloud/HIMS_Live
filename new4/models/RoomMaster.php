...
class RoomMaster extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // RoomType
        $this->RoomType = new DbField('room_master', 'room_master', 'x_RoomType', 'RoomType', '`RoomType`', '`RoomType`', 200, 45, -1, false, '`RoomType`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // SharingRoom
        $this->SharingRoom = new DbField('room_master', 'room_master', 'x_SharingRoom', 'SharingRoom', '`SharingRoom`', '`SharingRoom`', 200, 45, -1, false, '`SharingRoom`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // Status
        $this->Status = new DbField('room_master', 'room_master', 'x_Status', 'Status', '`Status`', '`Status`', 200, 45, -1, false, '`Status`', false, false, false, 'FORMATTED TEXT', 'RADIO');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RoomMasterList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "RoomMasterAdd";
            case Config("API_EDIT_ACTION"):
                return "RoomMasterEdit";
            case Config("API_DELETE_ACTION"):
                return "RoomMasterDelete";
