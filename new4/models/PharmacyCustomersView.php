 ...
 * Page class
 */
class PharmacyCustomersView extends PharmacyCustomers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyCustomersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PharmacyCustomersList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PharmacyCustomersList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PharmacyCustomersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
