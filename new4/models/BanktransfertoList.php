 ...
 * Page class
 */
class BanktransfertoList extends Banktransferto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BanktransfertoList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "BanktransfertoAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "BanktransfertoDelete";
        $this->MultiUpdateUrl = "BanktransfertoUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("banktransferto"));
                $doc->Text = @$content;
