 ...
 * Page class
 */
class IvfVitrificationDelete extends IvfVitrification
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfVitrificationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IvfVitrificationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IvfVitrificationList"); // Return to list
                return;
            }
        }
