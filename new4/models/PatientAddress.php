...
/**
 * Table class for patient_address
 */
class PatientAddress extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'patient_address';
        $this->TableName = 'patient_address';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`patient_address`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('patient_address', 'patient_address', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // patient_id
        $this->patient_id = new DbField('patient_address', 'patient_address', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, 11, -1, false, '`patient_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // street
        $this->street = new DbField('patient_address', 'patient_address', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('patient_address', 'patient_address', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // province
        $this->province = new DbField('patient_address', 'patient_address', 'x_province', 'province', '`province`', '`province`', 200, 50, -1, false, '`province`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postal_code
        $this->postal_code = new DbField('patient_address', 'patient_address', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 50, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // address_type
        $this->address_type = new DbField('patient_address', 'patient_address', 'x_address_type', 'address_type', '`address_type`', '`address_type`', 3, 11, -1, false, '`address_type`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // status
        $this->status = new DbField('patient_address', 'patient_address', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // createdby
        $this->createdby = new DbField('patient_address', 'patient_address', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('patient_address', 'patient_address', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('patient_address', 'patient_address', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('patient_address', 'patient_address', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`patient_address`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PatientAddressList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PatientAddressView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PatientAddressEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PatientAddressAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PatientAddressView";
            case Config("API_ADD_ACTION"):
                return "PatientAddressAdd";
            case Config("API_EDIT_ACTION"):
                return "PatientAddressEdit";
            case Config("API_DELETE_ACTION"):
                return "PatientAddressDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PatientAddressView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PatientAddressView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PatientAddressAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PatientAddressAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientAddressEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientAddressAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PatientAddressDelete", $this->getUrlParm());
    }
