...
/**
 * Table class for view_dashboard_service_summary
 */
class ViewDashboardServiceSummary extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_dashboard_service_summary';
        $this->TableName = 'view_dashboard_service_summary';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_dashboard_service_summary`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // DEPARTMENT
        $this->DEPARTMENT = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, 50, -1, false, '`DEPARTMENT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SubTotal
        $this->SubTotal = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_SubTotal', 'SubTotal', '`SubTotal`', '`SubTotal`', 131, 34, -1, false, '`SubTotal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdDate
        $this->createdDate = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike("`createdDate`", 7, "DB"), 133, 10, 7, false, '`createdDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vid
        $this->vid = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_vid', 'vid', '`vid`', '`vid`', 3, 11, -1, false, '`vid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemCode
        $this->ItemCode = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, 45, -1, false, '`ItemCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientId
        $this->PatientId = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_dashboard_service_servicetype") {
            $detailUrl = Container("view_dashboard_service_servicetype")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_DEPARTMENT", $this->DEPARTMENT->CurrentValue);
        ...
        if ($detailUrl == "") {
            $detailUrl = "ViewDashboardServiceSummaryList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_dashboard_service_summary`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDashboardServiceSummaryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDashboardServiceSummaryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDashboardServiceSummaryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDashboardServiceSummaryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDashboardServiceSummaryView";
            case Config("API_ADD_ACTION"):
                return "ViewDashboardServiceSummaryAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDashboardServiceSummaryEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDashboardServiceSummaryDelete";
            case Config("API_LIST_ACTION"):
                return "ViewDashboardServiceSummaryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDashboardServiceSummaryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDashboardServiceSummaryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDashboardServiceSummaryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDashboardServiceSummaryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardServiceSummaryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardServiceSummaryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDashboardServiceSummaryDelete", $this->getUrlParm());
    }
