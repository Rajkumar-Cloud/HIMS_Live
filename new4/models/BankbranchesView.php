 ...
 * Page class
 */
class BankbranchesView extends Bankbranches
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BankbranchesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BankbranchesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BankbranchesList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "BankbranchesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
