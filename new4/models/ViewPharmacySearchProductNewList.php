 ...
 * Page class
 */
class ViewPharmacySearchProductNewList extends ViewPharmacySearchProductNew
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacySearchProductNewList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPharmacySearchProductNewAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPharmacySearchProductNewDelete";
        $this->MultiUpdateUrl = "ViewPharmacySearchProductNewUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_pharmacy_search_product_new"));
                $doc->Text = @$content;
