 ...
 */
class ViewIvfTreatmentPlan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // CoupleID
        $this->CoupleID = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_CoupleID', 'CoupleID', '`CoupleID`', '`CoupleID`', 200, 45, -1, false, '`CoupleID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientID
        $this->PatientID = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientID->Sortable = true; // Allow sort
        $this->PatientID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientID->Param, "CustomMsg");
        $this->Fields['PatientID'] = &$this->PatientID;

        // PatientName
        $this->PatientName = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // WifeCell
        $this->WifeCell = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_WifeCell', 'WifeCell', '`WifeCell`', '`WifeCell`', 200, 45, -1, false, '`WifeCell`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PartnerID
        $this->PartnerID = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_PartnerID', 'PartnerID', '`PartnerID`', '`PartnerID`', 200, 45, -1, false, '`PartnerID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PartnerName
        $this->PartnerName = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, 45, -1, false, '`PartnerName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HusbandCell
        $this->HusbandCell = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_HusbandCell', 'HusbandCell', '`HusbandCell`', '`HusbandCell`', 200, 45, -1, false, '`HusbandCell`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Name
        $this->Name = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Name', 'Name', '`Name`', '`Name`', 200, 45, -1, false, '`Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Name->Sortable = true; // Allow sort
        $this->Name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Name->Param, "CustomMsg");
        $this->Fields['Name'] = &$this->Name;

        // Age
        $this->Age = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // TreatmentStartDate
        $this->TreatmentStartDate = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TreatmentStartDate', 'TreatmentStartDate', '`TreatmentStartDate`', CastDateFieldForLike("`TreatmentStartDate`", 0, "DB"), 135, 19, 0, false, '`TreatmentStartDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // treatment_status
        $this->treatment_status = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_treatment_status', 'treatment_status', '`treatment_status`', '`treatment_status`', 200, 45, -1, false, '`treatment_status`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ARTCYCLE
        $this->ARTCYCLE = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_ARTCYCLE', 'ARTCYCLE', '`ARTCYCLE`', '`ARTCYCLE`', 200, 45, -1, false, '`ARTCYCLE`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // RESULT
        $this->RESULT = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_RESULT', 'RESULT', '`RESULT`', '`RESULT`', 200, 45, -1, false, '`RESULT`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // status
        $this->status = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // createdby
        $this->createdby = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TreatementStopDate
        $this->TreatementStopDate = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TreatementStopDate', 'TreatementStopDate', '`TreatementStopDate`', CastDateFieldForLike("`TreatementStopDate`", 0, "DB"), 135, 19, 0, false, '`TreatementStopDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TypePatient
        $this->TypePatient = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TypePatient', 'TypePatient', '`TypePatient`', '`TypePatient`', 200, 45, -1, false, '`TypePatient`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Treatment
        $this->Treatment = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 200, 45, -1, false, '`Treatment`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TreatmentTec
        $this->TreatmentTec = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TreatmentTec', 'TreatmentTec', '`TreatmentTec`', '`TreatmentTec`', 200, 45, -1, false, '`TreatmentTec`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TypeOfCycle
        $this->TypeOfCycle = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TypeOfCycle', 'TypeOfCycle', '`TypeOfCycle`', '`TypeOfCycle`', 200, 45, -1, false, '`TypeOfCycle`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // SpermOrgin
        $this->SpermOrgin = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_SpermOrgin', 'SpermOrgin', '`SpermOrgin`', '`SpermOrgin`', 200, 45, -1, false, '`SpermOrgin`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // State
        $this->State = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Origin
        $this->Origin = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Origin', 'Origin', '`Origin`', '`Origin`', 200, 45, -1, false, '`Origin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MACS
        $this->MACS = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, 45, -1, false, '`MACS`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // Technique
        $this->Technique = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Technique', 'Technique', '`Technique`', '`Technique`', 200, 45, -1, false, '`Technique`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PgdPlanning
        $this->PgdPlanning = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_PgdPlanning', 'PgdPlanning', '`PgdPlanning`', '`PgdPlanning`', 200, 45, -1, false, '`PgdPlanning`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // IMSI
        $this->IMSI = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_IMSI', 'IMSI', '`IMSI`', '`IMSI`', 200, 45, -1, false, '`IMSI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SequentialCulture
        $this->SequentialCulture = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_SequentialCulture', 'SequentialCulture', '`SequentialCulture`', '`SequentialCulture`', 200, 45, -1, false, '`SequentialCulture`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TimeLapse
        $this->TimeLapse = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TimeLapse', 'TimeLapse', '`TimeLapse`', '`TimeLapse`', 200, 45, -1, false, '`TimeLapse`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AH
        $this->AH = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_AH', 'AH', '`AH`', '`AH`', 200, 45, -1, false, '`AH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Weight
        $this->Weight = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Weight', 'Weight', '`Weight`', '`Weight`', 200, 45, -1, false, '`Weight`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BMI
        $this->BMI = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_BMI', 'BMI', '`BMI`', '`BMI`', 200, 45, -1, false, '`BMI`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MaleIndications
        $this->MaleIndications = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_MaleIndications', 'MaleIndications', '`MaleIndications`', '`MaleIndications`', 200, 45, -1, false, '`MaleIndications`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // FemaleIndications
        $this->FemaleIndications = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_FemaleIndications', 'FemaleIndications', '`FemaleIndications`', '`FemaleIndications`', 200, 45, -1, false, '`FemaleIndications`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // UseOfThe
        $this->UseOfThe = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_UseOfThe', 'UseOfThe', '`UseOfThe`', '`UseOfThe`', 200, 45, -1, false, '`UseOfThe`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Ectopic
        $this->Ectopic = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Ectopic', 'Ectopic', '`Ectopic`', '`Ectopic`', 200, 45, -1, false, '`Ectopic`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Heterotopic
        $this->Heterotopic = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Heterotopic', 'Heterotopic', '`Heterotopic`', '`Heterotopic`', 200, 45, -1, false, '`Heterotopic`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TransferDFE
        $this->TransferDFE = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TransferDFE', 'TransferDFE', '`TransferDFE`', '`TransferDFE`', 200, 45, -1, false, '`TransferDFE`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // Evolutive
        $this->Evolutive = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Evolutive', 'Evolutive', '`Evolutive`', '`Evolutive`', 200, 45, -1, false, '`Evolutive`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Number
        $this->Number = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Number', 'Number', '`Number`', '`Number`', 200, 45, -1, false, '`Number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SequentialCult
        $this->SequentialCult = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_SequentialCult', 'SequentialCult', '`SequentialCult`', '`SequentialCult`', 200, 45, -1, false, '`SequentialCult`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TineLapse
        $this->TineLapse = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TineLapse', 'TineLapse', '`TineLapse`', '`TineLapse`', 200, 45, -1, false, '`TineLapse`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewIvfTreatmentPlanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewIvfTreatmentPlanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewIvfTreatmentPlanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewIvfTreatmentPlanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewIvfTreatmentPlanView";
            case Config("API_ADD_ACTION"):
                return "ViewIvfTreatmentPlanAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewIvfTreatmentPlanEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewIvfTreatmentPlanDelete";
            case Config("API_LIST_ACTION"):
                return "ViewIvfTreatmentPlanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewIvfTreatmentPlanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewIvfTreatmentPlanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewIvfTreatmentPlanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewIvfTreatmentPlanAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIvfTreatmentPlanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIvfTreatmentPlanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewIvfTreatmentPlanDelete", $this->getUrlParm());
    }
