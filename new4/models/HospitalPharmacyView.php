 ...
 * Page class
 */
class HospitalPharmacyView extends HospitalPharmacy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HospitalPharmacyView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "HospitalPharmacyList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "HospitalPharmacyList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "HospitalPharmacyList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
