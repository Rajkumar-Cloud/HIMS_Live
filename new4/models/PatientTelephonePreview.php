 ...
 * Page class
 */
class PatientTelephonePreview extends PatientTelephone
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientTelephonePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "patient") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=patient&" . GetForeignKeyUrl("fk_id", $this->patient_id->QueryStringValue) . "";
        }
        return $url;
    }
