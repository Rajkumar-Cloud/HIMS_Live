 ...
 * Page class
 */
class LabTestMasterView extends LabTestMaster
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabTestMasterView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LabTestMasterList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LabTestMasterList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "LabTestMasterList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
