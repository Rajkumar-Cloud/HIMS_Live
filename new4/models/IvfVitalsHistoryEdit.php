 ...
 * Page class
 */
class IvfVitalsHistoryEdit extends IvfVitalsHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfVitalsHistoryEdit";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->TemplateMenstrualHistory->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateMenstrualHistory->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateObstetricHistory->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateObstetricHistory->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateFertilityTreatmentHistory->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateFertilityTreatmentHistory->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateSurgeryHistory->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateSurgeryHistory->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateFInvestigations->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateFInvestigations->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplatePlanOfManagement->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplatePlanOfManagement->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplatePImpression->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplatePImpression->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateMedications->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateMedications->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateSemenAnalysis->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateSemenAnalysis->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->MaleInsvestications->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->MaleInsvestications->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateMIMpression->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateMIMpression->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
            ...
            if ($this->TemplateMalePlanOfManagement->ViewValue !== null) { // Load from cache
                ...
                $lookupFilter = $lookupFilter->bindTo($this);
                $sqlWrk = $this->TemplateMalePlanOfManagement->Lookup->getSql(true, $filterWrk, $lookupFilter, $this, false, true);
                $rswrk = Conn()->executeQuery($sqlWrk)->fetchAll(\PDO::FETCH_BOTH);
                $ari = count($rswrk);
                $arwrk = $rswrk;
    ...
    protected function validateForm()
    {
        ...
        if ($this->TemplateMenstrualHistory->Required) {
            if (!$this->TemplateMenstrualHistory->IsDetailKey && EmptyValue($this->TemplateMenstrualHistory->FormValue)) {
                $this->TemplateMenstrualHistory->addErrorMessage(str_replace("%s", $this->TemplateMenstrualHistory->caption(), $this->TemplateMenstrualHistory->RequiredErrorMessage));
            }
        }
        if ($this->TemplateObstetricHistory->Required) {
            if (!$this->TemplateObstetricHistory->IsDetailKey && EmptyValue($this->TemplateObstetricHistory->FormValue)) {
                $this->TemplateObstetricHistory->addErrorMessage(str_replace("%s", $this->TemplateObstetricHistory->caption(), $this->TemplateObstetricHistory->RequiredErrorMessage));
            }
        }
        if ($this->TemplateFertilityTreatmentHistory->Required) {
            if (!$this->TemplateFertilityTreatmentHistory->IsDetailKey && EmptyValue($this->TemplateFertilityTreatmentHistory->FormValue)) {
                $this->TemplateFertilityTreatmentHistory->addErrorMessage(str_replace("%s", $this->TemplateFertilityTreatmentHistory->caption(), $this->TemplateFertilityTreatmentHistory->RequiredErrorMessage));
            }
        }
        if ($this->TemplateSurgeryHistory->Required) {
            if (!$this->TemplateSurgeryHistory->IsDetailKey && EmptyValue($this->TemplateSurgeryHistory->FormValue)) {
                $this->TemplateSurgeryHistory->addErrorMessage(str_replace("%s", $this->TemplateSurgeryHistory->caption(), $this->TemplateSurgeryHistory->RequiredErrorMessage));
            }
        }
        if ($this->TemplateFInvestigations->Required) {
            if (!$this->TemplateFInvestigations->IsDetailKey && EmptyValue($this->TemplateFInvestigations->FormValue)) {
                $this->TemplateFInvestigations->addErrorMessage(str_replace("%s", $this->TemplateFInvestigations->caption(), $this->TemplateFInvestigations->RequiredErrorMessage));
            }
        }
        if ($this->TemplatePlanOfManagement->Required) {
            if (!$this->TemplatePlanOfManagement->IsDetailKey && EmptyValue($this->TemplatePlanOfManagement->FormValue)) {
                $this->TemplatePlanOfManagement->addErrorMessage(str_replace("%s", $this->TemplatePlanOfManagement->caption(), $this->TemplatePlanOfManagement->RequiredErrorMessage));
            }
        }
        if ($this->TemplatePImpression->Required) {
            if (!$this->TemplatePImpression->IsDetailKey && EmptyValue($this->TemplatePImpression->FormValue)) {
                $this->TemplatePImpression->addErrorMessage(str_replace("%s", $this->TemplatePImpression->caption(), $this->TemplatePImpression->RequiredErrorMessage));
            }
        }
        if ($this->TemplateMedications->Required) {
            if (!$this->TemplateMedications->IsDetailKey && EmptyValue($this->TemplateMedications->FormValue)) {
                $this->TemplateMedications->addErrorMessage(str_replace("%s", $this->TemplateMedications->caption(), $this->TemplateMedications->RequiredErrorMessage));
            }
        }
        if ($this->TemplateSemenAnalysis->Required) {
            if (!$this->TemplateSemenAnalysis->IsDetailKey && EmptyValue($this->TemplateSemenAnalysis->FormValue)) {
                $this->TemplateSemenAnalysis->addErrorMessage(str_replace("%s", $this->TemplateSemenAnalysis->caption(), $this->TemplateSemenAnalysis->RequiredErrorMessage));
            }
        }
        if ($this->MaleInsvestications->Required) {
            if (!$this->MaleInsvestications->IsDetailKey && EmptyValue($this->MaleInsvestications->FormValue)) {
                $this->MaleInsvestications->addErrorMessage(str_replace("%s", $this->MaleInsvestications->caption(), $this->MaleInsvestications->RequiredErrorMessage));
            }
        }
        if ($this->TemplateMIMpression->Required) {
            if (!$this->TemplateMIMpression->IsDetailKey && EmptyValue($this->TemplateMIMpression->FormValue)) {
                $this->TemplateMIMpression->addErrorMessage(str_replace("%s", $this->TemplateMIMpression->caption(), $this->TemplateMIMpression->RequiredErrorMessage));
            }
        }
        if ($this->TemplateMalePlanOfManagement->Required) {
            if (!$this->TemplateMalePlanOfManagement->IsDetailKey && EmptyValue($this->TemplateMalePlanOfManagement->FormValue)) {
                $this->TemplateMalePlanOfManagement->addErrorMessage(str_replace("%s", $this->TemplateMalePlanOfManagement->caption(), $this->TemplateMalePlanOfManagement->RequiredErrorMessage));
            }
        }
        ...
        if ($this->AntiTPO->Required) {
            if (!$this->AntiTPO->IsDetailKey && EmptyValue($this->AntiTPO->FormValue)) {
                $this->AntiTPO->addErrorMessage(str_replace("%s", $this->AntiTPO->caption(), $this->AntiTPO->RequiredErrorMessage));
            }
        }
        if ($this->AntiTG->Required) {
            if (!$this->AntiTG->IsDetailKey && EmptyValue($this->AntiTG->FormValue)) {
                $this->AntiTG->addErrorMessage(str_replace("%s", $this->AntiTG->caption(), $this->AntiTG->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // TemplateMenstrualHistory
            $this->TemplateMenstrualHistory->setDbValueDef($rsnew, $this->TemplateMenstrualHistory->CurrentValue, "", $this->TemplateMenstrualHistory->ReadOnly);

            // TemplateObstetricHistory
            $this->TemplateObstetricHistory->setDbValueDef($rsnew, $this->TemplateObstetricHistory->CurrentValue, "", $this->TemplateObstetricHistory->ReadOnly);

            // TemplateFertilityTreatmentHistory
            $this->TemplateFertilityTreatmentHistory->setDbValueDef($rsnew, $this->TemplateFertilityTreatmentHistory->CurrentValue, "", $this->TemplateFertilityTreatmentHistory->ReadOnly);

            // TemplateSurgeryHistory
            $this->TemplateSurgeryHistory->setDbValueDef($rsnew, $this->TemplateSurgeryHistory->CurrentValue, "", $this->TemplateSurgeryHistory->ReadOnly);

            // TemplateFInvestigations
            $this->TemplateFInvestigations->setDbValueDef($rsnew, $this->TemplateFInvestigations->CurrentValue, "", $this->TemplateFInvestigations->ReadOnly);

            // TemplatePlanOfManagement
            $this->TemplatePlanOfManagement->setDbValueDef($rsnew, $this->TemplatePlanOfManagement->CurrentValue, "", $this->TemplatePlanOfManagement->ReadOnly);

            // TemplatePImpression
            $this->TemplatePImpression->setDbValueDef($rsnew, $this->TemplatePImpression->CurrentValue, "", $this->TemplatePImpression->ReadOnly);

            // TemplateMedications
            $this->TemplateMedications->setDbValueDef($rsnew, $this->TemplateMedications->CurrentValue, "", $this->TemplateMedications->ReadOnly);

            // TemplateSemenAnalysis
            $this->TemplateSemenAnalysis->setDbValueDef($rsnew, $this->TemplateSemenAnalysis->CurrentValue, "", $this->TemplateSemenAnalysis->ReadOnly);

            // MaleInsvestications
            $this->MaleInsvestications->setDbValueDef($rsnew, $this->MaleInsvestications->CurrentValue, "", $this->MaleInsvestications->ReadOnly);

            // TemplateMIMpression
            $this->TemplateMIMpression->setDbValueDef($rsnew, $this->TemplateMIMpression->CurrentValue, "", $this->TemplateMIMpression->ReadOnly);

            // TemplateMalePlanOfManagement
            $this->TemplateMalePlanOfManagement->setDbValueDef($rsnew, $this->TemplateMalePlanOfManagement->CurrentValue, "", $this->TemplateMalePlanOfManagement->ReadOnly);
            ...
            // AntiTPO
            $this->AntiTPO->setDbValueDef($rsnew, $this->AntiTPO->CurrentValue, null, $this->AntiTPO->ReadOnly);

            // AntiTG
            $this->AntiTG->setDbValueDef($rsnew, $this->AntiTG->CurrentValue, null, $this->AntiTG->ReadOnly);
    ...
    public function pageRedirecting(&$url) {
       ...
       {
       		$url =  str_replace("ivf_vitals_historyview","ivf_vitals_historyedit",$url);
       }
