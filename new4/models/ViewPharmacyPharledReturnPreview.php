 ...
 * Page class
 */
class ViewPharmacyPharledReturnPreview extends ViewPharmacyPharledReturn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPharledReturnPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_billing_return") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_return&" . GetForeignKeyUrl("fk_id", $this->sretid->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "pharmacy_billing_return") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->sretid->setQueryStringValue($val);
            }
        }
    }
