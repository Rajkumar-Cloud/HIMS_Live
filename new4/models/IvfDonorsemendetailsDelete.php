 ...
 * Page class
 */
class IvfDonorsemendetailsDelete extends IvfDonorsemendetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfDonorsemendetailsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IvfDonorsemendetailsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IvfDonorsemendetailsList"); // Return to list
                return;
            }
        }
