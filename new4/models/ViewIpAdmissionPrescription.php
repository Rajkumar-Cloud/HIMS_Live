 ...
 */
class ViewIpAdmissionPrescription extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewIpAdmissionPrescriptionList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewIpAdmissionPrescriptionView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewIpAdmissionPrescriptionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewIpAdmissionPrescriptionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewIpAdmissionPrescriptionView";
            case Config("API_ADD_ACTION"):
                return "ViewIpAdmissionPrescriptionAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewIpAdmissionPrescriptionEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewIpAdmissionPrescriptionDelete";
            case Config("API_LIST_ACTION"):
                return "ViewIpAdmissionPrescriptionList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewIpAdmissionPrescriptionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewIpAdmissionPrescriptionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewIpAdmissionPrescriptionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewIpAdmissionPrescriptionAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIpAdmissionPrescriptionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIpAdmissionPrescriptionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewIpAdmissionPrescriptionDelete", $this->getUrlParm());
    }
