 ...
 */
class ViewPatientBilling extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('view_patient_billing', 'view_patient_billing', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 201, 450, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPatientBillingList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPatientBillingView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPatientBillingEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPatientBillingAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPatientBillingView";
            case Config("API_ADD_ACTION"):
                return "ViewPatientBillingAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPatientBillingEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPatientBillingDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPatientBillingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPatientBillingView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPatientBillingView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPatientBillingAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPatientBillingAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientBillingEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientBillingAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPatientBillingDelete", $this->getUrlParm());
    }
