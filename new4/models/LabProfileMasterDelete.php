 ...
 * Page class
 */
class LabProfileMasterDelete extends LabProfileMaster
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabProfileMasterDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LabProfileMasterList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LabProfileMasterList"); // Return to list
                return;
            }
        }
