 ...
 */
class PresIndicationstable extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Sno
        $this->Sno = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Sno', 'Sno', '`Sno`', '`Sno`', 3, 11, -1, false, '`Sno`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        $this->Sno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Sno->Param, "CustomMsg");
        $this->Fields['Sno'] = &$this->Sno;

        // Genericname
        $this->Genericname = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Genericname', 'Genericname', '`Genericname`', '`Genericname`', 200, 100, -1, false, '`Genericname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Indications
        $this->Indications = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Indications', 'Indications', '`Indications`', '`Indications`', 201, -1, -1, false, '`Indications`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Indications->Sortable = true; // Allow sort
        $this->Indications->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Indications->Param, "CustomMsg");
        $this->Fields['Indications'] = &$this->Indications;

        // Category
        $this->Category = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Category', 'Category', '`Category`', '`Category`', 200, 50, -1, false, '`Category`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Min_Age
        $this->Min_Age = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Min_Age', 'Min_Age', '`Min_Age`', '`Min_Age`', 3, 11, -1, false, '`Min_Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Min_Age->Sortable = true; // Allow sort
        $this->Min_Age->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Min_Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Min_Age->Param, "CustomMsg");
        $this->Fields['Min_Age'] = &$this->Min_Age;

        // Min_Days
        $this->Min_Days = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Min_Days', 'Min_Days', '`Min_Days`', '`Min_Days`', 200, 50, -1, false, '`Min_Days`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Min_Days->Sortable = true; // Allow sort
        $this->Min_Days->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Min_Days->Param, "CustomMsg");
        $this->Fields['Min_Days'] = &$this->Min_Days;

        // Max_Age
        $this->Max_Age = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Max_Age', 'Max_Age', '`Max_Age`', '`Max_Age`', 3, 11, -1, false, '`Max_Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Max_Age->Sortable = true; // Allow sort
        $this->Max_Age->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Max_Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Max_Age->Param, "CustomMsg");
        $this->Fields['Max_Age'] = &$this->Max_Age;

        // Max_Days
        $this->Max_Days = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Max_Days', 'Max_Days', '`Max_Days`', '`Max_Days`', 200, 50, -1, false, '`Max_Days`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Max_Days->Sortable = true; // Allow sort
        $this->Max_Days->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Max_Days->Param, "CustomMsg");
        $this->Fields['Max_Days'] = &$this->Max_Days;

        // Route
        $this->_Route = new DbField('pres_indicationstable', 'pres_indicationstable', 'x__Route', 'Route', '`Route`', '`Route`', 200, 50, -1, false, '`Route`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_Route->Sortable = true; // Allow sort
        $this->_Route->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_Route->Param, "CustomMsg");
        $this->Fields['Route'] = &$this->_Route;

        // Form
        $this->Form = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Form', 'Form', '`Form`', '`Form`', 200, 50, -1, false, '`Form`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Min_Dose_Val
        $this->Min_Dose_Val = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Min_Dose_Val', 'Min_Dose_Val', '`Min_Dose_Val`', '`Min_Dose_Val`', 5, 22, -1, false, '`Min_Dose_Val`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Min_Dose_Val->Sortable = true; // Allow sort
        $this->Min_Dose_Val->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->Min_Dose_Val->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->Min_Dose_Val->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Min_Dose_Val->Param, "CustomMsg");
        $this->Fields['Min_Dose_Val'] = &$this->Min_Dose_Val;

        // Min_Dose_Unit
        $this->Min_Dose_Unit = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Min_Dose_Unit', 'Min_Dose_Unit', '`Min_Dose_Unit`', '`Min_Dose_Unit`', 200, 50, -1, false, '`Min_Dose_Unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Min_Dose_Unit->Sortable = true; // Allow sort
        $this->Min_Dose_Unit->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Min_Dose_Unit->Param, "CustomMsg");
        $this->Fields['Min_Dose_Unit'] = &$this->Min_Dose_Unit;

        // Max_Dose_Val
        $this->Max_Dose_Val = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Max_Dose_Val', 'Max_Dose_Val', '`Max_Dose_Val`', '`Max_Dose_Val`', 5, 22, -1, false, '`Max_Dose_Val`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Max_Dose_Val->Sortable = true; // Allow sort
        $this->Max_Dose_Val->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->Max_Dose_Val->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->Max_Dose_Val->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Max_Dose_Val->Param, "CustomMsg");
        $this->Fields['Max_Dose_Val'] = &$this->Max_Dose_Val;

        // Max_Dose_Unit
        $this->Max_Dose_Unit = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Max_Dose_Unit', 'Max_Dose_Unit', '`Max_Dose_Unit`', '`Max_Dose_Unit`', 200, 50, -1, false, '`Max_Dose_Unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Max_Dose_Unit->Sortable = true; // Allow sort
        $this->Max_Dose_Unit->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Max_Dose_Unit->Param, "CustomMsg");
        $this->Fields['Max_Dose_Unit'] = &$this->Max_Dose_Unit;

        // Frequency
        $this->Frequency = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Frequency', 'Frequency', '`Frequency`', '`Frequency`', 200, 50, -1, false, '`Frequency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Frequency->Sortable = true; // Allow sort
        $this->Frequency->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Frequency->Param, "CustomMsg");
        $this->Fields['Frequency'] = &$this->Frequency;

        // Duration
        $this->Duration = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Duration', 'Duration', '`Duration`', '`Duration`', 3, 11, -1, false, '`Duration`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DWMY
        $this->DWMY = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_DWMY', 'DWMY', '`DWMY`', '`DWMY`', 200, 50, -1, false, '`DWMY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DWMY->Sortable = true; // Allow sort
        $this->DWMY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DWMY->Param, "CustomMsg");
        $this->Fields['DWMY'] = &$this->DWMY;

        // Contraindications
        $this->Contraindications = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Contraindications', 'Contraindications', '`Contraindications`', '`Contraindications`', 201, -1, -1, false, '`Contraindications`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Contraindications->Sortable = true; // Allow sort
        $this->Contraindications->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Contraindications->Param, "CustomMsg");
        $this->Fields['Contraindications'] = &$this->Contraindications;

        // RecStatus
        $this->RecStatus = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_RecStatus', 'RecStatus', '`RecStatus`', '`RecStatus`', 200, 50, -1, false, '`RecStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RecStatus->Sortable = true; // Allow sort
        $this->RecStatus->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RecStatus->Param, "CustomMsg");
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->Sno->setDbValue($conn->lastInsertId());
    ...
    {
        $keys = [];
        $val = $current ? $this->Sno->CurrentValue : $this->Sno->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->Sno->CurrentValue = $keys[0];
            } else {
                $this->Sno->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('Sno', $row) ? $row['Sno'] : null;
        } else {
            $val = $this->Sno->OldValue !== null ? $this->Sno->OldValue : $this->Sno->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PresIndicationstableList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PresIndicationstableEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PresIndicationstableAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PresIndicationstableView";
            case Config("API_ADD_ACTION"):
                return "PresIndicationstableAdd";
            case Config("API_EDIT_ACTION"):
                return "PresIndicationstableEdit";
            case Config("API_DELETE_ACTION"):
                return "PresIndicationstableDelete";
            case Config("API_LIST_ACTION"):
                return "PresIndicationstableList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PresIndicationstableView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PresIndicationstableView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PresIndicationstableAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PresIndicationstableAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresIndicationstableEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresIndicationstableAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PresIndicationstableDelete", $this->getUrlParm());
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->Sno->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->Sno->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("Sno") ?? Route("Sno")) !== null) {
                $arKeys[] = $keyValue;
