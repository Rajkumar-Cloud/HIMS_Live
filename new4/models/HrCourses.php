...
/**
 * Table class for hr_courses
 */
class HrCourses extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'hr_courses';
        $this->TableName = 'hr_courses';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`hr_courses`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('hr_courses', 'hr_courses', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // code
        $this->code = new DbField('hr_courses', 'hr_courses', 'x_code', 'code', '`code`', '`code`', 201, 300, -1, false, '`code`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // name
        $this->name = new DbField('hr_courses', 'hr_courses', 'x_name', 'name', '`name`', '`name`', 201, 300, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // description
        $this->description = new DbField('hr_courses', 'hr_courses', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->description->Sortable = true; // Allow sort
        $this->description->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->description->Param, "CustomMsg");
        $this->Fields['description'] = &$this->description;

        // coordinator
        $this->coordinator = new DbField('hr_courses', 'hr_courses', 'x_coordinator', 'coordinator', '`coordinator`', '`coordinator`', 3, 20, -1, false, '`coordinator`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->coordinator->Sortable = true; // Allow sort
        $this->coordinator->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->coordinator->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->coordinator->Param, "CustomMsg");
        $this->Fields['coordinator'] = &$this->coordinator;

        // trainer
        $this->trainer = new DbField('hr_courses', 'hr_courses', 'x_trainer', 'trainer', '`trainer`', '`trainer`', 201, 300, -1, false, '`trainer`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->trainer->Sortable = true; // Allow sort
        $this->trainer->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->trainer->Param, "CustomMsg");
        $this->Fields['trainer'] = &$this->trainer;

        // trainer_info
        $this->trainer_info = new DbField('hr_courses', 'hr_courses', 'x_trainer_info', 'trainer_info', '`trainer_info`', '`trainer_info`', 201, 65535, -1, false, '`trainer_info`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->trainer_info->Sortable = true; // Allow sort
        $this->trainer_info->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->trainer_info->Param, "CustomMsg");
        $this->Fields['trainer_info'] = &$this->trainer_info;

        // paymentType
        $this->paymentType = new DbField('hr_courses', 'hr_courses', 'x_paymentType', 'paymentType', '`paymentType`', '`paymentType`', 202, 17, -1, false, '`paymentType`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->paymentType->Sortable = true; // Allow sort
        $this->paymentType->Lookup = new Lookup('paymentType', 'hr_courses', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->paymentType->OptionCount = 2;
        ...
        // currency
        $this->currency = new DbField('hr_courses', 'hr_courses', 'x_currency', 'currency', '`currency`', '`currency`', 200, 3, -1, false, '`currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cost
        $this->cost = new DbField('hr_courses', 'hr_courses', 'x_cost', 'cost', '`cost`', '`cost`', 131, 12, -1, false, '`cost`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('hr_courses', 'hr_courses', 'x_status', 'status', '`status`', '`status`', 202, 8, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status->Sortable = true; // Allow sort
        $this->status->Lookup = new Lookup('status', 'hr_courses', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->status->OptionCount = 2;
        $this->status->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->status->Param, "CustomMsg");
        $this->Fields['status'] = &$this->status;

        // created
        $this->created = new DbField('hr_courses', 'hr_courses', 'x_created', 'created', '`created`', CastDateFieldForLike("`created`", 0, "DB"), 135, 19, 0, false, '`created`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated
        $this->updated = new DbField('hr_courses', 'hr_courses', 'x_updated', 'updated', '`updated`', CastDateFieldForLike("`updated`", 0, "DB"), 135, 19, 0, false, '`updated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`hr_courses`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->coordinator->DbValue = $row['coordinator'];
        $this->trainer->DbValue = $row['trainer'];
        $this->trainer_info->DbValue = $row['trainer_info'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HrCoursesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "HrCoursesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "HrCoursesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "HrCoursesView";
            case Config("API_ADD_ACTION"):
                return "HrCoursesAdd";
            case Config("API_EDIT_ACTION"):
                return "HrCoursesEdit";
            case Config("API_DELETE_ACTION"):
                return "HrCoursesDelete";
            case Config("API_LIST_ACTION"):
                return "HrCoursesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HrCoursesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("HrCoursesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "HrCoursesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "HrCoursesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("HrCoursesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HrCoursesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("HrCoursesDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->coordinator->EditValue = $this->coordinator->CurrentValue;
        ...
        $this->trainer->EditValue = $this->trainer->CurrentValue;
        ...
        $this->trainer_info->EditValue = $this->trainer_info->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->coordinator);
                    $doc->exportCaption($this->trainer);
                    $doc->exportCaption($this->trainer_info);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->coordinator);
                        $doc->exportField($this->trainer);
                        $doc->exportField($this->trainer_info);
