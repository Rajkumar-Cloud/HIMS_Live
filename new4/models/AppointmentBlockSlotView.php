 ...
 * Page class
 */
class AppointmentBlockSlotView extends AppointmentBlockSlot
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppointmentBlockSlotView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "AppointmentBlockSlotList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AppointmentBlockSlotList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "AppointmentBlockSlotList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
