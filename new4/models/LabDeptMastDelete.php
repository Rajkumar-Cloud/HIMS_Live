 ...
 * Page class
 */
class LabDeptMastDelete extends LabDeptMast
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabDeptMastDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LabDeptMastList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LabDeptMastList"); // Return to list
                return;
            }
        }
