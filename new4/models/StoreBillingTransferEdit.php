 ...
 * Page class
 */
class StoreBillingTransferEdit extends StoreBillingTransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreBillingTransferEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_store_transfer", $detailTblVar) && $detailPage->DetailEdit) {
