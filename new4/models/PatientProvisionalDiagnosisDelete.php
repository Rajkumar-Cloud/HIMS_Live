 ...
 * Page class
 */
class PatientProvisionalDiagnosisDelete extends PatientProvisionalDiagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientProvisionalDiagnosisDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientProvisionalDiagnosisList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientProvisionalDiagnosisList"); // Return to list
                return;
            }
        }
