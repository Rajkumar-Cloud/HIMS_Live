 ...
 * Page class
 */
class PharmacyBillingTransferDelete extends PharmacyBillingTransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingTransferDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyBillingTransferList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyBillingTransferList"); // Return to list
                return;
            }
        }
