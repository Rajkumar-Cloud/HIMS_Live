 ...
 * Page class
 */
class MasUserTemplatePrescriptionList extends MasUserTemplatePrescription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasUserTemplatePrescriptionList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "MasUserTemplatePrescriptionAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MasUserTemplatePrescriptionDelete";
        $this->MultiUpdateUrl = "MasUserTemplatePrescriptionUpdate";
    ...
    public function resetFormError()
    {
        ...
        $this->TemplateName->clearErrorMessage();
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['TemplateName']); // TemplateName
