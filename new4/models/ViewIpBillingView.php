 ...
 * Page class
 */
class ViewIpBillingView extends ViewIpBilling
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpBillingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewIpBillingList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewIpBillingList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewIpBillingList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
