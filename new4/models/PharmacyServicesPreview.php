 ...
 * Page class
 */
class PharmacyServicesPreview extends PharmacyServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyServicesPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy&" . GetForeignKeyUrl("fk_id", $this->pharmacy_id->QueryStringValue) . "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->QueryStringValue) . "";
        }
        if ($masterTblVar == "mas_pharmacy") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=mas_pharmacy&" . GetForeignKeyUrl("fk_name", $this->name->QueryStringValue) . "&" . GetForeignKeyUrl("fk_amount", $this->amount->QueryStringValue) . "&" . GetForeignKeyUrl("fk_description", $this->description->QueryStringValue) . "";
        }
        return $url;
    }
