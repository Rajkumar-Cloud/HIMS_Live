 ...
 * Page class
 */
class ViewPatientDischargeSummaryList extends ViewPatientDischargeSummary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPatientDischargeSummaryList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPatientDischargeSummaryAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPatientDischargeSummaryDelete";
        $this->MultiUpdateUrl = "ViewPatientDischargeSummaryUpdate";
    ...
    protected function loadSearchValues()
    {
        ...
        if (!$this->isAddOrEdit() && $this->DischargeAdviceMedicine->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->DischargeAdviceMedicine->AdvancedSearch->SearchValue != "" || $this->DischargeAdviceMedicine->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
