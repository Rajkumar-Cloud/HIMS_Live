 ...
 * Page class
 */
class ViewOpdFollowUpView extends ViewOpdFollowUp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOpdFollowUpView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewOpdFollowUpList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewOpdFollowUpList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewOpdFollowUpList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
