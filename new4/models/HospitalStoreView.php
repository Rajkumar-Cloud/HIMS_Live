 ...
 * Page class
 */
class HospitalStoreView extends HospitalStore
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HospitalStoreView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "HospitalStoreList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "HospitalStoreList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "HospitalStoreList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("HospitalStoreList"), "", $this->TableVar, true);
        $pageId = "view";
