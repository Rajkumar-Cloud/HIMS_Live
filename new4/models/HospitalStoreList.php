 ...
 * Page class
 */
class HospitalStoreList extends HospitalStore
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HospitalStoreList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "HospitalStoreAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "HospitalStoreDelete";
        $this->MultiUpdateUrl = "HospitalStoreUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("hospital_store"));
                $doc->Text = @$content;
