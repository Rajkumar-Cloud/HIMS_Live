 ...
 * Page class
 */
class ViewLabreportPrintList extends ViewLabreportPrint
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabreportPrintList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewLabreportPrintAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewLabreportPrintDelete";
        $this->MultiUpdateUrl = "ViewLabreportPrintUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_labreport_print"));
                $doc->Text = @$content;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_lab_resultreleased')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewLabResultreleasedList?" . Config("TABLE_SHOW_MASTER") . "=view_labreport_print&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["view_lab_resultreleased"] && $this->DetailPages["view_lab_resultreleased"]->Visible) {
            ...
            $url = "ViewLabResultreleasedPreview?t=view_labreport_print&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_labreport_print')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewLabResultreleasedList?" . Config("TABLE_SHOW_MASTER") . "=view_labreport_print&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_labreport_print')) {
