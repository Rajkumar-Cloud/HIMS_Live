 ...
 * Page class
 */
class MasServicesBillingView extends MasServicesBilling
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasServicesBillingView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "MasServicesBillingList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MasServicesBillingList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "MasServicesBillingList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
