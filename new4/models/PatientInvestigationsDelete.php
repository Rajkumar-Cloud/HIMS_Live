 ...
 * Page class
 */
class PatientInvestigationsDelete extends PatientInvestigations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientInvestigationsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientInvestigationsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientInvestigationsList"); // Return to list
                return;
            }
        }
