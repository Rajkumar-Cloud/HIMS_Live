...
/**
 * Table class for employee_travel_records
 */
class EmployeeTravelRecords extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_travel_records';
        $this->TableName = 'employee_travel_records';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`employee_travel_records`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('employee_travel_records', 'employee_travel_records', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee
        $this->employee = new DbField('employee_travel_records', 'employee_travel_records', 'x_employee', 'employee', '`employee`', '`employee`', 3, 20, -1, false, '`employee`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // type
        $this->type = new DbField('employee_travel_records', 'employee_travel_records', 'x_type', 'type', '`type`', '`type`', 202, 13, -1, false, '`type`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->type->Sortable = true; // Allow sort
        $this->type->Lookup = new Lookup('type', 'employee_travel_records', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->type->OptionCount = 2;
        $this->type->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->type->Param, "CustomMsg");
        $this->Fields['type'] = &$this->type;

        // purpose
        $this->purpose = new DbField('employee_travel_records', 'employee_travel_records', 'x_purpose', 'purpose', '`purpose`', '`purpose`', 200, 200, -1, false, '`purpose`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->purpose->Nullable = false; // NOT NULL field
        ...
        // travel_from
        $this->travel_from = new DbField('employee_travel_records', 'employee_travel_records', 'x_travel_from', 'travel_from', '`travel_from`', '`travel_from`', 200, 200, -1, false, '`travel_from`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->travel_from->Nullable = false; // NOT NULL field
        $this->travel_from->Required = true; // Required field
        $this->travel_from->Sortable = true; // Allow sort
        $this->travel_from->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->travel_from->Param, "CustomMsg");
        $this->Fields['travel_from'] = &$this->travel_from;

        // travel_to
        $this->travel_to = new DbField('employee_travel_records', 'employee_travel_records', 'x_travel_to', 'travel_to', '`travel_to`', '`travel_to`', 200, 200, -1, false, '`travel_to`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->travel_to->Nullable = false; // NOT NULL field
        $this->travel_to->Required = true; // Required field
        $this->travel_to->Sortable = true; // Allow sort
        $this->travel_to->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->travel_to->Param, "CustomMsg");
        $this->Fields['travel_to'] = &$this->travel_to;

        // travel_date
        $this->travel_date = new DbField('employee_travel_records', 'employee_travel_records', 'x_travel_date', 'travel_date', '`travel_date`', CastDateFieldForLike("`travel_date`", 0, "DB"), 135, 19, 0, false, '`travel_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->travel_date->Sortable = true; // Allow sort
        $this->travel_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->travel_date->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->travel_date->Param, "CustomMsg");
        $this->Fields['travel_date'] = &$this->travel_date;

        // return_date
        $this->return_date = new DbField('employee_travel_records', 'employee_travel_records', 'x_return_date', 'return_date', '`return_date`', CastDateFieldForLike("`return_date`", 0, "DB"), 135, 19, 0, false, '`return_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // details
        $this->details = new DbField('employee_travel_records', 'employee_travel_records', 'x_details', 'details', '`details`', '`details`', 201, 500, -1, false, '`details`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // funding
        $this->funding = new DbField('employee_travel_records', 'employee_travel_records', 'x_funding', 'funding', '`funding`', '`funding`', 131, 10, -1, false, '`funding`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->funding->Sortable = true; // Allow sort
        $this->funding->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->funding->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->funding->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->funding->Param, "CustomMsg");
        $this->Fields['funding'] = &$this->funding;

        // currency
        $this->currency = new DbField('employee_travel_records', 'employee_travel_records', 'x_currency', 'currency', '`currency`', '`currency`', 20, 20, -1, false, '`currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // attachment1
        $this->attachment1 = new DbField('employee_travel_records', 'employee_travel_records', 'x_attachment1', 'attachment1', '`attachment1`', '`attachment1`', 200, 100, -1, false, '`attachment1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // attachment2
        $this->attachment2 = new DbField('employee_travel_records', 'employee_travel_records', 'x_attachment2', 'attachment2', '`attachment2`', '`attachment2`', 200, 100, -1, false, '`attachment2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // attachment3
        $this->attachment3 = new DbField('employee_travel_records', 'employee_travel_records', 'x_attachment3', 'attachment3', '`attachment3`', '`attachment3`', 200, 100, -1, false, '`attachment3`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // created
        $this->created = new DbField('employee_travel_records', 'employee_travel_records', 'x_created', 'created', '`created`', CastDateFieldForLike("`created`", 0, "DB"), 135, 19, 0, false, '`created`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated
        $this->updated = new DbField('employee_travel_records', 'employee_travel_records', 'x_updated', 'updated', '`updated`', CastDateFieldForLike("`updated`", 0, "DB"), 135, 19, 0, false, '`updated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('employee_travel_records', 'employee_travel_records', 'x_status', 'status', '`status`', '`status`', 202, 22, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status->Sortable = true; // Allow sort
        $this->status->Lookup = new Lookup('status', 'employee_travel_records', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_travel_records`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->travel_from->DbValue = $row['travel_from'];
        $this->travel_to->DbValue = $row['travel_to'];
        $this->travel_date->DbValue = $row['travel_date'];
        $this->return_date->DbValue = $row['return_date'];
        $this->details->DbValue = $row['details'];
        $this->funding->DbValue = $row['funding'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeTravelRecordsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "EmployeeTravelRecordsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeTravelRecordsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeTravelRecordsView";
            case Config("API_ADD_ACTION"):
                return "EmployeeTravelRecordsAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeTravelRecordsEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeTravelRecordsDelete";
            case Config("API_LIST_ACTION"):
                return "EmployeeTravelRecordsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeTravelRecordsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeTravelRecordsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeTravelRecordsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeTravelRecordsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeTravelRecordsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeTravelRecordsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeTravelRecordsDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->travel_from->EditValue = $this->travel_from->CurrentValue;
        ...
        $this->travel_to->EditValue = $this->travel_to->CurrentValue;
        ...
        $this->travel_date->EditValue = FormatDateTime($this->travel_date->CurrentValue, 8);
        ...
        $this->funding->EditValue = $this->funding->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->travel_from);
                    $doc->exportCaption($this->travel_to);
                    $doc->exportCaption($this->travel_date);
                    $doc->exportCaption($this->return_date);
                    $doc->exportCaption($this->details);
                    $doc->exportCaption($this->funding);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->travel_from);
                        $doc->exportField($this->travel_to);
                        $doc->exportField($this->travel_date);
                        $doc->exportField($this->return_date);
                        $doc->exportField($this->details);
                        $doc->exportField($this->funding);
