 ...
 * Page class
 */
class PatientDocumentView extends PatientDocument
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientDocumentView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientDocumentList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientDocumentList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientDocumentList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
