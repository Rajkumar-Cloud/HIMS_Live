...
/**
 * Table class for view_store_search_product
 */
class ViewStoreSearchProduct extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_store_search_product';
        $this->TableName = 'view_store_search_product';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_store_search_product`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_store_search_product', 'view_store_search_product', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DES
        $this->DES = new DbField('view_store_search_product', 'view_store_search_product', 'x_DES', 'DES', '`DES`', '`DES`', 200, 100, -1, false, '`DES`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH
        $this->BATCH = new DbField('view_store_search_product', 'view_store_search_product', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, 10, -1, false, '`BATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_store_search_product', 'view_store_search_product', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('view_store_search_product', 'view_store_search_product', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('view_store_search_product', 'view_store_search_product', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 16, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_store_search_product', 'view_store_search_product', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENNAME
        $this->GENNAME = new DbField('view_store_search_product', 'view_store_search_product', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, 150, -1, false, '`GENNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNIT
        $this->UNIT = new DbField('view_store_search_product', 'view_store_search_product', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, 45, -1, false, '`UNIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('view_store_search_product', 'view_store_search_product', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_store_search_product', 'view_store_search_product', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_store_search_product', 'view_store_search_product', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_store_search_product', 'view_store_search_product', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_store_search_product', 'view_store_search_product', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_store_search_product', 'view_store_search_product', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('view_store_search_product', 'view_store_search_product', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('view_store_search_product', 'view_store_search_product', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('view_store_search_product', 'view_store_search_product', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('view_store_search_product', 'view_store_search_product', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_store_search_product', 'view_store_search_product', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_store_search_product', 'view_store_search_product', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDATE
        $this->BILLDATE = new DbField('view_store_search_product', 'view_store_search_product', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike("`BILLDATE`", 0, "DB"), 135, 19, 0, false, '`BILLDATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_store_search_product`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewStoreSearchProductList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewStoreSearchProductView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewStoreSearchProductEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewStoreSearchProductAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewStoreSearchProductView";
            case Config("API_ADD_ACTION"):
                return "ViewStoreSearchProductAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewStoreSearchProductEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewStoreSearchProductDelete";
            case Config("API_LIST_ACTION"):
                return "ViewStoreSearchProductList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewStoreSearchProductView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewStoreSearchProductView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewStoreSearchProductAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewStoreSearchProductAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewStoreSearchProductEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewStoreSearchProductAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewStoreSearchProductDelete", $this->getUrlParm());
    }
