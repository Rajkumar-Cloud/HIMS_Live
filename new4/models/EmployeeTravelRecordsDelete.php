 ...
 * Page class
 */
class EmployeeTravelRecordsDelete extends EmployeeTravelRecords
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTravelRecordsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeTravelRecordsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeTravelRecordsList"); // Return to list
                return;
            }
        }
