 ...
 * Page class
 */
class PatientInsuranceView extends PatientInsurance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientInsuranceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientInsuranceList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientInsuranceList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientInsuranceList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
