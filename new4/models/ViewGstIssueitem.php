...
/**
 * Table class for view_gst_issueitem
 */
class ViewGstIssueitem extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_gst_issueitem';
        $this->TableName = 'view_gst_issueitem';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_gst_issueitem`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // voucher_type
        $this->voucher_type = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // product
        $this->product = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_product', 'product', '`product`', '`product`', 200, 100, -1, false, '`product`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Damt
        $this->Damt = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_Damt', 'Damt', '`Damt`', '`Damt`', 131, 12, -1, false, '`Damt`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 12, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // amount
        $this->amount = new DbField('view_gst_issueitem', 'view_gst_issueitem', 'x_amount', 'amount', '`amount`', '`amount`', 131, 10, -1, false, '`amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_gst_issueitem`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewGstIssueitemList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewGstIssueitemView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewGstIssueitemEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewGstIssueitemAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewGstIssueitemView";
            case Config("API_ADD_ACTION"):
                return "ViewGstIssueitemAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewGstIssueitemEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewGstIssueitemDelete";
            case Config("API_LIST_ACTION"):
                return "ViewGstIssueitemList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewGstIssueitemView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewGstIssueitemView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewGstIssueitemAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewGstIssueitemAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewGstIssueitemEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewGstIssueitemAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewGstIssueitemDelete", $this->getUrlParm());
    }
