...
class ViewAppointmentSchedulerNew extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // start_time
        $this->start_time = new DbField('view_appointment_scheduler_new', 'view_appointment_scheduler_new', 'x_start_time', 'start_time', '`start_time`', CastDateFieldForLike("`start_time`", 3, "DB"), 135, 19, 3, false, '`start_time`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // start_date
        $this->start_date = new DbField('view_appointment_scheduler_new', 'view_appointment_scheduler_new', 'x_start_date', 'start_date', '`start_date`', CastDateFieldForLike("`start_date`", 11, "DB"), 135, 19, 11, false, '`start_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DoctorName
        $this->DoctorName = new DbField('view_appointment_scheduler_new', 'view_appointment_scheduler_new', 'x_DoctorName', 'DoctorName', '`DoctorName`', '`DoctorName`', 200, 45, -1, false, '`DoctorName`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewAppointmentSchedulerNewList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewAppointmentSchedulerNewView";
            case Config("API_ADD_ACTION"):
                return "ViewAppointmentSchedulerNewAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewAppointmentSchedulerNewEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewAppointmentSchedulerNewDelete";
