 ...
 * Page class
 */
class PharmacyGrnPreview extends PharmacyGrn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyGrnPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_payment") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_payment&" . GetForeignKeyUrl("fk_id", $this->Pid->QueryStringValue) . "";
        }
        return $url;
    }
