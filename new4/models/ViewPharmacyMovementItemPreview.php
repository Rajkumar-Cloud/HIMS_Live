 ...
 * Page class
 */
class ViewPharmacyMovementItemPreview extends ViewPharmacyMovementItem
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyMovementItemPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_pharmacy_movement") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_pharmacy_movement&" . GetForeignKeyUrl("fk_prc", $this->prc->QueryStringValue) . "&" . GetForeignKeyUrl("fk_BatchNo", $this->BatchNo->QueryStringValue) . "";
        }
        return $url;
    }
