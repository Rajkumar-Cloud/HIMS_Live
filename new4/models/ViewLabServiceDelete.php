 ...
 * Page class
 */
class ViewLabServiceDelete extends ViewLabService
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabServiceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewLabServiceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewLabServiceList"); // Return to list
                return;
            }
        }
