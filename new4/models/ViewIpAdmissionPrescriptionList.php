 ...
 * Page class
 */
class ViewIpAdmissionPrescriptionList extends ViewIpAdmissionPrescription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpAdmissionPrescriptionList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewIpAdmissionPrescriptionAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewIpAdmissionPrescriptionDelete";
        $this->MultiUpdateUrl = "ViewIpAdmissionPrescriptionUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_ip_admission_prescription"));
                $doc->Text = @$content;
