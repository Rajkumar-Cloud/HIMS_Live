 ...
 */
class ViewDashboardServiceServicetype extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // sum(SubTotal)
        $this->sumSubTotal = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_sumSubTotal', 'sum(SubTotal)', '`sum(SubTotal)`', '`sum(SubTotal)`', 131, 34, -1, false, '`sum(SubTotal)`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "view_dashboard_service_details") {
            $detailUrl = Container("view_dashboard_service_details")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            ...
            $detailUrl .= "&" . GetForeignKeyUrl("fk_SERVICE_TYPE", $this->SERVICE_TYPE->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->CurrentValue, 7);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewDashboardServiceServicetypeList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDashboardServiceServicetypeList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDashboardServiceServicetypeView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDashboardServiceServicetypeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDashboardServiceServicetypeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDashboardServiceServicetypeView";
            case Config("API_ADD_ACTION"):
                return "ViewDashboardServiceServicetypeAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDashboardServiceServicetypeEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDashboardServiceServicetypeDelete";
            case Config("API_LIST_ACTION"):
                return "ViewDashboardServiceServicetypeList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDashboardServiceServicetypeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDashboardServiceServicetypeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDashboardServiceServicetypeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDashboardServiceServicetypeAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardServiceServicetypeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardServiceServicetypeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDashboardServiceServicetypeDelete", $this->getUrlParm());
    }
    ...
    public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->sumSubTotal, 'TOTAL');
