 ...
 * Page class
 */
class RecruitmentJobDelete extends RecruitmentJob
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecruitmentJobDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RecruitmentJobList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RecruitmentJobList"); // Return to list
                return;
            }
        }
