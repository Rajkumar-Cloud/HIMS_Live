...
class Depositdetails extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ManualCash
        $this->ManualCash = new DbField('depositdetails', 'depositdetails', 'x_ManualCash', 'ManualCash', '`ManualCash`', '`ManualCash`', 131, 10, -1, false, '`ManualCash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ManualCard
        $this->ManualCard = new DbField('depositdetails', 'depositdetails', 'x_ManualCard', 'ManualCard', '`ManualCard`', '`ManualCard`', 131, 10, -1, false, '`ManualCard`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DepositdetailsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "DepositdetailsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DepositdetailsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "DepositdetailsAdd";
            case Config("API_EDIT_ACTION"):
                return "DepositdetailsEdit";
            case Config("API_DELETE_ACTION"):
                return "DepositdetailsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DepositdetailsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DepositdetailsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DepositdetailsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DepositdetailsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DepositdetailsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DepositdetailsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DepositdetailsDelete", $this->getUrlParm());
    }
