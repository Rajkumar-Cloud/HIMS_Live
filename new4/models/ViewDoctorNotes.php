...
class ViewDoctorNotes extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Started->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Started->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDoctorNotesList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDoctorNotesView";
            case Config("API_ADD_ACTION"):
                return "ViewDoctorNotesAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDoctorNotesEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDoctorNotesDelete";
