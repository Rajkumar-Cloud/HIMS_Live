 ...
 * Page class
 */
class ViewFollowUpList extends ViewFollowUp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewFollowUpList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewFollowUpAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewFollowUpDelete";
        $this->MultiUpdateUrl = "ViewFollowUpUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_follow_up"));
                $doc->Text = @$content;
