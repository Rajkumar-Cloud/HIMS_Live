 ...
 * Page class
 */
class IvfOocytedenudationStageDelete extends IvfOocytedenudationStage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfOocytedenudationStageDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IvfOocytedenudationStageList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IvfOocytedenudationStageList"); // Return to list
                return;
            }
        }
