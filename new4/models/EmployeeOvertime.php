...
/**
 * Table class for employee_overtime
 */
class EmployeeOvertime extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_overtime';
        $this->TableName = 'employee_overtime';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`employee_overtime`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('employee_overtime', 'employee_overtime', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee
        $this->employee = new DbField('employee_overtime', 'employee_overtime', 'x_employee', 'employee', '`employee`', '`employee`', 3, 20, -1, false, '`employee`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // start_time
        $this->start_time = new DbField('employee_overtime', 'employee_overtime', 'x_start_time', 'start_time', '`start_time`', CastDateFieldForLike("`start_time`", 0, "DB"), 135, 19, 0, false, '`start_time`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_time
        $this->end_time = new DbField('employee_overtime', 'employee_overtime', 'x_end_time', 'end_time', '`end_time`', CastDateFieldForLike("`end_time`", 0, "DB"), 135, 19, 0, false, '`end_time`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // category
        $this->category = new DbField('employee_overtime', 'employee_overtime', 'x_category', 'category', '`category`', '`category`', 20, 20, -1, false, '`category`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // project
        $this->project = new DbField('employee_overtime', 'employee_overtime', 'x_project', 'project', '`project`', '`project`', 20, 20, -1, false, '`project`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // notes
        $this->notes = new DbField('employee_overtime', 'employee_overtime', 'x_notes', 'notes', '`notes`', '`notes`', 201, 65535, -1, false, '`notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // created
        $this->created = new DbField('employee_overtime', 'employee_overtime', 'x_created', 'created', '`created`', CastDateFieldForLike("`created`", 0, "DB"), 135, 19, 0, false, '`created`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated
        $this->updated = new DbField('employee_overtime', 'employee_overtime', 'x_updated', 'updated', '`updated`', CastDateFieldForLike("`updated`", 0, "DB"), 135, 19, 0, false, '`updated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('employee_overtime', 'employee_overtime', 'x_status', 'status', '`status`', '`status`', 202, 22, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status->Sortable = true; // Allow sort
        $this->status->Lookup = new Lookup('status', 'employee_overtime', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_overtime`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeOvertimeList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmployeeOvertimeView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmployeeOvertimeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeOvertimeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EmployeeOvertimeAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeOvertimeEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeOvertimeDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeOvertimeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeOvertimeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeOvertimeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeOvertimeAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeOvertimeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeOvertimeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeOvertimeDelete", $this->getUrlParm());
    }
