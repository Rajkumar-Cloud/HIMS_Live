 ...
 * Page class
 */
class PatientAnRegistrationList extends PatientAnRegistration
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAnRegistrationList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "PatientAnRegistrationDelete";
        $this->MultiUpdateUrl = "PatientAnRegistrationUpdate";
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "patient_opd_follow_up") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    ...
                    $patient_opd_follow_up->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
