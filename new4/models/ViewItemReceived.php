 ...
 */
class ViewItemReceived extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // ORDNO
        $this->ORDNO = new DbField('view_item_received', 'view_item_received', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, 5, -1, false, '`ORDNO`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_item_received', 'view_item_received', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PRC
        $this->PRC = new DbField('view_item_received', 'view_item_received', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('view_item_received', 'view_item_received', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_item_received', 'view_item_received', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QTY
        $this->QTY = new DbField('view_item_received', 'view_item_received', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 3, 11, -1, false, '`QTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('view_item_received', 'view_item_received', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('view_item_received', 'view_item_received', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YM
        $this->YM = new DbField('view_item_received', 'view_item_received', 'x_YM', 'YM', '`YM`', '`YM`', 200, 6, -1, false, '`YM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('view_item_received', 'view_item_received', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 3, 11, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LastMonthSale
        $this->LastMonthSale = new DbField('view_item_received', 'view_item_received', 'x_LastMonthSale', 'LastMonthSale', '`LastMonthSale`', '`LastMonthSale`', 3, 11, -1, false, '`LastMonthSale`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Printcheck
        $this->Printcheck = new DbField('view_item_received', 'view_item_received', 'x_Printcheck', 'Printcheck', '`Printcheck`', '`Printcheck`', 200, 50, -1, false, '`Printcheck`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // poid
        $this->poid = new DbField('view_item_received', 'view_item_received', 'x_poid', 'poid', '`poid`', '`poid`', 3, 11, -1, false, '`poid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnid
        $this->grnid = new DbField('view_item_received', 'view_item_received', 'x_grnid', 'grnid', '`grnid`', '`grnid`', 3, 11, -1, false, '`grnid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BatchNo
        $this->BatchNo = new DbField('view_item_received', 'view_item_received', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, 45, -1, false, '`BatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillDate
        $this->BillDate = new DbField('view_item_received', 'view_item_received', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike("`BillDate`", 7, "DB"), 135, 19, 7, false, '`BillDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_item_received', 'view_item_received', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 7, "DB"), 135, 19, 7, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Quantity
        $this->Quantity = new DbField('view_item_received', 'view_item_received', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, 11, -1, false, '`Quantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FreeQty
        $this->FreeQty = new DbField('view_item_received', 'view_item_received', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 3, 11, -1, false, '`FreeQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemValue
        $this->ItemValue = new DbField('view_item_received', 'view_item_received', 'x_ItemValue', 'ItemValue', '`ItemValue`', '`ItemValue`', 131, 12, -1, false, '`ItemValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Disc
        $this->Disc = new DbField('view_item_received', 'view_item_received', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, 45, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PTax
        $this->PTax = new DbField('view_item_received', 'view_item_received', 'x_PTax', 'PTax', '`PTax`', '`PTax`', 131, 12, -1, false, '`PTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRP
        $this->MRP = new DbField('view_item_received', 'view_item_received', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalTax
        $this->SalTax = new DbField('view_item_received', 'view_item_received', 'x_SalTax', 'SalTax', '`SalTax`', '`SalTax`', 131, 12, -1, false, '`SalTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('view_item_received', 'view_item_received', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('view_item_received', 'view_item_received', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalRate
        $this->SalRate = new DbField('view_item_received', 'view_item_received', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, 12, -1, false, '`SalRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Discount
        $this->Discount = new DbField('view_item_received', 'view_item_received', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, 12, -1, false, '`Discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_item_received', 'view_item_received', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_item_received', 'view_item_received', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_item_received', 'view_item_received', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_item_received', 'view_item_received', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HSN
        $this->HSN = new DbField('view_item_received', 'view_item_received', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, 45, -1, false, '`HSN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pack
        $this->Pack = new DbField('view_item_received', 'view_item_received', 'x_Pack', 'Pack', '`Pack`', '`Pack`', 200, 45, -1, false, '`Pack`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('view_item_received', 'view_item_received', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('view_item_received', 'view_item_received', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnQuantity
        $this->GrnQuantity = new DbField('view_item_received', 'view_item_received', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 3, 11, -1, false, '`GrnQuantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnMRP
        $this->GrnMRP = new DbField('view_item_received', 'view_item_received', 'x_GrnMRP', 'GrnMRP', '`GrnMRP`', '`GrnMRP`', 131, 12, -1, false, '`GrnMRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // trid
        $this->trid = new DbField('view_item_received', 'view_item_received', 'x_trid', 'trid', '`trid`', '`trid`', 3, 11, -1, false, '`trid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_item_received', 'view_item_received', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedBy
        $this->CreatedBy = new DbField('view_item_received', 'view_item_received', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, 11, -1, false, '`CreatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_item_received', 'view_item_received', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedBy
        $this->ModifiedBy = new DbField('view_item_received', 'view_item_received', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, 11, -1, false, '`ModifiedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('view_item_received', 'view_item_received', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedby
        $this->grncreatedby = new DbField('view_item_received', 'view_item_received', 'x_grncreatedby', 'grncreatedby', '`grncreatedby`', '`grncreatedby`', 3, 11, -1, false, '`grncreatedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedDateTime
        $this->grncreatedDateTime = new DbField('view_item_received', 'view_item_received', 'x_grncreatedDateTime', 'grncreatedDateTime', '`grncreatedDateTime`', CastDateFieldForLike("`grncreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`grncreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnModifiedby
        $this->grnModifiedby = new DbField('view_item_received', 'view_item_received', 'x_grnModifiedby', 'grnModifiedby', '`grnModifiedby`', '`grnModifiedby`', 3, 11, -1, false, '`grnModifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnModifiedDateTime
        $this->grnModifiedDateTime = new DbField('view_item_received', 'view_item_received', 'x_grnModifiedDateTime', 'grnModifiedDateTime', '`grnModifiedDateTime`', CastDateFieldForLike("`grnModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`grnModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Received
        $this->Received = new DbField('view_item_received', 'view_item_received', 'x_Received', 'Received', '`Received`', '`Received`', 200, 45, -1, false, '`Received`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // id
        $this->id = new DbField('view_item_received', 'view_item_received', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HospID`='".HospitalID()."'  and  `BRCODE`='".PharmacyID()."'   and  `Received`  is null and  `ORDNO` is not null ";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewItemReceivedList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewItemReceivedView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewItemReceivedEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewItemReceivedAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewItemReceivedView";
            case Config("API_ADD_ACTION"):
                return "ViewItemReceivedAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewItemReceivedEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewItemReceivedDelete";
            case Config("API_LIST_ACTION"):
                return "ViewItemReceivedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewItemReceivedView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewItemReceivedView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewItemReceivedAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewItemReceivedAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewItemReceivedEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewItemReceivedAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewItemReceivedDelete", $this->getUrlParm());
    }
