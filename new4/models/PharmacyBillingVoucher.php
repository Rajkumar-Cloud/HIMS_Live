...
/**
 * Table class for pharmacy_billing_voucher
 */
class PharmacyBillingVoucher extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pharmacy_billing_voucher';
        $this->TableName = 'pharmacy_billing_voucher';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pharmacy_billing_voucher`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // BillNumber
        $this->BillNumber = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, 45, -1, false, '`BillNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // voucher_type
        $this->voucher_type = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->voucher_type->Sortable = false; // Allow sort
        ...
        // Reception
        $this->Reception = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PatientId
        $this->PatientId = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientName
        $this->PatientName = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Mobile
        $this->Mobile = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 45, -1, false, '`Mobile`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile->Sortable = true; // Allow sort
        $this->Mobile->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile->Param, "CustomMsg");
        $this->Fields['Mobile'] = &$this->Mobile;

        // Age
        $this->Age = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // mrnno
        $this->mrnno = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // IP_OP
        $this->IP_OP = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_IP_OP', 'IP_OP', '`IP_OP`', '`IP_OP`', 200, 45, -1, false, '`IP_OP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Doctor
        $this->Doctor = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, 45, -1, false, '`Doctor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Gender
        $this->Gender = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // Details
        $this->Details = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Details', 'Details', '`Details`', '`Details`', 200, 45, -1, false, '`Details`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Amount
        $this->Amount = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, 10, -1, false, '`Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnyDues
        $this->AnyDues = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_AnyDues', 'AnyDues', '`AnyDues`', '`AnyDues`', 200, 45, -1, false, '`AnyDues`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 7, "DB"), 135, 19, 7, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationAmount
        $this->RealizationAmount = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RealizationAmount', 'RealizationAmount', '`RealizationAmount`', '`RealizationAmount`', 131, 10, -1, false, '`RealizationAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationStatus
        $this->RealizationStatus = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RealizationStatus', 'RealizationStatus', '`RealizationStatus`', '`RealizationStatus`', 200, 45, -1, false, '`RealizationStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationRemarks
        $this->RealizationRemarks = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RealizationRemarks', 'RealizationRemarks', '`RealizationRemarks`', '`RealizationRemarks`', 200, 45, -1, false, '`RealizationRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationBatchNo
        $this->RealizationBatchNo = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RealizationBatchNo', 'RealizationBatchNo', '`RealizationBatchNo`', '`RealizationBatchNo`', 200, 45, -1, false, '`RealizationBatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationDate
        $this->RealizationDate = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RealizationDate', 'RealizationDate', '`RealizationDate`', '`RealizationDate`', 200, 45, -1, false, '`RealizationDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TidNo
        $this->TidNo = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PartnerName
        $this->PartnerName = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, 45, -1, false, '`PartnerName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PayerType
        $this->PayerType = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PayerType', 'PayerType', '`PayerType`', '`PayerType`', 200, 45, -1, false, '`PayerType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profilePic
        $this->profilePic = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // Dob
        $this->Dob = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Dob', 'Dob', '`Dob`', '`Dob`', 200, 45, -1, false, '`Dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Currency
        $this->Currency = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, 45, -1, false, '`Currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 200, 45, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, 45, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Remarks->Sortable = true; // Allow sort
        $this->Remarks->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Remarks->Param, "CustomMsg");
        $this->Fields['Remarks'] = &$this->Remarks;

        // PatId
        $this->PatId = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // DrDepartment
        $this->DrDepartment = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_DrDepartment', 'DrDepartment', '`DrDepartment`', '`DrDepartment`', 200, 45, -1, false, '`DrDepartment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefferedBy
        $this->RefferedBy = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, 45, -1, false, '`RefferedBy`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CardNumber
        $this->CardNumber = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, 45, -1, false, '`CardNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BankName
        $this->BankName = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, 45, -1, false, '`BankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->DrID->Required = true; // Required field
        ...
        // BillStatus
        $this->BillStatus = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, 11, -1, false, '`BillStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->ReportHeader->Sortable = true; // Allow sort
        $this->ReportHeader->Lookup = new Lookup('ReportHeader', 'pharmacy_billing_voucher', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // PharID
        $this->PharID = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PharID', 'PharID', '`PharID`', '`PharID`', 3, 11, -1, false, '`PharID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserName
        $this->_UserName = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardType
        $this->CardType = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_CardType', 'CardType', '`CardType`', '`CardType`', 200, 45, -1, false, '`CardType`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->CardType->Sortable = true; // Allow sort
        $this->CardType->Lookup = new Lookup('CardType', 'pharmacy_billing_voucher', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // DiscountAmount
        $this->DiscountAmount = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_DiscountAmount', 'DiscountAmount', '`DiscountAmount`', '`DiscountAmount`', 131, 10, -1, false, '`DiscountAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ApprovalNumber
        $this->ApprovalNumber = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_ApprovalNumber', 'ApprovalNumber', '`ApprovalNumber`', '`ApprovalNumber`', 200, 45, -1, false, '`ApprovalNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ApprovalNumber->Sortable = true; // Allow sort
        $this->ApprovalNumber->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ApprovalNumber->Param, "CustomMsg");
        $this->Fields['ApprovalNumber'] = &$this->ApprovalNumber;

        // Cash
        $this->Cash = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Cash', 'Cash', '`Cash`', '`Cash`', 131, 10, -1, false, '`Cash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Card
        $this->Card = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_Card', 'Card', '`Card`', '`Card`', 131, 10, -1, false, '`Card`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillType
        $this->BillType = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, 45, -1, false, '`BillType`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->BillType->Sortable = true; // Allow sort
        $this->BillType->Lookup = new Lookup('BillType', 'pharmacy_billing_voucher', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // PartialSave
        $this->PartialSave = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PartialSave', 'PartialSave', '`PartialSave`', '`PartialSave`', 200, 45, -1, false, '`PartialSave`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->PartialSave->Sortable = true; // Allow sort
        $this->PartialSave->Lookup = new Lookup('PartialSave', 'pharmacy_billing_voucher', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        $this->PartialSave->OptionCount = 1;
        $this->PartialSave->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PartialSave->Param, "CustomMsg");
        $this->Fields['PartialSave'] = &$this->PartialSave;

        // PatientGST
        $this->PatientGST = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_PatientGST', 'PatientGST', '`PatientGST`', '`PatientGST`', 200, 45, -1, false, '`PatientGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientGST->Sortable = true; // Allow sort
        $this->PatientGST->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientGST->Param, "CustomMsg");
        $this->Fields['PatientGST'] = &$this->PatientGST;
    }
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "pharmacy_pharled") {
            $detailUrl = Container("pharmacy_pharled")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "PharmacyBillingVoucherList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pharmacy_billing_voucher`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->ApprovalNumber->DbValue = $row['ApprovalNumber'];
        $this->Cash->DbValue = $row['Cash'];
        $this->Card->DbValue = $row['Card'];
        $this->BillType->DbValue = $row['BillType'];
        $this->PartialSave->DbValue = $row['PartialSave'];
        $this->PatientGST->DbValue = $row['PatientGST'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyBillingVoucherList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PharmacyBillingVoucherEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PharmacyBillingVoucherAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyBillingVoucherView";
            case Config("API_ADD_ACTION"):
                return "PharmacyBillingVoucherAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyBillingVoucherEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyBillingVoucherDelete";
            case Config("API_LIST_ACTION"):
                return "PharmacyBillingVoucherList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyBillingVoucherView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyBillingVoucherView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PharmacyBillingVoucherAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PharmacyBillingVoucherAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyBillingVoucherEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyBillingVoucherEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyBillingVoucherAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyBillingVoucherAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PharmacyBillingVoucherDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->ApprovalNumber->EditValue = $this->ApprovalNumber->CurrentValue;
        ...
        $this->PatientGST->EditValue = $this->PatientGST->CurrentValue;
    ...
    public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ApprovalNumber);
                    $doc->exportCaption($this->Cash);
                    $doc->exportCaption($this->Card);
                    $doc->exportCaption($this->BillType);
                    $doc->exportCaption($this->PartialSave);
                    $doc->exportCaption($this->PatientGST);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->BillNumber);
                    $doc->exportCaption($this->Reception);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ApprovalNumber);
                        $doc->exportField($this->Cash);
                        $doc->exportField($this->Card);
                        $doc->exportField($this->BillType);
                        $doc->exportField($this->PartialSave);
                        $doc->exportField($this->PatientGST);
                    } else {
                        $doc->exportField($this->id);
                        $doc->exportField($this->BillNumber);
                        $doc->exportField($this->Reception);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->CardType, '');
                $doc->exportAggregate($this->DiscountAmount, '');
                $doc->exportAggregate($this->ApprovalNumber, '');
                $doc->exportAggregate($this->Cash, '');
                $doc->exportAggregate($this->Card, '');
                $doc->exportAggregate($this->BillType, '');
                $doc->exportAggregate($this->PartialSave, '');
                $doc->exportAggregate($this->PatientGST, '');
                $doc->endExportRow();
            }
        }
        if (!$doc->ExportCustom) {
    ...
    public function rowInserting($rsold, &$rsnew) {
    	...
    	// To cancel, set return value to FALSE
    			...
    			$rsnew["BillNumber"]  =  $PharID_PreFixCode . 'BN'. getPharIDBillNo($PharID);
    	return TRUE;
    }
