 ...
 * Page class
 */
class PresGenericinteractionsEdit extends PresGenericinteractions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresGenericinteractionsEdit";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Createdtm->EditValue = HtmlEncode(FormatDateTime($this->Createdtm->CurrentValue, 4));
