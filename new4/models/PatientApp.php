 ...
 */
class PatientApp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('patient_app', 'patient_app', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PatientID
        $this->PatientID = new DbField('patient_app', 'patient_app', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // title
        $this->title = new DbField('patient_app', 'patient_app', 'x_title', 'title', '`title`', '`title`', 3, 11, -1, false, '`title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // first_name
        $this->first_name = new DbField('patient_app', 'patient_app', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, 50, -1, false, '`first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // middle_name
        $this->middle_name = new DbField('patient_app', 'patient_app', 'x_middle_name', 'middle_name', '`middle_name`', '`middle_name`', 200, 100, -1, false, '`middle_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // last_name
        $this->last_name = new DbField('patient_app', 'patient_app', 'x_last_name', 'last_name', '`last_name`', '`last_name`', 200, 50, -1, false, '`last_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // gender
        $this->gender = new DbField('patient_app', 'patient_app', 'x_gender', 'gender', '`gender`', '`gender`', 200, 45, -1, false, '`gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->gender->Sortable = true; // Allow sort
        $this->gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->gender->Param, "CustomMsg");
        $this->Fields['gender'] = &$this->gender;

        // dob
        $this->dob = new DbField('patient_app', 'patient_app', 'x_dob', 'dob', '`dob`', CastDateFieldForLike("`dob`", 0, "DB"), 133, 10, 0, false, '`dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Age
        $this->Age = new DbField('patient_app', 'patient_app', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // blood_group
        $this->blood_group = new DbField('patient_app', 'patient_app', 'x_blood_group', 'blood_group', '`blood_group`', '`blood_group`', 200, 45, -1, false, '`blood_group`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mobile_no
        $this->mobile_no = new DbField('patient_app', 'patient_app', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, 45, -1, false, '`mobile_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // description
        $this->description = new DbField('patient_app', 'patient_app', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->description->Sortable = true; // Allow sort
        $this->description->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->description->Param, "CustomMsg");
        $this->Fields['description'] = &$this->description;

        // IdentificationMark
        $this->IdentificationMark = new DbField('patient_app', 'patient_app', 'x_IdentificationMark', 'IdentificationMark', '`IdentificationMark`', '`IdentificationMark`', 200, 45, -1, false, '`IdentificationMark`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Religion
        $this->Religion = new DbField('patient_app', 'patient_app', 'x_Religion', 'Religion', '`Religion`', '`Religion`', 200, 45, -1, false, '`Religion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Nationality
        $this->Nationality = new DbField('patient_app', 'patient_app', 'x_Nationality', 'Nationality', '`Nationality`', '`Nationality`', 200, 45, -1, false, '`Nationality`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profilePic
        $this->profilePic = new DbField('patient_app', 'patient_app', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 200, 100, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // status
        $this->status = new DbField('patient_app', 'patient_app', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('patient_app', 'patient_app', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('patient_app', 'patient_app', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('patient_app', 'patient_app', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('patient_app', 'patient_app', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferedByDr
        $this->ReferedByDr = new DbField('patient_app', 'patient_app', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, 45, -1, false, '`ReferedByDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferClinicname
        $this->ReferClinicname = new DbField('patient_app', 'patient_app', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, 45, -1, false, '`ReferClinicname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferCity
        $this->ReferCity = new DbField('patient_app', 'patient_app', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, 45, -1, false, '`ReferCity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferMobileNo
        $this->ReferMobileNo = new DbField('patient_app', 'patient_app', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, 45, -1, false, '`ReferMobileNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->ReferA4TreatingConsultant = new DbField('patient_app', 'patient_app', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, 45, -1, false, '`ReferA4TreatingConsultant`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurposreReferredfor
        $this->PurposreReferredfor = new DbField('patient_app', 'patient_app', 'x_PurposreReferredfor', 'PurposreReferredfor', '`PurposreReferredfor`', '`PurposreReferredfor`', 200, 45, -1, false, '`PurposreReferredfor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_title
        $this->spouse_title = new DbField('patient_app', 'patient_app', 'x_spouse_title', 'spouse_title', '`spouse_title`', '`spouse_title`', 200, 45, -1, false, '`spouse_title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_first_name
        $this->spouse_first_name = new DbField('patient_app', 'patient_app', 'x_spouse_first_name', 'spouse_first_name', '`spouse_first_name`', '`spouse_first_name`', 200, 45, -1, false, '`spouse_first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_middle_name
        $this->spouse_middle_name = new DbField('patient_app', 'patient_app', 'x_spouse_middle_name', 'spouse_middle_name', '`spouse_middle_name`', '`spouse_middle_name`', 200, 45, -1, false, '`spouse_middle_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_last_name
        $this->spouse_last_name = new DbField('patient_app', 'patient_app', 'x_spouse_last_name', 'spouse_last_name', '`spouse_last_name`', '`spouse_last_name`', 200, 45, -1, false, '`spouse_last_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_gender
        $this->spouse_gender = new DbField('patient_app', 'patient_app', 'x_spouse_gender', 'spouse_gender', '`spouse_gender`', '`spouse_gender`', 200, 45, -1, false, '`spouse_gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_dob
        $this->spouse_dob = new DbField('patient_app', 'patient_app', 'x_spouse_dob', 'spouse_dob', '`spouse_dob`', CastDateFieldForLike("`spouse_dob`", 0, "DB"), 133, 10, 0, false, '`spouse_dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_Age
        $this->spouse_Age = new DbField('patient_app', 'patient_app', 'x_spouse_Age', 'spouse_Age', '`spouse_Age`', '`spouse_Age`', 200, 45, -1, false, '`spouse_Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_blood_group
        $this->spouse_blood_group = new DbField('patient_app', 'patient_app', 'x_spouse_blood_group', 'spouse_blood_group', '`spouse_blood_group`', '`spouse_blood_group`', 200, 45, -1, false, '`spouse_blood_group`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_mobile_no
        $this->spouse_mobile_no = new DbField('patient_app', 'patient_app', 'x_spouse_mobile_no', 'spouse_mobile_no', '`spouse_mobile_no`', '`spouse_mobile_no`', 200, 45, -1, false, '`spouse_mobile_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Maritalstatus
        $this->Maritalstatus = new DbField('patient_app', 'patient_app', 'x_Maritalstatus', 'Maritalstatus', '`Maritalstatus`', '`Maritalstatus`', 200, 45, -1, false, '`Maritalstatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Business
        $this->Business = new DbField('patient_app', 'patient_app', 'x_Business', 'Business', '`Business`', '`Business`', 200, 45, -1, false, '`Business`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Patient_Language
        $this->Patient_Language = new DbField('patient_app', 'patient_app', 'x_Patient_Language', 'Patient_Language', '`Patient_Language`', '`Patient_Language`', 200, 45, -1, false, '`Patient_Language`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Passport
        $this->Passport = new DbField('patient_app', 'patient_app', 'x_Passport', 'Passport', '`Passport`', '`Passport`', 200, 45, -1, false, '`Passport`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VisaNo
        $this->VisaNo = new DbField('patient_app', 'patient_app', 'x_VisaNo', 'VisaNo', '`VisaNo`', '`VisaNo`', 200, 45, -1, false, '`VisaNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ValidityOfVisa
        $this->ValidityOfVisa = new DbField('patient_app', 'patient_app', 'x_ValidityOfVisa', 'ValidityOfVisa', '`ValidityOfVisa`', '`ValidityOfVisa`', 200, 45, -1, false, '`ValidityOfVisa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WhereDidYouHear
        $this->WhereDidYouHear = new DbField('patient_app', 'patient_app', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, 45, -1, false, '`WhereDidYouHear`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('patient_app', 'patient_app', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->HospID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HospID->Param, "CustomMsg");
        $this->Fields['HospID'] = &$this->HospID;

        // street
        $this->street = new DbField('patient_app', 'patient_app', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('patient_app', 'patient_app', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // province
        $this->province = new DbField('patient_app', 'patient_app', 'x_province', 'province', '`province`', '`province`', 200, 50, -1, false, '`province`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // country
        $this->country = new DbField('patient_app', 'patient_app', 'x_country', 'country', '`country`', '`country`', 200, 50, -1, false, '`country`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postal_code
        $this->postal_code = new DbField('patient_app', 'patient_app', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 50, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PEmail
        $this->PEmail = new DbField('patient_app', 'patient_app', 'x_PEmail', 'PEmail', '`PEmail`', '`PEmail`', 200, 50, -1, false, '`PEmail`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PEmergencyContact
        $this->PEmergencyContact = new DbField('patient_app', 'patient_app', 'x_PEmergencyContact', 'PEmergencyContact', '`PEmergencyContact`', '`PEmergencyContact`', 200, 50, -1, false, '`PEmergencyContact`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // occupation
        $this->occupation = new DbField('patient_app', 'patient_app', 'x_occupation', 'occupation', '`occupation`', '`occupation`', 200, 45, -1, false, '`occupation`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_occupation
        $this->spouse_occupation = new DbField('patient_app', 'patient_app', 'x_spouse_occupation', 'spouse_occupation', '`spouse_occupation`', '`spouse_occupation`', 200, 45, -1, false, '`spouse_occupation`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WhatsApp
        $this->WhatsApp = new DbField('patient_app', 'patient_app', 'x_WhatsApp', 'WhatsApp', '`WhatsApp`', '`WhatsApp`', 200, 45, -1, false, '`WhatsApp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CouppleID
        $this->CouppleID = new DbField('patient_app', 'patient_app', 'x_CouppleID', 'CouppleID', '`CouppleID`', '`CouppleID`', 3, 11, -1, false, '`CouppleID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MaleID
        $this->MaleID = new DbField('patient_app', 'patient_app', 'x_MaleID', 'MaleID', '`MaleID`', '`MaleID`', 3, 11, -1, false, '`MaleID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FemaleID
        $this->FemaleID = new DbField('patient_app', 'patient_app', 'x_FemaleID', 'FemaleID', '`FemaleID`', '`FemaleID`', 3, 11, -1, false, '`FemaleID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GroupID
        $this->GroupID = new DbField('patient_app', 'patient_app', 'x_GroupID', 'GroupID', '`GroupID`', '`GroupID`', 3, 11, -1, false, '`GroupID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Relationship
        $this->Relationship = new DbField('patient_app', 'patient_app', 'x_Relationship', 'Relationship', '`Relationship`', '`Relationship`', 200, 45, -1, false, '`Relationship`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PatientAppList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PatientAppEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PatientAppAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "PatientAppAdd";
            case Config("API_EDIT_ACTION"):
                return "PatientAppEdit";
            case Config("API_DELETE_ACTION"):
                return "PatientAppDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PatientAppView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PatientAppView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PatientAppAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PatientAppAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PatientAppEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientAppAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PatientAppDelete", $this->getUrlParm());
    }
