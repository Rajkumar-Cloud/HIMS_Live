 ...
 * Page class
 */
class ViewPharmacyMovementSearch extends ViewPharmacyMovement
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyMovementSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "ViewPharmacyMovementList" . "?" . $srchStr;
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewPharmacyMovementList"), "", $this->TableVar, true);
        $pageId = "search";
