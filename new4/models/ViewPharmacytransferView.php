 ...
 * Page class
 */
class ViewPharmacytransferView extends ViewPharmacytransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacytransferView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewPharmacytransferList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewPharmacytransferList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewPharmacytransferList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
