 ...
 * Page class
 */
class LabDrugMastView extends LabDrugMast
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabDrugMastView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LabDrugMastList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LabDrugMastList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "LabDrugMastList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
