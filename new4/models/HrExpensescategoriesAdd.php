 ...
 * Page class
 */
class HrExpensescategoriesAdd extends HrExpensescategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrExpensescategoriesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("HrExpensescategoriesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "HrExpensescategoriesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "HrExpensescategoriesView") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->pre_approve->Required) {
            if ($this->pre_approve->FormValue == "") {
                $this->pre_approve->addErrorMessage(str_replace("%s", $this->pre_approve->caption(), $this->pre_approve->RequiredErrorMessage));
            }
        }
