 ...
 * Page class
 */
class ViewIvfTreatmentPlanEdit extends ViewIvfTreatmentPlan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIvfTreatmentPlanEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ViewIvfTreatmentPlanList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ViewIvfTreatmentPlanList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // TreatmentStartDate
            $this->TreatmentStartDate->setDbValueDef($rsnew, UnFormatDateTime($this->TreatmentStartDate->CurrentValue, 0), null, $this->TreatmentStartDate->ReadOnly);
            ...
            // TreatementStopDate
            $this->TreatementStopDate->setDbValueDef($rsnew, UnFormatDateTime($this->TreatementStopDate->CurrentValue, 0), null, $this->TreatementStopDate->ReadOnly);
