 ...
 * Page class
 */
class AppointmentSchedulerList extends AppointmentScheduler
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppointmentSchedulerList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "AppointmentSchedulerDelete";
        $this->MultiUpdateUrl = "AppointmentSchedulerUpdate";
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "doctors") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->Table = $doctors;
                    $doctors->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
