...
/**
 * Table class for view_item_received_items
 */
class ViewItemReceivedItems extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_item_received_items';
        $this->TableName = 'view_item_received_items';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_item_received_items`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Received
        $this->Received = new DbField('view_item_received_items', 'view_item_received_items', 'x_Received', 'Received', '`Received`', '`Received`', 200, 45, -1, false, '`Received`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDNO
        $this->ORDNO = new DbField('view_item_received_items', 'view_item_received_items', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, 5, -1, false, '`ORDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ORDNO->Sortable = false; // Allow sort
        $this->ORDNO->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORDNO->Param, "CustomMsg");
        $this->Fields['ORDNO'] = &$this->ORDNO;

        // BRCODE
        $this->BRCODE = new DbField('view_item_received_items', 'view_item_received_items', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PRC
        $this->PRC = new DbField('view_item_received_items', 'view_item_received_items', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('view_item_received_items', 'view_item_received_items', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_item_received_items', 'view_item_received_items', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QTY
        $this->QTY = new DbField('view_item_received_items', 'view_item_received_items', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 3, 11, -1, false, '`QTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('view_item_received_items', 'view_item_received_items', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DT->Sortable = false; // Allow sort
        ...
        // PC
        $this->PC = new DbField('view_item_received_items', 'view_item_received_items', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PC->Sortable = false; // Allow sort
        $this->PC->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PC->Param, "CustomMsg");
        $this->Fields['PC'] = &$this->PC;

        // YM
        $this->YM = new DbField('view_item_received_items', 'view_item_received_items', 'x_YM', 'YM', '`YM`', '`YM`', 200, 6, -1, false, '`YM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->YM->Sortable = false; // Allow sort
        $this->YM->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->YM->Param, "CustomMsg");
        $this->Fields['YM'] = &$this->YM;

        // Stock
        $this->Stock = new DbField('view_item_received_items', 'view_item_received_items', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 3, 11, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LastMonthSale
        $this->LastMonthSale = new DbField('view_item_received_items', 'view_item_received_items', 'x_LastMonthSale', 'LastMonthSale', '`LastMonthSale`', '`LastMonthSale`', 3, 11, -1, false, '`LastMonthSale`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LastMonthSale->Sortable = false; // Allow sort
        ...
        // Printcheck
        $this->Printcheck = new DbField('view_item_received_items', 'view_item_received_items', 'x_Printcheck', 'Printcheck', '`Printcheck`', '`Printcheck`', 200, 50, -1, false, '`Printcheck`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Printcheck->Sortable = false; // Allow sort
        ...
        // id
        $this->id = new DbField('view_item_received_items', 'view_item_received_items', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // poid
        $this->poid = new DbField('view_item_received_items', 'view_item_received_items', 'x_poid', 'poid', '`poid`', '`poid`', 3, 11, -1, false, '`poid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnid
        $this->grnid = new DbField('view_item_received_items', 'view_item_received_items', 'x_grnid', 'grnid', '`grnid`', '`grnid`', 3, 11, -1, false, '`grnid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->grnid->Sortable = false; // Allow sort
        ...
        // BatchNo
        $this->BatchNo = new DbField('view_item_received_items', 'view_item_received_items', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, 45, -1, false, '`BatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillDate
        $this->BillDate = new DbField('view_item_received_items', 'view_item_received_items', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike("`BillDate`", 0, "DB"), 135, 19, 0, false, '`BillDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_item_received_items', 'view_item_received_items', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 0, "DB"), 135, 19, 0, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Quantity
        $this->Quantity = new DbField('view_item_received_items', 'view_item_received_items', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, 11, -1, false, '`Quantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FreeQty
        $this->FreeQty = new DbField('view_item_received_items', 'view_item_received_items', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 3, 11, -1, false, '`FreeQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemValue
        $this->ItemValue = new DbField('view_item_received_items', 'view_item_received_items', 'x_ItemValue', 'ItemValue', '`ItemValue`', '`ItemValue`', 131, 12, -1, false, '`ItemValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ItemValue->Sortable = false; // Allow sort
        ...
        // Disc
        $this->Disc = new DbField('view_item_received_items', 'view_item_received_items', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, 45, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Disc->Sortable = false; // Allow sort
        $this->Disc->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Disc->Param, "CustomMsg");
        $this->Fields['Disc'] = &$this->Disc;

        // PTax
        $this->PTax = new DbField('view_item_received_items', 'view_item_received_items', 'x_PTax', 'PTax', '`PTax`', '`PTax`', 131, 12, -1, false, '`PTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PTax->Sortable = false; // Allow sort
        ...
        // MRP
        $this->MRP = new DbField('view_item_received_items', 'view_item_received_items', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MRP->Sortable = false; // Allow sort
        ...
        // SalTax
        $this->SalTax = new DbField('view_item_received_items', 'view_item_received_items', 'x_SalTax', 'SalTax', '`SalTax`', '`SalTax`', 131, 12, -1, false, '`SalTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SalTax->Sortable = false; // Allow sort
        ...
        // PurValue
        $this->PurValue = new DbField('view_item_received_items', 'view_item_received_items', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('view_item_received_items', 'view_item_received_items', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalRate
        $this->SalRate = new DbField('view_item_received_items', 'view_item_received_items', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, 12, -1, false, '`SalRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SalRate->Sortable = false; // Allow sort
        ...
        // Discount
        $this->Discount = new DbField('view_item_received_items', 'view_item_received_items', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, 12, -1, false, '`Discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_item_received_items', 'view_item_received_items', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_item_received_items', 'view_item_received_items', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_item_received_items', 'view_item_received_items', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_item_received_items', 'view_item_received_items', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HSN
        $this->HSN = new DbField('view_item_received_items', 'view_item_received_items', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, 45, -1, false, '`HSN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HSN->Sortable = false; // Allow sort
        $this->HSN->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HSN->Param, "CustomMsg");
        $this->Fields['HSN'] = &$this->HSN;

        // Pack
        $this->Pack = new DbField('view_item_received_items', 'view_item_received_items', 'x_Pack', 'Pack', '`Pack`', '`Pack`', 200, 45, -1, false, '`Pack`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Pack->Sortable = false; // Allow sort
        $this->Pack->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Pack->Param, "CustomMsg");
        $this->Fields['Pack'] = &$this->Pack;

        // PUnit
        $this->PUnit = new DbField('view_item_received_items', 'view_item_received_items', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('view_item_received_items', 'view_item_received_items', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnQuantity
        $this->GrnQuantity = new DbField('view_item_received_items', 'view_item_received_items', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 3, 11, -1, false, '`GrnQuantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GrnQuantity->Sortable = false; // Allow sort
        ...
        // GrnMRP
        $this->GrnMRP = new DbField('view_item_received_items', 'view_item_received_items', 'x_GrnMRP', 'GrnMRP', '`GrnMRP`', '`GrnMRP`', 131, 12, -1, false, '`GrnMRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GrnMRP->Sortable = false; // Allow sort
        ...
        // trid
        $this->trid = new DbField('view_item_received_items', 'view_item_received_items', 'x_trid', 'trid', '`trid`', '`trid`', 3, 11, -1, false, '`trid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->trid->Sortable = false; // Allow sort
        ...
        // HospID
        $this->HospID = new DbField('view_item_received_items', 'view_item_received_items', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedBy
        $this->CreatedBy = new DbField('view_item_received_items', 'view_item_received_items', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, 11, -1, false, '`CreatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_item_received_items', 'view_item_received_items', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedBy
        $this->ModifiedBy = new DbField('view_item_received_items', 'view_item_received_items', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, 11, -1, false, '`ModifiedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('view_item_received_items', 'view_item_received_items', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedby
        $this->grncreatedby = new DbField('view_item_received_items', 'view_item_received_items', 'x_grncreatedby', 'grncreatedby', '`grncreatedby`', '`grncreatedby`', 3, 11, -1, false, '`grncreatedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->grncreatedby->Sortable = false; // Allow sort
        ...
        // grncreatedDateTime
        $this->grncreatedDateTime = new DbField('view_item_received_items', 'view_item_received_items', 'x_grncreatedDateTime', 'grncreatedDateTime', '`grncreatedDateTime`', CastDateFieldForLike("`grncreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`grncreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->grncreatedDateTime->Sortable = false; // Allow sort
        ...
        // grnModifiedby
        $this->grnModifiedby = new DbField('view_item_received_items', 'view_item_received_items', 'x_grnModifiedby', 'grnModifiedby', '`grnModifiedby`', '`grnModifiedby`', 3, 11, -1, false, '`grnModifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->grnModifiedby->Sortable = false; // Allow sort
        ...
        // grnModifiedDateTime
        $this->grnModifiedDateTime = new DbField('view_item_received_items', 'view_item_received_items', 'x_grnModifiedDateTime', 'grnModifiedDateTime', '`grnModifiedDateTime`', CastDateFieldForLike("`grnModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`grnModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->grnModifiedDateTime->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_item_received_items`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewItemReceivedItemsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewItemReceivedItemsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewItemReceivedItemsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewItemReceivedItemsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewItemReceivedItemsView";
            case Config("API_ADD_ACTION"):
                return "ViewItemReceivedItemsAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewItemReceivedItemsEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewItemReceivedItemsDelete";
            case Config("API_LIST_ACTION"):
                return "ViewItemReceivedItemsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewItemReceivedItemsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewItemReceivedItemsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewItemReceivedItemsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewItemReceivedItemsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewItemReceivedItemsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewItemReceivedItemsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewItemReceivedItemsDelete", $this->getUrlParm());
    }
