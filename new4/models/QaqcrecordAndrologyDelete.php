 ...
 * Page class
 */
class QaqcrecordAndrologyDelete extends QaqcrecordAndrology
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "QaqcrecordAndrologyDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("QaqcrecordAndrologyList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("QaqcrecordAndrologyList"); // Return to list
                return;
            }
        }
