 ...
 * Page class
 */
class ViewStoreTransferPreview extends ViewStoreTransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewStoreTransferPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "store_billing_transfer") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=store_billing_transfer&" . GetForeignKeyUrl("fk_id", $this->strid->QueryStringValue) . "";
        }
        return $url;
    }
