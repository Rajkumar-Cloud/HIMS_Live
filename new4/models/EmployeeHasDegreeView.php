 ...
 * Page class
 */
class EmployeeHasDegreeView extends EmployeeHasDegree
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeHasDegreeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmployeeHasDegreeList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EmployeeHasDegreeList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "EmployeeHasDegreeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
