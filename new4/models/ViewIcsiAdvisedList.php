 ...
 * Page class
 */
class ViewIcsiAdvisedList extends ViewIcsiAdvised
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIcsiAdvisedList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewIcsiAdvisedAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewIcsiAdvisedDelete";
        $this->MultiUpdateUrl = "ViewIcsiAdvisedUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_icsi_advised"));
                $doc->Text = @$content;
