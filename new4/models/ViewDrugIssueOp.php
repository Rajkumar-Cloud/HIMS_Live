...
/**
 * Table class for view_drug_issue_op
 */
class ViewDrugIssueOp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_drug_issue_op';
        $this->TableName = 'view_drug_issue_op';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_drug_issue_op`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // voucher_type
        $this->voucher_type = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Doctor
        $this->Doctor = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, 45, -1, false, '`Doctor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientId
        $this->PatientId = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientName
        $this->PatientName = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Product
        $this->Product = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_Product', 'Product', '`Product`', '`Product`', 200, 100, -1, false, '`Product`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 12, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Mfg
        $this->Mfg = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, 45, -1, false, '`Mfg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCHNO
        $this->BATCHNO = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, 10, -1, false, '`BATCHNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_EXPDT', 'EXPDT', '`EXPDT`', '`EXPDT`', 200, 7, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_drug_issue_op', 'view_drug_issue_op', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_drug_issue_op`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDrugIssueOpList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDrugIssueOpView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDrugIssueOpEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDrugIssueOpAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDrugIssueOpView";
            case Config("API_ADD_ACTION"):
                return "ViewDrugIssueOpAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDrugIssueOpEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDrugIssueOpDelete";
            case Config("API_LIST_ACTION"):
                return "ViewDrugIssueOpList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDrugIssueOpView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDrugIssueOpView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDrugIssueOpAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDrugIssueOpAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDrugIssueOpEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDrugIssueOpAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDrugIssueOpDelete", $this->getUrlParm());
    }
