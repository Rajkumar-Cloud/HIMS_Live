 ...
 * Page class
 */
class ViewAppointmentSchedulerNewAdd extends ViewAppointmentSchedulerNew
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAppointmentSchedulerNewAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ViewAppointmentSchedulerNewView") {
