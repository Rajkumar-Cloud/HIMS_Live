 ...
 * Page class
 */
class MasEmployeeRoleJobDescriptionAdd extends MasEmployeeRoleJobDescription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasEmployeeRoleJobDescriptionAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("MasEmployeeRoleJobDescriptionList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MasEmployeeRoleJobDescriptionList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MasEmployeeRoleJobDescriptionView") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->job_description->Required) {
            if (!$this->job_description->IsDetailKey && EmptyValue($this->job_description->FormValue)) {
                $this->job_description->addErrorMessage(str_replace("%s", $this->job_description->caption(), $this->job_description->RequiredErrorMessage));
            }
        }
