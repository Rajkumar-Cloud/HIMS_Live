 ...
 */
class ViewPatientDischargeSummary extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientID
        $this->PatientID = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientID->Sortable = true; // Allow sort
        $this->PatientID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientID->Param, "CustomMsg");
        $this->Fields['PatientID'] = &$this->PatientID;

        // patient_name
        $this->patient_name = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_patient_name', 'patient_name', '`patient_name`', '`patient_name`', 200, 45, -1, false, '`patient_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profilePic
        $this->profilePic = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // gender
        $this->gender = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_gender', 'gender', '`gender`', '`gender`', 200, 45, -1, false, '`gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->gender->Sortable = true; // Allow sort
        $this->gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->gender->Param, "CustomMsg");
        $this->Fields['gender'] = &$this->gender;

        // age
        $this->age = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_age', 'age', '`age`', '`age`', 200, 45, -1, false, '`age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->age->Sortable = false; // Allow sort
        $this->age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->age->Param, "CustomMsg");
        $this->Fields['age'] = &$this->age;

        // physician_id
        $this->physician_id = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, 11, -1, false, '`physician_id`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // typeRegsisteration
        $this->typeRegsisteration = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_typeRegsisteration', 'typeRegsisteration', '`typeRegsisteration`', '`typeRegsisteration`', 200, 45, -1, false, '`typeRegsisteration`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentCategory
        $this->PaymentCategory = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, 45, -1, false, '`PaymentCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->admission_consultant_id = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_admission_consultant_id', 'admission_consultant_id', '`admission_consultant_id`', '`admission_consultant_id`', 3, 11, -1, false, '`admission_consultant_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->leading_consultant_id = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_leading_consultant_id', 'leading_consultant_id', '`leading_consultant_id`', '`leading_consultant_id`', 3, 11, -1, false, '`leading_consultant_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cause
        $this->cause = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_cause', 'cause', '`cause`', '`cause`', 201, 65535, -1, false, '`cause`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // admission_date
        $this->admission_date = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike("`admission_date`", 7, "DB"), 135, 19, 7, false, '`admission_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // release_date
        $this->release_date = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike("`release_date`", 7, "DB"), 135, 19, 7, false, '`release_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentStatus
        $this->PaymentStatus = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, 11, -1, false, '`PaymentStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->HospID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HospID->Param, "CustomMsg");
        $this->Fields['HospID'] = &$this->HospID;

        // status
        $this->status = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mrnNo
        $this->mrnNo = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_mrnNo', 'mrnNo', '`mrnNo`', '`mrnNo`', 200, 45, -1, false, '`mrnNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->provisional_diagnosis = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_provisional_diagnosis', 'provisional_diagnosis', '`provisional_diagnosis`', '`provisional_diagnosis`', 201, -1, -1, false, '`provisional_diagnosis`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Treatments
        $this->Treatments = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_Treatments', 'Treatments', '`Treatments`', '`Treatments`', 201, -1, -1, false, '`Treatments`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // FinalDiagnosis
        $this->FinalDiagnosis = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_FinalDiagnosis', 'FinalDiagnosis', '`FinalDiagnosis`', '`FinalDiagnosis`', 201, -1, -1, false, '`FinalDiagnosis`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // BP
        $this->BP = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_BP', 'BP', '`BP`', '`BP`', 200, 45, -1, false, '`BP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pulse
        $this->Pulse = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_Pulse', 'Pulse', '`Pulse`', '`Pulse`', 200, 45, -1, false, '`Pulse`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Resp
        $this->Resp = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_Resp', 'Resp', '`Resp`', '`Resp`', 200, 45, -1, false, '`Resp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPO2
        $this->SPO2 = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_SPO2', 'SPO2', '`SPO2`', '`SPO2`', 200, 45, -1, false, '`SPO2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FollowupAdvice
        $this->FollowupAdvice = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_FollowupAdvice', 'FollowupAdvice', '`FollowupAdvice`', '`FollowupAdvice`', 201, -1, -1, false, '`FollowupAdvice`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // NextReviewDate
        $this->NextReviewDate = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_NextReviewDate', 'NextReviewDate', '`NextReviewDate`', CastDateFieldForLike("`NextReviewDate`", 14, "DB"), 135, 19, 14, false, '`NextReviewDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // History
        $this->History = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_History', 'History', '`History`', '`History`', 201, 65535, -1, false, '`History`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // patient_id
        $this->patient_id = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, 11, -1, false, '`patient_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // vitals
        $this->vitals = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_vitals', 'vitals', '`vitals`', '`vitals`', 201, 65535, -1, false, '`vitals`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // courseinhospital
        $this->courseinhospital = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_courseinhospital', 'courseinhospital', '`courseinhospital`', '`courseinhospital`', 201, -1, -1, false, '`courseinhospital`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // procedurenotes
        $this->procedurenotes = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_procedurenotes', 'procedurenotes', '`procedurenotes`', '`procedurenotes`', 201, -1, -1, false, '`procedurenotes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        $this->conditionatdischarge = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_conditionatdischarge', 'conditionatdischarge', '`conditionatdischarge`', '`conditionatdischarge`', 201, -1, -1, false, '`conditionatdischarge`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        $this->AdviceToOtherHospital = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_AdviceToOtherHospital', 'AdviceToOtherHospital', '`AdviceToOtherHospital`', '`AdviceToOtherHospital`', 200, 45, -1, false, '`AdviceToOtherHospital`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferedByDr
        $this->ReferedByDr = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, 45, -1, false, '`ReferedByDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DischargeAdviceMedicine = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_DischargeAdviceMedicine', 'DischargeAdviceMedicine', '`DischargeAdviceMedicine`', '`DischargeAdviceMedicine`', 201, -1, -1, false, '`DischargeAdviceMedicine`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // vid
        $this->vid = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_vid', 'vid', '`vid`', '`vid`', 3, 11, -1, false, '`vid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPatientDischargeSummaryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPatientDischargeSummaryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPatientDischargeSummaryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPatientDischargeSummaryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPatientDischargeSummaryView";
            case Config("API_ADD_ACTION"):
                return "ViewPatientDischargeSummaryAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPatientDischargeSummaryEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPatientDischargeSummaryDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPatientDischargeSummaryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPatientDischargeSummaryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPatientDischargeSummaryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPatientDischargeSummaryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPatientDischargeSummaryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientDischargeSummaryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPatientDischargeSummaryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPatientDischargeSummaryDelete", $this->getUrlParm());
    }
