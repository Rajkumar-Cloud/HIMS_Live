...
class LabProfileMaster extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ProfileName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ProfileName->Param, "CustomMsg");
        ...
        $this->ProfileAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ProfileAmount->Param, "CustomMsg");
        ...
        $this->ProfileSpecialAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ProfileSpecialAmount->Param, "CustomMsg");
        ...
        $this->ProfileMasterInactive->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ProfileMasterInactive->Param, "CustomMsg");
        ...
        $this->EditUser->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->EditUser->Param, "CustomMsg");
        ...
        $this->IInsAmt->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->IInsAmt->Param, "CustomMsg");
        ...
        $this->IIpAmt->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->IIpAmt->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LabProfileMasterList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LabProfileMasterView";
            case Config("API_ADD_ACTION"):
                return "LabProfileMasterAdd";
            case Config("API_EDIT_ACTION"):
                return "LabProfileMasterEdit";
            case Config("API_DELETE_ACTION"):
                return "LabProfileMasterDelete";
