 ...
 * Page class
 */
class ViewIvfOocytedenudationEmbryologyChartDelete extends ViewIvfOocytedenudationEmbryologyChart
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIvfOocytedenudationEmbryologyChartDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewIvfOocytedenudationEmbryologyChartList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewIvfOocytedenudationEmbryologyChartList"); // Return to list
                return;
            }
        }
