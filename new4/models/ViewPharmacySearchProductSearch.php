 ...
 * Page class
 */
class ViewPharmacySearchProductSearch extends ViewPharmacySearchProduct
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacySearchProductSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "ViewPharmacySearchProductList" . "?" . $srchStr;
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewPharmacySearchProductList"), "", $this->TableVar, true);
        $pageId = "search";
