 ...
 */
class ViewPharmacySearchProductSearch2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_search_product_search2';
        ...
        // id
        $this->id = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DES
        $this->DES = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_DES', 'DES', '`DES`', '`DES`', 200, 100, -1, false, '`DES`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH
        $this->BATCH = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_BATCH', 'BATCH', '`BATCH`', '`BATCH`', 200, 10, -1, false, '`BATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 16, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENNAME
        $this->GENNAME = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, 150, -1, false, '`GENNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNIT
        $this->UNIT = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, 45, -1, false, '`UNIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDATE
        $this->BILLDATE = new DbField('view_pharmacy_search_product_search2', 'view_pharmacy_search_product_search', 'x_BILLDATE', 'BILLDATE', '`BILLDATE`', CastDateFieldForLike("`BILLDATE`", 0, "DB"), 135, 19, 0, false, '`BILLDATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacySearchProductSearch2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacySearchProductSearch2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacySearchProductSearch2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacySearchProductSearch2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacySearchProductSearch2View";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacySearchProductSearch2Add";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacySearchProductSearch2Edit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacySearchProductSearch2Delete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacySearchProductSearch2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacySearchProductSearch2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacySearchProductSearch2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacySearchProductSearch2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacySearchProductSearch2Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacySearchProductSearch2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacySearchProductSearch2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacySearchProductSearch2Delete", $this->getUrlParm());
    }
