 ...
 * Page class
 */
class IvfMasUserTemplateEdit extends IvfMasUserTemplate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfMasUserTemplateEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("IvfMasUserTemplateList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "IvfMasUserTemplateList") {
