...
class ReceptionList extends Reception
{
    ...
    // Page object name
    public $PageObjName = "ReceptionList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ReceptionAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ReceptionDelete";
        $this->MultiUpdateUrl = "ReceptionUpdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->MODEOFPAYMENT->AdvancedSearch->toJson(), ","); // Field MODE OF PAYMENT
        $filterList = Concat($filterList, $this->NEXTREVIEWDATE->AdvancedSearch->toJson(), ","); // Field NEXT REVIEW DATE
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->MODEOFPAYMENT); // MODE OF PAYMENT
            $this->updateSort($this->NEXTREVIEWDATE); // NEXT REVIEW DATE
