 ...
 * Page class
 */
class PharmacyPaymentDelete extends PharmacyPayment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPaymentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyPaymentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyPaymentList"); // Return to list
                return;
            }
        }
