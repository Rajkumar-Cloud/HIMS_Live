 ...
 * Page class
 */
class ViewBillingVoucherVoucherList extends ViewBillingVoucherVoucher
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBillingVoucherVoucherList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewBillingVoucherVoucherAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewBillingVoucherVoucherDelete";
        $this->MultiUpdateUrl = "ViewBillingVoucherVoucherUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_billing_voucher_voucher"));
                $doc->Text = @$content;
