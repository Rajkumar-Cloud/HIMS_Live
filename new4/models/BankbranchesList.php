 ...
 * Page class
 */
class BankbranchesList extends Bankbranches
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BankbranchesList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "BankbranchesAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "BankbranchesDelete";
        $this->MultiUpdateUrl = "BankbranchesUpdate";
