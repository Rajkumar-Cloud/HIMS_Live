 ...
 * Page class
 */
class EmployeeAttendanceDelete extends EmployeeAttendance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeAttendanceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeAttendanceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeAttendanceList"); // Return to list
                return;
            }
        }
