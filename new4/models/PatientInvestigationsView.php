 ...
 * Page class
 */
class PatientInvestigationsView extends PatientInvestigations
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientInvestigationsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientInvestigationsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientInvestigationsList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientInvestigationsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
