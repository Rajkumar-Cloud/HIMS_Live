 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestItemsApprovedPreview extends ViewPharmacyPurchaseRequestItemsApproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestItemsApprovedPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_pharmacy_purchase_request_approved") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_pharmacy_purchase_request_approved&" . GetForeignKeyUrl("fk_id", $this->prid->QueryStringValue) . "";
        }
        return $url;
    }
