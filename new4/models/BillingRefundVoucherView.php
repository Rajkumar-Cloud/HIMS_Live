 ...
 * Page class
 */
class BillingRefundVoucherView extends BillingRefundVoucher
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BillingRefundVoucherView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BillingRefundVoucherList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BillingRefundVoucherList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "BillingRefundVoucherList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
