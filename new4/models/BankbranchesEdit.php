 ...
 * Page class
 */
class BankbranchesEdit extends Bankbranches
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BankbranchesEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("BankbranchesList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "BankbranchesList") {
