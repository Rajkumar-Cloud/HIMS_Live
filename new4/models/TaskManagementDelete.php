 ...
 * Page class
 */
class TaskManagementDelete extends TaskManagement
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaskManagementDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TaskManagementList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TaskManagementList"); // Return to list
                return;
            }
        }
