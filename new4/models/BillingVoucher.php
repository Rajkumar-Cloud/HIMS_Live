 ...
 */
class BillingVoucher extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('billing_voucher', 'billing_voucher', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PatId
        $this->PatId = new DbField('billing_voucher', 'billing_voucher', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Reception
        $this->Reception = new DbField('billing_voucher', 'billing_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'IMAGE', 'SELECT');
        ...
        // BillNumber
        $this->BillNumber = new DbField('billing_voucher', 'billing_voucher', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, 45, -1, false, '`BillNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientId
        $this->PatientId = new DbField('billing_voucher', 'billing_voucher', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'IMAGE', 'TEXT');
        ...
        // mrnno
        $this->mrnno = new DbField('billing_voucher', 'billing_voucher', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // PatientName
        $this->PatientName = new DbField('billing_voucher', 'billing_voucher', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('billing_voucher', 'billing_voucher', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('billing_voucher', 'billing_voucher', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // profilePic
        $this->profilePic = new DbField('billing_voucher', 'billing_voucher', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->profilePic->Sortable = true; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // Mobile
        $this->Mobile = new DbField('billing_voucher', 'billing_voucher', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 45, -1, false, '`Mobile`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile->Sortable = true; // Allow sort
        $this->Mobile->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile->Param, "CustomMsg");
        $this->Fields['Mobile'] = &$this->Mobile;

        // IP_OP
        $this->IP_OP = new DbField('billing_voucher', 'billing_voucher', 'x_IP_OP', 'IP_OP', '`IP_OP`', '`IP_OP`', 200, 45, -1, false, '`IP_OP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Doctor
        $this->Doctor = new DbField('billing_voucher', 'billing_voucher', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, 45, -1, false, '`Doctor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // voucher_type
        $this->voucher_type = new DbField('billing_voucher', 'billing_voucher', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Details
        $this->Details = new DbField('billing_voucher', 'billing_voucher', 'x_Details', 'Details', '`Details`', '`Details`', 200, 45, -1, false, '`Details`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('billing_voucher', 'billing_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Amount
        $this->Amount = new DbField('billing_voucher', 'billing_voucher', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, 10, -1, false, '`Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnyDues
        $this->AnyDues = new DbField('billing_voucher', 'billing_voucher', 'x_AnyDues', 'AnyDues', '`AnyDues`', '`AnyDues`', 200, 45, -1, false, '`AnyDues`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('billing_voucher', 'billing_voucher', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('billing_voucher', 'billing_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 11, "DB"), 135, 19, 11, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('billing_voucher', 'billing_voucher', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('billing_voucher', 'billing_voucher', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationAmount
        $this->RealizationAmount = new DbField('billing_voucher', 'billing_voucher', 'x_RealizationAmount', 'RealizationAmount', '`RealizationAmount`', '`RealizationAmount`', 131, 10, -1, false, '`RealizationAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationStatus
        $this->RealizationStatus = new DbField('billing_voucher', 'billing_voucher', 'x_RealizationStatus', 'RealizationStatus', '`RealizationStatus`', '`RealizationStatus`', 200, 45, -1, false, '`RealizationStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationRemarks
        $this->RealizationRemarks = new DbField('billing_voucher', 'billing_voucher', 'x_RealizationRemarks', 'RealizationRemarks', '`RealizationRemarks`', '`RealizationRemarks`', 200, 45, -1, false, '`RealizationRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationBatchNo
        $this->RealizationBatchNo = new DbField('billing_voucher', 'billing_voucher', 'x_RealizationBatchNo', 'RealizationBatchNo', '`RealizationBatchNo`', '`RealizationBatchNo`', 200, 45, -1, false, '`RealizationBatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationDate
        $this->RealizationDate = new DbField('billing_voucher', 'billing_voucher', 'x_RealizationDate', 'RealizationDate', '`RealizationDate`', '`RealizationDate`', 200, 45, -1, false, '`RealizationDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('billing_voucher', 'billing_voucher', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->HospID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HospID->Param, "CustomMsg");
        $this->Fields['HospID'] = &$this->HospID;

        // RIDNO
        $this->RIDNO = new DbField('billing_voucher', 'billing_voucher', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TidNo
        $this->TidNo = new DbField('billing_voucher', 'billing_voucher', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('billing_voucher', 'billing_voucher', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PartnerName
        $this->PartnerName = new DbField('billing_voucher', 'billing_voucher', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, 45, -1, false, '`PartnerName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PayerType
        $this->PayerType = new DbField('billing_voucher', 'billing_voucher', 'x_PayerType', 'PayerType', '`PayerType`', '`PayerType`', 200, 45, -1, false, '`PayerType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Dob
        $this->Dob = new DbField('billing_voucher', 'billing_voucher', 'x_Dob', 'Dob', '`Dob`', '`Dob`', 200, 45, -1, false, '`Dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Currency
        $this->Currency = new DbField('billing_voucher', 'billing_voucher', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, 45, -1, false, '`Currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('billing_voucher', 'billing_voucher', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 201, 450, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('billing_voucher', 'billing_voucher', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 65535, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Remarks->Sortable = true; // Allow sort
        $this->Remarks->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Remarks->Param, "CustomMsg");
        $this->Fields['Remarks'] = &$this->Remarks;

        // DrDepartment
        $this->DrDepartment = new DbField('billing_voucher', 'billing_voucher', 'x_DrDepartment', 'DrDepartment', '`DrDepartment`', '`DrDepartment`', 200, 45, -1, false, '`DrDepartment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefferedBy
        $this->RefferedBy = new DbField('billing_voucher', 'billing_voucher', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, 45, -1, false, '`RefferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardNumber
        $this->CardNumber = new DbField('billing_voucher', 'billing_voucher', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, 45, -1, false, '`CardNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BankName
        $this->BankName = new DbField('billing_voucher', 'billing_voucher', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, 45, -1, false, '`BankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('billing_voucher', 'billing_voucher', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillStatus
        $this->BillStatus = new DbField('billing_voucher', 'billing_voucher', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, 11, -1, false, '`BillStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('billing_voucher', 'billing_voucher', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserName
        $this->_UserName = new DbField('billing_voucher', 'billing_voucher', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AdjustmentAdvance
        $this->AdjustmentAdvance = new DbField('billing_voucher', 'billing_voucher', 'x_AdjustmentAdvance', 'AdjustmentAdvance', '`AdjustmentAdvance`', '`AdjustmentAdvance`', 200, 45, -1, false, '`AdjustmentAdvance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // billing_vouchercol
        $this->billing_vouchercol = new DbField('billing_voucher', 'billing_voucher', 'x_billing_vouchercol', 'billing_vouchercol', '`billing_vouchercol`', '`billing_vouchercol`', 200, 45, -1, false, '`billing_vouchercol`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillType
        $this->BillType = new DbField('billing_voucher', 'billing_voucher', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, 45, -1, false, '`BillType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ProcedureName
        $this->ProcedureName = new DbField('billing_voucher', 'billing_voucher', 'x_ProcedureName', 'ProcedureName', '`ProcedureName`', '`ProcedureName`', 200, 45, -1, false, '`ProcedureName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ProcedureAmount
        $this->ProcedureAmount = new DbField('billing_voucher', 'billing_voucher', 'x_ProcedureAmount', 'ProcedureAmount', '`ProcedureAmount`', '`ProcedureAmount`', 131, 12, -1, false, '`ProcedureAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IncludePackage
        $this->IncludePackage = new DbField('billing_voucher', 'billing_voucher', 'x_IncludePackage', 'IncludePackage', '`IncludePackage`', '`IncludePackage`', 200, 45, -1, false, '`IncludePackage`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelBill
        $this->CancelBill = new DbField('billing_voucher', 'billing_voucher', 'x_CancelBill', 'CancelBill', '`CancelBill`', '`CancelBill`', 200, 45, -1, false, '`CancelBill`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelReason
        $this->CancelReason = new DbField('billing_voucher', 'billing_voucher', 'x_CancelReason', 'CancelReason', '`CancelReason`', '`CancelReason`', 201, 500, -1, false, '`CancelReason`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelModeOfPayment
        $this->CancelModeOfPayment = new DbField('billing_voucher', 'billing_voucher', 'x_CancelModeOfPayment', 'CancelModeOfPayment', '`CancelModeOfPayment`', '`CancelModeOfPayment`', 200, 45, -1, false, '`CancelModeOfPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelAmount
        $this->CancelAmount = new DbField('billing_voucher', 'billing_voucher', 'x_CancelAmount', 'CancelAmount', '`CancelAmount`', '`CancelAmount`', 200, 45, -1, false, '`CancelAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelBankName
        $this->CancelBankName = new DbField('billing_voucher', 'billing_voucher', 'x_CancelBankName', 'CancelBankName', '`CancelBankName`', '`CancelBankName`', 200, 45, -1, false, '`CancelBankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->CancelTransactionNumber = new DbField('billing_voucher', 'billing_voucher', 'x_CancelTransactionNumber', 'CancelTransactionNumber', '`CancelTransactionNumber`', '`CancelTransactionNumber`', 200, 45, -1, false, '`CancelTransactionNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LabTest
        $this->LabTest = new DbField('billing_voucher', 'billing_voucher', 'x_LabTest', 'LabTest', '`LabTest`', '`LabTest`', 200, 45, -1, false, '`LabTest`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sid
        $this->sid = new DbField('billing_voucher', 'billing_voucher', 'x_sid', 'sid', '`sid`', '`sid`', 3, 11, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SidNo
        $this->SidNo = new DbField('billing_voucher', 'billing_voucher', 'x_SidNo', 'SidNo', '`SidNo`', '`SidNo`', 200, 45, -1, false, '`SidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdDatettime
        $this->createdDatettime = new DbField('billing_voucher', 'billing_voucher', 'x_createdDatettime', 'createdDatettime', '`createdDatettime`', CastDateFieldForLike("`createdDatettime`", 0, "DB"), 135, 19, 0, false, '`createdDatettime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LabTestReleased
        $this->LabTestReleased = new DbField('billing_voucher', 'billing_voucher', 'x_LabTestReleased', 'LabTestReleased', '`LabTestReleased`', '`LabTestReleased`', 200, 45, -1, false, '`LabTestReleased`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GoogleReviewID
        $this->GoogleReviewID = new DbField('billing_voucher', 'billing_voucher', 'x_GoogleReviewID', 'GoogleReviewID', '`GoogleReviewID`', '`GoogleReviewID`', 200, 45, -1, false, '`GoogleReviewID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardType
        $this->CardType = new DbField('billing_voucher', 'billing_voucher', 'x_CardType', 'CardType', '`CardType`', '`CardType`', 200, 45, -1, false, '`CardType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PharmacyBill
        $this->PharmacyBill = new DbField('billing_voucher', 'billing_voucher', 'x_PharmacyBill', 'PharmacyBill', '`PharmacyBill`', '`PharmacyBill`', 200, 45, -1, false, '`PharmacyBill`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountAmount
        $this->DiscountAmount = new DbField('billing_voucher', 'billing_voucher', 'x_DiscountAmount', 'DiscountAmount', '`DiscountAmount`', '`DiscountAmount`', 131, 10, -1, false, '`DiscountAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cash
        $this->Cash = new DbField('billing_voucher', 'billing_voucher', 'x_Cash', 'Cash', '`Cash`', '`Cash`', 131, 10, -1, false, '`Cash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Card
        $this->Card = new DbField('billing_voucher', 'billing_voucher', 'x_Card', 'Card', '`Card`', '`Card`', 131, 10, -1, false, '`Card`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "patient_services") {
            $detailUrl = Container("patient_services")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "BillingVoucherList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BillingVoucherList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "BillingVoucherEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BillingVoucherAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BillingVoucherView";
            case Config("API_ADD_ACTION"):
                return "BillingVoucherAdd";
            case Config("API_EDIT_ACTION"):
                return "BillingVoucherEdit";
            case Config("API_DELETE_ACTION"):
                return "BillingVoucherDelete";
            case Config("API_LIST_ACTION"):
                return "BillingVoucherList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BillingVoucherView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BillingVoucherView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BillingVoucherAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BillingVoucherAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BillingVoucherEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BillingVoucherEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BillingVoucherAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BillingVoucherAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BillingVoucherDelete", $this->getUrlParm());
    }
