 ...
 * Page class
 */
class HrCoursesDelete extends HrCourses
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrCoursesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HrCoursesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HrCoursesList"); // Return to list
                return;
            }
        }
