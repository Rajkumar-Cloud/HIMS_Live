 ...
 * Page class
 */
class ViewBillingVoucherPrintView extends ViewBillingVoucherPrint
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBillingVoucherPrintView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewBillingVoucherPrintList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewBillingVoucherPrintList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewBillingVoucherPrintList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ViewPatientServicesList?" . Config("TABLE_SHOW_MASTER") . "=view_billing_voucher_print&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
