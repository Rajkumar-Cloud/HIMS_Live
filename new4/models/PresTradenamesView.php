 ...
 * Page class
 */
class PresTradenamesView extends PresTradenames
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresTradenamesView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PresTradenamesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PresTradenamesList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PresTradenamesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
