...
class IvfOvumPickUpChart extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->TotalDoseOfStimulation->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TotalDoseOfStimulation->Param, "CustomMsg");
        $this->Fields['TotalDoseOfStimulation'] = &$this->TotalDoseOfStimulation;

        // Protocol
        $this->Protocol = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_Protocol', 'Protocol', '`Protocol`', '`Protocol`', 200, 45, -1, false, '`Protocol`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->NumberOfDaysOfStimulation->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NumberOfDaysOfStimulation->Param, "CustomMsg");
        ...
        $this->TriggerDateTime->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TriggerDateTime->Param, "CustomMsg");
        ...
        $this->OPUDateTime->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OPUDateTime->Param, "CustomMsg");
        ...
        $this->HoursAfterTrigger->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->HoursAfterTrigger->Param, "CustomMsg");
        ...
        $this->SerumE2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SerumE2->Param, "CustomMsg");
        ...
        $this->ExperctedOocytes->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ExperctedOocytes->Param, "CustomMsg");
        ...
        $this->NoOfOocytesRetrieved->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NoOfOocytesRetrieved->Param, "CustomMsg");
        ...
        $this->OocytesRetreivalRate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocytesRetreivalRate->Param, "CustomMsg");
        ...
        $this->Anesthesia->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Anesthesia->Param, "CustomMsg");
        ...
        $this->UCL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->UCL->Param, "CustomMsg");
        ...
        $this->Angle->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Angle->Param, "CustomMsg");
        ...
        $this->EMS->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->EMS->Param, "CustomMsg");
        $this->Fields['EMS'] = &$this->EMS;

        // Cannulation
        $this->Cannulation = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_Cannulation', 'Cannulation', '`Cannulation`', '`Cannulation`', 200, 45, -1, false, '`Cannulation`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->ProcedureT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ProcedureT->Param, "CustomMsg");
        ...
        $this->NoOfOocytesRetrievedd->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NoOfOocytesRetrievedd->Param, "CustomMsg");
        ...
        $this->DischargeAdvise->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DischargeAdvise->Param, "CustomMsg");
        ...
        $this->FollowUpAdvise->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->FollowUpAdvise->Param, "CustomMsg");
        $this->Fields['FollowUpAdvise'] = &$this->FollowUpAdvise;

        // PlanT
        $this->PlanT = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_PlanT', 'PlanT', '`PlanT`', '`PlanT`', 200, 45, -1, false, '`PlanT`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->PlanT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PlanT->Param, "CustomMsg");
        ...
        // TemplateProcedure
        $this->TemplateProcedure = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_TemplateProcedure', 'TemplateProcedure', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->TemplateProcedure->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TemplateProcedure->Param, "CustomMsg");
        $this->Fields['TemplateProcedure'] = &$this->TemplateProcedure;

        // TemplateCourseInHospital
        $this->TemplateCourseInHospital = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_TemplateCourseInHospital', 'TemplateCourseInHospital', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->TemplateCourseInHospital->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TemplateCourseInHospital->Param, "CustomMsg");
        $this->Fields['TemplateCourseInHospital'] = &$this->TemplateCourseInHospital;

        // TemplateDischargeAdvise
        $this->TemplateDischargeAdvise = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_TemplateDischargeAdvise', 'TemplateDischargeAdvise', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->TemplateDischargeAdvise->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TemplateDischargeAdvise->Param, "CustomMsg");
        $this->Fields['TemplateDischargeAdvise'] = &$this->TemplateDischargeAdvise;

        // TemplateFollowUpAdvise
        $this->TemplateFollowUpAdvise = new DbField('ivf_ovum_pick_up_chart', 'ivf_ovum_pick_up_chart', 'x_TemplateFollowUpAdvise', 'TemplateFollowUpAdvise', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->TemplateFollowUpAdvise->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TemplateFollowUpAdvise->Param, "CustomMsg");
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `TemplateProcedure`, '' AS `TemplateCourseInHospital`, '' AS `TemplateDischargeAdvise`, '' AS `TemplateFollowUpAdvise`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IvfOvumPickUpChartList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IvfOvumPickUpChartView";
            case Config("API_ADD_ACTION"):
                return "IvfOvumPickUpChartAdd";
            case Config("API_EDIT_ACTION"):
                return "IvfOvumPickUpChartEdit";
            case Config("API_DELETE_ACTION"):
                return "IvfOvumPickUpChartDelete";
