 ...
 * Page class
 */
class HrClientsEdit extends HrClients
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrClientsEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // first_contact_date
            $this->first_contact_date->setDbValueDef($rsnew, UnFormatDateTime($this->first_contact_date->CurrentValue, 0), null, $this->first_contact_date->ReadOnly);
            ...
            // contact_number
            $this->contact_number->setDbValueDef($rsnew, $this->contact_number->CurrentValue, null, $this->contact_number->ReadOnly);

            // contact_email
            $this->contact_email->setDbValueDef($rsnew, $this->contact_email->CurrentValue, null, $this->contact_email->ReadOnly);

            // company_url
            $this->company_url->setDbValueDef($rsnew, $this->company_url->CurrentValue, null, $this->company_url->ReadOnly);
