...
class ViewDashboardCollectionDetailsList extends ViewDashboardCollectionDetails
{
    ...
    protected function setupSearchOptions()
    {
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"ViewDashboardCollectionDetailsSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_dashboard_collection_details\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'ViewDashboardCollectionDetailsSearch'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_summary_modeofpayment_details") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    ...
                    $view_dashboard_summary_modeofpayment_details->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_summary_payment_mode") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    ...
                    $view_dashboard_summary_payment_mode->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
                $doc->setStyle($exportStyle); // Restore
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "view_dashboard_summary_modeofpayment_details") {
                ...
                if (($parm = Get("fk_ModeofPayment", Get("ModeofPayment"))) !== null) {
                    $masterTbl->ModeofPayment->setQueryStringValue($parm);
                    $this->ModeofPayment->setQueryStringValue($masterTbl->ModeofPayment->QueryStringValue);
            ...
            if ($masterTblVar == "view_dashboard_summary_modeofpayment_details") {
                ...
                if (($parm = Post("fk_ModeofPayment", Post("ModeofPayment"))) !== null) {
                    $masterTbl->ModeofPayment->setFormValue($parm);
                    $this->ModeofPayment->setFormValue($masterTbl->ModeofPayment->FormValue);
