 ...
 */
class ViewAppointment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // App
        $this->_App = new DbField('view_appointment', 'view_appointment', 'x__App', 'App', '`App`', '`App`', 200, 7, -1, false, '`App`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_App->Nullable = false; // NOT NULL field
        $this->_App->Required = true; // Required field
        $this->_App->Sortable = true; // Allow sort
        $this->_App->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_App->Param, "CustomMsg");
        $this->Fields['App'] = &$this->_App;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewAppointmentList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewAppointmentView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewAppointmentEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewAppointmentAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewAppointmentView";
            case Config("API_ADD_ACTION"):
                return "ViewAppointmentAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewAppointmentEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewAppointmentDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewAppointmentView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewAppointmentView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewAppointmentAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewAppointmentAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAppointmentEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewAppointmentAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewAppointmentDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // App
        $this->_App->EditAttrs["class"] = "form-control";
        $this->_App->EditCustomAttributes = "";
        if (!$this->_App->Raw) {
            $this->_App->CurrentValue = HtmlDecode($this->_App->CurrentValue);
        }
        $this->_App->EditValue = $this->_App->CurrentValue;
        $this->_App->PlaceHolder = RemoveHtml($this->_App->caption());
