 ...
 * Page class
 */
class EmployeeSalaryAdd extends EmployeeSalary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeSalaryAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmployeeSalaryList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmployeeSalaryList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmployeeSalaryView") {
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->component->FormValue)) {
            $this->component->addErrorMessage($this->component->getErrorMessage(false));
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmployeeSalaryList"), "", $this->TableVar, true);
