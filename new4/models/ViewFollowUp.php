 ...
 */
class ViewFollowUp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewFollowUpList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewFollowUpView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewFollowUpEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewFollowUpAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewFollowUpView";
            case Config("API_ADD_ACTION"):
                return "ViewFollowUpAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewFollowUpEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewFollowUpDelete";
            case Config("API_LIST_ACTION"):
                return "ViewFollowUpList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewFollowUpView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewFollowUpView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewFollowUpAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewFollowUpAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewFollowUpEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFollowUpAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewFollowUpDelete", $this->getUrlParm());
    }
