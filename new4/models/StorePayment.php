 ...
 */
class StorePayment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('store_payment', 'store_payment', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PAYNO
        $this->PAYNO = new DbField('store_payment', 'store_payment', 'x_PAYNO', 'PAYNO', '`PAYNO`', '`PAYNO`', 200, 45, -1, false, '`PAYNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('store_payment', 'store_payment', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 7, "DB"), 135, 19, 7, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YM
        $this->YM = new DbField('store_payment', 'store_payment', 'x_YM', 'YM', '`YM`', '`YM`', 200, 45, -1, false, '`YM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('store_payment', 'store_payment', 'x_PC', 'PC', '`PC`', '`PC`', 200, 45, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Customercode
        $this->Customercode = new DbField('store_payment', 'store_payment', 'x_Customercode', 'Customercode', '`Customercode`', '`Customercode`', 200, 45, -1, false, '`Customercode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Customername
        $this->Customername = new DbField('store_payment', 'store_payment', 'x_Customername', 'Customername', '`Customername`', '`Customername`', 200, 45, -1, false, '`Customername`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // pharmacy_pocol
        $this->pharmacy_pocol = new DbField('store_payment', 'store_payment', 'x_pharmacy_pocol', 'pharmacy_pocol', '`pharmacy_pocol`', '`pharmacy_pocol`', 200, 45, -1, false, '`pharmacy_pocol`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Address1
        $this->Address1 = new DbField('store_payment', 'store_payment', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 201, 405, -1, false, '`Address1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address2
        $this->Address2 = new DbField('store_payment', 'store_payment', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 201, 405, -1, false, '`Address2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address3
        $this->Address3 = new DbField('store_payment', 'store_payment', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 201, 405, -1, false, '`Address3`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // State
        $this->State = new DbField('store_payment', 'store_payment', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pincode
        $this->Pincode = new DbField('store_payment', 'store_payment', 'x_Pincode', 'Pincode', '`Pincode`', '`Pincode`', 200, 45, -1, false, '`Pincode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Phone
        $this->Phone = new DbField('store_payment', 'store_payment', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, 45, -1, false, '`Phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Phone->Sortable = true; // Allow sort
        $this->Phone->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Phone->Param, "CustomMsg");
        $this->Fields['Phone'] = &$this->Phone;

        // Fax
        $this->Fax = new DbField('store_payment', 'store_payment', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, 45, -1, false, '`Fax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EEmail
        $this->EEmail = new DbField('store_payment', 'store_payment', 'x_EEmail', 'EEmail', '`EEmail`', '`EEmail`', 200, 45, -1, false, '`EEmail`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('store_payment', 'store_payment', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('store_payment', 'store_payment', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('store_payment', 'store_payment', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('store_payment', 'store_payment', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('store_payment', 'store_payment', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PharmacyID
        $this->PharmacyID = new DbField('store_payment', 'store_payment', 'x_PharmacyID', 'PharmacyID', '`PharmacyID`', '`PharmacyID`', 3, 11, -1, false, '`PharmacyID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillTotalValue
        $this->BillTotalValue = new DbField('store_payment', 'store_payment', 'x_BillTotalValue', 'BillTotalValue', '`BillTotalValue`', '`BillTotalValue`', 131, 10, -1, false, '`BillTotalValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GRNTotalValue
        $this->GRNTotalValue = new DbField('store_payment', 'store_payment', 'x_GRNTotalValue', 'GRNTotalValue', '`GRNTotalValue`', '`GRNTotalValue`', 131, 10, -1, false, '`GRNTotalValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillDiscount
        $this->BillDiscount = new DbField('store_payment', 'store_payment', 'x_BillDiscount', 'BillDiscount', '`BillDiscount`', '`BillDiscount`', 131, 10, -1, false, '`BillDiscount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillUpload
        $this->BillUpload = new DbField('store_payment', 'store_payment', 'x_BillUpload', 'BillUpload', '`BillUpload`', '`BillUpload`', 201, 450, -1, false, '`BillUpload`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // TransPort
        $this->TransPort = new DbField('store_payment', 'store_payment', 'x_TransPort', 'TransPort', '`TransPort`', '`TransPort`', 131, 10, -1, false, '`TransPort`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnyOther
        $this->AnyOther = new DbField('store_payment', 'store_payment', 'x_AnyOther', 'AnyOther', '`AnyOther`', '`AnyOther`', 131, 10, -1, false, '`AnyOther`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // voucher_type
        $this->voucher_type = new DbField('store_payment', 'store_payment', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Details
        $this->Details = new DbField('store_payment', 'store_payment', 'x_Details', 'Details', '`Details`', '`Details`', 200, 45, -1, false, '`Details`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('store_payment', 'store_payment', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Amount
        $this->Amount = new DbField('store_payment', 'store_payment', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, 10, -1, false, '`Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BankName
        $this->BankName = new DbField('store_payment', 'store_payment', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, 45, -1, false, '`BankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AccountNumber
        $this->AccountNumber = new DbField('store_payment', 'store_payment', 'x_AccountNumber', 'AccountNumber', '`AccountNumber`', '`AccountNumber`', 200, 45, -1, false, '`AccountNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // chequeNumber
        $this->chequeNumber = new DbField('store_payment', 'store_payment', 'x_chequeNumber', 'chequeNumber', '`chequeNumber`', '`chequeNumber`', 200, 45, -1, false, '`chequeNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('store_payment', 'store_payment', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 405, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Remarks->Sortable = true; // Allow sort
        $this->Remarks->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Remarks->Param, "CustomMsg");
        $this->Fields['Remarks'] = &$this->Remarks;

        // SeectPaymentMode
        $this->SeectPaymentMode = new DbField('store_payment', 'store_payment', 'x_SeectPaymentMode', 'SeectPaymentMode', '`SeectPaymentMode`', '`SeectPaymentMode`', 200, 45, -1, false, '`SeectPaymentMode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaidAmount
        $this->PaidAmount = new DbField('store_payment', 'store_payment', 'x_PaidAmount', 'PaidAmount', '`PaidAmount`', '`PaidAmount`', 200, 45, -1, false, '`PaidAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Currency
        $this->Currency = new DbField('store_payment', 'store_payment', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, 45, -1, false, '`Currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardNumber
        $this->CardNumber = new DbField('store_payment', 'store_payment', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, 45, -1, false, '`CardNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BranchID
        $this->BranchID = new DbField('store_payment', 'store_payment', 'x_BranchID', 'BranchID', '`BranchID`', '`BranchID`', 3, 11, -1, false, '`BranchID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StoreID
        $this->StoreID = new DbField('store_payment', 'store_payment', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, 11, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "store_grn") {
            $detailUrl = Container("store_grn")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "StorePaymentList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StorePaymentList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "StorePaymentEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "StorePaymentAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StorePaymentView";
            case Config("API_ADD_ACTION"):
                return "StorePaymentAdd";
            case Config("API_EDIT_ACTION"):
                return "StorePaymentEdit";
            case Config("API_DELETE_ACTION"):
                return "StorePaymentDelete";
            case Config("API_LIST_ACTION"):
                return "StorePaymentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StorePaymentView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StorePaymentView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "StorePaymentAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "StorePaymentAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StorePaymentEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StorePaymentEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StorePaymentAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StorePaymentAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("StorePaymentDelete", $this->getUrlParm());
    }
