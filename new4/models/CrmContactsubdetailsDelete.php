 ...
 * Page class
 */
class CrmContactsubdetailsDelete extends CrmContactsubdetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CrmContactsubdetailsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CrmContactsubdetailsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CrmContactsubdetailsList"); // Return to list
                return;
            }
        }
