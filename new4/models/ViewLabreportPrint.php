 ...
 */
class ViewLabreportPrint extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('view_labreport_print', 'view_labreport_print', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PatID
        $this->PatID = new DbField('view_labreport_print', 'view_labreport_print', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientName
        $this->PatientName = new DbField('view_labreport_print', 'view_labreport_print', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('view_labreport_print', 'view_labreport_print', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('view_labreport_print', 'view_labreport_print', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // sid
        $this->sid = new DbField('view_labreport_print', 'view_labreport_print', 'x_sid', 'sid', '`sid`', '`sid`', 3, 11, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemCode
        $this->ItemCode = new DbField('view_labreport_print', 'view_labreport_print', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, 45, -1, false, '`ItemCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DEptCd
        $this->DEptCd = new DbField('view_labreport_print', 'view_labreport_print', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, 45, -1, false, '`DEptCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Resulted
        $this->Resulted = new DbField('view_labreport_print', 'view_labreport_print', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, 45, -1, false, '`Resulted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Services
        $this->Services = new DbField('view_labreport_print', 'view_labreport_print', 'x_Services', 'Services', '`Services`', '`Services`', 200, 50, -1, false, '`Services`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LabReport
        $this->LabReport = new DbField('view_labreport_print', 'view_labreport_print', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, 65535, -1, false, '`LabReport`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Pic1
        $this->Pic1 = new DbField('view_labreport_print', 'view_labreport_print', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, 45, -1, false, '`Pic1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic2
        $this->Pic2 = new DbField('view_labreport_print', 'view_labreport_print', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, 45, -1, false, '`Pic2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestUnit
        $this->TestUnit = new DbField('view_labreport_print', 'view_labreport_print', 'x_TestUnit', 'TestUnit', '`TestUnit`', '`TestUnit`', 200, 45, -1, false, '`TestUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefValue
        $this->RefValue = new DbField('view_labreport_print', 'view_labreport_print', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, 65535, -1, false, '`RefValue`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Order
        $this->Order = new DbField('view_labreport_print', 'view_labreport_print', 'x_Order', 'Order', '`Order`', '`Order`', 131, 10, -1, false, '`Order`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Repeated
        $this->Repeated = new DbField('view_labreport_print', 'view_labreport_print', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, 45, -1, false, '`Repeated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Vid
        $this->Vid = new DbField('view_labreport_print', 'view_labreport_print', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, 11, -1, false, '`Vid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // invoiceId
        $this->invoiceId = new DbField('view_labreport_print', 'view_labreport_print', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, 11, -1, false, '`invoiceId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_labreport_print', 'view_labreport_print', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrCODE
        $this->DrCODE = new DbField('view_labreport_print', 'view_labreport_print', 'x_DrCODE', 'DrCODE', '`DrCODE`', '`DrCODE`', 200, 45, -1, false, '`DrCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrName
        $this->DrName = new DbField('view_labreport_print', 'view_labreport_print', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, 45, -1, false, '`DrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Department
        $this->Department = new DbField('view_labreport_print', 'view_labreport_print', 'x_Department', 'Department', '`Department`', '`Department`', 200, 45, -1, false, '`Department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_labreport_print', 'view_labreport_print', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('view_labreport_print', 'view_labreport_print', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestType
        $this->TestType = new DbField('view_labreport_print', 'view_labreport_print', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, 45, -1, false, '`TestType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultDate
        $this->ResultDate = new DbField('view_labreport_print', 'view_labreport_print', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike("`ResultDate`", 0, "DB"), 135, 19, 0, false, '`ResultDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultedBy
        $this->ResultedBy = new DbField('view_labreport_print', 'view_labreport_print', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, 45, -1, false, '`ResultedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Printed
        $this->Printed = new DbField('view_labreport_print', 'view_labreport_print', 'x_Printed', 'Printed', '`Printed`', '`Printed`', 200, 45, -1, false, '`Printed`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrintBy
        $this->PrintBy = new DbField('view_labreport_print', 'view_labreport_print', 'x_PrintBy', 'PrintBy', '`PrintBy`', '`PrintBy`', 200, 45, -1, false, '`PrintBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrintDate
        $this->PrintDate = new DbField('view_labreport_print', 'view_labreport_print', 'x_PrintDate', 'PrintDate', '`PrintDate`', CastDateFieldForLike("`PrintDate`", 0, "DB"), 135, 19, 0, false, '`PrintDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "ViewLabreportPrintList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewLabreportPrintList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewLabreportPrintView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewLabreportPrintEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewLabreportPrintAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewLabreportPrintView";
            case Config("API_ADD_ACTION"):
                return "ViewLabreportPrintAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewLabreportPrintEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewLabreportPrintDelete";
            case Config("API_LIST_ACTION"):
                return "ViewLabreportPrintList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabreportPrintView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabreportPrintView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewLabreportPrintAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewLabreportPrintAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabreportPrintEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabreportPrintEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabreportPrintAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabreportPrintAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewLabreportPrintDelete", $this->getUrlParm());
    }
