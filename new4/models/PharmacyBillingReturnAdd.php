 ...
 * Page class
 */
class PharmacyBillingReturnAdd extends PharmacyBillingReturn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingReturnAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PharmacyBillingReturnView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_pharmacy_pharled_return", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("ViewPharmacyPharledReturnGrid");
            if (in_array("view_pharmacy_pharled_return", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->sretid->setSessionValue($this->id->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->sretid->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
