 ...
 * Page class
 */
class ViewDoctorNotesList extends ViewDoctorNotes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDoctorNotesList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewDoctorNotesAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewDoctorNotesDelete";
        $this->MultiUpdateUrl = "ViewDoctorNotesUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_doctor_notes"));
                $doc->Text = @$content;
