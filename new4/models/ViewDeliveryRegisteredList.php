 ...
 * Page class
 */
class ViewDeliveryRegisteredList extends ViewDeliveryRegistered
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDeliveryRegisteredList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewDeliveryRegisteredAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewDeliveryRegisteredDelete";
        $this->MultiUpdateUrl = "ViewDeliveryRegisteredUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_delivery_registered"));
                $doc->Text = @$content;
