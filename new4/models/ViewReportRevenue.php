...
/**
 * Table class for view_report_revenue
 */
class ViewReportRevenue extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_report_revenue';
        $this->TableName = 'view_report_revenue';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_report_revenue`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Date
        $this->Date = new DbField('view_report_revenue', 'view_report_revenue', 'x_Date', 'Date', '`Date`', CastDateFieldForLike("`Date`", 7, "DB"), 133, 10, 7, false, '`Date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillType
        $this->BillType = new DbField('view_report_revenue', 'view_report_revenue', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, 45, -1, false, '`BillType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TotalAmount
        $this->TotalAmount = new DbField('view_report_revenue', 'view_report_revenue', 'x_TotalAmount', 'TotalAmount', '`TotalAmount`', '`TotalAmount`', 131, 32, -1, false, '`TotalAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_report_revenue', 'view_report_revenue', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_report_revenue`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewReportRevenueList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewReportRevenueView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewReportRevenueEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewReportRevenueAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewReportRevenueView";
            case Config("API_ADD_ACTION"):
                return "ViewReportRevenueAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewReportRevenueEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewReportRevenueDelete";
            case Config("API_LIST_ACTION"):
                return "ViewReportRevenueList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewReportRevenueView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewReportRevenueView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewReportRevenueAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewReportRevenueAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewReportRevenueEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewReportRevenueAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewReportRevenueDelete", $this->getUrlParm());
    }
