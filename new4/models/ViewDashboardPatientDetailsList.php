 ...
 * Page class
 */
class ViewDashboardPatientDetailsList extends ViewDashboardPatientDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardPatientDetailsList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewDashboardPatientDetailsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewDashboardPatientDetailsDelete";
        $this->MultiUpdateUrl = "ViewDashboardPatientDetailsUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_dashboard_patient_details"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_patient_summary") {
            $masterTbl = Container("view_dashboard_patient_summary");
            $rsmaster = $masterTbl->loadRs($this->DbMasterFilter)->fetch(\PDO::FETCH_ASSOC);
            $this->MasterRecordExists = $rsmaster !== false;
            if (!$this->MasterRecordExists) {
                $this->setFailureMessage($Language->phrase("NoRecord")); // Set no record found
                $this->terminate("ViewDashboardPatientSummaryList"); // Return to master page
                return;
            } else {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_patient_summary") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    ...
                    $view_dashboard_patient_summary->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "view_dashboard_patient_summary") {
                ...
                if (($parm = Get("fk_WhereDidYouHear", Get("WhereDidYouHear"))) !== null) {
                    $masterTbl->WhereDidYouHear->setQueryStringValue($parm);
                    $this->WhereDidYouHear->setQueryStringValue($masterTbl->WhereDidYouHear->QueryStringValue);
            ...
            if ($masterTblVar == "view_dashboard_patient_summary") {
                ...
                if (($parm = Post("fk_WhereDidYouHear", Post("WhereDidYouHear"))) !== null) {
                    $masterTbl->WhereDidYouHear->setFormValue($parm);
                    $this->WhereDidYouHear->setFormValue($masterTbl->WhereDidYouHear->FormValue);
