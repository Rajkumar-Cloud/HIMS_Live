 ...
 * Page class
 */
class EmployeeOvertimeDelete extends EmployeeOvertime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeOvertimeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeOvertimeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeOvertimeList"); // Return to list
                return;
            }
        }
