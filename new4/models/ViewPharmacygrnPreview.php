 ...
 * Page class
 */
class ViewPharmacygrnPreview extends ViewPharmacygrn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacygrnPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_grn") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_grn&" . GetForeignKeyUrl("fk_id", $this->grnid->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "pharmacy_grn") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->grnid->setQueryStringValue($val);
            }
        }
    }
