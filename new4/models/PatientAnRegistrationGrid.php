 ...
 * Page class
 */
class PatientAnRegistrationGrid extends PatientAnRegistration
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAnRegistrationGrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PatientAnRegistrationAdd";
    ...
    public function run()
    {
        ...
        if ($this->CurrentMode != "add" && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "patient_opd_follow_up") {
            ...
            if (!$this->MasterRecordExists) {
                ...
                $this->terminate("PatientOpdFollowUpList"); // Return to master page
                return;
            } else {
    ...
    public function resetFormError()
    {
        ...
        $this->fid->clearErrorMessage();
        $this->G->clearErrorMessage();
        $this->P->clearErrorMessage();
        $this->L->clearErrorMessage();
        $this->A->clearErrorMessage();
        $this->E->clearErrorMessage();
        $this->M->clearErrorMessage();
        $this->LMP->clearErrorMessage();
        $this->EDO->clearErrorMessage();
        $this->MenstrualHistory->clearErrorMessage();
        $this->MaritalHistory->clearErrorMessage();
        $this->ObstetricHistory->clearErrorMessage();
        $this->PreviousHistoryofGDM->clearErrorMessage();
        $this->PreviousHistorofPIH->clearErrorMessage();
        $this->PreviousHistoryofIUGR->clearErrorMessage();
        $this->PreviousHistoryofOligohydramnios->clearErrorMessage();
        $this->PreviousHistoryofPreterm->clearErrorMessage();
        $this->G1->clearErrorMessage();
        $this->G2->clearErrorMessage();
        $this->G3->clearErrorMessage();
        $this->DeliveryNDLSCS1->clearErrorMessage();
        $this->DeliveryNDLSCS2->clearErrorMessage();
        $this->DeliveryNDLSCS3->clearErrorMessage();
        $this->BabySexweight1->clearErrorMessage();
        $this->BabySexweight2->clearErrorMessage();
        $this->BabySexweight3->clearErrorMessage();
        $this->PastMedicalHistory->clearErrorMessage();
        $this->PastSurgicalHistory->clearErrorMessage();
        $this->FamilyHistory->clearErrorMessage();
        $this->Viability->clearErrorMessage();
        $this->ViabilityDATE->clearErrorMessage();
        $this->ViabilityREPORT->clearErrorMessage();
        $this->Viability2->clearErrorMessage();
        $this->Viability2DATE->clearErrorMessage();
        $this->Viability2REPORT->clearErrorMessage();
        $this->NTscan->clearErrorMessage();
        $this->NTscanDATE->clearErrorMessage();
        $this->NTscanREPORT->clearErrorMessage();
        $this->EarlyTarget->clearErrorMessage();
        $this->EarlyTargetDATE->clearErrorMessage();
        $this->EarlyTargetREPORT->clearErrorMessage();
        $this->Anomaly->clearErrorMessage();
        $this->AnomalyDATE->clearErrorMessage();
        $this->AnomalyREPORT->clearErrorMessage();
        $this->Growth->clearErrorMessage();
        $this->GrowthDATE->clearErrorMessage();
        $this->GrowthREPORT->clearErrorMessage();
        $this->Growth1->clearErrorMessage();
        $this->Growth1DATE->clearErrorMessage();
        $this->Growth1REPORT->clearErrorMessage();
        $this->ANProfile->clearErrorMessage();
        $this->ANProfileDATE->clearErrorMessage();
        $this->ANProfileINHOUSE->clearErrorMessage();
        $this->ANProfileREPORT->clearErrorMessage();
        $this->DualMarker->clearErrorMessage();
        $this->DualMarkerDATE->clearErrorMessage();
        $this->DualMarkerINHOUSE->clearErrorMessage();
        $this->DualMarkerREPORT->clearErrorMessage();
        $this->Quadruple->clearErrorMessage();
        $this->QuadrupleDATE->clearErrorMessage();
        $this->QuadrupleINHOUSE->clearErrorMessage();
        $this->QuadrupleREPORT->clearErrorMessage();
        $this->A5month->clearErrorMessage();
        $this->A5monthDATE->clearErrorMessage();
        $this->A5monthINHOUSE->clearErrorMessage();
        $this->A5monthREPORT->clearErrorMessage();
        $this->A7month->clearErrorMessage();
        $this->A7monthDATE->clearErrorMessage();
        $this->A7monthINHOUSE->clearErrorMessage();
        $this->A7monthREPORT->clearErrorMessage();
        $this->A9month->clearErrorMessage();
        $this->A9monthDATE->clearErrorMessage();
        $this->A9monthINHOUSE->clearErrorMessage();
        $this->A9monthREPORT->clearErrorMessage();
        $this->INJ->clearErrorMessage();
        $this->INJDATE->clearErrorMessage();
        $this->INJINHOUSE->clearErrorMessage();
        $this->INJREPORT->clearErrorMessage();
        $this->Bleeding->clearErrorMessage();
        $this->Hypothyroidism->clearErrorMessage();
        $this->PICMENumber->clearErrorMessage();
        $this->Outcome->clearErrorMessage();
        $this->DateofAdmission->clearErrorMessage();
        $this->DateodProcedure->clearErrorMessage();
        $this->Miscarriage->clearErrorMessage();
        $this->ModeOfDelivery->clearErrorMessage();
        $this->ND->clearErrorMessage();
        $this->NDS->clearErrorMessage();
        $this->NDP->clearErrorMessage();
        $this->Vaccum->clearErrorMessage();
        $this->VaccumS->clearErrorMessage();
        $this->VaccumP->clearErrorMessage();
        $this->Forceps->clearErrorMessage();
        $this->ForcepsS->clearErrorMessage();
        $this->ForcepsP->clearErrorMessage();
        $this->Elective->clearErrorMessage();
        $this->ElectiveS->clearErrorMessage();
        $this->ElectiveP->clearErrorMessage();
        $this->Emergency->clearErrorMessage();
        $this->EmergencyS->clearErrorMessage();
        $this->EmergencyP->clearErrorMessage();
        $this->Maturity->clearErrorMessage();
        $this->Baby1->clearErrorMessage();
        $this->Baby2->clearErrorMessage();
        $this->sex1->clearErrorMessage();
        $this->sex2->clearErrorMessage();
        $this->weight1->clearErrorMessage();
        $this->weight2->clearErrorMessage();
        $this->NICU1->clearErrorMessage();
        $this->NICU2->clearErrorMessage();
        $this->Jaundice1->clearErrorMessage();
        $this->Jaundice2->clearErrorMessage();
        $this->Others1->clearErrorMessage();
        $this->Others2->clearErrorMessage();
        $this->SpillOverReasons->clearErrorMessage();
        $this->ANClosed->clearErrorMessage();
        $this->ANClosedDATE->clearErrorMessage();
        $this->PastMedicalHistoryOthers->clearErrorMessage();
        $this->PastSurgicalHistoryOthers->clearErrorMessage();
        $this->FamilyHistoryOthers->clearErrorMessage();
        $this->PresentPregnancyComplicationsOthers->clearErrorMessage();
