 ...
 * Page class
 */
class PharmacyPurchaseRequestDelete extends PharmacyPurchaseRequest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPurchaseRequestDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyPurchaseRequestList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyPurchaseRequestList"); // Return to list
                return;
            }
        }
