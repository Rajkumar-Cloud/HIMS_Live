 ...
 * Page class
 */
class ViewLabServicesList extends ViewLabServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabServicesList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewLabServicesAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewLabServicesDelete";
        $this->MultiUpdateUrl = "ViewLabServicesUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_lab_services"));
                $doc->Text = @$content;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_lab_resultreleased')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewLabResultreleasedList?" . Config("TABLE_SHOW_MASTER") . "=view_lab_services&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ViewLabResultreleasedGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_lab_services')) {
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["view_lab_resultreleased"] && $this->DetailPages["view_lab_resultreleased"]->Visible) {
            ...
            $url = "ViewLabResultreleasedPreview?t=view_lab_services&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_lab_services')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewLabResultreleasedList?" . Config("TABLE_SHOW_MASTER") . "=view_lab_services&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
            ...
            $detailPageObj = Container("ViewLabResultreleasedGrid");
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_lab_services')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=view_lab_resultreleased");
    ...
    protected function setupSearchOptions()
    {
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"ViewLabServicesSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_lab_services\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'ViewLabServicesSearch'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
