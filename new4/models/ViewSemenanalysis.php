...
class ViewSemenanalysis extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // RIDNo
        $this->RIDNo = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, 11, -1, false, '`RIDNo`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // HusbandName
        $this->HusbandName = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_HusbandName', 'HusbandName', '`HusbandName`', '`HusbandName`', 200, 45, -1, false, '`HusbandName`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CollectionDate
        $this->CollectionDate = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_CollectionDate', 'CollectionDate', '`CollectionDate`', CastDateFieldForLike("`CollectionDate`", 7, "DB"), 135, 19, 7, false, '`CollectionDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultDate
        $this->ResultDate = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike("`ResultDate`", 7, "DB"), 135, 19, 7, false, '`ResultDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RequestSample
        $this->RequestSample = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_RequestSample', 'RequestSample', '`RequestSample`', '`RequestSample`', 200, 45, -1, false, '`RequestSample`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CollectionType
        $this->CollectionType = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_CollectionType', 'CollectionType', '`CollectionType`', '`CollectionType`', 200, 45, -1, false, '`CollectionType`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CollectionMethod
        $this->CollectionMethod = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_CollectionMethod', 'CollectionMethod', '`CollectionMethod`', '`CollectionMethod`', 200, 45, -1, false, '`CollectionMethod`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Medicationused
        $this->Medicationused = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_Medicationused', 'Medicationused', '`Medicationused`', '`Medicationused`', 200, 45, -1, false, '`Medicationused`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->DifficultiesinCollection = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_DifficultiesinCollection', 'DifficultiesinCollection', '`DifficultiesinCollection`', '`DifficultiesinCollection`', 200, 45, -1, false, '`DifficultiesinCollection`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Homogenosity
        $this->Homogenosity = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_Homogenosity', 'Homogenosity', '`Homogenosity`', '`Homogenosity`', 200, 45, -1, false, '`Homogenosity`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CompleteSample
        $this->CompleteSample = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_CompleteSample', 'CompleteSample', '`CompleteSample`', '`CompleteSample`', 200, 45, -1, false, '`CompleteSample`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Diagnosis
        $this->Diagnosis = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_Diagnosis', 'Diagnosis', '`Diagnosis`', '`Diagnosis`', 201, 65535, -1, false, '`Diagnosis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Observations
        $this->Observations = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_Observations', 'Observations', '`Observations`', '`Observations`', 201, 65535, -1, false, '`Observations`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SemenOrgin
        $this->SemenOrgin = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_SemenOrgin', 'SemenOrgin', '`SemenOrgin`', '`SemenOrgin`', 200, 45, -1, false, '`SemenOrgin`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Donor
        $this->Donor = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_Donor', 'Donor', '`Donor`', '`Donor`', 3, 11, -1, false, '`Donor`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // MACS
        $this->MACS = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, 45, -1, false, '`MACS`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // PREG_TEST_DATE
        $this->PREG_TEST_DATE = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_PREG_TEST_DATE', 'PREG_TEST_DATE', '`PREG_TEST_DATE`', CastDateFieldForLike("`PREG_TEST_DATE`", 7, "DB"), 135, 19, 7, false, '`PREG_TEST_DATE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPECIFIC_PROBLEMS
        $this->SPECIFIC_PROBLEMS = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_SPECIFIC_PROBLEMS', 'SPECIFIC_PROBLEMS', '`SPECIFIC_PROBLEMS`', '`SPECIFIC_PROBLEMS`', 200, 45, -1, false, '`SPECIFIC_PROBLEMS`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->LIQUIFACTION_STORAGE = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_LIQUIFACTION_STORAGE', 'LIQUIFACTION_STORAGE', '`LIQUIFACTION_STORAGE`', '`LIQUIFACTION_STORAGE`', 200, 45, -1, false, '`LIQUIFACTION_STORAGE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // IUI_PREP_METHOD
        $this->IUI_PREP_METHOD = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_IUI_PREP_METHOD', 'IUI_PREP_METHOD', '`IUI_PREP_METHOD`', '`IUI_PREP_METHOD`', 200, 45, -1, false, '`IUI_PREP_METHOD`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TIME_FROM_TRIGGER
        $this->TIME_FROM_TRIGGER = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_TIME_FROM_TRIGGER', 'TIME_FROM_TRIGGER', '`TIME_FROM_TRIGGER`', '`TIME_FROM_TRIGGER`', 200, 45, -1, false, '`TIME_FROM_TRIGGER`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->COLLECTION_TO_PREPARATION = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_COLLECTION_TO_PREPARATION', 'COLLECTION_TO_PREPARATION', '`COLLECTION_TO_PREPARATION`', '`COLLECTION_TO_PREPARATION`', 200, 45, -1, false, '`COLLECTION_TO_PREPARATION`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->TIME_FROM_PREP_TO_INSEM = new DbField('view_semenanalysis', 'view_semenanalysis', 'x_TIME_FROM_PREP_TO_INSEM', 'TIME_FROM_PREP_TO_INSEM', '`TIME_FROM_PREP_TO_INSEM`', '`TIME_FROM_PREP_TO_INSEM`', 200, 45, -1, false, '`TIME_FROM_PREP_TO_INSEM`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewSemenanalysisList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewSemenanalysisView";
            case Config("API_ADD_ACTION"):
                return "ViewSemenanalysisAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewSemenanalysisEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewSemenanalysisDelete";
