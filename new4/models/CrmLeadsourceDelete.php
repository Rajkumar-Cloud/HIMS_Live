 ...
 * Page class
 */
class CrmLeadsourceDelete extends CrmLeadsource
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CrmLeadsourceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CrmLeadsourceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CrmLeadsourceList"); // Return to list
                return;
            }
        }
