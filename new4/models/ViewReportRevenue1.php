...
/**
 * Table class for view_report_revenue1
 */
class ViewReportRevenue1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_report_revenue1';
        $this->TableName = 'view_report_revenue1';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_report_revenue1`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Date
        $this->Date = new DbField('view_report_revenue1', 'view_report_revenue1', 'x_Date', 'Date', '`Date`', CastDateFieldForLike("`Date`", 7, "DB"), 133, 10, 7, false, '`Date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillType
        $this->BillType = new DbField('view_report_revenue1', 'view_report_revenue1', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, 45, -1, false, '`BillType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TotalAmount
        $this->TotalAmount = new DbField('view_report_revenue1', 'view_report_revenue1', 'x_TotalAmount', 'TotalAmount', '`TotalAmount`', '`TotalAmount`', 131, 32, -1, false, '`TotalAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_report_revenue1', 'view_report_revenue1', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_report_revenue1`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewReportRevenue1List");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewReportRevenue1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewReportRevenue1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewReportRevenue1Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewReportRevenue1View";
            case Config("API_ADD_ACTION"):
                return "ViewReportRevenue1Add";
            case Config("API_EDIT_ACTION"):
                return "ViewReportRevenue1Edit";
            case Config("API_DELETE_ACTION"):
                return "ViewReportRevenue1Delete";
            case Config("API_LIST_ACTION"):
                return "ViewReportRevenue1List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewReportRevenue1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewReportRevenue1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewReportRevenue1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewReportRevenue1Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewReportRevenue1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewReportRevenue1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewReportRevenue1Delete", $this->getUrlParm());
    }
