 ...
 * Page class
 */
class ViewTillSearchList extends ViewTillSearch
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewTillSearchList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewTillSearchAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewTillSearchDelete";
        $this->MultiUpdateUrl = "ViewTillSearchUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_till_search"));
                $doc->Text = @$content;
