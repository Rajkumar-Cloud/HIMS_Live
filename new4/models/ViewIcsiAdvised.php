...
/**
 * Table class for view_icsi_advised
 */
class ViewIcsiAdvised extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_icsi_advised';
        $this->TableName = 'view_icsi_advised';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_icsi_advised`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // first_name
        $this->first_name = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_first_name', 'first_name', '`first_name`', '`first_name`', 200, 50, -1, false, '`first_name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientID
        $this->PatientID = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mobile_no
        $this->mobile_no = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_mobile_no', 'mobile_no', '`mobile_no`', '`mobile_no`', 200, 45, -1, false, '`mobile_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // street
        $this->street = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ICSIAdvised
        $this->ICSIAdvised = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_ICSIAdvised', 'ICSIAdvised', '`ICSIAdvised`', '`ICSIAdvised`', 200, 45, -1, false, '`ICSIAdvised`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->ICSIAdvised->Sortable = true; // Allow sort
        $this->ICSIAdvised->Lookup = new Lookup('ICSIAdvised', 'view_icsi_advised', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // ICSIDate
        $this->ICSIDate = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_ICSIDate', 'ICSIDate', '`ICSIDate`', CastDateFieldForLike("`ICSIDate`", 7, "DB"), 135, 19, 7, false, '`ICSIDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdUserName
        $this->createdUserName = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_createdUserName', 'createdUserName', '`createdUserName`', '`createdUserName`', 200, 45, -1, false, '`createdUserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_icsi_advised`";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HospID`='".HospitalID()."' and  `ICSIDate` is not null";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewIcsiAdvisedList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewIcsiAdvisedView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewIcsiAdvisedEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewIcsiAdvisedAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewIcsiAdvisedView";
            case Config("API_ADD_ACTION"):
                return "ViewIcsiAdvisedAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewIcsiAdvisedEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewIcsiAdvisedDelete";
            case Config("API_LIST_ACTION"):
                return "ViewIcsiAdvisedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewIcsiAdvisedView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewIcsiAdvisedView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewIcsiAdvisedAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewIcsiAdvisedAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIcsiAdvisedEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewIcsiAdvisedAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewIcsiAdvisedDelete", $this->getUrlParm());
    }
