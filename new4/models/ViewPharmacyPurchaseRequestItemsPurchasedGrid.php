 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestItemsPurchasedGrid extends ViewPharmacyPurchaseRequestItemsPurchased
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestItemsPurchasedGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fview_pharmacy_purchase_request_items_purchasedgrid";
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_ApprovedStatus")) {
            $this->ApprovedStatus->setOldValue($CurrentForm->getValue("o_ApprovedStatus"));
        }
        ...
        if ($CurrentForm->hasValue("o_PurchaseStatus")) {
            $this->PurchaseStatus->setOldValue($CurrentForm->getValue("o_PurchaseStatus"));
        }
    }
