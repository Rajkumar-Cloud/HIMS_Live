 ...
 * Page class
 */
class ViewDashboardCollectionDetailsSearch extends ViewDashboardCollectionDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardCollectionDetailsSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "ViewDashboardCollectionDetailsList" . "?" . $srchStr;
