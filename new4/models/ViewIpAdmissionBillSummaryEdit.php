 ...
 * Page class
 */
class ViewIpAdmissionBillSummaryEdit extends ViewIpAdmissionBillSummary
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpAdmissionBillSummaryEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ViewIpAdmissionBillSummaryList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "ViewIpAdmissionBillSummaryList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // billclosedBy
            $this->billclosedBy->CurrentValue = GetUserName();
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewIpAdmissionBillSummaryList"), "", $this->TableVar, true);
        $pageId = "edit";
