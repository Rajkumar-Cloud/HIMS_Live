 ...
 * Page class
 */
class ViewActivityCardList extends ViewActivityCard
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewActivityCardList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewActivityCardAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewActivityCardDelete";
        $this->MultiUpdateUrl = "ViewActivityCardUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_activity_card"));
                $doc->Text = @$content;
    ...
    public function resetFormError()
    {
        ...
        $this->Activity->clearErrorMessage();
        $this->Type->clearErrorMessage();
        $this->Selected->clearErrorMessage();
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Selected->PlaceHolder = RemoveHtml($this->Selected->caption());
    ...
    protected function validateForm()
    {
        ...
        if ($this->Selected->Required) {
            if ($this->Selected->FormValue == "") {
                $this->Selected->addErrorMessage(str_replace("%s", $this->Selected->caption(), $this->Selected->RequiredErrorMessage));
            }
        }
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['Activity']); // Activity
        $hash .= GetFieldHash($row['Type']); // Type
        $hash .= GetFieldHash($row['Selected']); // Selected
