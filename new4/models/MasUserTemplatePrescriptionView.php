 ...
 * Page class
 */
class MasUserTemplatePrescriptionView extends MasUserTemplatePrescription
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasUserTemplatePrescriptionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MasUserTemplatePrescriptionList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MasUserTemplatePrescriptionList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "MasUserTemplatePrescriptionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
