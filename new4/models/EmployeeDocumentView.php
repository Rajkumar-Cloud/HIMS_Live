 ...
 * Page class
 */
class EmployeeDocumentView extends EmployeeDocument
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeDocumentView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmployeeDocumentList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "EmployeeDocumentList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "EmployeeDocumentList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
