 ...
 * Page class
 */
class PatientFollowUpList extends PatientFollowUp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientFollowUpList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpatient_follow_uplist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PatientFollowUpAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PatientFollowUpDelete";
        $this->MultiUpdateUrl = "PatientFollowUpUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpatient_follow_uplistsrch";
    ...
    public function run()
    {
        ...
        $this->DischargeAdviceMedicineTemplate->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpatient_follow_uplistsrch");
        }
        ...
        $filterList = Concat($filterList, $this->_Template->AdvancedSearch->toJson(), ","); // Field Template
        ...
        $filterList = Concat($filterList, $this->Template1->AdvancedSearch->toJson(), ","); // Field Template1
        $filterList = Concat($filterList, $this->Template2->AdvancedSearch->toJson(), ","); // Field Template2
        $filterList = Concat($filterList, $this->Template3->AdvancedSearch->toJson(), ","); // Field Template3
        ...
        $filterList = Concat($filterList, $this->DischargeAdviceMedicineTemplate->AdvancedSearch->toJson(), ","); // Field DischargeAdviceMedicineTemplate
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpatient_follow_uplistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Template
        $this->_Template->AdvancedSearch->SearchValue = @$filter["x__Template"];
        $this->_Template->AdvancedSearch->SearchOperator = @$filter["z__Template"];
        $this->_Template->AdvancedSearch->SearchCondition = @$filter["v__Template"];
        $this->_Template->AdvancedSearch->SearchValue2 = @$filter["y__Template"];
        $this->_Template->AdvancedSearch->SearchOperator2 = @$filter["w__Template"];
        $this->_Template->AdvancedSearch->save();
        ...
        // Field Template2
        $this->Template2->AdvancedSearch->SearchValue = @$filter["x_Template2"];
        $this->Template2->AdvancedSearch->SearchOperator = @$filter["z_Template2"];
        $this->Template2->AdvancedSearch->SearchCondition = @$filter["v_Template2"];
        $this->Template2->AdvancedSearch->SearchValue2 = @$filter["y_Template2"];
        $this->Template2->AdvancedSearch->SearchOperator2 = @$filter["w_Template2"];
        $this->Template2->AdvancedSearch->save();

        // Field Template3
        $this->Template3->AdvancedSearch->SearchValue = @$filter["x_Template3"];
        $this->Template3->AdvancedSearch->SearchOperator = @$filter["z_Template3"];
        $this->Template3->AdvancedSearch->SearchCondition = @$filter["v_Template3"];
        $this->Template3->AdvancedSearch->SearchValue2 = @$filter["y_Template3"];
        $this->Template3->AdvancedSearch->SearchOperator2 = @$filter["w_Template3"];
        $this->Template3->AdvancedSearch->save();
        ...
        // Field DischargeAdviceMedicineTemplate
        $this->DischargeAdviceMedicineTemplate->AdvancedSearch->SearchValue = @$filter["x_DischargeAdviceMedicineTemplate"];
        $this->DischargeAdviceMedicineTemplate->AdvancedSearch->SearchOperator = @$filter["z_DischargeAdviceMedicineTemplate"];
        $this->DischargeAdviceMedicineTemplate->AdvancedSearch->SearchCondition = @$filter["v_DischargeAdviceMedicineTemplate"];
        $this->DischargeAdviceMedicineTemplate->AdvancedSearch->SearchValue2 = @$filter["y_DischargeAdviceMedicineTemplate"];
        $this->DischargeAdviceMedicineTemplate->AdvancedSearch->SearchOperator2 = @$filter["w_DischargeAdviceMedicineTemplate"];
        $this->DischargeAdviceMedicineTemplate->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->_Template, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->Template1, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Template2, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->Template3, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->DischargeAdviceMedicineTemplate, $arKeywords, $type);
        return $where;
    }
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->conditionatdischarge->setSort("");
                $this->Template1->setSort("");
                $this->Template2->setSort("");
                $this->Template3->setSort("");
                $this->HospID->setSort("");
                $this->Reception->setSort("");
                $this->PatientId->setSort("");
                $this->PatientSearch->setSort("");
                $this->DischargeAdviceMedicine->setSort("");
                $this->DischargeAdviceMedicineTemplate->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_follow_uplistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_follow_uplistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpatient_follow_uplist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function newRow()
    {
        ...
        $row['DischargeAdviceMedicineTemplate'] = null;
        return $row;
    }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpatient_follow_uplist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpatient_follow_uplist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpatient_follow_uplist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_patient_follow_up" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_patient_follow_up\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpatient_follow_uplist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_follow_uplistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
