 ...
 * Page class
 */
class ViewPartnerSemenstockList extends ViewPartnerSemenstock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPartnerSemenstockList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPartnerSemenstockAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPartnerSemenstockDelete";
        $this->MultiUpdateUrl = "ViewPartnerSemenstockUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_partner_semenstock"));
                $doc->Text = @$content;
