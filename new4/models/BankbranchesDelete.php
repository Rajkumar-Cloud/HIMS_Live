 ...
 * Page class
 */
class BankbranchesDelete extends Bankbranches
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BankbranchesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BankbranchesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BankbranchesList"); // Return to list
                return;
            }
        }
