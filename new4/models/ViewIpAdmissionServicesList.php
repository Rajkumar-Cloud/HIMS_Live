 ...
 * Page class
 */
class ViewIpAdmissionServicesList extends ViewIpAdmissionServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpAdmissionServicesList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewIpAdmissionServicesAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewIpAdmissionServicesDelete";
        $this->MultiUpdateUrl = "ViewIpAdmissionServicesUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_ip_admission_services"));
                $doc->Text = @$content;
