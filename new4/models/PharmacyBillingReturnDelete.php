 ...
 * Page class
 */
class PharmacyBillingReturnDelete extends PharmacyBillingReturn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingReturnDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyBillingReturnList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyBillingReturnList"); // Return to list
                return;
            }
        }
