 ...
 * Page class
 */
class ViewAppointmentSchedulerNewDelete extends ViewAppointmentSchedulerNew
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAppointmentSchedulerNewDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewAppointmentSchedulerNewList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewAppointmentSchedulerNewList"); // Return to list
                return;
            }
        }
