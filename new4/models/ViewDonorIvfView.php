 ...
 * Page class
 */
class ViewDonorIvfView extends ViewDonorIvf
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDonorIvfView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewDonorIvfList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewDonorIvfList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewDonorIvfList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("IvfTreatmentPlanList?" . Config("TABLE_SHOW_MASTER") . "=view_donor_ivf&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "&" . GetForeignKeyUrl("fk_Female", $this->Female->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
