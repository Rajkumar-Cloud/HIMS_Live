...
/**
 * Table class for view_store_transfer
 */
class ViewStoreTransfer extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_store_transfer';
        $this->TableName = 'view_store_transfer';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_store_transfer`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORDNO
        $this->ORDNO = new DbField('view_store_transfer', 'view_store_transfer', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, 5, -1, false, '`ORDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_store_transfer', 'view_store_transfer', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QTY
        $this->QTY = new DbField('view_store_transfer', 'view_store_transfer', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 3, 11, -1, false, '`QTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('view_store_transfer', 'view_store_transfer', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('view_store_transfer', 'view_store_transfer', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YM
        $this->YM = new DbField('view_store_transfer', 'view_store_transfer', 'x_YM', 'YM', '`YM`', '`YM`', 200, 6, -1, false, '`YM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_store_transfer', 'view_store_transfer', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('view_store_transfer', 'view_store_transfer', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 3, 11, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LastMonthSale
        $this->LastMonthSale = new DbField('view_store_transfer', 'view_store_transfer', 'x_LastMonthSale', 'LastMonthSale', '`LastMonthSale`', '`LastMonthSale`', 3, 11, -1, false, '`LastMonthSale`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LastMonthSale->Sortable = true; // Allow sort
        $this->LastMonthSale->Lookup = new Lookup('LastMonthSale', 'view_store_search_product', false, 'id', ["DES","Stock","RT",""], [], [], [], [], ["PRC","MFRCODE","BATCH","EXPDT","DES","RT","RT","PSGST","PCGST","SSGST","SCGST","BILLDATE","Stock"], ["x_PRC","x_MFRCODE","x_BatchNo","x_ExpDate","x_PrName","x_MRP","x_SalRate","x_PSGST","x_PCGST","x_SSGST","x_SCGST","x_BillDate","x_CurStock"], '`Stock` DESC', '');
        ...
        // Printcheck
        $this->Printcheck = new DbField('view_store_transfer', 'view_store_transfer', 'x_Printcheck', 'Printcheck', '`Printcheck`', '`Printcheck`', 200, 50, -1, false, '`Printcheck`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('view_store_transfer', 'view_store_transfer', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // poid
        $this->poid = new DbField('view_store_transfer', 'view_store_transfer', 'x_poid', 'poid', '`poid`', '`poid`', 3, 11, -1, false, '`poid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnid
        $this->grnid = new DbField('view_store_transfer', 'view_store_transfer', 'x_grnid', 'grnid', '`grnid`', '`grnid`', 3, 11, -1, false, '`grnid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BatchNo
        $this->BatchNo = new DbField('view_store_transfer', 'view_store_transfer', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, 45, -1, false, '`BatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_store_transfer', 'view_store_transfer', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 0, "DB"), 135, 19, 0, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('view_store_transfer', 'view_store_transfer', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Quantity
        $this->Quantity = new DbField('view_store_transfer', 'view_store_transfer', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, 11, -1, false, '`Quantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FreeQty
        $this->FreeQty = new DbField('view_store_transfer', 'view_store_transfer', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 3, 11, -1, false, '`FreeQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemValue
        $this->ItemValue = new DbField('view_store_transfer', 'view_store_transfer', 'x_ItemValue', 'ItemValue', '`ItemValue`', '`ItemValue`', 131, 12, -1, false, '`ItemValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Disc
        $this->Disc = new DbField('view_store_transfer', 'view_store_transfer', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, 45, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PTax
        $this->PTax = new DbField('view_store_transfer', 'view_store_transfer', 'x_PTax', 'PTax', '`PTax`', '`PTax`', 131, 12, -1, false, '`PTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRP
        $this->MRP = new DbField('view_store_transfer', 'view_store_transfer', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalTax
        $this->SalTax = new DbField('view_store_transfer', 'view_store_transfer', 'x_SalTax', 'SalTax', '`SalTax`', '`SalTax`', 131, 12, -1, false, '`SalTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('view_store_transfer', 'view_store_transfer', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('view_store_transfer', 'view_store_transfer', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalRate
        $this->SalRate = new DbField('view_store_transfer', 'view_store_transfer', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, 12, -1, false, '`SalRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Discount
        $this->Discount = new DbField('view_store_transfer', 'view_store_transfer', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, 12, -1, false, '`Discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_store_transfer', 'view_store_transfer', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_store_transfer', 'view_store_transfer', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_store_transfer', 'view_store_transfer', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_store_transfer', 'view_store_transfer', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_store_transfer', 'view_store_transfer', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HSN
        $this->HSN = new DbField('view_store_transfer', 'view_store_transfer', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, 45, -1, false, '`HSN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pack
        $this->Pack = new DbField('view_store_transfer', 'view_store_transfer', 'x_Pack', 'Pack', '`Pack`', '`Pack`', 200, 45, -1, false, '`Pack`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('view_store_transfer', 'view_store_transfer', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('view_store_transfer', 'view_store_transfer', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnQuantity
        $this->GrnQuantity = new DbField('view_store_transfer', 'view_store_transfer', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 3, 11, -1, false, '`GrnQuantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnMRP
        $this->GrnMRP = new DbField('view_store_transfer', 'view_store_transfer', 'x_GrnMRP', 'GrnMRP', '`GrnMRP`', '`GrnMRP`', 131, 12, -1, false, '`GrnMRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // strid
        $this->strid = new DbField('view_store_transfer', 'view_store_transfer', 'x_strid', 'strid', '`strid`', '`strid`', 3, 11, -1, false, '`strid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->strid->IsForeignKey = true; // Foreign key field
        ...
        // HospID
        $this->HospID = new DbField('view_store_transfer', 'view_store_transfer', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedBy
        $this->CreatedBy = new DbField('view_store_transfer', 'view_store_transfer', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, 11, -1, false, '`CreatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_store_transfer', 'view_store_transfer', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedBy
        $this->ModifiedBy = new DbField('view_store_transfer', 'view_store_transfer', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, 11, -1, false, '`ModifiedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('view_store_transfer', 'view_store_transfer', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedby
        $this->grncreatedby = new DbField('view_store_transfer', 'view_store_transfer', 'x_grncreatedby', 'grncreatedby', '`grncreatedby`', '`grncreatedby`', 3, 11, -1, false, '`grncreatedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedDateTime
        $this->grncreatedDateTime = new DbField('view_store_transfer', 'view_store_transfer', 'x_grncreatedDateTime', 'grncreatedDateTime', '`grncreatedDateTime`', CastDateFieldForLike("`grncreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`grncreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnModifiedby
        $this->grnModifiedby = new DbField('view_store_transfer', 'view_store_transfer', 'x_grnModifiedby', 'grnModifiedby', '`grnModifiedby`', '`grnModifiedby`', 3, 11, -1, false, '`grnModifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnModifiedDateTime
        $this->grnModifiedDateTime = new DbField('view_store_transfer', 'view_store_transfer', 'x_grnModifiedDateTime', 'grnModifiedDateTime', '`grnModifiedDateTime`', CastDateFieldForLike("`grnModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`grnModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Received
        $this->Received = new DbField('view_store_transfer', 'view_store_transfer', 'x_Received', 'Received', '`Received`', '`Received`', 200, 45, -1, false, '`Received`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillDate
        $this->BillDate = new DbField('view_store_transfer', 'view_store_transfer', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike("`BillDate`", 0, "DB"), 135, 19, 0, false, '`BillDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CurStock
        $this->CurStock = new DbField('view_store_transfer', 'view_store_transfer', 'x_CurStock', 'CurStock', '`CurStock`', '`CurStock`', 3, 11, -1, false, '`CurStock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "store_billing_transfer") {
            if ($this->strid->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->strid->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "store_billing_transfer") {
            if ($this->strid->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`strid`", $this->strid->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_store_billing_transfer()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_store_billing_transfer()
    {
        return "`strid`=@strid@";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_store_transfer`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewStoreTransferList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewStoreTransferEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewStoreTransferAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewStoreTransferView";
            case Config("API_ADD_ACTION"):
                return "ViewStoreTransferAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewStoreTransferEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewStoreTransferDelete";
            case Config("API_LIST_ACTION"):
                return "ViewStoreTransferList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewStoreTransferView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewStoreTransferView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewStoreTransferAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewStoreTransferAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewStoreTransferEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewStoreTransferAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewStoreTransferDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "store_billing_transfer" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->strid->CurrentValue ?? $this->strid->getSessionValue());
        }
        return $url;
    }
    ...
    public function rowInserting($rsold, &$rsnew) {
    	...
    	// To cancel, set return value to FALSE
    		$cid = $_GET["fk_id"] ;
    						...
    						$sqlpoh ="SELECT * FROM ganeshkumar_bjhims.store_purchaseorder  where PRC='".$rsnew["PRC"]."' and BATCHNO='".$rsnew["BatchNo"]."' and `BRCODE`='".PharmacyID()."' and  `HospID`='".HospitalID()."';";
    	...
    	$sqlA = " UPDATE `ganeshkumar_bjhims`.`store_batchmas`
