 ...
 * Page class
 */
class LabProfileDetailsPreview extends LabProfileDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabProfileDetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_lab_profile") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_profile&" . GetForeignKeyUrl("fk_CODE", $this->ProfileCode->QueryStringValue) . "";
        }
        return $url;
    }
