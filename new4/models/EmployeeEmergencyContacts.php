...
/**
 * Table class for employee_emergency_contacts
 */
class EmployeeEmergencyContacts extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_emergency_contacts';
        $this->TableName = 'employee_emergency_contacts';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`employee_emergency_contacts`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee
        $this->employee = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_employee', 'employee', '`employee`', '`employee`', 3, 20, -1, false, '`employee`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_name', 'name', '`name`', '`name`', 200, 100, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // relationship
        $this->relationship = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_relationship', 'relationship', '`relationship`', '`relationship`', 200, 100, -1, false, '`relationship`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // home_phone
        $this->home_phone = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_home_phone', 'home_phone', '`home_phone`', '`home_phone`', 200, 15, -1, false, '`home_phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // work_phone
        $this->work_phone = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_work_phone', 'work_phone', '`work_phone`', '`work_phone`', 200, 15, -1, false, '`work_phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mobile_phone
        $this->mobile_phone = new DbField('employee_emergency_contacts', 'employee_emergency_contacts', 'x_mobile_phone', 'mobile_phone', '`mobile_phone`', '`mobile_phone`', 200, 15, -1, false, '`mobile_phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_emergency_contacts`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeEmergencyContactsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmployeeEmergencyContactsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmployeeEmergencyContactsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeEmergencyContactsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeEmergencyContactsView";
            case Config("API_ADD_ACTION"):
                return "EmployeeEmergencyContactsAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeEmergencyContactsEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeEmergencyContactsDelete";
            case Config("API_LIST_ACTION"):
                return "EmployeeEmergencyContactsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeEmergencyContactsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeEmergencyContactsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeEmergencyContactsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeEmergencyContactsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeEmergencyContactsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeEmergencyContactsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeEmergencyContactsDelete", $this->getUrlParm());
    }
