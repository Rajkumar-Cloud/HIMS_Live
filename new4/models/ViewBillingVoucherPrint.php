...
class ViewBillingVoucherPrint extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 201, 450, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "ViewBillingVoucherPrintList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewBillingVoucherPrintList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBillingVoucherPrintView";
            case Config("API_ADD_ACTION"):
                return "ViewBillingVoucherPrintAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBillingVoucherPrintEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBillingVoucherPrintDelete";
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("ViewBillingVoucherPrintEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("ViewBillingVoucherPrintAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
