...
class PresMasTimeoftakingAdd extends PresMasTimeoftaking
{
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Time Of Taking' first before field var 'x_TimeOfTaking'
        $val = $CurrentForm->hasValue("Time Of Taking") ? $CurrentForm->getValue("Time Of Taking") : $CurrentForm->getValue("x_TimeOfTaking");
    ...
    protected function newRow()
    {
        ...
        $row['Time Of Taking'] = $this->TimeOfTaking->CurrentValue;
        return $row;
    }
