 ...
 * Page class
 */
class LabProfileMasterView extends LabProfileMaster
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabProfileMasterView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LabProfileMasterList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LabProfileMasterList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "LabProfileMasterList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
