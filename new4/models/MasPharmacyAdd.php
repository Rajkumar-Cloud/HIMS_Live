 ...
 * Page class
 */
class MasPharmacyAdd extends MasPharmacy
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasPharmacyAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("MasPharmacyList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MasPharmacyList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MasPharmacyView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            if (in_array("pharmacy_services", $detailTblVar) && $detailPage->DetailAdd) {
                ...
                $detailPage->amount->setSessionValue($this->amount->CurrentValue); // Set master key
                $detailPage->description->setSessionValue($this->description->CurrentValue); // Set master key
                ...
                $detailPage->amount->setSessionValue(""); // Clear master key if insert failed
                $detailPage->description->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
