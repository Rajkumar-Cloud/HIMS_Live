 ...
 * Page class
 */
class ViewSemenanalysisView extends ViewSemenanalysis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewSemenanalysisView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewSemenanalysisList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewSemenanalysisList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewSemenanalysisList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
