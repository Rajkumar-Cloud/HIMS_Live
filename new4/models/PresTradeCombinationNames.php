 ...
 */
class PresTradeCombinationNames extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->GENERIC_NAMES->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENERIC_NAMES->Param, "CustomMsg");
        ...
        $this->GenericNames_symbols->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GenericNames_symbols->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PresTradeCombinationNamesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PresTradeCombinationNamesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PresTradeCombinationNamesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PresTradeCombinationNamesView";
            case Config("API_ADD_ACTION"):
                return "PresTradeCombinationNamesAdd";
            case Config("API_EDIT_ACTION"):
                return "PresTradeCombinationNamesEdit";
            case Config("API_DELETE_ACTION"):
                return "PresTradeCombinationNamesDelete";
            case Config("API_LIST_ACTION"):
                return "PresTradeCombinationNamesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PresTradeCombinationNamesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PresTradeCombinationNamesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PresTradeCombinationNamesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PresTradeCombinationNamesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresTradeCombinationNamesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresTradeCombinationNamesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PresTradeCombinationNamesDelete", $this->getUrlParm());
    }
