 ...
 * Page class
 */
class ViewLabResultreleaseddPreview extends ViewLabResultreleasedd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabResultreleaseddPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_lab_servicess") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_servicess&" . GetForeignKeyUrl("fk_id", $this->Vid->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewLabResultreleaseddList"), "", $this->TableVar, true);
        $pageId = "preview";
