 ...
 * Page class
 */
class PresTradeCombinationNamesNewView extends PresTradeCombinationNamesNew
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresTradeCombinationNamesNewView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "PresTradeCombinationNamesNewList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PresTradeCombinationNamesNewList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PresTradeCombinationNamesNewList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
