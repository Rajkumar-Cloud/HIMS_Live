 ...
 * Page class
 */
class ViewLabServiceSubPreview extends ViewLabServiceSub
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabServiceSubPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_lab_service") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_service&" . GetForeignKeyUrl("fk_CODE", $this->CODE->QueryStringValue) . "";
        }
        return $url;
    }
