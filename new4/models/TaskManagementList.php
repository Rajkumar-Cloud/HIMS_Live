 ...
 * Page class
 */
class TaskManagementList extends TaskManagement
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaskManagementList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "TaskManagementAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "TaskManagementDelete";
        $this->MultiUpdateUrl = "TaskManagementUpdate";
