...
class Receipts extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ChequeCardNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ChequeCardNo->Param, "CustomMsg");
        ...
        $this->CreditBankName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditBankName->Param, "CustomMsg");
        ...
        $this->CreditCardHolder->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditCardHolder->Param, "CustomMsg");
        ...
        $this->CreditCardType->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditCardType->Param, "CustomMsg");
        ...
        $this->CreditCardMachine->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditCardMachine->Param, "CustomMsg");
        ...
        $this->CreditCardBatchNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditCardBatchNo->Param, "CustomMsg");
        ...
        $this->CreditCardTax->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditCardTax->Param, "CustomMsg");
        ...
        $this->CreditDeductionAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CreditDeductionAmount->Param, "CustomMsg");
        ...
        $this->BankAccHolderMobileNumber->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BankAccHolderMobileNumber->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ReceiptsList");
    }
