 ...
 * Page class
 */
class ViewLabResultreleasedPreview extends ViewLabResultreleased
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabResultreleasedPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_lab_services") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_services&" . GetForeignKeyUrl("fk_id", $this->Vid->QueryStringValue) . "";
        }
        if ($masterTblVar == "view_labreport_print") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_labreport_print&" . GetForeignKeyUrl("fk_id", $this->Vid->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewLabResultreleasedList"), "", $this->TableVar, true);
        $pageId = "preview";
