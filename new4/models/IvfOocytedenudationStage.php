 ...
 */
class IvfOocytedenudationStage extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // RIDNo
        $this->RIDNo = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, 11, -1, false, '`RIDNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Name
        $this->Name = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_Name', 'Name', '`Name`', '`Name`', 200, 45, -1, false, '`Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Name->Sortable = false; // Allow sort
        $this->Name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Name->Param, "CustomMsg");
        $this->Fields['Name'] = &$this->Name;

        // TidNo
        $this->TidNo = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OidNo
        $this->OidNo = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_OidNo', 'OidNo', '`OidNo`', '`OidNo`', 3, 11, -1, false, '`OidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->OidNo->Sortable = false; // Allow sort
        $this->OidNo->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->OidNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OidNo->Param, "CustomMsg");
        $this->Fields['OidNo'] = &$this->OidNo;

        // OocyteNo
        $this->OocyteNo = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_OocyteNo', 'OocyteNo', '`OocyteNo`', '`OocyteNo`', 200, 45, -1, false, '`OocyteNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stage
        $this->Stage = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_Stage', 'Stage', '`Stage`', '`Stage`', 200, 45, -1, false, '`Stage`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ReMarks
        $this->ReMarks = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_ReMarks', 'ReMarks', '`ReMarks`', '`ReMarks`', 200, 50, -1, false, '`ReMarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ReMarks->Sortable = true; // Allow sort
        $this->ReMarks->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ReMarks->Param, "CustomMsg");
        $this->Fields['ReMarks'] = &$this->ReMarks;

        // status
        $this->status = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('ivf_oocytedenudation_stage', 'ivf_oocytedenudation_stage', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IvfOocytedenudationStageList");
    }
    ...
    {
        global $Language;
        if ($pageName == "IvfOocytedenudationStageView") {
            return $Language->phrase("View");
        } elseif ($pageName == "IvfOocytedenudationStageEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "IvfOocytedenudationStageAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IvfOocytedenudationStageView";
            case Config("API_ADD_ACTION"):
                return "IvfOocytedenudationStageAdd";
            case Config("API_EDIT_ACTION"):
                return "IvfOocytedenudationStageEdit";
            case Config("API_DELETE_ACTION"):
                return "IvfOocytedenudationStageDelete";
            case Config("API_LIST_ACTION"):
                return "IvfOocytedenudationStageList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("IvfOocytedenudationStageView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("IvfOocytedenudationStageView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "IvfOocytedenudationStageAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "IvfOocytedenudationStageAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("IvfOocytedenudationStageEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("IvfOocytedenudationStageAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("IvfOocytedenudationStageDelete", $this->getUrlParm());
    }
