...
class PharmacyPurchaseRequestAdd extends PharmacyPurchaseRequest
{
    ...
    protected function validateForm()
    {
        ...
        if (in_array("pharmacy_purchase_request_items", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("PharmacyPurchaseRequestItemsGrid");
            if (in_array("pharmacy_purchase_request_items", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->prid->setSessionValue($this->id->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->prid->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
