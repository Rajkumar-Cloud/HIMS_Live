...
class PresFluidformulation extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Tradename->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Tradename->Param, "CustomMsg");
        ...
        $this->VolumeUnit->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->VolumeUnit->Param, "CustomMsg");
        ...
        $this->StrengthUnit->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->StrengthUnit->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PresFluidformulationList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PresFluidformulationView";
            case Config("API_ADD_ACTION"):
                return "PresFluidformulationAdd";
            case Config("API_EDIT_ACTION"):
                return "PresFluidformulationEdit";
            case Config("API_DELETE_ACTION"):
                return "PresFluidformulationDelete";
