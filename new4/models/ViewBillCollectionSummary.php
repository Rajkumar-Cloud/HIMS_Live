...
class ViewBillCollectionSummary extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewBillCollectionSummaryList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBillCollectionSummaryView";
            case Config("API_ADD_ACTION"):
                return "ViewBillCollectionSummaryAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBillCollectionSummaryEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBillCollectionSummaryDelete";
