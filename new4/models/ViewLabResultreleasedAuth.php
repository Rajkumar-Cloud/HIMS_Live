...
class ViewLabResultreleasedAuth extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewLabResultreleasedAuthList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewLabResultreleasedAuthView";
            case Config("API_ADD_ACTION"):
                return "ViewLabResultreleasedAuthAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewLabResultreleasedAuthEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewLabResultreleasedAuthDelete";
