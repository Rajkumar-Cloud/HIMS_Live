...
/**
 * Table class for employee_skills
 */
class EmployeeSkills extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_skills';
        $this->TableName = 'employee_skills';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`employee_skills`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('employee_skills', 'employee_skills', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // skill_id
        $this->skill_id = new DbField('employee_skills', 'employee_skills', 'x_skill_id', 'skill_id', '`skill_id`', '`skill_id`', 20, 20, -1, false, '`skill_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->skill_id->Sortable = true; // Allow sort
        $this->skill_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->skill_id->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->skill_id->Param, "CustomMsg");
        $this->Fields['skill_id'] = &$this->skill_id;

        // employee
        $this->employee = new DbField('employee_skills', 'employee_skills', 'x_employee', 'employee', '`employee`', '`employee`', 3, 20, -1, false, '`employee`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // details
        $this->details = new DbField('employee_skills', 'employee_skills', 'x_details', 'details', '`details`', '`details`', 201, 400, -1, false, '`details`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_skills`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeSkillsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "EmployeeSkillsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeSkillsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeSkillsView";
            case Config("API_ADD_ACTION"):
                return "EmployeeSkillsAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeSkillsEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeSkillsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeSkillsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeSkillsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeSkillsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeSkillsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeSkillsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeSkillsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeSkillsDelete", $this->getUrlParm());
    }
