 ...
 * Page class
 */
class StoreIntentIssueView extends StoreIntentIssue
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreIntentIssueView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "StoreIntentIssueList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "StoreIntentIssueList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "StoreIntentIssueList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
