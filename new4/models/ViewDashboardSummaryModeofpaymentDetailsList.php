 ...
 * Page class
 */
class ViewDashboardSummaryModeofpaymentDetailsList extends ViewDashboardSummaryModeofpaymentDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardSummaryModeofpaymentDetailsList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "ViewDashboardSummaryModeofpaymentDetailsDelete";
        $this->MultiUpdateUrl = "ViewDashboardSummaryModeofpaymentDetailsUpdate";
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_dashboard_collection_details')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewDashboardCollectionDetailsList?" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_summary_modeofpayment_details&" . GetForeignKeyUrl("fk__UserName", $this->_UserName->CurrentValue) . "&" . GetForeignKeyUrl("fk_createddate", $this->createddate->CurrentValue, 0) . "&" . GetForeignKeyUrl("fk_ModeofPayment", $this->ModeofPayment->CurrentValue) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ViewDashboardCollectionDetailsGrid");
            if ($links != "") {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_summary_details") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    ...
                    $view_dashboard_summary_details->exportDocument($doc, new Recordset($rsmaster));
                    $doc->exportEmptyRow();
                    $doc->Table = &$this;
                }
        ...
        if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== null) {
            ...
            if ($masterTblVar == "view_dashboard_summary_details") {
                ...
                if (($parm = Get("fk__UserName", Get("_UserName"))) !== null) {
                    ...
                    $this->_UserName->setQueryStringValue($masterTbl->_UserName->QueryStringValue);
            ...
            if ($masterTblVar == "view_dashboard_summary_details") {
                ...
                if (($parm = Post("fk__UserName", Post("_UserName"))) !== null) {
                    ...
                    $this->_UserName->setFormValue($masterTbl->_UserName->FormValue);
