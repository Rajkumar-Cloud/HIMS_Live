...
/**
 * Table class for view_dues
 */
class ViewDues extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_dues';
        $this->TableName = 'view_dues';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_dues`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_dues', 'view_dues', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Reception
        $this->Reception = new DbField('view_dues', 'view_dues', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientId
        $this->PatientId = new DbField('view_dues', 'view_dues', 'x_PatientId', 'PatientId', '`PatientId`', '`PatientId`', 200, 45, -1, false, '`PatientId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientId->Sortable = true; // Allow sort
        $this->PatientId->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientId->Param, "CustomMsg");
        $this->Fields['PatientId'] = &$this->PatientId;

        // mrnno
        $this->mrnno = new DbField('view_dues', 'view_dues', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // PatientName
        $this->PatientName = new DbField('view_dues', 'view_dues', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('view_dues', 'view_dues', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = false; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('view_dues', 'view_dues', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profilePic
        $this->profilePic = new DbField('view_dues', 'view_dues', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->profilePic->Sortable = false; // Allow sort
        $this->profilePic->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->profilePic->Param, "CustomMsg");
        $this->Fields['profilePic'] = &$this->profilePic;

        // Mobile
        $this->Mobile = new DbField('view_dues', 'view_dues', 'x_Mobile', 'Mobile', '`Mobile`', '`Mobile`', 200, 45, -1, false, '`Mobile`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile->Sortable = true; // Allow sort
        $this->Mobile->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile->Param, "CustomMsg");
        $this->Fields['Mobile'] = &$this->Mobile;

        // IP_OP
        $this->IP_OP = new DbField('view_dues', 'view_dues', 'x_IP_OP', 'IP_OP', '`IP_OP`', '`IP_OP`', 200, 45, -1, false, '`IP_OP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IP_OP->Sortable = false; // Allow sort
        $this->IP_OP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->IP_OP->Param, "CustomMsg");
        $this->Fields['IP_OP'] = &$this->IP_OP;

        // Doctor
        $this->Doctor = new DbField('view_dues', 'view_dues', 'x_Doctor', 'Doctor', '`Doctor`', '`Doctor`', 200, 45, -1, false, '`Doctor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // voucher_type
        $this->voucher_type = new DbField('view_dues', 'view_dues', 'x_voucher_type', 'voucher_type', '`voucher_type`', '`voucher_type`', 200, 45, -1, false, '`voucher_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Details
        $this->Details = new DbField('view_dues', 'view_dues', 'x_Details', 'Details', '`Details`', '`Details`', 200, 45, -1, false, '`Details`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('view_dues', 'view_dues', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Amount
        $this->Amount = new DbField('view_dues', 'view_dues', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, 10, -1, false, '`Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnyDues
        $this->AnyDues = new DbField('view_dues', 'view_dues', 'x_AnyDues', 'AnyDues', '`AnyDues`', '`AnyDues`', 200, 45, -1, false, '`AnyDues`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_dues', 'view_dues', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('view_dues', 'view_dues', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_dues', 'view_dues', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('view_dues', 'view_dues', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RealizationAmount
        $this->RealizationAmount = new DbField('view_dues', 'view_dues', 'x_RealizationAmount', 'RealizationAmount', '`RealizationAmount`', '`RealizationAmount`', 131, 10, -1, false, '`RealizationAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RealizationAmount->Sortable = false; // Allow sort
        ...
        // RealizationStatus
        $this->RealizationStatus = new DbField('view_dues', 'view_dues', 'x_RealizationStatus', 'RealizationStatus', '`RealizationStatus`', '`RealizationStatus`', 200, 45, -1, false, '`RealizationStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RealizationStatus->Sortable = false; // Allow sort
        ...
        // RealizationRemarks
        $this->RealizationRemarks = new DbField('view_dues', 'view_dues', 'x_RealizationRemarks', 'RealizationRemarks', '`RealizationRemarks`', '`RealizationRemarks`', 200, 45, -1, false, '`RealizationRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RealizationRemarks->Sortable = false; // Allow sort
        ...
        // RealizationBatchNo
        $this->RealizationBatchNo = new DbField('view_dues', 'view_dues', 'x_RealizationBatchNo', 'RealizationBatchNo', '`RealizationBatchNo`', '`RealizationBatchNo`', 200, 45, -1, false, '`RealizationBatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RealizationBatchNo->Sortable = false; // Allow sort
        ...
        // RealizationDate
        $this->RealizationDate = new DbField('view_dues', 'view_dues', 'x_RealizationDate', 'RealizationDate', '`RealizationDate`', '`RealizationDate`', 200, 45, -1, false, '`RealizationDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RealizationDate->Sortable = false; // Allow sort
        ...
        // HospID
        $this->HospID = new DbField('view_dues', 'view_dues', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_dues', 'view_dues', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TidNo
        $this->TidNo = new DbField('view_dues', 'view_dues', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('view_dues', 'view_dues', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PartnerName
        $this->PartnerName = new DbField('view_dues', 'view_dues', 'x_PartnerName', 'PartnerName', '`PartnerName`', '`PartnerName`', 200, 45, -1, false, '`PartnerName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PartnerName->Sortable = false; // Allow sort
        ...
        // PayerType
        $this->PayerType = new DbField('view_dues', 'view_dues', 'x_PayerType', 'PayerType', '`PayerType`', '`PayerType`', 200, 45, -1, false, '`PayerType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PayerType->Sortable = false; // Allow sort
        ...
        // Dob
        $this->Dob = new DbField('view_dues', 'view_dues', 'x_Dob', 'Dob', '`Dob`', '`Dob`', 200, 45, -1, false, '`Dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Currency
        $this->Currency = new DbField('view_dues', 'view_dues', 'x_Currency', 'Currency', '`Currency`', '`Currency`', 200, 45, -1, false, '`Currency`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('view_dues', 'view_dues', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 201, 450, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->DiscountRemarks->Sortable = false; // Allow sort
        ...
        // Remarks
        $this->Remarks = new DbField('view_dues', 'view_dues', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 65535, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // PatId
        $this->PatId = new DbField('view_dues', 'view_dues', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatId->Sortable = false; // Allow sort
        ...
        // DrDepartment
        $this->DrDepartment = new DbField('view_dues', 'view_dues', 'x_DrDepartment', 'DrDepartment', '`DrDepartment`', '`DrDepartment`', 200, 45, -1, false, '`DrDepartment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DrDepartment->Sortable = false; // Allow sort
        ...
        // RefferedBy
        $this->RefferedBy = new DbField('view_dues', 'view_dues', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, 45, -1, false, '`RefferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RefferedBy->Sortable = false; // Allow sort
        ...
        // BillNumber
        $this->BillNumber = new DbField('view_dues', 'view_dues', 'x_BillNumber', 'BillNumber', '`BillNumber`', '`BillNumber`', 200, 45, -1, false, '`BillNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BillNumber->Sortable = false; // Allow sort
        ...
        // CardNumber
        $this->CardNumber = new DbField('view_dues', 'view_dues', 'x_CardNumber', 'CardNumber', '`CardNumber`', '`CardNumber`', 200, 45, -1, false, '`CardNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CardNumber->Sortable = false; // Allow sort
        ...
        // BankName
        $this->BankName = new DbField('view_dues', 'view_dues', 'x_BankName', 'BankName', '`BankName`', '`BankName`', 200, 45, -1, false, '`BankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BankName->Sortable = false; // Allow sort
        ...
        // DrID
        $this->DrID = new DbField('view_dues', 'view_dues', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DrID->Sortable = false; // Allow sort
        ...
        // BillStatus
        $this->BillStatus = new DbField('view_dues', 'view_dues', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, 11, -1, false, '`BillStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BillStatus->Sortable = false; // Allow sort
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_dues', 'view_dues', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ReportHeader->Sortable = false; // Allow sort
        ...
        // UserName
        $this->_UserName = new DbField('view_dues', 'view_dues', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_UserName->Sortable = false; // Allow sort
        $this->_UserName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_UserName->Param, "CustomMsg");
        $this->Fields['UserName'] = &$this->_UserName;

        // AdjustmentAdvance
        $this->AdjustmentAdvance = new DbField('view_dues', 'view_dues', 'x_AdjustmentAdvance', 'AdjustmentAdvance', '`AdjustmentAdvance`', '`AdjustmentAdvance`', 200, 45, -1, false, '`AdjustmentAdvance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->AdjustmentAdvance->Sortable = false; // Allow sort
        ...
        // billing_vouchercol
        $this->billing_vouchercol = new DbField('view_dues', 'view_dues', 'x_billing_vouchercol', 'billing_vouchercol', '`billing_vouchercol`', '`billing_vouchercol`', 200, 45, -1, false, '`billing_vouchercol`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->billing_vouchercol->Sortable = false; // Allow sort
        ...
        // BillType
        $this->BillType = new DbField('view_dues', 'view_dues', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, 45, -1, false, '`BillType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BillType->Sortable = false; // Allow sort
        ...
        // ProcedureName
        $this->ProcedureName = new DbField('view_dues', 'view_dues', 'x_ProcedureName', 'ProcedureName', '`ProcedureName`', '`ProcedureName`', 200, 45, -1, false, '`ProcedureName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ProcedureName->Sortable = false; // Allow sort
        ...
        // ProcedureAmount
        $this->ProcedureAmount = new DbField('view_dues', 'view_dues', 'x_ProcedureAmount', 'ProcedureAmount', '`ProcedureAmount`', '`ProcedureAmount`', 131, 12, -1, false, '`ProcedureAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ProcedureAmount->Sortable = false; // Allow sort
        ...
        // IncludePackage
        $this->IncludePackage = new DbField('view_dues', 'view_dues', 'x_IncludePackage', 'IncludePackage', '`IncludePackage`', '`IncludePackage`', 200, 45, -1, false, '`IncludePackage`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IncludePackage->Sortable = false; // Allow sort
        ...
        // CancelBill
        $this->CancelBill = new DbField('view_dues', 'view_dues', 'x_CancelBill', 'CancelBill', '`CancelBill`', '`CancelBill`', 200, 45, -1, false, '`CancelBill`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CancelBill->Sortable = false; // Allow sort
        ...
        // CancelReason
        $this->CancelReason = new DbField('view_dues', 'view_dues', 'x_CancelReason', 'CancelReason', '`CancelReason`', '`CancelReason`', 201, 500, -1, false, '`CancelReason`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->CancelReason->Sortable = false; // Allow sort
        ...
        // CancelModeOfPayment
        $this->CancelModeOfPayment = new DbField('view_dues', 'view_dues', 'x_CancelModeOfPayment', 'CancelModeOfPayment', '`CancelModeOfPayment`', '`CancelModeOfPayment`', 200, 45, -1, false, '`CancelModeOfPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CancelModeOfPayment->Sortable = false; // Allow sort
        ...
        // CancelAmount
        $this->CancelAmount = new DbField('view_dues', 'view_dues', 'x_CancelAmount', 'CancelAmount', '`CancelAmount`', '`CancelAmount`', 200, 45, -1, false, '`CancelAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CancelAmount->Sortable = false; // Allow sort
        ...
        // CancelBankName
        $this->CancelBankName = new DbField('view_dues', 'view_dues', 'x_CancelBankName', 'CancelBankName', '`CancelBankName`', '`CancelBankName`', 200, 45, -1, false, '`CancelBankName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CancelBankName->Sortable = false; // Allow sort
        ...
        $this->CancelTransactionNumber = new DbField('view_dues', 'view_dues', 'x_CancelTransactionNumber', 'CancelTransactionNumber', '`CancelTransactionNumber`', '`CancelTransactionNumber`', 200, 45, -1, false, '`CancelTransactionNumber`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CancelTransactionNumber->Sortable = false; // Allow sort
        ...
        // LabTest
        $this->LabTest = new DbField('view_dues', 'view_dues', 'x_LabTest', 'LabTest', '`LabTest`', '`LabTest`', 200, 45, -1, false, '`LabTest`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LabTest->Sortable = false; // Allow sort
        $this->LabTest->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->LabTest->Param, "CustomMsg");
        $this->Fields['LabTest'] = &$this->LabTest;

        // sid
        $this->sid = new DbField('view_dues', 'view_dues', 'x_sid', 'sid', '`sid`', '`sid`', 3, 11, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SidNo
        $this->SidNo = new DbField('view_dues', 'view_dues', 'x_SidNo', 'SidNo', '`SidNo`', '`SidNo`', 200, 45, -1, false, '`SidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SidNo->Sortable = false; // Allow sort
        $this->SidNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SidNo->Param, "CustomMsg");
        $this->Fields['SidNo'] = &$this->SidNo;

        // createdDatettime
        $this->createdDatettime = new DbField('view_dues', 'view_dues', 'x_createdDatettime', 'createdDatettime', '`createdDatettime`', CastDateFieldForLike("`createdDatettime`", 0, "DB"), 135, 19, 0, false, '`createdDatettime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdDatettime->Sortable = false; // Allow sort
        ...
        // LabTestReleased
        $this->LabTestReleased = new DbField('view_dues', 'view_dues', 'x_LabTestReleased', 'LabTestReleased', '`LabTestReleased`', '`LabTestReleased`', 200, 45, -1, false, '`LabTestReleased`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LabTestReleased->Sortable = false; // Allow sort
        ...
        // GoogleReviewID
        $this->GoogleReviewID = new DbField('view_dues', 'view_dues', 'x_GoogleReviewID', 'GoogleReviewID', '`GoogleReviewID`', '`GoogleReviewID`', 200, 45, -1, false, '`GoogleReviewID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GoogleReviewID->Sortable = false; // Allow sort
        ...
        // CardType
        $this->CardType = new DbField('view_dues', 'view_dues', 'x_CardType', 'CardType', '`CardType`', '`CardType`', 200, 45, -1, false, '`CardType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CardType->Sortable = false; // Allow sort
        ...
        // PharmacyBill
        $this->PharmacyBill = new DbField('view_dues', 'view_dues', 'x_PharmacyBill', 'PharmacyBill', '`PharmacyBill`', '`PharmacyBill`', 200, 45, -1, false, '`PharmacyBill`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PharmacyBill->Sortable = false; // Allow sort
        ...
        // DiscountAmount
        $this->DiscountAmount = new DbField('view_dues', 'view_dues', 'x_DiscountAmount', 'DiscountAmount', '`DiscountAmount`', '`DiscountAmount`', 131, 10, -1, false, '`DiscountAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DiscountAmount->Sortable = false; // Allow sort
        ...
        // Cash
        $this->Cash = new DbField('view_dues', 'view_dues', 'x_Cash', 'Cash', '`Cash`', '`Cash`', 131, 10, -1, false, '`Cash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Cash->Sortable = false; // Allow sort
        ...
        // Card
        $this->Card = new DbField('view_dues', 'view_dues', 'x_Card', 'Card', '`Card`', '`Card`', 131, 10, -1, false, '`Card`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Card->Sortable = false; // Allow sort
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_dues`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDuesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDuesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDuesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDuesAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDuesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDuesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDuesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDuesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewDuesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDuesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDuesDelete", $this->getUrlParm());
    }
