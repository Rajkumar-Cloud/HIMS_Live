...
class IvfOocytedenudation extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ResultDate
        $this->ResultDate = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike("`ResultDate`", 11, "DB"), 135, 19, 11, false, '`ResultDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->AnaestheiaType->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->AnaestheiaType->Param, "CustomMsg");
        ...
        $this->PrimaryEmbryologist->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PrimaryEmbryologist->Param, "CustomMsg");
        ...
        $this->SecondaryEmbryologist->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SecondaryEmbryologist->Param, "CustomMsg");
        ...
        $this->OPUNotes->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OPUNotes->Param, "CustomMsg");
        ...
        $this->NoOfFolliclesRight->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NoOfFolliclesRight->Param, "CustomMsg");
        ...
        $this->NoOfFolliclesLeft->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NoOfFolliclesLeft->Param, "CustomMsg");
        ...
        $this->NoOfOocytes->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NoOfOocytes->Param, "CustomMsg");
        ...
        $this->RecordOocyteDenudation->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RecordOocyteDenudation->Param, "CustomMsg");
        $this->Fields['RecordOocyteDenudation'] = &$this->RecordOocyteDenudation;

        // DateOfDenudation
        $this->DateOfDenudation = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_DateOfDenudation', 'DateOfDenudation', '`DateOfDenudation`', CastDateFieldForLike("`DateOfDenudation`", 11, "DB"), 135, 19, 11, false, '`DateOfDenudation`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->DateOfDenudation->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DateOfDenudation->Param, "CustomMsg");
        ...
        $this->DenudationDoneBy->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DenudationDoneBy->Param, "CustomMsg");
        ...
        $this->ExpFollicles->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ExpFollicles->Param, "CustomMsg");
        ...
        $this->SecondaryDenudationDoneBy->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SecondaryDenudationDoneBy->Param, "CustomMsg");
        $this->Fields['SecondaryDenudationDoneBy'] = &$this->SecondaryDenudationDoneBy;

        // patient2
        $this->patient2 = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_patient2', 'patient2', '`patient2`', '`patient2`', 3, 11, -1, false, '`patient2`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->patient2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->patient2->Param, "CustomMsg");
        ...
        $this->OocytesDonate1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocytesDonate1->Param, "CustomMsg");
        ...
        $this->OocytesDonate2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocytesDonate2->Param, "CustomMsg");
        ...
        $this->ETDonate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ETDonate->Param, "CustomMsg");
        $this->Fields['ETDonate'] = &$this->ETDonate;

        // OocyteOrgin
        $this->OocyteOrgin = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_OocyteOrgin', 'OocyteOrgin', '`OocyteOrgin`', '`OocyteOrgin`', 200, 45, -1, false, '`OocyteOrgin`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->OocyteOrgin->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocyteOrgin->Param, "CustomMsg");
        $this->Fields['OocyteOrgin'] = &$this->OocyteOrgin;

        // patient1
        $this->patient1 = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_patient1', 'patient1', '`patient1`', '`patient1`', 3, 11, -1, false, '`patient1`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->patient1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->patient1->Param, "CustomMsg");
        $this->Fields['patient1'] = &$this->patient1;

        // OocyteType
        $this->OocyteType = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_OocyteType', 'OocyteType', '`OocyteType`', '`OocyteType`', 200, 45, -1, false, '`OocyteType`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        $this->OocyteType->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocyteType->Param, "CustomMsg");
        ...
        $this->MIOocytesDonate1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MIOocytesDonate1->Param, "CustomMsg");
        ...
        $this->MIOocytesDonate2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MIOocytesDonate2->Param, "CustomMsg");
        ...
        $this->SelfMI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SelfMI->Param, "CustomMsg");
        ...
        $this->SelfMII->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SelfMII->Param, "CustomMsg");
        $this->Fields['SelfMII'] = &$this->SelfMII;

        // patient3
        $this->patient3 = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_patient3', 'patient3', '`patient3`', '`patient3`', 3, 11, -1, false, '`patient3`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->patient3->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->patient3->Param, "CustomMsg");
        $this->Fields['patient3'] = &$this->patient3;

        // patient4
        $this->patient4 = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_patient4', 'patient4', '`patient4`', '`patient4`', 3, 11, -1, false, '`patient4`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->patient4->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->patient4->Param, "CustomMsg");
        ...
        $this->OocytesDonate3->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocytesDonate3->Param, "CustomMsg");
        ...
        $this->OocytesDonate4->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OocytesDonate4->Param, "CustomMsg");
        ...
        $this->MIOocytesDonate3->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MIOocytesDonate3->Param, "CustomMsg");
        ...
        $this->MIOocytesDonate4->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MIOocytesDonate4->Param, "CustomMsg");
        ...
        $this->SelfOocytesMI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SelfOocytesMI->Param, "CustomMsg");
        ...
        $this->SelfOocytesMII->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SelfOocytesMII->Param, "CustomMsg");
        $this->Fields['SelfOocytesMII'] = &$this->SelfOocytesMII;

        // donor
        $this->donor = new DbField('ivf_oocytedenudation', 'ivf_oocytedenudation', 'x_donor', 'donor', '`donor`', '`donor`', 3, 11, -1, false, '`donor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "IvfOocytedenudationList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IvfOocytedenudationList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IvfOocytedenudationView";
            case Config("API_ADD_ACTION"):
                return "IvfOocytedenudationAdd";
            case Config("API_EDIT_ACTION"):
                return "IvfOocytedenudationEdit";
            case Config("API_DELETE_ACTION"):
                return "IvfOocytedenudationDelete";
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("IvfOocytedenudationEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("IvfOocytedenudationAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
