...
/**
 * Table class for banktransferto
 */
class Banktransferto extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'banktransferto';
        $this->TableName = 'banktransferto';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`banktransferto`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('banktransferto', 'banktransferto', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Name
        $this->Name = new DbField('banktransferto', 'banktransferto', 'x_Name', 'Name', '`Name`', '`Name`', 200, 45, -1, false, '`Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Street_Address
        $this->Street_Address = new DbField('banktransferto', 'banktransferto', 'x_Street_Address', 'Street_Address', '`Street_Address`', '`Street_Address`', 200, 50, -1, false, '`Street_Address`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Street_Address->Nullable = false; // NOT NULL field
        $this->Street_Address->Required = true; // Required field
        $this->Street_Address->Sortable = true; // Allow sort
        $this->Street_Address->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Street_Address->Param, "CustomMsg");
        $this->Fields['Street_Address'] = &$this->Street_Address;

        // City
        $this->City = new DbField('banktransferto', 'banktransferto', 'x_City', 'City', '`City`', '`City`', 200, 25, -1, false, '`City`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // State
        $this->State = new DbField('banktransferto', 'banktransferto', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Zipcode
        $this->Zipcode = new DbField('banktransferto', 'banktransferto', 'x_Zipcode', 'Zipcode', '`Zipcode`', '`Zipcode`', 200, 45, -1, false, '`Zipcode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Zipcode->Nullable = false; // NOT NULL field
        $this->Zipcode->Required = true; // Required field
        $this->Zipcode->Sortable = true; // Allow sort
        $this->Zipcode->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Zipcode->Param, "CustomMsg");
        $this->Fields['Zipcode'] = &$this->Zipcode;

        // Mobile_Number
        $this->Mobile_Number = new DbField('banktransferto', 'banktransferto', 'x_Mobile_Number', 'Mobile_Number', '`Mobile_Number`', '`Mobile_Number`', 200, 12, -1, false, '`Mobile_Number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Mobile_Number->Nullable = false; // NOT NULL field
        $this->Mobile_Number->Required = true; // Required field
        $this->Mobile_Number->Sortable = true; // Allow sort
        $this->Mobile_Number->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Mobile_Number->Param, "CustomMsg");
        $this->Fields['Mobile_Number'] = &$this->Mobile_Number;

        // AccountNo
        $this->AccountNo = new DbField('banktransferto', 'banktransferto', 'x_AccountNo', 'AccountNo', '`AccountNo`', '`AccountNo`', 200, 45, -1, false, '`AccountNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->AccountNo->Nullable = false; // NOT NULL field
        $this->AccountNo->Required = true; // Required field
        $this->AccountNo->Sortable = true; // Allow sort
        $this->AccountNo->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->AccountNo->Param, "CustomMsg");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`banktransferto`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->Street_Address->DbValue = $row['Street_Address'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BanktransfertoList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BanktransfertoView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BanktransfertoEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BanktransfertoAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BanktransfertoView";
            case Config("API_ADD_ACTION"):
                return "BanktransfertoAdd";
            case Config("API_EDIT_ACTION"):
                return "BanktransfertoEdit";
            case Config("API_DELETE_ACTION"):
                return "BanktransfertoDelete";
            case Config("API_LIST_ACTION"):
                return "BanktransfertoList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BanktransfertoView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BanktransfertoView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BanktransfertoAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BanktransfertoAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BanktransfertoEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BanktransfertoAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BanktransfertoDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->Street_Address->EditValue = $this->Street_Address->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->Street_Address);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->Street_Address);
