 ...
 * Page class
 */
class EmployeeCompanyLoansDelete extends EmployeeCompanyLoans
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeCompanyLoansDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeCompanyLoansList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeCompanyLoansList"); // Return to list
                return;
            }
        }
