 ...
 */
class ViewTillSearchView2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_till_search_view2';
        ...
        // id
        $this->id = new DbField('view_till_search_view2', 'view_till_search_view', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DepositDate
        $this->DepositDate = new DbField('view_till_search_view2', 'view_till_search_view', 'x_DepositDate', 'DepositDate', '`DepositDate`', CastDateFieldForLike("`DepositDate`", 7, "DB"), 135, 19, 7, false, '`DepositDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DepositToBankSelect
        $this->DepositToBankSelect = new DbField('view_till_search_view2', 'view_till_search_view', 'x_DepositToBankSelect', 'DepositToBankSelect', '`DepositToBankSelect`', '`DepositToBankSelect`', 200, 45, -1, false, '`DepositToBankSelect`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DepositToBank
        $this->DepositToBank = new DbField('view_till_search_view2', 'view_till_search_view', 'x_DepositToBank', 'DepositToBank', '`DepositToBank`', '`DepositToBank`', 200, 45, -1, false, '`DepositToBank`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedUserName
        $this->CreatedUserName = new DbField('view_till_search_view2', 'view_till_search_view', 'x_CreatedUserName', 'CreatedUserName', '`CreatedUserName`', '`CreatedUserName`', 200, 45, -1, false, '`CreatedUserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TransferToSelect
        $this->TransferToSelect = new DbField('view_till_search_view2', 'view_till_search_view', 'x_TransferToSelect', 'TransferToSelect', '`TransferToSelect`', '`TransferToSelect`', 200, 45, -1, false, '`TransferToSelect`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TransferTo
        $this->TransferTo = new DbField('view_till_search_view2', 'view_till_search_view', 'x_TransferTo', 'TransferTo', '`TransferTo`', '`TransferTo`', 200, 45, -1, false, '`TransferTo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OpeningBalance
        $this->OpeningBalance = new DbField('view_till_search_view2', 'view_till_search_view', 'x_OpeningBalance', 'OpeningBalance', '`OpeningBalance`', '`OpeningBalance`', 131, 10, -1, false, '`OpeningBalance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CashCollected
        $this->CashCollected = new DbField('view_till_search_view2', 'view_till_search_view', 'x_CashCollected', 'CashCollected', '`CashCollected`', '`CashCollected`', 131, 10, -1, false, '`CashCollected`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A2000Count
        $this->A2000Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A2000Count', 'A2000Count', '`A2000Count`', '`A2000Count`', 3, 11, -1, false, '`A2000Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A2000Amount
        $this->A2000Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A2000Amount', 'A2000Amount', '`A2000Amount`', '`A2000Amount`', 131, 10, -1, false, '`A2000Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A1000Count
        $this->A1000Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A1000Count', 'A1000Count', '`A1000Count`', '`A1000Count`', 3, 11, -1, false, '`A1000Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A1000Amount
        $this->A1000Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A1000Amount', 'A1000Amount', '`A1000Amount`', '`A1000Amount`', 131, 10, -1, false, '`A1000Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A500Count
        $this->A500Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A500Count', 'A500Count', '`A500Count`', '`A500Count`', 3, 11, -1, false, '`A500Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A500Amount
        $this->A500Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A500Amount', 'A500Amount', '`A500Amount`', '`A500Amount`', 131, 10, -1, false, '`A500Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A200Count
        $this->A200Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A200Count', 'A200Count', '`A200Count`', '`A200Count`', 3, 11, -1, false, '`A200Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A200Amount
        $this->A200Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A200Amount', 'A200Amount', '`A200Amount`', '`A200Amount`', 131, 10, -1, false, '`A200Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A100Count
        $this->A100Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A100Count', 'A100Count', '`A100Count`', '`A100Count`', 3, 11, -1, false, '`A100Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A100Amount
        $this->A100Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A100Amount', 'A100Amount', '`A100Amount`', '`A100Amount`', 131, 10, -1, false, '`A100Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A50Count
        $this->A50Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A50Count', 'A50Count', '`A50Count`', '`A50Count`', 3, 11, -1, false, '`A50Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A50Amount
        $this->A50Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A50Amount', 'A50Amount', '`A50Amount`', '`A50Amount`', 131, 10, -1, false, '`A50Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A20Count
        $this->A20Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A20Count', 'A20Count', '`A20Count`', '`A20Count`', 3, 11, -1, false, '`A20Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A20Amount
        $this->A20Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A20Amount', 'A20Amount', '`A20Amount`', '`A20Amount`', 131, 10, -1, false, '`A20Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A10Count
        $this->A10Count = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A10Count', 'A10Count', '`A10Count`', '`A10Count`', 3, 11, -1, false, '`A10Count`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // A10Amount
        $this->A10Amount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_A10Amount', 'A10Amount', '`A10Amount`', '`A10Amount`', 131, 10, -1, false, '`A10Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TotalCash
        $this->TotalCash = new DbField('view_till_search_view2', 'view_till_search_view', 'x_TotalCash', 'TotalCash', '`TotalCash`', '`TotalCash`', 131, 10, -1, false, '`TotalCash`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cheque
        $this->Cheque = new DbField('view_till_search_view2', 'view_till_search_view', 'x_Cheque', 'Cheque', '`Cheque`', '`Cheque`', 131, 10, -1, false, '`Cheque`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Card
        $this->Card = new DbField('view_till_search_view2', 'view_till_search_view', 'x_Card', 'Card', '`Card`', '`Card`', 131, 10, -1, false, '`Card`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RTGS
        $this->RTGS = new DbField('view_till_search_view2', 'view_till_search_view', 'x_RTGS', 'RTGS', '`RTGS`', '`RTGS`', 131, 10, -1, false, '`RTGS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NEFTRTGS
        $this->NEFTRTGS = new DbField('view_till_search_view2', 'view_till_search_view', 'x_NEFTRTGS', 'NEFTRTGS', '`NEFTRTGS`', '`NEFTRTGS`', 131, 10, -1, false, '`NEFTRTGS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYTM
        $this->PAYTM = new DbField('view_till_search_view2', 'view_till_search_view', 'x_PAYTM', 'PAYTM', '`PAYTM`', '`PAYTM`', 131, 10, -1, false, '`PAYTM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Other
        $this->Other = new DbField('view_till_search_view2', 'view_till_search_view', 'x_Other', 'Other', '`Other`', '`Other`', 131, 10, -1, false, '`Other`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TotalTransferDepositAmount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_TotalTransferDepositAmount', 'TotalTransferDepositAmount', '`TotalTransferDepositAmount`', '`TotalTransferDepositAmount`', 131, 10, -1, false, '`TotalTransferDepositAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedBy
        $this->CreatedBy = new DbField('view_till_search_view2', 'view_till_search_view', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, 11, -1, false, '`CreatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('view_till_search_view2', 'view_till_search_view', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 7, "DB"), 135, 19, 7, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedBy
        $this->ModifiedBy = new DbField('view_till_search_view2', 'view_till_search_view', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, 11, -1, false, '`ModifiedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('view_till_search_view2', 'view_till_search_view', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedUserName
        $this->ModifiedUserName = new DbField('view_till_search_view2', 'view_till_search_view', 'x_ModifiedUserName', 'ModifiedUserName', '`ModifiedUserName`', '`ModifiedUserName`', 200, 45, -1, false, '`ModifiedUserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BalanceAmount
        $this->BalanceAmount = new DbField('view_till_search_view2', 'view_till_search_view', 'x_BalanceAmount', 'BalanceAmount', '`BalanceAmount`', '`BalanceAmount`', 131, 10, -1, false, '`BalanceAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_till_search_view2', 'view_till_search_view', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewTillSearchView2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewTillSearchView2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewTillSearchView2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewTillSearchView2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewTillSearchView2View";
            case Config("API_ADD_ACTION"):
                return "ViewTillSearchView2Add";
            case Config("API_EDIT_ACTION"):
                return "ViewTillSearchView2Edit";
            case Config("API_DELETE_ACTION"):
                return "ViewTillSearchView2Delete";
            case Config("API_LIST_ACTION"):
                return "ViewTillSearchView2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewTillSearchView2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewTillSearchView2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewTillSearchView2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewTillSearchView2Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTillSearchView2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewTillSearchView2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewTillSearchView2Delete", $this->getUrlParm());
    }
