 ...
 * Page class
 */
class EmployeePermissionsDelete extends EmployeePermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeePermissionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeePermissionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeePermissionsList"); // Return to list
                return;
            }
        }
