 ...
 * Page class
 */
class CrmCrmentityDelete extends CrmCrmentity
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CrmCrmentityDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CrmCrmentityList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CrmCrmentityList"); // Return to list
                return;
            }
        }
