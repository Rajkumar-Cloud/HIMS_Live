...
/**
 * Table class for view_lab_resultreleased
 */
class ViewLabResultreleased extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_lab_resultreleased';
        $this->TableName = 'view_lab_resultreleased';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_lab_resultreleased`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PatID
        $this->PatID = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientName
        $this->PatientName = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->PatientName->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PatientName->Param, "CustomMsg");
        $this->Fields['PatientName'] = &$this->PatientName;

        // Age
        $this->Age = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Age', 'Age', '`Age`', '`Age`', 200, 45, -1, false, '`Age`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Age->Sortable = true; // Allow sort
        $this->Age->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Age->Param, "CustomMsg");
        $this->Fields['Age'] = &$this->Age;

        // Gender
        $this->Gender = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Gender', 'Gender', '`Gender`', '`Gender`', 200, 45, -1, false, '`Gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Gender->Sortable = true; // Allow sort
        $this->Gender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Gender->Param, "CustomMsg");
        $this->Fields['Gender'] = &$this->Gender;

        // sid
        $this->sid = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_sid', 'sid', '`sid`', '`sid`', 3, 11, -1, false, '`sid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemCode
        $this->ItemCode = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_ItemCode', 'ItemCode', '`ItemCode`', '`ItemCode`', 200, 45, -1, false, '`ItemCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DEptCd
        $this->DEptCd = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_DEptCd', 'DEptCd', '`DEptCd`', '`DEptCd`', 200, 45, -1, false, '`DEptCd`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Resulted
        $this->Resulted = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, 45, -1, false, '`Resulted`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->Resulted->Sortable = true; // Allow sort
        $this->Resulted->Lookup = new Lookup('Resulted', 'view_lab_resultreleased', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // Services
        $this->Services = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Services', 'Services', '`Services`', '`Services`', 200, 50, -1, false, '`Services`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LabReport
        $this->LabReport = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_LabReport', 'LabReport', '`LabReport`', '`LabReport`', 201, 65535, -1, false, '`LabReport`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Pic1
        $this->Pic1 = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, 45, -1, true, '`Pic1`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // Pic2
        $this->Pic2 = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, 45, -1, true, '`Pic2`', false, false, false, 'FORMATTED TEXT', 'FILE');
        ...
        // TestUnit
        $this->TestUnit = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_TestUnit', 'TestUnit', '`TestUnit`', '`TestUnit`', 200, 45, -1, false, '`TestUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefValue
        $this->RefValue = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_RefValue', 'RefValue', '`RefValue`', '`RefValue`', 201, 65535, -1, false, '`RefValue`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Order
        $this->Order = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Order', 'Order', '`Order`', '`Order`', 131, 10, -1, false, '`Order`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Repeated
        $this->Repeated = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, 45, -1, false, '`Repeated`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->Repeated->Sortable = true; // Allow sort
        $this->Repeated->Lookup = new Lookup('Repeated', 'view_lab_resultreleased', false, '', ["","","",""], [], [], [], [], [], [], '', '');
        ...
        // Vid
        $this->Vid = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Vid', 'Vid', '`Vid`', '`Vid`', 3, 11, -1, false, '`Vid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // invoiceId
        $this->invoiceId = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_invoiceId', 'invoiceId', '`invoiceId`', '`invoiceId`', 3, 11, -1, false, '`invoiceId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrCODE
        $this->DrCODE = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_DrCODE', 'DrCODE', '`DrCODE`', '`DrCODE`', 200, 45, -1, false, '`DrCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrName
        $this->DrName = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_DrName', 'DrName', '`DrName`', '`DrName`', 200, 45, -1, false, '`DrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Department
        $this->Department = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Department', 'Department', '`Department`', '`Department`', 200, 45, -1, false, '`Department`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestType
        $this->TestType = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, 45, -1, false, '`TestType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultDate
        $this->ResultDate = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_ResultDate', 'ResultDate', '`ResultDate`', CastDateFieldForLike("`ResultDate`", 0, "DB"), 135, 19, 0, false, '`ResultDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ResultedBy
        $this->ResultedBy = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_ResultedBy', 'ResultedBy', '`ResultedBy`', '`ResultedBy`', 200, 45, -1, false, '`ResultedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    // Master filter
    public function sqlMasterFilter_view_lab_services()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_lab_services()
    {
        return "`Vid`=@Vid@";
    }

    // Master filter
    public function sqlMasterFilter_view_labreport_print()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_view_labreport_print()
    {
        return "`Vid`=@Vid@";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_lab_resultreleased`";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`TestType` IN ('Lab Test' , 'Lab Profile', 'ProfileSubTest') ";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewLabResultreleasedList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewLabResultreleasedView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewLabResultreleasedEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewLabResultreleasedAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewLabResultreleasedView";
            case Config("API_ADD_ACTION"):
                return "ViewLabResultreleasedAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewLabResultreleasedEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewLabResultreleasedDelete";
            case Config("API_LIST_ACTION"):
                return "ViewLabResultreleasedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabResultreleasedView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabResultreleasedView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewLabResultreleasedAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewLabResultreleasedAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLabResultreleasedEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLabResultreleasedAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewLabResultreleasedDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "view_lab_services" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->Vid->CurrentValue ?? $this->Vid->getSessionValue());
        }
        if ($this->getCurrentMasterTable() == "view_labreport_print" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->Vid->CurrentValue ?? $this->Vid->getSessionValue());
        }
        return $url;
