 ...
 * Page class
 */
class CrmLeadsourceAdd extends CrmLeadsource
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CrmLeadsourceAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CrmLeadsourceView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->leadsourceid->OldValue = $this->leadsourceid->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['leadsourceid'] = $this->leadsourceid->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // leadsource
        $this->leadsource->setDbValueDef($rsnew, $this->leadsource->CurrentValue, "", false);
