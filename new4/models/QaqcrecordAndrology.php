 ...
 */
class QaqcrecordAndrology extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Date
        $this->Date = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_Date', 'Date', '`Date`', CastDateFieldForLike("`Date`", 0, "DB"), 133, 10, 0, false, '`Date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LN2_Level
        $this->LN2_Level = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_LN2_Level', 'LN2_Level', '`LN2_Level`', '`LN2_Level`', 131, 10, -1, false, '`LN2_Level`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LN2_Checked
        $this->LN2_Checked = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_LN2_Checked', 'LN2_Checked', '`LN2_Checked`', '`LN2_Checked`', 200, 45, -1, false, '`LN2_Checked`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // Incubator_Temp
        $this->Incubator_Temp = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_Incubator_Temp', 'Incubator_Temp', '`Incubator_Temp`', '`Incubator_Temp`', 131, 10, -1, false, '`Incubator_Temp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Incubator_Cleaned
        $this->Incubator_Cleaned = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_Incubator_Cleaned', 'Incubator_Cleaned', '`Incubator_Cleaned`', '`Incubator_Cleaned`', 200, 45, -1, false, '`Incubator_Cleaned`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // LAF_MG
        $this->LAF_MG = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_LAF_MG', 'LAF_MG', '`LAF_MG`', '`LAF_MG`', 131, 10, -1, false, '`LAF_MG`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LAF_Cleaned
        $this->LAF_Cleaned = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_LAF_Cleaned', 'LAF_Cleaned', '`LAF_Cleaned`', '`LAF_Cleaned`', 200, 45, -1, false, '`LAF_Cleaned`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // REF_Temp
        $this->REF_Temp = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_REF_Temp', 'REF_Temp', '`REF_Temp`', '`REF_Temp`', 131, 10, -1, false, '`REF_Temp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REF_Cleaned
        $this->REF_Cleaned = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_REF_Cleaned', 'REF_Cleaned', '`REF_Cleaned`', '`REF_Cleaned`', 200, 45, -1, false, '`REF_Cleaned`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // Heating_Temp
        $this->Heating_Temp = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_Heating_Temp', 'Heating_Temp', '`Heating_Temp`', '`Heating_Temp`', 131, 10, -1, false, '`Heating_Temp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Heating_Cleaned
        $this->Heating_Cleaned = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_Heating_Cleaned', 'Heating_Cleaned', '`Heating_Cleaned`', '`Heating_Cleaned`', 200, 45, -1, false, '`Heating_Cleaned`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // Createdby
        $this->Createdby = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_Createdby', 'Createdby', '`Createdby`', '`Createdby`', 200, 45, -1, false, '`Createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Createdby->Sortable = true; // Allow sort
        $this->Createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Createdby->Param, "CustomMsg");
        $this->Fields['Createdby'] = &$this->Createdby;

        // CreatedDate
        $this->CreatedDate = new DbField('qaqcrecord_andrology', 'qaqcrecord_andrology', 'x_CreatedDate', 'CreatedDate', '`CreatedDate`', CastDateFieldForLike("`CreatedDate`", 0, "DB"), 135, 19, 0, false, '`CreatedDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("QaqcrecordAndrologyList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "QaqcrecordAndrologyEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "QaqcrecordAndrologyAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "QaqcrecordAndrologyView";
            case Config("API_ADD_ACTION"):
                return "QaqcrecordAndrologyAdd";
            case Config("API_EDIT_ACTION"):
                return "QaqcrecordAndrologyEdit";
            case Config("API_DELETE_ACTION"):
                return "QaqcrecordAndrologyDelete";
            case Config("API_LIST_ACTION"):
                return "QaqcrecordAndrologyList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("QaqcrecordAndrologyView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("QaqcrecordAndrologyView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "QaqcrecordAndrologyAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "QaqcrecordAndrologyAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("QaqcrecordAndrologyEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("QaqcrecordAndrologyAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("QaqcrecordAndrologyDelete", $this->getUrlParm());
    }
