 ...
 * Page class
 */
class ViewPharmacyPharledReturnView extends ViewPharmacyPharledReturn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPharledReturnView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewPharmacyPharledReturnList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewPharmacyPharledReturnList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewPharmacyPharledReturnList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewPharmacyPharledReturnList"), "", $this->TableVar, true);
        $pageId = "view";
