...
class Doctors extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->start_time1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->start_time1->Param, "CustomMsg");
        ...
        $this->end_time1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->end_time1->Param, "CustomMsg");
        ...
        $this->start_time2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->start_time2->Param, "CustomMsg");
        ...
        $this->end_time2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->end_time2->Param, "CustomMsg");
        ...
        $this->slot_time->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->slot_time->Param, "CustomMsg");
        ...
        $this->Fees->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Fees->Param, "CustomMsg");
        ...
        $this->slot_days->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->slot_days->Param, "CustomMsg");
        ...
        $this->Designation->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Designation->Param, "CustomMsg");
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "appointment_scheduler") {
            $detailUrl = Container("appointment_scheduler")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "DoctorsList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DoctorsList");
    }
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("DoctorsEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("DoctorsAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
