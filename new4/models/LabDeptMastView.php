 ...
 * Page class
 */
class LabDeptMastView extends LabDeptMast
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabDeptMastView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LabDeptMastList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LabDeptMastList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "LabDeptMastList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
