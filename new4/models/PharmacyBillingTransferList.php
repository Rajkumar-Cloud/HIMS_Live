...
class PharmacyBillingTransferList extends PharmacyBillingTransfer
{
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PharmacyBillingTransferAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_pharmacytransfer')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewPharmacytransferList?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_transfer&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ViewPharmacytransferGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pharmacy_billing_transfer')) {
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pharmacy_billing_transfer')) {
            ...
            if ($detailPage->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pharmacy_billing_transfer')) {
    ...
    protected function setupOtherOptions()
    {
        ...
        $detailTableLink = "";
                ...
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'pharmacy_billing_transfer') && $Security->canAdd());
                if ($item->Visible) {
                    if ($detailTableLink != "") {
                        $detailTableLink .= ",";
                    }
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["view_pharmacytransfer"] && $this->DetailPages["view_pharmacytransfer"]->Visible) {
            ...
            $url = "ViewPharmacytransferPreview?t=pharmacy_billing_transfer&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'pharmacy_billing_transfer')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewPharmacytransferList?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_transfer&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
