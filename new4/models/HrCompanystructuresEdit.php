 ...
 * Page class
 */
class HrCompanystructuresEdit extends HrCompanystructures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrCompanystructuresEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("HrCompanystructuresList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "HrCompanystructuresList") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->heads->Required) {
            if (!$this->heads->IsDetailKey && EmptyValue($this->heads->FormValue)) {
                $this->heads->addErrorMessage(str_replace("%s", $this->heads->caption(), $this->heads->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // timezone
            $this->timezone->setDbValueDef($rsnew, $this->timezone->CurrentValue, "", $this->timezone->ReadOnly);

            // heads
            $this->heads->setDbValueDef($rsnew, $this->heads->CurrentValue, null, $this->heads->ReadOnly);
