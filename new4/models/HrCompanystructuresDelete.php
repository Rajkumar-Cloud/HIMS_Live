 ...
 * Page class
 */
class HrCompanystructuresDelete extends HrCompanystructures
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HrCompanystructuresDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HrCompanystructuresList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HrCompanystructuresList"); // Return to list
                return;
            }
        }
