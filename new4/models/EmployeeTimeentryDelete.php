 ...
 * Page class
 */
class EmployeeTimeentryDelete extends EmployeeTimeentry
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTimeentryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeTimeentryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeTimeentryList"); // Return to list
                return;
            }
        }
