...
/**
 * Table class for employee_address
 */
class EmployeeAddress extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_address';
        $this->TableName = 'employee_address';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`employee_address`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('employee_address', 'employee_address', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee_id
        $this->employee_id = new DbField('employee_address', 'employee_address', 'x_employee_id', 'employee_id', '`employee_id`', '`employee_id`', 3, 11, -1, false, '`employee_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // contact_persion
        $this->contact_persion = new DbField('employee_address', 'employee_address', 'x_contact_persion', 'contact_persion', '`contact_persion`', '`contact_persion`', 200, 100, -1, false, '`contact_persion`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->contact_persion->Nullable = false; // NOT NULL field
        $this->contact_persion->Required = true; // Required field
        $this->contact_persion->Sortable = true; // Allow sort
        $this->contact_persion->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->contact_persion->Param, "CustomMsg");
        $this->Fields['contact_persion'] = &$this->contact_persion;

        // street
        $this->street = new DbField('employee_address', 'employee_address', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('employee_address', 'employee_address', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // province
        $this->province = new DbField('employee_address', 'employee_address', 'x_province', 'province', '`province`', '`province`', 200, 50, -1, false, '`province`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postal_code
        $this->postal_code = new DbField('employee_address', 'employee_address', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 50, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // address_type
        $this->address_type = new DbField('employee_address', 'employee_address', 'x_address_type', 'address_type', '`address_type`', '`address_type`', 3, 11, -1, false, '`address_type`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->address_type->Nullable = false; // NOT NULL field
        $this->address_type->Required = true; // Required field
        $this->address_type->Sortable = true; // Allow sort
        $this->address_type->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->address_type->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->address_type->Lookup = new Lookup('address_type', 'sys_address_type', false, 'id', ["Name","","",""], [], [], [], [], [], [], '', '');
        $this->address_type->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->address_type->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->address_type->Param, "CustomMsg");
        $this->Fields['address_type'] = &$this->address_type;

        // status
        $this->status = new DbField('employee_address', 'employee_address', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // createdby
        $this->createdby = new DbField('employee_address', 'employee_address', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('employee_address', 'employee_address', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('employee_address', 'employee_address', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('employee_address', 'employee_address', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('employee_address', 'employee_address', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_address`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->contact_persion->DbValue = $row['contact_persion'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeAddressList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmployeeAddressView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmployeeAddressEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeAddressAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EmployeeAddressAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeAddressEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeAddressDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeAddressView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeAddressView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeAddressAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeAddressAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeAddressEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeAddressAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeAddressDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->contact_persion->EditValue = $this->contact_persion->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->contact_persion);
                    ...
                    $doc->exportCaption($this->address_type);
