 ...
 * Page class
 */
class IvfMasUserTemplateDelete extends IvfMasUserTemplate
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfMasUserTemplateDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IvfMasUserTemplateList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IvfMasUserTemplateList"); // Return to list
                return;
            }
        }
