...
class PharmacyStoremast extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Scheduling
        $this->Scheduling = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_Scheduling', 'Scheduling', '`Scheduling`', '`Scheduling`', 200, 45, -1, false, '`Scheduling`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->Scheduling->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Scheduling->Param, "CustomMsg");
        $this->Fields['Scheduling'] = &$this->Scheduling;

        // Schedulingh1
        $this->Schedulingh1 = new DbField('pharmacy_storemast', 'pharmacy_storemast', 'x_Schedulingh1', 'Schedulingh1', '`Schedulingh1`', '`Schedulingh1`', 200, 45, -1, false, '`Schedulingh1`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        $this->Schedulingh1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Schedulingh1->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyStoremastList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyStoremastView";
            case Config("API_ADD_ACTION"):
                return "PharmacyStoremastAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyStoremastEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyStoremastDelete";
