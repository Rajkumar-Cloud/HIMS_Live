 ...
 * Page class
 */
class IvfDonorsemendetailsView extends IvfDonorsemendetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfDonorsemendetailsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "IvfDonorsemendetailsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IvfDonorsemendetailsList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "IvfDonorsemendetailsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
