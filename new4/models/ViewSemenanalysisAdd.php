 ...
 * Page class
 */
class ViewSemenanalysisAdd extends ViewSemenanalysis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewSemenanalysisAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("ViewSemenanalysisList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ViewSemenanalysisList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ViewSemenanalysisView") {
