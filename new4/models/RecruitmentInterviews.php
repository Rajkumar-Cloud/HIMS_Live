...
/**
 * Table class for recruitment_interviews
 */
class RecruitmentInterviews extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'recruitment_interviews';
        $this->TableName = 'recruitment_interviews';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`recruitment_interviews`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // job
        $this->job = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_job', 'job', '`job`', '`job`', 20, 20, -1, false, '`job`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->job->Nullable = false; // NOT NULL field
        $this->job->Required = true; // Required field
        $this->job->Sortable = true; // Allow sort
        $this->job->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->job->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->job->Param, "CustomMsg");
        $this->Fields['job'] = &$this->job;

        // candidate
        $this->candidate = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_candidate', 'candidate', '`candidate`', '`candidate`', 20, 20, -1, false, '`candidate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->candidate->Sortable = true; // Allow sort
        $this->candidate->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->candidate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->candidate->Param, "CustomMsg");
        $this->Fields['candidate'] = &$this->candidate;

        // level
        $this->level = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_level', 'level', '`level`', '`level`', 200, 100, -1, false, '`level`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // created
        $this->created = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_created', 'created', '`created`', CastDateFieldForLike("`created`", 0, "DB"), 135, 19, 0, false, '`created`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // updated
        $this->updated = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_updated', 'updated', '`updated`', CastDateFieldForLike("`updated`", 0, "DB"), 135, 19, 0, false, '`updated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // scheduled
        $this->scheduled = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_scheduled', 'scheduled', '`scheduled`', CastDateFieldForLike("`scheduled`", 0, "DB"), 135, 19, 0, false, '`scheduled`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // location
        $this->location = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_location', 'location', '`location`', '`location`', 201, 500, -1, false, '`location`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // mapId
        $this->mapId = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_mapId', 'mapId', '`mapId`', '`mapId`', 20, 20, -1, false, '`mapId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mapId->Sortable = true; // Allow sort
        $this->mapId->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->mapId->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mapId->Param, "CustomMsg");
        $this->Fields['mapId'] = &$this->mapId;

        // status
        $this->status = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_status', 'status', '`status`', '`status`', 200, 100, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->status->Sortable = true; // Allow sort
        $this->status->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->status->Param, "CustomMsg");
        $this->Fields['status'] = &$this->status;

        // notes
        $this->notes = new DbField('recruitment_interviews', 'recruitment_interviews', 'x_notes', 'notes', '`notes`', '`notes`', 201, 65535, -1, false, '`notes`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`recruitment_interviews`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RecruitmentInterviewsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "RecruitmentInterviewsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RecruitmentInterviewsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "RecruitmentInterviewsView";
            case Config("API_ADD_ACTION"):
                return "RecruitmentInterviewsAdd";
            case Config("API_EDIT_ACTION"):
                return "RecruitmentInterviewsEdit";
            case Config("API_DELETE_ACTION"):
                return "RecruitmentInterviewsDelete";
            case Config("API_LIST_ACTION"):
                return "RecruitmentInterviewsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RecruitmentInterviewsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RecruitmentInterviewsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RecruitmentInterviewsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RecruitmentInterviewsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecruitmentInterviewsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecruitmentInterviewsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RecruitmentInterviewsDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->candidate->EditValue = $this->candidate->CurrentValue;
        ...
        $this->mapId->EditValue = $this->mapId->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->job);
                    $doc->exportCaption($this->candidate);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->job);
                        $doc->exportField($this->candidate);
