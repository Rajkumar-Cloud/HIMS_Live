 ...
 * Page class
 */
class ViewProcedureRegisteredList extends ViewProcedureRegistered
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewProcedureRegisteredList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewProcedureRegisteredAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewProcedureRegisteredDelete";
        $this->MultiUpdateUrl = "ViewProcedureRegisteredUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_procedure_registered"));
                $doc->Text = @$content;
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`ProcedureDateTime` DESC";
            if ($this->getSqlOrderBy() != "") {
                $useDefaultSort = true;
                if ($this->ProcedureDateTime->getSort() != "") {
