 ...
 * Page class
 */
class EmployeeLeavesDelete extends EmployeeLeaves
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeLeavesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeLeavesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeLeavesList"); // Return to list
                return;
            }
        }
