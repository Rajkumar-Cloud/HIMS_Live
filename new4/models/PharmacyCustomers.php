...
class PharmacyCustomers extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->CPPhone->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CPPhone->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyCustomersList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyCustomersView";
            case Config("API_ADD_ACTION"):
                return "PharmacyCustomersAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyCustomersEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyCustomersDelete";
