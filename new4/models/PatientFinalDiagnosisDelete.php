 ...
 * Page class
 */
class PatientFinalDiagnosisDelete extends PatientFinalDiagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientFinalDiagnosisDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientFinalDiagnosisList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientFinalDiagnosisList"); // Return to list
                return;
            }
        }
