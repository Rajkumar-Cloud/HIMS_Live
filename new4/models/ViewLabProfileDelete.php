 ...
 * Page class
 */
class ViewLabProfileDelete extends ViewLabProfile
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabProfileDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewLabProfileList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewLabProfileList"); // Return to list
                return;
            }
        }
