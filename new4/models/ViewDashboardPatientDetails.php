...
class ViewDashboardPatientDetails extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // createdDate
        $this->createdDate = new DbField('view_dashboard_patient_details', 'view_dashboard_patient_details', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike("`createdDate`", 7, "DB"), 133, 10, 7, false, '`createdDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_dashboard_patient_summary") {
            ...
            if ($this->WhereDidYouHear->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("`WhereDidYouHear`", $this->WhereDidYouHear->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "view_dashboard_patient_summary") {
            ...
            if ($this->WhereDidYouHear->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("`WhereDidYouHear`", $this->WhereDidYouHear->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDashboardPatientDetailsList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDashboardPatientDetailsView";
            case Config("API_ADD_ACTION"):
                return "ViewDashboardPatientDetailsAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDashboardPatientDetailsEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDashboardPatientDetailsDelete";
    ...
    {
        if ($this->getCurrentMasterTable() == "view_dashboard_patient_summary" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->CurrentValue ?? $this->createdDate->getSessionValue(), 7);
            $url .= "&" . GetForeignKeyUrl("fk_WhereDidYouHear", $this->WhereDidYouHear->CurrentValue ?? $this->WhereDidYouHear->getSessionValue());
        }
        return $url;
    }
