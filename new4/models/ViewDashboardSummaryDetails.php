...
/**
 * Table class for view_dashboard_summary_details
 */
class ViewDashboardSummaryDetails extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_dashboard_summary_details';
        $this->TableName = 'view_dashboard_summary_details';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_dashboard_summary_details`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // UserName
        $this->_UserName = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sum(Amount)
        $this->sumAmount = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_sumAmount', 'sum(Amount)', '`sum(Amount)`', '`sum(Amount)`', 131, 34, -1, false, '`sum(Amount)`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddate
        $this->createddate = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_createddate', 'createddate', '`createddate`', CastDateFieldForLike("`createddate`", 7, "DB"), 133, 10, 7, false, '`createddate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_dashboard_summary_details', 'view_dashboard_summary_details', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_dashboard_summary_modeofpayment_details") {
            $detailUrl = Container("view_dashboard_summary_modeofpayment_details")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
        ...
        if ($detailUrl == "") {
            $detailUrl = "ViewDashboardSummaryDetailsList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_dashboard_summary_details`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDashboardSummaryDetailsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDashboardSummaryDetailsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDashboardSummaryDetailsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDashboardSummaryDetailsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDashboardSummaryDetailsView";
            case Config("API_ADD_ACTION"):
                return "ViewDashboardSummaryDetailsAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDashboardSummaryDetailsEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDashboardSummaryDetailsDelete";
            case Config("API_LIST_ACTION"):
                return "ViewDashboardSummaryDetailsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDashboardSummaryDetailsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDashboardSummaryDetailsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDashboardSummaryDetailsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDashboardSummaryDetailsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardSummaryDetailsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardSummaryDetailsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDashboardSummaryDetailsDelete", $this->getUrlParm());
    }
