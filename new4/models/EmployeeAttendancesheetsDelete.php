 ...
 * Page class
 */
class EmployeeAttendancesheetsDelete extends EmployeeAttendancesheets
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeAttendancesheetsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeAttendancesheetsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeAttendancesheetsList"); // Return to list
                return;
            }
        }
