 ...
 * Page class
 */
class ViewStoreTransferSearch extends ViewStoreTransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewStoreTransferSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "ViewStoreTransferList" . "?" . $srchStr;
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->strid->AdvancedSearch->post()) {
            $hasValue = true;
        }
