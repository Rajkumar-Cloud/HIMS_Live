...
class ViewDonorIvf extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Fgender->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Fgender->Param, "CustomMsg");
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `femalepic`, '' AS `Fgender`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDonorIvfList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDonorIvfView";
            case Config("API_ADD_ACTION"):
                return "ViewDonorIvfAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDonorIvfEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDonorIvfDelete";
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("ViewDonorIvfEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("ViewDonorIvfAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
