 ...
 * Page class
 */
class IvfEmbryologyChartPreview extends IvfEmbryologyChart
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfEmbryologyChartPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "ivf_oocytedenudation") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ivf_oocytedenudation&" . GetForeignKeyUrl("fk_id", $this->DidNO->QueryStringValue) . "";
        }
        return $url;
    }
