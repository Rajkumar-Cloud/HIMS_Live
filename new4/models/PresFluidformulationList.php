 ...
 * Page class
 */
class PresFluidformulationList extends PresFluidformulation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresFluidformulationList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PresFluidformulationAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PresFluidformulationDelete";
        $this->MultiUpdateUrl = "PresFluidformulationUpdate";
