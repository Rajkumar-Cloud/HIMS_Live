 ...
 * Page class
 */
class MasReferenceTypeDelete extends MasReferenceType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasReferenceTypeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MasReferenceTypeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MasReferenceTypeList"); // Return to list
                return;
            }
        }
