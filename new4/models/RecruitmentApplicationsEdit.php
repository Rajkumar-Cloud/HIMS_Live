 ...
 * Page class
 */
class RecruitmentApplicationsEdit extends RecruitmentApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecruitmentApplicationsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("RecruitmentApplicationsList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "RecruitmentApplicationsList") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->referredByEmail->Required) {
            if (!$this->referredByEmail->IsDetailKey && EmptyValue($this->referredByEmail->FormValue)) {
                $this->referredByEmail->addErrorMessage(str_replace("%s", $this->referredByEmail->caption(), $this->referredByEmail->RequiredErrorMessage));
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RecruitmentApplicationsList"), "", $this->TableVar, true);
        $pageId = "edit";
