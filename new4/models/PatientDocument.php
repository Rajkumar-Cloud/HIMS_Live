 ...
 */
class PatientDocument extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PatientDocumentList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PatientDocumentView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PatientDocumentEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PatientDocumentAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PatientDocumentView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PatientDocumentView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PatientDocumentAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PatientDocumentAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientDocumentEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientDocumentAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PatientDocumentDelete", $this->getUrlParm());
    }
