 ...
 * Page class
 */
class ViewTemplateForEtList extends ViewTemplateForEt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewTemplateForEtList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewTemplateForEtAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewTemplateForEtDelete";
        $this->MultiUpdateUrl = "ViewTemplateForEtUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_template_for_et"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->toJson(), ","); // Field FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
        ...
        $filterList = Concat($filterList, $this->MISCARRIAGEEARLYLATE->AdvancedSearch->toJson(), ","); // Field MISCARRIAGE EARLY / LATE
        $filterList = Concat($filterList, $this->ANC->AdvancedSearch->toJson(), ","); // Field ANC
        $filterList = Concat($filterList, $this->NICUADMISSION->AdvancedSearch->toJson(), ","); // Field NICU ADMISSION
        ...
        $filterList = Concat($filterList, $this->DELIVEREDHOSPITAL->AdvancedSearch->toJson(), ","); // Field DELIVERED HOSPITAL
    ...
    protected function restoreFilterList()
    {
        ...
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchValue = @$filter["x_FRESHETFETFRESHODETODFETFRESHDETFROZENDET"];
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchOperator = @$filter["z_FRESHETFETFRESHODETODFETFRESHDETFROZENDET"];
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchCondition = @$filter["v_FRESHETFETFRESHODETODFETFRESHDETFROZENDET"];
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchValue2 = @$filter["y_FRESHETFETFRESHODETODFETFRESHDETFROZENDET"];
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchOperator2 = @$filter["w_FRESHETFETFRESHODETODFETFRESHDETFROZENDET"];
        $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->save();
        ...
        $this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchValue = @$filter["x_MISCARRIAGEEARLYLATE"];
        $this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchOperator = @$filter["z_MISCARRIAGEEARLYLATE"];
        $this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchCondition = @$filter["v_MISCARRIAGEEARLYLATE"];
        $this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchValue2 = @$filter["y_MISCARRIAGEEARLYLATE"];
        $this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchOperator2 = @$filter["w_MISCARRIAGEEARLYLATE"];
        $this->MISCARRIAGEEARLYLATE->AdvancedSearch->save();
        ...
        $this->NICUADMISSION->AdvancedSearch->SearchValue = @$filter["x_NICUADMISSION"];
        $this->NICUADMISSION->AdvancedSearch->SearchOperator = @$filter["z_NICUADMISSION"];
        $this->NICUADMISSION->AdvancedSearch->SearchCondition = @$filter["v_NICUADMISSION"];
        $this->NICUADMISSION->AdvancedSearch->SearchValue2 = @$filter["y_NICUADMISSION"];
        $this->NICUADMISSION->AdvancedSearch->SearchOperator2 = @$filter["w_NICUADMISSION"];
        $this->NICUADMISSION->AdvancedSearch->save();
        ...
        $this->DELIVEREDHOSPITAL->AdvancedSearch->SearchValue = @$filter["x_DELIVEREDHOSPITAL"];
        $this->DELIVEREDHOSPITAL->AdvancedSearch->SearchOperator = @$filter["z_DELIVEREDHOSPITAL"];
        $this->DELIVEREDHOSPITAL->AdvancedSearch->SearchCondition = @$filter["v_DELIVEREDHOSPITAL"];
        $this->DELIVEREDHOSPITAL->AdvancedSearch->SearchValue2 = @$filter["y_DELIVEREDHOSPITAL"];
        $this->DELIVEREDHOSPITAL->AdvancedSearch->SearchOperator2 = @$filter["w_DELIVEREDHOSPITAL"];
        $this->DELIVEREDHOSPITAL->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET, $default, false); // FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
        ...
        $this->buildSearchSql($where, $this->MISCARRIAGEEARLYLATE, $default, false); // MISCARRIAGE EARLY / LATE
        $this->buildSearchSql($where, $this->ANC, $default, false); // ANC
        $this->buildSearchSql($where, $this->NICUADMISSION, $default, false); // NICU ADMISSION
        ...
        $this->buildSearchSql($where, $this->DELIVEREDHOSPITAL, $default, false); // DELIVERED HOSPITAL
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->save(); // FRESH ET/ FET/ FRESH OD ET/ OD FET / FRESH DET/ FROZEN DET
            ...
            $this->MISCARRIAGEEARLYLATE->AdvancedSearch->save(); // MISCARRIAGE EARLY / LATE
            $this->ANC->AdvancedSearch->save(); // ANC
            $this->NICUADMISSION->AdvancedSearch->save(); // NICU ADMISSION
            ...
            $this->DELIVEREDHOSPITAL->AdvancedSearch->save(); // DELIVERED HOSPITAL
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->MISCARRIAGEEARLYLATE, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->ANC, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->NICUADMISSION, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->DELIVEREDHOSPITAL, $arKeywords, $type);
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->MISCARRIAGEEARLYLATE->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->ANC->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->NICUADMISSION->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->DELIVEREDHOSPITAL->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->unsetSession();
                ...
                $this->MISCARRIAGEEARLYLATE->AdvancedSearch->unsetSession();
                $this->ANC->AdvancedSearch->unsetSession();
                $this->NICUADMISSION->AdvancedSearch->unsetSession();
                ...
                $this->DELIVEREDHOSPITAL->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->load();
                ...
                $this->MISCARRIAGEEARLYLATE->AdvancedSearch->load();
                $this->ANC->AdvancedSearch->load();
                $this->NICUADMISSION->AdvancedSearch->load();
                ...
                $this->DELIVEREDHOSPITAL->AdvancedSearch->load();
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->setSort("");
                ...
                $this->MISCARRIAGEEARLYLATE->setSort("");
                $this->ANC->setSort("");
                $this->NICUADMISSION->setSort("");
                $this->anomalies->setSort("");
                $this->babywt->setSort("");
                $this->GAatdelivery->setSort("");
                $this->Pregnancyoutcome->setSort("");
                $this->DELIVEREDHOSPITAL->setSort("");
                $this->DOCTOR->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_template_for_etlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_template_for_etlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fview_template_for_etlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadSearchValues()
    {
        ...
        if (!$this->isAddOrEdit() && $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchValue != "" || $this->FRESHETFETFRESHODETODFETFRESHDETFROZENDET->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if (!$this->isAddOrEdit() && $this->MISCARRIAGEEARLYLATE->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchValue != "" || $this->MISCARRIAGEEARLYLATE->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // NICU ADMISSION
        if (!$this->isAddOrEdit() && $this->NICUADMISSION->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->NICUADMISSION->AdvancedSearch->SearchValue != "" || $this->NICUADMISSION->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // DELIVERED HOSPITAL
        if (!$this->isAddOrEdit() && $this->DELIVEREDHOSPITAL->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->DELIVEREDHOSPITAL->AdvancedSearch->SearchValue != "" || $this->DELIVEREDHOSPITAL->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fview_template_for_etlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fview_template_for_etlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fview_template_for_etlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_template_for_etlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
