 ...
 * Page class
 */
class MasActivityCardList extends MasActivityCard
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasActivityCardList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "MasActivityCardAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MasActivityCardDelete";
        $this->MultiUpdateUrl = "MasActivityCardUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("mas_activity_card"));
                $doc->Text = @$content;
