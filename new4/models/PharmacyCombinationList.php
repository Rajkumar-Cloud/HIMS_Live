 ...
 * Page class
 */
class PharmacyCombinationList extends PharmacyCombination
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyCombinationList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PharmacyCombinationAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PharmacyCombinationDelete";
        $this->MultiUpdateUrl = "PharmacyCombinationUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("pharmacy_combination"));
                $doc->Text = @$content;
