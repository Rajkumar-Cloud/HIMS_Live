 ...
 * Page class
 */
class ViewPharmacyPharledReturnDelete extends ViewPharmacyPharledReturn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPharledReturnDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewPharmacyPharledReturnList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewPharmacyPharledReturnList"); // Return to list
                return;
            }
        }
