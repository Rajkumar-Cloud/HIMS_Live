 ...
 * Page class
 */
class EmployeeCertificationsAdd extends EmployeeCertifications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeCertificationsAdd";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("employee_certifications"));
                $doc->Text = @$content;
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmployeeCertificationsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmployeeCertificationsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmployeeCertificationsView") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->certification_id->Required) {
            if (!$this->certification_id->IsDetailKey && EmptyValue($this->certification_id->FormValue)) {
                $this->certification_id->addErrorMessage(str_replace("%s", $this->certification_id->caption(), $this->certification_id->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->certification_id->FormValue)) {
            $this->certification_id->addErrorMessage($this->certification_id->getErrorMessage(false));
        }
        ...
        if ($this->institute->Required) {
            if (!$this->institute->IsDetailKey && EmptyValue($this->institute->FormValue)) {
                $this->institute->addErrorMessage(str_replace("%s", $this->institute->caption(), $this->institute->RequiredErrorMessage));
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmployeeCertificationsList"), "", $this->TableVar, true);
