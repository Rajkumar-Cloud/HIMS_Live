...
class ViewPharmacySales extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // BILLNO
        $this->BILLNO = new DbField('view_pharmacy_sales', 'view_pharmacy_sales', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, 50, -1, false, '`BILLNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SiNo
        $this->SiNo = new DbField('view_pharmacy_sales', 'view_pharmacy_sales', 'x_SiNo', 'SiNo', '`SiNo`', '`SiNo`', 3, 11, -1, false, '`SiNo`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Taxable
        $this->Taxable = new DbField('view_pharmacy_sales', 'view_pharmacy_sales', 'x_Taxable', 'Taxable', '`Taxable`', '`Taxable`', 200, 25, -1, false, '`Taxable`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Taxable->Sortable = true; // Allow sort
        $this->Taxable->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Taxable->Param, "CustomMsg");
        ...
        $this->PAMT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PAMT->Param, "CustomMsg");
        ...
        $this->PSGSTAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PSGSTAmount->Param, "CustomMsg");
        ...
        $this->PCGSTAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PCGSTAmount->Param, "CustomMsg");
        $this->Fields['PCGSTAmount'] = &$this->PCGSTAmount;

        // SSGSTAmount
        $this->SSGSTAmount = new DbField('view_pharmacy_sales', 'view_pharmacy_sales', 'x_SSGSTAmount', 'SSGSTAmount', '`SSGSTAmount`', '`SSGSTAmount`', 131, 25, -1, false, '`SSGSTAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->SSGSTAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SSGSTAmount->Param, "CustomMsg");
        $this->Fields['SSGSTAmount'] = &$this->SSGSTAmount;

        // SCGSTAmount
        $this->SCGSTAmount = new DbField('view_pharmacy_sales', 'view_pharmacy_sales', 'x_SCGSTAmount', 'SCGSTAmount', '`SCGSTAmount`', '`SCGSTAmount`', 131, 25, -1, false, '`SCGSTAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->SCGSTAmount->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SCGSTAmount->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacySalesList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacySalesView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacySalesAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacySalesEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacySalesDelete";
