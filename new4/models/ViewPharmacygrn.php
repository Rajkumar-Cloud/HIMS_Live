...
class ViewPharmacygrn extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // FreeQtyyy
        $this->FreeQtyyy = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_FreeQtyyy', 'FreeQtyyy', '`FreeQtyyy`', '`FreeQtyyy`', 3, 11, -1, false, '`FreeQtyyy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 7, "DB"), 135, 19, 7, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GRNPer
        $this->GRNPer = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_GRNPer', 'GRNPer', '`GRNPer`', '`GRNPer`', 131, 12, -1, false, '`GRNPer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Disc
        $this->Disc = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, 45, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grndate
        $this->grndate = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grndate', 'grndate', '`grndate`', CastDateFieldForLike("`grndate`", 0, "DB"), 133, 10, 0, false, '`grndate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grndatetime
        $this->grndatetime = new DbField('view_pharmacygrn', 'view_pharmacygrn', 'x_grndatetime', 'grndatetime', '`grndatetime`', CastDateFieldForLike("`grndatetime`", 0, "DB"), 135, 19, 0, false, '`grndatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacygrnList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacygrnView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacygrnAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacygrnEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacygrnDelete";
    ...
    {
        if ($this->getCurrentMasterTable() == "pharmacy_grn" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
