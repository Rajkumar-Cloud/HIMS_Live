 ...
 * Page class
 */
class PresGenericinteractionsView extends PresGenericinteractions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresGenericinteractionsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PresGenericinteractionsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PresGenericinteractionsList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PresGenericinteractionsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
