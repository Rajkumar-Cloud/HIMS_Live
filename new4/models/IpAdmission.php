...
class IpAdmission extends DbTable
{
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "patient_vitals") {
            ...
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_history") {
            $detailUrl = Container("patient_history")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_provisional_diagnosis") {
            $detailUrl = Container("patient_provisional_diagnosis")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_prescription") {
            $detailUrl = Container("patient_prescription")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_final_diagnosis") {
            $detailUrl = Container("patient_final_diagnosis")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_follow_up") {
            $detailUrl = Container("patient_follow_up")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_ot_delivery_register") {
            $detailUrl = Container("patient_ot_delivery_register")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_ot_surgery_register") {
            $detailUrl = Container("patient_ot_surgery_register")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
        }
        ...
        if ($this->getCurrentDetailTable() == "patient_investigations") {
            $detailUrl = Container("patient_investigations")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_insurance") {
            $detailUrl = Container("patient_insurance")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
        }
        ...
        if ($this->getCurrentDetailTable() == "view_ip_advance") {
            $detailUrl = Container("view_ip_advance")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "patient_room") {
            $detailUrl = Container("patient_room")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnNo->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_patient_id", $this->patient_id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "IpAdmissionList";
        }
        return $detailUrl;
    }
    ...
    protected function useVirtualFields()
    {
        ...
        if (
            $this->ReferA4TreatingConsultant->AdvancedSearch->SearchValue != "" ||
        ...
        if (
            $this->patient_id->AdvancedSearch->SearchValue != "" ||
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("IpAdmissionList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "IpAdmissionView";
            case Config("API_ADD_ACTION"):
                return "IpAdmissionAdd";
            case Config("API_EDIT_ACTION"):
                return "IpAdmissionEdit";
            case Config("API_DELETE_ACTION"):
                return "IpAdmissionDelete";
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("IpAdmissionEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("IpAdmissionAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
