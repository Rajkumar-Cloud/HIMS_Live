...
class ViewIvfTreatment extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // status1
        $this->status1 = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_status1', 'status1', '`status1`', '`status1`', 3, 11, -1, false, '`status1`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->status1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->status1->Param, "CustomMsg");
        ...
        $this->id1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id1->Param, "CustomMsg");
        $this->Fields['id1'] = &$this->id1;

        // Male
        $this->Male = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_Male', 'Male', '`Male`', '`Male`', 3, 11, -1, false, '`EV__Male`', true, true, true, 'FORMATTED TEXT', 'SELECT');
        ...
        // Female
        $this->Female = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_Female', 'Female', '`Female`', '`Female`', 3, 11, -1, false, '`EV__Female`', true, true, true, 'FORMATTED TEXT', 'SELECT');
        ...
        // malepropic
        $this->malepropic = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_malepropic', 'malepropic', '`malepropic`', '`malepropic`', 201, 450, -1, true, '`malepropic`', false, false, false, 'IMAGE', 'FILE');
        ...
        // femalepropic
        $this->femalepropic = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_femalepropic', 'femalepropic', '`femalepropic`', '`femalepropic`', 201, 450, -1, true, '`femalepropic`', false, false, false, 'IMAGE', 'FILE');
        ...
        // ReferedBy
        $this->ReferedBy = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_ReferedBy', 'ReferedBy', '`ReferedBy`', '`ReferedBy`', 200, 45, -1, false, '`EV__ReferedBy`', true, true, true, 'FORMATTED TEXT', 'SELECT');
        ...
        // ARTCYCLE1
        $this->ARTCYCLE1 = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_ARTCYCLE1', 'ARTCYCLE1', '`ARTCYCLE1`', '`ARTCYCLE1`', 200, 45, -1, false, '`ARTCYCLE1`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->ARTCYCLE1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ARTCYCLE1->Param, "CustomMsg");
        $this->Fields['ARTCYCLE1'] = &$this->ARTCYCLE1;

        // RESULT1
        $this->RESULT1 = new DbField('view_ivf_treatment', 'view_ivf_treatment', 'x_RESULT1', 'RESULT1', '`RESULT1`', '`RESULT1`', 200, 45, -1, false, '`RESULT1`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->RESULT1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RESULT1->Param, "CustomMsg");
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "ivf_oocytedenudation") {
            $detailUrl = Container("ivf_oocytedenudation")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_RIDNO", $this->RIDNO->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_Name", $this->Name->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewIvfTreatmentList";
        }
        return $detailUrl;
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->id1->CurrentValue : $this->id1->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->id1->CurrentValue = $keys[1];
            } else {
                $this->id1->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewIvfTreatmentList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewIvfTreatmentView";
            case Config("API_ADD_ACTION"):
                return "ViewIvfTreatmentAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewIvfTreatmentEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewIvfTreatmentDelete";
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("ViewIvfTreatmentEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("ViewIvfTreatmentAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
