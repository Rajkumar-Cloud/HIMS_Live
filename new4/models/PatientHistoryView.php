 ...
 * Page class
 */
class PatientHistoryView extends PatientHistory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientHistoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientHistoryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientHistoryList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientHistoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
