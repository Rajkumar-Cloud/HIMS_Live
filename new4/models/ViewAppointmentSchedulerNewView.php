 ...
 * Page class
 */
class ViewAppointmentSchedulerNewView extends ViewAppointmentSchedulerNew
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAppointmentSchedulerNewView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "ViewAppointmentSchedulerNewList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewAppointmentSchedulerNewList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewAppointmentSchedulerNewList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
