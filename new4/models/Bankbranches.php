...
/**
 * Table class for bankbranches
 */
class Bankbranches extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'bankbranches';
        $this->TableName = 'bankbranches';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`bankbranches`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('bankbranches', 'bankbranches', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // Branch_Name
        $this->Branch_Name = new DbField('bankbranches', 'bankbranches', 'x_Branch_Name', 'Branch_Name', '`Branch_Name`', '`Branch_Name`', 200, 45, -1, false, '`Branch_Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Branch_Name->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Branch_Name->Param, "CustomMsg");
        $this->Fields['Branch_Name'] = &$this->Branch_Name;

        // Street_Address
        $this->Street_Address = new DbField('bankbranches', 'bankbranches', 'x_Street_Address', 'Street_Address', '`Street_Address`', '`Street_Address`', 200, 50, -1, false, '`Street_Address`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // City
        $this->City = new DbField('bankbranches', 'bankbranches', 'x_City', 'City', '`City`', '`City`', 200, 25, -1, false, '`City`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // State
        $this->State = new DbField('bankbranches', 'bankbranches', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Zipcode
        $this->Zipcode = new DbField('bankbranches', 'bankbranches', 'x_Zipcode', 'Zipcode', '`Zipcode`', '`Zipcode`', 200, 45, -1, false, '`Zipcode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Phone_Number
        $this->Phone_Number = new DbField('bankbranches', 'bankbranches', 'x_Phone_Number', 'Phone_Number', '`Phone_Number`', '`Phone_Number`', 200, 12, -1, false, '`Phone_Number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AccountNo
        $this->AccountNo = new DbField('bankbranches', 'bankbranches', 'x_AccountNo', 'AccountNo', '`AccountNo`', '`AccountNo`', 200, 45, -1, false, '`AccountNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`bankbranches`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BankbranchesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BankbranchesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BankbranchesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BankbranchesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BankbranchesView";
            case Config("API_ADD_ACTION"):
                return "BankbranchesAdd";
            case Config("API_EDIT_ACTION"):
                return "BankbranchesEdit";
            case Config("API_DELETE_ACTION"):
                return "BankbranchesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BankbranchesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BankbranchesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BankbranchesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BankbranchesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("BankbranchesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BankbranchesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BankbranchesDelete", $this->getUrlParm());
    }
