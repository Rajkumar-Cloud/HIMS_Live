 ...
 * Page class
 */
class ViewIvfTreatmentPlanAdd extends ViewIvfTreatmentPlan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIvfTreatmentPlanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ViewIvfTreatmentPlanView") {
