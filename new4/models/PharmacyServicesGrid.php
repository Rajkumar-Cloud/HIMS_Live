 ...
 * Page class
 */
class PharmacyServicesGrid extends PharmacyServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyServicesGrid";
    ...
    public function resetFormError()
    {
        ...
        $this->pharmacy_id->clearErrorMessage();
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // pharmacy_id
            if ($this->pharmacy_id->getSessionValue() != "") {
                $this->pharmacy_id->ReadOnly = true;
            }
