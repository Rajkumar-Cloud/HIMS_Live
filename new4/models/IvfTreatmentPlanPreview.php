 ...
 * Page class
 */
class IvfTreatmentPlanPreview extends IvfTreatmentPlan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfTreatmentPlanPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        $url = "";
        if ($masterTblVar == "ivf") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ivf&" . GetForeignKeyUrl("fk_id", $this->RIDNO->QueryStringValue) . "&" . GetForeignKeyUrl("fk_Female", $this->Name->QueryStringValue) . "";
        }
        if ($masterTblVar == "view_donor_ivf") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_donor_ivf&" . GetForeignKeyUrl("fk_id", $this->RIDNO->QueryStringValue) . "&" . GetForeignKeyUrl("fk_Female", $this->Name->QueryStringValue) . "";
        }
        return $url;
    }
