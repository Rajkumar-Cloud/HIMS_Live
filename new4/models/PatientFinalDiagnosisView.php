 ...
 * Page class
 */
class PatientFinalDiagnosisView extends PatientFinalDiagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientFinalDiagnosisView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PatientFinalDiagnosisList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PatientFinalDiagnosisList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PatientFinalDiagnosisList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
