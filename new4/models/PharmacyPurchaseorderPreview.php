 ...
 * Page class
 */
class PharmacyPurchaseorderPreview extends PharmacyPurchaseorder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPurchaseorderPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_po") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_po&" . GetForeignKeyUrl("fk_id", $this->poid->QueryStringValue) . "";
        }
        return $url;
    }
