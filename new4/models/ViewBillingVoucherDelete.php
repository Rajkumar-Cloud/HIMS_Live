 ...
 * Page class
 */
class ViewBillingVoucherDelete extends ViewBillingVoucher
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewBillingVoucherDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewBillingVoucherList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewBillingVoucherList"); // Return to list
                return;
            }
        }
