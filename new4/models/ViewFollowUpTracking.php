...
class ViewFollowUpTracking extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewFollowUpTrackingList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewFollowUpTrackingView";
            case Config("API_ADD_ACTION"):
                return "ViewFollowUpTrackingAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewFollowUpTrackingEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewFollowUpTrackingDelete";
