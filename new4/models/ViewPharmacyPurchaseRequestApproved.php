 ...
 */
class ViewPharmacyPurchaseRequestApproved extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "view_pharmacy_purchase_request_items_approved") {
            $detailUrl = Container("view_pharmacy_purchase_request_items_approved")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewPharmacyPurchaseRequestApprovedList";
        }
        return $detailUrl;
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HospID`='".HospitalID()."' and `ApprovedStatus` is null";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyPurchaseRequestApprovedList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewPharmacyPurchaseRequestApprovedEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyPurchaseRequestApprovedAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyPurchaseRequestApprovedView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyPurchaseRequestApprovedAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyPurchaseRequestApprovedEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyPurchaseRequestApprovedDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyPurchaseRequestApprovedList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyPurchaseRequestApprovedView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyPurchaseRequestApprovedView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyPurchaseRequestApprovedAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyPurchaseRequestApprovedAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyPurchaseRequestApprovedEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyPurchaseRequestApprovedEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyPurchaseRequestApprovedAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyPurchaseRequestApprovedAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyPurchaseRequestApprovedDelete", $this->getUrlParm());
    }
