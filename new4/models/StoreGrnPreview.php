 ...
 * Page class
 */
class StoreGrnPreview extends StoreGrn
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreGrnPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "store_payment") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=store_payment&" . GetForeignKeyUrl("fk_id", $this->Pid->QueryStringValue) . "";
        }
        return $url;
    }
