 ...
 */
class ViewDashboardSummaryPaymentMode extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // UserName
        $this->_UserName = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($detailUrl == "") {
            $detailUrl = "ViewDashboardSummaryPaymentModeList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewDashboardSummaryPaymentModeList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewDashboardSummaryPaymentModeView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewDashboardSummaryPaymentModeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDashboardSummaryPaymentModeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewDashboardSummaryPaymentModeView";
            case Config("API_ADD_ACTION"):
                return "ViewDashboardSummaryPaymentModeAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewDashboardSummaryPaymentModeEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewDashboardSummaryPaymentModeDelete";
            case Config("API_LIST_ACTION"):
                return "ViewDashboardSummaryPaymentModeList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDashboardSummaryPaymentModeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDashboardSummaryPaymentModeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDashboardSummaryPaymentModeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDashboardSummaryPaymentModeAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardSummaryPaymentModeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDashboardSummaryPaymentModeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDashboardSummaryPaymentModeDelete", $this->getUrlParm());
    }
