 ...
 */
class StorePurchaseorder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // ORDNO
        $this->ORDNO = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, 5, -1, false, '`ORDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QTY
        $this->QTY = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_QTY', 'QTY', '`QTY`', '`QTY`', 3, 11, -1, false, '`QTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YM
        $this->YM = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_YM', 'YM', '`YM`', '`YM`', 200, 6, -1, false, '`YM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Stock
        $this->Stock = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 3, 11, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LastMonthSale
        $this->LastMonthSale = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_LastMonthSale', 'LastMonthSale', '`LastMonthSale`', '`LastMonthSale`', 3, 11, -1, false, '`LastMonthSale`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Printcheck
        $this->Printcheck = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Printcheck', 'Printcheck', '`Printcheck`', '`Printcheck`', 200, 50, -1, false, '`Printcheck`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // poid
        $this->poid = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_poid', 'poid', '`poid`', '`poid`', 3, 11, -1, false, '`poid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnid
        $this->grnid = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grnid', 'grnid', '`grnid`', '`grnid`', 3, 11, -1, false, '`grnid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BatchNo
        $this->BatchNo = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, 45, -1, false, '`BatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 0, "DB"), 135, 19, 0, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Quantity
        $this->Quantity = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Quantity', 'Quantity', '`Quantity`', '`Quantity`', 3, 11, -1, false, '`Quantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FreeQty
        $this->FreeQty = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_FreeQty', 'FreeQty', '`FreeQty`', '`FreeQty`', 3, 11, -1, false, '`FreeQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ItemValue
        $this->ItemValue = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_ItemValue', 'ItemValue', '`ItemValue`', '`ItemValue`', 131, 12, -1, false, '`ItemValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Disc
        $this->Disc = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, 45, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PTax
        $this->PTax = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PTax', 'PTax', '`PTax`', '`PTax`', 131, 12, -1, false, '`PTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRP
        $this->MRP = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalTax
        $this->SalTax = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_SalTax', 'SalTax', '`SalTax`', '`SalTax`', 131, 12, -1, false, '`SalTax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurRate
        $this->PurRate = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PurRate', 'PurRate', '`PurRate`', '`PurRate`', 131, 12, -1, false, '`PurRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalRate
        $this->SalRate = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, 12, -1, false, '`SalRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Discount
        $this->Discount = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Discount', 'Discount', '`Discount`', '`Discount`', 131, 12, -1, false, '`Discount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HSN
        $this->HSN = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, 45, -1, false, '`HSN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pack
        $this->Pack = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Pack', 'Pack', '`Pack`', '`Pack`', 200, 45, -1, false, '`Pack`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUnit
        $this->SUnit = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_SUnit', 'SUnit', '`SUnit`', '`SUnit`', 3, 11, -1, false, '`SUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnQuantity
        $this->GrnQuantity = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_GrnQuantity', 'GrnQuantity', '`GrnQuantity`', '`GrnQuantity`', 3, 11, -1, false, '`GrnQuantity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GrnMRP
        $this->GrnMRP = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_GrnMRP', 'GrnMRP', '`GrnMRP`', '`GrnMRP`', 131, 12, -1, false, '`GrnMRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // trid
        $this->trid = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_trid', 'trid', '`trid`', '`trid`', 3, 11, -1, false, '`trid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedBy
        $this->CreatedBy = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_CreatedBy', 'CreatedBy', '`CreatedBy`', '`CreatedBy`', 3, 11, -1, false, '`CreatedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CreatedDateTime
        $this->CreatedDateTime = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_CreatedDateTime', 'CreatedDateTime', '`CreatedDateTime`', CastDateFieldForLike("`CreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`CreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedBy
        $this->ModifiedBy = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_ModifiedBy', 'ModifiedBy', '`ModifiedBy`', '`ModifiedBy`', 3, 11, -1, false, '`ModifiedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModifiedDateTime
        $this->ModifiedDateTime = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_ModifiedDateTime', 'ModifiedDateTime', '`ModifiedDateTime`', CastDateFieldForLike("`ModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`ModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedby
        $this->grncreatedby = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grncreatedby', 'grncreatedby', '`grncreatedby`', '`grncreatedby`', 3, 11, -1, false, '`grncreatedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grncreatedDateTime
        $this->grncreatedDateTime = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grncreatedDateTime', 'grncreatedDateTime', '`grncreatedDateTime`', CastDateFieldForLike("`grncreatedDateTime`", 0, "DB"), 135, 19, 0, false, '`grncreatedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnModifiedby
        $this->grnModifiedby = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grnModifiedby', 'grnModifiedby', '`grnModifiedby`', '`grnModifiedby`', 3, 11, -1, false, '`grnModifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grnModifiedDateTime
        $this->grnModifiedDateTime = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grnModifiedDateTime', 'grnModifiedDateTime', '`grnModifiedDateTime`', CastDateFieldForLike("`grnModifiedDateTime`", 0, "DB"), 135, 19, 0, false, '`grnModifiedDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Received
        $this->Received = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_Received', 'Received', '`Received`', '`Received`', 200, 45, -1, false, '`Received`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillDate
        $this->BillDate = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike("`BillDate`", 0, "DB"), 135, 19, 0, false, '`BillDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CurStock
        $this->CurStock = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_CurStock', 'CurStock', '`CurStock`', '`CurStock`', 3, 11, -1, false, '`CurStock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FreeQtyyy
        $this->FreeQtyyy = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_FreeQtyyy', 'FreeQtyyy', '`FreeQtyyy`', '`FreeQtyyy`', 3, 11, -1, false, '`FreeQtyyy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->FreeQtyyy->Sortable = true; // Allow sort
        $this->FreeQtyyy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->FreeQtyyy->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->FreeQtyyy->Param, "CustomMsg");
        $this->Fields['FreeQtyyy'] = &$this->FreeQtyyy;

        // grndate
        $this->grndate = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grndate', 'grndate', '`grndate`', CastDateFieldForLike("`grndate`", 0, "DB"), 133, 10, 0, false, '`grndate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->grndate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->grndate->Param, "CustomMsg");
        $this->Fields['grndate'] = &$this->grndate;

        // grndatetime
        $this->grndatetime = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_grndatetime', 'grndatetime', '`grndatetime`', CastDateFieldForLike("`grndatetime`", 0, "DB"), 135, 19, 0, false, '`grndatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->grndatetime->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->grndatetime->Param, "CustomMsg");
        $this->Fields['grndatetime'] = &$this->grndatetime;

        // strid
        $this->strid = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_strid', 'strid', '`strid`', '`strid`', 3, 11, -1, false, '`strid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->strid->Sortable = true; // Allow sort
        $this->strid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->strid->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->strid->Param, "CustomMsg");
        $this->Fields['strid'] = &$this->strid;

        // GRNPer
        $this->GRNPer = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_GRNPer', 'GRNPer', '`GRNPer`', '`GRNPer`', 131, 10, -1, false, '`GRNPer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GRNPer->Sortable = true; // Allow sort
        $this->GRNPer->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->GRNPer->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->GRNPer->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GRNPer->Param, "CustomMsg");
        $this->Fields['GRNPer'] = &$this->GRNPer;

        // StoreID
        $this->StoreID = new DbField('store_purchaseorder', 'store_purchaseorder', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 200, 45, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StorePurchaseorderList");
    }
    ...
    {
        global $Language;
        if ($pageName == "StorePurchaseorderView") {
            return $Language->phrase("View");
        } elseif ($pageName == "StorePurchaseorderEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "StorePurchaseorderAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StorePurchaseorderView";
            case Config("API_ADD_ACTION"):
                return "StorePurchaseorderAdd";
            case Config("API_EDIT_ACTION"):
                return "StorePurchaseorderEdit";
            case Config("API_DELETE_ACTION"):
                return "StorePurchaseorderDelete";
            case Config("API_LIST_ACTION"):
                return "StorePurchaseorderList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StorePurchaseorderView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StorePurchaseorderView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "StorePurchaseorderAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "StorePurchaseorderAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StorePurchaseorderEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StorePurchaseorderAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("StorePurchaseorderDelete", $this->getUrlParm());
    }
