 ...
 * Page class
 */
class EmployeePermissionsAdd extends EmployeePermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeePermissionsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmployeePermissionsList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmployeePermissionsList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmployeePermissionsView") {
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->module_id->FormValue)) {
            $this->module_id->addErrorMessage($this->module_id->getErrorMessage(false));
        }
