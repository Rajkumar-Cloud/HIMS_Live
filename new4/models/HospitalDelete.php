 ...
 * Page class
 */
class HospitalDelete extends Hospital
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "HospitalDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HospitalList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HospitalList"); // Return to list
                return;
            }
        }
