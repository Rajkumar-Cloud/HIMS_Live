 ...
 * Page class
 */
class ReceiptsList extends Receipts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReceiptsList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ReceiptsAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ReceiptsDelete";
        $this->MultiUpdateUrl = "ReceiptsUpdate";
