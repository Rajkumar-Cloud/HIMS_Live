 ...
 * Page class
 */
class PresTradeCombinationNamesDelete extends PresTradeCombinationNames
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PresTradeCombinationNamesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PresTradeCombinationNamesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PresTradeCombinationNamesList"); // Return to list
                return;
            }
        }
