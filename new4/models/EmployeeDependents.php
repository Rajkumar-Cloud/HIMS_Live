 ...
 */
class EmployeeDependents extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('employee_dependents', 'employee_dependents', 'x_id', 'id', '`id`', '`id`', 20, 20, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // employee
        $this->employee = new DbField('employee_dependents', 'employee_dependents', 'x_employee', 'employee', '`employee`', '`employee`', 3, 20, -1, false, '`employee`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name
        $this->name = new DbField('employee_dependents', 'employee_dependents', 'x_name', 'name', '`name`', '`name`', 200, 100, -1, false, '`name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // relationship
        $this->relationship = new DbField('employee_dependents', 'employee_dependents', 'x_relationship', 'relationship', '`relationship`', '`relationship`', 202, 6, -1, false, '`relationship`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // dob
        $this->dob = new DbField('employee_dependents', 'employee_dependents', 'x_dob', 'dob', '`dob`', CastDateFieldForLike("`dob`", 0, "DB"), 133, 10, 0, false, '`dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_number
        $this->id_number = new DbField('employee_dependents', 'employee_dependents', 'x_id_number', 'id_number', '`id_number`', '`id_number`', 200, 25, -1, false, '`id_number`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->id_number->Sortable = true; // Allow sort
        $this->id_number->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id_number->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeDependentsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "EmployeeDependentsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeDependentsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeDependentsView";
            case Config("API_ADD_ACTION"):
                return "EmployeeDependentsAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeeDependentsEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeDependentsDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeDependentsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeDependentsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeDependentsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeDependentsAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeDependentsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeDependentsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeDependentsDelete", $this->getUrlParm());
    }
