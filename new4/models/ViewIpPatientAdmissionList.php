 ...
 * Page class
 */
class ViewIpPatientAdmissionList extends ViewIpPatientAdmission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpPatientAdmissionList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewIpPatientAdmissionAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewIpPatientAdmissionDelete";
        $this->MultiUpdateUrl = "ViewIpPatientAdmissionUpdate";
    ...
    protected function setupSearchOptions()
    {
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"ViewIpPatientAdmissionSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_ip_patient_admission\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'ViewIpPatientAdmissionSearch'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
