 ...
 * Page class
 */
class ViewIpAdvancePreview extends ViewIpAdvance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpAdvancePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "ip_admission") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ip_admission&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnno->QueryStringValue) . "&" . GetForeignKeyUrl("fk_id", $this->Reception->QueryStringValue) . "&" . GetForeignKeyUrl("fk_patient_id", $this->PatID->QueryStringValue) . "";
        }
        return $url;
    }
