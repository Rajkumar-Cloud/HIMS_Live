 ...
 * Page class
 */
class MasReferenceTypeView extends MasReferenceType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasReferenceTypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MasReferenceTypeList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MasReferenceTypeList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "MasReferenceTypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
