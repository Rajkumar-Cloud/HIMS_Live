...
/**
 * Table class for store_storemast
 */
class StoreStoremast extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'store_storemast';
        $this->TableName = 'store_storemast';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`store_storemast`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // BRCODE
        $this->BRCODE = new DbField('store_storemast', 'store_storemast', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('store_storemast', 'store_storemast', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TYPE
        $this->TYPE = new DbField('store_storemast', 'store_storemast', 'x_TYPE', 'TYPE', '`TYPE`', '`TYPE`', 200, 3, -1, false, '`TYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TYPE->Sortable = true; // Allow sort
        $this->TYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TYPE->Param, "CustomMsg");
        $this->Fields['TYPE'] = &$this->TYPE;

        // DES
        $this->DES = new DbField('store_storemast', 'store_storemast', 'x_DES', 'DES', '`DES`', '`DES`', 200, 100, -1, false, '`DES`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UM
        $this->UM = new DbField('store_storemast', 'store_storemast', 'x_UM', 'UM', '`UM`', '`UM`', 200, 3, -1, false, '`UM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('store_storemast', 'store_storemast', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UR
        $this->UR = new DbField('store_storemast', 'store_storemast', 'x_UR', 'UR', '`UR`', '`UR`', 131, 12, -1, false, '`UR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAXP
        $this->TAXP = new DbField('store_storemast', 'store_storemast', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, 8, -1, false, '`TAXP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCHNO
        $this->BATCHNO = new DbField('store_storemast', 'store_storemast', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, 14, -1, false, '`BATCHNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('store_storemast', 'store_storemast', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RQ
        $this->RQ = new DbField('store_storemast', 'store_storemast', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, 12, -1, false, '`RQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRQ
        $this->MRQ = new DbField('store_storemast', 'store_storemast', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, 12, -1, false, '`MRQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('store_storemast', 'store_storemast', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 12, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRP
        $this->MRP = new DbField('store_storemast', 'store_storemast', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('store_storemast', 'store_storemast', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SALQTY
        $this->SALQTY = new DbField('store_storemast', 'store_storemast', 'x_SALQTY', 'SALQTY', '`SALQTY`', '`SALQTY`', 131, 12, -1, false, '`SALQTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->SALQTY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SALQTY->Param, "CustomMsg");
        $this->Fields['SALQTY'] = &$this->SALQTY;

        // LASTPURDT
        $this->LASTPURDT = new DbField('store_storemast', 'store_storemast', 'x_LASTPURDT', 'LASTPURDT', '`LASTPURDT`', CastDateFieldForLike("`LASTPURDT`", 0, "DB"), 135, 19, 0, false, '`LASTPURDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->LASTPURDT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->LASTPURDT->Param, "CustomMsg");
        $this->Fields['LASTPURDT'] = &$this->LASTPURDT;

        // LASTSUPP
        $this->LASTSUPP = new DbField('store_storemast', 'store_storemast', 'x_LASTSUPP', 'LASTSUPP', '`LASTSUPP`', '`LASTSUPP`', 200, 5, -1, false, '`LASTSUPP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LASTSUPP->Sortable = true; // Allow sort
        $this->LASTSUPP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->LASTSUPP->Param, "CustomMsg");
        $this->Fields['LASTSUPP'] = &$this->LASTSUPP;

        // GENNAME
        $this->GENNAME = new DbField('store_storemast', 'store_storemast', 'x_GENNAME', 'GENNAME', '`GENNAME`', '`GENNAME`', 200, 75, -1, false, '`GENNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LASTISSDT
        $this->LASTISSDT = new DbField('store_storemast', 'store_storemast', 'x_LASTISSDT', 'LASTISSDT', '`LASTISSDT`', CastDateFieldForLike("`LASTISSDT`", 0, "DB"), 135, 19, 0, false, '`LASTISSDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->LASTISSDT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->LASTISSDT->Param, "CustomMsg");
        $this->Fields['LASTISSDT'] = &$this->LASTISSDT;

        // CREATEDDT
        $this->CREATEDDT = new DbField('store_storemast', 'store_storemast', 'x_CREATEDDT', 'CREATEDDT', '`CREATEDDT`', CastDateFieldForLike("`CREATEDDT`", 0, "DB"), 135, 19, 0, false, '`CREATEDDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->CREATEDDT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CREATEDDT->Param, "CustomMsg");
        $this->Fields['CREATEDDT'] = &$this->CREATEDDT;

        // OPPRC
        $this->OPPRC = new DbField('store_storemast', 'store_storemast', 'x_OPPRC', 'OPPRC', '`OPPRC`', '`OPPRC`', 200, 9, -1, false, '`OPPRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->OPPRC->Sortable = true; // Allow sort
        $this->OPPRC->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OPPRC->Param, "CustomMsg");
        $this->Fields['OPPRC'] = &$this->OPPRC;

        // RESTRICT
        $this->RESTRICT = new DbField('store_storemast', 'store_storemast', 'x_RESTRICT', 'RESTRICT', '`RESTRICT`', '`RESTRICT`', 200, 1, -1, false, '`RESTRICT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESTRICT->Sortable = true; // Allow sort
        $this->RESTRICT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RESTRICT->Param, "CustomMsg");
        $this->Fields['RESTRICT'] = &$this->RESTRICT;

        // BAWAPRC
        $this->BAWAPRC = new DbField('store_storemast', 'store_storemast', 'x_BAWAPRC', 'BAWAPRC', '`BAWAPRC`', '`BAWAPRC`', 200, 9, -1, false, '`BAWAPRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BAWAPRC->Sortable = true; // Allow sort
        $this->BAWAPRC->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BAWAPRC->Param, "CustomMsg");
        $this->Fields['BAWAPRC'] = &$this->BAWAPRC;

        // STAXPER
        $this->STAXPER = new DbField('store_storemast', 'store_storemast', 'x_STAXPER', 'STAXPER', '`STAXPER`', '`STAXPER`', 131, 8, -1, false, '`STAXPER`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->STAXPER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->STAXPER->Param, "CustomMsg");
        $this->Fields['STAXPER'] = &$this->STAXPER;

        // TAXTYPE
        $this->TAXTYPE = new DbField('store_storemast', 'store_storemast', 'x_TAXTYPE', 'TAXTYPE', '`TAXTYPE`', '`TAXTYPE`', 200, 1, -1, false, '`TAXTYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TAXTYPE->Sortable = true; // Allow sort
        $this->TAXTYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TAXTYPE->Param, "CustomMsg");
        $this->Fields['TAXTYPE'] = &$this->TAXTYPE;

        // OLDTAXP
        $this->OLDTAXP = new DbField('store_storemast', 'store_storemast', 'x_OLDTAXP', 'OLDTAXP', '`OLDTAXP`', '`OLDTAXP`', 131, 12, -1, false, '`OLDTAXP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OLDTAXP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OLDTAXP->Param, "CustomMsg");
        $this->Fields['OLDTAXP'] = &$this->OLDTAXP;

        // TAXUPD
        $this->TAXUPD = new DbField('store_storemast', 'store_storemast', 'x_TAXUPD', 'TAXUPD', '`TAXUPD`', '`TAXUPD`', 200, 1, -1, false, '`TAXUPD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TAXUPD->Sortable = true; // Allow sort
        $this->TAXUPD->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TAXUPD->Param, "CustomMsg");
        $this->Fields['TAXUPD'] = &$this->TAXUPD;

        // PACKAGE
        $this->PACKAGE = new DbField('store_storemast', 'store_storemast', 'x_PACKAGE', 'PACKAGE', '`PACKAGE`', '`PACKAGE`', 200, 1, -1, false, '`PACKAGE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NEWRT
        $this->NEWRT = new DbField('store_storemast', 'store_storemast', 'x_NEWRT', 'NEWRT', '`NEWRT`', '`NEWRT`', 131, 12, -1, false, '`NEWRT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NEWRT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NEWRT->Param, "CustomMsg");
        $this->Fields['NEWRT'] = &$this->NEWRT;

        // NEWMRP
        $this->NEWMRP = new DbField('store_storemast', 'store_storemast', 'x_NEWMRP', 'NEWMRP', '`NEWMRP`', '`NEWMRP`', 131, 12, -1, false, '`NEWMRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NEWMRP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NEWMRP->Param, "CustomMsg");
        $this->Fields['NEWMRP'] = &$this->NEWMRP;

        // NEWUR
        $this->NEWUR = new DbField('store_storemast', 'store_storemast', 'x_NEWUR', 'NEWUR', '`NEWUR`', '`NEWUR`', 131, 12, -1, false, '`NEWUR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NEWUR->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NEWUR->Param, "CustomMsg");
        $this->Fields['NEWUR'] = &$this->NEWUR;

        // STATUS
        $this->STATUS = new DbField('store_storemast', 'store_storemast', 'x_STATUS', 'STATUS', '`STATUS`', '`STATUS`', 200, 10, -1, false, '`STATUS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->STATUS->Sortable = true; // Allow sort
        $this->STATUS->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->STATUS->Param, "CustomMsg");
        $this->Fields['STATUS'] = &$this->STATUS;

        // RETNQTY
        $this->RETNQTY = new DbField('store_storemast', 'store_storemast', 'x_RETNQTY', 'RETNQTY', '`RETNQTY`', '`RETNQTY`', 131, 12, -1, false, '`RETNQTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->RETNQTY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RETNQTY->Param, "CustomMsg");
        $this->Fields['RETNQTY'] = &$this->RETNQTY;

        // KEMODISC
        $this->KEMODISC = new DbField('store_storemast', 'store_storemast', 'x_KEMODISC', 'KEMODISC', '`KEMODISC`', '`KEMODISC`', 200, 1, -1, false, '`KEMODISC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->KEMODISC->Sortable = true; // Allow sort
        $this->KEMODISC->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->KEMODISC->Param, "CustomMsg");
        $this->Fields['KEMODISC'] = &$this->KEMODISC;

        // PATSALE
        $this->PATSALE = new DbField('store_storemast', 'store_storemast', 'x_PATSALE', 'PATSALE', '`PATSALE`', '`PATSALE`', 131, 12, -1, false, '`PATSALE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PATSALE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PATSALE->Param, "CustomMsg");
        $this->Fields['PATSALE'] = &$this->PATSALE;

        // ORGAN
        $this->ORGAN = new DbField('store_storemast', 'store_storemast', 'x_ORGAN', 'ORGAN', '`ORGAN`', '`ORGAN`', 200, 50, -1, false, '`ORGAN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ORGAN->Sortable = true; // Allow sort
        $this->ORGAN->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORGAN->Param, "CustomMsg");
        $this->Fields['ORGAN'] = &$this->ORGAN;

        // OLDRQ
        $this->OLDRQ = new DbField('store_storemast', 'store_storemast', 'x_OLDRQ', 'OLDRQ', '`OLDRQ`', '`OLDRQ`', 131, 12, -1, false, '`OLDRQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OLDRQ->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OLDRQ->Param, "CustomMsg");
        $this->Fields['OLDRQ'] = &$this->OLDRQ;

        // DRID
        $this->DRID = new DbField('store_storemast', 'store_storemast', 'x_DRID', 'DRID', '`DRID`', '`DRID`', 200, 5, -1, false, '`DRID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('store_storemast', 'store_storemast', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 3, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMBCODE
        $this->COMBCODE = new DbField('store_storemast', 'store_storemast', 'x_COMBCODE', 'COMBCODE', '`COMBCODE`', '`COMBCODE`', 200, 50, -1, false, '`COMBCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->COMBCODE->Sortable = true; // Allow sort
        $this->COMBCODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->COMBCODE->Param, "CustomMsg");
        $this->Fields['COMBCODE'] = &$this->COMBCODE;

        // GENCODE
        $this->GENCODE = new DbField('store_storemast', 'store_storemast', 'x_GENCODE', 'GENCODE', '`GENCODE`', '`GENCODE`', 200, 10, -1, false, '`GENCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENCODE->Sortable = true; // Allow sort
        $this->GENCODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENCODE->Param, "CustomMsg");
        $this->Fields['GENCODE'] = &$this->GENCODE;

        // STRENGTH
        $this->STRENGTH = new DbField('store_storemast', 'store_storemast', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 131, 11, -1, false, '`STRENGTH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNIT
        $this->UNIT = new DbField('store_storemast', 'store_storemast', 'x_UNIT', 'UNIT', '`UNIT`', '`UNIT`', 200, 3, -1, false, '`UNIT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FORMULARY
        $this->FORMULARY = new DbField('store_storemast', 'store_storemast', 'x_FORMULARY', 'FORMULARY', '`FORMULARY`', '`FORMULARY`', 200, 2, -1, false, '`FORMULARY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->FORMULARY->Sortable = true; // Allow sort
        $this->FORMULARY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->FORMULARY->Param, "CustomMsg");
        $this->Fields['FORMULARY'] = &$this->FORMULARY;

        // STOCK
        $this->STOCK = new DbField('store_storemast', 'store_storemast', 'x_STOCK', 'STOCK', '`STOCK`', '`STOCK`', 131, 12, -1, false, '`STOCK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RACKNO
        $this->RACKNO = new DbField('store_storemast', 'store_storemast', 'x_RACKNO', 'RACKNO', '`RACKNO`', '`RACKNO`', 200, 10, -1, false, '`RACKNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RACKNO->Sortable = true; // Allow sort
        $this->RACKNO->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->RACKNO->Param, "CustomMsg");
        $this->Fields['RACKNO'] = &$this->RACKNO;

        // SUPPNAME
        $this->SUPPNAME = new DbField('store_storemast', 'store_storemast', 'x_SUPPNAME', 'SUPPNAME', '`SUPPNAME`', '`SUPPNAME`', 200, 50, -1, false, '`SUPPNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SUPPNAME->Sortable = true; // Allow sort
        $this->SUPPNAME->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SUPPNAME->Param, "CustomMsg");
        $this->Fields['SUPPNAME'] = &$this->SUPPNAME;

        // COMBNAME
        $this->COMBNAME = new DbField('store_storemast', 'store_storemast', 'x_COMBNAME', 'COMBNAME', '`COMBNAME`', '`COMBNAME`', 200, 100, -1, false, '`COMBNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->COMBNAME->Sortable = true; // Allow sort
        $this->COMBNAME->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->COMBNAME->Param, "CustomMsg");
        $this->Fields['COMBNAME'] = &$this->COMBNAME;

        // GENERICNAME
        $this->GENERICNAME = new DbField('store_storemast', 'store_storemast', 'x_GENERICNAME', 'GENERICNAME', '`GENERICNAME`', '`GENERICNAME`', 200, 100, -1, false, '`GENERICNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENERICNAME->Sortable = true; // Allow sort
        $this->GENERICNAME->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENERICNAME->Param, "CustomMsg");
        $this->Fields['GENERICNAME'] = &$this->GENERICNAME;

        // REMARK
        $this->REMARK = new DbField('store_storemast', 'store_storemast', 'x_REMARK', 'REMARK', '`REMARK`', '`REMARK`', 200, 50, -1, false, '`REMARK`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->REMARK->Sortable = true; // Allow sort
        $this->REMARK->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->REMARK->Param, "CustomMsg");
        $this->Fields['REMARK'] = &$this->REMARK;

        // TEMP
        $this->TEMP = new DbField('store_storemast', 'store_storemast', 'x_TEMP', 'TEMP', '`TEMP`', '`TEMP`', 200, 5, -1, false, '`TEMP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PACKING
        $this->PACKING = new DbField('store_storemast', 'store_storemast', 'x_PACKING', 'PACKING', '`PACKING`', '`PACKING`', 131, 4, -1, false, '`PACKING`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PACKING->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PACKING->Param, "CustomMsg");
        $this->Fields['PACKING'] = &$this->PACKING;

        // PhysQty
        $this->PhysQty = new DbField('store_storemast', 'store_storemast', 'x_PhysQty', 'PhysQty', '`PhysQty`', '`PhysQty`', 131, 12, -1, false, '`PhysQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->PhysQty->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PhysQty->Param, "CustomMsg");
        $this->Fields['PhysQty'] = &$this->PhysQty;

        // LedQty
        $this->LedQty = new DbField('store_storemast', 'store_storemast', 'x_LedQty', 'LedQty', '`LedQty`', '`LedQty`', 131, 12, -1, false, '`LedQty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->LedQty->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->LedQty->Param, "CustomMsg");
        $this->Fields['LedQty'] = &$this->LedQty;

        // id
        $this->id = new DbField('store_storemast', 'store_storemast', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // PurValue
        $this->PurValue = new DbField('store_storemast', 'store_storemast', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('store_storemast', 'store_storemast', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('store_storemast', 'store_storemast', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SaleValue
        $this->SaleValue = new DbField('store_storemast', 'store_storemast', 'x_SaleValue', 'SaleValue', '`SaleValue`', '`SaleValue`', 131, 12, -1, false, '`SaleValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('store_storemast', 'store_storemast', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('store_storemast', 'store_storemast', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SaleRate
        $this->SaleRate = new DbField('store_storemast', 'store_storemast', 'x_SaleRate', 'SaleRate', '`SaleRate`', '`SaleRate`', 131, 12, -1, false, '`SaleRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->SaleRate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SaleRate->Param, "CustomMsg");
        $this->Fields['SaleRate'] = &$this->SaleRate;

        // HospID
        $this->HospID = new DbField('store_storemast', 'store_storemast', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRNAME
        $this->BRNAME = new DbField('store_storemast', 'store_storemast', 'x_BRNAME', 'BRNAME', '`BRNAME`', '`BRNAME`', 200, 45, -1, false, '`BRNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OV
        $this->OV = new DbField('store_storemast', 'store_storemast', 'x_OV', 'OV', '`OV`', '`OV`', 131, 12, -1, false, '`OV`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OV->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OV->Param, "CustomMsg");
        $this->Fields['OV'] = &$this->OV;

        // LATESTOV
        $this->LATESTOV = new DbField('store_storemast', 'store_storemast', 'x_LATESTOV', 'LATESTOV', '`LATESTOV`', '`LATESTOV`', 131, 12, -1, false, '`LATESTOV`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->LATESTOV->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->LATESTOV->Param, "CustomMsg");
        $this->Fields['LATESTOV'] = &$this->LATESTOV;

        // ITEMTYPE
        $this->ITEMTYPE = new DbField('store_storemast', 'store_storemast', 'x_ITEMTYPE', 'ITEMTYPE', '`ITEMTYPE`', '`ITEMTYPE`', 200, 45, -1, false, '`ITEMTYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ITEMTYPE->Sortable = true; // Allow sort
        $this->ITEMTYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ITEMTYPE->Param, "CustomMsg");
        $this->Fields['ITEMTYPE'] = &$this->ITEMTYPE;

        // ROWID
        $this->ROWID = new DbField('store_storemast', 'store_storemast', 'x_ROWID', 'ROWID', '`ROWID`', '`ROWID`', 200, 45, -1, false, '`ROWID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ROWID->Sortable = true; // Allow sort
        $this->ROWID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ROWID->Param, "CustomMsg");
        $this->Fields['ROWID'] = &$this->ROWID;

        // MOVED
        $this->MOVED = new DbField('store_storemast', 'store_storemast', 'x_MOVED', 'MOVED', '`MOVED`', '`MOVED`', 3, 11, -1, false, '`MOVED`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MOVED->Sortable = true; // Allow sort
        $this->MOVED->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->MOVED->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MOVED->Param, "CustomMsg");
        $this->Fields['MOVED'] = &$this->MOVED;

        // NEWTAX
        $this->NEWTAX = new DbField('store_storemast', 'store_storemast', 'x_NEWTAX', 'NEWTAX', '`NEWTAX`', '`NEWTAX`', 131, 12, -1, false, '`NEWTAX`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NEWTAX->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NEWTAX->Param, "CustomMsg");
        $this->Fields['NEWTAX'] = &$this->NEWTAX;

        // HSNCODE
        $this->HSNCODE = new DbField('store_storemast', 'store_storemast', 'x_HSNCODE', 'HSNCODE', '`HSNCODE`', '`HSNCODE`', 200, 45, -1, false, '`HSNCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OLDTAX
        $this->OLDTAX = new DbField('store_storemast', 'store_storemast', 'x_OLDTAX', 'OLDTAX', '`OLDTAX`', '`OLDTAX`', 131, 12, -1, false, '`OLDTAX`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->OLDTAX->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->OLDTAX->Param, "CustomMsg");
        $this->Fields['OLDTAX'] = &$this->OLDTAX;

        // StoreID
        $this->StoreID = new DbField('store_storemast', 'store_storemast', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, 11, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`store_storemast`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StoreStoremastList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "StoreStoremastEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "StoreStoremastAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StoreStoremastView";
            case Config("API_ADD_ACTION"):
                return "StoreStoremastAdd";
            case Config("API_EDIT_ACTION"):
                return "StoreStoremastEdit";
            case Config("API_DELETE_ACTION"):
                return "StoreStoremastDelete";
            case Config("API_LIST_ACTION"):
                return "StoreStoremastList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StoreStoremastView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StoreStoremastView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "StoreStoremastAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "StoreStoremastAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StoreStoremastEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("StoreStoremastAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("StoreStoremastDelete", $this->getUrlParm());
    }
