...
/**
 * Table class for mas_reference_type
 */
class MasReferenceType extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'mas_reference_type';
        $this->TableName = 'mas_reference_type';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`mas_reference_type`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('mas_reference_type', 'mas_reference_type', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // reference
        $this->reference = new DbField('mas_reference_type', 'mas_reference_type', 'x_reference', 'reference', '`reference`', '`reference`', 200, 45, -1, false, '`reference`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->reference->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->reference->Param, "CustomMsg");
        $this->Fields['reference'] = &$this->reference;

        // ReferMobileNo
        $this->ReferMobileNo = new DbField('mas_reference_type', 'mas_reference_type', 'x_ReferMobileNo', 'ReferMobileNo', '`ReferMobileNo`', '`ReferMobileNo`', 200, 45, -1, false, '`ReferMobileNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferClinicname
        $this->ReferClinicname = new DbField('mas_reference_type', 'mas_reference_type', 'x_ReferClinicname', 'ReferClinicname', '`ReferClinicname`', '`ReferClinicname`', 200, 45, -1, false, '`ReferClinicname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferCity
        $this->ReferCity = new DbField('mas_reference_type', 'mas_reference_type', 'x_ReferCity', 'ReferCity', '`ReferCity`', '`ReferCity`', 200, 45, -1, false, '`ReferCity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('mas_reference_type', 'mas_reference_type', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email
        $this->_email = new DbField('mas_reference_type', 'mas_reference_type', 'x__email', 'email', '`email`', '`email`', 200, 45, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_email->Sortable = true; // Allow sort
        $this->_email->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_email->Param, "CustomMsg");
        $this->Fields['email'] = &$this->_email;

        // whatapp
        $this->whatapp = new DbField('mas_reference_type', 'mas_reference_type', 'x_whatapp', 'whatapp', '`whatapp`', '`whatapp`', 200, 45, -1, false, '`whatapp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->whatapp->Sortable = true; // Allow sort
        $this->whatapp->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->whatapp->Param, "CustomMsg");
        $this->Fields['whatapp'] = &$this->whatapp;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`mas_reference_type`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->whatapp->DbValue = $row['whatapp'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MasReferenceTypeList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MasReferenceTypeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MasReferenceTypeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MasReferenceTypeView";
            case Config("API_ADD_ACTION"):
                return "MasReferenceTypeAdd";
            case Config("API_EDIT_ACTION"):
                return "MasReferenceTypeEdit";
            case Config("API_DELETE_ACTION"):
                return "MasReferenceTypeDelete";
            case Config("API_LIST_ACTION"):
                return "MasReferenceTypeList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MasReferenceTypeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MasReferenceTypeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MasReferenceTypeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MasReferenceTypeAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MasReferenceTypeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MasReferenceTypeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MasReferenceTypeDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        // whatapp
        $this->whatapp->EditAttrs["class"] = "form-control";
        $this->whatapp->EditCustomAttributes = "";
        if (!$this->whatapp->Raw) {
            $this->whatapp->CurrentValue = HtmlDecode($this->whatapp->CurrentValue);
        }
        $this->whatapp->EditValue = $this->whatapp->CurrentValue;
        $this->whatapp->PlaceHolder = RemoveHtml($this->whatapp->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->whatapp);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->reference);
                    $doc->exportCaption($this->ReferMobileNo);
