 ...
 * Page class
 */
class RecruitmentCallsDelete extends RecruitmentCalls
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecruitmentCallsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RecruitmentCallsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RecruitmentCallsList"); // Return to list
                return;
            }
        }
