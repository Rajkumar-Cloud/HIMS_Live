 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestApprovedEdit extends ViewPharmacyPurchaseRequestApproved
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestApprovedEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("ViewPharmacyPurchaseRequestApprovedList"); // No matching record, return to list
                    return;
                }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewPharmacyPurchaseRequestApprovedList") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_pharmacy_purchase_request_items_approved", $detailTblVar) && $detailPage->DetailEdit) {
