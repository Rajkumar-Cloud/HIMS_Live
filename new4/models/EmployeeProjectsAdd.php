 ...
 * Page class
 */
class EmployeeProjectsAdd extends EmployeeProjects
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeProjectsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "EmployeeProjectsView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->status->CurrentValue = "Current";
