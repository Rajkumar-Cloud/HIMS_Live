...
/**
 * Table class for pharmacy_combination
 */
class PharmacyCombination extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pharmacy_combination';
        $this->TableName = 'pharmacy_combination';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`pharmacy_combination`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // GENCODE
        $this->GENCODE = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_GENCODE', 'GENCODE', '`GENCODE`', '`GENCODE`', 200, 5, -1, false, '`GENCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->GENCODE->Lookup = new Lookup('GENCODE', 'pharmacy_master_generic', false, 'CODE', ["GENNAME","","",""], [], [], [], [], [], [], '', '');
        $this->GENCODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENCODE->Param, "CustomMsg");
        $this->Fields['GENCODE'] = &$this->GENCODE;

        // COMBCODE
        $this->COMBCODE = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_COMBCODE', 'COMBCODE', '`COMBCODE`', '`COMBCODE`', 200, 5, -1, false, '`COMBCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->COMBCODE->Lookup = new Lookup('COMBCODE', 'pharmacy_comb_master', false, 'CODE', ["NAME","","",""], [], [], [], [], [], [], '', '');
        ...
        // STRENGTH
        $this->STRENGTH = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 131, 6, -1, false, '`STRENGTH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SLNO
        $this->SLNO = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_SLNO', 'SLNO', '`SLNO`', '`SLNO`', 200, 2, -1, false, '`SLNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`pharmacy_combination`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyCombinationList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PharmacyCombinationView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PharmacyCombinationEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PharmacyCombinationAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyCombinationView";
            case Config("API_ADD_ACTION"):
                return "PharmacyCombinationAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyCombinationEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyCombinationDelete";
            case Config("API_LIST_ACTION"):
                return "PharmacyCombinationList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyCombinationView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyCombinationView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PharmacyCombinationAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PharmacyCombinationAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PharmacyCombinationEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PharmacyCombinationAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PharmacyCombinationDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->SLNO->Raw) {
            $this->SLNO->CurrentValue = HtmlDecode($this->SLNO->CurrentValue);
        }
