 ...
 * Page class
 */
class ReceptionView extends Reception
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReceptionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ReceptionList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ReceptionList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ReceptionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
