 ...
 * Page class
 */
class PharmacyPharledPreview extends PharmacyPharled
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPharledPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_billing_voucher") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_voucher&" . GetForeignKeyUrl("fk_id", $this->pbv->QueryStringValue) . "";
        }
        if ($masterTblVar == "pharmacy_billing_issue") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_issue&" . GetForeignKeyUrl("fk_id", $this->pbt->QueryStringValue) . "";
        }
        if ($masterTblVar == "ip_admission") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ip_admission&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnno->QueryStringValue) . "&" . GetForeignKeyUrl("fk_patient_id", $this->PatID->QueryStringValue) . "&" . GetForeignKeyUrl("fk_id", $this->Reception->QueryStringValue) . "";
        }
        return $url;
    }
