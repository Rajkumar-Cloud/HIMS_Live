 ...
 * Page class
 */
class ViewLabServicesAuthList extends ViewLabServicesAuth
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabServicesAuthList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewLabServicesAuthAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewLabServicesAuthDelete";
        $this->MultiUpdateUrl = "ViewLabServicesAuthUpdate";
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_lab_resultreleased_auth')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewLabResultreleasedAuthList?" . Config("TABLE_SHOW_MASTER") . "=view_lab_services_auth&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ViewLabResultreleasedAuthGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_lab_services_auth')) {
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["view_lab_resultreleased_auth"] && $this->DetailPages["view_lab_resultreleased_auth"]->Visible) {
            ...
            $url = "ViewLabResultreleasedAuthPreview?t=view_lab_services_auth&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_lab_services_auth')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewLabResultreleasedAuthList?" . Config("TABLE_SHOW_MASTER") . "=view_lab_services_auth&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue) . "");
            ...
            $detailPageObj = Container("ViewLabResultreleasedAuthGrid");
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_lab_services_auth')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=view_lab_resultreleased_auth");
    ...
    protected function setupSearchOptions()
    {
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"ViewLabServicesAuthSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_lab_services_auth\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'ViewLabServicesAuthSearch'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
