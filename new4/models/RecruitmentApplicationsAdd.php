 ...
 * Page class
 */
class RecruitmentApplicationsAdd extends RecruitmentApplications
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecruitmentApplicationsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RecruitmentApplicationsView") {
