 ...
 * Page class
 */
class ViewIvfOocytedenudationEmbryologyChartEdit extends ViewIvfOocytedenudationEmbryologyChart
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIvfOocytedenudationEmbryologyChartEdit";
