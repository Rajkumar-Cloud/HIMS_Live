...
class BillingRefundVoucher extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BillingRefundVoucherList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BillingRefundVoucherView";
            case Config("API_ADD_ACTION"):
                return "BillingRefundVoucherAdd";
            case Config("API_EDIT_ACTION"):
                return "BillingRefundVoucherEdit";
            case Config("API_DELETE_ACTION"):
                return "BillingRefundVoucherDelete";
