 ...
 * Page class
 */
class PharmacyCombinationView extends PharmacyCombination
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyCombinationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PharmacyCombinationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PharmacyCombinationList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "PharmacyCombinationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PharmacyCombinationList"), "", $this->TableVar, true);
        $pageId = "view";
