 ...
 * Page class
 */
class LabProfileDetailsView extends LabProfileDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LabProfileDetailsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LabProfileDetailsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LabProfileDetailsList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "LabProfileDetailsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
