 ...
 * Page class
 */
class EmployeesArchivedDelete extends EmployeesArchived
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeesArchivedDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeesArchivedList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeesArchivedList"); // Return to list
                return;
            }
        }
