 ...
 * Page class
 */
class ViewPharmacytransferPreview extends ViewPharmacytransfer
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacytransferPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pharmacy_billing_transfer") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_transfer&" . GetForeignKeyUrl("fk_id", $this->trid->QueryStringValue) . "";
        }
        return $url;
    }
