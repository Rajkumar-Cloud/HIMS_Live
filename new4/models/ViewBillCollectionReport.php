 ...
 */
class ViewBillCollectionReport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // createddate
        $this->createddate = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_createddate', 'createddate', '`createddate`', CastDateFieldForLike("`createddate`", 7, "DB"), 133, 10, 7, false, '`createddate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserName
        $this->_UserName = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CARD
        $this->CARD = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_CARD', 'CARD', '`CARD`', '`CARD`', 131, 56, -1, false, '`CARD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASH
        $this->CASH = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_CASH', 'CASH', '`CASH`', '`CASH`', 131, 56, -1, false, '`CASH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NEFT
        $this->NEFT = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_NEFT', 'NEFT', '`NEFT`', '`NEFT`', 131, 56, -1, false, '`NEFT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NEFT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NEFT->Param, "CustomMsg");
        $this->Fields['NEFT'] = &$this->NEFT;

        // PAYTM
        $this->PAYTM = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_PAYTM', 'PAYTM', '`PAYTM`', '`PAYTM`', 131, 56, -1, false, '`PAYTM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CHEQUE
        $this->CHEQUE = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_CHEQUE', 'CHEQUE', '`CHEQUE`', '`CHEQUE`', 131, 56, -1, false, '`CHEQUE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RTGS
        $this->RTGS = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_RTGS', 'RTGS', '`RTGS`', '`RTGS`', 131, 56, -1, false, '`RTGS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NotSelected
        $this->NotSelected = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_NotSelected', 'NotSelected', '`NotSelected`', '`NotSelected`', 131, 56, -1, false, '`NotSelected`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->NotSelected->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NotSelected->Param, "CustomMsg");
        $this->Fields['NotSelected'] = &$this->NotSelected;

        // REFUND
        $this->REFUND = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_REFUND', 'REFUND', '`REFUND`', '`REFUND`', 131, 56, -1, false, '`REFUND`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CANCEL
        $this->CANCEL = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_CANCEL', 'CANCEL', '`CANCEL`', '`CANCEL`', 131, 56, -1, false, '`CANCEL`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->CANCEL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->CANCEL->Param, "CustomMsg");
        $this->Fields['CANCEL'] = &$this->CANCEL;

        // Total
        $this->Total = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_Total', 'Total', '`Total`', '`Total`', 131, 56, -1, false, '`Total`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillType
        $this->BillType = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_BillType', 'BillType', '`BillType`', '`BillType`', 200, 8, -1, false, '`BillType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AdjAdvance
        $this->AdjAdvance = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_AdjAdvance', 'AdjAdvance', '`AdjAdvance`', '`AdjAdvance`', 131, 56, -1, false, '`AdjAdvance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->AdjAdvance->Sortable = true; // Allow sort
        $this->AdjAdvance->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->AdjAdvance->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->AdjAdvance->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->AdjAdvance->Param, "CustomMsg");
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HospID`='".HospitalID()."'  and `BillType` != 'Advance'";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewBillCollectionReportList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewBillCollectionReportView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewBillCollectionReportEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewBillCollectionReportAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewBillCollectionReportView";
            case Config("API_ADD_ACTION"):
                return "ViewBillCollectionReportAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewBillCollectionReportEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewBillCollectionReportDelete";
            case Config("API_LIST_ACTION"):
                return "ViewBillCollectionReportList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewBillCollectionReportView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewBillCollectionReportView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewBillCollectionReportAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewBillCollectionReportAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBillCollectionReportEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBillCollectionReportAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewBillCollectionReportDelete", $this->getUrlParm());
    }
