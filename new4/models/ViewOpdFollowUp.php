...
class ViewOpdFollowUp extends DbTable
{
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `RIDNo`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewOpdFollowUpList");
    }
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewOpdFollowUpView";
            case Config("API_ADD_ACTION"):
                return "ViewOpdFollowUpAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewOpdFollowUpEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewOpdFollowUpDelete";
