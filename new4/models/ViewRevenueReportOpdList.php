 ...
 * Page class
 */
class ViewRevenueReportOpdList extends ViewRevenueReportOpd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewRevenueReportOpdList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewRevenueReportOpdAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewRevenueReportOpdDelete";
        $this->MultiUpdateUrl = "ViewRevenueReportOpdUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_revenue_report_opd"));
                $doc->Text = @$content;
    ...
    public function run()
    {
        ...
        $this->Opconsultations->setVisibility();
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->Opconsultations->AdvancedSearch->toJson(), ","); // Field Op consultations
    ...
    protected function restoreFilterList()
    {
        ...
        $this->Opconsultations->AdvancedSearch->SearchValue = @$filter["x_Opconsultations"];
        $this->Opconsultations->AdvancedSearch->SearchOperator = @$filter["z_Opconsultations"];
        $this->Opconsultations->AdvancedSearch->SearchCondition = @$filter["v_Opconsultations"];
        $this->Opconsultations->AdvancedSearch->SearchValue2 = @$filter["y_Opconsultations"];
        $this->Opconsultations->AdvancedSearch->SearchOperator2 = @$filter["w_Opconsultations"];
        $this->Opconsultations->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->Opconsultations, $default, false); // Op consultations
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->Opconsultations->AdvancedSearch->save(); // Op consultations
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->Opconsultations->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->Opconsultations->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->Opconsultations->AdvancedSearch->load();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Opconsultations); // Op consultations
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fview_revenue_report_opdlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fview_revenue_report_opdlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fview_revenue_report_opdlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadSearchValues()
    {
        ...
        // Op consultations
        if (!$this->isAddOrEdit() && $this->Opconsultations->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Opconsultations->AdvancedSearch->SearchValue != "" || $this->Opconsultations->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // Scan
        if (!$this->isAddOrEdit() && $this->Scan->AdvancedSearch->get()) {
            $hasValue = true;
        ...
        // PROCEDURES
        if (!$this->isAddOrEdit() && $this->PROCEDURES->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->PROCEDURES->AdvancedSearch->SearchValue != "" || $this->PROCEDURES->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->Opconsultations->FormValue == $this->Opconsultations->CurrentValue && is_numeric(ConvertToFloatString($this->Opconsultations->CurrentValue))) {
            $this->Opconsultations->CurrentValue = ConvertToFloatString($this->Opconsultations->CurrentValue);
        }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Opconsultations->EditValue = HtmlEncode($this->Opconsultations->AdvancedSearch->SearchValue);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fview_revenue_report_opdlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fview_revenue_report_opdlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fview_revenue_report_opdlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_revenue_report_opdlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
