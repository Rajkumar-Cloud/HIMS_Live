 ...
 * Page class
 */
class ViewDashboardSummaryPaymentModeList extends ViewDashboardSummaryPaymentMode
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardSummaryPaymentModeList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewDashboardSummaryPaymentModeAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewDashboardSummaryPaymentModeDelete";
        $this->MultiUpdateUrl = "ViewDashboardSummaryPaymentModeUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_dashboard_summary_payment_mode"));
                $doc->Text = @$content;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_dashboard_collection_details')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewDashboardCollectionDetailsList?" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_summary_payment_mode&" . GetForeignKeyUrl("fk_createddate", $this->createddate->CurrentValue, 7) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->CurrentValue) . "&" . GetForeignKeyUrl("fk__UserName", $this->_UserName->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
    ...
    protected function renderListOptionsExt()
    {
        ...
        $sqlwrk = $sqlwrk . " AND " . "`UserName`='" . AdjustSql($this->_UserName->CurrentValue, $this->Dbid) . "'";
        ...
        if ($this->DetailPages && $this->DetailPages["view_dashboard_collection_details"] && $this->DetailPages["view_dashboard_collection_details"]->Visible) {
            ...
            $url = "ViewDashboardCollectionDetailsPreview?t=view_dashboard_summary_payment_mode&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_dashboard_summary_payment_mode')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewDashboardCollectionDetailsList?" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_summary_payment_mode&" . GetForeignKeyUrl("fk_createddate", $this->createddate->CurrentValue, 7) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->CurrentValue) . "&" . GetForeignKeyUrl("fk__UserName", $this->_UserName->CurrentValue) . "");
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_dashboard_summary_payment_mode')) {
