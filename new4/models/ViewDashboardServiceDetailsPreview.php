 ...
 * Page class
 */
class ViewDashboardServiceDetailsPreview extends ViewDashboardServiceDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardServiceDetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_dashboard_service_servicetype") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_service_servicetype&" . GetForeignKeyUrl("fk_DEPARTMENT", $this->DEPARTMENT->QueryStringValue) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->QueryStringValue) . "&" . GetForeignKeyUrl("fk_SERVICE_TYPE", $this->SERVICE_TYPE->QueryStringValue) . "&" . GetForeignKeyUrl("fk_createdDate", $this->createdDate->QueryStringValue, 7) . "";
        }
        return $url;
    }
