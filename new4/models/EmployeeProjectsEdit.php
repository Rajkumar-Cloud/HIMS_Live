 ...
 * Page class
 */
class EmployeeProjectsEdit extends EmployeeProjects
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeProjectsEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("EmployeeProjectsList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "EmployeeProjectsList") {
