...
/**
 * Table class for view_pharmacy_pharled_return
 */
class ViewPharmacyPharledReturn extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_pharled_return';
        $this->TableName = 'view_pharmacy_pharled_return';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_pharmacy_pharled_return`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TYPE
        $this->TYPE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TYPE', 'TYPE', '`TYPE`', '`TYPE`', 200, 4, -1, false, '`TYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TYPE->Sortable = true; // Allow sort
        $this->TYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TYPE->Param, "CustomMsg");
        $this->Fields['TYPE'] = &$this->TYPE;

        // DN
        $this->DN = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DN', 'DN', '`DN`', '`DN`', 200, 46, -1, false, '`DN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RDN
        $this->RDN = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RDN', 'RDN', '`RDN`', '`RDN`', 200, 6, -1, false, '`RDN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OQ
        $this->OQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_OQ', 'OQ', '`OQ`', '`OQ`', 131, 12, -1, false, '`OQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SiNo
        $this->SiNo = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_SiNo', 'SiNo', '`SiNo`', '`SiNo`', 3, 11, -1, false, '`SiNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RQ
        $this->RQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RQ', 'RQ', '`RQ`', '`RQ`', 131, 12, -1, false, '`RQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Product
        $this->Product = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_Product', 'Product', '`Product`', '`Product`', 200, 100, -1, false, '`Product`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SLNO
        $this->SLNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_SLNO', 'SLNO', '`SLNO`', '`SLNO`', 3, 11, -1, false, '`SLNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SLNO->Sortable = true; // Allow sort
        $this->SLNO->Lookup = new Lookup('SLNO', 'view_pharmacy_search_product', false, 'id', ["DES","Stock","BATCH","EXPDT"], [], [], [], [], ["BRCODE","PRC","DES","RT","BATCH","EXPDT","MFRCODE","Stock","MFRCODE"], ["x_BRCODE","x_PRC","x_Product","x_RT","x_BATCHNO","x_EXPDT","x_Mfg","x_UR","x_MFRCODE"], '`EXPDT` ASC', '');
        ...
        // RT
        $this->RT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RT', 'RT', '`RT`', '`RT`', 131, 12, -1, false, '`RT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRQ
        $this->MRQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MRQ', 'MRQ', '`MRQ`', '`MRQ`', 131, 12, -1, false, '`MRQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IQ
        $this->IQ = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_IQ', 'IQ', '`IQ`', '`IQ`', 131, 12, -1, false, '`IQ`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DAMT
        $this->DAMT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DAMT', 'DAMT', '`DAMT`', '`DAMT`', 131, 12, -1, false, '`DAMT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCHNO
        $this->BATCHNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BATCHNO', 'BATCHNO', '`BATCHNO`', '`BATCHNO`', 200, 10, -1, false, '`BATCHNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPDT
        $this->EXPDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_EXPDT', 'EXPDT', '`EXPDT`', CastDateFieldForLike("`EXPDT`", 0, "DB"), 135, 19, 0, false, '`EXPDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Mfg
        $this->Mfg = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_Mfg', 'Mfg', '`Mfg`', '`Mfg`', 200, 45, -1, false, '`Mfg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLNO
        $this->BILLNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, 50, -1, false, '`BILLNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDT
        $this->BILLDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLDT', 'BILLDT', '`BILLDT`', CastDateFieldForLike("`BILLDT`", 0, "DB"), 135, 19, 0, false, '`BILLDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VALUE
        $this->VALUE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_VALUE', 'VALUE', '`VALUE`', '`VALUE`', 131, 12, -1, false, '`VALUE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISC
        $this->DISC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DISC', 'DISC', '`DISC`', '`DISC`', 131, 12, -1, false, '`DISC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAXP
        $this->TAXP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TAXP', 'TAXP', '`TAXP`', '`TAXP`', 131, 8, -1, false, '`TAXP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAX
        $this->TAX = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TAX', 'TAX', '`TAX`', '`TAX`', 131, 12, -1, false, '`TAX`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAXR
        $this->TAXR = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TAXR', 'TAXR', '`TAXR`', '`TAXR`', 131, 12, -1, false, '`TAXR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPNO
        $this->EMPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_EMPNO', 'EMPNO', '`EMPNO`', '`EMPNO`', 200, 100, -1, false, '`EMPNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DRNAME
        $this->DRNAME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DRNAME', 'DRNAME', '`DRNAME`', '`DRNAME`', 200, 40, -1, false, '`DRNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BTIME
        $this->BTIME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BTIME', 'BTIME', '`BTIME`', '`BTIME`', 200, 8, -1, false, '`BTIME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ONO
        $this->ONO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_ONO', 'ONO', '`ONO`', '`ONO`', 200, 15, -1, false, '`ONO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ODT
        $this->ODT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_ODT', 'ODT', '`ODT`', CastDateFieldForLike("`ODT`", 0, "DB"), 135, 19, 0, false, '`ODT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PURRT
        $this->PURRT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PURRT', 'PURRT', '`PURRT`', '`PURRT`', 131, 12, -1, false, '`PURRT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GRP
        $this->GRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_GRP', 'GRP', '`GRP`', '`GRP`', 200, 21, -1, false, '`GRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GRP->Sortable = true; // Allow sort
        $this->GRP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GRP->Param, "CustomMsg");
        $this->Fields['GRP'] = &$this->GRP;

        // IBATCH
        $this->IBATCH = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_IBATCH', 'IBATCH', '`IBATCH`', '`IBATCH`', 200, 11, -1, false, '`IBATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IPNO
        $this->IPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_IPNO', 'IPNO', '`IPNO`', '`IPNO`', 200, 45, -1, false, '`IPNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OPNO
        $this->OPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_OPNO', 'OPNO', '`OPNO`', '`OPNO`', 200, 45, -1, false, '`OPNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RECID
        $this->RECID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RECID', 'RECID', '`RECID`', '`RECID`', 200, 18, -1, false, '`RECID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FQTY
        $this->FQTY = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_FQTY', 'FQTY', '`FQTY`', '`FQTY`', 131, 12, -1, false, '`FQTY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UR
        $this->UR = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_UR', 'UR', '`UR`', '`UR`', 131, 12, -1, false, '`UR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DCID
        $this->DCID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DCID', 'DCID', '`DCID`', '`DCID`', 200, 1, -1, false, '`DCID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USERID
        $this->_USERID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x__USERID', 'USERID', '`USERID`', '`USERID`', 200, 5, -1, false, '`USERID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODDT
        $this->MODDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MODDT', 'MODDT', '`MODDT`', CastDateFieldForLike("`MODDT`", 0, "DB"), 135, 19, 0, false, '`MODDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FYM
        $this->FYM = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_FYM', 'FYM', '`FYM`', '`FYM`', 200, 8, -1, false, '`FYM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRCBATCH
        $this->PRCBATCH = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRCBATCH', 'PRCBATCH', '`PRCBATCH`', '`PRCBATCH`', 200, 23, -1, false, '`PRCBATCH`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MRP
        $this->MRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MRP', 'MRP', '`MRP`', '`MRP`', 131, 12, -1, false, '`MRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLYM
        $this->BILLYM = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLYM', 'BILLYM', '`BILLYM`', '`BILLYM`', 200, 8, -1, false, '`BILLYM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLGRP
        $this->BILLGRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BILLGRP', 'BILLGRP', '`BILLGRP`', '`BILLGRP`', 200, 21, -1, false, '`BILLGRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STAFF
        $this->STAFF = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_STAFF', 'STAFF', '`STAFF`', '`STAFF`', 200, 80, -1, false, '`STAFF`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TEMPIPNO
        $this->TEMPIPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_TEMPIPNO', 'TEMPIPNO', '`TEMPIPNO`', '`TEMPIPNO`', 200, 16, -1, false, '`TEMPIPNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRNTED
        $this->PRNTED = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRNTED', 'PRNTED', '`PRNTED`', '`PRNTED`', 200, 1, -1, false, '`PRNTED`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PATNAME
        $this->PATNAME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PATNAME', 'PATNAME', '`PATNAME`', '`PATNAME`', 200, 99, -1, false, '`PATNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PJVNO
        $this->PJVNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PJVNO', 'PJVNO', '`PJVNO`', '`PJVNO`', 200, 5, -1, false, '`PJVNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PJVSLNO
        $this->PJVSLNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PJVSLNO', 'PJVSLNO', '`PJVSLNO`', '`PJVSLNO`', 200, 3, -1, false, '`PJVSLNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OTHDISC
        $this->OTHDISC = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_OTHDISC', 'OTHDISC', '`OTHDISC`', '`OTHDISC`', 131, 12, -1, false, '`OTHDISC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PJVYM
        $this->PJVYM = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PJVYM', 'PJVYM', '`PJVYM`', '`PJVYM`', 200, 6, -1, false, '`PJVYM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PURDISCPER
        $this->PURDISCPER = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PURDISCPER', 'PURDISCPER', '`PURDISCPER`', '`PURDISCPER`', 131, 5, -1, false, '`PURDISCPER`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHIER
        $this->CASHIER = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHIER', 'CASHIER', '`CASHIER`', '`CASHIER`', 200, 5, -1, false, '`CASHIER`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHTIME
        $this->CASHTIME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHTIME', 'CASHTIME', '`CASHTIME`', '`CASHTIME`', 200, 8, -1, false, '`CASHTIME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHRECD
        $this->CASHRECD = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHRECD', 'CASHRECD', '`CASHRECD`', '`CASHRECD`', 131, 12, -1, false, '`CASHRECD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHREFNO
        $this->CASHREFNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHREFNO', 'CASHREFNO', '`CASHREFNO`', '`CASHREFNO`', 200, 5, -1, false, '`CASHREFNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHIERSHIFT
        $this->CASHIERSHIFT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CASHIERSHIFT', 'CASHIERSHIFT', '`CASHIERSHIFT`', '`CASHIERSHIFT`', 200, 1, -1, false, '`CASHIERSHIFT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRCODE
        $this->PRCODE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PRCODE', 'PRCODE', '`PRCODE`', '`PRCODE`', 200, 9, -1, false, '`PRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RELEASEBY
        $this->RELEASEBY = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RELEASEBY', 'RELEASEBY', '`RELEASEBY`', '`RELEASEBY`', 200, 15, -1, false, '`RELEASEBY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CRAUTHOR
        $this->CRAUTHOR = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_CRAUTHOR', 'CRAUTHOR', '`CRAUTHOR`', '`CRAUTHOR`', 200, 15, -1, false, '`CRAUTHOR`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYMENT
        $this->PAYMENT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PAYMENT', 'PAYMENT', '`PAYMENT`', '`PAYMENT`', 200, 4, -1, false, '`PAYMENT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DRID
        $this->DRID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DRID', 'DRID', '`DRID`', '`DRID`', 200, 5, -1, false, '`DRID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WARD
        $this->WARD = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_WARD', 'WARD', '`WARD`', '`WARD`', 200, 30, -1, false, '`WARD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STAXTYPE
        $this->STAXTYPE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_STAXTYPE', 'STAXTYPE', '`STAXTYPE`', '`STAXTYPE`', 200, 1, -1, false, '`STAXTYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PURDISCVAL
        $this->PURDISCVAL = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PURDISCVAL', 'PURDISCVAL', '`PURDISCVAL`', '`PURDISCVAL`', 131, 12, -1, false, '`PURDISCVAL`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RNDOFF
        $this->RNDOFF = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_RNDOFF', 'RNDOFF', '`RNDOFF`', '`RNDOFF`', 131, 10, -1, false, '`RNDOFF`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCONMRP
        $this->DISCONMRP = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DISCONMRP', 'DISCONMRP', '`DISCONMRP`', '`DISCONMRP`', 131, 12, -1, false, '`DISCONMRP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DELVDT
        $this->DELVDT = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DELVDT', 'DELVDT', '`DELVDT`', CastDateFieldForLike("`DELVDT`", 0, "DB"), 135, 19, 0, false, '`DELVDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DELVTIME
        $this->DELVTIME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DELVTIME', 'DELVTIME', '`DELVTIME`', '`DELVTIME`', 200, 8, -1, false, '`DELVTIME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DELVBY
        $this->DELVBY = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_DELVBY', 'DELVBY', '`DELVBY`', '`DELVBY`', 200, 5, -1, false, '`DELVBY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HOSPNO
        $this->HOSPNO = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_HOSPNO', 'HOSPNO', '`HOSPNO`', '`HOSPNO`', 200, 10, -1, false, '`HOSPNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // pbv
        $this->pbv = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_pbv', 'pbv', '`pbv`', '`pbv`', 3, 11, -1, false, '`pbv`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pbt
        $this->pbt = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_pbt', 'pbt', '`pbt`', '`pbt`', 3, 11, -1, false, '`pbt`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HosoID
        $this->HosoID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_HosoID', 'HosoID', '`HosoID`', '`HosoID`', 3, 11, -1, false, '`HosoID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Reception
        $this->Reception = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatID
        $this->PatID = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // mrnno
        $this->mrnno = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_mrnno', 'mrnno', '`mrnno`', '`mrnno`', 200, 45, -1, false, '`mrnno`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->mrnno->Sortable = true; // Allow sort
        $this->mrnno->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mrnno->Param, "CustomMsg");
        $this->Fields['mrnno'] = &$this->mrnno;

        // BRNAME
        $this->BRNAME = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_BRNAME', 'BRNAME', '`BRNAME`', '`BRNAME`', 200, 45, -1, false, '`BRNAME`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sretid
        $this->sretid = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_sretid', 'sretid', '`sretid`', '`sretid`', 3, 11, -1, false, '`sretid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->sretid->IsForeignKey = true; // Foreign key field
        ...
        // sprid
        $this->sprid = new DbField('view_pharmacy_pharled_return', 'view_pharmacy_pharled_return', 'x_sprid', 'sprid', '`sprid`', '`sprid`', 3, 11, -1, false, '`sprid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "pharmacy_billing_return") {
            if ($this->sretid->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->sretid->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "pharmacy_billing_return") {
            if ($this->sretid->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`sretid`", $this->sretid->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_pharmacy_billing_return()
    {
        return "`id`=@id@";
    }
    // Detail filter
    public function sqlDetailFilter_pharmacy_billing_return()
    {
        return "`sretid`=@sretid@";
    }

    // Table level SQL
    public function getSqlFrom() // From
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_pharmacy_pharled_return`";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`HosoID`='".HospitalID()."'  and `pbt` is not null";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyPharledReturnList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyPharledReturnView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyPharledReturnEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyPharledReturnAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyPharledReturnView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyPharledReturnAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyPharledReturnEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyPharledReturnDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyPharledReturnList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyPharledReturnView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyPharledReturnView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyPharledReturnAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyPharledReturnAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyPharledReturnEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyPharledReturnAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyPharledReturnDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "pharmacy_billing_return" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->sretid->CurrentValue ?? $this->sretid->getSessionValue());
        }
        return $url;
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        if ($this->sretid->getSessionValue() != "") {
            $this->sretid->CurrentValue = GetForeignKeyValue($this->sretid->getSessionValue());
            $this->sretid->ViewValue = $this->sretid->CurrentValue;
            $this->sretid->ViewValue = FormatNumber($this->sretid->ViewValue, 0, -2, -2, -2);
            $this->sretid->ViewCustomAttributes = "";
        } else {
