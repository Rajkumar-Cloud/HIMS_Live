...
/**
 * Table class for view_pharmacy_movement
 */
class ViewPharmacyMovement extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_movement';
        $this->TableName = 'view_pharmacy_movement';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_pharmacy_movement`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // prc
        $this->prc = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_prc', 'prc', '`prc`', '`prc`', 200, 9, -1, false, '`prc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PrName
        $this->PrName = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 100, -1, false, '`PrName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BatchNo
        $this->BatchNo = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, 45, -1, false, '`BatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 7, "DB"), 135, 19, 7, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MFRCODE
        $this->MFRCODE = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_MFRCODE', 'MFRCODE', '`MFRCODE`', '`MFRCODE`', 200, 45, -1, false, '`MFRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // hsn
        $this->hsn = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_hsn', 'hsn', '`hsn`', '`hsn`', 200, 45, -1, false, '`hsn`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_pharmacy_movement_item") {
            $detailUrl = Container("view_pharmacy_movement_item")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_prc", $this->prc->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_BatchNo", $this->BatchNo->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "ViewPharmacyMovementList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_pharmacy_movement`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyMovementList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyMovementView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyMovementEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyMovementAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyMovementView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyMovementAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyMovementEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyMovementDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyMovementList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyMovementView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyMovementView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyMovementAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyMovementAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyMovementEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyMovementAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyMovementDelete", $this->getUrlParm());
    }
