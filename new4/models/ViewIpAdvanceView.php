 ...
 * Page class
 */
class ViewIpAdvanceView extends ViewIpAdvance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewIpAdvanceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ViewIpAdvanceList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ViewIpAdvanceList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "ViewIpAdvanceList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
