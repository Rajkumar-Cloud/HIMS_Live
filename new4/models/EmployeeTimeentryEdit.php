 ...
 * Page class
 */
class EmployeeTimeentryEdit extends EmployeeTimeentry
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTimeentryEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // timesheet
            $this->timesheet->setDbValueDef($rsnew, $this->timesheet->CurrentValue, 0, $this->timesheet->ReadOnly);
            ...
            // date_start
            $this->date_start->setDbValueDef($rsnew, UnFormatDateTime($this->date_start->CurrentValue, 0), null, $this->date_start->ReadOnly);

            // time_start
            $this->time_start->setDbValueDef($rsnew, $this->time_start->CurrentValue, "", $this->time_start->ReadOnly);

            // date_end
            $this->date_end->setDbValueDef($rsnew, UnFormatDateTime($this->date_end->CurrentValue, 0), null, $this->date_end->ReadOnly);

            // time_end
            $this->time_end->setDbValueDef($rsnew, $this->time_end->CurrentValue, "", $this->time_end->ReadOnly);
