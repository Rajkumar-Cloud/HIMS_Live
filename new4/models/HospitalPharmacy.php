 ...
 */
class HospitalPharmacy extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // logo
        $this->logo = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_logo', 'logo', '`logo`', '`logo`', 201, 450, -1, true, '`logo`', false, false, false, 'IMAGE', 'FILE');
        ...
        // pharmacy
        $this->pharmacy = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_pharmacy', 'pharmacy', '`pharmacy`', '`pharmacy`', 200, 100, -1, false, '`pharmacy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // street
        $this->street = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // area
        $this->area = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_area', 'area', '`area`', '`area`', 200, 45, -1, false, '`area`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // province
        $this->province = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_province', 'province', '`province`', '`province`', 200, 50, -1, false, '`province`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postal_code
        $this->postal_code = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 6, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // phone_no
        $this->phone_no = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_phone_no', 'phone_no', '`phone_no`', '`phone_no`', 200, 50, -1, false, '`phone_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PreFixCode
        $this->PreFixCode = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_PreFixCode', 'PreFixCode', '`PreFixCode`', '`PreFixCode`', 200, 45, -1, false, '`PreFixCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // createdby
        $this->createdby = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pharmacyGST
        $this->pharmacyGST = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_pharmacyGST', 'pharmacyGST', '`pharmacyGST`', '`pharmacyGST`', 200, 45, -1, false, '`pharmacyGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospId
        $this->HospId = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_HospId', 'HospId', '`HospId`', '`HospId`', 3, 11, -1, false, '`HospId`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // BranchID
        $this->BranchID = new DbField('hospital_pharmacy', 'hospital_pharmacy', 'x_BranchID', 'BranchID', '`BranchID`', '`BranchID`', 3, 11, -1, false, '`BranchID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HospitalPharmacyList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "HospitalPharmacyEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "HospitalPharmacyAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "HospitalPharmacyView";
            case Config("API_ADD_ACTION"):
                return "HospitalPharmacyAdd";
            case Config("API_EDIT_ACTION"):
                return "HospitalPharmacyEdit";
            case Config("API_DELETE_ACTION"):
                return "HospitalPharmacyDelete";
            case Config("API_LIST_ACTION"):
                return "HospitalPharmacyList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HospitalPharmacyView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("HospitalPharmacyView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "HospitalPharmacyAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "HospitalPharmacyAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HospitalPharmacyEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HospitalPharmacyAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("HospitalPharmacyDelete", $this->getUrlParm());
    }
