 ...
 */
class PharmacyPurchaseorder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Disc
        $this->Disc = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 200, 45, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grndate
        $this->grndate = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grndate', 'grndate', '`grndate`', CastDateFieldForLike("`grndate`", 0, "DB"), 133, 10, 0, false, '`grndate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // grndatetime
        $this->grndatetime = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_grndatetime', 'grndatetime', '`grndatetime`', CastDateFieldForLike("`grndatetime`", 0, "DB"), 135, 19, 0, false, '`grndatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // strid
        $this->strid = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_strid', 'strid', '`strid`', '`strid`', 3, 11, -1, false, '`strid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GRNPer
        $this->GRNPer = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_GRNPer', 'GRNPer', '`GRNPer`', '`GRNPer`', 131, 12, -1, false, '`GRNPer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FreeQtyyy
        $this->FreeQtyyy = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_FreeQtyyy', 'FreeQtyyy', '`FreeQtyyy`', '`FreeQtyyy`', 3, 11, -1, false, '`FreeQtyyy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "pharmacy_po") {
            if ($this->poid->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("`id`", $this->poid->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "pharmacy_po") {
            if ($this->poid->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`poid`", $this->poid->getSessionValue(), DATATYPE_NUMBER, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `DES` FROM `pharmacy_storemast` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`PRC` = `pharmacy_purchaseorder`.`PRC` LIMIT 1) AS `EV__PRC` FROM `pharmacy_purchaseorder`)";
    ...
    protected function useVirtualFields()
    {
        ...
        if (
            $this->PRC->AdvancedSearch->SearchValue != "" ||
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyPurchaseorderList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PharmacyPurchaseorderEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PharmacyPurchaseorderAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyPurchaseorderView";
            case Config("API_ADD_ACTION"):
                return "PharmacyPurchaseorderAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyPurchaseorderEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyPurchaseorderDelete";
            case Config("API_LIST_ACTION"):
                return "PharmacyPurchaseorderList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyPurchaseorderView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyPurchaseorderView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PharmacyPurchaseorderAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PharmacyPurchaseorderAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PharmacyPurchaseorderEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PharmacyPurchaseorderAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PharmacyPurchaseorderDelete", $this->getUrlParm());
    }
    ...
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "pharmacy_po" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            ...
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->poid->CurrentValue ?? $this->poid->getSessionValue());
        }
        return $url;
    }
