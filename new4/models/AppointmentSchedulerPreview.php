 ...
 * Page class
 */
class AppointmentSchedulerPreview extends AppointmentScheduler
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AppointmentSchedulerPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "doctors") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=doctors&" . GetForeignKeyUrl("fk_id", $this->DoctorID->QueryStringValue) . "";
        }
        return $url;
    }
