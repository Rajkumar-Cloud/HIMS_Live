 ...
 * Page class
 */
class ViewAppointmentSchedulerAdd extends ViewAppointmentScheduler
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewAppointmentSchedulerAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("ViewAppointmentSchedulerList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ViewAppointmentSchedulerList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ViewAppointmentSchedulerView") {
