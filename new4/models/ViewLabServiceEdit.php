 ...
 * Page class
 */
class ViewLabServiceEdit extends ViewLabService
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewLabServiceEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("view_lab_service_sub", $detailTblVar) && $detailPage->DetailEdit) {
