 ...
 * Page class
 */
class ViewDashboardSummaryModeofpaymentDetailsPreview extends ViewDashboardSummaryModeofpaymentDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardSummaryModeofpaymentDetailsPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_dashboard_summary_details") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_summary_details&" . GetForeignKeyUrl("fk__UserName", $this->_UserName->QueryStringValue) . "&" . GetForeignKeyUrl("fk_createddate", $this->createddate->QueryStringValue, 0) . "&" . GetForeignKeyUrl("fk_HospID", $this->HospID->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewDashboardSummaryModeofpaymentDetailsList"), "", $this->TableVar, true);
        $pageId = "preview";
