 ...
 * Page class
 */
class EmployeeHasExperienceList extends EmployeeHasExperience
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeHasExperienceList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "EmployeeHasExperienceDelete";
        $this->MultiUpdateUrl = "EmployeeHasExperienceUpdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->jobdescription->AdvancedSearch->toJson(), ","); // Field job description
    ...
    protected function restoreFilterList()
    {
        ...
        $this->jobdescription->AdvancedSearch->SearchValue = @$filter["x_jobdescription"];
        $this->jobdescription->AdvancedSearch->SearchOperator = @$filter["z_jobdescription"];
        $this->jobdescription->AdvancedSearch->SearchCondition = @$filter["v_jobdescription"];
        $this->jobdescription->AdvancedSearch->SearchValue2 = @$filter["y_jobdescription"];
        $this->jobdescription->AdvancedSearch->SearchOperator2 = @$filter["w_jobdescription"];
        $this->jobdescription->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->jobdescription, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->jobdescription); // job description
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash .= GetFieldHash($row['working_at']); // working_at
        $hash .= GetFieldHash($row['job description']); // job description
        $hash .= GetFieldHash($row['role']); // role
        $hash .= GetFieldHash($row['start_date']); // start_date
        $hash .= GetFieldHash($row['end_date']); // end_date
        $hash .= GetFieldHash($row['total_experience']); // total_experience
