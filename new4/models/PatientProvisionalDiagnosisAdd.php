 ...
 * Page class
 */
class PatientProvisionalDiagnosisAdd extends PatientProvisionalDiagnosis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientProvisionalDiagnosisAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PatientProvisionalDiagnosisView") {
