 ...
 * Page class
 */
class ViewOpdFollowUpDelete extends ViewOpdFollowUp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOpdFollowUpDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewOpdFollowUpList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ViewOpdFollowUpList"); // Return to list
                return;
            }
        }
