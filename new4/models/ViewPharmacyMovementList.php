 ...
 * Page class
 */
class ViewPharmacyMovementList extends ViewPharmacyMovement
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyMovementList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPharmacyMovementAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPharmacyMovementDelete";
        $this->MultiUpdateUrl = "ViewPharmacyMovementUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_pharmacy_movement"));
                $doc->Text = @$content;
    ...
    protected function loadSortOrder()
    {
        ...
        if ($orderBy == "") {
            $this->DefaultSort = "`PrName` ASC";
            if ($this->getSqlOrderBy() != "") {
                $useDefaultSort = true;
                if ($this->PrName->getSort() != "") {
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'view_pharmacy_movement_item')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ViewPharmacyMovementItemList?" . Config("TABLE_SHOW_MASTER") . "=view_pharmacy_movement&" . GetForeignKeyUrl("fk_prc", $this->prc->CurrentValue) . "&" . GetForeignKeyUrl("fk_BatchNo", $this->BatchNo->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ViewPharmacyMovementItemGrid");
            if ($links != "") {
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["view_pharmacy_movement_item"] && $this->DetailPages["view_pharmacy_movement_item"]->Visible) {
            ...
            $url = "ViewPharmacyMovementItemPreview?t=view_pharmacy_movement&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'view_pharmacy_movement')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ViewPharmacyMovementItemList?" . Config("TABLE_SHOW_MASTER") . "=view_pharmacy_movement&" . GetForeignKeyUrl("fk_prc", $this->prc->CurrentValue) . "&" . GetForeignKeyUrl("fk_BatchNo", $this->BatchNo->CurrentValue) . "");
            ...
            $detailPageObj = Container("ViewPharmacyMovementItemGrid");
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_pharmacy_movement')) {
    ...
    protected function setupSearchOptions()
    {
        ...
        if (IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"ViewPharmacyMovementSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_pharmacy_movement\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'ViewPharmacyMovementSearch'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        }
        $item->Visible = true;
