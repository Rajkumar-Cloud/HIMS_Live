 ...
 */
class PharmacyGrn extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // GRNNO
        $this->GRNNO = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_GRNNO', 'GRNNO', '`GRNNO`', '`GRNNO`', 200, 45, -1, false, '`GRNNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DT
        $this->DT = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 7, "DB"), 135, 19, 7, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YM
        $this->YM = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_YM', 'YM', '`YM`', '`YM`', 200, 45, -1, false, '`YM`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_PC', 'PC', '`PC`', '`PC`', 200, 45, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Customercode
        $this->Customercode = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Customercode', 'Customercode', '`Customercode`', '`Customercode`', 200, 45, -1, false, '`Customercode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Customername
        $this->Customername = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Customername', 'Customername', '`Customername`', '`Customername`', 200, 45, -1, false, '`Customername`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pharmacy_pocol
        $this->pharmacy_pocol = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_pharmacy_pocol', 'pharmacy_pocol', '`pharmacy_pocol`', '`pharmacy_pocol`', 200, 45, -1, false, '`pharmacy_pocol`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address1
        $this->Address1 = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 201, 405, -1, false, '`Address1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address2
        $this->Address2 = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 201, 405, -1, false, '`Address2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address3
        $this->Address3 = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 201, 405, -1, false, '`Address3`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // State
        $this->State = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pincode
        $this->Pincode = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Pincode', 'Pincode', '`Pincode`', '`Pincode`', 200, 45, -1, false, '`Pincode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Phone
        $this->Phone = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, 45, -1, false, '`Phone`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Phone->Sortable = true; // Allow sort
        $this->Phone->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Phone->Param, "CustomMsg");
        $this->Fields['Phone'] = &$this->Phone;

        // Fax
        $this->Fax = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, 45, -1, false, '`Fax`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EEmail
        $this->EEmail = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_EEmail', 'EEmail', '`EEmail`', '`EEmail`', 200, 45, -1, false, '`EEmail`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 7, "DB"), 135, 19, 7, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLNO
        $this->BILLNO = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_BILLNO', 'BILLNO', '`BILLNO`', '`BILLNO`', 200, 45, -1, false, '`BILLNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILLDT
        $this->BILLDT = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_BILLDT', 'BILLDT', '`BILLDT`', CastDateFieldForLike("`BILLDT`", 0, "DB"), 135, 19, 0, false, '`BILLDT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PharmacyID
        $this->PharmacyID = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_PharmacyID', 'PharmacyID', '`PharmacyID`', '`PharmacyID`', 3, 11, -1, false, '`PharmacyID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillTotalValue
        $this->BillTotalValue = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_BillTotalValue', 'BillTotalValue', '`BillTotalValue`', '`BillTotalValue`', 131, 10, -1, false, '`BillTotalValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GRNTotalValue
        $this->GRNTotalValue = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_GRNTotalValue', 'GRNTotalValue', '`GRNTotalValue`', '`GRNTotalValue`', 131, 10, -1, false, '`GRNTotalValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillDiscount
        $this->BillDiscount = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_BillDiscount', 'BillDiscount', '`BillDiscount`', '`BillDiscount`', 131, 10, -1, false, '`BillDiscount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillUpload
        $this->BillUpload = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_BillUpload', 'BillUpload', '`BillUpload`', '`BillUpload`', 201, 450, -1, true, '`BillUpload`', false, false, false, 'IMAGE', 'FILE');
        ...
        // TransPort
        $this->TransPort = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_TransPort', 'TransPort', '`TransPort`', '`TransPort`', 131, 10, -1, false, '`TransPort`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnyOther
        $this->AnyOther = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_AnyOther', 'AnyOther', '`AnyOther`', '`AnyOther`', 131, 10, -1, false, '`AnyOther`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, 205, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Remarks->Sortable = true; // Allow sort
        $this->Remarks->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Remarks->Param, "CustomMsg");
        $this->Fields['Remarks'] = &$this->Remarks;

        // GrnValue
        $this->GrnValue = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_GrnValue', 'GrnValue', '`GrnValue`', '`GrnValue`', 131, 10, -1, false, '`GrnValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pid
        $this->Pid = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_Pid', 'Pid', '`Pid`', '`Pid`', 3, 11, -1, false, '`Pid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentNo
        $this->PaymentNo = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_PaymentNo', 'PaymentNo', '`PaymentNo`', '`PaymentNo`', 200, 45, -1, false, '`PaymentNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentStatus
        $this->PaymentStatus = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 200, 45, -1, false, '`PaymentStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaidAmount
        $this->PaidAmount = new DbField('pharmacy_grn', 'pharmacy_grn', 'x_PaidAmount', 'PaidAmount', '`PaidAmount`', '`PaidAmount`', 131, 10, -1, false, '`PaidAmount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "view_pharmacygrn") {
            $detailUrl = Container("view_pharmacygrn")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "PharmacyGrnList";
        }
        return $detailUrl;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PharmacyGrnList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PharmacyGrnEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PharmacyGrnAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PharmacyGrnView";
            case Config("API_ADD_ACTION"):
                return "PharmacyGrnAdd";
            case Config("API_EDIT_ACTION"):
                return "PharmacyGrnEdit";
            case Config("API_DELETE_ACTION"):
                return "PharmacyGrnDelete";
            case Config("API_LIST_ACTION"):
                return "PharmacyGrnList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyGrnView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyGrnView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PharmacyGrnAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PharmacyGrnAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyGrnEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyGrnEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PharmacyGrnAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PharmacyGrnAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PharmacyGrnDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "pharmacy_payment" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
