 ...
 * Page class
 */
class IvfOocytedenudationStageList extends IvfOocytedenudationStage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IvfOocytedenudationStageList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "IvfOocytedenudationStageAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "IvfOocytedenudationStageDelete";
        $this->MultiUpdateUrl = "IvfOocytedenudationStageUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("ivf_oocytedenudation_stage"));
                $doc->Text = @$content;
