...
/**
 * Table class for store_billing_transfer
 */
class StoreBillingTransfer extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'store_billing_transfer';
        $this->TableName = 'store_billing_transfer';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`store_billing_transfer`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // transfer
        $this->transfer = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_transfer', 'transfer', '`transfer`', '`transfer`', 3, 11, -1, false, '`transfer`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // pharmacy
        $this->pharmacy = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_pharmacy', 'pharmacy', '`pharmacy`', '`pharmacy`', 200, 45, -1, false, '`pharmacy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // street
        $this->street = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_street', 'street', '`street`', '`street`', 201, 450, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // area
        $this->area = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_area', 'area', '`area`', '`area`', 201, 450, -1, false, '`area`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_town', 'town', '`town`', '`town`', 201, 450, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // province
        $this->province = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_province', 'province', '`province`', '`province`', 200, 45, -1, false, '`province`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postal_code
        $this->postal_code = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 45, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // phone_no
        $this->phone_no = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_phone_no', 'phone_no', '`phone_no`', '`phone_no`', 200, 45, -1, false, '`phone_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Details
        $this->Details = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_Details', 'Details', '`Details`', '`Details`', 200, 45, -1, false, '`Details`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 200, 45, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->createdby->Sortable = true; // Allow sort
        $this->createdby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->createdby->Param, "CustomMsg");
        $this->Fields['createdby'] = &$this->createdby;

        // createddatetime
        $this->createddatetime = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 200, 45, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modifiedby->Sortable = true; // Allow sort
        $this->modifiedby->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->modifiedby->Param, "CustomMsg");
        $this->Fields['modifiedby'] = &$this->modifiedby;

        // modifieddatetime
        $this->modifieddatetime = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TidNo
        $this->TidNo = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_TidNo', 'TidNo', '`TidNo`', '`TidNo`', 3, 11, -1, false, '`TidNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatId
        $this->PatId = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillStatus
        $this->BillStatus = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_BillStatus', 'BillStatus', '`BillStatus`', '`BillStatus`', 3, 11, -1, false, '`BillStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StoreID
        $this->StoreID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, 11, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->StoreID->Sortable = true; // Allow sort
        $this->StoreID->Lookup = new Lookup('StoreID', 'hospital_pharmacy', false, 'id', ["pharmacy","","",""], [], [], [], [], [], [], '', '');
        ...
        // BranchID
        $this->BranchID = new DbField('store_billing_transfer', 'store_billing_transfer', 'x_BranchID', 'BranchID', '`BranchID`', '`BranchID`', 3, 11, -1, false, '`BranchID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "view_store_transfer") {
            $detailUrl = Container("view_store_transfer")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "StoreBillingTransferList";
        }
        return $detailUrl;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`store_billing_transfer`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("StoreBillingTransferList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "StoreBillingTransferEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "StoreBillingTransferAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "StoreBillingTransferView";
            case Config("API_ADD_ACTION"):
                return "StoreBillingTransferAdd";
            case Config("API_EDIT_ACTION"):
                return "StoreBillingTransferEdit";
            case Config("API_DELETE_ACTION"):
                return "StoreBillingTransferDelete";
            case Config("API_LIST_ACTION"):
                return "StoreBillingTransferList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StoreBillingTransferView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StoreBillingTransferView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "StoreBillingTransferAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "StoreBillingTransferAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StoreBillingTransferEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StoreBillingTransferEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("StoreBillingTransferAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("StoreBillingTransferAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("StoreBillingTransferDelete", $this->getUrlParm());
    }
