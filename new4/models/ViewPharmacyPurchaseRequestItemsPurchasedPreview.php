 ...
 * Page class
 */
class ViewPharmacyPurchaseRequestItemsPurchasedPreview extends ViewPharmacyPurchaseRequestItemsPurchased
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewPharmacyPurchaseRequestItemsPurchasedPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_pharmacy_purchase_request_purchased") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_pharmacy_purchase_request_purchased&" . GetForeignKeyUrl("fk_id", $this->prid->QueryStringValue) . "";
        }
        return $url;
    }
