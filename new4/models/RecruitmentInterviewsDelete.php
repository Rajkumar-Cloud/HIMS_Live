 ...
 * Page class
 */
class RecruitmentInterviewsDelete extends RecruitmentInterviews
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecruitmentInterviewsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RecruitmentInterviewsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RecruitmentInterviewsList"); // Return to list
                return;
            }
        }
