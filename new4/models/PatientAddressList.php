 ...
 * Page class
 */
class PatientAddressList extends PatientAddress
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAddressList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PatientAddressAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PatientAddressDelete";
        $this->MultiUpdateUrl = "PatientAddressUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("patient_address"));
                $doc->Text = @$content;
