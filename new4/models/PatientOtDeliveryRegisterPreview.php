 ...
 * Page class
 */
class PatientOtDeliveryRegisterPreview extends PatientOtDeliveryRegister
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientOtDeliveryRegisterPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "ip_admission") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=ip_admission&" . GetForeignKeyUrl("fk_id", $this->Reception->QueryStringValue) . "&" . GetForeignKeyUrl("fk_mrnNo", $this->mrnno->QueryStringValue) . "&" . GetForeignKeyUrl("fk_patient_id", $this->PId->QueryStringValue) . "";
        }
        return $url;
    }
