...
/**
 * Table class for hospital_branch
 */
class HospitalBranch extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'hospital_branch';
        $this->TableName = 'hospital_branch';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`hospital_branch`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id
        $this->id = new DbField('hospital_branch', 'hospital_branch', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // logo
        $this->logo = new DbField('hospital_branch', 'hospital_branch', 'x_logo', 'logo', '`logo`', '`logo`', 201, 450, -1, false, '`logo`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // hospital
        $this->hospital = new DbField('hospital_branch', 'hospital_branch', 'x_hospital', 'hospital', '`hospital`', '`hospital`', 200, 100, -1, false, '`hospital`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->hospital->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->hospital->Param, "CustomMsg");
        $this->Fields['hospital'] = &$this->hospital;

        // street
        $this->street = new DbField('hospital_branch', 'hospital_branch', 'x_street', 'street', '`street`', '`street`', 200, 100, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // area
        $this->area = new DbField('hospital_branch', 'hospital_branch', 'x_area', 'area', '`area`', '`area`', 200, 45, -1, false, '`area`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // town
        $this->town = new DbField('hospital_branch', 'hospital_branch', 'x_town', 'town', '`town`', '`town`', 200, 50, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // province
        $this->province = new DbField('hospital_branch', 'hospital_branch', 'x_province', 'province', '`province`', '`province`', 200, 50, -1, false, '`province`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // postal_code
        $this->postal_code = new DbField('hospital_branch', 'hospital_branch', 'x_postal_code', 'postal_code', '`postal_code`', '`postal_code`', 200, 6, -1, false, '`postal_code`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // phone_no
        $this->phone_no = new DbField('hospital_branch', 'hospital_branch', 'x_phone_no', 'phone_no', '`phone_no`', '`phone_no`', 200, 50, -1, false, '`phone_no`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PreFixCode
        $this->PreFixCode = new DbField('hospital_branch', 'hospital_branch', 'x_PreFixCode', 'PreFixCode', '`PreFixCode`', '`PreFixCode`', 200, 45, -1, false, '`PreFixCode`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('hospital_branch', 'hospital_branch', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createdby
        $this->createdby = new DbField('hospital_branch', 'hospital_branch', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, false, '`createdby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('hospital_branch', 'hospital_branch', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifiedby
        $this->modifiedby = new DbField('hospital_branch', 'hospital_branch', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, false, '`modifiedby`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // modifieddatetime
        $this->modifieddatetime = new DbField('hospital_branch', 'hospital_branch', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, false, '`modifieddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospId
        $this->HospId = new DbField('hospital_branch', 'hospital_branch', 'x_HospId', 'HospId', '`HospId`', '`HospId`', 3, 11, -1, false, '`HospId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Country
        $this->Country = new DbField('hospital_branch', 'hospital_branch', 'x_Country', 'Country', '`Country`', '`Country`', 200, 45, -1, false, '`Country`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`hospital_branch`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HospitalBranchList");
    }
    ...
    {
        global $Language;
        if ($pageName == "HospitalBranchView") {
            return $Language->phrase("View");
        } elseif ($pageName == "HospitalBranchEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "HospitalBranchAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "HospitalBranchView";
            case Config("API_ADD_ACTION"):
                return "HospitalBranchAdd";
            case Config("API_EDIT_ACTION"):
                return "HospitalBranchEdit";
            case Config("API_DELETE_ACTION"):
                return "HospitalBranchDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HospitalBranchView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("HospitalBranchView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "HospitalBranchAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "HospitalBranchAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HospitalBranchEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HospitalBranchAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("HospitalBranchDelete", $this->getUrlParm());
    }
