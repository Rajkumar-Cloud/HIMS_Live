 ...
 * Page class
 */
class PharmacyPoAdd extends PharmacyPo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PharmacyPoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PharmacyPoView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("pharmacy_purchaseorder", $detailTblVar) && $detailPage->DetailAdd) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            ...
            $detailPage = Container("PharmacyPurchaseorderGrid");
            if (in_array("pharmacy_purchaseorder", $detailTblVar) && $detailPage->DetailAdd) {
                $detailPage->poid->setSessionValue($this->id->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->poid->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
