 ...
 */
class ViewPharmacyConsumption extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Stock
        $this->Stock = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 15, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Select->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->Select->Param, "CustomMsg");
        ...
        $this->ConsQTY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ConsQTY->Param, "CustomMsg");
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyConsumptionList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewPharmacyConsumptionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyConsumptionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyConsumptionView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyConsumptionAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyConsumptionEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyConsumptionDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyConsumptionList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyConsumptionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyConsumptionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyConsumptionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyConsumptionAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyConsumptionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyConsumptionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyConsumptionDelete", $this->getUrlParm());
    }
