 ...
 * Page class
 */
class PatientDocumentDelete extends PatientDocument
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientDocumentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientDocumentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientDocumentList"); // Return to list
                return;
            }
        }
