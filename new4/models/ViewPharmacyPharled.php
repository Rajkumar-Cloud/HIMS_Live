...
/**
 * Table class for view_pharmacy_pharled
 */
class ViewPharmacyPharled extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_pharled';
        $this->TableName = 'view_pharmacy_pharled';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_pharmacy_pharled`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalRate
        $this->SalRate = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, 12, -1, false, '`SalRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('view_pharmacy_pharled', 'view_pharmacy_pharled', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_pharmacy_pharled`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyPharledList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyPharledView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyPharledEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyPharledAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyPharledView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyPharledAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyPharledEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyPharledDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyPharledList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyPharledView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyPharledView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyPharledAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyPharledAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyPharledEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyPharledAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyPharledDelete", $this->getUrlParm());
    }
