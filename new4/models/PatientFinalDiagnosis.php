 ...
 */
class PatientFinalDiagnosis extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->FinalDiagnosisTemplate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->FinalDiagnosisTemplate->Param, "CustomMsg");
        ...
        $this->TreatmentsTemplate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TreatmentsTemplate->Param, "CustomMsg");
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS `FinalDiagnosisTemplate`, '' AS `TreatmentsTemplate`, '' AS `PatientSearch`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PatientFinalDiagnosisList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PatientFinalDiagnosisEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PatientFinalDiagnosisAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PatientFinalDiagnosisView";
            case Config("API_ADD_ACTION"):
                return "PatientFinalDiagnosisAdd";
            case Config("API_EDIT_ACTION"):
                return "PatientFinalDiagnosisEdit";
            case Config("API_DELETE_ACTION"):
                return "PatientFinalDiagnosisDelete";
            case Config("API_LIST_ACTION"):
                return "PatientFinalDiagnosisList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PatientFinalDiagnosisView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PatientFinalDiagnosisView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PatientFinalDiagnosisAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PatientFinalDiagnosisAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientFinalDiagnosisEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PatientFinalDiagnosisAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PatientFinalDiagnosisDelete", $this->getUrlParm());
    }
