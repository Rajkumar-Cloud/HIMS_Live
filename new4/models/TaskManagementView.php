 ...
 * Page class
 */
class TaskManagementView extends TaskManagement
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TaskManagementView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TaskManagementList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TaskManagementList"; // No matching record, return to list
                    }
                    break;
            }
            ...
            $returnUrl = "TaskManagementList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
