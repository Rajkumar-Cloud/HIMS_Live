...
/**
 * Table class for view_pharmacy_purchaseorder
 */
class ViewPharmacyPurchaseorder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'view_pharmacy_purchaseorder';
        $this->TableName = 'view_pharmacy_purchaseorder';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "`view_pharmacy_purchaseorder`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // HospID
        $this->HospID = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRC
        $this->PRC = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PSGST
        $this->PSGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PSGST', 'PSGST', '`PSGST`', '`PSGST`', 131, 12, -1, false, '`PSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PCGST
        $this->PCGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PCGST', 'PCGST', '`PCGST`', '`PCGST`', 131, 12, -1, false, '`PCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SSGST
        $this->SSGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_SSGST', 'SSGST', '`SSGST`', '`SSGST`', 131, 12, -1, false, '`SSGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCGST
        $this->SCGST = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_SCGST', 'SCGST', '`SCGST`', '`SCGST`', 131, 12, -1, false, '`SCGST`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HSN
        $this->HSN = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_HSN', 'HSN', '`HSN`', '`HSN`', 200, 45, -1, false, '`HSN`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BatchNo
        $this->BatchNo = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_BatchNo', 'BatchNo', '`BatchNo`', '`BatchNo`', 200, 45, -1, false, '`BatchNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SalRate
        $this->SalRate = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_SalRate', 'SalRate', '`SalRate`', '`SalRate`', 131, 12, -1, false, '`SalRate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PurValue
        $this->PurValue = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PurValue', 'PurValue', '`PurValue`', '`PurValue`', 131, 12, -1, false, '`PurValue`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PUnit
        $this->PUnit = new DbField('view_pharmacy_purchaseorder', 'view_pharmacy_purchaseorder', 'x_PUnit', 'PUnit', '`PUnit`', '`PUnit`', 3, 11, -1, false, '`PUnit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_pharmacy_purchaseorder`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPharmacyPurchaseorderList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPharmacyPurchaseorderView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPharmacyPurchaseorderEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPharmacyPurchaseorderAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ViewPharmacyPurchaseorderView";
            case Config("API_ADD_ACTION"):
                return "ViewPharmacyPurchaseorderAdd";
            case Config("API_EDIT_ACTION"):
                return "ViewPharmacyPurchaseorderEdit";
            case Config("API_DELETE_ACTION"):
                return "ViewPharmacyPurchaseorderDelete";
            case Config("API_LIST_ACTION"):
                return "ViewPharmacyPurchaseorderList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPharmacyPurchaseorderView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPharmacyPurchaseorderView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPharmacyPurchaseorderAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPharmacyPurchaseorderAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyPurchaseorderEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPharmacyPurchaseorderAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPharmacyPurchaseorderDelete", $this->getUrlParm());
    }
