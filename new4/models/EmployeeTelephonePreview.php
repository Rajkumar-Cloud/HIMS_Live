 ...
 * Page class
 */
class EmployeeTelephonePreview extends EmployeeTelephone
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeTelephonePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "employee") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=employee&" . GetForeignKeyUrl("fk_id", $this->employee_id->QueryStringValue) . "";
        }
        return $url;
    }
