 ...
 * Page class
 */
class ViewDashboardPatientDetailsGrid extends ViewDashboardPatientDetails
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewDashboardPatientDetailsGrid";
    ...
    public function resetFormError()
    {
        ...
        $this->mobile_no->clearErrorMessage();
        $this->ReferA4TreatingConsultant->clearErrorMessage();
        $this->Patient_Language->clearErrorMessage();
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->WhereDidYouHear->getSessionValue() != "") {
                $this->WhereDidYouHear->CurrentValue = GetForeignKeyValue($this->WhereDidYouHear->getSessionValue());
                $this->WhereDidYouHear->OldValue = $this->WhereDidYouHear->CurrentValue;
                $this->WhereDidYouHear->ViewValue = $this->WhereDidYouHear->CurrentValue;
                $this->WhereDidYouHear->ViewCustomAttributes = "";
            } else {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // WhereDidYouHear
            if ($this->WhereDidYouHear->getSessionValue() != "") {
                $this->WhereDidYouHear->ReadOnly = true;
            }
