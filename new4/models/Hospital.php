...
class Hospital extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('hospital', 'hospital', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        $this->BillingGST->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BillingGST->Param, "CustomMsg");
        ...
        // Country
        $this->Country = new DbField('hospital', 'hospital', 'x_Country', 'Country', '`Country`', '`Country`', 200, 45, -1, false, '`Country`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HospitalList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "HospitalEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "HospitalAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HospitalView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("HospitalView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "HospitalAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "HospitalAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("HospitalEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HospitalAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("HospitalDelete", $this->getUrlParm());
    }
