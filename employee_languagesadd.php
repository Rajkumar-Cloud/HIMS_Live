...
// Create page object
$employee_languages_add = new employee_languages_add();

// Run the page
$employee_languages_add->run();
...
$employee_languages_add->Page_Render();
?>
...
var femployee_languagesadd = currentForm = new ew.Form("femployee_languagesadd", "add");
...
femployee_languagesadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_languages_add->language_id->Required) { ?>
		...
		<?php if ($employee_languages_add->employee->Required) { ?>
		...
		<?php if ($employee_languages_add->reading->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_languages_add->speaking->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_languages_add->writing->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_languages_add->understanding->Required) { ?>
...
femployee_languagesadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_languagesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_languagesadd.lists["x_reading"] = <?php echo $employee_languages_add->reading->Lookup->toClientList() ?>;
femployee_languagesadd.lists["x_reading"].options = <?php echo JsonEncode($employee_languages_add->reading->options(FALSE, TRUE)) ?>;
femployee_languagesadd.lists["x_speaking"] = <?php echo $employee_languages_add->speaking->Lookup->toClientList() ?>;
femployee_languagesadd.lists["x_speaking"].options = <?php echo JsonEncode($employee_languages_add->speaking->options(FALSE, TRUE)) ?>;
femployee_languagesadd.lists["x_writing"] = <?php echo $employee_languages_add->writing->Lookup->toClientList() ?>;
femployee_languagesadd.lists["x_writing"].options = <?php echo JsonEncode($employee_languages_add->writing->options(FALSE, TRUE)) ?>;
femployee_languagesadd.lists["x_understanding"] = <?php echo $employee_languages_add->understanding->Lookup->toClientList() ?>;
femployee_languagesadd.lists["x_understanding"].options = <?php echo JsonEncode($employee_languages_add->understanding->options(FALSE, TRUE)) ?>;
...
<?php $employee_languages_add->showPageHeader(); ?>
<?php
$employee_languages_add->showMessage();
?>
<form name="femployee_languagesadd" id="femployee_languagesadd" class="<?php echo $employee_languages_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_languages_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_languages_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_languages">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$employee_languages_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($employee_languages->language_id->Visible) { // language_id ?>
	<div id="r_language_id" class="form-group row">
		<label id="elh_employee_languages_language_id" for="x_language_id" class="<?php echo $employee_languages_add->LeftColumnClass ?>"><?php echo $employee_languages->language_id->caption() ?><?php echo ($employee_languages->language_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_languages_add->RightColumnClass ?>"><div<?php echo $employee_languages->language_id->cellAttributes() ?>>
...
<?php if ($employee_languages->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employee_languages_employee" for="x_employee" class="<?php echo $employee_languages_add->LeftColumnClass ?>"><?php echo $employee_languages->employee->caption() ?><?php echo ($employee_languages->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_languages_add->RightColumnClass ?>"><div<?php echo $employee_languages->employee->cellAttributes() ?>>
...
<?php if ($employee_languages->reading->Visible) { // reading ?>
	<div id="r_reading" class="form-group row">
		<label id="elh_employee_languages_reading" class="<?php echo $employee_languages_add->LeftColumnClass ?>"><?php echo $employee_languages->reading->caption() ?><?php echo ($employee_languages->reading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_languages_add->RightColumnClass ?>"><div<?php echo $employee_languages->reading->cellAttributes() ?>>
...
<?php if ($employee_languages->speaking->Visible) { // speaking ?>
	<div id="r_speaking" class="form-group row">
		<label id="elh_employee_languages_speaking" class="<?php echo $employee_languages_add->LeftColumnClass ?>"><?php echo $employee_languages->speaking->caption() ?><?php echo ($employee_languages->speaking->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_languages_add->RightColumnClass ?>"><div<?php echo $employee_languages->speaking->cellAttributes() ?>>
...
<?php if ($employee_languages->writing->Visible) { // writing ?>
	<div id="r_writing" class="form-group row">
		<label id="elh_employee_languages_writing" class="<?php echo $employee_languages_add->LeftColumnClass ?>"><?php echo $employee_languages->writing->caption() ?><?php echo ($employee_languages->writing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_languages_add->RightColumnClass ?>"><div<?php echo $employee_languages->writing->cellAttributes() ?>>
...
<?php if ($employee_languages->understanding->Visible) { // understanding ?>
	<div id="r_understanding" class="form-group row">
		<label id="elh_employee_languages_understanding" class="<?php echo $employee_languages_add->LeftColumnClass ?>"><?php echo $employee_languages->understanding->caption() ?><?php echo ($employee_languages->understanding->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_languages_add->RightColumnClass ?>"><div<?php echo $employee_languages->understanding->cellAttributes() ?>>
...
<?php if (!$employee_languages_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_languages_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_languages_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_languages_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_languages_add->terminate();
?>