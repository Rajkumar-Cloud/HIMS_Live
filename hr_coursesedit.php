...
// Create page object
$hr_courses_edit = new hr_courses_edit();
...
var fhr_coursesedit = currentForm = new ew.Form("fhr_coursesedit", "edit");
...
fhr_coursesedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($hr_courses_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $hr_courses->id->caption(), $hr_courses->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($hr_courses_edit->code->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->name->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->coordinator->Required) { ?>
		...
		<?php if ($hr_courses_edit->trainer->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->trainer_info->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->paymentType->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->currency->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->cost->Required) { ?>
		...
		<?php if ($hr_courses_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_courses_edit->created->Required) { ?>
		...
		<?php if ($hr_courses_edit->updated->Required) { ?>
...
fhr_coursesedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fhr_coursesedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhr_coursesedit.lists["x_paymentType"] = <?php echo $hr_courses_edit->paymentType->Lookup->toClientList() ?>;
fhr_coursesedit.lists["x_paymentType"].options = <?php echo JsonEncode($hr_courses_edit->paymentType->options(FALSE, TRUE)) ?>;
fhr_coursesedit.lists["x_status"] = <?php echo $hr_courses_edit->status->Lookup->toClientList() ?>;
fhr_coursesedit.lists["x_status"].options = <?php echo JsonEncode($hr_courses_edit->status->options(FALSE, TRUE)) ?>;
...
<?php $hr_courses_edit->showPageHeader(); ?>
<?php
$hr_courses_edit->showMessage();
?>
<form name="fhr_coursesedit" id="fhr_coursesedit" class="<?php echo $hr_courses_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($hr_courses_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $hr_courses_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="hr_courses">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$hr_courses_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($hr_courses->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_hr_courses_id" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->id->caption() ?><?php echo ($hr_courses->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->id->cellAttributes() ?>>
<span id="el_hr_courses_id">
<span<?php echo $hr_courses->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($hr_courses->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="hr_courses" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($hr_courses->id->CurrentValue) ?>">
<?php echo $hr_courses->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($hr_courses->code->Visible) { // code ?>
	<div id="r_code" class="form-group row">
		<label id="elh_hr_courses_code" for="x_code" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->code->caption() ?><?php echo ($hr_courses->code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->code->cellAttributes() ?>>
...
<?php if ($hr_courses->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_hr_courses_name" for="x_name" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->name->caption() ?><?php echo ($hr_courses->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->name->cellAttributes() ?>>
...
<?php if ($hr_courses->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_hr_courses_description" for="x_description" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->description->caption() ?><?php echo ($hr_courses->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->description->cellAttributes() ?>>
...
<?php if ($hr_courses->coordinator->Visible) { // coordinator ?>
	<div id="r_coordinator" class="form-group row">
		<label id="elh_hr_courses_coordinator" for="x_coordinator" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->coordinator->caption() ?><?php echo ($hr_courses->coordinator->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->coordinator->cellAttributes() ?>>
...
<?php if ($hr_courses->trainer->Visible) { // trainer ?>
	<div id="r_trainer" class="form-group row">
		<label id="elh_hr_courses_trainer" for="x_trainer" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->trainer->caption() ?><?php echo ($hr_courses->trainer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->trainer->cellAttributes() ?>>
...
<?php if ($hr_courses->trainer_info->Visible) { // trainer_info ?>
	<div id="r_trainer_info" class="form-group row">
		<label id="elh_hr_courses_trainer_info" for="x_trainer_info" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->trainer_info->caption() ?><?php echo ($hr_courses->trainer_info->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->trainer_info->cellAttributes() ?>>
...
<?php if ($hr_courses->paymentType->Visible) { // paymentType ?>
	<div id="r_paymentType" class="form-group row">
		<label id="elh_hr_courses_paymentType" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->paymentType->caption() ?><?php echo ($hr_courses->paymentType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->paymentType->cellAttributes() ?>>
...
<?php if ($hr_courses->currency->Visible) { // currency ?>
	<div id="r_currency" class="form-group row">
		<label id="elh_hr_courses_currency" for="x_currency" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->currency->caption() ?><?php echo ($hr_courses->currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->currency->cellAttributes() ?>>
...
<?php if ($hr_courses->cost->Visible) { // cost ?>
	<div id="r_cost" class="form-group row">
		<label id="elh_hr_courses_cost" for="x_cost" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->cost->caption() ?><?php echo ($hr_courses->cost->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->cost->cellAttributes() ?>>
...
<?php if ($hr_courses->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_hr_courses_status" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->status->caption() ?><?php echo ($hr_courses->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->status->cellAttributes() ?>>
...
<?php if ($hr_courses->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_hr_courses_created" for="x_created" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->created->caption() ?><?php echo ($hr_courses->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->created->cellAttributes() ?>>
...
<?php if ($hr_courses->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_hr_courses_updated" for="x_updated" class="<?php echo $hr_courses_edit->LeftColumnClass ?>"><?php echo $hr_courses->updated->caption() ?><?php echo ($hr_courses->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_courses_edit->RightColumnClass ?>"><div<?php echo $hr_courses->updated->cellAttributes() ?>>
...
<?php if (!$hr_courses_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $hr_courses_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $hr_courses_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$hr_courses_edit->showPageFooter();
if (DEBUG_ENABLED)
