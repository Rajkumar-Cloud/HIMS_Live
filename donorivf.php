...
<div class="col-md-12">
			...
			<div class="card card-widget widget-user">
			  ...
			  <div class="widget-user-header bg-warning">
			  	<h4 class="widget-user-username"><span class="ew-cell">Donor Id : <?php echo $results2[0]["PatientID"]; ?></span></h4>
				<h4 class="widget-user-username"><span class="ew-cell">Donor Name : <?php echo $results2[0]["first_name"]; ?></span></h4>
...
<?php
	...
	$ivfTreatmentwarnUrl ="ivf_treatment_planlist.php?showdetail=&showmaster=view_donor_ivf&fk_id=".$IVFid."&fk_Female=".$results2[0]["id"]."";
		...
		<div class="card">
			  ...
			  <div class="card-body">
				...
				<a class="btn btn-app"  href="<?php echo $followupurl; ?>">
				  <i class="fas fa-map-marker"></i>Follow Up Notes
				</a>
