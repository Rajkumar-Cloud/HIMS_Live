...
var fivf_oocytedenudation_stageedit = currentForm = new ew.Form("fivf_oocytedenudation_stageedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($ivf_oocytedenudation_stage_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_oocytedenudation_stage->id->caption(), $ivf_oocytedenudation_stage->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php if ($ivf_oocytedenudation_stage_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_oocytedenudation_stage->modifiedby->caption(), $ivf_oocytedenudation_stage->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($ivf_oocytedenudation_stage_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_oocytedenudation_stage->modifieddatetime->caption(), $ivf_oocytedenudation_stage->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fivf_oocytedenudation_stageedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_oocytedenudation_stageedit.lists["x_Stage"] = <?php echo $ivf_oocytedenudation_stage_edit->Stage->Lookup->toClientList() ?>;
...
<?php if ($ivf_oocytedenudation_stage_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_oocytedenudation_stage_edit->Token ?>">
<?php } ?>
...
<?php if ($ivf_oocytedenudation_stage->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_id" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->id->caption() ?><?php echo ($ivf_oocytedenudation_stage->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->id->cellAttributes() ?>>
<span id="el_ivf_oocytedenudation_stage_id">
<span<?php echo $ivf_oocytedenudation_stage->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($ivf_oocytedenudation_stage->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="ivf_oocytedenudation_stage" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($ivf_oocytedenudation_stage->id->CurrentValue) ?>">
<?php echo $ivf_oocytedenudation_stage->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ivf_oocytedenudation_stage->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_RIDNo" for="x_RIDNo" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->RIDNo->caption() ?><?php echo ($ivf_oocytedenudation_stage->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->RIDNo->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_Name" for="x_Name" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->Name->caption() ?><?php echo ($ivf_oocytedenudation_stage->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->Name->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_TidNo" for="x_TidNo" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->TidNo->caption() ?><?php echo ($ivf_oocytedenudation_stage->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->TidNo->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->OidNo->Visible) { // OidNo ?>
	<div id="r_OidNo" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_OidNo" for="x_OidNo" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->OidNo->caption() ?><?php echo ($ivf_oocytedenudation_stage->OidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->OidNo->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->OocyteNo->Visible) { // OocyteNo ?>
	<div id="r_OocyteNo" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_OocyteNo" for="x_OocyteNo" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->OocyteNo->caption() ?><?php echo ($ivf_oocytedenudation_stage->OocyteNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->OocyteNo->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->Stage->Visible) { // Stage ?>
	<div id="r_Stage" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_Stage" for="x_Stage" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->Stage->caption() ?><?php echo ($ivf_oocytedenudation_stage->Stage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->Stage->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->ReMarks->Visible) { // ReMarks ?>
	<div id="r_ReMarks" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_ReMarks" for="x_ReMarks" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->ReMarks->caption() ?><?php echo ($ivf_oocytedenudation_stage->ReMarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->ReMarks->cellAttributes() ?>>
...
<?php if ($ivf_oocytedenudation_stage->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_ivf_oocytedenudation_stage_status" for="x_status" class="<?php echo $ivf_oocytedenudation_stage_edit->LeftColumnClass ?>"><?php echo $ivf_oocytedenudation_stage->status->caption() ?><?php echo ($ivf_oocytedenudation_stage->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_oocytedenudation_stage_edit->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation_stage->status->cellAttributes() ?>>
