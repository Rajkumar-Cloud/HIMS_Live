...
var fvitalsadd = currentForm = new ew.Form("fvitalsadd", "add");

// Validate form
fvitalsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($vitals_add->Reception->Required) { ?>
		...
		<?php if ($vitals_add->PatientId->Required) { ?>
		...
		<?php } ?>
		<?php if ($vitals_add->PatientName->Required) { ?>
		...
		<?php } ?>
		<?php if ($vitals_add->PULSE->Required) { ?>
...
fvitalsadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fvitalsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $vitals_add->showPageHeader(); ?>
<?php
$vitals_add->showMessage();
?>
<form name="fvitalsadd" id="fvitalsadd" class="<?php echo $vitals_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($vitals_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $vitals_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vitals">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$vitals_add->IsModal ?>">
...
<?php if ($vitals->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_vitals_Reception" for="x_Reception" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->Reception->caption() ?><?php echo ($vitals->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->Reception->cellAttributes() ?>>
...
<?php if ($vitals->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_vitals_PatientId" for="x_PatientId" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->PatientId->caption() ?><?php echo ($vitals->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->PatientId->cellAttributes() ?>>
...
<?php if ($vitals->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_vitals_PatientName" for="x_PatientName" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->PatientName->caption() ?><?php echo ($vitals->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->PatientName->cellAttributes() ?>>
...
<?php if ($vitals->HT->Visible) { // HT ?>
	<div id="r_HT" class="form-group row">
		<label id="elh_vitals_HT" for="x_HT" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->HT->caption() ?><?php echo ($vitals->HT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->HT->cellAttributes() ?>>
...
<?php if ($vitals->WT->Visible) { // WT ?>
	<div id="r_WT" class="form-group row">
		<label id="elh_vitals_WT" for="x_WT" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->WT->caption() ?><?php echo ($vitals->WT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->WT->cellAttributes() ?>>
...
<?php if ($vitals->BP->Visible) { // BP ?>
	<div id="r_BP" class="form-group row">
		<label id="elh_vitals_BP" for="x_BP" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->BP->caption() ?><?php echo ($vitals->BP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->BP->cellAttributes() ?>>
...
<?php if ($vitals->PULSE->Visible) { // PULSE ?>
	<div id="r_PULSE" class="form-group row">
		<label id="elh_vitals_PULSE" for="x_PULSE" class="<?php echo $vitals_add->LeftColumnClass ?>"><?php echo $vitals->PULSE->caption() ?><?php echo ($vitals->PULSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $vitals_add->RightColumnClass ?>"><div<?php echo $vitals->PULSE->cellAttributes() ?>>
...
<?php if (!$vitals_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $vitals_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $vitals_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$vitals_add->showPageFooter();
if (DEBUG_ENABLED)
