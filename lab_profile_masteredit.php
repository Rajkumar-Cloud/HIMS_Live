...
var flab_profile_masteredit = currentForm = new ew.Form("flab_profile_masteredit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($lab_profile_master_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $lab_profile_master->id->caption(), $lab_profile_master->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
flab_profile_masteredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($lab_profile_master_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $lab_profile_master_edit->Token ?>">
<?php } ?>
...
<?php if ($lab_profile_master->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_lab_profile_master_id" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->id->caption() ?><?php echo ($lab_profile_master->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->id->cellAttributes() ?>>
<span id="el_lab_profile_master_id">
<span<?php echo $lab_profile_master->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($lab_profile_master->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="lab_profile_master" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($lab_profile_master->id->CurrentValue) ?>">
<?php echo $lab_profile_master->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($lab_profile_master->ProfileCode->Visible) { // ProfileCode ?>
	<div id="r_ProfileCode" class="form-group row">
		<label id="elh_lab_profile_master_ProfileCode" for="x_ProfileCode" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ProfileCode->caption() ?><?php echo ($lab_profile_master->ProfileCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ProfileCode->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ProfileName->Visible) { // ProfileName ?>
	<div id="r_ProfileName" class="form-group row">
		<label id="elh_lab_profile_master_ProfileName" for="x_ProfileName" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ProfileName->caption() ?><?php echo ($lab_profile_master->ProfileName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ProfileName->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ProfileAmount->Visible) { // ProfileAmount ?>
	<div id="r_ProfileAmount" class="form-group row">
		<label id="elh_lab_profile_master_ProfileAmount" for="x_ProfileAmount" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ProfileAmount->caption() ?><?php echo ($lab_profile_master->ProfileAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ProfileAmount->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ProfileSpecialAmount->Visible) { // ProfileSpecialAmount ?>
	<div id="r_ProfileSpecialAmount" class="form-group row">
		<label id="elh_lab_profile_master_ProfileSpecialAmount" for="x_ProfileSpecialAmount" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ProfileSpecialAmount->caption() ?><?php echo ($lab_profile_master->ProfileSpecialAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ProfileSpecialAmount->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ProfileMasterInactive->Visible) { // ProfileMasterInactive ?>
	<div id="r_ProfileMasterInactive" class="form-group row">
		<label id="elh_lab_profile_master_ProfileMasterInactive" for="x_ProfileMasterInactive" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ProfileMasterInactive->caption() ?><?php echo ($lab_profile_master->ProfileMasterInactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ProfileMasterInactive->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ReagentAmt->Visible) { // ReagentAmt ?>
	<div id="r_ReagentAmt" class="form-group row">
		<label id="elh_lab_profile_master_ReagentAmt" for="x_ReagentAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ReagentAmt->caption() ?><?php echo ($lab_profile_master->ReagentAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ReagentAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->LabAmt->Visible) { // LabAmt ?>
	<div id="r_LabAmt" class="form-group row">
		<label id="elh_lab_profile_master_LabAmt" for="x_LabAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->LabAmt->caption() ?><?php echo ($lab_profile_master->LabAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->LabAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->RefAmt->Visible) { // RefAmt ?>
	<div id="r_RefAmt" class="form-group row">
		<label id="elh_lab_profile_master_RefAmt" for="x_RefAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->RefAmt->caption() ?><?php echo ($lab_profile_master->RefAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->RefAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->MainDeptCD->Visible) { // MainDeptCD ?>
	<div id="r_MainDeptCD" class="form-group row">
		<label id="elh_lab_profile_master_MainDeptCD" for="x_MainDeptCD" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->MainDeptCD->caption() ?><?php echo ($lab_profile_master->MainDeptCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->MainDeptCD->cellAttributes() ?>>
...
<?php if ($lab_profile_master->Individual->Visible) { // Individual ?>
	<div id="r_Individual" class="form-group row">
		<label id="elh_lab_profile_master_Individual" for="x_Individual" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->Individual->caption() ?><?php echo ($lab_profile_master->Individual->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->Individual->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ShortName->Visible) { // ShortName ?>
	<div id="r_ShortName" class="form-group row">
		<label id="elh_lab_profile_master_ShortName" for="x_ShortName" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ShortName->caption() ?><?php echo ($lab_profile_master->ShortName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ShortName->cellAttributes() ?>>
...
<?php if ($lab_profile_master->Note->Visible) { // Note ?>
	<div id="r_Note" class="form-group row">
		<label id="elh_lab_profile_master_Note" for="x_Note" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->Note->caption() ?><?php echo ($lab_profile_master->Note->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->Note->cellAttributes() ?>>
...
<?php if ($lab_profile_master->PrevAmt->Visible) { // PrevAmt ?>
	<div id="r_PrevAmt" class="form-group row">
		<label id="elh_lab_profile_master_PrevAmt" for="x_PrevAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->PrevAmt->caption() ?><?php echo ($lab_profile_master->PrevAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->PrevAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->BillName->Visible) { // BillName ?>
	<div id="r_BillName" class="form-group row">
		<label id="elh_lab_profile_master_BillName" for="x_BillName" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->BillName->caption() ?><?php echo ($lab_profile_master->BillName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->BillName->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ActualAmt->Visible) { // ActualAmt ?>
	<div id="r_ActualAmt" class="form-group row">
		<label id="elh_lab_profile_master_ActualAmt" for="x_ActualAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ActualAmt->caption() ?><?php echo ($lab_profile_master->ActualAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ActualAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->NoHeading->Visible) { // NoHeading ?>
	<div id="r_NoHeading" class="form-group row">
		<label id="elh_lab_profile_master_NoHeading" for="x_NoHeading" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->NoHeading->caption() ?><?php echo ($lab_profile_master->NoHeading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->NoHeading->cellAttributes() ?>>
...
<?php if ($lab_profile_master->EditDate->Visible) { // EditDate ?>
	<div id="r_EditDate" class="form-group row">
		<label id="elh_lab_profile_master_EditDate" for="x_EditDate" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->EditDate->caption() ?><?php echo ($lab_profile_master->EditDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->EditDate->cellAttributes() ?>>
...
<?php if ($lab_profile_master->EditUser->Visible) { // EditUser ?>
	<div id="r_EditUser" class="form-group row">
		<label id="elh_lab_profile_master_EditUser" for="x_EditUser" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->EditUser->caption() ?><?php echo ($lab_profile_master->EditUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->EditUser->cellAttributes() ?>>
...
<?php if ($lab_profile_master->HISCD->Visible) { // HISCD ?>
	<div id="r_HISCD" class="form-group row">
		<label id="elh_lab_profile_master_HISCD" for="x_HISCD" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->HISCD->caption() ?><?php echo ($lab_profile_master->HISCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->HISCD->cellAttributes() ?>>
...
<?php if ($lab_profile_master->PriceList->Visible) { // PriceList ?>
	<div id="r_PriceList" class="form-group row">
		<label id="elh_lab_profile_master_PriceList" for="x_PriceList" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->PriceList->caption() ?><?php echo ($lab_profile_master->PriceList->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->PriceList->cellAttributes() ?>>
...
<?php if ($lab_profile_master->IPAmt->Visible) { // IPAmt ?>
	<div id="r_IPAmt" class="form-group row">
		<label id="elh_lab_profile_master_IPAmt" for="x_IPAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->IPAmt->caption() ?><?php echo ($lab_profile_master->IPAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->IPAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->IInsAmt->Visible) { // IInsAmt ?>
	<div id="r_IInsAmt" class="form-group row">
		<label id="elh_lab_profile_master_IInsAmt" for="x_IInsAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->IInsAmt->caption() ?><?php echo ($lab_profile_master->IInsAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->IInsAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->ManualCD->Visible) { // ManualCD ?>
	<div id="r_ManualCD" class="form-group row">
		<label id="elh_lab_profile_master_ManualCD" for="x_ManualCD" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->ManualCD->caption() ?><?php echo ($lab_profile_master->ManualCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->ManualCD->cellAttributes() ?>>
...
<?php if ($lab_profile_master->Free->Visible) { // Free ?>
	<div id="r_Free" class="form-group row">
		<label id="elh_lab_profile_master_Free" for="x_Free" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->Free->caption() ?><?php echo ($lab_profile_master->Free->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->Free->cellAttributes() ?>>
...
<?php if ($lab_profile_master->IIpAmt->Visible) { // IIpAmt ?>
	<div id="r_IIpAmt" class="form-group row">
		<label id="elh_lab_profile_master_IIpAmt" for="x_IIpAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->IIpAmt->caption() ?><?php echo ($lab_profile_master->IIpAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->IIpAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->InsAmt->Visible) { // InsAmt ?>
	<div id="r_InsAmt" class="form-group row">
		<label id="elh_lab_profile_master_InsAmt" for="x_InsAmt" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->InsAmt->caption() ?><?php echo ($lab_profile_master->InsAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->InsAmt->cellAttributes() ?>>
...
<?php if ($lab_profile_master->OutSource->Visible) { // OutSource ?>
	<div id="r_OutSource" class="form-group row">
		<label id="elh_lab_profile_master_OutSource" for="x_OutSource" class="<?php echo $lab_profile_master_edit->LeftColumnClass ?>"><?php echo $lab_profile_master->OutSource->caption() ?><?php echo ($lab_profile_master->OutSource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_master_edit->RightColumnClass ?>"><div<?php echo $lab_profile_master->OutSource->cellAttributes() ?>>
