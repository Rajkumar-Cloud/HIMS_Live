...
var fstore_suppliersedit = currentForm = new ew.Form("fstore_suppliersedit", "edit");
...
fstore_suppliersedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($store_suppliers_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $store_suppliers->id->caption(), $store_suppliers->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($store_suppliers_edit->HospID->Required) { ?>
		...
		<?php if ($store_suppliers_edit->BranchID->Required) { ?>
		...
		<?php if ($store_suppliers_edit->StoreID->Required) { ?>
...
fstore_suppliersedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($store_suppliers_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_suppliers_edit->Token ?>">
<?php } ?>
...
<?php if ($store_suppliers->Suppliercode->Visible) { // Suppliercode ?>
	<div id="r_Suppliercode" class="form-group row">
		<label id="elh_store_suppliers_Suppliercode" for="x_Suppliercode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Suppliercode->caption() ?><?php echo ($store_suppliers->Suppliercode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Suppliercode->cellAttributes() ?>>
...
<?php if ($store_suppliers->Suppliername->Visible) { // Suppliername ?>
	<div id="r_Suppliername" class="form-group row">
		<label id="elh_store_suppliers_Suppliername" for="x_Suppliername" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Suppliername->caption() ?><?php echo ($store_suppliers->Suppliername->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Suppliername->cellAttributes() ?>>
...
<?php if ($store_suppliers->Abbreviation->Visible) { // Abbreviation ?>
	<div id="r_Abbreviation" class="form-group row">
		<label id="elh_store_suppliers_Abbreviation" for="x_Abbreviation" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Abbreviation->caption() ?><?php echo ($store_suppliers->Abbreviation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Abbreviation->cellAttributes() ?>>
...
<?php if ($store_suppliers->Creationdate->Visible) { // Creationdate ?>
	<div id="r_Creationdate" class="form-group row">
		<label id="elh_store_suppliers_Creationdate" for="x_Creationdate" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Creationdate->caption() ?><?php echo ($store_suppliers->Creationdate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Creationdate->cellAttributes() ?>>
...
<?php if ($store_suppliers->Address1->Visible) { // Address1 ?>
	<div id="r_Address1" class="form-group row">
		<label id="elh_store_suppliers_Address1" for="x_Address1" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Address1->caption() ?><?php echo ($store_suppliers->Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Address1->cellAttributes() ?>>
...
<?php if ($store_suppliers->Address2->Visible) { // Address2 ?>
	<div id="r_Address2" class="form-group row">
		<label id="elh_store_suppliers_Address2" for="x_Address2" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Address2->caption() ?><?php echo ($store_suppliers->Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Address2->cellAttributes() ?>>
...
<?php if ($store_suppliers->Address3->Visible) { // Address3 ?>
	<div id="r_Address3" class="form-group row">
		<label id="elh_store_suppliers_Address3" for="x_Address3" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Address3->caption() ?><?php echo ($store_suppliers->Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Address3->cellAttributes() ?>>
...
<?php if ($store_suppliers->Citycode->Visible) { // Citycode ?>
	<div id="r_Citycode" class="form-group row">
		<label id="elh_store_suppliers_Citycode" for="x_Citycode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Citycode->caption() ?><?php echo ($store_suppliers->Citycode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Citycode->cellAttributes() ?>>
...
<?php if ($store_suppliers->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_store_suppliers_State" for="x_State" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->State->caption() ?><?php echo ($store_suppliers->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->State->cellAttributes() ?>>
...
<?php if ($store_suppliers->Pincode->Visible) { // Pincode ?>
	<div id="r_Pincode" class="form-group row">
		<label id="elh_store_suppliers_Pincode" for="x_Pincode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Pincode->caption() ?><?php echo ($store_suppliers->Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Pincode->cellAttributes() ?>>
...
<?php if ($store_suppliers->Tngstnumber->Visible) { // Tngstnumber ?>
	<div id="r_Tngstnumber" class="form-group row">
		<label id="elh_store_suppliers_Tngstnumber" for="x_Tngstnumber" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Tngstnumber->caption() ?><?php echo ($store_suppliers->Tngstnumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Tngstnumber->cellAttributes() ?>>
...
<?php if ($store_suppliers->Phone->Visible) { // Phone ?>
	<div id="r_Phone" class="form-group row">
		<label id="elh_store_suppliers_Phone" for="x_Phone" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Phone->caption() ?><?php echo ($store_suppliers->Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Phone->cellAttributes() ?>>
...
<?php if ($store_suppliers->Fax->Visible) { // Fax ?>
	<div id="r_Fax" class="form-group row">
		<label id="elh_store_suppliers_Fax" for="x_Fax" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Fax->caption() ?><?php echo ($store_suppliers->Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Fax->cellAttributes() ?>>
...
<?php if ($store_suppliers->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group row">
		<label id="elh_store_suppliers__Email" for="x__Email" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->_Email->caption() ?><?php echo ($store_suppliers->_Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->_Email->cellAttributes() ?>>
...
<?php if ($store_suppliers->Paymentmode->Visible) { // Paymentmode ?>
	<div id="r_Paymentmode" class="form-group row">
		<label id="elh_store_suppliers_Paymentmode" for="x_Paymentmode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Paymentmode->caption() ?><?php echo ($store_suppliers->Paymentmode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Paymentmode->cellAttributes() ?>>
...
<?php if ($store_suppliers->Contactperson1->Visible) { // Contactperson1 ?>
	<div id="r_Contactperson1" class="form-group row">
		<label id="elh_store_suppliers_Contactperson1" for="x_Contactperson1" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Contactperson1->caption() ?><?php echo ($store_suppliers->Contactperson1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Contactperson1->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Address1->Visible) { // CP1Address1 ?>
	<div id="r_CP1Address1" class="form-group row">
		<label id="elh_store_suppliers_CP1Address1" for="x_CP1Address1" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Address1->caption() ?><?php echo ($store_suppliers->CP1Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Address1->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Address2->Visible) { // CP1Address2 ?>
	<div id="r_CP1Address2" class="form-group row">
		<label id="elh_store_suppliers_CP1Address2" for="x_CP1Address2" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Address2->caption() ?><?php echo ($store_suppliers->CP1Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Address2->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Address3->Visible) { // CP1Address3 ?>
	<div id="r_CP1Address3" class="form-group row">
		<label id="elh_store_suppliers_CP1Address3" for="x_CP1Address3" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Address3->caption() ?><?php echo ($store_suppliers->CP1Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Address3->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Citycode->Visible) { // CP1Citycode ?>
	<div id="r_CP1Citycode" class="form-group row">
		<label id="elh_store_suppliers_CP1Citycode" for="x_CP1Citycode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Citycode->caption() ?><?php echo ($store_suppliers->CP1Citycode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Citycode->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1State->Visible) { // CP1State ?>
	<div id="r_CP1State" class="form-group row">
		<label id="elh_store_suppliers_CP1State" for="x_CP1State" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1State->caption() ?><?php echo ($store_suppliers->CP1State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1State->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Pincode->Visible) { // CP1Pincode ?>
	<div id="r_CP1Pincode" class="form-group row">
		<label id="elh_store_suppliers_CP1Pincode" for="x_CP1Pincode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Pincode->caption() ?><?php echo ($store_suppliers->CP1Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Pincode->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Designation->Visible) { // CP1Designation ?>
	<div id="r_CP1Designation" class="form-group row">
		<label id="elh_store_suppliers_CP1Designation" for="x_CP1Designation" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Designation->caption() ?><?php echo ($store_suppliers->CP1Designation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Designation->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Phone->Visible) { // CP1Phone ?>
	<div id="r_CP1Phone" class="form-group row">
		<label id="elh_store_suppliers_CP1Phone" for="x_CP1Phone" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Phone->caption() ?><?php echo ($store_suppliers->CP1Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Phone->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1MobileNo->Visible) { // CP1MobileNo ?>
	<div id="r_CP1MobileNo" class="form-group row">
		<label id="elh_store_suppliers_CP1MobileNo" for="x_CP1MobileNo" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1MobileNo->caption() ?><?php echo ($store_suppliers->CP1MobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1MobileNo->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Fax->Visible) { // CP1Fax ?>
	<div id="r_CP1Fax" class="form-group row">
		<label id="elh_store_suppliers_CP1Fax" for="x_CP1Fax" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Fax->caption() ?><?php echo ($store_suppliers->CP1Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Fax->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP1Email->Visible) { // CP1Email ?>
	<div id="r_CP1Email" class="form-group row">
		<label id="elh_store_suppliers_CP1Email" for="x_CP1Email" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP1Email->caption() ?><?php echo ($store_suppliers->CP1Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP1Email->cellAttributes() ?>>
...
<?php if ($store_suppliers->Contactperson2->Visible) { // Contactperson2 ?>
	<div id="r_Contactperson2" class="form-group row">
		<label id="elh_store_suppliers_Contactperson2" for="x_Contactperson2" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Contactperson2->caption() ?><?php echo ($store_suppliers->Contactperson2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Contactperson2->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Address1->Visible) { // CP2Address1 ?>
	<div id="r_CP2Address1" class="form-group row">
		<label id="elh_store_suppliers_CP2Address1" for="x_CP2Address1" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Address1->caption() ?><?php echo ($store_suppliers->CP2Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Address1->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Address2->Visible) { // CP2Address2 ?>
	<div id="r_CP2Address2" class="form-group row">
		<label id="elh_store_suppliers_CP2Address2" for="x_CP2Address2" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Address2->caption() ?><?php echo ($store_suppliers->CP2Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Address2->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Address3->Visible) { // CP2Address3 ?>
	<div id="r_CP2Address3" class="form-group row">
		<label id="elh_store_suppliers_CP2Address3" for="x_CP2Address3" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Address3->caption() ?><?php echo ($store_suppliers->CP2Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Address3->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Citycode->Visible) { // CP2Citycode ?>
	<div id="r_CP2Citycode" class="form-group row">
		<label id="elh_store_suppliers_CP2Citycode" for="x_CP2Citycode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Citycode->caption() ?><?php echo ($store_suppliers->CP2Citycode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Citycode->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2State->Visible) { // CP2State ?>
	<div id="r_CP2State" class="form-group row">
		<label id="elh_store_suppliers_CP2State" for="x_CP2State" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2State->caption() ?><?php echo ($store_suppliers->CP2State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2State->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Pincode->Visible) { // CP2Pincode ?>
	<div id="r_CP2Pincode" class="form-group row">
		<label id="elh_store_suppliers_CP2Pincode" for="x_CP2Pincode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Pincode->caption() ?><?php echo ($store_suppliers->CP2Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Pincode->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Designation->Visible) { // CP2Designation ?>
	<div id="r_CP2Designation" class="form-group row">
		<label id="elh_store_suppliers_CP2Designation" for="x_CP2Designation" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Designation->caption() ?><?php echo ($store_suppliers->CP2Designation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Designation->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Phone->Visible) { // CP2Phone ?>
	<div id="r_CP2Phone" class="form-group row">
		<label id="elh_store_suppliers_CP2Phone" for="x_CP2Phone" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Phone->caption() ?><?php echo ($store_suppliers->CP2Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Phone->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2MobileNo->Visible) { // CP2MobileNo ?>
	<div id="r_CP2MobileNo" class="form-group row">
		<label id="elh_store_suppliers_CP2MobileNo" for="x_CP2MobileNo" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2MobileNo->caption() ?><?php echo ($store_suppliers->CP2MobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2MobileNo->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Fax->Visible) { // CP2Fax ?>
	<div id="r_CP2Fax" class="form-group row">
		<label id="elh_store_suppliers_CP2Fax" for="x_CP2Fax" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Fax->caption() ?><?php echo ($store_suppliers->CP2Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Fax->cellAttributes() ?>>
...
<?php if ($store_suppliers->CP2Email->Visible) { // CP2Email ?>
	<div id="r_CP2Email" class="form-group row">
		<label id="elh_store_suppliers_CP2Email" for="x_CP2Email" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->CP2Email->caption() ?><?php echo ($store_suppliers->CP2Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->CP2Email->cellAttributes() ?>>
...
<?php if ($store_suppliers->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group row">
		<label id="elh_store_suppliers_Type" for="x_Type" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Type->caption() ?><?php echo ($store_suppliers->Type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Type->cellAttributes() ?>>
...
<?php if ($store_suppliers->Creditterms->Visible) { // Creditterms ?>
	<div id="r_Creditterms" class="form-group row">
		<label id="elh_store_suppliers_Creditterms" for="x_Creditterms" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Creditterms->caption() ?><?php echo ($store_suppliers->Creditterms->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Creditterms->cellAttributes() ?>>
...
<?php if ($store_suppliers->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_store_suppliers_Remarks" for="x_Remarks" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Remarks->caption() ?><?php echo ($store_suppliers->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Remarks->cellAttributes() ?>>
...
<?php if ($store_suppliers->Tinnumber->Visible) { // Tinnumber ?>
	<div id="r_Tinnumber" class="form-group row">
		<label id="elh_store_suppliers_Tinnumber" for="x_Tinnumber" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Tinnumber->caption() ?><?php echo ($store_suppliers->Tinnumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Tinnumber->cellAttributes() ?>>
...
<?php if ($store_suppliers->Universalsuppliercode->Visible) { // Universalsuppliercode ?>
	<div id="r_Universalsuppliercode" class="form-group row">
		<label id="elh_store_suppliers_Universalsuppliercode" for="x_Universalsuppliercode" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Universalsuppliercode->caption() ?><?php echo ($store_suppliers->Universalsuppliercode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Universalsuppliercode->cellAttributes() ?>>
...
<?php if ($store_suppliers->Mobilenumber->Visible) { // Mobilenumber ?>
	<div id="r_Mobilenumber" class="form-group row">
		<label id="elh_store_suppliers_Mobilenumber" for="x_Mobilenumber" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->Mobilenumber->caption() ?><?php echo ($store_suppliers->Mobilenumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->Mobilenumber->cellAttributes() ?>>
...
<?php if ($store_suppliers->PANNumber->Visible) { // PANNumber ?>
	<div id="r_PANNumber" class="form-group row">
		<label id="elh_store_suppliers_PANNumber" for="x_PANNumber" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->PANNumber->caption() ?><?php echo ($store_suppliers->PANNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->PANNumber->cellAttributes() ?>>
...
<?php if ($store_suppliers->SalesRepMobileNo->Visible) { // SalesRepMobileNo ?>
	<div id="r_SalesRepMobileNo" class="form-group row">
		<label id="elh_store_suppliers_SalesRepMobileNo" for="x_SalesRepMobileNo" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->SalesRepMobileNo->caption() ?><?php echo ($store_suppliers->SalesRepMobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->SalesRepMobileNo->cellAttributes() ?>>
...
<?php if ($store_suppliers->GSTNumber->Visible) { // GSTNumber ?>
	<div id="r_GSTNumber" class="form-group row">
		<label id="elh_store_suppliers_GSTNumber" for="x_GSTNumber" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->GSTNumber->caption() ?><?php echo ($store_suppliers->GSTNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->GSTNumber->cellAttributes() ?>>
...
<?php if ($store_suppliers->TANNumber->Visible) { // TANNumber ?>
	<div id="r_TANNumber" class="form-group row">
		<label id="elh_store_suppliers_TANNumber" for="x_TANNumber" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->TANNumber->caption() ?><?php echo ($store_suppliers->TANNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->TANNumber->cellAttributes() ?>>
...
<?php if ($store_suppliers->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_store_suppliers_id" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->id->caption() ?><?php echo ($store_suppliers->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->id->cellAttributes() ?>>
<span id="el_store_suppliers_id">
<span<?php echo $store_suppliers->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($store_suppliers->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="store_suppliers" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($store_suppliers->id->CurrentValue) ?>">
<?php echo $store_suppliers->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($store_suppliers->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_store_suppliers_HospID" for="x_HospID" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->HospID->caption() ?><?php echo ($store_suppliers->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->HospID->cellAttributes() ?>>
...
<?php if ($store_suppliers->BranchID->Visible) { // BranchID ?>
	<div id="r_BranchID" class="form-group row">
		<label id="elh_store_suppliers_BranchID" for="x_BranchID" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->BranchID->caption() ?><?php echo ($store_suppliers->BranchID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->BranchID->cellAttributes() ?>>
...
<?php if ($store_suppliers->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_suppliers_StoreID" for="x_StoreID" class="<?php echo $store_suppliers_edit->LeftColumnClass ?>"><?php echo $store_suppliers->StoreID->caption() ?><?php echo ($store_suppliers->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_suppliers_edit->RightColumnClass ?>"><div<?php echo $store_suppliers->StoreID->cellAttributes() ?>>
