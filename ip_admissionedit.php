...
var fip_admissionedit = currentForm = new ew.Form("fip_admissionedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($ip_admission_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ip_admission->id->caption(), $ip_admission->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php if ($ip_admission_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ip_admission->modifiedby->caption(), $ip_admission->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($ip_admission_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ip_admission->modifieddatetime->caption(), $ip_admission->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fip_admissionedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fip_admissionedit.lists["x_gender"] = <?php echo $ip_admission_edit->gender->Lookup->toClientList() ?>;
...
fip_admissionedit.lists["x_typeRegsisteration"] = <?php echo $ip_admission_edit->typeRegsisteration->Lookup->toClientList() ?>;
...
fip_admissionedit.lists["x_PaymentCategory"] = <?php echo $ip_admission_edit->PaymentCategory->Lookup->toClientList() ?>;
fip_admissionedit.lists["x_PaymentCategory"].options = <?php echo JsonEncode($ip_admission_edit->PaymentCategory->lookupOptions()) ?>;
fip_admissionedit.lists["x_physician_id"] = <?php echo $ip_admission_edit->physician_id->Lookup->toClientList() ?>;
fip_admissionedit.lists["x_physician_id"].options = <?php echo JsonEncode($ip_admission_edit->physician_id->lookupOptions()) ?>;
fip_admissionedit.lists["x_admission_consultant_id"] = <?php echo $ip_admission_edit->admission_consultant_id->Lookup->toClientList() ?>;
...
fip_admissionedit.lists["x_leading_consultant_id"] = <?php echo $ip_admission_edit->leading_consultant_id->Lookup->toClientList() ?>;
...
fip_admissionedit.lists["x_PaymentStatus"] = <?php echo $ip_admission_edit->PaymentStatus->Lookup->toClientList() ?>;
fip_admissionedit.lists["x_PaymentStatus"].options = <?php echo JsonEncode($ip_admission_edit->PaymentStatus->lookupOptions()) ?>;
fip_admissionedit.lists["x_status"] = <?php echo $ip_admission_edit->status->Lookup->toClientList() ?>;
fip_admissionedit.lists["x_status"].options = <?php echo JsonEncode($ip_admission_edit->status->lookupOptions()) ?>;
fip_admissionedit.lists["x_HospID"] = <?php echo $ip_admission_edit->HospID->Lookup->toClientList() ?>;
fip_admissionedit.lists["x_HospID"].options = <?php echo JsonEncode($ip_admission_edit->HospID->lookupOptions()) ?>;
fip_admissionedit.lists["x_ReferedByDr"] = <?php echo $ip_admission_edit->ReferedByDr->Lookup->toClientList() ?>;
fip_admissionedit.lists["x_ReferedByDr"].options = <?php echo JsonEncode($ip_admission_edit->ReferedByDr->lookupOptions()) ?>;
fip_admissionedit.lists["x_ReferA4TreatingConsultant"] = <?php echo $ip_admission_edit->ReferA4TreatingConsultant->Lookup->toClientList() ?>;
...
fip_admissionedit.lists["x_patient_id"] = <?php echo $ip_admission_edit->patient_id->Lookup->toClientList() ?>;
...
<?php if ($ip_admission_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ip_admission_edit->Token ?>">
<?php } ?>
...
<?php if ($ip_admission->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_ip_admission_id" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_id" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->id->caption() ?><?php echo ($ip_admission->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->id->cellAttributes() ?>>
<script id="tpx_ip_admission_id" class="ip_admissionedit" type="text/html">
<span id="el_ip_admission_id">
<span<?php echo $ip_admission->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($ip_admission->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="ip_admission" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($ip_admission->id->CurrentValue) ?>">
<?php echo $ip_admission->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ip_admission->mrnNo->Visible) { // mrnNo ?>
	<div id="r_mrnNo" class="form-group row">
		<label id="elh_ip_admission_mrnNo" for="x_mrnNo" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_mrnNo" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->mrnNo->caption() ?><?php echo ($ip_admission->mrnNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->mrnNo->cellAttributes() ?>>
<script id="tpx_ip_admission_mrnNo" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_ip_admission_PatientID" for="x_PatientID" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PatientID" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PatientID->caption() ?><?php echo ($ip_admission->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PatientID->cellAttributes() ?>>
<script id="tpx_ip_admission_PatientID" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->mobileno->Visible) { // mobileno ?>
	<div id="r_mobileno" class="form-group row">
		<label id="elh_ip_admission_mobileno" for="x_mobileno" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_mobileno" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->mobileno->caption() ?><?php echo ($ip_admission->mobileno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->mobileno->cellAttributes() ?>>
<script id="tpx_ip_admission_mobileno" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_ip_admission_gender" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_gender" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->gender->caption() ?><?php echo ($ip_admission->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->gender->cellAttributes() ?>>
<script id="tpx_ip_admission_gender" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->age->Visible) { // age ?>
	<div id="r_age" class="form-group row">
		<label id="elh_ip_admission_age" for="x_age" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_age" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->age->caption() ?><?php echo ($ip_admission->age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->age->cellAttributes() ?>>
<script id="tpx_ip_admission_age" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->typeRegsisteration->Visible) { // typeRegsisteration ?>
	<div id="r_typeRegsisteration" class="form-group row">
		<label id="elh_ip_admission_typeRegsisteration" for="x_typeRegsisteration" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_typeRegsisteration" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->typeRegsisteration->caption() ?><?php echo ($ip_admission->typeRegsisteration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->typeRegsisteration->cellAttributes() ?>>
<script id="tpx_ip_admission_typeRegsisteration" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PaymentCategory->Visible) { // PaymentCategory ?>
	<div id="r_PaymentCategory" class="form-group row">
		<label id="elh_ip_admission_PaymentCategory" for="x_PaymentCategory" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PaymentCategory" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PaymentCategory->caption() ?><?php echo ($ip_admission->PaymentCategory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PaymentCategory->cellAttributes() ?>>
<script id="tpx_ip_admission_PaymentCategory" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->physician_id->Visible) { // physician_id ?>
	<div id="r_physician_id" class="form-group row">
		<label id="elh_ip_admission_physician_id" for="x_physician_id" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_physician_id" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->physician_id->caption() ?><?php echo ($ip_admission->physician_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->physician_id->cellAttributes() ?>>
<script id="tpx_ip_admission_physician_id" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->admission_consultant_id->Visible) { // admission_consultant_id ?>
	<div id="r_admission_consultant_id" class="form-group row">
		<label id="elh_ip_admission_admission_consultant_id" for="x_admission_consultant_id" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_admission_consultant_id" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->admission_consultant_id->caption() ?><?php echo ($ip_admission->admission_consultant_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->admission_consultant_id->cellAttributes() ?>>
<script id="tpx_ip_admission_admission_consultant_id" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->leading_consultant_id->Visible) { // leading_consultant_id ?>
	<div id="r_leading_consultant_id" class="form-group row">
		<label id="elh_ip_admission_leading_consultant_id" for="x_leading_consultant_id" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_leading_consultant_id" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->leading_consultant_id->caption() ?><?php echo ($ip_admission->leading_consultant_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->leading_consultant_id->cellAttributes() ?>>
<script id="tpx_ip_admission_leading_consultant_id" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->cause->Visible) { // cause ?>
	<div id="r_cause" class="form-group row">
		<label id="elh_ip_admission_cause" for="x_cause" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_cause" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->cause->caption() ?><?php echo ($ip_admission->cause->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->cause->cellAttributes() ?>>
<script id="tpx_ip_admission_cause" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->admission_date->Visible) { // admission_date ?>
	<div id="r_admission_date" class="form-group row">
		...
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->admission_date->cellAttributes() ?>>
<script id="tpx_ip_admission_admission_date" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->release_date->Visible) { // release_date ?>
	<div id="r_release_date" class="form-group row">
		<label id="elh_ip_admission_release_date" for="x_release_date" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_release_date" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->release_date->caption() ?><?php echo ($ip_admission->release_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->release_date->cellAttributes() ?>>
<script id="tpx_ip_admission_release_date" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PaymentStatus->Visible) { // PaymentStatus ?>
	<div id="r_PaymentStatus" class="form-group row">
		<label id="elh_ip_admission_PaymentStatus" for="x_PaymentStatus" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PaymentStatus" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PaymentStatus->caption() ?><?php echo ($ip_admission->PaymentStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PaymentStatus->cellAttributes() ?>>
<script id="tpx_ip_admission_PaymentStatus" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_ip_admission_profilePic" for="x_profilePic" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_profilePic" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->profilePic->caption() ?><?php echo ($ip_admission->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->profilePic->cellAttributes() ?>>
<script id="tpx_ip_admission_profilePic" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->DOB->Visible) { // DOB ?>
	<div id="r_DOB" class="form-group row">
		<label id="elh_ip_admission_DOB" for="x_DOB" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_DOB" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->DOB->caption() ?><?php echo ($ip_admission->DOB->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->DOB->cellAttributes() ?>>
<script id="tpx_ip_admission_DOB" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ReferedByDr->Visible) { // ReferedByDr ?>
	<div id="r_ReferedByDr" class="form-group row">
		<label id="elh_ip_admission_ReferedByDr" for="x_ReferedByDr" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ReferedByDr" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ReferedByDr->caption() ?><?php echo ($ip_admission->ReferedByDr->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ReferedByDr->cellAttributes() ?>>
<script id="tpx_ip_admission_ReferedByDr" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ReferClinicname->Visible) { // ReferClinicname ?>
	<div id="r_ReferClinicname" class="form-group row">
		<label id="elh_ip_admission_ReferClinicname" for="x_ReferClinicname" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ReferClinicname" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ReferClinicname->caption() ?><?php echo ($ip_admission->ReferClinicname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ReferClinicname->cellAttributes() ?>>
<script id="tpx_ip_admission_ReferClinicname" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ReferCity->Visible) { // ReferCity ?>
	<div id="r_ReferCity" class="form-group row">
		<label id="elh_ip_admission_ReferCity" for="x_ReferCity" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ReferCity" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ReferCity->caption() ?><?php echo ($ip_admission->ReferCity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ReferCity->cellAttributes() ?>>
<script id="tpx_ip_admission_ReferCity" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ReferMobileNo->Visible) { // ReferMobileNo ?>
	<div id="r_ReferMobileNo" class="form-group row">
		...
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ReferMobileNo->cellAttributes() ?>>
<script id="tpx_ip_admission_ReferMobileNo" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ReferA4TreatingConsultant->Visible) { // ReferA4TreatingConsultant ?>
	<div id="r_ReferA4TreatingConsultant" class="form-group row">
		<label id="elh_ip_admission_ReferA4TreatingConsultant" for="x_ReferA4TreatingConsultant" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ReferA4TreatingConsultant" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ReferA4TreatingConsultant->caption() ?><?php echo ($ip_admission->ReferA4TreatingConsultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ReferA4TreatingConsultant->cellAttributes() ?>>
<script id="tpx_ip_admission_ReferA4TreatingConsultant" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PurposreReferredfor->Visible) { // PurposreReferredfor ?>
	<div id="r_PurposreReferredfor" class="form-group row">
		<label id="elh_ip_admission_PurposreReferredfor" for="x_PurposreReferredfor" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PurposreReferredfor" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PurposreReferredfor->caption() ?><?php echo ($ip_admission->PurposreReferredfor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PurposreReferredfor->cellAttributes() ?>>
<script id="tpx_ip_admission_PurposreReferredfor" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->BillClosing->Visible) { // BillClosing ?>
	<div id="r_BillClosing" class="form-group row">
		<label id="elh_ip_admission_BillClosing" for="x_BillClosing" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_BillClosing" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->BillClosing->caption() ?><?php echo ($ip_admission->BillClosing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->BillClosing->cellAttributes() ?>>
<script id="tpx_ip_admission_BillClosing" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->BillClosingDate->Visible) { // BillClosingDate ?>
	<div id="r_BillClosingDate" class="form-group row">
		<label id="elh_ip_admission_BillClosingDate" for="x_BillClosingDate" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_BillClosingDate" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->BillClosingDate->caption() ?><?php echo ($ip_admission->BillClosingDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->BillClosingDate->cellAttributes() ?>>
<script id="tpx_ip_admission_BillClosingDate" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_ip_admission_BillNumber" for="x_BillNumber" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_BillNumber" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->BillNumber->caption() ?><?php echo ($ip_admission->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->BillNumber->cellAttributes() ?>>
<script id="tpx_ip_admission_BillNumber" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ClosingAmount->Visible) { // ClosingAmount ?>
	<div id="r_ClosingAmount" class="form-group row">
		<label id="elh_ip_admission_ClosingAmount" for="x_ClosingAmount" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ClosingAmount" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ClosingAmount->caption() ?><?php echo ($ip_admission->ClosingAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ClosingAmount->cellAttributes() ?>>
<script id="tpx_ip_admission_ClosingAmount" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ClosingType->Visible) { // ClosingType ?>
	<div id="r_ClosingType" class="form-group row">
		<label id="elh_ip_admission_ClosingType" for="x_ClosingType" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ClosingType" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ClosingType->caption() ?><?php echo ($ip_admission->ClosingType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ClosingType->cellAttributes() ?>>
<script id="tpx_ip_admission_ClosingType" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->BillAmount->Visible) { // BillAmount ?>
	<div id="r_BillAmount" class="form-group row">
		<label id="elh_ip_admission_BillAmount" for="x_BillAmount" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_BillAmount" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->BillAmount->caption() ?><?php echo ($ip_admission->BillAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->BillAmount->cellAttributes() ?>>
<script id="tpx_ip_admission_BillAmount" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->billclosedBy->Visible) { // billclosedBy ?>
	<div id="r_billclosedBy" class="form-group row">
		<label id="elh_ip_admission_billclosedBy" for="x_billclosedBy" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_billclosedBy" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->billclosedBy->caption() ?><?php echo ($ip_admission->billclosedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->billclosedBy->cellAttributes() ?>>
<script id="tpx_ip_admission_billclosedBy" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->bllcloseByDate->Visible) { // bllcloseByDate ?>
	<div id="r_bllcloseByDate" class="form-group row">
		<label id="elh_ip_admission_bllcloseByDate" for="x_bllcloseByDate" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_bllcloseByDate" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->bllcloseByDate->caption() ?><?php echo ($ip_admission->bllcloseByDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->bllcloseByDate->cellAttributes() ?>>
<script id="tpx_ip_admission_bllcloseByDate" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_ip_admission_ReportHeader" for="x_ReportHeader" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_ReportHeader" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->ReportHeader->caption() ?><?php echo ($ip_admission->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->ReportHeader->cellAttributes() ?>>
<script id="tpx_ip_admission_ReportHeader" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Procedure->Visible) { // Procedure ?>
	<div id="r_Procedure" class="form-group row">
		<label id="elh_ip_admission_Procedure" for="x_Procedure" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Procedure" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Procedure->caption() ?><?php echo ($ip_admission->Procedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Procedure->cellAttributes() ?>>
<script id="tpx_ip_admission_Procedure" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Consultant->Visible) { // Consultant ?>
	<div id="r_Consultant" class="form-group row">
		<label id="elh_ip_admission_Consultant" for="x_Consultant" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Consultant" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Consultant->caption() ?><?php echo ($ip_admission->Consultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Consultant->cellAttributes() ?>>
<script id="tpx_ip_admission_Consultant" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Anesthetist->Visible) { // Anesthetist ?>
	<div id="r_Anesthetist" class="form-group row">
		<label id="elh_ip_admission_Anesthetist" for="x_Anesthetist" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Anesthetist" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Anesthetist->caption() ?><?php echo ($ip_admission->Anesthetist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Anesthetist->cellAttributes() ?>>
<script id="tpx_ip_admission_Anesthetist" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Amound->Visible) { // Amound ?>
	<div id="r_Amound" class="form-group row">
		<label id="elh_ip_admission_Amound" for="x_Amound" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Amound" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Amound->caption() ?><?php echo ($ip_admission->Amound->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Amound->cellAttributes() ?>>
<script id="tpx_ip_admission_Amound" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Package->Visible) { // Package ?>
	<div id="r_Package" class="form-group row">
		<label id="elh_ip_admission_Package" for="x_Package" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Package" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Package->caption() ?><?php echo ($ip_admission->Package->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Package->cellAttributes() ?>>
<script id="tpx_ip_admission_Package" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_ip_admission_patient_id" for="x_patient_id" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_patient_id" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->patient_id->caption() ?><?php echo ($ip_admission->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->patient_id->cellAttributes() ?>>
<script id="tpx_ip_admission_patient_id" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_ip_admission_PartnerID" for="x_PartnerID" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PartnerID" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PartnerID->caption() ?><?php echo ($ip_admission->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PartnerID->cellAttributes() ?>>
<script id="tpx_ip_admission_PartnerID" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_ip_admission_PartnerName" for="x_PartnerName" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PartnerName" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PartnerName->caption() ?><?php echo ($ip_admission->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PartnerName->cellAttributes() ?>>
<script id="tpx_ip_admission_PartnerName" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PartnerMobile->Visible) { // PartnerMobile ?>
	<div id="r_PartnerMobile" class="form-group row">
		<label id="elh_ip_admission_PartnerMobile" for="x_PartnerMobile" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PartnerMobile" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PartnerMobile->caption() ?><?php echo ($ip_admission->PartnerMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PartnerMobile->cellAttributes() ?>>
<script id="tpx_ip_admission_PartnerMobile" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Cid->Visible) { // Cid ?>
	<div id="r_Cid" class="form-group row">
		<label id="elh_ip_admission_Cid" for="x_Cid" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Cid" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Cid->caption() ?><?php echo ($ip_admission->Cid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Cid->cellAttributes() ?>>
<script id="tpx_ip_admission_Cid" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->PartId->Visible) { // PartId ?>
	<div id="r_PartId" class="form-group row">
		<label id="elh_ip_admission_PartId" for="x_PartId" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_PartId" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->PartId->caption() ?><?php echo ($ip_admission->PartId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->PartId->cellAttributes() ?>>
<script id="tpx_ip_admission_PartId" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->IDProof->Visible) { // IDProof ?>
	<div id="r_IDProof" class="form-group row">
		<label id="elh_ip_admission_IDProof" for="x_IDProof" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_IDProof" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->IDProof->caption() ?><?php echo ($ip_admission->IDProof->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->IDProof->cellAttributes() ?>>
<script id="tpx_ip_admission_IDProof" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->AdviceToOtherHospital->Visible) { // AdviceToOtherHospital ?>
	<div id="r_AdviceToOtherHospital" class="form-group row">
		<label id="elh_ip_admission_AdviceToOtherHospital" for="x_AdviceToOtherHospital" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_AdviceToOtherHospital" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->AdviceToOtherHospital->caption() ?><?php echo ($ip_admission->AdviceToOtherHospital->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->AdviceToOtherHospital->cellAttributes() ?>>
<script id="tpx_ip_admission_AdviceToOtherHospital" class="ip_admissionedit" type="text/html">
...
<?php if ($ip_admission->Reason->Visible) { // Reason ?>
	<div id="r_Reason" class="form-group row">
		<label id="elh_ip_admission_Reason" for="x_Reason" class="<?php echo $ip_admission_edit->LeftColumnClass ?>"><script id="tpc_ip_admission_Reason" class="ip_admissionedit" type="text/html"><span><?php echo $ip_admission->Reason->caption() ?><?php echo ($ip_admission->Reason->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ip_admission_edit->RightColumnClass ?>"><div<?php echo $ip_admission->Reason->cellAttributes() ?>>
<script id="tpx_ip_admission_Reason" class="ip_admissionedit" type="text/html">
...
ew.applyTemplate("tpd_ip_admissionedit", "tpm_ip_admissionedit", "ip_admissionedit", "<?php echo $ip_admission->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ip_admissionedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
