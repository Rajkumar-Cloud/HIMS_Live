...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>a4logo_lgm_icon.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>a4logo_lgm_icon.ico">
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>phpimages/A4 Hospitals logo Final.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
