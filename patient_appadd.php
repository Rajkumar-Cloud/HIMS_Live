...
var fpatient_appadd = currentForm = new ew.Form("fpatient_appadd", "add");
...
fpatient_appadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($patient_app_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_app_add->Token ?>">
<?php } ?>
...
<?php if ($patient_app->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_patient_app_PatientID" for="x_PatientID" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->PatientID->caption() ?><?php echo ($patient_app->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->PatientID->cellAttributes() ?>>
<span id="el_patient_app_PatientID">
<input type="text" data-table="patient_app" data-field="x_PatientID" name="x_PatientID" id="x_PatientID" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($patient_app->PatientID->getPlaceHolder()) ?>" value="<?php echo $patient_app->PatientID->EditValue ?>"<?php echo $patient_app->PatientID->editAttributes() ?>>
</span>
...
<?php if ($patient_app->title->Visible) { // title ?>
	<div id="r_title" class="form-group row">
		<label id="elh_patient_app_title" for="x_title" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->title->caption() ?><?php echo ($patient_app->title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->title->cellAttributes() ?>>
...
<?php if ($patient_app->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group row">
		<label id="elh_patient_app_first_name" for="x_first_name" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->first_name->caption() ?><?php echo ($patient_app->first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->first_name->cellAttributes() ?>>
...
<?php if ($patient_app->middle_name->Visible) { // middle_name ?>
	<div id="r_middle_name" class="form-group row">
		<label id="elh_patient_app_middle_name" for="x_middle_name" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->middle_name->caption() ?><?php echo ($patient_app->middle_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->middle_name->cellAttributes() ?>>
...
<?php if ($patient_app->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group row">
		<label id="elh_patient_app_last_name" for="x_last_name" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->last_name->caption() ?><?php echo ($patient_app->last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->last_name->cellAttributes() ?>>
...
<?php if ($patient_app->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_patient_app_gender" for="x_gender" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->gender->caption() ?><?php echo ($patient_app->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->gender->cellAttributes() ?>>
...
<?php if ($patient_app->dob->Visible) { // dob ?>
	<div id="r_dob" class="form-group row">
		<label id="elh_patient_app_dob" for="x_dob" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->dob->caption() ?><?php echo ($patient_app->dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->dob->cellAttributes() ?>>
...
<?php if ($patient_app->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_app_Age" for="x_Age" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Age->caption() ?><?php echo ($patient_app->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Age->cellAttributes() ?>>
...
<?php if ($patient_app->blood_group->Visible) { // blood_group ?>
	<div id="r_blood_group" class="form-group row">
		<label id="elh_patient_app_blood_group" for="x_blood_group" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->blood_group->caption() ?><?php echo ($patient_app->blood_group->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->blood_group->cellAttributes() ?>>
...
<?php if ($patient_app->mobile_no->Visible) { // mobile_no ?>
	<div id="r_mobile_no" class="form-group row">
		<label id="elh_patient_app_mobile_no" for="x_mobile_no" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->mobile_no->caption() ?><?php echo ($patient_app->mobile_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->mobile_no->cellAttributes() ?>>
...
<?php if ($patient_app->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_patient_app_description" for="x_description" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->description->caption() ?><?php echo ($patient_app->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->description->cellAttributes() ?>>
...
<?php if ($patient_app->IdentificationMark->Visible) { // IdentificationMark ?>
	<div id="r_IdentificationMark" class="form-group row">
		<label id="elh_patient_app_IdentificationMark" for="x_IdentificationMark" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->IdentificationMark->caption() ?><?php echo ($patient_app->IdentificationMark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->IdentificationMark->cellAttributes() ?>>
...
<?php if ($patient_app->Religion->Visible) { // Religion ?>
	<div id="r_Religion" class="form-group row">
		<label id="elh_patient_app_Religion" for="x_Religion" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Religion->caption() ?><?php echo ($patient_app->Religion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Religion->cellAttributes() ?>>
...
<?php if ($patient_app->Nationality->Visible) { // Nationality ?>
	<div id="r_Nationality" class="form-group row">
		<label id="elh_patient_app_Nationality" for="x_Nationality" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Nationality->caption() ?><?php echo ($patient_app->Nationality->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Nationality->cellAttributes() ?>>
...
<?php if ($patient_app->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_app_profilePic" for="x_profilePic" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->profilePic->caption() ?><?php echo ($patient_app->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->profilePic->cellAttributes() ?>>
...
<?php if ($patient_app->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_app_status" for="x_status" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->status->caption() ?><?php echo ($patient_app->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->status->cellAttributes() ?>>
...
<?php if ($patient_app->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_patient_app_createdby" for="x_createdby" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->createdby->caption() ?><?php echo ($patient_app->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->createdby->cellAttributes() ?>>
...
<?php if ($patient_app->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_patient_app_createddatetime" for="x_createddatetime" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->createddatetime->caption() ?><?php echo ($patient_app->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->createddatetime->cellAttributes() ?>>
...
<?php if ($patient_app->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_patient_app_modifiedby" for="x_modifiedby" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->modifiedby->caption() ?><?php echo ($patient_app->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->modifiedby->cellAttributes() ?>>
...
<?php if ($patient_app->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_patient_app_modifieddatetime" for="x_modifieddatetime" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->modifieddatetime->caption() ?><?php echo ($patient_app->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->modifieddatetime->cellAttributes() ?>>
...
<?php if ($patient_app->ReferedByDr->Visible) { // ReferedByDr ?>
	<div id="r_ReferedByDr" class="form-group row">
		<label id="elh_patient_app_ReferedByDr" for="x_ReferedByDr" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->ReferedByDr->caption() ?><?php echo ($patient_app->ReferedByDr->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->ReferedByDr->cellAttributes() ?>>
...
<?php if ($patient_app->ReferClinicname->Visible) { // ReferClinicname ?>
	<div id="r_ReferClinicname" class="form-group row">
		<label id="elh_patient_app_ReferClinicname" for="x_ReferClinicname" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->ReferClinicname->caption() ?><?php echo ($patient_app->ReferClinicname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->ReferClinicname->cellAttributes() ?>>
...
<?php if ($patient_app->ReferCity->Visible) { // ReferCity ?>
	<div id="r_ReferCity" class="form-group row">
		<label id="elh_patient_app_ReferCity" for="x_ReferCity" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->ReferCity->caption() ?><?php echo ($patient_app->ReferCity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->ReferCity->cellAttributes() ?>>
...
<?php if ($patient_app->ReferMobileNo->Visible) { // ReferMobileNo ?>
	<div id="r_ReferMobileNo" class="form-group row">
		<label id="elh_patient_app_ReferMobileNo" for="x_ReferMobileNo" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->ReferMobileNo->caption() ?><?php echo ($patient_app->ReferMobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->ReferMobileNo->cellAttributes() ?>>
...
<?php if ($patient_app->ReferA4TreatingConsultant->Visible) { // ReferA4TreatingConsultant ?>
	<div id="r_ReferA4TreatingConsultant" class="form-group row">
		<label id="elh_patient_app_ReferA4TreatingConsultant" for="x_ReferA4TreatingConsultant" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->ReferA4TreatingConsultant->caption() ?><?php echo ($patient_app->ReferA4TreatingConsultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->ReferA4TreatingConsultant->cellAttributes() ?>>
...
<?php if ($patient_app->PurposreReferredfor->Visible) { // PurposreReferredfor ?>
	<div id="r_PurposreReferredfor" class="form-group row">
		<label id="elh_patient_app_PurposreReferredfor" for="x_PurposreReferredfor" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->PurposreReferredfor->caption() ?><?php echo ($patient_app->PurposreReferredfor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->PurposreReferredfor->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_title->Visible) { // spouse_title ?>
	<div id="r_spouse_title" class="form-group row">
		<label id="elh_patient_app_spouse_title" for="x_spouse_title" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_title->caption() ?><?php echo ($patient_app->spouse_title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_title->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_first_name->Visible) { // spouse_first_name ?>
	<div id="r_spouse_first_name" class="form-group row">
		<label id="elh_patient_app_spouse_first_name" for="x_spouse_first_name" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_first_name->caption() ?><?php echo ($patient_app->spouse_first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_first_name->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_middle_name->Visible) { // spouse_middle_name ?>
	<div id="r_spouse_middle_name" class="form-group row">
		<label id="elh_patient_app_spouse_middle_name" for="x_spouse_middle_name" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_middle_name->caption() ?><?php echo ($patient_app->spouse_middle_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_middle_name->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_last_name->Visible) { // spouse_last_name ?>
	<div id="r_spouse_last_name" class="form-group row">
		<label id="elh_patient_app_spouse_last_name" for="x_spouse_last_name" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_last_name->caption() ?><?php echo ($patient_app->spouse_last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_last_name->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_gender->Visible) { // spouse_gender ?>
	<div id="r_spouse_gender" class="form-group row">
		<label id="elh_patient_app_spouse_gender" for="x_spouse_gender" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_gender->caption() ?><?php echo ($patient_app->spouse_gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_gender->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_dob->Visible) { // spouse_dob ?>
	<div id="r_spouse_dob" class="form-group row">
		<label id="elh_patient_app_spouse_dob" for="x_spouse_dob" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_dob->caption() ?><?php echo ($patient_app->spouse_dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_dob->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_Age->Visible) { // spouse_Age ?>
	<div id="r_spouse_Age" class="form-group row">
		<label id="elh_patient_app_spouse_Age" for="x_spouse_Age" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_Age->caption() ?><?php echo ($patient_app->spouse_Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_Age->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_blood_group->Visible) { // spouse_blood_group ?>
	<div id="r_spouse_blood_group" class="form-group row">
		<label id="elh_patient_app_spouse_blood_group" for="x_spouse_blood_group" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_blood_group->caption() ?><?php echo ($patient_app->spouse_blood_group->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_blood_group->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_mobile_no->Visible) { // spouse_mobile_no ?>
	<div id="r_spouse_mobile_no" class="form-group row">
		<label id="elh_patient_app_spouse_mobile_no" for="x_spouse_mobile_no" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_mobile_no->caption() ?><?php echo ($patient_app->spouse_mobile_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_mobile_no->cellAttributes() ?>>
...
<?php if ($patient_app->Maritalstatus->Visible) { // Maritalstatus ?>
	<div id="r_Maritalstatus" class="form-group row">
		<label id="elh_patient_app_Maritalstatus" for="x_Maritalstatus" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Maritalstatus->caption() ?><?php echo ($patient_app->Maritalstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Maritalstatus->cellAttributes() ?>>
...
<?php if ($patient_app->Business->Visible) { // Business ?>
	<div id="r_Business" class="form-group row">
		<label id="elh_patient_app_Business" for="x_Business" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Business->caption() ?><?php echo ($patient_app->Business->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Business->cellAttributes() ?>>
...
<?php if ($patient_app->Patient_Language->Visible) { // Patient_Language ?>
	<div id="r_Patient_Language" class="form-group row">
		<label id="elh_patient_app_Patient_Language" for="x_Patient_Language" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Patient_Language->caption() ?><?php echo ($patient_app->Patient_Language->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Patient_Language->cellAttributes() ?>>
...
<?php if ($patient_app->Passport->Visible) { // Passport ?>
	<div id="r_Passport" class="form-group row">
		<label id="elh_patient_app_Passport" for="x_Passport" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Passport->caption() ?><?php echo ($patient_app->Passport->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Passport->cellAttributes() ?>>
...
<?php if ($patient_app->VisaNo->Visible) { // VisaNo ?>
	<div id="r_VisaNo" class="form-group row">
		<label id="elh_patient_app_VisaNo" for="x_VisaNo" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->VisaNo->caption() ?><?php echo ($patient_app->VisaNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->VisaNo->cellAttributes() ?>>
...
<?php if ($patient_app->ValidityOfVisa->Visible) { // ValidityOfVisa ?>
	<div id="r_ValidityOfVisa" class="form-group row">
		<label id="elh_patient_app_ValidityOfVisa" for="x_ValidityOfVisa" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->ValidityOfVisa->caption() ?><?php echo ($patient_app->ValidityOfVisa->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->ValidityOfVisa->cellAttributes() ?>>
...
<?php if ($patient_app->WhereDidYouHear->Visible) { // WhereDidYouHear ?>
	<div id="r_WhereDidYouHear" class="form-group row">
		<label id="elh_patient_app_WhereDidYouHear" for="x_WhereDidYouHear" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->WhereDidYouHear->caption() ?><?php echo ($patient_app->WhereDidYouHear->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->WhereDidYouHear->cellAttributes() ?>>
...
<?php if ($patient_app->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_patient_app_HospID" for="x_HospID" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->HospID->caption() ?><?php echo ($patient_app->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->HospID->cellAttributes() ?>>
...
<?php if ($patient_app->street->Visible) { // street ?>
	<div id="r_street" class="form-group row">
		<label id="elh_patient_app_street" for="x_street" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->street->caption() ?><?php echo ($patient_app->street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->street->cellAttributes() ?>>
...
<?php if ($patient_app->town->Visible) { // town ?>
	<div id="r_town" class="form-group row">
		<label id="elh_patient_app_town" for="x_town" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->town->caption() ?><?php echo ($patient_app->town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->town->cellAttributes() ?>>
...
<?php if ($patient_app->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_patient_app_province" for="x_province" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->province->caption() ?><?php echo ($patient_app->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->province->cellAttributes() ?>>
...
<?php if ($patient_app->country->Visible) { // country ?>
	<div id="r_country" class="form-group row">
		<label id="elh_patient_app_country" for="x_country" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->country->caption() ?><?php echo ($patient_app->country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->country->cellAttributes() ?>>
...
<?php if ($patient_app->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_patient_app_postal_code" for="x_postal_code" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->postal_code->caption() ?><?php echo ($patient_app->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->postal_code->cellAttributes() ?>>
...
<?php if ($patient_app->PEmail->Visible) { // PEmail ?>
	<div id="r_PEmail" class="form-group row">
		<label id="elh_patient_app_PEmail" for="x_PEmail" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->PEmail->caption() ?><?php echo ($patient_app->PEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->PEmail->cellAttributes() ?>>
...
<?php if ($patient_app->PEmergencyContact->Visible) { // PEmergencyContact ?>
	<div id="r_PEmergencyContact" class="form-group row">
		<label id="elh_patient_app_PEmergencyContact" for="x_PEmergencyContact" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->PEmergencyContact->caption() ?><?php echo ($patient_app->PEmergencyContact->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->PEmergencyContact->cellAttributes() ?>>
...
<?php if ($patient_app->occupation->Visible) { // occupation ?>
	<div id="r_occupation" class="form-group row">
		<label id="elh_patient_app_occupation" for="x_occupation" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->occupation->caption() ?><?php echo ($patient_app->occupation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->occupation->cellAttributes() ?>>
...
<?php if ($patient_app->spouse_occupation->Visible) { // spouse_occupation ?>
	<div id="r_spouse_occupation" class="form-group row">
		<label id="elh_patient_app_spouse_occupation" for="x_spouse_occupation" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->spouse_occupation->caption() ?><?php echo ($patient_app->spouse_occupation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->spouse_occupation->cellAttributes() ?>>
...
<?php if ($patient_app->WhatsApp->Visible) { // WhatsApp ?>
	<div id="r_WhatsApp" class="form-group row">
		<label id="elh_patient_app_WhatsApp" for="x_WhatsApp" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->WhatsApp->caption() ?><?php echo ($patient_app->WhatsApp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->WhatsApp->cellAttributes() ?>>
...
<?php if ($patient_app->CouppleID->Visible) { // CouppleID ?>
	<div id="r_CouppleID" class="form-group row">
		<label id="elh_patient_app_CouppleID" for="x_CouppleID" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->CouppleID->caption() ?><?php echo ($patient_app->CouppleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->CouppleID->cellAttributes() ?>>
...
<?php if ($patient_app->MaleID->Visible) { // MaleID ?>
	<div id="r_MaleID" class="form-group row">
		<label id="elh_patient_app_MaleID" for="x_MaleID" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->MaleID->caption() ?><?php echo ($patient_app->MaleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->MaleID->cellAttributes() ?>>
...
<?php if ($patient_app->FemaleID->Visible) { // FemaleID ?>
	<div id="r_FemaleID" class="form-group row">
		<label id="elh_patient_app_FemaleID" for="x_FemaleID" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->FemaleID->caption() ?><?php echo ($patient_app->FemaleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->FemaleID->cellAttributes() ?>>
...
<?php if ($patient_app->GroupID->Visible) { // GroupID ?>
	<div id="r_GroupID" class="form-group row">
		<label id="elh_patient_app_GroupID" for="x_GroupID" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->GroupID->caption() ?><?php echo ($patient_app->GroupID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->GroupID->cellAttributes() ?>>
...
<?php if ($patient_app->Relationship->Visible) { // Relationship ?>
	<div id="r_Relationship" class="form-group row">
		<label id="elh_patient_app_Relationship" for="x_Relationship" class="<?php echo $patient_app_add->LeftColumnClass ?>"><?php echo $patient_app->Relationship->caption() ?><?php echo ($patient_app->Relationship->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_app_add->RightColumnClass ?>"><div<?php echo $patient_app->Relationship->cellAttributes() ?>>
