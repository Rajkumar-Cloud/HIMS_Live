 ...
 * Page class
 */
class PatientDelete extends Patient
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PatientDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientList"); // Return to list
                return;
            }
        }
