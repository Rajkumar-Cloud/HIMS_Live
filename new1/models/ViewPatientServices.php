...
class ViewPatientServices extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DiscountCategory
        $this->DiscountCategory = new DbField('view_patient_services', 'view_patient_services', 'x_DiscountCategory', 'DiscountCategory', '`DiscountCategory`', '`DiscountCategory`', 200, 45, -1, false, '`DiscountCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPatientServicesList");
        }
    }
