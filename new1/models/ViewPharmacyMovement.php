...
class ViewPharmacyMovement extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_pharmacy_movement', 'view_pharmacy_movement', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 0, "DB"), 135, 19, 0, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPharmacyMovementList");
        }
    }
