 ...
 */
class RoomMaster extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('room_master', 'room_master', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // RoomNo
        $this->RoomNo = new DbField('room_master', 'room_master', 'x_RoomNo', 'RoomNo', '`RoomNo`', '`RoomNo`', 200, 45, -1, false, '`RoomNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RoomNo->Sortable = true; // Allow sort
        $this->Fields['RoomNo'] = &$this->RoomNo;

        // RoomType
        $this->RoomType = new DbField('room_master', 'room_master', 'x_RoomType', 'RoomType', '`RoomType`', '`RoomType`', 200, 45, -1, false, '`RoomType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RoomType->Sortable = true; // Allow sort
        $this->Fields['RoomType'] = &$this->RoomType;

        // SharingRoom
        $this->SharingRoom = new DbField('room_master', 'room_master', 'x_SharingRoom', 'SharingRoom', '`SharingRoom`', '`SharingRoom`', 200, 45, -1, false, '`SharingRoom`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SharingRoom->Sortable = true; // Allow sort
        $this->Fields['SharingRoom'] = &$this->SharingRoom;

        // Amount
        $this->Amount = new DbField('room_master', 'room_master', 'x_Amount', 'Amount', '`Amount`', '`Amount`', 131, 8, -1, false, '`Amount`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Status
        $this->Status = new DbField('room_master', 'room_master', 'x_Status', 'Status', '`Status`', '`Status`', 200, 45, -1, false, '`Status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Status->Sortable = true; // Allow sort
        $this->Fields['Status'] = &$this->Status;

        // PatientID
        $this->PatientID = new DbField('room_master', 'room_master', 'x_PatientID', 'PatientID', '`PatientID`', '`PatientID`', 200, 45, -1, false, '`PatientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientID->Sortable = true; // Allow sort
        $this->Fields['PatientID'] = &$this->PatientID;

        // PatientName
        $this->PatientName = new DbField('room_master', 'room_master', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->Fields['PatientName'] = &$this->PatientName;

        // MobileNo
        $this->MobileNo = new DbField('room_master', 'room_master', 'x_MobileNo', 'MobileNo', '`MobileNo`', '`MobileNo`', 200, 45, -1, false, '`MobileNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MobileNo->Sortable = true; // Allow sort
        $this->Fields['MobileNo'] = &$this->MobileNo;

        // PatID
        $this->PatID = new DbField('room_master', 'room_master', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "RoomMasterEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RoomMasterAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RoomMasterView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RoomMasterView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RoomMasterAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RoomMasterAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("RoomMasterEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RoomMasterAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RoomMasterDelete", $this->getUrlParm());
    }
