...
class PatientInsurance extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DocumentAttatch
        $this->DocumentAttatch = new DbField('patient_insurance', 'patient_insurance', 'x_DocumentAttatch', 'DocumentAttatch', '`DocumentAttatch`', '`DocumentAttatch`', 201, 405, -1, false, '`DocumentAttatch`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->DocumentAttatch->DbValue = $row['DocumentAttatch'];
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PatientInsuranceList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->DocumentAttatch->EditValue = $this->DocumentAttatch->CurrentValue;
