 ...
 * Page class
 */
class EmployeeHasExperienceDelete extends EmployeeHasExperience
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "EmployeeHasExperienceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeHasExperienceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeHasExperienceList"); // Return to list
                return;
            }
        }
