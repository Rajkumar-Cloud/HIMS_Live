 ...
 */
class ViewPartnerSemenstock extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // RIDNo
        $this->RIDNo = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, 11, -1, false, '`RIDNo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPartnerSemenstockList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewPartnerSemenstockView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewPartnerSemenstockEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewPartnerSemenstockAdd") {
    ...
    {
        return "ViewPartnerSemenstockList";
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPartnerSemenstockView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewPartnerSemenstockView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewPartnerSemenstockAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewPartnerSemenstockAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPartnerSemenstockEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPartnerSemenstockAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewPartnerSemenstockDelete", $this->getUrlParm());
    }
