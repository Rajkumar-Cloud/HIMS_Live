...
class Help extends DbTable
{
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HelpView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("HelpView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "HelpAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "HelpAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("HelpEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HelpAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("HelpDelete", $this->getUrlParm());
    }
