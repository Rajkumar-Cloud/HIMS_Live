 ...
 */
class BillingRefundVoucher extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('billing_refund_voucher', 'billing_refund_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Reception
        $this->Reception = new DbField('billing_refund_voucher', 'billing_refund_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("BillingRefundVoucherList");
        }
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "BillingRefundVoucherEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BillingRefundVoucherAdd") {
    ...
    {
        return "BillingRefundVoucherList";
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BillingRefundVoucherView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BillingRefundVoucherView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BillingRefundVoucherAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BillingRefundVoucherAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BillingRefundVoucherEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BillingRefundVoucherAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BillingRefundVoucherDelete", $this->getUrlParm());
    }
