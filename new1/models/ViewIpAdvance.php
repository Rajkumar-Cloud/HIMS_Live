...
class ViewIpAdvance extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('view_ip_advance', 'view_ip_advance', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('view_ip_advance', 'view_ip_advance', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 405, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Reception
        $this->Reception = new DbField('view_ip_advance', 'view_ip_advance', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIpAdvanceList");
        }
    }
