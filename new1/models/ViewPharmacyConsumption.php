...
class ViewPharmacyConsumption extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Select
        $this->Select = new DbField('view_pharmacy_consumption', 'view_pharmacy_consumption', 'x_Select', 'Select', '`Select`', '`Select`', 200, 99, -1, false, '`Select`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPharmacyConsumptionList");
        }
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // Select
        $this->Select->ViewValue = $this->Select->CurrentValue;
    ...
    public function renderEditRow()
    {
        ...
        // Select
        $this->Select->EditAttrs["class"] = "form-control";
        $this->Select->EditCustomAttributes = "";
        if (!$this->Select->Raw) {
            $this->Select->CurrentValue = HtmlDecode($this->Select->CurrentValue);
        }
        $this->Select->EditValue = $this->Select->CurrentValue;
