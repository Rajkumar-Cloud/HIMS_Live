 ...
 * Page class
 */
class PharmacyServicesDelete extends PharmacyServices
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PharmacyServicesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyServicesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyServicesList"); // Return to list
                return;
            }
        }
