 ...
 */
class ViewDonorIvf extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Female
        $this->Female = new DbField('view_donor_ivf', 'view_donor_ivf', 'x_Female', 'Female', '`Female`', '`Female`', 3, 11, -1, false, '`Female`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('view_donor_ivf', 'view_donor_ivf', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // malepropic
        $this->malepropic = new DbField('view_donor_ivf', 'view_donor_ivf', 'x_malepropic', 'malepropic', '`malepropic`', '`malepropic`', 201, 450, -1, false, '`malepropic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->malepropic->Sortable = true; // Allow sort
        $this->Fields['malepropic'] = &$this->malepropic;

        // femalepropic
        $this->femalepropic = new DbField('view_donor_ivf', 'view_donor_ivf', 'x_femalepropic', 'femalepropic', '`femalepropic`', '`femalepropic`', 201, 450, -1, false, '`femalepropic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ReferedBy
        $this->ReferedBy = new DbField('view_donor_ivf', 'view_donor_ivf', 'x_ReferedBy', 'ReferedBy', '`ReferedBy`', '`ReferedBy`', 200, 45, -1, false, '`ReferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_donor_ivf', 'view_donor_ivf', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewDonorIvfList");
        }
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewDonorIvfEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewDonorIvfAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewDonorIvfView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewDonorIvfView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewDonorIvfAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewDonorIvfAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ViewDonorIvfEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewDonorIvfAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewDonorIvfDelete", $this->getUrlParm());
    }
