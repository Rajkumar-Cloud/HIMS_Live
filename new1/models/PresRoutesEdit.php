 ...
 * Page class
 */
class PresRoutesEdit extends PresRoutes
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "PresRoutesEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (Post("action") !== null) {
                ...
                // Load key from Form
                if ($CurrentForm->hasValue("x_SNo")) {
                    $this->SNo->setFormValue($CurrentForm->getValue("x_SNo"));
                }
            } else {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("PresRoutesList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "PresRoutesList") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'S.No' first before field var 'x_SNo'
        $val = $CurrentForm->hasValue("S.No") ? $CurrentForm->getValue("S.No") : $CurrentForm->getValue("x_SNo");
