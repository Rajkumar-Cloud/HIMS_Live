...
class UserLogin extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // password
        $this->_password = new DbField('user_login', 'user_login', 'x__password', 'password', '`password`', '`password`', 200, 45, -1, false, '`password`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email_verified
        $this->email_verified = new DbField('user_login', 'user_login', 'x_email_verified', 'email_verified', '`email_verified`', '`email_verified`', 200, 45, -1, false, '`email_verified`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserLevel
        $this->_UserLevel = new DbField('user_login', 'user_login', 'x__UserLevel', 'UserLevel', '`UserLevel`', '`UserLevel`', 3, 11, -1, false, '`UserLevel`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('user_login', 'user_login', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->HospID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['HospID'] = &$this->HospID;

        // PharID
        $this->PharID = new DbField('user_login', 'user_login', 'x_PharID', 'PharID', '`PharID`', '`PharID`', 3, 11, -1, false, '`PharID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StoreID
        $this->StoreID = new DbField('user_login', 'user_login', 'x_StoreID', 'StoreID', '`StoreID`', '`StoreID`', 3, 11, -1, false, '`StoreID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
