 ...
 * Page class
 */
class HospitalStoreDelete extends HospitalStore
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "HospitalStoreDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HospitalStoreList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HospitalStoreList"); // Return to list
                return;
            }
        }
