...
class PresTradeCombinationNamesNew extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Generic_Name
        $this->Generic_Name = new DbField('pres_trade_combination_names_new', 'pres_trade_combination_names_new', 'x_Generic_Name', 'Generic_Name', '`Generic_Name`', '`Generic_Name`', 200, 100, -1, false, '`Generic_Name`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Form
        $this->Form = new DbField('pres_trade_combination_names_new', 'pres_trade_combination_names_new', 'x_Form', 'Form', '`Form`', '`Form`', 200, 50, -1, false, '`Form`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Unit
        $this->Unit = new DbField('pres_trade_combination_names_new', 'pres_trade_combination_names_new', 'x_Unit', 'Unit', '`Unit`', '`Unit`', 200, 50, -1, false, '`Unit`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TypeOfDrug
        $this->TypeOfDrug = new DbField('pres_trade_combination_names_new', 'pres_trade_combination_names_new', 'x_TypeOfDrug', 'TypeOfDrug', '`TypeOfDrug`', '`TypeOfDrug`', 200, 45, -1, false, '`TypeOfDrug`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PresTradeCombinationNamesNewList");
        }
    }
