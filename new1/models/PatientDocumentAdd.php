 ...
 * Page class
 */
class PatientDocumentAdd extends PatientDocument
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "PatientDocumentAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("PatientDocumentList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PatientDocumentList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PatientDocumentView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->DocumentUpload->CurrentValue = null;
        $this->DocumentUpload->OldValue = $this->DocumentUpload->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'DocumentUpload' first before field var 'x_DocumentUpload'
        $val = $CurrentForm->hasValue("DocumentUpload") ? $CurrentForm->getValue("DocumentUpload") : $CurrentForm->getValue("x_DocumentUpload");
        if (!$this->DocumentUpload->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->DocumentUpload->Visible = false; // Disable update for API request
            } else {
                $this->DocumentUpload->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->DocumentUpload->CurrentValue = $this->DocumentUpload->FormValue;
    ...
    protected function newRow()
    {
        ...
        $row['DocumentUpload'] = $this->DocumentUpload->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // DocumentUpload
            $this->DocumentUpload->ViewValue = $this->DocumentUpload->CurrentValue;
            ...
            $this->DocumentUpload->EditValue = HtmlEncode($this->DocumentUpload->CurrentValue);
            $this->DocumentUpload->PlaceHolder = RemoveHtml($this->DocumentUpload->caption());
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->DocumentName->FormValue)) {
            $this->DocumentName->addErrorMessage($this->DocumentName->getErrorMessage(false));
        }
        ...
        if ($this->DocumentUpload->Required) {
            if (!$this->DocumentUpload->IsDetailKey && EmptyValue($this->DocumentUpload->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // DocumentUpload
        $this->DocumentUpload->setDbValueDef($rsnew, $this->DocumentUpload->CurrentValue, "", false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PatientDocumentList"), "", $this->TableVar, true);
