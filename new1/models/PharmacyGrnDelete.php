 ...
 * Page class
 */
class PharmacyGrnDelete extends PharmacyGrn
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PharmacyGrnDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyGrnList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyGrnList"); // Return to list
                return;
            }
        }
