...
class EmployeeDocument extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DocumentName
        $this->DocumentName = new DbField('employee_document', 'employee_document', 'x_DocumentName', 'DocumentName', '`DocumentName`', '`DocumentName`', 3, 11, -1, false, '`DocumentName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DocumentUpload
        $this->DocumentUpload = new DbField('employee_document', 'employee_document', 'x_DocumentUpload', 'DocumentUpload', '`DocumentUpload`', '`DocumentUpload`', 201, 450, -1, false, '`DocumentUpload`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // status
        $this->status = new DbField('employee_document', 'employee_document', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->DocumentUpload->DbValue = $row['DocumentUpload'];
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("EmployeeDocumentList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->DocumentUpload->EditValue = $this->DocumentUpload->CurrentValue;
