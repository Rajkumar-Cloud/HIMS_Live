...
class PatientVitals extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // profilePic
        $this->profilePic = new DbField('patient_vitals', 'patient_vitals', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // GenericAllergies
        $this->GenericAllergies = new DbField('patient_vitals', 'patient_vitals', 'x_GenericAllergies', 'GenericAllergies', '`GenericAllergies`', '`GenericAllergies`', 200, 45, -1, false, '`GenericAllergies`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GenericAllergies->Sortable = true; // Allow sort
        $this->Fields['GenericAllergies'] = &$this->GenericAllergies;

        // GroupAllergies
        $this->GroupAllergies = new DbField('patient_vitals', 'patient_vitals', 'x_GroupAllergies', 'GroupAllergies', '`GroupAllergies`', '`GroupAllergies`', 200, 45, -1, false, '`GroupAllergies`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // clinicaldetails
        $this->clinicaldetails = new DbField('patient_vitals', 'patient_vitals', 'x_clinicaldetails', 'clinicaldetails', '`clinicaldetails`', '`clinicaldetails`', 200, 45, -1, false, '`clinicaldetails`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->clinicaldetails->Sortable = true; // Allow sort
        $this->Fields['clinicaldetails'] = &$this->clinicaldetails;

        // status
        $this->status = new DbField('patient_vitals', 'patient_vitals', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PatientVitalsList");
        }
    }
