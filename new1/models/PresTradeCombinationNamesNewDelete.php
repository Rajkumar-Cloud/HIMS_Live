 ...
 * Page class
 */
class PresTradeCombinationNamesNewDelete extends PresTradeCombinationNamesNew
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PresTradeCombinationNamesNewDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PresTradeCombinationNamesNewList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PresTradeCombinationNamesNewList"); // Return to list
                return;
            }
        }
