...
class IvfFollowUpTrackingEdit extends IvfFollowUpTracking
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->FollowUpDate->IsDetailKey) {
            ...
            $this->FollowUpDate->CurrentValue = UnFormatDateTime($this->FollowUpDate->CurrentValue, 0);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->FollowUpDate->EditValue = HtmlEncode(FormatDateTime($this->FollowUpDate->CurrentValue, 8));
    ...
    protected function validateForm()
    {
        ...
        if (!CheckDate($this->FollowUpDate->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // FollowUpDate
            $this->FollowUpDate->setDbValueDef($rsnew, UnFormatDateTime($this->FollowUpDate->CurrentValue, 0), null, $this->FollowUpDate->ReadOnly);
