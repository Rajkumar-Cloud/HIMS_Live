...
class ViewLabServicess extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // HospID
        $this->HospID = new DbField('view_lab_servicess', 'view_lab_servicess', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Remarks
        $this->Remarks = new DbField('view_lab_servicess', 'view_lab_servicess', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 65535, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewLabServicessList");
        }
    }
