...
class PharmacyPayment extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DT
        $this->DT = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Customername
        $this->Customername = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Customername', 'Customername', '`Customername`', '`Customername`', 200, 45, -1, false, '`Customername`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Customername->Sortable = true; // Allow sort
        $this->Fields['Customername'] = &$this->Customername;

        // pharmacy_pocol
        $this->pharmacy_pocol = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_pharmacy_pocol', 'pharmacy_pocol', '`pharmacy_pocol`', '`pharmacy_pocol`', 200, 45, -1, false, '`pharmacy_pocol`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->pharmacy_pocol->Sortable = true; // Allow sort
        $this->Fields['pharmacy_pocol'] = &$this->pharmacy_pocol;

        // Address1
        $this->Address1 = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 201, 405, -1, false, '`Address1`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Address1->Sortable = true; // Allow sort
        $this->Fields['Address1'] = &$this->Address1;

        // Address2
        $this->Address2 = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 201, 405, -1, false, '`Address2`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Address2->Sortable = true; // Allow sort
        $this->Fields['Address2'] = &$this->Address2;

        // Address3
        $this->Address3 = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 201, 405, -1, false, '`Address3`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('pharmacy_payment', 'pharmacy_payment', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PharmacyPaymentList");
        }
    }
