...
class ViewLabServiceSub extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // UNITS
        $this->UNITS = new DbField('view_lab_service_sub', 'view_lab_service_sub', 'x_UNITS', 'UNITS', '`UNITS`', '`UNITS`', 3, 11, -1, false, '`UNITS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVICE_TYPE
        $this->SERVICE_TYPE = new DbField('view_lab_service_sub', 'view_lab_service_sub', 'x_SERVICE_TYPE', 'SERVICE_TYPE', '`SERVICE_TYPE`', '`SERVICE_TYPE`', 200, 50, -1, false, '`SERVICE_TYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SERVICE_TYPE->Sortable = true; // Allow sort
        $this->Fields['SERVICE_TYPE'] = &$this->SERVICE_TYPE;

        // DEPARTMENT
        $this->DEPARTMENT = new DbField('view_lab_service_sub', 'view_lab_service_sub', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, 50, -1, false, '`DEPARTMENT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Inactive
        $this->Inactive = new DbField('view_lab_service_sub', 'view_lab_service_sub', 'x_Inactive', 'Inactive', '`Inactive`', '`Inactive`', 200, 45, -1, false, '`Inactive`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TestType
        $this->TestType = new DbField('view_lab_service_sub', 'view_lab_service_sub', 'x_TestType', 'TestType', '`TestType`', '`TestType`', 200, 45, -1, false, '`TestType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewLabServiceSubList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->Modified->EditValue = $this->Modified->CurrentValue;
