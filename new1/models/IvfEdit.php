...
class IvfEdit extends Ivf
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // malepropic
            $this->malepropic->setDbValueDef($rsnew, $this->malepropic->CurrentValue, null, $this->malepropic->ReadOnly);

            // femalepropic
            $this->femalepropic->setDbValueDef($rsnew, $this->femalepropic->CurrentValue, null, $this->femalepropic->ReadOnly);
