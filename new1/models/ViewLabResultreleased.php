...
class ViewLabResultreleased extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Resulted
        $this->Resulted = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, 45, -1, false, '`Resulted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic1
        $this->Pic1 = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, 45, -1, false, '`Pic1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Pic1->Sortable = true; // Allow sort
        $this->Fields['Pic1'] = &$this->Pic1;

        // Pic2
        $this->Pic2 = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, 45, -1, false, '`Pic2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Repeated
        $this->Repeated = new DbField('view_lab_resultreleased', 'view_lab_resultreleased', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, 45, -1, false, '`Repeated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewLabResultreleasedList");
        }
    }
