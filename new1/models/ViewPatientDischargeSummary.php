...
class ViewPatientDischargeSummary extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // physician_id
        $this->physician_id = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, 11, -1, false, '`physician_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // admission_date
        $this->admission_date = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike("`admission_date`", 0, "DB"), 135, 19, 0, false, '`admission_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // release_date
        $this->release_date = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike("`release_date`", 0, "DB"), 135, 19, 0, false, '`release_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NextReviewDate
        $this->NextReviewDate = new DbField('view_patient_discharge_summary', 'view_patient_discharge_summary', 'x_NextReviewDate', 'NextReviewDate', '`NextReviewDate`', CastDateFieldForLike("`NextReviewDate`", 0, "DB"), 135, 19, 0, false, '`NextReviewDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPatientDischargeSummaryList");
        }
    }
