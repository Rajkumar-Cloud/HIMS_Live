 ...
 * Page class
 */
class LabProfileDetailsDelete extends LabProfileDetails
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "LabProfileDetailsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LabProfileDetailsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LabProfileDetailsList"); // Return to list
                return;
            }
        }
