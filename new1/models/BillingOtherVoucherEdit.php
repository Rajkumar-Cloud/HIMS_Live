 ...
 * Page class
 */
class BillingOtherVoucherEdit extends BillingOtherVoucher
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "BillingOtherVoucherEdit";
    ...
    protected function validateForm()
    {
        ...
        if (!CheckDate($this->CancelDate->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // CancelDate
            $this->CancelDate->setDbValueDef($rsnew, UnFormatDateTime($this->CancelDate->CurrentValue, 0), null, $this->CancelDate->ReadOnly);
