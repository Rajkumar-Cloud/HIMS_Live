 ...
 * Page class
 */
class PharmacyPurchaseRequestAdd extends PharmacyPurchaseRequest
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "PharmacyPurchaseRequestAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("PharmacyPurchaseRequestList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PharmacyPurchaseRequestList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PharmacyPurchaseRequestView") {
    ...
    protected function newRow()
    {
        ...
        $row['EmployeeName'] = $this->EmployeeName->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->EmployeeName->EditValue = HtmlEncode($this->EmployeeName->CurrentValue);
            ...
            $this->PurchaseStatus->EditValue = HtmlEncode($this->PurchaseStatus->CurrentValue);
