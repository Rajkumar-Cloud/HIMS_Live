...
class ViewDashboardSummaryPaymentMode extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // createddate
        $this->createddate = new DbField('view_dashboard_summary_payment_mode', 'view_dashboard_summary_payment_mode', 'x_createddate', 'createddate', '`createddate`', CastDateFieldForLike("`createddate`", 0, "DB"), 133, 10, 0, false, '`createddate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewDashboardSummaryPaymentModeList");
        }
    }
