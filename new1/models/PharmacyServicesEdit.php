 ...
 * Page class
 */
class PharmacyServicesEdit extends PharmacyServices
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "PharmacyServicesEdit";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->pharmacy_id->EditValue = HtmlEncode($this->pharmacy_id->CurrentValue);
