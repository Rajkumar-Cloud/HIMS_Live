...
class EmployeeHasDegreeAdd extends EmployeeHasDegree
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->certificates->CurrentValue = null;
        $this->certificates->OldValue = $this->certificates->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'certificates' first before field var 'x_certificates'
        $val = $CurrentForm->hasValue("certificates") ? $CurrentForm->getValue("certificates") : $CurrentForm->getValue("x_certificates");
        if (!$this->certificates->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->certificates->Visible = false; // Disable update for API request
            } else {
                $this->certificates->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->certificates->CurrentValue = $this->certificates->FormValue;
    ...
    protected function newRow()
    {
        ...
        $row['certificates'] = $this->certificates->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->degree_id->EditValue = HtmlEncode($this->degree_id->CurrentValue);
            ...
            if (!$this->certificates->Raw) {
                $this->certificates->CurrentValue = HtmlDecode($this->certificates->CurrentValue);
            }
            $this->certificates->EditValue = HtmlEncode($this->certificates->CurrentValue);
            $this->certificates->PlaceHolder = RemoveHtml($this->certificates->caption());
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->degree_id->FormValue)) {
            $this->degree_id->addErrorMessage($this->degree_id->getErrorMessage(false));
        }
        ...
        if ($this->certificates->Required) {
            if (!$this->certificates->IsDetailKey && EmptyValue($this->certificates->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // certificates
        $this->certificates->setDbValueDef($rsnew, $this->certificates->CurrentValue, "", false);

        // others
        $this->_others->setDbValueDef($rsnew, $this->_others->CurrentValue, "", false);
