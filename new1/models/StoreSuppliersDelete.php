 ...
 * Page class
 */
class StoreSuppliersDelete extends StoreSuppliers
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "StoreSuppliersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("StoreSuppliersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("StoreSuppliersList"); // Return to list
                return;
            }
        }
