...
class ViewEt extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Day
        $this->Day = new DbField('view_et', 'view_et', 'x_Day', 'Day', '`Day`', '`Day`', 200, 45, -1, false, '`Day`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Day->Sortable = true; // Allow sort
        $this->Fields['Day'] = &$this->Day;

        // Grade
        $this->Grade = new DbField('view_et', 'view_et', 'x_Grade', 'Grade', '`Grade`', '`Grade`', 200, 45, -1, false, '`Grade`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Difficulty
        $this->Difficulty = new DbField('view_et', 'view_et', 'x_Difficulty', 'Difficulty', '`Difficulty`', '`Difficulty`', 200, 45, -1, false, '`Difficulty`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Difficulty->Sortable = true; // Allow sort
        $this->Fields['Difficulty'] = &$this->Difficulty;

        // Easy
        $this->Easy = new DbField('view_et', 'view_et', 'x_Easy', 'Easy', '`Easy`', '`Easy`', 200, 220, -1, false, '`Easy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
