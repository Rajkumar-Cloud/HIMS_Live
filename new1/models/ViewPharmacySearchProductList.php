 ...
 * Page class
 */
class ViewPharmacySearchProductList extends ViewPharmacySearchProduct
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "ViewPharmacySearchProductList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPharmacySearchProductAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPharmacySearchProductDelete";
        $this->MultiUpdateUrl = "ViewPharmacySearchProductUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_pharmacy_search_product"));
                $doc->Text = @$content;
