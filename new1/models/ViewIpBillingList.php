 ...
 * Page class
 */
class ViewIpBillingList extends ViewIpBilling
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "ViewIpBillingList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewIpBillingAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewIpBillingDelete";
        $this->MultiUpdateUrl = "ViewIpBillingUpdate";
