...
class PharmacyPo extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DT
        $this->DT = new DbField('pharmacy_po', 'pharmacy_po', 'x_DT', 'DT', '`DT`', CastDateFieldForLike("`DT`", 0, "DB"), 135, 19, 0, false, '`DT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('pharmacy_po', 'pharmacy_po', 'x_PC', 'PC', '`PC`', '`PC`', 200, 45, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Address1
        $this->Address1 = new DbField('pharmacy_po', 'pharmacy_po', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 201, 405, -1, false, '`Address1`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Address1->Sortable = true; // Allow sort
        $this->Fields['Address1'] = &$this->Address1;

        // Address2
        $this->Address2 = new DbField('pharmacy_po', 'pharmacy_po', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 201, 405, -1, false, '`Address2`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->Address2->Sortable = true; // Allow sort
        $this->Fields['Address2'] = &$this->Address2;

        // Address3
        $this->Address3 = new DbField('pharmacy_po', 'pharmacy_po', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 201, 405, -1, false, '`Address3`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // BRCODE
        $this->BRCODE = new DbField('pharmacy_po', 'pharmacy_po', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
