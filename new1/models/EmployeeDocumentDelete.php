 ...
 * Page class
 */
class EmployeeDocumentDelete extends EmployeeDocument
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "EmployeeDocumentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeDocumentList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeDocumentList"); // Return to list
                return;
            }
        }
