...
class Ivf extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Male
        $this->Male = new DbField('ivf', 'ivf', 'x_Male', 'Male', '`Male`', '`Male`', 3, 11, -1, false, '`Male`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Female
        $this->Female = new DbField('ivf', 'ivf', 'x_Female', 'Female', '`Female`', '`Female`', 3, 11, -1, false, '`Female`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('ivf', 'ivf', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // malepropic
        $this->malepropic = new DbField('ivf', 'ivf', 'x_malepropic', 'malepropic', '`malepropic`', '`malepropic`', 201, 450, -1, false, '`malepropic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->malepropic->Sortable = true; // Allow sort
        $this->Fields['malepropic'] = &$this->malepropic;

        // femalepropic
        $this->femalepropic = new DbField('ivf', 'ivf', 'x_femalepropic', 'femalepropic', '`femalepropic`', '`femalepropic`', 201, 450, -1, false, '`femalepropic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ReferedBy
        $this->ReferedBy = new DbField('ivf', 'ivf', 'x_ReferedBy', 'ReferedBy', '`ReferedBy`', '`ReferedBy`', 200, 45, -1, false, '`ReferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ARTCYCLE
        $this->ARTCYCLE = new DbField('ivf', 'ivf', 'x_ARTCYCLE', 'ARTCYCLE', '`ARTCYCLE`', '`ARTCYCLE`', 200, 45, -1, false, '`ARTCYCLE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ARTCYCLE->Sortable = true; // Allow sort
        $this->Fields['ARTCYCLE'] = &$this->ARTCYCLE;

        // RESULT
        $this->RESULT = new DbField('ivf', 'ivf', 'x_RESULT', 'RESULT', '`RESULT`', '`RESULT`', 200, 45, -1, false, '`RESULT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('ivf', 'ivf', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
