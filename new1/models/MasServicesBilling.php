...
class MasServicesBilling extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // SERVICE_TYPE
        $this->SERVICE_TYPE = new DbField('mas_services_billing', 'mas_services_billing', 'x_SERVICE_TYPE', 'SERVICE_TYPE', '`SERVICE_TYPE`', '`SERVICE_TYPE`', 200, 50, -1, false, '`SERVICE_TYPE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SERVICE_TYPE->Sortable = true; // Allow sort
        $this->Fields['SERVICE_TYPE'] = &$this->SERVICE_TYPE;

        // DEPARTMENT
        $this->DEPARTMENT = new DbField('mas_services_billing', 'mas_services_billing', 'x_DEPARTMENT', 'DEPARTMENT', '`DEPARTMENT`', '`DEPARTMENT`', 200, 50, -1, false, '`DEPARTMENT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("MasServicesBillingList");
        }
    }
