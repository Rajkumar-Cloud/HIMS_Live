...
class PharmacyCombination extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // GENCODE
        $this->GENCODE = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_GENCODE', 'GENCODE', '`GENCODE`', '`GENCODE`', 200, 5, -1, false, '`GENCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENCODE->Sortable = true; // Allow sort
        $this->Fields['GENCODE'] = &$this->GENCODE;

        // COMBCODE
        $this->COMBCODE = new DbField('pharmacy_combination', 'pharmacy_combination', 'x_COMBCODE', 'COMBCODE', '`COMBCODE`', '`COMBCODE`', 200, 5, -1, false, '`COMBCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PharmacyCombinationList");
        }
    }
