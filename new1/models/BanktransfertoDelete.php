 ...
 * Page class
 */
class BanktransfertoDelete extends Banktransferto
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "BanktransfertoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BanktransfertoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BanktransfertoList"); // Return to list
                return;
            }
        }
