...
class Patient extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // title
        $this->title = new DbField('patient', 'patient', 'x_title', 'title', '`title`', '`title`', 3, 11, -1, false, '`title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // gender
        $this->gender = new DbField('patient', 'patient', 'x_gender', 'gender', '`gender`', '`gender`', 200, 45, -1, false, '`gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->gender->Sortable = true; // Allow sort
        $this->Fields['gender'] = &$this->gender;

        // dob
        $this->dob = new DbField('patient', 'patient', 'x_dob', 'dob', '`dob`', CastDateFieldForLike("`dob`", 0, "DB"), 133, 10, 0, false, '`dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // blood_group
        $this->blood_group = new DbField('patient', 'patient', 'x_blood_group', 'blood_group', '`blood_group`', '`blood_group`', 200, 45, -1, false, '`blood_group`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // description
        $this->description = new DbField('patient', 'patient', 'x_description', 'description', '`description`', '`description`', 201, 65535, -1, false, '`description`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // profilePic
        $this->profilePic = new DbField('patient', 'patient', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 200, 100, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->profilePic->Sortable = true; // Allow sort
        $this->Fields['profilePic'] = &$this->profilePic;

        // status
        $this->status = new DbField('patient', 'patient', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReferedByDr
        $this->ReferedByDr = new DbField('patient', 'patient', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, 45, -1, false, '`ReferedByDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->ReferA4TreatingConsultant = new DbField('patient', 'patient', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, 45, -1, false, '`ReferA4TreatingConsultant`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_title
        $this->spouse_title = new DbField('patient', 'patient', 'x_spouse_title', 'spouse_title', '`spouse_title`', '`spouse_title`', 200, 45, -1, false, '`spouse_title`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_gender
        $this->spouse_gender = new DbField('patient', 'patient', 'x_spouse_gender', 'spouse_gender', '`spouse_gender`', '`spouse_gender`', 200, 45, -1, false, '`spouse_gender`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->spouse_gender->Sortable = true; // Allow sort
        $this->Fields['spouse_gender'] = &$this->spouse_gender;

        // spouse_dob
        $this->spouse_dob = new DbField('patient', 'patient', 'x_spouse_dob', 'spouse_dob', '`spouse_dob`', CastDateFieldForLike("`spouse_dob`", 0, "DB"), 133, 10, 0, false, '`spouse_dob`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spouse_blood_group
        $this->spouse_blood_group = new DbField('patient', 'patient', 'x_spouse_blood_group', 'spouse_blood_group', '`spouse_blood_group`', '`spouse_blood_group`', 200, 45, -1, false, '`spouse_blood_group`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Maritalstatus
        $this->Maritalstatus = new DbField('patient', 'patient', 'x_Maritalstatus', 'Maritalstatus', '`Maritalstatus`', '`Maritalstatus`', 200, 45, -1, false, '`Maritalstatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Patient_Language
        $this->Patient_Language = new DbField('patient', 'patient', 'x_Patient_Language', 'Patient_Language', '`Patient_Language`', '`Patient_Language`', 200, 45, -1, false, '`Patient_Language`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WhereDidYouHear
        $this->WhereDidYouHear = new DbField('patient', 'patient', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, 45, -1, false, '`WhereDidYouHear`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->WhereDidYouHear->Sortable = true; // Allow sort
        $this->Fields['WhereDidYouHear'] = &$this->WhereDidYouHear;

        // HospID
        $this->HospID = new DbField('patient', 'patient', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
