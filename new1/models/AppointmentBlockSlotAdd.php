 ...
 * Page class
 */
class AppointmentBlockSlotAdd extends AppointmentBlockSlot
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "AppointmentBlockSlotAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AppointmentBlockSlotView") {
