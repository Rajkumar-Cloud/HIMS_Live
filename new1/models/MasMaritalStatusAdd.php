 ...
 * Page class
 */
class MasMaritalStatusAdd extends MasMaritalStatus
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "MasMaritalStatusAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("MasMaritalStatusList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MasMaritalStatusList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MasMaritalStatusView") {
