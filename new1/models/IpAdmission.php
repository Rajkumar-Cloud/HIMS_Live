 ...
 */
class IpAdmission extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // patient_id
        $this->patient_id = new DbField('ip_admission', 'ip_admission', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, 11, -1, false, '`patient_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // physician_id
        $this->physician_id = new DbField('ip_admission', 'ip_admission', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, 11, -1, false, '`physician_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // typeRegsisteration
        $this->typeRegsisteration = new DbField('ip_admission', 'ip_admission', 'x_typeRegsisteration', 'typeRegsisteration', '`typeRegsisteration`', '`typeRegsisteration`', 200, 45, -1, false, '`typeRegsisteration`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->typeRegsisteration->Sortable = true; // Allow sort
        $this->Fields['typeRegsisteration'] = &$this->typeRegsisteration;

        // PaymentCategory
        $this->PaymentCategory = new DbField('ip_admission', 'ip_admission', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, 45, -1, false, '`PaymentCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PaymentCategory->Sortable = true; // Allow sort
        $this->Fields['PaymentCategory'] = &$this->PaymentCategory;

        // admission_consultant_id
        $this->admission_consultant_id = new DbField('ip_admission', 'ip_admission', 'x_admission_consultant_id', 'admission_consultant_id', '`admission_consultant_id`', '`admission_consultant_id`', 3, 11, -1, false, '`admission_consultant_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->leading_consultant_id = new DbField('ip_admission', 'ip_admission', 'x_leading_consultant_id', 'leading_consultant_id', '`leading_consultant_id`', '`leading_consultant_id`', 3, 11, -1, false, '`leading_consultant_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // admission_date
        $this->admission_date = new DbField('ip_admission', 'ip_admission', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike("`admission_date`", 0, "DB"), 135, 19, 0, false, '`admission_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // release_date
        $this->release_date = new DbField('ip_admission', 'ip_admission', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike("`release_date`", 0, "DB"), 135, 19, 0, false, '`release_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentStatus
        $this->PaymentStatus = new DbField('ip_admission', 'ip_admission', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, 11, -1, false, '`PaymentStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('ip_admission', 'ip_admission', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('ip_admission', 'ip_admission', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->Fields['HospID'] = &$this->HospID;

        // ReferedByDr
        $this->ReferedByDr = new DbField('ip_admission', 'ip_admission', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, 45, -1, false, '`ReferedByDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->ReferA4TreatingConsultant = new DbField('ip_admission', 'ip_admission', 'x_ReferA4TreatingConsultant', 'ReferA4TreatingConsultant', '`ReferA4TreatingConsultant`', '`ReferA4TreatingConsultant`', 200, 45, -1, false, '`ReferA4TreatingConsultant`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "IpAdmissionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "IpAdmissionAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("IpAdmissionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("IpAdmissionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "IpAdmissionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "IpAdmissionAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("IpAdmissionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("IpAdmissionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("IpAdmissionDelete", $this->getUrlParm());
    }
