...
class ViewGstOutputList extends ViewGstOutput
{
    ...
    public function run()
    {
        ...
        $this->IP_25_SGST->setVisibility();
        $this->IP_25_CGST->setVisibility();
        $this->IP_60_SGST->setVisibility();
        $this->IP_60_CGST->setVisibility();
        $this->IP_90_SGST->setVisibility();
        $this->IP_90_CGST->setVisibility();
        $this->IP_140_SGST->setVisibility();
        $this->IP_140_CGST->setVisibility();
        $this->OP_25_SGST->setVisibility();
        $this->OP_25_CGST->setVisibility();
        $this->OP_60_SGST->setVisibility();
        $this->OP_60_CGST->setVisibility();
        $this->OP_90_SGST->setVisibility();
        $this->OP_90_CGST->setVisibility();
        $this->OP_140_SGST->setVisibility();
        $this->OP_140_CGST->setVisibility();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->IP_25_SGST); // IP 2.5% SGST
            $this->updateSort($this->IP_25_CGST); // IP 2.5% CGST
            $this->updateSort($this->IP_60_SGST); // IP 6.0% SGST
            $this->updateSort($this->IP_60_CGST); // IP 6.0% CGST
            $this->updateSort($this->IP_90_SGST); // IP 9.0% SGST
            $this->updateSort($this->IP_90_CGST); // IP 9.0% CGST
            $this->updateSort($this->IP_140_SGST); // IP 14.0% SGST
            $this->updateSort($this->IP_140_CGST); // IP 14.0% CGST
            $this->updateSort($this->OP_25_SGST); // OP 2.5% SGST
            $this->updateSort($this->OP_25_CGST); // OP 2.5% CGST
            $this->updateSort($this->OP_60_SGST); // OP 6.0% SGST
            $this->updateSort($this->OP_60_CGST); // OP 6.0% CGST
            $this->updateSort($this->OP_90_SGST); // OP 9.0% SGST
            $this->updateSort($this->OP_90_CGST); // OP 9.0% CGST
            $this->updateSort($this->OP_140_SGST); // OP 14.0% SGST
            $this->updateSort($this->OP_140_CGST); // OP 14.0% CGST
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->IP_25_SGST->setSort("");
                $this->IP_25_CGST->setSort("");
                $this->IP_60_SGST->setSort("");
                $this->IP_60_CGST->setSort("");
                $this->IP_90_SGST->setSort("");
                $this->IP_90_CGST->setSort("");
                $this->IP_140_SGST->setSort("");
                $this->IP_140_CGST->setSort("");
                $this->OP_25_SGST->setSort("");
                $this->OP_25_CGST->setSort("");
                $this->OP_60_SGST->setSort("");
                $this->OP_60_CGST->setSort("");
                $this->OP_90_SGST->setSort("");
                $this->OP_90_CGST->setSort("");
                $this->OP_140_SGST->setSort("");
                $this->OP_140_CGST->setSort("");
                $this->HosoID->setSort("");
            }
    ...
    public function renderRow()
    {
        ...
        if ($this->IP_25_SGST->FormValue == $this->IP_25_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_25_SGST->CurrentValue))) {
            $this->IP_25_SGST->CurrentValue = ConvertToFloatString($this->IP_25_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_25_CGST->FormValue == $this->IP_25_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_25_CGST->CurrentValue))) {
            $this->IP_25_CGST->CurrentValue = ConvertToFloatString($this->IP_25_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_60_SGST->FormValue == $this->IP_60_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_60_SGST->CurrentValue))) {
            $this->IP_60_SGST->CurrentValue = ConvertToFloatString($this->IP_60_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_60_CGST->FormValue == $this->IP_60_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_60_CGST->CurrentValue))) {
            $this->IP_60_CGST->CurrentValue = ConvertToFloatString($this->IP_60_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_90_SGST->FormValue == $this->IP_90_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_90_SGST->CurrentValue))) {
            $this->IP_90_SGST->CurrentValue = ConvertToFloatString($this->IP_90_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_90_CGST->FormValue == $this->IP_90_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_90_CGST->CurrentValue))) {
            $this->IP_90_CGST->CurrentValue = ConvertToFloatString($this->IP_90_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_140_SGST->FormValue == $this->IP_140_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_140_SGST->CurrentValue))) {
            $this->IP_140_SGST->CurrentValue = ConvertToFloatString($this->IP_140_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->IP_140_CGST->FormValue == $this->IP_140_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->IP_140_CGST->CurrentValue))) {
            $this->IP_140_CGST->CurrentValue = ConvertToFloatString($this->IP_140_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_25_SGST->FormValue == $this->OP_25_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_25_SGST->CurrentValue))) {
            $this->OP_25_SGST->CurrentValue = ConvertToFloatString($this->OP_25_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_25_CGST->FormValue == $this->OP_25_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_25_CGST->CurrentValue))) {
            $this->OP_25_CGST->CurrentValue = ConvertToFloatString($this->OP_25_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_60_SGST->FormValue == $this->OP_60_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_60_SGST->CurrentValue))) {
            $this->OP_60_SGST->CurrentValue = ConvertToFloatString($this->OP_60_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_60_CGST->FormValue == $this->OP_60_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_60_CGST->CurrentValue))) {
            $this->OP_60_CGST->CurrentValue = ConvertToFloatString($this->OP_60_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_90_SGST->FormValue == $this->OP_90_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_90_SGST->CurrentValue))) {
            $this->OP_90_SGST->CurrentValue = ConvertToFloatString($this->OP_90_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_90_CGST->FormValue == $this->OP_90_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_90_CGST->CurrentValue))) {
            $this->OP_90_CGST->CurrentValue = ConvertToFloatString($this->OP_90_CGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_140_SGST->FormValue == $this->OP_140_SGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_140_SGST->CurrentValue))) {
            $this->OP_140_SGST->CurrentValue = ConvertToFloatString($this->OP_140_SGST->CurrentValue);
        }

        // Convert decimal values if posted back
        if ($this->OP_140_CGST->FormValue == $this->OP_140_CGST->CurrentValue && is_numeric(ConvertToFloatString($this->OP_140_CGST->CurrentValue))) {
            $this->OP_140_CGST->CurrentValue = ConvertToFloatString($this->OP_140_CGST->CurrentValue);
        }
