 ...
 * Page class
 */
class IvfSemenanalysisreportList extends IvfSemenanalysisreport
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "IvfSemenanalysisreportList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "IvfSemenanalysisreportDelete";
        $this->MultiUpdateUrl = "IvfSemenanalysisreportUpdate";
