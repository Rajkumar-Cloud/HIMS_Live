 ...
 * Page class
 */
class PatientDocumentEdit extends PatientDocument
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "PatientDocumentEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // DocumentUpload
            $this->DocumentUpload->setDbValueDef($rsnew, $this->DocumentUpload->CurrentValue, "", $this->DocumentUpload->ReadOnly);
