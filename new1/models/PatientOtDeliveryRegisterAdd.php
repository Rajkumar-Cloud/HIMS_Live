 ...
 * Page class
 */
class PatientOtDeliveryRegisterAdd extends PatientOtDeliveryRegister
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "PatientOtDeliveryRegisterAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PatientOtDeliveryRegisterView") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'ObstetricsHistryMale' first before field var 'x_ObstetricsHistryMale'
        $val = $CurrentForm->hasValue("ObstetricsHistryMale") ? $CurrentForm->getValue("ObstetricsHistryMale") : $CurrentForm->getValue("x_ObstetricsHistryMale");
        if (!$this->ObstetricsHistryMale->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->ObstetricsHistryMale->Visible = false; // Disable update for API request
            } else {
                $this->ObstetricsHistryMale->setFormValue($val);
            }
        }
        ...
        if (!$this->ChildBirthDate->IsDetailKey) {
            ...
            $this->ChildBirthDate->CurrentValue = UnFormatDateTime($this->ChildBirthDate->CurrentValue, 0);
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->ObstetricsHistryMale->CurrentValue = $this->ObstetricsHistryMale->FormValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->ObstetricsHistryMale->EditValue = HtmlEncode($this->ObstetricsHistryMale->CurrentValue);
            ...
            $this->ChildBirthDate->EditValue = HtmlEncode(FormatDateTime($this->ChildBirthDate->CurrentValue, 8));
            ...
            $this->DrVisit1->EditValue = HtmlEncode($this->DrVisit1->CurrentValue);
            ...
            $this->DrVisit2->EditValue = HtmlEncode($this->DrVisit2->CurrentValue);
            ...
            $this->DrVisit3->EditValue = HtmlEncode($this->DrVisit3->CurrentValue);
            ...
            $this->DrVisit4->EditValue = HtmlEncode($this->DrVisit4->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->ObstetricsHistryMale->Required) {
            if (!$this->ObstetricsHistryMale->IsDetailKey && EmptyValue($this->ObstetricsHistryMale->FormValue)) {
                $this->ObstetricsHistryMale->addErrorMessage(str_replace("%s", $this->ObstetricsHistryMale->caption(), $this->ObstetricsHistryMale->RequiredErrorMessage));
            }
        }
        ...
        if (!CheckDate($this->ChildBirthDate->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // ObstetricsHistryMale
        $this->ObstetricsHistryMale->setDbValueDef($rsnew, $this->ObstetricsHistryMale->CurrentValue, null, false);
        ...
        // ChildBirthDate
        $this->ChildBirthDate->setDbValueDef($rsnew, UnFormatDateTime($this->ChildBirthDate->CurrentValue, 0), null, false);
        ...
        // TypeofDelivery
        $this->TypeofDelivery->setDbValueDef($rsnew, $this->TypeofDelivery->CurrentValue, null, false);
        ...
        // TypeofDelivery1
        $this->TypeofDelivery1->setDbValueDef($rsnew, $this->TypeofDelivery1->CurrentValue, null, false);
        ...
        // RecievedTime
        $this->RecievedTime->setDbValueDef($rsnew, UnFormatDateTime($this->RecievedTime->CurrentValue, 0), null, false);

        // AnaesthesiaStarted
        $this->AnaesthesiaStarted->setDbValueDef($rsnew, UnFormatDateTime($this->AnaesthesiaStarted->CurrentValue, 0), null, false);

        // AnaesthesiaEnded
        $this->AnaesthesiaEnded->setDbValueDef($rsnew, UnFormatDateTime($this->AnaesthesiaEnded->CurrentValue, 0), null, false);

        // surgeryStarted
        $this->surgeryStarted->setDbValueDef($rsnew, UnFormatDateTime($this->surgeryStarted->CurrentValue, 0), null, false);

        // surgeryEnded
        $this->surgeryEnded->setDbValueDef($rsnew, UnFormatDateTime($this->surgeryEnded->CurrentValue, 0), null, false);

        // RecoveryTime
        $this->RecoveryTime->setDbValueDef($rsnew, UnFormatDateTime($this->RecoveryTime->CurrentValue, 0), null, false);

        // ShiftedTime
        $this->ShiftedTime->setDbValueDef($rsnew, UnFormatDateTime($this->ShiftedTime->CurrentValue, 0), null, false);

        // Duration
        $this->Duration->setDbValueDef($rsnew, $this->Duration->CurrentValue, null, false);

        // DrVisit1
        $this->DrVisit1->setDbValueDef($rsnew, $this->DrVisit1->CurrentValue, null, false);

        // DrVisit2
        $this->DrVisit2->setDbValueDef($rsnew, $this->DrVisit2->CurrentValue, null, false);

        // DrVisit3
        $this->DrVisit3->setDbValueDef($rsnew, $this->DrVisit3->CurrentValue, null, false);

        // DrVisit4
        $this->DrVisit4->setDbValueDef($rsnew, $this->DrVisit4->CurrentValue, null, false);
