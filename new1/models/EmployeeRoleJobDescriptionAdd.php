 ...
 * Page class
 */
class EmployeeRoleJobDescriptionAdd extends EmployeeRoleJobDescription
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "EmployeeRoleJobDescriptionAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmployeeRoleJobDescriptionList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmployeeRoleJobDescriptionList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmployeeRoleJobDescriptionView") {
