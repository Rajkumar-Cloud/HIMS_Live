 ...
 * Page class
 */
class IvfOocytedenudationStageEdit extends IvfOocytedenudationStage
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "IvfOocytedenudationStageEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("IvfOocytedenudationStageList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "IvfOocytedenudationStageList") {
    ...
    protected function validateForm()
    {
        ...
        if ($this->OidNo->Required) {
            if (!$this->OidNo->IsDetailKey && EmptyValue($this->OidNo->FormValue)) {
                $this->OidNo->addErrorMessage(str_replace("%s", $this->OidNo->caption(), $this->OidNo->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->OidNo->FormValue)) {
            $this->OidNo->addErrorMessage($this->OidNo->getErrorMessage(false));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // OidNo
            $this->OidNo->setDbValueDef($rsnew, $this->OidNo->CurrentValue, null, $this->OidNo->ReadOnly);
