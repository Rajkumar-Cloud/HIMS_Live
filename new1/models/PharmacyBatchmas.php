...
class PharmacyBatchmas extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // BRCODE
        $this->BRCODE = new DbField('pharmacy_batchmas', 'pharmacy_batchmas', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PharmacyBatchmasList");
        }
    }
