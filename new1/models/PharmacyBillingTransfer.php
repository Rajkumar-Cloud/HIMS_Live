...
class PharmacyBillingTransfer extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // transfer
        $this->transfer = new DbField('pharmacy_billing_transfer', 'pharmacy_billing_transfer', 'x_transfer', 'transfer', '`transfer`', '`transfer`', 3, 11, -1, false, '`transfer`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // street
        $this->street = new DbField('pharmacy_billing_transfer', 'pharmacy_billing_transfer', 'x_street', 'street', '`street`', '`street`', 201, 450, -1, false, '`street`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->street->Sortable = true; // Allow sort
        $this->Fields['street'] = &$this->street;

        // area
        $this->area = new DbField('pharmacy_billing_transfer', 'pharmacy_billing_transfer', 'x_area', 'area', '`area`', '`area`', 201, 450, -1, false, '`area`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->area->Sortable = true; // Allow sort
        $this->Fields['area'] = &$this->area;

        // town
        $this->town = new DbField('pharmacy_billing_transfer', 'pharmacy_billing_transfer', 'x_town', 'town', '`town`', '`town`', 201, 450, -1, false, '`town`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PharmacyBillingTransferList");
        }
    }
