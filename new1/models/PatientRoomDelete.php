 ...
 * Page class
 */
class PatientRoomDelete extends PatientRoom
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PatientRoomDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientRoomList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientRoomList"); // Return to list
                return;
            }
        }
