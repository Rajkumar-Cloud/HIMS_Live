 ...
 * Page class
 */
class BillingVoucherAdd extends BillingVoucher
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "BillingVoucherAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "BillingVoucherView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // createdDatettime
        $this->createdDatettime->setDbValueDef($rsnew, UnFormatDateTime($this->createdDatettime->CurrentValue, 0), null, false);
