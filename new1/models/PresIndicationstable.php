...
class PresIndicationstable extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Indications
        $this->Indications = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Indications', 'Indications', '`Indications`', '`Indications`', 201, -1, -1, false, '`Indications`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Contraindications
        $this->Contraindications = new DbField('pres_indicationstable', 'pres_indicationstable', 'x_Contraindications', 'Contraindications', '`Contraindications`', '`Contraindications`', 201, -1, -1, false, '`Contraindications`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PresIndicationstableList");
        }
    }
