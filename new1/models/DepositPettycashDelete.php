 ...
 * Page class
 */
class DepositPettycashDelete extends DepositPettycash
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "DepositPettycashDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DepositPettycashList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DepositPettycashList"); // Return to list
                return;
            }
        }
