 ...
 * Page class
 */
class PharmacyBillingIssueDelete extends PharmacyBillingIssue
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingIssueDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyBillingIssueList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyBillingIssueList"); // Return to list
                return;
            }
        }
