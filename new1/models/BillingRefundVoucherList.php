 ...
 * Page class
 */
class BillingRefundVoucherList extends BillingRefundVoucher
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "BillingRefundVoucherList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "BillingRefundVoucherAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "BillingRefundVoucherDelete";
        $this->MultiUpdateUrl = "BillingRefundVoucherUpdate";
