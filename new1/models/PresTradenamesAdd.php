 ...
 * Page class
 */
class PresTradenamesAdd extends PresTradenames
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "PresTradenamesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("PresTradenamesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PresTradenamesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PresTradenamesView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->GENERIC_NAMES->CurrentValue = null;
        $this->GENERIC_NAMES->OldValue = $this->GENERIC_NAMES->CurrentValue;
        ...
        $this->GenericNames_symbols->CurrentValue = null;
        $this->GenericNames_symbols->OldValue = $this->GenericNames_symbols->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['GENERIC_NAMES'] = $this->GENERIC_NAMES->CurrentValue;
        ...
        $row['GenericNames_symbols'] = $this->GenericNames_symbols->CurrentValue;
    ...
    protected function validateForm()
    {
        ...
        if ($this->GENERIC_NAMES->Required) {
            if (!$this->GENERIC_NAMES->IsDetailKey && EmptyValue($this->GENERIC_NAMES->FormValue)) {
                $this->GENERIC_NAMES->addErrorMessage(str_replace("%s", $this->GENERIC_NAMES->caption(), $this->GENERIC_NAMES->RequiredErrorMessage));
            }
        }
        ...
        if ($this->GenericNames_symbols->Required) {
            if (!$this->GenericNames_symbols->IsDetailKey && EmptyValue($this->GenericNames_symbols->FormValue)) {
                $this->GenericNames_symbols->addErrorMessage(str_replace("%s", $this->GenericNames_symbols->caption(), $this->GenericNames_symbols->RequiredErrorMessage));
            }
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // GENERIC_NAMES
        $this->GENERIC_NAMES->setDbValueDef($rsnew, $this->GENERIC_NAMES->CurrentValue, null, false);

        // TRADE_NAME
        $this->TRADE_NAME->setDbValueDef($rsnew, $this->TRADE_NAME->CurrentValue, null, false);

        // Drug_Name
        $this->Drug_Name->setDbValueDef($rsnew, $this->Drug_Name->CurrentValue, null, false);

        // PR_CODE
        $this->PR_CODE->setDbValueDef($rsnew, $this->PR_CODE->CurrentValue, null, false);

        // GenericNames_symbols
        $this->GenericNames_symbols->setDbValueDef($rsnew, $this->GenericNames_symbols->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PresTradenamesList"), "", $this->TableVar, true);
