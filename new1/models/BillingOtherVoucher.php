...
class BillingOtherVoucher extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatID
        $this->PatID = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_PatID', 'PatID', '`PatID`', '`PatID`', 3, 11, -1, false, '`PatID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VisitDate
        $this->VisitDate = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_VisitDate', 'VisitDate', '`VisitDate`', CastDateFieldForLike("`VisitDate`", 0, "DB"), 135, 19, 0, false, '`VisitDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Date
        $this->Date = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_Date', 'Date', '`Date`', CastDateFieldForLike("`Date`", 0, "DB"), 135, 19, 0, false, '`Date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelAdvance
        $this->CancelAdvance = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelAdvance', 'CancelAdvance', '`CancelAdvance`', '`CancelAdvance`', 200, 45, -1, false, '`CancelAdvance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelDate
        $this->CancelDate = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelDate', 'CancelDate', '`CancelDate`', CastDateFieldForLike("`CancelDate`", 0, "DB"), 135, 19, 0, false, '`CancelDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CancelStatus
        $this->CancelStatus = new DbField('billing_other_voucher', 'billing_other_voucher', 'x_CancelStatus', 'CancelStatus', '`CancelStatus`', '`CancelStatus`', 200, 45, -1, false, '`CancelStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("BillingOtherVoucherList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->CancelDate->EditValue = FormatDateTime($this->CancelDate->CurrentValue, 8);
