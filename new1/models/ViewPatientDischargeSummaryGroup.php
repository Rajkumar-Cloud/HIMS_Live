...
class ViewPatientDischargeSummaryGroup extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // profilePic
        $this->profilePic = new DbField('view_patient_discharge_summary_group', 'view_patient_discharge_summary_group', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // physician_id
        $this->physician_id = new DbField('view_patient_discharge_summary_group', 'view_patient_discharge_summary_group', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, 11, -1, false, '`physician_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPatientDischargeSummaryGroupList");
        }
    }
