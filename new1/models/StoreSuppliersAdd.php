 ...
 * Page class
 */
class StoreSuppliersAdd extends StoreSuppliers
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "StoreSuppliersAdd";
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if ($pageName != $this->getListUrl()) { // Not List page
                    ...
                    if ($pageName == "StoreSuppliersView") {
                        $row["view"] = "1";
                    }
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("StoreSuppliersList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "StoreSuppliersList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "StoreSuppliersView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Citycode
        $this->Citycode->setDbValueDef($rsnew, $this->Citycode->CurrentValue, null, false);
        ...
        // Tngstnumber
        $this->Tngstnumber->setDbValueDef($rsnew, $this->Tngstnumber->CurrentValue, null, false);
        ...
        // Paymentmode
        $this->Paymentmode->setDbValueDef($rsnew, $this->Paymentmode->CurrentValue, null, false);

        // Contactperson1
        $this->Contactperson1->setDbValueDef($rsnew, $this->Contactperson1->CurrentValue, null, false);

        // CP1Address1
        $this->CP1Address1->setDbValueDef($rsnew, $this->CP1Address1->CurrentValue, null, false);

        // CP1Address2
        $this->CP1Address2->setDbValueDef($rsnew, $this->CP1Address2->CurrentValue, null, false);

        // CP1Address3
        $this->CP1Address3->setDbValueDef($rsnew, $this->CP1Address3->CurrentValue, null, false);

        // CP1Citycode
        $this->CP1Citycode->setDbValueDef($rsnew, $this->CP1Citycode->CurrentValue, null, false);

        // CP1State
        $this->CP1State->setDbValueDef($rsnew, $this->CP1State->CurrentValue, null, false);

        // CP1Pincode
        $this->CP1Pincode->setDbValueDef($rsnew, $this->CP1Pincode->CurrentValue, null, false);

        // CP1Designation
        $this->CP1Designation->setDbValueDef($rsnew, $this->CP1Designation->CurrentValue, null, false);

        // CP1Phone
        $this->CP1Phone->setDbValueDef($rsnew, $this->CP1Phone->CurrentValue, null, false);

        // CP1MobileNo
        $this->CP1MobileNo->setDbValueDef($rsnew, $this->CP1MobileNo->CurrentValue, null, false);

        // CP1Fax
        $this->CP1Fax->setDbValueDef($rsnew, $this->CP1Fax->CurrentValue, null, false);

        // CP1Email
        $this->CP1Email->setDbValueDef($rsnew, $this->CP1Email->CurrentValue, null, false);

        // Contactperson2
        $this->Contactperson2->setDbValueDef($rsnew, $this->Contactperson2->CurrentValue, null, false);

        // CP2Address1
        $this->CP2Address1->setDbValueDef($rsnew, $this->CP2Address1->CurrentValue, null, false);

        // CP2Address2
        $this->CP2Address2->setDbValueDef($rsnew, $this->CP2Address2->CurrentValue, null, false);

        // CP2Address3
        $this->CP2Address3->setDbValueDef($rsnew, $this->CP2Address3->CurrentValue, null, false);

        // CP2Citycode
        $this->CP2Citycode->setDbValueDef($rsnew, $this->CP2Citycode->CurrentValue, null, false);

        // CP2State
        $this->CP2State->setDbValueDef($rsnew, $this->CP2State->CurrentValue, null, false);

        // CP2Pincode
        $this->CP2Pincode->setDbValueDef($rsnew, $this->CP2Pincode->CurrentValue, null, false);

        // CP2Designation
        $this->CP2Designation->setDbValueDef($rsnew, $this->CP2Designation->CurrentValue, null, false);

        // CP2Phone
        $this->CP2Phone->setDbValueDef($rsnew, $this->CP2Phone->CurrentValue, null, false);

        // CP2MobileNo
        $this->CP2MobileNo->setDbValueDef($rsnew, $this->CP2MobileNo->CurrentValue, null, false);

        // CP2Fax
        $this->CP2Fax->setDbValueDef($rsnew, $this->CP2Fax->CurrentValue, null, false);

        // CP2Email
        $this->CP2Email->setDbValueDef($rsnew, $this->CP2Email->CurrentValue, null, false);

        // Type
        $this->Type->setDbValueDef($rsnew, $this->Type->CurrentValue, null, false);

        // Creditterms
        $this->Creditterms->setDbValueDef($rsnew, $this->Creditterms->CurrentValue, null, false);

        // Remarks
        $this->Remarks->setDbValueDef($rsnew, $this->Remarks->CurrentValue, null, false);

        // Tinnumber
        $this->Tinnumber->setDbValueDef($rsnew, $this->Tinnumber->CurrentValue, null, false);

        // Universalsuppliercode
        $this->Universalsuppliercode->setDbValueDef($rsnew, $this->Universalsuppliercode->CurrentValue, null, false);

        // Mobilenumber
        $this->Mobilenumber->setDbValueDef($rsnew, $this->Mobilenumber->CurrentValue, null, false);

        // PANNumber
        $this->PANNumber->setDbValueDef($rsnew, $this->PANNumber->CurrentValue, null, false);

        // SalesRepMobileNo
        $this->SalesRepMobileNo->setDbValueDef($rsnew, $this->SalesRepMobileNo->CurrentValue, null, false);

        // GSTNumber
        $this->GSTNumber->setDbValueDef($rsnew, $this->GSTNumber->CurrentValue, null, false);

        // TANNumber
        $this->TANNumber->setDbValueDef($rsnew, $this->TANNumber->CurrentValue, null, false);
