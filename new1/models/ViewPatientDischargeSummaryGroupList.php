 ...
 * Page class
 */
class ViewPatientDischargeSummaryGroupList extends ViewPatientDischargeSummaryGroup
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "ViewPatientDischargeSummaryGroupList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewPatientDischargeSummaryGroupAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewPatientDischargeSummaryGroupDelete";
        $this->MultiUpdateUrl = "ViewPatientDischargeSummaryGroupUpdate";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("view_patient_discharge_summary_group"));
                $doc->Text = @$content;
