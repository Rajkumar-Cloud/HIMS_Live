...
class PatientOtDeliveryRegisterEdit extends PatientOtDeliveryRegister
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // ObstetricsHistryMale
            $this->ObstetricsHistryMale->setDbValueDef($rsnew, $this->ObstetricsHistryMale->CurrentValue, null, $this->ObstetricsHistryMale->ReadOnly);
            ...
            // ChildBirthDate
            $this->ChildBirthDate->setDbValueDef($rsnew, UnFormatDateTime($this->ChildBirthDate->CurrentValue, 0), null, $this->ChildBirthDate->ReadOnly);
