 ...
 * Page class
 */
class HospitalPharmacyDelete extends HospitalPharmacy
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "HospitalPharmacyDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("HospitalPharmacyList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("HospitalPharmacyList"); // Return to list
                return;
            }
        }
