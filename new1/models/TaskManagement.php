...
class TaskManagement extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // AssignTo
        $this->AssignTo = new DbField('task_management', 'task_management', 'x_AssignTo', 'AssignTo', '`AssignTo`', '`AssignTo`', 200, 45, -1, false, '`AssignTo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StartDate
        $this->StartDate = new DbField('task_management', 'task_management', 'x_StartDate', 'StartDate', '`StartDate`', CastDateFieldForLike("`StartDate`", 0, "DB"), 135, 19, 0, false, '`StartDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EndDate
        $this->EndDate = new DbField('task_management', 'task_management', 'x_EndDate', 'EndDate', '`EndDate`', CastDateFieldForLike("`EndDate`", 0, "DB"), 135, 19, 0, false, '`EndDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // StatusOfTask
        $this->StatusOfTask = new DbField('task_management', 'task_management', 'x_StatusOfTask', 'StatusOfTask', '`StatusOfTask`', '`StatusOfTask`', 200, 45, -1, false, '`StatusOfTask`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->StatusOfTask->Sortable = true; // Allow sort
        $this->Fields['StatusOfTask'] = &$this->StatusOfTask;

        // ForwardTo
        $this->ForwardTo = new DbField('task_management', 'task_management', 'x_ForwardTo', 'ForwardTo', '`ForwardTo`', '`ForwardTo`', 200, 45, -1, false, '`ForwardTo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("TaskManagementList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->AssignTo->EditValue = $this->AssignTo->CurrentValue;
        ...
        $this->StatusOfTask->EditValue = $this->StatusOfTask->CurrentValue;
        ...
        $this->ForwardTo->EditValue = $this->ForwardTo->CurrentValue;
        ...
        $this->GetModifiedName->EditValue = $this->GetModifiedName->CurrentValue;
