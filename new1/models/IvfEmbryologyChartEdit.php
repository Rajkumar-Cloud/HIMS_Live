 ...
 * Page class
 */
class IvfEmbryologyChartEdit extends IvfEmbryologyChart
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "IvfEmbryologyChartEdit";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Day3Grade->EditValue = HtmlEncode($this->Day3Grade->CurrentValue);
            ...
            $this->Day4Cryoptop->EditValue = HtmlEncode($this->Day4Cryoptop->CurrentValue);
            ...
            $this->Day5ICM->EditValue = HtmlEncode($this->Day5ICM->CurrentValue);
            ...
            $this->Day5TE->EditValue = HtmlEncode($this->Day5TE->CurrentValue);
            ...
            $this->Day5Grade->EditValue = HtmlEncode($this->Day5Grade->CurrentValue);
            ...
            $this->Day5Cryoptop->EditValue = HtmlEncode($this->Day5Cryoptop->CurrentValue);
            ...
            $this->Day6ICM->EditValue = HtmlEncode($this->Day6ICM->CurrentValue);
            ...
            $this->Day6TE->EditValue = HtmlEncode($this->Day6TE->CurrentValue);
            ...
            $this->Day6Collapsed->EditValue = HtmlEncode($this->Day6Collapsed->CurrentValue);
            ...
            $this->Day6Grade->EditValue = HtmlEncode($this->Day6Grade->CurrentValue);
            ...
            $this->EndingDay->EditValue = HtmlEncode($this->EndingDay->CurrentValue);
            ...
            $this->EndingGrade->EditValue = HtmlEncode($this->EndingGrade->CurrentValue);
            ...
            $this->EndingState->EditValue = HtmlEncode($this->EndingState->CurrentValue);
            ...
            $this->Day3End->EditValue = HtmlEncode($this->Day3End->CurrentValue);
            ...
            $this->vitriDay->EditValue = HtmlEncode($this->vitriDay->CurrentValue);
            ...
            $this->vitriGrade->EditValue = HtmlEncode($this->vitriGrade->CurrentValue);
            ...
            $this->ETDifficulty->EditValue = HtmlEncode($this->ETDifficulty->CurrentValue);
            ...
            $this->ETEasy->EditValue = HtmlEncode($this->ETEasy->CurrentValue);
            ...
            $this->Day2End->EditValue = HtmlEncode($this->Day2End->CurrentValue);
            ...
            $this->Day4End->EditValue = HtmlEncode($this->Day4End->CurrentValue);
            ...
            $this->Day1End->EditValue = HtmlEncode($this->Day1End->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->ETEasy->Required) {
            if (!$this->ETEasy->IsDetailKey && EmptyValue($this->ETEasy->FormValue)) {
