 ...
 * Page class
 */
class MasServicesBillingDelete extends MasServicesBilling
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "MasServicesBillingDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MasServicesBillingList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MasServicesBillingList"); // Return to list
                return;
            }
        }
