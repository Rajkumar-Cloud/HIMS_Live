 ...
 * Page class
 */
class IvfOocytedenudationStageAdd extends IvfOocytedenudationStage
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "IvfOocytedenudationStageAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "IvfOocytedenudationStageView") {
