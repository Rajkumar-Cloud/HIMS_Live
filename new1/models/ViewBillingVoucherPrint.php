 ...
 */
class ViewBillingVoucherPrint extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Reception
        $this->Reception = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatId
        $this->PatId = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefferedBy
        $this->RefferedBy = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, 45, -1, false, '`RefferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ReportHeader->Sortable = true; // Allow sort
        $this->Fields['ReportHeader'] = &$this->ReportHeader;

        // UserName
        $this->_UserName = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x__UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, false, '`UserName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_UserName->Sortable = true; // Allow sort
        $this->Fields['UserName'] = &$this->_UserName;

        // AdjustmentAdvance
        $this->AdjustmentAdvance = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_AdjustmentAdvance', 'AdjustmentAdvance', '`AdjustmentAdvance`', '`AdjustmentAdvance`', 200, 45, -1, false, '`AdjustmentAdvance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IncludePackage
        $this->IncludePackage = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_IncludePackage', 'IncludePackage', '`IncludePackage`', '`IncludePackage`', 200, 45, -1, false, '`IncludePackage`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IncludePackage->Sortable = true; // Allow sort
        $this->Fields['IncludePackage'] = &$this->IncludePackage;

        // CancelBill
        $this->CancelBill = new DbField('view_billing_voucher_print', 'view_billing_voucher_print', 'x_CancelBill', 'CancelBill', '`CancelBill`', '`CancelBill`', 200, 45, -1, false, '`CancelBill`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewBillingVoucherPrintList");
        }
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ViewBillingVoucherPrintEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewBillingVoucherPrintAdd") {
    ...
    {
        return "ViewBillingVoucherPrintList";
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewBillingVoucherPrintView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewBillingVoucherPrintView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewBillingVoucherPrintAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewBillingVoucherPrintAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBillingVoucherPrintEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewBillingVoucherPrintAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewBillingVoucherPrintDelete", $this->getUrlParm());
    }
