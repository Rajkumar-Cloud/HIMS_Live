...
class IvfOtherprocedureAdd extends IvfOtherprocedure
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // DateofAdmission
        $this->DateofAdmission->setDbValueDef($rsnew, UnFormatDateTime($this->DateofAdmission->CurrentValue, 0), null, false);

        // DateofProcedure
        $this->DateofProcedure->setDbValueDef($rsnew, UnFormatDateTime($this->DateofProcedure->CurrentValue, 0), null, false);

        // DateofDischarge
        $this->DateofDischarge->setDbValueDef($rsnew, UnFormatDateTime($this->DateofDischarge->CurrentValue, 0), null, false);
