 ...
 * Page class
 */
class BillingOtherVoucherDelete extends BillingOtherVoucher
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "BillingOtherVoucherDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BillingOtherVoucherList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BillingOtherVoucherList"); // Return to list
                return;
            }
        }
