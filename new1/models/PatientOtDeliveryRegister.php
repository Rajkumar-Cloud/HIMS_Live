...
class PatientOtDeliveryRegister extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->ObstetricsHistryMale->Sortable = true; // Allow sort
        ...
        // ChildBirthDate
        $this->ChildBirthDate = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_ChildBirthDate', 'ChildBirthDate', '`ChildBirthDate`', CastDateFieldForLike("`ChildBirthDate`", 0, "DB"), 135, 19, 0, false, '`ChildBirthDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ChildBirthDate->Sortable = true; // Allow sort
        $this->ChildBirthDate->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->Fields['ChildBirthDate'] = &$this->ChildBirthDate;

        // ChildBirthTime
        $this->ChildBirthTime = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_ChildBirthTime', 'ChildBirthTime', '`ChildBirthTime`', '`ChildBirthTime`', 200, 50, -1, false, '`ChildBirthTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RecievedTime
        $this->RecievedTime = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_RecievedTime', 'RecievedTime', '`RecievedTime`', CastDateFieldForLike("`RecievedTime`", 0, "DB"), 135, 19, 0, false, '`RecievedTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnaesthesiaStarted
        $this->AnaesthesiaStarted = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_AnaesthesiaStarted', 'AnaesthesiaStarted', '`AnaesthesiaStarted`', CastDateFieldForLike("`AnaesthesiaStarted`", 0, "DB"), 135, 19, 0, false, '`AnaesthesiaStarted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AnaesthesiaEnded
        $this->AnaesthesiaEnded = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_AnaesthesiaEnded', 'AnaesthesiaEnded', '`AnaesthesiaEnded`', CastDateFieldForLike("`AnaesthesiaEnded`", 0, "DB"), 135, 19, 0, false, '`AnaesthesiaEnded`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // surgeryStarted
        $this->surgeryStarted = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_surgeryStarted', 'surgeryStarted', '`surgeryStarted`', CastDateFieldForLike("`surgeryStarted`", 0, "DB"), 135, 19, 0, false, '`surgeryStarted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // surgeryEnded
        $this->surgeryEnded = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_surgeryEnded', 'surgeryEnded', '`surgeryEnded`', CastDateFieldForLike("`surgeryEnded`", 0, "DB"), 135, 19, 0, false, '`surgeryEnded`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RecoveryTime
        $this->RecoveryTime = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_RecoveryTime', 'RecoveryTime', '`RecoveryTime`', CastDateFieldForLike("`RecoveryTime`", 0, "DB"), 135, 19, 0, false, '`RecoveryTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ShiftedTime
        $this->ShiftedTime = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_ShiftedTime', 'ShiftedTime', '`ShiftedTime`', CastDateFieldForLike("`ShiftedTime`", 0, "DB"), 135, 19, 0, false, '`ShiftedTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrVisit1
        $this->DrVisit1 = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_DrVisit1', 'DrVisit1', '`DrVisit1`', '`DrVisit1`', 201, 500, -1, false, '`DrVisit1`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->DrVisit1->Sortable = true; // Allow sort
        $this->Fields['DrVisit1'] = &$this->DrVisit1;

        // DrVisit2
        $this->DrVisit2 = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_DrVisit2', 'DrVisit2', '`DrVisit2`', '`DrVisit2`', 201, 500, -1, false, '`DrVisit2`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->DrVisit2->Sortable = true; // Allow sort
        $this->Fields['DrVisit2'] = &$this->DrVisit2;

        // DrVisit3
        $this->DrVisit3 = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_DrVisit3', 'DrVisit3', '`DrVisit3`', '`DrVisit3`', 201, 500, -1, false, '`DrVisit3`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->DrVisit3->Sortable = true; // Allow sort
        $this->Fields['DrVisit3'] = &$this->DrVisit3;

        // DrVisit4
        $this->DrVisit4 = new DbField('patient_ot_delivery_register', 'patient_ot_delivery_register', 'x_DrVisit4', 'DrVisit4', '`DrVisit4`', '`DrVisit4`', 201, 500, -1, false, '`DrVisit4`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PatientOtDeliveryRegisterList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->ChildBirthDate->EditValue = FormatDateTime($this->ChildBirthDate->CurrentValue, 8);
        ...
        $this->DrVisit1->EditValue = $this->DrVisit1->CurrentValue;
        ...
        $this->DrVisit2->EditValue = $this->DrVisit2->CurrentValue;
        ...
        $this->DrVisit3->EditValue = $this->DrVisit3->CurrentValue;
        ...
        $this->DrVisit4->EditValue = $this->DrVisit4->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ObstetricsHistryMale);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ObstetricsHistryMale);
