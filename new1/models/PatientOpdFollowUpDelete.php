 ...
 * Page class
 */
class PatientOpdFollowUpDelete extends PatientOpdFollowUp
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PatientOpdFollowUpDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientOpdFollowUpList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientOpdFollowUpList"); // Return to list
                return;
            }
        }
