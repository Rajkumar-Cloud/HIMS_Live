...
class ViewIssuingSemen extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // PatientName
        $this->PatientName = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, false, '`PatientName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientName->Sortable = true; // Allow sort
        $this->Fields['PatientName'] = &$this->PatientName;

        // HusbandName
        $this->HusbandName = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_HusbandName', 'HusbandName', '`HusbandName`', '`HusbandName`', 200, 45, -1, false, '`HusbandName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IssuedTo
        $this->IssuedTo = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_IssuedTo', 'IssuedTo', '`IssuedTo`', '`IssuedTo`', 200, 45, -1, false, '`IssuedTo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IssuedTo->Sortable = true; // Allow sort
        $this->Fields['IssuedTo'] = &$this->IssuedTo;

        // RequestSample
        $this->RequestSample = new DbField('view_issuing_semen', 'view_issuing_semen', 'x_RequestSample', 'RequestSample', '`RequestSample`', '`RequestSample`', 200, 45, -1, false, '`RequestSample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIssuingSemenList");
        }
    }
