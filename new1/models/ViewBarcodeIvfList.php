 ...
 * Page class
 */
class ViewBarcodeIvfList extends ViewBarcodeIvf
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "ViewBarcodeIvfList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ViewBarcodeIvfAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ViewBarcodeIvfDelete";
        $this->MultiUpdateUrl = "ViewBarcodeIvfUpdate";
