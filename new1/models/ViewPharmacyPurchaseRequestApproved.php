...
class ViewPharmacyPurchaseRequestApproved extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ApprovedStatus
        $this->ApprovedStatus = new DbField('view_pharmacy_purchase_request_approved', 'view_pharmacy_purchase_request_approved', 'x_ApprovedStatus', 'ApprovedStatus', '`ApprovedStatus`', '`ApprovedStatus`', 200, 45, -1, false, '`ApprovedStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPharmacyPurchaseRequestApprovedList");
        }
    }
