 ...
 * Page class
 */
class EmployeeHasDegreeDelete extends EmployeeHasDegree
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "EmployeeHasDegreeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeeHasDegreeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeeHasDegreeList"); // Return to list
                return;
            }
        }
