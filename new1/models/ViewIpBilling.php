...
class ViewIpBilling extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // release_date
        $this->release_date = new DbField('view_ip_billing', 'view_ip_billing', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike("`release_date`", 0, "DB"), 135, 19, 0, false, '`release_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillClosing
        $this->BillClosing = new DbField('view_ip_billing', 'view_ip_billing', 'x_BillClosing', 'BillClosing', '`BillClosing`', '`BillClosing`', 200, 45, -1, false, '`BillClosing`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BillClosing->Sortable = true; // Allow sort
        $this->Fields['BillClosing'] = &$this->BillClosing;

        // BillClosingDate
        $this->BillClosingDate = new DbField('view_ip_billing', 'view_ip_billing', 'x_BillClosingDate', 'BillClosingDate', '`BillClosingDate`', CastDateFieldForLike("`BillClosingDate`", 0, "DB"), 135, 19, 0, false, '`BillClosingDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_ip_billing', 'view_ip_billing', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIpBillingList");
        }
    }
