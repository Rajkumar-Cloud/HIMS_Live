...
class ViewIpPatientAdmission extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // patient_id
        $this->patient_id = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, 11, -1, false, '`patient_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profilePic
        $this->profilePic = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_profilePic', 'profilePic', '`profilePic`', '`profilePic`', 201, 450, -1, false, '`profilePic`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // physician_id
        $this->physician_id = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_physician_id', 'physician_id', '`physician_id`', '`physician_id`', 3, 11, -1, false, '`physician_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // typeRegsisteration
        $this->typeRegsisteration = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_typeRegsisteration', 'typeRegsisteration', '`typeRegsisteration`', '`typeRegsisteration`', 200, 45, -1, false, '`typeRegsisteration`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->typeRegsisteration->Sortable = true; // Allow sort
        $this->Fields['typeRegsisteration'] = &$this->typeRegsisteration;

        // PaymentCategory
        $this->PaymentCategory = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, 45, -1, false, '`PaymentCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // admission_date
        $this->admission_date = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_admission_date', 'admission_date', '`admission_date`', CastDateFieldForLike("`admission_date`", 0, "DB"), 135, 19, 0, false, '`admission_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // release_date
        $this->release_date = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_release_date', 'release_date', '`release_date`', CastDateFieldForLike("`release_date`", 0, "DB"), 135, 19, 0, false, '`release_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentStatus
        $this->PaymentStatus = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, 11, -1, false, '`PaymentStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->HospID->Sortable = true; // Allow sort
        $this->Fields['HospID'] = &$this->HospID;

        // ReferedByDr
        $this->ReferedByDr = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_ReferedByDr', 'ReferedByDr', '`ReferedByDr`', '`ReferedByDr`', 200, 45, -1, false, '`ReferedByDr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillClosing
        $this->BillClosing = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_BillClosing', 'BillClosing', '`BillClosing`', '`BillClosing`', 200, 45, -1, false, '`BillClosing`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ReportHeader->Sortable = true; // Allow sort
        $this->Fields['ReportHeader'] = &$this->ReportHeader;

        // Procedure
        $this->Procedure = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_Procedure', 'Procedure', '`Procedure`', '`Procedure`', 200, 45, -1, false, '`Procedure`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Procedure->Sortable = true; // Allow sort
        $this->Fields['Procedure'] = &$this->Procedure;

        // Consultant
        $this->Consultant = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_Consultant', 'Consultant', '`Consultant`', '`Consultant`', 200, 45, -1, false, '`Consultant`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Consultant->Sortable = true; // Allow sort
        $this->Fields['Consultant'] = &$this->Consultant;

        // Anesthetist
        $this->Anesthetist = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_Anesthetist', 'Anesthetist', '`Anesthetist`', '`Anesthetist`', 200, 45, -1, false, '`Anesthetist`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Cid
        $this->Cid = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_Cid', 'Cid', '`Cid`', '`Cid`', 3, 11, -1, false, '`Cid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->AdviceToOtherHospital = new DbField('view_ip_patient_admission', 'view_ip_patient_admission', 'x_AdviceToOtherHospital', 'AdviceToOtherHospital', '`AdviceToOtherHospital`', '`AdviceToOtherHospital`', 200, 45, -1, false, '`AdviceToOtherHospital`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIpPatientAdmissionList");
        }
    }
