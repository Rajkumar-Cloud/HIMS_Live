 ...
 * Page class
 */
class ViewLabResultreleasedList extends ViewLabResultreleased
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "ViewLabResultreleasedList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "ViewLabResultreleasedDelete";
        $this->MultiUpdateUrl = "ViewLabResultreleasedUpdate";
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fview_lab_resultreleasedlistsrch", $filters);
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fview_lab_resultreleasedlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
