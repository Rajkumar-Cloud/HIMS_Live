...
class ViewItemReceived extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORDNO
        $this->ORDNO = new DbField('view_item_received', 'view_item_received', 'x_ORDNO', 'ORDNO', '`ORDNO`', '`ORDNO`', 200, 5, -1, false, '`ORDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ExpDate
        $this->ExpDate = new DbField('view_item_received', 'view_item_received', 'x_ExpDate', 'ExpDate', '`ExpDate`', CastDateFieldForLike("`ExpDate`", 0, "DB"), 135, 19, 0, false, '`ExpDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Disc
        $this->Disc = new DbField('view_item_received', 'view_item_received', 'x_Disc', 'Disc', '`Disc`', '`Disc`', 131, 12, -1, false, '`Disc`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRCODE
        $this->BRCODE = new DbField('view_item_received', 'view_item_received', 'x_BRCODE', 'BRCODE', '`BRCODE`', '`BRCODE`', 3, 11, -1, false, '`BRCODE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Received
        $this->Received = new DbField('view_item_received', 'view_item_received', 'x_Received', 'Received', '`Received`', '`Received`', 200, 45, -1, false, '`Received`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Received->Sortable = true; // Allow sort
        $this->Fields['Received'] = &$this->Received;

        // BillDate
        $this->BillDate = new DbField('view_item_received', 'view_item_received', 'x_BillDate', 'BillDate', '`BillDate`', CastDateFieldForLike("`BillDate`", 0, "DB"), 135, 19, 0, false, '`BillDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewItemReceivedList");
        }
    }
