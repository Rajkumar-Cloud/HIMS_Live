 ...
 * Page class
 */
class RoomMasterDelete extends RoomMaster
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "RoomMasterDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RoomMasterList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RoomMasterList"); // Return to list
                return;
            }
        }
