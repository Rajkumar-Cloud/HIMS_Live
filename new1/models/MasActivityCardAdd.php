 ...
 * Page class
 */
class MasActivityCardAdd extends MasActivityCard
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "MasActivityCardAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("MasActivityCardList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "MasActivityCardList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "MasActivityCardView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->Selected->EditValue = HtmlEncode($this->Selected->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->Selected->Required) {
            if (!$this->Selected->IsDetailKey && EmptyValue($this->Selected->FormValue)) {
