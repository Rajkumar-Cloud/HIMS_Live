...
class ViewTreatmendStatus extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // TreatmentStartDate
        $this->TreatmentStartDate = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_TreatmentStartDate', 'TreatmentStartDate', '`TreatmentStartDate`', CastDateFieldForLike("`TreatmentStartDate`", 0, "DB"), 135, 19, 0, false, '`TreatmentStartDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewTreatmendStatusList");
        }
    }
