 ...
 * Page class
 */
class PharmacyStoremastAdd extends PharmacyStoremast
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "PharmacyStoremastAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PharmacyStoremastView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->NEWRT->CurrentValue = 0.00;
        $this->NEWMRP->CurrentValue = 0.00;
        $this->NEWUR->CurrentValue = 0.00;
        $this->STATUS->CurrentValue = null;
        $this->STATUS->OldValue = $this->STATUS->CurrentValue;
        $this->RETNQTY->CurrentValue = 0.00;
        $this->KEMODISC->CurrentValue = null;
        $this->KEMODISC->OldValue = $this->KEMODISC->CurrentValue;
        $this->PATSALE->CurrentValue = 0.00;
        $this->ORGAN->CurrentValue = null;
        $this->ORGAN->OldValue = $this->ORGAN->CurrentValue;
        $this->OLDRQ->CurrentValue = 0.00;
        ...
        $this->STRENGTH->CurrentValue = 0000000000.00;
