 ...
 * Page class
 */
class PresTradenamesDelete extends PresTradenames
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PresTradenamesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PresTradenamesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PresTradenamesList"); // Return to list
                return;
            }
        }
