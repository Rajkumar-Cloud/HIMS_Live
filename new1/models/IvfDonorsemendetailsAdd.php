...
class IvfDonorsemendetailsAdd extends IvfDonorsemendetails
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->SkinColor->EditValue = HtmlEncode($this->SkinColor->CurrentValue);
            ...
            $this->EyeColor->EditValue = HtmlEncode($this->EyeColor->CurrentValue);
            ...
            $this->HairColor->EditValue = HtmlEncode($this->HairColor->CurrentValue);
