...
class HospitalStore extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // logo
        $this->logo = new DbField('hospital_store', 'hospital_store', 'x_logo', 'logo', '`logo`', '`logo`', 201, 450, -1, false, '`logo`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // status
        $this->status = new DbField('hospital_store', 'hospital_store', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospId
        $this->HospId = new DbField('hospital_store', 'hospital_store', 'x_HospId', 'HospId', '`HospId`', '`HospId`', 3, 11, -1, false, '`HospId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("HospitalStoreList");
        }
    }
