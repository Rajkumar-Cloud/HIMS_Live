...
class Reception extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // CATEGORY
        $this->CATEGORY = new DbField('reception', 'reception', 'x_CATEGORY', 'CATEGORY', '`CATEGORY`', '`CATEGORY`', 200, 45, -1, false, '`CATEGORY`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CATEGORY->Sortable = true; // Allow sort
        $this->Fields['CATEGORY'] = &$this->CATEGORY;

        // PROCEDURE
        $this->PROCEDURE = new DbField('reception', 'reception', 'x_PROCEDURE', 'PROCEDURE', '`PROCEDURE`', '`PROCEDURE`', 200, 45, -1, false, '`PROCEDURE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODE OF PAYMENT
        $this->MODE_OF_PAYMENT = new DbField('reception', 'reception', 'x_MODE_OF_PAYMENT', 'MODE OF PAYMENT', '`MODE OF PAYMENT`', '`MODE OF PAYMENT`', 200, 45, -1, false, '`MODE OF PAYMENT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->MODE_OF_PAYMENT->EditValue = $this->MODE_OF_PAYMENT->CurrentValue;
