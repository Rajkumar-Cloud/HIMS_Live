...
class AppointmentScheduler extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // start_date
        $this->start_date = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_start_date', 'start_date', '`start_date`', CastDateFieldForLike("`start_date`", 0, "DB"), 135, 19, 0, false, '`start_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // end_date
        $this->end_date = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_end_date', 'end_date', '`end_date`', CastDateFieldForLike("`end_date`", 0, "DB"), 135, 19, 0, false, '`end_date`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // patientID
        $this->patientID = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_patientID', 'patientID', '`patientID`', '`patientID`', 200, 45, -1, false, '`patientID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DoctorName
        $this->DoctorName = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_DoctorName', 'DoctorName', '`DoctorName`', '`DoctorName`', 200, 45, -1, false, '`DoctorName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_status', 'status', '`status`', '`status`', 200, 45, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // appointment_type
        $this->appointment_type = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_appointment_type', 'appointment_type', '`appointment_type`', '`appointment_type`', 200, 45, -1, false, '`appointment_type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->appointment_type->Sortable = true; // Allow sort
        $this->Fields['appointment_type'] = &$this->appointment_type;

        // Notified
        $this->Notified = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_Notified', 'Notified', '`Notified`', '`Notified`', 200, 45, -1, false, '`Notified`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientType
        $this->PatientType = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_PatientType', 'PatientType', '`PatientType`', '`PatientType`', 200, 45, -1, false, '`PatientType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PatientType->Sortable = true; // Allow sort
        $this->Fields['PatientType'] = &$this->PatientType;

        // Referal
        $this->Referal = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_Referal', 'Referal', '`Referal`', '`Referal`', 200, 45, -1, false, '`Referal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WhereDidYouHear
        $this->WhereDidYouHear = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_WhereDidYouHear', 'WhereDidYouHear', '`WhereDidYouHear`', '`WhereDidYouHear`', 200, 45, -1, false, '`WhereDidYouHear`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatientTypee
        $this->PatientTypee = new DbField('appointment_scheduler', 'appointment_scheduler', 'x_PatientTypee', 'PatientTypee', '`PatientTypee`', '`PatientTypee`', 200, 45, -1, false, '`PatientTypee`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("AppointmentSchedulerList");
        }
    }
