...
class MasUserTemplatePrescription extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // TemplateName
        $this->TemplateName = new DbField('mas_user_template_prescription', 'mas_user_template_prescription', 'x_TemplateName', 'TemplateName', '`TemplateName`', '`TemplateName`', 200, 45, -1, false, '`TemplateName`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PreRoute
        $this->PreRoute = new DbField('mas_user_template_prescription', 'mas_user_template_prescription', 'x_PreRoute', 'PreRoute', '`PreRoute`', '`PreRoute`', 200, 45, -1, false, '`PreRoute`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TimeOfTaking
        $this->TimeOfTaking = new DbField('mas_user_template_prescription', 'mas_user_template_prescription', 'x_TimeOfTaking', 'TimeOfTaking', '`TimeOfTaking`', '`TimeOfTaking`', 200, 45, -1, false, '`TimeOfTaking`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Status
        $this->Status = new DbField('mas_user_template_prescription', 'mas_user_template_prescription', 'x_Status', 'Status', '`Status`', '`Status`', 200, 45, -1, false, '`Status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("MasUserTemplatePrescriptionList");
        }
    }
