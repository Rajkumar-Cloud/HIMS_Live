...
class PharmacyList extends Pharmacy
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->op_id->AdvancedSearch->toJson(), ","); // Field op_id
        $filterList = Concat($filterList, $this->ip_id->AdvancedSearch->toJson(), ","); // Field ip_id
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpharmacylistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field op_id
        $this->op_id->AdvancedSearch->SearchValue = @$filter["x_op_id"];
        $this->op_id->AdvancedSearch->SearchOperator = @$filter["z_op_id"];
        $this->op_id->AdvancedSearch->SearchCondition = @$filter["v_op_id"];
        $this->op_id->AdvancedSearch->SearchValue2 = @$filter["y_op_id"];
        $this->op_id->AdvancedSearch->SearchOperator2 = @$filter["w_op_id"];
        $this->op_id->AdvancedSearch->save();

        // Field ip_id
        $this->ip_id->AdvancedSearch->SearchValue = @$filter["x_ip_id"];
        $this->ip_id->AdvancedSearch->SearchOperator = @$filter["z_ip_id"];
        $this->ip_id->AdvancedSearch->SearchCondition = @$filter["v_ip_id"];
        $this->ip_id->AdvancedSearch->SearchValue2 = @$filter["y_ip_id"];
        $this->ip_id->AdvancedSearch->SearchOperator2 = @$filter["w_ip_id"];
        $this->ip_id->AdvancedSearch->save();
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpharmacylistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
