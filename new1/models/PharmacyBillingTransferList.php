 ...
 * Page class
 */
class PharmacyBillingTransferList extends PharmacyBillingTransfer
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "PharmacyBillingTransferList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PharmacyBillingTransferAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PharmacyBillingTransferDelete";
        $this->MultiUpdateUrl = "PharmacyBillingTransferUpdate";
