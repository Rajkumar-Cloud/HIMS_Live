...
class ViewLabPrint extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Remarks
        $this->Remarks = new DbField('view_lab_print', 'view_lab_print', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 65535, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewLabPrintList");
        }
    }
