...
class ViewNextReviewDate extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // HospID
        $this->HospID = new DbField('view_next_review_date', 'view_next_review_date', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewNextReviewDateList");
        }
    }
