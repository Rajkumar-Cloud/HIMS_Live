 ...
 * Page class
 */
class EmployeeAddressAdd extends EmployeeAddress
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "EmployeeAddressAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmployeeAddressList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmployeeAddressList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmployeeAddressView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->address_type->EditValue = HtmlEncode($this->address_type->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->address_type->FormValue)) {
            $this->address_type->addErrorMessage($this->address_type->getErrorMessage(false));
        }
