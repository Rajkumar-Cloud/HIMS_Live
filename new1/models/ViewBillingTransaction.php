...
class ViewBillingTransaction extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Type
        $this->Type = new DbField('view_billing_transaction', 'view_billing_transaction', 'x_Type', 'Type', '`Type`', '`Type`', 200, 7, -1, false, '`Type`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_billing_transaction', 'view_billing_transaction', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewBillingTransactionList");
        }
    }
