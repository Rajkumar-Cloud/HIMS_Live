...
class EmployeeHasDegree extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // degree_id
        $this->degree_id = new DbField('employee_has_degree', 'employee_has_degree', 'x_degree_id', 'degree_id', '`degree_id`', '`degree_id`', 3, 11, -1, false, '`degree_id`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // certificates
        $this->certificates = new DbField('employee_has_degree', 'employee_has_degree', 'x_certificates', 'certificates', '`certificates`', '`certificates`', 200, 100, -1, false, '`certificates`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // others
        $this->_others = new DbField('employee_has_degree', 'employee_has_degree', 'x__others', 'others', '`others`', '`others`', 200, 100, -1, false, '`others`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('employee_has_degree', 'employee_has_degree', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->certificates->DbValue = $row['certificates'];
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("EmployeeHasDegreeList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->degree_id->EditValue = $this->degree_id->CurrentValue;
        ...
        $this->certificates->EditValue = $this->certificates->CurrentValue;
