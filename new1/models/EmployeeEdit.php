...
class EmployeeEdit extends Employee
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->employee_role_id->EditValue = HtmlEncode($this->employee_role_id->CurrentValue);
            ...
            $this->working_location->EditValue = HtmlEncode($this->working_location->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->tittle->FormValue)) {
            $this->tittle->addErrorMessage($this->tittle->getErrorMessage(false));
        }
        ...
        if ($this->employee_role_id->Required) {
            if (!$this->employee_role_id->IsDetailKey && EmptyValue($this->employee_role_id->FormValue)) {
                $this->employee_role_id->addErrorMessage(str_replace("%s", $this->employee_role_id->caption(), $this->employee_role_id->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->employee_role_id->FormValue)) {
            $this->employee_role_id->addErrorMessage($this->employee_role_id->getErrorMessage(false));
        }
        if ($this->default_shift_start->Required) {
            if (!$this->default_shift_start->IsDetailKey && EmptyValue($this->default_shift_start->FormValue)) {
                $this->default_shift_start->addErrorMessage(str_replace("%s", $this->default_shift_start->caption(), $this->default_shift_start->RequiredErrorMessage));
            }
        }
        if (!CheckTime($this->default_shift_start->FormValue)) {
            $this->default_shift_start->addErrorMessage($this->default_shift_start->getErrorMessage(false));
        }
        if ($this->default_shift_end->Required) {
            if (!$this->default_shift_end->IsDetailKey && EmptyValue($this->default_shift_end->FormValue)) {
                $this->default_shift_end->addErrorMessage(str_replace("%s", $this->default_shift_end->caption(), $this->default_shift_end->RequiredErrorMessage));
            }
        }
        if (!CheckTime($this->default_shift_end->FormValue)) {
            $this->default_shift_end->addErrorMessage($this->default_shift_end->getErrorMessage(false));
        }
        if ($this->working_days->Required) {
            if (!$this->working_days->IsDetailKey && EmptyValue($this->working_days->FormValue)) {
                $this->working_days->addErrorMessage(str_replace("%s", $this->working_days->caption(), $this->working_days->RequiredErrorMessage));
            }
        }
        if ($this->working_location->Required) {
            if (!$this->working_location->IsDetailKey && EmptyValue($this->working_location->FormValue)) {
                $this->working_location->addErrorMessage(str_replace("%s", $this->working_location->caption(), $this->working_location->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->working_location->FormValue)) {
            $this->working_location->addErrorMessage($this->working_location->getErrorMessage(false));
        }
