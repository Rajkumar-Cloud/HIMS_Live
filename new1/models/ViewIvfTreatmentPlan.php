...
class ViewIvfTreatmentPlan extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // RIDNO
        $this->RIDNO = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_RIDNO', 'RIDNO', '`RIDNO`', '`RIDNO`', 3, 11, -1, false, '`RIDNO`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // treatment_status
        $this->treatment_status = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_treatment_status', 'treatment_status', '`treatment_status`', '`treatment_status`', 200, 45, -1, false, '`treatment_status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->treatment_status->Sortable = true; // Allow sort
        $this->Fields['treatment_status'] = &$this->treatment_status;

        // ARTCYCLE
        $this->ARTCYCLE = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_ARTCYCLE', 'ARTCYCLE', '`ARTCYCLE`', '`ARTCYCLE`', 200, 45, -1, false, '`ARTCYCLE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ARTCYCLE->Sortable = true; // Allow sort
        $this->Fields['ARTCYCLE'] = &$this->ARTCYCLE;

        // RESULT
        $this->RESULT = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_RESULT', 'RESULT', '`RESULT`', '`RESULT`', 200, 45, -1, false, '`RESULT`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESULT->Sortable = true; // Allow sort
        $this->Fields['RESULT'] = &$this->RESULT;

        // status
        $this->status = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Treatment
        $this->Treatment = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 200, 45, -1, false, '`Treatment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TypeOfCycle
        $this->TypeOfCycle = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TypeOfCycle', 'TypeOfCycle', '`TypeOfCycle`', '`TypeOfCycle`', 200, 45, -1, false, '`TypeOfCycle`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TypeOfCycle->Sortable = true; // Allow sort
        $this->Fields['TypeOfCycle'] = &$this->TypeOfCycle;

        // SpermOrgin
        $this->SpermOrgin = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_SpermOrgin', 'SpermOrgin', '`SpermOrgin`', '`SpermOrgin`', 200, 45, -1, false, '`SpermOrgin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SpermOrgin->Sortable = true; // Allow sort
        $this->Fields['SpermOrgin'] = &$this->SpermOrgin;

        // State
        $this->State = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_State', 'State', '`State`', '`State`', 200, 45, -1, false, '`State`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MACS
        $this->MACS = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, 45, -1, false, '`MACS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PgdPlanning
        $this->PgdPlanning = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_PgdPlanning', 'PgdPlanning', '`PgdPlanning`', '`PgdPlanning`', 200, 45, -1, false, '`PgdPlanning`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MaleIndications
        $this->MaleIndications = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_MaleIndications', 'MaleIndications', '`MaleIndications`', '`MaleIndications`', 200, 45, -1, false, '`MaleIndications`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MaleIndications->Sortable = true; // Allow sort
        $this->Fields['MaleIndications'] = &$this->MaleIndications;

        // FemaleIndications
        $this->FemaleIndications = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_FemaleIndications', 'FemaleIndications', '`FemaleIndications`', '`FemaleIndications`', 200, 45, -1, false, '`FemaleIndications`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Heterotopic
        $this->Heterotopic = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_Heterotopic', 'Heterotopic', '`Heterotopic`', '`Heterotopic`', 200, 45, -1, false, '`Heterotopic`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Heterotopic->Sortable = true; // Allow sort
        $this->Fields['Heterotopic'] = &$this->Heterotopic;

        // TransferDFE
        $this->TransferDFE = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TransferDFE', 'TransferDFE', '`TransferDFE`', '`TransferDFE`', 200, 45, -1, false, '`TransferDFE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TineLapse
        $this->TineLapse = new DbField('view_ivf_treatment_plan', 'view_ivf_treatment_plan', 'x_TineLapse', 'TineLapse', '`TineLapse`', '`TineLapse`', 200, 45, -1, false, '`TineLapse`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIvfTreatmentPlanList");
        }
    }
