 ...
 * Page class
 */
class PatientPrescriptionDelete extends PatientPrescription
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PatientPrescriptionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientPrescriptionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientPrescriptionList"); // Return to list
                return;
            }
        }
