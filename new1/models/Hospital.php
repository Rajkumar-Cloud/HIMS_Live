...
class Hospital extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // logo
        $this->logo = new DbField('hospital', 'hospital', 'x_logo', 'logo', '`logo`', '`logo`', 201, 450, -1, false, '`logo`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // status
        $this->status = new DbField('hospital', 'hospital', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
