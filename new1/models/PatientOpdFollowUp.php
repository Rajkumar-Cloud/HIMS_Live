...
class PatientOpdFollowUp extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // NextReviewDate
        $this->NextReviewDate = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_NextReviewDate', 'NextReviewDate', '`NextReviewDate`', CastDateFieldForLike("`NextReviewDate`", 0, "DB"), 135, 19, 0, false, '`NextReviewDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ICSIAdvised
        $this->ICSIAdvised = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_ICSIAdvised', 'ICSIAdvised', '`ICSIAdvised`', '`ICSIAdvised`', 200, 45, -1, false, '`ICSIAdvised`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ICSIAdvised->Sortable = true; // Allow sort
        $this->Fields['ICSIAdvised'] = &$this->ICSIAdvised;

        // DeliveryRegistered
        $this->DeliveryRegistered = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_DeliveryRegistered', 'DeliveryRegistered', '`DeliveryRegistered`', '`DeliveryRegistered`', 200, 45, -1, false, '`DeliveryRegistered`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DeliveryRegistered->Sortable = true; // Allow sort
        $this->Fields['DeliveryRegistered'] = &$this->DeliveryRegistered;

        // EDD
        $this->EDD = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_EDD', 'EDD', '`EDD`', CastDateFieldForLike("`EDD`", 0, "DB"), 135, 19, 0, false, '`EDD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SerologyPositive
        $this->SerologyPositive = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_SerologyPositive', 'SerologyPositive', '`SerologyPositive`', '`SerologyPositive`', 200, 45, -1, false, '`SerologyPositive`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LMP
        $this->LMP = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_LMP', 'LMP', '`LMP`', CastDateFieldForLike("`LMP`", 0, "DB"), 135, 19, 0, false, '`LMP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ProcedureDateTime
        $this->ProcedureDateTime = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_ProcedureDateTime', 'ProcedureDateTime', '`ProcedureDateTime`', CastDateFieldForLike("`ProcedureDateTime`", 0, "DB"), 135, 19, 0, false, '`ProcedureDateTime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ICSIDate
        $this->ICSIDate = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_ICSIDate', 'ICSIDate', '`ICSIDate`', CastDateFieldForLike("`ICSIDate`", 0, "DB"), 135, 19, 0, false, '`ICSIDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // reportheader
        $this->reportheader = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_reportheader', 'reportheader', '`reportheader`', '`reportheader`', 200, 45, -1, false, '`reportheader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->reportheader->Sortable = true; // Allow sort
        $this->Fields['reportheader'] = &$this->reportheader;

        // PatientSearch
        $this->PatientSearch = new DbField('patient_opd_follow_up', 'patient_opd_follow_up', 'x_PatientSearch', 'PatientSearch', '`PatientSearch`', '`PatientSearch`', 200, 45, -1, false, '`PatientSearch`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PatientOpdFollowUpList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->PatientSearch->EditValue = $this->PatientSearch->CurrentValue;
