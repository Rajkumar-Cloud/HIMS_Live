...
class ViewPatientBilling extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Remarks
        $this->Remarks = new DbField('view_patient_billing', 'view_patient_billing', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 65535, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPatientBillingList");
        }
    }
