...
class PatientRoom extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Reception
        $this->Reception = new DbField('patient_room', 'patient_room', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RoomID
        $this->RoomID = new DbField('patient_room', 'patient_room', 'x_RoomID', 'RoomID', '`RoomID`', '`RoomID`', 3, 11, -1, false, '`RoomID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
