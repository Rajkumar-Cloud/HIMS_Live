 ...
 * Page class
 */
class IvfAgencyDelete extends IvfAgency
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "IvfAgencyDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IvfAgencyList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IvfAgencyList"); // Return to list
                return;
            }
        }
