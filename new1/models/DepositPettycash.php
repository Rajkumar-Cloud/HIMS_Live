...
class DepositPettycash extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // TransType
        $this->TransType = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_TransType', 'TransType', '`TransType`', '`TransType`', 200, 45, -1, false, '`TransType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AccoundHead
        $this->AccoundHead = new DbField('deposit_pettycash', 'deposit_pettycash', 'x_AccoundHead', 'AccoundHead', '`AccoundHead`', '`AccoundHead`', 200, 45, -1, false, '`AccoundHead`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("DepositPettycashList");
        }
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->TransType->EditValue = $this->TransType->CurrentValue;
        ...
        $this->AccoundHead->EditValue = $this->AccoundHead->CurrentValue;
