...
class ViewBillingVoucher extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Reception
        $this->Reception = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_Reception', 'Reception', '`Reception`', '`Reception`', 3, 11, -1, false, '`Reception`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ModeofPayment
        $this->ModeofPayment = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_ModeofPayment', 'ModeofPayment', '`ModeofPayment`', '`ModeofPayment`', 200, 45, -1, false, '`ModeofPayment`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // createddatetime
        $this->createddatetime = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, false, '`createddatetime`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CId
        $this->CId = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CId', 'CId', '`CId`', '`CId`', 3, 11, -1, false, '`CId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PatId
        $this->PatId = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_PatId', 'PatId', '`PatId`', '`PatId`', 3, 11, -1, false, '`PatId`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RefferedBy
        $this->RefferedBy = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_RefferedBy', 'RefferedBy', '`RefferedBy`', '`RefferedBy`', 200, 45, -1, false, '`RefferedBy`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DrID
        $this->DrID = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_DrID', 'DrID', '`DrID`', '`DrID`', 3, 11, -1, false, '`DrID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AdjustmentAdvance
        $this->AdjustmentAdvance = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_AdjustmentAdvance', 'AdjustmentAdvance', '`AdjustmentAdvance`', '`AdjustmentAdvance`', 200, 45, -1, false, '`AdjustmentAdvance`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IncludePackage
        $this->IncludePackage = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_IncludePackage', 'IncludePackage', '`IncludePackage`', '`IncludePackage`', 200, 45, -1, false, '`IncludePackage`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IncludePackage->Sortable = true; // Allow sort
        $this->Fields['IncludePackage'] = &$this->IncludePackage;

        // CancelBill
        $this->CancelBill = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CancelBill', 'CancelBill', '`CancelBill`', '`CancelBill`', 200, 45, -1, false, '`CancelBill`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GoogleReviewID
        $this->GoogleReviewID = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_GoogleReviewID', 'GoogleReviewID', '`GoogleReviewID`', '`GoogleReviewID`', 200, 45, -1, false, '`GoogleReviewID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CardType
        $this->CardType = new DbField('view_billing_voucher', 'view_billing_voucher', 'x_CardType', 'CardType', '`CardType`', '`CardType`', 200, 45, -1, false, '`CardType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewBillingVoucherList");
        }
    }
