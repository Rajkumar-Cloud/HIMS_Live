 ...
 * Page class
 */
class IvfStimulationChartList extends IvfStimulationChart
{
    // Page ID
    public $PageID = "list";
    ...
    // Page object name
    public $PageObjName = "IvfStimulationChartList";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "IvfStimulationChartAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "IvfStimulationChartDelete";
        $this->MultiUpdateUrl = "IvfStimulationChartUpdate";
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->SemenFrozen, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->PGTA, $arKeywords, $type);
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->DR12->setSort("");
                $this->DR13->setSort("");
                $this->DOCTORRESPONSIBLE->setSort("");
                $this->TidNo->setSort("");
