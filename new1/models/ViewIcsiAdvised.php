...
class ViewIcsiAdvised extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ICSIDate
        $this->ICSIDate = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_ICSIDate', 'ICSIDate', '`ICSIDate`', CastDateFieldForLike("`ICSIDate`", 0, "DB"), 135, 19, 0, false, '`ICSIDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIcsiAdvisedList");
        }
    }
