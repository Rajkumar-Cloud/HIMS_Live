...
class ViewLabServices extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // HospID
        $this->HospID = new DbField('view_lab_services', 'view_lab_services', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 3, 11, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DiscountRemarks
        $this->DiscountRemarks = new DbField('view_lab_services', 'view_lab_services', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 200, 45, -1, false, '`DiscountRemarks`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DiscountRemarks->Sortable = true; // Allow sort
        $this->Fields['DiscountRemarks'] = &$this->DiscountRemarks;

        // Remarks
        $this->Remarks = new DbField('view_lab_services', 'view_lab_services', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 65535, -1, false, '`Remarks`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewLabServicesList");
        }
    }
