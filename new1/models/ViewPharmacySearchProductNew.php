...
class ViewPharmacySearchProductNew extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Stock
        $this->Stock = new DbField('view_pharmacy_search_product_new', 'view_pharmacy_search_product_new', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 21, -1, false, '`Stock`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewPharmacySearchProductNewList");
        }
    }
