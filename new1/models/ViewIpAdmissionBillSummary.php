...
class ViewIpAdmissionBillSummary extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // PaymentCategory
        $this->PaymentCategory = new DbField('view_ip_admission_bill_summary', 'view_ip_admission_bill_summary', 'x_PaymentCategory', 'PaymentCategory', '`PaymentCategory`', '`PaymentCategory`', 200, 45, -1, false, '`PaymentCategory`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PaymentStatus
        $this->PaymentStatus = new DbField('view_ip_admission_bill_summary', 'view_ip_admission_bill_summary', 'x_PaymentStatus', 'PaymentStatus', '`PaymentStatus`', '`PaymentStatus`', 3, 11, -1, false, '`PaymentStatus`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BillClosing
        $this->BillClosing = new DbField('view_ip_admission_bill_summary', 'view_ip_admission_bill_summary', 'x_BillClosing', 'BillClosing', '`BillClosing`', '`BillClosing`', 200, 45, -1, false, '`BillClosing`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReportHeader
        $this->ReportHeader = new DbField('view_ip_admission_bill_summary', 'view_ip_admission_bill_summary', 'x_ReportHeader', 'ReportHeader', '`ReportHeader`', '`ReportHeader`', 200, 45, -1, false, '`ReportHeader`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ReportHeader->Sortable = true; // Allow sort
        $this->Fields['ReportHeader'] = &$this->ReportHeader;

        // Procedure
        $this->Procedure = new DbField('view_ip_admission_bill_summary', 'view_ip_admission_bill_summary', 'x_Procedure', 'Procedure', '`Procedure`', '`Procedure`', 200, 45, -1, false, '`Procedure`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewIpAdmissionBillSummaryList");
        }
    }
