...
class IvfSemenanalysisreport extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // RequestSample
        $this->RequestSample = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_RequestSample', 'RequestSample', '`RequestSample`', '`RequestSample`', 200, 45, -1, false, '`RequestSample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RequestSample->Sortable = true; // Allow sort
        $this->Fields['RequestSample'] = &$this->RequestSample;

        // CollectionType
        $this->CollectionType = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CollectionType', 'CollectionType', '`CollectionType`', '`CollectionType`', 200, 45, -1, false, '`CollectionType`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CollectionType->Sortable = true; // Allow sort
        $this->Fields['CollectionType'] = &$this->CollectionType;

        // CollectionMethod
        $this->CollectionMethod = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CollectionMethod', 'CollectionMethod', '`CollectionMethod`', '`CollectionMethod`', 200, 45, -1, false, '`CollectionMethod`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CollectionMethod->Sortable = true; // Allow sort
        $this->Fields['CollectionMethod'] = &$this->CollectionMethod;

        // Medicationused
        $this->Medicationused = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Medicationused', 'Medicationused', '`Medicationused`', '`Medicationused`', 200, 45, -1, false, '`Medicationused`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Medicationused->Sortable = true; // Allow sort
        $this->Fields['Medicationused'] = &$this->Medicationused;

        // DifficultiesinCollection
        $this->DifficultiesinCollection = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_DifficultiesinCollection', 'DifficultiesinCollection', '`DifficultiesinCollection`', '`DifficultiesinCollection`', 200, 45, -1, false, '`DifficultiesinCollection`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Timeofcollection
        $this->Timeofcollection = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Timeofcollection', 'Timeofcollection', '`Timeofcollection`', '`Timeofcollection`', 200, 45, -1, false, '`Timeofcollection`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Timeofcollection->Sortable = true; // Allow sort
        $this->Fields['Timeofcollection'] = &$this->Timeofcollection;

        // Timeofexamination
        $this->Timeofexamination = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Timeofexamination', 'Timeofexamination', '`Timeofexamination`', '`Timeofexamination`', 200, 45, -1, false, '`Timeofexamination`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Homogenosity
        $this->Homogenosity = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Homogenosity', 'Homogenosity', '`Homogenosity`', '`Homogenosity`', 200, 45, -1, false, '`Homogenosity`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Homogenosity->Sortable = true; // Allow sort
        $this->Fields['Homogenosity'] = &$this->Homogenosity;

        // CompleteSample
        $this->CompleteSample = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_CompleteSample', 'CompleteSample', '`CompleteSample`', '`CompleteSample`', 200, 45, -1, false, '`CompleteSample`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SemenOrgin
        $this->SemenOrgin = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_SemenOrgin', 'SemenOrgin', '`SemenOrgin`', '`SemenOrgin`', 200, 45, -1, false, '`SemenOrgin`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SemenOrgin->Sortable = true; // Allow sort
        $this->Fields['SemenOrgin'] = &$this->SemenOrgin;

        // Donor
        $this->Donor = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_Donor', 'Donor', '`Donor`', '`Donor`', 3, 11, -1, false, '`Donor`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MACS
        $this->MACS = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_MACS', 'MACS', '`MACS`', '`MACS`', 200, 45, -1, false, '`MACS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPECIFIC_PROBLEMS
        $this->SPECIFIC_PROBLEMS = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_SPECIFIC_PROBLEMS', 'SPECIFIC_PROBLEMS', '`SPECIFIC_PROBLEMS`', '`SPECIFIC_PROBLEMS`', 200, 45, -1, false, '`SPECIFIC_PROBLEMS`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->LIQUIFACTION_STORAGE = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_LIQUIFACTION_STORAGE', 'LIQUIFACTION_STORAGE', '`LIQUIFACTION_STORAGE`', '`LIQUIFACTION_STORAGE`', 200, 45, -1, false, '`LIQUIFACTION_STORAGE`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LIQUIFACTION_STORAGE->Sortable = true; // Allow sort
        $this->Fields['LIQUIFACTION_STORAGE'] = &$this->LIQUIFACTION_STORAGE;

        // IUI_PREP_METHOD
        $this->IUI_PREP_METHOD = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_IUI_PREP_METHOD', 'IUI_PREP_METHOD', '`IUI_PREP_METHOD`', '`IUI_PREP_METHOD`', 200, 45, -1, false, '`IUI_PREP_METHOD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IUI_PREP_METHOD->Sortable = true; // Allow sort
        $this->Fields['IUI_PREP_METHOD'] = &$this->IUI_PREP_METHOD;

        // TIME_FROM_TRIGGER
        $this->TIME_FROM_TRIGGER = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_TIME_FROM_TRIGGER', 'TIME_FROM_TRIGGER', '`TIME_FROM_TRIGGER`', '`TIME_FROM_TRIGGER`', 200, 45, -1, false, '`TIME_FROM_TRIGGER`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->COLLECTION_TO_PREPARATION = new DbField('ivf_semenanalysisreport', 'ivf_semenanalysisreport', 'x_COLLECTION_TO_PREPARATION', 'COLLECTION_TO_PREPARATION', '`COLLECTION_TO_PREPARATION`', '`COLLECTION_TO_PREPARATION`', 200, 45, -1, false, '`COLLECTION_TO_PREPARATION`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("IvfSemenanalysisreportList");
        }
    }
