 ...
 */
class PresTradenames extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PresTradenamesList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "PresTradenamesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PresTradenamesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PresTradenamesAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PresTradenamesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PresTradenamesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PresTradenamesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PresTradenamesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresTradenamesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PresTradenamesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PresTradenamesDelete", $this->getUrlParm());
    }
