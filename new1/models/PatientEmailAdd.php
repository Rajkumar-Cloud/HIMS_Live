...
class PatientEmailAdd extends PatientEmail
{
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->email_type->EditValue = HtmlEncode($this->email_type->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckInteger($this->email_type->FormValue)) {
            $this->email_type->addErrorMessage($this->email_type->getErrorMessage(false));
        }
