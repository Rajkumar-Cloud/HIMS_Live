...
class EmployeeHasExperience extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // job description
        $this->job_description = new DbField('employee_has_experience', 'employee_has_experience', 'x_job_description', 'job description', '`job description`', '`job description`', 200, 100, -1, false, '`job description`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // certificates
        $this->certificates = new DbField('employee_has_experience', 'employee_has_experience', 'x_certificates', 'certificates', '`certificates`', '`certificates`', 200, 100, -1, false, '`certificates`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // others
        $this->_others = new DbField('employee_has_experience', 'employee_has_experience', 'x__others', 'others', '`others`', '`others`', 200, 100, -1, false, '`others`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status
        $this->status = new DbField('employee_has_experience', 'employee_has_experience', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("EmployeeHasExperienceList");
        }
    }
