...
class ViewDeliveryRegistered extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DeliveryRegistered
        $this->DeliveryRegistered = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_DeliveryRegistered', 'DeliveryRegistered', '`DeliveryRegistered`', '`DeliveryRegistered`', 200, 45, -1, false, '`DeliveryRegistered`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DeliveryRegistered->Sortable = true; // Allow sort
        $this->Fields['DeliveryRegistered'] = &$this->DeliveryRegistered;

        // LMP
        $this->LMP = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_LMP', 'LMP', '`LMP`', CastDateFieldForLike("`LMP`", 0, "DB"), 135, 19, 0, false, '`LMP`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EDD
        $this->EDD = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_EDD', 'EDD', '`EDD`', CastDateFieldForLike("`EDD`", 0, "DB"), 135, 19, 0, false, '`EDD`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // HospID
        $this->HospID = new DbField('view_delivery_registered', 'view_delivery_registered', 'x_HospID', 'HospID', '`HospID`', '`HospID`', 200, 45, -1, false, '`HospID`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewDeliveryRegisteredList");
        }
    }
