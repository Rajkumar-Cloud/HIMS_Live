 ...
 * Page class
 */
class IvfSemenanalysisreportAdd extends IvfSemenanalysisreport
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "IvfSemenanalysisreportAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "IvfSemenanalysisreportView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->RequestSample->EditValue = HtmlEncode($this->RequestSample->CurrentValue);
            ...
            $this->CollectionType->EditValue = HtmlEncode($this->CollectionType->CurrentValue);
            ...
            $this->CollectionMethod->EditValue = HtmlEncode($this->CollectionMethod->CurrentValue);
            ...
            $this->Medicationused->EditValue = HtmlEncode($this->Medicationused->CurrentValue);
            ...
            $this->DifficultiesinCollection->EditValue = HtmlEncode($this->DifficultiesinCollection->CurrentValue);
            ...
            $this->Homogenosity->EditValue = HtmlEncode($this->Homogenosity->CurrentValue);
            ...
            $this->CompleteSample->EditValue = HtmlEncode($this->CompleteSample->CurrentValue);
            ...
            $this->SemenOrgin->EditValue = HtmlEncode($this->SemenOrgin->CurrentValue);
            ...
            $this->SPECIFIC_PROBLEMS->EditValue = HtmlEncode($this->SPECIFIC_PROBLEMS->CurrentValue);
            ...
            $this->LIQUIFACTION_STORAGE->EditValue = HtmlEncode($this->LIQUIFACTION_STORAGE->CurrentValue);
            ...
            $this->IUI_PREP_METHOD->EditValue = HtmlEncode($this->IUI_PREP_METHOD->CurrentValue);
            ...
            $this->TIME_FROM_TRIGGER->EditValue = HtmlEncode($this->TIME_FROM_TRIGGER->CurrentValue);
            ...
            $this->COLLECTION_TO_PREPARATION->EditValue = HtmlEncode($this->COLLECTION_TO_PREPARATION->CurrentValue);
