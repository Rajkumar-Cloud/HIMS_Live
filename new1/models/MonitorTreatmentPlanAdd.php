 ...
 * Page class
 */
class MonitorTreatmentPlanAdd extends MonitorTreatmentPlan
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "MonitorTreatmentPlanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MonitorTreatmentPlanView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // NewVisitDate
        $this->NewVisitDate->setDbValueDef($rsnew, UnFormatDateTime($this->NewVisitDate->CurrentValue, 0), null, false);
        ...
        // IUIDoneDate1
        $this->IUIDoneDate1->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate1->CurrentValue, 0), null, false);

        // IUIDoneYesNo1
        $this->IUIDoneYesNo1->setDbValueDef($rsnew, $this->IUIDoneYesNo1->CurrentValue, null, false);

        // UPTTestDate1
        $this->UPTTestDate1->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate1->CurrentValue, 0), null, false);

        // UPTTestYesNo1
        $this->UPTTestYesNo1->setDbValueDef($rsnew, $this->UPTTestYesNo1->CurrentValue, null, false);

        // IUIDoneDate2
        $this->IUIDoneDate2->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate2->CurrentValue, 0), null, false);

        // IUIDoneYesNo2
        $this->IUIDoneYesNo2->setDbValueDef($rsnew, $this->IUIDoneYesNo2->CurrentValue, null, false);

        // UPTTestDate2
        $this->UPTTestDate2->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate2->CurrentValue, 0), null, false);

        // UPTTestYesNo2
        $this->UPTTestYesNo2->setDbValueDef($rsnew, $this->UPTTestYesNo2->CurrentValue, null, false);

        // IUIDoneDate3
        $this->IUIDoneDate3->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate3->CurrentValue, 0), null, false);

        // IUIDoneYesNo3
        $this->IUIDoneYesNo3->setDbValueDef($rsnew, $this->IUIDoneYesNo3->CurrentValue, null, false);

        // UPTTestDate3
        $this->UPTTestDate3->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate3->CurrentValue, 0), null, false);

        // UPTTestYesNo3
        $this->UPTTestYesNo3->setDbValueDef($rsnew, $this->UPTTestYesNo3->CurrentValue, null, false);

        // IUIDoneDate4
        $this->IUIDoneDate4->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate4->CurrentValue, 0), null, false);

        // IUIDoneYesNo4
        $this->IUIDoneYesNo4->setDbValueDef($rsnew, $this->IUIDoneYesNo4->CurrentValue, null, false);

        // UPTTestDate4
        $this->UPTTestDate4->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate4->CurrentValue, 0), null, false);

        // UPTTestYesNo4
        $this->UPTTestYesNo4->setDbValueDef($rsnew, $this->UPTTestYesNo4->CurrentValue, null, false);

        // IVFStimulationDate
        $this->IVFStimulationDate->setDbValueDef($rsnew, UnFormatDateTime($this->IVFStimulationDate->CurrentValue, 0), null, false);
        ...
        // BetaHCGDate
        $this->BetaHCGDate->setDbValueDef($rsnew, UnFormatDateTime($this->BetaHCGDate->CurrentValue, 0), null, false);

        // BetaHCGYesNo
        $this->BetaHCGYesNo->setDbValueDef($rsnew, $this->BetaHCGYesNo->CurrentValue, null, false);

        // FETDate
        $this->FETDate->setDbValueDef($rsnew, UnFormatDateTime($this->FETDate->CurrentValue, 0), null, false);

        // FETYesNo
        $this->FETYesNo->setDbValueDef($rsnew, $this->FETYesNo->CurrentValue, null, false);

        // FBetaHCGDate
        $this->FBetaHCGDate->setDbValueDef($rsnew, UnFormatDateTime($this->FBetaHCGDate->CurrentValue, 0), null, false);
