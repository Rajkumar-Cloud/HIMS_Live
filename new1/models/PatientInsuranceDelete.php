 ...
 * Page class
 */
class PatientInsuranceDelete extends PatientInsurance
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PatientInsuranceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientInsuranceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientInsuranceList"); // Return to list
                return;
            }
        }
