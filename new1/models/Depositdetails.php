...
class Depositdetails extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // DepositDate
        $this->DepositDate = new DbField('depositdetails', 'depositdetails', 'x_DepositDate', 'DepositDate', '`DepositDate`', CastDateFieldForLike("`DepositDate`", 0, "DB"), 135, 19, 0, false, '`DepositDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DepositToBankSelect
        $this->DepositToBankSelect = new DbField('depositdetails', 'depositdetails', 'x_DepositToBankSelect', 'DepositToBankSelect', '`DepositToBankSelect`', '`DepositToBankSelect`', 200, 45, -1, false, '`DepositToBankSelect`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DepositToBankSelect->Sortable = true; // Allow sort
        $this->Fields['DepositToBankSelect'] = &$this->DepositToBankSelect;

        // DepositToBank
        $this->DepositToBank = new DbField('depositdetails', 'depositdetails', 'x_DepositToBank', 'DepositToBank', '`DepositToBank`', '`DepositToBank`', 200, 45, -1, false, '`DepositToBank`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TransferTo
        $this->TransferTo = new DbField('depositdetails', 'depositdetails', 'x_TransferTo', 'TransferTo', '`TransferTo`', '`TransferTo`', 200, 45, -1, false, '`TransferTo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("DepositdetailsList");
        }
    }
