 ...
 */
class ViewLabResultreleasedAuth extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Resulted
        $this->Resulted = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Resulted', 'Resulted', '`Resulted`', '`Resulted`', 200, 45, -1, false, '`Resulted`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Pic1
        $this->Pic1 = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Pic1', 'Pic1', '`Pic1`', '`Pic1`', 200, 45, -1, false, '`Pic1`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Pic1->Sortable = true; // Allow sort
        $this->Fields['Pic1'] = &$this->Pic1;

        // Pic2
        $this->Pic2 = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Pic2', 'Pic2', '`Pic2`', '`Pic2`', 200, 45, -1, false, '`Pic2`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Repeated
        $this->Repeated = new DbField('view_lab_resultreleased_auth', 'view_lab_resultreleased_auth', 'x_Repeated', 'Repeated', '`Repeated`', '`Repeated`', 200, 45, -1, false, '`Repeated`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewLabResultreleasedAuthList");
        }
    }
    ...
    {
        global $Language;
        if ($pageName == "ViewLabResultreleasedAuthView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ViewLabResultreleasedAuthEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ViewLabResultreleasedAuthAdd") {
    ...
    {
        return "ViewLabResultreleasedAuthList";
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewLabResultreleasedAuthView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ViewLabResultreleasedAuthView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ViewLabResultreleasedAuthAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ViewLabResultreleasedAuthAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLabResultreleasedAuthEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewLabResultreleasedAuthAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ViewLabResultreleasedAuthDelete", $this->getUrlParm());
    }
