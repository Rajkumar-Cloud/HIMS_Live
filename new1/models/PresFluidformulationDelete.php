 ...
 * Page class
 */
class PresFluidformulationDelete extends PresFluidformulation
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PresFluidformulationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PresFluidformulationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PresFluidformulationList"); // Return to list
                return;
            }
        }
