 ...
 * Page class
 */
class PharmacyCombinationDelete extends PharmacyCombination
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PharmacyCombinationDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PharmacyCombinationList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PharmacyCombinationList"); // Return to list
                return;
            }
        }
