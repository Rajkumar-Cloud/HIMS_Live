...
class IvfOocytedenudationList extends IvfOocytedenudation
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->patient2); // patient2
            $this->updateSort($this->OocytesDonate1); // OocytesDonate1
            $this->updateSort($this->OocytesDonate2); // OocytesDonate2
            $this->updateSort($this->ETDonate); // ETDonate
