...
class Thaw extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // thawReFrozen
        $this->thawReFrozen = new DbField('thaw', 'thaw', 'x_thawReFrozen', 'thawReFrozen', '`thawReFrozen`', '`thawReFrozen`', 200, 45, -1, false, '`thawReFrozen`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Day
        $this->Day = new DbField('thaw', 'thaw', 'x_Day', 'Day', '`Day`', '`Day`', 200, 45, -1, false, '`Day`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->Day->Sortable = true; // Allow sort
        $this->Fields['Day'] = &$this->Day;

        // Grade
        $this->Grade = new DbField('thaw', 'thaw', 'x_Grade', 'Grade', '`Grade`', '`Grade`', 200, 45, -1, false, '`Grade`', false, false, false, 'FORMATTED TEXT', 'TEXT');
