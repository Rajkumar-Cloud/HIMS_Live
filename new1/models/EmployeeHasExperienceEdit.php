...
class EmployeeHasExperienceEdit extends EmployeeHasExperience
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // certificates
            $this->certificates->setDbValueDef($rsnew, $this->certificates->CurrentValue, "", $this->certificates->ReadOnly);

            // others
            $this->_others->setDbValueDef($rsnew, $this->_others->CurrentValue, "", $this->_others->ReadOnly);
