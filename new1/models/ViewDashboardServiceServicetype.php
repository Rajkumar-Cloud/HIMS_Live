...
class ViewDashboardServiceServicetype extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // createdDate
        $this->createdDate = new DbField('view_dashboard_service_servicetype', 'view_dashboard_service_servicetype', 'x_createdDate', 'createdDate', '`createdDate`', CastDateFieldForLike("`createdDate`", 0, "DB"), 133, 10, 0, false, '`createdDate`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewDashboardServiceServicetypeList");
        }
    }
