...
class PatientInsuranceAdd extends PatientInsurance
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->DocumentAttatch->CurrentValue = null;
        $this->DocumentAttatch->OldValue = $this->DocumentAttatch->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'DocumentAttatch' first before field var 'x_DocumentAttatch'
        $val = $CurrentForm->hasValue("DocumentAttatch") ? $CurrentForm->getValue("DocumentAttatch") : $CurrentForm->getValue("x_DocumentAttatch");
        if (!$this->DocumentAttatch->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->DocumentAttatch->Visible = false; // Disable update for API request
            } else {
                $this->DocumentAttatch->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->ReferenceDate->CurrentValue = UnFormatDateTime($this->ReferenceDate->CurrentValue, 0);
        $this->DocumentAttatch->CurrentValue = $this->DocumentAttatch->FormValue;
    ...
    protected function newRow()
    {
        ...
        $row['DocumentAttatch'] = $this->DocumentAttatch->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // DocumentAttatch
            $this->DocumentAttatch->ViewValue = $this->DocumentAttatch->CurrentValue;
            ...
            $this->DocumentAttatch->EditValue = HtmlEncode($this->DocumentAttatch->CurrentValue);
            $this->DocumentAttatch->PlaceHolder = RemoveHtml($this->DocumentAttatch->caption());
    ...
    protected function validateForm()
    {
        ...
        if ($this->DocumentAttatch->Required) {
            if (!$this->DocumentAttatch->IsDetailKey && EmptyValue($this->DocumentAttatch->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // DocumentAttatch
        $this->DocumentAttatch->setDbValueDef($rsnew, $this->DocumentAttatch->CurrentValue, null, false);
