...
class PatientOpdFollowUpEdit extends PatientOpdFollowUp
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // PatID
            $this->PatID->setDbValueDef($rsnew, $this->PatID->CurrentValue, "", $this->PatID->ReadOnly);

            // MobileNumber
            $this->MobileNumber->setDbValueDef($rsnew, $this->MobileNumber->CurrentValue, "", $this->MobileNumber->ReadOnly);
