 ...
 * Page class
 */
class IvfOtherprocedureView extends IvfOtherprocedure
{
    // Page ID
    public $PageID = "view";
    ...
    // Page object name
    public $PageObjName = "IvfOtherprocedureView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "IvfOtherprocedureList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "IvfOtherprocedureList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "IvfOtherprocedureList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
