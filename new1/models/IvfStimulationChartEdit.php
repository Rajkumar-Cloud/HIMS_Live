 ...
 * Page class
 */
class IvfStimulationChartEdit extends IvfStimulationChart
{
    // Page ID
    public $PageID = "edit";
    ...
    // Page object name
    public $PageObjName = "IvfStimulationChartEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // SCDate
            $this->SCDate->setDbValueDef($rsnew, UnFormatDateTime($this->SCDate->CurrentValue, 0), null, $this->SCDate->ReadOnly);
            ...
            // TRIGGERDATE
            $this->TRIGGERDATE->setDbValueDef($rsnew, UnFormatDateTime($this->TRIGGERDATE->CurrentValue, 0), null, $this->TRIGGERDATE->ReadOnly);
            ...
            // DATEOFET
            $this->DATEOFET->setDbValueDef($rsnew, UnFormatDateTime($this->DATEOFET->CurrentValue, 0), null, $this->DATEOFET->ReadOnly);
            ...
            // StChDate1
            $this->StChDate1->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate1->CurrentValue, 0), null, $this->StChDate1->ReadOnly);

            // StChDate2
            $this->StChDate2->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate2->CurrentValue, 0), null, $this->StChDate2->ReadOnly);

            // StChDate3
            $this->StChDate3->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate3->CurrentValue, 0), null, $this->StChDate3->ReadOnly);

            // StChDate4
            $this->StChDate4->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate4->CurrentValue, 0), null, $this->StChDate4->ReadOnly);

            // StChDate5
            $this->StChDate5->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate5->CurrentValue, 0), null, $this->StChDate5->ReadOnly);

            // StChDate6
            $this->StChDate6->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate6->CurrentValue, 0), null, $this->StChDate6->ReadOnly);

            // StChDate7
            $this->StChDate7->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate7->CurrentValue, 0), null, $this->StChDate7->ReadOnly);

            // StChDate8
            $this->StChDate8->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate8->CurrentValue, 0), null, $this->StChDate8->ReadOnly);

            // StChDate9
            $this->StChDate9->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate9->CurrentValue, 0), null, $this->StChDate9->ReadOnly);

            // StChDate10
            $this->StChDate10->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate10->CurrentValue, 0), null, $this->StChDate10->ReadOnly);

            // StChDate11
            $this->StChDate11->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate11->CurrentValue, 0), null, $this->StChDate11->ReadOnly);

            // StChDate12
            $this->StChDate12->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate12->CurrentValue, 0), null, $this->StChDate12->ReadOnly);

            // StChDate13
            $this->StChDate13->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate13->CurrentValue, 0), null, $this->StChDate13->ReadOnly);
            ...
            // DATOFEMBRYOTRANSFER
            $this->DATOFEMBRYOTRANSFER->setDbValueDef($rsnew, UnFormatDateTime($this->DATOFEMBRYOTRANSFER->CurrentValue, 0), null, $this->DATOFEMBRYOTRANSFER->ReadOnly);
            ...
            // StChDate14
            $this->StChDate14->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate14->CurrentValue, 0), null, $this->StChDate14->ReadOnly);

            // StChDate15
            $this->StChDate15->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate15->CurrentValue, 0), null, $this->StChDate15->ReadOnly);

            // StChDate16
            $this->StChDate16->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate16->CurrentValue, 0), null, $this->StChDate16->ReadOnly);

            // StChDate17
            $this->StChDate17->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate17->CurrentValue, 0), null, $this->StChDate17->ReadOnly);

            // StChDate18
            $this->StChDate18->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate18->CurrentValue, 0), null, $this->StChDate18->ReadOnly);

            // StChDate19
            $this->StChDate19->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate19->CurrentValue, 0), null, $this->StChDate19->ReadOnly);

            // StChDate20
            $this->StChDate20->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate20->CurrentValue, 0), null, $this->StChDate20->ReadOnly);

            // StChDate21
            $this->StChDate21->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate21->CurrentValue, 0), null, $this->StChDate21->ReadOnly);

            // StChDate22
            $this->StChDate22->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate22->CurrentValue, 0), null, $this->StChDate22->ReadOnly);

            // StChDate23
            $this->StChDate23->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate23->CurrentValue, 0), null, $this->StChDate23->ReadOnly);

            // StChDate24
            $this->StChDate24->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate24->CurrentValue, 0), null, $this->StChDate24->ReadOnly);

            // StChDate25
            $this->StChDate25->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate25->CurrentValue, 0), null, $this->StChDate25->ReadOnly);
            ...
            // EEETTTDTE
            $this->EEETTTDTE->setDbValueDef($rsnew, UnFormatDateTime($this->EEETTTDTE->CurrentValue, 0), null, $this->EEETTTDTE->ReadOnly);

            // bhcgdate
            $this->bhcgdate->setDbValueDef($rsnew, UnFormatDateTime($this->bhcgdate->CurrentValue, 0), null, $this->bhcgdate->ReadOnly);
