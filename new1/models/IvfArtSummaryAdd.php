 ...
 * Page class
 */
class IvfArtSummaryAdd extends IvfArtSummary
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "IvfArtSummaryAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "IvfArtSummaryView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->_Others->CurrentValue = null;
        $this->_Others->OldValue = $this->_Others->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->DateofICSI->IsDetailKey) {
            ...
            $this->DateofICSI->CurrentValue = UnFormatDateTime($this->DateofICSI->CurrentValue, 0);
        }
    ...
    protected function newRow()
    {
        ...
        $row['Others'] = $this->_Others->CurrentValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->DateofICSI->EditValue = HtmlEncode(FormatDateTime($this->DateofICSI->CurrentValue, 8));
            ...
            $this->DateofET->EditValue = HtmlEncode($this->DateofET->CurrentValue);
            ...
            $this->Reasonfornotranfer->EditValue = HtmlEncode($this->Reasonfornotranfer->CurrentValue);
            ...
            $this->ConsultantsSignature->EditValue = HtmlEncode($this->ConsultantsSignature->CurrentValue);
            ...
            $this->Day1->EditValue = HtmlEncode($this->Day1->CurrentValue);
            ...
            $this->State1->EditValue = HtmlEncode($this->State1->CurrentValue);
            ...
            $this->Day2->EditValue = HtmlEncode($this->Day2->CurrentValue);
            ...
            $this->State2->EditValue = HtmlEncode($this->State2->CurrentValue);
            ...
            $this->Day3->EditValue = HtmlEncode($this->Day3->CurrentValue);
            ...
            $this->CellStage3->EditValue = HtmlEncode($this->CellStage3->CurrentValue);
            ...
            $this->Grade3->EditValue = HtmlEncode($this->Grade3->CurrentValue);
            ...
            $this->State3->EditValue = HtmlEncode($this->State3->CurrentValue);
            ...
            $this->Day4->EditValue = HtmlEncode($this->Day4->CurrentValue);
            ...
            $this->CellStage4->EditValue = HtmlEncode($this->CellStage4->CurrentValue);
            ...
            $this->Grade4->EditValue = HtmlEncode($this->Grade4->CurrentValue);
            ...
            $this->State4->EditValue = HtmlEncode($this->State4->CurrentValue);
            ...
            $this->Day5->EditValue = HtmlEncode($this->Day5->CurrentValue);
            ...
            $this->CellStage5->EditValue = HtmlEncode($this->CellStage5->CurrentValue);
            ...
            $this->Grade5->EditValue = HtmlEncode($this->Grade5->CurrentValue);
            ...
            $this->State5->EditValue = HtmlEncode($this->State5->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if (!CheckDate($this->DateofICSI->FormValue)) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // DateofICSI
        $this->DateofICSI->setDbValueDef($rsnew, UnFormatDateTime($this->DateofICSI->CurrentValue, 0), null, false);
        ...
        // Others
        $this->_Others->setDbValueDef($rsnew, $this->_Others->CurrentValue, null, false);
