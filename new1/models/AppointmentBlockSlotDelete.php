 ...
 * Page class
 */
class AppointmentBlockSlotDelete extends AppointmentBlockSlot
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "AppointmentBlockSlotDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AppointmentBlockSlotList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AppointmentBlockSlotList"); // Return to list
                return;
            }
        }
