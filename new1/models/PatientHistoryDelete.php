 ...
 * Page class
 */
class PatientHistoryDelete extends PatientHistory
{
    // Page ID
    ...
    // Page object name
    public $PageObjName = "PatientHistoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PatientHistoryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PatientHistoryList"); // Return to list
                return;
            }
        }
