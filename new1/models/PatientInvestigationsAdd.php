 ...
 * Page class
 */
class PatientInvestigationsAdd extends PatientInvestigations
{
    // Page ID
    public $PageID = "add";
    ...
    // Page object name
    public $PageObjName = "PatientInvestigationsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PatientInvestigationsView") {
