...
class ViewTreatmentCulture extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Day0OocyteStage->Required = true; // Required field
        ...
        $this->Day1->Required = true; // Required field
        ...
        $this->Day2->Required = true; // Required field
        ...
        $this->Day3->Required = true; // Required field
        ...
        $this->Day4->Required = true; // Required field
        ...
        $this->Day5->Required = true; // Required field
        ...
        $this->Day6->Required = true; // Required field
        ...
        $this->ET->Required = true; // Required field
        ...
        $this->ETDate->Required = true; // Required field
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("ViewTreatmentCultureList");
        }
    }
