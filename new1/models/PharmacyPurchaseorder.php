...
class PharmacyPurchaseorder extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // PRC
        $this->PRC = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PRC', 'PRC', '`PRC`', '`PRC`', 200, 9, -1, false, '`PRC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PC
        $this->PC = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_PC', 'PC', '`PC`', '`PC`', 200, 5, -1, false, '`PC`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Received
        $this->Received = new DbField('pharmacy_purchaseorder', 'pharmacy_purchaseorder', 'x_Received', 'Received', '`Received`', '`Received`', 200, 45, -1, false, '`Received`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        if (@$_SESSION[$name] != "") {
            ...
            return GetUrl("PharmacyPurchaseorderList");
        }
    }
