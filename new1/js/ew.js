/*!
 * JavaScript for PHPMaker v2021.0.2
...
(function ($) {
  ...
  function getContent(html) {
    ...
    return body ? $__default['default'](body[0]).not("div[id^=ew].modal, #ew-tooltip, #ew-drilldown-panel, #cookie-consent, #template-upload, #template-download") : "";
