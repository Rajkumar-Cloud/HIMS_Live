...
$Page->showMessage();
?>
<form name="fivf_follow_up_trackingedit" id="fivf_follow_up_trackingedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_follow_up_tracking_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fivf_follow_up_trackingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_follow_up_trackingedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_follow_up_trackingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_follow_up_trackingedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_follow_up_trackingedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_follow_up_trackingedit", "x_FollowUpDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
