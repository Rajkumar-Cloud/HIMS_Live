...
<form name="fbilling_voucherlistsrch" id="fbilling_voucherlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fbilling_voucherlist" id="fbilling_voucherlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th data-name="Reception" class="<?= $Page->Reception->headerCellClass() ?>"><div id="elh_billing_voucher_Reception" class="billing_voucher_Reception"><?= $Page->renderSort($Page->Reception) ?></div></th>
<?php } ?>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
        <th data-name="mrnno" class="<?= $Page->mrnno->headerCellClass() ?>"><div id="elh_billing_voucher_mrnno" class="billing_voucher_mrnno"><?= $Page->renderSort($Page->mrnno) ?></div></th>
<?php } ?>
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_billing_voucher_Age" class="billing_voucher_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
        <th data-name="IP_OP" class="<?= $Page->IP_OP->headerCellClass() ?>"><div id="elh_billing_voucher_IP_OP" class="billing_voucher_IP_OP"><?= $Page->renderSort($Page->IP_OP) ?></div></th>
<?php } ?>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
        <th data-name="voucher_type" class="<?= $Page->voucher_type->headerCellClass() ?>"><div id="elh_billing_voucher_voucher_type" class="billing_voucher_voucher_type"><?= $Page->renderSort($Page->voucher_type) ?></div></th>
<?php } ?>
<?php if ($Page->Details->Visible) { // Details ?>
        <th data-name="Details" class="<?= $Page->Details->headerCellClass() ?>"><div id="elh_billing_voucher_Details" class="billing_voucher_Details"><?= $Page->renderSort($Page->Details) ?></div></th>
<?php } ?>
...
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
        <th data-name="RealizationAmount" class="<?= $Page->RealizationAmount->headerCellClass() ?>"><div id="elh_billing_voucher_RealizationAmount" class="billing_voucher_RealizationAmount"><?= $Page->renderSort($Page->RealizationAmount) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
        <th data-name="RealizationStatus" class="<?= $Page->RealizationStatus->headerCellClass() ?>"><div id="elh_billing_voucher_RealizationStatus" class="billing_voucher_RealizationStatus"><?= $Page->renderSort($Page->RealizationStatus) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
        <th data-name="RealizationRemarks" class="<?= $Page->RealizationRemarks->headerCellClass() ?>"><div id="elh_billing_voucher_RealizationRemarks" class="billing_voucher_RealizationRemarks"><?= $Page->renderSort($Page->RealizationRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
        <th data-name="RealizationBatchNo" class="<?= $Page->RealizationBatchNo->headerCellClass() ?>"><div id="elh_billing_voucher_RealizationBatchNo" class="billing_voucher_RealizationBatchNo"><?= $Page->renderSort($Page->RealizationBatchNo) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
        <th data-name="RealizationDate" class="<?= $Page->RealizationDate->headerCellClass() ?>"><div id="elh_billing_voucher_RealizationDate" class="billing_voucher_RealizationDate"><?= $Page->renderSort($Page->RealizationDate) ?></div></th>
<?php } ?>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th data-name="Currency" class="<?= $Page->Currency->headerCellClass() ?>"><div id="elh_billing_voucher_Currency" class="billing_voucher_Currency"><?= $Page->renderSort($Page->Currency) ?></div></th>
<?php } ?>
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
        <th data-name="DiscountRemarks" class="<?= $Page->DiscountRemarks->headerCellClass() ?>"><div id="elh_billing_voucher_DiscountRemarks" class="billing_voucher_DiscountRemarks"><?= $Page->renderSort($Page->DiscountRemarks) ?></div></th>
<?php } ?>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th data-name="DrID" class="<?= $Page->DrID->headerCellClass() ?>"><div id="elh_billing_voucher_DrID" class="billing_voucher_DrID"><?= $Page->renderSort($Page->DrID) ?></div></th>
<?php } ?>
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
        <th data-name="BillStatus" class="<?= $Page->BillStatus->headerCellClass() ?>"><div id="elh_billing_voucher_BillStatus" class="billing_voucher_BillStatus"><?= $Page->renderSort($Page->BillStatus) ?></div></th>
<?php } ?>
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
        <th data-name="ReportHeader" class="<?= $Page->ReportHeader->headerCellClass() ?>"><div id="elh_billing_voucher_ReportHeader" class="billing_voucher_ReportHeader"><?= $Page->renderSort($Page->ReportHeader) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_Reception">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_mrnno">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_Age">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_IP_OP">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_voucher_type">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_Details">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_RealizationAmount">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_RealizationStatus">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_RealizationRemarks">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_RealizationBatchNo">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_RealizationDate">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_Currency">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_DiscountRemarks">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_DrID">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_BillStatus">
...
<span id="el<?= $Page->RowCount ?>_billing_voucher_ReportHeader">
