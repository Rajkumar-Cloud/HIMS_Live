...
<form name="fview_bill_collection_summarylistsrch" id="fview_bill_collection_summarylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_bill_collection_summarylist" id="fview_bill_collection_summarylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<table id="tbl_view_bill_collection_summarylist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_createddate">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary__UserName">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_CARD">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_CASH">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_NEFT">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_PAYTM">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_CHEQUE">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_RTGS">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_NotSelected">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_REFUND">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_CANCEL">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_Total">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_HospID">
...
<span id="el<?= $Page->RowCount ?>_view_bill_collection_summary_BillType">
