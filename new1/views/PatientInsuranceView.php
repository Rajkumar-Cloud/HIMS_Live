...
$Page->showMessage();
?>
<form name="fpatient_insuranceview" id="fpatient_insuranceview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?= $Page->DocumentAttatch->getViewValue() ?></span>
</span>
</td>
    </tr>
<?php } ?>
