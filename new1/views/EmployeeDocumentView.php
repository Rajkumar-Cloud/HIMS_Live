...
$Page->showMessage();
?>
<form name="femployee_documentview" id="femployee_documentview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?= $Page->DocumentUpload->getViewValue() ?></span>
</span>
</td>
    </tr>
<?php } ?>
