...
// Page object
$MasTypeofregsistrationEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fmas_typeofregsistrationedit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.mas_typeofregsistration.fields;
    fmas_typeofregsistrationedit.addFields([
        ["id", [fields.id.required ? ew.Validators.required(fields.id.caption) : null], fields.id.isInvalid],
        ["RegsistrationType", [fields.RegsistrationType.required ? ew.Validators.required(fields.RegsistrationType.caption) : null], fields.RegsistrationType.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fmas_typeofregsistrationedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fmas_typeofregsistrationedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmas_typeofregsistrationedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fmas_typeofregsistrationedit" id="fmas_typeofregsistrationedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_mas_typeofregsistration_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_mas_typeofregsistration_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="mas_typeofregsistration" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
