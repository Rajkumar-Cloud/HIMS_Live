...
$Page->showMessage();
?>
<form name="fdeposit_pettycashedit" id="fdeposit_pettycashedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fdeposit_pettycashedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fdeposit_pettycashedit", "x_CreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fdeposit_pettycashedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fdeposit_pettycashedit", "x_ModifiedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
