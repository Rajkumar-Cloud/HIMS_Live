...
$Page->showMessage();
?>
<form name="fmas_employee_role_job_descriptionview" id="fmas_employee_role_job_descriptionview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
