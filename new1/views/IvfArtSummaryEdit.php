...
$Page->showMessage();
?>
<form name="fivf_art_summaryedit" id="fivf_art_summaryedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_art_summary_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fivf_art_summaryedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_art_summaryedit", "x_DateofICSI", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
