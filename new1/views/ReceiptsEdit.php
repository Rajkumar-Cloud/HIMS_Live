...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.receipts.fields;
    freceiptsedit.addFields([
        ...
        ["ChequeCardNo", [fields.ChequeCardNo.required ? ew.Validators.required(fields.ChequeCardNo.caption) : null], fields.ChequeCardNo.isInvalid],
        ["CreditBankName", [fields.CreditBankName.required ? ew.Validators.required(fields.CreditBankName.caption) : null], fields.CreditBankName.isInvalid],
        ["CreditCardHolder", [fields.CreditCardHolder.required ? ew.Validators.required(fields.CreditCardHolder.caption) : null], fields.CreditCardHolder.isInvalid],
        ["CreditCardType", [fields.CreditCardType.required ? ew.Validators.required(fields.CreditCardType.caption) : null], fields.CreditCardType.isInvalid],
        ["CreditCardMachine", [fields.CreditCardMachine.required ? ew.Validators.required(fields.CreditCardMachine.caption) : null], fields.CreditCardMachine.isInvalid],
        ["CreditCardBatchNo", [fields.CreditCardBatchNo.required ? ew.Validators.required(fields.CreditCardBatchNo.caption) : null], fields.CreditCardBatchNo.isInvalid],
        ["CreditCardTax", [fields.CreditCardTax.required ? ew.Validators.required(fields.CreditCardTax.caption) : null], fields.CreditCardTax.isInvalid],
        ["CreditDeductionAmount", [fields.CreditDeductionAmount.required ? ew.Validators.required(fields.CreditDeductionAmount.caption) : null], fields.CreditDeductionAmount.isInvalid],
        ["RealizationAmount", [fields.RealizationAmount.required ? ew.Validators.required(fields.RealizationAmount.caption) : null], fields.RealizationAmount.isInvalid],
        ...
        ["BankAccHolderMobileNumber", [fields.BankAccHolderMobileNumber.required ? ew.Validators.required(fields.BankAccHolderMobileNumber.caption) : null], fields.BankAccHolderMobileNumber.isInvalid]
    ]);
    ...
    // Form_CustomValidate
    freceiptsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    freceiptsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="freceiptsedit" id="freceiptsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_receipts_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_receipts_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="receipts" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
