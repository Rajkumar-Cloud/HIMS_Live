...
<form name="fview_lab_serviceslistsrch" id="fview_lab_serviceslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_lab_serviceslist" id="fview_lab_serviceslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th data-name="Reception" class="<?= $Page->Reception->headerCellClass() ?>"><div id="elh_view_lab_services_Reception" class="view_lab_services_Reception"><?= $Page->renderSort($Page->Reception) ?></div></th>
<?php } ?>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
        <th data-name="mrnno" class="<?= $Page->mrnno->headerCellClass() ?>"><div id="elh_view_lab_services_mrnno" class="view_lab_services_mrnno"><?= $Page->renderSort($Page->mrnno) ?></div></th>
<?php } ?>
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_view_lab_services_Age" class="view_lab_services_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
        <th data-name="IP_OP" class="<?= $Page->IP_OP->headerCellClass() ?>"><div id="elh_view_lab_services_IP_OP" class="view_lab_services_IP_OP"><?= $Page->renderSort($Page->IP_OP) ?></div></th>
<?php } ?>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
        <th data-name="voucher_type" class="<?= $Page->voucher_type->headerCellClass() ?>"><div id="elh_view_lab_services_voucher_type" class="view_lab_services_voucher_type"><?= $Page->renderSort($Page->voucher_type) ?></div></th>
<?php } ?>
<?php if ($Page->Details->Visible) { // Details ?>
        <th data-name="Details" class="<?= $Page->Details->headerCellClass() ?>"><div id="elh_view_lab_services_Details" class="view_lab_services_Details"><?= $Page->renderSort($Page->Details) ?></div></th>
<?php } ?>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
        <th data-name="AnyDues" class="<?= $Page->AnyDues->headerCellClass() ?>"><div id="elh_view_lab_services_AnyDues" class="view_lab_services_AnyDues"><?= $Page->renderSort($Page->AnyDues) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_view_lab_services_createdby" class="view_lab_services_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th data-name="createddatetime" class="<?= $Page->createddatetime->headerCellClass() ?>"><div id="elh_view_lab_services_createddatetime" class="view_lab_services_createddatetime"><?= $Page->renderSort($Page->createddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_view_lab_services_modifiedby" class="view_lab_services_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_view_lab_services_modifieddatetime" class="view_lab_services_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
        <th data-name="RealizationAmount" class="<?= $Page->RealizationAmount->headerCellClass() ?>"><div id="elh_view_lab_services_RealizationAmount" class="view_lab_services_RealizationAmount"><?= $Page->renderSort($Page->RealizationAmount) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
        <th data-name="RealizationStatus" class="<?= $Page->RealizationStatus->headerCellClass() ?>"><div id="elh_view_lab_services_RealizationStatus" class="view_lab_services_RealizationStatus"><?= $Page->renderSort($Page->RealizationStatus) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
        <th data-name="RealizationRemarks" class="<?= $Page->RealizationRemarks->headerCellClass() ?>"><div id="elh_view_lab_services_RealizationRemarks" class="view_lab_services_RealizationRemarks"><?= $Page->renderSort($Page->RealizationRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
        <th data-name="RealizationBatchNo" class="<?= $Page->RealizationBatchNo->headerCellClass() ?>"><div id="elh_view_lab_services_RealizationBatchNo" class="view_lab_services_RealizationBatchNo"><?= $Page->renderSort($Page->RealizationBatchNo) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
        <th data-name="RealizationDate" class="<?= $Page->RealizationDate->headerCellClass() ?>"><div id="elh_view_lab_services_RealizationDate" class="view_lab_services_RealizationDate"><?= $Page->renderSort($Page->RealizationDate) ?></div></th>
<?php } ?>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
        <th data-name="TidNo" class="<?= $Page->TidNo->headerCellClass() ?>"><div id="elh_view_lab_services_TidNo" class="view_lab_services_TidNo"><?= $Page->renderSort($Page->TidNo) ?></div></th>
<?php } ?>
<?php if ($Page->CId->Visible) { // CId ?>
        <th data-name="CId" class="<?= $Page->CId->headerCellClass() ?>"><div id="elh_view_lab_services_CId" class="view_lab_services_CId"><?= $Page->renderSort($Page->CId) ?></div></th>
<?php } ?>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
        <th data-name="PayerType" class="<?= $Page->PayerType->headerCellClass() ?>"><div id="elh_view_lab_services_PayerType" class="view_lab_services_PayerType"><?= $Page->renderSort($Page->PayerType) ?></div></th>
<?php } ?>
<?php if ($Page->Dob->Visible) { // Dob ?>
        <th data-name="Dob" class="<?= $Page->Dob->headerCellClass() ?>"><div id="elh_view_lab_services_Dob" class="view_lab_services_Dob"><?= $Page->renderSort($Page->Dob) ?></div></th>
<?php } ?>
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th data-name="Currency" class="<?= $Page->Currency->headerCellClass() ?>"><div id="elh_view_lab_services_Currency" class="view_lab_services_Currency"><?= $Page->renderSort($Page->Currency) ?></div></th>
<?php } ?>
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
        <th data-name="DiscountRemarks" class="<?= $Page->DiscountRemarks->headerCellClass() ?>"><div id="elh_view_lab_services_DiscountRemarks" class="view_lab_services_DiscountRemarks"><?= $Page->renderSort($Page->DiscountRemarks) ?></div></th>
<?php } ?>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
        <th data-name="CardNumber" class="<?= $Page->CardNumber->headerCellClass() ?>"><div id="elh_view_lab_services_CardNumber" class="view_lab_services_CardNumber"><?= $Page->renderSort($Page->CardNumber) ?></div></th>
<?php } ?>
<?php if ($Page->BankName->Visible) { // BankName ?>
        <th data-name="BankName" class="<?= $Page->BankName->headerCellClass() ?>"><div id="elh_view_lab_services_BankName" class="view_lab_services_BankName"><?= $Page->renderSort($Page->BankName) ?></div></th>
<?php } ?>
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th data-name="DrID" class="<?= $Page->DrID->headerCellClass() ?>"><div id="elh_view_lab_services_DrID" class="view_lab_services_DrID"><?= $Page->renderSort($Page->DrID) ?></div></th>
<?php } ?>
...
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
        <th data-name="BillStatus" class="<?= $Page->BillStatus->headerCellClass() ?>"><div id="elh_view_lab_services_BillStatus" class="view_lab_services_BillStatus"><?= $Page->renderSort($Page->BillStatus) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_Reception">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_mrnno">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_Age">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_IP_OP">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_voucher_type">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_Details">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_AnyDues">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_createdby">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_RealizationAmount">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_RealizationStatus">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_RealizationRemarks">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_RealizationBatchNo">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_RealizationDate">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_TidNo">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_CId">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_PayerType">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_Dob">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_Currency">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_DiscountRemarks">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_CardNumber">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_BankName">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_DrID">
...
<span id="el<?= $Page->RowCount ?>_view_lab_services_BillStatus">
