...
$Page->showMessage();
?>
<form name="fpharmacy_billing_returnadd" id="fpharmacy_billing_returnadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpharmacy_billing_returnadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_returnadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_billing_returnadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_returnadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
