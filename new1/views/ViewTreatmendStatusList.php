...
<form name="fview_treatmend_statuslistsrch" id="fview_treatmend_statuslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_treatmend_statuslist" id="fview_treatmend_statuslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->mobile_no->Visible) { // mobile_no ?>
        <th data-name="mobile_no" class="<?= $Page->mobile_no->headerCellClass() ?>"><div id="elh_view_treatmend_status_mobile_no" class="view_treatmend_status_mobile_no"><?= $Page->renderSort($Page->mobile_no) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_treatmend_status_mobile_no">
