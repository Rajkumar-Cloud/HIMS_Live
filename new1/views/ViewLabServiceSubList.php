...
<form name="fview_lab_service_sublistsrch" id="fview_lab_service_sublistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_lab_service_sublist" id="fview_lab_service_sublist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->AMOUNT->Visible) { // AMOUNT ?>
        <th data-name="AMOUNT" class="<?= $Page->AMOUNT->headerCellClass() ?>"><div id="elh_view_lab_service_sub_AMOUNT" class="view_lab_service_sub_AMOUNT"><?= $Page->renderSort($Page->AMOUNT) ?></div></th>
<?php } ?>
<?php if ($Page->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
        <th data-name="SERVICE_TYPE" class="<?= $Page->SERVICE_TYPE->headerCellClass() ?>"><div id="elh_view_lab_service_sub_SERVICE_TYPE" class="view_lab_service_sub_SERVICE_TYPE"><?= $Page->renderSort($Page->SERVICE_TYPE) ?></div></th>
<?php } ?>
<?php if ($Page->DEPARTMENT->Visible) { // DEPARTMENT ?>
        <th data-name="DEPARTMENT" class="<?= $Page->DEPARTMENT->headerCellClass() ?>"><div id="elh_view_lab_service_sub_DEPARTMENT" class="view_lab_service_sub_DEPARTMENT"><?= $Page->renderSort($Page->DEPARTMENT) ?></div></th>
<?php } ?>
<?php if ($Page->Created->Visible) { // Created ?>
        <th data-name="Created" class="<?= $Page->Created->headerCellClass() ?>"><div id="elh_view_lab_service_sub_Created" class="view_lab_service_sub_Created"><?= $Page->renderSort($Page->Created) ?></div></th>
<?php } ?>
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
        <th data-name="CreatedDateTime" class="<?= $Page->CreatedDateTime->headerCellClass() ?>"><div id="elh_view_lab_service_sub_CreatedDateTime" class="view_lab_service_sub_CreatedDateTime"><?= $Page->renderSort($Page->CreatedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->Modified->Visible) { // Modified ?>
        <th data-name="Modified" class="<?= $Page->Modified->headerCellClass() ?>"><div id="elh_view_lab_service_sub_Modified" class="view_lab_service_sub_Modified"><?= $Page->renderSort($Page->Modified) ?></div></th>
<?php } ?>
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
        <th data-name="ModifiedDateTime" class="<?= $Page->ModifiedDateTime->headerCellClass() ?>"><div id="elh_view_lab_service_sub_ModifiedDateTime" class="view_lab_service_sub_ModifiedDateTime"><?= $Page->renderSort($Page->ModifiedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
        <th data-name="mas_services_billingcol" class="<?= $Page->mas_services_billingcol->headerCellClass() ?>"><div id="elh_view_lab_service_sub_mas_services_billingcol" class="view_lab_service_sub_mas_services_billingcol"><?= $Page->renderSort($Page->mas_services_billingcol) ?></div></th>
<?php } ?>
<?php if ($Page->DrShareAmount->Visible) { // DrShareAmount ?>
        <th data-name="DrShareAmount" class="<?= $Page->DrShareAmount->headerCellClass() ?>"><div id="elh_view_lab_service_sub_DrShareAmount" class="view_lab_service_sub_DrShareAmount"><?= $Page->renderSort($Page->DrShareAmount) ?></div></th>
<?php } ?>
<?php if ($Page->HospShareAmount->Visible) { // HospShareAmount ?>
        <th data-name="HospShareAmount" class="<?= $Page->HospShareAmount->headerCellClass() ?>"><div id="elh_view_lab_service_sub_HospShareAmount" class="view_lab_service_sub_HospShareAmount"><?= $Page->renderSort($Page->HospShareAmount) ?></div></th>
<?php } ?>
<?php if ($Page->DrSharePer->Visible) { // DrSharePer ?>
        <th data-name="DrSharePer" class="<?= $Page->DrSharePer->headerCellClass() ?>"><div id="elh_view_lab_service_sub_DrSharePer" class="view_lab_service_sub_DrSharePer"><?= $Page->renderSort($Page->DrSharePer) ?></div></th>
<?php } ?>
<?php if ($Page->HospSharePer->Visible) { // HospSharePer ?>
        <th data-name="HospSharePer" class="<?= $Page->HospSharePer->headerCellClass() ?>"><div id="elh_view_lab_service_sub_HospSharePer" class="view_lab_service_sub_HospSharePer"><?= $Page->renderSort($Page->HospSharePer) ?></div></th>
<?php } ?>
...
<?php if ($Page->TestType->Visible) { // TestType ?>
        <th data-name="TestType" class="<?= $Page->TestType->headerCellClass() ?>"><div id="elh_view_lab_service_sub_TestType" class="view_lab_service_sub_TestType"><?= $Page->renderSort($Page->TestType) ?></div></th>
<?php } ?>
<?php if ($Page->NoHeading->Visible) { // NoHeading ?>
        <th data-name="NoHeading" class="<?= $Page->NoHeading->headerCellClass() ?>"><div id="elh_view_lab_service_sub_NoHeading" class="view_lab_service_sub_NoHeading"><?= $Page->renderSort($Page->NoHeading) ?></div></th>
<?php } ?>
<?php if ($Page->ChemicalCode->Visible) { // ChemicalCode ?>
        <th data-name="ChemicalCode" class="<?= $Page->ChemicalCode->headerCellClass() ?>"><div id="elh_view_lab_service_sub_ChemicalCode" class="view_lab_service_sub_ChemicalCode"><?= $Page->renderSort($Page->ChemicalCode) ?></div></th>
<?php } ?>
<?php if ($Page->ChemicalName->Visible) { // ChemicalName ?>
        <th data-name="ChemicalName" class="<?= $Page->ChemicalName->headerCellClass() ?>"><div id="elh_view_lab_service_sub_ChemicalName" class="view_lab_service_sub_ChemicalName"><?= $Page->renderSort($Page->ChemicalName) ?></div></th>
<?php } ?>
<?php if ($Page->Utilaization->Visible) { // Utilaization ?>
        <th data-name="Utilaization" class="<?= $Page->Utilaization->headerCellClass() ?>"><div id="elh_view_lab_service_sub_Utilaization" class="view_lab_service_sub_Utilaization"><?= $Page->renderSort($Page->Utilaization) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_AMOUNT">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_SERVICE_TYPE">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_DEPARTMENT">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_Created">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_CreatedDateTime">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_Modified">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_ModifiedDateTime">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_mas_services_billingcol">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_DrShareAmount">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_HospShareAmount">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_DrSharePer">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_HospSharePer">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_TestType">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_NoHeading">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_ChemicalCode">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_ChemicalName">
...
<span id="el<?= $Page->RowCount ?>_view_lab_service_sub_Utilaization">
