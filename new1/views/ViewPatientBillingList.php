...
<form name="fview_patient_billinglistsrch" id="fview_patient_billinglistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_patient_billinglist" id="fview_patient_billinglist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
