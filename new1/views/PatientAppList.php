...
<form name="fpatient_applistsrch" id="fpatient_applistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpatient_applist" id="fpatient_applist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
