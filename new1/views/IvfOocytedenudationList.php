...
<form name="fivf_oocytedenudationlistsrch" id="fivf_oocytedenudationlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fivf_oocytedenudationlist" id="fivf_oocytedenudationlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->patient2->Visible) { // patient2 ?>
        <th data-name="patient2" class="<?= $Page->patient2->headerCellClass() ?>"><div id="elh_ivf_oocytedenudation_patient2" class="ivf_oocytedenudation_patient2"><?= $Page->renderSort($Page->patient2) ?></div></th>
<?php } ?>
<?php if ($Page->OocytesDonate1->Visible) { // OocytesDonate1 ?>
        <th data-name="OocytesDonate1" class="<?= $Page->OocytesDonate1->headerCellClass() ?>"><div id="elh_ivf_oocytedenudation_OocytesDonate1" class="ivf_oocytedenudation_OocytesDonate1"><?= $Page->renderSort($Page->OocytesDonate1) ?></div></th>
<?php } ?>
<?php if ($Page->OocytesDonate2->Visible) { // OocytesDonate2 ?>
        <th data-name="OocytesDonate2" class="<?= $Page->OocytesDonate2->headerCellClass() ?>"><div id="elh_ivf_oocytedenudation_OocytesDonate2" class="ivf_oocytedenudation_OocytesDonate2"><?= $Page->renderSort($Page->OocytesDonate2) ?></div></th>
<?php } ?>
<?php if ($Page->ETDonate->Visible) { // ETDonate ?>
        <th data-name="ETDonate" class="<?= $Page->ETDonate->headerCellClass() ?>"><div id="elh_ivf_oocytedenudation_ETDonate" class="ivf_oocytedenudation_ETDonate"><?= $Page->renderSort($Page->ETDonate) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_patient2">
...
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_OocytesDonate1">
...
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_OocytesDonate2">
...
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_ETDonate">
