...
$Page->showMessage();
?>
<form name="fbilling_voucheredit" id="fbilling_voucheredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_billing_voucher_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<script>
loadjs.ready(["fbilling_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_voucheredit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_voucheredit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_voucheredit", "x_createdDatettime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
