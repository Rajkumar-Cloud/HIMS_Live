...
<form name="fpatient_ot_delivery_registerlistsrch" id="fpatient_ot_delivery_registerlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpatient_ot_delivery_registerlist" id="fpatient_ot_delivery_registerlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->ObstetricsHistryMale->Visible) { // ObstetricsHistryMale ?>
        <th data-name="ObstetricsHistryMale" class="<?= $Page->ObstetricsHistryMale->headerCellClass() ?>"><div id="elh_patient_ot_delivery_register_ObstetricsHistryMale" class="patient_ot_delivery_register_ObstetricsHistryMale"><?= $Page->renderSort($Page->ObstetricsHistryMale) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_patient_ot_delivery_register_ObstetricsHistryMale">
