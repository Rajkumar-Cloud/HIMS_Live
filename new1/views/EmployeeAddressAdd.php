...
$Page->showMessage();
?>
<form name="femployee_addressadd" id="femployee_addressadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_addressadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_addressadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_addressadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_addressadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
