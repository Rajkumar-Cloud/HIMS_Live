...
<form name="fivf_otherprocedurelistsrch" id="fivf_otherprocedurelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fivf_otherprocedurelist" id="fivf_otherprocedurelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_ivf_otherprocedure_Age" class="ivf_otherprocedure_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
<?php if ($Page->SEX->Visible) { // SEX ?>
        <th data-name="SEX" class="<?= $Page->SEX->headerCellClass() ?>"><div id="elh_ivf_otherprocedure_SEX" class="ivf_otherprocedure_SEX"><?= $Page->renderSort($Page->SEX) ?></div></th>
<?php } ?>
<?php if ($Page->Address->Visible) { // Address ?>
        <th data-name="Address" class="<?= $Page->Address->headerCellClass() ?>"><div id="elh_ivf_otherprocedure_Address" class="ivf_otherprocedure_Address"><?= $Page->renderSort($Page->Address) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ivf_otherprocedure_Age">
...
<span id="el<?= $Page->RowCount ?>_ivf_otherprocedure_SEX">
...
<span id="el<?= $Page->RowCount ?>_ivf_otherprocedure_Address">
