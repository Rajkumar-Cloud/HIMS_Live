...
$Page->showMessage();
?>
<form name="fmas_pharmacyedit" id="fmas_pharmacyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fmas_pharmacyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmas_pharmacyedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmas_pharmacyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmas_pharmacyedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
