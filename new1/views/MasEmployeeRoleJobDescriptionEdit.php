...
$Page->showMessage();
?>
<form name="fmas_employee_role_job_descriptionedit" id="fmas_employee_role_job_descriptionedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fmas_employee_role_job_descriptionedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmas_employee_role_job_descriptionedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmas_employee_role_job_descriptionedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmas_employee_role_job_descriptionedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
