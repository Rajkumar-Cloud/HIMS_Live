...
$Page->showMessage();
?>
<form name="fpharmacy_paymentedit" id="fpharmacy_paymentedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fpharmacy_paymentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_paymentedit", "x_DT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_paymentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_paymentedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_paymentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_paymentedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
