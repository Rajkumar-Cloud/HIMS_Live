...
<form name="fview_billing_voucher_voucherlistsrch" id="fview_billing_voucher_voucherlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_billing_voucher_voucherlist" id="fview_billing_voucher_voucherlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
        <th data-name="IP_OP" class="<?= $Page->IP_OP->headerCellClass() ?>"><div id="elh_view_billing_voucher_voucher_IP_OP" class="view_billing_voucher_voucher_IP_OP"><?= $Page->renderSort($Page->IP_OP) ?></div></th>
<?php } ?>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
        <th data-name="voucher_type" class="<?= $Page->voucher_type->headerCellClass() ?>"><div id="elh_view_billing_voucher_voucher_voucher_type" class="view_billing_voucher_voucher_voucher_type"><?= $Page->renderSort($Page->voucher_type) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_voucher_IP_OP">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_voucher_voucher_type">
