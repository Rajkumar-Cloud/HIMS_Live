...
$Page->showMessage();
?>
<form name="fbilling_refund_voucheradd" id="fbilling_refund_voucheradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fbilling_refund_voucheradd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_refund_voucheradd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_refund_voucheradd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_refund_voucheradd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
