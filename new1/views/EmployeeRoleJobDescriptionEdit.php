...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.employee_role_job_description.fields;
...
$Page->showMessage();
?>
<form name="femployee_role_job_descriptionedit" id="femployee_role_job_descriptionedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
