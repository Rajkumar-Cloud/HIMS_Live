...
// Page object
$LabTestMasterEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var flab_test_masteredit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.lab_test_master.fields;
    flab_test_masteredit.addFields([
        ...
        ["TestCd", [fields.TestCd.required ? ew.Validators.required(fields.TestCd.caption) : null], fields.TestCd.isInvalid],
        ["TestSubCd", [fields.TestSubCd.required ? ew.Validators.required(fields.TestSubCd.caption) : null], fields.TestSubCd.isInvalid],
        ["TestName", [fields.TestName.required ? ew.Validators.required(fields.TestName.caption) : null], fields.TestName.isInvalid],
        ["XrayPart", [fields.XrayPart.required ? ew.Validators.required(fields.XrayPart.caption) : null], fields.XrayPart.isInvalid],
        ...
        ["Amt", [fields.Amt.required ? ew.Validators.required(fields.Amt.caption) : null, ew.Validators.float], fields.Amt.isInvalid],
        ["SplAmt", [fields.SplAmt.required ? ew.Validators.required(fields.SplAmt.caption) : null, ew.Validators.float], fields.SplAmt.isInvalid],
        ...
        ["CreFrom", [fields.CreFrom.required ? ew.Validators.required(fields.CreFrom.caption) : null, ew.Validators.float], fields.CreFrom.isInvalid],
        ["CreTo", [fields.CreTo.required ? ew.Validators.required(fields.CreTo.caption) : null, ew.Validators.float], fields.CreTo.isInvalid],
        ["Note", [fields.Note.required ? ew.Validators.required(fields.Note.caption) : null], fields.Note.isInvalid],
        ["Sun", [fields.Sun.required ? ew.Validators.required(fields.Sun.caption) : null], fields.Sun.isInvalid],
        ["Mon", [fields.Mon.required ? ew.Validators.required(fields.Mon.caption) : null], fields.Mon.isInvalid],
        ["Tue", [fields.Tue.required ? ew.Validators.required(fields.Tue.caption) : null], fields.Tue.isInvalid],
        ["Wed", [fields.Wed.required ? ew.Validators.required(fields.Wed.caption) : null], fields.Wed.isInvalid],
        ["Thi", [fields.Thi.required ? ew.Validators.required(fields.Thi.caption) : null], fields.Thi.isInvalid],
        ["Fri", [fields.Fri.required ? ew.Validators.required(fields.Fri.caption) : null], fields.Fri.isInvalid],
        ["Sat", [fields.Sat.required ? ew.Validators.required(fields.Sat.caption) : null], fields.Sat.isInvalid],
        ["Days", [fields.Days.required ? ew.Validators.required(fields.Days.caption) : null, ew.Validators.float], fields.Days.isInvalid],
        ["Cutoff", [fields.Cutoff.required ? ew.Validators.required(fields.Cutoff.caption) : null], fields.Cutoff.isInvalid],
        ["FontBold", [fields.FontBold.required ? ew.Validators.required(fields.FontBold.caption) : null], fields.FontBold.isInvalid],
        ["TestHeading", [fields.TestHeading.required ? ew.Validators.required(fields.TestHeading.caption) : null], fields.TestHeading.isInvalid],
        ["Outsource", [fields.Outsource.required ? ew.Validators.required(fields.Outsource.caption) : null], fields.Outsource.isInvalid],
        ["NoResult", [fields.NoResult.required ? ew.Validators.required(fields.NoResult.caption) : null], fields.NoResult.isInvalid],
        ["GraphLow", [fields.GraphLow.required ? ew.Validators.required(fields.GraphLow.caption) : null, ew.Validators.float], fields.GraphLow.isInvalid],
        ["GraphHigh", [fields.GraphHigh.required ? ew.Validators.required(fields.GraphHigh.caption) : null, ew.Validators.float], fields.GraphHigh.isInvalid],
        ["CollSample", [fields.CollSample.required ? ew.Validators.required(fields.CollSample.caption) : null], fields.CollSample.isInvalid],
        ["ProcessTime", [fields.ProcessTime.required ? ew.Validators.required(fields.ProcessTime.caption) : null], fields.ProcessTime.isInvalid],
        ["TamilName", [fields.TamilName.required ? ew.Validators.required(fields.TamilName.caption) : null], fields.TamilName.isInvalid],
        ...
        ["PrevSplAmt", [fields.PrevSplAmt.required ? ew.Validators.required(fields.PrevSplAmt.caption) : null, ew.Validators.float], fields.PrevSplAmt.isInvalid],
        ...
        ["AutoAuth", [fields.AutoAuth.required ? ew.Validators.required(fields.AutoAuth.caption) : null], fields.AutoAuth.isInvalid],
        ["ProductCD", [fields.ProductCD.required ? ew.Validators.required(fields.ProductCD.caption) : null], fields.ProductCD.isInvalid],
        ["Inventory", [fields.Inventory.required ? ew.Validators.required(fields.Inventory.caption) : null], fields.Inventory.isInvalid],
        ["IntimateTest", [fields.IntimateTest.required ? ew.Validators.required(fields.IntimateTest.caption) : null], fields.IntimateTest.isInvalid],
        ["Manual", [fields.Manual.required ? ew.Validators.required(fields.Manual.caption) : null], fields.Manual.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = flab_test_masteredit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    flab_test_masteredit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flab_test_masteredit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="flab_test_masteredit" id="flab_test_masteredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_lab_test_master_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_lab_test_master_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="lab_test_master" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
