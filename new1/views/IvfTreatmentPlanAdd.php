...
$Page->showMessage();
?>
<form name="fivf_treatment_planadd" id="fivf_treatment_planadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fivf_treatment_planadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_treatment_planadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_treatment_planadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_treatment_planadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_treatment_planadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_treatment_planadd", "x_TreatmentStartDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_treatment_planadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_treatment_planadd", "x_TreatementStopDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
