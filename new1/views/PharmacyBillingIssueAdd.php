...
$Page->showMessage();
?>
<form name="fpharmacy_billing_issueadd" id="fpharmacy_billing_issueadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpharmacy_billing_issueadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_issueadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_billing_issueadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_issueadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
