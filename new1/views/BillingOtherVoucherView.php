...
$Page->showMessage();
?>
<form name="fbilling_other_voucherview" id="fbilling_other_voucherview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->Name->Visible) { // Name ?>
    <tr id="r_Name">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Name"><?= $Page->Name->caption() ?></span></td>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <tr id="r_Mobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Mobile"><?= $Page->Mobile->caption() ?></span></td>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
    <tr id="r_voucher_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_voucher_type"><?= $Page->voucher_type->caption() ?></span></td>
...
<?php if ($Page->Details->Visible) { // Details ?>
    <tr id="r_Details">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Details"><?= $Page->Details->caption() ?></span></td>
...
<?php if ($Page->ModeofPayment->Visible) { // ModeofPayment ?>
    <tr id="r_ModeofPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_ModeofPayment"><?= $Page->ModeofPayment->caption() ?></span></td>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <tr id="r_Amount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Amount"><?= $Page->Amount->caption() ?></span></td>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
    <tr id="r_AnyDues">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_AnyDues"><?= $Page->AnyDues->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->PatID->Visible) { // PatID ?>
    <tr id="r_PatID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_PatID"><?= $Page->PatID->caption() ?></span></td>
...
<?php if ($Page->PatientID->Visible) { // PatientID ?>
    <tr id="r_PatientID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_PatientID"><?= $Page->PatientID->caption() ?></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_PatientName"><?= $Page->PatientName->caption() ?></span></td>
...
<?php if ($Page->VisiteType->Visible) { // VisiteType ?>
    <tr id="r_VisiteType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_VisiteType"><?= $Page->VisiteType->caption() ?></span></td>
...
<?php if ($Page->VisitDate->Visible) { // VisitDate ?>
    <tr id="r_VisitDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_VisitDate"><?= $Page->VisitDate->caption() ?></span></td>
...
<?php if ($Page->AdvanceNo->Visible) { // AdvanceNo ?>
    <tr id="r_AdvanceNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_AdvanceNo"><?= $Page->AdvanceNo->caption() ?></span></td>
...
<?php if ($Page->Status->Visible) { // Status ?>
    <tr id="r_Status">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Status"><?= $Page->Status->caption() ?></span></td>
...
<?php if ($Page->Date->Visible) { // Date ?>
    <tr id="r_Date">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Date"><?= $Page->Date->caption() ?></span></td>
...
<?php if ($Page->AdvanceValidityDate->Visible) { // AdvanceValidityDate ?>
    <tr id="r_AdvanceValidityDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_AdvanceValidityDate"><?= $Page->AdvanceValidityDate->caption() ?></span></td>
...
<?php if ($Page->TotalRemainingAdvance->Visible) { // TotalRemainingAdvance ?>
    <tr id="r_TotalRemainingAdvance">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_TotalRemainingAdvance"><?= $Page->TotalRemainingAdvance->caption() ?></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Remarks"><?= $Page->Remarks->caption() ?></span></td>
...
<?php if ($Page->SeectPaymentMode->Visible) { // SeectPaymentMode ?>
    <tr id="r_SeectPaymentMode">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_SeectPaymentMode"><?= $Page->SeectPaymentMode->caption() ?></span></td>
...
<?php if ($Page->PaidAmount->Visible) { // PaidAmount ?>
    <tr id="r_PaidAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_PaidAmount"><?= $Page->PaidAmount->caption() ?></span></td>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <tr id="r_Currency">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Currency"><?= $Page->Currency->caption() ?></span></td>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <tr id="r_CardNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CardNumber"><?= $Page->CardNumber->caption() ?></span></td>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <tr id="r_BankName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_BankName"><?= $Page->BankName->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_Reception"><?= $Page->Reception->caption() ?></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_mrnno"><?= $Page->mrnno->caption() ?></span></td>
...
<?php if ($Page->GetUserName->Visible) { // GetUserName ?>
    <tr id="r_GetUserName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_GetUserName"><?= $Page->GetUserName->caption() ?></span></td>
...
<?php if ($Page->AdjustmentwithAdvance->Visible) { // AdjustmentwithAdvance ?>
    <tr id="r_AdjustmentwithAdvance">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_AdjustmentwithAdvance"><?= $Page->AdjustmentwithAdvance->caption() ?></span></td>
...
<?php if ($Page->AdjustmentBillNumber->Visible) { // AdjustmentBillNumber ?>
    <tr id="r_AdjustmentBillNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_AdjustmentBillNumber"><?= $Page->AdjustmentBillNumber->caption() ?></span></td>
...
<?php if ($Page->CancelAdvance->Visible) { // CancelAdvance ?>
    <tr id="r_CancelAdvance">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CancelAdvance"><?= $Page->CancelAdvance->caption() ?></span></td>
...
<?php if ($Page->CancelReasan->Visible) { // CancelReasan ?>
    <tr id="r_CancelReasan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CancelReasan"><?= $Page->CancelReasan->caption() ?></span></td>
...
<?php if ($Page->CancelBy->Visible) { // CancelBy ?>
    <tr id="r_CancelBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CancelBy"><?= $Page->CancelBy->caption() ?></span></td>
...
<?php if ($Page->CancelDate->Visible) { // CancelDate ?>
    <tr id="r_CancelDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CancelDate"><?= $Page->CancelDate->caption() ?></span></td>
...
<?php if ($Page->CancelDateTime->Visible) { // CancelDateTime ?>
    <tr id="r_CancelDateTime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CancelDateTime"><?= $Page->CancelDateTime->caption() ?></span></td>
...
<?php if ($Page->CanceledBy->Visible) { // CanceledBy ?>
    <tr id="r_CanceledBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CanceledBy"><?= $Page->CanceledBy->caption() ?></span></td>
...
<?php if ($Page->CancelStatus->Visible) { // CancelStatus ?>
    <tr id="r_CancelStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_billing_other_voucher_CancelStatus"><?= $Page->CancelStatus->caption() ?></span></td>
