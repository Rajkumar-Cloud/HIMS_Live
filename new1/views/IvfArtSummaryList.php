...
<form name="fivf_art_summarylistsrch" id="fivf_art_summarylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fivf_art_summarylist" id="fivf_art_summarylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
