...
$Page->showMessage();
?>
<form name="fpres_trade_combination_names_newview" id="fpres_trade_combination_names_newview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
