...
<form name="fview_billing_voucherlistsrch" id="fview_billing_voucherlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_billing_voucherlist" id="fview_billing_voucherlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_view_billing_voucher_id" class="view_billing_voucher_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th data-name="Reception" class="<?= $Page->Reception->headerCellClass() ?>"><div id="elh_view_billing_voucher_Reception" class="view_billing_voucher_Reception"><?= $Page->renderSort($Page->Reception) ?></div></th>
<?php } ?>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
        <th data-name="mrnno" class="<?= $Page->mrnno->headerCellClass() ?>"><div id="elh_view_billing_voucher_mrnno" class="view_billing_voucher_mrnno"><?= $Page->renderSort($Page->mrnno) ?></div></th>
<?php } ?>
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_view_billing_voucher_Age" class="view_billing_voucher_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
<?php if ($Page->Gender->Visible) { // Gender ?>
        <th data-name="Gender" class="<?= $Page->Gender->headerCellClass() ?>"><div id="elh_view_billing_voucher_Gender" class="view_billing_voucher_Gender"><?= $Page->renderSort($Page->Gender) ?></div></th>
<?php } ?>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
        <th data-name="IP_OP" class="<?= $Page->IP_OP->headerCellClass() ?>"><div id="elh_view_billing_voucher_IP_OP" class="view_billing_voucher_IP_OP"><?= $Page->renderSort($Page->IP_OP) ?></div></th>
<?php } ?>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
        <th data-name="voucher_type" class="<?= $Page->voucher_type->headerCellClass() ?>"><div id="elh_view_billing_voucher_voucher_type" class="view_billing_voucher_voucher_type"><?= $Page->renderSort($Page->voucher_type) ?></div></th>
<?php } ?>
<?php if ($Page->Details->Visible) { // Details ?>
        <th data-name="Details" class="<?= $Page->Details->headerCellClass() ?>"><div id="elh_view_billing_voucher_Details" class="view_billing_voucher_Details"><?= $Page->renderSort($Page->Details) ?></div></th>
<?php } ?>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
        <th data-name="AnyDues" class="<?= $Page->AnyDues->headerCellClass() ?>"><div id="elh_view_billing_voucher_AnyDues" class="view_billing_voucher_AnyDues"><?= $Page->renderSort($Page->AnyDues) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_view_billing_voucher_createdby" class="view_billing_voucher_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_view_billing_voucher_modifiedby" class="view_billing_voucher_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_view_billing_voucher_modifieddatetime" class="view_billing_voucher_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
        <th data-name="RealizationAmount" class="<?= $Page->RealizationAmount->headerCellClass() ?>"><div id="elh_view_billing_voucher_RealizationAmount" class="view_billing_voucher_RealizationAmount"><?= $Page->renderSort($Page->RealizationAmount) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
        <th data-name="RealizationStatus" class="<?= $Page->RealizationStatus->headerCellClass() ?>"><div id="elh_view_billing_voucher_RealizationStatus" class="view_billing_voucher_RealizationStatus"><?= $Page->renderSort($Page->RealizationStatus) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
        <th data-name="RealizationRemarks" class="<?= $Page->RealizationRemarks->headerCellClass() ?>"><div id="elh_view_billing_voucher_RealizationRemarks" class="view_billing_voucher_RealizationRemarks"><?= $Page->renderSort($Page->RealizationRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
        <th data-name="RealizationBatchNo" class="<?= $Page->RealizationBatchNo->headerCellClass() ?>"><div id="elh_view_billing_voucher_RealizationBatchNo" class="view_billing_voucher_RealizationBatchNo"><?= $Page->renderSort($Page->RealizationBatchNo) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
        <th data-name="RealizationDate" class="<?= $Page->RealizationDate->headerCellClass() ?>"><div id="elh_view_billing_voucher_RealizationDate" class="view_billing_voucher_RealizationDate"><?= $Page->renderSort($Page->RealizationDate) ?></div></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_view_billing_voucher_HospID" class="view_billing_voucher_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
        <th data-name="RIDNO" class="<?= $Page->RIDNO->headerCellClass() ?>"><div id="elh_view_billing_voucher_RIDNO" class="view_billing_voucher_RIDNO"><?= $Page->renderSort($Page->RIDNO) ?></div></th>
<?php } ?>
<?php if ($Page->TidNo->Visible) { // TidNo ?>
        <th data-name="TidNo" class="<?= $Page->TidNo->headerCellClass() ?>"><div id="elh_view_billing_voucher_TidNo" class="view_billing_voucher_TidNo"><?= $Page->renderSort($Page->TidNo) ?></div></th>
<?php } ?>
<?php if ($Page->CId->Visible) { // CId ?>
        <th data-name="CId" class="<?= $Page->CId->headerCellClass() ?>"><div id="elh_view_billing_voucher_CId" class="view_billing_voucher_CId"><?= $Page->renderSort($Page->CId) ?></div></th>
<?php } ?>
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
        <th data-name="PartnerName" class="<?= $Page->PartnerName->headerCellClass() ?>"><div id="elh_view_billing_voucher_PartnerName" class="view_billing_voucher_PartnerName"><?= $Page->renderSort($Page->PartnerName) ?></div></th>
<?php } ?>
<?php if ($Page->PayerType->Visible) { // PayerType ?>
        <th data-name="PayerType" class="<?= $Page->PayerType->headerCellClass() ?>"><div id="elh_view_billing_voucher_PayerType" class="view_billing_voucher_PayerType"><?= $Page->renderSort($Page->PayerType) ?></div></th>
<?php } ?>
<?php if ($Page->Dob->Visible) { // Dob ?>
        <th data-name="Dob" class="<?= $Page->Dob->headerCellClass() ?>"><div id="elh_view_billing_voucher_Dob" class="view_billing_voucher_Dob"><?= $Page->renderSort($Page->Dob) ?></div></th>
<?php } ?>
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th data-name="Currency" class="<?= $Page->Currency->headerCellClass() ?>"><div id="elh_view_billing_voucher_Currency" class="view_billing_voucher_Currency"><?= $Page->renderSort($Page->Currency) ?></div></th>
<?php } ?>
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
        <th data-name="DiscountRemarks" class="<?= $Page->DiscountRemarks->headerCellClass() ?>"><div id="elh_view_billing_voucher_DiscountRemarks" class="view_billing_voucher_DiscountRemarks"><?= $Page->renderSort($Page->DiscountRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->PatId->Visible) { // PatId ?>
        <th data-name="PatId" class="<?= $Page->PatId->headerCellClass() ?>"><div id="elh_view_billing_voucher_PatId" class="view_billing_voucher_PatId"><?= $Page->renderSort($Page->PatId) ?></div></th>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
        <th data-name="DrDepartment" class="<?= $Page->DrDepartment->headerCellClass() ?>"><div id="elh_view_billing_voucher_DrDepartment" class="view_billing_voucher_DrDepartment"><?= $Page->renderSort($Page->DrDepartment) ?></div></th>
<?php } ?>
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
        <th data-name="RefferedBy" class="<?= $Page->RefferedBy->headerCellClass() ?>"><div id="elh_view_billing_voucher_RefferedBy" class="view_billing_voucher_RefferedBy"><?= $Page->renderSort($Page->RefferedBy) ?></div></th>
<?php } ?>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
        <th data-name="CardNumber" class="<?= $Page->CardNumber->headerCellClass() ?>"><div id="elh_view_billing_voucher_CardNumber" class="view_billing_voucher_CardNumber"><?= $Page->renderSort($Page->CardNumber) ?></div></th>
<?php } ?>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th data-name="DrID" class="<?= $Page->DrID->headerCellClass() ?>"><div id="elh_view_billing_voucher_DrID" class="view_billing_voucher_DrID"><?= $Page->renderSort($Page->DrID) ?></div></th>
<?php } ?>
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
        <th data-name="BillStatus" class="<?= $Page->BillStatus->headerCellClass() ?>"><div id="elh_view_billing_voucher_BillStatus" class="view_billing_voucher_BillStatus"><?= $Page->renderSort($Page->BillStatus) ?></div></th>
<?php } ?>
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
        <th data-name="ReportHeader" class="<?= $Page->ReportHeader->headerCellClass() ?>"><div id="elh_view_billing_voucher_ReportHeader" class="view_billing_voucher_ReportHeader"><?= $Page->renderSort($Page->ReportHeader) ?></div></th>
<?php } ?>
...
<?php if ($Page->AdjustmentAdvance->Visible) { // AdjustmentAdvance ?>
        <th data-name="AdjustmentAdvance" class="<?= $Page->AdjustmentAdvance->headerCellClass() ?>"><div id="elh_view_billing_voucher_AdjustmentAdvance" class="view_billing_voucher_AdjustmentAdvance"><?= $Page->renderSort($Page->AdjustmentAdvance) ?></div></th>
<?php } ?>
<?php if ($Page->billing_vouchercol->Visible) { // billing_vouchercol ?>
        <th data-name="billing_vouchercol" class="<?= $Page->billing_vouchercol->headerCellClass() ?>"><div id="elh_view_billing_voucher_billing_vouchercol" class="view_billing_voucher_billing_vouchercol"><?= $Page->renderSort($Page->billing_vouchercol) ?></div></th>
<?php } ?>
...
<?php if ($Page->ProcedureName->Visible) { // ProcedureName ?>
        <th data-name="ProcedureName" class="<?= $Page->ProcedureName->headerCellClass() ?>"><div id="elh_view_billing_voucher_ProcedureName" class="view_billing_voucher_ProcedureName"><?= $Page->renderSort($Page->ProcedureName) ?></div></th>
<?php } ?>
<?php if ($Page->ProcedureAmount->Visible) { // ProcedureAmount ?>
        <th data-name="ProcedureAmount" class="<?= $Page->ProcedureAmount->headerCellClass() ?>"><div id="elh_view_billing_voucher_ProcedureAmount" class="view_billing_voucher_ProcedureAmount"><?= $Page->renderSort($Page->ProcedureAmount) ?></div></th>
<?php } ?>
<?php if ($Page->IncludePackage->Visible) { // IncludePackage ?>
        <th data-name="IncludePackage" class="<?= $Page->IncludePackage->headerCellClass() ?>"><div id="elh_view_billing_voucher_IncludePackage" class="view_billing_voucher_IncludePackage"><?= $Page->renderSort($Page->IncludePackage) ?></div></th>
<?php } ?>
...
<?php if ($Page->CancelModeOfPayment->Visible) { // CancelModeOfPayment ?>
        <th data-name="CancelModeOfPayment" class="<?= $Page->CancelModeOfPayment->headerCellClass() ?>"><div id="elh_view_billing_voucher_CancelModeOfPayment" class="view_billing_voucher_CancelModeOfPayment"><?= $Page->renderSort($Page->CancelModeOfPayment) ?></div></th>
<?php } ?>
<?php if ($Page->CancelAmount->Visible) { // CancelAmount ?>
        <th data-name="CancelAmount" class="<?= $Page->CancelAmount->headerCellClass() ?>"><div id="elh_view_billing_voucher_CancelAmount" class="view_billing_voucher_CancelAmount"><?= $Page->renderSort($Page->CancelAmount) ?></div></th>
<?php } ?>
<?php if ($Page->CancelBankName->Visible) { // CancelBankName ?>
        <th data-name="CancelBankName" class="<?= $Page->CancelBankName->headerCellClass() ?>"><div id="elh_view_billing_voucher_CancelBankName" class="view_billing_voucher_CancelBankName"><?= $Page->renderSort($Page->CancelBankName) ?></div></th>
<?php } ?>
<?php if ($Page->CancelTransactionNumber->Visible) { // CancelTransactionNumber ?>
        <th data-name="CancelTransactionNumber" class="<?= $Page->CancelTransactionNumber->headerCellClass() ?>"><div id="elh_view_billing_voucher_CancelTransactionNumber" class="view_billing_voucher_CancelTransactionNumber"><?= $Page->renderSort($Page->CancelTransactionNumber) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_id">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_Reception">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_mrnno">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_Age">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_Gender">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_IP_OP">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_voucher_type">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_Details">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_AnyDues">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_createdby">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RealizationAmount">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RealizationStatus">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RealizationRemarks">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RealizationBatchNo">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RealizationDate">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_HospID">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RIDNO">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_TidNo">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_CId">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_PartnerName">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_PayerType">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_Dob">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_Currency">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_DiscountRemarks">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_PatId">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_DrDepartment">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_RefferedBy">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_CardNumber">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_DrID">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_BillStatus">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_ReportHeader">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_AdjustmentAdvance">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_billing_vouchercol">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_ProcedureName">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_ProcedureAmount">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_IncludePackage">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_CancelModeOfPayment">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_CancelAmount">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_CancelBankName">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_CancelTransactionNumber">
