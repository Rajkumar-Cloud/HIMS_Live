...
$Page->showMessage();
?>
<form name="fpres_mas_timeoftakingdelete" id="fpres_mas_timeoftakingdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Time_Of_Taking->Visible) { // Time Of Taking ?>
        <th class="<?= $Page->Time_Of_Taking->headerCellClass() ?>"><span id="elh_pres_mas_timeoftaking_Time_Of_Taking" class="pres_mas_timeoftaking_Time_Of_Taking"><?= $Page->Time_Of_Taking->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php } ?>
<?php if ($Page->Time_Of_Taking->Visible) { // Time Of Taking ?>
        <td <?= $Page->Time_Of_Taking->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pres_mas_timeoftaking_Time_Of_Taking" class="pres_mas_timeoftaking_Time_Of_Taking">
