...
<form name="fdepositdetailslistsrch" id="fdepositdetailslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fdepositdetailslist" id="fdepositdetailslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->DepositToBankSelect->Visible) { // DepositToBankSelect ?>
        <th data-name="DepositToBankSelect" class="<?= $Page->DepositToBankSelect->headerCellClass() ?>"><div id="elh_depositdetails_DepositToBankSelect" class="depositdetails_DepositToBankSelect"><?= $Page->renderSort($Page->DepositToBankSelect) ?></div></th>
<?php } ?>
<?php if ($Page->DepositToBank->Visible) { // DepositToBank ?>
        <th data-name="DepositToBank" class="<?= $Page->DepositToBank->headerCellClass() ?>"><div id="elh_depositdetails_DepositToBank" class="depositdetails_DepositToBank"><?= $Page->renderSort($Page->DepositToBank) ?></div></th>
<?php } ?>
<?php if ($Page->TransferToSelect->Visible) { // TransferToSelect ?>
        <th data-name="TransferToSelect" class="<?= $Page->TransferToSelect->headerCellClass() ?>"><div id="elh_depositdetails_TransferToSelect" class="depositdetails_TransferToSelect"><?= $Page->renderSort($Page->TransferToSelect) ?></div></th>
<?php } ?>
...
<?php if ($Page->A2000Count->Visible) { // A2000Count ?>
        <th data-name="A2000Count" class="<?= $Page->A2000Count->headerCellClass() ?>"><div id="elh_depositdetails_A2000Count" class="depositdetails_A2000Count"><?= $Page->renderSort($Page->A2000Count) ?></div></th>
<?php } ?>
<?php if ($Page->A2000Amount->Visible) { // A2000Amount ?>
        <th data-name="A2000Amount" class="<?= $Page->A2000Amount->headerCellClass() ?>"><div id="elh_depositdetails_A2000Amount" class="depositdetails_A2000Amount"><?= $Page->renderSort($Page->A2000Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A1000Count->Visible) { // A1000Count ?>
        <th data-name="A1000Count" class="<?= $Page->A1000Count->headerCellClass() ?>"><div id="elh_depositdetails_A1000Count" class="depositdetails_A1000Count"><?= $Page->renderSort($Page->A1000Count) ?></div></th>
<?php } ?>
<?php if ($Page->A1000Amount->Visible) { // A1000Amount ?>
        <th data-name="A1000Amount" class="<?= $Page->A1000Amount->headerCellClass() ?>"><div id="elh_depositdetails_A1000Amount" class="depositdetails_A1000Amount"><?= $Page->renderSort($Page->A1000Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A500Count->Visible) { // A500Count ?>
        <th data-name="A500Count" class="<?= $Page->A500Count->headerCellClass() ?>"><div id="elh_depositdetails_A500Count" class="depositdetails_A500Count"><?= $Page->renderSort($Page->A500Count) ?></div></th>
<?php } ?>
<?php if ($Page->A500Amount->Visible) { // A500Amount ?>
        <th data-name="A500Amount" class="<?= $Page->A500Amount->headerCellClass() ?>"><div id="elh_depositdetails_A500Amount" class="depositdetails_A500Amount"><?= $Page->renderSort($Page->A500Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A200Count->Visible) { // A200Count ?>
        <th data-name="A200Count" class="<?= $Page->A200Count->headerCellClass() ?>"><div id="elh_depositdetails_A200Count" class="depositdetails_A200Count"><?= $Page->renderSort($Page->A200Count) ?></div></th>
<?php } ?>
<?php if ($Page->A200Amount->Visible) { // A200Amount ?>
        <th data-name="A200Amount" class="<?= $Page->A200Amount->headerCellClass() ?>"><div id="elh_depositdetails_A200Amount" class="depositdetails_A200Amount"><?= $Page->renderSort($Page->A200Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A100Count->Visible) { // A100Count ?>
        <th data-name="A100Count" class="<?= $Page->A100Count->headerCellClass() ?>"><div id="elh_depositdetails_A100Count" class="depositdetails_A100Count"><?= $Page->renderSort($Page->A100Count) ?></div></th>
<?php } ?>
<?php if ($Page->A100Amount->Visible) { // A100Amount ?>
        <th data-name="A100Amount" class="<?= $Page->A100Amount->headerCellClass() ?>"><div id="elh_depositdetails_A100Amount" class="depositdetails_A100Amount"><?= $Page->renderSort($Page->A100Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A50Count->Visible) { // A50Count ?>
        <th data-name="A50Count" class="<?= $Page->A50Count->headerCellClass() ?>"><div id="elh_depositdetails_A50Count" class="depositdetails_A50Count"><?= $Page->renderSort($Page->A50Count) ?></div></th>
<?php } ?>
<?php if ($Page->A50Amount->Visible) { // A50Amount ?>
        <th data-name="A50Amount" class="<?= $Page->A50Amount->headerCellClass() ?>"><div id="elh_depositdetails_A50Amount" class="depositdetails_A50Amount"><?= $Page->renderSort($Page->A50Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A20Count->Visible) { // A20Count ?>
        <th data-name="A20Count" class="<?= $Page->A20Count->headerCellClass() ?>"><div id="elh_depositdetails_A20Count" class="depositdetails_A20Count"><?= $Page->renderSort($Page->A20Count) ?></div></th>
<?php } ?>
<?php if ($Page->A20Amount->Visible) { // A20Amount ?>
        <th data-name="A20Amount" class="<?= $Page->A20Amount->headerCellClass() ?>"><div id="elh_depositdetails_A20Amount" class="depositdetails_A20Amount"><?= $Page->renderSort($Page->A20Amount) ?></div></th>
<?php } ?>
<?php if ($Page->A10Count->Visible) { // A10Count ?>
        <th data-name="A10Count" class="<?= $Page->A10Count->headerCellClass() ?>"><div id="elh_depositdetails_A10Count" class="depositdetails_A10Count"><?= $Page->renderSort($Page->A10Count) ?></div></th>
<?php } ?>
<?php if ($Page->A10Amount->Visible) { // A10Amount ?>
        <th data-name="A10Amount" class="<?= $Page->A10Amount->headerCellClass() ?>"><div id="elh_depositdetails_A10Amount" class="depositdetails_A10Amount"><?= $Page->renderSort($Page->A10Amount) ?></div></th>
<?php } ?>
...
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
        <th data-name="CreatedBy" class="<?= $Page->CreatedBy->headerCellClass() ?>"><div id="elh_depositdetails_CreatedBy" class="depositdetails_CreatedBy"><?= $Page->renderSort($Page->CreatedBy) ?></div></th>
<?php } ?>
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
        <th data-name="CreatedDateTime" class="<?= $Page->CreatedDateTime->headerCellClass() ?>"><div id="elh_depositdetails_CreatedDateTime" class="depositdetails_CreatedDateTime"><?= $Page->renderSort($Page->CreatedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->ModifiedBy->Visible) { // ModifiedBy ?>
        <th data-name="ModifiedBy" class="<?= $Page->ModifiedBy->headerCellClass() ?>"><div id="elh_depositdetails_ModifiedBy" class="depositdetails_ModifiedBy"><?= $Page->renderSort($Page->ModifiedBy) ?></div></th>
<?php } ?>
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
        <th data-name="ModifiedDateTime" class="<?= $Page->ModifiedDateTime->headerCellClass() ?>"><div id="elh_depositdetails_ModifiedDateTime" class="depositdetails_ModifiedDateTime"><?= $Page->renderSort($Page->ModifiedDateTime) ?></div></th>
<?php } ?>
...
<?php if ($Page->ModifiedUserName->Visible) { // ModifiedUserName ?>
        <th data-name="ModifiedUserName" class="<?= $Page->ModifiedUserName->headerCellClass() ?>"><div id="elh_depositdetails_ModifiedUserName" class="depositdetails_ModifiedUserName"><?= $Page->renderSort($Page->ModifiedUserName) ?></div></th>
<?php } ?>
<?php if ($Page->BalanceAmount->Visible) { // BalanceAmount ?>
        <th data-name="BalanceAmount" class="<?= $Page->BalanceAmount->headerCellClass() ?>"><div id="elh_depositdetails_BalanceAmount" class="depositdetails_BalanceAmount"><?= $Page->renderSort($Page->BalanceAmount) ?></div></th>
<?php } ?>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_depositdetails_HospID" class="depositdetails_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_depositdetails_DepositToBankSelect">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_DepositToBank">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_TransferToSelect">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A2000Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A2000Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A1000Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A1000Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A500Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A500Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A200Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A200Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A100Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A100Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A50Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A50Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A20Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A20Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A10Count">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_A10Amount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_CreatedBy">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_CreatedDateTime">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_ModifiedBy">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_ModifiedDateTime">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_ModifiedUserName">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_BalanceAmount">
...
<span id="el<?= $Page->RowCount ?>_depositdetails_HospID">
