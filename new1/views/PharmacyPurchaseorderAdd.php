...
$Page->showMessage();
?>
<form name="fpharmacy_purchaseorderadd" id="fpharmacy_purchaseorderadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpharmacy_purchaseorderadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_purchaseorderadd", "x_ExpDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_purchaseorderadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_purchaseorderadd", "x_CreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_purchaseorderadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_purchaseorderadd", "x_ModifiedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
