...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.appointment_reminder.fields;
    fappointment_reminderedit.addFields([
        ["id", [fields.id.required ? ew.Validators.required(fields.id.caption) : null], fields.id.isInvalid],
        ["reminder", [fields.reminder.required ? ew.Validators.required(fields.reminder.caption) : null], fields.reminder.isInvalid],
        ...
        ["SMSSend", [fields.SMSSend.required ? ew.Validators.required(fields.SMSSend.caption) : null, ew.Validators.integer], fields.SMSSend.isInvalid],
        ["EmailSend", [fields.EmailSend.required ? ew.Validators.required(fields.EmailSend.caption) : null, ew.Validators.integer], fields.EmailSend.isInvalid]
    ]);
...
$Page->showMessage();
?>
<form name="fappointment_reminderedit" id="fappointment_reminderedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
