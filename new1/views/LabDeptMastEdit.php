...
// Page object
$LabDeptMastEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var flab_dept_mastedit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.lab_dept_mast.fields;
    flab_dept_mastedit.addFields([
        ["MainCD", [fields.MainCD.required ? ew.Validators.required(fields.MainCD.caption) : null], fields.MainCD.isInvalid],
        ...
        ["SignCD", [fields.SignCD.required ? ew.Validators.required(fields.SignCD.caption) : null], fields.SignCD.isInvalid],
        ["Collection", [fields.Collection.required ? ew.Validators.required(fields.Collection.caption) : null], fields.Collection.isInvalid],
        ...
        ["SMS", [fields.SMS.required ? ew.Validators.required(fields.SMS.caption) : null], fields.SMS.isInvalid],
        ["Note", [fields.Note.required ? ew.Validators.required(fields.Note.caption) : null], fields.Note.isInvalid],
        ["WorkList", [fields.WorkList.required ? ew.Validators.required(fields.WorkList.caption) : null], fields.WorkList.isInvalid],
        ["_Page", [fields._Page.required ? ew.Validators.required(fields._Page.caption) : null, ew.Validators.float], fields._Page.isInvalid],
        ["Incharge", [fields.Incharge.required ? ew.Validators.required(fields.Incharge.caption) : null], fields.Incharge.isInvalid],
        ["AutoNum", [fields.AutoNum.required ? ew.Validators.required(fields.AutoNum.caption) : null], fields.AutoNum.isInvalid],
        ["id", [fields.id.required ? ew.Validators.required(fields.id.caption) : null], fields.id.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = flab_dept_mastedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    flab_dept_mastedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flab_dept_mastedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="flab_dept_mastedit" id="flab_dept_mastedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_lab_dept_mast_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_lab_dept_mast_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="lab_dept_mast" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
</div><!-- /page* -->
