...
$Page->showMessage();
?>
<form name="fappointment_scheduleredit" id="fappointment_scheduleredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_appointment_scheduler_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fappointment_scheduleredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fappointment_scheduleredit", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fappointment_scheduleredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fappointment_scheduleredit", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fappointment_scheduleredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fappointment_scheduleredit", "x_createdDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
