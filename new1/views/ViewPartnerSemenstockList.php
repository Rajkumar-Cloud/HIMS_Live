...
<form name="fview_partner_semenstocklistsrch" id="fview_partner_semenstocklistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_partner_semenstocklist" id="fview_partner_semenstocklist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
