...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.pres_restricteddruglist.fields;
    fpres_restricteddruglistedit.addFields([
        ...
        ["RestrictedWarning", [fields.RestrictedWarning.required ? ew.Validators.required(fields.RestrictedWarning.caption) : null], fields.RestrictedWarning.isInvalid]
    ]);
...
$Page->showMessage();
?>
<form name="fpres_restricteddruglistedit" id="fpres_restricteddruglistedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
