...
$Page->showMessage();
?>
<form name="ftask_managementadd" id="ftask_managementadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["ftask_managementadd", "datetimepicker"], function() {
    ew.createDateTimePicker("ftask_managementadd", "x_StartDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftask_managementadd", "datetimepicker"], function() {
    ew.createDateTimePicker("ftask_managementadd", "x_EndDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftask_managementadd", "datetimepicker"], function() {
    ew.createDateTimePicker("ftask_managementadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftask_managementadd", "datetimepicker"], function() {
    ew.createDateTimePicker("ftask_managementadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
