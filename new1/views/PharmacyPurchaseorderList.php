...
<form name="fpharmacy_purchaseorderlistsrch" id="fpharmacy_purchaseorderlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpharmacy_purchaseorderlist" id="fpharmacy_purchaseorderlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->ORDNO->Visible) { // ORDNO ?>
        <th data-name="ORDNO" class="<?= $Page->ORDNO->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_ORDNO" class="pharmacy_purchaseorder_ORDNO"><?= $Page->renderSort($Page->ORDNO) ?></div></th>
<?php } ?>
...
<?php if ($Page->DT->Visible) { // DT ?>
        <th data-name="DT" class="<?= $Page->DT->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_DT" class="pharmacy_purchaseorder_DT"><?= $Page->renderSort($Page->DT) ?></div></th>
<?php } ?>
<?php if ($Page->PC->Visible) { // PC ?>
        <th data-name="PC" class="<?= $Page->PC->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PC" class="pharmacy_purchaseorder_PC"><?= $Page->renderSort($Page->PC) ?></div></th>
<?php } ?>
<?php if ($Page->YM->Visible) { // YM ?>
        <th data-name="YM" class="<?= $Page->YM->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_YM" class="pharmacy_purchaseorder_YM"><?= $Page->renderSort($Page->YM) ?></div></th>
<?php } ?>
<?php if ($Page->MFRCODE->Visible) { // MFRCODE ?>
        <th data-name="MFRCODE" class="<?= $Page->MFRCODE->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_MFRCODE" class="pharmacy_purchaseorder_MFRCODE"><?= $Page->renderSort($Page->MFRCODE) ?></div></th>
<?php } ?>
...
<?php if ($Page->Printcheck->Visible) { // Printcheck ?>
        <th data-name="Printcheck" class="<?= $Page->Printcheck->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_Printcheck" class="pharmacy_purchaseorder_Printcheck"><?= $Page->renderSort($Page->Printcheck) ?></div></th>
<?php } ?>
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_id" class="pharmacy_purchaseorder_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->poid->Visible) { // poid ?>
        <th data-name="poid" class="<?= $Page->poid->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_poid" class="pharmacy_purchaseorder_poid"><?= $Page->renderSort($Page->poid) ?></div></th>
<?php } ?>
<?php if ($Page->grnid->Visible) { // grnid ?>
        <th data-name="grnid" class="<?= $Page->grnid->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_grnid" class="pharmacy_purchaseorder_grnid"><?= $Page->renderSort($Page->grnid) ?></div></th>
<?php } ?>
<?php if ($Page->BatchNo->Visible) { // BatchNo ?>
        <th data-name="BatchNo" class="<?= $Page->BatchNo->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_BatchNo" class="pharmacy_purchaseorder_BatchNo"><?= $Page->renderSort($Page->BatchNo) ?></div></th>
<?php } ?>
<?php if ($Page->ExpDate->Visible) { // ExpDate ?>
        <th data-name="ExpDate" class="<?= $Page->ExpDate->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_ExpDate" class="pharmacy_purchaseorder_ExpDate"><?= $Page->renderSort($Page->ExpDate) ?></div></th>
<?php } ?>
<?php if ($Page->PrName->Visible) { // PrName ?>
        <th data-name="PrName" class="<?= $Page->PrName->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PrName" class="pharmacy_purchaseorder_PrName"><?= $Page->renderSort($Page->PrName) ?></div></th>
<?php } ?>
<?php if ($Page->Quantity->Visible) { // Quantity ?>
        <th data-name="Quantity" class="<?= $Page->Quantity->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_Quantity" class="pharmacy_purchaseorder_Quantity"><?= $Page->renderSort($Page->Quantity) ?></div></th>
<?php } ?>
<?php if ($Page->FreeQty->Visible) { // FreeQty ?>
        <th data-name="FreeQty" class="<?= $Page->FreeQty->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_FreeQty" class="pharmacy_purchaseorder_FreeQty"><?= $Page->renderSort($Page->FreeQty) ?></div></th>
<?php } ?>
<?php if ($Page->ItemValue->Visible) { // ItemValue ?>
        <th data-name="ItemValue" class="<?= $Page->ItemValue->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_ItemValue" class="pharmacy_purchaseorder_ItemValue"><?= $Page->renderSort($Page->ItemValue) ?></div></th>
<?php } ?>
<?php if ($Page->Disc->Visible) { // Disc ?>
        <th data-name="Disc" class="<?= $Page->Disc->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_Disc" class="pharmacy_purchaseorder_Disc"><?= $Page->renderSort($Page->Disc) ?></div></th>
<?php } ?>
<?php if ($Page->PTax->Visible) { // PTax ?>
        <th data-name="PTax" class="<?= $Page->PTax->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PTax" class="pharmacy_purchaseorder_PTax"><?= $Page->renderSort($Page->PTax) ?></div></th>
<?php } ?>
<?php if ($Page->MRP->Visible) { // MRP ?>
        <th data-name="MRP" class="<?= $Page->MRP->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_MRP" class="pharmacy_purchaseorder_MRP"><?= $Page->renderSort($Page->MRP) ?></div></th>
<?php } ?>
<?php if ($Page->SalTax->Visible) { // SalTax ?>
        <th data-name="SalTax" class="<?= $Page->SalTax->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_SalTax" class="pharmacy_purchaseorder_SalTax"><?= $Page->renderSort($Page->SalTax) ?></div></th>
<?php } ?>
<?php if ($Page->PurValue->Visible) { // PurValue ?>
        <th data-name="PurValue" class="<?= $Page->PurValue->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PurValue" class="pharmacy_purchaseorder_PurValue"><?= $Page->renderSort($Page->PurValue) ?></div></th>
<?php } ?>
<?php if ($Page->PurRate->Visible) { // PurRate ?>
        <th data-name="PurRate" class="<?= $Page->PurRate->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PurRate" class="pharmacy_purchaseorder_PurRate"><?= $Page->renderSort($Page->PurRate) ?></div></th>
<?php } ?>
<?php if ($Page->SalRate->Visible) { // SalRate ?>
        <th data-name="SalRate" class="<?= $Page->SalRate->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_SalRate" class="pharmacy_purchaseorder_SalRate"><?= $Page->renderSort($Page->SalRate) ?></div></th>
<?php } ?>
<?php if ($Page->Discount->Visible) { // Discount ?>
        <th data-name="Discount" class="<?= $Page->Discount->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_Discount" class="pharmacy_purchaseorder_Discount"><?= $Page->renderSort($Page->Discount) ?></div></th>
<?php } ?>
<?php if ($Page->PSGST->Visible) { // PSGST ?>
        <th data-name="PSGST" class="<?= $Page->PSGST->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PSGST" class="pharmacy_purchaseorder_PSGST"><?= $Page->renderSort($Page->PSGST) ?></div></th>
<?php } ?>
<?php if ($Page->PCGST->Visible) { // PCGST ?>
        <th data-name="PCGST" class="<?= $Page->PCGST->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PCGST" class="pharmacy_purchaseorder_PCGST"><?= $Page->renderSort($Page->PCGST) ?></div></th>
<?php } ?>
<?php if ($Page->SSGST->Visible) { // SSGST ?>
        <th data-name="SSGST" class="<?= $Page->SSGST->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_SSGST" class="pharmacy_purchaseorder_SSGST"><?= $Page->renderSort($Page->SSGST) ?></div></th>
<?php } ?>
<?php if ($Page->SCGST->Visible) { // SCGST ?>
        <th data-name="SCGST" class="<?= $Page->SCGST->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_SCGST" class="pharmacy_purchaseorder_SCGST"><?= $Page->renderSort($Page->SCGST) ?></div></th>
<?php } ?>
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
        <th data-name="BRCODE" class="<?= $Page->BRCODE->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_BRCODE" class="pharmacy_purchaseorder_BRCODE"><?= $Page->renderSort($Page->BRCODE) ?></div></th>
<?php } ?>
<?php if ($Page->HSN->Visible) { // HSN ?>
        <th data-name="HSN" class="<?= $Page->HSN->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_HSN" class="pharmacy_purchaseorder_HSN"><?= $Page->renderSort($Page->HSN) ?></div></th>
<?php } ?>
<?php if ($Page->Pack->Visible) { // Pack ?>
        <th data-name="Pack" class="<?= $Page->Pack->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_Pack" class="pharmacy_purchaseorder_Pack"><?= $Page->renderSort($Page->Pack) ?></div></th>
<?php } ?>
<?php if ($Page->PUnit->Visible) { // PUnit ?>
        <th data-name="PUnit" class="<?= $Page->PUnit->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_PUnit" class="pharmacy_purchaseorder_PUnit"><?= $Page->renderSort($Page->PUnit) ?></div></th>
<?php } ?>
<?php if ($Page->SUnit->Visible) { // SUnit ?>
        <th data-name="SUnit" class="<?= $Page->SUnit->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_SUnit" class="pharmacy_purchaseorder_SUnit"><?= $Page->renderSort($Page->SUnit) ?></div></th>
<?php } ?>
<?php if ($Page->GrnQuantity->Visible) { // GrnQuantity ?>
        <th data-name="GrnQuantity" class="<?= $Page->GrnQuantity->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_GrnQuantity" class="pharmacy_purchaseorder_GrnQuantity"><?= $Page->renderSort($Page->GrnQuantity) ?></div></th>
<?php } ?>
<?php if ($Page->GrnMRP->Visible) { // GrnMRP ?>
        <th data-name="GrnMRP" class="<?= $Page->GrnMRP->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_GrnMRP" class="pharmacy_purchaseorder_GrnMRP"><?= $Page->renderSort($Page->GrnMRP) ?></div></th>
<?php } ?>
<?php if ($Page->trid->Visible) { // trid ?>
        <th data-name="trid" class="<?= $Page->trid->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_trid" class="pharmacy_purchaseorder_trid"><?= $Page->renderSort($Page->trid) ?></div></th>
<?php } ?>
...
<?php if ($Page->grncreatedby->Visible) { // grncreatedby ?>
        <th data-name="grncreatedby" class="<?= $Page->grncreatedby->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_grncreatedby" class="pharmacy_purchaseorder_grncreatedby"><?= $Page->renderSort($Page->grncreatedby) ?></div></th>
<?php } ?>
<?php if ($Page->grncreatedDateTime->Visible) { // grncreatedDateTime ?>
        <th data-name="grncreatedDateTime" class="<?= $Page->grncreatedDateTime->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_grncreatedDateTime" class="pharmacy_purchaseorder_grncreatedDateTime"><?= $Page->renderSort($Page->grncreatedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->grnModifiedby->Visible) { // grnModifiedby ?>
        <th data-name="grnModifiedby" class="<?= $Page->grnModifiedby->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_grnModifiedby" class="pharmacy_purchaseorder_grnModifiedby"><?= $Page->renderSort($Page->grnModifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->grnModifiedDateTime->Visible) { // grnModifiedDateTime ?>
        <th data-name="grnModifiedDateTime" class="<?= $Page->grnModifiedDateTime->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_grnModifiedDateTime" class="pharmacy_purchaseorder_grnModifiedDateTime"><?= $Page->renderSort($Page->grnModifiedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->Received->Visible) { // Received ?>
        <th data-name="Received" class="<?= $Page->Received->headerCellClass() ?>"><div id="elh_pharmacy_purchaseorder_Received" class="pharmacy_purchaseorder_Received"><?= $Page->renderSort($Page->Received) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_ORDNO">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_DT">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PC">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_YM">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_MFRCODE">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_Printcheck">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_id">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_poid">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_grnid">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_BatchNo">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_ExpDate">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PrName">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_Quantity">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_FreeQty">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_ItemValue">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_Disc">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PTax">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_MRP">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_SalTax">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PurValue">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PurRate">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_SalRate">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_Discount">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PSGST">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PCGST">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_SSGST">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_SCGST">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_BRCODE">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_HSN">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_Pack">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_PUnit">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_SUnit">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_GrnQuantity">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_GrnMRP">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_trid">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_grncreatedby">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_grncreatedDateTime">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_grnModifiedby">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_grnModifiedDateTime">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchaseorder_Received">
