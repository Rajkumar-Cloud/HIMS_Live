...
<form name="fview_dashboard_summary_modeofpayment_detailslistsrch" id="fview_dashboard_summary_modeofpayment_detailslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_dashboard_summary_modeofpayment_detailslist" id="fview_dashboard_summary_modeofpayment_detailslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
