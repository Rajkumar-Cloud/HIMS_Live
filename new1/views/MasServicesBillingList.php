...
<form name="fmas_services_billinglistsrch" id="fmas_services_billinglistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fmas_services_billinglist" id="fmas_services_billinglist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Created->Visible) { // Created ?>
        <th data-name="Created" class="<?= $Page->Created->headerCellClass() ?>"><div id="elh_mas_services_billing_Created" class="mas_services_billing_Created"><?= $Page->renderSort($Page->Created) ?></div></th>
<?php } ?>
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
        <th data-name="CreatedDateTime" class="<?= $Page->CreatedDateTime->headerCellClass() ?>"><div id="elh_mas_services_billing_CreatedDateTime" class="mas_services_billing_CreatedDateTime"><?= $Page->renderSort($Page->CreatedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->Modified->Visible) { // Modified ?>
        <th data-name="Modified" class="<?= $Page->Modified->headerCellClass() ?>"><div id="elh_mas_services_billing_Modified" class="mas_services_billing_Modified"><?= $Page->renderSort($Page->Modified) ?></div></th>
<?php } ?>
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
        <th data-name="ModifiedDateTime" class="<?= $Page->ModifiedDateTime->headerCellClass() ?>"><div id="elh_mas_services_billing_ModifiedDateTime" class="mas_services_billing_ModifiedDateTime"><?= $Page->renderSort($Page->ModifiedDateTime) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_mas_services_billing_Created">
...
<span id="el<?= $Page->RowCount ?>_mas_services_billing_CreatedDateTime">
...
<span id="el<?= $Page->RowCount ?>_mas_services_billing_Modified">
...
<span id="el<?= $Page->RowCount ?>_mas_services_billing_ModifiedDateTime">
