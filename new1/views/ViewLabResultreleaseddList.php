...
var fview_lab_resultreleaseddlistsrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    fview_lab_resultreleaseddlistsrch = currentSearchForm = new ew.Form("fview_lab_resultreleaseddlistsrch");

    // Dynamic selection lists

    // Filters
    fview_lab_resultreleaseddlistsrch.filterList = <?= $Page->getFilterList() ?>;
    loadjs.done("fview_lab_resultreleaseddlistsrch");
});
</script>
<script>
loadjs.ready("head", function () {
...
<form name="fview_lab_resultreleaseddlistsrch" id="fview_lab_resultreleaseddlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
<div id="fview_lab_resultreleaseddlistsrch-search-panel" class="<?= $Page->SearchPanelClass ?>">
...
<form name="fview_lab_resultreleaseddlist" id="fview_lab_resultreleaseddlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
