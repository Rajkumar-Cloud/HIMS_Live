...
<form name="fview_issuing_semenlistsrch" id="fview_issuing_semenlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_issuing_semenlist" id="fview_issuing_semenlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
