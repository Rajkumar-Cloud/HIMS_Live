...
$Page->showMessage();
?>
<form name="fpres_trade_combination_namesview" id="fpres_trade_combination_namesview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
