...
$Page->showMessage();
?>
<form name="fpharmacy_billing_returndelete" id="fpharmacy_billing_returndelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th class="<?= $Page->Reception->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Reception" class="pharmacy_billing_return_Reception"><?= $Page->Reception->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th class="<?= $Page->Age->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Age" class="pharmacy_billing_return_Age"><?= $Page->Age->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Gender->Visible) { // Gender ?>
        <th class="<?= $Page->Gender->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Gender" class="pharmacy_billing_return_Gender"><?= $Page->Gender->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->Details->Visible) { // Details ?>
        <th class="<?= $Page->Details->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Details" class="pharmacy_billing_return_Details"><?= $Page->Details->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
        <th class="<?= $Page->RealizationStatus->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_RealizationStatus" class="pharmacy_billing_return_RealizationStatus"><?= $Page->RealizationStatus->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
        <th class="<?= $Page->RealizationRemarks->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_RealizationRemarks" class="pharmacy_billing_return_RealizationRemarks"><?= $Page->RealizationRemarks->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
        <th class="<?= $Page->RealizationBatchNo->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_RealizationBatchNo" class="pharmacy_billing_return_RealizationBatchNo"><?= $Page->RealizationBatchNo->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
        <th class="<?= $Page->RealizationDate->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_RealizationDate" class="pharmacy_billing_return_RealizationDate"><?= $Page->RealizationDate->caption() ?></span></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th class="<?= $Page->HospID->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_HospID" class="pharmacy_billing_return_HospID"><?= $Page->HospID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
        <th class="<?= $Page->RIDNO->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_RIDNO" class="pharmacy_billing_return_RIDNO"><?= $Page->RIDNO->caption() ?></span></th>
<?php } ?>
<?php if ($Page->TidNo->Visible) { // TidNo ?>
        <th class="<?= $Page->TidNo->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_TidNo" class="pharmacy_billing_return_TidNo"><?= $Page->TidNo->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
        <th class="<?= $Page->PayerType->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_PayerType" class="pharmacy_billing_return_PayerType"><?= $Page->PayerType->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Dob->Visible) { // Dob ?>
        <th class="<?= $Page->Dob->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Dob" class="pharmacy_billing_return_Dob"><?= $Page->Dob->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th class="<?= $Page->Currency->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Currency" class="pharmacy_billing_return_Currency"><?= $Page->Currency->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
        <th class="<?= $Page->DiscountRemarks->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_DiscountRemarks" class="pharmacy_billing_return_DiscountRemarks"><?= $Page->DiscountRemarks->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Remarks->Visible) { // Remarks ?>
        <th class="<?= $Page->Remarks->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_Remarks" class="pharmacy_billing_return_Remarks"><?= $Page->Remarks->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PatId->Visible) { // PatId ?>
        <th class="<?= $Page->PatId->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_PatId" class="pharmacy_billing_return_PatId"><?= $Page->PatId->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
        <th class="<?= $Page->DrDepartment->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_DrDepartment" class="pharmacy_billing_return_DrDepartment"><?= $Page->DrDepartment->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
        <th class="<?= $Page->RefferedBy->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_RefferedBy" class="pharmacy_billing_return_RefferedBy"><?= $Page->RefferedBy->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
        <th class="<?= $Page->BankName->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_BankName" class="pharmacy_billing_return_BankName"><?= $Page->BankName->caption() ?></span></th>
<?php } ?>
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th class="<?= $Page->DrID->headerCellClass() ?>"><span id="elh_pharmacy_billing_return_DrID" class="pharmacy_billing_return_DrID"><?= $Page->DrID->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Reception" class="pharmacy_billing_return_Reception">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Age" class="pharmacy_billing_return_Age">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Gender" class="pharmacy_billing_return_Gender">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Details" class="pharmacy_billing_return_Details">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationStatus" class="pharmacy_billing_return_RealizationStatus">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationRemarks" class="pharmacy_billing_return_RealizationRemarks">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationBatchNo" class="pharmacy_billing_return_RealizationBatchNo">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationDate" class="pharmacy_billing_return_RealizationDate">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_HospID" class="pharmacy_billing_return_HospID">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RIDNO" class="pharmacy_billing_return_RIDNO">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_TidNo" class="pharmacy_billing_return_TidNo">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_PayerType" class="pharmacy_billing_return_PayerType">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Dob" class="pharmacy_billing_return_Dob">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Currency" class="pharmacy_billing_return_Currency">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_DiscountRemarks" class="pharmacy_billing_return_DiscountRemarks">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Remarks" class="pharmacy_billing_return_Remarks">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_PatId" class="pharmacy_billing_return_PatId">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_DrDepartment" class="pharmacy_billing_return_DrDepartment">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RefferedBy" class="pharmacy_billing_return_RefferedBy">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_BankName" class="pharmacy_billing_return_BankName">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_DrID" class="pharmacy_billing_return_DrID">
