...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.mas_bloodgroup.fields;
...
$Page->showMessage();
?>
<form name="fmas_bloodgroupedit" id="fmas_bloodgroupedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
