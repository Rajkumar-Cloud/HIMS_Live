...
$Page->showMessage();
?>
<form name="fpatient_opd_follow_updelete" id="fpatient_opd_follow_updelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th class="<?= $Page->Reception->headerCellClass() ?>"><span id="elh_patient_opd_follow_up_Reception" class="patient_opd_follow_up_Reception"><?= $Page->Reception->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PatientId->Visible) { // PatientId ?>
        <th class="<?= $Page->PatientId->headerCellClass() ?>"><span id="elh_patient_opd_follow_up_PatientId" class="patient_opd_follow_up_PatientId"><?= $Page->PatientId->caption() ?></span></th>
<?php } ?>
<?php if ($Page->mrnno->Visible) { // mrnno ?>
        <th class="<?= $Page->mrnno->headerCellClass() ?>"><span id="elh_patient_opd_follow_up_mrnno" class="patient_opd_follow_up_mrnno"><?= $Page->mrnno->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->Telephone->Visible) { // Telephone ?>
        <th class="<?= $Page->Telephone->headerCellClass() ?>"><span id="elh_patient_opd_follow_up_Telephone" class="patient_opd_follow_up_Telephone"><?= $Page->Telephone->caption() ?></span></th>
<?php } ?>
<?php if ($Page->Age->Visible) { // Age ?>
        <th class="<?= $Page->Age->headerCellClass() ?>"><span id="elh_patient_opd_follow_up_Age" class="patient_opd_follow_up_Age"><?= $Page->Age->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->PatientSearch->Visible) { // PatientSearch ?>
        <th class="<?= $Page->PatientSearch->headerCellClass() ?>"><span id="elh_patient_opd_follow_up_PatientSearch" class="patient_opd_follow_up_PatientSearch"><?= $Page->PatientSearch->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_patient_opd_follow_up_Reception" class="patient_opd_follow_up_Reception">
...
<span id="el<?= $Page->RowCount ?>_patient_opd_follow_up_PatientId" class="patient_opd_follow_up_PatientId">
...
<span id="el<?= $Page->RowCount ?>_patient_opd_follow_up_mrnno" class="patient_opd_follow_up_mrnno">
...
<span id="el<?= $Page->RowCount ?>_patient_opd_follow_up_Telephone" class="patient_opd_follow_up_Telephone">
...
<span id="el<?= $Page->RowCount ?>_patient_opd_follow_up_Age" class="patient_opd_follow_up_Age">
...
<?php } ?>
<?php if ($Page->PatientSearch->Visible) { // PatientSearch ?>
        <td <?= $Page->PatientSearch->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_patient_opd_follow_up_PatientSearch" class="patient_opd_follow_up_PatientSearch">
