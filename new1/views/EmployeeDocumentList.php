...
<form name="femployee_documentlistsrch" id="femployee_documentlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="femployee_documentlist" id="femployee_documentlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
