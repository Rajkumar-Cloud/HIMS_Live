...
$Page->showMessage();
?>
<form name="fivfdelete" id="fivfdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th class="<?= $Page->createdby->headerCellClass() ?>"><span id="elh_ivf_createdby" class="ivf_createdby"><?= $Page->createdby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th class="<?= $Page->createddatetime->headerCellClass() ?>"><span id="elh_ivf_createddatetime" class="ivf_createddatetime"><?= $Page->createddatetime->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th class="<?= $Page->modifiedby->headerCellClass() ?>"><span id="elh_ivf_modifiedby" class="ivf_modifiedby"><?= $Page->modifiedby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th class="<?= $Page->modifieddatetime->headerCellClass() ?>"><span id="elh_ivf_modifieddatetime" class="ivf_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ivf_createdby" class="ivf_createdby">
...
<span id="el<?= $Page->RowCount ?>_ivf_createddatetime" class="ivf_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_ivf_modifiedby" class="ivf_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_ivf_modifieddatetime" class="ivf_modifieddatetime">
