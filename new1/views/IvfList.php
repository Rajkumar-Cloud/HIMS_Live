...
<form name="fivflistsrch" id="fivflistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fivflist" id="fivflist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<table id="tbl_ivflist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_ivf_createdby" class="ivf_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th data-name="createddatetime" class="<?= $Page->createddatetime->headerCellClass() ?>"><div id="elh_ivf_createddatetime" class="ivf_createddatetime"><?= $Page->renderSort($Page->createddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_ivf_modifiedby" class="ivf_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_ivf_modifieddatetime" class="ivf_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ivf_id">
...
<span id="el<?= $Page->RowCount ?>_ivf_Male">
...
<span id="el<?= $Page->RowCount ?>_ivf_Female">
...
<span id="el<?= $Page->RowCount ?>_ivf_status">
...
<span id="el<?= $Page->RowCount ?>_ivf_createdby">
...
<span id="el<?= $Page->RowCount ?>_ivf_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_ivf_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_ivf_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_ivf_HusbandEducation">
...
<span id="el<?= $Page->RowCount ?>_ivf_WifeEducation">
...
<span id="el<?= $Page->RowCount ?>_ivf_HusbandWorkHours">
...
<span id="el<?= $Page->RowCount ?>_ivf_WifeWorkHours">
...
<span id="el<?= $Page->RowCount ?>_ivf_PatientLanguage">
...
<span id="el<?= $Page->RowCount ?>_ivf_ReferedBy">
...
<span id="el<?= $Page->RowCount ?>_ivf_ReferPhNo">
...
<span id="el<?= $Page->RowCount ?>_ivf_WifeCell">
...
<span id="el<?= $Page->RowCount ?>_ivf_HusbandCell">
...
<span id="el<?= $Page->RowCount ?>_ivf_WifeEmail">
...
<span id="el<?= $Page->RowCount ?>_ivf_HusbandEmail">
...
<span id="el<?= $Page->RowCount ?>_ivf_ARTCYCLE">
...
<span id="el<?= $Page->RowCount ?>_ivf_RESULT">
...
<span id="el<?= $Page->RowCount ?>_ivf_CoupleID">
...
<span id="el<?= $Page->RowCount ?>_ivf_HospID">
...
<span id="el<?= $Page->RowCount ?>_ivf_PatientName">
...
<span id="el<?= $Page->RowCount ?>_ivf_PatientID">
...
<span id="el<?= $Page->RowCount ?>_ivf_PartnerName">
...
<span id="el<?= $Page->RowCount ?>_ivf_PartnerID">
...
<span id="el<?= $Page->RowCount ?>_ivf_DrID">
...
<span id="el<?= $Page->RowCount ?>_ivf_DrDepartment">
...
<span id="el<?= $Page->RowCount ?>_ivf_Doctor">
