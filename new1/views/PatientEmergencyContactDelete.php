...
$Page->showMessage();
?>
<form name="fpatient_emergency_contactdelete" id="fpatient_emergency_contactdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th class="<?= $Page->createdby->headerCellClass() ?>"><span id="elh_patient_emergency_contact_createdby" class="patient_emergency_contact_createdby"><?= $Page->createdby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th class="<?= $Page->createddatetime->headerCellClass() ?>"><span id="elh_patient_emergency_contact_createddatetime" class="patient_emergency_contact_createddatetime"><?= $Page->createddatetime->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th class="<?= $Page->modifiedby->headerCellClass() ?>"><span id="elh_patient_emergency_contact_modifiedby" class="patient_emergency_contact_modifiedby"><?= $Page->modifiedby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th class="<?= $Page->modifieddatetime->headerCellClass() ?>"><span id="elh_patient_emergency_contact_modifieddatetime" class="patient_emergency_contact_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_patient_emergency_contact_createdby" class="patient_emergency_contact_createdby">
...
<span id="el<?= $Page->RowCount ?>_patient_emergency_contact_createddatetime" class="patient_emergency_contact_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_patient_emergency_contact_modifiedby" class="patient_emergency_contact_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_patient_emergency_contact_modifieddatetime" class="patient_emergency_contact_modifieddatetime">
