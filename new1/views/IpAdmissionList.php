...
<form name="fip_admissionlistsrch" id="fip_admissionlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fip_admissionlist" id="fip_admissionlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->status->Visible) { // status ?>
        <th data-name="status" class="<?= $Page->status->headerCellClass() ?>"><div id="elh_ip_admission_status" class="ip_admission_status"><?= $Page->renderSort($Page->status) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_ip_admission_createdby" class="ip_admission_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_ip_admission_modifiedby" class="ip_admission_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_ip_admission_modifieddatetime" class="ip_admission_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ip_admission_status">
...
<span id="el<?= $Page->RowCount ?>_ip_admission_createdby">
...
<span id="el<?= $Page->RowCount ?>_ip_admission_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_ip_admission_modifieddatetime">
