...
<form name="fview_ivf_treatment_planlistsrch" id="fview_ivf_treatment_planlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_ivf_treatment_planlist" id="fview_ivf_treatment_planlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_id" class="view_ivf_treatment_plan_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
...
<?php if ($Page->Name->Visible) { // Name ?>
        <th data-name="Name" class="<?= $Page->Name->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Name" class="view_ivf_treatment_plan_Name"><?= $Page->renderSort($Page->Name) ?></div></th>
<?php } ?>
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Age" class="view_ivf_treatment_plan_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
...
<?php if ($Page->status->Visible) { // status ?>
        <th data-name="status" class="<?= $Page->status->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_status" class="view_ivf_treatment_plan_status"><?= $Page->renderSort($Page->status) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_createdby" class="view_ivf_treatment_plan_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th data-name="createddatetime" class="<?= $Page->createddatetime->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_createddatetime" class="view_ivf_treatment_plan_createddatetime"><?= $Page->renderSort($Page->createddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_modifiedby" class="view_ivf_treatment_plan_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_modifieddatetime" class="view_ivf_treatment_plan_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
...
<?php if ($Page->TreatementStopDate->Visible) { // TreatementStopDate ?>
        <th data-name="TreatementStopDate" class="<?= $Page->TreatementStopDate->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TreatementStopDate" class="view_ivf_treatment_plan_TreatementStopDate"><?= $Page->renderSort($Page->TreatementStopDate) ?></div></th>
<?php } ?>
<?php if ($Page->TypePatient->Visible) { // TypePatient ?>
        <th data-name="TypePatient" class="<?= $Page->TypePatient->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TypePatient" class="view_ivf_treatment_plan_TypePatient"><?= $Page->renderSort($Page->TypePatient) ?></div></th>
<?php } ?>
<?php if ($Page->Treatment->Visible) { // Treatment ?>
        <th data-name="Treatment" class="<?= $Page->Treatment->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Treatment" class="view_ivf_treatment_plan_Treatment"><?= $Page->renderSort($Page->Treatment) ?></div></th>
<?php } ?>
<?php if ($Page->TreatmentTec->Visible) { // TreatmentTec ?>
        <th data-name="TreatmentTec" class="<?= $Page->TreatmentTec->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TreatmentTec" class="view_ivf_treatment_plan_TreatmentTec"><?= $Page->renderSort($Page->TreatmentTec) ?></div></th>
<?php } ?>
<?php if ($Page->TypeOfCycle->Visible) { // TypeOfCycle ?>
        <th data-name="TypeOfCycle" class="<?= $Page->TypeOfCycle->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TypeOfCycle" class="view_ivf_treatment_plan_TypeOfCycle"><?= $Page->renderSort($Page->TypeOfCycle) ?></div></th>
<?php } ?>
<?php if ($Page->SpermOrgin->Visible) { // SpermOrgin ?>
        <th data-name="SpermOrgin" class="<?= $Page->SpermOrgin->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_SpermOrgin" class="view_ivf_treatment_plan_SpermOrgin"><?= $Page->renderSort($Page->SpermOrgin) ?></div></th>
<?php } ?>
<?php if ($Page->State->Visible) { // State ?>
        <th data-name="State" class="<?= $Page->State->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_State" class="view_ivf_treatment_plan_State"><?= $Page->renderSort($Page->State) ?></div></th>
<?php } ?>
<?php if ($Page->Origin->Visible) { // Origin ?>
        <th data-name="Origin" class="<?= $Page->Origin->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Origin" class="view_ivf_treatment_plan_Origin"><?= $Page->renderSort($Page->Origin) ?></div></th>
<?php } ?>
<?php if ($Page->MACS->Visible) { // MACS ?>
        <th data-name="MACS" class="<?= $Page->MACS->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_MACS" class="view_ivf_treatment_plan_MACS"><?= $Page->renderSort($Page->MACS) ?></div></th>
<?php } ?>
<?php if ($Page->Technique->Visible) { // Technique ?>
        <th data-name="Technique" class="<?= $Page->Technique->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Technique" class="view_ivf_treatment_plan_Technique"><?= $Page->renderSort($Page->Technique) ?></div></th>
<?php } ?>
<?php if ($Page->PgdPlanning->Visible) { // PgdPlanning ?>
        <th data-name="PgdPlanning" class="<?= $Page->PgdPlanning->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_PgdPlanning" class="view_ivf_treatment_plan_PgdPlanning"><?= $Page->renderSort($Page->PgdPlanning) ?></div></th>
<?php } ?>
<?php if ($Page->IMSI->Visible) { // IMSI ?>
        <th data-name="IMSI" class="<?= $Page->IMSI->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_IMSI" class="view_ivf_treatment_plan_IMSI"><?= $Page->renderSort($Page->IMSI) ?></div></th>
<?php } ?>
<?php if ($Page->SequentialCulture->Visible) { // SequentialCulture ?>
        <th data-name="SequentialCulture" class="<?= $Page->SequentialCulture->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_SequentialCulture" class="view_ivf_treatment_plan_SequentialCulture"><?= $Page->renderSort($Page->SequentialCulture) ?></div></th>
<?php } ?>
<?php if ($Page->TimeLapse->Visible) { // TimeLapse ?>
        <th data-name="TimeLapse" class="<?= $Page->TimeLapse->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TimeLapse" class="view_ivf_treatment_plan_TimeLapse"><?= $Page->renderSort($Page->TimeLapse) ?></div></th>
<?php } ?>
<?php if ($Page->AH->Visible) { // AH ?>
        <th data-name="AH" class="<?= $Page->AH->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_AH" class="view_ivf_treatment_plan_AH"><?= $Page->renderSort($Page->AH) ?></div></th>
<?php } ?>
<?php if ($Page->Weight->Visible) { // Weight ?>
        <th data-name="Weight" class="<?= $Page->Weight->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Weight" class="view_ivf_treatment_plan_Weight"><?= $Page->renderSort($Page->Weight) ?></div></th>
<?php } ?>
<?php if ($Page->BMI->Visible) { // BMI ?>
        <th data-name="BMI" class="<?= $Page->BMI->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_BMI" class="view_ivf_treatment_plan_BMI"><?= $Page->renderSort($Page->BMI) ?></div></th>
<?php } ?>
<?php if ($Page->MaleIndications->Visible) { // MaleIndications ?>
        <th data-name="MaleIndications" class="<?= $Page->MaleIndications->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_MaleIndications" class="view_ivf_treatment_plan_MaleIndications"><?= $Page->renderSort($Page->MaleIndications) ?></div></th>
<?php } ?>
<?php if ($Page->FemaleIndications->Visible) { // FemaleIndications ?>
        <th data-name="FemaleIndications" class="<?= $Page->FemaleIndications->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_FemaleIndications" class="view_ivf_treatment_plan_FemaleIndications"><?= $Page->renderSort($Page->FemaleIndications) ?></div></th>
<?php } ?>
<?php if ($Page->UseOfThe->Visible) { // UseOfThe ?>
        <th data-name="UseOfThe" class="<?= $Page->UseOfThe->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_UseOfThe" class="view_ivf_treatment_plan_UseOfThe"><?= $Page->renderSort($Page->UseOfThe) ?></div></th>
<?php } ?>
<?php if ($Page->Ectopic->Visible) { // Ectopic ?>
        <th data-name="Ectopic" class="<?= $Page->Ectopic->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Ectopic" class="view_ivf_treatment_plan_Ectopic"><?= $Page->renderSort($Page->Ectopic) ?></div></th>
<?php } ?>
<?php if ($Page->Heterotopic->Visible) { // Heterotopic ?>
        <th data-name="Heterotopic" class="<?= $Page->Heterotopic->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Heterotopic" class="view_ivf_treatment_plan_Heterotopic"><?= $Page->renderSort($Page->Heterotopic) ?></div></th>
<?php } ?>
<?php if ($Page->TransferDFE->Visible) { // TransferDFE ?>
        <th data-name="TransferDFE" class="<?= $Page->TransferDFE->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TransferDFE" class="view_ivf_treatment_plan_TransferDFE"><?= $Page->renderSort($Page->TransferDFE) ?></div></th>
<?php } ?>
<?php if ($Page->Evolutive->Visible) { // Evolutive ?>
        <th data-name="Evolutive" class="<?= $Page->Evolutive->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Evolutive" class="view_ivf_treatment_plan_Evolutive"><?= $Page->renderSort($Page->Evolutive) ?></div></th>
<?php } ?>
<?php if ($Page->Number->Visible) { // Number ?>
        <th data-name="Number" class="<?= $Page->Number->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_Number" class="view_ivf_treatment_plan_Number"><?= $Page->renderSort($Page->Number) ?></div></th>
<?php } ?>
<?php if ($Page->SequentialCult->Visible) { // SequentialCult ?>
        <th data-name="SequentialCult" class="<?= $Page->SequentialCult->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_SequentialCult" class="view_ivf_treatment_plan_SequentialCult"><?= $Page->renderSort($Page->SequentialCult) ?></div></th>
<?php } ?>
<?php if ($Page->TineLapse->Visible) { // TineLapse ?>
        <th data-name="TineLapse" class="<?= $Page->TineLapse->headerCellClass() ?>"><div id="elh_view_ivf_treatment_plan_TineLapse" class="view_ivf_treatment_plan_TineLapse"><?= $Page->renderSort($Page->TineLapse) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_id">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Name">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Age">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_status">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_createdby">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TreatementStopDate">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TypePatient">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Treatment">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TreatmentTec">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TypeOfCycle">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_SpermOrgin">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_State">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Origin">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_MACS">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Technique">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_PgdPlanning">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_IMSI">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_SequentialCulture">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TimeLapse">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_AH">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Weight">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_BMI">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_MaleIndications">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_FemaleIndications">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_UseOfThe">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Ectopic">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Heterotopic">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TransferDFE">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Evolutive">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_Number">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_SequentialCult">
...
<span id="el<?= $Page->RowCount ?>_view_ivf_treatment_plan_TineLapse">
