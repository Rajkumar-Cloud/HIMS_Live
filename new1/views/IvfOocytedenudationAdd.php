...
$Page->showMessage();
?>
<form name="fivf_oocytedenudationadd" id="fivf_oocytedenudationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fivf_oocytedenudationadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_oocytedenudationadd", "x_ResultDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_oocytedenudationadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_oocytedenudationadd", "x_DateOfDenudation", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_oocytedenudationadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_oocytedenudationadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_oocytedenudationadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_oocytedenudationadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
