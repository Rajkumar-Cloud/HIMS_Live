...
<form name="fpharmacy_billing_returnlistsrch" id="fpharmacy_billing_returnlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpharmacy_billing_returnlist" id="fpharmacy_billing_returnlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th data-name="Reception" class="<?= $Page->Reception->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Reception" class="pharmacy_billing_return_Reception"><?= $Page->renderSort($Page->Reception) ?></div></th>
<?php } ?>
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Age" class="pharmacy_billing_return_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
<?php if ($Page->Gender->Visible) { // Gender ?>
        <th data-name="Gender" class="<?= $Page->Gender->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Gender" class="pharmacy_billing_return_Gender"><?= $Page->renderSort($Page->Gender) ?></div></th>
<?php } ?>
...
<?php if ($Page->Details->Visible) { // Details ?>
        <th data-name="Details" class="<?= $Page->Details->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Details" class="pharmacy_billing_return_Details"><?= $Page->renderSort($Page->Details) ?></div></th>
<?php } ?>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
        <th data-name="RealizationStatus" class="<?= $Page->RealizationStatus->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_RealizationStatus" class="pharmacy_billing_return_RealizationStatus"><?= $Page->renderSort($Page->RealizationStatus) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
        <th data-name="RealizationRemarks" class="<?= $Page->RealizationRemarks->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_RealizationRemarks" class="pharmacy_billing_return_RealizationRemarks"><?= $Page->renderSort($Page->RealizationRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
        <th data-name="RealizationBatchNo" class="<?= $Page->RealizationBatchNo->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_RealizationBatchNo" class="pharmacy_billing_return_RealizationBatchNo"><?= $Page->renderSort($Page->RealizationBatchNo) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
        <th data-name="RealizationDate" class="<?= $Page->RealizationDate->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_RealizationDate" class="pharmacy_billing_return_RealizationDate"><?= $Page->renderSort($Page->RealizationDate) ?></div></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_HospID" class="pharmacy_billing_return_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
        <th data-name="RIDNO" class="<?= $Page->RIDNO->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_RIDNO" class="pharmacy_billing_return_RIDNO"><?= $Page->renderSort($Page->RIDNO) ?></div></th>
<?php } ?>
<?php if ($Page->TidNo->Visible) { // TidNo ?>
        <th data-name="TidNo" class="<?= $Page->TidNo->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_TidNo" class="pharmacy_billing_return_TidNo"><?= $Page->renderSort($Page->TidNo) ?></div></th>
<?php } ?>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
        <th data-name="PayerType" class="<?= $Page->PayerType->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_PayerType" class="pharmacy_billing_return_PayerType"><?= $Page->renderSort($Page->PayerType) ?></div></th>
<?php } ?>
<?php if ($Page->Dob->Visible) { // Dob ?>
        <th data-name="Dob" class="<?= $Page->Dob->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Dob" class="pharmacy_billing_return_Dob"><?= $Page->renderSort($Page->Dob) ?></div></th>
<?php } ?>
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th data-name="Currency" class="<?= $Page->Currency->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Currency" class="pharmacy_billing_return_Currency"><?= $Page->renderSort($Page->Currency) ?></div></th>
<?php } ?>
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
        <th data-name="DiscountRemarks" class="<?= $Page->DiscountRemarks->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_DiscountRemarks" class="pharmacy_billing_return_DiscountRemarks"><?= $Page->renderSort($Page->DiscountRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->Remarks->Visible) { // Remarks ?>
        <th data-name="Remarks" class="<?= $Page->Remarks->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_Remarks" class="pharmacy_billing_return_Remarks"><?= $Page->renderSort($Page->Remarks) ?></div></th>
<?php } ?>
<?php if ($Page->PatId->Visible) { // PatId ?>
        <th data-name="PatId" class="<?= $Page->PatId->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_PatId" class="pharmacy_billing_return_PatId"><?= $Page->renderSort($Page->PatId) ?></div></th>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
        <th data-name="DrDepartment" class="<?= $Page->DrDepartment->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_DrDepartment" class="pharmacy_billing_return_DrDepartment"><?= $Page->renderSort($Page->DrDepartment) ?></div></th>
<?php } ?>
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
        <th data-name="RefferedBy" class="<?= $Page->RefferedBy->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_RefferedBy" class="pharmacy_billing_return_RefferedBy"><?= $Page->renderSort($Page->RefferedBy) ?></div></th>
<?php } ?>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
        <th data-name="BankName" class="<?= $Page->BankName->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_BankName" class="pharmacy_billing_return_BankName"><?= $Page->renderSort($Page->BankName) ?></div></th>
<?php } ?>
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th data-name="DrID" class="<?= $Page->DrID->headerCellClass() ?>"><div id="elh_pharmacy_billing_return_DrID" class="pharmacy_billing_return_DrID"><?= $Page->renderSort($Page->DrID) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Reception">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Age">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Gender">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Details">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationStatus">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationRemarks">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationBatchNo">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RealizationDate">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_HospID">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RIDNO">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_TidNo">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_PayerType">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Dob">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Currency">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_DiscountRemarks">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_Remarks">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_PatId">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_DrDepartment">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_RefferedBy">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_BankName">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_billing_return_DrID">
