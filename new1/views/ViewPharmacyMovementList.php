...
<form name="fview_pharmacy_movementlistsrch" id="fview_pharmacy_movementlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_pharmacy_movementlist" id="fview_pharmacy_movementlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
