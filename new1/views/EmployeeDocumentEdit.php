...
$Page->showMessage();
?>
<form name="femployee_documentedit" id="femployee_documentedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_documentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_documentedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_documentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_documentedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
