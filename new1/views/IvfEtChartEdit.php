...
$Page->showMessage();
?>
<form name="fivf_et_chartedit" id="fivf_et_chartedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_et_chart_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fivf_et_chartedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_et_chartedit", "x_DATEOFSTART", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_et_chartedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_et_chartedit", "x_DATEOFEMBRYOTRANSFER", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
