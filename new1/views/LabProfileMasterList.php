...
<form name="flab_profile_masterlistsrch" id="flab_profile_masterlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="flab_profile_masterlist" id="flab_profile_masterlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
