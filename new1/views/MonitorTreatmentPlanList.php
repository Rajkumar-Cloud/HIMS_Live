...
<form name="fmonitor_treatment_planlistsrch" id="fmonitor_treatment_planlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fmonitor_treatment_planlist" id="fmonitor_treatment_planlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
