...
<form name="fview_pharmacy_search_product_newlistsrch" id="fview_pharmacy_search_product_newlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_pharmacy_search_product_newlist" id="fview_pharmacy_search_product_newlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
