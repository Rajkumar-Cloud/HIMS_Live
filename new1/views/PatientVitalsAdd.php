...
$Page->showMessage();
?>
<form name="fpatient_vitalsadd" id="fpatient_vitalsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fpatient_vitalsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_vitalsadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_vitalsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_vitalsadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
