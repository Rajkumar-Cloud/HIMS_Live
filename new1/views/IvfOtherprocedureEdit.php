...
$Page->showMessage();
?>
<form name="fivf_otherprocedureedit" id="fivf_otherprocedureedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_otherprocedure_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fivf_otherprocedureedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_otherprocedureedit", "x_DateofAdmission", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_otherprocedureedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_otherprocedureedit", "x_DateofProcedure", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_otherprocedureedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_otherprocedureedit", "x_DateofDischarge", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
