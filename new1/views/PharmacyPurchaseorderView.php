...
$Page->showMessage();
?>
<form name="fpharmacy_purchaseorderview" id="fpharmacy_purchaseorderview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->grnid->Visible) { // grnid ?>
    <tr id="r_grnid">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_grnid"><?= $Page->grnid->caption() ?></span></td>
...
<?php if ($Page->BatchNo->Visible) { // BatchNo ?>
    <tr id="r_BatchNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_BatchNo"><?= $Page->BatchNo->caption() ?></span></td>
...
<?php if ($Page->ExpDate->Visible) { // ExpDate ?>
    <tr id="r_ExpDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_ExpDate"><?= $Page->ExpDate->caption() ?></span></td>
...
<?php if ($Page->PrName->Visible) { // PrName ?>
    <tr id="r_PrName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_PrName"><?= $Page->PrName->caption() ?></span></td>
...
<?php if ($Page->Quantity->Visible) { // Quantity ?>
    <tr id="r_Quantity">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_Quantity"><?= $Page->Quantity->caption() ?></span></td>
...
<?php if ($Page->FreeQty->Visible) { // FreeQty ?>
    <tr id="r_FreeQty">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_FreeQty"><?= $Page->FreeQty->caption() ?></span></td>
...
<?php if ($Page->ItemValue->Visible) { // ItemValue ?>
    <tr id="r_ItemValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_ItemValue"><?= $Page->ItemValue->caption() ?></span></td>
...
<?php if ($Page->Disc->Visible) { // Disc ?>
    <tr id="r_Disc">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_Disc"><?= $Page->Disc->caption() ?></span></td>
...
<?php if ($Page->PTax->Visible) { // PTax ?>
    <tr id="r_PTax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_PTax"><?= $Page->PTax->caption() ?></span></td>
...
<?php if ($Page->MRP->Visible) { // MRP ?>
    <tr id="r_MRP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_MRP"><?= $Page->MRP->caption() ?></span></td>
...
<?php if ($Page->SalTax->Visible) { // SalTax ?>
    <tr id="r_SalTax">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_SalTax"><?= $Page->SalTax->caption() ?></span></td>
...
<?php if ($Page->PurValue->Visible) { // PurValue ?>
    <tr id="r_PurValue">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_PurValue"><?= $Page->PurValue->caption() ?></span></td>
...
<?php if ($Page->PurRate->Visible) { // PurRate ?>
    <tr id="r_PurRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_PurRate"><?= $Page->PurRate->caption() ?></span></td>
...
<?php if ($Page->SalRate->Visible) { // SalRate ?>
    <tr id="r_SalRate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_SalRate"><?= $Page->SalRate->caption() ?></span></td>
...
<?php if ($Page->Discount->Visible) { // Discount ?>
    <tr id="r_Discount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_purchaseorder_Discount"><?= $Page->Discount->caption() ?></span></td>
