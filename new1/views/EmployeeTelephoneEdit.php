...
$Page->showMessage();
?>
<form name="femployee_telephoneedit" id="femployee_telephoneedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_telephoneedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_telephoneedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_telephoneedit", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_telephoneedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
