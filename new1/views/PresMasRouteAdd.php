...
// Page object
$PresMasRouteAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpres_mas_routeadd;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fpres_mas_routeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpres_mas_routeadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpres_mas_routeadd" id="fpres_mas_routeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
