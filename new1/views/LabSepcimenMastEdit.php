...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.lab_sepcimen_mast.fields;
    flab_sepcimen_mastedit.addFields([
        ["SpecimenCD", [fields.SpecimenCD.required ? ew.Validators.required(fields.SpecimenCD.caption) : null], fields.SpecimenCD.isInvalid],
        ["SpecimenDesc", [fields.SpecimenDesc.required ? ew.Validators.required(fields.SpecimenDesc.caption) : null], fields.SpecimenDesc.isInvalid],
...
$Page->showMessage();
?>
<form name="flab_sepcimen_mastedit" id="flab_sepcimen_mastedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
