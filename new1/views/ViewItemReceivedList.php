...
<form name="fview_item_receivedlistsrch" id="fview_item_receivedlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_item_receivedlist" id="fview_item_receivedlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->QTY->Visible) { // QTY ?>
        <th data-name="QTY" class="<?= $Page->QTY->headerCellClass() ?>"><div id="elh_view_item_received_QTY" class="view_item_received_QTY"><?= $Page->renderSort($Page->QTY) ?></div></th>
<?php } ?>
<?php if ($Page->DT->Visible) { // DT ?>
        <th data-name="DT" class="<?= $Page->DT->headerCellClass() ?>"><div id="elh_view_item_received_DT" class="view_item_received_DT"><?= $Page->renderSort($Page->DT) ?></div></th>
<?php } ?>
<?php if ($Page->PC->Visible) { // PC ?>
        <th data-name="PC" class="<?= $Page->PC->headerCellClass() ?>"><div id="elh_view_item_received_PC" class="view_item_received_PC"><?= $Page->renderSort($Page->PC) ?></div></th>
<?php } ?>
<?php if ($Page->YM->Visible) { // YM ?>
        <th data-name="YM" class="<?= $Page->YM->headerCellClass() ?>"><div id="elh_view_item_received_YM" class="view_item_received_YM"><?= $Page->renderSort($Page->YM) ?></div></th>
<?php } ?>
...
<?php if ($Page->Stock->Visible) { // Stock ?>
        <th data-name="Stock" class="<?= $Page->Stock->headerCellClass() ?>"><div id="elh_view_item_received_Stock" class="view_item_received_Stock"><?= $Page->renderSort($Page->Stock) ?></div></th>
<?php } ?>
<?php if ($Page->LastMonthSale->Visible) { // LastMonthSale ?>
        <th data-name="LastMonthSale" class="<?= $Page->LastMonthSale->headerCellClass() ?>"><div id="elh_view_item_received_LastMonthSale" class="view_item_received_LastMonthSale"><?= $Page->renderSort($Page->LastMonthSale) ?></div></th>
<?php } ?>
<?php if ($Page->Printcheck->Visible) { // Printcheck ?>
        <th data-name="Printcheck" class="<?= $Page->Printcheck->headerCellClass() ?>"><div id="elh_view_item_received_Printcheck" class="view_item_received_Printcheck"><?= $Page->renderSort($Page->Printcheck) ?></div></th>
<?php } ?>
...
<?php if ($Page->poid->Visible) { // poid ?>
        <th data-name="poid" class="<?= $Page->poid->headerCellClass() ?>"><div id="elh_view_item_received_poid" class="view_item_received_poid"><?= $Page->renderSort($Page->poid) ?></div></th>
<?php } ?>
<?php if ($Page->grnid->Visible) { // grnid ?>
        <th data-name="grnid" class="<?= $Page->grnid->headerCellClass() ?>"><div id="elh_view_item_received_grnid" class="view_item_received_grnid"><?= $Page->renderSort($Page->grnid) ?></div></th>
<?php } ?>
...
<?php if ($Page->Disc->Visible) { // Disc ?>
        <th data-name="Disc" class="<?= $Page->Disc->headerCellClass() ?>"><div id="elh_view_item_received_Disc" class="view_item_received_Disc"><?= $Page->renderSort($Page->Disc) ?></div></th>
<?php } ?>
<?php if ($Page->PTax->Visible) { // PTax ?>
        <th data-name="PTax" class="<?= $Page->PTax->headerCellClass() ?>"><div id="elh_view_item_received_PTax" class="view_item_received_PTax"><?= $Page->renderSort($Page->PTax) ?></div></th>
<?php } ?>
<?php if ($Page->MRP->Visible) { // MRP ?>
        <th data-name="MRP" class="<?= $Page->MRP->headerCellClass() ?>"><div id="elh_view_item_received_MRP" class="view_item_received_MRP"><?= $Page->renderSort($Page->MRP) ?></div></th>
<?php } ?>
<?php if ($Page->SalTax->Visible) { // SalTax ?>
        <th data-name="SalTax" class="<?= $Page->SalTax->headerCellClass() ?>"><div id="elh_view_item_received_SalTax" class="view_item_received_SalTax"><?= $Page->renderSort($Page->SalTax) ?></div></th>
<?php } ?>
<?php if ($Page->PurValue->Visible) { // PurValue ?>
        <th data-name="PurValue" class="<?= $Page->PurValue->headerCellClass() ?>"><div id="elh_view_item_received_PurValue" class="view_item_received_PurValue"><?= $Page->renderSort($Page->PurValue) ?></div></th>
<?php } ?>
<?php if ($Page->PurRate->Visible) { // PurRate ?>
        <th data-name="PurRate" class="<?= $Page->PurRate->headerCellClass() ?>"><div id="elh_view_item_received_PurRate" class="view_item_received_PurRate"><?= $Page->renderSort($Page->PurRate) ?></div></th>
<?php } ?>
<?php if ($Page->SalRate->Visible) { // SalRate ?>
        <th data-name="SalRate" class="<?= $Page->SalRate->headerCellClass() ?>"><div id="elh_view_item_received_SalRate" class="view_item_received_SalRate"><?= $Page->renderSort($Page->SalRate) ?></div></th>
<?php } ?>
<?php if ($Page->Discount->Visible) { // Discount ?>
        <th data-name="Discount" class="<?= $Page->Discount->headerCellClass() ?>"><div id="elh_view_item_received_Discount" class="view_item_received_Discount"><?= $Page->renderSort($Page->Discount) ?></div></th>
<?php } ?>
<?php if ($Page->PSGST->Visible) { // PSGST ?>
        <th data-name="PSGST" class="<?= $Page->PSGST->headerCellClass() ?>"><div id="elh_view_item_received_PSGST" class="view_item_received_PSGST"><?= $Page->renderSort($Page->PSGST) ?></div></th>
<?php } ?>
<?php if ($Page->PCGST->Visible) { // PCGST ?>
        <th data-name="PCGST" class="<?= $Page->PCGST->headerCellClass() ?>"><div id="elh_view_item_received_PCGST" class="view_item_received_PCGST"><?= $Page->renderSort($Page->PCGST) ?></div></th>
<?php } ?>
<?php if ($Page->SSGST->Visible) { // SSGST ?>
        <th data-name="SSGST" class="<?= $Page->SSGST->headerCellClass() ?>"><div id="elh_view_item_received_SSGST" class="view_item_received_SSGST"><?= $Page->renderSort($Page->SSGST) ?></div></th>
<?php } ?>
<?php if ($Page->SCGST->Visible) { // SCGST ?>
        <th data-name="SCGST" class="<?= $Page->SCGST->headerCellClass() ?>"><div id="elh_view_item_received_SCGST" class="view_item_received_SCGST"><?= $Page->renderSort($Page->SCGST) ?></div></th>
<?php } ?>
...
<?php if ($Page->HSN->Visible) { // HSN ?>
        <th data-name="HSN" class="<?= $Page->HSN->headerCellClass() ?>"><div id="elh_view_item_received_HSN" class="view_item_received_HSN"><?= $Page->renderSort($Page->HSN) ?></div></th>
<?php } ?>
<?php if ($Page->Pack->Visible) { // Pack ?>
        <th data-name="Pack" class="<?= $Page->Pack->headerCellClass() ?>"><div id="elh_view_item_received_Pack" class="view_item_received_Pack"><?= $Page->renderSort($Page->Pack) ?></div></th>
<?php } ?>
<?php if ($Page->PUnit->Visible) { // PUnit ?>
        <th data-name="PUnit" class="<?= $Page->PUnit->headerCellClass() ?>"><div id="elh_view_item_received_PUnit" class="view_item_received_PUnit"><?= $Page->renderSort($Page->PUnit) ?></div></th>
<?php } ?>
<?php if ($Page->SUnit->Visible) { // SUnit ?>
        <th data-name="SUnit" class="<?= $Page->SUnit->headerCellClass() ?>"><div id="elh_view_item_received_SUnit" class="view_item_received_SUnit"><?= $Page->renderSort($Page->SUnit) ?></div></th>
<?php } ?>
<?php if ($Page->GrnQuantity->Visible) { // GrnQuantity ?>
        <th data-name="GrnQuantity" class="<?= $Page->GrnQuantity->headerCellClass() ?>"><div id="elh_view_item_received_GrnQuantity" class="view_item_received_GrnQuantity"><?= $Page->renderSort($Page->GrnQuantity) ?></div></th>
<?php } ?>
<?php if ($Page->GrnMRP->Visible) { // GrnMRP ?>
        <th data-name="GrnMRP" class="<?= $Page->GrnMRP->headerCellClass() ?>"><div id="elh_view_item_received_GrnMRP" class="view_item_received_GrnMRP"><?= $Page->renderSort($Page->GrnMRP) ?></div></th>
<?php } ?>
<?php if ($Page->trid->Visible) { // trid ?>
        <th data-name="trid" class="<?= $Page->trid->headerCellClass() ?>"><div id="elh_view_item_received_trid" class="view_item_received_trid"><?= $Page->renderSort($Page->trid) ?></div></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_view_item_received_HospID" class="view_item_received_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php if ($Page->CreatedBy->Visible) { // CreatedBy ?>
        <th data-name="CreatedBy" class="<?= $Page->CreatedBy->headerCellClass() ?>"><div id="elh_view_item_received_CreatedBy" class="view_item_received_CreatedBy"><?= $Page->renderSort($Page->CreatedBy) ?></div></th>
<?php } ?>
<?php if ($Page->CreatedDateTime->Visible) { // CreatedDateTime ?>
        <th data-name="CreatedDateTime" class="<?= $Page->CreatedDateTime->headerCellClass() ?>"><div id="elh_view_item_received_CreatedDateTime" class="view_item_received_CreatedDateTime"><?= $Page->renderSort($Page->CreatedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->ModifiedBy->Visible) { // ModifiedBy ?>
        <th data-name="ModifiedBy" class="<?= $Page->ModifiedBy->headerCellClass() ?>"><div id="elh_view_item_received_ModifiedBy" class="view_item_received_ModifiedBy"><?= $Page->renderSort($Page->ModifiedBy) ?></div></th>
<?php } ?>
<?php if ($Page->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
        <th data-name="ModifiedDateTime" class="<?= $Page->ModifiedDateTime->headerCellClass() ?>"><div id="elh_view_item_received_ModifiedDateTime" class="view_item_received_ModifiedDateTime"><?= $Page->renderSort($Page->ModifiedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->grncreatedby->Visible) { // grncreatedby ?>
        <th data-name="grncreatedby" class="<?= $Page->grncreatedby->headerCellClass() ?>"><div id="elh_view_item_received_grncreatedby" class="view_item_received_grncreatedby"><?= $Page->renderSort($Page->grncreatedby) ?></div></th>
<?php } ?>
<?php if ($Page->grncreatedDateTime->Visible) { // grncreatedDateTime ?>
        <th data-name="grncreatedDateTime" class="<?= $Page->grncreatedDateTime->headerCellClass() ?>"><div id="elh_view_item_received_grncreatedDateTime" class="view_item_received_grncreatedDateTime"><?= $Page->renderSort($Page->grncreatedDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->grnModifiedby->Visible) { // grnModifiedby ?>
        <th data-name="grnModifiedby" class="<?= $Page->grnModifiedby->headerCellClass() ?>"><div id="elh_view_item_received_grnModifiedby" class="view_item_received_grnModifiedby"><?= $Page->renderSort($Page->grnModifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->grnModifiedDateTime->Visible) { // grnModifiedDateTime ?>
        <th data-name="grnModifiedDateTime" class="<?= $Page->grnModifiedDateTime->headerCellClass() ?>"><div id="elh_view_item_received_grnModifiedDateTime" class="view_item_received_grnModifiedDateTime"><?= $Page->renderSort($Page->grnModifiedDateTime) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_item_received_QTY">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_DT">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PC">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_YM">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_Stock">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_LastMonthSale">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_Printcheck">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_poid">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_grnid">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_Disc">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PTax">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_MRP">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_SalTax">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PurValue">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PurRate">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_SalRate">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_Discount">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PSGST">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PCGST">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_SSGST">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_SCGST">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_HSN">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_Pack">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_PUnit">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_SUnit">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_GrnQuantity">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_GrnMRP">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_trid">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_HospID">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_CreatedBy">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_CreatedDateTime">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_ModifiedBy">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_ModifiedDateTime">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_grncreatedby">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_grncreatedDateTime">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_grnModifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_item_received_grnModifiedDateTime">
