...
$Page->showMessage();
?>
<form name="fpharmacy_storemastdelete" id="fpharmacy_storemastdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->UR->Visible) { // UR ?>
        <th class="<?= $Page->UR->headerCellClass() ?>"><span id="elh_pharmacy_storemast_UR" class="pharmacy_storemast_UR"><?= $Page->UR->caption() ?></span></th>
<?php } ?>
<?php if ($Page->TAXP->Visible) { // TAXP ?>
        <th class="<?= $Page->TAXP->headerCellClass() ?>"><span id="elh_pharmacy_storemast_TAXP" class="pharmacy_storemast_TAXP"><?= $Page->TAXP->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->OQ->Visible) { // OQ ?>
        <th class="<?= $Page->OQ->headerCellClass() ?>"><span id="elh_pharmacy_storemast_OQ" class="pharmacy_storemast_OQ"><?= $Page->OQ->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RQ->Visible) { // RQ ?>
        <th class="<?= $Page->RQ->headerCellClass() ?>"><span id="elh_pharmacy_storemast_RQ" class="pharmacy_storemast_RQ"><?= $Page->RQ->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MRQ->Visible) { // MRQ ?>
        <th class="<?= $Page->MRQ->headerCellClass() ?>"><span id="elh_pharmacy_storemast_MRQ" class="pharmacy_storemast_MRQ"><?= $Page->MRQ->caption() ?></span></th>
<?php } ?>
<?php if ($Page->IQ->Visible) { // IQ ?>
        <th class="<?= $Page->IQ->headerCellClass() ?>"><span id="elh_pharmacy_storemast_IQ" class="pharmacy_storemast_IQ"><?= $Page->IQ->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->SALQTY->Visible) { // SALQTY ?>
        <th class="<?= $Page->SALQTY->headerCellClass() ?>"><span id="elh_pharmacy_storemast_SALQTY" class="pharmacy_storemast_SALQTY"><?= $Page->SALQTY->caption() ?></span></th>
<?php } ?>
<?php if ($Page->LASTPURDT->Visible) { // LASTPURDT ?>
        <th class="<?= $Page->LASTPURDT->headerCellClass() ?>"><span id="elh_pharmacy_storemast_LASTPURDT" class="pharmacy_storemast_LASTPURDT"><?= $Page->LASTPURDT->caption() ?></span></th>
<?php } ?>
<?php if ($Page->LASTSUPP->Visible) { // LASTSUPP ?>
        <th class="<?= $Page->LASTSUPP->headerCellClass() ?>"><span id="elh_pharmacy_storemast_LASTSUPP" class="pharmacy_storemast_LASTSUPP"><?= $Page->LASTSUPP->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->LASTISSDT->Visible) { // LASTISSDT ?>
        <th class="<?= $Page->LASTISSDT->headerCellClass() ?>"><span id="elh_pharmacy_storemast_LASTISSDT" class="pharmacy_storemast_LASTISSDT"><?= $Page->LASTISSDT->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->OPPRC->Visible) { // OPPRC ?>
        <th class="<?= $Page->OPPRC->headerCellClass() ?>"><span id="elh_pharmacy_storemast_OPPRC" class="pharmacy_storemast_OPPRC"><?= $Page->OPPRC->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RESTRICT->Visible) { // RESTRICT ?>
        <th class="<?= $Page->RESTRICT->headerCellClass() ?>"><span id="elh_pharmacy_storemast_RESTRICT" class="pharmacy_storemast_RESTRICT"><?= $Page->RESTRICT->caption() ?></span></th>
<?php } ?>
<?php if ($Page->BAWAPRC->Visible) { // BAWAPRC ?>
        <th class="<?= $Page->BAWAPRC->headerCellClass() ?>"><span id="elh_pharmacy_storemast_BAWAPRC" class="pharmacy_storemast_BAWAPRC"><?= $Page->BAWAPRC->caption() ?></span></th>
<?php } ?>
<?php if ($Page->STAXPER->Visible) { // STAXPER ?>
        <th class="<?= $Page->STAXPER->headerCellClass() ?>"><span id="elh_pharmacy_storemast_STAXPER" class="pharmacy_storemast_STAXPER"><?= $Page->STAXPER->caption() ?></span></th>
<?php } ?>
<?php if ($Page->TAXTYPE->Visible) { // TAXTYPE ?>
        <th class="<?= $Page->TAXTYPE->headerCellClass() ?>"><span id="elh_pharmacy_storemast_TAXTYPE" class="pharmacy_storemast_TAXTYPE"><?= $Page->TAXTYPE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->OLDTAXP->Visible) { // OLDTAXP ?>
        <th class="<?= $Page->OLDTAXP->headerCellClass() ?>"><span id="elh_pharmacy_storemast_OLDTAXP" class="pharmacy_storemast_OLDTAXP"><?= $Page->OLDTAXP->caption() ?></span></th>
<?php } ?>
<?php if ($Page->TAXUPD->Visible) { // TAXUPD ?>
        <th class="<?= $Page->TAXUPD->headerCellClass() ?>"><span id="elh_pharmacy_storemast_TAXUPD" class="pharmacy_storemast_TAXUPD"><?= $Page->TAXUPD->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PACKAGE->Visible) { // PACKAGE ?>
        <th class="<?= $Page->PACKAGE->headerCellClass() ?>"><span id="elh_pharmacy_storemast_PACKAGE" class="pharmacy_storemast_PACKAGE"><?= $Page->PACKAGE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->NEWRT->Visible) { // NEWRT ?>
        <th class="<?= $Page->NEWRT->headerCellClass() ?>"><span id="elh_pharmacy_storemast_NEWRT" class="pharmacy_storemast_NEWRT"><?= $Page->NEWRT->caption() ?></span></th>
<?php } ?>
<?php if ($Page->NEWMRP->Visible) { // NEWMRP ?>
        <th class="<?= $Page->NEWMRP->headerCellClass() ?>"><span id="elh_pharmacy_storemast_NEWMRP" class="pharmacy_storemast_NEWMRP"><?= $Page->NEWMRP->caption() ?></span></th>
<?php } ?>
<?php if ($Page->NEWUR->Visible) { // NEWUR ?>
        <th class="<?= $Page->NEWUR->headerCellClass() ?>"><span id="elh_pharmacy_storemast_NEWUR" class="pharmacy_storemast_NEWUR"><?= $Page->NEWUR->caption() ?></span></th>
<?php } ?>
<?php if ($Page->STATUS->Visible) { // STATUS ?>
        <th class="<?= $Page->STATUS->headerCellClass() ?>"><span id="elh_pharmacy_storemast_STATUS" class="pharmacy_storemast_STATUS"><?= $Page->STATUS->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RETNQTY->Visible) { // RETNQTY ?>
        <th class="<?= $Page->RETNQTY->headerCellClass() ?>"><span id="elh_pharmacy_storemast_RETNQTY" class="pharmacy_storemast_RETNQTY"><?= $Page->RETNQTY->caption() ?></span></th>
<?php } ?>
<?php if ($Page->KEMODISC->Visible) { // KEMODISC ?>
        <th class="<?= $Page->KEMODISC->headerCellClass() ?>"><span id="elh_pharmacy_storemast_KEMODISC" class="pharmacy_storemast_KEMODISC"><?= $Page->KEMODISC->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PATSALE->Visible) { // PATSALE ?>
        <th class="<?= $Page->PATSALE->headerCellClass() ?>"><span id="elh_pharmacy_storemast_PATSALE" class="pharmacy_storemast_PATSALE"><?= $Page->PATSALE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ORGAN->Visible) { // ORGAN ?>
        <th class="<?= $Page->ORGAN->headerCellClass() ?>"><span id="elh_pharmacy_storemast_ORGAN" class="pharmacy_storemast_ORGAN"><?= $Page->ORGAN->caption() ?></span></th>
<?php } ?>
<?php if ($Page->OLDRQ->Visible) { // OLDRQ ?>
        <th class="<?= $Page->OLDRQ->headerCellClass() ?>"><span id="elh_pharmacy_storemast_OLDRQ" class="pharmacy_storemast_OLDRQ"><?= $Page->OLDRQ->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->STOCK->Visible) { // STOCK ?>
        <th class="<?= $Page->STOCK->headerCellClass() ?>"><span id="elh_pharmacy_storemast_STOCK" class="pharmacy_storemast_STOCK"><?= $Page->STOCK->caption() ?></span></th>
<?php } ?>
<?php if ($Page->RACKNO->Visible) { // RACKNO ?>
        <th class="<?= $Page->RACKNO->headerCellClass() ?>"><span id="elh_pharmacy_storemast_RACKNO" class="pharmacy_storemast_RACKNO"><?= $Page->RACKNO->caption() ?></span></th>
<?php } ?>
<?php if ($Page->SUPPNAME->Visible) { // SUPPNAME ?>
        <th class="<?= $Page->SUPPNAME->headerCellClass() ?>"><span id="elh_pharmacy_storemast_SUPPNAME" class="pharmacy_storemast_SUPPNAME"><?= $Page->SUPPNAME->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->PACKING->Visible) { // PACKING ?>
        <th class="<?= $Page->PACKING->headerCellClass() ?>"><span id="elh_pharmacy_storemast_PACKING" class="pharmacy_storemast_PACKING"><?= $Page->PACKING->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PhysQty->Visible) { // PhysQty ?>
        <th class="<?= $Page->PhysQty->headerCellClass() ?>"><span id="elh_pharmacy_storemast_PhysQty" class="pharmacy_storemast_PhysQty"><?= $Page->PhysQty->caption() ?></span></th>
<?php } ?>
<?php if ($Page->LedQty->Visible) { // LedQty ?>
        <th class="<?= $Page->LedQty->headerCellClass() ?>"><span id="elh_pharmacy_storemast_LedQty" class="pharmacy_storemast_LedQty"><?= $Page->LedQty->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->OV->Visible) { // OV ?>
        <th class="<?= $Page->OV->headerCellClass() ?>"><span id="elh_pharmacy_storemast_OV" class="pharmacy_storemast_OV"><?= $Page->OV->caption() ?></span></th>
<?php } ?>
<?php if ($Page->LATESTOV->Visible) { // LATESTOV ?>
        <th class="<?= $Page->LATESTOV->headerCellClass() ?>"><span id="elh_pharmacy_storemast_LATESTOV" class="pharmacy_storemast_LATESTOV"><?= $Page->LATESTOV->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ITEMTYPE->Visible) { // ITEMTYPE ?>
        <th class="<?= $Page->ITEMTYPE->headerCellClass() ?>"><span id="elh_pharmacy_storemast_ITEMTYPE" class="pharmacy_storemast_ITEMTYPE"><?= $Page->ITEMTYPE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ROWID->Visible) { // ROWID ?>
        <th class="<?= $Page->ROWID->headerCellClass() ?>"><span id="elh_pharmacy_storemast_ROWID" class="pharmacy_storemast_ROWID"><?= $Page->ROWID->caption() ?></span></th>
<?php } ?>
<?php if ($Page->MOVED->Visible) { // MOVED ?>
        <th class="<?= $Page->MOVED->headerCellClass() ?>"><span id="elh_pharmacy_storemast_MOVED" class="pharmacy_storemast_MOVED"><?= $Page->MOVED->caption() ?></span></th>
<?php } ?>
<?php if ($Page->NEWTAX->Visible) { // NEWTAX ?>
        <th class="<?= $Page->NEWTAX->headerCellClass() ?>"><span id="elh_pharmacy_storemast_NEWTAX" class="pharmacy_storemast_NEWTAX"><?= $Page->NEWTAX->caption() ?></span></th>
<?php } ?>
<?php if ($Page->HSNCODE->Visible) { // HSNCODE ?>
        <th class="<?= $Page->HSNCODE->headerCellClass() ?>"><span id="elh_pharmacy_storemast_HSNCODE" class="pharmacy_storemast_HSNCODE"><?= $Page->HSNCODE->caption() ?></span></th>
<?php } ?>
<?php if ($Page->OLDTAX->Visible) { // OLDTAX ?>
        <th class="<?= $Page->OLDTAX->headerCellClass() ?>"><span id="elh_pharmacy_storemast_OLDTAX" class="pharmacy_storemast_OLDTAX"><?= $Page->OLDTAX->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_UR" class="pharmacy_storemast_UR">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_TAXP" class="pharmacy_storemast_TAXP">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_OQ" class="pharmacy_storemast_OQ">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_RQ" class="pharmacy_storemast_RQ">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_MRQ" class="pharmacy_storemast_MRQ">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_IQ" class="pharmacy_storemast_IQ">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_SALQTY" class="pharmacy_storemast_SALQTY">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_LASTPURDT" class="pharmacy_storemast_LASTPURDT">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_LASTSUPP" class="pharmacy_storemast_LASTSUPP">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_LASTISSDT" class="pharmacy_storemast_LASTISSDT">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_OPPRC" class="pharmacy_storemast_OPPRC">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_RESTRICT" class="pharmacy_storemast_RESTRICT">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_BAWAPRC" class="pharmacy_storemast_BAWAPRC">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_STAXPER" class="pharmacy_storemast_STAXPER">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_TAXTYPE" class="pharmacy_storemast_TAXTYPE">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_OLDTAXP" class="pharmacy_storemast_OLDTAXP">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_TAXUPD" class="pharmacy_storemast_TAXUPD">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_PACKAGE" class="pharmacy_storemast_PACKAGE">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_NEWRT" class="pharmacy_storemast_NEWRT">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_NEWMRP" class="pharmacy_storemast_NEWMRP">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_NEWUR" class="pharmacy_storemast_NEWUR">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_STATUS" class="pharmacy_storemast_STATUS">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_RETNQTY" class="pharmacy_storemast_RETNQTY">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_KEMODISC" class="pharmacy_storemast_KEMODISC">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_PATSALE" class="pharmacy_storemast_PATSALE">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_ORGAN" class="pharmacy_storemast_ORGAN">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_OLDRQ" class="pharmacy_storemast_OLDRQ">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_STOCK" class="pharmacy_storemast_STOCK">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_RACKNO" class="pharmacy_storemast_RACKNO">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_SUPPNAME" class="pharmacy_storemast_SUPPNAME">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_PACKING" class="pharmacy_storemast_PACKING">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_PhysQty" class="pharmacy_storemast_PhysQty">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_LedQty" class="pharmacy_storemast_LedQty">
...
<?php } ?>
<?php if ($Page->OV->Visible) { // OV ?>
        <td <?= $Page->OV->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_OV" class="pharmacy_storemast_OV">
...
<?php } ?>
<?php if ($Page->LATESTOV->Visible) { // LATESTOV ?>
        <td <?= $Page->LATESTOV->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_LATESTOV" class="pharmacy_storemast_LATESTOV">
...
<?php } ?>
<?php if ($Page->ITEMTYPE->Visible) { // ITEMTYPE ?>
        <td <?= $Page->ITEMTYPE->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_ITEMTYPE" class="pharmacy_storemast_ITEMTYPE">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_ROWID" class="pharmacy_storemast_ROWID">
...
<?php } ?>
<?php if ($Page->MOVED->Visible) { // MOVED ?>
        <td <?= $Page->MOVED->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_MOVED" class="pharmacy_storemast_MOVED">
...
<?php } ?>
<?php if ($Page->NEWTAX->Visible) { // NEWTAX ?>
        <td <?= $Page->NEWTAX->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_NEWTAX" class="pharmacy_storemast_NEWTAX">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_HSNCODE" class="pharmacy_storemast_HSNCODE">
...
<?php } ?>
<?php if ($Page->OLDTAX->Visible) { // OLDTAX ?>
        <td <?= $Page->OLDTAX->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pharmacy_storemast_OLDTAX" class="pharmacy_storemast_OLDTAX">
