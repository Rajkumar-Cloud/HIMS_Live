...
<form name="fview_patient_serviceslistsrch" id="fview_patient_serviceslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_patient_serviceslist" id="fview_patient_serviceslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
