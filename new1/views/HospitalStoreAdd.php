...
$Page->showMessage();
?>
<form name="fhospital_storeadd" id="fhospital_storeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fhospital_storeadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fhospital_storeadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fhospital_storeadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fhospital_storeadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
