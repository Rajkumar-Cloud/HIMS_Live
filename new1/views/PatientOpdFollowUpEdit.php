...
$Page->showMessage();
?>
<form name="fpatient_opd_follow_upedit" id="fpatient_opd_follow_upedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_patient_opd_follow_up_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_NextReviewDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_EDD", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_LMP", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_ProcedureDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_opd_follow_upedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_opd_follow_upedit", "x_ICSIDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
