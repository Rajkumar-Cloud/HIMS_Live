...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.store_suppliers.fields;
...
$Page->showMessage();
?>
<form name="fstore_suppliersedit" id="fstore_suppliersedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
