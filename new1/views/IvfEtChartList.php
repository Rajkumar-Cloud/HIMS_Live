...
<form name="fivf_et_chartlistsrch" id="fivf_et_chartlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fivf_et_chartlist" id="fivf_et_chartlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
