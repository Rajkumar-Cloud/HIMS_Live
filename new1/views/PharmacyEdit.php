...
$Page->showMessage();
?>
<form name="fpharmacyedit" id="fpharmacyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpharmacyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacyedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacyedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
