...
$Page->showMessage();
?>
<form name="fivf_semenanalysisreportdelete" id="fivf_semenanalysisreportdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->MACS->Visible) { // MACS ?>
        <th class="<?= $Page->MACS->headerCellClass() ?>"><span id="elh_ivf_semenanalysisreport_MACS" class="ivf_semenanalysisreport_MACS"><?= $Page->MACS->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ivf_semenanalysisreport_MACS" class="ivf_semenanalysisreport_MACS">
