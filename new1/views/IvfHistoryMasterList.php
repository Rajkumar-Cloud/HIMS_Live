...
<form name="fivf_history_masterlistsrch" id="fivf_history_masterlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fivf_history_masterlist" id="fivf_history_masterlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
