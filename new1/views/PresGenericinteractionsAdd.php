...
// Page object
$PresGenericinteractionsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpres_genericinteractionsadd;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.pres_genericinteractions.fields;
    fpres_genericinteractionsadd.addFields([
        ...
        ["Catid", [fields.Catid.required ? ew.Validators.required(fields.Catid.caption) : null, ew.Validators.integer], fields.Catid.isInvalid],
        ["Interactions", [fields.Interactions.required ? ew.Validators.required(fields.Interactions.caption) : null], fields.Interactions.isInvalid],
        ["Intid", [fields.Intid.required ? ew.Validators.required(fields.Intid.caption) : null, ew.Validators.integer], fields.Intid.isInvalid],
        ...
        ["Createdtm", [fields.Createdtm.required ? ew.Validators.required(fields.Createdtm.caption) : null, ew.Validators.time], fields.Createdtm.isInvalid],
        ["Statusbit", [fields.Statusbit.required ? ew.Validators.required(fields.Statusbit.caption) : null, ew.Validators.integer], fields.Statusbit.isInvalid],
    ...
    // Set invalid fields
    $(function() {
        var f = fpres_genericinteractionsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpres_genericinteractionsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpres_genericinteractionsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpres_genericinteractionsadd" id="fpres_genericinteractionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<textarea data-table="pres_genericinteractions" data-field="x_Remarks" name="x_Remarks" id="x_Remarks" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Remarks->getPlaceHolder()) ?>"<?= $Page->Remarks->editAttributes() ?> aria-describedby="x_Remarks_help"><?= $Page->Remarks->EditValue ?></textarea>
...
<input type="<?= $Page->_Username->getInputTextType() ?>" data-table="pres_genericinteractions" data-field="x__Username" name="x__Username" id="x__Username" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->_Username->getPlaceHolder()) ?>" value="<?= $Page->_Username->EditValue ?>"<?= $Page->_Username->editAttributes() ?> aria-describedby="x__Username_help">
