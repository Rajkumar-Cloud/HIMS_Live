...
$Page->showMessage();
?>
<form name="femployee_has_degreedelete" id="femployee_has_degreedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th class="<?= $Page->createdby->headerCellClass() ?>"><span id="elh_employee_has_degree_createdby" class="employee_has_degree_createdby"><?= $Page->createdby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th class="<?= $Page->createddatetime->headerCellClass() ?>"><span id="elh_employee_has_degree_createddatetime" class="employee_has_degree_createddatetime"><?= $Page->createddatetime->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th class="<?= $Page->modifiedby->headerCellClass() ?>"><span id="elh_employee_has_degree_modifiedby" class="employee_has_degree_modifiedby"><?= $Page->modifiedby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th class="<?= $Page->modifieddatetime->headerCellClass() ?>"><span id="elh_employee_has_degree_modifieddatetime" class="employee_has_degree_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<span id="el<?= $Page->RowCount ?>_employee_has_degree_createdby" class="employee_has_degree_createdby">
...
<span id="el<?= $Page->RowCount ?>_employee_has_degree_createddatetime" class="employee_has_degree_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_employee_has_degree_modifiedby" class="employee_has_degree_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_employee_has_degree_modifieddatetime" class="employee_has_degree_modifieddatetime">
