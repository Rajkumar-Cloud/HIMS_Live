...
<form name="fview_pharmacy_consumptionlistsrch" id="fview_pharmacy_consumptionlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_pharmacy_consumptionlist" id="fview_pharmacy_consumptionlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->OQ->Visible) { // OQ ?>
        <th data-name="OQ" class="<?= $Page->OQ->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_OQ" class="view_pharmacy_consumption_OQ"><?= $Page->renderSort($Page->OQ) ?></div></th>
<?php } ?>
...
<?php if ($Page->GENNAME->Visible) { // GENNAME ?>
        <th data-name="GENNAME" class="<?= $Page->GENNAME->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_GENNAME" class="view_pharmacy_consumption_GENNAME"><?= $Page->renderSort($Page->GENNAME) ?></div></th>
<?php } ?>
<?php if ($Page->UNIT->Visible) { // UNIT ?>
        <th data-name="UNIT" class="<?= $Page->UNIT->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_UNIT" class="view_pharmacy_consumption_UNIT"><?= $Page->renderSort($Page->UNIT) ?></div></th>
<?php } ?>
<?php if ($Page->RT->Visible) { // RT ?>
        <th data-name="RT" class="<?= $Page->RT->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_RT" class="view_pharmacy_consumption_RT"><?= $Page->renderSort($Page->RT) ?></div></th>
<?php } ?>
<?php if ($Page->SSGST->Visible) { // SSGST ?>
        <th data-name="SSGST" class="<?= $Page->SSGST->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_SSGST" class="view_pharmacy_consumption_SSGST"><?= $Page->renderSort($Page->SSGST) ?></div></th>
<?php } ?>
<?php if ($Page->SCGST->Visible) { // SCGST ?>
        <th data-name="SCGST" class="<?= $Page->SCGST->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_SCGST" class="view_pharmacy_consumption_SCGST"><?= $Page->renderSort($Page->SCGST) ?></div></th>
<?php } ?>
...
<?php if ($Page->BRCODE->Visible) { // BRCODE ?>
        <th data-name="BRCODE" class="<?= $Page->BRCODE->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_BRCODE" class="view_pharmacy_consumption_BRCODE"><?= $Page->renderSort($Page->BRCODE) ?></div></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_view_pharmacy_consumption_HospID" class="view_pharmacy_consumption_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_OQ">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_GENNAME">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_UNIT">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_RT">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_SSGST">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_SCGST">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_BRCODE">
...
<span id="el<?= $Page->RowCount ?>_view_pharmacy_consumption_HospID">
