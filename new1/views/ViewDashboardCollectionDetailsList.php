...
<form name="fview_dashboard_collection_detailslistsrch" id="fview_dashboard_collection_detailslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_dashboard_collection_detailslist" id="fview_dashboard_collection_detailslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
