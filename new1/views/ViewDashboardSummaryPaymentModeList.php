...
<form name="fview_dashboard_summary_payment_modelistsrch" id="fview_dashboard_summary_payment_modelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_dashboard_summary_payment_modelist" id="fview_dashboard_summary_payment_modelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
