...
$Page->showMessage();
?>
<form name="fpharmacy_billing_voucheredit" id="fpharmacy_billing_voucheredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_pharmacy_billing_voucher_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<script>
loadjs.ready(["fpharmacy_billing_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_voucheredit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_billing_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_voucheredit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
