...
<form name="fpharmacy_purchase_request_itemslistsrch" id="fpharmacy_purchase_request_itemslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpharmacy_purchase_request_itemslist" id="fpharmacy_purchase_request_itemslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->ApprovedStatus->Visible) { // ApprovedStatus ?>
        <th data-name="ApprovedStatus" class="<?= $Page->ApprovedStatus->headerCellClass() ?>"><div id="elh_pharmacy_purchase_request_items_ApprovedStatus" class="pharmacy_purchase_request_items_ApprovedStatus"><?= $Page->renderSort($Page->ApprovedStatus) ?></div></th>
<?php } ?>
<?php if ($Page->PurchaseStatus->Visible) { // PurchaseStatus ?>
        <th data-name="PurchaseStatus" class="<?= $Page->PurchaseStatus->headerCellClass() ?>"><div id="elh_pharmacy_purchase_request_items_PurchaseStatus" class="pharmacy_purchase_request_items_PurchaseStatus"><?= $Page->renderSort($Page->PurchaseStatus) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchase_request_items_ApprovedStatus">
...
<span id="el<?= $Page->RowCount ?>_pharmacy_purchase_request_items_PurchaseStatus">
