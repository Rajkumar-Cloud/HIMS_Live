...
// Page object
$PatientEmailAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpatient_emailadd;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fpatient_emailadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpatient_emailadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpatient_emailadd" id="fpatient_emailadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpatient_emailadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_emailadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_emailadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_emailadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
