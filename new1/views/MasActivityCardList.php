...
<form name="fmas_activity_cardlistsrch" id="fmas_activity_cardlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fmas_activity_cardlist" id="fmas_activity_cardlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
