...
<form name="fview_dashboard_patient_summarylistsrch" id="fview_dashboard_patient_summarylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_dashboard_patient_summarylist" id="fview_dashboard_patient_summarylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
