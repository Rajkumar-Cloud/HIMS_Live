...
// Page object
$PresFluidformulationAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpres_fluidformulationadd;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.pres_fluidformulation.fields;
    fpres_fluidformulationadd.addFields([
        ["Tradename", [fields.Tradename.required ? ew.Validators.required(fields.Tradename.caption) : null], fields.Tradename.isInvalid],
        ...
        ["VolumeUnit", [fields.VolumeUnit.required ? ew.Validators.required(fields.VolumeUnit.caption) : null], fields.VolumeUnit.isInvalid],
        ...
        ["StrengthUnit", [fields.StrengthUnit.required ? ew.Validators.required(fields.StrengthUnit.caption) : null], fields.StrengthUnit.isInvalid],
    ...
    // Set invalid fields
    $(function() {
        var f = fpres_fluidformulationadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpres_fluidformulationadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpres_fluidformulationadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpres_fluidformulationadd" id="fpres_fluidformulationadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<textarea data-table="pres_fluidformulation" data-field="x_Tradename" name="x_Tradename" id="x_Tradename" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Tradename->getPlaceHolder()) ?>"<?= $Page->Tradename->editAttributes() ?> aria-describedby="x_Tradename_help"><?= $Page->Tradename->EditValue ?></textarea>
