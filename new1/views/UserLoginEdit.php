...
$Page->showMessage();
?>
<form name="fuser_loginedit" id="fuser_loginedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fuser_loginedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fuser_loginedit", "x_CreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
