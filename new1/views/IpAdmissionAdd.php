...
$Page->showMessage();
?>
<form name="fip_admissionadd" id="fip_admissionadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fip_admissionadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fip_admissionadd", "x_admission_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fip_admissionadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fip_admissionadd", "x_release_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fip_admissionadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fip_admissionadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fip_admissionadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fip_admissionadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
