...
// Page object
$EmployeeHasExperienceAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var femployee_has_experienceadd;
loadjs.ready("head", function () {
    ...
    femployee_has_experienceadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = femployee_has_experienceadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    femployee_has_experienceadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    femployee_has_experienceadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="femployee_has_experienceadd" id="femployee_has_experienceadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_has_experienceadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_has_experienceadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["femployee_has_experienceadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_has_experienceadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
