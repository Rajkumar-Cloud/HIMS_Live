...
<form name="fview_procedure_registeredlistsrch" id="fview_procedure_registeredlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_procedure_registeredlist" id="fview_procedure_registeredlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
