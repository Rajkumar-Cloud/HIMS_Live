...
$Page->showMessage();
?>
<form name="fpatient_follow_upadd" id="fpatient_follow_upadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fpatient_follow_upadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_follow_upadd", "x_NextReviewDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
