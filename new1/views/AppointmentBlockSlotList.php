...
<form name="fappointment_block_slotlistsrch" id="fappointment_block_slotlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fappointment_block_slotlist" id="fappointment_block_slotlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
