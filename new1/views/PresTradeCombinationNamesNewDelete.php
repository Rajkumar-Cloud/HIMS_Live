...
$Page->showMessage();
?>
<form name="fpres_trade_combination_names_newdelete" id="fpres_trade_combination_names_newdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
