...
$Page->showMessage();
?>
<form name="femployee_emailadd" id="femployee_emailadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["femployee_emailadd", "datetimepicker"], function() {
    ew.createDateTimePicker("femployee_emailadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
