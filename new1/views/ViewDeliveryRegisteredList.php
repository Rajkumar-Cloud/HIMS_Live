...
<form name="fview_delivery_registeredlistsrch" id="fview_delivery_registeredlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_delivery_registeredlist" id="fview_delivery_registeredlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
