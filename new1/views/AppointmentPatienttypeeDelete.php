...
$Page->showMessage();
?>
<form name="fappointment_patienttypeedelete" id="fappointment_patienttypeedelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
