...
<form name="fmas_reference_typelistsrch" id="fmas_reference_typelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fmas_reference_typelist" id="fmas_reference_typelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
