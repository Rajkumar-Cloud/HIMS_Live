...
$Page->showMessage();
?>
<form name="fip_admissiondelete" id="fip_admissiondelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->status->Visible) { // status ?>
        <th class="<?= $Page->status->headerCellClass() ?>"><span id="elh_ip_admission_status" class="ip_admission_status"><?= $Page->status->caption() ?></span></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th class="<?= $Page->createdby->headerCellClass() ?>"><span id="elh_ip_admission_createdby" class="ip_admission_createdby"><?= $Page->createdby->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th class="<?= $Page->modifiedby->headerCellClass() ?>"><span id="elh_ip_admission_modifiedby" class="ip_admission_modifiedby"><?= $Page->modifiedby->caption() ?></span></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th class="<?= $Page->modifieddatetime->headerCellClass() ?>"><span id="elh_ip_admission_modifieddatetime" class="ip_admission_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_ip_admission_status" class="ip_admission_status">
...
<span id="el<?= $Page->RowCount ?>_ip_admission_createdby" class="ip_admission_createdby">
...
<span id="el<?= $Page->RowCount ?>_ip_admission_modifiedby" class="ip_admission_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_ip_admission_modifieddatetime" class="ip_admission_modifieddatetime">
