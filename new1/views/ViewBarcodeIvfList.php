...
<form name="fview_barcode_ivflistsrch" id="fview_barcode_ivflistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_barcode_ivflist" id="fview_barcode_ivflist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th data-name="DrID" class="<?= $Page->DrID->headerCellClass() ?>"><div id="elh_view_barcode_ivf_DrID" class="view_barcode_ivf_DrID"><?= $Page->renderSort($Page->DrID) ?></div></th>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
        <th data-name="DrDepartment" class="<?= $Page->DrDepartment->headerCellClass() ?>"><div id="elh_view_barcode_ivf_DrDepartment" class="view_barcode_ivf_DrDepartment"><?= $Page->renderSort($Page->DrDepartment) ?></div></th>
<?php } ?>
<?php if ($Page->Doctor->Visible) { // Doctor ?>
        <th data-name="Doctor" class="<?= $Page->Doctor->headerCellClass() ?>"><div id="elh_view_barcode_ivf_Doctor" class="view_barcode_ivf_Doctor"><?= $Page->renderSort($Page->Doctor) ?></div></th>
<?php } ?>
<?php if ($Page->Male->Visible) { // Male ?>
        <th data-name="Male" class="<?= $Page->Male->headerCellClass() ?>"><div id="elh_view_barcode_ivf_Male" class="view_barcode_ivf_Male"><?= $Page->renderSort($Page->Male) ?></div></th>
<?php } ?>
<?php if ($Page->Female->Visible) { // Female ?>
        <th data-name="Female" class="<?= $Page->Female->headerCellClass() ?>"><div id="elh_view_barcode_ivf_Female" class="view_barcode_ivf_Female"><?= $Page->renderSort($Page->Female) ?></div></th>
<?php } ?>
<?php if ($Page->status->Visible) { // status ?>
        <th data-name="status" class="<?= $Page->status->headerCellClass() ?>"><div id="elh_view_barcode_ivf_status" class="view_barcode_ivf_status"><?= $Page->renderSort($Page->status) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_view_barcode_ivf_createdby" class="view_barcode_ivf_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th data-name="createddatetime" class="<?= $Page->createddatetime->headerCellClass() ?>"><div id="elh_view_barcode_ivf_createddatetime" class="view_barcode_ivf_createddatetime"><?= $Page->renderSort($Page->createddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_view_barcode_ivf_modifiedby" class="view_barcode_ivf_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_view_barcode_ivf_modifieddatetime" class="view_barcode_ivf_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->HusbandEducation->Visible) { // HusbandEducation ?>
        <th data-name="HusbandEducation" class="<?= $Page->HusbandEducation->headerCellClass() ?>"><div id="elh_view_barcode_ivf_HusbandEducation" class="view_barcode_ivf_HusbandEducation"><?= $Page->renderSort($Page->HusbandEducation) ?></div></th>
<?php } ?>
<?php if ($Page->WifeEducation->Visible) { // WifeEducation ?>
        <th data-name="WifeEducation" class="<?= $Page->WifeEducation->headerCellClass() ?>"><div id="elh_view_barcode_ivf_WifeEducation" class="view_barcode_ivf_WifeEducation"><?= $Page->renderSort($Page->WifeEducation) ?></div></th>
<?php } ?>
<?php if ($Page->HusbandWorkHours->Visible) { // HusbandWorkHours ?>
        <th data-name="HusbandWorkHours" class="<?= $Page->HusbandWorkHours->headerCellClass() ?>"><div id="elh_view_barcode_ivf_HusbandWorkHours" class="view_barcode_ivf_HusbandWorkHours"><?= $Page->renderSort($Page->HusbandWorkHours) ?></div></th>
<?php } ?>
<?php if ($Page->WifeWorkHours->Visible) { // WifeWorkHours ?>
        <th data-name="WifeWorkHours" class="<?= $Page->WifeWorkHours->headerCellClass() ?>"><div id="elh_view_barcode_ivf_WifeWorkHours" class="view_barcode_ivf_WifeWorkHours"><?= $Page->renderSort($Page->WifeWorkHours) ?></div></th>
<?php } ?>
<?php if ($Page->PatientLanguage->Visible) { // PatientLanguage ?>
        <th data-name="PatientLanguage" class="<?= $Page->PatientLanguage->headerCellClass() ?>"><div id="elh_view_barcode_ivf_PatientLanguage" class="view_barcode_ivf_PatientLanguage"><?= $Page->renderSort($Page->PatientLanguage) ?></div></th>
<?php } ?>
<?php if ($Page->ReferedBy->Visible) { // ReferedBy ?>
        <th data-name="ReferedBy" class="<?= $Page->ReferedBy->headerCellClass() ?>"><div id="elh_view_barcode_ivf_ReferedBy" class="view_barcode_ivf_ReferedBy"><?= $Page->renderSort($Page->ReferedBy) ?></div></th>
<?php } ?>
<?php if ($Page->ReferPhNo->Visible) { // ReferPhNo ?>
        <th data-name="ReferPhNo" class="<?= $Page->ReferPhNo->headerCellClass() ?>"><div id="elh_view_barcode_ivf_ReferPhNo" class="view_barcode_ivf_ReferPhNo"><?= $Page->renderSort($Page->ReferPhNo) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_DrID">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_DrDepartment">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_Doctor">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_Male">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_Female">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_status">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_createdby">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_HusbandEducation">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_WifeEducation">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_HusbandWorkHours">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_WifeWorkHours">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_PatientLanguage">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_ReferedBy">
...
<span id="el<?= $Page->RowCount ?>_view_barcode_ivf_ReferPhNo">
