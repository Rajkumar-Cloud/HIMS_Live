...
$Page->showMessage();
?>
<form name="fdepositdetailsadd" id="fdepositdetailsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fdepositdetailsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fdepositdetailsadd", "x_DepositDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fdepositdetailsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fdepositdetailsadd", "x_CreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fdepositdetailsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fdepositdetailsadd", "x_ModifiedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
