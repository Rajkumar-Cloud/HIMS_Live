...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.mas_degree.fields;
...
$Page->showMessage();
?>
<form name="fmas_degreeadd" id="fmas_degreeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<input type="<?= $Page->id->getInputTextType() ?>" data-table="mas_degree" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?= HtmlEncode($Page->id->getPlaceHolder()) ?>" value="<?= $Page->id->EditValue ?>"<?= $Page->id->editAttributes() ?> aria-describedby="x_id_help">
