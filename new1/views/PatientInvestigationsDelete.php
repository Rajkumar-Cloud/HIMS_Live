...
$Page->showMessage();
?>
<form name="fpatient_investigationsdelete" id="fpatient_investigationsdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th class="<?= $Page->Reception->headerCellClass() ?>"><span id="elh_patient_investigations_Reception" class="patient_investigations_Reception"><?= $Page->Reception->caption() ?></span></th>
<?php } ?>
<?php if ($Page->PatientId->Visible) { // PatientId ?>
        <th class="<?= $Page->PatientId->headerCellClass() ?>"><span id="elh_patient_investigations_PatientId" class="patient_investigations_PatientId"><?= $Page->PatientId->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
        <th class="<?= $Page->PatientName->headerCellClass() ?>"><span id="elh_patient_investigations_PatientName" class="patient_investigations_PatientName"><?= $Page->PatientName->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_patient_investigations_Reception" class="patient_investigations_Reception">
...
<span id="el<?= $Page->RowCount ?>_patient_investigations_PatientId" class="patient_investigations_PatientId">
...
<span id="el<?= $Page->RowCount ?>_patient_investigations_PatientName" class="patient_investigations_PatientName">
