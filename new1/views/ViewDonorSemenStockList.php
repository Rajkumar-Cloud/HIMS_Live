...
<form name="fview_donor_semen_stocklistsrch" id="fview_donor_semen_stocklistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_donor_semen_stocklist" id="fview_donor_semen_stocklist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
