...
$Page->showMessage();
?>
<form name="fpatient_insuranceedit" id="fpatient_insuranceedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpatient_insuranceedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_insuranceedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_insuranceedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_insuranceedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
