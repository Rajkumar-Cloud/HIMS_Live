...
$Page->showMessage();
?>
<form name="fpharmacy_billing_returnview" id="fpharmacy_billing_returnview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <tr id="r_Reception">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Reception"><?= $Page->Reception->caption() ?></span></td>
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <tr id="r_PatientId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PatientId"><?= $Page->PatientId->caption() ?></span></td>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <tr id="r_mrnno">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_mrnno"><?= $Page->mrnno->caption() ?></span></td>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <tr id="r_PatientName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PatientName"><?= $Page->PatientName->caption() ?></span></td>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <tr id="r_Age">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Age"><?= $Page->Age->caption() ?></span></td>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <tr id="r_Gender">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Gender"><?= $Page->Gender->caption() ?></span></td>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <tr id="r_profilePic">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_profilePic"><?= $Page->profilePic->caption() ?></span></td>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <tr id="r_Mobile">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Mobile"><?= $Page->Mobile->caption() ?></span></td>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
    <tr id="r_IP_OP">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_IP_OP"><?= $Page->IP_OP->caption() ?></span></td>
...
<?php if ($Page->Doctor->Visible) { // Doctor ?>
    <tr id="r_Doctor">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Doctor"><?= $Page->Doctor->caption() ?></span></td>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
    <tr id="r_voucher_type">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_voucher_type"><?= $Page->voucher_type->caption() ?></span></td>
...
<?php if ($Page->Details->Visible) { // Details ?>
    <tr id="r_Details">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Details"><?= $Page->Details->caption() ?></span></td>
...
<?php if ($Page->ModeofPayment->Visible) { // ModeofPayment ?>
    <tr id="r_ModeofPayment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_ModeofPayment"><?= $Page->ModeofPayment->caption() ?></span></td>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <tr id="r_Amount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Amount"><?= $Page->Amount->caption() ?></span></td>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
    <tr id="r_AnyDues">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_AnyDues"><?= $Page->AnyDues->caption() ?></span></td>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <tr id="r_createdby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_createdby"><?= $Page->createdby->caption() ?></span></td>
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <tr id="r_createddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_createddatetime"><?= $Page->createddatetime->caption() ?></span></td>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <tr id="r_modifiedby">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_modifiedby"><?= $Page->modifiedby->caption() ?></span></td>
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <tr id="r_modifieddatetime">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_modifieddatetime"><?= $Page->modifieddatetime->caption() ?></span></td>
...
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
    <tr id="r_RealizationAmount">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationAmount"><?= $Page->RealizationAmount->caption() ?></span></td>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
    <tr id="r_RealizationStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationStatus"><?= $Page->RealizationStatus->caption() ?></span></td>
...
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
    <tr id="r_RealizationRemarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationRemarks"><?= $Page->RealizationRemarks->caption() ?></span></td>
...
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
    <tr id="r_RealizationBatchNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationBatchNo"><?= $Page->RealizationBatchNo->caption() ?></span></td>
...
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
    <tr id="r_RealizationDate">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RealizationDate"><?= $Page->RealizationDate->caption() ?></span></td>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <tr id="r_HospID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_HospID"><?= $Page->HospID->caption() ?></span></td>
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <tr id="r_RIDNO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RIDNO"><?= $Page->RIDNO->caption() ?></span></td>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <tr id="r_TidNo">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_TidNo"><?= $Page->TidNo->caption() ?></span></td>
...
<?php if ($Page->CId->Visible) { // CId ?>
    <tr id="r_CId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_CId"><?= $Page->CId->caption() ?></span></td>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <tr id="r_PartnerName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PartnerName"><?= $Page->PartnerName->caption() ?></span></td>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
    <tr id="r_PayerType">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PayerType"><?= $Page->PayerType->caption() ?></span></td>
...
<?php if ($Page->Dob->Visible) { // Dob ?>
    <tr id="r_Dob">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Dob"><?= $Page->Dob->caption() ?></span></td>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <tr id="r_Currency">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Currency"><?= $Page->Currency->caption() ?></span></td>
...
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
    <tr id="r_DiscountRemarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_DiscountRemarks"><?= $Page->DiscountRemarks->caption() ?></span></td>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <tr id="r_Remarks">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_Remarks"><?= $Page->Remarks->caption() ?></span></td>
...
<?php if ($Page->PatId->Visible) { // PatId ?>
    <tr id="r_PatId">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PatId"><?= $Page->PatId->caption() ?></span></td>
...
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
    <tr id="r_DrDepartment">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_DrDepartment"><?= $Page->DrDepartment->caption() ?></span></td>
...
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
    <tr id="r_RefferedBy">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_RefferedBy"><?= $Page->RefferedBy->caption() ?></span></td>
...
<?php if ($Page->BillNumber->Visible) { // BillNumber ?>
    <tr id="r_BillNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_BillNumber"><?= $Page->BillNumber->caption() ?></span></td>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <tr id="r_CardNumber">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_CardNumber"><?= $Page->CardNumber->caption() ?></span></td>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <tr id="r_BankName">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_BankName"><?= $Page->BankName->caption() ?></span></td>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <tr id="r_DrID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_DrID"><?= $Page->DrID->caption() ?></span></td>
...
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
    <tr id="r_BillStatus">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_BillStatus"><?= $Page->BillStatus->caption() ?></span></td>
...
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
    <tr id="r_ReportHeader">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_ReportHeader"><?= $Page->ReportHeader->caption() ?></span></td>
...
<?php if ($Page->PharID->Visible) { // PharID ?>
    <tr id="r_PharID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pharmacy_billing_return_PharID"><?= $Page->PharID->caption() ?></span></td>
