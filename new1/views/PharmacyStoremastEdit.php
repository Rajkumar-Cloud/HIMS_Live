...
$Page->showMessage();
?>
<form name="fpharmacy_storemastedit" id="fpharmacy_storemastedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpharmacy_storemastedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_storemastedit", "x_CREATEDDT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
