...
<form name="fview_ip_billinglistsrch" id="fview_ip_billinglistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_ip_billinglist" id="fview_ip_billinglist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->age->Visible) { // age ?>
        <th data-name="age" class="<?= $Page->age->headerCellClass() ?>"><div id="elh_view_ip_billing_age" class="view_ip_billing_age"><?= $Page->renderSort($Page->age) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_ip_billing_age">
