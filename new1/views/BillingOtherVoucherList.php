...
<form name="fbilling_other_voucherlistsrch" id="fbilling_other_voucherlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fbilling_other_voucherlist" id="fbilling_other_voucherlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Name->Visible) { // Name ?>
        <th data-name="Name" class="<?= $Page->Name->headerCellClass() ?>"><div id="elh_billing_other_voucher_Name" class="billing_other_voucher_Name"><?= $Page->renderSort($Page->Name) ?></div></th>
<?php } ?>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
        <th data-name="voucher_type" class="<?= $Page->voucher_type->headerCellClass() ?>"><div id="elh_billing_other_voucher_voucher_type" class="billing_other_voucher_voucher_type"><?= $Page->renderSort($Page->voucher_type) ?></div></th>
<?php } ?>
<?php if ($Page->Details->Visible) { // Details ?>
        <th data-name="Details" class="<?= $Page->Details->headerCellClass() ?>"><div id="elh_billing_other_voucher_Details" class="billing_other_voucher_Details"><?= $Page->renderSort($Page->Details) ?></div></th>
<?php } ?>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
        <th data-name="AnyDues" class="<?= $Page->AnyDues->headerCellClass() ?>"><div id="elh_billing_other_voucher_AnyDues" class="billing_other_voucher_AnyDues"><?= $Page->renderSort($Page->AnyDues) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_billing_other_voucher_createdby" class="billing_other_voucher_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th data-name="createddatetime" class="<?= $Page->createddatetime->headerCellClass() ?>"><div id="elh_billing_other_voucher_createddatetime" class="billing_other_voucher_createddatetime"><?= $Page->renderSort($Page->createddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_billing_other_voucher_modifiedby" class="billing_other_voucher_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_billing_other_voucher_modifieddatetime" class="billing_other_voucher_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->PatID->Visible) { // PatID ?>
        <th data-name="PatID" class="<?= $Page->PatID->headerCellClass() ?>"><div id="elh_billing_other_voucher_PatID" class="billing_other_voucher_PatID"><?= $Page->renderSort($Page->PatID) ?></div></th>
<?php } ?>
...
<?php if ($Page->VisiteType->Visible) { // VisiteType ?>
        <th data-name="VisiteType" class="<?= $Page->VisiteType->headerCellClass() ?>"><div id="elh_billing_other_voucher_VisiteType" class="billing_other_voucher_VisiteType"><?= $Page->renderSort($Page->VisiteType) ?></div></th>
<?php } ?>
<?php if ($Page->VisitDate->Visible) { // VisitDate ?>
        <th data-name="VisitDate" class="<?= $Page->VisitDate->headerCellClass() ?>"><div id="elh_billing_other_voucher_VisitDate" class="billing_other_voucher_VisitDate"><?= $Page->renderSort($Page->VisitDate) ?></div></th>
<?php } ?>
...
<?php if ($Page->Status->Visible) { // Status ?>
        <th data-name="Status" class="<?= $Page->Status->headerCellClass() ?>"><div id="elh_billing_other_voucher_Status" class="billing_other_voucher_Status"><?= $Page->renderSort($Page->Status) ?></div></th>
<?php } ?>
...
<?php if ($Page->AdvanceValidityDate->Visible) { // AdvanceValidityDate ?>
        <th data-name="AdvanceValidityDate" class="<?= $Page->AdvanceValidityDate->headerCellClass() ?>"><div id="elh_billing_other_voucher_AdvanceValidityDate" class="billing_other_voucher_AdvanceValidityDate"><?= $Page->renderSort($Page->AdvanceValidityDate) ?></div></th>
<?php } ?>
<?php if ($Page->TotalRemainingAdvance->Visible) { // TotalRemainingAdvance ?>
        <th data-name="TotalRemainingAdvance" class="<?= $Page->TotalRemainingAdvance->headerCellClass() ?>"><div id="elh_billing_other_voucher_TotalRemainingAdvance" class="billing_other_voucher_TotalRemainingAdvance"><?= $Page->renderSort($Page->TotalRemainingAdvance) ?></div></th>
<?php } ?>
<?php if ($Page->SeectPaymentMode->Visible) { // SeectPaymentMode ?>
        <th data-name="SeectPaymentMode" class="<?= $Page->SeectPaymentMode->headerCellClass() ?>"><div id="elh_billing_other_voucher_SeectPaymentMode" class="billing_other_voucher_SeectPaymentMode"><?= $Page->renderSort($Page->SeectPaymentMode) ?></div></th>
<?php } ?>
<?php if ($Page->PaidAmount->Visible) { // PaidAmount ?>
        <th data-name="PaidAmount" class="<?= $Page->PaidAmount->headerCellClass() ?>"><div id="elh_billing_other_voucher_PaidAmount" class="billing_other_voucher_PaidAmount"><?= $Page->renderSort($Page->PaidAmount) ?></div></th>
<?php } ?>
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th data-name="Currency" class="<?= $Page->Currency->headerCellClass() ?>"><div id="elh_billing_other_voucher_Currency" class="billing_other_voucher_Currency"><?= $Page->renderSort($Page->Currency) ?></div></th>
<?php } ?>
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
        <th data-name="CardNumber" class="<?= $Page->CardNumber->headerCellClass() ?>"><div id="elh_billing_other_voucher_CardNumber" class="billing_other_voucher_CardNumber"><?= $Page->renderSort($Page->CardNumber) ?></div></th>
<?php } ?>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_billing_other_voucher_HospID" class="billing_other_voucher_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th data-name="Reception" class="<?= $Page->Reception->headerCellClass() ?>"><div id="elh_billing_other_voucher_Reception" class="billing_other_voucher_Reception"><?= $Page->renderSort($Page->Reception) ?></div></th>
<?php } ?>
<?php if ($Page->mrnno->Visible) { // mrnno ?>
        <th data-name="mrnno" class="<?= $Page->mrnno->headerCellClass() ?>"><div id="elh_billing_other_voucher_mrnno" class="billing_other_voucher_mrnno"><?= $Page->renderSort($Page->mrnno) ?></div></th>
<?php } ?>
...
<?php if ($Page->AdjustmentwithAdvance->Visible) { // AdjustmentwithAdvance ?>
        <th data-name="AdjustmentwithAdvance" class="<?= $Page->AdjustmentwithAdvance->headerCellClass() ?>"><div id="elh_billing_other_voucher_AdjustmentwithAdvance" class="billing_other_voucher_AdjustmentwithAdvance"><?= $Page->renderSort($Page->AdjustmentwithAdvance) ?></div></th>
<?php } ?>
<?php if ($Page->AdjustmentBillNumber->Visible) { // AdjustmentBillNumber ?>
        <th data-name="AdjustmentBillNumber" class="<?= $Page->AdjustmentBillNumber->headerCellClass() ?>"><div id="elh_billing_other_voucher_AdjustmentBillNumber" class="billing_other_voucher_AdjustmentBillNumber"><?= $Page->renderSort($Page->AdjustmentBillNumber) ?></div></th>
<?php } ?>
...
<?php if ($Page->CancelBy->Visible) { // CancelBy ?>
        <th data-name="CancelBy" class="<?= $Page->CancelBy->headerCellClass() ?>"><div id="elh_billing_other_voucher_CancelBy" class="billing_other_voucher_CancelBy"><?= $Page->renderSort($Page->CancelBy) ?></div></th>
<?php } ?>
<?php if ($Page->CancelDate->Visible) { // CancelDate ?>
        <th data-name="CancelDate" class="<?= $Page->CancelDate->headerCellClass() ?>"><div id="elh_billing_other_voucher_CancelDate" class="billing_other_voucher_CancelDate"><?= $Page->renderSort($Page->CancelDate) ?></div></th>
<?php } ?>
<?php if ($Page->CancelDateTime->Visible) { // CancelDateTime ?>
        <th data-name="CancelDateTime" class="<?= $Page->CancelDateTime->headerCellClass() ?>"><div id="elh_billing_other_voucher_CancelDateTime" class="billing_other_voucher_CancelDateTime"><?= $Page->renderSort($Page->CancelDateTime) ?></div></th>
<?php } ?>
<?php if ($Page->CanceledBy->Visible) { // CanceledBy ?>
        <th data-name="CanceledBy" class="<?= $Page->CanceledBy->headerCellClass() ?>"><div id="elh_billing_other_voucher_CanceledBy" class="billing_other_voucher_CanceledBy"><?= $Page->renderSort($Page->CanceledBy) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_Name">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_voucher_type">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_Details">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_AnyDues">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_createdby">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_PatID">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_VisiteType">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_VisitDate">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_Status">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_AdvanceValidityDate">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_TotalRemainingAdvance">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_SeectPaymentMode">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_PaidAmount">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_Currency">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_CardNumber">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_HospID">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_Reception">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_mrnno">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_AdjustmentwithAdvance">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_AdjustmentBillNumber">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_CancelBy">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_CancelDate">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_CancelDateTime">
...
<span id="el<?= $Page->RowCount ?>_billing_other_voucher_CanceledBy">
