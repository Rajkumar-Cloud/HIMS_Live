...
$Page->showMessage();
?>
<form name="fivf_oocytedenudationdelete" id="fivf_oocytedenudationdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->patient2->Visible) { // patient2 ?>
        <th class="<?= $Page->patient2->headerCellClass() ?>"><span id="elh_ivf_oocytedenudation_patient2" class="ivf_oocytedenudation_patient2"><?= $Page->patient2->caption() ?></span></th>
<?php } ?>
<?php if ($Page->OocytesDonate1->Visible) { // OocytesDonate1 ?>
        <th class="<?= $Page->OocytesDonate1->headerCellClass() ?>"><span id="elh_ivf_oocytedenudation_OocytesDonate1" class="ivf_oocytedenudation_OocytesDonate1"><?= $Page->OocytesDonate1->caption() ?></span></th>
<?php } ?>
<?php if ($Page->OocytesDonate2->Visible) { // OocytesDonate2 ?>
        <th class="<?= $Page->OocytesDonate2->headerCellClass() ?>"><span id="elh_ivf_oocytedenudation_OocytesDonate2" class="ivf_oocytedenudation_OocytesDonate2"><?= $Page->OocytesDonate2->caption() ?></span></th>
<?php } ?>
<?php if ($Page->ETDonate->Visible) { // ETDonate ?>
        <th class="<?= $Page->ETDonate->headerCellClass() ?>"><span id="elh_ivf_oocytedenudation_ETDonate" class="ivf_oocytedenudation_ETDonate"><?= $Page->ETDonate->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($Page->patient2->Visible) { // patient2 ?>
        <td <?= $Page->patient2->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_patient2" class="ivf_oocytedenudation_patient2">
...
<?php } ?>
<?php if ($Page->OocytesDonate1->Visible) { // OocytesDonate1 ?>
        <td <?= $Page->OocytesDonate1->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_OocytesDonate1" class="ivf_oocytedenudation_OocytesDonate1">
...
<?php } ?>
<?php if ($Page->OocytesDonate2->Visible) { // OocytesDonate2 ?>
        <td <?= $Page->OocytesDonate2->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_OocytesDonate2" class="ivf_oocytedenudation_OocytesDonate2">
...
<?php } ?>
<?php if ($Page->ETDonate->Visible) { // ETDonate ?>
        <td <?= $Page->ETDonate->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_ivf_oocytedenudation_ETDonate" class="ivf_oocytedenudation_ETDonate">
