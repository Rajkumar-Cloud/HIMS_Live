...
// Page object
$IvfMasUserTemplateAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_mas_user_templateadd;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.ivf_mas_user_template.fields;
    fivf_mas_user_templateadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fivf_mas_user_templateadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_mas_user_templateadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_mas_user_templateadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fivf_mas_user_templateadd" id="fivf_mas_user_templateadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->created->Visible) { // created ?>
    <div id="r_created" class="form-group row">
        <label id="elh_ivf_mas_user_template_created" for="x_created" class="<?= $Page->LeftColumnClass ?>"><?= $Page->created->caption() ?><?= $Page->created->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->created->cellAttributes() ?>>
<span id="el_ivf_mas_user_template_created">
<input type="<?= $Page->created->getInputTextType() ?>" data-table="ivf_mas_user_template" data-field="x_created" name="x_created" id="x_created" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->created->getPlaceHolder()) ?>" value="<?= $Page->created->EditValue ?>"<?= $Page->created->editAttributes() ?> aria-describedby="x_created_help">
...
<?php if ($Page->createdDatetime->Visible) { // createdDatetime ?>
    <div id="r_createdDatetime" class="form-group row">
        <label id="elh_ivf_mas_user_template_createdDatetime" for="x_createdDatetime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->createdDatetime->caption() ?><?= $Page->createdDatetime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->createdDatetime->cellAttributes() ?>>
<span id="el_ivf_mas_user_template_createdDatetime">
<input type="<?= $Page->createdDatetime->getInputTextType() ?>" data-table="ivf_mas_user_template" data-field="x_createdDatetime" name="x_createdDatetime" id="x_createdDatetime" placeholder="<?= HtmlEncode($Page->createdDatetime->getPlaceHolder()) ?>" value="<?= $Page->createdDatetime->EditValue ?>"<?= $Page->createdDatetime->editAttributes() ?> aria-describedby="x_createdDatetime_help">
...
<script>
loadjs.ready(["fivf_mas_user_templateadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_mas_user_templateadd", "x_createdDatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->modified->Visible) { // modified ?>
    <div id="r_modified" class="form-group row">
        <label id="elh_ivf_mas_user_template_modified" for="x_modified" class="<?= $Page->LeftColumnClass ?>"><?= $Page->modified->caption() ?><?= $Page->modified->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->modified->cellAttributes() ?>>
<span id="el_ivf_mas_user_template_modified">
<input type="<?= $Page->modified->getInputTextType() ?>" data-table="ivf_mas_user_template" data-field="x_modified" name="x_modified" id="x_modified" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->modified->getPlaceHolder()) ?>" value="<?= $Page->modified->EditValue ?>"<?= $Page->modified->editAttributes() ?> aria-describedby="x_modified_help">
...
<?php if ($Page->modifiedDatetime->Visible) { // modifiedDatetime ?>
    <div id="r_modifiedDatetime" class="form-group row">
        <label id="elh_ivf_mas_user_template_modifiedDatetime" for="x_modifiedDatetime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->modifiedDatetime->caption() ?><?= $Page->modifiedDatetime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->modifiedDatetime->cellAttributes() ?>>
<span id="el_ivf_mas_user_template_modifiedDatetime">
<input type="<?= $Page->modifiedDatetime->getInputTextType() ?>" data-table="ivf_mas_user_template" data-field="x_modifiedDatetime" name="x_modifiedDatetime" id="x_modifiedDatetime" placeholder="<?= HtmlEncode($Page->modifiedDatetime->getPlaceHolder()) ?>" value="<?= $Page->modifiedDatetime->EditValue ?>"<?= $Page->modifiedDatetime->editAttributes() ?> aria-describedby="x_modifiedDatetime_help">
...
<script>
loadjs.ready(["fivf_mas_user_templateadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_mas_user_templateadd", "x_modifiedDatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
