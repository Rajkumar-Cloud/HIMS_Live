...
<form name="fview_ongoing_treatmentlistsrch" id="fview_ongoing_treatmentlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_ongoing_treatmentlist" id="fview_ongoing_treatmentlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
