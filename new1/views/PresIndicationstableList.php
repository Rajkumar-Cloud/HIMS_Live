...
<form name="fpres_indicationstablelistsrch" id="fpres_indicationstablelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpres_indicationstablelist" id="fpres_indicationstablelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
