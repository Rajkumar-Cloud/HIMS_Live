...
<form name="fview_icsi_advisedlistsrch" id="fview_icsi_advisedlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_icsi_advisedlist" id="fview_icsi_advisedlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
