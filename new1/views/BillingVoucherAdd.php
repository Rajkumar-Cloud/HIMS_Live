...
// Page object
$BillingVoucherAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fbilling_voucheradd;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.billing_voucher.fields;
    fbilling_voucheradd.addFields([
        ...
        ["AdjustmentAdvance", [fields.AdjustmentAdvance.required ? ew.Validators.required(fields.AdjustmentAdvance.caption) : null], fields.AdjustmentAdvance.isInvalid],
        ["billing_vouchercol", [fields.billing_vouchercol.required ? ew.Validators.required(fields.billing_vouchercol.caption) : null], fields.billing_vouchercol.isInvalid],
        ["BillType", [fields.BillType.required ? ew.Validators.required(fields.BillType.caption) : null], fields.BillType.isInvalid],
        ["ProcedureName", [fields.ProcedureName.required ? ew.Validators.required(fields.ProcedureName.caption) : null], fields.ProcedureName.isInvalid],
        ["ProcedureAmount", [fields.ProcedureAmount.required ? ew.Validators.required(fields.ProcedureAmount.caption) : null, ew.Validators.float], fields.ProcedureAmount.isInvalid],
        ["IncludePackage", [fields.IncludePackage.required ? ew.Validators.required(fields.IncludePackage.caption) : null], fields.IncludePackage.isInvalid],
        ["CancelBill", [fields.CancelBill.required ? ew.Validators.required(fields.CancelBill.caption) : null], fields.CancelBill.isInvalid],
        ["CancelReason", [fields.CancelReason.required ? ew.Validators.required(fields.CancelReason.caption) : null], fields.CancelReason.isInvalid],
        ["CancelModeOfPayment", [fields.CancelModeOfPayment.required ? ew.Validators.required(fields.CancelModeOfPayment.caption) : null], fields.CancelModeOfPayment.isInvalid],
        ["CancelAmount", [fields.CancelAmount.required ? ew.Validators.required(fields.CancelAmount.caption) : null], fields.CancelAmount.isInvalid],
        ["CancelBankName", [fields.CancelBankName.required ? ew.Validators.required(fields.CancelBankName.caption) : null], fields.CancelBankName.isInvalid],
        ["CancelTransactionNumber", [fields.CancelTransactionNumber.required ? ew.Validators.required(fields.CancelTransactionNumber.caption) : null], fields.CancelTransactionNumber.isInvalid],
        ["LabTest", [fields.LabTest.required ? ew.Validators.required(fields.LabTest.caption) : null], fields.LabTest.isInvalid],
        ["sid", [fields.sid.required ? ew.Validators.required(fields.sid.caption) : null, ew.Validators.integer], fields.sid.isInvalid],
        ["SidNo", [fields.SidNo.required ? ew.Validators.required(fields.SidNo.caption) : null], fields.SidNo.isInvalid],
        ["createdDatettime", [fields.createdDatettime.required ? ew.Validators.required(fields.createdDatettime.caption) : null, ew.Validators.datetime(0)], fields.createdDatettime.isInvalid],
        ["LabTestReleased", [fields.LabTestReleased.required ? ew.Validators.required(fields.LabTestReleased.caption) : null], fields.LabTestReleased.isInvalid],
        ["GoogleReviewID", [fields.GoogleReviewID.required ? ew.Validators.required(fields.GoogleReviewID.caption) : null], fields.GoogleReviewID.isInvalid],
        ["CardType", [fields.CardType.required ? ew.Validators.required(fields.CardType.caption) : null], fields.CardType.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fbilling_voucheradd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fbilling_voucheradd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbilling_voucheradd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fbilling_voucheradd" id="fbilling_voucheradd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->Reception->Visible) { // Reception ?>
    <div id="r_Reception" class="form-group row">
        <label id="elh_billing_voucher_Reception" for="x_Reception" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Reception->caption() ?><?= $Page->Reception->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Reception->cellAttributes() ?>>
<span id="el_billing_voucher_Reception">
<input type="<?= $Page->Reception->getInputTextType() ?>" data-table="billing_voucher" data-field="x_Reception" name="x_Reception" id="x_Reception" size="30" placeholder="<?= HtmlEncode($Page->Reception->getPlaceHolder()) ?>" value="<?= $Page->Reception->EditValue ?>"<?= $Page->Reception->editAttributes() ?> aria-describedby="x_Reception_help">
...
<?php if ($Page->PatientId->Visible) { // PatientId ?>
    <div id="r_PatientId" class="form-group row">
        <label id="elh_billing_voucher_PatientId" for="x_PatientId" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PatientId->caption() ?><?= $Page->PatientId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PatientId->cellAttributes() ?>>
<span id="el_billing_voucher_PatientId">
<input type="<?= $Page->PatientId->getInputTextType() ?>" data-table="billing_voucher" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->PatientId->getPlaceHolder()) ?>" value="<?= $Page->PatientId->EditValue ?>"<?= $Page->PatientId->editAttributes() ?> aria-describedby="x_PatientId_help">
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
    <div id="r_mrnno" class="form-group row">
        <label id="elh_billing_voucher_mrnno" for="x_mrnno" class="<?= $Page->LeftColumnClass ?>"><?= $Page->mrnno->caption() ?><?= $Page->mrnno->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->PatientName->Visible) { // PatientName ?>
    <div id="r_PatientName" class="form-group row">
        <label id="elh_billing_voucher_PatientName" for="x_PatientName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PatientName->caption() ?><?= $Page->PatientName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Age->Visible) { // Age ?>
    <div id="r_Age" class="form-group row">
        <label id="elh_billing_voucher_Age" for="x_Age" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Age->caption() ?><?= $Page->Age->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Gender->Visible) { // Gender ?>
    <div id="r_Gender" class="form-group row">
        <label id="elh_billing_voucher_Gender" for="x_Gender" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Gender->caption() ?><?= $Page->Gender->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->profilePic->Visible) { // profilePic ?>
    <div id="r_profilePic" class="form-group row">
        <label id="elh_billing_voucher_profilePic" for="x_profilePic" class="<?= $Page->LeftColumnClass ?>"><?= $Page->profilePic->caption() ?><?= $Page->profilePic->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->profilePic->cellAttributes() ?>>
<span id="el_billing_voucher_profilePic">
<textarea data-table="billing_voucher" data-field="x_profilePic" name="x_profilePic" id="x_profilePic" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->profilePic->getPlaceHolder()) ?>"<?= $Page->profilePic->editAttributes() ?> aria-describedby="x_profilePic_help"><?= $Page->profilePic->EditValue ?></textarea>
...
<?php if ($Page->Mobile->Visible) { // Mobile ?>
    <div id="r_Mobile" class="form-group row">
        <label id="elh_billing_voucher_Mobile" for="x_Mobile" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Mobile->caption() ?><?= $Page->Mobile->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
    <div id="r_IP_OP" class="form-group row">
        <label id="elh_billing_voucher_IP_OP" for="x_IP_OP" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IP_OP->caption() ?><?= $Page->IP_OP->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Doctor->Visible) { // Doctor ?>
    <div id="r_Doctor" class="form-group row">
        <label id="elh_billing_voucher_Doctor" for="x_Doctor" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Doctor->caption() ?><?= $Page->Doctor->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Doctor->cellAttributes() ?>>
<span id="el_billing_voucher_Doctor">
<input type="<?= $Page->Doctor->getInputTextType() ?>" data-table="billing_voucher" data-field="x_Doctor" name="x_Doctor" id="x_Doctor" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Doctor->getPlaceHolder()) ?>" value="<?= $Page->Doctor->EditValue ?>"<?= $Page->Doctor->editAttributes() ?> aria-describedby="x_Doctor_help">
...
<?php if ($Page->Details->Visible) { // Details ?>
    <div id="r_Details" class="form-group row">
        <label id="elh_billing_voucher_Details" for="x_Details" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Details->caption() ?><?= $Page->Details->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Amount->Visible) { // Amount ?>
    <div id="r_Amount" class="form-group row">
        <label id="elh_billing_voucher_Amount" for="x_Amount" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Amount->caption() ?><?= $Page->Amount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
    <div id="r_AnyDues" class="form-group row">
        <label id="elh_billing_voucher_AnyDues" for="x_AnyDues" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AnyDues->caption() ?><?= $Page->AnyDues->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
    <div id="r_createdby" class="form-group row">
        <label id="elh_billing_voucher_createdby" for="x_createdby" class="<?= $Page->LeftColumnClass ?>"><?= $Page->createdby->caption() ?><?= $Page->createdby->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->createdby->cellAttributes() ?>>
<span id="el_billing_voucher_createdby">
<input type="<?= $Page->createdby->getInputTextType() ?>" data-table="billing_voucher" data-field="x_createdby" name="x_createdby" id="x_createdby" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->createdby->getPlaceHolder()) ?>" value="<?= $Page->createdby->EditValue ?>"<?= $Page->createdby->editAttributes() ?> aria-describedby="x_createdby_help">
...
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
    <div id="r_createddatetime" class="form-group row">
        <label id="elh_billing_voucher_createddatetime" for="x_createddatetime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->createddatetime->caption() ?><?= $Page->createddatetime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->createddatetime->cellAttributes() ?>>
<span id="el_billing_voucher_createddatetime">
<input type="<?= $Page->createddatetime->getInputTextType() ?>" data-table="billing_voucher" data-field="x_createddatetime" name="x_createddatetime" id="x_createddatetime" placeholder="<?= HtmlEncode($Page->createddatetime->getPlaceHolder()) ?>" value="<?= $Page->createddatetime->EditValue ?>"<?= $Page->createddatetime->editAttributes() ?> aria-describedby="x_createddatetime_help">
...
<script>
loadjs.ready(["fbilling_voucheradd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_voucheradd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
    <div id="r_modifiedby" class="form-group row">
        <label id="elh_billing_voucher_modifiedby" for="x_modifiedby" class="<?= $Page->LeftColumnClass ?>"><?= $Page->modifiedby->caption() ?><?= $Page->modifiedby->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->modifiedby->cellAttributes() ?>>
<span id="el_billing_voucher_modifiedby">
<input type="<?= $Page->modifiedby->getInputTextType() ?>" data-table="billing_voucher" data-field="x_modifiedby" name="x_modifiedby" id="x_modifiedby" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->modifiedby->getPlaceHolder()) ?>" value="<?= $Page->modifiedby->EditValue ?>"<?= $Page->modifiedby->editAttributes() ?> aria-describedby="x_modifiedby_help">
...
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
    <div id="r_modifieddatetime" class="form-group row">
        <label id="elh_billing_voucher_modifieddatetime" for="x_modifieddatetime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->modifieddatetime->caption() ?><?= $Page->modifieddatetime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->modifieddatetime->cellAttributes() ?>>
<span id="el_billing_voucher_modifieddatetime">
<input type="<?= $Page->modifieddatetime->getInputTextType() ?>" data-table="billing_voucher" data-field="x_modifieddatetime" name="x_modifieddatetime" id="x_modifieddatetime" placeholder="<?= HtmlEncode($Page->modifieddatetime->getPlaceHolder()) ?>" value="<?= $Page->modifieddatetime->EditValue ?>"<?= $Page->modifieddatetime->editAttributes() ?> aria-describedby="x_modifieddatetime_help">
...
<script>
loadjs.ready(["fbilling_voucheradd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_voucheradd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
    <div id="r_RealizationAmount" class="form-group row">
        <label id="elh_billing_voucher_RealizationAmount" for="x_RealizationAmount" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RealizationAmount->caption() ?><?= $Page->RealizationAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
    <div id="r_RealizationStatus" class="form-group row">
        <label id="elh_billing_voucher_RealizationStatus" for="x_RealizationStatus" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RealizationStatus->caption() ?><?= $Page->RealizationStatus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
    <div id="r_RealizationRemarks" class="form-group row">
        <label id="elh_billing_voucher_RealizationRemarks" for="x_RealizationRemarks" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RealizationRemarks->caption() ?><?= $Page->RealizationRemarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
    <div id="r_RealizationBatchNo" class="form-group row">
        <label id="elh_billing_voucher_RealizationBatchNo" for="x_RealizationBatchNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RealizationBatchNo->caption() ?><?= $Page->RealizationBatchNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
    <div id="r_RealizationDate" class="form-group row">
        <label id="elh_billing_voucher_RealizationDate" for="x_RealizationDate" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RealizationDate->caption() ?><?= $Page->RealizationDate->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->HospID->Visible) { // HospID ?>
    <div id="r_HospID" class="form-group row">
        <label id="elh_billing_voucher_HospID" for="x_HospID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->HospID->caption() ?><?= $Page->HospID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->HospID->cellAttributes() ?>>
<span id="el_billing_voucher_HospID">
<input type="<?= $Page->HospID->getInputTextType() ?>" data-table="billing_voucher" data-field="x_HospID" name="x_HospID" id="x_HospID" size="30" placeholder="<?= HtmlEncode($Page->HospID->getPlaceHolder()) ?>" value="<?= $Page->HospID->EditValue ?>"<?= $Page->HospID->editAttributes() ?> aria-describedby="x_HospID_help">
...
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
    <div id="r_RIDNO" class="form-group row">
        <label id="elh_billing_voucher_RIDNO" for="x_RIDNO" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RIDNO->caption() ?><?= $Page->RIDNO->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->TidNo->Visible) { // TidNo ?>
    <div id="r_TidNo" class="form-group row">
        <label id="elh_billing_voucher_TidNo" for="x_TidNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TidNo->caption() ?><?= $Page->TidNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CId->Visible) { // CId ?>
    <div id="r_CId" class="form-group row">
        <label id="elh_billing_voucher_CId" for="x_CId" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CId->caption() ?><?= $Page->CId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
    <div id="r_PartnerName" class="form-group row">
        <label id="elh_billing_voucher_PartnerName" for="x_PartnerName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PartnerName->caption() ?><?= $Page->PartnerName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->PayerType->Visible) { // PayerType ?>
    <div id="r_PayerType" class="form-group row">
        <label id="elh_billing_voucher_PayerType" for="x_PayerType" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PayerType->caption() ?><?= $Page->PayerType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Dob->Visible) { // Dob ?>
    <div id="r_Dob" class="form-group row">
        <label id="elh_billing_voucher_Dob" for="x_Dob" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Dob->caption() ?><?= $Page->Dob->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Currency->Visible) { // Currency ?>
    <div id="r_Currency" class="form-group row">
        <label id="elh_billing_voucher_Currency" for="x_Currency" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Currency->caption() ?><?= $Page->Currency->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
    <div id="r_DiscountRemarks" class="form-group row">
        <label id="elh_billing_voucher_DiscountRemarks" for="x_DiscountRemarks" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DiscountRemarks->caption() ?><?= $Page->DiscountRemarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->Remarks->Visible) { // Remarks ?>
    <div id="r_Remarks" class="form-group row">
        <label id="elh_billing_voucher_Remarks" for="x_Remarks" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Remarks->caption() ?><?= $Page->Remarks->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Remarks->cellAttributes() ?>>
<span id="el_billing_voucher_Remarks">
<textarea data-table="billing_voucher" data-field="x_Remarks" name="x_Remarks" id="x_Remarks" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->Remarks->getPlaceHolder()) ?>"<?= $Page->Remarks->editAttributes() ?> aria-describedby="x_Remarks_help"><?= $Page->Remarks->EditValue ?></textarea>
...
<?php if ($Page->PatId->Visible) { // PatId ?>
    <div id="r_PatId" class="form-group row">
        <label id="elh_billing_voucher_PatId" for="x_PatId" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PatId->caption() ?><?= $Page->PatId->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
    <div id="r_DrDepartment" class="form-group row">
        <label id="elh_billing_voucher_DrDepartment" for="x_DrDepartment" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DrDepartment->caption() ?><?= $Page->DrDepartment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
    <div id="r_RefferedBy" class="form-group row">
        <label id="elh_billing_voucher_RefferedBy" for="x_RefferedBy" class="<?= $Page->LeftColumnClass ?>"><?= $Page->RefferedBy->caption() ?><?= $Page->RefferedBy->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->BillNumber->Visible) { // BillNumber ?>
    <div id="r_BillNumber" class="form-group row">
        <label id="elh_billing_voucher_BillNumber" for="x_BillNumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BillNumber->caption() ?><?= $Page->BillNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
    <div id="r_CardNumber" class="form-group row">
        <label id="elh_billing_voucher_CardNumber" for="x_CardNumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CardNumber->caption() ?><?= $Page->CardNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->BankName->Visible) { // BankName ?>
    <div id="r_BankName" class="form-group row">
        <label id="elh_billing_voucher_BankName" for="x_BankName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BankName->caption() ?><?= $Page->BankName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
    <div id="r_DrID" class="form-group row">
        <label id="elh_billing_voucher_DrID" for="x_DrID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->DrID->caption() ?><?= $Page->DrID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
    <div id="r_BillStatus" class="form-group row">
        <label id="elh_billing_voucher_BillStatus" for="x_BillStatus" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BillStatus->caption() ?><?= $Page->BillStatus->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
    <div id="r_ReportHeader" class="form-group row">
        <label id="elh_billing_voucher_ReportHeader" for="x_ReportHeader" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ReportHeader->caption() ?><?= $Page->ReportHeader->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->_UserName->Visible) { // UserName ?>
    <div id="r__UserName" class="form-group row">
        <label id="elh_billing_voucher__UserName" for="x__UserName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_UserName->caption() ?><?= $Page->_UserName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->_UserName->cellAttributes() ?>>
<span id="el_billing_voucher__UserName">
<input type="<?= $Page->_UserName->getInputTextType() ?>" data-table="billing_voucher" data-field="x__UserName" name="x__UserName" id="x__UserName" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->_UserName->getPlaceHolder()) ?>" value="<?= $Page->_UserName->EditValue ?>"<?= $Page->_UserName->editAttributes() ?> aria-describedby="x__UserName_help">
...
<?php if ($Page->AdjustmentAdvance->Visible) { // AdjustmentAdvance ?>
    <div id="r_AdjustmentAdvance" class="form-group row">
        <label id="elh_billing_voucher_AdjustmentAdvance" for="x_AdjustmentAdvance" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AdjustmentAdvance->caption() ?><?= $Page->AdjustmentAdvance->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->billing_vouchercol->Visible) { // billing_vouchercol ?>
    <div id="r_billing_vouchercol" class="form-group row">
        <label id="elh_billing_voucher_billing_vouchercol" for="x_billing_vouchercol" class="<?= $Page->LeftColumnClass ?>"><?= $Page->billing_vouchercol->caption() ?><?= $Page->billing_vouchercol->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->BillType->Visible) { // BillType ?>
    <div id="r_BillType" class="form-group row">
        <label id="elh_billing_voucher_BillType" for="x_BillType" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BillType->caption() ?><?= $Page->BillType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->ProcedureName->Visible) { // ProcedureName ?>
    <div id="r_ProcedureName" class="form-group row">
        <label id="elh_billing_voucher_ProcedureName" for="x_ProcedureName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ProcedureName->caption() ?><?= $Page->ProcedureName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->ProcedureAmount->Visible) { // ProcedureAmount ?>
    <div id="r_ProcedureAmount" class="form-group row">
        <label id="elh_billing_voucher_ProcedureAmount" for="x_ProcedureAmount" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ProcedureAmount->caption() ?><?= $Page->ProcedureAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->IncludePackage->Visible) { // IncludePackage ?>
    <div id="r_IncludePackage" class="form-group row">
        <label id="elh_billing_voucher_IncludePackage" for="x_IncludePackage" class="<?= $Page->LeftColumnClass ?>"><?= $Page->IncludePackage->caption() ?><?= $Page->IncludePackage->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CancelBill->Visible) { // CancelBill ?>
    <div id="r_CancelBill" class="form-group row">
        <label id="elh_billing_voucher_CancelBill" for="x_CancelBill" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CancelBill->caption() ?><?= $Page->CancelBill->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CancelReason->Visible) { // CancelReason ?>
    <div id="r_CancelReason" class="form-group row">
        <label id="elh_billing_voucher_CancelReason" for="x_CancelReason" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CancelReason->caption() ?><?= $Page->CancelReason->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CancelReason->cellAttributes() ?>>
<span id="el_billing_voucher_CancelReason">
<textarea data-table="billing_voucher" data-field="x_CancelReason" name="x_CancelReason" id="x_CancelReason" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->CancelReason->getPlaceHolder()) ?>"<?= $Page->CancelReason->editAttributes() ?> aria-describedby="x_CancelReason_help"><?= $Page->CancelReason->EditValue ?></textarea>
...
<?php if ($Page->CancelModeOfPayment->Visible) { // CancelModeOfPayment ?>
    <div id="r_CancelModeOfPayment" class="form-group row">
        <label id="elh_billing_voucher_CancelModeOfPayment" for="x_CancelModeOfPayment" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CancelModeOfPayment->caption() ?><?= $Page->CancelModeOfPayment->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CancelAmount->Visible) { // CancelAmount ?>
    <div id="r_CancelAmount" class="form-group row">
        <label id="elh_billing_voucher_CancelAmount" for="x_CancelAmount" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CancelAmount->caption() ?><?= $Page->CancelAmount->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CancelBankName->Visible) { // CancelBankName ?>
    <div id="r_CancelBankName" class="form-group row">
        <label id="elh_billing_voucher_CancelBankName" for="x_CancelBankName" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CancelBankName->caption() ?><?= $Page->CancelBankName->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CancelTransactionNumber->Visible) { // CancelTransactionNumber ?>
    <div id="r_CancelTransactionNumber" class="form-group row">
        <label id="elh_billing_voucher_CancelTransactionNumber" for="x_CancelTransactionNumber" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CancelTransactionNumber->caption() ?><?= $Page->CancelTransactionNumber->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->LabTest->Visible) { // LabTest ?>
    <div id="r_LabTest" class="form-group row">
        <label id="elh_billing_voucher_LabTest" for="x_LabTest" class="<?= $Page->LeftColumnClass ?>"><?= $Page->LabTest->caption() ?><?= $Page->LabTest->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->sid->Visible) { // sid ?>
    <div id="r_sid" class="form-group row">
        <label id="elh_billing_voucher_sid" for="x_sid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sid->caption() ?><?= $Page->sid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->SidNo->Visible) { // SidNo ?>
    <div id="r_SidNo" class="form-group row">
        <label id="elh_billing_voucher_SidNo" for="x_SidNo" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SidNo->caption() ?><?= $Page->SidNo->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->createdDatettime->Visible) { // createdDatettime ?>
    <div id="r_createdDatettime" class="form-group row">
        <label id="elh_billing_voucher_createdDatettime" for="x_createdDatettime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->createdDatettime->caption() ?><?= $Page->createdDatettime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->createdDatettime->cellAttributes() ?>>
<span id="el_billing_voucher_createdDatettime">
<input type="<?= $Page->createdDatettime->getInputTextType() ?>" data-table="billing_voucher" data-field="x_createdDatettime" name="x_createdDatettime" id="x_createdDatettime" placeholder="<?= HtmlEncode($Page->createdDatettime->getPlaceHolder()) ?>" value="<?= $Page->createdDatettime->EditValue ?>"<?= $Page->createdDatettime->editAttributes() ?> aria-describedby="x_createdDatettime_help">
<?= $Page->createdDatettime->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->createdDatettime->getErrorMessage() ?></div>
...
<script>
loadjs.ready(["fbilling_voucheradd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_voucheradd", "x_createdDatettime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->LabTestReleased->Visible) { // LabTestReleased ?>
    <div id="r_LabTestReleased" class="form-group row">
        <label id="elh_billing_voucher_LabTestReleased" for="x_LabTestReleased" class="<?= $Page->LeftColumnClass ?>"><?= $Page->LabTestReleased->caption() ?><?= $Page->LabTestReleased->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->GoogleReviewID->Visible) { // GoogleReviewID ?>
    <div id="r_GoogleReviewID" class="form-group row">
        <label id="elh_billing_voucher_GoogleReviewID" for="x_GoogleReviewID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->GoogleReviewID->caption() ?><?= $Page->GoogleReviewID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->CardType->Visible) { // CardType ?>
    <div id="r_CardType" class="form-group row">
        <label id="elh_billing_voucher_CardType" for="x_CardType" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CardType->caption() ?><?= $Page->CardType->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
