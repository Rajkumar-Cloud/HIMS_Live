...
$Page->showMessage();
?>
<form name="fpatientadd" id="fpatientadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
loadjs.ready(["fpatientadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatientadd", "x_dob", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatientadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatientadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatientadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatientadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatientadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatientadd", "x_spouse_dob", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
