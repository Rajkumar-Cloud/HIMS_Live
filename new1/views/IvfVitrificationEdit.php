...
// Page object
$IvfVitrificationEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fivf_vitrificationedit;
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.ivf_vitrification.fields;
    fivf_vitrificationedit.addFields([
        ...
        ["FertilisationDate", [fields.FertilisationDate.required ? ew.Validators.required(fields.FertilisationDate.caption) : null, ew.Validators.datetime(0)], fields.FertilisationDate.isInvalid],
        ["Day", [fields.Day.required ? ew.Validators.required(fields.Day.caption) : null], fields.Day.isInvalid],
        ["Grade", [fields.Grade.required ? ew.Validators.required(fields.Grade.caption) : null], fields.Grade.isInvalid],
        ...
        ["Gobiet", [fields.Gobiet.required ? ew.Validators.required(fields.Gobiet.caption) : null], fields.Gobiet.isInvalid],
        ["CryolockNo", [fields.CryolockNo.required ? ew.Validators.required(fields.CryolockNo.caption) : null], fields.CryolockNo.isInvalid],
        ["CryolockColour", [fields.CryolockColour.required ? ew.Validators.required(fields.CryolockColour.caption) : null], fields.CryolockColour.isInvalid],
        ...
        ["Catheter", [fields.Catheter.required ? ew.Validators.required(fields.Catheter.caption) : null], fields.Catheter.isInvalid],
        ["Difficulty", [fields.Difficulty.required ? ew.Validators.required(fields.Difficulty.caption) : null], fields.Difficulty.isInvalid],
        ["Easy", [fields.Easy.required ? ew.Validators.required(fields.Easy.caption) : null], fields.Easy.isInvalid],
        ...
        ["Embryologist", [fields.Embryologist.required ? ew.Validators.required(fields.Embryologist.caption) : null], fields.Embryologist.isInvalid]
    ]);

    // Set invalid fields
    $(function() {
        var f = fivf_vitrificationedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fivf_vitrificationedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fivf_vitrificationedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fivf_vitrificationedit" id="fivf_vitrificationedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_ivf_vitrification_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id->cellAttributes() ?>>
<span id="el_ivf_vitrification_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="ivf_vitrification" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="<?= $Page->Day->getInputTextType() ?>" data-table="ivf_vitrification" data-field="x_Day" name="x_Day" id="x_Day" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Day->getPlaceHolder()) ?>" value="<?= $Page->Day->EditValue ?>"<?= $Page->Day->editAttributes() ?> aria-describedby="x_Day_help">
...
<input type="<?= $Page->Grade->getInputTextType() ?>" data-table="ivf_vitrification" data-field="x_Grade" name="x_Grade" id="x_Grade" size="30" maxlength="45" placeholder="<?= HtmlEncode($Page->Grade->getPlaceHolder()) ?>" value="<?= $Page->Grade->EditValue ?>"<?= $Page->Grade->editAttributes() ?> aria-describedby="x_Grade_help">
