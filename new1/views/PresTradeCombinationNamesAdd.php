...
// Page object
$PresTradeCombinationNamesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpres_trade_combination_namesadd;
loadjs.ready("head", function () {
    ...
    fpres_trade_combination_namesadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpres_trade_combination_namesadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Form_CustomValidate
    fpres_trade_combination_namesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpres_trade_combination_namesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fpres_trade_combination_namesadd" id="fpres_trade_combination_namesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
