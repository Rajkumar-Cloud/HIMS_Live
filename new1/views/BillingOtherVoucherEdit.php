...
$Page->showMessage();
?>
<form name="fbilling_other_voucheredit" id="fbilling_other_voucheredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id" class="form-group row">
        <label id="elh_billing_other_voucher_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
loadjs.ready(["fbilling_other_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_other_voucheredit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_other_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_other_voucheredit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_other_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_other_voucheredit", "x_VisitDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_other_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_other_voucheredit", "x_Date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fbilling_other_voucheredit", "datetimepicker"], function() {
    ew.createDateTimePicker("fbilling_other_voucheredit", "x_CancelDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
