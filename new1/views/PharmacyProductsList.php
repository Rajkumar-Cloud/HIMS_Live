...
<form name="fpharmacy_productslistsrch" id="fpharmacy_productslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fpharmacy_productslist" id="fpharmacy_productslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
