...
<form name="fview_billing_voucher_printlistsrch" id="fview_billing_voucher_printlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_billing_voucher_printlist" id="fview_billing_voucher_printlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
        <th data-name="id" class="<?= $Page->id->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_id" class="view_billing_voucher_print_id"><?= $Page->renderSort($Page->id) ?></div></th>
<?php } ?>
<?php if ($Page->Reception->Visible) { // Reception ?>
        <th data-name="Reception" class="<?= $Page->Reception->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_Reception" class="view_billing_voucher_print_Reception"><?= $Page->renderSort($Page->Reception) ?></div></th>
<?php } ?>
...
<?php if ($Page->mrnno->Visible) { // mrnno ?>
        <th data-name="mrnno" class="<?= $Page->mrnno->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_mrnno" class="view_billing_voucher_print_mrnno"><?= $Page->renderSort($Page->mrnno) ?></div></th>
<?php } ?>
...
<?php if ($Page->Age->Visible) { // Age ?>
        <th data-name="Age" class="<?= $Page->Age->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_Age" class="view_billing_voucher_print_Age"><?= $Page->renderSort($Page->Age) ?></div></th>
<?php } ?>
<?php if ($Page->Gender->Visible) { // Gender ?>
        <th data-name="Gender" class="<?= $Page->Gender->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_Gender" class="view_billing_voucher_print_Gender"><?= $Page->renderSort($Page->Gender) ?></div></th>
<?php } ?>
...
<?php if ($Page->IP_OP->Visible) { // IP_OP ?>
        <th data-name="IP_OP" class="<?= $Page->IP_OP->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_IP_OP" class="view_billing_voucher_print_IP_OP"><?= $Page->renderSort($Page->IP_OP) ?></div></th>
<?php } ?>
...
<?php if ($Page->voucher_type->Visible) { // voucher_type ?>
        <th data-name="voucher_type" class="<?= $Page->voucher_type->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_voucher_type" class="view_billing_voucher_print_voucher_type"><?= $Page->renderSort($Page->voucher_type) ?></div></th>
<?php } ?>
<?php if ($Page->Details->Visible) { // Details ?>
        <th data-name="Details" class="<?= $Page->Details->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_Details" class="view_billing_voucher_print_Details"><?= $Page->renderSort($Page->Details) ?></div></th>
<?php } ?>
...
<?php if ($Page->AnyDues->Visible) { // AnyDues ?>
        <th data-name="AnyDues" class="<?= $Page->AnyDues->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_AnyDues" class="view_billing_voucher_print_AnyDues"><?= $Page->renderSort($Page->AnyDues) ?></div></th>
<?php } ?>
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_createdby" class="view_billing_voucher_print_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
...
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_modifiedby" class="view_billing_voucher_print_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_modifieddatetime" class="view_billing_voucher_print_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationAmount->Visible) { // RealizationAmount ?>
        <th data-name="RealizationAmount" class="<?= $Page->RealizationAmount->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RealizationAmount" class="view_billing_voucher_print_RealizationAmount"><?= $Page->renderSort($Page->RealizationAmount) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationStatus->Visible) { // RealizationStatus ?>
        <th data-name="RealizationStatus" class="<?= $Page->RealizationStatus->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RealizationStatus" class="view_billing_voucher_print_RealizationStatus"><?= $Page->renderSort($Page->RealizationStatus) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationRemarks->Visible) { // RealizationRemarks ?>
        <th data-name="RealizationRemarks" class="<?= $Page->RealizationRemarks->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RealizationRemarks" class="view_billing_voucher_print_RealizationRemarks"><?= $Page->renderSort($Page->RealizationRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
        <th data-name="RealizationBatchNo" class="<?= $Page->RealizationBatchNo->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RealizationBatchNo" class="view_billing_voucher_print_RealizationBatchNo"><?= $Page->renderSort($Page->RealizationBatchNo) ?></div></th>
<?php } ?>
<?php if ($Page->RealizationDate->Visible) { // RealizationDate ?>
        <th data-name="RealizationDate" class="<?= $Page->RealizationDate->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RealizationDate" class="view_billing_voucher_print_RealizationDate"><?= $Page->renderSort($Page->RealizationDate) ?></div></th>
<?php } ?>
<?php if ($Page->HospID->Visible) { // HospID ?>
        <th data-name="HospID" class="<?= $Page->HospID->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_HospID" class="view_billing_voucher_print_HospID"><?= $Page->renderSort($Page->HospID) ?></div></th>
<?php } ?>
<?php if ($Page->RIDNO->Visible) { // RIDNO ?>
        <th data-name="RIDNO" class="<?= $Page->RIDNO->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RIDNO" class="view_billing_voucher_print_RIDNO"><?= $Page->renderSort($Page->RIDNO) ?></div></th>
<?php } ?>
<?php if ($Page->TidNo->Visible) { // TidNo ?>
        <th data-name="TidNo" class="<?= $Page->TidNo->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_TidNo" class="view_billing_voucher_print_TidNo"><?= $Page->renderSort($Page->TidNo) ?></div></th>
<?php } ?>
<?php if ($Page->CId->Visible) { // CId ?>
        <th data-name="CId" class="<?= $Page->CId->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_CId" class="view_billing_voucher_print_CId"><?= $Page->renderSort($Page->CId) ?></div></th>
<?php } ?>
<?php if ($Page->PartnerName->Visible) { // PartnerName ?>
        <th data-name="PartnerName" class="<?= $Page->PartnerName->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_PartnerName" class="view_billing_voucher_print_PartnerName"><?= $Page->renderSort($Page->PartnerName) ?></div></th>
<?php } ?>
<?php if ($Page->PayerType->Visible) { // PayerType ?>
        <th data-name="PayerType" class="<?= $Page->PayerType->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_PayerType" class="view_billing_voucher_print_PayerType"><?= $Page->renderSort($Page->PayerType) ?></div></th>
<?php } ?>
<?php if ($Page->Dob->Visible) { // Dob ?>
        <th data-name="Dob" class="<?= $Page->Dob->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_Dob" class="view_billing_voucher_print_Dob"><?= $Page->renderSort($Page->Dob) ?></div></th>
<?php } ?>
<?php if ($Page->Currency->Visible) { // Currency ?>
        <th data-name="Currency" class="<?= $Page->Currency->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_Currency" class="view_billing_voucher_print_Currency"><?= $Page->renderSort($Page->Currency) ?></div></th>
<?php } ?>
<?php if ($Page->DiscountRemarks->Visible) { // DiscountRemarks ?>
        <th data-name="DiscountRemarks" class="<?= $Page->DiscountRemarks->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_DiscountRemarks" class="view_billing_voucher_print_DiscountRemarks"><?= $Page->renderSort($Page->DiscountRemarks) ?></div></th>
<?php } ?>
<?php if ($Page->PatId->Visible) { // PatId ?>
        <th data-name="PatId" class="<?= $Page->PatId->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_PatId" class="view_billing_voucher_print_PatId"><?= $Page->renderSort($Page->PatId) ?></div></th>
<?php } ?>
<?php if ($Page->DrDepartment->Visible) { // DrDepartment ?>
        <th data-name="DrDepartment" class="<?= $Page->DrDepartment->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_DrDepartment" class="view_billing_voucher_print_DrDepartment"><?= $Page->renderSort($Page->DrDepartment) ?></div></th>
<?php } ?>
<?php if ($Page->RefferedBy->Visible) { // RefferedBy ?>
        <th data-name="RefferedBy" class="<?= $Page->RefferedBy->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_RefferedBy" class="view_billing_voucher_print_RefferedBy"><?= $Page->renderSort($Page->RefferedBy) ?></div></th>
<?php } ?>
...
<?php if ($Page->CardNumber->Visible) { // CardNumber ?>
        <th data-name="CardNumber" class="<?= $Page->CardNumber->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_CardNumber" class="view_billing_voucher_print_CardNumber"><?= $Page->renderSort($Page->CardNumber) ?></div></th>
<?php } ?>
...
<?php if ($Page->DrID->Visible) { // DrID ?>
        <th data-name="DrID" class="<?= $Page->DrID->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_DrID" class="view_billing_voucher_print_DrID"><?= $Page->renderSort($Page->DrID) ?></div></th>
<?php } ?>
<?php if ($Page->BillStatus->Visible) { // BillStatus ?>
        <th data-name="BillStatus" class="<?= $Page->BillStatus->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_BillStatus" class="view_billing_voucher_print_BillStatus"><?= $Page->renderSort($Page->BillStatus) ?></div></th>
<?php } ?>
<?php if ($Page->ReportHeader->Visible) { // ReportHeader ?>
        <th data-name="ReportHeader" class="<?= $Page->ReportHeader->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_ReportHeader" class="view_billing_voucher_print_ReportHeader"><?= $Page->renderSort($Page->ReportHeader) ?></div></th>
<?php } ?>
...
<?php if ($Page->AdjustmentAdvance->Visible) { // AdjustmentAdvance ?>
        <th data-name="AdjustmentAdvance" class="<?= $Page->AdjustmentAdvance->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_AdjustmentAdvance" class="view_billing_voucher_print_AdjustmentAdvance"><?= $Page->renderSort($Page->AdjustmentAdvance) ?></div></th>
<?php } ?>
<?php if ($Page->billing_vouchercol->Visible) { // billing_vouchercol ?>
        <th data-name="billing_vouchercol" class="<?= $Page->billing_vouchercol->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_billing_vouchercol" class="view_billing_voucher_print_billing_vouchercol"><?= $Page->renderSort($Page->billing_vouchercol) ?></div></th>
<?php } ?>
...
<?php if ($Page->ProcedureName->Visible) { // ProcedureName ?>
        <th data-name="ProcedureName" class="<?= $Page->ProcedureName->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_ProcedureName" class="view_billing_voucher_print_ProcedureName"><?= $Page->renderSort($Page->ProcedureName) ?></div></th>
<?php } ?>
<?php if ($Page->ProcedureAmount->Visible) { // ProcedureAmount ?>
        <th data-name="ProcedureAmount" class="<?= $Page->ProcedureAmount->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_ProcedureAmount" class="view_billing_voucher_print_ProcedureAmount"><?= $Page->renderSort($Page->ProcedureAmount) ?></div></th>
<?php } ?>
<?php if ($Page->IncludePackage->Visible) { // IncludePackage ?>
        <th data-name="IncludePackage" class="<?= $Page->IncludePackage->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_IncludePackage" class="view_billing_voucher_print_IncludePackage"><?= $Page->renderSort($Page->IncludePackage) ?></div></th>
<?php } ?>
<?php if ($Page->CancelBill->Visible) { // CancelBill ?>
        <th data-name="CancelBill" class="<?= $Page->CancelBill->headerCellClass() ?>"><div id="elh_view_billing_voucher_print_CancelBill" class="view_billing_voucher_print_CancelBill"><?= $Page->renderSort($Page->CancelBill) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_id">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_Reception">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_mrnno">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_Age">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_Gender">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_IP_OP">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_voucher_type">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_Details">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_AnyDues">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_createdby">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RealizationAmount">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RealizationStatus">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RealizationRemarks">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RealizationBatchNo">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RealizationDate">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_HospID">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RIDNO">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_TidNo">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_CId">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_PartnerName">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_PayerType">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_Dob">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_Currency">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_DiscountRemarks">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_PatId">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_DrDepartment">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_RefferedBy">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_CardNumber">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_DrID">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_BillStatus">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_ReportHeader">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_AdjustmentAdvance">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_billing_vouchercol">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_ProcedureName">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_ProcedureAmount">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_IncludePackage">
...
<span id="el<?= $Page->RowCount ?>_view_billing_voucher_print_CancelBill">
