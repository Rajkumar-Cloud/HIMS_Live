...
<form name="fview_ip_admission_prescriptionlistsrch" id="fview_ip_admission_prescriptionlistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_ip_admission_prescriptionlist" id="fview_ip_admission_prescriptionlist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<table id="tbl_view_ip_admission_prescriptionlist" class="table ew-table"><!-- .ew-table -->
<thead>
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_id">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_mrnNo">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_patient_id">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_patient_name">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_gender">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_age">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_physician_id">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_typeRegsisteration">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_PaymentCategory">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_admission_consultant_id">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_leading_consultant_id">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_admission_date">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_release_date">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_PaymentStatus">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_status">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_createdby">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_modifieddatetime">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_PatientID">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_HospID">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ReferedByDr">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ReferClinicname">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ReferCity">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ReferMobileNo">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ReferA4TreatingConsultant">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_PurposreReferredfor">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_mobileno">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_BillClosing">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_BillClosingDate">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_BillNumber">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ClosingAmount">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ClosingType">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_BillAmount">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_billclosedBy">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_bllcloseByDate">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_ReportHeader">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_Procedure">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_Consultant">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_Anesthetist">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_Amound">
...
<span id="el<?= $Page->RowCount ?>_view_ip_admission_prescription_Package">
