...
loadjs.ready("head", function () {
    ...
    // Add fields
    var fields = ew.vars.tables.appointment_block_slot.fields;
    fappointment_block_slotedit.addFields([
        ...
        ["BlockType", [fields.BlockType.required ? ew.Validators.required(fields.BlockType.caption) : null], fields.BlockType.isInvalid],
        ["FromDate", [fields.FromDate.required ? ew.Validators.required(fields.FromDate.caption) : null, ew.Validators.datetime(0)], fields.FromDate.isInvalid],
        ["ToDate", [fields.ToDate.required ? ew.Validators.required(fields.ToDate.caption) : null, ew.Validators.datetime(0)], fields.ToDate.isInvalid],
        ["FromTime", [fields.FromTime.required ? ew.Validators.required(fields.FromTime.caption) : null, ew.Validators.datetime(0)], fields.FromTime.isInvalid],
        ["ToTime", [fields.ToTime.required ? ew.Validators.required(fields.ToTime.caption) : null, ew.Validators.datetime(0)], fields.ToTime.isInvalid]
    ]);
...
$Page->showMessage();
?>
<form name="fappointment_block_slotedit" id="fappointment_block_slotedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
