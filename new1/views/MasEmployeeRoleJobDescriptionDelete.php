...
$Page->showMessage();
?>
<form name="fmas_employee_role_job_descriptiondelete" id="fmas_employee_role_job_descriptiondelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
