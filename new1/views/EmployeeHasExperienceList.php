...
<form name="femployee_has_experiencelistsrch" id="femployee_has_experiencelistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="femployee_has_experiencelist" id="femployee_has_experiencelist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->job_description->Visible) { // job description ?>
        <th data-name="job_description" class="<?= $Page->job_description->headerCellClass() ?>"><div id="elh_employee_has_experience_job_description" class="employee_has_experience_job_description"><?= $Page->renderSort($Page->job_description) ?></div></th>
<?php } ?>
...
<?php if ($Page->createdby->Visible) { // createdby ?>
        <th data-name="createdby" class="<?= $Page->createdby->headerCellClass() ?>"><div id="elh_employee_has_experience_createdby" class="employee_has_experience_createdby"><?= $Page->renderSort($Page->createdby) ?></div></th>
<?php } ?>
<?php if ($Page->createddatetime->Visible) { // createddatetime ?>
        <th data-name="createddatetime" class="<?= $Page->createddatetime->headerCellClass() ?>"><div id="elh_employee_has_experience_createddatetime" class="employee_has_experience_createddatetime"><?= $Page->renderSort($Page->createddatetime) ?></div></th>
<?php } ?>
<?php if ($Page->modifiedby->Visible) { // modifiedby ?>
        <th data-name="modifiedby" class="<?= $Page->modifiedby->headerCellClass() ?>"><div id="elh_employee_has_experience_modifiedby" class="employee_has_experience_modifiedby"><?= $Page->renderSort($Page->modifiedby) ?></div></th>
<?php } ?>
<?php if ($Page->modifieddatetime->Visible) { // modifieddatetime ?>
        <th data-name="modifieddatetime" class="<?= $Page->modifieddatetime->headerCellClass() ?>"><div id="elh_employee_has_experience_modifieddatetime" class="employee_has_experience_modifieddatetime"><?= $Page->renderSort($Page->modifieddatetime) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_employee_has_experience_job_description">
...
<span id="el<?= $Page->RowCount ?>_employee_has_experience_createdby">
...
<span id="el<?= $Page->RowCount ?>_employee_has_experience_createddatetime">
...
<span id="el<?= $Page->RowCount ?>_employee_has_experience_modifiedby">
...
<span id="el<?= $Page->RowCount ?>_employee_has_experience_modifieddatetime">
