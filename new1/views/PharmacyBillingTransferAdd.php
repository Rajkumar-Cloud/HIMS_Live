...
$Page->showMessage();
?>
<form name="fpharmacy_billing_transferadd" id="fpharmacy_billing_transferadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpharmacy_billing_transferadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_transferadd", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpharmacy_billing_transferadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpharmacy_billing_transferadd", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
