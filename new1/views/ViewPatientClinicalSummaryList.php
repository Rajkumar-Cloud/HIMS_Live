...
<form name="fview_patient_clinical_summarylistsrch" id="fview_patient_clinical_summarylistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fview_patient_clinical_summarylist" id="fview_patient_clinical_summarylist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
