...
$Page->showMessage();
?>
<form name="fhospital_pharmacyedit" id="fhospital_pharmacyedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fhospital_pharmacyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fhospital_pharmacyedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fhospital_pharmacyedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fhospital_pharmacyedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
