...
$Page->showMessage();
?>
<form name="fmaster_procedure_treatmentdelete" id="fmaster_procedure_treatmentdelete" class="form-inline ew-form ew-delete-form" action="<?= CurrentPageUrl() ?>" method="post">
