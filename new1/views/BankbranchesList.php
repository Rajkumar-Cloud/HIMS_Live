...
<form name="fbankbrancheslistsrch" id="fbankbrancheslistsrch" class="form-inline ew-form ew-ext-search-form" action="<?= CurrentPageUrl() ?>">
...
<form name="fbankbrancheslist" id="fbankbrancheslist" class="form-inline ew-form ew-list-form" action="<?= CurrentPageUrl() ?>" method="post">
