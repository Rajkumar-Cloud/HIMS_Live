...
$Page->showMessage();
?>
<form name="fpatient_documentedit" id="fpatient_documentedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fpatient_documentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_documentedit", "x_createddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fpatient_documentedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpatient_documentedit", "x_modifieddatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
