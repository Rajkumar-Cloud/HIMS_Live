...
loadjs.ready("head", function () {
    ...
    fpharmacy_productsedit.addFields([
        ["ProductCode", [fields.ProductCode.required ? ew.Validators.required(fields.ProductCode.caption) : null], fields.ProductCode.isInvalid],
...
$Page->showMessage();
?>
<form name="fpharmacy_productsedit" id="fpharmacy_productsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
