...
$Page->showMessage();
?>
<form name="fivf_mas_user_templateedit" id="fivf_mas_user_templateedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fivf_mas_user_templateedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_mas_user_templateedit", "x_createdDatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fivf_mas_user_templateedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fivf_mas_user_templateedit", "x_modifiedDatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
