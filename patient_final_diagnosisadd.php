...
var fpatient_final_diagnosisadd = currentForm = new ew.Form("fpatient_final_diagnosisadd", "add");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
			...
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($patient_final_diagnosis->PatientId->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_Reception");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($patient_final_diagnosis->Reception->errorMessage()) ?>");
...
fpatient_final_diagnosisadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_final_diagnosisadd.lists["x_FinalDiagnosisTemplate"] = <?php echo $patient_final_diagnosis_add->FinalDiagnosisTemplate->Lookup->toClientList() ?>;
...
fpatient_final_diagnosisadd.lists["x_TreatmentsTemplate"] = <?php echo $patient_final_diagnosis_add->TreatmentsTemplate->Lookup->toClientList() ?>;
...
fpatient_final_diagnosisadd.lists["x_PatientSearch"] = <?php echo $patient_final_diagnosis_add->PatientSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_final_diagnosis_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_final_diagnosis_add->Token ?>">
<?php } ?>
...
<?php if ($patient_final_diagnosis->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_final_diagnosis_PatID" for="x_PatID" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_PatID" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->PatID->caption() ?><?php echo ($patient_final_diagnosis->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->PatID->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_PatID" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_final_diagnosis_PatientName" for="x_PatientName" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_PatientName" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->PatientName->caption() ?><?php echo ($patient_final_diagnosis->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->PatientName->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_PatientName" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_final_diagnosis_mrnno" for="x_mrnno" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_mrnno" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->mrnno->caption() ?><?php echo ($patient_final_diagnosis->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->mrnno->cellAttributes() ?>>
<?php if ($patient_final_diagnosis->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_final_diagnosis_mrnno" class="patient_final_diagnosisadd" type="text/html">
...
<input type="hidden" id="x_mrnno" name="x_mrnno" value="<?php echo HtmlEncode($patient_final_diagnosis->mrnno->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_final_diagnosis_mrnno" class="patient_final_diagnosisadd" type="text/html">
<span id="el_patient_final_diagnosis_mrnno">
<input type="text" data-table="patient_final_diagnosis" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($patient_final_diagnosis->mrnno->getPlaceHolder()) ?>" value="<?php echo $patient_final_diagnosis->mrnno->EditValue ?>"<?php echo $patient_final_diagnosis->mrnno->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_final_diagnosis->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_final_diagnosis_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_MobileNumber" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->MobileNumber->caption() ?><?php echo ($patient_final_diagnosis->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_MobileNumber" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->FinalDiagnosis->Visible) { // FinalDiagnosis ?>
	<div id="r_FinalDiagnosis" class="form-group row">
		<label id="elh_patient_final_diagnosis_FinalDiagnosis" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_FinalDiagnosis" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->FinalDiagnosis->caption() ?><?php echo ($patient_final_diagnosis->FinalDiagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->FinalDiagnosis->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_FinalDiagnosis" class="patient_final_diagnosisadd" type="text/html">
...
ew.createEditor("fpatient_final_diagnosisadd", "x_FinalDiagnosis", 35, 25, <?php echo ($patient_final_diagnosis->FinalDiagnosis->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_final_diagnosis->Treatments->Visible) { // Treatments ?>
	<div id="r_Treatments" class="form-group row">
		<label id="elh_patient_final_diagnosis_Treatments" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_Treatments" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->Treatments->caption() ?><?php echo ($patient_final_diagnosis->Treatments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->Treatments->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_Treatments" class="patient_final_diagnosisadd" type="text/html">
...
<script type="text/html" class="patient_final_diagnosisadd_js">
ew.createEditor("fpatient_final_diagnosisadd", "x_Treatments", 35, 25, <?php echo ($patient_final_diagnosis->Treatments->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_final_diagnosis->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_final_diagnosis_Age" for="x_Age" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_Age" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->Age->caption() ?><?php echo ($patient_final_diagnosis->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->Age->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_Age" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_final_diagnosis_Gender" for="x_Gender" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_Gender" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->Gender->caption() ?><?php echo ($patient_final_diagnosis->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->Gender->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_Gender" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_final_diagnosis_profilePic" for="x_profilePic" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_profilePic" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->profilePic->caption() ?><?php echo ($patient_final_diagnosis->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->profilePic->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_profilePic" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->FinalDiagnosisTemplate->Visible) { // FinalDiagnosisTemplate ?>
	<div id="r_FinalDiagnosisTemplate" class="form-group row">
		<label id="elh_patient_final_diagnosis_FinalDiagnosisTemplate" for="x_FinalDiagnosisTemplate" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_FinalDiagnosisTemplate" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->FinalDiagnosisTemplate->caption() ?><?php echo ($patient_final_diagnosis->FinalDiagnosisTemplate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->FinalDiagnosisTemplate->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_FinalDiagnosisTemplate" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->TreatmentsTemplate->Visible) { // TreatmentsTemplate ?>
	<div id="r_TreatmentsTemplate" class="form-group row">
		<label id="elh_patient_final_diagnosis_TreatmentsTemplate" for="x_TreatmentsTemplate" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_TreatmentsTemplate" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->TreatmentsTemplate->caption() ?><?php echo ($patient_final_diagnosis->TreatmentsTemplate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->TreatmentsTemplate->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_TreatmentsTemplate" class="patient_final_diagnosisadd" type="text/html">
...
<?php if ($patient_final_diagnosis->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_final_diagnosis_PatientId" for="x_PatientId" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_PatientId" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->PatientId->caption() ?><?php echo ($patient_final_diagnosis->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->PatientId->cellAttributes() ?>>
<?php if ($patient_final_diagnosis->PatientId->getSessionValue() <> "") { ?>
<script id="tpx_patient_final_diagnosis_PatientId" class="patient_final_diagnosisadd" type="text/html">
...
<input type="hidden" id="x_PatientId" name="x_PatientId" value="<?php echo HtmlEncode($patient_final_diagnosis->PatientId->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_final_diagnosis_PatientId" class="patient_final_diagnosisadd" type="text/html">
<span id="el_patient_final_diagnosis_PatientId">
<input type="text" data-table="patient_final_diagnosis" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" size="30" placeholder="<?php echo HtmlEncode($patient_final_diagnosis->PatientId->getPlaceHolder()) ?>" value="<?php echo $patient_final_diagnosis->PatientId->EditValue ?>"<?php echo $patient_final_diagnosis->PatientId->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_final_diagnosis->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_final_diagnosis_Reception" for="x_Reception" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_Reception" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->Reception->caption() ?><?php echo ($patient_final_diagnosis->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->Reception->cellAttributes() ?>>
<?php if ($patient_final_diagnosis->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_final_diagnosis_Reception" class="patient_final_diagnosisadd" type="text/html">
...
<input type="hidden" id="x_Reception" name="x_Reception" value="<?php echo HtmlEncode($patient_final_diagnosis->Reception->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_final_diagnosis_Reception" class="patient_final_diagnosisadd" type="text/html">
<span id="el_patient_final_diagnosis_Reception">
<input type="text" data-table="patient_final_diagnosis" data-field="x_Reception" name="x_Reception" id="x_Reception" size="30" placeholder="<?php echo HtmlEncode($patient_final_diagnosis->Reception->getPlaceHolder()) ?>" value="<?php echo $patient_final_diagnosis->Reception->EditValue ?>"<?php echo $patient_final_diagnosis->Reception->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_final_diagnosis->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_final_diagnosis_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_final_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_final_diagnosis_PatientSearch" class="patient_final_diagnosisadd" type="text/html"><span><?php echo $patient_final_diagnosis->PatientSearch->caption() ?><?php echo ($patient_final_diagnosis->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_final_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_final_diagnosis->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_final_diagnosis_PatientSearch" class="patient_final_diagnosisadd" type="text/html">
...
{{include tmpl="#tpc_patient_final_diagnosis_PatientSearch"/}}&nbsp;{{include tmpl="#tpx_patient_final_diagnosis_PatientSearch"/}}	
...
ew.applyTemplate("tpd_patient_final_diagnosisadd", "tpm_patient_final_diagnosisadd", "patient_final_diagnosisadd", "<?php echo $patient_final_diagnosis->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_final_diagnosisadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
...
// document.write("page loaded");
 ...
 var c = document.getElementById("el_patient_final_diagnosis_profilePic").children;
 var d = c[0].children;
