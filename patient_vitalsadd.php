...
var fpatient_vitalsadd = currentForm = new ew.Form("fpatient_vitalsadd", "add");
...
fpatient_vitalsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_vitalsadd.lists["x_AnticoagulantifAny"] = <?php echo $patient_vitals_add->AnticoagulantifAny->Lookup->toClientList() ?>;
...
fpatient_vitalsadd.lists["x_GenericAllergies[]"] = <?php echo $patient_vitals_add->GenericAllergies->Lookup->toClientList() ?>;
...
fpatient_vitalsadd.lists["x_GroupAllergies[]"] = <?php echo $patient_vitals_add->GroupAllergies->Lookup->toClientList() ?>;
fpatient_vitalsadd.lists["x_GroupAllergies[]"].options = <?php echo JsonEncode($patient_vitals_add->GroupAllergies->lookupOptions()) ?>;
fpatient_vitalsadd.lists["x_clinicaldetails[]"] = <?php echo $patient_vitals_add->clinicaldetails->Lookup->toClientList() ?>;
fpatient_vitalsadd.lists["x_clinicaldetails[]"].options = <?php echo JsonEncode($patient_vitals_add->clinicaldetails->lookupOptions()) ?>;
fpatient_vitalsadd.lists["x_status"] = <?php echo $patient_vitals_add->status->Lookup->toClientList() ?>;
fpatient_vitalsadd.lists["x_status"].options = <?php echo JsonEncode($patient_vitals_add->status->lookupOptions()) ?>;
fpatient_vitalsadd.lists["x_PatientSearch"] = <?php echo $patient_vitals_add->PatientSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_vitals_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_vitals_add->Token ?>">
<?php } ?>
...
<?php if ($patient_vitals->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_vitals_mrnno" for="x_mrnno" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_mrnno" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->mrnno->caption() ?><?php echo ($patient_vitals->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->mrnno->cellAttributes() ?>>
<?php if ($patient_vitals->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_vitals_mrnno" class="patient_vitalsadd" type="text/html">
...
<input type="hidden" id="x_mrnno" name="x_mrnno" value="<?php echo HtmlEncode($patient_vitals->mrnno->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_vitals_mrnno" class="patient_vitalsadd" type="text/html">
<span id="el_patient_vitals_mrnno">
...
<?php if ($patient_vitals->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_vitals_PatientName" for="x_PatientName" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PatientName" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PatientName->caption() ?><?php echo ($patient_vitals->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PatientName->cellAttributes() ?>>
<script id="tpx_patient_vitals_PatientName" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_vitals_PatID" for="x_PatID" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PatID" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PatID->caption() ?><?php echo ($patient_vitals->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PatID->cellAttributes() ?>>
<script id="tpx_patient_vitals_PatID" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_vitals_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_MobileNumber" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->MobileNumber->caption() ?><?php echo ($patient_vitals->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_vitals_MobileNumber" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_vitals_profilePic" for="x_profilePic" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_profilePic" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->profilePic->caption() ?><?php echo ($patient_vitals->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->profilePic->cellAttributes() ?>>
<script id="tpx_patient_vitals_profilePic" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->HT->Visible) { // HT ?>
	<div id="r_HT" class="form-group row">
		<label id="elh_patient_vitals_HT" for="x_HT" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_HT" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->HT->caption() ?><?php echo ($patient_vitals->HT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->HT->cellAttributes() ?>>
<script id="tpx_patient_vitals_HT" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->WT->Visible) { // WT ?>
	<div id="r_WT" class="form-group row">
		<label id="elh_patient_vitals_WT" for="x_WT" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_WT" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->WT->caption() ?><?php echo ($patient_vitals->WT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->WT->cellAttributes() ?>>
<script id="tpx_patient_vitals_WT" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->SurfaceArea->Visible) { // SurfaceArea ?>
	<div id="r_SurfaceArea" class="form-group row">
		<label id="elh_patient_vitals_SurfaceArea" for="x_SurfaceArea" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_SurfaceArea" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->SurfaceArea->caption() ?><?php echo ($patient_vitals->SurfaceArea->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->SurfaceArea->cellAttributes() ?>>
<script id="tpx_patient_vitals_SurfaceArea" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->BodyMassIndex->Visible) { // BodyMassIndex ?>
	<div id="r_BodyMassIndex" class="form-group row">
		<label id="elh_patient_vitals_BodyMassIndex" for="x_BodyMassIndex" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_BodyMassIndex" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->BodyMassIndex->caption() ?><?php echo ($patient_vitals->BodyMassIndex->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->BodyMassIndex->cellAttributes() ?>>
<script id="tpx_patient_vitals_BodyMassIndex" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->ClinicalFindings->Visible) { // ClinicalFindings ?>
	<div id="r_ClinicalFindings" class="form-group row">
		<label id="elh_patient_vitals_ClinicalFindings" for="x_ClinicalFindings" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_ClinicalFindings" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->ClinicalFindings->caption() ?><?php echo ($patient_vitals->ClinicalFindings->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->ClinicalFindings->cellAttributes() ?>>
<script id="tpx_patient_vitals_ClinicalFindings" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->ClinicalDiagnosis->Visible) { // ClinicalDiagnosis ?>
	<div id="r_ClinicalDiagnosis" class="form-group row">
		<label id="elh_patient_vitals_ClinicalDiagnosis" for="x_ClinicalDiagnosis" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_ClinicalDiagnosis" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->ClinicalDiagnosis->caption() ?><?php echo ($patient_vitals->ClinicalDiagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->ClinicalDiagnosis->cellAttributes() ?>>
<script id="tpx_patient_vitals_ClinicalDiagnosis" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->AnticoagulantifAny->Visible) { // AnticoagulantifAny ?>
	<div id="r_AnticoagulantifAny" class="form-group row">
		<label id="elh_patient_vitals_AnticoagulantifAny" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_AnticoagulantifAny" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->AnticoagulantifAny->caption() ?><?php echo ($patient_vitals->AnticoagulantifAny->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->AnticoagulantifAny->cellAttributes() ?>>
<script id="tpx_patient_vitals_AnticoagulantifAny" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->FoodAllergies->Visible) { // FoodAllergies ?>
	<div id="r_FoodAllergies" class="form-group row">
		<label id="elh_patient_vitals_FoodAllergies" for="x_FoodAllergies" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_FoodAllergies" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->FoodAllergies->caption() ?><?php echo ($patient_vitals->FoodAllergies->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->FoodAllergies->cellAttributes() ?>>
<script id="tpx_patient_vitals_FoodAllergies" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->GenericAllergies->Visible) { // GenericAllergies ?>
	<div id="r_GenericAllergies" class="form-group row">
		<label id="elh_patient_vitals_GenericAllergies" for="x_GenericAllergies" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_GenericAllergies" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->GenericAllergies->caption() ?><?php echo ($patient_vitals->GenericAllergies->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->GenericAllergies->cellAttributes() ?>>
<script id="tpx_patient_vitals_GenericAllergies" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->GroupAllergies->Visible) { // GroupAllergies ?>
	<div id="r_GroupAllergies" class="form-group row">
		<label id="elh_patient_vitals_GroupAllergies" for="x_GroupAllergies" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_GroupAllergies" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->GroupAllergies->caption() ?><?php echo ($patient_vitals->GroupAllergies->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->GroupAllergies->cellAttributes() ?>>
<script id="tpx_patient_vitals_GroupAllergies" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->Temp->Visible) { // Temp ?>
	<div id="r_Temp" class="form-group row">
		<label id="elh_patient_vitals_Temp" for="x_Temp" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_Temp" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->Temp->caption() ?><?php echo ($patient_vitals->Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->Temp->cellAttributes() ?>>
<script id="tpx_patient_vitals_Temp" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->Pulse->Visible) { // Pulse ?>
	<div id="r_Pulse" class="form-group row">
		<label id="elh_patient_vitals_Pulse" for="x_Pulse" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_Pulse" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->Pulse->caption() ?><?php echo ($patient_vitals->Pulse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->Pulse->cellAttributes() ?>>
<script id="tpx_patient_vitals_Pulse" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->BP->Visible) { // BP ?>
	<div id="r_BP" class="form-group row">
		<label id="elh_patient_vitals_BP" for="x_BP" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_BP" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->BP->caption() ?><?php echo ($patient_vitals->BP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->BP->cellAttributes() ?>>
<script id="tpx_patient_vitals_BP" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PR->Visible) { // PR ?>
	<div id="r_PR" class="form-group row">
		<label id="elh_patient_vitals_PR" for="x_PR" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PR" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PR->caption() ?><?php echo ($patient_vitals->PR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PR->cellAttributes() ?>>
<script id="tpx_patient_vitals_PR" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->CNS->Visible) { // CNS ?>
	<div id="r_CNS" class="form-group row">
		<label id="elh_patient_vitals_CNS" for="x_CNS" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_CNS" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->CNS->caption() ?><?php echo ($patient_vitals->CNS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->CNS->cellAttributes() ?>>
<script id="tpx_patient_vitals_CNS" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->RSA->Visible) { // RSA ?>
	<div id="r_RSA" class="form-group row">
		<label id="elh_patient_vitals_RSA" for="x_RSA" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_RSA" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->RSA->caption() ?><?php echo ($patient_vitals->RSA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->RSA->cellAttributes() ?>>
<script id="tpx_patient_vitals_RSA" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->CVS->Visible) { // CVS ?>
	<div id="r_CVS" class="form-group row">
		<label id="elh_patient_vitals_CVS" for="x_CVS" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_CVS" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->CVS->caption() ?><?php echo ($patient_vitals->CVS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->CVS->cellAttributes() ?>>
<script id="tpx_patient_vitals_CVS" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PA->Visible) { // PA ?>
	<div id="r_PA" class="form-group row">
		<label id="elh_patient_vitals_PA" for="x_PA" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PA" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PA->caption() ?><?php echo ($patient_vitals->PA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PA->cellAttributes() ?>>
<script id="tpx_patient_vitals_PA" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PS->Visible) { // PS ?>
	<div id="r_PS" class="form-group row">
		<label id="elh_patient_vitals_PS" for="x_PS" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PS" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PS->caption() ?><?php echo ($patient_vitals->PS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PS->cellAttributes() ?>>
<script id="tpx_patient_vitals_PS" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PV->Visible) { // PV ?>
	<div id="r_PV" class="form-group row">
		<label id="elh_patient_vitals_PV" for="x_PV" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PV" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PV->caption() ?><?php echo ($patient_vitals->PV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PV->cellAttributes() ?>>
<script id="tpx_patient_vitals_PV" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->clinicaldetails->Visible) { // clinicaldetails ?>
	<div id="r_clinicaldetails" class="form-group row">
		<label id="elh_patient_vitals_clinicaldetails" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_clinicaldetails" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->clinicaldetails->caption() ?><?php echo ($patient_vitals->clinicaldetails->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->clinicaldetails->cellAttributes() ?>>
<script id="tpx_patient_vitals_clinicaldetails" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_vitals_status" for="x_status" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_status" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->status->caption() ?><?php echo ($patient_vitals->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->status->cellAttributes() ?>>
<script id="tpx_patient_vitals_status" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_vitals_Age" for="x_Age" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_Age" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->Age->caption() ?><?php echo ($patient_vitals->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->Age->cellAttributes() ?>>
<script id="tpx_patient_vitals_Age" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_vitals_Gender" for="x_Gender" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_Gender" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->Gender->caption() ?><?php echo ($patient_vitals->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->Gender->cellAttributes() ?>>
<script id="tpx_patient_vitals_Gender" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_vitals_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PatientSearch" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PatientSearch->caption() ?><?php echo ($patient_vitals->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_vitals_PatientSearch" class="patient_vitalsadd" type="text/html">
...
<?php if ($patient_vitals->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_vitals_PatientId" for="x_PatientId" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_PatientId" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->PatientId->caption() ?><?php echo ($patient_vitals->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->PatientId->cellAttributes() ?>>
<?php if ($patient_vitals->PatientId->getSessionValue() <> "") { ?>
<script id="tpx_patient_vitals_PatientId" class="patient_vitalsadd" type="text/html">
...
<input type="hidden" id="x_PatientId" name="x_PatientId" value="<?php echo HtmlEncode($patient_vitals->PatientId->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_vitals_PatientId" class="patient_vitalsadd" type="text/html">
<span id="el_patient_vitals_PatientId">
...
<?php if ($patient_vitals->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_vitals_Reception" for="x_Reception" class="<?php echo $patient_vitals_add->LeftColumnClass ?>"><script id="tpc_patient_vitals_Reception" class="patient_vitalsadd" type="text/html"><span><?php echo $patient_vitals->Reception->caption() ?><?php echo ($patient_vitals->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_vitals_add->RightColumnClass ?>"><div<?php echo $patient_vitals->Reception->cellAttributes() ?>>
<?php if ($patient_vitals->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_vitals_Reception" class="patient_vitalsadd" type="text/html">
...
<input type="hidden" id="x_Reception" name="x_Reception" value="<?php echo HtmlEncode($patient_vitals->Reception->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_vitals_Reception" class="patient_vitalsadd" type="text/html">
<span id="el_patient_vitals_Reception">
...
{{include tmpl="#tpc_patient_vitals_PatientSearch"/}}&nbsp;{{include tmpl="#tpx_patient_vitals_PatientSearch"/}}	
...
ew.applyTemplate("tpd_patient_vitalsadd", "tpm_patient_vitalsadd", "patient_vitalsadd", "<?php echo $patient_vitals->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_vitalsadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
