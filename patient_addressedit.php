...
var fpatient_addressedit = currentForm = new ew.Form("fpatient_addressedit", "edit");
...
fpatient_addressedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($patient_address_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $patient_address->modifiedby->caption(), $patient_address->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($patient_address_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $patient_address->modifieddatetime->caption(), $patient_address->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fpatient_addressedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_addressedit.lists["x_address_type"] = <?php echo $patient_address_edit->address_type->Lookup->toClientList() ?>;
fpatient_addressedit.lists["x_address_type"].options = <?php echo JsonEncode($patient_address_edit->address_type->lookupOptions()) ?>;
fpatient_addressedit.lists["x_status"] = <?php echo $patient_address_edit->status->Lookup->toClientList() ?>;
...
<?php if ($patient_address_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_address_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_address->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_address_id" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->id->caption() ?><?php echo ($patient_address->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_address" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_address->id->CurrentValue) ?>">
<?php echo $patient_address->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_address->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_patient_address_patient_id" for="x_patient_id" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->patient_id->caption() ?><?php echo ($patient_address->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->patient_id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_address" data-field="x_patient_id" name="x_patient_id" id="x_patient_id" value="<?php echo HtmlEncode($patient_address->patient_id->CurrentValue) ?>">
...
<?php if ($patient_address->street->Visible) { // street ?>
	<div id="r_street" class="form-group row">
		<label id="elh_patient_address_street" for="x_street" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->street->caption() ?><?php echo ($patient_address->street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->street->cellAttributes() ?>>
...
<?php if ($patient_address->town->Visible) { // town ?>
	<div id="r_town" class="form-group row">
		<label id="elh_patient_address_town" for="x_town" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->town->caption() ?><?php echo ($patient_address->town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->town->cellAttributes() ?>>
...
<?php if ($patient_address->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_patient_address_province" for="x_province" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->province->caption() ?><?php echo ($patient_address->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->province->cellAttributes() ?>>
...
<?php if ($patient_address->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_patient_address_postal_code" for="x_postal_code" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->postal_code->caption() ?><?php echo ($patient_address->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->postal_code->cellAttributes() ?>>
...
<?php if ($patient_address->address_type->Visible) { // address_type ?>
	<div id="r_address_type" class="form-group row">
		<label id="elh_patient_address_address_type" for="x_address_type" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->address_type->caption() ?><?php echo ($patient_address->address_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->address_type->cellAttributes() ?>>
...
<?php if ($patient_address->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_address_status" for="x_status" class="<?php echo $patient_address_edit->LeftColumnClass ?>"><?php echo $patient_address->status->caption() ?><?php echo ($patient_address->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_address_edit->RightColumnClass ?>"><div<?php echo $patient_address->status->cellAttributes() ?>>
