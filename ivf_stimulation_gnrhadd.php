...
var fivf_stimulation_gnrhadd = currentForm = new ew.Form("fivf_stimulation_gnrhadd", "add");
...
fivf_stimulation_gnrhadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($ivf_stimulation_gnrh_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_stimulation_gnrh_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_stimulation_gnrh->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_stimulation_gnrh_Name" for="x_Name" class="<?php echo $ivf_stimulation_gnrh_add->LeftColumnClass ?>"><?php echo $ivf_stimulation_gnrh->Name->caption() ?><?php echo ($ivf_stimulation_gnrh->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_stimulation_gnrh_add->RightColumnClass ?>"><div<?php echo $ivf_stimulation_gnrh->Name->cellAttributes() ?>>
