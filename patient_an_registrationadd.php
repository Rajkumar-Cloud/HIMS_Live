...
var fpatient_an_registrationadd = currentForm = new ew.Form("fpatient_an_registrationadd", "add");
...
fpatient_an_registrationadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_an_registrationadd.lists["x_MenstrualHistory"] = <?php echo $patient_an_registration_add->MenstrualHistory->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PreviousHistoryofGDM"] = <?php echo $patient_an_registration_add->PreviousHistoryofGDM->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PreviousHistorofPIH"] = <?php echo $patient_an_registration_add->PreviousHistorofPIH->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PreviousHistoryofIUGR"] = <?php echo $patient_an_registration_add->PreviousHistoryofIUGR->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PreviousHistoryofOligohydramnios"] = <?php echo $patient_an_registration_add->PreviousHistoryofOligohydramnios->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PreviousHistoryofPreterm"] = <?php echo $patient_an_registration_add->PreviousHistoryofPreterm->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PastMedicalHistory[]"] = <?php echo $patient_an_registration_add->PastMedicalHistory->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_PastSurgicalHistory[]"] = <?php echo $patient_an_registration_add->PastSurgicalHistory->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_FamilyHistory[]"] = <?php echo $patient_an_registration_add->FamilyHistory->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_Bleeding[]"] = <?php echo $patient_an_registration_add->Bleeding->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_Miscarriage"] = <?php echo $patient_an_registration_add->Miscarriage->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_ModeOfDelivery"] = <?php echo $patient_an_registration_add->ModeOfDelivery->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_NDS"] = <?php echo $patient_an_registration_add->NDS->Lookup->toClientList() ?>;
fpatient_an_registrationadd.lists["x_NDS"].options = <?php echo JsonEncode($patient_an_registration_add->NDS->options(FALSE, TRUE)) ?>;
fpatient_an_registrationadd.lists["x_NDP"] = <?php echo $patient_an_registration_add->NDP->Lookup->toClientList() ?>;
fpatient_an_registrationadd.lists["x_NDP"].options = <?php echo JsonEncode($patient_an_registration_add->NDP->options(FALSE, TRUE)) ?>;
fpatient_an_registrationadd.lists["x_VaccumS"] = <?php echo $patient_an_registration_add->VaccumS->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_VaccumP"] = <?php echo $patient_an_registration_add->VaccumP->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_ForcepsS"] = <?php echo $patient_an_registration_add->ForcepsS->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_ForcepsP"] = <?php echo $patient_an_registration_add->ForcepsP->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_ElectiveS"] = <?php echo $patient_an_registration_add->ElectiveS->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_ElectiveP"] = <?php echo $patient_an_registration_add->ElectiveP->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_EmergencyS"] = <?php echo $patient_an_registration_add->EmergencyS->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_EmergencyP"] = <?php echo $patient_an_registration_add->EmergencyP->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_Maturity"] = <?php echo $patient_an_registration_add->Maturity->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_SpillOverReasons"] = <?php echo $patient_an_registration_add->SpillOverReasons->Lookup->toClientList() ?>;
...
fpatient_an_registrationadd.lists["x_ANClosed[]"] = <?php echo $patient_an_registration_add->ANClosed->Lookup->toClientList() ?>;
...
<?php if ($patient_an_registration_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_an_registration_add->Token ?>">
<?php } ?>
...
<?php if ($patient_an_registration->pid->Visible) { // pid ?>
	<div id="r_pid" class="form-group row">
		<label id="elh_patient_an_registration_pid" for="x_pid" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_pid" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->pid->caption() ?><?php echo ($patient_an_registration->pid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->pid->cellAttributes() ?>>
<?php if ($patient_an_registration->pid->getSessionValue() <> "") { ?>
<script id="tpx_patient_an_registration_pid" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->fid->Visible) { // fid ?>
	<div id="r_fid" class="form-group row">
		<label id="elh_patient_an_registration_fid" for="x_fid" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_fid" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->fid->caption() ?><?php echo ($patient_an_registration->fid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->fid->cellAttributes() ?>>
<?php if ($patient_an_registration->fid->getSessionValue() <> "") { ?>
<script id="tpx_patient_an_registration_fid" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->G->Visible) { // G ?>
	<div id="r_G" class="form-group row">
		<label id="elh_patient_an_registration_G" for="x_G" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_G" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->G->caption() ?><?php echo ($patient_an_registration->G->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->G->cellAttributes() ?>>
<script id="tpx_patient_an_registration_G" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->P->Visible) { // P ?>
	<div id="r_P" class="form-group row">
		<label id="elh_patient_an_registration_P" for="x_P" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_P" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->P->caption() ?><?php echo ($patient_an_registration->P->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->P->cellAttributes() ?>>
<script id="tpx_patient_an_registration_P" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->L->Visible) { // L ?>
	<div id="r_L" class="form-group row">
		<label id="elh_patient_an_registration_L" for="x_L" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_L" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->L->caption() ?><?php echo ($patient_an_registration->L->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->L->cellAttributes() ?>>
<script id="tpx_patient_an_registration_L" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A->Visible) { // A ?>
	<div id="r_A" class="form-group row">
		<label id="elh_patient_an_registration_A" for="x_A" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A->caption() ?><?php echo ($patient_an_registration->A->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->E->Visible) { // E ?>
	<div id="r_E" class="form-group row">
		<label id="elh_patient_an_registration_E" for="x_E" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_E" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->E->caption() ?><?php echo ($patient_an_registration->E->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->E->cellAttributes() ?>>
<script id="tpx_patient_an_registration_E" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->M->Visible) { // M ?>
	<div id="r_M" class="form-group row">
		<label id="elh_patient_an_registration_M" for="x_M" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_M" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->M->caption() ?><?php echo ($patient_an_registration->M->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->M->cellAttributes() ?>>
<script id="tpx_patient_an_registration_M" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->LMP->Visible) { // LMP ?>
	<div id="r_LMP" class="form-group row">
		<label id="elh_patient_an_registration_LMP" for="x_LMP" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_LMP" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->LMP->caption() ?><?php echo ($patient_an_registration->LMP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->LMP->cellAttributes() ?>>
<script id="tpx_patient_an_registration_LMP" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->EDO->Visible) { // EDO ?>
	<div id="r_EDO" class="form-group row">
		<label id="elh_patient_an_registration_EDO" for="x_EDO" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_EDO" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->EDO->caption() ?><?php echo ($patient_an_registration->EDO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->EDO->cellAttributes() ?>>
<script id="tpx_patient_an_registration_EDO" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->MenstrualHistory->Visible) { // MenstrualHistory ?>
	<div id="r_MenstrualHistory" class="form-group row">
		<label id="elh_patient_an_registration_MenstrualHistory" for="x_MenstrualHistory" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_MenstrualHistory" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->MenstrualHistory->caption() ?><?php echo ($patient_an_registration->MenstrualHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->MenstrualHistory->cellAttributes() ?>>
<script id="tpx_patient_an_registration_MenstrualHistory" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->MaritalHistory->Visible) { // MaritalHistory ?>
	<div id="r_MaritalHistory" class="form-group row">
		<label id="elh_patient_an_registration_MaritalHistory" for="x_MaritalHistory" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_MaritalHistory" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->MaritalHistory->caption() ?><?php echo ($patient_an_registration->MaritalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->MaritalHistory->cellAttributes() ?>>
<script id="tpx_patient_an_registration_MaritalHistory" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ObstetricHistory->Visible) { // ObstetricHistory ?>
	<div id="r_ObstetricHistory" class="form-group row">
		<label id="elh_patient_an_registration_ObstetricHistory" for="x_ObstetricHistory" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ObstetricHistory" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ObstetricHistory->caption() ?><?php echo ($patient_an_registration->ObstetricHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ObstetricHistory->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ObstetricHistory" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PreviousHistoryofGDM->Visible) { // PreviousHistoryofGDM ?>
	<div id="r_PreviousHistoryofGDM" class="form-group row">
		<label id="elh_patient_an_registration_PreviousHistoryofGDM" for="x_PreviousHistoryofGDM" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PreviousHistoryofGDM" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PreviousHistoryofGDM->caption() ?><?php echo ($patient_an_registration->PreviousHistoryofGDM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PreviousHistoryofGDM->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PreviousHistoryofGDM" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PreviousHistorofPIH->Visible) { // PreviousHistorofPIH ?>
	<div id="r_PreviousHistorofPIH" class="form-group row">
		<label id="elh_patient_an_registration_PreviousHistorofPIH" for="x_PreviousHistorofPIH" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PreviousHistorofPIH" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PreviousHistorofPIH->caption() ?><?php echo ($patient_an_registration->PreviousHistorofPIH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PreviousHistorofPIH->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PreviousHistorofPIH" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PreviousHistoryofIUGR->Visible) { // PreviousHistoryofIUGR ?>
	<div id="r_PreviousHistoryofIUGR" class="form-group row">
		<label id="elh_patient_an_registration_PreviousHistoryofIUGR" for="x_PreviousHistoryofIUGR" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PreviousHistoryofIUGR" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PreviousHistoryofIUGR->caption() ?><?php echo ($patient_an_registration->PreviousHistoryofIUGR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PreviousHistoryofIUGR->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PreviousHistoryofIUGR" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PreviousHistoryofOligohydramnios->Visible) { // PreviousHistoryofOligohydramnios ?>
	<div id="r_PreviousHistoryofOligohydramnios" class="form-group row">
		<label id="elh_patient_an_registration_PreviousHistoryofOligohydramnios" for="x_PreviousHistoryofOligohydramnios" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PreviousHistoryofOligohydramnios" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PreviousHistoryofOligohydramnios->caption() ?><?php echo ($patient_an_registration->PreviousHistoryofOligohydramnios->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PreviousHistoryofOligohydramnios->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PreviousHistoryofOligohydramnios" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PreviousHistoryofPreterm->Visible) { // PreviousHistoryofPreterm ?>
	<div id="r_PreviousHistoryofPreterm" class="form-group row">
		<label id="elh_patient_an_registration_PreviousHistoryofPreterm" for="x_PreviousHistoryofPreterm" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PreviousHistoryofPreterm" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PreviousHistoryofPreterm->caption() ?><?php echo ($patient_an_registration->PreviousHistoryofPreterm->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PreviousHistoryofPreterm->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PreviousHistoryofPreterm" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->G1->Visible) { // G1 ?>
	<div id="r_G1" class="form-group row">
		<label id="elh_patient_an_registration_G1" for="x_G1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_G1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->G1->caption() ?><?php echo ($patient_an_registration->G1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->G1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_G1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->G2->Visible) { // G2 ?>
	<div id="r_G2" class="form-group row">
		<label id="elh_patient_an_registration_G2" for="x_G2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_G2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->G2->caption() ?><?php echo ($patient_an_registration->G2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->G2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_G2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->G3->Visible) { // G3 ?>
	<div id="r_G3" class="form-group row">
		<label id="elh_patient_an_registration_G3" for="x_G3" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_G3" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->G3->caption() ?><?php echo ($patient_an_registration->G3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->G3->cellAttributes() ?>>
<script id="tpx_patient_an_registration_G3" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DeliveryNDLSCS1->Visible) { // DeliveryNDLSCS1 ?>
	<div id="r_DeliveryNDLSCS1" class="form-group row">
		<label id="elh_patient_an_registration_DeliveryNDLSCS1" for="x_DeliveryNDLSCS1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DeliveryNDLSCS1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DeliveryNDLSCS1->caption() ?><?php echo ($patient_an_registration->DeliveryNDLSCS1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DeliveryNDLSCS1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DeliveryNDLSCS1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DeliveryNDLSCS2->Visible) { // DeliveryNDLSCS2 ?>
	<div id="r_DeliveryNDLSCS2" class="form-group row">
		<label id="elh_patient_an_registration_DeliveryNDLSCS2" for="x_DeliveryNDLSCS2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DeliveryNDLSCS2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DeliveryNDLSCS2->caption() ?><?php echo ($patient_an_registration->DeliveryNDLSCS2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DeliveryNDLSCS2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DeliveryNDLSCS2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DeliveryNDLSCS3->Visible) { // DeliveryNDLSCS3 ?>
	<div id="r_DeliveryNDLSCS3" class="form-group row">
		<label id="elh_patient_an_registration_DeliveryNDLSCS3" for="x_DeliveryNDLSCS3" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DeliveryNDLSCS3" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DeliveryNDLSCS3->caption() ?><?php echo ($patient_an_registration->DeliveryNDLSCS3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DeliveryNDLSCS3->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DeliveryNDLSCS3" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->BabySexweight1->Visible) { // BabySexweight1 ?>
	<div id="r_BabySexweight1" class="form-group row">
		<label id="elh_patient_an_registration_BabySexweight1" for="x_BabySexweight1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_BabySexweight1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->BabySexweight1->caption() ?><?php echo ($patient_an_registration->BabySexweight1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->BabySexweight1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_BabySexweight1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->BabySexweight2->Visible) { // BabySexweight2 ?>
	<div id="r_BabySexweight2" class="form-group row">
		<label id="elh_patient_an_registration_BabySexweight2" for="x_BabySexweight2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_BabySexweight2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->BabySexweight2->caption() ?><?php echo ($patient_an_registration->BabySexweight2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->BabySexweight2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_BabySexweight2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->BabySexweight3->Visible) { // BabySexweight3 ?>
	<div id="r_BabySexweight3" class="form-group row">
		<label id="elh_patient_an_registration_BabySexweight3" for="x_BabySexweight3" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_BabySexweight3" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->BabySexweight3->caption() ?><?php echo ($patient_an_registration->BabySexweight3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->BabySexweight3->cellAttributes() ?>>
<script id="tpx_patient_an_registration_BabySexweight3" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PastMedicalHistory->Visible) { // PastMedicalHistory ?>
	<div id="r_PastMedicalHistory" class="form-group row">
		<label id="elh_patient_an_registration_PastMedicalHistory" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PastMedicalHistory" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PastMedicalHistory->caption() ?><?php echo ($patient_an_registration->PastMedicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PastMedicalHistory->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PastMedicalHistory" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PastSurgicalHistory->Visible) { // PastSurgicalHistory ?>
	<div id="r_PastSurgicalHistory" class="form-group row">
		<label id="elh_patient_an_registration_PastSurgicalHistory" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PastSurgicalHistory" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PastSurgicalHistory->caption() ?><?php echo ($patient_an_registration->PastSurgicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PastSurgicalHistory->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PastSurgicalHistory" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->FamilyHistory->Visible) { // FamilyHistory ?>
	<div id="r_FamilyHistory" class="form-group row">
		<label id="elh_patient_an_registration_FamilyHistory" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_FamilyHistory" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->FamilyHistory->caption() ?><?php echo ($patient_an_registration->FamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->FamilyHistory->cellAttributes() ?>>
<script id="tpx_patient_an_registration_FamilyHistory" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Viability->Visible) { // Viability ?>
	<div id="r_Viability" class="form-group row">
		<label id="elh_patient_an_registration_Viability" for="x_Viability" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Viability" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Viability->caption() ?><?php echo ($patient_an_registration->Viability->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Viability->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Viability" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ViabilityDATE->Visible) { // ViabilityDATE ?>
	<div id="r_ViabilityDATE" class="form-group row">
		<label id="elh_patient_an_registration_ViabilityDATE" for="x_ViabilityDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ViabilityDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ViabilityDATE->caption() ?><?php echo ($patient_an_registration->ViabilityDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ViabilityDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ViabilityDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ViabilityREPORT->Visible) { // ViabilityREPORT ?>
	<div id="r_ViabilityREPORT" class="form-group row">
		<label id="elh_patient_an_registration_ViabilityREPORT" for="x_ViabilityREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ViabilityREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ViabilityREPORT->caption() ?><?php echo ($patient_an_registration->ViabilityREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ViabilityREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ViabilityREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Viability2->Visible) { // Viability2 ?>
	<div id="r_Viability2" class="form-group row">
		<label id="elh_patient_an_registration_Viability2" for="x_Viability2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Viability2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Viability2->caption() ?><?php echo ($patient_an_registration->Viability2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Viability2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Viability2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Viability2DATE->Visible) { // Viability2DATE ?>
	<div id="r_Viability2DATE" class="form-group row">
		<label id="elh_patient_an_registration_Viability2DATE" for="x_Viability2DATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Viability2DATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Viability2DATE->caption() ?><?php echo ($patient_an_registration->Viability2DATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Viability2DATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Viability2DATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Viability2REPORT->Visible) { // Viability2REPORT ?>
	<div id="r_Viability2REPORT" class="form-group row">
		<label id="elh_patient_an_registration_Viability2REPORT" for="x_Viability2REPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Viability2REPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Viability2REPORT->caption() ?><?php echo ($patient_an_registration->Viability2REPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Viability2REPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Viability2REPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NTscan->Visible) { // NTscan ?>
	<div id="r_NTscan" class="form-group row">
		<label id="elh_patient_an_registration_NTscan" for="x_NTscan" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NTscan" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NTscan->caption() ?><?php echo ($patient_an_registration->NTscan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NTscan->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NTscan" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NTscanDATE->Visible) { // NTscanDATE ?>
	<div id="r_NTscanDATE" class="form-group row">
		<label id="elh_patient_an_registration_NTscanDATE" for="x_NTscanDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NTscanDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NTscanDATE->caption() ?><?php echo ($patient_an_registration->NTscanDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NTscanDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NTscanDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NTscanREPORT->Visible) { // NTscanREPORT ?>
	<div id="r_NTscanREPORT" class="form-group row">
		<label id="elh_patient_an_registration_NTscanREPORT" for="x_NTscanREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NTscanREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NTscanREPORT->caption() ?><?php echo ($patient_an_registration->NTscanREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NTscanREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NTscanREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->EarlyTarget->Visible) { // EarlyTarget ?>
	<div id="r_EarlyTarget" class="form-group row">
		<label id="elh_patient_an_registration_EarlyTarget" for="x_EarlyTarget" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_EarlyTarget" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->EarlyTarget->caption() ?><?php echo ($patient_an_registration->EarlyTarget->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->EarlyTarget->cellAttributes() ?>>
<script id="tpx_patient_an_registration_EarlyTarget" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->EarlyTargetDATE->Visible) { // EarlyTargetDATE ?>
	<div id="r_EarlyTargetDATE" class="form-group row">
		<label id="elh_patient_an_registration_EarlyTargetDATE" for="x_EarlyTargetDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_EarlyTargetDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->EarlyTargetDATE->caption() ?><?php echo ($patient_an_registration->EarlyTargetDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->EarlyTargetDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_EarlyTargetDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->EarlyTargetREPORT->Visible) { // EarlyTargetREPORT ?>
	<div id="r_EarlyTargetREPORT" class="form-group row">
		<label id="elh_patient_an_registration_EarlyTargetREPORT" for="x_EarlyTargetREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_EarlyTargetREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->EarlyTargetREPORT->caption() ?><?php echo ($patient_an_registration->EarlyTargetREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->EarlyTargetREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_EarlyTargetREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Anomaly->Visible) { // Anomaly ?>
	<div id="r_Anomaly" class="form-group row">
		<label id="elh_patient_an_registration_Anomaly" for="x_Anomaly" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Anomaly" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Anomaly->caption() ?><?php echo ($patient_an_registration->Anomaly->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Anomaly->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Anomaly" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->AnomalyDATE->Visible) { // AnomalyDATE ?>
	<div id="r_AnomalyDATE" class="form-group row">
		<label id="elh_patient_an_registration_AnomalyDATE" for="x_AnomalyDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_AnomalyDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->AnomalyDATE->caption() ?><?php echo ($patient_an_registration->AnomalyDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->AnomalyDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_AnomalyDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->AnomalyREPORT->Visible) { // AnomalyREPORT ?>
	<div id="r_AnomalyREPORT" class="form-group row">
		<label id="elh_patient_an_registration_AnomalyREPORT" for="x_AnomalyREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_AnomalyREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->AnomalyREPORT->caption() ?><?php echo ($patient_an_registration->AnomalyREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->AnomalyREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_AnomalyREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Growth->Visible) { // Growth ?>
	<div id="r_Growth" class="form-group row">
		<label id="elh_patient_an_registration_Growth" for="x_Growth" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Growth" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Growth->caption() ?><?php echo ($patient_an_registration->Growth->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Growth->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Growth" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->GrowthDATE->Visible) { // GrowthDATE ?>
	<div id="r_GrowthDATE" class="form-group row">
		<label id="elh_patient_an_registration_GrowthDATE" for="x_GrowthDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_GrowthDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->GrowthDATE->caption() ?><?php echo ($patient_an_registration->GrowthDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->GrowthDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_GrowthDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->GrowthREPORT->Visible) { // GrowthREPORT ?>
	<div id="r_GrowthREPORT" class="form-group row">
		<label id="elh_patient_an_registration_GrowthREPORT" for="x_GrowthREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_GrowthREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->GrowthREPORT->caption() ?><?php echo ($patient_an_registration->GrowthREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->GrowthREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_GrowthREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Growth1->Visible) { // Growth1 ?>
	<div id="r_Growth1" class="form-group row">
		<label id="elh_patient_an_registration_Growth1" for="x_Growth1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Growth1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Growth1->caption() ?><?php echo ($patient_an_registration->Growth1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Growth1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Growth1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Growth1DATE->Visible) { // Growth1DATE ?>
	<div id="r_Growth1DATE" class="form-group row">
		<label id="elh_patient_an_registration_Growth1DATE" for="x_Growth1DATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Growth1DATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Growth1DATE->caption() ?><?php echo ($patient_an_registration->Growth1DATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Growth1DATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Growth1DATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Growth1REPORT->Visible) { // Growth1REPORT ?>
	<div id="r_Growth1REPORT" class="form-group row">
		<label id="elh_patient_an_registration_Growth1REPORT" for="x_Growth1REPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Growth1REPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Growth1REPORT->caption() ?><?php echo ($patient_an_registration->Growth1REPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Growth1REPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Growth1REPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ANProfile->Visible) { // ANProfile ?>
	<div id="r_ANProfile" class="form-group row">
		<label id="elh_patient_an_registration_ANProfile" for="x_ANProfile" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ANProfile" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ANProfile->caption() ?><?php echo ($patient_an_registration->ANProfile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ANProfile->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ANProfile" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ANProfileDATE->Visible) { // ANProfileDATE ?>
	<div id="r_ANProfileDATE" class="form-group row">
		<label id="elh_patient_an_registration_ANProfileDATE" for="x_ANProfileDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ANProfileDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ANProfileDATE->caption() ?><?php echo ($patient_an_registration->ANProfileDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ANProfileDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ANProfileDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ANProfileINHOUSE->Visible) { // ANProfileINHOUSE ?>
	<div id="r_ANProfileINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_ANProfileINHOUSE" for="x_ANProfileINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ANProfileINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ANProfileINHOUSE->caption() ?><?php echo ($patient_an_registration->ANProfileINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ANProfileINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ANProfileINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ANProfileREPORT->Visible) { // ANProfileREPORT ?>
	<div id="r_ANProfileREPORT" class="form-group row">
		<label id="elh_patient_an_registration_ANProfileREPORT" for="x_ANProfileREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ANProfileREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ANProfileREPORT->caption() ?><?php echo ($patient_an_registration->ANProfileREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ANProfileREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ANProfileREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DualMarker->Visible) { // DualMarker ?>
	<div id="r_DualMarker" class="form-group row">
		<label id="elh_patient_an_registration_DualMarker" for="x_DualMarker" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DualMarker" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DualMarker->caption() ?><?php echo ($patient_an_registration->DualMarker->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DualMarker->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DualMarker" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DualMarkerDATE->Visible) { // DualMarkerDATE ?>
	<div id="r_DualMarkerDATE" class="form-group row">
		<label id="elh_patient_an_registration_DualMarkerDATE" for="x_DualMarkerDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DualMarkerDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DualMarkerDATE->caption() ?><?php echo ($patient_an_registration->DualMarkerDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DualMarkerDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DualMarkerDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DualMarkerINHOUSE->Visible) { // DualMarkerINHOUSE ?>
	<div id="r_DualMarkerINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_DualMarkerINHOUSE" for="x_DualMarkerINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DualMarkerINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DualMarkerINHOUSE->caption() ?><?php echo ($patient_an_registration->DualMarkerINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DualMarkerINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DualMarkerINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DualMarkerREPORT->Visible) { // DualMarkerREPORT ?>
	<div id="r_DualMarkerREPORT" class="form-group row">
		<label id="elh_patient_an_registration_DualMarkerREPORT" for="x_DualMarkerREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DualMarkerREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DualMarkerREPORT->caption() ?><?php echo ($patient_an_registration->DualMarkerREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DualMarkerREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DualMarkerREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Quadruple->Visible) { // Quadruple ?>
	<div id="r_Quadruple" class="form-group row">
		<label id="elh_patient_an_registration_Quadruple" for="x_Quadruple" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Quadruple" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Quadruple->caption() ?><?php echo ($patient_an_registration->Quadruple->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Quadruple->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Quadruple" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->QuadrupleDATE->Visible) { // QuadrupleDATE ?>
	<div id="r_QuadrupleDATE" class="form-group row">
		<label id="elh_patient_an_registration_QuadrupleDATE" for="x_QuadrupleDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_QuadrupleDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->QuadrupleDATE->caption() ?><?php echo ($patient_an_registration->QuadrupleDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->QuadrupleDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_QuadrupleDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->QuadrupleINHOUSE->Visible) { // QuadrupleINHOUSE ?>
	<div id="r_QuadrupleINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_QuadrupleINHOUSE" for="x_QuadrupleINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_QuadrupleINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->QuadrupleINHOUSE->caption() ?><?php echo ($patient_an_registration->QuadrupleINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->QuadrupleINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_QuadrupleINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->QuadrupleREPORT->Visible) { // QuadrupleREPORT ?>
	<div id="r_QuadrupleREPORT" class="form-group row">
		<label id="elh_patient_an_registration_QuadrupleREPORT" for="x_QuadrupleREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_QuadrupleREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->QuadrupleREPORT->caption() ?><?php echo ($patient_an_registration->QuadrupleREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->QuadrupleREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_QuadrupleREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A5month->Visible) { // A5month ?>
	<div id="r_A5month" class="form-group row">
		<label id="elh_patient_an_registration_A5month" for="x_A5month" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A5month" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A5month->caption() ?><?php echo ($patient_an_registration->A5month->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A5month->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A5month" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A5monthDATE->Visible) { // A5monthDATE ?>
	<div id="r_A5monthDATE" class="form-group row">
		<label id="elh_patient_an_registration_A5monthDATE" for="x_A5monthDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A5monthDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A5monthDATE->caption() ?><?php echo ($patient_an_registration->A5monthDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A5monthDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A5monthDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A5monthINHOUSE->Visible) { // A5monthINHOUSE ?>
	<div id="r_A5monthINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_A5monthINHOUSE" for="x_A5monthINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A5monthINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A5monthINHOUSE->caption() ?><?php echo ($patient_an_registration->A5monthINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A5monthINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A5monthINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A5monthREPORT->Visible) { // A5monthREPORT ?>
	<div id="r_A5monthREPORT" class="form-group row">
		<label id="elh_patient_an_registration_A5monthREPORT" for="x_A5monthREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A5monthREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A5monthREPORT->caption() ?><?php echo ($patient_an_registration->A5monthREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A5monthREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A5monthREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A7month->Visible) { // A7month ?>
	<div id="r_A7month" class="form-group row">
		<label id="elh_patient_an_registration_A7month" for="x_A7month" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A7month" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A7month->caption() ?><?php echo ($patient_an_registration->A7month->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A7month->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A7month" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A7monthDATE->Visible) { // A7monthDATE ?>
	<div id="r_A7monthDATE" class="form-group row">
		<label id="elh_patient_an_registration_A7monthDATE" for="x_A7monthDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A7monthDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A7monthDATE->caption() ?><?php echo ($patient_an_registration->A7monthDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A7monthDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A7monthDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A7monthINHOUSE->Visible) { // A7monthINHOUSE ?>
	<div id="r_A7monthINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_A7monthINHOUSE" for="x_A7monthINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A7monthINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A7monthINHOUSE->caption() ?><?php echo ($patient_an_registration->A7monthINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A7monthINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A7monthINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A7monthREPORT->Visible) { // A7monthREPORT ?>
	<div id="r_A7monthREPORT" class="form-group row">
		<label id="elh_patient_an_registration_A7monthREPORT" for="x_A7monthREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A7monthREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A7monthREPORT->caption() ?><?php echo ($patient_an_registration->A7monthREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A7monthREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A7monthREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A9month->Visible) { // A9month ?>
	<div id="r_A9month" class="form-group row">
		<label id="elh_patient_an_registration_A9month" for="x_A9month" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A9month" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A9month->caption() ?><?php echo ($patient_an_registration->A9month->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A9month->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A9month" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A9monthDATE->Visible) { // A9monthDATE ?>
	<div id="r_A9monthDATE" class="form-group row">
		<label id="elh_patient_an_registration_A9monthDATE" for="x_A9monthDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A9monthDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A9monthDATE->caption() ?><?php echo ($patient_an_registration->A9monthDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A9monthDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A9monthDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A9monthINHOUSE->Visible) { // A9monthINHOUSE ?>
	<div id="r_A9monthINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_A9monthINHOUSE" for="x_A9monthINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A9monthINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A9monthINHOUSE->caption() ?><?php echo ($patient_an_registration->A9monthINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A9monthINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A9monthINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->A9monthREPORT->Visible) { // A9monthREPORT ?>
	<div id="r_A9monthREPORT" class="form-group row">
		<label id="elh_patient_an_registration_A9monthREPORT" for="x_A9monthREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_A9monthREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->A9monthREPORT->caption() ?><?php echo ($patient_an_registration->A9monthREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->A9monthREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_A9monthREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->INJ->Visible) { // INJ ?>
	<div id="r_INJ" class="form-group row">
		<label id="elh_patient_an_registration_INJ" for="x_INJ" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_INJ" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->INJ->caption() ?><?php echo ($patient_an_registration->INJ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->INJ->cellAttributes() ?>>
<script id="tpx_patient_an_registration_INJ" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->INJDATE->Visible) { // INJDATE ?>
	<div id="r_INJDATE" class="form-group row">
		<label id="elh_patient_an_registration_INJDATE" for="x_INJDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_INJDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->INJDATE->caption() ?><?php echo ($patient_an_registration->INJDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->INJDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_INJDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->INJINHOUSE->Visible) { // INJINHOUSE ?>
	<div id="r_INJINHOUSE" class="form-group row">
		<label id="elh_patient_an_registration_INJINHOUSE" for="x_INJINHOUSE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_INJINHOUSE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->INJINHOUSE->caption() ?><?php echo ($patient_an_registration->INJINHOUSE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->INJINHOUSE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_INJINHOUSE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->INJREPORT->Visible) { // INJREPORT ?>
	<div id="r_INJREPORT" class="form-group row">
		<label id="elh_patient_an_registration_INJREPORT" for="x_INJREPORT" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_INJREPORT" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->INJREPORT->caption() ?><?php echo ($patient_an_registration->INJREPORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->INJREPORT->cellAttributes() ?>>
<script id="tpx_patient_an_registration_INJREPORT" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Bleeding->Visible) { // Bleeding ?>
	<div id="r_Bleeding" class="form-group row">
		<label id="elh_patient_an_registration_Bleeding" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Bleeding" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Bleeding->caption() ?><?php echo ($patient_an_registration->Bleeding->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Bleeding->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Bleeding" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Hypothyroidism->Visible) { // Hypothyroidism ?>
	<div id="r_Hypothyroidism" class="form-group row">
		<label id="elh_patient_an_registration_Hypothyroidism" for="x_Hypothyroidism" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Hypothyroidism" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Hypothyroidism->caption() ?><?php echo ($patient_an_registration->Hypothyroidism->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Hypothyroidism->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Hypothyroidism" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PICMENumber->Visible) { // PICMENumber ?>
	<div id="r_PICMENumber" class="form-group row">
		<label id="elh_patient_an_registration_PICMENumber" for="x_PICMENumber" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PICMENumber" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PICMENumber->caption() ?><?php echo ($patient_an_registration->PICMENumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PICMENumber->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PICMENumber" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Outcome->Visible) { // Outcome ?>
	<div id="r_Outcome" class="form-group row">
		<label id="elh_patient_an_registration_Outcome" for="x_Outcome" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Outcome" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Outcome->caption() ?><?php echo ($patient_an_registration->Outcome->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Outcome->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Outcome" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DateofAdmission->Visible) { // DateofAdmission ?>
	<div id="r_DateofAdmission" class="form-group row">
		<label id="elh_patient_an_registration_DateofAdmission" for="x_DateofAdmission" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DateofAdmission" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DateofAdmission->caption() ?><?php echo ($patient_an_registration->DateofAdmission->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DateofAdmission->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DateofAdmission" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->DateodProcedure->Visible) { // DateodProcedure ?>
	<div id="r_DateodProcedure" class="form-group row">
		<label id="elh_patient_an_registration_DateodProcedure" for="x_DateodProcedure" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_DateodProcedure" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->DateodProcedure->caption() ?><?php echo ($patient_an_registration->DateodProcedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->DateodProcedure->cellAttributes() ?>>
<script id="tpx_patient_an_registration_DateodProcedure" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Miscarriage->Visible) { // Miscarriage ?>
	<div id="r_Miscarriage" class="form-group row">
		<label id="elh_patient_an_registration_Miscarriage" for="x_Miscarriage" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Miscarriage" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Miscarriage->caption() ?><?php echo ($patient_an_registration->Miscarriage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Miscarriage->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Miscarriage" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ModeOfDelivery->Visible) { // ModeOfDelivery ?>
	<div id="r_ModeOfDelivery" class="form-group row">
		<label id="elh_patient_an_registration_ModeOfDelivery" for="x_ModeOfDelivery" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ModeOfDelivery" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ModeOfDelivery->caption() ?><?php echo ($patient_an_registration->ModeOfDelivery->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ModeOfDelivery->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ModeOfDelivery" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ND->Visible) { // ND ?>
	<div id="r_ND" class="form-group row">
		<label id="elh_patient_an_registration_ND" for="x_ND" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ND" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ND->caption() ?><?php echo ($patient_an_registration->ND->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ND->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ND" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NDS->Visible) { // NDS ?>
	<div id="r_NDS" class="form-group row">
		<label id="elh_patient_an_registration_NDS" for="x_NDS" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NDS" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NDS->caption() ?><?php echo ($patient_an_registration->NDS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NDS->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NDS" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NDP->Visible) { // NDP ?>
	<div id="r_NDP" class="form-group row">
		<label id="elh_patient_an_registration_NDP" for="x_NDP" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NDP" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NDP->caption() ?><?php echo ($patient_an_registration->NDP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NDP->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NDP" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Vaccum->Visible) { // Vaccum ?>
	<div id="r_Vaccum" class="form-group row">
		<label id="elh_patient_an_registration_Vaccum" for="x_Vaccum" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Vaccum" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Vaccum->caption() ?><?php echo ($patient_an_registration->Vaccum->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Vaccum->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Vaccum" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->VaccumS->Visible) { // VaccumS ?>
	<div id="r_VaccumS" class="form-group row">
		<label id="elh_patient_an_registration_VaccumS" for="x_VaccumS" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_VaccumS" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->VaccumS->caption() ?><?php echo ($patient_an_registration->VaccumS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->VaccumS->cellAttributes() ?>>
<script id="tpx_patient_an_registration_VaccumS" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->VaccumP->Visible) { // VaccumP ?>
	<div id="r_VaccumP" class="form-group row">
		<label id="elh_patient_an_registration_VaccumP" for="x_VaccumP" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_VaccumP" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->VaccumP->caption() ?><?php echo ($patient_an_registration->VaccumP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->VaccumP->cellAttributes() ?>>
<script id="tpx_patient_an_registration_VaccumP" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Forceps->Visible) { // Forceps ?>
	<div id="r_Forceps" class="form-group row">
		<label id="elh_patient_an_registration_Forceps" for="x_Forceps" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Forceps" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Forceps->caption() ?><?php echo ($patient_an_registration->Forceps->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Forceps->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Forceps" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ForcepsS->Visible) { // ForcepsS ?>
	<div id="r_ForcepsS" class="form-group row">
		<label id="elh_patient_an_registration_ForcepsS" for="x_ForcepsS" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ForcepsS" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ForcepsS->caption() ?><?php echo ($patient_an_registration->ForcepsS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ForcepsS->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ForcepsS" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ForcepsP->Visible) { // ForcepsP ?>
	<div id="r_ForcepsP" class="form-group row">
		<label id="elh_patient_an_registration_ForcepsP" for="x_ForcepsP" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ForcepsP" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ForcepsP->caption() ?><?php echo ($patient_an_registration->ForcepsP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ForcepsP->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ForcepsP" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Elective->Visible) { // Elective ?>
	<div id="r_Elective" class="form-group row">
		<label id="elh_patient_an_registration_Elective" for="x_Elective" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Elective" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Elective->caption() ?><?php echo ($patient_an_registration->Elective->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Elective->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Elective" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ElectiveS->Visible) { // ElectiveS ?>
	<div id="r_ElectiveS" class="form-group row">
		<label id="elh_patient_an_registration_ElectiveS" for="x_ElectiveS" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ElectiveS" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ElectiveS->caption() ?><?php echo ($patient_an_registration->ElectiveS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ElectiveS->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ElectiveS" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ElectiveP->Visible) { // ElectiveP ?>
	<div id="r_ElectiveP" class="form-group row">
		<label id="elh_patient_an_registration_ElectiveP" for="x_ElectiveP" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ElectiveP" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ElectiveP->caption() ?><?php echo ($patient_an_registration->ElectiveP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ElectiveP->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ElectiveP" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Emergency->Visible) { // Emergency ?>
	<div id="r_Emergency" class="form-group row">
		<label id="elh_patient_an_registration_Emergency" for="x_Emergency" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Emergency" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Emergency->caption() ?><?php echo ($patient_an_registration->Emergency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Emergency->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Emergency" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->EmergencyS->Visible) { // EmergencyS ?>
	<div id="r_EmergencyS" class="form-group row">
		<label id="elh_patient_an_registration_EmergencyS" for="x_EmergencyS" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_EmergencyS" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->EmergencyS->caption() ?><?php echo ($patient_an_registration->EmergencyS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->EmergencyS->cellAttributes() ?>>
<script id="tpx_patient_an_registration_EmergencyS" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->EmergencyP->Visible) { // EmergencyP ?>
	<div id="r_EmergencyP" class="form-group row">
		<label id="elh_patient_an_registration_EmergencyP" for="x_EmergencyP" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_EmergencyP" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->EmergencyP->caption() ?><?php echo ($patient_an_registration->EmergencyP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->EmergencyP->cellAttributes() ?>>
<script id="tpx_patient_an_registration_EmergencyP" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Maturity->Visible) { // Maturity ?>
	<div id="r_Maturity" class="form-group row">
		<label id="elh_patient_an_registration_Maturity" for="x_Maturity" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Maturity" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Maturity->caption() ?><?php echo ($patient_an_registration->Maturity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Maturity->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Maturity" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Baby1->Visible) { // Baby1 ?>
	<div id="r_Baby1" class="form-group row">
		<label id="elh_patient_an_registration_Baby1" for="x_Baby1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Baby1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Baby1->caption() ?><?php echo ($patient_an_registration->Baby1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Baby1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Baby1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Baby2->Visible) { // Baby2 ?>
	<div id="r_Baby2" class="form-group row">
		<label id="elh_patient_an_registration_Baby2" for="x_Baby2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Baby2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Baby2->caption() ?><?php echo ($patient_an_registration->Baby2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Baby2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Baby2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->sex1->Visible) { // sex1 ?>
	<div id="r_sex1" class="form-group row">
		<label id="elh_patient_an_registration_sex1" for="x_sex1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_sex1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->sex1->caption() ?><?php echo ($patient_an_registration->sex1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->sex1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_sex1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->sex2->Visible) { // sex2 ?>
	<div id="r_sex2" class="form-group row">
		<label id="elh_patient_an_registration_sex2" for="x_sex2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_sex2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->sex2->caption() ?><?php echo ($patient_an_registration->sex2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->sex2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_sex2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->weight1->Visible) { // weight1 ?>
	<div id="r_weight1" class="form-group row">
		<label id="elh_patient_an_registration_weight1" for="x_weight1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_weight1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->weight1->caption() ?><?php echo ($patient_an_registration->weight1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->weight1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_weight1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->weight2->Visible) { // weight2 ?>
	<div id="r_weight2" class="form-group row">
		<label id="elh_patient_an_registration_weight2" for="x_weight2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_weight2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->weight2->caption() ?><?php echo ($patient_an_registration->weight2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->weight2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_weight2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NICU1->Visible) { // NICU1 ?>
	<div id="r_NICU1" class="form-group row">
		<label id="elh_patient_an_registration_NICU1" for="x_NICU1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NICU1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NICU1->caption() ?><?php echo ($patient_an_registration->NICU1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NICU1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NICU1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->NICU2->Visible) { // NICU2 ?>
	<div id="r_NICU2" class="form-group row">
		<label id="elh_patient_an_registration_NICU2" for="x_NICU2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_NICU2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->NICU2->caption() ?><?php echo ($patient_an_registration->NICU2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->NICU2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_NICU2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Jaundice1->Visible) { // Jaundice1 ?>
	<div id="r_Jaundice1" class="form-group row">
		<label id="elh_patient_an_registration_Jaundice1" for="x_Jaundice1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Jaundice1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Jaundice1->caption() ?><?php echo ($patient_an_registration->Jaundice1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Jaundice1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Jaundice1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Jaundice2->Visible) { // Jaundice2 ?>
	<div id="r_Jaundice2" class="form-group row">
		<label id="elh_patient_an_registration_Jaundice2" for="x_Jaundice2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Jaundice2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Jaundice2->caption() ?><?php echo ($patient_an_registration->Jaundice2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Jaundice2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Jaundice2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Others1->Visible) { // Others1 ?>
	<div id="r_Others1" class="form-group row">
		<label id="elh_patient_an_registration_Others1" for="x_Others1" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Others1" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Others1->caption() ?><?php echo ($patient_an_registration->Others1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Others1->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Others1" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->Others2->Visible) { // Others2 ?>
	<div id="r_Others2" class="form-group row">
		<label id="elh_patient_an_registration_Others2" for="x_Others2" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_Others2" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->Others2->caption() ?><?php echo ($patient_an_registration->Others2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->Others2->cellAttributes() ?>>
<script id="tpx_patient_an_registration_Others2" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->SpillOverReasons->Visible) { // SpillOverReasons ?>
	<div id="r_SpillOverReasons" class="form-group row">
		<label id="elh_patient_an_registration_SpillOverReasons" for="x_SpillOverReasons" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_SpillOverReasons" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->SpillOverReasons->caption() ?><?php echo ($patient_an_registration->SpillOverReasons->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->SpillOverReasons->cellAttributes() ?>>
<script id="tpx_patient_an_registration_SpillOverReasons" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ANClosed->Visible) { // ANClosed ?>
	<div id="r_ANClosed" class="form-group row">
		<label id="elh_patient_an_registration_ANClosed" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ANClosed" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ANClosed->caption() ?><?php echo ($patient_an_registration->ANClosed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ANClosed->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ANClosed" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ANClosedDATE->Visible) { // ANClosedDATE ?>
	<div id="r_ANClosedDATE" class="form-group row">
		<label id="elh_patient_an_registration_ANClosedDATE" for="x_ANClosedDATE" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ANClosedDATE" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ANClosedDATE->caption() ?><?php echo ($patient_an_registration->ANClosedDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ANClosedDATE->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ANClosedDATE" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PastMedicalHistoryOthers->Visible) { // PastMedicalHistoryOthers ?>
	<div id="r_PastMedicalHistoryOthers" class="form-group row">
		<label id="elh_patient_an_registration_PastMedicalHistoryOthers" for="x_PastMedicalHistoryOthers" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PastMedicalHistoryOthers" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PastMedicalHistoryOthers->caption() ?><?php echo ($patient_an_registration->PastMedicalHistoryOthers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PastMedicalHistoryOthers->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PastMedicalHistoryOthers" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PastSurgicalHistoryOthers->Visible) { // PastSurgicalHistoryOthers ?>
	<div id="r_PastSurgicalHistoryOthers" class="form-group row">
		<label id="elh_patient_an_registration_PastSurgicalHistoryOthers" for="x_PastSurgicalHistoryOthers" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PastSurgicalHistoryOthers" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PastSurgicalHistoryOthers->caption() ?><?php echo ($patient_an_registration->PastSurgicalHistoryOthers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PastSurgicalHistoryOthers->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PastSurgicalHistoryOthers" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->FamilyHistoryOthers->Visible) { // FamilyHistoryOthers ?>
	<div id="r_FamilyHistoryOthers" class="form-group row">
		<label id="elh_patient_an_registration_FamilyHistoryOthers" for="x_FamilyHistoryOthers" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_FamilyHistoryOthers" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->FamilyHistoryOthers->caption() ?><?php echo ($patient_an_registration->FamilyHistoryOthers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->FamilyHistoryOthers->cellAttributes() ?>>
<script id="tpx_patient_an_registration_FamilyHistoryOthers" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->PresentPregnancyComplicationsOthers->Visible) { // PresentPregnancyComplicationsOthers ?>
	<div id="r_PresentPregnancyComplicationsOthers" class="form-group row">
		<label id="elh_patient_an_registration_PresentPregnancyComplicationsOthers" for="x_PresentPregnancyComplicationsOthers" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_PresentPregnancyComplicationsOthers" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->PresentPregnancyComplicationsOthers->caption() ?><?php echo ($patient_an_registration->PresentPregnancyComplicationsOthers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->PresentPregnancyComplicationsOthers->cellAttributes() ?>>
<script id="tpx_patient_an_registration_PresentPregnancyComplicationsOthers" class="patient_an_registrationadd" type="text/html">
...
<?php if ($patient_an_registration->ETdate->Visible) { // ETdate ?>
	<div id="r_ETdate" class="form-group row">
		<label id="elh_patient_an_registration_ETdate" for="x_ETdate" class="<?php echo $patient_an_registration_add->LeftColumnClass ?>"><script id="tpc_patient_an_registration_ETdate" class="patient_an_registrationadd" type="text/html"><span><?php echo $patient_an_registration->ETdate->caption() ?><?php echo ($patient_an_registration->ETdate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_an_registration_add->RightColumnClass ?>"><div<?php echo $patient_an_registration->ETdate->cellAttributes() ?>>
<script id="tpx_patient_an_registration_ETdate" class="patient_an_registrationadd" type="text/html">
...
ew.applyTemplate("tpd_patient_an_registrationadd", "tpm_patient_an_registrationadd", "patient_an_registrationadd", "<?php echo $patient_an_registration->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_an_registrationadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
