...
var fivf_oocytedenudationadd = currentForm = new ew.Form("fivf_oocytedenudationadd", "add");
...
fivf_oocytedenudationadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($ivf_oocytedenudation_add->donor->Required) { ?>
...
fivf_oocytedenudationadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_oocytedenudationadd.lists["x_patient2"] = <?php echo $ivf_oocytedenudation_add->patient2->Lookup->toClientList() ?>;
fivf_oocytedenudationadd.lists["x_patient2"].options = <?php echo JsonEncode($ivf_oocytedenudation_add->patient2->lookupOptions()) ?>;
fivf_oocytedenudationadd.lists["x_OocyteOrgin"] = <?php echo $ivf_oocytedenudation_add->OocyteOrgin->Lookup->toClientList() ?>;
...
fivf_oocytedenudationadd.lists["x_patient1"] = <?php echo $ivf_oocytedenudation_add->patient1->Lookup->toClientList() ?>;
fivf_oocytedenudationadd.lists["x_patient1"].options = <?php echo JsonEncode($ivf_oocytedenudation_add->patient1->lookupOptions()) ?>;
fivf_oocytedenudationadd.lists["x_OocyteType[]"] = <?php echo $ivf_oocytedenudation_add->OocyteType->Lookup->toClientList() ?>;
...
fivf_oocytedenudationadd.lists["x_patient3"] = <?php echo $ivf_oocytedenudation_add->patient3->Lookup->toClientList() ?>;
fivf_oocytedenudationadd.lists["x_patient3"].options = <?php echo JsonEncode($ivf_oocytedenudation_add->patient3->lookupOptions()) ?>;
fivf_oocytedenudationadd.lists["x_patient4"] = <?php echo $ivf_oocytedenudation_add->patient4->Lookup->toClientList() ?>;
...
<?php if ($ivf_oocytedenudation_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_oocytedenudation_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_oocytedenudation->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_oocytedenudation_RIDNo" for="x_RIDNo" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_RIDNo" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->RIDNo->caption() ?><?php echo ($ivf_oocytedenudation->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->RIDNo->cellAttributes() ?>>
<?php if ($ivf_oocytedenudation->RIDNo->getSessionValue() <> "") { ?>
<script id="tpx_ivf_oocytedenudation_RIDNo" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_oocytedenudation_Name" for="x_Name" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_Name" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->Name->caption() ?><?php echo ($ivf_oocytedenudation->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->Name->cellAttributes() ?>>
<?php if ($ivf_oocytedenudation->Name->getSessionValue() <> "") { ?>
<script id="tpx_ivf_oocytedenudation_Name" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->ResultDate->Visible) { // ResultDate ?>
	<div id="r_ResultDate" class="form-group row">
		<label id="elh_ivf_oocytedenudation_ResultDate" for="x_ResultDate" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_ResultDate" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->ResultDate->caption() ?><?php echo ($ivf_oocytedenudation->ResultDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->ResultDate->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_ResultDate" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->Surgeon->Visible) { // Surgeon ?>
	<div id="r_Surgeon" class="form-group row">
		<label id="elh_ivf_oocytedenudation_Surgeon" for="x_Surgeon" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_Surgeon" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->Surgeon->caption() ?><?php echo ($ivf_oocytedenudation->Surgeon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->Surgeon->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_Surgeon" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->AsstSurgeon->Visible) { // AsstSurgeon ?>
	<div id="r_AsstSurgeon" class="form-group row">
		<label id="elh_ivf_oocytedenudation_AsstSurgeon" for="x_AsstSurgeon" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_AsstSurgeon" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->AsstSurgeon->caption() ?><?php echo ($ivf_oocytedenudation->AsstSurgeon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->AsstSurgeon->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_AsstSurgeon" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->Anaesthetist->Visible) { // Anaesthetist ?>
	<div id="r_Anaesthetist" class="form-group row">
		<label id="elh_ivf_oocytedenudation_Anaesthetist" for="x_Anaesthetist" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_Anaesthetist" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->Anaesthetist->caption() ?><?php echo ($ivf_oocytedenudation->Anaesthetist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->Anaesthetist->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_Anaesthetist" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->AnaestheiaType->Visible) { // AnaestheiaType ?>
	<div id="r_AnaestheiaType" class="form-group row">
		<label id="elh_ivf_oocytedenudation_AnaestheiaType" for="x_AnaestheiaType" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_AnaestheiaType" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->AnaestheiaType->caption() ?><?php echo ($ivf_oocytedenudation->AnaestheiaType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->AnaestheiaType->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_AnaestheiaType" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->PrimaryEmbryologist->Visible) { // PrimaryEmbryologist ?>
	<div id="r_PrimaryEmbryologist" class="form-group row">
		<label id="elh_ivf_oocytedenudation_PrimaryEmbryologist" for="x_PrimaryEmbryologist" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_PrimaryEmbryologist" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->PrimaryEmbryologist->caption() ?><?php echo ($ivf_oocytedenudation->PrimaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->PrimaryEmbryologist->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_PrimaryEmbryologist" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OPUNotes->Visible) { // OPUNotes ?>
	<div id="r_OPUNotes" class="form-group row">
		<label id="elh_ivf_oocytedenudation_OPUNotes" for="x_OPUNotes" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OPUNotes" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->OPUNotes->caption() ?><?php echo ($ivf_oocytedenudation->OPUNotes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OPUNotes->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OPUNotes" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->NoOfFolliclesRight->Visible) { // NoOfFolliclesRight ?>
	<div id="r_NoOfFolliclesRight" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->NoOfFolliclesRight->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_NoOfFolliclesRight" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->NoOfFolliclesLeft->Visible) { // NoOfFolliclesLeft ?>
	<div id="r_NoOfFolliclesLeft" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->NoOfFolliclesLeft->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_NoOfFolliclesLeft" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->NoOfOocytes->Visible) { // NoOfOocytes ?>
	<div id="r_NoOfOocytes" class="form-group row">
		<label id="elh_ivf_oocytedenudation_NoOfOocytes" for="x_NoOfOocytes" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_NoOfOocytes" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->NoOfOocytes->caption() ?><?php echo ($ivf_oocytedenudation->NoOfOocytes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->NoOfOocytes->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_NoOfOocytes" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->RecordOocyteDenudation->Visible) { // RecordOocyteDenudation ?>
	<div id="r_RecordOocyteDenudation" class="form-group row">
		<label id="elh_ivf_oocytedenudation_RecordOocyteDenudation" for="x_RecordOocyteDenudation" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_RecordOocyteDenudation" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->RecordOocyteDenudation->caption() ?><?php echo ($ivf_oocytedenudation->RecordOocyteDenudation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->RecordOocyteDenudation->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_RecordOocyteDenudation" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->DateOfDenudation->Visible) { // DateOfDenudation ?>
	<div id="r_DateOfDenudation" class="form-group row">
		<label id="elh_ivf_oocytedenudation_DateOfDenudation" for="x_DateOfDenudation" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_DateOfDenudation" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->DateOfDenudation->caption() ?><?php echo ($ivf_oocytedenudation->DateOfDenudation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->DateOfDenudation->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_DateOfDenudation" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->DenudationDoneBy->Visible) { // DenudationDoneBy ?>
	<div id="r_DenudationDoneBy" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->DenudationDoneBy->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_DenudationDoneBy" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_ivf_oocytedenudation_status" for="x_status" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_status" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->status->caption() ?><?php echo ($ivf_oocytedenudation->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->status->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_status" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_oocytedenudation_TidNo" for="x_TidNo" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_TidNo" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->TidNo->caption() ?><?php echo ($ivf_oocytedenudation->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->TidNo->cellAttributes() ?>>
<?php if ($ivf_oocytedenudation->TidNo->getSessionValue() <> "") { ?>
<script id="tpx_ivf_oocytedenudation_TidNo" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->ExpFollicles->Visible) { // ExpFollicles ?>
	<div id="r_ExpFollicles" class="form-group row">
		<label id="elh_ivf_oocytedenudation_ExpFollicles" for="x_ExpFollicles" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_ExpFollicles" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->ExpFollicles->caption() ?><?php echo ($ivf_oocytedenudation->ExpFollicles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->ExpFollicles->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_ExpFollicles" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->SecondaryDenudationDoneBy->Visible) { // SecondaryDenudationDoneBy ?>
	<div id="r_SecondaryDenudationDoneBy" class="form-group row">
		<label id="elh_ivf_oocytedenudation_SecondaryDenudationDoneBy" for="x_SecondaryDenudationDoneBy" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SecondaryDenudationDoneBy" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->SecondaryDenudationDoneBy->caption() ?><?php echo ($ivf_oocytedenudation->SecondaryDenudationDoneBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->SecondaryDenudationDoneBy->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_SecondaryDenudationDoneBy" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->patient2->Visible) { // patient2 ?>
	<div id="r_patient2" class="form-group row">
		<label id="elh_ivf_oocytedenudation_patient2" for="x_patient2" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_patient2" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->patient2->caption() ?><?php echo ($ivf_oocytedenudation->patient2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->patient2->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_patient2" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OocytesDonate1->Visible) { // OocytesDonate1 ?>
	<div id="r_OocytesDonate1" class="form-group row">
		<label id="elh_ivf_oocytedenudation_OocytesDonate1" for="x_OocytesDonate1" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocytesDonate1" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->OocytesDonate1->caption() ?><?php echo ($ivf_oocytedenudation->OocytesDonate1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OocytesDonate1->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OocytesDonate1" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OocytesDonate2->Visible) { // OocytesDonate2 ?>
	<div id="r_OocytesDonate2" class="form-group row">
		<label id="elh_ivf_oocytedenudation_OocytesDonate2" for="x_OocytesDonate2" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocytesDonate2" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->OocytesDonate2->caption() ?><?php echo ($ivf_oocytedenudation->OocytesDonate2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OocytesDonate2->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OocytesDonate2" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->ETDonate->Visible) { // ETDonate ?>
	<div id="r_ETDonate" class="form-group row">
		<label id="elh_ivf_oocytedenudation_ETDonate" for="x_ETDonate" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_ETDonate" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->ETDonate->caption() ?><?php echo ($ivf_oocytedenudation->ETDonate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->ETDonate->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_ETDonate" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OocyteOrgin->Visible) { // OocyteOrgin ?>
	<div id="r_OocyteOrgin" class="form-group row">
		<label id="elh_ivf_oocytedenudation_OocyteOrgin" for="x_OocyteOrgin" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocyteOrgin" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->OocyteOrgin->caption() ?><?php echo ($ivf_oocytedenudation->OocyteOrgin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OocyteOrgin->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OocyteOrgin" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->patient1->Visible) { // patient1 ?>
	<div id="r_patient1" class="form-group row">
		<label id="elh_ivf_oocytedenudation_patient1" for="x_patient1" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_patient1" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->patient1->caption() ?><?php echo ($ivf_oocytedenudation->patient1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->patient1->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_patient1" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OocyteType->Visible) { // OocyteType ?>
	<div id="r_OocyteType" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OocyteType->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OocyteType" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->MIOocytesDonate1->Visible) { // MIOocytesDonate1 ?>
	<div id="r_MIOocytesDonate1" class="form-group row">
		<label id="elh_ivf_oocytedenudation_MIOocytesDonate1" for="x_MIOocytesDonate1" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate1" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->MIOocytesDonate1->caption() ?><?php echo ($ivf_oocytedenudation->MIOocytesDonate1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->MIOocytesDonate1->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_MIOocytesDonate1" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->MIOocytesDonate2->Visible) { // MIOocytesDonate2 ?>
	<div id="r_MIOocytesDonate2" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->MIOocytesDonate2->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_MIOocytesDonate2" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->SelfMI->Visible) { // SelfMI ?>
	<div id="r_SelfMI" class="form-group row">
		<label id="elh_ivf_oocytedenudation_SelfMI" for="x_SelfMI" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SelfMI" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->SelfMI->caption() ?><?php echo ($ivf_oocytedenudation->SelfMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->SelfMI->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_SelfMI" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->SelfMII->Visible) { // SelfMII ?>
	<div id="r_SelfMII" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->SelfMII->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_SelfMII" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->patient3->Visible) { // patient3 ?>
	<div id="r_patient3" class="form-group row">
		<label id="elh_ivf_oocytedenudation_patient3" for="x_patient3" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_patient3" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->patient3->caption() ?><?php echo ($ivf_oocytedenudation->patient3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->patient3->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_patient3" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->patient4->Visible) { // patient4 ?>
	<div id="r_patient4" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->patient4->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_patient4" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OocytesDonate3->Visible) { // OocytesDonate3 ?>
	<div id="r_OocytesDonate3" class="form-group row">
		<label id="elh_ivf_oocytedenudation_OocytesDonate3" for="x_OocytesDonate3" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocytesDonate3" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->OocytesDonate3->caption() ?><?php echo ($ivf_oocytedenudation->OocytesDonate3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OocytesDonate3->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OocytesDonate3" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->OocytesDonate4->Visible) { // OocytesDonate4 ?>
	<div id="r_OocytesDonate4" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->OocytesDonate4->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_OocytesDonate4" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->MIOocytesDonate3->Visible) { // MIOocytesDonate3 ?>
	<div id="r_MIOocytesDonate3" class="form-group row">
		<label id="elh_ivf_oocytedenudation_MIOocytesDonate3" for="x_MIOocytesDonate3" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate3" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->MIOocytesDonate3->caption() ?><?php echo ($ivf_oocytedenudation->MIOocytesDonate3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->MIOocytesDonate3->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_MIOocytesDonate3" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->MIOocytesDonate4->Visible) { // MIOocytesDonate4 ?>
	<div id="r_MIOocytesDonate4" class="form-group row">
		<label id="elh_ivf_oocytedenudation_MIOocytesDonate4" for="x_MIOocytesDonate4" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate4" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->MIOocytesDonate4->caption() ?><?php echo ($ivf_oocytedenudation->MIOocytesDonate4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->MIOocytesDonate4->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_MIOocytesDonate4" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->SelfOocytesMI->Visible) { // SelfOocytesMI ?>
	<div id="r_SelfOocytesMI" class="form-group row">
		<label id="elh_ivf_oocytedenudation_SelfOocytesMI" for="x_SelfOocytesMI" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SelfOocytesMI" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->SelfOocytesMI->caption() ?><?php echo ($ivf_oocytedenudation->SelfOocytesMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->SelfOocytesMI->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_SelfOocytesMI" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->SelfOocytesMII->Visible) { // SelfOocytesMII ?>
	<div id="r_SelfOocytesMII" class="form-group row">
		...
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->SelfOocytesMII->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_SelfOocytesMII" class="ivf_oocytedenudationadd" type="text/html">
...
<?php if ($ivf_oocytedenudation->donor->Visible) { // donor ?>
	<div id="r_donor" class="form-group row">
		<label id="elh_ivf_oocytedenudation_donor" for="x_donor" class="<?php echo $ivf_oocytedenudation_add->LeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_donor" class="ivf_oocytedenudationadd" type="text/html"><span><?php echo $ivf_oocytedenudation->donor->caption() ?><?php echo ($ivf_oocytedenudation->donor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_oocytedenudation_add->RightColumnClass ?>"><div<?php echo $ivf_oocytedenudation->donor->cellAttributes() ?>>
<script id="tpx_ivf_oocytedenudation_donor" class="ivf_oocytedenudationadd" type="text/html">
...
ew.applyTemplate("tpd_ivf_oocytedenudationadd", "tpm_ivf_oocytedenudationadd", "ivf_oocytedenudationadd", "<?php echo $ivf_oocytedenudation->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_oocytedenudationadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
