...
var fmas_employee_role_job_descriptionedit = currentForm = new ew.Form("fmas_employee_role_job_descriptionedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($mas_employee_role_job_description_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $mas_employee_role_job_description->id->caption(), $mas_employee_role_job_description->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php if ($mas_employee_role_job_description_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $mas_employee_role_job_description->modifiedby->caption(), $mas_employee_role_job_description->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($mas_employee_role_job_description_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $mas_employee_role_job_description->modifieddatetime->caption(), $mas_employee_role_job_description->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fmas_employee_role_job_descriptionedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmas_employee_role_job_descriptionedit.lists["x_status"] = <?php echo $mas_employee_role_job_description_edit->status->Lookup->toClientList() ?>;
...
<?php if ($mas_employee_role_job_description_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_employee_role_job_description_edit->Token ?>">
<?php } ?>
...
<?php if ($mas_employee_role_job_description->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_mas_employee_role_job_description_id" class="<?php echo $mas_employee_role_job_description_edit->LeftColumnClass ?>"><?php echo $mas_employee_role_job_description->id->caption() ?><?php echo ($mas_employee_role_job_description->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_employee_role_job_description_edit->RightColumnClass ?>"><div<?php echo $mas_employee_role_job_description->id->cellAttributes() ?>>
<span id="el_mas_employee_role_job_description_id">
<span<?php echo $mas_employee_role_job_description->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($mas_employee_role_job_description->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="mas_employee_role_job_description" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($mas_employee_role_job_description->id->CurrentValue) ?>">
<?php echo $mas_employee_role_job_description->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($mas_employee_role_job_description->role->Visible) { // role ?>
	<div id="r_role" class="form-group row">
		<label id="elh_mas_employee_role_job_description_role" for="x_role" class="<?php echo $mas_employee_role_job_description_edit->LeftColumnClass ?>"><?php echo $mas_employee_role_job_description->role->caption() ?><?php echo ($mas_employee_role_job_description->role->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_employee_role_job_description_edit->RightColumnClass ?>"><div<?php echo $mas_employee_role_job_description->role->cellAttributes() ?>>
...
<?php if ($mas_employee_role_job_description->job_description->Visible) { // job_description ?>
	<div id="r_job_description" class="form-group row">
		<label id="elh_mas_employee_role_job_description_job_description" for="x_job_description" class="<?php echo $mas_employee_role_job_description_edit->LeftColumnClass ?>"><?php echo $mas_employee_role_job_description->job_description->caption() ?><?php echo ($mas_employee_role_job_description->job_description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_employee_role_job_description_edit->RightColumnClass ?>"><div<?php echo $mas_employee_role_job_description->job_description->cellAttributes() ?>>
...
<?php if ($mas_employee_role_job_description->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_mas_employee_role_job_description_status" for="x_status" class="<?php echo $mas_employee_role_job_description_edit->LeftColumnClass ?>"><?php echo $mas_employee_role_job_description->status->caption() ?><?php echo ($mas_employee_role_job_description->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_employee_role_job_description_edit->RightColumnClass ?>"><div<?php echo $mas_employee_role_job_description->status->cellAttributes() ?>>
