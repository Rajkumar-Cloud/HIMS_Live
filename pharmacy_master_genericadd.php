...
var fpharmacy_master_genericadd = currentForm = new ew.Form("fpharmacy_master_genericadd", "add");
...
fpharmacy_master_genericadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_master_genericadd.lists["x_GRPCODE"] = <?php echo $pharmacy_master_generic_add->GRPCODE->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_master_generic_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_master_generic_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_master_generic->GENNAME->Visible) { // GENNAME ?>
	<div id="r_GENNAME" class="form-group row">
		<label id="elh_pharmacy_master_generic_GENNAME" for="x_GENNAME" class="<?php echo $pharmacy_master_generic_add->LeftColumnClass ?>"><?php echo $pharmacy_master_generic->GENNAME->caption() ?><?php echo ($pharmacy_master_generic->GENNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_master_generic_add->RightColumnClass ?>"><div<?php echo $pharmacy_master_generic->GENNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_master_generic->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_pharmacy_master_generic_CODE" for="x_CODE" class="<?php echo $pharmacy_master_generic_add->LeftColumnClass ?>"><?php echo $pharmacy_master_generic->CODE->caption() ?><?php echo ($pharmacy_master_generic->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_master_generic_add->RightColumnClass ?>"><div<?php echo $pharmacy_master_generic->CODE->cellAttributes() ?>>
...
<?php if ($pharmacy_master_generic->GRPCODE->Visible) { // GRPCODE ?>
	<div id="r_GRPCODE" class="form-group row">
		<label id="elh_pharmacy_master_generic_GRPCODE" for="x_GRPCODE" class="<?php echo $pharmacy_master_generic_add->LeftColumnClass ?>"><?php echo $pharmacy_master_generic->GRPCODE->caption() ?><?php echo ($pharmacy_master_generic->GRPCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_master_generic_add->RightColumnClass ?>"><div<?php echo $pharmacy_master_generic->GRPCODE->cellAttributes() ?>>
