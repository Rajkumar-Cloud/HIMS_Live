...
var fbanktransfertoedit = currentForm = new ew.Form("fbanktransfertoedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($banktransferto_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $banktransferto->id->caption(), $banktransferto->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fbanktransfertoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($banktransferto_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $banktransferto_edit->Token ?>">
<?php } ?>
...
<?php if ($banktransferto->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_banktransferto_id" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->id->caption() ?><?php echo ($banktransferto->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->id->cellAttributes() ?>>
<span id="el_banktransferto_id">
<span<?php echo $banktransferto->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($banktransferto->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="banktransferto" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($banktransferto->id->CurrentValue) ?>">
<?php echo $banktransferto->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($banktransferto->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_banktransferto_Name" for="x_Name" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->Name->caption() ?><?php echo ($banktransferto->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->Name->cellAttributes() ?>>
...
<?php if ($banktransferto->Street_Address->Visible) { // Street_Address ?>
	<div id="r_Street_Address" class="form-group row">
		<label id="elh_banktransferto_Street_Address" for="x_Street_Address" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->Street_Address->caption() ?><?php echo ($banktransferto->Street_Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->Street_Address->cellAttributes() ?>>
...
<?php if ($banktransferto->City->Visible) { // City ?>
	<div id="r_City" class="form-group row">
		<label id="elh_banktransferto_City" for="x_City" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->City->caption() ?><?php echo ($banktransferto->City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->City->cellAttributes() ?>>
...
<?php if ($banktransferto->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_banktransferto_State" for="x_State" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->State->caption() ?><?php echo ($banktransferto->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->State->cellAttributes() ?>>
...
<?php if ($banktransferto->Zipcode->Visible) { // Zipcode ?>
	<div id="r_Zipcode" class="form-group row">
		<label id="elh_banktransferto_Zipcode" for="x_Zipcode" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->Zipcode->caption() ?><?php echo ($banktransferto->Zipcode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->Zipcode->cellAttributes() ?>>
...
<?php if ($banktransferto->Mobile_Number->Visible) { // Mobile_Number ?>
	<div id="r_Mobile_Number" class="form-group row">
		<label id="elh_banktransferto_Mobile_Number" for="x_Mobile_Number" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->Mobile_Number->caption() ?><?php echo ($banktransferto->Mobile_Number->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->Mobile_Number->cellAttributes() ?>>
...
<?php if ($banktransferto->AccountNo->Visible) { // AccountNo ?>
	<div id="r_AccountNo" class="form-group row">
		<label id="elh_banktransferto_AccountNo" for="x_AccountNo" class="<?php echo $banktransferto_edit->LeftColumnClass ?>"><?php echo $banktransferto->AccountNo->caption() ?><?php echo ($banktransferto->AccountNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $banktransferto_edit->RightColumnClass ?>"><div<?php echo $banktransferto->AccountNo->cellAttributes() ?>>
