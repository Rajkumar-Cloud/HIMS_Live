...
var fpatient_historyadd = currentForm = new ew.Form("fpatient_historyadd", "add");
...
fpatient_historyadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_historyadd.lists["x_PatientSearch"] = <?php echo $patient_history_add->PatientSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_history_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_history_add->Token ?>">
<?php } ?>
...
<?php if ($patient_history->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_history_mrnno" for="x_mrnno" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_mrnno" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->mrnno->caption() ?><?php echo ($patient_history->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->mrnno->cellAttributes() ?>>
<?php if ($patient_history->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_history_mrnno" class="patient_historyadd" type="text/html">
...
<input type="hidden" id="x_mrnno" name="x_mrnno" value="<?php echo HtmlEncode($patient_history->mrnno->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_history_mrnno" class="patient_historyadd" type="text/html">
<span id="el_patient_history_mrnno">
...
<?php if ($patient_history->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_history_PatientName" for="x_PatientName" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_PatientName" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->PatientName->caption() ?><?php echo ($patient_history->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->PatientName->cellAttributes() ?>>
<script id="tpx_patient_history_PatientName" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_history_PatientId" for="x_PatientId" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_PatientId" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->PatientId->caption() ?><?php echo ($patient_history->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->PatientId->cellAttributes() ?>>
<?php if ($patient_history->PatientId->getSessionValue() <> "") { ?>
<script id="tpx_patient_history_PatientId" class="patient_historyadd" type="text/html">
...
<input type="hidden" id="x_PatientId" name="x_PatientId" value="<?php echo HtmlEncode($patient_history->PatientId->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_history_PatientId" class="patient_historyadd" type="text/html">
<span id="el_patient_history_PatientId">
...
<?php if ($patient_history->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_history_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_MobileNumber" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->MobileNumber->caption() ?><?php echo ($patient_history->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_history_MobileNumber" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->MaritalHistory->Visible) { // MaritalHistory ?>
	<div id="r_MaritalHistory" class="form-group row">
		<label id="elh_patient_history_MaritalHistory" for="x_MaritalHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_MaritalHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->MaritalHistory->caption() ?><?php echo ($patient_history->MaritalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->MaritalHistory->cellAttributes() ?>>
<script id="tpx_patient_history_MaritalHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->MenstrualHistory->Visible) { // MenstrualHistory ?>
	<div id="r_MenstrualHistory" class="form-group row">
		<label id="elh_patient_history_MenstrualHistory" for="x_MenstrualHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_MenstrualHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->MenstrualHistory->caption() ?><?php echo ($patient_history->MenstrualHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->MenstrualHistory->cellAttributes() ?>>
<script id="tpx_patient_history_MenstrualHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->ObstetricHistory->Visible) { // ObstetricHistory ?>
	<div id="r_ObstetricHistory" class="form-group row">
		<label id="elh_patient_history_ObstetricHistory" for="x_ObstetricHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_ObstetricHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->ObstetricHistory->caption() ?><?php echo ($patient_history->ObstetricHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->ObstetricHistory->cellAttributes() ?>>
<script id="tpx_patient_history_ObstetricHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->MedicalHistory->Visible) { // MedicalHistory ?>
	<div id="r_MedicalHistory" class="form-group row">
		<label id="elh_patient_history_MedicalHistory" for="x_MedicalHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_MedicalHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->MedicalHistory->caption() ?><?php echo ($patient_history->MedicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->MedicalHistory->cellAttributes() ?>>
<script id="tpx_patient_history_MedicalHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->SurgicalHistory->Visible) { // SurgicalHistory ?>
	<div id="r_SurgicalHistory" class="form-group row">
		<label id="elh_patient_history_SurgicalHistory" for="x_SurgicalHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_SurgicalHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->SurgicalHistory->caption() ?><?php echo ($patient_history->SurgicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->SurgicalHistory->cellAttributes() ?>>
<script id="tpx_patient_history_SurgicalHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->PastHistory->Visible) { // PastHistory ?>
	<div id="r_PastHistory" class="form-group row">
		<label id="elh_patient_history_PastHistory" for="x_PastHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_PastHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->PastHistory->caption() ?><?php echo ($patient_history->PastHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->PastHistory->cellAttributes() ?>>
<script id="tpx_patient_history_PastHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->TreatmentHistory->Visible) { // TreatmentHistory ?>
	<div id="r_TreatmentHistory" class="form-group row">
		<label id="elh_patient_history_TreatmentHistory" for="x_TreatmentHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_TreatmentHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->TreatmentHistory->caption() ?><?php echo ($patient_history->TreatmentHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->TreatmentHistory->cellAttributes() ?>>
<script id="tpx_patient_history_TreatmentHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->FamilyHistory->Visible) { // FamilyHistory ?>
	<div id="r_FamilyHistory" class="form-group row">
		<label id="elh_patient_history_FamilyHistory" for="x_FamilyHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_FamilyHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->FamilyHistory->caption() ?><?php echo ($patient_history->FamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->FamilyHistory->cellAttributes() ?>>
<script id="tpx_patient_history_FamilyHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_history_Age" for="x_Age" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_Age" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->Age->caption() ?><?php echo ($patient_history->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->Age->cellAttributes() ?>>
<script id="tpx_patient_history_Age" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_history_Gender" for="x_Gender" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_Gender" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->Gender->caption() ?><?php echo ($patient_history->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->Gender->cellAttributes() ?>>
<script id="tpx_patient_history_Gender" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_history_profilePic" for="x_profilePic" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_profilePic" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->profilePic->caption() ?><?php echo ($patient_history->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->profilePic->cellAttributes() ?>>
<script id="tpx_patient_history_profilePic" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->Complaints->Visible) { // Complaints ?>
	<div id="r_Complaints" class="form-group row">
		<label id="elh_patient_history_Complaints" for="x_Complaints" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_Complaints" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->Complaints->caption() ?><?php echo ($patient_history->Complaints->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->Complaints->cellAttributes() ?>>
<script id="tpx_patient_history_Complaints" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->illness->Visible) { // illness ?>
	<div id="r_illness" class="form-group row">
		<label id="elh_patient_history_illness" for="x_illness" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_illness" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->illness->caption() ?><?php echo ($patient_history->illness->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->illness->cellAttributes() ?>>
<script id="tpx_patient_history_illness" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->PersonalHistory->Visible) { // PersonalHistory ?>
	<div id="r_PersonalHistory" class="form-group row">
		<label id="elh_patient_history_PersonalHistory" for="x_PersonalHistory" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_PersonalHistory" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->PersonalHistory->caption() ?><?php echo ($patient_history->PersonalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->PersonalHistory->cellAttributes() ?>>
<script id="tpx_patient_history_PersonalHistory" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_history_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_PatientSearch" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->PatientSearch->caption() ?><?php echo ($patient_history->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_history_PatientSearch" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_history_PatID" for="x_PatID" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_PatID" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->PatID->caption() ?><?php echo ($patient_history->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->PatID->cellAttributes() ?>>
<script id="tpx_patient_history_PatID" class="patient_historyadd" type="text/html">
...
<?php if ($patient_history->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_history_Reception" for="x_Reception" class="<?php echo $patient_history_add->LeftColumnClass ?>"><script id="tpc_patient_history_Reception" class="patient_historyadd" type="text/html"><span><?php echo $patient_history->Reception->caption() ?><?php echo ($patient_history->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_history_add->RightColumnClass ?>"><div<?php echo $patient_history->Reception->cellAttributes() ?>>
<?php if ($patient_history->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_history_Reception" class="patient_historyadd" type="text/html">
...
<input type="hidden" id="x_Reception" name="x_Reception" value="<?php echo HtmlEncode($patient_history->Reception->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_history_Reception" class="patient_historyadd" type="text/html">
<span id="el_patient_history_Reception">
...
{{include tmpl="#tpc_patient_history_PatientSearch"/}}&nbsp;{{include tmpl="#tpx_patient_history_PatientSearch"/}}	
...
ew.applyTemplate("tpd_patient_historyadd", "tpm_patient_historyadd", "patient_historyadd", "<?php echo $patient_history->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_historyadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
...
// document.write("page loaded");
 ...
 var c = document.getElementById("el_patient_history_profilePic").children;
 var d = c[0].children;
