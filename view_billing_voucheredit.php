...
var fview_billing_voucheredit = currentForm = new ew.Form("fview_billing_voucheredit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_billing_voucher_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_billing_voucher->id->caption(), $view_billing_voucher->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php } ?>
		<?php if ($view_billing_voucher_edit->DiscountAmount->Required) { ?>
		...
		<?php if ($view_billing_voucher_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_billing_voucher->modifiedby->caption(), $view_billing_voucher->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($view_billing_voucher_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_billing_voucher->modifieddatetime->caption(), $view_billing_voucher->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php } ?>
		<?php if ($view_billing_voucher_edit->CardType->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_billing_voucher_edit->PharmacyBill->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_billing_voucher_edit->cash->Required) { ?>
		...
		<?php if ($view_billing_voucher_edit->Card->Required) { ?>
...
fview_billing_voucheredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_billing_voucheredit.lists["x_Reception"] = <?php echo $view_billing_voucher_edit->Reception->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_ModeofPayment"] = <?php echo $view_billing_voucher_edit->ModeofPayment->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_CId"] = <?php echo $view_billing_voucher_edit->CId->Lookup->toClientList() ?>;
fview_billing_voucheredit.lists["x_CId"].options = <?php echo JsonEncode($view_billing_voucher_edit->CId->lookupOptions()) ?>;
fview_billing_voucheredit.lists["x_PatId"] = <?php echo $view_billing_voucher_edit->PatId->Lookup->toClientList() ?>;
fview_billing_voucheredit.lists["x_PatId"].options = <?php echo JsonEncode($view_billing_voucher_edit->PatId->lookupOptions()) ?>;
fview_billing_voucheredit.lists["x_RefferedBy"] = <?php echo $view_billing_voucher_edit->RefferedBy->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_DrID"] = <?php echo $view_billing_voucher_edit->DrID->Lookup->toClientList() ?>;
fview_billing_voucheredit.lists["x_DrID"].options = <?php echo JsonEncode($view_billing_voucher_edit->DrID->lookupOptions()) ?>;
fview_billing_voucheredit.lists["x_ReportHeader[]"] = <?php echo $view_billing_voucher_edit->ReportHeader->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_AdjustmentAdvance[]"] = <?php echo $view_billing_voucher_edit->AdjustmentAdvance->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_BillType"] = <?php echo $view_billing_voucher_edit->BillType->Lookup->toClientList() ?>;
fview_billing_voucheredit.lists["x_BillType"].options = <?php echo JsonEncode($view_billing_voucher_edit->BillType->options(FALSE, TRUE)) ?>;
fview_billing_voucheredit.lists["x_IncludePackage[]"] = <?php echo $view_billing_voucher_edit->IncludePackage->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_CancelBill"] = <?php echo $view_billing_voucher_edit->CancelBill->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_BillClosing[]"] = <?php echo $view_billing_voucher_edit->BillClosing->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_GoogleReviewID[]"] = <?php echo $view_billing_voucher_edit->GoogleReviewID->Lookup->toClientList() ?>;
...
fview_billing_voucheredit.lists["x_CardType"] = <?php echo $view_billing_voucher_edit->CardType->Lookup->toClientList() ?>;
fview_billing_voucheredit.lists["x_CardType"].options = <?php echo JsonEncode($view_billing_voucher_edit->CardType->options(FALSE, TRUE)) ?>;
fview_billing_voucheredit.lists["x_PharmacyBill[]"] = <?php echo $view_billing_voucher_edit->PharmacyBill->Lookup->toClientList() ?>;
fview_billing_voucheredit.lists["x_PharmacyBill[]"].options = <?php echo JsonEncode($view_billing_voucher_edit->PharmacyBill->options(FALSE, TRUE)) ?>;
...
<?php if ($view_billing_voucher_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_billing_voucher_edit->Token ?>">
<?php } ?>
...
<?php if ($view_billing_voucher->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_view_billing_voucher_id" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_id" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->id->caption() ?><?php echo ($view_billing_voucher->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->id->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_id" class="view_billing_voucheredit" type="text/html">
<span id="el_view_billing_voucher_id">
<span<?php echo $view_billing_voucher->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($view_billing_voucher->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="view_billing_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($view_billing_voucher->id->CurrentValue) ?>">
<?php echo $view_billing_voucher->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_billing_voucher->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_view_billing_voucher_createddatetime" for="x_createddatetime" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_createddatetime" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->createddatetime->caption() ?><?php echo ($view_billing_voucher->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->createddatetime->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_createddatetime" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_view_billing_voucher_BillNumber" for="x_BillNumber" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_BillNumber" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->BillNumber->caption() ?><?php echo ($view_billing_voucher->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->BillNumber->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_BillNumber" class="view_billing_voucheredit" type="text/html">
...
<input type="hidden" data-table="view_billing_voucher" data-field="x_BillNumber" name="x_BillNumber" id="x_BillNumber" value="<?php echo HtmlEncode($view_billing_voucher->BillNumber->CurrentValue) ?>">
<?php echo $view_billing_voucher->BillNumber->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_billing_voucher->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_view_billing_voucher_Reception" for="x_Reception" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Reception" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Reception->caption() ?><?php echo ($view_billing_voucher->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Reception->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Reception" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_view_billing_voucher_PatientId" for="x_PatientId" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_PatientId" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->PatientId->caption() ?><?php echo ($view_billing_voucher->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->PatientId->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_PatientId" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_view_billing_voucher_mrnno" for="x_mrnno" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_mrnno" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->mrnno->caption() ?><?php echo ($view_billing_voucher->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->mrnno->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_mrnno" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_view_billing_voucher_PatientName" for="x_PatientName" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_PatientName" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->PatientName->caption() ?><?php echo ($view_billing_voucher->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->PatientName->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_PatientName" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_view_billing_voucher_Age" for="x_Age" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Age" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Age->caption() ?><?php echo ($view_billing_voucher->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Age->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Age" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_view_billing_voucher_Gender" for="x_Gender" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Gender" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Gender->caption() ?><?php echo ($view_billing_voucher->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Gender->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Gender" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_view_billing_voucher_profilePic" for="x_profilePic" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_profilePic" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->profilePic->caption() ?><?php echo ($view_billing_voucher->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->profilePic->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_profilePic" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_view_billing_voucher_Mobile" for="x_Mobile" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Mobile" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Mobile->caption() ?><?php echo ($view_billing_voucher->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Mobile->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Mobile" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->IP_OP->Visible) { // IP_OP ?>
	<div id="r_IP_OP" class="form-group row">
		<label id="elh_view_billing_voucher_IP_OP" for="x_IP_OP" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_IP_OP" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->IP_OP->caption() ?><?php echo ($view_billing_voucher->IP_OP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->IP_OP->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_IP_OP" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_view_billing_voucher_Doctor" for="x_Doctor" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Doctor" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Doctor->caption() ?><?php echo ($view_billing_voucher->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Doctor->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Doctor" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_view_billing_voucher_voucher_type" for="x_voucher_type" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_voucher_type" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->voucher_type->caption() ?><?php echo ($view_billing_voucher->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->voucher_type->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_voucher_type" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_view_billing_voucher_Details" for="x_Details" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Details" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Details->caption() ?><?php echo ($view_billing_voucher->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Details->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Details" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_view_billing_voucher_ModeofPayment" for="x_ModeofPayment" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_ModeofPayment" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->ModeofPayment->caption() ?><?php echo ($view_billing_voucher->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->ModeofPayment->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_ModeofPayment" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_view_billing_voucher_Amount" for="x_Amount" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Amount" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Amount->caption() ?><?php echo ($view_billing_voucher->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Amount->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Amount" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_view_billing_voucher_AnyDues" for="x_AnyDues" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_AnyDues" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->AnyDues->caption() ?><?php echo ($view_billing_voucher->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->AnyDues->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_AnyDues" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->DiscountAmount->Visible) { // DiscountAmount ?>
	<div id="r_DiscountAmount" class="form-group row">
		<label id="elh_view_billing_voucher_DiscountAmount" for="x_DiscountAmount" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_DiscountAmount" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->DiscountAmount->caption() ?><?php echo ($view_billing_voucher->DiscountAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->DiscountAmount->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_DiscountAmount" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		<label id="elh_view_billing_voucher_RealizationAmount" for="x_RealizationAmount" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RealizationAmount" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RealizationAmount->caption() ?><?php echo ($view_billing_voucher->RealizationAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RealizationAmount->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RealizationAmount" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		<label id="elh_view_billing_voucher_RealizationStatus" for="x_RealizationStatus" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RealizationStatus" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RealizationStatus->caption() ?><?php echo ($view_billing_voucher->RealizationStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RealizationStatus->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RealizationStatus" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		<label id="elh_view_billing_voucher_RealizationRemarks" for="x_RealizationRemarks" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RealizationRemarks" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RealizationRemarks->caption() ?><?php echo ($view_billing_voucher->RealizationRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RealizationRemarks->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RealizationRemarks" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		<label id="elh_view_billing_voucher_RealizationBatchNo" for="x_RealizationBatchNo" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RealizationBatchNo" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RealizationBatchNo->caption() ?><?php echo ($view_billing_voucher->RealizationBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RealizationBatchNo->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RealizationBatchNo" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		<label id="elh_view_billing_voucher_RealizationDate" for="x_RealizationDate" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RealizationDate" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RealizationDate->caption() ?><?php echo ($view_billing_voucher->RealizationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RealizationDate->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RealizationDate" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_view_billing_voucher_RIDNO" for="x_RIDNO" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RIDNO" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RIDNO->caption() ?><?php echo ($view_billing_voucher->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RIDNO->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RIDNO" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_view_billing_voucher_TidNo" for="x_TidNo" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_TidNo" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->TidNo->caption() ?><?php echo ($view_billing_voucher->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->TidNo->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_TidNo" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_view_billing_voucher_CId" for="x_CId" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CId" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CId->caption() ?><?php echo ($view_billing_voucher->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CId->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CId" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_view_billing_voucher_PartnerName" for="x_PartnerName" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_PartnerName" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->PartnerName->caption() ?><?php echo ($view_billing_voucher->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->PartnerName->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_PartnerName" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->PayerType->Visible) { // PayerType ?>
	<div id="r_PayerType" class="form-group row">
		<label id="elh_view_billing_voucher_PayerType" for="x_PayerType" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_PayerType" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->PayerType->caption() ?><?php echo ($view_billing_voucher->PayerType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->PayerType->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_PayerType" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Dob->Visible) { // Dob ?>
	<div id="r_Dob" class="form-group row">
		<label id="elh_view_billing_voucher_Dob" for="x_Dob" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Dob" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Dob->caption() ?><?php echo ($view_billing_voucher->Dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Dob->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Dob" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_view_billing_voucher_Currency" for="x_Currency" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Currency" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Currency->caption() ?><?php echo ($view_billing_voucher->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Currency->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Currency" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->DiscountRemarks->Visible) { // DiscountRemarks ?>
	<div id="r_DiscountRemarks" class="form-group row">
		<label id="elh_view_billing_voucher_DiscountRemarks" for="x_DiscountRemarks" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_DiscountRemarks" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->DiscountRemarks->caption() ?><?php echo ($view_billing_voucher->DiscountRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->DiscountRemarks->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_DiscountRemarks" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_view_billing_voucher_Remarks" for="x_Remarks" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Remarks" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Remarks->caption() ?><?php echo ($view_billing_voucher->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Remarks->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Remarks" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_view_billing_voucher_PatId" for="x_PatId" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_PatId" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->PatId->caption() ?><?php echo ($view_billing_voucher->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->PatId->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_PatId" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_view_billing_voucher_DrDepartment" for="x_DrDepartment" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_DrDepartment" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->DrDepartment->caption() ?><?php echo ($view_billing_voucher->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->DrDepartment->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_DrDepartment" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->RefferedBy->Visible) { // RefferedBy ?>
	<div id="r_RefferedBy" class="form-group row">
		<label id="elh_view_billing_voucher_RefferedBy" for="x_RefferedBy" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_RefferedBy" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->RefferedBy->caption() ?><?php echo ($view_billing_voucher->RefferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->RefferedBy->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_RefferedBy" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_view_billing_voucher_CardNumber" for="x_CardNumber" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CardNumber" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CardNumber->caption() ?><?php echo ($view_billing_voucher->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CardNumber->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CardNumber" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_view_billing_voucher_BankName" for="x_BankName" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_BankName" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->BankName->caption() ?><?php echo ($view_billing_voucher->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->BankName->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_BankName" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_view_billing_voucher_DrID" for="x_DrID" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_DrID" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->DrID->caption() ?><?php echo ($view_billing_voucher->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->DrID->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_DrID" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_view_billing_voucher_BillStatus" for="x_BillStatus" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_BillStatus" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->BillStatus->caption() ?><?php echo ($view_billing_voucher->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->BillStatus->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_BillStatus" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_view_billing_voucher_ReportHeader" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_ReportHeader" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->ReportHeader->caption() ?><?php echo ($view_billing_voucher->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->ReportHeader->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_ReportHeader" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->AdjustmentAdvance->Visible) { // AdjustmentAdvance ?>
	<div id="r_AdjustmentAdvance" class="form-group row">
		<label id="elh_view_billing_voucher_AdjustmentAdvance" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_AdjustmentAdvance" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->AdjustmentAdvance->caption() ?><?php echo ($view_billing_voucher->AdjustmentAdvance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->AdjustmentAdvance->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_AdjustmentAdvance" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->billing_vouchercol->Visible) { // billing_vouchercol ?>
	<div id="r_billing_vouchercol" class="form-group row">
		<label id="elh_view_billing_voucher_billing_vouchercol" for="x_billing_vouchercol" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_billing_vouchercol" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->billing_vouchercol->caption() ?><?php echo ($view_billing_voucher->billing_vouchercol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->billing_vouchercol->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_billing_vouchercol" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->BillType->Visible) { // BillType ?>
	<div id="r_BillType" class="form-group row">
		<label id="elh_view_billing_voucher_BillType" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_BillType" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->BillType->caption() ?><?php echo ($view_billing_voucher->BillType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->BillType->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_BillType" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->ProcedureName->Visible) { // ProcedureName ?>
	<div id="r_ProcedureName" class="form-group row">
		<label id="elh_view_billing_voucher_ProcedureName" for="x_ProcedureName" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_ProcedureName" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->ProcedureName->caption() ?><?php echo ($view_billing_voucher->ProcedureName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->ProcedureName->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_ProcedureName" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->ProcedureAmount->Visible) { // ProcedureAmount ?>
	<div id="r_ProcedureAmount" class="form-group row">
		<label id="elh_view_billing_voucher_ProcedureAmount" for="x_ProcedureAmount" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_ProcedureAmount" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->ProcedureAmount->caption() ?><?php echo ($view_billing_voucher->ProcedureAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->ProcedureAmount->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_ProcedureAmount" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->IncludePackage->Visible) { // IncludePackage ?>
	<div id="r_IncludePackage" class="form-group row">
		<label id="elh_view_billing_voucher_IncludePackage" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_IncludePackage" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->IncludePackage->caption() ?><?php echo ($view_billing_voucher->IncludePackage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->IncludePackage->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_IncludePackage" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CancelBill->Visible) { // CancelBill ?>
	<div id="r_CancelBill" class="form-group row">
		<label id="elh_view_billing_voucher_CancelBill" for="x_CancelBill" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CancelBill" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CancelBill->caption() ?><?php echo ($view_billing_voucher->CancelBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CancelBill->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CancelBill" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CancelReason->Visible) { // CancelReason ?>
	<div id="r_CancelReason" class="form-group row">
		<label id="elh_view_billing_voucher_CancelReason" for="x_CancelReason" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CancelReason" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CancelReason->caption() ?><?php echo ($view_billing_voucher->CancelReason->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CancelReason->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CancelReason" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CancelModeOfPayment->Visible) { // CancelModeOfPayment ?>
	<div id="r_CancelModeOfPayment" class="form-group row">
		<label id="elh_view_billing_voucher_CancelModeOfPayment" for="x_CancelModeOfPayment" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CancelModeOfPayment" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CancelModeOfPayment->caption() ?><?php echo ($view_billing_voucher->CancelModeOfPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CancelModeOfPayment->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CancelModeOfPayment" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CancelAmount->Visible) { // CancelAmount ?>
	<div id="r_CancelAmount" class="form-group row">
		<label id="elh_view_billing_voucher_CancelAmount" for="x_CancelAmount" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CancelAmount" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CancelAmount->caption() ?><?php echo ($view_billing_voucher->CancelAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CancelAmount->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CancelAmount" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CancelBankName->Visible) { // CancelBankName ?>
	<div id="r_CancelBankName" class="form-group row">
		<label id="elh_view_billing_voucher_CancelBankName" for="x_CancelBankName" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CancelBankName" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CancelBankName->caption() ?><?php echo ($view_billing_voucher->CancelBankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CancelBankName->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CancelBankName" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CancelTransactionNumber->Visible) { // CancelTransactionNumber ?>
	<div id="r_CancelTransactionNumber" class="form-group row">
		<label id="elh_view_billing_voucher_CancelTransactionNumber" for="x_CancelTransactionNumber" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CancelTransactionNumber" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CancelTransactionNumber->caption() ?><?php echo ($view_billing_voucher->CancelTransactionNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CancelTransactionNumber->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CancelTransactionNumber" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->LabTest->Visible) { // LabTest ?>
	<div id="r_LabTest" class="form-group row">
		<label id="elh_view_billing_voucher_LabTest" for="x_LabTest" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_LabTest" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->LabTest->caption() ?><?php echo ($view_billing_voucher->LabTest->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->LabTest->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_LabTest" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->sid->Visible) { // sid ?>
	<div id="r_sid" class="form-group row">
		<label id="elh_view_billing_voucher_sid" for="x_sid" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_sid" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->sid->caption() ?><?php echo ($view_billing_voucher->sid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->sid->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_sid" class="view_billing_voucheredit" type="text/html">
...
<input type="hidden" data-table="view_billing_voucher" data-field="x_sid" name="x_sid" id="x_sid" value="<?php echo HtmlEncode($view_billing_voucher->sid->CurrentValue) ?>">
...
<?php if ($view_billing_voucher->SidNo->Visible) { // SidNo ?>
	<div id="r_SidNo" class="form-group row">
		<label id="elh_view_billing_voucher_SidNo" for="x_SidNo" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_SidNo" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->SidNo->caption() ?><?php echo ($view_billing_voucher->SidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->SidNo->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_SidNo" class="view_billing_voucheredit" type="text/html">
...
<input type="hidden" data-table="view_billing_voucher" data-field="x_SidNo" name="x_SidNo" id="x_SidNo" value="<?php echo HtmlEncode($view_billing_voucher->SidNo->CurrentValue) ?>">
...
<?php if ($view_billing_voucher->BillClosing->Visible) { // BillClosing ?>
	<div id="r_BillClosing" class="form-group row">
		<label id="elh_view_billing_voucher_BillClosing" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_BillClosing" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->BillClosing->caption() ?><?php echo ($view_billing_voucher->BillClosing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->BillClosing->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_BillClosing" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->GoogleReviewID->Visible) { // GoogleReviewID ?>
	<div id="r_GoogleReviewID" class="form-group row">
		<label id="elh_view_billing_voucher_GoogleReviewID" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_GoogleReviewID" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->GoogleReviewID->caption() ?><?php echo ($view_billing_voucher->GoogleReviewID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->GoogleReviewID->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_GoogleReviewID" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->CardType->Visible) { // CardType ?>
	<div id="r_CardType" class="form-group row">
		<label id="elh_view_billing_voucher_CardType" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_CardType" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->CardType->caption() ?><?php echo ($view_billing_voucher->CardType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->CardType->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_CardType" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->PharmacyBill->Visible) { // PharmacyBill ?>
	<div id="r_PharmacyBill" class="form-group row">
		<label id="elh_view_billing_voucher_PharmacyBill" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_PharmacyBill" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->PharmacyBill->caption() ?><?php echo ($view_billing_voucher->PharmacyBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->PharmacyBill->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_PharmacyBill" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->cash->Visible) { // cash ?>
	<div id="r_cash" class="form-group row">
		<label id="elh_view_billing_voucher_cash" for="x_cash" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_cash" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->cash->caption() ?><?php echo ($view_billing_voucher->cash->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->cash->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_cash" class="view_billing_voucheredit" type="text/html">
...
<?php if ($view_billing_voucher->Card->Visible) { // Card ?>
	<div id="r_Card" class="form-group row">
		<label id="elh_view_billing_voucher_Card" for="x_Card" class="<?php echo $view_billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_view_billing_voucher_Card" class="view_billing_voucheredit" type="text/html"><span><?php echo $view_billing_voucher->Card->caption() ?><?php echo ($view_billing_voucher->Card->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_billing_voucher_edit->RightColumnClass ?>"><div<?php echo $view_billing_voucher->Card->cellAttributes() ?>>
<script id="tpx_view_billing_voucher_Card" class="view_billing_voucheredit" type="text/html">
...
ew.applyTemplate("tpd_view_billing_voucheredit", "tpm_view_billing_voucheredit", "view_billing_voucheredit", "<?php echo $view_billing_voucher->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_billing_voucheredit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
...
{	
	...
	for (var i = 1; i < 80; i++) {
		...
		var DSAmount = document.getElementById("x_DiscountAmount");
	var DisCountAmount = 0; // DSAmount.value;
		var DisCountAmount = DisCountAmount.replace(',','');
