...
// Create page object
$employee_company_loans_edit = new employee_company_loans_edit();

// Run the page
$employee_company_loans_edit->run();
...
$employee_company_loans_edit->Page_Render();
?>
...
var femployee_company_loansedit = currentForm = new ew.Form("femployee_company_loansedit", "edit");
...
femployee_company_loansedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_company_loans_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_company_loans->id->caption(), $employee_company_loans->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_company_loans_edit->employee->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->loan->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->start_date->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->last_installment_date->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->period_months->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->currency->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->amount->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->monthly_installment->Required) { ?>
		...
		<?php if ($employee_company_loans_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_company_loans_edit->details->Required) { ?>
...
femployee_company_loansedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_company_loansedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_company_loansedit.lists["x_status"] = <?php echo $employee_company_loans_edit->status->Lookup->toClientList() ?>;
femployee_company_loansedit.lists["x_status"].options = <?php echo JsonEncode($employee_company_loans_edit->status->options(FALSE, TRUE)) ?>;
...
<?php $employee_company_loans_edit->showPageHeader(); ?>
<?php
$employee_company_loans_edit->showMessage();
?>
<form name="femployee_company_loansedit" id="femployee_company_loansedit" class="<?php echo $employee_company_loans_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_company_loans_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_company_loans_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_company_loans">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$employee_company_loans_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($employee_company_loans->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_employee_company_loans_id" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->id->caption() ?><?php echo ($employee_company_loans->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->id->cellAttributes() ?>>
<span id="el_employee_company_loans_id">
<span<?php echo $employee_company_loans->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($employee_company_loans->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="employee_company_loans" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($employee_company_loans->id->CurrentValue) ?>">
<?php echo $employee_company_loans->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($employee_company_loans->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employee_company_loans_employee" for="x_employee" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->employee->caption() ?><?php echo ($employee_company_loans->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->employee->cellAttributes() ?>>
...
<?php if ($employee_company_loans->loan->Visible) { // loan ?>
	<div id="r_loan" class="form-group row">
		<label id="elh_employee_company_loans_loan" for="x_loan" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->loan->caption() ?><?php echo ($employee_company_loans->loan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->loan->cellAttributes() ?>>
...
<?php if ($employee_company_loans->start_date->Visible) { // start_date ?>
	<div id="r_start_date" class="form-group row">
		<label id="elh_employee_company_loans_start_date" for="x_start_date" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->start_date->caption() ?><?php echo ($employee_company_loans->start_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->start_date->cellAttributes() ?>>
...
<?php if ($employee_company_loans->last_installment_date->Visible) { // last_installment_date ?>
	<div id="r_last_installment_date" class="form-group row">
		<label id="elh_employee_company_loans_last_installment_date" for="x_last_installment_date" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->last_installment_date->caption() ?><?php echo ($employee_company_loans->last_installment_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->last_installment_date->cellAttributes() ?>>
...
<?php if ($employee_company_loans->period_months->Visible) { // period_months ?>
	<div id="r_period_months" class="form-group row">
		<label id="elh_employee_company_loans_period_months" for="x_period_months" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->period_months->caption() ?><?php echo ($employee_company_loans->period_months->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->period_months->cellAttributes() ?>>
...
<?php if ($employee_company_loans->currency->Visible) { // currency ?>
	<div id="r_currency" class="form-group row">
		<label id="elh_employee_company_loans_currency" for="x_currency" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->currency->caption() ?><?php echo ($employee_company_loans->currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->currency->cellAttributes() ?>>
...
<?php if ($employee_company_loans->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group row">
		<label id="elh_employee_company_loans_amount" for="x_amount" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->amount->caption() ?><?php echo ($employee_company_loans->amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->amount->cellAttributes() ?>>
...
<?php if ($employee_company_loans->monthly_installment->Visible) { // monthly_installment ?>
	<div id="r_monthly_installment" class="form-group row">
		<label id="elh_employee_company_loans_monthly_installment" for="x_monthly_installment" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->monthly_installment->caption() ?><?php echo ($employee_company_loans->monthly_installment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->monthly_installment->cellAttributes() ?>>
...
<?php if ($employee_company_loans->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_company_loans_status" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->status->caption() ?><?php echo ($employee_company_loans->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->status->cellAttributes() ?>>
...
<?php if ($employee_company_loans->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_employee_company_loans_details" for="x_details" class="<?php echo $employee_company_loans_edit->LeftColumnClass ?>"><?php echo $employee_company_loans->details->caption() ?><?php echo ($employee_company_loans->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_company_loans_edit->RightColumnClass ?>"><div<?php echo $employee_company_loans->details->cellAttributes() ?>>
...
<?php if (!$employee_company_loans_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_company_loans_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_company_loans_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_company_loans_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_company_loans_edit->terminate();
?>