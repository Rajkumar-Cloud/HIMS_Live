...
<?php if ($pharmacy_billing_voucher->CardType->Visible) { // CardType ?>
		<tr id="r_CardType">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->CardType->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->DiscountAmount->Visible) { // DiscountAmount ?>
		<tr id="r_DiscountAmount">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->DiscountAmount->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->ApprovalNumber->Visible) { // ApprovalNumber ?>
		<tr id="r_ApprovalNumber">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->ApprovalNumber->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->Cash->Visible) { // Cash ?>
		<tr id="r_Cash">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->Cash->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->Card->Visible) { // Card ?>
		<tr id="r_Card">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->Card->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->BillType->Visible) { // BillType ?>
		<tr id="r_BillType">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->BillType->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->PartialSave->Visible) { // PartialSave ?>
		<tr id="r_PartialSave">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->PartialSave->caption() ?></td>
...
<?php if ($pharmacy_billing_voucher->PatientGST->Visible) { // PatientGST ?>
		<tr id="r_PatientGST">
			<td class="<?php echo $pharmacy_billing_voucher->TableLeftColumnClass ?>"><?php echo $pharmacy_billing_voucher->PatientGST->caption() ?></td>
