...
var fdoctorsedit = currentForm = new ew.Form("fdoctorsedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($doctors_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $doctors->id->caption(), $doctors->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fdoctorsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fdoctorsedit.lists["x_slot_days[]"] = <?php echo $doctors_edit->slot_days->Lookup->toClientList() ?>;
fdoctorsedit.lists["x_slot_days[]"].options = <?php echo JsonEncode($doctors_edit->slot_days->lookupOptions()) ?>;
fdoctorsedit.lists["x_Status"] = <?php echo $doctors_edit->Status->Lookup->toClientList() ?>;
...
<?php if ($doctors_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $doctors_edit->Token ?>">
<?php } ?>
...
<?php if ($doctors->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_doctors_id" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->id->caption() ?><?php echo ($doctors->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->id->cellAttributes() ?>>
<span id="el_doctors_id">
<span<?php echo $doctors->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($doctors->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="doctors" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($doctors->id->CurrentValue) ?>">
<?php echo $doctors->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($doctors->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_doctors_CODE" for="x_CODE" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->CODE->caption() ?><?php echo ($doctors->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->CODE->cellAttributes() ?>>
...
<?php if ($doctors->NAME->Visible) { // NAME ?>
	<div id="r_NAME" class="form-group row">
		<label id="elh_doctors_NAME" for="x_NAME" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->NAME->caption() ?><?php echo ($doctors->NAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->NAME->cellAttributes() ?>>
...
<?php if ($doctors->DEPARTMENT->Visible) { // DEPARTMENT ?>
	<div id="r_DEPARTMENT" class="form-group row">
		<label id="elh_doctors_DEPARTMENT" for="x_DEPARTMENT" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->DEPARTMENT->caption() ?><?php echo ($doctors->DEPARTMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->DEPARTMENT->cellAttributes() ?>>
...
<?php if ($doctors->start_time->Visible) { // start_time ?>
	<div id="r_start_time" class="form-group row">
		<label id="elh_doctors_start_time" for="x_start_time" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->start_time->caption() ?><?php echo ($doctors->start_time->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->start_time->cellAttributes() ?>>
...
<script>ew.createTimePicker("fdoctorsedit", "x_start_time", {"timeFormat":"H:i:s","step":15});</script><?php } ?>
</span>
...
<?php if ($doctors->end_time->Visible) { // end_time ?>
	<div id="r_end_time" class="form-group row">
		<label id="elh_doctors_end_time" for="x_end_time" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->end_time->caption() ?><?php echo ($doctors->end_time->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->end_time->cellAttributes() ?>>
...
<script>ew.createTimePicker("fdoctorsedit", "x_end_time", {"timeFormat":"H:i:s","step":15});</script><?php } ?>
</span>
...
<?php if ($doctors->start_time1->Visible) { // start_time1 ?>
	<div id="r_start_time1" class="form-group row">
		<label id="elh_doctors_start_time1" for="x_start_time1" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->start_time1->caption() ?><?php echo ($doctors->start_time1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->start_time1->cellAttributes() ?>>
...
<script>ew.createTimePicker("fdoctorsedit", "x_start_time1", {"timeFormat":"H:i:s","step":15});</script><?php } ?>
</span>
...
<?php if ($doctors->end_time1->Visible) { // end_time1 ?>
	<div id="r_end_time1" class="form-group row">
		<label id="elh_doctors_end_time1" for="x_end_time1" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->end_time1->caption() ?><?php echo ($doctors->end_time1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->end_time1->cellAttributes() ?>>
...
<script>ew.createTimePicker("fdoctorsedit", "x_end_time1", {"timeFormat":"H:i:s","step":15});</script><?php } ?>
</span>
...
<?php if ($doctors->start_time2->Visible) { // start_time2 ?>
	<div id="r_start_time2" class="form-group row">
		<label id="elh_doctors_start_time2" for="x_start_time2" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->start_time2->caption() ?><?php echo ($doctors->start_time2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->start_time2->cellAttributes() ?>>
...
<script>ew.createTimePicker("fdoctorsedit", "x_start_time2", {"timeFormat":"H:i:s","step":15});</script><?php } ?>
</span>
...
<?php if ($doctors->end_time2->Visible) { // end_time2 ?>
	<div id="r_end_time2" class="form-group row">
		<label id="elh_doctors_end_time2" for="x_end_time2" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->end_time2->caption() ?><?php echo ($doctors->end_time2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->end_time2->cellAttributes() ?>>
...
<script>ew.createTimePicker("fdoctorsedit", "x_end_time2", {"timeFormat":"H:i:s","step":15});</script><?php } ?>
</span>
...
<?php if ($doctors->slot_time->Visible) { // slot_time ?>
	<div id="r_slot_time" class="form-group row">
		<label id="elh_doctors_slot_time" for="x_slot_time" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->slot_time->caption() ?><?php echo ($doctors->slot_time->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->slot_time->cellAttributes() ?>>
...
<?php if ($doctors->Fees->Visible) { // Fees ?>
	<div id="r_Fees" class="form-group row">
		<label id="elh_doctors_Fees" for="x_Fees" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->Fees->caption() ?><?php echo ($doctors->Fees->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->Fees->cellAttributes() ?>>
...
<?php if ($doctors->ProfilePic->Visible) { // ProfilePic ?>
	<div id="r_ProfilePic" class="form-group row">
		<label id="elh_doctors_ProfilePic" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->ProfilePic->caption() ?><?php echo ($doctors->ProfilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->ProfilePic->cellAttributes() ?>>
...
<?php if ($doctors->slot_days->Visible) { // slot_days ?>
	<div id="r_slot_days" class="form-group row">
		<label id="elh_doctors_slot_days" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->slot_days->caption() ?><?php echo ($doctors->slot_days->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->slot_days->cellAttributes() ?>>
...
<?php if ($doctors->Status->Visible) { // Status ?>
	<div id="r_Status" class="form-group row">
		<label id="elh_doctors_Status" for="x_Status" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->Status->caption() ?><?php echo ($doctors->Status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->Status->cellAttributes() ?>>
...
<?php if ($doctors->scheduler_id->Visible) { // scheduler_id ?>
	<div id="r_scheduler_id" class="form-group row">
		<label id="elh_doctors_scheduler_id" for="x_scheduler_id" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->scheduler_id->caption() ?><?php echo ($doctors->scheduler_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->scheduler_id->cellAttributes() ?>>
...
<?php if ($doctors->Designation->Visible) { // Designation ?>
	<div id="r_Designation" class="form-group row">
		<label id="elh_doctors_Designation" for="x_Designation" class="<?php echo $doctors_edit->LeftColumnClass ?>"><?php echo $doctors->Designation->caption() ?><?php echo ($doctors->Designation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $doctors_edit->RightColumnClass ?>"><div<?php echo $doctors->Designation->cellAttributes() ?>>
...
<?php
	if (in_array("_appointment_scheduler", explode(",", $doctors->getCurrentDetailTable())) && $_appointment_scheduler->DetailEdit) {
?>
