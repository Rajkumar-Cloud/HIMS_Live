...
// Create page object
$crm_contactdetails_edit = new crm_contactdetails_edit();

// Run the page
$crm_contactdetails_edit->run();
...
$crm_contactdetails_edit->Page_Render();
?>
...
var fcrm_contactdetailsedit = currentForm = new ew.Form("fcrm_contactdetailsedit", "edit");
...
fcrm_contactdetailsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($crm_contactdetails_edit->contactid->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->contact_no->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->parentid->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->salutation->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->firstname->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->lastname->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->mobile->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->reportsto->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->training->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->usertype->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->contacttype->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->otheremail->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->donotcall->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->emailoptout->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->imagename->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->isconvertedfromlead->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->verification->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->secondary_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->notifilanguage->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->contactstatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->dav_status->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->jobtitle->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->decision_maker->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->sum_time->Required) { ?>
		...
		<?php if ($crm_contactdetails_edit->phone_extra->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->mobile_extra->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->approvals->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_contactdetails_edit->gender->Required) { ?>
...
fcrm_contactdetailsedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcrm_contactdetailsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $crm_contactdetails_edit->showPageHeader(); ?>
<?php
$crm_contactdetails_edit->showMessage();
?>
<form name="fcrm_contactdetailsedit" id="fcrm_contactdetailsedit" class="<?php echo $crm_contactdetails_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($crm_contactdetails_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $crm_contactdetails_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="crm_contactdetails">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$crm_contactdetails_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($crm_contactdetails->contactid->Visible) { // contactid ?>
	<div id="r_contactid" class="form-group row">
		<label id="elh_crm_contactdetails_contactid" for="x_contactid" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->contactid->caption() ?><?php echo ($crm_contactdetails->contactid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->contactid->cellAttributes() ?>>
<span id="el_crm_contactdetails_contactid">
<span<?php echo $crm_contactdetails->contactid->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($crm_contactdetails->contactid->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="crm_contactdetails" data-field="x_contactid" name="x_contactid" id="x_contactid" value="<?php echo HtmlEncode($crm_contactdetails->contactid->CurrentValue) ?>">
...
<?php if ($crm_contactdetails->contact_no->Visible) { // contact_no ?>
	<div id="r_contact_no" class="form-group row">
		<label id="elh_crm_contactdetails_contact_no" for="x_contact_no" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->contact_no->caption() ?><?php echo ($crm_contactdetails->contact_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->contact_no->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->parentid->Visible) { // parentid ?>
	<div id="r_parentid" class="form-group row">
		<label id="elh_crm_contactdetails_parentid" for="x_parentid" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->parentid->caption() ?><?php echo ($crm_contactdetails->parentid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->parentid->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->salutation->Visible) { // salutation ?>
	<div id="r_salutation" class="form-group row">
		<label id="elh_crm_contactdetails_salutation" for="x_salutation" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->salutation->caption() ?><?php echo ($crm_contactdetails->salutation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->salutation->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->firstname->Visible) { // firstname ?>
	<div id="r_firstname" class="form-group row">
		<label id="elh_crm_contactdetails_firstname" for="x_firstname" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->firstname->caption() ?><?php echo ($crm_contactdetails->firstname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->firstname->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->lastname->Visible) { // lastname ?>
	<div id="r_lastname" class="form-group row">
		<label id="elh_crm_contactdetails_lastname" for="x_lastname" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->lastname->caption() ?><?php echo ($crm_contactdetails->lastname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->lastname->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->_email->Visible) { // email ?>
	<div id="r__email" class="form-group row">
		<label id="elh_crm_contactdetails__email" for="x__email" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->_email->caption() ?><?php echo ($crm_contactdetails->_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->_email->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group row">
		<label id="elh_crm_contactdetails_phone" for="x_phone" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->phone->caption() ?><?php echo ($crm_contactdetails->phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->phone->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->mobile->Visible) { // mobile ?>
	<div id="r_mobile" class="form-group row">
		<label id="elh_crm_contactdetails_mobile" for="x_mobile" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->mobile->caption() ?><?php echo ($crm_contactdetails->mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->mobile->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->reportsto->Visible) { // reportsto ?>
	<div id="r_reportsto" class="form-group row">
		<label id="elh_crm_contactdetails_reportsto" for="x_reportsto" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->reportsto->caption() ?><?php echo ($crm_contactdetails->reportsto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->reportsto->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->training->Visible) { // training ?>
	<div id="r_training" class="form-group row">
		<label id="elh_crm_contactdetails_training" for="x_training" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->training->caption() ?><?php echo ($crm_contactdetails->training->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->training->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->usertype->Visible) { // usertype ?>
	<div id="r_usertype" class="form-group row">
		<label id="elh_crm_contactdetails_usertype" for="x_usertype" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->usertype->caption() ?><?php echo ($crm_contactdetails->usertype->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->usertype->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->contacttype->Visible) { // contacttype ?>
	<div id="r_contacttype" class="form-group row">
		<label id="elh_crm_contactdetails_contacttype" for="x_contacttype" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->contacttype->caption() ?><?php echo ($crm_contactdetails->contacttype->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->contacttype->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->otheremail->Visible) { // otheremail ?>
	<div id="r_otheremail" class="form-group row">
		<label id="elh_crm_contactdetails_otheremail" for="x_otheremail" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->otheremail->caption() ?><?php echo ($crm_contactdetails->otheremail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->otheremail->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->donotcall->Visible) { // donotcall ?>
	<div id="r_donotcall" class="form-group row">
		<label id="elh_crm_contactdetails_donotcall" for="x_donotcall" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->donotcall->caption() ?><?php echo ($crm_contactdetails->donotcall->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->donotcall->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->emailoptout->Visible) { // emailoptout ?>
	<div id="r_emailoptout" class="form-group row">
		<label id="elh_crm_contactdetails_emailoptout" for="x_emailoptout" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->emailoptout->caption() ?><?php echo ($crm_contactdetails->emailoptout->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->emailoptout->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->imagename->Visible) { // imagename ?>
	<div id="r_imagename" class="form-group row">
		<label id="elh_crm_contactdetails_imagename" for="x_imagename" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->imagename->caption() ?><?php echo ($crm_contactdetails->imagename->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->imagename->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->isconvertedfromlead->Visible) { // isconvertedfromlead ?>
	<div id="r_isconvertedfromlead" class="form-group row">
		<label id="elh_crm_contactdetails_isconvertedfromlead" for="x_isconvertedfromlead" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->isconvertedfromlead->caption() ?><?php echo ($crm_contactdetails->isconvertedfromlead->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->isconvertedfromlead->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->verification->Visible) { // verification ?>
	<div id="r_verification" class="form-group row">
		<label id="elh_crm_contactdetails_verification" for="x_verification" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->verification->caption() ?><?php echo ($crm_contactdetails->verification->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->verification->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->secondary_email->Visible) { // secondary_email ?>
	<div id="r_secondary_email" class="form-group row">
		<label id="elh_crm_contactdetails_secondary_email" for="x_secondary_email" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->secondary_email->caption() ?><?php echo ($crm_contactdetails->secondary_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->secondary_email->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->notifilanguage->Visible) { // notifilanguage ?>
	<div id="r_notifilanguage" class="form-group row">
		<label id="elh_crm_contactdetails_notifilanguage" for="x_notifilanguage" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->notifilanguage->caption() ?><?php echo ($crm_contactdetails->notifilanguage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->notifilanguage->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->contactstatus->Visible) { // contactstatus ?>
	<div id="r_contactstatus" class="form-group row">
		<label id="elh_crm_contactdetails_contactstatus" for="x_contactstatus" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->contactstatus->caption() ?><?php echo ($crm_contactdetails->contactstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->contactstatus->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->dav_status->Visible) { // dav_status ?>
	<div id="r_dav_status" class="form-group row">
		<label id="elh_crm_contactdetails_dav_status" for="x_dav_status" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->dav_status->caption() ?><?php echo ($crm_contactdetails->dav_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->dav_status->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->jobtitle->Visible) { // jobtitle ?>
	<div id="r_jobtitle" class="form-group row">
		<label id="elh_crm_contactdetails_jobtitle" for="x_jobtitle" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->jobtitle->caption() ?><?php echo ($crm_contactdetails->jobtitle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->jobtitle->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->decision_maker->Visible) { // decision_maker ?>
	<div id="r_decision_maker" class="form-group row">
		<label id="elh_crm_contactdetails_decision_maker" for="x_decision_maker" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->decision_maker->caption() ?><?php echo ($crm_contactdetails->decision_maker->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->decision_maker->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->sum_time->Visible) { // sum_time ?>
	<div id="r_sum_time" class="form-group row">
		<label id="elh_crm_contactdetails_sum_time" for="x_sum_time" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->sum_time->caption() ?><?php echo ($crm_contactdetails->sum_time->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->sum_time->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->phone_extra->Visible) { // phone_extra ?>
	<div id="r_phone_extra" class="form-group row">
		<label id="elh_crm_contactdetails_phone_extra" for="x_phone_extra" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->phone_extra->caption() ?><?php echo ($crm_contactdetails->phone_extra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->phone_extra->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->mobile_extra->Visible) { // mobile_extra ?>
	<div id="r_mobile_extra" class="form-group row">
		<label id="elh_crm_contactdetails_mobile_extra" for="x_mobile_extra" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->mobile_extra->caption() ?><?php echo ($crm_contactdetails->mobile_extra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->mobile_extra->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->approvals->Visible) { // approvals ?>
	<div id="r_approvals" class="form-group row">
		<label id="elh_crm_contactdetails_approvals" for="x_approvals" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->approvals->caption() ?><?php echo ($crm_contactdetails->approvals->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->approvals->cellAttributes() ?>>
...
<?php if ($crm_contactdetails->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_crm_contactdetails_gender" for="x_gender" class="<?php echo $crm_contactdetails_edit->LeftColumnClass ?>"><?php echo $crm_contactdetails->gender->caption() ?><?php echo ($crm_contactdetails->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactdetails_edit->RightColumnClass ?>"><div<?php echo $crm_contactdetails->gender->cellAttributes() ?>>
...
<?php if (!$crm_contactdetails_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $crm_contactdetails_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $crm_contactdetails_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$crm_contactdetails_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$crm_contactdetails_edit->terminate();
?>