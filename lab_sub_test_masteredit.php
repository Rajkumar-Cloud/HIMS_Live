...
// Create page object
$lab_sub_test_master_edit = new lab_sub_test_master_edit();

// Run the page
$lab_sub_test_master_edit->run();
...
$lab_sub_test_master_edit->Page_Render();
?>
...
var flab_sub_test_masteredit = currentForm = new ew.Form("flab_sub_test_masteredit", "edit");

// Validate form
flab_sub_test_masteredit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($lab_sub_test_master_edit->id->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_sub_test_master_edit->TestMasterID->Required) { ?>
		...
		<?php if ($lab_sub_test_master_edit->SubTestName->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_sub_test_master_edit->TestOrder->Required) { ?>
		...
		<?php if ($lab_sub_test_master_edit->NormalRange->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_sub_test_master_edit->Modified->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_sub_test_master_edit->ModifiedBy->Required) { ?>
...
flab_sub_test_masteredit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
flab_sub_test_masteredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flab_sub_test_masteredit.lists["x_SubTestName"] = <?php echo $lab_sub_test_master_edit->SubTestName->Lookup->toClientList() ?>;
flab_sub_test_masteredit.lists["x_SubTestName"].options = <?php echo JsonEncode($lab_sub_test_master_edit->SubTestName->lookupOptions()) ?>;
...
<?php $lab_sub_test_master_edit->showPageHeader(); ?>
<?php
$lab_sub_test_master_edit->showMessage();
?>
<form name="flab_sub_test_masteredit" id="flab_sub_test_masteredit" class="<?php echo $lab_sub_test_master_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($lab_sub_test_master_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $lab_sub_test_master_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="lab_sub_test_master">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$lab_sub_test_master_edit->IsModal ?>">
...
<?php if ($lab_sub_test_master->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_lab_sub_test_master_id" class="<?php echo $lab_sub_test_master_edit->LeftColumnClass ?>"><?php echo $lab_sub_test_master->id->caption() ?><?php echo ($lab_sub_test_master->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sub_test_master_edit->RightColumnClass ?>"><div<?php echo $lab_sub_test_master->id->cellAttributes() ?>>
...
<input type="hidden" data-table="lab_sub_test_master" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($lab_sub_test_master->id->CurrentValue) ?>">
<?php echo $lab_sub_test_master->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($lab_sub_test_master->TestMasterID->Visible) { // TestMasterID ?>
	<div id="r_TestMasterID" class="form-group row">
		<label id="elh_lab_sub_test_master_TestMasterID" for="x_TestMasterID" class="<?php echo $lab_sub_test_master_edit->LeftColumnClass ?>"><?php echo $lab_sub_test_master->TestMasterID->caption() ?><?php echo ($lab_sub_test_master->TestMasterID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sub_test_master_edit->RightColumnClass ?>"><div<?php echo $lab_sub_test_master->TestMasterID->cellAttributes() ?>>
...
<?php if ($lab_sub_test_master->SubTestName->Visible) { // SubTestName ?>
	<div id="r_SubTestName" class="form-group row">
		<label id="elh_lab_sub_test_master_SubTestName" for="x_SubTestName" class="<?php echo $lab_sub_test_master_edit->LeftColumnClass ?>"><?php echo $lab_sub_test_master->SubTestName->caption() ?><?php echo ($lab_sub_test_master->SubTestName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sub_test_master_edit->RightColumnClass ?>"><div<?php echo $lab_sub_test_master->SubTestName->cellAttributes() ?>>
...
<?php if ($lab_sub_test_master->TestOrder->Visible) { // TestOrder ?>
	<div id="r_TestOrder" class="form-group row">
		<label id="elh_lab_sub_test_master_TestOrder" for="x_TestOrder" class="<?php echo $lab_sub_test_master_edit->LeftColumnClass ?>"><?php echo $lab_sub_test_master->TestOrder->caption() ?><?php echo ($lab_sub_test_master->TestOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sub_test_master_edit->RightColumnClass ?>"><div<?php echo $lab_sub_test_master->TestOrder->cellAttributes() ?>>
...
<?php if ($lab_sub_test_master->NormalRange->Visible) { // NormalRange ?>
	<div id="r_NormalRange" class="form-group row">
		<label id="elh_lab_sub_test_master_NormalRange" for="x_NormalRange" class="<?php echo $lab_sub_test_master_edit->LeftColumnClass ?>"><?php echo $lab_sub_test_master->NormalRange->caption() ?><?php echo ($lab_sub_test_master->NormalRange->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sub_test_master_edit->RightColumnClass ?>"><div<?php echo $lab_sub_test_master->NormalRange->cellAttributes() ?>>
...
<?php if (!$lab_sub_test_master_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $lab_sub_test_master_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $lab_sub_test_master_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$lab_sub_test_master_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$lab_sub_test_master_edit->terminate();
?>