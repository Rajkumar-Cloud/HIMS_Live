...
// Create page object
$employee_immigrationdocuments_add = new employee_immigrationdocuments_add();

// Run the page
$employee_immigrationdocuments_add->run();
...
$employee_immigrationdocuments_add->Page_Render();
?>
...
var femployee_immigrationdocumentsadd = currentForm = new ew.Form("femployee_immigrationdocumentsadd", "add");

// Validate form
femployee_immigrationdocumentsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_immigrationdocuments_add->name->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrationdocuments_add->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrationdocuments_add->required->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrationdocuments_add->alert_on_missing->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrationdocuments_add->alert_before_expiry->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrationdocuments_add->alert_before_day_number->Required) { ?>
		...
		<?php if ($employee_immigrationdocuments_add->created->Required) { ?>
		...
		<?php if ($employee_immigrationdocuments_add->updated->Required) { ?>
...
femployee_immigrationdocumentsadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_immigrationdocumentsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_immigrationdocumentsadd.lists["x_required"] = <?php echo $employee_immigrationdocuments_add->required->Lookup->toClientList() ?>;
femployee_immigrationdocumentsadd.lists["x_required"].options = <?php echo JsonEncode($employee_immigrationdocuments_add->required->options(FALSE, TRUE)) ?>;
femployee_immigrationdocumentsadd.lists["x_alert_on_missing"] = <?php echo $employee_immigrationdocuments_add->alert_on_missing->Lookup->toClientList() ?>;
femployee_immigrationdocumentsadd.lists["x_alert_on_missing"].options = <?php echo JsonEncode($employee_immigrationdocuments_add->alert_on_missing->options(FALSE, TRUE)) ?>;
femployee_immigrationdocumentsadd.lists["x_alert_before_expiry"] = <?php echo $employee_immigrationdocuments_add->alert_before_expiry->Lookup->toClientList() ?>;
femployee_immigrationdocumentsadd.lists["x_alert_before_expiry"].options = <?php echo JsonEncode($employee_immigrationdocuments_add->alert_before_expiry->options(FALSE, TRUE)) ?>;
...
<?php $employee_immigrationdocuments_add->showPageHeader(); ?>
<?php
$employee_immigrationdocuments_add->showMessage();
?>
<form name="femployee_immigrationdocumentsadd" id="femployee_immigrationdocumentsadd" class="<?php echo $employee_immigrationdocuments_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_immigrationdocuments_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_immigrationdocuments_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_immigrationdocuments">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$employee_immigrationdocuments_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($employee_immigrationdocuments->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_employee_immigrationdocuments_name" for="x_name" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->name->caption() ?><?php echo ($employee_immigrationdocuments->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->name->cellAttributes() ?>>
...
<?php if ($employee_immigrationdocuments->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_employee_immigrationdocuments_details" for="x_details" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->details->caption() ?><?php echo ($employee_immigrationdocuments->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->details->cellAttributes() ?>>
...
<?php if ($employee_immigrationdocuments->required->Visible) { // required ?>
	<div id="r_required" class="form-group row">
		<label id="elh_employee_immigrationdocuments_required" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->required->caption() ?><?php echo ($employee_immigrationdocuments->required->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->required->cellAttributes() ?>>
...
<?php if ($employee_immigrationdocuments->alert_on_missing->Visible) { // alert_on_missing ?>
	<div id="r_alert_on_missing" class="form-group row">
		<label id="elh_employee_immigrationdocuments_alert_on_missing" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->alert_on_missing->caption() ?><?php echo ($employee_immigrationdocuments->alert_on_missing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->alert_on_missing->cellAttributes() ?>>
...
<?php if ($employee_immigrationdocuments->alert_before_expiry->Visible) { // alert_before_expiry ?>
	<div id="r_alert_before_expiry" class="form-group row">
		<label id="elh_employee_immigrationdocuments_alert_before_expiry" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->alert_before_expiry->caption() ?><?php echo ($employee_immigrationdocuments->alert_before_expiry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->alert_before_expiry->cellAttributes() ?>>
...
<?php if ($employee_immigrationdocuments->alert_before_day_number->Visible) { // alert_before_day_number ?>
	<div id="r_alert_before_day_number" class="form-group row">
		<label id="elh_employee_immigrationdocuments_alert_before_day_number" for="x_alert_before_day_number" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->alert_before_day_number->caption() ?><?php echo ($employee_immigrationdocuments->alert_before_day_number->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->alert_before_day_number->cellAttributes() ?>>
...
<?php if ($employee_immigrationdocuments->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_employee_immigrationdocuments_created" for="x_created" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->created->caption() ?><?php echo ($employee_immigrationdocuments->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->created->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("femployee_immigrationdocumentsadd", "x_created", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($employee_immigrationdocuments->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_employee_immigrationdocuments_updated" for="x_updated" class="<?php echo $employee_immigrationdocuments_add->LeftColumnClass ?>"><?php echo $employee_immigrationdocuments->updated->caption() ?><?php echo ($employee_immigrationdocuments->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrationdocuments_add->RightColumnClass ?>"><div<?php echo $employee_immigrationdocuments->updated->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("femployee_immigrationdocumentsadd", "x_updated", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if (!$employee_immigrationdocuments_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_immigrationdocuments_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_immigrationdocuments_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_immigrationdocuments_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_immigrationdocuments_add->terminate();
?>