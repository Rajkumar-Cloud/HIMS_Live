...
var fview_pharmacy_pharled_returnedit = currentForm = new ew.Form("fview_pharmacy_pharled_returnedit", "edit");
...
fview_pharmacy_pharled_returnedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($view_pharmacy_pharled_return_edit->sretid->Required) { ?>
		...
		<?php if ($view_pharmacy_pharled_return_edit->sprid->Required) { ?>
...
fview_pharmacy_pharled_returnedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_pharmacy_pharled_returnedit.lists["x_SLNO"] = <?php echo $view_pharmacy_pharled_return_edit->SLNO->Lookup->toClientList() ?>;
fview_pharmacy_pharled_returnedit.lists["x_SLNO"].options = <?php echo JsonEncode($view_pharmacy_pharled_return_edit->SLNO->lookupOptions()) ?>;
fview_pharmacy_pharled_returnedit.autoSuggests["x_SLNO"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php if ($view_pharmacy_pharled_return_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_pharmacy_pharled_return_edit->Token ?>">
<?php } ?>
...
<?php if ($view_pharmacy_pharled_return->TYPE->Visible) { // TYPE ?>
	<div id="r_TYPE" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_TYPE" for="x_TYPE" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->TYPE->caption() ?><?php echo ($view_pharmacy_pharled_return->TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->TYPE->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DN->Visible) { // DN ?>
	<div id="r_DN" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DN" for="x_DN" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DN->caption() ?><?php echo ($view_pharmacy_pharled_return->DN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DN->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->RDN->Visible) { // RDN ?>
	<div id="r_RDN" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_RDN" for="x_RDN" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->RDN->caption() ?><?php echo ($view_pharmacy_pharled_return->RDN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->RDN->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DT" for="x_DT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DT->caption() ?><?php echo ($view_pharmacy_pharled_return->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PRC" for="x_PRC" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PRC->caption() ?><?php echo ($view_pharmacy_pharled_return->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PRC->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_OQ" for="x_OQ" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->OQ->caption() ?><?php echo ($view_pharmacy_pharled_return->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->OQ->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->SiNo->Visible) { // SiNo ?>
	<div id="r_SiNo" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_SiNo" for="x_SiNo" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->SiNo->caption() ?><?php echo ($view_pharmacy_pharled_return->SiNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->SiNo->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_RQ" for="x_RQ" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->RQ->caption() ?><?php echo ($view_pharmacy_pharled_return->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->RQ->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->Product->Visible) { // Product ?>
	<div id="r_Product" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_Product" for="x_Product" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->Product->caption() ?><?php echo ($view_pharmacy_pharled_return->Product->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->Product->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->SLNO->Visible) { // SLNO ?>
	<div id="r_SLNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_SLNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->SLNO->caption() ?><?php echo ($view_pharmacy_pharled_return->SLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->SLNO->cellAttributes() ?>>
...
<script>
fview_pharmacy_pharled_returnedit.createAutoSuggest({"id":"x_SLNO","forceSelect":true});
</script>
...
<?php if ($view_pharmacy_pharled_return->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_RT" for="x_RT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->RT->caption() ?><?php echo ($view_pharmacy_pharled_return->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->RT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_MRQ" for="x_MRQ" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->MRQ->caption() ?><?php echo ($view_pharmacy_pharled_return->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->MRQ->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_IQ" for="x_IQ" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->IQ->caption() ?><?php echo ($view_pharmacy_pharled_return->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->IQ->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DAMT->Visible) { // DAMT ?>
	<div id="r_DAMT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DAMT" for="x_DAMT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DAMT->caption() ?><?php echo ($view_pharmacy_pharled_return->DAMT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DAMT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_BATCHNO" for="x_BATCHNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->BATCHNO->caption() ?><?php echo ($view_pharmacy_pharled_return->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->BATCHNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_EXPDT" for="x_EXPDT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->EXPDT->caption() ?><?php echo ($view_pharmacy_pharled_return->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->EXPDT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->Mfg->Visible) { // Mfg ?>
	<div id="r_Mfg" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_Mfg" for="x_Mfg" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->Mfg->caption() ?><?php echo ($view_pharmacy_pharled_return->Mfg->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->Mfg->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->BILLNO->Visible) { // BILLNO ?>
	<div id="r_BILLNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_BILLNO" for="x_BILLNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->BILLNO->caption() ?><?php echo ($view_pharmacy_pharled_return->BILLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->BILLNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->BILLDT->Visible) { // BILLDT ?>
	<div id="r_BILLDT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_BILLDT" for="x_BILLDT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->BILLDT->caption() ?><?php echo ($view_pharmacy_pharled_return->BILLDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->BILLDT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->VALUE->Visible) { // VALUE ?>
	<div id="r_VALUE" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_VALUE" for="x_VALUE" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->VALUE->caption() ?><?php echo ($view_pharmacy_pharled_return->VALUE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->VALUE->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DISC->Visible) { // DISC ?>
	<div id="r_DISC" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DISC" for="x_DISC" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DISC->caption() ?><?php echo ($view_pharmacy_pharled_return->DISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DISC->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_TAXP" for="x_TAXP" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->TAXP->caption() ?><?php echo ($view_pharmacy_pharled_return->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->TAXP->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->TAX->Visible) { // TAX ?>
	<div id="r_TAX" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_TAX" for="x_TAX" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->TAX->caption() ?><?php echo ($view_pharmacy_pharled_return->TAX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->TAX->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->TAXR->Visible) { // TAXR ?>
	<div id="r_TAXR" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_TAXR" for="x_TAXR" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->TAXR->caption() ?><?php echo ($view_pharmacy_pharled_return->TAXR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->TAXR->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->EMPNO->Visible) { // EMPNO ?>
	<div id="r_EMPNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_EMPNO" for="x_EMPNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->EMPNO->caption() ?><?php echo ($view_pharmacy_pharled_return->EMPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->EMPNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PC" for="x_PC" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PC->caption() ?><?php echo ($view_pharmacy_pharled_return->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PC->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DRNAME->Visible) { // DRNAME ?>
	<div id="r_DRNAME" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DRNAME" for="x_DRNAME" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DRNAME->caption() ?><?php echo ($view_pharmacy_pharled_return->DRNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DRNAME->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->BTIME->Visible) { // BTIME ?>
	<div id="r_BTIME" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_BTIME" for="x_BTIME" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->BTIME->caption() ?><?php echo ($view_pharmacy_pharled_return->BTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->BTIME->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->ONO->Visible) { // ONO ?>
	<div id="r_ONO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_ONO" for="x_ONO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->ONO->caption() ?><?php echo ($view_pharmacy_pharled_return->ONO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->ONO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->ODT->Visible) { // ODT ?>
	<div id="r_ODT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_ODT" for="x_ODT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->ODT->caption() ?><?php echo ($view_pharmacy_pharled_return->ODT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->ODT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PURRT->Visible) { // PURRT ?>
	<div id="r_PURRT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PURRT" for="x_PURRT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PURRT->caption() ?><?php echo ($view_pharmacy_pharled_return->PURRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PURRT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->GRP->Visible) { // GRP ?>
	<div id="r_GRP" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_GRP" for="x_GRP" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->GRP->caption() ?><?php echo ($view_pharmacy_pharled_return->GRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->GRP->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->IBATCH->Visible) { // IBATCH ?>
	<div id="r_IBATCH" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_IBATCH" for="x_IBATCH" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->IBATCH->caption() ?><?php echo ($view_pharmacy_pharled_return->IBATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->IBATCH->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->IPNO->Visible) { // IPNO ?>
	<div id="r_IPNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_IPNO" for="x_IPNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->IPNO->caption() ?><?php echo ($view_pharmacy_pharled_return->IPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->IPNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->OPNO->Visible) { // OPNO ?>
	<div id="r_OPNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_OPNO" for="x_OPNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->OPNO->caption() ?><?php echo ($view_pharmacy_pharled_return->OPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->OPNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->RECID->Visible) { // RECID ?>
	<div id="r_RECID" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_RECID" for="x_RECID" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->RECID->caption() ?><?php echo ($view_pharmacy_pharled_return->RECID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->RECID->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->FQTY->Visible) { // FQTY ?>
	<div id="r_FQTY" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_FQTY" for="x_FQTY" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->FQTY->caption() ?><?php echo ($view_pharmacy_pharled_return->FQTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->FQTY->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_UR" for="x_UR" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->UR->caption() ?><?php echo ($view_pharmacy_pharled_return->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->UR->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DCID->Visible) { // DCID ?>
	<div id="r_DCID" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DCID" for="x_DCID" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DCID->caption() ?><?php echo ($view_pharmacy_pharled_return->DCID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DCID->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->MODDT->Visible) { // MODDT ?>
	<div id="r_MODDT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_MODDT" for="x_MODDT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->MODDT->caption() ?><?php echo ($view_pharmacy_pharled_return->MODDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->MODDT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->FYM->Visible) { // FYM ?>
	<div id="r_FYM" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_FYM" for="x_FYM" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->FYM->caption() ?><?php echo ($view_pharmacy_pharled_return->FYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->FYM->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PRCBATCH->Visible) { // PRCBATCH ?>
	<div id="r_PRCBATCH" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PRCBATCH" for="x_PRCBATCH" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PRCBATCH->caption() ?><?php echo ($view_pharmacy_pharled_return->PRCBATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PRCBATCH->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_MRP" for="x_MRP" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->MRP->caption() ?><?php echo ($view_pharmacy_pharled_return->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->MRP->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->BILLYM->Visible) { // BILLYM ?>
	<div id="r_BILLYM" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_BILLYM" for="x_BILLYM" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->BILLYM->caption() ?><?php echo ($view_pharmacy_pharled_return->BILLYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->BILLYM->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->BILLGRP->Visible) { // BILLGRP ?>
	<div id="r_BILLGRP" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_BILLGRP" for="x_BILLGRP" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->BILLGRP->caption() ?><?php echo ($view_pharmacy_pharled_return->BILLGRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->BILLGRP->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->STAFF->Visible) { // STAFF ?>
	<div id="r_STAFF" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_STAFF" for="x_STAFF" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->STAFF->caption() ?><?php echo ($view_pharmacy_pharled_return->STAFF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->STAFF->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->TEMPIPNO->Visible) { // TEMPIPNO ?>
	<div id="r_TEMPIPNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_TEMPIPNO" for="x_TEMPIPNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->TEMPIPNO->caption() ?><?php echo ($view_pharmacy_pharled_return->TEMPIPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->TEMPIPNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PRNTED->Visible) { // PRNTED ?>
	<div id="r_PRNTED" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PRNTED" for="x_PRNTED" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PRNTED->caption() ?><?php echo ($view_pharmacy_pharled_return->PRNTED->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PRNTED->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PATNAME->Visible) { // PATNAME ?>
	<div id="r_PATNAME" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PATNAME" for="x_PATNAME" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PATNAME->caption() ?><?php echo ($view_pharmacy_pharled_return->PATNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PATNAME->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PJVNO->Visible) { // PJVNO ?>
	<div id="r_PJVNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PJVNO" for="x_PJVNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PJVNO->caption() ?><?php echo ($view_pharmacy_pharled_return->PJVNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PJVNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PJVSLNO->Visible) { // PJVSLNO ?>
	<div id="r_PJVSLNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PJVSLNO" for="x_PJVSLNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PJVSLNO->caption() ?><?php echo ($view_pharmacy_pharled_return->PJVSLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PJVSLNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->OTHDISC->Visible) { // OTHDISC ?>
	<div id="r_OTHDISC" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_OTHDISC" for="x_OTHDISC" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->OTHDISC->caption() ?><?php echo ($view_pharmacy_pharled_return->OTHDISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->OTHDISC->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PJVYM->Visible) { // PJVYM ?>
	<div id="r_PJVYM" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PJVYM" for="x_PJVYM" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PJVYM->caption() ?><?php echo ($view_pharmacy_pharled_return->PJVYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PJVYM->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PURDISCPER->Visible) { // PURDISCPER ?>
	<div id="r_PURDISCPER" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PURDISCPER" for="x_PURDISCPER" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PURDISCPER->caption() ?><?php echo ($view_pharmacy_pharled_return->PURDISCPER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PURDISCPER->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->CASHIER->Visible) { // CASHIER ?>
	<div id="r_CASHIER" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_CASHIER" for="x_CASHIER" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->CASHIER->caption() ?><?php echo ($view_pharmacy_pharled_return->CASHIER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->CASHIER->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->CASHTIME->Visible) { // CASHTIME ?>
	<div id="r_CASHTIME" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_CASHTIME" for="x_CASHTIME" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->CASHTIME->caption() ?><?php echo ($view_pharmacy_pharled_return->CASHTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->CASHTIME->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->CASHRECD->Visible) { // CASHRECD ?>
	<div id="r_CASHRECD" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_CASHRECD" for="x_CASHRECD" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->CASHRECD->caption() ?><?php echo ($view_pharmacy_pharled_return->CASHRECD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->CASHRECD->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->CASHREFNO->Visible) { // CASHREFNO ?>
	<div id="r_CASHREFNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_CASHREFNO" for="x_CASHREFNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->CASHREFNO->caption() ?><?php echo ($view_pharmacy_pharled_return->CASHREFNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->CASHREFNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->CASHIERSHIFT->Visible) { // CASHIERSHIFT ?>
	<div id="r_CASHIERSHIFT" class="form-group row">
		...
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->CASHIERSHIFT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PRCODE->Visible) { // PRCODE ?>
	<div id="r_PRCODE" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PRCODE" for="x_PRCODE" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PRCODE->caption() ?><?php echo ($view_pharmacy_pharled_return->PRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PRCODE->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->RELEASEBY->Visible) { // RELEASEBY ?>
	<div id="r_RELEASEBY" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_RELEASEBY" for="x_RELEASEBY" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->RELEASEBY->caption() ?><?php echo ($view_pharmacy_pharled_return->RELEASEBY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->RELEASEBY->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->CRAUTHOR->Visible) { // CRAUTHOR ?>
	<div id="r_CRAUTHOR" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_CRAUTHOR" for="x_CRAUTHOR" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->CRAUTHOR->caption() ?><?php echo ($view_pharmacy_pharled_return->CRAUTHOR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->CRAUTHOR->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PAYMENT->Visible) { // PAYMENT ?>
	<div id="r_PAYMENT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PAYMENT" for="x_PAYMENT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PAYMENT->caption() ?><?php echo ($view_pharmacy_pharled_return->PAYMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PAYMENT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DRID->Visible) { // DRID ?>
	<div id="r_DRID" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DRID" for="x_DRID" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DRID->caption() ?><?php echo ($view_pharmacy_pharled_return->DRID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DRID->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->WARD->Visible) { // WARD ?>
	<div id="r_WARD" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_WARD" for="x_WARD" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->WARD->caption() ?><?php echo ($view_pharmacy_pharled_return->WARD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->WARD->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->STAXTYPE->Visible) { // STAXTYPE ?>
	<div id="r_STAXTYPE" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_STAXTYPE" for="x_STAXTYPE" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->STAXTYPE->caption() ?><?php echo ($view_pharmacy_pharled_return->STAXTYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->STAXTYPE->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PURDISCVAL->Visible) { // PURDISCVAL ?>
	<div id="r_PURDISCVAL" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PURDISCVAL" for="x_PURDISCVAL" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PURDISCVAL->caption() ?><?php echo ($view_pharmacy_pharled_return->PURDISCVAL->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PURDISCVAL->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->RNDOFF->Visible) { // RNDOFF ?>
	<div id="r_RNDOFF" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_RNDOFF" for="x_RNDOFF" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->RNDOFF->caption() ?><?php echo ($view_pharmacy_pharled_return->RNDOFF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->RNDOFF->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DISCONMRP->Visible) { // DISCONMRP ?>
	<div id="r_DISCONMRP" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DISCONMRP" for="x_DISCONMRP" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DISCONMRP->caption() ?><?php echo ($view_pharmacy_pharled_return->DISCONMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DISCONMRP->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DELVDT->Visible) { // DELVDT ?>
	<div id="r_DELVDT" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DELVDT" for="x_DELVDT" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DELVDT->caption() ?><?php echo ($view_pharmacy_pharled_return->DELVDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DELVDT->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DELVTIME->Visible) { // DELVTIME ?>
	<div id="r_DELVTIME" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DELVTIME" for="x_DELVTIME" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DELVTIME->caption() ?><?php echo ($view_pharmacy_pharled_return->DELVTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DELVTIME->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->DELVBY->Visible) { // DELVBY ?>
	<div id="r_DELVBY" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_DELVBY" for="x_DELVBY" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->DELVBY->caption() ?><?php echo ($view_pharmacy_pharled_return->DELVBY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->DELVBY->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->HOSPNO->Visible) { // HOSPNO ?>
	<div id="r_HOSPNO" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_HOSPNO" for="x_HOSPNO" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->HOSPNO->caption() ?><?php echo ($view_pharmacy_pharled_return->HOSPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->HOSPNO->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_id" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->id->caption() ?><?php echo ($view_pharmacy_pharled_return->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->id->cellAttributes() ?>>
...
<input type="hidden" data-table="view_pharmacy_pharled_return" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($view_pharmacy_pharled_return->id->CurrentValue) ?>">
<?php echo $view_pharmacy_pharled_return->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_pharmacy_pharled_return->pbv->Visible) { // pbv ?>
	<div id="r_pbv" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_pbv" for="x_pbv" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->pbv->caption() ?><?php echo ($view_pharmacy_pharled_return->pbv->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->pbv->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->pbt->Visible) { // pbt ?>
	<div id="r_pbt" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_pbt" for="x_pbt" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->pbt->caption() ?><?php echo ($view_pharmacy_pharled_return->pbt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->pbt->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_MFRCODE" for="x_MFRCODE" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->MFRCODE->caption() ?><?php echo ($view_pharmacy_pharled_return->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->MFRCODE->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_Reception" for="x_Reception" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->Reception->caption() ?><?php echo ($view_pharmacy_pharled_return->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->Reception->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_PatID" for="x_PatID" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->PatID->caption() ?><?php echo ($view_pharmacy_pharled_return->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->PatID->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_mrnno" for="x_mrnno" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->mrnno->caption() ?><?php echo ($view_pharmacy_pharled_return->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->mrnno->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->sretid->Visible) { // sretid ?>
	<div id="r_sretid" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_sretid" for="x_sretid" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->sretid->caption() ?><?php echo ($view_pharmacy_pharled_return->sretid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->sretid->cellAttributes() ?>>
...
<?php if ($view_pharmacy_pharled_return->sprid->Visible) { // sprid ?>
	<div id="r_sprid" class="form-group row">
		<label id="elh_view_pharmacy_pharled_return_sprid" for="x_sprid" class="<?php echo $view_pharmacy_pharled_return_edit->LeftColumnClass ?>"><?php echo $view_pharmacy_pharled_return->sprid->caption() ?><?php echo ($view_pharmacy_pharled_return->sprid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacy_pharled_return_edit->RightColumnClass ?>"><div<?php echo $view_pharmacy_pharled_return->sprid->cellAttributes() ?>>
