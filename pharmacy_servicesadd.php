...
var fpharmacy_servicesadd = currentForm = new ew.Form("fpharmacy_servicesadd", "add");
...
fpharmacy_servicesadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_services_add->createdby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $pharmacy_services->createdby->caption(), $pharmacy_services->createdby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($pharmacy_services_add->createddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_createddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $pharmacy_services->createddatetime->caption(), $pharmacy_services->createddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fpharmacy_servicesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_servicesadd.lists["x_pharmacy_id"] = <?php echo $pharmacy_services_add->pharmacy_id->Lookup->toClientList() ?>;
fpharmacy_servicesadd.lists["x_pharmacy_id"].options = <?php echo JsonEncode($pharmacy_services_add->pharmacy_id->lookupOptions()) ?>;
fpharmacy_servicesadd.lists["x_name"] = <?php echo $pharmacy_services_add->name->Lookup->toClientList() ?>;
fpharmacy_servicesadd.lists["x_name"].options = <?php echo JsonEncode($pharmacy_services_add->name->lookupOptions()) ?>;
fpharmacy_servicesadd.lists["x_status"] = <?php echo $pharmacy_services_add->status->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_services_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_services_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_services->pharmacy_id->Visible) { // pharmacy_id ?>
	<div id="r_pharmacy_id" class="form-group row">
		<label id="elh_pharmacy_services_pharmacy_id" for="x_pharmacy_id" class="<?php echo $pharmacy_services_add->LeftColumnClass ?>"><?php echo $pharmacy_services->pharmacy_id->caption() ?><?php echo ($pharmacy_services->pharmacy_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_services_add->RightColumnClass ?>"><div<?php echo $pharmacy_services->pharmacy_id->cellAttributes() ?>>
...
<?php if ($pharmacy_services->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_pharmacy_services_patient_id" for="x_patient_id" class="<?php echo $pharmacy_services_add->LeftColumnClass ?>"><?php echo $pharmacy_services->patient_id->caption() ?><?php echo ($pharmacy_services->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_services_add->RightColumnClass ?>"><div<?php echo $pharmacy_services->patient_id->cellAttributes() ?>>
...
<?php if ($pharmacy_services->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_pharmacy_services_name" for="x_name" class="<?php echo $pharmacy_services_add->LeftColumnClass ?>"><?php echo $pharmacy_services->name->caption() ?><?php echo ($pharmacy_services->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_services_add->RightColumnClass ?>"><div<?php echo $pharmacy_services->name->cellAttributes() ?>>
...
<?php if ($pharmacy_services->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group row">
		<label id="elh_pharmacy_services_amount" for="x_amount" class="<?php echo $pharmacy_services_add->LeftColumnClass ?>"><?php echo $pharmacy_services->amount->caption() ?><?php echo ($pharmacy_services->amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_services_add->RightColumnClass ?>"><div<?php echo $pharmacy_services->amount->cellAttributes() ?>>
...
<?php if ($pharmacy_services->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_pharmacy_services_description" for="x_description" class="<?php echo $pharmacy_services_add->LeftColumnClass ?>"><?php echo $pharmacy_services->description->caption() ?><?php echo ($pharmacy_services->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_services_add->RightColumnClass ?>"><div<?php echo $pharmacy_services->description->cellAttributes() ?>>
...
<?php if ($pharmacy_services->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_pharmacy_services_status" for="x_status" class="<?php echo $pharmacy_services_add->LeftColumnClass ?>"><?php echo $pharmacy_services->status->caption() ?><?php echo ($pharmacy_services->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_services_add->RightColumnClass ?>"><div<?php echo $pharmacy_services->status->cellAttributes() ?>>
