...
// Create page object
$employee_immigrations_edit = new employee_immigrations_edit();

// Run the page
$employee_immigrations_edit->run();
...
$employee_immigrations_edit->Page_Render();
?>
...
var femployee_immigrationsedit = currentForm = new ew.Form("femployee_immigrationsedit", "edit");
...
femployee_immigrationsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_immigrations_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_immigrations->id->caption(), $employee_immigrations->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_immigrations_edit->employee->Required) { ?>
		...
		<?php if ($employee_immigrations_edit->document->Required) { ?>
		...
		<?php if ($employee_immigrations_edit->documentname->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrations_edit->valid_until->Required) { ?>
		...
		<?php if ($employee_immigrations_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrations_edit->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrations_edit->attachment1->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrations_edit->attachment2->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrations_edit->attachment3->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_immigrations_edit->created->Required) { ?>
		...
		<?php if ($employee_immigrations_edit->updated->Required) { ?>
...
femployee_immigrationsedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_immigrationsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_immigrationsedit.lists["x_status"] = <?php echo $employee_immigrations_edit->status->Lookup->toClientList() ?>;
femployee_immigrationsedit.lists["x_status"].options = <?php echo JsonEncode($employee_immigrations_edit->status->options(FALSE, TRUE)) ?>;
...
<?php $employee_immigrations_edit->showPageHeader(); ?>
<?php
$employee_immigrations_edit->showMessage();
?>
<form name="femployee_immigrationsedit" id="femployee_immigrationsedit" class="<?php echo $employee_immigrations_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_immigrations_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_immigrations_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_immigrations">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$employee_immigrations_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($employee_immigrations->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_employee_immigrations_id" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->id->caption() ?><?php echo ($employee_immigrations->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->id->cellAttributes() ?>>
<span id="el_employee_immigrations_id">
<span<?php echo $employee_immigrations->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($employee_immigrations->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="employee_immigrations" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($employee_immigrations->id->CurrentValue) ?>">
<?php echo $employee_immigrations->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($employee_immigrations->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employee_immigrations_employee" for="x_employee" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->employee->caption() ?><?php echo ($employee_immigrations->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->employee->cellAttributes() ?>>
...
<?php if ($employee_immigrations->document->Visible) { // document ?>
	<div id="r_document" class="form-group row">
		<label id="elh_employee_immigrations_document" for="x_document" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->document->caption() ?><?php echo ($employee_immigrations->document->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->document->cellAttributes() ?>>
...
<?php if ($employee_immigrations->documentname->Visible) { // documentname ?>
	<div id="r_documentname" class="form-group row">
		<label id="elh_employee_immigrations_documentname" for="x_documentname" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->documentname->caption() ?><?php echo ($employee_immigrations->documentname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->documentname->cellAttributes() ?>>
...
<?php if ($employee_immigrations->valid_until->Visible) { // valid_until ?>
	<div id="r_valid_until" class="form-group row">
		<label id="elh_employee_immigrations_valid_until" for="x_valid_until" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->valid_until->caption() ?><?php echo ($employee_immigrations->valid_until->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->valid_until->cellAttributes() ?>>
...
<?php if ($employee_immigrations->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_immigrations_status" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->status->caption() ?><?php echo ($employee_immigrations->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->status->cellAttributes() ?>>
...
<?php if ($employee_immigrations->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_employee_immigrations_details" for="x_details" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->details->caption() ?><?php echo ($employee_immigrations->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->details->cellAttributes() ?>>
...
<?php if ($employee_immigrations->attachment1->Visible) { // attachment1 ?>
	<div id="r_attachment1" class="form-group row">
		<label id="elh_employee_immigrations_attachment1" for="x_attachment1" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->attachment1->caption() ?><?php echo ($employee_immigrations->attachment1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->attachment1->cellAttributes() ?>>
...
<?php if ($employee_immigrations->attachment2->Visible) { // attachment2 ?>
	<div id="r_attachment2" class="form-group row">
		<label id="elh_employee_immigrations_attachment2" for="x_attachment2" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->attachment2->caption() ?><?php echo ($employee_immigrations->attachment2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->attachment2->cellAttributes() ?>>
...
<?php if ($employee_immigrations->attachment3->Visible) { // attachment3 ?>
	<div id="r_attachment3" class="form-group row">
		<label id="elh_employee_immigrations_attachment3" for="x_attachment3" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->attachment3->caption() ?><?php echo ($employee_immigrations->attachment3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->attachment3->cellAttributes() ?>>
...
<?php if ($employee_immigrations->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_employee_immigrations_created" for="x_created" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->created->caption() ?><?php echo ($employee_immigrations->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->created->cellAttributes() ?>>
...
<?php if ($employee_immigrations->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_employee_immigrations_updated" for="x_updated" class="<?php echo $employee_immigrations_edit->LeftColumnClass ?>"><?php echo $employee_immigrations->updated->caption() ?><?php echo ($employee_immigrations->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_immigrations_edit->RightColumnClass ?>"><div<?php echo $employee_immigrations->updated->cellAttributes() ?>>
...
<?php if (!$employee_immigrations_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_immigrations_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_immigrations_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_immigrations_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_immigrations_edit->terminate();
?>