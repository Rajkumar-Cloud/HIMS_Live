...
var fpharmacy_purchaseorderadd = currentForm = new ew.Form("fpharmacy_purchaseorderadd", "add");
...
fpharmacy_purchaseorderadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_purchaseorder_add->grndate->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_purchaseorder_add->grndatetime->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_purchaseorder_add->strid->Required) { ?>
		...
		<?php if ($pharmacy_purchaseorder_add->GRNPer->Required) { ?>
		...
		<?php if ($pharmacy_purchaseorder_add->FreeQtyyy->Required) { ?>
...
fpharmacy_purchaseorderadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_purchaseorderadd.lists["x_PRC"] = <?php echo $pharmacy_purchaseorder_add->PRC->Lookup->toClientList() ?>;
...
fpharmacy_purchaseorderadd.lists["x_PC"] = <?php echo $pharmacy_purchaseorder_add->PC->Lookup->toClientList() ?>;
fpharmacy_purchaseorderadd.lists["x_PC"].options = <?php echo JsonEncode($pharmacy_purchaseorder_add->PC->lookupOptions()) ?>;
fpharmacy_purchaseorderadd.lists["x_Received[]"] = <?php echo $pharmacy_purchaseorder_add->Received->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_purchaseorder_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_purchaseorder_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_purchaseorder->ORDNO->Visible) { // ORDNO ?>
	<div id="r_ORDNO" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_ORDNO" for="x_ORDNO" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->ORDNO->caption() ?><?php echo ($pharmacy_purchaseorder->ORDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->ORDNO->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_PRC" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->PRC->caption() ?><?php echo ($pharmacy_purchaseorder->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->PRC->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->QTY->Visible) { // QTY ?>
	<div id="r_QTY" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_QTY" for="x_QTY" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->QTY->caption() ?><?php echo ($pharmacy_purchaseorder->QTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->QTY->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_DT" for="x_DT" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->DT->caption() ?><?php echo ($pharmacy_purchaseorder->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->DT->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_PC" for="x_PC" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->PC->caption() ?><?php echo ($pharmacy_purchaseorder->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->PC->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_YM" for="x_YM" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->YM->caption() ?><?php echo ($pharmacy_purchaseorder->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->YM->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_MFRCODE" for="x_MFRCODE" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->MFRCODE->caption() ?><?php echo ($pharmacy_purchaseorder->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->MFRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->Stock->Visible) { // Stock ?>
	<div id="r_Stock" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_Stock" for="x_Stock" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->Stock->caption() ?><?php echo ($pharmacy_purchaseorder->Stock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->Stock->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->LastMonthSale->Visible) { // LastMonthSale ?>
	<div id="r_LastMonthSale" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_LastMonthSale" for="x_LastMonthSale" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->LastMonthSale->caption() ?><?php echo ($pharmacy_purchaseorder->LastMonthSale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->LastMonthSale->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->Printcheck->Visible) { // Printcheck ?>
	<div id="r_Printcheck" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_Printcheck" for="x_Printcheck" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->Printcheck->caption() ?><?php echo ($pharmacy_purchaseorder->Printcheck->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->Printcheck->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->poid->Visible) { // poid ?>
	<div id="r_poid" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_poid" for="x_poid" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->poid->caption() ?><?php echo ($pharmacy_purchaseorder->poid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->poid->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_PSGST" for="x_PSGST" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->PSGST->caption() ?><?php echo ($pharmacy_purchaseorder->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->PSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_PCGST" for="x_PCGST" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->PCGST->caption() ?><?php echo ($pharmacy_purchaseorder->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->PCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_SSGST" for="x_SSGST" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->SSGST->caption() ?><?php echo ($pharmacy_purchaseorder->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->SSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_SCGST" for="x_SCGST" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->SCGST->caption() ?><?php echo ($pharmacy_purchaseorder->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->SCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_BRCODE" for="x_BRCODE" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->BRCODE->caption() ?><?php echo ($pharmacy_purchaseorder->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->BRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->HSN->Visible) { // HSN ?>
	<div id="r_HSN" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_HSN" for="x_HSN" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->HSN->caption() ?><?php echo ($pharmacy_purchaseorder->HSN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->HSN->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->Pack->Visible) { // Pack ?>
	<div id="r_Pack" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_Pack" for="x_Pack" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->Pack->caption() ?><?php echo ($pharmacy_purchaseorder->Pack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->Pack->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_PUnit" for="x_PUnit" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->PUnit->caption() ?><?php echo ($pharmacy_purchaseorder->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->PUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_SUnit" for="x_SUnit" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->SUnit->caption() ?><?php echo ($pharmacy_purchaseorder->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->SUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->GrnQuantity->Visible) { // GrnQuantity ?>
	<div id="r_GrnQuantity" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_GrnQuantity" for="x_GrnQuantity" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->GrnQuantity->caption() ?><?php echo ($pharmacy_purchaseorder->GrnQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->GrnQuantity->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->GrnMRP->Visible) { // GrnMRP ?>
	<div id="r_GrnMRP" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_GrnMRP" for="x_GrnMRP" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->GrnMRP->caption() ?><?php echo ($pharmacy_purchaseorder->GrnMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->GrnMRP->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->trid->Visible) { // trid ?>
	<div id="r_trid" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_trid" for="x_trid" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->trid->caption() ?><?php echo ($pharmacy_purchaseorder->trid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->trid->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->grncreatedby->Visible) { // grncreatedby ?>
	<div id="r_grncreatedby" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_grncreatedby" for="x_grncreatedby" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->grncreatedby->caption() ?><?php echo ($pharmacy_purchaseorder->grncreatedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->grncreatedby->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->grncreatedDateTime->Visible) { // grncreatedDateTime ?>
	<div id="r_grncreatedDateTime" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_grncreatedDateTime" for="x_grncreatedDateTime" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->grncreatedDateTime->caption() ?><?php echo ($pharmacy_purchaseorder->grncreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->grncreatedDateTime->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->grnModifiedby->Visible) { // grnModifiedby ?>
	<div id="r_grnModifiedby" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_grnModifiedby" for="x_grnModifiedby" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->grnModifiedby->caption() ?><?php echo ($pharmacy_purchaseorder->grnModifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->grnModifiedby->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->grnModifiedDateTime->Visible) { // grnModifiedDateTime ?>
	<div id="r_grnModifiedDateTime" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_grnModifiedDateTime" for="x_grnModifiedDateTime" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->grnModifiedDateTime->caption() ?><?php echo ($pharmacy_purchaseorder->grnModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->grnModifiedDateTime->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->Received->Visible) { // Received ?>
	<div id="r_Received" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_Received" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->Received->caption() ?><?php echo ($pharmacy_purchaseorder->Received->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->Received->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->BillDate->Visible) { // BillDate ?>
	<div id="r_BillDate" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_BillDate" for="x_BillDate" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->BillDate->caption() ?><?php echo ($pharmacy_purchaseorder->BillDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->BillDate->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->CurStock->Visible) { // CurStock ?>
	<div id="r_CurStock" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_CurStock" for="x_CurStock" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->CurStock->caption() ?><?php echo ($pharmacy_purchaseorder->CurStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->CurStock->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->strid->Visible) { // strid ?>
	<div id="r_strid" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_strid" for="x_strid" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->strid->caption() ?><?php echo ($pharmacy_purchaseorder->strid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->strid->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->GRNPer->Visible) { // GRNPer ?>
	<div id="r_GRNPer" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_GRNPer" for="x_GRNPer" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->GRNPer->caption() ?><?php echo ($pharmacy_purchaseorder->GRNPer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->GRNPer->cellAttributes() ?>>
...
<?php if ($pharmacy_purchaseorder->FreeQtyyy->Visible) { // FreeQtyyy ?>
	<div id="r_FreeQtyyy" class="form-group row">
		<label id="elh_pharmacy_purchaseorder_FreeQtyyy" for="x_FreeQtyyy" class="<?php echo $pharmacy_purchaseorder_add->LeftColumnClass ?>"><?php echo $pharmacy_purchaseorder->FreeQtyyy->caption() ?><?php echo ($pharmacy_purchaseorder->FreeQtyyy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_purchaseorder_add->RightColumnClass ?>"><div<?php echo $pharmacy_purchaseorder->FreeQtyyy->cellAttributes() ?>>
