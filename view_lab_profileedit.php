...
var fview_lab_profileedit = currentForm = new ew.Form("fview_lab_profileedit", "edit");
...
fview_lab_profileedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_lab_profile_edit->Modified->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_lab_profile->Modified->caption(), $view_lab_profile->Modified->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($view_lab_profile_edit->ModifiedDateTime->Required) { ?>
			elm = this.getElements("x" + infix + "_ModifiedDateTime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_lab_profile->ModifiedDateTime->caption(), $view_lab_profile->ModifiedDateTime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fview_lab_profileedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_lab_profileedit.lists["x_SERVICE_TYPE"] = <?php echo $view_lab_profile_edit->SERVICE_TYPE->Lookup->toClientList() ?>;
fview_lab_profileedit.lists["x_SERVICE_TYPE"].options = <?php echo JsonEncode($view_lab_profile_edit->SERVICE_TYPE->lookupOptions()) ?>;
fview_lab_profileedit.lists["x_DEPARTMENT"] = <?php echo $view_lab_profile_edit->DEPARTMENT->Lookup->toClientList() ?>;
fview_lab_profileedit.lists["x_DEPARTMENT"].options = <?php echo JsonEncode($view_lab_profile_edit->DEPARTMENT->lookupOptions()) ?>;
fview_lab_profileedit.lists["x_TestType"] = <?php echo $view_lab_profile_edit->TestType->Lookup->toClientList() ?>;
...
<?php if ($view_lab_profile_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_lab_profile_edit->Token ?>">
<?php } ?>
...
<?php if ($view_lab_profile->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group row">
		<label id="elh_view_lab_profile_Id" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Id" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Id->caption() ?><?php echo ($view_lab_profile->Id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Id->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Id" class="view_lab_profileedit" type="text/html">
...
<input type="hidden" data-table="view_lab_profile" data-field="x_Id" name="x_Id" id="x_Id" value="<?php echo HtmlEncode($view_lab_profile->Id->CurrentValue) ?>">
<?php echo $view_lab_profile->Id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_lab_profile->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_view_lab_profile_CODE" for="x_CODE" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_CODE" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->CODE->caption() ?><?php echo ($view_lab_profile->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->CODE->cellAttributes() ?>>
<script id="tpx_view_lab_profile_CODE" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->SERVICE->Visible) { // SERVICE ?>
	<div id="r_SERVICE" class="form-group row">
		<label id="elh_view_lab_profile_SERVICE" for="x_SERVICE" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_SERVICE" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->SERVICE->caption() ?><?php echo ($view_lab_profile->SERVICE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->SERVICE->cellAttributes() ?>>
<script id="tpx_view_lab_profile_SERVICE" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->UNITS->Visible) { // UNITS ?>
	<div id="r_UNITS" class="form-group row">
		<label id="elh_view_lab_profile_UNITS" for="x_UNITS" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_UNITS" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->UNITS->caption() ?><?php echo ($view_lab_profile->UNITS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->UNITS->cellAttributes() ?>>
<script id="tpx_view_lab_profile_UNITS" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->AMOUNT->Visible) { // AMOUNT ?>
	<div id="r_AMOUNT" class="form-group row">
		<label id="elh_view_lab_profile_AMOUNT" for="x_AMOUNT" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_AMOUNT" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->AMOUNT->caption() ?><?php echo ($view_lab_profile->AMOUNT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->AMOUNT->cellAttributes() ?>>
<script id="tpx_view_lab_profile_AMOUNT" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
	<div id="r_SERVICE_TYPE" class="form-group row">
		<label id="elh_view_lab_profile_SERVICE_TYPE" for="x_SERVICE_TYPE" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_SERVICE_TYPE" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->SERVICE_TYPE->caption() ?><?php echo ($view_lab_profile->SERVICE_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->SERVICE_TYPE->cellAttributes() ?>>
<script id="tpx_view_lab_profile_SERVICE_TYPE" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->DEPARTMENT->Visible) { // DEPARTMENT ?>
	<div id="r_DEPARTMENT" class="form-group row">
		<label id="elh_view_lab_profile_DEPARTMENT" for="x_DEPARTMENT" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_DEPARTMENT" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->DEPARTMENT->caption() ?><?php echo ($view_lab_profile->DEPARTMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->DEPARTMENT->cellAttributes() ?>>
<script id="tpx_view_lab_profile_DEPARTMENT" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
	<div id="r_mas_services_billingcol" class="form-group row">
		<label id="elh_view_lab_profile_mas_services_billingcol" for="x_mas_services_billingcol" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_mas_services_billingcol" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->mas_services_billingcol->caption() ?><?php echo ($view_lab_profile->mas_services_billingcol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->mas_services_billingcol->cellAttributes() ?>>
<script id="tpx_view_lab_profile_mas_services_billingcol" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->DrShareAmount->Visible) { // DrShareAmount ?>
	<div id="r_DrShareAmount" class="form-group row">
		<label id="elh_view_lab_profile_DrShareAmount" for="x_DrShareAmount" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_DrShareAmount" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->DrShareAmount->caption() ?><?php echo ($view_lab_profile->DrShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->DrShareAmount->cellAttributes() ?>>
<script id="tpx_view_lab_profile_DrShareAmount" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->HospShareAmount->Visible) { // HospShareAmount ?>
	<div id="r_HospShareAmount" class="form-group row">
		<label id="elh_view_lab_profile_HospShareAmount" for="x_HospShareAmount" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_HospShareAmount" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->HospShareAmount->caption() ?><?php echo ($view_lab_profile->HospShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->HospShareAmount->cellAttributes() ?>>
<script id="tpx_view_lab_profile_HospShareAmount" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->DrSharePer->Visible) { // DrSharePer ?>
	<div id="r_DrSharePer" class="form-group row">
		<label id="elh_view_lab_profile_DrSharePer" for="x_DrSharePer" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_DrSharePer" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->DrSharePer->caption() ?><?php echo ($view_lab_profile->DrSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->DrSharePer->cellAttributes() ?>>
<script id="tpx_view_lab_profile_DrSharePer" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->HospSharePer->Visible) { // HospSharePer ?>
	<div id="r_HospSharePer" class="form-group row">
		<label id="elh_view_lab_profile_HospSharePer" for="x_HospSharePer" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_HospSharePer" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->HospSharePer->caption() ?><?php echo ($view_lab_profile->HospSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->HospSharePer->cellAttributes() ?>>
<script id="tpx_view_lab_profile_HospSharePer" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_view_lab_profile_TestSubCd" for="x_TestSubCd" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_TestSubCd" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->TestSubCd->caption() ?><?php echo ($view_lab_profile->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->TestSubCd->cellAttributes() ?>>
<script id="tpx_view_lab_profile_TestSubCd" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_view_lab_profile_Method" for="x_Method" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Method" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Method->caption() ?><?php echo ($view_lab_profile->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Method->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Method" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_view_lab_profile_Order" for="x_Order" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Order" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Order->caption() ?><?php echo ($view_lab_profile->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Order->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Order" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_view_lab_profile_Form" for="x_Form" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Form" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Form->caption() ?><?php echo ($view_lab_profile->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Form->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Form" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_view_lab_profile_ResType" for="x_ResType" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_ResType" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->ResType->caption() ?><?php echo ($view_lab_profile->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->ResType->cellAttributes() ?>>
<script id="tpx_view_lab_profile_ResType" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->UnitCD->Visible) { // UnitCD ?>
	<div id="r_UnitCD" class="form-group row">
		<label id="elh_view_lab_profile_UnitCD" for="x_UnitCD" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_UnitCD" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->UnitCD->caption() ?><?php echo ($view_lab_profile->UnitCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->UnitCD->cellAttributes() ?>>
<script id="tpx_view_lab_profile_UnitCD" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_view_lab_profile_RefValue" for="x_RefValue" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_RefValue" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->RefValue->caption() ?><?php echo ($view_lab_profile->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->RefValue->cellAttributes() ?>>
<script id="tpx_view_lab_profile_RefValue" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_view_lab_profile_Sample" for="x_Sample" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Sample" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Sample->caption() ?><?php echo ($view_lab_profile->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Sample->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Sample" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_view_lab_profile_NoD" for="x_NoD" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_NoD" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->NoD->caption() ?><?php echo ($view_lab_profile->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->NoD->cellAttributes() ?>>
<script id="tpx_view_lab_profile_NoD" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_view_lab_profile_BillOrder" for="x_BillOrder" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_BillOrder" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->BillOrder->caption() ?><?php echo ($view_lab_profile->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->BillOrder->cellAttributes() ?>>
<script id="tpx_view_lab_profile_BillOrder" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_view_lab_profile_Formula" for="x_Formula" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Formula" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Formula->caption() ?><?php echo ($view_lab_profile->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Formula->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Formula" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_view_lab_profile_Inactive" for="x_Inactive" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Inactive" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Inactive->caption() ?><?php echo ($view_lab_profile->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Inactive->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Inactive" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Outsource->Visible) { // Outsource ?>
	<div id="r_Outsource" class="form-group row">
		<label id="elh_view_lab_profile_Outsource" for="x_Outsource" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Outsource" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Outsource->caption() ?><?php echo ($view_lab_profile->Outsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Outsource->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Outsource" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_view_lab_profile_CollSample" for="x_CollSample" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_CollSample" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->CollSample->caption() ?><?php echo ($view_lab_profile->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->CollSample->cellAttributes() ?>>
<script id="tpx_view_lab_profile_CollSample" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->TestType->Visible) { // TestType ?>
	<div id="r_TestType" class="form-group row">
		<label id="elh_view_lab_profile_TestType" for="x_TestType" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_TestType" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->TestType->caption() ?><?php echo ($view_lab_profile->TestType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->TestType->cellAttributes() ?>>
<script id="tpx_view_lab_profile_TestType" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->NoHeading->Visible) { // NoHeading ?>
	<div id="r_NoHeading" class="form-group row">
		<label id="elh_view_lab_profile_NoHeading" for="x_NoHeading" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_NoHeading" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->NoHeading->caption() ?><?php echo ($view_lab_profile->NoHeading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->NoHeading->cellAttributes() ?>>
<script id="tpx_view_lab_profile_NoHeading" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->ChemicalCode->Visible) { // ChemicalCode ?>
	<div id="r_ChemicalCode" class="form-group row">
		<label id="elh_view_lab_profile_ChemicalCode" for="x_ChemicalCode" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_ChemicalCode" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->ChemicalCode->caption() ?><?php echo ($view_lab_profile->ChemicalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->ChemicalCode->cellAttributes() ?>>
<script id="tpx_view_lab_profile_ChemicalCode" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->ChemicalName->Visible) { // ChemicalName ?>
	<div id="r_ChemicalName" class="form-group row">
		<label id="elh_view_lab_profile_ChemicalName" for="x_ChemicalName" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_ChemicalName" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->ChemicalName->caption() ?><?php echo ($view_lab_profile->ChemicalName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->ChemicalName->cellAttributes() ?>>
<script id="tpx_view_lab_profile_ChemicalName" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Utilaization->Visible) { // Utilaization ?>
	<div id="r_Utilaization" class="form-group row">
		<label id="elh_view_lab_profile_Utilaization" for="x_Utilaization" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Utilaization" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Utilaization->caption() ?><?php echo ($view_lab_profile->Utilaization->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Utilaization->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Utilaization" class="view_lab_profileedit" type="text/html">
...
<?php if ($view_lab_profile->Interpretation->Visible) { // Interpretation ?>
	<div id="r_Interpretation" class="form-group row">
		<label id="elh_view_lab_profile_Interpretation" class="<?php echo $view_lab_profile_edit->LeftColumnClass ?>"><script id="tpc_view_lab_profile_Interpretation" class="view_lab_profileedit" type="text/html"><span><?php echo $view_lab_profile->Interpretation->caption() ?><?php echo ($view_lab_profile->Interpretation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_profile_edit->RightColumnClass ?>"><div<?php echo $view_lab_profile->Interpretation->cellAttributes() ?>>
<script id="tpx_view_lab_profile_Interpretation" class="view_lab_profileedit" type="text/html">
...
ew.createEditor("fview_lab_profileedit", "x_Interpretation", 35, 4, <?php echo ($view_lab_profile->Interpretation->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
ew.applyTemplate("tpd_view_lab_profileedit", "tpm_view_lab_profileedit", "view_lab_profileedit", "<?php echo $view_lab_profile->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_lab_profileedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
