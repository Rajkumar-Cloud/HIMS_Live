...
<?php if ($view_pharmacy_purchase_request_approved->id->Visible) { // id ?>
		<tr id="r_id">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_id" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->id->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->id->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_id" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->DT->Visible) { // DT ?>
		<tr id="r_DT">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_DT" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->DT->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->DT->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_DT" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->EmployeeName->Visible) { // EmployeeName ?>
		<tr id="r_EmployeeName">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_EmployeeName" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->EmployeeName->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->EmployeeName->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_EmployeeName" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->Department->Visible) { // Department ?>
		<tr id="r_Department">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_Department" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->Department->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->Department->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_Department" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->ApprovedStatus->Visible) { // ApprovedStatus ?>
		<tr id="r_ApprovedStatus">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_ApprovedStatus" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->ApprovedStatus->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->ApprovedStatus->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_ApprovedStatus" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->PurchaseStatus->Visible) { // PurchaseStatus ?>
		<tr id="r_PurchaseStatus">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_PurchaseStatus" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->PurchaseStatus->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->PurchaseStatus->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_PurchaseStatus" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->HospID->Visible) { // HospID ?>
		<tr id="r_HospID">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_HospID" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->HospID->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->HospID->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_HospID" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->createdby->Visible) { // createdby ?>
		<tr id="r_createdby">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_createdby" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->createdby->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->createdby->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_createdby" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->createddatetime->Visible) { // createddatetime ?>
		<tr id="r_createddatetime">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_createddatetime" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->createddatetime->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->createddatetime->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_createddatetime" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->modifiedby->Visible) { // modifiedby ?>
		<tr id="r_modifiedby">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_modifiedby" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->modifiedby->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->modifiedby->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_modifiedby" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->modifieddatetime->Visible) { // modifieddatetime ?>
		<tr id="r_modifieddatetime">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_modifieddatetime" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->modifieddatetime->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->modifieddatetime->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_modifieddatetime" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_approved->BRCODE->Visible) { // BRCODE ?>
		<tr id="r_BRCODE">
			<td class="<?php echo $view_pharmacy_purchase_request_approved->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_approved_BRCODE" class="view_pharmacy_purchase_request_approvedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_approved->BRCODE->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_approved->BRCODE->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_approved_BRCODE" class="view_pharmacy_purchase_request_approvedmaster" type="text/html">
...
ew.applyTemplate("tpd_view_pharmacy_purchase_request_approvedmaster", "tpm_view_pharmacy_purchase_request_approvedmaster", "view_pharmacy_purchase_request_approvedmaster", "<?php echo $view_pharmacy_purchase_request_approved->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_pharmacy_purchase_request_approvedmaster_js").each(function(){ew.addScript(this.text);});
</script>
<?php } ?>