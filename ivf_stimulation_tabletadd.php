...
var fivf_stimulation_tabletadd = currentForm = new ew.Form("fivf_stimulation_tabletadd", "add");
...
fivf_stimulation_tabletadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($ivf_stimulation_tablet_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_stimulation_tablet_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_stimulation_tablet->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_stimulation_tablet_Name" for="x_Name" class="<?php echo $ivf_stimulation_tablet_add->LeftColumnClass ?>"><?php echo $ivf_stimulation_tablet->Name->caption() ?><?php echo ($ivf_stimulation_tablet->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_stimulation_tablet_add->RightColumnClass ?>"><div<?php echo $ivf_stimulation_tablet->Name->cellAttributes() ?>>
