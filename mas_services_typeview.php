...
var fmas_services_typeview = currentForm = new ew.Form("fmas_services_typeview", "view");

// Form_CustomValidate event
fmas_services_typeview.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fmas_services_typeview.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($mas_services_type_view->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_services_type_view->Token ?>">
<?php } ?>
...
<?php if ($mas_services_type->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="<?php echo $mas_services_type_view->TableLeftColumnClass ?>"><span id="elh_mas_services_type_id"><?php echo $mas_services_type->id->caption() ?></span></td>
...
<?php if ($mas_services_type->name->Visible) { // name ?>
	<tr id="r_name">
		<td class="<?php echo $mas_services_type_view->TableLeftColumnClass ?>"><span id="elh_mas_services_type_name"><?php echo $mas_services_type->name->caption() ?></span></td>
