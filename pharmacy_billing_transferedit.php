...
var fpharmacy_billing_transferedit = currentForm = new ew.Form("fpharmacy_billing_transferedit", "edit");
...
fpharmacy_billing_transferedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_billing_transferedit.lists["x_PharID"] = <?php echo $pharmacy_billing_transfer_edit->PharID->Lookup->toClientList() ?>;
...
fpharmacy_billing_transferedit.lists["x_transfer"] = <?php echo $pharmacy_billing_transfer_edit->transfer->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_billing_transfer_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_billing_transfer_edit->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_billing_transfer->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_id" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_id" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->id->caption() ?><?php echo ($pharmacy_billing_transfer->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->id->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_id" class="pharmacy_billing_transferedit" type="text/html">
...
<input type="hidden" data-table="pharmacy_billing_transfer" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($pharmacy_billing_transfer->id->CurrentValue) ?>">
<?php echo $pharmacy_billing_transfer->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pharmacy_billing_transfer->pharmacy->Visible) { // pharmacy ?>
	<div id="r_pharmacy" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_pharmacy" for="x_pharmacy" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_pharmacy" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->pharmacy->caption() ?><?php echo ($pharmacy_billing_transfer->pharmacy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->pharmacy->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_pharmacy" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_Details" for="x_Details" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_Details" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->Details->caption() ?><?php echo ($pharmacy_billing_transfer->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->Details->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_Details" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_RIDNO" for="x_RIDNO" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_RIDNO" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->RIDNO->caption() ?><?php echo ($pharmacy_billing_transfer->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->RIDNO->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_RIDNO" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_TidNo" for="x_TidNo" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_TidNo" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->TidNo->caption() ?><?php echo ($pharmacy_billing_transfer->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->TidNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_TidNo" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_CId" for="x_CId" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_CId" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->CId->caption() ?><?php echo ($pharmacy_billing_transfer->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->CId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_CId" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_PatId" for="x_PatId" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_PatId" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->PatId->caption() ?><?php echo ($pharmacy_billing_transfer->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->PatId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_PatId" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_DrID" for="x_DrID" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_DrID" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->DrID->caption() ?><?php echo ($pharmacy_billing_transfer->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->DrID->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_DrID" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_BillStatus" for="x_BillStatus" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_BillStatus" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->BillStatus->caption() ?><?php echo ($pharmacy_billing_transfer->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->BillStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_BillStatus" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->transfer->Visible) { // transfer ?>
	<div id="r_transfer" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_transfer" for="x_transfer" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_transfer" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->transfer->caption() ?><?php echo ($pharmacy_billing_transfer->transfer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->transfer->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_transfer" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->street->Visible) { // street ?>
	<div id="r_street" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_street" for="x_street" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_street" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->street->caption() ?><?php echo ($pharmacy_billing_transfer->street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->street->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_street" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->area->Visible) { // area ?>
	<div id="r_area" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_area" for="x_area" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_area" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->area->caption() ?><?php echo ($pharmacy_billing_transfer->area->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->area->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_area" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->town->Visible) { // town ?>
	<div id="r_town" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_town" for="x_town" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_town" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->town->caption() ?><?php echo ($pharmacy_billing_transfer->town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->town->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_town" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_province" for="x_province" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_province" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->province->caption() ?><?php echo ($pharmacy_billing_transfer->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->province->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_province" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_postal_code" for="x_postal_code" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_postal_code" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->postal_code->caption() ?><?php echo ($pharmacy_billing_transfer->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->postal_code->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_postal_code" class="pharmacy_billing_transferedit" type="text/html">
...
<?php if ($pharmacy_billing_transfer->phone_no->Visible) { // phone_no ?>
	<div id="r_phone_no" class="form-group row">
		<label id="elh_pharmacy_billing_transfer_phone_no" for="x_phone_no" class="<?php echo $pharmacy_billing_transfer_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_transfer_phone_no" class="pharmacy_billing_transferedit" type="text/html"><span><?php echo $pharmacy_billing_transfer->phone_no->caption() ?><?php echo ($pharmacy_billing_transfer->phone_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_transfer_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_transfer->phone_no->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_transfer_phone_no" class="pharmacy_billing_transferedit" type="text/html">
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_pharmacy_billing_transfer_PatId"/}}&nbsp;{{include tmpl="#tpx_pharmacy_billing_transfer_PatId"/}}</h3>
	</div>
		<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_pharmacy_billing_transfer_RIDNO"/}}&nbsp;{{include tmpl="#tpx_pharmacy_billing_transfer_RIDNO"/}}</h3>
	</div>
		<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_pharmacy_billing_transfer_CId"/}}&nbsp;{{include tmpl="#tpx_pharmacy_billing_transfer_CId"/}}</h3>
	</div>
</div>
<div class="row">
	<div class="col-12">
...
<table class="ew-table">
	 <tbody>
		...
		<tr>
		 ...
		 <tr>
		 	<td>{{include tmpl="#tpc_pharmacy_billing_transfer_DrID"/}}&nbsp;{{include tmpl="#tpx_pharmacy_billing_transfer_DrID"/}}</td>
...
ew.applyTemplate("tpd_pharmacy_billing_transferedit", "tpm_pharmacy_billing_transferedit", "pharmacy_billing_transferedit", "<?php echo $pharmacy_billing_transfer->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.pharmacy_billing_transferedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
