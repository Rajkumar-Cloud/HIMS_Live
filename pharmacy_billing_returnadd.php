...
var fpharmacy_billing_returnadd = currentForm = new ew.Form("fpharmacy_billing_returnadd", "add");
...
fpharmacy_billing_returnadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_billing_returnadd.lists["x_Reception"] = <?php echo $pharmacy_billing_return_add->Reception->Lookup->toClientList() ?>;
...
fpharmacy_billing_returnadd.lists["x_ModeofPayment"] = <?php echo $pharmacy_billing_return_add->ModeofPayment->Lookup->toClientList() ?>;
...
fpharmacy_billing_returnadd.lists["x_RIDNO"] = <?php echo $pharmacy_billing_return_add->RIDNO->Lookup->toClientList() ?>;
fpharmacy_billing_returnadd.lists["x_RIDNO"].options = <?php echo JsonEncode($pharmacy_billing_return_add->RIDNO->lookupOptions()) ?>;
fpharmacy_billing_returnadd.lists["x_CId"] = <?php echo $pharmacy_billing_return_add->CId->Lookup->toClientList() ?>;
fpharmacy_billing_returnadd.lists["x_CId"].options = <?php echo JsonEncode($pharmacy_billing_return_add->CId->lookupOptions()) ?>;
fpharmacy_billing_returnadd.lists["x_PatId"] = <?php echo $pharmacy_billing_return_add->PatId->Lookup->toClientList() ?>;
fpharmacy_billing_returnadd.lists["x_PatId"].options = <?php echo JsonEncode($pharmacy_billing_return_add->PatId->lookupOptions()) ?>;
fpharmacy_billing_returnadd.lists["x_RefferedBy"] = <?php echo $pharmacy_billing_return_add->RefferedBy->Lookup->toClientList() ?>;
...
fpharmacy_billing_returnadd.lists["x_DrID"] = <?php echo $pharmacy_billing_return_add->DrID->Lookup->toClientList() ?>;
fpharmacy_billing_returnadd.lists["x_DrID"].options = <?php echo JsonEncode($pharmacy_billing_return_add->DrID->lookupOptions()) ?>;
fpharmacy_billing_returnadd.lists["x_ReportHeader[]"] = <?php echo $pharmacy_billing_return_add->ReportHeader->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_billing_return_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_billing_return_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_billing_return->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_pharmacy_billing_return_Reception" for="x_Reception" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Reception" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Reception->caption() ?><?php echo ($pharmacy_billing_return->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Reception->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Reception" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_pharmacy_billing_return_PatientId" for="x_PatientId" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_PatientId" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->PatientId->caption() ?><?php echo ($pharmacy_billing_return->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->PatientId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_PatientId" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_pharmacy_billing_return_PatientName" for="x_PatientName" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_PatientName" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->PatientName->caption() ?><?php echo ($pharmacy_billing_return->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->PatientName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_PatientName" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_pharmacy_billing_return_Age" for="x_Age" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Age" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Age->caption() ?><?php echo ($pharmacy_billing_return->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Age->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Age" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_pharmacy_billing_return_Gender" for="x_Gender" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Gender" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Gender->caption() ?><?php echo ($pharmacy_billing_return->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Gender->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Gender" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->profilePic->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_profilePic" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Mobile->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Mobile" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->IP_OP->Visible) { // IP_OP ?>
	<div id="r_IP_OP" class="form-group row">
		<label id="elh_pharmacy_billing_return_IP_OP" for="x_IP_OP" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_IP_OP" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->IP_OP->caption() ?><?php echo ($pharmacy_billing_return->IP_OP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->IP_OP->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_IP_OP" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_pharmacy_billing_return_Doctor" for="x_Doctor" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Doctor" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Doctor->caption() ?><?php echo ($pharmacy_billing_return->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Doctor->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Doctor" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_pharmacy_billing_return_voucher_type" for="x_voucher_type" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_voucher_type" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->voucher_type->caption() ?><?php echo ($pharmacy_billing_return->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->voucher_type->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_voucher_type" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_pharmacy_billing_return_Details" for="x_Details" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Details" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Details->caption() ?><?php echo ($pharmacy_billing_return->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Details->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Details" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_pharmacy_billing_return_ModeofPayment" for="x_ModeofPayment" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_ModeofPayment" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->ModeofPayment->caption() ?><?php echo ($pharmacy_billing_return->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->ModeofPayment->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_ModeofPayment" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_pharmacy_billing_return_Amount" for="x_Amount" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Amount" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Amount->caption() ?><?php echo ($pharmacy_billing_return->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Amount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Amount" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->AnyDues->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_AnyDues" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RealizationAmount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RealizationAmount" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RealizationStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RealizationStatus" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RealizationRemarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RealizationRemarks" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RealizationBatchNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RealizationBatchNo" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RealizationDate->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RealizationDate" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_pharmacy_billing_return_RIDNO" for="x_RIDNO" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_RIDNO" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->RIDNO->caption() ?><?php echo ($pharmacy_billing_return->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RIDNO->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RIDNO" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_pharmacy_billing_return_TidNo" for="x_TidNo" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_TidNo" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->TidNo->caption() ?><?php echo ($pharmacy_billing_return->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->TidNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_TidNo" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_pharmacy_billing_return_CId" for="x_CId" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_CId" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->CId->caption() ?><?php echo ($pharmacy_billing_return->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->CId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_CId" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_pharmacy_billing_return_PartnerName" for="x_PartnerName" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_PartnerName" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->PartnerName->caption() ?><?php echo ($pharmacy_billing_return->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->PartnerName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_PartnerName" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->PayerType->Visible) { // PayerType ?>
	<div id="r_PayerType" class="form-group row">
		<label id="elh_pharmacy_billing_return_PayerType" for="x_PayerType" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_PayerType" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->PayerType->caption() ?><?php echo ($pharmacy_billing_return->PayerType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->PayerType->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_PayerType" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Currency->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Currency" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->DiscountRemarks->Visible) { // DiscountRemarks ?>
	<div id="r_DiscountRemarks" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->DiscountRemarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_DiscountRemarks" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_pharmacy_billing_return_Remarks" for="x_Remarks" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_Remarks" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->Remarks->caption() ?><?php echo ($pharmacy_billing_return->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->Remarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_Remarks" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_pharmacy_billing_return_PatId" for="x_PatId" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_PatId" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->PatId->caption() ?><?php echo ($pharmacy_billing_return->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->PatId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_PatId" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_pharmacy_billing_return_DrDepartment" for="x_DrDepartment" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_DrDepartment" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->DrDepartment->caption() ?><?php echo ($pharmacy_billing_return->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->DrDepartment->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_DrDepartment" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->RefferedBy->Visible) { // RefferedBy ?>
	<div id="r_RefferedBy" class="form-group row">
		<label id="elh_pharmacy_billing_return_RefferedBy" for="x_RefferedBy" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_RefferedBy" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->RefferedBy->caption() ?><?php echo ($pharmacy_billing_return->RefferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->RefferedBy->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_RefferedBy" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->BillNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_BillNumber" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->CardNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_CardNumber" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_pharmacy_billing_return_BankName" for="x_BankName" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_BankName" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->BankName->caption() ?><?php echo ($pharmacy_billing_return->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->BankName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_BankName" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_pharmacy_billing_return_DrID" for="x_DrID" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_DrID" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->DrID->caption() ?><?php echo ($pharmacy_billing_return->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->DrID->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_DrID" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_pharmacy_billing_return_BillStatus" for="x_BillStatus" class="<?php echo $pharmacy_billing_return_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_return_BillStatus" class="pharmacy_billing_returnadd" type="text/html"><span><?php echo $pharmacy_billing_return->BillStatus->caption() ?><?php echo ($pharmacy_billing_return->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->BillStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_BillStatus" class="pharmacy_billing_returnadd" type="text/html">
...
<?php if ($pharmacy_billing_return->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		...
		<div class="<?php echo $pharmacy_billing_return_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_return->ReportHeader->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_return_ReportHeader" class="pharmacy_billing_returnadd" type="text/html">
...
ew.applyTemplate("tpd_pharmacy_billing_returnadd", "tpm_pharmacy_billing_returnadd", "pharmacy_billing_returnadd", "<?php echo $pharmacy_billing_return->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.pharmacy_billing_returnadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
