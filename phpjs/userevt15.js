...
(function($) {
		...
		{ // keys = event types, values = handler functions
			"change": function(e) {
				...
				// Your code
						var $row = $(this).fields();
						var ModeofPayment = $row["ModeofPayment"].value();
						if(ModeofPayment=='CARD' || ModeofPayment=='PAYTM' || ModeofPayment=='NEFT' || ModeofPayment=='RTGS' || ModeofPayment=='CHEQUE' || ModeofPayment=='CASH & CARD')
						{
							if(ModeofPayment=='CARD'|| ModeofPayment=='CASH & CARD')
							{
								document.getElementById("viewCardType").style.display = "block";
								if(ModeofPayment=='CASH & CARD')
								{
									document.getElementById("viewCash").style.display = "block";
									document.getElementById("viewCard").style.display = "block";
								}else{
									document.getElementById("viewCash").style.display = "none";
									document.getElementById("viewCard").style.display = "none";
								}
							}else{
								document.getElementById("viewCardType").style.display = "none";
							}
							document.getElementById("viewBankName").style.display = "block";
							document.getElementById("viewBankDetails").innerText = ModeofPayment + " Details";
						}
	...
	// Table 'view_billing_voucher' Field 'DiscountAmount'
	$('[data-table=view_billing_voucher][data-field=x_DiscountAmount]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
		...
		"change keyup": function(e) {
							 ...
							 Services.value = obj.ReferedBy;
															...
															if(obj.typeRegsisteration != 'null')
															{
																document.getElementById('ipAdmissiontype').style.display = "block";
																document.getElementById('BillClosingType').style.display = "block";
																 document.getElementById("AddBulkService").style.display = "block";
																 document.getElementById("Addloadservice").style.display = "block";
															}else
															{
																document.getElementById('ipAdmissiontype').style.display = "none";
																document.getElementById('BillClosingType').style.display = "none";
								...
								$.ajax({
									...
									success: function (data) {
										...
										var tabbllee = tabbllee + '</table>';
										var tabbllee = tabbllee + '<table style="width:100%"><tr><th hidden >Total Advance = '+TotalAdvance+'</th><th hidden>Total Bill = '+ TotalBill +'</th><th>Balance Amount = '+ BalanceAmount +'</th></tr></table>';								
										if(json.length > 0)
										{
											document.getElementById("LoadGetOPAdvance").innerHTML =  tabbllee;
										}
	...
	// Table 'view_billing_voucher' Field 'cash'
	$('[data-table=view_billing_voucher][data-field=x_cash]').on(
		{ // keys = event types, values = handler functions
				"change keyup click keypress": function(e) {
	...
	// Table 'view_billing_voucher' Field 'Card'
	$('[data-table=view_billing_voucher][data-field=x_Card]').on(
		{ // keys = event types, values = handler functions
				"change keyup click keypress": function(e) {
	...
	$('[data-table=view_semenanalysis][data-field=x_Concentration1]').on(
		{ // keys = event types, values = handler functions
			"change keyup": function(e) {
				...
				var Concentration = $row["Concentration1"].toNumber();
				var Total = Volume * Concentration;
				$row["Total1"].val(Total.toFixed(1));
			}
		}
	);
	...
	$('[data-table=view_semenanalysis][data-field=x_Concentration2]').on(
		{ // keys = event types, values = handler functions
			"change keyup": function(e) {
				...
				var Concentration = $row["Concentration2"].toNumber();
				var Total = Volume * Concentration;
				$row["Total2"].val(Total.toFixed(1));
			}
		}
	);
	...
	// Table 'view_pharmacygrn' Field 'FreeQtyyy'
	$('[data-table=view_pharmacygrn][data-field=x_FreeQtyyy]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
				...
				// Your code
					var $row = $(this).fields();
					var SUnit = $row["SUnit"].toNumber();
					var $FreeQty = $row["FreeQtyyy"].toNumber();
					if(SUnit > 0)
					{
						var kkk = $FreeQty * SUnit;
						$row["FreeQty"].value(kkk);
					}else{
						$row["FreeQty"].value(totalitm);
					}
	...
	$('[data-table=view_pharmacygrn][data-field=x_SUnit]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
				...
				{
					$MRPP = $MRP / SUnit ;
						$row["SalRate"].value($MRPP.toFixed(2));
				}else{
				...
				if(SUnit > 0)
				{
					$MRPPs = $PurValue / SUnit ;
						$row["PurRate"].value($MRPPs.toFixed(2));
				}else{
					$row["PurRate"].value($PurValue.toFixed(2));
				}
	...
	// Table 'view_pharmacygrn' Field 'GRNPer'
	$('[data-table=view_pharmacygrn][data-field=x_GRNPer]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
				...
				// Your code
						...
						var $ItemValue = $row["PurValue"].toNumber();
						var $Disc = $row["Disc"].toNumber();
						var $DiscGRNPer = $row["GRNPer"].toNumber();
						var $MRP = $row["MRP"].toNumber();
						var $PurValue = $row["PurValue"].toNumber();
		...
		{ // keys = event types, values = handler functions
			"change": function(e) {
				...
				// Your code
						...
						var $BillDiscount = $row["BillDiscount"].toNumber();
						var $GrnValue = $row["GrnValue"].toNumber();
						$FFGRNTotalValue = (parseInt($GrnValue) + parseInt($TransPort) + parseInt($AnyOther)) - $BillDiscount;
						$row["GRNTotalValue"].value($FFGRNTotalValue);
			}
		}
	);
	...
	// Table 'pharmacy_billing_voucher' Field 'DiscountAmount'
	$('[data-table=pharmacy_billing_voucher][data-field=x_DiscountAmount]').on(
		{ // keys = event types, values = handler functions
			"change keyup click keypress": function(e) {
	...
	// Table 'pharmacy_billing_voucher' Field 'Cash'
	$('[data-table=pharmacy_billing_voucher][data-field=x_Cash]').on(
		{ // keys = event types, values = handler functions
				"change keyup click keypress": function(e) {
	...
	// Table 'pharmacy_billing_voucher' Field 'Card'
	$('[data-table=pharmacy_billing_voucher][data-field=x_Card]').on(
		{ // keys = event types, values = handler functions
			"change keyup click keypress": function(e) {
												...
												$.ajax({
													...
													success: function (data) {
														...
														for (var i = 0; i < json.length; i++) {
															...
															if(obj.ModeofPayment == "CASH &amp; CARD")
															{
		 var cccash = 	document.getElementById('x_CashCollected').value;
		 var ccard = 	document.getElementById('x_Card').value;
		 														if(cccash == "")
		 														{
																	document.getElementById('x_CashCollected').value =  obj.Cash;
																}else{
																	document.getElementById('x_CashCollected').value = (parseInt(cccash) + parseInt( obj.Cash)).toFixed(2);
																}
																if(ccard == "")
																{
																	document.getElementById('x_Card').value =  obj.Card;
																}else{
																	document.getElementById('x_Card').value = (parseInt(ccard) + parseInt(obj.Card)).toFixed(2);
																}
															}
															if(obj.ModeofPayment == "PharmacyReturnCash")
															{
																var kkmm = parseInt(document.getElementById('x_CashCollected').value) - parseInt(obj.Amount);
																document.getElementById('x_CashCollected').value =  kkmm.toFixed(2);
															}
															if(obj.ModeofPayment == "PharmacyReturnCard")
															{
															    var kkuu = parseInt(document.getElementById('x_Card').value) - parseInt(obj.Amount);
																document.getElementById('x_Card').value = kkuu.toFixed(2);
															}
	...
	// Table 'store_grn' Field 'BillDiscount'
	$('[data-table=store_grn][data-field=x_BillDiscount]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'store_grn' Field 'TransPort'
	$('[data-table=store_grn][data-field=x_TransPort]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'store_grn' Field 'AnyOther'
	$('[data-table=store_grn][data-field=x_AnyOther]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'GrnQuantity'
	$('[data-table=view_store_grn][data-field=x_GrnQuantity]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'PUnit'
	$('[data-table=view_store_grn][data-field=x_PUnit]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'SUnit'
	$('[data-table=view_store_grn][data-field=x_SUnit]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'MRP'
	$('[data-table=view_store_grn][data-field=x_MRP]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'PurValue'
	$('[data-table=view_store_grn][data-field=x_PurValue]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'PSGST'
	$('[data-table=view_store_grn][data-field=x_PSGST]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'PCGST'
	$('[data-table=view_store_grn][data-field=x_PCGST]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'view_store_grn' Field 'Quantity'
	$('[data-table=view_store_grn][data-field=x_Quantity]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
	...
	// Table 'store_payment' Field 'Customername'
	$('[data-table=store_payment][data-field=x_Customername]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
				...
				// Your code
						...
						var HospitalID  =  document.getElementById("HospitalIDDD").value;
														...
														$.ajax({
															type: "GET",
															url: "ajaxinsert.php?control=StoreGRNSearch",
															data: { data: jsonString },
															cache: false,
															success: function (data) {
																let jsonObject = JSON.parse(data);
	...
	// Table 'view_store_transfer' Field 'LastMonthSale'
	$('[data-table=view_store_transfer][data-field=x_LastMonthSale]').on(
		{ // keys = event types, values = handler functions
			"change": function(e) {
