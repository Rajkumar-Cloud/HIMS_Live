...
var fivf_embryology_chartedit = currentForm = new ew.Form("fivf_embryology_chartedit", "edit");
...
fivf_embryology_chartedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_embryology_chartedit.lists["x_Day0PolarBodyPosition"] = <?php echo $ivf_embryology_chart_edit->Day0PolarBodyPosition->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day0Breakage"] = <?php echo $ivf_embryology_chart_edit->Day0Breakage->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day0Attempts"] = <?php echo $ivf_embryology_chart_edit->Day0Attempts->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day0SPZMorpho"] = <?php echo $ivf_embryology_chart_edit->Day0SPZMorpho->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day0SPZLocation"] = <?php echo $ivf_embryology_chart_edit->Day0SPZLocation->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day0SpOrgin"] = <?php echo $ivf_embryology_chart_edit->Day0SpOrgin->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day5Cryoptop"] = <?php echo $ivf_embryology_chart_edit->Day5Cryoptop->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day1PN"] = <?php echo $ivf_embryology_chart_edit->Day1PN->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_Day1PN"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->Day1PN->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_Day1PB"] = <?php echo $ivf_embryology_chart_edit->Day1PB->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_Day1PB"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->Day1PB->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_Day1Pronucleus"] = <?php echo $ivf_embryology_chart_edit->Day1Pronucleus->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day1Nucleolus"] = <?php echo $ivf_embryology_chart_edit->Day1Nucleolus->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day1Halo"] = <?php echo $ivf_embryology_chart_edit->Day1Halo->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day2End"] = <?php echo $ivf_embryology_chart_edit->Day2End->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day3Frag"] = <?php echo $ivf_embryology_chart_edit->Day3Frag->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day3Symmetry"] = <?php echo $ivf_embryology_chart_edit->Day3Symmetry->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day3ZP"] = <?php echo $ivf_embryology_chart_edit->Day3ZP->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_Day3ZP"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->Day3ZP->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_Day3Vacoules"] = <?php echo $ivf_embryology_chart_edit->Day3Vacoules->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day3Grade"] = <?php echo $ivf_embryology_chart_edit->Day3Grade->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day3Cryoptop"] = <?php echo $ivf_embryology_chart_edit->Day3Cryoptop->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day3End"] = <?php echo $ivf_embryology_chart_edit->Day3End->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day4Cryoptop"] = <?php echo $ivf_embryology_chart_edit->Day4Cryoptop->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day4End"] = <?php echo $ivf_embryology_chart_edit->Day4End->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day5ICM"] = <?php echo $ivf_embryology_chart_edit->Day5ICM->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day5TE"] = <?php echo $ivf_embryology_chart_edit->Day5TE->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_Day5TE"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->Day5TE->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_Day5Observation"] = <?php echo $ivf_embryology_chart_edit->Day5Observation->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day5Collapsed"] = <?php echo $ivf_embryology_chart_edit->Day5Collapsed->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day5Vacoulles"] = <?php echo $ivf_embryology_chart_edit->Day5Vacoulles->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day5Grade"] = <?php echo $ivf_embryology_chart_edit->Day5Grade->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day6ICM"] = <?php echo $ivf_embryology_chart_edit->Day6ICM->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day6TE"] = <?php echo $ivf_embryology_chart_edit->Day6TE->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_Day6TE"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->Day6TE->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_Day6Observation"] = <?php echo $ivf_embryology_chart_edit->Day6Observation->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day6Collapsed"] = <?php echo $ivf_embryology_chart_edit->Day6Collapsed->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day6Vacoulles"] = <?php echo $ivf_embryology_chart_edit->Day6Vacoulles->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Day6Grade"] = <?php echo $ivf_embryology_chart_edit->Day6Grade->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_EndingDay"] = <?php echo $ivf_embryology_chart_edit->EndingDay->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_EndingGrade"] = <?php echo $ivf_embryology_chart_edit->EndingGrade->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_EndingState"] = <?php echo $ivf_embryology_chart_edit->EndingState->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_Stage"] = <?php echo $ivf_embryology_chart_edit->Stage->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_Stage"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->Stage->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_thawReFrozen[]"] = <?php echo $ivf_embryology_chart_edit->thawReFrozen->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_vitriDay"] = <?php echo $ivf_embryology_chart_edit->vitriDay->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_vitriGrade"] = <?php echo $ivf_embryology_chart_edit->vitriGrade->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_thawET"] = <?php echo $ivf_embryology_chart_edit->thawET->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_thawET"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->thawET->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_ETDifficulty"] = <?php echo $ivf_embryology_chart_edit->ETDifficulty->Lookup->toClientList() ?>;
...
fivf_embryology_chartedit.lists["x_ETEasy[]"] = <?php echo $ivf_embryology_chart_edit->ETEasy->Lookup->toClientList() ?>;
fivf_embryology_chartedit.lists["x_ETEasy[]"].options = <?php echo JsonEncode($ivf_embryology_chart_edit->ETEasy->options(FALSE, TRUE)) ?>;
fivf_embryology_chartedit.lists["x_Day1End"] = <?php echo $ivf_embryology_chart_edit->Day1End->Lookup->toClientList() ?>;
...
<?php if ($ivf_embryology_chart_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_embryology_chart_edit->Token ?>">
<?php } ?>
...
<?php if ($ivf_embryology_chart->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_ivf_embryology_chart_id" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->id->caption() ?><?php echo ($ivf_embryology_chart->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->id->cellAttributes() ?>>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($ivf_embryology_chart->id->CurrentValue) ?>">
<?php echo $ivf_embryology_chart->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ivf_embryology_chart->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_RIDNo" for="x_RIDNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->RIDNo->caption() ?><?php echo ($ivf_embryology_chart->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->RIDNo->cellAttributes() ?>>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_RIDNo" name="x_RIDNo" id="x_RIDNo" value="<?php echo HtmlEncode($ivf_embryology_chart->RIDNo->CurrentValue) ?>">
<?php echo $ivf_embryology_chart->RIDNo->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ivf_embryology_chart->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_embryology_chart_Name" for="x_Name" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Name->caption() ?><?php echo ($ivf_embryology_chart->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Name->cellAttributes() ?>>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_Name" name="x_Name" id="x_Name" value="<?php echo HtmlEncode($ivf_embryology_chart->Name->CurrentValue) ?>">
...
<?php if ($ivf_embryology_chart->ARTCycle->Visible) { // ARTCycle ?>
	<div id="r_ARTCycle" class="form-group row">
		<label id="elh_ivf_embryology_chart_ARTCycle" for="x_ARTCycle" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ARTCycle->caption() ?><?php echo ($ivf_embryology_chart->ARTCycle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ARTCycle->cellAttributes() ?>>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_ARTCycle" name="x_ARTCycle" id="x_ARTCycle" value="<?php echo HtmlEncode($ivf_embryology_chart->ARTCycle->CurrentValue) ?>">
...
<?php if ($ivf_embryology_chart->SpermOrigin->Visible) { // SpermOrigin ?>
	<div id="r_SpermOrigin" class="form-group row">
		<label id="elh_ivf_embryology_chart_SpermOrigin" for="x_SpermOrigin" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->SpermOrigin->caption() ?><?php echo ($ivf_embryology_chart->SpermOrigin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->SpermOrigin->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->InseminatinTechnique->Visible) { // InseminatinTechnique ?>
	<div id="r_InseminatinTechnique" class="form-group row">
		<label id="elh_ivf_embryology_chart_InseminatinTechnique" for="x_InseminatinTechnique" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->InseminatinTechnique->caption() ?><?php echo ($ivf_embryology_chart->InseminatinTechnique->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->InseminatinTechnique->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->IndicationForART->Visible) { // IndicationForART ?>
	<div id="r_IndicationForART" class="form-group row">
		<label id="elh_ivf_embryology_chart_IndicationForART" for="x_IndicationForART" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->IndicationForART->caption() ?><?php echo ($ivf_embryology_chart->IndicationForART->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->IndicationForART->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0sino->Visible) { // Day0sino ?>
	<div id="r_Day0sino" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0sino" for="x_Day0sino" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0sino->caption() ?><?php echo ($ivf_embryology_chart->Day0sino->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0sino->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0OocyteStage->Visible) { // Day0OocyteStage ?>
	<div id="r_Day0OocyteStage" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0OocyteStage" for="x_Day0OocyteStage" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0OocyteStage->caption() ?><?php echo ($ivf_embryology_chart->Day0OocyteStage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0OocyteStage->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0PolarBodyPosition->Visible) { // Day0PolarBodyPosition ?>
	<div id="r_Day0PolarBodyPosition" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0PolarBodyPosition" for="x_Day0PolarBodyPosition" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0PolarBodyPosition->caption() ?><?php echo ($ivf_embryology_chart->Day0PolarBodyPosition->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0PolarBodyPosition->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0Breakage->Visible) { // Day0Breakage ?>
	<div id="r_Day0Breakage" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0Breakage" for="x_Day0Breakage" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0Breakage->caption() ?><?php echo ($ivf_embryology_chart->Day0Breakage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0Breakage->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0Attempts->Visible) { // Day0Attempts ?>
	<div id="r_Day0Attempts" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0Attempts" for="x_Day0Attempts" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0Attempts->caption() ?><?php echo ($ivf_embryology_chart->Day0Attempts->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0Attempts->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0SPZMorpho->Visible) { // Day0SPZMorpho ?>
	<div id="r_Day0SPZMorpho" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0SPZMorpho" for="x_Day0SPZMorpho" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0SPZMorpho->caption() ?><?php echo ($ivf_embryology_chart->Day0SPZMorpho->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0SPZMorpho->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0SPZLocation->Visible) { // Day0SPZLocation ?>
	<div id="r_Day0SPZLocation" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0SPZLocation" for="x_Day0SPZLocation" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0SPZLocation->caption() ?><?php echo ($ivf_embryology_chart->Day0SPZLocation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0SPZLocation->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day0SpOrgin->Visible) { // Day0SpOrgin ?>
	<div id="r_Day0SpOrgin" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day0SpOrgin" for="x_Day0SpOrgin" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day0SpOrgin->caption() ?><?php echo ($ivf_embryology_chart->Day0SpOrgin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day0SpOrgin->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5Cryoptop->Visible) { // Day5Cryoptop ?>
	<div id="r_Day5Cryoptop" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5Cryoptop" for="x_Day5Cryoptop" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5Cryoptop->caption() ?><?php echo ($ivf_embryology_chart->Day5Cryoptop->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5Cryoptop->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1Sperm->Visible) { // Day1Sperm ?>
	<div id="r_Day1Sperm" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1Sperm" for="x_Day1Sperm" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1Sperm->caption() ?><?php echo ($ivf_embryology_chart->Day1Sperm->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1Sperm->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1PN->Visible) { // Day1PN ?>
	<div id="r_Day1PN" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1PN" for="x_Day1PN" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1PN->caption() ?><?php echo ($ivf_embryology_chart->Day1PN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1PN->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1PB->Visible) { // Day1PB ?>
	<div id="r_Day1PB" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1PB" for="x_Day1PB" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1PB->caption() ?><?php echo ($ivf_embryology_chart->Day1PB->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1PB->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1Pronucleus->Visible) { // Day1Pronucleus ?>
	<div id="r_Day1Pronucleus" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1Pronucleus" for="x_Day1Pronucleus" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1Pronucleus->caption() ?><?php echo ($ivf_embryology_chart->Day1Pronucleus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1Pronucleus->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1Nucleolus->Visible) { // Day1Nucleolus ?>
	<div id="r_Day1Nucleolus" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1Nucleolus" for="x_Day1Nucleolus" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1Nucleolus->caption() ?><?php echo ($ivf_embryology_chart->Day1Nucleolus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1Nucleolus->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1Halo->Visible) { // Day1Halo ?>
	<div id="r_Day1Halo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1Halo" for="x_Day1Halo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1Halo->caption() ?><?php echo ($ivf_embryology_chart->Day1Halo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1Halo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2SiNo->Visible) { // Day2SiNo ?>
	<div id="r_Day2SiNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2SiNo" for="x_Day2SiNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2SiNo->caption() ?><?php echo ($ivf_embryology_chart->Day2SiNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2SiNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2CellNo->Visible) { // Day2CellNo ?>
	<div id="r_Day2CellNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2CellNo" for="x_Day2CellNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2CellNo->caption() ?><?php echo ($ivf_embryology_chart->Day2CellNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2CellNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2Frag->Visible) { // Day2Frag ?>
	<div id="r_Day2Frag" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2Frag" for="x_Day2Frag" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2Frag->caption() ?><?php echo ($ivf_embryology_chart->Day2Frag->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2Frag->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2Symmetry->Visible) { // Day2Symmetry ?>
	<div id="r_Day2Symmetry" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2Symmetry" for="x_Day2Symmetry" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2Symmetry->caption() ?><?php echo ($ivf_embryology_chart->Day2Symmetry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2Symmetry->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2Cryoptop->Visible) { // Day2Cryoptop ?>
	<div id="r_Day2Cryoptop" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2Cryoptop" for="x_Day2Cryoptop" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2Cryoptop->caption() ?><?php echo ($ivf_embryology_chart->Day2Cryoptop->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2Cryoptop->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2Grade->Visible) { // Day2Grade ?>
	<div id="r_Day2Grade" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2Grade" for="x_Day2Grade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2Grade->caption() ?><?php echo ($ivf_embryology_chart->Day2Grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2Grade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day2End->Visible) { // Day2End ?>
	<div id="r_Day2End" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day2End" for="x_Day2End" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day2End->caption() ?><?php echo ($ivf_embryology_chart->Day2End->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day2End->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3Sino->Visible) { // Day3Sino ?>
	<div id="r_Day3Sino" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3Sino" for="x_Day3Sino" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3Sino->caption() ?><?php echo ($ivf_embryology_chart->Day3Sino->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3Sino->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3CellNo->Visible) { // Day3CellNo ?>
	<div id="r_Day3CellNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3CellNo" for="x_Day3CellNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3CellNo->caption() ?><?php echo ($ivf_embryology_chart->Day3CellNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3CellNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3Frag->Visible) { // Day3Frag ?>
	<div id="r_Day3Frag" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3Frag" for="x_Day3Frag" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3Frag->caption() ?><?php echo ($ivf_embryology_chart->Day3Frag->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3Frag->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3Symmetry->Visible) { // Day3Symmetry ?>
	<div id="r_Day3Symmetry" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3Symmetry" for="x_Day3Symmetry" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3Symmetry->caption() ?><?php echo ($ivf_embryology_chart->Day3Symmetry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3Symmetry->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3ZP->Visible) { // Day3ZP ?>
	<div id="r_Day3ZP" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3ZP" for="x_Day3ZP" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3ZP->caption() ?><?php echo ($ivf_embryology_chart->Day3ZP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3ZP->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3Vacoules->Visible) { // Day3Vacoules ?>
	<div id="r_Day3Vacoules" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3Vacoules" for="x_Day3Vacoules" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3Vacoules->caption() ?><?php echo ($ivf_embryology_chart->Day3Vacoules->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3Vacoules->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3Grade->Visible) { // Day3Grade ?>
	<div id="r_Day3Grade" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3Grade" for="x_Day3Grade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3Grade->caption() ?><?php echo ($ivf_embryology_chart->Day3Grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3Grade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3Cryoptop->Visible) { // Day3Cryoptop ?>
	<div id="r_Day3Cryoptop" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3Cryoptop" for="x_Day3Cryoptop" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3Cryoptop->caption() ?><?php echo ($ivf_embryology_chart->Day3Cryoptop->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3Cryoptop->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day3End->Visible) { // Day3End ?>
	<div id="r_Day3End" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day3End" for="x_Day3End" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day3End->caption() ?><?php echo ($ivf_embryology_chart->Day3End->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day3End->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4SiNo->Visible) { // Day4SiNo ?>
	<div id="r_Day4SiNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4SiNo" for="x_Day4SiNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4SiNo->caption() ?><?php echo ($ivf_embryology_chart->Day4SiNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4SiNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4CellNo->Visible) { // Day4CellNo ?>
	<div id="r_Day4CellNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4CellNo" for="x_Day4CellNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4CellNo->caption() ?><?php echo ($ivf_embryology_chart->Day4CellNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4CellNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4Frag->Visible) { // Day4Frag ?>
	<div id="r_Day4Frag" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4Frag" for="x_Day4Frag" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4Frag->caption() ?><?php echo ($ivf_embryology_chart->Day4Frag->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4Frag->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4Symmetry->Visible) { // Day4Symmetry ?>
	<div id="r_Day4Symmetry" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4Symmetry" for="x_Day4Symmetry" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4Symmetry->caption() ?><?php echo ($ivf_embryology_chart->Day4Symmetry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4Symmetry->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4Grade->Visible) { // Day4Grade ?>
	<div id="r_Day4Grade" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4Grade" for="x_Day4Grade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4Grade->caption() ?><?php echo ($ivf_embryology_chart->Day4Grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4Grade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4Cryoptop->Visible) { // Day4Cryoptop ?>
	<div id="r_Day4Cryoptop" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4Cryoptop" for="x_Day4Cryoptop" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4Cryoptop->caption() ?><?php echo ($ivf_embryology_chart->Day4Cryoptop->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4Cryoptop->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day4End->Visible) { // Day4End ?>
	<div id="r_Day4End" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day4End" for="x_Day4End" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day4End->caption() ?><?php echo ($ivf_embryology_chart->Day4End->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day4End->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5CellNo->Visible) { // Day5CellNo ?>
	<div id="r_Day5CellNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5CellNo" for="x_Day5CellNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5CellNo->caption() ?><?php echo ($ivf_embryology_chart->Day5CellNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5CellNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5ICM->Visible) { // Day5ICM ?>
	<div id="r_Day5ICM" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5ICM" for="x_Day5ICM" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5ICM->caption() ?><?php echo ($ivf_embryology_chart->Day5ICM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5ICM->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5TE->Visible) { // Day5TE ?>
	<div id="r_Day5TE" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5TE" for="x_Day5TE" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5TE->caption() ?><?php echo ($ivf_embryology_chart->Day5TE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5TE->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5Observation->Visible) { // Day5Observation ?>
	<div id="r_Day5Observation" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5Observation" for="x_Day5Observation" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5Observation->caption() ?><?php echo ($ivf_embryology_chart->Day5Observation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5Observation->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5Collapsed->Visible) { // Day5Collapsed ?>
	<div id="r_Day5Collapsed" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5Collapsed" for="x_Day5Collapsed" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5Collapsed->caption() ?><?php echo ($ivf_embryology_chart->Day5Collapsed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5Collapsed->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5Vacoulles->Visible) { // Day5Vacoulles ?>
	<div id="r_Day5Vacoulles" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5Vacoulles" for="x_Day5Vacoulles" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5Vacoulles->caption() ?><?php echo ($ivf_embryology_chart->Day5Vacoulles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5Vacoulles->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day5Grade->Visible) { // Day5Grade ?>
	<div id="r_Day5Grade" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day5Grade" for="x_Day5Grade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day5Grade->caption() ?><?php echo ($ivf_embryology_chart->Day5Grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day5Grade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6CellNo->Visible) { // Day6CellNo ?>
	<div id="r_Day6CellNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6CellNo" for="x_Day6CellNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6CellNo->caption() ?><?php echo ($ivf_embryology_chart->Day6CellNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6CellNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6ICM->Visible) { // Day6ICM ?>
	<div id="r_Day6ICM" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6ICM" for="x_Day6ICM" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6ICM->caption() ?><?php echo ($ivf_embryology_chart->Day6ICM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6ICM->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6TE->Visible) { // Day6TE ?>
	<div id="r_Day6TE" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6TE" for="x_Day6TE" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6TE->caption() ?><?php echo ($ivf_embryology_chart->Day6TE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6TE->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6Observation->Visible) { // Day6Observation ?>
	<div id="r_Day6Observation" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6Observation" for="x_Day6Observation" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6Observation->caption() ?><?php echo ($ivf_embryology_chart->Day6Observation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6Observation->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6Collapsed->Visible) { // Day6Collapsed ?>
	<div id="r_Day6Collapsed" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6Collapsed" for="x_Day6Collapsed" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6Collapsed->caption() ?><?php echo ($ivf_embryology_chart->Day6Collapsed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6Collapsed->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6Vacoulles->Visible) { // Day6Vacoulles ?>
	<div id="r_Day6Vacoulles" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6Vacoulles" for="x_Day6Vacoulles" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6Vacoulles->caption() ?><?php echo ($ivf_embryology_chart->Day6Vacoulles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6Vacoulles->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6Grade->Visible) { // Day6Grade ?>
	<div id="r_Day6Grade" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6Grade" for="x_Day6Grade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6Grade->caption() ?><?php echo ($ivf_embryology_chart->Day6Grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6Grade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day6Cryoptop->Visible) { // Day6Cryoptop ?>
	<div id="r_Day6Cryoptop" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day6Cryoptop" for="x_Day6Cryoptop" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day6Cryoptop->caption() ?><?php echo ($ivf_embryology_chart->Day6Cryoptop->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day6Cryoptop->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->EndSiNo->Visible) { // EndSiNo ?>
	<div id="r_EndSiNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_EndSiNo" for="x_EndSiNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->EndSiNo->caption() ?><?php echo ($ivf_embryology_chart->EndSiNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->EndSiNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->EndingDay->Visible) { // EndingDay ?>
	<div id="r_EndingDay" class="form-group row">
		<label id="elh_ivf_embryology_chart_EndingDay" for="x_EndingDay" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->EndingDay->caption() ?><?php echo ($ivf_embryology_chart->EndingDay->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->EndingDay->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->EndingCellStage->Visible) { // EndingCellStage ?>
	<div id="r_EndingCellStage" class="form-group row">
		<label id="elh_ivf_embryology_chart_EndingCellStage" for="x_EndingCellStage" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->EndingCellStage->caption() ?><?php echo ($ivf_embryology_chart->EndingCellStage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->EndingCellStage->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->EndingGrade->Visible) { // EndingGrade ?>
	<div id="r_EndingGrade" class="form-group row">
		<label id="elh_ivf_embryology_chart_EndingGrade" for="x_EndingGrade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->EndingGrade->caption() ?><?php echo ($ivf_embryology_chart->EndingGrade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->EndingGrade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->EndingState->Visible) { // EndingState ?>
	<div id="r_EndingState" class="form-group row">
		<label id="elh_ivf_embryology_chart_EndingState" for="x_EndingState" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->EndingState->caption() ?><?php echo ($ivf_embryology_chart->EndingState->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->EndingState->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_TidNo" for="x_TidNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->TidNo->caption() ?><?php echo ($ivf_embryology_chart->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->TidNo->cellAttributes() ?>>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_TidNo" name="x_TidNo" id="x_TidNo" value="<?php echo HtmlEncode($ivf_embryology_chart->TidNo->CurrentValue) ?>">
...
<?php if ($ivf_embryology_chart->DidNO->Visible) { // DidNO ?>
	<div id="r_DidNO" class="form-group row">
		<label id="elh_ivf_embryology_chart_DidNO" for="x_DidNO" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->DidNO->caption() ?><?php echo ($ivf_embryology_chart->DidNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->DidNO->cellAttributes() ?>>
...
<input type="hidden" data-table="ivf_embryology_chart" data-field="x_DidNO" name="x_DidNO" id="x_DidNO" value="<?php echo HtmlEncode($ivf_embryology_chart->DidNO->CurrentValue) ?>">
...
<?php if ($ivf_embryology_chart->ICSiIVFDateTime->Visible) { // ICSiIVFDateTime ?>
	<div id="r_ICSiIVFDateTime" class="form-group row">
		<label id="elh_ivf_embryology_chart_ICSiIVFDateTime" for="x_ICSiIVFDateTime" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ICSiIVFDateTime->caption() ?><?php echo ($ivf_embryology_chart->ICSiIVFDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ICSiIVFDateTime->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->PrimaryEmbrologist->Visible) { // PrimaryEmbrologist ?>
	<div id="r_PrimaryEmbrologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_PrimaryEmbrologist" for="x_PrimaryEmbrologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->PrimaryEmbrologist->caption() ?><?php echo ($ivf_embryology_chart->PrimaryEmbrologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->PrimaryEmbrologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->SecondaryEmbrologist->Visible) { // SecondaryEmbrologist ?>
	<div id="r_SecondaryEmbrologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_SecondaryEmbrologist" for="x_SecondaryEmbrologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->SecondaryEmbrologist->caption() ?><?php echo ($ivf_embryology_chart->SecondaryEmbrologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->SecondaryEmbrologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Incubator->Visible) { // Incubator ?>
	<div id="r_Incubator" class="form-group row">
		<label id="elh_ivf_embryology_chart_Incubator" for="x_Incubator" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Incubator->caption() ?><?php echo ($ivf_embryology_chart->Incubator->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Incubator->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->location->Visible) { // location ?>
	<div id="r_location" class="form-group row">
		<label id="elh_ivf_embryology_chart_location" for="x_location" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->location->caption() ?><?php echo ($ivf_embryology_chart->location->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->location->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->OocyteNo->Visible) { // OocyteNo ?>
	<div id="r_OocyteNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_OocyteNo" for="x_OocyteNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->OocyteNo->caption() ?><?php echo ($ivf_embryology_chart->OocyteNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->OocyteNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Stage->Visible) { // Stage ?>
	<div id="r_Stage" class="form-group row">
		<label id="elh_ivf_embryology_chart_Stage" for="x_Stage" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Stage->caption() ?><?php echo ($ivf_embryology_chart->Stage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Stage->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_ivf_embryology_chart_Remarks" for="x_Remarks" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Remarks->caption() ?><?php echo ($ivf_embryology_chart->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Remarks->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitrificationDate->Visible) { // vitrificationDate ?>
	<div id="r_vitrificationDate" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitrificationDate" for="x_vitrificationDate" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitrificationDate->caption() ?><?php echo ($ivf_embryology_chart->vitrificationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitrificationDate->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriPrimaryEmbryologist->Visible) { // vitriPrimaryEmbryologist ?>
	<div id="r_vitriPrimaryEmbryologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriPrimaryEmbryologist" for="x_vitriPrimaryEmbryologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriPrimaryEmbryologist->caption() ?><?php echo ($ivf_embryology_chart->vitriPrimaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriPrimaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriSecondaryEmbryologist->Visible) { // vitriSecondaryEmbryologist ?>
	<div id="r_vitriSecondaryEmbryologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriSecondaryEmbryologist" for="x_vitriSecondaryEmbryologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriSecondaryEmbryologist->caption() ?><?php echo ($ivf_embryology_chart->vitriSecondaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriSecondaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriEmbryoNo->Visible) { // vitriEmbryoNo ?>
	<div id="r_vitriEmbryoNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriEmbryoNo" for="x_vitriEmbryoNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriEmbryoNo->caption() ?><?php echo ($ivf_embryology_chart->vitriEmbryoNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriEmbryoNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawReFrozen->Visible) { // thawReFrozen ?>
	<div id="r_thawReFrozen" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawReFrozen" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawReFrozen->caption() ?><?php echo ($ivf_embryology_chart->thawReFrozen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawReFrozen->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriFertilisationDate->Visible) { // vitriFertilisationDate ?>
	<div id="r_vitriFertilisationDate" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriFertilisationDate" for="x_vitriFertilisationDate" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriFertilisationDate->caption() ?><?php echo ($ivf_embryology_chart->vitriFertilisationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriFertilisationDate->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriDay->Visible) { // vitriDay ?>
	<div id="r_vitriDay" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriDay" for="x_vitriDay" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriDay->caption() ?><?php echo ($ivf_embryology_chart->vitriDay->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriDay->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriStage->Visible) { // vitriStage ?>
	<div id="r_vitriStage" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriStage" for="x_vitriStage" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriStage->caption() ?><?php echo ($ivf_embryology_chart->vitriStage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriStage->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriGrade->Visible) { // vitriGrade ?>
	<div id="r_vitriGrade" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriGrade" for="x_vitriGrade" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriGrade->caption() ?><?php echo ($ivf_embryology_chart->vitriGrade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriGrade->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriIncubator->Visible) { // vitriIncubator ?>
	<div id="r_vitriIncubator" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriIncubator" for="x_vitriIncubator" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriIncubator->caption() ?><?php echo ($ivf_embryology_chart->vitriIncubator->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriIncubator->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriTank->Visible) { // vitriTank ?>
	<div id="r_vitriTank" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriTank" for="x_vitriTank" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriTank->caption() ?><?php echo ($ivf_embryology_chart->vitriTank->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriTank->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriCanister->Visible) { // vitriCanister ?>
	<div id="r_vitriCanister" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriCanister" for="x_vitriCanister" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriCanister->caption() ?><?php echo ($ivf_embryology_chart->vitriCanister->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriCanister->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriGobiet->Visible) { // vitriGobiet ?>
	<div id="r_vitriGobiet" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriGobiet" for="x_vitriGobiet" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriGobiet->caption() ?><?php echo ($ivf_embryology_chart->vitriGobiet->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriGobiet->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriViscotube->Visible) { // vitriViscotube ?>
	<div id="r_vitriViscotube" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriViscotube" for="x_vitriViscotube" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriViscotube->caption() ?><?php echo ($ivf_embryology_chart->vitriViscotube->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriViscotube->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriCryolockNo->Visible) { // vitriCryolockNo ?>
	<div id="r_vitriCryolockNo" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriCryolockNo" for="x_vitriCryolockNo" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriCryolockNo->caption() ?><?php echo ($ivf_embryology_chart->vitriCryolockNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriCryolockNo->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->vitriCryolockColour->Visible) { // vitriCryolockColour ?>
	<div id="r_vitriCryolockColour" class="form-group row">
		<label id="elh_ivf_embryology_chart_vitriCryolockColour" for="x_vitriCryolockColour" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->vitriCryolockColour->caption() ?><?php echo ($ivf_embryology_chart->vitriCryolockColour->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->vitriCryolockColour->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawDate->Visible) { // thawDate ?>
	<div id="r_thawDate" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawDate" for="x_thawDate" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawDate->caption() ?><?php echo ($ivf_embryology_chart->thawDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawDate->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawPrimaryEmbryologist->Visible) { // thawPrimaryEmbryologist ?>
	<div id="r_thawPrimaryEmbryologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawPrimaryEmbryologist" for="x_thawPrimaryEmbryologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawPrimaryEmbryologist->caption() ?><?php echo ($ivf_embryology_chart->thawPrimaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawPrimaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawSecondaryEmbryologist->Visible) { // thawSecondaryEmbryologist ?>
	<div id="r_thawSecondaryEmbryologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawSecondaryEmbryologist" for="x_thawSecondaryEmbryologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawSecondaryEmbryologist->caption() ?><?php echo ($ivf_embryology_chart->thawSecondaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawSecondaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawET->Visible) { // thawET ?>
	<div id="r_thawET" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawET" for="x_thawET" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawET->caption() ?><?php echo ($ivf_embryology_chart->thawET->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawET->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawAbserve->Visible) { // thawAbserve ?>
	<div id="r_thawAbserve" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawAbserve" for="x_thawAbserve" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawAbserve->caption() ?><?php echo ($ivf_embryology_chart->thawAbserve->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawAbserve->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->thawDiscard->Visible) { // thawDiscard ?>
	<div id="r_thawDiscard" class="form-group row">
		<label id="elh_ivf_embryology_chart_thawDiscard" for="x_thawDiscard" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->thawDiscard->caption() ?><?php echo ($ivf_embryology_chart->thawDiscard->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->thawDiscard->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETCatheter->Visible) { // ETCatheter ?>
	<div id="r_ETCatheter" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETCatheter" for="x_ETCatheter" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETCatheter->caption() ?><?php echo ($ivf_embryology_chart->ETCatheter->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETCatheter->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETDifficulty->Visible) { // ETDifficulty ?>
	<div id="r_ETDifficulty" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETDifficulty" for="x_ETDifficulty" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETDifficulty->caption() ?><?php echo ($ivf_embryology_chart->ETDifficulty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETDifficulty->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETEasy->Visible) { // ETEasy ?>
	<div id="r_ETEasy" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETEasy" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETEasy->caption() ?><?php echo ($ivf_embryology_chart->ETEasy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETEasy->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETComments->Visible) { // ETComments ?>
	<div id="r_ETComments" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETComments" for="x_ETComments" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETComments->caption() ?><?php echo ($ivf_embryology_chart->ETComments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETComments->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETDoctor->Visible) { // ETDoctor ?>
	<div id="r_ETDoctor" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETDoctor" for="x_ETDoctor" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETDoctor->caption() ?><?php echo ($ivf_embryology_chart->ETDoctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETDoctor->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETEmbryologist->Visible) { // ETEmbryologist ?>
	<div id="r_ETEmbryologist" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETEmbryologist" for="x_ETEmbryologist" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETEmbryologist->caption() ?><?php echo ($ivf_embryology_chart->ETEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->ETDate->Visible) { // ETDate ?>
	<div id="r_ETDate" class="form-group row">
		<label id="elh_ivf_embryology_chart_ETDate" for="x_ETDate" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->ETDate->caption() ?><?php echo ($ivf_embryology_chart->ETDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->ETDate->cellAttributes() ?>>
...
<?php if ($ivf_embryology_chart->Day1End->Visible) { // Day1End ?>
	<div id="r_Day1End" class="form-group row">
		<label id="elh_ivf_embryology_chart_Day1End" for="x_Day1End" class="<?php echo $ivf_embryology_chart_edit->LeftColumnClass ?>"><?php echo $ivf_embryology_chart->Day1End->caption() ?><?php echo ($ivf_embryology_chart->Day1End->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_embryology_chart->Day1End->cellAttributes() ?>>
