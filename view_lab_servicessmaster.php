...
<?php if ($view_lab_servicess->id->Visible) { // id ?>
		<tr id="r_id">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_id" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->id->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->id->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_id" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->SID->Visible) { // SID ?>
		<tr id="r_SID">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_SID" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->SID->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->SID->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_SID" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->PatientId->Visible) { // PatientId ?>
		<tr id="r_PatientId">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_PatientId" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->PatientId->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->PatientId->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_PatientId" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->PatientName->Visible) { // PatientName ?>
		<tr id="r_PatientName">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_PatientName" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->PatientName->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->PatientName->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_PatientName" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->Gender->Visible) { // Gender ?>
		<tr id="r_Gender">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_Gender" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->Gender->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->Gender->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_Gender" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->Mobile->Visible) { // Mobile ?>
		<tr id="r_Mobile">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_Mobile" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->Mobile->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->Mobile->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_Mobile" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->Doctor->Visible) { // Doctor ?>
		<tr id="r_Doctor">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_Doctor" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->Doctor->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->Doctor->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_Doctor" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->ModeofPayment->Visible) { // ModeofPayment ?>
		<tr id="r_ModeofPayment">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_ModeofPayment" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->ModeofPayment->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->ModeofPayment->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_ModeofPayment" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->Amount->Visible) { // Amount ?>
		<tr id="r_Amount">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_Amount" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->Amount->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->Amount->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_Amount" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->HospID->Visible) { // HospID ?>
		<tr id="r_HospID">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_HospID" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->HospID->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->HospID->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_HospID" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->RIDNO->Visible) { // RIDNO ?>
		<tr id="r_RIDNO">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_RIDNO" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->RIDNO->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->RIDNO->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_RIDNO" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->PartnerName->Visible) { // PartnerName ?>
		<tr id="r_PartnerName">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_PartnerName" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->PartnerName->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->PartnerName->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_PartnerName" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->PatId->Visible) { // PatId ?>
		<tr id="r_PatId">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_PatId" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->PatId->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->PatId->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_PatId" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->DrDepartment->Visible) { // DrDepartment ?>
		<tr id="r_DrDepartment">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_DrDepartment" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->DrDepartment->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->DrDepartment->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_DrDepartment" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->RefferedBy->Visible) { // RefferedBy ?>
		<tr id="r_RefferedBy">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_RefferedBy" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->RefferedBy->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->RefferedBy->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_RefferedBy" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->BillNumber->Visible) { // BillNumber ?>
		<tr id="r_BillNumber">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_BillNumber" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->BillNumber->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->BillNumber->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_BillNumber" class="view_lab_servicessmaster" type="text/html">
...
<?php if ($view_lab_servicess->LabTestReleased->Visible) { // LabTestReleased ?>
		<tr id="r_LabTestReleased">
			<td class="<?php echo $view_lab_servicess->TableLeftColumnClass ?>"><script id="tpc_view_lab_servicess_LabTestReleased" class="view_lab_servicessmaster" type="text/html"><span><?php echo $view_lab_servicess->LabTestReleased->caption() ?></span></script></td>
			<td<?php echo $view_lab_servicess->LabTestReleased->cellAttributes() ?>>
<script id="tpx_view_lab_servicess_LabTestReleased" class="view_lab_servicessmaster" type="text/html">
...
ew.applyTemplate("tpd_view_lab_servicessmaster", "tpm_view_lab_servicessmaster", "view_lab_servicessmaster", "<?php echo $view_lab_servicess->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_lab_servicessmaster_js").each(function(){ew.addScript(this.text);});
</script>
<?php } ?>