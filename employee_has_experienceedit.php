...
var femployee_has_experienceedit = currentForm = new ew.Form("femployee_has_experienceedit", "edit");
...
femployee_has_experienceedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_has_experience_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_has_experience->modifiedby->caption(), $employee_has_experience->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_has_experience_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_has_experience->modifieddatetime->caption(), $employee_has_experience->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_has_experience_edit->HospID->Required) { ?>
...
femployee_has_experienceedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_has_experienceedit.lists["x_status"] = <?php echo $employee_has_experience_edit->status->Lookup->toClientList() ?>;
...
<?php if ($employee_has_experience_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_has_experience_edit->Token ?>">
<?php } ?>
...
<?php if ($employee_has_experience->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_employee_has_experience_id" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->id->caption() ?><?php echo ($employee_has_experience->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->id->cellAttributes() ?>>
...
<input type="hidden" data-table="employee_has_experience" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($employee_has_experience->id->CurrentValue) ?>">
<?php echo $employee_has_experience->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($employee_has_experience->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group row">
		<label id="elh_employee_has_experience_employee_id" for="x_employee_id" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->employee_id->caption() ?><?php echo ($employee_has_experience->employee_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->employee_id->cellAttributes() ?>>
...
<?php if ($employee_has_experience->working_at->Visible) { // working_at ?>
	<div id="r_working_at" class="form-group row">
		<label id="elh_employee_has_experience_working_at" for="x_working_at" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->working_at->caption() ?><?php echo ($employee_has_experience->working_at->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->working_at->cellAttributes() ?>>
...
<?php if ($employee_has_experience->job_description->Visible) { // job description ?>
	<div id="r_job_description" class="form-group row">
		<label id="elh_employee_has_experience_job_description" for="x_job_description" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->job_description->caption() ?><?php echo ($employee_has_experience->job_description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->job_description->cellAttributes() ?>>
...
<?php if ($employee_has_experience->role->Visible) { // role ?>
	<div id="r_role" class="form-group row">
		<label id="elh_employee_has_experience_role" for="x_role" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->role->caption() ?><?php echo ($employee_has_experience->role->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->role->cellAttributes() ?>>
...
<?php if ($employee_has_experience->start_date->Visible) { // start_date ?>
	<div id="r_start_date" class="form-group row">
		<label id="elh_employee_has_experience_start_date" for="x_start_date" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->start_date->caption() ?><?php echo ($employee_has_experience->start_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->start_date->cellAttributes() ?>>
...
<?php if ($employee_has_experience->end_date->Visible) { // end_date ?>
	<div id="r_end_date" class="form-group row">
		<label id="elh_employee_has_experience_end_date" for="x_end_date" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->end_date->caption() ?><?php echo ($employee_has_experience->end_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->end_date->cellAttributes() ?>>
...
<?php if ($employee_has_experience->total_experience->Visible) { // total_experience ?>
	<div id="r_total_experience" class="form-group row">
		<label id="elh_employee_has_experience_total_experience" for="x_total_experience" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->total_experience->caption() ?><?php echo ($employee_has_experience->total_experience->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->total_experience->cellAttributes() ?>>
...
<?php if ($employee_has_experience->certificates->Visible) { // certificates ?>
	<div id="r_certificates" class="form-group row">
		<label id="elh_employee_has_experience_certificates" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->certificates->caption() ?><?php echo ($employee_has_experience->certificates->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->certificates->cellAttributes() ?>>
...
<?php if ($employee_has_experience->others->Visible) { // others ?>
	<div id="r_others" class="form-group row">
		<label id="elh_employee_has_experience_others" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->others->caption() ?><?php echo ($employee_has_experience->others->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->others->cellAttributes() ?>>
...
<?php if ($employee_has_experience->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_has_experience_status" for="x_status" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->status->caption() ?><?php echo ($employee_has_experience->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->status->cellAttributes() ?>>
...
<?php if ($employee_has_experience->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_employee_has_experience_HospID" for="x_HospID" class="<?php echo $employee_has_experience_edit->LeftColumnClass ?>"><?php echo $employee_has_experience->HospID->caption() ?><?php echo ($employee_has_experience->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_experience_edit->RightColumnClass ?>"><div<?php echo $employee_has_experience->HospID->cellAttributes() ?>>
