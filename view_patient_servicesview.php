...
var fview_patient_servicesview = currentForm = new ew.Form("fview_patient_servicesview", "view");

// Form_CustomValidate event
fview_patient_servicesview.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fview_patient_servicesview.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_patient_servicesview.lists["x_Services"] = <?php echo $view_patient_services_view->Services->Lookup->toClientList() ?>;
fview_patient_servicesview.lists["x_Services"].options = <?php echo JsonEncode($view_patient_services_view->Services->lookupOptions()) ?>;
fview_patient_servicesview.autoSuggests["x_Services"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fview_patient_servicesview.lists["x_DiscountCategory"] = <?php echo $view_patient_services_view->DiscountCategory->Lookup->toClientList() ?>;
fview_patient_servicesview.lists["x_DiscountCategory"].options = <?php echo JsonEncode($view_patient_services_view->DiscountCategory->lookupOptions()) ?>;
...
<?php if ($view_patient_services_view->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_patient_services_view->Token ?>">
<?php } ?>
...
<?php if ($view_patient_services->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_id"><?php echo $view_patient_services->id->caption() ?></span></td>
...
<?php if ($view_patient_services->Reception->Visible) { // Reception ?>
	<tr id="r_Reception">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Reception"><?php echo $view_patient_services->Reception->caption() ?></span></td>
...
<?php if ($view_patient_services->mrnno->Visible) { // mrnno ?>
	<tr id="r_mrnno">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_mrnno"><?php echo $view_patient_services->mrnno->caption() ?></span></td>
...
<?php if ($view_patient_services->PatientName->Visible) { // PatientName ?>
	<tr id="r_PatientName">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PatientName"><?php echo $view_patient_services->PatientName->caption() ?></span></td>
...
<?php if ($view_patient_services->Age->Visible) { // Age ?>
	<tr id="r_Age">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Age"><?php echo $view_patient_services->Age->caption() ?></span></td>
...
<?php if ($view_patient_services->Gender->Visible) { // Gender ?>
	<tr id="r_Gender">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Gender"><?php echo $view_patient_services->Gender->caption() ?></span></td>
...
<?php if ($view_patient_services->profilePic->Visible) { // profilePic ?>
	<tr id="r_profilePic">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_profilePic"><?php echo $view_patient_services->profilePic->caption() ?></span></td>
...
<?php if ($view_patient_services->Services->Visible) { // Services ?>
	<tr id="r_Services">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Services"><?php echo $view_patient_services->Services->caption() ?></span></td>
...
<?php if ($view_patient_services->Unit->Visible) { // Unit ?>
	<tr id="r_Unit">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Unit"><?php echo $view_patient_services->Unit->caption() ?></span></td>
...
<?php if ($view_patient_services->amount->Visible) { // amount ?>
	<tr id="r_amount">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_amount"><?php echo $view_patient_services->amount->caption() ?></span></td>
...
<?php if ($view_patient_services->Quantity->Visible) { // Quantity ?>
	<tr id="r_Quantity">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Quantity"><?php echo $view_patient_services->Quantity->caption() ?></span></td>
...
<?php if ($view_patient_services->DiscountCategory->Visible) { // DiscountCategory ?>
	<tr id="r_DiscountCategory">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DiscountCategory"><?php echo $view_patient_services->DiscountCategory->caption() ?></span></td>
...
<?php if ($view_patient_services->Discount->Visible) { // Discount ?>
	<tr id="r_Discount">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Discount"><?php echo $view_patient_services->Discount->caption() ?></span></td>
...
<?php if ($view_patient_services->SubTotal->Visible) { // SubTotal ?>
	<tr id="r_SubTotal">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SubTotal"><?php echo $view_patient_services->SubTotal->caption() ?></span></td>
...
<?php if ($view_patient_services->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_description"><?php echo $view_patient_services->description->caption() ?></span></td>
...
<?php if ($view_patient_services->patient_type->Visible) { // patient_type ?>
	<tr id="r_patient_type">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_patient_type"><?php echo $view_patient_services->patient_type->caption() ?></span></td>
...
<?php if ($view_patient_services->charged_date->Visible) { // charged_date ?>
	<tr id="r_charged_date">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_charged_date"><?php echo $view_patient_services->charged_date->caption() ?></span></td>
...
<?php if ($view_patient_services->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_status"><?php echo $view_patient_services->status->caption() ?></span></td>
...
<?php if ($view_patient_services->createdby->Visible) { // createdby ?>
	<tr id="r_createdby">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_createdby"><?php echo $view_patient_services->createdby->caption() ?></span></td>
...
<?php if ($view_patient_services->createddatetime->Visible) { // createddatetime ?>
	<tr id="r_createddatetime">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_createddatetime"><?php echo $view_patient_services->createddatetime->caption() ?></span></td>
...
<?php if ($view_patient_services->modifiedby->Visible) { // modifiedby ?>
	<tr id="r_modifiedby">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_modifiedby"><?php echo $view_patient_services->modifiedby->caption() ?></span></td>
...
<?php if ($view_patient_services->modifieddatetime->Visible) { // modifieddatetime ?>
	<tr id="r_modifieddatetime">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_modifieddatetime"><?php echo $view_patient_services->modifieddatetime->caption() ?></span></td>
...
<?php if ($view_patient_services->Aid->Visible) { // Aid ?>
	<tr id="r_Aid">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Aid"><?php echo $view_patient_services->Aid->caption() ?></span></td>
...
<?php if ($view_patient_services->Vid->Visible) { // Vid ?>
	<tr id="r_Vid">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Vid"><?php echo $view_patient_services->Vid->caption() ?></span></td>
...
<?php if ($view_patient_services->DrID->Visible) { // DrID ?>
	<tr id="r_DrID">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrID"><?php echo $view_patient_services->DrID->caption() ?></span></td>
...
<?php if ($view_patient_services->DrCODE->Visible) { // DrCODE ?>
	<tr id="r_DrCODE">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrCODE"><?php echo $view_patient_services->DrCODE->caption() ?></span></td>
...
<?php if ($view_patient_services->DrName->Visible) { // DrName ?>
	<tr id="r_DrName">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrName"><?php echo $view_patient_services->DrName->caption() ?></span></td>
...
<?php if ($view_patient_services->Department->Visible) { // Department ?>
	<tr id="r_Department">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Department"><?php echo $view_patient_services->Department->caption() ?></span></td>
...
<?php if ($view_patient_services->DrSharePres->Visible) { // DrSharePres ?>
	<tr id="r_DrSharePres">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrSharePres"><?php echo $view_patient_services->DrSharePres->caption() ?></span></td>
...
<?php if ($view_patient_services->HospSharePres->Visible) { // HospSharePres ?>
	<tr id="r_HospSharePres">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_HospSharePres"><?php echo $view_patient_services->HospSharePres->caption() ?></span></td>
...
<?php if ($view_patient_services->DrShareAmount->Visible) { // DrShareAmount ?>
	<tr id="r_DrShareAmount">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareAmount"><?php echo $view_patient_services->DrShareAmount->caption() ?></span></td>
...
<?php if ($view_patient_services->HospShareAmount->Visible) { // HospShareAmount ?>
	<tr id="r_HospShareAmount">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_HospShareAmount"><?php echo $view_patient_services->HospShareAmount->caption() ?></span></td>
...
<?php if ($view_patient_services->DrShareSettiledAmount->Visible) { // DrShareSettiledAmount ?>
	<tr id="r_DrShareSettiledAmount">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareSettiledAmount"><?php echo $view_patient_services->DrShareSettiledAmount->caption() ?></span></td>
...
<?php if ($view_patient_services->DrShareSettledId->Visible) { // DrShareSettledId ?>
	<tr id="r_DrShareSettledId">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareSettledId"><?php echo $view_patient_services->DrShareSettledId->caption() ?></span></td>
...
<?php if ($view_patient_services->DrShareSettiledStatus->Visible) { // DrShareSettiledStatus ?>
	<tr id="r_DrShareSettiledStatus">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DrShareSettiledStatus"><?php echo $view_patient_services->DrShareSettiledStatus->caption() ?></span></td>
...
<?php if ($view_patient_services->invoiceId->Visible) { // invoiceId ?>
	<tr id="r_invoiceId">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_invoiceId"><?php echo $view_patient_services->invoiceId->caption() ?></span></td>
...
<?php if ($view_patient_services->invoiceAmount->Visible) { // invoiceAmount ?>
	<tr id="r_invoiceAmount">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_invoiceAmount"><?php echo $view_patient_services->invoiceAmount->caption() ?></span></td>
...
<?php if ($view_patient_services->invoiceStatus->Visible) { // invoiceStatus ?>
	<tr id="r_invoiceStatus">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_invoiceStatus"><?php echo $view_patient_services->invoiceStatus->caption() ?></span></td>
...
<?php if ($view_patient_services->modeOfPayment->Visible) { // modeOfPayment ?>
	<tr id="r_modeOfPayment">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_modeOfPayment"><?php echo $view_patient_services->modeOfPayment->caption() ?></span></td>
...
<?php if ($view_patient_services->HospID->Visible) { // HospID ?>
	<tr id="r_HospID">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_HospID"><?php echo $view_patient_services->HospID->caption() ?></span></td>
...
<?php if ($view_patient_services->RIDNO->Visible) { // RIDNO ?>
	<tr id="r_RIDNO">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RIDNO"><?php echo $view_patient_services->RIDNO->caption() ?></span></td>
...
<?php if ($view_patient_services->ItemCode->Visible) { // ItemCode ?>
	<tr id="r_ItemCode">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ItemCode"><?php echo $view_patient_services->ItemCode->caption() ?></span></td>
...
<?php if ($view_patient_services->TidNo->Visible) { // TidNo ?>
	<tr id="r_TidNo">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TidNo"><?php echo $view_patient_services->TidNo->caption() ?></span></td>
...
<?php if ($view_patient_services->sid->Visible) { // sid ?>
	<tr id="r_sid">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_sid"><?php echo $view_patient_services->sid->caption() ?></span></td>
...
<?php if ($view_patient_services->TestSubCd->Visible) { // TestSubCd ?>
	<tr id="r_TestSubCd">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestSubCd"><?php echo $view_patient_services->TestSubCd->caption() ?></span></td>
...
<?php if ($view_patient_services->DEptCd->Visible) { // DEptCd ?>
	<tr id="r_DEptCd">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DEptCd"><?php echo $view_patient_services->DEptCd->caption() ?></span></td>
...
<?php if ($view_patient_services->ProfCd->Visible) { // ProfCd ?>
	<tr id="r_ProfCd">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ProfCd"><?php echo $view_patient_services->ProfCd->caption() ?></span></td>
...
<?php if ($view_patient_services->LabReport->Visible) { // LabReport ?>
	<tr id="r_LabReport">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_LabReport"><?php echo $view_patient_services->LabReport->caption() ?></span></td>
		<td data-name="LabReport"<?php echo $view_patient_services->LabReport->cellAttributes() ?>>
<span id="el_view_patient_services_LabReport">
<span<?php echo $view_patient_services->LabReport->viewAttributes() ?>>
<?php echo $view_patient_services->LabReport->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($view_patient_services->Comments->Visible) { // Comments ?>
	<tr id="r_Comments">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Comments"><?php echo $view_patient_services->Comments->caption() ?></span></td>
...
<?php if ($view_patient_services->Method->Visible) { // Method ?>
	<tr id="r_Method">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Method"><?php echo $view_patient_services->Method->caption() ?></span></td>
...
<?php if ($view_patient_services->Specimen->Visible) { // Specimen ?>
	<tr id="r_Specimen">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Specimen"><?php echo $view_patient_services->Specimen->caption() ?></span></td>
...
<?php if ($view_patient_services->Abnormal->Visible) { // Abnormal ?>
	<tr id="r_Abnormal">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Abnormal"><?php echo $view_patient_services->Abnormal->caption() ?></span></td>
...
<?php if ($view_patient_services->RefValue->Visible) { // RefValue ?>
	<tr id="r_RefValue">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RefValue"><?php echo $view_patient_services->RefValue->caption() ?></span></td>
		<td data-name="RefValue"<?php echo $view_patient_services->RefValue->cellAttributes() ?>>
<span id="el_view_patient_services_RefValue">
<span<?php echo $view_patient_services->RefValue->viewAttributes() ?>>
<?php echo $view_patient_services->RefValue->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($view_patient_services->TestUnit->Visible) { // TestUnit ?>
	<tr id="r_TestUnit">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestUnit"><?php echo $view_patient_services->TestUnit->caption() ?></span></td>
...
<?php if ($view_patient_services->LOWHIGH->Visible) { // LOWHIGH ?>
	<tr id="r_LOWHIGH">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_LOWHIGH"><?php echo $view_patient_services->LOWHIGH->caption() ?></span></td>
...
<?php if ($view_patient_services->Branch->Visible) { // Branch ?>
	<tr id="r_Branch">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Branch"><?php echo $view_patient_services->Branch->caption() ?></span></td>
...
<?php if ($view_patient_services->Dispatch->Visible) { // Dispatch ?>
	<tr id="r_Dispatch">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Dispatch"><?php echo $view_patient_services->Dispatch->caption() ?></span></td>
...
<?php if ($view_patient_services->Pic1->Visible) { // Pic1 ?>
	<tr id="r_Pic1">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Pic1"><?php echo $view_patient_services->Pic1->caption() ?></span></td>
...
<?php if ($view_patient_services->Pic2->Visible) { // Pic2 ?>
	<tr id="r_Pic2">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Pic2"><?php echo $view_patient_services->Pic2->caption() ?></span></td>
...
<?php if ($view_patient_services->GraphPath->Visible) { // GraphPath ?>
	<tr id="r_GraphPath">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_GraphPath"><?php echo $view_patient_services->GraphPath->caption() ?></span></td>
...
<?php if ($view_patient_services->MachineCD->Visible) { // MachineCD ?>
	<tr id="r_MachineCD">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_MachineCD"><?php echo $view_patient_services->MachineCD->caption() ?></span></td>
...
<?php if ($view_patient_services->TestCancel->Visible) { // TestCancel ?>
	<tr id="r_TestCancel">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestCancel"><?php echo $view_patient_services->TestCancel->caption() ?></span></td>
...
<?php if ($view_patient_services->OutSource->Visible) { // OutSource ?>
	<tr id="r_OutSource">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_OutSource"><?php echo $view_patient_services->OutSource->caption() ?></span></td>
...
<?php if ($view_patient_services->Printed->Visible) { // Printed ?>
	<tr id="r_Printed">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Printed"><?php echo $view_patient_services->Printed->caption() ?></span></td>
...
<?php if ($view_patient_services->PrintBy->Visible) { // PrintBy ?>
	<tr id="r_PrintBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PrintBy"><?php echo $view_patient_services->PrintBy->caption() ?></span></td>
...
<?php if ($view_patient_services->PrintDate->Visible) { // PrintDate ?>
	<tr id="r_PrintDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PrintDate"><?php echo $view_patient_services->PrintDate->caption() ?></span></td>
...
<?php if ($view_patient_services->BillingDate->Visible) { // BillingDate ?>
	<tr id="r_BillingDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_BillingDate"><?php echo $view_patient_services->BillingDate->caption() ?></span></td>
...
<?php if ($view_patient_services->BilledBy->Visible) { // BilledBy ?>
	<tr id="r_BilledBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_BilledBy"><?php echo $view_patient_services->BilledBy->caption() ?></span></td>
...
<?php if ($view_patient_services->Resulted->Visible) { // Resulted ?>
	<tr id="r_Resulted">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Resulted"><?php echo $view_patient_services->Resulted->caption() ?></span></td>
...
<?php if ($view_patient_services->ResultDate->Visible) { // ResultDate ?>
	<tr id="r_ResultDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ResultDate"><?php echo $view_patient_services->ResultDate->caption() ?></span></td>
...
<?php if ($view_patient_services->ResultedBy->Visible) { // ResultedBy ?>
	<tr id="r_ResultedBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ResultedBy"><?php echo $view_patient_services->ResultedBy->caption() ?></span></td>
...
<?php if ($view_patient_services->SampleDate->Visible) { // SampleDate ?>
	<tr id="r_SampleDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SampleDate"><?php echo $view_patient_services->SampleDate->caption() ?></span></td>
...
<?php if ($view_patient_services->SampleUser->Visible) { // SampleUser ?>
	<tr id="r_SampleUser">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SampleUser"><?php echo $view_patient_services->SampleUser->caption() ?></span></td>
...
<?php if ($view_patient_services->Sampled->Visible) { // Sampled ?>
	<tr id="r_Sampled">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Sampled"><?php echo $view_patient_services->Sampled->caption() ?></span></td>
...
<?php if ($view_patient_services->ReceivedDate->Visible) { // ReceivedDate ?>
	<tr id="r_ReceivedDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ReceivedDate"><?php echo $view_patient_services->ReceivedDate->caption() ?></span></td>
...
<?php if ($view_patient_services->ReceivedUser->Visible) { // ReceivedUser ?>
	<tr id="r_ReceivedUser">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ReceivedUser"><?php echo $view_patient_services->ReceivedUser->caption() ?></span></td>
...
<?php if ($view_patient_services->Recevied->Visible) { // Recevied ?>
	<tr id="r_Recevied">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Recevied"><?php echo $view_patient_services->Recevied->caption() ?></span></td>
...
<?php if ($view_patient_services->DeptRecvDate->Visible) { // DeptRecvDate ?>
	<tr id="r_DeptRecvDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DeptRecvDate"><?php echo $view_patient_services->DeptRecvDate->caption() ?></span></td>
...
<?php if ($view_patient_services->DeptRecvUser->Visible) { // DeptRecvUser ?>
	<tr id="r_DeptRecvUser">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DeptRecvUser"><?php echo $view_patient_services->DeptRecvUser->caption() ?></span></td>
...
<?php if ($view_patient_services->DeptRecived->Visible) { // DeptRecived ?>
	<tr id="r_DeptRecived">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_DeptRecived"><?php echo $view_patient_services->DeptRecived->caption() ?></span></td>
...
<?php if ($view_patient_services->SAuthDate->Visible) { // SAuthDate ?>
	<tr id="r_SAuthDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SAuthDate"><?php echo $view_patient_services->SAuthDate->caption() ?></span></td>
...
<?php if ($view_patient_services->SAuthBy->Visible) { // SAuthBy ?>
	<tr id="r_SAuthBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SAuthBy"><?php echo $view_patient_services->SAuthBy->caption() ?></span></td>
...
<?php if ($view_patient_services->SAuthendicate->Visible) { // SAuthendicate ?>
	<tr id="r_SAuthendicate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_SAuthendicate"><?php echo $view_patient_services->SAuthendicate->caption() ?></span></td>
...
<?php if ($view_patient_services->AuthDate->Visible) { // AuthDate ?>
	<tr id="r_AuthDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_AuthDate"><?php echo $view_patient_services->AuthDate->caption() ?></span></td>
...
<?php if ($view_patient_services->AuthBy->Visible) { // AuthBy ?>
	<tr id="r_AuthBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_AuthBy"><?php echo $view_patient_services->AuthBy->caption() ?></span></td>
...
<?php if ($view_patient_services->Authencate->Visible) { // Authencate ?>
	<tr id="r_Authencate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Authencate"><?php echo $view_patient_services->Authencate->caption() ?></span></td>
...
<?php if ($view_patient_services->EditDate->Visible) { // EditDate ?>
	<tr id="r_EditDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_EditDate"><?php echo $view_patient_services->EditDate->caption() ?></span></td>
...
<?php if ($view_patient_services->EditBy->Visible) { // EditBy ?>
	<tr id="r_EditBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_EditBy"><?php echo $view_patient_services->EditBy->caption() ?></span></td>
...
<?php if ($view_patient_services->Editted->Visible) { // Editted ?>
	<tr id="r_Editted">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Editted"><?php echo $view_patient_services->Editted->caption() ?></span></td>
...
<?php if ($view_patient_services->PatID->Visible) { // PatID ?>
	<tr id="r_PatID">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PatID"><?php echo $view_patient_services->PatID->caption() ?></span></td>
...
<?php if ($view_patient_services->PatientId->Visible) { // PatientId ?>
	<tr id="r_PatientId">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_PatientId"><?php echo $view_patient_services->PatientId->caption() ?></span></td>
...
<?php if ($view_patient_services->Mobile->Visible) { // Mobile ?>
	<tr id="r_Mobile">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Mobile"><?php echo $view_patient_services->Mobile->caption() ?></span></td>
...
<?php if ($view_patient_services->CId->Visible) { // CId ?>
	<tr id="r_CId">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_CId"><?php echo $view_patient_services->CId->caption() ?></span></td>
...
<?php if ($view_patient_services->Order->Visible) { // Order ?>
	<tr id="r_Order">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Order"><?php echo $view_patient_services->Order->caption() ?></span></td>
...
<?php if ($view_patient_services->Form->Visible) { // Form ?>
	<tr id="r_Form">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Form"><?php echo $view_patient_services->Form->caption() ?></span></td>
		<td data-name="Form"<?php echo $view_patient_services->Form->cellAttributes() ?>>
<span id="el_view_patient_services_Form">
<span<?php echo $view_patient_services->Form->viewAttributes() ?>>
<?php echo $view_patient_services->Form->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($view_patient_services->ResType->Visible) { // ResType ?>
	<tr id="r_ResType">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_ResType"><?php echo $view_patient_services->ResType->caption() ?></span></td>
...
<?php if ($view_patient_services->Sample->Visible) { // Sample ?>
	<tr id="r_Sample">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Sample"><?php echo $view_patient_services->Sample->caption() ?></span></td>
...
<?php if ($view_patient_services->NoD->Visible) { // NoD ?>
	<tr id="r_NoD">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_NoD"><?php echo $view_patient_services->NoD->caption() ?></span></td>
...
<?php if ($view_patient_services->BillOrder->Visible) { // BillOrder ?>
	<tr id="r_BillOrder">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_BillOrder"><?php echo $view_patient_services->BillOrder->caption() ?></span></td>
...
<?php if ($view_patient_services->Formula->Visible) { // Formula ?>
	<tr id="r_Formula">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Formula"><?php echo $view_patient_services->Formula->caption() ?></span></td>
		<td data-name="Formula"<?php echo $view_patient_services->Formula->cellAttributes() ?>>
<span id="el_view_patient_services_Formula">
<span<?php echo $view_patient_services->Formula->viewAttributes() ?>>
<?php echo $view_patient_services->Formula->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($view_patient_services->Inactive->Visible) { // Inactive ?>
	<tr id="r_Inactive">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Inactive"><?php echo $view_patient_services->Inactive->caption() ?></span></td>
...
<?php if ($view_patient_services->CollSample->Visible) { // CollSample ?>
	<tr id="r_CollSample">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_CollSample"><?php echo $view_patient_services->CollSample->caption() ?></span></td>
...
<?php if ($view_patient_services->TestType->Visible) { // TestType ?>
	<tr id="r_TestType">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_TestType"><?php echo $view_patient_services->TestType->caption() ?></span></td>
...
<?php if ($view_patient_services->Repeated->Visible) { // Repeated ?>
	<tr id="r_Repeated">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Repeated"><?php echo $view_patient_services->Repeated->caption() ?></span></td>
...
<?php if ($view_patient_services->RepeatedBy->Visible) { // RepeatedBy ?>
	<tr id="r_RepeatedBy">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RepeatedBy"><?php echo $view_patient_services->RepeatedBy->caption() ?></span></td>
...
<?php if ($view_patient_services->RepeatedDate->Visible) { // RepeatedDate ?>
	<tr id="r_RepeatedDate">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RepeatedDate"><?php echo $view_patient_services->RepeatedDate->caption() ?></span></td>
...
<?php if ($view_patient_services->serviceID->Visible) { // serviceID ?>
	<tr id="r_serviceID">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_serviceID"><?php echo $view_patient_services->serviceID->caption() ?></span></td>
...
<?php if ($view_patient_services->Service_Type->Visible) { // Service_Type ?>
	<tr id="r_Service_Type">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Service_Type"><?php echo $view_patient_services->Service_Type->caption() ?></span></td>
...
<?php if ($view_patient_services->Service_Department->Visible) { // Service_Department ?>
	<tr id="r_Service_Department">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_Service_Department"><?php echo $view_patient_services->Service_Department->caption() ?></span></td>
...
<?php if ($view_patient_services->RequestNo->Visible) { // RequestNo ?>
	<tr id="r_RequestNo">
		<td class="<?php echo $view_patient_services_view->TableLeftColumnClass ?>"><span id="elh_view_patient_services_RequestNo"><?php echo $view_patient_services->RequestNo->caption() ?></span></td>
