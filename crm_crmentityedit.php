...
// Create page object
$crm_crmentity_edit = new crm_crmentity_edit();

// Run the page
$crm_crmentity_edit->run();
...
$crm_crmentity_edit->Page_Render();
?>
...
var fcrm_crmentityedit = currentForm = new ew.Form("fcrm_crmentityedit", "edit");
...
fcrm_crmentityedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($crm_crmentity_edit->crmid->Required) { ?>
			elm = this.getElements("x" + infix + "_crmid");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $crm_crmentity->crmid->caption(), $crm_crmentity->crmid->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($crm_crmentity_edit->smcreatorid->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->smownerid->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->shownerid->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->modifiedby->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->setype->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_crmentity_edit->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_crmentity_edit->attention->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_crmentity_edit->createdtime->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->modifiedtime->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->viewedtime->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_crmentity_edit->version->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->presence->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->deleted->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->was_read->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->_private->Required) { ?>
		...
		<?php if ($crm_crmentity_edit->users->Required) { ?>
...
fcrm_crmentityedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcrm_crmentityedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $crm_crmentity_edit->showPageHeader(); ?>
<?php
$crm_crmentity_edit->showMessage();
?>
<form name="fcrm_crmentityedit" id="fcrm_crmentityedit" class="<?php echo $crm_crmentity_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($crm_crmentity_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $crm_crmentity_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="crm_crmentity">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$crm_crmentity_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($crm_crmentity->crmid->Visible) { // crmid ?>
	<div id="r_crmid" class="form-group row">
		<label id="elh_crm_crmentity_crmid" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->crmid->caption() ?><?php echo ($crm_crmentity->crmid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->crmid->cellAttributes() ?>>
<span id="el_crm_crmentity_crmid">
<span<?php echo $crm_crmentity->crmid->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($crm_crmentity->crmid->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="crm_crmentity" data-field="x_crmid" name="x_crmid" id="x_crmid" value="<?php echo HtmlEncode($crm_crmentity->crmid->CurrentValue) ?>">
<?php echo $crm_crmentity->crmid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($crm_crmentity->smcreatorid->Visible) { // smcreatorid ?>
	<div id="r_smcreatorid" class="form-group row">
		<label id="elh_crm_crmentity_smcreatorid" for="x_smcreatorid" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->smcreatorid->caption() ?><?php echo ($crm_crmentity->smcreatorid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->smcreatorid->cellAttributes() ?>>
...
<?php if ($crm_crmentity->smownerid->Visible) { // smownerid ?>
	<div id="r_smownerid" class="form-group row">
		<label id="elh_crm_crmentity_smownerid" for="x_smownerid" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->smownerid->caption() ?><?php echo ($crm_crmentity->smownerid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->smownerid->cellAttributes() ?>>
...
<?php if ($crm_crmentity->shownerid->Visible) { // shownerid ?>
	<div id="r_shownerid" class="form-group row">
		<label id="elh_crm_crmentity_shownerid" for="x_shownerid" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->shownerid->caption() ?><?php echo ($crm_crmentity->shownerid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->shownerid->cellAttributes() ?>>
...
<?php if ($crm_crmentity->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_crm_crmentity_modifiedby" for="x_modifiedby" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->modifiedby->caption() ?><?php echo ($crm_crmentity->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->modifiedby->cellAttributes() ?>>
...
<?php if ($crm_crmentity->setype->Visible) { // setype ?>
	<div id="r_setype" class="form-group row">
		<label id="elh_crm_crmentity_setype" for="x_setype" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->setype->caption() ?><?php echo ($crm_crmentity->setype->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->setype->cellAttributes() ?>>
...
<?php if ($crm_crmentity->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_crm_crmentity_description" for="x_description" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->description->caption() ?><?php echo ($crm_crmentity->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->description->cellAttributes() ?>>
...
<?php if ($crm_crmentity->attention->Visible) { // attention ?>
	<div id="r_attention" class="form-group row">
		<label id="elh_crm_crmentity_attention" for="x_attention" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->attention->caption() ?><?php echo ($crm_crmentity->attention->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->attention->cellAttributes() ?>>
...
<?php if ($crm_crmentity->createdtime->Visible) { // createdtime ?>
	<div id="r_createdtime" class="form-group row">
		<label id="elh_crm_crmentity_createdtime" for="x_createdtime" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->createdtime->caption() ?><?php echo ($crm_crmentity->createdtime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->createdtime->cellAttributes() ?>>
...
<?php if ($crm_crmentity->modifiedtime->Visible) { // modifiedtime ?>
	<div id="r_modifiedtime" class="form-group row">
		<label id="elh_crm_crmentity_modifiedtime" for="x_modifiedtime" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->modifiedtime->caption() ?><?php echo ($crm_crmentity->modifiedtime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->modifiedtime->cellAttributes() ?>>
...
<?php if ($crm_crmentity->viewedtime->Visible) { // viewedtime ?>
	<div id="r_viewedtime" class="form-group row">
		<label id="elh_crm_crmentity_viewedtime" for="x_viewedtime" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->viewedtime->caption() ?><?php echo ($crm_crmentity->viewedtime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->viewedtime->cellAttributes() ?>>
...
<?php if ($crm_crmentity->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_crm_crmentity_status" for="x_status" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->status->caption() ?><?php echo ($crm_crmentity->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->status->cellAttributes() ?>>
...
<?php if ($crm_crmentity->version->Visible) { // version ?>
	<div id="r_version" class="form-group row">
		<label id="elh_crm_crmentity_version" for="x_version" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->version->caption() ?><?php echo ($crm_crmentity->version->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->version->cellAttributes() ?>>
...
<?php if ($crm_crmentity->presence->Visible) { // presence ?>
	<div id="r_presence" class="form-group row">
		<label id="elh_crm_crmentity_presence" for="x_presence" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->presence->caption() ?><?php echo ($crm_crmentity->presence->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->presence->cellAttributes() ?>>
...
<?php if ($crm_crmentity->deleted->Visible) { // deleted ?>
	<div id="r_deleted" class="form-group row">
		<label id="elh_crm_crmentity_deleted" for="x_deleted" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->deleted->caption() ?><?php echo ($crm_crmentity->deleted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->deleted->cellAttributes() ?>>
...
<?php if ($crm_crmentity->was_read->Visible) { // was_read ?>
	<div id="r_was_read" class="form-group row">
		<label id="elh_crm_crmentity_was_read" for="x_was_read" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->was_read->caption() ?><?php echo ($crm_crmentity->was_read->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->was_read->cellAttributes() ?>>
...
<?php if ($crm_crmentity->_private->Visible) { // private ?>
	<div id="r__private" class="form-group row">
		<label id="elh_crm_crmentity__private" for="x__private" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->_private->caption() ?><?php echo ($crm_crmentity->_private->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->_private->cellAttributes() ?>>
...
<?php if ($crm_crmentity->users->Visible) { // users ?>
	<div id="r_users" class="form-group row">
		<label id="elh_crm_crmentity_users" for="x_users" class="<?php echo $crm_crmentity_edit->LeftColumnClass ?>"><?php echo $crm_crmentity->users->caption() ?><?php echo ($crm_crmentity->users->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_crmentity_edit->RightColumnClass ?>"><div<?php echo $crm_crmentity->users->cellAttributes() ?>>
...
<?php if (!$crm_crmentity_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $crm_crmentity_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $crm_crmentity_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$crm_crmentity_edit->showPageFooter();
if (DEBUG_ENABLED)
