...
var fmas_typeofregsistrationadd = currentForm = new ew.Form("fmas_typeofregsistrationadd", "add");
...
fmas_typeofregsistrationadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($mas_typeofregsistration_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_typeofregsistration_add->Token ?>">
<?php } ?>
...
<?php if ($mas_typeofregsistration->RegsistrationType->Visible) { // RegsistrationType ?>
	<div id="r_RegsistrationType" class="form-group row">
		<label id="elh_mas_typeofregsistration_RegsistrationType" for="x_RegsistrationType" class="<?php echo $mas_typeofregsistration_add->LeftColumnClass ?>"><?php echo $mas_typeofregsistration->RegsistrationType->caption() ?><?php echo ($mas_typeofregsistration->RegsistrationType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_typeofregsistration_add->RightColumnClass ?>"><div<?php echo $mas_typeofregsistration->RegsistrationType->cellAttributes() ?>>
