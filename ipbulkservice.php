...
// Create page object
$ipbulkservice = new ipbulkservice();
...
//$sql = "SELECT * FROM ganeshkumar_bjhims.patient where id='".$cid."'; ";
...
<form id="bulkservice" name="bulkservice" action="ipbulkserviceinsert.php" method="post">
