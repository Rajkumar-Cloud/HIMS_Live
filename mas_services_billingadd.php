...
var fmas_services_billingadd = currentForm = new ew.Form("fmas_services_billingadd", "add");
...
fmas_services_billingadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($mas_services_billing_add->Created->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $mas_services_billing->Created->caption(), $mas_services_billing->Created->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($mas_services_billing_add->CreatedDateTime->Required) { ?>
			elm = this.getElements("x" + infix + "_CreatedDateTime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $mas_services_billing->CreatedDateTime->caption(), $mas_services_billing->CreatedDateTime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fmas_services_billingadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmas_services_billingadd.lists["x_SERVICE_TYPE"] = <?php echo $mas_services_billing_add->SERVICE_TYPE->Lookup->toClientList() ?>;
...
fmas_services_billingadd.lists["x_DEPARTMENT"] = <?php echo $mas_services_billing_add->DEPARTMENT->Lookup->toClientList() ?>;
...
<?php if ($mas_services_billing_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_services_billing_add->Token ?>">
<?php } ?>
...
<?php if ($mas_services_billing->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_mas_services_billing_CODE" for="x_CODE" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_CODE" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->CODE->caption() ?><?php echo ($mas_services_billing->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->CODE->cellAttributes() ?>>
<script id="tpx_mas_services_billing_CODE" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->SERVICE->Visible) { // SERVICE ?>
	<div id="r_SERVICE" class="form-group row">
		<label id="elh_mas_services_billing_SERVICE" for="x_SERVICE" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_SERVICE" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->SERVICE->caption() ?><?php echo ($mas_services_billing->SERVICE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->SERVICE->cellAttributes() ?>>
<script id="tpx_mas_services_billing_SERVICE" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->UNITS->Visible) { // UNITS ?>
	<div id="r_UNITS" class="form-group row">
		<label id="elh_mas_services_billing_UNITS" for="x_UNITS" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_UNITS" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->UNITS->caption() ?><?php echo ($mas_services_billing->UNITS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->UNITS->cellAttributes() ?>>
<script id="tpx_mas_services_billing_UNITS" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->AMOUNT->Visible) { // AMOUNT ?>
	<div id="r_AMOUNT" class="form-group row">
		<label id="elh_mas_services_billing_AMOUNT" for="x_AMOUNT" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_AMOUNT" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->AMOUNT->caption() ?><?php echo ($mas_services_billing->AMOUNT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->AMOUNT->cellAttributes() ?>>
<script id="tpx_mas_services_billing_AMOUNT" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
	<div id="r_SERVICE_TYPE" class="form-group row">
		<label id="elh_mas_services_billing_SERVICE_TYPE" for="x_SERVICE_TYPE" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_SERVICE_TYPE" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->SERVICE_TYPE->caption() ?><?php echo ($mas_services_billing->SERVICE_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->SERVICE_TYPE->cellAttributes() ?>>
<script id="tpx_mas_services_billing_SERVICE_TYPE" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->DEPARTMENT->Visible) { // DEPARTMENT ?>
	<div id="r_DEPARTMENT" class="form-group row">
		<label id="elh_mas_services_billing_DEPARTMENT" for="x_DEPARTMENT" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_DEPARTMENT" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->DEPARTMENT->caption() ?><?php echo ($mas_services_billing->DEPARTMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->DEPARTMENT->cellAttributes() ?>>
<script id="tpx_mas_services_billing_DEPARTMENT" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
	<div id="r_mas_services_billingcol" class="form-group row">
		<label id="elh_mas_services_billing_mas_services_billingcol" for="x_mas_services_billingcol" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_mas_services_billingcol" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->mas_services_billingcol->caption() ?><?php echo ($mas_services_billing->mas_services_billingcol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->mas_services_billingcol->cellAttributes() ?>>
<script id="tpx_mas_services_billing_mas_services_billingcol" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->DrShareAmount->Visible) { // DrShareAmount ?>
	<div id="r_DrShareAmount" class="form-group row">
		<label id="elh_mas_services_billing_DrShareAmount" for="x_DrShareAmount" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_DrShareAmount" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->DrShareAmount->caption() ?><?php echo ($mas_services_billing->DrShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->DrShareAmount->cellAttributes() ?>>
<script id="tpx_mas_services_billing_DrShareAmount" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->HospShareAmount->Visible) { // HospShareAmount ?>
	<div id="r_HospShareAmount" class="form-group row">
		<label id="elh_mas_services_billing_HospShareAmount" for="x_HospShareAmount" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_HospShareAmount" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->HospShareAmount->caption() ?><?php echo ($mas_services_billing->HospShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->HospShareAmount->cellAttributes() ?>>
<script id="tpx_mas_services_billing_HospShareAmount" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->DrSharePer->Visible) { // DrSharePer ?>
	<div id="r_DrSharePer" class="form-group row">
		<label id="elh_mas_services_billing_DrSharePer" for="x_DrSharePer" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_DrSharePer" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->DrSharePer->caption() ?><?php echo ($mas_services_billing->DrSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->DrSharePer->cellAttributes() ?>>
<script id="tpx_mas_services_billing_DrSharePer" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->HospSharePer->Visible) { // HospSharePer ?>
	<div id="r_HospSharePer" class="form-group row">
		<label id="elh_mas_services_billing_HospSharePer" for="x_HospSharePer" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_HospSharePer" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->HospSharePer->caption() ?><?php echo ($mas_services_billing->HospSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->HospSharePer->cellAttributes() ?>>
<script id="tpx_mas_services_billing_HospSharePer" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_mas_services_billing_TestSubCd" for="x_TestSubCd" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_TestSubCd" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->TestSubCd->caption() ?><?php echo ($mas_services_billing->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->TestSubCd->cellAttributes() ?>>
<script id="tpx_mas_services_billing_TestSubCd" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_mas_services_billing_Method" for="x_Method" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Method" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Method->caption() ?><?php echo ($mas_services_billing->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Method->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Method" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_mas_services_billing_Order" for="x_Order" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Order" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Order->caption() ?><?php echo ($mas_services_billing->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Order->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Order" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_mas_services_billing_Form" for="x_Form" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Form" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Form->caption() ?><?php echo ($mas_services_billing->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Form->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Form" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_mas_services_billing_ResType" for="x_ResType" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_ResType" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->ResType->caption() ?><?php echo ($mas_services_billing->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->ResType->cellAttributes() ?>>
<script id="tpx_mas_services_billing_ResType" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->UnitCD->Visible) { // UnitCD ?>
	<div id="r_UnitCD" class="form-group row">
		<label id="elh_mas_services_billing_UnitCD" for="x_UnitCD" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_UnitCD" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->UnitCD->caption() ?><?php echo ($mas_services_billing->UnitCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->UnitCD->cellAttributes() ?>>
<script id="tpx_mas_services_billing_UnitCD" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_mas_services_billing_RefValue" for="x_RefValue" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_RefValue" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->RefValue->caption() ?><?php echo ($mas_services_billing->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->RefValue->cellAttributes() ?>>
<script id="tpx_mas_services_billing_RefValue" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_mas_services_billing_Sample" for="x_Sample" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Sample" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Sample->caption() ?><?php echo ($mas_services_billing->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Sample->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Sample" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_mas_services_billing_NoD" for="x_NoD" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_NoD" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->NoD->caption() ?><?php echo ($mas_services_billing->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->NoD->cellAttributes() ?>>
<script id="tpx_mas_services_billing_NoD" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_mas_services_billing_BillOrder" for="x_BillOrder" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_BillOrder" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->BillOrder->caption() ?><?php echo ($mas_services_billing->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->BillOrder->cellAttributes() ?>>
<script id="tpx_mas_services_billing_BillOrder" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_mas_services_billing_Formula" for="x_Formula" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Formula" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Formula->caption() ?><?php echo ($mas_services_billing->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Formula->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Formula" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_mas_services_billing_Inactive" for="x_Inactive" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Inactive" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Inactive->caption() ?><?php echo ($mas_services_billing->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Inactive->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Inactive" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Outsource->Visible) { // Outsource ?>
	<div id="r_Outsource" class="form-group row">
		<label id="elh_mas_services_billing_Outsource" for="x_Outsource" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Outsource" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Outsource->caption() ?><?php echo ($mas_services_billing->Outsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Outsource->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Outsource" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_mas_services_billing_CollSample" for="x_CollSample" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_CollSample" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->CollSample->caption() ?><?php echo ($mas_services_billing->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->CollSample->cellAttributes() ?>>
<script id="tpx_mas_services_billing_CollSample" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->TestType->Visible) { // TestType ?>
	<div id="r_TestType" class="form-group row">
		<label id="elh_mas_services_billing_TestType" for="x_TestType" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_TestType" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->TestType->caption() ?><?php echo ($mas_services_billing->TestType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->TestType->cellAttributes() ?>>
<script id="tpx_mas_services_billing_TestType" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->NoHeading->Visible) { // NoHeading ?>
	<div id="r_NoHeading" class="form-group row">
		<label id="elh_mas_services_billing_NoHeading" for="x_NoHeading" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_NoHeading" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->NoHeading->caption() ?><?php echo ($mas_services_billing->NoHeading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->NoHeading->cellAttributes() ?>>
<script id="tpx_mas_services_billing_NoHeading" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->ChemicalCode->Visible) { // ChemicalCode ?>
	<div id="r_ChemicalCode" class="form-group row">
		<label id="elh_mas_services_billing_ChemicalCode" for="x_ChemicalCode" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_ChemicalCode" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->ChemicalCode->caption() ?><?php echo ($mas_services_billing->ChemicalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->ChemicalCode->cellAttributes() ?>>
<script id="tpx_mas_services_billing_ChemicalCode" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->ChemicalName->Visible) { // ChemicalName ?>
	<div id="r_ChemicalName" class="form-group row">
		<label id="elh_mas_services_billing_ChemicalName" for="x_ChemicalName" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_ChemicalName" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->ChemicalName->caption() ?><?php echo ($mas_services_billing->ChemicalName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->ChemicalName->cellAttributes() ?>>
<script id="tpx_mas_services_billing_ChemicalName" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Utilaization->Visible) { // Utilaization ?>
	<div id="r_Utilaization" class="form-group row">
		<label id="elh_mas_services_billing_Utilaization" for="x_Utilaization" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Utilaization" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Utilaization->caption() ?><?php echo ($mas_services_billing->Utilaization->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Utilaization->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Utilaization" class="mas_services_billingadd" type="text/html">
...
<?php if ($mas_services_billing->Interpretation->Visible) { // Interpretation ?>
	<div id="r_Interpretation" class="form-group row">
		<label id="elh_mas_services_billing_Interpretation" class="<?php echo $mas_services_billing_add->LeftColumnClass ?>"><script id="tpc_mas_services_billing_Interpretation" class="mas_services_billingadd" type="text/html"><span><?php echo $mas_services_billing->Interpretation->caption() ?><?php echo ($mas_services_billing->Interpretation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $mas_services_billing_add->RightColumnClass ?>"><div<?php echo $mas_services_billing->Interpretation->cellAttributes() ?>>
<script id="tpx_mas_services_billing_Interpretation" class="mas_services_billingadd" type="text/html">
...
ew.createEditor("fmas_services_billingadd", "x_Interpretation", 35, 4, <?php echo ($mas_services_billing->Interpretation->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
ew.applyTemplate("tpd_mas_services_billingadd", "tpm_mas_services_billingadd", "mas_services_billingadd", "<?php echo $mas_services_billing->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.mas_services_billingadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
