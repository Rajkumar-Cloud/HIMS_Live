...
var fhospital_pharmacyadd = currentForm = new ew.Form("fhospital_pharmacyadd", "add");
...
fhospital_pharmacyadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($hospital_pharmacy_add->BranchID->Required) { ?>
...
fhospital_pharmacyadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhospital_pharmacyadd.lists["x_status"] = <?php echo $hospital_pharmacy_add->status->Lookup->toClientList() ?>;
fhospital_pharmacyadd.lists["x_status"].options = <?php echo JsonEncode($hospital_pharmacy_add->status->lookupOptions()) ?>;
fhospital_pharmacyadd.lists["x_HospId"] = <?php echo $hospital_pharmacy_add->HospId->Lookup->toClientList() ?>;
...
<?php if ($hospital_pharmacy_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $hospital_pharmacy_add->Token ?>">
<?php } ?>
...
<?php if ($hospital_pharmacy->logo->Visible) { // logo ?>
	<div id="r_logo" class="form-group row">
		<label id="elh_hospital_pharmacy_logo" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->logo->caption() ?><?php echo ($hospital_pharmacy->logo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->logo->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->pharmacy->Visible) { // pharmacy ?>
	<div id="r_pharmacy" class="form-group row">
		<label id="elh_hospital_pharmacy_pharmacy" for="x_pharmacy" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->pharmacy->caption() ?><?php echo ($hospital_pharmacy->pharmacy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->pharmacy->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->street->Visible) { // street ?>
	<div id="r_street" class="form-group row">
		<label id="elh_hospital_pharmacy_street" for="x_street" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->street->caption() ?><?php echo ($hospital_pharmacy->street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->street->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->area->Visible) { // area ?>
	<div id="r_area" class="form-group row">
		<label id="elh_hospital_pharmacy_area" for="x_area" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->area->caption() ?><?php echo ($hospital_pharmacy->area->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->area->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->town->Visible) { // town ?>
	<div id="r_town" class="form-group row">
		<label id="elh_hospital_pharmacy_town" for="x_town" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->town->caption() ?><?php echo ($hospital_pharmacy->town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->town->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_hospital_pharmacy_province" for="x_province" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->province->caption() ?><?php echo ($hospital_pharmacy->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->province->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_hospital_pharmacy_postal_code" for="x_postal_code" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->postal_code->caption() ?><?php echo ($hospital_pharmacy->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->postal_code->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->phone_no->Visible) { // phone_no ?>
	<div id="r_phone_no" class="form-group row">
		<label id="elh_hospital_pharmacy_phone_no" for="x_phone_no" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->phone_no->caption() ?><?php echo ($hospital_pharmacy->phone_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->phone_no->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->PreFixCode->Visible) { // PreFixCode ?>
	<div id="r_PreFixCode" class="form-group row">
		<label id="elh_hospital_pharmacy_PreFixCode" for="x_PreFixCode" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->PreFixCode->caption() ?><?php echo ($hospital_pharmacy->PreFixCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->PreFixCode->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_hospital_pharmacy_status" for="x_status" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->status->caption() ?><?php echo ($hospital_pharmacy->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->status->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->pharmacyGST->Visible) { // pharmacyGST ?>
	<div id="r_pharmacyGST" class="form-group row">
		<label id="elh_hospital_pharmacy_pharmacyGST" for="x_pharmacyGST" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->pharmacyGST->caption() ?><?php echo ($hospital_pharmacy->pharmacyGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->pharmacyGST->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->HospId->Visible) { // HospId ?>
	<div id="r_HospId" class="form-group row">
		<label id="elh_hospital_pharmacy_HospId" for="x_HospId" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->HospId->caption() ?><?php echo ($hospital_pharmacy->HospId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->HospId->cellAttributes() ?>>
...
<?php if ($hospital_pharmacy->BranchID->Visible) { // BranchID ?>
	<div id="r_BranchID" class="form-group row">
		<label id="elh_hospital_pharmacy_BranchID" for="x_BranchID" class="<?php echo $hospital_pharmacy_add->LeftColumnClass ?>"><?php echo $hospital_pharmacy->BranchID->caption() ?><?php echo ($hospital_pharmacy->BranchID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hospital_pharmacy_add->RightColumnClass ?>"><div<?php echo $hospital_pharmacy->BranchID->cellAttributes() ?>>
