...
var fstore_storemastedit = currentForm = new ew.Form("fstore_storemastedit", "edit");
...
fstore_storemastedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($store_storemast_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $store_storemast->id->caption(), $store_storemast->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php } ?>
		<?php if ($store_storemast_edit->OV->Required) { ?>
		...
		<?php if ($store_storemast_edit->LATESTOV->Required) { ?>
		...
		<?php if ($store_storemast_edit->ITEMTYPE->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_storemast_edit->ROWID->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_storemast_edit->MOVED->Required) { ?>
		...
		<?php if ($store_storemast_edit->NEWTAX->Required) { ?>
		...
		<?php if ($store_storemast_edit->HSNCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_storemast_edit->OLDTAX->Required) { ?>
		...
		<?php if ($store_storemast_edit->StoreID->Required) { ?>
...
fstore_storemastedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($store_storemast_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_storemast_edit->Token ?>">
<?php } ?>
...
<?php if ($store_storemast->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_store_storemast_BRCODE" for="x_BRCODE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->BRCODE->caption() ?><?php echo ($store_storemast->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->BRCODE->cellAttributes() ?>>
...
<?php if ($store_storemast->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_store_storemast_PRC" for="x_PRC" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PRC->caption() ?><?php echo ($store_storemast->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PRC->cellAttributes() ?>>
...
<?php if ($store_storemast->TYPE->Visible) { // TYPE ?>
	<div id="r_TYPE" class="form-group row">
		<label id="elh_store_storemast_TYPE" for="x_TYPE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->TYPE->caption() ?><?php echo ($store_storemast->TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->TYPE->cellAttributes() ?>>
...
<?php if ($store_storemast->DES->Visible) { // DES ?>
	<div id="r_DES" class="form-group row">
		<label id="elh_store_storemast_DES" for="x_DES" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->DES->caption() ?><?php echo ($store_storemast->DES->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->DES->cellAttributes() ?>>
...
<?php if ($store_storemast->UM->Visible) { // UM ?>
	<div id="r_UM" class="form-group row">
		<label id="elh_store_storemast_UM" for="x_UM" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->UM->caption() ?><?php echo ($store_storemast->UM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->UM->cellAttributes() ?>>
...
<?php if ($store_storemast->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_store_storemast_RT" for="x_RT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->RT->caption() ?><?php echo ($store_storemast->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->RT->cellAttributes() ?>>
...
<?php if ($store_storemast->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_store_storemast_UR" for="x_UR" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->UR->caption() ?><?php echo ($store_storemast->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->UR->cellAttributes() ?>>
...
<?php if ($store_storemast->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_store_storemast_TAXP" for="x_TAXP" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->TAXP->caption() ?><?php echo ($store_storemast->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->TAXP->cellAttributes() ?>>
...
<?php if ($store_storemast->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_store_storemast_BATCHNO" for="x_BATCHNO" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->BATCHNO->caption() ?><?php echo ($store_storemast->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->BATCHNO->cellAttributes() ?>>
...
<?php if ($store_storemast->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_store_storemast_OQ" for="x_OQ" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->OQ->caption() ?><?php echo ($store_storemast->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->OQ->cellAttributes() ?>>
...
<?php if ($store_storemast->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_store_storemast_RQ" for="x_RQ" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->RQ->caption() ?><?php echo ($store_storemast->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->RQ->cellAttributes() ?>>
...
<?php if ($store_storemast->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_store_storemast_MRQ" for="x_MRQ" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->MRQ->caption() ?><?php echo ($store_storemast->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->MRQ->cellAttributes() ?>>
...
<?php if ($store_storemast->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_store_storemast_IQ" for="x_IQ" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->IQ->caption() ?><?php echo ($store_storemast->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->IQ->cellAttributes() ?>>
...
<?php if ($store_storemast->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_store_storemast_MRP" for="x_MRP" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->MRP->caption() ?><?php echo ($store_storemast->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->MRP->cellAttributes() ?>>
...
<?php if ($store_storemast->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_store_storemast_EXPDT" for="x_EXPDT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->EXPDT->caption() ?><?php echo ($store_storemast->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->EXPDT->cellAttributes() ?>>
...
<?php if ($store_storemast->SALQTY->Visible) { // SALQTY ?>
	<div id="r_SALQTY" class="form-group row">
		<label id="elh_store_storemast_SALQTY" for="x_SALQTY" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->SALQTY->caption() ?><?php echo ($store_storemast->SALQTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->SALQTY->cellAttributes() ?>>
...
<?php if ($store_storemast->LASTPURDT->Visible) { // LASTPURDT ?>
	<div id="r_LASTPURDT" class="form-group row">
		<label id="elh_store_storemast_LASTPURDT" for="x_LASTPURDT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->LASTPURDT->caption() ?><?php echo ($store_storemast->LASTPURDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->LASTPURDT->cellAttributes() ?>>
...
<?php if ($store_storemast->LASTSUPP->Visible) { // LASTSUPP ?>
	<div id="r_LASTSUPP" class="form-group row">
		<label id="elh_store_storemast_LASTSUPP" for="x_LASTSUPP" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->LASTSUPP->caption() ?><?php echo ($store_storemast->LASTSUPP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->LASTSUPP->cellAttributes() ?>>
...
<?php if ($store_storemast->GENNAME->Visible) { // GENNAME ?>
	<div id="r_GENNAME" class="form-group row">
		<label id="elh_store_storemast_GENNAME" for="x_GENNAME" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->GENNAME->caption() ?><?php echo ($store_storemast->GENNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->GENNAME->cellAttributes() ?>>
...
<?php if ($store_storemast->LASTISSDT->Visible) { // LASTISSDT ?>
	<div id="r_LASTISSDT" class="form-group row">
		<label id="elh_store_storemast_LASTISSDT" for="x_LASTISSDT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->LASTISSDT->caption() ?><?php echo ($store_storemast->LASTISSDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->LASTISSDT->cellAttributes() ?>>
...
<?php if ($store_storemast->CREATEDDT->Visible) { // CREATEDDT ?>
	<div id="r_CREATEDDT" class="form-group row">
		<label id="elh_store_storemast_CREATEDDT" for="x_CREATEDDT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->CREATEDDT->caption() ?><?php echo ($store_storemast->CREATEDDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->CREATEDDT->cellAttributes() ?>>
...
<?php if ($store_storemast->OPPRC->Visible) { // OPPRC ?>
	<div id="r_OPPRC" class="form-group row">
		<label id="elh_store_storemast_OPPRC" for="x_OPPRC" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->OPPRC->caption() ?><?php echo ($store_storemast->OPPRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->OPPRC->cellAttributes() ?>>
...
<?php if ($store_storemast->RESTRICT->Visible) { // RESTRICT ?>
	<div id="r_RESTRICT" class="form-group row">
		<label id="elh_store_storemast_RESTRICT" for="x_RESTRICT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->RESTRICT->caption() ?><?php echo ($store_storemast->RESTRICT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->RESTRICT->cellAttributes() ?>>
...
<?php if ($store_storemast->BAWAPRC->Visible) { // BAWAPRC ?>
	<div id="r_BAWAPRC" class="form-group row">
		<label id="elh_store_storemast_BAWAPRC" for="x_BAWAPRC" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->BAWAPRC->caption() ?><?php echo ($store_storemast->BAWAPRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->BAWAPRC->cellAttributes() ?>>
...
<?php if ($store_storemast->STAXPER->Visible) { // STAXPER ?>
	<div id="r_STAXPER" class="form-group row">
		<label id="elh_store_storemast_STAXPER" for="x_STAXPER" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->STAXPER->caption() ?><?php echo ($store_storemast->STAXPER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->STAXPER->cellAttributes() ?>>
...
<?php if ($store_storemast->TAXTYPE->Visible) { // TAXTYPE ?>
	<div id="r_TAXTYPE" class="form-group row">
		<label id="elh_store_storemast_TAXTYPE" for="x_TAXTYPE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->TAXTYPE->caption() ?><?php echo ($store_storemast->TAXTYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->TAXTYPE->cellAttributes() ?>>
...
<?php if ($store_storemast->OLDTAXP->Visible) { // OLDTAXP ?>
	<div id="r_OLDTAXP" class="form-group row">
		<label id="elh_store_storemast_OLDTAXP" for="x_OLDTAXP" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->OLDTAXP->caption() ?><?php echo ($store_storemast->OLDTAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->OLDTAXP->cellAttributes() ?>>
...
<?php if ($store_storemast->TAXUPD->Visible) { // TAXUPD ?>
	<div id="r_TAXUPD" class="form-group row">
		<label id="elh_store_storemast_TAXUPD" for="x_TAXUPD" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->TAXUPD->caption() ?><?php echo ($store_storemast->TAXUPD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->TAXUPD->cellAttributes() ?>>
...
<?php if ($store_storemast->PACKAGE->Visible) { // PACKAGE ?>
	<div id="r_PACKAGE" class="form-group row">
		<label id="elh_store_storemast_PACKAGE" for="x_PACKAGE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PACKAGE->caption() ?><?php echo ($store_storemast->PACKAGE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PACKAGE->cellAttributes() ?>>
...
<?php if ($store_storemast->NEWRT->Visible) { // NEWRT ?>
	<div id="r_NEWRT" class="form-group row">
		<label id="elh_store_storemast_NEWRT" for="x_NEWRT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->NEWRT->caption() ?><?php echo ($store_storemast->NEWRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->NEWRT->cellAttributes() ?>>
...
<?php if ($store_storemast->NEWMRP->Visible) { // NEWMRP ?>
	<div id="r_NEWMRP" class="form-group row">
		<label id="elh_store_storemast_NEWMRP" for="x_NEWMRP" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->NEWMRP->caption() ?><?php echo ($store_storemast->NEWMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->NEWMRP->cellAttributes() ?>>
...
<?php if ($store_storemast->NEWUR->Visible) { // NEWUR ?>
	<div id="r_NEWUR" class="form-group row">
		<label id="elh_store_storemast_NEWUR" for="x_NEWUR" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->NEWUR->caption() ?><?php echo ($store_storemast->NEWUR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->NEWUR->cellAttributes() ?>>
...
<?php if ($store_storemast->STATUS->Visible) { // STATUS ?>
	<div id="r_STATUS" class="form-group row">
		<label id="elh_store_storemast_STATUS" for="x_STATUS" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->STATUS->caption() ?><?php echo ($store_storemast->STATUS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->STATUS->cellAttributes() ?>>
...
<?php if ($store_storemast->RETNQTY->Visible) { // RETNQTY ?>
	<div id="r_RETNQTY" class="form-group row">
		<label id="elh_store_storemast_RETNQTY" for="x_RETNQTY" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->RETNQTY->caption() ?><?php echo ($store_storemast->RETNQTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->RETNQTY->cellAttributes() ?>>
...
<?php if ($store_storemast->KEMODISC->Visible) { // KEMODISC ?>
	<div id="r_KEMODISC" class="form-group row">
		<label id="elh_store_storemast_KEMODISC" for="x_KEMODISC" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->KEMODISC->caption() ?><?php echo ($store_storemast->KEMODISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->KEMODISC->cellAttributes() ?>>
...
<?php if ($store_storemast->PATSALE->Visible) { // PATSALE ?>
	<div id="r_PATSALE" class="form-group row">
		<label id="elh_store_storemast_PATSALE" for="x_PATSALE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PATSALE->caption() ?><?php echo ($store_storemast->PATSALE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PATSALE->cellAttributes() ?>>
...
<?php if ($store_storemast->ORGAN->Visible) { // ORGAN ?>
	<div id="r_ORGAN" class="form-group row">
		<label id="elh_store_storemast_ORGAN" for="x_ORGAN" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->ORGAN->caption() ?><?php echo ($store_storemast->ORGAN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->ORGAN->cellAttributes() ?>>
...
<?php if ($store_storemast->OLDRQ->Visible) { // OLDRQ ?>
	<div id="r_OLDRQ" class="form-group row">
		<label id="elh_store_storemast_OLDRQ" for="x_OLDRQ" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->OLDRQ->caption() ?><?php echo ($store_storemast->OLDRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->OLDRQ->cellAttributes() ?>>
...
<?php if ($store_storemast->DRID->Visible) { // DRID ?>
	<div id="r_DRID" class="form-group row">
		<label id="elh_store_storemast_DRID" for="x_DRID" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->DRID->caption() ?><?php echo ($store_storemast->DRID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->DRID->cellAttributes() ?>>
...
<?php if ($store_storemast->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_store_storemast_MFRCODE" for="x_MFRCODE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->MFRCODE->caption() ?><?php echo ($store_storemast->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->MFRCODE->cellAttributes() ?>>
...
<?php if ($store_storemast->COMBCODE->Visible) { // COMBCODE ?>
	<div id="r_COMBCODE" class="form-group row">
		<label id="elh_store_storemast_COMBCODE" for="x_COMBCODE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->COMBCODE->caption() ?><?php echo ($store_storemast->COMBCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->COMBCODE->cellAttributes() ?>>
...
<?php if ($store_storemast->GENCODE->Visible) { // GENCODE ?>
	<div id="r_GENCODE" class="form-group row">
		<label id="elh_store_storemast_GENCODE" for="x_GENCODE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->GENCODE->caption() ?><?php echo ($store_storemast->GENCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->GENCODE->cellAttributes() ?>>
...
<?php if ($store_storemast->STRENGTH->Visible) { // STRENGTH ?>
	<div id="r_STRENGTH" class="form-group row">
		<label id="elh_store_storemast_STRENGTH" for="x_STRENGTH" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->STRENGTH->caption() ?><?php echo ($store_storemast->STRENGTH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->STRENGTH->cellAttributes() ?>>
...
<?php if ($store_storemast->UNIT->Visible) { // UNIT ?>
	<div id="r_UNIT" class="form-group row">
		<label id="elh_store_storemast_UNIT" for="x_UNIT" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->UNIT->caption() ?><?php echo ($store_storemast->UNIT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->UNIT->cellAttributes() ?>>
...
<?php if ($store_storemast->FORMULARY->Visible) { // FORMULARY ?>
	<div id="r_FORMULARY" class="form-group row">
		<label id="elh_store_storemast_FORMULARY" for="x_FORMULARY" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->FORMULARY->caption() ?><?php echo ($store_storemast->FORMULARY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->FORMULARY->cellAttributes() ?>>
...
<?php if ($store_storemast->STOCK->Visible) { // STOCK ?>
	<div id="r_STOCK" class="form-group row">
		<label id="elh_store_storemast_STOCK" for="x_STOCK" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->STOCK->caption() ?><?php echo ($store_storemast->STOCK->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->STOCK->cellAttributes() ?>>
...
<?php if ($store_storemast->RACKNO->Visible) { // RACKNO ?>
	<div id="r_RACKNO" class="form-group row">
		<label id="elh_store_storemast_RACKNO" for="x_RACKNO" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->RACKNO->caption() ?><?php echo ($store_storemast->RACKNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->RACKNO->cellAttributes() ?>>
...
<?php if ($store_storemast->SUPPNAME->Visible) { // SUPPNAME ?>
	<div id="r_SUPPNAME" class="form-group row">
		<label id="elh_store_storemast_SUPPNAME" for="x_SUPPNAME" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->SUPPNAME->caption() ?><?php echo ($store_storemast->SUPPNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->SUPPNAME->cellAttributes() ?>>
...
<?php if ($store_storemast->COMBNAME->Visible) { // COMBNAME ?>
	<div id="r_COMBNAME" class="form-group row">
		<label id="elh_store_storemast_COMBNAME" for="x_COMBNAME" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->COMBNAME->caption() ?><?php echo ($store_storemast->COMBNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->COMBNAME->cellAttributes() ?>>
...
<?php if ($store_storemast->GENERICNAME->Visible) { // GENERICNAME ?>
	<div id="r_GENERICNAME" class="form-group row">
		<label id="elh_store_storemast_GENERICNAME" for="x_GENERICNAME" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->GENERICNAME->caption() ?><?php echo ($store_storemast->GENERICNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->GENERICNAME->cellAttributes() ?>>
...
<?php if ($store_storemast->REMARK->Visible) { // REMARK ?>
	<div id="r_REMARK" class="form-group row">
		<label id="elh_store_storemast_REMARK" for="x_REMARK" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->REMARK->caption() ?><?php echo ($store_storemast->REMARK->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->REMARK->cellAttributes() ?>>
...
<?php if ($store_storemast->TEMP->Visible) { // TEMP ?>
	<div id="r_TEMP" class="form-group row">
		<label id="elh_store_storemast_TEMP" for="x_TEMP" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->TEMP->caption() ?><?php echo ($store_storemast->TEMP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->TEMP->cellAttributes() ?>>
...
<?php if ($store_storemast->PACKING->Visible) { // PACKING ?>
	<div id="r_PACKING" class="form-group row">
		<label id="elh_store_storemast_PACKING" for="x_PACKING" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PACKING->caption() ?><?php echo ($store_storemast->PACKING->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PACKING->cellAttributes() ?>>
...
<?php if ($store_storemast->PhysQty->Visible) { // PhysQty ?>
	<div id="r_PhysQty" class="form-group row">
		<label id="elh_store_storemast_PhysQty" for="x_PhysQty" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PhysQty->caption() ?><?php echo ($store_storemast->PhysQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PhysQty->cellAttributes() ?>>
...
<?php if ($store_storemast->LedQty->Visible) { // LedQty ?>
	<div id="r_LedQty" class="form-group row">
		<label id="elh_store_storemast_LedQty" for="x_LedQty" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->LedQty->caption() ?><?php echo ($store_storemast->LedQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->LedQty->cellAttributes() ?>>
...
<?php if ($store_storemast->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_store_storemast_id" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->id->caption() ?><?php echo ($store_storemast->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->id->cellAttributes() ?>>
<span id="el_store_storemast_id">
<span<?php echo $store_storemast->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($store_storemast->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="store_storemast" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($store_storemast->id->CurrentValue) ?>">
<?php echo $store_storemast->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($store_storemast->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_store_storemast_PurValue" for="x_PurValue" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PurValue->caption() ?><?php echo ($store_storemast->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PurValue->cellAttributes() ?>>
...
<?php if ($store_storemast->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_store_storemast_PSGST" for="x_PSGST" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PSGST->caption() ?><?php echo ($store_storemast->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PSGST->cellAttributes() ?>>
...
<?php if ($store_storemast->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_store_storemast_PCGST" for="x_PCGST" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->PCGST->caption() ?><?php echo ($store_storemast->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->PCGST->cellAttributes() ?>>
...
<?php if ($store_storemast->SaleValue->Visible) { // SaleValue ?>
	<div id="r_SaleValue" class="form-group row">
		<label id="elh_store_storemast_SaleValue" for="x_SaleValue" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->SaleValue->caption() ?><?php echo ($store_storemast->SaleValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->SaleValue->cellAttributes() ?>>
...
<?php if ($store_storemast->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_store_storemast_SSGST" for="x_SSGST" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->SSGST->caption() ?><?php echo ($store_storemast->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->SSGST->cellAttributes() ?>>
...
<?php if ($store_storemast->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_store_storemast_SCGST" for="x_SCGST" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->SCGST->caption() ?><?php echo ($store_storemast->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->SCGST->cellAttributes() ?>>
...
<?php if ($store_storemast->SaleRate->Visible) { // SaleRate ?>
	<div id="r_SaleRate" class="form-group row">
		<label id="elh_store_storemast_SaleRate" for="x_SaleRate" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->SaleRate->caption() ?><?php echo ($store_storemast->SaleRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->SaleRate->cellAttributes() ?>>
...
<?php if ($store_storemast->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_store_storemast_HospID" for="x_HospID" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->HospID->caption() ?><?php echo ($store_storemast->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->HospID->cellAttributes() ?>>
...
<?php if ($store_storemast->BRNAME->Visible) { // BRNAME ?>
	<div id="r_BRNAME" class="form-group row">
		<label id="elh_store_storemast_BRNAME" for="x_BRNAME" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->BRNAME->caption() ?><?php echo ($store_storemast->BRNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->BRNAME->cellAttributes() ?>>
...
<?php if ($store_storemast->OV->Visible) { // OV ?>
	<div id="r_OV" class="form-group row">
		<label id="elh_store_storemast_OV" for="x_OV" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->OV->caption() ?><?php echo ($store_storemast->OV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->OV->cellAttributes() ?>>
...
<?php if ($store_storemast->LATESTOV->Visible) { // LATESTOV ?>
	<div id="r_LATESTOV" class="form-group row">
		<label id="elh_store_storemast_LATESTOV" for="x_LATESTOV" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->LATESTOV->caption() ?><?php echo ($store_storemast->LATESTOV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->LATESTOV->cellAttributes() ?>>
...
<?php if ($store_storemast->ITEMTYPE->Visible) { // ITEMTYPE ?>
	<div id="r_ITEMTYPE" class="form-group row">
		<label id="elh_store_storemast_ITEMTYPE" for="x_ITEMTYPE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->ITEMTYPE->caption() ?><?php echo ($store_storemast->ITEMTYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->ITEMTYPE->cellAttributes() ?>>
...
<?php if ($store_storemast->ROWID->Visible) { // ROWID ?>
	<div id="r_ROWID" class="form-group row">
		<label id="elh_store_storemast_ROWID" for="x_ROWID" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->ROWID->caption() ?><?php echo ($store_storemast->ROWID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->ROWID->cellAttributes() ?>>
...
<?php if ($store_storemast->MOVED->Visible) { // MOVED ?>
	<div id="r_MOVED" class="form-group row">
		<label id="elh_store_storemast_MOVED" for="x_MOVED" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->MOVED->caption() ?><?php echo ($store_storemast->MOVED->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->MOVED->cellAttributes() ?>>
...
<?php if ($store_storemast->NEWTAX->Visible) { // NEWTAX ?>
	<div id="r_NEWTAX" class="form-group row">
		<label id="elh_store_storemast_NEWTAX" for="x_NEWTAX" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->NEWTAX->caption() ?><?php echo ($store_storemast->NEWTAX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->NEWTAX->cellAttributes() ?>>
...
<?php if ($store_storemast->HSNCODE->Visible) { // HSNCODE ?>
	<div id="r_HSNCODE" class="form-group row">
		<label id="elh_store_storemast_HSNCODE" for="x_HSNCODE" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->HSNCODE->caption() ?><?php echo ($store_storemast->HSNCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->HSNCODE->cellAttributes() ?>>
...
<?php if ($store_storemast->OLDTAX->Visible) { // OLDTAX ?>
	<div id="r_OLDTAX" class="form-group row">
		<label id="elh_store_storemast_OLDTAX" for="x_OLDTAX" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->OLDTAX->caption() ?><?php echo ($store_storemast->OLDTAX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->OLDTAX->cellAttributes() ?>>
...
<?php if ($store_storemast->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_storemast_StoreID" for="x_StoreID" class="<?php echo $store_storemast_edit->LeftColumnClass ?>"><?php echo $store_storemast->StoreID->caption() ?><?php echo ($store_storemast->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storemast_edit->RightColumnClass ?>"><div<?php echo $store_storemast->StoreID->cellAttributes() ?>>
