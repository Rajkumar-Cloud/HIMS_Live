...
// Create page object
$pharmacy_stock_movement_add = new pharmacy_stock_movement_add();

// Run the page
$pharmacy_stock_movement_add->run();
...
$pharmacy_stock_movement_add->Page_Render();
?>
...
var fpharmacy_stock_movementadd = currentForm = new ew.Form("fpharmacy_stock_movementadd", "add");
...
fpharmacy_stock_movementadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_stock_movement_add->PRC->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->PrName->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->BATCHNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->OpeningStk->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->PurchaseQty->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->SalesQty->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->ClosingStk->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->PurchasefreeQty->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->TransferingQty->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->UnitPurchaseRate->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->UnitSaleRate->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->CreatedDate->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->OQ->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->RQ->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->MRQ->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->IQ->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->MRP->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->EXPDT->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->UR->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->RT->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->PRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->BATCH->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->PC->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->OLDRT->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->TEMPMRQ->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->TAXP->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->OLDRATE->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->NEWRATE->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->OTEMPMRA->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->ACTIVESTATUS->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->PSGST->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->PCGST->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->SSGST->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->SCGST->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->MFRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->BRCODE->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->FRQ->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->HospID->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->UM->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->GENNAME->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_stock_movement_add->BILLDATE->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->CreatedDateTime->Required) { ?>
		...
		<?php if ($pharmacy_stock_movement_add->baid->Required) { ?>
...
fpharmacy_stock_movementadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fpharmacy_stock_movementadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $pharmacy_stock_movement_add->showPageHeader(); ?>
<?php
$pharmacy_stock_movement_add->showMessage();
?>
<form name="fpharmacy_stock_movementadd" id="fpharmacy_stock_movementadd" class="<?php echo $pharmacy_stock_movement_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($pharmacy_stock_movement_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_stock_movement_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="pharmacy_stock_movement">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$pharmacy_stock_movement_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($pharmacy_stock_movement->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PRC" for="x_PRC" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PRC->caption() ?><?php echo ($pharmacy_stock_movement->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PRC->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PrName" for="x_PrName" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PrName->caption() ?><?php echo ($pharmacy_stock_movement->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PrName->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_pharmacy_stock_movement_BATCHNO" for="x_BATCHNO" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->BATCHNO->caption() ?><?php echo ($pharmacy_stock_movement->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->BATCHNO->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->OpeningStk->Visible) { // OpeningStk ?>
	<div id="r_OpeningStk" class="form-group row">
		<label id="elh_pharmacy_stock_movement_OpeningStk" for="x_OpeningStk" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->OpeningStk->caption() ?><?php echo ($pharmacy_stock_movement->OpeningStk->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->OpeningStk->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PurchaseQty->Visible) { // PurchaseQty ?>
	<div id="r_PurchaseQty" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PurchaseQty" for="x_PurchaseQty" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PurchaseQty->caption() ?><?php echo ($pharmacy_stock_movement->PurchaseQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PurchaseQty->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->SalesQty->Visible) { // SalesQty ?>
	<div id="r_SalesQty" class="form-group row">
		<label id="elh_pharmacy_stock_movement_SalesQty" for="x_SalesQty" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->SalesQty->caption() ?><?php echo ($pharmacy_stock_movement->SalesQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->SalesQty->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->ClosingStk->Visible) { // ClosingStk ?>
	<div id="r_ClosingStk" class="form-group row">
		<label id="elh_pharmacy_stock_movement_ClosingStk" for="x_ClosingStk" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->ClosingStk->caption() ?><?php echo ($pharmacy_stock_movement->ClosingStk->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->ClosingStk->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PurchasefreeQty->Visible) { // PurchasefreeQty ?>
	<div id="r_PurchasefreeQty" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PurchasefreeQty" for="x_PurchasefreeQty" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PurchasefreeQty->caption() ?><?php echo ($pharmacy_stock_movement->PurchasefreeQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PurchasefreeQty->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->TransferingQty->Visible) { // TransferingQty ?>
	<div id="r_TransferingQty" class="form-group row">
		<label id="elh_pharmacy_stock_movement_TransferingQty" for="x_TransferingQty" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->TransferingQty->caption() ?><?php echo ($pharmacy_stock_movement->TransferingQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->TransferingQty->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->UnitPurchaseRate->Visible) { // UnitPurchaseRate ?>
	<div id="r_UnitPurchaseRate" class="form-group row">
		<label id="elh_pharmacy_stock_movement_UnitPurchaseRate" for="x_UnitPurchaseRate" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->UnitPurchaseRate->caption() ?><?php echo ($pharmacy_stock_movement->UnitPurchaseRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->UnitPurchaseRate->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->UnitSaleRate->Visible) { // UnitSaleRate ?>
	<div id="r_UnitSaleRate" class="form-group row">
		<label id="elh_pharmacy_stock_movement_UnitSaleRate" for="x_UnitSaleRate" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->UnitSaleRate->caption() ?><?php echo ($pharmacy_stock_movement->UnitSaleRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->UnitSaleRate->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->CreatedDate->Visible) { // CreatedDate ?>
	<div id="r_CreatedDate" class="form-group row">
		<label id="elh_pharmacy_stock_movement_CreatedDate" for="x_CreatedDate" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->CreatedDate->caption() ?><?php echo ($pharmacy_stock_movement->CreatedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->CreatedDate->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_pharmacy_stock_movement_OQ" for="x_OQ" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->OQ->caption() ?><?php echo ($pharmacy_stock_movement->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->OQ->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_pharmacy_stock_movement_RQ" for="x_RQ" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->RQ->caption() ?><?php echo ($pharmacy_stock_movement->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->RQ->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_pharmacy_stock_movement_MRQ" for="x_MRQ" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->MRQ->caption() ?><?php echo ($pharmacy_stock_movement->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->MRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_pharmacy_stock_movement_IQ" for="x_IQ" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->IQ->caption() ?><?php echo ($pharmacy_stock_movement->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->IQ->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_pharmacy_stock_movement_MRP" for="x_MRP" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->MRP->caption() ?><?php echo ($pharmacy_stock_movement->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->MRP->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_pharmacy_stock_movement_EXPDT" for="x_EXPDT" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->EXPDT->caption() ?><?php echo ($pharmacy_stock_movement->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->EXPDT->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_pharmacy_stock_movement_UR" for="x_UR" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->UR->caption() ?><?php echo ($pharmacy_stock_movement->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->UR->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_pharmacy_stock_movement_RT" for="x_RT" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->RT->caption() ?><?php echo ($pharmacy_stock_movement->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->RT->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PRCODE->Visible) { // PRCODE ?>
	<div id="r_PRCODE" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PRCODE" for="x_PRCODE" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PRCODE->caption() ?><?php echo ($pharmacy_stock_movement->PRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->BATCH->Visible) { // BATCH ?>
	<div id="r_BATCH" class="form-group row">
		<label id="elh_pharmacy_stock_movement_BATCH" for="x_BATCH" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->BATCH->caption() ?><?php echo ($pharmacy_stock_movement->BATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->BATCH->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PC" for="x_PC" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PC->caption() ?><?php echo ($pharmacy_stock_movement->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PC->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->OLDRT->Visible) { // OLDRT ?>
	<div id="r_OLDRT" class="form-group row">
		<label id="elh_pharmacy_stock_movement_OLDRT" for="x_OLDRT" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->OLDRT->caption() ?><?php echo ($pharmacy_stock_movement->OLDRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->OLDRT->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->TEMPMRQ->Visible) { // TEMPMRQ ?>
	<div id="r_TEMPMRQ" class="form-group row">
		<label id="elh_pharmacy_stock_movement_TEMPMRQ" for="x_TEMPMRQ" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->TEMPMRQ->caption() ?><?php echo ($pharmacy_stock_movement->TEMPMRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->TEMPMRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_pharmacy_stock_movement_TAXP" for="x_TAXP" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->TAXP->caption() ?><?php echo ($pharmacy_stock_movement->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->TAXP->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->OLDRATE->Visible) { // OLDRATE ?>
	<div id="r_OLDRATE" class="form-group row">
		<label id="elh_pharmacy_stock_movement_OLDRATE" for="x_OLDRATE" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->OLDRATE->caption() ?><?php echo ($pharmacy_stock_movement->OLDRATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->OLDRATE->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->NEWRATE->Visible) { // NEWRATE ?>
	<div id="r_NEWRATE" class="form-group row">
		<label id="elh_pharmacy_stock_movement_NEWRATE" for="x_NEWRATE" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->NEWRATE->caption() ?><?php echo ($pharmacy_stock_movement->NEWRATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->NEWRATE->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->OTEMPMRA->Visible) { // OTEMPMRA ?>
	<div id="r_OTEMPMRA" class="form-group row">
		<label id="elh_pharmacy_stock_movement_OTEMPMRA" for="x_OTEMPMRA" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->OTEMPMRA->caption() ?><?php echo ($pharmacy_stock_movement->OTEMPMRA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->OTEMPMRA->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->ACTIVESTATUS->Visible) { // ACTIVESTATUS ?>
	<div id="r_ACTIVESTATUS" class="form-group row">
		<label id="elh_pharmacy_stock_movement_ACTIVESTATUS" for="x_ACTIVESTATUS" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->ACTIVESTATUS->caption() ?><?php echo ($pharmacy_stock_movement->ACTIVESTATUS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->ACTIVESTATUS->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PSGST" for="x_PSGST" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PSGST->caption() ?><?php echo ($pharmacy_stock_movement->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_pharmacy_stock_movement_PCGST" for="x_PCGST" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->PCGST->caption() ?><?php echo ($pharmacy_stock_movement->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->PCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_pharmacy_stock_movement_SSGST" for="x_SSGST" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->SSGST->caption() ?><?php echo ($pharmacy_stock_movement->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->SSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_pharmacy_stock_movement_SCGST" for="x_SCGST" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->SCGST->caption() ?><?php echo ($pharmacy_stock_movement->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->SCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_pharmacy_stock_movement_MFRCODE" for="x_MFRCODE" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->MFRCODE->caption() ?><?php echo ($pharmacy_stock_movement->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->MFRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_pharmacy_stock_movement_BRCODE" for="x_BRCODE" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->BRCODE->caption() ?><?php echo ($pharmacy_stock_movement->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->BRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->FRQ->Visible) { // FRQ ?>
	<div id="r_FRQ" class="form-group row">
		<label id="elh_pharmacy_stock_movement_FRQ" for="x_FRQ" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->FRQ->caption() ?><?php echo ($pharmacy_stock_movement->FRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->FRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_pharmacy_stock_movement_HospID" for="x_HospID" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->HospID->caption() ?><?php echo ($pharmacy_stock_movement->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->HospID->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->UM->Visible) { // UM ?>
	<div id="r_UM" class="form-group row">
		<label id="elh_pharmacy_stock_movement_UM" for="x_UM" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->UM->caption() ?><?php echo ($pharmacy_stock_movement->UM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->UM->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->GENNAME->Visible) { // GENNAME ?>
	<div id="r_GENNAME" class="form-group row">
		<label id="elh_pharmacy_stock_movement_GENNAME" for="x_GENNAME" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->GENNAME->caption() ?><?php echo ($pharmacy_stock_movement->GENNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->GENNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->BILLDATE->Visible) { // BILLDATE ?>
	<div id="r_BILLDATE" class="form-group row">
		<label id="elh_pharmacy_stock_movement_BILLDATE" for="x_BILLDATE" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->BILLDATE->caption() ?><?php echo ($pharmacy_stock_movement->BILLDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->BILLDATE->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->CreatedDateTime->Visible) { // CreatedDateTime ?>
	<div id="r_CreatedDateTime" class="form-group row">
		<label id="elh_pharmacy_stock_movement_CreatedDateTime" for="x_CreatedDateTime" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->CreatedDateTime->caption() ?><?php echo ($pharmacy_stock_movement->CreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->CreatedDateTime->cellAttributes() ?>>
...
<?php if ($pharmacy_stock_movement->baid->Visible) { // baid ?>
	<div id="r_baid" class="form-group row">
		<label id="elh_pharmacy_stock_movement_baid" for="x_baid" class="<?php echo $pharmacy_stock_movement_add->LeftColumnClass ?>"><?php echo $pharmacy_stock_movement->baid->caption() ?><?php echo ($pharmacy_stock_movement->baid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_stock_movement_add->RightColumnClass ?>"><div<?php echo $pharmacy_stock_movement->baid->cellAttributes() ?>>
...
<?php if (!$pharmacy_stock_movement_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $pharmacy_stock_movement_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $pharmacy_stock_movement_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$pharmacy_stock_movement_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$pharmacy_stock_movement_add->terminate();
?>