 ...
 */
class pharmacy_suppliers extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// Suppliercode
		$this->Suppliercode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Suppliercode', 'Suppliercode', '`Suppliercode`', '`Suppliercode`', 200, -1, FALSE, '`Suppliercode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Suppliername
		$this->Suppliername = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Suppliername', 'Suppliername', '`Suppliername`', '`Suppliername`', 200, -1, FALSE, '`Suppliername`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Abbreviation
		$this->Abbreviation = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Abbreviation', 'Abbreviation', '`Abbreviation`', '`Abbreviation`', 200, -1, FALSE, '`Abbreviation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Abbreviation->Sortable = TRUE; // Allow sort
		$this->fields['Abbreviation'] = &$this->Abbreviation;

		// Creationdate
		$this->Creationdate = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Creationdate', 'Creationdate', '`Creationdate`', CastDateFieldForLike('`Creationdate`', 0, "DB"), 135, 0, FALSE, '`Creationdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Address1
		$this->Address1 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Address1', 'Address1', '`Address1`', '`Address1`', 200, -1, FALSE, '`Address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address1->Sortable = TRUE; // Allow sort
		$this->fields['Address1'] = &$this->Address1;

		// Address2
		$this->Address2 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Address2', 'Address2', '`Address2`', '`Address2`', 200, -1, FALSE, '`Address2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address2->Sortable = TRUE; // Allow sort
		$this->fields['Address2'] = &$this->Address2;

		// Address3
		$this->Address3 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Address3', 'Address3', '`Address3`', '`Address3`', 200, -1, FALSE, '`Address3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Address3->Sortable = TRUE; // Allow sort
		$this->fields['Address3'] = &$this->Address3;

		// Citycode
		$this->Citycode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Citycode', 'Citycode', '`Citycode`', '`Citycode`', 3, -1, FALSE, '`Citycode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// State
		$this->State = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_State', 'State', '`State`', '`State`', 200, -1, FALSE, '`State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->State->Sortable = TRUE; // Allow sort
		$this->fields['State'] = &$this->State;

		// Pincode
		$this->Pincode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Pincode', 'Pincode', '`Pincode`', '`Pincode`', 200, -1, FALSE, '`Pincode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pincode->Sortable = TRUE; // Allow sort
		$this->fields['Pincode'] = &$this->Pincode;

		// Tngstnumber
		$this->Tngstnumber = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Tngstnumber', 'Tngstnumber', '`Tngstnumber`', '`Tngstnumber`', 200, -1, FALSE, '`Tngstnumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tngstnumber->Sortable = TRUE; // Allow sort
		$this->fields['Tngstnumber'] = &$this->Tngstnumber;

		// Phone
		$this->Phone = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Phone', 'Phone', '`Phone`', '`Phone`', 200, -1, FALSE, '`Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Phone->Sortable = TRUE; // Allow sort
		$this->fields['Phone'] = &$this->Phone;

		// Fax
		$this->Fax = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Fax', 'Fax', '`Fax`', '`Fax`', 200, -1, FALSE, '`Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fax->Sortable = TRUE; // Allow sort
		$this->fields['Fax'] = &$this->Fax;

		// Email
		$this->_Email = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x__Email', 'Email', '`Email`', '`Email`', 200, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_Email->Sortable = TRUE; // Allow sort
		$this->fields['Email'] = &$this->_Email;

		// Paymentmode
		$this->Paymentmode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Paymentmode', 'Paymentmode', '`Paymentmode`', '`Paymentmode`', 200, -1, FALSE, '`Paymentmode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Paymentmode->Sortable = TRUE; // Allow sort
		$this->fields['Paymentmode'] = &$this->Paymentmode;

		// Contactperson1
		$this->Contactperson1 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Contactperson1', 'Contactperson1', '`Contactperson1`', '`Contactperson1`', 200, -1, FALSE, '`Contactperson1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Contactperson1->Sortable = TRUE; // Allow sort
		$this->fields['Contactperson1'] = &$this->Contactperson1;

		// CP1Address1
		$this->CP1Address1 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Address1', 'CP1Address1', '`CP1Address1`', '`CP1Address1`', 200, -1, FALSE, '`CP1Address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Address1->Sortable = TRUE; // Allow sort
		$this->fields['CP1Address1'] = &$this->CP1Address1;

		// CP1Address2
		$this->CP1Address2 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Address2', 'CP1Address2', '`CP1Address2`', '`CP1Address2`', 200, -1, FALSE, '`CP1Address2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Address2->Sortable = TRUE; // Allow sort
		$this->fields['CP1Address2'] = &$this->CP1Address2;

		// CP1Address3
		$this->CP1Address3 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Address3', 'CP1Address3', '`CP1Address3`', '`CP1Address3`', 200, -1, FALSE, '`CP1Address3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Address3->Sortable = TRUE; // Allow sort
		$this->fields['CP1Address3'] = &$this->CP1Address3;

		// CP1Citycode
		$this->CP1Citycode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Citycode', 'CP1Citycode', '`CP1Citycode`', '`CP1Citycode`', 3, -1, FALSE, '`CP1Citycode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CP1State
		$this->CP1State = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1State', 'CP1State', '`CP1State`', '`CP1State`', 200, -1, FALSE, '`CP1State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1State->Sortable = TRUE; // Allow sort
		$this->fields['CP1State'] = &$this->CP1State;

		// CP1Pincode
		$this->CP1Pincode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Pincode', 'CP1Pincode', '`CP1Pincode`', '`CP1Pincode`', 200, -1, FALSE, '`CP1Pincode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Pincode->Sortable = TRUE; // Allow sort
		$this->fields['CP1Pincode'] = &$this->CP1Pincode;

		// CP1Designation
		$this->CP1Designation = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Designation', 'CP1Designation', '`CP1Designation`', '`CP1Designation`', 200, -1, FALSE, '`CP1Designation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Designation->Sortable = TRUE; // Allow sort
		$this->fields['CP1Designation'] = &$this->CP1Designation;

		// CP1Phone
		$this->CP1Phone = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Phone', 'CP1Phone', '`CP1Phone`', '`CP1Phone`', 200, -1, FALSE, '`CP1Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Phone->Sortable = TRUE; // Allow sort
		$this->fields['CP1Phone'] = &$this->CP1Phone;

		// CP1MobileNo
		$this->CP1MobileNo = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1MobileNo', 'CP1MobileNo', '`CP1MobileNo`', '`CP1MobileNo`', 200, -1, FALSE, '`CP1MobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1MobileNo->Sortable = TRUE; // Allow sort
		$this->fields['CP1MobileNo'] = &$this->CP1MobileNo;

		// CP1Fax
		$this->CP1Fax = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Fax', 'CP1Fax', '`CP1Fax`', '`CP1Fax`', 200, -1, FALSE, '`CP1Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Fax->Sortable = TRUE; // Allow sort
		$this->fields['CP1Fax'] = &$this->CP1Fax;

		// CP1Email
		$this->CP1Email = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP1Email', 'CP1Email', '`CP1Email`', '`CP1Email`', 200, -1, FALSE, '`CP1Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP1Email->Sortable = TRUE; // Allow sort
		$this->fields['CP1Email'] = &$this->CP1Email;

		// Contactperson2
		$this->Contactperson2 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Contactperson2', 'Contactperson2', '`Contactperson2`', '`Contactperson2`', 200, -1, FALSE, '`Contactperson2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Contactperson2->Sortable = TRUE; // Allow sort
		$this->fields['Contactperson2'] = &$this->Contactperson2;

		// CP2Address1
		$this->CP2Address1 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Address1', 'CP2Address1', '`CP2Address1`', '`CP2Address1`', 200, -1, FALSE, '`CP2Address1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Address1->Sortable = TRUE; // Allow sort
		$this->fields['CP2Address1'] = &$this->CP2Address1;

		// CP2Address2
		$this->CP2Address2 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Address2', 'CP2Address2', '`CP2Address2`', '`CP2Address2`', 200, -1, FALSE, '`CP2Address2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Address2->Sortable = TRUE; // Allow sort
		$this->fields['CP2Address2'] = &$this->CP2Address2;

		// CP2Address3
		$this->CP2Address3 = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Address3', 'CP2Address3', '`CP2Address3`', '`CP2Address3`', 200, -1, FALSE, '`CP2Address3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Address3->Sortable = TRUE; // Allow sort
		$this->fields['CP2Address3'] = &$this->CP2Address3;

		// CP2Citycode
		$this->CP2Citycode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Citycode', 'CP2Citycode', '`CP2Citycode`', '`CP2Citycode`', 3, -1, FALSE, '`CP2Citycode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// CP2State
		$this->CP2State = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2State', 'CP2State', '`CP2State`', '`CP2State`', 200, -1, FALSE, '`CP2State`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2State->Sortable = TRUE; // Allow sort
		$this->fields['CP2State'] = &$this->CP2State;

		// CP2Pincode
		$this->CP2Pincode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Pincode', 'CP2Pincode', '`CP2Pincode`', '`CP2Pincode`', 200, -1, FALSE, '`CP2Pincode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Pincode->Sortable = TRUE; // Allow sort
		$this->fields['CP2Pincode'] = &$this->CP2Pincode;

		// CP2Designation
		$this->CP2Designation = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Designation', 'CP2Designation', '`CP2Designation`', '`CP2Designation`', 200, -1, FALSE, '`CP2Designation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Designation->Sortable = TRUE; // Allow sort
		$this->fields['CP2Designation'] = &$this->CP2Designation;

		// CP2Phone
		$this->CP2Phone = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Phone', 'CP2Phone', '`CP2Phone`', '`CP2Phone`', 200, -1, FALSE, '`CP2Phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Phone->Sortable = TRUE; // Allow sort
		$this->fields['CP2Phone'] = &$this->CP2Phone;

		// CP2MobileNo
		$this->CP2MobileNo = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2MobileNo', 'CP2MobileNo', '`CP2MobileNo`', '`CP2MobileNo`', 200, -1, FALSE, '`CP2MobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2MobileNo->Sortable = TRUE; // Allow sort
		$this->fields['CP2MobileNo'] = &$this->CP2MobileNo;

		// CP2Fax
		$this->CP2Fax = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Fax', 'CP2Fax', '`CP2Fax`', '`CP2Fax`', 200, -1, FALSE, '`CP2Fax`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Fax->Sortable = TRUE; // Allow sort
		$this->fields['CP2Fax'] = &$this->CP2Fax;

		// CP2Email
		$this->CP2Email = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_CP2Email', 'CP2Email', '`CP2Email`', '`CP2Email`', 200, -1, FALSE, '`CP2Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CP2Email->Sortable = TRUE; // Allow sort
		$this->fields['CP2Email'] = &$this->CP2Email;

		// Type
		$this->Type = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Type', 'Type', '`Type`', '`Type`', 200, -1, FALSE, '`Type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Type->Sortable = TRUE; // Allow sort
		$this->fields['Type'] = &$this->Type;

		// Creditterms
		$this->Creditterms = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Creditterms', 'Creditterms', '`Creditterms`', '`Creditterms`', 200, -1, FALSE, '`Creditterms`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Creditterms->Sortable = TRUE; // Allow sort
		$this->fields['Creditterms'] = &$this->Creditterms;

		// Remarks
		$this->Remarks = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// Tinnumber
		$this->Tinnumber = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Tinnumber', 'Tinnumber', '`Tinnumber`', '`Tinnumber`', 200, -1, FALSE, '`Tinnumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tinnumber->Sortable = TRUE; // Allow sort
		$this->fields['Tinnumber'] = &$this->Tinnumber;

		// Universalsuppliercode
		$this->Universalsuppliercode = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Universalsuppliercode', 'Universalsuppliercode', '`Universalsuppliercode`', '`Universalsuppliercode`', 200, -1, FALSE, '`Universalsuppliercode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Universalsuppliercode->Sortable = TRUE; // Allow sort
		$this->fields['Universalsuppliercode'] = &$this->Universalsuppliercode;

		// Mobilenumber
		$this->Mobilenumber = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_Mobilenumber', 'Mobilenumber', '`Mobilenumber`', '`Mobilenumber`', 200, -1, FALSE, '`Mobilenumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Mobilenumber->Sortable = TRUE; // Allow sort
		$this->fields['Mobilenumber'] = &$this->Mobilenumber;

		// PANNumber
		$this->PANNumber = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_PANNumber', 'PANNumber', '`PANNumber`', '`PANNumber`', 200, -1, FALSE, '`PANNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PANNumber->Sortable = TRUE; // Allow sort
		$this->fields['PANNumber'] = &$this->PANNumber;

		// SalesRepMobileNo
		$this->SalesRepMobileNo = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_SalesRepMobileNo', 'SalesRepMobileNo', '`SalesRepMobileNo`', '`SalesRepMobileNo`', 200, -1, FALSE, '`SalesRepMobileNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SalesRepMobileNo->Sortable = TRUE; // Allow sort
		$this->fields['SalesRepMobileNo'] = &$this->SalesRepMobileNo;

		// GSTNumber
		$this->GSTNumber = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_GSTNumber', 'GSTNumber', '`GSTNumber`', '`GSTNumber`', 200, -1, FALSE, '`GSTNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->GSTNumber->Sortable = TRUE; // Allow sort
		$this->fields['GSTNumber'] = &$this->GSTNumber;

		// TANNumber
		$this->TANNumber = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_TANNumber', 'TANNumber', '`TANNumber`', '`TANNumber`', 200, -1, FALSE, '`TANNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TANNumber->Sortable = TRUE; // Allow sort
		$this->fields['TANNumber'] = &$this->TANNumber;

		// id
		$this->id = new DbField('pharmacy_suppliers', 'pharmacy_suppliers', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "pharmacy_supplierslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "pharmacy_suppliersedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "pharmacy_suppliersadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("pharmacy_suppliersview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("pharmacy_suppliersview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "pharmacy_suppliersadd.php?" . $this->getUrlParm($parm);
		else
			$url = "pharmacy_suppliersadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pharmacy_suppliersedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pharmacy_suppliersadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("pharmacy_suppliersdelete.php", $this->getUrlParm());
	}
