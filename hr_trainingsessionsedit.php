...
// Create page object
$hr_trainingsessions_edit = new hr_trainingsessions_edit();

// Run the page
$hr_trainingsessions_edit->run();
...
$hr_trainingsessions_edit->Page_Render();
?>
...
var fhr_trainingsessionsedit = currentForm = new ew.Form("fhr_trainingsessionsedit", "edit");

// Validate form
fhr_trainingsessionsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($hr_trainingsessions_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $hr_trainingsessions->id->caption(), $hr_trainingsessions->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->name->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->course->Required) { ?>
		...
		<?php if ($hr_trainingsessions_edit->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->scheduled->Required) { ?>
		...
		<?php if ($hr_trainingsessions_edit->dueDate->Required) { ?>
		...
		<?php if ($hr_trainingsessions_edit->deliveryMethod->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->deliveryLocation->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->attendanceType->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->attachment->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_trainingsessions_edit->created->Required) { ?>
		...
		<?php if ($hr_trainingsessions_edit->updated->Required) { ?>
		...
		<?php if ($hr_trainingsessions_edit->requireProof->Required) { ?>
...
fhr_trainingsessionsedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fhr_trainingsessionsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhr_trainingsessionsedit.lists["x_deliveryMethod"] = <?php echo $hr_trainingsessions_edit->deliveryMethod->Lookup->toClientList() ?>;
fhr_trainingsessionsedit.lists["x_deliveryMethod"].options = <?php echo JsonEncode($hr_trainingsessions_edit->deliveryMethod->options(FALSE, TRUE)) ?>;
fhr_trainingsessionsedit.lists["x_status"] = <?php echo $hr_trainingsessions_edit->status->Lookup->toClientList() ?>;
fhr_trainingsessionsedit.lists["x_status"].options = <?php echo JsonEncode($hr_trainingsessions_edit->status->options(FALSE, TRUE)) ?>;
fhr_trainingsessionsedit.lists["x_attendanceType"] = <?php echo $hr_trainingsessions_edit->attendanceType->Lookup->toClientList() ?>;
fhr_trainingsessionsedit.lists["x_attendanceType"].options = <?php echo JsonEncode($hr_trainingsessions_edit->attendanceType->options(FALSE, TRUE)) ?>;
fhr_trainingsessionsedit.lists["x_requireProof"] = <?php echo $hr_trainingsessions_edit->requireProof->Lookup->toClientList() ?>;
fhr_trainingsessionsedit.lists["x_requireProof"].options = <?php echo JsonEncode($hr_trainingsessions_edit->requireProof->options(FALSE, TRUE)) ?>;
...
<?php $hr_trainingsessions_edit->showPageHeader(); ?>
<?php
$hr_trainingsessions_edit->showMessage();
?>
<form name="fhr_trainingsessionsedit" id="fhr_trainingsessionsedit" class="<?php echo $hr_trainingsessions_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($hr_trainingsessions_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $hr_trainingsessions_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="hr_trainingsessions">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$hr_trainingsessions_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($hr_trainingsessions->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_hr_trainingsessions_id" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->id->caption() ?><?php echo ($hr_trainingsessions->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->id->cellAttributes() ?>>
<span id="el_hr_trainingsessions_id">
<span<?php echo $hr_trainingsessions->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($hr_trainingsessions->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="hr_trainingsessions" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($hr_trainingsessions->id->CurrentValue) ?>">
<?php echo $hr_trainingsessions->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($hr_trainingsessions->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_hr_trainingsessions_name" for="x_name" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->name->caption() ?><?php echo ($hr_trainingsessions->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->name->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->course->Visible) { // course ?>
	<div id="r_course" class="form-group row">
		<label id="elh_hr_trainingsessions_course" for="x_course" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->course->caption() ?><?php echo ($hr_trainingsessions->course->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->course->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_hr_trainingsessions_description" for="x_description" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->description->caption() ?><?php echo ($hr_trainingsessions->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->description->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->scheduled->Visible) { // scheduled ?>
	<div id="r_scheduled" class="form-group row">
		<label id="elh_hr_trainingsessions_scheduled" for="x_scheduled" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->scheduled->caption() ?><?php echo ($hr_trainingsessions->scheduled->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->scheduled->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fhr_trainingsessionsedit", "x_scheduled", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($hr_trainingsessions->dueDate->Visible) { // dueDate ?>
	<div id="r_dueDate" class="form-group row">
		<label id="elh_hr_trainingsessions_dueDate" for="x_dueDate" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->dueDate->caption() ?><?php echo ($hr_trainingsessions->dueDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->dueDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fhr_trainingsessionsedit", "x_dueDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($hr_trainingsessions->deliveryMethod->Visible) { // deliveryMethod ?>
	<div id="r_deliveryMethod" class="form-group row">
		<label id="elh_hr_trainingsessions_deliveryMethod" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->deliveryMethod->caption() ?><?php echo ($hr_trainingsessions->deliveryMethod->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->deliveryMethod->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->deliveryLocation->Visible) { // deliveryLocation ?>
	<div id="r_deliveryLocation" class="form-group row">
		<label id="elh_hr_trainingsessions_deliveryLocation" for="x_deliveryLocation" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->deliveryLocation->caption() ?><?php echo ($hr_trainingsessions->deliveryLocation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->deliveryLocation->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_hr_trainingsessions_status" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->status->caption() ?><?php echo ($hr_trainingsessions->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->status->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->attendanceType->Visible) { // attendanceType ?>
	<div id="r_attendanceType" class="form-group row">
		<label id="elh_hr_trainingsessions_attendanceType" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->attendanceType->caption() ?><?php echo ($hr_trainingsessions->attendanceType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->attendanceType->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->attachment->Visible) { // attachment ?>
	<div id="r_attachment" class="form-group row">
		<label id="elh_hr_trainingsessions_attachment" for="x_attachment" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->attachment->caption() ?><?php echo ($hr_trainingsessions->attachment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->attachment->cellAttributes() ?>>
...
<?php if ($hr_trainingsessions->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_hr_trainingsessions_created" for="x_created" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->created->caption() ?><?php echo ($hr_trainingsessions->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->created->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fhr_trainingsessionsedit", "x_created", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($hr_trainingsessions->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_hr_trainingsessions_updated" for="x_updated" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->updated->caption() ?><?php echo ($hr_trainingsessions->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->updated->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fhr_trainingsessionsedit", "x_updated", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($hr_trainingsessions->requireProof->Visible) { // requireProof ?>
	<div id="r_requireProof" class="form-group row">
		<label id="elh_hr_trainingsessions_requireProof" class="<?php echo $hr_trainingsessions_edit->LeftColumnClass ?>"><?php echo $hr_trainingsessions->requireProof->caption() ?><?php echo ($hr_trainingsessions->requireProof->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_trainingsessions_edit->RightColumnClass ?>"><div<?php echo $hr_trainingsessions->requireProof->cellAttributes() ?>>
...
<?php if (!$hr_trainingsessions_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $hr_trainingsessions_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $hr_trainingsessions_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$hr_trainingsessions_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$hr_trainingsessions_edit->terminate();
?>