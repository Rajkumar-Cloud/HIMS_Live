...
<?php if ($help->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_help_id" class="<?php echo $help_edit->LeftColumnClass ?>"><script id="tpc_help_id" class="helpedit" type="text/html"><span><?php echo $help->id->caption() ?><?php echo ($help->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $help_edit->RightColumnClass ?>"><div<?php echo $help->id->cellAttributes() ?>>
<script id="tpx_help_id" class="helpedit" type="text/html">
<span id="el_help_id">
...
<?php if ($help->Tittle->Visible) { // Tittle ?>
	<div id="r_Tittle" class="form-group row">
		<label id="elh_help_Tittle" for="x_Tittle" class="<?php echo $help_edit->LeftColumnClass ?>"><script id="tpc_help_Tittle" class="helpedit" type="text/html"><span><?php echo $help->Tittle->caption() ?><?php echo ($help->Tittle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $help_edit->RightColumnClass ?>"><div<?php echo $help->Tittle->cellAttributes() ?>>
<script id="tpx_help_Tittle" class="helpedit" type="text/html">
...
<?php if ($help->Description->Visible) { // Description ?>
	<div id="r_Description" class="form-group row">
		<label id="elh_help_Description" class="<?php echo $help_edit->LeftColumnClass ?>"><script id="tpc_help_Description" class="helpedit" type="text/html"><span><?php echo $help->Description->caption() ?><?php echo ($help->Description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $help_edit->RightColumnClass ?>"><div<?php echo $help->Description->cellAttributes() ?>>
<script id="tpx_help_Description" class="helpedit" type="text/html">
...
ew.createEditor("fhelpedit", "x_Description", 35, 400, <?php echo ($help->Description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($help->orderid->Visible) { // orderid ?>
	<div id="r_orderid" class="form-group row">
		<label id="elh_help_orderid" for="x_orderid" class="<?php echo $help_edit->LeftColumnClass ?>"><script id="tpc_help_orderid" class="helpedit" type="text/html"><span><?php echo $help->orderid->caption() ?><?php echo ($help->orderid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $help_edit->RightColumnClass ?>"><div<?php echo $help->orderid->cellAttributes() ?>>
<script id="tpx_help_orderid" class="helpedit" type="text/html">
...
ew.applyTemplate("tpd_helpedit", "tpm_helpedit", "helpedit", "<?php echo $help->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.helpedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
