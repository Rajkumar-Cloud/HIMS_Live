...
var fpharmacy_billing_voucheradd = currentForm = new ew.Form("fpharmacy_billing_voucheradd", "add");
...
fpharmacy_billing_voucheradd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($pharmacy_billing_voucher_add->CardType->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_billing_voucher_add->DiscountAmount->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_billing_voucher_add->ApprovalNumber->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_billing_voucher_add->Cash->Required) { ?>
		...
		<?php if ($pharmacy_billing_voucher_add->Card->Required) { ?>
		...
		<?php if ($pharmacy_billing_voucher_add->BillType->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_billing_voucher_add->PartialSave->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_billing_voucher_add->PatientGST->Required) { ?>
...
fpharmacy_billing_voucheradd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_billing_voucheradd.lists["x_Reception"] = <?php echo $pharmacy_billing_voucher_add->Reception->Lookup->toClientList() ?>;
...
fpharmacy_billing_voucheradd.lists["x_ModeofPayment"] = <?php echo $pharmacy_billing_voucher_add->ModeofPayment->Lookup->toClientList() ?>;
...
fpharmacy_billing_voucheradd.lists["x_RIDNO"] = <?php echo $pharmacy_billing_voucher_add->RIDNO->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_RIDNO"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->RIDNO->lookupOptions()) ?>;
fpharmacy_billing_voucheradd.lists["x_CId"] = <?php echo $pharmacy_billing_voucher_add->CId->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_CId"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->CId->lookupOptions()) ?>;
fpharmacy_billing_voucheradd.lists["x_PatId"] = <?php echo $pharmacy_billing_voucher_add->PatId->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_PatId"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->PatId->lookupOptions()) ?>;
fpharmacy_billing_voucheradd.lists["x_RefferedBy"] = <?php echo $pharmacy_billing_voucher_add->RefferedBy->Lookup->toClientList() ?>;
...
fpharmacy_billing_voucheradd.lists["x_DrID"] = <?php echo $pharmacy_billing_voucher_add->DrID->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_DrID"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->DrID->lookupOptions()) ?>;
fpharmacy_billing_voucheradd.lists["x_ReportHeader[]"] = <?php echo $pharmacy_billing_voucher_add->ReportHeader->Lookup->toClientList() ?>;
...
fpharmacy_billing_voucheradd.lists["x_CardType"] = <?php echo $pharmacy_billing_voucher_add->CardType->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_CardType"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->CardType->options(FALSE, TRUE)) ?>;
fpharmacy_billing_voucheradd.lists["x_BillType"] = <?php echo $pharmacy_billing_voucher_add->BillType->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_BillType"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->BillType->options(FALSE, TRUE)) ?>;
fpharmacy_billing_voucheradd.lists["x_PartialSave[]"] = <?php echo $pharmacy_billing_voucher_add->PartialSave->Lookup->toClientList() ?>;
fpharmacy_billing_voucheradd.lists["x_PartialSave[]"].options = <?php echo JsonEncode($pharmacy_billing_voucher_add->PartialSave->options(FALSE, TRUE)) ?>;
...
<?php if ($pharmacy_billing_voucher_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_billing_voucher_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_billing_voucher->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_BillNumber" for="x_BillNumber" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_BillNumber" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->BillNumber->caption() ?><?php echo ($pharmacy_billing_voucher->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->BillNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_BillNumber" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_voucher_type" for="x_voucher_type" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_voucher_type" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->voucher_type->caption() ?><?php echo ($pharmacy_billing_voucher->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->voucher_type->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_voucher_type" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Reception" for="x_Reception" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Reception" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Reception->caption() ?><?php echo ($pharmacy_billing_voucher->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Reception->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Reception" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PatientId" for="x_PatientId" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PatientId" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PatientId->caption() ?><?php echo ($pharmacy_billing_voucher->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PatientId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PatientId" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PatientName" for="x_PatientName" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PatientName" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PatientName->caption() ?><?php echo ($pharmacy_billing_voucher->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PatientName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PatientName" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Mobile" for="x_Mobile" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Mobile" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Mobile->caption() ?><?php echo ($pharmacy_billing_voucher->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Mobile->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Mobile" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Age" for="x_Age" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Age" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Age->caption() ?><?php echo ($pharmacy_billing_voucher->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Age->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Age" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_mrnno" for="x_mrnno" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_mrnno" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->mrnno->caption() ?><?php echo ($pharmacy_billing_voucher->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->mrnno->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_mrnno" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->IP_OP->Visible) { // IP_OP ?>
	<div id="r_IP_OP" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_IP_OP" for="x_IP_OP" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_IP_OP" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->IP_OP->caption() ?><?php echo ($pharmacy_billing_voucher->IP_OP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->IP_OP->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_IP_OP" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Doctor" for="x_Doctor" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Doctor" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Doctor->caption() ?><?php echo ($pharmacy_billing_voucher->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Doctor->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Doctor" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Gender" for="x_Gender" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Gender" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Gender->caption() ?><?php echo ($pharmacy_billing_voucher->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Gender->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Gender" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Details" for="x_Details" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Details" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Details->caption() ?><?php echo ($pharmacy_billing_voucher->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Details->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Details" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_ModeofPayment" for="x_ModeofPayment" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_ModeofPayment" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->ModeofPayment->caption() ?><?php echo ($pharmacy_billing_voucher->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->ModeofPayment->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_ModeofPayment" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Amount" for="x_Amount" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Amount" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Amount->caption() ?><?php echo ($pharmacy_billing_voucher->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Amount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Amount" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_AnyDues" for="x_AnyDues" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_AnyDues" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->AnyDues->caption() ?><?php echo ($pharmacy_billing_voucher->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->AnyDues->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_AnyDues" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RealizationAmount" for="x_RealizationAmount" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RealizationAmount" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RealizationAmount->caption() ?><?php echo ($pharmacy_billing_voucher->RealizationAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RealizationAmount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RealizationAmount" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RealizationStatus" for="x_RealizationStatus" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RealizationStatus" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RealizationStatus->caption() ?><?php echo ($pharmacy_billing_voucher->RealizationStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RealizationStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RealizationStatus" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RealizationRemarks" for="x_RealizationRemarks" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RealizationRemarks" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RealizationRemarks->caption() ?><?php echo ($pharmacy_billing_voucher->RealizationRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RealizationRemarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RealizationRemarks" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RealizationBatchNo" for="x_RealizationBatchNo" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RealizationBatchNo" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RealizationBatchNo->caption() ?><?php echo ($pharmacy_billing_voucher->RealizationBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RealizationBatchNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RealizationBatchNo" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RealizationDate" for="x_RealizationDate" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RealizationDate" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RealizationDate->caption() ?><?php echo ($pharmacy_billing_voucher->RealizationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RealizationDate->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RealizationDate" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RIDNO" for="x_RIDNO" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RIDNO" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RIDNO->caption() ?><?php echo ($pharmacy_billing_voucher->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RIDNO->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RIDNO" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_TidNo" for="x_TidNo" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_TidNo" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->TidNo->caption() ?><?php echo ($pharmacy_billing_voucher->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->TidNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_TidNo" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_CId" for="x_CId" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_CId" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->CId->caption() ?><?php echo ($pharmacy_billing_voucher->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->CId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_CId" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PartnerName" for="x_PartnerName" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PartnerName" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PartnerName->caption() ?><?php echo ($pharmacy_billing_voucher->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PartnerName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PartnerName" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PayerType->Visible) { // PayerType ?>
	<div id="r_PayerType" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PayerType" for="x_PayerType" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PayerType" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PayerType->caption() ?><?php echo ($pharmacy_billing_voucher->PayerType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PayerType->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PayerType" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_profilePic" for="x_profilePic" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_profilePic" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->profilePic->caption() ?><?php echo ($pharmacy_billing_voucher->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->profilePic->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_profilePic" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Dob->Visible) { // Dob ?>
	<div id="r_Dob" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Dob" for="x_Dob" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Dob" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Dob->caption() ?><?php echo ($pharmacy_billing_voucher->Dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Dob->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Dob" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Currency" for="x_Currency" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Currency" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Currency->caption() ?><?php echo ($pharmacy_billing_voucher->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Currency->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Currency" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->DiscountRemarks->Visible) { // DiscountRemarks ?>
	<div id="r_DiscountRemarks" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_DiscountRemarks" for="x_DiscountRemarks" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_DiscountRemarks" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->DiscountRemarks->caption() ?><?php echo ($pharmacy_billing_voucher->DiscountRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->DiscountRemarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_DiscountRemarks" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Remarks" for="x_Remarks" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Remarks" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Remarks->caption() ?><?php echo ($pharmacy_billing_voucher->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Remarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Remarks" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PatId" for="x_PatId" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PatId" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PatId->caption() ?><?php echo ($pharmacy_billing_voucher->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PatId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PatId" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_DrDepartment" for="x_DrDepartment" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_DrDepartment" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->DrDepartment->caption() ?><?php echo ($pharmacy_billing_voucher->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->DrDepartment->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_DrDepartment" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->RefferedBy->Visible) { // RefferedBy ?>
	<div id="r_RefferedBy" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_RefferedBy" for="x_RefferedBy" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_RefferedBy" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->RefferedBy->caption() ?><?php echo ($pharmacy_billing_voucher->RefferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->RefferedBy->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_RefferedBy" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_CardNumber" for="x_CardNumber" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_CardNumber" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->CardNumber->caption() ?><?php echo ($pharmacy_billing_voucher->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->CardNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_CardNumber" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_BankName" for="x_BankName" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_BankName" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->BankName->caption() ?><?php echo ($pharmacy_billing_voucher->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->BankName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_BankName" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_DrID" for="x_DrID" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_DrID" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->DrID->caption() ?><?php echo ($pharmacy_billing_voucher->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->DrID->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_DrID" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_BillStatus" for="x_BillStatus" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_BillStatus" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->BillStatus->caption() ?><?php echo ($pharmacy_billing_voucher->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->BillStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_BillStatus" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_ReportHeader" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_ReportHeader" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->ReportHeader->caption() ?><?php echo ($pharmacy_billing_voucher->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->ReportHeader->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_ReportHeader" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->CardType->Visible) { // CardType ?>
	<div id="r_CardType" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_CardType" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_CardType" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->CardType->caption() ?><?php echo ($pharmacy_billing_voucher->CardType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->CardType->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_CardType" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->DiscountAmount->Visible) { // DiscountAmount ?>
	<div id="r_DiscountAmount" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_DiscountAmount" for="x_DiscountAmount" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_DiscountAmount" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->DiscountAmount->caption() ?><?php echo ($pharmacy_billing_voucher->DiscountAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->DiscountAmount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_DiscountAmount" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->ApprovalNumber->Visible) { // ApprovalNumber ?>
	<div id="r_ApprovalNumber" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_ApprovalNumber" for="x_ApprovalNumber" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_ApprovalNumber" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->ApprovalNumber->caption() ?><?php echo ($pharmacy_billing_voucher->ApprovalNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->ApprovalNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_ApprovalNumber" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Cash->Visible) { // Cash ?>
	<div id="r_Cash" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Cash" for="x_Cash" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Cash" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Cash->caption() ?><?php echo ($pharmacy_billing_voucher->Cash->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Cash->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Cash" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->Card->Visible) { // Card ?>
	<div id="r_Card" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_Card" for="x_Card" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_Card" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->Card->caption() ?><?php echo ($pharmacy_billing_voucher->Card->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->Card->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_Card" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->BillType->Visible) { // BillType ?>
	<div id="r_BillType" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_BillType" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_BillType" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->BillType->caption() ?><?php echo ($pharmacy_billing_voucher->BillType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->BillType->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_BillType" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PartialSave->Visible) { // PartialSave ?>
	<div id="r_PartialSave" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PartialSave" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PartialSave" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PartialSave->caption() ?><?php echo ($pharmacy_billing_voucher->PartialSave->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PartialSave->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PartialSave" class="pharmacy_billing_voucheradd" type="text/html">
...
<?php if ($pharmacy_billing_voucher->PatientGST->Visible) { // PatientGST ?>
	<div id="r_PatientGST" class="form-group row">
		<label id="elh_pharmacy_billing_voucher_PatientGST" for="x_PatientGST" class="<?php echo $pharmacy_billing_voucher_add->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_voucher_PatientGST" class="pharmacy_billing_voucheradd" type="text/html"><span><?php echo $pharmacy_billing_voucher->PatientGST->caption() ?><?php echo ($pharmacy_billing_voucher->PatientGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_voucher_add->RightColumnClass ?>"><div<?php echo $pharmacy_billing_voucher->PatientGST->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_voucher_PatientGST" class="pharmacy_billing_voucheradd" type="text/html">
...
ew.applyTemplate("tpd_pharmacy_billing_voucheradd", "tpm_pharmacy_billing_voucheradd", "pharmacy_billing_voucheradd", "<?php echo $pharmacy_billing_voucher->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.pharmacy_billing_voucheradd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
...
{	
	...
	for (var i = 1; i < 100; i++) {
			try {
				...
				var RT = document.getElementById("x" + i + "_RT").value;
				var Product = document.getElementById("sv_x" + i + "_SLNO").value;
				if (Product != '') {
				 var SiNo = document.getElementById("x" + i + "_SiNo");
				 SiNo.value = i;
				 }
			...
			try {
				...
				if (Product != '') {
				 ...
				 SiNo.value = i;
				    if(amount.value == '')
					{
						alert( Product+ " amount is 0 Please verify");
						break;
					}
				  	if(amount.value == 0)
					{
			...
			swal({
				...
				.then((result) => {
					if (result.value) {
						...
						//form.submit();
						$("#fpharmacy_billing_voucheradd").submit();
