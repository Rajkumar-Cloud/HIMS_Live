...
var femployee_telephoneadd = currentForm = new ew.Form("femployee_telephoneadd", "add");
...
femployee_telephoneadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_telephone_add->createdby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_telephone->createdby->caption(), $employee_telephone->createdby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_telephone_add->createddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_createddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_telephone->createddatetime->caption(), $employee_telephone->createddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_telephone_add->HospID->Required) { ?>
...
femployee_telephoneadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_telephoneadd.lists["x_tele_type"] = <?php echo $employee_telephone_add->tele_type->Lookup->toClientList() ?>;
femployee_telephoneadd.lists["x_tele_type"].options = <?php echo JsonEncode($employee_telephone_add->tele_type->lookupOptions()) ?>;
femployee_telephoneadd.lists["x_telephone_type"] = <?php echo $employee_telephone_add->telephone_type->Lookup->toClientList() ?>;
...
femployee_telephoneadd.lists["x_status"] = <?php echo $employee_telephone_add->status->Lookup->toClientList() ?>;
...
<?php if ($employee_telephone_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_telephone_add->Token ?>">
<?php } ?>
...
<?php if ($employee_telephone->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group row">
		<label id="elh_employee_telephone_employee_id" for="x_employee_id" class="<?php echo $employee_telephone_add->LeftColumnClass ?>"><?php echo $employee_telephone->employee_id->caption() ?><?php echo ($employee_telephone->employee_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_telephone_add->RightColumnClass ?>"><div<?php echo $employee_telephone->employee_id->cellAttributes() ?>>
...
<?php if ($employee_telephone->tele_type->Visible) { // tele_type ?>
	<div id="r_tele_type" class="form-group row">
		<label id="elh_employee_telephone_tele_type" for="x_tele_type" class="<?php echo $employee_telephone_add->LeftColumnClass ?>"><?php echo $employee_telephone->tele_type->caption() ?><?php echo ($employee_telephone->tele_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_telephone_add->RightColumnClass ?>"><div<?php echo $employee_telephone->tele_type->cellAttributes() ?>>
...
<?php if ($employee_telephone->telephone->Visible) { // telephone ?>
	<div id="r_telephone" class="form-group row">
		<label id="elh_employee_telephone_telephone" for="x_telephone" class="<?php echo $employee_telephone_add->LeftColumnClass ?>"><?php echo $employee_telephone->telephone->caption() ?><?php echo ($employee_telephone->telephone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_telephone_add->RightColumnClass ?>"><div<?php echo $employee_telephone->telephone->cellAttributes() ?>>
...
<?php if ($employee_telephone->telephone_type->Visible) { // telephone_type ?>
	<div id="r_telephone_type" class="form-group row">
		<label id="elh_employee_telephone_telephone_type" for="x_telephone_type" class="<?php echo $employee_telephone_add->LeftColumnClass ?>"><?php echo $employee_telephone->telephone_type->caption() ?><?php echo ($employee_telephone->telephone_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_telephone_add->RightColumnClass ?>"><div<?php echo $employee_telephone->telephone_type->cellAttributes() ?>>
...
<?php if ($employee_telephone->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_telephone_status" for="x_status" class="<?php echo $employee_telephone_add->LeftColumnClass ?>"><?php echo $employee_telephone->status->caption() ?><?php echo ($employee_telephone->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_telephone_add->RightColumnClass ?>"><div<?php echo $employee_telephone->status->cellAttributes() ?>>
...
<?php if ($employee_telephone->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_employee_telephone_HospID" for="x_HospID" class="<?php echo $employee_telephone_add->LeftColumnClass ?>"><?php echo $employee_telephone->HospID->caption() ?><?php echo ($employee_telephone->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_telephone_add->RightColumnClass ?>"><div<?php echo $employee_telephone->HospID->cellAttributes() ?>>
