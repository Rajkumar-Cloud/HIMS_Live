...
! function() {
    ...
    var _isFF = !1,
        ...
        function() {
            ...
            //function a(t) {              //Ganesh Kumar Bose
            //    u.area || (u.area = document.createElement("div"), u.area.className = "dhtmlx_message_area 1234", u.area.style[u.position] = "5px", document.body.appendChild(u.area)), u.hide(t.id);
    ...
    Scheduler.plugin = function(t) {
        ...
        var u = {
            ...
            view: function(e) {
                var i = t("dhx_cal_tab");
                return i.setAttribute("name", e.view + "_tab"), i.setAttribute("data-viewname", e.view), _.config.fix_tab_position && ("day" === e.view ? i.classList.add("dhx_cal_tab_first") : "month" === e.view ? i.classList.add("dhx_cal_tab_last") : "week" !== e.view && i.classList.add("dhx_cal_tab_standalone")), i
            },
            date: function() {
        ...
        _._init_nav_bar = function(t) {
            var e = this.$container.querySelector(".dhx_cal_navline");
            return e || (e = document.createElement("div"), e.className = "dhx_cal_navline dhx_cal_navline_flex", _._update_nav_bar(t, e), e)
        };
        var f = null,
            g = null;
        _._update_nav_bar = function(t, e) {
            if (t) {
                var i = !1,
                    n = !1,
                    r = t.height || _.xy.nav_height;
                null !== g && g === r || (i = !0), f && JSON.stringify(t) === f || (n = !0), i && (_.xy.nav_height = r),
                    n && (e.innerHTML = "", e.appendChild(a(t))), (i || n) && (_._els = [], _.get_elements(), _.set_actions()), e.style.display = 0 === r ? "none" : "", g = r
            }
        }, _._detachDomEvent = function(t, e, i) {
            t.removeEventListener ? t.removeEventListener(e, i, !1) : t.detachEvent && t.detachEvent("on" + e, i)
        }, _._init_once = function() {
            function t(t) {
            ...
            _.event(window, "resize", function() {
                t(_._obj) && (window.clearTimeout(_._resize_timer), _._resize_timer = window.setTimeout(function() {
                    var a = e();
                    if (!i(n, a)) {
                        if (!t(_._obj)) return;
                        _.callEvent("onSchedulerResize", []) && (_.updateView(), _.callEvent("onAfterSchedulerResize", []))
                    }
                    n = a
                }, 100))
            }), _._init_once = function() {}
        ...
        _.init = function(t, e, i) {
                ...
                _._is_material_skin() ? (a || (a = document.createElement("div"), a.className = "dhx_cal_scale_placeholder", this.$container.insertBefore(a, this._els.dhx_cal_header[0])), a.style.display = "block",
                    this.set_xy(a, t, this.xy.scale_height + 1, 0, this.xy.nav_height + (this._quirks ? -1 : 1))) : a && a.parentNode.removeChild(a), this._lightbox && (_.$container.offsetWidth < 1200 || this._setLbPosition(document.querySelector(".dhx_cal_light"))), this.set_xy(this._els.dhx_cal_navline[0], t, this.xy.nav_height, 0, 0), this.set_xy(this._els.dhx_cal_header[0], t - i, this.xy.scale_height, n, this.xy.nav_height + (this._quirks ? -1 : 1));
            ...
            _.set_actions = function() {
                for (var t in this._els)
                    if (this._click[t])
                        for (var e = 0; e < this._els[t].length; e++) this._els[t][e].onclick = _._click[t];
                this._obj.onselectstart = function(t) {
                        return !1
                    }, this._obj.onmousemove = function(t) {
                        _._temp_touch_block || _._on_mouse_move(t || event)
                    }, this._obj.onmousedown = function(t) {
                        _._ignore_next_click || _._on_mouse_down(t || event)
                    }, this._obj.onmouseup = function(t) {
                        _._ignore_next_click || _._on_mouse_up(t || event)
                    }, this._obj.ondblclick = function(t) {
                        _._on_dbl_click(t || event)
                    },
                    this._obj.oncontextmenu = function(t) {
                        var e = t || event,
                            i = e.target || e.srcElement;
                        return _.callEvent("onContextMenu", [_._locate_event(i), e])
                    }
            }, _.select = function(t) {
                this._select_id != t && (_._close_not_saved(), this.editStop(!1), this.unselect(), this._select_id = t, this.updateEvent(t))
            }, _.unselect = function(t) {
                ...
                dhx_cal_data: function(t) {
                    if (_._ignore_next_click) return t.preventDefault && t.preventDefault(), t.cancelBubble = !0, _._ignore_next_click = !1, !1;
                    var e = t ? t.target : event.srcElement,
                        i = _._locate_event(e);
                    if (t = t || event, i) {
                        if (!_.callEvent("onClick", [i, t]) || _.config.readonly) return
                    } else _.callEvent("onEmptyClick", [_.getActionData(t).date, t]);
                    if (i && _.config.select) {
                        _.select(i);
                        var n = _._getClassName(e); - 1 != n.indexOf("_icon") && _._click.buttons[n.split(" ")[1].replace("icon_", "")](i)
                    } else _._close_not_saved(), (new Date).valueOf() - (_._new_event || 0) > 500 && _.unselect()
                },
                dhx_cal_prev_button: function() {
                    _._click.dhx_cal_next_button(0, -1)
                },
                dhx_cal_next_button: function(t, e) {
                    var i = 1;
                    _.config.rtl && (e = -e, i = -i),
                        _.setCurrentView(_.date.add(_.date[_._mode + "_start"](new Date(_._date)), e || i, _._mode))
                },
                dhx_cal_today_button: function() {
                    _.callEvent("onBeforeTodayDisplayed", []) && _.setCurrentView(_._currentDate())
                },
                dhx_cal_tab: function() {
                    var t = this.getAttribute("name"),
                        e = t.substring(0, t.search("_tab"));
                    _.setCurrentView(_._date, e)
                },
                buttons: {
                    delete: function(t) {
                        var e = _.locale.labels.confirm_deleting;
                        _._dhtmlx_confirm(e, _.locale.labels.title_confirm_deleting, function() {
                            _.deleteEvent(t)
                        })
                    },
                    edit: function(t) {
            ...
            }, _._dhtmlx_confirm = function(t, e, i) {
                if (!t) return i();
                var n = {
                    text: t
                };
            ...
            }, _.addEventNow = function(t, e, i) {
                var n = {};
                _._isObject(t) && !_._isDate(t) && (n = t, t = null);
                var a = 6e4 * (this.config.event_duration || this.config.time_step);
                t || (t = n.start_date || Math.round(_._currentDate().valueOf() / a) * a);
                var r = new Date(t);
                if (!e) {
            ...
            _._on_dbl_click = function(t, e) {
                if (e = e || t.target || t.srcElement, !this.config.readonly) {
                    var i = _._getClassName(e).split(" ")[0];
                    switch (i) {
                        case "dhx_scale_holder":
                        case "dhx_scale_holder_now":
                        case "dhx_month_body":
                        case "dhx_wa_day_data":
                            if (!_.config.dblclick_create) break;
                        ...
                        default:
                            ...
                            if (a) a.call(this, t);
                            else if (e.parentNode && e != this) return _._on_dbl_click(t, e.parentNode)
                    }
                }
            }, _._get_column_index = function(t) {
                var e = 0;
                if (this._cols) {
                ...
                return e
            }, _._week_indexes_from_pos = function(t) {
                if (this._cols) {
                ...
                if (a) e = a.call(this, e);
                    ...
                    e.y = Math.ceil(24 * (Math.max(0, r) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step), (_._drag_mode || "month" == this._mode) && (e.y = 24 * (Math.max(0, Math.ceil(r) - 1) + 7 * Math.max(0, s - 1)) * 60 / this.config.time_step), "move" == this._drag_mode && _._ignores_detected && _.config.preserve_length && (e._ignores = !0, this._drag_event._event_length || (this._drag_event._event_length = this._get_real_event_length(this._drag_event.start_date, this._drag_event.end_date, {
                        x_step: 1,
                        x_unit: "day"
                    }))), e.x = 0
                } else e = this._week_indexes_from_pos(e);
                return e.timestamp = +new Date, e
            }, _._close_not_saved = function() {
                if ((new Date).valueOf() - (_._new_event || 0) > 500 && _._edit_id) {
                    var t = _.locale.labels.confirm_closing;
                    _._dhtmlx_confirm(t, _.locale.labels.title_confirm_closing, function() {
                        _.editStop(_.config.positive_closing)
                    }), t && (this._drag_id = this._drag_pos = this._drag_mode = null)
                }
            }, _._correct_shift = function(t, e) {
                return t -= 6e4 * (new Date(_._min_date).getTimezoneOffset() - new Date(t).getTimezoneOffset()) * (e ? -1 : 1)
            }, _._is_pos_changed = function(t, e) {
                function i(t, e, i) {
            ...
            }, _._correct_drag_start_date = function(t) {
                var e;
                _.matrix && (e = _.matrix[_._mode]), e = e || {
                    x_step: 1,
                    x_unit: "day"
                }, t = new Date(t);
                var i = 1;
                return (e._start_correction || e._end_correction) && (i = 60 * (e.last_hour || 0) - (60 * t.getHours() + t.getMinutes()) || 1), 1 * t + (_._get_fictional_event_length(t, i, e) - i)
            },
            _._correct_drag_end_date = function(t, e) {
                var i;
                _.matrix && (i = _.matrix[_._mode]), i = i || {
                    x_step: 1,
                    x_unit: "day"
                };
                var n = 1 * t + _._get_fictional_event_length(t, e, i);
                return new Date(1 * n - (_._get_fictional_event_length(n, -1, i, -1) + 1))
            }, _._on_mouse_move = function(t) {
                if (this._drag_mode) {
                    ...
                    if (this._is_pos_changed(this._drag_pos, e)) {
                        ...
                        if (_.matrix && (o = _.matrix[_._mode]), o = o || {
                                x_step: 1,
                                x_unit: "day"
                            },
                            ...
                            n = _._correct_drag_end_date(i, this._drag_event._event_length)) : n = l.end_date.valueOf() - (l.start_date.valueOf() - i);
                        else {
                            if (i = l.start_date.valueOf(), n = l.end_date.valueOf(), this._table_view) {
                                ...
                                if ("month" == this._mode)
                                    if (h = this._correct_shift(h, !1), this._drag_from_start) {
                                        var c = 864e5;
                                        h <= _.date.date_part(new Date(n + c - 1)).valueOf() && (i = h - c)
                                    } else n = h;
                                else this.config.preserve_length ? e.resize_from_start ? i = _._correct_drag_start_date(h) : n = _._correct_drag_end_date(h, 0) : e.resize_from_start ? i = h : n = h
                            } else {
                                var u = this.date.date_part(new Date(l.end_date.valueOf() - 1)).valueOf(),
                                    f = new Date(u),
                        ...
                        var D = new Date(n - 1),
                            E = new Date(i);
                        if ("move" == this._drag_mode && _.config.limit_drag_out && (+E < +_._min_date || +n > +_._max_date)) {
                            if (+l.start_date < +_._min_date || +l.end_date > +_._max_date) E = new Date(l.start_date), n = new Date(l.end_date);
                            else {
                                var A = n - E; + E < +_._min_date ? (E = new Date(_._min_date), e._ignores && this.config.preserve_length && this._table_view ? (E = new Date(_._correct_drag_start_date(E)), o._start_correction && (E = new Date(E.valueOf() + o._start_correction)),
                                    n = new Date(1 * E + this._get_fictional_event_length(E, this._drag_event._event_length, o))) : n = new Date(+E + A)) : (n = new Date(_._max_date), e._ignores && this.config.preserve_length && this._table_view ? (o._end_correction && (n = new Date(n.valueOf() - o._end_correction)), n = new Date(1 * n - this._get_fictional_event_length(n, 0, o, !0)), E = new Date(1 * n - this._get_fictional_event_length(n, this._drag_event._event_length, o, !0)), this._ignores_detected && (E = _.date.add(E, o.x_step, o.x_unit),
                                    n = new Date(1 * n - this._get_fictional_event_length(n, 0, o, !0)), n = _.date.add(n, o.x_step, o.x_unit))) : E = new Date(+n - A))
                            }
                            var D = new Date(n - 1)
                        }
                        if (!this._table_view && this._dragEventBody && !_.config.all_timed && (!_._get_section_view() && e.x != this._get_event_sday({
                        ...
                        if (!this._table_view && !_.config.all_timed && (!_.getView() && e.x != this._get_event_sday({
                                start_date: new Date(n),
                                end_date: new Date(n)
                            }) || new Date(n).getHours() >= this.config.last_hour)) {
                            var A = n - E,
                                c = this._min_date.valueOf() + 24 * e.x * 60 * 6e4;
                            n = _.date.date_part(new Date(c)), n.setHours(this.config.last_hour), D = new Date(n - 1), "move" == this._drag_mode && (E = new Date(+n - A))
                        }
                        if (this._table_view || D.getDate() == E.getDate() && D.getHours() < this.config.last_hour || _._allow_dnd)
                            if (l.start_date = E, l.end_date = new Date(n), this.config.update_render) {
                                var S = _._els.dhx_cal_data[0].scrollTop;
                                this.update_view(), _._els.dhx_cal_data[0].scrollTop = S
                ...
                if (2 != t.button && !this.config.readonly && !this._drag_mode) {
                    ...
                    switch (this.config.drag_event_body && "dhx_body" == i && e.parentNode && -1 === e.parentNode.className.indexOf("dhx_cal_select_menu") && (i = "dhx_event_move", this._dragEventBody = !0), i) {
                        ...
                        case "dhx_event_resize":
                            ...
                            _._getClassName(e).indexOf("dhx_event_resize_end") < 0 ? _._drag_from_start = !0 : _._drag_from_start = !1;
                            break;
                        case "dhx_scale_holder":
                        case "dhx_scale_holder_now":
                        case "dhx_month_body":
                        ...
                        case "dhx_marked_timespan":
                            ...
                            break;
                        case "":
                            if (e.parentNode) return _._on_mouse_down(t, e.parentNode);
                            break;
                        default:
                            if ((!_.checkEvent("onMouseDown") || _.callEvent("onMouseDown", [i, t])) && e.parentNode && e != this && "dhx_body" != i) return _._on_mouse_down(t, e.parentNode);
                    ...
                    if (this._drag_mode) {
                        ...
                        if (this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [n, this._drag_mode, t])) {
                            ...
                            this._drag_event = _._lame_clone(this.getEvent(this._drag_id) || {}), this._drag_pos = this._mouse_coords(t)
                        } else this._drag_mode = this._drag_id = 0
                    }
                    this._drag_start = null
                }
            }, _._get_private_properties = function(t) {
                var e = {};
                for (var i in t) 0 === i.indexOf("_") && (e[i] = !0);
                return e
            }, _._clear_temporary_properties = function(t, e) {
                var i = this._get_private_properties(t),
                    n = this._get_private_properties(e);
                for (var a in n) i[a] || delete e[a]
            }, _._on_mouse_up = function(t) {
                if (!t || 2 != t.button || !this._mobile) {
                    if (this._drag_mode && this._drag_id) {
                        ...
                        if (n && (this._drag_event._dhx_changed || !this._drag_event.start_date || a.start_date.valueOf() != this._drag_event.start_date.valueOf() || a.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                            ...
                            if (this.callEvent("onBeforeEventChanged", [a, t, r, this._drag_event]))
                                if (this._drag_id = this._drag_mode = null, r && this.config.edit_on_create) {
                                    if (this.unselect(), this._new_event = new Date,
                                        this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(e))) return _.callEvent("onDragEnd", [e, i, t]), this.showLightbox(e);
                            ...
                            else r ? this.deleteEvent(a.id, !0) : (this._drag_event._dhx_changed = !1, this._clear_temporary_properties(a, this._drag_event), _._lame_copy(a, this._drag_event), this.updateEvent(a.id))
                        }
                        this._drag_pos && (this._drag_pos.has_moved || !0 === this._drag_pos) && (this._drag_id = this._drag_mode = null, this.render_view_data()), _.callEvent("onDragEnd", [e, i, t])
                    }
                    this._drag_id = null, this._drag_mode = null, this._drag_pos = null
                }
            }, _._trigger_dyn_loading = function() {
                return !(!this._load_mode || !this._load()) && (this._render_wait = !0, !0)
            }, _.update_view = function() {
            ...
            }, _.isViewExists = function(t) {
                return !!(_[t + "_view"] || _.date[t + "_start"] && _.templates[t + "_date"] && _.templates[t + "_scale_date"])
            }, _._set_aria_buttons_attrs = function() {
                ...
                _.setCurrentView(t, e)
            }, _._render_x_header = function(t, e, i, n, a) {
                a = a || 0;
                var r = document.createElement("div");
            ...
            }, _._get_columns_num = function(t, e) {
                var i = 7;
                if (!_._table_view) {
                    var n = _.date["get_" + _._mode + "_end"];
                    n && (e = n(t)), i = Math.round((e.valueOf() - t.valueOf()) / 864e5)
                }
                return i
            }, _._get_timeunit_start = function() {
                return this.date[this._mode + "_start"](new Date(this._date.valueOf()))
            }, _._get_view_end = function() {
                var t = this._get_timeunit_start(),
                    e = _.date.add(t, 1, this._mode);
                if (!_._table_view) {
                    var i = _.date["get_" + _._mode + "_end"];
                    i && (e = i(t))
                }
                return e
            }, _._calc_scale_sizes = function(t, e, i) {
            ...
            }, _._set_scale_col_size = function(t, e, i) {
                var n = this.config;
                this.set_xy(t, e - 1, n.hour_size_px * (n.last_hour - n.first_hour), i + this.xy.scale_width + 1, 0)
            },
            _._render_scales = function(t, e) {
                var i = new Date(_._min_date),
                    n = new Date(_._max_date),
                    a = this.date.date_part(_._currentDate()),
                ...
                for (var l = 0; l < o; l++) {
                    if (this._ignores[l] || this._render_x_header(l, d, s, t), !this._table_view) {
                        ...
                        s.valueOf() == a.valueOf() && (c = "dhx_scale_holder_now"),
                            h.setAttribute("data-column-index", l), this._ignores_detected && this._ignores[l] && (c += " dhx_scale_ignore"), h.className = c + " " + this.templates.week_date_class(s, a), this._waiAria.dayColumnAttr(h, s), this._set_scale_col_size(h, this._cols[l], d), e.appendChild(h), this.callEvent("onScaleAdd", [h, s])
                    }
                    d += this._cols[l], s = this.date.add(s, 1, "day"), s = this.date.day_start(s)
                }
            }, _._reset_scale = function() {
                if (this.templates[this._mode + "_date"]) {
                    ...
                    var a, r, s = this._get_timeunit_start(),
                        o = _._get_view_end();
                    a = r = this._table_view ? _.date.week_start(s) : s, this._min_date = a;
                    var d = this.templates[this._mode + "_date"](s, o, this._mode);
                    if (this._els.dhx_cal_date[0].innerHTML = d,
                        this._waiAria.navBarDateAttr(this._els.dhx_cal_date[0], d), this._max_date = o, _._render_scales(t, e), this._table_view) this._reset_month_scale(e, s, r);
                        ...
                        u.className = l, u.style.visibility = "hidden";
                        ...
                        var m = u.cloneNode(!0);
                        m.className = l + "_icon", m.style.visibility = "hidden", this.set_xy(m, this.xy.scale_width, 0, 0, c), u.appendChild(m), this._els[l] = [u, m], this._els[l][0].onclick = this._click.dhx_cal_data
                    }
                }
            }, _._reset_hours_scale = function(t, e, i) {
                ...
                for (var a = new Date(1980, 1, 1, this.config.first_hour, 0, 0), r = 1 * this.config.first_hour; r < this.config.last_hour; r++) {
                    ...
                    var d = _.templates.hour_scale(a);
            ...
            }, _._currentDate = function() {
                return _.config.now_date ? new Date(_.config.now_date) : new Date
            }, _._reset_ignores = function() {
                this._ignores = {}, this._ignores_detected = 0
            }, _._process_ignores = function(t, e, i, n, a) {
                this._reset_ignores();
                var r = _["ignore_" + this._mode];
                if (r)
                    for (var s = new Date(t), o = 0; o < e; o++) r(s) && (this._ignores_detected += 1, this._ignores[o] = !0, a && e++), s = _.date.add(s, n, i),
                        _.date[i + "_start"] && (s = _.date[i + "_start"](s))
            }, _._render_month_scale = function(t, e, i, n) {
                function a(t) {
                    var e = _._colsS.height;
                    return void 0 !== _._colsS.heights[t + 1] && (e = _._colsS.heights[t + 1] - (_._colsS.heights[t] || 0)), e
                }
                var r = _.date.add(e, 1, "month"),
                    s = new Date(i),
                    o = _._currentDate();
                this.date.date_part(o), this.date.date_part(i), n = n || Math.ceil(Math.round((r.valueOf() - i.valueOf()) / 864e5) / 7);
                for (var d = [], l = 0; l <= 7; l++) {
                    var h = (this._cols[l] || 0) - 1;
                    0 === l && this.config.left_border && (h -= 1), d[l] = h + "px"
                }
                var c = 0,
                ...
                for (var g = [], l = 0; l < n; l++) {
                    ...
                    f.appendChild(v);
                    for (var m = Math.max(a(l) - _.xy.month_head_height, 0), p = 0; p < 7; p++) {
                        var x = document.createElement("td");
                        v.appendChild(x);
                        var b = "";
                        i < e ? b = "dhx_before" : i >= r ? b = "dhx_after" : i.valueOf() == o.valueOf() && (b = "dhx_now"),
                            this._ignores_detected && this._ignores[p] && (b += " dhx_scale_ignore"), x.className = b + " " + this.templates.month_date_class(i, o), x.setAttribute("data-cell-date", _.templates.format_date(i));
                    ...
                    _._colsS.heights[l] = c, c += a(l)
                }
                this._min_date = s, this._max_date = i, t.innerHTML = "", t.appendChild(u), this._scales = {};
                for (var S = t.getElementsByTagName("div"), l = 0; l < g.length; l++) {
                    var t = S[2 * l + 1],
                        M = g[l];
                    this._scales[+M] = t
                }
            ...
            }, _._reset_month_scale = function(t, e, i, n) {
                var a = _.date.add(e, 1, "month"),
                    r = _._currentDate();
                ...
                return this._colsS.height = s + this.xy.month_head_height, this._colsS.heights = [], _._render_month_scale(t, e, i, n)
            }, _.getView = function(t) {
                return t || (t = _.getState().mode), _.matrix && _.matrix[t] ? _.matrix[t] : _._props && _._props[t] ? _._props[t] : null
            }, _.getLabel = function(t, e) {
                ...
                return ""
            }, _.updateCollection = function(t, e) {
                var i = _.serverList(t);
                return !!i && (i.splice(0, i.length), i.push.apply(i, e || []), _.callEvent("onOptionsLoad", []), _.resetLightbox(), !0)
            }, _._lame_clone = function(t, e) {
                var i, n, a;
                ...
                if (t && "object" == typeof t) {
                    ...
                    e.push(t, a);
                    for (i in t) Object.prototype.hasOwnProperty.apply(t, [i]) && (a[i] = _._lame_clone(t[i], e))
                }
                return a || t
            }, _._lame_copy = function(t, e) {
                for (var i in e) e.hasOwnProperty(i) && (t[i] = e[i]);
                return t
            }, _._get_date_from_pos = function(t) {
            ...
            }, _.getActionData = function(t) {
                var e = this._mouse_coords(t);
                return {
                    date: this._get_date_from_pos(e),
                    section: e.section
                }
            }, _._focus = function(t, e) {
                if (t && t.focus)
            ...
            }, _._get_real_event_length = function(t, e, i) {
                var n, a = e - t,
                ...
                for (var d = !0; o < n;) {
                    var l = _.date.add(e, -i.x_step, i.x_unit);
                    s && s(e) && (!d || d && s(l)) ? a -= e - l : (d = !1, a -= r), e = l, n--
                }
                return a
            }, _._get_fictional_event_length = function(t, e, i, n) {
                var a = new Date(t),
                    r = n ? -1 : 1;
                ...
                var l, h = new Date(1 * t + e * r),
                    c = this["ignore_" + this._mode],
                    u = 0;
                for (i.render ? (u = this._get_date_index(i, a), l = this._get_date_index(i, h)) : l = Math.round(e / 60 / 60 / 1e3 / 24); u * r <= l * r;) {
                    var f = _.date.add(a, i.x_step * r, i.x_unit);
                    c && c(a) && (e += (f - a) * r, l += r), a = f, u += r
                }
                return e
            }, _._get_section_view = function() {
                return this.getView()
            }, _._get_section_property = function() {
            ...
            }, _._is_initialized = function() {
                var t = this.getState();
                return this._obj && t.date && t.mode
            }, _._is_lightbox_open = function() {
                var t = this.getState();
                return null !== t.lightbox_id && void 0 !== t.lightbox_id
            }, _._getClassName = function(t) {
                if (!t) return "";
                var e = t.className || "";
                return e.baseVal && (e = e.baseVal),
                    e.indexOf || (e = ""), e || ""
            }, _.event = function(t, e, i) {
                t.addEventListener ? t.addEventListener(e, i, !1) : t.attachEvent && t.attachEvent("on" + e, i)
            }, _.eventRemove = function(t, e, i) {
                t.removeEventListener ? t.removeEventListener(e, i, !1) : t.detachEvent && t.detachEvent("on" + e, i)
            },
            function() {
                function t(t) {
                ...
                _._getFocusableNodes = function(a) {
            ...
            }, _._isDate = function(t) {
                return !(!t || "object" != typeof t) && !!(t.getFullYear && t.getMonth && t.getDate)
            },
            _._isObject = function(t) {
            ...
            function() {
                ...
                function i() {
                    return !_.config.wai_aria_attributes
                }
                var n = new RegExp("<(?:.|\n)*?>", "gm"),
                    a = new RegExp(" +", "gm"),
                    r = new RegExp("'", "gm");
                _._waiAria = {
                    ...
                    label: function(t) {
                        return _._waiAria.getAttributeString({
                            "aria-label": t
                        })
                    },
                    ...
                    monthCellAttr: function(t, e) {
                        this.labelAttr(t, _.templates.day_date(e))
                    },
                    ...
                    dayColumnAttr: function(t, e) {
                        this.dayHeaderAttr(t, _.templates.day_date(e))
                    },
                    ...
                    _eventCommonAttr: function(e, i) {
                        i.setAttribute("aria-label", t(_.templates.event_text(e.start_date, e.end_date, e))),
                            _.config.readonly && i.setAttribute("aria-readonly", !0), e.$dataprocessor_class && i.setAttribute("aria-busy", !0), i.setAttribute("aria-selected", _.getState().select_id == e.id ? "true" : "false")
                    },
                    ...
                    agendaDetailsBtnString: function() {
                        return this.getAttributeString({
                            role: "button",
                            "aria-label": _.locale.labels.icon_details
                        })
                    },
                    ...
                    minicalDayCell: function(t, e) {
                        var i = e.valueOf() < _._max_date.valueOf() && e.valueOf() >= _._min_date.valueOf();
                        this.setAttributes(t, {
                            role: "gridcell",
                            "aria-label": _.templates.day_date(e),
                    ...
                    lightboxSelectAttrString: function(t) {
                        ...
                        switch (t) {
                            case "%Y":
                                e = _.locale.labels.year;
                                break;
                            case "%m":
                                e = _.locale.labels.month;
                                break;
                            case "%d":
                                e = _.locale.labels.day;
                                break;
                            case "%H:%i":
                                e = _.locale.labels.hour + " " + _.locale.labels.minute
                        }
                        return _._waiAria.getAttributeString({
                            "aria-label": e
                        })
                ...
                for (var s in _._waiAria) _._waiAria[s] = function(t) {
                    return function() {
        ...
        _.$env = {
            ...
            parse: function(t) {
                ...
                return t = t.replace(/^[\s]+/, ""),
                    window.DOMParser && !_.$env.isIE ? e = (new window.DOMParser).parseFromString(t, "text/xml") : window.ActiveXObject !== window.undefined && (e = new window.ActiveXObject("Microsoft.XMLDOM"), e.async = "false", e.loadXML(t)), e
            },
            ...
            xpath: function(t, e) {
                if (e.nodeName || (e = e.responseXML || e), _.$env.isIE) return e.selectNodes(t) || [];
        ...
        _.date = {
                init: function() {
                    for (var t = _.locale.date.month_short, e = _.locale.date.month_short_hash = {}, i = 0; i < t.length; i++) e[t[i]] = i;
                    for (var t = _.locale.date.month_full, e = _.locale.date.month_full_hash = {}, i = 0; i < t.length; i++) e[t[i]] = i
                },
                _bind_host_object: function(t) {
                    return t.bind ? t.bind(_) : function() {
                ...
                week_start: function(t) {
                    var e = t.getDay();
                    return _.config.start_on_monday && (0 === e ? e = 6 : e--), this.date_part(this.add(t, -1 * e, "day"))
                },
                ...
                add: function(t, e, i) {
                    ...
                    switch (i) {
                        case "day":
                            n = _.date._add_days(n, e);
                            break;
                        case "week":
                            n = _.date._add_days(n, 7 * e);
                            break;
                        case "month":
                ...
                date_to_str: function(t, e) {
                    ...
                    return _.date._bind_host_object(i)
                },
                str_to_date: function(t, e, i) {
                    var n = x(t, e),
                        ...
                        g = x("%d-%m-%Y %H:%i:%s", e);
                    return function(t) {
                        if (!i && !_.config.parse_exact_format) {
            ...
            }, _.config.buttons_left.$inital = _.config.buttons_left.join(), _.config.buttons_right.$inital = _.config.buttons_right.join(), _._helpers = {
                parseDate: function(t) {
                    return (_.templates.xml_date || _.templates.parse_date)(t)
                },
                formatDate: function(t) {
                    return (_.templates.xml_format || _.templates.format_date)(t)
                }
            }, _.templates = {}, _.init_templates = function() {
                var t = _.locale.labels;
                t.dhx_save_btn = t.icon_save, t.dhx_cancel_btn = t.icon_cancel,
                    t.dhx_delete_btn = t.icon_delete;
                var e = _.date.date_to_str,
                    i = _.config;
                (function(t, e) {
                    ...
                    week_date: function(t, e) {
                        return i.rtl ? _.templates.day_date(_.date.add(e, -1, "day")) + " &ndash; " + _.templates.day_date(t) : _.templates.day_date(t) + " &ndash; " + _.templates.day_date(_.date.add(e, -1, "day"))
                    },
                    ...
                    parse_date: _.date.str_to_date(i.date_format, i.server_utc),
                    api_date: _.date.str_to_date(i.api_date, !1, !1),
                    event_header: function(t, e, i) {
                        return _.templates.event_date(t) + " - " + _.templates.event_date(e)
                    },
                    ...
                    event_bar_date: function(t, e, i) {
                        return _.templates.event_date(t) + " "
                    },
                    ...
                    tooltip_date_format: _.date.date_to_str("%Y-%m-%d %H:%i"),
                    tooltip_text: function(t, e, i) {
                        return "<b>Event:</b> " + i.text + "<br/><b>Start date:</b> " + _.templates.tooltip_date_format(t) + "<br/><b>End date:</b> " + _.templates.tooltip_date_format(e)
                    }
                }), this.callEvent("onTemplatesReady", [])
            }, _.uid = function() {
                return this._seed || (this._seed = (new Date).valueOf()), this._seed++
            }, _._events = {}, _.clearAll = function() {
            ...
            }, _.addEvent = function(t, e, i, n, a) {
                if (!arguments.length) return this.addEventNow();
                var r = t;
                1 != arguments.length && (r = a || {}, r.start_date = t, r.end_date = e, r.text = i, r.id = n), r.id = r.id || _.uid(), r.text = r.text || "", "string" == typeof r.start_date && (r.start_date = this.templates.api_date(r.start_date)), "string" == typeof r.end_date && (r.end_date = this.templates.api_date(r.end_date));
            ...
            function() {
                for (var t = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], e = function(t) {
                        return function(e) {
                            return _.getEvent(e)[t]
                        }
                    }, i = function(t) {
                        return function(e, i) {
                            var n = _.getEvent(e);
                            n[t] = i, n._changed = !0, n._timed = this.isOneDayEvent(n), _.event_updated(n, !0)
                        }
                    }, n = 0; n < t.length; n += 2) _["getEvent" + t[n + 1]] = e(t[n]), _["setEvent" + t[n + 1]] = i(t[n])
            }(), _.event_updated = function(t, e) {
                this.is_visible_events(t) ? this.render_view_data() : this.clear_event(t.id)
            }, _.is_visible_events = function(t) {
            ...
            }, _.get_visible_events = function(t) {
                var e = [];
                ...
                return e
            }, _.filter_event = function(t, e) {
                var i = this["filter_" + this._mode];
                return !i || i(t, e)
            }, _._is_main_area_event = function(t) {
                return !!t._timed
            }, _.render_view_data = function(t, e) {
                var i = !1;
                if (!t) {
                ...
                if (this.config.multi_day && !this._table_view) {
                    ...
                    if (!this._els.dhx_multi_day) {
                        var o = _._commonErrorMessages.unknownView(this._mode);
                        throw new Error(o)
                    }
            ...
            }, _._view_month_day = function(t) {
                var e = _.getActionData(t).date;
                _.callEvent("onViewMoreClick", [e]) && _.setCurrentView(e, "day")
            }, _._render_month_link = function(t) {
                for (var e = this._rendered_location, i = this._lame_clone(t), n = t._sday; n < t._eday; n++) {
                    ...
                    var s = _.getEvents(r, a.add(r, 1, "day")).length,
                        o = this._get_event_bar_pos(i),
                        d = o.x2 - o.x,
                        l = document.createElement("div");
                    l.onclick = function(t) {
                            _._view_month_day(t || event)
                        }, l.className = "dhx_month_link", l.style.top = o.y + "px", l.style.left = o.x + "px", l.style.width = d + "px", l.innerHTML = _.templates.month_events_link(r, s),
                        this._rendered.push(l), e.appendChild(l)
                }
            }, _._recalculate_timed = function(t) {
                if (t) {
                    var e;
                    e = "object" != typeof t ? this._events[t] : t, e && (e._timed = _.isOneDayEvent(e))
                }
            }, _.attachEvent("onEventChanged", _._recalculate_timed), _.attachEvent("onEventAdded", _._recalculate_timed), _.render_data = function(t, e) {
                t = this._pre_render_events(t, e);
                for (var i = {}, n = 0; n < t.length; n++)
                    if (this._table_view)
                        if ("month" != _._mode) this.render_event_bar(t[n]);
                        else {
                            var a = _.config.max_month_events;
                            a !== 1 * a || t[n]._sorder < a ? this.render_event_bar(t[n]) : void 0 !== a && t[n]._sorder == a && _._render_month_link(t[n])
                        } else {
                    var r = t[n],
                        s = _.locate_holder(r._sday);
                    if (!s) continue;
                    i[r._sday] || (i[r._sday] = {
                        real: s,
            ...
            }, _._get_first_visible_cell = function(t) {
                for (var e = 0; e < t.length; e++)
                    if (-1 == (t[e].className || "").indexOf("dhx_scale_ignore")) return t[e];
                return t[0]
            }, _._pre_render_events = function(t, e) {
                    ...
                    if (e) this._colsS.heights = n;
                        ...
                        if (s.rows) {
                            for (var o = 0; o < s.rows.length; o++) {
                                ...
                                if (a[o] * i > l) {
                                    var h = l;
                                    1 * this.config.max_month_events !== this.config.max_month_events || a[o] <= this.config.max_month_events ? h = a[o] * i : (this.config.max_month_events + 1) * i > l && (h = (this.config.max_month_events + 1) * i);
                                    for (var c = 0; c < d.length; c++) d[c].childNodes[1].style.height = h + "px"
                                }
                                a[o] = (a[o - 1] || 0) + _._get_first_visible_cell(d).offsetHeight
                            }
                            if (a.unshift(0),
                                s.parentNode.offsetHeight < s.parentNode.scrollHeight && !_._colsS.scroll_fix && _.xy.scroll_width) {
                                var u = _._colsS,
                                    f = u[u.col_length],
                                    g = u.heights.slice();
                                f -= _.xy.scroll_width || 0, this._calc_scale_sizes(f, this._min_date, this._max_date), _._colsS.heights = g, this.set_xy(this._els.dhx_cal_header[0], f, this.xy.scale_height), _._render_scales(this._els.dhx_cal_header[0]), _._render_month_scale(this._els.dhx_cal_data[0], this._get_timeunit_start(), this._min_date), u.scroll_fix = !0
                            }
                ...
                return e
            }, _._pre_render_events_line = function(t, e) {
                t.sort(function(t, e) {
            ...
            }, _._is_any_multiday_cell_visible = function(t, e, i) {
                var n = this._cols.length,
                    a = !1,
                    r = t,
                    s = !0,
                    o = new Date(e);
                for (_.date.day_start(new Date(e)).valueOf() != e.valueOf() && (o = _.date.day_start(o), o = _.date.add(o, 1, "day")); r < o;) {
                    s = !1;
                    ...
                    r = _.date.add(r, 1, "day")
                }
                return s || a
            },
            _._pre_render_events_table = function(t, e) {
                this._time_order(t);
                for (var i, n = [], a = [
                        [],
                        [],
                    ...
                    var g = this.locate_holder_day(u, !1, l);
                    if (l._sday = g % s, !this._ignores[l._sday] || !l._timed) {
                        var v = this.locate_holder_day(f, !0, l) || s;
                        l._eday = v % s || s, l._length = v - g, l._sweek = Math.floor((this._correct_shift(u.valueOf(), 1) - this._min_date.valueOf()) / (864e5 * s));
                        if (_._is_any_multiday_cell_visible(u, f, l)) {
                            var m, p = a[l._sweek];
                            for (m = 0; m < p.length && !(p[m]._eday <= l._sday); m++);
                            if (l._sorder && e || (l._sorder = m), l._sday + l._length <= s) i = null, n.push(l), p[m] = l, r[l._sweek] = p.length - 1, l._first_chunk = c.first_chunk, l._last_chunk = c.last_chunk;
                            else {
                                var x = this._copy_event(l);
                                x.id = l.id, x._length = s - l._sday, x._eday = s,
                                    x._sday = l._sday, x._sweek = l._sweek, x._sorder = l._sorder, x.end_date = this.date.add(u, x._length, "day"), x._first_chunk = c.first_chunk, c.first_chunk && (c.first_chunk = !1), n.push(x), p[m] = x, i = x.end_date, r[l._sweek] = p.length - 1, d--
                            }
                        }
                    }
                }
                return n
            }, _._copy_dummy = function() {
                var t = new Date(this.start_date),
                    e = new Date(this.end_date);
                this.start_date = t, this.end_date = e
            }, _._copy_event = function(t) {
            ...
            _.clear_event = function(t) {
                this.for_rendered(t, function(t, e) {
                    t.parentNode && t.parentNode.removeChild(t), _._rendered.splice(e, 1)
                })
            }, _._y_from_date = function(t) {
            ...
            }, _._calc_event_y = function(t, e) {
                e = e || 0;
                var i = 60 * t.start_date.getHours() + t.start_date.getMinutes(),
                    n = 60 * t.end_date.getHours() + t.end_date.getMinutes() || 60 * _.config.last_hour;
                return {
                    top: this._y_from_date(t.start_date),
                    height: Math.max(e, (n - i) * this.config.hour_size_px / 60)
                }
            }, _.render_event = function(t, e, i) {
                var n = _.xy.menu_width,
                    a = this.config.use_select_menu_space ? 0 : n;
                if (!(t._sday < 0)) {
                    var r = _.locate_holder(t._sday);
                    if (r) {
                        e = e || r;
                        var s = this._calc_event_y(t, _.xy.min_event_height),
                            o = s.top,
                            d = s.height,
                            l = t._count || 1,
                            h = t._sorder || 0;
                        i = i || r.clientWidth;
                        var c = Math.floor((i - a) / l),
                            u = h * c + 1;
                        if (t._inner || (c *= l - h), this.config.cascade_event_display) {
                            var f = this.config.cascade_event_count,
                                g = this.config.cascade_event_margin;
                            u = h % f * g;
                            var v = t._inner ? (l - h - 1) % f * g / 2 : 0;
                            c = Math.floor(i - a - u - v)
                        }
                        var m = this._render_v_bar(t, a + u, o, c, d, t._text_style, _.templates.event_header(t.start_date, t.end_date, t), _.templates.event_text(t.start_date, t.end_date, t));
                        ...
                        if (u = u + parseInt(this.config.rtl ? r.style.right : r.style.left, 10) + a, this._edit_id == t.id) {
                            m.style.zIndex = 1, c = Math.max(c - 4, _.xy.editor_width),
                                m = document.createElement("div"), m.setAttribute("event_id", t.id), this._waiAria.eventAttr(t, m), m.className = "dhx_cal_event dhx_cal_editor", this.config.rtl && u++, this.set_xy(m, c, d - 20, u, o + (_.xy.event_header_height || 14)), t.color && (m.style.backgroundColor = t.color);
                            var p = _.templates.event_class(t.start_date, t.end_date, t);
                            p && (m.className += " " + p);
                            ...
                            this.set_xy(x, c - 6, d - 26), x.style.cssText += ";margin:2px 2px 2px 2px;overflow:hidden;", m.appendChild(x),
                                this._els.dhx_cal_data[0].appendChild(m), this._rendered.push(m), x.innerHTML = "<textarea class='dhx_cal_editor'>" + t.text + "</textarea>", this._editor = x.querySelector("textarea"), this._quirks7 && (this._editor.style.height = d - 12 + "px"), this._editor.onkeydown = function(t) {
                                    ...
                                    e == _.keys.edit_save && _.editStop(!0), e == _.keys.edit_cancel && _.editStop(!1), e != _.keys.edit_save && e != _.keys.edit_cancel || t.preventDefault && t.preventDefault()
                                },
                                this._editor.onselectstart = function(t) {
                                    return (t || event).cancelBubble = !0, !0
                                }, _._focus(this._editor, !0), this._els.dhx_cal_data[0].scrollLeft = 0
                        }
                        if (0 !== this.xy.menu_width && this._select_id == t.id) {
                            ...
                            var S = this._render_v_bar(t, u - n + 1, o, n, 20 * y.length + 26 - 2, "", "<div style='" + D + E + "' class='dhx_menu_head'></div>", w, !0);
            ...
            }, _._render_v_bar = function(t, e, i, n, a, r, s, o, d) {
                ...
                var f = _.templates.event_class(t.start_date, t.end_date, t);
                ...
                if (!d && _.renderEvent(A, t, n, a, s, o)) return A;
                A = l.firstChild;
                var S = '<div class="dhx_event_move dhx_header" style=" width:' + b + "px;" + g + '" >&nbsp;</div>';
                S += '<div class="dhx_event_move dhx_title" style="' + g + v + '">' + s + "</div>", S += '<div class="dhx_body" style=" width:' + y + "px; height:" + D + "px;" + g + v + '">' + o + "</div>";
                var M = "dhx_event_resize dhx_footer";
                return (d || !1 === t._drag_resize) && (M = "dhx_resize_denied " + M), S += '<div class="' + M + '" style=" width:' + w + "px;" + (d ? " margin-top:-1px;" : "") + g + v + '" ></div>',
                    A.innerHTML = S, A
            }, _.renderEvent = function() {
                return !1
            }, _.locate_holder = function(t) {
                return "day" == this._mode ? this._els.dhx_cal_data[0].firstChild : this._els.dhx_cal_data[0].childNodes[t]
            }, _.locate_holder_day = function(t, e) {
                var i = Math.floor((this._correct_shift(t, 1) - this._min_date) / 864e5);
                return e && this.date.time_part(t) && i++, i
            }, _._get_dnd_order = function(t, e, i) {
            ...
            }, _._get_event_bar_pos = function(t) {
                ...
                var e = this._rendered_location,
                    ...
                    s = "";
                if (r) {
                    var o = _.config.resize_month_events && "month" == this._mode && (!t._timed || _.config.resize_month_timed),
                    ...
                    t._timed && !o || (f = !1, g = "dhx_cal_event_line"), l && (g += " dhx_cal_event_line_start"),
                    ...
                    var v = _.templates.event_class(t.start_date, t.end_date, t);
                    v && (g += " " + v);
                    ...
                    o && (b += s), "month" == _.getState().mode && (t = _.getEvent(t.id)), t._timed && (b += _.templates.event_bar_date(t.start_date, t.end_date, t)), b += _.templates.event_bar_text(t.start_date, t.end_date, t) + "</div>",
                        b += "</div>", d.innerHTML = b, this._rendered.push(d.firstChild), e.appendChild(d.firstChild)
                }
            }, _._locate_event = function(t) {
                for (var e = null; t && !e && t.getAttribute;) e = t.getAttribute("event_id"), t = t.parentNode;
                return e
            }, _._locate_css = function(t, e, i) {
                void 0 === i && (i = !0);
                for (var n = t.target || t.srcElement, a = ""; n;) {
                    if (a = _._getClassName(n)) {
                        var r = a.indexOf(e);
                        if (r >= 0) {
                            if (!i) return n;
                            var s = 0 === r || !_._trim(a.charAt(r - 1)),
                                o = r + e.length >= a.length || !_._trim(a.charAt(r + e.length));
                            if (s && o) return n
                        }
                    }
                    n = n.parentNode
            ...
            }, _._edit_stop_event = function(t, e) {
                ...
                return i
            }, _.getRenderedEvent = function(t) {
                if (t) {
                    for (var e = _._rendered, i = 0; i < e.length; i++) {
                        var n = e[i];
                        if (n.getAttribute("event_id") == t) return n
                    }
                    return null
                }
            }, _.showEvent = function(t, e) {
                var i = "number" == typeof t || "string" == typeof t ? _.getEvent(t) : t;
                if (e = e || _._mode,
                    i && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [i, e]))) {
                    var n = _.config.scroll_hour;
                    _.config.scroll_hour = i.start_date.getHours();
                    var a = _.config.preserve_scroll;
                    _.config.preserve_scroll = !1;
                    var r = i.color,
                        s = i.textColor;
                    if (_.config.highlight_displayed_event && (i.color = _.config.displayed_event_color, i.textColor = _.config.displayed_event_text_color), _.setCurrentView(new Date(i.start_date), e), i.color = r, i.textColor = s, _.config.scroll_hour = n, _.config.preserve_scroll = a,
                        _.matrix && _.matrix[e]) {
                        var o = _.getView(),
                            d = o.y_property,
                            l = _.getEvent(i.id);
                        if (l) {
                            var h = o.posFromSection(l[d]),
                                c = o.posFromDate(l.start_date),
                                u = _.$container.querySelector(".dhx_timeline_data_wrapper");
                    ...
                    _.callEvent("onAfterEventDisplay", [i, e])
                }
            }, _._append_drag_marker = function(t) {
                if (!t.parentNode) {
                    var e = _._els.dhx_cal_data[0],
                        i = e.lastChild,
                        n = _._getClassName(i);
                    n.indexOf("dhx_scale_holder") < 0 && i.previousSibling && (i = i.previousSibling), n = _._getClassName(i), i && 0 === n.indexOf("dhx_scale_holder") && i.appendChild(t)
                }
            }, _._update_marker_position = function(t, e) {
                var i = _._calc_event_y(e, 0);
                t.style.top = i.top + "px", t.style.height = i.height + "px"
            }, _.highlightEventPosition = function(t) {
                var e = document.createElement("div");
            ...
            }, _._loaded = {}, _._load = function(t, e) {
                function i(t) {
                    _.on_load(t), _.callEvent("onLoadEnd", [])
                }
                ...
                parse: function(t) {
                    var e;
                    if (t.xmlDoc.responseXML || (t.xmlDoc.responseXML = _.$ajax.parse(t.xmlDoc.responseText)), e = _.$ajax.xmltop("data", t.xmlDoc),
                        "data" != e.tagName) return null;
                    var i = e.getAttribute("dhx_security");
                    i && (window.dhtmlx && (dhtmlx.security_key = i), _.security_key = i);
                    for (var n = _.$ajax.xpath("//coll_options", t.xmlDoc), a = 0; a < n.length; a++) {
                        var r = n[a].getAttribute("for"),
                            s = _.serverList[r];
                        s || (_.serverList[r] = s = []), s.splice(0, s.length);
                        for (var o = _.$ajax.xpath(".//item", n[a]), d = 0; d < o.length; d++) {
                            for (var l = o[d], h = l.attributes, c = {
                    ...
                    n.length && _.callEvent("onOptionsLoad", []);
                    for (var g = _.$ajax.xpath("//userdata", t.xmlDoc), a = 0; a < g.length; a++) {
                        var v = _._xmlNodeToJSON(g[a]);
                        _._userdata[v.name] = v.text
                    }
                    var m = [];
                    e = _.$ajax.xpath("//event", t.xmlDoc);
                    for (var a = 0; a < e.length; a++) {
                        var p = m[a] = _._xmlNodeToJSON(e[a]);
                        _._init_event(p)
                    }
                    return m
                }
            }, _.json = _._parsers.json = {
                canParse: function(t) {
                ...
                parse: function(t) {
                    var e = [];
                    "string" == typeof t && (t = JSON.parse(t)), e = "[object Array]" === Object.prototype.toString.call(t) ? t : t ? t.data : [], e = e || [], t.dhx_security && (window.dhtmlx && (dhtmlx.security_key = t.dhx_security), _.security_key = t.dhx_security);
                    ...
                    for (var a in i)
                        if (i.hasOwnProperty(a)) {
                            ...
                            var r = i[a],
                                s = _.serverList[a];
                            s || (_.serverList[a] = s = []), s.splice(0, s.length);
                    ...
                    n && _.callEvent("onOptionsLoad", []);
                    for (var c = [], u = 0; u < e.length; u++) {
                        var f = e[u];
                        _._init_event(f), c.push(f)
                    }
                    return c
                }
            }, _.ical = _._parsers.ical = {
                canParse: function(t) {
                ...
                parse_date: function(t, e, i) {
                    ...
                    var r = n[0].substr(0, 4),
                        ...
                        o = n[0].substr(6, 2);
                    return _.config.server_utc || a ? new Date(Date.UTC(r, s, o, e, i)) : new Date(r, s, o, e, i)
                },
                c_start: "BEGIN:VCALENDAR",
                e_start: "BEGIN:VEVENT",
                e_end: "END:VEVENT",
                c_end: "END:VCALENDAR"
            }, _.on_load = function(t) {
            ...
            }, _._init_event = function(t) {
                t.text = t.text || t._tagvalue || "", t.start_date = _._init_date(t.start_date), t.end_date = _._init_date(t.end_date)
            }, _._init_date = function(t) {
                return t ? "string" == typeof t ? _._helpers.parseDate(t) : new Date(t) : null
            }, _.json = {}, _.json.parse = function(t) {
                var e = [];
                "string" == typeof t && (t = JSON.parse(t)), e = "[object Array]" === Object.prototype.toString.call(t) ? t : t ? t.data : [], e = e || [],
                    t.dhx_security && (window.dhtmlx && (dhtmlx.security_key = t.dhx_security), _.security_key = t.dhx_security);
                var i = t && t.collections ? t.collections : {},
                    n = !1;
                for (var a in i)
                    if (i.hasOwnProperty(a)) {
            ...
            _._xmlNodeToJSON = function(t) {
                ...
                var a = document.getElementById(n.id),
                    ...
                    s = {
                        ...
                        node: r,
                        getValue: function(t) {
                            return _.form_blocks[n.type].get_value(r, t || {}, n)
                        },
                        setValue: function(t, e) {
                            return _.form_blocks[n.type].set_value(r, t, e || {}, n)
                        }
                    },
                    o = _._lightbox_controls["get_" + n.type + "_control"];
                return o ? o(s) : s
            }, _._lightbox_controls.get_template_control = function(t) {
                return t.control = t.node, t
            }, _._lightbox_controls.get_select_control = function(t) {
                return t.control = t.node.getElementsByTagName("select")[0], t
            }, _._lightbox_controls.get_textarea_control = function(t) {
                return t.control = t.node.getElementsByTagName("textarea")[0], t
            }, _._lightbox_controls.get_time_control = function(t) {
                return t.control = t.node.getElementsByTagName("select"), t
            }, _._lightbox_controls.defaults = {
                template: {
                    height: 30
                },
                textarea: {
                ...
                template: {
                    render: function(t) {
                        var e = _._lightbox_controls.defaults.template,
                            i = e ? e.height : 30;
                ...
                textarea: {
                    render: function(t) {
                        var e = _._lightbox_controls.defaults.textarea,
                            i = e ? e.height : 200;
                        return "<div class='dhx_cal_ltext' style='height:" + (t.height || i || "130") + "px;'><textarea></textarea></div>"
                    },
                    set_value: function(t, e, i) {
                        _.form_blocks.textarea._get_input(t).value = e || ""
                    },
                    get_value: function(t, e) {
                        return _.form_blocks.textarea._get_input(t).value
                    },
                    focus: function(t) {
                        var e = _.form_blocks.textarea._get_input(t);
                        _._focus(e, !0)
                    },
                ...
                select: {
                    render: function(t) {
                        for (var e = _._lightbox_controls.defaults.select, i = e ? e.height : 23, n = (t.height || i || "23") + "px", a = "<div class='dhx_cal_ltext' style='height:" + n + ";'><select style='width:100%;'>", r = 0; r < t.options.length; r++) a += "<option value='" + t.options[r].key + "'>" + t.options[r].label + "</option>";
                        return a += "</select></div>"
                    },
                    set_value: function(t, e, i, n) {
                        var a = t.firstChild;
                ...
                time: {
                    render: function(t) {
                        ...
                        var e = t.time_format,
                            i = _.config,
                            n = _.date.date_part(_._currentDate()),
                            a = 1440,
                            r = 0;
                        _.config.limit_time_select && (a = 60 * i.last_hour + 1,
                        ...
                        for (var s = "", o = 0; o < e.length; o++) {
                            ...
                            if (h) {
                                var p = _._waiAria.lightboxSelectAttrString(d);
                                s += "<select class='" + l + "' " + (t.readonly ? "disabled='disabled'" : "") + p + ">" + h + "</select> "
                            }
                        }
                        var x = _._lightbox_controls.defaults.select;
                    ...
                    set_value: function(t, e, i, n) {
                        ...
                        if (o.full_day) {
                            if (!t._full_day) {
                                var h = "<label class='dhx_fullday'><input type='checkbox' name='full_day' value='true'> " + _.locale.labels.full_day + "&nbsp;</label></input>";
                                _.config.wide_form || (h = t.previousSibling.innerHTML + h), t.previousSibling.innerHTML = h, t._full_day = !0
                            }
                            var c = t.previousSibling.getElementsByTagName("input")[0];
                            c.checked = 0 === _.date.time_part(i.start_date) && 0 === _.date.time_part(i.end_date), d[l[0]].disabled = c.checked, d[l[0] + d.length / 2].disabled = c.checked, c.onclick = function() {
                                if (c.checked) {
                                    var e = {};
                                    _.form_blocks.time.get_value(t, e, n), r = _.date.date_part(e.start_date), s = _.date.date_part(e.end_date), (+s == +r || +s >= +r && (0 !== i.end_date.getHours() || 0 !== i.end_date.getMinutes())) && (s = _.date.add(s, 1, "day"))
                                } else r = null, s = null;
                                d[l[0]].disabled = c.checked, d[l[0] + d.length / 2].disabled = c.checked, a(d, 0, r || i.start_date),
                                    a(d, 4, s || i.end_date)
                            }
                        }
                        if (o.auto_end_date && o.event_duration)
                            for (var u = function() {
                                    r = new Date(d[l[3]].value, d[l[2]].value, d[l[1]].value, 0, d[l[0]].value), s = new Date(r.getTime() + 60 * _.config.event_duration * 1e3), a(d, 4, s)
                    ...
                    get_value: function(t, e, i) {
                        ...
                        if (e.start_date = new Date(n[a[3]].value, n[a[2]].value, n[a[1]].value, 0, n[a[0]].value),
                            ...
                            var r = _.getEvent(_._lightbox_id);
                            r && (e.start_date = r.start_date, e.end_date = r.end_date)
                        }
                        return e.end_date <= e.start_date && (e.end_date = _.date.add(e.start_date, _.config.time_step, "minute")), {
                            start_date: new Date(e.start_date),
                            end_date: new Date(e.end_date)
                        }
                    },
                    focus: function(t) {
                        _._focus(t.getElementsByTagName("select")[0])
                    }
                }
            }, _._setLbPosition = function(t) {
                if (t) {
            ...
            }, _.showCover = function(t) {
                t && (t.style.display = "block", this._setLbPosition(t)), _.config.responsive_lightbox && (document.documentElement.classList.add("dhx_cal_overflow_container"), document.body.classList.add("dhx_cal_overflow_container")), this.show_cover()
            }, _.showLightbox = function(t) {
                if (t) {
            ...
            }, _._fill_lightbox = function(t, e) {
                var i = this.getEvent(t),
                    n = e.getElementsByTagName("span"),
                    a = [];
                if (_.templates.lightbox_header) {
                    a.push("");
                    var r = _.templates.lightbox_header(i.start_date, i.end_date, i);
                ...
                for (var d = this.config.lightbox.sections, l = 0; l < d.length; l++) {
                    var h = d[l],
                        c = _._get_lightbox_section_node(h),
                        u = this.form_blocks[h.type],
                        f = void 0 !== i[h.map_to] ? i[h.map_to] : h.default_value;
                    u.set_value.call(this, c, f, i, h), d[l].focus && u.focus.call(this, c)
                }
                _._lightbox_id = t
            }, _._get_lightbox_section_node = function(t) {
                return document.getElementById(t.id).nextSibling
            }, _._lightbox_out = function(t) {
                ...
                return t
            }, _._empty_lightbox = function(t) {
                var e = _._lightbox_id,
                    i = this.getEvent(e);
                this.getLightbox();
                this._lame_copy(i, t), this.setEvent(i.id, i),
                    this._edit_stop_event(i, !0), this.render_view_data()
            }, _.hide_lightbox = function(t) {
                _.endLightbox(!1, this.getLightbox())
            }, _.hideLightbox = _.hide_lightbox, _.hideCover = function(t) {
                t && (t.style.display = "none"), this.hide_cover(), _.config.responsive_lightbox && (document.documentElement.classList.remove("dhx_cal_overflow_container"), document.body.classList.remove("dhx_cal_overflow_container"))
            }, _.hide_cover = function() {
                this._cover && this._cover.parentNode.removeChild(this._cover), this._cover = null
            },
            _.set_cover_height = function(t) {
            ...
            }, _.startLightbox = function(t, e) {
                this._lightbox_id = t, this._custom_lightbox = !0, this._temp_lightbox = this._lightbox, this._lightbox = e, this.showCover(e)
            }, _.endLightbox = function(t, e) {
                var e = e || _.getLightbox(),
                    i = _.getEvent(this._lightbox_id);
                i && this._edit_stop_event(i, t), t && _.render_view_data(), this.hideCover(e),
            ...
            }, _.resetLightbox = function() {
                _._lightbox && !_._custom_lightbox && _._lightbox.parentNode.removeChild(_._lightbox), _._lightbox = null
            }, _.cancel_lightbox = function() {
                this.callEvent("onEventCancel", [this._lightbox_id, this._new_event]), this.hide_lightbox()
            }, _._init_lightbox_events = function() {
                this.getLightbox().onclick = function(t) {
                    var e = t ? t.target : event.srcElement;
                    if (e.className || (e = e.previousSibling), !(e && e.className && _._getClassName(e).indexOf("dhx_btn_set") > -1) || (e = e.querySelector("[dhx_button]"))) {
                        var i = _._getClassName(e);
                        if (e && i) switch (i) {
                            case "dhx_save_btn":
                                _.save_lightbox();
                                break;
                            case "dhx_delete_btn":
                                var n = _.locale.labels.confirm_deleting;
                                _._dhtmlx_confirm(n, _.locale.labels.title_confirm_deleting, function() {
                                    _.deleteEvent(_._lightbox_id), _._new_event = null, _.hide_lightbox()
                                });
                                break;
                            case "dhx_cancel_btn":
                                _.cancel_lightbox();
                                break;
                            default:
                                if (e.getAttribute("dhx_button")) _.callEvent("onLightboxButton", [i, e, t]);
                                else {
                                    var a, r, s; - 1 != i.indexOf("dhx_custom_button") && (-1 != i.indexOf("dhx_custom_button_") ? (a = e.parentNode.getAttribute("index"), s = e.parentNode.parentNode) : (a = e.getAttribute("index"), s = e.parentNode, e = e.firstChild)), a && (r = _.form_blocks[_.config.lightbox.sections[a].type], r.button_click(a, e, s, s.nextSibling))
                                }
                        }
                    }
                    ...
                    switch (n || (n = i.parentNode.querySelector(".dhx_custom_button, .dhx_readonly")), (t || e).keyCode) {
                        case 32:
                            ...
                            n && n.click && n.click();
                            break;
                        case _.keys.edit_save:
                            if ((t || e).shiftKey) return;
                            n && n.click ? n.click() : _.save_lightbox();
                            break;
                        case _.keys.edit_cancel:
                            _.cancel_lightbox()
                    }
                }
            }, _.setLightboxSize = function() {
                var t = this._lightbox;
                if (t) {
                    var e = t.childNodes[1];
                    e.style.height = "0px",
                        e.style.height = e.scrollHeight + "px", t.style.height = e.scrollHeight + _.xy.lightbox_additional_height + "px", e.style.height = e.scrollHeight + "px"
                }
            }, _._init_dnd_events = function() {
                _.event(document.body, "mousemove", _._move_while_dnd), _.event(document.body, "mouseup", _._finish_dnd), _._init_dnd_events = function() {}
            }, _._move_while_dnd = function(t) {
                if (_._dnd_start_lb) {
                    ...
                    e.style.top = _._lb_start[1] + i[1] - _._dnd_start_lb[1] + "px", e.style.left = _._lb_start[0] + i[0] - _._dnd_start_lb[0] + "px"
                }
            }, _._ready_to_dnd = function(t) {
                var e = _.getLightbox();
                _._lb_start = [parseInt(e.style.left, 10), parseInt(e.style.top, 10)], _._dnd_start_lb = t && t.target ? [t.pageX, t.pageY] : [event.clientX, event.clientY]
            }, _._finish_dnd = function() {
            ...
            }, _.getLightbox = function() {
                if (!this._lightbox) {
                    var t = document.createElement("div");
                    t.className = "dhx_cal_light", _.config.wide_form && (t.className += " dhx_cal_light_wide"), _.form_blocks.recurring && (t.className += " dhx_cal_light_rec"), _.config.rtl && (t.className += " dhx_cal_light_rtl"), _.config.responsive_lightbox && (t.className += " dhx_cal_light_responsive"),
                        /msie|MSIE 6/.test(navigator.userAgent) && (t.className += " dhx_ie6"), t.style.visibility = "hidden";
                    for (var e = this._lightbox_template, i = this.config.buttons_left, n = "", a = 0; a < i.length; a++) n = this._waiAria.lightboxButtonAttrString(i[a]), e += "<div " + n + " class='dhx_btn_set dhx_" + (_.config.rtl ? "right" : "left") + "_btn_set " + i[a] + "_set'><div dhx_button='1' class='" + i[a] + "'></div><div>" + _.locale.labels[i[a]] + "</div></div>";
                    i = this.config.buttons_right;
                    for (var r = _.config.rtl, a = 0; a < i.length; a++) n = this._waiAria.lightboxButtonAttrString(i[a]), e += "<div " + n + " class='dhx_btn_set dhx_" + (r ? "left" : "right") + "_btn_set " + i[a] + "_set' style='float:" + (r ? "left" : "right") + ";'><div dhx_button='1' class='" + i[a] + "'></div><div>" + _.locale.labels[i[a]] + "</div></div>";
                    e += "</div>", t.innerHTML = e, _.config.drag_lightbox && (t.firstChild.onmousedown = _._ready_to_dnd, t.firstChild.onselectstart = function() {
                            return !1
                        }, t.firstChild.style.cursor = "move", _._init_dnd_events()),
                    ...
                    for (var a = 0; a < s.length; a++) {
                        ...
                        if (o) {
                            ...
                            var d = "";
                            if (s[a].button) {
                                var n = _._waiAria.lightboxSectionButtonAttrString(this.locale.labels["button_" + s[a].button]);
                    ...
                    for (var h = t.getElementsByTagName("div"), a = 0; a < h.length; a++) {
                        var c = h[a];
                        if ("dhx_cal_larea" == _._getClassName(c)) {
                            c.innerHTML = e;
                            break
                        }
                    }
                    _._bindLightboxLabels(s), this.setLightboxSize(), this._init_lightbox_events(this), t.style.display = "none", t.style.visibility = "visible"
                }
                return this._lightbox
            }, _._bindLightboxLabels = function(t) {
                for (var e = 0; e < t.length; e++) {
                    var i = t[e];
                    if (i.id && document.getElementById(i.id)) {
                        for (var n = document.getElementById(i.id), a = n.querySelector("label"), r = _._get_lightbox_section_node(i); r && !r.querySelector;) r = r.nextSibling;
                        var s = !0;
                        if (r) {
                            var o = r.querySelector("input, select, textarea");
                            o && (i.inputId = o.id || "input_" + _.uid(), o.id || (o.id = i.inputId), a.setAttribute("for", i.inputId), s = !1)
                        }
                        if (s) {
                            _.form_blocks[i.type].focus && (a.onclick = function(t) {
                                return function() {
                                    var e = _.form_blocks[t.type],
                                        i = _._get_lightbox_section_node(t);
                                    e && e.focus && e.focus.call(_, i)
                                }
                            }(i))
                        }
                    }
                }
            }, _.attachEvent("onEventIdChange", function(t, e) {
                this._lightbox_id == t && (this._lightbox_id = e)
            }),
            _._lightbox_template = "<div class='dhx_cal_ltitle'><span class='dhx_mark'>&nbsp;</span><span class='dhx_time'></span><span class='dhx_title'></span></div><div class='dhx_cal_larea'></div>", _._init_touch_events = function() {
            ...
            }, _._touch_events = function(t, e, i) {
                function n(t, e, n) {
                    t.addEventListener(e, function(t) {
                        if (_._is_lightbox_open()) return !0;
                        if (!i(t)) return n(t)
                    }, {
                        passive: !1
                    })
                ...
                function a(t, e, i, n) {
                    if (!t || !e) return !1;
                    for (var a = t.target; a && a != _._obj;) a = a.parentNode;
                    if (a != _._obj) return !1;
                    if (_.matrix && _.matrix[_.getState().mode]) {
                        if (_.matrix[_.getState().mode].scrollable) return !1
                    }
                    var r = Math.abs(t.pageY - e.pageY),
                        s = Math.abs(t.pageX - e.pageX);
                    return r < n && s > i && (!r || s / r > 3) && (t.pageX > e.pageX ? _._click.dhx_cal_next_button() : _._click.dhx_cal_prev_button(), !0)
                }

                function r(t) {
                    if (!i(t)) {
                        var e = _.getState().drag_mode,
                            n = !!_.matrix && _.matrix[_._mode],
                            a = _.render_view_data;
                        return "create" == e && n && (_.render_view_data = function() {
                            for (var t = _.getState().drag_id, e = _.getEvent(t), i = n.y_property, a = _.getEvents(e.start_date, e.end_date), r = 0; r < a.length; r++) a[r][i] != e[i] && (a.splice(r, 1), r--);
                            e._sorder = a.length - 1, e._count = a.length, this.render_data([e], _.getState().mode)
                        }), _._on_mouse_move(t), "create" == e && n && (_.render_view_data = a), t.preventDefault && t.preventDefault(), t.cancelBubble = !0, !1
                    }
                }

                function s(t) {
                    i(t) || (_._hide_global_tip(), h && (_._on_mouse_up(e(t || event)), _._temp_touch_block = !1), _._drag_id = null, _._drag_mode = null,
                        _._drag_pos = null, _._pointerDragId = null, clearTimeout(l), h = u = !1, c = !0)
                }
                var o, d, l, h, c, u, f = (-1 != navigator.userAgent.indexOf("Android") && navigator.userAgent.indexOf("WebKit"), 0);
                n(document.body, t[0], function(t) {
                        if (!i(t)) {
                            var n = e(t);
                            if (n) {
                                if (h) return r(n), t.preventDefault && t.preventDefault(), t.cancelBubble = !0, _._update_global_tip(), !1;
                                if (d = e(t), u) return d ? void((o.target != d.target || Math.abs(o.pageX - d.pageX) > 5 || Math.abs(o.pageY - d.pageY) > 5) && (c = !0, clearTimeout(l))) : void(c = !0)
                            }
                        }
                    }),
                    n(this._els.dhx_cal_data[0], "touchcancel", s), n(this._els.dhx_cal_data[0], "contextmenu", function(t) {
                        ...
                        if (!i(t)) {
                            _._pointerDragId = t.pointerId;
                            var n;
                            if (h = c = !1, u = !0, !(n = d = e(t))) return void(c = !0);
                            var a = new Date;
                            if (!c && !h && a - f < 250) return _._click.dhx_cal_data(n), window.setTimeout(function() {
                                    n.type = "dblclick", _._on_dbl_click(n)
                                }, 50), t.preventDefault && t.preventDefault(),
                                t.cancelBubble = !0, _._block_next_stop = !0, !1;
                            if (f = a, !c && !h && _.config.touch_drag) {
                                var r = _._locate_event(document.activeElement),
                                    s = _._locate_event(n.target),
                                    g = o ? _._locate_event(o.target) : null;
                                if (r && s && r == s && r != g) return t.preventDefault && t.preventDefault(), t.cancelBubble = !0, _._ignore_next_click = !1, _._click.dhx_cal_data(n), o = n, !1;
                                l = setTimeout(function() {
                                    h = !0;
                                    var t = o.target,
                                        e = _._getClassName(t);
                                    t && -1 != e.indexOf("dhx_body") && (t = t.previousSibling), _._on_mouse_down(o, t),
                                        _._drag_mode && "create" != _._drag_mode && _.for_rendered(_._drag_id, function(t, e) {
                                            t.style.display = "none", _._rendered.splice(e, 1)
                                        }), _.config.touch_tip && _._show_global_tip(), _.updateEvent(_._drag_id)
                                }, _.config.touch_drag), o = n
                            }
                        }
                    }), n(this._els.dhx_cal_data[0], t[2], function(t) {
                        if (!i(t)) return _.config.touch_swipe_dates && !h && a(o, d, 200, 100) && (_._block_next_stop = !0), h && (_._ignore_next_click = !0, setTimeout(function() {
                            _._ignore_next_click = !1
                        }, 100)), s(t), _._block_next_stop ? (_._block_next_stop = !1,
                            t.preventDefault && t.preventDefault(), t.cancelBubble = !0, !1) : void 0
                    }), _.event(document.body, t[2], s)
            }, _._show_global_tip = function() {
                _._hide_global_tip();
                var t = _._global_tip = document.createElement("div");
                t.className = "dhx_global_tip", _._update_global_tip(1), document.body.appendChild(t)
            }, _._update_global_tip = function(t) {
                var e = _._global_tip;
                if (e) {
                    var i = "";
                    if (_._drag_id && !t) {
                        var n = _.getEvent(_._drag_id);
                        n && (i = "<div>" + (n._timed ? _.templates.event_header(n.start_date, n.end_date, n) : _.templates.day_date(n.start_date, n.end_date, n)) + "</div>")
                    }
                    "create" == _._drag_mode || "new-size" == _._drag_mode ? e.innerHTML = (_.locale.labels.drag_to_create || "Drag to create") + i : e.innerHTML = (_.locale.labels.drag_to_move || "Drag to move") + i
                }
            }, _._hide_global_tip = function() {
                var t = _._global_tip;
                t && t.parentNode && (t.parentNode.removeChild(t), _._global_tip = 0)
            }, _._dp_init = function(t) {
                t._methods = ["_set_event_text_style", "", "_dp_change_event_id", "_dp_hook_delete"], this._dp_change_event_id = function(t, e) {
                        _.getEvent(t) && _.changeEventId(t, e)
                    }, this._dp_hook_delete = function(e, i) {
                        if (_.getEvent(e)) return i && e != i && ("true_deleted" == this.getUserData(e, t.action_param) && this.setUserData(e, t.action_param, "updated"), this.changeEventId(e, i)), this.deleteEvent(i, !0)
                    ...
                    }), _.attachEvent("onClearAll", function() {
                ...
                t._getRowData = function(t, n) {
                    ...
                    t._clearUpdateFlag = function() {}, t.attachEvent("insertCallback", _._update_callback), t.attachEvent("updateCallback", _._update_callback), t.attachEvent("deleteCallback", function(t, e) {
            ...
            }, _._validId = function(t) {
                return !0
            }, _.setUserData = function(t, e, i) {
                if (t) {
                    var n = this.getEvent(t);
                    n && (n[e] = i)
                } else this._userdata[e] = i
            },
            _.getUserData = function(t, e) {
                if (t) {
                    var i = this.getEvent(t);
                    return i ? i[e] : null
                }
                return this._userdata[e]
            }, _._set_event_text_style = function(t, e) {
                if (_.getEvent(t)) {
            ...
            }, _._update_callback = function(t, e) {
                var i = _._xmlNodeToJSON(t.firstChild);
                "none" == i.rec_type && (i.rec_pattern = "none"), i.text = i.text || i._tagvalue, i.start_date = _._helpers.parseDate(i.start_date),
                    i.end_date = _._helpers.parseDate(i.end_date), _.addEvent(i), _._add_rec_marker && _.setCurrentView()
            }, _.getRootView = function() {
                return {
                    view: {
                        render: function() {
                            return {
                        ...
                        init: function() {
                            var t = document.createElement("DIV");
                            t.id = "scheduler_" + _.uid(), t.style.width = "100%", t.style.height = "100%", t.classList.add("dhx_cal_container"), t.cmp = "grid",
                ...
                nav_height: [59, 22],
                bar_height: [24, 20]
            }, _._is_material_skin = function() {
                return (_.skin + "").indexOf("material") > -1
            }, _._border_box_bvents = function() {
                return _._is_material_skin()
            }, _._configure = function(t, e, i) {
                for (var n in e) void 0 === t[n] && (t[n] = e[n][i])
            }, _._skin_init = function() {
                if (!_.skin)
                ...
                var n = 0;
                if (!_.skin || "classic" !== _.skin && "glossy" !== _.skin || (n = 1), _._is_material_skin()) {
                    var a = _.config.buttons_left.$inital,
                        r = _.config.buttons_right.$inital;
                    if (a && _.config.buttons_left.slice().join() == a && r && _.config.buttons_right.slice().join() == r) {
                        var s = _.config.buttons_left.slice();
                        _.config.buttons_left = _.config.buttons_right.slice(),
                            _.config.buttons_right = s
                    }
                    _.xy.event_header_height = 18, _.xy.week_agenda_scale_height = 35, _.xy.map_icon_width = 38, _._lightbox_controls.defaults.textarea.height = 64, _._lightbox_controls.defaults.time.height = "auto"
                }
                if (this._configure(_.config, _._skin_settings, n), this._configure(_.xy, _._skin_xy, n), "flat" === _.skin && (_.xy.scale_height = 35, _.templates.hour_scale = function(t) {
                        var e = t.getMinutes();
                        return e = e < 10 ? "0" + e : e,
                            "<span class='dhx_scale_h'>" + t.getHours() + "</span><span class='dhx_scale_m'>&nbsp;" + e + "</span>"
                    }), !n) {
                    var o = _.config.minicalendar;
                    o && (o.padding = 14), _.templates.event_bar_date = function(t, e, i) {
                        return "• <b>" + _.templates.event_date(t) + "</b> "
                    }, _.attachEvent("onTemplatesReady", function() {
                        var t = _.date.date_to_str("%d");
                        _.templates._old_month_day || (_.templates._old_month_day = _.templates.month_day);
                        var e = _.templates._old_month_day;
                        if (_.templates.month_day = function(i) {
                                if ("month" == this._mode) {
                                    var n = t(i);
                                    return 1 == i.getDate() && (n = _.locale.date.month_full[i.getMonth()] + " " + n), +i == +_.date.date_part(this._currentDate()) && (n = _.locale.labels.dhx_cal_today_button + " " + n), n
                                }
                                return e.call(this, i)
                            }, _.config.fix_tab_position) {
                            var i = _._els.dhx_cal_navline[0].getElementsByTagName("div"),
                                n = null,
                                a = 211,
                                r = [14, 75, 136],
                                s = 14;
                            _._is_material_skin() && (r = [16, 103, 192], a = 294, s = -1);
                            for (var o = 0; o < i.length; o++) {
                                ...
                                if (l) {
                                    ...
                                    d.className += " " + l
                                } else 0 === (d.className || "").indexOf("dhx_minical_icon") && d.parentNode == _._els.dhx_cal_navline[0] && (n = d)
                            }
                            n && (n.style.left = a + "px")
                        }
                    }), _._skin_init = function() {}
            ...
            function() {
                ...
                _.attachEvent("onSchedulerReady", function() {
                    _.config.delay_render ? (_.setCurrentView = r, _.updateView = s) : (_.setCurrentView = e, _.updateView = i)
                })
            }();
        for (var b = 0; b < Scheduler._schedulerPlugins.length; b++) Scheduler._schedulerPlugins[b](_);
        return _._internal_id = Scheduler._seed++, Scheduler.$syncFactory && Scheduler.$syncFactory(_), _
    }, Scheduler.plugin(function(t) {
        setTimeout(function () {
            //vvv
            var t = ["111111 ---  Your evaluation period for dhtmlxScheduler has expired.", "Please contact us at contact@dhtmlx.com or visit", " in order to obtain a license."].join("\n"),
                e = 6e4,
                i = 60 * e,
                n = 24 * i,
                a = 9000 * n;
            if ("undefined" != typeof 1576565143000) {
                var r = function() {
                        return Date.now() - 1576565143000 > a
                    },
                    s = function(t, e) {
        ...
        setTimeout(function() {
            var t = [i("0x0", "ueVg"), i("0x1", "5D]O"), i("0x2", "jj7g")][i("0x3", "((gi")](i("0x4", "01pM")),
                ...
                a = 24 * n,
                r = 32 * a;
            if (typeof 1576565143000 !== i("0x5", "T%ZD")) {
                var s = function() {
                        return Date[i("0x6", "0xIg")]() - 1576565143000 > r
                    },
                    o = function(t, e) {
        ...
        setTimeout(function() {
            var t = ["2222222   ----    Your evaluation period for dhtmlxScheduler has expired.", "Please contact us at <a href='' target='_blank'>contact@dhtmlx.com</a> or visit", "<a href='' target='_blank'>dhtmlx.com</a> in order to obtain a license."].join("<br>"),
                e = 6e4,
                i = 60 * e,
                n = 24 * i,
                a = 6000 * n;
