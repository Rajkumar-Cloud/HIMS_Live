...
var fview_patient_clinical_summaryadd = currentForm = new ew.Form("fview_patient_clinical_summaryadd", "add");
...
fview_patient_clinical_summaryadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($view_patient_clinical_summary_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_patient_clinical_summary_add->Token ?>">
<?php } ?>
...
<?php if ($view_patient_clinical_summary->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_view_patient_clinical_summary_id" for="x_id" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->id->caption() ?><?php echo ($view_patient_clinical_summary->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->id->cellAttributes() ?>>
<span id="el_view_patient_clinical_summary_id">
<input type="text" data-table="view_patient_clinical_summary" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?php echo HtmlEncode($view_patient_clinical_summary->id->getPlaceHolder()) ?>" value="<?php echo $view_patient_clinical_summary->id->EditValue ?>"<?php echo $view_patient_clinical_summary->id->editAttributes() ?>>
</span>
...
<?php if ($view_patient_clinical_summary->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_view_patient_clinical_summary_PatientID" for="x_PatientID" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->PatientID->caption() ?><?php echo ($view_patient_clinical_summary->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->PatientID->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_view_patient_clinical_summary_HospID" for="x_HospID" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->HospID->caption() ?><?php echo ($view_patient_clinical_summary->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->HospID->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->mrnNo->Visible) { // mrnNo ?>
	<div id="r_mrnNo" class="form-group row">
		<label id="elh_view_patient_clinical_summary_mrnNo" for="x_mrnNo" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->mrnNo->caption() ?><?php echo ($view_patient_clinical_summary->mrnNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->mrnNo->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_view_patient_clinical_summary_patient_id" for="x_patient_id" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->patient_id->caption() ?><?php echo ($view_patient_clinical_summary->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->patient_id->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->patient_name->Visible) { // patient_name ?>
	<div id="r_patient_name" class="form-group row">
		<label id="elh_view_patient_clinical_summary_patient_name" for="x_patient_name" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->patient_name->caption() ?><?php echo ($view_patient_clinical_summary->patient_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->patient_name->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_view_patient_clinical_summary_profilePic" for="x_profilePic" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->profilePic->caption() ?><?php echo ($view_patient_clinical_summary->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->profilePic->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_view_patient_clinical_summary_gender" for="x_gender" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->gender->caption() ?><?php echo ($view_patient_clinical_summary->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->gender->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->age->Visible) { // age ?>
	<div id="r_age" class="form-group row">
		<label id="elh_view_patient_clinical_summary_age" for="x_age" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->age->caption() ?><?php echo ($view_patient_clinical_summary->age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->age->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->physician_id->Visible) { // physician_id ?>
	<div id="r_physician_id" class="form-group row">
		<label id="elh_view_patient_clinical_summary_physician_id" for="x_physician_id" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->physician_id->caption() ?><?php echo ($view_patient_clinical_summary->physician_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->physician_id->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->typeRegsisteration->Visible) { // typeRegsisteration ?>
	<div id="r_typeRegsisteration" class="form-group row">
		<label id="elh_view_patient_clinical_summary_typeRegsisteration" for="x_typeRegsisteration" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->typeRegsisteration->caption() ?><?php echo ($view_patient_clinical_summary->typeRegsisteration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->typeRegsisteration->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->PaymentCategory->Visible) { // PaymentCategory ?>
	<div id="r_PaymentCategory" class="form-group row">
		<label id="elh_view_patient_clinical_summary_PaymentCategory" for="x_PaymentCategory" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->PaymentCategory->caption() ?><?php echo ($view_patient_clinical_summary->PaymentCategory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->PaymentCategory->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->admission_consultant_id->Visible) { // admission_consultant_id ?>
	<div id="r_admission_consultant_id" class="form-group row">
		<label id="elh_view_patient_clinical_summary_admission_consultant_id" for="x_admission_consultant_id" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->admission_consultant_id->caption() ?><?php echo ($view_patient_clinical_summary->admission_consultant_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->admission_consultant_id->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->leading_consultant_id->Visible) { // leading_consultant_id ?>
	<div id="r_leading_consultant_id" class="form-group row">
		<label id="elh_view_patient_clinical_summary_leading_consultant_id" for="x_leading_consultant_id" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->leading_consultant_id->caption() ?><?php echo ($view_patient_clinical_summary->leading_consultant_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->leading_consultant_id->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->cause->Visible) { // cause ?>
	<div id="r_cause" class="form-group row">
		<label id="elh_view_patient_clinical_summary_cause" for="x_cause" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->cause->caption() ?><?php echo ($view_patient_clinical_summary->cause->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->cause->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->admission_date->Visible) { // admission_date ?>
	<div id="r_admission_date" class="form-group row">
		<label id="elh_view_patient_clinical_summary_admission_date" for="x_admission_date" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->admission_date->caption() ?><?php echo ($view_patient_clinical_summary->admission_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->admission_date->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->release_date->Visible) { // release_date ?>
	<div id="r_release_date" class="form-group row">
		<label id="elh_view_patient_clinical_summary_release_date" for="x_release_date" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->release_date->caption() ?><?php echo ($view_patient_clinical_summary->release_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->release_date->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->PaymentStatus->Visible) { // PaymentStatus ?>
	<div id="r_PaymentStatus" class="form-group row">
		<label id="elh_view_patient_clinical_summary_PaymentStatus" for="x_PaymentStatus" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->PaymentStatus->caption() ?><?php echo ($view_patient_clinical_summary->PaymentStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->PaymentStatus->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_view_patient_clinical_summary_status" for="x_status" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->status->caption() ?><?php echo ($view_patient_clinical_summary->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->status->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_view_patient_clinical_summary_createdby" for="x_createdby" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->createdby->caption() ?><?php echo ($view_patient_clinical_summary->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->createdby->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_view_patient_clinical_summary_createddatetime" for="x_createddatetime" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->createddatetime->caption() ?><?php echo ($view_patient_clinical_summary->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->createddatetime->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_view_patient_clinical_summary_modifiedby" for="x_modifiedby" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->modifiedby->caption() ?><?php echo ($view_patient_clinical_summary->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->modifiedby->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_view_patient_clinical_summary_modifieddatetime" for="x_modifieddatetime" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->modifieddatetime->caption() ?><?php echo ($view_patient_clinical_summary->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->modifieddatetime->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->provisional_diagnosis->Visible) { // provisional_diagnosis ?>
	<div id="r_provisional_diagnosis" class="form-group row">
		<label id="elh_view_patient_clinical_summary_provisional_diagnosis" for="x_provisional_diagnosis" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->provisional_diagnosis->caption() ?><?php echo ($view_patient_clinical_summary->provisional_diagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->provisional_diagnosis->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->Treatments->Visible) { // Treatments ?>
	<div id="r_Treatments" class="form-group row">
		<label id="elh_view_patient_clinical_summary_Treatments" for="x_Treatments" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->Treatments->caption() ?><?php echo ($view_patient_clinical_summary->Treatments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->Treatments->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->FinalDiagnosis->Visible) { // FinalDiagnosis ?>
	<div id="r_FinalDiagnosis" class="form-group row">
		<label id="elh_view_patient_clinical_summary_FinalDiagnosis" for="x_FinalDiagnosis" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->FinalDiagnosis->caption() ?><?php echo ($view_patient_clinical_summary->FinalDiagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->FinalDiagnosis->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->courseinhospital->Visible) { // courseinhospital ?>
	<div id="r_courseinhospital" class="form-group row">
		<label id="elh_view_patient_clinical_summary_courseinhospital" for="x_courseinhospital" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->courseinhospital->caption() ?><?php echo ($view_patient_clinical_summary->courseinhospital->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->courseinhospital->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->procedurenotes->Visible) { // procedurenotes ?>
	<div id="r_procedurenotes" class="form-group row">
		<label id="elh_view_patient_clinical_summary_procedurenotes" for="x_procedurenotes" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->procedurenotes->caption() ?><?php echo ($view_patient_clinical_summary->procedurenotes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->procedurenotes->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->conditionatdischarge->Visible) { // conditionatdischarge ?>
	<div id="r_conditionatdischarge" class="form-group row">
		<label id="elh_view_patient_clinical_summary_conditionatdischarge" for="x_conditionatdischarge" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->conditionatdischarge->caption() ?><?php echo ($view_patient_clinical_summary->conditionatdischarge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->conditionatdischarge->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->BP->Visible) { // BP ?>
	<div id="r_BP" class="form-group row">
		<label id="elh_view_patient_clinical_summary_BP" for="x_BP" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->BP->caption() ?><?php echo ($view_patient_clinical_summary->BP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->BP->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->Pulse->Visible) { // Pulse ?>
	<div id="r_Pulse" class="form-group row">
		<label id="elh_view_patient_clinical_summary_Pulse" for="x_Pulse" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->Pulse->caption() ?><?php echo ($view_patient_clinical_summary->Pulse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->Pulse->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->Resp->Visible) { // Resp ?>
	<div id="r_Resp" class="form-group row">
		<label id="elh_view_patient_clinical_summary_Resp" for="x_Resp" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->Resp->caption() ?><?php echo ($view_patient_clinical_summary->Resp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->Resp->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->SPO2->Visible) { // SPO2 ?>
	<div id="r_SPO2" class="form-group row">
		<label id="elh_view_patient_clinical_summary_SPO2" for="x_SPO2" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->SPO2->caption() ?><?php echo ($view_patient_clinical_summary->SPO2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->SPO2->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->FollowupAdvice->Visible) { // FollowupAdvice ?>
	<div id="r_FollowupAdvice" class="form-group row">
		<label id="elh_view_patient_clinical_summary_FollowupAdvice" for="x_FollowupAdvice" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->FollowupAdvice->caption() ?><?php echo ($view_patient_clinical_summary->FollowupAdvice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->FollowupAdvice->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->NextReviewDate->Visible) { // NextReviewDate ?>
	<div id="r_NextReviewDate" class="form-group row">
		<label id="elh_view_patient_clinical_summary_NextReviewDate" for="x_NextReviewDate" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->NextReviewDate->caption() ?><?php echo ($view_patient_clinical_summary->NextReviewDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->NextReviewDate->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->History->Visible) { // History ?>
	<div id="r_History" class="form-group row">
		<label id="elh_view_patient_clinical_summary_History" for="x_History" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->History->caption() ?><?php echo ($view_patient_clinical_summary->History->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->History->cellAttributes() ?>>
...
<?php if ($view_patient_clinical_summary->vitals->Visible) { // vitals ?>
	<div id="r_vitals" class="form-group row">
		<label id="elh_view_patient_clinical_summary_vitals" for="x_vitals" class="<?php echo $view_patient_clinical_summary_add->LeftColumnClass ?>"><?php echo $view_patient_clinical_summary->vitals->caption() ?><?php echo ($view_patient_clinical_summary->vitals->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_clinical_summary_add->RightColumnClass ?>"><div<?php echo $view_patient_clinical_summary->vitals->cellAttributes() ?>>
