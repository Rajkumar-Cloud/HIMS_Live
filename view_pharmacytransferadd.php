...
var fview_pharmacytransferadd = currentForm = new ew.Form("fview_pharmacytransferadd", "add");
...
fview_pharmacytransferadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_pharmacytransferadd.lists["x_ORDNO"] = <?php echo $view_pharmacytransfer_add->ORDNO->Lookup->toClientList() ?>;
...
fview_pharmacytransferadd.lists["x_BRCODE"] = <?php echo $view_pharmacytransfer_add->BRCODE->Lookup->toClientList() ?>;
...
fview_pharmacytransferadd.lists["x_LastMonthSale"] = <?php echo $view_pharmacytransfer_add->LastMonthSale->Lookup->toClientList() ?>;
...
<?php if ($view_pharmacytransfer_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_pharmacytransfer_add->Token ?>">
<?php } ?>
...
<?php if ($view_pharmacytransfer->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_view_pharmacytransfer_BRCODE" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->BRCODE->caption() ?><?php echo ($view_pharmacytransfer->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->BRCODE->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_view_pharmacytransfer_PRC" for="x_PRC" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PRC->caption() ?><?php echo ($view_pharmacytransfer->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PRC->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->QTY->Visible) { // QTY ?>
	<div id="r_QTY" class="form-group row">
		<label id="elh_view_pharmacytransfer_QTY" for="x_QTY" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->QTY->caption() ?><?php echo ($view_pharmacytransfer->QTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->QTY->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_view_pharmacytransfer_DT" for="x_DT" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->DT->caption() ?><?php echo ($view_pharmacytransfer->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->DT->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_view_pharmacytransfer_PC" for="x_PC" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PC->caption() ?><?php echo ($view_pharmacytransfer->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PC->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_view_pharmacytransfer_YM" for="x_YM" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->YM->caption() ?><?php echo ($view_pharmacytransfer->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->YM->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Stock->Visible) { // Stock ?>
	<div id="r_Stock" class="form-group row">
		<label id="elh_view_pharmacytransfer_Stock" for="x_Stock" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Stock->caption() ?><?php echo ($view_pharmacytransfer->Stock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Stock->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Printcheck->Visible) { // Printcheck ?>
	<div id="r_Printcheck" class="form-group row">
		<label id="elh_view_pharmacytransfer_Printcheck" for="x_Printcheck" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Printcheck->caption() ?><?php echo ($view_pharmacytransfer->Printcheck->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Printcheck->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->grnid->Visible) { // grnid ?>
	<div id="r_grnid" class="form-group row">
		<label id="elh_view_pharmacytransfer_grnid" for="x_grnid" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->grnid->caption() ?><?php echo ($view_pharmacytransfer->grnid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->grnid->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->poid->Visible) { // poid ?>
	<div id="r_poid" class="form-group row">
		<label id="elh_view_pharmacytransfer_poid" for="x_poid" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->poid->caption() ?><?php echo ($view_pharmacytransfer->poid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->poid->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->LastMonthSale->Visible) { // LastMonthSale ?>
	<div id="r_LastMonthSale" class="form-group row">
		<label id="elh_view_pharmacytransfer_LastMonthSale" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->LastMonthSale->caption() ?><?php echo ($view_pharmacytransfer->LastMonthSale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->LastMonthSale->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_view_pharmacytransfer_PrName" for="x_PrName" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PrName->caption() ?><?php echo ($view_pharmacytransfer->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PrName->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->GrnQuantity->Visible) { // GrnQuantity ?>
	<div id="r_GrnQuantity" class="form-group row">
		<label id="elh_view_pharmacytransfer_GrnQuantity" for="x_GrnQuantity" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->GrnQuantity->caption() ?><?php echo ($view_pharmacytransfer->GrnQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->GrnQuantity->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_view_pharmacytransfer_Quantity" for="x_Quantity" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Quantity->caption() ?><?php echo ($view_pharmacytransfer->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Quantity->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->FreeQty->Visible) { // FreeQty ?>
	<div id="r_FreeQty" class="form-group row">
		<label id="elh_view_pharmacytransfer_FreeQty" for="x_FreeQty" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->FreeQty->caption() ?><?php echo ($view_pharmacytransfer->FreeQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->FreeQty->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->BatchNo->Visible) { // BatchNo ?>
	<div id="r_BatchNo" class="form-group row">
		<label id="elh_view_pharmacytransfer_BatchNo" for="x_BatchNo" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->BatchNo->caption() ?><?php echo ($view_pharmacytransfer->BatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->BatchNo->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->ExpDate->Visible) { // ExpDate ?>
	<div id="r_ExpDate" class="form-group row">
		<label id="elh_view_pharmacytransfer_ExpDate" for="x_ExpDate" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->ExpDate->caption() ?><?php echo ($view_pharmacytransfer->ExpDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->ExpDate->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->HSN->Visible) { // HSN ?>
	<div id="r_HSN" class="form-group row">
		<label id="elh_view_pharmacytransfer_HSN" for="x_HSN" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->HSN->caption() ?><?php echo ($view_pharmacytransfer->HSN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->HSN->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_view_pharmacytransfer_MFRCODE" for="x_MFRCODE" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->MFRCODE->caption() ?><?php echo ($view_pharmacytransfer->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->MFRCODE->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_view_pharmacytransfer_PUnit" for="x_PUnit" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PUnit->caption() ?><?php echo ($view_pharmacytransfer->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PUnit->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_view_pharmacytransfer_SUnit" for="x_SUnit" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->SUnit->caption() ?><?php echo ($view_pharmacytransfer->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->SUnit->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_view_pharmacytransfer_MRP" for="x_MRP" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->MRP->caption() ?><?php echo ($view_pharmacytransfer->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->MRP->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_view_pharmacytransfer_PurValue" for="x_PurValue" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PurValue->caption() ?><?php echo ($view_pharmacytransfer->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PurValue->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Disc->Visible) { // Disc ?>
	<div id="r_Disc" class="form-group row">
		<label id="elh_view_pharmacytransfer_Disc" for="x_Disc" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Disc->caption() ?><?php echo ($view_pharmacytransfer->Disc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Disc->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_view_pharmacytransfer_PSGST" for="x_PSGST" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PSGST->caption() ?><?php echo ($view_pharmacytransfer->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PSGST->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_view_pharmacytransfer_PCGST" for="x_PCGST" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PCGST->caption() ?><?php echo ($view_pharmacytransfer->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PCGST->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PTax->Visible) { // PTax ?>
	<div id="r_PTax" class="form-group row">
		<label id="elh_view_pharmacytransfer_PTax" for="x_PTax" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PTax->caption() ?><?php echo ($view_pharmacytransfer->PTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PTax->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->ItemValue->Visible) { // ItemValue ?>
	<div id="r_ItemValue" class="form-group row">
		<label id="elh_view_pharmacytransfer_ItemValue" for="x_ItemValue" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->ItemValue->caption() ?><?php echo ($view_pharmacytransfer->ItemValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->ItemValue->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->SalTax->Visible) { // SalTax ?>
	<div id="r_SalTax" class="form-group row">
		<label id="elh_view_pharmacytransfer_SalTax" for="x_SalTax" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->SalTax->caption() ?><?php echo ($view_pharmacytransfer->SalTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->SalTax->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_view_pharmacytransfer_PurRate" for="x_PurRate" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->PurRate->caption() ?><?php echo ($view_pharmacytransfer->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->PurRate->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->SalRate->Visible) { // SalRate ?>
	<div id="r_SalRate" class="form-group row">
		<label id="elh_view_pharmacytransfer_SalRate" for="x_SalRate" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->SalRate->caption() ?><?php echo ($view_pharmacytransfer->SalRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->SalRate->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_view_pharmacytransfer_Discount" for="x_Discount" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Discount->caption() ?><?php echo ($view_pharmacytransfer->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Discount->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_view_pharmacytransfer_SSGST" for="x_SSGST" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->SSGST->caption() ?><?php echo ($view_pharmacytransfer->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->SSGST->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_view_pharmacytransfer_SCGST" for="x_SCGST" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->SCGST->caption() ?><?php echo ($view_pharmacytransfer->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->SCGST->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Pack->Visible) { // Pack ?>
	<div id="r_Pack" class="form-group row">
		<label id="elh_view_pharmacytransfer_Pack" for="x_Pack" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Pack->caption() ?><?php echo ($view_pharmacytransfer->Pack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Pack->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->GrnMRP->Visible) { // GrnMRP ?>
	<div id="r_GrnMRP" class="form-group row">
		<label id="elh_view_pharmacytransfer_GrnMRP" for="x_GrnMRP" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->GrnMRP->caption() ?><?php echo ($view_pharmacytransfer->GrnMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->GrnMRP->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->trid->Visible) { // trid ?>
	<div id="r_trid" class="form-group row">
		<label id="elh_view_pharmacytransfer_trid" for="x_trid" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->trid->caption() ?><?php echo ($view_pharmacytransfer->trid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->trid->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->CreatedBy->Visible) { // CreatedBy ?>
	<div id="r_CreatedBy" class="form-group row">
		<label id="elh_view_pharmacytransfer_CreatedBy" for="x_CreatedBy" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->CreatedBy->caption() ?><?php echo ($view_pharmacytransfer->CreatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->CreatedBy->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->CreatedDateTime->Visible) { // CreatedDateTime ?>
	<div id="r_CreatedDateTime" class="form-group row">
		<label id="elh_view_pharmacytransfer_CreatedDateTime" for="x_CreatedDateTime" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->CreatedDateTime->caption() ?><?php echo ($view_pharmacytransfer->CreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->CreatedDateTime->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->ModifiedBy->Visible) { // ModifiedBy ?>
	<div id="r_ModifiedBy" class="form-group row">
		<label id="elh_view_pharmacytransfer_ModifiedBy" for="x_ModifiedBy" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->ModifiedBy->caption() ?><?php echo ($view_pharmacytransfer->ModifiedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->ModifiedBy->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
	<div id="r_ModifiedDateTime" class="form-group row">
		<label id="elh_view_pharmacytransfer_ModifiedDateTime" for="x_ModifiedDateTime" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->ModifiedDateTime->caption() ?><?php echo ($view_pharmacytransfer->ModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->ModifiedDateTime->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->Received->Visible) { // Received ?>
	<div id="r_Received" class="form-group row">
		<label id="elh_view_pharmacytransfer_Received" for="x_Received" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->Received->caption() ?><?php echo ($view_pharmacytransfer->Received->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->Received->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->BillDate->Visible) { // BillDate ?>
	<div id="r_BillDate" class="form-group row">
		<label id="elh_view_pharmacytransfer_BillDate" for="x_BillDate" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->BillDate->caption() ?><?php echo ($view_pharmacytransfer->BillDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->BillDate->cellAttributes() ?>>
...
<?php if ($view_pharmacytransfer->CurStock->Visible) { // CurStock ?>
	<div id="r_CurStock" class="form-group row">
		<label id="elh_view_pharmacytransfer_CurStock" for="x_CurStock" class="<?php echo $view_pharmacytransfer_add->LeftColumnClass ?>"><?php echo $view_pharmacytransfer->CurStock->caption() ?><?php echo ($view_pharmacytransfer->CurStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacytransfer_add->RightColumnClass ?>"><div<?php echo $view_pharmacytransfer->CurStock->cellAttributes() ?>>
