...
var femployee_has_degreeadd = currentForm = new ew.Form("femployee_has_degreeadd", "add");
...
femployee_has_degreeadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_has_degree_add->createdby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_has_degree->createdby->caption(), $employee_has_degree->createdby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_has_degree_add->createddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_createddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_has_degree->createddatetime->caption(), $employee_has_degree->createddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_has_degree_add->HospID->Required) { ?>
...
femployee_has_degreeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_has_degreeadd.lists["x_degree_id"] = <?php echo $employee_has_degree_add->degree_id->Lookup->toClientList() ?>;
femployee_has_degreeadd.lists["x_degree_id"].options = <?php echo JsonEncode($employee_has_degree_add->degree_id->lookupOptions()) ?>;
femployee_has_degreeadd.lists["x_status"] = <?php echo $employee_has_degree_add->status->Lookup->toClientList() ?>;
...
<?php if ($employee_has_degree_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_has_degree_add->Token ?>">
<?php } ?>
...
<?php if ($employee_has_degree->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group row">
		<label id="elh_employee_has_degree_employee_id" for="x_employee_id" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->employee_id->caption() ?><?php echo ($employee_has_degree->employee_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->employee_id->cellAttributes() ?>>
...
<?php if ($employee_has_degree->degree_id->Visible) { // degree_id ?>
	<div id="r_degree_id" class="form-group row">
		<label id="elh_employee_has_degree_degree_id" for="x_degree_id" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->degree_id->caption() ?><?php echo ($employee_has_degree->degree_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->degree_id->cellAttributes() ?>>
...
<?php if ($employee_has_degree->college_or_school->Visible) { // college_or_school ?>
	<div id="r_college_or_school" class="form-group row">
		<label id="elh_employee_has_degree_college_or_school" for="x_college_or_school" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->college_or_school->caption() ?><?php echo ($employee_has_degree->college_or_school->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->college_or_school->cellAttributes() ?>>
...
<?php if ($employee_has_degree->university_or_board->Visible) { // university_or_board ?>
	<div id="r_university_or_board" class="form-group row">
		<label id="elh_employee_has_degree_university_or_board" for="x_university_or_board" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->university_or_board->caption() ?><?php echo ($employee_has_degree->university_or_board->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->university_or_board->cellAttributes() ?>>
...
<?php if ($employee_has_degree->year_of_passing->Visible) { // year_of_passing ?>
	<div id="r_year_of_passing" class="form-group row">
		<label id="elh_employee_has_degree_year_of_passing" for="x_year_of_passing" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->year_of_passing->caption() ?><?php echo ($employee_has_degree->year_of_passing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->year_of_passing->cellAttributes() ?>>
...
<?php if ($employee_has_degree->scoring_marks->Visible) { // scoring_marks ?>
	<div id="r_scoring_marks" class="form-group row">
		<label id="elh_employee_has_degree_scoring_marks" for="x_scoring_marks" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->scoring_marks->caption() ?><?php echo ($employee_has_degree->scoring_marks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->scoring_marks->cellAttributes() ?>>
...
<?php if ($employee_has_degree->certificates->Visible) { // certificates ?>
	<div id="r_certificates" class="form-group row">
		<label id="elh_employee_has_degree_certificates" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->certificates->caption() ?><?php echo ($employee_has_degree->certificates->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->certificates->cellAttributes() ?>>
...
<?php if ($employee_has_degree->others->Visible) { // others ?>
	<div id="r_others" class="form-group row">
		<label id="elh_employee_has_degree_others" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->others->caption() ?><?php echo ($employee_has_degree->others->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->others->cellAttributes() ?>>
...
<?php if ($employee_has_degree->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_has_degree_status" for="x_status" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->status->caption() ?><?php echo ($employee_has_degree->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->status->cellAttributes() ?>>
...
<?php if ($employee_has_degree->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_employee_has_degree_HospID" for="x_HospID" class="<?php echo $employee_has_degree_add->LeftColumnClass ?>"><?php echo $employee_has_degree->HospID->caption() ?><?php echo ($employee_has_degree->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_has_degree_add->RightColumnClass ?>"><div<?php echo $employee_has_degree->HospID->cellAttributes() ?>>
