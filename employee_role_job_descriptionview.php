...
var femployee_role_job_descriptionview = currentForm = new ew.Form("femployee_role_job_descriptionview", "view");

// Form_CustomValidate event
femployee_role_job_descriptionview.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_role_job_descriptionview.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($employee_role_job_description_view->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_role_job_description_view->Token ?>">
<?php } ?>
...
<?php if ($employee_role_job_description->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_id"><?php echo $employee_role_job_description->id->caption() ?></span></td>
...
<?php if ($employee_role_job_description->role->Visible) { // role ?>
	<tr id="r_role">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_role"><?php echo $employee_role_job_description->role->caption() ?></span></td>
...
<?php if ($employee_role_job_description->job_description->Visible) { // job_description ?>
	<tr id="r_job_description">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_job_description"><?php echo $employee_role_job_description->job_description->caption() ?></span></td>
...
<?php if ($employee_role_job_description->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_status"><?php echo $employee_role_job_description->status->caption() ?></span></td>
...
<?php if ($employee_role_job_description->createdby->Visible) { // createdby ?>
	<tr id="r_createdby">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_createdby"><?php echo $employee_role_job_description->createdby->caption() ?></span></td>
...
<?php if ($employee_role_job_description->createddatetime->Visible) { // createddatetime ?>
	<tr id="r_createddatetime">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_createddatetime"><?php echo $employee_role_job_description->createddatetime->caption() ?></span></td>
...
<?php if ($employee_role_job_description->modifiedby->Visible) { // modifiedby ?>
	<tr id="r_modifiedby">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_modifiedby"><?php echo $employee_role_job_description->modifiedby->caption() ?></span></td>
...
<?php if ($employee_role_job_description->modifieddatetime->Visible) { // modifieddatetime ?>
	<tr id="r_modifieddatetime">
		<td class="<?php echo $employee_role_job_description_view->TableLeftColumnClass ?>"><span id="elh_employee_role_job_description_modifieddatetime"><?php echo $employee_role_job_description->modifieddatetime->caption() ?></span></td>
