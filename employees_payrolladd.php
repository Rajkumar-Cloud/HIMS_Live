...
// Create page object
$employees_payroll_add = new employees_payroll_add();

// Run the page
$employees_payroll_add->run();
...
$employees_payroll_add->Page_Render();
?>
...
var femployees_payrolladd = currentForm = new ew.Form("femployees_payrolladd", "add");

// Validate form
femployees_payrolladd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employees_payroll_add->employee->Required) { ?>
		...
		<?php if ($employees_payroll_add->pay_frequency->Required) { ?>
		...
		<?php if ($employees_payroll_add->currency->Required) { ?>
		...
		<?php if ($employees_payroll_add->deduction_exemptions->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_payroll_add->deduction_allowed->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_payroll_add->deduction_group->Required) { ?>
...
femployees_payrolladd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployees_payrolladd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $employees_payroll_add->showPageHeader(); ?>
<?php
$employees_payroll_add->showMessage();
?>
<form name="femployees_payrolladd" id="femployees_payrolladd" class="<?php echo $employees_payroll_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employees_payroll_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employees_payroll_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employees_payroll">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$employees_payroll_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($employees_payroll->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employees_payroll_employee" for="x_employee" class="<?php echo $employees_payroll_add->LeftColumnClass ?>"><?php echo $employees_payroll->employee->caption() ?><?php echo ($employees_payroll->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_payroll_add->RightColumnClass ?>"><div<?php echo $employees_payroll->employee->cellAttributes() ?>>
...
<?php if ($employees_payroll->pay_frequency->Visible) { // pay_frequency ?>
	<div id="r_pay_frequency" class="form-group row">
		<label id="elh_employees_payroll_pay_frequency" for="x_pay_frequency" class="<?php echo $employees_payroll_add->LeftColumnClass ?>"><?php echo $employees_payroll->pay_frequency->caption() ?><?php echo ($employees_payroll->pay_frequency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_payroll_add->RightColumnClass ?>"><div<?php echo $employees_payroll->pay_frequency->cellAttributes() ?>>
...
<?php if ($employees_payroll->currency->Visible) { // currency ?>
	<div id="r_currency" class="form-group row">
		<label id="elh_employees_payroll_currency" for="x_currency" class="<?php echo $employees_payroll_add->LeftColumnClass ?>"><?php echo $employees_payroll->currency->caption() ?><?php echo ($employees_payroll->currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_payroll_add->RightColumnClass ?>"><div<?php echo $employees_payroll->currency->cellAttributes() ?>>
...
<?php if ($employees_payroll->deduction_exemptions->Visible) { // deduction_exemptions ?>
	<div id="r_deduction_exemptions" class="form-group row">
		<label id="elh_employees_payroll_deduction_exemptions" for="x_deduction_exemptions" class="<?php echo $employees_payroll_add->LeftColumnClass ?>"><?php echo $employees_payroll->deduction_exemptions->caption() ?><?php echo ($employees_payroll->deduction_exemptions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_payroll_add->RightColumnClass ?>"><div<?php echo $employees_payroll->deduction_exemptions->cellAttributes() ?>>
...
<?php if ($employees_payroll->deduction_allowed->Visible) { // deduction_allowed ?>
	<div id="r_deduction_allowed" class="form-group row">
		<label id="elh_employees_payroll_deduction_allowed" for="x_deduction_allowed" class="<?php echo $employees_payroll_add->LeftColumnClass ?>"><?php echo $employees_payroll->deduction_allowed->caption() ?><?php echo ($employees_payroll->deduction_allowed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_payroll_add->RightColumnClass ?>"><div<?php echo $employees_payroll->deduction_allowed->cellAttributes() ?>>
...
<?php if ($employees_payroll->deduction_group->Visible) { // deduction_group ?>
	<div id="r_deduction_group" class="form-group row">
		<label id="elh_employees_payroll_deduction_group" for="x_deduction_group" class="<?php echo $employees_payroll_add->LeftColumnClass ?>"><?php echo $employees_payroll->deduction_group->caption() ?><?php echo ($employees_payroll->deduction_group->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_payroll_add->RightColumnClass ?>"><div<?php echo $employees_payroll->deduction_group->cellAttributes() ?>>
...
<?php if (!$employees_payroll_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employees_payroll_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employees_payroll_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employees_payroll_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employees_payroll_add->terminate();
?>