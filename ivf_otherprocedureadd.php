...
var fivf_otherprocedureadd = currentForm = new ew.Form("fivf_otherprocedureadd", "add");
...
fivf_otherprocedureadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_otherprocedureadd.lists["x_Name"] = <?php echo $ivf_otherprocedure_add->Name->Lookup->toClientList() ?>;
...
fivf_otherprocedureadd.lists["x_Consultant"] = <?php echo $ivf_otherprocedure_add->Consultant->Lookup->toClientList() ?>;
fivf_otherprocedureadd.lists["x_Consultant"].options = <?php echo JsonEncode($ivf_otherprocedure_add->Consultant->lookupOptions()) ?>;
fivf_otherprocedureadd.lists["x_Surgeon"] = <?php echo $ivf_otherprocedure_add->Surgeon->Lookup->toClientList() ?>;
fivf_otherprocedureadd.lists["x_Surgeon"].options = <?php echo JsonEncode($ivf_otherprocedure_add->Surgeon->lookupOptions()) ?>;
fivf_otherprocedureadd.lists["x_Anesthetist"] = <?php echo $ivf_otherprocedure_add->Anesthetist->Lookup->toClientList() ?>;
fivf_otherprocedureadd.lists["x_Anesthetist"].options = <?php echo JsonEncode($ivf_otherprocedure_add->Anesthetist->lookupOptions()) ?>;
fivf_otherprocedureadd.lists["x_TempleteFinalDiagnosis"] = <?php echo $ivf_otherprocedure_add->TempleteFinalDiagnosis->Lookup->toClientList() ?>;
...
fivf_otherprocedureadd.lists["x_TemplateTreatment"] = <?php echo $ivf_otherprocedure_add->TemplateTreatment->Lookup->toClientList() ?>;
...
fivf_otherprocedureadd.lists["x_TemplateOperation"] = <?php echo $ivf_otherprocedure_add->TemplateOperation->Lookup->toClientList() ?>;
...
fivf_otherprocedureadd.lists["x_TemplateFollowUpAdvice"] = <?php echo $ivf_otherprocedure_add->TemplateFollowUpAdvice->Lookup->toClientList() ?>;
...
fivf_otherprocedureadd.lists["x_TemplateFollowUpMedication"] = <?php echo $ivf_otherprocedure_add->TemplateFollowUpMedication->Lookup->toClientList() ?>;
...
fivf_otherprocedureadd.lists["x_TemplatePlan"] = <?php echo $ivf_otherprocedure_add->TemplatePlan->Lookup->toClientList() ?>;
...
<?php if ($ivf_otherprocedure_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_otherprocedure_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_otherprocedure->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_ivf_otherprocedure_RIDNO" for="x_RIDNO" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_RIDNO" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->RIDNO->caption() ?><?php echo ($ivf_otherprocedure->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->RIDNO->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_RIDNO" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_otherprocedure_Name" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Name" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Name->caption() ?><?php echo ($ivf_otherprocedure->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Name->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Name" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_ivf_otherprocedure_Age" for="x_Age" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Age" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Age->caption() ?><?php echo ($ivf_otherprocedure->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Age->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Age" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->SEX->Visible) { // SEX ?>
	<div id="r_SEX" class="form-group row">
		<label id="elh_ivf_otherprocedure_SEX" for="x_SEX" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_SEX" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->SEX->caption() ?><?php echo ($ivf_otherprocedure->SEX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->SEX->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_SEX" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group row">
		<label id="elh_ivf_otherprocedure_Address" for="x_Address" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Address" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Address->caption() ?><?php echo ($ivf_otherprocedure->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Address->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Address" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->DateofAdmission->Visible) { // DateofAdmission ?>
	<div id="r_DateofAdmission" class="form-group row">
		<label id="elh_ivf_otherprocedure_DateofAdmission" for="x_DateofAdmission" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_DateofAdmission" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->DateofAdmission->caption() ?><?php echo ($ivf_otherprocedure->DateofAdmission->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->DateofAdmission->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_DateofAdmission" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->DateofProcedure->Visible) { // DateofProcedure ?>
	<div id="r_DateofProcedure" class="form-group row">
		<label id="elh_ivf_otherprocedure_DateofProcedure" for="x_DateofProcedure" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_DateofProcedure" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->DateofProcedure->caption() ?><?php echo ($ivf_otherprocedure->DateofProcedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->DateofProcedure->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_DateofProcedure" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->DateofDischarge->Visible) { // DateofDischarge ?>
	<div id="r_DateofDischarge" class="form-group row">
		<label id="elh_ivf_otherprocedure_DateofDischarge" for="x_DateofDischarge" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_DateofDischarge" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->DateofDischarge->caption() ?><?php echo ($ivf_otherprocedure->DateofDischarge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->DateofDischarge->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_DateofDischarge" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Consultant->Visible) { // Consultant ?>
	<div id="r_Consultant" class="form-group row">
		<label id="elh_ivf_otherprocedure_Consultant" for="x_Consultant" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Consultant" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Consultant->caption() ?><?php echo ($ivf_otherprocedure->Consultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Consultant->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Consultant" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Surgeon->Visible) { // Surgeon ?>
	<div id="r_Surgeon" class="form-group row">
		<label id="elh_ivf_otherprocedure_Surgeon" for="x_Surgeon" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Surgeon" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Surgeon->caption() ?><?php echo ($ivf_otherprocedure->Surgeon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Surgeon->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Surgeon" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Anesthetist->Visible) { // Anesthetist ?>
	<div id="r_Anesthetist" class="form-group row">
		<label id="elh_ivf_otherprocedure_Anesthetist" for="x_Anesthetist" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Anesthetist" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Anesthetist->caption() ?><?php echo ($ivf_otherprocedure->Anesthetist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Anesthetist->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Anesthetist" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->IdentificationMark->Visible) { // IdentificationMark ?>
	<div id="r_IdentificationMark" class="form-group row">
		<label id="elh_ivf_otherprocedure_IdentificationMark" for="x_IdentificationMark" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_IdentificationMark" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->IdentificationMark->caption() ?><?php echo ($ivf_otherprocedure->IdentificationMark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->IdentificationMark->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_IdentificationMark" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->ProcedureDone->Visible) { // ProcedureDone ?>
	<div id="r_ProcedureDone" class="form-group row">
		<label id="elh_ivf_otherprocedure_ProcedureDone" for="x_ProcedureDone" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_ProcedureDone" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->ProcedureDone->caption() ?><?php echo ($ivf_otherprocedure->ProcedureDone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->ProcedureDone->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_ProcedureDone" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->PROVISIONALDIAGNOSIS->Visible) { // PROVISIONALDIAGNOSIS ?>
	<div id="r_PROVISIONALDIAGNOSIS" class="form-group row">
		<label id="elh_ivf_otherprocedure_PROVISIONALDIAGNOSIS" for="x_PROVISIONALDIAGNOSIS" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_PROVISIONALDIAGNOSIS" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->PROVISIONALDIAGNOSIS->caption() ?><?php echo ($ivf_otherprocedure->PROVISIONALDIAGNOSIS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->PROVISIONALDIAGNOSIS->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_PROVISIONALDIAGNOSIS" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
	<div id="r_Chiefcomplaints" class="form-group row">
		<label id="elh_ivf_otherprocedure_Chiefcomplaints" for="x_Chiefcomplaints" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Chiefcomplaints" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Chiefcomplaints->caption() ?><?php echo ($ivf_otherprocedure->Chiefcomplaints->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Chiefcomplaints->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Chiefcomplaints" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->MaritallHistory->Visible) { // MaritallHistory ?>
	<div id="r_MaritallHistory" class="form-group row">
		<label id="elh_ivf_otherprocedure_MaritallHistory" for="x_MaritallHistory" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_MaritallHistory" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->MaritallHistory->caption() ?><?php echo ($ivf_otherprocedure->MaritallHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->MaritallHistory->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_MaritallHistory" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->MenstrualHistory->Visible) { // MenstrualHistory ?>
	<div id="r_MenstrualHistory" class="form-group row">
		<label id="elh_ivf_otherprocedure_MenstrualHistory" for="x_MenstrualHistory" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_MenstrualHistory" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->MenstrualHistory->caption() ?><?php echo ($ivf_otherprocedure->MenstrualHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->MenstrualHistory->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_MenstrualHistory" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->SurgicalHistory->Visible) { // SurgicalHistory ?>
	<div id="r_SurgicalHistory" class="form-group row">
		<label id="elh_ivf_otherprocedure_SurgicalHistory" for="x_SurgicalHistory" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_SurgicalHistory" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->SurgicalHistory->caption() ?><?php echo ($ivf_otherprocedure->SurgicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->SurgicalHistory->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_SurgicalHistory" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->PastHistory->Visible) { // PastHistory ?>
	<div id="r_PastHistory" class="form-group row">
		<label id="elh_ivf_otherprocedure_PastHistory" for="x_PastHistory" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_PastHistory" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->PastHistory->caption() ?><?php echo ($ivf_otherprocedure->PastHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->PastHistory->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_PastHistory" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->FamilyHistory->Visible) { // FamilyHistory ?>
	<div id="r_FamilyHistory" class="form-group row">
		<label id="elh_ivf_otherprocedure_FamilyHistory" for="x_FamilyHistory" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_FamilyHistory" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->FamilyHistory->caption() ?><?php echo ($ivf_otherprocedure->FamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->FamilyHistory->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_FamilyHistory" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Temp->Visible) { // Temp ?>
	<div id="r_Temp" class="form-group row">
		<label id="elh_ivf_otherprocedure_Temp" for="x_Temp" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Temp" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Temp->caption() ?><?php echo ($ivf_otherprocedure->Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Temp->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Temp" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->Pulse->Visible) { // Pulse ?>
	<div id="r_Pulse" class="form-group row">
		<label id="elh_ivf_otherprocedure_Pulse" for="x_Pulse" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Pulse" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Pulse->caption() ?><?php echo ($ivf_otherprocedure->Pulse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Pulse->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Pulse" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->BP->Visible) { // BP ?>
	<div id="r_BP" class="form-group row">
		<label id="elh_ivf_otherprocedure_BP" for="x_BP" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_BP" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->BP->caption() ?><?php echo ($ivf_otherprocedure->BP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->BP->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_BP" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->CNS->Visible) { // CNS ?>
	<div id="r_CNS" class="form-group row">
		<label id="elh_ivf_otherprocedure_CNS" for="x_CNS" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_CNS" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->CNS->caption() ?><?php echo ($ivf_otherprocedure->CNS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->CNS->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_CNS" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->_RS->Visible) { // RS ?>
	<div id="r__RS" class="form-group row">
		<label id="elh_ivf_otherprocedure__RS" for="x__RS" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure__RS" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->_RS->caption() ?><?php echo ($ivf_otherprocedure->_RS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->_RS->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure__RS" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->CVS->Visible) { // CVS ?>
	<div id="r_CVS" class="form-group row">
		<label id="elh_ivf_otherprocedure_CVS" for="x_CVS" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_CVS" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->CVS->caption() ?><?php echo ($ivf_otherprocedure->CVS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->CVS->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_CVS" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->PA->Visible) { // PA ?>
	<div id="r_PA" class="form-group row">
		<label id="elh_ivf_otherprocedure_PA" for="x_PA" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_PA" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->PA->caption() ?><?php echo ($ivf_otherprocedure->PA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->PA->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_PA" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->InvestigationReport->Visible) { // InvestigationReport ?>
	<div id="r_InvestigationReport" class="form-group row">
		<label id="elh_ivf_otherprocedure_InvestigationReport" for="x_InvestigationReport" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_InvestigationReport" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->InvestigationReport->caption() ?><?php echo ($ivf_otherprocedure->InvestigationReport->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->InvestigationReport->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_InvestigationReport" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->FinalDiagnosis->Visible) { // FinalDiagnosis ?>
	<div id="r_FinalDiagnosis" class="form-group row">
		<label id="elh_ivf_otherprocedure_FinalDiagnosis" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_FinalDiagnosis" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->FinalDiagnosis->caption() ?><?php echo ($ivf_otherprocedure->FinalDiagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->FinalDiagnosis->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_FinalDiagnosis" class="ivf_otherprocedureadd" type="text/html">
...
<script type="text/html" class="ivf_otherprocedureadd_js">
ew.createEditor("fivf_otherprocedureadd", "x_FinalDiagnosis", 0, 0, <?php echo ($ivf_otherprocedure->FinalDiagnosis->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_otherprocedure->Treatment->Visible) { // Treatment ?>
	<div id="r_Treatment" class="form-group row">
		<label id="elh_ivf_otherprocedure_Treatment" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Treatment" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Treatment->caption() ?><?php echo ($ivf_otherprocedure->Treatment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Treatment->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Treatment" class="ivf_otherprocedureadd" type="text/html">
...
<script type="text/html" class="ivf_otherprocedureadd_js">
ew.createEditor("fivf_otherprocedureadd", "x_Treatment", 35, 4, <?php echo ($ivf_otherprocedure->Treatment->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_otherprocedure->DetailOfOperation->Visible) { // DetailOfOperation ?>
	<div id="r_DetailOfOperation" class="form-group row">
		<label id="elh_ivf_otherprocedure_DetailOfOperation" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_DetailOfOperation" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->DetailOfOperation->caption() ?><?php echo ($ivf_otherprocedure->DetailOfOperation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->DetailOfOperation->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_DetailOfOperation" class="ivf_otherprocedureadd" type="text/html">
...
<script type="text/html" class="ivf_otherprocedureadd_js">
ew.createEditor("fivf_otherprocedureadd", "x_DetailOfOperation", 35, 4, <?php echo ($ivf_otherprocedure->DetailOfOperation->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_otherprocedure->FollowUpAdvice->Visible) { // FollowUpAdvice ?>
	<div id="r_FollowUpAdvice" class="form-group row">
		<label id="elh_ivf_otherprocedure_FollowUpAdvice" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_FollowUpAdvice" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->FollowUpAdvice->caption() ?><?php echo ($ivf_otherprocedure->FollowUpAdvice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->FollowUpAdvice->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_FollowUpAdvice" class="ivf_otherprocedureadd" type="text/html">
...
<script type="text/html" class="ivf_otherprocedureadd_js">
ew.createEditor("fivf_otherprocedureadd", "x_FollowUpAdvice", 35, 4, <?php echo ($ivf_otherprocedure->FollowUpAdvice->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_otherprocedure->FollowUpMedication->Visible) { // FollowUpMedication ?>
	<div id="r_FollowUpMedication" class="form-group row">
		<label id="elh_ivf_otherprocedure_FollowUpMedication" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_FollowUpMedication" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->FollowUpMedication->caption() ?><?php echo ($ivf_otherprocedure->FollowUpMedication->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->FollowUpMedication->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_FollowUpMedication" class="ivf_otherprocedureadd" type="text/html">
...
<script type="text/html" class="ivf_otherprocedureadd_js">
ew.createEditor("fivf_otherprocedureadd", "x_FollowUpMedication", 35, 4, <?php echo ($ivf_otherprocedure->FollowUpMedication->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_otherprocedure->Plan->Visible) { // Plan ?>
	<div id="r_Plan" class="form-group row">
		<label id="elh_ivf_otherprocedure_Plan" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_Plan" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->Plan->caption() ?><?php echo ($ivf_otherprocedure->Plan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->Plan->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_Plan" class="ivf_otherprocedureadd" type="text/html">
...
<script type="text/html" class="ivf_otherprocedureadd_js">
ew.createEditor("fivf_otherprocedureadd", "x_Plan", 35, 4, <?php echo ($ivf_otherprocedure->Plan->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_otherprocedure->TempleteFinalDiagnosis->Visible) { // TempleteFinalDiagnosis ?>
	<div id="r_TempleteFinalDiagnosis" class="form-group row">
		<label id="elh_ivf_otherprocedure_TempleteFinalDiagnosis" for="x_TempleteFinalDiagnosis" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TempleteFinalDiagnosis" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TempleteFinalDiagnosis->caption() ?><?php echo ($ivf_otherprocedure->TempleteFinalDiagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TempleteFinalDiagnosis->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TempleteFinalDiagnosis" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->TemplateTreatment->Visible) { // TemplateTreatment ?>
	<div id="r_TemplateTreatment" class="form-group row">
		<label id="elh_ivf_otherprocedure_TemplateTreatment" for="x_TemplateTreatment" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TemplateTreatment" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TemplateTreatment->caption() ?><?php echo ($ivf_otherprocedure->TemplateTreatment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TemplateTreatment->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TemplateTreatment" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->TemplateOperation->Visible) { // TemplateOperation ?>
	<div id="r_TemplateOperation" class="form-group row">
		<label id="elh_ivf_otherprocedure_TemplateOperation" for="x_TemplateOperation" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TemplateOperation" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TemplateOperation->caption() ?><?php echo ($ivf_otherprocedure->TemplateOperation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TemplateOperation->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TemplateOperation" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->TemplateFollowUpAdvice->Visible) { // TemplateFollowUpAdvice ?>
	<div id="r_TemplateFollowUpAdvice" class="form-group row">
		<label id="elh_ivf_otherprocedure_TemplateFollowUpAdvice" for="x_TemplateFollowUpAdvice" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TemplateFollowUpAdvice" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TemplateFollowUpAdvice->caption() ?><?php echo ($ivf_otherprocedure->TemplateFollowUpAdvice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TemplateFollowUpAdvice->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TemplateFollowUpAdvice" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->TemplateFollowUpMedication->Visible) { // TemplateFollowUpMedication ?>
	<div id="r_TemplateFollowUpMedication" class="form-group row">
		<label id="elh_ivf_otherprocedure_TemplateFollowUpMedication" for="x_TemplateFollowUpMedication" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TemplateFollowUpMedication" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TemplateFollowUpMedication->caption() ?><?php echo ($ivf_otherprocedure->TemplateFollowUpMedication->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TemplateFollowUpMedication->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TemplateFollowUpMedication" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->TemplatePlan->Visible) { // TemplatePlan ?>
	<div id="r_TemplatePlan" class="form-group row">
		<label id="elh_ivf_otherprocedure_TemplatePlan" for="x_TemplatePlan" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TemplatePlan" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TemplatePlan->caption() ?><?php echo ($ivf_otherprocedure->TemplatePlan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TemplatePlan->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TemplatePlan" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->QRCode->Visible) { // QRCode ?>
	<div id="r_QRCode" class="form-group row">
		<label id="elh_ivf_otherprocedure_QRCode" for="x_QRCode" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_QRCode" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->QRCode->caption() ?><?php echo ($ivf_otherprocedure->QRCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->QRCode->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_QRCode" class="ivf_otherprocedureadd" type="text/html">
...
<?php if ($ivf_otherprocedure->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_otherprocedure_TidNo" for="x_TidNo" class="<?php echo $ivf_otherprocedure_add->LeftColumnClass ?>"><script id="tpc_ivf_otherprocedure_TidNo" class="ivf_otherprocedureadd" type="text/html"><span><?php echo $ivf_otherprocedure->TidNo->caption() ?><?php echo ($ivf_otherprocedure->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_otherprocedure_add->RightColumnClass ?>"><div<?php echo $ivf_otherprocedure->TidNo->cellAttributes() ?>>
<script id="tpx_ivf_otherprocedure_TidNo" class="ivf_otherprocedureadd" type="text/html">
...
ew.applyTemplate("tpd_ivf_otherprocedureadd", "tpm_ivf_otherprocedureadd", "ivf_otherprocedureadd", "<?php echo $ivf_otherprocedure->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_otherprocedureadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
