...
// Create page object
$bulkserviceinsert = new bulkserviceinsert();

// Run the page
$bulkserviceinsert->run();
...
('".$IVFid."', '".$results[0]["patient_id"]."', '".$results[0]["mrnNo"]."', '".$results2[0]["first_name"]."', '".AgeCalculationb($results2[0]["dob"])."',
