...
?>
<?php if ($userlevels_list->id->Visible) { // id ?>
	<?php if ($userlevels_list->SortUrl($userlevels_list->id) == "") { ?>
		<th data-name="id" class="<?php echo $userlevels_list->id->headerCellClass() ?>"><div id="elh_userlevels_id" class="userlevels_id"><div class="ew-table-header-caption"><?php echo $userlevels_list->id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $userlevels_list->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $userlevels_list->SortUrl($userlevels_list->id) ?>', 1);"><div id="elh_userlevels_id" class="userlevels_id">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $userlevels_list->id->caption() ?></span><span class="ew-table-header-sort"><?php if ($userlevels_list->id->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($userlevels_list->id->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($userlevels_list->UserLevelsName->Visible) { // UserLevelsName ?>
	<?php if ($userlevels_list->SortUrl($userlevels_list->UserLevelsName) == "") { ?>
		<th data-name="UserLevelsName" class="<?php echo $userlevels_list->UserLevelsName->headerCellClass() ?>"><div id="elh_userlevels_UserLevelsName" class="userlevels_UserLevelsName"><div class="ew-table-header-caption"><?php echo $userlevels_list->UserLevelsName->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="UserLevelsName" class="<?php echo $userlevels_list->UserLevelsName->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $userlevels_list->SortUrl($userlevels_list->UserLevelsName) ?>', 1);"><div id="elh_userlevels_UserLevelsName" class="userlevels_UserLevelsName">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $userlevels_list->UserLevelsName->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($userlevels_list->UserLevelsName->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($userlevels_list->UserLevelsName->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($userlevels_list->id->Visible) { // id ?>
		<td data-name="id" <?php echo $userlevels_list->id->cellAttributes() ?>>
<span id="el<?php echo $userlevels_list->RowCount ?>_userlevels_id">
<span<?php echo $userlevels_list->id->viewAttributes() ?>><?php echo $userlevels_list->id->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($userlevels_list->UserLevelsName->Visible) { // UserLevelsName ?>
		<td data-name="UserLevelsName" <?php echo $userlevels_list->UserLevelsName->cellAttributes() ?>>
<span id="el<?php echo $userlevels_list->RowCount ?>_userlevels_UserLevelsName">
<span<?php echo $userlevels_list->UserLevelsName->viewAttributes() ?>><?php echo $userlevels_list->UserLevelsName->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
