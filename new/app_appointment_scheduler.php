...
// Create page object
$app_appointment_scheduler = new app_appointment_scheduler();

// Run the page
$app_appointment_scheduler->run();
...
$sql = "SELECT * FROM ganeshkumar_bjhims.appointment_scheduler where start_date between '".$fromdt."' and '".$todate."' ;";
...
scheduler.showLightbox = function(id) {
   ...
   //  var formatFunc = scheduler.date.date_to_str("%d/%m/%Y %H:%i:%s");
	...
	//$('#content').load('appointment_scheduleradd.php?' + $.param ({'startdate' : start_format_date , 'enddate' : end_format_date , 'evtext' : ev.text ,'Drid' : Drid ,'DRRCODE' : DRRCODE ,'DRRNAME' : DRRNAME ,'DRRDEPARTMENT' : DRRDEPARTMENT }));

	document.getElementById("content").src = 'appointment_scheduleradd.php?' + $.param ({'startdate' : start_format_date , 'enddate' : end_format_date , 'evtext' : ev.text ,'Drid' : Drid ,'DRRCODE' : DRRCODE ,'DRRNAME' : DRRNAME ,'DRRDEPARTMENT' : DRRDEPARTMENT });
...
//			});
			...
			//	$('#content').load('appointment_scheduleredit.php?' + $.param ({'id' : id  }));

				document.getElementById("content").src = 'appointment_scheduleredit.php?' + $.param ({'id' : id  });
...
function ClosePop() {
	var layer = document.getElementById("my_form");
...
$('#content').load(function(){
		...
		iframe.find("#btn-action").click(function(){
			   alert("test");
		});
});
				...
				<div class="card-body">
					<div class="tab-content" id="custom-tabs-one-tabContent">
						<div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
							...
							<!--//////////////////////////////////////-->
									   <iframe style="width:100%;height:550px" id="content"></iframe>				  
							<!--///////////////////////////////////////////-->
...
<?php
$app_appointment_scheduler->terminate();
?>