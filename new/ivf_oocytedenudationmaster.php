...
<?php if ($ivf_oocytedenudation->id->Visible) { // id ?>
		<tr id="r_id">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_id" type="text/html"><?php echo $ivf_oocytedenudation->id->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->id->viewAttributes() ?>><?php echo $ivf_oocytedenudation->id->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->RIDNo->Visible) { // RIDNo ?>
		<tr id="r_RIDNo">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_RIDNo" type="text/html"><?php echo $ivf_oocytedenudation->RIDNo->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->RIDNo->viewAttributes() ?>><?php echo $ivf_oocytedenudation->RIDNo->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->Name->Visible) { // Name ?>
		<tr id="r_Name">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_Name" type="text/html"><?php echo $ivf_oocytedenudation->Name->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->Name->viewAttributes() ?>><?php echo $ivf_oocytedenudation->Name->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->ResultDate->Visible) { // ResultDate ?>
		<tr id="r_ResultDate">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_ResultDate" type="text/html"><?php echo $ivf_oocytedenudation->ResultDate->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->ResultDate->viewAttributes() ?>><?php echo $ivf_oocytedenudation->ResultDate->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->Surgeon->Visible) { // Surgeon ?>
		<tr id="r_Surgeon">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_Surgeon" type="text/html"><?php echo $ivf_oocytedenudation->Surgeon->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->Surgeon->viewAttributes() ?>><?php echo $ivf_oocytedenudation->Surgeon->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->AsstSurgeon->Visible) { // AsstSurgeon ?>
		<tr id="r_AsstSurgeon">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_AsstSurgeon" type="text/html"><?php echo $ivf_oocytedenudation->AsstSurgeon->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->AsstSurgeon->viewAttributes() ?>><?php echo $ivf_oocytedenudation->AsstSurgeon->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->Anaesthetist->Visible) { // Anaesthetist ?>
		<tr id="r_Anaesthetist">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_Anaesthetist" type="text/html"><?php echo $ivf_oocytedenudation->Anaesthetist->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->Anaesthetist->viewAttributes() ?>><?php echo $ivf_oocytedenudation->Anaesthetist->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->AnaestheiaType->Visible) { // AnaestheiaType ?>
		<tr id="r_AnaestheiaType">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_AnaestheiaType" type="text/html"><?php echo $ivf_oocytedenudation->AnaestheiaType->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->AnaestheiaType->viewAttributes() ?>><?php echo $ivf_oocytedenudation->AnaestheiaType->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->PrimaryEmbryologist->Visible) { // PrimaryEmbryologist ?>
		<tr id="r_PrimaryEmbryologist">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_PrimaryEmbryologist" type="text/html"><?php echo $ivf_oocytedenudation->PrimaryEmbryologist->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->PrimaryEmbryologist->viewAttributes() ?>><?php echo $ivf_oocytedenudation->PrimaryEmbryologist->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->SecondaryEmbryologist->Visible) { // SecondaryEmbryologist ?>
		<tr id="r_SecondaryEmbryologist">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SecondaryEmbryologist" type="text/html"><?php echo $ivf_oocytedenudation->SecondaryEmbryologist->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->SecondaryEmbryologist->viewAttributes() ?>><?php echo $ivf_oocytedenudation->SecondaryEmbryologist->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->NoOfFolliclesRight->Visible) { // NoOfFolliclesRight ?>
		<tr id="r_NoOfFolliclesRight">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_NoOfFolliclesRight" type="text/html"><?php echo $ivf_oocytedenudation->NoOfFolliclesRight->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->NoOfFolliclesRight->viewAttributes() ?>><?php echo $ivf_oocytedenudation->NoOfFolliclesRight->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->NoOfFolliclesLeft->Visible) { // NoOfFolliclesLeft ?>
		<tr id="r_NoOfFolliclesLeft">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_NoOfFolliclesLeft" type="text/html"><?php echo $ivf_oocytedenudation->NoOfFolliclesLeft->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->NoOfFolliclesLeft->viewAttributes() ?>><?php echo $ivf_oocytedenudation->NoOfFolliclesLeft->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->NoOfOocytes->Visible) { // NoOfOocytes ?>
		<tr id="r_NoOfOocytes">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_NoOfOocytes" type="text/html"><?php echo $ivf_oocytedenudation->NoOfOocytes->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->NoOfOocytes->viewAttributes() ?>><?php echo $ivf_oocytedenudation->NoOfOocytes->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->RecordOocyteDenudation->Visible) { // RecordOocyteDenudation ?>
		<tr id="r_RecordOocyteDenudation">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_RecordOocyteDenudation" type="text/html"><?php echo $ivf_oocytedenudation->RecordOocyteDenudation->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->RecordOocyteDenudation->viewAttributes() ?>><?php echo $ivf_oocytedenudation->RecordOocyteDenudation->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->DateOfDenudation->Visible) { // DateOfDenudation ?>
		<tr id="r_DateOfDenudation">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_DateOfDenudation" type="text/html"><?php echo $ivf_oocytedenudation->DateOfDenudation->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->DateOfDenudation->viewAttributes() ?>><?php echo $ivf_oocytedenudation->DateOfDenudation->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->DenudationDoneBy->Visible) { // DenudationDoneBy ?>
		<tr id="r_DenudationDoneBy">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_DenudationDoneBy" type="text/html"><?php echo $ivf_oocytedenudation->DenudationDoneBy->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->DenudationDoneBy->viewAttributes() ?>><?php echo $ivf_oocytedenudation->DenudationDoneBy->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->status->Visible) { // status ?>
		<tr id="r_status">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_status" type="text/html"><?php echo $ivf_oocytedenudation->status->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->status->viewAttributes() ?>><?php echo $ivf_oocytedenudation->status->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->createdby->Visible) { // createdby ?>
		<tr id="r_createdby">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_createdby" type="text/html"><?php echo $ivf_oocytedenudation->createdby->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->createdby->viewAttributes() ?>><?php echo $ivf_oocytedenudation->createdby->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->createddatetime->Visible) { // createddatetime ?>
		<tr id="r_createddatetime">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_createddatetime" type="text/html"><?php echo $ivf_oocytedenudation->createddatetime->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->createddatetime->viewAttributes() ?>><?php echo $ivf_oocytedenudation->createddatetime->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->modifiedby->Visible) { // modifiedby ?>
		<tr id="r_modifiedby">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_modifiedby" type="text/html"><?php echo $ivf_oocytedenudation->modifiedby->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->modifiedby->viewAttributes() ?>><?php echo $ivf_oocytedenudation->modifiedby->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->modifieddatetime->Visible) { // modifieddatetime ?>
		<tr id="r_modifieddatetime">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_modifieddatetime" type="text/html"><?php echo $ivf_oocytedenudation->modifieddatetime->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->modifieddatetime->viewAttributes() ?>><?php echo $ivf_oocytedenudation->modifieddatetime->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->TidNo->Visible) { // TidNo ?>
		<tr id="r_TidNo">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_TidNo" type="text/html"><?php echo $ivf_oocytedenudation->TidNo->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->TidNo->viewAttributes() ?>><?php echo $ivf_oocytedenudation->TidNo->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->ExpFollicles->Visible) { // ExpFollicles ?>
		<tr id="r_ExpFollicles">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_ExpFollicles" type="text/html"><?php echo $ivf_oocytedenudation->ExpFollicles->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->ExpFollicles->viewAttributes() ?>><?php echo $ivf_oocytedenudation->ExpFollicles->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->SecondaryDenudationDoneBy->Visible) { // SecondaryDenudationDoneBy ?>
		<tr id="r_SecondaryDenudationDoneBy">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SecondaryDenudationDoneBy" type="text/html"><?php echo $ivf_oocytedenudation->SecondaryDenudationDoneBy->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->SecondaryDenudationDoneBy->viewAttributes() ?>><?php echo $ivf_oocytedenudation->SecondaryDenudationDoneBy->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->OocyteOrgin->Visible) { // OocyteOrgin ?>
		<tr id="r_OocyteOrgin">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocyteOrgin" type="text/html"><?php echo $ivf_oocytedenudation->OocyteOrgin->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->OocyteOrgin->viewAttributes() ?>><?php echo $ivf_oocytedenudation->OocyteOrgin->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->patient1->Visible) { // patient1 ?>
		<tr id="r_patient1">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_patient1" type="text/html"><?php echo $ivf_oocytedenudation->patient1->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->patient1->viewAttributes() ?>><?php echo $ivf_oocytedenudation->patient1->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->OocyteType->Visible) { // OocyteType ?>
		<tr id="r_OocyteType">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocyteType" type="text/html"><?php echo $ivf_oocytedenudation->OocyteType->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->OocyteType->viewAttributes() ?>><?php echo $ivf_oocytedenudation->OocyteType->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->MIOocytesDonate1->Visible) { // MIOocytesDonate1 ?>
		<tr id="r_MIOocytesDonate1">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate1" type="text/html"><?php echo $ivf_oocytedenudation->MIOocytesDonate1->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->MIOocytesDonate1->viewAttributes() ?>><?php echo $ivf_oocytedenudation->MIOocytesDonate1->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->MIOocytesDonate2->Visible) { // MIOocytesDonate2 ?>
		<tr id="r_MIOocytesDonate2">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate2" type="text/html"><?php echo $ivf_oocytedenudation->MIOocytesDonate2->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->MIOocytesDonate2->viewAttributes() ?>><?php echo $ivf_oocytedenudation->MIOocytesDonate2->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->SelfMI->Visible) { // SelfMI ?>
		<tr id="r_SelfMI">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SelfMI" type="text/html"><?php echo $ivf_oocytedenudation->SelfMI->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->SelfMI->viewAttributes() ?>><?php echo $ivf_oocytedenudation->SelfMI->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->SelfMII->Visible) { // SelfMII ?>
		<tr id="r_SelfMII">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SelfMII" type="text/html"><?php echo $ivf_oocytedenudation->SelfMII->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->SelfMII->viewAttributes() ?>><?php echo $ivf_oocytedenudation->SelfMII->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->patient3->Visible) { // patient3 ?>
		<tr id="r_patient3">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_patient3" type="text/html"><?php echo $ivf_oocytedenudation->patient3->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->patient3->viewAttributes() ?>><?php echo $ivf_oocytedenudation->patient3->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->patient4->Visible) { // patient4 ?>
		<tr id="r_patient4">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_patient4" type="text/html"><?php echo $ivf_oocytedenudation->patient4->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->patient4->viewAttributes() ?>><?php echo $ivf_oocytedenudation->patient4->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->OocytesDonate3->Visible) { // OocytesDonate3 ?>
		<tr id="r_OocytesDonate3">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocytesDonate3" type="text/html"><?php echo $ivf_oocytedenudation->OocytesDonate3->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->OocytesDonate3->viewAttributes() ?>><?php echo $ivf_oocytedenudation->OocytesDonate3->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->OocytesDonate4->Visible) { // OocytesDonate4 ?>
		<tr id="r_OocytesDonate4">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_OocytesDonate4" type="text/html"><?php echo $ivf_oocytedenudation->OocytesDonate4->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->OocytesDonate4->viewAttributes() ?>><?php echo $ivf_oocytedenudation->OocytesDonate4->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->MIOocytesDonate3->Visible) { // MIOocytesDonate3 ?>
		<tr id="r_MIOocytesDonate3">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate3" type="text/html"><?php echo $ivf_oocytedenudation->MIOocytesDonate3->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->MIOocytesDonate3->viewAttributes() ?>><?php echo $ivf_oocytedenudation->MIOocytesDonate3->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->MIOocytesDonate4->Visible) { // MIOocytesDonate4 ?>
		<tr id="r_MIOocytesDonate4">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_MIOocytesDonate4" type="text/html"><?php echo $ivf_oocytedenudation->MIOocytesDonate4->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->MIOocytesDonate4->viewAttributes() ?>><?php echo $ivf_oocytedenudation->MIOocytesDonate4->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->SelfOocytesMI->Visible) { // SelfOocytesMI ?>
		<tr id="r_SelfOocytesMI">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SelfOocytesMI" type="text/html"><?php echo $ivf_oocytedenudation->SelfOocytesMI->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->SelfOocytesMI->viewAttributes() ?>><?php echo $ivf_oocytedenudation->SelfOocytesMI->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
<?php if ($ivf_oocytedenudation->SelfOocytesMII->Visible) { // SelfOocytesMII ?>
		<tr id="r_SelfOocytesMII">
			<td class="<?php echo $ivf_oocytedenudation->TableLeftColumnClass ?>"><script id="tpc_ivf_oocytedenudation_SelfOocytesMII" type="text/html"><?php echo $ivf_oocytedenudation->SelfOocytesMII->caption() ?></script></td>
...
<span<?php echo $ivf_oocytedenudation->SelfOocytesMII->viewAttributes() ?>><?php echo $ivf_oocytedenudation->SelfOocytesMII->getViewValue() ?></span>
</span></script>
</td>
		</tr>
<?php } ?>
...
loadjs.ready(["jsrender", "makerjs"], function() {
	...
	ew.applyTemplate("tpd_ivf_oocytedenudationmaster", "tpm_ivf_oocytedenudationmaster", "ivf_oocytedenudationmaster", "<?php echo $ivf_oocytedenudation->CustomExport ?>", ew.templateData.rows[0]);
	$("script.ivf_oocytedenudationmaster_js").each(function() {
