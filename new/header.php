...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>a4logo_lgm_icon.ico">
<link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>a4logo_lgm_icon.ico">
...
<div class="wrapper ew-layout">
	...
	<nav class="<?php echo Config("NAVBAR_CLASS") ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			...
			<a class="navbar-brand d-none" href="http://www.a4hospital.com/">
				<img src="<?php echo $RELATIVE_PATH ?>images/A4 Hospitals logo Final.png" alt="" class="brand-image ew-brand-image">
			</a>
		</ul>
		<!-- Right navbar links -->
	...
	<aside class="<?php echo Config("SIDEBAR_CLASS") ?>">
		...
		<a href="http://www.a4hospital.com/" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>images/A4 Hospitals logo Final.png" alt="" class="brand-image ew-brand-image">
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
