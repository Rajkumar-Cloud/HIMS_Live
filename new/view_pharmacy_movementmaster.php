...
<span<?php echo $view_pharmacy_movement->prc->viewAttributes() ?>><?php echo $view_pharmacy_movement->prc->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_pharmacy_movement->PrName->viewAttributes() ?>><?php echo $view_pharmacy_movement->PrName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_pharmacy_movement->BatchNo->viewAttributes() ?>><?php echo $view_pharmacy_movement->BatchNo->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_pharmacy_movement->ExpDate->viewAttributes() ?>><?php echo $view_pharmacy_movement->ExpDate->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_pharmacy_movement->MFRCODE->viewAttributes() ?>><?php echo $view_pharmacy_movement->MFRCODE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_pharmacy_movement->hsn->viewAttributes() ?>><?php echo $view_pharmacy_movement->hsn->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_pharmacy_movement->HospID->viewAttributes() ?>><?php echo $view_pharmacy_movement->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
