...
<input type="hidden" name="x_id" id="x_id" value="<?php echo $userpriv->id->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-user-priv">
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->phrase("UserLevel") ?><?php echo $Security->getUserLevelName((int)$userpriv->id->CurrentValue) ?> (<?php echo $userpriv->id->CurrentValue ?>)</h3>
