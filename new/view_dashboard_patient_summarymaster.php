...
<span<?php echo $view_dashboard_patient_summary->WhereDidYouHear->viewAttributes() ?>><?php echo $view_dashboard_patient_summary->WhereDidYouHear->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_patient_summary->count28WhereDidYouHear29->viewAttributes() ?>><?php echo $view_dashboard_patient_summary->count28WhereDidYouHear29->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_patient_summary->HospID->viewAttributes() ?>><?php echo $view_dashboard_patient_summary->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_patient_summary->createdDate->viewAttributes() ?>><?php echo $view_dashboard_patient_summary->createdDate->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
