...
define(PROJECT_NAMESPACE . "RANDOM_KEY", '4yVXT1qKlqHahWb4'); // Random key for encryption
...
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "kumar8989"); // Administrator password
