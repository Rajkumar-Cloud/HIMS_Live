...
<span<?php echo $view_dashboard_summary_modeofpayment_details->UserName->viewAttributes() ?>><?php echo $view_dashboard_summary_modeofpayment_details->UserName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_summary_modeofpayment_details->ModeofPayment->viewAttributes() ?>><?php echo $view_dashboard_summary_modeofpayment_details->ModeofPayment->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_summary_modeofpayment_details->sum28Amount29->viewAttributes() ?>><?php echo $view_dashboard_summary_modeofpayment_details->sum28Amount29->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_summary_modeofpayment_details->createddate->viewAttributes() ?>><?php echo $view_dashboard_summary_modeofpayment_details->createddate->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_summary_modeofpayment_details->HospID->viewAttributes() ?>><?php echo $view_dashboard_summary_modeofpayment_details->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_summary_modeofpayment_details->BillType->viewAttributes() ?>><?php echo $view_dashboard_summary_modeofpayment_details->BillType->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
