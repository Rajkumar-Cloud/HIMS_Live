...
<span<?php echo $view_lab_service->Id->viewAttributes() ?>><?php echo $view_lab_service->Id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->CODE->viewAttributes() ?>><?php echo $view_lab_service->CODE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->SERVICE->viewAttributes() ?>><?php echo $view_lab_service->SERVICE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->UNITS->viewAttributes() ?>><?php echo $view_lab_service->UNITS->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->AMOUNT->viewAttributes() ?>><?php echo $view_lab_service->AMOUNT->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->SERVICE_TYPE->viewAttributes() ?>><?php echo $view_lab_service->SERVICE_TYPE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->DEPARTMENT->viewAttributes() ?>><?php echo $view_lab_service->DEPARTMENT->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->mas_services_billingcol->viewAttributes() ?>><?php echo $view_lab_service->mas_services_billingcol->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->DrShareAmount->viewAttributes() ?>><?php echo $view_lab_service->DrShareAmount->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->HospShareAmount->viewAttributes() ?>><?php echo $view_lab_service->HospShareAmount->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->DrSharePer->viewAttributes() ?>><?php echo $view_lab_service->DrSharePer->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->HospSharePer->viewAttributes() ?>><?php echo $view_lab_service->HospSharePer->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->HospID->viewAttributes() ?>><?php echo $view_lab_service->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->TestSubCd->viewAttributes() ?>><?php echo $view_lab_service->TestSubCd->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->Method->viewAttributes() ?>><?php echo $view_lab_service->Method->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->Order->viewAttributes() ?>><?php echo $view_lab_service->Order->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->ResType->viewAttributes() ?>><?php echo $view_lab_service->ResType->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->UnitCD->viewAttributes() ?>><?php echo $view_lab_service->UnitCD->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->Sample->viewAttributes() ?>><?php echo $view_lab_service->Sample->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->NoD->viewAttributes() ?>><?php echo $view_lab_service->NoD->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->BillOrder->viewAttributes() ?>><?php echo $view_lab_service->BillOrder->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->Inactive->viewAttributes() ?>><?php echo $view_lab_service->Inactive->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->Outsource->viewAttributes() ?>><?php echo $view_lab_service->Outsource->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->CollSample->viewAttributes() ?>><?php echo $view_lab_service->CollSample->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->TestType->viewAttributes() ?>><?php echo $view_lab_service->TestType->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->NoHeading->viewAttributes() ?>><?php echo $view_lab_service->NoHeading->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->ChemicalCode->viewAttributes() ?>><?php echo $view_lab_service->ChemicalCode->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->ChemicalName->viewAttributes() ?>><?php echo $view_lab_service->ChemicalName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_lab_service->Utilaization->viewAttributes() ?>><?php echo $view_lab_service->Utilaization->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
