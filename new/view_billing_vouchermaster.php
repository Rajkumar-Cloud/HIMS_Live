...
<span<?php echo $view_billing_voucher->createddatetime->viewAttributes() ?>><?php echo $view_billing_voucher->createddatetime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->BillNumber->viewAttributes() ?>><?php echo $view_billing_voucher->BillNumber->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->PatientId->viewAttributes() ?>><?php echo $view_billing_voucher->PatientId->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->PatientName->viewAttributes() ?>><?php echo $view_billing_voucher->PatientName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->Mobile->viewAttributes() ?>><?php echo $view_billing_voucher->Mobile->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->Doctor->viewAttributes() ?>><?php echo $view_billing_voucher->Doctor->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->ModeofPayment->viewAttributes() ?>><?php echo $view_billing_voucher->ModeofPayment->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->Amount->viewAttributes() ?>><?php echo $view_billing_voucher->Amount->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->BankName->viewAttributes() ?>><?php echo $view_billing_voucher->BankName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->UserName->viewAttributes() ?>><?php echo $view_billing_voucher->UserName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->BillType->viewAttributes() ?>><?php echo $view_billing_voucher->BillType->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->CancelBill->viewAttributes() ?>><?php echo $view_billing_voucher->CancelBill->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->LabTest->viewAttributes() ?>><?php echo $view_billing_voucher->LabTest->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->sid->viewAttributes() ?>><?php echo $view_billing_voucher->sid->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->SidNo->viewAttributes() ?>><?php echo $view_billing_voucher->SidNo->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->createdDatettime->viewAttributes() ?>><?php echo $view_billing_voucher->createdDatettime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_billing_voucher->GoogleReviewID->viewAttributes() ?>><?php echo $view_billing_voucher->GoogleReviewID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
