...
<span<?php echo $view_labreport_print->id->viewAttributes() ?>><?php echo $view_labreport_print->id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->PatID->viewAttributes() ?>><?php echo $view_labreport_print->PatID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->PatientName->viewAttributes() ?>><?php echo $view_labreport_print->PatientName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Age->viewAttributes() ?>><?php echo $view_labreport_print->Age->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Gender->viewAttributes() ?>><?php echo $view_labreport_print->Gender->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->sid->viewAttributes() ?>><?php echo $view_labreport_print->sid->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->ItemCode->viewAttributes() ?>><?php echo $view_labreport_print->ItemCode->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->DEptCd->viewAttributes() ?>><?php echo $view_labreport_print->DEptCd->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Resulted->viewAttributes() ?>><?php echo $view_labreport_print->Resulted->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Services->viewAttributes() ?>><?php echo $view_labreport_print->Services->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Pic1->viewAttributes() ?>><?php echo $view_labreport_print->Pic1->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Pic2->viewAttributes() ?>><?php echo $view_labreport_print->Pic2->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->TestUnit->viewAttributes() ?>><?php echo $view_labreport_print->TestUnit->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Order->viewAttributes() ?>><?php echo $view_labreport_print->Order->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Repeated->viewAttributes() ?>><?php echo $view_labreport_print->Repeated->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Vid->viewAttributes() ?>><?php echo $view_labreport_print->Vid->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->invoiceId->viewAttributes() ?>><?php echo $view_labreport_print->invoiceId->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->DrID->viewAttributes() ?>><?php echo $view_labreport_print->DrID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->DrCODE->viewAttributes() ?>><?php echo $view_labreport_print->DrCODE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->DrName->viewAttributes() ?>><?php echo $view_labreport_print->DrName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Department->viewAttributes() ?>><?php echo $view_labreport_print->Department->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->createddatetime->viewAttributes() ?>><?php echo $view_labreport_print->createddatetime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->status->viewAttributes() ?>><?php echo $view_labreport_print->status->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->TestType->viewAttributes() ?>><?php echo $view_labreport_print->TestType->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->ResultDate->viewAttributes() ?>><?php echo $view_labreport_print->ResultDate->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->ResultedBy->viewAttributes() ?>><?php echo $view_labreport_print->ResultedBy->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->Printed->viewAttributes() ?>><?php echo $view_labreport_print->Printed->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->PrintBy->viewAttributes() ?>><?php echo $view_labreport_print->PrintBy->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_labreport_print->PrintDate->viewAttributes() ?>><?php echo $view_labreport_print->PrintDate->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
