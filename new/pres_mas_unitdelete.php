...
<script>
var fpres_mas_unitdelete, currentPageID;
...
<?php if ($pres_mas_unit_delete->id->Visible) { // id ?>
		<th class="<?php echo $pres_mas_unit_delete->id->headerCellClass() ?>"><span id="elh_pres_mas_unit_id" class="pres_mas_unit_id"><?php echo $pres_mas_unit_delete->id->caption() ?></span></th>
<?php } ?>
<?php if ($pres_mas_unit_delete->Units->Visible) { // Units ?>
		<th class="<?php echo $pres_mas_unit_delete->Units->headerCellClass() ?>"><span id="elh_pres_mas_unit_Units" class="pres_mas_unit_Units"><?php echo $pres_mas_unit_delete->Units->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$pres_mas_unit_delete->RecordCount = 0;
$i = 0;
while (!$pres_mas_unit_delete->Recordset->EOF) {
	$pres_mas_unit_delete->RecordCount++;
	$pres_mas_unit_delete->RowCount++;
...
<?php if ($pres_mas_unit_delete->id->Visible) { // id ?>
		<td <?php echo $pres_mas_unit_delete->id->cellAttributes() ?>>
<span id="el<?php echo $pres_mas_unit_delete->RowCount ?>_pres_mas_unit_id" class="pres_mas_unit_id">
<span<?php echo $pres_mas_unit_delete->id->viewAttributes() ?>><?php echo $pres_mas_unit_delete->id->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($pres_mas_unit_delete->Units->Visible) { // Units ?>
		<td <?php echo $pres_mas_unit_delete->Units->cellAttributes() ?>>
<span id="el<?php echo $pres_mas_unit_delete->RowCount ?>_pres_mas_unit_Units" class="pres_mas_unit_Units">
<span<?php echo $pres_mas_unit_delete->Units->viewAttributes() ?>><?php echo $pres_mas_unit_delete->Units->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
