 ...
 * Page class
 */
class store_storemast_add extends store_storemast
{
	...
	// Page object name
	public $PageObjName = "store_storemast_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("store_storemastlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "store_storemastlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "store_storemastview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// SALQTY
		$this->SALQTY->setDbValueDef($rsnew, $this->SALQTY->CurrentValue, NULL, FALSE);
		...
		// NEWRT
		$this->NEWRT->setDbValueDef($rsnew, $this->NEWRT->CurrentValue, NULL, FALSE);

		// NEWMRP
		$this->NEWMRP->setDbValueDef($rsnew, $this->NEWMRP->CurrentValue, NULL, FALSE);

		// NEWUR
		$this->NEWUR->setDbValueDef($rsnew, $this->NEWUR->CurrentValue, NULL, FALSE);

		// STATUS
		$this->STATUS->setDbValueDef($rsnew, $this->STATUS->CurrentValue, NULL, FALSE);

		// RETNQTY
		$this->RETNQTY->setDbValueDef($rsnew, $this->RETNQTY->CurrentValue, NULL, FALSE);

		// KEMODISC
		$this->KEMODISC->setDbValueDef($rsnew, $this->KEMODISC->CurrentValue, NULL, FALSE);

		// PATSALE
		$this->PATSALE->setDbValueDef($rsnew, $this->PATSALE->CurrentValue, NULL, FALSE);

		// ORGAN
		$this->ORGAN->setDbValueDef($rsnew, $this->ORGAN->CurrentValue, NULL, FALSE);

		// OLDRQ
		$this->OLDRQ->setDbValueDef($rsnew, $this->OLDRQ->CurrentValue, NULL, FALSE);
		...
		// PhysQty
		$this->PhysQty->setDbValueDef($rsnew, $this->PhysQty->CurrentValue, NULL, FALSE);

		// LedQty
		$this->LedQty->setDbValueDef($rsnew, $this->LedQty->CurrentValue, NULL, FALSE);
		...
		// SaleValue
		$this->SaleValue->setDbValueDef($rsnew, $this->SaleValue->CurrentValue, NULL, FALSE);
		...
		// SaleRate
		$this->SaleRate->setDbValueDef($rsnew, $this->SaleRate->CurrentValue, NULL, FALSE);
