 ...
 * Page class
 */
class lab_profile_details_delete extends lab_profile_details
{
	...
	// Page object name
	public $PageObjName = "lab_profile_details_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lab_profile_detailslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lab_profile_detailslist.php"); // Return to list
			}
		}
	}
