 ...
 * Page class
 */
class mas_template_type_add extends mas_template_type
{
	...
	// Page object name
	public $PageObjName = "mas_template_type_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("mas_template_typelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "mas_template_typelist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "mas_template_typeview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// TemplateName
		$this->TemplateName->CurrentValue = CurrentUserName();
		$this->TemplateName->setDbValueDef($rsnew, $this->TemplateName->CurrentValue, "");
