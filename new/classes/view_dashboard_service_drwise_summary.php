 ...
 */
class view_dashboard_service_drwise_summary extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// sum(SubTotal)
		$this->sum28SubTotal29 = new DbField('view_dashboard_service_drwise_summary', 'view_dashboard_service_drwise_summary', 'x_sum28SubTotal29', 'sum(SubTotal)', '`sum(SubTotal)`', '`sum(SubTotal)`', 131, 34, -1, FALSE, '`sum(SubTotal)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_dashboard_service_drwise_summarylist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_dashboard_service_drwise_summaryview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_dashboard_service_drwise_summaryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_dashboard_service_drwise_summaryadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_dashboard_service_drwise_summaryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_dashboard_service_drwise_summaryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_dashboard_service_drwise_summaryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_dashboard_service_drwise_summaryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_dashboard_service_drwise_summaryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_dashboard_service_drwise_summaryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_dashboard_service_drwise_summarydelete.php", $this->getUrlParm());
	}
