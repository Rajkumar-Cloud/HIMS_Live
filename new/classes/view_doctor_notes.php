...
class view_doctor_notes extends DbTable
{
	...
	public function __construct()
	{
		...
		// Created
		$this->Created = new DbField('view_doctor_notes', 'view_doctor_notes', 'x_Created', 'Created', '`Created`', CastDateFieldForLike("`Created`", 7, "DB"), 133, 10, 7, FALSE, '`Created`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Created->Sortable = TRUE; // Allow sort
		$this->Created->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
		$this->fields['Created'] = &$this->Created;

		// Started
		$this->Started = new DbField('view_doctor_notes', 'view_doctor_notes', 'x_Started', 'Started', '`Started`', CastDateFieldForLike("`Started`", 6, "DB"), 133, 10, 6, FALSE, '`Started`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Started->Sortable = TRUE; // Allow sort
		$this->Started->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateMDY"));
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_doctor_notesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function renderEditRow()
	{
		...
		$this->Created->EditValue = FormatDateTime($this->Created->CurrentValue, 7);
		...
		$this->Started->EditValue = FormatDateTime($this->Started->CurrentValue, 6);
