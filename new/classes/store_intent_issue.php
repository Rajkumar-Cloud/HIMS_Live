...
class store_intent_issue extends DbTable
{
	...
	public function __construct()
	{
		...
		// PharID
		$this->PharID = new DbField('store_intent_issue', 'store_intent_issue', 'x_PharID', 'PharID', '`PharID`', '`PharID`', 3, 11, -1, FALSE, '`PharID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("store_intent_issueview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
