 ...
 * Page class
 */
class pharmacy_po_list extends pharmacy_po
{
	...
	// Page object name
	public $PageObjName = "pharmacy_po_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pharmacy_poadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "pharmacy_podelete.php";
		$this->MultiUpdateUrl = "pharmacy_poupdate.php";
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'pharmacy_purchaseorder')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("pharmacy_purchaseorderlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_po&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["pharmacy_purchaseorder_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pharmacy_po')) {
			...
			if ($GLOBALS["pharmacy_purchaseorder_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pharmacy_po')) {
			...
			if ($GLOBALS["pharmacy_purchaseorder_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pharmacy_po')) {
	...
	protected function setupOtherOptions()
	{
		...
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["pharmacy_purchaseorder"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["pharmacy_purchaseorder"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'pharmacy_po') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
...
// Render list options (extended codes)
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["pharmacy_purchaseorder"] && $this->DetailPages["pharmacy_purchaseorder"]->Visible) {
			...
			$url = "pharmacy_purchaseorderpreview.php?t=pharmacy_po&f=" . Encrypt($sqlwrk);
			...
			if ($Security->allowList(CurrentProjectID() . 'pharmacy_po')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("pharmacy_purchaseorderlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_po&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
