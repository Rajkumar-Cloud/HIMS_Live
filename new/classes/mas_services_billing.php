 ...
 */
class mas_services_billing extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "mas_services_billinglist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "mas_services_billingview.php")
			return $Language->phrase("View");
		elseif ($pageName == "mas_services_billingedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "mas_services_billingadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("mas_services_billingview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mas_services_billingview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "mas_services_billingadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mas_services_billingadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mas_services_billingedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mas_services_billingadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("mas_services_billingdelete.php", $this->getUrlParm());
	}
