 ...
 * Page class
 */
class appointment_block_slot_delete extends appointment_block_slot
{
	...
	// Page object name
	public $PageObjName = "appointment_block_slot_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("appointment_block_slotlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("appointment_block_slotlist.php"); // Return to list
			}
		}
	}
