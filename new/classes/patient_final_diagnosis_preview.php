 ...
 * Page class
 */
class patient_final_diagnosis_preview extends patient_final_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_final_diagnosis_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_final_diagnosis');
			if ($Security->isLoggedIn())
