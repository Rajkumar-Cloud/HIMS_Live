...
class pres_genericinteractions extends DbTable
{
	...
	public function __construct()
	{
		...
		// Remarks
		$this->Remarks = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Remarks', 'Remarks', '`Remarks`', '`Remarks`', 201, 500, -1, FALSE, '`Remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Remarks->Sortable = TRUE; // Allow sort
		$this->fields['Remarks'] = &$this->Remarks;

		// Username
		$this->Username = new DbField('pres_genericinteractions', 'pres_genericinteractions', 'x_Username', 'Username', '`Username`', '`Username`', 200, 50, -1, FALSE, '`Username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("pres_genericinteractionsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
