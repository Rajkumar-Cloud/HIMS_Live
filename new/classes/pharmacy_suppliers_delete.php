 ...
 * Page class
 */
class pharmacy_suppliers_delete extends pharmacy_suppliers
{
	...
	// Page object name
	public $PageObjName = "pharmacy_suppliers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_supplierslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_supplierslist.php"); // Return to list
			}
		}
	}
