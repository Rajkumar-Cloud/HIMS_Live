...
class employee_has_degree extends DbTable
{
	...
	public function __construct()
	{
		...
		// others
		$this->others = new DbField('employee_has_degree', 'employee_has_degree', 'x_others', 'others', '`others`', '`others`', 200, 100, -1, TRUE, '`others`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("employee_has_degreeview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
