 ...
 * Page class
 */
class patient_prescription_preview extends patient_prescription
{
	...
	// Page object name
	public $PageObjName = "patient_prescription_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_prescription');
			if ($Security->isLoggedIn())
