 ...
 * Page class
 */
class view_dashboard_collection_details_list extends view_dashboard_collection_details
{
	...
	// Page object name
	public $PageObjName = "view_dashboard_collection_details_list";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "view_dashboard_collection_detailsdelete.php";
		$this->MultiUpdateUrl = "view_dashboard_collection_detailsupdate.php";
		...
		if (!isset($GLOBALS['view_dashboard_summary_modeofpayment_details']))
			$GLOBALS['view_dashboard_summary_modeofpayment_details'] = new view_dashboard_summary_modeofpayment_details();

		// Table object (view_dashboard_summary_payment_mode)
		if (!isset($GLOBALS['view_dashboard_summary_payment_mode']))
			$GLOBALS['view_dashboard_summary_payment_mode'] = new view_dashboard_summary_payment_mode();
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fview_dashboard_collection_detailslistsrch");
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fview_dashboard_collection_detailslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fview_dashboard_collection_detailslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fview_dashboard_collection_detailslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_view_dashboard_collection_details" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_view_dashboard_collection_details\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fview_dashboard_collection_detailslist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"view_dashboard_collection_detailssrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_dashboard_collection_details\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'view_dashboard_collection_detailssrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->add("searchhighlight");
		$item->Body = "<a class=\"btn btn-default ew-highlight active\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fview_dashboard_collection_detailslistsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
	...
	public function exportData($return = FALSE)
	{
		...
		if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_summary_modeofpayment_details") {
			global $view_dashboard_summary_modeofpayment_details;
			if (!isset($view_dashboard_summary_modeofpayment_details))
				$view_dashboard_summary_modeofpayment_details = new view_dashboard_summary_modeofpayment_details();
			$rsmaster = $view_dashboard_summary_modeofpayment_details->loadRs($this->DbMasterFilter); // Load master record
			if ($rsmaster && !$rsmaster->EOF) {
				$exportStyle = $doc->Style;
				$doc->setStyle("v"); // Change to vertical
				if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
					$doc->Table = &$view_dashboard_summary_modeofpayment_details;
					$view_dashboard_summary_modeofpayment_details->exportDocument($doc, $rsmaster);
					$doc->exportEmptyRow();
					$doc->Table = &$this;
				}
		...
		// Export master record
		if (Config("EXPORT_MASTER_RECORD") && $this->getMasterFilter() != "" && $this->getCurrentMasterTable() == "view_dashboard_summary_payment_mode") {
			global $view_dashboard_summary_payment_mode;
			if (!isset($view_dashboard_summary_payment_mode))
				$view_dashboard_summary_payment_mode = new view_dashboard_summary_payment_mode();
			$rsmaster = $view_dashboard_summary_payment_mode->loadRs($this->DbMasterFilter); // Load master record
			if ($rsmaster && !$rsmaster->EOF) {
				$exportStyle = $doc->Style;
				$doc->setStyle("v"); // Change to vertical
				if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
					$doc->Table = &$view_dashboard_summary_payment_mode;
					$view_dashboard_summary_payment_mode->exportDocument($doc, $rsmaster);
					$doc->exportEmptyRow();
					$doc->Table = &$this;
				}
				$doc->setStyle($exportStyle); // Restore
		...
		if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== NULL) {
			...
			if ($masterTblVar == "view_dashboard_summary_modeofpayment_details") {
				...
				if (($parm = Get("fk_UserName", Get("UserName"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->UserName->setQueryStringValue($parm);
					$this->UserName->setQueryStringValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->UserName->QueryStringValue);
					$this->UserName->setSessionValue($this->UserName->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Get("fk_createddate", Get("createddate"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->createddate->setQueryStringValue($parm);
					$this->createddate->setQueryStringValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->createddate->QueryStringValue);
					$this->createddate->setSessionValue($this->createddate->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Get("fk_ModeofPayment", Get("ModeofPayment"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->ModeofPayment->setQueryStringValue($parm);
					$this->ModeofPayment->setQueryStringValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->ModeofPayment->QueryStringValue);
					$this->ModeofPayment->setSessionValue($this->ModeofPayment->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Get("fk_HospID", Get("HospID"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->HospID->setQueryStringValue($parm);
					$this->HospID->setQueryStringValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->HospID->QueryStringValue);
					$this->HospID->setSessionValue($this->HospID->QueryStringValue);
					if (!is_numeric($GLOBALS["view_dashboard_summary_modeofpayment_details"]->HospID->QueryStringValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
			...
			if ($masterTblVar == "view_dashboard_summary_payment_mode") {
				$validMaster = TRUE;
				if (($parm = Get("fk_createddate", Get("createddate"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_payment_mode"]->createddate->setQueryStringValue($parm);
					$this->createddate->setQueryStringValue($GLOBALS["view_dashboard_summary_payment_mode"]->createddate->QueryStringValue);
					$this->createddate->setSessionValue($this->createddate->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Get("fk_HospID", Get("HospID"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_payment_mode"]->HospID->setQueryStringValue($parm);
					$this->HospID->setQueryStringValue($GLOBALS["view_dashboard_summary_payment_mode"]->HospID->QueryStringValue);
					$this->HospID->setSessionValue($this->HospID->QueryStringValue);
					if (!is_numeric($GLOBALS["view_dashboard_summary_payment_mode"]->HospID->QueryStringValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Get("fk_UserName", Get("UserName"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_payment_mode"]->UserName->setQueryStringValue($parm);
					$this->UserName->setQueryStringValue($GLOBALS["view_dashboard_summary_payment_mode"]->UserName->QueryStringValue);
					$this->UserName->setSessionValue($this->UserName->QueryStringValue);
				} else {
					$validMaster = FALSE;
				}
			...
			if ($masterTblVar == "view_dashboard_summary_modeofpayment_details") {
				...
				if (($parm = Post("fk_UserName", Post("UserName"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->UserName->setFormValue($parm);
					$this->UserName->setFormValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->UserName->FormValue);
					$this->UserName->setSessionValue($this->UserName->FormValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Post("fk_createddate", Post("createddate"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->createddate->setFormValue($parm);
					$this->createddate->setFormValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->createddate->FormValue);
					$this->createddate->setSessionValue($this->createddate->FormValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Post("fk_ModeofPayment", Post("ModeofPayment"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->ModeofPayment->setFormValue($parm);
					$this->ModeofPayment->setFormValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->ModeofPayment->FormValue);
					$this->ModeofPayment->setSessionValue($this->ModeofPayment->FormValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Post("fk_HospID", Post("HospID"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_modeofpayment_details"]->HospID->setFormValue($parm);
					$this->HospID->setFormValue($GLOBALS["view_dashboard_summary_modeofpayment_details"]->HospID->FormValue);
					$this->HospID->setSessionValue($this->HospID->FormValue);
					if (!is_numeric($GLOBALS["view_dashboard_summary_modeofpayment_details"]->HospID->FormValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
			...
			if ($masterTblVar == "view_dashboard_summary_payment_mode") {
				$validMaster = TRUE;
				if (($parm = Post("fk_createddate", Post("createddate"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_payment_mode"]->createddate->setFormValue($parm);
					$this->createddate->setFormValue($GLOBALS["view_dashboard_summary_payment_mode"]->createddate->FormValue);
					$this->createddate->setSessionValue($this->createddate->FormValue);
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Post("fk_HospID", Post("HospID"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_payment_mode"]->HospID->setFormValue($parm);
					$this->HospID->setFormValue($GLOBALS["view_dashboard_summary_payment_mode"]->HospID->FormValue);
					$this->HospID->setSessionValue($this->HospID->FormValue);
					if (!is_numeric($GLOBALS["view_dashboard_summary_payment_mode"]->HospID->FormValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
				if (($parm = Post("fk_UserName", Post("UserName"))) !== NULL) {
					$GLOBALS["view_dashboard_summary_payment_mode"]->UserName->setFormValue($parm);
					$this->UserName->setFormValue($GLOBALS["view_dashboard_summary_payment_mode"]->UserName->FormValue);
					$this->UserName->setSessionValue($this->UserName->FormValue);
				} else {
					$validMaster = FALSE;
				}
		...
		if ($validMaster) {
			...
			if ($masterTblVar != "view_dashboard_summary_modeofpayment_details") {
				...
				if ($this->createddate->CurrentValue == "")
					$this->createddate->setSessionValue("");
				if ($this->ModeofPayment->CurrentValue == "")
					$this->ModeofPayment->setSessionValue("");
