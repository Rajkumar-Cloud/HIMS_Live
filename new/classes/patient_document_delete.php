 ...
 * Page class
 */
class patient_document_delete extends patient_document
{
	...
	// Page object name
	public $PageObjName = "patient_document_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_documentlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("patient_documentlist.php"); // Return to list
			}
		}
	}
