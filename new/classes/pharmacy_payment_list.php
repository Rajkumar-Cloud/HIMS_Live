 ...
 * Page class
 */
class pharmacy_payment_list extends pharmacy_payment
{
	...
	// Page object name
	public $PageObjName = "pharmacy_payment_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pharmacy_paymentadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "pharmacy_paymentdelete.php";
		$this->MultiUpdateUrl = "pharmacy_paymentupdate.php";
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'pharmacy_grn')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("pharmacy_grnlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_payment&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["pharmacy_grn_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pharmacy_payment')) {
			...
			if ($GLOBALS["pharmacy_grn_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pharmacy_payment')) {
			...
			if ($GLOBALS["pharmacy_grn_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pharmacy_payment')) {
	...
	protected function setupOtherOptions()
	{
		...
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["pharmacy_grn"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["pharmacy_grn"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'pharmacy_payment') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
...
// Render list options (extended codes)
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["pharmacy_grn"] && $this->DetailPages["pharmacy_grn"]->Visible) {
			...
			$url = "pharmacy_grnpreview.php?t=pharmacy_payment&f=" . Encrypt($sqlwrk);
			...
			if ($Security->allowList(CurrentProjectID() . 'pharmacy_payment')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("pharmacy_grnlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_payment&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
