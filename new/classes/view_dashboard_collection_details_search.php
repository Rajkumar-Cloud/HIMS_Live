 ...
 * Page class
 */
class view_dashboard_collection_details_search extends view_dashboard_collection_details
{
	...
	// Page object name
	public $PageObjName = "view_dashboard_collection_details_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("view_dashboard_collection_detailslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "view_dashboard_collection_detailslist.php" . "?" . $srchStr;
