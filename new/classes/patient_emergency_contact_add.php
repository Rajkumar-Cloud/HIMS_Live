 ...
 * Page class
 */
class patient_emergency_contact_add extends patient_emergency_contact
{
	...
	// Page object name
	public $PageObjName = "patient_emergency_contact_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("patient_emergency_contactlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "patient_emergency_contactlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "patient_emergency_contactview.php")
