 ...
 * Page class
 */
class view_lab_service_edit extends view_lab_service
{
	...
	// Page object name
	public $PageObjName = "view_lab_service_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("view_lab_service_sub", $detailTblVar) && $GLOBALS["view_lab_service_sub"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("view_lab_service_sub", $detailTblVar) && $GLOBALS["view_lab_service_sub"]->DetailEdit) {
						...
						$editRow = $GLOBALS["view_lab_service_sub_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("view_lab_service_sub", $detailTblVar)) {
				...
				if ($GLOBALS["view_lab_service_sub_grid"]->DetailEdit) {
					$GLOBALS["view_lab_service_sub_grid"]->CurrentMode = "edit";
					$GLOBALS["view_lab_service_sub_grid"]->CurrentAction = "gridedit";
