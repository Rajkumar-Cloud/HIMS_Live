 ...
 */
class view_ip_admission_issue extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_ip_admission_issuelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_ip_admission_issueview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_ip_admission_issueedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_ip_admission_issueadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_ip_admission_issueview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_ip_admission_issueview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_ip_admission_issueadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_ip_admission_issueadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admission_issueedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admission_issueadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_ip_admission_issuedelete.php", $this->getUrlParm());
	}
