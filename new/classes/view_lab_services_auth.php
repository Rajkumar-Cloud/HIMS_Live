 ...
 */
class view_lab_services_auth extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// DiscountRemarks
		$this->DiscountRemarks = new DbField('view_lab_services_auth', 'view_lab_services_auth', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 200, 45, -1, FALSE, '`DiscountRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_lab_resultreleased_auth") {
			$detailUrl = $GLOBALS["view_lab_resultreleased_auth"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($detailUrl == "")
			$detailUrl = "view_lab_services_authlist.php";
		return $detailUrl;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_lab_services_authlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_lab_services_authview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_lab_services_authedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_lab_services_authadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_lab_services_authview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_lab_services_authview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_lab_services_authadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_lab_services_authadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_lab_services_authedit.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_lab_services_authedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_lab_services_authadd.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_lab_services_authadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_lab_services_authdelete.php", $this->getUrlParm());
	}
