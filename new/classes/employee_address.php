 ...
 */
class employee_address extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// employee_id
		$this->employee_id = new DbField('employee_address', 'employee_address', 'x_employee_id', 'employee_id', '`employee_id`', '`employee_id`', 3, 11, -1, FALSE, '`employee_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "employee_addresslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "employee_addressedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "employee_addressadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("employee_addressview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("employee_addressview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "employee_addressadd.php?" . $this->getUrlParm($parm);
		else
			$url = "employee_addressadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_addressedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("employee_addressadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("employee_addressdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->contact_persion->setDbValue($rs->fields('contact_persion'));
		...
		$this->address_type->setDbValue($rs->fields('address_type'));
