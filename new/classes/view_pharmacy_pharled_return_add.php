 ...
 * Page class
 */
class view_pharmacy_pharled_return_add extends view_pharmacy_pharled_return
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_pharled_return_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("view_pharmacy_pharled_returnlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "view_pharmacy_pharled_returnlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "view_pharmacy_pharled_returnview.php")
