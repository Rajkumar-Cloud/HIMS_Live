 ...
 * Page class
 */
class ivf_otherprocedure_add extends ivf_otherprocedure
{
	...
	// Page object name
	public $PageObjName = "ivf_otherprocedure_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_otherprocedureview.php")
