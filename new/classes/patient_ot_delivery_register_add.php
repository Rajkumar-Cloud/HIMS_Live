 ...
 * Page class
 */
class patient_ot_delivery_register_add extends patient_ot_delivery_register
{
	...
	// Page object name
	public $PageObjName = "patient_ot_delivery_register_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "patient_ot_delivery_registerview.php")
