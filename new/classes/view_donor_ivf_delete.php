 ...
 * Page class
 */
class view_donor_ivf_delete extends view_donor_ivf
{
	...
	// Page object name
	public $PageObjName = "view_donor_ivf_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_donor_ivflist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("view_donor_ivflist.php"); // Return to list
			}
		}
	}
