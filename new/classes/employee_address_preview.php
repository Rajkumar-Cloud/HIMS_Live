 ...
 * Page class
 */
class employee_address_preview extends employee_address
{
	...
	// Page object name
	public $PageObjName = "employee_address_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'employee_address');
			if ($Security->isLoggedIn())
