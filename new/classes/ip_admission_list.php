...
class ip_admission_list extends ip_admission
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "ip_admissionadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupOtherOptions()
	{
		...
		if (!isset($GLOBALS["patient_vitals"]))
			$GLOBALS["patient_vitals"] = new patient_vitals();
		...
		$item->Visible = ($GLOBALS["patient_vitals"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_history"]))
			$GLOBALS["patient_history"] = new patient_history();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_history"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_history"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_provisional_diagnosis"]))
			$GLOBALS["patient_provisional_diagnosis"] = new patient_provisional_diagnosis();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_provisional_diagnosis"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_provisional_diagnosis"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_prescription"]))
			$GLOBALS["patient_prescription"] = new patient_prescription();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_prescription"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_prescription"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_final_diagnosis"]))
			$GLOBALS["patient_final_diagnosis"] = new patient_final_diagnosis();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_final_diagnosis"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_final_diagnosis"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_follow_up"]))
			$GLOBALS["patient_follow_up"] = new patient_follow_up();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_follow_up"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_follow_up"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_ot_delivery_register"]))
			$GLOBALS["patient_ot_delivery_register"] = new patient_ot_delivery_register();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_ot_delivery_register"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_ot_delivery_register"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_ot_surgery_register"]))
			$GLOBALS["patient_ot_surgery_register"] = new patient_ot_surgery_register();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_ot_surgery_register"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_ot_surgery_register"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_services"]))
			$GLOBALS["patient_services"] = new patient_services();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_services"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_services"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_investigations"]))
			$GLOBALS["patient_investigations"] = new patient_investigations();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_investigations"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_investigations"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_insurance"]))
			$GLOBALS["patient_insurance"] = new patient_insurance();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_insurance"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_insurance"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["pharmacy_pharled"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["view_ip_advance"]))
			$GLOBALS["view_ip_advance"] = new view_ip_advance();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["view_ip_advance"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["view_ip_advance"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["patient_room"]))
			$GLOBALS["patient_room"] = new patient_room();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["patient_room"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["patient_room"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ip_admission') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
...
// Render list options (extended codes)
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["patient_vitals"] && $this->DetailPages["patient_vitals"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_vitalslist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_history"] && $this->DetailPages["patient_history"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_historylist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_provisional_diagnosis"] && $this->DetailPages["patient_provisional_diagnosis"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_provisional_diagnosislist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_prescription"] && $this->DetailPages["patient_prescription"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_prescriptionlist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_final_diagnosis"] && $this->DetailPages["patient_final_diagnosis"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_final_diagnosislist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_follow_up"] && $this->DetailPages["patient_follow_up"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_follow_uplist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_ot_delivery_register"] && $this->DetailPages["patient_ot_delivery_register"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_ot_delivery_registerlist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_ot_surgery_register"] && $this->DetailPages["patient_ot_surgery_register"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_ot_surgery_registerlist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_services"] && $this->DetailPages["patient_services"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_serviceslist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_investigations"] && $this->DetailPages["patient_investigations"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_investigationslist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_insurance"] && $this->DetailPages["patient_insurance"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_insurancelist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["pharmacy_pharled"] && $this->DetailPages["pharmacy_pharled"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("pharmacy_pharledlist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["view_ip_advance"] && $this->DetailPages["view_ip_advance"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("view_ip_advancelist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["patient_room"] && $this->DetailPages["patient_room"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'ip_admission')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("patient_roomlist.php?" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_mrnNo=" . urlencode(strval($this->mrnNo->CurrentValue)) . "&fk_patient_id=" . urlencode(strval($this->patient_id->CurrentValue)) . "");
	...
	protected function setupSearchOptions()
	{
		...
		if (IsMobile())
			...
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"ip_admission\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'ip_admissionsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
