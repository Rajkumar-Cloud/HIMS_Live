...
/**
 * Table class for pres_tradenames
 */
class pres_tradenames extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'pres_tradenames';
		$this->TableName = 'pres_tradenames';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`pres_tradenames`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('pres_tradenames', 'pres_tradenames', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// GENERIC_NAMES
		$this->GENERIC_NAMES = new DbField('pres_tradenames', 'pres_tradenames', 'x_GENERIC_NAMES', 'GENERIC_NAMES', '`GENERIC_NAMES`', '`GENERIC_NAMES`', 201, 500, -1, FALSE, '`GENERIC_NAMES`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->GENERIC_NAMES->Sortable = TRUE; // Allow sort
		$this->fields['GENERIC_NAMES'] = &$this->GENERIC_NAMES;

		// TRADE_NAME
		$this->TRADE_NAME = new DbField('pres_tradenames', 'pres_tradenames', 'x_TRADE_NAME', 'TRADE_NAME', '`TRADE_NAME`', '`TRADE_NAME`', 201, 500, -1, FALSE, '`TRADE_NAME`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->TRADE_NAME->Sortable = TRUE; // Allow sort
		$this->fields['TRADE_NAME'] = &$this->TRADE_NAME;

		// Drug_Name
		$this->Drug_Name = new DbField('pres_tradenames', 'pres_tradenames', 'x_Drug_Name', 'Drug_Name', '`Drug_Name`', '`Drug_Name`', 201, 500, -1, FALSE, '`Drug_Name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Drug_Name->Sortable = TRUE; // Allow sort
		$this->fields['Drug_Name'] = &$this->Drug_Name;

		// PR_CODE
		$this->PR_CODE = new DbField('pres_tradenames', 'pres_tradenames', 'x_PR_CODE', 'PR_CODE', '`PR_CODE`', '`PR_CODE`', 200, 50, -1, FALSE, '`PR_CODE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PR_CODE->Sortable = TRUE; // Allow sort
		$this->fields['PR_CODE'] = &$this->PR_CODE;

		// GenericNames_symbols
		$this->GenericNames_symbols = new DbField('pres_tradenames', 'pres_tradenames', 'x_GenericNames_symbols', 'GenericNames_symbols', '`GenericNames_symbols`', '`GenericNames_symbols`', 201, -1, -1, FALSE, '`GenericNames_symbols`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->GenericNames_symbols->Sortable = TRUE; // Allow sort
		$this->fields['GenericNames_symbols'] = &$this->GenericNames_symbols;

		// CONTAINER_TYPE
		$this->CONTAINER_TYPE = new DbField('pres_tradenames', 'pres_tradenames', 'x_CONTAINER_TYPE', 'CONTAINER_TYPE', '`CONTAINER_TYPE`', '`CONTAINER_TYPE`', 200, 50, -1, FALSE, '`CONTAINER_TYPE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CONTAINER_TYPE->Sortable = TRUE; // Allow sort
		$this->fields['CONTAINER_TYPE'] = &$this->CONTAINER_TYPE;

		// STRENGTH
		$this->STRENGTH = new DbField('pres_tradenames', 'pres_tradenames', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 200, 50, -1, FALSE, '`STRENGTH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`pres_tradenames`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "pres_tradenameslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "pres_tradenamesview.php")
			return $Language->phrase("View");
		elseif ($pageName == "pres_tradenamesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "pres_tradenamesadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("pres_tradenamesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("pres_tradenamesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "pres_tradenamesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "pres_tradenamesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pres_tradenamesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pres_tradenamesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("pres_tradenamesdelete.php", $this->getUrlParm());
	}
