 ...
 */
class view_lab_resultreleased extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`TestType` IN ('Lab Test' , 'Lab Profile', 'ProfileSubTest') ";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_lab_resultreleasedlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_lab_resultreleasedview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_lab_resultreleasededit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_lab_resultreleasedadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_lab_resultreleasedview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_lab_resultreleasedview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_lab_resultreleasedadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_lab_resultreleasedadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_lab_resultreleasededit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_lab_resultreleasedadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_lab_resultreleaseddelete.php", $this->getUrlParm());
	}
