...
class view_pharmacy_movement extends DbTable
{
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_pharmacy_movement_item") {
			$detailUrl = $GLOBALS["view_pharmacy_movement_item"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_pharmacy_movementview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
