 ...
 * Page class
 */
class _appointment_scheduler_edit extends _appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "_appointment_scheduler_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("_appointment_schedulerlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "_appointment_schedulerlist.php")
