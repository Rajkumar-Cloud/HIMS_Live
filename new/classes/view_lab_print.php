 ...
 */
class view_lab_print extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// DiscountRemarks
		$this->DiscountRemarks = new DbField('view_lab_print', 'view_lab_print', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 200, 45, -1, FALSE, '`DiscountRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "view_lab_printedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_lab_printadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_lab_printview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_lab_printview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_lab_printadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_lab_printadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_lab_printedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_lab_printadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_lab_printdelete.php", $this->getUrlParm());
	}
