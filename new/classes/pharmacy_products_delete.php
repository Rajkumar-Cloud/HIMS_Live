 ...
 * Page class
 */
class pharmacy_products_delete extends pharmacy_products
{
	...
	// Page object name
	public $PageObjName = "pharmacy_products_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_productslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_productslist.php"); // Return to list
			}
		}
	}
