...
class ivf_oocytedenudation extends DbTable
{
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "ivf_embryology_chart") {
			$detailUrl = $GLOBALS["ivf_embryology_chart"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ivf_oocytedenudationview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ivf_oocytedenudationedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ivf_oocytedenudationadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
