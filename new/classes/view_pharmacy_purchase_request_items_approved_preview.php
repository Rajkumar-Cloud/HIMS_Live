 ...
 * Page class
 */
class view_pharmacy_purchase_request_items_approved_preview extends view_pharmacy_purchase_request_items_approved
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_purchase_request_items_approved_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'view_pharmacy_purchase_request_items_approved');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_pharmacy_purchase_request_approved") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=view_pharmacy_purchase_request_approved&fk_id=" . urlencode(strval($this->prid->QueryStringValue)) . "";
		}
		return $url;
	}
