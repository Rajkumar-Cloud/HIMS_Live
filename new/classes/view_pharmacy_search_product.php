...
class view_pharmacy_search_product extends DbTable
{
	...
	public function __construct()
	{
		...
		// Stock
		$this->Stock = new DbField('view_pharmacy_search_product', 'view_pharmacy_search_product', 'x_Stock', 'Stock', '`Stock`', '`Stock`', 20, 21, -1, FALSE, '`Stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_pharmacy_search_productview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
