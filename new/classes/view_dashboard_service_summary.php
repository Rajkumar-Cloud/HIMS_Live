...
class view_dashboard_service_summary extends DbTable
{
	...
	public function __construct()
	{
		...
		// sum(SubTotal)
		$this->sum28SubTotal29 = new DbField('view_dashboard_service_summary', 'view_dashboard_service_summary', 'x_sum28SubTotal29', 'sum(SubTotal)', '`sum(SubTotal)`', '`sum(SubTotal)`', 131, 34, -1, FALSE, '`sum(SubTotal)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "view_dashboard_service_servicetype") {
			$detailUrl = $GLOBALS["view_dashboard_service_servicetype"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_dashboard_service_summaryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
