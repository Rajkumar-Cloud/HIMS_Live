...
class ivf_treatment_plan extends DbTable
{
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "ivf_outcome") {
			$detailUrl = $GLOBALS["ivf_outcome"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
		...
		if ($this->getCurrentDetailTable() == "ivf_stimulation_chart") {
			$detailUrl = $GLOBALS["ivf_stimulation_chart"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_RIDNO=" . urlencode($this->RIDNO->CurrentValue);
			$detailUrl .= "&fk_Name=" . urlencode($this->Name->CurrentValue);
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ivf_treatment_planview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ivf_treatment_planedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("ivf_treatment_planadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
