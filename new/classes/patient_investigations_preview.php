 ...
 * Page class
 */
class patient_investigations_preview extends patient_investigations
{
	...
	// Page object name
	public $PageObjName = "patient_investigations_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_investigations');
			if ($Security->isLoggedIn())
