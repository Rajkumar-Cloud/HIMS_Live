 ...
 * Page class
 */
class view_ivf_treatment_plan_edit extends view_ivf_treatment_plan
{
	...
	// Page object name
	public $PageObjName = "view_ivf_treatment_plan_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("view_ivf_treatment_planlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "view_ivf_treatment_planlist.php")
