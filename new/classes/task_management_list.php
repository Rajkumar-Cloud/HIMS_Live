 ...
 * Page class
 */
class task_management_list extends task_management
{
	...
	// Page object name
	public $PageObjName = "task_management_list";

	// Grid form hidden field names
	public $FormName = "ftask_managementlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "task_managementadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "task_managementdelete.php";
		$this->MultiUpdateUrl = "task_managementupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ftask_managementlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "ftask_managementlistsrch");
		$filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
		$filterList = Concat($filterList, $this->TaskName->AdvancedSearch->toJson(), ","); // Field TaskName
		$filterList = Concat($filterList, $this->AssignTo->AdvancedSearch->toJson(), ","); // Field AssignTo
		...
		$filterList = Concat($filterList, $this->StatusOfTask->AdvancedSearch->toJson(), ","); // Field StatusOfTask
		$filterList = Concat($filterList, $this->ForwardTo->AdvancedSearch->toJson(), ","); // Field ForwardTo
		...
		$filterList = Concat($filterList, $this->GetModifiedName->AdvancedSearch->toJson(), ","); // Field GetModifiedName
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ftask_managementlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field TaskName
		$this->TaskName->AdvancedSearch->SearchValue = @$filter["x_TaskName"];
		$this->TaskName->AdvancedSearch->SearchOperator = @$filter["z_TaskName"];
		$this->TaskName->AdvancedSearch->SearchCondition = @$filter["v_TaskName"];
		$this->TaskName->AdvancedSearch->SearchValue2 = @$filter["y_TaskName"];
		$this->TaskName->AdvancedSearch->SearchOperator2 = @$filter["w_TaskName"];
		$this->TaskName->AdvancedSearch->save();

		// Field AssignTo
		$this->AssignTo->AdvancedSearch->SearchValue = @$filter["x_AssignTo"];
		$this->AssignTo->AdvancedSearch->SearchOperator = @$filter["z_AssignTo"];
		$this->AssignTo->AdvancedSearch->SearchCondition = @$filter["v_AssignTo"];
		$this->AssignTo->AdvancedSearch->SearchValue2 = @$filter["y_AssignTo"];
		$this->AssignTo->AdvancedSearch->SearchOperator2 = @$filter["w_AssignTo"];
		$this->AssignTo->AdvancedSearch->save();
		...
		// Field StatusOfTask
		$this->StatusOfTask->AdvancedSearch->SearchValue = @$filter["x_StatusOfTask"];
		$this->StatusOfTask->AdvancedSearch->SearchOperator = @$filter["z_StatusOfTask"];
		$this->StatusOfTask->AdvancedSearch->SearchCondition = @$filter["v_StatusOfTask"];
		$this->StatusOfTask->AdvancedSearch->SearchValue2 = @$filter["y_StatusOfTask"];
		$this->StatusOfTask->AdvancedSearch->SearchOperator2 = @$filter["w_StatusOfTask"];
		$this->StatusOfTask->AdvancedSearch->save();

		// Field ForwardTo
		$this->ForwardTo->AdvancedSearch->SearchValue = @$filter["x_ForwardTo"];
		$this->ForwardTo->AdvancedSearch->SearchOperator = @$filter["z_ForwardTo"];
		$this->ForwardTo->AdvancedSearch->SearchCondition = @$filter["v_ForwardTo"];
		$this->ForwardTo->AdvancedSearch->SearchValue2 = @$filter["y_ForwardTo"];
		$this->ForwardTo->AdvancedSearch->SearchOperator2 = @$filter["w_ForwardTo"];
		$this->ForwardTo->AdvancedSearch->save();
		...
		// Field GetModifiedName
		$this->GetModifiedName->AdvancedSearch->SearchValue = @$filter["x_GetModifiedName"];
		$this->GetModifiedName->AdvancedSearch->SearchOperator = @$filter["z_GetModifiedName"];
		$this->GetModifiedName->AdvancedSearch->SearchCondition = @$filter["v_GetModifiedName"];
		$this->GetModifiedName->AdvancedSearch->SearchValue2 = @$filter["y_GetModifiedName"];
		$this->GetModifiedName->AdvancedSearch->SearchOperator2 = @$filter["w_GetModifiedName"];
		$this->GetModifiedName->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->TaskName, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->AssignTo, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Description, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->StatusOfTask, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->ForwardTo, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->GetModifiedName, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->AssignTo); // AssignTo
			$this->updateSort($this->StartDate); // StartDate
			$this->updateSort($this->EndDate); // EndDate
			$this->updateSort($this->StatusOfTask); // StatusOfTask
			$this->updateSort($this->ForwardTo); // ForwardTo
			...
			$this->updateSort($this->GetModifiedName); // GetModifiedName
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->AssignTo->setSort("");
				$this->StartDate->setSort("");
				$this->EndDate->setSort("");
				$this->StatusOfTask->setSort("");
				$this->ForwardTo->setSort("");
				$this->createdby->setSort("");
				$this->createddatetime->setSort("");
				$this->modifiedby->setSort("");
				$this->modifieddatetime->setSort("");
				$this->GetUserName->setSort("");
				$this->GetModifiedName->setSort("");
				$this->HospID->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ftask_managementlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftask_managementlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.ftask_managementlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.ftask_managementlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.ftask_managementlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.ftask_managementlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_task_management" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_task_management\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.ftask_managementlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ftask_managementlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
