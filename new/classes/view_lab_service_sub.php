 ...
 */
class view_lab_service_sub extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_lab_service_sublist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "view_lab_service_subedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_lab_service_subadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_lab_service_subview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_lab_service_subview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_lab_service_subadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_lab_service_subadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_lab_service_subedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_lab_service_subadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_lab_service_subdelete.php", $this->getUrlParm());
	}
