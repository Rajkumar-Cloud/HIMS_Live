...
class view_lab_service_list extends view_lab_service
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "view_lab_serviceadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Visible = ($GLOBALS["view_lab_service_sub"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'view_lab_service') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["view_lab_service_sub"] && $this->DetailPages["view_lab_service_sub"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'view_lab_service')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("view_lab_service_sublist.php?" . Config("TABLE_SHOW_MASTER") . "=view_lab_service&fk_CODE=" . urlencode(strval($this->CODE->CurrentValue)) . "");
