 ...
 * Page class
 */
class ivf_oocytedenudation_stage_delete extends ivf_oocytedenudation_stage
{
	...
	// Page object name
	public $PageObjName = "ivf_oocytedenudation_stage_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_oocytedenudation_stagelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ivf_oocytedenudation_stagelist.php"); // Return to list
			}
		}
	}
