 ...
 * Page class
 */
class pres_sideeffect_table_edit extends pres_sideeffect_table
{
	...
	// Page object name
	public $PageObjName = "pres_sideeffect_table_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// SideEffects
			$this->SideEffects->setDbValueDef($rsnew, $this->SideEffects->CurrentValue, NULL, $this->SideEffects->ReadOnly);
