 ...
 * Page class
 */
class view_lab_service_sub_preview extends view_lab_service_sub
{
	...
	// Page object name
	public $PageObjName = "view_lab_service_sub_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'view_lab_service_sub');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_lab_service") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_service&fk_CODE=" . urlencode(strval($this->CODE->QueryStringValue)) . "";
		}
		return $url;
	}
