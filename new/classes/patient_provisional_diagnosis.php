...
class patient_provisional_diagnosis extends DbTable
{
	...
	public function __construct()
	{
		...
		$this->provisionaldiagnosisTemplate = new DbField('patient_provisional_diagnosis', 'patient_provisional_diagnosis', 'x_provisionaldiagnosisTemplate', 'provisionaldiagnosisTemplate', '\'\'', '\'\'', 201, 65530, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientSearch
		$this->PatientSearch = new DbField('patient_provisional_diagnosis', 'patient_provisional_diagnosis', 'x_PatientSearch', 'PatientSearch', '\'\'', '\'\'', 201, 65530, -1, FALSE, '\'\'', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("patient_provisional_diagnosisview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
