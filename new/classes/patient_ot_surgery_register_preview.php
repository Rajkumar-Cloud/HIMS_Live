 ...
 * Page class
 */
class patient_ot_surgery_register_preview extends patient_ot_surgery_register
{
	...
	// Page object name
	public $PageObjName = "patient_ot_surgery_register_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_ot_surgery_register');
			if ($Security->isLoggedIn())
