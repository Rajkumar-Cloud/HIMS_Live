 ...
 * Page class
 */
class employee_has_experience_delete extends employee_has_experience
{
	...
	// Page object name
	public $PageObjName = "employee_has_experience_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_has_experiencelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("employee_has_experiencelist.php"); // Return to list
			}
		}
	}
