 ...
 * Page class
 */
class ivf_vitrification_list extends ivf_vitrification
{
	...
	// Page object name
	public $PageObjName = "ivf_vitrification_list";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "ivf_vitrificationdelete.php";
		$this->MultiUpdateUrl = "ivf_vitrificationupdate.php";
...
// Render list options (extended codes)
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('PrimaryEmbryologist')); // PrimaryEmbryologist
		$hash .= GetFieldHash($rs->fields('SecondaryEmbryologist')); // SecondaryEmbryologist
		$hash .= GetFieldHash($rs->fields('EmbryoNo')); // EmbryoNo
		$hash .= GetFieldHash($rs->fields('FertilisationDate')); // FertilisationDate
		$hash .= GetFieldHash($rs->fields('Day')); // Day
		...
		$hash .= GetFieldHash($rs->fields('Gobiet')); // Gobiet
		$hash .= GetFieldHash($rs->fields('CryolockNo')); // CryolockNo
		$hash .= GetFieldHash($rs->fields('CryolockColour')); // CryolockColour
