...
class view_appointment_scheduler extends DbTable
{
	...
	public function __construct()
	{
		...
		// patientID
		$this->patientID = new DbField('view_appointment_scheduler', 'view_appointment_scheduler', 'x_patientID', 'patientID', '`patientID`', '`patientID`', 200, 45, -1, FALSE, '`EV__patientID`', TRUE, TRUE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_appointment_schedulerview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
