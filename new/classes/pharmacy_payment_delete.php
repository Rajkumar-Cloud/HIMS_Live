 ...
 * Page class
 */
class pharmacy_payment_delete extends pharmacy_payment
{
	...
	// Page object name
	public $PageObjName = "pharmacy_payment_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_paymentlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_paymentlist.php"); // Return to list
			}
		}
	}
