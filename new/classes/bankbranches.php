...
class bankbranches extends DbTable
{
	...
	{
		global $Language;
		if ($pageName == "bankbranchesview.php")
			return $Language->phrase("View");
		elseif ($pageName == "bankbranchesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "bankbranchesadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("bankbranchesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("bankbranchesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "bankbranchesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "bankbranchesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bankbranchesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bankbranchesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("bankbranchesdelete.php", $this->getUrlParm());
	}
