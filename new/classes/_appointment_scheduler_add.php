 ...
 * Page class
 */
class _appointment_scheduler_add extends _appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "_appointment_scheduler_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "_appointment_schedulerview.php")
