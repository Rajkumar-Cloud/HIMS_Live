 ...
 * Page class
 */
class patient_document_grid extends patient_document
{
	...
	// Page object name
	public $PageObjName = "patient_document_grid";

	// Grid form hidden field names
	public $FormName = "fpatient_documentgrid";
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->DocumentUpload->Upload->Index = $this->RowIndex;
