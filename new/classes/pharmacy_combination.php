 ...
 */
class pharmacy_combination extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "pharmacy_combinationlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "pharmacy_combinationedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "pharmacy_combinationadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("pharmacy_combinationview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("pharmacy_combinationview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "pharmacy_combinationadd.php?" . $this->getUrlParm($parm);
		else
			$url = "pharmacy_combinationadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pharmacy_combinationedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("pharmacy_combinationadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("pharmacy_combinationdelete.php", $this->getUrlParm());
	}
