 ...
 * Page class
 */
class pharmacy_grn_preview extends pharmacy_grn
{
	...
	// Page object name
	public $PageObjName = "pharmacy_grn_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'pharmacy_grn');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "pharmacy_payment") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_payment&fk_id=" . urlencode(strval($this->Pid->QueryStringValue)) . "";
		}
		return $url;
	}
