...
class view_billing_voucher_print_list extends view_billing_voucher_print
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "view_billing_voucher_printadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Visible = ($GLOBALS["view_patient_services"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'view_billing_voucher_print') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["view_patient_services"] && $this->DetailPages["view_patient_services"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'view_billing_voucher_print')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("view_patient_serviceslist.php?" . Config("TABLE_SHOW_MASTER") . "=view_billing_voucher_print&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
