...
class view_ivf_treatment extends DbTable
{
	...
	public function getDetailUrl()
	{
		...
		if ($this->getCurrentDetailTable() == "ivf_semenanalysisreport") {
			$detailUrl = $GLOBALS["ivf_semenanalysisreport"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
		...
		if ($this->getCurrentDetailTable() == "ivf_oocytedenudation") {
			$detailUrl = $GLOBALS["ivf_oocytedenudation"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
			$detailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$detailUrl .= "&fk_RIDNO=" . urlencode($this->RIDNO->CurrentValue);
			$detailUrl .= "&fk_Name=" . urlencode($this->Name->CurrentValue);
		}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_ivf_treatmentview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_ivf_treatmentedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_ivf_treatmentadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
