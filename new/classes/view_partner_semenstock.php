...
/**
 * Table class for view_partner_semenstock
 */
class view_partner_semenstock extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'view_partner_semenstock';
		$this->TableName = 'view_partner_semenstock';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`view_partner_semenstock`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// RIDNo
		$this->RIDNo = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_RIDNo', 'RIDNo', '`RIDNo`', '`RIDNo`', 3, 11, -1, FALSE, '`RIDNo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// PatientName
		$this->PatientName = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_PatientName', 'PatientName', '`PatientName`', '`PatientName`', 200, 45, -1, FALSE, '`PatientName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PatientName->Sortable = TRUE; // Allow sort
		$this->fields['PatientName'] = &$this->PatientName;

		// HusbandName
		$this->HusbandName = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_HusbandName', 'HusbandName', '`HusbandName`', '`HusbandName`', 200, 45, -1, FALSE, '`HusbandName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HusbandName->Sortable = TRUE; // Allow sort
		$this->fields['HusbandName'] = &$this->HusbandName;

		// RequestDr
		$this->RequestDr = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_RequestDr', 'RequestDr', '`RequestDr`', '`RequestDr`', 200, 45, -1, FALSE, '`RequestDr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->RequestDr->Sortable = TRUE; // Allow sort
		$this->fields['RequestDr'] = &$this->RequestDr;

		// stock
		$this->stock = new DbField('view_partner_semenstock', 'view_partner_semenstock', 'x_stock', 'stock', '`stock`', '`stock`', 20, 21, -1, FALSE, '`stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`view_partner_semenstock`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_partner_semenstocklist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_partner_semenstockview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_partner_semenstockedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_partner_semenstockadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_partner_semenstockview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_partner_semenstockview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_partner_semenstockadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_partner_semenstockadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_partner_semenstockedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_partner_semenstockadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_partner_semenstockdelete.php", $this->getUrlParm());
	}
