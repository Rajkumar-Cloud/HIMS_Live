 ...
 * Page class
 */
class patient_final_diagnosis_list extends patient_final_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_final_diagnosis_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_final_diagnosisadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "patient_final_diagnosisdelete.php";
		$this->MultiUpdateUrl = "patient_final_diagnosisupdate.php";
