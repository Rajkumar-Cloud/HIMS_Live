 ...
 * Page class
 */
class ivf_art_summary_add extends ivf_art_summary
{
	...
	// Page object name
	public $PageObjName = "ivf_art_summary_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_art_summaryview.php")
