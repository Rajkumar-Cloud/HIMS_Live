...
class store_batchmas extends DbTable
{
	...
	public function __construct()
	{
		...
		// PrName
		$this->PrName = new DbField('store_batchmas', 'store_batchmas', 'x_PrName', 'PrName', '`PrName`', '`PrName`', 200, 45, -1, FALSE, '`PrName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("store_batchmasview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
