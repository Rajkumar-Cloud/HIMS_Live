 ...
 * Page class
 */
class _appointment_scheduler_preview extends _appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "_appointment_scheduler_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'appointment_scheduler');
			if ($Security->isLoggedIn())
