...
class store_storemast extends DbTable
{
	...
	public function __construct()
	{
		...
		// STRENGTH
		$this->STRENGTH = new DbField('store_storemast', 'store_storemast', 'x_STRENGTH', 'STRENGTH', '`STRENGTH`', '`STRENGTH`', 131, 12, -1, FALSE, '`STRENGTH`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("store_storemastview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
