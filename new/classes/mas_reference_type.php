 ...
 */
class mas_reference_type extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "mas_reference_typelist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "mas_reference_typeedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "mas_reference_typeadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("mas_reference_typeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mas_reference_typeview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "mas_reference_typeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mas_reference_typeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mas_reference_typeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mas_reference_typeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("mas_reference_typedelete.php", $this->getUrlParm());
	}
