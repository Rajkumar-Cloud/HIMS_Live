...
class pharmacy_billing_voucher extends DbTable
{
	...
	public function __construct()
	{
		...
		// createddatetime
		$this->createddatetime = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UserName
		$this->UserName = new DbField('pharmacy_billing_voucher', 'pharmacy_billing_voucher', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("pharmacy_billing_voucherview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("pharmacy_billing_voucheredit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("pharmacy_billing_voucheradd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
