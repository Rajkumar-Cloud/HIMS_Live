 ...
 * Page class
 */
class patient_vitals_preview extends patient_vitals
{
	...
	// Page object name
	public $PageObjName = "patient_vitals_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_vitals');
			if ($Security->isLoggedIn())
