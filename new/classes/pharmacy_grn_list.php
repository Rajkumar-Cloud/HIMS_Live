...
class pharmacy_grn_list extends pharmacy_grn
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pharmacy_grnadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupOtherOptions()
	{
		...
		if (!isset($GLOBALS["view_pharmacygrn"]))
			$GLOBALS["view_pharmacygrn"] = new view_pharmacygrn();
		...
		$item->Visible = ($GLOBALS["view_pharmacygrn"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'pharmacy_grn') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["view_pharmacygrn"] && $this->DetailPages["view_pharmacygrn"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'pharmacy_grn')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("view_pharmacygrnlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_grn&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
