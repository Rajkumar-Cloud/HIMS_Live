 ...
 * Page class
 */
class ivf_ovum_pick_up_chart_delete extends ivf_ovum_pick_up_chart
{
	...
	// Page object name
	public $PageObjName = "ivf_ovum_pick_up_chart_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_ovum_pick_up_chartlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ivf_ovum_pick_up_chartlist.php"); // Return to list
			}
		}
	}
