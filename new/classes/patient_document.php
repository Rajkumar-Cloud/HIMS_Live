...
/**
 * Table class for patient_document
 */
class patient_document extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'patient_document';
		$this->TableName = 'patient_document';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`patient_document`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('patient_document', 'patient_document', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// patient_id
		$this->patient_id = new DbField('patient_document', 'patient_document', 'x_patient_id', 'patient_id', '`patient_id`', '`patient_id`', 3, 11, -1, FALSE, '`patient_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DocumentName
		$this->DocumentName = new DbField('patient_document', 'patient_document', 'x_DocumentName', 'DocumentName', '`DocumentName`', '`DocumentName`', 3, 11, -1, FALSE, '`DocumentName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DocumentUpload
		$this->DocumentUpload = new DbField('patient_document', 'patient_document', 'x_DocumentUpload', 'DocumentUpload', '`DocumentUpload`', '`DocumentUpload`', 201, 450, -1, TRUE, '`DocumentUpload`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		...
		// status
		$this->status = new DbField('patient_document', 'patient_document', 'x_status', 'status', '`status`', '`status`', 3, 11, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// createdby
		$this->createdby = new DbField('patient_document', 'patient_document', 'x_createdby', 'createdby', '`createdby`', '`createdby`', 3, 11, -1, FALSE, '`createdby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createdby->Sortable = TRUE; // Allow sort
		$this->createdby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['createdby'] = &$this->createdby;

		// createddatetime
		$this->createddatetime = new DbField('patient_document', 'patient_document', 'x_createddatetime', 'createddatetime', '`createddatetime`', CastDateFieldForLike("`createddatetime`", 0, "DB"), 135, 19, 0, FALSE, '`createddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->createddatetime->Sortable = TRUE; // Allow sort
		$this->createddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['createddatetime'] = &$this->createddatetime;

		// modifiedby
		$this->modifiedby = new DbField('patient_document', 'patient_document', 'x_modifiedby', 'modifiedby', '`modifiedby`', '`modifiedby`', 3, 11, -1, FALSE, '`modifiedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifiedby->Sortable = TRUE; // Allow sort
		$this->modifiedby->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['modifiedby'] = &$this->modifiedby;

		// modifieddatetime
		$this->modifieddatetime = new DbField('patient_document', 'patient_document', 'x_modifieddatetime', 'modifieddatetime', '`modifieddatetime`', CastDateFieldForLike("`modifieddatetime`", 0, "DB"), 135, 19, 0, FALSE, '`modifieddatetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->modifieddatetime->Sortable = TRUE; // Allow sort
		$this->modifieddatetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['modifieddatetime'] = &$this->modifieddatetime;

		// DocumentNumber
		$this->DocumentNumber = new DbField('patient_document', 'patient_document', 'x_DocumentNumber', 'DocumentNumber', '`DocumentNumber`', '`DocumentNumber`', 200, 45, -1, FALSE, '`DocumentNumber`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`patient_document`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "patient_documentlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "patient_documentview.php")
			return $Language->phrase("View");
		elseif ($pageName == "patient_documentedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "patient_documentadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("patient_documentview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("patient_documentview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "patient_documentadd.php?" . $this->getUrlParm($parm);
		else
			$url = "patient_documentadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("patient_documentedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("patient_documentadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("patient_documentdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->DocumentName->setDbValue($rs->fields('DocumentName'));
		$this->DocumentUpload->Upload->DbValue = $rs->fields('DocumentUpload');
		$this->status->setDbValue($rs->fields('status'));
		$this->createdby->setDbValue($rs->fields('createdby'));
		$this->createddatetime->setDbValue($rs->fields('createddatetime'));
		$this->modifiedby->setDbValue($rs->fields('modifiedby'));
		$this->modifieddatetime->setDbValue($rs->fields('modifieddatetime'));
		$this->DocumentNumber->setDbValue($rs->fields('DocumentNumber'));
	}
