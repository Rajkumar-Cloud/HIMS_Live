 ...
 * Page class
 */
class employee_address_delete extends employee_address
{
	...
	// Page object name
	public $PageObjName = "employee_address_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_addresslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("employee_addresslist.php"); // Return to list
			}
		}
	}
