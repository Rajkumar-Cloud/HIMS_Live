 ...
 * Page class
 */
class monitor_treatment_plan_edit extends monitor_treatment_plan
{
	...
	// Page object name
	public $PageObjName = "monitor_treatment_plan_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// NewVisitDate
			$this->NewVisitDate->setDbValueDef($rsnew, UnFormatDateTime($this->NewVisitDate->CurrentValue, 7), NULL, $this->NewVisitDate->ReadOnly);
			...
			// IUIDoneDate1
			$this->IUIDoneDate1->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate1->CurrentValue, 7), NULL, $this->IUIDoneDate1->ReadOnly);

			// IUIDoneYesNo1
			$this->IUIDoneYesNo1->setDbValueDef($rsnew, $this->IUIDoneYesNo1->CurrentValue, NULL, $this->IUIDoneYesNo1->ReadOnly);

			// UPTTestDate1
			$this->UPTTestDate1->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate1->CurrentValue, 7), NULL, $this->UPTTestDate1->ReadOnly);

			// UPTTestYesNo1
			$this->UPTTestYesNo1->setDbValueDef($rsnew, $this->UPTTestYesNo1->CurrentValue, NULL, $this->UPTTestYesNo1->ReadOnly);

			// IUIDoneDate2
			$this->IUIDoneDate2->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate2->CurrentValue, 7), NULL, $this->IUIDoneDate2->ReadOnly);

			// IUIDoneYesNo2
			$this->IUIDoneYesNo2->setDbValueDef($rsnew, $this->IUIDoneYesNo2->CurrentValue, NULL, $this->IUIDoneYesNo2->ReadOnly);

			// UPTTestDate2
			$this->UPTTestDate2->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate2->CurrentValue, 7), NULL, $this->UPTTestDate2->ReadOnly);

			// UPTTestYesNo2
			$this->UPTTestYesNo2->setDbValueDef($rsnew, $this->UPTTestYesNo2->CurrentValue, NULL, $this->UPTTestYesNo2->ReadOnly);

			// IUIDoneDate3
			$this->IUIDoneDate3->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate3->CurrentValue, 7), NULL, $this->IUIDoneDate3->ReadOnly);

			// IUIDoneYesNo3
			$this->IUIDoneYesNo3->setDbValueDef($rsnew, $this->IUIDoneYesNo3->CurrentValue, NULL, $this->IUIDoneYesNo3->ReadOnly);

			// UPTTestDate3
			$this->UPTTestDate3->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate3->CurrentValue, 7), NULL, $this->UPTTestDate3->ReadOnly);

			// UPTTestYesNo3
			$this->UPTTestYesNo3->setDbValueDef($rsnew, $this->UPTTestYesNo3->CurrentValue, NULL, $this->UPTTestYesNo3->ReadOnly);

			// IUIDoneDate4
			$this->IUIDoneDate4->setDbValueDef($rsnew, UnFormatDateTime($this->IUIDoneDate4->CurrentValue, 7), NULL, $this->IUIDoneDate4->ReadOnly);

			// IUIDoneYesNo4
			$this->IUIDoneYesNo4->setDbValueDef($rsnew, $this->IUIDoneYesNo4->CurrentValue, NULL, $this->IUIDoneYesNo4->ReadOnly);

			// UPTTestDate4
			$this->UPTTestDate4->setDbValueDef($rsnew, UnFormatDateTime($this->UPTTestDate4->CurrentValue, 7), NULL, $this->UPTTestDate4->ReadOnly);

			// UPTTestYesNo4
			$this->UPTTestYesNo4->setDbValueDef($rsnew, $this->UPTTestYesNo4->CurrentValue, NULL, $this->UPTTestYesNo4->ReadOnly);

			// IVFStimulationDate
			$this->IVFStimulationDate->setDbValueDef($rsnew, UnFormatDateTime($this->IVFStimulationDate->CurrentValue, 7), NULL, $this->IVFStimulationDate->ReadOnly);
			...
			// OPUDate
			$this->OPUDate->setDbValueDef($rsnew, UnFormatDateTime($this->OPUDate->CurrentValue, 7), NULL, $this->OPUDate->ReadOnly);

			// OPUYesNo
			$this->OPUYesNo->setDbValueDef($rsnew, $this->OPUYesNo->CurrentValue, NULL, $this->OPUYesNo->ReadOnly);

			// ETDate
			$this->ETDate->setDbValueDef($rsnew, UnFormatDateTime($this->ETDate->CurrentValue, 7), NULL, $this->ETDate->ReadOnly);

			// ETYesNo
			$this->ETYesNo->setDbValueDef($rsnew, $this->ETYesNo->CurrentValue, NULL, $this->ETYesNo->ReadOnly);

			// BetaHCGDate
			$this->BetaHCGDate->setDbValueDef($rsnew, UnFormatDateTime($this->BetaHCGDate->CurrentValue, 7), NULL, $this->BetaHCGDate->ReadOnly);

			// BetaHCGYesNo
			$this->BetaHCGYesNo->setDbValueDef($rsnew, $this->BetaHCGYesNo->CurrentValue, NULL, $this->BetaHCGYesNo->ReadOnly);

			// FETDate
			$this->FETDate->setDbValueDef($rsnew, UnFormatDateTime($this->FETDate->CurrentValue, 7), NULL, $this->FETDate->ReadOnly);

			// FETYesNo
			$this->FETYesNo->setDbValueDef($rsnew, $this->FETYesNo->CurrentValue, NULL, $this->FETYesNo->ReadOnly);

			// FBetaHCGDate
			$this->FBetaHCGDate->setDbValueDef($rsnew, UnFormatDateTime($this->FBetaHCGDate->CurrentValue, 7), NULL, $this->FBetaHCGDate->ReadOnly);
