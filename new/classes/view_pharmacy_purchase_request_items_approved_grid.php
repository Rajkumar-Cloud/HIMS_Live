 ...
 * Page class
 */
class view_pharmacy_purchase_request_items_approved_grid extends view_pharmacy_purchase_request_items_approved
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_purchase_request_items_approved_grid";

	// Grid form hidden field names
	public $FormName = "fview_pharmacy_purchase_request_items_approvedgrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "view_pharmacy_purchase_request_approved") {
			$this->prid->Visible = FALSE;
			if ($GLOBALS["view_pharmacy_purchase_request_approved"]->EventCancelled)
