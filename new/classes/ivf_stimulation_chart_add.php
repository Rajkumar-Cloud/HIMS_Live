 ...
 * Page class
 */
class ivf_stimulation_chart_add extends ivf_stimulation_chart
{
	...
	// Page object name
	public $PageObjName = "ivf_stimulation_chart_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_stimulation_chartview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->Projectron->CurrentValue = NULL;
		$this->Projectron->OldValue = $this->Projectron->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['Projectron'] = $this->Projectron->CurrentValue;
	...
	protected function validateForm()
	{
		...
		if ($this->ATHOMEorCLINIC->Required) {
			if (!$this->ATHOMEorCLINIC->IsDetailKey && $this->ATHOMEorCLINIC->FormValue != NULL && $this->ATHOMEorCLINIC->FormValue == "") {
	...
	protected function addRow($rsold = NULL)
	{
		...
		// SCDate
		$this->SCDate->setDbValueDef($rsnew, UnFormatDateTime($this->SCDate->CurrentValue, 7), NULL, FALSE);
		...
		// TRIGGERDATE
		$this->TRIGGERDATE->setDbValueDef($rsnew, UnFormatDateTime($this->TRIGGERDATE->CurrentValue, 11), NULL, FALSE);

		// ATHOMEorCLINIC
		$this->ATHOMEorCLINIC->setDbValueDef($rsnew, $this->ATHOMEorCLINIC->CurrentValue, NULL, FALSE);

		// OPUDATE
		$this->OPUDATE->setDbValueDef($rsnew, UnFormatDateTime($this->OPUDATE->CurrentValue, 11), NULL, FALSE);
		...
		// DATEOFET
		$this->DATEOFET->setDbValueDef($rsnew, UnFormatDateTime($this->DATEOFET->CurrentValue, 11), NULL, FALSE);
		...
		// StChDate1
		$this->StChDate1->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate1->CurrentValue, 7), NULL, FALSE);

		// StChDate2
		$this->StChDate2->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate2->CurrentValue, 7), NULL, FALSE);

		// StChDate3
		$this->StChDate3->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate3->CurrentValue, 7), NULL, FALSE);

		// StChDate4
		$this->StChDate4->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate4->CurrentValue, 7), NULL, FALSE);

		// StChDate5
		$this->StChDate5->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate5->CurrentValue, 7), NULL, FALSE);

		// StChDate6
		$this->StChDate6->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate6->CurrentValue, 7), NULL, FALSE);

		// StChDate7
		$this->StChDate7->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate7->CurrentValue, 7), NULL, FALSE);

		// StChDate8
		$this->StChDate8->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate8->CurrentValue, 7), NULL, FALSE);

		// StChDate9
		$this->StChDate9->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate9->CurrentValue, 7), NULL, FALSE);

		// StChDate10
		$this->StChDate10->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate10->CurrentValue, 7), NULL, FALSE);

		// StChDate11
		$this->StChDate11->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate11->CurrentValue, 7), NULL, FALSE);

		// StChDate12
		$this->StChDate12->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate12->CurrentValue, 7), NULL, FALSE);

		// StChDate13
		$this->StChDate13->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate13->CurrentValue, 7), NULL, FALSE);
		...
		// DATOFEMBRYOTRANSFER
		$this->DATOFEMBRYOTRANSFER->setDbValueDef($rsnew, $this->DATOFEMBRYOTRANSFER->CurrentValue, NULL, FALSE);
		...
		// Projectron
		$this->Projectron->setDbValueDef($rsnew, $this->Projectron->CurrentValue, "", FALSE);

		// StChDate14
		$this->StChDate14->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate14->CurrentValue, 7), NULL, FALSE);

		// StChDate15
		$this->StChDate15->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate15->CurrentValue, 7), NULL, FALSE);

		// StChDate16
		$this->StChDate16->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate16->CurrentValue, 7), NULL, FALSE);

		// StChDate17
		$this->StChDate17->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate17->CurrentValue, 7), NULL, FALSE);

		// StChDate18
		$this->StChDate18->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate18->CurrentValue, 7), NULL, FALSE);

		// StChDate19
		$this->StChDate19->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate19->CurrentValue, 7), NULL, FALSE);

		// StChDate20
		$this->StChDate20->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate20->CurrentValue, 7), NULL, FALSE);

		// StChDate21
		$this->StChDate21->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate21->CurrentValue, 7), NULL, FALSE);

		// StChDate22
		$this->StChDate22->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate22->CurrentValue, 7), NULL, FALSE);

		// StChDate23
		$this->StChDate23->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate23->CurrentValue, 7), NULL, FALSE);

		// StChDate24
		$this->StChDate24->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate24->CurrentValue, 7), NULL, FALSE);

		// StChDate25
		$this->StChDate25->setDbValueDef($rsnew, UnFormatDateTime($this->StChDate25->CurrentValue, 7), NULL, FALSE);
		...
		// EEETTTDTE
		$this->EEETTTDTE->setDbValueDef($rsnew, UnFormatDateTime($this->EEETTTDTE->CurrentValue, 7), NULL, FALSE);

		// bhcgdate
		$this->bhcgdate->setDbValueDef($rsnew, UnFormatDateTime($this->bhcgdate->CurrentValue, 7), NULL, FALSE);
