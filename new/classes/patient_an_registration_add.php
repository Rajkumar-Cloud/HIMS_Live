 ...
 * Page class
 */
class patient_an_registration_add extends patient_an_registration
{
	...
	// Page object name
	public $PageObjName = "patient_an_registration_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "patient_an_registrationview.php")
