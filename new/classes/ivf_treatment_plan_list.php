...
class ivf_treatment_plan_list extends ivf_treatment_plan
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "ivf_treatment_planadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupOtherOptions()
	{
		...
		if (!isset($GLOBALS["ivf_outcome"]))
			$GLOBALS["ivf_outcome"] = new ivf_outcome();
		...
		$item->Visible = ($GLOBALS["ivf_outcome"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ivf_treatment_plan') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["ivf_stimulation_chart"]))
			$GLOBALS["ivf_stimulation_chart"] = new ivf_stimulation_chart();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["ivf_stimulation_chart"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["ivf_stimulation_chart"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ivf_treatment_plan') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		if (!isset($GLOBALS["ivf_semenanalysisreport"]))
			$GLOBALS["ivf_semenanalysisreport"] = new ivf_semenanalysisreport();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["ivf_semenanalysisreport"]->tableCaption();
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["ivf_semenanalysisreport"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ivf_treatment_plan') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
		...
		$item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a>";
		$item->Visible = ($GLOBALS["ivf_embryology_chart"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'ivf_treatment_plan') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
