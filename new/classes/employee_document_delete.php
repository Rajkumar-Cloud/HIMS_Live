 ...
 * Page class
 */
class employee_document_delete extends employee_document
{
	...
	// Page object name
	public $PageObjName = "employee_document_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("employee_documentlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("employee_documentlist.php"); // Return to list
			}
		}
	}
