 ...
 * Page class
 */
class lab_dept_mast_delete extends lab_dept_mast
{
	...
	// Page object name
	public $PageObjName = "lab_dept_mast_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lab_dept_mastlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lab_dept_mastlist.php"); // Return to list
			}
		}
	}
