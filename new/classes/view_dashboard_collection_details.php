...
class view_dashboard_collection_details extends DbTable
{
	...
	public function __construct()
	{
		...
		// UserName
		$this->UserName = new DbField('view_dashboard_collection_details', 'view_dashboard_collection_details', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_dashboard_collection_detailsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
