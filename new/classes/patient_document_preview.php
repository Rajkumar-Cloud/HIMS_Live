 ...
 * Page class
 */
class patient_document_preview extends patient_document
{
	...
	// Page object name
	public $PageObjName = "patient_document_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_document');
			if ($Security->isLoggedIn())
