 ...
 * Page class
 */
class lab_profile_details_grid extends lab_profile_details
{
	...
	// Page object name
	public $PageObjName = "lab_profile_details_grid";

	// Grid form hidden field names
	public $FormName = "flab_profile_detailsgrid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "view_lab_profile") {
			...
			if ($GLOBALS["view_lab_profile"]->EventCancelled)
