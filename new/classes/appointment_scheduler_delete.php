 ...
 * Page class
 */
class appointment_scheduler_delete extends appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "appointment_scheduler_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("appointment_schedulerlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("appointment_schedulerlist.php"); // Return to list
			}
		}
	}
