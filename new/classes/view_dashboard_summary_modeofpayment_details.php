...
class view_dashboard_summary_modeofpayment_details extends DbTable
{
	...
	public function __construct()
	{
		...
		// UserName
		$this->UserName = new DbField('view_dashboard_summary_modeofpayment_details', 'view_dashboard_summary_modeofpayment_details', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sum(Amount)
		$this->sum28Amount29 = new DbField('view_dashboard_summary_modeofpayment_details', 'view_dashboard_summary_modeofpayment_details', 'x_sum28Amount29', 'sum(Amount)', '`sum(Amount)`', '`sum(Amount)`', 131, 34, -1, FALSE, '`sum(Amount)`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_dashboard_summary_modeofpayment_detailsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
