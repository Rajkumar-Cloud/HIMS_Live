 ...
 * Page class
 */
class deposit_pettycash_delete extends deposit_pettycash
{
	...
	// Page object name
	public $PageObjName = "deposit_pettycash_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("deposit_pettycashlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("deposit_pettycashlist.php"); // Return to list
			}
		}
	}
