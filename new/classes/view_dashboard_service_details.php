...
class view_dashboard_service_details extends DbTable
{
	...
	{
		return "`DEPARTMENT`='@DEPARTMENT@' AND `HospID`=@HospID@ AND `createdDate`='@createdDate@' AND `SERVICE_TYPE`='@SERVICE_TYPE@'";
	}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_dashboard_service_detailsview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
