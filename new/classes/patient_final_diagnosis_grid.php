 ...
 * Page class
 */
class patient_final_diagnosis_grid extends patient_final_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_final_diagnosis_grid";

	// Grid form hidden field names
	public $FormName = "fpatient_final_diagnosisgrid";
