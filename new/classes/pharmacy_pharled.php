...
class pharmacy_pharled extends DbTable
{
	...
	public function __construct()
	{
		...
		$this->SLNO->Lookup = new Lookup('SLNO', 'view_pharmacy_search_product', FALSE, 'id', ["DES","Stock","BATCH","EXPDT"], [], [], [], [], ["DES","RT","MFRCODE","EXPDT","BATCH","BRCODE","PRC","Stock","MFRCODE"], ["x_Product","x_RT","x_Mfg","x_EXPDT","x_BATCHNO","x_BRCODE","x_PRC","x_UR","x_MFRCODE"], '`EXPDT` ASC', '');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("pharmacy_pharledview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
