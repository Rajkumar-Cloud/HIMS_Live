 ...
 * Page class
 */
class pharmacy_products_edit extends pharmacy_products
{
	...
	// Page object name
	public $PageObjName = "pharmacy_products_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ProductCode") !== NULL) {
				...
				$this->ProductCode->setOldValue($this->ProductCode->QueryStringValue);
			} elseif (Key(0) !== NULL) {
				$this->ProductCode->setQueryStringValue(Key(0));
				$this->ProductCode->setOldValue($this->ProductCode->QueryStringValue);
			} elseif (Post("ProductCode") !== NULL) {
				$this->ProductCode->setFormValue(Post("ProductCode"));
				$this->ProductCode->setOldValue($this->ProductCode->FormValue);
			} elseif (Route(2) !== NULL) {
				$this->ProductCode->setQueryStringValue(Route(2));
				$this->ProductCode->setOldValue($this->ProductCode->QueryStringValue);
			} else {
			...
			if (Post("action") !== NULL) {
				...
				// Load key from Form
				if ($CurrentForm->hasValue("x_ProductCode")) {
					$this->ProductCode->setFormValue($CurrentForm->getValue("x_ProductCode"));
				}
			} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// DivisionCode
			$this->DivisionCode->setDbValueDef($rsnew, $this->DivisionCode->CurrentValue, NULL, $this->DivisionCode->ReadOnly);

			// ManufacturerCode
			$this->ManufacturerCode->setDbValueDef($rsnew, $this->ManufacturerCode->CurrentValue, NULL, $this->ManufacturerCode->ReadOnly);

			// SupplierCode
			$this->SupplierCode->setDbValueDef($rsnew, $this->SupplierCode->CurrentValue, NULL, $this->SupplierCode->ReadOnly);

			// AlternateSupplierCodes
			$this->AlternateSupplierCodes->setDbValueDef($rsnew, $this->AlternateSupplierCodes->CurrentValue, NULL, $this->AlternateSupplierCodes->ReadOnly);

			// AlternateProductCode
			$this->AlternateProductCode->setDbValueDef($rsnew, $this->AlternateProductCode->CurrentValue, NULL, $this->AlternateProductCode->ReadOnly);

			// UniversalProductCode
			$this->UniversalProductCode->setDbValueDef($rsnew, $this->UniversalProductCode->CurrentValue, NULL, $this->UniversalProductCode->ReadOnly);

			// BookProductCode
			$this->BookProductCode->setDbValueDef($rsnew, $this->BookProductCode->CurrentValue, NULL, $this->BookProductCode->ReadOnly);

			// OldCode
			$this->OldCode->setDbValueDef($rsnew, $this->OldCode->CurrentValue, NULL, $this->OldCode->ReadOnly);

			// ProtectedProducts
			$this->ProtectedProducts->setDbValueDef($rsnew, $this->ProtectedProducts->CurrentValue, NULL, $this->ProtectedProducts->ReadOnly);

			// ProductFullName
			$this->ProductFullName->setDbValueDef($rsnew, $this->ProductFullName->CurrentValue, NULL, $this->ProductFullName->ReadOnly);

			// UnitOfMeasure
			$this->UnitOfMeasure->setDbValueDef($rsnew, $this->UnitOfMeasure->CurrentValue, NULL, $this->UnitOfMeasure->ReadOnly);

			// UnitDescription
			$this->UnitDescription->setDbValueDef($rsnew, $this->UnitDescription->CurrentValue, NULL, $this->UnitDescription->ReadOnly);

			// BulkDescription
			$this->BulkDescription->setDbValueDef($rsnew, $this->BulkDescription->CurrentValue, NULL, $this->BulkDescription->ReadOnly);

			// BarCodeDescription
			$this->BarCodeDescription->setDbValueDef($rsnew, $this->BarCodeDescription->CurrentValue, NULL, $this->BarCodeDescription->ReadOnly);

			// PackageInformation
			$this->PackageInformation->setDbValueDef($rsnew, $this->PackageInformation->CurrentValue, NULL, $this->PackageInformation->ReadOnly);

			// PackageId
			$this->PackageId->setDbValueDef($rsnew, $this->PackageId->CurrentValue, NULL, $this->PackageId->ReadOnly);

			// Weight
			$this->Weight->setDbValueDef($rsnew, $this->Weight->CurrentValue, NULL, $this->Weight->ReadOnly);

			// AllowFractions
			$this->AllowFractions->setDbValueDef($rsnew, $this->AllowFractions->CurrentValue, NULL, $this->AllowFractions->ReadOnly);

			// MinimumStockLevel
			$this->MinimumStockLevel->setDbValueDef($rsnew, $this->MinimumStockLevel->CurrentValue, NULL, $this->MinimumStockLevel->ReadOnly);

			// MaximumStockLevel
			$this->MaximumStockLevel->setDbValueDef($rsnew, $this->MaximumStockLevel->CurrentValue, NULL, $this->MaximumStockLevel->ReadOnly);

			// ReorderLevel
			$this->ReorderLevel->setDbValueDef($rsnew, $this->ReorderLevel->CurrentValue, NULL, $this->ReorderLevel->ReadOnly);

			// MinMaxRatio
			$this->MinMaxRatio->setDbValueDef($rsnew, $this->MinMaxRatio->CurrentValue, NULL, $this->MinMaxRatio->ReadOnly);

			// AutoMinMaxRatio
			$this->AutoMinMaxRatio->setDbValueDef($rsnew, $this->AutoMinMaxRatio->CurrentValue, NULL, $this->AutoMinMaxRatio->ReadOnly);

			// ScheduleCode
			$this->ScheduleCode->setDbValueDef($rsnew, $this->ScheduleCode->CurrentValue, NULL, $this->ScheduleCode->ReadOnly);

			// RopRatio
			$this->RopRatio->setDbValueDef($rsnew, $this->RopRatio->CurrentValue, NULL, $this->RopRatio->ReadOnly);
			...
			// PurchaseUnit
			$this->PurchaseUnit->setDbValueDef($rsnew, $this->PurchaseUnit->CurrentValue, NULL, $this->PurchaseUnit->ReadOnly);

			// PurchaseTaxCode
			$this->PurchaseTaxCode->setDbValueDef($rsnew, $this->PurchaseTaxCode->CurrentValue, NULL, $this->PurchaseTaxCode->ReadOnly);

			// AllowDirectInward
			$this->AllowDirectInward->setDbValueDef($rsnew, $this->AllowDirectInward->CurrentValue, NULL, $this->AllowDirectInward->ReadOnly);

			// SalePrice
			$this->SalePrice->setDbValueDef($rsnew, $this->SalePrice->CurrentValue, NULL, $this->SalePrice->ReadOnly);

			// SaleUnit
			$this->SaleUnit->setDbValueDef($rsnew, $this->SaleUnit->CurrentValue, NULL, $this->SaleUnit->ReadOnly);

			// SalesTaxCode
			$this->SalesTaxCode->setDbValueDef($rsnew, $this->SalesTaxCode->CurrentValue, NULL, $this->SalesTaxCode->ReadOnly);

			// StockReceived
			$this->StockReceived->setDbValueDef($rsnew, $this->StockReceived->CurrentValue, NULL, $this->StockReceived->ReadOnly);

			// TotalStock
			$this->TotalStock->setDbValueDef($rsnew, $this->TotalStock->CurrentValue, NULL, $this->TotalStock->ReadOnly);

			// StockType
			$this->StockType->setDbValueDef($rsnew, $this->StockType->CurrentValue, NULL, $this->StockType->ReadOnly);

			// StockCheckDate
			$this->StockCheckDate->setDbValueDef($rsnew, UnFormatDateTime($this->StockCheckDate->CurrentValue, 0), NULL, $this->StockCheckDate->ReadOnly);

			// StockAdjustmentDate
			$this->StockAdjustmentDate->setDbValueDef($rsnew, UnFormatDateTime($this->StockAdjustmentDate->CurrentValue, 0), NULL, $this->StockAdjustmentDate->ReadOnly);

			// Remarks
			$this->Remarks->setDbValueDef($rsnew, $this->Remarks->CurrentValue, NULL, $this->Remarks->ReadOnly);

			// CostCentre
			$this->CostCentre->setDbValueDef($rsnew, $this->CostCentre->CurrentValue, NULL, $this->CostCentre->ReadOnly);
			...
			// TaxId
			$this->TaxId->setDbValueDef($rsnew, $this->TaxId->CurrentValue, NULL, $this->TaxId->ReadOnly);

			// ResaleTaxApplicable
			$this->ResaleTaxApplicable->setDbValueDef($rsnew, $this->ResaleTaxApplicable->CurrentValue, NULL, $this->ResaleTaxApplicable->ReadOnly);

			// CstOtherTax
			$this->CstOtherTax->setDbValueDef($rsnew, $this->CstOtherTax->CurrentValue, NULL, $this->CstOtherTax->ReadOnly);

			// TotalTax
			$this->TotalTax->setDbValueDef($rsnew, $this->TotalTax->CurrentValue, NULL, $this->TotalTax->ReadOnly);

			// ItemCost
			$this->ItemCost->setDbValueDef($rsnew, $this->ItemCost->CurrentValue, NULL, $this->ItemCost->ReadOnly);

			// ExpiryDate
			$this->ExpiryDate->setDbValueDef($rsnew, UnFormatDateTime($this->ExpiryDate->CurrentValue, 0), NULL, $this->ExpiryDate->ReadOnly);

			// BatchDescription
			$this->BatchDescription->setDbValueDef($rsnew, $this->BatchDescription->CurrentValue, NULL, $this->BatchDescription->ReadOnly);

			// FreeScheme
			$this->FreeScheme->setDbValueDef($rsnew, $this->FreeScheme->CurrentValue, NULL, $this->FreeScheme->ReadOnly);

			// CashDiscountEligibility
			$this->CashDiscountEligibility->setDbValueDef($rsnew, $this->CashDiscountEligibility->CurrentValue, NULL, $this->CashDiscountEligibility->ReadOnly);

			// DiscountPerAllowInBill
			$this->DiscountPerAllowInBill->setDbValueDef($rsnew, $this->DiscountPerAllowInBill->CurrentValue, NULL, $this->DiscountPerAllowInBill->ReadOnly);
			...
			// StandardMargin
			$this->StandardMargin->setDbValueDef($rsnew, $this->StandardMargin->CurrentValue, NULL, $this->StandardMargin->ReadOnly);

			// Margin
			$this->Margin->setDbValueDef($rsnew, $this->Margin->CurrentValue, NULL, $this->Margin->ReadOnly);

			// MarginId
			$this->MarginId->setDbValueDef($rsnew, $this->MarginId->CurrentValue, NULL, $this->MarginId->ReadOnly);

			// ExpectedMargin
			$this->ExpectedMargin->setDbValueDef($rsnew, $this->ExpectedMargin->CurrentValue, NULL, $this->ExpectedMargin->ReadOnly);

			// SurchargeBeforeTax
			$this->SurchargeBeforeTax->setDbValueDef($rsnew, $this->SurchargeBeforeTax->CurrentValue, NULL, $this->SurchargeBeforeTax->ReadOnly);

			// SurchargeAfterTax
			$this->SurchargeAfterTax->setDbValueDef($rsnew, $this->SurchargeAfterTax->CurrentValue, NULL, $this->SurchargeAfterTax->ReadOnly);

			// TempOrderNo
			$this->TempOrderNo->setDbValueDef($rsnew, $this->TempOrderNo->CurrentValue, NULL, $this->TempOrderNo->ReadOnly);

			// TempOrderDate
			$this->TempOrderDate->setDbValueDef($rsnew, UnFormatDateTime($this->TempOrderDate->CurrentValue, 0), NULL, $this->TempOrderDate->ReadOnly);

			// OrderUnit
			$this->OrderUnit->setDbValueDef($rsnew, $this->OrderUnit->CurrentValue, NULL, $this->OrderUnit->ReadOnly);

			// OrderQuantity
			$this->OrderQuantity->setDbValueDef($rsnew, $this->OrderQuantity->CurrentValue, NULL, $this->OrderQuantity->ReadOnly);

			// MarkForOrder
			$this->MarkForOrder->setDbValueDef($rsnew, $this->MarkForOrder->CurrentValue, NULL, $this->MarkForOrder->ReadOnly);

			// OrderAllId
			$this->OrderAllId->setDbValueDef($rsnew, $this->OrderAllId->CurrentValue, NULL, $this->OrderAllId->ReadOnly);

			// CalculateOrderQty
			$this->CalculateOrderQty->setDbValueDef($rsnew, $this->CalculateOrderQty->CurrentValue, NULL, $this->CalculateOrderQty->ReadOnly);

			// SubLocation
			$this->SubLocation->setDbValueDef($rsnew, $this->SubLocation->CurrentValue, NULL, $this->SubLocation->ReadOnly);

			// CategoryCode
			$this->CategoryCode->setDbValueDef($rsnew, $this->CategoryCode->CurrentValue, NULL, $this->CategoryCode->ReadOnly);

			// SubCategory
			$this->SubCategory->setDbValueDef($rsnew, $this->SubCategory->CurrentValue, NULL, $this->SubCategory->ReadOnly);

			// FlexCategoryCode
			$this->FlexCategoryCode->setDbValueDef($rsnew, $this->FlexCategoryCode->CurrentValue, NULL, $this->FlexCategoryCode->ReadOnly);

			// ABCSaleQty
			$this->ABCSaleQty->setDbValueDef($rsnew, $this->ABCSaleQty->CurrentValue, NULL, $this->ABCSaleQty->ReadOnly);

			// ABCSaleValue
			$this->ABCSaleValue->setDbValueDef($rsnew, $this->ABCSaleValue->CurrentValue, NULL, $this->ABCSaleValue->ReadOnly);

			// ConvertionFactor
			$this->ConvertionFactor->setDbValueDef($rsnew, $this->ConvertionFactor->CurrentValue, 0, $this->ConvertionFactor->ReadOnly);

			// ConvertionUnitDesc
			$this->ConvertionUnitDesc->setDbValueDef($rsnew, $this->ConvertionUnitDesc->CurrentValue, NULL, $this->ConvertionUnitDesc->ReadOnly);

			// TransactionId
			$this->TransactionId->setDbValueDef($rsnew, $this->TransactionId->CurrentValue, NULL, $this->TransactionId->ReadOnly);

			// SoldProductId
			$this->SoldProductId->setDbValueDef($rsnew, $this->SoldProductId->CurrentValue, NULL, $this->SoldProductId->ReadOnly);

			// WantedBookId
			$this->WantedBookId->setDbValueDef($rsnew, $this->WantedBookId->CurrentValue, NULL, $this->WantedBookId->ReadOnly);

			// AllId
			$this->AllId->setDbValueDef($rsnew, $this->AllId->CurrentValue, NULL, $this->AllId->ReadOnly);

			// BatchAndExpiryCompulsory
			$this->BatchAndExpiryCompulsory->setDbValueDef($rsnew, $this->BatchAndExpiryCompulsory->CurrentValue, NULL, $this->BatchAndExpiryCompulsory->ReadOnly);

			// BatchStockForWantedBook
			$this->BatchStockForWantedBook->setDbValueDef($rsnew, $this->BatchStockForWantedBook->CurrentValue, NULL, $this->BatchStockForWantedBook->ReadOnly);

			// UnitBasedBilling
			$this->UnitBasedBilling->setDbValueDef($rsnew, $this->UnitBasedBilling->CurrentValue, NULL, $this->UnitBasedBilling->ReadOnly);

			// DoNotCheckStock
			$this->DoNotCheckStock->setDbValueDef($rsnew, $this->DoNotCheckStock->CurrentValue, NULL, $this->DoNotCheckStock->ReadOnly);

			// AcceptRate
			$this->AcceptRate->setDbValueDef($rsnew, $this->AcceptRate->CurrentValue, NULL, $this->AcceptRate->ReadOnly);

			// PriceLevel
			$this->PriceLevel->setDbValueDef($rsnew, $this->PriceLevel->CurrentValue, NULL, $this->PriceLevel->ReadOnly);

			// LastQuotePrice
			$this->LastQuotePrice->setDbValueDef($rsnew, $this->LastQuotePrice->CurrentValue, NULL, $this->LastQuotePrice->ReadOnly);

			// PriceChange
			$this->PriceChange->setDbValueDef($rsnew, $this->PriceChange->CurrentValue, NULL, $this->PriceChange->ReadOnly);

			// CommodityCode
			$this->CommodityCode->setDbValueDef($rsnew, $this->CommodityCode->CurrentValue, NULL, $this->CommodityCode->ReadOnly);

			// InstitutePrice
			$this->InstitutePrice->setDbValueDef($rsnew, $this->InstitutePrice->CurrentValue, NULL, $this->InstitutePrice->ReadOnly);

			// CtrlOrDCtrlProduct
			$this->CtrlOrDCtrlProduct->setDbValueDef($rsnew, $this->CtrlOrDCtrlProduct->CurrentValue, NULL, $this->CtrlOrDCtrlProduct->ReadOnly);

			// ImportedDate
			$this->ImportedDate->setDbValueDef($rsnew, UnFormatDateTime($this->ImportedDate->CurrentValue, 0), NULL, $this->ImportedDate->ReadOnly);

			// IsImported
			$this->IsImported->setDbValueDef($rsnew, $this->IsImported->CurrentValue, NULL, $this->IsImported->ReadOnly);

			// FileName
			$this->FileName->setDbValueDef($rsnew, $this->FileName->CurrentValue, NULL, $this->FileName->ReadOnly);

			// LPName
			$this->LPName->setDbValueDef($rsnew, $this->LPName->CurrentValue, NULL, $this->LPName->ReadOnly);

			// GodownNumber
			$this->GodownNumber->setDbValueDef($rsnew, $this->GodownNumber->CurrentValue, NULL, $this->GodownNumber->ReadOnly);

			// CreationDate
			$this->CreationDate->setDbValueDef($rsnew, UnFormatDateTime($this->CreationDate->CurrentValue, 0), NULL, $this->CreationDate->ReadOnly);

			// CreatedbyUser
			$this->CreatedbyUser->setDbValueDef($rsnew, $this->CreatedbyUser->CurrentValue, NULL, $this->CreatedbyUser->ReadOnly);

			// ModifiedDate
			$this->ModifiedDate->setDbValueDef($rsnew, UnFormatDateTime($this->ModifiedDate->CurrentValue, 0), NULL, $this->ModifiedDate->ReadOnly);

			// ModifiedbyUser
			$this->ModifiedbyUser->setDbValueDef($rsnew, $this->ModifiedbyUser->CurrentValue, NULL, $this->ModifiedbyUser->ReadOnly);

			// isActive
			$this->isActive->setDbValueDef($rsnew, $this->isActive->CurrentValue, NULL, $this->isActive->ReadOnly);

			// AllowExpiryClaim
			$this->AllowExpiryClaim->setDbValueDef($rsnew, $this->AllowExpiryClaim->CurrentValue, NULL, $this->AllowExpiryClaim->ReadOnly);

			// BrandCode
			$this->BrandCode->setDbValueDef($rsnew, $this->BrandCode->CurrentValue, NULL, $this->BrandCode->ReadOnly);

			// FreeSchemeBasedon
			$this->FreeSchemeBasedon->setDbValueDef($rsnew, $this->FreeSchemeBasedon->CurrentValue, NULL, $this->FreeSchemeBasedon->ReadOnly);

			// DoNotCheckCostInBill
			$this->DoNotCheckCostInBill->setDbValueDef($rsnew, $this->DoNotCheckCostInBill->CurrentValue, NULL, $this->DoNotCheckCostInBill->ReadOnly);

			// ProductGroupCode
			$this->ProductGroupCode->setDbValueDef($rsnew, $this->ProductGroupCode->CurrentValue, NULL, $this->ProductGroupCode->ReadOnly);

			// ProductStrengthCode
			$this->ProductStrengthCode->setDbValueDef($rsnew, $this->ProductStrengthCode->CurrentValue, NULL, $this->ProductStrengthCode->ReadOnly);

			// PackingCode
			$this->PackingCode->setDbValueDef($rsnew, $this->PackingCode->CurrentValue, NULL, $this->PackingCode->ReadOnly);

			// ComputedMinStock
			$this->ComputedMinStock->setDbValueDef($rsnew, $this->ComputedMinStock->CurrentValue, NULL, $this->ComputedMinStock->ReadOnly);

			// ComputedMaxStock
			$this->ComputedMaxStock->setDbValueDef($rsnew, $this->ComputedMaxStock->CurrentValue, NULL, $this->ComputedMaxStock->ReadOnly);

			// ProductRemark
			$this->ProductRemark->setDbValueDef($rsnew, $this->ProductRemark->CurrentValue, NULL, $this->ProductRemark->ReadOnly);

			// ProductDrugCode
			$this->ProductDrugCode->setDbValueDef($rsnew, $this->ProductDrugCode->CurrentValue, NULL, $this->ProductDrugCode->ReadOnly);

			// IsMatrixProduct
			$this->IsMatrixProduct->setDbValueDef($rsnew, $this->IsMatrixProduct->CurrentValue, NULL, $this->IsMatrixProduct->ReadOnly);

			// AttributeCount1
			$this->AttributeCount1->setDbValueDef($rsnew, $this->AttributeCount1->CurrentValue, NULL, $this->AttributeCount1->ReadOnly);

			// AttributeCount2
			$this->AttributeCount2->setDbValueDef($rsnew, $this->AttributeCount2->CurrentValue, NULL, $this->AttributeCount2->ReadOnly);

			// AttributeCount3
			$this->AttributeCount3->setDbValueDef($rsnew, $this->AttributeCount3->CurrentValue, NULL, $this->AttributeCount3->ReadOnly);

			// AttributeCount4
			$this->AttributeCount4->setDbValueDef($rsnew, $this->AttributeCount4->CurrentValue, NULL, $this->AttributeCount4->ReadOnly);

			// AttributeCount5
			$this->AttributeCount5->setDbValueDef($rsnew, $this->AttributeCount5->CurrentValue, NULL, $this->AttributeCount5->ReadOnly);

			// DefaultDiscountPercentage
			$this->DefaultDiscountPercentage->setDbValueDef($rsnew, $this->DefaultDiscountPercentage->CurrentValue, NULL, $this->DefaultDiscountPercentage->ReadOnly);

			// DonotPrintBarcode
			$this->DonotPrintBarcode->setDbValueDef($rsnew, $this->DonotPrintBarcode->CurrentValue, NULL, $this->DonotPrintBarcode->ReadOnly);

			// ProductLevelDiscount
			$this->ProductLevelDiscount->setDbValueDef($rsnew, $this->ProductLevelDiscount->CurrentValue, NULL, $this->ProductLevelDiscount->ReadOnly);

			// Markup
			$this->Markup->setDbValueDef($rsnew, $this->Markup->CurrentValue, NULL, $this->Markup->ReadOnly);

			// MarkDown
			$this->MarkDown->setDbValueDef($rsnew, $this->MarkDown->CurrentValue, NULL, $this->MarkDown->ReadOnly);

			// ReworkSalePrice
			$this->ReworkSalePrice->setDbValueDef($rsnew, $this->ReworkSalePrice->CurrentValue, NULL, $this->ReworkSalePrice->ReadOnly);

			// MultipleInput
			$this->MultipleInput->setDbValueDef($rsnew, $this->MultipleInput->CurrentValue, NULL, $this->MultipleInput->ReadOnly);

			// LpPackageInformation
			$this->LpPackageInformation->setDbValueDef($rsnew, $this->LpPackageInformation->CurrentValue, NULL, $this->LpPackageInformation->ReadOnly);

			// AllowNegativeStock
			$this->AllowNegativeStock->setDbValueDef($rsnew, $this->AllowNegativeStock->CurrentValue, NULL, $this->AllowNegativeStock->ReadOnly);

			// OrderDate
			$this->OrderDate->setDbValueDef($rsnew, UnFormatDateTime($this->OrderDate->CurrentValue, 0), NULL, $this->OrderDate->ReadOnly);

			// OrderTime
			$this->OrderTime->setDbValueDef($rsnew, UnFormatDateTime($this->OrderTime->CurrentValue, 0), NULL, $this->OrderTime->ReadOnly);

			// RateGroupCode
			$this->RateGroupCode->setDbValueDef($rsnew, $this->RateGroupCode->CurrentValue, NULL, $this->RateGroupCode->ReadOnly);

			// ConversionCaseLot
			$this->ConversionCaseLot->setDbValueDef($rsnew, $this->ConversionCaseLot->CurrentValue, NULL, $this->ConversionCaseLot->ReadOnly);

			// ShippingLot
			$this->ShippingLot->setDbValueDef($rsnew, $this->ShippingLot->CurrentValue, NULL, $this->ShippingLot->ReadOnly);

			// AllowExpiryReplacement
			$this->AllowExpiryReplacement->setDbValueDef($rsnew, $this->AllowExpiryReplacement->CurrentValue, 0, $this->AllowExpiryReplacement->ReadOnly);

			// NoOfMonthExpiryAllowed
			$this->NoOfMonthExpiryAllowed->setDbValueDef($rsnew, $this->NoOfMonthExpiryAllowed->CurrentValue, NULL, $this->NoOfMonthExpiryAllowed->ReadOnly);

			// ProductDiscountEligibility
			$this->ProductDiscountEligibility->setDbValueDef($rsnew, $this->ProductDiscountEligibility->CurrentValue, NULL, $this->ProductDiscountEligibility->ReadOnly);

			// ScheduleTypeCode
			$this->ScheduleTypeCode->setDbValueDef($rsnew, $this->ScheduleTypeCode->CurrentValue, NULL, $this->ScheduleTypeCode->ReadOnly);

			// AIOCDProductCode
			$this->AIOCDProductCode->setDbValueDef($rsnew, $this->AIOCDProductCode->CurrentValue, NULL, $this->AIOCDProductCode->ReadOnly);

			// FreeQuantity
			$this->FreeQuantity->setDbValueDef($rsnew, $this->FreeQuantity->CurrentValue, NULL, $this->FreeQuantity->ReadOnly);

			// DiscountType
			$this->DiscountType->setDbValueDef($rsnew, $this->DiscountType->CurrentValue, NULL, $this->DiscountType->ReadOnly);

			// DiscountValue
			$this->DiscountValue->setDbValueDef($rsnew, $this->DiscountValue->CurrentValue, NULL, $this->DiscountValue->ReadOnly);

			// HasProductOrderAttribute
			$this->HasProductOrderAttribute->setDbValueDef($rsnew, $this->HasProductOrderAttribute->CurrentValue, NULL, $this->HasProductOrderAttribute->ReadOnly);

			// FirstPODate
			$this->FirstPODate->setDbValueDef($rsnew, UnFormatDateTime($this->FirstPODate->CurrentValue, 0), NULL, $this->FirstPODate->ReadOnly);

			// SaleprcieAndMrpCalcPercent
			$this->SaleprcieAndMrpCalcPercent->setDbValueDef($rsnew, $this->SaleprcieAndMrpCalcPercent->CurrentValue, 0, $this->SaleprcieAndMrpCalcPercent->ReadOnly);

			// IsGiftVoucherProducts
			$this->IsGiftVoucherProducts->setDbValueDef($rsnew, $this->IsGiftVoucherProducts->CurrentValue, NULL, $this->IsGiftVoucherProducts->ReadOnly);

			// AcceptRange4SerialNumber
			$this->AcceptRange4SerialNumber->setDbValueDef($rsnew, $this->AcceptRange4SerialNumber->CurrentValue, NULL, $this->AcceptRange4SerialNumber->ReadOnly);

			// GiftVoucherDenomination
			$this->GiftVoucherDenomination->setDbValueDef($rsnew, $this->GiftVoucherDenomination->CurrentValue, NULL, $this->GiftVoucherDenomination->ReadOnly);

			// Subclasscode
			$this->Subclasscode->setDbValueDef($rsnew, $this->Subclasscode->CurrentValue, NULL, $this->Subclasscode->ReadOnly);

			// BarCodeFromWeighingMachine
			$this->BarCodeFromWeighingMachine->setDbValueDef($rsnew, $this->BarCodeFromWeighingMachine->CurrentValue, NULL, $this->BarCodeFromWeighingMachine->ReadOnly);

			// CheckCostInReturn
			$this->CheckCostInReturn->setDbValueDef($rsnew, $this->CheckCostInReturn->CurrentValue, NULL, $this->CheckCostInReturn->ReadOnly);

			// FrequentSaleProduct
			$this->FrequentSaleProduct->setDbValueDef($rsnew, $this->FrequentSaleProduct->CurrentValue, NULL, $this->FrequentSaleProduct->ReadOnly);

			// RateType
			$this->RateType->setDbValueDef($rsnew, $this->RateType->CurrentValue, NULL, $this->RateType->ReadOnly);

			// TouchscreenName
			$this->TouchscreenName->setDbValueDef($rsnew, $this->TouchscreenName->CurrentValue, NULL, $this->TouchscreenName->ReadOnly);

			// FreeType
			$this->FreeType->setDbValueDef($rsnew, $this->FreeType->CurrentValue, NULL, $this->FreeType->ReadOnly);

			// LooseQtyasNewBatch
			$this->LooseQtyasNewBatch->setDbValueDef($rsnew, $this->LooseQtyasNewBatch->CurrentValue, NULL, $this->LooseQtyasNewBatch->ReadOnly);

			// AllowSlabBilling
			$this->AllowSlabBilling->setDbValueDef($rsnew, $this->AllowSlabBilling->CurrentValue, NULL, $this->AllowSlabBilling->ReadOnly);

			// ProductTypeForProduction
			$this->ProductTypeForProduction->setDbValueDef($rsnew, $this->ProductTypeForProduction->CurrentValue, NULL, $this->ProductTypeForProduction->ReadOnly);

			// RecipeCode
			$this->RecipeCode->setDbValueDef($rsnew, $this->RecipeCode->CurrentValue, NULL, $this->RecipeCode->ReadOnly);

			// DefaultUnitType
			$this->DefaultUnitType->setDbValueDef($rsnew, $this->DefaultUnitType->CurrentValue, NULL, $this->DefaultUnitType->ReadOnly);

			// PIstatus
			$this->PIstatus->setDbValueDef($rsnew, $this->PIstatus->CurrentValue, NULL, $this->PIstatus->ReadOnly);

			// LastPiConfirmedDate
			$this->LastPiConfirmedDate->setDbValueDef($rsnew, UnFormatDateTime($this->LastPiConfirmedDate->CurrentValue, 0), NULL, $this->LastPiConfirmedDate->ReadOnly);

			// BarCodeDesign
			$this->BarCodeDesign->setDbValueDef($rsnew, $this->BarCodeDesign->CurrentValue, NULL, $this->BarCodeDesign->ReadOnly);

			// AcceptRemarksInBill
			$this->AcceptRemarksInBill->setDbValueDef($rsnew, $this->AcceptRemarksInBill->CurrentValue, NULL, $this->AcceptRemarksInBill->ReadOnly);

			// Classification
			$this->Classification->setDbValueDef($rsnew, $this->Classification->CurrentValue, NULL, $this->Classification->ReadOnly);

			// TimeSlot
			$this->TimeSlot->setDbValueDef($rsnew, $this->TimeSlot->CurrentValue, NULL, $this->TimeSlot->ReadOnly);

			// IsBundle
			$this->IsBundle->setDbValueDef($rsnew, $this->IsBundle->CurrentValue, NULL, $this->IsBundle->ReadOnly);

			// ColorCode
			$this->ColorCode->setDbValueDef($rsnew, $this->ColorCode->CurrentValue, NULL, $this->ColorCode->ReadOnly);

			// GenderCode
			$this->GenderCode->setDbValueDef($rsnew, $this->GenderCode->CurrentValue, NULL, $this->GenderCode->ReadOnly);

			// SizeCode
			$this->SizeCode->setDbValueDef($rsnew, $this->SizeCode->CurrentValue, NULL, $this->SizeCode->ReadOnly);

			// GiftCard
			$this->GiftCard->setDbValueDef($rsnew, $this->GiftCard->CurrentValue, NULL, $this->GiftCard->ReadOnly);

			// ToonLabel
			$this->ToonLabel->setDbValueDef($rsnew, $this->ToonLabel->CurrentValue, NULL, $this->ToonLabel->ReadOnly);

			// GarmentType
			$this->GarmentType->setDbValueDef($rsnew, $this->GarmentType->CurrentValue, NULL, $this->GarmentType->ReadOnly);

			// AgeGroup
			$this->AgeGroup->setDbValueDef($rsnew, $this->AgeGroup->CurrentValue, NULL, $this->AgeGroup->ReadOnly);

			// Season
			$this->Season->setDbValueDef($rsnew, $this->Season->CurrentValue, NULL, $this->Season->ReadOnly);

			// DailyStockEntry
			$this->DailyStockEntry->setDbValueDef($rsnew, $this->DailyStockEntry->CurrentValue, NULL, $this->DailyStockEntry->ReadOnly);

			// ModifierApplicable
			$this->ModifierApplicable->setDbValueDef($rsnew, $this->ModifierApplicable->CurrentValue, 0, $this->ModifierApplicable->ReadOnly);

			// ModifierType
			$this->ModifierType->setDbValueDef($rsnew, $this->ModifierType->CurrentValue, 0, $this->ModifierType->ReadOnly);

			// AcceptZeroRate
			$this->AcceptZeroRate->setDbValueDef($rsnew, $this->AcceptZeroRate->CurrentValue, 0, $this->AcceptZeroRate->ReadOnly);

			// ExciseDutyCode
			$this->ExciseDutyCode->setDbValueDef($rsnew, $this->ExciseDutyCode->CurrentValue, NULL, $this->ExciseDutyCode->ReadOnly);

			// IndentProductGroupCode
			$this->IndentProductGroupCode->setDbValueDef($rsnew, $this->IndentProductGroupCode->CurrentValue, NULL, $this->IndentProductGroupCode->ReadOnly);

			// IsMultiBatch
			$this->IsMultiBatch->setDbValueDef($rsnew, $this->IsMultiBatch->CurrentValue, NULL, $this->IsMultiBatch->ReadOnly);

			// IsSingleBatch
			$this->IsSingleBatch->setDbValueDef($rsnew, $this->IsSingleBatch->CurrentValue, NULL, $this->IsSingleBatch->ReadOnly);

			// MarkUpRate1
			$this->MarkUpRate1->setDbValueDef($rsnew, $this->MarkUpRate1->CurrentValue, NULL, $this->MarkUpRate1->ReadOnly);

			// MarkDownRate1
			$this->MarkDownRate1->setDbValueDef($rsnew, $this->MarkDownRate1->CurrentValue, NULL, $this->MarkDownRate1->ReadOnly);

			// MarkUpRate2
			$this->MarkUpRate2->setDbValueDef($rsnew, $this->MarkUpRate2->CurrentValue, NULL, $this->MarkUpRate2->ReadOnly);

			// MarkDownRate2
			$this->MarkDownRate2->setDbValueDef($rsnew, $this->MarkDownRate2->CurrentValue, NULL, $this->MarkDownRate2->ReadOnly);

			// Yield
			$this->_Yield->setDbValueDef($rsnew, $this->_Yield->CurrentValue, NULL, $this->_Yield->ReadOnly);

			// RefProductCode
			$this->RefProductCode->setDbValueDef($rsnew, $this->RefProductCode->CurrentValue, NULL, $this->RefProductCode->ReadOnly);

			// Volume
			$this->Volume->setDbValueDef($rsnew, $this->Volume->CurrentValue, NULL, $this->Volume->ReadOnly);

			// MeasurementID
			$this->MeasurementID->setDbValueDef($rsnew, $this->MeasurementID->CurrentValue, NULL, $this->MeasurementID->ReadOnly);

			// CountryCode
			$this->CountryCode->setDbValueDef($rsnew, $this->CountryCode->CurrentValue, NULL, $this->CountryCode->ReadOnly);

			// AcceptWMQty
			$this->AcceptWMQty->setDbValueDef($rsnew, $this->AcceptWMQty->CurrentValue, NULL, $this->AcceptWMQty->ReadOnly);

			// SingleBatchBasedOnRate
			$this->SingleBatchBasedOnRate->setDbValueDef($rsnew, $this->SingleBatchBasedOnRate->CurrentValue, NULL, $this->SingleBatchBasedOnRate->ReadOnly);

			// TenderNo
			$this->TenderNo->setDbValueDef($rsnew, $this->TenderNo->CurrentValue, NULL, $this->TenderNo->ReadOnly);

			// SingleBillMaximumSoldQtyFiled
			$this->SingleBillMaximumSoldQtyFiled->setDbValueDef($rsnew, $this->SingleBillMaximumSoldQtyFiled->CurrentValue, NULL, $this->SingleBillMaximumSoldQtyFiled->ReadOnly);
			...
			// IngredientCode1
			$this->IngredientCode1->setDbValueDef($rsnew, $this->IngredientCode1->CurrentValue, NULL, $this->IngredientCode1->ReadOnly);

			// IngredientCode2
			$this->IngredientCode2->setDbValueDef($rsnew, $this->IngredientCode2->CurrentValue, NULL, $this->IngredientCode2->ReadOnly);

			// IngredientCode3
			$this->IngredientCode3->setDbValueDef($rsnew, $this->IngredientCode3->CurrentValue, NULL, $this->IngredientCode3->ReadOnly);

			// IngredientCode4
			$this->IngredientCode4->setDbValueDef($rsnew, $this->IngredientCode4->CurrentValue, NULL, $this->IngredientCode4->ReadOnly);

			// IngredientCode5
			$this->IngredientCode5->setDbValueDef($rsnew, $this->IngredientCode5->CurrentValue, NULL, $this->IngredientCode5->ReadOnly);

			// OrderType
			$this->OrderType->setDbValueDef($rsnew, $this->OrderType->CurrentValue, NULL, $this->OrderType->ReadOnly);

			// StockUOM
			$this->StockUOM->setDbValueDef($rsnew, $this->StockUOM->CurrentValue, NULL, $this->StockUOM->ReadOnly);

			// PriceUOM
			$this->PriceUOM->setDbValueDef($rsnew, $this->PriceUOM->CurrentValue, NULL, $this->PriceUOM->ReadOnly);

			// DefaultSaleUOM
			$this->DefaultSaleUOM->setDbValueDef($rsnew, $this->DefaultSaleUOM->CurrentValue, NULL, $this->DefaultSaleUOM->ReadOnly);

			// DefaultPurchaseUOM
			$this->DefaultPurchaseUOM->setDbValueDef($rsnew, $this->DefaultPurchaseUOM->CurrentValue, NULL, $this->DefaultPurchaseUOM->ReadOnly);

			// ReportingUOM
			$this->ReportingUOM->setDbValueDef($rsnew, $this->ReportingUOM->CurrentValue, NULL, $this->ReportingUOM->ReadOnly);

			// LastPurchasedUOM
			$this->LastPurchasedUOM->setDbValueDef($rsnew, $this->LastPurchasedUOM->CurrentValue, NULL, $this->LastPurchasedUOM->ReadOnly);

			// TreatmentCodes
			$this->TreatmentCodes->setDbValueDef($rsnew, $this->TreatmentCodes->CurrentValue, NULL, $this->TreatmentCodes->ReadOnly);

			// InsuranceType
			$this->InsuranceType->setDbValueDef($rsnew, $this->InsuranceType->CurrentValue, NULL, $this->InsuranceType->ReadOnly);

			// CoverageGroupCodes
			$this->CoverageGroupCodes->setDbValueDef($rsnew, $this->CoverageGroupCodes->CurrentValue, NULL, $this->CoverageGroupCodes->ReadOnly);

			// MultipleUOM
			$this->MultipleUOM->setDbValueDef($rsnew, $this->MultipleUOM->CurrentValue, NULL, $this->MultipleUOM->ReadOnly);

			// SalePriceComputation
			$this->SalePriceComputation->setDbValueDef($rsnew, $this->SalePriceComputation->CurrentValue, NULL, $this->SalePriceComputation->ReadOnly);

			// StockCorrection
			$this->StockCorrection->setDbValueDef($rsnew, $this->StockCorrection->CurrentValue, NULL, $this->StockCorrection->ReadOnly);

			// LBTPercentage
			$this->LBTPercentage->setDbValueDef($rsnew, $this->LBTPercentage->CurrentValue, NULL, $this->LBTPercentage->ReadOnly);

			// SalesCommission
			$this->SalesCommission->setDbValueDef($rsnew, $this->SalesCommission->CurrentValue, NULL, $this->SalesCommission->ReadOnly);

			// LockedStock
			$this->LockedStock->setDbValueDef($rsnew, $this->LockedStock->CurrentValue, NULL, $this->LockedStock->ReadOnly);

			// MinMaxUOM
			$this->MinMaxUOM->setDbValueDef($rsnew, $this->MinMaxUOM->CurrentValue, NULL, $this->MinMaxUOM->ReadOnly);

			// ExpiryMfrDateFormat
			$this->ExpiryMfrDateFormat->setDbValueDef($rsnew, $this->ExpiryMfrDateFormat->CurrentValue, NULL, $this->ExpiryMfrDateFormat->ReadOnly);

			// ProductLifeTime
			$this->ProductLifeTime->setDbValueDef($rsnew, $this->ProductLifeTime->CurrentValue, NULL, $this->ProductLifeTime->ReadOnly);

			// IsCombo
			$this->IsCombo->setDbValueDef($rsnew, $this->IsCombo->CurrentValue, NULL, $this->IsCombo->ReadOnly);

			// ComboTypeCode
			$this->ComboTypeCode->setDbValueDef($rsnew, $this->ComboTypeCode->CurrentValue, NULL, $this->ComboTypeCode->ReadOnly);

			// AttributeCount6
			$this->AttributeCount6->setDbValueDef($rsnew, $this->AttributeCount6->CurrentValue, NULL, $this->AttributeCount6->ReadOnly);

			// AttributeCount7
			$this->AttributeCount7->setDbValueDef($rsnew, $this->AttributeCount7->CurrentValue, NULL, $this->AttributeCount7->ReadOnly);

			// AttributeCount8
			$this->AttributeCount8->setDbValueDef($rsnew, $this->AttributeCount8->CurrentValue, NULL, $this->AttributeCount8->ReadOnly);

			// AttributeCount9
			$this->AttributeCount9->setDbValueDef($rsnew, $this->AttributeCount9->CurrentValue, NULL, $this->AttributeCount9->ReadOnly);

			// AttributeCount10
			$this->AttributeCount10->setDbValueDef($rsnew, $this->AttributeCount10->CurrentValue, NULL, $this->AttributeCount10->ReadOnly);

			// LabourCharge
			$this->LabourCharge->setDbValueDef($rsnew, $this->LabourCharge->CurrentValue, NULL, $this->LabourCharge->ReadOnly);

			// AffectOtherCharge
			$this->AffectOtherCharge->setDbValueDef($rsnew, $this->AffectOtherCharge->CurrentValue, NULL, $this->AffectOtherCharge->ReadOnly);

			// DosageInfo
			$this->DosageInfo->setDbValueDef($rsnew, $this->DosageInfo->CurrentValue, NULL, $this->DosageInfo->ReadOnly);

			// DosageType
			$this->DosageType->setDbValueDef($rsnew, $this->DosageType->CurrentValue, NULL, $this->DosageType->ReadOnly);

			// DefaultIndentUOM
			$this->DefaultIndentUOM->setDbValueDef($rsnew, $this->DefaultIndentUOM->CurrentValue, NULL, $this->DefaultIndentUOM->ReadOnly);

			// PromoTag
			$this->PromoTag->setDbValueDef($rsnew, $this->PromoTag->CurrentValue, NULL, $this->PromoTag->ReadOnly);

			// BillLevelPromoTag
			$this->BillLevelPromoTag->setDbValueDef($rsnew, $this->BillLevelPromoTag->CurrentValue, NULL, $this->BillLevelPromoTag->ReadOnly);

			// IsMRPProduct
			$this->IsMRPProduct->setDbValueDef($rsnew, $this->IsMRPProduct->CurrentValue, NULL, $this->IsMRPProduct->ReadOnly);

			// MrpList
			$this->MrpList->setDbValueDef($rsnew, $this->MrpList->CurrentValue, NULL, $this->MrpList->ReadOnly);

			// AlternateSaleUOM
			$this->AlternateSaleUOM->setDbValueDef($rsnew, $this->AlternateSaleUOM->CurrentValue, NULL, $this->AlternateSaleUOM->ReadOnly);

			// FreeUOM
			$this->FreeUOM->setDbValueDef($rsnew, $this->FreeUOM->CurrentValue, NULL, $this->FreeUOM->ReadOnly);

			// MarketedCode
			$this->MarketedCode->setDbValueDef($rsnew, $this->MarketedCode->CurrentValue, NULL, $this->MarketedCode->ReadOnly);

			// MinimumSalePrice
			$this->MinimumSalePrice->setDbValueDef($rsnew, $this->MinimumSalePrice->CurrentValue, NULL, $this->MinimumSalePrice->ReadOnly);

			// PRate1
			$this->PRate1->setDbValueDef($rsnew, $this->PRate1->CurrentValue, NULL, $this->PRate1->ReadOnly);

			// PRate2
			$this->PRate2->setDbValueDef($rsnew, $this->PRate2->CurrentValue, NULL, $this->PRate2->ReadOnly);

			// LPItemCost
			$this->LPItemCost->setDbValueDef($rsnew, $this->LPItemCost->CurrentValue, NULL, $this->LPItemCost->ReadOnly);

			// FixedItemCost
			$this->FixedItemCost->setDbValueDef($rsnew, $this->FixedItemCost->CurrentValue, NULL, $this->FixedItemCost->ReadOnly);

			// HSNId
			$this->HSNId->setDbValueDef($rsnew, $this->HSNId->CurrentValue, NULL, $this->HSNId->ReadOnly);

			// TaxInclusive
			$this->TaxInclusive->setDbValueDef($rsnew, $this->TaxInclusive->CurrentValue, NULL, $this->TaxInclusive->ReadOnly);

			// EligibleforWarranty
			$this->EligibleforWarranty->setDbValueDef($rsnew, $this->EligibleforWarranty->CurrentValue, NULL, $this->EligibleforWarranty->ReadOnly);

			// NoofMonthsWarranty
			$this->NoofMonthsWarranty->setDbValueDef($rsnew, $this->NoofMonthsWarranty->CurrentValue, NULL, $this->NoofMonthsWarranty->ReadOnly);

			// ComputeTaxonCost
			$this->ComputeTaxonCost->setDbValueDef($rsnew, $this->ComputeTaxonCost->CurrentValue, NULL, $this->ComputeTaxonCost->ReadOnly);

			// HasEmptyBottleTrack
			$this->HasEmptyBottleTrack->setDbValueDef($rsnew, $this->HasEmptyBottleTrack->CurrentValue, NULL, $this->HasEmptyBottleTrack->ReadOnly);

			// EmptyBottleReferenceCode
			$this->EmptyBottleReferenceCode->setDbValueDef($rsnew, $this->EmptyBottleReferenceCode->CurrentValue, NULL, $this->EmptyBottleReferenceCode->ReadOnly);

			// AdditionalCESSAmount
			$this->AdditionalCESSAmount->setDbValueDef($rsnew, $this->AdditionalCESSAmount->CurrentValue, NULL, $this->AdditionalCESSAmount->ReadOnly);

			// EmptyBottleRate
			$this->EmptyBottleRate->setDbValueDef($rsnew, $this->EmptyBottleRate->CurrentValue, NULL, $this->EmptyBottleRate->ReadOnly);
