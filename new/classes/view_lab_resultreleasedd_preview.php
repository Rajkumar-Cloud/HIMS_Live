 ...
 * Page class
 */
class view_lab_resultreleasedd_preview extends view_lab_resultreleasedd
{
	...
	// Page object name
	public $PageObjName = "view_lab_resultreleasedd_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'view_lab_resultreleasedd');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_lab_servicess") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=view_lab_servicess&fk_id=" . urlencode(strval($this->Vid->QueryStringValue)) . "";
		}
		return $url;
	}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("view_lab_resultreleaseddlist.php"), "", $this->TableVar, TRUE);
		$pageId = "preview";
