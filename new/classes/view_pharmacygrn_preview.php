 ...
 * Page class
 */
class view_pharmacygrn_preview extends view_pharmacygrn
{
	...
	// Page object name
	public $PageObjName = "view_pharmacygrn_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'view_pharmacygrn');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "pharmacy_grn") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_grn&fk_id=" . urlencode(strval($this->grnid->QueryStringValue)) . "";
		}
		return $url;
	}
