 ...
 * Page class
 */
class view_opd_follow_up_delete extends view_opd_follow_up
{
	...
	// Page object name
	public $PageObjName = "view_opd_follow_up_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_opd_follow_uplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("view_opd_follow_uplist.php"); // Return to list
			}
		}
	}
