 ...
 * Page class
 */
class employee_document_preview extends employee_document
{
	...
	// Page object name
	public $PageObjName = "employee_document_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'employee_document');
			if ($Security->isLoggedIn())
