...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		// sum(b.amount)
		if (!$this->isAddOrEdit() && $this->sum28b_amount29->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->sum28b_amount29->AdvancedSearch->SearchValue != "" || $this->sum28b_amount29->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
