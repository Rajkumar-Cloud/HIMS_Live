 ...
 * Page class
 */
class pharmacy_services_delete extends pharmacy_services
{
	...
	// Page object name
	public $PageObjName = "pharmacy_services_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_serviceslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_serviceslist.php"); // Return to list
			}
		}
	}
