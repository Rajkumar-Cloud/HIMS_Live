 ...
 * Page class
 */
class pharmacy_purchase_request_items_preview extends pharmacy_purchase_request_items
{
	...
	// Page object name
	public $PageObjName = "pharmacy_purchase_request_items_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'pharmacy_purchase_request_items');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "pharmacy_purchase_request") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_purchase_request&fk_id=" . urlencode(strval($this->prid->QueryStringValue)) . "";
		}
		return $url;
	}
