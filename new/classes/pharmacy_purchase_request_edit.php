 ...
 * Page class
 */
class pharmacy_purchase_request_edit extends pharmacy_purchase_request
{
	...
	// Page object name
	public $PageObjName = "pharmacy_purchase_request_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("pharmacy_purchase_request_items", $detailTblVar) && $GLOBALS["pharmacy_purchase_request_items"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("pharmacy_purchase_request_items", $detailTblVar) && $GLOBALS["pharmacy_purchase_request_items"]->DetailEdit) {
						...
						$editRow = $GLOBALS["pharmacy_purchase_request_items_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("pharmacy_purchase_request_items", $detailTblVar)) {
				...
				if ($GLOBALS["pharmacy_purchase_request_items_grid"]->DetailEdit) {
					$GLOBALS["pharmacy_purchase_request_items_grid"]->CurrentMode = "edit";
					$GLOBALS["pharmacy_purchase_request_items_grid"]->CurrentAction = "gridedit";
