 ...
 */
class ivf_agency extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "ivf_agencyedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ivf_agencyadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ivf_agencyview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ivf_agencyview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "ivf_agencyadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ivf_agencyadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ivf_agencyedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ivf_agencyadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ivf_agencydelete.php", $this->getUrlParm());
	}
