 ...
 * Page class
 */
class patient_emergency_contact_preview extends patient_emergency_contact
{
	...
	// Page object name
	public $PageObjName = "patient_emergency_contact_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_emergency_contact');
			if ($Security->isLoggedIn())
