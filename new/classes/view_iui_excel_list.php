...
// Render list options (extended codes)
	...
	protected function loadSearchValues()
	{
		...
		// HUSBAND NAME
		if (!$this->isAddOrEdit() && $this->HUSBAND_NAME->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->HUSBAND_NAME->AdvancedSearch->SearchValue != "" || $this->HUSBAND_NAME->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// AGE  - WIFE
		if (!$this->isAddOrEdit() && $this->AGE____WIFE->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->AGE____WIFE->AdvancedSearch->SearchValue != "" || $this->AGE____WIFE->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// AGE- HUSBAND
		if (!$this->isAddOrEdit() && $this->AGE__HUSBAND->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->AGE__HUSBAND->AdvancedSearch->SearchValue != "" || $this->AGE__HUSBAND->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// ANXIOUS TO CONCEIVE FOR
		if (!$this->isAddOrEdit() && $this->ANXIOUS_TO_CONCEIVE_FOR->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->ANXIOUS_TO_CONCEIVE_FOR->AdvancedSearch->SearchValue != "" || $this->ANXIOUS_TO_CONCEIVE_FOR->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// AMH ( NG/ML)
		if (!$this->isAddOrEdit() && $this->AMH_28_NG2FML29->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->AMH_28_NG2FML29->AdvancedSearch->SearchValue != "" || $this->AMH_28_NG2FML29->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// PREV IUI
		if (!$this->isAddOrEdit() && $this->PREV_IUI->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->PREV_IUI->AdvancedSearch->SearchValue != "" || $this->PREV_IUI->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// H/D SAMPLE
		if (!$this->isAddOrEdit() && $this->H2FD_SAMPLE->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->H2FD_SAMPLE->AdvancedSearch->SearchValue != "" || $this->H2FD_SAMPLE->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// DONOR - I.D
		if (!$this->isAddOrEdit() && $this->DONOR___I_D->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->DONOR___I_D->AdvancedSearch->SearchValue != "" || $this->DONOR___I_D->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// COLLECTION  METHOD
		if (!$this->isAddOrEdit() && $this->COLLECTION__METHOD->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->COLLECTION__METHOD->AdvancedSearch->SearchValue != "" || $this->COLLECTION__METHOD->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// SAMPLE SOURCE
		if (!$this->isAddOrEdit() && $this->SAMPLE_SOURCE->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->SAMPLE_SOURCE->AdvancedSearch->SearchValue != "" || $this->SAMPLE_SOURCE->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
	...
	protected function setupSearchOptions()
	{
		...
		if (IsMobile())
			...
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_iui_excel\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'view_iui_excelsrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
