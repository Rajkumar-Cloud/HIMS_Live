 ...
 * Page class
 */
class ivf_ovum_pick_up_chart_add extends ivf_ovum_pick_up_chart
{
	...
	// Page object name
	public $PageObjName = "ivf_ovum_pick_up_chart_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "ivf_ovum_pick_up_chartview.php")
