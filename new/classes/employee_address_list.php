 ...
 * Page class
 */
class employee_address_list extends employee_address
{
	...
	// Page object name
	public $PageObjName = "employee_address_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "employee_addressadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "employee_addressdelete.php";
		$this->MultiUpdateUrl = "employee_addressupdate.php";
...
// Render list options (extended codes)
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('contact_persion')); // contact_persion
		$hash .= GetFieldHash($rs->fields('street')); // street
		...
		$hash .= GetFieldHash($rs->fields('address_type')); // address_type
