...
class view_lab_servicess_list extends view_lab_servicess
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "view_lab_servicessadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'view_lab_resultreleasedd')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("view_lab_resultreleaseddlist.php?" . Config("TABLE_SHOW_MASTER") . "=view_lab_servicess&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["view_lab_resultreleasedd_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'view_lab_servicess')) {
...
// Render list options (extended codes)
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["view_lab_resultreleasedd"] && $this->DetailPages["view_lab_resultreleasedd"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'view_lab_servicess')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("view_lab_resultreleaseddlist.php?" . Config("TABLE_SHOW_MASTER") . "=view_lab_servicess&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
	...
	protected function setupSearchOptions()
	{
		...
		if (IsMobile())
			...
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"view_lab_servicess\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'view_lab_servicesssrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
