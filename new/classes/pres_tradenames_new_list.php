...
class pres_tradenames_new_list extends pres_tradenames_new
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pres_tradenames_newadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Visible = ($GLOBALS["pres_trade_combination_names_new"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'pres_tradenames_new') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["pres_trade_combination_names_new"] && $this->DetailPages["pres_trade_combination_names_new"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'pres_tradenames_new')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("pres_trade_combination_names_newlist.php?" . Config("TABLE_SHOW_MASTER") . "=pres_tradenames_new&fk_ID=" . urlencode(strval($this->ID->CurrentValue)) . "");
