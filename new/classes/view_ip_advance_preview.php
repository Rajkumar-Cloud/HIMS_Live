...
class view_ip_advance_preview extends view_ip_advance
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "ip_admission") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=ip_admission&fk_mrnNo=" . urlencode(strval($this->mrnno->QueryStringValue)) . "&fk_id=" . urlencode(strval($this->Reception->QueryStringValue)) . "&fk_patient_id=" . urlencode(strval($this->PatID->QueryStringValue)) . "";
		}
		return $url;
	}
