 ...
 * Page class
 */
class employee_has_degree_list extends employee_has_degree
{
	...
	// Page object name
	public $PageObjName = "employee_has_degree_list";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "employee_has_degreedelete.php";
		$this->MultiUpdateUrl = "employee_has_degreeupdate.php";
...
// Render list options (extended codes)
	...
	public function getRowHash(&$rs)
	{
		...
		$hash .= GetFieldHash($rs->fields('degree_id')); // degree_id
		$hash .= GetFieldHash($rs->fields('college_or_school')); // college_or_school
		$hash .= GetFieldHash($rs->fields('university_or_board')); // university_or_board
		$hash .= GetFieldHash($rs->fields('year_of_passing')); // year_of_passing
		$hash .= GetFieldHash($rs->fields('scoring_marks')); // scoring_marks
		$hash .= GetFieldHash($rs->fields('certificates')); // certificates
		$hash .= GetFieldHash($rs->fields('others')); // others
