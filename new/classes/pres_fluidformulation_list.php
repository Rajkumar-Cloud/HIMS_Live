 ...
 * Page class
 */
class pres_fluidformulation_list extends pres_fluidformulation
{
	...
	// Page object name
	public $PageObjName = "pres_fluidformulation_list";

	// Grid form hidden field names
	public $FormName = "fpres_fluidformulationlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pres_fluidformulationadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "pres_fluidformulationdelete.php";
		$this->MultiUpdateUrl = "pres_fluidformulationupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fpres_fluidformulationlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpres_fluidformulationlistsrch");
		$filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
		$filterList = Concat($filterList, $this->Tradename->AdvancedSearch->toJson(), ","); // Field Tradename
		...
		$filterList = Concat($filterList, $this->VolumeUnit->AdvancedSearch->toJson(), ","); // Field VolumeUnit
		$filterList = Concat($filterList, $this->Strength->AdvancedSearch->toJson(), ","); // Field Strength
		$filterList = Concat($filterList, $this->StrengthUnit->AdvancedSearch->toJson(), ","); // Field StrengthUnit
		$filterList = Concat($filterList, $this->_Route->AdvancedSearch->toJson(), ","); // Field Route
		$filterList = Concat($filterList, $this->Forms->AdvancedSearch->toJson(), ","); // Field Forms
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fpres_fluidformulationlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field Tradename
		$this->Tradename->AdvancedSearch->SearchValue = @$filter["x_Tradename"];
		$this->Tradename->AdvancedSearch->SearchOperator = @$filter["z_Tradename"];
		$this->Tradename->AdvancedSearch->SearchCondition = @$filter["v_Tradename"];
		$this->Tradename->AdvancedSearch->SearchValue2 = @$filter["y_Tradename"];
		$this->Tradename->AdvancedSearch->SearchOperator2 = @$filter["w_Tradename"];
		$this->Tradename->AdvancedSearch->save();
		...
		// Field VolumeUnit
		$this->VolumeUnit->AdvancedSearch->SearchValue = @$filter["x_VolumeUnit"];
		$this->VolumeUnit->AdvancedSearch->SearchOperator = @$filter["z_VolumeUnit"];
		$this->VolumeUnit->AdvancedSearch->SearchCondition = @$filter["v_VolumeUnit"];
		$this->VolumeUnit->AdvancedSearch->SearchValue2 = @$filter["y_VolumeUnit"];
		$this->VolumeUnit->AdvancedSearch->SearchOperator2 = @$filter["w_VolumeUnit"];
		$this->VolumeUnit->AdvancedSearch->save();
		...
		// Field StrengthUnit
		$this->StrengthUnit->AdvancedSearch->SearchValue = @$filter["x_StrengthUnit"];
		$this->StrengthUnit->AdvancedSearch->SearchOperator = @$filter["z_StrengthUnit"];
		$this->StrengthUnit->AdvancedSearch->SearchCondition = @$filter["v_StrengthUnit"];
		$this->StrengthUnit->AdvancedSearch->SearchValue2 = @$filter["y_StrengthUnit"];
		$this->StrengthUnit->AdvancedSearch->SearchOperator2 = @$filter["w_StrengthUnit"];
		$this->StrengthUnit->AdvancedSearch->save();
		...
		// Field Forms
		$this->Forms->AdvancedSearch->SearchValue = @$filter["x_Forms"];
		$this->Forms->AdvancedSearch->SearchOperator = @$filter["z_Forms"];
		$this->Forms->AdvancedSearch->SearchCondition = @$filter["v_Forms"];
		$this->Forms->AdvancedSearch->SearchValue2 = @$filter["y_Forms"];
		$this->Forms->AdvancedSearch->SearchOperator2 = @$filter["w_Forms"];
		$this->Forms->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->Tradename, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->VolumeUnit, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->StrengthUnit, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->_Route, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->Forms, $arKeywords, $type);
		return $where;
	}
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->setSessionOrderBy($orderBy);
				$this->id->setSort("");
				$this->Tradename->setSort("");
				$this->Itemcode->setSort("");
				$this->Genericname->setSort("");
				$this->Volume->setSort("");
				$this->VolumeUnit->setSort("");
				$this->Strength->setSort("");
				$this->StrengthUnit->setSort("");
				$this->_Route->setSort("");
				$this->Forms->setSort("");
			}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpres_fluidformulationlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpres_fluidformulationlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fpres_fluidformulationlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpres_fluidformulationlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpres_fluidformulationlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpres_fluidformulationlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_pres_fluidformulation" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_pres_fluidformulation\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpres_fluidformulationlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpres_fluidformulationlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
