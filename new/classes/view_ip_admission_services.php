 ...
 */
class view_ip_admission_services extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_ip_admission_serviceslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_ip_admission_servicesview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_ip_admission_servicesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_ip_admission_servicesadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_ip_admission_servicesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_ip_admission_servicesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_ip_admission_servicesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_ip_admission_servicesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admission_servicesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admission_servicesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_ip_admission_servicesdelete.php", $this->getUrlParm());
	}
