...
class lab_profile_details_search extends lab_profile_details
{
	...
	protected function loadSearchValues()
	{
		...
		if ($this->id->AdvancedSearch->post())
			$got = TRUE;
		if ($this->ProfileCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->SubProfileCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->ProfileTestCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->ProfileSubTestCode->AdvancedSearch->post())
			$got = TRUE;
		if ($this->TestOrder->AdvancedSearch->post())
			$got = TRUE;
		if ($this->TestAmount->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
