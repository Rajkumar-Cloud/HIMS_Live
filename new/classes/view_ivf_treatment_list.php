...
class view_ivf_treatment_list extends view_ivf_treatment
{
	...
	public function __construct()
	{
		...
		$this->AddUrl = "view_ivf_treatmentadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["ivf_semenanalysisreport"] && $this->DetailPages["ivf_semenanalysisreport"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'view_ivf_treatment')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("ivf_semenanalysisreportlist.php?" . Config("TABLE_SHOW_MASTER") . "=view_ivf_treatment&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_RIDNO=" . urlencode(strval($this->RIDNO->CurrentValue)) . "&fk_Name=" . urlencode(strval($this->Name->CurrentValue)) . "");
		...
		if ($this->DetailPages && $this->DetailPages["ivf_oocytedenudation"] && $this->DetailPages["ivf_oocytedenudation"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'view_ivf_treatment')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("ivf_oocytedenudationlist.php?" . Config("TABLE_SHOW_MASTER") . "=view_ivf_treatment&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_RIDNO=" . urlencode(strval($this->RIDNO->CurrentValue)) . "&fk_Name=" . urlencode(strval($this->Name->CurrentValue)) . "");
