 ...
 */
class view_patient_services extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// Services
		$this->Services = new DbField('view_patient_services', 'view_patient_services', 'x_Services', 'Services', '`Services`', '`Services`', 200, 50, -1, FALSE, '`EV__Services`', TRUE, FALSE, TRUE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getSqlSelectList() // Select for List page
	{
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT `SERVICE` FROM `mas_services_billing` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`SERVICE` = `view_patient_services`.`Services` LIMIT 1) AS `EV__Services` FROM `view_patient_services`" .
			") `TMP_TABLE`";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_patient_serviceslist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "view_patient_servicesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_patient_servicesadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_patient_servicesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_patient_servicesview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_patient_servicesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_patient_servicesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_patient_servicesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_patient_servicesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_patient_servicesdelete.php", $this->getUrlParm());
	}
