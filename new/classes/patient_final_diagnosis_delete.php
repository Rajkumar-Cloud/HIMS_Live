 ...
 * Page class
 */
class patient_final_diagnosis_delete extends patient_final_diagnosis
{
	...
	// Page object name
	public $PageObjName = "patient_final_diagnosis_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("patient_final_diagnosislist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("patient_final_diagnosislist.php"); // Return to list
			}
		}
	}
