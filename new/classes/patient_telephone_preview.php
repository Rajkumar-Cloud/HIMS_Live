 ...
 * Page class
 */
class patient_telephone_preview extends patient_telephone
{
	...
	// Page object name
	public $PageObjName = "patient_telephone_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'patient_telephone');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "patient") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=patient&fk_id=" . urlencode(strval($this->patient_id->QueryStringValue)) . "";
		}
		return $url;
	}
