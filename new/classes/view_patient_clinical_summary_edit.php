 ...
 * Page class
 */
class view_patient_clinical_summary_edit extends view_patient_clinical_summary
{
	...
	// Page object name
	public $PageObjName = "view_patient_clinical_summary_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// vitals
			$this->vitals->setDbValueDef($rsnew, $this->vitals->CurrentValue, NULL, $this->vitals->ReadOnly);
