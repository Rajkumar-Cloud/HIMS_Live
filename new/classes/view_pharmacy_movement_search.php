 ...
 * Page class
 */
class view_pharmacy_movement_search extends view_pharmacy_movement
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_movement_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("view_pharmacy_movementlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "view_pharmacy_movementlist.php" . "?" . $srchStr;
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("view_pharmacy_movementlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
