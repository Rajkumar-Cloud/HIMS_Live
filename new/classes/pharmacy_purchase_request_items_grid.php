 ...
 * Page class
 */
class pharmacy_purchase_request_items_grid extends pharmacy_purchase_request_items
{
	...
	// Page object name
	public $PageObjName = "pharmacy_purchase_request_items_grid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "pharmacy_purchase_request") {
			...
			if ($GLOBALS["pharmacy_purchase_request"]->EventCancelled)
