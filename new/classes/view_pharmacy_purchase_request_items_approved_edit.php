 ...
 * Page class
 */
class view_pharmacy_purchase_request_items_approved_edit extends view_pharmacy_purchase_request_items_approved
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_purchase_request_items_approved_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("view_pharmacy_purchase_request_items_approvedlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "view_pharmacy_purchase_request_items_approvedlist.php")
