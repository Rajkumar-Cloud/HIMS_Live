 ...
 * Page class
 */
class pharmacy_customers_delete extends pharmacy_customers
{
	...
	// Page object name
	public $PageObjName = "pharmacy_customers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_customerslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_customerslist.php"); // Return to list
			}
		}
	}
