 ...
 * Page class
 */
class view_lab_service_sub_delete extends view_lab_service_sub
{
	...
	// Page object name
	public $PageObjName = "view_lab_service_sub_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_lab_service_sublist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("view_lab_service_sublist.php"); // Return to list
			}
		}
	}
