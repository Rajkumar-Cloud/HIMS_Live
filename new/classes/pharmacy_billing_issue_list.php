 ...
 * Page class
 */
class pharmacy_billing_issue_list extends pharmacy_billing_issue
{
	...
	// Page object name
	public $PageObjName = "pharmacy_billing_issue_list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "pharmacy_billing_issueadd.php?" . Config("TABLE_SHOW_DETAIL") . "=";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "pharmacy_billing_issuedelete.php";
		$this->MultiUpdateUrl = "pharmacy_billing_issueupdate.php";
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'pharmacy_pharled')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("pharmacy_pharledlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_issue&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS["pharmacy_pharled_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pharmacy_billing_issue')) {
			...
			if ($GLOBALS["pharmacy_pharled_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pharmacy_billing_issue')) {
			...
			if ($GLOBALS["pharmacy_pharled_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pharmacy_billing_issue')) {
	...
	protected function setupOtherOptions()
	{
		...
		$item->Visible = ($GLOBALS["pharmacy_pharled"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'pharmacy_billing_issue') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
...
// Render list options (extended codes)
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["pharmacy_pharled"] && $this->DetailPages["pharmacy_pharled"]->Visible) {
			...
			$url = "pharmacy_pharledpreview.php?t=pharmacy_billing_issue&f=" . Encrypt($sqlwrk);
			...
			if ($Security->allowList(CurrentProjectID() . 'pharmacy_billing_issue')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("pharmacy_pharledlist.php?" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_issue&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
