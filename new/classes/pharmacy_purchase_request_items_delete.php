 ...
 * Page class
 */
class pharmacy_purchase_request_items_delete extends pharmacy_purchase_request_items
{
	...
	// Page object name
	public $PageObjName = "pharmacy_purchase_request_items_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_purchase_request_itemslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_purchase_request_itemslist.php"); // Return to list
			}
		}
	}
