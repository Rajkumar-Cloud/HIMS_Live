 ...
 * Page class
 */
class employee_has_degree_preview extends employee_has_degree
{
	...
	// Page object name
	public $PageObjName = "employee_has_degree_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'employee_has_degree');
			if ($Security->isLoggedIn())
