 ...
 * Page class
 */
class view_opd_follow_up_edit extends view_opd_follow_up
{
	...
	// Page object name
	public $PageObjName = "view_opd_follow_up_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// PatientId
			$this->PatientId->setDbValueDef($rsnew, $this->PatientId->CurrentValue, 0, $this->PatientId->ReadOnly);

			// mrnno
			$this->mrnno->setDbValueDef($rsnew, $this->mrnno->CurrentValue, NULL, $this->mrnno->ReadOnly);

			// PatientName
			$this->PatientName->setDbValueDef($rsnew, $this->PatientName->CurrentValue, "", $this->PatientName->ReadOnly);
			...
			// RIDNo
			$this->RIDNo->setDbValueDef($rsnew, $this->RIDNo->CurrentValue, "", $this->RIDNo->ReadOnly);
