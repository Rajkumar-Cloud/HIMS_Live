 ...
 * Page class
 */
class pharmacy_pharled_delete extends pharmacy_pharled
{
	...
	// Page object name
	public $PageObjName = "pharmacy_pharled_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pharmacy_pharledlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pharmacy_pharledlist.php"); // Return to list
			}
		}
	}
