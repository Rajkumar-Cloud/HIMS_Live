 ...
 */
class appointment_scheduler extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "appointment_schedulerlist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "appointment_scheduleredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "appointment_scheduleradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("appointment_schedulerview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("appointment_schedulerview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "appointment_scheduleradd.php?" . $this->getUrlParm($parm);
		else
			$url = "appointment_scheduleradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("appointment_scheduleredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("appointment_scheduleradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("appointment_schedulerdelete.php", $this->getUrlParm());
	}
