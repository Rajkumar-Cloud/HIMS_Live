 ...
 */
class view_ip_admission_bill_summary extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_ip_admission_bill_summarylist.php";
		}
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "view_ip_admission_bill_summaryedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_ip_admission_bill_summaryadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_ip_admission_bill_summaryview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_ip_admission_bill_summaryview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_ip_admission_bill_summaryadd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_ip_admission_bill_summaryadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admission_bill_summaryedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_ip_admission_bill_summaryadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_ip_admission_bill_summarydelete.php", $this->getUrlParm());
	}
