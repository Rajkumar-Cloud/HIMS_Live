 ...
 * Page class
 */
class pharmacy_suppliers_add extends pharmacy_suppliers
{
	...
	// Page object name
	public $PageObjName = "pharmacy_suppliers_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "pharmacy_suppliersview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->Suppliercode->CurrentValue != "") { // Check field with unique index
			$filter = "(`Suppliercode` = '" . AdjustSql($this->Suppliercode->CurrentValue, $this->Dbid) . "')";
