 ...
 */
class view_billing_voucher_voucher extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// DiscountRemarks
		$this->DiscountRemarks = new DbField('view_billing_voucher_voucher', 'view_billing_voucher_voucher', 'x_DiscountRemarks', 'DiscountRemarks', '`DiscountRemarks`', '`DiscountRemarks`', 200, 45, -1, FALSE, '`DiscountRemarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// UserName
		$this->UserName = new DbField('view_billing_voucher_voucher', 'view_billing_voucher_voucher', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "view_billing_voucher_voucherlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "view_billing_voucher_voucherview.php")
			return $Language->phrase("View");
		elseif ($pageName == "view_billing_voucher_voucheredit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "view_billing_voucher_voucheradd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("view_billing_voucher_voucherview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("view_billing_voucher_voucherview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "view_billing_voucher_voucheradd.php?" . $this->getUrlParm($parm);
		else
			$url = "view_billing_voucher_voucheradd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_billing_voucher_voucheredit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("view_billing_voucher_voucheradd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("view_billing_voucher_voucherdelete.php", $this->getUrlParm());
	}
