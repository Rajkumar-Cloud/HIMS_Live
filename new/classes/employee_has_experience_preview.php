 ...
 * Page class
 */
class employee_has_experience_preview extends employee_has_experience
{
	...
	// Page object name
	public $PageObjName = "employee_has_experience_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'employee_has_experience');
			if ($Security->isLoggedIn())
