 ...
 * Page class
 */
class task_management_delete extends task_management
{
	...
	// Page object name
	public $PageObjName = "task_management_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("task_managementlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("task_managementlist.php"); // Return to list
			}
		}
	}
