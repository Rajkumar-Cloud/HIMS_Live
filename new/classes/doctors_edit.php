...
class doctors_edit extends doctors
{
	...
	protected function validateForm()
	{
		...
		if (in_array("appointment_scheduler", $detailTblVar) && $GLOBALS["appointment_scheduler"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("appointment_scheduler", $detailTblVar) && $GLOBALS["appointment_scheduler"]->DetailEdit) {
						...
						$editRow = $GLOBALS["appointment_scheduler_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("appointment_scheduler", $detailTblVar)) {
				...
				if ($GLOBALS["appointment_scheduler_grid"]->DetailEdit) {
					$GLOBALS["appointment_scheduler_grid"]->CurrentMode = "edit";
					$GLOBALS["appointment_scheduler_grid"]->CurrentAction = "gridedit";
