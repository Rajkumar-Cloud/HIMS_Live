 ...
 * Page class
 */
class view_pharmacy_pharled_return_preview extends view_pharmacy_pharled_return
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_pharled_return_preview";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'view_pharmacy_pharled_return');
			if ($Security->isLoggedIn())
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "pharmacy_billing_return") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=pharmacy_billing_return&fk_id=" . urlencode(strval($this->pbt->QueryStringValue)) . "";
		}
		return $url;
	}
