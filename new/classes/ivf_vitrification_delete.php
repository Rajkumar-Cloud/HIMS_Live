 ...
 * Page class
 */
class ivf_vitrification_delete extends ivf_vitrification
{
	...
	// Page object name
	public $PageObjName = "ivf_vitrification_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ivf_vitrificationlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ivf_vitrificationlist.php"); // Return to list
			}
		}
	}
