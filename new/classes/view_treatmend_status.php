...
class view_treatmend_status extends DbTable
{
	...
	public function __construct()
	{
		...
		// Treatment
		$this->Treatment = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_Treatment', 'Treatment', '`Treatment`', '`Treatment`', 200, 45, -1, FALSE, '`Treatment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Treatment->Sortable = TRUE; // Allow sort
		$this->fields['Treatment'] = &$this->Treatment;

		// Treatment1
		$this->Treatment1 = new DbField('view_treatmend_status', 'view_treatmend_status', 'x_Treatment1', 'Treatment1', '`Treatment1`', '`Treatment1`', 200, 45, -1, FALSE, '`Treatment1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_treatmend_statusview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function renderEditRow()
	{
		...
		// Treatment1
		$this->Treatment1->EditAttrs["class"] = "form-control";
		$this->Treatment1->EditCustomAttributes = "";
		if (!$this->Treatment1->Raw)
			$this->Treatment1->CurrentValue = HtmlDecode($this->Treatment1->CurrentValue);
		$this->Treatment1->EditValue = $this->Treatment1->CurrentValue;
