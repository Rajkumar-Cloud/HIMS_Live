...
class view_ip_patient_admission extends DbTable
{
	...
	public function __construct()
	{
		...
		$this->patient_id->Lookup = new Lookup('patient_id', 'patient', FALSE, 'id', ["PatientID","first_name","mobile_no",""], [], [], [], [], ["PatientID","first_name","mobile_no","profilePic","gender","Age","CouppleID","FemaleID","dob"], ["x_PatientID","x_patient_name","x_mobileno","x_profilePic","x_gender","x_age","x_Cid","x_PartId","x_DOB"], '`id` DESC', '');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_ip_patient_admissionview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
