 ...
 * Page class
 */
class patient_address_edit extends patient_address
{
	...
	// Page object name
	public $PageObjName = "patient_address_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("patient_addresslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "patient_addresslist.php")
