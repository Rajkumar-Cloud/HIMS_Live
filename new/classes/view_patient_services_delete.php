 ...
 * Page class
 */
class view_patient_services_delete extends view_patient_services
{
	...
	// Page object name
	public $PageObjName = "view_patient_services_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("view_patient_serviceslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("view_patient_serviceslist.php"); // Return to list
			}
		}
	}
