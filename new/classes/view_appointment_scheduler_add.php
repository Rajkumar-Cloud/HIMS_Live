 ...
 * Page class
 */
class view_appointment_scheduler_add extends view_appointment_scheduler
{
	...
	// Page object name
	public $PageObjName = "view_appointment_scheduler_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "view_appointment_schedulerview.php")
