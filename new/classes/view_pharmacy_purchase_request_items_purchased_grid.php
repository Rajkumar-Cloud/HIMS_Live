 ...
 * Page class
 */
class view_pharmacy_purchase_request_items_purchased_grid extends view_pharmacy_purchase_request_items_purchased
{
	...
	// Page object name
	public $PageObjName = "view_pharmacy_purchase_request_items_purchased_grid";
...
// Render list options (extended codes)
	...
	protected function setupMasterParms()
	{
		...
		if ($masterTblVar == "view_pharmacy_purchase_request_purchased") {
			$this->prid->Visible = FALSE;
			if ($GLOBALS["view_pharmacy_purchase_request_purchased"]->EventCancelled)
