...
class view_dashboard_patient_details_preview extends view_dashboard_patient_details
{
	...
	protected function masterKeyUrl()
	{
		...
		if ($masterTblVar == "view_dashboard_patient_summary") {
			$url = "" . Config("TABLE_SHOW_MASTER") . "=view_dashboard_patient_summary&fk_createdDate=" . urlencode(UnFormatDateTime($this->createdDate->QueryStringValue, 0)) . "&fk_WhereDidYouHear=" . urlencode(strval($this->WhereDidYouHear->QueryStringValue)) . "";
		}
		return $url;
	}
