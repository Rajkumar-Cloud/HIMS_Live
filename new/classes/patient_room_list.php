 ...
 * Page class
 */
class patient_room_list extends patient_room
{
	...
	// Page object name
	public $PageObjName = "patient_room_list";

	// Grid form hidden field names
	public $FormName = "fpatient_roomlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "patient_roomadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "patient_roomdelete.php";
		$this->MultiUpdateUrl = "patient_roomupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fpatient_roomlistsrch";
	...
	public function getFilterList()
	{
		...
		if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile))
			$savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fpatient_roomlistsrch");
		...
		$filterList = Concat($filterList, $this->RoomID->AdvancedSearch->toJson(), ","); // Field RoomID
		$filterList = Concat($filterList, $this->RoomNo->AdvancedSearch->toJson(), ","); // Field RoomNo
		$filterList = Concat($filterList, $this->RoomType->AdvancedSearch->toJson(), ","); // Field RoomType
		$filterList = Concat($filterList, $this->SharingRoom->AdvancedSearch->toJson(), ","); // Field SharingRoom
		$filterList = Concat($filterList, $this->Amount->AdvancedSearch->toJson(), ","); // Field Amount
		$filterList = Concat($filterList, $this->Startdatetime->AdvancedSearch->toJson(), ","); // Field Startdatetime
		$filterList = Concat($filterList, $this->Enddatetime->AdvancedSearch->toJson(), ","); // Field Enddatetime
		$filterList = Concat($filterList, $this->DaysHours->AdvancedSearch->toJson(), ","); // Field DaysHours
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fpatient_roomlistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field RoomID
		$this->RoomID->AdvancedSearch->SearchValue = @$filter["x_RoomID"];
		$this->RoomID->AdvancedSearch->SearchOperator = @$filter["z_RoomID"];
		$this->RoomID->AdvancedSearch->SearchCondition = @$filter["v_RoomID"];
		$this->RoomID->AdvancedSearch->SearchValue2 = @$filter["y_RoomID"];
		$this->RoomID->AdvancedSearch->SearchOperator2 = @$filter["w_RoomID"];
		$this->RoomID->AdvancedSearch->save();

		// Field RoomNo
		$this->RoomNo->AdvancedSearch->SearchValue = @$filter["x_RoomNo"];
		$this->RoomNo->AdvancedSearch->SearchOperator = @$filter["z_RoomNo"];
		$this->RoomNo->AdvancedSearch->SearchCondition = @$filter["v_RoomNo"];
		$this->RoomNo->AdvancedSearch->SearchValue2 = @$filter["y_RoomNo"];
		$this->RoomNo->AdvancedSearch->SearchOperator2 = @$filter["w_RoomNo"];
		$this->RoomNo->AdvancedSearch->save();

		// Field RoomType
		$this->RoomType->AdvancedSearch->SearchValue = @$filter["x_RoomType"];
		$this->RoomType->AdvancedSearch->SearchOperator = @$filter["z_RoomType"];
		$this->RoomType->AdvancedSearch->SearchCondition = @$filter["v_RoomType"];
		$this->RoomType->AdvancedSearch->SearchValue2 = @$filter["y_RoomType"];
		$this->RoomType->AdvancedSearch->SearchOperator2 = @$filter["w_RoomType"];
		$this->RoomType->AdvancedSearch->save();

		// Field SharingRoom
		$this->SharingRoom->AdvancedSearch->SearchValue = @$filter["x_SharingRoom"];
		$this->SharingRoom->AdvancedSearch->SearchOperator = @$filter["z_SharingRoom"];
		$this->SharingRoom->AdvancedSearch->SearchCondition = @$filter["v_SharingRoom"];
		$this->SharingRoom->AdvancedSearch->SearchValue2 = @$filter["y_SharingRoom"];
		$this->SharingRoom->AdvancedSearch->SearchOperator2 = @$filter["w_SharingRoom"];
		$this->SharingRoom->AdvancedSearch->save();
		...
		// Field Startdatetime
		$this->Startdatetime->AdvancedSearch->SearchValue = @$filter["x_Startdatetime"];
		$this->Startdatetime->AdvancedSearch->SearchOperator = @$filter["z_Startdatetime"];
		$this->Startdatetime->AdvancedSearch->SearchCondition = @$filter["v_Startdatetime"];
		$this->Startdatetime->AdvancedSearch->SearchValue2 = @$filter["y_Startdatetime"];
		$this->Startdatetime->AdvancedSearch->SearchOperator2 = @$filter["w_Startdatetime"];
		$this->Startdatetime->AdvancedSearch->save();

		// Field Enddatetime
		$this->Enddatetime->AdvancedSearch->SearchValue = @$filter["x_Enddatetime"];
		$this->Enddatetime->AdvancedSearch->SearchOperator = @$filter["z_Enddatetime"];
		$this->Enddatetime->AdvancedSearch->SearchCondition = @$filter["v_Enddatetime"];
		$this->Enddatetime->AdvancedSearch->SearchValue2 = @$filter["y_Enddatetime"];
		$this->Enddatetime->AdvancedSearch->SearchOperator2 = @$filter["w_Enddatetime"];
		$this->Enddatetime->AdvancedSearch->save();

		// Field DaysHours
		$this->DaysHours->AdvancedSearch->SearchValue = @$filter["x_DaysHours"];
		$this->DaysHours->AdvancedSearch->SearchOperator = @$filter["z_DaysHours"];
		$this->DaysHours->AdvancedSearch->SearchCondition = @$filter["v_DaysHours"];
		$this->DaysHours->AdvancedSearch->SearchValue2 = @$filter["y_DaysHours"];
		$this->DaysHours->AdvancedSearch->SearchOperator2 = @$filter["w_DaysHours"];
		$this->DaysHours->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->RoomNo, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->RoomType, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->SharingRoom, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->DaysHours, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->RoomNo); // RoomNo
			$this->updateSort($this->RoomType); // RoomType
			$this->updateSort($this->SharingRoom); // SharingRoom
			$this->updateSort($this->Amount); // Amount
			$this->updateSort($this->Startdatetime); // Startdatetime
			$this->updateSort($this->Enddatetime); // Enddatetime
			$this->updateSort($this->DaysHours); // DaysHours
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->RoomID->setSort("");
				$this->RoomNo->setSort("");
				$this->RoomType->setSort("");
				$this->SharingRoom->setSort("");
				$this->Amount->setSort("");
				$this->Startdatetime->setSort("");
				$this->Enddatetime->setSort("");
				$this->DaysHours->setSort("");
				$this->Days->setSort("");
				$this->Hours->setSort("");
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpatient_roomlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpatient_roomlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fpatient_roomlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
...
// Render list options (extended codes)
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpatient_roomlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpatient_roomlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpatient_roomlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_patient_room" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_patient_room\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpatient_roomlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpatient_roomlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
