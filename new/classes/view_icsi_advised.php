...
class view_icsi_advised extends DbTable
{
	...
	public function __construct()
	{
		...
		// ICSIAdvised
		$this->ICSIAdvised = new DbField('view_icsi_advised', 'view_icsi_advised', 'x_ICSIAdvised', 'ICSIAdvised', '`ICSIAdvised`', '`ICSIAdvised`', 200, 45, -1, FALSE, '`ICSIAdvised`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_icsi_advisedview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
