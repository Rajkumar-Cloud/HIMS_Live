...
class help extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('help', 'help', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Tittle
		$this->Tittle = new DbField('help', 'help', 'x_Tittle', 'Tittle', '`Tittle`', '`Tittle`', 200, 45, -1, FALSE, '`Tittle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Description
		$this->Description = new DbField('help', 'help', 'x_Description', 'Description', '`Description`', '`Description`', 201, 65535, -1, FALSE, '`Description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// orderid
		$this->orderid = new DbField('help', 'help', 'x_orderid', 'orderid', '`orderid`', '`orderid`', 3, 11, -1, FALSE, '`orderid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "helpedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "helpadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("helpview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("helpview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "helpadd.php?" . $this->getUrlParm($parm);
		else
			$url = "helpadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("helpedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("helpadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("helpdelete.php", $this->getUrlParm());
	}
