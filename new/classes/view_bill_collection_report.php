...
class view_bill_collection_report extends DbTable
{
	...
	public function __construct()
	{
		...
		// UserName
		$this->UserName = new DbField('view_bill_collection_report', 'view_bill_collection_report', 'x_UserName', 'UserName', '`UserName`', '`UserName`', 200, 45, -1, FALSE, '`UserName`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("view_bill_collection_reportview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
