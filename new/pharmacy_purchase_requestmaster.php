...
<span<?php echo $pharmacy_purchase_request->id->viewAttributes() ?>><?php echo $pharmacy_purchase_request->id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->DT->viewAttributes() ?>><?php echo $pharmacy_purchase_request->DT->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->EmployeeName->viewAttributes() ?>><?php echo $pharmacy_purchase_request->EmployeeName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->Department->viewAttributes() ?>><?php echo $pharmacy_purchase_request->Department->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->ApprovedStatus->viewAttributes() ?>><?php echo $pharmacy_purchase_request->ApprovedStatus->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->PurchaseStatus->viewAttributes() ?>><?php echo $pharmacy_purchase_request->PurchaseStatus->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->HospID->viewAttributes() ?>><?php echo $pharmacy_purchase_request->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->createdby->viewAttributes() ?>><?php echo $pharmacy_purchase_request->createdby->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->createddatetime->viewAttributes() ?>><?php echo $pharmacy_purchase_request->createddatetime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->modifiedby->viewAttributes() ?>><?php echo $pharmacy_purchase_request->modifiedby->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->modifieddatetime->viewAttributes() ?>><?php echo $pharmacy_purchase_request->modifieddatetime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_purchase_request->BRCODE->viewAttributes() ?>><?php echo $pharmacy_purchase_request->BRCODE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
