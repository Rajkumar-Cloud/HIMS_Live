...
<span<?php echo $doctors->id->viewAttributes() ?>><?php echo $doctors->id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->CODE->viewAttributes() ?>><?php echo $doctors->CODE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->NAME->viewAttributes() ?>><?php echo $doctors->NAME->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->DEPARTMENT->viewAttributes() ?>><?php echo $doctors->DEPARTMENT->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->start_time->viewAttributes() ?>><?php echo $doctors->start_time->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->end_time->viewAttributes() ?>><?php echo $doctors->end_time->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->start_time1->viewAttributes() ?>><?php echo $doctors->start_time1->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->end_time1->viewAttributes() ?>><?php echo $doctors->end_time1->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->start_time2->viewAttributes() ?>><?php echo $doctors->start_time2->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->end_time2->viewAttributes() ?>><?php echo $doctors->end_time2->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->slot_time->viewAttributes() ?>><?php echo $doctors->slot_time->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->Fees->viewAttributes() ?>><?php echo $doctors->Fees->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->slot_days->viewAttributes() ?>><?php echo $doctors->slot_days->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->Status->viewAttributes() ?>><?php echo $doctors->Status->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->scheduler_id->viewAttributes() ?>><?php echo $doctors->scheduler_id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->HospID->viewAttributes() ?>><?php echo $doctors->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $doctors->Designation->viewAttributes() ?>><?php echo $doctors->Designation->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
