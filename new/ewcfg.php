...
$CONFIG = [
	...
	"RANDOM_KEY" => '9BfQLb86M4pf9vt1', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/HIMS.css", // Project stylesheet file name
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "ganeshkumar_89", "pass" => "Kumar@8989", "db" => "ganeshkumar_bjhims"]
	],
	...
	"ADMIN_PASSWORD" => "kumar8989", // Administrator password
	...
	"USER_LEVEL_NAME_FIELD" => "`UserLevelsName`",
	...
	"USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD" => "`id`",
	"USER_LEVEL_PRIV_PRIV_FIELD" => "`Permissions`",
	...
	"LOGIN_USERNAME_FIELD_NAME" => "mail_id",
	...
	"REGISTER_ACTIVATE_FIELD_NAME" => "email_verified",
	"USER_EMAIL_FIELD_NAME" => "mail_id",

	// User table filters
	"USER_TABLE_DBID" => "DB",
	"USER_TABLE" => "`user_login`",
	"USER_NAME_FILTER" => "(`mail_id` = '%u')",
	"USER_ID_FILTER" => "",
	"USER_EMAIL_FILTER" => "(`mail_id` = '%e')",
	...
	"SMTP_SECURE_OPTION" => "tls",
	"SMTP_SERVER_USERNAME" => "support@a4hospital.com", // SMTP server user name
	"SMTP_SERVER_PASSWORD" => "1234", // SMTP server password
	"SENDER_EMAIL" => "support@a4hospital.com", // Sender email address
	"RECIPIENT_EMAIL" => "support@a4hospital.com", // Recipient email address
...
$CONFIG["PDF_TIME_LIMIT"] = 1200; // Time limit
