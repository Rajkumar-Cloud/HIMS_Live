...
<span<?php echo $view_dashboard_service_servicetype->DEPARTMENT->viewAttributes() ?>><?php echo $view_dashboard_service_servicetype->DEPARTMENT->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_service_servicetype->SERVICE_TYPE->viewAttributes() ?>><?php echo $view_dashboard_service_servicetype->SERVICE_TYPE->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_service_servicetype->sum28SubTotal29->viewAttributes() ?>><?php echo $view_dashboard_service_servicetype->sum28SubTotal29->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_service_servicetype->createdDate->viewAttributes() ?>><?php echo $view_dashboard_service_servicetype->createdDate->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $view_dashboard_service_servicetype->HospID->viewAttributes() ?>><?php echo $view_dashboard_service_servicetype->HospID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
