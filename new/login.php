...
loadjs.ready("load", function() {
	...
	// Startup script
	var button=document.createElement("a");button.setAttribute("class","btn btn-warning ewButton"),button.innerHTML='<p>Download Android App Click here <i class="fa fa-hand-o-right" aria-hidden="true"></i> <a href="\\uploads\\userfiles\\apk\\a4hims.apk"><img border="0" alt="W3Schools" src="\\uploads\\userfiles\\apk\\Android-icon.png" width="100" height="100"></a>';var body=document.getElementsByTagName("form")[0];body.appendChild(button);
});
</script>
