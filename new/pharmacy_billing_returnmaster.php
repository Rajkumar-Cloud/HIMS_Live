...
<span<?php echo $pharmacy_billing_return->id->viewAttributes() ?>><?php echo $pharmacy_billing_return->id->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->PatientId->viewAttributes() ?>><?php echo $pharmacy_billing_return->PatientId->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->mrnno->viewAttributes() ?>><?php echo $pharmacy_billing_return->mrnno->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->PatientName->viewAttributes() ?>><?php echo $pharmacy_billing_return->PatientName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->Mobile->viewAttributes() ?>><?php echo $pharmacy_billing_return->Mobile->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->IP_OP->viewAttributes() ?>><?php echo $pharmacy_billing_return->IP_OP->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->Doctor->viewAttributes() ?>><?php echo $pharmacy_billing_return->Doctor->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->voucher_type->viewAttributes() ?>><?php echo $pharmacy_billing_return->voucher_type->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->ModeofPayment->viewAttributes() ?>><?php echo $pharmacy_billing_return->ModeofPayment->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->Amount->viewAttributes() ?>><?php echo $pharmacy_billing_return->Amount->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->AnyDues->viewAttributes() ?>><?php echo $pharmacy_billing_return->AnyDues->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->createdby->viewAttributes() ?>><?php echo $pharmacy_billing_return->createdby->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->createddatetime->viewAttributes() ?>><?php echo $pharmacy_billing_return->createddatetime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->modifiedby->viewAttributes() ?>><?php echo $pharmacy_billing_return->modifiedby->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->modifieddatetime->viewAttributes() ?>><?php echo $pharmacy_billing_return->modifieddatetime->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->RealizationAmount->viewAttributes() ?>><?php echo $pharmacy_billing_return->RealizationAmount->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->CId->viewAttributes() ?>><?php echo $pharmacy_billing_return->CId->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->PartnerName->viewAttributes() ?>><?php echo $pharmacy_billing_return->PartnerName->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->BillNumber->viewAttributes() ?>><?php echo $pharmacy_billing_return->BillNumber->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->CardNumber->viewAttributes() ?>><?php echo $pharmacy_billing_return->CardNumber->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->BillStatus->viewAttributes() ?>><?php echo $pharmacy_billing_return->BillStatus->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->ReportHeader->viewAttributes() ?>><?php echo $pharmacy_billing_return->ReportHeader->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
...
<span<?php echo $pharmacy_billing_return->PharID->viewAttributes() ?>><?php echo $pharmacy_billing_return->PharID->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
