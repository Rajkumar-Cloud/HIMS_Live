...
// Create page object
$recruitment_job_edit = new recruitment_job_edit();

// Run the page
$recruitment_job_edit->run();
...
$recruitment_job_edit->Page_Render();
?>
...
var frecruitment_jobedit = currentForm = new ew.Form("frecruitment_jobedit", "edit");

// Validate form
frecruitment_jobedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($recruitment_job_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $recruitment_job->id->caption(), $recruitment_job->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($recruitment_job_edit->title->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->shortDescription->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->requirements->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->benefits->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->country->Required) { ?>
		...
		<?php if ($recruitment_job_edit->company->Required) { ?>
		...
		<?php if ($recruitment_job_edit->department->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->code->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->employementType->Required) { ?>
		...
		<?php if ($recruitment_job_edit->industry->Required) { ?>
		...
		<?php if ($recruitment_job_edit->experienceLevel->Required) { ?>
		...
		<?php if ($recruitment_job_edit->jobFunction->Required) { ?>
		...
		<?php if ($recruitment_job_edit->educationLevel->Required) { ?>
		...
		<?php if ($recruitment_job_edit->currency->Required) { ?>
		...
		<?php if ($recruitment_job_edit->showSalary->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->salaryMin->Required) { ?>
		...
		<?php if ($recruitment_job_edit->salaryMax->Required) { ?>
		...
		<?php if ($recruitment_job_edit->keywords->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->closingDate->Required) { ?>
		...
		<?php if ($recruitment_job_edit->attachment->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->display->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_job_edit->postedBy->Required) { ?>
...
frecruitment_jobedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
frecruitment_jobedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frecruitment_jobedit.lists["x_showSalary"] = <?php echo $recruitment_job_edit->showSalary->Lookup->toClientList() ?>;
frecruitment_jobedit.lists["x_showSalary"].options = <?php echo JsonEncode($recruitment_job_edit->showSalary->options(FALSE, TRUE)) ?>;
frecruitment_jobedit.lists["x_status"] = <?php echo $recruitment_job_edit->status->Lookup->toClientList() ?>;
frecruitment_jobedit.lists["x_status"].options = <?php echo JsonEncode($recruitment_job_edit->status->options(FALSE, TRUE)) ?>;
...
<?php $recruitment_job_edit->showPageHeader(); ?>
<?php
$recruitment_job_edit->showMessage();
?>
<form name="frecruitment_jobedit" id="frecruitment_jobedit" class="<?php echo $recruitment_job_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($recruitment_job_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $recruitment_job_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="recruitment_job">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$recruitment_job_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($recruitment_job->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_recruitment_job_id" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->id->caption() ?><?php echo ($recruitment_job->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->id->cellAttributes() ?>>
<span id="el_recruitment_job_id">
<span<?php echo $recruitment_job->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($recruitment_job->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="recruitment_job" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($recruitment_job->id->CurrentValue) ?>">
<?php echo $recruitment_job->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($recruitment_job->title->Visible) { // title ?>
	<div id="r_title" class="form-group row">
		<label id="elh_recruitment_job_title" for="x_title" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->title->caption() ?><?php echo ($recruitment_job->title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->title->cellAttributes() ?>>
...
<?php if ($recruitment_job->shortDescription->Visible) { // shortDescription ?>
	<div id="r_shortDescription" class="form-group row">
		<label id="elh_recruitment_job_shortDescription" for="x_shortDescription" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->shortDescription->caption() ?><?php echo ($recruitment_job->shortDescription->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->shortDescription->cellAttributes() ?>>
...
<?php if ($recruitment_job->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_recruitment_job_description" for="x_description" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->description->caption() ?><?php echo ($recruitment_job->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->description->cellAttributes() ?>>
...
<?php if ($recruitment_job->requirements->Visible) { // requirements ?>
	<div id="r_requirements" class="form-group row">
		<label id="elh_recruitment_job_requirements" for="x_requirements" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->requirements->caption() ?><?php echo ($recruitment_job->requirements->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->requirements->cellAttributes() ?>>
...
<?php if ($recruitment_job->benefits->Visible) { // benefits ?>
	<div id="r_benefits" class="form-group row">
		<label id="elh_recruitment_job_benefits" for="x_benefits" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->benefits->caption() ?><?php echo ($recruitment_job->benefits->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->benefits->cellAttributes() ?>>
...
<?php if ($recruitment_job->country->Visible) { // country ?>
	<div id="r_country" class="form-group row">
		<label id="elh_recruitment_job_country" for="x_country" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->country->caption() ?><?php echo ($recruitment_job->country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->country->cellAttributes() ?>>
...
<?php if ($recruitment_job->company->Visible) { // company ?>
	<div id="r_company" class="form-group row">
		<label id="elh_recruitment_job_company" for="x_company" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->company->caption() ?><?php echo ($recruitment_job->company->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->company->cellAttributes() ?>>
...
<?php if ($recruitment_job->department->Visible) { // department ?>
	<div id="r_department" class="form-group row">
		<label id="elh_recruitment_job_department" for="x_department" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->department->caption() ?><?php echo ($recruitment_job->department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->department->cellAttributes() ?>>
...
<?php if ($recruitment_job->code->Visible) { // code ?>
	<div id="r_code" class="form-group row">
		<label id="elh_recruitment_job_code" for="x_code" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->code->caption() ?><?php echo ($recruitment_job->code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->code->cellAttributes() ?>>
...
<?php if ($recruitment_job->employementType->Visible) { // employementType ?>
	<div id="r_employementType" class="form-group row">
		<label id="elh_recruitment_job_employementType" for="x_employementType" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->employementType->caption() ?><?php echo ($recruitment_job->employementType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->employementType->cellAttributes() ?>>
...
<?php if ($recruitment_job->industry->Visible) { // industry ?>
	<div id="r_industry" class="form-group row">
		<label id="elh_recruitment_job_industry" for="x_industry" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->industry->caption() ?><?php echo ($recruitment_job->industry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->industry->cellAttributes() ?>>
...
<?php if ($recruitment_job->experienceLevel->Visible) { // experienceLevel ?>
	<div id="r_experienceLevel" class="form-group row">
		<label id="elh_recruitment_job_experienceLevel" for="x_experienceLevel" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->experienceLevel->caption() ?><?php echo ($recruitment_job->experienceLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->experienceLevel->cellAttributes() ?>>
...
<?php if ($recruitment_job->jobFunction->Visible) { // jobFunction ?>
	<div id="r_jobFunction" class="form-group row">
		<label id="elh_recruitment_job_jobFunction" for="x_jobFunction" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->jobFunction->caption() ?><?php echo ($recruitment_job->jobFunction->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->jobFunction->cellAttributes() ?>>
...
<?php if ($recruitment_job->educationLevel->Visible) { // educationLevel ?>
	<div id="r_educationLevel" class="form-group row">
		<label id="elh_recruitment_job_educationLevel" for="x_educationLevel" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->educationLevel->caption() ?><?php echo ($recruitment_job->educationLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->educationLevel->cellAttributes() ?>>
...
<?php if ($recruitment_job->currency->Visible) { // currency ?>
	<div id="r_currency" class="form-group row">
		<label id="elh_recruitment_job_currency" for="x_currency" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->currency->caption() ?><?php echo ($recruitment_job->currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->currency->cellAttributes() ?>>
...
<?php if ($recruitment_job->showSalary->Visible) { // showSalary ?>
	<div id="r_showSalary" class="form-group row">
		<label id="elh_recruitment_job_showSalary" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->showSalary->caption() ?><?php echo ($recruitment_job->showSalary->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->showSalary->cellAttributes() ?>>
...
<?php if ($recruitment_job->salaryMin->Visible) { // salaryMin ?>
	<div id="r_salaryMin" class="form-group row">
		<label id="elh_recruitment_job_salaryMin" for="x_salaryMin" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->salaryMin->caption() ?><?php echo ($recruitment_job->salaryMin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->salaryMin->cellAttributes() ?>>
...
<?php if ($recruitment_job->salaryMax->Visible) { // salaryMax ?>
	<div id="r_salaryMax" class="form-group row">
		<label id="elh_recruitment_job_salaryMax" for="x_salaryMax" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->salaryMax->caption() ?><?php echo ($recruitment_job->salaryMax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->salaryMax->cellAttributes() ?>>
...
<?php if ($recruitment_job->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group row">
		<label id="elh_recruitment_job_keywords" for="x_keywords" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->keywords->caption() ?><?php echo ($recruitment_job->keywords->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->keywords->cellAttributes() ?>>
...
<?php if ($recruitment_job->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_recruitment_job_status" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->status->caption() ?><?php echo ($recruitment_job->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->status->cellAttributes() ?>>
...
<?php if ($recruitment_job->closingDate->Visible) { // closingDate ?>
	<div id="r_closingDate" class="form-group row">
		<label id="elh_recruitment_job_closingDate" for="x_closingDate" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->closingDate->caption() ?><?php echo ($recruitment_job->closingDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->closingDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("frecruitment_jobedit", "x_closingDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($recruitment_job->attachment->Visible) { // attachment ?>
	<div id="r_attachment" class="form-group row">
		<label id="elh_recruitment_job_attachment" for="x_attachment" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->attachment->caption() ?><?php echo ($recruitment_job->attachment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->attachment->cellAttributes() ?>>
...
<?php if ($recruitment_job->display->Visible) { // display ?>
	<div id="r_display" class="form-group row">
		<label id="elh_recruitment_job_display" for="x_display" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->display->caption() ?><?php echo ($recruitment_job->display->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->display->cellAttributes() ?>>
...
<?php if ($recruitment_job->postedBy->Visible) { // postedBy ?>
	<div id="r_postedBy" class="form-group row">
		<label id="elh_recruitment_job_postedBy" for="x_postedBy" class="<?php echo $recruitment_job_edit->LeftColumnClass ?>"><?php echo $recruitment_job->postedBy->caption() ?><?php echo ($recruitment_job->postedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_job_edit->RightColumnClass ?>"><div<?php echo $recruitment_job->postedBy->cellAttributes() ?>>
...
<?php if (!$recruitment_job_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $recruitment_job_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $recruitment_job_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$recruitment_job_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$recruitment_job_edit->terminate();
?>