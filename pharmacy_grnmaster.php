...
<?php if ($pharmacy_grn->id->Visible) { // id ?>
		<tr id="r_id">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_id" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->id->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->id->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_id" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->GRNNO->Visible) { // GRNNO ?>
		<tr id="r_GRNNO">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_GRNNO" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->GRNNO->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->GRNNO->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_GRNNO" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->DT->Visible) { // DT ?>
		<tr id="r_DT">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_DT" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->DT->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->DT->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_DT" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->Customername->Visible) { // Customername ?>
		<tr id="r_Customername">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_Customername" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->Customername->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->Customername->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_Customername" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->State->Visible) { // State ?>
		<tr id="r_State">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_State" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->State->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->State->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_State" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->Pincode->Visible) { // Pincode ?>
		<tr id="r_Pincode">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_Pincode" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->Pincode->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->Pincode->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_Pincode" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->Phone->Visible) { // Phone ?>
		<tr id="r_Phone">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_Phone" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->Phone->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->Phone->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_Phone" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->BILLNO->Visible) { // BILLNO ?>
		<tr id="r_BILLNO">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_BILLNO" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->BILLNO->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->BILLNO->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_BILLNO" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->BILLDT->Visible) { // BILLDT ?>
		<tr id="r_BILLDT">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_BILLDT" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->BILLDT->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->BILLDT->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_BILLDT" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->BillTotalValue->Visible) { // BillTotalValue ?>
		<tr id="r_BillTotalValue">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_BillTotalValue" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->BillTotalValue->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->BillTotalValue->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_BillTotalValue" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->GRNTotalValue->Visible) { // GRNTotalValue ?>
		<tr id="r_GRNTotalValue">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_GRNTotalValue" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->GRNTotalValue->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->GRNTotalValue->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_GRNTotalValue" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->BillDiscount->Visible) { // BillDiscount ?>
		<tr id="r_BillDiscount">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_BillDiscount" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->BillDiscount->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->BillDiscount->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_BillDiscount" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->GrnValue->Visible) { // GrnValue ?>
		<tr id="r_GrnValue">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_GrnValue" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->GrnValue->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->GrnValue->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_GrnValue" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->Pid->Visible) { // Pid ?>
		<tr id="r_Pid">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_Pid" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->Pid->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->Pid->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_Pid" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->PaymentNo->Visible) { // PaymentNo ?>
		<tr id="r_PaymentNo">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_PaymentNo" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->PaymentNo->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->PaymentNo->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_PaymentNo" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->PaymentStatus->Visible) { // PaymentStatus ?>
		<tr id="r_PaymentStatus">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_PaymentStatus" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->PaymentStatus->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->PaymentStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_PaymentStatus" class="pharmacy_grnmaster" type="text/html">
...
<?php if ($pharmacy_grn->PaidAmount->Visible) { // PaidAmount ?>
		<tr id="r_PaidAmount">
			<td class="<?php echo $pharmacy_grn->TableLeftColumnClass ?>"><script id="tpc_pharmacy_grn_PaidAmount" class="pharmacy_grnmaster" type="text/html"><span><?php echo $pharmacy_grn->PaidAmount->caption() ?></span></script></td>
			<td<?php echo $pharmacy_grn->PaidAmount->cellAttributes() ?>>
<script id="tpx_pharmacy_grn_PaidAmount" class="pharmacy_grnmaster" type="text/html">
...
ew.applyTemplate("tpd_pharmacy_grnmaster", "tpm_pharmacy_grnmaster", "pharmacy_grnmaster", "<?php echo $pharmacy_grn->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.pharmacy_grnmaster_js").each(function(){ew.addScript(this.text);});
</script>
<?php } ?>