...
// Create page object
$view_ivf_oocytedenudation_embryology_chart_edit = new view_ivf_oocytedenudation_embryology_chart_edit();

// Run the page
$view_ivf_oocytedenudation_embryology_chart_edit->run();
...
$view_ivf_oocytedenudation_embryology_chart_edit->Page_Render();
?>
...
var fview_ivf_oocytedenudation_embryology_chartedit = currentForm = new ew.Form("fview_ivf_oocytedenudation_embryology_chartedit", "edit");
...
fview_ivf_oocytedenudation_embryology_chartedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->id->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->OocyteNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->Stage->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->RIDNo->Required) { ?>
		...
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->Name->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->Day0OocyteStage->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->Day0sino->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->TidNo->Required) { ?>
		...
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->DidNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->Remarks->Required) { ?>
...
fview_ivf_oocytedenudation_embryology_chartedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fview_ivf_oocytedenudation_embryology_chartedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $view_ivf_oocytedenudation_embryology_chart_edit->showPageHeader(); ?>
<?php
$view_ivf_oocytedenudation_embryology_chart_edit->showMessage();
?>
<form name="fview_ivf_oocytedenudation_embryology_chartedit" id="fview_ivf_oocytedenudation_embryology_chartedit" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($view_ivf_oocytedenudation_embryology_chart_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="view_ivf_oocytedenudation_embryology_chart">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$view_ivf_oocytedenudation_embryology_chart_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($view_ivf_oocytedenudation_embryology_chart->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_id" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->id->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->id->cellAttributes() ?>>
...
<input type="hidden" data-table="view_ivf_oocytedenudation_embryology_chart" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($view_ivf_oocytedenudation_embryology_chart->id->CurrentValue) ?>">
<?php echo $view_ivf_oocytedenudation_embryology_chart->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_ivf_oocytedenudation_embryology_chart->OocyteNo->Visible) { // OocyteNo ?>
	<div id="r_OocyteNo" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_OocyteNo" for="x_OocyteNo" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->OocyteNo->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->OocyteNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->OocyteNo->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->Stage->Visible) { // Stage ?>
	<div id="r_Stage" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_Stage" for="x_Stage" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->Stage->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->Stage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->Stage->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_RIDNo" for="x_RIDNo" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->RIDNo->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->RIDNo->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_Name" for="x_Name" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->Name->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->Name->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->Day0OocyteStage->Visible) { // Day0OocyteStage ?>
	<div id="r_Day0OocyteStage" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_Day0OocyteStage" for="x_Day0OocyteStage" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->Day0OocyteStage->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->Day0OocyteStage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->Day0OocyteStage->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->Day0sino->Visible) { // Day0sino ?>
	<div id="r_Day0sino" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_Day0sino" for="x_Day0sino" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->Day0sino->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->Day0sino->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->Day0sino->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_TidNo" for="x_TidNo" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->TidNo->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->TidNo->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->DidNO->Visible) { // DidNO ?>
	<div id="r_DidNO" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_DidNO" for="x_DidNO" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->DidNO->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->DidNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->DidNO->cellAttributes() ?>>
...
<?php if ($view_ivf_oocytedenudation_embryology_chart->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_view_ivf_oocytedenudation_embryology_chart_Remarks" for="x_Remarks" class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->LeftColumnClass ?>"><?php echo $view_ivf_oocytedenudation_embryology_chart->Remarks->caption() ?><?php echo ($view_ivf_oocytedenudation_embryology_chart->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->RightColumnClass ?>"><div<?php echo $view_ivf_oocytedenudation_embryology_chart->Remarks->cellAttributes() ?>>
...
<?php if (!$view_ivf_oocytedenudation_embryology_chart_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $view_ivf_oocytedenudation_embryology_chart_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$view_ivf_oocytedenudation_embryology_chart_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$view_ivf_oocytedenudation_embryology_chart_edit->terminate();
?>