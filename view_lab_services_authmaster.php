...
<?php if ($view_lab_services_auth->id->Visible) { // id ?>
		<tr id="r_id">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_id" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->id->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->id->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_id" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->SID->Visible) { // SID ?>
		<tr id="r_SID">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_SID" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->SID->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->SID->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_SID" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->PatientId->Visible) { // PatientId ?>
		<tr id="r_PatientId">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_PatientId" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->PatientId->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->PatientId->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_PatientId" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->PatientName->Visible) { // PatientName ?>
		<tr id="r_PatientName">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_PatientName" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->PatientName->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->PatientName->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_PatientName" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->Gender->Visible) { // Gender ?>
		<tr id="r_Gender">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_Gender" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->Gender->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->Gender->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_Gender" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->Mobile->Visible) { // Mobile ?>
		<tr id="r_Mobile">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_Mobile" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->Mobile->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->Mobile->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_Mobile" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->Doctor->Visible) { // Doctor ?>
		<tr id="r_Doctor">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_Doctor" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->Doctor->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->Doctor->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_Doctor" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->ModeofPayment->Visible) { // ModeofPayment ?>
		<tr id="r_ModeofPayment">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_ModeofPayment" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->ModeofPayment->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->ModeofPayment->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_ModeofPayment" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->Amount->Visible) { // Amount ?>
		<tr id="r_Amount">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_Amount" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->Amount->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->Amount->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_Amount" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->HospID->Visible) { // HospID ?>
		<tr id="r_HospID">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_HospID" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->HospID->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->HospID->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_HospID" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->RIDNO->Visible) { // RIDNO ?>
		<tr id="r_RIDNO">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_RIDNO" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->RIDNO->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->RIDNO->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_RIDNO" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->PartnerName->Visible) { // PartnerName ?>
		<tr id="r_PartnerName">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_PartnerName" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->PartnerName->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->PartnerName->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_PartnerName" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->PatId->Visible) { // PatId ?>
		<tr id="r_PatId">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_PatId" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->PatId->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->PatId->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_PatId" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->DrDepartment->Visible) { // DrDepartment ?>
		<tr id="r_DrDepartment">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_DrDepartment" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->DrDepartment->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->DrDepartment->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_DrDepartment" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->RefferedBy->Visible) { // RefferedBy ?>
		<tr id="r_RefferedBy">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_RefferedBy" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->RefferedBy->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->RefferedBy->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_RefferedBy" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->BillNumber->Visible) { // BillNumber ?>
		<tr id="r_BillNumber">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_BillNumber" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->BillNumber->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->BillNumber->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_BillNumber" class="view_lab_services_authmaster" type="text/html">
...
<?php if ($view_lab_services_auth->LabTestReleased->Visible) { // LabTestReleased ?>
		<tr id="r_LabTestReleased">
			<td class="<?php echo $view_lab_services_auth->TableLeftColumnClass ?>"><script id="tpc_view_lab_services_auth_LabTestReleased" class="view_lab_services_authmaster" type="text/html"><span><?php echo $view_lab_services_auth->LabTestReleased->caption() ?></span></script></td>
			<td<?php echo $view_lab_services_auth->LabTestReleased->cellAttributes() ?>>
<script id="tpx_view_lab_services_auth_LabTestReleased" class="view_lab_services_authmaster" type="text/html">
...
ew.applyTemplate("tpd_view_lab_services_authmaster", "tpm_view_lab_services_authmaster", "view_lab_services_authmaster", "<?php echo $view_lab_services_auth->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_lab_services_authmaster_js").each(function(){ew.addScript(this.text);});
</script>
<?php } ?>