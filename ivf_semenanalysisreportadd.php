...
var fivf_semenanalysisreportadd = currentForm = new ew.Form("fivf_semenanalysisreportadd", "add");
...
fivf_semenanalysisreportadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_semenanalysisreportadd.lists["x_RequestSample"] = <?php echo $ivf_semenanalysisreport_add->RequestSample->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_CollectionType"] = <?php echo $ivf_semenanalysisreport_add->CollectionType->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_CollectionMethod"] = <?php echo $ivf_semenanalysisreport_add->CollectionMethod->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_Medicationused"] = <?php echo $ivf_semenanalysisreport_add->Medicationused->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_DifficultiesinCollection"] = <?php echo $ivf_semenanalysisreport_add->DifficultiesinCollection->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_Homogenosity"] = <?php echo $ivf_semenanalysisreport_add->Homogenosity->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_CompleteSample"] = <?php echo $ivf_semenanalysisreport_add->CompleteSample->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_SemenOrgin"] = <?php echo $ivf_semenanalysisreport_add->SemenOrgin->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_Donor"] = <?php echo $ivf_semenanalysisreport_add->Donor->Lookup->toClientList() ?>;
fivf_semenanalysisreportadd.lists["x_Donor"].options = <?php echo JsonEncode($ivf_semenanalysisreport_add->Donor->lookupOptions()) ?>;
fivf_semenanalysisreportadd.lists["x_MACS[]"] = <?php echo $ivf_semenanalysisreport_add->MACS->Lookup->toClientList() ?>;
fivf_semenanalysisreportadd.lists["x_MACS[]"].options = <?php echo JsonEncode($ivf_semenanalysisreport_add->MACS->options(FALSE, TRUE)) ?>;
fivf_semenanalysisreportadd.lists["x_SPECIFIC_PROBLEMS"] = <?php echo $ivf_semenanalysisreport_add->SPECIFIC_PROBLEMS->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_LIQUIFACTION_STORAGE"] = <?php echo $ivf_semenanalysisreport_add->LIQUIFACTION_STORAGE->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_IUI_PREP_METHOD"] = <?php echo $ivf_semenanalysisreport_add->IUI_PREP_METHOD->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_TIME_FROM_TRIGGER"] = <?php echo $ivf_semenanalysisreport_add->TIME_FROM_TRIGGER->Lookup->toClientList() ?>;
...
fivf_semenanalysisreportadd.lists["x_COLLECTION_TO_PREPARATION"] = <?php echo $ivf_semenanalysisreport_add->COLLECTION_TO_PREPARATION->Lookup->toClientList() ?>;
...
<?php if ($ivf_semenanalysisreport_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_semenanalysisreport_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_semenanalysisreport->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_RIDNo" for="x_RIDNo" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_RIDNo" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->RIDNo->caption() ?><?php echo ($ivf_semenanalysisreport->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->RIDNo->cellAttributes() ?>>
<?php if ($ivf_semenanalysisreport->RIDNo->getSessionValue() <> "") { ?>
<script id="tpx_ivf_semenanalysisreport_RIDNo" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PatientName" for="x_PatientName" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PatientName" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PatientName->caption() ?><?php echo ($ivf_semenanalysisreport->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PatientName->cellAttributes() ?>>
<?php if ($ivf_semenanalysisreport->PatientName->getSessionValue() <> "") { ?>
<script id="tpx_ivf_semenanalysisreport_PatientName" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->HusbandName->Visible) { // HusbandName ?>
	<div id="r_HusbandName" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_HusbandName" for="x_HusbandName" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_HusbandName" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->HusbandName->caption() ?><?php echo ($ivf_semenanalysisreport->HusbandName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->HusbandName->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_HusbandName" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->RequestDr->Visible) { // RequestDr ?>
	<div id="r_RequestDr" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_RequestDr" for="x_RequestDr" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_RequestDr" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->RequestDr->caption() ?><?php echo ($ivf_semenanalysisreport->RequestDr->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->RequestDr->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_RequestDr" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->CollectionDate->Visible) { // CollectionDate ?>
	<div id="r_CollectionDate" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_CollectionDate" for="x_CollectionDate" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_CollectionDate" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->CollectionDate->caption() ?><?php echo ($ivf_semenanalysisreport->CollectionDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->CollectionDate->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_CollectionDate" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->ResultDate->Visible) { // ResultDate ?>
	<div id="r_ResultDate" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_ResultDate" for="x_ResultDate" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_ResultDate" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->ResultDate->caption() ?><?php echo ($ivf_semenanalysisreport->ResultDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->ResultDate->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_ResultDate" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->RequestSample->Visible) { // RequestSample ?>
	<div id="r_RequestSample" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_RequestSample" for="x_RequestSample" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_RequestSample" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->RequestSample->caption() ?><?php echo ($ivf_semenanalysisreport->RequestSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->RequestSample->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_RequestSample" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->CollectionType->Visible) { // CollectionType ?>
	<div id="r_CollectionType" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_CollectionType" for="x_CollectionType" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_CollectionType" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->CollectionType->caption() ?><?php echo ($ivf_semenanalysisreport->CollectionType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->CollectionType->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_CollectionType" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->CollectionMethod->Visible) { // CollectionMethod ?>
	<div id="r_CollectionMethod" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_CollectionMethod" for="x_CollectionMethod" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_CollectionMethod" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->CollectionMethod->caption() ?><?php echo ($ivf_semenanalysisreport->CollectionMethod->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->CollectionMethod->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_CollectionMethod" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Medicationused->Visible) { // Medicationused ?>
	<div id="r_Medicationused" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Medicationused" for="x_Medicationused" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Medicationused" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Medicationused->caption() ?><?php echo ($ivf_semenanalysisreport->Medicationused->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Medicationused->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Medicationused" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->DifficultiesinCollection->Visible) { // DifficultiesinCollection ?>
	<div id="r_DifficultiesinCollection" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_DifficultiesinCollection" for="x_DifficultiesinCollection" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_DifficultiesinCollection" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->DifficultiesinCollection->caption() ?><?php echo ($ivf_semenanalysisreport->DifficultiesinCollection->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->DifficultiesinCollection->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_DifficultiesinCollection" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->pH->Visible) { // pH ?>
	<div id="r_pH" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_pH" for="x_pH" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_pH" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->pH->caption() ?><?php echo ($ivf_semenanalysisreport->pH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->pH->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_pH" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Timeofcollection->Visible) { // Timeofcollection ?>
	<div id="r_Timeofcollection" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Timeofcollection" for="x_Timeofcollection" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Timeofcollection" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Timeofcollection->caption() ?><?php echo ($ivf_semenanalysisreport->Timeofcollection->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Timeofcollection->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Timeofcollection" class="ivf_semenanalysisreportadd" type="text/html">
...
<script type="text/html" class="ivf_semenanalysisreportadd_js">ew.createTimePicker("fivf_semenanalysisreportadd", "x_Timeofcollection", {"timeFormat":"h:i A","step":15});
</script>
...
<?php if ($ivf_semenanalysisreport->Timeofexamination->Visible) { // Timeofexamination ?>
	<div id="r_Timeofexamination" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Timeofexamination" for="x_Timeofexamination" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Timeofexamination" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Timeofexamination->caption() ?><?php echo ($ivf_semenanalysisreport->Timeofexamination->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Timeofexamination->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Timeofexamination" class="ivf_semenanalysisreportadd" type="text/html">
...
<script type="text/html" class="ivf_semenanalysisreportadd_js">ew.createTimePicker("fivf_semenanalysisreportadd", "x_Timeofexamination", {"timeFormat":"h:i A","step":15});
</script>
...
<?php if ($ivf_semenanalysisreport->Volume->Visible) { // Volume ?>
	<div id="r_Volume" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Volume" for="x_Volume" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Volume" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Volume->caption() ?><?php echo ($ivf_semenanalysisreport->Volume->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Volume->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Volume" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Concentration->Visible) { // Concentration ?>
	<div id="r_Concentration" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Concentration" for="x_Concentration" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Concentration" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Concentration->caption() ?><?php echo ($ivf_semenanalysisreport->Concentration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Concentration->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Concentration" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Total->Visible) { // Total ?>
	<div id="r_Total" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Total" for="x_Total" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Total" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Total->caption() ?><?php echo ($ivf_semenanalysisreport->Total->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Total->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Total" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->ProgressiveMotility->Visible) { // ProgressiveMotility ?>
	<div id="r_ProgressiveMotility" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_ProgressiveMotility" for="x_ProgressiveMotility" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_ProgressiveMotility" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->ProgressiveMotility->caption() ?><?php echo ($ivf_semenanalysisreport->ProgressiveMotility->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->ProgressiveMotility->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_ProgressiveMotility" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->NonProgrssiveMotile->Visible) { // NonProgrssiveMotile ?>
	<div id="r_NonProgrssiveMotile" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_NonProgrssiveMotile" for="x_NonProgrssiveMotile" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_NonProgrssiveMotile" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->NonProgrssiveMotile->caption() ?><?php echo ($ivf_semenanalysisreport->NonProgrssiveMotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->NonProgrssiveMotile->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_NonProgrssiveMotile" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Immotile->Visible) { // Immotile ?>
	<div id="r_Immotile" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Immotile" for="x_Immotile" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Immotile" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Immotile->caption() ?><?php echo ($ivf_semenanalysisreport->Immotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Immotile->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Immotile" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TotalProgrssiveMotile->Visible) { // TotalProgrssiveMotile ?>
	<div id="r_TotalProgrssiveMotile" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TotalProgrssiveMotile" for="x_TotalProgrssiveMotile" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TotalProgrssiveMotile" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TotalProgrssiveMotile->caption() ?><?php echo ($ivf_semenanalysisreport->TotalProgrssiveMotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TotalProgrssiveMotile->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_TotalProgrssiveMotile" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Appearance->Visible) { // Appearance ?>
	<div id="r_Appearance" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Appearance" for="x_Appearance" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Appearance" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Appearance->caption() ?><?php echo ($ivf_semenanalysisreport->Appearance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Appearance->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Appearance" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Homogenosity->Visible) { // Homogenosity ?>
	<div id="r_Homogenosity" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Homogenosity" for="x_Homogenosity" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Homogenosity" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Homogenosity->caption() ?><?php echo ($ivf_semenanalysisreport->Homogenosity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Homogenosity->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Homogenosity" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->CompleteSample->Visible) { // CompleteSample ?>
	<div id="r_CompleteSample" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_CompleteSample" for="x_CompleteSample" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_CompleteSample" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->CompleteSample->caption() ?><?php echo ($ivf_semenanalysisreport->CompleteSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->CompleteSample->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_CompleteSample" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Liquefactiontime->Visible) { // Liquefactiontime ?>
	<div id="r_Liquefactiontime" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Liquefactiontime" for="x_Liquefactiontime" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Liquefactiontime" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Liquefactiontime->caption() ?><?php echo ($ivf_semenanalysisreport->Liquefactiontime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Liquefactiontime->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Liquefactiontime" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Normal->Visible) { // Normal ?>
	<div id="r_Normal" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Normal" for="x_Normal" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Normal" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Normal->caption() ?><?php echo ($ivf_semenanalysisreport->Normal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Normal->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Normal" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Abnormal->Visible) { // Abnormal ?>
	<div id="r_Abnormal" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Abnormal" for="x_Abnormal" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Abnormal" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Abnormal->caption() ?><?php echo ($ivf_semenanalysisreport->Abnormal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Abnormal->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Abnormal" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Headdefects->Visible) { // Headdefects ?>
	<div id="r_Headdefects" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Headdefects" for="x_Headdefects" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Headdefects" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Headdefects->caption() ?><?php echo ($ivf_semenanalysisreport->Headdefects->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Headdefects->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Headdefects" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->MidpieceDefects->Visible) { // MidpieceDefects ?>
	<div id="r_MidpieceDefects" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_MidpieceDefects" for="x_MidpieceDefects" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_MidpieceDefects" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->MidpieceDefects->caption() ?><?php echo ($ivf_semenanalysisreport->MidpieceDefects->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->MidpieceDefects->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_MidpieceDefects" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TailDefects->Visible) { // TailDefects ?>
	<div id="r_TailDefects" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TailDefects" for="x_TailDefects" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TailDefects" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TailDefects->caption() ?><?php echo ($ivf_semenanalysisreport->TailDefects->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TailDefects->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_TailDefects" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->NormalProgMotile->Visible) { // NormalProgMotile ?>
	<div id="r_NormalProgMotile" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_NormalProgMotile" for="x_NormalProgMotile" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_NormalProgMotile" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->NormalProgMotile->caption() ?><?php echo ($ivf_semenanalysisreport->NormalProgMotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->NormalProgMotile->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_NormalProgMotile" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->ImmatureForms->Visible) { // ImmatureForms ?>
	<div id="r_ImmatureForms" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_ImmatureForms" for="x_ImmatureForms" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_ImmatureForms" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->ImmatureForms->caption() ?><?php echo ($ivf_semenanalysisreport->ImmatureForms->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->ImmatureForms->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_ImmatureForms" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Leucocytes->Visible) { // Leucocytes ?>
	<div id="r_Leucocytes" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Leucocytes" for="x_Leucocytes" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Leucocytes" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Leucocytes->caption() ?><?php echo ($ivf_semenanalysisreport->Leucocytes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Leucocytes->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Leucocytes" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Agglutination->Visible) { // Agglutination ?>
	<div id="r_Agglutination" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Agglutination" for="x_Agglutination" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Agglutination" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Agglutination->caption() ?><?php echo ($ivf_semenanalysisreport->Agglutination->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Agglutination->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Agglutination" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Debris->Visible) { // Debris ?>
	<div id="r_Debris" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Debris" for="x_Debris" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Debris" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Debris->caption() ?><?php echo ($ivf_semenanalysisreport->Debris->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Debris->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Debris" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Diagnosis->Visible) { // Diagnosis ?>
	<div id="r_Diagnosis" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Diagnosis" for="x_Diagnosis" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Diagnosis" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Diagnosis->caption() ?><?php echo ($ivf_semenanalysisreport->Diagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Diagnosis->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Diagnosis" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Observations->Visible) { // Observations ?>
	<div id="r_Observations" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Observations" for="x_Observations" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Observations" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Observations->caption() ?><?php echo ($ivf_semenanalysisreport->Observations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Observations->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Observations" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Signature->Visible) { // Signature ?>
	<div id="r_Signature" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Signature" for="x_Signature" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Signature" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Signature->caption() ?><?php echo ($ivf_semenanalysisreport->Signature->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Signature->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Signature" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->SemenOrgin->Visible) { // SemenOrgin ?>
	<div id="r_SemenOrgin" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_SemenOrgin" for="x_SemenOrgin" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_SemenOrgin" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->SemenOrgin->caption() ?><?php echo ($ivf_semenanalysisreport->SemenOrgin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->SemenOrgin->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_SemenOrgin" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Donor->Visible) { // Donor ?>
	<div id="r_Donor" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Donor" for="x_Donor" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Donor" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Donor->caption() ?><?php echo ($ivf_semenanalysisreport->Donor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Donor->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Donor" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->DonorBloodgroup->Visible) { // DonorBloodgroup ?>
	<div id="r_DonorBloodgroup" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_DonorBloodgroup" for="x_DonorBloodgroup" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_DonorBloodgroup" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->DonorBloodgroup->caption() ?><?php echo ($ivf_semenanalysisreport->DonorBloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->DonorBloodgroup->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_DonorBloodgroup" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Tank->Visible) { // Tank ?>
	<div id="r_Tank" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Tank" for="x_Tank" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Tank" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Tank->caption() ?><?php echo ($ivf_semenanalysisreport->Tank->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Tank->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Tank" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Location->Visible) { // Location ?>
	<div id="r_Location" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Location" for="x_Location" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Location" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Location->caption() ?><?php echo ($ivf_semenanalysisreport->Location->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Location->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Location" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Volume1->Visible) { // Volume1 ?>
	<div id="r_Volume1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Volume1" for="x_Volume1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Volume1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Volume1->caption() ?><?php echo ($ivf_semenanalysisreport->Volume1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Volume1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Volume1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Concentration1->Visible) { // Concentration1 ?>
	<div id="r_Concentration1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Concentration1" for="x_Concentration1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Concentration1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Concentration1->caption() ?><?php echo ($ivf_semenanalysisreport->Concentration1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Concentration1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Concentration1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Total1->Visible) { // Total1 ?>
	<div id="r_Total1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Total1" for="x_Total1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Total1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Total1->caption() ?><?php echo ($ivf_semenanalysisreport->Total1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Total1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Total1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->ProgressiveMotility1->Visible) { // ProgressiveMotility1 ?>
	<div id="r_ProgressiveMotility1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_ProgressiveMotility1" for="x_ProgressiveMotility1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_ProgressiveMotility1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->ProgressiveMotility1->caption() ?><?php echo ($ivf_semenanalysisreport->ProgressiveMotility1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->ProgressiveMotility1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_ProgressiveMotility1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->NonProgrssiveMotile1->Visible) { // NonProgrssiveMotile1 ?>
	<div id="r_NonProgrssiveMotile1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_NonProgrssiveMotile1" for="x_NonProgrssiveMotile1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_NonProgrssiveMotile1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->NonProgrssiveMotile1->caption() ?><?php echo ($ivf_semenanalysisreport->NonProgrssiveMotile1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->NonProgrssiveMotile1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_NonProgrssiveMotile1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Immotile1->Visible) { // Immotile1 ?>
	<div id="r_Immotile1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Immotile1" for="x_Immotile1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Immotile1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Immotile1->caption() ?><?php echo ($ivf_semenanalysisreport->Immotile1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Immotile1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Immotile1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TotalProgrssiveMotile1->Visible) { // TotalProgrssiveMotile1 ?>
	<div id="r_TotalProgrssiveMotile1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TotalProgrssiveMotile1" for="x_TotalProgrssiveMotile1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TotalProgrssiveMotile1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TotalProgrssiveMotile1->caption() ?><?php echo ($ivf_semenanalysisreport->TotalProgrssiveMotile1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TotalProgrssiveMotile1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_TotalProgrssiveMotile1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TidNo" for="x_TidNo" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TidNo" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TidNo->caption() ?><?php echo ($ivf_semenanalysisreport->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TidNo->cellAttributes() ?>>
<?php if ($ivf_semenanalysisreport->TidNo->getSessionValue() <> "") { ?>
<script id="tpx_ivf_semenanalysisreport_TidNo" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Color->Visible) { // Color ?>
	<div id="r_Color" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Color" for="x_Color" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Color" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Color->caption() ?><?php echo ($ivf_semenanalysisreport->Color->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Color->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Color" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->DoneBy->Visible) { // DoneBy ?>
	<div id="r_DoneBy" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_DoneBy" for="x_DoneBy" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_DoneBy" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->DoneBy->caption() ?><?php echo ($ivf_semenanalysisreport->DoneBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->DoneBy->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_DoneBy" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Method" for="x_Method" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Method" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Method->caption() ?><?php echo ($ivf_semenanalysisreport->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Method->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Method" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Abstinence->Visible) { // Abstinence ?>
	<div id="r_Abstinence" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Abstinence" for="x_Abstinence" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Abstinence" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Abstinence->caption() ?><?php echo ($ivf_semenanalysisreport->Abstinence->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Abstinence->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Abstinence" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->ProcessedBy->Visible) { // ProcessedBy ?>
	<div id="r_ProcessedBy" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_ProcessedBy" for="x_ProcessedBy" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_ProcessedBy" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->ProcessedBy->caption() ?><?php echo ($ivf_semenanalysisreport->ProcessedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->ProcessedBy->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_ProcessedBy" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->InseminationTime->Visible) { // InseminationTime ?>
	<div id="r_InseminationTime" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_InseminationTime" for="x_InseminationTime" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_InseminationTime" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->InseminationTime->caption() ?><?php echo ($ivf_semenanalysisreport->InseminationTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->InseminationTime->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_InseminationTime" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->InseminationBy->Visible) { // InseminationBy ?>
	<div id="r_InseminationBy" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_InseminationBy" for="x_InseminationBy" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_InseminationBy" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->InseminationBy->caption() ?><?php echo ($ivf_semenanalysisreport->InseminationBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->InseminationBy->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_InseminationBy" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Big->Visible) { // Big ?>
	<div id="r_Big" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Big" for="x_Big" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Big" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Big->caption() ?><?php echo ($ivf_semenanalysisreport->Big->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Big->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Big" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Medium->Visible) { // Medium ?>
	<div id="r_Medium" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Medium" for="x_Medium" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Medium" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Medium->caption() ?><?php echo ($ivf_semenanalysisreport->Medium->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Medium->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Medium" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Small->Visible) { // Small ?>
	<div id="r_Small" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Small" for="x_Small" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Small" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Small->caption() ?><?php echo ($ivf_semenanalysisreport->Small->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Small->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Small" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->NoHalo->Visible) { // NoHalo ?>
	<div id="r_NoHalo" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_NoHalo" for="x_NoHalo" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_NoHalo" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->NoHalo->caption() ?><?php echo ($ivf_semenanalysisreport->NoHalo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->NoHalo->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_NoHalo" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Fragmented->Visible) { // Fragmented ?>
	<div id="r_Fragmented" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Fragmented" for="x_Fragmented" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Fragmented" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Fragmented->caption() ?><?php echo ($ivf_semenanalysisreport->Fragmented->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Fragmented->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Fragmented" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->NonFragmented->Visible) { // NonFragmented ?>
	<div id="r_NonFragmented" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_NonFragmented" for="x_NonFragmented" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_NonFragmented" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->NonFragmented->caption() ?><?php echo ($ivf_semenanalysisreport->NonFragmented->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->NonFragmented->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_NonFragmented" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->DFI->Visible) { // DFI ?>
	<div id="r_DFI" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_DFI" for="x_DFI" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_DFI" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->DFI->caption() ?><?php echo ($ivf_semenanalysisreport->DFI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->DFI->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_DFI" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->IsueBy->Visible) { // IsueBy ?>
	<div id="r_IsueBy" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_IsueBy" for="x_IsueBy" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_IsueBy" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->IsueBy->caption() ?><?php echo ($ivf_semenanalysisreport->IsueBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->IsueBy->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_IsueBy" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Volume2->Visible) { // Volume2 ?>
	<div id="r_Volume2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Volume2" for="x_Volume2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Volume2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Volume2->caption() ?><?php echo ($ivf_semenanalysisreport->Volume2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Volume2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Volume2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Concentration2->Visible) { // Concentration2 ?>
	<div id="r_Concentration2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Concentration2" for="x_Concentration2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Concentration2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Concentration2->caption() ?><?php echo ($ivf_semenanalysisreport->Concentration2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Concentration2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Concentration2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Total2->Visible) { // Total2 ?>
	<div id="r_Total2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Total2" for="x_Total2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Total2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Total2->caption() ?><?php echo ($ivf_semenanalysisreport->Total2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Total2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Total2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->ProgressiveMotility2->Visible) { // ProgressiveMotility2 ?>
	<div id="r_ProgressiveMotility2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_ProgressiveMotility2" for="x_ProgressiveMotility2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_ProgressiveMotility2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->ProgressiveMotility2->caption() ?><?php echo ($ivf_semenanalysisreport->ProgressiveMotility2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->ProgressiveMotility2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_ProgressiveMotility2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->NonProgrssiveMotile2->Visible) { // NonProgrssiveMotile2 ?>
	<div id="r_NonProgrssiveMotile2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_NonProgrssiveMotile2" for="x_NonProgrssiveMotile2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_NonProgrssiveMotile2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->NonProgrssiveMotile2->caption() ?><?php echo ($ivf_semenanalysisreport->NonProgrssiveMotile2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->NonProgrssiveMotile2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_NonProgrssiveMotile2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->Immotile2->Visible) { // Immotile2 ?>
	<div id="r_Immotile2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_Immotile2" for="x_Immotile2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_Immotile2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->Immotile2->caption() ?><?php echo ($ivf_semenanalysisreport->Immotile2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->Immotile2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_Immotile2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TotalProgrssiveMotile2->Visible) { // TotalProgrssiveMotile2 ?>
	<div id="r_TotalProgrssiveMotile2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TotalProgrssiveMotile2" for="x_TotalProgrssiveMotile2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TotalProgrssiveMotile2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TotalProgrssiveMotile2->caption() ?><?php echo ($ivf_semenanalysisreport->TotalProgrssiveMotile2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TotalProgrssiveMotile2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_TotalProgrssiveMotile2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->MACS->Visible) { // MACS ?>
	<div id="r_MACS" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_MACS" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_MACS" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->MACS->caption() ?><?php echo ($ivf_semenanalysisreport->MACS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->MACS->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_MACS" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->IssuedBy->Visible) { // IssuedBy ?>
	<div id="r_IssuedBy" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_IssuedBy" for="x_IssuedBy" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_IssuedBy" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->IssuedBy->caption() ?><?php echo ($ivf_semenanalysisreport->IssuedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->IssuedBy->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_IssuedBy" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->IssuedTo->Visible) { // IssuedTo ?>
	<div id="r_IssuedTo" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_IssuedTo" for="x_IssuedTo" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_IssuedTo" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->IssuedTo->caption() ?><?php echo ($ivf_semenanalysisreport->IssuedTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->IssuedTo->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_IssuedTo" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PaID->Visible) { // PaID ?>
	<div id="r_PaID" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PaID" for="x_PaID" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PaID" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PaID->caption() ?><?php echo ($ivf_semenanalysisreport->PaID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PaID->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PaID" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PaName->Visible) { // PaName ?>
	<div id="r_PaName" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PaName" for="x_PaName" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PaName" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PaName->caption() ?><?php echo ($ivf_semenanalysisreport->PaName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PaName->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PaName" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PaMobile->Visible) { // PaMobile ?>
	<div id="r_PaMobile" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PaMobile" for="x_PaMobile" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PaMobile" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PaMobile->caption() ?><?php echo ($ivf_semenanalysisreport->PaMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PaMobile->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PaMobile" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PartnerID" for="x_PartnerID" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PartnerID" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PartnerID->caption() ?><?php echo ($ivf_semenanalysisreport->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PartnerID->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PartnerID" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PartnerName" for="x_PartnerName" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PartnerName" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PartnerName->caption() ?><?php echo ($ivf_semenanalysisreport->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PartnerName->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PartnerName" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PartnerMobile->Visible) { // PartnerMobile ?>
	<div id="r_PartnerMobile" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PartnerMobile" for="x_PartnerMobile" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PartnerMobile" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PartnerMobile->caption() ?><?php echo ($ivf_semenanalysisreport->PartnerMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PartnerMobile->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PartnerMobile" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->PREG_TEST_DATE->Visible) { // PREG_TEST_DATE ?>
	<div id="r_PREG_TEST_DATE" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_PREG_TEST_DATE" for="x_PREG_TEST_DATE" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_PREG_TEST_DATE" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->PREG_TEST_DATE->caption() ?><?php echo ($ivf_semenanalysisreport->PREG_TEST_DATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->PREG_TEST_DATE->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_PREG_TEST_DATE" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->SPECIFIC_PROBLEMS->Visible) { // SPECIFIC_PROBLEMS ?>
	<div id="r_SPECIFIC_PROBLEMS" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_SPECIFIC_PROBLEMS" for="x_SPECIFIC_PROBLEMS" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_SPECIFIC_PROBLEMS" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->SPECIFIC_PROBLEMS->caption() ?><?php echo ($ivf_semenanalysisreport->SPECIFIC_PROBLEMS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->SPECIFIC_PROBLEMS->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_SPECIFIC_PROBLEMS" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->IMSC_1->Visible) { // IMSC_1 ?>
	<div id="r_IMSC_1" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_IMSC_1" for="x_IMSC_1" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_IMSC_1" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->IMSC_1->caption() ?><?php echo ($ivf_semenanalysisreport->IMSC_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->IMSC_1->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_IMSC_1" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->IMSC_2->Visible) { // IMSC_2 ?>
	<div id="r_IMSC_2" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_IMSC_2" for="x_IMSC_2" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_IMSC_2" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->IMSC_2->caption() ?><?php echo ($ivf_semenanalysisreport->IMSC_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->IMSC_2->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_IMSC_2" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->LIQUIFACTION_STORAGE->Visible) { // LIQUIFACTION_STORAGE ?>
	<div id="r_LIQUIFACTION_STORAGE" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_LIQUIFACTION_STORAGE" for="x_LIQUIFACTION_STORAGE" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_LIQUIFACTION_STORAGE" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->LIQUIFACTION_STORAGE->caption() ?><?php echo ($ivf_semenanalysisreport->LIQUIFACTION_STORAGE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->LIQUIFACTION_STORAGE->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_LIQUIFACTION_STORAGE" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->IUI_PREP_METHOD->Visible) { // IUI_PREP_METHOD ?>
	<div id="r_IUI_PREP_METHOD" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_IUI_PREP_METHOD" for="x_IUI_PREP_METHOD" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_IUI_PREP_METHOD" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->IUI_PREP_METHOD->caption() ?><?php echo ($ivf_semenanalysisreport->IUI_PREP_METHOD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->IUI_PREP_METHOD->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_IUI_PREP_METHOD" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TIME_FROM_TRIGGER->Visible) { // TIME_FROM_TRIGGER ?>
	<div id="r_TIME_FROM_TRIGGER" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TIME_FROM_TRIGGER" for="x_TIME_FROM_TRIGGER" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TIME_FROM_TRIGGER" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TIME_FROM_TRIGGER->caption() ?><?php echo ($ivf_semenanalysisreport->TIME_FROM_TRIGGER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TIME_FROM_TRIGGER->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_TIME_FROM_TRIGGER" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->COLLECTION_TO_PREPARATION->Visible) { // COLLECTION_TO_PREPARATION ?>
	<div id="r_COLLECTION_TO_PREPARATION" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION" for="x_COLLECTION_TO_PREPARATION" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->COLLECTION_TO_PREPARATION->caption() ?><?php echo ($ivf_semenanalysisreport->COLLECTION_TO_PREPARATION->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->COLLECTION_TO_PREPARATION->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_COLLECTION_TO_PREPARATION" class="ivf_semenanalysisreportadd" type="text/html">
...
<?php if ($ivf_semenanalysisreport->TIME_FROM_PREP_TO_INSEM->Visible) { // TIME_FROM_PREP_TO_INSEM ?>
	<div id="r_TIME_FROM_PREP_TO_INSEM" class="form-group row">
		<label id="elh_ivf_semenanalysisreport_TIME_FROM_PREP_TO_INSEM" for="x_TIME_FROM_PREP_TO_INSEM" class="<?php echo $ivf_semenanalysisreport_add->LeftColumnClass ?>"><script id="tpc_ivf_semenanalysisreport_TIME_FROM_PREP_TO_INSEM" class="ivf_semenanalysisreportadd" type="text/html"><span><?php echo $ivf_semenanalysisreport->TIME_FROM_PREP_TO_INSEM->caption() ?><?php echo ($ivf_semenanalysisreport->TIME_FROM_PREP_TO_INSEM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_semenanalysisreport_add->RightColumnClass ?>"><div<?php echo $ivf_semenanalysisreport->TIME_FROM_PREP_TO_INSEM->cellAttributes() ?>>
<script id="tpx_ivf_semenanalysisreport_TIME_FROM_PREP_TO_INSEM" class="ivf_semenanalysisreportadd" type="text/html">
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_ivf_semenanalysisreport_HusbandName"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_HusbandName"/}}</h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_ivf_semenanalysisreport_RIDNo"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_RIDNo"/}}</h3>
	</div>
</div>
<div id="divCheckbox" style="display: none;">
{{include tmpl="#tpc_ivf_semenanalysisreport_PaID"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PaID"/}}
{{include tmpl="#tpc_ivf_semenanalysisreport_PaName"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PaName"/}}
{{include tmpl="#tpc_ivf_semenanalysisreport_PatientName"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PatientName"/}}
{{include tmpl="#tpc_ivf_semenanalysisreport_PaMobile"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PaMobile"/}}
{{include tmpl="#tpc_ivf_semenanalysisreport_PartnerID"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PartnerID"/}}
{{include tmpl="#tpc_ivf_semenanalysisreport_PartnerName"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PartnerName"/}}
{{include tmpl="#tpc_ivf_semenanalysisreport_PartnerMobile"/}}&nbsp;{{include tmpl="#tpx_ivf_semenanalysisreport_PartnerMobile"/}}
</div>
<div class="row">
...
ew.applyTemplate("tpd_ivf_semenanalysisreportadd", "tpm_ivf_semenanalysisreportadd", "ivf_semenanalysisreportadd", "<?php echo $ivf_semenanalysisreport->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_semenanalysisreportadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
