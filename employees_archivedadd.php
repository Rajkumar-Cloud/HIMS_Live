...
// Create page object
$employees_archived_add = new employees_archived_add();

// Run the page
$employees_archived_add->run();
...
$employees_archived_add->Page_Render();
?>
...
var femployees_archivedadd = currentForm = new ew.Form("femployees_archivedadd", "add");
...
femployees_archivedadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employees_archived_add->ref_id->Required) { ?>
		...
		<?php if ($employees_archived_add->employee_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->first_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->last_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->gender->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->ssn_num->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->nic_num->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->other_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->work_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->joined_date->Required) { ?>
		...
		<?php if ($employees_archived_add->confirmation_date->Required) { ?>
		...
		<?php if ($employees_archived_add->supervisor->Required) { ?>
		...
		<?php if ($employees_archived_add->department->Required) { ?>
		...
		<?php if ($employees_archived_add->termination_date->Required) { ?>
		...
		<?php if ($employees_archived_add->notes->Required) { ?>
		...
		<?php } ?>
		<?php if ($employees_archived_add->data->Required) { ?>
...
femployees_archivedadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployees_archivedadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployees_archivedadd.lists["x_gender"] = <?php echo $employees_archived_add->gender->Lookup->toClientList() ?>;
femployees_archivedadd.lists["x_gender"].options = <?php echo JsonEncode($employees_archived_add->gender->options(FALSE, TRUE)) ?>;
...
<?php $employees_archived_add->showPageHeader(); ?>
<?php
$employees_archived_add->showMessage();
?>
<form name="femployees_archivedadd" id="femployees_archivedadd" class="<?php echo $employees_archived_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employees_archived_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employees_archived_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employees_archived">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$employees_archived_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($employees_archived->ref_id->Visible) { // ref_id ?>
	<div id="r_ref_id" class="form-group row">
		<label id="elh_employees_archived_ref_id" for="x_ref_id" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->ref_id->caption() ?><?php echo ($employees_archived->ref_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->ref_id->cellAttributes() ?>>
...
<?php if ($employees_archived->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group row">
		<label id="elh_employees_archived_employee_id" for="x_employee_id" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->employee_id->caption() ?><?php echo ($employees_archived->employee_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->employee_id->cellAttributes() ?>>
...
<?php if ($employees_archived->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group row">
		<label id="elh_employees_archived_first_name" for="x_first_name" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->first_name->caption() ?><?php echo ($employees_archived->first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->first_name->cellAttributes() ?>>
...
<?php if ($employees_archived->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group row">
		<label id="elh_employees_archived_last_name" for="x_last_name" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->last_name->caption() ?><?php echo ($employees_archived->last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->last_name->cellAttributes() ?>>
...
<?php if ($employees_archived->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_employees_archived_gender" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->gender->caption() ?><?php echo ($employees_archived->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->gender->cellAttributes() ?>>
...
<?php if ($employees_archived->ssn_num->Visible) { // ssn_num ?>
	<div id="r_ssn_num" class="form-group row">
		<label id="elh_employees_archived_ssn_num" for="x_ssn_num" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->ssn_num->caption() ?><?php echo ($employees_archived->ssn_num->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->ssn_num->cellAttributes() ?>>
...
<?php if ($employees_archived->nic_num->Visible) { // nic_num ?>
	<div id="r_nic_num" class="form-group row">
		<label id="elh_employees_archived_nic_num" for="x_nic_num" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->nic_num->caption() ?><?php echo ($employees_archived->nic_num->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->nic_num->cellAttributes() ?>>
...
<?php if ($employees_archived->other_id->Visible) { // other_id ?>
	<div id="r_other_id" class="form-group row">
		<label id="elh_employees_archived_other_id" for="x_other_id" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->other_id->caption() ?><?php echo ($employees_archived->other_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->other_id->cellAttributes() ?>>
...
<?php if ($employees_archived->work_email->Visible) { // work_email ?>
	<div id="r_work_email" class="form-group row">
		<label id="elh_employees_archived_work_email" for="x_work_email" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->work_email->caption() ?><?php echo ($employees_archived->work_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->work_email->cellAttributes() ?>>
...
<?php if ($employees_archived->joined_date->Visible) { // joined_date ?>
	<div id="r_joined_date" class="form-group row">
		<label id="elh_employees_archived_joined_date" for="x_joined_date" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->joined_date->caption() ?><?php echo ($employees_archived->joined_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->joined_date->cellAttributes() ?>>
...
<?php if ($employees_archived->confirmation_date->Visible) { // confirmation_date ?>
	<div id="r_confirmation_date" class="form-group row">
		<label id="elh_employees_archived_confirmation_date" for="x_confirmation_date" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->confirmation_date->caption() ?><?php echo ($employees_archived->confirmation_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->confirmation_date->cellAttributes() ?>>
...
<?php if ($employees_archived->supervisor->Visible) { // supervisor ?>
	<div id="r_supervisor" class="form-group row">
		<label id="elh_employees_archived_supervisor" for="x_supervisor" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->supervisor->caption() ?><?php echo ($employees_archived->supervisor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->supervisor->cellAttributes() ?>>
...
<?php if ($employees_archived->department->Visible) { // department ?>
	<div id="r_department" class="form-group row">
		<label id="elh_employees_archived_department" for="x_department" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->department->caption() ?><?php echo ($employees_archived->department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->department->cellAttributes() ?>>
...
<?php if ($employees_archived->termination_date->Visible) { // termination_date ?>
	<div id="r_termination_date" class="form-group row">
		<label id="elh_employees_archived_termination_date" for="x_termination_date" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->termination_date->caption() ?><?php echo ($employees_archived->termination_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->termination_date->cellAttributes() ?>>
...
<?php if ($employees_archived->notes->Visible) { // notes ?>
	<div id="r_notes" class="form-group row">
		<label id="elh_employees_archived_notes" for="x_notes" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->notes->caption() ?><?php echo ($employees_archived->notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->notes->cellAttributes() ?>>
...
<?php if ($employees_archived->data->Visible) { // data ?>
	<div id="r_data" class="form-group row">
		<label id="elh_employees_archived_data" for="x_data" class="<?php echo $employees_archived_add->LeftColumnClass ?>"><?php echo $employees_archived->data->caption() ?><?php echo ($employees_archived->data->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employees_archived_add->RightColumnClass ?>"><div<?php echo $employees_archived->data->cellAttributes() ?>>
...
<?php if (!$employees_archived_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employees_archived_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employees_archived_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employees_archived_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employees_archived_add->terminate();
?>