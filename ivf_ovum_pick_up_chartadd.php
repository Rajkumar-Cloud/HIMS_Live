...
var fivf_ovum_pick_up_chartadd = currentForm = new ew.Form("fivf_ovum_pick_up_chartadd", "add");
...
fivf_ovum_pick_up_chartadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_ovum_pick_up_chartadd.lists["x_Protocol"] = <?php echo $ivf_ovum_pick_up_chart_add->Protocol->Lookup->toClientList() ?>;
...
fivf_ovum_pick_up_chartadd.lists["x_Cannulation"] = <?php echo $ivf_ovum_pick_up_chart_add->Cannulation->Lookup->toClientList() ?>;
...
fivf_ovum_pick_up_chartadd.lists["x_PlanT"] = <?php echo $ivf_ovum_pick_up_chart_add->PlanT->Lookup->toClientList() ?>;
fivf_ovum_pick_up_chartadd.lists["x_PlanT"].options = <?php echo JsonEncode($ivf_ovum_pick_up_chart_add->PlanT->options(FALSE, TRUE)) ?>;
fivf_ovum_pick_up_chartadd.lists["x_TemplateProcedure"] = <?php echo $ivf_ovum_pick_up_chart_add->TemplateProcedure->Lookup->toClientList() ?>;
...
fivf_ovum_pick_up_chartadd.lists["x_TemplateCourseInHospital"] = <?php echo $ivf_ovum_pick_up_chart_add->TemplateCourseInHospital->Lookup->toClientList() ?>;
...
fivf_ovum_pick_up_chartadd.lists["x_TemplateDischargeAdvise"] = <?php echo $ivf_ovum_pick_up_chart_add->TemplateDischargeAdvise->Lookup->toClientList() ?>;
...
fivf_ovum_pick_up_chartadd.lists["x_TemplateFollowUpAdvise"] = <?php echo $ivf_ovum_pick_up_chart_add->TemplateFollowUpAdvise->Lookup->toClientList() ?>;
...
<?php if ($ivf_ovum_pick_up_chart_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_ovum_pick_up_chart_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_ovum_pick_up_chart->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_RIDNo" for="x_RIDNo" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_RIDNo" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->RIDNo->caption() ?><?php echo ($ivf_ovum_pick_up_chart->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->RIDNo->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_RIDNo" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_Name" for="x_Name" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_Name" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->Name->caption() ?><?php echo ($ivf_ovum_pick_up_chart->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->Name->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_Name" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->ARTCycle->Visible) { // ARTCycle ?>
	<div id="r_ARTCycle" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_ARTCycle" for="x_ARTCycle" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_ARTCycle" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->ARTCycle->caption() ?><?php echo ($ivf_ovum_pick_up_chart->ARTCycle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->ARTCycle->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_ARTCycle" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->Consultant->Visible) { // Consultant ?>
	<div id="r_Consultant" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_Consultant" for="x_Consultant" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_Consultant" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->Consultant->caption() ?><?php echo ($ivf_ovum_pick_up_chart->Consultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->Consultant->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_Consultant" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TotalDoseOfStimulation->Visible) { // TotalDoseOfStimulation ?>
	<div id="r_TotalDoseOfStimulation" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TotalDoseOfStimulation" for="x_TotalDoseOfStimulation" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TotalDoseOfStimulation" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TotalDoseOfStimulation->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TotalDoseOfStimulation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TotalDoseOfStimulation->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TotalDoseOfStimulation" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->Protocol->Visible) { // Protocol ?>
	<div id="r_Protocol" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_Protocol" for="x_Protocol" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_Protocol" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->Protocol->caption() ?><?php echo ($ivf_ovum_pick_up_chart->Protocol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->Protocol->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_Protocol" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->NumberOfDaysOfStimulation->Visible) { // NumberOfDaysOfStimulation ?>
	<div id="r_NumberOfDaysOfStimulation" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_NumberOfDaysOfStimulation" for="x_NumberOfDaysOfStimulation" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_NumberOfDaysOfStimulation" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->NumberOfDaysOfStimulation->caption() ?><?php echo ($ivf_ovum_pick_up_chart->NumberOfDaysOfStimulation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->NumberOfDaysOfStimulation->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_NumberOfDaysOfStimulation" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TriggerDateTime->Visible) { // TriggerDateTime ?>
	<div id="r_TriggerDateTime" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TriggerDateTime" for="x_TriggerDateTime" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TriggerDateTime" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TriggerDateTime->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TriggerDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TriggerDateTime->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TriggerDateTime" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->OPUDateTime->Visible) { // OPUDateTime ?>
	<div id="r_OPUDateTime" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_OPUDateTime" for="x_OPUDateTime" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_OPUDateTime" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->OPUDateTime->caption() ?><?php echo ($ivf_ovum_pick_up_chart->OPUDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->OPUDateTime->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_OPUDateTime" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->HoursAfterTrigger->Visible) { // HoursAfterTrigger ?>
	<div id="r_HoursAfterTrigger" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_HoursAfterTrigger" for="x_HoursAfterTrigger" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_HoursAfterTrigger" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->HoursAfterTrigger->caption() ?><?php echo ($ivf_ovum_pick_up_chart->HoursAfterTrigger->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->HoursAfterTrigger->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_HoursAfterTrigger" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->SerumE2->Visible) { // SerumE2 ?>
	<div id="r_SerumE2" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_SerumE2" for="x_SerumE2" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_SerumE2" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->SerumE2->caption() ?><?php echo ($ivf_ovum_pick_up_chart->SerumE2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->SerumE2->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_SerumE2" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->SerumP4->Visible) { // SerumP4 ?>
	<div id="r_SerumP4" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_SerumP4" for="x_SerumP4" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_SerumP4" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->SerumP4->caption() ?><?php echo ($ivf_ovum_pick_up_chart->SerumP4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->SerumP4->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_SerumP4" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->FORT->Visible) { // FORT ?>
	<div id="r_FORT" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_FORT" for="x_FORT" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_FORT" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->FORT->caption() ?><?php echo ($ivf_ovum_pick_up_chart->FORT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->FORT->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_FORT" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->ExperctedOocytes->Visible) { // ExperctedOocytes ?>
	<div id="r_ExperctedOocytes" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_ExperctedOocytes" for="x_ExperctedOocytes" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_ExperctedOocytes" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->ExperctedOocytes->caption() ?><?php echo ($ivf_ovum_pick_up_chart->ExperctedOocytes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->ExperctedOocytes->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_ExperctedOocytes" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->NoOfOocytesRetrieved->Visible) { // NoOfOocytesRetrieved ?>
	<div id="r_NoOfOocytesRetrieved" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_NoOfOocytesRetrieved" for="x_NoOfOocytesRetrieved" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_NoOfOocytesRetrieved" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->NoOfOocytesRetrieved->caption() ?><?php echo ($ivf_ovum_pick_up_chart->NoOfOocytesRetrieved->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->NoOfOocytesRetrieved->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_NoOfOocytesRetrieved" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->OocytesRetreivalRate->Visible) { // OocytesRetreivalRate ?>
	<div id="r_OocytesRetreivalRate" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_OocytesRetreivalRate" for="x_OocytesRetreivalRate" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_OocytesRetreivalRate" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->OocytesRetreivalRate->caption() ?><?php echo ($ivf_ovum_pick_up_chart->OocytesRetreivalRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->OocytesRetreivalRate->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_OocytesRetreivalRate" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->Anesthesia->Visible) { // Anesthesia ?>
	<div id="r_Anesthesia" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_Anesthesia" for="x_Anesthesia" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_Anesthesia" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->Anesthesia->caption() ?><?php echo ($ivf_ovum_pick_up_chart->Anesthesia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->Anesthesia->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_Anesthesia" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TrialCannulation->Visible) { // TrialCannulation ?>
	<div id="r_TrialCannulation" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TrialCannulation" for="x_TrialCannulation" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TrialCannulation" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TrialCannulation->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TrialCannulation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TrialCannulation->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TrialCannulation" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->UCL->Visible) { // UCL ?>
	<div id="r_UCL" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_UCL" for="x_UCL" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_UCL" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->UCL->caption() ?><?php echo ($ivf_ovum_pick_up_chart->UCL->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->UCL->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_UCL" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->Angle->Visible) { // Angle ?>
	<div id="r_Angle" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_Angle" for="x_Angle" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_Angle" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->Angle->caption() ?><?php echo ($ivf_ovum_pick_up_chart->Angle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->Angle->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_Angle" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->EMS->Visible) { // EMS ?>
	<div id="r_EMS" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_EMS" for="x_EMS" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_EMS" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->EMS->caption() ?><?php echo ($ivf_ovum_pick_up_chart->EMS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->EMS->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_EMS" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->Cannulation->Visible) { // Cannulation ?>
	<div id="r_Cannulation" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_Cannulation" for="x_Cannulation" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_Cannulation" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->Cannulation->caption() ?><?php echo ($ivf_ovum_pick_up_chart->Cannulation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->Cannulation->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_Cannulation" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->ProcedureT->Visible) { // ProcedureT ?>
	<div id="r_ProcedureT" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_ProcedureT" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_ProcedureT" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->ProcedureT->caption() ?><?php echo ($ivf_ovum_pick_up_chart->ProcedureT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->ProcedureT->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_ProcedureT" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<script type="text/html" class="ivf_ovum_pick_up_chartadd_js">
ew.createEditor("fivf_ovum_pick_up_chartadd", "x_ProcedureT", 35, 4, <?php echo ($ivf_ovum_pick_up_chart->ProcedureT->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_ovum_pick_up_chart->NoOfOocytesRetrievedd->Visible) { // NoOfOocytesRetrievedd ?>
	<div id="r_NoOfOocytesRetrievedd" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_NoOfOocytesRetrievedd" for="x_NoOfOocytesRetrievedd" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_NoOfOocytesRetrievedd" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->NoOfOocytesRetrievedd->caption() ?><?php echo ($ivf_ovum_pick_up_chart->NoOfOocytesRetrievedd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->NoOfOocytesRetrievedd->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_NoOfOocytesRetrievedd" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->CourseInHospital->Visible) { // CourseInHospital ?>
	<div id="r_CourseInHospital" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_CourseInHospital" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_CourseInHospital" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->CourseInHospital->caption() ?><?php echo ($ivf_ovum_pick_up_chart->CourseInHospital->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->CourseInHospital->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_CourseInHospital" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<script type="text/html" class="ivf_ovum_pick_up_chartadd_js">
ew.createEditor("fivf_ovum_pick_up_chartadd", "x_CourseInHospital", 35, 4, <?php echo ($ivf_ovum_pick_up_chart->CourseInHospital->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_ovum_pick_up_chart->DischargeAdvise->Visible) { // DischargeAdvise ?>
	<div id="r_DischargeAdvise" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_DischargeAdvise" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_DischargeAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->DischargeAdvise->caption() ?><?php echo ($ivf_ovum_pick_up_chart->DischargeAdvise->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->DischargeAdvise->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_DischargeAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<script type="text/html" class="ivf_ovum_pick_up_chartadd_js">
ew.createEditor("fivf_ovum_pick_up_chartadd", "x_DischargeAdvise", 35, 4, <?php echo ($ivf_ovum_pick_up_chart->DischargeAdvise->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_ovum_pick_up_chart->FollowUpAdvise->Visible) { // FollowUpAdvise ?>
	<div id="r_FollowUpAdvise" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_FollowUpAdvise" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_FollowUpAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->FollowUpAdvise->caption() ?><?php echo ($ivf_ovum_pick_up_chart->FollowUpAdvise->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->FollowUpAdvise->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_FollowUpAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<script type="text/html" class="ivf_ovum_pick_up_chartadd_js">
ew.createEditor("fivf_ovum_pick_up_chartadd", "x_FollowUpAdvise", 35, 4, <?php echo ($ivf_ovum_pick_up_chart->FollowUpAdvise->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_ovum_pick_up_chart->PlanT->Visible) { // PlanT ?>
	<div id="r_PlanT" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_PlanT" for="x_PlanT" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_PlanT" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->PlanT->caption() ?><?php echo ($ivf_ovum_pick_up_chart->PlanT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->PlanT->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_PlanT" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->ReviewDate->Visible) { // ReviewDate ?>
	<div id="r_ReviewDate" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_ReviewDate" for="x_ReviewDate" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_ReviewDate" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->ReviewDate->caption() ?><?php echo ($ivf_ovum_pick_up_chart->ReviewDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->ReviewDate->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_ReviewDate" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->ReviewDoctor->Visible) { // ReviewDoctor ?>
	<div id="r_ReviewDoctor" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_ReviewDoctor" for="x_ReviewDoctor" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_ReviewDoctor" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->ReviewDoctor->caption() ?><?php echo ($ivf_ovum_pick_up_chart->ReviewDoctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->ReviewDoctor->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_ReviewDoctor" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TemplateProcedure->Visible) { // TemplateProcedure ?>
	<div id="r_TemplateProcedure" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TemplateProcedure" for="x_TemplateProcedure" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TemplateProcedure" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TemplateProcedure->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TemplateProcedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TemplateProcedure->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TemplateProcedure" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TemplateCourseInHospital->Visible) { // TemplateCourseInHospital ?>
	<div id="r_TemplateCourseInHospital" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TemplateCourseInHospital" for="x_TemplateCourseInHospital" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TemplateCourseInHospital" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TemplateCourseInHospital->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TemplateCourseInHospital->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TemplateCourseInHospital->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TemplateCourseInHospital" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TemplateDischargeAdvise->Visible) { // TemplateDischargeAdvise ?>
	<div id="r_TemplateDischargeAdvise" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TemplateDischargeAdvise" for="x_TemplateDischargeAdvise" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TemplateDischargeAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TemplateDischargeAdvise->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TemplateDischargeAdvise->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TemplateDischargeAdvise->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TemplateDischargeAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TemplateFollowUpAdvise->Visible) { // TemplateFollowUpAdvise ?>
	<div id="r_TemplateFollowUpAdvise" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TemplateFollowUpAdvise" for="x_TemplateFollowUpAdvise" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TemplateFollowUpAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TemplateFollowUpAdvise->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TemplateFollowUpAdvise->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TemplateFollowUpAdvise->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TemplateFollowUpAdvise" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
<?php if ($ivf_ovum_pick_up_chart->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_ovum_pick_up_chart_TidNo" for="x_TidNo" class="<?php echo $ivf_ovum_pick_up_chart_add->LeftColumnClass ?>"><script id="tpc_ivf_ovum_pick_up_chart_TidNo" class="ivf_ovum_pick_up_chartadd" type="text/html"><span><?php echo $ivf_ovum_pick_up_chart->TidNo->caption() ?><?php echo ($ivf_ovum_pick_up_chart->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_ovum_pick_up_chart_add->RightColumnClass ?>"><div<?php echo $ivf_ovum_pick_up_chart->TidNo->cellAttributes() ?>>
<script id="tpx_ivf_ovum_pick_up_chart_TidNo" class="ivf_ovum_pick_up_chartadd" type="text/html">
...
ew.applyTemplate("tpd_ivf_ovum_pick_up_chartadd", "tpm_ivf_ovum_pick_up_chartadd", "ivf_ovum_pick_up_chartadd", "<?php echo $ivf_ovum_pick_up_chart->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_ovum_pick_up_chartadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
