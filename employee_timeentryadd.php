...
// Create page object
$employee_timeentry_add = new employee_timeentry_add();

// Run the page
$employee_timeentry_add->run();
...
$employee_timeentry_add->Page_Render();
?>
...
var femployee_timeentryadd = currentForm = new ew.Form("femployee_timeentryadd", "add");
...
femployee_timeentryadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_timeentry_add->project->Required) { ?>
		...
		<?php if ($employee_timeentry_add->employee->Required) { ?>
		...
		<?php if ($employee_timeentry_add->timesheet->Required) { ?>
		...
		<?php if ($employee_timeentry_add->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_timeentry_add->created->Required) { ?>
		...
		<?php if ($employee_timeentry_add->date_start->Required) { ?>
		...
		<?php if ($employee_timeentry_add->time_start->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_timeentry_add->date_end->Required) { ?>
		...
		<?php if ($employee_timeentry_add->time_end->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_timeentry_add->status->Required) { ?>
...
femployee_timeentryadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_timeentryadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_timeentryadd.lists["x_status"] = <?php echo $employee_timeentry_add->status->Lookup->toClientList() ?>;
femployee_timeentryadd.lists["x_status"].options = <?php echo JsonEncode($employee_timeentry_add->status->options(FALSE, TRUE)) ?>;
...
<?php $employee_timeentry_add->showPageHeader(); ?>
<?php
$employee_timeentry_add->showMessage();
?>
<form name="femployee_timeentryadd" id="femployee_timeentryadd" class="<?php echo $employee_timeentry_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_timeentry_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_timeentry_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_timeentry">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$employee_timeentry_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($employee_timeentry->project->Visible) { // project ?>
	<div id="r_project" class="form-group row">
		<label id="elh_employee_timeentry_project" for="x_project" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->project->caption() ?><?php echo ($employee_timeentry->project->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->project->cellAttributes() ?>>
...
<?php if ($employee_timeentry->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employee_timeentry_employee" for="x_employee" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->employee->caption() ?><?php echo ($employee_timeentry->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->employee->cellAttributes() ?>>
...
<?php if ($employee_timeentry->timesheet->Visible) { // timesheet ?>
	<div id="r_timesheet" class="form-group row">
		<label id="elh_employee_timeentry_timesheet" for="x_timesheet" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->timesheet->caption() ?><?php echo ($employee_timeentry->timesheet->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->timesheet->cellAttributes() ?>>
...
<?php if ($employee_timeentry->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_employee_timeentry_details" for="x_details" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->details->caption() ?><?php echo ($employee_timeentry->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->details->cellAttributes() ?>>
...
<?php if ($employee_timeentry->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_employee_timeentry_created" for="x_created" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->created->caption() ?><?php echo ($employee_timeentry->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->created->cellAttributes() ?>>
...
<?php if ($employee_timeentry->date_start->Visible) { // date_start ?>
	<div id="r_date_start" class="form-group row">
		<label id="elh_employee_timeentry_date_start" for="x_date_start" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->date_start->caption() ?><?php echo ($employee_timeentry->date_start->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->date_start->cellAttributes() ?>>
...
<?php if ($employee_timeentry->time_start->Visible) { // time_start ?>
	<div id="r_time_start" class="form-group row">
		<label id="elh_employee_timeentry_time_start" for="x_time_start" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->time_start->caption() ?><?php echo ($employee_timeentry->time_start->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->time_start->cellAttributes() ?>>
...
<?php if ($employee_timeentry->date_end->Visible) { // date_end ?>
	<div id="r_date_end" class="form-group row">
		<label id="elh_employee_timeentry_date_end" for="x_date_end" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->date_end->caption() ?><?php echo ($employee_timeentry->date_end->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->date_end->cellAttributes() ?>>
...
<?php if ($employee_timeentry->time_end->Visible) { // time_end ?>
	<div id="r_time_end" class="form-group row">
		<label id="elh_employee_timeentry_time_end" for="x_time_end" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->time_end->caption() ?><?php echo ($employee_timeentry->time_end->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->time_end->cellAttributes() ?>>
...
<?php if ($employee_timeentry->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_timeentry_status" class="<?php echo $employee_timeentry_add->LeftColumnClass ?>"><?php echo $employee_timeentry->status->caption() ?><?php echo ($employee_timeentry->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_timeentry_add->RightColumnClass ?>"><div<?php echo $employee_timeentry->status->cellAttributes() ?>>
...
<?php if (!$employee_timeentry_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_timeentry_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_timeentry_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_timeentry_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_timeentry_add->terminate();
?>