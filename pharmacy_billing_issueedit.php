...
var fpharmacy_billing_issueedit = currentForm = new ew.Form("fpharmacy_billing_issueedit", "edit");
...
fpharmacy_billing_issueedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_billing_issueedit.lists["x_Reception"] = <?php echo $pharmacy_billing_issue_edit->Reception->Lookup->toClientList() ?>;
...
fpharmacy_billing_issueedit.lists["x_ModeofPayment"] = <?php echo $pharmacy_billing_issue_edit->ModeofPayment->Lookup->toClientList() ?>;
...
fpharmacy_billing_issueedit.lists["x_RIDNO"] = <?php echo $pharmacy_billing_issue_edit->RIDNO->Lookup->toClientList() ?>;
fpharmacy_billing_issueedit.lists["x_RIDNO"].options = <?php echo JsonEncode($pharmacy_billing_issue_edit->RIDNO->lookupOptions()) ?>;
fpharmacy_billing_issueedit.lists["x_CId"] = <?php echo $pharmacy_billing_issue_edit->CId->Lookup->toClientList() ?>;
fpharmacy_billing_issueedit.lists["x_CId"].options = <?php echo JsonEncode($pharmacy_billing_issue_edit->CId->lookupOptions()) ?>;
fpharmacy_billing_issueedit.lists["x_PatId"] = <?php echo $pharmacy_billing_issue_edit->PatId->Lookup->toClientList() ?>;
fpharmacy_billing_issueedit.lists["x_PatId"].options = <?php echo JsonEncode($pharmacy_billing_issue_edit->PatId->lookupOptions()) ?>;
fpharmacy_billing_issueedit.lists["x_RefferedBy"] = <?php echo $pharmacy_billing_issue_edit->RefferedBy->Lookup->toClientList() ?>;
...
fpharmacy_billing_issueedit.lists["x_DrID"] = <?php echo $pharmacy_billing_issue_edit->DrID->Lookup->toClientList() ?>;
fpharmacy_billing_issueedit.lists["x_DrID"].options = <?php echo JsonEncode($pharmacy_billing_issue_edit->DrID->lookupOptions()) ?>;
fpharmacy_billing_issueedit.lists["x_ReportHeader[]"] = <?php echo $pharmacy_billing_issue_edit->ReportHeader->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_billing_issue_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_billing_issue_edit->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_billing_issue->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_pharmacy_billing_issue_id" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_id" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->id->caption() ?><?php echo ($pharmacy_billing_issue->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->id->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_id" class="pharmacy_billing_issueedit" type="text/html">
...
<input type="hidden" data-table="pharmacy_billing_issue" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($pharmacy_billing_issue->id->CurrentValue) ?>">
<?php echo $pharmacy_billing_issue->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pharmacy_billing_issue->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Reception" for="x_Reception" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Reception" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Reception->caption() ?><?php echo ($pharmacy_billing_issue->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Reception->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Reception" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_pharmacy_billing_issue_PatientId" for="x_PatientId" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_PatientId" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->PatientId->caption() ?><?php echo ($pharmacy_billing_issue->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->PatientId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_PatientId" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_pharmacy_billing_issue_mrnno" for="x_mrnno" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_mrnno" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->mrnno->caption() ?><?php echo ($pharmacy_billing_issue->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->mrnno->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_mrnno" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_pharmacy_billing_issue_PatientName" for="x_PatientName" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_PatientName" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->PatientName->caption() ?><?php echo ($pharmacy_billing_issue->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->PatientName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_PatientName" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Age" for="x_Age" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Age" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Age->caption() ?><?php echo ($pharmacy_billing_issue->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Age->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Age" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Gender" for="x_Gender" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Gender" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Gender->caption() ?><?php echo ($pharmacy_billing_issue->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Gender->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Gender" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_pharmacy_billing_issue_profilePic" for="x_profilePic" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_profilePic" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->profilePic->caption() ?><?php echo ($pharmacy_billing_issue->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->profilePic->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_profilePic" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Mobile" for="x_Mobile" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Mobile" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Mobile->caption() ?><?php echo ($pharmacy_billing_issue->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Mobile->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Mobile" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->IP_OP->Visible) { // IP_OP ?>
	<div id="r_IP_OP" class="form-group row">
		<label id="elh_pharmacy_billing_issue_IP_OP" for="x_IP_OP" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_IP_OP" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->IP_OP->caption() ?><?php echo ($pharmacy_billing_issue->IP_OP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->IP_OP->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_IP_OP" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Doctor" for="x_Doctor" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Doctor" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Doctor->caption() ?><?php echo ($pharmacy_billing_issue->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Doctor->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Doctor" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_pharmacy_billing_issue_voucher_type" for="x_voucher_type" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_voucher_type" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->voucher_type->caption() ?><?php echo ($pharmacy_billing_issue->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->voucher_type->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_voucher_type" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Details" for="x_Details" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Details" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Details->caption() ?><?php echo ($pharmacy_billing_issue->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Details->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Details" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_pharmacy_billing_issue_ModeofPayment" for="x_ModeofPayment" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_ModeofPayment" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->ModeofPayment->caption() ?><?php echo ($pharmacy_billing_issue->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->ModeofPayment->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_ModeofPayment" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Amount" for="x_Amount" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Amount" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Amount->caption() ?><?php echo ($pharmacy_billing_issue->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Amount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Amount" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_pharmacy_billing_issue_AnyDues" for="x_AnyDues" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_AnyDues" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->AnyDues->caption() ?><?php echo ($pharmacy_billing_issue->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->AnyDues->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_AnyDues" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RealizationAmount" for="x_RealizationAmount" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RealizationAmount" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RealizationAmount->caption() ?><?php echo ($pharmacy_billing_issue->RealizationAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RealizationAmount->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RealizationAmount" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RealizationStatus" for="x_RealizationStatus" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RealizationStatus" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RealizationStatus->caption() ?><?php echo ($pharmacy_billing_issue->RealizationStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RealizationStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RealizationStatus" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RealizationRemarks" for="x_RealizationRemarks" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RealizationRemarks" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RealizationRemarks->caption() ?><?php echo ($pharmacy_billing_issue->RealizationRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RealizationRemarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RealizationRemarks" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RealizationBatchNo" for="x_RealizationBatchNo" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RealizationBatchNo" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RealizationBatchNo->caption() ?><?php echo ($pharmacy_billing_issue->RealizationBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RealizationBatchNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RealizationBatchNo" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RealizationDate" for="x_RealizationDate" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RealizationDate" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RealizationDate->caption() ?><?php echo ($pharmacy_billing_issue->RealizationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RealizationDate->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RealizationDate" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RIDNO" for="x_RIDNO" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RIDNO" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RIDNO->caption() ?><?php echo ($pharmacy_billing_issue->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RIDNO->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RIDNO" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_pharmacy_billing_issue_TidNo" for="x_TidNo" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_TidNo" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->TidNo->caption() ?><?php echo ($pharmacy_billing_issue->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->TidNo->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_TidNo" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_pharmacy_billing_issue_CId" for="x_CId" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_CId" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->CId->caption() ?><?php echo ($pharmacy_billing_issue->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->CId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_CId" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_pharmacy_billing_issue_PartnerName" for="x_PartnerName" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_PartnerName" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->PartnerName->caption() ?><?php echo ($pharmacy_billing_issue->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->PartnerName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_PartnerName" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->PayerType->Visible) { // PayerType ?>
	<div id="r_PayerType" class="form-group row">
		<label id="elh_pharmacy_billing_issue_PayerType" for="x_PayerType" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_PayerType" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->PayerType->caption() ?><?php echo ($pharmacy_billing_issue->PayerType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->PayerType->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_PayerType" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Dob->Visible) { // Dob ?>
	<div id="r_Dob" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Dob" for="x_Dob" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Dob" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Dob->caption() ?><?php echo ($pharmacy_billing_issue->Dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Dob->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Dob" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Currency" for="x_Currency" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Currency" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Currency->caption() ?><?php echo ($pharmacy_billing_issue->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Currency->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Currency" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->DiscountRemarks->Visible) { // DiscountRemarks ?>
	<div id="r_DiscountRemarks" class="form-group row">
		<label id="elh_pharmacy_billing_issue_DiscountRemarks" for="x_DiscountRemarks" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_DiscountRemarks" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->DiscountRemarks->caption() ?><?php echo ($pharmacy_billing_issue->DiscountRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->DiscountRemarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_DiscountRemarks" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_pharmacy_billing_issue_Remarks" for="x_Remarks" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_Remarks" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->Remarks->caption() ?><?php echo ($pharmacy_billing_issue->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->Remarks->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_Remarks" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_pharmacy_billing_issue_PatId" for="x_PatId" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_PatId" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->PatId->caption() ?><?php echo ($pharmacy_billing_issue->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->PatId->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_PatId" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_pharmacy_billing_issue_DrDepartment" for="x_DrDepartment" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_DrDepartment" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->DrDepartment->caption() ?><?php echo ($pharmacy_billing_issue->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->DrDepartment->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_DrDepartment" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->RefferedBy->Visible) { // RefferedBy ?>
	<div id="r_RefferedBy" class="form-group row">
		<label id="elh_pharmacy_billing_issue_RefferedBy" for="x_RefferedBy" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_RefferedBy" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->RefferedBy->caption() ?><?php echo ($pharmacy_billing_issue->RefferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->RefferedBy->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_RefferedBy" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_pharmacy_billing_issue_BillNumber" for="x_BillNumber" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_BillNumber" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->BillNumber->caption() ?><?php echo ($pharmacy_billing_issue->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->BillNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_BillNumber" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_pharmacy_billing_issue_CardNumber" for="x_CardNumber" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_CardNumber" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->CardNumber->caption() ?><?php echo ($pharmacy_billing_issue->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->CardNumber->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_CardNumber" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_pharmacy_billing_issue_BankName" for="x_BankName" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_BankName" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->BankName->caption() ?><?php echo ($pharmacy_billing_issue->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->BankName->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_BankName" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_pharmacy_billing_issue_DrID" for="x_DrID" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_DrID" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->DrID->caption() ?><?php echo ($pharmacy_billing_issue->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->DrID->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_DrID" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_pharmacy_billing_issue_BillStatus" for="x_BillStatus" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_BillStatus" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->BillStatus->caption() ?><?php echo ($pharmacy_billing_issue->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->BillStatus->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_BillStatus" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_pharmacy_billing_issue_ReportHeader" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_ReportHeader" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->ReportHeader->caption() ?><?php echo ($pharmacy_billing_issue->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->ReportHeader->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_ReportHeader" class="pharmacy_billing_issueedit" type="text/html">
...
<?php if ($pharmacy_billing_issue->PharID->Visible) { // PharID ?>
	<div id="r_PharID" class="form-group row">
		<label id="elh_pharmacy_billing_issue_PharID" for="x_PharID" class="<?php echo $pharmacy_billing_issue_edit->LeftColumnClass ?>"><script id="tpc_pharmacy_billing_issue_PharID" class="pharmacy_billing_issueedit" type="text/html"><span><?php echo $pharmacy_billing_issue->PharID->caption() ?><?php echo ($pharmacy_billing_issue->PharID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $pharmacy_billing_issue_edit->RightColumnClass ?>"><div<?php echo $pharmacy_billing_issue->PharID->cellAttributes() ?>>
<script id="tpx_pharmacy_billing_issue_PharID" class="pharmacy_billing_issueedit" type="text/html">
...
ew.applyTemplate("tpd_pharmacy_billing_issueedit", "tpm_pharmacy_billing_issueedit", "pharmacy_billing_issueedit", "<?php echo $pharmacy_billing_issue->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.pharmacy_billing_issueedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
