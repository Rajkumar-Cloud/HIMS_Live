...
var fview_donor_ivfadd = currentForm = new ew.Form("fview_donor_ivfadd", "add");
...
fview_donor_ivfadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_donor_ivfadd.lists["x_Female"] = <?php echo $view_donor_ivf_add->Female->Lookup->toClientList() ?>;
fview_donor_ivfadd.lists["x_Female"].options = <?php echo JsonEncode($view_donor_ivf_add->Female->lookupOptions()) ?>;
fview_donor_ivfadd.lists["x_status"] = <?php echo $view_donor_ivf_add->status->Lookup->toClientList() ?>;
fview_donor_ivfadd.lists["x_status"].options = <?php echo JsonEncode($view_donor_ivf_add->status->lookupOptions()) ?>;
fview_donor_ivfadd.lists["x_ReferedBy"] = <?php echo $view_donor_ivf_add->ReferedBy->Lookup->toClientList() ?>;
fview_donor_ivfadd.lists["x_ReferedBy"].options = <?php echo JsonEncode($view_donor_ivf_add->ReferedBy->lookupOptions()) ?>;
fview_donor_ivfadd.lists["x_DrID"] = <?php echo $view_donor_ivf_add->DrID->Lookup->toClientList() ?>;
...
<?php if ($view_donor_ivf_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_donor_ivf_add->Token ?>">
<?php } ?>
...
<?php if ($view_donor_ivf->Female->Visible) { // Female ?>
	<div id="r_Female" class="form-group row">
		<label id="elh_view_donor_ivf_Female" for="x_Female" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_Female" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->Female->caption() ?><?php echo ($view_donor_ivf->Female->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->Female->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_Female" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_view_donor_ivf_status" for="x_status" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_status" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->status->caption() ?><?php echo ($view_donor_ivf->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->status->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_status" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->malepropic->Visible) { // malepropic ?>
	<div id="r_malepropic" class="form-group row">
		<label id="elh_view_donor_ivf_malepropic" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_malepropic" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->malepropic->caption() ?><?php echo ($view_donor_ivf->malepropic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->malepropic->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_malepropic" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->femalepropic->Visible) { // femalepropic ?>
	<div id="r_femalepropic" class="form-group row">
		<label id="elh_view_donor_ivf_femalepropic" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_femalepropic" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->femalepropic->caption() ?><?php echo ($view_donor_ivf->femalepropic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->femalepropic->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_femalepropic" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->HusbandEducation->Visible) { // HusbandEducation ?>
	<div id="r_HusbandEducation" class="form-group row">
		<label id="elh_view_donor_ivf_HusbandEducation" for="x_HusbandEducation" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_HusbandEducation" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->HusbandEducation->caption() ?><?php echo ($view_donor_ivf->HusbandEducation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->HusbandEducation->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_HusbandEducation" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->WifeEducation->Visible) { // WifeEducation ?>
	<div id="r_WifeEducation" class="form-group row">
		<label id="elh_view_donor_ivf_WifeEducation" for="x_WifeEducation" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_WifeEducation" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->WifeEducation->caption() ?><?php echo ($view_donor_ivf->WifeEducation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->WifeEducation->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_WifeEducation" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->HusbandWorkHours->Visible) { // HusbandWorkHours ?>
	<div id="r_HusbandWorkHours" class="form-group row">
		<label id="elh_view_donor_ivf_HusbandWorkHours" for="x_HusbandWorkHours" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_HusbandWorkHours" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->HusbandWorkHours->caption() ?><?php echo ($view_donor_ivf->HusbandWorkHours->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->HusbandWorkHours->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_HusbandWorkHours" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->WifeWorkHours->Visible) { // WifeWorkHours ?>
	<div id="r_WifeWorkHours" class="form-group row">
		<label id="elh_view_donor_ivf_WifeWorkHours" for="x_WifeWorkHours" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_WifeWorkHours" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->WifeWorkHours->caption() ?><?php echo ($view_donor_ivf->WifeWorkHours->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->WifeWorkHours->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_WifeWorkHours" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->PatientLanguage->Visible) { // PatientLanguage ?>
	<div id="r_PatientLanguage" class="form-group row">
		<label id="elh_view_donor_ivf_PatientLanguage" for="x_PatientLanguage" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_PatientLanguage" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->PatientLanguage->caption() ?><?php echo ($view_donor_ivf->PatientLanguage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->PatientLanguage->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_PatientLanguage" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->ReferedBy->Visible) { // ReferedBy ?>
	<div id="r_ReferedBy" class="form-group row">
		<label id="elh_view_donor_ivf_ReferedBy" for="x_ReferedBy" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_ReferedBy" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->ReferedBy->caption() ?><?php echo ($view_donor_ivf->ReferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->ReferedBy->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_ReferedBy" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->ReferPhNo->Visible) { // ReferPhNo ?>
	<div id="r_ReferPhNo" class="form-group row">
		<label id="elh_view_donor_ivf_ReferPhNo" for="x_ReferPhNo" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_ReferPhNo" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->ReferPhNo->caption() ?><?php echo ($view_donor_ivf->ReferPhNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->ReferPhNo->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_ReferPhNo" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->WifeCell->Visible) { // WifeCell ?>
	<div id="r_WifeCell" class="form-group row">
		<label id="elh_view_donor_ivf_WifeCell" for="x_WifeCell" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_WifeCell" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->WifeCell->caption() ?><?php echo ($view_donor_ivf->WifeCell->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->WifeCell->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_WifeCell" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->HusbandCell->Visible) { // HusbandCell ?>
	<div id="r_HusbandCell" class="form-group row">
		<label id="elh_view_donor_ivf_HusbandCell" for="x_HusbandCell" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_HusbandCell" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->HusbandCell->caption() ?><?php echo ($view_donor_ivf->HusbandCell->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->HusbandCell->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_HusbandCell" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->WifeEmail->Visible) { // WifeEmail ?>
	<div id="r_WifeEmail" class="form-group row">
		<label id="elh_view_donor_ivf_WifeEmail" for="x_WifeEmail" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_WifeEmail" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->WifeEmail->caption() ?><?php echo ($view_donor_ivf->WifeEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->WifeEmail->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_WifeEmail" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->HusbandEmail->Visible) { // HusbandEmail ?>
	<div id="r_HusbandEmail" class="form-group row">
		<label id="elh_view_donor_ivf_HusbandEmail" for="x_HusbandEmail" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_HusbandEmail" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->HusbandEmail->caption() ?><?php echo ($view_donor_ivf->HusbandEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->HusbandEmail->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_HusbandEmail" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->ARTCYCLE->Visible) { // ARTCYCLE ?>
	<div id="r_ARTCYCLE" class="form-group row">
		<label id="elh_view_donor_ivf_ARTCYCLE" for="x_ARTCYCLE" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_ARTCYCLE" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->ARTCYCLE->caption() ?><?php echo ($view_donor_ivf->ARTCYCLE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->ARTCYCLE->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_ARTCYCLE" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->RESULT->Visible) { // RESULT ?>
	<div id="r_RESULT" class="form-group row">
		<label id="elh_view_donor_ivf_RESULT" for="x_RESULT" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_RESULT" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->RESULT->caption() ?><?php echo ($view_donor_ivf->RESULT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->RESULT->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_RESULT" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->CoupleID->Visible) { // CoupleID ?>
	<div id="r_CoupleID" class="form-group row">
		<label id="elh_view_donor_ivf_CoupleID" for="x_CoupleID" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_CoupleID" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->CoupleID->caption() ?><?php echo ($view_donor_ivf->CoupleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->CoupleID->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_CoupleID" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_view_donor_ivf_HospID" for="x_HospID" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_HospID" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->HospID->caption() ?><?php echo ($view_donor_ivf->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->HospID->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_HospID" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_view_donor_ivf_PatientName" for="x_PatientName" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_PatientName" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->PatientName->caption() ?><?php echo ($view_donor_ivf->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->PatientName->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_PatientName" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_view_donor_ivf_PatientID" for="x_PatientID" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_PatientID" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->PatientID->caption() ?><?php echo ($view_donor_ivf->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->PatientID->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_PatientID" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_view_donor_ivf_PartnerName" for="x_PartnerName" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_PartnerName" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->PartnerName->caption() ?><?php echo ($view_donor_ivf->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->PartnerName->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_PartnerName" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_view_donor_ivf_PartnerID" for="x_PartnerID" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_PartnerID" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->PartnerID->caption() ?><?php echo ($view_donor_ivf->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->PartnerID->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_PartnerID" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_view_donor_ivf_DrID" for="x_DrID" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_DrID" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->DrID->caption() ?><?php echo ($view_donor_ivf->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->DrID->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_DrID" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_view_donor_ivf_DrDepartment" for="x_DrDepartment" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_DrDepartment" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->DrDepartment->caption() ?><?php echo ($view_donor_ivf->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->DrDepartment->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_DrDepartment" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_view_donor_ivf_Doctor" for="x_Doctor" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_Doctor" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->Doctor->caption() ?><?php echo ($view_donor_ivf->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->Doctor->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_Doctor" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->femalepic->Visible) { // femalepic ?>
	<div id="r_femalepic" class="form-group row">
		<label id="elh_view_donor_ivf_femalepic" for="x_femalepic" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_femalepic" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->femalepic->caption() ?><?php echo ($view_donor_ivf->femalepic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->femalepic->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_femalepic" class="view_donor_ivfadd" type="text/html">
...
<?php if ($view_donor_ivf->Fgender->Visible) { // Fgender ?>
	<div id="r_Fgender" class="form-group row">
		<label id="elh_view_donor_ivf_Fgender" for="x_Fgender" class="<?php echo $view_donor_ivf_add->LeftColumnClass ?>"><script id="tpc_view_donor_ivf_Fgender" class="view_donor_ivfadd" type="text/html"><span><?php echo $view_donor_ivf->Fgender->caption() ?><?php echo ($view_donor_ivf->Fgender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_donor_ivf_add->RightColumnClass ?>"><div<?php echo $view_donor_ivf->Fgender->cellAttributes() ?>>
<script id="tpx_view_donor_ivf_Fgender" class="view_donor_ivfadd" type="text/html">
...
.ew-row .ew-cell {
	margin-right: unset;
				   ...
				   {{include tmpl="#tpc_view_donor_ivf_Fgender"/}}&nbsp;{{include tmpl="#tpx_view_donor_ivf_Fgender"/}}
...
ew.applyTemplate("tpd_view_donor_ivfadd", "tpm_view_donor_ivfadd", "view_donor_ivfadd", "<?php echo $view_donor_ivf->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_donor_ivfadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
