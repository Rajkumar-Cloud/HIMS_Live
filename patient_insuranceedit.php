...
var fpatient_insuranceedit = currentForm = new ew.Form("fpatient_insuranceedit", "edit");
...
fpatient_insuranceedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($patient_insurance_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_insurance_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_insurance->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_insurance_id" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->id->caption() ?><?php echo ($patient_insurance->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_insurance" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_insurance->id->CurrentValue) ?>">
<?php echo $patient_insurance->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_insurance->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_insurance_Reception" for="x_Reception" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->Reception->caption() ?><?php echo ($patient_insurance->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->Reception->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_insurance" data-field="x_Reception" name="x_Reception" id="x_Reception" value="<?php echo HtmlEncode($patient_insurance->Reception->CurrentValue) ?>">
<?php echo $patient_insurance->Reception->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_insurance->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_insurance_PatientId" for="x_PatientId" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->PatientId->caption() ?><?php echo ($patient_insurance->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->PatientId->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_insurance" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" value="<?php echo HtmlEncode($patient_insurance->PatientId->CurrentValue) ?>">
<?php echo $patient_insurance->PatientId->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_insurance->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_insurance_PatientName" for="x_PatientName" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->PatientName->caption() ?><?php echo ($patient_insurance->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->PatientName->cellAttributes() ?>>
...
<?php if ($patient_insurance->Company->Visible) { // Company ?>
	<div id="r_Company" class="form-group row">
		<label id="elh_patient_insurance_Company" for="x_Company" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->Company->caption() ?><?php echo ($patient_insurance->Company->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->Company->cellAttributes() ?>>
...
<?php if ($patient_insurance->AddressInsuranceCarierName->Visible) { // AddressInsuranceCarierName ?>
	<div id="r_AddressInsuranceCarierName" class="form-group row">
		<label id="elh_patient_insurance_AddressInsuranceCarierName" for="x_AddressInsuranceCarierName" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->AddressInsuranceCarierName->caption() ?><?php echo ($patient_insurance->AddressInsuranceCarierName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->AddressInsuranceCarierName->cellAttributes() ?>>
...
<?php if ($patient_insurance->ContactName->Visible) { // ContactName ?>
	<div id="r_ContactName" class="form-group row">
		<label id="elh_patient_insurance_ContactName" for="x_ContactName" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->ContactName->caption() ?><?php echo ($patient_insurance->ContactName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->ContactName->cellAttributes() ?>>
...
<?php if ($patient_insurance->ContactMobile->Visible) { // ContactMobile ?>
	<div id="r_ContactMobile" class="form-group row">
		<label id="elh_patient_insurance_ContactMobile" for="x_ContactMobile" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->ContactMobile->caption() ?><?php echo ($patient_insurance->ContactMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->ContactMobile->cellAttributes() ?>>
...
<?php if ($patient_insurance->PolicyType->Visible) { // PolicyType ?>
	<div id="r_PolicyType" class="form-group row">
		<label id="elh_patient_insurance_PolicyType" for="x_PolicyType" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->PolicyType->caption() ?><?php echo ($patient_insurance->PolicyType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->PolicyType->cellAttributes() ?>>
...
<?php if ($patient_insurance->PolicyName->Visible) { // PolicyName ?>
	<div id="r_PolicyName" class="form-group row">
		<label id="elh_patient_insurance_PolicyName" for="x_PolicyName" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->PolicyName->caption() ?><?php echo ($patient_insurance->PolicyName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->PolicyName->cellAttributes() ?>>
...
<?php if ($patient_insurance->PolicyNo->Visible) { // PolicyNo ?>
	<div id="r_PolicyNo" class="form-group row">
		<label id="elh_patient_insurance_PolicyNo" for="x_PolicyNo" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->PolicyNo->caption() ?><?php echo ($patient_insurance->PolicyNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->PolicyNo->cellAttributes() ?>>
...
<?php if ($patient_insurance->PolicyAmount->Visible) { // PolicyAmount ?>
	<div id="r_PolicyAmount" class="form-group row">
		<label id="elh_patient_insurance_PolicyAmount" for="x_PolicyAmount" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->PolicyAmount->caption() ?><?php echo ($patient_insurance->PolicyAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->PolicyAmount->cellAttributes() ?>>
...
<?php if ($patient_insurance->RefLetterNo->Visible) { // RefLetterNo ?>
	<div id="r_RefLetterNo" class="form-group row">
		<label id="elh_patient_insurance_RefLetterNo" for="x_RefLetterNo" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->RefLetterNo->caption() ?><?php echo ($patient_insurance->RefLetterNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->RefLetterNo->cellAttributes() ?>>
...
<?php if ($patient_insurance->ReferenceBy->Visible) { // ReferenceBy ?>
	<div id="r_ReferenceBy" class="form-group row">
		<label id="elh_patient_insurance_ReferenceBy" for="x_ReferenceBy" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->ReferenceBy->caption() ?><?php echo ($patient_insurance->ReferenceBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->ReferenceBy->cellAttributes() ?>>
...
<?php if ($patient_insurance->ReferenceDate->Visible) { // ReferenceDate ?>
	<div id="r_ReferenceDate" class="form-group row">
		<label id="elh_patient_insurance_ReferenceDate" for="x_ReferenceDate" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->ReferenceDate->caption() ?><?php echo ($patient_insurance->ReferenceDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->ReferenceDate->cellAttributes() ?>>
...
<?php if ($patient_insurance->DocumentAttatch->Visible) { // DocumentAttatch ?>
	<div id="r_DocumentAttatch" class="form-group row">
		<label id="elh_patient_insurance_DocumentAttatch" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->DocumentAttatch->caption() ?><?php echo ($patient_insurance->DocumentAttatch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->DocumentAttatch->cellAttributes() ?>>
...
<?php if (Post("fa_x_DocumentAttatch") == "0") { ?>
<input type="hidden" name="fa_x_DocumentAttatch" id= "fa_x_DocumentAttatch" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_DocumentAttatch" id= "fa_x_DocumentAttatch" value="1">
<?php } ?>
...
<?php if ($patient_insurance->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_insurance_mrnno" for="x_mrnno" class="<?php echo $patient_insurance_edit->LeftColumnClass ?>"><?php echo $patient_insurance->mrnno->caption() ?><?php echo ($patient_insurance->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_insurance_edit->RightColumnClass ?>"><div<?php echo $patient_insurance->mrnno->cellAttributes() ?>>
