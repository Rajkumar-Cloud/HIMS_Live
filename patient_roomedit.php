...
var fpatient_roomedit = currentForm = new ew.Form("fpatient_roomedit", "edit");
...
fpatient_roomedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_roomedit.lists["x_Reception"] = <?php echo $patient_room_edit->Reception->Lookup->toClientList() ?>;
fpatient_roomedit.lists["x_Reception"].options = <?php echo JsonEncode($patient_room_edit->Reception->lookupOptions()) ?>;
fpatient_roomedit.lists["x_RoomID"] = <?php echo $patient_room_edit->RoomID->Lookup->toClientList() ?>;
...
<?php if ($patient_room_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_room_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_room->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_room_id" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_id" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->id->caption() ?><?php echo ($patient_room->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->id->cellAttributes() ?>>
<script id="tpx_patient_room_id" class="patient_roomedit" type="text/html">
...
<input type="hidden" data-table="patient_room" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_room->id->CurrentValue) ?>">
<?php echo $patient_room->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_room->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_room_Reception" for="x_Reception" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Reception" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Reception->caption() ?><?php echo ($patient_room->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Reception->cellAttributes() ?>>
<script id="tpx_patient_room_Reception" class="patient_roomedit" type="text/html">
...
<input type="hidden" data-table="patient_room" data-field="x_Reception" name="x_Reception" id="x_Reception" value="<?php echo HtmlEncode($patient_room->Reception->CurrentValue) ?>">
<?php echo $patient_room->Reception->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_room->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_room_PatientId" for="x_PatientId" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_PatientId" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->PatientId->caption() ?><?php echo ($patient_room->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->PatientId->cellAttributes() ?>>
<script id="tpx_patient_room_PatientId" class="patient_roomedit" type="text/html">
...
<input type="hidden" data-table="patient_room" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" value="<?php echo HtmlEncode($patient_room->PatientId->CurrentValue) ?>">
<?php echo $patient_room->PatientId->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_room->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_room_mrnno" for="x_mrnno" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_mrnno" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->mrnno->caption() ?><?php echo ($patient_room->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->mrnno->cellAttributes() ?>>
<script id="tpx_patient_room_mrnno" class="patient_roomedit" type="text/html">
...
<input type="hidden" data-table="patient_room" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" value="<?php echo HtmlEncode($patient_room->mrnno->CurrentValue) ?>">
<?php echo $patient_room->mrnno->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_room->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_room_PatientName" for="x_PatientName" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_PatientName" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->PatientName->caption() ?><?php echo ($patient_room->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->PatientName->cellAttributes() ?>>
<script id="tpx_patient_room_PatientName" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_room_Gender" for="x_Gender" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Gender" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Gender->caption() ?><?php echo ($patient_room->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Gender->cellAttributes() ?>>
<script id="tpx_patient_room_Gender" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->RoomID->Visible) { // RoomID ?>
	<div id="r_RoomID" class="form-group row">
		<label id="elh_patient_room_RoomID" for="x_RoomID" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_RoomID" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->RoomID->caption() ?><?php echo ($patient_room->RoomID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->RoomID->cellAttributes() ?>>
<script id="tpx_patient_room_RoomID" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->RoomNo->Visible) { // RoomNo ?>
	<div id="r_RoomNo" class="form-group row">
		<label id="elh_patient_room_RoomNo" for="x_RoomNo" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_RoomNo" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->RoomNo->caption() ?><?php echo ($patient_room->RoomNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->RoomNo->cellAttributes() ?>>
<script id="tpx_patient_room_RoomNo" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->RoomType->Visible) { // RoomType ?>
	<div id="r_RoomType" class="form-group row">
		<label id="elh_patient_room_RoomType" for="x_RoomType" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_RoomType" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->RoomType->caption() ?><?php echo ($patient_room->RoomType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->RoomType->cellAttributes() ?>>
<script id="tpx_patient_room_RoomType" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->SharingRoom->Visible) { // SharingRoom ?>
	<div id="r_SharingRoom" class="form-group row">
		<label id="elh_patient_room_SharingRoom" for="x_SharingRoom" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_SharingRoom" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->SharingRoom->caption() ?><?php echo ($patient_room->SharingRoom->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->SharingRoom->cellAttributes() ?>>
<script id="tpx_patient_room_SharingRoom" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_patient_room_Amount" for="x_Amount" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Amount" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Amount->caption() ?><?php echo ($patient_room->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Amount->cellAttributes() ?>>
<script id="tpx_patient_room_Amount" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->Startdatetime->Visible) { // Startdatetime ?>
	<div id="r_Startdatetime" class="form-group row">
		<label id="elh_patient_room_Startdatetime" for="x_Startdatetime" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Startdatetime" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Startdatetime->caption() ?><?php echo ($patient_room->Startdatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Startdatetime->cellAttributes() ?>>
<script id="tpx_patient_room_Startdatetime" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->Enddatetime->Visible) { // Enddatetime ?>
	<div id="r_Enddatetime" class="form-group row">
		<label id="elh_patient_room_Enddatetime" for="x_Enddatetime" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Enddatetime" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Enddatetime->caption() ?><?php echo ($patient_room->Enddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Enddatetime->cellAttributes() ?>>
<script id="tpx_patient_room_Enddatetime" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->DaysHours->Visible) { // DaysHours ?>
	<div id="r_DaysHours" class="form-group row">
		<label id="elh_patient_room_DaysHours" for="x_DaysHours" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_DaysHours" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->DaysHours->caption() ?><?php echo ($patient_room->DaysHours->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->DaysHours->cellAttributes() ?>>
<script id="tpx_patient_room_DaysHours" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->Days->Visible) { // Days ?>
	<div id="r_Days" class="form-group row">
		<label id="elh_patient_room_Days" for="x_Days" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Days" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Days->caption() ?><?php echo ($patient_room->Days->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Days->cellAttributes() ?>>
<script id="tpx_patient_room_Days" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->Hours->Visible) { // Hours ?>
	<div id="r_Hours" class="form-group row">
		<label id="elh_patient_room_Hours" for="x_Hours" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_Hours" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->Hours->caption() ?><?php echo ($patient_room->Hours->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->Hours->cellAttributes() ?>>
<script id="tpx_patient_room_Hours" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->TotalAmount->Visible) { // TotalAmount ?>
	<div id="r_TotalAmount" class="form-group row">
		<label id="elh_patient_room_TotalAmount" for="x_TotalAmount" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_TotalAmount" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->TotalAmount->caption() ?><?php echo ($patient_room->TotalAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->TotalAmount->cellAttributes() ?>>
<script id="tpx_patient_room_TotalAmount" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_room_PatID" for="x_PatID" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_PatID" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->PatID->caption() ?><?php echo ($patient_room->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->PatID->cellAttributes() ?>>
<?php if ($patient_room->PatID->getSessionValue() <> "") { ?>
<script id="tpx_patient_room_PatID" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_room_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_MobileNumber" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->MobileNumber->caption() ?><?php echo ($patient_room->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_room_MobileNumber" class="patient_roomedit" type="text/html">
...
<?php if ($patient_room->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_room_status" for="x_status" class="<?php echo $patient_room_edit->LeftColumnClass ?>"><script id="tpc_patient_room_status" class="patient_roomedit" type="text/html"><span><?php echo $patient_room->status->caption() ?><?php echo ($patient_room->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_room_edit->RightColumnClass ?>"><div<?php echo $patient_room->status->cellAttributes() ?>>
<script id="tpx_patient_room_status" class="patient_roomedit" type="text/html">
...
ew.applyTemplate("tpd_patient_roomedit", "tpm_patient_roomedit", "patient_roomedit", "<?php echo $patient_room->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_roomedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
