...
var flab_test_masteradd = currentForm = new ew.Form("flab_test_masteradd", "add");
...
flab_test_masteradd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($lab_test_master_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $lab_test_master_add->Token ?>">
<?php } ?>
...
<?php if ($lab_test_master->MainDeptCd->Visible) { // MainDeptCd ?>
	<div id="r_MainDeptCd" class="form-group row">
		<label id="elh_lab_test_master_MainDeptCd" for="x_MainDeptCd" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->MainDeptCd->caption() ?><?php echo ($lab_test_master->MainDeptCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->MainDeptCd->cellAttributes() ?>>
...
<?php if ($lab_test_master->DeptCd->Visible) { // DeptCd ?>
	<div id="r_DeptCd" class="form-group row">
		<label id="elh_lab_test_master_DeptCd" for="x_DeptCd" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->DeptCd->caption() ?><?php echo ($lab_test_master->DeptCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->DeptCd->cellAttributes() ?>>
...
<?php if ($lab_test_master->TestCd->Visible) { // TestCd ?>
	<div id="r_TestCd" class="form-group row">
		<label id="elh_lab_test_master_TestCd" for="x_TestCd" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->TestCd->caption() ?><?php echo ($lab_test_master->TestCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->TestCd->cellAttributes() ?>>
...
<?php if ($lab_test_master->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_lab_test_master_TestSubCd" for="x_TestSubCd" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->TestSubCd->caption() ?><?php echo ($lab_test_master->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->TestSubCd->cellAttributes() ?>>
...
<?php if ($lab_test_master->TestName->Visible) { // TestName ?>
	<div id="r_TestName" class="form-group row">
		<label id="elh_lab_test_master_TestName" for="x_TestName" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->TestName->caption() ?><?php echo ($lab_test_master->TestName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->TestName->cellAttributes() ?>>
...
<?php if ($lab_test_master->XrayPart->Visible) { // XrayPart ?>
	<div id="r_XrayPart" class="form-group row">
		<label id="elh_lab_test_master_XrayPart" for="x_XrayPart" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->XrayPart->caption() ?><?php echo ($lab_test_master->XrayPart->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->XrayPart->cellAttributes() ?>>
...
<?php if ($lab_test_master->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_lab_test_master_Method" for="x_Method" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Method->caption() ?><?php echo ($lab_test_master->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Method->cellAttributes() ?>>
...
<?php if ($lab_test_master->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_lab_test_master_Order" for="x_Order" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Order->caption() ?><?php echo ($lab_test_master->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Order->cellAttributes() ?>>
...
<?php if ($lab_test_master->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_lab_test_master_Form" for="x_Form" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Form->caption() ?><?php echo ($lab_test_master->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Form->cellAttributes() ?>>
...
<?php if ($lab_test_master->Amt->Visible) { // Amt ?>
	<div id="r_Amt" class="form-group row">
		<label id="elh_lab_test_master_Amt" for="x_Amt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Amt->caption() ?><?php echo ($lab_test_master->Amt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Amt->cellAttributes() ?>>
...
<?php if ($lab_test_master->SplAmt->Visible) { // SplAmt ?>
	<div id="r_SplAmt" class="form-group row">
		<label id="elh_lab_test_master_SplAmt" for="x_SplAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->SplAmt->caption() ?><?php echo ($lab_test_master->SplAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->SplAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_lab_test_master_ResType" for="x_ResType" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ResType->caption() ?><?php echo ($lab_test_master->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ResType->cellAttributes() ?>>
...
<?php if ($lab_test_master->UnitCD->Visible) { // UnitCD ?>
	<div id="r_UnitCD" class="form-group row">
		<label id="elh_lab_test_master_UnitCD" for="x_UnitCD" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->UnitCD->caption() ?><?php echo ($lab_test_master->UnitCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->UnitCD->cellAttributes() ?>>
...
<?php if ($lab_test_master->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_lab_test_master_RefValue" for="x_RefValue" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->RefValue->caption() ?><?php echo ($lab_test_master->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->RefValue->cellAttributes() ?>>
...
<?php if ($lab_test_master->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_lab_test_master_Sample" for="x_Sample" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Sample->caption() ?><?php echo ($lab_test_master->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Sample->cellAttributes() ?>>
...
<?php if ($lab_test_master->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_lab_test_master_NoD" for="x_NoD" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->NoD->caption() ?><?php echo ($lab_test_master->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->NoD->cellAttributes() ?>>
...
<?php if ($lab_test_master->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_lab_test_master_BillOrder" for="x_BillOrder" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->BillOrder->caption() ?><?php echo ($lab_test_master->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->BillOrder->cellAttributes() ?>>
...
<?php if ($lab_test_master->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_lab_test_master_Formula" for="x_Formula" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Formula->caption() ?><?php echo ($lab_test_master->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Formula->cellAttributes() ?>>
...
<?php if ($lab_test_master->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_lab_test_master_Inactive" for="x_Inactive" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Inactive->caption() ?><?php echo ($lab_test_master->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Inactive->cellAttributes() ?>>
...
<?php if ($lab_test_master->ReagentAmt->Visible) { // ReagentAmt ?>
	<div id="r_ReagentAmt" class="form-group row">
		<label id="elh_lab_test_master_ReagentAmt" for="x_ReagentAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ReagentAmt->caption() ?><?php echo ($lab_test_master->ReagentAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ReagentAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->LabAmt->Visible) { // LabAmt ?>
	<div id="r_LabAmt" class="form-group row">
		<label id="elh_lab_test_master_LabAmt" for="x_LabAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->LabAmt->caption() ?><?php echo ($lab_test_master->LabAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->LabAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->RefAmt->Visible) { // RefAmt ?>
	<div id="r_RefAmt" class="form-group row">
		<label id="elh_lab_test_master_RefAmt" for="x_RefAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->RefAmt->caption() ?><?php echo ($lab_test_master->RefAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->RefAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->CreFrom->Visible) { // CreFrom ?>
	<div id="r_CreFrom" class="form-group row">
		<label id="elh_lab_test_master_CreFrom" for="x_CreFrom" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->CreFrom->caption() ?><?php echo ($lab_test_master->CreFrom->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->CreFrom->cellAttributes() ?>>
...
<?php if ($lab_test_master->CreTo->Visible) { // CreTo ?>
	<div id="r_CreTo" class="form-group row">
		<label id="elh_lab_test_master_CreTo" for="x_CreTo" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->CreTo->caption() ?><?php echo ($lab_test_master->CreTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->CreTo->cellAttributes() ?>>
...
<?php if ($lab_test_master->Note->Visible) { // Note ?>
	<div id="r_Note" class="form-group row">
		<label id="elh_lab_test_master_Note" for="x_Note" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Note->caption() ?><?php echo ($lab_test_master->Note->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Note->cellAttributes() ?>>
...
<?php if ($lab_test_master->Sun->Visible) { // Sun ?>
	<div id="r_Sun" class="form-group row">
		<label id="elh_lab_test_master_Sun" for="x_Sun" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Sun->caption() ?><?php echo ($lab_test_master->Sun->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Sun->cellAttributes() ?>>
...
<?php if ($lab_test_master->Mon->Visible) { // Mon ?>
	<div id="r_Mon" class="form-group row">
		<label id="elh_lab_test_master_Mon" for="x_Mon" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Mon->caption() ?><?php echo ($lab_test_master->Mon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Mon->cellAttributes() ?>>
...
<?php if ($lab_test_master->Tue->Visible) { // Tue ?>
	<div id="r_Tue" class="form-group row">
		<label id="elh_lab_test_master_Tue" for="x_Tue" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Tue->caption() ?><?php echo ($lab_test_master->Tue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Tue->cellAttributes() ?>>
...
<?php if ($lab_test_master->Wed->Visible) { // Wed ?>
	<div id="r_Wed" class="form-group row">
		<label id="elh_lab_test_master_Wed" for="x_Wed" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Wed->caption() ?><?php echo ($lab_test_master->Wed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Wed->cellAttributes() ?>>
...
<?php if ($lab_test_master->Thi->Visible) { // Thi ?>
	<div id="r_Thi" class="form-group row">
		<label id="elh_lab_test_master_Thi" for="x_Thi" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Thi->caption() ?><?php echo ($lab_test_master->Thi->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Thi->cellAttributes() ?>>
...
<?php if ($lab_test_master->Fri->Visible) { // Fri ?>
	<div id="r_Fri" class="form-group row">
		<label id="elh_lab_test_master_Fri" for="x_Fri" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Fri->caption() ?><?php echo ($lab_test_master->Fri->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Fri->cellAttributes() ?>>
...
<?php if ($lab_test_master->Sat->Visible) { // Sat ?>
	<div id="r_Sat" class="form-group row">
		<label id="elh_lab_test_master_Sat" for="x_Sat" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Sat->caption() ?><?php echo ($lab_test_master->Sat->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Sat->cellAttributes() ?>>
...
<?php if ($lab_test_master->Days->Visible) { // Days ?>
	<div id="r_Days" class="form-group row">
		<label id="elh_lab_test_master_Days" for="x_Days" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Days->caption() ?><?php echo ($lab_test_master->Days->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Days->cellAttributes() ?>>
...
<?php if ($lab_test_master->Cutoff->Visible) { // Cutoff ?>
	<div id="r_Cutoff" class="form-group row">
		<label id="elh_lab_test_master_Cutoff" for="x_Cutoff" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Cutoff->caption() ?><?php echo ($lab_test_master->Cutoff->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Cutoff->cellAttributes() ?>>
...
<?php if ($lab_test_master->FontBold->Visible) { // FontBold ?>
	<div id="r_FontBold" class="form-group row">
		<label id="elh_lab_test_master_FontBold" for="x_FontBold" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->FontBold->caption() ?><?php echo ($lab_test_master->FontBold->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->FontBold->cellAttributes() ?>>
...
<?php if ($lab_test_master->TestHeading->Visible) { // TestHeading ?>
	<div id="r_TestHeading" class="form-group row">
		<label id="elh_lab_test_master_TestHeading" for="x_TestHeading" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->TestHeading->caption() ?><?php echo ($lab_test_master->TestHeading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->TestHeading->cellAttributes() ?>>
...
<?php if ($lab_test_master->Outsource->Visible) { // Outsource ?>
	<div id="r_Outsource" class="form-group row">
		<label id="elh_lab_test_master_Outsource" for="x_Outsource" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Outsource->caption() ?><?php echo ($lab_test_master->Outsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Outsource->cellAttributes() ?>>
...
<?php if ($lab_test_master->NoResult->Visible) { // NoResult ?>
	<div id="r_NoResult" class="form-group row">
		<label id="elh_lab_test_master_NoResult" for="x_NoResult" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->NoResult->caption() ?><?php echo ($lab_test_master->NoResult->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->NoResult->cellAttributes() ?>>
...
<?php if ($lab_test_master->GraphLow->Visible) { // GraphLow ?>
	<div id="r_GraphLow" class="form-group row">
		<label id="elh_lab_test_master_GraphLow" for="x_GraphLow" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->GraphLow->caption() ?><?php echo ($lab_test_master->GraphLow->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->GraphLow->cellAttributes() ?>>
...
<?php if ($lab_test_master->GraphHigh->Visible) { // GraphHigh ?>
	<div id="r_GraphHigh" class="form-group row">
		<label id="elh_lab_test_master_GraphHigh" for="x_GraphHigh" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->GraphHigh->caption() ?><?php echo ($lab_test_master->GraphHigh->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->GraphHigh->cellAttributes() ?>>
...
<?php if ($lab_test_master->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_lab_test_master_CollSample" for="x_CollSample" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->CollSample->caption() ?><?php echo ($lab_test_master->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->CollSample->cellAttributes() ?>>
...
<?php if ($lab_test_master->ProcessTime->Visible) { // ProcessTime ?>
	<div id="r_ProcessTime" class="form-group row">
		<label id="elh_lab_test_master_ProcessTime" for="x_ProcessTime" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ProcessTime->caption() ?><?php echo ($lab_test_master->ProcessTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ProcessTime->cellAttributes() ?>>
...
<?php if ($lab_test_master->TamilName->Visible) { // TamilName ?>
	<div id="r_TamilName" class="form-group row">
		<label id="elh_lab_test_master_TamilName" for="x_TamilName" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->TamilName->caption() ?><?php echo ($lab_test_master->TamilName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->TamilName->cellAttributes() ?>>
...
<?php if ($lab_test_master->ShortName->Visible) { // ShortName ?>
	<div id="r_ShortName" class="form-group row">
		<label id="elh_lab_test_master_ShortName" for="x_ShortName" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ShortName->caption() ?><?php echo ($lab_test_master->ShortName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ShortName->cellAttributes() ?>>
...
<?php if ($lab_test_master->Individual->Visible) { // Individual ?>
	<div id="r_Individual" class="form-group row">
		<label id="elh_lab_test_master_Individual" for="x_Individual" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Individual->caption() ?><?php echo ($lab_test_master->Individual->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Individual->cellAttributes() ?>>
...
<?php if ($lab_test_master->PrevAmt->Visible) { // PrevAmt ?>
	<div id="r_PrevAmt" class="form-group row">
		<label id="elh_lab_test_master_PrevAmt" for="x_PrevAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->PrevAmt->caption() ?><?php echo ($lab_test_master->PrevAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->PrevAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->PrevSplAmt->Visible) { // PrevSplAmt ?>
	<div id="r_PrevSplAmt" class="form-group row">
		<label id="elh_lab_test_master_PrevSplAmt" for="x_PrevSplAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->PrevSplAmt->caption() ?><?php echo ($lab_test_master->PrevSplAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->PrevSplAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_lab_test_master_Remarks" for="x_Remarks" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Remarks->caption() ?><?php echo ($lab_test_master->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Remarks->cellAttributes() ?>>
...
<?php if ($lab_test_master->EditDate->Visible) { // EditDate ?>
	<div id="r_EditDate" class="form-group row">
		<label id="elh_lab_test_master_EditDate" for="x_EditDate" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->EditDate->caption() ?><?php echo ($lab_test_master->EditDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->EditDate->cellAttributes() ?>>
...
<?php if ($lab_test_master->BillName->Visible) { // BillName ?>
	<div id="r_BillName" class="form-group row">
		<label id="elh_lab_test_master_BillName" for="x_BillName" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->BillName->caption() ?><?php echo ($lab_test_master->BillName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->BillName->cellAttributes() ?>>
...
<?php if ($lab_test_master->ActualAmt->Visible) { // ActualAmt ?>
	<div id="r_ActualAmt" class="form-group row">
		<label id="elh_lab_test_master_ActualAmt" for="x_ActualAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ActualAmt->caption() ?><?php echo ($lab_test_master->ActualAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ActualAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->HISCD->Visible) { // HISCD ?>
	<div id="r_HISCD" class="form-group row">
		<label id="elh_lab_test_master_HISCD" for="x_HISCD" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->HISCD->caption() ?><?php echo ($lab_test_master->HISCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->HISCD->cellAttributes() ?>>
...
<?php if ($lab_test_master->PriceList->Visible) { // PriceList ?>
	<div id="r_PriceList" class="form-group row">
		<label id="elh_lab_test_master_PriceList" for="x_PriceList" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->PriceList->caption() ?><?php echo ($lab_test_master->PriceList->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->PriceList->cellAttributes() ?>>
...
<?php if ($lab_test_master->IPAmt->Visible) { // IPAmt ?>
	<div id="r_IPAmt" class="form-group row">
		<label id="elh_lab_test_master_IPAmt" for="x_IPAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->IPAmt->caption() ?><?php echo ($lab_test_master->IPAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->IPAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->InsAmt->Visible) { // InsAmt ?>
	<div id="r_InsAmt" class="form-group row">
		<label id="elh_lab_test_master_InsAmt" for="x_InsAmt" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->InsAmt->caption() ?><?php echo ($lab_test_master->InsAmt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->InsAmt->cellAttributes() ?>>
...
<?php if ($lab_test_master->ManualCD->Visible) { // ManualCD ?>
	<div id="r_ManualCD" class="form-group row">
		<label id="elh_lab_test_master_ManualCD" for="x_ManualCD" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ManualCD->caption() ?><?php echo ($lab_test_master->ManualCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ManualCD->cellAttributes() ?>>
...
<?php if ($lab_test_master->Free->Visible) { // Free ?>
	<div id="r_Free" class="form-group row">
		<label id="elh_lab_test_master_Free" for="x_Free" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Free->caption() ?><?php echo ($lab_test_master->Free->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Free->cellAttributes() ?>>
...
<?php if ($lab_test_master->AutoAuth->Visible) { // AutoAuth ?>
	<div id="r_AutoAuth" class="form-group row">
		<label id="elh_lab_test_master_AutoAuth" for="x_AutoAuth" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->AutoAuth->caption() ?><?php echo ($lab_test_master->AutoAuth->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->AutoAuth->cellAttributes() ?>>
...
<?php if ($lab_test_master->ProductCD->Visible) { // ProductCD ?>
	<div id="r_ProductCD" class="form-group row">
		<label id="elh_lab_test_master_ProductCD" for="x_ProductCD" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->ProductCD->caption() ?><?php echo ($lab_test_master->ProductCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->ProductCD->cellAttributes() ?>>
...
<?php if ($lab_test_master->Inventory->Visible) { // Inventory ?>
	<div id="r_Inventory" class="form-group row">
		<label id="elh_lab_test_master_Inventory" for="x_Inventory" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Inventory->caption() ?><?php echo ($lab_test_master->Inventory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Inventory->cellAttributes() ?>>
...
<?php if ($lab_test_master->IntimateTest->Visible) { // IntimateTest ?>
	<div id="r_IntimateTest" class="form-group row">
		<label id="elh_lab_test_master_IntimateTest" for="x_IntimateTest" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->IntimateTest->caption() ?><?php echo ($lab_test_master->IntimateTest->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->IntimateTest->cellAttributes() ?>>
...
<?php if ($lab_test_master->Manual->Visible) { // Manual ?>
	<div id="r_Manual" class="form-group row">
		<label id="elh_lab_test_master_Manual" for="x_Manual" class="<?php echo $lab_test_master_add->LeftColumnClass ?>"><?php echo $lab_test_master->Manual->caption() ?><?php echo ($lab_test_master->Manual->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_test_master_add->RightColumnClass ?>"><div<?php echo $lab_test_master->Manual->cellAttributes() ?>>
