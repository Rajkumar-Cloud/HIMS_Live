...
var fivf_outcomeadd = currentForm = new ew.Form("fivf_outcomeadd", "add");
...
fivf_outcomeadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($ivf_outcome_add->Implantation->Required) { ?>
		...
		<?php } ?>
		<?php if ($ivf_outcome_add->DeliveryDate->Required) { ?>
		...
		<?php if ($ivf_outcome_add->BabyDetails->Required) { ?>
		...
		<?php } ?>
		<?php if ($ivf_outcome_add->LSCSNormal->Required) { ?>
		...
		<?php } ?>
		<?php if ($ivf_outcome_add->Notes->Required) { ?>
...
fivf_outcomeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_outcomeadd.lists["x_Gestation"] = <?php echo $ivf_outcome_add->Gestation->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_Gestation"].options = <?php echo JsonEncode($ivf_outcome_add->Gestation->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_Urine"] = <?php echo $ivf_outcome_add->Urine->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_Urine"].options = <?php echo JsonEncode($ivf_outcome_add->Urine->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_Miscarriage"] = <?php echo $ivf_outcome_add->Miscarriage->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_Miscarriage"].options = <?php echo JsonEncode($ivf_outcome_add->Miscarriage->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_Induced1"] = <?php echo $ivf_outcome_add->Induced1->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_Induced1"].options = <?php echo JsonEncode($ivf_outcome_add->Induced1->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_Type"] = <?php echo $ivf_outcome_add->Type->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_Type"].options = <?php echo JsonEncode($ivf_outcome_add->Type->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_FoetalDeath"] = <?php echo $ivf_outcome_add->FoetalDeath->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_FoetalDeath"].options = <?php echo JsonEncode($ivf_outcome_add->FoetalDeath->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_FerinatalDeath"] = <?php echo $ivf_outcome_add->FerinatalDeath->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_FerinatalDeath"].options = <?php echo JsonEncode($ivf_outcome_add->FerinatalDeath->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_Ectopic"] = <?php echo $ivf_outcome_add->Ectopic->Lookup->toClientList() ?>;
fivf_outcomeadd.lists["x_Ectopic"].options = <?php echo JsonEncode($ivf_outcome_add->Ectopic->options(FALSE, TRUE)) ?>;
fivf_outcomeadd.lists["x_Extra"] = <?php echo $ivf_outcome_add->Extra->Lookup->toClientList() ?>;
...
<?php if ($ivf_outcome_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_outcome_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_outcome->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_ivf_outcome_RIDNO" for="x_RIDNO" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_RIDNO" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->RIDNO->caption() ?><?php echo ($ivf_outcome->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->RIDNO->cellAttributes() ?>>
<?php if ($ivf_outcome->RIDNO->getSessionValue() <> "") { ?>
<script id="tpx_ivf_outcome_RIDNO" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_outcome_Name" for="x_Name" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Name" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Name->caption() ?><?php echo ($ivf_outcome->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Name->cellAttributes() ?>>
<?php if ($ivf_outcome->Name->getSessionValue() <> "") { ?>
<script id="tpx_ivf_outcome_Name" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_ivf_outcome_Age" for="x_Age" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Age" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Age->caption() ?><?php echo ($ivf_outcome->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Age->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Age" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->treatment_status->Visible) { // treatment_status ?>
	<div id="r_treatment_status" class="form-group row">
		<label id="elh_ivf_outcome_treatment_status" for="x_treatment_status" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_treatment_status" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->treatment_status->caption() ?><?php echo ($ivf_outcome->treatment_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->treatment_status->cellAttributes() ?>>
<script id="tpx_ivf_outcome_treatment_status" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->ARTCYCLE->Visible) { // ARTCYCLE ?>
	<div id="r_ARTCYCLE" class="form-group row">
		<label id="elh_ivf_outcome_ARTCYCLE" for="x_ARTCYCLE" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_ARTCYCLE" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->ARTCYCLE->caption() ?><?php echo ($ivf_outcome->ARTCYCLE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->ARTCYCLE->cellAttributes() ?>>
<script id="tpx_ivf_outcome_ARTCYCLE" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->RESULT->Visible) { // RESULT ?>
	<div id="r_RESULT" class="form-group row">
		<label id="elh_ivf_outcome_RESULT" for="x_RESULT" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_RESULT" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->RESULT->caption() ?><?php echo ($ivf_outcome->RESULT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->RESULT->cellAttributes() ?>>
<script id="tpx_ivf_outcome_RESULT" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_ivf_outcome_status" for="x_status" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_status" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->status->caption() ?><?php echo ($ivf_outcome->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->status->cellAttributes() ?>>
<script id="tpx_ivf_outcome_status" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_ivf_outcome_createdby" for="x_createdby" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_createdby" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->createdby->caption() ?><?php echo ($ivf_outcome->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->createdby->cellAttributes() ?>>
<script id="tpx_ivf_outcome_createdby" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_ivf_outcome_createddatetime" for="x_createddatetime" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_createddatetime" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->createddatetime->caption() ?><?php echo ($ivf_outcome->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->createddatetime->cellAttributes() ?>>
<script id="tpx_ivf_outcome_createddatetime" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_ivf_outcome_modifiedby" for="x_modifiedby" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_modifiedby" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->modifiedby->caption() ?><?php echo ($ivf_outcome->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->modifiedby->cellAttributes() ?>>
<script id="tpx_ivf_outcome_modifiedby" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_ivf_outcome_modifieddatetime" for="x_modifieddatetime" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_modifieddatetime" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->modifieddatetime->caption() ?><?php echo ($ivf_outcome->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->modifieddatetime->cellAttributes() ?>>
<script id="tpx_ivf_outcome_modifieddatetime" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->outcomeDate->Visible) { // outcomeDate ?>
	<div id="r_outcomeDate" class="form-group row">
		<label id="elh_ivf_outcome_outcomeDate" for="x_outcomeDate" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_outcomeDate" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->outcomeDate->caption() ?><?php echo ($ivf_outcome->outcomeDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->outcomeDate->cellAttributes() ?>>
<script id="tpx_ivf_outcome_outcomeDate" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->outcomeDay->Visible) { // outcomeDay ?>
	<div id="r_outcomeDay" class="form-group row">
		<label id="elh_ivf_outcome_outcomeDay" for="x_outcomeDay" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_outcomeDay" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->outcomeDay->caption() ?><?php echo ($ivf_outcome->outcomeDay->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->outcomeDay->cellAttributes() ?>>
<script id="tpx_ivf_outcome_outcomeDay" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->OPResult->Visible) { // OPResult ?>
	<div id="r_OPResult" class="form-group row">
		<label id="elh_ivf_outcome_OPResult" for="x_OPResult" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_OPResult" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->OPResult->caption() ?><?php echo ($ivf_outcome->OPResult->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->OPResult->cellAttributes() ?>>
<script id="tpx_ivf_outcome_OPResult" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Gestation->Visible) { // Gestation ?>
	<div id="r_Gestation" class="form-group row">
		<label id="elh_ivf_outcome_Gestation" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Gestation" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Gestation->caption() ?><?php echo ($ivf_outcome->Gestation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Gestation->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Gestation" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->TransferdEmbryos->Visible) { // TransferdEmbryos ?>
	<div id="r_TransferdEmbryos" class="form-group row">
		<label id="elh_ivf_outcome_TransferdEmbryos" for="x_TransferdEmbryos" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_TransferdEmbryos" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->TransferdEmbryos->caption() ?><?php echo ($ivf_outcome->TransferdEmbryos->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->TransferdEmbryos->cellAttributes() ?>>
<script id="tpx_ivf_outcome_TransferdEmbryos" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->InitalOfSacs->Visible) { // InitalOfSacs ?>
	<div id="r_InitalOfSacs" class="form-group row">
		<label id="elh_ivf_outcome_InitalOfSacs" for="x_InitalOfSacs" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_InitalOfSacs" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->InitalOfSacs->caption() ?><?php echo ($ivf_outcome->InitalOfSacs->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->InitalOfSacs->cellAttributes() ?>>
<script id="tpx_ivf_outcome_InitalOfSacs" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->ImplimentationRate->Visible) { // ImplimentationRate ?>
	<div id="r_ImplimentationRate" class="form-group row">
		<label id="elh_ivf_outcome_ImplimentationRate" for="x_ImplimentationRate" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_ImplimentationRate" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->ImplimentationRate->caption() ?><?php echo ($ivf_outcome->ImplimentationRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->ImplimentationRate->cellAttributes() ?>>
<script id="tpx_ivf_outcome_ImplimentationRate" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->EmbryoNo->Visible) { // EmbryoNo ?>
	<div id="r_EmbryoNo" class="form-group row">
		<label id="elh_ivf_outcome_EmbryoNo" for="x_EmbryoNo" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_EmbryoNo" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->EmbryoNo->caption() ?><?php echo ($ivf_outcome->EmbryoNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->EmbryoNo->cellAttributes() ?>>
<script id="tpx_ivf_outcome_EmbryoNo" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->ExtrauterineSac->Visible) { // ExtrauterineSac ?>
	<div id="r_ExtrauterineSac" class="form-group row">
		<label id="elh_ivf_outcome_ExtrauterineSac" for="x_ExtrauterineSac" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_ExtrauterineSac" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->ExtrauterineSac->caption() ?><?php echo ($ivf_outcome->ExtrauterineSac->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->ExtrauterineSac->cellAttributes() ?>>
<script id="tpx_ivf_outcome_ExtrauterineSac" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->PregnancyMonozygotic->Visible) { // PregnancyMonozygotic ?>
	<div id="r_PregnancyMonozygotic" class="form-group row">
		<label id="elh_ivf_outcome_PregnancyMonozygotic" for="x_PregnancyMonozygotic" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_PregnancyMonozygotic" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->PregnancyMonozygotic->caption() ?><?php echo ($ivf_outcome->PregnancyMonozygotic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->PregnancyMonozygotic->cellAttributes() ?>>
<script id="tpx_ivf_outcome_PregnancyMonozygotic" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->TypeGestation->Visible) { // TypeGestation ?>
	<div id="r_TypeGestation" class="form-group row">
		<label id="elh_ivf_outcome_TypeGestation" for="x_TypeGestation" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_TypeGestation" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->TypeGestation->caption() ?><?php echo ($ivf_outcome->TypeGestation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->TypeGestation->cellAttributes() ?>>
<script id="tpx_ivf_outcome_TypeGestation" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Urine->Visible) { // Urine ?>
	<div id="r_Urine" class="form-group row">
		<label id="elh_ivf_outcome_Urine" for="x_Urine" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Urine" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Urine->caption() ?><?php echo ($ivf_outcome->Urine->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Urine->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Urine" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->PTdate->Visible) { // PTdate ?>
	<div id="r_PTdate" class="form-group row">
		<label id="elh_ivf_outcome_PTdate" for="x_PTdate" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_PTdate" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->PTdate->caption() ?><?php echo ($ivf_outcome->PTdate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->PTdate->cellAttributes() ?>>
<script id="tpx_ivf_outcome_PTdate" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Reduced->Visible) { // Reduced ?>
	<div id="r_Reduced" class="form-group row">
		<label id="elh_ivf_outcome_Reduced" for="x_Reduced" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Reduced" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Reduced->caption() ?><?php echo ($ivf_outcome->Reduced->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Reduced->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Reduced" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->INduced->Visible) { // INduced ?>
	<div id="r_INduced" class="form-group row">
		<label id="elh_ivf_outcome_INduced" for="x_INduced" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_INduced" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->INduced->caption() ?><?php echo ($ivf_outcome->INduced->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->INduced->cellAttributes() ?>>
<script id="tpx_ivf_outcome_INduced" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->INducedDate->Visible) { // INducedDate ?>
	<div id="r_INducedDate" class="form-group row">
		<label id="elh_ivf_outcome_INducedDate" for="x_INducedDate" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_INducedDate" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->INducedDate->caption() ?><?php echo ($ivf_outcome->INducedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->INducedDate->cellAttributes() ?>>
<script id="tpx_ivf_outcome_INducedDate" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Miscarriage->Visible) { // Miscarriage ?>
	<div id="r_Miscarriage" class="form-group row">
		<label id="elh_ivf_outcome_Miscarriage" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Miscarriage" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Miscarriage->caption() ?><?php echo ($ivf_outcome->Miscarriage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Miscarriage->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Miscarriage" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Induced1->Visible) { // Induced1 ?>
	<div id="r_Induced1" class="form-group row">
		<label id="elh_ivf_outcome_Induced1" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Induced1" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Induced1->caption() ?><?php echo ($ivf_outcome->Induced1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Induced1->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Induced1" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Type->Visible) { // Type ?>
	<div id="r_Type" class="form-group row">
		<label id="elh_ivf_outcome_Type" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Type" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Type->caption() ?><?php echo ($ivf_outcome->Type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Type->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Type" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->IfClinical->Visible) { // IfClinical ?>
	<div id="r_IfClinical" class="form-group row">
		<label id="elh_ivf_outcome_IfClinical" for="x_IfClinical" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_IfClinical" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->IfClinical->caption() ?><?php echo ($ivf_outcome->IfClinical->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->IfClinical->cellAttributes() ?>>
<script id="tpx_ivf_outcome_IfClinical" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->GADate->Visible) { // GADate ?>
	<div id="r_GADate" class="form-group row">
		<label id="elh_ivf_outcome_GADate" for="x_GADate" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_GADate" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->GADate->caption() ?><?php echo ($ivf_outcome->GADate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->GADate->cellAttributes() ?>>
<script id="tpx_ivf_outcome_GADate" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->GA->Visible) { // GA ?>
	<div id="r_GA" class="form-group row">
		<label id="elh_ivf_outcome_GA" for="x_GA" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_GA" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->GA->caption() ?><?php echo ($ivf_outcome->GA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->GA->cellAttributes() ?>>
<script id="tpx_ivf_outcome_GA" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->FoetalDeath->Visible) { // FoetalDeath ?>
	<div id="r_FoetalDeath" class="form-group row">
		<label id="elh_ivf_outcome_FoetalDeath" for="x_FoetalDeath" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_FoetalDeath" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->FoetalDeath->caption() ?><?php echo ($ivf_outcome->FoetalDeath->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->FoetalDeath->cellAttributes() ?>>
<script id="tpx_ivf_outcome_FoetalDeath" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->FerinatalDeath->Visible) { // FerinatalDeath ?>
	<div id="r_FerinatalDeath" class="form-group row">
		<label id="elh_ivf_outcome_FerinatalDeath" for="x_FerinatalDeath" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_FerinatalDeath" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->FerinatalDeath->caption() ?><?php echo ($ivf_outcome->FerinatalDeath->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->FerinatalDeath->cellAttributes() ?>>
<script id="tpx_ivf_outcome_FerinatalDeath" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_outcome_TidNo" for="x_TidNo" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_TidNo" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->TidNo->caption() ?><?php echo ($ivf_outcome->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->TidNo->cellAttributes() ?>>
<?php if ($ivf_outcome->TidNo->getSessionValue() <> "") { ?>
<script id="tpx_ivf_outcome_TidNo" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Ectopic->Visible) { // Ectopic ?>
	<div id="r_Ectopic" class="form-group row">
		<label id="elh_ivf_outcome_Ectopic" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Ectopic" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Ectopic->caption() ?><?php echo ($ivf_outcome->Ectopic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Ectopic->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Ectopic" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Extra->Visible) { // Extra ?>
	<div id="r_Extra" class="form-group row">
		<label id="elh_ivf_outcome_Extra" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Extra" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Extra->caption() ?><?php echo ($ivf_outcome->Extra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Extra->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Extra" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Implantation->Visible) { // Implantation ?>
	<div id="r_Implantation" class="form-group row">
		<label id="elh_ivf_outcome_Implantation" for="x_Implantation" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Implantation" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Implantation->caption() ?><?php echo ($ivf_outcome->Implantation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Implantation->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Implantation" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->DeliveryDate->Visible) { // DeliveryDate ?>
	<div id="r_DeliveryDate" class="form-group row">
		<label id="elh_ivf_outcome_DeliveryDate" for="x_DeliveryDate" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_DeliveryDate" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->DeliveryDate->caption() ?><?php echo ($ivf_outcome->DeliveryDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->DeliveryDate->cellAttributes() ?>>
<script id="tpx_ivf_outcome_DeliveryDate" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->BabyDetails->Visible) { // BabyDetails ?>
	<div id="r_BabyDetails" class="form-group row">
		<label id="elh_ivf_outcome_BabyDetails" for="x_BabyDetails" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_BabyDetails" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->BabyDetails->caption() ?><?php echo ($ivf_outcome->BabyDetails->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->BabyDetails->cellAttributes() ?>>
<script id="tpx_ivf_outcome_BabyDetails" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->LSCSNormal->Visible) { // LSCSNormal ?>
	<div id="r_LSCSNormal" class="form-group row">
		<label id="elh_ivf_outcome_LSCSNormal" for="x_LSCSNormal" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_LSCSNormal" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->LSCSNormal->caption() ?><?php echo ($ivf_outcome->LSCSNormal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->LSCSNormal->cellAttributes() ?>>
<script id="tpx_ivf_outcome_LSCSNormal" class="ivf_outcomeadd" type="text/html">
...
<?php if ($ivf_outcome->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh_ivf_outcome_Notes" for="x_Notes" class="<?php echo $ivf_outcome_add->LeftColumnClass ?>"><script id="tpc_ivf_outcome_Notes" class="ivf_outcomeadd" type="text/html"><span><?php echo $ivf_outcome->Notes->caption() ?><?php echo ($ivf_outcome->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_outcome_add->RightColumnClass ?>"><div<?php echo $ivf_outcome->Notes->cellAttributes() ?>>
<script id="tpx_ivf_outcome_Notes" class="ivf_outcomeadd" type="text/html">
	...
	<div class="col-12">
		<div class="card card-danger">
			...
			<table class="ew-table" style="width:100%;">
					...
					<tr>
						<td id="TypeOfCycle"  style="width:50%">
							<span class="ew-cell">{{include tmpl="#tpc_ivf_outcome_BabyDetails"/}}&nbsp;{{include tmpl="#tpx_ivf_outcome_BabyDetails"/}}</span>
						</td>
						<td id="SpermOrgin"  style="width:50%">
							<span class="ew-cell">{{include tmpl="#tpc_ivf_outcome_DeliveryDate"/}}&nbsp;{{include tmpl="#tpx_ivf_outcome_DeliveryDate"/}}</span>
						</td>
					</tr>
					<tr>
						<td id="AH"  style="width:50%">
							<span class="ew-cell">{{include tmpl="#tpc_ivf_outcome_Implantation"/}}&nbsp;{{include tmpl="#tpx_ivf_outcome_Implantation"/}}</span>
						</td>
						<td id="Weight"  style="width:50%">
							<span class="ew-cell">{{include tmpl="#tpc_ivf_outcome_LSCSNormal"/}}&nbsp;{{include tmpl="#tpx_ivf_outcome_LSCSNormal"/}}</span>
						</td>
					</tr>
					<tr>
						<td id="AH"  style="width:50%">
							<span class="ew-cell">{{include tmpl="#tpc_ivf_outcome_Notes"/}}&nbsp;{{include tmpl="#tpx_ivf_outcome_Notes"/}}</span>
						</td>
						<td id="Weight"  style="width:50%">
							<span class="ew-cell"></span>
						</td>
...
ew.applyTemplate("tpd_ivf_outcomeadd", "tpm_ivf_outcomeadd", "ivf_outcomeadd", "<?php echo $ivf_outcome->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_outcomeadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
