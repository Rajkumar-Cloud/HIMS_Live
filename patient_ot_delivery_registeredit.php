...
var fpatient_ot_delivery_registeredit = currentForm = new ew.Form("fpatient_ot_delivery_registeredit", "edit");
...
fpatient_ot_delivery_registeredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_ot_delivery_registeredit.lists["x_DrVisit1"] = <?php echo $patient_ot_delivery_register_edit->DrVisit1->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_DrVisit2"] = <?php echo $patient_ot_delivery_register_edit->DrVisit2->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_DrVisit3"] = <?php echo $patient_ot_delivery_register_edit->DrVisit3->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_DrVisit4"] = <?php echo $patient_ot_delivery_register_edit->DrVisit4->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_Surgeon"] = <?php echo $patient_ot_delivery_register_edit->Surgeon->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_Anaesthetist"] = <?php echo $patient_ot_delivery_register_edit->Anaesthetist->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_AsstSurgeon1"] = <?php echo $patient_ot_delivery_register_edit->AsstSurgeon1->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_AsstSurgeon2"] = <?php echo $patient_ot_delivery_register_edit->AsstSurgeon2->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_paediatric"] = <?php echo $patient_ot_delivery_register_edit->paediatric->Lookup->toClientList() ?>;
...
fpatient_ot_delivery_registeredit.lists["x_PatientSearch"] = <?php echo $patient_ot_delivery_register_edit->PatientSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_ot_delivery_register_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_ot_delivery_register_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_ot_delivery_register->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_ot_delivery_register_id" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_id" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->id->caption() ?><?php echo ($patient_ot_delivery_register->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->id->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_id" class="patient_ot_delivery_registeredit" type="text/html">
...
<input type="hidden" data-table="patient_ot_delivery_register" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_ot_delivery_register->id->CurrentValue) ?>">
<?php echo $patient_ot_delivery_register->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_ot_delivery_register->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_ot_delivery_register_PatID" for="x_PatID" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_PatID" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->PatID->caption() ?><?php echo ($patient_ot_delivery_register->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->PatID->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_PatID" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		...
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->PatientName->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_PatientName" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_ot_delivery_register_mrnno" for="x_mrnno" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_mrnno" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->mrnno->caption() ?><?php echo ($patient_ot_delivery_register->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->mrnno->cellAttributes() ?>>
<?php if ($patient_ot_delivery_register->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_ot_delivery_register_mrnno" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_ot_delivery_register_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_MobileNumber" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->MobileNumber->caption() ?><?php echo ($patient_ot_delivery_register->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_MobileNumber" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Age" for="x_Age" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Age" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Age->caption() ?><?php echo ($patient_ot_delivery_register->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Age->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Age" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Gender" for="x_Gender" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Gender" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Gender->caption() ?><?php echo ($patient_ot_delivery_register->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Gender->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Gender" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_ot_delivery_register_profilePic" for="x_profilePic" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_profilePic" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->profilePic->caption() ?><?php echo ($patient_ot_delivery_register->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->profilePic->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_profilePic" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ObstetricsHistryFeMale->Visible) { // ObstetricsHistryFeMale ?>
	<div id="r_ObstetricsHistryFeMale" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ObstetricsHistryFeMale" for="x_ObstetricsHistryFeMale" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ObstetricsHistryFeMale" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ObstetricsHistryFeMale->caption() ?><?php echo ($patient_ot_delivery_register->ObstetricsHistryFeMale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ObstetricsHistryFeMale->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ObstetricsHistryFeMale" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Abortion->Visible) { // Abortion ?>
	<div id="r_Abortion" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Abortion" for="x_Abortion" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Abortion" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Abortion->caption() ?><?php echo ($patient_ot_delivery_register->Abortion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Abortion->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Abortion" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildBirthDate->Visible) { // ChildBirthDate ?>
	<div id="r_ChildBirthDate" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildBirthDate" for="x_ChildBirthDate" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildBirthDate" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildBirthDate->caption() ?><?php echo ($patient_ot_delivery_register->ChildBirthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildBirthDate->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildBirthDate" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildBirthTime->Visible) { // ChildBirthTime ?>
	<div id="r_ChildBirthTime" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildBirthTime" for="x_ChildBirthTime" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildBirthTime" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildBirthTime->caption() ?><?php echo ($patient_ot_delivery_register->ChildBirthTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildBirthTime->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildBirthTime" class="patient_ot_delivery_registeredit" type="text/html">
...
<script type="text/html" class="patient_ot_delivery_registeredit_js">ew.createTimePicker("fpatient_ot_delivery_registeredit", "x_ChildBirthTime", {"timeFormat":"h:i A","step":15});
</script>
...
<?php if ($patient_ot_delivery_register->ChildSex->Visible) { // ChildSex ?>
	<div id="r_ChildSex" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildSex" for="x_ChildSex" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildSex" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildSex->caption() ?><?php echo ($patient_ot_delivery_register->ChildSex->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildSex->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildSex" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildWt->Visible) { // ChildWt ?>
	<div id="r_ChildWt" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildWt" for="x_ChildWt" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildWt" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildWt->caption() ?><?php echo ($patient_ot_delivery_register->ChildWt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildWt->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildWt" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildDay->Visible) { // ChildDay ?>
	<div id="r_ChildDay" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildDay" for="x_ChildDay" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildDay" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildDay->caption() ?><?php echo ($patient_ot_delivery_register->ChildDay->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildDay->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildDay" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildOE->Visible) { // ChildOE ?>
	<div id="r_ChildOE" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildOE" for="x_ChildOE" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildOE" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildOE->caption() ?><?php echo ($patient_ot_delivery_register->ChildOE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildOE->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildOE" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->TypeofDelivery->Visible) { // TypeofDelivery ?>
	<div id="r_TypeofDelivery" class="form-group row">
		<label id="elh_patient_ot_delivery_register_TypeofDelivery" for="x_TypeofDelivery" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_TypeofDelivery" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->TypeofDelivery->caption() ?><?php echo ($patient_ot_delivery_register->TypeofDelivery->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->TypeofDelivery->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_TypeofDelivery" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildBlGrp->Visible) { // ChildBlGrp ?>
	<div id="r_ChildBlGrp" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildBlGrp" for="x_ChildBlGrp" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildBlGrp" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildBlGrp->caption() ?><?php echo ($patient_ot_delivery_register->ChildBlGrp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildBlGrp->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildBlGrp" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ApgarScore->Visible) { // ApgarScore ?>
	<div id="r_ApgarScore" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ApgarScore" for="x_ApgarScore" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ApgarScore" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ApgarScore->caption() ?><?php echo ($patient_ot_delivery_register->ApgarScore->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ApgarScore->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ApgarScore" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->birthnotification->Visible) { // birthnotification ?>
	<div id="r_birthnotification" class="form-group row">
		<label id="elh_patient_ot_delivery_register_birthnotification" for="x_birthnotification" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_birthnotification" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->birthnotification->caption() ?><?php echo ($patient_ot_delivery_register->birthnotification->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->birthnotification->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_birthnotification" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->formno->Visible) { // formno ?>
	<div id="r_formno" class="form-group row">
		<label id="elh_patient_ot_delivery_register_formno" for="x_formno" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_formno" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->formno->caption() ?><?php echo ($patient_ot_delivery_register->formno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->formno->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_formno" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->dte->Visible) { // dte ?>
	<div id="r_dte" class="form-group row">
		<label id="elh_patient_ot_delivery_register_dte" for="x_dte" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_dte" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->dte->caption() ?><?php echo ($patient_ot_delivery_register->dte->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->dte->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_dte" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->motherReligion->Visible) { // motherReligion ?>
	<div id="r_motherReligion" class="form-group row">
		<label id="elh_patient_ot_delivery_register_motherReligion" for="x_motherReligion" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_motherReligion" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->motherReligion->caption() ?><?php echo ($patient_ot_delivery_register->motherReligion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->motherReligion->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_motherReligion" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->bloodgroup->Visible) { // bloodgroup ?>
	<div id="r_bloodgroup" class="form-group row">
		<label id="elh_patient_ot_delivery_register_bloodgroup" for="x_bloodgroup" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_bloodgroup" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->bloodgroup->caption() ?><?php echo ($patient_ot_delivery_register->bloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->bloodgroup->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_bloodgroup" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_ot_delivery_register_status" for="x_status" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_status" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->status->caption() ?><?php echo ($patient_ot_delivery_register->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->status->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_status" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_patient_ot_delivery_register_createdby" for="x_createdby" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_createdby" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->createdby->caption() ?><?php echo ($patient_ot_delivery_register->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->createdby->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_createdby" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_patient_ot_delivery_register_createddatetime" for="x_createddatetime" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_createddatetime" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->createddatetime->caption() ?><?php echo ($patient_ot_delivery_register->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->createddatetime->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_createddatetime" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_patient_ot_delivery_register_modifiedby" for="x_modifiedby" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_modifiedby" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->modifiedby->caption() ?><?php echo ($patient_ot_delivery_register->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->modifiedby->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_modifiedby" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_patient_ot_delivery_register_modifieddatetime" for="x_modifieddatetime" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_modifieddatetime" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->modifieddatetime->caption() ?><?php echo ($patient_ot_delivery_register->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->modifieddatetime->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_modifieddatetime" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_patient_ot_delivery_register_PatientID" for="x_PatientID" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_PatientID" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->PatientID->caption() ?><?php echo ($patient_ot_delivery_register->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->PatientID->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_PatientID" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildBirthDate1->Visible) { // ChildBirthDate1 ?>
	<div id="r_ChildBirthDate1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildBirthDate1" for="x_ChildBirthDate1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildBirthDate1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildBirthDate1->caption() ?><?php echo ($patient_ot_delivery_register->ChildBirthDate1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildBirthDate1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildBirthDate1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildBirthTime1->Visible) { // ChildBirthTime1 ?>
	<div id="r_ChildBirthTime1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildBirthTime1" for="x_ChildBirthTime1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildBirthTime1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildBirthTime1->caption() ?><?php echo ($patient_ot_delivery_register->ChildBirthTime1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildBirthTime1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildBirthTime1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildSex1->Visible) { // ChildSex1 ?>
	<div id="r_ChildSex1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildSex1" for="x_ChildSex1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildSex1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildSex1->caption() ?><?php echo ($patient_ot_delivery_register->ChildSex1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildSex1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildSex1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildWt1->Visible) { // ChildWt1 ?>
	<div id="r_ChildWt1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildWt1" for="x_ChildWt1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildWt1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildWt1->caption() ?><?php echo ($patient_ot_delivery_register->ChildWt1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildWt1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildWt1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildDay1->Visible) { // ChildDay1 ?>
	<div id="r_ChildDay1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildDay1" for="x_ChildDay1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildDay1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildDay1->caption() ?><?php echo ($patient_ot_delivery_register->ChildDay1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildDay1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildDay1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildOE1->Visible) { // ChildOE1 ?>
	<div id="r_ChildOE1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildOE1" for="x_ChildOE1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildOE1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildOE1->caption() ?><?php echo ($patient_ot_delivery_register->ChildOE1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildOE1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildOE1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->TypeofDelivery1->Visible) { // TypeofDelivery1 ?>
	<div id="r_TypeofDelivery1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_TypeofDelivery1" for="x_TypeofDelivery1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_TypeofDelivery1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->TypeofDelivery1->caption() ?><?php echo ($patient_ot_delivery_register->TypeofDelivery1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->TypeofDelivery1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_TypeofDelivery1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ChildBlGrp1->Visible) { // ChildBlGrp1 ?>
	<div id="r_ChildBlGrp1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ChildBlGrp1" for="x_ChildBlGrp1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ChildBlGrp1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ChildBlGrp1->caption() ?><?php echo ($patient_ot_delivery_register->ChildBlGrp1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ChildBlGrp1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ChildBlGrp1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ApgarScore1->Visible) { // ApgarScore1 ?>
	<div id="r_ApgarScore1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ApgarScore1" for="x_ApgarScore1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ApgarScore1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ApgarScore1->caption() ?><?php echo ($patient_ot_delivery_register->ApgarScore1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ApgarScore1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ApgarScore1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->birthnotification1->Visible) { // birthnotification1 ?>
	<div id="r_birthnotification1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_birthnotification1" for="x_birthnotification1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_birthnotification1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->birthnotification1->caption() ?><?php echo ($patient_ot_delivery_register->birthnotification1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->birthnotification1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_birthnotification1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->formno1->Visible) { // formno1 ?>
	<div id="r_formno1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_formno1" for="x_formno1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_formno1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->formno1->caption() ?><?php echo ($patient_ot_delivery_register->formno1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->formno1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_formno1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->proposedSurgery->Visible) { // proposedSurgery ?>
	<div id="r_proposedSurgery" class="form-group row">
		<label id="elh_patient_ot_delivery_register_proposedSurgery" for="x_proposedSurgery" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_proposedSurgery" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->proposedSurgery->caption() ?><?php echo ($patient_ot_delivery_register->proposedSurgery->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->proposedSurgery->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_proposedSurgery" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->surgeryProcedure->Visible) { // surgeryProcedure ?>
	<div id="r_surgeryProcedure" class="form-group row">
		<label id="elh_patient_ot_delivery_register_surgeryProcedure" for="x_surgeryProcedure" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_surgeryProcedure" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->surgeryProcedure->caption() ?><?php echo ($patient_ot_delivery_register->surgeryProcedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->surgeryProcedure->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_surgeryProcedure" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->typeOfAnaesthesia->Visible) { // typeOfAnaesthesia ?>
	<div id="r_typeOfAnaesthesia" class="form-group row">
		<label id="elh_patient_ot_delivery_register_typeOfAnaesthesia" for="x_typeOfAnaesthesia" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_typeOfAnaesthesia" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->typeOfAnaesthesia->caption() ?><?php echo ($patient_ot_delivery_register->typeOfAnaesthesia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->typeOfAnaesthesia->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_typeOfAnaesthesia" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->RecievedTime->Visible) { // RecievedTime ?>
	<div id="r_RecievedTime" class="form-group row">
		<label id="elh_patient_ot_delivery_register_RecievedTime" for="x_RecievedTime" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_RecievedTime" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->RecievedTime->caption() ?><?php echo ($patient_ot_delivery_register->RecievedTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->RecievedTime->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_RecievedTime" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->AnaesthesiaStarted->Visible) { // AnaesthesiaStarted ?>
	<div id="r_AnaesthesiaStarted" class="form-group row">
		<label id="elh_patient_ot_delivery_register_AnaesthesiaStarted" for="x_AnaesthesiaStarted" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_AnaesthesiaStarted" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->AnaesthesiaStarted->caption() ?><?php echo ($patient_ot_delivery_register->AnaesthesiaStarted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->AnaesthesiaStarted->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_AnaesthesiaStarted" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->AnaesthesiaEnded->Visible) { // AnaesthesiaEnded ?>
	<div id="r_AnaesthesiaEnded" class="form-group row">
		<label id="elh_patient_ot_delivery_register_AnaesthesiaEnded" for="x_AnaesthesiaEnded" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_AnaesthesiaEnded" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->AnaesthesiaEnded->caption() ?><?php echo ($patient_ot_delivery_register->AnaesthesiaEnded->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->AnaesthesiaEnded->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_AnaesthesiaEnded" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->surgeryStarted->Visible) { // surgeryStarted ?>
	<div id="r_surgeryStarted" class="form-group row">
		<label id="elh_patient_ot_delivery_register_surgeryStarted" for="x_surgeryStarted" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_surgeryStarted" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->surgeryStarted->caption() ?><?php echo ($patient_ot_delivery_register->surgeryStarted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->surgeryStarted->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_surgeryStarted" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->surgeryEnded->Visible) { // surgeryEnded ?>
	<div id="r_surgeryEnded" class="form-group row">
		<label id="elh_patient_ot_delivery_register_surgeryEnded" for="x_surgeryEnded" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_surgeryEnded" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->surgeryEnded->caption() ?><?php echo ($patient_ot_delivery_register->surgeryEnded->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->surgeryEnded->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_surgeryEnded" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->RecoveryTime->Visible) { // RecoveryTime ?>
	<div id="r_RecoveryTime" class="form-group row">
		<label id="elh_patient_ot_delivery_register_RecoveryTime" for="x_RecoveryTime" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_RecoveryTime" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->RecoveryTime->caption() ?><?php echo ($patient_ot_delivery_register->RecoveryTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->RecoveryTime->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_RecoveryTime" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ShiftedTime->Visible) { // ShiftedTime ?>
	<div id="r_ShiftedTime" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ShiftedTime" for="x_ShiftedTime" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ShiftedTime" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ShiftedTime->caption() ?><?php echo ($patient_ot_delivery_register->ShiftedTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ShiftedTime->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ShiftedTime" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Duration->Visible) { // Duration ?>
	<div id="r_Duration" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Duration" for="x_Duration" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Duration" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Duration->caption() ?><?php echo ($patient_ot_delivery_register->Duration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Duration->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Duration" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->DrVisit1->Visible) { // DrVisit1 ?>
	<div id="r_DrVisit1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_DrVisit1" for="x_DrVisit1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_DrVisit1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->DrVisit1->caption() ?><?php echo ($patient_ot_delivery_register->DrVisit1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->DrVisit1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_DrVisit1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->DrVisit2->Visible) { // DrVisit2 ?>
	<div id="r_DrVisit2" class="form-group row">
		<label id="elh_patient_ot_delivery_register_DrVisit2" for="x_DrVisit2" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_DrVisit2" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->DrVisit2->caption() ?><?php echo ($patient_ot_delivery_register->DrVisit2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->DrVisit2->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_DrVisit2" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->DrVisit3->Visible) { // DrVisit3 ?>
	<div id="r_DrVisit3" class="form-group row">
		<label id="elh_patient_ot_delivery_register_DrVisit3" for="x_DrVisit3" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_DrVisit3" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->DrVisit3->caption() ?><?php echo ($patient_ot_delivery_register->DrVisit3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->DrVisit3->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_DrVisit3" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->DrVisit4->Visible) { // DrVisit4 ?>
	<div id="r_DrVisit4" class="form-group row">
		<label id="elh_patient_ot_delivery_register_DrVisit4" for="x_DrVisit4" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_DrVisit4" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->DrVisit4->caption() ?><?php echo ($patient_ot_delivery_register->DrVisit4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->DrVisit4->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_DrVisit4" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Surgeon->Visible) { // Surgeon ?>
	<div id="r_Surgeon" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Surgeon" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Surgeon" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Surgeon->caption() ?><?php echo ($patient_ot_delivery_register->Surgeon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Surgeon->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Surgeon" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Anaesthetist->Visible) { // Anaesthetist ?>
	<div id="r_Anaesthetist" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Anaesthetist" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Anaesthetist" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Anaesthetist->caption() ?><?php echo ($patient_ot_delivery_register->Anaesthetist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Anaesthetist->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Anaesthetist" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->AsstSurgeon1->Visible) { // AsstSurgeon1 ?>
	<div id="r_AsstSurgeon1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_AsstSurgeon1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_AsstSurgeon1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->AsstSurgeon1->caption() ?><?php echo ($patient_ot_delivery_register->AsstSurgeon1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->AsstSurgeon1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_AsstSurgeon1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->AsstSurgeon2->Visible) { // AsstSurgeon2 ?>
	<div id="r_AsstSurgeon2" class="form-group row">
		<label id="elh_patient_ot_delivery_register_AsstSurgeon2" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_AsstSurgeon2" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->AsstSurgeon2->caption() ?><?php echo ($patient_ot_delivery_register->AsstSurgeon2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->AsstSurgeon2->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_AsstSurgeon2" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->paediatric->Visible) { // paediatric ?>
	<div id="r_paediatric" class="form-group row">
		<label id="elh_patient_ot_delivery_register_paediatric" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_paediatric" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->paediatric->caption() ?><?php echo ($patient_ot_delivery_register->paediatric->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->paediatric->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_paediatric" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ScrubNurse1->Visible) { // ScrubNurse1 ?>
	<div id="r_ScrubNurse1" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ScrubNurse1" for="x_ScrubNurse1" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ScrubNurse1" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ScrubNurse1->caption() ?><?php echo ($patient_ot_delivery_register->ScrubNurse1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ScrubNurse1->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ScrubNurse1" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->ScrubNurse2->Visible) { // ScrubNurse2 ?>
	<div id="r_ScrubNurse2" class="form-group row">
		<label id="elh_patient_ot_delivery_register_ScrubNurse2" for="x_ScrubNurse2" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_ScrubNurse2" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->ScrubNurse2->caption() ?><?php echo ($patient_ot_delivery_register->ScrubNurse2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->ScrubNurse2->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_ScrubNurse2" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->FloorNurse->Visible) { // FloorNurse ?>
	<div id="r_FloorNurse" class="form-group row">
		<label id="elh_patient_ot_delivery_register_FloorNurse" for="x_FloorNurse" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_FloorNurse" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->FloorNurse->caption() ?><?php echo ($patient_ot_delivery_register->FloorNurse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->FloorNurse->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_FloorNurse" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Technician->Visible) { // Technician ?>
	<div id="r_Technician" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Technician" for="x_Technician" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Technician" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Technician->caption() ?><?php echo ($patient_ot_delivery_register->Technician->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Technician->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_Technician" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->HouseKeeping->Visible) { // HouseKeeping ?>
	<div id="r_HouseKeeping" class="form-group row">
		<label id="elh_patient_ot_delivery_register_HouseKeeping" for="x_HouseKeeping" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_HouseKeeping" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->HouseKeeping->caption() ?><?php echo ($patient_ot_delivery_register->HouseKeeping->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->HouseKeeping->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_HouseKeeping" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->countsCheckedMops->Visible) { // countsCheckedMops ?>
	<div id="r_countsCheckedMops" class="form-group row">
		<label id="elh_patient_ot_delivery_register_countsCheckedMops" for="x_countsCheckedMops" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_countsCheckedMops" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->countsCheckedMops->caption() ?><?php echo ($patient_ot_delivery_register->countsCheckedMops->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->countsCheckedMops->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_countsCheckedMops" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->gauze->Visible) { // gauze ?>
	<div id="r_gauze" class="form-group row">
		<label id="elh_patient_ot_delivery_register_gauze" for="x_gauze" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_gauze" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->gauze->caption() ?><?php echo ($patient_ot_delivery_register->gauze->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->gauze->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_gauze" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->needles->Visible) { // needles ?>
	<div id="r_needles" class="form-group row">
		<label id="elh_patient_ot_delivery_register_needles" for="x_needles" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_needles" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->needles->caption() ?><?php echo ($patient_ot_delivery_register->needles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->needles->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_needles" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->bloodloss->Visible) { // bloodloss ?>
	<div id="r_bloodloss" class="form-group row">
		<label id="elh_patient_ot_delivery_register_bloodloss" for="x_bloodloss" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_bloodloss" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->bloodloss->caption() ?><?php echo ($patient_ot_delivery_register->bloodloss->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->bloodloss->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_bloodloss" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->bloodtransfusion->Visible) { // bloodtransfusion ?>
	<div id="r_bloodtransfusion" class="form-group row">
		<label id="elh_patient_ot_delivery_register_bloodtransfusion" for="x_bloodtransfusion" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_bloodtransfusion" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->bloodtransfusion->caption() ?><?php echo ($patient_ot_delivery_register->bloodtransfusion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->bloodtransfusion->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_bloodtransfusion" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->implantsUsed->Visible) { // implantsUsed ?>
	<div id="r_implantsUsed" class="form-group row">
		<label id="elh_patient_ot_delivery_register_implantsUsed" for="x_implantsUsed" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_implantsUsed" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->implantsUsed->caption() ?><?php echo ($patient_ot_delivery_register->implantsUsed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->implantsUsed->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_implantsUsed" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->MaterialsForHPE->Visible) { // MaterialsForHPE ?>
	<div id="r_MaterialsForHPE" class="form-group row">
		<label id="elh_patient_ot_delivery_register_MaterialsForHPE" for="x_MaterialsForHPE" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_MaterialsForHPE" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->MaterialsForHPE->caption() ?><?php echo ($patient_ot_delivery_register->MaterialsForHPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->MaterialsForHPE->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_MaterialsForHPE" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_ot_delivery_register_Reception" for="x_Reception" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_Reception" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->Reception->caption() ?><?php echo ($patient_ot_delivery_register->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->Reception->cellAttributes() ?>>
<?php if ($patient_ot_delivery_register->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_ot_delivery_register_Reception" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->PId->Visible) { // PId ?>
	<div id="r_PId" class="form-group row">
		<label id="elh_patient_ot_delivery_register_PId" for="x_PId" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_PId" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->PId->caption() ?><?php echo ($patient_ot_delivery_register->PId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->PId->cellAttributes() ?>>
<?php if ($patient_ot_delivery_register->PId->getSessionValue() <> "") { ?>
<script id="tpx_patient_ot_delivery_register_PId" class="patient_ot_delivery_registeredit" type="text/html">
...
<?php if ($patient_ot_delivery_register->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_ot_delivery_register_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_ot_delivery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_delivery_register_PatientSearch" class="patient_ot_delivery_registeredit" type="text/html"><span><?php echo $patient_ot_delivery_register->PatientSearch->caption() ?><?php echo ($patient_ot_delivery_register->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_delivery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_delivery_register->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_ot_delivery_register_PatientSearch" class="patient_ot_delivery_registeredit" type="text/html">
...
ew.applyTemplate("tpd_patient_ot_delivery_registeredit", "tpm_patient_ot_delivery_registeredit", "patient_ot_delivery_registeredit", "<?php echo $patient_ot_delivery_register->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_ot_delivery_registeredit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
