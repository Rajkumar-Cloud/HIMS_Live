...
var fpres_trade_combination_namesadd = currentForm = new ew.Form("fpres_trade_combination_namesadd", "add");
...
fpres_trade_combination_namesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_trade_combination_names_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_trade_combination_names_add->Token ?>">
<?php } ?>
...
<?php if ($pres_trade_combination_names->tradenames_id->Visible) { // tradenames_id ?>
	<div id="r_tradenames_id" class="form-group row">
		<label id="elh_pres_trade_combination_names_tradenames_id" for="x_tradenames_id" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->tradenames_id->caption() ?><?php echo ($pres_trade_combination_names->tradenames_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->tradenames_id->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->GENERIC_NAMES->Visible) { // GENERIC_NAMES ?>
	<div id="r_GENERIC_NAMES" class="form-group row">
		<label id="elh_pres_trade_combination_names_GENERIC_NAMES" for="x_GENERIC_NAMES" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->GENERIC_NAMES->caption() ?><?php echo ($pres_trade_combination_names->GENERIC_NAMES->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->GENERIC_NAMES->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->TRADE_NAME->Visible) { // TRADE_NAME ?>
	<div id="r_TRADE_NAME" class="form-group row">
		<label id="elh_pres_trade_combination_names_TRADE_NAME" for="x_TRADE_NAME" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->TRADE_NAME->caption() ?><?php echo ($pres_trade_combination_names->TRADE_NAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->TRADE_NAME->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->Drug_Name->Visible) { // Drug_Name ?>
	<div id="r_Drug_Name" class="form-group row">
		<label id="elh_pres_trade_combination_names_Drug_Name" for="x_Drug_Name" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->Drug_Name->caption() ?><?php echo ($pres_trade_combination_names->Drug_Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->Drug_Name->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->PR_CODE->Visible) { // PR_CODE ?>
	<div id="r_PR_CODE" class="form-group row">
		<label id="elh_pres_trade_combination_names_PR_CODE" for="x_PR_CODE" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->PR_CODE->caption() ?><?php echo ($pres_trade_combination_names->PR_CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->PR_CODE->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->GenericNames_symbols->Visible) { // GenericNames_symbols ?>
	<div id="r_GenericNames_symbols" class="form-group row">
		...
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->GenericNames_symbols->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->CONTAINER_TYPE->Visible) { // CONTAINER_TYPE ?>
	<div id="r_CONTAINER_TYPE" class="form-group row">
		<label id="elh_pres_trade_combination_names_CONTAINER_TYPE" for="x_CONTAINER_TYPE" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->CONTAINER_TYPE->caption() ?><?php echo ($pres_trade_combination_names->CONTAINER_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->CONTAINER_TYPE->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names->STRENGTH->Visible) { // STRENGTH ?>
	<div id="r_STRENGTH" class="form-group row">
		<label id="elh_pres_trade_combination_names_STRENGTH" for="x_STRENGTH" class="<?php echo $pres_trade_combination_names_add->LeftColumnClass ?>"><?php echo $pres_trade_combination_names->STRENGTH->caption() ?><?php echo ($pres_trade_combination_names->STRENGTH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_add->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names->STRENGTH->cellAttributes() ?>>
