...
var fpharmacy_pharledadd = currentForm = new ew.Form("fpharmacy_pharledadd", "add");
...
fpharmacy_pharledadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($pharmacy_pharled_add->sretid->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->sprid->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->baid->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->isdate->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_pharled_add->PSGST->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->PCGST->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->SSGST->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->SCGST->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->PurValue->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->PurRate->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->PUnit->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->SUnit->Required) { ?>
		...
		<?php if ($pharmacy_pharled_add->HSNCODE->Required) { ?>
...
fpharmacy_pharledadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_pharledadd.lists["x_SLNO"] = <?php echo $pharmacy_pharled_add->SLNO->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_pharled_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_pharled_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_pharled->SiNo->Visible) { // SiNo ?>
	<div id="r_SiNo" class="form-group row">
		<label id="elh_pharmacy_pharled_SiNo" for="x_SiNo" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->SiNo->caption() ?><?php echo ($pharmacy_pharled->SiNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->SiNo->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->SLNO->Visible) { // SLNO ?>
	<div id="r_SLNO" class="form-group row">
		<label id="elh_pharmacy_pharled_SLNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->SLNO->caption() ?><?php echo ($pharmacy_pharled->SLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->SLNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->Product->Visible) { // Product ?>
	<div id="r_Product" class="form-group row">
		<label id="elh_pharmacy_pharled_Product" for="x_Product" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->Product->caption() ?><?php echo ($pharmacy_pharled->Product->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->Product->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_pharmacy_pharled_RT" for="x_RT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->RT->caption() ?><?php echo ($pharmacy_pharled->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->RT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_pharmacy_pharled_IQ" for="x_IQ" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->IQ->caption() ?><?php echo ($pharmacy_pharled->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->IQ->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DAMT->Visible) { // DAMT ?>
	<div id="r_DAMT" class="form-group row">
		<label id="elh_pharmacy_pharled_DAMT" for="x_DAMT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DAMT->caption() ?><?php echo ($pharmacy_pharled->DAMT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DAMT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->Mfg->Visible) { // Mfg ?>
	<div id="r_Mfg" class="form-group row">
		<label id="elh_pharmacy_pharled_Mfg" for="x_Mfg" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->Mfg->caption() ?><?php echo ($pharmacy_pharled->Mfg->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->Mfg->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_pharmacy_pharled_EXPDT" for="x_EXPDT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->EXPDT->caption() ?><?php echo ($pharmacy_pharled->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->EXPDT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_pharmacy_pharled_BATCHNO" for="x_BATCHNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->BATCHNO->caption() ?><?php echo ($pharmacy_pharled->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->BATCHNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->TYPE->Visible) { // TYPE ?>
	<div id="r_TYPE" class="form-group row">
		<label id="elh_pharmacy_pharled_TYPE" for="x_TYPE" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->TYPE->caption() ?><?php echo ($pharmacy_pharled->TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->TYPE->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DN->Visible) { // DN ?>
	<div id="r_DN" class="form-group row">
		<label id="elh_pharmacy_pharled_DN" for="x_DN" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DN->caption() ?><?php echo ($pharmacy_pharled->DN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DN->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->RDN->Visible) { // RDN ?>
	<div id="r_RDN" class="form-group row">
		<label id="elh_pharmacy_pharled_RDN" for="x_RDN" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->RDN->caption() ?><?php echo ($pharmacy_pharled->RDN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->RDN->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_pharmacy_pharled_DT" for="x_DT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DT->caption() ?><?php echo ($pharmacy_pharled->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_pharmacy_pharled_PRC" for="x_PRC" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PRC->caption() ?><?php echo ($pharmacy_pharled->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PRC->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_pharmacy_pharled_OQ" for="x_OQ" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->OQ->caption() ?><?php echo ($pharmacy_pharled->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->OQ->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_pharmacy_pharled_RQ" for="x_RQ" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->RQ->caption() ?><?php echo ($pharmacy_pharled->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->RQ->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_pharmacy_pharled_MRQ" for="x_MRQ" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->MRQ->caption() ?><?php echo ($pharmacy_pharled->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->MRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->BILLNO->Visible) { // BILLNO ?>
	<div id="r_BILLNO" class="form-group row">
		<label id="elh_pharmacy_pharled_BILLNO" for="x_BILLNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->BILLNO->caption() ?><?php echo ($pharmacy_pharled->BILLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->BILLNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->BILLDT->Visible) { // BILLDT ?>
	<div id="r_BILLDT" class="form-group row">
		<label id="elh_pharmacy_pharled_BILLDT" for="x_BILLDT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->BILLDT->caption() ?><?php echo ($pharmacy_pharled->BILLDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->BILLDT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->VALUE->Visible) { // VALUE ?>
	<div id="r_VALUE" class="form-group row">
		<label id="elh_pharmacy_pharled_VALUE" for="x_VALUE" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->VALUE->caption() ?><?php echo ($pharmacy_pharled->VALUE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->VALUE->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DISC->Visible) { // DISC ?>
	<div id="r_DISC" class="form-group row">
		<label id="elh_pharmacy_pharled_DISC" for="x_DISC" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DISC->caption() ?><?php echo ($pharmacy_pharled->DISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DISC->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_pharmacy_pharled_TAXP" for="x_TAXP" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->TAXP->caption() ?><?php echo ($pharmacy_pharled->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->TAXP->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->TAX->Visible) { // TAX ?>
	<div id="r_TAX" class="form-group row">
		<label id="elh_pharmacy_pharled_TAX" for="x_TAX" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->TAX->caption() ?><?php echo ($pharmacy_pharled->TAX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->TAX->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->TAXR->Visible) { // TAXR ?>
	<div id="r_TAXR" class="form-group row">
		<label id="elh_pharmacy_pharled_TAXR" for="x_TAXR" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->TAXR->caption() ?><?php echo ($pharmacy_pharled->TAXR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->TAXR->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->EMPNO->Visible) { // EMPNO ?>
	<div id="r_EMPNO" class="form-group row">
		<label id="elh_pharmacy_pharled_EMPNO" for="x_EMPNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->EMPNO->caption() ?><?php echo ($pharmacy_pharled->EMPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->EMPNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_pharmacy_pharled_PC" for="x_PC" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PC->caption() ?><?php echo ($pharmacy_pharled->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PC->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DRNAME->Visible) { // DRNAME ?>
	<div id="r_DRNAME" class="form-group row">
		<label id="elh_pharmacy_pharled_DRNAME" for="x_DRNAME" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DRNAME->caption() ?><?php echo ($pharmacy_pharled->DRNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DRNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->BTIME->Visible) { // BTIME ?>
	<div id="r_BTIME" class="form-group row">
		<label id="elh_pharmacy_pharled_BTIME" for="x_BTIME" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->BTIME->caption() ?><?php echo ($pharmacy_pharled->BTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->BTIME->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->ONO->Visible) { // ONO ?>
	<div id="r_ONO" class="form-group row">
		<label id="elh_pharmacy_pharled_ONO" for="x_ONO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->ONO->caption() ?><?php echo ($pharmacy_pharled->ONO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->ONO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->ODT->Visible) { // ODT ?>
	<div id="r_ODT" class="form-group row">
		<label id="elh_pharmacy_pharled_ODT" for="x_ODT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->ODT->caption() ?><?php echo ($pharmacy_pharled->ODT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->ODT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PURRT->Visible) { // PURRT ?>
	<div id="r_PURRT" class="form-group row">
		<label id="elh_pharmacy_pharled_PURRT" for="x_PURRT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PURRT->caption() ?><?php echo ($pharmacy_pharled->PURRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PURRT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->GRP->Visible) { // GRP ?>
	<div id="r_GRP" class="form-group row">
		<label id="elh_pharmacy_pharled_GRP" for="x_GRP" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->GRP->caption() ?><?php echo ($pharmacy_pharled->GRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->GRP->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->IBATCH->Visible) { // IBATCH ?>
	<div id="r_IBATCH" class="form-group row">
		<label id="elh_pharmacy_pharled_IBATCH" for="x_IBATCH" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->IBATCH->caption() ?><?php echo ($pharmacy_pharled->IBATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->IBATCH->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->IPNO->Visible) { // IPNO ?>
	<div id="r_IPNO" class="form-group row">
		<label id="elh_pharmacy_pharled_IPNO" for="x_IPNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->IPNO->caption() ?><?php echo ($pharmacy_pharled->IPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->IPNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->OPNO->Visible) { // OPNO ?>
	<div id="r_OPNO" class="form-group row">
		<label id="elh_pharmacy_pharled_OPNO" for="x_OPNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->OPNO->caption() ?><?php echo ($pharmacy_pharled->OPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->OPNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->RECID->Visible) { // RECID ?>
	<div id="r_RECID" class="form-group row">
		<label id="elh_pharmacy_pharled_RECID" for="x_RECID" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->RECID->caption() ?><?php echo ($pharmacy_pharled->RECID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->RECID->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->FQTY->Visible) { // FQTY ?>
	<div id="r_FQTY" class="form-group row">
		<label id="elh_pharmacy_pharled_FQTY" for="x_FQTY" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->FQTY->caption() ?><?php echo ($pharmacy_pharled->FQTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->FQTY->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_pharmacy_pharled_UR" for="x_UR" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->UR->caption() ?><?php echo ($pharmacy_pharled->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->UR->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DCID->Visible) { // DCID ?>
	<div id="r_DCID" class="form-group row">
		<label id="elh_pharmacy_pharled_DCID" for="x_DCID" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DCID->caption() ?><?php echo ($pharmacy_pharled->DCID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DCID->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->MODDT->Visible) { // MODDT ?>
	<div id="r_MODDT" class="form-group row">
		<label id="elh_pharmacy_pharled_MODDT" for="x_MODDT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->MODDT->caption() ?><?php echo ($pharmacy_pharled->MODDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->MODDT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->FYM->Visible) { // FYM ?>
	<div id="r_FYM" class="form-group row">
		<label id="elh_pharmacy_pharled_FYM" for="x_FYM" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->FYM->caption() ?><?php echo ($pharmacy_pharled->FYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->FYM->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PRCBATCH->Visible) { // PRCBATCH ?>
	<div id="r_PRCBATCH" class="form-group row">
		<label id="elh_pharmacy_pharled_PRCBATCH" for="x_PRCBATCH" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PRCBATCH->caption() ?><?php echo ($pharmacy_pharled->PRCBATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PRCBATCH->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_pharmacy_pharled_MRP" for="x_MRP" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->MRP->caption() ?><?php echo ($pharmacy_pharled->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->MRP->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->BILLYM->Visible) { // BILLYM ?>
	<div id="r_BILLYM" class="form-group row">
		<label id="elh_pharmacy_pharled_BILLYM" for="x_BILLYM" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->BILLYM->caption() ?><?php echo ($pharmacy_pharled->BILLYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->BILLYM->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->BILLGRP->Visible) { // BILLGRP ?>
	<div id="r_BILLGRP" class="form-group row">
		<label id="elh_pharmacy_pharled_BILLGRP" for="x_BILLGRP" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->BILLGRP->caption() ?><?php echo ($pharmacy_pharled->BILLGRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->BILLGRP->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->STAFF->Visible) { // STAFF ?>
	<div id="r_STAFF" class="form-group row">
		<label id="elh_pharmacy_pharled_STAFF" for="x_STAFF" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->STAFF->caption() ?><?php echo ($pharmacy_pharled->STAFF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->STAFF->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->TEMPIPNO->Visible) { // TEMPIPNO ?>
	<div id="r_TEMPIPNO" class="form-group row">
		<label id="elh_pharmacy_pharled_TEMPIPNO" for="x_TEMPIPNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->TEMPIPNO->caption() ?><?php echo ($pharmacy_pharled->TEMPIPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->TEMPIPNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PRNTED->Visible) { // PRNTED ?>
	<div id="r_PRNTED" class="form-group row">
		<label id="elh_pharmacy_pharled_PRNTED" for="x_PRNTED" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PRNTED->caption() ?><?php echo ($pharmacy_pharled->PRNTED->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PRNTED->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PATNAME->Visible) { // PATNAME ?>
	<div id="r_PATNAME" class="form-group row">
		<label id="elh_pharmacy_pharled_PATNAME" for="x_PATNAME" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PATNAME->caption() ?><?php echo ($pharmacy_pharled->PATNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PATNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PJVNO->Visible) { // PJVNO ?>
	<div id="r_PJVNO" class="form-group row">
		<label id="elh_pharmacy_pharled_PJVNO" for="x_PJVNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PJVNO->caption() ?><?php echo ($pharmacy_pharled->PJVNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PJVNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PJVSLNO->Visible) { // PJVSLNO ?>
	<div id="r_PJVSLNO" class="form-group row">
		<label id="elh_pharmacy_pharled_PJVSLNO" for="x_PJVSLNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PJVSLNO->caption() ?><?php echo ($pharmacy_pharled->PJVSLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PJVSLNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->OTHDISC->Visible) { // OTHDISC ?>
	<div id="r_OTHDISC" class="form-group row">
		<label id="elh_pharmacy_pharled_OTHDISC" for="x_OTHDISC" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->OTHDISC->caption() ?><?php echo ($pharmacy_pharled->OTHDISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->OTHDISC->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PJVYM->Visible) { // PJVYM ?>
	<div id="r_PJVYM" class="form-group row">
		<label id="elh_pharmacy_pharled_PJVYM" for="x_PJVYM" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PJVYM->caption() ?><?php echo ($pharmacy_pharled->PJVYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PJVYM->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PURDISCPER->Visible) { // PURDISCPER ?>
	<div id="r_PURDISCPER" class="form-group row">
		<label id="elh_pharmacy_pharled_PURDISCPER" for="x_PURDISCPER" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PURDISCPER->caption() ?><?php echo ($pharmacy_pharled->PURDISCPER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PURDISCPER->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->CASHIER->Visible) { // CASHIER ?>
	<div id="r_CASHIER" class="form-group row">
		<label id="elh_pharmacy_pharled_CASHIER" for="x_CASHIER" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->CASHIER->caption() ?><?php echo ($pharmacy_pharled->CASHIER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->CASHIER->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->CASHTIME->Visible) { // CASHTIME ?>
	<div id="r_CASHTIME" class="form-group row">
		<label id="elh_pharmacy_pharled_CASHTIME" for="x_CASHTIME" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->CASHTIME->caption() ?><?php echo ($pharmacy_pharled->CASHTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->CASHTIME->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->CASHRECD->Visible) { // CASHRECD ?>
	<div id="r_CASHRECD" class="form-group row">
		<label id="elh_pharmacy_pharled_CASHRECD" for="x_CASHRECD" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->CASHRECD->caption() ?><?php echo ($pharmacy_pharled->CASHRECD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->CASHRECD->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->CASHREFNO->Visible) { // CASHREFNO ?>
	<div id="r_CASHREFNO" class="form-group row">
		<label id="elh_pharmacy_pharled_CASHREFNO" for="x_CASHREFNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->CASHREFNO->caption() ?><?php echo ($pharmacy_pharled->CASHREFNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->CASHREFNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->CASHIERSHIFT->Visible) { // CASHIERSHIFT ?>
	<div id="r_CASHIERSHIFT" class="form-group row">
		<label id="elh_pharmacy_pharled_CASHIERSHIFT" for="x_CASHIERSHIFT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->CASHIERSHIFT->caption() ?><?php echo ($pharmacy_pharled->CASHIERSHIFT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->CASHIERSHIFT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PRCODE->Visible) { // PRCODE ?>
	<div id="r_PRCODE" class="form-group row">
		<label id="elh_pharmacy_pharled_PRCODE" for="x_PRCODE" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PRCODE->caption() ?><?php echo ($pharmacy_pharled->PRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->RELEASEBY->Visible) { // RELEASEBY ?>
	<div id="r_RELEASEBY" class="form-group row">
		<label id="elh_pharmacy_pharled_RELEASEBY" for="x_RELEASEBY" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->RELEASEBY->caption() ?><?php echo ($pharmacy_pharled->RELEASEBY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->RELEASEBY->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->CRAUTHOR->Visible) { // CRAUTHOR ?>
	<div id="r_CRAUTHOR" class="form-group row">
		<label id="elh_pharmacy_pharled_CRAUTHOR" for="x_CRAUTHOR" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->CRAUTHOR->caption() ?><?php echo ($pharmacy_pharled->CRAUTHOR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->CRAUTHOR->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PAYMENT->Visible) { // PAYMENT ?>
	<div id="r_PAYMENT" class="form-group row">
		<label id="elh_pharmacy_pharled_PAYMENT" for="x_PAYMENT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PAYMENT->caption() ?><?php echo ($pharmacy_pharled->PAYMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PAYMENT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DRID->Visible) { // DRID ?>
	<div id="r_DRID" class="form-group row">
		<label id="elh_pharmacy_pharled_DRID" for="x_DRID" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DRID->caption() ?><?php echo ($pharmacy_pharled->DRID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DRID->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->WARD->Visible) { // WARD ?>
	<div id="r_WARD" class="form-group row">
		<label id="elh_pharmacy_pharled_WARD" for="x_WARD" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->WARD->caption() ?><?php echo ($pharmacy_pharled->WARD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->WARD->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->STAXTYPE->Visible) { // STAXTYPE ?>
	<div id="r_STAXTYPE" class="form-group row">
		<label id="elh_pharmacy_pharled_STAXTYPE" for="x_STAXTYPE" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->STAXTYPE->caption() ?><?php echo ($pharmacy_pharled->STAXTYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->STAXTYPE->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PURDISCVAL->Visible) { // PURDISCVAL ?>
	<div id="r_PURDISCVAL" class="form-group row">
		<label id="elh_pharmacy_pharled_PURDISCVAL" for="x_PURDISCVAL" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PURDISCVAL->caption() ?><?php echo ($pharmacy_pharled->PURDISCVAL->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PURDISCVAL->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->RNDOFF->Visible) { // RNDOFF ?>
	<div id="r_RNDOFF" class="form-group row">
		<label id="elh_pharmacy_pharled_RNDOFF" for="x_RNDOFF" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->RNDOFF->caption() ?><?php echo ($pharmacy_pharled->RNDOFF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->RNDOFF->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DISCONMRP->Visible) { // DISCONMRP ?>
	<div id="r_DISCONMRP" class="form-group row">
		<label id="elh_pharmacy_pharled_DISCONMRP" for="x_DISCONMRP" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DISCONMRP->caption() ?><?php echo ($pharmacy_pharled->DISCONMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DISCONMRP->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DELVDT->Visible) { // DELVDT ?>
	<div id="r_DELVDT" class="form-group row">
		<label id="elh_pharmacy_pharled_DELVDT" for="x_DELVDT" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DELVDT->caption() ?><?php echo ($pharmacy_pharled->DELVDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DELVDT->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DELVTIME->Visible) { // DELVTIME ?>
	<div id="r_DELVTIME" class="form-group row">
		<label id="elh_pharmacy_pharled_DELVTIME" for="x_DELVTIME" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DELVTIME->caption() ?><?php echo ($pharmacy_pharled->DELVTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DELVTIME->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->DELVBY->Visible) { // DELVBY ?>
	<div id="r_DELVBY" class="form-group row">
		<label id="elh_pharmacy_pharled_DELVBY" for="x_DELVBY" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->DELVBY->caption() ?><?php echo ($pharmacy_pharled->DELVBY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->DELVBY->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->HOSPNO->Visible) { // HOSPNO ?>
	<div id="r_HOSPNO" class="form-group row">
		<label id="elh_pharmacy_pharled_HOSPNO" for="x_HOSPNO" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->HOSPNO->caption() ?><?php echo ($pharmacy_pharled->HOSPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->HOSPNO->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->pbv->Visible) { // pbv ?>
	<div id="r_pbv" class="form-group row">
		<label id="elh_pharmacy_pharled_pbv" for="x_pbv" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->pbv->caption() ?><?php echo ($pharmacy_pharled->pbv->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->pbv->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->pbt->Visible) { // pbt ?>
	<div id="r_pbt" class="form-group row">
		<label id="elh_pharmacy_pharled_pbt" for="x_pbt" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->pbt->caption() ?><?php echo ($pharmacy_pharled->pbt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->pbt->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_pharmacy_pharled_MFRCODE" for="x_MFRCODE" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->MFRCODE->caption() ?><?php echo ($pharmacy_pharled->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->MFRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_pharmacy_pharled_Reception" for="x_Reception" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->Reception->caption() ?><?php echo ($pharmacy_pharled->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->Reception->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_pharmacy_pharled_PatID" for="x_PatID" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PatID->caption() ?><?php echo ($pharmacy_pharled->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PatID->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_pharmacy_pharled_mrnno" for="x_mrnno" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->mrnno->caption() ?><?php echo ($pharmacy_pharled->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->mrnno->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->sretid->Visible) { // sretid ?>
	<div id="r_sretid" class="form-group row">
		<label id="elh_pharmacy_pharled_sretid" for="x_sretid" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->sretid->caption() ?><?php echo ($pharmacy_pharled->sretid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->sretid->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->sprid->Visible) { // sprid ?>
	<div id="r_sprid" class="form-group row">
		<label id="elh_pharmacy_pharled_sprid" for="x_sprid" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->sprid->caption() ?><?php echo ($pharmacy_pharled->sprid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->sprid->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->baid->Visible) { // baid ?>
	<div id="r_baid" class="form-group row">
		<label id="elh_pharmacy_pharled_baid" for="x_baid" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->baid->caption() ?><?php echo ($pharmacy_pharled->baid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->baid->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_pharmacy_pharled_PSGST" for="x_PSGST" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PSGST->caption() ?><?php echo ($pharmacy_pharled->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_pharmacy_pharled_PCGST" for="x_PCGST" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PCGST->caption() ?><?php echo ($pharmacy_pharled->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_pharmacy_pharled_SSGST" for="x_SSGST" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->SSGST->caption() ?><?php echo ($pharmacy_pharled->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->SSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_pharmacy_pharled_SCGST" for="x_SCGST" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->SCGST->caption() ?><?php echo ($pharmacy_pharled->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->SCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_pharmacy_pharled_PurValue" for="x_PurValue" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PurValue->caption() ?><?php echo ($pharmacy_pharled->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PurValue->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_pharmacy_pharled_PurRate" for="x_PurRate" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PurRate->caption() ?><?php echo ($pharmacy_pharled->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PurRate->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_pharmacy_pharled_PUnit" for="x_PUnit" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->PUnit->caption() ?><?php echo ($pharmacy_pharled->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->PUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_pharmacy_pharled_SUnit" for="x_SUnit" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->SUnit->caption() ?><?php echo ($pharmacy_pharled->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->SUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_pharled->HSNCODE->Visible) { // HSNCODE ?>
	<div id="r_HSNCODE" class="form-group row">
		<label id="elh_pharmacy_pharled_HSNCODE" for="x_HSNCODE" class="<?php echo $pharmacy_pharled_add->LeftColumnClass ?>"><?php echo $pharmacy_pharled->HSNCODE->caption() ?><?php echo ($pharmacy_pharled->HSNCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_pharled_add->RightColumnClass ?>"><div<?php echo $pharmacy_pharled->HSNCODE->cellAttributes() ?>>
