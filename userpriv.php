...
<input type="hidden" name="x_id" id="x_id" value="<?php echo $userlevels->id->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-grid">
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->getUserLevelName($userlevels->id->CurrentValue) ?> (<?php echo $userlevels->id->CurrentValue ?>)</h3>
