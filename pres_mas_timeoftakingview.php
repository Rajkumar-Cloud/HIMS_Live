...
var fpres_mas_timeoftakingview = currentForm = new ew.Form("fpres_mas_timeoftakingview", "view");

// Form_CustomValidate event
fpres_mas_timeoftakingview.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fpres_mas_timeoftakingview.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_mas_timeoftaking_view->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_mas_timeoftaking_view->Token ?>">
<?php } ?>
...
<?php if ($pres_mas_timeoftaking->ID->Visible) { // ID ?>
	<tr id="r_ID">
		<td class="<?php echo $pres_mas_timeoftaking_view->TableLeftColumnClass ?>"><span id="elh_pres_mas_timeoftaking_ID"><?php echo $pres_mas_timeoftaking->ID->caption() ?></span></td>
...
<?php if ($pres_mas_timeoftaking->Time_Of_Taking->Visible) { // Time Of Taking ?>
	<tr id="r_Time_Of_Taking">
		<td class="<?php echo $pres_mas_timeoftaking_view->TableLeftColumnClass ?>"><span id="elh_pres_mas_timeoftaking_Time_Of_Taking"><?php echo $pres_mas_timeoftaking->Time_Of_Taking->caption() ?></span></td>
