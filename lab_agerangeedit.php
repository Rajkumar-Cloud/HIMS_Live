...
// Create page object
$lab_agerange_edit = new lab_agerange_edit();

// Run the page
$lab_agerange_edit->run();
...
var flab_agerangeedit = currentForm = new ew.Form("flab_agerangeedit", "edit");

// Validate form
flab_agerangeedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($lab_agerange_edit->id->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_agerange_edit->testid->Required) { ?>
		...
		<?php if ($lab_agerange_edit->TestName->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_agerange_edit->Gender->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_agerange_edit->MinAge->Required) { ?>
		...
		<?php if ($lab_agerange_edit->MinAgeType->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_agerange_edit->MaxAge->Required) { ?>
		...
		<?php if ($lab_agerange_edit->MaxAgeType->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_agerange_edit->Value->Required) { ?>
		...
		<?php } ?>
		<?php if ($lab_agerange_edit->Modied->Required) { ?>
			elm = this.getElements("x" + infix + "_Modied");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $lab_agerange->Modied->caption(), $lab_agerange->Modied->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($lab_agerange_edit->ModifiedBy->Required) { ?>
			elm = this.getElements("x" + infix + "_ModifiedBy");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $lab_agerange->ModifiedBy->caption(), $lab_agerange->ModifiedBy->RequiredErrorMessage)) ?>");
		<?php } ?>
...
flab_agerangeedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
flab_agerangeedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flab_agerangeedit.lists["x_Gender"] = <?php echo $lab_agerange_edit->Gender->Lookup->toClientList() ?>;
flab_agerangeedit.lists["x_Gender"].options = <?php echo JsonEncode($lab_agerange_edit->Gender->lookupOptions()) ?>;
flab_agerangeedit.lists["x_MinAgeType"] = <?php echo $lab_agerange_edit->MinAgeType->Lookup->toClientList() ?>;
flab_agerangeedit.lists["x_MinAgeType"].options = <?php echo JsonEncode($lab_agerange_edit->MinAgeType->options(FALSE, TRUE)) ?>;
flab_agerangeedit.lists["x_MaxAgeType"] = <?php echo $lab_agerange_edit->MaxAgeType->Lookup->toClientList() ?>;
flab_agerangeedit.lists["x_MaxAgeType"].options = <?php echo JsonEncode($lab_agerange_edit->MaxAgeType->options(FALSE, TRUE)) ?>;
...
<?php $lab_agerange_edit->showPageHeader(); ?>
<?php
$lab_agerange_edit->showMessage();
?>
<form name="flab_agerangeedit" id="flab_agerangeedit" class="<?php echo $lab_agerange_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($lab_agerange_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $lab_agerange_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="lab_agerange">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$lab_agerange_edit->IsModal ?>">
...
<?php if ($lab_agerange->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_lab_agerange_id" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->id->caption() ?><?php echo ($lab_agerange->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->id->cellAttributes() ?>>
...
<input type="hidden" data-table="lab_agerange" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($lab_agerange->id->CurrentValue) ?>">
<?php echo $lab_agerange->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($lab_agerange->testid->Visible) { // testid ?>
	<div id="r_testid" class="form-group row">
		<label id="elh_lab_agerange_testid" for="x_testid" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->testid->caption() ?><?php echo ($lab_agerange->testid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->testid->cellAttributes() ?>>
...
<?php if ($lab_agerange->TestName->Visible) { // TestName ?>
	<div id="r_TestName" class="form-group row">
		<label id="elh_lab_agerange_TestName" for="x_TestName" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->TestName->caption() ?><?php echo ($lab_agerange->TestName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->TestName->cellAttributes() ?>>
...
<?php if ($lab_agerange->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_lab_agerange_Gender" for="x_Gender" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->Gender->caption() ?><?php echo ($lab_agerange->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->Gender->cellAttributes() ?>>
...
<?php if ($lab_agerange->MinAge->Visible) { // MinAge ?>
	<div id="r_MinAge" class="form-group row">
		<label id="elh_lab_agerange_MinAge" for="x_MinAge" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->MinAge->caption() ?><?php echo ($lab_agerange->MinAge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->MinAge->cellAttributes() ?>>
...
<?php if ($lab_agerange->MinAgeType->Visible) { // MinAgeType ?>
	<div id="r_MinAgeType" class="form-group row">
		<label id="elh_lab_agerange_MinAgeType" for="x_MinAgeType" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->MinAgeType->caption() ?><?php echo ($lab_agerange->MinAgeType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->MinAgeType->cellAttributes() ?>>
...
<?php if ($lab_agerange->MaxAge->Visible) { // MaxAge ?>
	<div id="r_MaxAge" class="form-group row">
		<label id="elh_lab_agerange_MaxAge" for="x_MaxAge" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->MaxAge->caption() ?><?php echo ($lab_agerange->MaxAge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->MaxAge->cellAttributes() ?>>
...
<?php if ($lab_agerange->MaxAgeType->Visible) { // MaxAgeType ?>
	<div id="r_MaxAgeType" class="form-group row">
		<label id="elh_lab_agerange_MaxAgeType" for="x_MaxAgeType" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->MaxAgeType->caption() ?><?php echo ($lab_agerange->MaxAgeType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->MaxAgeType->cellAttributes() ?>>
...
<?php if ($lab_agerange->Value->Visible) { // Value ?>
	<div id="r_Value" class="form-group row">
		<label id="elh_lab_agerange_Value" for="x_Value" class="<?php echo $lab_agerange_edit->LeftColumnClass ?>"><?php echo $lab_agerange->Value->caption() ?><?php echo ($lab_agerange->Value->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_agerange_edit->RightColumnClass ?>"><div<?php echo $lab_agerange->Value->cellAttributes() ?>>
...
<?php if (!$lab_agerange_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $lab_agerange_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $lab_agerange_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$lab_agerange_edit->showPageFooter();
if (DEBUG_ENABLED)
