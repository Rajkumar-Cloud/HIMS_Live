...
var fivf_art_summaryadd = currentForm = new ew.Form("fivf_art_summaryadd", "add");
...
fivf_art_summaryadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_art_summaryadd.lists["x_ARTCycle"] = <?php echo $ivf_art_summary_add->ARTCycle->Lookup->toClientList() ?>;
fivf_art_summaryadd.lists["x_ARTCycle"].options = <?php echo JsonEncode($ivf_art_summary_add->ARTCycle->options(FALSE, TRUE)) ?>;
fivf_art_summaryadd.lists["x_Spermorigin"] = <?php echo $ivf_art_summary_add->Spermorigin->Lookup->toClientList() ?>;
fivf_art_summaryadd.lists["x_Spermorigin"].options = <?php echo JsonEncode($ivf_art_summary_add->Spermorigin->options(FALSE, TRUE)) ?>;
fivf_art_summaryadd.lists["x_Origin"] = <?php echo $ivf_art_summary_add->Origin->Lookup->toClientList() ?>;
fivf_art_summaryadd.lists["x_Origin"].options = <?php echo JsonEncode($ivf_art_summary_add->Origin->options(FALSE, TRUE)) ?>;
fivf_art_summaryadd.lists["x_Status"] = <?php echo $ivf_art_summary_add->Status->Lookup->toClientList() ?>;
fivf_art_summaryadd.lists["x_Status"].options = <?php echo JsonEncode($ivf_art_summary_add->Status->options(FALSE, TRUE)) ?>;
fivf_art_summaryadd.lists["x_Method"] = <?php echo $ivf_art_summary_add->Method->Lookup->toClientList() ?>;
fivf_art_summaryadd.lists["x_Method"].options = <?php echo JsonEncode($ivf_art_summary_add->Method->options(FALSE, TRUE)) ?>;
fivf_art_summaryadd.lists["x_InseminatinTechnique"] = <?php echo $ivf_art_summary_add->InseminatinTechnique->Lookup->toClientList() ?>;
...
fivf_art_summaryadd.lists["x_DateofET"] = <?php echo $ivf_art_summary_add->DateofET->Lookup->toClientList() ?>;
fivf_art_summaryadd.lists["x_DateofET"].options = <?php echo JsonEncode($ivf_art_summary_add->DateofET->options(FALSE, TRUE)) ?>;
fivf_art_summaryadd.lists["x_Reasonfornotranfer"] = <?php echo $ivf_art_summary_add->Reasonfornotranfer->Lookup->toClientList() ?>;
...
fivf_art_summaryadd.lists["x_ConsultantsSignature"] = <?php echo $ivf_art_summary_add->ConsultantsSignature->Lookup->toClientList() ?>;
...
<?php if ($ivf_art_summary_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_art_summary_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_art_summary->ARTCycle->Visible) { // ARTCycle ?>
	<div id="r_ARTCycle" class="form-group row">
		<label id="elh_ivf_art_summary_ARTCycle" for="x_ARTCycle" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_ARTCycle" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->ARTCycle->caption() ?><?php echo ($ivf_art_summary->ARTCycle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->ARTCycle->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_ARTCycle" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Spermorigin->Visible) { // Spermorigin ?>
	<div id="r_Spermorigin" class="form-group row">
		<label id="elh_ivf_art_summary_Spermorigin" for="x_Spermorigin" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Spermorigin" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Spermorigin->caption() ?><?php echo ($ivf_art_summary->Spermorigin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Spermorigin->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Spermorigin" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->IndicationforART->Visible) { // IndicationforART ?>
	<div id="r_IndicationforART" class="form-group row">
		<label id="elh_ivf_art_summary_IndicationforART" for="x_IndicationforART" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_IndicationforART" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->IndicationforART->caption() ?><?php echo ($ivf_art_summary->IndicationforART->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->IndicationforART->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_IndicationforART" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->DateofICSI->Visible) { // DateofICSI ?>
	<div id="r_DateofICSI" class="form-group row">
		<label id="elh_ivf_art_summary_DateofICSI" for="x_DateofICSI" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_DateofICSI" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->DateofICSI->caption() ?><?php echo ($ivf_art_summary->DateofICSI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->DateofICSI->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_DateofICSI" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Origin->Visible) { // Origin ?>
	<div id="r_Origin" class="form-group row">
		<label id="elh_ivf_art_summary_Origin" for="x_Origin" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Origin" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Origin->caption() ?><?php echo ($ivf_art_summary->Origin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Origin->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Origin" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Status->Visible) { // Status ?>
	<div id="r_Status" class="form-group row">
		<label id="elh_ivf_art_summary_Status" for="x_Status" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Status" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Status->caption() ?><?php echo ($ivf_art_summary->Status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Status->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Status" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_ivf_art_summary_Method" for="x_Method" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Method" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Method->caption() ?><?php echo ($ivf_art_summary->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Method->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Method" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->pre_Concentration->Visible) { // pre_Concentration ?>
	<div id="r_pre_Concentration" class="form-group row">
		<label id="elh_ivf_art_summary_pre_Concentration" for="x_pre_Concentration" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_pre_Concentration" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->pre_Concentration->caption() ?><?php echo ($ivf_art_summary->pre_Concentration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->pre_Concentration->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_pre_Concentration" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->pre_Motility->Visible) { // pre_Motility ?>
	<div id="r_pre_Motility" class="form-group row">
		<label id="elh_ivf_art_summary_pre_Motility" for="x_pre_Motility" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_pre_Motility" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->pre_Motility->caption() ?><?php echo ($ivf_art_summary->pre_Motility->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->pre_Motility->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_pre_Motility" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->pre_Morphology->Visible) { // pre_Morphology ?>
	<div id="r_pre_Morphology" class="form-group row">
		<label id="elh_ivf_art_summary_pre_Morphology" for="x_pre_Morphology" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_pre_Morphology" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->pre_Morphology->caption() ?><?php echo ($ivf_art_summary->pre_Morphology->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->pre_Morphology->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_pre_Morphology" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->post_Concentration->Visible) { // post_Concentration ?>
	<div id="r_post_Concentration" class="form-group row">
		<label id="elh_ivf_art_summary_post_Concentration" for="x_post_Concentration" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_post_Concentration" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->post_Concentration->caption() ?><?php echo ($ivf_art_summary->post_Concentration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->post_Concentration->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_post_Concentration" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->post_Motility->Visible) { // post_Motility ?>
	<div id="r_post_Motility" class="form-group row">
		<label id="elh_ivf_art_summary_post_Motility" for="x_post_Motility" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_post_Motility" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->post_Motility->caption() ?><?php echo ($ivf_art_summary->post_Motility->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->post_Motility->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_post_Motility" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->post_Morphology->Visible) { // post_Morphology ?>
	<div id="r_post_Morphology" class="form-group row">
		<label id="elh_ivf_art_summary_post_Morphology" for="x_post_Morphology" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_post_Morphology" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->post_Morphology->caption() ?><?php echo ($ivf_art_summary->post_Morphology->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->post_Morphology->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_post_Morphology" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->NumberofEmbryostransferred->Visible) { // NumberofEmbryostransferred ?>
	<div id="r_NumberofEmbryostransferred" class="form-group row">
		<label id="elh_ivf_art_summary_NumberofEmbryostransferred" for="x_NumberofEmbryostransferred" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_NumberofEmbryostransferred" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->NumberofEmbryostransferred->caption() ?><?php echo ($ivf_art_summary->NumberofEmbryostransferred->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->NumberofEmbryostransferred->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_NumberofEmbryostransferred" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Embryosunderobservation->Visible) { // Embryosunderobservation ?>
	<div id="r_Embryosunderobservation" class="form-group row">
		<label id="elh_ivf_art_summary_Embryosunderobservation" for="x_Embryosunderobservation" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Embryosunderobservation" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Embryosunderobservation->caption() ?><?php echo ($ivf_art_summary->Embryosunderobservation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Embryosunderobservation->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Embryosunderobservation" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->EmbryoDevelopmentSummary->Visible) { // EmbryoDevelopmentSummary ?>
	<div id="r_EmbryoDevelopmentSummary" class="form-group row">
		<label id="elh_ivf_art_summary_EmbryoDevelopmentSummary" for="x_EmbryoDevelopmentSummary" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_EmbryoDevelopmentSummary" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->EmbryoDevelopmentSummary->caption() ?><?php echo ($ivf_art_summary->EmbryoDevelopmentSummary->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->EmbryoDevelopmentSummary->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_EmbryoDevelopmentSummary" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->EmbryologistSignature->Visible) { // EmbryologistSignature ?>
	<div id="r_EmbryologistSignature" class="form-group row">
		<label id="elh_ivf_art_summary_EmbryologistSignature" for="x_EmbryologistSignature" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_EmbryologistSignature" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->EmbryologistSignature->caption() ?><?php echo ($ivf_art_summary->EmbryologistSignature->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->EmbryologistSignature->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_EmbryologistSignature" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->IVFRegistrationID->Visible) { // IVFRegistrationID ?>
	<div id="r_IVFRegistrationID" class="form-group row">
		<label id="elh_ivf_art_summary_IVFRegistrationID" for="x_IVFRegistrationID" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_IVFRegistrationID" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->IVFRegistrationID->caption() ?><?php echo ($ivf_art_summary->IVFRegistrationID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->IVFRegistrationID->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_IVFRegistrationID" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->InseminatinTechnique->Visible) { // InseminatinTechnique ?>
	<div id="r_InseminatinTechnique" class="form-group row">
		<label id="elh_ivf_art_summary_InseminatinTechnique" for="x_InseminatinTechnique" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_InseminatinTechnique" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->InseminatinTechnique->caption() ?><?php echo ($ivf_art_summary->InseminatinTechnique->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->InseminatinTechnique->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_InseminatinTechnique" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->ICSIDetails->Visible) { // ICSIDetails ?>
	<div id="r_ICSIDetails" class="form-group row">
		<label id="elh_ivf_art_summary_ICSIDetails" for="x_ICSIDetails" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_ICSIDetails" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->ICSIDetails->caption() ?><?php echo ($ivf_art_summary->ICSIDetails->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->ICSIDetails->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_ICSIDetails" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->DateofET->Visible) { // DateofET ?>
	<div id="r_DateofET" class="form-group row">
		<label id="elh_ivf_art_summary_DateofET" for="x_DateofET" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_DateofET" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->DateofET->caption() ?><?php echo ($ivf_art_summary->DateofET->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->DateofET->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_DateofET" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Reasonfornotranfer->Visible) { // Reasonfornotranfer ?>
	<div id="r_Reasonfornotranfer" class="form-group row">
		<label id="elh_ivf_art_summary_Reasonfornotranfer" for="x_Reasonfornotranfer" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Reasonfornotranfer" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Reasonfornotranfer->caption() ?><?php echo ($ivf_art_summary->Reasonfornotranfer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Reasonfornotranfer->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Reasonfornotranfer" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->EmbryosCryopreserved->Visible) { // EmbryosCryopreserved ?>
	<div id="r_EmbryosCryopreserved" class="form-group row">
		<label id="elh_ivf_art_summary_EmbryosCryopreserved" for="x_EmbryosCryopreserved" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_EmbryosCryopreserved" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->EmbryosCryopreserved->caption() ?><?php echo ($ivf_art_summary->EmbryosCryopreserved->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->EmbryosCryopreserved->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_EmbryosCryopreserved" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->LegendCellStage->Visible) { // LegendCellStage ?>
	<div id="r_LegendCellStage" class="form-group row">
		<label id="elh_ivf_art_summary_LegendCellStage" for="x_LegendCellStage" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_LegendCellStage" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->LegendCellStage->caption() ?><?php echo ($ivf_art_summary->LegendCellStage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->LegendCellStage->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_LegendCellStage" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->ConsultantsSignature->Visible) { // ConsultantsSignature ?>
	<div id="r_ConsultantsSignature" class="form-group row">
		<label id="elh_ivf_art_summary_ConsultantsSignature" for="x_ConsultantsSignature" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_ConsultantsSignature" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->ConsultantsSignature->caption() ?><?php echo ($ivf_art_summary->ConsultantsSignature->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->ConsultantsSignature->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_ConsultantsSignature" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_art_summary_Name" for="x_Name" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Name" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Name->caption() ?><?php echo ($ivf_art_summary->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Name->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Name" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->M2->Visible) { // M2 ?>
	<div id="r_M2" class="form-group row">
		<label id="elh_ivf_art_summary_M2" for="x_M2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_M2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->M2->caption() ?><?php echo ($ivf_art_summary->M2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->M2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_M2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Mi2->Visible) { // Mi2 ?>
	<div id="r_Mi2" class="form-group row">
		<label id="elh_ivf_art_summary_Mi2" for="x_Mi2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Mi2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Mi2->caption() ?><?php echo ($ivf_art_summary->Mi2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Mi2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Mi2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->ICSI->Visible) { // ICSI ?>
	<div id="r_ICSI" class="form-group row">
		<label id="elh_ivf_art_summary_ICSI" for="x_ICSI" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_ICSI" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->ICSI->caption() ?><?php echo ($ivf_art_summary->ICSI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->ICSI->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_ICSI" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->IVF->Visible) { // IVF ?>
	<div id="r_IVF" class="form-group row">
		<label id="elh_ivf_art_summary_IVF" for="x_IVF" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_IVF" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->IVF->caption() ?><?php echo ($ivf_art_summary->IVF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->IVF->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_IVF" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->M1->Visible) { // M1 ?>
	<div id="r_M1" class="form-group row">
		<label id="elh_ivf_art_summary_M1" for="x_M1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_M1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->M1->caption() ?><?php echo ($ivf_art_summary->M1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->M1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_M1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->GV->Visible) { // GV ?>
	<div id="r_GV" class="form-group row">
		<label id="elh_ivf_art_summary_GV" for="x_GV" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_GV" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->GV->caption() ?><?php echo ($ivf_art_summary->GV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->GV->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_GV" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Others->Visible) { // Others ?>
	<div id="r_Others" class="form-group row">
		<label id="elh_ivf_art_summary_Others" for="x_Others" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Others" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Others->caption() ?><?php echo ($ivf_art_summary->Others->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Others->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Others" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Normal2PN->Visible) { // Normal2PN ?>
	<div id="r_Normal2PN" class="form-group row">
		<label id="elh_ivf_art_summary_Normal2PN" for="x_Normal2PN" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Normal2PN" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Normal2PN->caption() ?><?php echo ($ivf_art_summary->Normal2PN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Normal2PN->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Normal2PN" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Abnormalfertilisation1N->Visible) { // Abnormalfertilisation1N ?>
	<div id="r_Abnormalfertilisation1N" class="form-group row">
		<label id="elh_ivf_art_summary_Abnormalfertilisation1N" for="x_Abnormalfertilisation1N" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Abnormalfertilisation1N" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Abnormalfertilisation1N->caption() ?><?php echo ($ivf_art_summary->Abnormalfertilisation1N->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Abnormalfertilisation1N->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Abnormalfertilisation1N" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Abnormalfertilisation3N->Visible) { // Abnormalfertilisation3N ?>
	<div id="r_Abnormalfertilisation3N" class="form-group row">
		<label id="elh_ivf_art_summary_Abnormalfertilisation3N" for="x_Abnormalfertilisation3N" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Abnormalfertilisation3N" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Abnormalfertilisation3N->caption() ?><?php echo ($ivf_art_summary->Abnormalfertilisation3N->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Abnormalfertilisation3N->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Abnormalfertilisation3N" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->NotFertilized->Visible) { // NotFertilized ?>
	<div id="r_NotFertilized" class="form-group row">
		<label id="elh_ivf_art_summary_NotFertilized" for="x_NotFertilized" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_NotFertilized" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->NotFertilized->caption() ?><?php echo ($ivf_art_summary->NotFertilized->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->NotFertilized->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_NotFertilized" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Degenerated->Visible) { // Degenerated ?>
	<div id="r_Degenerated" class="form-group row">
		<label id="elh_ivf_art_summary_Degenerated" for="x_Degenerated" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Degenerated" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Degenerated->caption() ?><?php echo ($ivf_art_summary->Degenerated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Degenerated->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Degenerated" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->SpermDate->Visible) { // SpermDate ?>
	<div id="r_SpermDate" class="form-group row">
		<label id="elh_ivf_art_summary_SpermDate" for="x_SpermDate" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_SpermDate" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->SpermDate->caption() ?><?php echo ($ivf_art_summary->SpermDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->SpermDate->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_SpermDate" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Code1->Visible) { // Code1 ?>
	<div id="r_Code1" class="form-group row">
		<label id="elh_ivf_art_summary_Code1" for="x_Code1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Code1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Code1->caption() ?><?php echo ($ivf_art_summary->Code1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Code1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Code1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Day1->Visible) { // Day1 ?>
	<div id="r_Day1" class="form-group row">
		<label id="elh_ivf_art_summary_Day1" for="x_Day1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Day1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Day1->caption() ?><?php echo ($ivf_art_summary->Day1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Day1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Day1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->CellStage1->Visible) { // CellStage1 ?>
	<div id="r_CellStage1" class="form-group row">
		<label id="elh_ivf_art_summary_CellStage1" for="x_CellStage1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_CellStage1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->CellStage1->caption() ?><?php echo ($ivf_art_summary->CellStage1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->CellStage1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_CellStage1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Grade1->Visible) { // Grade1 ?>
	<div id="r_Grade1" class="form-group row">
		<label id="elh_ivf_art_summary_Grade1" for="x_Grade1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Grade1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Grade1->caption() ?><?php echo ($ivf_art_summary->Grade1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Grade1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Grade1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->State1->Visible) { // State1 ?>
	<div id="r_State1" class="form-group row">
		<label id="elh_ivf_art_summary_State1" for="x_State1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_State1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->State1->caption() ?><?php echo ($ivf_art_summary->State1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->State1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_State1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Code2->Visible) { // Code2 ?>
	<div id="r_Code2" class="form-group row">
		<label id="elh_ivf_art_summary_Code2" for="x_Code2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Code2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Code2->caption() ?><?php echo ($ivf_art_summary->Code2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Code2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Code2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Day2->Visible) { // Day2 ?>
	<div id="r_Day2" class="form-group row">
		<label id="elh_ivf_art_summary_Day2" for="x_Day2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Day2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Day2->caption() ?><?php echo ($ivf_art_summary->Day2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Day2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Day2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->CellStage2->Visible) { // CellStage2 ?>
	<div id="r_CellStage2" class="form-group row">
		<label id="elh_ivf_art_summary_CellStage2" for="x_CellStage2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_CellStage2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->CellStage2->caption() ?><?php echo ($ivf_art_summary->CellStage2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->CellStage2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_CellStage2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Grade2->Visible) { // Grade2 ?>
	<div id="r_Grade2" class="form-group row">
		<label id="elh_ivf_art_summary_Grade2" for="x_Grade2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Grade2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Grade2->caption() ?><?php echo ($ivf_art_summary->Grade2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Grade2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Grade2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->State2->Visible) { // State2 ?>
	<div id="r_State2" class="form-group row">
		<label id="elh_ivf_art_summary_State2" for="x_State2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_State2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->State2->caption() ?><?php echo ($ivf_art_summary->State2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->State2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_State2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Code3->Visible) { // Code3 ?>
	<div id="r_Code3" class="form-group row">
		<label id="elh_ivf_art_summary_Code3" for="x_Code3" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Code3" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Code3->caption() ?><?php echo ($ivf_art_summary->Code3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Code3->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Code3" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Day3->Visible) { // Day3 ?>
	<div id="r_Day3" class="form-group row">
		<label id="elh_ivf_art_summary_Day3" for="x_Day3" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Day3" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Day3->caption() ?><?php echo ($ivf_art_summary->Day3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Day3->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Day3" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->CellStage3->Visible) { // CellStage3 ?>
	<div id="r_CellStage3" class="form-group row">
		<label id="elh_ivf_art_summary_CellStage3" for="x_CellStage3" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_CellStage3" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->CellStage3->caption() ?><?php echo ($ivf_art_summary->CellStage3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->CellStage3->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_CellStage3" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Grade3->Visible) { // Grade3 ?>
	<div id="r_Grade3" class="form-group row">
		<label id="elh_ivf_art_summary_Grade3" for="x_Grade3" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Grade3" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Grade3->caption() ?><?php echo ($ivf_art_summary->Grade3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Grade3->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Grade3" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->State3->Visible) { // State3 ?>
	<div id="r_State3" class="form-group row">
		<label id="elh_ivf_art_summary_State3" for="x_State3" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_State3" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->State3->caption() ?><?php echo ($ivf_art_summary->State3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->State3->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_State3" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Code4->Visible) { // Code4 ?>
	<div id="r_Code4" class="form-group row">
		<label id="elh_ivf_art_summary_Code4" for="x_Code4" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Code4" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Code4->caption() ?><?php echo ($ivf_art_summary->Code4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Code4->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Code4" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Day4->Visible) { // Day4 ?>
	<div id="r_Day4" class="form-group row">
		<label id="elh_ivf_art_summary_Day4" for="x_Day4" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Day4" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Day4->caption() ?><?php echo ($ivf_art_summary->Day4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Day4->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Day4" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->CellStage4->Visible) { // CellStage4 ?>
	<div id="r_CellStage4" class="form-group row">
		<label id="elh_ivf_art_summary_CellStage4" for="x_CellStage4" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_CellStage4" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->CellStage4->caption() ?><?php echo ($ivf_art_summary->CellStage4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->CellStage4->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_CellStage4" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Grade4->Visible) { // Grade4 ?>
	<div id="r_Grade4" class="form-group row">
		<label id="elh_ivf_art_summary_Grade4" for="x_Grade4" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Grade4" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Grade4->caption() ?><?php echo ($ivf_art_summary->Grade4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Grade4->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Grade4" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->State4->Visible) { // State4 ?>
	<div id="r_State4" class="form-group row">
		<label id="elh_ivf_art_summary_State4" for="x_State4" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_State4" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->State4->caption() ?><?php echo ($ivf_art_summary->State4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->State4->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_State4" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Code5->Visible) { // Code5 ?>
	<div id="r_Code5" class="form-group row">
		<label id="elh_ivf_art_summary_Code5" for="x_Code5" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Code5" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Code5->caption() ?><?php echo ($ivf_art_summary->Code5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Code5->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Code5" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Day5->Visible) { // Day5 ?>
	<div id="r_Day5" class="form-group row">
		<label id="elh_ivf_art_summary_Day5" for="x_Day5" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Day5" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Day5->caption() ?><?php echo ($ivf_art_summary->Day5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Day5->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Day5" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->CellStage5->Visible) { // CellStage5 ?>
	<div id="r_CellStage5" class="form-group row">
		<label id="elh_ivf_art_summary_CellStage5" for="x_CellStage5" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_CellStage5" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->CellStage5->caption() ?><?php echo ($ivf_art_summary->CellStage5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->CellStage5->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_CellStage5" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Grade5->Visible) { // Grade5 ?>
	<div id="r_Grade5" class="form-group row">
		<label id="elh_ivf_art_summary_Grade5" for="x_Grade5" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Grade5" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Grade5->caption() ?><?php echo ($ivf_art_summary->Grade5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Grade5->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Grade5" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->State5->Visible) { // State5 ?>
	<div id="r_State5" class="form-group row">
		<label id="elh_ivf_art_summary_State5" for="x_State5" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_State5" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->State5->caption() ?><?php echo ($ivf_art_summary->State5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->State5->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_State5" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_art_summary_TidNo" for="x_TidNo" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_TidNo" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->TidNo->caption() ?><?php echo ($ivf_art_summary->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->TidNo->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_TidNo" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_art_summary_RIDNo" for="x_RIDNo" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_RIDNo" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->RIDNo->caption() ?><?php echo ($ivf_art_summary->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->RIDNo->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_RIDNo" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Volume->Visible) { // Volume ?>
	<div id="r_Volume" class="form-group row">
		<label id="elh_ivf_art_summary_Volume" for="x_Volume" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Volume" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Volume->caption() ?><?php echo ($ivf_art_summary->Volume->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Volume->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Volume" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Volume1->Visible) { // Volume1 ?>
	<div id="r_Volume1" class="form-group row">
		<label id="elh_ivf_art_summary_Volume1" for="x_Volume1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Volume1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Volume1->caption() ?><?php echo ($ivf_art_summary->Volume1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Volume1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Volume1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Volume2->Visible) { // Volume2 ?>
	<div id="r_Volume2" class="form-group row">
		<label id="elh_ivf_art_summary_Volume2" for="x_Volume2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Volume2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Volume2->caption() ?><?php echo ($ivf_art_summary->Volume2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Volume2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Volume2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Concentration2->Visible) { // Concentration2 ?>
	<div id="r_Concentration2" class="form-group row">
		<label id="elh_ivf_art_summary_Concentration2" for="x_Concentration2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Concentration2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Concentration2->caption() ?><?php echo ($ivf_art_summary->Concentration2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Concentration2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Concentration2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Total->Visible) { // Total ?>
	<div id="r_Total" class="form-group row">
		<label id="elh_ivf_art_summary_Total" for="x_Total" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Total" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Total->caption() ?><?php echo ($ivf_art_summary->Total->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Total->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Total" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Total1->Visible) { // Total1 ?>
	<div id="r_Total1" class="form-group row">
		<label id="elh_ivf_art_summary_Total1" for="x_Total1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Total1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Total1->caption() ?><?php echo ($ivf_art_summary->Total1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Total1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Total1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Total2->Visible) { // Total2 ?>
	<div id="r_Total2" class="form-group row">
		<label id="elh_ivf_art_summary_Total2" for="x_Total2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Total2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Total2->caption() ?><?php echo ($ivf_art_summary->Total2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Total2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Total2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Progressive->Visible) { // Progressive ?>
	<div id="r_Progressive" class="form-group row">
		<label id="elh_ivf_art_summary_Progressive" for="x_Progressive" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Progressive" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Progressive->caption() ?><?php echo ($ivf_art_summary->Progressive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Progressive->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Progressive" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Progressive1->Visible) { // Progressive1 ?>
	<div id="r_Progressive1" class="form-group row">
		<label id="elh_ivf_art_summary_Progressive1" for="x_Progressive1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Progressive1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Progressive1->caption() ?><?php echo ($ivf_art_summary->Progressive1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Progressive1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Progressive1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Progressive2->Visible) { // Progressive2 ?>
	<div id="r_Progressive2" class="form-group row">
		<label id="elh_ivf_art_summary_Progressive2" for="x_Progressive2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Progressive2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Progressive2->caption() ?><?php echo ($ivf_art_summary->Progressive2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Progressive2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Progressive2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->NotProgressive->Visible) { // NotProgressive ?>
	<div id="r_NotProgressive" class="form-group row">
		<label id="elh_ivf_art_summary_NotProgressive" for="x_NotProgressive" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_NotProgressive" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->NotProgressive->caption() ?><?php echo ($ivf_art_summary->NotProgressive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->NotProgressive->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_NotProgressive" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->NotProgressive1->Visible) { // NotProgressive1 ?>
	<div id="r_NotProgressive1" class="form-group row">
		<label id="elh_ivf_art_summary_NotProgressive1" for="x_NotProgressive1" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_NotProgressive1" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->NotProgressive1->caption() ?><?php echo ($ivf_art_summary->NotProgressive1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->NotProgressive1->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_NotProgressive1" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->NotProgressive2->Visible) { // NotProgressive2 ?>
	<div id="r_NotProgressive2" class="form-group row">
		<label id="elh_ivf_art_summary_NotProgressive2" for="x_NotProgressive2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_NotProgressive2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->NotProgressive2->caption() ?><?php echo ($ivf_art_summary->NotProgressive2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->NotProgressive2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_NotProgressive2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Motility2->Visible) { // Motility2 ?>
	<div id="r_Motility2" class="form-group row">
		<label id="elh_ivf_art_summary_Motility2" for="x_Motility2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Motility2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Motility2->caption() ?><?php echo ($ivf_art_summary->Motility2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Motility2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Motility2" class="ivf_art_summaryadd" type="text/html">
...
<?php if ($ivf_art_summary->Morphology2->Visible) { // Morphology2 ?>
	<div id="r_Morphology2" class="form-group row">
		<label id="elh_ivf_art_summary_Morphology2" for="x_Morphology2" class="<?php echo $ivf_art_summary_add->LeftColumnClass ?>"><script id="tpc_ivf_art_summary_Morphology2" class="ivf_art_summaryadd" type="text/html"><span><?php echo $ivf_art_summary->Morphology2->caption() ?><?php echo ($ivf_art_summary->Morphology2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_art_summary_add->RightColumnClass ?>"><div<?php echo $ivf_art_summary->Morphology2->cellAttributes() ?>>
<script id="tpx_ivf_art_summary_Morphology2" class="ivf_art_summaryadd" type="text/html">
...
ew.applyTemplate("tpd_ivf_art_summaryadd", "tpm_ivf_art_summaryadd", "ivf_art_summaryadd", "<?php echo $ivf_art_summary->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_art_summaryadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
