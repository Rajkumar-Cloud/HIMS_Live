...
// Create page object
$hr_clients_add = new hr_clients_add();
...
var fhr_clientsadd = currentForm = new ew.Form("fhr_clientsadd", "add");
...
fhr_clientsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($hr_clients_add->name->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->first_contact_date->Required) { ?>
		...
		<?php if ($hr_clients_add->created->Required) { ?>
		...
		<?php if ($hr_clients_add->address->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->contact_number->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->contact_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->company_url->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_clients_add->HospID->Required) { ?>
...
fhr_clientsadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fhr_clientsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhr_clientsadd.lists["x_status"] = <?php echo $hr_clients_add->status->Lookup->toClientList() ?>;
fhr_clientsadd.lists["x_status"].options = <?php echo JsonEncode($hr_clients_add->status->options(FALSE, TRUE)) ?>;
...
<?php $hr_clients_add->showPageHeader(); ?>
<?php
$hr_clients_add->showMessage();
?>
<form name="fhr_clientsadd" id="fhr_clientsadd" class="<?php echo $hr_clients_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($hr_clients_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $hr_clients_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="hr_clients">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$hr_clients_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($hr_clients->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_hr_clients_name" for="x_name" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->name->caption() ?><?php echo ($hr_clients->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->name->cellAttributes() ?>>
...
<?php if ($hr_clients->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_hr_clients_details" for="x_details" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->details->caption() ?><?php echo ($hr_clients->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->details->cellAttributes() ?>>
...
<?php if ($hr_clients->first_contact_date->Visible) { // first_contact_date ?>
	<div id="r_first_contact_date" class="form-group row">
		<label id="elh_hr_clients_first_contact_date" for="x_first_contact_date" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->first_contact_date->caption() ?><?php echo ($hr_clients->first_contact_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->first_contact_date->cellAttributes() ?>>
...
<?php if ($hr_clients->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_hr_clients_created" for="x_created" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->created->caption() ?><?php echo ($hr_clients->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->created->cellAttributes() ?>>
...
<?php if ($hr_clients->address->Visible) { // address ?>
	<div id="r_address" class="form-group row">
		<label id="elh_hr_clients_address" for="x_address" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->address->caption() ?><?php echo ($hr_clients->address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->address->cellAttributes() ?>>
...
<?php if ($hr_clients->contact_number->Visible) { // contact_number ?>
	<div id="r_contact_number" class="form-group row">
		<label id="elh_hr_clients_contact_number" for="x_contact_number" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->contact_number->caption() ?><?php echo ($hr_clients->contact_number->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->contact_number->cellAttributes() ?>>
...
<?php if ($hr_clients->contact_email->Visible) { // contact_email ?>
	<div id="r_contact_email" class="form-group row">
		<label id="elh_hr_clients_contact_email" for="x_contact_email" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->contact_email->caption() ?><?php echo ($hr_clients->contact_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->contact_email->cellAttributes() ?>>
...
<?php if ($hr_clients->company_url->Visible) { // company_url ?>
	<div id="r_company_url" class="form-group row">
		<label id="elh_hr_clients_company_url" for="x_company_url" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->company_url->caption() ?><?php echo ($hr_clients->company_url->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->company_url->cellAttributes() ?>>
...
<?php if ($hr_clients->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_hr_clients_status" class="<?php echo $hr_clients_add->LeftColumnClass ?>"><?php echo $hr_clients->status->caption() ?><?php echo ($hr_clients->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_clients_add->RightColumnClass ?>"><div<?php echo $hr_clients->status->cellAttributes() ?>>
...
<?php if (!$hr_clients_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $hr_clients_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $hr_clients_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$hr_clients_add->showPageFooter();
if (DEBUG_ENABLED)
