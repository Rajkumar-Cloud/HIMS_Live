...
// Create page object
$employee_travel_records_edit = new employee_travel_records_edit();

// Run the page
$employee_travel_records_edit->run();
...
$employee_travel_records_edit->Page_Render();
?>
...
var femployee_travel_recordsedit = currentForm = new ew.Form("femployee_travel_recordsedit", "edit");
...
femployee_travel_recordsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_travel_records_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_travel_records->id->caption(), $employee_travel_records->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_travel_records_edit->employee->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->type->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->purpose->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->travel_from->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->travel_to->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->travel_date->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->return_date->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->funding->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->currency->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->attachment1->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->attachment2->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->attachment3->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_travel_records_edit->created->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->updated->Required) { ?>
		...
		<?php if ($employee_travel_records_edit->status->Required) { ?>
...
femployee_travel_recordsedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_travel_recordsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_travel_recordsedit.lists["x_type"] = <?php echo $employee_travel_records_edit->type->Lookup->toClientList() ?>;
femployee_travel_recordsedit.lists["x_type"].options = <?php echo JsonEncode($employee_travel_records_edit->type->options(FALSE, TRUE)) ?>;
femployee_travel_recordsedit.lists["x_status"] = <?php echo $employee_travel_records_edit->status->Lookup->toClientList() ?>;
femployee_travel_recordsedit.lists["x_status"].options = <?php echo JsonEncode($employee_travel_records_edit->status->options(FALSE, TRUE)) ?>;
...
<?php $employee_travel_records_edit->showPageHeader(); ?>
<?php
$employee_travel_records_edit->showMessage();
?>
<form name="femployee_travel_recordsedit" id="femployee_travel_recordsedit" class="<?php echo $employee_travel_records_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_travel_records_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_travel_records_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_travel_records">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$employee_travel_records_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($employee_travel_records->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_employee_travel_records_id" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->id->caption() ?><?php echo ($employee_travel_records->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->id->cellAttributes() ?>>
<span id="el_employee_travel_records_id">
<span<?php echo $employee_travel_records->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($employee_travel_records->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="employee_travel_records" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($employee_travel_records->id->CurrentValue) ?>">
<?php echo $employee_travel_records->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($employee_travel_records->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employee_travel_records_employee" for="x_employee" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->employee->caption() ?><?php echo ($employee_travel_records->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->employee->cellAttributes() ?>>
...
<?php if ($employee_travel_records->type->Visible) { // type ?>
	<div id="r_type" class="form-group row">
		<label id="elh_employee_travel_records_type" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->type->caption() ?><?php echo ($employee_travel_records->type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->type->cellAttributes() ?>>
...
<?php if ($employee_travel_records->purpose->Visible) { // purpose ?>
	<div id="r_purpose" class="form-group row">
		<label id="elh_employee_travel_records_purpose" for="x_purpose" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->purpose->caption() ?><?php echo ($employee_travel_records->purpose->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->purpose->cellAttributes() ?>>
...
<?php if ($employee_travel_records->travel_from->Visible) { // travel_from ?>
	<div id="r_travel_from" class="form-group row">
		<label id="elh_employee_travel_records_travel_from" for="x_travel_from" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->travel_from->caption() ?><?php echo ($employee_travel_records->travel_from->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->travel_from->cellAttributes() ?>>
...
<?php if ($employee_travel_records->travel_to->Visible) { // travel_to ?>
	<div id="r_travel_to" class="form-group row">
		<label id="elh_employee_travel_records_travel_to" for="x_travel_to" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->travel_to->caption() ?><?php echo ($employee_travel_records->travel_to->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->travel_to->cellAttributes() ?>>
...
<?php if ($employee_travel_records->travel_date->Visible) { // travel_date ?>
	<div id="r_travel_date" class="form-group row">
		<label id="elh_employee_travel_records_travel_date" for="x_travel_date" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->travel_date->caption() ?><?php echo ($employee_travel_records->travel_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->travel_date->cellAttributes() ?>>
...
<?php if ($employee_travel_records->return_date->Visible) { // return_date ?>
	<div id="r_return_date" class="form-group row">
		<label id="elh_employee_travel_records_return_date" for="x_return_date" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->return_date->caption() ?><?php echo ($employee_travel_records->return_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->return_date->cellAttributes() ?>>
...
<?php if ($employee_travel_records->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_employee_travel_records_details" for="x_details" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->details->caption() ?><?php echo ($employee_travel_records->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->details->cellAttributes() ?>>
...
<?php if ($employee_travel_records->funding->Visible) { // funding ?>
	<div id="r_funding" class="form-group row">
		<label id="elh_employee_travel_records_funding" for="x_funding" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->funding->caption() ?><?php echo ($employee_travel_records->funding->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->funding->cellAttributes() ?>>
...
<?php if ($employee_travel_records->currency->Visible) { // currency ?>
	<div id="r_currency" class="form-group row">
		<label id="elh_employee_travel_records_currency" for="x_currency" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->currency->caption() ?><?php echo ($employee_travel_records->currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->currency->cellAttributes() ?>>
...
<?php if ($employee_travel_records->attachment1->Visible) { // attachment1 ?>
	<div id="r_attachment1" class="form-group row">
		<label id="elh_employee_travel_records_attachment1" for="x_attachment1" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->attachment1->caption() ?><?php echo ($employee_travel_records->attachment1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->attachment1->cellAttributes() ?>>
...
<?php if ($employee_travel_records->attachment2->Visible) { // attachment2 ?>
	<div id="r_attachment2" class="form-group row">
		<label id="elh_employee_travel_records_attachment2" for="x_attachment2" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->attachment2->caption() ?><?php echo ($employee_travel_records->attachment2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->attachment2->cellAttributes() ?>>
...
<?php if ($employee_travel_records->attachment3->Visible) { // attachment3 ?>
	<div id="r_attachment3" class="form-group row">
		<label id="elh_employee_travel_records_attachment3" for="x_attachment3" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->attachment3->caption() ?><?php echo ($employee_travel_records->attachment3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->attachment3->cellAttributes() ?>>
...
<?php if ($employee_travel_records->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_employee_travel_records_created" for="x_created" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->created->caption() ?><?php echo ($employee_travel_records->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->created->cellAttributes() ?>>
...
<?php if ($employee_travel_records->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_employee_travel_records_updated" for="x_updated" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->updated->caption() ?><?php echo ($employee_travel_records->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->updated->cellAttributes() ?>>
...
<?php if ($employee_travel_records->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_travel_records_status" class="<?php echo $employee_travel_records_edit->LeftColumnClass ?>"><?php echo $employee_travel_records->status->caption() ?><?php echo ($employee_travel_records->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_travel_records_edit->RightColumnClass ?>"><div<?php echo $employee_travel_records->status->cellAttributes() ?>>
...
<?php if (!$employee_travel_records_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_travel_records_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_travel_records_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_travel_records_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_travel_records_edit->terminate();
?>