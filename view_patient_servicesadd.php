...
var fview_patient_servicesadd = currentForm = new ew.Form("fview_patient_servicesadd", "add");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
			...
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->Reception->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_patient_type");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->patient_type->errorMessage()) ?>");
		...
		<?php } ?>
			...
			if (elm && !ew.checkDateDef(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->charged_date->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_status");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->status->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_Aid");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->Aid->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_Vid");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->Vid->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_DrID");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($view_patient_services->DrID->errorMessage()) ?>");
...
fview_patient_servicesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_patient_servicesadd.lists["x_Services"] = <?php echo $view_patient_services_add->Services->Lookup->toClientList() ?>;
...
fview_patient_servicesadd.lists["x_DiscountCategory"] = <?php echo $view_patient_services_add->DiscountCategory->Lookup->toClientList() ?>;
...
<?php if ($view_patient_services_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_patient_services_add->Token ?>">
<?php } ?>
...
<?php if ($view_patient_services->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_view_patient_services_Reception" for="x_Reception" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Reception->caption() ?><?php echo ($view_patient_services->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Reception->cellAttributes() ?>>
<span id="el_view_patient_services_Reception">
<input type="text" data-table="view_patient_services" data-field="x_Reception" name="x_Reception" id="x_Reception" size="30" placeholder="<?php echo HtmlEncode($view_patient_services->Reception->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->Reception->EditValue ?>"<?php echo $view_patient_services->Reception->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_view_patient_services_mrnno" for="x_mrnno" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->mrnno->caption() ?><?php echo ($view_patient_services->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->mrnno->cellAttributes() ?>>
<span id="el_view_patient_services_mrnno">
<input type="text" data-table="view_patient_services" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->mrnno->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->mrnno->EditValue ?>"<?php echo $view_patient_services->mrnno->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_view_patient_services_PatientName" for="x_PatientName" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->PatientName->caption() ?><?php echo ($view_patient_services->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->PatientName->cellAttributes() ?>>
<span id="el_view_patient_services_PatientName">
<input type="text" data-table="view_patient_services" data-field="x_PatientName" name="x_PatientName" id="x_PatientName" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->PatientName->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->PatientName->EditValue ?>"<?php echo $view_patient_services->PatientName->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_view_patient_services_Age" for="x_Age" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Age->caption() ?><?php echo ($view_patient_services->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Age->cellAttributes() ?>>
<span id="el_view_patient_services_Age">
<input type="text" data-table="view_patient_services" data-field="x_Age" name="x_Age" id="x_Age" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->Age->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->Age->EditValue ?>"<?php echo $view_patient_services->Age->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_view_patient_services_Gender" for="x_Gender" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Gender->caption() ?><?php echo ($view_patient_services->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Gender->cellAttributes() ?>>
<span id="el_view_patient_services_Gender">
<input type="text" data-table="view_patient_services" data-field="x_Gender" name="x_Gender" id="x_Gender" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->Gender->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->Gender->EditValue ?>"<?php echo $view_patient_services->Gender->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_view_patient_services_profilePic" for="x_profilePic" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->profilePic->caption() ?><?php echo ($view_patient_services->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->profilePic->cellAttributes() ?>>
<span id="el_view_patient_services_profilePic">
<textarea data-table="view_patient_services" data-field="x_profilePic" name="x_profilePic" id="x_profilePic" cols="35" rows="4" placeholder="<?php echo HtmlEncode($view_patient_services->profilePic->getPlaceHolder()) ?>"<?php echo $view_patient_services->profilePic->editAttributes() ?>><?php echo $view_patient_services->profilePic->EditValue ?></textarea>
</span>
...
<?php if ($view_patient_services->Services->Visible) { // Services ?>
	<div id="r_Services" class="form-group row">
		<label id="elh_view_patient_services_Services" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Services->caption() ?><?php echo ($view_patient_services->Services->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Services->cellAttributes() ?>>
...
<?php if ($view_patient_services->Unit->Visible) { // Unit ?>
	<div id="r_Unit" class="form-group row">
		<label id="elh_view_patient_services_Unit" for="x_Unit" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Unit->caption() ?><?php echo ($view_patient_services->Unit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Unit->cellAttributes() ?>>
...
<?php if ($view_patient_services->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group row">
		<label id="elh_view_patient_services_amount" for="x_amount" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->amount->caption() ?><?php echo ($view_patient_services->amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->amount->cellAttributes() ?>>
...
<?php if ($view_patient_services->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_view_patient_services_Quantity" for="x_Quantity" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Quantity->caption() ?><?php echo ($view_patient_services->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Quantity->cellAttributes() ?>>
...
<?php if ($view_patient_services->DiscountCategory->Visible) { // DiscountCategory ?>
	<div id="r_DiscountCategory" class="form-group row">
		<label id="elh_view_patient_services_DiscountCategory" for="x_DiscountCategory" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DiscountCategory->caption() ?><?php echo ($view_patient_services->DiscountCategory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DiscountCategory->cellAttributes() ?>>
...
<?php if ($view_patient_services->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_view_patient_services_Discount" for="x_Discount" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Discount->caption() ?><?php echo ($view_patient_services->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Discount->cellAttributes() ?>>
...
<?php if ($view_patient_services->SubTotal->Visible) { // SubTotal ?>
	<div id="r_SubTotal" class="form-group row">
		<label id="elh_view_patient_services_SubTotal" for="x_SubTotal" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->SubTotal->caption() ?><?php echo ($view_patient_services->SubTotal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->SubTotal->cellAttributes() ?>>
...
<?php if ($view_patient_services->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_view_patient_services_description" for="x_description" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->description->caption() ?><?php echo ($view_patient_services->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->description->cellAttributes() ?>>
<span id="el_view_patient_services_description">
<textarea data-table="view_patient_services" data-field="x_description" name="x_description" id="x_description" cols="35" rows="4" placeholder="<?php echo HtmlEncode($view_patient_services->description->getPlaceHolder()) ?>"<?php echo $view_patient_services->description->editAttributes() ?>><?php echo $view_patient_services->description->EditValue ?></textarea>
</span>
...
<?php if ($view_patient_services->patient_type->Visible) { // patient_type ?>
	<div id="r_patient_type" class="form-group row">
		<label id="elh_view_patient_services_patient_type" for="x_patient_type" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->patient_type->caption() ?><?php echo ($view_patient_services->patient_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->patient_type->cellAttributes() ?>>
<span id="el_view_patient_services_patient_type">
<input type="text" data-table="view_patient_services" data-field="x_patient_type" name="x_patient_type" id="x_patient_type" size="30" placeholder="<?php echo HtmlEncode($view_patient_services->patient_type->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->patient_type->EditValue ?>"<?php echo $view_patient_services->patient_type->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->charged_date->Visible) { // charged_date ?>
	<div id="r_charged_date" class="form-group row">
		<label id="elh_view_patient_services_charged_date" for="x_charged_date" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->charged_date->caption() ?><?php echo ($view_patient_services->charged_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->charged_date->cellAttributes() ?>>
<span id="el_view_patient_services_charged_date">
<input type="text" data-table="view_patient_services" data-field="x_charged_date" name="x_charged_date" id="x_charged_date" placeholder="<?php echo HtmlEncode($view_patient_services->charged_date->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->charged_date->EditValue ?>"<?php echo $view_patient_services->charged_date->editAttributes() ?>>
...
<?php if ($view_patient_services->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_view_patient_services_status" for="x_status" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->status->caption() ?><?php echo ($view_patient_services->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->status->cellAttributes() ?>>
<span id="el_view_patient_services_status">
<input type="text" data-table="view_patient_services" data-field="x_status" name="x_status" id="x_status" size="30" placeholder="<?php echo HtmlEncode($view_patient_services->status->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->status->EditValue ?>"<?php echo $view_patient_services->status->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->Aid->Visible) { // Aid ?>
	<div id="r_Aid" class="form-group row">
		<label id="elh_view_patient_services_Aid" for="x_Aid" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Aid->caption() ?><?php echo ($view_patient_services->Aid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Aid->cellAttributes() ?>>
<span id="el_view_patient_services_Aid">
<input type="text" data-table="view_patient_services" data-field="x_Aid" name="x_Aid" id="x_Aid" size="30" placeholder="<?php echo HtmlEncode($view_patient_services->Aid->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->Aid->EditValue ?>"<?php echo $view_patient_services->Aid->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->Vid->Visible) { // Vid ?>
	<div id="r_Vid" class="form-group row">
		<label id="elh_view_patient_services_Vid" for="x_Vid" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Vid->caption() ?><?php echo ($view_patient_services->Vid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Vid->cellAttributes() ?>>
...
<input type="hidden" id="x_Vid" name="x_Vid" value="<?php echo HtmlEncode($view_patient_services->Vid->CurrentValue) ?>">
<?php } else { ?>
<span id="el_view_patient_services_Vid">
<input type="text" data-table="view_patient_services" data-field="x_Vid" name="x_Vid" id="x_Vid" size="30" placeholder="<?php echo HtmlEncode($view_patient_services->Vid->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->Vid->EditValue ?>"<?php echo $view_patient_services->Vid->editAttributes() ?>>
</span>
<?php } ?>
...
<?php if ($view_patient_services->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_view_patient_services_DrID" for="x_DrID" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrID->caption() ?><?php echo ($view_patient_services->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrID->cellAttributes() ?>>
<span id="el_view_patient_services_DrID">
<input type="text" data-table="view_patient_services" data-field="x_DrID" name="x_DrID" id="x_DrID" size="30" placeholder="<?php echo HtmlEncode($view_patient_services->DrID->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->DrID->EditValue ?>"<?php echo $view_patient_services->DrID->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->DrCODE->Visible) { // DrCODE ?>
	<div id="r_DrCODE" class="form-group row">
		<label id="elh_view_patient_services_DrCODE" for="x_DrCODE" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrCODE->caption() ?><?php echo ($view_patient_services->DrCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrCODE->cellAttributes() ?>>
<span id="el_view_patient_services_DrCODE">
<input type="text" data-table="view_patient_services" data-field="x_DrCODE" name="x_DrCODE" id="x_DrCODE" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->DrCODE->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->DrCODE->EditValue ?>"<?php echo $view_patient_services->DrCODE->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->DrName->Visible) { // DrName ?>
	<div id="r_DrName" class="form-group row">
		<label id="elh_view_patient_services_DrName" for="x_DrName" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrName->caption() ?><?php echo ($view_patient_services->DrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrName->cellAttributes() ?>>
<span id="el_view_patient_services_DrName">
<input type="text" data-table="view_patient_services" data-field="x_DrName" name="x_DrName" id="x_DrName" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->DrName->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->DrName->EditValue ?>"<?php echo $view_patient_services->DrName->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->Department->Visible) { // Department ?>
	<div id="r_Department" class="form-group row">
		<label id="elh_view_patient_services_Department" for="x_Department" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Department->caption() ?><?php echo ($view_patient_services->Department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Department->cellAttributes() ?>>
<span id="el_view_patient_services_Department">
<input type="text" data-table="view_patient_services" data-field="x_Department" name="x_Department" id="x_Department" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->Department->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->Department->EditValue ?>"<?php echo $view_patient_services->Department->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->DrSharePres->Visible) { // DrSharePres ?>
	<div id="r_DrSharePres" class="form-group row">
		<label id="elh_view_patient_services_DrSharePres" for="x_DrSharePres" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrSharePres->caption() ?><?php echo ($view_patient_services->DrSharePres->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrSharePres->cellAttributes() ?>>
...
<?php if ($view_patient_services->HospSharePres->Visible) { // HospSharePres ?>
	<div id="r_HospSharePres" class="form-group row">
		<label id="elh_view_patient_services_HospSharePres" for="x_HospSharePres" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->HospSharePres->caption() ?><?php echo ($view_patient_services->HospSharePres->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->HospSharePres->cellAttributes() ?>>
...
<?php if ($view_patient_services->DrShareAmount->Visible) { // DrShareAmount ?>
	<div id="r_DrShareAmount" class="form-group row">
		<label id="elh_view_patient_services_DrShareAmount" for="x_DrShareAmount" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrShareAmount->caption() ?><?php echo ($view_patient_services->DrShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrShareAmount->cellAttributes() ?>>
...
<?php if ($view_patient_services->HospShareAmount->Visible) { // HospShareAmount ?>
	<div id="r_HospShareAmount" class="form-group row">
		<label id="elh_view_patient_services_HospShareAmount" for="x_HospShareAmount" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->HospShareAmount->caption() ?><?php echo ($view_patient_services->HospShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->HospShareAmount->cellAttributes() ?>>
...
<?php if ($view_patient_services->DrShareSettiledAmount->Visible) { // DrShareSettiledAmount ?>
	<div id="r_DrShareSettiledAmount" class="form-group row">
		<label id="elh_view_patient_services_DrShareSettiledAmount" for="x_DrShareSettiledAmount" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrShareSettiledAmount->caption() ?><?php echo ($view_patient_services->DrShareSettiledAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrShareSettiledAmount->cellAttributes() ?>>
...
<?php if ($view_patient_services->DrShareSettledId->Visible) { // DrShareSettledId ?>
	<div id="r_DrShareSettledId" class="form-group row">
		<label id="elh_view_patient_services_DrShareSettledId" for="x_DrShareSettledId" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrShareSettledId->caption() ?><?php echo ($view_patient_services->DrShareSettledId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrShareSettledId->cellAttributes() ?>>
...
<?php if ($view_patient_services->DrShareSettiledStatus->Visible) { // DrShareSettiledStatus ?>
	<div id="r_DrShareSettiledStatus" class="form-group row">
		<label id="elh_view_patient_services_DrShareSettiledStatus" for="x_DrShareSettiledStatus" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DrShareSettiledStatus->caption() ?><?php echo ($view_patient_services->DrShareSettiledStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DrShareSettiledStatus->cellAttributes() ?>>
...
<?php if ($view_patient_services->invoiceId->Visible) { // invoiceId ?>
	<div id="r_invoiceId" class="form-group row">
		<label id="elh_view_patient_services_invoiceId" for="x_invoiceId" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->invoiceId->caption() ?><?php echo ($view_patient_services->invoiceId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->invoiceId->cellAttributes() ?>>
...
<?php if ($view_patient_services->invoiceAmount->Visible) { // invoiceAmount ?>
	<div id="r_invoiceAmount" class="form-group row">
		<label id="elh_view_patient_services_invoiceAmount" for="x_invoiceAmount" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->invoiceAmount->caption() ?><?php echo ($view_patient_services->invoiceAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->invoiceAmount->cellAttributes() ?>>
...
<?php if ($view_patient_services->invoiceStatus->Visible) { // invoiceStatus ?>
	<div id="r_invoiceStatus" class="form-group row">
		<label id="elh_view_patient_services_invoiceStatus" for="x_invoiceStatus" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->invoiceStatus->caption() ?><?php echo ($view_patient_services->invoiceStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->invoiceStatus->cellAttributes() ?>>
...
<?php if ($view_patient_services->modeOfPayment->Visible) { // modeOfPayment ?>
	<div id="r_modeOfPayment" class="form-group row">
		<label id="elh_view_patient_services_modeOfPayment" for="x_modeOfPayment" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->modeOfPayment->caption() ?><?php echo ($view_patient_services->modeOfPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->modeOfPayment->cellAttributes() ?>>
...
<?php if ($view_patient_services->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_view_patient_services_RIDNO" for="x_RIDNO" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->RIDNO->caption() ?><?php echo ($view_patient_services->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->RIDNO->cellAttributes() ?>>
...
<?php if ($view_patient_services->ItemCode->Visible) { // ItemCode ?>
	<div id="r_ItemCode" class="form-group row">
		<label id="elh_view_patient_services_ItemCode" for="x_ItemCode" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ItemCode->caption() ?><?php echo ($view_patient_services->ItemCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ItemCode->cellAttributes() ?>>
...
<?php if ($view_patient_services->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_view_patient_services_TidNo" for="x_TidNo" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->TidNo->caption() ?><?php echo ($view_patient_services->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->TidNo->cellAttributes() ?>>
...
<?php if ($view_patient_services->sid->Visible) { // sid ?>
	<div id="r_sid" class="form-group row">
		<label id="elh_view_patient_services_sid" for="x_sid" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->sid->caption() ?><?php echo ($view_patient_services->sid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->sid->cellAttributes() ?>>
...
<?php if ($view_patient_services->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_view_patient_services_TestSubCd" for="x_TestSubCd" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->TestSubCd->caption() ?><?php echo ($view_patient_services->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->TestSubCd->cellAttributes() ?>>
...
<?php if ($view_patient_services->DEptCd->Visible) { // DEptCd ?>
	<div id="r_DEptCd" class="form-group row">
		<label id="elh_view_patient_services_DEptCd" for="x_DEptCd" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DEptCd->caption() ?><?php echo ($view_patient_services->DEptCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DEptCd->cellAttributes() ?>>
...
<?php if ($view_patient_services->ProfCd->Visible) { // ProfCd ?>
	<div id="r_ProfCd" class="form-group row">
		<label id="elh_view_patient_services_ProfCd" for="x_ProfCd" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ProfCd->caption() ?><?php echo ($view_patient_services->ProfCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ProfCd->cellAttributes() ?>>
...
<?php if ($view_patient_services->LabReport->Visible) { // LabReport ?>
	<div id="r_LabReport" class="form-group row">
		<label id="elh_view_patient_services_LabReport" for="x_LabReport" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->LabReport->caption() ?><?php echo ($view_patient_services->LabReport->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->LabReport->cellAttributes() ?>>
...
<?php if ($view_patient_services->Comments->Visible) { // Comments ?>
	<div id="r_Comments" class="form-group row">
		<label id="elh_view_patient_services_Comments" for="x_Comments" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Comments->caption() ?><?php echo ($view_patient_services->Comments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Comments->cellAttributes() ?>>
...
<?php if ($view_patient_services->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_view_patient_services_Method" for="x_Method" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Method->caption() ?><?php echo ($view_patient_services->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Method->cellAttributes() ?>>
...
<?php if ($view_patient_services->Specimen->Visible) { // Specimen ?>
	<div id="r_Specimen" class="form-group row">
		<label id="elh_view_patient_services_Specimen" for="x_Specimen" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Specimen->caption() ?><?php echo ($view_patient_services->Specimen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Specimen->cellAttributes() ?>>
...
<?php if ($view_patient_services->Abnormal->Visible) { // Abnormal ?>
	<div id="r_Abnormal" class="form-group row">
		<label id="elh_view_patient_services_Abnormal" for="x_Abnormal" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Abnormal->caption() ?><?php echo ($view_patient_services->Abnormal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Abnormal->cellAttributes() ?>>
...
<?php if ($view_patient_services->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_view_patient_services_RefValue" for="x_RefValue" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->RefValue->caption() ?><?php echo ($view_patient_services->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->RefValue->cellAttributes() ?>>
...
<?php if ($view_patient_services->TestUnit->Visible) { // TestUnit ?>
	<div id="r_TestUnit" class="form-group row">
		<label id="elh_view_patient_services_TestUnit" for="x_TestUnit" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->TestUnit->caption() ?><?php echo ($view_patient_services->TestUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->TestUnit->cellAttributes() ?>>
...
<?php if ($view_patient_services->LOWHIGH->Visible) { // LOWHIGH ?>
	<div id="r_LOWHIGH" class="form-group row">
		<label id="elh_view_patient_services_LOWHIGH" for="x_LOWHIGH" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->LOWHIGH->caption() ?><?php echo ($view_patient_services->LOWHIGH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->LOWHIGH->cellAttributes() ?>>
...
<?php if ($view_patient_services->Branch->Visible) { // Branch ?>
	<div id="r_Branch" class="form-group row">
		<label id="elh_view_patient_services_Branch" for="x_Branch" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Branch->caption() ?><?php echo ($view_patient_services->Branch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Branch->cellAttributes() ?>>
...
<?php if ($view_patient_services->Dispatch->Visible) { // Dispatch ?>
	<div id="r_Dispatch" class="form-group row">
		<label id="elh_view_patient_services_Dispatch" for="x_Dispatch" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Dispatch->caption() ?><?php echo ($view_patient_services->Dispatch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Dispatch->cellAttributes() ?>>
...
<?php if ($view_patient_services->Pic1->Visible) { // Pic1 ?>
	<div id="r_Pic1" class="form-group row">
		<label id="elh_view_patient_services_Pic1" for="x_Pic1" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Pic1->caption() ?><?php echo ($view_patient_services->Pic1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Pic1->cellAttributes() ?>>
...
<?php if ($view_patient_services->Pic2->Visible) { // Pic2 ?>
	<div id="r_Pic2" class="form-group row">
		<label id="elh_view_patient_services_Pic2" for="x_Pic2" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Pic2->caption() ?><?php echo ($view_patient_services->Pic2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Pic2->cellAttributes() ?>>
...
<?php if ($view_patient_services->GraphPath->Visible) { // GraphPath ?>
	<div id="r_GraphPath" class="form-group row">
		<label id="elh_view_patient_services_GraphPath" for="x_GraphPath" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->GraphPath->caption() ?><?php echo ($view_patient_services->GraphPath->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->GraphPath->cellAttributes() ?>>
...
<?php if ($view_patient_services->MachineCD->Visible) { // MachineCD ?>
	<div id="r_MachineCD" class="form-group row">
		<label id="elh_view_patient_services_MachineCD" for="x_MachineCD" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->MachineCD->caption() ?><?php echo ($view_patient_services->MachineCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->MachineCD->cellAttributes() ?>>
...
<?php if ($view_patient_services->TestCancel->Visible) { // TestCancel ?>
	<div id="r_TestCancel" class="form-group row">
		<label id="elh_view_patient_services_TestCancel" for="x_TestCancel" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->TestCancel->caption() ?><?php echo ($view_patient_services->TestCancel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->TestCancel->cellAttributes() ?>>
...
<?php if ($view_patient_services->OutSource->Visible) { // OutSource ?>
	<div id="r_OutSource" class="form-group row">
		<label id="elh_view_patient_services_OutSource" for="x_OutSource" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->OutSource->caption() ?><?php echo ($view_patient_services->OutSource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->OutSource->cellAttributes() ?>>
...
<?php if ($view_patient_services->Printed->Visible) { // Printed ?>
	<div id="r_Printed" class="form-group row">
		<label id="elh_view_patient_services_Printed" for="x_Printed" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Printed->caption() ?><?php echo ($view_patient_services->Printed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Printed->cellAttributes() ?>>
...
<?php if ($view_patient_services->PrintBy->Visible) { // PrintBy ?>
	<div id="r_PrintBy" class="form-group row">
		<label id="elh_view_patient_services_PrintBy" for="x_PrintBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->PrintBy->caption() ?><?php echo ($view_patient_services->PrintBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->PrintBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->PrintDate->Visible) { // PrintDate ?>
	<div id="r_PrintDate" class="form-group row">
		<label id="elh_view_patient_services_PrintDate" for="x_PrintDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->PrintDate->caption() ?><?php echo ($view_patient_services->PrintDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->PrintDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->BillingDate->Visible) { // BillingDate ?>
	<div id="r_BillingDate" class="form-group row">
		<label id="elh_view_patient_services_BillingDate" for="x_BillingDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->BillingDate->caption() ?><?php echo ($view_patient_services->BillingDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->BillingDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->BilledBy->Visible) { // BilledBy ?>
	<div id="r_BilledBy" class="form-group row">
		<label id="elh_view_patient_services_BilledBy" for="x_BilledBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->BilledBy->caption() ?><?php echo ($view_patient_services->BilledBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->BilledBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->Resulted->Visible) { // Resulted ?>
	<div id="r_Resulted" class="form-group row">
		<label id="elh_view_patient_services_Resulted" for="x_Resulted" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Resulted->caption() ?><?php echo ($view_patient_services->Resulted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Resulted->cellAttributes() ?>>
...
<?php if ($view_patient_services->ResultDate->Visible) { // ResultDate ?>
	<div id="r_ResultDate" class="form-group row">
		<label id="elh_view_patient_services_ResultDate" for="x_ResultDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ResultDate->caption() ?><?php echo ($view_patient_services->ResultDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ResultDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->ResultedBy->Visible) { // ResultedBy ?>
	<div id="r_ResultedBy" class="form-group row">
		<label id="elh_view_patient_services_ResultedBy" for="x_ResultedBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ResultedBy->caption() ?><?php echo ($view_patient_services->ResultedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ResultedBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->SampleDate->Visible) { // SampleDate ?>
	<div id="r_SampleDate" class="form-group row">
		<label id="elh_view_patient_services_SampleDate" for="x_SampleDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->SampleDate->caption() ?><?php echo ($view_patient_services->SampleDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->SampleDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->SampleUser->Visible) { // SampleUser ?>
	<div id="r_SampleUser" class="form-group row">
		<label id="elh_view_patient_services_SampleUser" for="x_SampleUser" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->SampleUser->caption() ?><?php echo ($view_patient_services->SampleUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->SampleUser->cellAttributes() ?>>
...
<?php if ($view_patient_services->Sampled->Visible) { // Sampled ?>
	<div id="r_Sampled" class="form-group row">
		<label id="elh_view_patient_services_Sampled" for="x_Sampled" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Sampled->caption() ?><?php echo ($view_patient_services->Sampled->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Sampled->cellAttributes() ?>>
...
<?php if ($view_patient_services->ReceivedDate->Visible) { // ReceivedDate ?>
	<div id="r_ReceivedDate" class="form-group row">
		<label id="elh_view_patient_services_ReceivedDate" for="x_ReceivedDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ReceivedDate->caption() ?><?php echo ($view_patient_services->ReceivedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ReceivedDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->ReceivedUser->Visible) { // ReceivedUser ?>
	<div id="r_ReceivedUser" class="form-group row">
		<label id="elh_view_patient_services_ReceivedUser" for="x_ReceivedUser" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ReceivedUser->caption() ?><?php echo ($view_patient_services->ReceivedUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ReceivedUser->cellAttributes() ?>>
...
<?php if ($view_patient_services->Recevied->Visible) { // Recevied ?>
	<div id="r_Recevied" class="form-group row">
		<label id="elh_view_patient_services_Recevied" for="x_Recevied" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Recevied->caption() ?><?php echo ($view_patient_services->Recevied->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Recevied->cellAttributes() ?>>
...
<?php if ($view_patient_services->DeptRecvDate->Visible) { // DeptRecvDate ?>
	<div id="r_DeptRecvDate" class="form-group row">
		<label id="elh_view_patient_services_DeptRecvDate" for="x_DeptRecvDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DeptRecvDate->caption() ?><?php echo ($view_patient_services->DeptRecvDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DeptRecvDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->DeptRecvUser->Visible) { // DeptRecvUser ?>
	<div id="r_DeptRecvUser" class="form-group row">
		<label id="elh_view_patient_services_DeptRecvUser" for="x_DeptRecvUser" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DeptRecvUser->caption() ?><?php echo ($view_patient_services->DeptRecvUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DeptRecvUser->cellAttributes() ?>>
...
<?php if ($view_patient_services->DeptRecived->Visible) { // DeptRecived ?>
	<div id="r_DeptRecived" class="form-group row">
		<label id="elh_view_patient_services_DeptRecived" for="x_DeptRecived" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->DeptRecived->caption() ?><?php echo ($view_patient_services->DeptRecived->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->DeptRecived->cellAttributes() ?>>
...
<?php if ($view_patient_services->SAuthDate->Visible) { // SAuthDate ?>
	<div id="r_SAuthDate" class="form-group row">
		<label id="elh_view_patient_services_SAuthDate" for="x_SAuthDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->SAuthDate->caption() ?><?php echo ($view_patient_services->SAuthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->SAuthDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->SAuthBy->Visible) { // SAuthBy ?>
	<div id="r_SAuthBy" class="form-group row">
		<label id="elh_view_patient_services_SAuthBy" for="x_SAuthBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->SAuthBy->caption() ?><?php echo ($view_patient_services->SAuthBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->SAuthBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->SAuthendicate->Visible) { // SAuthendicate ?>
	<div id="r_SAuthendicate" class="form-group row">
		<label id="elh_view_patient_services_SAuthendicate" for="x_SAuthendicate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->SAuthendicate->caption() ?><?php echo ($view_patient_services->SAuthendicate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->SAuthendicate->cellAttributes() ?>>
...
<?php if ($view_patient_services->AuthDate->Visible) { // AuthDate ?>
	<div id="r_AuthDate" class="form-group row">
		<label id="elh_view_patient_services_AuthDate" for="x_AuthDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->AuthDate->caption() ?><?php echo ($view_patient_services->AuthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->AuthDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->AuthBy->Visible) { // AuthBy ?>
	<div id="r_AuthBy" class="form-group row">
		<label id="elh_view_patient_services_AuthBy" for="x_AuthBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->AuthBy->caption() ?><?php echo ($view_patient_services->AuthBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->AuthBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->Authencate->Visible) { // Authencate ?>
	<div id="r_Authencate" class="form-group row">
		<label id="elh_view_patient_services_Authencate" for="x_Authencate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Authencate->caption() ?><?php echo ($view_patient_services->Authencate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Authencate->cellAttributes() ?>>
...
<?php if ($view_patient_services->EditDate->Visible) { // EditDate ?>
	<div id="r_EditDate" class="form-group row">
		<label id="elh_view_patient_services_EditDate" for="x_EditDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->EditDate->caption() ?><?php echo ($view_patient_services->EditDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->EditDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->EditBy->Visible) { // EditBy ?>
	<div id="r_EditBy" class="form-group row">
		<label id="elh_view_patient_services_EditBy" for="x_EditBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->EditBy->caption() ?><?php echo ($view_patient_services->EditBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->EditBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->Editted->Visible) { // Editted ?>
	<div id="r_Editted" class="form-group row">
		<label id="elh_view_patient_services_Editted" for="x_Editted" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Editted->caption() ?><?php echo ($view_patient_services->Editted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Editted->cellAttributes() ?>>
...
<?php if ($view_patient_services->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_view_patient_services_PatID" for="x_PatID" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->PatID->caption() ?><?php echo ($view_patient_services->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->PatID->cellAttributes() ?>>
...
<?php if ($view_patient_services->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_view_patient_services_PatientId" for="x_PatientId" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->PatientId->caption() ?><?php echo ($view_patient_services->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->PatientId->cellAttributes() ?>>
...
<?php if ($view_patient_services->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_view_patient_services_Mobile" for="x_Mobile" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Mobile->caption() ?><?php echo ($view_patient_services->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Mobile->cellAttributes() ?>>
...
<?php if ($view_patient_services->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_view_patient_services_CId" for="x_CId" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->CId->caption() ?><?php echo ($view_patient_services->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->CId->cellAttributes() ?>>
...
<?php if ($view_patient_services->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_view_patient_services_Order" for="x_Order" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Order->caption() ?><?php echo ($view_patient_services->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Order->cellAttributes() ?>>
...
<?php if ($view_patient_services->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_view_patient_services_Form" for="x_Form" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Form->caption() ?><?php echo ($view_patient_services->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Form->cellAttributes() ?>>
...
<?php if ($view_patient_services->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_view_patient_services_ResType" for="x_ResType" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->ResType->caption() ?><?php echo ($view_patient_services->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->ResType->cellAttributes() ?>>
...
<?php if ($view_patient_services->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_view_patient_services_Sample" for="x_Sample" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Sample->caption() ?><?php echo ($view_patient_services->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Sample->cellAttributes() ?>>
...
<?php if ($view_patient_services->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_view_patient_services_NoD" for="x_NoD" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->NoD->caption() ?><?php echo ($view_patient_services->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->NoD->cellAttributes() ?>>
...
<?php if ($view_patient_services->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_view_patient_services_BillOrder" for="x_BillOrder" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->BillOrder->caption() ?><?php echo ($view_patient_services->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->BillOrder->cellAttributes() ?>>
...
<?php if ($view_patient_services->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_view_patient_services_Formula" for="x_Formula" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Formula->caption() ?><?php echo ($view_patient_services->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Formula->cellAttributes() ?>>
...
<?php if ($view_patient_services->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_view_patient_services_Inactive" for="x_Inactive" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Inactive->caption() ?><?php echo ($view_patient_services->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Inactive->cellAttributes() ?>>
...
<?php if ($view_patient_services->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_view_patient_services_CollSample" for="x_CollSample" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->CollSample->caption() ?><?php echo ($view_patient_services->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->CollSample->cellAttributes() ?>>
...
<?php if ($view_patient_services->TestType->Visible) { // TestType ?>
	<div id="r_TestType" class="form-group row">
		<label id="elh_view_patient_services_TestType" for="x_TestType" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->TestType->caption() ?><?php echo ($view_patient_services->TestType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->TestType->cellAttributes() ?>>
<span id="el_view_patient_services_TestType">
<input type="text" data-table="view_patient_services" data-field="x_TestType" name="x_TestType" id="x_TestType" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($view_patient_services->TestType->getPlaceHolder()) ?>" value="<?php echo $view_patient_services->TestType->EditValue ?>"<?php echo $view_patient_services->TestType->editAttributes() ?>>
</span>
...
<?php if ($view_patient_services->Repeated->Visible) { // Repeated ?>
	<div id="r_Repeated" class="form-group row">
		<label id="elh_view_patient_services_Repeated" for="x_Repeated" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Repeated->caption() ?><?php echo ($view_patient_services->Repeated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Repeated->cellAttributes() ?>>
...
<?php if ($view_patient_services->RepeatedBy->Visible) { // RepeatedBy ?>
	<div id="r_RepeatedBy" class="form-group row">
		<label id="elh_view_patient_services_RepeatedBy" for="x_RepeatedBy" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->RepeatedBy->caption() ?><?php echo ($view_patient_services->RepeatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->RepeatedBy->cellAttributes() ?>>
...
<?php if ($view_patient_services->RepeatedDate->Visible) { // RepeatedDate ?>
	<div id="r_RepeatedDate" class="form-group row">
		<label id="elh_view_patient_services_RepeatedDate" for="x_RepeatedDate" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->RepeatedDate->caption() ?><?php echo ($view_patient_services->RepeatedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->RepeatedDate->cellAttributes() ?>>
...
<?php if ($view_patient_services->serviceID->Visible) { // serviceID ?>
	<div id="r_serviceID" class="form-group row">
		<label id="elh_view_patient_services_serviceID" for="x_serviceID" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->serviceID->caption() ?><?php echo ($view_patient_services->serviceID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->serviceID->cellAttributes() ?>>
...
<?php if ($view_patient_services->Service_Type->Visible) { // Service_Type ?>
	<div id="r_Service_Type" class="form-group row">
		<label id="elh_view_patient_services_Service_Type" for="x_Service_Type" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Service_Type->caption() ?><?php echo ($view_patient_services->Service_Type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Service_Type->cellAttributes() ?>>
...
<?php if ($view_patient_services->Service_Department->Visible) { // Service_Department ?>
	<div id="r_Service_Department" class="form-group row">
		<label id="elh_view_patient_services_Service_Department" for="x_Service_Department" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->Service_Department->caption() ?><?php echo ($view_patient_services->Service_Department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->Service_Department->cellAttributes() ?>>
...
<?php if ($view_patient_services->RequestNo->Visible) { // RequestNo ?>
	<div id="r_RequestNo" class="form-group row">
		<label id="elh_view_patient_services_RequestNo" for="x_RequestNo" class="<?php echo $view_patient_services_add->LeftColumnClass ?>"><?php echo $view_patient_services->RequestNo->caption() ?><?php echo ($view_patient_services->RequestNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_patient_services_add->RightColumnClass ?>"><div<?php echo $view_patient_services->RequestNo->cellAttributes() ?>>
