...
var fpres_mas_routeadd = currentForm = new ew.Form("fpres_mas_routeadd", "add");
...
fpres_mas_routeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_mas_route_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_mas_route_add->Token ?>">
<?php } ?>
...
<?php if ($pres_mas_route->_Route->Visible) { // Route ?>
	<div id="r__Route" class="form-group row">
		<label id="elh_pres_mas_route__Route" for="x__Route" class="<?php echo $pres_mas_route_add->LeftColumnClass ?>"><?php echo $pres_mas_route->_Route->caption() ?><?php echo ($pres_mas_route->_Route->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_mas_route_add->RightColumnClass ?>"><div<?php echo $pres_mas_route->_Route->cellAttributes() ?>>
