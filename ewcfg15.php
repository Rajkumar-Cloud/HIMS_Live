...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "HIMS"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'DzpIwtjdg27xW39u'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/HIMS.css"); // Project stylesheet file name
...
$PROJECT_ID = "{EA4F6D13-AF8F-428D-9EA7-BA88D1107EC3}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$JAVASCRIPT_FILES = [];
$JAVASCRIPT_FILES[] = "customized\\lightWeightPopup\\lightWeightPopup.js";

// External StyleSheets
$STYLESHEET_FILES = [];
$STYLESHEET_FILES[] = "Font-Awesome\\Font-Awesome\\css\\all.css";
$STYLESHEET_FILES[] = "Font-Awesome\\Font-Awesome\\css\\font-awesome-animation.css";
$STYLESHEET_FILES[] = "customized\\lightWeightPopup\\lightweightpopup.css";
 ...
 */
define(PROJECT_NAMESPACE . "DB_TIME_ZONE", "Asia/Kolkata");
...
define(PROJECT_NAMESPACE . "SESSION_TIMEOUT", 600); // Session timeout time (minutes)

// Session keep alive interval
define(PROJECT_NAMESPACE . "SESSION_KEEP_ALIVE_INTERVAL", 0); // Session keep alive interval (seconds)
define(PROJECT_NAMESPACE . "SESSION_TIMEOUT_COUNTDOWN", 600); // Session timeout count down interval (seconds)
...
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "admin123"); // Administrator password
...
define(PROJECT_NAMESPACE . "USER_LEVEL_ID_FIELD", "`id`");
define(PROJECT_NAMESPACE . "USER_LEVEL_NAME_FIELD", "`UserLevelsName`");
...
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "`id`");
define(PROJECT_NAMESPACE . "USER_LEVEL_PRIV_PRIV_FIELD", "`Permissions`");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "user_login");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "mail_id");
...
define(PROJECT_NAMESPACE . "USER_PROFILE_FIELD_NAME", "profilefield");
define(PROJECT_NAMESPACE . "REGISTER_ACTIVATE_FIELD_NAME", "email_verified");
define(PROJECT_NAMESPACE . "USER_EMAIL_FIELD_NAME", "mail_id");

// User table filters
define(PROJECT_NAMESPACE . "USER_TABLE_DBID", "DB");
define(PROJECT_NAMESPACE . "USER_TABLE", "`user_login`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`mail_id` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "");
define(PROJECT_NAMESPACE . "USER_EMAIL_FILTER", "(`mail_id` = '%e')");
...
define(PROJECT_NAMESPACE . "USER_PROFILE_CONCURRENT_SESSION_COUNT", 10); // Maximum sessions allowed
define(PROJECT_NAMESPACE . "USER_PROFILE_SESSION_TIMEOUT", 200);
...
define(PROJECT_NAMESPACE . "USER_PROFILE_MAX_RETRY", 30);
...
define(PROJECT_NAMESPACE . "USER_PROFILE_PASSWORD_EXPIRE", 900);
...
define(PROJECT_NAMESPACE . "SMTP_SERVER_USERNAME", "support@a4hospital.com"); // SMTP server user name
define(PROJECT_NAMESPACE . "SMTP_SERVER_PASSWORD", "1234"); // SMTP server password
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "support@a4hospital.com"); // Sender email address
define(PROJECT_NAMESPACE . "RECIPIENT_EMAIL", "support@a4hospital.com"); // Recipient email address
...
define(PROJECT_NAMESPACE . "PDF_TIME_LIMIT", 1200); // Time limit
?>