...
var fview_ip_patient_admissionadd = currentForm = new ew.Form("fview_ip_patient_admissionadd", "add");
...
fview_ip_patient_admissionadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_ip_patient_admissionadd.lists["x_typeRegsisteration"] = <?php echo $view_ip_patient_admission_add->typeRegsisteration->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_PaymentCategory"] = <?php echo $view_ip_patient_admission_add->PaymentCategory->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_PaymentStatus"] = <?php echo $view_ip_patient_admission_add->PaymentStatus->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_HospID"] = <?php echo $view_ip_patient_admission_add->HospID->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_ReferedByDr"] = <?php echo $view_ip_patient_admission_add->ReferedByDr->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_BillClosing[]"] = <?php echo $view_ip_patient_admission_add->BillClosing->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_ReportHeader[]"] = <?php echo $view_ip_patient_admission_add->ReportHeader->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_Procedure"] = <?php echo $view_ip_patient_admission_add->Procedure->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_Consultant"] = <?php echo $view_ip_patient_admission_add->Consultant->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_Anesthetist"] = <?php echo $view_ip_patient_admission_add->Anesthetist->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_physician_id"] = <?php echo $view_ip_patient_admission_add->physician_id->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_patient_id"] = <?php echo $view_ip_patient_admission_add->patient_id->Lookup->toClientList() ?>;
...
fview_ip_patient_admissionadd.lists["x_Cid"] = <?php echo $view_ip_patient_admission_add->Cid->Lookup->toClientList() ?>;
fview_ip_patient_admissionadd.lists["x_Cid"].options = <?php echo JsonEncode($view_ip_patient_admission_add->Cid->lookupOptions()) ?>;
fview_ip_patient_admissionadd.lists["x_AdviceToOtherHospital[]"] = <?php echo $view_ip_patient_admission_add->AdviceToOtherHospital->Lookup->toClientList() ?>;
...
<?php if ($view_ip_patient_admission_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_ip_patient_admission_add->Token ?>">
<?php } ?>
...
<?php if ($view_ip_patient_admission->mrnNo->Visible) { // mrnNo ?>
	<div id="r_mrnNo" class="form-group row">
		<label id="elh_view_ip_patient_admission_mrnNo" for="x_mrnNo" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_mrnNo" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->mrnNo->caption() ?><?php echo ($view_ip_patient_admission->mrnNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->mrnNo->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_mrnNo" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_view_ip_patient_admission_PatientID" for="x_PatientID" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PatientID" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PatientID->caption() ?><?php echo ($view_ip_patient_admission->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PatientID->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PatientID" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->patient_name->Visible) { // patient_name ?>
	<div id="r_patient_name" class="form-group row">
		<label id="elh_view_ip_patient_admission_patient_name" for="x_patient_name" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_patient_name" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->patient_name->caption() ?><?php echo ($view_ip_patient_admission->patient_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->patient_name->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_patient_name" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->mobileno->Visible) { // mobileno ?>
	<div id="r_mobileno" class="form-group row">
		<label id="elh_view_ip_patient_admission_mobileno" for="x_mobileno" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_mobileno" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->mobileno->caption() ?><?php echo ($view_ip_patient_admission->mobileno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->mobileno->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_mobileno" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_view_ip_patient_admission_profilePic" for="x_profilePic" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_profilePic" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->profilePic->caption() ?><?php echo ($view_ip_patient_admission->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->profilePic->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_profilePic" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_view_ip_patient_admission_gender" for="x_gender" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_gender" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->gender->caption() ?><?php echo ($view_ip_patient_admission->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->gender->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_gender" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->age->Visible) { // age ?>
	<div id="r_age" class="form-group row">
		<label id="elh_view_ip_patient_admission_age" for="x_age" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_age" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->age->caption() ?><?php echo ($view_ip_patient_admission->age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->age->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_age" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Package->Visible) { // Package ?>
	<div id="r_Package" class="form-group row">
		<label id="elh_view_ip_patient_admission_Package" for="x_Package" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Package" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Package->caption() ?><?php echo ($view_ip_patient_admission->Package->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Package->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Package" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->typeRegsisteration->Visible) { // typeRegsisteration ?>
	<div id="r_typeRegsisteration" class="form-group row">
		<label id="elh_view_ip_patient_admission_typeRegsisteration" for="x_typeRegsisteration" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_typeRegsisteration" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->typeRegsisteration->caption() ?><?php echo ($view_ip_patient_admission->typeRegsisteration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->typeRegsisteration->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_typeRegsisteration" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PaymentCategory->Visible) { // PaymentCategory ?>
	<div id="r_PaymentCategory" class="form-group row">
		<label id="elh_view_ip_patient_admission_PaymentCategory" for="x_PaymentCategory" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PaymentCategory" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PaymentCategory->caption() ?><?php echo ($view_ip_patient_admission->PaymentCategory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PaymentCategory->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PaymentCategory" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->admission_consultant_id->Visible) { // admission_consultant_id ?>
	<div id="r_admission_consultant_id" class="form-group row">
		<label id="elh_view_ip_patient_admission_admission_consultant_id" for="x_admission_consultant_id" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_admission_consultant_id" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->admission_consultant_id->caption() ?><?php echo ($view_ip_patient_admission->admission_consultant_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->admission_consultant_id->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_admission_consultant_id" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->leading_consultant_id->Visible) { // leading_consultant_id ?>
	<div id="r_leading_consultant_id" class="form-group row">
		<label id="elh_view_ip_patient_admission_leading_consultant_id" for="x_leading_consultant_id" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_leading_consultant_id" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->leading_consultant_id->caption() ?><?php echo ($view_ip_patient_admission->leading_consultant_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->leading_consultant_id->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_leading_consultant_id" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->cause->Visible) { // cause ?>
	<div id="r_cause" class="form-group row">
		<label id="elh_view_ip_patient_admission_cause" for="x_cause" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_cause" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->cause->caption() ?><?php echo ($view_ip_patient_admission->cause->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->cause->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_cause" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->admission_date->Visible) { // admission_date ?>
	<div id="r_admission_date" class="form-group row">
		<label id="elh_view_ip_patient_admission_admission_date" for="x_admission_date" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_admission_date" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->admission_date->caption() ?><?php echo ($view_ip_patient_admission->admission_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->admission_date->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_admission_date" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->release_date->Visible) { // release_date ?>
	<div id="r_release_date" class="form-group row">
		<label id="elh_view_ip_patient_admission_release_date" for="x_release_date" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_release_date" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->release_date->caption() ?><?php echo ($view_ip_patient_admission->release_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->release_date->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_release_date" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PaymentStatus->Visible) { // PaymentStatus ?>
	<div id="r_PaymentStatus" class="form-group row">
		<label id="elh_view_ip_patient_admission_PaymentStatus" for="x_PaymentStatus" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PaymentStatus" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PaymentStatus->caption() ?><?php echo ($view_ip_patient_admission->PaymentStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PaymentStatus->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PaymentStatus" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_view_ip_patient_admission_status" for="x_status" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_status" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->status->caption() ?><?php echo ($view_ip_patient_admission->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->status->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_status" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ReferedByDr->Visible) { // ReferedByDr ?>
	<div id="r_ReferedByDr" class="form-group row">
		<label id="elh_view_ip_patient_admission_ReferedByDr" for="x_ReferedByDr" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ReferedByDr" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ReferedByDr->caption() ?><?php echo ($view_ip_patient_admission->ReferedByDr->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ReferedByDr->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ReferedByDr" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ReferClinicname->Visible) { // ReferClinicname ?>
	<div id="r_ReferClinicname" class="form-group row">
		<label id="elh_view_ip_patient_admission_ReferClinicname" for="x_ReferClinicname" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ReferClinicname" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ReferClinicname->caption() ?><?php echo ($view_ip_patient_admission->ReferClinicname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ReferClinicname->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ReferClinicname" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ReferCity->Visible) { // ReferCity ?>
	<div id="r_ReferCity" class="form-group row">
		<label id="elh_view_ip_patient_admission_ReferCity" for="x_ReferCity" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ReferCity" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ReferCity->caption() ?><?php echo ($view_ip_patient_admission->ReferCity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ReferCity->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ReferCity" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ReferMobileNo->Visible) { // ReferMobileNo ?>
	<div id="r_ReferMobileNo" class="form-group row">
		<label id="elh_view_ip_patient_admission_ReferMobileNo" for="x_ReferMobileNo" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ReferMobileNo" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ReferMobileNo->caption() ?><?php echo ($view_ip_patient_admission->ReferMobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ReferMobileNo->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ReferMobileNo" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ReferA4TreatingConsultant->Visible) { // ReferA4TreatingConsultant ?>
	<div id="r_ReferA4TreatingConsultant" class="form-group row">
		<label id="elh_view_ip_patient_admission_ReferA4TreatingConsultant" for="x_ReferA4TreatingConsultant" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ReferA4TreatingConsultant" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ReferA4TreatingConsultant->caption() ?><?php echo ($view_ip_patient_admission->ReferA4TreatingConsultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ReferA4TreatingConsultant->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ReferA4TreatingConsultant" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PurposreReferredfor->Visible) { // PurposreReferredfor ?>
	<div id="r_PurposreReferredfor" class="form-group row">
		<label id="elh_view_ip_patient_admission_PurposreReferredfor" for="x_PurposreReferredfor" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PurposreReferredfor" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PurposreReferredfor->caption() ?><?php echo ($view_ip_patient_admission->PurposreReferredfor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PurposreReferredfor->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PurposreReferredfor" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->BillClosing->Visible) { // BillClosing ?>
	<div id="r_BillClosing" class="form-group row">
		<label id="elh_view_ip_patient_admission_BillClosing" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_BillClosing" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->BillClosing->caption() ?><?php echo ($view_ip_patient_admission->BillClosing->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->BillClosing->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_BillClosing" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->BillClosingDate->Visible) { // BillClosingDate ?>
	<div id="r_BillClosingDate" class="form-group row">
		<label id="elh_view_ip_patient_admission_BillClosingDate" for="x_BillClosingDate" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_BillClosingDate" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->BillClosingDate->caption() ?><?php echo ($view_ip_patient_admission->BillClosingDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->BillClosingDate->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_BillClosingDate" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_view_ip_patient_admission_BillNumber" for="x_BillNumber" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_BillNumber" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->BillNumber->caption() ?><?php echo ($view_ip_patient_admission->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->BillNumber->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_BillNumber" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ClosingAmount->Visible) { // ClosingAmount ?>
	<div id="r_ClosingAmount" class="form-group row">
		<label id="elh_view_ip_patient_admission_ClosingAmount" for="x_ClosingAmount" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ClosingAmount" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ClosingAmount->caption() ?><?php echo ($view_ip_patient_admission->ClosingAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ClosingAmount->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ClosingAmount" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ClosingType->Visible) { // ClosingType ?>
	<div id="r_ClosingType" class="form-group row">
		<label id="elh_view_ip_patient_admission_ClosingType" for="x_ClosingType" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ClosingType" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ClosingType->caption() ?><?php echo ($view_ip_patient_admission->ClosingType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ClosingType->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ClosingType" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->BillAmount->Visible) { // BillAmount ?>
	<div id="r_BillAmount" class="form-group row">
		<label id="elh_view_ip_patient_admission_BillAmount" for="x_BillAmount" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_BillAmount" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->BillAmount->caption() ?><?php echo ($view_ip_patient_admission->BillAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->BillAmount->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_BillAmount" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->billclosedBy->Visible) { // billclosedBy ?>
	<div id="r_billclosedBy" class="form-group row">
		<label id="elh_view_ip_patient_admission_billclosedBy" for="x_billclosedBy" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_billclosedBy" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->billclosedBy->caption() ?><?php echo ($view_ip_patient_admission->billclosedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->billclosedBy->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_billclosedBy" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->bllcloseByDate->Visible) { // bllcloseByDate ?>
	<div id="r_bllcloseByDate" class="form-group row">
		<label id="elh_view_ip_patient_admission_bllcloseByDate" for="x_bllcloseByDate" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_bllcloseByDate" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->bllcloseByDate->caption() ?><?php echo ($view_ip_patient_admission->bllcloseByDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->bllcloseByDate->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_bllcloseByDate" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_view_ip_patient_admission_ReportHeader" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_ReportHeader" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->ReportHeader->caption() ?><?php echo ($view_ip_patient_admission->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->ReportHeader->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_ReportHeader" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Procedure->Visible) { // Procedure ?>
	<div id="r_Procedure" class="form-group row">
		<label id="elh_view_ip_patient_admission_Procedure" for="x_Procedure" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Procedure" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Procedure->caption() ?><?php echo ($view_ip_patient_admission->Procedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Procedure->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Procedure" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Consultant->Visible) { // Consultant ?>
	<div id="r_Consultant" class="form-group row">
		<label id="elh_view_ip_patient_admission_Consultant" for="x_Consultant" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Consultant" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Consultant->caption() ?><?php echo ($view_ip_patient_admission->Consultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Consultant->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Consultant" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Anesthetist->Visible) { // Anesthetist ?>
	<div id="r_Anesthetist" class="form-group row">
		<label id="elh_view_ip_patient_admission_Anesthetist" for="x_Anesthetist" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Anesthetist" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Anesthetist->caption() ?><?php echo ($view_ip_patient_admission->Anesthetist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Anesthetist->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Anesthetist" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Amound->Visible) { // Amound ?>
	<div id="r_Amound" class="form-group row">
		<label id="elh_view_ip_patient_admission_Amound" for="x_Amound" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Amound" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Amound->caption() ?><?php echo ($view_ip_patient_admission->Amound->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Amound->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Amound" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->physician_id->Visible) { // physician_id ?>
	<div id="r_physician_id" class="form-group row">
		<label id="elh_view_ip_patient_admission_physician_id" for="x_physician_id" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_physician_id" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->physician_id->caption() ?><?php echo ($view_ip_patient_admission->physician_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->physician_id->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_physician_id" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_view_ip_patient_admission_PartnerID" for="x_PartnerID" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PartnerID" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PartnerID->caption() ?><?php echo ($view_ip_patient_admission->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PartnerID->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PartnerID" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_view_ip_patient_admission_PartnerName" for="x_PartnerName" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PartnerName" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PartnerName->caption() ?><?php echo ($view_ip_patient_admission->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PartnerName->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PartnerName" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PartnerMobile->Visible) { // PartnerMobile ?>
	<div id="r_PartnerMobile" class="form-group row">
		<label id="elh_view_ip_patient_admission_PartnerMobile" for="x_PartnerMobile" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PartnerMobile" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PartnerMobile->caption() ?><?php echo ($view_ip_patient_admission->PartnerMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PartnerMobile->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PartnerMobile" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_view_ip_patient_admission_patient_id" for="x_patient_id" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_patient_id" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->patient_id->caption() ?><?php echo ($view_ip_patient_admission->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->patient_id->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_patient_id" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Cid->Visible) { // Cid ?>
	<div id="r_Cid" class="form-group row">
		<label id="elh_view_ip_patient_admission_Cid" for="x_Cid" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Cid" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Cid->caption() ?><?php echo ($view_ip_patient_admission->Cid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Cid->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Cid" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->PartId->Visible) { // PartId ?>
	<div id="r_PartId" class="form-group row">
		<label id="elh_view_ip_patient_admission_PartId" for="x_PartId" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_PartId" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->PartId->caption() ?><?php echo ($view_ip_patient_admission->PartId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->PartId->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_PartId" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->IDProof->Visible) { // IDProof ?>
	<div id="r_IDProof" class="form-group row">
		<label id="elh_view_ip_patient_admission_IDProof" for="x_IDProof" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_IDProof" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->IDProof->caption() ?><?php echo ($view_ip_patient_admission->IDProof->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->IDProof->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_IDProof" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->DOB->Visible) { // DOB ?>
	<div id="r_DOB" class="form-group row">
		<label id="elh_view_ip_patient_admission_DOB" for="x_DOB" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_DOB" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->DOB->caption() ?><?php echo ($view_ip_patient_admission->DOB->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->DOB->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_DOB" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->AdviceToOtherHospital->Visible) { // AdviceToOtherHospital ?>
	<div id="r_AdviceToOtherHospital" class="form-group row">
		<label id="elh_view_ip_patient_admission_AdviceToOtherHospital" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_AdviceToOtherHospital" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->AdviceToOtherHospital->caption() ?><?php echo ($view_ip_patient_admission->AdviceToOtherHospital->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->AdviceToOtherHospital->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_AdviceToOtherHospital" class="view_ip_patient_admissionadd" type="text/html">
...
<?php if ($view_ip_patient_admission->Reason->Visible) { // Reason ?>
	<div id="r_Reason" class="form-group row">
		<label id="elh_view_ip_patient_admission_Reason" for="x_Reason" class="<?php echo $view_ip_patient_admission_add->LeftColumnClass ?>"><script id="tpc_view_ip_patient_admission_Reason" class="view_ip_patient_admissionadd" type="text/html"><span><?php echo $view_ip_patient_admission->Reason->caption() ?><?php echo ($view_ip_patient_admission->Reason->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_ip_patient_admission_add->RightColumnClass ?>"><div<?php echo $view_ip_patient_admission->Reason->cellAttributes() ?>>
<script id="tpx_view_ip_patient_admission_Reason" class="view_ip_patient_admissionadd" type="text/html">
...
ew.applyTemplate("tpd_view_ip_patient_admissionadd", "tpm_view_ip_patient_admissionadd", "view_ip_patient_admissionadd", "<?php echo $view_ip_patient_admission->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_ip_patient_admissionadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
