...
var fbilling_refund_voucheredit = currentForm = new ew.Form("fbilling_refund_voucheredit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($billing_refund_voucher_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $billing_refund_voucher->id->caption(), $billing_refund_voucher->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php if ($billing_refund_voucher_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $billing_refund_voucher->modifiedby->caption(), $billing_refund_voucher->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($billing_refund_voucher_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $billing_refund_voucher->modifieddatetime->caption(), $billing_refund_voucher->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fbilling_refund_voucheredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fbilling_refund_voucheredit.lists["x_ModeofPayment"] = <?php echo $billing_refund_voucher_edit->ModeofPayment->Lookup->toClientList() ?>;
...
fbilling_refund_voucheredit.lists["x_Reception"] = <?php echo $billing_refund_voucher_edit->Reception->Lookup->toClientList() ?>;
fbilling_refund_voucheredit.lists["x_Reception"].options = <?php echo JsonEncode($billing_refund_voucher_edit->Reception->lookupOptions()) ?>;
...
<?php if ($billing_refund_voucher_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $billing_refund_voucher_edit->Token ?>">
<?php } ?>
...
<?php if ($billing_refund_voucher->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_billing_refund_voucher_id" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_id" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->id->caption() ?><?php echo ($billing_refund_voucher->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->id->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_id" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_id">
<span<?php echo $billing_refund_voucher->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_refund_voucher->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_refund_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($billing_refund_voucher->id->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_refund_voucher_id" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_id">
<span<?php echo $billing_refund_voucher->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_refund_voucher->id->ViewValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_refund_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($billing_refund_voucher->id->FormValue) ?>">
<?php } ?>
<?php echo $billing_refund_voucher->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($billing_refund_voucher->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_billing_refund_voucher_Name" for="x_Name" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Name" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Name->caption() ?><?php echo ($billing_refund_voucher->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Name->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Name" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_billing_refund_voucher_Mobile" for="x_Mobile" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Mobile" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Mobile->caption() ?><?php echo ($billing_refund_voucher->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Mobile->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Mobile" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_billing_refund_voucher_voucher_type" for="x_voucher_type" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_voucher_type" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->voucher_type->caption() ?><?php echo ($billing_refund_voucher->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->voucher_type->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_voucher_type" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_billing_refund_voucher_Details" for="x_Details" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Details" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Details->caption() ?><?php echo ($billing_refund_voucher->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Details->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Details" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_billing_refund_voucher_ModeofPayment" for="x_ModeofPayment" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_ModeofPayment" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->ModeofPayment->caption() ?><?php echo ($billing_refund_voucher->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->ModeofPayment->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_ModeofPayment" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_billing_refund_voucher_Amount" for="x_Amount" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Amount" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Amount->caption() ?><?php echo ($billing_refund_voucher->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Amount->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Amount" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_billing_refund_voucher_AnyDues" for="x_AnyDues" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_AnyDues" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->AnyDues->caption() ?><?php echo ($billing_refund_voucher->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->AnyDues->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_AnyDues" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_billing_refund_voucher_PatID" for="x_PatID" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_PatID" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->PatID->caption() ?><?php echo ($billing_refund_voucher->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->PatID->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_PatID" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_PatID">
<span<?php echo $billing_refund_voucher->PatID->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_refund_voucher->PatID->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_refund_voucher" data-field="x_PatID" name="x_PatID" id="x_PatID" value="<?php echo HtmlEncode($billing_refund_voucher->PatID->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_refund_voucher_PatID" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_PatID">
<span<?php echo $billing_refund_voucher->PatID->viewAttributes() ?>>
...
<?php if ($billing_refund_voucher->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_billing_refund_voucher_PatientID" for="x_PatientID" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_PatientID" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->PatientID->caption() ?><?php echo ($billing_refund_voucher->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->PatientID->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_PatientID" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_billing_refund_voucher_PatientName" for="x_PatientName" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_PatientName" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->PatientName->caption() ?><?php echo ($billing_refund_voucher->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->PatientName->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_PatientName" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->VisiteType->Visible) { // VisiteType ?>
	<div id="r_VisiteType" class="form-group row">
		<label id="elh_billing_refund_voucher_VisiteType" for="x_VisiteType" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_VisiteType" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->VisiteType->caption() ?><?php echo ($billing_refund_voucher->VisiteType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->VisiteType->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_VisiteType" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->VisitDate->Visible) { // VisitDate ?>
	<div id="r_VisitDate" class="form-group row">
		<label id="elh_billing_refund_voucher_VisitDate" for="x_VisitDate" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_VisitDate" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->VisitDate->caption() ?><?php echo ($billing_refund_voucher->VisitDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->VisitDate->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_VisitDate" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->AdvanceNo->Visible) { // AdvanceNo ?>
	<div id="r_AdvanceNo" class="form-group row">
		<label id="elh_billing_refund_voucher_AdvanceNo" for="x_AdvanceNo" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_AdvanceNo" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->AdvanceNo->caption() ?><?php echo ($billing_refund_voucher->AdvanceNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->AdvanceNo->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_AdvanceNo" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Status->Visible) { // Status ?>
	<div id="r_Status" class="form-group row">
		<label id="elh_billing_refund_voucher_Status" for="x_Status" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Status" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Status->caption() ?><?php echo ($billing_refund_voucher->Status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Status->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Status" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Date->Visible) { // Date ?>
	<div id="r_Date" class="form-group row">
		<label id="elh_billing_refund_voucher_Date" for="x_Date" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Date" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Date->caption() ?><?php echo ($billing_refund_voucher->Date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Date->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Date" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->AdvanceValidityDate->Visible) { // AdvanceValidityDate ?>
	<div id="r_AdvanceValidityDate" class="form-group row">
		<label id="elh_billing_refund_voucher_AdvanceValidityDate" for="x_AdvanceValidityDate" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_AdvanceValidityDate" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->AdvanceValidityDate->caption() ?><?php echo ($billing_refund_voucher->AdvanceValidityDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->AdvanceValidityDate->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_AdvanceValidityDate" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->TotalRemainingAdvance->Visible) { // TotalRemainingAdvance ?>
	<div id="r_TotalRemainingAdvance" class="form-group row">
		<label id="elh_billing_refund_voucher_TotalRemainingAdvance" for="x_TotalRemainingAdvance" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_TotalRemainingAdvance" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->TotalRemainingAdvance->caption() ?><?php echo ($billing_refund_voucher->TotalRemainingAdvance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->TotalRemainingAdvance->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_TotalRemainingAdvance" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_billing_refund_voucher_Remarks" for="x_Remarks" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Remarks" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Remarks->caption() ?><?php echo ($billing_refund_voucher->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Remarks->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Remarks" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->SeectPaymentMode->Visible) { // SeectPaymentMode ?>
	<div id="r_SeectPaymentMode" class="form-group row">
		<label id="elh_billing_refund_voucher_SeectPaymentMode" for="x_SeectPaymentMode" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_SeectPaymentMode" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->SeectPaymentMode->caption() ?><?php echo ($billing_refund_voucher->SeectPaymentMode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->SeectPaymentMode->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_SeectPaymentMode" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->PaidAmount->Visible) { // PaidAmount ?>
	<div id="r_PaidAmount" class="form-group row">
		<label id="elh_billing_refund_voucher_PaidAmount" for="x_PaidAmount" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_PaidAmount" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->PaidAmount->caption() ?><?php echo ($billing_refund_voucher->PaidAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->PaidAmount->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_PaidAmount" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_billing_refund_voucher_Currency" for="x_Currency" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Currency" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Currency->caption() ?><?php echo ($billing_refund_voucher->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Currency->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Currency" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_billing_refund_voucher_CardNumber" for="x_CardNumber" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_CardNumber" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->CardNumber->caption() ?><?php echo ($billing_refund_voucher->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->CardNumber->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_CardNumber" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_billing_refund_voucher_BankName" for="x_BankName" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_BankName" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->BankName->caption() ?><?php echo ($billing_refund_voucher->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->BankName->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_BankName" class="billing_refund_voucheredit" type="text/html">
...
<?php if ($billing_refund_voucher->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_billing_refund_voucher_Reception" for="x_Reception" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_Reception" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->Reception->caption() ?><?php echo ($billing_refund_voucher->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->Reception->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_Reception" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_Reception">
<span<?php echo $billing_refund_voucher->Reception->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_refund_voucher->Reception->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_refund_voucher" data-field="x_Reception" name="x_Reception" id="x_Reception" value="<?php echo HtmlEncode($billing_refund_voucher->Reception->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_refund_voucher_Reception" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_Reception">
<span<?php echo $billing_refund_voucher->Reception->viewAttributes() ?>>
...
<?php if ($billing_refund_voucher->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_billing_refund_voucher_mrnno" for="x_mrnno" class="<?php echo $billing_refund_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_refund_voucher_mrnno" class="billing_refund_voucheredit" type="text/html"><span><?php echo $billing_refund_voucher->mrnno->caption() ?><?php echo ($billing_refund_voucher->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_refund_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_refund_voucher->mrnno->cellAttributes() ?>>
<?php if (!$billing_refund_voucher->isConfirm()) { ?>
<script id="tpx_billing_refund_voucher_mrnno" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_mrnno">
<span<?php echo $billing_refund_voucher->mrnno->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_refund_voucher->mrnno->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_refund_voucher" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" value="<?php echo HtmlEncode($billing_refund_voucher->mrnno->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_refund_voucher_mrnno" class="billing_refund_voucheredit" type="text/html">
<span id="el_billing_refund_voucher_mrnno">
<span<?php echo $billing_refund_voucher->mrnno->viewAttributes() ?>>
...
ew.applyTemplate("tpd_billing_refund_voucheredit", "tpm_billing_refund_voucheredit", "billing_refund_voucheredit", "<?php echo $billing_refund_voucher->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.billing_refund_voucheredit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
