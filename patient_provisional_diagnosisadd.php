...
var fpatient_provisional_diagnosisadd = currentForm = new ew.Form("fpatient_provisional_diagnosisadd", "add");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
			...
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($patient_provisional_diagnosis->Reception->errorMessage()) ?>");
		...
		<?php } ?>
			elm = this.getElements("x" + infix + "_PatientId");
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($patient_provisional_diagnosis->PatientId->errorMessage()) ?>");
...
fpatient_provisional_diagnosisadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_provisional_diagnosisadd.lists["x_provisionaldiagnosisTemplate"] = <?php echo $patient_provisional_diagnosis_add->provisionaldiagnosisTemplate->Lookup->toClientList() ?>;
...
fpatient_provisional_diagnosisadd.lists["x_PatientSearch"] = <?php echo $patient_provisional_diagnosis_add->PatientSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_provisional_diagnosis_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_provisional_diagnosis_add->Token ?>">
<?php } ?>
...
<?php if ($patient_provisional_diagnosis->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_mrnno" for="x_mrnno" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_mrnno" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->mrnno->caption() ?><?php echo ($patient_provisional_diagnosis->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->mrnno->cellAttributes() ?>>
<?php if ($patient_provisional_diagnosis->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_provisional_diagnosis_mrnno" class="patient_provisional_diagnosisadd" type="text/html">
...
<input type="hidden" id="x_mrnno" name="x_mrnno" value="<?php echo HtmlEncode($patient_provisional_diagnosis->mrnno->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_provisional_diagnosis_mrnno" class="patient_provisional_diagnosisadd" type="text/html">
<span id="el_patient_provisional_diagnosis_mrnno">
<input type="text" data-table="patient_provisional_diagnosis" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($patient_provisional_diagnosis->mrnno->getPlaceHolder()) ?>" value="<?php echo $patient_provisional_diagnosis->mrnno->EditValue ?>"<?php echo $patient_provisional_diagnosis->mrnno->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_provisional_diagnosis->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_PatientName" for="x_PatientName" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_PatientName" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->PatientName->caption() ?><?php echo ($patient_provisional_diagnosis->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->PatientName->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_PatientName" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_PatID" for="x_PatID" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_PatID" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->PatID->caption() ?><?php echo ($patient_provisional_diagnosis->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->PatID->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_PatID" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_MobileNumber" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->MobileNumber->caption() ?><?php echo ($patient_provisional_diagnosis->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_MobileNumber" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_Reception" for="x_Reception" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_Reception" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->Reception->caption() ?><?php echo ($patient_provisional_diagnosis->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->Reception->cellAttributes() ?>>
<?php if ($patient_provisional_diagnosis->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_provisional_diagnosis_Reception" class="patient_provisional_diagnosisadd" type="text/html">
...
<input type="hidden" id="x_Reception" name="x_Reception" value="<?php echo HtmlEncode($patient_provisional_diagnosis->Reception->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_provisional_diagnosis_Reception" class="patient_provisional_diagnosisadd" type="text/html">
<span id="el_patient_provisional_diagnosis_Reception">
<input type="text" data-table="patient_provisional_diagnosis" data-field="x_Reception" name="x_Reception" id="x_Reception" size="30" placeholder="<?php echo HtmlEncode($patient_provisional_diagnosis->Reception->getPlaceHolder()) ?>" value="<?php echo $patient_provisional_diagnosis->Reception->EditValue ?>"<?php echo $patient_provisional_diagnosis->Reception->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_provisional_diagnosis->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_PatientId" for="x_PatientId" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_PatientId" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->PatientId->caption() ?><?php echo ($patient_provisional_diagnosis->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->PatientId->cellAttributes() ?>>
<?php if ($patient_provisional_diagnosis->PatientId->getSessionValue() <> "") { ?>
<script id="tpx_patient_provisional_diagnosis_PatientId" class="patient_provisional_diagnosisadd" type="text/html">
...
<input type="hidden" id="x_PatientId" name="x_PatientId" value="<?php echo HtmlEncode($patient_provisional_diagnosis->PatientId->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_provisional_diagnosis_PatientId" class="patient_provisional_diagnosisadd" type="text/html">
<span id="el_patient_provisional_diagnosis_PatientId">
<input type="text" data-table="patient_provisional_diagnosis" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" size="30" placeholder="<?php echo HtmlEncode($patient_provisional_diagnosis->PatientId->getPlaceHolder()) ?>" value="<?php echo $patient_provisional_diagnosis->PatientId->EditValue ?>"<?php echo $patient_provisional_diagnosis->PatientId->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_provisional_diagnosis->provisional_diagnosis->Visible) { // provisional_diagnosis ?>
	<div id="r_provisional_diagnosis" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_provisional_diagnosis" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_provisional_diagnosis" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->provisional_diagnosis->caption() ?><?php echo ($patient_provisional_diagnosis->provisional_diagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->provisional_diagnosis->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_provisional_diagnosis" class="patient_provisional_diagnosisadd" type="text/html">
...
ew.createEditor("fpatient_provisional_diagnosisadd", "x_provisional_diagnosis", 35, 25, <?php echo ($patient_provisional_diagnosis->provisional_diagnosis->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_provisional_diagnosis->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_Age" for="x_Age" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_Age" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->Age->caption() ?><?php echo ($patient_provisional_diagnosis->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->Age->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_Age" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_Gender" for="x_Gender" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_Gender" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->Gender->caption() ?><?php echo ($patient_provisional_diagnosis->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->Gender->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_Gender" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_profilePic" for="x_profilePic" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_profilePic" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->profilePic->caption() ?><?php echo ($patient_provisional_diagnosis->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->profilePic->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_profilePic" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->provisionaldiagnosisTemplate->Visible) { // provisionaldiagnosisTemplate ?>
	<div id="r_provisionaldiagnosisTemplate" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_provisionaldiagnosisTemplate" for="x_provisionaldiagnosisTemplate" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_provisionaldiagnosisTemplate" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->provisionaldiagnosisTemplate->caption() ?><?php echo ($patient_provisional_diagnosis->provisionaldiagnosisTemplate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->provisionaldiagnosisTemplate->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_provisionaldiagnosisTemplate" class="patient_provisional_diagnosisadd" type="text/html">
...
<?php if ($patient_provisional_diagnosis->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_provisional_diagnosis_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_provisional_diagnosis_add->LeftColumnClass ?>"><script id="tpc_patient_provisional_diagnosis_PatientSearch" class="patient_provisional_diagnosisadd" type="text/html"><span><?php echo $patient_provisional_diagnosis->PatientSearch->caption() ?><?php echo ($patient_provisional_diagnosis->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_provisional_diagnosis_add->RightColumnClass ?>"><div<?php echo $patient_provisional_diagnosis->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_provisional_diagnosis_PatientSearch" class="patient_provisional_diagnosisadd" type="text/html">
...
{{include tmpl="#tpc_patient_provisional_diagnosis_PatientSearch"/}}&nbsp;{{include tmpl="#tpx_patient_provisional_diagnosis_PatientSearch"/}}	
...
ew.applyTemplate("tpd_patient_provisional_diagnosisadd", "tpm_patient_provisional_diagnosisadd", "patient_provisional_diagnosisadd", "<?php echo $patient_provisional_diagnosis->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_provisional_diagnosisadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
...
// document.write("page loaded");
 ...
 var c = document.getElementById("el_patient_provisional_diagnosis_profilePic").children;
 var d = c[0].children;
