...
// Create page object
$crm_leadaddress_edit = new crm_leadaddress_edit();

// Run the page
$crm_leadaddress_edit->run();
...
$crm_leadaddress_edit->Page_Render();
?>
...
var fcrm_leadaddressedit = currentForm = new ew.Form("fcrm_leadaddressedit", "edit");

// Validate form
fcrm_leadaddressedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($crm_leadaddress_edit->leadaddressid->Required) { ?>
		...
		<?php if ($crm_leadaddress_edit->phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->mobile->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->fax->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel1a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel2a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel3a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel4a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel5a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel6a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel7a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->addresslevel8a->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->buildingnumbera->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->localnumbera->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->poboxa->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->phone_extra->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->mobile_extra->Required) { ?>
		...
		<?php } ?>
		<?php if ($crm_leadaddress_edit->fax_extra->Required) { ?>
...
fcrm_leadaddressedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcrm_leadaddressedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $crm_leadaddress_edit->showPageHeader(); ?>
<?php
$crm_leadaddress_edit->showMessage();
?>
<form name="fcrm_leadaddressedit" id="fcrm_leadaddressedit" class="<?php echo $crm_leadaddress_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($crm_leadaddress_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $crm_leadaddress_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="crm_leadaddress">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$crm_leadaddress_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($crm_leadaddress->leadaddressid->Visible) { // leadaddressid ?>
	<div id="r_leadaddressid" class="form-group row">
		<label id="elh_crm_leadaddress_leadaddressid" for="x_leadaddressid" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->leadaddressid->caption() ?><?php echo ($crm_leadaddress->leadaddressid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->leadaddressid->cellAttributes() ?>>
<span id="el_crm_leadaddress_leadaddressid">
<span<?php echo $crm_leadaddress->leadaddressid->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($crm_leadaddress->leadaddressid->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="crm_leadaddress" data-field="x_leadaddressid" name="x_leadaddressid" id="x_leadaddressid" value="<?php echo HtmlEncode($crm_leadaddress->leadaddressid->CurrentValue) ?>">
<?php echo $crm_leadaddress->leadaddressid->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($crm_leadaddress->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group row">
		<label id="elh_crm_leadaddress_phone" for="x_phone" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->phone->caption() ?><?php echo ($crm_leadaddress->phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->phone->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->mobile->Visible) { // mobile ?>
	<div id="r_mobile" class="form-group row">
		<label id="elh_crm_leadaddress_mobile" for="x_mobile" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->mobile->caption() ?><?php echo ($crm_leadaddress->mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->mobile->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->fax->Visible) { // fax ?>
	<div id="r_fax" class="form-group row">
		<label id="elh_crm_leadaddress_fax" for="x_fax" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->fax->caption() ?><?php echo ($crm_leadaddress->fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->fax->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel1a->Visible) { // addresslevel1a ?>
	<div id="r_addresslevel1a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel1a" for="x_addresslevel1a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel1a->caption() ?><?php echo ($crm_leadaddress->addresslevel1a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel1a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel2a->Visible) { // addresslevel2a ?>
	<div id="r_addresslevel2a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel2a" for="x_addresslevel2a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel2a->caption() ?><?php echo ($crm_leadaddress->addresslevel2a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel2a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel3a->Visible) { // addresslevel3a ?>
	<div id="r_addresslevel3a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel3a" for="x_addresslevel3a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel3a->caption() ?><?php echo ($crm_leadaddress->addresslevel3a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel3a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel4a->Visible) { // addresslevel4a ?>
	<div id="r_addresslevel4a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel4a" for="x_addresslevel4a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel4a->caption() ?><?php echo ($crm_leadaddress->addresslevel4a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel4a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel5a->Visible) { // addresslevel5a ?>
	<div id="r_addresslevel5a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel5a" for="x_addresslevel5a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel5a->caption() ?><?php echo ($crm_leadaddress->addresslevel5a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel5a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel6a->Visible) { // addresslevel6a ?>
	<div id="r_addresslevel6a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel6a" for="x_addresslevel6a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel6a->caption() ?><?php echo ($crm_leadaddress->addresslevel6a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel6a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel7a->Visible) { // addresslevel7a ?>
	<div id="r_addresslevel7a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel7a" for="x_addresslevel7a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel7a->caption() ?><?php echo ($crm_leadaddress->addresslevel7a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel7a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->addresslevel8a->Visible) { // addresslevel8a ?>
	<div id="r_addresslevel8a" class="form-group row">
		<label id="elh_crm_leadaddress_addresslevel8a" for="x_addresslevel8a" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->addresslevel8a->caption() ?><?php echo ($crm_leadaddress->addresslevel8a->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->addresslevel8a->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->buildingnumbera->Visible) { // buildingnumbera ?>
	<div id="r_buildingnumbera" class="form-group row">
		<label id="elh_crm_leadaddress_buildingnumbera" for="x_buildingnumbera" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->buildingnumbera->caption() ?><?php echo ($crm_leadaddress->buildingnumbera->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->buildingnumbera->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->localnumbera->Visible) { // localnumbera ?>
	<div id="r_localnumbera" class="form-group row">
		<label id="elh_crm_leadaddress_localnumbera" for="x_localnumbera" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->localnumbera->caption() ?><?php echo ($crm_leadaddress->localnumbera->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->localnumbera->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->poboxa->Visible) { // poboxa ?>
	<div id="r_poboxa" class="form-group row">
		<label id="elh_crm_leadaddress_poboxa" for="x_poboxa" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->poboxa->caption() ?><?php echo ($crm_leadaddress->poboxa->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->poboxa->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->phone_extra->Visible) { // phone_extra ?>
	<div id="r_phone_extra" class="form-group row">
		<label id="elh_crm_leadaddress_phone_extra" for="x_phone_extra" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->phone_extra->caption() ?><?php echo ($crm_leadaddress->phone_extra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->phone_extra->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->mobile_extra->Visible) { // mobile_extra ?>
	<div id="r_mobile_extra" class="form-group row">
		<label id="elh_crm_leadaddress_mobile_extra" for="x_mobile_extra" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->mobile_extra->caption() ?><?php echo ($crm_leadaddress->mobile_extra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->mobile_extra->cellAttributes() ?>>
...
<?php if ($crm_leadaddress->fax_extra->Visible) { // fax_extra ?>
	<div id="r_fax_extra" class="form-group row">
		<label id="elh_crm_leadaddress_fax_extra" for="x_fax_extra" class="<?php echo $crm_leadaddress_edit->LeftColumnClass ?>"><?php echo $crm_leadaddress->fax_extra->caption() ?><?php echo ($crm_leadaddress->fax_extra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_leadaddress_edit->RightColumnClass ?>"><div<?php echo $crm_leadaddress->fax_extra->cellAttributes() ?>>
...
<?php if (!$crm_leadaddress_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $crm_leadaddress_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $crm_leadaddress_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$crm_leadaddress_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$crm_leadaddress_edit->terminate();
?>