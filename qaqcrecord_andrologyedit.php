...
// Create page object
$qaqcrecord_andrology_edit = new qaqcrecord_andrology_edit();

// Run the page
$qaqcrecord_andrology_edit->run();
...
$qaqcrecord_andrology_edit->Page_Render();
?>
...
var fqaqcrecord_andrologyedit = currentForm = new ew.Form("fqaqcrecord_andrologyedit", "edit");

// Validate form
fqaqcrecord_andrologyedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($qaqcrecord_andrology_edit->id->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->Date->Required) { ?>
		...
		<?php if ($qaqcrecord_andrology_edit->LN2_Level->Required) { ?>
		...
		<?php if ($qaqcrecord_andrology_edit->LN2_Checked->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->Incubator_Temp->Required) { ?>
		...
		<?php if ($qaqcrecord_andrology_edit->Incubator_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->LAF_MG->Required) { ?>
		...
		<?php if ($qaqcrecord_andrology_edit->LAF_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->REF_Temp->Required) { ?>
		...
		<?php if ($qaqcrecord_andrology_edit->REF_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->Heating_Temp->Required) { ?>
		...
		<?php if ($qaqcrecord_andrology_edit->Heating_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->Createdby->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_andrology_edit->CreatedDate->Required) { ?>
...
fqaqcrecord_andrologyedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fqaqcrecord_andrologyedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fqaqcrecord_andrologyedit.lists["x_LN2_Checked[]"] = <?php echo $qaqcrecord_andrology_edit->LN2_Checked->Lookup->toClientList() ?>;
fqaqcrecord_andrologyedit.lists["x_LN2_Checked[]"].options = <?php echo JsonEncode($qaqcrecord_andrology_edit->LN2_Checked->options(FALSE, TRUE)) ?>;
fqaqcrecord_andrologyedit.lists["x_Incubator_Cleaned[]"] = <?php echo $qaqcrecord_andrology_edit->Incubator_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_andrologyedit.lists["x_Incubator_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_andrology_edit->Incubator_Cleaned->options(FALSE, TRUE)) ?>;
fqaqcrecord_andrologyedit.lists["x_LAF_Cleaned[]"] = <?php echo $qaqcrecord_andrology_edit->LAF_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_andrologyedit.lists["x_LAF_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_andrology_edit->LAF_Cleaned->options(FALSE, TRUE)) ?>;
fqaqcrecord_andrologyedit.lists["x_REF_Cleaned[]"] = <?php echo $qaqcrecord_andrology_edit->REF_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_andrologyedit.lists["x_REF_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_andrology_edit->REF_Cleaned->options(FALSE, TRUE)) ?>;
fqaqcrecord_andrologyedit.lists["x_Heating_Cleaned[]"] = <?php echo $qaqcrecord_andrology_edit->Heating_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_andrologyedit.lists["x_Heating_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_andrology_edit->Heating_Cleaned->options(FALSE, TRUE)) ?>;
...
<?php $qaqcrecord_andrology_edit->showPageHeader(); ?>
<?php
$qaqcrecord_andrology_edit->showMessage();
?>
<form name="fqaqcrecord_andrologyedit" id="fqaqcrecord_andrologyedit" class="<?php echo $qaqcrecord_andrology_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($qaqcrecord_andrology_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $qaqcrecord_andrology_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="qaqcrecord_andrology">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$qaqcrecord_andrology_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($qaqcrecord_andrology->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_qaqcrecord_andrology_id" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->id->caption() ?><?php echo ($qaqcrecord_andrology->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->id->cellAttributes() ?>>
...
<input type="hidden" data-table="qaqcrecord_andrology" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($qaqcrecord_andrology->id->CurrentValue) ?>">
<?php echo $qaqcrecord_andrology->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($qaqcrecord_andrology->Date->Visible) { // Date ?>
	<div id="r_Date" class="form-group row">
		<label id="elh_qaqcrecord_andrology_Date" for="x_Date" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->Date->caption() ?><?php echo ($qaqcrecord_andrology->Date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->Date->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fqaqcrecord_andrologyedit", "x_Date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($qaqcrecord_andrology->LN2_Level->Visible) { // LN2_Level ?>
	<div id="r_LN2_Level" class="form-group row">
		<label id="elh_qaqcrecord_andrology_LN2_Level" for="x_LN2_Level" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->LN2_Level->caption() ?><?php echo ($qaqcrecord_andrology->LN2_Level->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->LN2_Level->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->LN2_Checked->Visible) { // LN2_Checked ?>
	<div id="r_LN2_Checked" class="form-group row">
		<label id="elh_qaqcrecord_andrology_LN2_Checked" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->LN2_Checked->caption() ?><?php echo ($qaqcrecord_andrology->LN2_Checked->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->LN2_Checked->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->Incubator_Temp->Visible) { // Incubator_Temp ?>
	<div id="r_Incubator_Temp" class="form-group row">
		<label id="elh_qaqcrecord_andrology_Incubator_Temp" for="x_Incubator_Temp" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->Incubator_Temp->caption() ?><?php echo ($qaqcrecord_andrology->Incubator_Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->Incubator_Temp->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->Incubator_Cleaned->Visible) { // Incubator_Cleaned ?>
	<div id="r_Incubator_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_andrology_Incubator_Cleaned" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->Incubator_Cleaned->caption() ?><?php echo ($qaqcrecord_andrology->Incubator_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->Incubator_Cleaned->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->LAF_MG->Visible) { // LAF_MG ?>
	<div id="r_LAF_MG" class="form-group row">
		<label id="elh_qaqcrecord_andrology_LAF_MG" for="x_LAF_MG" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->LAF_MG->caption() ?><?php echo ($qaqcrecord_andrology->LAF_MG->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->LAF_MG->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->LAF_Cleaned->Visible) { // LAF_Cleaned ?>
	<div id="r_LAF_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_andrology_LAF_Cleaned" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->LAF_Cleaned->caption() ?><?php echo ($qaqcrecord_andrology->LAF_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->LAF_Cleaned->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->REF_Temp->Visible) { // REF_Temp ?>
	<div id="r_REF_Temp" class="form-group row">
		<label id="elh_qaqcrecord_andrology_REF_Temp" for="x_REF_Temp" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->REF_Temp->caption() ?><?php echo ($qaqcrecord_andrology->REF_Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->REF_Temp->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->REF_Cleaned->Visible) { // REF_Cleaned ?>
	<div id="r_REF_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_andrology_REF_Cleaned" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->REF_Cleaned->caption() ?><?php echo ($qaqcrecord_andrology->REF_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->REF_Cleaned->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->Heating_Temp->Visible) { // Heating_Temp ?>
	<div id="r_Heating_Temp" class="form-group row">
		<label id="elh_qaqcrecord_andrology_Heating_Temp" for="x_Heating_Temp" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->Heating_Temp->caption() ?><?php echo ($qaqcrecord_andrology->Heating_Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->Heating_Temp->cellAttributes() ?>>
...
<?php if ($qaqcrecord_andrology->Heating_Cleaned->Visible) { // Heating_Cleaned ?>
	<div id="r_Heating_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_andrology_Heating_Cleaned" class="<?php echo $qaqcrecord_andrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_andrology->Heating_Cleaned->caption() ?><?php echo ($qaqcrecord_andrology->Heating_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_andrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_andrology->Heating_Cleaned->cellAttributes() ?>>
...
<?php if (!$qaqcrecord_andrology_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $qaqcrecord_andrology_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $qaqcrecord_andrology_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$qaqcrecord_andrology_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$qaqcrecord_andrology_edit->terminate();
?>