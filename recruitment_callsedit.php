...
// Create page object
$recruitment_calls_edit = new recruitment_calls_edit();

// Run the page
$recruitment_calls_edit->run();
...
$recruitment_calls_edit->Page_Render();
?>
...
var frecruitment_callsedit = currentForm = new ew.Form("frecruitment_callsedit", "edit");
...
frecruitment_callsedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($recruitment_calls_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $recruitment_calls->id->caption(), $recruitment_calls->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($recruitment_calls_edit->job->Required) { ?>
		...
		<?php if ($recruitment_calls_edit->candidate->Required) { ?>
		...
		<?php if ($recruitment_calls_edit->phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_calls_edit->created->Required) { ?>
		...
		<?php if ($recruitment_calls_edit->updated->Required) { ?>
		...
		<?php if ($recruitment_calls_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_calls_edit->notes->Required) { ?>
...
frecruitment_callsedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
frecruitment_callsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $recruitment_calls_edit->showPageHeader(); ?>
<?php
$recruitment_calls_edit->showMessage();
?>
<form name="frecruitment_callsedit" id="frecruitment_callsedit" class="<?php echo $recruitment_calls_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($recruitment_calls_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $recruitment_calls_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="recruitment_calls">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$recruitment_calls_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($recruitment_calls->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_recruitment_calls_id" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->id->caption() ?><?php echo ($recruitment_calls->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->id->cellAttributes() ?>>
<span id="el_recruitment_calls_id">
<span<?php echo $recruitment_calls->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($recruitment_calls->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="recruitment_calls" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($recruitment_calls->id->CurrentValue) ?>">
<?php echo $recruitment_calls->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($recruitment_calls->job->Visible) { // job ?>
	<div id="r_job" class="form-group row">
		<label id="elh_recruitment_calls_job" for="x_job" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->job->caption() ?><?php echo ($recruitment_calls->job->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->job->cellAttributes() ?>>
...
<?php if ($recruitment_calls->candidate->Visible) { // candidate ?>
	<div id="r_candidate" class="form-group row">
		<label id="elh_recruitment_calls_candidate" for="x_candidate" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->candidate->caption() ?><?php echo ($recruitment_calls->candidate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->candidate->cellAttributes() ?>>
...
<?php if ($recruitment_calls->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group row">
		<label id="elh_recruitment_calls_phone" for="x_phone" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->phone->caption() ?><?php echo ($recruitment_calls->phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->phone->cellAttributes() ?>>
...
<?php if ($recruitment_calls->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_recruitment_calls_created" for="x_created" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->created->caption() ?><?php echo ($recruitment_calls->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->created->cellAttributes() ?>>
...
<?php if ($recruitment_calls->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_recruitment_calls_updated" for="x_updated" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->updated->caption() ?><?php echo ($recruitment_calls->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->updated->cellAttributes() ?>>
...
<?php if ($recruitment_calls->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_recruitment_calls_status" for="x_status" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->status->caption() ?><?php echo ($recruitment_calls->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->status->cellAttributes() ?>>
...
<?php if ($recruitment_calls->notes->Visible) { // notes ?>
	<div id="r_notes" class="form-group row">
		<label id="elh_recruitment_calls_notes" for="x_notes" class="<?php echo $recruitment_calls_edit->LeftColumnClass ?>"><?php echo $recruitment_calls->notes->caption() ?><?php echo ($recruitment_calls->notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_calls_edit->RightColumnClass ?>"><div<?php echo $recruitment_calls->notes->cellAttributes() ?>>
...
<?php if (!$recruitment_calls_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $recruitment_calls_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $recruitment_calls_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$recruitment_calls_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$recruitment_calls_edit->terminate();
?>