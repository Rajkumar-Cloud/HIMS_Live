...
// Create page object
$store_grn_edit = new store_grn_edit();
...
var fstore_grnedit = currentForm = new ew.Form("fstore_grnedit", "edit");

// Validate form
fstore_grnedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($store_grn_edit->id->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->GRNNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->DT->Required) { ?>
		...
		<?php if ($store_grn_edit->YM->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->PC->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Customercode->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Customername->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->pharmacy_pocol->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Address1->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Address2->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Address3->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->State->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Pincode->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->Fax->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->EEmail->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->HospID->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->modifiedby->Required) { ?>
			elm = this.getElements("x" + infix + "_modifiedby");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $store_grn->modifiedby->caption(), $store_grn->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($store_grn_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $store_grn->modifieddatetime->caption(), $store_grn->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($store_grn_edit->BILLNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->BILLDT->Required) { ?>
		...
		<?php if ($store_grn_edit->BRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->PharmacyID->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->BillTotalValue->Required) { ?>
		...
		<?php if ($store_grn_edit->GRNTotalValue->Required) { ?>
		...
		<?php if ($store_grn_edit->BillDiscount->Required) { ?>
		...
		<?php if ($store_grn_edit->BillUpload->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->TransPort->Required) { ?>
		...
		<?php if ($store_grn_edit->AnyOther->Required) { ?>
		...
		<?php if ($store_grn_edit->Remarks->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->GrnValue->Required) { ?>
		...
		<?php if ($store_grn_edit->Pid->Required) { ?>
		...
		<?php if ($store_grn_edit->PaymentNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->PaymentStatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_grn_edit->PaidAmount->Required) { ?>
		...
		<?php if ($store_grn_edit->StoreID->Required) { ?>
...
fstore_grnedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fstore_grnedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fstore_grnedit.lists["x_PC"] = <?php echo $store_grn_edit->PC->Lookup->toClientList() ?>;
fstore_grnedit.lists["x_PC"].options = <?php echo JsonEncode($store_grn_edit->PC->lookupOptions()) ?>;
fstore_grnedit.lists["x_BRCODE"] = <?php echo $store_grn_edit->BRCODE->Lookup->toClientList() ?>;
fstore_grnedit.lists["x_BRCODE"].options = <?php echo JsonEncode($store_grn_edit->BRCODE->lookupOptions()) ?>;
...
<?php $store_grn_edit->showPageHeader(); ?>
<?php
$store_grn_edit->showMessage();
?>
<form name="fstore_grnedit" id="fstore_grnedit" class="<?php echo $store_grn_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($store_grn_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_grn_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="store_grn">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$store_grn_edit->IsModal ?>">
...
<?php if ($store_grn->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_store_grn_id" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_id" class="store_grnedit" type="text/html"><span><?php echo $store_grn->id->caption() ?><?php echo ($store_grn->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->id->cellAttributes() ?>>
<script id="tpx_store_grn_id" class="store_grnedit" type="text/html">
...
<input type="hidden" data-table="store_grn" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($store_grn->id->CurrentValue) ?>">
<?php echo $store_grn->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($store_grn->GRNNO->Visible) { // GRNNO ?>
	<div id="r_GRNNO" class="form-group row">
		<label id="elh_store_grn_GRNNO" for="x_GRNNO" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_GRNNO" class="store_grnedit" type="text/html"><span><?php echo $store_grn->GRNNO->caption() ?><?php echo ($store_grn->GRNNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->GRNNO->cellAttributes() ?>>
<script id="tpx_store_grn_GRNNO" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_store_grn_DT" for="x_DT" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_DT" class="store_grnedit" type="text/html"><span><?php echo $store_grn->DT->caption() ?><?php echo ($store_grn->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->DT->cellAttributes() ?>>
<script id="tpx_store_grn_DT" class="store_grnedit" type="text/html">
...
<script type="text/html" class="store_grnedit_js">
ew.createDateTimePicker("fstore_grnedit", "x_DT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
...
<?php if ($store_grn->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_store_grn_YM" for="x_YM" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_YM" class="store_grnedit" type="text/html"><span><?php echo $store_grn->YM->caption() ?><?php echo ($store_grn->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->YM->cellAttributes() ?>>
<script id="tpx_store_grn_YM" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_store_grn_PC" for="x_PC" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_PC" class="store_grnedit" type="text/html"><span><?php echo $store_grn->PC->caption() ?><?php echo ($store_grn->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->PC->cellAttributes() ?>>
<script id="tpx_store_grn_PC" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Customercode->Visible) { // Customercode ?>
	<div id="r_Customercode" class="form-group row">
		<label id="elh_store_grn_Customercode" for="x_Customercode" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Customercode" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Customercode->caption() ?><?php echo ($store_grn->Customercode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Customercode->cellAttributes() ?>>
<script id="tpx_store_grn_Customercode" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Customername->Visible) { // Customername ?>
	<div id="r_Customername" class="form-group row">
		<label id="elh_store_grn_Customername" for="x_Customername" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Customername" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Customername->caption() ?><?php echo ($store_grn->Customername->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Customername->cellAttributes() ?>>
<script id="tpx_store_grn_Customername" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->pharmacy_pocol->Visible) { // pharmacy_pocol ?>
	<div id="r_pharmacy_pocol" class="form-group row">
		<label id="elh_store_grn_pharmacy_pocol" for="x_pharmacy_pocol" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_pharmacy_pocol" class="store_grnedit" type="text/html"><span><?php echo $store_grn->pharmacy_pocol->caption() ?><?php echo ($store_grn->pharmacy_pocol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->pharmacy_pocol->cellAttributes() ?>>
<script id="tpx_store_grn_pharmacy_pocol" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Address1->Visible) { // Address1 ?>
	<div id="r_Address1" class="form-group row">
		<label id="elh_store_grn_Address1" for="x_Address1" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Address1" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Address1->caption() ?><?php echo ($store_grn->Address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Address1->cellAttributes() ?>>
<script id="tpx_store_grn_Address1" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Address2->Visible) { // Address2 ?>
	<div id="r_Address2" class="form-group row">
		<label id="elh_store_grn_Address2" for="x_Address2" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Address2" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Address2->caption() ?><?php echo ($store_grn->Address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Address2->cellAttributes() ?>>
<script id="tpx_store_grn_Address2" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Address3->Visible) { // Address3 ?>
	<div id="r_Address3" class="form-group row">
		<label id="elh_store_grn_Address3" for="x_Address3" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Address3" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Address3->caption() ?><?php echo ($store_grn->Address3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Address3->cellAttributes() ?>>
<script id="tpx_store_grn_Address3" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->State->Visible) { // State ?>
	<div id="r_State" class="form-group row">
		<label id="elh_store_grn_State" for="x_State" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_State" class="store_grnedit" type="text/html"><span><?php echo $store_grn->State->caption() ?><?php echo ($store_grn->State->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->State->cellAttributes() ?>>
<script id="tpx_store_grn_State" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Pincode->Visible) { // Pincode ?>
	<div id="r_Pincode" class="form-group row">
		<label id="elh_store_grn_Pincode" for="x_Pincode" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Pincode" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Pincode->caption() ?><?php echo ($store_grn->Pincode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Pincode->cellAttributes() ?>>
<script id="tpx_store_grn_Pincode" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Phone->Visible) { // Phone ?>
	<div id="r_Phone" class="form-group row">
		<label id="elh_store_grn_Phone" for="x_Phone" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Phone" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Phone->caption() ?><?php echo ($store_grn->Phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Phone->cellAttributes() ?>>
<script id="tpx_store_grn_Phone" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Fax->Visible) { // Fax ?>
	<div id="r_Fax" class="form-group row">
		<label id="elh_store_grn_Fax" for="x_Fax" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Fax" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Fax->caption() ?><?php echo ($store_grn->Fax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Fax->cellAttributes() ?>>
<script id="tpx_store_grn_Fax" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->EEmail->Visible) { // EEmail ?>
	<div id="r_EEmail" class="form-group row">
		<label id="elh_store_grn_EEmail" for="x_EEmail" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_EEmail" class="store_grnedit" type="text/html"><span><?php echo $store_grn->EEmail->caption() ?><?php echo ($store_grn->EEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->EEmail->cellAttributes() ?>>
<script id="tpx_store_grn_EEmail" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->BILLNO->Visible) { // BILLNO ?>
	<div id="r_BILLNO" class="form-group row">
		<label id="elh_store_grn_BILLNO" for="x_BILLNO" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_BILLNO" class="store_grnedit" type="text/html"><span><?php echo $store_grn->BILLNO->caption() ?><?php echo ($store_grn->BILLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->BILLNO->cellAttributes() ?>>
<script id="tpx_store_grn_BILLNO" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->BILLDT->Visible) { // BILLDT ?>
	<div id="r_BILLDT" class="form-group row">
		<label id="elh_store_grn_BILLDT" for="x_BILLDT" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_BILLDT" class="store_grnedit" type="text/html"><span><?php echo $store_grn->BILLDT->caption() ?><?php echo ($store_grn->BILLDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->BILLDT->cellAttributes() ?>>
<script id="tpx_store_grn_BILLDT" class="store_grnedit" type="text/html">
...
<script type="text/html" class="store_grnedit_js">
ew.createDateTimePicker("fstore_grnedit", "x_BILLDT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
...
<?php if ($store_grn->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_store_grn_BRCODE" for="x_BRCODE" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_BRCODE" class="store_grnedit" type="text/html"><span><?php echo $store_grn->BRCODE->caption() ?><?php echo ($store_grn->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->BRCODE->cellAttributes() ?>>
<script id="tpx_store_grn_BRCODE" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->BillTotalValue->Visible) { // BillTotalValue ?>
	<div id="r_BillTotalValue" class="form-group row">
		<label id="elh_store_grn_BillTotalValue" for="x_BillTotalValue" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_BillTotalValue" class="store_grnedit" type="text/html"><span><?php echo $store_grn->BillTotalValue->caption() ?><?php echo ($store_grn->BillTotalValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->BillTotalValue->cellAttributes() ?>>
<script id="tpx_store_grn_BillTotalValue" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->GRNTotalValue->Visible) { // GRNTotalValue ?>
	<div id="r_GRNTotalValue" class="form-group row">
		<label id="elh_store_grn_GRNTotalValue" for="x_GRNTotalValue" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_GRNTotalValue" class="store_grnedit" type="text/html"><span><?php echo $store_grn->GRNTotalValue->caption() ?><?php echo ($store_grn->GRNTotalValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->GRNTotalValue->cellAttributes() ?>>
<script id="tpx_store_grn_GRNTotalValue" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->BillDiscount->Visible) { // BillDiscount ?>
	<div id="r_BillDiscount" class="form-group row">
		<label id="elh_store_grn_BillDiscount" for="x_BillDiscount" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_BillDiscount" class="store_grnedit" type="text/html"><span><?php echo $store_grn->BillDiscount->caption() ?><?php echo ($store_grn->BillDiscount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->BillDiscount->cellAttributes() ?>>
<script id="tpx_store_grn_BillDiscount" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->BillUpload->Visible) { // BillUpload ?>
	<div id="r_BillUpload" class="form-group row">
		<label id="elh_store_grn_BillUpload" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_BillUpload" class="store_grnedit" type="text/html"><span><?php echo $store_grn->BillUpload->caption() ?><?php echo ($store_grn->BillUpload->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->BillUpload->cellAttributes() ?>>
<script id="tpx_store_grn_BillUpload" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->TransPort->Visible) { // TransPort ?>
	<div id="r_TransPort" class="form-group row">
		<label id="elh_store_grn_TransPort" for="x_TransPort" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_TransPort" class="store_grnedit" type="text/html"><span><?php echo $store_grn->TransPort->caption() ?><?php echo ($store_grn->TransPort->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->TransPort->cellAttributes() ?>>
<script id="tpx_store_grn_TransPort" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->AnyOther->Visible) { // AnyOther ?>
	<div id="r_AnyOther" class="form-group row">
		<label id="elh_store_grn_AnyOther" for="x_AnyOther" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_AnyOther" class="store_grnedit" type="text/html"><span><?php echo $store_grn->AnyOther->caption() ?><?php echo ($store_grn->AnyOther->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->AnyOther->cellAttributes() ?>>
<script id="tpx_store_grn_AnyOther" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_store_grn_Remarks" for="x_Remarks" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Remarks" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Remarks->caption() ?><?php echo ($store_grn->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Remarks->cellAttributes() ?>>
<script id="tpx_store_grn_Remarks" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->GrnValue->Visible) { // GrnValue ?>
	<div id="r_GrnValue" class="form-group row">
		<label id="elh_store_grn_GrnValue" for="x_GrnValue" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_GrnValue" class="store_grnedit" type="text/html"><span><?php echo $store_grn->GrnValue->caption() ?><?php echo ($store_grn->GrnValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->GrnValue->cellAttributes() ?>>
<script id="tpx_store_grn_GrnValue" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->Pid->Visible) { // Pid ?>
	<div id="r_Pid" class="form-group row">
		<label id="elh_store_grn_Pid" for="x_Pid" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_Pid" class="store_grnedit" type="text/html"><span><?php echo $store_grn->Pid->caption() ?><?php echo ($store_grn->Pid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->Pid->cellAttributes() ?>>
<?php if ($store_grn->Pid->getSessionValue() <> "") { ?>
<script id="tpx_store_grn_Pid" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->PaymentNo->Visible) { // PaymentNo ?>
	<div id="r_PaymentNo" class="form-group row">
		<label id="elh_store_grn_PaymentNo" for="x_PaymentNo" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_PaymentNo" class="store_grnedit" type="text/html"><span><?php echo $store_grn->PaymentNo->caption() ?><?php echo ($store_grn->PaymentNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->PaymentNo->cellAttributes() ?>>
<script id="tpx_store_grn_PaymentNo" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->PaymentStatus->Visible) { // PaymentStatus ?>
	<div id="r_PaymentStatus" class="form-group row">
		<label id="elh_store_grn_PaymentStatus" for="x_PaymentStatus" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_PaymentStatus" class="store_grnedit" type="text/html"><span><?php echo $store_grn->PaymentStatus->caption() ?><?php echo ($store_grn->PaymentStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->PaymentStatus->cellAttributes() ?>>
<script id="tpx_store_grn_PaymentStatus" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->PaidAmount->Visible) { // PaidAmount ?>
	<div id="r_PaidAmount" class="form-group row">
		<label id="elh_store_grn_PaidAmount" for="x_PaidAmount" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_PaidAmount" class="store_grnedit" type="text/html"><span><?php echo $store_grn->PaidAmount->caption() ?><?php echo ($store_grn->PaidAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->PaidAmount->cellAttributes() ?>>
<script id="tpx_store_grn_PaidAmount" class="store_grnedit" type="text/html">
...
<?php if ($store_grn->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_grn_StoreID" for="x_StoreID" class="<?php echo $store_grn_edit->LeftColumnClass ?>"><script id="tpc_store_grn_StoreID" class="store_grnedit" type="text/html"><span><?php echo $store_grn->StoreID->caption() ?><?php echo ($store_grn->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $store_grn_edit->RightColumnClass ?>"><div<?php echo $store_grn->StoreID->cellAttributes() ?>>
<script id="tpx_store_grn_StoreID" class="store_grnedit" type="text/html">
...
<div id="tpd_store_grnedit" class="ew-custom-template"></div>
<script id="tpm_store_grnedit" type="text/html">
<div id="ct_store_grn_edit"><style>
...
<?php
	if (in_array("view_store_grn", explode(",", $store_grn->getCurrentDetailTable())) && $view_store_grn->DetailEdit) {
?>
...
<?php } ?>
<?php if (!$store_grn_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $store_grn_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $store_grn_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
ew.applyTemplate("tpd_store_grnedit", "tpm_store_grnedit", "store_grnedit", "<?php echo $store_grn->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.store_grnedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
$store_grn_edit->showPageFooter();
if (DEBUG_ENABLED)
