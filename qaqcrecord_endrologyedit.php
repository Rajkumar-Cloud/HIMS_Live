...
// Create page object
$qaqcrecord_endrology_edit = new qaqcrecord_endrology_edit();

// Run the page
$qaqcrecord_endrology_edit->run();
...
$qaqcrecord_endrology_edit->Page_Render();
?>
...
var fqaqcrecord_endrologyedit = currentForm = new ew.Form("fqaqcrecord_endrologyedit", "edit");

// Validate form
fqaqcrecord_endrologyedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($qaqcrecord_endrology_edit->id->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->Date->Required) { ?>
		...
		<?php if ($qaqcrecord_endrology_edit->LN2_Level->Required) { ?>
		...
		<?php if ($qaqcrecord_endrology_edit->LN2_Checked->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->Incubator_Temp->Required) { ?>
		...
		<?php if ($qaqcrecord_endrology_edit->Incubator_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->LAF_MG->Required) { ?>
		...
		<?php if ($qaqcrecord_endrology_edit->LAF_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->REF_Temp->Required) { ?>
		...
		<?php if ($qaqcrecord_endrology_edit->REF_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->Heating_Temp->Required) { ?>
		...
		<?php if ($qaqcrecord_endrology_edit->Heating_Cleaned->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->Createdby->Required) { ?>
		...
		<?php } ?>
		<?php if ($qaqcrecord_endrology_edit->CreatedDate->Required) { ?>
...
fqaqcrecord_endrologyedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fqaqcrecord_endrologyedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fqaqcrecord_endrologyedit.lists["x_LN2_Checked[]"] = <?php echo $qaqcrecord_endrology_edit->LN2_Checked->Lookup->toClientList() ?>;
fqaqcrecord_endrologyedit.lists["x_LN2_Checked[]"].options = <?php echo JsonEncode($qaqcrecord_endrology_edit->LN2_Checked->options(FALSE, TRUE)) ?>;
fqaqcrecord_endrologyedit.lists["x_Incubator_Cleaned[]"] = <?php echo $qaqcrecord_endrology_edit->Incubator_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_endrologyedit.lists["x_Incubator_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_endrology_edit->Incubator_Cleaned->options(FALSE, TRUE)) ?>;
fqaqcrecord_endrologyedit.lists["x_LAF_Cleaned[]"] = <?php echo $qaqcrecord_endrology_edit->LAF_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_endrologyedit.lists["x_LAF_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_endrology_edit->LAF_Cleaned->options(FALSE, TRUE)) ?>;
fqaqcrecord_endrologyedit.lists["x_REF_Cleaned[]"] = <?php echo $qaqcrecord_endrology_edit->REF_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_endrologyedit.lists["x_REF_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_endrology_edit->REF_Cleaned->options(FALSE, TRUE)) ?>;
fqaqcrecord_endrologyedit.lists["x_Heating_Cleaned[]"] = <?php echo $qaqcrecord_endrology_edit->Heating_Cleaned->Lookup->toClientList() ?>;
fqaqcrecord_endrologyedit.lists["x_Heating_Cleaned[]"].options = <?php echo JsonEncode($qaqcrecord_endrology_edit->Heating_Cleaned->options(FALSE, TRUE)) ?>;
...
<?php $qaqcrecord_endrology_edit->showPageHeader(); ?>
<?php
$qaqcrecord_endrology_edit->showMessage();
?>
<form name="fqaqcrecord_endrologyedit" id="fqaqcrecord_endrologyedit" class="<?php echo $qaqcrecord_endrology_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($qaqcrecord_endrology_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $qaqcrecord_endrology_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="qaqcrecord_endrology">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$qaqcrecord_endrology_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($qaqcrecord_endrology->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_qaqcrecord_endrology_id" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->id->caption() ?><?php echo ($qaqcrecord_endrology->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->id->cellAttributes() ?>>
...
<input type="hidden" data-table="qaqcrecord_endrology" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($qaqcrecord_endrology->id->CurrentValue) ?>">
<?php echo $qaqcrecord_endrology->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($qaqcrecord_endrology->Date->Visible) { // Date ?>
	<div id="r_Date" class="form-group row">
		<label id="elh_qaqcrecord_endrology_Date" for="x_Date" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->Date->caption() ?><?php echo ($qaqcrecord_endrology->Date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->Date->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fqaqcrecord_endrologyedit", "x_Date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($qaqcrecord_endrology->LN2_Level->Visible) { // LN2_Level ?>
	<div id="r_LN2_Level" class="form-group row">
		<label id="elh_qaqcrecord_endrology_LN2_Level" for="x_LN2_Level" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->LN2_Level->caption() ?><?php echo ($qaqcrecord_endrology->LN2_Level->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->LN2_Level->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->LN2_Checked->Visible) { // LN2_Checked ?>
	<div id="r_LN2_Checked" class="form-group row">
		<label id="elh_qaqcrecord_endrology_LN2_Checked" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->LN2_Checked->caption() ?><?php echo ($qaqcrecord_endrology->LN2_Checked->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->LN2_Checked->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->Incubator_Temp->Visible) { // Incubator_Temp ?>
	<div id="r_Incubator_Temp" class="form-group row">
		<label id="elh_qaqcrecord_endrology_Incubator_Temp" for="x_Incubator_Temp" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->Incubator_Temp->caption() ?><?php echo ($qaqcrecord_endrology->Incubator_Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->Incubator_Temp->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->Incubator_Cleaned->Visible) { // Incubator_Cleaned ?>
	<div id="r_Incubator_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_endrology_Incubator_Cleaned" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->Incubator_Cleaned->caption() ?><?php echo ($qaqcrecord_endrology->Incubator_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->Incubator_Cleaned->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->LAF_MG->Visible) { // LAF_MG ?>
	<div id="r_LAF_MG" class="form-group row">
		<label id="elh_qaqcrecord_endrology_LAF_MG" for="x_LAF_MG" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->LAF_MG->caption() ?><?php echo ($qaqcrecord_endrology->LAF_MG->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->LAF_MG->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->LAF_Cleaned->Visible) { // LAF_Cleaned ?>
	<div id="r_LAF_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_endrology_LAF_Cleaned" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->LAF_Cleaned->caption() ?><?php echo ($qaqcrecord_endrology->LAF_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->LAF_Cleaned->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->REF_Temp->Visible) { // REF_Temp ?>
	<div id="r_REF_Temp" class="form-group row">
		<label id="elh_qaqcrecord_endrology_REF_Temp" for="x_REF_Temp" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->REF_Temp->caption() ?><?php echo ($qaqcrecord_endrology->REF_Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->REF_Temp->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->REF_Cleaned->Visible) { // REF_Cleaned ?>
	<div id="r_REF_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_endrology_REF_Cleaned" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->REF_Cleaned->caption() ?><?php echo ($qaqcrecord_endrology->REF_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->REF_Cleaned->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->Heating_Temp->Visible) { // Heating_Temp ?>
	<div id="r_Heating_Temp" class="form-group row">
		<label id="elh_qaqcrecord_endrology_Heating_Temp" for="x_Heating_Temp" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->Heating_Temp->caption() ?><?php echo ($qaqcrecord_endrology->Heating_Temp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->Heating_Temp->cellAttributes() ?>>
...
<?php if ($qaqcrecord_endrology->Heating_Cleaned->Visible) { // Heating_Cleaned ?>
	<div id="r_Heating_Cleaned" class="form-group row">
		<label id="elh_qaqcrecord_endrology_Heating_Cleaned" class="<?php echo $qaqcrecord_endrology_edit->LeftColumnClass ?>"><?php echo $qaqcrecord_endrology->Heating_Cleaned->caption() ?><?php echo ($qaqcrecord_endrology->Heating_Cleaned->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $qaqcrecord_endrology_edit->RightColumnClass ?>"><div<?php echo $qaqcrecord_endrology->Heating_Cleaned->cellAttributes() ?>>
...
<?php if (!$qaqcrecord_endrology_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $qaqcrecord_endrology_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $qaqcrecord_endrology_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$qaqcrecord_endrology_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$qaqcrecord_endrology_edit->terminate();
?>