...
var fuser_loginadd = currentForm = new ew.Form("fuser_loginadd", "add");
...
fuser_loginadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($user_login_add->UserLevel->Required) { ?>
		...
		<?php } ?>
		<?php if ($user_login_add->OTP->Required) { ?>
		...
		<?php } ?>
		<?php if ($user_login_add->LoginType->Required) { ?>
		...
		<?php if ($user_login_add->BranchId->Required) { ?>
...
fuser_loginadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fuser_loginadd.lists["x_User_Name"] = <?php echo $user_login_add->User_Name->Lookup->toClientList() ?>;
...
fuser_loginadd.lists["x_email_verified"] = <?php echo $user_login_add->email_verified->Lookup->toClientList() ?>;
fuser_loginadd.lists["x_email_verified"].options = <?php echo JsonEncode($user_login_add->email_verified->options(FALSE, TRUE)) ?>;
fuser_loginadd.lists["x_UserLevel"] = <?php echo $user_login_add->UserLevel->Lookup->toClientList() ?>;
fuser_loginadd.lists["x_UserLevel"].options = <?php echo JsonEncode($user_login_add->UserLevel->lookupOptions()) ?>;
fuser_loginadd.lists["x_HospID"] = <?php echo $user_login_add->HospID->Lookup->toClientList() ?>;
fuser_loginadd.lists["x_HospID"].options = <?php echo JsonEncode($user_login_add->HospID->lookupOptions()) ?>;
fuser_loginadd.lists["x_PharID[]"] = <?php echo $user_login_add->PharID->Lookup->toClientList() ?>;
fuser_loginadd.lists["x_PharID[]"].options = <?php echo JsonEncode($user_login_add->PharID->lookupOptions()) ?>;
fuser_loginadd.lists["x_StoreID[]"] = <?php echo $user_login_add->StoreID->Lookup->toClientList() ?>;
...
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $user_login_add->Token ?>">
<?php } ?>
...
<?php if ($user_login->User_Name->Visible) { // User_Name ?>
	<div id="r_User_Name" class="form-group row">
		<label id="elh_user_login_User_Name" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->User_Name->caption() ?><?php echo ($user_login->User_Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->User_Name->cellAttributes() ?>>
...
<?php if ($user_login->mail_id->Visible) { // mail_id ?>
	<div id="r_mail_id" class="form-group row">
		<label id="elh_user_login_mail_id" for="x_mail_id" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->mail_id->caption() ?><?php echo ($user_login->mail_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->mail_id->cellAttributes() ?>>
...
<?php if ($user_login->mobile_no->Visible) { // mobile_no ?>
	<div id="r_mobile_no" class="form-group row">
		<label id="elh_user_login_mobile_no" for="x_mobile_no" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->mobile_no->caption() ?><?php echo ($user_login->mobile_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->mobile_no->cellAttributes() ?>>
...
<?php if ($user_login->password->Visible) { // password ?>
	<div id="r_password" class="form-group row">
		<label id="elh_user_login_password" for="x_password" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->password->caption() ?><?php echo ($user_login->password->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->password->cellAttributes() ?>>
<span id="el_user_login_password">
<input type="password" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($user_login->password->getPlaceHolder()) ?>"<?php echo $user_login->password->editAttributes() ?>>
</span>
...
<?php if ($user_login->email_verified->Visible) { // email_verified ?>
	<div id="r_email_verified" class="form-group row">
		<label id="elh_user_login_email_verified" for="x_email_verified" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->email_verified->caption() ?><?php echo ($user_login->email_verified->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->email_verified->cellAttributes() ?>>
...
<?php if ($user_login->UserLevel->Visible) { // UserLevel ?>
	<div id="r_UserLevel" class="form-group row">
		<label id="elh_user_login_UserLevel" for="x_UserLevel" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->UserLevel->caption() ?><?php echo ($user_login->UserLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->UserLevel->cellAttributes() ?>>
...
<?php if ($user_login->_UserID->Visible) { // UserID ?>
	<div id="r__UserID" class="form-group row">
		<label id="elh_user_login__UserID" for="x__UserID" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->_UserID->caption() ?><?php echo ($user_login->_UserID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->_UserID->cellAttributes() ?>>
...
<?php if ($user_login->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_user_login_HospID" for="x_HospID" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->HospID->caption() ?><?php echo ($user_login->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->HospID->cellAttributes() ?>>
...
<?php if ($user_login->PharID->Visible) { // PharID ?>
	<div id="r_PharID" class="form-group row">
		<label id="elh_user_login_PharID" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->PharID->caption() ?><?php echo ($user_login->PharID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->PharID->cellAttributes() ?>>
...
<?php if ($user_login->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_user_login_StoreID" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->StoreID->caption() ?><?php echo ($user_login->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->StoreID->cellAttributes() ?>>
...
<?php if ($user_login->OTP->Visible) { // OTP ?>
	<div id="r_OTP" class="form-group row">
		<label id="elh_user_login_OTP" for="x_OTP" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->OTP->caption() ?><?php echo ($user_login->OTP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->OTP->cellAttributes() ?>>
...
<?php if ($user_login->LoginType->Visible) { // LoginType ?>
	<div id="r_LoginType" class="form-group row">
		<label id="elh_user_login_LoginType" for="x_LoginType" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->LoginType->caption() ?><?php echo ($user_login->LoginType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->LoginType->cellAttributes() ?>>
...
<?php if ($user_login->BranchId->Visible) { // BranchId ?>
	<div id="r_BranchId" class="form-group row">
		<label id="elh_user_login_BranchId" for="x_BranchId" class="<?php echo $user_login_add->LeftColumnClass ?>"><?php echo $user_login->BranchId->caption() ?><?php echo ($user_login->BranchId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $user_login_add->RightColumnClass ?>"><div<?php echo $user_login->BranchId->cellAttributes() ?>>
