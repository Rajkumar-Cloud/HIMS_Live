...
var fpatient_ot_surgery_registeredit = currentForm = new ew.Form("fpatient_ot_surgery_registeredit", "edit");
...
fpatient_ot_surgery_registeredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_ot_surgery_registeredit.lists["x_Surgeon"] = <?php echo $patient_ot_surgery_register_edit->Surgeon->Lookup->toClientList() ?>;
...
fpatient_ot_surgery_registeredit.lists["x_Anaesthetist"] = <?php echo $patient_ot_surgery_register_edit->Anaesthetist->Lookup->toClientList() ?>;
...
fpatient_ot_surgery_registeredit.lists["x_AsstSurgeon1"] = <?php echo $patient_ot_surgery_register_edit->AsstSurgeon1->Lookup->toClientList() ?>;
...
fpatient_ot_surgery_registeredit.lists["x_AsstSurgeon2"] = <?php echo $patient_ot_surgery_register_edit->AsstSurgeon2->Lookup->toClientList() ?>;
...
fpatient_ot_surgery_registeredit.lists["x_paediatric"] = <?php echo $patient_ot_surgery_register_edit->paediatric->Lookup->toClientList() ?>;
...
fpatient_ot_surgery_registeredit.lists["x_PatientSearch"] = <?php echo $patient_ot_surgery_register_edit->PatientSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_ot_surgery_register_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_ot_surgery_register_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_ot_surgery_register->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_ot_surgery_register_id" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_id" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->id->caption() ?><?php echo ($patient_ot_surgery_register->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->id->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_id" class="patient_ot_surgery_registeredit" type="text/html">
...
<input type="hidden" data-table="patient_ot_surgery_register" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_ot_surgery_register->id->CurrentValue) ?>">
<?php echo $patient_ot_surgery_register->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_ot_surgery_register->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_ot_surgery_register_PatID" for="x_PatID" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_PatID" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->PatID->caption() ?><?php echo ($patient_ot_surgery_register->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->PatID->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_PatID" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_ot_surgery_register_PatientName" for="x_PatientName" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_PatientName" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->PatientName->caption() ?><?php echo ($patient_ot_surgery_register->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->PatientName->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_PatientName" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_ot_surgery_register_mrnno" for="x_mrnno" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_mrnno" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->mrnno->caption() ?><?php echo ($patient_ot_surgery_register->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->mrnno->cellAttributes() ?>>
<?php if ($patient_ot_surgery_register->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_ot_surgery_register_mrnno" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_ot_surgery_register_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_MobileNumber" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->MobileNumber->caption() ?><?php echo ($patient_ot_surgery_register->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_MobileNumber" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Age" for="x_Age" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Age" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Age->caption() ?><?php echo ($patient_ot_surgery_register->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Age->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_Age" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Gender" for="x_Gender" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Gender" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Gender->caption() ?><?php echo ($patient_ot_surgery_register->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Gender->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_Gender" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_ot_surgery_register_profilePic" for="x_profilePic" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_profilePic" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->profilePic->caption() ?><?php echo ($patient_ot_surgery_register->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->profilePic->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_profilePic" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->diagnosis->Visible) { // diagnosis ?>
	<div id="r_diagnosis" class="form-group row">
		<label id="elh_patient_ot_surgery_register_diagnosis" for="x_diagnosis" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_diagnosis" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->diagnosis->caption() ?><?php echo ($patient_ot_surgery_register->diagnosis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->diagnosis->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_diagnosis" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->proposedSurgery->Visible) { // proposedSurgery ?>
	<div id="r_proposedSurgery" class="form-group row">
		<label id="elh_patient_ot_surgery_register_proposedSurgery" for="x_proposedSurgery" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_proposedSurgery" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->proposedSurgery->caption() ?><?php echo ($patient_ot_surgery_register->proposedSurgery->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->proposedSurgery->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_proposedSurgery" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->surgeryProcedure->Visible) { // surgeryProcedure ?>
	<div id="r_surgeryProcedure" class="form-group row">
		<label id="elh_patient_ot_surgery_register_surgeryProcedure" for="x_surgeryProcedure" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_surgeryProcedure" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->surgeryProcedure->caption() ?><?php echo ($patient_ot_surgery_register->surgeryProcedure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->surgeryProcedure->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_surgeryProcedure" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->typeOfAnaesthesia->Visible) { // typeOfAnaesthesia ?>
	<div id="r_typeOfAnaesthesia" class="form-group row">
		<label id="elh_patient_ot_surgery_register_typeOfAnaesthesia" for="x_typeOfAnaesthesia" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_typeOfAnaesthesia" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->typeOfAnaesthesia->caption() ?><?php echo ($patient_ot_surgery_register->typeOfAnaesthesia->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->typeOfAnaesthesia->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_typeOfAnaesthesia" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->RecievedTime->Visible) { // RecievedTime ?>
	<div id="r_RecievedTime" class="form-group row">
		<label id="elh_patient_ot_surgery_register_RecievedTime" for="x_RecievedTime" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_RecievedTime" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->RecievedTime->caption() ?><?php echo ($patient_ot_surgery_register->RecievedTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->RecievedTime->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_RecievedTime" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->AnaesthesiaStarted->Visible) { // AnaesthesiaStarted ?>
	<div id="r_AnaesthesiaStarted" class="form-group row">
		<label id="elh_patient_ot_surgery_register_AnaesthesiaStarted" for="x_AnaesthesiaStarted" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_AnaesthesiaStarted" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->AnaesthesiaStarted->caption() ?><?php echo ($patient_ot_surgery_register->AnaesthesiaStarted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->AnaesthesiaStarted->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_AnaesthesiaStarted" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->AnaesthesiaEnded->Visible) { // AnaesthesiaEnded ?>
	<div id="r_AnaesthesiaEnded" class="form-group row">
		<label id="elh_patient_ot_surgery_register_AnaesthesiaEnded" for="x_AnaesthesiaEnded" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_AnaesthesiaEnded" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->AnaesthesiaEnded->caption() ?><?php echo ($patient_ot_surgery_register->AnaesthesiaEnded->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->AnaesthesiaEnded->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_AnaesthesiaEnded" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->surgeryStarted->Visible) { // surgeryStarted ?>
	<div id="r_surgeryStarted" class="form-group row">
		<label id="elh_patient_ot_surgery_register_surgeryStarted" for="x_surgeryStarted" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_surgeryStarted" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->surgeryStarted->caption() ?><?php echo ($patient_ot_surgery_register->surgeryStarted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->surgeryStarted->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_surgeryStarted" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->surgeryEnded->Visible) { // surgeryEnded ?>
	<div id="r_surgeryEnded" class="form-group row">
		<label id="elh_patient_ot_surgery_register_surgeryEnded" for="x_surgeryEnded" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_surgeryEnded" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->surgeryEnded->caption() ?><?php echo ($patient_ot_surgery_register->surgeryEnded->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->surgeryEnded->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_surgeryEnded" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->RecoveryTime->Visible) { // RecoveryTime ?>
	<div id="r_RecoveryTime" class="form-group row">
		<label id="elh_patient_ot_surgery_register_RecoveryTime" for="x_RecoveryTime" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_RecoveryTime" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->RecoveryTime->caption() ?><?php echo ($patient_ot_surgery_register->RecoveryTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->RecoveryTime->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_RecoveryTime" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->ShiftedTime->Visible) { // ShiftedTime ?>
	<div id="r_ShiftedTime" class="form-group row">
		<label id="elh_patient_ot_surgery_register_ShiftedTime" for="x_ShiftedTime" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_ShiftedTime" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->ShiftedTime->caption() ?><?php echo ($patient_ot_surgery_register->ShiftedTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->ShiftedTime->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_ShiftedTime" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->Duration->Visible) { // Duration ?>
	<div id="r_Duration" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Duration" for="x_Duration" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Duration" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Duration->caption() ?><?php echo ($patient_ot_surgery_register->Duration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Duration->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_Duration" class="patient_ot_surgery_registeredit" type="text/html">
...
<script type="text/html" class="patient_ot_surgery_registeredit_js">ew.createTimePicker("fpatient_ot_surgery_registeredit", "x_Duration", {"timeFormat":"h:i A","step":15});
</script>
...
<?php if ($patient_ot_surgery_register->Surgeon->Visible) { // Surgeon ?>
	<div id="r_Surgeon" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Surgeon" for="x_Surgeon" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Surgeon" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Surgeon->caption() ?><?php echo ($patient_ot_surgery_register->Surgeon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Surgeon->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_Surgeon" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->Anaesthetist->Visible) { // Anaesthetist ?>
	<div id="r_Anaesthetist" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Anaesthetist" for="x_Anaesthetist" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Anaesthetist" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Anaesthetist->caption() ?><?php echo ($patient_ot_surgery_register->Anaesthetist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Anaesthetist->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_Anaesthetist" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->AsstSurgeon1->Visible) { // AsstSurgeon1 ?>
	<div id="r_AsstSurgeon1" class="form-group row">
		<label id="elh_patient_ot_surgery_register_AsstSurgeon1" for="x_AsstSurgeon1" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_AsstSurgeon1" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->AsstSurgeon1->caption() ?><?php echo ($patient_ot_surgery_register->AsstSurgeon1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->AsstSurgeon1->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_AsstSurgeon1" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->AsstSurgeon2->Visible) { // AsstSurgeon2 ?>
	<div id="r_AsstSurgeon2" class="form-group row">
		<label id="elh_patient_ot_surgery_register_AsstSurgeon2" for="x_AsstSurgeon2" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_AsstSurgeon2" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->AsstSurgeon2->caption() ?><?php echo ($patient_ot_surgery_register->AsstSurgeon2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->AsstSurgeon2->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_AsstSurgeon2" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->paediatric->Visible) { // paediatric ?>
	<div id="r_paediatric" class="form-group row">
		<label id="elh_patient_ot_surgery_register_paediatric" for="x_paediatric" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_paediatric" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->paediatric->caption() ?><?php echo ($patient_ot_surgery_register->paediatric->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->paediatric->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_paediatric" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->ScrubNurse1->Visible) { // ScrubNurse1 ?>
	<div id="r_ScrubNurse1" class="form-group row">
		<label id="elh_patient_ot_surgery_register_ScrubNurse1" for="x_ScrubNurse1" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_ScrubNurse1" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->ScrubNurse1->caption() ?><?php echo ($patient_ot_surgery_register->ScrubNurse1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->ScrubNurse1->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_ScrubNurse1" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->ScrubNurse2->Visible) { // ScrubNurse2 ?>
	<div id="r_ScrubNurse2" class="form-group row">
		<label id="elh_patient_ot_surgery_register_ScrubNurse2" for="x_ScrubNurse2" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_ScrubNurse2" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->ScrubNurse2->caption() ?><?php echo ($patient_ot_surgery_register->ScrubNurse2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->ScrubNurse2->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_ScrubNurse2" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->FloorNurse->Visible) { // FloorNurse ?>
	<div id="r_FloorNurse" class="form-group row">
		<label id="elh_patient_ot_surgery_register_FloorNurse" for="x_FloorNurse" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_FloorNurse" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->FloorNurse->caption() ?><?php echo ($patient_ot_surgery_register->FloorNurse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->FloorNurse->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_FloorNurse" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->Technician->Visible) { // Technician ?>
	<div id="r_Technician" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Technician" for="x_Technician" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Technician" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Technician->caption() ?><?php echo ($patient_ot_surgery_register->Technician->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Technician->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_Technician" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->HouseKeeping->Visible) { // HouseKeeping ?>
	<div id="r_HouseKeeping" class="form-group row">
		<label id="elh_patient_ot_surgery_register_HouseKeeping" for="x_HouseKeeping" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_HouseKeeping" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->HouseKeeping->caption() ?><?php echo ($patient_ot_surgery_register->HouseKeeping->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->HouseKeeping->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_HouseKeeping" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->countsCheckedMops->Visible) { // countsCheckedMops ?>
	<div id="r_countsCheckedMops" class="form-group row">
		<label id="elh_patient_ot_surgery_register_countsCheckedMops" for="x_countsCheckedMops" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_countsCheckedMops" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->countsCheckedMops->caption() ?><?php echo ($patient_ot_surgery_register->countsCheckedMops->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->countsCheckedMops->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_countsCheckedMops" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->gauze->Visible) { // gauze ?>
	<div id="r_gauze" class="form-group row">
		<label id="elh_patient_ot_surgery_register_gauze" for="x_gauze" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_gauze" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->gauze->caption() ?><?php echo ($patient_ot_surgery_register->gauze->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->gauze->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_gauze" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->needles->Visible) { // needles ?>
	<div id="r_needles" class="form-group row">
		<label id="elh_patient_ot_surgery_register_needles" for="x_needles" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_needles" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->needles->caption() ?><?php echo ($patient_ot_surgery_register->needles->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->needles->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_needles" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->bloodloss->Visible) { // bloodloss ?>
	<div id="r_bloodloss" class="form-group row">
		<label id="elh_patient_ot_surgery_register_bloodloss" for="x_bloodloss" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_bloodloss" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->bloodloss->caption() ?><?php echo ($patient_ot_surgery_register->bloodloss->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->bloodloss->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_bloodloss" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->bloodtransfusion->Visible) { // bloodtransfusion ?>
	<div id="r_bloodtransfusion" class="form-group row">
		<label id="elh_patient_ot_surgery_register_bloodtransfusion" for="x_bloodtransfusion" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_bloodtransfusion" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->bloodtransfusion->caption() ?><?php echo ($patient_ot_surgery_register->bloodtransfusion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->bloodtransfusion->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_bloodtransfusion" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->implantsUsed->Visible) { // implantsUsed ?>
	<div id="r_implantsUsed" class="form-group row">
		<label id="elh_patient_ot_surgery_register_implantsUsed" for="x_implantsUsed" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_implantsUsed" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->implantsUsed->caption() ?><?php echo ($patient_ot_surgery_register->implantsUsed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->implantsUsed->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_implantsUsed" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->MaterialsForHPE->Visible) { // MaterialsForHPE ?>
	<div id="r_MaterialsForHPE" class="form-group row">
		<label id="elh_patient_ot_surgery_register_MaterialsForHPE" for="x_MaterialsForHPE" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_MaterialsForHPE" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->MaterialsForHPE->caption() ?><?php echo ($patient_ot_surgery_register->MaterialsForHPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->MaterialsForHPE->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_MaterialsForHPE" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_ot_surgery_register_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_PatientSearch" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->PatientSearch->caption() ?><?php echo ($patient_ot_surgery_register->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_PatientSearch" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_ot_surgery_register_Reception" for="x_Reception" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_Reception" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->Reception->caption() ?><?php echo ($patient_ot_surgery_register->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->Reception->cellAttributes() ?>>
<?php if ($patient_ot_surgery_register->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_ot_surgery_register_Reception" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_patient_ot_surgery_register_PatientID" for="x_PatientID" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_PatientID" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->PatientID->caption() ?><?php echo ($patient_ot_surgery_register->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->PatientID->cellAttributes() ?>>
<script id="tpx_patient_ot_surgery_register_PatientID" class="patient_ot_surgery_registeredit" type="text/html">
...
<?php if ($patient_ot_surgery_register->PId->Visible) { // PId ?>
	<div id="r_PId" class="form-group row">
		<label id="elh_patient_ot_surgery_register_PId" for="x_PId" class="<?php echo $patient_ot_surgery_register_edit->LeftColumnClass ?>"><script id="tpc_patient_ot_surgery_register_PId" class="patient_ot_surgery_registeredit" type="text/html"><span><?php echo $patient_ot_surgery_register->PId->caption() ?><?php echo ($patient_ot_surgery_register->PId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_ot_surgery_register_edit->RightColumnClass ?>"><div<?php echo $patient_ot_surgery_register->PId->cellAttributes() ?>>
<?php if ($patient_ot_surgery_register->PId->getSessionValue() <> "") { ?>
<script id="tpx_patient_ot_surgery_register_PId" class="patient_ot_surgery_registeredit" type="text/html">
...
ew.applyTemplate("tpd_patient_ot_surgery_registeredit", "tpm_patient_ot_surgery_registeredit", "patient_ot_surgery_registeredit", "<?php echo $patient_ot_surgery_register->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_ot_surgery_registeredit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
