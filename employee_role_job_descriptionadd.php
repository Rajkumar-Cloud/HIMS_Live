...
var femployee_role_job_descriptionadd = currentForm = new ew.Form("femployee_role_job_descriptionadd", "add");
...
femployee_role_job_descriptionadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($employee_role_job_description_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_role_job_description_add->Token ?>">
<?php } ?>
...
<?php if ($employee_role_job_description->role->Visible) { // role ?>
	<div id="r_role" class="form-group row">
		<label id="elh_employee_role_job_description_role" for="x_role" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->role->caption() ?><?php echo ($employee_role_job_description->role->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->role->cellAttributes() ?>>
...
<?php if ($employee_role_job_description->job_description->Visible) { // job_description ?>
	<div id="r_job_description" class="form-group row">
		<label id="elh_employee_role_job_description_job_description" for="x_job_description" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->job_description->caption() ?><?php echo ($employee_role_job_description->job_description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->job_description->cellAttributes() ?>>
...
<?php if ($employee_role_job_description->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_role_job_description_status" for="x_status" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->status->caption() ?><?php echo ($employee_role_job_description->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->status->cellAttributes() ?>>
...
<?php if ($employee_role_job_description->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_employee_role_job_description_createdby" for="x_createdby" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->createdby->caption() ?><?php echo ($employee_role_job_description->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->createdby->cellAttributes() ?>>
...
<?php if ($employee_role_job_description->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_employee_role_job_description_createddatetime" for="x_createddatetime" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->createddatetime->caption() ?><?php echo ($employee_role_job_description->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->createddatetime->cellAttributes() ?>>
...
<?php if ($employee_role_job_description->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_employee_role_job_description_modifiedby" for="x_modifiedby" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->modifiedby->caption() ?><?php echo ($employee_role_job_description->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->modifiedby->cellAttributes() ?>>
...
<?php if ($employee_role_job_description->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_employee_role_job_description_modifieddatetime" for="x_modifieddatetime" class="<?php echo $employee_role_job_description_add->LeftColumnClass ?>"><?php echo $employee_role_job_description->modifieddatetime->caption() ?><?php echo ($employee_role_job_description->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_role_job_description_add->RightColumnClass ?>"><div<?php echo $employee_role_job_description->modifieddatetime->cellAttributes() ?>>
