...
var fpharmacy_combinationedit = currentForm = new ew.Form("fpharmacy_combinationedit", "edit");
...
fpharmacy_combinationedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_combination_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $pharmacy_combination->id->caption(), $pharmacy_combination->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fpharmacy_combinationedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_combinationedit.lists["x_GENCODE"] = <?php echo $pharmacy_combination_edit->GENCODE->Lookup->toClientList() ?>;
fpharmacy_combinationedit.lists["x_GENCODE"].options = <?php echo JsonEncode($pharmacy_combination_edit->GENCODE->lookupOptions()) ?>;
fpharmacy_combinationedit.lists["x_COMBCODE"] = <?php echo $pharmacy_combination_edit->COMBCODE->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_combination_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_combination_edit->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_combination->GENCODE->Visible) { // GENCODE ?>
	<div id="r_GENCODE" class="form-group row">
		<label id="elh_pharmacy_combination_GENCODE" for="x_GENCODE" class="<?php echo $pharmacy_combination_edit->LeftColumnClass ?>"><?php echo $pharmacy_combination->GENCODE->caption() ?><?php echo ($pharmacy_combination->GENCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_combination_edit->RightColumnClass ?>"><div<?php echo $pharmacy_combination->GENCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_combination->COMBCODE->Visible) { // COMBCODE ?>
	<div id="r_COMBCODE" class="form-group row">
		<label id="elh_pharmacy_combination_COMBCODE" for="x_COMBCODE" class="<?php echo $pharmacy_combination_edit->LeftColumnClass ?>"><?php echo $pharmacy_combination->COMBCODE->caption() ?><?php echo ($pharmacy_combination->COMBCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_combination_edit->RightColumnClass ?>"><div<?php echo $pharmacy_combination->COMBCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_combination->STRENGTH->Visible) { // STRENGTH ?>
	<div id="r_STRENGTH" class="form-group row">
		<label id="elh_pharmacy_combination_STRENGTH" for="x_STRENGTH" class="<?php echo $pharmacy_combination_edit->LeftColumnClass ?>"><?php echo $pharmacy_combination->STRENGTH->caption() ?><?php echo ($pharmacy_combination->STRENGTH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_combination_edit->RightColumnClass ?>"><div<?php echo $pharmacy_combination->STRENGTH->cellAttributes() ?>>
...
<?php if ($pharmacy_combination->SLNO->Visible) { // SLNO ?>
	<div id="r_SLNO" class="form-group row">
		<label id="elh_pharmacy_combination_SLNO" for="x_SLNO" class="<?php echo $pharmacy_combination_edit->LeftColumnClass ?>"><?php echo $pharmacy_combination->SLNO->caption() ?><?php echo ($pharmacy_combination->SLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_combination_edit->RightColumnClass ?>"><div<?php echo $pharmacy_combination->SLNO->cellAttributes() ?>>
...
<?php if ($pharmacy_combination->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_pharmacy_combination_id" class="<?php echo $pharmacy_combination_edit->LeftColumnClass ?>"><?php echo $pharmacy_combination->id->caption() ?><?php echo ($pharmacy_combination->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_combination_edit->RightColumnClass ?>"><div<?php echo $pharmacy_combination->id->cellAttributes() ?>>
<span id="el_pharmacy_combination_id">
<span<?php echo $pharmacy_combination->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($pharmacy_combination->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="pharmacy_combination" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($pharmacy_combination->id->CurrentValue) ?>">
<?php echo $pharmacy_combination->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
