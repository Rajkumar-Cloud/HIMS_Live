...
var fstore_batchmasadd = currentForm = new ew.Form("fstore_batchmasadd", "add");
...
fstore_batchmasadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($store_batchmas_add->FRQ->Required) { ?>
		...
		<?php if ($store_batchmas_add->HospID->Required) { ?>
		...
		<?php if ($store_batchmas_add->UM->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_batchmas_add->GENNAME->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_batchmas_add->BILLDATE->Required) { ?>
		...
		<?php if ($store_batchmas_add->PUnit->Required) { ?>
		...
		<?php if ($store_batchmas_add->SUnit->Required) { ?>
		...
		<?php if ($store_batchmas_add->PurValue->Required) { ?>
		...
		<?php if ($store_batchmas_add->PurRate->Required) { ?>
		...
		<?php if ($store_batchmas_add->StoreID->Required) { ?>
...
fstore_batchmasadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($store_batchmas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_batchmas_add->Token ?>">
<?php } ?>
...
<?php if ($store_batchmas->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_store_batchmas_PRC" for="x_PRC" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PRC->caption() ?><?php echo ($store_batchmas->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PRC->cellAttributes() ?>>
...
<?php if ($store_batchmas->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_store_batchmas_BATCHNO" for="x_BATCHNO" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->BATCHNO->caption() ?><?php echo ($store_batchmas->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->BATCHNO->cellAttributes() ?>>
...
<?php if ($store_batchmas->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_store_batchmas_OQ" for="x_OQ" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->OQ->caption() ?><?php echo ($store_batchmas->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->OQ->cellAttributes() ?>>
...
<?php if ($store_batchmas->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_store_batchmas_RQ" for="x_RQ" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->RQ->caption() ?><?php echo ($store_batchmas->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->RQ->cellAttributes() ?>>
...
<?php if ($store_batchmas->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_store_batchmas_MRQ" for="x_MRQ" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->MRQ->caption() ?><?php echo ($store_batchmas->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->MRQ->cellAttributes() ?>>
...
<?php if ($store_batchmas->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_store_batchmas_IQ" for="x_IQ" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->IQ->caption() ?><?php echo ($store_batchmas->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->IQ->cellAttributes() ?>>
...
<?php if ($store_batchmas->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_store_batchmas_MRP" for="x_MRP" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->MRP->caption() ?><?php echo ($store_batchmas->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->MRP->cellAttributes() ?>>
...
<?php if ($store_batchmas->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_store_batchmas_EXPDT" for="x_EXPDT" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->EXPDT->caption() ?><?php echo ($store_batchmas->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->EXPDT->cellAttributes() ?>>
...
<?php if ($store_batchmas->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_store_batchmas_UR" for="x_UR" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->UR->caption() ?><?php echo ($store_batchmas->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->UR->cellAttributes() ?>>
...
<?php if ($store_batchmas->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_store_batchmas_RT" for="x_RT" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->RT->caption() ?><?php echo ($store_batchmas->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->RT->cellAttributes() ?>>
...
<?php if ($store_batchmas->PRCODE->Visible) { // PRCODE ?>
	<div id="r_PRCODE" class="form-group row">
		<label id="elh_store_batchmas_PRCODE" for="x_PRCODE" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PRCODE->caption() ?><?php echo ($store_batchmas->PRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PRCODE->cellAttributes() ?>>
...
<?php if ($store_batchmas->BATCH->Visible) { // BATCH ?>
	<div id="r_BATCH" class="form-group row">
		<label id="elh_store_batchmas_BATCH" for="x_BATCH" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->BATCH->caption() ?><?php echo ($store_batchmas->BATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->BATCH->cellAttributes() ?>>
...
<?php if ($store_batchmas->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_store_batchmas_PC" for="x_PC" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PC->caption() ?><?php echo ($store_batchmas->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PC->cellAttributes() ?>>
...
<?php if ($store_batchmas->OLDRT->Visible) { // OLDRT ?>
	<div id="r_OLDRT" class="form-group row">
		<label id="elh_store_batchmas_OLDRT" for="x_OLDRT" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->OLDRT->caption() ?><?php echo ($store_batchmas->OLDRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->OLDRT->cellAttributes() ?>>
...
<?php if ($store_batchmas->TEMPMRQ->Visible) { // TEMPMRQ ?>
	<div id="r_TEMPMRQ" class="form-group row">
		<label id="elh_store_batchmas_TEMPMRQ" for="x_TEMPMRQ" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->TEMPMRQ->caption() ?><?php echo ($store_batchmas->TEMPMRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->TEMPMRQ->cellAttributes() ?>>
...
<?php if ($store_batchmas->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_store_batchmas_TAXP" for="x_TAXP" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->TAXP->caption() ?><?php echo ($store_batchmas->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->TAXP->cellAttributes() ?>>
...
<?php if ($store_batchmas->OLDRATE->Visible) { // OLDRATE ?>
	<div id="r_OLDRATE" class="form-group row">
		<label id="elh_store_batchmas_OLDRATE" for="x_OLDRATE" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->OLDRATE->caption() ?><?php echo ($store_batchmas->OLDRATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->OLDRATE->cellAttributes() ?>>
...
<?php if ($store_batchmas->NEWRATE->Visible) { // NEWRATE ?>
	<div id="r_NEWRATE" class="form-group row">
		<label id="elh_store_batchmas_NEWRATE" for="x_NEWRATE" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->NEWRATE->caption() ?><?php echo ($store_batchmas->NEWRATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->NEWRATE->cellAttributes() ?>>
...
<?php if ($store_batchmas->OTEMPMRA->Visible) { // OTEMPMRA ?>
	<div id="r_OTEMPMRA" class="form-group row">
		<label id="elh_store_batchmas_OTEMPMRA" for="x_OTEMPMRA" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->OTEMPMRA->caption() ?><?php echo ($store_batchmas->OTEMPMRA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->OTEMPMRA->cellAttributes() ?>>
...
<?php if ($store_batchmas->ACTIVESTATUS->Visible) { // ACTIVESTATUS ?>
	<div id="r_ACTIVESTATUS" class="form-group row">
		<label id="elh_store_batchmas_ACTIVESTATUS" for="x_ACTIVESTATUS" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->ACTIVESTATUS->caption() ?><?php echo ($store_batchmas->ACTIVESTATUS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->ACTIVESTATUS->cellAttributes() ?>>
...
<?php if ($store_batchmas->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_store_batchmas_PrName" for="x_PrName" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PrName->caption() ?><?php echo ($store_batchmas->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PrName->cellAttributes() ?>>
...
<?php if ($store_batchmas->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_store_batchmas_PSGST" for="x_PSGST" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PSGST->caption() ?><?php echo ($store_batchmas->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PSGST->cellAttributes() ?>>
...
<?php if ($store_batchmas->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_store_batchmas_PCGST" for="x_PCGST" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PCGST->caption() ?><?php echo ($store_batchmas->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PCGST->cellAttributes() ?>>
...
<?php if ($store_batchmas->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_store_batchmas_SSGST" for="x_SSGST" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->SSGST->caption() ?><?php echo ($store_batchmas->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->SSGST->cellAttributes() ?>>
...
<?php if ($store_batchmas->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_store_batchmas_SCGST" for="x_SCGST" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->SCGST->caption() ?><?php echo ($store_batchmas->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->SCGST->cellAttributes() ?>>
...
<?php if ($store_batchmas->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_store_batchmas_MFRCODE" for="x_MFRCODE" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->MFRCODE->caption() ?><?php echo ($store_batchmas->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->MFRCODE->cellAttributes() ?>>
...
<?php if ($store_batchmas->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_store_batchmas_BRCODE" for="x_BRCODE" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->BRCODE->caption() ?><?php echo ($store_batchmas->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->BRCODE->cellAttributes() ?>>
...
<?php if ($store_batchmas->FRQ->Visible) { // FRQ ?>
	<div id="r_FRQ" class="form-group row">
		<label id="elh_store_batchmas_FRQ" for="x_FRQ" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->FRQ->caption() ?><?php echo ($store_batchmas->FRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->FRQ->cellAttributes() ?>>
...
<?php if ($store_batchmas->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_store_batchmas_HospID" for="x_HospID" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->HospID->caption() ?><?php echo ($store_batchmas->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->HospID->cellAttributes() ?>>
...
<?php if ($store_batchmas->UM->Visible) { // UM ?>
	<div id="r_UM" class="form-group row">
		<label id="elh_store_batchmas_UM" for="x_UM" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->UM->caption() ?><?php echo ($store_batchmas->UM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->UM->cellAttributes() ?>>
...
<?php if ($store_batchmas->GENNAME->Visible) { // GENNAME ?>
	<div id="r_GENNAME" class="form-group row">
		<label id="elh_store_batchmas_GENNAME" for="x_GENNAME" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->GENNAME->caption() ?><?php echo ($store_batchmas->GENNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->GENNAME->cellAttributes() ?>>
...
<?php if ($store_batchmas->BILLDATE->Visible) { // BILLDATE ?>
	<div id="r_BILLDATE" class="form-group row">
		<label id="elh_store_batchmas_BILLDATE" for="x_BILLDATE" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->BILLDATE->caption() ?><?php echo ($store_batchmas->BILLDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->BILLDATE->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_batchmasadd", "x_BILLDATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_batchmas->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_store_batchmas_PUnit" for="x_PUnit" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PUnit->caption() ?><?php echo ($store_batchmas->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PUnit->cellAttributes() ?>>
...
<?php if ($store_batchmas->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_store_batchmas_SUnit" for="x_SUnit" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->SUnit->caption() ?><?php echo ($store_batchmas->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->SUnit->cellAttributes() ?>>
...
<?php if ($store_batchmas->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_store_batchmas_PurValue" for="x_PurValue" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PurValue->caption() ?><?php echo ($store_batchmas->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PurValue->cellAttributes() ?>>
...
<?php if ($store_batchmas->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_store_batchmas_PurRate" for="x_PurRate" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->PurRate->caption() ?><?php echo ($store_batchmas->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->PurRate->cellAttributes() ?>>
...
<?php if ($store_batchmas->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_batchmas_StoreID" for="x_StoreID" class="<?php echo $store_batchmas_add->LeftColumnClass ?>"><?php echo $store_batchmas->StoreID->caption() ?><?php echo ($store_batchmas->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_batchmas_add->RightColumnClass ?>"><div<?php echo $store_batchmas->StoreID->cellAttributes() ?>>
