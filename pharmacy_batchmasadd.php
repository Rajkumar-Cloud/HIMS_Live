...
var fpharmacy_batchmasadd = currentForm = new ew.Form("fpharmacy_batchmasadd", "add");
...
fpharmacy_batchmasadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_batchmas_add->PUnit->Required) { ?>
		...
		<?php if ($pharmacy_batchmas_add->SUnit->Required) { ?>
		...
		<?php if ($pharmacy_batchmas_add->PurValue->Required) { ?>
		...
		<?php if ($pharmacy_batchmas_add->PurRate->Required) { ?>
...
fpharmacy_batchmasadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_batchmasadd.lists["x_PrName"] = <?php echo $pharmacy_batchmas_add->PrName->Lookup->toClientList() ?>;
...
fpharmacy_batchmasadd.lists["x_BRCODE"] = <?php echo $pharmacy_batchmas_add->BRCODE->Lookup->toClientList() ?>;
...
<?php if ($pharmacy_batchmas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_batchmas_add->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_batchmas->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_pharmacy_batchmas_PRC" for="x_PRC" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PRC->caption() ?><?php echo ($pharmacy_batchmas->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PRC->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_pharmacy_batchmas_PrName" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PrName->caption() ?><?php echo ($pharmacy_batchmas->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PrName->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_pharmacy_batchmas_BATCHNO" for="x_BATCHNO" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->BATCHNO->caption() ?><?php echo ($pharmacy_batchmas->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->BATCHNO->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->BATCH->Visible) { // BATCH ?>
	<div id="r_BATCH" class="form-group row">
		<label id="elh_pharmacy_batchmas_BATCH" for="x_BATCH" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->BATCH->caption() ?><?php echo ($pharmacy_batchmas->BATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->BATCH->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_pharmacy_batchmas_MFRCODE" for="x_MFRCODE" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->MFRCODE->caption() ?><?php echo ($pharmacy_batchmas->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->MFRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_pharmacy_batchmas_EXPDT" for="x_EXPDT" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->EXPDT->caption() ?><?php echo ($pharmacy_batchmas->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->EXPDT->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PRCODE->Visible) { // PRCODE ?>
	<div id="r_PRCODE" class="form-group row">
		<label id="elh_pharmacy_batchmas_PRCODE" for="x_PRCODE" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PRCODE->caption() ?><?php echo ($pharmacy_batchmas->PRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_pharmacy_batchmas_OQ" for="x_OQ" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->OQ->caption() ?><?php echo ($pharmacy_batchmas->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->OQ->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_pharmacy_batchmas_RQ" for="x_RQ" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->RQ->caption() ?><?php echo ($pharmacy_batchmas->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->RQ->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->FRQ->Visible) { // FRQ ?>
	<div id="r_FRQ" class="form-group row">
		<label id="elh_pharmacy_batchmas_FRQ" for="x_FRQ" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->FRQ->caption() ?><?php echo ($pharmacy_batchmas->FRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->FRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_pharmacy_batchmas_IQ" for="x_IQ" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->IQ->caption() ?><?php echo ($pharmacy_batchmas->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->IQ->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_pharmacy_batchmas_MRQ" for="x_MRQ" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->MRQ->caption() ?><?php echo ($pharmacy_batchmas->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->MRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_pharmacy_batchmas_MRP" for="x_MRP" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->MRP->caption() ?><?php echo ($pharmacy_batchmas->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->MRP->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_pharmacy_batchmas_UR" for="x_UR" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->UR->caption() ?><?php echo ($pharmacy_batchmas->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->UR->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_pharmacy_batchmas_PC" for="x_PC" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PC->caption() ?><?php echo ($pharmacy_batchmas->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PC->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->OLDRT->Visible) { // OLDRT ?>
	<div id="r_OLDRT" class="form-group row">
		<label id="elh_pharmacy_batchmas_OLDRT" for="x_OLDRT" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->OLDRT->caption() ?><?php echo ($pharmacy_batchmas->OLDRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->OLDRT->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->TEMPMRQ->Visible) { // TEMPMRQ ?>
	<div id="r_TEMPMRQ" class="form-group row">
		<label id="elh_pharmacy_batchmas_TEMPMRQ" for="x_TEMPMRQ" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->TEMPMRQ->caption() ?><?php echo ($pharmacy_batchmas->TEMPMRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->TEMPMRQ->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_pharmacy_batchmas_TAXP" for="x_TAXP" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->TAXP->caption() ?><?php echo ($pharmacy_batchmas->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->TAXP->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->OLDRATE->Visible) { // OLDRATE ?>
	<div id="r_OLDRATE" class="form-group row">
		<label id="elh_pharmacy_batchmas_OLDRATE" for="x_OLDRATE" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->OLDRATE->caption() ?><?php echo ($pharmacy_batchmas->OLDRATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->OLDRATE->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->NEWRATE->Visible) { // NEWRATE ?>
	<div id="r_NEWRATE" class="form-group row">
		<label id="elh_pharmacy_batchmas_NEWRATE" for="x_NEWRATE" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->NEWRATE->caption() ?><?php echo ($pharmacy_batchmas->NEWRATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->NEWRATE->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->OTEMPMRA->Visible) { // OTEMPMRA ?>
	<div id="r_OTEMPMRA" class="form-group row">
		<label id="elh_pharmacy_batchmas_OTEMPMRA" for="x_OTEMPMRA" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->OTEMPMRA->caption() ?><?php echo ($pharmacy_batchmas->OTEMPMRA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->OTEMPMRA->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->ACTIVESTATUS->Visible) { // ACTIVESTATUS ?>
	<div id="r_ACTIVESTATUS" class="form-group row">
		<label id="elh_pharmacy_batchmas_ACTIVESTATUS" for="x_ACTIVESTATUS" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->ACTIVESTATUS->caption() ?><?php echo ($pharmacy_batchmas->ACTIVESTATUS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->ACTIVESTATUS->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_pharmacy_batchmas_PSGST" for="x_PSGST" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PSGST->caption() ?><?php echo ($pharmacy_batchmas->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_pharmacy_batchmas_PCGST" for="x_PCGST" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PCGST->caption() ?><?php echo ($pharmacy_batchmas->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_pharmacy_batchmas_SSGST" for="x_SSGST" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->SSGST->caption() ?><?php echo ($pharmacy_batchmas->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->SSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_pharmacy_batchmas_SCGST" for="x_SCGST" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->SCGST->caption() ?><?php echo ($pharmacy_batchmas->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->SCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_pharmacy_batchmas_RT" for="x_RT" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->RT->caption() ?><?php echo ($pharmacy_batchmas->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->RT->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_pharmacy_batchmas_BRCODE" for="x_BRCODE" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->BRCODE->caption() ?><?php echo ($pharmacy_batchmas->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->BRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_pharmacy_batchmas_HospID" for="x_HospID" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->HospID->caption() ?><?php echo ($pharmacy_batchmas->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->HospID->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->UM->Visible) { // UM ?>
	<div id="r_UM" class="form-group row">
		<label id="elh_pharmacy_batchmas_UM" for="x_UM" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->UM->caption() ?><?php echo ($pharmacy_batchmas->UM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->UM->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->GENNAME->Visible) { // GENNAME ?>
	<div id="r_GENNAME" class="form-group row">
		<label id="elh_pharmacy_batchmas_GENNAME" for="x_GENNAME" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->GENNAME->caption() ?><?php echo ($pharmacy_batchmas->GENNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->GENNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->BILLDATE->Visible) { // BILLDATE ?>
	<div id="r_BILLDATE" class="form-group row">
		<label id="elh_pharmacy_batchmas_BILLDATE" for="x_BILLDATE" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->BILLDATE->caption() ?><?php echo ($pharmacy_batchmas->BILLDATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->BILLDATE->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_pharmacy_batchmas_PUnit" for="x_PUnit" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PUnit->caption() ?><?php echo ($pharmacy_batchmas->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_pharmacy_batchmas_SUnit" for="x_SUnit" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->SUnit->caption() ?><?php echo ($pharmacy_batchmas->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->SUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_pharmacy_batchmas_PurValue" for="x_PurValue" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PurValue->caption() ?><?php echo ($pharmacy_batchmas->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PurValue->cellAttributes() ?>>
...
<?php if ($pharmacy_batchmas->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_pharmacy_batchmas_PurRate" for="x_PurRate" class="<?php echo $pharmacy_batchmas_add->LeftColumnClass ?>"><?php echo $pharmacy_batchmas->PurRate->caption() ?><?php echo ($pharmacy_batchmas->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_batchmas_add->RightColumnClass ?>"><div<?php echo $pharmacy_batchmas->PurRate->cellAttributes() ?>>
