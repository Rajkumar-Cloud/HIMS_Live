...
// Create page object
$recruitment_candidates_add = new recruitment_candidates_add();

// Run the page
$recruitment_candidates_add->run();
...
$recruitment_candidates_add->Page_Render();
?>
...
var frecruitment_candidatesadd = currentForm = new ew.Form("frecruitment_candidatesadd", "add");

// Validate form
frecruitment_candidatesadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($recruitment_candidates_add->first_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->last_name->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->nationality->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->birthday->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->gender->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->marital_status->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->address1->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->address2->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->city->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->country->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->province->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->postal_code->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->home_phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->mobile_phone->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->cv_title->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->cv->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->cvtext->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->industry->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->profileImage->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->head_line->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->objective->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->work_history->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->education->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->skills->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->referees->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->linkedInUrl->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->linkedInData->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->totalYearsOfExperience->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->totalMonthsOfExperience->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->htmlCVData->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->generatedCVFile->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->created->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->updated->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->expectedSalary->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->preferedPositions->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->preferedJobtype->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->preferedCountries->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->tags->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->notes->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->calls->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->age->Required) { ?>
		...
		<?php if ($recruitment_candidates_add->hash->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->linkedInProfileLink->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->linkedInProfileId->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->facebookProfileLink->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->facebookProfileId->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->twitterProfileLink->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->twitterProfileId->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->googleProfileLink->Required) { ?>
		...
		<?php } ?>
		<?php if ($recruitment_candidates_add->googleProfileId->Required) { ?>
...
frecruitment_candidatesadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
frecruitment_candidatesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frecruitment_candidatesadd.lists["x_gender"] = <?php echo $recruitment_candidates_add->gender->Lookup->toClientList() ?>;
frecruitment_candidatesadd.lists["x_gender"].options = <?php echo JsonEncode($recruitment_candidates_add->gender->options(FALSE, TRUE)) ?>;
frecruitment_candidatesadd.lists["x_marital_status"] = <?php echo $recruitment_candidates_add->marital_status->Lookup->toClientList() ?>;
frecruitment_candidatesadd.lists["x_marital_status"].options = <?php echo JsonEncode($recruitment_candidates_add->marital_status->options(FALSE, TRUE)) ?>;
...
<?php $recruitment_candidates_add->showPageHeader(); ?>
<?php
$recruitment_candidates_add->showMessage();
?>
<form name="frecruitment_candidatesadd" id="frecruitment_candidatesadd" class="<?php echo $recruitment_candidates_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($recruitment_candidates_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $recruitment_candidates_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="recruitment_candidates">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$recruitment_candidates_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($recruitment_candidates->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group row">
		<label id="elh_recruitment_candidates_first_name" for="x_first_name" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->first_name->caption() ?><?php echo ($recruitment_candidates->first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->first_name->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group row">
		<label id="elh_recruitment_candidates_last_name" for="x_last_name" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->last_name->caption() ?><?php echo ($recruitment_candidates->last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->last_name->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->nationality->Visible) { // nationality ?>
	<div id="r_nationality" class="form-group row">
		<label id="elh_recruitment_candidates_nationality" for="x_nationality" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->nationality->caption() ?><?php echo ($recruitment_candidates->nationality->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->nationality->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->birthday->Visible) { // birthday ?>
	<div id="r_birthday" class="form-group row">
		<label id="elh_recruitment_candidates_birthday" for="x_birthday" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->birthday->caption() ?><?php echo ($recruitment_candidates->birthday->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->birthday->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("frecruitment_candidatesadd", "x_birthday", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($recruitment_candidates->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_recruitment_candidates_gender" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->gender->caption() ?><?php echo ($recruitment_candidates->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->gender->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->marital_status->Visible) { // marital_status ?>
	<div id="r_marital_status" class="form-group row">
		<label id="elh_recruitment_candidates_marital_status" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->marital_status->caption() ?><?php echo ($recruitment_candidates->marital_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->marital_status->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->address1->Visible) { // address1 ?>
	<div id="r_address1" class="form-group row">
		<label id="elh_recruitment_candidates_address1" for="x_address1" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->address1->caption() ?><?php echo ($recruitment_candidates->address1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->address1->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->address2->Visible) { // address2 ?>
	<div id="r_address2" class="form-group row">
		<label id="elh_recruitment_candidates_address2" for="x_address2" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->address2->caption() ?><?php echo ($recruitment_candidates->address2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->address2->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->city->Visible) { // city ?>
	<div id="r_city" class="form-group row">
		<label id="elh_recruitment_candidates_city" for="x_city" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->city->caption() ?><?php echo ($recruitment_candidates->city->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->city->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->country->Visible) { // country ?>
	<div id="r_country" class="form-group row">
		<label id="elh_recruitment_candidates_country" for="x_country" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->country->caption() ?><?php echo ($recruitment_candidates->country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->country->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_recruitment_candidates_province" for="x_province" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->province->caption() ?><?php echo ($recruitment_candidates->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->province->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_recruitment_candidates_postal_code" for="x_postal_code" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->postal_code->caption() ?><?php echo ($recruitment_candidates->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->postal_code->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->_email->Visible) { // email ?>
	<div id="r__email" class="form-group row">
		<label id="elh_recruitment_candidates__email" for="x__email" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->_email->caption() ?><?php echo ($recruitment_candidates->_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->_email->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->home_phone->Visible) { // home_phone ?>
	<div id="r_home_phone" class="form-group row">
		<label id="elh_recruitment_candidates_home_phone" for="x_home_phone" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->home_phone->caption() ?><?php echo ($recruitment_candidates->home_phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->home_phone->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->mobile_phone->Visible) { // mobile_phone ?>
	<div id="r_mobile_phone" class="form-group row">
		<label id="elh_recruitment_candidates_mobile_phone" for="x_mobile_phone" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->mobile_phone->caption() ?><?php echo ($recruitment_candidates->mobile_phone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->mobile_phone->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->cv_title->Visible) { // cv_title ?>
	<div id="r_cv_title" class="form-group row">
		<label id="elh_recruitment_candidates_cv_title" for="x_cv_title" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->cv_title->caption() ?><?php echo ($recruitment_candidates->cv_title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->cv_title->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->cv->Visible) { // cv ?>
	<div id="r_cv" class="form-group row">
		<label id="elh_recruitment_candidates_cv" for="x_cv" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->cv->caption() ?><?php echo ($recruitment_candidates->cv->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->cv->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->cvtext->Visible) { // cvtext ?>
	<div id="r_cvtext" class="form-group row">
		<label id="elh_recruitment_candidates_cvtext" for="x_cvtext" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->cvtext->caption() ?><?php echo ($recruitment_candidates->cvtext->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->cvtext->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->industry->Visible) { // industry ?>
	<div id="r_industry" class="form-group row">
		<label id="elh_recruitment_candidates_industry" for="x_industry" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->industry->caption() ?><?php echo ($recruitment_candidates->industry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->industry->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->profileImage->Visible) { // profileImage ?>
	<div id="r_profileImage" class="form-group row">
		<label id="elh_recruitment_candidates_profileImage" for="x_profileImage" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->profileImage->caption() ?><?php echo ($recruitment_candidates->profileImage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->profileImage->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->head_line->Visible) { // head_line ?>
	<div id="r_head_line" class="form-group row">
		<label id="elh_recruitment_candidates_head_line" for="x_head_line" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->head_line->caption() ?><?php echo ($recruitment_candidates->head_line->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->head_line->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->objective->Visible) { // objective ?>
	<div id="r_objective" class="form-group row">
		<label id="elh_recruitment_candidates_objective" for="x_objective" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->objective->caption() ?><?php echo ($recruitment_candidates->objective->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->objective->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->work_history->Visible) { // work_history ?>
	<div id="r_work_history" class="form-group row">
		<label id="elh_recruitment_candidates_work_history" for="x_work_history" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->work_history->caption() ?><?php echo ($recruitment_candidates->work_history->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->work_history->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->education->Visible) { // education ?>
	<div id="r_education" class="form-group row">
		<label id="elh_recruitment_candidates_education" for="x_education" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->education->caption() ?><?php echo ($recruitment_candidates->education->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->education->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->skills->Visible) { // skills ?>
	<div id="r_skills" class="form-group row">
		<label id="elh_recruitment_candidates_skills" for="x_skills" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->skills->caption() ?><?php echo ($recruitment_candidates->skills->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->skills->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->referees->Visible) { // referees ?>
	<div id="r_referees" class="form-group row">
		<label id="elh_recruitment_candidates_referees" for="x_referees" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->referees->caption() ?><?php echo ($recruitment_candidates->referees->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->referees->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->linkedInUrl->Visible) { // linkedInUrl ?>
	<div id="r_linkedInUrl" class="form-group row">
		<label id="elh_recruitment_candidates_linkedInUrl" for="x_linkedInUrl" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->linkedInUrl->caption() ?><?php echo ($recruitment_candidates->linkedInUrl->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->linkedInUrl->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->linkedInData->Visible) { // linkedInData ?>
	<div id="r_linkedInData" class="form-group row">
		<label id="elh_recruitment_candidates_linkedInData" for="x_linkedInData" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->linkedInData->caption() ?><?php echo ($recruitment_candidates->linkedInData->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->linkedInData->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->totalYearsOfExperience->Visible) { // totalYearsOfExperience ?>
	<div id="r_totalYearsOfExperience" class="form-group row">
		<label id="elh_recruitment_candidates_totalYearsOfExperience" for="x_totalYearsOfExperience" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->totalYearsOfExperience->caption() ?><?php echo ($recruitment_candidates->totalYearsOfExperience->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->totalYearsOfExperience->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->totalMonthsOfExperience->Visible) { // totalMonthsOfExperience ?>
	<div id="r_totalMonthsOfExperience" class="form-group row">
		<label id="elh_recruitment_candidates_totalMonthsOfExperience" for="x_totalMonthsOfExperience" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->totalMonthsOfExperience->caption() ?><?php echo ($recruitment_candidates->totalMonthsOfExperience->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->totalMonthsOfExperience->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->htmlCVData->Visible) { // htmlCVData ?>
	<div id="r_htmlCVData" class="form-group row">
		<label id="elh_recruitment_candidates_htmlCVData" for="x_htmlCVData" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->htmlCVData->caption() ?><?php echo ($recruitment_candidates->htmlCVData->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->htmlCVData->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->generatedCVFile->Visible) { // generatedCVFile ?>
	<div id="r_generatedCVFile" class="form-group row">
		<label id="elh_recruitment_candidates_generatedCVFile" for="x_generatedCVFile" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->generatedCVFile->caption() ?><?php echo ($recruitment_candidates->generatedCVFile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->generatedCVFile->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->created->Visible) { // created ?>
	<div id="r_created" class="form-group row">
		<label id="elh_recruitment_candidates_created" for="x_created" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->created->caption() ?><?php echo ($recruitment_candidates->created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->created->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("frecruitment_candidatesadd", "x_created", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($recruitment_candidates->updated->Visible) { // updated ?>
	<div id="r_updated" class="form-group row">
		<label id="elh_recruitment_candidates_updated" for="x_updated" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->updated->caption() ?><?php echo ($recruitment_candidates->updated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->updated->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("frecruitment_candidatesadd", "x_updated", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($recruitment_candidates->expectedSalary->Visible) { // expectedSalary ?>
	<div id="r_expectedSalary" class="form-group row">
		<label id="elh_recruitment_candidates_expectedSalary" for="x_expectedSalary" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->expectedSalary->caption() ?><?php echo ($recruitment_candidates->expectedSalary->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->expectedSalary->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->preferedPositions->Visible) { // preferedPositions ?>
	<div id="r_preferedPositions" class="form-group row">
		<label id="elh_recruitment_candidates_preferedPositions" for="x_preferedPositions" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->preferedPositions->caption() ?><?php echo ($recruitment_candidates->preferedPositions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->preferedPositions->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->preferedJobtype->Visible) { // preferedJobtype ?>
	<div id="r_preferedJobtype" class="form-group row">
		<label id="elh_recruitment_candidates_preferedJobtype" for="x_preferedJobtype" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->preferedJobtype->caption() ?><?php echo ($recruitment_candidates->preferedJobtype->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->preferedJobtype->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->preferedCountries->Visible) { // preferedCountries ?>
	<div id="r_preferedCountries" class="form-group row">
		<label id="elh_recruitment_candidates_preferedCountries" for="x_preferedCountries" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->preferedCountries->caption() ?><?php echo ($recruitment_candidates->preferedCountries->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->preferedCountries->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->tags->Visible) { // tags ?>
	<div id="r_tags" class="form-group row">
		<label id="elh_recruitment_candidates_tags" for="x_tags" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->tags->caption() ?><?php echo ($recruitment_candidates->tags->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->tags->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->notes->Visible) { // notes ?>
	<div id="r_notes" class="form-group row">
		<label id="elh_recruitment_candidates_notes" for="x_notes" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->notes->caption() ?><?php echo ($recruitment_candidates->notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->notes->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->calls->Visible) { // calls ?>
	<div id="r_calls" class="form-group row">
		<label id="elh_recruitment_candidates_calls" for="x_calls" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->calls->caption() ?><?php echo ($recruitment_candidates->calls->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->calls->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->age->Visible) { // age ?>
	<div id="r_age" class="form-group row">
		<label id="elh_recruitment_candidates_age" for="x_age" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->age->caption() ?><?php echo ($recruitment_candidates->age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->age->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->hash->Visible) { // hash ?>
	<div id="r_hash" class="form-group row">
		<label id="elh_recruitment_candidates_hash" for="x_hash" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->hash->caption() ?><?php echo ($recruitment_candidates->hash->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->hash->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->linkedInProfileLink->Visible) { // linkedInProfileLink ?>
	<div id="r_linkedInProfileLink" class="form-group row">
		<label id="elh_recruitment_candidates_linkedInProfileLink" for="x_linkedInProfileLink" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->linkedInProfileLink->caption() ?><?php echo ($recruitment_candidates->linkedInProfileLink->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->linkedInProfileLink->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->linkedInProfileId->Visible) { // linkedInProfileId ?>
	<div id="r_linkedInProfileId" class="form-group row">
		<label id="elh_recruitment_candidates_linkedInProfileId" for="x_linkedInProfileId" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->linkedInProfileId->caption() ?><?php echo ($recruitment_candidates->linkedInProfileId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->linkedInProfileId->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->facebookProfileLink->Visible) { // facebookProfileLink ?>
	<div id="r_facebookProfileLink" class="form-group row">
		<label id="elh_recruitment_candidates_facebookProfileLink" for="x_facebookProfileLink" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->facebookProfileLink->caption() ?><?php echo ($recruitment_candidates->facebookProfileLink->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->facebookProfileLink->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->facebookProfileId->Visible) { // facebookProfileId ?>
	<div id="r_facebookProfileId" class="form-group row">
		<label id="elh_recruitment_candidates_facebookProfileId" for="x_facebookProfileId" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->facebookProfileId->caption() ?><?php echo ($recruitment_candidates->facebookProfileId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->facebookProfileId->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->twitterProfileLink->Visible) { // twitterProfileLink ?>
	<div id="r_twitterProfileLink" class="form-group row">
		<label id="elh_recruitment_candidates_twitterProfileLink" for="x_twitterProfileLink" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->twitterProfileLink->caption() ?><?php echo ($recruitment_candidates->twitterProfileLink->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->twitterProfileLink->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->twitterProfileId->Visible) { // twitterProfileId ?>
	<div id="r_twitterProfileId" class="form-group row">
		<label id="elh_recruitment_candidates_twitterProfileId" for="x_twitterProfileId" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->twitterProfileId->caption() ?><?php echo ($recruitment_candidates->twitterProfileId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->twitterProfileId->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->googleProfileLink->Visible) { // googleProfileLink ?>
	<div id="r_googleProfileLink" class="form-group row">
		<label id="elh_recruitment_candidates_googleProfileLink" for="x_googleProfileLink" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->googleProfileLink->caption() ?><?php echo ($recruitment_candidates->googleProfileLink->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->googleProfileLink->cellAttributes() ?>>
...
<?php if ($recruitment_candidates->googleProfileId->Visible) { // googleProfileId ?>
	<div id="r_googleProfileId" class="form-group row">
		<label id="elh_recruitment_candidates_googleProfileId" for="x_googleProfileId" class="<?php echo $recruitment_candidates_add->LeftColumnClass ?>"><?php echo $recruitment_candidates->googleProfileId->caption() ?><?php echo ($recruitment_candidates->googleProfileId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $recruitment_candidates_add->RightColumnClass ?>"><div<?php echo $recruitment_candidates->googleProfileId->cellAttributes() ?>>
...
<?php if (!$recruitment_candidates_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $recruitment_candidates_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $recruitment_candidates_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$recruitment_candidates_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$recruitment_candidates_add->terminate();
?>