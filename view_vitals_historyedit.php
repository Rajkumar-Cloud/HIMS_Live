...
// Create page object
$view_vitals_history_edit = new view_vitals_history_edit();

// Run the page
$view_vitals_history_edit->run();
...
$view_vitals_history_edit->Page_Render();
?>
...
var fview_vitals_historyedit = currentForm = new ew.Form("fview_vitals_historyedit", "edit");

// Validate form
fview_vitals_historyedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_vitals_history_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_vitals_history->id->caption(), $view_vitals_history->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($view_vitals_history_edit->RIDNO->Required) { ?>
		...
		<?php if ($view_vitals_history_edit->Name->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Age->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->SEX->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Religion->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Address->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->IdentificationMark->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->DoublewitnessName1->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->DoublewitnessName2->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Chiefcomplaints->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MenstrualHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->ObstetricHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MedicalHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->SurgicalHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Generalexaminationpallor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PR->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->CVS->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PA->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PROVISIONALDIAGNOSIS->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Investigations->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Fheight->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Fweight->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FBMI->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FBloodgroup->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Mheight->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Mweight->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MBMI->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MBloodgroup->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FBuild->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MBuild->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FSkinColor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MSkinColor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FEyesColor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MEyesColor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FHairColor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MhairColor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FhairTexture->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MHairTexture->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Fothers->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Mothers->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PGE->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PPR->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PBP->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Breast->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PPA->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PPSV->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PPAPSMEAR->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PTHYROID->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MTHYROID->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->SecSexCharacters->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PenisUM->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->VAS->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->EPIDIDYMIS->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Varicocele->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FertilityTreatmentHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->SurgeryHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->FamilyHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PInvestigations->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Addictions->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Medications->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Medical->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->Surgical->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->CoitalHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->SemenAnalysis->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MInsvestications->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PImpression->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MIMpression->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PPlanOfManagement->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MPlanOfManagement->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->PReadMore->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MReadMore->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->MariedFor->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->CMNCM->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->TidNo->Required) { ?>
		...
		<?php if ($view_vitals_history_edit->pFamilyHistory->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_vitals_history_edit->pTemplateMedications->Required) { ?>
...
fview_vitals_historyedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fview_vitals_historyedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_vitals_historyedit.lists["x_MedicalHistory[]"] = <?php echo $view_vitals_history_edit->MedicalHistory->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MedicalHistory[]"].options = <?php echo JsonEncode($view_vitals_history_edit->MedicalHistory->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_FBloodgroup"] = <?php echo $view_vitals_history_edit->FBloodgroup->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FBloodgroup"].options = <?php echo JsonEncode($view_vitals_history_edit->FBloodgroup->lookupOptions()) ?>;
fview_vitals_historyedit.lists["x_MBloodgroup"] = <?php echo $view_vitals_history_edit->MBloodgroup->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MBloodgroup"].options = <?php echo JsonEncode($view_vitals_history_edit->MBloodgroup->lookupOptions()) ?>;
fview_vitals_historyedit.lists["x_FBuild"] = <?php echo $view_vitals_history_edit->FBuild->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FBuild"].options = <?php echo JsonEncode($view_vitals_history_edit->FBuild->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_MBuild"] = <?php echo $view_vitals_history_edit->MBuild->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MBuild"].options = <?php echo JsonEncode($view_vitals_history_edit->MBuild->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_FSkinColor"] = <?php echo $view_vitals_history_edit->FSkinColor->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FSkinColor"].options = <?php echo JsonEncode($view_vitals_history_edit->FSkinColor->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_MSkinColor"] = <?php echo $view_vitals_history_edit->MSkinColor->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MSkinColor"].options = <?php echo JsonEncode($view_vitals_history_edit->MSkinColor->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_FEyesColor"] = <?php echo $view_vitals_history_edit->FEyesColor->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FEyesColor"].options = <?php echo JsonEncode($view_vitals_history_edit->FEyesColor->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_MEyesColor"] = <?php echo $view_vitals_history_edit->MEyesColor->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MEyesColor"].options = <?php echo JsonEncode($view_vitals_history_edit->MEyesColor->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_FHairColor"] = <?php echo $view_vitals_history_edit->FHairColor->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FHairColor"].options = <?php echo JsonEncode($view_vitals_history_edit->FHairColor->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_MhairColor"] = <?php echo $view_vitals_history_edit->MhairColor->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MhairColor"].options = <?php echo JsonEncode($view_vitals_history_edit->MhairColor->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_FhairTexture"] = <?php echo $view_vitals_history_edit->FhairTexture->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FhairTexture"].options = <?php echo JsonEncode($view_vitals_history_edit->FhairTexture->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_MHairTexture"] = <?php echo $view_vitals_history_edit->MHairTexture->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_MHairTexture"].options = <?php echo JsonEncode($view_vitals_history_edit->MHairTexture->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_FamilyHistory"] = <?php echo $view_vitals_history_edit->FamilyHistory->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_FamilyHistory"].options = <?php echo JsonEncode($view_vitals_history_edit->FamilyHistory->lookupOptions()) ?>;
fview_vitals_historyedit.autoSuggests["x_FamilyHistory"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fview_vitals_historyedit.lists["x_Addictions[]"] = <?php echo $view_vitals_history_edit->Addictions->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_Addictions[]"].options = <?php echo JsonEncode($view_vitals_history_edit->Addictions->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_Medical"] = <?php echo $view_vitals_history_edit->Medical->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_Medical"].options = <?php echo JsonEncode($view_vitals_history_edit->Medical->options(FALSE, TRUE)) ?>;
fview_vitals_historyedit.lists["x_Surgical"] = <?php echo $view_vitals_history_edit->Surgical->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_Surgical"].options = <?php echo JsonEncode($view_vitals_history_edit->Surgical->lookupOptions()) ?>;
fview_vitals_historyedit.autoSuggests["x_Surgical"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fview_vitals_historyedit.lists["x_CoitalHistory"] = <?php echo $view_vitals_history_edit->CoitalHistory->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_CoitalHistory"].options = <?php echo JsonEncode($view_vitals_history_edit->CoitalHistory->lookupOptions()) ?>;
fview_vitals_historyedit.autoSuggests["x_CoitalHistory"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fview_vitals_historyedit.lists["x_pFamilyHistory"] = <?php echo $view_vitals_history_edit->pFamilyHistory->Lookup->toClientList() ?>;
fview_vitals_historyedit.lists["x_pFamilyHistory"].options = <?php echo JsonEncode($view_vitals_history_edit->pFamilyHistory->lookupOptions()) ?>;
fview_vitals_historyedit.autoSuggests["x_pFamilyHistory"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $view_vitals_history_edit->showPageHeader(); ?>
<?php
$view_vitals_history_edit->showMessage();
?>
<form name="fview_vitals_historyedit" id="fview_vitals_historyedit" class="<?php echo $view_vitals_history_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($view_vitals_history_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_vitals_history_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="view_vitals_history">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$view_vitals_history_edit->IsModal ?>">
<div class="ew-edit-div d-none"><!-- page* -->
<?php if ($view_vitals_history->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_view_vitals_history_id" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_id" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->id->caption() ?><?php echo ($view_vitals_history->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->id->cellAttributes() ?>>
<script id="tpx_view_vitals_history_id" class="view_vitals_historyedit" type="text/html">
<span id="el_view_vitals_history_id">
<span<?php echo $view_vitals_history->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($view_vitals_history->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="view_vitals_history" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($view_vitals_history->id->CurrentValue) ?>">
<?php echo $view_vitals_history->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($view_vitals_history->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_view_vitals_history_RIDNO" for="x_RIDNO" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_RIDNO" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->RIDNO->caption() ?><?php echo ($view_vitals_history->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->RIDNO->cellAttributes() ?>>
<script id="tpx_view_vitals_history_RIDNO" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_view_vitals_history_Name" for="x_Name" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Name" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Name->caption() ?><?php echo ($view_vitals_history->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Name->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Name" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_view_vitals_history_Age" for="x_Age" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Age" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Age->caption() ?><?php echo ($view_vitals_history->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Age->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Age" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->SEX->Visible) { // SEX ?>
	<div id="r_SEX" class="form-group row">
		<label id="elh_view_vitals_history_SEX" for="x_SEX" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_SEX" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->SEX->caption() ?><?php echo ($view_vitals_history->SEX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->SEX->cellAttributes() ?>>
<script id="tpx_view_vitals_history_SEX" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Religion->Visible) { // Religion ?>
	<div id="r_Religion" class="form-group row">
		<label id="elh_view_vitals_history_Religion" for="x_Religion" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Religion" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Religion->caption() ?><?php echo ($view_vitals_history->Religion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Religion->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Religion" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group row">
		<label id="elh_view_vitals_history_Address" for="x_Address" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Address" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Address->caption() ?><?php echo ($view_vitals_history->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Address->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Address" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->IdentificationMark->Visible) { // IdentificationMark ?>
	<div id="r_IdentificationMark" class="form-group row">
		<label id="elh_view_vitals_history_IdentificationMark" for="x_IdentificationMark" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_IdentificationMark" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->IdentificationMark->caption() ?><?php echo ($view_vitals_history->IdentificationMark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->IdentificationMark->cellAttributes() ?>>
<script id="tpx_view_vitals_history_IdentificationMark" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->DoublewitnessName1->Visible) { // DoublewitnessName1 ?>
	<div id="r_DoublewitnessName1" class="form-group row">
		<label id="elh_view_vitals_history_DoublewitnessName1" for="x_DoublewitnessName1" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_DoublewitnessName1" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->DoublewitnessName1->caption() ?><?php echo ($view_vitals_history->DoublewitnessName1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->DoublewitnessName1->cellAttributes() ?>>
<script id="tpx_view_vitals_history_DoublewitnessName1" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->DoublewitnessName2->Visible) { // DoublewitnessName2 ?>
	<div id="r_DoublewitnessName2" class="form-group row">
		<label id="elh_view_vitals_history_DoublewitnessName2" for="x_DoublewitnessName2" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_DoublewitnessName2" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->DoublewitnessName2->caption() ?><?php echo ($view_vitals_history->DoublewitnessName2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->DoublewitnessName2->cellAttributes() ?>>
<script id="tpx_view_vitals_history_DoublewitnessName2" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
	<div id="r_Chiefcomplaints" class="form-group row">
		<label id="elh_view_vitals_history_Chiefcomplaints" for="x_Chiefcomplaints" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Chiefcomplaints" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Chiefcomplaints->caption() ?><?php echo ($view_vitals_history->Chiefcomplaints->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Chiefcomplaints->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Chiefcomplaints" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MenstrualHistory->Visible) { // MenstrualHistory ?>
	<div id="r_MenstrualHistory" class="form-group row">
		<label id="elh_view_vitals_history_MenstrualHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MenstrualHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MenstrualHistory->caption() ?><?php echo ($view_vitals_history->MenstrualHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MenstrualHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MenstrualHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_MenstrualHistory", 0, 0, <?php echo ($view_vitals_history->MenstrualHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->ObstetricHistory->Visible) { // ObstetricHistory ?>
	<div id="r_ObstetricHistory" class="form-group row">
		<label id="elh_view_vitals_history_ObstetricHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_ObstetricHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->ObstetricHistory->caption() ?><?php echo ($view_vitals_history->ObstetricHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->ObstetricHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_ObstetricHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_ObstetricHistory", 0, 0, <?php echo ($view_vitals_history->ObstetricHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->MedicalHistory->Visible) { // MedicalHistory ?>
	<div id="r_MedicalHistory" class="form-group row">
		<label id="elh_view_vitals_history_MedicalHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MedicalHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MedicalHistory->caption() ?><?php echo ($view_vitals_history->MedicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MedicalHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MedicalHistory" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->SurgicalHistory->Visible) { // SurgicalHistory ?>
	<div id="r_SurgicalHistory" class="form-group row">
		<label id="elh_view_vitals_history_SurgicalHistory" for="x_SurgicalHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_SurgicalHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->SurgicalHistory->caption() ?><?php echo ($view_vitals_history->SurgicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->SurgicalHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_SurgicalHistory" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Generalexaminationpallor->Visible) { // Generalexaminationpallor ?>
	<div id="r_Generalexaminationpallor" class="form-group row">
		<label id="elh_view_vitals_history_Generalexaminationpallor" for="x_Generalexaminationpallor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Generalexaminationpallor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Generalexaminationpallor->caption() ?><?php echo ($view_vitals_history->Generalexaminationpallor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Generalexaminationpallor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Generalexaminationpallor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PR->Visible) { // PR ?>
	<div id="r_PR" class="form-group row">
		<label id="elh_view_vitals_history_PR" for="x_PR" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PR" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PR->caption() ?><?php echo ($view_vitals_history->PR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PR->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PR" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->CVS->Visible) { // CVS ?>
	<div id="r_CVS" class="form-group row">
		<label id="elh_view_vitals_history_CVS" for="x_CVS" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_CVS" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->CVS->caption() ?><?php echo ($view_vitals_history->CVS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->CVS->cellAttributes() ?>>
<script id="tpx_view_vitals_history_CVS" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PA->Visible) { // PA ?>
	<div id="r_PA" class="form-group row">
		<label id="elh_view_vitals_history_PA" for="x_PA" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PA" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PA->caption() ?><?php echo ($view_vitals_history->PA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PA->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PA" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PROVISIONALDIAGNOSIS->Visible) { // PROVISIONALDIAGNOSIS ?>
	<div id="r_PROVISIONALDIAGNOSIS" class="form-group row">
		<label id="elh_view_vitals_history_PROVISIONALDIAGNOSIS" for="x_PROVISIONALDIAGNOSIS" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PROVISIONALDIAGNOSIS" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PROVISIONALDIAGNOSIS->caption() ?><?php echo ($view_vitals_history->PROVISIONALDIAGNOSIS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PROVISIONALDIAGNOSIS->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PROVISIONALDIAGNOSIS" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Investigations->Visible) { // Investigations ?>
	<div id="r_Investigations" class="form-group row">
		<label id="elh_view_vitals_history_Investigations" for="x_Investigations" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Investigations" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Investigations->caption() ?><?php echo ($view_vitals_history->Investigations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Investigations->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Investigations" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Fheight->Visible) { // Fheight ?>
	<div id="r_Fheight" class="form-group row">
		<label id="elh_view_vitals_history_Fheight" for="x_Fheight" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Fheight" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Fheight->caption() ?><?php echo ($view_vitals_history->Fheight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Fheight->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Fheight" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Fweight->Visible) { // Fweight ?>
	<div id="r_Fweight" class="form-group row">
		<label id="elh_view_vitals_history_Fweight" for="x_Fweight" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Fweight" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Fweight->caption() ?><?php echo ($view_vitals_history->Fweight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Fweight->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Fweight" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FBMI->Visible) { // FBMI ?>
	<div id="r_FBMI" class="form-group row">
		<label id="elh_view_vitals_history_FBMI" for="x_FBMI" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FBMI" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FBMI->caption() ?><?php echo ($view_vitals_history->FBMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FBMI->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FBMI" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FBloodgroup->Visible) { // FBloodgroup ?>
	<div id="r_FBloodgroup" class="form-group row">
		<label id="elh_view_vitals_history_FBloodgroup" for="x_FBloodgroup" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FBloodgroup" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FBloodgroup->caption() ?><?php echo ($view_vitals_history->FBloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FBloodgroup->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FBloodgroup" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Mheight->Visible) { // Mheight ?>
	<div id="r_Mheight" class="form-group row">
		<label id="elh_view_vitals_history_Mheight" for="x_Mheight" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Mheight" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Mheight->caption() ?><?php echo ($view_vitals_history->Mheight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Mheight->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Mheight" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Mweight->Visible) { // Mweight ?>
	<div id="r_Mweight" class="form-group row">
		<label id="elh_view_vitals_history_Mweight" for="x_Mweight" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Mweight" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Mweight->caption() ?><?php echo ($view_vitals_history->Mweight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Mweight->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Mweight" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MBMI->Visible) { // MBMI ?>
	<div id="r_MBMI" class="form-group row">
		<label id="elh_view_vitals_history_MBMI" for="x_MBMI" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MBMI" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MBMI->caption() ?><?php echo ($view_vitals_history->MBMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MBMI->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MBMI" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MBloodgroup->Visible) { // MBloodgroup ?>
	<div id="r_MBloodgroup" class="form-group row">
		<label id="elh_view_vitals_history_MBloodgroup" for="x_MBloodgroup" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MBloodgroup" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MBloodgroup->caption() ?><?php echo ($view_vitals_history->MBloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MBloodgroup->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MBloodgroup" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FBuild->Visible) { // FBuild ?>
	<div id="r_FBuild" class="form-group row">
		<label id="elh_view_vitals_history_FBuild" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FBuild" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FBuild->caption() ?><?php echo ($view_vitals_history->FBuild->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FBuild->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FBuild" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MBuild->Visible) { // MBuild ?>
	<div id="r_MBuild" class="form-group row">
		<label id="elh_view_vitals_history_MBuild" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MBuild" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MBuild->caption() ?><?php echo ($view_vitals_history->MBuild->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MBuild->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MBuild" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FSkinColor->Visible) { // FSkinColor ?>
	<div id="r_FSkinColor" class="form-group row">
		<label id="elh_view_vitals_history_FSkinColor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FSkinColor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FSkinColor->caption() ?><?php echo ($view_vitals_history->FSkinColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FSkinColor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FSkinColor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MSkinColor->Visible) { // MSkinColor ?>
	<div id="r_MSkinColor" class="form-group row">
		<label id="elh_view_vitals_history_MSkinColor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MSkinColor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MSkinColor->caption() ?><?php echo ($view_vitals_history->MSkinColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MSkinColor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MSkinColor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FEyesColor->Visible) { // FEyesColor ?>
	<div id="r_FEyesColor" class="form-group row">
		<label id="elh_view_vitals_history_FEyesColor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FEyesColor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FEyesColor->caption() ?><?php echo ($view_vitals_history->FEyesColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FEyesColor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FEyesColor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MEyesColor->Visible) { // MEyesColor ?>
	<div id="r_MEyesColor" class="form-group row">
		<label id="elh_view_vitals_history_MEyesColor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MEyesColor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MEyesColor->caption() ?><?php echo ($view_vitals_history->MEyesColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MEyesColor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MEyesColor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FHairColor->Visible) { // FHairColor ?>
	<div id="r_FHairColor" class="form-group row">
		<label id="elh_view_vitals_history_FHairColor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FHairColor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FHairColor->caption() ?><?php echo ($view_vitals_history->FHairColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FHairColor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FHairColor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MhairColor->Visible) { // MhairColor ?>
	<div id="r_MhairColor" class="form-group row">
		<label id="elh_view_vitals_history_MhairColor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MhairColor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MhairColor->caption() ?><?php echo ($view_vitals_history->MhairColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MhairColor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MhairColor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FhairTexture->Visible) { // FhairTexture ?>
	<div id="r_FhairTexture" class="form-group row">
		<label id="elh_view_vitals_history_FhairTexture" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FhairTexture" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FhairTexture->caption() ?><?php echo ($view_vitals_history->FhairTexture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FhairTexture->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FhairTexture" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MHairTexture->Visible) { // MHairTexture ?>
	<div id="r_MHairTexture" class="form-group row">
		<label id="elh_view_vitals_history_MHairTexture" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MHairTexture" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MHairTexture->caption() ?><?php echo ($view_vitals_history->MHairTexture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MHairTexture->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MHairTexture" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Fothers->Visible) { // Fothers ?>
	<div id="r_Fothers" class="form-group row">
		<label id="elh_view_vitals_history_Fothers" for="x_Fothers" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Fothers" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Fothers->caption() ?><?php echo ($view_vitals_history->Fothers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Fothers->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Fothers" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Mothers->Visible) { // Mothers ?>
	<div id="r_Mothers" class="form-group row">
		<label id="elh_view_vitals_history_Mothers" for="x_Mothers" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Mothers" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Mothers->caption() ?><?php echo ($view_vitals_history->Mothers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Mothers->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Mothers" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PGE->Visible) { // PGE ?>
	<div id="r_PGE" class="form-group row">
		<label id="elh_view_vitals_history_PGE" for="x_PGE" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PGE" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PGE->caption() ?><?php echo ($view_vitals_history->PGE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PGE->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PGE" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PPR->Visible) { // PPR ?>
	<div id="r_PPR" class="form-group row">
		<label id="elh_view_vitals_history_PPR" for="x_PPR" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PPR" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PPR->caption() ?><?php echo ($view_vitals_history->PPR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PPR->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PPR" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PBP->Visible) { // PBP ?>
	<div id="r_PBP" class="form-group row">
		<label id="elh_view_vitals_history_PBP" for="x_PBP" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PBP" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PBP->caption() ?><?php echo ($view_vitals_history->PBP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PBP->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PBP" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Breast->Visible) { // Breast ?>
	<div id="r_Breast" class="form-group row">
		<label id="elh_view_vitals_history_Breast" for="x_Breast" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Breast" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Breast->caption() ?><?php echo ($view_vitals_history->Breast->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Breast->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Breast" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PPA->Visible) { // PPA ?>
	<div id="r_PPA" class="form-group row">
		<label id="elh_view_vitals_history_PPA" for="x_PPA" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PPA" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PPA->caption() ?><?php echo ($view_vitals_history->PPA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PPA->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PPA" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PPSV->Visible) { // PPSV ?>
	<div id="r_PPSV" class="form-group row">
		<label id="elh_view_vitals_history_PPSV" for="x_PPSV" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PPSV" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PPSV->caption() ?><?php echo ($view_vitals_history->PPSV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PPSV->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PPSV" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PPAPSMEAR->Visible) { // PPAPSMEAR ?>
	<div id="r_PPAPSMEAR" class="form-group row">
		<label id="elh_view_vitals_history_PPAPSMEAR" for="x_PPAPSMEAR" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PPAPSMEAR" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PPAPSMEAR->caption() ?><?php echo ($view_vitals_history->PPAPSMEAR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PPAPSMEAR->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PPAPSMEAR" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PTHYROID->Visible) { // PTHYROID ?>
	<div id="r_PTHYROID" class="form-group row">
		<label id="elh_view_vitals_history_PTHYROID" for="x_PTHYROID" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PTHYROID" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PTHYROID->caption() ?><?php echo ($view_vitals_history->PTHYROID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PTHYROID->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PTHYROID" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->MTHYROID->Visible) { // MTHYROID ?>
	<div id="r_MTHYROID" class="form-group row">
		<label id="elh_view_vitals_history_MTHYROID" for="x_MTHYROID" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MTHYROID" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MTHYROID->caption() ?><?php echo ($view_vitals_history->MTHYROID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MTHYROID->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MTHYROID" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->SecSexCharacters->Visible) { // SecSexCharacters ?>
	<div id="r_SecSexCharacters" class="form-group row">
		<label id="elh_view_vitals_history_SecSexCharacters" for="x_SecSexCharacters" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_SecSexCharacters" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->SecSexCharacters->caption() ?><?php echo ($view_vitals_history->SecSexCharacters->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->SecSexCharacters->cellAttributes() ?>>
<script id="tpx_view_vitals_history_SecSexCharacters" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->PenisUM->Visible) { // PenisUM ?>
	<div id="r_PenisUM" class="form-group row">
		<label id="elh_view_vitals_history_PenisUM" for="x_PenisUM" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PenisUM" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PenisUM->caption() ?><?php echo ($view_vitals_history->PenisUM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PenisUM->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PenisUM" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->VAS->Visible) { // VAS ?>
	<div id="r_VAS" class="form-group row">
		<label id="elh_view_vitals_history_VAS" for="x_VAS" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_VAS" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->VAS->caption() ?><?php echo ($view_vitals_history->VAS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->VAS->cellAttributes() ?>>
<script id="tpx_view_vitals_history_VAS" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->EPIDIDYMIS->Visible) { // EPIDIDYMIS ?>
	<div id="r_EPIDIDYMIS" class="form-group row">
		<label id="elh_view_vitals_history_EPIDIDYMIS" for="x_EPIDIDYMIS" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_EPIDIDYMIS" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->EPIDIDYMIS->caption() ?><?php echo ($view_vitals_history->EPIDIDYMIS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->EPIDIDYMIS->cellAttributes() ?>>
<script id="tpx_view_vitals_history_EPIDIDYMIS" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Varicocele->Visible) { // Varicocele ?>
	<div id="r_Varicocele" class="form-group row">
		<label id="elh_view_vitals_history_Varicocele" for="x_Varicocele" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Varicocele" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Varicocele->caption() ?><?php echo ($view_vitals_history->Varicocele->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Varicocele->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Varicocele" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->FertilityTreatmentHistory->Visible) { // FertilityTreatmentHistory ?>
	<div id="r_FertilityTreatmentHistory" class="form-group row">
		<label id="elh_view_vitals_history_FertilityTreatmentHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FertilityTreatmentHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FertilityTreatmentHistory->caption() ?><?php echo ($view_vitals_history->FertilityTreatmentHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FertilityTreatmentHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FertilityTreatmentHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_FertilityTreatmentHistory", 35, 4, <?php echo ($view_vitals_history->FertilityTreatmentHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->SurgeryHistory->Visible) { // SurgeryHistory ?>
	<div id="r_SurgeryHistory" class="form-group row">
		<label id="elh_view_vitals_history_SurgeryHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_SurgeryHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->SurgeryHistory->caption() ?><?php echo ($view_vitals_history->SurgeryHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->SurgeryHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_SurgeryHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_SurgeryHistory", 35, 4, <?php echo ($view_vitals_history->SurgeryHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->FamilyHistory->Visible) { // FamilyHistory ?>
	<div id="r_FamilyHistory" class="form-group row">
		<label id="elh_view_vitals_history_FamilyHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_FamilyHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->FamilyHistory->caption() ?><?php echo ($view_vitals_history->FamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->FamilyHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_FamilyHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
fview_vitals_historyedit.createAutoSuggest({"id":"x_FamilyHistory","forceSelect":false});
</script>
...
<?php if ($view_vitals_history->PInvestigations->Visible) { // PInvestigations ?>
	<div id="r_PInvestigations" class="form-group row">
		<label id="elh_view_vitals_history_PInvestigations" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PInvestigations" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PInvestigations->caption() ?><?php echo ($view_vitals_history->PInvestigations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PInvestigations->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PInvestigations" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_PInvestigations", 35, 4, <?php echo ($view_vitals_history->PInvestigations->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->Addictions->Visible) { // Addictions ?>
	<div id="r_Addictions" class="form-group row">
		<label id="elh_view_vitals_history_Addictions" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Addictions" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Addictions->caption() ?><?php echo ($view_vitals_history->Addictions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Addictions->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Addictions" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Medications->Visible) { // Medications ?>
	<div id="r_Medications" class="form-group row">
		<label id="elh_view_vitals_history_Medications" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Medications" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Medications->caption() ?><?php echo ($view_vitals_history->Medications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Medications->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Medications" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_Medications", 35, 4, <?php echo ($view_vitals_history->Medications->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->Medical->Visible) { // Medical ?>
	<div id="r_Medical" class="form-group row">
		<label id="elh_view_vitals_history_Medical" for="x_Medical" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Medical" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Medical->caption() ?><?php echo ($view_vitals_history->Medical->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Medical->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Medical" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->Surgical->Visible) { // Surgical ?>
	<div id="r_Surgical" class="form-group row">
		<label id="elh_view_vitals_history_Surgical" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_Surgical" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->Surgical->caption() ?><?php echo ($view_vitals_history->Surgical->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->Surgical->cellAttributes() ?>>
<script id="tpx_view_vitals_history_Surgical" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
fview_vitals_historyedit.createAutoSuggest({"id":"x_Surgical","forceSelect":false});
</script>
...
<?php if ($view_vitals_history->CoitalHistory->Visible) { // CoitalHistory ?>
	<div id="r_CoitalHistory" class="form-group row">
		<label id="elh_view_vitals_history_CoitalHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_CoitalHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->CoitalHistory->caption() ?><?php echo ($view_vitals_history->CoitalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->CoitalHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_CoitalHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
fview_vitals_historyedit.createAutoSuggest({"id":"x_CoitalHistory","forceSelect":false});
</script>
...
<?php if ($view_vitals_history->SemenAnalysis->Visible) { // SemenAnalysis ?>
	<div id="r_SemenAnalysis" class="form-group row">
		<label id="elh_view_vitals_history_SemenAnalysis" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_SemenAnalysis" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->SemenAnalysis->caption() ?><?php echo ($view_vitals_history->SemenAnalysis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->SemenAnalysis->cellAttributes() ?>>
<script id="tpx_view_vitals_history_SemenAnalysis" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_SemenAnalysis", 35, 4, <?php echo ($view_vitals_history->SemenAnalysis->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->MInsvestications->Visible) { // MInsvestications ?>
	<div id="r_MInsvestications" class="form-group row">
		<label id="elh_view_vitals_history_MInsvestications" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MInsvestications" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MInsvestications->caption() ?><?php echo ($view_vitals_history->MInsvestications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MInsvestications->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MInsvestications" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_MInsvestications", 35, 4, <?php echo ($view_vitals_history->MInsvestications->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->PImpression->Visible) { // PImpression ?>
	<div id="r_PImpression" class="form-group row">
		<label id="elh_view_vitals_history_PImpression" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PImpression" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PImpression->caption() ?><?php echo ($view_vitals_history->PImpression->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PImpression->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PImpression" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_PImpression", 35, 4, <?php echo ($view_vitals_history->PImpression->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->MIMpression->Visible) { // MIMpression ?>
	<div id="r_MIMpression" class="form-group row">
		<label id="elh_view_vitals_history_MIMpression" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MIMpression" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MIMpression->caption() ?><?php echo ($view_vitals_history->MIMpression->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MIMpression->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MIMpression" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_MIMpression", 35, 4, <?php echo ($view_vitals_history->MIMpression->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->PPlanOfManagement->Visible) { // PPlanOfManagement ?>
	<div id="r_PPlanOfManagement" class="form-group row">
		<label id="elh_view_vitals_history_PPlanOfManagement" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PPlanOfManagement" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PPlanOfManagement->caption() ?><?php echo ($view_vitals_history->PPlanOfManagement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PPlanOfManagement->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PPlanOfManagement" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_PPlanOfManagement", 35, 4, <?php echo ($view_vitals_history->PPlanOfManagement->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->MPlanOfManagement->Visible) { // MPlanOfManagement ?>
	<div id="r_MPlanOfManagement" class="form-group row">
		<label id="elh_view_vitals_history_MPlanOfManagement" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MPlanOfManagement" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MPlanOfManagement->caption() ?><?php echo ($view_vitals_history->MPlanOfManagement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MPlanOfManagement->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MPlanOfManagement" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_MPlanOfManagement", 35, 4, <?php echo ($view_vitals_history->MPlanOfManagement->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->PReadMore->Visible) { // PReadMore ?>
	<div id="r_PReadMore" class="form-group row">
		<label id="elh_view_vitals_history_PReadMore" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_PReadMore" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->PReadMore->caption() ?><?php echo ($view_vitals_history->PReadMore->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->PReadMore->cellAttributes() ?>>
<script id="tpx_view_vitals_history_PReadMore" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_PReadMore", 35, 4, <?php echo ($view_vitals_history->PReadMore->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->MReadMore->Visible) { // MReadMore ?>
	<div id="r_MReadMore" class="form-group row">
		<label id="elh_view_vitals_history_MReadMore" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MReadMore" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MReadMore->caption() ?><?php echo ($view_vitals_history->MReadMore->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MReadMore->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MReadMore" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_MReadMore", 35, 4, <?php echo ($view_vitals_history->MReadMore->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($view_vitals_history->MariedFor->Visible) { // MariedFor ?>
	<div id="r_MariedFor" class="form-group row">
		<label id="elh_view_vitals_history_MariedFor" for="x_MariedFor" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_MariedFor" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->MariedFor->caption() ?><?php echo ($view_vitals_history->MariedFor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->MariedFor->cellAttributes() ?>>
<script id="tpx_view_vitals_history_MariedFor" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->CMNCM->Visible) { // CMNCM ?>
	<div id="r_CMNCM" class="form-group row">
		<label id="elh_view_vitals_history_CMNCM" for="x_CMNCM" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_CMNCM" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->CMNCM->caption() ?><?php echo ($view_vitals_history->CMNCM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->CMNCM->cellAttributes() ?>>
<script id="tpx_view_vitals_history_CMNCM" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_view_vitals_history_TidNo" for="x_TidNo" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_TidNo" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->TidNo->caption() ?><?php echo ($view_vitals_history->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->TidNo->cellAttributes() ?>>
<script id="tpx_view_vitals_history_TidNo" class="view_vitals_historyedit" type="text/html">
...
<?php if ($view_vitals_history->pFamilyHistory->Visible) { // pFamilyHistory ?>
	<div id="r_pFamilyHistory" class="form-group row">
		<label id="elh_view_vitals_history_pFamilyHistory" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_pFamilyHistory" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->pFamilyHistory->caption() ?><?php echo ($view_vitals_history->pFamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->pFamilyHistory->cellAttributes() ?>>
<script id="tpx_view_vitals_history_pFamilyHistory" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
fview_vitals_historyedit.createAutoSuggest({"id":"x_pFamilyHistory","forceSelect":false});
</script>
...
<?php if ($view_vitals_history->pTemplateMedications->Visible) { // pTemplateMedications ?>
	<div id="r_pTemplateMedications" class="form-group row">
		<label id="elh_view_vitals_history_pTemplateMedications" class="<?php echo $view_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_view_vitals_history_pTemplateMedications" class="view_vitals_historyedit" type="text/html"><span><?php echo $view_vitals_history->pTemplateMedications->caption() ?><?php echo ($view_vitals_history->pTemplateMedications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_vitals_history_edit->RightColumnClass ?>"><div<?php echo $view_vitals_history->pTemplateMedications->cellAttributes() ?>>
<script id="tpx_view_vitals_history_pTemplateMedications" class="view_vitals_historyedit" type="text/html">
...
<script type="text/html" class="view_vitals_historyedit_js">
ew.createEditor("fview_vitals_historyedit", "x_pTemplateMedications", 35, 4, <?php echo ($view_vitals_history->pTemplateMedications->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
<?php echo $view_vitals_history->pTemplateMedications->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<div id="tpd_view_vitals_historyedit" class="ew-custom-template"></div>
<script id="tpm_view_vitals_historyedit" type="text/html">
<div id="ct_view_vitals_history_edit"><style>
...
<?php if (!$view_vitals_history_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $view_vitals_history_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $view_vitals_history_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
ew.applyTemplate("tpd_view_vitals_historyedit", "tpm_view_vitals_historyedit", "view_vitals_historyedit", "<?php echo $view_vitals_history->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_vitals_historyedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
$view_vitals_history_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$view_vitals_history_edit->terminate();
?>