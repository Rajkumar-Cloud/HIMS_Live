...
var fstore_storelededit = currentForm = new ew.Form("fstore_storelededit", "edit");
...
fstore_storelededit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($store_storeled_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $store_storeled->id->caption(), $store_storeled->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php } ?>
		<?php if ($store_storeled_edit->StoreID->Required) { ?>
...
fstore_storelededit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($store_storeled_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_storeled_edit->Token ?>">
<?php } ?>
...
<?php if ($store_storeled->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_store_storeled_BRCODE" for="x_BRCODE" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BRCODE->caption() ?><?php echo ($store_storeled->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BRCODE->cellAttributes() ?>>
...
<?php if ($store_storeled->TYPE->Visible) { // TYPE ?>
	<div id="r_TYPE" class="form-group row">
		<label id="elh_store_storeled_TYPE" for="x_TYPE" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->TYPE->caption() ?><?php echo ($store_storeled->TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->TYPE->cellAttributes() ?>>
...
<?php if ($store_storeled->DN->Visible) { // DN ?>
	<div id="r_DN" class="form-group row">
		<label id="elh_store_storeled_DN" for="x_DN" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DN->caption() ?><?php echo ($store_storeled->DN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DN->cellAttributes() ?>>
...
<?php if ($store_storeled->RDN->Visible) { // RDN ?>
	<div id="r_RDN" class="form-group row">
		<label id="elh_store_storeled_RDN" for="x_RDN" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->RDN->caption() ?><?php echo ($store_storeled->RDN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->RDN->cellAttributes() ?>>
...
<?php if ($store_storeled->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_store_storeled_DT" for="x_DT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DT->caption() ?><?php echo ($store_storeled->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DT->cellAttributes() ?>>
...
<?php if ($store_storeled->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_store_storeled_PRC" for="x_PRC" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PRC->caption() ?><?php echo ($store_storeled->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PRC->cellAttributes() ?>>
...
<?php if ($store_storeled->OQ->Visible) { // OQ ?>
	<div id="r_OQ" class="form-group row">
		<label id="elh_store_storeled_OQ" for="x_OQ" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->OQ->caption() ?><?php echo ($store_storeled->OQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->OQ->cellAttributes() ?>>
...
<?php if ($store_storeled->RQ->Visible) { // RQ ?>
	<div id="r_RQ" class="form-group row">
		<label id="elh_store_storeled_RQ" for="x_RQ" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->RQ->caption() ?><?php echo ($store_storeled->RQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->RQ->cellAttributes() ?>>
...
<?php if ($store_storeled->MRQ->Visible) { // MRQ ?>
	<div id="r_MRQ" class="form-group row">
		<label id="elh_store_storeled_MRQ" for="x_MRQ" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->MRQ->caption() ?><?php echo ($store_storeled->MRQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->MRQ->cellAttributes() ?>>
...
<?php if ($store_storeled->IQ->Visible) { // IQ ?>
	<div id="r_IQ" class="form-group row">
		<label id="elh_store_storeled_IQ" for="x_IQ" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->IQ->caption() ?><?php echo ($store_storeled->IQ->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->IQ->cellAttributes() ?>>
...
<?php if ($store_storeled->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_store_storeled_BATCHNO" for="x_BATCHNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BATCHNO->caption() ?><?php echo ($store_storeled->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BATCHNO->cellAttributes() ?>>
...
<?php if ($store_storeled->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_store_storeled_EXPDT" for="x_EXPDT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->EXPDT->caption() ?><?php echo ($store_storeled->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->EXPDT->cellAttributes() ?>>
...
<?php if ($store_storeled->BILLNO->Visible) { // BILLNO ?>
	<div id="r_BILLNO" class="form-group row">
		<label id="elh_store_storeled_BILLNO" for="x_BILLNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BILLNO->caption() ?><?php echo ($store_storeled->BILLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BILLNO->cellAttributes() ?>>
...
<?php if ($store_storeled->BILLDT->Visible) { // BILLDT ?>
	<div id="r_BILLDT" class="form-group row">
		<label id="elh_store_storeled_BILLDT" for="x_BILLDT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BILLDT->caption() ?><?php echo ($store_storeled->BILLDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BILLDT->cellAttributes() ?>>
...
<?php if ($store_storeled->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_store_storeled_RT" for="x_RT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->RT->caption() ?><?php echo ($store_storeled->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->RT->cellAttributes() ?>>
...
<?php if ($store_storeled->VALUE->Visible) { // VALUE ?>
	<div id="r_VALUE" class="form-group row">
		<label id="elh_store_storeled_VALUE" for="x_VALUE" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->VALUE->caption() ?><?php echo ($store_storeled->VALUE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->VALUE->cellAttributes() ?>>
...
<?php if ($store_storeled->DISC->Visible) { // DISC ?>
	<div id="r_DISC" class="form-group row">
		<label id="elh_store_storeled_DISC" for="x_DISC" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DISC->caption() ?><?php echo ($store_storeled->DISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DISC->cellAttributes() ?>>
...
<?php if ($store_storeled->TAXP->Visible) { // TAXP ?>
	<div id="r_TAXP" class="form-group row">
		<label id="elh_store_storeled_TAXP" for="x_TAXP" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->TAXP->caption() ?><?php echo ($store_storeled->TAXP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->TAXP->cellAttributes() ?>>
...
<?php if ($store_storeled->TAX->Visible) { // TAX ?>
	<div id="r_TAX" class="form-group row">
		<label id="elh_store_storeled_TAX" for="x_TAX" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->TAX->caption() ?><?php echo ($store_storeled->TAX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->TAX->cellAttributes() ?>>
...
<?php if ($store_storeled->TAXR->Visible) { // TAXR ?>
	<div id="r_TAXR" class="form-group row">
		<label id="elh_store_storeled_TAXR" for="x_TAXR" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->TAXR->caption() ?><?php echo ($store_storeled->TAXR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->TAXR->cellAttributes() ?>>
...
<?php if ($store_storeled->DAMT->Visible) { // DAMT ?>
	<div id="r_DAMT" class="form-group row">
		<label id="elh_store_storeled_DAMT" for="x_DAMT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DAMT->caption() ?><?php echo ($store_storeled->DAMT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DAMT->cellAttributes() ?>>
...
<?php if ($store_storeled->EMPNO->Visible) { // EMPNO ?>
	<div id="r_EMPNO" class="form-group row">
		<label id="elh_store_storeled_EMPNO" for="x_EMPNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->EMPNO->caption() ?><?php echo ($store_storeled->EMPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->EMPNO->cellAttributes() ?>>
...
<?php if ($store_storeled->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_store_storeled_PC" for="x_PC" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PC->caption() ?><?php echo ($store_storeled->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PC->cellAttributes() ?>>
...
<?php if ($store_storeled->DRNAME->Visible) { // DRNAME ?>
	<div id="r_DRNAME" class="form-group row">
		<label id="elh_store_storeled_DRNAME" for="x_DRNAME" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DRNAME->caption() ?><?php echo ($store_storeled->DRNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DRNAME->cellAttributes() ?>>
...
<?php if ($store_storeled->BTIME->Visible) { // BTIME ?>
	<div id="r_BTIME" class="form-group row">
		<label id="elh_store_storeled_BTIME" for="x_BTIME" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BTIME->caption() ?><?php echo ($store_storeled->BTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BTIME->cellAttributes() ?>>
...
<?php if ($store_storeled->ONO->Visible) { // ONO ?>
	<div id="r_ONO" class="form-group row">
		<label id="elh_store_storeled_ONO" for="x_ONO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->ONO->caption() ?><?php echo ($store_storeled->ONO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->ONO->cellAttributes() ?>>
...
<?php if ($store_storeled->ODT->Visible) { // ODT ?>
	<div id="r_ODT" class="form-group row">
		<label id="elh_store_storeled_ODT" for="x_ODT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->ODT->caption() ?><?php echo ($store_storeled->ODT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->ODT->cellAttributes() ?>>
...
<?php if ($store_storeled->PURRT->Visible) { // PURRT ?>
	<div id="r_PURRT" class="form-group row">
		<label id="elh_store_storeled_PURRT" for="x_PURRT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PURRT->caption() ?><?php echo ($store_storeled->PURRT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PURRT->cellAttributes() ?>>
...
<?php if ($store_storeled->GRP->Visible) { // GRP ?>
	<div id="r_GRP" class="form-group row">
		<label id="elh_store_storeled_GRP" for="x_GRP" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->GRP->caption() ?><?php echo ($store_storeled->GRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->GRP->cellAttributes() ?>>
...
<?php if ($store_storeled->IBATCH->Visible) { // IBATCH ?>
	<div id="r_IBATCH" class="form-group row">
		<label id="elh_store_storeled_IBATCH" for="x_IBATCH" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->IBATCH->caption() ?><?php echo ($store_storeled->IBATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->IBATCH->cellAttributes() ?>>
...
<?php if ($store_storeled->IPNO->Visible) { // IPNO ?>
	<div id="r_IPNO" class="form-group row">
		<label id="elh_store_storeled_IPNO" for="x_IPNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->IPNO->caption() ?><?php echo ($store_storeled->IPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->IPNO->cellAttributes() ?>>
...
<?php if ($store_storeled->OPNO->Visible) { // OPNO ?>
	<div id="r_OPNO" class="form-group row">
		<label id="elh_store_storeled_OPNO" for="x_OPNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->OPNO->caption() ?><?php echo ($store_storeled->OPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->OPNO->cellAttributes() ?>>
...
<?php if ($store_storeled->RECID->Visible) { // RECID ?>
	<div id="r_RECID" class="form-group row">
		<label id="elh_store_storeled_RECID" for="x_RECID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->RECID->caption() ?><?php echo ($store_storeled->RECID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->RECID->cellAttributes() ?>>
...
<?php if ($store_storeled->FQTY->Visible) { // FQTY ?>
	<div id="r_FQTY" class="form-group row">
		<label id="elh_store_storeled_FQTY" for="x_FQTY" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->FQTY->caption() ?><?php echo ($store_storeled->FQTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->FQTY->cellAttributes() ?>>
...
<?php if ($store_storeled->UR->Visible) { // UR ?>
	<div id="r_UR" class="form-group row">
		<label id="elh_store_storeled_UR" for="x_UR" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->UR->caption() ?><?php echo ($store_storeled->UR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->UR->cellAttributes() ?>>
...
<?php if ($store_storeled->DCID->Visible) { // DCID ?>
	<div id="r_DCID" class="form-group row">
		<label id="elh_store_storeled_DCID" for="x_DCID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DCID->caption() ?><?php echo ($store_storeled->DCID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DCID->cellAttributes() ?>>
...
<?php if ($store_storeled->_USERID->Visible) { // USERID ?>
	<div id="r__USERID" class="form-group row">
		<label id="elh_store_storeled__USERID" for="x__USERID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->_USERID->caption() ?><?php echo ($store_storeled->_USERID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->_USERID->cellAttributes() ?>>
...
<?php if ($store_storeled->MODDT->Visible) { // MODDT ?>
	<div id="r_MODDT" class="form-group row">
		<label id="elh_store_storeled_MODDT" for="x_MODDT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->MODDT->caption() ?><?php echo ($store_storeled->MODDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->MODDT->cellAttributes() ?>>
...
<?php if ($store_storeled->FYM->Visible) { // FYM ?>
	<div id="r_FYM" class="form-group row">
		<label id="elh_store_storeled_FYM" for="x_FYM" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->FYM->caption() ?><?php echo ($store_storeled->FYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->FYM->cellAttributes() ?>>
...
<?php if ($store_storeled->PRCBATCH->Visible) { // PRCBATCH ?>
	<div id="r_PRCBATCH" class="form-group row">
		<label id="elh_store_storeled_PRCBATCH" for="x_PRCBATCH" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PRCBATCH->caption() ?><?php echo ($store_storeled->PRCBATCH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PRCBATCH->cellAttributes() ?>>
...
<?php if ($store_storeled->SLNO->Visible) { // SLNO ?>
	<div id="r_SLNO" class="form-group row">
		<label id="elh_store_storeled_SLNO" for="x_SLNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->SLNO->caption() ?><?php echo ($store_storeled->SLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->SLNO->cellAttributes() ?>>
...
<?php if ($store_storeled->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_store_storeled_MRP" for="x_MRP" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->MRP->caption() ?><?php echo ($store_storeled->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->MRP->cellAttributes() ?>>
...
<?php if ($store_storeled->BILLYM->Visible) { // BILLYM ?>
	<div id="r_BILLYM" class="form-group row">
		<label id="elh_store_storeled_BILLYM" for="x_BILLYM" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BILLYM->caption() ?><?php echo ($store_storeled->BILLYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BILLYM->cellAttributes() ?>>
...
<?php if ($store_storeled->BILLGRP->Visible) { // BILLGRP ?>
	<div id="r_BILLGRP" class="form-group row">
		<label id="elh_store_storeled_BILLGRP" for="x_BILLGRP" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BILLGRP->caption() ?><?php echo ($store_storeled->BILLGRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BILLGRP->cellAttributes() ?>>
...
<?php if ($store_storeled->STAFF->Visible) { // STAFF ?>
	<div id="r_STAFF" class="form-group row">
		<label id="elh_store_storeled_STAFF" for="x_STAFF" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->STAFF->caption() ?><?php echo ($store_storeled->STAFF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->STAFF->cellAttributes() ?>>
...
<?php if ($store_storeled->TEMPIPNO->Visible) { // TEMPIPNO ?>
	<div id="r_TEMPIPNO" class="form-group row">
		<label id="elh_store_storeled_TEMPIPNO" for="x_TEMPIPNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->TEMPIPNO->caption() ?><?php echo ($store_storeled->TEMPIPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->TEMPIPNO->cellAttributes() ?>>
...
<?php if ($store_storeled->PRNTED->Visible) { // PRNTED ?>
	<div id="r_PRNTED" class="form-group row">
		<label id="elh_store_storeled_PRNTED" for="x_PRNTED" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PRNTED->caption() ?><?php echo ($store_storeled->PRNTED->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PRNTED->cellAttributes() ?>>
...
<?php if ($store_storeled->PATNAME->Visible) { // PATNAME ?>
	<div id="r_PATNAME" class="form-group row">
		<label id="elh_store_storeled_PATNAME" for="x_PATNAME" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PATNAME->caption() ?><?php echo ($store_storeled->PATNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PATNAME->cellAttributes() ?>>
...
<?php if ($store_storeled->PJVNO->Visible) { // PJVNO ?>
	<div id="r_PJVNO" class="form-group row">
		<label id="elh_store_storeled_PJVNO" for="x_PJVNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PJVNO->caption() ?><?php echo ($store_storeled->PJVNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PJVNO->cellAttributes() ?>>
...
<?php if ($store_storeled->PJVSLNO->Visible) { // PJVSLNO ?>
	<div id="r_PJVSLNO" class="form-group row">
		<label id="elh_store_storeled_PJVSLNO" for="x_PJVSLNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PJVSLNO->caption() ?><?php echo ($store_storeled->PJVSLNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PJVSLNO->cellAttributes() ?>>
...
<?php if ($store_storeled->OTHDISC->Visible) { // OTHDISC ?>
	<div id="r_OTHDISC" class="form-group row">
		<label id="elh_store_storeled_OTHDISC" for="x_OTHDISC" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->OTHDISC->caption() ?><?php echo ($store_storeled->OTHDISC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->OTHDISC->cellAttributes() ?>>
...
<?php if ($store_storeled->PJVYM->Visible) { // PJVYM ?>
	<div id="r_PJVYM" class="form-group row">
		<label id="elh_store_storeled_PJVYM" for="x_PJVYM" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PJVYM->caption() ?><?php echo ($store_storeled->PJVYM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PJVYM->cellAttributes() ?>>
...
<?php if ($store_storeled->PURDISCPER->Visible) { // PURDISCPER ?>
	<div id="r_PURDISCPER" class="form-group row">
		<label id="elh_store_storeled_PURDISCPER" for="x_PURDISCPER" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PURDISCPER->caption() ?><?php echo ($store_storeled->PURDISCPER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PURDISCPER->cellAttributes() ?>>
...
<?php if ($store_storeled->CASHIER->Visible) { // CASHIER ?>
	<div id="r_CASHIER" class="form-group row">
		<label id="elh_store_storeled_CASHIER" for="x_CASHIER" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->CASHIER->caption() ?><?php echo ($store_storeled->CASHIER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->CASHIER->cellAttributes() ?>>
...
<?php if ($store_storeled->CASHTIME->Visible) { // CASHTIME ?>
	<div id="r_CASHTIME" class="form-group row">
		<label id="elh_store_storeled_CASHTIME" for="x_CASHTIME" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->CASHTIME->caption() ?><?php echo ($store_storeled->CASHTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->CASHTIME->cellAttributes() ?>>
...
<?php if ($store_storeled->CASHRECD->Visible) { // CASHRECD ?>
	<div id="r_CASHRECD" class="form-group row">
		<label id="elh_store_storeled_CASHRECD" for="x_CASHRECD" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->CASHRECD->caption() ?><?php echo ($store_storeled->CASHRECD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->CASHRECD->cellAttributes() ?>>
...
<?php if ($store_storeled->CASHREFNO->Visible) { // CASHREFNO ?>
	<div id="r_CASHREFNO" class="form-group row">
		<label id="elh_store_storeled_CASHREFNO" for="x_CASHREFNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->CASHREFNO->caption() ?><?php echo ($store_storeled->CASHREFNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->CASHREFNO->cellAttributes() ?>>
...
<?php if ($store_storeled->CASHIERSHIFT->Visible) { // CASHIERSHIFT ?>
	<div id="r_CASHIERSHIFT" class="form-group row">
		<label id="elh_store_storeled_CASHIERSHIFT" for="x_CASHIERSHIFT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->CASHIERSHIFT->caption() ?><?php echo ($store_storeled->CASHIERSHIFT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->CASHIERSHIFT->cellAttributes() ?>>
...
<?php if ($store_storeled->PRCODE->Visible) { // PRCODE ?>
	<div id="r_PRCODE" class="form-group row">
		<label id="elh_store_storeled_PRCODE" for="x_PRCODE" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PRCODE->caption() ?><?php echo ($store_storeled->PRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PRCODE->cellAttributes() ?>>
...
<?php if ($store_storeled->RELEASEBY->Visible) { // RELEASEBY ?>
	<div id="r_RELEASEBY" class="form-group row">
		<label id="elh_store_storeled_RELEASEBY" for="x_RELEASEBY" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->RELEASEBY->caption() ?><?php echo ($store_storeled->RELEASEBY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->RELEASEBY->cellAttributes() ?>>
...
<?php if ($store_storeled->CRAUTHOR->Visible) { // CRAUTHOR ?>
	<div id="r_CRAUTHOR" class="form-group row">
		<label id="elh_store_storeled_CRAUTHOR" for="x_CRAUTHOR" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->CRAUTHOR->caption() ?><?php echo ($store_storeled->CRAUTHOR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->CRAUTHOR->cellAttributes() ?>>
...
<?php if ($store_storeled->PAYMENT->Visible) { // PAYMENT ?>
	<div id="r_PAYMENT" class="form-group row">
		<label id="elh_store_storeled_PAYMENT" for="x_PAYMENT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PAYMENT->caption() ?><?php echo ($store_storeled->PAYMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PAYMENT->cellAttributes() ?>>
...
<?php if ($store_storeled->DRID->Visible) { // DRID ?>
	<div id="r_DRID" class="form-group row">
		<label id="elh_store_storeled_DRID" for="x_DRID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DRID->caption() ?><?php echo ($store_storeled->DRID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DRID->cellAttributes() ?>>
...
<?php if ($store_storeled->WARD->Visible) { // WARD ?>
	<div id="r_WARD" class="form-group row">
		<label id="elh_store_storeled_WARD" for="x_WARD" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->WARD->caption() ?><?php echo ($store_storeled->WARD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->WARD->cellAttributes() ?>>
...
<?php if ($store_storeled->STAXTYPE->Visible) { // STAXTYPE ?>
	<div id="r_STAXTYPE" class="form-group row">
		<label id="elh_store_storeled_STAXTYPE" for="x_STAXTYPE" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->STAXTYPE->caption() ?><?php echo ($store_storeled->STAXTYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->STAXTYPE->cellAttributes() ?>>
...
<?php if ($store_storeled->PURDISCVAL->Visible) { // PURDISCVAL ?>
	<div id="r_PURDISCVAL" class="form-group row">
		<label id="elh_store_storeled_PURDISCVAL" for="x_PURDISCVAL" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PURDISCVAL->caption() ?><?php echo ($store_storeled->PURDISCVAL->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PURDISCVAL->cellAttributes() ?>>
...
<?php if ($store_storeled->RNDOFF->Visible) { // RNDOFF ?>
	<div id="r_RNDOFF" class="form-group row">
		<label id="elh_store_storeled_RNDOFF" for="x_RNDOFF" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->RNDOFF->caption() ?><?php echo ($store_storeled->RNDOFF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->RNDOFF->cellAttributes() ?>>
...
<?php if ($store_storeled->DISCONMRP->Visible) { // DISCONMRP ?>
	<div id="r_DISCONMRP" class="form-group row">
		<label id="elh_store_storeled_DISCONMRP" for="x_DISCONMRP" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DISCONMRP->caption() ?><?php echo ($store_storeled->DISCONMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DISCONMRP->cellAttributes() ?>>
...
<?php if ($store_storeled->DELVDT->Visible) { // DELVDT ?>
	<div id="r_DELVDT" class="form-group row">
		<label id="elh_store_storeled_DELVDT" for="x_DELVDT" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DELVDT->caption() ?><?php echo ($store_storeled->DELVDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DELVDT->cellAttributes() ?>>
...
<?php if ($store_storeled->DELVTIME->Visible) { // DELVTIME ?>
	<div id="r_DELVTIME" class="form-group row">
		<label id="elh_store_storeled_DELVTIME" for="x_DELVTIME" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DELVTIME->caption() ?><?php echo ($store_storeled->DELVTIME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DELVTIME->cellAttributes() ?>>
...
<?php if ($store_storeled->DELVBY->Visible) { // DELVBY ?>
	<div id="r_DELVBY" class="form-group row">
		<label id="elh_store_storeled_DELVBY" for="x_DELVBY" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->DELVBY->caption() ?><?php echo ($store_storeled->DELVBY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->DELVBY->cellAttributes() ?>>
...
<?php if ($store_storeled->HOSPNO->Visible) { // HOSPNO ?>
	<div id="r_HOSPNO" class="form-group row">
		<label id="elh_store_storeled_HOSPNO" for="x_HOSPNO" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->HOSPNO->caption() ?><?php echo ($store_storeled->HOSPNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->HOSPNO->cellAttributes() ?>>
...
<?php if ($store_storeled->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_store_storeled_id" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->id->caption() ?><?php echo ($store_storeled->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->id->cellAttributes() ?>>
<span id="el_store_storeled_id">
<span<?php echo $store_storeled->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($store_storeled->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="store_storeled" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($store_storeled->id->CurrentValue) ?>">
<?php echo $store_storeled->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($store_storeled->pbv->Visible) { // pbv ?>
	<div id="r_pbv" class="form-group row">
		<label id="elh_store_storeled_pbv" for="x_pbv" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->pbv->caption() ?><?php echo ($store_storeled->pbv->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->pbv->cellAttributes() ?>>
...
<?php if ($store_storeled->pbt->Visible) { // pbt ?>
	<div id="r_pbt" class="form-group row">
		<label id="elh_store_storeled_pbt" for="x_pbt" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->pbt->caption() ?><?php echo ($store_storeled->pbt->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->pbt->cellAttributes() ?>>
...
<?php if ($store_storeled->SiNo->Visible) { // SiNo ?>
	<div id="r_SiNo" class="form-group row">
		<label id="elh_store_storeled_SiNo" for="x_SiNo" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->SiNo->caption() ?><?php echo ($store_storeled->SiNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->SiNo->cellAttributes() ?>>
...
<?php if ($store_storeled->Product->Visible) { // Product ?>
	<div id="r_Product" class="form-group row">
		<label id="elh_store_storeled_Product" for="x_Product" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->Product->caption() ?><?php echo ($store_storeled->Product->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->Product->cellAttributes() ?>>
...
<?php if ($store_storeled->Mfg->Visible) { // Mfg ?>
	<div id="r_Mfg" class="form-group row">
		<label id="elh_store_storeled_Mfg" for="x_Mfg" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->Mfg->caption() ?><?php echo ($store_storeled->Mfg->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->Mfg->cellAttributes() ?>>
...
<?php if ($store_storeled->HosoID->Visible) { // HosoID ?>
	<div id="r_HosoID" class="form-group row">
		<label id="elh_store_storeled_HosoID" for="x_HosoID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->HosoID->caption() ?><?php echo ($store_storeled->HosoID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->HosoID->cellAttributes() ?>>
...
<?php if ($store_storeled->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_store_storeled_createdby" for="x_createdby" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->createdby->caption() ?><?php echo ($store_storeled->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->createdby->cellAttributes() ?>>
...
<?php if ($store_storeled->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_store_storeled_createddatetime" for="x_createddatetime" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->createddatetime->caption() ?><?php echo ($store_storeled->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->createddatetime->cellAttributes() ?>>
...
<?php if ($store_storeled->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_store_storeled_modifiedby" for="x_modifiedby" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->modifiedby->caption() ?><?php echo ($store_storeled->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->modifiedby->cellAttributes() ?>>
...
<?php if ($store_storeled->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_store_storeled_modifieddatetime" for="x_modifieddatetime" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->modifieddatetime->caption() ?><?php echo ($store_storeled->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->modifieddatetime->cellAttributes() ?>>
...
<?php if ($store_storeled->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_store_storeled_MFRCODE" for="x_MFRCODE" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->MFRCODE->caption() ?><?php echo ($store_storeled->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->MFRCODE->cellAttributes() ?>>
...
<?php if ($store_storeled->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_store_storeled_Reception" for="x_Reception" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->Reception->caption() ?><?php echo ($store_storeled->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->Reception->cellAttributes() ?>>
...
<?php if ($store_storeled->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_store_storeled_PatID" for="x_PatID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->PatID->caption() ?><?php echo ($store_storeled->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->PatID->cellAttributes() ?>>
...
<?php if ($store_storeled->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_store_storeled_mrnno" for="x_mrnno" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->mrnno->caption() ?><?php echo ($store_storeled->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->mrnno->cellAttributes() ?>>
...
<?php if ($store_storeled->BRNAME->Visible) { // BRNAME ?>
	<div id="r_BRNAME" class="form-group row">
		<label id="elh_store_storeled_BRNAME" for="x_BRNAME" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->BRNAME->caption() ?><?php echo ($store_storeled->BRNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->BRNAME->cellAttributes() ?>>
...
<?php if ($store_storeled->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_storeled_StoreID" for="x_StoreID" class="<?php echo $store_storeled_edit->LeftColumnClass ?>"><?php echo $store_storeled->StoreID->caption() ?><?php echo ($store_storeled->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_storeled_edit->RightColumnClass ?>"><div<?php echo $store_storeled->StoreID->cellAttributes() ?>>
