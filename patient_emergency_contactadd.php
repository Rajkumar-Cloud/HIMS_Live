...
var fpatient_emergency_contactadd = currentForm = new ew.Form("fpatient_emergency_contactadd", "add");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
			...
			if (elm && !ew.checkInteger(elm.value))
				return this.onError(elm, "<?php echo JsEncode($patient_emergency_contact->patient_id->errorMessage()) ?>");
...
fpatient_emergency_contactadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_emergency_contactadd.lists["x_status"] = <?php echo $patient_emergency_contact_add->status->Lookup->toClientList() ?>;
...
<?php if ($patient_emergency_contact_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_emergency_contact_add->Token ?>">
<?php } ?>
...
<?php if ($patient_emergency_contact->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_patient_emergency_contact_patient_id" for="x_patient_id" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->patient_id->caption() ?><?php echo ($patient_emergency_contact->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->patient_id->cellAttributes() ?>>
...
<input type="hidden" id="x_patient_id" name="x_patient_id" value="<?php echo HtmlEncode($patient_emergency_contact->patient_id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_patient_emergency_contact_patient_id">
<input type="text" data-table="patient_emergency_contact" data-field="x_patient_id" name="x_patient_id" id="x_patient_id" size="30" placeholder="<?php echo HtmlEncode($patient_emergency_contact->patient_id->getPlaceHolder()) ?>" value="<?php echo $patient_emergency_contact->patient_id->EditValue ?>"<?php echo $patient_emergency_contact->patient_id->editAttributes() ?>>
</span>
<?php } ?>
...
<?php if ($patient_emergency_contact->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_patient_emergency_contact_name" for="x_name" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->name->caption() ?><?php echo ($patient_emergency_contact->name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->name->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->relationship->Visible) { // relationship ?>
	<div id="r_relationship" class="form-group row">
		<label id="elh_patient_emergency_contact_relationship" for="x_relationship" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->relationship->caption() ?><?php echo ($patient_emergency_contact->relationship->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->relationship->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->telephone->Visible) { // telephone ?>
	<div id="r_telephone" class="form-group row">
		<label id="elh_patient_emergency_contact_telephone" for="x_telephone" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->telephone->caption() ?><?php echo ($patient_emergency_contact->telephone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->telephone->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->address->Visible) { // address ?>
	<div id="r_address" class="form-group row">
		<label id="elh_patient_emergency_contact_address" for="x_address" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->address->caption() ?><?php echo ($patient_emergency_contact->address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->address->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_emergency_contact_status" for="x_status" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->status->caption() ?><?php echo ($patient_emergency_contact->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->status->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_patient_emergency_contact_createdby" for="x_createdby" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->createdby->caption() ?><?php echo ($patient_emergency_contact->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->createdby->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_patient_emergency_contact_createddatetime" for="x_createddatetime" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->createddatetime->caption() ?><?php echo ($patient_emergency_contact->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->createddatetime->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_patient_emergency_contact_modifiedby" for="x_modifiedby" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->modifiedby->caption() ?><?php echo ($patient_emergency_contact->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->modifiedby->cellAttributes() ?>>
...
<?php if ($patient_emergency_contact->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_patient_emergency_contact_modifieddatetime" for="x_modifieddatetime" class="<?php echo $patient_emergency_contact_add->LeftColumnClass ?>"><?php echo $patient_emergency_contact->modifieddatetime->caption() ?><?php echo ($patient_emergency_contact->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_emergency_contact_add->RightColumnClass ?>"><div<?php echo $patient_emergency_contact->modifieddatetime->cellAttributes() ?>>
