...
var fmas_reference_typeadd = currentForm = new ew.Form("fmas_reference_typeadd", "add");
...
fmas_reference_typeadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($mas_reference_type_add->HospID->Required) { ?>
		...
		<?php if ($mas_reference_type_add->_email->Required) { ?>
		...
		<?php } ?>
		<?php if ($mas_reference_type_add->whatapp->Required) { ?>
...
fmas_reference_typeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($mas_reference_type_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_reference_type_add->Token ?>">
<?php } ?>
...
<?php if ($mas_reference_type->reference->Visible) { // reference ?>
	<div id="r_reference" class="form-group row">
		<label id="elh_mas_reference_type_reference" for="x_reference" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->reference->caption() ?><?php echo ($mas_reference_type->reference->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->reference->cellAttributes() ?>>
...
<?php if ($mas_reference_type->ReferMobileNo->Visible) { // ReferMobileNo ?>
	<div id="r_ReferMobileNo" class="form-group row">
		<label id="elh_mas_reference_type_ReferMobileNo" for="x_ReferMobileNo" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->ReferMobileNo->caption() ?><?php echo ($mas_reference_type->ReferMobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->ReferMobileNo->cellAttributes() ?>>
...
<?php if ($mas_reference_type->ReferClinicname->Visible) { // ReferClinicname ?>
	<div id="r_ReferClinicname" class="form-group row">
		<label id="elh_mas_reference_type_ReferClinicname" for="x_ReferClinicname" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->ReferClinicname->caption() ?><?php echo ($mas_reference_type->ReferClinicname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->ReferClinicname->cellAttributes() ?>>
...
<?php if ($mas_reference_type->ReferCity->Visible) { // ReferCity ?>
	<div id="r_ReferCity" class="form-group row">
		<label id="elh_mas_reference_type_ReferCity" for="x_ReferCity" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->ReferCity->caption() ?><?php echo ($mas_reference_type->ReferCity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->ReferCity->cellAttributes() ?>>
...
<?php if ($mas_reference_type->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_mas_reference_type_HospID" for="x_HospID" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->HospID->caption() ?><?php echo ($mas_reference_type->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->HospID->cellAttributes() ?>>
...
<?php if ($mas_reference_type->_email->Visible) { // email ?>
	<div id="r__email" class="form-group row">
		<label id="elh_mas_reference_type__email" for="x__email" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->_email->caption() ?><?php echo ($mas_reference_type->_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->_email->cellAttributes() ?>>
...
<?php if ($mas_reference_type->whatapp->Visible) { // whatapp ?>
	<div id="r_whatapp" class="form-group row">
		<label id="elh_mas_reference_type_whatapp" for="x_whatapp" class="<?php echo $mas_reference_type_add->LeftColumnClass ?>"><?php echo $mas_reference_type->whatapp->caption() ?><?php echo ($mas_reference_type->whatapp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $mas_reference_type_add->RightColumnClass ?>"><div<?php echo $mas_reference_type->whatapp->cellAttributes() ?>>
