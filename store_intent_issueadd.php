...
var fstore_intent_issueadd = currentForm = new ew.Form("fstore_intent_issueadd", "add");
...
fstore_intent_issueadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($store_intent_issue_add->StoreID->Required) { ?>
		...
		<?php if ($store_intent_issue_add->BranchID->Required) { ?>
...
fstore_intent_issueadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($store_intent_issue_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_intent_issue_add->Token ?>">
<?php } ?>
...
<?php if ($store_intent_issue->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_store_intent_issue_Reception" for="x_Reception" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Reception->caption() ?><?php echo ($store_intent_issue->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Reception->cellAttributes() ?>>
...
<?php if ($store_intent_issue->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_store_intent_issue_PatientId" for="x_PatientId" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->PatientId->caption() ?><?php echo ($store_intent_issue->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->PatientId->cellAttributes() ?>>
...
<?php if ($store_intent_issue->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_store_intent_issue_mrnno" for="x_mrnno" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->mrnno->caption() ?><?php echo ($store_intent_issue->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->mrnno->cellAttributes() ?>>
...
<?php if ($store_intent_issue->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_store_intent_issue_PatientName" for="x_PatientName" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->PatientName->caption() ?><?php echo ($store_intent_issue->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->PatientName->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_store_intent_issue_Age" for="x_Age" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Age->caption() ?><?php echo ($store_intent_issue->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Age->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_store_intent_issue_Gender" for="x_Gender" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Gender->caption() ?><?php echo ($store_intent_issue->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Gender->cellAttributes() ?>>
...
<?php if ($store_intent_issue->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_store_intent_issue_profilePic" for="x_profilePic" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->profilePic->caption() ?><?php echo ($store_intent_issue->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->profilePic->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_store_intent_issue_Mobile" for="x_Mobile" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Mobile->caption() ?><?php echo ($store_intent_issue->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Mobile->cellAttributes() ?>>
...
<?php if ($store_intent_issue->IP_OP->Visible) { // IP_OP ?>
	<div id="r_IP_OP" class="form-group row">
		<label id="elh_store_intent_issue_IP_OP" for="x_IP_OP" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->IP_OP->caption() ?><?php echo ($store_intent_issue->IP_OP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->IP_OP->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_store_intent_issue_Doctor" for="x_Doctor" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Doctor->caption() ?><?php echo ($store_intent_issue->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Doctor->cellAttributes() ?>>
...
<?php if ($store_intent_issue->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_store_intent_issue_voucher_type" for="x_voucher_type" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->voucher_type->caption() ?><?php echo ($store_intent_issue->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->voucher_type->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_store_intent_issue_Details" for="x_Details" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Details->caption() ?><?php echo ($store_intent_issue->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Details->cellAttributes() ?>>
...
<?php if ($store_intent_issue->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_store_intent_issue_ModeofPayment" for="x_ModeofPayment" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->ModeofPayment->caption() ?><?php echo ($store_intent_issue->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->ModeofPayment->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_store_intent_issue_Amount" for="x_Amount" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Amount->caption() ?><?php echo ($store_intent_issue->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Amount->cellAttributes() ?>>
...
<?php if ($store_intent_issue->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_store_intent_issue_AnyDues" for="x_AnyDues" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->AnyDues->caption() ?><?php echo ($store_intent_issue->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->AnyDues->cellAttributes() ?>>
...
<?php if ($store_intent_issue->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_store_intent_issue_createdby" for="x_createdby" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->createdby->caption() ?><?php echo ($store_intent_issue->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->createdby->cellAttributes() ?>>
...
<?php if ($store_intent_issue->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_store_intent_issue_createddatetime" for="x_createddatetime" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->createddatetime->caption() ?><?php echo ($store_intent_issue->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->createddatetime->cellAttributes() ?>>
...
<?php if ($store_intent_issue->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_store_intent_issue_modifiedby" for="x_modifiedby" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->modifiedby->caption() ?><?php echo ($store_intent_issue->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->modifiedby->cellAttributes() ?>>
...
<?php if ($store_intent_issue->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_store_intent_issue_modifieddatetime" for="x_modifieddatetime" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->modifieddatetime->caption() ?><?php echo ($store_intent_issue->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->modifieddatetime->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		<label id="elh_store_intent_issue_RealizationAmount" for="x_RealizationAmount" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RealizationAmount->caption() ?><?php echo ($store_intent_issue->RealizationAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RealizationAmount->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		<label id="elh_store_intent_issue_RealizationStatus" for="x_RealizationStatus" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RealizationStatus->caption() ?><?php echo ($store_intent_issue->RealizationStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RealizationStatus->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		<label id="elh_store_intent_issue_RealizationRemarks" for="x_RealizationRemarks" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RealizationRemarks->caption() ?><?php echo ($store_intent_issue->RealizationRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RealizationRemarks->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		<label id="elh_store_intent_issue_RealizationBatchNo" for="x_RealizationBatchNo" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RealizationBatchNo->caption() ?><?php echo ($store_intent_issue->RealizationBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RealizationBatchNo->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		<label id="elh_store_intent_issue_RealizationDate" for="x_RealizationDate" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RealizationDate->caption() ?><?php echo ($store_intent_issue->RealizationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RealizationDate->cellAttributes() ?>>
...
<?php if ($store_intent_issue->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_store_intent_issue_HospID" for="x_HospID" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->HospID->caption() ?><?php echo ($store_intent_issue->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->HospID->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_store_intent_issue_RIDNO" for="x_RIDNO" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RIDNO->caption() ?><?php echo ($store_intent_issue->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RIDNO->cellAttributes() ?>>
...
<?php if ($store_intent_issue->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_store_intent_issue_TidNo" for="x_TidNo" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->TidNo->caption() ?><?php echo ($store_intent_issue->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->TidNo->cellAttributes() ?>>
...
<?php if ($store_intent_issue->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_store_intent_issue_CId" for="x_CId" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->CId->caption() ?><?php echo ($store_intent_issue->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->CId->cellAttributes() ?>>
...
<?php if ($store_intent_issue->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_store_intent_issue_PartnerName" for="x_PartnerName" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->PartnerName->caption() ?><?php echo ($store_intent_issue->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->PartnerName->cellAttributes() ?>>
...
<?php if ($store_intent_issue->PayerType->Visible) { // PayerType ?>
	<div id="r_PayerType" class="form-group row">
		<label id="elh_store_intent_issue_PayerType" for="x_PayerType" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->PayerType->caption() ?><?php echo ($store_intent_issue->PayerType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->PayerType->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Dob->Visible) { // Dob ?>
	<div id="r_Dob" class="form-group row">
		<label id="elh_store_intent_issue_Dob" for="x_Dob" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Dob->caption() ?><?php echo ($store_intent_issue->Dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Dob->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_store_intent_issue_Currency" for="x_Currency" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Currency->caption() ?><?php echo ($store_intent_issue->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Currency->cellAttributes() ?>>
...
<?php if ($store_intent_issue->DiscountRemarks->Visible) { // DiscountRemarks ?>
	<div id="r_DiscountRemarks" class="form-group row">
		<label id="elh_store_intent_issue_DiscountRemarks" for="x_DiscountRemarks" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->DiscountRemarks->caption() ?><?php echo ($store_intent_issue->DiscountRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->DiscountRemarks->cellAttributes() ?>>
...
<?php if ($store_intent_issue->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_store_intent_issue_Remarks" for="x_Remarks" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->Remarks->caption() ?><?php echo ($store_intent_issue->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->Remarks->cellAttributes() ?>>
...
<?php if ($store_intent_issue->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_store_intent_issue_PatId" for="x_PatId" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->PatId->caption() ?><?php echo ($store_intent_issue->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->PatId->cellAttributes() ?>>
...
<?php if ($store_intent_issue->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_store_intent_issue_DrDepartment" for="x_DrDepartment" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->DrDepartment->caption() ?><?php echo ($store_intent_issue->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->DrDepartment->cellAttributes() ?>>
...
<?php if ($store_intent_issue->RefferedBy->Visible) { // RefferedBy ?>
	<div id="r_RefferedBy" class="form-group row">
		<label id="elh_store_intent_issue_RefferedBy" for="x_RefferedBy" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->RefferedBy->caption() ?><?php echo ($store_intent_issue->RefferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->RefferedBy->cellAttributes() ?>>
...
<?php if ($store_intent_issue->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_store_intent_issue_BillNumber" for="x_BillNumber" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->BillNumber->caption() ?><?php echo ($store_intent_issue->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->BillNumber->cellAttributes() ?>>
...
<?php if ($store_intent_issue->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_store_intent_issue_CardNumber" for="x_CardNumber" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->CardNumber->caption() ?><?php echo ($store_intent_issue->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->CardNumber->cellAttributes() ?>>
...
<?php if ($store_intent_issue->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_store_intent_issue_BankName" for="x_BankName" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->BankName->caption() ?><?php echo ($store_intent_issue->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->BankName->cellAttributes() ?>>
...
<?php if ($store_intent_issue->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_store_intent_issue_DrID" for="x_DrID" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->DrID->caption() ?><?php echo ($store_intent_issue->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->DrID->cellAttributes() ?>>
...
<?php if ($store_intent_issue->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_store_intent_issue_BillStatus" for="x_BillStatus" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->BillStatus->caption() ?><?php echo ($store_intent_issue->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->BillStatus->cellAttributes() ?>>
...
<?php if ($store_intent_issue->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_store_intent_issue_ReportHeader" for="x_ReportHeader" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->ReportHeader->caption() ?><?php echo ($store_intent_issue->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->ReportHeader->cellAttributes() ?>>
...
<?php if ($store_intent_issue->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_intent_issue_StoreID" for="x_StoreID" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->StoreID->caption() ?><?php echo ($store_intent_issue->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->StoreID->cellAttributes() ?>>
...
<?php if ($store_intent_issue->BranchID->Visible) { // BranchID ?>
	<div id="r_BranchID" class="form-group row">
		<label id="elh_store_intent_issue_BranchID" for="x_BranchID" class="<?php echo $store_intent_issue_add->LeftColumnClass ?>"><?php echo $store_intent_issue->BranchID->caption() ?><?php echo ($store_intent_issue->BranchID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_intent_issue_add->RightColumnClass ?>"><div<?php echo $store_intent_issue->BranchID->cellAttributes() ?>>
