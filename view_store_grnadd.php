...
// Create page object
$view_store_grn_add = new view_store_grn_add();

// Run the page
$view_store_grn_add->run();
...
$view_store_grn_add->Page_Render();
?>
...
var fview_store_grnadd = currentForm = new ew.Form("fview_store_grnadd", "add");
...
fview_store_grnadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_store_grn_add->ORDNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->PRC->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->PrName->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->GrnQuantity->Required) { ?>
		...
		<?php if ($view_store_grn_add->QTY->Required) { ?>
		...
		<?php if ($view_store_grn_add->FreeQty->Required) { ?>
		...
		<?php if ($view_store_grn_add->DT->Required) { ?>
		...
		<?php if ($view_store_grn_add->PC->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->YM->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->MFRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->PUnit->Required) { ?>
		...
		<?php if ($view_store_grn_add->SUnit->Required) { ?>
		...
		<?php if ($view_store_grn_add->Stock->Required) { ?>
		...
		<?php if ($view_store_grn_add->MRP->Required) { ?>
		...
		<?php if ($view_store_grn_add->PurRate->Required) { ?>
		...
		<?php if ($view_store_grn_add->PurValue->Required) { ?>
		...
		<?php if ($view_store_grn_add->Disc->Required) { ?>
		...
		<?php if ($view_store_grn_add->PSGST->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->PCGST->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->PTax->Required) { ?>
		...
		<?php if ($view_store_grn_add->ItemValue->Required) { ?>
		...
		<?php if ($view_store_grn_add->SalTax->Required) { ?>
		...
		<?php if ($view_store_grn_add->LastMonthSale->Required) { ?>
		...
		<?php if ($view_store_grn_add->Printcheck->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->poid->Required) { ?>
		...
		<?php if ($view_store_grn_add->grnid->Required) { ?>
		...
		<?php if ($view_store_grn_add->BatchNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->ExpDate->Required) { ?>
		...
		<?php if ($view_store_grn_add->Quantity->Required) { ?>
		...
		<?php if ($view_store_grn_add->SalRate->Required) { ?>
		...
		<?php if ($view_store_grn_add->Discount->Required) { ?>
		...
		<?php if ($view_store_grn_add->SSGST->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->SCGST->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->BRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->HSN->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->Pack->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->GrnMRP->Required) { ?>
		...
		<?php if ($view_store_grn_add->trid->Required) { ?>
		...
		<?php if ($view_store_grn_add->HospID->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->CreatedBy->Required) { ?>
		...
		<?php if ($view_store_grn_add->CreatedDateTime->Required) { ?>
		...
		<?php if ($view_store_grn_add->ModifiedBy->Required) { ?>
		...
		<?php if ($view_store_grn_add->ModifiedDateTime->Required) { ?>
		...
		<?php if ($view_store_grn_add->grncreatedby->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->grncreatedDateTime->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->grnModifiedby->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->grnModifiedDateTime->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->Received->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_grn_add->BillDate->Required) { ?>
		...
		<?php if ($view_store_grn_add->CurStock->Required) { ?>
		...
		<?php if ($view_store_grn_add->FreeQtyyy->Required) { ?>
		...
		<?php if ($view_store_grn_add->grndate->Required) { ?>
		...
		<?php if ($view_store_grn_add->grndatetime->Required) { ?>
		...
		<?php if ($view_store_grn_add->strid->Required) { ?>
		...
		<?php if ($view_store_grn_add->GRNPer->Required) { ?>
...
fview_store_grnadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fview_store_grnadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_store_grnadd.lists["x_PrName"] = <?php echo $view_store_grn_add->PrName->Lookup->toClientList() ?>;
fview_store_grnadd.lists["x_PrName"].options = <?php echo JsonEncode($view_store_grn_add->PrName->lookupOptions()) ?>;
fview_store_grnadd.autoSuggests["x_PrName"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $view_store_grn_add->showPageHeader(); ?>
<?php
$view_store_grn_add->showMessage();
?>
<form name="fview_store_grnadd" id="fview_store_grnadd" class="<?php echo $view_store_grn_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($view_store_grn_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_store_grn_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="view_store_grn">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$view_store_grn_add->IsModal ?>">
...
<?php if ($view_store_grn->ORDNO->Visible) { // ORDNO ?>
	<div id="r_ORDNO" class="form-group row">
		<label id="elh_view_store_grn_ORDNO" for="x_ORDNO" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->ORDNO->caption() ?><?php echo ($view_store_grn->ORDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->ORDNO->cellAttributes() ?>>
...
<?php if ($view_store_grn->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_view_store_grn_PRC" for="x_PRC" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PRC->caption() ?><?php echo ($view_store_grn->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PRC->cellAttributes() ?>>
...
<?php if ($view_store_grn->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_view_store_grn_PrName" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PrName->caption() ?><?php echo ($view_store_grn->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PrName->cellAttributes() ?>>
...
<script>
fview_store_grnadd.createAutoSuggest({"id":"x_PrName","forceSelect":true});
</script>
...
<?php if ($view_store_grn->GrnQuantity->Visible) { // GrnQuantity ?>
	<div id="r_GrnQuantity" class="form-group row">
		<label id="elh_view_store_grn_GrnQuantity" for="x_GrnQuantity" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->GrnQuantity->caption() ?><?php echo ($view_store_grn->GrnQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->GrnQuantity->cellAttributes() ?>>
...
<?php if ($view_store_grn->QTY->Visible) { // QTY ?>
	<div id="r_QTY" class="form-group row">
		<label id="elh_view_store_grn_QTY" for="x_QTY" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->QTY->caption() ?><?php echo ($view_store_grn->QTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->QTY->cellAttributes() ?>>
...
<?php if ($view_store_grn->FreeQty->Visible) { // FreeQty ?>
	<div id="r_FreeQty" class="form-group row">
		<label id="elh_view_store_grn_FreeQty" for="x_FreeQty" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->FreeQty->caption() ?><?php echo ($view_store_grn->FreeQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->FreeQty->cellAttributes() ?>>
...
<?php if ($view_store_grn->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_view_store_grn_DT" for="x_DT" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->DT->caption() ?><?php echo ($view_store_grn->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->DT->cellAttributes() ?>>
...
<?php if ($view_store_grn->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_view_store_grn_PC" for="x_PC" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PC->caption() ?><?php echo ($view_store_grn->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PC->cellAttributes() ?>>
...
<?php if ($view_store_grn->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_view_store_grn_YM" for="x_YM" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->YM->caption() ?><?php echo ($view_store_grn->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->YM->cellAttributes() ?>>
...
<?php if ($view_store_grn->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_view_store_grn_MFRCODE" for="x_MFRCODE" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->MFRCODE->caption() ?><?php echo ($view_store_grn->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->MFRCODE->cellAttributes() ?>>
...
<?php if ($view_store_grn->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_view_store_grn_PUnit" for="x_PUnit" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PUnit->caption() ?><?php echo ($view_store_grn->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PUnit->cellAttributes() ?>>
...
<?php if ($view_store_grn->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_view_store_grn_SUnit" for="x_SUnit" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->SUnit->caption() ?><?php echo ($view_store_grn->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->SUnit->cellAttributes() ?>>
...
<?php if ($view_store_grn->Stock->Visible) { // Stock ?>
	<div id="r_Stock" class="form-group row">
		<label id="elh_view_store_grn_Stock" for="x_Stock" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Stock->caption() ?><?php echo ($view_store_grn->Stock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Stock->cellAttributes() ?>>
...
<?php if ($view_store_grn->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_view_store_grn_MRP" for="x_MRP" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->MRP->caption() ?><?php echo ($view_store_grn->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->MRP->cellAttributes() ?>>
...
<?php if ($view_store_grn->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_view_store_grn_PurRate" for="x_PurRate" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PurRate->caption() ?><?php echo ($view_store_grn->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PurRate->cellAttributes() ?>>
...
<?php if ($view_store_grn->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_view_store_grn_PurValue" for="x_PurValue" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PurValue->caption() ?><?php echo ($view_store_grn->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PurValue->cellAttributes() ?>>
...
<?php if ($view_store_grn->Disc->Visible) { // Disc ?>
	<div id="r_Disc" class="form-group row">
		<label id="elh_view_store_grn_Disc" for="x_Disc" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Disc->caption() ?><?php echo ($view_store_grn->Disc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Disc->cellAttributes() ?>>
...
<?php if ($view_store_grn->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_view_store_grn_PSGST" for="x_PSGST" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PSGST->caption() ?><?php echo ($view_store_grn->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PSGST->cellAttributes() ?>>
...
<?php if ($view_store_grn->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_view_store_grn_PCGST" for="x_PCGST" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PCGST->caption() ?><?php echo ($view_store_grn->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PCGST->cellAttributes() ?>>
...
<?php if ($view_store_grn->PTax->Visible) { // PTax ?>
	<div id="r_PTax" class="form-group row">
		<label id="elh_view_store_grn_PTax" for="x_PTax" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->PTax->caption() ?><?php echo ($view_store_grn->PTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->PTax->cellAttributes() ?>>
...
<?php if ($view_store_grn->ItemValue->Visible) { // ItemValue ?>
	<div id="r_ItemValue" class="form-group row">
		<label id="elh_view_store_grn_ItemValue" for="x_ItemValue" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->ItemValue->caption() ?><?php echo ($view_store_grn->ItemValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->ItemValue->cellAttributes() ?>>
...
<?php if ($view_store_grn->SalTax->Visible) { // SalTax ?>
	<div id="r_SalTax" class="form-group row">
		<label id="elh_view_store_grn_SalTax" for="x_SalTax" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->SalTax->caption() ?><?php echo ($view_store_grn->SalTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->SalTax->cellAttributes() ?>>
...
<?php if ($view_store_grn->LastMonthSale->Visible) { // LastMonthSale ?>
	<div id="r_LastMonthSale" class="form-group row">
		<label id="elh_view_store_grn_LastMonthSale" for="x_LastMonthSale" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->LastMonthSale->caption() ?><?php echo ($view_store_grn->LastMonthSale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->LastMonthSale->cellAttributes() ?>>
...
<?php if ($view_store_grn->Printcheck->Visible) { // Printcheck ?>
	<div id="r_Printcheck" class="form-group row">
		<label id="elh_view_store_grn_Printcheck" for="x_Printcheck" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Printcheck->caption() ?><?php echo ($view_store_grn->Printcheck->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Printcheck->cellAttributes() ?>>
...
<?php if ($view_store_grn->poid->Visible) { // poid ?>
	<div id="r_poid" class="form-group row">
		<label id="elh_view_store_grn_poid" for="x_poid" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->poid->caption() ?><?php echo ($view_store_grn->poid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->poid->cellAttributes() ?>>
...
<?php if ($view_store_grn->grnid->Visible) { // grnid ?>
	<div id="r_grnid" class="form-group row">
		<label id="elh_view_store_grn_grnid" for="x_grnid" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->grnid->caption() ?><?php echo ($view_store_grn->grnid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->grnid->cellAttributes() ?>>
...
<?php if ($view_store_grn->BatchNo->Visible) { // BatchNo ?>
	<div id="r_BatchNo" class="form-group row">
		<label id="elh_view_store_grn_BatchNo" for="x_BatchNo" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->BatchNo->caption() ?><?php echo ($view_store_grn->BatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->BatchNo->cellAttributes() ?>>
...
<?php if ($view_store_grn->ExpDate->Visible) { // ExpDate ?>
	<div id="r_ExpDate" class="form-group row">
		<label id="elh_view_store_grn_ExpDate" for="x_ExpDate" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->ExpDate->caption() ?><?php echo ($view_store_grn->ExpDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->ExpDate->cellAttributes() ?>>
...
<?php if ($view_store_grn->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_view_store_grn_Quantity" for="x_Quantity" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Quantity->caption() ?><?php echo ($view_store_grn->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Quantity->cellAttributes() ?>>
...
<?php if ($view_store_grn->SalRate->Visible) { // SalRate ?>
	<div id="r_SalRate" class="form-group row">
		<label id="elh_view_store_grn_SalRate" for="x_SalRate" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->SalRate->caption() ?><?php echo ($view_store_grn->SalRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->SalRate->cellAttributes() ?>>
...
<?php if ($view_store_grn->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_view_store_grn_Discount" for="x_Discount" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Discount->caption() ?><?php echo ($view_store_grn->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Discount->cellAttributes() ?>>
...
<?php if ($view_store_grn->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_view_store_grn_SSGST" for="x_SSGST" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->SSGST->caption() ?><?php echo ($view_store_grn->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->SSGST->cellAttributes() ?>>
...
<?php if ($view_store_grn->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_view_store_grn_SCGST" for="x_SCGST" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->SCGST->caption() ?><?php echo ($view_store_grn->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->SCGST->cellAttributes() ?>>
...
<?php if ($view_store_grn->HSN->Visible) { // HSN ?>
	<div id="r_HSN" class="form-group row">
		<label id="elh_view_store_grn_HSN" for="x_HSN" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->HSN->caption() ?><?php echo ($view_store_grn->HSN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->HSN->cellAttributes() ?>>
...
<?php if ($view_store_grn->Pack->Visible) { // Pack ?>
	<div id="r_Pack" class="form-group row">
		<label id="elh_view_store_grn_Pack" for="x_Pack" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Pack->caption() ?><?php echo ($view_store_grn->Pack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Pack->cellAttributes() ?>>
...
<?php if ($view_store_grn->GrnMRP->Visible) { // GrnMRP ?>
	<div id="r_GrnMRP" class="form-group row">
		<label id="elh_view_store_grn_GrnMRP" for="x_GrnMRP" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->GrnMRP->caption() ?><?php echo ($view_store_grn->GrnMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->GrnMRP->cellAttributes() ?>>
...
<?php if ($view_store_grn->trid->Visible) { // trid ?>
	<div id="r_trid" class="form-group row">
		<label id="elh_view_store_grn_trid" for="x_trid" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->trid->caption() ?><?php echo ($view_store_grn->trid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->trid->cellAttributes() ?>>
...
<?php if ($view_store_grn->CreatedBy->Visible) { // CreatedBy ?>
	<div id="r_CreatedBy" class="form-group row">
		<label id="elh_view_store_grn_CreatedBy" for="x_CreatedBy" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->CreatedBy->caption() ?><?php echo ($view_store_grn->CreatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->CreatedBy->cellAttributes() ?>>
...
<?php if ($view_store_grn->CreatedDateTime->Visible) { // CreatedDateTime ?>
	<div id="r_CreatedDateTime" class="form-group row">
		<label id="elh_view_store_grn_CreatedDateTime" for="x_CreatedDateTime" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->CreatedDateTime->caption() ?><?php echo ($view_store_grn->CreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->CreatedDateTime->cellAttributes() ?>>
...
<?php if ($view_store_grn->ModifiedBy->Visible) { // ModifiedBy ?>
	<div id="r_ModifiedBy" class="form-group row">
		<label id="elh_view_store_grn_ModifiedBy" for="x_ModifiedBy" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->ModifiedBy->caption() ?><?php echo ($view_store_grn->ModifiedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->ModifiedBy->cellAttributes() ?>>
...
<?php if ($view_store_grn->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
	<div id="r_ModifiedDateTime" class="form-group row">
		<label id="elh_view_store_grn_ModifiedDateTime" for="x_ModifiedDateTime" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->ModifiedDateTime->caption() ?><?php echo ($view_store_grn->ModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->ModifiedDateTime->cellAttributes() ?>>
...
<?php if ($view_store_grn->Received->Visible) { // Received ?>
	<div id="r_Received" class="form-group row">
		<label id="elh_view_store_grn_Received" for="x_Received" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->Received->caption() ?><?php echo ($view_store_grn->Received->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->Received->cellAttributes() ?>>
...
<?php if ($view_store_grn->BillDate->Visible) { // BillDate ?>
	<div id="r_BillDate" class="form-group row">
		<label id="elh_view_store_grn_BillDate" for="x_BillDate" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->BillDate->caption() ?><?php echo ($view_store_grn->BillDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->BillDate->cellAttributes() ?>>
...
<?php if ($view_store_grn->CurStock->Visible) { // CurStock ?>
	<div id="r_CurStock" class="form-group row">
		<label id="elh_view_store_grn_CurStock" for="x_CurStock" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->CurStock->caption() ?><?php echo ($view_store_grn->CurStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->CurStock->cellAttributes() ?>>
...
<?php if ($view_store_grn->FreeQtyyy->Visible) { // FreeQtyyy ?>
	<div id="r_FreeQtyyy" class="form-group row">
		<label id="elh_view_store_grn_FreeQtyyy" for="x_FreeQtyyy" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->FreeQtyyy->caption() ?><?php echo ($view_store_grn->FreeQtyyy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->FreeQtyyy->cellAttributes() ?>>
...
<?php if ($view_store_grn->grndate->Visible) { // grndate ?>
	<div id="r_grndate" class="form-group row">
		<label id="elh_view_store_grn_grndate" for="x_grndate" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->grndate->caption() ?><?php echo ($view_store_grn->grndate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->grndate->cellAttributes() ?>>
...
<?php if ($view_store_grn->grndatetime->Visible) { // grndatetime ?>
	<div id="r_grndatetime" class="form-group row">
		<label id="elh_view_store_grn_grndatetime" for="x_grndatetime" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->grndatetime->caption() ?><?php echo ($view_store_grn->grndatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->grndatetime->cellAttributes() ?>>
...
<?php if ($view_store_grn->strid->Visible) { // strid ?>
	<div id="r_strid" class="form-group row">
		<label id="elh_view_store_grn_strid" for="x_strid" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->strid->caption() ?><?php echo ($view_store_grn->strid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->strid->cellAttributes() ?>>
...
<?php if ($view_store_grn->GRNPer->Visible) { // GRNPer ?>
	<div id="r_GRNPer" class="form-group row">
		<label id="elh_view_store_grn_GRNPer" for="x_GRNPer" class="<?php echo $view_store_grn_add->LeftColumnClass ?>"><?php echo $view_store_grn->GRNPer->caption() ?><?php echo ($view_store_grn->GRNPer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_grn_add->RightColumnClass ?>"><div<?php echo $view_store_grn->GRNPer->cellAttributes() ?>>
...
<?php if (!$view_store_grn_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $view_store_grn_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $view_store_grn_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$view_store_grn_add->showPageFooter();
if (DEBUG_ENABLED)
