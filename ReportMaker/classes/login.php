 ...
 * Page class (login)
 */
class login extends user_login_base
{
	...
	public function __construct()
	{
		...
		// Table object (user_login_base)
		if (!isset($GLOBALS["user_login_base"])) {
			$GLOBALS["user_login_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["user_login_base"];
		}
