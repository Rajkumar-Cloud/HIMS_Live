...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "HIMS___2019"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'P54MfzZ06p2QzfIm'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phprptcss/HIMS___2019.css"); // Project stylesheet file name
...
$PROJECT_ID = "{55283AC9-9E27-42B1-8A30-44C43BC7CEA5}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
