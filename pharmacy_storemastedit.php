...
var fpharmacy_storemastedit = currentForm = new ew.Form("fpharmacy_storemastedit", "edit");
...
fpharmacy_storemastedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($pharmacy_storemast_edit->Scheduling->Required) { ?>
		...
		<?php } ?>
		<?php if ($pharmacy_storemast_edit->Schedulingh1->Required) { ?>
...
fpharmacy_storemastedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpharmacy_storemastedit.lists["x_TYPE"] = <?php echo $pharmacy_storemast_edit->TYPE->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_TYPE"].options = <?php echo JsonEncode($pharmacy_storemast_edit->TYPE->options(FALSE, TRUE)) ?>;
fpharmacy_storemastedit.lists["x_LASTSUPP"] = <?php echo $pharmacy_storemast_edit->LASTSUPP->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_LASTSUPP"].options = <?php echo JsonEncode($pharmacy_storemast_edit->LASTSUPP->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_GENNAME"] = <?php echo $pharmacy_storemast_edit->GENNAME->Lookup->toClientList() ?>;
...
fpharmacy_storemastedit.lists["x_DRID"] = <?php echo $pharmacy_storemast_edit->DRID->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_DRID"].options = <?php echo JsonEncode($pharmacy_storemast_edit->DRID->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_MFRCODE"] = <?php echo $pharmacy_storemast_edit->MFRCODE->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_MFRCODE"].options = <?php echo JsonEncode($pharmacy_storemast_edit->MFRCODE->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_COMBCODE"] = <?php echo $pharmacy_storemast_edit->COMBCODE->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_COMBCODE"].options = <?php echo JsonEncode($pharmacy_storemast_edit->COMBCODE->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_GENCODE"] = <?php echo $pharmacy_storemast_edit->GENCODE->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_GENCODE"].options = <?php echo JsonEncode($pharmacy_storemast_edit->GENCODE->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_UNIT"] = <?php echo $pharmacy_storemast_edit->UNIT->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_UNIT"].options = <?php echo JsonEncode($pharmacy_storemast_edit->UNIT->options(FALSE, TRUE)) ?>;
fpharmacy_storemastedit.lists["x_FORMULARY"] = <?php echo $pharmacy_storemast_edit->FORMULARY->Lookup->toClientList() ?>;
...
fpharmacy_storemastedit.lists["x_SUPPNAME"] = <?php echo $pharmacy_storemast_edit->SUPPNAME->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_SUPPNAME"].options = <?php echo JsonEncode($pharmacy_storemast_edit->SUPPNAME->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_COMBNAME"] = <?php echo $pharmacy_storemast_edit->COMBNAME->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_COMBNAME"].options = <?php echo JsonEncode($pharmacy_storemast_edit->COMBNAME->lookupOptions()) ?>;
fpharmacy_storemastedit.lists["x_GENERICNAME"] = <?php echo $pharmacy_storemast_edit->GENERICNAME->Lookup->toClientList() ?>;
...
fpharmacy_storemastedit.lists["x_Scheduling"] = <?php echo $pharmacy_storemast_edit->Scheduling->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_Scheduling"].options = <?php echo JsonEncode($pharmacy_storemast_edit->Scheduling->options(FALSE, TRUE)) ?>;
fpharmacy_storemastedit.lists["x_Schedulingh1"] = <?php echo $pharmacy_storemast_edit->Schedulingh1->Lookup->toClientList() ?>;
fpharmacy_storemastedit.lists["x_Schedulingh1"].options = <?php echo JsonEncode($pharmacy_storemast_edit->Schedulingh1->options(FALSE, TRUE)) ?>;
...
<?php if ($pharmacy_storemast_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_storemast_edit->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_storemast->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_pharmacy_storemast_PRC" for="x_PRC" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->PRC->caption() ?><?php echo ($pharmacy_storemast->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->PRC->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->TYPE->Visible) { // TYPE ?>
	<div id="r_TYPE" class="form-group row">
		<label id="elh_pharmacy_storemast_TYPE" for="x_TYPE" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->TYPE->caption() ?><?php echo ($pharmacy_storemast->TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->TYPE->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->DES->Visible) { // DES ?>
	<div id="r_DES" class="form-group row">
		<label id="elh_pharmacy_storemast_DES" for="x_DES" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->DES->caption() ?><?php echo ($pharmacy_storemast->DES->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->DES->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->UM->Visible) { // UM ?>
	<div id="r_UM" class="form-group row">
		<label id="elh_pharmacy_storemast_UM" for="x_UM" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->UM->caption() ?><?php echo ($pharmacy_storemast->UM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->UM->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->RT->Visible) { // RT ?>
	<div id="r_RT" class="form-group row">
		<label id="elh_pharmacy_storemast_RT" for="x_RT" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->RT->caption() ?><?php echo ($pharmacy_storemast->RT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->RT->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->BATCHNO->Visible) { // BATCHNO ?>
	<div id="r_BATCHNO" class="form-group row">
		<label id="elh_pharmacy_storemast_BATCHNO" for="x_BATCHNO" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->BATCHNO->caption() ?><?php echo ($pharmacy_storemast->BATCHNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->BATCHNO->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_pharmacy_storemast_MRP" for="x_MRP" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->MRP->caption() ?><?php echo ($pharmacy_storemast->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->MRP->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->EXPDT->Visible) { // EXPDT ?>
	<div id="r_EXPDT" class="form-group row">
		<label id="elh_pharmacy_storemast_EXPDT" for="x_EXPDT" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->EXPDT->caption() ?><?php echo ($pharmacy_storemast->EXPDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->EXPDT->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->LASTPURDT->Visible) { // LASTPURDT ?>
	<div id="r_LASTPURDT" class="form-group row">
		<label id="elh_pharmacy_storemast_LASTPURDT" for="x_LASTPURDT" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->LASTPURDT->caption() ?><?php echo ($pharmacy_storemast->LASTPURDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->LASTPURDT->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->LASTSUPP->Visible) { // LASTSUPP ?>
	<div id="r_LASTSUPP" class="form-group row">
		<label id="elh_pharmacy_storemast_LASTSUPP" for="x_LASTSUPP" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->LASTSUPP->caption() ?><?php echo ($pharmacy_storemast->LASTSUPP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->LASTSUPP->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->GENNAME->Visible) { // GENNAME ?>
	<div id="r_GENNAME" class="form-group row">
		<label id="elh_pharmacy_storemast_GENNAME" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->GENNAME->caption() ?><?php echo ($pharmacy_storemast->GENNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->GENNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->LASTISSDT->Visible) { // LASTISSDT ?>
	<div id="r_LASTISSDT" class="form-group row">
		<label id="elh_pharmacy_storemast_LASTISSDT" for="x_LASTISSDT" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->LASTISSDT->caption() ?><?php echo ($pharmacy_storemast->LASTISSDT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->LASTISSDT->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->DRID->Visible) { // DRID ?>
	<div id="r_DRID" class="form-group row">
		<label id="elh_pharmacy_storemast_DRID" for="x_DRID" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->DRID->caption() ?><?php echo ($pharmacy_storemast->DRID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->DRID->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_pharmacy_storemast_MFRCODE" for="x_MFRCODE" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->MFRCODE->caption() ?><?php echo ($pharmacy_storemast->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->MFRCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->COMBCODE->Visible) { // COMBCODE ?>
	<div id="r_COMBCODE" class="form-group row">
		<label id="elh_pharmacy_storemast_COMBCODE" for="x_COMBCODE" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->COMBCODE->caption() ?><?php echo ($pharmacy_storemast->COMBCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->COMBCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->GENCODE->Visible) { // GENCODE ?>
	<div id="r_GENCODE" class="form-group row">
		<label id="elh_pharmacy_storemast_GENCODE" for="x_GENCODE" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->GENCODE->caption() ?><?php echo ($pharmacy_storemast->GENCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->GENCODE->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->STRENGTH->Visible) { // STRENGTH ?>
	<div id="r_STRENGTH" class="form-group row">
		<label id="elh_pharmacy_storemast_STRENGTH" for="x_STRENGTH" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->STRENGTH->caption() ?><?php echo ($pharmacy_storemast->STRENGTH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->STRENGTH->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->UNIT->Visible) { // UNIT ?>
	<div id="r_UNIT" class="form-group row">
		<label id="elh_pharmacy_storemast_UNIT" for="x_UNIT" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->UNIT->caption() ?><?php echo ($pharmacy_storemast->UNIT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->UNIT->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->FORMULARY->Visible) { // FORMULARY ?>
	<div id="r_FORMULARY" class="form-group row">
		<label id="elh_pharmacy_storemast_FORMULARY" for="x_FORMULARY" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->FORMULARY->caption() ?><?php echo ($pharmacy_storemast->FORMULARY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->FORMULARY->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->RACKNO->Visible) { // RACKNO ?>
	<div id="r_RACKNO" class="form-group row">
		<label id="elh_pharmacy_storemast_RACKNO" for="x_RACKNO" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->RACKNO->caption() ?><?php echo ($pharmacy_storemast->RACKNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->RACKNO->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->SUPPNAME->Visible) { // SUPPNAME ?>
	<div id="r_SUPPNAME" class="form-group row">
		<label id="elh_pharmacy_storemast_SUPPNAME" for="x_SUPPNAME" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->SUPPNAME->caption() ?><?php echo ($pharmacy_storemast->SUPPNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->SUPPNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->COMBNAME->Visible) { // COMBNAME ?>
	<div id="r_COMBNAME" class="form-group row">
		<label id="elh_pharmacy_storemast_COMBNAME" for="x_COMBNAME" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->COMBNAME->caption() ?><?php echo ($pharmacy_storemast->COMBNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->COMBNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->GENERICNAME->Visible) { // GENERICNAME ?>
	<div id="r_GENERICNAME" class="form-group row">
		<label id="elh_pharmacy_storemast_GENERICNAME" for="x_GENERICNAME" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->GENERICNAME->caption() ?><?php echo ($pharmacy_storemast->GENERICNAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->GENERICNAME->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->REMARK->Visible) { // REMARK ?>
	<div id="r_REMARK" class="form-group row">
		<label id="elh_pharmacy_storemast_REMARK" for="x_REMARK" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->REMARK->caption() ?><?php echo ($pharmacy_storemast->REMARK->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->REMARK->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->TEMP->Visible) { // TEMP ?>
	<div id="r_TEMP" class="form-group row">
		<label id="elh_pharmacy_storemast_TEMP" for="x_TEMP" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->TEMP->caption() ?><?php echo ($pharmacy_storemast->TEMP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->TEMP->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_pharmacy_storemast_id" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->id->caption() ?><?php echo ($pharmacy_storemast->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->id->cellAttributes() ?>>
...
<input type="hidden" data-table="pharmacy_storemast" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($pharmacy_storemast->id->CurrentValue) ?>">
<?php echo $pharmacy_storemast->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pharmacy_storemast->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_pharmacy_storemast_PurValue" for="x_PurValue" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->PurValue->caption() ?><?php echo ($pharmacy_storemast->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->PurValue->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_pharmacy_storemast_PSGST" for="x_PSGST" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->PSGST->caption() ?><?php echo ($pharmacy_storemast->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->PSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_pharmacy_storemast_PCGST" for="x_PCGST" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->PCGST->caption() ?><?php echo ($pharmacy_storemast->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->PCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->SaleValue->Visible) { // SaleValue ?>
	<div id="r_SaleValue" class="form-group row">
		<label id="elh_pharmacy_storemast_SaleValue" for="x_SaleValue" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->SaleValue->caption() ?><?php echo ($pharmacy_storemast->SaleValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->SaleValue->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_pharmacy_storemast_SSGST" for="x_SSGST" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->SSGST->caption() ?><?php echo ($pharmacy_storemast->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->SSGST->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_pharmacy_storemast_SCGST" for="x_SCGST" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->SCGST->caption() ?><?php echo ($pharmacy_storemast->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->SCGST->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->SaleRate->Visible) { // SaleRate ?>
	<div id="r_SaleRate" class="form-group row">
		<label id="elh_pharmacy_storemast_SaleRate" for="x_SaleRate" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->SaleRate->caption() ?><?php echo ($pharmacy_storemast->SaleRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->SaleRate->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->Scheduling->Visible) { // Scheduling ?>
	<div id="r_Scheduling" class="form-group row">
		<label id="elh_pharmacy_storemast_Scheduling" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->Scheduling->caption() ?><?php echo ($pharmacy_storemast->Scheduling->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->Scheduling->cellAttributes() ?>>
...
<?php if ($pharmacy_storemast->Schedulingh1->Visible) { // Schedulingh1 ?>
	<div id="r_Schedulingh1" class="form-group row">
		<label id="elh_pharmacy_storemast_Schedulingh1" class="<?php echo $pharmacy_storemast_edit->LeftColumnClass ?>"><?php echo $pharmacy_storemast->Schedulingh1->caption() ?><?php echo ($pharmacy_storemast->Schedulingh1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_storemast_edit->RightColumnClass ?>"><div<?php echo $pharmacy_storemast->Schedulingh1->cellAttributes() ?>>
