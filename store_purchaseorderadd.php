...
// Create page object
$store_purchaseorder_add = new store_purchaseorder_add();

// Run the page
$store_purchaseorder_add->run();
...
$store_purchaseorder_add->Page_Render();
?>
...
var fstore_purchaseorderadd = currentForm = new ew.Form("fstore_purchaseorderadd", "add");

// Validate form
fstore_purchaseorderadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($store_purchaseorder_add->ORDNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->PRC->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->QTY->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->DT->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PC->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->YM->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->MFRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->Stock->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->LastMonthSale->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->Printcheck->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->poid->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grnid->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->BatchNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->ExpDate->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PrName->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->Quantity->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->FreeQty->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->ItemValue->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->Disc->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PTax->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->MRP->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->SalTax->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PurValue->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PurRate->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->SalRate->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->Discount->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PSGST->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->PCGST->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->SSGST->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->SCGST->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->BRCODE->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->HSN->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->Pack->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->PUnit->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->SUnit->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->GrnQuantity->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->GrnMRP->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->trid->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->HospID->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->CreatedBy->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->CreatedDateTime->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->ModifiedBy->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->ModifiedDateTime->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grncreatedby->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grncreatedDateTime->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grnModifiedby->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grnModifiedDateTime->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->Received->Required) { ?>
		...
		<?php } ?>
		<?php if ($store_purchaseorder_add->BillDate->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->CurStock->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->FreeQtyyy->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grndate->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->grndatetime->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->strid->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->GRNPer->Required) { ?>
		...
		<?php if ($store_purchaseorder_add->StoreID->Required) { ?>
...
fstore_purchaseorderadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fstore_purchaseorderadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $store_purchaseorder_add->showPageHeader(); ?>
<?php
$store_purchaseorder_add->showMessage();
?>
<form name="fstore_purchaseorderadd" id="fstore_purchaseorderadd" class="<?php echo $store_purchaseorder_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($store_purchaseorder_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $store_purchaseorder_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="store_purchaseorder">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$store_purchaseorder_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($store_purchaseorder->ORDNO->Visible) { // ORDNO ?>
	<div id="r_ORDNO" class="form-group row">
		<label id="elh_store_purchaseorder_ORDNO" for="x_ORDNO" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->ORDNO->caption() ?><?php echo ($store_purchaseorder->ORDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->ORDNO->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_store_purchaseorder_PRC" for="x_PRC" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PRC->caption() ?><?php echo ($store_purchaseorder->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PRC->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->QTY->Visible) { // QTY ?>
	<div id="r_QTY" class="form-group row">
		<label id="elh_store_purchaseorder_QTY" for="x_QTY" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->QTY->caption() ?><?php echo ($store_purchaseorder->QTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->QTY->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_store_purchaseorder_DT" for="x_DT" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->DT->caption() ?><?php echo ($store_purchaseorder->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->DT->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_DT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_store_purchaseorder_PC" for="x_PC" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PC->caption() ?><?php echo ($store_purchaseorder->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PC->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_store_purchaseorder_YM" for="x_YM" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->YM->caption() ?><?php echo ($store_purchaseorder->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->YM->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_store_purchaseorder_MFRCODE" for="x_MFRCODE" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->MFRCODE->caption() ?><?php echo ($store_purchaseorder->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->MFRCODE->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->Stock->Visible) { // Stock ?>
	<div id="r_Stock" class="form-group row">
		<label id="elh_store_purchaseorder_Stock" for="x_Stock" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Stock->caption() ?><?php echo ($store_purchaseorder->Stock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Stock->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->LastMonthSale->Visible) { // LastMonthSale ?>
	<div id="r_LastMonthSale" class="form-group row">
		<label id="elh_store_purchaseorder_LastMonthSale" for="x_LastMonthSale" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->LastMonthSale->caption() ?><?php echo ($store_purchaseorder->LastMonthSale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->LastMonthSale->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->Printcheck->Visible) { // Printcheck ?>
	<div id="r_Printcheck" class="form-group row">
		<label id="elh_store_purchaseorder_Printcheck" for="x_Printcheck" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Printcheck->caption() ?><?php echo ($store_purchaseorder->Printcheck->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Printcheck->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->poid->Visible) { // poid ?>
	<div id="r_poid" class="form-group row">
		<label id="elh_store_purchaseorder_poid" for="x_poid" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->poid->caption() ?><?php echo ($store_purchaseorder->poid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->poid->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->grnid->Visible) { // grnid ?>
	<div id="r_grnid" class="form-group row">
		<label id="elh_store_purchaseorder_grnid" for="x_grnid" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grnid->caption() ?><?php echo ($store_purchaseorder->grnid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grnid->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->BatchNo->Visible) { // BatchNo ?>
	<div id="r_BatchNo" class="form-group row">
		<label id="elh_store_purchaseorder_BatchNo" for="x_BatchNo" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->BatchNo->caption() ?><?php echo ($store_purchaseorder->BatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->BatchNo->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->ExpDate->Visible) { // ExpDate ?>
	<div id="r_ExpDate" class="form-group row">
		<label id="elh_store_purchaseorder_ExpDate" for="x_ExpDate" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->ExpDate->caption() ?><?php echo ($store_purchaseorder->ExpDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->ExpDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_ExpDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_store_purchaseorder_PrName" for="x_PrName" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PrName->caption() ?><?php echo ($store_purchaseorder->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PrName->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_store_purchaseorder_Quantity" for="x_Quantity" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Quantity->caption() ?><?php echo ($store_purchaseorder->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Quantity->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->FreeQty->Visible) { // FreeQty ?>
	<div id="r_FreeQty" class="form-group row">
		<label id="elh_store_purchaseorder_FreeQty" for="x_FreeQty" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->FreeQty->caption() ?><?php echo ($store_purchaseorder->FreeQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->FreeQty->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->ItemValue->Visible) { // ItemValue ?>
	<div id="r_ItemValue" class="form-group row">
		<label id="elh_store_purchaseorder_ItemValue" for="x_ItemValue" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->ItemValue->caption() ?><?php echo ($store_purchaseorder->ItemValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->ItemValue->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->Disc->Visible) { // Disc ?>
	<div id="r_Disc" class="form-group row">
		<label id="elh_store_purchaseorder_Disc" for="x_Disc" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Disc->caption() ?><?php echo ($store_purchaseorder->Disc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Disc->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PTax->Visible) { // PTax ?>
	<div id="r_PTax" class="form-group row">
		<label id="elh_store_purchaseorder_PTax" for="x_PTax" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PTax->caption() ?><?php echo ($store_purchaseorder->PTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PTax->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_store_purchaseorder_MRP" for="x_MRP" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->MRP->caption() ?><?php echo ($store_purchaseorder->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->MRP->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->SalTax->Visible) { // SalTax ?>
	<div id="r_SalTax" class="form-group row">
		<label id="elh_store_purchaseorder_SalTax" for="x_SalTax" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->SalTax->caption() ?><?php echo ($store_purchaseorder->SalTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->SalTax->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_store_purchaseorder_PurValue" for="x_PurValue" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PurValue->caption() ?><?php echo ($store_purchaseorder->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PurValue->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_store_purchaseorder_PurRate" for="x_PurRate" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PurRate->caption() ?><?php echo ($store_purchaseorder->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PurRate->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->SalRate->Visible) { // SalRate ?>
	<div id="r_SalRate" class="form-group row">
		<label id="elh_store_purchaseorder_SalRate" for="x_SalRate" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->SalRate->caption() ?><?php echo ($store_purchaseorder->SalRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->SalRate->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_store_purchaseorder_Discount" for="x_Discount" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Discount->caption() ?><?php echo ($store_purchaseorder->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Discount->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_store_purchaseorder_PSGST" for="x_PSGST" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PSGST->caption() ?><?php echo ($store_purchaseorder->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PSGST->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_store_purchaseorder_PCGST" for="x_PCGST" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PCGST->caption() ?><?php echo ($store_purchaseorder->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PCGST->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_store_purchaseorder_SSGST" for="x_SSGST" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->SSGST->caption() ?><?php echo ($store_purchaseorder->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->SSGST->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_store_purchaseorder_SCGST" for="x_SCGST" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->SCGST->caption() ?><?php echo ($store_purchaseorder->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->SCGST->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_store_purchaseorder_BRCODE" for="x_BRCODE" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->BRCODE->caption() ?><?php echo ($store_purchaseorder->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->BRCODE->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->HSN->Visible) { // HSN ?>
	<div id="r_HSN" class="form-group row">
		<label id="elh_store_purchaseorder_HSN" for="x_HSN" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->HSN->caption() ?><?php echo ($store_purchaseorder->HSN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->HSN->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->Pack->Visible) { // Pack ?>
	<div id="r_Pack" class="form-group row">
		<label id="elh_store_purchaseorder_Pack" for="x_Pack" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Pack->caption() ?><?php echo ($store_purchaseorder->Pack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Pack->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_store_purchaseorder_PUnit" for="x_PUnit" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->PUnit->caption() ?><?php echo ($store_purchaseorder->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->PUnit->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_store_purchaseorder_SUnit" for="x_SUnit" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->SUnit->caption() ?><?php echo ($store_purchaseorder->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->SUnit->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->GrnQuantity->Visible) { // GrnQuantity ?>
	<div id="r_GrnQuantity" class="form-group row">
		<label id="elh_store_purchaseorder_GrnQuantity" for="x_GrnQuantity" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->GrnQuantity->caption() ?><?php echo ($store_purchaseorder->GrnQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->GrnQuantity->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->GrnMRP->Visible) { // GrnMRP ?>
	<div id="r_GrnMRP" class="form-group row">
		<label id="elh_store_purchaseorder_GrnMRP" for="x_GrnMRP" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->GrnMRP->caption() ?><?php echo ($store_purchaseorder->GrnMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->GrnMRP->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->trid->Visible) { // trid ?>
	<div id="r_trid" class="form-group row">
		<label id="elh_store_purchaseorder_trid" for="x_trid" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->trid->caption() ?><?php echo ($store_purchaseorder->trid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->trid->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_store_purchaseorder_HospID" for="x_HospID" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->HospID->caption() ?><?php echo ($store_purchaseorder->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->HospID->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->CreatedBy->Visible) { // CreatedBy ?>
	<div id="r_CreatedBy" class="form-group row">
		<label id="elh_store_purchaseorder_CreatedBy" for="x_CreatedBy" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->CreatedBy->caption() ?><?php echo ($store_purchaseorder->CreatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->CreatedBy->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->CreatedDateTime->Visible) { // CreatedDateTime ?>
	<div id="r_CreatedDateTime" class="form-group row">
		<label id="elh_store_purchaseorder_CreatedDateTime" for="x_CreatedDateTime" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->CreatedDateTime->caption() ?><?php echo ($store_purchaseorder->CreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->CreatedDateTime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_CreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->ModifiedBy->Visible) { // ModifiedBy ?>
	<div id="r_ModifiedBy" class="form-group row">
		<label id="elh_store_purchaseorder_ModifiedBy" for="x_ModifiedBy" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->ModifiedBy->caption() ?><?php echo ($store_purchaseorder->ModifiedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->ModifiedBy->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
	<div id="r_ModifiedDateTime" class="form-group row">
		<label id="elh_store_purchaseorder_ModifiedDateTime" for="x_ModifiedDateTime" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->ModifiedDateTime->caption() ?><?php echo ($store_purchaseorder->ModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->ModifiedDateTime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_ModifiedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->grncreatedby->Visible) { // grncreatedby ?>
	<div id="r_grncreatedby" class="form-group row">
		<label id="elh_store_purchaseorder_grncreatedby" for="x_grncreatedby" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grncreatedby->caption() ?><?php echo ($store_purchaseorder->grncreatedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grncreatedby->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->grncreatedDateTime->Visible) { // grncreatedDateTime ?>
	<div id="r_grncreatedDateTime" class="form-group row">
		<label id="elh_store_purchaseorder_grncreatedDateTime" for="x_grncreatedDateTime" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grncreatedDateTime->caption() ?><?php echo ($store_purchaseorder->grncreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grncreatedDateTime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_grncreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->grnModifiedby->Visible) { // grnModifiedby ?>
	<div id="r_grnModifiedby" class="form-group row">
		<label id="elh_store_purchaseorder_grnModifiedby" for="x_grnModifiedby" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grnModifiedby->caption() ?><?php echo ($store_purchaseorder->grnModifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grnModifiedby->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->grnModifiedDateTime->Visible) { // grnModifiedDateTime ?>
	<div id="r_grnModifiedDateTime" class="form-group row">
		<label id="elh_store_purchaseorder_grnModifiedDateTime" for="x_grnModifiedDateTime" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grnModifiedDateTime->caption() ?><?php echo ($store_purchaseorder->grnModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grnModifiedDateTime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_grnModifiedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->Received->Visible) { // Received ?>
	<div id="r_Received" class="form-group row">
		<label id="elh_store_purchaseorder_Received" for="x_Received" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->Received->caption() ?><?php echo ($store_purchaseorder->Received->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->Received->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->BillDate->Visible) { // BillDate ?>
	<div id="r_BillDate" class="form-group row">
		<label id="elh_store_purchaseorder_BillDate" for="x_BillDate" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->BillDate->caption() ?><?php echo ($store_purchaseorder->BillDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->BillDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_BillDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->CurStock->Visible) { // CurStock ?>
	<div id="r_CurStock" class="form-group row">
		<label id="elh_store_purchaseorder_CurStock" for="x_CurStock" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->CurStock->caption() ?><?php echo ($store_purchaseorder->CurStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->CurStock->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->FreeQtyyy->Visible) { // FreeQtyyy ?>
	<div id="r_FreeQtyyy" class="form-group row">
		<label id="elh_store_purchaseorder_FreeQtyyy" for="x_FreeQtyyy" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->FreeQtyyy->caption() ?><?php echo ($store_purchaseorder->FreeQtyyy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->FreeQtyyy->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->grndate->Visible) { // grndate ?>
	<div id="r_grndate" class="form-group row">
		<label id="elh_store_purchaseorder_grndate" for="x_grndate" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grndate->caption() ?><?php echo ($store_purchaseorder->grndate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grndate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_grndate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->grndatetime->Visible) { // grndatetime ?>
	<div id="r_grndatetime" class="form-group row">
		<label id="elh_store_purchaseorder_grndatetime" for="x_grndatetime" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->grndatetime->caption() ?><?php echo ($store_purchaseorder->grndatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->grndatetime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fstore_purchaseorderadd", "x_grndatetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($store_purchaseorder->strid->Visible) { // strid ?>
	<div id="r_strid" class="form-group row">
		<label id="elh_store_purchaseorder_strid" for="x_strid" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->strid->caption() ?><?php echo ($store_purchaseorder->strid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->strid->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->GRNPer->Visible) { // GRNPer ?>
	<div id="r_GRNPer" class="form-group row">
		<label id="elh_store_purchaseorder_GRNPer" for="x_GRNPer" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->GRNPer->caption() ?><?php echo ($store_purchaseorder->GRNPer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->GRNPer->cellAttributes() ?>>
...
<?php if ($store_purchaseorder->StoreID->Visible) { // StoreID ?>
	<div id="r_StoreID" class="form-group row">
		<label id="elh_store_purchaseorder_StoreID" for="x_StoreID" class="<?php echo $store_purchaseorder_add->LeftColumnClass ?>"><?php echo $store_purchaseorder->StoreID->caption() ?><?php echo ($store_purchaseorder->StoreID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $store_purchaseorder_add->RightColumnClass ?>"><div<?php echo $store_purchaseorder->StoreID->cellAttributes() ?>>
...
<?php if (!$store_purchaseorder_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $store_purchaseorder_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $store_purchaseorder_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$store_purchaseorder_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$store_purchaseorder_add->terminate();
?>