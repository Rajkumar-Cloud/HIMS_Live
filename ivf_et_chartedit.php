...
var fivf_et_chartedit = currentForm = new ew.Form("fivf_et_chartedit", "edit");
...
fivf_et_chartedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_et_chartedit.lists["x_ARTCycle"] = <?php echo $ivf_et_chart_edit->ARTCycle->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_ARTCycle"].options = <?php echo JsonEncode($ivf_et_chart_edit->ARTCycle->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_InseminatinTechnique"] = <?php echo $ivf_et_chart_edit->InseminatinTechnique->Lookup->toClientList() ?>;
...
fivf_et_chartedit.lists["x_PreTreatment"] = <?php echo $ivf_et_chart_edit->PreTreatment->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_PreTreatment"].options = <?php echo JsonEncode($ivf_et_chart_edit->PreTreatment->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_Hysteroscopy"] = <?php echo $ivf_et_chart_edit->Hysteroscopy->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_Hysteroscopy"].options = <?php echo JsonEncode($ivf_et_chart_edit->Hysteroscopy->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_EndometrialScratching"] = <?php echo $ivf_et_chart_edit->EndometrialScratching->Lookup->toClientList() ?>;
...
fivf_et_chartedit.lists["x_TrialCannulation"] = <?php echo $ivf_et_chart_edit->TrialCannulation->Lookup->toClientList() ?>;
...
fivf_et_chartedit.lists["x_CYCLETYPE"] = <?php echo $ivf_et_chart_edit->CYCLETYPE->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_CYCLETYPE"].options = <?php echo JsonEncode($ivf_et_chart_edit->CYCLETYPE->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_OralEstrogenDosage"] = <?php echo $ivf_et_chart_edit->OralEstrogenDosage->Lookup->toClientList() ?>;
...
fivf_et_chartedit.lists["x_GCSF"] = <?php echo $ivf_et_chart_edit->GCSF->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_GCSF"].options = <?php echo JsonEncode($ivf_et_chart_edit->GCSF->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_ActivatedPRP"] = <?php echo $ivf_et_chart_edit->ActivatedPRP->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_ActivatedPRP"].options = <?php echo JsonEncode($ivf_et_chart_edit->ActivatedPRP->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_ERA"] = <?php echo $ivf_et_chart_edit->ERA->Lookup->toClientList() ?>;
fivf_et_chartedit.lists["x_ERA"].options = <?php echo JsonEncode($ivf_et_chart_edit->ERA->options(FALSE, TRUE)) ?>;
fivf_et_chartedit.lists["x_TemplateProcedureRecord"] = <?php echo $ivf_et_chart_edit->TemplateProcedureRecord->Lookup->toClientList() ?>;
...
fivf_et_chartedit.lists["x_TemplateMedicationsadvised"] = <?php echo $ivf_et_chart_edit->TemplateMedicationsadvised->Lookup->toClientList() ?>;
...
fivf_et_chartedit.lists["x_TemplatePostProcedureInstructions"] = <?php echo $ivf_et_chart_edit->TemplatePostProcedureInstructions->Lookup->toClientList() ?>;
...
<?php if ($ivf_et_chart_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_et_chart_edit->Token ?>">
<?php } ?>
...
<?php if ($ivf_et_chart->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_ivf_et_chart_id" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_id" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->id->caption() ?><?php echo ($ivf_et_chart->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->id->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_id" class="ivf_et_chartedit" type="text/html">
...
<input type="hidden" data-table="ivf_et_chart" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($ivf_et_chart->id->CurrentValue) ?>">
<?php echo $ivf_et_chart->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ivf_et_chart->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_et_chart_RIDNo" for="x_RIDNo" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_RIDNo" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->RIDNo->caption() ?><?php echo ($ivf_et_chart->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->RIDNo->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_RIDNo" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_et_chart_Name" for="x_Name" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Name" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Name->caption() ?><?php echo ($ivf_et_chart->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Name->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Name" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->ARTCycle->Visible) { // ARTCycle ?>
	<div id="r_ARTCycle" class="form-group row">
		<label id="elh_ivf_et_chart_ARTCycle" for="x_ARTCycle" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_ARTCycle" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->ARTCycle->caption() ?><?php echo ($ivf_et_chart->ARTCycle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->ARTCycle->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_ARTCycle" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Consultant->Visible) { // Consultant ?>
	<div id="r_Consultant" class="form-group row">
		<label id="elh_ivf_et_chart_Consultant" for="x_Consultant" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Consultant" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Consultant->caption() ?><?php echo ($ivf_et_chart->Consultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Consultant->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Consultant" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->InseminatinTechnique->Visible) { // InseminatinTechnique ?>
	<div id="r_InseminatinTechnique" class="form-group row">
		<label id="elh_ivf_et_chart_InseminatinTechnique" for="x_InseminatinTechnique" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_InseminatinTechnique" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->InseminatinTechnique->caption() ?><?php echo ($ivf_et_chart->InseminatinTechnique->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->InseminatinTechnique->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_InseminatinTechnique" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->IndicationForART->Visible) { // IndicationForART ?>
	<div id="r_IndicationForART" class="form-group row">
		<label id="elh_ivf_et_chart_IndicationForART" for="x_IndicationForART" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_IndicationForART" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->IndicationForART->caption() ?><?php echo ($ivf_et_chart->IndicationForART->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->IndicationForART->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_IndicationForART" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->PreTreatment->Visible) { // PreTreatment ?>
	<div id="r_PreTreatment" class="form-group row">
		<label id="elh_ivf_et_chart_PreTreatment" for="x_PreTreatment" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_PreTreatment" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->PreTreatment->caption() ?><?php echo ($ivf_et_chart->PreTreatment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->PreTreatment->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_PreTreatment" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Hysteroscopy->Visible) { // Hysteroscopy ?>
	<div id="r_Hysteroscopy" class="form-group row">
		<label id="elh_ivf_et_chart_Hysteroscopy" for="x_Hysteroscopy" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Hysteroscopy" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Hysteroscopy->caption() ?><?php echo ($ivf_et_chart->Hysteroscopy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Hysteroscopy->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Hysteroscopy" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->EndometrialScratching->Visible) { // EndometrialScratching ?>
	<div id="r_EndometrialScratching" class="form-group row">
		<label id="elh_ivf_et_chart_EndometrialScratching" for="x_EndometrialScratching" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_EndometrialScratching" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->EndometrialScratching->caption() ?><?php echo ($ivf_et_chart->EndometrialScratching->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->EndometrialScratching->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_EndometrialScratching" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->TrialCannulation->Visible) { // TrialCannulation ?>
	<div id="r_TrialCannulation" class="form-group row">
		<label id="elh_ivf_et_chart_TrialCannulation" for="x_TrialCannulation" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_TrialCannulation" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->TrialCannulation->caption() ?><?php echo ($ivf_et_chart->TrialCannulation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->TrialCannulation->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_TrialCannulation" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->CYCLETYPE->Visible) { // CYCLETYPE ?>
	<div id="r_CYCLETYPE" class="form-group row">
		<label id="elh_ivf_et_chart_CYCLETYPE" for="x_CYCLETYPE" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_CYCLETYPE" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->CYCLETYPE->caption() ?><?php echo ($ivf_et_chart->CYCLETYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->CYCLETYPE->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_CYCLETYPE" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->HRTCYCLE->Visible) { // HRTCYCLE ?>
	<div id="r_HRTCYCLE" class="form-group row">
		<label id="elh_ivf_et_chart_HRTCYCLE" for="x_HRTCYCLE" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_HRTCYCLE" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->HRTCYCLE->caption() ?><?php echo ($ivf_et_chart->HRTCYCLE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->HRTCYCLE->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_HRTCYCLE" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->OralEstrogenDosage->Visible) { // OralEstrogenDosage ?>
	<div id="r_OralEstrogenDosage" class="form-group row">
		<label id="elh_ivf_et_chart_OralEstrogenDosage" for="x_OralEstrogenDosage" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_OralEstrogenDosage" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->OralEstrogenDosage->caption() ?><?php echo ($ivf_et_chart->OralEstrogenDosage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->OralEstrogenDosage->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_OralEstrogenDosage" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->VaginalEstrogen->Visible) { // VaginalEstrogen ?>
	<div id="r_VaginalEstrogen" class="form-group row">
		<label id="elh_ivf_et_chart_VaginalEstrogen" for="x_VaginalEstrogen" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_VaginalEstrogen" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->VaginalEstrogen->caption() ?><?php echo ($ivf_et_chart->VaginalEstrogen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->VaginalEstrogen->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_VaginalEstrogen" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->GCSF->Visible) { // GCSF ?>
	<div id="r_GCSF" class="form-group row">
		<label id="elh_ivf_et_chart_GCSF" for="x_GCSF" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_GCSF" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->GCSF->caption() ?><?php echo ($ivf_et_chart->GCSF->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->GCSF->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_GCSF" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->ActivatedPRP->Visible) { // ActivatedPRP ?>
	<div id="r_ActivatedPRP" class="form-group row">
		<label id="elh_ivf_et_chart_ActivatedPRP" for="x_ActivatedPRP" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_ActivatedPRP" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->ActivatedPRP->caption() ?><?php echo ($ivf_et_chart->ActivatedPRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->ActivatedPRP->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_ActivatedPRP" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->ERA->Visible) { // ERA ?>
	<div id="r_ERA" class="form-group row">
		<label id="elh_ivf_et_chart_ERA" for="x_ERA" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_ERA" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->ERA->caption() ?><?php echo ($ivf_et_chart->ERA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->ERA->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_ERA" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->UCLcm->Visible) { // UCLcm ?>
	<div id="r_UCLcm" class="form-group row">
		<label id="elh_ivf_et_chart_UCLcm" for="x_UCLcm" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_UCLcm" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->UCLcm->caption() ?><?php echo ($ivf_et_chart->UCLcm->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->UCLcm->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_UCLcm" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->DATEOFSTART->Visible) { // DATEOFSTART ?>
	<div id="r_DATEOFSTART" class="form-group row">
		<label id="elh_ivf_et_chart_DATEOFSTART" for="x_DATEOFSTART" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_DATEOFSTART" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->DATEOFSTART->caption() ?><?php echo ($ivf_et_chart->DATEOFSTART->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->DATEOFSTART->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_DATEOFSTART" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->DATEOFEMBRYOTRANSFER->Visible) { // DATEOFEMBRYOTRANSFER ?>
	<div id="r_DATEOFEMBRYOTRANSFER" class="form-group row">
		<label id="elh_ivf_et_chart_DATEOFEMBRYOTRANSFER" for="x_DATEOFEMBRYOTRANSFER" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_DATEOFEMBRYOTRANSFER" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->DATEOFEMBRYOTRANSFER->caption() ?><?php echo ($ivf_et_chart->DATEOFEMBRYOTRANSFER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->DATEOFEMBRYOTRANSFER->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_DATEOFEMBRYOTRANSFER" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->DAYOFEMBRYOTRANSFER->Visible) { // DAYOFEMBRYOTRANSFER ?>
	<div id="r_DAYOFEMBRYOTRANSFER" class="form-group row">
		<label id="elh_ivf_et_chart_DAYOFEMBRYOTRANSFER" for="x_DAYOFEMBRYOTRANSFER" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_DAYOFEMBRYOTRANSFER" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->DAYOFEMBRYOTRANSFER->caption() ?><?php echo ($ivf_et_chart->DAYOFEMBRYOTRANSFER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->DAYOFEMBRYOTRANSFER->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_DAYOFEMBRYOTRANSFER" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->NOOFEMBRYOSTHAWED->Visible) { // NOOFEMBRYOSTHAWED ?>
	<div id="r_NOOFEMBRYOSTHAWED" class="form-group row">
		<label id="elh_ivf_et_chart_NOOFEMBRYOSTHAWED" for="x_NOOFEMBRYOSTHAWED" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_NOOFEMBRYOSTHAWED" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->NOOFEMBRYOSTHAWED->caption() ?><?php echo ($ivf_et_chart->NOOFEMBRYOSTHAWED->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->NOOFEMBRYOSTHAWED->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_NOOFEMBRYOSTHAWED" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->NOOFEMBRYOSTRANSFERRED->Visible) { // NOOFEMBRYOSTRANSFERRED ?>
	<div id="r_NOOFEMBRYOSTRANSFERRED" class="form-group row">
		<label id="elh_ivf_et_chart_NOOFEMBRYOSTRANSFERRED" for="x_NOOFEMBRYOSTRANSFERRED" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_NOOFEMBRYOSTRANSFERRED" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->NOOFEMBRYOSTRANSFERRED->caption() ?><?php echo ($ivf_et_chart->NOOFEMBRYOSTRANSFERRED->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->NOOFEMBRYOSTRANSFERRED->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_NOOFEMBRYOSTRANSFERRED" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->DAYOFEMBRYOS->Visible) { // DAYOFEMBRYOS ?>
	<div id="r_DAYOFEMBRYOS" class="form-group row">
		<label id="elh_ivf_et_chart_DAYOFEMBRYOS" for="x_DAYOFEMBRYOS" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_DAYOFEMBRYOS" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->DAYOFEMBRYOS->caption() ?><?php echo ($ivf_et_chart->DAYOFEMBRYOS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->DAYOFEMBRYOS->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_DAYOFEMBRYOS" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->CRYOPRESERVEDEMBRYOS->Visible) { // CRYOPRESERVEDEMBRYOS ?>
	<div id="r_CRYOPRESERVEDEMBRYOS" class="form-group row">
		<label id="elh_ivf_et_chart_CRYOPRESERVEDEMBRYOS" for="x_CRYOPRESERVEDEMBRYOS" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_CRYOPRESERVEDEMBRYOS" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->CRYOPRESERVEDEMBRYOS->caption() ?><?php echo ($ivf_et_chart->CRYOPRESERVEDEMBRYOS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->CRYOPRESERVEDEMBRYOS->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_CRYOPRESERVEDEMBRYOS" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Code1->Visible) { // Code1 ?>
	<div id="r_Code1" class="form-group row">
		<label id="elh_ivf_et_chart_Code1" for="x_Code1" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Code1" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Code1->caption() ?><?php echo ($ivf_et_chart->Code1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Code1->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Code1" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Code2->Visible) { // Code2 ?>
	<div id="r_Code2" class="form-group row">
		<label id="elh_ivf_et_chart_Code2" for="x_Code2" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Code2" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Code2->caption() ?><?php echo ($ivf_et_chart->Code2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Code2->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Code2" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->CellStage1->Visible) { // CellStage1 ?>
	<div id="r_CellStage1" class="form-group row">
		<label id="elh_ivf_et_chart_CellStage1" for="x_CellStage1" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_CellStage1" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->CellStage1->caption() ?><?php echo ($ivf_et_chart->CellStage1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->CellStage1->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_CellStage1" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->CellStage2->Visible) { // CellStage2 ?>
	<div id="r_CellStage2" class="form-group row">
		<label id="elh_ivf_et_chart_CellStage2" for="x_CellStage2" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_CellStage2" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->CellStage2->caption() ?><?php echo ($ivf_et_chart->CellStage2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->CellStage2->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_CellStage2" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Grade1->Visible) { // Grade1 ?>
	<div id="r_Grade1" class="form-group row">
		<label id="elh_ivf_et_chart_Grade1" for="x_Grade1" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Grade1" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Grade1->caption() ?><?php echo ($ivf_et_chart->Grade1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Grade1->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Grade1" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->Grade2->Visible) { // Grade2 ?>
	<div id="r_Grade2" class="form-group row">
		<label id="elh_ivf_et_chart_Grade2" for="x_Grade2" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Grade2" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Grade2->caption() ?><?php echo ($ivf_et_chart->Grade2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Grade2->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Grade2" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->ProcedureRecord->Visible) { // ProcedureRecord ?>
	<div id="r_ProcedureRecord" class="form-group row">
		<label id="elh_ivf_et_chart_ProcedureRecord" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_ProcedureRecord" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->ProcedureRecord->caption() ?><?php echo ($ivf_et_chart->ProcedureRecord->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->ProcedureRecord->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_ProcedureRecord" class="ivf_et_chartedit" type="text/html">
...
<script type="text/html" class="ivf_et_chartedit_js">
ew.createEditor("fivf_et_chartedit", "x_ProcedureRecord", 35, 4, <?php echo ($ivf_et_chart->ProcedureRecord->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_et_chart->Medicationsadvised->Visible) { // Medicationsadvised ?>
	<div id="r_Medicationsadvised" class="form-group row">
		<label id="elh_ivf_et_chart_Medicationsadvised" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_Medicationsadvised" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->Medicationsadvised->caption() ?><?php echo ($ivf_et_chart->Medicationsadvised->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->Medicationsadvised->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_Medicationsadvised" class="ivf_et_chartedit" type="text/html">
...
<script type="text/html" class="ivf_et_chartedit_js">
ew.createEditor("fivf_et_chartedit", "x_Medicationsadvised", 35, 4, <?php echo ($ivf_et_chart->Medicationsadvised->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_et_chart->PostProcedureInstructions->Visible) { // PostProcedureInstructions ?>
	<div id="r_PostProcedureInstructions" class="form-group row">
		<label id="elh_ivf_et_chart_PostProcedureInstructions" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_PostProcedureInstructions" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->PostProcedureInstructions->caption() ?><?php echo ($ivf_et_chart->PostProcedureInstructions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->PostProcedureInstructions->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_PostProcedureInstructions" class="ivf_et_chartedit" type="text/html">
...
<script type="text/html" class="ivf_et_chartedit_js">
ew.createEditor("fivf_et_chartedit", "x_PostProcedureInstructions", 35, 4, <?php echo ($ivf_et_chart->PostProcedureInstructions->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_et_chart->PregnancyTestingWithSerumBetaHcG->Visible) { // PregnancyTestingWithSerumBetaHcG ?>
	<div id="r_PregnancyTestingWithSerumBetaHcG" class="form-group row">
		<label id="elh_ivf_et_chart_PregnancyTestingWithSerumBetaHcG" for="x_PregnancyTestingWithSerumBetaHcG" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_PregnancyTestingWithSerumBetaHcG" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->PregnancyTestingWithSerumBetaHcG->caption() ?><?php echo ($ivf_et_chart->PregnancyTestingWithSerumBetaHcG->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->PregnancyTestingWithSerumBetaHcG->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_PregnancyTestingWithSerumBetaHcG" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->ReviewDate->Visible) { // ReviewDate ?>
	<div id="r_ReviewDate" class="form-group row">
		<label id="elh_ivf_et_chart_ReviewDate" for="x_ReviewDate" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_ReviewDate" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->ReviewDate->caption() ?><?php echo ($ivf_et_chart->ReviewDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->ReviewDate->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_ReviewDate" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->ReviewDoctor->Visible) { // ReviewDoctor ?>
	<div id="r_ReviewDoctor" class="form-group row">
		<label id="elh_ivf_et_chart_ReviewDoctor" for="x_ReviewDoctor" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_ReviewDoctor" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->ReviewDoctor->caption() ?><?php echo ($ivf_et_chart->ReviewDoctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->ReviewDoctor->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_ReviewDoctor" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->TemplateProcedureRecord->Visible) { // TemplateProcedureRecord ?>
	<div id="r_TemplateProcedureRecord" class="form-group row">
		<label id="elh_ivf_et_chart_TemplateProcedureRecord" for="x_TemplateProcedureRecord" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_TemplateProcedureRecord" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->TemplateProcedureRecord->caption() ?><?php echo ($ivf_et_chart->TemplateProcedureRecord->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->TemplateProcedureRecord->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_TemplateProcedureRecord" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->TemplateMedicationsadvised->Visible) { // TemplateMedicationsadvised ?>
	<div id="r_TemplateMedicationsadvised" class="form-group row">
		<label id="elh_ivf_et_chart_TemplateMedicationsadvised" for="x_TemplateMedicationsadvised" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_TemplateMedicationsadvised" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->TemplateMedicationsadvised->caption() ?><?php echo ($ivf_et_chart->TemplateMedicationsadvised->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->TemplateMedicationsadvised->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_TemplateMedicationsadvised" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->TemplatePostProcedureInstructions->Visible) { // TemplatePostProcedureInstructions ?>
	<div id="r_TemplatePostProcedureInstructions" class="form-group row">
		<label id="elh_ivf_et_chart_TemplatePostProcedureInstructions" for="x_TemplatePostProcedureInstructions" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_TemplatePostProcedureInstructions" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->TemplatePostProcedureInstructions->caption() ?><?php echo ($ivf_et_chart->TemplatePostProcedureInstructions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->TemplatePostProcedureInstructions->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_TemplatePostProcedureInstructions" class="ivf_et_chartedit" type="text/html">
...
<?php if ($ivf_et_chart->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_et_chart_TidNo" for="x_TidNo" class="<?php echo $ivf_et_chart_edit->LeftColumnClass ?>"><script id="tpc_ivf_et_chart_TidNo" class="ivf_et_chartedit" type="text/html"><span><?php echo $ivf_et_chart->TidNo->caption() ?><?php echo ($ivf_et_chart->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_et_chart_edit->RightColumnClass ?>"><div<?php echo $ivf_et_chart->TidNo->cellAttributes() ?>>
<script id="tpx_ivf_et_chart_TidNo" class="ivf_et_chartedit" type="text/html">
...
ew.applyTemplate("tpd_ivf_et_chartedit", "tpm_ivf_et_chartedit", "ivf_et_chartedit", "<?php echo $ivf_et_chart->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_et_chartedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
