...
<?php if ($view_pharmacy_purchase_request_purchased->id->Visible) { // id ?>
		<tr id="r_id">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_id" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->id->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->id->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_id" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->DT->Visible) { // DT ?>
		<tr id="r_DT">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_DT" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->DT->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->DT->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_DT" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->EmployeeName->Visible) { // EmployeeName ?>
		<tr id="r_EmployeeName">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_EmployeeName" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->EmployeeName->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->EmployeeName->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_EmployeeName" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->Department->Visible) { // Department ?>
		<tr id="r_Department">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_Department" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->Department->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->Department->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_Department" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->ApprovedStatus->Visible) { // ApprovedStatus ?>
		<tr id="r_ApprovedStatus">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_ApprovedStatus" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->ApprovedStatus->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->ApprovedStatus->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_ApprovedStatus" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->PurchaseStatus->Visible) { // PurchaseStatus ?>
		<tr id="r_PurchaseStatus">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_PurchaseStatus" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->PurchaseStatus->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->PurchaseStatus->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_PurchaseStatus" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->HospID->Visible) { // HospID ?>
		<tr id="r_HospID">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_HospID" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->HospID->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->HospID->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_HospID" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->createdby->Visible) { // createdby ?>
		<tr id="r_createdby">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_createdby" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->createdby->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->createdby->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_createdby" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->createddatetime->Visible) { // createddatetime ?>
		<tr id="r_createddatetime">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_createddatetime" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->createddatetime->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->createddatetime->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_createddatetime" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->modifiedby->Visible) { // modifiedby ?>
		<tr id="r_modifiedby">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_modifiedby" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->modifiedby->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->modifiedby->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_modifiedby" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->modifieddatetime->Visible) { // modifieddatetime ?>
		<tr id="r_modifieddatetime">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_modifieddatetime" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->modifieddatetime->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->modifieddatetime->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_modifieddatetime" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
<?php if ($view_pharmacy_purchase_request_purchased->BRCODE->Visible) { // BRCODE ?>
		<tr id="r_BRCODE">
			<td class="<?php echo $view_pharmacy_purchase_request_purchased->TableLeftColumnClass ?>"><script id="tpc_view_pharmacy_purchase_request_purchased_BRCODE" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html"><span><?php echo $view_pharmacy_purchase_request_purchased->BRCODE->caption() ?></span></script></td>
			<td<?php echo $view_pharmacy_purchase_request_purchased->BRCODE->cellAttributes() ?>>
<script id="tpx_view_pharmacy_purchase_request_purchased_BRCODE" class="view_pharmacy_purchase_request_purchasedmaster" type="text/html">
...
ew.applyTemplate("tpd_view_pharmacy_purchase_request_purchasedmaster", "tpm_view_pharmacy_purchase_request_purchasedmaster", "view_pharmacy_purchase_request_purchasedmaster", "<?php echo $view_pharmacy_purchase_request_purchased->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_pharmacy_purchase_request_purchasedmaster_js").each(function(){ew.addScript(this.text);});
</script>
<?php } ?>