...
var fivf_vitrificationadd = currentForm = new ew.Form("fivf_vitrificationadd", "add");
...
fivf_vitrificationadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_vitrificationadd.lists["x_Day"] = <?php echo $ivf_vitrification_add->Day->Lookup->toClientList() ?>;
fivf_vitrificationadd.lists["x_Day"].options = <?php echo JsonEncode($ivf_vitrification_add->Day->options(FALSE, TRUE)) ?>;
fivf_vitrificationadd.lists["x_Grade"] = <?php echo $ivf_vitrification_add->Grade->Lookup->toClientList() ?>;
...
<?php if ($ivf_vitrification_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_vitrification_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_vitrification->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_vitrification_RIDNo" for="x_RIDNo" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->RIDNo->caption() ?><?php echo ($ivf_vitrification->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->RIDNo->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_ivf_vitrification_PatientName" for="x_PatientName" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->PatientName->caption() ?><?php echo ($ivf_vitrification->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->PatientName->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->TiDNo->Visible) { // TiDNo ?>
	<div id="r_TiDNo" class="form-group row">
		<label id="elh_ivf_vitrification_TiDNo" for="x_TiDNo" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->TiDNo->caption() ?><?php echo ($ivf_vitrification->TiDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->TiDNo->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->vitrificationDate->Visible) { // vitrificationDate ?>
	<div id="r_vitrificationDate" class="form-group row">
		<label id="elh_ivf_vitrification_vitrificationDate" for="x_vitrificationDate" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->vitrificationDate->caption() ?><?php echo ($ivf_vitrification->vitrificationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->vitrificationDate->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->PrimaryEmbryologist->Visible) { // PrimaryEmbryologist ?>
	<div id="r_PrimaryEmbryologist" class="form-group row">
		<label id="elh_ivf_vitrification_PrimaryEmbryologist" for="x_PrimaryEmbryologist" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->PrimaryEmbryologist->caption() ?><?php echo ($ivf_vitrification->PrimaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->PrimaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->SecondaryEmbryologist->Visible) { // SecondaryEmbryologist ?>
	<div id="r_SecondaryEmbryologist" class="form-group row">
		<label id="elh_ivf_vitrification_SecondaryEmbryologist" for="x_SecondaryEmbryologist" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->SecondaryEmbryologist->caption() ?><?php echo ($ivf_vitrification->SecondaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->SecondaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->EmbryoNo->Visible) { // EmbryoNo ?>
	<div id="r_EmbryoNo" class="form-group row">
		<label id="elh_ivf_vitrification_EmbryoNo" for="x_EmbryoNo" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->EmbryoNo->caption() ?><?php echo ($ivf_vitrification->EmbryoNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->EmbryoNo->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->FertilisationDate->Visible) { // FertilisationDate ?>
	<div id="r_FertilisationDate" class="form-group row">
		<label id="elh_ivf_vitrification_FertilisationDate" for="x_FertilisationDate" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->FertilisationDate->caption() ?><?php echo ($ivf_vitrification->FertilisationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->FertilisationDate->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Day->Visible) { // Day ?>
	<div id="r_Day" class="form-group row">
		<label id="elh_ivf_vitrification_Day" for="x_Day" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Day->caption() ?><?php echo ($ivf_vitrification->Day->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Day->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Grade->Visible) { // Grade ?>
	<div id="r_Grade" class="form-group row">
		<label id="elh_ivf_vitrification_Grade" for="x_Grade" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Grade->caption() ?><?php echo ($ivf_vitrification->Grade->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Grade->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Incubator->Visible) { // Incubator ?>
	<div id="r_Incubator" class="form-group row">
		<label id="elh_ivf_vitrification_Incubator" for="x_Incubator" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Incubator->caption() ?><?php echo ($ivf_vitrification->Incubator->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Incubator->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Tank->Visible) { // Tank ?>
	<div id="r_Tank" class="form-group row">
		<label id="elh_ivf_vitrification_Tank" for="x_Tank" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Tank->caption() ?><?php echo ($ivf_vitrification->Tank->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Tank->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Canister->Visible) { // Canister ?>
	<div id="r_Canister" class="form-group row">
		<label id="elh_ivf_vitrification_Canister" for="x_Canister" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Canister->caption() ?><?php echo ($ivf_vitrification->Canister->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Canister->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Gobiet->Visible) { // Gobiet ?>
	<div id="r_Gobiet" class="form-group row">
		<label id="elh_ivf_vitrification_Gobiet" for="x_Gobiet" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Gobiet->caption() ?><?php echo ($ivf_vitrification->Gobiet->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Gobiet->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->CryolockNo->Visible) { // CryolockNo ?>
	<div id="r_CryolockNo" class="form-group row">
		<label id="elh_ivf_vitrification_CryolockNo" for="x_CryolockNo" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->CryolockNo->caption() ?><?php echo ($ivf_vitrification->CryolockNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->CryolockNo->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->CryolockColour->Visible) { // CryolockColour ?>
	<div id="r_CryolockColour" class="form-group row">
		<label id="elh_ivf_vitrification_CryolockColour" for="x_CryolockColour" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->CryolockColour->caption() ?><?php echo ($ivf_vitrification->CryolockColour->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->CryolockColour->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Stage->Visible) { // Stage ?>
	<div id="r_Stage" class="form-group row">
		<label id="elh_ivf_vitrification_Stage" for="x_Stage" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Stage->caption() ?><?php echo ($ivf_vitrification->Stage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Stage->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawDate->Visible) { // thawDate ?>
	<div id="r_thawDate" class="form-group row">
		<label id="elh_ivf_vitrification_thawDate" for="x_thawDate" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawDate->caption() ?><?php echo ($ivf_vitrification->thawDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawDate->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawPrimaryEmbryologist->Visible) { // thawPrimaryEmbryologist ?>
	<div id="r_thawPrimaryEmbryologist" class="form-group row">
		<label id="elh_ivf_vitrification_thawPrimaryEmbryologist" for="x_thawPrimaryEmbryologist" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawPrimaryEmbryologist->caption() ?><?php echo ($ivf_vitrification->thawPrimaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawPrimaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawSecondaryEmbryologist->Visible) { // thawSecondaryEmbryologist ?>
	<div id="r_thawSecondaryEmbryologist" class="form-group row">
		<label id="elh_ivf_vitrification_thawSecondaryEmbryologist" for="x_thawSecondaryEmbryologist" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawSecondaryEmbryologist->caption() ?><?php echo ($ivf_vitrification->thawSecondaryEmbryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawSecondaryEmbryologist->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawET->Visible) { // thawET ?>
	<div id="r_thawET" class="form-group row">
		<label id="elh_ivf_vitrification_thawET" for="x_thawET" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawET->caption() ?><?php echo ($ivf_vitrification->thawET->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawET->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawReFrozen->Visible) { // thawReFrozen ?>
	<div id="r_thawReFrozen" class="form-group row">
		<label id="elh_ivf_vitrification_thawReFrozen" for="x_thawReFrozen" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawReFrozen->caption() ?><?php echo ($ivf_vitrification->thawReFrozen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawReFrozen->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawAbserve->Visible) { // thawAbserve ?>
	<div id="r_thawAbserve" class="form-group row">
		<label id="elh_ivf_vitrification_thawAbserve" for="x_thawAbserve" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawAbserve->caption() ?><?php echo ($ivf_vitrification->thawAbserve->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawAbserve->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->thawDiscard->Visible) { // thawDiscard ?>
	<div id="r_thawDiscard" class="form-group row">
		<label id="elh_ivf_vitrification_thawDiscard" for="x_thawDiscard" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->thawDiscard->caption() ?><?php echo ($ivf_vitrification->thawDiscard->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->thawDiscard->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Catheter->Visible) { // Catheter ?>
	<div id="r_Catheter" class="form-group row">
		<label id="elh_ivf_vitrification_Catheter" for="x_Catheter" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Catheter->caption() ?><?php echo ($ivf_vitrification->Catheter->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Catheter->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Difficulty->Visible) { // Difficulty ?>
	<div id="r_Difficulty" class="form-group row">
		<label id="elh_ivf_vitrification_Difficulty" for="x_Difficulty" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Difficulty->caption() ?><?php echo ($ivf_vitrification->Difficulty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Difficulty->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Easy->Visible) { // Easy ?>
	<div id="r_Easy" class="form-group row">
		<label id="elh_ivf_vitrification_Easy" for="x_Easy" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Easy->caption() ?><?php echo ($ivf_vitrification->Easy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Easy->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Comments->Visible) { // Comments ?>
	<div id="r_Comments" class="form-group row">
		<label id="elh_ivf_vitrification_Comments" for="x_Comments" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Comments->caption() ?><?php echo ($ivf_vitrification->Comments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Comments->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_ivf_vitrification_Doctor" for="x_Doctor" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Doctor->caption() ?><?php echo ($ivf_vitrification->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Doctor->cellAttributes() ?>>
...
<?php if ($ivf_vitrification->Embryologist->Visible) { // Embryologist ?>
	<div id="r_Embryologist" class="form-group row">
		<label id="elh_ivf_vitrification_Embryologist" for="x_Embryologist" class="<?php echo $ivf_vitrification_add->LeftColumnClass ?>"><?php echo $ivf_vitrification->Embryologist->caption() ?><?php echo ($ivf_vitrification->Embryologist->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_vitrification_add->RightColumnClass ?>"><div<?php echo $ivf_vitrification->Embryologist->cellAttributes() ?>>
