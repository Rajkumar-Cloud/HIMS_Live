...
var fpharmacy_productsedit = currentForm = new ew.Form("fpharmacy_productsedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pharmacy_products_edit->ProductCode->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $pharmacy_products->ProductCode->caption(), $pharmacy_products->ProductCode->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fpharmacy_productsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pharmacy_products_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pharmacy_products_edit->Token ?>">
<?php } ?>
...
<?php if ($pharmacy_products->ProductCode->Visible) { // ProductCode ?>
	<div id="r_ProductCode" class="form-group row">
		<label id="elh_pharmacy_products_ProductCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductCode->caption() ?><?php echo ($pharmacy_products->ProductCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductCode->cellAttributes() ?>>
<span id="el_pharmacy_products_ProductCode">
<span<?php echo $pharmacy_products->ProductCode->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($pharmacy_products->ProductCode->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="pharmacy_products" data-field="x_ProductCode" name="x_ProductCode" id="x_ProductCode" value="<?php echo HtmlEncode($pharmacy_products->ProductCode->CurrentValue) ?>">
<?php echo $pharmacy_products->ProductCode->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pharmacy_products->ProductName->Visible) { // ProductName ?>
	<div id="r_ProductName" class="form-group row">
		<label id="elh_pharmacy_products_ProductName" for="x_ProductName" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductName->caption() ?><?php echo ($pharmacy_products->ProductName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductName->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DivisionCode->Visible) { // DivisionCode ?>
	<div id="r_DivisionCode" class="form-group row">
		<label id="elh_pharmacy_products_DivisionCode" for="x_DivisionCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DivisionCode->caption() ?><?php echo ($pharmacy_products->DivisionCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DivisionCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ManufacturerCode->Visible) { // ManufacturerCode ?>
	<div id="r_ManufacturerCode" class="form-group row">
		<label id="elh_pharmacy_products_ManufacturerCode" for="x_ManufacturerCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ManufacturerCode->caption() ?><?php echo ($pharmacy_products->ManufacturerCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ManufacturerCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SupplierCode->Visible) { // SupplierCode ?>
	<div id="r_SupplierCode" class="form-group row">
		<label id="elh_pharmacy_products_SupplierCode" for="x_SupplierCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SupplierCode->caption() ?><?php echo ($pharmacy_products->SupplierCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SupplierCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AlternateSupplierCodes->Visible) { // AlternateSupplierCodes ?>
	<div id="r_AlternateSupplierCodes" class="form-group row">
		<label id="elh_pharmacy_products_AlternateSupplierCodes" for="x_AlternateSupplierCodes" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AlternateSupplierCodes->caption() ?><?php echo ($pharmacy_products->AlternateSupplierCodes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AlternateSupplierCodes->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AlternateProductCode->Visible) { // AlternateProductCode ?>
	<div id="r_AlternateProductCode" class="form-group row">
		<label id="elh_pharmacy_products_AlternateProductCode" for="x_AlternateProductCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AlternateProductCode->caption() ?><?php echo ($pharmacy_products->AlternateProductCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AlternateProductCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->UniversalProductCode->Visible) { // UniversalProductCode ?>
	<div id="r_UniversalProductCode" class="form-group row">
		<label id="elh_pharmacy_products_UniversalProductCode" for="x_UniversalProductCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->UniversalProductCode->caption() ?><?php echo ($pharmacy_products->UniversalProductCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->UniversalProductCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BookProductCode->Visible) { // BookProductCode ?>
	<div id="r_BookProductCode" class="form-group row">
		<label id="elh_pharmacy_products_BookProductCode" for="x_BookProductCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BookProductCode->caption() ?><?php echo ($pharmacy_products->BookProductCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BookProductCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OldCode->Visible) { // OldCode ?>
	<div id="r_OldCode" class="form-group row">
		<label id="elh_pharmacy_products_OldCode" for="x_OldCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OldCode->caption() ?><?php echo ($pharmacy_products->OldCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OldCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProtectedProducts->Visible) { // ProtectedProducts ?>
	<div id="r_ProtectedProducts" class="form-group row">
		<label id="elh_pharmacy_products_ProtectedProducts" for="x_ProtectedProducts" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProtectedProducts->caption() ?><?php echo ($pharmacy_products->ProtectedProducts->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProtectedProducts->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductFullName->Visible) { // ProductFullName ?>
	<div id="r_ProductFullName" class="form-group row">
		<label id="elh_pharmacy_products_ProductFullName" for="x_ProductFullName" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductFullName->caption() ?><?php echo ($pharmacy_products->ProductFullName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductFullName->cellAttributes() ?>>
...
<?php if ($pharmacy_products->UnitOfMeasure->Visible) { // UnitOfMeasure ?>
	<div id="r_UnitOfMeasure" class="form-group row">
		<label id="elh_pharmacy_products_UnitOfMeasure" for="x_UnitOfMeasure" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->UnitOfMeasure->caption() ?><?php echo ($pharmacy_products->UnitOfMeasure->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->UnitOfMeasure->cellAttributes() ?>>
...
<?php if ($pharmacy_products->UnitDescription->Visible) { // UnitDescription ?>
	<div id="r_UnitDescription" class="form-group row">
		<label id="elh_pharmacy_products_UnitDescription" for="x_UnitDescription" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->UnitDescription->caption() ?><?php echo ($pharmacy_products->UnitDescription->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->UnitDescription->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BulkDescription->Visible) { // BulkDescription ?>
	<div id="r_BulkDescription" class="form-group row">
		<label id="elh_pharmacy_products_BulkDescription" for="x_BulkDescription" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BulkDescription->caption() ?><?php echo ($pharmacy_products->BulkDescription->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BulkDescription->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BarCodeDescription->Visible) { // BarCodeDescription ?>
	<div id="r_BarCodeDescription" class="form-group row">
		<label id="elh_pharmacy_products_BarCodeDescription" for="x_BarCodeDescription" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BarCodeDescription->caption() ?><?php echo ($pharmacy_products->BarCodeDescription->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BarCodeDescription->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PackageInformation->Visible) { // PackageInformation ?>
	<div id="r_PackageInformation" class="form-group row">
		<label id="elh_pharmacy_products_PackageInformation" for="x_PackageInformation" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PackageInformation->caption() ?><?php echo ($pharmacy_products->PackageInformation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PackageInformation->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PackageId->Visible) { // PackageId ?>
	<div id="r_PackageId" class="form-group row">
		<label id="elh_pharmacy_products_PackageId" for="x_PackageId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PackageId->caption() ?><?php echo ($pharmacy_products->PackageId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PackageId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Weight->Visible) { // Weight ?>
	<div id="r_Weight" class="form-group row">
		<label id="elh_pharmacy_products_Weight" for="x_Weight" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Weight->caption() ?><?php echo ($pharmacy_products->Weight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Weight->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllowFractions->Visible) { // AllowFractions ?>
	<div id="r_AllowFractions" class="form-group row">
		<label id="elh_pharmacy_products_AllowFractions" for="x_AllowFractions" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllowFractions->caption() ?><?php echo ($pharmacy_products->AllowFractions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllowFractions->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MinimumStockLevel->Visible) { // MinimumStockLevel ?>
	<div id="r_MinimumStockLevel" class="form-group row">
		<label id="elh_pharmacy_products_MinimumStockLevel" for="x_MinimumStockLevel" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MinimumStockLevel->caption() ?><?php echo ($pharmacy_products->MinimumStockLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MinimumStockLevel->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MaximumStockLevel->Visible) { // MaximumStockLevel ?>
	<div id="r_MaximumStockLevel" class="form-group row">
		<label id="elh_pharmacy_products_MaximumStockLevel" for="x_MaximumStockLevel" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MaximumStockLevel->caption() ?><?php echo ($pharmacy_products->MaximumStockLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MaximumStockLevel->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ReorderLevel->Visible) { // ReorderLevel ?>
	<div id="r_ReorderLevel" class="form-group row">
		<label id="elh_pharmacy_products_ReorderLevel" for="x_ReorderLevel" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ReorderLevel->caption() ?><?php echo ($pharmacy_products->ReorderLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ReorderLevel->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MinMaxRatio->Visible) { // MinMaxRatio ?>
	<div id="r_MinMaxRatio" class="form-group row">
		<label id="elh_pharmacy_products_MinMaxRatio" for="x_MinMaxRatio" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MinMaxRatio->caption() ?><?php echo ($pharmacy_products->MinMaxRatio->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MinMaxRatio->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AutoMinMaxRatio->Visible) { // AutoMinMaxRatio ?>
	<div id="r_AutoMinMaxRatio" class="form-group row">
		<label id="elh_pharmacy_products_AutoMinMaxRatio" for="x_AutoMinMaxRatio" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AutoMinMaxRatio->caption() ?><?php echo ($pharmacy_products->AutoMinMaxRatio->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AutoMinMaxRatio->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ScheduleCode->Visible) { // ScheduleCode ?>
	<div id="r_ScheduleCode" class="form-group row">
		<label id="elh_pharmacy_products_ScheduleCode" for="x_ScheduleCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ScheduleCode->caption() ?><?php echo ($pharmacy_products->ScheduleCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ScheduleCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->RopRatio->Visible) { // RopRatio ?>
	<div id="r_RopRatio" class="form-group row">
		<label id="elh_pharmacy_products_RopRatio" for="x_RopRatio" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->RopRatio->caption() ?><?php echo ($pharmacy_products->RopRatio->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->RopRatio->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_pharmacy_products_MRP" for="x_MRP" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MRP->caption() ?><?php echo ($pharmacy_products->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MRP->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PurchasePrice->Visible) { // PurchasePrice ?>
	<div id="r_PurchasePrice" class="form-group row">
		<label id="elh_pharmacy_products_PurchasePrice" for="x_PurchasePrice" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PurchasePrice->caption() ?><?php echo ($pharmacy_products->PurchasePrice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PurchasePrice->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PurchaseUnit->Visible) { // PurchaseUnit ?>
	<div id="r_PurchaseUnit" class="form-group row">
		<label id="elh_pharmacy_products_PurchaseUnit" for="x_PurchaseUnit" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PurchaseUnit->caption() ?><?php echo ($pharmacy_products->PurchaseUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PurchaseUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PurchaseTaxCode->Visible) { // PurchaseTaxCode ?>
	<div id="r_PurchaseTaxCode" class="form-group row">
		<label id="elh_pharmacy_products_PurchaseTaxCode" for="x_PurchaseTaxCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PurchaseTaxCode->caption() ?><?php echo ($pharmacy_products->PurchaseTaxCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PurchaseTaxCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllowDirectInward->Visible) { // AllowDirectInward ?>
	<div id="r_AllowDirectInward" class="form-group row">
		<label id="elh_pharmacy_products_AllowDirectInward" for="x_AllowDirectInward" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllowDirectInward->caption() ?><?php echo ($pharmacy_products->AllowDirectInward->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllowDirectInward->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SalePrice->Visible) { // SalePrice ?>
	<div id="r_SalePrice" class="form-group row">
		<label id="elh_pharmacy_products_SalePrice" for="x_SalePrice" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SalePrice->caption() ?><?php echo ($pharmacy_products->SalePrice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SalePrice->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SaleUnit->Visible) { // SaleUnit ?>
	<div id="r_SaleUnit" class="form-group row">
		<label id="elh_pharmacy_products_SaleUnit" for="x_SaleUnit" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SaleUnit->caption() ?><?php echo ($pharmacy_products->SaleUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SaleUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SalesTaxCode->Visible) { // SalesTaxCode ?>
	<div id="r_SalesTaxCode" class="form-group row">
		<label id="elh_pharmacy_products_SalesTaxCode" for="x_SalesTaxCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SalesTaxCode->caption() ?><?php echo ($pharmacy_products->SalesTaxCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SalesTaxCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StockReceived->Visible) { // StockReceived ?>
	<div id="r_StockReceived" class="form-group row">
		<label id="elh_pharmacy_products_StockReceived" for="x_StockReceived" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StockReceived->caption() ?><?php echo ($pharmacy_products->StockReceived->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StockReceived->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TotalStock->Visible) { // TotalStock ?>
	<div id="r_TotalStock" class="form-group row">
		<label id="elh_pharmacy_products_TotalStock" for="x_TotalStock" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TotalStock->caption() ?><?php echo ($pharmacy_products->TotalStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TotalStock->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StockType->Visible) { // StockType ?>
	<div id="r_StockType" class="form-group row">
		<label id="elh_pharmacy_products_StockType" for="x_StockType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StockType->caption() ?><?php echo ($pharmacy_products->StockType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StockType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StockCheckDate->Visible) { // StockCheckDate ?>
	<div id="r_StockCheckDate" class="form-group row">
		<label id="elh_pharmacy_products_StockCheckDate" for="x_StockCheckDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StockCheckDate->caption() ?><?php echo ($pharmacy_products->StockCheckDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StockCheckDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StockAdjustmentDate->Visible) { // StockAdjustmentDate ?>
	<div id="r_StockAdjustmentDate" class="form-group row">
		<label id="elh_pharmacy_products_StockAdjustmentDate" for="x_StockAdjustmentDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StockAdjustmentDate->caption() ?><?php echo ($pharmacy_products->StockAdjustmentDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StockAdjustmentDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_pharmacy_products_Remarks" for="x_Remarks" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Remarks->caption() ?><?php echo ($pharmacy_products->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Remarks->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CostCentre->Visible) { // CostCentre ?>
	<div id="r_CostCentre" class="form-group row">
		<label id="elh_pharmacy_products_CostCentre" for="x_CostCentre" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CostCentre->caption() ?><?php echo ($pharmacy_products->CostCentre->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CostCentre->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductType->Visible) { // ProductType ?>
	<div id="r_ProductType" class="form-group row">
		<label id="elh_pharmacy_products_ProductType" for="x_ProductType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductType->caption() ?><?php echo ($pharmacy_products->ProductType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TaxAmount->Visible) { // TaxAmount ?>
	<div id="r_TaxAmount" class="form-group row">
		<label id="elh_pharmacy_products_TaxAmount" for="x_TaxAmount" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TaxAmount->caption() ?><?php echo ($pharmacy_products->TaxAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TaxAmount->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TaxId->Visible) { // TaxId ?>
	<div id="r_TaxId" class="form-group row">
		<label id="elh_pharmacy_products_TaxId" for="x_TaxId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TaxId->caption() ?><?php echo ($pharmacy_products->TaxId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TaxId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ResaleTaxApplicable->Visible) { // ResaleTaxApplicable ?>
	<div id="r_ResaleTaxApplicable" class="form-group row">
		<label id="elh_pharmacy_products_ResaleTaxApplicable" for="x_ResaleTaxApplicable" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ResaleTaxApplicable->caption() ?><?php echo ($pharmacy_products->ResaleTaxApplicable->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ResaleTaxApplicable->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CstOtherTax->Visible) { // CstOtherTax ?>
	<div id="r_CstOtherTax" class="form-group row">
		<label id="elh_pharmacy_products_CstOtherTax" for="x_CstOtherTax" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CstOtherTax->caption() ?><?php echo ($pharmacy_products->CstOtherTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CstOtherTax->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TotalTax->Visible) { // TotalTax ?>
	<div id="r_TotalTax" class="form-group row">
		<label id="elh_pharmacy_products_TotalTax" for="x_TotalTax" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TotalTax->caption() ?><?php echo ($pharmacy_products->TotalTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TotalTax->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ItemCost->Visible) { // ItemCost ?>
	<div id="r_ItemCost" class="form-group row">
		<label id="elh_pharmacy_products_ItemCost" for="x_ItemCost" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ItemCost->caption() ?><?php echo ($pharmacy_products->ItemCost->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ItemCost->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ExpiryDate->Visible) { // ExpiryDate ?>
	<div id="r_ExpiryDate" class="form-group row">
		<label id="elh_pharmacy_products_ExpiryDate" for="x_ExpiryDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ExpiryDate->caption() ?><?php echo ($pharmacy_products->ExpiryDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ExpiryDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BatchDescription->Visible) { // BatchDescription ?>
	<div id="r_BatchDescription" class="form-group row">
		<label id="elh_pharmacy_products_BatchDescription" for="x_BatchDescription" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BatchDescription->caption() ?><?php echo ($pharmacy_products->BatchDescription->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BatchDescription->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FreeScheme->Visible) { // FreeScheme ?>
	<div id="r_FreeScheme" class="form-group row">
		<label id="elh_pharmacy_products_FreeScheme" for="x_FreeScheme" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FreeScheme->caption() ?><?php echo ($pharmacy_products->FreeScheme->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FreeScheme->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CashDiscountEligibility->Visible) { // CashDiscountEligibility ?>
	<div id="r_CashDiscountEligibility" class="form-group row">
		<label id="elh_pharmacy_products_CashDiscountEligibility" for="x_CashDiscountEligibility" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CashDiscountEligibility->caption() ?><?php echo ($pharmacy_products->CashDiscountEligibility->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CashDiscountEligibility->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DiscountPerAllowInBill->Visible) { // DiscountPerAllowInBill ?>
	<div id="r_DiscountPerAllowInBill" class="form-group row">
		<label id="elh_pharmacy_products_DiscountPerAllowInBill" for="x_DiscountPerAllowInBill" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DiscountPerAllowInBill->caption() ?><?php echo ($pharmacy_products->DiscountPerAllowInBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DiscountPerAllowInBill->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_pharmacy_products_Discount" for="x_Discount" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Discount->caption() ?><?php echo ($pharmacy_products->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Discount->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TotalAmount->Visible) { // TotalAmount ?>
	<div id="r_TotalAmount" class="form-group row">
		<label id="elh_pharmacy_products_TotalAmount" for="x_TotalAmount" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TotalAmount->caption() ?><?php echo ($pharmacy_products->TotalAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TotalAmount->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StandardMargin->Visible) { // StandardMargin ?>
	<div id="r_StandardMargin" class="form-group row">
		<label id="elh_pharmacy_products_StandardMargin" for="x_StandardMargin" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StandardMargin->caption() ?><?php echo ($pharmacy_products->StandardMargin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StandardMargin->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Margin->Visible) { // Margin ?>
	<div id="r_Margin" class="form-group row">
		<label id="elh_pharmacy_products_Margin" for="x_Margin" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Margin->caption() ?><?php echo ($pharmacy_products->Margin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Margin->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarginId->Visible) { // MarginId ?>
	<div id="r_MarginId" class="form-group row">
		<label id="elh_pharmacy_products_MarginId" for="x_MarginId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarginId->caption() ?><?php echo ($pharmacy_products->MarginId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarginId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ExpectedMargin->Visible) { // ExpectedMargin ?>
	<div id="r_ExpectedMargin" class="form-group row">
		<label id="elh_pharmacy_products_ExpectedMargin" for="x_ExpectedMargin" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ExpectedMargin->caption() ?><?php echo ($pharmacy_products->ExpectedMargin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ExpectedMargin->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SurchargeBeforeTax->Visible) { // SurchargeBeforeTax ?>
	<div id="r_SurchargeBeforeTax" class="form-group row">
		<label id="elh_pharmacy_products_SurchargeBeforeTax" for="x_SurchargeBeforeTax" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SurchargeBeforeTax->caption() ?><?php echo ($pharmacy_products->SurchargeBeforeTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SurchargeBeforeTax->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SurchargeAfterTax->Visible) { // SurchargeAfterTax ?>
	<div id="r_SurchargeAfterTax" class="form-group row">
		<label id="elh_pharmacy_products_SurchargeAfterTax" for="x_SurchargeAfterTax" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SurchargeAfterTax->caption() ?><?php echo ($pharmacy_products->SurchargeAfterTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SurchargeAfterTax->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TempOrderNo->Visible) { // TempOrderNo ?>
	<div id="r_TempOrderNo" class="form-group row">
		<label id="elh_pharmacy_products_TempOrderNo" for="x_TempOrderNo" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TempOrderNo->caption() ?><?php echo ($pharmacy_products->TempOrderNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TempOrderNo->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TempOrderDate->Visible) { // TempOrderDate ?>
	<div id="r_TempOrderDate" class="form-group row">
		<label id="elh_pharmacy_products_TempOrderDate" for="x_TempOrderDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TempOrderDate->caption() ?><?php echo ($pharmacy_products->TempOrderDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TempOrderDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OrderUnit->Visible) { // OrderUnit ?>
	<div id="r_OrderUnit" class="form-group row">
		<label id="elh_pharmacy_products_OrderUnit" for="x_OrderUnit" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OrderUnit->caption() ?><?php echo ($pharmacy_products->OrderUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OrderUnit->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OrderQuantity->Visible) { // OrderQuantity ?>
	<div id="r_OrderQuantity" class="form-group row">
		<label id="elh_pharmacy_products_OrderQuantity" for="x_OrderQuantity" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OrderQuantity->caption() ?><?php echo ($pharmacy_products->OrderQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OrderQuantity->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarkForOrder->Visible) { // MarkForOrder ?>
	<div id="r_MarkForOrder" class="form-group row">
		<label id="elh_pharmacy_products_MarkForOrder" for="x_MarkForOrder" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarkForOrder->caption() ?><?php echo ($pharmacy_products->MarkForOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarkForOrder->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OrderAllId->Visible) { // OrderAllId ?>
	<div id="r_OrderAllId" class="form-group row">
		<label id="elh_pharmacy_products_OrderAllId" for="x_OrderAllId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OrderAllId->caption() ?><?php echo ($pharmacy_products->OrderAllId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OrderAllId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CalculateOrderQty->Visible) { // CalculateOrderQty ?>
	<div id="r_CalculateOrderQty" class="form-group row">
		<label id="elh_pharmacy_products_CalculateOrderQty" for="x_CalculateOrderQty" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CalculateOrderQty->caption() ?><?php echo ($pharmacy_products->CalculateOrderQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CalculateOrderQty->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SubLocation->Visible) { // SubLocation ?>
	<div id="r_SubLocation" class="form-group row">
		<label id="elh_pharmacy_products_SubLocation" for="x_SubLocation" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SubLocation->caption() ?><?php echo ($pharmacy_products->SubLocation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SubLocation->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CategoryCode->Visible) { // CategoryCode ?>
	<div id="r_CategoryCode" class="form-group row">
		<label id="elh_pharmacy_products_CategoryCode" for="x_CategoryCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CategoryCode->caption() ?><?php echo ($pharmacy_products->CategoryCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CategoryCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SubCategory->Visible) { // SubCategory ?>
	<div id="r_SubCategory" class="form-group row">
		<label id="elh_pharmacy_products_SubCategory" for="x_SubCategory" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SubCategory->caption() ?><?php echo ($pharmacy_products->SubCategory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SubCategory->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FlexCategoryCode->Visible) { // FlexCategoryCode ?>
	<div id="r_FlexCategoryCode" class="form-group row">
		<label id="elh_pharmacy_products_FlexCategoryCode" for="x_FlexCategoryCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FlexCategoryCode->caption() ?><?php echo ($pharmacy_products->FlexCategoryCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FlexCategoryCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ABCSaleQty->Visible) { // ABCSaleQty ?>
	<div id="r_ABCSaleQty" class="form-group row">
		<label id="elh_pharmacy_products_ABCSaleQty" for="x_ABCSaleQty" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ABCSaleQty->caption() ?><?php echo ($pharmacy_products->ABCSaleQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ABCSaleQty->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ABCSaleValue->Visible) { // ABCSaleValue ?>
	<div id="r_ABCSaleValue" class="form-group row">
		<label id="elh_pharmacy_products_ABCSaleValue" for="x_ABCSaleValue" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ABCSaleValue->caption() ?><?php echo ($pharmacy_products->ABCSaleValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ABCSaleValue->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ConvertionFactor->Visible) { // ConvertionFactor ?>
	<div id="r_ConvertionFactor" class="form-group row">
		<label id="elh_pharmacy_products_ConvertionFactor" for="x_ConvertionFactor" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ConvertionFactor->caption() ?><?php echo ($pharmacy_products->ConvertionFactor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ConvertionFactor->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ConvertionUnitDesc->Visible) { // ConvertionUnitDesc ?>
	<div id="r_ConvertionUnitDesc" class="form-group row">
		<label id="elh_pharmacy_products_ConvertionUnitDesc" for="x_ConvertionUnitDesc" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ConvertionUnitDesc->caption() ?><?php echo ($pharmacy_products->ConvertionUnitDesc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ConvertionUnitDesc->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TransactionId->Visible) { // TransactionId ?>
	<div id="r_TransactionId" class="form-group row">
		<label id="elh_pharmacy_products_TransactionId" for="x_TransactionId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TransactionId->caption() ?><?php echo ($pharmacy_products->TransactionId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TransactionId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SoldProductId->Visible) { // SoldProductId ?>
	<div id="r_SoldProductId" class="form-group row">
		<label id="elh_pharmacy_products_SoldProductId" for="x_SoldProductId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SoldProductId->caption() ?><?php echo ($pharmacy_products->SoldProductId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SoldProductId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->WantedBookId->Visible) { // WantedBookId ?>
	<div id="r_WantedBookId" class="form-group row">
		<label id="elh_pharmacy_products_WantedBookId" for="x_WantedBookId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->WantedBookId->caption() ?><?php echo ($pharmacy_products->WantedBookId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->WantedBookId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllId->Visible) { // AllId ?>
	<div id="r_AllId" class="form-group row">
		<label id="elh_pharmacy_products_AllId" for="x_AllId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllId->caption() ?><?php echo ($pharmacy_products->AllId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BatchAndExpiryCompulsory->Visible) { // BatchAndExpiryCompulsory ?>
	<div id="r_BatchAndExpiryCompulsory" class="form-group row">
		<label id="elh_pharmacy_products_BatchAndExpiryCompulsory" for="x_BatchAndExpiryCompulsory" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BatchAndExpiryCompulsory->caption() ?><?php echo ($pharmacy_products->BatchAndExpiryCompulsory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BatchAndExpiryCompulsory->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BatchStockForWantedBook->Visible) { // BatchStockForWantedBook ?>
	<div id="r_BatchStockForWantedBook" class="form-group row">
		<label id="elh_pharmacy_products_BatchStockForWantedBook" for="x_BatchStockForWantedBook" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BatchStockForWantedBook->caption() ?><?php echo ($pharmacy_products->BatchStockForWantedBook->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BatchStockForWantedBook->cellAttributes() ?>>
...
<?php if ($pharmacy_products->UnitBasedBilling->Visible) { // UnitBasedBilling ?>
	<div id="r_UnitBasedBilling" class="form-group row">
		<label id="elh_pharmacy_products_UnitBasedBilling" for="x_UnitBasedBilling" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->UnitBasedBilling->caption() ?><?php echo ($pharmacy_products->UnitBasedBilling->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->UnitBasedBilling->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DoNotCheckStock->Visible) { // DoNotCheckStock ?>
	<div id="r_DoNotCheckStock" class="form-group row">
		<label id="elh_pharmacy_products_DoNotCheckStock" for="x_DoNotCheckStock" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DoNotCheckStock->caption() ?><?php echo ($pharmacy_products->DoNotCheckStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DoNotCheckStock->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AcceptRate->Visible) { // AcceptRate ?>
	<div id="r_AcceptRate" class="form-group row">
		<label id="elh_pharmacy_products_AcceptRate" for="x_AcceptRate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AcceptRate->caption() ?><?php echo ($pharmacy_products->AcceptRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AcceptRate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PriceLevel->Visible) { // PriceLevel ?>
	<div id="r_PriceLevel" class="form-group row">
		<label id="elh_pharmacy_products_PriceLevel" for="x_PriceLevel" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PriceLevel->caption() ?><?php echo ($pharmacy_products->PriceLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PriceLevel->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LastQuotePrice->Visible) { // LastQuotePrice ?>
	<div id="r_LastQuotePrice" class="form-group row">
		<label id="elh_pharmacy_products_LastQuotePrice" for="x_LastQuotePrice" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LastQuotePrice->caption() ?><?php echo ($pharmacy_products->LastQuotePrice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LastQuotePrice->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PriceChange->Visible) { // PriceChange ?>
	<div id="r_PriceChange" class="form-group row">
		<label id="elh_pharmacy_products_PriceChange" for="x_PriceChange" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PriceChange->caption() ?><?php echo ($pharmacy_products->PriceChange->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PriceChange->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CommodityCode->Visible) { // CommodityCode ?>
	<div id="r_CommodityCode" class="form-group row">
		<label id="elh_pharmacy_products_CommodityCode" for="x_CommodityCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CommodityCode->caption() ?><?php echo ($pharmacy_products->CommodityCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CommodityCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->InstitutePrice->Visible) { // InstitutePrice ?>
	<div id="r_InstitutePrice" class="form-group row">
		<label id="elh_pharmacy_products_InstitutePrice" for="x_InstitutePrice" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->InstitutePrice->caption() ?><?php echo ($pharmacy_products->InstitutePrice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->InstitutePrice->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CtrlOrDCtrlProduct->Visible) { // CtrlOrDCtrlProduct ?>
	<div id="r_CtrlOrDCtrlProduct" class="form-group row">
		<label id="elh_pharmacy_products_CtrlOrDCtrlProduct" for="x_CtrlOrDCtrlProduct" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CtrlOrDCtrlProduct->caption() ?><?php echo ($pharmacy_products->CtrlOrDCtrlProduct->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CtrlOrDCtrlProduct->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ImportedDate->Visible) { // ImportedDate ?>
	<div id="r_ImportedDate" class="form-group row">
		<label id="elh_pharmacy_products_ImportedDate" for="x_ImportedDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ImportedDate->caption() ?><?php echo ($pharmacy_products->ImportedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ImportedDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsImported->Visible) { // IsImported ?>
	<div id="r_IsImported" class="form-group row">
		<label id="elh_pharmacy_products_IsImported" for="x_IsImported" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsImported->caption() ?><?php echo ($pharmacy_products->IsImported->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsImported->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FileName->Visible) { // FileName ?>
	<div id="r_FileName" class="form-group row">
		<label id="elh_pharmacy_products_FileName" for="x_FileName" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FileName->caption() ?><?php echo ($pharmacy_products->FileName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FileName->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LPName->Visible) { // LPName ?>
	<div id="r_LPName" class="form-group row">
		<label id="elh_pharmacy_products_LPName" for="x_LPName" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LPName->caption() ?><?php echo ($pharmacy_products->LPName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LPName->cellAttributes() ?>>
...
<?php if ($pharmacy_products->GodownNumber->Visible) { // GodownNumber ?>
	<div id="r_GodownNumber" class="form-group row">
		<label id="elh_pharmacy_products_GodownNumber" for="x_GodownNumber" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->GodownNumber->caption() ?><?php echo ($pharmacy_products->GodownNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->GodownNumber->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CreationDate->Visible) { // CreationDate ?>
	<div id="r_CreationDate" class="form-group row">
		<label id="elh_pharmacy_products_CreationDate" for="x_CreationDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CreationDate->caption() ?><?php echo ($pharmacy_products->CreationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CreationDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CreatedbyUser->Visible) { // CreatedbyUser ?>
	<div id="r_CreatedbyUser" class="form-group row">
		<label id="elh_pharmacy_products_CreatedbyUser" for="x_CreatedbyUser" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CreatedbyUser->caption() ?><?php echo ($pharmacy_products->CreatedbyUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CreatedbyUser->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ModifiedDate->Visible) { // ModifiedDate ?>
	<div id="r_ModifiedDate" class="form-group row">
		<label id="elh_pharmacy_products_ModifiedDate" for="x_ModifiedDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ModifiedDate->caption() ?><?php echo ($pharmacy_products->ModifiedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ModifiedDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ModifiedbyUser->Visible) { // ModifiedbyUser ?>
	<div id="r_ModifiedbyUser" class="form-group row">
		<label id="elh_pharmacy_products_ModifiedbyUser" for="x_ModifiedbyUser" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ModifiedbyUser->caption() ?><?php echo ($pharmacy_products->ModifiedbyUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ModifiedbyUser->cellAttributes() ?>>
...
<?php if ($pharmacy_products->isActive->Visible) { // isActive ?>
	<div id="r_isActive" class="form-group row">
		<label id="elh_pharmacy_products_isActive" for="x_isActive" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->isActive->caption() ?><?php echo ($pharmacy_products->isActive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->isActive->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllowExpiryClaim->Visible) { // AllowExpiryClaim ?>
	<div id="r_AllowExpiryClaim" class="form-group row">
		<label id="elh_pharmacy_products_AllowExpiryClaim" for="x_AllowExpiryClaim" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllowExpiryClaim->caption() ?><?php echo ($pharmacy_products->AllowExpiryClaim->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllowExpiryClaim->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BrandCode->Visible) { // BrandCode ?>
	<div id="r_BrandCode" class="form-group row">
		<label id="elh_pharmacy_products_BrandCode" for="x_BrandCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BrandCode->caption() ?><?php echo ($pharmacy_products->BrandCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BrandCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FreeSchemeBasedon->Visible) { // FreeSchemeBasedon ?>
	<div id="r_FreeSchemeBasedon" class="form-group row">
		<label id="elh_pharmacy_products_FreeSchemeBasedon" for="x_FreeSchemeBasedon" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FreeSchemeBasedon->caption() ?><?php echo ($pharmacy_products->FreeSchemeBasedon->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FreeSchemeBasedon->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DoNotCheckCostInBill->Visible) { // DoNotCheckCostInBill ?>
	<div id="r_DoNotCheckCostInBill" class="form-group row">
		<label id="elh_pharmacy_products_DoNotCheckCostInBill" for="x_DoNotCheckCostInBill" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DoNotCheckCostInBill->caption() ?><?php echo ($pharmacy_products->DoNotCheckCostInBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DoNotCheckCostInBill->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductGroupCode->Visible) { // ProductGroupCode ?>
	<div id="r_ProductGroupCode" class="form-group row">
		<label id="elh_pharmacy_products_ProductGroupCode" for="x_ProductGroupCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductGroupCode->caption() ?><?php echo ($pharmacy_products->ProductGroupCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductGroupCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductStrengthCode->Visible) { // ProductStrengthCode ?>
	<div id="r_ProductStrengthCode" class="form-group row">
		<label id="elh_pharmacy_products_ProductStrengthCode" for="x_ProductStrengthCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductStrengthCode->caption() ?><?php echo ($pharmacy_products->ProductStrengthCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductStrengthCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PackingCode->Visible) { // PackingCode ?>
	<div id="r_PackingCode" class="form-group row">
		<label id="elh_pharmacy_products_PackingCode" for="x_PackingCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PackingCode->caption() ?><?php echo ($pharmacy_products->PackingCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PackingCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ComputedMinStock->Visible) { // ComputedMinStock ?>
	<div id="r_ComputedMinStock" class="form-group row">
		<label id="elh_pharmacy_products_ComputedMinStock" for="x_ComputedMinStock" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ComputedMinStock->caption() ?><?php echo ($pharmacy_products->ComputedMinStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ComputedMinStock->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ComputedMaxStock->Visible) { // ComputedMaxStock ?>
	<div id="r_ComputedMaxStock" class="form-group row">
		<label id="elh_pharmacy_products_ComputedMaxStock" for="x_ComputedMaxStock" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ComputedMaxStock->caption() ?><?php echo ($pharmacy_products->ComputedMaxStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ComputedMaxStock->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductRemark->Visible) { // ProductRemark ?>
	<div id="r_ProductRemark" class="form-group row">
		<label id="elh_pharmacy_products_ProductRemark" for="x_ProductRemark" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductRemark->caption() ?><?php echo ($pharmacy_products->ProductRemark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductRemark->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductDrugCode->Visible) { // ProductDrugCode ?>
	<div id="r_ProductDrugCode" class="form-group row">
		<label id="elh_pharmacy_products_ProductDrugCode" for="x_ProductDrugCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductDrugCode->caption() ?><?php echo ($pharmacy_products->ProductDrugCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductDrugCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsMatrixProduct->Visible) { // IsMatrixProduct ?>
	<div id="r_IsMatrixProduct" class="form-group row">
		<label id="elh_pharmacy_products_IsMatrixProduct" for="x_IsMatrixProduct" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsMatrixProduct->caption() ?><?php echo ($pharmacy_products->IsMatrixProduct->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsMatrixProduct->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount1->Visible) { // AttributeCount1 ?>
	<div id="r_AttributeCount1" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount1" for="x_AttributeCount1" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount1->caption() ?><?php echo ($pharmacy_products->AttributeCount1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount1->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount2->Visible) { // AttributeCount2 ?>
	<div id="r_AttributeCount2" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount2" for="x_AttributeCount2" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount2->caption() ?><?php echo ($pharmacy_products->AttributeCount2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount2->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount3->Visible) { // AttributeCount3 ?>
	<div id="r_AttributeCount3" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount3" for="x_AttributeCount3" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount3->caption() ?><?php echo ($pharmacy_products->AttributeCount3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount3->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount4->Visible) { // AttributeCount4 ?>
	<div id="r_AttributeCount4" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount4" for="x_AttributeCount4" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount4->caption() ?><?php echo ($pharmacy_products->AttributeCount4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount4->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount5->Visible) { // AttributeCount5 ?>
	<div id="r_AttributeCount5" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount5" for="x_AttributeCount5" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount5->caption() ?><?php echo ($pharmacy_products->AttributeCount5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount5->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DefaultDiscountPercentage->Visible) { // DefaultDiscountPercentage ?>
	<div id="r_DefaultDiscountPercentage" class="form-group row">
		<label id="elh_pharmacy_products_DefaultDiscountPercentage" for="x_DefaultDiscountPercentage" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DefaultDiscountPercentage->caption() ?><?php echo ($pharmacy_products->DefaultDiscountPercentage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DefaultDiscountPercentage->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DonotPrintBarcode->Visible) { // DonotPrintBarcode ?>
	<div id="r_DonotPrintBarcode" class="form-group row">
		<label id="elh_pharmacy_products_DonotPrintBarcode" for="x_DonotPrintBarcode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DonotPrintBarcode->caption() ?><?php echo ($pharmacy_products->DonotPrintBarcode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DonotPrintBarcode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductLevelDiscount->Visible) { // ProductLevelDiscount ?>
	<div id="r_ProductLevelDiscount" class="form-group row">
		<label id="elh_pharmacy_products_ProductLevelDiscount" for="x_ProductLevelDiscount" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductLevelDiscount->caption() ?><?php echo ($pharmacy_products->ProductLevelDiscount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductLevelDiscount->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Markup->Visible) { // Markup ?>
	<div id="r_Markup" class="form-group row">
		<label id="elh_pharmacy_products_Markup" for="x_Markup" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Markup->caption() ?><?php echo ($pharmacy_products->Markup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Markup->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarkDown->Visible) { // MarkDown ?>
	<div id="r_MarkDown" class="form-group row">
		<label id="elh_pharmacy_products_MarkDown" for="x_MarkDown" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarkDown->caption() ?><?php echo ($pharmacy_products->MarkDown->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarkDown->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ReworkSalePrice->Visible) { // ReworkSalePrice ?>
	<div id="r_ReworkSalePrice" class="form-group row">
		<label id="elh_pharmacy_products_ReworkSalePrice" for="x_ReworkSalePrice" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ReworkSalePrice->caption() ?><?php echo ($pharmacy_products->ReworkSalePrice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ReworkSalePrice->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MultipleInput->Visible) { // MultipleInput ?>
	<div id="r_MultipleInput" class="form-group row">
		<label id="elh_pharmacy_products_MultipleInput" for="x_MultipleInput" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MultipleInput->caption() ?><?php echo ($pharmacy_products->MultipleInput->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MultipleInput->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LpPackageInformation->Visible) { // LpPackageInformation ?>
	<div id="r_LpPackageInformation" class="form-group row">
		<label id="elh_pharmacy_products_LpPackageInformation" for="x_LpPackageInformation" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LpPackageInformation->caption() ?><?php echo ($pharmacy_products->LpPackageInformation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LpPackageInformation->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllowNegativeStock->Visible) { // AllowNegativeStock ?>
	<div id="r_AllowNegativeStock" class="form-group row">
		<label id="elh_pharmacy_products_AllowNegativeStock" for="x_AllowNegativeStock" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllowNegativeStock->caption() ?><?php echo ($pharmacy_products->AllowNegativeStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllowNegativeStock->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OrderDate->Visible) { // OrderDate ?>
	<div id="r_OrderDate" class="form-group row">
		<label id="elh_pharmacy_products_OrderDate" for="x_OrderDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OrderDate->caption() ?><?php echo ($pharmacy_products->OrderDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OrderDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OrderTime->Visible) { // OrderTime ?>
	<div id="r_OrderTime" class="form-group row">
		<label id="elh_pharmacy_products_OrderTime" for="x_OrderTime" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OrderTime->caption() ?><?php echo ($pharmacy_products->OrderTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OrderTime->cellAttributes() ?>>
...
<?php if ($pharmacy_products->RateGroupCode->Visible) { // RateGroupCode ?>
	<div id="r_RateGroupCode" class="form-group row">
		<label id="elh_pharmacy_products_RateGroupCode" for="x_RateGroupCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->RateGroupCode->caption() ?><?php echo ($pharmacy_products->RateGroupCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->RateGroupCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ConversionCaseLot->Visible) { // ConversionCaseLot ?>
	<div id="r_ConversionCaseLot" class="form-group row">
		<label id="elh_pharmacy_products_ConversionCaseLot" for="x_ConversionCaseLot" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ConversionCaseLot->caption() ?><?php echo ($pharmacy_products->ConversionCaseLot->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ConversionCaseLot->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ShippingLot->Visible) { // ShippingLot ?>
	<div id="r_ShippingLot" class="form-group row">
		<label id="elh_pharmacy_products_ShippingLot" for="x_ShippingLot" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ShippingLot->caption() ?><?php echo ($pharmacy_products->ShippingLot->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ShippingLot->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllowExpiryReplacement->Visible) { // AllowExpiryReplacement ?>
	<div id="r_AllowExpiryReplacement" class="form-group row">
		<label id="elh_pharmacy_products_AllowExpiryReplacement" for="x_AllowExpiryReplacement" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllowExpiryReplacement->caption() ?><?php echo ($pharmacy_products->AllowExpiryReplacement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllowExpiryReplacement->cellAttributes() ?>>
...
<?php if ($pharmacy_products->NoOfMonthExpiryAllowed->Visible) { // NoOfMonthExpiryAllowed ?>
	<div id="r_NoOfMonthExpiryAllowed" class="form-group row">
		<label id="elh_pharmacy_products_NoOfMonthExpiryAllowed" for="x_NoOfMonthExpiryAllowed" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->NoOfMonthExpiryAllowed->caption() ?><?php echo ($pharmacy_products->NoOfMonthExpiryAllowed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->NoOfMonthExpiryAllowed->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductDiscountEligibility->Visible) { // ProductDiscountEligibility ?>
	<div id="r_ProductDiscountEligibility" class="form-group row">
		<label id="elh_pharmacy_products_ProductDiscountEligibility" for="x_ProductDiscountEligibility" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductDiscountEligibility->caption() ?><?php echo ($pharmacy_products->ProductDiscountEligibility->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductDiscountEligibility->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ScheduleTypeCode->Visible) { // ScheduleTypeCode ?>
	<div id="r_ScheduleTypeCode" class="form-group row">
		<label id="elh_pharmacy_products_ScheduleTypeCode" for="x_ScheduleTypeCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ScheduleTypeCode->caption() ?><?php echo ($pharmacy_products->ScheduleTypeCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ScheduleTypeCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AIOCDProductCode->Visible) { // AIOCDProductCode ?>
	<div id="r_AIOCDProductCode" class="form-group row">
		<label id="elh_pharmacy_products_AIOCDProductCode" for="x_AIOCDProductCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AIOCDProductCode->caption() ?><?php echo ($pharmacy_products->AIOCDProductCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AIOCDProductCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FreeQuantity->Visible) { // FreeQuantity ?>
	<div id="r_FreeQuantity" class="form-group row">
		<label id="elh_pharmacy_products_FreeQuantity" for="x_FreeQuantity" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FreeQuantity->caption() ?><?php echo ($pharmacy_products->FreeQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FreeQuantity->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DiscountType->Visible) { // DiscountType ?>
	<div id="r_DiscountType" class="form-group row">
		<label id="elh_pharmacy_products_DiscountType" for="x_DiscountType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DiscountType->caption() ?><?php echo ($pharmacy_products->DiscountType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DiscountType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DiscountValue->Visible) { // DiscountValue ?>
	<div id="r_DiscountValue" class="form-group row">
		<label id="elh_pharmacy_products_DiscountValue" for="x_DiscountValue" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DiscountValue->caption() ?><?php echo ($pharmacy_products->DiscountValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DiscountValue->cellAttributes() ?>>
...
<?php if ($pharmacy_products->HasProductOrderAttribute->Visible) { // HasProductOrderAttribute ?>
	<div id="r_HasProductOrderAttribute" class="form-group row">
		<label id="elh_pharmacy_products_HasProductOrderAttribute" for="x_HasProductOrderAttribute" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->HasProductOrderAttribute->caption() ?><?php echo ($pharmacy_products->HasProductOrderAttribute->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->HasProductOrderAttribute->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FirstPODate->Visible) { // FirstPODate ?>
	<div id="r_FirstPODate" class="form-group row">
		<label id="elh_pharmacy_products_FirstPODate" for="x_FirstPODate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FirstPODate->caption() ?><?php echo ($pharmacy_products->FirstPODate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FirstPODate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SaleprcieAndMrpCalcPercent->Visible) { // SaleprcieAndMrpCalcPercent ?>
	<div id="r_SaleprcieAndMrpCalcPercent" class="form-group row">
		<label id="elh_pharmacy_products_SaleprcieAndMrpCalcPercent" for="x_SaleprcieAndMrpCalcPercent" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SaleprcieAndMrpCalcPercent->caption() ?><?php echo ($pharmacy_products->SaleprcieAndMrpCalcPercent->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SaleprcieAndMrpCalcPercent->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsGiftVoucherProducts->Visible) { // IsGiftVoucherProducts ?>
	<div id="r_IsGiftVoucherProducts" class="form-group row">
		<label id="elh_pharmacy_products_IsGiftVoucherProducts" for="x_IsGiftVoucherProducts" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsGiftVoucherProducts->caption() ?><?php echo ($pharmacy_products->IsGiftVoucherProducts->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsGiftVoucherProducts->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AcceptRange4SerialNumber->Visible) { // AcceptRange4SerialNumber ?>
	<div id="r_AcceptRange4SerialNumber" class="form-group row">
		<label id="elh_pharmacy_products_AcceptRange4SerialNumber" for="x_AcceptRange4SerialNumber" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AcceptRange4SerialNumber->caption() ?><?php echo ($pharmacy_products->AcceptRange4SerialNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AcceptRange4SerialNumber->cellAttributes() ?>>
...
<?php if ($pharmacy_products->GiftVoucherDenomination->Visible) { // GiftVoucherDenomination ?>
	<div id="r_GiftVoucherDenomination" class="form-group row">
		<label id="elh_pharmacy_products_GiftVoucherDenomination" for="x_GiftVoucherDenomination" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->GiftVoucherDenomination->caption() ?><?php echo ($pharmacy_products->GiftVoucherDenomination->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->GiftVoucherDenomination->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Subclasscode->Visible) { // Subclasscode ?>
	<div id="r_Subclasscode" class="form-group row">
		<label id="elh_pharmacy_products_Subclasscode" for="x_Subclasscode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Subclasscode->caption() ?><?php echo ($pharmacy_products->Subclasscode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Subclasscode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BarCodeFromWeighingMachine->Visible) { // BarCodeFromWeighingMachine ?>
	<div id="r_BarCodeFromWeighingMachine" class="form-group row">
		<label id="elh_pharmacy_products_BarCodeFromWeighingMachine" for="x_BarCodeFromWeighingMachine" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BarCodeFromWeighingMachine->caption() ?><?php echo ($pharmacy_products->BarCodeFromWeighingMachine->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BarCodeFromWeighingMachine->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CheckCostInReturn->Visible) { // CheckCostInReturn ?>
	<div id="r_CheckCostInReturn" class="form-group row">
		<label id="elh_pharmacy_products_CheckCostInReturn" for="x_CheckCostInReturn" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CheckCostInReturn->caption() ?><?php echo ($pharmacy_products->CheckCostInReturn->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CheckCostInReturn->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FrequentSaleProduct->Visible) { // FrequentSaleProduct ?>
	<div id="r_FrequentSaleProduct" class="form-group row">
		<label id="elh_pharmacy_products_FrequentSaleProduct" for="x_FrequentSaleProduct" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FrequentSaleProduct->caption() ?><?php echo ($pharmacy_products->FrequentSaleProduct->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FrequentSaleProduct->cellAttributes() ?>>
...
<?php if ($pharmacy_products->RateType->Visible) { // RateType ?>
	<div id="r_RateType" class="form-group row">
		<label id="elh_pharmacy_products_RateType" for="x_RateType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->RateType->caption() ?><?php echo ($pharmacy_products->RateType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->RateType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TouchscreenName->Visible) { // TouchscreenName ?>
	<div id="r_TouchscreenName" class="form-group row">
		<label id="elh_pharmacy_products_TouchscreenName" for="x_TouchscreenName" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TouchscreenName->caption() ?><?php echo ($pharmacy_products->TouchscreenName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TouchscreenName->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FreeType->Visible) { // FreeType ?>
	<div id="r_FreeType" class="form-group row">
		<label id="elh_pharmacy_products_FreeType" for="x_FreeType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FreeType->caption() ?><?php echo ($pharmacy_products->FreeType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FreeType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LooseQtyasNewBatch->Visible) { // LooseQtyasNewBatch ?>
	<div id="r_LooseQtyasNewBatch" class="form-group row">
		<label id="elh_pharmacy_products_LooseQtyasNewBatch" for="x_LooseQtyasNewBatch" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LooseQtyasNewBatch->caption() ?><?php echo ($pharmacy_products->LooseQtyasNewBatch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LooseQtyasNewBatch->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AllowSlabBilling->Visible) { // AllowSlabBilling ?>
	<div id="r_AllowSlabBilling" class="form-group row">
		<label id="elh_pharmacy_products_AllowSlabBilling" for="x_AllowSlabBilling" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AllowSlabBilling->caption() ?><?php echo ($pharmacy_products->AllowSlabBilling->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AllowSlabBilling->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductTypeForProduction->Visible) { // ProductTypeForProduction ?>
	<div id="r_ProductTypeForProduction" class="form-group row">
		<label id="elh_pharmacy_products_ProductTypeForProduction" for="x_ProductTypeForProduction" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductTypeForProduction->caption() ?><?php echo ($pharmacy_products->ProductTypeForProduction->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductTypeForProduction->cellAttributes() ?>>
...
<?php if ($pharmacy_products->RecipeCode->Visible) { // RecipeCode ?>
	<div id="r_RecipeCode" class="form-group row">
		<label id="elh_pharmacy_products_RecipeCode" for="x_RecipeCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->RecipeCode->caption() ?><?php echo ($pharmacy_products->RecipeCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->RecipeCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DefaultUnitType->Visible) { // DefaultUnitType ?>
	<div id="r_DefaultUnitType" class="form-group row">
		<label id="elh_pharmacy_products_DefaultUnitType" for="x_DefaultUnitType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DefaultUnitType->caption() ?><?php echo ($pharmacy_products->DefaultUnitType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DefaultUnitType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PIstatus->Visible) { // PIstatus ?>
	<div id="r_PIstatus" class="form-group row">
		<label id="elh_pharmacy_products_PIstatus" for="x_PIstatus" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PIstatus->caption() ?><?php echo ($pharmacy_products->PIstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PIstatus->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LastPiConfirmedDate->Visible) { // LastPiConfirmedDate ?>
	<div id="r_LastPiConfirmedDate" class="form-group row">
		<label id="elh_pharmacy_products_LastPiConfirmedDate" for="x_LastPiConfirmedDate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LastPiConfirmedDate->caption() ?><?php echo ($pharmacy_products->LastPiConfirmedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LastPiConfirmedDate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BarCodeDesign->Visible) { // BarCodeDesign ?>
	<div id="r_BarCodeDesign" class="form-group row">
		<label id="elh_pharmacy_products_BarCodeDesign" for="x_BarCodeDesign" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BarCodeDesign->caption() ?><?php echo ($pharmacy_products->BarCodeDesign->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BarCodeDesign->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AcceptRemarksInBill->Visible) { // AcceptRemarksInBill ?>
	<div id="r_AcceptRemarksInBill" class="form-group row">
		<label id="elh_pharmacy_products_AcceptRemarksInBill" for="x_AcceptRemarksInBill" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AcceptRemarksInBill->caption() ?><?php echo ($pharmacy_products->AcceptRemarksInBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AcceptRemarksInBill->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Classification->Visible) { // Classification ?>
	<div id="r_Classification" class="form-group row">
		<label id="elh_pharmacy_products_Classification" for="x_Classification" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Classification->caption() ?><?php echo ($pharmacy_products->Classification->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Classification->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TimeSlot->Visible) { // TimeSlot ?>
	<div id="r_TimeSlot" class="form-group row">
		<label id="elh_pharmacy_products_TimeSlot" for="x_TimeSlot" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TimeSlot->caption() ?><?php echo ($pharmacy_products->TimeSlot->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TimeSlot->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsBundle->Visible) { // IsBundle ?>
	<div id="r_IsBundle" class="form-group row">
		<label id="elh_pharmacy_products_IsBundle" for="x_IsBundle" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsBundle->caption() ?><?php echo ($pharmacy_products->IsBundle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsBundle->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ColorCode->Visible) { // ColorCode ?>
	<div id="r_ColorCode" class="form-group row">
		<label id="elh_pharmacy_products_ColorCode" for="x_ColorCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ColorCode->caption() ?><?php echo ($pharmacy_products->ColorCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ColorCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->GenderCode->Visible) { // GenderCode ?>
	<div id="r_GenderCode" class="form-group row">
		<label id="elh_pharmacy_products_GenderCode" for="x_GenderCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->GenderCode->caption() ?><?php echo ($pharmacy_products->GenderCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->GenderCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SizeCode->Visible) { // SizeCode ?>
	<div id="r_SizeCode" class="form-group row">
		<label id="elh_pharmacy_products_SizeCode" for="x_SizeCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SizeCode->caption() ?><?php echo ($pharmacy_products->SizeCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SizeCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->GiftCard->Visible) { // GiftCard ?>
	<div id="r_GiftCard" class="form-group row">
		<label id="elh_pharmacy_products_GiftCard" for="x_GiftCard" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->GiftCard->caption() ?><?php echo ($pharmacy_products->GiftCard->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->GiftCard->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ToonLabel->Visible) { // ToonLabel ?>
	<div id="r_ToonLabel" class="form-group row">
		<label id="elh_pharmacy_products_ToonLabel" for="x_ToonLabel" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ToonLabel->caption() ?><?php echo ($pharmacy_products->ToonLabel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ToonLabel->cellAttributes() ?>>
...
<?php if ($pharmacy_products->GarmentType->Visible) { // GarmentType ?>
	<div id="r_GarmentType" class="form-group row">
		<label id="elh_pharmacy_products_GarmentType" for="x_GarmentType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->GarmentType->caption() ?><?php echo ($pharmacy_products->GarmentType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->GarmentType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AgeGroup->Visible) { // AgeGroup ?>
	<div id="r_AgeGroup" class="form-group row">
		<label id="elh_pharmacy_products_AgeGroup" for="x_AgeGroup" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AgeGroup->caption() ?><?php echo ($pharmacy_products->AgeGroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AgeGroup->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Season->Visible) { // Season ?>
	<div id="r_Season" class="form-group row">
		<label id="elh_pharmacy_products_Season" for="x_Season" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Season->caption() ?><?php echo ($pharmacy_products->Season->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Season->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DailyStockEntry->Visible) { // DailyStockEntry ?>
	<div id="r_DailyStockEntry" class="form-group row">
		<label id="elh_pharmacy_products_DailyStockEntry" for="x_DailyStockEntry" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DailyStockEntry->caption() ?><?php echo ($pharmacy_products->DailyStockEntry->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DailyStockEntry->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ModifierApplicable->Visible) { // ModifierApplicable ?>
	<div id="r_ModifierApplicable" class="form-group row">
		<label id="elh_pharmacy_products_ModifierApplicable" for="x_ModifierApplicable" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ModifierApplicable->caption() ?><?php echo ($pharmacy_products->ModifierApplicable->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ModifierApplicable->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ModifierType->Visible) { // ModifierType ?>
	<div id="r_ModifierType" class="form-group row">
		<label id="elh_pharmacy_products_ModifierType" for="x_ModifierType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ModifierType->caption() ?><?php echo ($pharmacy_products->ModifierType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ModifierType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AcceptZeroRate->Visible) { // AcceptZeroRate ?>
	<div id="r_AcceptZeroRate" class="form-group row">
		<label id="elh_pharmacy_products_AcceptZeroRate" for="x_AcceptZeroRate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AcceptZeroRate->caption() ?><?php echo ($pharmacy_products->AcceptZeroRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AcceptZeroRate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ExciseDutyCode->Visible) { // ExciseDutyCode ?>
	<div id="r_ExciseDutyCode" class="form-group row">
		<label id="elh_pharmacy_products_ExciseDutyCode" for="x_ExciseDutyCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ExciseDutyCode->caption() ?><?php echo ($pharmacy_products->ExciseDutyCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ExciseDutyCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IndentProductGroupCode->Visible) { // IndentProductGroupCode ?>
	<div id="r_IndentProductGroupCode" class="form-group row">
		<label id="elh_pharmacy_products_IndentProductGroupCode" for="x_IndentProductGroupCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IndentProductGroupCode->caption() ?><?php echo ($pharmacy_products->IndentProductGroupCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IndentProductGroupCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsMultiBatch->Visible) { // IsMultiBatch ?>
	<div id="r_IsMultiBatch" class="form-group row">
		<label id="elh_pharmacy_products_IsMultiBatch" for="x_IsMultiBatch" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsMultiBatch->caption() ?><?php echo ($pharmacy_products->IsMultiBatch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsMultiBatch->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsSingleBatch->Visible) { // IsSingleBatch ?>
	<div id="r_IsSingleBatch" class="form-group row">
		<label id="elh_pharmacy_products_IsSingleBatch" for="x_IsSingleBatch" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsSingleBatch->caption() ?><?php echo ($pharmacy_products->IsSingleBatch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsSingleBatch->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarkUpRate1->Visible) { // MarkUpRate1 ?>
	<div id="r_MarkUpRate1" class="form-group row">
		<label id="elh_pharmacy_products_MarkUpRate1" for="x_MarkUpRate1" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarkUpRate1->caption() ?><?php echo ($pharmacy_products->MarkUpRate1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarkUpRate1->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarkDownRate1->Visible) { // MarkDownRate1 ?>
	<div id="r_MarkDownRate1" class="form-group row">
		<label id="elh_pharmacy_products_MarkDownRate1" for="x_MarkDownRate1" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarkDownRate1->caption() ?><?php echo ($pharmacy_products->MarkDownRate1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarkDownRate1->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarkUpRate2->Visible) { // MarkUpRate2 ?>
	<div id="r_MarkUpRate2" class="form-group row">
		<label id="elh_pharmacy_products_MarkUpRate2" for="x_MarkUpRate2" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarkUpRate2->caption() ?><?php echo ($pharmacy_products->MarkUpRate2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarkUpRate2->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarkDownRate2->Visible) { // MarkDownRate2 ?>
	<div id="r_MarkDownRate2" class="form-group row">
		<label id="elh_pharmacy_products_MarkDownRate2" for="x_MarkDownRate2" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarkDownRate2->caption() ?><?php echo ($pharmacy_products->MarkDownRate2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarkDownRate2->cellAttributes() ?>>
...
<?php if ($pharmacy_products->_Yield->Visible) { // Yield ?>
	<div id="r__Yield" class="form-group row">
		<label id="elh_pharmacy_products__Yield" for="x__Yield" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->_Yield->caption() ?><?php echo ($pharmacy_products->_Yield->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->_Yield->cellAttributes() ?>>
...
<?php if ($pharmacy_products->RefProductCode->Visible) { // RefProductCode ?>
	<div id="r_RefProductCode" class="form-group row">
		<label id="elh_pharmacy_products_RefProductCode" for="x_RefProductCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->RefProductCode->caption() ?><?php echo ($pharmacy_products->RefProductCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->RefProductCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Volume->Visible) { // Volume ?>
	<div id="r_Volume" class="form-group row">
		<label id="elh_pharmacy_products_Volume" for="x_Volume" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Volume->caption() ?><?php echo ($pharmacy_products->Volume->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Volume->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MeasurementID->Visible) { // MeasurementID ?>
	<div id="r_MeasurementID" class="form-group row">
		<label id="elh_pharmacy_products_MeasurementID" for="x_MeasurementID" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MeasurementID->caption() ?><?php echo ($pharmacy_products->MeasurementID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MeasurementID->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CountryCode->Visible) { // CountryCode ?>
	<div id="r_CountryCode" class="form-group row">
		<label id="elh_pharmacy_products_CountryCode" for="x_CountryCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CountryCode->caption() ?><?php echo ($pharmacy_products->CountryCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CountryCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AcceptWMQty->Visible) { // AcceptWMQty ?>
	<div id="r_AcceptWMQty" class="form-group row">
		<label id="elh_pharmacy_products_AcceptWMQty" for="x_AcceptWMQty" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AcceptWMQty->caption() ?><?php echo ($pharmacy_products->AcceptWMQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AcceptWMQty->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SingleBatchBasedOnRate->Visible) { // SingleBatchBasedOnRate ?>
	<div id="r_SingleBatchBasedOnRate" class="form-group row">
		<label id="elh_pharmacy_products_SingleBatchBasedOnRate" for="x_SingleBatchBasedOnRate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SingleBatchBasedOnRate->caption() ?><?php echo ($pharmacy_products->SingleBatchBasedOnRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SingleBatchBasedOnRate->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TenderNo->Visible) { // TenderNo ?>
	<div id="r_TenderNo" class="form-group row">
		<label id="elh_pharmacy_products_TenderNo" for="x_TenderNo" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TenderNo->caption() ?><?php echo ($pharmacy_products->TenderNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TenderNo->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SingleBillMaximumSoldQtyFiled->Visible) { // SingleBillMaximumSoldQtyFiled ?>
	<div id="r_SingleBillMaximumSoldQtyFiled" class="form-group row">
		<label id="elh_pharmacy_products_SingleBillMaximumSoldQtyFiled" for="x_SingleBillMaximumSoldQtyFiled" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SingleBillMaximumSoldQtyFiled->caption() ?><?php echo ($pharmacy_products->SingleBillMaximumSoldQtyFiled->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SingleBillMaximumSoldQtyFiled->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Strength1->Visible) { // Strength1 ?>
	<div id="r_Strength1" class="form-group row">
		<label id="elh_pharmacy_products_Strength1" for="x_Strength1" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Strength1->caption() ?><?php echo ($pharmacy_products->Strength1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Strength1->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Strength2->Visible) { // Strength2 ?>
	<div id="r_Strength2" class="form-group row">
		<label id="elh_pharmacy_products_Strength2" for="x_Strength2" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Strength2->caption() ?><?php echo ($pharmacy_products->Strength2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Strength2->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Strength3->Visible) { // Strength3 ?>
	<div id="r_Strength3" class="form-group row">
		<label id="elh_pharmacy_products_Strength3" for="x_Strength3" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Strength3->caption() ?><?php echo ($pharmacy_products->Strength3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Strength3->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Strength4->Visible) { // Strength4 ?>
	<div id="r_Strength4" class="form-group row">
		<label id="elh_pharmacy_products_Strength4" for="x_Strength4" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Strength4->caption() ?><?php echo ($pharmacy_products->Strength4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Strength4->cellAttributes() ?>>
...
<?php if ($pharmacy_products->Strength5->Visible) { // Strength5 ?>
	<div id="r_Strength5" class="form-group row">
		<label id="elh_pharmacy_products_Strength5" for="x_Strength5" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->Strength5->caption() ?><?php echo ($pharmacy_products->Strength5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->Strength5->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IngredientCode1->Visible) { // IngredientCode1 ?>
	<div id="r_IngredientCode1" class="form-group row">
		<label id="elh_pharmacy_products_IngredientCode1" for="x_IngredientCode1" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IngredientCode1->caption() ?><?php echo ($pharmacy_products->IngredientCode1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IngredientCode1->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IngredientCode2->Visible) { // IngredientCode2 ?>
	<div id="r_IngredientCode2" class="form-group row">
		<label id="elh_pharmacy_products_IngredientCode2" for="x_IngredientCode2" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IngredientCode2->caption() ?><?php echo ($pharmacy_products->IngredientCode2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IngredientCode2->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IngredientCode3->Visible) { // IngredientCode3 ?>
	<div id="r_IngredientCode3" class="form-group row">
		<label id="elh_pharmacy_products_IngredientCode3" for="x_IngredientCode3" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IngredientCode3->caption() ?><?php echo ($pharmacy_products->IngredientCode3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IngredientCode3->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IngredientCode4->Visible) { // IngredientCode4 ?>
	<div id="r_IngredientCode4" class="form-group row">
		<label id="elh_pharmacy_products_IngredientCode4" for="x_IngredientCode4" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IngredientCode4->caption() ?><?php echo ($pharmacy_products->IngredientCode4->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IngredientCode4->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IngredientCode5->Visible) { // IngredientCode5 ?>
	<div id="r_IngredientCode5" class="form-group row">
		<label id="elh_pharmacy_products_IngredientCode5" for="x_IngredientCode5" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IngredientCode5->caption() ?><?php echo ($pharmacy_products->IngredientCode5->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IngredientCode5->cellAttributes() ?>>
...
<?php if ($pharmacy_products->OrderType->Visible) { // OrderType ?>
	<div id="r_OrderType" class="form-group row">
		<label id="elh_pharmacy_products_OrderType" for="x_OrderType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->OrderType->caption() ?><?php echo ($pharmacy_products->OrderType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->OrderType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StockUOM->Visible) { // StockUOM ?>
	<div id="r_StockUOM" class="form-group row">
		<label id="elh_pharmacy_products_StockUOM" for="x_StockUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StockUOM->caption() ?><?php echo ($pharmacy_products->StockUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StockUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PriceUOM->Visible) { // PriceUOM ?>
	<div id="r_PriceUOM" class="form-group row">
		<label id="elh_pharmacy_products_PriceUOM" for="x_PriceUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PriceUOM->caption() ?><?php echo ($pharmacy_products->PriceUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PriceUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DefaultSaleUOM->Visible) { // DefaultSaleUOM ?>
	<div id="r_DefaultSaleUOM" class="form-group row">
		<label id="elh_pharmacy_products_DefaultSaleUOM" for="x_DefaultSaleUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DefaultSaleUOM->caption() ?><?php echo ($pharmacy_products->DefaultSaleUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DefaultSaleUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DefaultPurchaseUOM->Visible) { // DefaultPurchaseUOM ?>
	<div id="r_DefaultPurchaseUOM" class="form-group row">
		<label id="elh_pharmacy_products_DefaultPurchaseUOM" for="x_DefaultPurchaseUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DefaultPurchaseUOM->caption() ?><?php echo ($pharmacy_products->DefaultPurchaseUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DefaultPurchaseUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ReportingUOM->Visible) { // ReportingUOM ?>
	<div id="r_ReportingUOM" class="form-group row">
		<label id="elh_pharmacy_products_ReportingUOM" for="x_ReportingUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ReportingUOM->caption() ?><?php echo ($pharmacy_products->ReportingUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ReportingUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LastPurchasedUOM->Visible) { // LastPurchasedUOM ?>
	<div id="r_LastPurchasedUOM" class="form-group row">
		<label id="elh_pharmacy_products_LastPurchasedUOM" for="x_LastPurchasedUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LastPurchasedUOM->caption() ?><?php echo ($pharmacy_products->LastPurchasedUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LastPurchasedUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TreatmentCodes->Visible) { // TreatmentCodes ?>
	<div id="r_TreatmentCodes" class="form-group row">
		<label id="elh_pharmacy_products_TreatmentCodes" for="x_TreatmentCodes" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TreatmentCodes->caption() ?><?php echo ($pharmacy_products->TreatmentCodes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TreatmentCodes->cellAttributes() ?>>
...
<?php if ($pharmacy_products->InsuranceType->Visible) { // InsuranceType ?>
	<div id="r_InsuranceType" class="form-group row">
		<label id="elh_pharmacy_products_InsuranceType" for="x_InsuranceType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->InsuranceType->caption() ?><?php echo ($pharmacy_products->InsuranceType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->InsuranceType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->CoverageGroupCodes->Visible) { // CoverageGroupCodes ?>
	<div id="r_CoverageGroupCodes" class="form-group row">
		<label id="elh_pharmacy_products_CoverageGroupCodes" for="x_CoverageGroupCodes" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->CoverageGroupCodes->caption() ?><?php echo ($pharmacy_products->CoverageGroupCodes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->CoverageGroupCodes->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MultipleUOM->Visible) { // MultipleUOM ?>
	<div id="r_MultipleUOM" class="form-group row">
		<label id="elh_pharmacy_products_MultipleUOM" for="x_MultipleUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MultipleUOM->caption() ?><?php echo ($pharmacy_products->MultipleUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MultipleUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SalePriceComputation->Visible) { // SalePriceComputation ?>
	<div id="r_SalePriceComputation" class="form-group row">
		<label id="elh_pharmacy_products_SalePriceComputation" for="x_SalePriceComputation" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SalePriceComputation->caption() ?><?php echo ($pharmacy_products->SalePriceComputation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SalePriceComputation->cellAttributes() ?>>
...
<?php if ($pharmacy_products->StockCorrection->Visible) { // StockCorrection ?>
	<div id="r_StockCorrection" class="form-group row">
		<label id="elh_pharmacy_products_StockCorrection" for="x_StockCorrection" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->StockCorrection->caption() ?><?php echo ($pharmacy_products->StockCorrection->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->StockCorrection->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LBTPercentage->Visible) { // LBTPercentage ?>
	<div id="r_LBTPercentage" class="form-group row">
		<label id="elh_pharmacy_products_LBTPercentage" for="x_LBTPercentage" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LBTPercentage->caption() ?><?php echo ($pharmacy_products->LBTPercentage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LBTPercentage->cellAttributes() ?>>
...
<?php if ($pharmacy_products->SalesCommission->Visible) { // SalesCommission ?>
	<div id="r_SalesCommission" class="form-group row">
		<label id="elh_pharmacy_products_SalesCommission" for="x_SalesCommission" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->SalesCommission->caption() ?><?php echo ($pharmacy_products->SalesCommission->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->SalesCommission->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LockedStock->Visible) { // LockedStock ?>
	<div id="r_LockedStock" class="form-group row">
		<label id="elh_pharmacy_products_LockedStock" for="x_LockedStock" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LockedStock->caption() ?><?php echo ($pharmacy_products->LockedStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LockedStock->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MinMaxUOM->Visible) { // MinMaxUOM ?>
	<div id="r_MinMaxUOM" class="form-group row">
		<label id="elh_pharmacy_products_MinMaxUOM" for="x_MinMaxUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MinMaxUOM->caption() ?><?php echo ($pharmacy_products->MinMaxUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MinMaxUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ExpiryMfrDateFormat->Visible) { // ExpiryMfrDateFormat ?>
	<div id="r_ExpiryMfrDateFormat" class="form-group row">
		<label id="elh_pharmacy_products_ExpiryMfrDateFormat" for="x_ExpiryMfrDateFormat" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ExpiryMfrDateFormat->caption() ?><?php echo ($pharmacy_products->ExpiryMfrDateFormat->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ExpiryMfrDateFormat->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ProductLifeTime->Visible) { // ProductLifeTime ?>
	<div id="r_ProductLifeTime" class="form-group row">
		<label id="elh_pharmacy_products_ProductLifeTime" for="x_ProductLifeTime" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ProductLifeTime->caption() ?><?php echo ($pharmacy_products->ProductLifeTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ProductLifeTime->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsCombo->Visible) { // IsCombo ?>
	<div id="r_IsCombo" class="form-group row">
		<label id="elh_pharmacy_products_IsCombo" for="x_IsCombo" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsCombo->caption() ?><?php echo ($pharmacy_products->IsCombo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsCombo->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ComboTypeCode->Visible) { // ComboTypeCode ?>
	<div id="r_ComboTypeCode" class="form-group row">
		<label id="elh_pharmacy_products_ComboTypeCode" for="x_ComboTypeCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ComboTypeCode->caption() ?><?php echo ($pharmacy_products->ComboTypeCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ComboTypeCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount6->Visible) { // AttributeCount6 ?>
	<div id="r_AttributeCount6" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount6" for="x_AttributeCount6" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount6->caption() ?><?php echo ($pharmacy_products->AttributeCount6->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount6->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount7->Visible) { // AttributeCount7 ?>
	<div id="r_AttributeCount7" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount7" for="x_AttributeCount7" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount7->caption() ?><?php echo ($pharmacy_products->AttributeCount7->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount7->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount8->Visible) { // AttributeCount8 ?>
	<div id="r_AttributeCount8" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount8" for="x_AttributeCount8" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount8->caption() ?><?php echo ($pharmacy_products->AttributeCount8->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount8->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount9->Visible) { // AttributeCount9 ?>
	<div id="r_AttributeCount9" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount9" for="x_AttributeCount9" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount9->caption() ?><?php echo ($pharmacy_products->AttributeCount9->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount9->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AttributeCount10->Visible) { // AttributeCount10 ?>
	<div id="r_AttributeCount10" class="form-group row">
		<label id="elh_pharmacy_products_AttributeCount10" for="x_AttributeCount10" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AttributeCount10->caption() ?><?php echo ($pharmacy_products->AttributeCount10->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AttributeCount10->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LabourCharge->Visible) { // LabourCharge ?>
	<div id="r_LabourCharge" class="form-group row">
		<label id="elh_pharmacy_products_LabourCharge" for="x_LabourCharge" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LabourCharge->caption() ?><?php echo ($pharmacy_products->LabourCharge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LabourCharge->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AffectOtherCharge->Visible) { // AffectOtherCharge ?>
	<div id="r_AffectOtherCharge" class="form-group row">
		<label id="elh_pharmacy_products_AffectOtherCharge" for="x_AffectOtherCharge" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AffectOtherCharge->caption() ?><?php echo ($pharmacy_products->AffectOtherCharge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AffectOtherCharge->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DosageInfo->Visible) { // DosageInfo ?>
	<div id="r_DosageInfo" class="form-group row">
		<label id="elh_pharmacy_products_DosageInfo" for="x_DosageInfo" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DosageInfo->caption() ?><?php echo ($pharmacy_products->DosageInfo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DosageInfo->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DosageType->Visible) { // DosageType ?>
	<div id="r_DosageType" class="form-group row">
		<label id="elh_pharmacy_products_DosageType" for="x_DosageType" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DosageType->caption() ?><?php echo ($pharmacy_products->DosageType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DosageType->cellAttributes() ?>>
...
<?php if ($pharmacy_products->DefaultIndentUOM->Visible) { // DefaultIndentUOM ?>
	<div id="r_DefaultIndentUOM" class="form-group row">
		<label id="elh_pharmacy_products_DefaultIndentUOM" for="x_DefaultIndentUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->DefaultIndentUOM->caption() ?><?php echo ($pharmacy_products->DefaultIndentUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->DefaultIndentUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PromoTag->Visible) { // PromoTag ?>
	<div id="r_PromoTag" class="form-group row">
		<label id="elh_pharmacy_products_PromoTag" for="x_PromoTag" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PromoTag->caption() ?><?php echo ($pharmacy_products->PromoTag->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PromoTag->cellAttributes() ?>>
...
<?php if ($pharmacy_products->BillLevelPromoTag->Visible) { // BillLevelPromoTag ?>
	<div id="r_BillLevelPromoTag" class="form-group row">
		<label id="elh_pharmacy_products_BillLevelPromoTag" for="x_BillLevelPromoTag" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->BillLevelPromoTag->caption() ?><?php echo ($pharmacy_products->BillLevelPromoTag->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->BillLevelPromoTag->cellAttributes() ?>>
...
<?php if ($pharmacy_products->IsMRPProduct->Visible) { // IsMRPProduct ?>
	<div id="r_IsMRPProduct" class="form-group row">
		<label id="elh_pharmacy_products_IsMRPProduct" for="x_IsMRPProduct" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->IsMRPProduct->caption() ?><?php echo ($pharmacy_products->IsMRPProduct->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->IsMRPProduct->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MrpList->Visible) { // MrpList ?>
	<div id="r_MrpList" class="form-group row">
		<label id="elh_pharmacy_products_MrpList" for="x_MrpList" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MrpList->caption() ?><?php echo ($pharmacy_products->MrpList->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MrpList->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AlternateSaleUOM->Visible) { // AlternateSaleUOM ?>
	<div id="r_AlternateSaleUOM" class="form-group row">
		<label id="elh_pharmacy_products_AlternateSaleUOM" for="x_AlternateSaleUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AlternateSaleUOM->caption() ?><?php echo ($pharmacy_products->AlternateSaleUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AlternateSaleUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FreeUOM->Visible) { // FreeUOM ?>
	<div id="r_FreeUOM" class="form-group row">
		<label id="elh_pharmacy_products_FreeUOM" for="x_FreeUOM" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FreeUOM->caption() ?><?php echo ($pharmacy_products->FreeUOM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FreeUOM->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MarketedCode->Visible) { // MarketedCode ?>
	<div id="r_MarketedCode" class="form-group row">
		<label id="elh_pharmacy_products_MarketedCode" for="x_MarketedCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MarketedCode->caption() ?><?php echo ($pharmacy_products->MarketedCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MarketedCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->MinimumSalePrice->Visible) { // MinimumSalePrice ?>
	<div id="r_MinimumSalePrice" class="form-group row">
		<label id="elh_pharmacy_products_MinimumSalePrice" for="x_MinimumSalePrice" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->MinimumSalePrice->caption() ?><?php echo ($pharmacy_products->MinimumSalePrice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->MinimumSalePrice->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PRate1->Visible) { // PRate1 ?>
	<div id="r_PRate1" class="form-group row">
		<label id="elh_pharmacy_products_PRate1" for="x_PRate1" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PRate1->caption() ?><?php echo ($pharmacy_products->PRate1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PRate1->cellAttributes() ?>>
...
<?php if ($pharmacy_products->PRate2->Visible) { // PRate2 ?>
	<div id="r_PRate2" class="form-group row">
		<label id="elh_pharmacy_products_PRate2" for="x_PRate2" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->PRate2->caption() ?><?php echo ($pharmacy_products->PRate2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->PRate2->cellAttributes() ?>>
...
<?php if ($pharmacy_products->LPItemCost->Visible) { // LPItemCost ?>
	<div id="r_LPItemCost" class="form-group row">
		<label id="elh_pharmacy_products_LPItemCost" for="x_LPItemCost" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->LPItemCost->caption() ?><?php echo ($pharmacy_products->LPItemCost->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->LPItemCost->cellAttributes() ?>>
...
<?php if ($pharmacy_products->FixedItemCost->Visible) { // FixedItemCost ?>
	<div id="r_FixedItemCost" class="form-group row">
		<label id="elh_pharmacy_products_FixedItemCost" for="x_FixedItemCost" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->FixedItemCost->caption() ?><?php echo ($pharmacy_products->FixedItemCost->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->FixedItemCost->cellAttributes() ?>>
...
<?php if ($pharmacy_products->HSNId->Visible) { // HSNId ?>
	<div id="r_HSNId" class="form-group row">
		<label id="elh_pharmacy_products_HSNId" for="x_HSNId" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->HSNId->caption() ?><?php echo ($pharmacy_products->HSNId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->HSNId->cellAttributes() ?>>
...
<?php if ($pharmacy_products->TaxInclusive->Visible) { // TaxInclusive ?>
	<div id="r_TaxInclusive" class="form-group row">
		<label id="elh_pharmacy_products_TaxInclusive" for="x_TaxInclusive" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->TaxInclusive->caption() ?><?php echo ($pharmacy_products->TaxInclusive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->TaxInclusive->cellAttributes() ?>>
...
<?php if ($pharmacy_products->EligibleforWarranty->Visible) { // EligibleforWarranty ?>
	<div id="r_EligibleforWarranty" class="form-group row">
		<label id="elh_pharmacy_products_EligibleforWarranty" for="x_EligibleforWarranty" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->EligibleforWarranty->caption() ?><?php echo ($pharmacy_products->EligibleforWarranty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->EligibleforWarranty->cellAttributes() ?>>
...
<?php if ($pharmacy_products->NoofMonthsWarranty->Visible) { // NoofMonthsWarranty ?>
	<div id="r_NoofMonthsWarranty" class="form-group row">
		<label id="elh_pharmacy_products_NoofMonthsWarranty" for="x_NoofMonthsWarranty" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->NoofMonthsWarranty->caption() ?><?php echo ($pharmacy_products->NoofMonthsWarranty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->NoofMonthsWarranty->cellAttributes() ?>>
...
<?php if ($pharmacy_products->ComputeTaxonCost->Visible) { // ComputeTaxonCost ?>
	<div id="r_ComputeTaxonCost" class="form-group row">
		<label id="elh_pharmacy_products_ComputeTaxonCost" for="x_ComputeTaxonCost" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->ComputeTaxonCost->caption() ?><?php echo ($pharmacy_products->ComputeTaxonCost->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->ComputeTaxonCost->cellAttributes() ?>>
...
<?php if ($pharmacy_products->HasEmptyBottleTrack->Visible) { // HasEmptyBottleTrack ?>
	<div id="r_HasEmptyBottleTrack" class="form-group row">
		<label id="elh_pharmacy_products_HasEmptyBottleTrack" for="x_HasEmptyBottleTrack" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->HasEmptyBottleTrack->caption() ?><?php echo ($pharmacy_products->HasEmptyBottleTrack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->HasEmptyBottleTrack->cellAttributes() ?>>
...
<?php if ($pharmacy_products->EmptyBottleReferenceCode->Visible) { // EmptyBottleReferenceCode ?>
	<div id="r_EmptyBottleReferenceCode" class="form-group row">
		<label id="elh_pharmacy_products_EmptyBottleReferenceCode" for="x_EmptyBottleReferenceCode" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->EmptyBottleReferenceCode->caption() ?><?php echo ($pharmacy_products->EmptyBottleReferenceCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->EmptyBottleReferenceCode->cellAttributes() ?>>
...
<?php if ($pharmacy_products->AdditionalCESSAmount->Visible) { // AdditionalCESSAmount ?>
	<div id="r_AdditionalCESSAmount" class="form-group row">
		<label id="elh_pharmacy_products_AdditionalCESSAmount" for="x_AdditionalCESSAmount" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->AdditionalCESSAmount->caption() ?><?php echo ($pharmacy_products->AdditionalCESSAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->AdditionalCESSAmount->cellAttributes() ?>>
...
<?php if ($pharmacy_products->EmptyBottleRate->Visible) { // EmptyBottleRate ?>
	<div id="r_EmptyBottleRate" class="form-group row">
		<label id="elh_pharmacy_products_EmptyBottleRate" for="x_EmptyBottleRate" class="<?php echo $pharmacy_products_edit->LeftColumnClass ?>"><?php echo $pharmacy_products->EmptyBottleRate->caption() ?><?php echo ($pharmacy_products->EmptyBottleRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pharmacy_products_edit->RightColumnClass ?>"><div<?php echo $pharmacy_products->EmptyBottleRate->cellAttributes() ?>>
