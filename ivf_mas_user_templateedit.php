...
var fivf_mas_user_templateedit = currentForm = new ew.Form("fivf_mas_user_templateedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($ivf_mas_user_template_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_mas_user_template->id->caption(), $ivf_mas_user_template->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fivf_mas_user_templateedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_mas_user_templateedit.lists["x_TemplateType"] = <?php echo $ivf_mas_user_template_edit->TemplateType->Lookup->toClientList() ?>;
...
<?php if ($ivf_mas_user_template_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_mas_user_template_edit->Token ?>">
<?php } ?>
...
<?php if ($ivf_mas_user_template->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_ivf_mas_user_template_id" class="<?php echo $ivf_mas_user_template_edit->LeftColumnClass ?>"><?php echo $ivf_mas_user_template->id->caption() ?><?php echo ($ivf_mas_user_template->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_mas_user_template_edit->RightColumnClass ?>"><div<?php echo $ivf_mas_user_template->id->cellAttributes() ?>>
<span id="el_ivf_mas_user_template_id">
<span<?php echo $ivf_mas_user_template->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($ivf_mas_user_template->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="ivf_mas_user_template" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($ivf_mas_user_template->id->CurrentValue) ?>">
<?php echo $ivf_mas_user_template->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ivf_mas_user_template->TemplateName->Visible) { // TemplateName ?>
	<div id="r_TemplateName" class="form-group row">
		<label id="elh_ivf_mas_user_template_TemplateName" for="x_TemplateName" class="<?php echo $ivf_mas_user_template_edit->LeftColumnClass ?>"><?php echo $ivf_mas_user_template->TemplateName->caption() ?><?php echo ($ivf_mas_user_template->TemplateName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_mas_user_template_edit->RightColumnClass ?>"><div<?php echo $ivf_mas_user_template->TemplateName->cellAttributes() ?>>
...
<?php if ($ivf_mas_user_template->TemplateType->Visible) { // TemplateType ?>
	<div id="r_TemplateType" class="form-group row">
		<label id="elh_ivf_mas_user_template_TemplateType" for="x_TemplateType" class="<?php echo $ivf_mas_user_template_edit->LeftColumnClass ?>"><?php echo $ivf_mas_user_template->TemplateType->caption() ?><?php echo ($ivf_mas_user_template->TemplateType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_mas_user_template_edit->RightColumnClass ?>"><div<?php echo $ivf_mas_user_template->TemplateType->cellAttributes() ?>>
...
<?php if ($ivf_mas_user_template->Template->Visible) { // Template ?>
	<div id="r_Template" class="form-group row">
		<label id="elh_ivf_mas_user_template_Template" for="x_Template" class="<?php echo $ivf_mas_user_template_edit->LeftColumnClass ?>"><?php echo $ivf_mas_user_template->Template->caption() ?><?php echo ($ivf_mas_user_template->Template->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_mas_user_template_edit->RightColumnClass ?>"><div<?php echo $ivf_mas_user_template->Template->cellAttributes() ?>>
