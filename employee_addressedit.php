...
var femployee_addressedit = currentForm = new ew.Form("femployee_addressedit", "edit");
...
femployee_addressedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_address_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_address->modifiedby->caption(), $employee_address->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_address_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_address->modifieddatetime->caption(), $employee_address->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_address_edit->HospID->Required) { ?>
...
femployee_addressedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_addressedit.lists["x_address_type"] = <?php echo $employee_address_edit->address_type->Lookup->toClientList() ?>;
femployee_addressedit.lists["x_address_type"].options = <?php echo JsonEncode($employee_address_edit->address_type->lookupOptions()) ?>;
femployee_addressedit.lists["x_status"] = <?php echo $employee_address_edit->status->Lookup->toClientList() ?>;
...
<?php if ($employee_address_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_address_edit->Token ?>">
<?php } ?>
...
<?php if ($employee_address->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_employee_address_id" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->id->caption() ?><?php echo ($employee_address->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->id->cellAttributes() ?>>
...
<input type="hidden" data-table="employee_address" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($employee_address->id->CurrentValue) ?>">
<?php echo $employee_address->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($employee_address->employee_id->Visible) { // employee_id ?>
	<div id="r_employee_id" class="form-group row">
		<label id="elh_employee_address_employee_id" for="x_employee_id" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->employee_id->caption() ?><?php echo ($employee_address->employee_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->employee_id->cellAttributes() ?>>
...
<?php if ($employee_address->contact_persion->Visible) { // contact_persion ?>
	<div id="r_contact_persion" class="form-group row">
		<label id="elh_employee_address_contact_persion" for="x_contact_persion" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->contact_persion->caption() ?><?php echo ($employee_address->contact_persion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->contact_persion->cellAttributes() ?>>
...
<?php if ($employee_address->street->Visible) { // street ?>
	<div id="r_street" class="form-group row">
		<label id="elh_employee_address_street" for="x_street" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->street->caption() ?><?php echo ($employee_address->street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->street->cellAttributes() ?>>
...
<?php if ($employee_address->town->Visible) { // town ?>
	<div id="r_town" class="form-group row">
		<label id="elh_employee_address_town" for="x_town" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->town->caption() ?><?php echo ($employee_address->town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->town->cellAttributes() ?>>
...
<?php if ($employee_address->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_employee_address_province" for="x_province" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->province->caption() ?><?php echo ($employee_address->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->province->cellAttributes() ?>>
...
<?php if ($employee_address->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_employee_address_postal_code" for="x_postal_code" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->postal_code->caption() ?><?php echo ($employee_address->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->postal_code->cellAttributes() ?>>
...
<?php if ($employee_address->address_type->Visible) { // address_type ?>
	<div id="r_address_type" class="form-group row">
		<label id="elh_employee_address_address_type" for="x_address_type" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->address_type->caption() ?><?php echo ($employee_address->address_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->address_type->cellAttributes() ?>>
...
<?php if ($employee_address->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_address_status" for="x_status" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->status->caption() ?><?php echo ($employee_address->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->status->cellAttributes() ?>>
...
<?php if ($employee_address->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_employee_address_HospID" for="x_HospID" class="<?php echo $employee_address_edit->LeftColumnClass ?>"><?php echo $employee_address->HospID->caption() ?><?php echo ($employee_address->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_address_edit->RightColumnClass ?>"><div<?php echo $employee_address->HospID->cellAttributes() ?>>
