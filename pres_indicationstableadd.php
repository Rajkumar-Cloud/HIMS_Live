...
var fpres_indicationstableadd = currentForm = new ew.Form("fpres_indicationstableadd", "add");
...
fpres_indicationstableadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_indicationstable_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_indicationstable_add->Token ?>">
<?php } ?>
...
<?php if ($pres_indicationstable->Genericname->Visible) { // Genericname ?>
	<div id="r_Genericname" class="form-group row">
		<label id="elh_pres_indicationstable_Genericname" for="x_Genericname" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Genericname->caption() ?><?php echo ($pres_indicationstable->Genericname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Genericname->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Indications->Visible) { // Indications ?>
	<div id="r_Indications" class="form-group row">
		<label id="elh_pres_indicationstable_Indications" for="x_Indications" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Indications->caption() ?><?php echo ($pres_indicationstable->Indications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Indications->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Category->Visible) { // Category ?>
	<div id="r_Category" class="form-group row">
		<label id="elh_pres_indicationstable_Category" for="x_Category" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Category->caption() ?><?php echo ($pres_indicationstable->Category->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Category->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Min_Age->Visible) { // Min_Age ?>
	<div id="r_Min_Age" class="form-group row">
		<label id="elh_pres_indicationstable_Min_Age" for="x_Min_Age" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Min_Age->caption() ?><?php echo ($pres_indicationstable->Min_Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Min_Age->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Min_Days->Visible) { // Min_Days ?>
	<div id="r_Min_Days" class="form-group row">
		<label id="elh_pres_indicationstable_Min_Days" for="x_Min_Days" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Min_Days->caption() ?><?php echo ($pres_indicationstable->Min_Days->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Min_Days->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Max_Age->Visible) { // Max_Age ?>
	<div id="r_Max_Age" class="form-group row">
		<label id="elh_pres_indicationstable_Max_Age" for="x_Max_Age" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Max_Age->caption() ?><?php echo ($pres_indicationstable->Max_Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Max_Age->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Max_Days->Visible) { // Max_Days ?>
	<div id="r_Max_Days" class="form-group row">
		<label id="elh_pres_indicationstable_Max_Days" for="x_Max_Days" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Max_Days->caption() ?><?php echo ($pres_indicationstable->Max_Days->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Max_Days->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->_Route->Visible) { // Route ?>
	<div id="r__Route" class="form-group row">
		<label id="elh_pres_indicationstable__Route" for="x__Route" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->_Route->caption() ?><?php echo ($pres_indicationstable->_Route->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->_Route->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_pres_indicationstable_Form" for="x_Form" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Form->caption() ?><?php echo ($pres_indicationstable->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Form->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Min_Dose_Val->Visible) { // Min_Dose_Val ?>
	<div id="r_Min_Dose_Val" class="form-group row">
		<label id="elh_pres_indicationstable_Min_Dose_Val" for="x_Min_Dose_Val" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Min_Dose_Val->caption() ?><?php echo ($pres_indicationstable->Min_Dose_Val->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Min_Dose_Val->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Min_Dose_Unit->Visible) { // Min_Dose_Unit ?>
	<div id="r_Min_Dose_Unit" class="form-group row">
		<label id="elh_pres_indicationstable_Min_Dose_Unit" for="x_Min_Dose_Unit" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Min_Dose_Unit->caption() ?><?php echo ($pres_indicationstable->Min_Dose_Unit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Min_Dose_Unit->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Max_Dose_Val->Visible) { // Max_Dose_Val ?>
	<div id="r_Max_Dose_Val" class="form-group row">
		<label id="elh_pres_indicationstable_Max_Dose_Val" for="x_Max_Dose_Val" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Max_Dose_Val->caption() ?><?php echo ($pres_indicationstable->Max_Dose_Val->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Max_Dose_Val->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Max_Dose_Unit->Visible) { // Max_Dose_Unit ?>
	<div id="r_Max_Dose_Unit" class="form-group row">
		<label id="elh_pres_indicationstable_Max_Dose_Unit" for="x_Max_Dose_Unit" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Max_Dose_Unit->caption() ?><?php echo ($pres_indicationstable->Max_Dose_Unit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Max_Dose_Unit->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Frequency->Visible) { // Frequency ?>
	<div id="r_Frequency" class="form-group row">
		<label id="elh_pres_indicationstable_Frequency" for="x_Frequency" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Frequency->caption() ?><?php echo ($pres_indicationstable->Frequency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Frequency->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Duration->Visible) { // Duration ?>
	<div id="r_Duration" class="form-group row">
		<label id="elh_pres_indicationstable_Duration" for="x_Duration" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Duration->caption() ?><?php echo ($pres_indicationstable->Duration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Duration->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->DWMY->Visible) { // DWMY ?>
	<div id="r_DWMY" class="form-group row">
		<label id="elh_pres_indicationstable_DWMY" for="x_DWMY" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->DWMY->caption() ?><?php echo ($pres_indicationstable->DWMY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->DWMY->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->Contraindications->Visible) { // Contraindications ?>
	<div id="r_Contraindications" class="form-group row">
		<label id="elh_pres_indicationstable_Contraindications" for="x_Contraindications" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->Contraindications->caption() ?><?php echo ($pres_indicationstable->Contraindications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->Contraindications->cellAttributes() ?>>
...
<?php if ($pres_indicationstable->RecStatus->Visible) { // RecStatus ?>
	<div id="r_RecStatus" class="form-group row">
		<label id="elh_pres_indicationstable_RecStatus" for="x_RecStatus" class="<?php echo $pres_indicationstable_add->LeftColumnClass ?>"><?php echo $pres_indicationstable->RecStatus->caption() ?><?php echo ($pres_indicationstable->RecStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_indicationstable_add->RightColumnClass ?>"><div<?php echo $pres_indicationstable->RecStatus->cellAttributes() ?>>
