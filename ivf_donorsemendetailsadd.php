...
var fivf_donorsemendetailsadd = currentForm = new ew.Form("fivf_donorsemendetailsadd", "add");
...
fivf_donorsemendetailsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($ivf_donorsemendetails_add->createdby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_donorsemendetails->createdby->caption(), $ivf_donorsemendetails->createdby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($ivf_donorsemendetails_add->createddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_createddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $ivf_donorsemendetails->createddatetime->caption(), $ivf_donorsemendetails->createddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fivf_donorsemendetailsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_donorsemendetailsadd.lists["x_BloodGroup"] = <?php echo $ivf_donorsemendetails_add->BloodGroup->Lookup->toClientList() ?>;
...
fivf_donorsemendetailsadd.lists["x_SkinColor"] = <?php echo $ivf_donorsemendetails_add->SkinColor->Lookup->toClientList() ?>;
...
fivf_donorsemendetailsadd.lists["x_EyeColor"] = <?php echo $ivf_donorsemendetails_add->EyeColor->Lookup->toClientList() ?>;
...
fivf_donorsemendetailsadd.lists["x_HairColor"] = <?php echo $ivf_donorsemendetails_add->HairColor->Lookup->toClientList() ?>;
...
fivf_donorsemendetailsadd.lists["x_Lagency"] = <?php echo $ivf_donorsemendetails_add->Lagency->Lookup->toClientList() ?>;
...
<?php if ($ivf_donorsemendetails_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_donorsemendetails_add->Token ?>">
<?php } ?>
...
<?php if ($ivf_donorsemendetails->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_ivf_donorsemendetails_RIDNo" for="x_RIDNo" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->RIDNo->caption() ?><?php echo ($ivf_donorsemendetails->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->RIDNo->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_donorsemendetails_TidNo" for="x_TidNo" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->TidNo->caption() ?><?php echo ($ivf_donorsemendetails->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->TidNo->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Agency->Visible) { // Agency ?>
	<div id="r_Agency" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Agency" for="x_Agency" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Agency->caption() ?><?php echo ($ivf_donorsemendetails->Agency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Agency->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->ReceivedOn->Visible) { // ReceivedOn ?>
	<div id="r_ReceivedOn" class="form-group row">
		<label id="elh_ivf_donorsemendetails_ReceivedOn" for="x_ReceivedOn" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->ReceivedOn->caption() ?><?php echo ($ivf_donorsemendetails->ReceivedOn->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->ReceivedOn->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->ReceivedBy->Visible) { // ReceivedBy ?>
	<div id="r_ReceivedBy" class="form-group row">
		<label id="elh_ivf_donorsemendetails_ReceivedBy" for="x_ReceivedBy" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->ReceivedBy->caption() ?><?php echo ($ivf_donorsemendetails->ReceivedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->ReceivedBy->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->DonorNo->Visible) { // DonorNo ?>
	<div id="r_DonorNo" class="form-group row">
		<label id="elh_ivf_donorsemendetails_DonorNo" for="x_DonorNo" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->DonorNo->caption() ?><?php echo ($ivf_donorsemendetails->DonorNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->DonorNo->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->BatchNo->Visible) { // BatchNo ?>
	<div id="r_BatchNo" class="form-group row">
		<label id="elh_ivf_donorsemendetails_BatchNo" for="x_BatchNo" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->BatchNo->caption() ?><?php echo ($ivf_donorsemendetails->BatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->BatchNo->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->BloodGroup->Visible) { // BloodGroup ?>
	<div id="r_BloodGroup" class="form-group row">
		<label id="elh_ivf_donorsemendetails_BloodGroup" for="x_BloodGroup" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->BloodGroup->caption() ?><?php echo ($ivf_donorsemendetails->BloodGroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->BloodGroup->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Height->Visible) { // Height ?>
	<div id="r_Height" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Height" for="x_Height" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Height->caption() ?><?php echo ($ivf_donorsemendetails->Height->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Height->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->SkinColor->Visible) { // SkinColor ?>
	<div id="r_SkinColor" class="form-group row">
		<label id="elh_ivf_donorsemendetails_SkinColor" for="x_SkinColor" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->SkinColor->caption() ?><?php echo ($ivf_donorsemendetails->SkinColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->SkinColor->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->EyeColor->Visible) { // EyeColor ?>
	<div id="r_EyeColor" class="form-group row">
		<label id="elh_ivf_donorsemendetails_EyeColor" for="x_EyeColor" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->EyeColor->caption() ?><?php echo ($ivf_donorsemendetails->EyeColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->EyeColor->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->HairColor->Visible) { // HairColor ?>
	<div id="r_HairColor" class="form-group row">
		<label id="elh_ivf_donorsemendetails_HairColor" for="x_HairColor" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->HairColor->caption() ?><?php echo ($ivf_donorsemendetails->HairColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->HairColor->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->NoOfVials->Visible) { // NoOfVials ?>
	<div id="r_NoOfVials" class="form-group row">
		<label id="elh_ivf_donorsemendetails_NoOfVials" for="x_NoOfVials" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->NoOfVials->caption() ?><?php echo ($ivf_donorsemendetails->NoOfVials->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->NoOfVials->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Tank->Visible) { // Tank ?>
	<div id="r_Tank" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Tank" for="x_Tank" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Tank->caption() ?><?php echo ($ivf_donorsemendetails->Tank->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Tank->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Canister->Visible) { // Canister ?>
	<div id="r_Canister" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Canister" for="x_Canister" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Canister->caption() ?><?php echo ($ivf_donorsemendetails->Canister->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Canister->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Remarks" for="x_Remarks" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Remarks->caption() ?><?php echo ($ivf_donorsemendetails->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Remarks->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->patientid->Visible) { // patientid ?>
	<div id="r_patientid" class="form-group row">
		<label id="elh_ivf_donorsemendetails_patientid" for="x_patientid" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->patientid->caption() ?><?php echo ($ivf_donorsemendetails->patientid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->patientid->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->coupleid->Visible) { // coupleid ?>
	<div id="r_coupleid" class="form-group row">
		<label id="elh_ivf_donorsemendetails_coupleid" for="x_coupleid" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->coupleid->caption() ?><?php echo ($ivf_donorsemendetails->coupleid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->coupleid->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Usedstatus->Visible) { // Usedstatus ?>
	<div id="r_Usedstatus" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Usedstatus" for="x_Usedstatus" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Usedstatus->caption() ?><?php echo ($ivf_donorsemendetails->Usedstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Usedstatus->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_ivf_donorsemendetails_status" for="x_status" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->status->caption() ?><?php echo ($ivf_donorsemendetails->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->status->cellAttributes() ?>>
...
<?php if ($ivf_donorsemendetails->Lagency->Visible) { // Lagency ?>
	<div id="r_Lagency" class="form-group row">
		<label id="elh_ivf_donorsemendetails_Lagency" for="x_Lagency" class="<?php echo $ivf_donorsemendetails_add->LeftColumnClass ?>"><?php echo $ivf_donorsemendetails->Lagency->caption() ?><?php echo ($ivf_donorsemendetails->Lagency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $ivf_donorsemendetails_add->RightColumnClass ?>"><div<?php echo $ivf_donorsemendetails->Lagency->cellAttributes() ?>>
