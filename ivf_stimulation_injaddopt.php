...
var fivf_stimulation_injaddopt = currentForm = new ew.Form("fivf_stimulation_injaddopt", "addopt");
...
fivf_stimulation_injaddopt.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
?>
<form name="fivf_stimulation_injaddopt" id="fivf_stimulation_injaddopt" class="ew-form ew-horizontal" action="<?php echo API_URL ?>" method="post">
<?php //if ($ivf_stimulation_inj_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_stimulation_inj_addopt->Token ?>">
<?php //} ?>
<input type="hidden" name="<?php echo API_ACTION_NAME ?>" id="<?php echo API_ACTION_NAME ?>" value="<?php echo API_ADD_ACTION ?>">
<input type="hidden" name="<?php echo API_OBJECT_NAME ?>" id="<?php echo API_OBJECT_NAME ?>" value="<?php echo $ivf_stimulation_inj_addopt->TableVar ?>">
<?php if ($ivf_stimulation_inj->Name->Visible) { // Name ?>
	<div class="form-group row">
		<label class="col-sm-2 col-form-label ew-label" for="x_Name"><?php echo $ivf_stimulation_inj->Name->caption() ?><?php echo ($ivf_stimulation_inj->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="col-sm-10">
...
<?php echo $ivf_stimulation_inj->Name->CustomMsg ?></div>
	</div>
<?php } ?>
</form>
<?php
