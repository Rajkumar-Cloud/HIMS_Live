...
var fpatient_follow_upadd = currentForm = new ew.Form("fpatient_follow_upadd", "add");
...
fpatient_follow_upadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($patient_follow_up_add->DischargeAdviceMedicine->Required) { ?>
		...
		<?php } ?>
		<?php if ($patient_follow_up_add->DischargeAdviceMedicineTemplate->Required) { ?>
...
fpatient_follow_upadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_follow_upadd.lists["x_Template"] = <?php echo $patient_follow_up_add->Template->Lookup->toClientList() ?>;
fpatient_follow_upadd.lists["x_Template"].options = <?php echo JsonEncode($patient_follow_up_add->Template->lookupOptions()) ?>;
fpatient_follow_upadd.lists["x_Template1"] = <?php echo $patient_follow_up_add->Template1->Lookup->toClientList() ?>;
fpatient_follow_upadd.lists["x_Template1"].options = <?php echo JsonEncode($patient_follow_up_add->Template1->lookupOptions()) ?>;
fpatient_follow_upadd.lists["x_Template2"] = <?php echo $patient_follow_up_add->Template2->Lookup->toClientList() ?>;
fpatient_follow_upadd.lists["x_Template2"].options = <?php echo JsonEncode($patient_follow_up_add->Template2->lookupOptions()) ?>;
fpatient_follow_upadd.lists["x_Template3"] = <?php echo $patient_follow_up_add->Template3->Lookup->toClientList() ?>;
fpatient_follow_upadd.lists["x_Template3"].options = <?php echo JsonEncode($patient_follow_up_add->Template3->lookupOptions()) ?>;
fpatient_follow_upadd.lists["x_PatientSearch"] = <?php echo $patient_follow_up_add->PatientSearch->Lookup->toClientList() ?>;
...
fpatient_follow_upadd.lists["x_DischargeAdviceMedicineTemplate"] = <?php echo $patient_follow_up_add->DischargeAdviceMedicineTemplate->Lookup->toClientList() ?>;
fpatient_follow_upadd.lists["x_DischargeAdviceMedicineTemplate"].options = <?php echo JsonEncode($patient_follow_up_add->DischargeAdviceMedicineTemplate->lookupOptions()) ?>;
...
<?php if ($patient_follow_up_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_follow_up_add->Token ?>">
<?php } ?>
...
<?php if ($patient_follow_up->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_follow_up_PatID" for="x_PatID" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_PatID" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->PatID->caption() ?><?php echo ($patient_follow_up->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->PatID->cellAttributes() ?>>
<script id="tpx_patient_follow_up_PatID" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_follow_up_PatientName" for="x_PatientName" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_PatientName" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->PatientName->caption() ?><?php echo ($patient_follow_up->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->PatientName->cellAttributes() ?>>
<script id="tpx_patient_follow_up_PatientName" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_patient_follow_up_MobileNumber" for="x_MobileNumber" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_MobileNumber" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->MobileNumber->caption() ?><?php echo ($patient_follow_up->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->MobileNumber->cellAttributes() ?>>
<script id="tpx_patient_follow_up_MobileNumber" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_follow_up_mrnno" for="x_mrnno" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_mrnno" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->mrnno->caption() ?><?php echo ($patient_follow_up->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->mrnno->cellAttributes() ?>>
<?php if ($patient_follow_up->mrnno->getSessionValue() <> "") { ?>
<script id="tpx_patient_follow_up_mrnno" class="patient_follow_upadd" type="text/html">
...
<input type="hidden" id="x_mrnno" name="x_mrnno" value="<?php echo HtmlEncode($patient_follow_up->mrnno->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_follow_up_mrnno" class="patient_follow_upadd" type="text/html">
<span id="el_patient_follow_up_mrnno">
<input type="text" data-table="patient_follow_up" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($patient_follow_up->mrnno->getPlaceHolder()) ?>" value="<?php echo $patient_follow_up->mrnno->EditValue ?>"<?php echo $patient_follow_up->mrnno->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_follow_up->BP->Visible) { // BP ?>
	<div id="r_BP" class="form-group row">
		<label id="elh_patient_follow_up_BP" for="x_BP" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_BP" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->BP->caption() ?><?php echo ($patient_follow_up->BP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->BP->cellAttributes() ?>>
<script id="tpx_patient_follow_up_BP" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Pulse->Visible) { // Pulse ?>
	<div id="r_Pulse" class="form-group row">
		<label id="elh_patient_follow_up_Pulse" for="x_Pulse" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Pulse" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Pulse->caption() ?><?php echo ($patient_follow_up->Pulse->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Pulse->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Pulse" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Resp->Visible) { // Resp ?>
	<div id="r_Resp" class="form-group row">
		<label id="elh_patient_follow_up_Resp" for="x_Resp" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Resp" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Resp->caption() ?><?php echo ($patient_follow_up->Resp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Resp->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Resp" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->SPO2->Visible) { // SPO2 ?>
	<div id="r_SPO2" class="form-group row">
		<label id="elh_patient_follow_up_SPO2" for="x_SPO2" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_SPO2" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->SPO2->caption() ?><?php echo ($patient_follow_up->SPO2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->SPO2->cellAttributes() ?>>
<script id="tpx_patient_follow_up_SPO2" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->FollowupAdvice->Visible) { // FollowupAdvice ?>
	<div id="r_FollowupAdvice" class="form-group row">
		<label id="elh_patient_follow_up_FollowupAdvice" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_FollowupAdvice" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->FollowupAdvice->caption() ?><?php echo ($patient_follow_up->FollowupAdvice->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->FollowupAdvice->cellAttributes() ?>>
<script id="tpx_patient_follow_up_FollowupAdvice" class="patient_follow_upadd" type="text/html">
...
ew.createEditor("fpatient_follow_upadd", "x_FollowupAdvice", 35, 25, <?php echo ($patient_follow_up->FollowupAdvice->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_follow_up->NextReviewDate->Visible) { // NextReviewDate ?>
	<div id="r_NextReviewDate" class="form-group row">
		<label id="elh_patient_follow_up_NextReviewDate" for="x_NextReviewDate" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_NextReviewDate" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->NextReviewDate->caption() ?><?php echo ($patient_follow_up->NextReviewDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->NextReviewDate->cellAttributes() ?>>
<script id="tpx_patient_follow_up_NextReviewDate" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_follow_up_Age" for="x_Age" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Age" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Age->caption() ?><?php echo ($patient_follow_up->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Age->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Age" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_follow_up_Gender" for="x_Gender" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Gender" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Gender->caption() ?><?php echo ($patient_follow_up->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Gender->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Gender" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_follow_up_profilePic" for="x_profilePic" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_profilePic" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->profilePic->caption() ?><?php echo ($patient_follow_up->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->profilePic->cellAttributes() ?>>
<script id="tpx_patient_follow_up_profilePic" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Template->Visible) { // Template ?>
	<div id="r_Template" class="form-group row">
		<label id="elh_patient_follow_up_Template" for="x_Template" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Template" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Template->caption() ?><?php echo ($patient_follow_up->Template->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Template->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Template" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->courseinhospital->Visible) { // courseinhospital ?>
	<div id="r_courseinhospital" class="form-group row">
		<label id="elh_patient_follow_up_courseinhospital" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_courseinhospital" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->courseinhospital->caption() ?><?php echo ($patient_follow_up->courseinhospital->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->courseinhospital->cellAttributes() ?>>
<script id="tpx_patient_follow_up_courseinhospital" class="patient_follow_upadd" type="text/html">
...
<script type="text/html" class="patient_follow_upadd_js">
ew.createEditor("fpatient_follow_upadd", "x_courseinhospital", 35, 4, <?php echo ($patient_follow_up->courseinhospital->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_follow_up->procedurenotes->Visible) { // procedurenotes ?>
	<div id="r_procedurenotes" class="form-group row">
		<label id="elh_patient_follow_up_procedurenotes" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_procedurenotes" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->procedurenotes->caption() ?><?php echo ($patient_follow_up->procedurenotes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->procedurenotes->cellAttributes() ?>>
<script id="tpx_patient_follow_up_procedurenotes" class="patient_follow_upadd" type="text/html">
...
<script type="text/html" class="patient_follow_upadd_js">
ew.createEditor("fpatient_follow_upadd", "x_procedurenotes", 35, 4, <?php echo ($patient_follow_up->procedurenotes->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_follow_up->conditionatdischarge->Visible) { // conditionatdischarge ?>
	<div id="r_conditionatdischarge" class="form-group row">
		<label id="elh_patient_follow_up_conditionatdischarge" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_conditionatdischarge" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->conditionatdischarge->caption() ?><?php echo ($patient_follow_up->conditionatdischarge->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->conditionatdischarge->cellAttributes() ?>>
<script id="tpx_patient_follow_up_conditionatdischarge" class="patient_follow_upadd" type="text/html">
...
<script type="text/html" class="patient_follow_upadd_js">
ew.createEditor("fpatient_follow_upadd", "x_conditionatdischarge", 35, 4, <?php echo ($patient_follow_up->conditionatdischarge->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_follow_up->Template1->Visible) { // Template1 ?>
	<div id="r_Template1" class="form-group row">
		<label id="elh_patient_follow_up_Template1" for="x_Template1" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Template1" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Template1->caption() ?><?php echo ($patient_follow_up->Template1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Template1->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Template1" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Template2->Visible) { // Template2 ?>
	<div id="r_Template2" class="form-group row">
		<label id="elh_patient_follow_up_Template2" for="x_Template2" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Template2" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Template2->caption() ?><?php echo ($patient_follow_up->Template2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Template2->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Template2" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Template3->Visible) { // Template3 ?>
	<div id="r_Template3" class="form-group row">
		<label id="elh_patient_follow_up_Template3" for="x_Template3" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Template3" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Template3->caption() ?><?php echo ($patient_follow_up->Template3->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Template3->cellAttributes() ?>>
<script id="tpx_patient_follow_up_Template3" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_follow_up_Reception" for="x_Reception" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_Reception" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->Reception->caption() ?><?php echo ($patient_follow_up->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->Reception->cellAttributes() ?>>
<?php if ($patient_follow_up->Reception->getSessionValue() <> "") { ?>
<script id="tpx_patient_follow_up_Reception" class="patient_follow_upadd" type="text/html">
...
<input type="hidden" id="x_Reception" name="x_Reception" value="<?php echo HtmlEncode($patient_follow_up->Reception->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_follow_up_Reception" class="patient_follow_upadd" type="text/html">
<span id="el_patient_follow_up_Reception">
<input type="text" data-table="patient_follow_up" data-field="x_Reception" name="x_Reception" id="x_Reception" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($patient_follow_up->Reception->getPlaceHolder()) ?>" value="<?php echo $patient_follow_up->Reception->EditValue ?>"<?php echo $patient_follow_up->Reception->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_follow_up->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_follow_up_PatientId" for="x_PatientId" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_PatientId" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->PatientId->caption() ?><?php echo ($patient_follow_up->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->PatientId->cellAttributes() ?>>
<?php if ($patient_follow_up->PatientId->getSessionValue() <> "") { ?>
<script id="tpx_patient_follow_up_PatientId" class="patient_follow_upadd" type="text/html">
...
<input type="hidden" id="x_PatientId" name="x_PatientId" value="<?php echo HtmlEncode($patient_follow_up->PatientId->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_patient_follow_up_PatientId" class="patient_follow_upadd" type="text/html">
<span id="el_patient_follow_up_PatientId">
<input type="text" data-table="patient_follow_up" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($patient_follow_up->PatientId->getPlaceHolder()) ?>" value="<?php echo $patient_follow_up->PatientId->EditValue ?>"<?php echo $patient_follow_up->PatientId->editAttributes() ?>>
</span>
</script>
<?php } ?>
...
<?php if ($patient_follow_up->PatientSearch->Visible) { // PatientSearch ?>
	<div id="r_PatientSearch" class="form-group row">
		<label id="elh_patient_follow_up_PatientSearch" for="x_PatientSearch" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_PatientSearch" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->PatientSearch->caption() ?><?php echo ($patient_follow_up->PatientSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->PatientSearch->cellAttributes() ?>>
<script id="tpx_patient_follow_up_PatientSearch" class="patient_follow_upadd" type="text/html">
...
<?php if ($patient_follow_up->DischargeAdviceMedicine->Visible) { // DischargeAdviceMedicine ?>
	<div id="r_DischargeAdviceMedicine" class="form-group row">
		<label id="elh_patient_follow_up_DischargeAdviceMedicine" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_DischargeAdviceMedicine" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->DischargeAdviceMedicine->caption() ?><?php echo ($patient_follow_up->DischargeAdviceMedicine->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->DischargeAdviceMedicine->cellAttributes() ?>>
<script id="tpx_patient_follow_up_DischargeAdviceMedicine" class="patient_follow_upadd" type="text/html">
...
<script type="text/html" class="patient_follow_upadd_js">
ew.createEditor("fpatient_follow_upadd", "x_DischargeAdviceMedicine", 35, 10, <?php echo ($patient_follow_up->DischargeAdviceMedicine->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($patient_follow_up->DischargeAdviceMedicineTemplate->Visible) { // DischargeAdviceMedicineTemplate ?>
	<div id="r_DischargeAdviceMedicineTemplate" class="form-group row">
		<label id="elh_patient_follow_up_DischargeAdviceMedicineTemplate" for="x_DischargeAdviceMedicineTemplate" class="<?php echo $patient_follow_up_add->LeftColumnClass ?>"><script id="tpc_patient_follow_up_DischargeAdviceMedicineTemplate" class="patient_follow_upadd" type="text/html"><span><?php echo $patient_follow_up->DischargeAdviceMedicineTemplate->caption() ?><?php echo ($patient_follow_up->DischargeAdviceMedicineTemplate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_follow_up_add->RightColumnClass ?>"><div<?php echo $patient_follow_up->DischargeAdviceMedicineTemplate->cellAttributes() ?>>
<script id="tpx_patient_follow_up_DischargeAdviceMedicineTemplate" class="patient_follow_upadd" type="text/html">
...
{{include tmpl="#tpc_patient_follow_up_PatientSearch"/}}&nbsp;{{include tmpl="#tpx_patient_follow_up_PatientSearch"/}}	
...
{{include tmpl="#tpc_patient_follow_up_Template1"/}}&nbsp;{{include tmpl="#tpx_patient_follow_up_Template1"/}}
<div class="row">
		 <div class="col-lg-12">
			<div class="card">             
			  <div class="card-body">
...
{{include tmpl="#tpc_patient_follow_up_Template2"/}}&nbsp;{{include tmpl="#tpx_patient_follow_up_Template2"/}}
<div class="row">
		 <div class="col-lg-12">
			<div class="card">             
			  <div class="card-body">
...
{{include tmpl="#tpc_patient_follow_up_Template3"/}}&nbsp;{{include tmpl="#tpx_patient_follow_up_Template3"/}}
<div class="row">
		 <div class="col-lg-12">
			<div class="card">             
			  <div class="card-body">
...
ew.applyTemplate("tpd_patient_follow_upadd", "tpm_patient_follow_upadd", "patient_follow_upadd", "<?php echo $patient_follow_up->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patient_follow_upadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
...
// document.write("page loaded");
 ...
 var c = document.getElementById("el_patient_follow_up_profilePic").children;
 var d = c[0].children;
