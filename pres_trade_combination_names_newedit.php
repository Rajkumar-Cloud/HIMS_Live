...
var fpres_trade_combination_names_newedit = currentForm = new ew.Form("fpres_trade_combination_names_newedit", "edit");
...
fpres_trade_combination_names_newedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpres_trade_combination_names_newedit.lists["x_Generic_Name"] = <?php echo $pres_trade_combination_names_new_edit->Generic_Name->Lookup->toClientList() ?>;
...
fpres_trade_combination_names_newedit.lists["x_Form"] = <?php echo $pres_trade_combination_names_new_edit->Form->Lookup->toClientList() ?>;
...
fpres_trade_combination_names_newedit.lists["x_Unit"] = <?php echo $pres_trade_combination_names_new_edit->Unit->Lookup->toClientList() ?>;
...
fpres_trade_combination_names_newedit.lists["x_TypeOfDrug"] = <?php echo $pres_trade_combination_names_new_edit->TypeOfDrug->Lookup->toClientList() ?>;
...
<?php if ($pres_trade_combination_names_new_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_trade_combination_names_new_edit->Token ?>">
<?php } ?>
...
<?php if ($pres_trade_combination_names_new->ID->Visible) { // ID ?>
	<div id="r_ID" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_ID" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->ID->caption() ?><?php echo ($pres_trade_combination_names_new->ID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->ID->cellAttributes() ?>>
...
<input type="hidden" data-table="pres_trade_combination_names_new" data-field="x_ID" name="x_ID" id="x_ID" value="<?php echo HtmlEncode($pres_trade_combination_names_new->ID->CurrentValue) ?>">
<?php echo $pres_trade_combination_names_new->ID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($pres_trade_combination_names_new->tradenames_id->Visible) { // tradenames_id ?>
	<div id="r_tradenames_id" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_tradenames_id" for="x_tradenames_id" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->tradenames_id->caption() ?><?php echo ($pres_trade_combination_names_new->tradenames_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->tradenames_id->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->Drug_Name->Visible) { // Drug_Name ?>
	<div id="r_Drug_Name" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_Drug_Name" for="x_Drug_Name" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->Drug_Name->caption() ?><?php echo ($pres_trade_combination_names_new->Drug_Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->Drug_Name->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->Generic_Name->Visible) { // Generic_Name ?>
	<div id="r_Generic_Name" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_Generic_Name" for="x_Generic_Name" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->Generic_Name->caption() ?><?php echo ($pres_trade_combination_names_new->Generic_Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->Generic_Name->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->Trade_Name->Visible) { // Trade_Name ?>
	<div id="r_Trade_Name" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_Trade_Name" for="x_Trade_Name" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->Trade_Name->caption() ?><?php echo ($pres_trade_combination_names_new->Trade_Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->Trade_Name->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->PR_CODE->Visible) { // PR_CODE ?>
	<div id="r_PR_CODE" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_PR_CODE" for="x_PR_CODE" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->PR_CODE->caption() ?><?php echo ($pres_trade_combination_names_new->PR_CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->PR_CODE->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_Form" for="x_Form" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->Form->caption() ?><?php echo ($pres_trade_combination_names_new->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->Form->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->Unit->Visible) { // Unit ?>
	<div id="r_Unit" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_Unit" for="x_Unit" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->Unit->caption() ?><?php echo ($pres_trade_combination_names_new->Unit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->Unit->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->CONTAINER_TYPE->Visible) { // CONTAINER_TYPE ?>
	<div id="r_CONTAINER_TYPE" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_CONTAINER_TYPE" for="x_CONTAINER_TYPE" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->CONTAINER_TYPE->caption() ?><?php echo ($pres_trade_combination_names_new->CONTAINER_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->CONTAINER_TYPE->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->CONTAINER_STRENGTH->Visible) { // CONTAINER_STRENGTH ?>
	<div id="r_CONTAINER_STRENGTH" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_CONTAINER_STRENGTH" for="x_CONTAINER_STRENGTH" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->CONTAINER_STRENGTH->caption() ?><?php echo ($pres_trade_combination_names_new->CONTAINER_STRENGTH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->CONTAINER_STRENGTH->cellAttributes() ?>>
...
<?php if ($pres_trade_combination_names_new->TypeOfDrug->Visible) { // TypeOfDrug ?>
	<div id="r_TypeOfDrug" class="form-group row">
		<label id="elh_pres_trade_combination_names_new_TypeOfDrug" for="x_TypeOfDrug" class="<?php echo $pres_trade_combination_names_new_edit->LeftColumnClass ?>"><?php echo $pres_trade_combination_names_new->TypeOfDrug->caption() ?><?php echo ($pres_trade_combination_names_new->TypeOfDrug->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_trade_combination_names_new_edit->RightColumnClass ?>"><div<?php echo $pres_trade_combination_names_new->TypeOfDrug->cellAttributes() ?>>
