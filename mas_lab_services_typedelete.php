...
var fmas_lab_services_typedelete = currentForm = new ew.Form("fmas_lab_services_typedelete", "delete");

// Form_CustomValidate event
fmas_lab_services_typedelete.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fmas_lab_services_typedelete.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($mas_lab_services_type_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_lab_services_type_delete->Token ?>">
<?php } ?>
...
<?php if ($mas_lab_services_type->id->Visible) { // id ?>
		<th class="<?php echo $mas_lab_services_type->id->headerCellClass() ?>"><span id="elh_mas_lab_services_type_id" class="mas_lab_services_type_id"><?php echo $mas_lab_services_type->id->caption() ?></span></th>
<?php } ?>
<?php if ($mas_lab_services_type->name->Visible) { // name ?>
		<th class="<?php echo $mas_lab_services_type->name->headerCellClass() ?>"><span id="elh_mas_lab_services_type_name" class="mas_lab_services_type_name"><?php echo $mas_lab_services_type->name->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$mas_lab_services_type_delete->RecCnt = 0;
$i = 0;
while (!$mas_lab_services_type_delete->Recordset->EOF) {
	$mas_lab_services_type_delete->RecCnt++;
	$mas_lab_services_type_delete->RowCnt++;
...
<?php if ($mas_lab_services_type->id->Visible) { // id ?>
		<td<?php echo $mas_lab_services_type->id->cellAttributes() ?>>
<span id="el<?php echo $mas_lab_services_type_delete->RowCnt ?>_mas_lab_services_type_id" class="mas_lab_services_type_id">
...
<?php } ?>
<?php if ($mas_lab_services_type->name->Visible) { // name ?>
		<td<?php echo $mas_lab_services_type->name->cellAttributes() ?>>
<span id="el<?php echo $mas_lab_services_type_delete->RowCnt ?>_mas_lab_services_type_name" class="mas_lab_services_type_name">
