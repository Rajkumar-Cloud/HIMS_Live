...
// Create page object
$crm_contactsubdetails_add = new crm_contactsubdetails_add();

// Run the page
$crm_contactsubdetails_add->run();
...
$crm_contactsubdetails_add->Page_Render();
?>
...
var fcrm_contactsubdetailsadd = currentForm = new ew.Form("fcrm_contactsubdetailsadd", "add");

// Validate form
fcrm_contactsubdetailsadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($crm_contactsubdetails_add->contactsubscriptionid->Required) { ?>
		...
		<?php if ($crm_contactsubdetails_add->birthday->Required) { ?>
		...
		<?php if ($crm_contactsubdetails_add->laststayintouchrequest->Required) { ?>
		...
		<?php if ($crm_contactsubdetails_add->laststayintouchsavedate->Required) { ?>
		...
		<?php if ($crm_contactsubdetails_add->leadsource->Required) { ?>
...
fcrm_contactsubdetailsadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcrm_contactsubdetailsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $crm_contactsubdetails_add->showPageHeader(); ?>
<?php
$crm_contactsubdetails_add->showMessage();
?>
<form name="fcrm_contactsubdetailsadd" id="fcrm_contactsubdetailsadd" class="<?php echo $crm_contactsubdetails_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($crm_contactsubdetails_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $crm_contactsubdetails_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="crm_contactsubdetails">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$crm_contactsubdetails_add->IsModal ?>">
...
<?php if ($crm_contactsubdetails->contactsubscriptionid->Visible) { // contactsubscriptionid ?>
	<div id="r_contactsubscriptionid" class="form-group row">
		<label id="elh_crm_contactsubdetails_contactsubscriptionid" for="x_contactsubscriptionid" class="<?php echo $crm_contactsubdetails_add->LeftColumnClass ?>"><?php echo $crm_contactsubdetails->contactsubscriptionid->caption() ?><?php echo ($crm_contactsubdetails->contactsubscriptionid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactsubdetails_add->RightColumnClass ?>"><div<?php echo $crm_contactsubdetails->contactsubscriptionid->cellAttributes() ?>>
<span id="el_crm_contactsubdetails_contactsubscriptionid">
<input type="text" data-table="crm_contactsubdetails" data-field="x_contactsubscriptionid" name="x_contactsubscriptionid" id="x_contactsubscriptionid" size="30" placeholder="<?php echo HtmlEncode($crm_contactsubdetails->contactsubscriptionid->getPlaceHolder()) ?>" value="<?php echo $crm_contactsubdetails->contactsubscriptionid->EditValue ?>"<?php echo $crm_contactsubdetails->contactsubscriptionid->editAttributes() ?>>
</span>
...
<?php if ($crm_contactsubdetails->birthday->Visible) { // birthday ?>
	<div id="r_birthday" class="form-group row">
		<label id="elh_crm_contactsubdetails_birthday" for="x_birthday" class="<?php echo $crm_contactsubdetails_add->LeftColumnClass ?>"><?php echo $crm_contactsubdetails->birthday->caption() ?><?php echo ($crm_contactsubdetails->birthday->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactsubdetails_add->RightColumnClass ?>"><div<?php echo $crm_contactsubdetails->birthday->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fcrm_contactsubdetailsadd", "x_birthday", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($crm_contactsubdetails->laststayintouchsavedate->Visible) { // laststayintouchsavedate ?>
	<div id="r_laststayintouchsavedate" class="form-group row">
		<label id="elh_crm_contactsubdetails_laststayintouchsavedate" for="x_laststayintouchsavedate" class="<?php echo $crm_contactsubdetails_add->LeftColumnClass ?>"><?php echo $crm_contactsubdetails->laststayintouchsavedate->caption() ?><?php echo ($crm_contactsubdetails->laststayintouchsavedate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactsubdetails_add->RightColumnClass ?>"><div<?php echo $crm_contactsubdetails->laststayintouchsavedate->cellAttributes() ?>>
...
<?php if ($crm_contactsubdetails->leadsource->Visible) { // leadsource ?>
	<div id="r_leadsource" class="form-group row">
		<label id="elh_crm_contactsubdetails_leadsource" for="x_leadsource" class="<?php echo $crm_contactsubdetails_add->LeftColumnClass ?>"><?php echo $crm_contactsubdetails->leadsource->caption() ?><?php echo ($crm_contactsubdetails->leadsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $crm_contactsubdetails_add->RightColumnClass ?>"><div<?php echo $crm_contactsubdetails->leadsource->cellAttributes() ?>>
...
<?php if (!$crm_contactsubdetails_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $crm_contactsubdetails_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $crm_contactsubdetails_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$crm_contactsubdetails_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$crm_contactsubdetails_add->terminate();
?>