...
var fview_appointment_scheduler_newadd = currentForm = new ew.Form("fview_appointment_scheduler_newadd", "add");
...
fview_appointment_scheduler_newadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_appointment_scheduler_newadd.lists["x_Referal"] = <?php echo $view_appointment_scheduler_new_add->Referal->Lookup->toClientList() ?>;
...
fview_appointment_scheduler_newadd.lists["x_DoctorName"] = <?php echo $view_appointment_scheduler_new_add->DoctorName->Lookup->toClientList() ?>;
...
<?php if ($view_appointment_scheduler_new_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_appointment_scheduler_new_add->Token ?>">
<?php } ?>
...
<?php if ($view_appointment_scheduler_new->patientID->Visible) { // patientID ?>
	<div id="r_patientID" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_patientID" for="x_patientID" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->patientID->caption() ?><?php echo ($view_appointment_scheduler_new->patientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->patientID->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->patientName->Visible) { // patientName ?>
	<div id="r_patientName" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_patientName" for="x_patientName" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->patientName->caption() ?><?php echo ($view_appointment_scheduler_new->patientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->patientName->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_MobileNumber" for="x_MobileNumber" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->MobileNumber->caption() ?><?php echo ($view_appointment_scheduler_new->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->MobileNumber->cellAttributes() ?>>
...
<?php } ?>
<?php if (!$view_appointment_scheduler_new->start_time->ReadOnly && !$view_appointment_scheduler_new->start_time->Disabled && !isset($view_appointment_scheduler_new->start_time->EditAttrs["readonly"]) && !isset($view_appointment_scheduler_new->start_time->EditAttrs["disabled"])) { ?>
<script>ew.createTimePicker("fview_appointment_scheduler_newadd", "x_start_time", {"timeFormat":"h:i A","step":15});</script><?php } ?>
</span>
...
<?php if ($view_appointment_scheduler_new->Purpose->Visible) { // Purpose ?>
	<div id="r_Purpose" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_Purpose" for="x_Purpose" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->Purpose->caption() ?><?php echo ($view_appointment_scheduler_new->Purpose->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->Purpose->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->patienttype->Visible) { // patienttype ?>
	<div id="r_patienttype" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_patienttype" for="x_patienttype" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->patienttype->caption() ?><?php echo ($view_appointment_scheduler_new->patienttype->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->patienttype->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->Referal->Visible) { // Referal ?>
	<div id="r_Referal" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_Referal" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->Referal->caption() ?><?php echo ($view_appointment_scheduler_new->Referal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->Referal->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->start_date->Visible) { // start_date ?>
	<div id="r_start_date" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_start_date" for="x_start_date" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->start_date->caption() ?><?php echo ($view_appointment_scheduler_new->start_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->start_date->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->DoctorName->Visible) { // DoctorName ?>
	<div id="r_DoctorName" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_DoctorName" for="x_DoctorName" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->DoctorName->caption() ?><?php echo ($view_appointment_scheduler_new->DoctorName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->DoctorName->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->HospID->Visible) { // HospID ?>
	<div id="r_HospID" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_HospID" for="x_HospID" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->HospID->caption() ?><?php echo ($view_appointment_scheduler_new->HospID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->HospID->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->PatientTypee->Visible) { // PatientTypee ?>
	<div id="r_PatientTypee" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_PatientTypee" for="x_PatientTypee" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->PatientTypee->caption() ?><?php echo ($view_appointment_scheduler_new->PatientTypee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->PatientTypee->cellAttributes() ?>>
...
<?php if ($view_appointment_scheduler_new->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh_view_appointment_scheduler_new_Notes" for="x_Notes" class="<?php echo $view_appointment_scheduler_new_add->LeftColumnClass ?>"><?php echo $view_appointment_scheduler_new->Notes->caption() ?><?php echo ($view_appointment_scheduler_new->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_appointment_scheduler_new_add->RightColumnClass ?>"><div<?php echo $view_appointment_scheduler_new->Notes->cellAttributes() ?>>
