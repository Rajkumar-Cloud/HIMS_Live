...
var fpres_categoryallergyadd = currentForm = new ew.Form("fpres_categoryallergyadd", "add");
...
fpres_categoryallergyadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_categoryallergy_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_categoryallergy_add->Token ?>">
<?php } ?>
...
<?php if ($pres_categoryallergy->Genericname->Visible) { // Genericname ?>
	<div id="r_Genericname" class="form-group row">
		<label id="elh_pres_categoryallergy_Genericname" for="x_Genericname" class="<?php echo $pres_categoryallergy_add->LeftColumnClass ?>"><?php echo $pres_categoryallergy->Genericname->caption() ?><?php echo ($pres_categoryallergy->Genericname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_categoryallergy_add->RightColumnClass ?>"><div<?php echo $pres_categoryallergy->Genericname->cellAttributes() ?>>
...
<?php if ($pres_categoryallergy->CategoryDrug->Visible) { // CategoryDrug ?>
	<div id="r_CategoryDrug" class="form-group row">
		<label id="elh_pres_categoryallergy_CategoryDrug" for="x_CategoryDrug" class="<?php echo $pres_categoryallergy_add->LeftColumnClass ?>"><?php echo $pres_categoryallergy->CategoryDrug->caption() ?><?php echo ($pres_categoryallergy->CategoryDrug->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_categoryallergy_add->RightColumnClass ?>"><div<?php echo $pres_categoryallergy->CategoryDrug->cellAttributes() ?>>
