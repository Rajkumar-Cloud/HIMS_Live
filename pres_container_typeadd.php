...
var fpres_container_typeadd = currentForm = new ew.Form("fpres_container_typeadd", "add");
...
fpres_container_typeadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_container_type_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_container_type_add->Token ?>">
<?php } ?>
...
<?php if ($pres_container_type->Container->Visible) { // Container ?>
	<div id="r_Container" class="form-group row">
		<label id="elh_pres_container_type_Container" for="x_Container" class="<?php echo $pres_container_type_add->LeftColumnClass ?>"><?php echo $pres_container_type->Container->caption() ?><?php echo ($pres_container_type->Container->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_container_type_add->RightColumnClass ?>"><div<?php echo $pres_container_type->Container->cellAttributes() ?>>
