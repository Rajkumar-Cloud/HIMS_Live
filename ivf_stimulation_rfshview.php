...
var fivf_stimulation_rfshview = currentForm = new ew.Form("fivf_stimulation_rfshview", "view");

// Form_CustomValidate event
fivf_stimulation_rfshview.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fivf_stimulation_rfshview.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($ivf_stimulation_rfsh_view->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_stimulation_rfsh_view->Token ?>">
<?php } ?>
...
<?php if ($ivf_stimulation_rfsh->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="<?php echo $ivf_stimulation_rfsh_view->TableLeftColumnClass ?>"><span id="elh_ivf_stimulation_rfsh_id"><?php echo $ivf_stimulation_rfsh->id->caption() ?></span></td>
...
<?php if ($ivf_stimulation_rfsh->Name->Visible) { // Name ?>
	<tr id="r_Name">
		<td class="<?php echo $ivf_stimulation_rfsh_view->TableLeftColumnClass ?>"><span id="elh_ivf_stimulation_rfsh_Name"><?php echo $ivf_stimulation_rfsh->Name->caption() ?></span></td>
