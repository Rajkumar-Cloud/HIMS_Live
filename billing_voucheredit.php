...
var fbilling_voucheredit = currentForm = new ew.Form("fbilling_voucheredit", "edit");
...
fbilling_voucheredit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($billing_voucher_edit->CardType->Required) { ?>
		...
		<?php } ?>
		<?php if ($billing_voucher_edit->PharmacyBill->Required) { ?>
		...
		<?php } ?>
		<?php if ($billing_voucher_edit->DiscountAmount->Required) { ?>
		...
		<?php if ($billing_voucher_edit->Cash->Required) { ?>
		...
		<?php if ($billing_voucher_edit->Card->Required) { ?>
...
fbilling_voucheredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fbilling_voucheredit.lists["x_Reception"] = <?php echo $billing_voucher_edit->Reception->Lookup->toClientList() ?>;
fbilling_voucheredit.lists["x_Reception"].options = <?php echo JsonEncode($billing_voucher_edit->Reception->lookupOptions()) ?>;
fbilling_voucheredit.lists["x_Doctor"] = <?php echo $billing_voucher_edit->Doctor->Lookup->toClientList() ?>;
...
fbilling_voucheredit.lists["x_voucher_type"] = <?php echo $billing_voucher_edit->voucher_type->Lookup->toClientList() ?>;
fbilling_voucheredit.lists["x_voucher_type"].options = <?php echo JsonEncode($billing_voucher_edit->voucher_type->lookupOptions()) ?>;
fbilling_voucheredit.lists["x_ModeofPayment"] = <?php echo $billing_voucher_edit->ModeofPayment->Lookup->toClientList() ?>;
...
<?php if ($billing_voucher_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $billing_voucher_edit->Token ?>">
<?php } ?>
...
<?php if ($billing_voucher->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_billing_voucher_id" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_id" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->id->caption() ?><?php echo ($billing_voucher->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->id->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_id" class="billing_voucheredit" type="text/html">
...
<input type="hidden" data-table="billing_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($billing_voucher->id->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_voucher_id" class="billing_voucheredit" type="text/html">
<span id="el_billing_voucher_id">
<span<?php echo $billing_voucher->id->viewAttributes() ?>>
...
<input type="hidden" data-table="billing_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($billing_voucher->id->FormValue) ?>">
<?php } ?>
<?php echo $billing_voucher->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($billing_voucher->PatId->Visible) { // PatId ?>
	<div id="r_PatId" class="form-group row">
		<label id="elh_billing_voucher_PatId" for="x_PatId" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_PatId" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->PatId->caption() ?><?php echo ($billing_voucher->PatId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->PatId->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_PatId" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_billing_voucher_Reception" for="x_Reception" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Reception" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Reception->caption() ?><?php echo ($billing_voucher->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Reception->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Reception" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->BillNumber->Visible) { // BillNumber ?>
	<div id="r_BillNumber" class="form-group row">
		<label id="elh_billing_voucher_BillNumber" for="x_BillNumber" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_BillNumber" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->BillNumber->caption() ?><?php echo ($billing_voucher->BillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->BillNumber->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_BillNumber" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_billing_voucher_PatientId" for="x_PatientId" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_PatientId" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->PatientId->caption() ?><?php echo ($billing_voucher->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->PatientId->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_PatientId" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_billing_voucher_mrnno" for="x_mrnno" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_mrnno" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->mrnno->caption() ?><?php echo ($billing_voucher->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->mrnno->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_mrnno" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_billing_voucher_PatientName" for="x_PatientName" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_PatientName" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->PatientName->caption() ?><?php echo ($billing_voucher->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->PatientName->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_PatientName" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_billing_voucher_Age" for="x_Age" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Age" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Age->caption() ?><?php echo ($billing_voucher->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Age->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Age" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_billing_voucher_Gender" for="x_Gender" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Gender" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Gender->caption() ?><?php echo ($billing_voucher->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Gender->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Gender" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_billing_voucher_profilePic" for="x_profilePic" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_profilePic" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->profilePic->caption() ?><?php echo ($billing_voucher->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->profilePic->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_profilePic" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_billing_voucher_Mobile" for="x_Mobile" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Mobile" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Mobile->caption() ?><?php echo ($billing_voucher->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Mobile->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Mobile" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->IP_OP->Visible) { // IP_OP ?>
	<div id="r_IP_OP" class="form-group row">
		<label id="elh_billing_voucher_IP_OP" for="x_IP_OP" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_IP_OP" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->IP_OP->caption() ?><?php echo ($billing_voucher->IP_OP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->IP_OP->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_IP_OP" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Doctor->Visible) { // Doctor ?>
	<div id="r_Doctor" class="form-group row">
		<label id="elh_billing_voucher_Doctor" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Doctor" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Doctor->caption() ?><?php echo ($billing_voucher->Doctor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Doctor->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Doctor" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_billing_voucher_voucher_type" for="x_voucher_type" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_voucher_type" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->voucher_type->caption() ?><?php echo ($billing_voucher->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->voucher_type->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_voucher_type" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_billing_voucher_Details" for="x_Details" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Details" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Details->caption() ?><?php echo ($billing_voucher->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Details->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Details" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_billing_voucher_ModeofPayment" for="x_ModeofPayment" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_ModeofPayment" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->ModeofPayment->caption() ?><?php echo ($billing_voucher->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->ModeofPayment->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_ModeofPayment" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_billing_voucher_Amount" for="x_Amount" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Amount" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Amount->caption() ?><?php echo ($billing_voucher->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Amount->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Amount" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_billing_voucher_AnyDues" for="x_AnyDues" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_AnyDues" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->AnyDues->caption() ?><?php echo ($billing_voucher->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->AnyDues->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_AnyDues" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		<label id="elh_billing_voucher_RealizationAmount" for="x_RealizationAmount" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RealizationAmount" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RealizationAmount->caption() ?><?php echo ($billing_voucher->RealizationAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RealizationAmount->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RealizationAmount" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		<label id="elh_billing_voucher_RealizationStatus" for="x_RealizationStatus" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RealizationStatus" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RealizationStatus->caption() ?><?php echo ($billing_voucher->RealizationStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RealizationStatus->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RealizationStatus" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		<label id="elh_billing_voucher_RealizationRemarks" for="x_RealizationRemarks" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RealizationRemarks" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RealizationRemarks->caption() ?><?php echo ($billing_voucher->RealizationRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RealizationRemarks->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RealizationRemarks" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		<label id="elh_billing_voucher_RealizationBatchNo" for="x_RealizationBatchNo" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RealizationBatchNo" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RealizationBatchNo->caption() ?><?php echo ($billing_voucher->RealizationBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RealizationBatchNo->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RealizationBatchNo" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		<label id="elh_billing_voucher_RealizationDate" for="x_RealizationDate" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RealizationDate" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RealizationDate->caption() ?><?php echo ($billing_voucher->RealizationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RealizationDate->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RealizationDate" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_billing_voucher_RIDNO" for="x_RIDNO" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RIDNO" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RIDNO->caption() ?><?php echo ($billing_voucher->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RIDNO->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RIDNO" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_billing_voucher_TidNo" for="x_TidNo" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_TidNo" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->TidNo->caption() ?><?php echo ($billing_voucher->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->TidNo->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_TidNo" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_billing_voucher_CId" for="x_CId" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CId" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CId->caption() ?><?php echo ($billing_voucher->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CId->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CId" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_billing_voucher_PartnerName" for="x_PartnerName" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_PartnerName" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->PartnerName->caption() ?><?php echo ($billing_voucher->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->PartnerName->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_PartnerName" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->PayerType->Visible) { // PayerType ?>
	<div id="r_PayerType" class="form-group row">
		<label id="elh_billing_voucher_PayerType" for="x_PayerType" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_PayerType" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->PayerType->caption() ?><?php echo ($billing_voucher->PayerType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->PayerType->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_PayerType" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Dob->Visible) { // Dob ?>
	<div id="r_Dob" class="form-group row">
		<label id="elh_billing_voucher_Dob" for="x_Dob" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Dob" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Dob->caption() ?><?php echo ($billing_voucher->Dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Dob->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Dob" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_billing_voucher_Currency" for="x_Currency" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Currency" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Currency->caption() ?><?php echo ($billing_voucher->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Currency->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Currency" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->DiscountRemarks->Visible) { // DiscountRemarks ?>
	<div id="r_DiscountRemarks" class="form-group row">
		<label id="elh_billing_voucher_DiscountRemarks" for="x_DiscountRemarks" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_DiscountRemarks" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->DiscountRemarks->caption() ?><?php echo ($billing_voucher->DiscountRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->DiscountRemarks->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_DiscountRemarks" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_billing_voucher_Remarks" for="x_Remarks" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Remarks" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Remarks->caption() ?><?php echo ($billing_voucher->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Remarks->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Remarks" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->DrDepartment->Visible) { // DrDepartment ?>
	<div id="r_DrDepartment" class="form-group row">
		<label id="elh_billing_voucher_DrDepartment" for="x_DrDepartment" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_DrDepartment" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->DrDepartment->caption() ?><?php echo ($billing_voucher->DrDepartment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->DrDepartment->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_DrDepartment" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->RefferedBy->Visible) { // RefferedBy ?>
	<div id="r_RefferedBy" class="form-group row">
		<label id="elh_billing_voucher_RefferedBy" for="x_RefferedBy" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_RefferedBy" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->RefferedBy->caption() ?><?php echo ($billing_voucher->RefferedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->RefferedBy->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_RefferedBy" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_billing_voucher_CardNumber" for="x_CardNumber" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CardNumber" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CardNumber->caption() ?><?php echo ($billing_voucher->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CardNumber->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CardNumber" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_billing_voucher_BankName" for="x_BankName" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_BankName" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->BankName->caption() ?><?php echo ($billing_voucher->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->BankName->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_BankName" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_billing_voucher_DrID" for="x_DrID" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_DrID" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->DrID->caption() ?><?php echo ($billing_voucher->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->DrID->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_DrID" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->BillStatus->Visible) { // BillStatus ?>
	<div id="r_BillStatus" class="form-group row">
		<label id="elh_billing_voucher_BillStatus" for="x_BillStatus" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_BillStatus" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->BillStatus->caption() ?><?php echo ($billing_voucher->BillStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->BillStatus->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_BillStatus" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->ReportHeader->Visible) { // ReportHeader ?>
	<div id="r_ReportHeader" class="form-group row">
		<label id="elh_billing_voucher_ReportHeader" for="x_ReportHeader" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_ReportHeader" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->ReportHeader->caption() ?><?php echo ($billing_voucher->ReportHeader->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->ReportHeader->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_ReportHeader" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->AdjustmentAdvance->Visible) { // AdjustmentAdvance ?>
	<div id="r_AdjustmentAdvance" class="form-group row">
		<label id="elh_billing_voucher_AdjustmentAdvance" for="x_AdjustmentAdvance" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_AdjustmentAdvance" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->AdjustmentAdvance->caption() ?><?php echo ($billing_voucher->AdjustmentAdvance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->AdjustmentAdvance->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_AdjustmentAdvance" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->billing_vouchercol->Visible) { // billing_vouchercol ?>
	<div id="r_billing_vouchercol" class="form-group row">
		<label id="elh_billing_voucher_billing_vouchercol" for="x_billing_vouchercol" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_billing_vouchercol" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->billing_vouchercol->caption() ?><?php echo ($billing_voucher->billing_vouchercol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->billing_vouchercol->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_billing_vouchercol" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->BillType->Visible) { // BillType ?>
	<div id="r_BillType" class="form-group row">
		<label id="elh_billing_voucher_BillType" for="x_BillType" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_BillType" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->BillType->caption() ?><?php echo ($billing_voucher->BillType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->BillType->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_BillType" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->ProcedureName->Visible) { // ProcedureName ?>
	<div id="r_ProcedureName" class="form-group row">
		<label id="elh_billing_voucher_ProcedureName" for="x_ProcedureName" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_ProcedureName" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->ProcedureName->caption() ?><?php echo ($billing_voucher->ProcedureName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->ProcedureName->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_ProcedureName" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->ProcedureAmount->Visible) { // ProcedureAmount ?>
	<div id="r_ProcedureAmount" class="form-group row">
		<label id="elh_billing_voucher_ProcedureAmount" for="x_ProcedureAmount" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_ProcedureAmount" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->ProcedureAmount->caption() ?><?php echo ($billing_voucher->ProcedureAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->ProcedureAmount->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_ProcedureAmount" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->IncludePackage->Visible) { // IncludePackage ?>
	<div id="r_IncludePackage" class="form-group row">
		<label id="elh_billing_voucher_IncludePackage" for="x_IncludePackage" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_IncludePackage" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->IncludePackage->caption() ?><?php echo ($billing_voucher->IncludePackage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->IncludePackage->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_IncludePackage" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CancelBill->Visible) { // CancelBill ?>
	<div id="r_CancelBill" class="form-group row">
		<label id="elh_billing_voucher_CancelBill" for="x_CancelBill" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CancelBill" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CancelBill->caption() ?><?php echo ($billing_voucher->CancelBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CancelBill->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CancelBill" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CancelReason->Visible) { // CancelReason ?>
	<div id="r_CancelReason" class="form-group row">
		<label id="elh_billing_voucher_CancelReason" for="x_CancelReason" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CancelReason" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CancelReason->caption() ?><?php echo ($billing_voucher->CancelReason->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CancelReason->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CancelReason" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CancelModeOfPayment->Visible) { // CancelModeOfPayment ?>
	<div id="r_CancelModeOfPayment" class="form-group row">
		<label id="elh_billing_voucher_CancelModeOfPayment" for="x_CancelModeOfPayment" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CancelModeOfPayment" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CancelModeOfPayment->caption() ?><?php echo ($billing_voucher->CancelModeOfPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CancelModeOfPayment->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CancelModeOfPayment" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CancelAmount->Visible) { // CancelAmount ?>
	<div id="r_CancelAmount" class="form-group row">
		<label id="elh_billing_voucher_CancelAmount" for="x_CancelAmount" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CancelAmount" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CancelAmount->caption() ?><?php echo ($billing_voucher->CancelAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CancelAmount->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CancelAmount" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CancelBankName->Visible) { // CancelBankName ?>
	<div id="r_CancelBankName" class="form-group row">
		<label id="elh_billing_voucher_CancelBankName" for="x_CancelBankName" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CancelBankName" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CancelBankName->caption() ?><?php echo ($billing_voucher->CancelBankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CancelBankName->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CancelBankName" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CancelTransactionNumber->Visible) { // CancelTransactionNumber ?>
	<div id="r_CancelTransactionNumber" class="form-group row">
		<label id="elh_billing_voucher_CancelTransactionNumber" for="x_CancelTransactionNumber" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CancelTransactionNumber" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CancelTransactionNumber->caption() ?><?php echo ($billing_voucher->CancelTransactionNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CancelTransactionNumber->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CancelTransactionNumber" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->LabTest->Visible) { // LabTest ?>
	<div id="r_LabTest" class="form-group row">
		<label id="elh_billing_voucher_LabTest" for="x_LabTest" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_LabTest" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->LabTest->caption() ?><?php echo ($billing_voucher->LabTest->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->LabTest->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_LabTest" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->sid->Visible) { // sid ?>
	<div id="r_sid" class="form-group row">
		<label id="elh_billing_voucher_sid" for="x_sid" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_sid" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->sid->caption() ?><?php echo ($billing_voucher->sid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->sid->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_sid" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->SidNo->Visible) { // SidNo ?>
	<div id="r_SidNo" class="form-group row">
		<label id="elh_billing_voucher_SidNo" for="x_SidNo" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_SidNo" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->SidNo->caption() ?><?php echo ($billing_voucher->SidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->SidNo->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_SidNo" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->LabTestReleased->Visible) { // LabTestReleased ?>
	<div id="r_LabTestReleased" class="form-group row">
		<label id="elh_billing_voucher_LabTestReleased" for="x_LabTestReleased" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_LabTestReleased" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->LabTestReleased->caption() ?><?php echo ($billing_voucher->LabTestReleased->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->LabTestReleased->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_LabTestReleased" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->GoogleReviewID->Visible) { // GoogleReviewID ?>
	<div id="r_GoogleReviewID" class="form-group row">
		<label id="elh_billing_voucher_GoogleReviewID" for="x_GoogleReviewID" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_GoogleReviewID" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->GoogleReviewID->caption() ?><?php echo ($billing_voucher->GoogleReviewID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->GoogleReviewID->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_GoogleReviewID" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->CardType->Visible) { // CardType ?>
	<div id="r_CardType" class="form-group row">
		<label id="elh_billing_voucher_CardType" for="x_CardType" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_CardType" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->CardType->caption() ?><?php echo ($billing_voucher->CardType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->CardType->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_CardType" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->PharmacyBill->Visible) { // PharmacyBill ?>
	<div id="r_PharmacyBill" class="form-group row">
		<label id="elh_billing_voucher_PharmacyBill" for="x_PharmacyBill" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_PharmacyBill" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->PharmacyBill->caption() ?><?php echo ($billing_voucher->PharmacyBill->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->PharmacyBill->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_PharmacyBill" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->DiscountAmount->Visible) { // DiscountAmount ?>
	<div id="r_DiscountAmount" class="form-group row">
		<label id="elh_billing_voucher_DiscountAmount" for="x_DiscountAmount" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_DiscountAmount" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->DiscountAmount->caption() ?><?php echo ($billing_voucher->DiscountAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->DiscountAmount->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_DiscountAmount" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Cash->Visible) { // Cash ?>
	<div id="r_Cash" class="form-group row">
		<label id="elh_billing_voucher_Cash" for="x_Cash" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Cash" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Cash->caption() ?><?php echo ($billing_voucher->Cash->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Cash->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Cash" class="billing_voucheredit" type="text/html">
...
<?php if ($billing_voucher->Card->Visible) { // Card ?>
	<div id="r_Card" class="form-group row">
		<label id="elh_billing_voucher_Card" for="x_Card" class="<?php echo $billing_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_voucher_Card" class="billing_voucheredit" type="text/html"><span><?php echo $billing_voucher->Card->caption() ?><?php echo ($billing_voucher->Card->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_voucher->Card->cellAttributes() ?>>
<?php if (!$billing_voucher->isConfirm()) { ?>
<script id="tpx_billing_voucher_Card" class="billing_voucheredit" type="text/html">
...
ew.applyTemplate("tpd_billing_voucheredit", "tpm_billing_voucheredit", "billing_voucheredit", "<?php echo $billing_voucher->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.billing_voucheredit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
