...
var fpatient_provisional_diagnosislist = currentForm = new ew.Form("fpatient_provisional_diagnosislist", "list");
fpatient_provisional_diagnosislist.formKeyCountName = '<?php echo $patient_provisional_diagnosis_list->FormKeyCountName ?>';

// Form_CustomValidate event
fpatient_provisional_diagnosislist.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fpatient_provisional_diagnosislist.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
// Form object for search

var fpatient_provisional_diagnosislistsrch = currentSearchForm = new ew.Form("fpatient_provisional_diagnosislistsrch");
...
<?php if ($patient_provisional_diagnosis_list->TotalRecs > 0 && $patient_provisional_diagnosis_list->ExportOptions->visible()) { ?>
...
<?php } ?>
<?php if (!$patient_provisional_diagnosis->isExport() || EXPORT_MASTER_RECORD && $patient_provisional_diagnosis->isExport("print")) { ?>
<?php
...
<?php if (!$patient_provisional_diagnosis->isExport() && !$patient_provisional_diagnosis->CurrentAction) { ?>
...
<?php $searchPanelClass = ($patient_provisional_diagnosis_list->SearchWhere <> "") ? " show" : " show"; ?>
<div id="fpatient_provisional_diagnosislistsrch-search-panel" class="ew-search-panel collapse<?php echo $searchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="patient_provisional_diagnosis">
	<div class="ew-basic-search">
<div id="xsr_1" class="ew-row d-sm-flex">
	<div class="ew-quick-search input-group">
		<input type="text" name="<?php echo TABLE_BASIC_SEARCH ?>" id="<?php echo TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo HtmlEncode($patient_provisional_diagnosis_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo HtmlEncode($Language->phrase("Search")) ?>">
		<input type="hidden" name="<?php echo TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo TABLE_BASIC_SEARCH_TYPE ?>" value="<?php echo HtmlEncode($patient_provisional_diagnosis_list->BasicSearch->getType()) ?>">
		<div class="input-group-append">
			...
			<div class="dropdown-menu dropdown-menu-right">
				<a class="dropdown-item<?php if ($patient_provisional_diagnosis_list->BasicSearch->getType() == "") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this)"><?php echo $Language->phrase("QuickSearchAuto") ?></a>
				<a class="dropdown-item<?php if ($patient_provisional_diagnosis_list->BasicSearch->getType() == "=") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this,'=')"><?php echo $Language->phrase("QuickSearchExact") ?></a>
				<a class="dropdown-item<?php if ($patient_provisional_diagnosis_list->BasicSearch->getType() == "AND") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this,'AND')"><?php echo $Language->phrase("QuickSearchAll") ?></a>
				<a class="dropdown-item<?php if ($patient_provisional_diagnosis_list->BasicSearch->getType() == "OR") echo " active"; ?>" href="javascript:void(0);" onclick="ew.setSearchType(this,'OR')"><?php echo $Language->phrase("QuickSearchAny") ?></a>
			</div>
		</div>
	</div>
</div>
...
?>
<?php if ($patient_provisional_diagnosis_list->TotalRecs > 0 || $patient_provisional_diagnosis->CurrentAction) { ?>
...
<?php if (!$patient_provisional_diagnosis->isGridAdd()) { ?>
<form name="ew-pager-form" class="form-inline ew-form ew-pager-form" action="<?php echo CurrentPageName() ?>">
<?php if (!isset($patient_provisional_diagnosis_list->Pager)) $patient_provisional_diagnosis_list->Pager = new NumericPager($patient_provisional_diagnosis_list->StartRec, $patient_provisional_diagnosis_list->DisplayRecs, $patient_provisional_diagnosis_list->TotalRecs, $patient_provisional_diagnosis_list->RecRange, $patient_provisional_diagnosis_list->AutoHidePager) ?>
<?php if ($patient_provisional_diagnosis_list->Pager->RecordCount > 0 && $patient_provisional_diagnosis_list->Pager->Visible) { ?>
<div class="ew-pager">
<div class="ew-numeric-page"><ul class="pagination">
	<?php if ($patient_provisional_diagnosis_list->Pager->FirstButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $patient_provisional_diagnosis_list->pageUrl() ?>start=<?php echo $patient_provisional_diagnosis_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($patient_provisional_diagnosis_list->Pager->PrevButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $patient_provisional_diagnosis_list->pageUrl() ?>start=<?php echo $patient_provisional_diagnosis_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($patient_provisional_diagnosis_list->Pager->Items as $pagerItem) { ?>
		<li class="page-item<?php if (!$pagerItem->Enabled) { ?> active<?php } ?>"><a class="page-link" href="<?php if ($pagerItem->Enabled) { echo $patient_provisional_diagnosis_list->pageUrl() . "start=" . $pagerItem->Start; } else { echo "#"; } ?>"><?php echo $pagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($patient_provisional_diagnosis_list->Pager->NextButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $patient_provisional_diagnosis_list->pageUrl() ?>start=<?php echo $patient_provisional_diagnosis_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($patient_provisional_diagnosis_list->Pager->LastButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $patient_provisional_diagnosis_list->pageUrl() ?>start=<?php echo $patient_provisional_diagnosis_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
<?php if ($patient_provisional_diagnosis_list->Pager->RecordCount > 0) { ?>
<div class="ew-pager ew-rec">
	<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $patient_provisional_diagnosis_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $patient_provisional_diagnosis_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $patient_provisional_diagnosis_list->Pager->RecordCount ?></span>
</div>
<?php } ?>
<?php if ($patient_provisional_diagnosis_list->TotalRecs > 0 && (!$patient_provisional_diagnosis_list->AutoHidePageSizeSelector || $patient_provisional_diagnosis_list->Pager->Visible)) { ?>
<div class="ew-pager">
<input type="hidden" name="t" value="patient_provisional_diagnosis">
<select name="<?php echo TABLE_REC_PER_PAGE ?>" class="form-control form-control-sm ew-tooltip" title="<?php echo $Language->phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="20"<?php if ($patient_provisional_diagnosis_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="40"<?php if ($patient_provisional_diagnosis_list->DisplayRecs == 40) { ?> selected<?php } ?>>40</option>
<option value="60"<?php if ($patient_provisional_diagnosis_list->DisplayRecs == 60) { ?> selected<?php } ?>>60</option>
<option value="100"<?php if ($patient_provisional_diagnosis_list->DisplayRecs == 100) { ?> selected<?php } ?>>100</option>
<option value="500"<?php if ($patient_provisional_diagnosis_list->DisplayRecs == 500) { ?> selected<?php } ?>>500</option>
<option value="1000"<?php if ($patient_provisional_diagnosis_list->DisplayRecs == 1000) { ?> selected<?php } ?>>1000</option>
<option value="ALL"<?php if ($patient_provisional_diagnosis->getRecordsPerPage() == -1) { ?> selected<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</div>
<?php } ?>
</form>
...
<?php if ($patient_provisional_diagnosis_list->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_provisional_diagnosis_list->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="patient_provisional_diagnosis">
...
<?php if ($patient_provisional_diagnosis_list->TotalRecs > 0 || $patient_provisional_diagnosis->isGridEdit()) { ?>
...
// Header row
$patient_provisional_diagnosis_list->RowType = ROWTYPE_HEADER;
...
<?php if ($patient_provisional_diagnosis->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id" class="<?php echo $patient_provisional_diagnosis->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->id) ?>',1);"><div id="elh_patient_provisional_diagnosis_id" class="patient_provisional_diagnosis_id">
...
<?php if ($patient_provisional_diagnosis->mrnno->Visible) { // mrnno ?>
	...
	<?php } else { ?>
		<th data-name="mrnno" class="<?php echo $patient_provisional_diagnosis->mrnno->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->mrnno) ?>',1);"><div id="elh_patient_provisional_diagnosis_mrnno" class="patient_provisional_diagnosis_mrnno">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $patient_provisional_diagnosis->mrnno->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($patient_provisional_diagnosis->mrnno->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($patient_provisional_diagnosis->mrnno->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($patient_provisional_diagnosis->PatientName->Visible) { // PatientName ?>
	...
	<?php } else { ?>
		<th data-name="PatientName" class="<?php echo $patient_provisional_diagnosis->PatientName->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->PatientName) ?>',1);"><div id="elh_patient_provisional_diagnosis_PatientName" class="patient_provisional_diagnosis_PatientName">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $patient_provisional_diagnosis->PatientName->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($patient_provisional_diagnosis->PatientName->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($patient_provisional_diagnosis->PatientName->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($patient_provisional_diagnosis->PatID->Visible) { // PatID ?>
	...
	<?php } else { ?>
		<th data-name="PatID" class="<?php echo $patient_provisional_diagnosis->PatID->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->PatID) ?>',1);"><div id="elh_patient_provisional_diagnosis_PatID" class="patient_provisional_diagnosis_PatID">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $patient_provisional_diagnosis->PatID->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($patient_provisional_diagnosis->PatID->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($patient_provisional_diagnosis->PatID->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($patient_provisional_diagnosis->MobileNumber->Visible) { // MobileNumber ?>
	...
	<?php } else { ?>
		<th data-name="MobileNumber" class="<?php echo $patient_provisional_diagnosis->MobileNumber->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->MobileNumber) ?>',1);"><div id="elh_patient_provisional_diagnosis_MobileNumber" class="patient_provisional_diagnosis_MobileNumber">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $patient_provisional_diagnosis->MobileNumber->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($patient_provisional_diagnosis->MobileNumber->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($patient_provisional_diagnosis->MobileNumber->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($patient_provisional_diagnosis->Reception->Visible) { // Reception ?>
	...
	<?php } else { ?>
		<th data-name="Reception" class="<?php echo $patient_provisional_diagnosis->Reception->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->Reception) ?>',1);"><div id="elh_patient_provisional_diagnosis_Reception" class="patient_provisional_diagnosis_Reception">
...
<?php if ($patient_provisional_diagnosis->PatientId->Visible) { // PatientId ?>
	...
	<?php } else { ?>
		<th data-name="PatientId" class="<?php echo $patient_provisional_diagnosis->PatientId->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->PatientId) ?>',1);"><div id="elh_patient_provisional_diagnosis_PatientId" class="patient_provisional_diagnosis_PatientId">
...
<?php if ($patient_provisional_diagnosis->Age->Visible) { // Age ?>
	...
	<?php } else { ?>
		<th data-name="Age" class="<?php echo $patient_provisional_diagnosis->Age->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->Age) ?>',1);"><div id="elh_patient_provisional_diagnosis_Age" class="patient_provisional_diagnosis_Age">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $patient_provisional_diagnosis->Age->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($patient_provisional_diagnosis->Age->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($patient_provisional_diagnosis->Age->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($patient_provisional_diagnosis->Gender->Visible) { // Gender ?>
	...
	<?php } else { ?>
		<th data-name="Gender" class="<?php echo $patient_provisional_diagnosis->Gender->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->Gender) ?>',1);"><div id="elh_patient_provisional_diagnosis_Gender" class="patient_provisional_diagnosis_Gender">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $patient_provisional_diagnosis->Gender->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($patient_provisional_diagnosis->Gender->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($patient_provisional_diagnosis->Gender->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($patient_provisional_diagnosis->HospID->Visible) { // HospID ?>
	...
	<?php } else { ?>
		<th data-name="HospID" class="<?php echo $patient_provisional_diagnosis->HospID->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $patient_provisional_diagnosis->SortUrl($patient_provisional_diagnosis->HospID) ?>',1);"><div id="elh_patient_provisional_diagnosis_HospID" class="patient_provisional_diagnosis_HospID">
...
<tbody>
<?php
if ($patient_provisional_diagnosis->ExportAll && $patient_provisional_diagnosis->isExport()) {
	$patient_provisional_diagnosis_list->StopRec = $patient_provisional_diagnosis_list->TotalRecs;
} else {

	// Set the last record to display
	if ($patient_provisional_diagnosis_list->TotalRecs > $patient_provisional_diagnosis_list->StartRec + $patient_provisional_diagnosis_list->DisplayRecs - 1)
		$patient_provisional_diagnosis_list->StopRec = $patient_provisional_diagnosis_list->StartRec + $patient_provisional_diagnosis_list->DisplayRecs - 1;
	else
		$patient_provisional_diagnosis_list->StopRec = $patient_provisional_diagnosis_list->TotalRecs;
}
$patient_provisional_diagnosis_list->RecCnt = $patient_provisional_diagnosis_list->StartRec - 1;
if ($patient_provisional_diagnosis_list->Recordset && !$patient_provisional_diagnosis_list->Recordset->EOF) {
	...
	if (!$selectLimit && $patient_provisional_diagnosis_list->StartRec > 1)
		$patient_provisional_diagnosis_list->Recordset->move($patient_provisional_diagnosis_list->StartRec - 1);
} elseif (!$patient_provisional_diagnosis->AllowAddDeleteRow && $patient_provisional_diagnosis_list->StopRec == 0) {
	$patient_provisional_diagnosis_list->StopRec = $patient_provisional_diagnosis->GridAddRowCount;
}
...
while ($patient_provisional_diagnosis_list->RecCnt < $patient_provisional_diagnosis_list->StopRec) {
	$patient_provisional_diagnosis_list->RecCnt++;
	if ($patient_provisional_diagnosis_list->RecCnt >= $patient_provisional_diagnosis_list->StartRec) {
		$patient_provisional_diagnosis_list->RowCnt++;
		...
		$patient_provisional_diagnosis->RowAttrs = array_merge($patient_provisional_diagnosis->RowAttrs, array('data-rowindex'=>$patient_provisional_diagnosis_list->RowCnt, 'id'=>'r' . $patient_provisional_diagnosis_list->RowCnt . '_patient_provisional_diagnosis', 'data-rowtype'=>$patient_provisional_diagnosis->RowType));
...
$patient_provisional_diagnosis_list->ListOptions->render("body", "left", $patient_provisional_diagnosis_list->RowCnt);
?>
	<?php if ($patient_provisional_diagnosis->id->Visible) { // id ?>
		<td data-name="id"<?php echo $patient_provisional_diagnosis->id->cellAttributes() ?>>
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_id" class="patient_provisional_diagnosis_id">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_mrnno" class="patient_provisional_diagnosis_mrnno">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_PatientName" class="patient_provisional_diagnosis_PatientName">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_PatID" class="patient_provisional_diagnosis_PatID">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_MobileNumber" class="patient_provisional_diagnosis_MobileNumber">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_Reception" class="patient_provisional_diagnosis_Reception">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_PatientId" class="patient_provisional_diagnosis_PatientId">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_Age" class="patient_provisional_diagnosis_Age">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_Gender" class="patient_provisional_diagnosis_Gender">
...
<span id="el<?php echo $patient_provisional_diagnosis_list->RowCnt ?>_patient_provisional_diagnosis_HospID" class="patient_provisional_diagnosis_HospID">
...
$patient_provisional_diagnosis_list->ListOptions->render("body", "right", $patient_provisional_diagnosis_list->RowCnt);
?>
	</tr>
<?php
	}
...
<?php } ?>
<?php if ($patient_provisional_diagnosis_list->TotalRecs == 0 && !$patient_provisional_diagnosis->CurrentAction) { // Show other options ?>
<div class="ew-list-other-options">
<?php $patient_provisional_diagnosis_list->OtherOptions->render("body") ?>
</div>
<div class="clearfix"></div>
