...
var fpres_frequenciesadd = currentForm = new ew.Form("fpres_frequenciesadd", "add");
...
fpres_frequenciesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_frequencies_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_frequencies_add->Token ?>">
<?php } ?>
...
<?php if ($pres_frequencies->Frequency->Visible) { // Frequency ?>
	<div id="r_Frequency" class="form-group row">
		<label id="elh_pres_frequencies_Frequency" for="x_Frequency" class="<?php echo $pres_frequencies_add->LeftColumnClass ?>"><?php echo $pres_frequencies->Frequency->caption() ?><?php echo ($pres_frequencies->Frequency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_frequencies_add->RightColumnClass ?>"><div<?php echo $pres_frequencies->Frequency->cellAttributes() ?>>
...
<?php if ($pres_frequencies->Freq_Exp->Visible) { // Freq_Exp ?>
	<div id="r_Freq_Exp" class="form-group row">
		<label id="elh_pres_frequencies_Freq_Exp" for="x_Freq_Exp" class="<?php echo $pres_frequencies_add->LeftColumnClass ?>"><?php echo $pres_frequencies->Freq_Exp->caption() ?><?php echo ($pres_frequencies->Freq_Exp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_frequencies_add->RightColumnClass ?>"><div<?php echo $pres_frequencies->Freq_Exp->cellAttributes() ?>>
...
<?php if ($pres_frequencies->Freq_Count->Visible) { // Freq_Count ?>
	<div id="r_Freq_Count" class="form-group row">
		<label id="elh_pres_frequencies_Freq_Count" for="x_Freq_Count" class="<?php echo $pres_frequencies_add->LeftColumnClass ?>"><?php echo $pres_frequencies->Freq_Count->caption() ?><?php echo ($pres_frequencies->Freq_Count->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_frequencies_add->RightColumnClass ?>"><div<?php echo $pres_frequencies->Freq_Count->cellAttributes() ?>>
