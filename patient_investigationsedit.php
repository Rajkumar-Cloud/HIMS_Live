...
var fpatient_investigationsedit = currentForm = new ew.Form("fpatient_investigationsedit", "edit");
...
fpatient_investigationsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($patient_investigations_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_investigations_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_investigations->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_investigations_id" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->id->caption() ?><?php echo ($patient_investigations->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_investigations" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_investigations->id->CurrentValue) ?>">
<?php echo $patient_investigations->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_investigations->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_investigations_Reception" for="x_Reception" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Reception->caption() ?><?php echo ($patient_investigations->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Reception->cellAttributes() ?>>
<span id="el_patient_investigations_Reception">
<span<?php echo $patient_investigations->Reception->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($patient_investigations->Reception->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="patient_investigations" data-field="x_Reception" name="x_Reception" id="x_Reception" value="<?php echo HtmlEncode($patient_investigations->Reception->CurrentValue) ?>">
...
<?php if ($patient_investigations->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_investigations_PatientId" for="x_PatientId" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->PatientId->caption() ?><?php echo ($patient_investigations->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->PatientId->cellAttributes() ?>>
<span id="el_patient_investigations_PatientId">
<span<?php echo $patient_investigations->PatientId->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($patient_investigations->PatientId->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="patient_investigations" data-field="x_PatientId" name="x_PatientId" id="x_PatientId" value="<?php echo HtmlEncode($patient_investigations->PatientId->CurrentValue) ?>">
...
<?php if ($patient_investigations->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_investigations_PatientName" for="x_PatientName" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->PatientName->caption() ?><?php echo ($patient_investigations->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->PatientName->cellAttributes() ?>>
...
<?php if ($patient_investigations->Investigation->Visible) { // Investigation ?>
	<div id="r_Investigation" class="form-group row">
		<label id="elh_patient_investigations_Investigation" for="x_Investigation" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Investigation->caption() ?><?php echo ($patient_investigations->Investigation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Investigation->cellAttributes() ?>>
...
<?php if ($patient_investigations->Value->Visible) { // Value ?>
	<div id="r_Value" class="form-group row">
		<label id="elh_patient_investigations_Value" for="x_Value" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Value->caption() ?><?php echo ($patient_investigations->Value->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Value->cellAttributes() ?>>
...
<?php if ($patient_investigations->NormalRange->Visible) { // NormalRange ?>
	<div id="r_NormalRange" class="form-group row">
		<label id="elh_patient_investigations_NormalRange" for="x_NormalRange" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->NormalRange->caption() ?><?php echo ($patient_investigations->NormalRange->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->NormalRange->cellAttributes() ?>>
...
<?php if ($patient_investigations->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_investigations_mrnno" for="x_mrnno" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->mrnno->caption() ?><?php echo ($patient_investigations->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->mrnno->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_investigations" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" value="<?php echo HtmlEncode($patient_investigations->mrnno->CurrentValue) ?>">
<?php echo $patient_investigations->mrnno->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_investigations->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_investigations_Age" for="x_Age" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Age->caption() ?><?php echo ($patient_investigations->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Age->cellAttributes() ?>>
...
<?php if ($patient_investigations->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_investigations_Gender" for="x_Gender" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Gender->caption() ?><?php echo ($patient_investigations->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Gender->cellAttributes() ?>>
...
<?php if ($patient_investigations->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_investigations_profilePic" for="x_profilePic" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->profilePic->caption() ?><?php echo ($patient_investigations->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->profilePic->cellAttributes() ?>>
...
<?php if ($patient_investigations->SampleCollected->Visible) { // SampleCollected ?>
	<div id="r_SampleCollected" class="form-group row">
		<label id="elh_patient_investigations_SampleCollected" for="x_SampleCollected" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->SampleCollected->caption() ?><?php echo ($patient_investigations->SampleCollected->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->SampleCollected->cellAttributes() ?>>
...
<?php if ($patient_investigations->SampleCollectedBy->Visible) { // SampleCollectedBy ?>
	<div id="r_SampleCollectedBy" class="form-group row">
		<label id="elh_patient_investigations_SampleCollectedBy" for="x_SampleCollectedBy" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->SampleCollectedBy->caption() ?><?php echo ($patient_investigations->SampleCollectedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->SampleCollectedBy->cellAttributes() ?>>
...
<?php if ($patient_investigations->ResultedDate->Visible) { // ResultedDate ?>
	<div id="r_ResultedDate" class="form-group row">
		<label id="elh_patient_investigations_ResultedDate" for="x_ResultedDate" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->ResultedDate->caption() ?><?php echo ($patient_investigations->ResultedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->ResultedDate->cellAttributes() ?>>
...
<?php if ($patient_investigations->ResultedBy->Visible) { // ResultedBy ?>
	<div id="r_ResultedBy" class="form-group row">
		<label id="elh_patient_investigations_ResultedBy" for="x_ResultedBy" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->ResultedBy->caption() ?><?php echo ($patient_investigations->ResultedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->ResultedBy->cellAttributes() ?>>
...
<?php if ($patient_investigations->Modified->Visible) { // Modified ?>
	<div id="r_Modified" class="form-group row">
		<label id="elh_patient_investigations_Modified" for="x_Modified" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Modified->caption() ?><?php echo ($patient_investigations->Modified->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Modified->cellAttributes() ?>>
...
<?php if ($patient_investigations->ModifiedBy->Visible) { // ModifiedBy ?>
	<div id="r_ModifiedBy" class="form-group row">
		<label id="elh_patient_investigations_ModifiedBy" for="x_ModifiedBy" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->ModifiedBy->caption() ?><?php echo ($patient_investigations->ModifiedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->ModifiedBy->cellAttributes() ?>>
...
<?php if ($patient_investigations->Created->Visible) { // Created ?>
	<div id="r_Created" class="form-group row">
		<label id="elh_patient_investigations_Created" for="x_Created" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Created->caption() ?><?php echo ($patient_investigations->Created->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Created->cellAttributes() ?>>
...
<?php if ($patient_investigations->CreatedBy->Visible) { // CreatedBy ?>
	<div id="r_CreatedBy" class="form-group row">
		<label id="elh_patient_investigations_CreatedBy" for="x_CreatedBy" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->CreatedBy->caption() ?><?php echo ($patient_investigations->CreatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->CreatedBy->cellAttributes() ?>>
...
<?php if ($patient_investigations->GroupHead->Visible) { // GroupHead ?>
	<div id="r_GroupHead" class="form-group row">
		<label id="elh_patient_investigations_GroupHead" for="x_GroupHead" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->GroupHead->caption() ?><?php echo ($patient_investigations->GroupHead->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->GroupHead->cellAttributes() ?>>
...
<?php if ($patient_investigations->Cost->Visible) { // Cost ?>
	<div id="r_Cost" class="form-group row">
		<label id="elh_patient_investigations_Cost" for="x_Cost" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->Cost->caption() ?><?php echo ($patient_investigations->Cost->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->Cost->cellAttributes() ?>>
...
<?php if ($patient_investigations->PaymentStatus->Visible) { // PaymentStatus ?>
	<div id="r_PaymentStatus" class="form-group row">
		<label id="elh_patient_investigations_PaymentStatus" for="x_PaymentStatus" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->PaymentStatus->caption() ?><?php echo ($patient_investigations->PaymentStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->PaymentStatus->cellAttributes() ?>>
...
<?php if ($patient_investigations->PayMode->Visible) { // PayMode ?>
	<div id="r_PayMode" class="form-group row">
		<label id="elh_patient_investigations_PayMode" for="x_PayMode" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->PayMode->caption() ?><?php echo ($patient_investigations->PayMode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->PayMode->cellAttributes() ?>>
...
<?php if ($patient_investigations->VoucherNo->Visible) { // VoucherNo ?>
	<div id="r_VoucherNo" class="form-group row">
		<label id="elh_patient_investigations_VoucherNo" for="x_VoucherNo" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->VoucherNo->caption() ?><?php echo ($patient_investigations->VoucherNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->VoucherNo->cellAttributes() ?>>
...
<?php if ($patient_investigations->InvestigationMultiselect->Visible) { // InvestigationMultiselect ?>
	<div id="r_InvestigationMultiselect" class="form-group row">
		<label id="elh_patient_investigations_InvestigationMultiselect" for="x_InvestigationMultiselect" class="<?php echo $patient_investigations_edit->LeftColumnClass ?>"><?php echo $patient_investigations->InvestigationMultiselect->caption() ?><?php echo ($patient_investigations->InvestigationMultiselect->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_investigations_edit->RightColumnClass ?>"><div<?php echo $patient_investigations->InvestigationMultiselect->cellAttributes() ?>>
