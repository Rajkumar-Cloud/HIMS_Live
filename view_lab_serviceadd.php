...
var fview_lab_serviceadd = currentForm = new ew.Form("fview_lab_serviceadd", "add");
...
fview_lab_serviceadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_lab_service_add->Created->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_lab_service->Created->caption(), $view_lab_service->Created->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($view_lab_service_add->CreatedDateTime->Required) { ?>
			elm = this.getElements("x" + infix + "_CreatedDateTime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $view_lab_service->CreatedDateTime->caption(), $view_lab_service->CreatedDateTime->RequiredErrorMessage)) ?>");
		<?php } ?>
...
fview_lab_serviceadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_lab_serviceadd.lists["x_UNITS"] = <?php echo $view_lab_service_add->UNITS->Lookup->toClientList() ?>;
fview_lab_serviceadd.lists["x_UNITS"].options = <?php echo JsonEncode($view_lab_service_add->UNITS->lookupOptions()) ?>;
fview_lab_serviceadd.lists["x_SERVICE_TYPE"] = <?php echo $view_lab_service_add->SERVICE_TYPE->Lookup->toClientList() ?>;
fview_lab_serviceadd.lists["x_SERVICE_TYPE"].options = <?php echo JsonEncode($view_lab_service_add->SERVICE_TYPE->lookupOptions()) ?>;
fview_lab_serviceadd.lists["x_DEPARTMENT"] = <?php echo $view_lab_service_add->DEPARTMENT->Lookup->toClientList() ?>;
fview_lab_serviceadd.lists["x_DEPARTMENT"].options = <?php echo JsonEncode($view_lab_service_add->DEPARTMENT->options(FALSE, TRUE)) ?>;
fview_lab_serviceadd.lists["x_Inactive[]"] = <?php echo $view_lab_service_add->Inactive->Lookup->toClientList() ?>;
fview_lab_serviceadd.lists["x_Inactive[]"].options = <?php echo JsonEncode($view_lab_service_add->Inactive->options(FALSE, TRUE)) ?>;
fview_lab_serviceadd.lists["x_TestType"] = <?php echo $view_lab_service_add->TestType->Lookup->toClientList() ?>;
...
<?php if ($view_lab_service_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_lab_service_add->Token ?>">
<?php } ?>
...
<?php if ($view_lab_service->CODE->Visible) { // CODE ?>
	<div id="r_CODE" class="form-group row">
		<label id="elh_view_lab_service_CODE" for="x_CODE" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_CODE" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->CODE->caption() ?><?php echo ($view_lab_service->CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->CODE->cellAttributes() ?>>
<script id="tpx_view_lab_service_CODE" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->SERVICE->Visible) { // SERVICE ?>
	<div id="r_SERVICE" class="form-group row">
		<label id="elh_view_lab_service_SERVICE" for="x_SERVICE" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_SERVICE" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->SERVICE->caption() ?><?php echo ($view_lab_service->SERVICE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->SERVICE->cellAttributes() ?>>
<script id="tpx_view_lab_service_SERVICE" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->UNITS->Visible) { // UNITS ?>
	<div id="r_UNITS" class="form-group row">
		<label id="elh_view_lab_service_UNITS" for="x_UNITS" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_UNITS" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->UNITS->caption() ?><?php echo ($view_lab_service->UNITS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->UNITS->cellAttributes() ?>>
<script id="tpx_view_lab_service_UNITS" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->AMOUNT->Visible) { // AMOUNT ?>
	<div id="r_AMOUNT" class="form-group row">
		<label id="elh_view_lab_service_AMOUNT" for="x_AMOUNT" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_AMOUNT" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->AMOUNT->caption() ?><?php echo ($view_lab_service->AMOUNT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->AMOUNT->cellAttributes() ?>>
<script id="tpx_view_lab_service_AMOUNT" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->SERVICE_TYPE->Visible) { // SERVICE_TYPE ?>
	<div id="r_SERVICE_TYPE" class="form-group row">
		<label id="elh_view_lab_service_SERVICE_TYPE" for="x_SERVICE_TYPE" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_SERVICE_TYPE" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->SERVICE_TYPE->caption() ?><?php echo ($view_lab_service->SERVICE_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->SERVICE_TYPE->cellAttributes() ?>>
<script id="tpx_view_lab_service_SERVICE_TYPE" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->DEPARTMENT->Visible) { // DEPARTMENT ?>
	<div id="r_DEPARTMENT" class="form-group row">
		<label id="elh_view_lab_service_DEPARTMENT" for="x_DEPARTMENT" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_DEPARTMENT" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->DEPARTMENT->caption() ?><?php echo ($view_lab_service->DEPARTMENT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->DEPARTMENT->cellAttributes() ?>>
<script id="tpx_view_lab_service_DEPARTMENT" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->mas_services_billingcol->Visible) { // mas_services_billingcol ?>
	<div id="r_mas_services_billingcol" class="form-group row">
		<label id="elh_view_lab_service_mas_services_billingcol" for="x_mas_services_billingcol" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_mas_services_billingcol" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->mas_services_billingcol->caption() ?><?php echo ($view_lab_service->mas_services_billingcol->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->mas_services_billingcol->cellAttributes() ?>>
<script id="tpx_view_lab_service_mas_services_billingcol" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->DrShareAmount->Visible) { // DrShareAmount ?>
	<div id="r_DrShareAmount" class="form-group row">
		<label id="elh_view_lab_service_DrShareAmount" for="x_DrShareAmount" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_DrShareAmount" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->DrShareAmount->caption() ?><?php echo ($view_lab_service->DrShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->DrShareAmount->cellAttributes() ?>>
<script id="tpx_view_lab_service_DrShareAmount" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->HospShareAmount->Visible) { // HospShareAmount ?>
	<div id="r_HospShareAmount" class="form-group row">
		<label id="elh_view_lab_service_HospShareAmount" for="x_HospShareAmount" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_HospShareAmount" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->HospShareAmount->caption() ?><?php echo ($view_lab_service->HospShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->HospShareAmount->cellAttributes() ?>>
<script id="tpx_view_lab_service_HospShareAmount" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->DrSharePer->Visible) { // DrSharePer ?>
	<div id="r_DrSharePer" class="form-group row">
		<label id="elh_view_lab_service_DrSharePer" for="x_DrSharePer" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_DrSharePer" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->DrSharePer->caption() ?><?php echo ($view_lab_service->DrSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->DrSharePer->cellAttributes() ?>>
<script id="tpx_view_lab_service_DrSharePer" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->HospSharePer->Visible) { // HospSharePer ?>
	<div id="r_HospSharePer" class="form-group row">
		<label id="elh_view_lab_service_HospSharePer" for="x_HospSharePer" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_HospSharePer" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->HospSharePer->caption() ?><?php echo ($view_lab_service->HospSharePer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->HospSharePer->cellAttributes() ?>>
<script id="tpx_view_lab_service_HospSharePer" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_view_lab_service_TestSubCd" for="x_TestSubCd" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_TestSubCd" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->TestSubCd->caption() ?><?php echo ($view_lab_service->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->TestSubCd->cellAttributes() ?>>
<script id="tpx_view_lab_service_TestSubCd" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_view_lab_service_Method" for="x_Method" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Method" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Method->caption() ?><?php echo ($view_lab_service->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Method->cellAttributes() ?>>
<script id="tpx_view_lab_service_Method" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_view_lab_service_Order" for="x_Order" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Order" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Order->caption() ?><?php echo ($view_lab_service->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Order->cellAttributes() ?>>
<script id="tpx_view_lab_service_Order" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_view_lab_service_Form" for="x_Form" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Form" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Form->caption() ?><?php echo ($view_lab_service->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Form->cellAttributes() ?>>
<script id="tpx_view_lab_service_Form" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_view_lab_service_ResType" for="x_ResType" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_ResType" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->ResType->caption() ?><?php echo ($view_lab_service->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->ResType->cellAttributes() ?>>
<script id="tpx_view_lab_service_ResType" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->UnitCD->Visible) { // UnitCD ?>
	<div id="r_UnitCD" class="form-group row">
		<label id="elh_view_lab_service_UnitCD" for="x_UnitCD" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_UnitCD" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->UnitCD->caption() ?><?php echo ($view_lab_service->UnitCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->UnitCD->cellAttributes() ?>>
<script id="tpx_view_lab_service_UnitCD" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_view_lab_service_RefValue" for="x_RefValue" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_RefValue" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->RefValue->caption() ?><?php echo ($view_lab_service->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->RefValue->cellAttributes() ?>>
<script id="tpx_view_lab_service_RefValue" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_view_lab_service_Sample" for="x_Sample" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Sample" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Sample->caption() ?><?php echo ($view_lab_service->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Sample->cellAttributes() ?>>
<script id="tpx_view_lab_service_Sample" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_view_lab_service_NoD" for="x_NoD" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_NoD" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->NoD->caption() ?><?php echo ($view_lab_service->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->NoD->cellAttributes() ?>>
<script id="tpx_view_lab_service_NoD" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_view_lab_service_BillOrder" for="x_BillOrder" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_BillOrder" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->BillOrder->caption() ?><?php echo ($view_lab_service->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->BillOrder->cellAttributes() ?>>
<script id="tpx_view_lab_service_BillOrder" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_view_lab_service_Formula" for="x_Formula" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Formula" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Formula->caption() ?><?php echo ($view_lab_service->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Formula->cellAttributes() ?>>
<script id="tpx_view_lab_service_Formula" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_view_lab_service_Inactive" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Inactive" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Inactive->caption() ?><?php echo ($view_lab_service->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Inactive->cellAttributes() ?>>
<script id="tpx_view_lab_service_Inactive" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Outsource->Visible) { // Outsource ?>
	<div id="r_Outsource" class="form-group row">
		<label id="elh_view_lab_service_Outsource" for="x_Outsource" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Outsource" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Outsource->caption() ?><?php echo ($view_lab_service->Outsource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Outsource->cellAttributes() ?>>
<script id="tpx_view_lab_service_Outsource" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_view_lab_service_CollSample" for="x_CollSample" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_CollSample" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->CollSample->caption() ?><?php echo ($view_lab_service->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->CollSample->cellAttributes() ?>>
<script id="tpx_view_lab_service_CollSample" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->TestType->Visible) { // TestType ?>
	<div id="r_TestType" class="form-group row">
		<label id="elh_view_lab_service_TestType" for="x_TestType" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_TestType" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->TestType->caption() ?><?php echo ($view_lab_service->TestType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->TestType->cellAttributes() ?>>
<script id="tpx_view_lab_service_TestType" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->NoHeading->Visible) { // NoHeading ?>
	<div id="r_NoHeading" class="form-group row">
		<label id="elh_view_lab_service_NoHeading" for="x_NoHeading" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_NoHeading" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->NoHeading->caption() ?><?php echo ($view_lab_service->NoHeading->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->NoHeading->cellAttributes() ?>>
<script id="tpx_view_lab_service_NoHeading" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->ChemicalCode->Visible) { // ChemicalCode ?>
	<div id="r_ChemicalCode" class="form-group row">
		<label id="elh_view_lab_service_ChemicalCode" for="x_ChemicalCode" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_ChemicalCode" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->ChemicalCode->caption() ?><?php echo ($view_lab_service->ChemicalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->ChemicalCode->cellAttributes() ?>>
<script id="tpx_view_lab_service_ChemicalCode" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->ChemicalName->Visible) { // ChemicalName ?>
	<div id="r_ChemicalName" class="form-group row">
		<label id="elh_view_lab_service_ChemicalName" for="x_ChemicalName" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_ChemicalName" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->ChemicalName->caption() ?><?php echo ($view_lab_service->ChemicalName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->ChemicalName->cellAttributes() ?>>
<script id="tpx_view_lab_service_ChemicalName" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Utilaization->Visible) { // Utilaization ?>
	<div id="r_Utilaization" class="form-group row">
		<label id="elh_view_lab_service_Utilaization" for="x_Utilaization" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Utilaization" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Utilaization->caption() ?><?php echo ($view_lab_service->Utilaization->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Utilaization->cellAttributes() ?>>
<script id="tpx_view_lab_service_Utilaization" class="view_lab_serviceadd" type="text/html">
...
<?php if ($view_lab_service->Interpretation->Visible) { // Interpretation ?>
	<div id="r_Interpretation" class="form-group row">
		<label id="elh_view_lab_service_Interpretation" class="<?php echo $view_lab_service_add->LeftColumnClass ?>"><script id="tpc_view_lab_service_Interpretation" class="view_lab_serviceadd" type="text/html"><span><?php echo $view_lab_service->Interpretation->caption() ?><?php echo ($view_lab_service->Interpretation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_lab_service_add->RightColumnClass ?>"><div<?php echo $view_lab_service->Interpretation->cellAttributes() ?>>
<script id="tpx_view_lab_service_Interpretation" class="view_lab_serviceadd" type="text/html">
...
ew.createEditor("fview_lab_serviceadd", "x_Interpretation", 35, 4, <?php echo ($view_lab_service->Interpretation->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
ew.applyTemplate("tpd_view_lab_serviceadd", "tpm_view_lab_serviceadd", "view_lab_serviceadd", "<?php echo $view_lab_service->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_lab_serviceadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
