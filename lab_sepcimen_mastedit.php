...
var flab_sepcimen_mastedit = currentForm = new ew.Form("flab_sepcimen_mastedit", "edit");
...
flab_sepcimen_mastedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($lab_sepcimen_mast_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $lab_sepcimen_mast->id->caption(), $lab_sepcimen_mast->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
flab_sepcimen_mastedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($lab_sepcimen_mast_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $lab_sepcimen_mast_edit->Token ?>">
<?php } ?>
...
<?php if ($lab_sepcimen_mast->SpecimenCD->Visible) { // SpecimenCD ?>
	<div id="r_SpecimenCD" class="form-group row">
		<label id="elh_lab_sepcimen_mast_SpecimenCD" for="x_SpecimenCD" class="<?php echo $lab_sepcimen_mast_edit->LeftColumnClass ?>"><?php echo $lab_sepcimen_mast->SpecimenCD->caption() ?><?php echo ($lab_sepcimen_mast->SpecimenCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sepcimen_mast_edit->RightColumnClass ?>"><div<?php echo $lab_sepcimen_mast->SpecimenCD->cellAttributes() ?>>
...
<?php if ($lab_sepcimen_mast->SpecimenDesc->Visible) { // SpecimenDesc ?>
	<div id="r_SpecimenDesc" class="form-group row">
		<label id="elh_lab_sepcimen_mast_SpecimenDesc" for="x_SpecimenDesc" class="<?php echo $lab_sepcimen_mast_edit->LeftColumnClass ?>"><?php echo $lab_sepcimen_mast->SpecimenDesc->caption() ?><?php echo ($lab_sepcimen_mast->SpecimenDesc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sepcimen_mast_edit->RightColumnClass ?>"><div<?php echo $lab_sepcimen_mast->SpecimenDesc->cellAttributes() ?>>
...
<?php if ($lab_sepcimen_mast->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_lab_sepcimen_mast_id" class="<?php echo $lab_sepcimen_mast_edit->LeftColumnClass ?>"><?php echo $lab_sepcimen_mast->id->caption() ?><?php echo ($lab_sepcimen_mast->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_sepcimen_mast_edit->RightColumnClass ?>"><div<?php echo $lab_sepcimen_mast->id->cellAttributes() ?>>
<span id="el_lab_sepcimen_mast_id">
<span<?php echo $lab_sepcimen_mast->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($lab_sepcimen_mast->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="lab_sepcimen_mast" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($lab_sepcimen_mast->id->CurrentValue) ?>">
<?php echo $lab_sepcimen_mast->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
