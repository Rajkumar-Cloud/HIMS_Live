...
var fview_pharmacygrnadd = currentForm = new ew.Form("fview_pharmacygrnadd", "add");
...
fview_pharmacygrnadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_pharmacygrn_add->FreeQtyyy->Required) { ?>
		...
		<?php if ($view_pharmacygrn_add->GRNPer->Required) { ?>
		...
		<?php if ($view_pharmacygrn_add->grndate->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_pharmacygrn_add->grndatetime->Required) { ?>
...
fview_pharmacygrnadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_pharmacygrnadd.lists["x_PrName"] = <?php echo $view_pharmacygrn_add->PrName->Lookup->toClientList() ?>;
...
<?php if ($view_pharmacygrn_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_pharmacygrn_add->Token ?>">
<?php } ?>
...
<?php if ($view_pharmacygrn->ORDNO->Visible) { // ORDNO ?>
	<div id="r_ORDNO" class="form-group row">
		<label id="elh_view_pharmacygrn_ORDNO" for="x_ORDNO" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->ORDNO->caption() ?><?php echo ($view_pharmacygrn->ORDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->ORDNO->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_view_pharmacygrn_PRC" for="x_PRC" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PRC->caption() ?><?php echo ($view_pharmacygrn->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PRC->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->QTY->Visible) { // QTY ?>
	<div id="r_QTY" class="form-group row">
		<label id="elh_view_pharmacygrn_QTY" for="x_QTY" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->QTY->caption() ?><?php echo ($view_pharmacygrn->QTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->QTY->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_view_pharmacygrn_DT" for="x_DT" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->DT->caption() ?><?php echo ($view_pharmacygrn->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->DT->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_view_pharmacygrn_PC" for="x_PC" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PC->caption() ?><?php echo ($view_pharmacygrn->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PC->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_view_pharmacygrn_YM" for="x_YM" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->YM->caption() ?><?php echo ($view_pharmacygrn->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->YM->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Stock->Visible) { // Stock ?>
	<div id="r_Stock" class="form-group row">
		<label id="elh_view_pharmacygrn_Stock" for="x_Stock" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Stock->caption() ?><?php echo ($view_pharmacygrn->Stock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Stock->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->LastMonthSale->Visible) { // LastMonthSale ?>
	<div id="r_LastMonthSale" class="form-group row">
		<label id="elh_view_pharmacygrn_LastMonthSale" for="x_LastMonthSale" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->LastMonthSale->caption() ?><?php echo ($view_pharmacygrn->LastMonthSale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->LastMonthSale->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Printcheck->Visible) { // Printcheck ?>
	<div id="r_Printcheck" class="form-group row">
		<label id="elh_view_pharmacygrn_Printcheck" for="x_Printcheck" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Printcheck->caption() ?><?php echo ($view_pharmacygrn->Printcheck->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Printcheck->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->poid->Visible) { // poid ?>
	<div id="r_poid" class="form-group row">
		<label id="elh_view_pharmacygrn_poid" for="x_poid" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->poid->caption() ?><?php echo ($view_pharmacygrn->poid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->poid->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_view_pharmacygrn_PrName" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PrName->caption() ?><?php echo ($view_pharmacygrn->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PrName->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->grnid->Visible) { // grnid ?>
	<div id="r_grnid" class="form-group row">
		<label id="elh_view_pharmacygrn_grnid" for="x_grnid" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->grnid->caption() ?><?php echo ($view_pharmacygrn->grnid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->grnid->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->GrnQuantity->Visible) { // GrnQuantity ?>
	<div id="r_GrnQuantity" class="form-group row">
		<label id="elh_view_pharmacygrn_GrnQuantity" for="x_GrnQuantity" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->GrnQuantity->caption() ?><?php echo ($view_pharmacygrn->GrnQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->GrnQuantity->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_view_pharmacygrn_Quantity" for="x_Quantity" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Quantity->caption() ?><?php echo ($view_pharmacygrn->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Quantity->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->FreeQty->Visible) { // FreeQty ?>
	<div id="r_FreeQty" class="form-group row">
		<label id="elh_view_pharmacygrn_FreeQty" for="x_FreeQty" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->FreeQty->caption() ?><?php echo ($view_pharmacygrn->FreeQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->FreeQty->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->FreeQtyyy->Visible) { // FreeQtyyy ?>
	<div id="r_FreeQtyyy" class="form-group row">
		<label id="elh_view_pharmacygrn_FreeQtyyy" for="x_FreeQtyyy" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->FreeQtyyy->caption() ?><?php echo ($view_pharmacygrn->FreeQtyyy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->FreeQtyyy->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->BatchNo->Visible) { // BatchNo ?>
	<div id="r_BatchNo" class="form-group row">
		<label id="elh_view_pharmacygrn_BatchNo" for="x_BatchNo" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->BatchNo->caption() ?><?php echo ($view_pharmacygrn->BatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->BatchNo->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->ExpDate->Visible) { // ExpDate ?>
	<div id="r_ExpDate" class="form-group row">
		<label id="elh_view_pharmacygrn_ExpDate" for="x_ExpDate" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->ExpDate->caption() ?><?php echo ($view_pharmacygrn->ExpDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->ExpDate->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->HSN->Visible) { // HSN ?>
	<div id="r_HSN" class="form-group row">
		<label id="elh_view_pharmacygrn_HSN" for="x_HSN" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->HSN->caption() ?><?php echo ($view_pharmacygrn->HSN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->HSN->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_view_pharmacygrn_MFRCODE" for="x_MFRCODE" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->MFRCODE->caption() ?><?php echo ($view_pharmacygrn->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->MFRCODE->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_view_pharmacygrn_PUnit" for="x_PUnit" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PUnit->caption() ?><?php echo ($view_pharmacygrn->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PUnit->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_view_pharmacygrn_SUnit" for="x_SUnit" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->SUnit->caption() ?><?php echo ($view_pharmacygrn->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->SUnit->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Pack->Visible) { // Pack ?>
	<div id="r_Pack" class="form-group row">
		<label id="elh_view_pharmacygrn_Pack" for="x_Pack" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Pack->caption() ?><?php echo ($view_pharmacygrn->Pack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Pack->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->GrnMRP->Visible) { // GrnMRP ?>
	<div id="r_GrnMRP" class="form-group row">
		<label id="elh_view_pharmacygrn_GrnMRP" for="x_GrnMRP" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->GrnMRP->caption() ?><?php echo ($view_pharmacygrn->GrnMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->GrnMRP->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_view_pharmacygrn_MRP" for="x_MRP" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->MRP->caption() ?><?php echo ($view_pharmacygrn->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->MRP->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_view_pharmacygrn_PurValue" for="x_PurValue" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PurValue->caption() ?><?php echo ($view_pharmacygrn->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PurValue->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->GRNPer->Visible) { // GRNPer ?>
	<div id="r_GRNPer" class="form-group row">
		<label id="elh_view_pharmacygrn_GRNPer" for="x_GRNPer" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->GRNPer->caption() ?><?php echo ($view_pharmacygrn->GRNPer->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->GRNPer->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Disc->Visible) { // Disc ?>
	<div id="r_Disc" class="form-group row">
		<label id="elh_view_pharmacygrn_Disc" for="x_Disc" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Disc->caption() ?><?php echo ($view_pharmacygrn->Disc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Disc->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_view_pharmacygrn_PSGST" for="x_PSGST" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PSGST->caption() ?><?php echo ($view_pharmacygrn->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PSGST->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_view_pharmacygrn_PCGST" for="x_PCGST" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PCGST->caption() ?><?php echo ($view_pharmacygrn->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PCGST->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PTax->Visible) { // PTax ?>
	<div id="r_PTax" class="form-group row">
		<label id="elh_view_pharmacygrn_PTax" for="x_PTax" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PTax->caption() ?><?php echo ($view_pharmacygrn->PTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PTax->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->ItemValue->Visible) { // ItemValue ?>
	<div id="r_ItemValue" class="form-group row">
		<label id="elh_view_pharmacygrn_ItemValue" for="x_ItemValue" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->ItemValue->caption() ?><?php echo ($view_pharmacygrn->ItemValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->ItemValue->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->SalTax->Visible) { // SalTax ?>
	<div id="r_SalTax" class="form-group row">
		<label id="elh_view_pharmacygrn_SalTax" for="x_SalTax" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->SalTax->caption() ?><?php echo ($view_pharmacygrn->SalTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->SalTax->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_view_pharmacygrn_PurRate" for="x_PurRate" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->PurRate->caption() ?><?php echo ($view_pharmacygrn->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->PurRate->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->SalRate->Visible) { // SalRate ?>
	<div id="r_SalRate" class="form-group row">
		<label id="elh_view_pharmacygrn_SalRate" for="x_SalRate" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->SalRate->caption() ?><?php echo ($view_pharmacygrn->SalRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->SalRate->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_view_pharmacygrn_Discount" for="x_Discount" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Discount->caption() ?><?php echo ($view_pharmacygrn->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Discount->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_view_pharmacygrn_SSGST" for="x_SSGST" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->SSGST->caption() ?><?php echo ($view_pharmacygrn->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->SSGST->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_view_pharmacygrn_SCGST" for="x_SCGST" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->SCGST->caption() ?><?php echo ($view_pharmacygrn->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->SCGST->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->trid->Visible) { // trid ?>
	<div id="r_trid" class="form-group row">
		<label id="elh_view_pharmacygrn_trid" for="x_trid" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->trid->caption() ?><?php echo ($view_pharmacygrn->trid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->trid->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->CreatedBy->Visible) { // CreatedBy ?>
	<div id="r_CreatedBy" class="form-group row">
		<label id="elh_view_pharmacygrn_CreatedBy" for="x_CreatedBy" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->CreatedBy->caption() ?><?php echo ($view_pharmacygrn->CreatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->CreatedBy->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->CreatedDateTime->Visible) { // CreatedDateTime ?>
	<div id="r_CreatedDateTime" class="form-group row">
		<label id="elh_view_pharmacygrn_CreatedDateTime" for="x_CreatedDateTime" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->CreatedDateTime->caption() ?><?php echo ($view_pharmacygrn->CreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->CreatedDateTime->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->ModifiedBy->Visible) { // ModifiedBy ?>
	<div id="r_ModifiedBy" class="form-group row">
		<label id="elh_view_pharmacygrn_ModifiedBy" for="x_ModifiedBy" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->ModifiedBy->caption() ?><?php echo ($view_pharmacygrn->ModifiedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->ModifiedBy->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
	<div id="r_ModifiedDateTime" class="form-group row">
		<label id="elh_view_pharmacygrn_ModifiedDateTime" for="x_ModifiedDateTime" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->ModifiedDateTime->caption() ?><?php echo ($view_pharmacygrn->ModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->ModifiedDateTime->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->Received->Visible) { // Received ?>
	<div id="r_Received" class="form-group row">
		<label id="elh_view_pharmacygrn_Received" for="x_Received" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->Received->caption() ?><?php echo ($view_pharmacygrn->Received->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->Received->cellAttributes() ?>>
...
<?php if ($view_pharmacygrn->BillDate->Visible) { // BillDate ?>
	<div id="r_BillDate" class="form-group row">
		<label id="elh_view_pharmacygrn_BillDate" for="x_BillDate" class="<?php echo $view_pharmacygrn_add->LeftColumnClass ?>"><?php echo $view_pharmacygrn->BillDate->caption() ?><?php echo ($view_pharmacygrn->BillDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_pharmacygrn_add->RightColumnClass ?>"><div<?php echo $view_pharmacygrn->BillDate->cellAttributes() ?>>
