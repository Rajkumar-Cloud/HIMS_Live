...
var fview_semenanalysisadd = currentForm = new ew.Form("fview_semenanalysisadd", "add");
...
fview_semenanalysisadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_semenanalysisadd.lists["x_RIDNo"] = <?php echo $view_semenanalysis_add->RIDNo->Lookup->toClientList() ?>;
fview_semenanalysisadd.lists["x_RIDNo"].options = <?php echo JsonEncode($view_semenanalysis_add->RIDNo->lookupOptions()) ?>;
fview_semenanalysisadd.lists["x_PatientName"] = <?php echo $view_semenanalysis_add->PatientName->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_HusbandName"] = <?php echo $view_semenanalysis_add->HusbandName->Lookup->toClientList() ?>;
fview_semenanalysisadd.lists["x_HusbandName"].options = <?php echo JsonEncode($view_semenanalysis_add->HusbandName->lookupOptions()) ?>;
fview_semenanalysisadd.lists["x_RequestSample"] = <?php echo $view_semenanalysis_add->RequestSample->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_CollectionType"] = <?php echo $view_semenanalysis_add->CollectionType->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_CollectionMethod"] = <?php echo $view_semenanalysis_add->CollectionMethod->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_Medicationused"] = <?php echo $view_semenanalysis_add->Medicationused->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_DifficultiesinCollection"] = <?php echo $view_semenanalysis_add->DifficultiesinCollection->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_Homogenosity"] = <?php echo $view_semenanalysis_add->Homogenosity->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_CompleteSample"] = <?php echo $view_semenanalysis_add->CompleteSample->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_SemenOrgin"] = <?php echo $view_semenanalysis_add->SemenOrgin->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_Donor"] = <?php echo $view_semenanalysis_add->Donor->Lookup->toClientList() ?>;
fview_semenanalysisadd.lists["x_Donor"].options = <?php echo JsonEncode($view_semenanalysis_add->Donor->lookupOptions()) ?>;
fview_semenanalysisadd.lists["x_MACS[]"] = <?php echo $view_semenanalysis_add->MACS->Lookup->toClientList() ?>;
fview_semenanalysisadd.lists["x_MACS[]"].options = <?php echo JsonEncode($view_semenanalysis_add->MACS->options(FALSE, TRUE)) ?>;
fview_semenanalysisadd.lists["x_SPECIFIC_PROBLEMS"] = <?php echo $view_semenanalysis_add->SPECIFIC_PROBLEMS->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_LIQUIFACTION_STORAGE"] = <?php echo $view_semenanalysis_add->LIQUIFACTION_STORAGE->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_IUI_PREP_METHOD"] = <?php echo $view_semenanalysis_add->IUI_PREP_METHOD->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_TIME_FROM_TRIGGER"] = <?php echo $view_semenanalysis_add->TIME_FROM_TRIGGER->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_COLLECTION_TO_PREPARATION"] = <?php echo $view_semenanalysis_add->COLLECTION_TO_PREPARATION->Lookup->toClientList() ?>;
...
fview_semenanalysisadd.lists["x_TIME_FROM_PREP_TO_INSEM"] = <?php echo $view_semenanalysis_add->TIME_FROM_PREP_TO_INSEM->Lookup->toClientList() ?>;
...
<?php if ($view_semenanalysis_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_semenanalysis_add->Token ?>">
<?php } ?>
...
<?php if ($view_semenanalysis->PaID->Visible) { // PaID ?>
	<div id="r_PaID" class="form-group row">
		<label id="elh_view_semenanalysis_PaID" for="x_PaID" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PaID" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PaID->caption() ?><?php echo ($view_semenanalysis->PaID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PaID->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PaID" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->PaName->Visible) { // PaName ?>
	<div id="r_PaName" class="form-group row">
		<label id="elh_view_semenanalysis_PaName" for="x_PaName" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PaName" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PaName->caption() ?><?php echo ($view_semenanalysis->PaName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PaName->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PaName" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->PaMobile->Visible) { // PaMobile ?>
	<div id="r_PaMobile" class="form-group row">
		<label id="elh_view_semenanalysis_PaMobile" for="x_PaMobile" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PaMobile" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PaMobile->caption() ?><?php echo ($view_semenanalysis->PaMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PaMobile->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PaMobile" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->PartnerID->Visible) { // PartnerID ?>
	<div id="r_PartnerID" class="form-group row">
		<label id="elh_view_semenanalysis_PartnerID" for="x_PartnerID" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PartnerID" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PartnerID->caption() ?><?php echo ($view_semenanalysis->PartnerID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PartnerID->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PartnerID" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->PartnerName->Visible) { // PartnerName ?>
	<div id="r_PartnerName" class="form-group row">
		<label id="elh_view_semenanalysis_PartnerName" for="x_PartnerName" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PartnerName" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PartnerName->caption() ?><?php echo ($view_semenanalysis->PartnerName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PartnerName->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PartnerName" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->PartnerMobile->Visible) { // PartnerMobile ?>
	<div id="r_PartnerMobile" class="form-group row">
		<label id="elh_view_semenanalysis_PartnerMobile" for="x_PartnerMobile" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PartnerMobile" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PartnerMobile->caption() ?><?php echo ($view_semenanalysis->PartnerMobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PartnerMobile->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PartnerMobile" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->RIDNo->Visible) { // RIDNo ?>
	<div id="r_RIDNo" class="form-group row">
		<label id="elh_view_semenanalysis_RIDNo" for="x_RIDNo" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_RIDNo" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->RIDNo->caption() ?><?php echo ($view_semenanalysis->RIDNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->RIDNo->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_RIDNo" class="view_semenanalysisadd" type="text/html">
<span id="el_view_semenanalysis_RIDNo">
<?php $view_semenanalysis->RIDNo->EditAttrs["onchange"] = "ew.autoFill(this);" . @$view_semenanalysis->RIDNo->EditAttrs["onchange"]; ?>
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_RIDNo"><?php echo strval($view_semenanalysis->RIDNo->ViewValue) == "" ? $Language->phrase("PleaseSelect") : (REMOVE_XSS ? HtmlDecode($view_semenanalysis->RIDNo->ViewValue) : $view_semenanalysis->RIDNo->ViewValue) ?></div>
...
<?php if ($view_semenanalysis->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PatientName->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PatientName" class="view_semenanalysisadd" type="text/html">
...
<input type="hidden" data-table="view_semenanalysis" data-field="x_PatientName" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $view_semenanalysis->PatientName->displayValueSeparatorAttribute() ?>" name="x_PatientName" id="x_PatientName" value="<?php echo HtmlEncode($view_semenanalysis->PatientName->CurrentValue) ?>"<?php echo $wrkonchange ?>>
...
<?php if ($view_semenanalysis->HusbandName->Visible) { // HusbandName ?>
	<div id="r_HusbandName" class="form-group row">
		<label id="elh_view_semenanalysis_HusbandName" for="x_HusbandName" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_HusbandName" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->HusbandName->caption() ?><?php echo ($view_semenanalysis->HusbandName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->HusbandName->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_HusbandName" class="view_semenanalysisadd" type="text/html">
<span id="el_view_semenanalysis_HusbandName">
<?php $view_semenanalysis->HusbandName->EditAttrs["onchange"] = "ew.autoFill(this);" . @$view_semenanalysis->HusbandName->EditAttrs["onchange"]; ?>
<div class="input-group ew-lookup-list">
	<div class="form-control ew-lookup-text" tabindex="-1" id="lu_x_HusbandName"><?php echo strval($view_semenanalysis->HusbandName->ViewValue) == "" ? $Language->phrase("PleaseSelect") : (REMOVE_XSS ? HtmlDecode($view_semenanalysis->HusbandName->ViewValue) : $view_semenanalysis->HusbandName->ViewValue) ?></div>
	<div class="input-group-append">
...
<?php if ($view_semenanalysis->RequestDr->Visible) { // RequestDr ?>
	<div id="r_RequestDr" class="form-group row">
		<label id="elh_view_semenanalysis_RequestDr" for="x_RequestDr" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_RequestDr" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->RequestDr->caption() ?><?php echo ($view_semenanalysis->RequestDr->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->RequestDr->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_RequestDr" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->CollectionDate->Visible) { // CollectionDate ?>
	<div id="r_CollectionDate" class="form-group row">
		<label id="elh_view_semenanalysis_CollectionDate" for="x_CollectionDate" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_CollectionDate" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->CollectionDate->caption() ?><?php echo ($view_semenanalysis->CollectionDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->CollectionDate->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_CollectionDate" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->ResultDate->Visible) { // ResultDate ?>
	<div id="r_ResultDate" class="form-group row">
		<label id="elh_view_semenanalysis_ResultDate" for="x_ResultDate" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_ResultDate" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->ResultDate->caption() ?><?php echo ($view_semenanalysis->ResultDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->ResultDate->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_ResultDate" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->RequestSample->Visible) { // RequestSample ?>
	<div id="r_RequestSample" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->RequestSample->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_RequestSample" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->CollectionType->Visible) { // CollectionType ?>
	<div id="r_CollectionType" class="form-group row">
		<label id="elh_view_semenanalysis_CollectionType" for="x_CollectionType" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_CollectionType" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->CollectionType->caption() ?><?php echo ($view_semenanalysis->CollectionType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->CollectionType->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_CollectionType" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->CollectionMethod->Visible) { // CollectionMethod ?>
	<div id="r_CollectionMethod" class="form-group row">
		<label id="elh_view_semenanalysis_CollectionMethod" for="x_CollectionMethod" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_CollectionMethod" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->CollectionMethod->caption() ?><?php echo ($view_semenanalysis->CollectionMethod->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->CollectionMethod->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_CollectionMethod" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Medicationused->Visible) { // Medicationused ?>
	<div id="r_Medicationused" class="form-group row">
		<label id="elh_view_semenanalysis_Medicationused" for="x_Medicationused" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Medicationused" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Medicationused->caption() ?><?php echo ($view_semenanalysis->Medicationused->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Medicationused->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Medicationused" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->DifficultiesinCollection->Visible) { // DifficultiesinCollection ?>
	<div id="r_DifficultiesinCollection" class="form-group row">
		<label id="elh_view_semenanalysis_DifficultiesinCollection" for="x_DifficultiesinCollection" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_DifficultiesinCollection" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->DifficultiesinCollection->caption() ?><?php echo ($view_semenanalysis->DifficultiesinCollection->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->DifficultiesinCollection->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_DifficultiesinCollection" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Volume->Visible) { // Volume ?>
	<div id="r_Volume" class="form-group row">
		<label id="elh_view_semenanalysis_Volume" for="x_Volume" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Volume" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Volume->caption() ?><?php echo ($view_semenanalysis->Volume->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Volume->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Volume" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->pH->Visible) { // pH ?>
	<div id="r_pH" class="form-group row">
		<label id="elh_view_semenanalysis_pH" for="x_pH" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_pH" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->pH->caption() ?><?php echo ($view_semenanalysis->pH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->pH->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_pH" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Timeofcollection->Visible) { // Timeofcollection ?>
	<div id="r_Timeofcollection" class="form-group row">
		<label id="elh_view_semenanalysis_Timeofcollection" for="x_Timeofcollection" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Timeofcollection" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Timeofcollection->caption() ?><?php echo ($view_semenanalysis->Timeofcollection->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Timeofcollection->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Timeofcollection" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Timeofexamination->Visible) { // Timeofexamination ?>
	<div id="r_Timeofexamination" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Timeofexamination->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Timeofexamination" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Concentration->Visible) { // Concentration ?>
	<div id="r_Concentration" class="form-group row">
		<label id="elh_view_semenanalysis_Concentration" for="x_Concentration" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Concentration" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Concentration->caption() ?><?php echo ($view_semenanalysis->Concentration->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Concentration->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Concentration" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Total->Visible) { // Total ?>
	<div id="r_Total" class="form-group row">
		<label id="elh_view_semenanalysis_Total" for="x_Total" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Total" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Total->caption() ?><?php echo ($view_semenanalysis->Total->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Total->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Total" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->ProgressiveMotility->Visible) { // ProgressiveMotility ?>
	<div id="r_ProgressiveMotility" class="form-group row">
		<label id="elh_view_semenanalysis_ProgressiveMotility" for="x_ProgressiveMotility" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_ProgressiveMotility" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->ProgressiveMotility->caption() ?><?php echo ($view_semenanalysis->ProgressiveMotility->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->ProgressiveMotility->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_ProgressiveMotility" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->NonProgrssiveMotile->Visible) { // NonProgrssiveMotile ?>
	<div id="r_NonProgrssiveMotile" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->NonProgrssiveMotile->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_NonProgrssiveMotile" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Immotile->Visible) { // Immotile ?>
	<div id="r_Immotile" class="form-group row">
		<label id="elh_view_semenanalysis_Immotile" for="x_Immotile" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Immotile" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Immotile->caption() ?><?php echo ($view_semenanalysis->Immotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Immotile->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Immotile" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TotalProgrssiveMotile->Visible) { // TotalProgrssiveMotile ?>
	<div id="r_TotalProgrssiveMotile" class="form-group row">
		<label id="elh_view_semenanalysis_TotalProgrssiveMotile" for="x_TotalProgrssiveMotile" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_TotalProgrssiveMotile" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->TotalProgrssiveMotile->caption() ?><?php echo ($view_semenanalysis->TotalProgrssiveMotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TotalProgrssiveMotile->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TotalProgrssiveMotile" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Appearance->Visible) { // Appearance ?>
	<div id="r_Appearance" class="form-group row">
		<label id="elh_view_semenanalysis_Appearance" for="x_Appearance" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Appearance" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Appearance->caption() ?><?php echo ($view_semenanalysis->Appearance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Appearance->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Appearance" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Homogenosity->Visible) { // Homogenosity ?>
	<div id="r_Homogenosity" class="form-group row">
		<label id="elh_view_semenanalysis_Homogenosity" for="x_Homogenosity" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Homogenosity" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Homogenosity->caption() ?><?php echo ($view_semenanalysis->Homogenosity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Homogenosity->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Homogenosity" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->CompleteSample->Visible) { // CompleteSample ?>
	<div id="r_CompleteSample" class="form-group row">
		<label id="elh_view_semenanalysis_CompleteSample" for="x_CompleteSample" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_CompleteSample" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->CompleteSample->caption() ?><?php echo ($view_semenanalysis->CompleteSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->CompleteSample->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_CompleteSample" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Liquefactiontime->Visible) { // Liquefactiontime ?>
	<div id="r_Liquefactiontime" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Liquefactiontime->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Liquefactiontime" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Normal->Visible) { // Normal ?>
	<div id="r_Normal" class="form-group row">
		<label id="elh_view_semenanalysis_Normal" for="x_Normal" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Normal" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Normal->caption() ?><?php echo ($view_semenanalysis->Normal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Normal->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Normal" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Abnormal->Visible) { // Abnormal ?>
	<div id="r_Abnormal" class="form-group row">
		<label id="elh_view_semenanalysis_Abnormal" for="x_Abnormal" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Abnormal" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Abnormal->caption() ?><?php echo ($view_semenanalysis->Abnormal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Abnormal->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Abnormal" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Headdefects->Visible) { // Headdefects ?>
	<div id="r_Headdefects" class="form-group row">
		<label id="elh_view_semenanalysis_Headdefects" for="x_Headdefects" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Headdefects" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Headdefects->caption() ?><?php echo ($view_semenanalysis->Headdefects->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Headdefects->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Headdefects" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->MidpieceDefects->Visible) { // MidpieceDefects ?>
	<div id="r_MidpieceDefects" class="form-group row">
		<label id="elh_view_semenanalysis_MidpieceDefects" for="x_MidpieceDefects" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_MidpieceDefects" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->MidpieceDefects->caption() ?><?php echo ($view_semenanalysis->MidpieceDefects->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->MidpieceDefects->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_MidpieceDefects" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TailDefects->Visible) { // TailDefects ?>
	<div id="r_TailDefects" class="form-group row">
		<label id="elh_view_semenanalysis_TailDefects" for="x_TailDefects" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_TailDefects" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->TailDefects->caption() ?><?php echo ($view_semenanalysis->TailDefects->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TailDefects->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TailDefects" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->NormalProgMotile->Visible) { // NormalProgMotile ?>
	<div id="r_NormalProgMotile" class="form-group row">
		<label id="elh_view_semenanalysis_NormalProgMotile" for="x_NormalProgMotile" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_NormalProgMotile" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->NormalProgMotile->caption() ?><?php echo ($view_semenanalysis->NormalProgMotile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->NormalProgMotile->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_NormalProgMotile" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->ImmatureForms->Visible) { // ImmatureForms ?>
	<div id="r_ImmatureForms" class="form-group row">
		<label id="elh_view_semenanalysis_ImmatureForms" for="x_ImmatureForms" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_ImmatureForms" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->ImmatureForms->caption() ?><?php echo ($view_semenanalysis->ImmatureForms->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->ImmatureForms->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_ImmatureForms" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Leucocytes->Visible) { // Leucocytes ?>
	<div id="r_Leucocytes" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Leucocytes->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Leucocytes" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Agglutination->Visible) { // Agglutination ?>
	<div id="r_Agglutination" class="form-group row">
		<label id="elh_view_semenanalysis_Agglutination" for="x_Agglutination" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Agglutination" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Agglutination->caption() ?><?php echo ($view_semenanalysis->Agglutination->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Agglutination->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Agglutination" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Debris->Visible) { // Debris ?>
	<div id="r_Debris" class="form-group row">
		<label id="elh_view_semenanalysis_Debris" for="x_Debris" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Debris" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Debris->caption() ?><?php echo ($view_semenanalysis->Debris->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Debris->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Debris" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Diagnosis->Visible) { // Diagnosis ?>
	<div id="r_Diagnosis" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Diagnosis->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Diagnosis" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Observations->Visible) { // Observations ?>
	<div id="r_Observations" class="form-group row">
		<label id="elh_view_semenanalysis_Observations" for="x_Observations" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Observations" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Observations->caption() ?><?php echo ($view_semenanalysis->Observations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Observations->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Observations" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Signature->Visible) { // Signature ?>
	<div id="r_Signature" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Signature->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Signature" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->SemenOrgin->Visible) { // SemenOrgin ?>
	<div id="r_SemenOrgin" class="form-group row">
		<label id="elh_view_semenanalysis_SemenOrgin" for="x_SemenOrgin" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_SemenOrgin" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->SemenOrgin->caption() ?><?php echo ($view_semenanalysis->SemenOrgin->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->SemenOrgin->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_SemenOrgin" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Donor->Visible) { // Donor ?>
	<div id="r_Donor" class="form-group row">
		<label id="elh_view_semenanalysis_Donor" for="x_Donor" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Donor" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Donor->caption() ?><?php echo ($view_semenanalysis->Donor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Donor->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Donor" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->DonorBloodgroup->Visible) { // DonorBloodgroup ?>
	<div id="r_DonorBloodgroup" class="form-group row">
		<label id="elh_view_semenanalysis_DonorBloodgroup" for="x_DonorBloodgroup" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_DonorBloodgroup" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->DonorBloodgroup->caption() ?><?php echo ($view_semenanalysis->DonorBloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->DonorBloodgroup->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_DonorBloodgroup" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Tank->Visible) { // Tank ?>
	<div id="r_Tank" class="form-group row">
		<label id="elh_view_semenanalysis_Tank" for="x_Tank" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Tank" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Tank->caption() ?><?php echo ($view_semenanalysis->Tank->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Tank->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Tank" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Location->Visible) { // Location ?>
	<div id="r_Location" class="form-group row">
		<label id="elh_view_semenanalysis_Location" for="x_Location" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Location" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Location->caption() ?><?php echo ($view_semenanalysis->Location->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Location->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Location" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Volume1->Visible) { // Volume1 ?>
	<div id="r_Volume1" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Volume1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Volume1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Concentration1->Visible) { // Concentration1 ?>
	<div id="r_Concentration1" class="form-group row">
		<label id="elh_view_semenanalysis_Concentration1" for="x_Concentration1" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Concentration1" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Concentration1->caption() ?><?php echo ($view_semenanalysis->Concentration1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Concentration1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Concentration1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Total1->Visible) { // Total1 ?>
	<div id="r_Total1" class="form-group row">
		<label id="elh_view_semenanalysis_Total1" for="x_Total1" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Total1" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Total1->caption() ?><?php echo ($view_semenanalysis->Total1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Total1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Total1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->ProgressiveMotility1->Visible) { // ProgressiveMotility1 ?>
	<div id="r_ProgressiveMotility1" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->ProgressiveMotility1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_ProgressiveMotility1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->NonProgrssiveMotile1->Visible) { // NonProgrssiveMotile1 ?>
	<div id="r_NonProgrssiveMotile1" class="form-group row">
		<label id="elh_view_semenanalysis_NonProgrssiveMotile1" for="x_NonProgrssiveMotile1" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_NonProgrssiveMotile1" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->NonProgrssiveMotile1->caption() ?><?php echo ($view_semenanalysis->NonProgrssiveMotile1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->NonProgrssiveMotile1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_NonProgrssiveMotile1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Immotile1->Visible) { // Immotile1 ?>
	<div id="r_Immotile1" class="form-group row">
		<label id="elh_view_semenanalysis_Immotile1" for="x_Immotile1" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Immotile1" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Immotile1->caption() ?><?php echo ($view_semenanalysis->Immotile1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Immotile1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Immotile1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TotalProgrssiveMotile1->Visible) { // TotalProgrssiveMotile1 ?>
	<div id="r_TotalProgrssiveMotile1" class="form-group row">
		<label id="elh_view_semenanalysis_TotalProgrssiveMotile1" for="x_TotalProgrssiveMotile1" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_TotalProgrssiveMotile1" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->TotalProgrssiveMotile1->caption() ?><?php echo ($view_semenanalysis->TotalProgrssiveMotile1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TotalProgrssiveMotile1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TotalProgrssiveMotile1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_view_semenanalysis_TidNo" for="x_TidNo" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_TidNo" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->TidNo->caption() ?><?php echo ($view_semenanalysis->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TidNo->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TidNo" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Color->Visible) { // Color ?>
	<div id="r_Color" class="form-group row">
		<label id="elh_view_semenanalysis_Color" for="x_Color" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Color" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Color->caption() ?><?php echo ($view_semenanalysis->Color->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Color->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Color" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->DoneBy->Visible) { // DoneBy ?>
	<div id="r_DoneBy" class="form-group row">
		<label id="elh_view_semenanalysis_DoneBy" for="x_DoneBy" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_DoneBy" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->DoneBy->caption() ?><?php echo ($view_semenanalysis->DoneBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->DoneBy->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_DoneBy" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_view_semenanalysis_Method" for="x_Method" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Method" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Method->caption() ?><?php echo ($view_semenanalysis->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Method->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Method" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Abstinence->Visible) { // Abstinence ?>
	<div id="r_Abstinence" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Abstinence->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Abstinence" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->ProcessedBy->Visible) { // ProcessedBy ?>
	<div id="r_ProcessedBy" class="form-group row">
		<label id="elh_view_semenanalysis_ProcessedBy" for="x_ProcessedBy" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_ProcessedBy" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->ProcessedBy->caption() ?><?php echo ($view_semenanalysis->ProcessedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->ProcessedBy->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_ProcessedBy" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->InseminationTime->Visible) { // InseminationTime ?>
	<div id="r_InseminationTime" class="form-group row">
		<label id="elh_view_semenanalysis_InseminationTime" for="x_InseminationTime" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_InseminationTime" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->InseminationTime->caption() ?><?php echo ($view_semenanalysis->InseminationTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->InseminationTime->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_InseminationTime" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->InseminationBy->Visible) { // InseminationBy ?>
	<div id="r_InseminationBy" class="form-group row">
		<label id="elh_view_semenanalysis_InseminationBy" for="x_InseminationBy" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_InseminationBy" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->InseminationBy->caption() ?><?php echo ($view_semenanalysis->InseminationBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->InseminationBy->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_InseminationBy" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Big->Visible) { // Big ?>
	<div id="r_Big" class="form-group row">
		<label id="elh_view_semenanalysis_Big" for="x_Big" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Big" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Big->caption() ?><?php echo ($view_semenanalysis->Big->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Big->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Big" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Medium->Visible) { // Medium ?>
	<div id="r_Medium" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Medium->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Medium" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Small->Visible) { // Small ?>
	<div id="r_Small" class="form-group row">
		<label id="elh_view_semenanalysis_Small" for="x_Small" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Small" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Small->caption() ?><?php echo ($view_semenanalysis->Small->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Small->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Small" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->NoHalo->Visible) { // NoHalo ?>
	<div id="r_NoHalo" class="form-group row">
		<label id="elh_view_semenanalysis_NoHalo" for="x_NoHalo" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_NoHalo" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->NoHalo->caption() ?><?php echo ($view_semenanalysis->NoHalo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->NoHalo->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_NoHalo" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Fragmented->Visible) { // Fragmented ?>
	<div id="r_Fragmented" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Fragmented->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Fragmented" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->NonFragmented->Visible) { // NonFragmented ?>
	<div id="r_NonFragmented" class="form-group row">
		<label id="elh_view_semenanalysis_NonFragmented" for="x_NonFragmented" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_NonFragmented" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->NonFragmented->caption() ?><?php echo ($view_semenanalysis->NonFragmented->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->NonFragmented->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_NonFragmented" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->DFI->Visible) { // DFI ?>
	<div id="r_DFI" class="form-group row">
		<label id="elh_view_semenanalysis_DFI" for="x_DFI" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_DFI" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->DFI->caption() ?><?php echo ($view_semenanalysis->DFI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->DFI->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_DFI" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->IsueBy->Visible) { // IsueBy ?>
	<div id="r_IsueBy" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->IsueBy->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_IsueBy" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Volume2->Visible) { // Volume2 ?>
	<div id="r_Volume2" class="form-group row">
		<label id="elh_view_semenanalysis_Volume2" for="x_Volume2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Volume2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Volume2->caption() ?><?php echo ($view_semenanalysis->Volume2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Volume2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Volume2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Concentration2->Visible) { // Concentration2 ?>
	<div id="r_Concentration2" class="form-group row">
		<label id="elh_view_semenanalysis_Concentration2" for="x_Concentration2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Concentration2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Concentration2->caption() ?><?php echo ($view_semenanalysis->Concentration2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Concentration2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Concentration2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Total2->Visible) { // Total2 ?>
	<div id="r_Total2" class="form-group row">
		<label id="elh_view_semenanalysis_Total2" for="x_Total2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Total2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Total2->caption() ?><?php echo ($view_semenanalysis->Total2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Total2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Total2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->ProgressiveMotility2->Visible) { // ProgressiveMotility2 ?>
	<div id="r_ProgressiveMotility2" class="form-group row">
		<label id="elh_view_semenanalysis_ProgressiveMotility2" for="x_ProgressiveMotility2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_ProgressiveMotility2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->ProgressiveMotility2->caption() ?><?php echo ($view_semenanalysis->ProgressiveMotility2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->ProgressiveMotility2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_ProgressiveMotility2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->NonProgrssiveMotile2->Visible) { // NonProgrssiveMotile2 ?>
	<div id="r_NonProgrssiveMotile2" class="form-group row">
		<label id="elh_view_semenanalysis_NonProgrssiveMotile2" for="x_NonProgrssiveMotile2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_NonProgrssiveMotile2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->NonProgrssiveMotile2->caption() ?><?php echo ($view_semenanalysis->NonProgrssiveMotile2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->NonProgrssiveMotile2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_NonProgrssiveMotile2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->Immotile2->Visible) { // Immotile2 ?>
	<div id="r_Immotile2" class="form-group row">
		<label id="elh_view_semenanalysis_Immotile2" for="x_Immotile2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_Immotile2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->Immotile2->caption() ?><?php echo ($view_semenanalysis->Immotile2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->Immotile2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_Immotile2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TotalProgrssiveMotile2->Visible) { // TotalProgrssiveMotile2 ?>
	<div id="r_TotalProgrssiveMotile2" class="form-group row">
		<label id="elh_view_semenanalysis_TotalProgrssiveMotile2" for="x_TotalProgrssiveMotile2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_TotalProgrssiveMotile2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->TotalProgrssiveMotile2->caption() ?><?php echo ($view_semenanalysis->TotalProgrssiveMotile2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TotalProgrssiveMotile2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TotalProgrssiveMotile2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->IssuedBy->Visible) { // IssuedBy ?>
	<div id="r_IssuedBy" class="form-group row">
		<label id="elh_view_semenanalysis_IssuedBy" for="x_IssuedBy" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_IssuedBy" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->IssuedBy->caption() ?><?php echo ($view_semenanalysis->IssuedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->IssuedBy->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_IssuedBy" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->IssuedTo->Visible) { // IssuedTo ?>
	<div id="r_IssuedTo" class="form-group row">
		<label id="elh_view_semenanalysis_IssuedTo" for="x_IssuedTo" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_IssuedTo" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->IssuedTo->caption() ?><?php echo ($view_semenanalysis->IssuedTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->IssuedTo->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_IssuedTo" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->MACS->Visible) { // MACS ?>
	<div id="r_MACS" class="form-group row">
		<label id="elh_view_semenanalysis_MACS" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_MACS" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->MACS->caption() ?><?php echo ($view_semenanalysis->MACS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->MACS->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_MACS" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->PREG_TEST_DATE->Visible) { // PREG_TEST_DATE ?>
	<div id="r_PREG_TEST_DATE" class="form-group row">
		<label id="elh_view_semenanalysis_PREG_TEST_DATE" for="x_PREG_TEST_DATE" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_PREG_TEST_DATE" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->PREG_TEST_DATE->caption() ?><?php echo ($view_semenanalysis->PREG_TEST_DATE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->PREG_TEST_DATE->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_PREG_TEST_DATE" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->SPECIFIC_PROBLEMS->Visible) { // SPECIFIC_PROBLEMS ?>
	<div id="r_SPECIFIC_PROBLEMS" class="form-group row">
		<label id="elh_view_semenanalysis_SPECIFIC_PROBLEMS" for="x_SPECIFIC_PROBLEMS" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_SPECIFIC_PROBLEMS" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->SPECIFIC_PROBLEMS->caption() ?><?php echo ($view_semenanalysis->SPECIFIC_PROBLEMS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->SPECIFIC_PROBLEMS->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_SPECIFIC_PROBLEMS" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->IMSC_1->Visible) { // IMSC_1 ?>
	<div id="r_IMSC_1" class="form-group row">
		<label id="elh_view_semenanalysis_IMSC_1" for="x_IMSC_1" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_IMSC_1" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->IMSC_1->caption() ?><?php echo ($view_semenanalysis->IMSC_1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->IMSC_1->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_IMSC_1" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->IMSC_2->Visible) { // IMSC_2 ?>
	<div id="r_IMSC_2" class="form-group row">
		<label id="elh_view_semenanalysis_IMSC_2" for="x_IMSC_2" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_IMSC_2" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->IMSC_2->caption() ?><?php echo ($view_semenanalysis->IMSC_2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->IMSC_2->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_IMSC_2" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->LIQUIFACTION_STORAGE->Visible) { // LIQUIFACTION_STORAGE ?>
	<div id="r_LIQUIFACTION_STORAGE" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->LIQUIFACTION_STORAGE->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_LIQUIFACTION_STORAGE" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->IUI_PREP_METHOD->Visible) { // IUI_PREP_METHOD ?>
	<div id="r_IUI_PREP_METHOD" class="form-group row">
		<label id="elh_view_semenanalysis_IUI_PREP_METHOD" for="x_IUI_PREP_METHOD" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_IUI_PREP_METHOD" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->IUI_PREP_METHOD->caption() ?><?php echo ($view_semenanalysis->IUI_PREP_METHOD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->IUI_PREP_METHOD->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_IUI_PREP_METHOD" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TIME_FROM_TRIGGER->Visible) { // TIME_FROM_TRIGGER ?>
	<div id="r_TIME_FROM_TRIGGER" class="form-group row">
		<label id="elh_view_semenanalysis_TIME_FROM_TRIGGER" for="x_TIME_FROM_TRIGGER" class="<?php echo $view_semenanalysis_add->LeftColumnClass ?>"><script id="tpc_view_semenanalysis_TIME_FROM_TRIGGER" class="view_semenanalysisadd" type="text/html"><span><?php echo $view_semenanalysis->TIME_FROM_TRIGGER->caption() ?><?php echo ($view_semenanalysis->TIME_FROM_TRIGGER->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TIME_FROM_TRIGGER->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TIME_FROM_TRIGGER" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->COLLECTION_TO_PREPARATION->Visible) { // COLLECTION_TO_PREPARATION ?>
	<div id="r_COLLECTION_TO_PREPARATION" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->COLLECTION_TO_PREPARATION->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_COLLECTION_TO_PREPARATION" class="view_semenanalysisadd" type="text/html">
...
<?php if ($view_semenanalysis->TIME_FROM_PREP_TO_INSEM->Visible) { // TIME_FROM_PREP_TO_INSEM ?>
	<div id="r_TIME_FROM_PREP_TO_INSEM" class="form-group row">
		...
		<div class="<?php echo $view_semenanalysis_add->RightColumnClass ?>"><div<?php echo $view_semenanalysis->TIME_FROM_PREP_TO_INSEM->cellAttributes() ?>>
<script id="tpx_view_semenanalysis_TIME_FROM_PREP_TO_INSEM" class="view_semenanalysisadd" type="text/html">
...
<div class="row">
	<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_view_semenanalysis_HusbandName"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_HusbandName"/}}</h3>
	</div>
		<div class="col-4">
		<h3 class="card-title"></h3>
	</div>
		<div class="col-4">
		<h3 class="card-title">{{include tmpl="#tpc_view_semenanalysis_RIDNo"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_RIDNo"/}}</h3>
	</div>
</div>
<div id="divCheckbox" style="display: none;">
{{include tmpl="#tpc_view_semenanalysis_PaID"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PaID"/}}
{{include tmpl="#tpc_view_semenanalysis_PaName"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PaName"/}}
{{include tmpl="#tpc_view_semenanalysis_PatientName"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PatientName"/}}
{{include tmpl="#tpc_view_semenanalysis_PaMobile"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PaMobile"/}}
{{include tmpl="#tpc_view_semenanalysis_PartnerID"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PartnerID"/}}
{{include tmpl="#tpc_view_semenanalysis_PartnerName"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PartnerName"/}}
{{include tmpl="#tpc_view_semenanalysis_PartnerMobile"/}}&nbsp;{{include tmpl="#tpx_view_semenanalysis_PartnerMobile"/}}
</div>
<div class="row">
...
ew.applyTemplate("tpd_view_semenanalysisadd", "tpm_view_semenanalysisadd", "view_semenanalysisadd", "<?php echo $view_semenanalysis->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.view_semenanalysisadd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
