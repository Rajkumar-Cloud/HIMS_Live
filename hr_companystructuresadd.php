...
// Create page object
$hr_companystructures_add = new hr_companystructures_add();

// Run the page
$hr_companystructures_add->run();
...
$hr_companystructures_add->Page_Render();
?>
...
var fhr_companystructuresadd = currentForm = new ew.Form("fhr_companystructuresadd", "add");

// Validate form
fhr_companystructuresadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($hr_companystructures_add->title->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->address->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->type->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->country->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->parent->Required) { ?>
		...
		<?php if ($hr_companystructures_add->timezone->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->heads->Required) { ?>
		...
		<?php } ?>
		<?php if ($hr_companystructures_add->HospID->Required) { ?>
...
fhr_companystructuresadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fhr_companystructuresadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fhr_companystructuresadd.lists["x_type"] = <?php echo $hr_companystructures_add->type->Lookup->toClientList() ?>;
fhr_companystructuresadd.lists["x_type"].options = <?php echo JsonEncode($hr_companystructures_add->type->options(FALSE, TRUE)) ?>;
...
<?php $hr_companystructures_add->showPageHeader(); ?>
<?php
$hr_companystructures_add->showMessage();
?>
<form name="fhr_companystructuresadd" id="fhr_companystructuresadd" class="<?php echo $hr_companystructures_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($hr_companystructures_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $hr_companystructures_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="hr_companystructures">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$hr_companystructures_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($hr_companystructures->title->Visible) { // title ?>
	<div id="r_title" class="form-group row">
		<label id="elh_hr_companystructures_title" for="x_title" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->title->caption() ?><?php echo ($hr_companystructures->title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->title->cellAttributes() ?>>
...
<?php if ($hr_companystructures->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_hr_companystructures_description" for="x_description" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->description->caption() ?><?php echo ($hr_companystructures->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->description->cellAttributes() ?>>
...
<?php if ($hr_companystructures->address->Visible) { // address ?>
	<div id="r_address" class="form-group row">
		<label id="elh_hr_companystructures_address" for="x_address" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->address->caption() ?><?php echo ($hr_companystructures->address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->address->cellAttributes() ?>>
...
<?php if ($hr_companystructures->type->Visible) { // type ?>
	<div id="r_type" class="form-group row">
		<label id="elh_hr_companystructures_type" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->type->caption() ?><?php echo ($hr_companystructures->type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->type->cellAttributes() ?>>
...
<?php if ($hr_companystructures->country->Visible) { // country ?>
	<div id="r_country" class="form-group row">
		<label id="elh_hr_companystructures_country" for="x_country" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->country->caption() ?><?php echo ($hr_companystructures->country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->country->cellAttributes() ?>>
...
<?php if ($hr_companystructures->parent->Visible) { // parent ?>
	<div id="r_parent" class="form-group row">
		<label id="elh_hr_companystructures_parent" for="x_parent" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->parent->caption() ?><?php echo ($hr_companystructures->parent->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->parent->cellAttributes() ?>>
...
<?php if ($hr_companystructures->timezone->Visible) { // timezone ?>
	<div id="r_timezone" class="form-group row">
		<label id="elh_hr_companystructures_timezone" for="x_timezone" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->timezone->caption() ?><?php echo ($hr_companystructures->timezone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->timezone->cellAttributes() ?>>
...
<?php if ($hr_companystructures->heads->Visible) { // heads ?>
	<div id="r_heads" class="form-group row">
		<label id="elh_hr_companystructures_heads" for="x_heads" class="<?php echo $hr_companystructures_add->LeftColumnClass ?>"><?php echo $hr_companystructures->heads->caption() ?><?php echo ($hr_companystructures->heads->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $hr_companystructures_add->RightColumnClass ?>"><div<?php echo $hr_companystructures->heads->cellAttributes() ?>>
...
<?php if (!$hr_companystructures_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $hr_companystructures_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $hr_companystructures_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$hr_companystructures_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$hr_companystructures_add->terminate();
?>