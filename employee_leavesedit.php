...
// Create page object
$employee_leaves_edit = new employee_leaves_edit();

// Run the page
$employee_leaves_edit->run();
...
$employee_leaves_edit->Page_Render();
?>
...
var femployee_leavesedit = currentForm = new ew.Form("femployee_leavesedit", "edit");
...
femployee_leavesedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($employee_leaves_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $employee_leaves->id->caption(), $employee_leaves->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($employee_leaves_edit->employee->Required) { ?>
		...
		<?php if ($employee_leaves_edit->leave_type->Required) { ?>
		...
		<?php if ($employee_leaves_edit->leave_period->Required) { ?>
		...
		<?php if ($employee_leaves_edit->date_start->Required) { ?>
		...
		<?php if ($employee_leaves_edit->date_end->Required) { ?>
		...
		<?php if ($employee_leaves_edit->details->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_leaves_edit->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($employee_leaves_edit->attachment->Required) { ?>
...
femployee_leavesedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
femployee_leavesedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
femployee_leavesedit.lists["x_status"] = <?php echo $employee_leaves_edit->status->Lookup->toClientList() ?>;
femployee_leavesedit.lists["x_status"].options = <?php echo JsonEncode($employee_leaves_edit->status->options(FALSE, TRUE)) ?>;
...
<?php $employee_leaves_edit->showPageHeader(); ?>
<?php
$employee_leaves_edit->showMessage();
?>
<form name="femployee_leavesedit" id="femployee_leavesedit" class="<?php echo $employee_leaves_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($employee_leaves_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $employee_leaves_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="employee_leaves">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$employee_leaves_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($employee_leaves->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_employee_leaves_id" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->id->caption() ?><?php echo ($employee_leaves->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->id->cellAttributes() ?>>
<span id="el_employee_leaves_id">
<span<?php echo $employee_leaves->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($employee_leaves->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="employee_leaves" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($employee_leaves->id->CurrentValue) ?>">
<?php echo $employee_leaves->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($employee_leaves->employee->Visible) { // employee ?>
	<div id="r_employee" class="form-group row">
		<label id="elh_employee_leaves_employee" for="x_employee" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->employee->caption() ?><?php echo ($employee_leaves->employee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->employee->cellAttributes() ?>>
...
<?php if ($employee_leaves->leave_type->Visible) { // leave_type ?>
	<div id="r_leave_type" class="form-group row">
		<label id="elh_employee_leaves_leave_type" for="x_leave_type" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->leave_type->caption() ?><?php echo ($employee_leaves->leave_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->leave_type->cellAttributes() ?>>
...
<?php if ($employee_leaves->leave_period->Visible) { // leave_period ?>
	<div id="r_leave_period" class="form-group row">
		<label id="elh_employee_leaves_leave_period" for="x_leave_period" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->leave_period->caption() ?><?php echo ($employee_leaves->leave_period->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->leave_period->cellAttributes() ?>>
...
<?php if ($employee_leaves->date_start->Visible) { // date_start ?>
	<div id="r_date_start" class="form-group row">
		<label id="elh_employee_leaves_date_start" for="x_date_start" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->date_start->caption() ?><?php echo ($employee_leaves->date_start->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->date_start->cellAttributes() ?>>
...
<?php if ($employee_leaves->date_end->Visible) { // date_end ?>
	<div id="r_date_end" class="form-group row">
		<label id="elh_employee_leaves_date_end" for="x_date_end" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->date_end->caption() ?><?php echo ($employee_leaves->date_end->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->date_end->cellAttributes() ?>>
...
<?php if ($employee_leaves->details->Visible) { // details ?>
	<div id="r_details" class="form-group row">
		<label id="elh_employee_leaves_details" for="x_details" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->details->caption() ?><?php echo ($employee_leaves->details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->details->cellAttributes() ?>>
...
<?php if ($employee_leaves->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_employee_leaves_status" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->status->caption() ?><?php echo ($employee_leaves->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->status->cellAttributes() ?>>
...
<?php if ($employee_leaves->attachment->Visible) { // attachment ?>
	<div id="r_attachment" class="form-group row">
		<label id="elh_employee_leaves_attachment" for="x_attachment" class="<?php echo $employee_leaves_edit->LeftColumnClass ?>"><?php echo $employee_leaves->attachment->caption() ?><?php echo ($employee_leaves->attachment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $employee_leaves_edit->RightColumnClass ?>"><div<?php echo $employee_leaves->attachment->cellAttributes() ?>>
...
<?php if (!$employee_leaves_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $employee_leaves_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $employee_leaves_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$employee_leaves_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$employee_leaves_edit->terminate();
?>