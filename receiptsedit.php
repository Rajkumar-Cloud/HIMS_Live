...
var freceiptsedit = currentForm = new ew.Form("freceiptsedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($receipts_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $receipts->id->caption(), $receipts->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
freceiptsedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($receipts_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $receipts_edit->Token ?>">
<?php } ?>
...
<?php if ($receipts->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_receipts_id" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->id->caption() ?><?php echo ($receipts->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->id->cellAttributes() ?>>
<span id="el_receipts_id">
<span<?php echo $receipts->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($receipts->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="receipts" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($receipts->id->CurrentValue) ?>">
<?php echo $receipts->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($receipts->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_receipts_Reception" for="x_Reception" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->Reception->caption() ?><?php echo ($receipts->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->Reception->cellAttributes() ?>>
...
<?php if ($receipts->Aid->Visible) { // Aid ?>
	<div id="r_Aid" class="form-group row">
		<label id="elh_receipts_Aid" for="x_Aid" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->Aid->caption() ?><?php echo ($receipts->Aid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->Aid->cellAttributes() ?>>
...
<?php if ($receipts->Vid->Visible) { // Vid ?>
	<div id="r_Vid" class="form-group row">
		<label id="elh_receipts_Vid" for="x_Vid" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->Vid->caption() ?><?php echo ($receipts->Vid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->Vid->cellAttributes() ?>>
...
<?php if ($receipts->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_receipts_patient_id" for="x_patient_id" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->patient_id->caption() ?><?php echo ($receipts->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->patient_id->cellAttributes() ?>>
...
<?php if ($receipts->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_receipts_mrnno" for="x_mrnno" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->mrnno->caption() ?><?php echo ($receipts->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->mrnno->cellAttributes() ?>>
...
<?php if ($receipts->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_receipts_PatientName" for="x_PatientName" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->PatientName->caption() ?><?php echo ($receipts->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->PatientName->cellAttributes() ?>>
...
<?php if ($receipts->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group row">
		<label id="elh_receipts_amount" for="x_amount" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->amount->caption() ?><?php echo ($receipts->amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->amount->cellAttributes() ?>>
...
<?php if ($receipts->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_receipts_Discount" for="x_Discount" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->Discount->caption() ?><?php echo ($receipts->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->Discount->cellAttributes() ?>>
...
<?php if ($receipts->SubTotal->Visible) { // SubTotal ?>
	<div id="r_SubTotal" class="form-group row">
		<label id="elh_receipts_SubTotal" for="x_SubTotal" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->SubTotal->caption() ?><?php echo ($receipts->SubTotal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->SubTotal->cellAttributes() ?>>
...
<?php if ($receipts->patient_type->Visible) { // patient_type ?>
	<div id="r_patient_type" class="form-group row">
		<label id="elh_receipts_patient_type" for="x_patient_type" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->patient_type->caption() ?><?php echo ($receipts->patient_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->patient_type->cellAttributes() ?>>
...
<?php if ($receipts->invoiceId->Visible) { // invoiceId ?>
	<div id="r_invoiceId" class="form-group row">
		<label id="elh_receipts_invoiceId" for="x_invoiceId" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->invoiceId->caption() ?><?php echo ($receipts->invoiceId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->invoiceId->cellAttributes() ?>>
...
<?php if ($receipts->invoiceAmount->Visible) { // invoiceAmount ?>
	<div id="r_invoiceAmount" class="form-group row">
		<label id="elh_receipts_invoiceAmount" for="x_invoiceAmount" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->invoiceAmount->caption() ?><?php echo ($receipts->invoiceAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->invoiceAmount->cellAttributes() ?>>
...
<?php if ($receipts->invoiceStatus->Visible) { // invoiceStatus ?>
	<div id="r_invoiceStatus" class="form-group row">
		<label id="elh_receipts_invoiceStatus" for="x_invoiceStatus" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->invoiceStatus->caption() ?><?php echo ($receipts->invoiceStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->invoiceStatus->cellAttributes() ?>>
...
<?php if ($receipts->modeOfPayment->Visible) { // modeOfPayment ?>
	<div id="r_modeOfPayment" class="form-group row">
		<label id="elh_receipts_modeOfPayment" for="x_modeOfPayment" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->modeOfPayment->caption() ?><?php echo ($receipts->modeOfPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->modeOfPayment->cellAttributes() ?>>
...
<?php if ($receipts->charged_date->Visible) { // charged_date ?>
	<div id="r_charged_date" class="form-group row">
		<label id="elh_receipts_charged_date" for="x_charged_date" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->charged_date->caption() ?><?php echo ($receipts->charged_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->charged_date->cellAttributes() ?>>
...
<?php if ($receipts->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_receipts_status" for="x_status" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->status->caption() ?><?php echo ($receipts->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->status->cellAttributes() ?>>
...
<?php if ($receipts->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_receipts_createdby" for="x_createdby" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->createdby->caption() ?><?php echo ($receipts->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->createdby->cellAttributes() ?>>
...
<?php if ($receipts->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_receipts_createddatetime" for="x_createddatetime" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->createddatetime->caption() ?><?php echo ($receipts->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->createddatetime->cellAttributes() ?>>
...
<?php if ($receipts->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_receipts_modifiedby" for="x_modifiedby" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->modifiedby->caption() ?><?php echo ($receipts->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->modifiedby->cellAttributes() ?>>
...
<?php if ($receipts->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_receipts_modifieddatetime" for="x_modifieddatetime" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->modifieddatetime->caption() ?><?php echo ($receipts->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->modifieddatetime->cellAttributes() ?>>
...
<?php if ($receipts->ChequeCardNo->Visible) { // ChequeCardNo ?>
	<div id="r_ChequeCardNo" class="form-group row">
		<label id="elh_receipts_ChequeCardNo" for="x_ChequeCardNo" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->ChequeCardNo->caption() ?><?php echo ($receipts->ChequeCardNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->ChequeCardNo->cellAttributes() ?>>
...
<?php if ($receipts->CreditBankName->Visible) { // CreditBankName ?>
	<div id="r_CreditBankName" class="form-group row">
		<label id="elh_receipts_CreditBankName" for="x_CreditBankName" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditBankName->caption() ?><?php echo ($receipts->CreditBankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditBankName->cellAttributes() ?>>
...
<?php if ($receipts->CreditCardHolder->Visible) { // CreditCardHolder ?>
	<div id="r_CreditCardHolder" class="form-group row">
		<label id="elh_receipts_CreditCardHolder" for="x_CreditCardHolder" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditCardHolder->caption() ?><?php echo ($receipts->CreditCardHolder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditCardHolder->cellAttributes() ?>>
...
<?php if ($receipts->CreditCardType->Visible) { // CreditCardType ?>
	<div id="r_CreditCardType" class="form-group row">
		<label id="elh_receipts_CreditCardType" for="x_CreditCardType" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditCardType->caption() ?><?php echo ($receipts->CreditCardType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditCardType->cellAttributes() ?>>
...
<?php if ($receipts->CreditCardMachine->Visible) { // CreditCardMachine ?>
	<div id="r_CreditCardMachine" class="form-group row">
		<label id="elh_receipts_CreditCardMachine" for="x_CreditCardMachine" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditCardMachine->caption() ?><?php echo ($receipts->CreditCardMachine->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditCardMachine->cellAttributes() ?>>
...
<?php if ($receipts->CreditCardBatchNo->Visible) { // CreditCardBatchNo ?>
	<div id="r_CreditCardBatchNo" class="form-group row">
		<label id="elh_receipts_CreditCardBatchNo" for="x_CreditCardBatchNo" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditCardBatchNo->caption() ?><?php echo ($receipts->CreditCardBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditCardBatchNo->cellAttributes() ?>>
...
<?php if ($receipts->CreditCardTax->Visible) { // CreditCardTax ?>
	<div id="r_CreditCardTax" class="form-group row">
		<label id="elh_receipts_CreditCardTax" for="x_CreditCardTax" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditCardTax->caption() ?><?php echo ($receipts->CreditCardTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditCardTax->cellAttributes() ?>>
...
<?php if ($receipts->CreditDeductionAmount->Visible) { // CreditDeductionAmount ?>
	<div id="r_CreditDeductionAmount" class="form-group row">
		<label id="elh_receipts_CreditDeductionAmount" for="x_CreditDeductionAmount" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->CreditDeductionAmount->caption() ?><?php echo ($receipts->CreditDeductionAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->CreditDeductionAmount->cellAttributes() ?>>
...
<?php if ($receipts->RealizationAmount->Visible) { // RealizationAmount ?>
	<div id="r_RealizationAmount" class="form-group row">
		<label id="elh_receipts_RealizationAmount" for="x_RealizationAmount" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->RealizationAmount->caption() ?><?php echo ($receipts->RealizationAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->RealizationAmount->cellAttributes() ?>>
...
<?php if ($receipts->RealizationStatus->Visible) { // RealizationStatus ?>
	<div id="r_RealizationStatus" class="form-group row">
		<label id="elh_receipts_RealizationStatus" for="x_RealizationStatus" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->RealizationStatus->caption() ?><?php echo ($receipts->RealizationStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->RealizationStatus->cellAttributes() ?>>
...
<?php if ($receipts->RealizationRemarks->Visible) { // RealizationRemarks ?>
	<div id="r_RealizationRemarks" class="form-group row">
		<label id="elh_receipts_RealizationRemarks" for="x_RealizationRemarks" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->RealizationRemarks->caption() ?><?php echo ($receipts->RealizationRemarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->RealizationRemarks->cellAttributes() ?>>
...
<?php if ($receipts->RealizationBatchNo->Visible) { // RealizationBatchNo ?>
	<div id="r_RealizationBatchNo" class="form-group row">
		<label id="elh_receipts_RealizationBatchNo" for="x_RealizationBatchNo" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->RealizationBatchNo->caption() ?><?php echo ($receipts->RealizationBatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->RealizationBatchNo->cellAttributes() ?>>
...
<?php if ($receipts->RealizationDate->Visible) { // RealizationDate ?>
	<div id="r_RealizationDate" class="form-group row">
		<label id="elh_receipts_RealizationDate" for="x_RealizationDate" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->RealizationDate->caption() ?><?php echo ($receipts->RealizationDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->RealizationDate->cellAttributes() ?>>
...
<?php if ($receipts->BankAccHolderMobileNumber->Visible) { // BankAccHolderMobileNumber ?>
	<div id="r_BankAccHolderMobileNumber" class="form-group row">
		<label id="elh_receipts_BankAccHolderMobileNumber" for="x_BankAccHolderMobileNumber" class="<?php echo $receipts_edit->LeftColumnClass ?>"><?php echo $receipts->BankAccHolderMobileNumber->caption() ?><?php echo ($receipts->BankAccHolderMobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $receipts_edit->RightColumnClass ?>"><div<?php echo $receipts->BankAccHolderMobileNumber->cellAttributes() ?>>
