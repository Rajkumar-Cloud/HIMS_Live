...
var fpatient_servicesedit = currentForm = new ew.Form("fpatient_servicesedit", "edit");
...
fpatient_servicesedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_servicesedit.lists["x_Services"] = <?php echo $patient_services_edit->Services->Lookup->toClientList() ?>;
...
fpatient_servicesedit.lists["x_status"] = <?php echo $patient_services_edit->status->Lookup->toClientList() ?>;
fpatient_servicesedit.lists["x_status"].options = <?php echo JsonEncode($patient_services_edit->status->lookupOptions()) ?>;
fpatient_servicesedit.lists["x_ServiceSelect[]"] = <?php echo $patient_services_edit->ServiceSelect->Lookup->toClientList() ?>;
...
<?php if ($patient_services_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_services_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_services->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_services_id" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->id->caption() ?><?php echo ($patient_services->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_services" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_services->id->CurrentValue) ?>">
<?php echo $patient_services->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_services->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_patient_services_Reception" for="x_Reception" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Reception->caption() ?><?php echo ($patient_services->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Reception->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_services" data-field="x_Reception" name="x_Reception" id="x_Reception" value="<?php echo HtmlEncode($patient_services->Reception->CurrentValue) ?>">
...
<?php if ($patient_services->Services->Visible) { // Services ?>
	<div id="r_Services" class="form-group row">
		<label id="elh_patient_services_Services" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Services->caption() ?><?php echo ($patient_services->Services->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Services->cellAttributes() ?>>
...
<?php if ($patient_services->amount->Visible) { // amount ?>
	<div id="r_amount" class="form-group row">
		<label id="elh_patient_services_amount" for="x_amount" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->amount->caption() ?><?php echo ($patient_services->amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->amount->cellAttributes() ?>>
...
<?php if ($patient_services->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_patient_services_description" for="x_description" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->description->caption() ?><?php echo ($patient_services->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->description->cellAttributes() ?>>
...
<?php if ($patient_services->patient_type->Visible) { // patient_type ?>
	<div id="r_patient_type" class="form-group row">
		<label id="elh_patient_services_patient_type" for="x_patient_type" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->patient_type->caption() ?><?php echo ($patient_services->patient_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->patient_type->cellAttributes() ?>>
...
<?php if ($patient_services->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_services_status" for="x_status" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->status->caption() ?><?php echo ($patient_services->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->status->cellAttributes() ?>>
...
<?php if ($patient_services->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_patient_services_mrnno" for="x_mrnno" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->mrnno->caption() ?><?php echo ($patient_services->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->mrnno->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_services" data-field="x_mrnno" name="x_mrnno" id="x_mrnno" value="<?php echo HtmlEncode($patient_services->mrnno->CurrentValue) ?>">
<?php echo $patient_services->mrnno->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_services->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_patient_services_PatientName" for="x_PatientName" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->PatientName->caption() ?><?php echo ($patient_services->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->PatientName->cellAttributes() ?>>
...
<?php if ($patient_services->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_services_Age" for="x_Age" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Age->caption() ?><?php echo ($patient_services->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Age->cellAttributes() ?>>
...
<?php if ($patient_services->Gender->Visible) { // Gender ?>
	<div id="r_Gender" class="form-group row">
		<label id="elh_patient_services_Gender" for="x_Gender" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Gender->caption() ?><?php echo ($patient_services->Gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Gender->cellAttributes() ?>>
...
<?php if ($patient_services->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_services_profilePic" for="x_profilePic" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->profilePic->caption() ?><?php echo ($patient_services->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->profilePic->cellAttributes() ?>>
...
<?php if ($patient_services->Unit->Visible) { // Unit ?>
	<div id="r_Unit" class="form-group row">
		<label id="elh_patient_services_Unit" for="x_Unit" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Unit->caption() ?><?php echo ($patient_services->Unit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Unit->cellAttributes() ?>>
...
<?php if ($patient_services->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_patient_services_Quantity" for="x_Quantity" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Quantity->caption() ?><?php echo ($patient_services->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Quantity->cellAttributes() ?>>
...
<?php if ($patient_services->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_patient_services_Discount" for="x_Discount" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Discount->caption() ?><?php echo ($patient_services->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Discount->cellAttributes() ?>>
...
<?php if ($patient_services->SubTotal->Visible) { // SubTotal ?>
	<div id="r_SubTotal" class="form-group row">
		<label id="elh_patient_services_SubTotal" for="x_SubTotal" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->SubTotal->caption() ?><?php echo ($patient_services->SubTotal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->SubTotal->cellAttributes() ?>>
...
<?php if ($patient_services->ServiceSelect->Visible) { // ServiceSelect ?>
	<div id="r_ServiceSelect" class="form-group row">
		<label id="elh_patient_services_ServiceSelect" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ServiceSelect->caption() ?><?php echo ($patient_services->ServiceSelect->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ServiceSelect->cellAttributes() ?>>
...
<?php if ($patient_services->Aid->Visible) { // Aid ?>
	<div id="r_Aid" class="form-group row">
		<label id="elh_patient_services_Aid" for="x_Aid" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Aid->caption() ?><?php echo ($patient_services->Aid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Aid->cellAttributes() ?>>
...
<?php if ($patient_services->Vid->Visible) { // Vid ?>
	<div id="r_Vid" class="form-group row">
		<label id="elh_patient_services_Vid" for="x_Vid" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Vid->caption() ?><?php echo ($patient_services->Vid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Vid->cellAttributes() ?>>
...
<?php if ($patient_services->DrID->Visible) { // DrID ?>
	<div id="r_DrID" class="form-group row">
		<label id="elh_patient_services_DrID" for="x_DrID" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrID->caption() ?><?php echo ($patient_services->DrID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrID->cellAttributes() ?>>
...
<?php if ($patient_services->DrCODE->Visible) { // DrCODE ?>
	<div id="r_DrCODE" class="form-group row">
		<label id="elh_patient_services_DrCODE" for="x_DrCODE" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrCODE->caption() ?><?php echo ($patient_services->DrCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrCODE->cellAttributes() ?>>
...
<?php if ($patient_services->DrName->Visible) { // DrName ?>
	<div id="r_DrName" class="form-group row">
		<label id="elh_patient_services_DrName" for="x_DrName" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrName->caption() ?><?php echo ($patient_services->DrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrName->cellAttributes() ?>>
...
<?php if ($patient_services->Department->Visible) { // Department ?>
	<div id="r_Department" class="form-group row">
		<label id="elh_patient_services_Department" for="x_Department" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Department->caption() ?><?php echo ($patient_services->Department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Department->cellAttributes() ?>>
...
<?php if ($patient_services->DrSharePres->Visible) { // DrSharePres ?>
	<div id="r_DrSharePres" class="form-group row">
		<label id="elh_patient_services_DrSharePres" for="x_DrSharePres" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrSharePres->caption() ?><?php echo ($patient_services->DrSharePres->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrSharePres->cellAttributes() ?>>
...
<?php if ($patient_services->HospSharePres->Visible) { // HospSharePres ?>
	<div id="r_HospSharePres" class="form-group row">
		<label id="elh_patient_services_HospSharePres" for="x_HospSharePres" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->HospSharePres->caption() ?><?php echo ($patient_services->HospSharePres->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->HospSharePres->cellAttributes() ?>>
...
<?php if ($patient_services->DrShareAmount->Visible) { // DrShareAmount ?>
	<div id="r_DrShareAmount" class="form-group row">
		<label id="elh_patient_services_DrShareAmount" for="x_DrShareAmount" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrShareAmount->caption() ?><?php echo ($patient_services->DrShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrShareAmount->cellAttributes() ?>>
...
<?php if ($patient_services->HospShareAmount->Visible) { // HospShareAmount ?>
	<div id="r_HospShareAmount" class="form-group row">
		<label id="elh_patient_services_HospShareAmount" for="x_HospShareAmount" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->HospShareAmount->caption() ?><?php echo ($patient_services->HospShareAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->HospShareAmount->cellAttributes() ?>>
...
<?php if ($patient_services->DrShareSettiledAmount->Visible) { // DrShareSettiledAmount ?>
	<div id="r_DrShareSettiledAmount" class="form-group row">
		<label id="elh_patient_services_DrShareSettiledAmount" for="x_DrShareSettiledAmount" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrShareSettiledAmount->caption() ?><?php echo ($patient_services->DrShareSettiledAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrShareSettiledAmount->cellAttributes() ?>>
...
<?php if ($patient_services->DrShareSettledId->Visible) { // DrShareSettledId ?>
	<div id="r_DrShareSettledId" class="form-group row">
		<label id="elh_patient_services_DrShareSettledId" for="x_DrShareSettledId" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrShareSettledId->caption() ?><?php echo ($patient_services->DrShareSettledId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrShareSettledId->cellAttributes() ?>>
...
<?php if ($patient_services->DrShareSettiledStatus->Visible) { // DrShareSettiledStatus ?>
	<div id="r_DrShareSettiledStatus" class="form-group row">
		<label id="elh_patient_services_DrShareSettiledStatus" for="x_DrShareSettiledStatus" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DrShareSettiledStatus->caption() ?><?php echo ($patient_services->DrShareSettiledStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DrShareSettiledStatus->cellAttributes() ?>>
...
<?php if ($patient_services->invoiceId->Visible) { // invoiceId ?>
	<div id="r_invoiceId" class="form-group row">
		<label id="elh_patient_services_invoiceId" for="x_invoiceId" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->invoiceId->caption() ?><?php echo ($patient_services->invoiceId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->invoiceId->cellAttributes() ?>>
...
<?php if ($patient_services->invoiceAmount->Visible) { // invoiceAmount ?>
	<div id="r_invoiceAmount" class="form-group row">
		<label id="elh_patient_services_invoiceAmount" for="x_invoiceAmount" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->invoiceAmount->caption() ?><?php echo ($patient_services->invoiceAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->invoiceAmount->cellAttributes() ?>>
...
<?php if ($patient_services->invoiceStatus->Visible) { // invoiceStatus ?>
	<div id="r_invoiceStatus" class="form-group row">
		<label id="elh_patient_services_invoiceStatus" for="x_invoiceStatus" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->invoiceStatus->caption() ?><?php echo ($patient_services->invoiceStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->invoiceStatus->cellAttributes() ?>>
...
<?php if ($patient_services->modeOfPayment->Visible) { // modeOfPayment ?>
	<div id="r_modeOfPayment" class="form-group row">
		<label id="elh_patient_services_modeOfPayment" for="x_modeOfPayment" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->modeOfPayment->caption() ?><?php echo ($patient_services->modeOfPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->modeOfPayment->cellAttributes() ?>>
...
<?php if ($patient_services->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_patient_services_RIDNO" for="x_RIDNO" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->RIDNO->caption() ?><?php echo ($patient_services->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->RIDNO->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_services" data-field="x_RIDNO" name="x_RIDNO" id="x_RIDNO" value="<?php echo HtmlEncode($patient_services->RIDNO->CurrentValue) ?>">
<?php echo $patient_services->RIDNO->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_services->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_patient_services_TidNo" for="x_TidNo" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->TidNo->caption() ?><?php echo ($patient_services->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->TidNo->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_services" data-field="x_TidNo" name="x_TidNo" id="x_TidNo" value="<?php echo HtmlEncode($patient_services->TidNo->CurrentValue) ?>">
...
<?php if ($patient_services->DiscountCategory->Visible) { // DiscountCategory ?>
	<div id="r_DiscountCategory" class="form-group row">
		<label id="elh_patient_services_DiscountCategory" for="x_DiscountCategory" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DiscountCategory->caption() ?><?php echo ($patient_services->DiscountCategory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DiscountCategory->cellAttributes() ?>>
...
<?php if ($patient_services->sid->Visible) { // sid ?>
	<div id="r_sid" class="form-group row">
		<label id="elh_patient_services_sid" for="x_sid" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->sid->caption() ?><?php echo ($patient_services->sid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->sid->cellAttributes() ?>>
...
<?php if ($patient_services->ItemCode->Visible) { // ItemCode ?>
	<div id="r_ItemCode" class="form-group row">
		<label id="elh_patient_services_ItemCode" for="x_ItemCode" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ItemCode->caption() ?><?php echo ($patient_services->ItemCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ItemCode->cellAttributes() ?>>
...
<?php if ($patient_services->TestSubCd->Visible) { // TestSubCd ?>
	<div id="r_TestSubCd" class="form-group row">
		<label id="elh_patient_services_TestSubCd" for="x_TestSubCd" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->TestSubCd->caption() ?><?php echo ($patient_services->TestSubCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->TestSubCd->cellAttributes() ?>>
...
<?php if ($patient_services->DEptCd->Visible) { // DEptCd ?>
	<div id="r_DEptCd" class="form-group row">
		<label id="elh_patient_services_DEptCd" for="x_DEptCd" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DEptCd->caption() ?><?php echo ($patient_services->DEptCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DEptCd->cellAttributes() ?>>
...
<?php if ($patient_services->ProfCd->Visible) { // ProfCd ?>
	<div id="r_ProfCd" class="form-group row">
		<label id="elh_patient_services_ProfCd" for="x_ProfCd" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ProfCd->caption() ?><?php echo ($patient_services->ProfCd->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ProfCd->cellAttributes() ?>>
...
<?php if ($patient_services->LabReport->Visible) { // LabReport ?>
	<div id="r_LabReport" class="form-group row">
		<label id="elh_patient_services_LabReport" for="x_LabReport" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->LabReport->caption() ?><?php echo ($patient_services->LabReport->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->LabReport->cellAttributes() ?>>
...
<?php if ($patient_services->Comments->Visible) { // Comments ?>
	<div id="r_Comments" class="form-group row">
		<label id="elh_patient_services_Comments" for="x_Comments" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Comments->caption() ?><?php echo ($patient_services->Comments->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Comments->cellAttributes() ?>>
...
<?php if ($patient_services->Method->Visible) { // Method ?>
	<div id="r_Method" class="form-group row">
		<label id="elh_patient_services_Method" for="x_Method" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Method->caption() ?><?php echo ($patient_services->Method->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Method->cellAttributes() ?>>
...
<?php if ($patient_services->Specimen->Visible) { // Specimen ?>
	<div id="r_Specimen" class="form-group row">
		<label id="elh_patient_services_Specimen" for="x_Specimen" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Specimen->caption() ?><?php echo ($patient_services->Specimen->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Specimen->cellAttributes() ?>>
...
<?php if ($patient_services->Abnormal->Visible) { // Abnormal ?>
	<div id="r_Abnormal" class="form-group row">
		<label id="elh_patient_services_Abnormal" for="x_Abnormal" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Abnormal->caption() ?><?php echo ($patient_services->Abnormal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Abnormal->cellAttributes() ?>>
...
<?php if ($patient_services->RefValue->Visible) { // RefValue ?>
	<div id="r_RefValue" class="form-group row">
		<label id="elh_patient_services_RefValue" for="x_RefValue" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->RefValue->caption() ?><?php echo ($patient_services->RefValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->RefValue->cellAttributes() ?>>
...
<?php if ($patient_services->TestUnit->Visible) { // TestUnit ?>
	<div id="r_TestUnit" class="form-group row">
		<label id="elh_patient_services_TestUnit" for="x_TestUnit" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->TestUnit->caption() ?><?php echo ($patient_services->TestUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->TestUnit->cellAttributes() ?>>
...
<?php if ($patient_services->LOWHIGH->Visible) { // LOWHIGH ?>
	<div id="r_LOWHIGH" class="form-group row">
		<label id="elh_patient_services_LOWHIGH" for="x_LOWHIGH" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->LOWHIGH->caption() ?><?php echo ($patient_services->LOWHIGH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->LOWHIGH->cellAttributes() ?>>
...
<?php if ($patient_services->Branch->Visible) { // Branch ?>
	<div id="r_Branch" class="form-group row">
		<label id="elh_patient_services_Branch" for="x_Branch" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Branch->caption() ?><?php echo ($patient_services->Branch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Branch->cellAttributes() ?>>
...
<?php if ($patient_services->Dispatch->Visible) { // Dispatch ?>
	<div id="r_Dispatch" class="form-group row">
		<label id="elh_patient_services_Dispatch" for="x_Dispatch" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Dispatch->caption() ?><?php echo ($patient_services->Dispatch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Dispatch->cellAttributes() ?>>
...
<?php if ($patient_services->Pic1->Visible) { // Pic1 ?>
	<div id="r_Pic1" class="form-group row">
		<label id="elh_patient_services_Pic1" for="x_Pic1" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Pic1->caption() ?><?php echo ($patient_services->Pic1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Pic1->cellAttributes() ?>>
...
<?php if ($patient_services->Pic2->Visible) { // Pic2 ?>
	<div id="r_Pic2" class="form-group row">
		<label id="elh_patient_services_Pic2" for="x_Pic2" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Pic2->caption() ?><?php echo ($patient_services->Pic2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Pic2->cellAttributes() ?>>
...
<?php if ($patient_services->GraphPath->Visible) { // GraphPath ?>
	<div id="r_GraphPath" class="form-group row">
		<label id="elh_patient_services_GraphPath" for="x_GraphPath" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->GraphPath->caption() ?><?php echo ($patient_services->GraphPath->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->GraphPath->cellAttributes() ?>>
...
<?php if ($patient_services->MachineCD->Visible) { // MachineCD ?>
	<div id="r_MachineCD" class="form-group row">
		<label id="elh_patient_services_MachineCD" for="x_MachineCD" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->MachineCD->caption() ?><?php echo ($patient_services->MachineCD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->MachineCD->cellAttributes() ?>>
...
<?php if ($patient_services->TestCancel->Visible) { // TestCancel ?>
	<div id="r_TestCancel" class="form-group row">
		<label id="elh_patient_services_TestCancel" for="x_TestCancel" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->TestCancel->caption() ?><?php echo ($patient_services->TestCancel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->TestCancel->cellAttributes() ?>>
...
<?php if ($patient_services->OutSource->Visible) { // OutSource ?>
	<div id="r_OutSource" class="form-group row">
		<label id="elh_patient_services_OutSource" for="x_OutSource" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->OutSource->caption() ?><?php echo ($patient_services->OutSource->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->OutSource->cellAttributes() ?>>
...
<?php if ($patient_services->Printed->Visible) { // Printed ?>
	<div id="r_Printed" class="form-group row">
		<label id="elh_patient_services_Printed" for="x_Printed" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Printed->caption() ?><?php echo ($patient_services->Printed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Printed->cellAttributes() ?>>
...
<?php if ($patient_services->PrintBy->Visible) { // PrintBy ?>
	<div id="r_PrintBy" class="form-group row">
		<label id="elh_patient_services_PrintBy" for="x_PrintBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->PrintBy->caption() ?><?php echo ($patient_services->PrintBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->PrintBy->cellAttributes() ?>>
...
<?php if ($patient_services->PrintDate->Visible) { // PrintDate ?>
	<div id="r_PrintDate" class="form-group row">
		<label id="elh_patient_services_PrintDate" for="x_PrintDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->PrintDate->caption() ?><?php echo ($patient_services->PrintDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->PrintDate->cellAttributes() ?>>
...
<?php if ($patient_services->BillingDate->Visible) { // BillingDate ?>
	<div id="r_BillingDate" class="form-group row">
		<label id="elh_patient_services_BillingDate" for="x_BillingDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->BillingDate->caption() ?><?php echo ($patient_services->BillingDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->BillingDate->cellAttributes() ?>>
...
<?php if ($patient_services->BilledBy->Visible) { // BilledBy ?>
	<div id="r_BilledBy" class="form-group row">
		<label id="elh_patient_services_BilledBy" for="x_BilledBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->BilledBy->caption() ?><?php echo ($patient_services->BilledBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->BilledBy->cellAttributes() ?>>
...
<?php if ($patient_services->Resulted->Visible) { // Resulted ?>
	<div id="r_Resulted" class="form-group row">
		<label id="elh_patient_services_Resulted" for="x_Resulted" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Resulted->caption() ?><?php echo ($patient_services->Resulted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Resulted->cellAttributes() ?>>
...
<?php if ($patient_services->ResultDate->Visible) { // ResultDate ?>
	<div id="r_ResultDate" class="form-group row">
		<label id="elh_patient_services_ResultDate" for="x_ResultDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ResultDate->caption() ?><?php echo ($patient_services->ResultDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ResultDate->cellAttributes() ?>>
...
<?php if ($patient_services->ResultedBy->Visible) { // ResultedBy ?>
	<div id="r_ResultedBy" class="form-group row">
		<label id="elh_patient_services_ResultedBy" for="x_ResultedBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ResultedBy->caption() ?><?php echo ($patient_services->ResultedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ResultedBy->cellAttributes() ?>>
...
<?php if ($patient_services->SampleDate->Visible) { // SampleDate ?>
	<div id="r_SampleDate" class="form-group row">
		<label id="elh_patient_services_SampleDate" for="x_SampleDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->SampleDate->caption() ?><?php echo ($patient_services->SampleDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->SampleDate->cellAttributes() ?>>
...
<?php if ($patient_services->SampleUser->Visible) { // SampleUser ?>
	<div id="r_SampleUser" class="form-group row">
		<label id="elh_patient_services_SampleUser" for="x_SampleUser" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->SampleUser->caption() ?><?php echo ($patient_services->SampleUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->SampleUser->cellAttributes() ?>>
...
<?php if ($patient_services->Sampled->Visible) { // Sampled ?>
	<div id="r_Sampled" class="form-group row">
		<label id="elh_patient_services_Sampled" for="x_Sampled" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Sampled->caption() ?><?php echo ($patient_services->Sampled->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Sampled->cellAttributes() ?>>
...
<?php if ($patient_services->ReceivedDate->Visible) { // ReceivedDate ?>
	<div id="r_ReceivedDate" class="form-group row">
		<label id="elh_patient_services_ReceivedDate" for="x_ReceivedDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ReceivedDate->caption() ?><?php echo ($patient_services->ReceivedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ReceivedDate->cellAttributes() ?>>
...
<?php if ($patient_services->ReceivedUser->Visible) { // ReceivedUser ?>
	<div id="r_ReceivedUser" class="form-group row">
		<label id="elh_patient_services_ReceivedUser" for="x_ReceivedUser" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ReceivedUser->caption() ?><?php echo ($patient_services->ReceivedUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ReceivedUser->cellAttributes() ?>>
...
<?php if ($patient_services->Recevied->Visible) { // Recevied ?>
	<div id="r_Recevied" class="form-group row">
		<label id="elh_patient_services_Recevied" for="x_Recevied" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Recevied->caption() ?><?php echo ($patient_services->Recevied->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Recevied->cellAttributes() ?>>
...
<?php if ($patient_services->DeptRecvDate->Visible) { // DeptRecvDate ?>
	<div id="r_DeptRecvDate" class="form-group row">
		<label id="elh_patient_services_DeptRecvDate" for="x_DeptRecvDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DeptRecvDate->caption() ?><?php echo ($patient_services->DeptRecvDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DeptRecvDate->cellAttributes() ?>>
...
<?php if ($patient_services->DeptRecvUser->Visible) { // DeptRecvUser ?>
	<div id="r_DeptRecvUser" class="form-group row">
		<label id="elh_patient_services_DeptRecvUser" for="x_DeptRecvUser" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DeptRecvUser->caption() ?><?php echo ($patient_services->DeptRecvUser->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DeptRecvUser->cellAttributes() ?>>
...
<?php if ($patient_services->DeptRecived->Visible) { // DeptRecived ?>
	<div id="r_DeptRecived" class="form-group row">
		<label id="elh_patient_services_DeptRecived" for="x_DeptRecived" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->DeptRecived->caption() ?><?php echo ($patient_services->DeptRecived->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->DeptRecived->cellAttributes() ?>>
...
<?php if ($patient_services->SAuthDate->Visible) { // SAuthDate ?>
	<div id="r_SAuthDate" class="form-group row">
		<label id="elh_patient_services_SAuthDate" for="x_SAuthDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->SAuthDate->caption() ?><?php echo ($patient_services->SAuthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->SAuthDate->cellAttributes() ?>>
...
<?php if ($patient_services->SAuthBy->Visible) { // SAuthBy ?>
	<div id="r_SAuthBy" class="form-group row">
		<label id="elh_patient_services_SAuthBy" for="x_SAuthBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->SAuthBy->caption() ?><?php echo ($patient_services->SAuthBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->SAuthBy->cellAttributes() ?>>
...
<?php if ($patient_services->SAuthendicate->Visible) { // SAuthendicate ?>
	<div id="r_SAuthendicate" class="form-group row">
		<label id="elh_patient_services_SAuthendicate" for="x_SAuthendicate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->SAuthendicate->caption() ?><?php echo ($patient_services->SAuthendicate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->SAuthendicate->cellAttributes() ?>>
...
<?php if ($patient_services->AuthDate->Visible) { // AuthDate ?>
	<div id="r_AuthDate" class="form-group row">
		<label id="elh_patient_services_AuthDate" for="x_AuthDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->AuthDate->caption() ?><?php echo ($patient_services->AuthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->AuthDate->cellAttributes() ?>>
...
<?php if ($patient_services->AuthBy->Visible) { // AuthBy ?>
	<div id="r_AuthBy" class="form-group row">
		<label id="elh_patient_services_AuthBy" for="x_AuthBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->AuthBy->caption() ?><?php echo ($patient_services->AuthBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->AuthBy->cellAttributes() ?>>
...
<?php if ($patient_services->Authencate->Visible) { // Authencate ?>
	<div id="r_Authencate" class="form-group row">
		<label id="elh_patient_services_Authencate" for="x_Authencate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Authencate->caption() ?><?php echo ($patient_services->Authencate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Authencate->cellAttributes() ?>>
...
<?php if ($patient_services->EditDate->Visible) { // EditDate ?>
	<div id="r_EditDate" class="form-group row">
		<label id="elh_patient_services_EditDate" for="x_EditDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->EditDate->caption() ?><?php echo ($patient_services->EditDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->EditDate->cellAttributes() ?>>
...
<?php if ($patient_services->EditBy->Visible) { // EditBy ?>
	<div id="r_EditBy" class="form-group row">
		<label id="elh_patient_services_EditBy" for="x_EditBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->EditBy->caption() ?><?php echo ($patient_services->EditBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->EditBy->cellAttributes() ?>>
...
<?php if ($patient_services->Editted->Visible) { // Editted ?>
	<div id="r_Editted" class="form-group row">
		<label id="elh_patient_services_Editted" for="x_Editted" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Editted->caption() ?><?php echo ($patient_services->Editted->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Editted->cellAttributes() ?>>
...
<?php if ($patient_services->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_patient_services_PatID" for="x_PatID" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->PatID->caption() ?><?php echo ($patient_services->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->PatID->cellAttributes() ?>>
...
<?php if ($patient_services->PatientId->Visible) { // PatientId ?>
	<div id="r_PatientId" class="form-group row">
		<label id="elh_patient_services_PatientId" for="x_PatientId" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->PatientId->caption() ?><?php echo ($patient_services->PatientId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->PatientId->cellAttributes() ?>>
...
<?php if ($patient_services->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_patient_services_Mobile" for="x_Mobile" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Mobile->caption() ?><?php echo ($patient_services->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Mobile->cellAttributes() ?>>
...
<?php if ($patient_services->CId->Visible) { // CId ?>
	<div id="r_CId" class="form-group row">
		<label id="elh_patient_services_CId" for="x_CId" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->CId->caption() ?><?php echo ($patient_services->CId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->CId->cellAttributes() ?>>
...
<?php if ($patient_services->Order->Visible) { // Order ?>
	<div id="r_Order" class="form-group row">
		<label id="elh_patient_services_Order" for="x_Order" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Order->caption() ?><?php echo ($patient_services->Order->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Order->cellAttributes() ?>>
...
<?php if ($patient_services->Form->Visible) { // Form ?>
	<div id="r_Form" class="form-group row">
		<label id="elh_patient_services_Form" for="x_Form" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Form->caption() ?><?php echo ($patient_services->Form->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Form->cellAttributes() ?>>
...
<?php if ($patient_services->ResType->Visible) { // ResType ?>
	<div id="r_ResType" class="form-group row">
		<label id="elh_patient_services_ResType" for="x_ResType" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->ResType->caption() ?><?php echo ($patient_services->ResType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->ResType->cellAttributes() ?>>
...
<?php if ($patient_services->Sample->Visible) { // Sample ?>
	<div id="r_Sample" class="form-group row">
		<label id="elh_patient_services_Sample" for="x_Sample" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Sample->caption() ?><?php echo ($patient_services->Sample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Sample->cellAttributes() ?>>
...
<?php if ($patient_services->NoD->Visible) { // NoD ?>
	<div id="r_NoD" class="form-group row">
		<label id="elh_patient_services_NoD" for="x_NoD" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->NoD->caption() ?><?php echo ($patient_services->NoD->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->NoD->cellAttributes() ?>>
...
<?php if ($patient_services->BillOrder->Visible) { // BillOrder ?>
	<div id="r_BillOrder" class="form-group row">
		<label id="elh_patient_services_BillOrder" for="x_BillOrder" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->BillOrder->caption() ?><?php echo ($patient_services->BillOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->BillOrder->cellAttributes() ?>>
...
<?php if ($patient_services->Formula->Visible) { // Formula ?>
	<div id="r_Formula" class="form-group row">
		<label id="elh_patient_services_Formula" for="x_Formula" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Formula->caption() ?><?php echo ($patient_services->Formula->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Formula->cellAttributes() ?>>
...
<?php if ($patient_services->Inactive->Visible) { // Inactive ?>
	<div id="r_Inactive" class="form-group row">
		<label id="elh_patient_services_Inactive" for="x_Inactive" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Inactive->caption() ?><?php echo ($patient_services->Inactive->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Inactive->cellAttributes() ?>>
...
<?php if ($patient_services->CollSample->Visible) { // CollSample ?>
	<div id="r_CollSample" class="form-group row">
		<label id="elh_patient_services_CollSample" for="x_CollSample" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->CollSample->caption() ?><?php echo ($patient_services->CollSample->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->CollSample->cellAttributes() ?>>
...
<?php if ($patient_services->TestType->Visible) { // TestType ?>
	<div id="r_TestType" class="form-group row">
		<label id="elh_patient_services_TestType" for="x_TestType" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->TestType->caption() ?><?php echo ($patient_services->TestType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->TestType->cellAttributes() ?>>
...
<?php if ($patient_services->Repeated->Visible) { // Repeated ?>
	<div id="r_Repeated" class="form-group row">
		<label id="elh_patient_services_Repeated" for="x_Repeated" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Repeated->caption() ?><?php echo ($patient_services->Repeated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Repeated->cellAttributes() ?>>
...
<?php if ($patient_services->RepeatedBy->Visible) { // RepeatedBy ?>
	<div id="r_RepeatedBy" class="form-group row">
		<label id="elh_patient_services_RepeatedBy" for="x_RepeatedBy" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->RepeatedBy->caption() ?><?php echo ($patient_services->RepeatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->RepeatedBy->cellAttributes() ?>>
...
<?php if ($patient_services->RepeatedDate->Visible) { // RepeatedDate ?>
	<div id="r_RepeatedDate" class="form-group row">
		<label id="elh_patient_services_RepeatedDate" for="x_RepeatedDate" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->RepeatedDate->caption() ?><?php echo ($patient_services->RepeatedDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->RepeatedDate->cellAttributes() ?>>
...
<?php if ($patient_services->serviceID->Visible) { // serviceID ?>
	<div id="r_serviceID" class="form-group row">
		<label id="elh_patient_services_serviceID" for="x_serviceID" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->serviceID->caption() ?><?php echo ($patient_services->serviceID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->serviceID->cellAttributes() ?>>
...
<?php if ($patient_services->Service_Type->Visible) { // Service_Type ?>
	<div id="r_Service_Type" class="form-group row">
		<label id="elh_patient_services_Service_Type" for="x_Service_Type" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Service_Type->caption() ?><?php echo ($patient_services->Service_Type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Service_Type->cellAttributes() ?>>
...
<?php if ($patient_services->Service_Department->Visible) { // Service_Department ?>
	<div id="r_Service_Department" class="form-group row">
		<label id="elh_patient_services_Service_Department" for="x_Service_Department" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->Service_Department->caption() ?><?php echo ($patient_services->Service_Department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->Service_Department->cellAttributes() ?>>
...
<?php if ($patient_services->RequestNo->Visible) { // RequestNo ?>
	<div id="r_RequestNo" class="form-group row">
		<label id="elh_patient_services_RequestNo" for="x_RequestNo" class="<?php echo $patient_services_edit->LeftColumnClass ?>"><?php echo $patient_services->RequestNo->caption() ?><?php echo ($patient_services->RequestNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_services_edit->RightColumnClass ?>"><div<?php echo $patient_services->RequestNo->cellAttributes() ?>>
