...
var fpatientedit = currentForm = new ew.Form("fpatientedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($patient_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $patient->id->caption(), $patient->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php } ?>
		<?php if ($patient_edit->profilePicImage->Required) { ?>
		...
		<?php } ?>
		<?php if ($patient_edit->Clients->Required) { ?>
...
fpatientedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatientedit.lists["x_title"] = <?php echo $patient_edit->title->Lookup->toClientList() ?>;
fpatientedit.lists["x_title"].options = <?php echo JsonEncode($patient_edit->title->lookupOptions()) ?>;
fpatientedit.lists["x_gender"] = <?php echo $patient_edit->gender->Lookup->toClientList() ?>;
fpatientedit.lists["x_gender"].options = <?php echo JsonEncode($patient_edit->gender->lookupOptions()) ?>;
fpatientedit.lists["x_blood_group"] = <?php echo $patient_edit->blood_group->Lookup->toClientList() ?>;
fpatientedit.lists["x_blood_group"].options = <?php echo JsonEncode($patient_edit->blood_group->lookupOptions()) ?>;
fpatientedit.lists["x_status"] = <?php echo $patient_edit->status->Lookup->toClientList() ?>;
fpatientedit.lists["x_status"].options = <?php echo JsonEncode($patient_edit->status->lookupOptions()) ?>;
fpatientedit.lists["x_ReferedByDr"] = <?php echo $patient_edit->ReferedByDr->Lookup->toClientList() ?>;
fpatientedit.lists["x_ReferedByDr"].options = <?php echo JsonEncode($patient_edit->ReferedByDr->lookupOptions()) ?>;
fpatientedit.lists["x_ReferA4TreatingConsultant"] = <?php echo $patient_edit->ReferA4TreatingConsultant->Lookup->toClientList() ?>;
...
fpatientedit.lists["x_spouse_title"] = <?php echo $patient_edit->spouse_title->Lookup->toClientList() ?>;
fpatientedit.lists["x_spouse_title"].options = <?php echo JsonEncode($patient_edit->spouse_title->lookupOptions()) ?>;
fpatientedit.lists["x_spouse_gender"] = <?php echo $patient_edit->spouse_gender->Lookup->toClientList() ?>;
fpatientedit.lists["x_spouse_gender"].options = <?php echo JsonEncode($patient_edit->spouse_gender->lookupOptions()) ?>;
fpatientedit.lists["x_spouse_blood_group"] = <?php echo $patient_edit->spouse_blood_group->Lookup->toClientList() ?>;
fpatientedit.lists["x_spouse_blood_group"].options = <?php echo JsonEncode($patient_edit->spouse_blood_group->lookupOptions()) ?>;
fpatientedit.lists["x_Maritalstatus"] = <?php echo $patient_edit->Maritalstatus->Lookup->toClientList() ?>;
fpatientedit.lists["x_Maritalstatus"].options = <?php echo JsonEncode($patient_edit->Maritalstatus->lookupOptions()) ?>;
fpatientedit.lists["x_Business"] = <?php echo $patient_edit->Business->Lookup->toClientList() ?>;
...
fpatientedit.lists["x_Patient_Language"] = <?php echo $patient_edit->Patient_Language->Lookup->toClientList() ?>;
fpatientedit.lists["x_Patient_Language"].options = <?php echo JsonEncode($patient_edit->Patient_Language->lookupOptions()) ?>;
fpatientedit.lists["x_WhereDidYouHear[]"] = <?php echo $patient_edit->WhereDidYouHear->Lookup->toClientList() ?>;
fpatientedit.lists["x_WhereDidYouHear[]"].options = <?php echo JsonEncode($patient_edit->WhereDidYouHear->lookupOptions()) ?>;
fpatientedit.lists["x_HospID"] = <?php echo $patient_edit->HospID->Lookup->toClientList() ?>;
fpatientedit.lists["x_HospID"].options = <?php echo JsonEncode($patient_edit->HospID->lookupOptions()) ?>;
fpatientedit.lists["x_AppointmentSearch"] = <?php echo $patient_edit->AppointmentSearch->Lookup->toClientList() ?>;
...
<?php if ($patient_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_edit->Token ?>">
<?php } ?>
...
<?php if ($patient->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_id" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_id" class="patientedit" type="text/html"><span><?php echo $patient->id->caption() ?><?php echo ($patient->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->id->cellAttributes() ?>>
<script id="tpx_patient_id" class="patientedit" type="text/html">
<span id="el_patient_id">
<span<?php echo $patient->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($patient->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="patient" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient->id->CurrentValue) ?>">
<?php echo $patient->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_patient_PatientID" for="x_PatientID" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_PatientID" class="patientedit" type="text/html"><span><?php echo $patient->PatientID->caption() ?><?php echo ($patient->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->PatientID->cellAttributes() ?>>
<script id="tpx_patient_PatientID" class="patientedit" type="text/html">
<span id="el_patient_PatientID">
<span<?php echo $patient->PatientID->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($patient->PatientID->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="patient" data-field="x_PatientID" name="x_PatientID" id="x_PatientID" value="<?php echo HtmlEncode($patient->PatientID->CurrentValue) ?>">
<?php echo $patient->PatientID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient->title->Visible) { // title ?>
	<div id="r_title" class="form-group row">
		<label id="elh_patient_title" for="x_title" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_title" class="patientedit" type="text/html"><span><?php echo $patient->title->caption() ?><?php echo ($patient->title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->title->cellAttributes() ?>>
<script id="tpx_patient_title" class="patientedit" type="text/html">
...
<?php if ($patient->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group row">
		<label id="elh_patient_first_name" for="x_first_name" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_first_name" class="patientedit" type="text/html"><span><?php echo $patient->first_name->caption() ?><?php echo ($patient->first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->first_name->cellAttributes() ?>>
<script id="tpx_patient_first_name" class="patientedit" type="text/html">
...
<?php if ($patient->middle_name->Visible) { // middle_name ?>
	<div id="r_middle_name" class="form-group row">
		<label id="elh_patient_middle_name" for="x_middle_name" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_middle_name" class="patientedit" type="text/html"><span><?php echo $patient->middle_name->caption() ?><?php echo ($patient->middle_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->middle_name->cellAttributes() ?>>
<script id="tpx_patient_middle_name" class="patientedit" type="text/html">
...
<?php if ($patient->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group row">
		<label id="elh_patient_last_name" for="x_last_name" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_last_name" class="patientedit" type="text/html"><span><?php echo $patient->last_name->caption() ?><?php echo ($patient->last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->last_name->cellAttributes() ?>>
<script id="tpx_patient_last_name" class="patientedit" type="text/html">
...
<?php if ($patient->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group row">
		<label id="elh_patient_gender" for="x_gender" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_gender" class="patientedit" type="text/html"><span><?php echo $patient->gender->caption() ?><?php echo ($patient->gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->gender->cellAttributes() ?>>
<script id="tpx_patient_gender" class="patientedit" type="text/html">
...
<?php if ($patient->dob->Visible) { // dob ?>
	<div id="r_dob" class="form-group row">
		<label id="elh_patient_dob" for="x_dob" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_dob" class="patientedit" type="text/html"><span><?php echo $patient->dob->caption() ?><?php echo ($patient->dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->dob->cellAttributes() ?>>
<script id="tpx_patient_dob" class="patientedit" type="text/html">
...
<?php if ($patient->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_patient_Age" for="x_Age" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Age" class="patientedit" type="text/html"><span><?php echo $patient->Age->caption() ?><?php echo ($patient->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Age->cellAttributes() ?>>
<script id="tpx_patient_Age" class="patientedit" type="text/html">
...
<?php if ($patient->blood_group->Visible) { // blood_group ?>
	<div id="r_blood_group" class="form-group row">
		<label id="elh_patient_blood_group" for="x_blood_group" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_blood_group" class="patientedit" type="text/html"><span><?php echo $patient->blood_group->caption() ?><?php echo ($patient->blood_group->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->blood_group->cellAttributes() ?>>
<script id="tpx_patient_blood_group" class="patientedit" type="text/html">
...
<?php if ($patient->mobile_no->Visible) { // mobile_no ?>
	<div id="r_mobile_no" class="form-group row">
		<label id="elh_patient_mobile_no" for="x_mobile_no" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_mobile_no" class="patientedit" type="text/html"><span><?php echo $patient->mobile_no->caption() ?><?php echo ($patient->mobile_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->mobile_no->cellAttributes() ?>>
<script id="tpx_patient_mobile_no" class="patientedit" type="text/html">
...
<?php if ($patient->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_patient_description" for="x_description" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_description" class="patientedit" type="text/html"><span><?php echo $patient->description->caption() ?><?php echo ($patient->description->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->description->cellAttributes() ?>>
<script id="tpx_patient_description" class="patientedit" type="text/html">
...
<?php if ($patient->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_status" for="x_status" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_status" class="patientedit" type="text/html"><span><?php echo $patient->status->caption() ?><?php echo ($patient->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->status->cellAttributes() ?>>
<script id="tpx_patient_status" class="patientedit" type="text/html">
...
<?php if ($patient->profilePic->Visible) { // profilePic ?>
	<div id="r_profilePic" class="form-group row">
		<label id="elh_patient_profilePic" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_profilePic" class="patientedit" type="text/html"><span><?php echo $patient->profilePic->caption() ?><?php echo ($patient->profilePic->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->profilePic->cellAttributes() ?>>
<script id="tpx_patient_profilePic" class="patientedit" type="text/html">
...
<?php if (Post("fa_x_profilePic") == "0") { ?>
<input type="hidden" name="fa_x_profilePic" id= "fa_x_profilePic" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_profilePic" id= "fa_x_profilePic" value="1">
<?php } ?>
...
<?php if ($patient->IdentificationMark->Visible) { // IdentificationMark ?>
	<div id="r_IdentificationMark" class="form-group row">
		<label id="elh_patient_IdentificationMark" for="x_IdentificationMark" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_IdentificationMark" class="patientedit" type="text/html"><span><?php echo $patient->IdentificationMark->caption() ?><?php echo ($patient->IdentificationMark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->IdentificationMark->cellAttributes() ?>>
<script id="tpx_patient_IdentificationMark" class="patientedit" type="text/html">
...
<?php if ($patient->Religion->Visible) { // Religion ?>
	<div id="r_Religion" class="form-group row">
		<label id="elh_patient_Religion" for="x_Religion" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Religion" class="patientedit" type="text/html"><span><?php echo $patient->Religion->caption() ?><?php echo ($patient->Religion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Religion->cellAttributes() ?>>
<script id="tpx_patient_Religion" class="patientedit" type="text/html">
...
<?php if ($patient->Nationality->Visible) { // Nationality ?>
	<div id="r_Nationality" class="form-group row">
		<label id="elh_patient_Nationality" for="x_Nationality" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Nationality" class="patientedit" type="text/html"><span><?php echo $patient->Nationality->caption() ?><?php echo ($patient->Nationality->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Nationality->cellAttributes() ?>>
<script id="tpx_patient_Nationality" class="patientedit" type="text/html">
...
<?php if ($patient->ReferedByDr->Visible) { // ReferedByDr ?>
	<div id="r_ReferedByDr" class="form-group row">
		<label id="elh_patient_ReferedByDr" for="x_ReferedByDr" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_ReferedByDr" class="patientedit" type="text/html"><span><?php echo $patient->ReferedByDr->caption() ?><?php echo ($patient->ReferedByDr->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->ReferedByDr->cellAttributes() ?>>
<script id="tpx_patient_ReferedByDr" class="patientedit" type="text/html">
...
<?php if ($patient->ReferClinicname->Visible) { // ReferClinicname ?>
	<div id="r_ReferClinicname" class="form-group row">
		<label id="elh_patient_ReferClinicname" for="x_ReferClinicname" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_ReferClinicname" class="patientedit" type="text/html"><span><?php echo $patient->ReferClinicname->caption() ?><?php echo ($patient->ReferClinicname->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->ReferClinicname->cellAttributes() ?>>
<script id="tpx_patient_ReferClinicname" class="patientedit" type="text/html">
...
<?php if ($patient->ReferCity->Visible) { // ReferCity ?>
	<div id="r_ReferCity" class="form-group row">
		<label id="elh_patient_ReferCity" for="x_ReferCity" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_ReferCity" class="patientedit" type="text/html"><span><?php echo $patient->ReferCity->caption() ?><?php echo ($patient->ReferCity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->ReferCity->cellAttributes() ?>>
<script id="tpx_patient_ReferCity" class="patientedit" type="text/html">
...
<?php if ($patient->ReferMobileNo->Visible) { // ReferMobileNo ?>
	<div id="r_ReferMobileNo" class="form-group row">
		<label id="elh_patient_ReferMobileNo" for="x_ReferMobileNo" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_ReferMobileNo" class="patientedit" type="text/html"><span><?php echo $patient->ReferMobileNo->caption() ?><?php echo ($patient->ReferMobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->ReferMobileNo->cellAttributes() ?>>
<script id="tpx_patient_ReferMobileNo" class="patientedit" type="text/html">
...
<?php if ($patient->ReferA4TreatingConsultant->Visible) { // ReferA4TreatingConsultant ?>
	<div id="r_ReferA4TreatingConsultant" class="form-group row">
		<label id="elh_patient_ReferA4TreatingConsultant" for="x_ReferA4TreatingConsultant" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_ReferA4TreatingConsultant" class="patientedit" type="text/html"><span><?php echo $patient->ReferA4TreatingConsultant->caption() ?><?php echo ($patient->ReferA4TreatingConsultant->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->ReferA4TreatingConsultant->cellAttributes() ?>>
<script id="tpx_patient_ReferA4TreatingConsultant" class="patientedit" type="text/html">
...
<?php if ($patient->PurposreReferredfor->Visible) { // PurposreReferredfor ?>
	<div id="r_PurposreReferredfor" class="form-group row">
		<label id="elh_patient_PurposreReferredfor" for="x_PurposreReferredfor" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_PurposreReferredfor" class="patientedit" type="text/html"><span><?php echo $patient->PurposreReferredfor->caption() ?><?php echo ($patient->PurposreReferredfor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->PurposreReferredfor->cellAttributes() ?>>
<script id="tpx_patient_PurposreReferredfor" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_title->Visible) { // spouse_title ?>
	<div id="r_spouse_title" class="form-group row">
		<label id="elh_patient_spouse_title" for="x_spouse_title" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_title" class="patientedit" type="text/html"><span><?php echo $patient->spouse_title->caption() ?><?php echo ($patient->spouse_title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_title->cellAttributes() ?>>
<script id="tpx_patient_spouse_title" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_first_name->Visible) { // spouse_first_name ?>
	<div id="r_spouse_first_name" class="form-group row">
		<label id="elh_patient_spouse_first_name" for="x_spouse_first_name" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_first_name" class="patientedit" type="text/html"><span><?php echo $patient->spouse_first_name->caption() ?><?php echo ($patient->spouse_first_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_first_name->cellAttributes() ?>>
<script id="tpx_patient_spouse_first_name" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_middle_name->Visible) { // spouse_middle_name ?>
	<div id="r_spouse_middle_name" class="form-group row">
		<label id="elh_patient_spouse_middle_name" for="x_spouse_middle_name" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_middle_name" class="patientedit" type="text/html"><span><?php echo $patient->spouse_middle_name->caption() ?><?php echo ($patient->spouse_middle_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_middle_name->cellAttributes() ?>>
<script id="tpx_patient_spouse_middle_name" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_last_name->Visible) { // spouse_last_name ?>
	<div id="r_spouse_last_name" class="form-group row">
		<label id="elh_patient_spouse_last_name" for="x_spouse_last_name" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_last_name" class="patientedit" type="text/html"><span><?php echo $patient->spouse_last_name->caption() ?><?php echo ($patient->spouse_last_name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_last_name->cellAttributes() ?>>
<script id="tpx_patient_spouse_last_name" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_gender->Visible) { // spouse_gender ?>
	<div id="r_spouse_gender" class="form-group row">
		<label id="elh_patient_spouse_gender" for="x_spouse_gender" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_gender" class="patientedit" type="text/html"><span><?php echo $patient->spouse_gender->caption() ?><?php echo ($patient->spouse_gender->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_gender->cellAttributes() ?>>
<script id="tpx_patient_spouse_gender" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_dob->Visible) { // spouse_dob ?>
	<div id="r_spouse_dob" class="form-group row">
		<label id="elh_patient_spouse_dob" for="x_spouse_dob" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_dob" class="patientedit" type="text/html"><span><?php echo $patient->spouse_dob->caption() ?><?php echo ($patient->spouse_dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_dob->cellAttributes() ?>>
<script id="tpx_patient_spouse_dob" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_Age->Visible) { // spouse_Age ?>
	<div id="r_spouse_Age" class="form-group row">
		<label id="elh_patient_spouse_Age" for="x_spouse_Age" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_Age" class="patientedit" type="text/html"><span><?php echo $patient->spouse_Age->caption() ?><?php echo ($patient->spouse_Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_Age->cellAttributes() ?>>
<script id="tpx_patient_spouse_Age" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_blood_group->Visible) { // spouse_blood_group ?>
	<div id="r_spouse_blood_group" class="form-group row">
		<label id="elh_patient_spouse_blood_group" for="x_spouse_blood_group" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_blood_group" class="patientedit" type="text/html"><span><?php echo $patient->spouse_blood_group->caption() ?><?php echo ($patient->spouse_blood_group->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_blood_group->cellAttributes() ?>>
<script id="tpx_patient_spouse_blood_group" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_mobile_no->Visible) { // spouse_mobile_no ?>
	<div id="r_spouse_mobile_no" class="form-group row">
		<label id="elh_patient_spouse_mobile_no" for="x_spouse_mobile_no" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_mobile_no" class="patientedit" type="text/html"><span><?php echo $patient->spouse_mobile_no->caption() ?><?php echo ($patient->spouse_mobile_no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_mobile_no->cellAttributes() ?>>
<script id="tpx_patient_spouse_mobile_no" class="patientedit" type="text/html">
...
<?php if ($patient->Maritalstatus->Visible) { // Maritalstatus ?>
	<div id="r_Maritalstatus" class="form-group row">
		<label id="elh_patient_Maritalstatus" for="x_Maritalstatus" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Maritalstatus" class="patientedit" type="text/html"><span><?php echo $patient->Maritalstatus->caption() ?><?php echo ($patient->Maritalstatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Maritalstatus->cellAttributes() ?>>
<script id="tpx_patient_Maritalstatus" class="patientedit" type="text/html">
...
<?php if ($patient->Business->Visible) { // Business ?>
	<div id="r_Business" class="form-group row">
		<label id="elh_patient_Business" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Business" class="patientedit" type="text/html"><span><?php echo $patient->Business->caption() ?><?php echo ($patient->Business->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Business->cellAttributes() ?>>
<script id="tpx_patient_Business" class="patientedit" type="text/html">
...
<?php if ($patient->Patient_Language->Visible) { // Patient_Language ?>
	<div id="r_Patient_Language" class="form-group row">
		<label id="elh_patient_Patient_Language" for="x_Patient_Language" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Patient_Language" class="patientedit" type="text/html"><span><?php echo $patient->Patient_Language->caption() ?><?php echo ($patient->Patient_Language->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Patient_Language->cellAttributes() ?>>
<script id="tpx_patient_Patient_Language" class="patientedit" type="text/html">
...
<?php if ($patient->Passport->Visible) { // Passport ?>
	<div id="r_Passport" class="form-group row">
		<label id="elh_patient_Passport" for="x_Passport" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Passport" class="patientedit" type="text/html"><span><?php echo $patient->Passport->caption() ?><?php echo ($patient->Passport->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Passport->cellAttributes() ?>>
<script id="tpx_patient_Passport" class="patientedit" type="text/html">
...
<?php if ($patient->VisaNo->Visible) { // VisaNo ?>
	<div id="r_VisaNo" class="form-group row">
		<label id="elh_patient_VisaNo" for="x_VisaNo" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_VisaNo" class="patientedit" type="text/html"><span><?php echo $patient->VisaNo->caption() ?><?php echo ($patient->VisaNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->VisaNo->cellAttributes() ?>>
<script id="tpx_patient_VisaNo" class="patientedit" type="text/html">
...
<?php if ($patient->ValidityOfVisa->Visible) { // ValidityOfVisa ?>
	<div id="r_ValidityOfVisa" class="form-group row">
		<label id="elh_patient_ValidityOfVisa" for="x_ValidityOfVisa" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_ValidityOfVisa" class="patientedit" type="text/html"><span><?php echo $patient->ValidityOfVisa->caption() ?><?php echo ($patient->ValidityOfVisa->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->ValidityOfVisa->cellAttributes() ?>>
<script id="tpx_patient_ValidityOfVisa" class="patientedit" type="text/html">
...
<?php if ($patient->WhereDidYouHear->Visible) { // WhereDidYouHear ?>
	<div id="r_WhereDidYouHear" class="form-group row">
		<label id="elh_patient_WhereDidYouHear" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_WhereDidYouHear" class="patientedit" type="text/html"><span><?php echo $patient->WhereDidYouHear->caption() ?><?php echo ($patient->WhereDidYouHear->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->WhereDidYouHear->cellAttributes() ?>>
<script id="tpx_patient_WhereDidYouHear" class="patientedit" type="text/html">
...
<?php if ($patient->street->Visible) { // street ?>
	<div id="r_street" class="form-group row">
		<label id="elh_patient_street" for="x_street" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_street" class="patientedit" type="text/html"><span><?php echo $patient->street->caption() ?><?php echo ($patient->street->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->street->cellAttributes() ?>>
<script id="tpx_patient_street" class="patientedit" type="text/html">
...
<?php if ($patient->town->Visible) { // town ?>
	<div id="r_town" class="form-group row">
		<label id="elh_patient_town" for="x_town" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_town" class="patientedit" type="text/html"><span><?php echo $patient->town->caption() ?><?php echo ($patient->town->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->town->cellAttributes() ?>>
<script id="tpx_patient_town" class="patientedit" type="text/html">
...
<?php if ($patient->province->Visible) { // province ?>
	<div id="r_province" class="form-group row">
		<label id="elh_patient_province" for="x_province" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_province" class="patientedit" type="text/html"><span><?php echo $patient->province->caption() ?><?php echo ($patient->province->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->province->cellAttributes() ?>>
<script id="tpx_patient_province" class="patientedit" type="text/html">
...
<?php if ($patient->country->Visible) { // country ?>
	<div id="r_country" class="form-group row">
		<label id="elh_patient_country" for="x_country" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_country" class="patientedit" type="text/html"><span><?php echo $patient->country->caption() ?><?php echo ($patient->country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->country->cellAttributes() ?>>
<script id="tpx_patient_country" class="patientedit" type="text/html">
...
<?php if ($patient->postal_code->Visible) { // postal_code ?>
	<div id="r_postal_code" class="form-group row">
		<label id="elh_patient_postal_code" for="x_postal_code" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_postal_code" class="patientedit" type="text/html"><span><?php echo $patient->postal_code->caption() ?><?php echo ($patient->postal_code->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->postal_code->cellAttributes() ?>>
<script id="tpx_patient_postal_code" class="patientedit" type="text/html">
...
<?php if ($patient->PEmail->Visible) { // PEmail ?>
	<div id="r_PEmail" class="form-group row">
		<label id="elh_patient_PEmail" for="x_PEmail" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_PEmail" class="patientedit" type="text/html"><span><?php echo $patient->PEmail->caption() ?><?php echo ($patient->PEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->PEmail->cellAttributes() ?>>
<script id="tpx_patient_PEmail" class="patientedit" type="text/html">
...
<?php if ($patient->PEmergencyContact->Visible) { // PEmergencyContact ?>
	<div id="r_PEmergencyContact" class="form-group row">
		<label id="elh_patient_PEmergencyContact" for="x_PEmergencyContact" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_PEmergencyContact" class="patientedit" type="text/html"><span><?php echo $patient->PEmergencyContact->caption() ?><?php echo ($patient->PEmergencyContact->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->PEmergencyContact->cellAttributes() ?>>
<script id="tpx_patient_PEmergencyContact" class="patientedit" type="text/html">
...
<?php if ($patient->occupation->Visible) { // occupation ?>
	<div id="r_occupation" class="form-group row">
		<label id="elh_patient_occupation" for="x_occupation" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_occupation" class="patientedit" type="text/html"><span><?php echo $patient->occupation->caption() ?><?php echo ($patient->occupation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->occupation->cellAttributes() ?>>
<script id="tpx_patient_occupation" class="patientedit" type="text/html">
...
<?php if ($patient->spouse_occupation->Visible) { // spouse_occupation ?>
	<div id="r_spouse_occupation" class="form-group row">
		<label id="elh_patient_spouse_occupation" for="x_spouse_occupation" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_spouse_occupation" class="patientedit" type="text/html"><span><?php echo $patient->spouse_occupation->caption() ?><?php echo ($patient->spouse_occupation->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->spouse_occupation->cellAttributes() ?>>
<script id="tpx_patient_spouse_occupation" class="patientedit" type="text/html">
...
<?php if ($patient->WhatsApp->Visible) { // WhatsApp ?>
	<div id="r_WhatsApp" class="form-group row">
		<label id="elh_patient_WhatsApp" for="x_WhatsApp" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_WhatsApp" class="patientedit" type="text/html"><span><?php echo $patient->WhatsApp->caption() ?><?php echo ($patient->WhatsApp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->WhatsApp->cellAttributes() ?>>
<script id="tpx_patient_WhatsApp" class="patientedit" type="text/html">
...
<?php if ($patient->CouppleID->Visible) { // CouppleID ?>
	<div id="r_CouppleID" class="form-group row">
		<label id="elh_patient_CouppleID" for="x_CouppleID" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_CouppleID" class="patientedit" type="text/html"><span><?php echo $patient->CouppleID->caption() ?><?php echo ($patient->CouppleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->CouppleID->cellAttributes() ?>>
<script id="tpx_patient_CouppleID" class="patientedit" type="text/html">
...
<?php if ($patient->MaleID->Visible) { // MaleID ?>
	<div id="r_MaleID" class="form-group row">
		<label id="elh_patient_MaleID" for="x_MaleID" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_MaleID" class="patientedit" type="text/html"><span><?php echo $patient->MaleID->caption() ?><?php echo ($patient->MaleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->MaleID->cellAttributes() ?>>
<script id="tpx_patient_MaleID" class="patientedit" type="text/html">
...
<?php if ($patient->FemaleID->Visible) { // FemaleID ?>
	<div id="r_FemaleID" class="form-group row">
		<label id="elh_patient_FemaleID" for="x_FemaleID" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_FemaleID" class="patientedit" type="text/html"><span><?php echo $patient->FemaleID->caption() ?><?php echo ($patient->FemaleID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->FemaleID->cellAttributes() ?>>
<script id="tpx_patient_FemaleID" class="patientedit" type="text/html">
...
<?php if ($patient->GroupID->Visible) { // GroupID ?>
	<div id="r_GroupID" class="form-group row">
		<label id="elh_patient_GroupID" for="x_GroupID" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_GroupID" class="patientedit" type="text/html"><span><?php echo $patient->GroupID->caption() ?><?php echo ($patient->GroupID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->GroupID->cellAttributes() ?>>
<script id="tpx_patient_GroupID" class="patientedit" type="text/html">
...
<?php if ($patient->Relationship->Visible) { // Relationship ?>
	<div id="r_Relationship" class="form-group row">
		<label id="elh_patient_Relationship" for="x_Relationship" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Relationship" class="patientedit" type="text/html"><span><?php echo $patient->Relationship->caption() ?><?php echo ($patient->Relationship->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Relationship->cellAttributes() ?>>
<script id="tpx_patient_Relationship" class="patientedit" type="text/html">
...
<?php if ($patient->AppointmentSearch->Visible) { // AppointmentSearch ?>
	<div id="r_AppointmentSearch" class="form-group row">
		<label id="elh_patient_AppointmentSearch" for="x_AppointmentSearch" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_AppointmentSearch" class="patientedit" type="text/html"><span><?php echo $patient->AppointmentSearch->caption() ?><?php echo ($patient->AppointmentSearch->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->AppointmentSearch->cellAttributes() ?>>
<script id="tpx_patient_AppointmentSearch" class="patientedit" type="text/html">
...
<?php if ($patient->FacebookID->Visible) { // FacebookID ?>
	<div id="r_FacebookID" class="form-group row">
		<label id="elh_patient_FacebookID" for="x_FacebookID" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_FacebookID" class="patientedit" type="text/html"><span><?php echo $patient->FacebookID->caption() ?><?php echo ($patient->FacebookID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->FacebookID->cellAttributes() ?>>
<script id="tpx_patient_FacebookID" class="patientedit" type="text/html">
...
<?php if ($patient->profilePicImage->Visible) { // profilePicImage ?>
	<div id="r_profilePicImage" class="form-group row">
		<label id="elh_patient_profilePicImage" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_profilePicImage" class="patientedit" type="text/html"><span><?php echo $patient->profilePicImage->caption() ?><?php echo ($patient->profilePicImage->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->profilePicImage->cellAttributes() ?>>
<script id="tpx_patient_profilePicImage" class="patientedit" type="text/html">
...
<?php if (Post("fa_x_profilePicImage") == "0") { ?>
<input type="hidden" name="fa_x_profilePicImage" id= "fa_x_profilePicImage" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x_profilePicImage" id= "fa_x_profilePicImage" value="1">
<?php } ?>
...
<?php if ($patient->Clients->Visible) { // Clients ?>
	<div id="r_Clients" class="form-group row">
		<label id="elh_patient_Clients" for="x_Clients" class="<?php echo $patient_edit->LeftColumnClass ?>"><script id="tpc_patient_Clients" class="patientedit" type="text/html"><span><?php echo $patient->Clients->caption() ?><?php echo ($patient->Clients->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $patient_edit->RightColumnClass ?>"><div<?php echo $patient->Clients->cellAttributes() ?>>
<script id="tpx_patient_Clients" class="patientedit" type="text/html">
...
//	$ccid = $resultsa[0]["Name"];
	...
	$cPatientID = $results1[0]["PatientID"];
}
if($cPatientID == null)
{
...
ew.applyTemplate("tpd_patientedit", "tpm_patientedit", "patientedit", "<?php echo $patient->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.patientedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
