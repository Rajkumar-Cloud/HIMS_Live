...
var fivf_vitals_historyedit = currentForm = new ew.Form("fivf_vitals_historyedit", "edit");
...
fivf_vitals_historyedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($ivf_vitals_history_edit->AntiTPO->Required) { ?>
		...
		<?php } ?>
		<?php if ($ivf_vitals_history_edit->AntiTG->Required) { ?>
...
fivf_vitals_historyedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fivf_vitals_historyedit.lists["x_MedicalHistory[]"] = <?php echo $ivf_vitals_history_edit->MedicalHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_FBloodgroup"] = <?php echo $ivf_vitals_history_edit->FBloodgroup->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_MBloodgroup"] = <?php echo $ivf_vitals_history_edit->MBloodgroup->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_FBuild"] = <?php echo $ivf_vitals_history_edit->FBuild->Lookup->toClientList() ?>;
fivf_vitals_historyedit.lists["x_FBuild"].options = <?php echo JsonEncode($ivf_vitals_history_edit->FBuild->options(FALSE, TRUE)) ?>;
fivf_vitals_historyedit.lists["x_MBuild"] = <?php echo $ivf_vitals_history_edit->MBuild->Lookup->toClientList() ?>;
fivf_vitals_historyedit.lists["x_MBuild"].options = <?php echo JsonEncode($ivf_vitals_history_edit->MBuild->options(FALSE, TRUE)) ?>;
fivf_vitals_historyedit.lists["x_FSkinColor"] = <?php echo $ivf_vitals_history_edit->FSkinColor->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_MSkinColor"] = <?php echo $ivf_vitals_history_edit->MSkinColor->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_FEyesColor"] = <?php echo $ivf_vitals_history_edit->FEyesColor->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_MEyesColor"] = <?php echo $ivf_vitals_history_edit->MEyesColor->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_FHairColor"] = <?php echo $ivf_vitals_history_edit->FHairColor->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_MhairColor"] = <?php echo $ivf_vitals_history_edit->MhairColor->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_FhairTexture"] = <?php echo $ivf_vitals_history_edit->FhairTexture->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_MHairTexture"] = <?php echo $ivf_vitals_history_edit->MHairTexture->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_FamilyHistory"] = <?php echo $ivf_vitals_history_edit->FamilyHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_Addictions[]"] = <?php echo $ivf_vitals_history_edit->Addictions->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_Medical"] = <?php echo $ivf_vitals_history_edit->Medical->Lookup->toClientList() ?>;
fivf_vitals_historyedit.lists["x_Medical"].options = <?php echo JsonEncode($ivf_vitals_history_edit->Medical->options(FALSE, TRUE)) ?>;
fivf_vitals_historyedit.lists["x_Surgical"] = <?php echo $ivf_vitals_history_edit->Surgical->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_CoitalHistory"] = <?php echo $ivf_vitals_history_edit->CoitalHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateMenstrualHistory"] = <?php echo $ivf_vitals_history_edit->TemplateMenstrualHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateObstetricHistory"] = <?php echo $ivf_vitals_history_edit->TemplateObstetricHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateFertilityTreatmentHistory"] = <?php echo $ivf_vitals_history_edit->TemplateFertilityTreatmentHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateSurgeryHistory"] = <?php echo $ivf_vitals_history_edit->TemplateSurgeryHistory->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateFInvestigations"] = <?php echo $ivf_vitals_history_edit->TemplateFInvestigations->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplatePlanOfManagement"] = <?php echo $ivf_vitals_history_edit->TemplatePlanOfManagement->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplatePImpression"] = <?php echo $ivf_vitals_history_edit->TemplatePImpression->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateMedications"] = <?php echo $ivf_vitals_history_edit->TemplateMedications->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateSemenAnalysis"] = <?php echo $ivf_vitals_history_edit->TemplateSemenAnalysis->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_MaleInsvestications"] = <?php echo $ivf_vitals_history_edit->MaleInsvestications->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateMIMpression"] = <?php echo $ivf_vitals_history_edit->TemplateMIMpression->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_TemplateMalePlanOfManagement"] = <?php echo $ivf_vitals_history_edit->TemplateMalePlanOfManagement->Lookup->toClientList() ?>;
...
fivf_vitals_historyedit.lists["x_pFamilyHistory"] = <?php echo $ivf_vitals_history_edit->pFamilyHistory->Lookup->toClientList() ?>;
...
<?php if ($ivf_vitals_history_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $ivf_vitals_history_edit->Token ?>">
<?php } ?>
...
<?php if ($ivf_vitals_history->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_ivf_vitals_history_id" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_id" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->id->caption() ?><?php echo ($ivf_vitals_history->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->id->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_id" class="ivf_vitals_historyedit" type="text/html">
...
<input type="hidden" data-table="ivf_vitals_history" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($ivf_vitals_history->id->CurrentValue) ?>">
<?php echo $ivf_vitals_history->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($ivf_vitals_history->RIDNO->Visible) { // RIDNO ?>
	<div id="r_RIDNO" class="form-group row">
		<label id="elh_ivf_vitals_history_RIDNO" for="x_RIDNO" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_RIDNO" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->RIDNO->caption() ?><?php echo ($ivf_vitals_history->RIDNO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->RIDNO->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_RIDNO" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_ivf_vitals_history_Name" for="x_Name" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Name" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Name->caption() ?><?php echo ($ivf_vitals_history->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Name->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Name" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh_ivf_vitals_history_Age" for="x_Age" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Age" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Age->caption() ?><?php echo ($ivf_vitals_history->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Age->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Age" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->SEX->Visible) { // SEX ?>
	<div id="r_SEX" class="form-group row">
		<label id="elh_ivf_vitals_history_SEX" for="x_SEX" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_SEX" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->SEX->caption() ?><?php echo ($ivf_vitals_history->SEX->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->SEX->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_SEX" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Religion->Visible) { // Religion ?>
	<div id="r_Religion" class="form-group row">
		<label id="elh_ivf_vitals_history_Religion" for="x_Religion" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Religion" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Religion->caption() ?><?php echo ($ivf_vitals_history->Religion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Religion->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Religion" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group row">
		<label id="elh_ivf_vitals_history_Address" for="x_Address" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Address" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Address->caption() ?><?php echo ($ivf_vitals_history->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Address->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Address" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->IdentificationMark->Visible) { // IdentificationMark ?>
	<div id="r_IdentificationMark" class="form-group row">
		<label id="elh_ivf_vitals_history_IdentificationMark" for="x_IdentificationMark" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_IdentificationMark" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->IdentificationMark->caption() ?><?php echo ($ivf_vitals_history->IdentificationMark->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->IdentificationMark->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_IdentificationMark" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->DoublewitnessName1->Visible) { // DoublewitnessName1 ?>
	<div id="r_DoublewitnessName1" class="form-group row">
		<label id="elh_ivf_vitals_history_DoublewitnessName1" for="x_DoublewitnessName1" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_DoublewitnessName1" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->DoublewitnessName1->caption() ?><?php echo ($ivf_vitals_history->DoublewitnessName1->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->DoublewitnessName1->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_DoublewitnessName1" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->DoublewitnessName2->Visible) { // DoublewitnessName2 ?>
	<div id="r_DoublewitnessName2" class="form-group row">
		<label id="elh_ivf_vitals_history_DoublewitnessName2" for="x_DoublewitnessName2" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_DoublewitnessName2" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->DoublewitnessName2->caption() ?><?php echo ($ivf_vitals_history->DoublewitnessName2->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->DoublewitnessName2->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_DoublewitnessName2" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Chiefcomplaints->Visible) { // Chiefcomplaints ?>
	<div id="r_Chiefcomplaints" class="form-group row">
		<label id="elh_ivf_vitals_history_Chiefcomplaints" for="x_Chiefcomplaints" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Chiefcomplaints" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Chiefcomplaints->caption() ?><?php echo ($ivf_vitals_history->Chiefcomplaints->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Chiefcomplaints->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Chiefcomplaints" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MenstrualHistory->Visible) { // MenstrualHistory ?>
	<div id="r_MenstrualHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_MenstrualHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MenstrualHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MenstrualHistory->caption() ?><?php echo ($ivf_vitals_history->MenstrualHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MenstrualHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MenstrualHistory" class="ivf_vitals_historyedit" type="text/html">
...
ew.createEditor("fivf_vitals_historyedit", "x_MenstrualHistory", 0, 0, <?php echo ($ivf_vitals_history->MenstrualHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->ObstetricHistory->Visible) { // ObstetricHistory ?>
	<div id="r_ObstetricHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_ObstetricHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_ObstetricHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->ObstetricHistory->caption() ?><?php echo ($ivf_vitals_history->ObstetricHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->ObstetricHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_ObstetricHistory" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_ObstetricHistory", 0, 0, <?php echo ($ivf_vitals_history->ObstetricHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->MedicalHistory->Visible) { // MedicalHistory ?>
	<div id="r_MedicalHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_MedicalHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MedicalHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MedicalHistory->caption() ?><?php echo ($ivf_vitals_history->MedicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MedicalHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MedicalHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->SurgicalHistory->Visible) { // SurgicalHistory ?>
	<div id="r_SurgicalHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_SurgicalHistory" for="x_SurgicalHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_SurgicalHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->SurgicalHistory->caption() ?><?php echo ($ivf_vitals_history->SurgicalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->SurgicalHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_SurgicalHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Generalexaminationpallor->Visible) { // Generalexaminationpallor ?>
	<div id="r_Generalexaminationpallor" class="form-group row">
		<label id="elh_ivf_vitals_history_Generalexaminationpallor" for="x_Generalexaminationpallor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Generalexaminationpallor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Generalexaminationpallor->caption() ?><?php echo ($ivf_vitals_history->Generalexaminationpallor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Generalexaminationpallor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Generalexaminationpallor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PR->Visible) { // PR ?>
	<div id="r_PR" class="form-group row">
		<label id="elh_ivf_vitals_history_PR" for="x_PR" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PR" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PR->caption() ?><?php echo ($ivf_vitals_history->PR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PR->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PR" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->CVS->Visible) { // CVS ?>
	<div id="r_CVS" class="form-group row">
		<label id="elh_ivf_vitals_history_CVS" for="x_CVS" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_CVS" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->CVS->caption() ?><?php echo ($ivf_vitals_history->CVS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->CVS->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_CVS" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PA->Visible) { // PA ?>
	<div id="r_PA" class="form-group row">
		<label id="elh_ivf_vitals_history_PA" for="x_PA" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PA" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PA->caption() ?><?php echo ($ivf_vitals_history->PA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PA->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PA" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PROVISIONALDIAGNOSIS->Visible) { // PROVISIONALDIAGNOSIS ?>
	<div id="r_PROVISIONALDIAGNOSIS" class="form-group row">
		<label id="elh_ivf_vitals_history_PROVISIONALDIAGNOSIS" for="x_PROVISIONALDIAGNOSIS" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PROVISIONALDIAGNOSIS" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PROVISIONALDIAGNOSIS->caption() ?><?php echo ($ivf_vitals_history->PROVISIONALDIAGNOSIS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PROVISIONALDIAGNOSIS->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PROVISIONALDIAGNOSIS" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Investigations->Visible) { // Investigations ?>
	<div id="r_Investigations" class="form-group row">
		<label id="elh_ivf_vitals_history_Investigations" for="x_Investigations" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Investigations" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Investigations->caption() ?><?php echo ($ivf_vitals_history->Investigations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Investigations->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Investigations" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Fheight->Visible) { // Fheight ?>
	<div id="r_Fheight" class="form-group row">
		<label id="elh_ivf_vitals_history_Fheight" for="x_Fheight" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Fheight" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Fheight->caption() ?><?php echo ($ivf_vitals_history->Fheight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Fheight->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Fheight" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Fweight->Visible) { // Fweight ?>
	<div id="r_Fweight" class="form-group row">
		<label id="elh_ivf_vitals_history_Fweight" for="x_Fweight" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Fweight" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Fweight->caption() ?><?php echo ($ivf_vitals_history->Fweight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Fweight->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Fweight" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FBMI->Visible) { // FBMI ?>
	<div id="r_FBMI" class="form-group row">
		<label id="elh_ivf_vitals_history_FBMI" for="x_FBMI" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FBMI" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FBMI->caption() ?><?php echo ($ivf_vitals_history->FBMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FBMI->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FBMI" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FBloodgroup->Visible) { // FBloodgroup ?>
	<div id="r_FBloodgroup" class="form-group row">
		<label id="elh_ivf_vitals_history_FBloodgroup" for="x_FBloodgroup" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FBloodgroup" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FBloodgroup->caption() ?><?php echo ($ivf_vitals_history->FBloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FBloodgroup->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FBloodgroup" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Mheight->Visible) { // Mheight ?>
	<div id="r_Mheight" class="form-group row">
		<label id="elh_ivf_vitals_history_Mheight" for="x_Mheight" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Mheight" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Mheight->caption() ?><?php echo ($ivf_vitals_history->Mheight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Mheight->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Mheight" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Mweight->Visible) { // Mweight ?>
	<div id="r_Mweight" class="form-group row">
		<label id="elh_ivf_vitals_history_Mweight" for="x_Mweight" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Mweight" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Mweight->caption() ?><?php echo ($ivf_vitals_history->Mweight->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Mweight->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Mweight" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MBMI->Visible) { // MBMI ?>
	<div id="r_MBMI" class="form-group row">
		<label id="elh_ivf_vitals_history_MBMI" for="x_MBMI" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MBMI" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MBMI->caption() ?><?php echo ($ivf_vitals_history->MBMI->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MBMI->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MBMI" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MBloodgroup->Visible) { // MBloodgroup ?>
	<div id="r_MBloodgroup" class="form-group row">
		<label id="elh_ivf_vitals_history_MBloodgroup" for="x_MBloodgroup" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MBloodgroup" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MBloodgroup->caption() ?><?php echo ($ivf_vitals_history->MBloodgroup->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MBloodgroup->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MBloodgroup" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FBuild->Visible) { // FBuild ?>
	<div id="r_FBuild" class="form-group row">
		<label id="elh_ivf_vitals_history_FBuild" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FBuild" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FBuild->caption() ?><?php echo ($ivf_vitals_history->FBuild->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FBuild->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FBuild" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MBuild->Visible) { // MBuild ?>
	<div id="r_MBuild" class="form-group row">
		<label id="elh_ivf_vitals_history_MBuild" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MBuild" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MBuild->caption() ?><?php echo ($ivf_vitals_history->MBuild->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MBuild->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MBuild" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FSkinColor->Visible) { // FSkinColor ?>
	<div id="r_FSkinColor" class="form-group row">
		<label id="elh_ivf_vitals_history_FSkinColor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FSkinColor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FSkinColor->caption() ?><?php echo ($ivf_vitals_history->FSkinColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FSkinColor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FSkinColor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MSkinColor->Visible) { // MSkinColor ?>
	<div id="r_MSkinColor" class="form-group row">
		<label id="elh_ivf_vitals_history_MSkinColor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MSkinColor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MSkinColor->caption() ?><?php echo ($ivf_vitals_history->MSkinColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MSkinColor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MSkinColor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FEyesColor->Visible) { // FEyesColor ?>
	<div id="r_FEyesColor" class="form-group row">
		<label id="elh_ivf_vitals_history_FEyesColor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FEyesColor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FEyesColor->caption() ?><?php echo ($ivf_vitals_history->FEyesColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FEyesColor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FEyesColor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MEyesColor->Visible) { // MEyesColor ?>
	<div id="r_MEyesColor" class="form-group row">
		<label id="elh_ivf_vitals_history_MEyesColor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MEyesColor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MEyesColor->caption() ?><?php echo ($ivf_vitals_history->MEyesColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MEyesColor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MEyesColor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FHairColor->Visible) { // FHairColor ?>
	<div id="r_FHairColor" class="form-group row">
		<label id="elh_ivf_vitals_history_FHairColor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FHairColor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FHairColor->caption() ?><?php echo ($ivf_vitals_history->FHairColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FHairColor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FHairColor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MhairColor->Visible) { // MhairColor ?>
	<div id="r_MhairColor" class="form-group row">
		<label id="elh_ivf_vitals_history_MhairColor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MhairColor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MhairColor->caption() ?><?php echo ($ivf_vitals_history->MhairColor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MhairColor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MhairColor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FhairTexture->Visible) { // FhairTexture ?>
	<div id="r_FhairTexture" class="form-group row">
		<label id="elh_ivf_vitals_history_FhairTexture" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FhairTexture" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FhairTexture->caption() ?><?php echo ($ivf_vitals_history->FhairTexture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FhairTexture->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FhairTexture" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MHairTexture->Visible) { // MHairTexture ?>
	<div id="r_MHairTexture" class="form-group row">
		<label id="elh_ivf_vitals_history_MHairTexture" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MHairTexture" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MHairTexture->caption() ?><?php echo ($ivf_vitals_history->MHairTexture->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MHairTexture->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MHairTexture" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Fothers->Visible) { // Fothers ?>
	<div id="r_Fothers" class="form-group row">
		<label id="elh_ivf_vitals_history_Fothers" for="x_Fothers" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Fothers" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Fothers->caption() ?><?php echo ($ivf_vitals_history->Fothers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Fothers->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Fothers" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Mothers->Visible) { // Mothers ?>
	<div id="r_Mothers" class="form-group row">
		<label id="elh_ivf_vitals_history_Mothers" for="x_Mothers" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Mothers" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Mothers->caption() ?><?php echo ($ivf_vitals_history->Mothers->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Mothers->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Mothers" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PGE->Visible) { // PGE ?>
	<div id="r_PGE" class="form-group row">
		<label id="elh_ivf_vitals_history_PGE" for="x_PGE" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PGE" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PGE->caption() ?><?php echo ($ivf_vitals_history->PGE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PGE->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PGE" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PPR->Visible) { // PPR ?>
	<div id="r_PPR" class="form-group row">
		<label id="elh_ivf_vitals_history_PPR" for="x_PPR" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PPR" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PPR->caption() ?><?php echo ($ivf_vitals_history->PPR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PPR->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PPR" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PBP->Visible) { // PBP ?>
	<div id="r_PBP" class="form-group row">
		<label id="elh_ivf_vitals_history_PBP" for="x_PBP" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PBP" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PBP->caption() ?><?php echo ($ivf_vitals_history->PBP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PBP->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PBP" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Breast->Visible) { // Breast ?>
	<div id="r_Breast" class="form-group row">
		<label id="elh_ivf_vitals_history_Breast" for="x_Breast" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Breast" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Breast->caption() ?><?php echo ($ivf_vitals_history->Breast->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Breast->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Breast" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PPA->Visible) { // PPA ?>
	<div id="r_PPA" class="form-group row">
		<label id="elh_ivf_vitals_history_PPA" for="x_PPA" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PPA" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PPA->caption() ?><?php echo ($ivf_vitals_history->PPA->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PPA->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PPA" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PPSV->Visible) { // PPSV ?>
	<div id="r_PPSV" class="form-group row">
		<label id="elh_ivf_vitals_history_PPSV" for="x_PPSV" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PPSV" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PPSV->caption() ?><?php echo ($ivf_vitals_history->PPSV->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PPSV->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PPSV" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PPAPSMEAR->Visible) { // PPAPSMEAR ?>
	<div id="r_PPAPSMEAR" class="form-group row">
		<label id="elh_ivf_vitals_history_PPAPSMEAR" for="x_PPAPSMEAR" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PPAPSMEAR" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PPAPSMEAR->caption() ?><?php echo ($ivf_vitals_history->PPAPSMEAR->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PPAPSMEAR->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PPAPSMEAR" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PTHYROID->Visible) { // PTHYROID ?>
	<div id="r_PTHYROID" class="form-group row">
		<label id="elh_ivf_vitals_history_PTHYROID" for="x_PTHYROID" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PTHYROID" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PTHYROID->caption() ?><?php echo ($ivf_vitals_history->PTHYROID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PTHYROID->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PTHYROID" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MTHYROID->Visible) { // MTHYROID ?>
	<div id="r_MTHYROID" class="form-group row">
		<label id="elh_ivf_vitals_history_MTHYROID" for="x_MTHYROID" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MTHYROID" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MTHYROID->caption() ?><?php echo ($ivf_vitals_history->MTHYROID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MTHYROID->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MTHYROID" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->SecSexCharacters->Visible) { // SecSexCharacters ?>
	<div id="r_SecSexCharacters" class="form-group row">
		<label id="elh_ivf_vitals_history_SecSexCharacters" for="x_SecSexCharacters" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_SecSexCharacters" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->SecSexCharacters->caption() ?><?php echo ($ivf_vitals_history->SecSexCharacters->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->SecSexCharacters->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_SecSexCharacters" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PenisUM->Visible) { // PenisUM ?>
	<div id="r_PenisUM" class="form-group row">
		<label id="elh_ivf_vitals_history_PenisUM" for="x_PenisUM" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PenisUM" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PenisUM->caption() ?><?php echo ($ivf_vitals_history->PenisUM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PenisUM->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PenisUM" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->VAS->Visible) { // VAS ?>
	<div id="r_VAS" class="form-group row">
		<label id="elh_ivf_vitals_history_VAS" for="x_VAS" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_VAS" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->VAS->caption() ?><?php echo ($ivf_vitals_history->VAS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->VAS->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_VAS" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->EPIDIDYMIS->Visible) { // EPIDIDYMIS ?>
	<div id="r_EPIDIDYMIS" class="form-group row">
		<label id="elh_ivf_vitals_history_EPIDIDYMIS" for="x_EPIDIDYMIS" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_EPIDIDYMIS" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->EPIDIDYMIS->caption() ?><?php echo ($ivf_vitals_history->EPIDIDYMIS->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->EPIDIDYMIS->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_EPIDIDYMIS" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Varicocele->Visible) { // Varicocele ?>
	<div id="r_Varicocele" class="form-group row">
		<label id="elh_ivf_vitals_history_Varicocele" for="x_Varicocele" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Varicocele" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Varicocele->caption() ?><?php echo ($ivf_vitals_history->Varicocele->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Varicocele->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Varicocele" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->FertilityTreatmentHistory->Visible) { // FertilityTreatmentHistory ?>
	<div id="r_FertilityTreatmentHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_FertilityTreatmentHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FertilityTreatmentHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FertilityTreatmentHistory->caption() ?><?php echo ($ivf_vitals_history->FertilityTreatmentHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FertilityTreatmentHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FertilityTreatmentHistory" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_FertilityTreatmentHistory", 35, 4, <?php echo ($ivf_vitals_history->FertilityTreatmentHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->SurgeryHistory->Visible) { // SurgeryHistory ?>
	<div id="r_SurgeryHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_SurgeryHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_SurgeryHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->SurgeryHistory->caption() ?><?php echo ($ivf_vitals_history->SurgeryHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->SurgeryHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_SurgeryHistory" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_SurgeryHistory", 35, 4, <?php echo ($ivf_vitals_history->SurgeryHistory->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->FamilyHistory->Visible) { // FamilyHistory ?>
	<div id="r_FamilyHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_FamilyHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_FamilyHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->FamilyHistory->caption() ?><?php echo ($ivf_vitals_history->FamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->FamilyHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_FamilyHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->PInvestigations->Visible) { // PInvestigations ?>
	<div id="r_PInvestigations" class="form-group row">
		<label id="elh_ivf_vitals_history_PInvestigations" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PInvestigations" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PInvestigations->caption() ?><?php echo ($ivf_vitals_history->PInvestigations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PInvestigations->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PInvestigations" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_PInvestigations", 35, 4, <?php echo ($ivf_vitals_history->PInvestigations->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->Addictions->Visible) { // Addictions ?>
	<div id="r_Addictions" class="form-group row">
		<label id="elh_ivf_vitals_history_Addictions" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Addictions" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Addictions->caption() ?><?php echo ($ivf_vitals_history->Addictions->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Addictions->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Addictions" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Medications->Visible) { // Medications ?>
	<div id="r_Medications" class="form-group row">
		<label id="elh_ivf_vitals_history_Medications" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Medications" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Medications->caption() ?><?php echo ($ivf_vitals_history->Medications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Medications->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Medications" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_Medications", 35, 4, <?php echo ($ivf_vitals_history->Medications->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->Medical->Visible) { // Medical ?>
	<div id="r_Medical" class="form-group row">
		<label id="elh_ivf_vitals_history_Medical" for="x_Medical" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Medical" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Medical->caption() ?><?php echo ($ivf_vitals_history->Medical->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Medical->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Medical" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->Surgical->Visible) { // Surgical ?>
	<div id="r_Surgical" class="form-group row">
		<label id="elh_ivf_vitals_history_Surgical" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_Surgical" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->Surgical->caption() ?><?php echo ($ivf_vitals_history->Surgical->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->Surgical->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_Surgical" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->CoitalHistory->Visible) { // CoitalHistory ?>
	<div id="r_CoitalHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_CoitalHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_CoitalHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->CoitalHistory->caption() ?><?php echo ($ivf_vitals_history->CoitalHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->CoitalHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_CoitalHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->SemenAnalysis->Visible) { // SemenAnalysis ?>
	<div id="r_SemenAnalysis" class="form-group row">
		<label id="elh_ivf_vitals_history_SemenAnalysis" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_SemenAnalysis" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->SemenAnalysis->caption() ?><?php echo ($ivf_vitals_history->SemenAnalysis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->SemenAnalysis->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_SemenAnalysis" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_SemenAnalysis", 35, 4, <?php echo ($ivf_vitals_history->SemenAnalysis->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->MInsvestications->Visible) { // MInsvestications ?>
	<div id="r_MInsvestications" class="form-group row">
		<label id="elh_ivf_vitals_history_MInsvestications" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MInsvestications" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MInsvestications->caption() ?><?php echo ($ivf_vitals_history->MInsvestications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MInsvestications->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MInsvestications" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_MInsvestications", 35, 4, <?php echo ($ivf_vitals_history->MInsvestications->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->PImpression->Visible) { // PImpression ?>
	<div id="r_PImpression" class="form-group row">
		<label id="elh_ivf_vitals_history_PImpression" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PImpression" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PImpression->caption() ?><?php echo ($ivf_vitals_history->PImpression->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PImpression->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PImpression" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_PImpression", 35, 4, <?php echo ($ivf_vitals_history->PImpression->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->MIMpression->Visible) { // MIMpression ?>
	<div id="r_MIMpression" class="form-group row">
		<label id="elh_ivf_vitals_history_MIMpression" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MIMpression" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MIMpression->caption() ?><?php echo ($ivf_vitals_history->MIMpression->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MIMpression->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MIMpression" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_MIMpression", 35, 4, <?php echo ($ivf_vitals_history->MIMpression->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->PPlanOfManagement->Visible) { // PPlanOfManagement ?>
	<div id="r_PPlanOfManagement" class="form-group row">
		<label id="elh_ivf_vitals_history_PPlanOfManagement" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PPlanOfManagement" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PPlanOfManagement->caption() ?><?php echo ($ivf_vitals_history->PPlanOfManagement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PPlanOfManagement->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PPlanOfManagement" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_PPlanOfManagement", 35, 4, <?php echo ($ivf_vitals_history->PPlanOfManagement->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->MPlanOfManagement->Visible) { // MPlanOfManagement ?>
	<div id="r_MPlanOfManagement" class="form-group row">
		<label id="elh_ivf_vitals_history_MPlanOfManagement" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MPlanOfManagement" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MPlanOfManagement->caption() ?><?php echo ($ivf_vitals_history->MPlanOfManagement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MPlanOfManagement->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MPlanOfManagement" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_MPlanOfManagement", 35, 4, <?php echo ($ivf_vitals_history->MPlanOfManagement->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->PReadMore->Visible) { // PReadMore ?>
	<div id="r_PReadMore" class="form-group row">
		<label id="elh_ivf_vitals_history_PReadMore" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_PReadMore" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->PReadMore->caption() ?><?php echo ($ivf_vitals_history->PReadMore->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->PReadMore->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_PReadMore" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_PReadMore", 35, 4, <?php echo ($ivf_vitals_history->PReadMore->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->MReadMore->Visible) { // MReadMore ?>
	<div id="r_MReadMore" class="form-group row">
		<label id="elh_ivf_vitals_history_MReadMore" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MReadMore" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MReadMore->caption() ?><?php echo ($ivf_vitals_history->MReadMore->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MReadMore->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MReadMore" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_MReadMore", 35, 4, <?php echo ($ivf_vitals_history->MReadMore->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->MariedFor->Visible) { // MariedFor ?>
	<div id="r_MariedFor" class="form-group row">
		<label id="elh_ivf_vitals_history_MariedFor" for="x_MariedFor" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MariedFor" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MariedFor->caption() ?><?php echo ($ivf_vitals_history->MariedFor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MariedFor->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MariedFor" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->CMNCM->Visible) { // CMNCM ?>
	<div id="r_CMNCM" class="form-group row">
		<label id="elh_ivf_vitals_history_CMNCM" for="x_CMNCM" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_CMNCM" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->CMNCM->caption() ?><?php echo ($ivf_vitals_history->CMNCM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->CMNCM->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_CMNCM" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateMenstrualHistory->Visible) { // TemplateMenstrualHistory ?>
	<div id="r_TemplateMenstrualHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateMenstrualHistory" for="x_TemplateMenstrualHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateMenstrualHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateMenstrualHistory->caption() ?><?php echo ($ivf_vitals_history->TemplateMenstrualHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateMenstrualHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateMenstrualHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateObstetricHistory->Visible) { // TemplateObstetricHistory ?>
	<div id="r_TemplateObstetricHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateObstetricHistory" for="x_TemplateObstetricHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateObstetricHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateObstetricHistory->caption() ?><?php echo ($ivf_vitals_history->TemplateObstetricHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateObstetricHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateObstetricHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateFertilityTreatmentHistory->Visible) { // TemplateFertilityTreatmentHistory ?>
	<div id="r_TemplateFertilityTreatmentHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateFertilityTreatmentHistory" for="x_TemplateFertilityTreatmentHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateFertilityTreatmentHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateFertilityTreatmentHistory->caption() ?><?php echo ($ivf_vitals_history->TemplateFertilityTreatmentHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateFertilityTreatmentHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateFertilityTreatmentHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateSurgeryHistory->Visible) { // TemplateSurgeryHistory ?>
	<div id="r_TemplateSurgeryHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateSurgeryHistory" for="x_TemplateSurgeryHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateSurgeryHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateSurgeryHistory->caption() ?><?php echo ($ivf_vitals_history->TemplateSurgeryHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateSurgeryHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateSurgeryHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateFInvestigations->Visible) { // TemplateFInvestigations ?>
	<div id="r_TemplateFInvestigations" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateFInvestigations" for="x_TemplateFInvestigations" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateFInvestigations" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateFInvestigations->caption() ?><?php echo ($ivf_vitals_history->TemplateFInvestigations->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateFInvestigations->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateFInvestigations" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplatePlanOfManagement->Visible) { // TemplatePlanOfManagement ?>
	<div id="r_TemplatePlanOfManagement" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplatePlanOfManagement" for="x_TemplatePlanOfManagement" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplatePlanOfManagement" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplatePlanOfManagement->caption() ?><?php echo ($ivf_vitals_history->TemplatePlanOfManagement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplatePlanOfManagement->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplatePlanOfManagement" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplatePImpression->Visible) { // TemplatePImpression ?>
	<div id="r_TemplatePImpression" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplatePImpression" for="x_TemplatePImpression" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplatePImpression" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplatePImpression->caption() ?><?php echo ($ivf_vitals_history->TemplatePImpression->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplatePImpression->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplatePImpression" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateMedications->Visible) { // TemplateMedications ?>
	<div id="r_TemplateMedications" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateMedications" for="x_TemplateMedications" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateMedications" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateMedications->caption() ?><?php echo ($ivf_vitals_history->TemplateMedications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateMedications->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateMedications" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateSemenAnalysis->Visible) { // TemplateSemenAnalysis ?>
	<div id="r_TemplateSemenAnalysis" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateSemenAnalysis" for="x_TemplateSemenAnalysis" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateSemenAnalysis" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateSemenAnalysis->caption() ?><?php echo ($ivf_vitals_history->TemplateSemenAnalysis->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateSemenAnalysis->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateSemenAnalysis" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->MaleInsvestications->Visible) { // MaleInsvestications ?>
	<div id="r_MaleInsvestications" class="form-group row">
		<label id="elh_ivf_vitals_history_MaleInsvestications" for="x_MaleInsvestications" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_MaleInsvestications" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->MaleInsvestications->caption() ?><?php echo ($ivf_vitals_history->MaleInsvestications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->MaleInsvestications->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_MaleInsvestications" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateMIMpression->Visible) { // TemplateMIMpression ?>
	<div id="r_TemplateMIMpression" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateMIMpression" for="x_TemplateMIMpression" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateMIMpression" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateMIMpression->caption() ?><?php echo ($ivf_vitals_history->TemplateMIMpression->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateMIMpression->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateMIMpression" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TemplateMalePlanOfManagement->Visible) { // TemplateMalePlanOfManagement ?>
	<div id="r_TemplateMalePlanOfManagement" class="form-group row">
		<label id="elh_ivf_vitals_history_TemplateMalePlanOfManagement" for="x_TemplateMalePlanOfManagement" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TemplateMalePlanOfManagement" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TemplateMalePlanOfManagement->caption() ?><?php echo ($ivf_vitals_history->TemplateMalePlanOfManagement->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TemplateMalePlanOfManagement->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TemplateMalePlanOfManagement" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->TidNo->Visible) { // TidNo ?>
	<div id="r_TidNo" class="form-group row">
		<label id="elh_ivf_vitals_history_TidNo" for="x_TidNo" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_TidNo" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->TidNo->caption() ?><?php echo ($ivf_vitals_history->TidNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->TidNo->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_TidNo" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->pFamilyHistory->Visible) { // pFamilyHistory ?>
	<div id="r_pFamilyHistory" class="form-group row">
		<label id="elh_ivf_vitals_history_pFamilyHistory" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_pFamilyHistory" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->pFamilyHistory->caption() ?><?php echo ($ivf_vitals_history->pFamilyHistory->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->pFamilyHistory->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_pFamilyHistory" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->pTemplateMedications->Visible) { // pTemplateMedications ?>
	<div id="r_pTemplateMedications" class="form-group row">
		<label id="elh_ivf_vitals_history_pTemplateMedications" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_pTemplateMedications" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->pTemplateMedications->caption() ?><?php echo ($ivf_vitals_history->pTemplateMedications->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->pTemplateMedications->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_pTemplateMedications" class="ivf_vitals_historyedit" type="text/html">
...
<script type="text/html" class="ivf_vitals_historyedit_js">
ew.createEditor("fivf_vitals_historyedit", "x_pTemplateMedications", 35, 4, <?php echo ($ivf_vitals_history->pTemplateMedications->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<?php if ($ivf_vitals_history->AntiTPO->Visible) { // AntiTPO ?>
	<div id="r_AntiTPO" class="form-group row">
		<label id="elh_ivf_vitals_history_AntiTPO" for="x_AntiTPO" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_AntiTPO" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->AntiTPO->caption() ?><?php echo ($ivf_vitals_history->AntiTPO->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->AntiTPO->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_AntiTPO" class="ivf_vitals_historyedit" type="text/html">
...
<?php if ($ivf_vitals_history->AntiTG->Visible) { // AntiTG ?>
	<div id="r_AntiTG" class="form-group row">
		<label id="elh_ivf_vitals_history_AntiTG" for="x_AntiTG" class="<?php echo $ivf_vitals_history_edit->LeftColumnClass ?>"><script id="tpc_ivf_vitals_history_AntiTG" class="ivf_vitals_historyedit" type="text/html"><span><?php echo $ivf_vitals_history->AntiTG->caption() ?><?php echo ($ivf_vitals_history->AntiTG->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $ivf_vitals_history_edit->RightColumnClass ?>"><div<?php echo $ivf_vitals_history->AntiTG->cellAttributes() ?>>
<script id="tpx_ivf_vitals_history_AntiTG" class="ivf_vitals_historyedit" type="text/html">
...
ew.applyTemplate("tpd_ivf_vitals_historyedit", "tpm_ivf_vitals_historyedit", "ivf_vitals_historyedit", "<?php echo $ivf_vitals_history->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.ivf_vitals_historyedit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
