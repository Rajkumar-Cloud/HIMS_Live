...
var fpatient_telephoneedit = currentForm = new ew.Form("fpatient_telephoneedit", "edit");
...
fpatient_telephoneedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fpatient_telephoneedit.lists["x_tele_type"] = <?php echo $patient_telephone_edit->tele_type->Lookup->toClientList() ?>;
fpatient_telephoneedit.lists["x_tele_type"].options = <?php echo JsonEncode($patient_telephone_edit->tele_type->lookupOptions()) ?>;
fpatient_telephoneedit.lists["x_telephone_type"] = <?php echo $patient_telephone_edit->telephone_type->Lookup->toClientList() ?>;
...
fpatient_telephoneedit.lists["x_status"] = <?php echo $patient_telephone_edit->status->Lookup->toClientList() ?>;
...
<?php if ($patient_telephone_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $patient_telephone_edit->Token ?>">
<?php } ?>
...
<?php if ($patient_telephone->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_patient_telephone_id" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->id->caption() ?><?php echo ($patient_telephone->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_telephone" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($patient_telephone->id->CurrentValue) ?>">
<?php echo $patient_telephone->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($patient_telephone->patient_id->Visible) { // patient_id ?>
	<div id="r_patient_id" class="form-group row">
		<label id="elh_patient_telephone_patient_id" for="x_patient_id" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->patient_id->caption() ?><?php echo ($patient_telephone->patient_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->patient_id->cellAttributes() ?>>
...
<input type="hidden" data-table="patient_telephone" data-field="x_patient_id" name="x_patient_id" id="x_patient_id" value="<?php echo HtmlEncode($patient_telephone->patient_id->CurrentValue) ?>">
...
<?php if ($patient_telephone->tele_type->Visible) { // tele_type ?>
	<div id="r_tele_type" class="form-group row">
		<label id="elh_patient_telephone_tele_type" for="x_tele_type" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->tele_type->caption() ?><?php echo ($patient_telephone->tele_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->tele_type->cellAttributes() ?>>
...
<?php if ($patient_telephone->telephone->Visible) { // telephone ?>
	<div id="r_telephone" class="form-group row">
		<label id="elh_patient_telephone_telephone" for="x_telephone" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->telephone->caption() ?><?php echo ($patient_telephone->telephone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->telephone->cellAttributes() ?>>
...
<?php if ($patient_telephone->telephone_type->Visible) { // telephone_type ?>
	<div id="r_telephone_type" class="form-group row">
		<label id="elh_patient_telephone_telephone_type" for="x_telephone_type" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->telephone_type->caption() ?><?php echo ($patient_telephone->telephone_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->telephone_type->cellAttributes() ?>>
...
<?php if ($patient_telephone->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh_patient_telephone_status" for="x_status" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->status->caption() ?><?php echo ($patient_telephone->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->status->cellAttributes() ?>>
...
<?php if ($patient_telephone->createdby->Visible) { // createdby ?>
	<div id="r_createdby" class="form-group row">
		<label id="elh_patient_telephone_createdby" for="x_createdby" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->createdby->caption() ?><?php echo ($patient_telephone->createdby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->createdby->cellAttributes() ?>>
...
<?php if ($patient_telephone->createddatetime->Visible) { // createddatetime ?>
	<div id="r_createddatetime" class="form-group row">
		<label id="elh_patient_telephone_createddatetime" for="x_createddatetime" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->createddatetime->caption() ?><?php echo ($patient_telephone->createddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->createddatetime->cellAttributes() ?>>
...
<?php if ($patient_telephone->modifiedby->Visible) { // modifiedby ?>
	<div id="r_modifiedby" class="form-group row">
		<label id="elh_patient_telephone_modifiedby" for="x_modifiedby" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->modifiedby->caption() ?><?php echo ($patient_telephone->modifiedby->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->modifiedby->cellAttributes() ?>>
...
<?php if ($patient_telephone->modifieddatetime->Visible) { // modifieddatetime ?>
	<div id="r_modifieddatetime" class="form-group row">
		<label id="elh_patient_telephone_modifieddatetime" for="x_modifieddatetime" class="<?php echo $patient_telephone_edit->LeftColumnClass ?>"><?php echo $patient_telephone->modifieddatetime->caption() ?><?php echo ($patient_telephone->modifieddatetime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $patient_telephone_edit->RightColumnClass ?>"><div<?php echo $patient_telephone->modifieddatetime->cellAttributes() ?>>
