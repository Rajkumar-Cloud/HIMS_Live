...
// Create page object
$view_store_transfer_add = new view_store_transfer_add();

// Run the page
$view_store_transfer_add->run();
...
$view_store_transfer_add->Page_Render();
?>
...
var fview_store_transferadd = currentForm = new ew.Form("fview_store_transferadd", "add");

// Validate form
fview_store_transferadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($view_store_transfer_add->ORDNO->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->PRC->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->QTY->Required) { ?>
		...
		<?php if ($view_store_transfer_add->DT->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PC->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->YM->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->MFRCODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->Stock->Required) { ?>
		...
		<?php if ($view_store_transfer_add->LastMonthSale->Required) { ?>
		...
		<?php if ($view_store_transfer_add->Printcheck->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->poid->Required) { ?>
		...
		<?php if ($view_store_transfer_add->grnid->Required) { ?>
		...
		<?php if ($view_store_transfer_add->BatchNo->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->ExpDate->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PrName->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->Quantity->Required) { ?>
		...
		<?php if ($view_store_transfer_add->FreeQty->Required) { ?>
		...
		<?php if ($view_store_transfer_add->ItemValue->Required) { ?>
		...
		<?php if ($view_store_transfer_add->Disc->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PTax->Required) { ?>
		...
		<?php if ($view_store_transfer_add->MRP->Required) { ?>
		...
		<?php if ($view_store_transfer_add->SalTax->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PurValue->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PurRate->Required) { ?>
		...
		<?php if ($view_store_transfer_add->SalRate->Required) { ?>
		...
		<?php if ($view_store_transfer_add->Discount->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PSGST->Required) { ?>
		...
		<?php if ($view_store_transfer_add->PCGST->Required) { ?>
		...
		<?php if ($view_store_transfer_add->SSGST->Required) { ?>
		...
		<?php if ($view_store_transfer_add->SCGST->Required) { ?>
		...
		<?php if ($view_store_transfer_add->BRCODE->Required) { ?>
		...
		<?php if ($view_store_transfer_add->HSN->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->Pack->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->PUnit->Required) { ?>
		...
		<?php if ($view_store_transfer_add->SUnit->Required) { ?>
		...
		<?php if ($view_store_transfer_add->GrnQuantity->Required) { ?>
		...
		<?php if ($view_store_transfer_add->GrnMRP->Required) { ?>
		...
		<?php if ($view_store_transfer_add->strid->Required) { ?>
		...
		<?php if ($view_store_transfer_add->HospID->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->CreatedBy->Required) { ?>
		...
		<?php if ($view_store_transfer_add->CreatedDateTime->Required) { ?>
		...
		<?php if ($view_store_transfer_add->ModifiedBy->Required) { ?>
		...
		<?php if ($view_store_transfer_add->ModifiedDateTime->Required) { ?>
		...
		<?php if ($view_store_transfer_add->grncreatedby->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->grncreatedDateTime->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->grnModifiedby->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->grnModifiedDateTime->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->Received->Required) { ?>
		...
		<?php } ?>
		<?php if ($view_store_transfer_add->BillDate->Required) { ?>
		...
		<?php if ($view_store_transfer_add->CurStock->Required) { ?>
...
fview_store_transferadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fview_store_transferadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fview_store_transferadd.lists["x_ORDNO"] = <?php echo $view_store_transfer_add->ORDNO->Lookup->toClientList() ?>;
fview_store_transferadd.lists["x_ORDNO"].options = <?php echo JsonEncode($view_store_transfer_add->ORDNO->lookupOptions()) ?>;
fview_store_transferadd.autoSuggests["x_ORDNO"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fview_store_transferadd.lists["x_LastMonthSale"] = <?php echo $view_store_transfer_add->LastMonthSale->Lookup->toClientList() ?>;
fview_store_transferadd.lists["x_LastMonthSale"].options = <?php echo JsonEncode($view_store_transfer_add->LastMonthSale->lookupOptions()) ?>;
fview_store_transferadd.autoSuggests["x_LastMonthSale"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
fview_store_transferadd.lists["x_BRCODE"] = <?php echo $view_store_transfer_add->BRCODE->Lookup->toClientList() ?>;
fview_store_transferadd.lists["x_BRCODE"].options = <?php echo JsonEncode($view_store_transfer_add->BRCODE->lookupOptions()) ?>;
fview_store_transferadd.autoSuggests["x_BRCODE"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $view_store_transfer_add->showPageHeader(); ?>
<?php
$view_store_transfer_add->showMessage();
?>
<form name="fview_store_transferadd" id="fview_store_transferadd" class="<?php echo $view_store_transfer_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($view_store_transfer_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $view_store_transfer_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="view_store_transfer">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$view_store_transfer_add->IsModal ?>">
...
<?php if ($view_store_transfer->PRC->Visible) { // PRC ?>
	<div id="r_PRC" class="form-group row">
		<label id="elh_view_store_transfer_PRC" for="x_PRC" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PRC->caption() ?><?php echo ($view_store_transfer->PRC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PRC->cellAttributes() ?>>
...
<?php if ($view_store_transfer->QTY->Visible) { // QTY ?>
	<div id="r_QTY" class="form-group row">
		<label id="elh_view_store_transfer_QTY" for="x_QTY" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->QTY->caption() ?><?php echo ($view_store_transfer->QTY->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->QTY->cellAttributes() ?>>
...
<?php if ($view_store_transfer->DT->Visible) { // DT ?>
	<div id="r_DT" class="form-group row">
		<label id="elh_view_store_transfer_DT" for="x_DT" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->DT->caption() ?><?php echo ($view_store_transfer->DT->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->DT->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fview_store_transferadd", "x_DT", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($view_store_transfer->PC->Visible) { // PC ?>
	<div id="r_PC" class="form-group row">
		<label id="elh_view_store_transfer_PC" for="x_PC" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PC->caption() ?><?php echo ($view_store_transfer->PC->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PC->cellAttributes() ?>>
...
<?php if ($view_store_transfer->YM->Visible) { // YM ?>
	<div id="r_YM" class="form-group row">
		<label id="elh_view_store_transfer_YM" for="x_YM" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->YM->caption() ?><?php echo ($view_store_transfer->YM->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->YM->cellAttributes() ?>>
...
<?php if ($view_store_transfer->MFRCODE->Visible) { // MFRCODE ?>
	<div id="r_MFRCODE" class="form-group row">
		<label id="elh_view_store_transfer_MFRCODE" for="x_MFRCODE" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->MFRCODE->caption() ?><?php echo ($view_store_transfer->MFRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->MFRCODE->cellAttributes() ?>>
...
<?php if ($view_store_transfer->Stock->Visible) { // Stock ?>
	<div id="r_Stock" class="form-group row">
		<label id="elh_view_store_transfer_Stock" for="x_Stock" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Stock->caption() ?><?php echo ($view_store_transfer->Stock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Stock->cellAttributes() ?>>
...
<?php if ($view_store_transfer->LastMonthSale->Visible) { // LastMonthSale ?>
	<div id="r_LastMonthSale" class="form-group row">
		<label id="elh_view_store_transfer_LastMonthSale" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->LastMonthSale->caption() ?><?php echo ($view_store_transfer->LastMonthSale->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->LastMonthSale->cellAttributes() ?>>
...
<script>
fview_store_transferadd.createAutoSuggest({"id":"x_LastMonthSale","forceSelect":true});
</script>
...
<?php if ($view_store_transfer->Printcheck->Visible) { // Printcheck ?>
	<div id="r_Printcheck" class="form-group row">
		<label id="elh_view_store_transfer_Printcheck" for="x_Printcheck" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Printcheck->caption() ?><?php echo ($view_store_transfer->Printcheck->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Printcheck->cellAttributes() ?>>
...
<?php if ($view_store_transfer->poid->Visible) { // poid ?>
	<div id="r_poid" class="form-group row">
		<label id="elh_view_store_transfer_poid" for="x_poid" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->poid->caption() ?><?php echo ($view_store_transfer->poid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->poid->cellAttributes() ?>>
...
<?php if ($view_store_transfer->grnid->Visible) { // grnid ?>
	<div id="r_grnid" class="form-group row">
		<label id="elh_view_store_transfer_grnid" for="x_grnid" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->grnid->caption() ?><?php echo ($view_store_transfer->grnid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->grnid->cellAttributes() ?>>
...
<?php if ($view_store_transfer->BatchNo->Visible) { // BatchNo ?>
	<div id="r_BatchNo" class="form-group row">
		<label id="elh_view_store_transfer_BatchNo" for="x_BatchNo" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->BatchNo->caption() ?><?php echo ($view_store_transfer->BatchNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->BatchNo->cellAttributes() ?>>
...
<?php if ($view_store_transfer->ExpDate->Visible) { // ExpDate ?>
	<div id="r_ExpDate" class="form-group row">
		<label id="elh_view_store_transfer_ExpDate" for="x_ExpDate" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->ExpDate->caption() ?><?php echo ($view_store_transfer->ExpDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->ExpDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fview_store_transferadd", "x_ExpDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($view_store_transfer->PrName->Visible) { // PrName ?>
	<div id="r_PrName" class="form-group row">
		<label id="elh_view_store_transfer_PrName" for="x_PrName" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PrName->caption() ?><?php echo ($view_store_transfer->PrName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PrName->cellAttributes() ?>>
...
<?php if ($view_store_transfer->Quantity->Visible) { // Quantity ?>
	<div id="r_Quantity" class="form-group row">
		<label id="elh_view_store_transfer_Quantity" for="x_Quantity" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Quantity->caption() ?><?php echo ($view_store_transfer->Quantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Quantity->cellAttributes() ?>>
...
<?php if ($view_store_transfer->FreeQty->Visible) { // FreeQty ?>
	<div id="r_FreeQty" class="form-group row">
		<label id="elh_view_store_transfer_FreeQty" for="x_FreeQty" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->FreeQty->caption() ?><?php echo ($view_store_transfer->FreeQty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->FreeQty->cellAttributes() ?>>
...
<?php if ($view_store_transfer->ItemValue->Visible) { // ItemValue ?>
	<div id="r_ItemValue" class="form-group row">
		<label id="elh_view_store_transfer_ItemValue" for="x_ItemValue" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->ItemValue->caption() ?><?php echo ($view_store_transfer->ItemValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->ItemValue->cellAttributes() ?>>
...
<?php if ($view_store_transfer->Disc->Visible) { // Disc ?>
	<div id="r_Disc" class="form-group row">
		<label id="elh_view_store_transfer_Disc" for="x_Disc" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Disc->caption() ?><?php echo ($view_store_transfer->Disc->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Disc->cellAttributes() ?>>
...
<?php if ($view_store_transfer->PTax->Visible) { // PTax ?>
	<div id="r_PTax" class="form-group row">
		<label id="elh_view_store_transfer_PTax" for="x_PTax" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PTax->caption() ?><?php echo ($view_store_transfer->PTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PTax->cellAttributes() ?>>
...
<?php if ($view_store_transfer->MRP->Visible) { // MRP ?>
	<div id="r_MRP" class="form-group row">
		<label id="elh_view_store_transfer_MRP" for="x_MRP" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->MRP->caption() ?><?php echo ($view_store_transfer->MRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->MRP->cellAttributes() ?>>
...
<?php if ($view_store_transfer->SalTax->Visible) { // SalTax ?>
	<div id="r_SalTax" class="form-group row">
		<label id="elh_view_store_transfer_SalTax" for="x_SalTax" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->SalTax->caption() ?><?php echo ($view_store_transfer->SalTax->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->SalTax->cellAttributes() ?>>
...
<?php if ($view_store_transfer->PurValue->Visible) { // PurValue ?>
	<div id="r_PurValue" class="form-group row">
		<label id="elh_view_store_transfer_PurValue" for="x_PurValue" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PurValue->caption() ?><?php echo ($view_store_transfer->PurValue->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PurValue->cellAttributes() ?>>
...
<?php if ($view_store_transfer->PurRate->Visible) { // PurRate ?>
	<div id="r_PurRate" class="form-group row">
		<label id="elh_view_store_transfer_PurRate" for="x_PurRate" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PurRate->caption() ?><?php echo ($view_store_transfer->PurRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PurRate->cellAttributes() ?>>
...
<?php if ($view_store_transfer->SalRate->Visible) { // SalRate ?>
	<div id="r_SalRate" class="form-group row">
		<label id="elh_view_store_transfer_SalRate" for="x_SalRate" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->SalRate->caption() ?><?php echo ($view_store_transfer->SalRate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->SalRate->cellAttributes() ?>>
...
<?php if ($view_store_transfer->Discount->Visible) { // Discount ?>
	<div id="r_Discount" class="form-group row">
		<label id="elh_view_store_transfer_Discount" for="x_Discount" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Discount->caption() ?><?php echo ($view_store_transfer->Discount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Discount->cellAttributes() ?>>
...
<?php if ($view_store_transfer->PSGST->Visible) { // PSGST ?>
	<div id="r_PSGST" class="form-group row">
		<label id="elh_view_store_transfer_PSGST" for="x_PSGST" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PSGST->caption() ?><?php echo ($view_store_transfer->PSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PSGST->cellAttributes() ?>>
...
<?php if ($view_store_transfer->PCGST->Visible) { // PCGST ?>
	<div id="r_PCGST" class="form-group row">
		<label id="elh_view_store_transfer_PCGST" for="x_PCGST" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PCGST->caption() ?><?php echo ($view_store_transfer->PCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PCGST->cellAttributes() ?>>
...
<?php if ($view_store_transfer->SSGST->Visible) { // SSGST ?>
	<div id="r_SSGST" class="form-group row">
		<label id="elh_view_store_transfer_SSGST" for="x_SSGST" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->SSGST->caption() ?><?php echo ($view_store_transfer->SSGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->SSGST->cellAttributes() ?>>
...
<?php if ($view_store_transfer->SCGST->Visible) { // SCGST ?>
	<div id="r_SCGST" class="form-group row">
		<label id="elh_view_store_transfer_SCGST" for="x_SCGST" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->SCGST->caption() ?><?php echo ($view_store_transfer->SCGST->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->SCGST->cellAttributes() ?>>
...
<?php if ($view_store_transfer->BRCODE->Visible) { // BRCODE ?>
	<div id="r_BRCODE" class="form-group row">
		<label id="elh_view_store_transfer_BRCODE" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->BRCODE->caption() ?><?php echo ($view_store_transfer->BRCODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->BRCODE->cellAttributes() ?>>
...
<script>
fview_store_transferadd.createAutoSuggest({"id":"x_BRCODE","forceSelect":false});
</script>
...
<?php if ($view_store_transfer->HSN->Visible) { // HSN ?>
	<div id="r_HSN" class="form-group row">
		<label id="elh_view_store_transfer_HSN" for="x_HSN" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->HSN->caption() ?><?php echo ($view_store_transfer->HSN->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->HSN->cellAttributes() ?>>
...
<?php if ($view_store_transfer->Pack->Visible) { // Pack ?>
	<div id="r_Pack" class="form-group row">
		<label id="elh_view_store_transfer_Pack" for="x_Pack" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Pack->caption() ?><?php echo ($view_store_transfer->Pack->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Pack->cellAttributes() ?>>
...
<?php if ($view_store_transfer->PUnit->Visible) { // PUnit ?>
	<div id="r_PUnit" class="form-group row">
		<label id="elh_view_store_transfer_PUnit" for="x_PUnit" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->PUnit->caption() ?><?php echo ($view_store_transfer->PUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->PUnit->cellAttributes() ?>>
...
<?php if ($view_store_transfer->SUnit->Visible) { // SUnit ?>
	<div id="r_SUnit" class="form-group row">
		<label id="elh_view_store_transfer_SUnit" for="x_SUnit" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->SUnit->caption() ?><?php echo ($view_store_transfer->SUnit->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->SUnit->cellAttributes() ?>>
...
<?php if ($view_store_transfer->GrnQuantity->Visible) { // GrnQuantity ?>
	<div id="r_GrnQuantity" class="form-group row">
		<label id="elh_view_store_transfer_GrnQuantity" for="x_GrnQuantity" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->GrnQuantity->caption() ?><?php echo ($view_store_transfer->GrnQuantity->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->GrnQuantity->cellAttributes() ?>>
...
<?php if ($view_store_transfer->GrnMRP->Visible) { // GrnMRP ?>
	<div id="r_GrnMRP" class="form-group row">
		<label id="elh_view_store_transfer_GrnMRP" for="x_GrnMRP" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->GrnMRP->caption() ?><?php echo ($view_store_transfer->GrnMRP->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->GrnMRP->cellAttributes() ?>>
...
<?php if ($view_store_transfer->strid->Visible) { // strid ?>
	<div id="r_strid" class="form-group row">
		<label id="elh_view_store_transfer_strid" for="x_strid" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->strid->caption() ?><?php echo ($view_store_transfer->strid->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->strid->cellAttributes() ?>>
...
<?php if ($view_store_transfer->CreatedBy->Visible) { // CreatedBy ?>
	<div id="r_CreatedBy" class="form-group row">
		<label id="elh_view_store_transfer_CreatedBy" for="x_CreatedBy" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->CreatedBy->caption() ?><?php echo ($view_store_transfer->CreatedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->CreatedBy->cellAttributes() ?>>
...
<?php if ($view_store_transfer->CreatedDateTime->Visible) { // CreatedDateTime ?>
	<div id="r_CreatedDateTime" class="form-group row">
		<label id="elh_view_store_transfer_CreatedDateTime" for="x_CreatedDateTime" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->CreatedDateTime->caption() ?><?php echo ($view_store_transfer->CreatedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->CreatedDateTime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fview_store_transferadd", "x_CreatedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($view_store_transfer->ModifiedBy->Visible) { // ModifiedBy ?>
	<div id="r_ModifiedBy" class="form-group row">
		<label id="elh_view_store_transfer_ModifiedBy" for="x_ModifiedBy" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->ModifiedBy->caption() ?><?php echo ($view_store_transfer->ModifiedBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->ModifiedBy->cellAttributes() ?>>
...
<?php if ($view_store_transfer->ModifiedDateTime->Visible) { // ModifiedDateTime ?>
	<div id="r_ModifiedDateTime" class="form-group row">
		<label id="elh_view_store_transfer_ModifiedDateTime" for="x_ModifiedDateTime" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->ModifiedDateTime->caption() ?><?php echo ($view_store_transfer->ModifiedDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->ModifiedDateTime->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fview_store_transferadd", "x_ModifiedDateTime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($view_store_transfer->Received->Visible) { // Received ?>
	<div id="r_Received" class="form-group row">
		<label id="elh_view_store_transfer_Received" for="x_Received" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->Received->caption() ?><?php echo ($view_store_transfer->Received->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->Received->cellAttributes() ?>>
...
<?php if ($view_store_transfer->BillDate->Visible) { // BillDate ?>
	<div id="r_BillDate" class="form-group row">
		<label id="elh_view_store_transfer_BillDate" for="x_BillDate" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->BillDate->caption() ?><?php echo ($view_store_transfer->BillDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->BillDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fview_store_transferadd", "x_BillDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($view_store_transfer->CurStock->Visible) { // CurStock ?>
	<div id="r_CurStock" class="form-group row">
		<label id="elh_view_store_transfer_CurStock" for="x_CurStock" class="<?php echo $view_store_transfer_add->LeftColumnClass ?>"><?php echo $view_store_transfer->CurStock->caption() ?><?php echo ($view_store_transfer->CurStock->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $view_store_transfer_add->RightColumnClass ?>"><div<?php echo $view_store_transfer->CurStock->cellAttributes() ?>>
...
<?php if (!$view_store_transfer_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $view_store_transfer_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $view_store_transfer_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$view_store_transfer_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$view_store_transfer_add->terminate();
?>