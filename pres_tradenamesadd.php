...
var fpres_tradenamesadd = currentForm = new ew.Form("fpres_tradenamesadd", "add");
...
fpres_tradenamesadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($pres_tradenames_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pres_tradenames_add->Token ?>">
<?php } ?>
...
<?php if ($pres_tradenames->GENERIC_NAMES->Visible) { // GENERIC_NAMES ?>
	<div id="r_GENERIC_NAMES" class="form-group row">
		<label id="elh_pres_tradenames_GENERIC_NAMES" for="x_GENERIC_NAMES" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->GENERIC_NAMES->caption() ?><?php echo ($pres_tradenames->GENERIC_NAMES->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->GENERIC_NAMES->cellAttributes() ?>>
...
<?php if ($pres_tradenames->TRADE_NAME->Visible) { // TRADE_NAME ?>
	<div id="r_TRADE_NAME" class="form-group row">
		<label id="elh_pres_tradenames_TRADE_NAME" for="x_TRADE_NAME" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->TRADE_NAME->caption() ?><?php echo ($pres_tradenames->TRADE_NAME->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->TRADE_NAME->cellAttributes() ?>>
...
<?php if ($pres_tradenames->Drug_Name->Visible) { // Drug_Name ?>
	<div id="r_Drug_Name" class="form-group row">
		<label id="elh_pres_tradenames_Drug_Name" for="x_Drug_Name" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->Drug_Name->caption() ?><?php echo ($pres_tradenames->Drug_Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->Drug_Name->cellAttributes() ?>>
...
<?php if ($pres_tradenames->PR_CODE->Visible) { // PR_CODE ?>
	<div id="r_PR_CODE" class="form-group row">
		<label id="elh_pres_tradenames_PR_CODE" for="x_PR_CODE" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->PR_CODE->caption() ?><?php echo ($pres_tradenames->PR_CODE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->PR_CODE->cellAttributes() ?>>
...
<?php if ($pres_tradenames->GenericNames_symbols->Visible) { // GenericNames_symbols ?>
	<div id="r_GenericNames_symbols" class="form-group row">
		<label id="elh_pres_tradenames_GenericNames_symbols" for="x_GenericNames_symbols" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->GenericNames_symbols->caption() ?><?php echo ($pres_tradenames->GenericNames_symbols->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->GenericNames_symbols->cellAttributes() ?>>
...
<?php if ($pres_tradenames->CONTAINER_TYPE->Visible) { // CONTAINER_TYPE ?>
	<div id="r_CONTAINER_TYPE" class="form-group row">
		<label id="elh_pres_tradenames_CONTAINER_TYPE" for="x_CONTAINER_TYPE" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->CONTAINER_TYPE->caption() ?><?php echo ($pres_tradenames->CONTAINER_TYPE->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->CONTAINER_TYPE->cellAttributes() ?>>
...
<?php if ($pres_tradenames->STRENGTH->Visible) { // STRENGTH ?>
	<div id="r_STRENGTH" class="form-group row">
		<label id="elh_pres_tradenames_STRENGTH" for="x_STRENGTH" class="<?php echo $pres_tradenames_add->LeftColumnClass ?>"><?php echo $pres_tradenames->STRENGTH->caption() ?><?php echo ($pres_tradenames->STRENGTH->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pres_tradenames_add->RightColumnClass ?>"><div<?php echo $pres_tradenames->STRENGTH->cellAttributes() ?>>
