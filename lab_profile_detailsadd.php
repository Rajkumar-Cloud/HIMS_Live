...
var flab_profile_detailsadd = currentForm = new ew.Form("flab_profile_detailsadd", "add");
...
flab_profile_detailsadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flab_profile_detailsadd.lists["x_SubProfileCode"] = <?php echo $lab_profile_details_add->SubProfileCode->Lookup->toClientList() ?>;
...
flab_profile_detailsadd.lists["x_ProfileTestCode"] = <?php echo $lab_profile_details_add->ProfileTestCode->Lookup->toClientList() ?>;
...
<?php if ($lab_profile_details_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $lab_profile_details_add->Token ?>">
<?php } ?>
...
<?php if ($lab_profile_details->ProfileCode->Visible) { // ProfileCode ?>
	<div id="r_ProfileCode" class="form-group row">
		<label id="elh_lab_profile_details_ProfileCode" for="x_ProfileCode" class="<?php echo $lab_profile_details_add->LeftColumnClass ?>"><?php echo $lab_profile_details->ProfileCode->caption() ?><?php echo ($lab_profile_details->ProfileCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_details_add->RightColumnClass ?>"><div<?php echo $lab_profile_details->ProfileCode->cellAttributes() ?>>
...
<?php if ($lab_profile_details->SubProfileCode->Visible) { // SubProfileCode ?>
	<div id="r_SubProfileCode" class="form-group row">
		<label id="elh_lab_profile_details_SubProfileCode" for="x_SubProfileCode" class="<?php echo $lab_profile_details_add->LeftColumnClass ?>"><?php echo $lab_profile_details->SubProfileCode->caption() ?><?php echo ($lab_profile_details->SubProfileCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_details_add->RightColumnClass ?>"><div<?php echo $lab_profile_details->SubProfileCode->cellAttributes() ?>>
...
<?php if ($lab_profile_details->ProfileTestCode->Visible) { // ProfileTestCode ?>
	<div id="r_ProfileTestCode" class="form-group row">
		<label id="elh_lab_profile_details_ProfileTestCode" for="x_ProfileTestCode" class="<?php echo $lab_profile_details_add->LeftColumnClass ?>"><?php echo $lab_profile_details->ProfileTestCode->caption() ?><?php echo ($lab_profile_details->ProfileTestCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_details_add->RightColumnClass ?>"><div<?php echo $lab_profile_details->ProfileTestCode->cellAttributes() ?>>
...
<?php if ($lab_profile_details->ProfileSubTestCode->Visible) { // ProfileSubTestCode ?>
	<div id="r_ProfileSubTestCode" class="form-group row">
		<label id="elh_lab_profile_details_ProfileSubTestCode" for="x_ProfileSubTestCode" class="<?php echo $lab_profile_details_add->LeftColumnClass ?>"><?php echo $lab_profile_details->ProfileSubTestCode->caption() ?><?php echo ($lab_profile_details->ProfileSubTestCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_details_add->RightColumnClass ?>"><div<?php echo $lab_profile_details->ProfileSubTestCode->cellAttributes() ?>>
...
<?php if ($lab_profile_details->TestOrder->Visible) { // TestOrder ?>
	<div id="r_TestOrder" class="form-group row">
		<label id="elh_lab_profile_details_TestOrder" for="x_TestOrder" class="<?php echo $lab_profile_details_add->LeftColumnClass ?>"><?php echo $lab_profile_details->TestOrder->caption() ?><?php echo ($lab_profile_details->TestOrder->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_details_add->RightColumnClass ?>"><div<?php echo $lab_profile_details->TestOrder->cellAttributes() ?>>
...
<?php if ($lab_profile_details->TestAmount->Visible) { // TestAmount ?>
	<div id="r_TestAmount" class="form-group row">
		<label id="elh_lab_profile_details_TestAmount" for="x_TestAmount" class="<?php echo $lab_profile_details_add->LeftColumnClass ?>"><?php echo $lab_profile_details->TestAmount->caption() ?><?php echo ($lab_profile_details->TestAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $lab_profile_details_add->RightColumnClass ?>"><div<?php echo $lab_profile_details->TestAmount->cellAttributes() ?>>
