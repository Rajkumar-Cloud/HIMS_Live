...
var fmas_template_typedelete = currentForm = new ew.Form("fmas_template_typedelete", "delete");

// Form_CustomValidate event
fmas_template_typedelete.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fmas_template_typedelete.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($mas_template_type_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $mas_template_type_delete->Token ?>">
<?php } ?>
...
<?php if ($mas_template_type->id->Visible) { // id ?>
		<th class="<?php echo $mas_template_type->id->headerCellClass() ?>"><span id="elh_mas_template_type_id" class="mas_template_type_id"><?php echo $mas_template_type->id->caption() ?></span></th>
<?php } ?>
<?php if ($mas_template_type->TemplateName->Visible) { // TemplateName ?>
		<th class="<?php echo $mas_template_type->TemplateName->headerCellClass() ?>"><span id="elh_mas_template_type_TemplateName" class="mas_template_type_TemplateName"><?php echo $mas_template_type->TemplateName->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$mas_template_type_delete->RecCnt = 0;
$i = 0;
while (!$mas_template_type_delete->Recordset->EOF) {
	$mas_template_type_delete->RecCnt++;
	$mas_template_type_delete->RowCnt++;
...
<?php if ($mas_template_type->id->Visible) { // id ?>
		<td<?php echo $mas_template_type->id->cellAttributes() ?>>
<span id="el<?php echo $mas_template_type_delete->RowCnt ?>_mas_template_type_id" class="mas_template_type_id">
...
<?php } ?>
<?php if ($mas_template_type->TemplateName->Visible) { // TemplateName ?>
		<td<?php echo $mas_template_type->TemplateName->cellAttributes() ?>>
<span id="el<?php echo $mas_template_type_delete->RowCnt ?>_mas_template_type_TemplateName" class="mas_template_type_TemplateName">
