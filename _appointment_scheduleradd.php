...
// Create page object
$_appointment_scheduler_add = new _appointment_scheduler_add();

// Run the page
$_appointment_scheduler_add->run();
...
$_appointment_scheduler_add->Page_Render();
?>
...
var f_appointment_scheduleradd = currentForm = new ew.Form("f_appointment_scheduleradd", "add");

// Validate form
f_appointment_scheduleradd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($_appointment_scheduler_add->start_date->Required) { ?>
		...
		<?php if ($_appointment_scheduler_add->end_date->Required) { ?>
		...
		<?php if ($_appointment_scheduler_add->patientID->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->patientName->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->DoctorID->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->DoctorName->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->AppointmentStatus->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->status->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->DoctorCode->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Department->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->scheduler_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->text->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->appointment_status->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->PId->Required) { ?>
		...
		<?php if ($_appointment_scheduler_add->MobileNumber->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->SchEmail->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->appointment_type->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Notified->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Purpose->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Notes->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->PatientType->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Referal->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->paymentType->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->tittle->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->gendar->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Dob->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->Age->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->WhereDidYouHear->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->HospID->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->createdBy->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->createdDateTime->Required) { ?>
		...
		<?php } ?>
		<?php if ($_appointment_scheduler_add->PatientTypee->Required) { ?>
...
f_appointment_scheduleradd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
f_appointment_scheduleradd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
f_appointment_scheduleradd.lists["x_patientID"] = <?php echo $_appointment_scheduler_add->patientID->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_patientID"].options = <?php echo JsonEncode($_appointment_scheduler_add->patientID->lookupOptions()) ?>;
f_appointment_scheduleradd.lists["x_DoctorName"] = <?php echo $_appointment_scheduler_add->DoctorName->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_DoctorName"].options = <?php echo JsonEncode($_appointment_scheduler_add->DoctorName->lookupOptions()) ?>;
f_appointment_scheduleradd.lists["x_status[]"] = <?php echo $_appointment_scheduler_add->status->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_status[]"].options = <?php echo JsonEncode($_appointment_scheduler_add->status->options(FALSE, TRUE)) ?>;
f_appointment_scheduleradd.lists["x_appointment_type"] = <?php echo $_appointment_scheduler_add->appointment_type->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_appointment_type"].options = <?php echo JsonEncode($_appointment_scheduler_add->appointment_type->options(FALSE, TRUE)) ?>;
f_appointment_scheduleradd.lists["x_Notified[]"] = <?php echo $_appointment_scheduler_add->Notified->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_Notified[]"].options = <?php echo JsonEncode($_appointment_scheduler_add->Notified->options(FALSE, TRUE)) ?>;
f_appointment_scheduleradd.lists["x_PatientType"] = <?php echo $_appointment_scheduler_add->PatientType->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_PatientType"].options = <?php echo JsonEncode($_appointment_scheduler_add->PatientType->options(FALSE, TRUE)) ?>;
f_appointment_scheduleradd.lists["x_Referal"] = <?php echo $_appointment_scheduler_add->Referal->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_Referal"].options = <?php echo JsonEncode($_appointment_scheduler_add->Referal->lookupOptions()) ?>;
f_appointment_scheduleradd.lists["x_tittle"] = <?php echo $_appointment_scheduler_add->tittle->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_tittle"].options = <?php echo JsonEncode($_appointment_scheduler_add->tittle->lookupOptions()) ?>;
f_appointment_scheduleradd.lists["x_gendar"] = <?php echo $_appointment_scheduler_add->gendar->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_gendar"].options = <?php echo JsonEncode($_appointment_scheduler_add->gendar->lookupOptions()) ?>;
f_appointment_scheduleradd.lists["x_WhereDidYouHear[]"] = <?php echo $_appointment_scheduler_add->WhereDidYouHear->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_WhereDidYouHear[]"].options = <?php echo JsonEncode($_appointment_scheduler_add->WhereDidYouHear->lookupOptions()) ?>;
f_appointment_scheduleradd.lists["x_PatientTypee"] = <?php echo $_appointment_scheduler_add->PatientTypee->Lookup->toClientList() ?>;
f_appointment_scheduleradd.lists["x_PatientTypee"].options = <?php echo JsonEncode($_appointment_scheduler_add->PatientTypee->lookupOptions()) ?>;
...
<?php $_appointment_scheduler_add->showPageHeader(); ?>
<?php
$_appointment_scheduler_add->showMessage();
?>
<form name="f_appointment_scheduleradd" id="f_appointment_scheduleradd" class="<?php echo $_appointment_scheduler_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($_appointment_scheduler_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $_appointment_scheduler_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="_appointment_scheduler">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$_appointment_scheduler_add->IsModal ?>">
...
<?php if ($_appointment_scheduler->start_date->Visible) { // start_date ?>
	<div id="r_start_date" class="form-group row">
		<label id="elh__appointment_scheduler_start_date" for="x_start_date" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_start_date" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->start_date->caption() ?><?php echo ($_appointment_scheduler->start_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->start_date->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_start_date" class="_appointment_scheduleradd" type="text/html">
...
<script type="text/html" class="_appointment_scheduleradd_js">
ew.createDateTimePicker("f_appointment_scheduleradd", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":11});
</script>
...
<?php if ($_appointment_scheduler->end_date->Visible) { // end_date ?>
	<div id="r_end_date" class="form-group row">
		<label id="elh__appointment_scheduler_end_date" for="x_end_date" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_end_date" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->end_date->caption() ?><?php echo ($_appointment_scheduler->end_date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->end_date->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_end_date" class="_appointment_scheduleradd" type="text/html">
...
<script type="text/html" class="_appointment_scheduleradd_js">
ew.createDateTimePicker("f_appointment_scheduleradd", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":11});
</script>
...
<?php if ($_appointment_scheduler->patientID->Visible) { // patientID ?>
	<div id="r_patientID" class="form-group row">
		<label id="elh__appointment_scheduler_patientID" for="x_patientID" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_patientID" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->patientID->caption() ?><?php echo ($_appointment_scheduler->patientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->patientID->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_patientID" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->patientName->Visible) { // patientName ?>
	<div id="r_patientName" class="form-group row">
		<label id="elh__appointment_scheduler_patientName" for="x_patientName" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_patientName" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->patientName->caption() ?><?php echo ($_appointment_scheduler->patientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->patientName->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_patientName" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->DoctorID->Visible) { // DoctorID ?>
	<div id="r_DoctorID" class="form-group row">
		<label id="elh__appointment_scheduler_DoctorID" for="x_DoctorID" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_DoctorID" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->DoctorID->caption() ?><?php echo ($_appointment_scheduler->DoctorID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->DoctorID->cellAttributes() ?>>
<?php if ($_appointment_scheduler->DoctorID->getSessionValue() <> "") { ?>
<script id="tpx__appointment_scheduler_DoctorID" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->DoctorName->Visible) { // DoctorName ?>
	<div id="r_DoctorName" class="form-group row">
		<label id="elh__appointment_scheduler_DoctorName" for="x_DoctorName" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_DoctorName" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->DoctorName->caption() ?><?php echo ($_appointment_scheduler->DoctorName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->DoctorName->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_DoctorName" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->AppointmentStatus->Visible) { // AppointmentStatus ?>
	<div id="r_AppointmentStatus" class="form-group row">
		<label id="elh__appointment_scheduler_AppointmentStatus" for="x_AppointmentStatus" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_AppointmentStatus" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->AppointmentStatus->caption() ?><?php echo ($_appointment_scheduler->AppointmentStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->AppointmentStatus->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_AppointmentStatus" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->status->Visible) { // status ?>
	<div id="r_status" class="form-group row">
		<label id="elh__appointment_scheduler_status" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_status" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->status->caption() ?><?php echo ($_appointment_scheduler->status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->status->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_status" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->DoctorCode->Visible) { // DoctorCode ?>
	<div id="r_DoctorCode" class="form-group row">
		<label id="elh__appointment_scheduler_DoctorCode" for="x_DoctorCode" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_DoctorCode" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->DoctorCode->caption() ?><?php echo ($_appointment_scheduler->DoctorCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->DoctorCode->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_DoctorCode" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->Department->Visible) { // Department ?>
	<div id="r_Department" class="form-group row">
		<label id="elh__appointment_scheduler_Department" for="x_Department" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Department" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Department->caption() ?><?php echo ($_appointment_scheduler->Department->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Department->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Department" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->scheduler_id->Visible) { // scheduler_id ?>
	<div id="r_scheduler_id" class="form-group row">
		<label id="elh__appointment_scheduler_scheduler_id" for="x_scheduler_id" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_scheduler_id" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->scheduler_id->caption() ?><?php echo ($_appointment_scheduler->scheduler_id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->scheduler_id->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_scheduler_id" class="_appointment_scheduleradd" type="text/html">
<span id="el__appointment_scheduler_scheduler_id">
<input type="text" data-table="_appointment_scheduler" data-field="x_scheduler_id" name="x_scheduler_id" id="x_scheduler_id" size="30" maxlength="45" placeholder="<?php echo HtmlEncode($_appointment_scheduler->scheduler_id->getPlaceHolder()) ?>" value="<?php echo $_appointment_scheduler->scheduler_id->EditValue ?>"<?php echo $_appointment_scheduler->scheduler_id->editAttributes() ?>>
</span>
</script>
...
<?php if ($_appointment_scheduler->text->Visible) { // text ?>
	<div id="r_text" class="form-group row">
		<label id="elh__appointment_scheduler_text" for="x_text" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_text" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->text->caption() ?><?php echo ($_appointment_scheduler->text->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->text->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_text" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->appointment_status->Visible) { // appointment_status ?>
	<div id="r_appointment_status" class="form-group row">
		<label id="elh__appointment_scheduler_appointment_status" for="x_appointment_status" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_appointment_status" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->appointment_status->caption() ?><?php echo ($_appointment_scheduler->appointment_status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->appointment_status->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_appointment_status" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->PId->Visible) { // PId ?>
	<div id="r_PId" class="form-group row">
		<label id="elh__appointment_scheduler_PId" for="x_PId" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_PId" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->PId->caption() ?><?php echo ($_appointment_scheduler->PId->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->PId->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_PId" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->MobileNumber->Visible) { // MobileNumber ?>
	<div id="r_MobileNumber" class="form-group row">
		<label id="elh__appointment_scheduler_MobileNumber" for="x_MobileNumber" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_MobileNumber" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->MobileNumber->caption() ?><?php echo ($_appointment_scheduler->MobileNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->MobileNumber->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_MobileNumber" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->SchEmail->Visible) { // SchEmail ?>
	<div id="r_SchEmail" class="form-group row">
		<label id="elh__appointment_scheduler_SchEmail" for="x_SchEmail" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_SchEmail" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->SchEmail->caption() ?><?php echo ($_appointment_scheduler->SchEmail->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->SchEmail->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_SchEmail" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->appointment_type->Visible) { // appointment_type ?>
	<div id="r_appointment_type" class="form-group row">
		<label id="elh__appointment_scheduler_appointment_type" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_appointment_type" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->appointment_type->caption() ?><?php echo ($_appointment_scheduler->appointment_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->appointment_type->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_appointment_type" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->Notified->Visible) { // Notified ?>
	<div id="r_Notified" class="form-group row">
		<label id="elh__appointment_scheduler_Notified" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Notified" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Notified->caption() ?><?php echo ($_appointment_scheduler->Notified->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Notified->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Notified" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->Purpose->Visible) { // Purpose ?>
	<div id="r_Purpose" class="form-group row">
		<label id="elh__appointment_scheduler_Purpose" for="x_Purpose" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Purpose" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Purpose->caption() ?><?php echo ($_appointment_scheduler->Purpose->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Purpose->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Purpose" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh__appointment_scheduler_Notes" for="x_Notes" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Notes" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Notes->caption() ?><?php echo ($_appointment_scheduler->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Notes->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Notes" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->PatientType->Visible) { // PatientType ?>
	<div id="r_PatientType" class="form-group row">
		<label id="elh__appointment_scheduler_PatientType" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_PatientType" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->PatientType->caption() ?><?php echo ($_appointment_scheduler->PatientType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->PatientType->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_PatientType" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->Referal->Visible) { // Referal ?>
	<div id="r_Referal" class="form-group row">
		<label id="elh__appointment_scheduler_Referal" for="x_Referal" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Referal" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Referal->caption() ?><?php echo ($_appointment_scheduler->Referal->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Referal->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Referal" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->paymentType->Visible) { // paymentType ?>
	<div id="r_paymentType" class="form-group row">
		<label id="elh__appointment_scheduler_paymentType" for="x_paymentType" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_paymentType" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->paymentType->caption() ?><?php echo ($_appointment_scheduler->paymentType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->paymentType->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_paymentType" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->tittle->Visible) { // tittle ?>
	<div id="r_tittle" class="form-group row">
		<label id="elh__appointment_scheduler_tittle" for="x_tittle" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_tittle" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->tittle->caption() ?><?php echo ($_appointment_scheduler->tittle->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->tittle->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_tittle" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->gendar->Visible) { // gendar ?>
	<div id="r_gendar" class="form-group row">
		<label id="elh__appointment_scheduler_gendar" for="x_gendar" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_gendar" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->gendar->caption() ?><?php echo ($_appointment_scheduler->gendar->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->gendar->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_gendar" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->Dob->Visible) { // Dob ?>
	<div id="r_Dob" class="form-group row">
		<label id="elh__appointment_scheduler_Dob" for="x_Dob" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Dob" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Dob->caption() ?><?php echo ($_appointment_scheduler->Dob->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Dob->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Dob" class="_appointment_scheduleradd" type="text/html">
...
<script type="text/html" class="_appointment_scheduleradd_js">
ew.createDateTimePicker("f_appointment_scheduleradd", "x_Dob", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
...
<?php if ($_appointment_scheduler->Age->Visible) { // Age ?>
	<div id="r_Age" class="form-group row">
		<label id="elh__appointment_scheduler_Age" for="x_Age" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_Age" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->Age->caption() ?><?php echo ($_appointment_scheduler->Age->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->Age->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_Age" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->WhereDidYouHear->Visible) { // WhereDidYouHear ?>
	<div id="r_WhereDidYouHear" class="form-group row">
		<label id="elh__appointment_scheduler_WhereDidYouHear" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_WhereDidYouHear" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->WhereDidYouHear->caption() ?><?php echo ($_appointment_scheduler->WhereDidYouHear->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->WhereDidYouHear->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_WhereDidYouHear" class="_appointment_scheduleradd" type="text/html">
...
<?php if ($_appointment_scheduler->PatientTypee->Visible) { // PatientTypee ?>
	<div id="r_PatientTypee" class="form-group row">
		<label id="elh__appointment_scheduler_PatientTypee" for="x_PatientTypee" class="<?php echo $_appointment_scheduler_add->LeftColumnClass ?>"><script id="tpc__appointment_scheduler_PatientTypee" class="_appointment_scheduleradd" type="text/html"><span><?php echo $_appointment_scheduler->PatientTypee->caption() ?><?php echo ($_appointment_scheduler->PatientTypee->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $_appointment_scheduler_add->RightColumnClass ?>"><div<?php echo $_appointment_scheduler->PatientTypee->cellAttributes() ?>>
<script id="tpx__appointment_scheduler_PatientTypee" class="_appointment_scheduleradd" type="text/html">
...
<div id="tpd__appointment_scheduleradd" class="ew-custom-template"></div>
<script id="tpm__appointment_scheduleradd" type="text/html">
<div id="ct__appointment_scheduler_add"><style type="text/css" >
.form-control {
	display: table;
	max-width: none;
}
...
<?php if (!$_appointment_scheduler_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $_appointment_scheduler_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $_appointment_scheduler_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
...
ew.applyTemplate("tpd__appointment_scheduleradd", "tpm__appointment_scheduleradd", "_appointment_scheduleradd", "<?php echo $_appointment_scheduler->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script._appointment_scheduleradd_js").each(function(){ew.addScript(this.text);});
</script>
<?php
$_appointment_scheduler_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$_appointment_scheduler_add->terminate();
?>