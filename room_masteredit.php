...
var froom_masteredit = currentForm = new ew.Form("froom_masteredit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($room_master_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $room_master->id->caption(), $room_master->id->RequiredErrorMessage)) ?>");
		<?php } ?>
...
froom_masteredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
froom_masteredit.lists["x_RoomType"] = <?php echo $room_master_edit->RoomType->Lookup->toClientList() ?>;
froom_masteredit.lists["x_RoomType"].options = <?php echo JsonEncode($room_master_edit->RoomType->lookupOptions()) ?>;
froom_masteredit.lists["x_SharingRoom"] = <?php echo $room_master_edit->SharingRoom->Lookup->toClientList() ?>;
froom_masteredit.lists["x_SharingRoom"].options = <?php echo JsonEncode($room_master_edit->SharingRoom->options(FALSE, TRUE)) ?>;
froom_masteredit.lists["x_Status"] = <?php echo $room_master_edit->Status->Lookup->toClientList() ?>;
...
<?php if ($room_master_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $room_master_edit->Token ?>">
<?php } ?>
...
<?php if ($room_master->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_room_master_id" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->id->caption() ?><?php echo ($room_master->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->id->cellAttributes() ?>>
<span id="el_room_master_id">
<span<?php echo $room_master->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($room_master->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="room_master" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($room_master->id->CurrentValue) ?>">
<?php echo $room_master->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($room_master->RoomNo->Visible) { // RoomNo ?>
	<div id="r_RoomNo" class="form-group row">
		<label id="elh_room_master_RoomNo" for="x_RoomNo" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->RoomNo->caption() ?><?php echo ($room_master->RoomNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->RoomNo->cellAttributes() ?>>
...
<?php if ($room_master->RoomType->Visible) { // RoomType ?>
	<div id="r_RoomType" class="form-group row">
		<label id="elh_room_master_RoomType" for="x_RoomType" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->RoomType->caption() ?><?php echo ($room_master->RoomType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->RoomType->cellAttributes() ?>>
...
<?php if ($room_master->SharingRoom->Visible) { // SharingRoom ?>
	<div id="r_SharingRoom" class="form-group row">
		<label id="elh_room_master_SharingRoom" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->SharingRoom->caption() ?><?php echo ($room_master->SharingRoom->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->SharingRoom->cellAttributes() ?>>
...
<?php if ($room_master->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_room_master_Amount" for="x_Amount" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->Amount->caption() ?><?php echo ($room_master->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->Amount->cellAttributes() ?>>
...
<?php if ($room_master->Status->Visible) { // Status ?>
	<div id="r_Status" class="form-group row">
		<label id="elh_room_master_Status" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->Status->caption() ?><?php echo ($room_master->Status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->Status->cellAttributes() ?>>
...
<?php if ($room_master->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_room_master_PatientID" for="x_PatientID" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->PatientID->caption() ?><?php echo ($room_master->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->PatientID->cellAttributes() ?>>
...
<?php if ($room_master->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_room_master_PatientName" for="x_PatientName" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->PatientName->caption() ?><?php echo ($room_master->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->PatientName->cellAttributes() ?>>
...
<?php if ($room_master->MobileNo->Visible) { // MobileNo ?>
	<div id="r_MobileNo" class="form-group row">
		<label id="elh_room_master_MobileNo" for="x_MobileNo" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->MobileNo->caption() ?><?php echo ($room_master->MobileNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->MobileNo->cellAttributes() ?>>
...
<?php if ($room_master->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_room_master_PatID" for="x_PatID" class="<?php echo $room_master_edit->LeftColumnClass ?>"><?php echo $room_master->PatID->caption() ?><?php echo ($room_master->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $room_master_edit->RightColumnClass ?>"><div<?php echo $room_master->PatID->cellAttributes() ?>>
