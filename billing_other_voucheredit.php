...
var fbilling_other_voucheredit = currentForm = new ew.Form("fbilling_other_voucheredit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($billing_other_voucher_edit->id->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $billing_other_voucher->id->caption(), $billing_other_voucher->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($billing_other_voucher_edit->freezed->Required) { ?>
		...
		<?php if ($billing_other_voucher_edit->modifiedby->Required) { ?>
			...
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $billing_other_voucher->modifiedby->caption(), $billing_other_voucher->modifiedby->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($billing_other_voucher_edit->modifieddatetime->Required) { ?>
			elm = this.getElements("x" + infix + "_modifieddatetime");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $billing_other_voucher->modifieddatetime->caption(), $billing_other_voucher->modifieddatetime->RequiredErrorMessage)) ?>");
		<?php } ?>
		...
		<?php } ?>
		<?php if ($billing_other_voucher_edit->Cash->Required) { ?>
		...
		<?php if ($billing_other_voucher_edit->Card->Required) { ?>
...
fbilling_other_voucheredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fbilling_other_voucheredit.lists["x_ModeofPayment"] = <?php echo $billing_other_voucher_edit->ModeofPayment->Lookup->toClientList() ?>;
...
fbilling_other_voucheredit.lists["x_PatID"] = <?php echo $billing_other_voucher_edit->PatID->Lookup->toClientList() ?>;
fbilling_other_voucheredit.lists["x_PatID"].options = <?php echo JsonEncode($billing_other_voucher_edit->PatID->lookupOptions()) ?>;
fbilling_other_voucheredit.lists["x_CancelAdvance[]"] = <?php echo $billing_other_voucher_edit->CancelAdvance->Lookup->toClientList() ?>;
...
fbilling_other_voucheredit.lists["x_CancelStatus"] = <?php echo $billing_other_voucher_edit->CancelStatus->Lookup->toClientList() ?>;
...
<?php if ($billing_other_voucher_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $billing_other_voucher_edit->Token ?>">
<?php } ?>
...
<?php if ($billing_other_voucher->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_billing_other_voucher_id" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_id" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->id->caption() ?><?php echo ($billing_other_voucher->id->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->id->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_id" class="billing_other_voucheredit" type="text/html">
<span id="el_billing_other_voucher_id">
<span<?php echo $billing_other_voucher->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_other_voucher->id->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_other_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($billing_other_voucher->id->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_other_voucher_id" class="billing_other_voucheredit" type="text/html">
<span id="el_billing_other_voucher_id">
<span<?php echo $billing_other_voucher->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_other_voucher->id->ViewValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_other_voucher" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($billing_other_voucher->id->FormValue) ?>">
<?php } ?>
<?php echo $billing_other_voucher->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($billing_other_voucher->freezed->Visible) { // freezed ?>
	<div id="r_freezed" class="form-group row">
		<label id="elh_billing_other_voucher_freezed" for="x_freezed" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_freezed" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->freezed->caption() ?><?php echo ($billing_other_voucher->freezed->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->freezed->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_freezed" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->AdvanceNo->Visible) { // AdvanceNo ?>
	<div id="r_AdvanceNo" class="form-group row">
		<label id="elh_billing_other_voucher_AdvanceNo" for="x_AdvanceNo" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_AdvanceNo" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->AdvanceNo->caption() ?><?php echo ($billing_other_voucher->AdvanceNo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->AdvanceNo->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_AdvanceNo" class="billing_other_voucheredit" type="text/html">
<span id="el_billing_other_voucher_AdvanceNo">
<span<?php echo $billing_other_voucher->AdvanceNo->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($billing_other_voucher->AdvanceNo->EditValue) ?>"></span>
</span>
</script>
<input type="hidden" data-table="billing_other_voucher" data-field="x_AdvanceNo" name="x_AdvanceNo" id="x_AdvanceNo" value="<?php echo HtmlEncode($billing_other_voucher->AdvanceNo->CurrentValue) ?>">
<?php } else { ?>
<script id="tpx_billing_other_voucher_AdvanceNo" class="billing_other_voucheredit" type="text/html">
<span id="el_billing_other_voucher_AdvanceNo">
<span<?php echo $billing_other_voucher->AdvanceNo->viewAttributes() ?>>
...
<?php if ($billing_other_voucher->PatientID->Visible) { // PatientID ?>
	<div id="r_PatientID" class="form-group row">
		<label id="elh_billing_other_voucher_PatientID" for="x_PatientID" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_PatientID" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->PatientID->caption() ?><?php echo ($billing_other_voucher->PatientID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->PatientID->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_PatientID" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->PatientName->Visible) { // PatientName ?>
	<div id="r_PatientName" class="form-group row">
		<label id="elh_billing_other_voucher_PatientName" for="x_PatientName" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_PatientName" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->PatientName->caption() ?><?php echo ($billing_other_voucher->PatientName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->PatientName->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_PatientName" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Mobile->Visible) { // Mobile ?>
	<div id="r_Mobile" class="form-group row">
		<label id="elh_billing_other_voucher_Mobile" for="x_Mobile" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Mobile" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Mobile->caption() ?><?php echo ($billing_other_voucher->Mobile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Mobile->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Mobile" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->ModeofPayment->Visible) { // ModeofPayment ?>
	<div id="r_ModeofPayment" class="form-group row">
		<label id="elh_billing_other_voucher_ModeofPayment" for="x_ModeofPayment" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_ModeofPayment" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->ModeofPayment->caption() ?><?php echo ($billing_other_voucher->ModeofPayment->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->ModeofPayment->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_ModeofPayment" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Amount->Visible) { // Amount ?>
	<div id="r_Amount" class="form-group row">
		<label id="elh_billing_other_voucher_Amount" for="x_Amount" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Amount" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Amount->caption() ?><?php echo ($billing_other_voucher->Amount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Amount->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Amount" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CardNumber->Visible) { // CardNumber ?>
	<div id="r_CardNumber" class="form-group row">
		<label id="elh_billing_other_voucher_CardNumber" for="x_CardNumber" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CardNumber" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CardNumber->caption() ?><?php echo ($billing_other_voucher->CardNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CardNumber->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CardNumber" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->BankName->Visible) { // BankName ?>
	<div id="r_BankName" class="form-group row">
		<label id="elh_billing_other_voucher_BankName" for="x_BankName" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_BankName" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->BankName->caption() ?><?php echo ($billing_other_voucher->BankName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->BankName->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_BankName" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Name->Visible) { // Name ?>
	<div id="r_Name" class="form-group row">
		<label id="elh_billing_other_voucher_Name" for="x_Name" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Name" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Name->caption() ?><?php echo ($billing_other_voucher->Name->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Name->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Name" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->voucher_type->Visible) { // voucher_type ?>
	<div id="r_voucher_type" class="form-group row">
		<label id="elh_billing_other_voucher_voucher_type" for="x_voucher_type" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_voucher_type" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->voucher_type->caption() ?><?php echo ($billing_other_voucher->voucher_type->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->voucher_type->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_voucher_type" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Details->Visible) { // Details ?>
	<div id="r_Details" class="form-group row">
		<label id="elh_billing_other_voucher_Details" for="x_Details" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Details" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Details->caption() ?><?php echo ($billing_other_voucher->Details->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Details->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Details" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Date->Visible) { // Date ?>
	<div id="r_Date" class="form-group row">
		<label id="elh_billing_other_voucher_Date" for="x_Date" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Date" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Date->caption() ?><?php echo ($billing_other_voucher->Date->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Date->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Date" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->AnyDues->Visible) { // AnyDues ?>
	<div id="r_AnyDues" class="form-group row">
		<label id="elh_billing_other_voucher_AnyDues" for="x_AnyDues" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_AnyDues" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->AnyDues->caption() ?><?php echo ($billing_other_voucher->AnyDues->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->AnyDues->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_AnyDues" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->PatID->Visible) { // PatID ?>
	<div id="r_PatID" class="form-group row">
		<label id="elh_billing_other_voucher_PatID" for="x_PatID" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_PatID" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->PatID->caption() ?><?php echo ($billing_other_voucher->PatID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->PatID->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_PatID" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->VisiteType->Visible) { // VisiteType ?>
	<div id="r_VisiteType" class="form-group row">
		<label id="elh_billing_other_voucher_VisiteType" for="x_VisiteType" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_VisiteType" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->VisiteType->caption() ?><?php echo ($billing_other_voucher->VisiteType->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->VisiteType->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_VisiteType" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->VisitDate->Visible) { // VisitDate ?>
	<div id="r_VisitDate" class="form-group row">
		<label id="elh_billing_other_voucher_VisitDate" for="x_VisitDate" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_VisitDate" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->VisitDate->caption() ?><?php echo ($billing_other_voucher->VisitDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->VisitDate->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_VisitDate" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Status->Visible) { // Status ?>
	<div id="r_Status" class="form-group row">
		<label id="elh_billing_other_voucher_Status" for="x_Status" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Status" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Status->caption() ?><?php echo ($billing_other_voucher->Status->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Status->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Status" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->AdvanceValidityDate->Visible) { // AdvanceValidityDate ?>
	<div id="r_AdvanceValidityDate" class="form-group row">
		<label id="elh_billing_other_voucher_AdvanceValidityDate" for="x_AdvanceValidityDate" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_AdvanceValidityDate" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->AdvanceValidityDate->caption() ?><?php echo ($billing_other_voucher->AdvanceValidityDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->AdvanceValidityDate->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_AdvanceValidityDate" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->TotalRemainingAdvance->Visible) { // TotalRemainingAdvance ?>
	<div id="r_TotalRemainingAdvance" class="form-group row">
		<label id="elh_billing_other_voucher_TotalRemainingAdvance" for="x_TotalRemainingAdvance" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_TotalRemainingAdvance" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->TotalRemainingAdvance->caption() ?><?php echo ($billing_other_voucher->TotalRemainingAdvance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->TotalRemainingAdvance->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_TotalRemainingAdvance" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Remarks->Visible) { // Remarks ?>
	<div id="r_Remarks" class="form-group row">
		<label id="elh_billing_other_voucher_Remarks" for="x_Remarks" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Remarks" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Remarks->caption() ?><?php echo ($billing_other_voucher->Remarks->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Remarks->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Remarks" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->SeectPaymentMode->Visible) { // SeectPaymentMode ?>
	<div id="r_SeectPaymentMode" class="form-group row">
		<label id="elh_billing_other_voucher_SeectPaymentMode" for="x_SeectPaymentMode" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_SeectPaymentMode" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->SeectPaymentMode->caption() ?><?php echo ($billing_other_voucher->SeectPaymentMode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->SeectPaymentMode->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_SeectPaymentMode" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->PaidAmount->Visible) { // PaidAmount ?>
	<div id="r_PaidAmount" class="form-group row">
		<label id="elh_billing_other_voucher_PaidAmount" for="x_PaidAmount" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_PaidAmount" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->PaidAmount->caption() ?><?php echo ($billing_other_voucher->PaidAmount->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->PaidAmount->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_PaidAmount" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Currency->Visible) { // Currency ?>
	<div id="r_Currency" class="form-group row">
		<label id="elh_billing_other_voucher_Currency" for="x_Currency" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Currency" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Currency->caption() ?><?php echo ($billing_other_voucher->Currency->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Currency->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Currency" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Reception->Visible) { // Reception ?>
	<div id="r_Reception" class="form-group row">
		<label id="elh_billing_other_voucher_Reception" for="x_Reception" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Reception" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Reception->caption() ?><?php echo ($billing_other_voucher->Reception->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Reception->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Reception" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->mrnno->Visible) { // mrnno ?>
	<div id="r_mrnno" class="form-group row">
		<label id="elh_billing_other_voucher_mrnno" for="x_mrnno" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_mrnno" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->mrnno->caption() ?><?php echo ($billing_other_voucher->mrnno->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->mrnno->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_mrnno" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->AdjustmentwithAdvance->Visible) { // AdjustmentwithAdvance ?>
	<div id="r_AdjustmentwithAdvance" class="form-group row">
		<label id="elh_billing_other_voucher_AdjustmentwithAdvance" for="x_AdjustmentwithAdvance" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_AdjustmentwithAdvance" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->AdjustmentwithAdvance->caption() ?><?php echo ($billing_other_voucher->AdjustmentwithAdvance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->AdjustmentwithAdvance->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_AdjustmentwithAdvance" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->AdjustmentBillNumber->Visible) { // AdjustmentBillNumber ?>
	<div id="r_AdjustmentBillNumber" class="form-group row">
		<label id="elh_billing_other_voucher_AdjustmentBillNumber" for="x_AdjustmentBillNumber" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_AdjustmentBillNumber" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->AdjustmentBillNumber->caption() ?><?php echo ($billing_other_voucher->AdjustmentBillNumber->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->AdjustmentBillNumber->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_AdjustmentBillNumber" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CancelAdvance->Visible) { // CancelAdvance ?>
	<div id="r_CancelAdvance" class="form-group row">
		<label id="elh_billing_other_voucher_CancelAdvance" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CancelAdvance" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CancelAdvance->caption() ?><?php echo ($billing_other_voucher->CancelAdvance->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CancelAdvance->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CancelAdvance" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CancelReasan->Visible) { // CancelReasan ?>
	<div id="r_CancelReasan" class="form-group row">
		<label id="elh_billing_other_voucher_CancelReasan" for="x_CancelReasan" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CancelReasan" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CancelReasan->caption() ?><?php echo ($billing_other_voucher->CancelReasan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CancelReasan->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CancelReasan" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CancelBy->Visible) { // CancelBy ?>
	<div id="r_CancelBy" class="form-group row">
		<label id="elh_billing_other_voucher_CancelBy" for="x_CancelBy" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CancelBy" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CancelBy->caption() ?><?php echo ($billing_other_voucher->CancelBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CancelBy->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CancelBy" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CancelDate->Visible) { // CancelDate ?>
	<div id="r_CancelDate" class="form-group row">
		<label id="elh_billing_other_voucher_CancelDate" for="x_CancelDate" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CancelDate" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CancelDate->caption() ?><?php echo ($billing_other_voucher->CancelDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CancelDate->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CancelDate" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CancelDateTime->Visible) { // CancelDateTime ?>
	<div id="r_CancelDateTime" class="form-group row">
		<label id="elh_billing_other_voucher_CancelDateTime" for="x_CancelDateTime" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CancelDateTime" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CancelDateTime->caption() ?><?php echo ($billing_other_voucher->CancelDateTime->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CancelDateTime->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CancelDateTime" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CanceledBy->Visible) { // CanceledBy ?>
	<div id="r_CanceledBy" class="form-group row">
		<label id="elh_billing_other_voucher_CanceledBy" for="x_CanceledBy" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CanceledBy" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CanceledBy->caption() ?><?php echo ($billing_other_voucher->CanceledBy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CanceledBy->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CanceledBy" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->CancelStatus->Visible) { // CancelStatus ?>
	<div id="r_CancelStatus" class="form-group row">
		<label id="elh_billing_other_voucher_CancelStatus" for="x_CancelStatus" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_CancelStatus" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->CancelStatus->caption() ?><?php echo ($billing_other_voucher->CancelStatus->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->CancelStatus->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_CancelStatus" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Cash->Visible) { // Cash ?>
	<div id="r_Cash" class="form-group row">
		<label id="elh_billing_other_voucher_Cash" for="x_Cash" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Cash" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Cash->caption() ?><?php echo ($billing_other_voucher->Cash->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Cash->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Cash" class="billing_other_voucheredit" type="text/html">
...
<?php if ($billing_other_voucher->Card->Visible) { // Card ?>
	<div id="r_Card" class="form-group row">
		<label id="elh_billing_other_voucher_Card" for="x_Card" class="<?php echo $billing_other_voucher_edit->LeftColumnClass ?>"><script id="tpc_billing_other_voucher_Card" class="billing_other_voucheredit" type="text/html"><span><?php echo $billing_other_voucher->Card->caption() ?><?php echo ($billing_other_voucher->Card->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></span></script></label>
		<div class="<?php echo $billing_other_voucher_edit->RightColumnClass ?>"><div<?php echo $billing_other_voucher->Card->cellAttributes() ?>>
<?php if (!$billing_other_voucher->isConfirm()) { ?>
<script id="tpx_billing_other_voucher_Card" class="billing_other_voucheredit" type="text/html">
...
<table class="ew-table">
	 <tbody>
		<tr>
		<td>{{include tmpl="#tpc_billing_other_voucher_CancelStatus"/}}&nbsp;{{include tmpl="#tpx_billing_other_voucher_CancelStatus"/}}</td>
			<td>{{include tmpl="#tpc_billing_other_voucher_CancelAdvance"/}}&nbsp;{{include tmpl="#tpx_billing_other_voucher_CancelAdvance"/}}</td>
			<td>{{include tmpl="#tpc_billing_other_voucher_CancelReasan"/}}&nbsp;{{include tmpl="#tpx_billing_other_voucher_CancelReasan"/}}</td>
			<td>{{include tmpl="#tpc_billing_other_voucher_CancelDate"/}}&nbsp;{{include tmpl="#tpx_billing_other_voucher_CancelDate"/}}</td>
		</tr>
	</tbody>
</table>
			</div>
...
ew.applyTemplate("tpd_billing_other_voucheredit", "tpm_billing_other_voucheredit", "billing_other_voucheredit", "<?php echo $billing_other_voucher->CustomExport ?>", ew.vars.templateData.rows[0]);
jQuery("script.billing_other_voucheredit_js").each(function(){ew.addScript(this.text);});
</script>
<?php
